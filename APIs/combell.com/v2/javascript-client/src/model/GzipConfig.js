...
/**
 * The GzipConfig model module.
 * @module model/GzipConfig
 * @version v2
 */
class GzipConfig {
    /**
     * Constructs a new <code>GzipConfig</code>.
     * @alias module:model/GzipConfig
     */
    constructor() { 
        
        GzipConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GzipConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GzipConfig} obj Optional instance to populate.
     * @return {module:model/GzipConfig} The populated <code>GzipConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GzipConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GzipConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GzipConfig</code>.
     */
 ...
 */
GzipConfig.prototype['enabled'] = undefined;
