...
/**
 * The CreateMySqlDatabase model module.
 * @module model/CreateMySqlDatabase
 * @version v2
 */
class CreateMySqlDatabase {
    /**
     * Constructs a new <code>CreateMySqlDatabase</code>.
     * @alias module:model/CreateMySqlDatabase
     */
    constructor() { 
        
        CreateMySqlDatabase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMySqlDatabase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMySqlDatabase} obj Optional instance to populate.
     * @return {module:model/CreateMySqlDatabase} The populated <code>CreateMySqlDatabase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMySqlDatabase();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMySqlDatabase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMySqlDatabase</code>.
     */
 ...
 */
CreateMySqlDatabase.prototype['account_id'] = undefined;
 ...
 */
CreateMySqlDatabase.prototype['database_name'] = undefined;
 ...
 */
CreateMySqlDatabase.prototype['password'] = undefined;
...
export default CreateMySqlDatabase;
