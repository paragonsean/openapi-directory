...
/**
 * The MailZoneAccount model module.
 * @module model/MailZoneAccount
 * @version v2
 */
class MailZoneAccount {
    /**
     * Constructs a new <code>MailZoneAccount</code>.
     * @alias module:model/MailZoneAccount
     */
    constructor() { 
        
        MailZoneAccount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MailZoneAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MailZoneAccount} obj Optional instance to populate.
     * @return {module:model/MailZoneAccount} The populated <code>MailZoneAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MailZoneAccount();
    ...
    /**
     * Validates the JSON data with respect to <code>MailZoneAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MailZoneAccount</code>.
     */
 ...
 */
MailZoneAccount.prototype['account_id'] = undefined;

/**
 * Size of mailbox(es) in MB
 * @member {Number} size
 */
MailZoneAccount.prototype['size'] = undefined;
...
export default MailZoneAccount;
