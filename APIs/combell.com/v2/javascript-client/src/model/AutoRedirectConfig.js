...
/**
 * The AutoRedirectConfig model module.
 * @module model/AutoRedirectConfig
 * @version v2
 */
class AutoRedirectConfig {
    /**
     * Constructs a new <code>AutoRedirectConfig</code>.
     * @alias module:model/AutoRedirectConfig
     */
    constructor() { 
        
        AutoRedirectConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AutoRedirectConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoRedirectConfig} obj Optional instance to populate.
     * @return {module:model/AutoRedirectConfig} The populated <code>AutoRedirectConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoRedirectConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>AutoRedirectConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoRedirectConfig</code>.
     */
 ...
 */
AutoRedirectConfig.prototype['enabled'] = undefined;
...
export default AutoRedirectConfig;
