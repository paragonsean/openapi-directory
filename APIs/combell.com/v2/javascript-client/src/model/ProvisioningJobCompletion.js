...
/**
 * The ProvisioningJobCompletion model module.
 * @module model/ProvisioningJobCompletion
 * @version v2
 */
class ProvisioningJobCompletion {
    /**
     * Constructs a new <code>ProvisioningJobCompletion</code>.
     * @alias module:model/ProvisioningJobCompletion
     */
    constructor() { 
        
        ProvisioningJobCompletion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProvisioningJobCompletion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProvisioningJobCompletion} obj Optional instance to populate.
     * @return {module:model/ProvisioningJobCompletion} The populated <code>ProvisioningJobCompletion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvisioningJobCompletion();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('resource_links')) {
                obj['resource_links'] = ApiClient.convertToType(data['resource_links'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProvisioningJobCompletion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProvisioningJobCompletion</code>.
     */
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['resource_links'])) {
            throw new Error("Expected the field `resource_links` to be an array in the JSON data but got " + data['resource_links']);
        }
 ...
 * @member {String} id
 */
ProvisioningJobCompletion.prototype['id'] = undefined;

/**
 * Links to the created resource(s).
 * @member {Array.<String>} resource_links
 */
ProvisioningJobCompletion.prototype['resource_links'] = undefined;
...
export default ProvisioningJobCompletion;
