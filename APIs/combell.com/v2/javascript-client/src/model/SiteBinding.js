...
/**
 * The SiteBinding model module.
 * @module model/SiteBinding
 * @version v2
 */
class SiteBinding {
    /**
     * Constructs a new <code>SiteBinding</code>.
     * A site binding identifies a web domain.
     * @alias module:model/SiteBinding
     */
    constructor() { 
        
        SiteBinding.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SiteBinding</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SiteBinding} obj Optional instance to populate.
     * @return {module:model/SiteBinding} The populated <code>SiteBinding</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SiteBinding();

            if (data.hasOwnProperty('cert_thumbprint')) {
                obj['cert_thumbprint'] = ApiClient.convertToType(data['cert_thumbprint'], 'String');
            }
            ...
            if (data.hasOwnProperty('ssl_enabled')) {
                obj['ssl_enabled'] = ApiClient.convertToType(data['ssl_enabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SiteBinding</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SiteBinding</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['cert_thumbprint'] && !(typeof data['cert_thumbprint'] === 'string' || data['cert_thumbprint'] instanceof String)) {
            throw new Error("Expected the field `cert_thumbprint` to be a primitive type in the JSON string but got " + data['cert_thumbprint']);
        }
        // ensure the json data is a string
 ...
 * @member {String} cert_thumbprint
 */
SiteBinding.prototype['cert_thumbprint'] = undefined;

/**
 * The host name of the site binding.
 * @member {String} host_name
 */
SiteBinding.prototype['host_name'] = undefined;

/**
 * The IP address of the site binding.
 * @member {String} ip_address
 */
SiteBinding.prototype['ip_address'] = undefined;

/**
 * The port of the site binding.
 * @member {Number} port
 */
SiteBinding.prototype['port'] = undefined;

/**
 * The protocol of the site binding.
 * @member {String} protocol
 */
SiteBinding.prototype['protocol'] = undefined;

/**
 * Indicates whether ssl is enabled for the binding.
 * @member {Boolean} ssl_enabled
 */
SiteBinding.prototype['ssl_enabled'] = undefined;
