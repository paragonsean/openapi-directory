...
/**
 * The ValidationErrorMessage model module.
 * @module model/ValidationErrorMessage
 * @version v2
 */
class ValidationErrorMessage {
    /**
     * Constructs a new <code>ValidationErrorMessage</code>.
     * @alias module:model/ValidationErrorMessage
     */
    constructor() { 
        
        ValidationErrorMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ValidationErrorMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidationErrorMessage} obj Optional instance to populate.
     * @return {module:model/ValidationErrorMessage} The populated <code>ValidationErrorMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationErrorMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>ValidationErrorMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationErrorMessage</code>.
     */
 ...
 */
ValidationErrorMessage.prototype['error_code'] = undefined;

/**
 * @member {String} error_text
 */
ValidationErrorMessage.prototype['error_text'] = undefined;
