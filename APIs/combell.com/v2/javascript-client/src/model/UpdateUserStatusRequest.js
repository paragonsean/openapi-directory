...
/**
 * The UpdateUserStatusRequest model module.
 * @module model/UpdateUserStatusRequest
 * @version v2
 */
class UpdateUserStatusRequest {
    /**
     * Constructs a new <code>UpdateUserStatusRequest</code>.
     * @alias module:model/UpdateUserStatusRequest
     */
    constructor() { 
        
        UpdateUserStatusRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserStatusRequest} obj Optional instance to populate.
     * @return {module:model/UpdateUserStatusRequest} The populated <code>UpdateUserStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserStatusRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserStatusRequest</code>.
     */
 ...
 */
UpdateUserStatusRequest.prototype['enabled'] = undefined;
...
export default UpdateUserStatusRequest;
