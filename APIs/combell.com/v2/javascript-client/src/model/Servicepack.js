...
/**
 * The Servicepack model module.
 * @module model/Servicepack
 * @version v2
 */
class Servicepack {
    /**
     * Constructs a new <code>Servicepack</code>.
     * Servicepack information.
     * @alias module:model/Servicepack
     */
    constructor() { 
        
        Servicepack.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Servicepack</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Servicepack} obj Optional instance to populate.
     * @return {module:model/Servicepack} The populated <code>Servicepack</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Servicepack();
    ...
    /**
     * Validates the JSON data with respect to <code>Servicepack</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Servicepack</code>.
     */
 ...
 * @member {Number} id
 */
Servicepack.prototype['id'] = undefined;

/**
 * The name of the service pack
 * @member {String} name
 */
Servicepack.prototype['name'] = undefined;
