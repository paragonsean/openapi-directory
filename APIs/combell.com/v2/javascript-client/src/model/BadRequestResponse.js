...
class BadRequestResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('validation_errors')) {
                obj['validation_errors'] = ApiClient.convertToType(data['validation_errors'], [ValidationErrorMessage]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['validation_errors']) { // data not null
            ...
            for (const item of data['validation_errors']) {
                ValidationErrorMessage.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ValidationErrorMessage>} validation_errors
 */
BadRequestResponse.prototype['validation_errors'] = undefined;
