...
class UpdateUserPasswordRequest {
    ...
    constructor() { 
        ...
        UpdateUserPasswordRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPasswordRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPasswordRequest} obj Optional instance to populate.
     * @return {module:model/UpdateUserPasswordRequest} The populated <code>UpdateUserPasswordRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPasswordRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPasswordRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPasswordRequest</code>.
     */
