...
/**
 * The LetsEncryptConfig model module.
 * @module model/LetsEncryptConfig
 * @version v2
 */
class LetsEncryptConfig {
    /**
     * Constructs a new <code>LetsEncryptConfig</code>.
     * @alias module:model/LetsEncryptConfig
     */
    constructor() { 
        
        LetsEncryptConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LetsEncryptConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LetsEncryptConfig} obj Optional instance to populate.
     * @return {module:model/LetsEncryptConfig} The populated <code>LetsEncryptConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LetsEncryptConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>LetsEncryptConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LetsEncryptConfig</code>.
     */
 ...
 */
LetsEncryptConfig.prototype['enabled'] = undefined;
...
export default LetsEncryptConfig;
