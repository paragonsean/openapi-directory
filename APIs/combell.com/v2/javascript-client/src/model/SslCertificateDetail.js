...
/**
 * The SslCertificateDetail model module.
 * @module model/SslCertificateDetail
 * @version v2
 */
class SslCertificateDetail {
    /**
     * Constructs a new <code>SslCertificateDetail</code>.
     * @alias module:model/SslCertificateDetail
     */
    constructor() { 
        
        SslCertificateDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SslCertificateDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SslCertificateDetail} obj Optional instance to populate.
     * @return {module:model/SslCertificateDetail} The populated <code>SslCertificateDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SslCertificateDetail();
            ...
            if (data.hasOwnProperty('sha1_fingerprint')) {
                obj['sha1_fingerprint'] = ApiClient.convertToType(data['sha1_fingerprint'], 'String');
            }
            if (data.hasOwnProperty('subject_alt_names')) {
                obj['subject_alt_names'] = ApiClient.convertToType(data['subject_alt_names'], [SslSubjectAltName]);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = SslCertificateType.constructFromObject(data['type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SslCertificateDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SslCertificateDetail</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['sha1_fingerprint'] && !(typeof data['sha1_fingerprint'] === 'string' || data['sha1_fingerprint'] instanceof String)) {
            throw new Error("Expected the field `sha1_fingerprint` to be a primitive type in the JSON string but got " + data['sha1_fingerprint']);
        }
        if (data['subject_alt_names']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['subject_alt_names'])) {
                throw new Error("Expected the field `subject_alt_names` to be an array in the JSON data but got " + data['subject_alt_names']);
            }
            // validate the optional field `subject_alt_names` (array)
            for (const item of data['subject_alt_names']) {
                SslSubjectAltName.validateJSON(item);
            };
        }
 ...
 */
SslCertificateDetail.prototype['common_name'] = undefined;

/**
 * The exact time the certificate will expire.
 * @member {Date} expires_after
 */
SslCertificateDetail.prototype['expires_after'] = undefined;
 ...
 * @member {String} sha1_fingerprint
 */
SslCertificateDetail.prototype['sha1_fingerprint'] = undefined;

/**
 * The list of all supported dns names in the certificate.
 * @member {Array.<module:model/SslSubjectAltName>} subject_alt_names
 */
SslCertificateDetail.prototype['subject_alt_names'] = undefined;

/**
 * @member {module:model/SslCertificateType} type
 */
SslCertificateDetail.prototype['type'] = undefined;

/**
 * @member {module:model/SslCertificateValidationLevel} validation_level
 */
SslCertificateDetail.prototype['validation_level'] = undefined;
