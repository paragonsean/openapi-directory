...
/**
 * The CreateMySqlUser model module.
 * @module model/CreateMySqlUser
 * @version v2
 */
class CreateMySqlUser {
    /**
     * Constructs a new <code>CreateMySqlUser</code>.
     * @alias module:model/CreateMySqlUser
     */
    constructor() { 
        
        CreateMySqlUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMySqlUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMySqlUser} obj Optional instance to populate.
     * @return {module:model/CreateMySqlUser} The populated <code>CreateMySqlUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMySqlUser();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMySqlUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMySqlUser</code>.
     */
 ...
 * @member {String} name
 */
CreateMySqlUser.prototype['name'] = undefined;
 ...
 */
CreateMySqlUser.prototype['password'] = undefined;
...
export default CreateMySqlUser;
