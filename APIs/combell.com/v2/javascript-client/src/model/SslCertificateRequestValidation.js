...
import SslCertificateRequestValidationType from './SslCertificateRequestValidationType';

/**
 * The SslCertificateRequestValidation model module.
 * @module model/SslCertificateRequestValidation
 * @version v2
 */
class SslCertificateRequestValidation {
    /**
     * Constructs a new <code>SslCertificateRequestValidation</code>.
     * @alias module:model/SslCertificateRequestValidation
     */
    constructor() { 
        
        SslCertificateRequestValidation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SslCertificateRequestValidation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SslCertificateRequestValidation} obj Optional instance to populate.
     * @return {module:model/SslCertificateRequestValidation} The populated <code>SslCertificateRequestValidation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SslCertificateRequestValidation();

            if (data.hasOwnProperty('auto_validated')) {
                obj['auto_validated'] = ApiClient.convertToType(data['auto_validated'], 'Boolean');
            }
            if (data.hasOwnProperty('cname_validation_content')) {
                obj['cname_validation_content'] = ApiClient.convertToType(data['cname_validation_content'], 'String');
            }
            if (data.hasOwnProperty('cname_validation_name')) {
                obj['cname_validation_name'] = ApiClient.convertToType(data['cname_validation_name'], 'String');
            }
            ...
            if (data.hasOwnProperty('file_validation_content')) {
                obj['file_validation_content'] = ApiClient.convertToType(data['file_validation_content'], ['String']);
            }
            if (data.hasOwnProperty('file_validation_url_http')) {
                obj['file_validation_url_http'] = ApiClient.convertToType(data['file_validation_url_http'], 'String');
            }
            if (data.hasOwnProperty('file_validation_url_https')) {
                obj['file_validation_url_https'] = ApiClient.convertToType(data['file_validation_url_https'], 'String');
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = SslCertificateRequestValidationType.constructFromObject(data['type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SslCertificateRequestValidation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SslCertificateRequestValidation</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['cname_validation_content'] && !(typeof data['cname_validation_content'] === 'string' || data['cname_validation_content'] instanceof String)) {
            throw new Error("Expected the field `cname_validation_content` to be a primitive type in the JSON string but got " + data['cname_validation_content']);
        }
        // ensure the json data is a string
        if (data['cname_validation_name'] && !(typeof data['cname_validation_name'] === 'string' || data['cname_validation_name'] instanceof String)) {
            throw new Error("Expected the field `cname_validation_name` to be a primitive type in the JSON string but got " + data['cname_validation_name']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['file_validation_content'])) {
            throw new Error("Expected the field `file_validation_content` to be an array in the JSON data but got " + data['file_validation_content']);
        }
        // ensure the json data is a string
        if (data['file_validation_url_http'] && !(typeof data['file_validation_url_http'] === 'string' || data['file_validation_url_http'] instanceof String)) {
            throw new Error("Expected the field `file_validation_url_http` to be a primitive type in the JSON string but got " + data['file_validation_url_http']);
        }
        // ensure the json data is a string
        if (data['file_validation_url_https'] && !(typeof data['file_validation_url_https'] === 'string' || data['file_validation_url_https'] instanceof String)) {
            throw new Error("Expected the field `file_validation_url_https` to be a primitive type in the JSON string but got " + data['file_validation_url_https']);
        }
 ...
 * @member {Boolean} auto_validated
 */
SslCertificateRequestValidation.prototype['auto_validated'] = undefined;

/**
 * The value-part (Point To) of the CNAME-record that must be created as part of domain verification.
 * @member {String} cname_validation_content
 */
SslCertificateRequestValidation.prototype['cname_validation_content'] = undefined;

/**
 * The host-part (Name) of the CNAME-record that must be created as part of domain verification.
 * @member {String} cname_validation_name
 */
SslCertificateRequestValidation.prototype['cname_validation_name'] = undefined;

/**
 * A domain name of the certificate.
 * @member {String} dns_name
 */
SslCertificateRequestValidation.prototype['dns_name'] = undefined;

/**
 * An array of eligible domain verification email addresses.
 * @member {Array.<String>} email_addresses
 */
SslCertificateRequestValidation.prototype['email_addresses'] = undefined;

/**
 * The content your verification file must contain, consisting of three lines of plain-text.
 * @member {Array.<String>} file_validation_content
 */
SslCertificateRequestValidation.prototype['file_validation_content'] = undefined;

/**
 * The URL (http format) your verification file must be uploaded to as part of domain verification.
 * @member {String} file_validation_url_http
 */
SslCertificateRequestValidation.prototype['file_validation_url_http'] = undefined;

/**
 * The URL (https format) your verification file must be uploaded to as part of domain verification.
 * @member {String} file_validation_url_https
 */
SslCertificateRequestValidation.prototype['file_validation_url_https'] = undefined;

/**
 * @member {module:model/SslCertificateRequestValidationType} type
 */
SslCertificateRequestValidation.prototype['type'] = undefined;
...
export default SslCertificateRequestValidation;
