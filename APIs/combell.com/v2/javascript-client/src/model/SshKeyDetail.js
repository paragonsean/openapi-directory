...
/**
 * The SshKeyDetail model module.
 * @module model/SshKeyDetail
 * @version v2
 */
class SshKeyDetail {
    /**
     * Constructs a new <code>SshKeyDetail</code>.
     * @alias module:model/SshKeyDetail
     */
    constructor() { 
        
        SshKeyDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SshKeyDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SshKeyDetail} obj Optional instance to populate.
     * @return {module:model/SshKeyDetail} The populated <code>SshKeyDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SshKeyDetail();

            if (data.hasOwnProperty('fingerprint')) {
                obj['fingerprint'] = ApiClient.convertToType(data['fingerprint'], 'String');
            }
            if (data.hasOwnProperty('linux_hostings')) {
                obj['linux_hostings'] = ApiClient.convertToType(data['linux_hostings'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SshKeyDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SshKeyDetail</code>.
     */
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['linux_hostings'])) {
            throw new Error("Expected the field `linux_hostings` to be an array in the JSON data but got " + data['linux_hostings']);
        }
        // ensure the json data is a string
 ...
 */
SshKeyDetail.prototype['fingerprint'] = undefined;

/**
 * List of Linux hostings where SSH key is attached
 * @member {Array.<String>} linux_hostings
 */
SshKeyDetail.prototype['linux_hostings'] = undefined;

/**
 * Public key
 * @member {String} public_key
 */
SshKeyDetail.prototype['public_key'] = undefined;
