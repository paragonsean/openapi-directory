...
class DomainDetail {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('can_toggle_renew')) {
                obj['can_toggle_renew'] = ApiClient.convertToType(data['can_toggle_renew'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('name_servers')) {
                obj['name_servers'] = ApiClient.convertToType(data['name_servers'], [NameServer]);
            }
            if (data.hasOwnProperty('registrant')) {
                obj['registrant'] = Registrant.constructFromObject(data['registrant']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['name_servers']) { // data not null
            ...
            for (const item of data['name_servers']) {
                NameServer.validateJSON(item);
            };
        }
        // validate the optional field `registrant`
        if (data['registrant']) { // data not null
          Registrant.validateJSON(data['registrant']);
        }
 ...
 * @member {Boolean} can_toggle_renew
 */
DomainDetail.prototype['can_toggle_renew'] = undefined;

/**
 * The domain name
 * @member {String} domain_name
 */
DomainDetail.prototype['domain_name'] = undefined;

/**
 * Expiration date of the domain
 * @member {Date} expiration_date
 */
DomainDetail.prototype['expiration_date'] = undefined;

/**
 * Nameservers of the domain
 * @member {Array.<module:model/NameServer>} name_servers
 */
DomainDetail.prototype['name_servers'] = undefined;

/**
 * @member {module:model/Registrant} registrant
 */
DomainDetail.prototype['registrant'] = undefined;
 ...
 */
DomainDetail.prototype['will_renew'] = undefined;
