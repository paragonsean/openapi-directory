...
/**
 * The UpdatePhpAPcuRequest model module.
 * @module model/UpdatePhpAPcuRequest
 * @version v2
 */
class UpdatePhpAPcuRequest {
    /**
     * Constructs a new <code>UpdatePhpAPcuRequest</code>.
     * @alias module:model/UpdatePhpAPcuRequest
     */
    constructor() { 
        
        UpdatePhpAPcuRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePhpAPcuRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePhpAPcuRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePhpAPcuRequest} The populated <code>UpdatePhpAPcuRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePhpAPcuRequest();

            if (data.hasOwnProperty('apcu_size')) {
                obj['apcu_size'] = ApiClient.convertToType(data['apcu_size'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePhpAPcuRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePhpAPcuRequest</code>.
     */
...
/**
 * The APcu size.
 * @member {Number} apcu_size
 */
UpdatePhpAPcuRequest.prototype['apcu_size'] = undefined;

/**
 * Enables or disables APC.
 * @member {Boolean} enabled
 */
UpdatePhpAPcuRequest.prototype['enabled'] = undefined;
...
export default UpdatePhpAPcuRequest;
