...
/**
 * The UpdateSmtpDomainRequest model module.
 * @module model/UpdateSmtpDomainRequest
 * @version v2
 */
class UpdateSmtpDomainRequest {
    /**
     * Constructs a new <code>UpdateSmtpDomainRequest</code>.
     * @alias module:model/UpdateSmtpDomainRequest
     */
    constructor() { 
        
        UpdateSmtpDomainRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSmtpDomainRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSmtpDomainRequest} obj Optional instance to populate.
     * @return {module:model/UpdateSmtpDomainRequest} The populated <code>UpdateSmtpDomainRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSmtpDomainRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSmtpDomainRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSmtpDomainRequest</code>.
     */
 ...
 */
UpdateSmtpDomainRequest.prototype['enabled'] = undefined;
...
export default UpdateSmtpDomainRequest;
