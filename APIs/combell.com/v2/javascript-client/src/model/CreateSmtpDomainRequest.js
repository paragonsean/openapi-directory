...
/**
 * The CreateSmtpDomainRequest model module.
 * @module model/CreateSmtpDomainRequest
 * @version v2
 */
class CreateSmtpDomainRequest {
    /**
     * Constructs a new <code>CreateSmtpDomainRequest</code>.
     * @alias module:model/CreateSmtpDomainRequest
     */
    constructor() { 
        
        CreateSmtpDomainRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSmtpDomainRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSmtpDomainRequest} obj Optional instance to populate.
     * @return {module:model/CreateSmtpDomainRequest} The populated <code>CreateSmtpDomainRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSmtpDomainRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSmtpDomainRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSmtpDomainRequest</code>.
     */
 ...
 */
CreateSmtpDomainRequest.prototype['hostname'] = undefined;
...
export default CreateSmtpDomainRequest;
