...
/**
 * The MySqlUser model module.
 * @module model/MySqlUser
 * @version v2
 */
class MySqlUser {
    /**
     * Constructs a new <code>MySqlUser</code>.
     * @alias module:model/MySqlUser
     */
    constructor() { 
        
        MySqlUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MySqlUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MySqlUser} obj Optional instance to populate.
     * @return {module:model/MySqlUser} The populated <code>MySqlUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MySqlUser();
            ...
            if (data.hasOwnProperty('rights')) {
                obj['rights'] = UserRights.constructFromObject(data['rights']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MySqlUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MySqlUser</code>.
     */
 ...
 */
MySqlUser.prototype['enabled'] = undefined;

/**
 * User name
 * @member {String} name
 */
MySqlUser.prototype['name'] = undefined;

/**
 * @member {module:model/UserRights} rights
 */
MySqlUser.prototype['rights'] = undefined;
