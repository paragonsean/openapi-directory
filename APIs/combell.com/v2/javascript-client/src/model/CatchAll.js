...
/**
 * The CatchAll model module.
 * @module model/CatchAll
 * @version v2
 */
class CatchAll {
    /**
     * Constructs a new <code>CatchAll</code>.
     * @alias module:model/CatchAll
     */
    constructor() { 
        
        CatchAll.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CatchAll</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CatchAll} obj Optional instance to populate.
     * @return {module:model/CatchAll} The populated <code>CatchAll</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CatchAll();
    ...
    /**
     * Validates the JSON data with respect to <code>CatchAll</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CatchAll</code>.
     */
 ...
 */
CatchAll.prototype['email_addresses'] = undefined;
