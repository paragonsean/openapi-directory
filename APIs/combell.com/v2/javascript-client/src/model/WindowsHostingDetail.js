...
import WindowsIpType from './WindowsIpType';
import WindowsSite from './WindowsSite';

/**
 * The WindowsHostingDetail model module.
 * @module model/WindowsHostingDetail
 * @version v2
 */
class WindowsHostingDetail {
    /**
     * Constructs a new <code>WindowsHostingDetail</code>.
     * @alias module:model/WindowsHostingDetail
     */
    constructor() { 
        
        WindowsHostingDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WindowsHostingDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WindowsHostingDetail} obj Optional instance to populate.
     * @return {module:model/WindowsHostingDetail} The populated <code>WindowsHostingDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WindowsHostingDetail();

            if (data.hasOwnProperty('actual_size')) {
                obj['actual_size'] = ApiClient.convertToType(data['actual_size'], 'Number');
            }
            if (data.hasOwnProperty('application_pool')) {
                obj['application_pool'] = ApplicationPool.constructFromObject(data['application_pool']);
            }
            ...
            if (data.hasOwnProperty('ip_type')) {
                obj['ip_type'] = WindowsIpType.constructFromObject(data['ip_type']);
            }
            if (data.hasOwnProperty('max_size')) {
                obj['max_size'] = ApiClient.convertToType(data['max_size'], 'Number');
            }
            if (data.hasOwnProperty('mssql_database_names')) {
                obj['mssql_database_names'] = ApiClient.convertToType(data['mssql_database_names'], ['String']);
            }
            ...
            if (data.hasOwnProperty('sites')) {
                obj['sites'] = ApiClient.convertToType(data['sites'], [WindowsSite]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WindowsHostingDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WindowsHostingDetail</code>.
     */
    static validateJSON(data) {
        // validate the optional field `application_pool`
        if (data['application_pool']) { // data not null
          ApplicationPool.validateJSON(data['application_pool']);
        }
        ...
        if (!Array.isArray(data['mssql_database_names'])) {
            throw new Error("Expected the field `mssql_database_names` to be an array in the JSON data but got " + data['mssql_database_names']);
        }
 ...
 */
WindowsHostingDetail.prototype['actual_size'] = undefined;

/**
 * @member {module:model/ApplicationPool} application_pool
 */
WindowsHostingDetail.prototype['application_pool'] = undefined;

/**
 * Domain name for the Windows hosting account.
 * @member {String} domain_name
 */
WindowsHostingDetail.prototype['domain_name'] = undefined;

/**
 * Ftp username
 * @member {String} ftp_username
 */
WindowsHostingDetail.prototype['ftp_username'] = undefined;

/**
 * Windows hosting IP address
 * @member {String} ip
 */
WindowsHostingDetail.prototype['ip'] = undefined;

/**
 * @member {module:model/WindowsIpType} ip_type
 */
WindowsHostingDetail.prototype['ip_type'] = undefined;

/**
 * Maximum webspace size in MB
 * @member {Number} max_size
 */
WindowsHostingDetail.prototype['max_size'] = undefined;

/**
 * A list of mssql databases linked to the hosting account.<br />
 * @member {Array.<String>} mssql_database_names
 */
WindowsHostingDetail.prototype['mssql_database_names'] = undefined;

/**
 * Id of Windows hosting service package.
 * @member {Number} servicepack_id
 */
WindowsHostingDetail.prototype['servicepack_id'] = undefined;

/**
 * A list of websites on the hosting account.
 * @member {Array.<module:model/WindowsSite>} sites
 */
WindowsHostingDetail.prototype['sites'] = undefined;
...
export default WindowsHostingDetail;
