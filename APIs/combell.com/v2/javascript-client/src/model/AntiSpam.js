...
/**
 * The AntiSpam model module.
 * @module model/AntiSpam
 * @version v2
 */
class AntiSpam {
    /**
     * Constructs a new <code>AntiSpam</code>.
     * @alias module:model/AntiSpam
     */
    constructor() { 
        
        AntiSpam.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AntiSpam</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AntiSpam} obj Optional instance to populate.
     * @return {module:model/AntiSpam} The populated <code>AntiSpam</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AntiSpam();

            if (data.hasOwnProperty('allowed_types')) {
                obj['allowed_types'] = ApiClient.convertToType(data['allowed_types'], [AntiSpamTypes]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AntiSpam</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AntiSpam</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['allowed_types'])) {
            throw new Error("Expected the field `allowed_types` to be an array in the JSON data but got " + data['allowed_types']);
        }
 ...
 * @member {Array.<module:model/AntiSpamTypes>} allowed_types
 */
AntiSpam.prototype['allowed_types'] = undefined;

/**
 * @member {module:model/AntiSpamTypes} type
 */
AntiSpam.prototype['type'] = undefined;
