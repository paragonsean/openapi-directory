...
/**
 * The LinuxSite model module.
 * @module model/LinuxSite
 * @version v2
 */
class LinuxSite {
    /**
     * Constructs a new <code>LinuxSite</code>.
     * @alias module:model/LinuxSite
     */
    constructor() { 
        
        LinuxSite.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LinuxSite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinuxSite} obj Optional instance to populate.
     * @return {module:model/LinuxSite} The populated <code>LinuxSite</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinuxSite();

            if (data.hasOwnProperty('host_headers')) {
                obj['host_headers'] = ApiClient.convertToType(data['host_headers'], [HostHeader]);
            }
            if (data.hasOwnProperty('http2_enabled')) {
                obj['http2_enabled'] = ApiClient.convertToType(data['http2_enabled'], 'Boolean');
            }
            if (data.hasOwnProperty('https_redirect_enabled')) {
                obj['https_redirect_enabled'] = ApiClient.convertToType(data['https_redirect_enabled'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LinuxSite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinuxSite</code>.
     */
    static validateJSON(data) {
        if (data['host_headers']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['host_headers'])) {
                throw new Error("Expected the field `host_headers` to be an array in the JSON data but got " + data['host_headers']);
            }
            // validate the optional field `host_headers` (array)
            for (const item of data['host_headers']) {
                HostHeader.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/HostHeader>} host_headers
 */
LinuxSite.prototype['host_headers'] = undefined;

/**
 * Indicates whether http/2 protocol is enabled for the website.
 * @member {Boolean} http2_enabled
 */
LinuxSite.prototype['http2_enabled'] = undefined;

/**
 * Indicates whether automatic https redirection is enabled for the website.
 * @member {Boolean} https_redirect_enabled
 */
LinuxSite.prototype['https_redirect_enabled'] = undefined;

/**
 * The name of the website.
 * @member {String} name
 */
LinuxSite.prototype['name'] = undefined;

/**
 * The path of the website.
 * @member {String} path
 */
LinuxSite.prototype['path'] = undefined;

/**
 * Indicates whether ssl is enabled for the website.
 * @member {Boolean} ssl_enabled
 */
LinuxSite.prototype['ssl_enabled'] = undefined;
