...
/**
 * The MailboxDetail model module.
 * @module model/MailboxDetail
 * @version v2
 */
class MailboxDetail {
    /**
     * Constructs a new <code>MailboxDetail</code>.
     * @alias module:model/MailboxDetail
     */
    constructor() { 
        
        MailboxDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MailboxDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MailboxDetail} obj Optional instance to populate.
     * @return {module:model/MailboxDetail} The populated <code>MailboxDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MailboxDetail();

            if (data.hasOwnProperty('actual_size')) {
                obj['actual_size'] = ApiClient.convertToType(data['actual_size'], 'Number');
            }
            if (data.hasOwnProperty('auto_forward')) {
                obj['auto_forward'] = AutoForward.constructFromObject(data['auto_forward']);
            }
            if (data.hasOwnProperty('auto_reply')) {
                obj['auto_reply'] = AutoReply.constructFromObject(data['auto_reply']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MailboxDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MailboxDetail</code>.
     */
    static validateJSON(data) {
        // validate the optional field `auto_forward`
        if (data['auto_forward']) { // data not null
          AutoForward.validateJSON(data['auto_forward']);
        }
        // validate the optional field `auto_reply`
        if (data['auto_reply']) { // data not null
          AutoReply.validateJSON(data['auto_reply']);
        }
 ...
 */
MailboxDetail.prototype['actual_size'] = undefined;

/**
 * @member {module:model/AutoForward} auto_forward
 */
MailboxDetail.prototype['auto_forward'] = undefined;

/**
 * @member {module:model/AutoReply} auto_reply
 */
MailboxDetail.prototype['auto_reply'] = undefined;

/**
 * Login to connect with the mailbox
 * @member {String} login
 */
MailboxDetail.prototype['login'] = undefined;

/**
 * Maximum size in MB
 * @member {Number} max_size
 */
MailboxDetail.prototype['max_size'] = undefined;

/**
 * @member {String} name
 */
MailboxDetail.prototype['name'] = undefined;
