...
/**
 * The UpdatePhpMemoryLimitRequest model module.
 * @module model/UpdatePhpMemoryLimitRequest
 * @version v2
 */
class UpdatePhpMemoryLimitRequest {
    /**
     * Constructs a new <code>UpdatePhpMemoryLimitRequest</code>.
     * @alias module:model/UpdatePhpMemoryLimitRequest
     */
    constructor() { 
        
        UpdatePhpMemoryLimitRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePhpMemoryLimitRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePhpMemoryLimitRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePhpMemoryLimitRequest} The populated <code>UpdatePhpMemoryLimitRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePhpMemoryLimitRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePhpMemoryLimitRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePhpMemoryLimitRequest</code>.
     */
 ...
 */
UpdatePhpMemoryLimitRequest.prototype['memory_limit'] = undefined;
...
export default UpdatePhpMemoryLimitRequest;
