...
/**
 * The UpdateMailboxPasswordRequest model module.
 * @module model/UpdateMailboxPasswordRequest
 * @version v2
 */
class UpdateMailboxPasswordRequest {
    /**
     * Constructs a new <code>UpdateMailboxPasswordRequest</code>.
     * @alias module:model/UpdateMailboxPasswordRequest
     */
    constructor() { 
        
        UpdateMailboxPasswordRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateMailboxPasswordRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMailboxPasswordRequest} obj Optional instance to populate.
     * @return {module:model/UpdateMailboxPasswordRequest} The populated <code>UpdateMailboxPasswordRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMailboxPasswordRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMailboxPasswordRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMailboxPasswordRequest</code>.
     */
 ...
 */
UpdateMailboxPasswordRequest.prototype['password'] = undefined;
...
export default UpdateMailboxPasswordRequest;
