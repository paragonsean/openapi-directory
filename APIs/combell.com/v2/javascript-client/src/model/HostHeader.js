...
/**
 * The HostHeader model module.
 * @module model/HostHeader
 * @version v2
 */
class HostHeader {
    /**
     * Constructs a new <code>HostHeader</code>.
     * A host header identifies a web domain.
     * @alias module:model/HostHeader
     */
    constructor() { 
        
        HostHeader.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HostHeader</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HostHeader} obj Optional instance to populate.
     * @return {module:model/HostHeader} The populated <code>HostHeader</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HostHeader();
    ...
    /**
     * Validates the JSON data with respect to <code>HostHeader</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HostHeader</code>.
     */
 ...
 */
HostHeader.prototype['enabled'] = undefined;

/**
 * The name of the host header.
 * @member {String} name
 */
HostHeader.prototype['name'] = undefined;
