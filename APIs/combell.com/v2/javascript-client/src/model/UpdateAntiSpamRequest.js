...
import AntiSpamTypes from './AntiSpamTypes';

/**
 * The UpdateAntiSpamRequest model module.
 * @module model/UpdateAntiSpamRequest
 * @version v2
 */
class UpdateAntiSpamRequest {
    /**
     * Constructs a new <code>UpdateAntiSpamRequest</code>.
     * @alias module:model/UpdateAntiSpamRequest
     */
    constructor() { 
        
        UpdateAntiSpamRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAntiSpamRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAntiSpamRequest} obj Optional instance to populate.
     * @return {module:model/UpdateAntiSpamRequest} The populated <code>UpdateAntiSpamRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAntiSpamRequest();

            if (data.hasOwnProperty('type')) {
                obj['type'] = AntiSpamTypes.constructFromObject(data['type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAntiSpamRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAntiSpamRequest</code>.
     */
...
/**
 * @member {module:model/AntiSpamTypes} type
 */
UpdateAntiSpamRequest.prototype['type'] = undefined;
...
export default UpdateAntiSpamRequest;
