...
/**
 * The AddHostHeaderRequest model module.
 * @module model/AddHostHeaderRequest
 * @version v2
 */
class AddHostHeaderRequest {
    /**
     * Constructs a new <code>AddHostHeaderRequest</code>.
     * @alias module:model/AddHostHeaderRequest
     */
    constructor() { 
        
        AddHostHeaderRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddHostHeaderRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddHostHeaderRequest} obj Optional instance to populate.
     * @return {module:model/AddHostHeaderRequest} The populated <code>AddHostHeaderRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddHostHeaderRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddHostHeaderRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddHostHeaderRequest</code>.
     */
 ...
 */
AddHostHeaderRequest.prototype['domain_name'] = undefined;
...
export default AddHostHeaderRequest;
