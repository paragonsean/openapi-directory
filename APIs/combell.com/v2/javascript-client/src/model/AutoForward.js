...
/**
 * The AutoForward model module.
 * @module model/AutoForward
 * @version v2
 */
class AutoForward {
    /**
     * Constructs a new <code>AutoForward</code>.
     * @alias module:model/AutoForward
     */
    constructor() { 
        
        AutoForward.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AutoForward</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoForward} obj Optional instance to populate.
     * @return {module:model/AutoForward} The populated <code>AutoForward</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoForward();

            if (data.hasOwnProperty('copy_to_myself')) {
                obj['copy_to_myself'] = ApiClient.convertToType(data['copy_to_myself'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AutoForward</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoForward</code>.
     */
...
/**
 * Copy to myself
 * @member {Boolean} copy_to_myself
 */
AutoForward.prototype['copy_to_myself'] = undefined;

/**
 * E-mail addresses to which e-mails are forwarded
 * @member {Array.<String>} email_addresses
 */
AutoForward.prototype['email_addresses'] = undefined;

/**
 * Enabled
 * @member {Boolean} enabled
 */
AutoForward.prototype['enabled'] = undefined;
