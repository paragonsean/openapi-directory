...
import SslCertificateVendor from './SslCertificateVendor';

/**
 * The SslCertificateRequest model module.
 * @module model/SslCertificateRequest
 * @version v2
 */
class SslCertificateRequest {
    /**
     * Constructs a new <code>SslCertificateRequest</code>.
     * @alias module:model/SslCertificateRequest
     */
    constructor() { 
        
        SslCertificateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SslCertificateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SslCertificateRequest} obj Optional instance to populate.
     * @return {module:model/SslCertificateRequest} The populated <code>SslCertificateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SslCertificateRequest();
            ...
            if (data.hasOwnProperty('vendor')) {
                obj['vendor'] = SslCertificateVendor.constructFromObject(data['vendor']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SslCertificateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SslCertificateRequest</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['order_code'] && !(typeof data['order_code'] === 'string' || data['order_code'] instanceof String)) {
            throw new Error("Expected the field `order_code` to be a primitive type in the JSON string but got " + data['order_code']);
        }
 ...
 */
SslCertificateRequest.prototype['certificate_type'] = undefined;

/**
 * The common name of the certificate request.
 * @member {String} common_name
 */
SslCertificateRequest.prototype['common_name'] = undefined;

/**
 * The id of the certificate request.
 * @member {Number} id
 */
SslCertificateRequest.prototype['id'] = undefined;

/**
 * The order code of the certificate request.
 * @member {String} order_code
 */
SslCertificateRequest.prototype['order_code'] = undefined;

/**
 * @member {module:model/SslCertificateValidationLevel} validation_level
 */
SslCertificateRequest.prototype['validation_level'] = undefined;

/**
 * @member {module:model/SslCertificateVendor} vendor
 */
SslCertificateRequest.prototype['vendor'] = undefined;
...
export default SslCertificateRequest;
