...
import ProvisioningJobStatus from './ProvisioningJobStatus';

/**
 * The ProvisioningJobInfo model module.
 * @module model/ProvisioningJobInfo
 * @version v2
 */
class ProvisioningJobInfo {
    /**
     * Constructs a new <code>ProvisioningJobInfo</code>.
     * @alias module:model/ProvisioningJobInfo
     */
    constructor() { 
        
        ProvisioningJobInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProvisioningJobInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProvisioningJobInfo} obj Optional instance to populate.
     * @return {module:model/ProvisioningJobInfo} The populated <code>ProvisioningJobInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvisioningJobInfo();

            if (data.hasOwnProperty('completion')) {
                obj['completion'] = CompletionEstimation.constructFromObject(data['completion']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ProvisioningJobStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProvisioningJobInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProvisioningJobInfo</code>.
     */
    static validateJSON(data) {
        // validate the optional field `completion`
        if (data['completion']) { // data not null
          CompletionEstimation.validateJSON(data['completion']);
        }
...
/**
 * @member {module:model/CompletionEstimation} completion
 */
ProvisioningJobInfo.prototype['completion'] = undefined;

/**
 * The id of the job.
 * @member {String} id
 */
ProvisioningJobInfo.prototype['id'] = undefined;

/**
 * @member {module:model/ProvisioningJobStatus} status
 */
ProvisioningJobInfo.prototype['status'] = undefined;
...
export default ProvisioningJobInfo;
