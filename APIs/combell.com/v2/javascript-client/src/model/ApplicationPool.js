...
/**
 * The ApplicationPool model module.
 * @module model/ApplicationPool
 * @version v2
 */
class ApplicationPool {
    /**
     * Constructs a new <code>ApplicationPool</code>.
     * The application pool for the hosting account.
     * @alias module:model/ApplicationPool
     */
    constructor() { 
        
        ApplicationPool.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApplicationPool</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationPool} obj Optional instance to populate.
     * @return {module:model/ApplicationPool} The populated <code>ApplicationPool</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationPool();

            if (data.hasOwnProperty('installed_net_core_runtimes')) {
                obj['installed_net_core_runtimes'] = ApiClient.convertToType(data['installed_net_core_runtimes'], ['String']);
            }
            if (data.hasOwnProperty('pipeline_mode')) {
                obj['pipeline_mode'] = ApiClient.convertToType(data['pipeline_mode'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationPool</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationPool</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['installed_net_core_runtimes'])) {
            throw new Error("Expected the field `installed_net_core_runtimes` to be an array in the JSON data but got " + data['installed_net_core_runtimes']);
        }
        // ensure the json data is a string
        if (data['pipeline_mode'] && !(typeof data['pipeline_mode'] === 'string' || data['pipeline_mode'] instanceof String)) {
            throw new Error("Expected the field `pipeline_mode` to be a primitive type in the JSON string but got " + data['pipeline_mode']);
        }
        // ensure the json data is a string
 ...
 * @member {Array.<String>} installed_net_core_runtimes
 */
ApplicationPool.prototype['installed_net_core_runtimes'] = undefined;

/**
 * The active pipeline mode for the hosting account.
 * @member {String} pipeline_mode
 */
ApplicationPool.prototype['pipeline_mode'] = undefined;

/**
 * The active runtime for the hosting account.
 * @member {String} runtime
 */
ApplicationPool.prototype['runtime'] = undefined;
