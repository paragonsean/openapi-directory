...
/**
 * The EditNameServers model module.
 * @module model/EditNameServers
 * @version v2
 */
class EditNameServers {
    /**
     * Constructs a new <code>EditNameServers</code>.
     * @alias module:model/EditNameServers
     */
    constructor() { 
        
        EditNameServers.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EditNameServers</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EditNameServers} obj Optional instance to populate.
     * @return {module:model/EditNameServers} The populated <code>EditNameServers</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EditNameServers();
    ...
    /**
     * Validates the JSON data with respect to <code>EditNameServers</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EditNameServers</code>.
     */
 ...
 */
EditNameServers.prototype['domain_name'] = undefined;

/**
 * List of name servers.
 * @member {Array.<String>} name_servers
 */
EditNameServers.prototype['name_servers'] = undefined;
