...
class ScheduledTask {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('script_location')) {
                obj['script_location'] = ApiClient.convertToType(data['script_location'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduledTask</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduledTask</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['script_location'] && !(typeof data['script_location'] === 'string' || data['script_location'] instanceof String)) {
            throw new Error("Expected the field `script_location` to be a primitive type in the JSON string but got " + data['script_location']);
        }
 ...
 */
ScheduledTask.prototype['cron_expression'] = undefined;

/**
 * Enabled.
 * @member {Boolean} enabled
 */
ScheduledTask.prototype['enabled'] = undefined;
 ...
 * @member {String} script_location
 */
ScheduledTask.prototype['script_location'] = undefined;
