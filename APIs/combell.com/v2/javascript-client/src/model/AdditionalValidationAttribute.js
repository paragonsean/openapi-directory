...
/**
 * The AdditionalValidationAttribute model module.
 * @module model/AdditionalValidationAttribute
 * @version v2
 */
class AdditionalValidationAttribute {
    /**
     * Constructs a new <code>AdditionalValidationAttribute</code>.
     * @alias module:model/AdditionalValidationAttribute
     */
    constructor() { 
        
        AdditionalValidationAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdditionalValidationAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdditionalValidationAttribute} obj Optional instance to populate.
     * @return {module:model/AdditionalValidationAttribute} The populated <code>AdditionalValidationAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdditionalValidationAttribute();
    ...
    /**
     * Validates the JSON data with respect to <code>AdditionalValidationAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdditionalValidationAttribute</code>.
     */
 ...
 * @member {String} name
 */
AdditionalValidationAttribute.prototype['name'] = undefined;

/**
 * Additional validation attribute field value.
 * @member {String} value
 */
AdditionalValidationAttribute.prototype['value'] = undefined;
...
export default AdditionalValidationAttribute;
