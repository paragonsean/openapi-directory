 ...
 */
MySqlDatabase.prototype['account_id'] = undefined;

/**
 * The actual size in MB for the database.
 * @member {Number} actual_size
 */
MySqlDatabase.prototype['actual_size'] = undefined;

/**
 * Hostname
 * @member {String} hostname
 */
MySqlDatabase.prototype['hostname'] = undefined;

/**
 * The maximim size in MB for the database.
 * @member {Number} max_size
 */
MySqlDatabase.prototype['max_size'] = undefined;

/**
 * Database name
 * @member {String} name
 */
MySqlDatabase.prototype['name'] = undefined;

/**
 * The number of users.
 * @member {Number} user_count
 */
MySqlDatabase.prototype['user_count'] = undefined;
