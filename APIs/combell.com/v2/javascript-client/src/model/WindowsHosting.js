...
/**
 * The WindowsHosting model module.
 * @module model/WindowsHosting
 * @version v2
 */
class WindowsHosting {
    /**
     * Constructs a new <code>WindowsHosting</code>.
     * @alias module:model/WindowsHosting
     */
    constructor() { 
        
        WindowsHosting.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WindowsHosting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WindowsHosting} obj Optional instance to populate.
     * @return {module:model/WindowsHosting} The populated <code>WindowsHosting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WindowsHosting();
    ...
    /**
     * Validates the JSON data with respect to <code>WindowsHosting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WindowsHosting</code>.
     */
 ...
 */
WindowsHosting.prototype['domain_name'] = undefined;

/**
 * Id of Windows hosting service package.
 * @member {Number} servicepack_id
 */
WindowsHosting.prototype['servicepack_id'] = undefined;
