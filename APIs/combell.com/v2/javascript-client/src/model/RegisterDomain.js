...
/**
 * The RegisterDomain model module.
 * @module model/RegisterDomain
 * @version v2
 */
class RegisterDomain {
    /**
     * Constructs a new <code>RegisterDomain</code>.
     * @alias module:model/RegisterDomain
     */
    constructor() { 
        
        RegisterDomain.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterDomain</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterDomain} obj Optional instance to populate.
     * @return {module:model/RegisterDomain} The populated <code>RegisterDomain</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterDomain();
            ...
            if (data.hasOwnProperty('registrant')) {
                obj['registrant'] = RegistrantInput.constructFromObject(data['registrant']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterDomain</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterDomain</code>.
     */
    static validateJSON(data) {
        ...
        if (data['registrant']) { // data not null
          RegistrantInput.validateJSON(data['registrant']);
        }
 ...
 */
RegisterDomain.prototype['domain_name'] = undefined;

/**
 * List of name servers. When empty, the registation will be done on default name servers.
 * @member {Array.<String>} name_servers
 */
RegisterDomain.prototype['name_servers'] = undefined;

/**
 * @member {module:model/RegistrantInput} registrant
 */
RegisterDomain.prototype['registrant'] = undefined;
