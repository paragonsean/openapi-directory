...
/**
 * The TransferDomain model module.
 * @module model/TransferDomain
 * @version v2
 */
class TransferDomain {
    /**
     * Constructs a new <code>TransferDomain</code>.
     * @alias module:model/TransferDomain
     */
    constructor() { 
        
        TransferDomain.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TransferDomain</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransferDomain} obj Optional instance to populate.
     * @return {module:model/TransferDomain} The populated <code>TransferDomain</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransferDomain();
    ...
    /**
     * Validates the JSON data with respect to <code>TransferDomain</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransferDomain</code>.
     */
 ...
 */
TransferDomain.prototype['auth_code'] = undefined;
