...
class SslCertificate {
    ...
    constructor() { 
        ...
        SslCertificate.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SslCertificate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SslCertificate</code>.
     */
 ...
 */
SslCertificate.prototype['common_name'] = undefined;

/**
 * The exact time the certificate will expire.
 * @member {Date} expires_after
 */
SslCertificate.prototype['expires_after'] = undefined;
 ...
 */
SslCertificate.prototype['sha1_fingerprint'] = undefined;

/**
 * @member {module:model/SslCertificateType} type
 */
SslCertificate.prototype['type'] = undefined;

/**
 * @member {module:model/SslCertificateValidationLevel} validation_level
 */
SslCertificate.prototype['validation_level'] = undefined;
