...
/**
 * The CompletionEstimation model module.
 * @module model/CompletionEstimation
 * @version v2
 */
class CompletionEstimation {
    /**
     * Constructs a new <code>CompletionEstimation</code>.
     * @alias module:model/CompletionEstimation
     */
    constructor() { 
        
        CompletionEstimation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompletionEstimation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompletionEstimation} obj Optional instance to populate.
     * @return {module:model/CompletionEstimation} The populated <code>CompletionEstimation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompletionEstimation();

            if (data.hasOwnProperty('estimate')) {
                obj['estimate'] = ApiClient.convertToType(data['estimate'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CompletionEstimation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompletionEstimation</code>.
     */
 ...
 * @member {Date} estimate
 */
CompletionEstimation.prototype['estimate'] = undefined;
...
export default CompletionEstimation;
