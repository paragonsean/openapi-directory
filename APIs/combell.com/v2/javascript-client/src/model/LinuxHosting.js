...
/**
 * The LinuxHosting model module.
 * @module model/LinuxHosting
 * @version v2
 */
class LinuxHosting {
    /**
     * Constructs a new <code>LinuxHosting</code>.
     * @alias module:model/LinuxHosting
     */
    constructor() { 
        
        LinuxHosting.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LinuxHosting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LinuxHosting} obj Optional instance to populate.
     * @return {module:model/LinuxHosting} The populated <code>LinuxHosting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LinuxHosting();
    ...
    /**
     * Validates the JSON data with respect to <code>LinuxHosting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LinuxHosting</code>.
     */
 ...
 */
LinuxHosting.prototype['domain_name'] = undefined;

/**
 * Id of Linux hosting service package.
 * @member {Number} servicepack_id
 */
LinuxHosting.prototype['servicepack_id'] = undefined;
