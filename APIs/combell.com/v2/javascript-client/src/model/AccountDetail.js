...
class AccountDetail {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('servicepack')) {
                obj['servicepack'] = Servicepack.constructFromObject(data['servicepack']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['servicepack']) { // data not null
          Servicepack.validateJSON(data['servicepack']);
        }
 ...
 */
AccountDetail.prototype['addons'] = undefined;

/**
 * The id of the account
 * @member {Number} id
 */
AccountDetail.prototype['id'] = undefined;

/**
 * Identifier for the account
 * @member {String} identifier
 */
AccountDetail.prototype['identifier'] = undefined;

/**
 * @member {module:model/Servicepack} servicepack
 */
AccountDetail.prototype['servicepack'] = undefined;
