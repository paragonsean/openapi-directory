...
/**
 * The EditDomainWillRenewRequest model module.
 * @module model/EditDomainWillRenewRequest
 * @version v2
 */
class EditDomainWillRenewRequest {
    /**
     * Constructs a new <code>EditDomainWillRenewRequest</code>.
     * @alias module:model/EditDomainWillRenewRequest
     */
    constructor() { 
        
        EditDomainWillRenewRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EditDomainWillRenewRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EditDomainWillRenewRequest} obj Optional instance to populate.
     * @return {module:model/EditDomainWillRenewRequest} The populated <code>EditDomainWillRenewRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EditDomainWillRenewRequest();

            if (data.hasOwnProperty('will_renew')) {
                obj['will_renew'] = ApiClient.convertToType(data['will_renew'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EditDomainWillRenewRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EditDomainWillRenewRequest</code>.
     */
 ...
 * @member {Boolean} will_renew
 */
EditDomainWillRenewRequest.prototype['will_renew'] = undefined;
...
export default EditDomainWillRenewRequest;
