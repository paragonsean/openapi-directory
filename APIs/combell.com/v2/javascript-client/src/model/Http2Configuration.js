...
/**
 * The Http2Configuration model module.
 * @module model/Http2Configuration
 * @version v2
 */
class Http2Configuration {
    /**
     * Constructs a new <code>Http2Configuration</code>.
     * @alias module:model/Http2Configuration
     */
    constructor() { 
        
        Http2Configuration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Http2Configuration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Http2Configuration} obj Optional instance to populate.
     * @return {module:model/Http2Configuration} The populated <code>Http2Configuration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Http2Configuration();
    ...
    /**
     * Validates the JSON data with respect to <code>Http2Configuration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Http2Configuration</code>.
     */
 ...
 */
Http2Configuration.prototype['enabled'] = undefined;
...
export default Http2Configuration;
