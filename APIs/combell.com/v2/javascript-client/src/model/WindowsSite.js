...
/**
 * The WindowsSite model module.
 * @module model/WindowsSite
 * @version v2
 */
class WindowsSite {
    /**
     * Constructs a new <code>WindowsSite</code>.
     * @alias module:model/WindowsSite
     */
    constructor() { 
        
        WindowsSite.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WindowsSite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WindowsSite} obj Optional instance to populate.
     * @return {module:model/WindowsSite} The populated <code>WindowsSite</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WindowsSite();

            if (data.hasOwnProperty('bindings')) {
                obj['bindings'] = ApiClient.convertToType(data['bindings'], [SiteBinding]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WindowsSite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WindowsSite</code>.
     */
 ...
 * @member {Array.<module:model/SiteBinding>} bindings
 */
WindowsSite.prototype['bindings'] = undefined;

/**
 * The name of the website.
 * @member {String} name
 */
WindowsSite.prototype['name'] = undefined;

/**
 * The path of the website.
 * @member {String} path
 */
WindowsSite.prototype['path'] = undefined;
