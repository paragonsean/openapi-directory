...
/**
 * The AddSubsiteRequest model module.
 * @module model/AddSubsiteRequest
 * @version v2
 */
class AddSubsiteRequest {
    /**
     * Constructs a new <code>AddSubsiteRequest</code>.
     * @alias module:model/AddSubsiteRequest
     */
    constructor() { 
        
        AddSubsiteRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddSubsiteRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddSubsiteRequest} obj Optional instance to populate.
     * @return {module:model/AddSubsiteRequest} The populated <code>AddSubsiteRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddSubsiteRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddSubsiteRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddSubsiteRequest</code>.
     */
 ...
 */
AddSubsiteRequest.prototype['domain_name'] = undefined;
 ...
 * @member {String} path
 */
AddSubsiteRequest.prototype['path'] = undefined;
...
export default AddSubsiteRequest;
