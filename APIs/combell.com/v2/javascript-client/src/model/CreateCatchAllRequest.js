...
/**
 * The CreateCatchAllRequest model module.
 * @module model/CreateCatchAllRequest
 * @version v2
 */
class CreateCatchAllRequest {
    /**
     * Constructs a new <code>CreateCatchAllRequest</code>.
     * @alias module:model/CreateCatchAllRequest
     */
    constructor() { 
        
        CreateCatchAllRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCatchAllRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCatchAllRequest} obj Optional instance to populate.
     * @return {module:model/CreateCatchAllRequest} The populated <code>CreateCatchAllRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCatchAllRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCatchAllRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCatchAllRequest</code>.
     */
 ...
 */
CreateCatchAllRequest.prototype['email_address'] = undefined;
...
export default CreateCatchAllRequest;
