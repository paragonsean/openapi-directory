...
class Mailbox {
    ...
    /**
     * Validates the JSON data with respect to <code>Mailbox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Mailbox</code>.
     */
 ...
 */
Mailbox.prototype['actual_size'] = undefined;

/**
 * Maximum size in MB
 * @member {Number} max_size
 */
Mailbox.prototype['max_size'] = undefined;

/**
 * @member {String} name
 */
Mailbox.prototype['name'] = undefined;
