...
/**
 * The PhpVersion model module.
 * @module model/PhpVersion
 * @version v2
 */
class PhpVersion {
    /**
     * Constructs a new <code>PhpVersion</code>.
     * @alias module:model/PhpVersion
     */
    constructor() { 
        
        PhpVersion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PhpVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PhpVersion} obj Optional instance to populate.
     * @return {module:model/PhpVersion} The populated <code>PhpVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PhpVersion();
    ...
    /**
     * Validates the JSON data with respect to <code>PhpVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PhpVersion</code>.
     */
 ...
 */
PhpVersion.prototype['version'] = undefined;
