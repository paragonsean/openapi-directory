...
import SslSubjectAltNameType from './SslSubjectAltNameType';

/**
 * The SslSubjectAltName model module.
 * @module model/SslSubjectAltName
 * @version v2
 */
class SslSubjectAltName {
    /**
     * Constructs a new <code>SslSubjectAltName</code>.
     * @alias module:model/SslSubjectAltName
     */
    constructor() { 
        
        SslSubjectAltName.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SslSubjectAltName</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SslSubjectAltName} obj Optional instance to populate.
     * @return {module:model/SslSubjectAltName} The populated <code>SslSubjectAltName</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SslSubjectAltName();

            if (data.hasOwnProperty('type')) {
                obj['type'] = SslSubjectAltNameType.constructFromObject(data['type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SslSubjectAltName</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SslSubjectAltName</code>.
     */
...
/**
 * @member {module:model/SslSubjectAltNameType} type
 */
SslSubjectAltName.prototype['type'] = undefined;

/**
 * The value of the alt name.
 * @member {String} value
 */
SslSubjectAltName.prototype['value'] = undefined;
...
export default SslSubjectAltName;
