...
/**
 * The SmtpDomain model module.
 * @module model/SmtpDomain
 * @version v2
 */
class SmtpDomain {
    /**
     * Constructs a new <code>SmtpDomain</code>.
     * @alias module:model/SmtpDomain
     */
    constructor() { 
        
        SmtpDomain.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SmtpDomain</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SmtpDomain} obj Optional instance to populate.
     * @return {module:model/SmtpDomain} The populated <code>SmtpDomain</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SmtpDomain();
    ...
    /**
     * Validates the JSON data with respect to <code>SmtpDomain</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SmtpDomain</code>.
     */
 ...
 */
SmtpDomain.prototype['enabled'] = undefined;

/**
 * The smtp domain name
 * @member {String} hostname
 */
SmtpDomain.prototype['hostname'] = undefined;
