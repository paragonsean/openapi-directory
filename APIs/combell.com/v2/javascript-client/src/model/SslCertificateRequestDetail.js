...
/**
 * The SslCertificateRequestDetail model module.
 * @module model/SslCertificateRequestDetail
 * @version v2
 */
class SslCertificateRequestDetail {
    /**
     * Constructs a new <code>SslCertificateRequestDetail</code>.
     * @alias module:model/SslCertificateRequestDetail
     */
    constructor() { 
        
        SslCertificateRequestDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SslCertificateRequestDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SslCertificateRequestDetail} obj Optional instance to populate.
     * @return {module:model/SslCertificateRequestDetail} The populated <code>SslCertificateRequestDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SslCertificateRequestDetail();
            ...
            if (data.hasOwnProperty('validations')) {
                obj['validations'] = ApiClient.convertToType(data['validations'], [SslCertificateRequestValidation]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SslCertificateRequestDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SslCertificateRequestDetail</code>.
     */
    static validateJSON(data) {
        ...
        if (data['validations']) { // data not null
            ...
            for (const item of data['validations']) {
                SslCertificateRequestValidation.validateJSON(item);
            };
        }
 ...
 */
SslCertificateRequestDetail.prototype['certificate_type'] = undefined;

/**
 * The common name of the certificate request.
 * @member {String} common_name
 */
SslCertificateRequestDetail.prototype['common_name'] = undefined;

/**
 * The id of the certificate request.
 * @member {Number} id
 */
SslCertificateRequestDetail.prototype['id'] = undefined;

/**
 * The order code of the certificate request.
 * @member {String} order_code
 */
SslCertificateRequestDetail.prototype['order_code'] = undefined;

/**
 * The list of all supported domains in the certificate.
 * @member {Array.<module:model/SslSubjectAltName>} subject_alt_names
 */
SslCertificateRequestDetail.prototype['subject_alt_names'] = undefined;

/**
 * @member {module:model/SslCertificateValidationLevel} validation_level
 */
SslCertificateRequestDetail.prototype['validation_level'] = undefined;

/**
 * The list of dns names to be validated with the information related to domain verification.
 * @member {Array.<module:model/SslCertificateRequestValidation>} validations
 */
SslCertificateRequestDetail.prototype['validations'] = undefined;

/**
 * @member {module:model/SslCertificateVendor} vendor
 */
SslCertificateRequestDetail.prototype['vendor'] = undefined;
...
export default SslCertificateRequestDetail;
