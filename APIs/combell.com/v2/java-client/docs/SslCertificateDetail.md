...
|**expiresAfter** | **OffsetDateTime** | The exact time the certificate will expire. |  [optional] |
...
|**subjectAltNames** | [**List&lt;SslSubjectAltName&gt;**](SslSubjectAltName.md) | The list of all supported dns names in the certificate. |  [optional] |
