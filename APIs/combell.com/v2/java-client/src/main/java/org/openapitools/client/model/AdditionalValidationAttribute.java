...
public class AdditionalValidationAttribute {
  ...
  public AdditionalValidationAttribute name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AdditionalValidationAttribute value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdditionalValidationAttribute additionalValidationAttribute = (AdditionalValidationAttribute) o;
    return Objects.equals(this.name, additionalValidationAttribute.name) &&
        Objects.equals(this.value, additionalValidationAttribute.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdditionalValidationAttribute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdditionalValidationAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdditionalValidationAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdditionalValidationAttribute is not found in the empty JSON string", AdditionalValidationAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdditionalValidationAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdditionalValidationAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdditionalValidationAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdditionalValidationAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdditionalValidationAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdditionalValidationAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<AdditionalValidationAttribute>() {
           @Override
           public void write(JsonWriter out, AdditionalValidationAttribute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdditionalValidationAttribute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdditionalValidationAttribute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdditionalValidationAttribute
   * @throws IOException if the JSON string is invalid with respect to AdditionalValidationAttribute
   */
  public static AdditionalValidationAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdditionalValidationAttribute.class);
  }

  /**
   * Convert an instance of AdditionalValidationAttribute to an JSON string
   *
   * @return JSON string
   */
