...
public class LetsEncryptConfig {
  ...
  public LetsEncryptConfig enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    LetsEncryptConfig letsEncryptConfig = (LetsEncryptConfig) o;
    return Objects.equals(this.enabled, letsEncryptConfig.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class LetsEncryptConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LetsEncryptConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LetsEncryptConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LetsEncryptConfig is not found in the empty JSON string", LetsEncryptConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LetsEncryptConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LetsEncryptConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LetsEncryptConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LetsEncryptConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LetsEncryptConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LetsEncryptConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<LetsEncryptConfig>() {
           @Override
           public void write(JsonWriter out, LetsEncryptConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LetsEncryptConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LetsEncryptConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LetsEncryptConfig
   * @throws IOException if the JSON string is invalid with respect to LetsEncryptConfig
   */
  public static LetsEncryptConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LetsEncryptConfig.class);
  }

  /**
   * Convert an instance of LetsEncryptConfig to an JSON string
   *
   * @return JSON string
   */
