...
public class CompletionEstimation {
  ...
  public CompletionEstimation estimate(OffsetDateTime estimate) {
  ...
  public OffsetDateTime getEstimate() {
    return estimate;
  }

  public void setEstimate(OffsetDateTime estimate) {
    this.estimate = estimate;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompletionEstimation completionEstimation = (CompletionEstimation) o;
    return Objects.equals(this.estimate, completionEstimation.estimate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompletionEstimation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompletionEstimation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompletionEstimation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompletionEstimation is not found in the empty JSON string", CompletionEstimation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompletionEstimation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompletionEstimation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompletionEstimation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompletionEstimation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompletionEstimation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompletionEstimation.class));

       return (TypeAdapter<T>) new TypeAdapter<CompletionEstimation>() {
           @Override
           public void write(JsonWriter out, CompletionEstimation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompletionEstimation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompletionEstimation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompletionEstimation
   * @throws IOException if the JSON string is invalid with respect to CompletionEstimation
   */
  public static CompletionEstimation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompletionEstimation.class);
  }

  /**
   * Convert an instance of CompletionEstimation to an JSON string
   *
   * @return JSON string
   */
