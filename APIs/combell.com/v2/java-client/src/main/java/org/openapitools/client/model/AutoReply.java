...
public class AutoReply {
  ...
  public AutoReply enabled(Boolean enabled) {
  ...
  public AutoReply message(String message) {
  ...
  public AutoReply subject(String subject) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, autoReply.enabled) &&
        Objects.equals(this.message, autoReply.message) &&
        Objects.equals(this.subject, autoReply.subject);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, message, subject);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AutoReply {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoReply
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoReply.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoReply is not found in the empty JSON string", AutoReply.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoReply.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoReply` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoReply.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoReply' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoReply> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoReply.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoReply>() {
           @Override
           public void write(JsonWriter out, AutoReply value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoReply read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoReply given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoReply
   * @throws IOException if the JSON string is invalid with respect to AutoReply
   */
  public static AutoReply fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoReply.class);
  }

  /**
   * Convert an instance of AutoReply to an JSON string
   *
   * @return JSON string
   */
