 ...
 */
@JsonAdapter(LinuxIpType.Adapter.class)
public enum LinuxIpType {
  ...
  public static LinuxIpType fromValue(String value) {
    for (LinuxIpType b : LinuxIpType.values()) {
  ...
  public static class Adapter extends TypeAdapter<LinuxIpType> {
    @Override
    public void write(final JsonWriter jsonWriter, final LinuxIpType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LinuxIpType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LinuxIpType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LinuxIpType.fromValue(value);
  }
}
