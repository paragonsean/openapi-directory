...
public class Servicepack {
  ...
  public Servicepack id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Servicepack name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Servicepack servicepack = (Servicepack) o;
    return Objects.equals(this.id, servicepack.id) &&
        Objects.equals(this.name, servicepack.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Servicepack
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Servicepack.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Servicepack is not found in the empty JSON string", Servicepack.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Servicepack.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Servicepack` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Servicepack.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Servicepack' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Servicepack> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Servicepack.class));

       return (TypeAdapter<T>) new TypeAdapter<Servicepack>() {
           @Override
           public void write(JsonWriter out, Servicepack value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Servicepack read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Servicepack given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Servicepack
   * @throws IOException if the JSON string is invalid with respect to Servicepack
   */
  public static Servicepack fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Servicepack.class);
  }

  /**
   * Convert an instance of Servicepack to an JSON string
   *
   * @return JSON string
   */
