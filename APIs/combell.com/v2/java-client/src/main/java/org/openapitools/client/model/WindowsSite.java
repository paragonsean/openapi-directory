...
import org.openapitools.client.model.SiteBinding;
...
public class WindowsSite {
  ...
  private List<SiteBinding> bindings = new ArrayList<>();
  ...
  public WindowsSite bindings(List<SiteBinding> bindings) {
    this.bindings = bindings;
    return this;
  }

  public WindowsSite addBindingsItem(SiteBinding bindingsItem) {
  ...
  public List<SiteBinding> getBindings() {
    return bindings;
  }

  public void setBindings(List<SiteBinding> bindings) {
    this.bindings = bindings;
  }


  public WindowsSite name(String name) {
    this.name = name;
    return this;
  }
  ...
  public WindowsSite path(String path) {
    this.path = path;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WindowsSite windowsSite = (WindowsSite) o;
    return Objects.equals(this.bindings, windowsSite.bindings) &&
        Objects.equals(this.name, windowsSite.name) &&
        Objects.equals(this.path, windowsSite.path);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bindings, name, path);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WindowsSite {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WindowsSite
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WindowsSite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WindowsSite is not found in the empty JSON string", WindowsSite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WindowsSite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WindowsSite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bindings") != null && !jsonObj.get("bindings").isJsonNull()) {
        ...
        if (jsonArraybindings != null) {
          ...
          for (int i = 0; i < jsonArraybindings.size(); i++) {
            SiteBinding.validateJsonElement(jsonArraybindings.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WindowsSite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WindowsSite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WindowsSite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WindowsSite.class));

       return (TypeAdapter<T>) new TypeAdapter<WindowsSite>() {
           @Override
           public void write(JsonWriter out, WindowsSite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WindowsSite read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WindowsSite given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WindowsSite
   * @throws IOException if the JSON string is invalid with respect to WindowsSite
   */
  public static WindowsSite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WindowsSite.class);
  }

  /**
   * Convert an instance of WindowsSite to an JSON string
   *
   * @return JSON string
   */
