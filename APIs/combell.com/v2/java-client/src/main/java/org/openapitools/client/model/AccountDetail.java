...
public class AccountDetail {
  ...
  public static final String SERIALIZED_NAME_SERVICEPACK = "servicepack";
  @SerializedName(SERIALIZED_NAME_SERVICEPACK)
  private Servicepack servicepack;

  public AccountDetail() {
  }

  public AccountDetail addons(List<Addon> addons) {
    this.addons = addons;
    return this;
  }

  public AccountDetail addAddonsItem(Addon addonsItem) {
    if (this.addons == null) {
  ...
  public AccountDetail id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AccountDetail identifier(String identifier) {
  ...
  public AccountDetail servicepack(Servicepack servicepack) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addons, accountDetail.addons) &&
        Objects.equals(this.id, accountDetail.id) &&
        Objects.equals(this.identifier, accountDetail.identifier) &&
        Objects.equals(this.servicepack, accountDetail.servicepack);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addons, id, identifier, servicepack);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountDetail is not found in the empty JSON string", AccountDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("servicepack") != null && !jsonObj.get("servicepack").isJsonNull()) {
        Servicepack.validateJsonElement(jsonObj.get("servicepack"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountDetail>() {
           @Override
           public void write(JsonWriter out, AccountDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountDetail
   * @throws IOException if the JSON string is invalid with respect to AccountDetail
   */
  public static AccountDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountDetail.class);
  }

  /**
   * Convert an instance of AccountDetail to an JSON string
   *
   * @return JSON string
   */
