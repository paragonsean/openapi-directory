...
import org.openapitools.client.model.UserRights;
...
public class MySqlUser {
  ...
  public MySqlUser enabled(Boolean enabled) {
  ...
  public MySqlUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MySqlUser rights(UserRights rights) {
    this.rights = rights;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MySqlUser mySqlUser = (MySqlUser) o;
    return Objects.equals(this.enabled, mySqlUser.enabled) &&
        Objects.equals(this.name, mySqlUser.name) &&
        Objects.equals(this.rights, mySqlUser.rights);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, name, rights);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MySqlUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MySqlUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MySqlUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MySqlUser is not found in the empty JSON string", MySqlUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MySqlUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MySqlUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("rights") != null && !jsonObj.get("rights").isJsonNull()) {
        UserRights.validateJsonElement(jsonObj.get("rights"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MySqlUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MySqlUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MySqlUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MySqlUser.class));

       return (TypeAdapter<T>) new TypeAdapter<MySqlUser>() {
           @Override
           public void write(JsonWriter out, MySqlUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MySqlUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MySqlUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MySqlUser
   * @throws IOException if the JSON string is invalid with respect to MySqlUser
   */
  public static MySqlUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MySqlUser.class);
  }

  /**
   * Convert an instance of MySqlUser to an JSON string
   *
   * @return JSON string
   */
