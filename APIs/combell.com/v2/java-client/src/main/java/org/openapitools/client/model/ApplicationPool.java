...
public class ApplicationPool {
  public static final String SERIALIZED_NAME_INSTALLED_NET_CORE_RUNTIMES = "installed_net_core_runtimes";
  @SerializedName(SERIALIZED_NAME_INSTALLED_NET_CORE_RUNTIMES)
  private List<String> installedNetCoreRuntimes = new ArrayList<>();

  public static final String SERIALIZED_NAME_PIPELINE_MODE = "pipeline_mode";
  @SerializedName(SERIALIZED_NAME_PIPELINE_MODE)
  ...
  public ApplicationPool installedNetCoreRuntimes(List<String> installedNetCoreRuntimes) {
    this.installedNetCoreRuntimes = installedNetCoreRuntimes;
    return this;
  }

  public ApplicationPool addInstalledNetCoreRuntimesItem(String installedNetCoreRuntimesItem) {
    if (this.installedNetCoreRuntimes == null) {
      this.installedNetCoreRuntimes = new ArrayList<>();
    }
    this.installedNetCoreRuntimes.add(installedNetCoreRuntimesItem);
    return this;
  }

  /**
   * The installed .NET Core runtimes for the hosting account.
   * @return installedNetCoreRuntimes
   */
  ...
  public void setInstalledNetCoreRuntimes(List<String> installedNetCoreRuntimes) {
    this.installedNetCoreRuntimes = installedNetCoreRuntimes;
  }


  public ApplicationPool pipelineMode(String pipelineMode) {
  ...
  public ApplicationPool runtime(String runtime) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationPool applicationPool = (ApplicationPool) o;
    return Objects.equals(this.installedNetCoreRuntimes, applicationPool.installedNetCoreRuntimes) &&
        Objects.equals(this.pipelineMode, applicationPool.pipelineMode) &&
        Objects.equals(this.runtime, applicationPool.runtime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(installedNetCoreRuntimes, pipelineMode, runtime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApplicationPool {\n");
    sb.append("    installedNetCoreRuntimes: ").append(toIndentedString(installedNetCoreRuntimes)).append("\n");
    sb.append("    pipelineMode: ").append(toIndentedString(pipelineMode)).append("\n");
  ...
  static {
    ...
    openapiFields.add("installed_net_core_runtimes");
    openapiFields.add("pipeline_mode");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationPool
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationPool.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationPool is not found in the empty JSON string", ApplicationPool.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationPool.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationPool` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("installed_net_core_runtimes") != null && !jsonObj.get("installed_net_core_runtimes").isJsonNull() && !jsonObj.get("installed_net_core_runtimes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `installed_net_core_runtimes` to be an array in the JSON string but got `%s`", jsonObj.get("installed_net_core_runtimes").toString()));
      }
      if ((jsonObj.get("pipeline_mode") != null && !jsonObj.get("pipeline_mode").isJsonNull()) && !jsonObj.get("pipeline_mode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `pipeline_mode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pipeline_mode").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationPool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationPool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationPool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationPool.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationPool>() {
           @Override
           public void write(JsonWriter out, ApplicationPool value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationPool read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationPool given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationPool
   * @throws IOException if the JSON string is invalid with respect to ApplicationPool
   */
  public static ApplicationPool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationPool.class);
  }

  /**
   * Convert an instance of ApplicationPool to an JSON string
   *
   * @return JSON string
   */
