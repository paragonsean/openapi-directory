...
public class SshConfiguration {
  ...
  public SshConfiguration enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    SshConfiguration sshConfiguration = (SshConfiguration) o;
    return Objects.equals(this.enabled, sshConfiguration.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SshConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SshConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshConfiguration is not found in the empty JSON string", SshConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SshConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SshConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SshConfiguration>() {
           @Override
           public void write(JsonWriter out, SshConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SshConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SshConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SshConfiguration
   * @throws IOException if the JSON string is invalid with respect to SshConfiguration
   */
  public static SshConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshConfiguration.class);
  }

  /**
   * Convert an instance of SshConfiguration to an JSON string
   *
   * @return JSON string
   */
