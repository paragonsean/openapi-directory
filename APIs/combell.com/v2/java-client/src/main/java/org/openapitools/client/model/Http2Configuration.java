...
public class Http2Configuration {
  ...
  public Http2Configuration enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    Http2Configuration http2Configuration = (Http2Configuration) o;
    return Objects.equals(this.enabled, http2Configuration.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class Http2Configuration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Http2Configuration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Http2Configuration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Http2Configuration is not found in the empty JSON string", Http2Configuration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Http2Configuration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Http2Configuration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Http2Configuration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Http2Configuration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Http2Configuration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Http2Configuration.class));

       return (TypeAdapter<T>) new TypeAdapter<Http2Configuration>() {
           @Override
           public void write(JsonWriter out, Http2Configuration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Http2Configuration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Http2Configuration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Http2Configuration
   * @throws IOException if the JSON string is invalid with respect to Http2Configuration
   */
  public static Http2Configuration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Http2Configuration.class);
  }

  /**
   * Convert an instance of Http2Configuration to an JSON string
   *
   * @return JSON string
   */
