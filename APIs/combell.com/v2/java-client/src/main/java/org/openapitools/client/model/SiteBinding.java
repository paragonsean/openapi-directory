...
public class SiteBinding {
  public static final String SERIALIZED_NAME_CERT_THUMBPRINT = "cert_thumbprint";
  ...
  public SiteBinding certThumbprint(String certThumbprint) {
  ...
  public SiteBinding hostName(String hostName) {
  ...
  public SiteBinding ipAddress(String ipAddress) {
  ...
  public SiteBinding port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public SiteBinding protocol(String protocol) {
  ...
  public SiteBinding sslEnabled(Boolean sslEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    SiteBinding siteBinding = (SiteBinding) o;
    return Objects.equals(this.certThumbprint, siteBinding.certThumbprint) &&
        Objects.equals(this.hostName, siteBinding.hostName) &&
        Objects.equals(this.ipAddress, siteBinding.ipAddress) &&
        Objects.equals(this.port, siteBinding.port) &&
        Objects.equals(this.protocol, siteBinding.protocol) &&
        Objects.equals(this.sslEnabled, siteBinding.sslEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certThumbprint, hostName, ipAddress, port, protocol, sslEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SiteBinding {\n");
  ...
  static {
    ...
    openapiFields.add("cert_thumbprint");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SiteBinding
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SiteBinding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SiteBinding is not found in the empty JSON string", SiteBinding.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SiteBinding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SiteBinding` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("cert_thumbprint") != null && !jsonObj.get("cert_thumbprint").isJsonNull()) && !jsonObj.get("cert_thumbprint").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `cert_thumbprint` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cert_thumbprint").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SiteBinding.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SiteBinding' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SiteBinding> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SiteBinding.class));

       return (TypeAdapter<T>) new TypeAdapter<SiteBinding>() {
           @Override
           public void write(JsonWriter out, SiteBinding value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SiteBinding read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SiteBinding given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SiteBinding
   * @throws IOException if the JSON string is invalid with respect to SiteBinding
   */
  public static SiteBinding fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SiteBinding.class);
  }

  /**
   * Convert an instance of SiteBinding to an JSON string
   *
   * @return JSON string
   */
