...
public class UpdatePhpMemoryLimitRequest {
  ...
  public UpdatePhpMemoryLimitRequest memoryLimit(Integer memoryLimit) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePhpMemoryLimitRequest updatePhpMemoryLimitRequest = (UpdatePhpMemoryLimitRequest) o;
    return Objects.equals(this.memoryLimit, updatePhpMemoryLimitRequest.memoryLimit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(memoryLimit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePhpMemoryLimitRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePhpMemoryLimitRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePhpMemoryLimitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePhpMemoryLimitRequest is not found in the empty JSON string", UpdatePhpMemoryLimitRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePhpMemoryLimitRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePhpMemoryLimitRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePhpMemoryLimitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePhpMemoryLimitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePhpMemoryLimitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePhpMemoryLimitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePhpMemoryLimitRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePhpMemoryLimitRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePhpMemoryLimitRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePhpMemoryLimitRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePhpMemoryLimitRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePhpMemoryLimitRequest
   */
  public static UpdatePhpMemoryLimitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePhpMemoryLimitRequest.class);
  }

  /**
   * Convert an instance of UpdatePhpMemoryLimitRequest to an JSON string
   *
   * @return JSON string
   */
