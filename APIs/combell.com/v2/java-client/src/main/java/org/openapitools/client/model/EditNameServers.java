...
public class EditNameServers {
  ...
  public EditNameServers domainName(String domainName) {
  ...
  public EditNameServers nameServers(List<String> nameServers) {
    this.nameServers = nameServers;
    return this;
  }

  public EditNameServers addNameServersItem(String nameServersItem) {
  ...
  public boolean equals(Object o) {
    ...
    EditNameServers editNameServers = (EditNameServers) o;
    return Objects.equals(this.domainName, editNameServers.domainName) &&
        Objects.equals(this.nameServers, editNameServers.nameServers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainName, nameServers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EditNameServers {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EditNameServers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EditNameServers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EditNameServers is not found in the empty JSON string", EditNameServers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EditNameServers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EditNameServers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EditNameServers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EditNameServers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EditNameServers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EditNameServers.class));

       return (TypeAdapter<T>) new TypeAdapter<EditNameServers>() {
           @Override
           public void write(JsonWriter out, EditNameServers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EditNameServers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EditNameServers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EditNameServers
   * @throws IOException if the JSON string is invalid with respect to EditNameServers
   */
  public static EditNameServers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EditNameServers.class);
  }

  /**
   * Convert an instance of EditNameServers to an JSON string
   *
   * @return JSON string
   */
