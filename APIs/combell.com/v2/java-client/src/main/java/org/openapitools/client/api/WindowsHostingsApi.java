...
import org.openapitools.client.model.WindowsHosting;
import org.openapitools.client.model.WindowsHostingDetail;
...
public class WindowsHostingsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public WindowsHostingsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public WindowsHostingsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getWindowsHosting
     * @param domainName The Windows hosting domain name. (required)
     ...
     */
    public okhttp3.Call getWindowsHostingCall(String domainName, String domainName2, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/windowshostings/{domainName}"
    ...
    private okhttp3.Call getWindowsHostingValidateBeforeCall(String domainName, String domainName2, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainName' is set
        if (domainName == null) {
            throw new ApiException("Missing the required parameter 'domainName' when calling getWindowsHosting(Async)");
        }

        // verify the required parameter 'domainName2' is set
        if (domainName2 == null) {
            throw new ApiException("Missing the required parameter 'domainName2' when calling getWindowsHosting(Async)");
        }

        return getWindowsHostingCall(domainName, domainName2, _callback);
     ...
     */
    public WindowsHostingDetail getWindowsHosting(String domainName, String domainName2) throws ApiException {
        ApiResponse<WindowsHostingDetail> localVarResp = getWindowsHostingWithHttpInfo(domainName, domainName2);
     ...
     * @param domainName The Windows hosting domain name. (required)
     * @param domainName2 Automatically added (required)
     * @return ApiResponse&lt;WindowsHostingDetail&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WindowsHostingDetail> getWindowsHostingWithHttpInfo(String domainName, String domainName2) throws ApiException {
        okhttp3.Call localVarCall = getWindowsHostingValidateBeforeCall(domainName, domainName2, null);
        Type localVarReturnType = new TypeToken<WindowsHostingDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Windows hosting detail (asynchronously)
     * 
     * @param domainName The Windows hosting domain name. (required)
     * @param domainName2 Automatically added (required)
     ...
     */
    public okhttp3.Call getWindowsHostingAsync(String domainName, String domainName2, final ApiCallback<WindowsHostingDetail> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWindowsHostingValidateBeforeCall(domainName, domainName2, _callback);
        Type localVarReturnType = new TypeToken<WindowsHostingDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getWindowsHostings
     ...
     */
    public okhttp3.Call getWindowsHostingsCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/windowshostings";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWindowsHostingsValidateBeforeCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
        return getWindowsHostingsCall(skip, take, _callback);
     ...
     */
    public List<WindowsHosting> getWindowsHostings(Integer skip, Integer take) throws ApiException {
        ApiResponse<List<WindowsHosting>> localVarResp = getWindowsHostingsWithHttpInfo(skip, take);
        return localVarResp.getData();
    }
     ...
     * @param skip The number of items to skip in the resultset. (optional)
     * @param take The number of items to return in the resultset. The returned count can be equal or less than this number. (optional)
     * @return ApiResponse&lt;List&lt;WindowsHosting&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<WindowsHosting>> getWindowsHostingsWithHttpInfo(Integer skip, Integer take) throws ApiException {
        okhttp3.Call localVarCall = getWindowsHostingsValidateBeforeCall(skip, take, null);
        Type localVarReturnType = new TypeToken<List<WindowsHosting>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Overview of windows hostings (asynchronously)
     * 
     * @param skip The number of items to skip in the resultset. (optional)
     * @param take The number of items to return in the resultset. The returned count can be equal or less than this number. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getWindowsHostingsAsync(Integer skip, Integer take, final ApiCallback<List<WindowsHosting>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWindowsHostingsValidateBeforeCall(skip, take, _callback);
        Type localVarReturnType = new TypeToken<List<WindowsHosting>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
