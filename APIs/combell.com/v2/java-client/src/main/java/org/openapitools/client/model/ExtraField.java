...
public class ExtraField {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, extraField.name) &&
        Objects.equals(this.value, extraField.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExtraField
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtraField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExtraField is not found in the empty JSON string", ExtraField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtraField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExtraField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtraField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtraField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtraField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtraField.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtraField>() {
           @Override
           public void write(JsonWriter out, ExtraField value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExtraField read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExtraField given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtraField
   * @throws IOException if the JSON string is invalid with respect to ExtraField
   */
  public static ExtraField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtraField.class);
  }

  /**
   * Convert an instance of ExtraField to an JSON string
   *
   * @return JSON string
   */
