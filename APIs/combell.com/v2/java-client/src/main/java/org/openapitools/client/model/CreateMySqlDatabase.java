...
public class CreateMySqlDatabase {
  ...
  public CreateMySqlDatabase accountId(Integer accountId) {
  ...
  public CreateMySqlDatabase databaseName(String databaseName) {
  ...
  public CreateMySqlDatabase password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMySqlDatabase createMySqlDatabase = (CreateMySqlDatabase) o;
    return Objects.equals(this.accountId, createMySqlDatabase.accountId) &&
        Objects.equals(this.databaseName, createMySqlDatabase.databaseName) &&
        Objects.equals(this.password, createMySqlDatabase.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, databaseName, password);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateMySqlDatabase {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMySqlDatabase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMySqlDatabase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMySqlDatabase is not found in the empty JSON string", CreateMySqlDatabase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMySqlDatabase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMySqlDatabase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMySqlDatabase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMySqlDatabase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMySqlDatabase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMySqlDatabase.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMySqlDatabase>() {
           @Override
           public void write(JsonWriter out, CreateMySqlDatabase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMySqlDatabase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMySqlDatabase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMySqlDatabase
   * @throws IOException if the JSON string is invalid with respect to CreateMySqlDatabase
   */
  public static CreateMySqlDatabase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMySqlDatabase.class);
  }

  /**
   * Convert an instance of CreateMySqlDatabase to an JSON string
   *
   * @return JSON string
   */
