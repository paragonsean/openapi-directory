...
public class CreateMailboxRequest {
  ...
  public CreateMailboxRequest accountId(Integer accountId) {
  ...
  public CreateMailboxRequest emailAddress(String emailAddress) {
  ...
  public CreateMailboxRequest password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMailboxRequest createMailboxRequest = (CreateMailboxRequest) o;
    return Objects.equals(this.accountId, createMailboxRequest.accountId) &&
        Objects.equals(this.emailAddress, createMailboxRequest.emailAddress) &&
        Objects.equals(this.password, createMailboxRequest.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, emailAddress, password);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateMailboxRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMailboxRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMailboxRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMailboxRequest is not found in the empty JSON string", CreateMailboxRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMailboxRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMailboxRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMailboxRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMailboxRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMailboxRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMailboxRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMailboxRequest>() {
           @Override
           public void write(JsonWriter out, CreateMailboxRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMailboxRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMailboxRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMailboxRequest
   * @throws IOException if the JSON string is invalid with respect to CreateMailboxRequest
   */
  public static CreateMailboxRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMailboxRequest.class);
  }

  /**
   * Convert an instance of CreateMailboxRequest to an JSON string
   *
   * @return JSON string
   */
