...
public class SslCertificateRequestDetail {
  ...
  public static final String SERIALIZED_NAME_ORDER_CODE = "order_code";
  ...
  private List<SslCertificateRequestValidation> validations = new ArrayList<>();

  public static final String SERIALIZED_NAME_VENDOR = "vendor";
  @SerializedName(SERIALIZED_NAME_VENDOR)
  private SslCertificateVendor vendor;

  public SslCertificateRequestDetail() {
  }

  public SslCertificateRequestDetail certificateType(SslCertificateType certificateType) {
  ...
  public SslCertificateRequestDetail commonName(String commonName) {
  ...
  public SslCertificateRequestDetail id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SslCertificateRequestDetail orderCode(String orderCode) {
  ...
  public SslCertificateRequestDetail subjectAltNames(List<SslSubjectAltName> subjectAltNames) {
    this.subjectAltNames = subjectAltNames;
    return this;
  }

  public SslCertificateRequestDetail addSubjectAltNamesItem(SslSubjectAltName subjectAltNamesItem) {
  ...
  public SslCertificateRequestDetail validationLevel(SslCertificateValidationLevel validationLevel) {
  ...
  public SslCertificateRequestDetail validations(List<SslCertificateRequestValidation> validations) {
    this.validations = validations;
    return this;
  }

  public SslCertificateRequestDetail addValidationsItem(SslCertificateRequestValidation validationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SslCertificateRequestValidation> getValidations() {
    return validations;
  }

  public void setValidations(List<SslCertificateRequestValidation> validations) {
    this.validations = validations;
  }


  public SslCertificateRequestDetail vendor(SslCertificateVendor vendor) {
    this.vendor = vendor;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SslCertificateVendor getVendor() {
    return vendor;
  }

  public void setVendor(SslCertificateVendor vendor) {
    this.vendor = vendor;
  }
  ...
  public boolean equals(Object o) {
    ...
    SslCertificateRequestDetail sslCertificateRequestDetail = (SslCertificateRequestDetail) o;
    return Objects.equals(this.certificateType, sslCertificateRequestDetail.certificateType) &&
        Objects.equals(this.commonName, sslCertificateRequestDetail.commonName) &&
        Objects.equals(this.id, sslCertificateRequestDetail.id) &&
        Objects.equals(this.orderCode, sslCertificateRequestDetail.orderCode) &&
        Objects.equals(this.subjectAltNames, sslCertificateRequestDetail.subjectAltNames) &&
        Objects.equals(this.validationLevel, sslCertificateRequestDetail.validationLevel) &&
        Objects.equals(this.validations, sslCertificateRequestDetail.validations) &&
        Objects.equals(this.vendor, sslCertificateRequestDetail.vendor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificateType, commonName, id, orderCode, subjectAltNames, validationLevel, validations, vendor);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SslCertificateRequestDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SslCertificateRequestDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SslCertificateRequestDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SslCertificateRequestDetail is not found in the empty JSON string", SslCertificateRequestDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SslCertificateRequestDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SslCertificateRequestDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("order_code") != null && !jsonObj.get("order_code").isJsonNull()) && !jsonObj.get("order_code").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `order_code` to be a primitive type in the JSON string but got `%s`", jsonObj.get("order_code").toString()));
      }
      ...
      if (jsonObj.get("validations") != null && !jsonObj.get("validations").isJsonNull()) {
        ...
        if (jsonArrayvalidations != null) {
          ...
          for (int i = 0; i < jsonArrayvalidations.size(); i++) {
            SslCertificateRequestValidation.validateJsonElement(jsonArrayvalidations.get(i));
          };
        }
      }
      // validate the optional field `vendor`
      if (jsonObj.get("vendor") != null && !jsonObj.get("vendor").isJsonNull()) {
        SslCertificateVendor.validateJsonElement(jsonObj.get("vendor"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SslCertificateRequestDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SslCertificateRequestDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SslCertificateRequestDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SslCertificateRequestDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<SslCertificateRequestDetail>() {
           @Override
           public void write(JsonWriter out, SslCertificateRequestDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SslCertificateRequestDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SslCertificateRequestDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SslCertificateRequestDetail
   * @throws IOException if the JSON string is invalid with respect to SslCertificateRequestDetail
   */
  public static SslCertificateRequestDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SslCertificateRequestDetail.class);
  }

  /**
   * Convert an instance of SslCertificateRequestDetail to an JSON string
   *
   * @return JSON string
   */
