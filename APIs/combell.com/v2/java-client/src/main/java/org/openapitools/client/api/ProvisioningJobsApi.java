...
import org.openapitools.client.model.ProvisioningJobCompletion;
import org.openapitools.client.model.ProvisioningJobInfo;
...
public class ProvisioningJobsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ProvisioningJobsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ProvisioningJobsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for provisioningjobsJobIdGet
     * @param jobId  (required)
     * @param jobId2 Automatically added (required)
     ...
     */
    public okhttp3.Call provisioningjobsJobIdGetCall(UUID jobId, String jobId2, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/provisioningjobs/{jobId}"
            .replace("{" + "jobId" + "}", localVarApiClient.escapeString(jobId2.toString()));
    ...
    private okhttp3.Call provisioningjobsJobIdGetValidateBeforeCall(UUID jobId, String jobId2, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling provisioningjobsJobIdGet(Async)");
        }

        // verify the required parameter 'jobId2' is set
        if (jobId2 == null) {
            throw new ApiException("Missing the required parameter 'jobId2' when calling provisioningjobsJobIdGet(Async)");
        }

        return provisioningjobsJobIdGetCall(jobId, jobId2, _callback);
     ...
     */
    public ProvisioningJobInfo provisioningjobsJobIdGet(UUID jobId, String jobId2) throws ApiException {
        ApiResponse<ProvisioningJobInfo> localVarResp = provisioningjobsJobIdGetWithHttpInfo(jobId, jobId2);
     ...
     * @param jobId  (required)
     * @param jobId2 Automatically added (required)
     * @return ApiResponse&lt;ProvisioningJobInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ProvisioningJobInfo> provisioningjobsJobIdGetWithHttpInfo(UUID jobId, String jobId2) throws ApiException {
        okhttp3.Call localVarCall = provisioningjobsJobIdGetValidateBeforeCall(jobId, jobId2, null);
        Type localVarReturnType = new TypeToken<ProvisioningJobInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Detail of a provisioning job (asynchronously)
     * Provisioning failures may occur. Contact support in the event of a failure or wait for error resolution.&lt;br /&gt;  Do NOT retry provisioning until the job reports finished or cancelled.
     * @param jobId  (required)
     * @param jobId2 Automatically added (required)
     ...
     */
    public okhttp3.Call provisioningjobsJobIdGetAsync(UUID jobId, String jobId2, final ApiCallback<ProvisioningJobInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = provisioningjobsJobIdGetValidateBeforeCall(jobId, jobId2, _callback);
        Type localVarReturnType = new TypeToken<ProvisioningJobInfo>(){}.getType();
