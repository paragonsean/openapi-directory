 ...
 */
@JsonAdapter(AntiSpamTypes.Adapter.class)
public enum AntiSpamTypes {
  ...
  public static AntiSpamTypes fromValue(String value) {
    for (AntiSpamTypes b : AntiSpamTypes.values()) {
  ...
  public static class Adapter extends TypeAdapter<AntiSpamTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final AntiSpamTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AntiSpamTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AntiSpamTypes.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AntiSpamTypes.fromValue(value);
  }
}
