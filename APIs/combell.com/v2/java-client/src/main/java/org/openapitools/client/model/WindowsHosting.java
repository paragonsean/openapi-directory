...
public class WindowsHosting {
  ...
  public WindowsHosting domainName(String domainName) {
  ...
  public WindowsHosting servicepackId(Integer servicepackId) {
  ...
  public boolean equals(Object o) {
    ...
    WindowsHosting windowsHosting = (WindowsHosting) o;
    return Objects.equals(this.domainName, windowsHosting.domainName) &&
        Objects.equals(this.servicepackId, windowsHosting.servicepackId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainName, servicepackId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WindowsHosting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WindowsHosting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WindowsHosting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WindowsHosting is not found in the empty JSON string", WindowsHosting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WindowsHosting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WindowsHosting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WindowsHosting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WindowsHosting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WindowsHosting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WindowsHosting.class));

       return (TypeAdapter<T>) new TypeAdapter<WindowsHosting>() {
           @Override
           public void write(JsonWriter out, WindowsHosting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WindowsHosting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WindowsHosting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WindowsHosting
   * @throws IOException if the JSON string is invalid with respect to WindowsHosting
   */
  public static WindowsHosting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WindowsHosting.class);
  }

  /**
   * Convert an instance of WindowsHosting to an JSON string
   *
   * @return JSON string
   */
