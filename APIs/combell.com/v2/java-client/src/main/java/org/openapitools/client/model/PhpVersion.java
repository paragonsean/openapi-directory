...
public class PhpVersion {
  ...
  public PhpVersion version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    PhpVersion phpVersion = (PhpVersion) o;
    return Objects.equals(this.version, phpVersion.version);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PhpVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PhpVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PhpVersion is not found in the empty JSON string", PhpVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PhpVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PhpVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PhpVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PhpVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PhpVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PhpVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<PhpVersion>() {
           @Override
           public void write(JsonWriter out, PhpVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PhpVersion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PhpVersion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PhpVersion
   * @throws IOException if the JSON string is invalid with respect to PhpVersion
   */
  public static PhpVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PhpVersion.class);
  }

  /**
   * Convert an instance of PhpVersion to an JSON string
   *
   * @return JSON string
   */
