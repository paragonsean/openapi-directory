...
import org.openapitools.client.model.ValidationErrorMessage;
...
public class BadRequestResponse {
  ...
  private List<ValidationErrorMessage> validationErrors = new ArrayList<>();

  public BadRequestResponse() {
  }

  public BadRequestResponse validationErrors(List<ValidationErrorMessage> validationErrors) {
    this.validationErrors = validationErrors;
    return this;
  }

  public BadRequestResponse addValidationErrorsItem(ValidationErrorMessage validationErrorsItem) {
  ...
  public void setValidationErrors(List<ValidationErrorMessage> validationErrors) {
    this.validationErrors = validationErrors;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.validationErrors, badRequestResponse.validationErrors);
  }
      ...
      if (jsonObj.get("validation_errors") != null && !jsonObj.get("validation_errors").isJsonNull()) {
        ...
        if (jsonArrayvalidationErrors != null) {
          ...
          for (int i = 0; i < jsonArrayvalidationErrors.size(); i++) {
            ValidationErrorMessage.validateJsonElement(jsonArrayvalidationErrors.get(i));
          };
        }
      }
  }
