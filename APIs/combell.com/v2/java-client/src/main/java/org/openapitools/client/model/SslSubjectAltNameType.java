...
/**
 * The type of the alt name:  &lt;ul&gt;&lt;li&gt;Dns&lt;/li&gt;&lt;li&gt;Ip&lt;/li&gt;&lt;/ul&gt;
 */
@JsonAdapter(SslSubjectAltNameType.Adapter.class)
public enum SslSubjectAltNameType {
  ...
  SslSubjectAltNameType(String value) {
    this.value = value;
  }
  ...
  public static SslSubjectAltNameType fromValue(String value) {
    for (SslSubjectAltNameType b : SslSubjectAltNameType.values()) {
  ...
  public static class Adapter extends TypeAdapter<SslSubjectAltNameType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SslSubjectAltNameType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SslSubjectAltNameType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SslSubjectAltNameType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SslSubjectAltNameType.fromValue(value);
  }
}
