 ...
 */
@JsonAdapter(SslCertificateVendor.Adapter.class)
public enum SslCertificateVendor {
  ...
  SslCertificateVendor(String value) {
    this.value = value;
  }
  ...
  public static SslCertificateVendor fromValue(String value) {
    for (SslCertificateVendor b : SslCertificateVendor.values()) {
  ...
  public static class Adapter extends TypeAdapter<SslCertificateVendor> {
    @Override
    public void write(final JsonWriter jsonWriter, final SslCertificateVendor enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SslCertificateVendor read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SslCertificateVendor.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SslCertificateVendor.fromValue(value);
  }
}
