...
public class CreateAccount {
  ...
  public CreateAccount ftpPassword(String ftpPassword) {
  ...
  public CreateAccount identifier(String identifier) {
  ...
  public CreateAccount servicepackId(Integer servicepackId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ftpPassword, createAccount.ftpPassword) &&
        Objects.equals(this.identifier, createAccount.identifier) &&
        Objects.equals(this.servicepackId, createAccount.servicepackId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ftpPassword, identifier, servicepackId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAccount is not found in the empty JSON string", CreateAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAccount>() {
           @Override
           public void write(JsonWriter out, CreateAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAccount
   * @throws IOException if the JSON string is invalid with respect to CreateAccount
   */
  public static CreateAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAccount.class);
  }

  /**
   * Convert an instance of CreateAccount to an JSON string
   *
   * @return JSON string
   */
