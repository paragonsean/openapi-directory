...
public class Mailbox {
  ...
  public Mailbox actualSize(Integer actualSize) {
  ...
  public Mailbox maxSize(Integer maxSize) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actualSize, mailbox.actualSize) &&
        Objects.equals(this.maxSize, mailbox.maxSize) &&
        Objects.equals(this.name, mailbox.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actualSize, maxSize, name);
  }
