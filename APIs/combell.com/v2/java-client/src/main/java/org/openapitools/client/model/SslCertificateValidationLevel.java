...
/**
 * The validation level of the certificate:  &lt;ul&gt;&lt;li&gt;Domain validated: Basic check of the identity of the owner of the domain name.&lt;/li&gt;&lt;li&gt;Organization validated: Company details are verified and integrated in the certificate.&lt;/li&gt;&lt;li&gt;Extended validated: A thorough verification of your domain name and company details.&lt;/li&gt;&lt;/ul&gt;
 */
@JsonAdapter(SslCertificateValidationLevel.Adapter.class)
public enum SslCertificateValidationLevel {
  ...
  SslCertificateValidationLevel(String value) {
    this.value = value;
  }
  ...
  public static SslCertificateValidationLevel fromValue(String value) {
    for (SslCertificateValidationLevel b : SslCertificateValidationLevel.values()) {
  ...
  public static class Adapter extends TypeAdapter<SslCertificateValidationLevel> {
    @Override
    public void write(final JsonWriter jsonWriter, final SslCertificateValidationLevel enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SslCertificateValidationLevel read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SslCertificateValidationLevel.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SslCertificateValidationLevel.fromValue(value);
  }
}
