...
public class UpdateMailboxPasswordRequest {
  ...
  public UpdateMailboxPasswordRequest password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMailboxPasswordRequest updateMailboxPasswordRequest = (UpdateMailboxPasswordRequest) o;
    return Objects.equals(this.password, updateMailboxPasswordRequest.password);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMailboxPasswordRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMailboxPasswordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMailboxPasswordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMailboxPasswordRequest is not found in the empty JSON string", UpdateMailboxPasswordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMailboxPasswordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMailboxPasswordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMailboxPasswordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMailboxPasswordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMailboxPasswordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMailboxPasswordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMailboxPasswordRequest>() {
           @Override
           public void write(JsonWriter out, UpdateMailboxPasswordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMailboxPasswordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMailboxPasswordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMailboxPasswordRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateMailboxPasswordRequest
   */
  public static UpdateMailboxPasswordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMailboxPasswordRequest.class);
  }

  /**
   * Convert an instance of UpdateMailboxPasswordRequest to an JSON string
   *
   * @return JSON string
   */
