...
public class UpdateSmtpDomainRequest {
  ...
  public UpdateSmtpDomainRequest() {
  }

  public UpdateSmtpDomainRequest enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSmtpDomainRequest updateSmtpDomainRequest = (UpdateSmtpDomainRequest) o;
    return Objects.equals(this.enabled, updateSmtpDomainRequest.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSmtpDomainRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSmtpDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSmtpDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSmtpDomainRequest is not found in the empty JSON string", UpdateSmtpDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSmtpDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSmtpDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSmtpDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSmtpDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSmtpDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSmtpDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSmtpDomainRequest>() {
           @Override
           public void write(JsonWriter out, UpdateSmtpDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSmtpDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSmtpDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSmtpDomainRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateSmtpDomainRequest
   */
  public static UpdateSmtpDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSmtpDomainRequest.class);
  }

  /**
   * Convert an instance of UpdateSmtpDomainRequest to an JSON string
   *
   * @return JSON string
   */
