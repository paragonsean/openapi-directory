...
public class SmtpDomain {
  ...
  public SmtpDomain enabled(Boolean enabled) {
  ...
  public SmtpDomain hostname(String hostname) {
  ...
  public boolean equals(Object o) {
    ...
    SmtpDomain smtpDomain = (SmtpDomain) o;
    return Objects.equals(this.enabled, smtpDomain.enabled) &&
        Objects.equals(this.hostname, smtpDomain.hostname);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, hostname);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmtpDomain {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SmtpDomain
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmtpDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmtpDomain is not found in the empty JSON string", SmtpDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmtpDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmtpDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmtpDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmtpDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmtpDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmtpDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<SmtpDomain>() {
           @Override
           public void write(JsonWriter out, SmtpDomain value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmtpDomain read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SmtpDomain given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SmtpDomain
   * @throws IOException if the JSON string is invalid with respect to SmtpDomain
   */
  public static SmtpDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmtpDomain.class);
  }

  /**
   * Convert an instance of SmtpDomain to an JSON string
   *
   * @return JSON string
   */
