 ...
 */
@JsonAdapter(SslCertificateRequestValidationType.Adapter.class)
public enum SslCertificateRequestValidationType {
  ...
  SslCertificateRequestValidationType(String value) {
    this.value = value;
  }
  ...
  public static SslCertificateRequestValidationType fromValue(String value) {
    for (SslCertificateRequestValidationType b : SslCertificateRequestValidationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<SslCertificateRequestValidationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SslCertificateRequestValidationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SslCertificateRequestValidationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SslCertificateRequestValidationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SslCertificateRequestValidationType.fromValue(value);
  }
}
