...
public class AccountsApi {
     ...
     */
    public okhttp3.Call createAccountCall(CreateAccount createAccount, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createAccountValidateBeforeCall(CreateAccount createAccount, final ApiCallback _callback) throws ApiException {
        return createAccountCall(createAccount, _callback);
     ...
     */
    public void createAccount(CreateAccount createAccount) throws ApiException {
        createAccountWithHttpInfo(createAccount);
    }
     ...
     */
    public ApiResponse<Void> createAccountWithHttpInfo(CreateAccount createAccount) throws ApiException {
        okhttp3.Call localVarCall = createAccountValidateBeforeCall(createAccount, null);
     ...
     */
    public okhttp3.Call createAccountAsync(CreateAccount createAccount, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAccountValidateBeforeCall(createAccount, _callback);
     ...
     * @param accountId2 Automatically added (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getAccountCall(Integer accountId, String accountId2, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        String localVarPath = "/accounts/{accountId}"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId2.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountValidateBeforeCall(Integer accountId, String accountId2, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling getAccount(Async)");
        }

        // verify the required parameter 'accountId2' is set
        if (accountId2 == null) {
            throw new ApiException("Missing the required parameter 'accountId2' when calling getAccount(Async)");
        }

        return getAccountCall(accountId, accountId2, _callback);
     ...
     */
    public AccountDetail getAccount(Integer accountId, String accountId2) throws ApiException {
        ApiResponse<AccountDetail> localVarResp = getAccountWithHttpInfo(accountId, accountId2);
     ...
     */
    public ApiResponse<AccountDetail> getAccountWithHttpInfo(Integer accountId, String accountId2) throws ApiException {
        okhttp3.Call localVarCall = getAccountValidateBeforeCall(accountId, accountId2, null);
        Type localVarReturnType = new TypeToken<AccountDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a specific account (asynchronously)
     * 
     * @param accountId The id of the account. (required)
     * @param accountId2 Automatically added (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getAccountAsync(Integer accountId, String accountId2, final ApiCallback<AccountDetail> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountValidateBeforeCall(accountId, accountId2, _callback);
        Type localVarReturnType = new TypeToken<AccountDetail>(){}.getType();
     ...
     * @param assetType Filters the list, returning only accounts containing the specified asset type. (optional)
     * @param identifier Return only accounts, matching the specified identifier. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getAccountsCall(Integer skip, Integer take, AssetType assetType, String identifier, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountsValidateBeforeCall(Integer skip, Integer take, AssetType assetType, String identifier, final ApiCallback _callback) throws ApiException {
        return getAccountsCall(skip, take, assetType, identifier, _callback);
     ...
     */
    public List<Account> getAccounts(Integer skip, Integer take, AssetType assetType, String identifier) throws ApiException {
        ApiResponse<List<Account>> localVarResp = getAccountsWithHttpInfo(skip, take, assetType, identifier);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Account>> getAccountsWithHttpInfo(Integer skip, Integer take, AssetType assetType, String identifier) throws ApiException {
        okhttp3.Call localVarCall = getAccountsValidateBeforeCall(skip, take, assetType, identifier, null);
        Type localVarReturnType = new TypeToken<List<Account>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Overview of accounts (asynchronously)
     * 
     * @param skip The number of items to skip in the resultset. (optional)
     * @param take The number of items to return in the resultset. The returned count can be equal or less than this number. (optional)
     * @param assetType Filters the list, returning only accounts containing the specified asset type. (optional)
     ...
     */
    public okhttp3.Call getAccountsAsync(Integer skip, Integer take, AssetType assetType, String identifier, final ApiCallback<List<Account>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountsValidateBeforeCall(skip, take, assetType, identifier, _callback);
        Type localVarReturnType = new TypeToken<List<Account>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
