...
public class AutoForward {
  public static final String SERIALIZED_NAME_COPY_TO_MYSELF = "copy_to_myself";
  @SerializedName(SERIALIZED_NAME_COPY_TO_MYSELF)
  ...
  public AutoForward copyToMyself(Boolean copyToMyself) {
  ...
  public Boolean getCopyToMyself() {
    return copyToMyself;
  }
  ...
  public AutoForward emailAddresses(List<String> emailAddresses) {
    this.emailAddresses = emailAddresses;
    return this;
  }

  public AutoForward addEmailAddressesItem(String emailAddressesItem) {
  ...
  public AutoForward enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    AutoForward autoForward = (AutoForward) o;
    return Objects.equals(this.copyToMyself, autoForward.copyToMyself) &&
        Objects.equals(this.emailAddresses, autoForward.emailAddresses) &&
        Objects.equals(this.enabled, autoForward.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(copyToMyself, emailAddresses, enabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AutoForward {\n");
    sb.append("    copyToMyself: ").append(toIndentedString(copyToMyself)).append("\n");
  ...
  static {
    ...
    openapiFields.add("copy_to_myself");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoForward
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoForward.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoForward is not found in the empty JSON string", AutoForward.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoForward.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoForward` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoForward.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoForward' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoForward> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoForward.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoForward>() {
           @Override
           public void write(JsonWriter out, AutoForward value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoForward read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoForward given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoForward
   * @throws IOException if the JSON string is invalid with respect to AutoForward
   */
  public static AutoForward fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoForward.class);
  }

  /**
   * Convert an instance of AutoForward to an JSON string
   *
   * @return JSON string
   */
