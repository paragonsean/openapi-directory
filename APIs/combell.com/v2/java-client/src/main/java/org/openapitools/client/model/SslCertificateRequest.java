...
public class SslCertificateRequest {
  ...
  public SslCertificateRequest certificateType(SslCertificateType certificateType) {
  ...
  public SslCertificateRequest commonName(String commonName) {
  ...
  public SslCertificateRequest id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SslCertificateRequest orderCode(String orderCode) {
  ...
  public SslCertificateRequest validationLevel(SslCertificateValidationLevel validationLevel) {
  ...
  public SslCertificateRequest vendor(SslCertificateVendor vendor) {
    this.vendor = vendor;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SslCertificateRequest sslCertificateRequest = (SslCertificateRequest) o;
    return Objects.equals(this.certificateType, sslCertificateRequest.certificateType) &&
        Objects.equals(this.commonName, sslCertificateRequest.commonName) &&
        Objects.equals(this.id, sslCertificateRequest.id) &&
        Objects.equals(this.orderCode, sslCertificateRequest.orderCode) &&
        Objects.equals(this.validationLevel, sslCertificateRequest.validationLevel) &&
        Objects.equals(this.vendor, sslCertificateRequest.vendor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificateType, commonName, id, orderCode, validationLevel, vendor);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SslCertificateRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SslCertificateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SslCertificateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SslCertificateRequest is not found in the empty JSON string", SslCertificateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SslCertificateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SslCertificateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SslCertificateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SslCertificateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SslCertificateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SslCertificateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SslCertificateRequest>() {
           @Override
           public void write(JsonWriter out, SslCertificateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SslCertificateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SslCertificateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SslCertificateRequest
   * @throws IOException if the JSON string is invalid with respect to SslCertificateRequest
   */
  public static SslCertificateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SslCertificateRequest.class);
  }

  /**
   * Convert an instance of SslCertificateRequest to an JSON string
   *
   * @return JSON string
   */
