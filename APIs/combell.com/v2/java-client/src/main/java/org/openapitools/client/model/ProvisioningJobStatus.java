 ...
 * Current job status
 */
@JsonAdapter(ProvisioningJobStatus.Adapter.class)
public enum ProvisioningJobStatus {
  ...
  ProvisioningJobStatus(String value) {
    this.value = value;
  }
  ...
  public static ProvisioningJobStatus fromValue(String value) {
    for (ProvisioningJobStatus b : ProvisioningJobStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProvisioningJobStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProvisioningJobStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProvisioningJobStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProvisioningJobStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ProvisioningJobStatus.fromValue(value);
  }
}
