...
public class MailZoneAccount {
  ...
  public MailZoneAccount accountId(Integer accountId) {
  ...
  public MailZoneAccount size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MailZoneAccount mailZoneAccount = (MailZoneAccount) o;
    return Objects.equals(this.accountId, mailZoneAccount.accountId) &&
        Objects.equals(this.size, mailZoneAccount.size);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, size);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MailZoneAccount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MailZoneAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MailZoneAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MailZoneAccount is not found in the empty JSON string", MailZoneAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MailZoneAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MailZoneAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MailZoneAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MailZoneAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MailZoneAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MailZoneAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<MailZoneAccount>() {
           @Override
           public void write(JsonWriter out, MailZoneAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MailZoneAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MailZoneAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MailZoneAccount
   * @throws IOException if the JSON string is invalid with respect to MailZoneAccount
   */
  public static MailZoneAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MailZoneAccount.class);
  }

  /**
   * Convert an instance of MailZoneAccount to an JSON string
   *
   * @return JSON string
   */
