...
public class GzipConfig {
  ...
  public GzipConfig enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    GzipConfig gzipConfig = (GzipConfig) o;
    return Objects.equals(this.enabled, gzipConfig.enabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GzipConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GzipConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GzipConfig is not found in the empty JSON string", GzipConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GzipConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GzipConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GzipConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GzipConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GzipConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GzipConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GzipConfig>() {
           @Override
           public void write(JsonWriter out, GzipConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GzipConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GzipConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GzipConfig
   * @throws IOException if the JSON string is invalid with respect to GzipConfig
   */
  public static GzipConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GzipConfig.class);
  }

  /**
   * Convert an instance of GzipConfig to an JSON string
   *
   * @return JSON string
   */
