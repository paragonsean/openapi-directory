...
public class LinuxHosting {
  ...
  public LinuxHosting domainName(String domainName) {
  ...
  public LinuxHosting servicepackId(Integer servicepackId) {
  ...
  public boolean equals(Object o) {
    ...
    LinuxHosting linuxHosting = (LinuxHosting) o;
    return Objects.equals(this.domainName, linuxHosting.domainName) &&
        Objects.equals(this.servicepackId, linuxHosting.servicepackId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinuxHosting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinuxHosting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinuxHosting is not found in the empty JSON string", LinuxHosting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinuxHosting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinuxHosting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinuxHosting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinuxHosting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinuxHosting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinuxHosting.class));

       return (TypeAdapter<T>) new TypeAdapter<LinuxHosting>() {
           @Override
           public void write(JsonWriter out, LinuxHosting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinuxHosting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinuxHosting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinuxHosting
   * @throws IOException if the JSON string is invalid with respect to LinuxHosting
   */
  public static LinuxHosting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinuxHosting.class);
  }

  /**
   * Convert an instance of LinuxHosting to an JSON string
   *
   * @return JSON string
   */
