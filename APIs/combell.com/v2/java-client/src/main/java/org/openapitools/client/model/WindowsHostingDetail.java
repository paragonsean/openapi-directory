...
public class WindowsHostingDetail {
  ...
  public static final String SERIALIZED_NAME_APPLICATION_POOL = "application_pool";
  @SerializedName(SERIALIZED_NAME_APPLICATION_POOL)
  ...
  private WindowsIpType ipType;

  public static final String SERIALIZED_NAME_MAX_SIZE = "max_size";
  @SerializedName(SERIALIZED_NAME_MAX_SIZE)
  private Integer maxSize;

  public static final String SERIALIZED_NAME_MSSQL_DATABASE_NAMES = "mssql_database_names";
  @SerializedName(SERIALIZED_NAME_MSSQL_DATABASE_NAMES)
  private List<String> mssqlDatabaseNames = new ArrayList<>();
  ...
  private List<WindowsSite> sites = new ArrayList<>();

  public WindowsHostingDetail() {
  }

  public WindowsHostingDetail actualSize(Integer actualSize) {
  ...
  public WindowsHostingDetail applicationPool(ApplicationPool applicationPool) {
  ...
  public void setApplicationPool(ApplicationPool applicationPool) {
    this.applicationPool = applicationPool;
  }


  public WindowsHostingDetail domainName(String domainName) {
  ...
  public WindowsHostingDetail ftpUsername(String ftpUsername) {
  ...
  public WindowsHostingDetail ip(String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public WindowsHostingDetail ipType(WindowsIpType ipType) {
    this.ipType = ipType;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public WindowsIpType getIpType() {
    return ipType;
  }

  public void setIpType(WindowsIpType ipType) {
    this.ipType = ipType;
  }


  public WindowsHostingDetail maxSize(Integer maxSize) {
  ...
  public WindowsHostingDetail mssqlDatabaseNames(List<String> mssqlDatabaseNames) {
    this.mssqlDatabaseNames = mssqlDatabaseNames;
    return this;
  }

  public WindowsHostingDetail addMssqlDatabaseNamesItem(String mssqlDatabaseNamesItem) {
    if (this.mssqlDatabaseNames == null) {
      this.mssqlDatabaseNames = new ArrayList<>();
    }
    this.mssqlDatabaseNames.add(mssqlDatabaseNamesItem);
    return this;
  }

  /**
   * A list of mssql databases linked to the hosting account.&lt;br /&gt;
   * @return mssqlDatabaseNames
   */
  @javax.annotation.Nullable
  public List<String> getMssqlDatabaseNames() {
    return mssqlDatabaseNames;
  }

  public void setMssqlDatabaseNames(List<String> mssqlDatabaseNames) {
    this.mssqlDatabaseNames = mssqlDatabaseNames;
  }


  public WindowsHostingDetail servicepackId(Integer servicepackId) {
  ...
  public WindowsHostingDetail sites(List<WindowsSite> sites) {
    this.sites = sites;
    return this;
  }

  public WindowsHostingDetail addSitesItem(WindowsSite sitesItem) {
    if (this.sites == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<WindowsSite> getSites() {
    return sites;
  }

  public void setSites(List<WindowsSite> sites) {
    this.sites = sites;
  }
  ...
  public boolean equals(Object o) {
    ...
    WindowsHostingDetail windowsHostingDetail = (WindowsHostingDetail) o;
    return Objects.equals(this.actualSize, windowsHostingDetail.actualSize) &&
        Objects.equals(this.applicationPool, windowsHostingDetail.applicationPool) &&
        Objects.equals(this.domainName, windowsHostingDetail.domainName) &&
        Objects.equals(this.ftpUsername, windowsHostingDetail.ftpUsername) &&
        Objects.equals(this.ip, windowsHostingDetail.ip) &&
        Objects.equals(this.ipType, windowsHostingDetail.ipType) &&
        Objects.equals(this.maxSize, windowsHostingDetail.maxSize) &&
        Objects.equals(this.mssqlDatabaseNames, windowsHostingDetail.mssqlDatabaseNames) &&
        Objects.equals(this.servicepackId, windowsHostingDetail.servicepackId) &&
        Objects.equals(this.sites, windowsHostingDetail.sites);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actualSize, applicationPool, domainName, ftpUsername, ip, ipType, maxSize, mssqlDatabaseNames, servicepackId, sites);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WindowsHostingDetail {\n");
    sb.append("    actualSize: ").append(toIndentedString(actualSize)).append("\n");
    sb.append("    applicationPool: ").append(toIndentedString(applicationPool)).append("\n");
    sb.append("    domainName: ").append(toIndentedString(domainName)).append("\n");
    sb.append("    ftpUsername: ").append(toIndentedString(ftpUsername)).append("\n");
    sb.append("    ip: ").append(toIndentedString(ip)).append("\n");
    sb.append("    ipType: ").append(toIndentedString(ipType)).append("\n");
    sb.append("    maxSize: ").append(toIndentedString(maxSize)).append("\n");
    sb.append("    mssqlDatabaseNames: ").append(toIndentedString(mssqlDatabaseNames)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WindowsHostingDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WindowsHostingDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WindowsHostingDetail is not found in the empty JSON string", WindowsHostingDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WindowsHostingDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WindowsHostingDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `application_pool`
      if (jsonObj.get("application_pool") != null && !jsonObj.get("application_pool").isJsonNull()) {
        ApplicationPool.validateJsonElement(jsonObj.get("application_pool"));
      }
      ...
      if (jsonObj.get("ip_type") != null && !jsonObj.get("ip_type").isJsonNull()) {
        WindowsIpType.validateJsonElement(jsonObj.get("ip_type"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("mssql_database_names") != null && !jsonObj.get("mssql_database_names").isJsonNull() && !jsonObj.get("mssql_database_names").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `mssql_database_names` to be an array in the JSON string but got `%s`", jsonObj.get("mssql_database_names").toString()));
      }
      if (jsonObj.get("sites") != null && !jsonObj.get("sites").isJsonNull()) {
        ...
        if (jsonArraysites != null) {
          ...
          for (int i = 0; i < jsonArraysites.size(); i++) {
            WindowsSite.validateJsonElement(jsonArraysites.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WindowsHostingDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WindowsHostingDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WindowsHostingDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WindowsHostingDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<WindowsHostingDetail>() {
           @Override
           public void write(JsonWriter out, WindowsHostingDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WindowsHostingDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WindowsHostingDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WindowsHostingDetail
   * @throws IOException if the JSON string is invalid with respect to WindowsHostingDetail
   */
  public static WindowsHostingDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WindowsHostingDetail.class);
  }

  /**
   * Convert an instance of WindowsHostingDetail to an JSON string
   *
   * @return JSON string
   */
