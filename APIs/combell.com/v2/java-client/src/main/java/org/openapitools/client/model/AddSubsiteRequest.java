...
public class AddSubsiteRequest {
  ...
  public AddSubsiteRequest domainName(String domainName) {
  ...
  public AddSubsiteRequest path(String path) {
    this.path = path;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddSubsiteRequest addSubsiteRequest = (AddSubsiteRequest) o;
    return Objects.equals(this.domainName, addSubsiteRequest.domainName) &&
        Objects.equals(this.path, addSubsiteRequest.path);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainName, path);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddSubsiteRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddSubsiteRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddSubsiteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSubsiteRequest is not found in the empty JSON string", AddSubsiteRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddSubsiteRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddSubsiteRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSubsiteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSubsiteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSubsiteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSubsiteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSubsiteRequest>() {
           @Override
           public void write(JsonWriter out, AddSubsiteRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddSubsiteRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddSubsiteRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddSubsiteRequest
   * @throws IOException if the JSON string is invalid with respect to AddSubsiteRequest
   */
  public static AddSubsiteRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSubsiteRequest.class);
  }

  /**
   * Convert an instance of AddSubsiteRequest to an JSON string
   *
   * @return JSON string
   */
