...
public class UpdateUserStatusRequest {
  ...
  public UpdateUserStatusRequest enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, updateUserStatusRequest.enabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserStatusRequest is not found in the empty JSON string", UpdateUserStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserStatusRequest>() {
           @Override
           public void write(JsonWriter out, UpdateUserStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserStatusRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateUserStatusRequest
   */
  public static UpdateUserStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserStatusRequest.class);
  }

  /**
   * Convert an instance of UpdateUserStatusRequest to an JSON string
   *
   * @return JSON string
   */
