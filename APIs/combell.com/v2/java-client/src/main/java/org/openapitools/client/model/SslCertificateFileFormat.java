...
/**
 * The file format of the returned file stream:  &lt;ul&gt;&lt;li&gt;PFX: Also known as PKCS #12, is a single, password protected certificate archive that contains the entire certificate chain plus the matching private key.&lt;/li&gt;&lt;/ul&gt;
 */
@JsonAdapter(SslCertificateFileFormat.Adapter.class)
public enum SslCertificateFileFormat {
  ...
  SslCertificateFileFormat(String value) {
    this.value = value;
  }
  ...
  public static SslCertificateFileFormat fromValue(String value) {
    for (SslCertificateFileFormat b : SslCertificateFileFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<SslCertificateFileFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final SslCertificateFileFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SslCertificateFileFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SslCertificateFileFormat.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SslCertificateFileFormat.fromValue(value);
  }
}
