...
public class CreateAliasRequest {
  ...
  public CreateAliasRequest destinations(List<String> destinations) {
    this.destinations = destinations;
    return this;
  }

  public CreateAliasRequest addDestinationsItem(String destinationsItem) {
  ...
  public CreateAliasRequest emailAddress(String emailAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.destinations, createAliasRequest.destinations) &&
        Objects.equals(this.emailAddress, createAliasRequest.emailAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(destinations, emailAddress);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAliasRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAliasRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAliasRequest is not found in the empty JSON string", CreateAliasRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAliasRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAliasRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAliasRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAliasRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAliasRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAliasRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAliasRequest>() {
           @Override
           public void write(JsonWriter out, CreateAliasRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAliasRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAliasRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAliasRequest
   * @throws IOException if the JSON string is invalid with respect to CreateAliasRequest
   */
  public static CreateAliasRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAliasRequest.class);
  }

  /**
   * Convert an instance of CreateAliasRequest to an JSON string
   *
   * @return JSON string
   */
