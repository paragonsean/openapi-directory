...
public class UpdateUserPasswordRequest {
  ...
  public UpdateUserPasswordRequest password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.password, updateUserPasswordRequest.password);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPasswordRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPasswordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPasswordRequest is not found in the empty JSON string", UpdateUserPasswordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPasswordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPasswordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPasswordRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPasswordRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPasswordRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPasswordRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPasswordRequest>() {
           @Override
           public void write(JsonWriter out, UpdateUserPasswordRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPasswordRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPasswordRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPasswordRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPasswordRequest
   */
  public static UpdateUserPasswordRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPasswordRequest.class);
  }

  /**
   * Convert an instance of UpdateUserPasswordRequest to an JSON string
   *
   * @return JSON string
   */
