...
public class FtpConfiguration {
  ...
  public FtpConfiguration enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    FtpConfiguration ftpConfiguration = (FtpConfiguration) o;
    return Objects.equals(this.enabled, ftpConfiguration.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class FtpConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FtpConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FtpConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FtpConfiguration is not found in the empty JSON string", FtpConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FtpConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FtpConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FtpConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FtpConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FtpConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FtpConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FtpConfiguration>() {
           @Override
           public void write(JsonWriter out, FtpConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FtpConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FtpConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FtpConfiguration
   * @throws IOException if the JSON string is invalid with respect to FtpConfiguration
   */
  public static FtpConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FtpConfiguration.class);
  }

  /**
   * Convert an instance of FtpConfiguration to an JSON string
   *
   * @return JSON string
   */
