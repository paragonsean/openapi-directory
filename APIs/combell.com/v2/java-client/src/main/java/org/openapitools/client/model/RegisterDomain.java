...
public class RegisterDomain {
  ...
  public RegisterDomain domainName(String domainName) {
  ...
  public RegisterDomain nameServers(List<String> nameServers) {
    this.nameServers = nameServers;
    return this;
  }

  public RegisterDomain addNameServersItem(String nameServersItem) {
  ...
  public RegisterDomain registrant(RegistrantInput registrant) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterDomain registerDomain = (RegisterDomain) o;
    return Objects.equals(this.domainName, registerDomain.domainName) &&
        Objects.equals(this.nameServers, registerDomain.nameServers) &&
        Objects.equals(this.registrant, registerDomain.registrant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainName, nameServers, registrant);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegisterDomain {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterDomain
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisterDomain is not found in the empty JSON string", RegisterDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisterDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterDomain>() {
           @Override
           public void write(JsonWriter out, RegisterDomain value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterDomain read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterDomain given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterDomain
   * @throws IOException if the JSON string is invalid with respect to RegisterDomain
   */
  public static RegisterDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterDomain.class);
  }

  /**
   * Convert an instance of RegisterDomain to an JSON string
   *
   * @return JSON string
   */
