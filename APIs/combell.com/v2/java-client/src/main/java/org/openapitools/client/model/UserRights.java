 ...
 * User rights
 */
@JsonAdapter(UserRights.Adapter.class)
public enum UserRights {
  ...
  public static UserRights fromValue(String value) {
    for (UserRights b : UserRights.values()) {
  ...
  public static class Adapter extends TypeAdapter<UserRights> {
    @Override
    public void write(final JsonWriter jsonWriter, final UserRights enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UserRights read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UserRights.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UserRights.fromValue(value);
  }
}
