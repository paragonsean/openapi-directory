...
public class CreateMySqlUser {
  ...
  public CreateMySqlUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateMySqlUser password(String password) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMySqlUser createMySqlUser = (CreateMySqlUser) o;
    return Objects.equals(this.name, createMySqlUser.name) &&
        Objects.equals(this.password, createMySqlUser.password);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateMySqlUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMySqlUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMySqlUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMySqlUser is not found in the empty JSON string", CreateMySqlUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMySqlUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMySqlUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMySqlUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMySqlUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMySqlUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMySqlUser.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMySqlUser>() {
           @Override
           public void write(JsonWriter out, CreateMySqlUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMySqlUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMySqlUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMySqlUser
   * @throws IOException if the JSON string is invalid with respect to CreateMySqlUser
   */
  public static CreateMySqlUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMySqlUser.class);
  }

  /**
   * Convert an instance of CreateMySqlUser to an JSON string
   *
   * @return JSON string
   */
