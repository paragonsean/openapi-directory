...
import org.openapitools.client.model.CompletionEstimation;
import org.openapitools.client.model.ProvisioningJobStatus;
...
public class ProvisioningJobInfo {
  ...
  private CompletionEstimation completion;
  ...
  public ProvisioningJobInfo completion(CompletionEstimation completion) {
  ...
  public CompletionEstimation getCompletion() {
    return completion;
  }

  public void setCompletion(CompletionEstimation completion) {
    this.completion = completion;
  }


  public ProvisioningJobInfo id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ProvisioningJobInfo status(ProvisioningJobStatus status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ProvisioningJobStatus getStatus() {
    return status;
  }

  public void setStatus(ProvisioningJobStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProvisioningJobInfo provisioningJobInfo = (ProvisioningJobInfo) o;
    return Objects.equals(this.completion, provisioningJobInfo.completion) &&
        Objects.equals(this.id, provisioningJobInfo.id) &&
        Objects.equals(this.status, provisioningJobInfo.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(completion, id, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProvisioningJobInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProvisioningJobInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisioningJobInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisioningJobInfo is not found in the empty JSON string", ProvisioningJobInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisioningJobInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisioningJobInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `completion`
      if (jsonObj.get("completion") != null && !jsonObj.get("completion").isJsonNull()) {
        CompletionEstimation.validateJsonElement(jsonObj.get("completion"));
      }
      ...
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        ProvisioningJobStatus.validateJsonElement(jsonObj.get("status"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisioningJobInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisioningJobInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisioningJobInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisioningJobInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisioningJobInfo>() {
           @Override
           public void write(JsonWriter out, ProvisioningJobInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisioningJobInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProvisioningJobInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProvisioningJobInfo
   * @throws IOException if the JSON string is invalid with respect to ProvisioningJobInfo
   */
  public static ProvisioningJobInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisioningJobInfo.class);
  }

  /**
   * Convert an instance of ProvisioningJobInfo to an JSON string
   *
   * @return JSON string
   */
