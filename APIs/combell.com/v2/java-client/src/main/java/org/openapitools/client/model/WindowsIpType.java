 ...
 */
@JsonAdapter(WindowsIpType.Adapter.class)
public enum WindowsIpType {
  ...
  public static WindowsIpType fromValue(String value) {
    for (WindowsIpType b : WindowsIpType.values()) {
  ...
  public static class Adapter extends TypeAdapter<WindowsIpType> {
    @Override
    public void write(final JsonWriter jsonWriter, final WindowsIpType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WindowsIpType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WindowsIpType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WindowsIpType.fromValue(value);
  }
}
