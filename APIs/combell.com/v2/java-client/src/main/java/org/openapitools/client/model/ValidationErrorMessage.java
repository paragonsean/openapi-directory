...
public class ValidationErrorMessage {
  ...
  public ValidationErrorMessage errorCode(String errorCode) {
  ...
  public ValidationErrorMessage errorText(String errorText) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorCode, validationErrorMessage.errorCode) &&
        Objects.equals(this.errorText, validationErrorMessage.errorText);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidationErrorMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidationErrorMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidationErrorMessage is not found in the empty JSON string", ValidationErrorMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidationErrorMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidationErrorMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationErrorMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationErrorMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationErrorMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationErrorMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationErrorMessage>() {
           @Override
           public void write(JsonWriter out, ValidationErrorMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidationErrorMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValidationErrorMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValidationErrorMessage
   * @throws IOException if the JSON string is invalid with respect to ValidationErrorMessage
   */
  public static ValidationErrorMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationErrorMessage.class);
  }

  /**
   * Convert an instance of ValidationErrorMessage to an JSON string
   *
   * @return JSON string
   */
