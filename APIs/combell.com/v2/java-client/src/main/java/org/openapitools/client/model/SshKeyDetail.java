...
public class SshKeyDetail {
  ...
  public static final String SERIALIZED_NAME_LINUX_HOSTINGS = "linux_hostings";
  @SerializedName(SERIALIZED_NAME_LINUX_HOSTINGS)
  private List<String> linuxHostings = new ArrayList<>();
  ...
  public SshKeyDetail linuxHostings(List<String> linuxHostings) {
    this.linuxHostings = linuxHostings;
    return this;
  }

  public SshKeyDetail addLinuxHostingsItem(String linuxHostingsItem) {
    if (this.linuxHostings == null) {
      this.linuxHostings = new ArrayList<>();
    }
    this.linuxHostings.add(linuxHostingsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<String> getLinuxHostings() {
    return linuxHostings;
  }

  public void setLinuxHostings(List<String> linuxHostings) {
    this.linuxHostings = linuxHostings;
  }
  ...
  public boolean equals(Object o) {
    ...
    SshKeyDetail sshKeyDetail = (SshKeyDetail) o;
    return Objects.equals(this.fingerprint, sshKeyDetail.fingerprint) &&
        Objects.equals(this.linuxHostings, sshKeyDetail.linuxHostings) &&
        Objects.equals(this.publicKey, sshKeyDetail.publicKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fingerprint, linuxHostings, publicKey);
  }
  ...
  public String toString() {
    ...
    sb.append("    linuxHostings: ").append(toIndentedString(linuxHostings)).append("\n");
  ...
  static {
    ...
    openapiFields.add("linux_hostings");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SshKeyDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SshKeyDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeyDetail is not found in the empty JSON string", SshKeyDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SshKeyDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SshKeyDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("linux_hostings") != null && !jsonObj.get("linux_hostings").isJsonNull() && !jsonObj.get("linux_hostings").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `linux_hostings` to be an array in the JSON string but got `%s`", jsonObj.get("linux_hostings").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeyDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeyDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeyDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeyDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeyDetail>() {
           @Override
           public void write(JsonWriter out, SshKeyDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SshKeyDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SshKeyDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SshKeyDetail
   * @throws IOException if the JSON string is invalid with respect to SshKeyDetail
   */
  public static SshKeyDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeyDetail.class);
  }

  /**
   * Convert an instance of SshKeyDetail to an JSON string
   *
   * @return JSON string
   */
