...
public class DomainsApi {
    ...
    /**
     * Build call for configureDomain
     * @param domainName The domain name (required)
     * @param domainName2 Automatically added (required)
     * @param editDomainWillRenewRequest Contains the domain renew information (optional)
     ...
     */
    public okhttp3.Call configureDomainCall(String domainName, String domainName2, EditDomainWillRenewRequest editDomainWillRenewRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = editDomainWillRenewRequest;

        // create path and map variables
        String localVarPath = "/domains/{domainName}/renew"
    ...
    private okhttp3.Call configureDomainValidateBeforeCall(String domainName, String domainName2, EditDomainWillRenewRequest editDomainWillRenewRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainName' is set
        if (domainName == null) {
            throw new ApiException("Missing the required parameter 'domainName' when calling configureDomain(Async)");
        }

        // verify the required parameter 'domainName2' is set
        if (domainName2 == null) {
            throw new ApiException("Missing the required parameter 'domainName2' when calling configureDomain(Async)");
        }

        return configureDomainCall(domainName, domainName2, editDomainWillRenewRequest, _callback);
     ...
     */
    public void configureDomain(String domainName, String domainName2, EditDomainWillRenewRequest editDomainWillRenewRequest) throws ApiException {
        configureDomainWithHttpInfo(domainName, domainName2, editDomainWillRenewRequest);
    }
     ...
     */
    public ApiResponse<Void> configureDomainWithHttpInfo(String domainName, String domainName2, EditDomainWillRenewRequest editDomainWillRenewRequest) throws ApiException {
        okhttp3.Call localVarCall = configureDomainValidateBeforeCall(domainName, domainName2, editDomainWillRenewRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Edit domain name renew state (asynchronously)
     * Allowed if can_toggle_renew is true on the domain detail:&lt;br /&gt;&lt;ul&gt;&lt;li&gt;If there are no unpaid invoices for the domain name anymore.&lt;/li&gt;&lt;li&gt;If the renewal won&#39;t start within 1 month.&lt;/li&gt;&lt;/ul&gt;  Allowed if the requesting user has the finance role.
     * @param domainName The domain name (required)
     * @param domainName2 Automatically added (required)
     * @param editDomainWillRenewRequest Contains the domain renew information (optional)
     ...
     */
    public okhttp3.Call configureDomainAsync(String domainName, String domainName2, EditDomainWillRenewRequest editDomainWillRenewRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = configureDomainValidateBeforeCall(domainName, domainName2, editDomainWillRenewRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for editNameServers
     * @param domainName The domain name (required)
     * @param domainName2 Automatically added (required)
     * @param editNameServers  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call editNameServersCall(String domainName, String domainName2, EditNameServers editNameServers, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = editNameServers;

        // create path and map variables
        String localVarPath = "/domains/{domainName}/nameservers"
            .replace("{" + "domainName" + "}", localVarApiClient.escapeString(domainName2.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call editNameServersValidateBeforeCall(String domainName, String domainName2, EditNameServers editNameServers, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainName' is set
        if (domainName == null) {
            throw new ApiException("Missing the required parameter 'domainName' when calling editNameServers(Async)");
        }

        // verify the required parameter 'domainName2' is set
        if (domainName2 == null) {
            throw new ApiException("Missing the required parameter 'domainName2' when calling editNameServers(Async)");
        }

        return editNameServersCall(domainName, domainName2, editNameServers, _callback);
     ...
     */
    public void editNameServers(String domainName, String domainName2, EditNameServers editNameServers) throws ApiException {
        editNameServersWithHttpInfo(domainName, domainName2, editNameServers);
    }
     ...
     */
    public ApiResponse<Void> editNameServersWithHttpInfo(String domainName, String domainName2, EditNameServers editNameServers) throws ApiException {
        okhttp3.Call localVarCall = editNameServersValidateBeforeCall(domainName, domainName2, editNameServers, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Edit domain name servers (asynchronously)
     * 
     * @param domainName The domain name (required)
     * @param domainName2 Automatically added (required)
     * @param editNameServers  (optional)
     ...
     */
    public okhttp3.Call editNameServersAsync(String domainName, String domainName2, EditNameServers editNameServers, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = editNameServersValidateBeforeCall(domainName, domainName2, editNameServers, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call getDomainCall(String domainName, String domainName2, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDomainValidateBeforeCall(String domainName, String domainName2, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainName' is set
        if (domainName == null) {
        ...
        // verify the required parameter 'domainName2' is set
        if (domainName2 == null) {
            throw new ApiException("Missing the required parameter 'domainName2' when calling getDomain(Async)");
        }

        return getDomainCall(domainName, domainName2, _callback);
     ...
     */
    public DomainDetail getDomain(String domainName, String domainName2) throws ApiException {
        ApiResponse<DomainDetail> localVarResp = getDomainWithHttpInfo(domainName, domainName2);
     ...
     */
    public ApiResponse<DomainDetail> getDomainWithHttpInfo(String domainName, String domainName2) throws ApiException {
        okhttp3.Call localVarCall = getDomainValidateBeforeCall(domainName, domainName2, null);
        Type localVarReturnType = new TypeToken<DomainDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Details of a domain (asynchronously)
     * 
     * @param domainName The domain name (required)
     * @param domainName2 Automatically added (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getDomainAsync(String domainName, String domainName2, final ApiCallback<DomainDetail> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDomainValidateBeforeCall(domainName, domainName2, _callback);
        Type localVarReturnType = new TypeToken<DomainDetail>(){}.getType();
     ...
     */
    public okhttp3.Call getDomainsCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDomainsValidateBeforeCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
        return getDomainsCall(skip, take, _callback);
     ...
     */
    public List<Domain> getDomains(Integer skip, Integer take) throws ApiException {
        ApiResponse<List<Domain>> localVarResp = getDomainsWithHttpInfo(skip, take);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Domain>> getDomainsWithHttpInfo(Integer skip, Integer take) throws ApiException {
        okhttp3.Call localVarCall = getDomainsValidateBeforeCall(skip, take, null);
        Type localVarReturnType = new TypeToken<List<Domain>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Overviews of domains (asynchronously)
     * 
     * @param skip The number of items to skip in the resultset. (optional)
     * @param take The number of items to return in the resultset. The returned count can be equal or less than this number. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getDomainsAsync(Integer skip, Integer take, final ApiCallback<List<Domain>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDomainsValidateBeforeCall(skip, take, _callback);
        Type localVarReturnType = new TypeToken<List<Domain>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call registerCall(RegisterDomain registerDomain, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = registerDomain;

        // create path and map variables
        String localVarPath = "/domains/registrations";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call registerValidateBeforeCall(RegisterDomain registerDomain, final ApiCallback _callback) throws ApiException {
        return registerCall(registerDomain, _callback);
     ...
     */
    public void register(RegisterDomain registerDomain) throws ApiException {
        registerWithHttpInfo(registerDomain);
    }
     ...
     */
    public ApiResponse<Void> registerWithHttpInfo(RegisterDomain registerDomain) throws ApiException {
        okhttp3.Call localVarCall = registerValidateBeforeCall(registerDomain, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call registerAsync(RegisterDomain registerDomain, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = registerValidateBeforeCall(registerDomain, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for transfer
     * @param transferDomain  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call transferCall(TransferDomain transferDomain, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = transferDomain;

        // create path and map variables
        String localVarPath = "/domains/transfers";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call transferValidateBeforeCall(TransferDomain transferDomain, final ApiCallback _callback) throws ApiException {
        return transferCall(transferDomain, _callback);
     ...
     */
    public void transfer(TransferDomain transferDomain) throws ApiException {
        transferWithHttpInfo(transferDomain);
    }
     ...
     */
    public ApiResponse<Void> transferWithHttpInfo(TransferDomain transferDomain) throws ApiException {
        okhttp3.Call localVarCall = transferValidateBeforeCall(transferDomain, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Transfer a domain (asynchronously)
     * Transfers a domain with a transfer authorization code.&lt;br /&gt;Domain names with extension &#39;.ca&#39; are only available for registrants with country code &#39;CA&#39;.
     * @param transferDomain  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call transferAsync(TransferDomain transferDomain, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = transferValidateBeforeCall(transferDomain, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
