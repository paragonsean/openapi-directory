...
public class MailboxDetail {
  ...
  public static final String SERIALIZED_NAME_AUTO_FORWARD = "auto_forward";
  @SerializedName(SERIALIZED_NAME_AUTO_FORWARD)
  ...
  public MailboxDetail actualSize(Integer actualSize) {
  ...
  public MailboxDetail autoForward(AutoForward autoForward) {
   ...
   */
  @javax.annotation.Nullable
  public AutoForward getAutoForward() {
    return autoForward;
  }

  public void setAutoForward(AutoForward autoForward) {
    this.autoForward = autoForward;
  }


  public MailboxDetail autoReply(AutoReply autoReply) {
  ...
  public MailboxDetail login(String login) {
    this.login = login;
    return this;
  }
  ...
  public MailboxDetail maxSize(Integer maxSize) {
  ...
  public MailboxDetail name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MailboxDetail mailboxDetail = (MailboxDetail) o;
    return Objects.equals(this.actualSize, mailboxDetail.actualSize) &&
        Objects.equals(this.autoForward, mailboxDetail.autoForward) &&
        Objects.equals(this.autoReply, mailboxDetail.autoReply) &&
        Objects.equals(this.login, mailboxDetail.login) &&
        Objects.equals(this.maxSize, mailboxDetail.maxSize) &&
        Objects.equals(this.name, mailboxDetail.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actualSize, autoForward, autoReply, login, maxSize, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MailboxDetail {\n");
    sb.append("    actualSize: ").append(toIndentedString(actualSize)).append("\n");
    sb.append("    autoForward: ").append(toIndentedString(autoForward)).append("\n");
  ...
  static {
    ...
    openapiFields.add("auto_forward");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MailboxDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MailboxDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MailboxDetail is not found in the empty JSON string", MailboxDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MailboxDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MailboxDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `auto_forward`
      if (jsonObj.get("auto_forward") != null && !jsonObj.get("auto_forward").isJsonNull()) {
        AutoForward.validateJsonElement(jsonObj.get("auto_forward"));
      }
      // validate the optional field `auto_reply`
      if (jsonObj.get("auto_reply") != null && !jsonObj.get("auto_reply").isJsonNull()) {
        AutoReply.validateJsonElement(jsonObj.get("auto_reply"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MailboxDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MailboxDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MailboxDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MailboxDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<MailboxDetail>() {
           @Override
           public void write(JsonWriter out, MailboxDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MailboxDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MailboxDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MailboxDetail
   * @throws IOException if the JSON string is invalid with respect to MailboxDetail
   */
  public static MailboxDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MailboxDetail.class);
  }

  /**
   * Convert an instance of MailboxDetail to an JSON string
   *
   * @return JSON string
   */
