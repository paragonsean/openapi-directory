...
import java.io.File;
import org.openapitools.client.model.SslCertificate;
import org.openapitools.client.model.SslCertificateDetail;
import org.openapitools.client.model.SslCertificateFileFormat;
...
public class SslCertificatesApi {
     ...
     * @param sha1Fingerprint The SHA-1 fingerprint of the certificate. (required)
     * @param fileFormat The file format of the returned file stream:  &lt;ul&gt;&lt;li&gt;PFX: Also known as PKCS #12, is a single, password protected certificate archive that contains the entire certificate chain plus the matching private key.&lt;/li&gt;&lt;/ul&gt; (required)
     * @param password The password used to protect the certificate file.&lt;br /&gt; (required)
     * @param sha1Fingerprint2 Automatically added (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Invalid file_format or invalid password </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call downloadCertificateCall(String sha1Fingerprint, SslCertificateFileFormat fileFormat, String password, String sha1Fingerprint2, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/sslcertificates/{sha1Fingerprint}/download"
            .replace("{" + "sha1Fingerprint" + "}", localVarApiClient.escapeString(sha1Fingerprint2.toString()));
        ...
        if (sha1Fingerprint != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("sha1_fingerprint", sha1Fingerprint));
        }
    ...
    private okhttp3.Call downloadCertificateValidateBeforeCall(String sha1Fingerprint, SslCertificateFileFormat fileFormat, String password, String sha1Fingerprint2, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sha1Fingerprint' is set
        if (sha1Fingerprint == null) {
            throw new ApiException("Missing the required parameter 'sha1Fingerprint' when calling downloadCertificate(Async)");
        }

        // verify the required parameter 'fileFormat' is set
        if (fileFormat == null) {
            throw new ApiException("Missing the required parameter 'fileFormat' when calling downloadCertificate(Async)");
        }

        // verify the required parameter 'password' is set
        if (password == null) {
            throw new ApiException("Missing the required parameter 'password' when calling downloadCertificate(Async)");
        }

        // verify the required parameter 'sha1Fingerprint2' is set
        if (sha1Fingerprint2 == null) {
            throw new ApiException("Missing the required parameter 'sha1Fingerprint2' when calling downloadCertificate(Async)");
        }

        return downloadCertificateCall(sha1Fingerprint, fileFormat, password, sha1Fingerprint2, _callback);
     ...
     */
    public File downloadCertificate(String sha1Fingerprint, SslCertificateFileFormat fileFormat, String password, String sha1Fingerprint2) throws ApiException {
        ApiResponse<File> localVarResp = downloadCertificateWithHttpInfo(sha1Fingerprint, fileFormat, password, sha1Fingerprint2);
     ...
     */
    public ApiResponse<File> downloadCertificateWithHttpInfo(String sha1Fingerprint, SslCertificateFileFormat fileFormat, String password, String sha1Fingerprint2) throws ApiException {
        okhttp3.Call localVarCall = downloadCertificateValidateBeforeCall(sha1Fingerprint, fileFormat, password, sha1Fingerprint2, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Download a SSL certificate (asynchronously)
     * Returns the certifcate as binary data with the content-type and the filename information in the response headers.
     * @param sha1Fingerprint The SHA-1 fingerprint of the certificate. (required)
     * @param fileFormat The file format of the returned file stream:  &lt;ul&gt;&lt;li&gt;PFX: Also known as PKCS #12, is a single, password protected certificate archive that contains the entire certificate chain plus the matching private key.&lt;/li&gt;&lt;/ul&gt; (required)
     * @param password The password used to protect the certificate file.&lt;br /&gt; (required)
     ...
     */
    public okhttp3.Call downloadCertificateAsync(String sha1Fingerprint, SslCertificateFileFormat fileFormat, String password, String sha1Fingerprint2, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = downloadCertificateValidateBeforeCall(sha1Fingerprint, fileFormat, password, sha1Fingerprint2, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
     ...
     */
    public okhttp3.Call getSslCertificateCall(String sha1Fingerprint, String sha1Fingerprint2, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/sslcertificates/{sha1Fingerprint}"
            .replace("{" + "sha1Fingerprint" + "}", localVarApiClient.escapeString(sha1Fingerprint2.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSslCertificateValidateBeforeCall(String sha1Fingerprint, String sha1Fingerprint2, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sha1Fingerprint' is set
        if (sha1Fingerprint == null) {
            throw new ApiException("Missing the required parameter 'sha1Fingerprint' when calling getSslCertificate(Async)");
        }

        // verify the required parameter 'sha1Fingerprint2' is set
        if (sha1Fingerprint2 == null) {
            throw new ApiException("Missing the required parameter 'sha1Fingerprint2' when calling getSslCertificate(Async)");
        }

        return getSslCertificateCall(sha1Fingerprint, sha1Fingerprint2, _callback);
     ...
     */
    public SslCertificateDetail getSslCertificate(String sha1Fingerprint, String sha1Fingerprint2) throws ApiException {
        ApiResponse<SslCertificateDetail> localVarResp = getSslCertificateWithHttpInfo(sha1Fingerprint, sha1Fingerprint2);
        return localVarResp.getData();
    }
     ...
     * @param sha1Fingerprint The SHA-1 fingerprint of the certificate. (required)
     * @param sha1Fingerprint2 Automatically added (required)
     * @return ApiResponse&lt;SslCertificateDetail&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SslCertificateDetail> getSslCertificateWithHttpInfo(String sha1Fingerprint, String sha1Fingerprint2) throws ApiException {
        okhttp3.Call localVarCall = getSslCertificateValidateBeforeCall(sha1Fingerprint, sha1Fingerprint2, null);
        Type localVarReturnType = new TypeToken<SslCertificateDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Detail of a SSL certificate (asynchronously)
     * 
     * @param sha1Fingerprint The SHA-1 fingerprint of the certificate. (required)
     * @param sha1Fingerprint2 Automatically added (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getSslCertificateAsync(String sha1Fingerprint, String sha1Fingerprint2, final ApiCallback<SslCertificateDetail> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSslCertificateValidateBeforeCall(sha1Fingerprint, sha1Fingerprint2, _callback);
        Type localVarReturnType = new TypeToken<SslCertificateDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getSslCertificates
     ...
     */
    public okhttp3.Call getSslCertificatesCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/sslcertificates";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSslCertificatesValidateBeforeCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
        return getSslCertificatesCall(skip, take, _callback);
     ...
     */
    public List<SslCertificate> getSslCertificates(Integer skip, Integer take) throws ApiException {
        ApiResponse<List<SslCertificate>> localVarResp = getSslCertificatesWithHttpInfo(skip, take);
        return localVarResp.getData();
    }
     ...
     * @param skip The number of items to skip in the resultset. (optional)
     * @param take The number of items to return in the resultset. The returned count can be equal or less than this number. (optional)
     * @return ApiResponse&lt;List&lt;SslCertificate&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<SslCertificate>> getSslCertificatesWithHttpInfo(Integer skip, Integer take) throws ApiException {
        okhttp3.Call localVarCall = getSslCertificatesValidateBeforeCall(skip, take, null);
        Type localVarReturnType = new TypeToken<List<SslCertificate>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Overview of SSL certificates (asynchronously)
     * 
     * @param skip The number of items to skip in the resultset. (optional)
     * @param take The number of items to return in the resultset. The returned count can be equal or less than this number. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getSslCertificatesAsync(Integer skip, Integer take, final ApiCallback<List<SslCertificate>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSslCertificatesValidateBeforeCall(skip, take, _callback);
        Type localVarReturnType = new TypeToken<List<SslCertificate>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
