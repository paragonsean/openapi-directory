...
public class CreateCatchAllRequest {
  ...
  public CreateCatchAllRequest emailAddress(String emailAddress) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCatchAllRequest createCatchAllRequest = (CreateCatchAllRequest) o;
    return Objects.equals(this.emailAddress, createCatchAllRequest.emailAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCatchAllRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCatchAllRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCatchAllRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCatchAllRequest is not found in the empty JSON string", CreateCatchAllRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCatchAllRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCatchAllRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCatchAllRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCatchAllRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCatchAllRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCatchAllRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCatchAllRequest>() {
           @Override
           public void write(JsonWriter out, CreateCatchAllRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCatchAllRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCatchAllRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCatchAllRequest
   * @throws IOException if the JSON string is invalid with respect to CreateCatchAllRequest
   */
  public static CreateCatchAllRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCatchAllRequest.class);
  }

  /**
   * Convert an instance of CreateCatchAllRequest to an JSON string
   *
   * @return JSON string
   */
