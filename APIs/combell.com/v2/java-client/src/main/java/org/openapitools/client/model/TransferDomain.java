...
import org.openapitools.client.model.RegistrantInput;
...
public class TransferDomain {
  ...
  private RegistrantInput registrant;

  public TransferDomain() {
  }

  public TransferDomain authCode(String authCode) {
  ...
  public TransferDomain domainName(String domainName) {
  ...
  public TransferDomain nameServers(List<String> nameServers) {
    this.nameServers = nameServers;
    return this;
  }

  public TransferDomain addNameServersItem(String nameServersItem) {
  ...
  public TransferDomain registrant(RegistrantInput registrant) {
   ...
   */
  @javax.annotation.Nullable
  public RegistrantInput getRegistrant() {
    return registrant;
  }

  public void setRegistrant(RegistrantInput registrant) {
    this.registrant = registrant;
  }
  ...
  public boolean equals(Object o) {
    ...
    TransferDomain transferDomain = (TransferDomain) o;
    return Objects.equals(this.authCode, transferDomain.authCode) &&
        Objects.equals(this.domainName, transferDomain.domainName) &&
        Objects.equals(this.nameServers, transferDomain.nameServers) &&
        Objects.equals(this.registrant, transferDomain.registrant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authCode, domainName, nameServers, registrant);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TransferDomain {\n");
  ...
  static {
    ...
    openapiFields.add("name_servers");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransferDomain
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransferDomain is not found in the empty JSON string", TransferDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransferDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransferDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("name_servers") != null && !jsonObj.get("name_servers").isJsonNull() && !jsonObj.get("name_servers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `name_servers` to be an array in the JSON string but got `%s`", jsonObj.get("name_servers").toString()));
      }
      // validate the optional field `registrant`
      if (jsonObj.get("registrant") != null && !jsonObj.get("registrant").isJsonNull()) {
        RegistrantInput.validateJsonElement(jsonObj.get("registrant"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransferDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransferDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransferDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransferDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<TransferDomain>() {
           @Override
           public void write(JsonWriter out, TransferDomain value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransferDomain read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransferDomain given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransferDomain
   * @throws IOException if the JSON string is invalid with respect to TransferDomain
   */
  public static TransferDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransferDomain.class);
  }

  /**
   * Convert an instance of TransferDomain to an JSON string
   *
   * @return JSON string
   */
