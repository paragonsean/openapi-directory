...
import org.openapitools.client.model.NameServer;
...
public class DomainDetail {
  public static final String SERIALIZED_NAME_CAN_TOGGLE_RENEW = "can_toggle_renew";
  @SerializedName(SERIALIZED_NAME_CAN_TOGGLE_RENEW)
  private Boolean canToggleRenew;
  ...
  public static final String SERIALIZED_NAME_WILL_RENEW = "will_renew";
  @SerializedName(SERIALIZED_NAME_WILL_RENEW)
  private Boolean willRenew;

  public DomainDetail() {
  }

  public DomainDetail canToggleRenew(Boolean canToggleRenew) {
   ...
   * @return canToggleRenew
   */
  @javax.annotation.Nullable
  public Boolean getCanToggleRenew() {
    return canToggleRenew;
  }

  public void setCanToggleRenew(Boolean canToggleRenew) {
    this.canToggleRenew = canToggleRenew;
  }


  public DomainDetail domainName(String domainName) {
  ...
  public DomainDetail expirationDate(OffsetDateTime expirationDate) {
  ...
  public DomainDetail nameServers(List<NameServer> nameServers) {
    this.nameServers = nameServers;
    return this;
  }

  public DomainDetail addNameServersItem(NameServer nameServersItem) {
  ...
  public DomainDetail registrant(Registrant registrant) {
  ...
  public DomainDetail willRenew(Boolean willRenew) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.canToggleRenew, domainDetail.canToggleRenew) &&
        Objects.equals(this.domainName, domainDetail.domainName) &&
        Objects.equals(this.expirationDate, domainDetail.expirationDate) &&
        Objects.equals(this.nameServers, domainDetail.nameServers) &&
        Objects.equals(this.registrant, domainDetail.registrant) &&
        Objects.equals(this.willRenew, domainDetail.willRenew);
  }

  @Override
  public int hashCode() {
    return Objects.hash(canToggleRenew, domainName, expirationDate, nameServers, registrant, willRenew);
  }
  ...
  public String toString() {
    ...
    sb.append("    canToggleRenew: ").append(toIndentedString(canToggleRenew)).append("\n");
    sb.append("    domainName: ").append(toIndentedString(domainName)).append("\n");
    sb.append("    expirationDate: ").append(toIndentedString(expirationDate)).append("\n");
    sb.append("    nameServers: ").append(toIndentedString(nameServers)).append("\n");
    sb.append("    registrant: ").append(toIndentedString(registrant)).append("\n");
    sb.append("    willRenew: ").append(toIndentedString(willRenew)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("name_servers") != null && !jsonObj.get("name_servers").isJsonNull()) {
        JsonArray jsonArraynameServers = jsonObj.getAsJsonArray("name_servers");
        if (jsonArraynameServers != null) {
          // ensure the json data is an array
          if (!jsonObj.get("name_servers").isJsonArray()) {
          ...
          // validate the optional field `name_servers` (array)
          for (int i = 0; i < jsonArraynameServers.size(); i++) {
            NameServer.validateJsonElement(jsonArraynameServers.get(i));
          };
        }
      }
