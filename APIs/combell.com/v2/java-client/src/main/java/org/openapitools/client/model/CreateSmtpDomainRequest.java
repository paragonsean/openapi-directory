...
public class CreateSmtpDomainRequest {
  ...
  public CreateSmtpDomainRequest hostname(String hostname) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSmtpDomainRequest createSmtpDomainRequest = (CreateSmtpDomainRequest) o;
    return Objects.equals(this.hostname, createSmtpDomainRequest.hostname);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSmtpDomainRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSmtpDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSmtpDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSmtpDomainRequest is not found in the empty JSON string", CreateSmtpDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSmtpDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSmtpDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSmtpDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSmtpDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSmtpDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSmtpDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSmtpDomainRequest>() {
           @Override
           public void write(JsonWriter out, CreateSmtpDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSmtpDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSmtpDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSmtpDomainRequest
   * @throws IOException if the JSON string is invalid with respect to CreateSmtpDomainRequest
   */
  public static CreateSmtpDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSmtpDomainRequest.class);
  }

  /**
   * Convert an instance of CreateSmtpDomainRequest to an JSON string
   *
   * @return JSON string
   */
