...
import org.openapitools.client.model.AntiSpamTypes;
...
public class UpdateAntiSpamRequest {
  ...
  private AntiSpamTypes type;

  public UpdateAntiSpamRequest() {
  }

  public UpdateAntiSpamRequest type(AntiSpamTypes type) {
    this.type = type;
    return this;
  }
  ...
  public AntiSpamTypes getType() {
    return type;
  }

  public void setType(AntiSpamTypes type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateAntiSpamRequest updateAntiSpamRequest = (UpdateAntiSpamRequest) o;
    return Objects.equals(this.type, updateAntiSpamRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAntiSpamRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAntiSpamRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAntiSpamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAntiSpamRequest is not found in the empty JSON string", UpdateAntiSpamRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAntiSpamRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAntiSpamRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `type`
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        AntiSpamTypes.validateJsonElement(jsonObj.get("type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAntiSpamRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAntiSpamRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAntiSpamRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAntiSpamRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAntiSpamRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAntiSpamRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAntiSpamRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAntiSpamRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAntiSpamRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAntiSpamRequest
   */
  public static UpdateAntiSpamRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAntiSpamRequest.class);
  }

  /**
   * Convert an instance of UpdateAntiSpamRequest to an JSON string
   *
   * @return JSON string
   */
