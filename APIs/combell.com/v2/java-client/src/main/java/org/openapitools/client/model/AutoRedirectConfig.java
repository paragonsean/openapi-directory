...
public class AutoRedirectConfig {
  ...
  public AutoRedirectConfig enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    AutoRedirectConfig autoRedirectConfig = (AutoRedirectConfig) o;
    return Objects.equals(this.enabled, autoRedirectConfig.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoRedirectConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoRedirectConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoRedirectConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoRedirectConfig is not found in the empty JSON string", AutoRedirectConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoRedirectConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoRedirectConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoRedirectConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoRedirectConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoRedirectConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoRedirectConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoRedirectConfig>() {
           @Override
           public void write(JsonWriter out, AutoRedirectConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoRedirectConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoRedirectConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoRedirectConfig
   * @throws IOException if the JSON string is invalid with respect to AutoRedirectConfig
   */
  public static AutoRedirectConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoRedirectConfig.class);
  }

  /**
   * Convert an instance of AutoRedirectConfig to an JSON string
   *
   * @return JSON string
   */
