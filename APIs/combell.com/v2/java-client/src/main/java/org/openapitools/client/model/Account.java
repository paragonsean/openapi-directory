...
public class Account {
  ...
  public Account servicepackId(Integer servicepackId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, account.id) &&
        ...
        Objects.equals(this.servicepackId, account.servicepackId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, identifier, servicepackId);
  }
