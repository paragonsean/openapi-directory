...
/**
 * The type of the certificate:  &lt;ul&gt;&lt;li&gt;Standard: Certificate for a single domain.&lt;/li&gt;&lt;li&gt;Multi domain: Certificate for multiple (sub)domains belonging to the same owner.&lt;/li&gt;&lt;li&gt;Wildcard: Certificate for all the subdomains.&lt;/li&gt;&lt;/ul&gt;
 */
@JsonAdapter(SslCertificateType.Adapter.class)
public enum SslCertificateType {
  ...
  public static SslCertificateType fromValue(String value) {
    for (SslCertificateType b : SslCertificateType.values()) {
  ...
  public static class Adapter extends TypeAdapter<SslCertificateType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SslCertificateType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SslCertificateType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SslCertificateType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SslCertificateType.fromValue(value);
  }
}
