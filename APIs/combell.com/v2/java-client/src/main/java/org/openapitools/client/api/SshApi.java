...
import org.openapitools.client.model.SshKeyDetail;
...
public class SshApi {
     ...
     */
    public okhttp3.Call getAllSshKeysCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllSshKeysValidateBeforeCall(Integer skip, Integer take, final ApiCallback _callback) throws ApiException {
        return getAllSshKeysCall(skip, take, _callback);
     ...
     */
    public List<SshKeyDetail> getAllSshKeys(Integer skip, Integer take) throws ApiException {
        ApiResponse<List<SshKeyDetail>> localVarResp = getAllSshKeysWithHttpInfo(skip, take);
     ...
     * @param skip The number of items to skip in the resultset. (optional)
     * @param take The number of items to return in the resultset. The returned count can be equal or less than this number. (optional)
     * @return ApiResponse&lt;List&lt;SshKeyDetail&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<SshKeyDetail>> getAllSshKeysWithHttpInfo(Integer skip, Integer take) throws ApiException {
        okhttp3.Call localVarCall = getAllSshKeysValidateBeforeCall(skip, take, null);
        Type localVarReturnType = new TypeToken<List<SshKeyDetail>>(){}.getType();
     ...
     */
    public okhttp3.Call getAllSshKeysAsync(Integer skip, Integer take, final ApiCallback<List<SshKeyDetail>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllSshKeysValidateBeforeCall(skip, take, _callback);
        Type localVarReturnType = new TypeToken<List<SshKeyDetail>>(){}.getType();
