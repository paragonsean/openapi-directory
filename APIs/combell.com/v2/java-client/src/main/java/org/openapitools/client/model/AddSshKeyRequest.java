...
public class AddSshKeyRequest {
  ...
  public AddSshKeyRequest publicKey(String publicKey) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.publicKey, addSshKeyRequest.publicKey);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddSshKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddSshKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSshKeyRequest is not found in the empty JSON string", AddSshKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddSshKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddSshKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSshKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSshKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSshKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSshKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSshKeyRequest>() {
           @Override
           public void write(JsonWriter out, AddSshKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddSshKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddSshKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddSshKeyRequest
   * @throws IOException if the JSON string is invalid with respect to AddSshKeyRequest
   */
  public static AddSshKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSshKeyRequest.class);
  }

  /**
   * Convert an instance of AddSshKeyRequest to an JSON string
   *
   * @return JSON string
   */
