...
public class UpdatePhpAPcuRequest {
  public static final String SERIALIZED_NAME_APCU_SIZE = "apcu_size";
  @SerializedName(SERIALIZED_NAME_APCU_SIZE)
  private Integer apcuSize;
  ...
  public UpdatePhpAPcuRequest apcuSize(Integer apcuSize) {
  ...
  public Integer getApcuSize() {
    return apcuSize;
  }

  public void setApcuSize(Integer apcuSize) {
    this.apcuSize = apcuSize;
  }


  public UpdatePhpAPcuRequest enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePhpAPcuRequest updatePhpAPcuRequest = (UpdatePhpAPcuRequest) o;
    return Objects.equals(this.apcuSize, updatePhpAPcuRequest.apcuSize) &&
        Objects.equals(this.enabled, updatePhpAPcuRequest.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apcuSize, enabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePhpAPcuRequest {\n");
    sb.append("    apcuSize: ").append(toIndentedString(apcuSize)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePhpAPcuRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePhpAPcuRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePhpAPcuRequest is not found in the empty JSON string", UpdatePhpAPcuRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePhpAPcuRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePhpAPcuRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePhpAPcuRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePhpAPcuRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePhpAPcuRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePhpAPcuRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePhpAPcuRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePhpAPcuRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePhpAPcuRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePhpAPcuRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePhpAPcuRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePhpAPcuRequest
   */
  public static UpdatePhpAPcuRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePhpAPcuRequest.class);
  }

  /**
   * Convert an instance of UpdatePhpAPcuRequest to an JSON string
   *
   * @return JSON string
   */
