...
public class ProvisioningJobCompletion {
  ...
  public ProvisioningJobCompletion id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ProvisioningJobCompletion resourceLinks(List<String> resourceLinks) {
    this.resourceLinks = resourceLinks;
    return this;
  }

  public ProvisioningJobCompletion addResourceLinksItem(String resourceLinksItem) {
  ...
  public boolean equals(Object o) {
    ...
    ProvisioningJobCompletion provisioningJobCompletion = (ProvisioningJobCompletion) o;
    return Objects.equals(this.id, provisioningJobCompletion.id) &&
        Objects.equals(this.resourceLinks, provisioningJobCompletion.resourceLinks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, resourceLinks);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProvisioningJobCompletion {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProvisioningJobCompletion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisioningJobCompletion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisioningJobCompletion is not found in the empty JSON string", ProvisioningJobCompletion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisioningJobCompletion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisioningJobCompletion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("resource_links") != null && !jsonObj.get("resource_links").isJsonNull() && !jsonObj.get("resource_links").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `resource_links` to be an array in the JSON string but got `%s`", jsonObj.get("resource_links").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisioningJobCompletion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisioningJobCompletion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisioningJobCompletion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisioningJobCompletion.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisioningJobCompletion>() {
           @Override
           public void write(JsonWriter out, ProvisioningJobCompletion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisioningJobCompletion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProvisioningJobCompletion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProvisioningJobCompletion
   * @throws IOException if the JSON string is invalid with respect to ProvisioningJobCompletion
   */
  public static ProvisioningJobCompletion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisioningJobCompletion.class);
  }

  /**
   * Convert an instance of ProvisioningJobCompletion to an JSON string
   *
   * @return JSON string
   */
