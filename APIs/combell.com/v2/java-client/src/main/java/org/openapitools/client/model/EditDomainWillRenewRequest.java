...
public class EditDomainWillRenewRequest {
  ...
  public EditDomainWillRenewRequest willRenew(Boolean willRenew) {
  ...
  public boolean equals(Object o) {
    ...
    EditDomainWillRenewRequest editDomainWillRenewRequest = (EditDomainWillRenewRequest) o;
    return Objects.equals(this.willRenew, editDomainWillRenewRequest.willRenew);
  }

  @Override
  public int hashCode() {
    return Objects.hash(willRenew);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EditDomainWillRenewRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EditDomainWillRenewRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EditDomainWillRenewRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EditDomainWillRenewRequest is not found in the empty JSON string", EditDomainWillRenewRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EditDomainWillRenewRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EditDomainWillRenewRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EditDomainWillRenewRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EditDomainWillRenewRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EditDomainWillRenewRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EditDomainWillRenewRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EditDomainWillRenewRequest>() {
           @Override
           public void write(JsonWriter out, EditDomainWillRenewRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EditDomainWillRenewRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EditDomainWillRenewRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EditDomainWillRenewRequest
   * @throws IOException if the JSON string is invalid with respect to EditDomainWillRenewRequest
   */
  public static EditDomainWillRenewRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EditDomainWillRenewRequest.class);
  }

  /**
   * Convert an instance of EditDomainWillRenewRequest to an JSON string
   *
   * @return JSON string
   */
