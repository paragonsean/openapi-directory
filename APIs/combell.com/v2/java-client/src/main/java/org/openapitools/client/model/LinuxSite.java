...
public class LinuxSite {
  public static final String SERIALIZED_NAME_HOST_HEADERS = "host_headers";
  @SerializedName(SERIALIZED_NAME_HOST_HEADERS)
  private List<HostHeader> hostHeaders = new ArrayList<>();

  public static final String SERIALIZED_NAME_HTTP2_ENABLED = "http2_enabled";
  @SerializedName(SERIALIZED_NAME_HTTP2_ENABLED)
  private Boolean http2Enabled;

  public static final String SERIALIZED_NAME_HTTPS_REDIRECT_ENABLED = "https_redirect_enabled";
  @SerializedName(SERIALIZED_NAME_HTTPS_REDIRECT_ENABLED)
  ...
  public static final String SERIALIZED_NAME_SSL_ENABLED = "ssl_enabled";
  ...
  public LinuxSite hostHeaders(List<HostHeader> hostHeaders) {
    this.hostHeaders = hostHeaders;
    return this;
  }

  public LinuxSite addHostHeadersItem(HostHeader hostHeadersItem) {
    if (this.hostHeaders == null) {
      this.hostHeaders = new ArrayList<>();
    }
    this.hostHeaders.add(hostHeadersItem);
    return this;
  }
  ...
  public List<HostHeader> getHostHeaders() {
    return hostHeaders;
  }

  public void setHostHeaders(List<HostHeader> hostHeaders) {
    this.hostHeaders = hostHeaders;
  }


  public LinuxSite http2Enabled(Boolean http2Enabled) {
  ...
  public LinuxSite httpsRedirectEnabled(Boolean httpsRedirectEnabled) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getHttpsRedirectEnabled() {
    return httpsRedirectEnabled;
  }

  public void setHttpsRedirectEnabled(Boolean httpsRedirectEnabled) {
    this.httpsRedirectEnabled = httpsRedirectEnabled;
  }


  public LinuxSite name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LinuxSite path(String path) {
    this.path = path;
    return this;
  }
  ...
  public LinuxSite sslEnabled(Boolean sslEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    LinuxSite linuxSite = (LinuxSite) o;
    return Objects.equals(this.hostHeaders, linuxSite.hostHeaders) &&
        Objects.equals(this.http2Enabled, linuxSite.http2Enabled) &&
        Objects.equals(this.httpsRedirectEnabled, linuxSite.httpsRedirectEnabled) &&
        Objects.equals(this.name, linuxSite.name) &&
        Objects.equals(this.path, linuxSite.path) &&
        Objects.equals(this.sslEnabled, linuxSite.sslEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hostHeaders, http2Enabled, httpsRedirectEnabled, name, path, sslEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinuxSite {\n");
    sb.append("    hostHeaders: ").append(toIndentedString(hostHeaders)).append("\n");
    sb.append("    http2Enabled: ").append(toIndentedString(http2Enabled)).append("\n");
    sb.append("    httpsRedirectEnabled: ").append(toIndentedString(httpsRedirectEnabled)).append("\n");
  ...
  static {
    ...
    openapiFields.add("host_headers");
    openapiFields.add("http2_enabled");
    openapiFields.add("https_redirect_enabled");
    openapiFields.add("name");
    openapiFields.add("path");
    openapiFields.add("ssl_enabled");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinuxSite
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinuxSite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinuxSite is not found in the empty JSON string", LinuxSite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinuxSite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinuxSite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("host_headers") != null && !jsonObj.get("host_headers").isJsonNull()) {
        JsonArray jsonArrayhostHeaders = jsonObj.getAsJsonArray("host_headers");
        if (jsonArrayhostHeaders != null) {
          // ensure the json data is an array
          if (!jsonObj.get("host_headers").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `host_headers` to be an array in the JSON string but got `%s`", jsonObj.get("host_headers").toString()));
          }

          // validate the optional field `host_headers` (array)
          for (int i = 0; i < jsonArrayhostHeaders.size(); i++) {
            HostHeader.validateJsonElement(jsonArrayhostHeaders.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinuxSite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinuxSite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinuxSite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinuxSite.class));

       return (TypeAdapter<T>) new TypeAdapter<LinuxSite>() {
           @Override
           public void write(JsonWriter out, LinuxSite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinuxSite read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinuxSite given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinuxSite
   * @throws IOException if the JSON string is invalid with respect to LinuxSite
   */
  public static LinuxSite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinuxSite.class);
  }

  /**
   * Convert an instance of LinuxSite to an JSON string
   *
   * @return JSON string
   */
