...
public class AddHostHeaderRequest {
  ...
  public AddHostHeaderRequest domainName(String domainName) {
  ...
  public boolean equals(Object o) {
    ...
    AddHostHeaderRequest addHostHeaderRequest = (AddHostHeaderRequest) o;
    return Objects.equals(this.domainName, addHostHeaderRequest.domainName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddHostHeaderRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddHostHeaderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddHostHeaderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHostHeaderRequest is not found in the empty JSON string", AddHostHeaderRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddHostHeaderRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddHostHeaderRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHostHeaderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHostHeaderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHostHeaderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHostHeaderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHostHeaderRequest>() {
           @Override
           public void write(JsonWriter out, AddHostHeaderRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddHostHeaderRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddHostHeaderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddHostHeaderRequest
   * @throws IOException if the JSON string is invalid with respect to AddHostHeaderRequest
   */
  public static AddHostHeaderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHostHeaderRequest.class);
  }

  /**
   * Convert an instance of AddHostHeaderRequest to an JSON string
   *
   * @return JSON string
   */
