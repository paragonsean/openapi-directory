...
public class ScheduledTask {
  ...
  public static final String SERIALIZED_NAME_SCRIPT_LOCATION = "script_location";
  ...
  public ScheduledTask enabled(Boolean enabled) {
  ...
  public ScheduledTask id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ScheduledTask scriptLocation(String scriptLocation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cronExpression, scheduledTask.cronExpression) &&
        Objects.equals(this.enabled, scheduledTask.enabled) &&
        Objects.equals(this.id, scheduledTask.id) &&
        Objects.equals(this.scriptLocation, scheduledTask.scriptLocation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cronExpression, enabled, id, scriptLocation);
  }
  ...
  static {
    ...
    openapiFields.add("script_location");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduledTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduledTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduledTask is not found in the empty JSON string", ScheduledTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduledTask.openapiFields.contains(entry.getKey())) {
      ...
      if ((jsonObj.get("script_location") != null && !jsonObj.get("script_location").isJsonNull()) && !jsonObj.get("script_location").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `script_location` to be a primitive type in the JSON string but got `%s`", jsonObj.get("script_location").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduledTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduledTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduledTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduledTask.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduledTask>() {
           @Override
           public void write(JsonWriter out, ScheduledTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduledTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduledTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduledTask
   * @throws IOException if the JSON string is invalid with respect to ScheduledTask
   */
  public static ScheduledTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduledTask.class);
  }

  /**
   * Convert an instance of ScheduledTask to an JSON string
   *
   * @return JSON string
   */
