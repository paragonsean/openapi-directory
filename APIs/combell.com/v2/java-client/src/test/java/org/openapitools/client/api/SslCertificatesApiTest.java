...
public class SslCertificatesApiTest {
     ...
     */
    @Test
    public void downloadCertificateTest() throws ApiException {
        String sha1Fingerprint = null;
        SslCertificateFileFormat fileFormat = null;
        String password = null;
        String sha1Fingerprint2 = null;
        File response = api.downloadCertificate(sha1Fingerprint, fileFormat, password, sha1Fingerprint2);
     ...
     */
    @Test
    public void getSslCertificateTest() throws ApiException {
        String sha1Fingerprint = null;
        String sha1Fingerprint2 = null;
        SslCertificateDetail response = api.getSslCertificate(sha1Fingerprint, sha1Fingerprint2);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getSslCertificatesTest() throws ApiException {
        Integer skip = null;
        Integer take = null;
        List<SslCertificate> response = api.getSslCertificates(skip, take);
        // TODO: test validations
    }
