...
public class TemplateDefinitionNewLayout {
   ...
   */
  @JsonAdapter(RotaionEnum.Adapter.class)
  public enum RotaionEnum {
    NUMBER_0(0),
    ...
    public static RotaionEnum fromValue(Integer value) {
      for (RotaionEnum b : RotaionEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<RotaionEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RotaionEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RotaionEnum read(final JsonReader jsonReader) throws IOException {
        Integer value =  jsonReader.nextInt();
        return RotaionEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      Integer value = jsonElement.getAsInt();
      RotaionEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_ROTAION = "rotaion";
  @SerializedName(SERIALIZED_NAME_ROTAION)
  private RotaionEnum rotaion;
  ...
  public TemplateDefinitionNewLayout margins(TemplateDefinitionLayoutMargins margins) {
  ...
  public TemplateDefinitionNewLayout repeatLayout(TemplateDefinitionLayoutRepeatLayout repeatLayout) {
  ...
  public TemplateDefinitionNewLayout rotaion(RotaionEnum rotaion) {
   ...
   */
  @javax.annotation.Nullable
  public RotaionEnum getRotaion() {
    return rotaion;
  }

  public void setRotaion(RotaionEnum rotaion) {
    this.rotaion = rotaion;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emptyLabels, templateDefinitionNewLayout.emptyLabels) &&
        Objects.equals(this.format, templateDefinitionNewLayout.format) &&
        ...
        Objects.equals(this.rotaion, templateDefinitionNewLayout.rotaion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(emptyLabels, format, height, margins, orientation, repeatLayout, rotaion, unit, width);
  }
  ...
  public String toString() {
    ...
    sb.append("    rotaion: ").append(toIndentedString(rotaion)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `rotaion`
      if (jsonObj.get("rotaion") != null && !jsonObj.get("rotaion").isJsonNull()) {
        RotaionEnum.validateJsonElement(jsonObj.get("rotaion"));
      }
