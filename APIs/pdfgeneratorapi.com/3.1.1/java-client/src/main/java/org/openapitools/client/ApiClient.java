...
public class ApiClient {
    ...
    private String basePath = "https://us1.pdfgeneratorapi.com/api/v3";
    ...
    public ApiClient() {
        ...
        authentications.put("JSONWebTokenAuth", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://us1.pdfgeneratorapi.com/api/v3
