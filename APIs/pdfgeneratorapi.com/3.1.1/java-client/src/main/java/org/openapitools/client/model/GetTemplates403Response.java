...
public class GetTemplates403Response {
  /**
   * Error description
   */
  ...
  public GetTemplates403Response() {
  }

  public GetTemplates403Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates403Response status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTemplates403Response getTemplates403Response = (GetTemplates403Response) o;
    return Objects.equals(this.error, getTemplates403Response.error) &&
        Objects.equals(this.status, getTemplates403Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTemplates403Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTemplates403Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTemplates403Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTemplates403Response is not found in the empty JSON string", GetTemplates403Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates403Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates403Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTemplates403Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTemplates403Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTemplates403Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTemplates403Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTemplates403Response>() {
           @Override
           public void write(JsonWriter out, GetTemplates403Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTemplates403Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTemplates403Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTemplates403Response
   * @throws IOException if the JSON string is invalid with respect to GetTemplates403Response
   */
  public static GetTemplates403Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTemplates403Response.class);
  }

  /**
   * Convert an instance of GetTemplates403Response to an JSON string
   *
   * @return JSON string
   */
