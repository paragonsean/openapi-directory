...
public class GetTemplates500Response {
  ...
  public GetTemplates500Response() {
  }

  public GetTemplates500Response error(String error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates500Response status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTemplates500Response getTemplates500Response = (GetTemplates500Response) o;
    return Objects.equals(this.error, getTemplates500Response.error) &&
        Objects.equals(this.status, getTemplates500Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTemplates500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTemplates500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTemplates500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTemplates500Response is not found in the empty JSON string", GetTemplates500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTemplates500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTemplates500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTemplates500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTemplates500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTemplates500Response>() {
           @Override
           public void write(JsonWriter out, GetTemplates500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTemplates500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTemplates500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTemplates500Response
   * @throws IOException if the JSON string is invalid with respect to GetTemplates500Response
   */
  public static GetTemplates500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTemplates500Response.class);
  }

  /**
   * Convert an instance of GetTemplates500Response to an JSON string
   *
   * @return JSON string
   */
