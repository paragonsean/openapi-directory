...
import org.openapitools.client.model.BatchDataInner;
...
import org.openapitools.client.model.MergeTemplates200Response;
...
public class DocumentsApi {
    ...
    private okhttp3.Call mergeTemplateValidateBeforeCall(Integer templateId, Data data, String name, String format, String output, final ApiCallback _callback) throws ApiException {
        ...
        return mergeTemplateCall(templateId, data, name, format, output, _callback);
     ...
     * @param format Document format. The zip option will return a ZIP file with PDF files. (optional, default to pdf)
     * @param output Response format. With the url option, the document is stored for 30 days and automatically deleted. (optional, default to base64)
     * @return MergeTemplates200Response
     ...
     */
    public MergeTemplates200Response mergeTemplate(Integer templateId, Data data, String name, String format, String output) throws ApiException {
        ApiResponse<MergeTemplates200Response> localVarResp = mergeTemplateWithHttpInfo(templateId, data, name, format, output);
     ...
     * @param format Document format. The zip option will return a ZIP file with PDF files. (optional, default to pdf)
     * @param output Response format. With the url option, the document is stored for 30 days and automatically deleted. (optional, default to base64)
     * @return ApiResponse&lt;MergeTemplates200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MergeTemplates200Response> mergeTemplateWithHttpInfo(Integer templateId, Data data, String name, String format, String output) throws ApiException {
        okhttp3.Call localVarCall = mergeTemplateValidateBeforeCall(templateId, data, name, format, output, null);
        Type localVarReturnType = new TypeToken<MergeTemplates200Response>(){}.getType();
     ...
     */
    public okhttp3.Call mergeTemplateAsync(Integer templateId, Data data, String name, String format, String output, final ApiCallback<MergeTemplates200Response> _callback) throws ApiException {
     ...
     */
    public MergeTemplates200Response mergeTemplates(List<BatchDataInner> batchDataInner, String name, String format, String output) throws ApiException {
        ApiResponse<MergeTemplates200Response> localVarResp = mergeTemplatesWithHttpInfo(batchDataInner, name, format, output);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MergeTemplates200Response> mergeTemplatesWithHttpInfo(List<BatchDataInner> batchDataInner, String name, String format, String output) throws ApiException {
     ...
     */
    public okhttp3.Call mergeTemplatesAsync(List<BatchDataInner> batchDataInner, String name, String format, String output, final ApiCallback<MergeTemplates200Response> _callback) throws ApiException {
