...
public class TemplateDefinitionDataSettings {
  ...
  private List<Object> filterBy = new ArrayList<>();

  public static final String SERIALIZED_NAME_SORT_BY = "sortBy";
  @SerializedName(SERIALIZED_NAME_SORT_BY)
  private List<Object> sortBy = new ArrayList<>();

  public TemplateDefinitionDataSettings() {
  }

  public TemplateDefinitionDataSettings filterBy(List<Object> filterBy) {
    this.filterBy = filterBy;
    return this;
  }

  public TemplateDefinitionDataSettings addFilterByItem(Object filterByItem) {
  ...
  public TemplateDefinitionDataSettings sortBy(List<Object> sortBy) {
    this.sortBy = sortBy;
    return this;
  }

  public TemplateDefinitionDataSettings addSortByItem(Object sortByItem) {
    if (this.sortBy == null) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateDefinitionDataSettings templateDefinitionDataSettings = (TemplateDefinitionDataSettings) o;
    return Objects.equals(this.filterBy, templateDefinitionDataSettings.filterBy) &&
        Objects.equals(this.sortBy, templateDefinitionDataSettings.sortBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateDefinitionDataSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionDataSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionDataSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateDefinitionDataSettings is not found in the empty JSON string", TemplateDefinitionDataSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionDataSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionDataSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateDefinitionDataSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateDefinitionDataSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateDefinitionDataSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateDefinitionDataSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateDefinitionDataSettings>() {
           @Override
           public void write(JsonWriter out, TemplateDefinitionDataSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateDefinitionDataSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateDefinitionDataSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateDefinitionDataSettings
   * @throws IOException if the JSON string is invalid with respect to TemplateDefinitionDataSettings
   */
  public static TemplateDefinitionDataSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateDefinitionDataSettings.class);
  }

  /**
   * Convert an instance of TemplateDefinitionDataSettings to an JSON string
   *
   * @return JSON string
   */
