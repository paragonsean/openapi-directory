...
public class GetWorkspace200Response {
  public static final String SERIALIZED_NAME_RESPONSE = "response";
  @SerializedName(SERIALIZED_NAME_RESPONSE)
  private Workspace response;

  public GetWorkspace200Response() {
  }

  public GetWorkspace200Response response(Workspace response) {
  ...
  public Workspace getResponse() {
    return response;
  }

  public void setResponse(Workspace response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetWorkspace200Response getWorkspace200Response = (GetWorkspace200Response) o;
    return Objects.equals(this.response, getWorkspace200Response.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetWorkspace200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetWorkspace200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWorkspace200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetWorkspace200Response is not found in the empty JSON string", GetWorkspace200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWorkspace200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetWorkspace200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `response`
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        Workspace.validateJsonElement(jsonObj.get("response"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetWorkspace200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetWorkspace200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetWorkspace200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetWorkspace200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetWorkspace200Response>() {
           @Override
           public void write(JsonWriter out, GetWorkspace200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetWorkspace200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetWorkspace200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetWorkspace200Response
   * @throws IOException if the JSON string is invalid with respect to GetWorkspace200Response
   */
  public static GetWorkspace200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetWorkspace200Response.class);
  }

  /**
   * Convert an instance of GetWorkspace200Response to an JSON string
   *
   * @return JSON string
   */
