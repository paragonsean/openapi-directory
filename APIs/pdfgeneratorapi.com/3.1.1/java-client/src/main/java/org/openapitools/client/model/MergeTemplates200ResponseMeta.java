 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T11:28:59.586680-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class MergeTemplates200ResponseMeta {
  ...
  public MergeTemplates200ResponseMeta() {
  }

  public MergeTemplates200ResponseMeta contentType(String contentType) {
  ...
  public MergeTemplates200ResponseMeta displayName(String displayName) {
  ...
  public MergeTemplates200ResponseMeta encoding(String encoding) {
  ...
  public MergeTemplates200ResponseMeta name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeTemplates200ResponseMeta mergeTemplates200ResponseMeta = (MergeTemplates200ResponseMeta) o;
    return Objects.equals(this.contentType, mergeTemplates200ResponseMeta.contentType) &&
        Objects.equals(this.displayName, mergeTemplates200ResponseMeta.displayName) &&
        Objects.equals(this.encoding, mergeTemplates200ResponseMeta.encoding) &&
        Objects.equals(this.name, mergeTemplates200ResponseMeta.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contentType, displayName, encoding, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeTemplates200ResponseMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeTemplates200ResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeTemplates200ResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeTemplates200ResponseMeta is not found in the empty JSON string", MergeTemplates200ResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeTemplates200ResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeTemplates200ResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeTemplates200ResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeTemplates200ResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeTemplates200ResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeTemplates200ResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeTemplates200ResponseMeta>() {
           @Override
           public void write(JsonWriter out, MergeTemplates200ResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeTemplates200ResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeTemplates200ResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeTemplates200ResponseMeta
   * @throws IOException if the JSON string is invalid with respect to MergeTemplates200ResponseMeta
   */
  public static MergeTemplates200ResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeTemplates200ResponseMeta.class);
  }

  /**
   * Convert an instance of MergeTemplates200ResponseMeta to an JSON string
   *
   * @return JSON string
   */
