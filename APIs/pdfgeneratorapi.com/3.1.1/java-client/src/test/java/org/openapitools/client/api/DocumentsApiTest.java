...
public class DocumentsApiTest {
    ...
    public void mergeTemplateTest() throws ApiException {
        ...
        String format = null;
        String output = null;
        MergeTemplates200Response response = api.mergeTemplate(templateId, data, name, format, output);
    ...
    public void mergeTemplatesTest() throws ApiException {
        List<BatchDataInner> batchDataInner = null;
        String name = null;
        String format = null;
        String output = null;
        MergeTemplates200Response response = api.mergeTemplates(batchDataInner, name, format, output);
        // TODO: test validations
    }
