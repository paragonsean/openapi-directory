...
<a id="mergeTemplate"></a>
# **mergeTemplate**
> MergeTemplates200Response mergeTemplate(templateId, data, name, format, output)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      MergeTemplates200Response result = apiInstance.mergeTemplate(templateId, data, name, format, output);
...
<a id="mergeTemplates"></a>
# **mergeTemplates**
> MergeTemplates200Response mergeTemplates(batchDataInner, name, format, output)
...
public class Example {
  public static void main(String[] args) {
    ...
    String output = "base64"; // String | Response format. With the url option, the document is stored for 30 days and automatically deleted.
    try {
      MergeTemplates200Response result = apiInstance.mergeTemplates(batchDataInner, name, format, output);
      System.out.println(result);
    } catch (ApiException e) {
