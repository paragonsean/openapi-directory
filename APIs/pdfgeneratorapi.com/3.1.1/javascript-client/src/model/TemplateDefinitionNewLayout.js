...
import TemplateDefinitionLayoutMargins from './TemplateDefinitionLayoutMargins';
import TemplateDefinitionLayoutRepeatLayout from './TemplateDefinitionLayoutRepeatLayout';
...
class TemplateDefinitionNewLayout {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('margins')) {
                obj['margins'] = TemplateDefinitionLayoutMargins.constructFromObject(data['margins']);
            }
            if (data.hasOwnProperty('orientation')) {
                obj['orientation'] = ApiClient.convertToType(data['orientation'], 'String');
            }
            if (data.hasOwnProperty('repeatLayout')) {
                obj['repeatLayout'] = TemplateDefinitionLayoutRepeatLayout.constructFromObject(data['repeatLayout']);
            }
            if (data.hasOwnProperty('rotaion')) {
                obj['rotaion'] = ApiClient.convertToType(data['rotaion'], 'Number');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['margins']) { // data not null
          TemplateDefinitionLayoutMargins.validateJSON(data['margins']);
        }
        // ensure the json data is a string
        ...
        if (data['repeatLayout']) { // data not null
          TemplateDefinitionLayoutRepeatLayout.validateJSON(data['repeatLayout']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/TemplateDefinitionLayoutMargins} margins
 */
...
/**
 * @member {module:model/TemplateDefinitionLayoutRepeatLayout} repeatLayout
 */
