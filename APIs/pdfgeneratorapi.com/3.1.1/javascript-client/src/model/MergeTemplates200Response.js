...
import MergeTemplates200ResponseMeta from './MergeTemplates200ResponseMeta';

/**
 * The MergeTemplates200Response model module.
 * @module model/MergeTemplates200Response
 * @version 3.1.1
 */
class MergeTemplates200Response {
    /**
     * Constructs a new <code>MergeTemplates200Response</code>.
     * @alias module:model/MergeTemplates200Response
     */
    constructor() { 
        
        MergeTemplates200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeTemplates200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeTemplates200Response} obj Optional instance to populate.
     * @return {module:model/MergeTemplates200Response} The populated <code>MergeTemplates200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeTemplates200Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = MergeTemplates200ResponseMeta.constructFromObject(data['meta']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MergeTemplates200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeTemplates200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `meta`
        if (data['meta']) { // data not null
          MergeTemplates200ResponseMeta.validateJSON(data['meta']);
        }
...
/**
 * @member {module:model/MergeTemplates200ResponseMeta} meta
 */
MergeTemplates200Response.prototype['meta'] = undefined;

/**
 * Base64 encoded document if the output=base64 is used or URL to the document when the output=url is used.
 * @member {String} response
 */
MergeTemplates200Response.prototype['response'] = undefined;
...
export default MergeTemplates200Response;
