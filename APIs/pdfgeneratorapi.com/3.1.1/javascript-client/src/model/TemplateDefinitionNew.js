...
import TemplateDefinitionNewLayout from './TemplateDefinitionNewLayout';
import TemplateDefinitionPagesInner from './TemplateDefinitionPagesInner';
...
class TemplateDefinitionNew {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('layout')) {
                obj['layout'] = TemplateDefinitionNewLayout.constructFromObject(data['layout']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('pages')) {
                obj['pages'] = ApiClient.convertToType(data['pages'], [TemplateDefinitionPagesInner]);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of TemplateDefinitionNew.RequiredProperties) {
        ...
        if (data['layout']) { // data not null
          TemplateDefinitionNewLayout.validateJSON(data['layout']);
        }
        ...
        if (data['pages']) { // data not null
            ...
            for (const item of data['pages']) {
                TemplateDefinitionPagesInner.validateJSON(item);
            };
        }
        // ensure the json data is an array
...
export default TemplateDefinitionNew;
