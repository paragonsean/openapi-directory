...
/**
 * The MergeTemplates200ResponseMeta model module.
 * @module model/MergeTemplates200ResponseMeta
 * @version 3.1.1
 */
class MergeTemplates200ResponseMeta {
    /**
     * Constructs a new <code>MergeTemplates200ResponseMeta</code>.
     * @alias module:model/MergeTemplates200ResponseMeta
     */
    constructor() { 
        
        MergeTemplates200ResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeTemplates200ResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeTemplates200ResponseMeta} obj Optional instance to populate.
     * @return {module:model/MergeTemplates200ResponseMeta} The populated <code>MergeTemplates200ResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeTemplates200ResponseMeta();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeTemplates200ResponseMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeTemplates200ResponseMeta</code>.
     */
 ...
 */
MergeTemplates200ResponseMeta.prototype['content-type'] = undefined;

/**
 * Document name without the file extension.
 * @member {String} display_name
 */
MergeTemplates200ResponseMeta.prototype['display_name'] = undefined;

/**
 * Document encoding
 * @member {String} encoding
 */
MergeTemplates200ResponseMeta.prototype['encoding'] = undefined;

/**
 * Document name. This value is automatically generated if name attribute is not defined in request.
 * @member {String} name
 */
MergeTemplates200ResponseMeta.prototype['name'] = undefined;
...
export default MergeTemplates200ResponseMeta;
