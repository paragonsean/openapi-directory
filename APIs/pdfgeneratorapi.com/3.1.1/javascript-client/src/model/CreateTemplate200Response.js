...
/**
 * The CreateTemplate200Response model module.
 * @module model/CreateTemplate200Response
 * @version 3.1.1
 */
class CreateTemplate200Response {
    /**
     * Constructs a new <code>CreateTemplate200Response</code>.
     * @alias module:model/CreateTemplate200Response
     */
    constructor() { 
        
        CreateTemplate200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTemplate200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTemplate200Response} obj Optional instance to populate.
     * @return {module:model/CreateTemplate200Response} The populated <code>CreateTemplate200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTemplate200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = TemplateDefinition.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTemplate200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTemplate200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          TemplateDefinition.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/TemplateDefinition} response
 */
CreateTemplate200Response.prototype['response'] = undefined;
...
export default CreateTemplate200Response;
