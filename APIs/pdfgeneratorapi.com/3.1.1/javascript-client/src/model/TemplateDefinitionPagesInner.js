...
import TemplateDefinitionPagesInnerMargins from './TemplateDefinitionPagesInnerMargins';
...
class TemplateDefinitionPagesInner {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('margins')) {
                obj['margins'] = TemplateDefinitionPagesInnerMargins.constructFromObject(data['margins']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['margins']) { // data not null
          TemplateDefinitionPagesInnerMargins.validateJSON(data['margins']);
        }
...
/**
 * @member {module:model/TemplateDefinitionPagesInnerMargins} margins
 */
