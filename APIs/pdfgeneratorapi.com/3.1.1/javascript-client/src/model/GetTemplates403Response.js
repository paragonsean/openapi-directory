...
/**
 * The GetTemplates403Response model module.
 * @module model/GetTemplates403Response
 * @version 3.1.1
 */
class GetTemplates403Response {
    /**
     * Constructs a new <code>GetTemplates403Response</code>.
     * @alias module:model/GetTemplates403Response
     */
    constructor() { 
        
        GetTemplates403Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTemplates403Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTemplates403Response} obj Optional instance to populate.
     * @return {module:model/GetTemplates403Response} The populated <code>GetTemplates403Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTemplates403Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTemplates403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemplates403Response</code>.
     */
...
/**
 * Error description
 * @member {module:model/GetTemplates403Response.ErrorEnum} error
 */
GetTemplates403Response.prototype['error'] = undefined;

/**
 * HTTP Error code
 * @member {Number} status
 */
GetTemplates403Response.prototype['status'] = undefined;
 ...
 * @readonly
 */
GetTemplates403Response['ErrorEnum'] = {
...
export default GetTemplates403Response;
