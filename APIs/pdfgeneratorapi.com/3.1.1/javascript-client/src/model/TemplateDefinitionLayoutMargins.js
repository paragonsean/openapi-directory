...
/**
 * The TemplateDefinitionLayoutMargins model module.
 * @module model/TemplateDefinitionLayoutMargins
 * @version 3.1.1
 */
class TemplateDefinitionLayoutMargins {
    /**
     * Constructs a new <code>TemplateDefinitionLayoutMargins</code>.
     * Page margins in units
     * @alias module:model/TemplateDefinitionLayoutMargins
     */
    constructor() { 
        
        TemplateDefinitionLayoutMargins.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateDefinitionLayoutMargins</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateDefinitionLayoutMargins} obj Optional instance to populate.
     * @return {module:model/TemplateDefinitionLayoutMargins} The populated <code>TemplateDefinitionLayoutMargins</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateDefinitionLayoutMargins();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateDefinitionLayoutMargins</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateDefinitionLayoutMargins</code>.
     */
 ...
 */
TemplateDefinitionLayoutMargins.prototype['bottom'] = undefined;

/**
 * @member {Number} left
 */
TemplateDefinitionLayoutMargins.prototype['left'] = undefined;

/**
 * @member {Number} right
 */
TemplateDefinitionLayoutMargins.prototype['right'] = undefined;

/**
 * @member {Number} top
 */
TemplateDefinitionLayoutMargins.prototype['top'] = undefined;
...
export default TemplateDefinitionLayoutMargins;
