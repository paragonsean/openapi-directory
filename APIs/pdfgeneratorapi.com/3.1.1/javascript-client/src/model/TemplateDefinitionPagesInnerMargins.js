...
/**
 * The TemplateDefinitionPagesInnerMargins model module.
 * @module model/TemplateDefinitionPagesInnerMargins
 * @version 3.1.1
 */
class TemplateDefinitionPagesInnerMargins {
    /**
     * Constructs a new <code>TemplateDefinitionPagesInnerMargins</code>.
     * @alias module:model/TemplateDefinitionPagesInnerMargins
     */
    constructor() { 
        
        TemplateDefinitionPagesInnerMargins.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateDefinitionPagesInnerMargins</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateDefinitionPagesInnerMargins} obj Optional instance to populate.
     * @return {module:model/TemplateDefinitionPagesInnerMargins} The populated <code>TemplateDefinitionPagesInnerMargins</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateDefinitionPagesInnerMargins();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateDefinitionPagesInnerMargins</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateDefinitionPagesInnerMargins</code>.
     */
 ...
 */
TemplateDefinitionPagesInnerMargins.prototype['bottom'] = undefined;

/**
 * Page or label margin from right
 * @member {Number} right
 */
TemplateDefinitionPagesInnerMargins.prototype['right'] = undefined;
...
export default TemplateDefinitionPagesInnerMargins;
