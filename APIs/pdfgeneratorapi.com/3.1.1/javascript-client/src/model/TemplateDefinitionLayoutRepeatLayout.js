...
/**
 * The TemplateDefinitionLayoutRepeatLayout model module.
 * @module model/TemplateDefinitionLayoutRepeatLayout
 * @version 3.1.1
 */
class TemplateDefinitionLayoutRepeatLayout {
    /**
     * Constructs a new <code>TemplateDefinitionLayoutRepeatLayout</code>.
     * Defines page size if layout is repeated on the page e.g sheet labels
     * @alias module:model/TemplateDefinitionLayoutRepeatLayout
     */
    constructor() { 
        
        TemplateDefinitionLayoutRepeatLayout.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateDefinitionLayoutRepeatLayout</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateDefinitionLayoutRepeatLayout} obj Optional instance to populate.
     * @return {module:model/TemplateDefinitionLayoutRepeatLayout} The populated <code>TemplateDefinitionLayoutRepeatLayout</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateDefinitionLayoutRepeatLayout();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateDefinitionLayoutRepeatLayout</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateDefinitionLayoutRepeatLayout</code>.
     */
 ...
 * @member {module:model/TemplateDefinitionLayoutRepeatLayout.FormatEnum} format
 */
TemplateDefinitionLayoutRepeatLayout.prototype['format'] = undefined;

/**
 * Page height in units
 * @member {Number} height
 */
TemplateDefinitionLayoutRepeatLayout.prototype['height'] = undefined;

/**
 * Page width in units
 * @member {Number} width
 */
TemplateDefinitionLayoutRepeatLayout.prototype['width'] = undefined;
 ...
 * @readonly
 */
TemplateDefinitionLayoutRepeatLayout['FormatEnum'] = {
...
export default TemplateDefinitionLayoutRepeatLayout;
