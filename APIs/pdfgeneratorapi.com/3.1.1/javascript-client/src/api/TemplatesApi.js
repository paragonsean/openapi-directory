...
export default class TemplatesApi {
    ...
    */
     ...
     * @callback module:api/TemplatesApi~copyTemplateCallback
     ...
     * @param {module:api/TemplatesApi~copyTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @param {module:model/TemplateDefinitionNew} templateDefinitionNew Template configuration as JSON string
     ...
     * data is of type: {@link module:model/CreateTemplate200Response}
     */
    createTemplate(templateDefinitionNew, callback) {
      let postBody = templateDefinitionNew;
      // verify the required parameter 'templateDefinitionNew' is set
      if (templateDefinitionNew === undefined || templateDefinitionNew === null) {
        throw new Error("Missing the required parameter 'templateDefinitionNew' when calling createTemplate");
      }
     ...
     * @callback module:api/TemplatesApi~getEditorUrlCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TemplatesApi~getEditorUrlCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetEditorUrl200Response}
     */
    getEditorUrl(templateId, body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'templateId' is set
      if (templateId === undefined || templateId === null) {
        throw new Error("Missing the required parameter 'templateId' when calling getEditorUrl");
      }
     ...
     * @callback module:api/TemplatesApi~getTemplateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateTemplate200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} templateId Template unique identifier
     * @param {module:api/TemplatesApi~getTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateTemplate200Response}
     */
     ...
     * data is of type: {@link module:model/CreateTemplate200Response}
     */
    updateTemplate(templateId, templateDefinitionNew, callback) {
      let postBody = templateDefinitionNew;
      // verify the required parameter 'templateId' is set
      if (templateId === undefined || templateId === null) {
      ...
      // verify the required parameter 'templateDefinitionNew' is set
      if (templateDefinitionNew === undefined || templateDefinitionNew === null) {
        throw new Error("Missing the required parameter 'templateDefinitionNew' when calling updateTemplate");
      }
