...
export default class DocumentsApi {
    ...
    */
     ...
     * @callback module:api/DocumentsApi~mergeTemplateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MergeTemplates200Response} data The data returned by the service call.
     ...
     * @param {module:model/String} [format = 'pdf')] Document format. The zip option will return a ZIP file with PDF files.
     * @param {module:model/String} [output = 'base64')] Response format. With the url option, the document is stored for 30 days and automatically deleted.
     * @param {module:api/DocumentsApi~mergeTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MergeTemplates200Response}
     */
    mergeTemplate(templateId, data, opts, callback) {
      opts = opts || {};
      let postBody = data;
      ...
      let returnType = MergeTemplates200Response;
     ...
     * @callback module:api/DocumentsApi~mergeTemplatesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MergeTemplates200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Array.<module:model/BatchDataInner>} batchDataInner Data used to specify templates and data objects which are used to merge the template
     * @param {Object} opts Optional parameters
     * @param {String} [name] Document name, returned in the meta data.
     * @param {module:model/String} [format = 'pdf')] Document format. The zip option will return a ZIP file with PDF files.
     * @param {module:model/String} [output = 'base64')] Response format. With the url option, the document is stored for 30 days and automatically deleted.
     * @param {module:api/DocumentsApi~mergeTemplatesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MergeTemplates200Response}
     */
    mergeTemplates(batchDataInner, opts, callback) {
      opts = opts || {};
      let postBody = batchDataInner;
      // verify the required parameter 'batchDataInner' is set
      if (batchDataInner === undefined || batchDataInner === null) {
        throw new Error("Missing the required parameter 'batchDataInner' when calling mergeTemplates");
      }
