...
(function(root, factory) {
  ...
  describe('Workspace', function() {
    ...
    it('should have the property isMasterWorkspace (base name: "is_master_workspace")', function() {
      // uncomment below and update the code to test the property isMasterWorkspace
      //var instance = new PdfGeneratorApi.Workspace();
      //expect(instance).to.be();
    });
