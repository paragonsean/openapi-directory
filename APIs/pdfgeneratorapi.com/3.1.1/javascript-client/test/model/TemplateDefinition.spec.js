...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfGeneratorApi.TemplateDefinition();
  });
  ...
  describe('TemplateDefinition', function() {
    it('should create an instance of TemplateDefinition', function() {
      // uncomment below and update the code to test TemplateDefinition
      //var instance = new PdfGeneratorApi.TemplateDefinition();
      //expect(instance).to.be.a(PdfGeneratorApi.TemplateDefinition);
    });

    it('should have the property dataSettings (base name: "dataSettings")', function() {
      // uncomment below and update the code to test the property dataSettings
      //var instance = new PdfGeneratorApi.TemplateDefinition();
