...
(function(root, factory) {
  ...
  describe('TemplateDefinitionLayout', function() {
    ...
    it('should have the property emptyLabels (base name: "emptyLabels")', function() {
      // uncomment below and update the code to test the property emptyLabels
      //var instance = new PdfGeneratorApi.TemplateDefinitionLayout();
    ...
    it('should have the property repeatLayout (base name: "repeatLayout")', function() {
      // uncomment below and update the code to test the property repeatLayout
      //var instance = new PdfGeneratorApi.TemplateDefinitionLayout();
      //expect(instance).to.be();
    });
