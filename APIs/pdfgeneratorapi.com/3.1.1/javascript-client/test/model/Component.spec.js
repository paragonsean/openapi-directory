...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfGeneratorApi.Component();
  });
  ...
  describe('Component', function() {
    it('should create an instance of Component', function() {
      ...
      //var instance = new PdfGeneratorApi.Component();
      //expect(instance).to.be.a(PdfGeneratorApi.Component);
    });
    ...
    it('should have the property dataIndex (base name: "dataIndex")', function() {
      // uncomment below and update the code to test the property dataIndex
      //var instance = new PdfGeneratorApi.Component();
      //expect(instance).to.be();
    });
