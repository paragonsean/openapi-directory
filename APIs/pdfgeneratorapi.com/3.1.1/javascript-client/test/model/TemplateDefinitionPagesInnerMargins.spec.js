...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfGeneratorApi.TemplateDefinitionPagesInnerMargins();
  });
  ...
  describe('TemplateDefinitionPagesInnerMargins', function() {
    it('should create an instance of TemplateDefinitionPagesInnerMargins', function() {
      // uncomment below and update the code to test TemplateDefinitionPagesInnerMargins
      //var instance = new PdfGeneratorApi.TemplateDefinitionPagesInnerMargins();
      //expect(instance).to.be.a(PdfGeneratorApi.TemplateDefinitionPagesInnerMargins);
    });
