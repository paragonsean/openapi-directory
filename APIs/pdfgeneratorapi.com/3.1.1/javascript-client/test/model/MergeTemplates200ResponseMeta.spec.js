...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfGeneratorApi.MergeTemplates200ResponseMeta();
  });
  ...
  describe('MergeTemplates200ResponseMeta', function() {
    it('should create an instance of MergeTemplates200ResponseMeta', function() {
      // uncomment below and update the code to test MergeTemplates200ResponseMeta
      //var instance = new PdfGeneratorApi.MergeTemplates200ResponseMeta();
      //expect(instance).to.be.a(PdfGeneratorApi.MergeTemplates200ResponseMeta);
    });
