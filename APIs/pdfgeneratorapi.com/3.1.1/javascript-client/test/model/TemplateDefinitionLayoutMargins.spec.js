...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfGeneratorApi.TemplateDefinitionLayoutMargins();
  });
  ...
  describe('TemplateDefinitionLayoutMargins', function() {
    it('should create an instance of TemplateDefinitionLayoutMargins', function() {
      // uncomment below and update the code to test TemplateDefinitionLayoutMargins
      //var instance = new PdfGeneratorApi.TemplateDefinitionLayoutMargins();
      //expect(instance).to.be.a(PdfGeneratorApi.TemplateDefinitionLayoutMargins);
    });
