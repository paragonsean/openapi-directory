...
(function(root, factory) {
  ...
  describe('TemplateDefinitionEditor', function() {
    ...
    it('should have the property heightMultiplier (base name: "heightMultiplier")', function() {
      // uncomment below and update the code to test the property heightMultiplier
      //var instance = new PdfGeneratorApi.TemplateDefinitionEditor();
