...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdfGeneratorApi.TemplateDefinitionLayoutRepeatLayout();
  });
  ...
  describe('TemplateDefinitionLayoutRepeatLayout', function() {
    it('should create an instance of TemplateDefinitionLayoutRepeatLayout', function() {
      // uncomment below and update the code to test TemplateDefinitionLayoutRepeatLayout
      //var instance = new PdfGeneratorApi.TemplateDefinitionLayoutRepeatLayout();
      //expect(instance).to.be.a(PdfGeneratorApi.TemplateDefinitionLayoutRepeatLayout);
    });
