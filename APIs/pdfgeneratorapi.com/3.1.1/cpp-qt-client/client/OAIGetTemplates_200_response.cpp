...
#include "OAIGetTemplates_200_response.h"
...
OAIGetTemplates_200_response::OAIGetTemplates_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTemplates_200_response::OAIGetTemplates_200_response() {
    this->initializeModel();
}

OAIGetTemplates_200_response::~OAIGetTemplates_200_response() {}

void OAIGetTemplates_200_response::initializeModel() {

    m_response_isSet = false;
    m_response_isValid = false;
}

void OAIGetTemplates_200_response::fromJson(QString jsonString) {
...
void OAIGetTemplates_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetTemplates_200_response::asJson() const {
...
QJsonObject OAIGetTemplates_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAITemplate> OAIGetTemplates_200_response::getResponse() const {
    return m_response;
}
void OAIGetTemplates_200_response::setResponse(const QList<OAITemplate> &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIGetTemplates_200_response::is_response_Set() const{
    return m_response_isSet;
}

bool OAIGetTemplates_200_response::is_response_Valid() const{
    return m_response_isValid;
}

bool OAIGetTemplates_200_response::isSet() const {
...
bool OAIGetTemplates_200_response::isValid() const {
