...
/*
 * OAITemplateDefinition_dataSettings.h
 *
 * Defines filter and sort option for root data set.
 */

#ifndef OAITemplateDefinition_dataSettings_H
#define OAITemplateDefinition_dataSettings_H
...
class OAITemplateDefinition_dataSettings : public OAIObject {
public:
    OAITemplateDefinition_dataSettings();
    OAITemplateDefinition_dataSettings(QString json);
    ~OAITemplateDefinition_dataSettings() override;
    ...
    QList<OAIObject> getFilterBy() const;
    void setFilterBy(const QList<OAIObject> &filter_by);
    bool is_filter_by_Set() const;
    bool is_filter_by_Valid() const;

    QList<OAIObject> getSortBy() const;
    void setSortBy(const QList<OAIObject> &sort_by);
...
private:
    ...
    QList<OAIObject> m_filter_by;
    bool m_filter_by_isSet;
    bool m_filter_by_isValid;

    QList<OAIObject> m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition_dataSettings)

#endif // OAITemplateDefinition_dataSettings_H
