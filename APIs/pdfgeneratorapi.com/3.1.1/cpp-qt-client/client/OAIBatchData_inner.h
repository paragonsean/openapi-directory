...
/*
 * OAIBatchData_inner.h
 *
 * 
 */

#ifndef OAIBatchData_inner_H
#define OAIBatchData_inner_H
...
class OAIBatchData_inner : public OAIObject {
public:
    OAIBatchData_inner();
    OAIBatchData_inner(QString json);
    ~OAIBatchData_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchData_inner)

#endif // OAIBatchData_inner_H
