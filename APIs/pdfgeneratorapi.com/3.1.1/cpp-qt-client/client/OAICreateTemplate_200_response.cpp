...
#include "OAICreateTemplate_200_response.h"
...
OAICreateTemplate_200_response::OAICreateTemplate_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTemplate_200_response::OAICreateTemplate_200_response() {
    this->initializeModel();
}

OAICreateTemplate_200_response::~OAICreateTemplate_200_response() {}

void OAICreateTemplate_200_response::initializeModel() {

    m_response_isSet = false;
    m_response_isValid = false;
}

void OAICreateTemplate_200_response::fromJson(QString jsonString) {
...
void OAICreateTemplate_200_response::fromJsonObject(QJsonObject json) {
...
QString OAICreateTemplate_200_response::asJson() const {
...
QJsonObject OAICreateTemplate_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_response.isSet()) {
...
OAITemplateDefinition OAICreateTemplate_200_response::getResponse() const {
    return m_response;
}
void OAICreateTemplate_200_response::setResponse(const OAITemplateDefinition &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAICreateTemplate_200_response::is_response_Set() const{
    return m_response_isSet;
}

bool OAICreateTemplate_200_response::is_response_Valid() const{
    return m_response_isValid;
}

bool OAICreateTemplate_200_response::isSet() const {
...
bool OAICreateTemplate_200_response::isValid() const {
