...
QString OAITemplate::getModified() const {
    return m_modified;
}
void OAITemplate::setModified(const QString &modified) {
    m_modified = modified;
    m_modified_isSet = true;
}

bool OAITemplate::is_modified_Set() const{
    return m_modified_isSet;
}

bool OAITemplate::is_modified_Valid() const{
...
bool OAITemplate::isOwner() const {
    return m_owner;
}
void OAITemplate::setOwner(const bool &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAITemplate::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAITemplate::is_owner_Valid() const{
    return m_owner_isValid;
}

QList<QString> OAITemplate::getTags() const {
    return m_tags;
}
void OAITemplate::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITemplate::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITemplate::is_tags_Valid() const{
