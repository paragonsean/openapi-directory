...
OAIGetEditorUrl_200_response::OAIGetEditorUrl_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEditorUrl_200_response::OAIGetEditorUrl_200_response() {
    this->initializeModel();
}

OAIGetEditorUrl_200_response::~OAIGetEditorUrl_200_response() {}

void OAIGetEditorUrl_200_response::initializeModel() {

    m_response_isSet = false;
    m_response_isValid = false;
}

void OAIGetEditorUrl_200_response::fromJson(QString jsonString) {
...
void OAIGetEditorUrl_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetEditorUrl_200_response::asJson() const {
...
QJsonObject OAIGetEditorUrl_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_response_isSet) {
...
QString OAIGetEditorUrl_200_response::getResponse() const {
    return m_response;
}
void OAIGetEditorUrl_200_response::setResponse(const QString &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIGetEditorUrl_200_response::is_response_Set() const{
    return m_response_isSet;
}

bool OAIGetEditorUrl_200_response::is_response_Valid() const{
    return m_response_isValid;
}

bool OAIGetEditorUrl_200_response::isSet() const {
...
bool OAIGetEditorUrl_200_response::isValid() const {
