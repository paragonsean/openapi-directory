...
void OAIComponent::initializeModel() {
    ...
    m_data_index_isSet = false;
    m_data_index_isValid = false;
...
void OAIComponent::fromJsonObject(QJsonObject json) {
    ...
    m_cls_isValid = ::OpenAPI::fromJsonValue(m_cls, json[QString("cls")]);
    m_cls_isSet = !json[QString("cls")].isNull() && m_cls_isValid;

    m_data_index_isValid = ::OpenAPI::fromJsonValue(m_data_index, json[QString("dataIndex")]);
    m_data_index_isSet = !json[QString("dataIndex")].isNull() && m_data_index_isValid;
...
QJsonObject OAIComponent::asJsonObject() const {
    QJsonObject obj;
    if (m_cls_isSet) {
        obj.insert(QString("cls"), ::OpenAPI::toJsonValue(m_cls));
    }
    if (m_data_index_isSet) {
        obj.insert(QString("dataIndex"), ::OpenAPI::toJsonValue(m_data_index));
    }
    if (m_height_isSet) {
...
QString OAIComponent::getCls() const {
    return m_cls;
}
void OAIComponent::setCls(const QString &cls) {
    m_cls = cls;
    m_cls_isSet = true;
}

bool OAIComponent::is_cls_Set() const{
    return m_cls_isSet;
}

bool OAIComponent::is_cls_Valid() const{
    return m_cls_isValid;
}

QString OAIComponent::getDataIndex() const {
    return m_data_index;
}
void OAIComponent::setDataIndex(const QString &data_index) {
    m_data_index = data_index;
    m_data_index_isSet = true;
}

bool OAIComponent::is_data_index_Set() const{
    return m_data_index_isSet;
}

bool OAIComponent::is_data_index_Valid() const{
    return m_data_index_isValid;
}

double OAIComponent::getHeight() const {
    return m_height;
}
void OAIComponent::setHeight(const double &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIComponent::is_height_Set() const{
    return m_height_isSet;
}

bool OAIComponent::is_height_Valid() const{
...
double OAIComponent::getLeft() const {
    return m_left;
}
void OAIComponent::setLeft(const double &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIComponent::is_left_Set() const{
    return m_left_isSet;
}

bool OAIComponent::is_left_Valid() const{
    return m_left_isValid;
}

double OAIComponent::getTop() const {
    return m_top;
}
void OAIComponent::setTop(const double &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIComponent::is_top_Set() const{
    return m_top_isSet;
}

bool OAIComponent::is_top_Valid() const{
    return m_top_isValid;
}

QString OAIComponent::getValue() const {
    return m_value;
}
void OAIComponent::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIComponent::is_value_Set() const{
    return m_value_isSet;
}

bool OAIComponent::is_value_Valid() const{
    return m_value_isValid;
}

double OAIComponent::getWidth() const {
    return m_width;
}
void OAIComponent::setWidth(const double &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIComponent::is_width_Set() const{
    return m_width_isSet;
}

bool OAIComponent::is_width_Valid() const{
    return m_width_isValid;
}

qint32 OAIComponent::getZindex() const {
    return m_zindex;
}
void OAIComponent::setZindex(const qint32 &zindex) {
    m_zindex = zindex;
    m_zindex_isSet = true;
}

bool OAIComponent::is_zindex_Set() const{
    return m_zindex_isSet;
}

bool OAIComponent::is_zindex_Valid() const{
