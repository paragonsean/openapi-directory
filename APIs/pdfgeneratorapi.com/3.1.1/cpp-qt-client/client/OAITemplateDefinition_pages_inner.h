...
/*
 * OAITemplateDefinition_pages_inner.h
 *
 * 
 */

#ifndef OAITemplateDefinition_pages_inner_H
#define OAITemplateDefinition_pages_inner_H
...
namespace OpenAPI {
class OAIComponent;
class OAITemplateDefinition_pages_inner_margins;

class OAITemplateDefinition_pages_inner : public OAIObject {
public:
    OAITemplateDefinition_pages_inner();
    OAITemplateDefinition_pages_inner(QString json);
    ~OAITemplateDefinition_pages_inner() override;
    ...
    QList<OAIComponent> getComponents() const;
    void setComponents(const QList<OAIComponent> &components);
    ...
    OAITemplateDefinition_pages_inner_margins getMargins() const;
    void setMargins(const OAITemplateDefinition_pages_inner_margins &margins);
...
private:
    ...
    QList<OAIComponent> m_components;
    ...
    OAITemplateDefinition_pages_inner_margins m_margins;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition_pages_inner)

#endif // OAITemplateDefinition_pages_inner_H
