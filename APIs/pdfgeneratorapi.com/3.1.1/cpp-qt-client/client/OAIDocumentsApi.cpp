...
void OAIDocumentsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("mergeTemplate", defaultConf);
    _serverIndices.insert("mergeTemplate", 0);
    _serverConfigs.insert("mergeTemplates", defaultConf);
    _serverIndices.insert("mergeTemplates", 0);
}
...
void OAIDocumentsApi::mergeTemplate(const qint32 &template_id, const OAIData &oai_data, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &output) {
    QString fullPath = QString(_serverConfigs["mergeTemplate"][_serverIndices.value("mergeTemplate")].URL()+"/templates/templateId/output");
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("templateId")).append(querySuffix).append(QUrl::toPercentEncoding(template_id));
    }
    if (name.hasValue())
    {
        queryStyle = "form";
...

    {
        ...
        QByteArray output = oai_data.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDocumentsApi::mergeTemplateCallback);
...
void OAIDocumentsApi::mergeTemplateCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIMergeTemplates_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mergeTemplateSignal(output);
        Q_EMIT mergeTemplateSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mergeTemplateSignalE(output, error_type, error_str);
        Q_EMIT mergeTemplateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mergeTemplateSignalError(output, error_type, error_str);
        Q_EMIT mergeTemplateSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDocumentsApi::mergeTemplates(const QList<OAIBatchData_inner> &oai_batch_data_inner, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &output) {
    QString fullPath = QString(_serverConfigs["mergeTemplates"][_serverIndices.value("mergeTemplates")].URL()+"/templates/output");
    ...
    {
        QJsonDocument doc(::OpenAPI::toJsonValue(oai_batch_data_inner).toArray());
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDocumentsApi::mergeTemplatesCallback);
    connect(this, &OAIDocumentsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDocumentsApi::mergeTemplatesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mergeTemplatesSignal(output);
        Q_EMIT mergeTemplatesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mergeTemplatesSignalE(output, error_type, error_str);
        Q_EMIT mergeTemplatesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mergeTemplatesSignalError(output, error_type, error_str);
        Q_EMIT mergeTemplatesSignalErrorFull(worker, error_type, error_str);
    }
}
