...
OAIDeleteTemplate_200_response::OAIDeleteTemplate_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTemplate_200_response::OAIDeleteTemplate_200_response() {
    this->initializeModel();
}

OAIDeleteTemplate_200_response::~OAIDeleteTemplate_200_response() {}

void OAIDeleteTemplate_200_response::initializeModel() {

    m_response_isSet = false;
    m_response_isValid = false;
}

void OAIDeleteTemplate_200_response::fromJson(QString jsonString) {
...
void OAIDeleteTemplate_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTemplate_200_response::asJson() const {
...
QJsonObject OAIDeleteTemplate_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_response.isSet()) {
...
OAIDeleteTemplate_200_response_response OAIDeleteTemplate_200_response::getResponse() const {
    return m_response;
}
void OAIDeleteTemplate_200_response::setResponse(const OAIDeleteTemplate_200_response_response &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIDeleteTemplate_200_response::is_response_Set() const{
    return m_response_isSet;
}

bool OAIDeleteTemplate_200_response::is_response_Valid() const{
    return m_response_isValid;
}

bool OAIDeleteTemplate_200_response::isSet() const {
...
bool OAIDeleteTemplate_200_response::isValid() const {
