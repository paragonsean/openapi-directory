...
/*
 * OAIDeleteTemplate_200_response_response.h
 *
 * 
 */

#ifndef OAIDeleteTemplate_200_response_response_H
#define OAIDeleteTemplate_200_response_response_H
...
class OAIDeleteTemplate_200_response_response : public OAIObject {
public:
    OAIDeleteTemplate_200_response_response();
    OAIDeleteTemplate_200_response_response(QString json);
    ~OAIDeleteTemplate_200_response_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTemplate_200_response_response)

#endif // OAIDeleteTemplate_200_response_response_H
