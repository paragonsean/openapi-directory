...
/*
 * OAITemplateDefinition_layout_repeatLayout.h
 *
 * Defines page size if layout is repeated on the page e.g sheet labels
 */

#ifndef OAITemplateDefinition_layout_repeatLayout_H
#define OAITemplateDefinition_layout_repeatLayout_H
...
class OAITemplateDefinition_layout_repeatLayout : public OAIObject {
public:
    OAITemplateDefinition_layout_repeatLayout();
    OAITemplateDefinition_layout_repeatLayout(QString json);
    ~OAITemplateDefinition_layout_repeatLayout() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition_layout_repeatLayout)

#endif // OAITemplateDefinition_layout_repeatLayout_H
