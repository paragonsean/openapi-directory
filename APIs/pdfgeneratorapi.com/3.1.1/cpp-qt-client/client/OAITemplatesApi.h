...
#include "OAIGetEditorUrl_200_response.h"
...
#include "OAIObject.h"
#include "OAITemplateDefinitionNew.h"
#include <QString>
...
public:
    ...
    */
    virtual void copyTemplate(const qint32 &template_id, const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  oai_template_definition_new OAITemplateDefinitionNew [required]
    */
    virtual void createTemplate(const OAITemplateDefinitionNew &oai_template_definition_new);

    /**
    * @param[in]  template_id qint32 [required]
    */
    virtual void deleteTemplate(const qint32 &template_id);
    ...
    */
    virtual void getEditorUrl(const qint32 &template_id, const OAIObject &body, const ::OpenAPI::OptionalParam<QString> &language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  template_id qint32 [required]
    */
    virtual void getTemplate(const qint32 &template_id);
    ...
    * @param[in]  oai_template_definition_new OAITemplateDefinitionNew [required]
    */
    virtual void updateTemplate(const qint32 &template_id, const OAITemplateDefinitionNew &oai_template_definition_new);
...
private:
    ...
    void getEditorUrlCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void copyTemplateSignal(OAICreateTemplate_200_response summary);
    void createTemplateSignal(OAICreateTemplate_200_response summary);
    void deleteTemplateSignal(OAIDeleteTemplate_200_response summary);
    void getEditorUrlSignal(OAIGetEditorUrl_200_response summary);
    void getTemplateSignal(OAICreateTemplate_200_response summary);
    void getTemplatesSignal(OAIGetTemplates_200_response summary);
    void updateTemplateSignal(OAICreateTemplate_200_response summary);


    void copyTemplateSignalFull(OAIHttpRequestWorker *worker, OAICreateTemplate_200_response summary);
    void createTemplateSignalFull(OAIHttpRequestWorker *worker, OAICreateTemplate_200_response summary);
    void deleteTemplateSignalFull(OAIHttpRequestWorker *worker, OAIDeleteTemplate_200_response summary);
    void getEditorUrlSignalFull(OAIHttpRequestWorker *worker, OAIGetEditorUrl_200_response summary);
    void getTemplateSignalFull(OAIHttpRequestWorker *worker, OAICreateTemplate_200_response summary);
    void getTemplatesSignalFull(OAIHttpRequestWorker *worker, OAIGetTemplates_200_response summary);
    void updateTemplateSignalFull(OAIHttpRequestWorker *worker, OAICreateTemplate_200_response summary);

    Q_DECL_DEPRECATED_X("Use copyTemplateSignalError() instead")
    void copyTemplateSignalE(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void copyTemplateSignalError(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use createTemplateSignalError() instead")
    void createTemplateSignalE(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createTemplateSignalError(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteTemplateSignalError() instead")
    void deleteTemplateSignalE(OAIDeleteTemplate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteTemplateSignalError(OAIDeleteTemplate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getEditorUrlSignalError() instead")
    void getEditorUrlSignalE(OAIGetEditorUrl_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getEditorUrlSignalError(OAIGetEditorUrl_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTemplateSignalError() instead")
    void getTemplateSignalE(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTemplateSignalError(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTemplatesSignalError() instead")
    void getTemplatesSignalE(OAIGetTemplates_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTemplatesSignalError(OAIGetTemplates_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateTemplateSignalError() instead")
    void updateTemplateSignalE(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateTemplateSignalError(OAICreateTemplate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getEditorUrlSignalErrorFull() instead")
    void getEditorUrlSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getEditorUrlSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
