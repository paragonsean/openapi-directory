...
OAITemplateDefinitionNew::OAITemplateDefinitionNew(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateDefinitionNew::OAITemplateDefinitionNew() {
    this->initializeModel();
}

OAITemplateDefinitionNew::~OAITemplateDefinitionNew() {}

void OAITemplateDefinitionNew::initializeModel() {
...
void OAITemplateDefinitionNew::fromJson(QString jsonString) {
...
void OAITemplateDefinitionNew::fromJsonObject(QJsonObject json) {
...
QString OAITemplateDefinitionNew::asJson() const {
...
QJsonObject OAITemplateDefinitionNew::asJsonObject() const {
    QJsonObject obj;
    if (m_is_draft_isSet) {
...
bool OAITemplateDefinitionNew::isIsDraft() const {
    return m_is_draft;
}
void OAITemplateDefinitionNew::setIsDraft(const bool &is_draft) {
    m_is_draft = is_draft;
    m_is_draft_isSet = true;
}

bool OAITemplateDefinitionNew::is_is_draft_Set() const{
    return m_is_draft_isSet;
}

bool OAITemplateDefinitionNew::is_is_draft_Valid() const{
    return m_is_draft_isValid;
}

OAITemplateDefinitionNew_layout OAITemplateDefinitionNew::getLayout() const {
    return m_layout;
}
void OAITemplateDefinitionNew::setLayout(const OAITemplateDefinitionNew_layout &layout) {
    m_layout = layout;
    m_layout_isSet = true;
}

bool OAITemplateDefinitionNew::is_layout_Set() const{
    return m_layout_isSet;
}

bool OAITemplateDefinitionNew::is_layout_Valid() const{
    return m_layout_isValid;
}

QString OAITemplateDefinitionNew::getName() const {
    return m_name;
}
void OAITemplateDefinitionNew::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITemplateDefinitionNew::is_name_Set() const{
    return m_name_isSet;
}

bool OAITemplateDefinitionNew::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAITemplateDefinition_pages_inner> OAITemplateDefinitionNew::getPages() const {
    return m_pages;
}
void OAITemplateDefinitionNew::setPages(const QList<OAITemplateDefinition_pages_inner> &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAITemplateDefinitionNew::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAITemplateDefinitionNew::is_pages_Valid() const{
    return m_pages_isValid;
}

QList<QString> OAITemplateDefinitionNew::getTags() const {
    return m_tags;
}
void OAITemplateDefinitionNew::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITemplateDefinitionNew::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITemplateDefinitionNew::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITemplateDefinitionNew::isSet() const {
...
bool OAITemplateDefinitionNew::isValid() const {
