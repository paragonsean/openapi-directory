...
public:
    ...
    bool isIsMasterWorkspace() const;
    void setIsMasterWorkspace(const bool &is_master_workspace);
    bool is_is_master_workspace_Set() const;
    bool is_is_master_workspace_Valid() const;
...
private:
    ...
    bool m_is_master_workspace;
    bool m_is_master_workspace_isSet;
    bool m_is_master_workspace_isValid;
};
