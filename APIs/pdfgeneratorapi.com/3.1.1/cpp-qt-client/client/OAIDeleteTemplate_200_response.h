...
/*
 * OAIDeleteTemplate_200_response.h
 *
 * 
 */

#ifndef OAIDeleteTemplate_200_response_H
#define OAIDeleteTemplate_200_response_H
...
namespace OpenAPI {
class OAIDeleteTemplate_200_response_response;

class OAIDeleteTemplate_200_response : public OAIObject {
public:
    OAIDeleteTemplate_200_response();
    OAIDeleteTemplate_200_response(QString json);
    ~OAIDeleteTemplate_200_response() override;
    ...
    OAIDeleteTemplate_200_response_response getResponse() const;
    void setResponse(const OAIDeleteTemplate_200_response_response &response);
...
private:
    ...
    OAIDeleteTemplate_200_response_response m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTemplate_200_response)

#endif // OAIDeleteTemplate_200_response_H
