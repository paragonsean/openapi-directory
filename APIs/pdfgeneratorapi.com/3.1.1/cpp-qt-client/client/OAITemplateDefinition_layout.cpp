...
OAITemplateDefinition_layout::OAITemplateDefinition_layout(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateDefinition_layout::OAITemplateDefinition_layout() {
    this->initializeModel();
}

OAITemplateDefinition_layout::~OAITemplateDefinition_layout() {}

void OAITemplateDefinition_layout::initializeModel() {
...
void OAITemplateDefinition_layout::fromJson(QString jsonString) {
...
void OAITemplateDefinition_layout::fromJsonObject(QJsonObject json) {
...
QString OAITemplateDefinition_layout::asJson() const {
...
QJsonObject OAITemplateDefinition_layout::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAITemplateDefinition_layout::getEmptyLabels() const {
    return m_empty_labels;
}
void OAITemplateDefinition_layout::setEmptyLabels(const qint32 &empty_labels) {
    m_empty_labels = empty_labels;
    m_empty_labels_isSet = true;
}

bool OAITemplateDefinition_layout::is_empty_labels_Set() const{
    return m_empty_labels_isSet;
}

bool OAITemplateDefinition_layout::is_empty_labels_Valid() const{
    return m_empty_labels_isValid;
}

QString OAITemplateDefinition_layout::getFormat() const {
    return m_format;
}
void OAITemplateDefinition_layout::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAITemplateDefinition_layout::is_format_Set() const{
    return m_format_isSet;
}

bool OAITemplateDefinition_layout::is_format_Valid() const{
    return m_format_isValid;
}

double OAITemplateDefinition_layout::getHeight() const {
    return m_height;
}
void OAITemplateDefinition_layout::setHeight(const double &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAITemplateDefinition_layout::is_height_Set() const{
    return m_height_isSet;
}

bool OAITemplateDefinition_layout::is_height_Valid() const{
    return m_height_isValid;
}

OAITemplateDefinition_layout_margins OAITemplateDefinition_layout::getMargins() const {
    return m_margins;
}
void OAITemplateDefinition_layout::setMargins(const OAITemplateDefinition_layout_margins &margins) {
    m_margins = margins;
    m_margins_isSet = true;
}

bool OAITemplateDefinition_layout::is_margins_Set() const{
    return m_margins_isSet;
}

bool OAITemplateDefinition_layout::is_margins_Valid() const{
    return m_margins_isValid;
}

QString OAITemplateDefinition_layout::getOrientation() const {
    return m_orientation;
}
void OAITemplateDefinition_layout::setOrientation(const QString &orientation) {
    m_orientation = orientation;
    m_orientation_isSet = true;
}

bool OAITemplateDefinition_layout::is_orientation_Set() const{
    return m_orientation_isSet;
}

bool OAITemplateDefinition_layout::is_orientation_Valid() const{
    return m_orientation_isValid;
}

OAITemplateDefinition_layout_repeatLayout OAITemplateDefinition_layout::getRepeatLayout() const {
    return m_repeat_layout;
}
void OAITemplateDefinition_layout::setRepeatLayout(const OAITemplateDefinition_layout_repeatLayout &repeat_layout) {
    m_repeat_layout = repeat_layout;
    m_repeat_layout_isSet = true;
}

bool OAITemplateDefinition_layout::is_repeat_layout_Set() const{
    return m_repeat_layout_isSet;
}

bool OAITemplateDefinition_layout::is_repeat_layout_Valid() const{
    return m_repeat_layout_isValid;
}

qint32 OAITemplateDefinition_layout::getRotation() const {
    return m_rotation;
}
void OAITemplateDefinition_layout::setRotation(const qint32 &rotation) {
    m_rotation = rotation;
    m_rotation_isSet = true;
}

bool OAITemplateDefinition_layout::is_rotation_Set() const{
    return m_rotation_isSet;
}

bool OAITemplateDefinition_layout::is_rotation_Valid() const{
    return m_rotation_isValid;
}

QString OAITemplateDefinition_layout::getUnit() const {
    return m_unit;
}
void OAITemplateDefinition_layout::setUnit(const QString &unit) {
    m_unit = unit;
    m_unit_isSet = true;
}

bool OAITemplateDefinition_layout::is_unit_Set() const{
    return m_unit_isSet;
}

bool OAITemplateDefinition_layout::is_unit_Valid() const{
    return m_unit_isValid;
}

double OAITemplateDefinition_layout::getWidth() const {
    return m_width;
}
void OAITemplateDefinition_layout::setWidth(const double &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAITemplateDefinition_layout::is_width_Set() const{
    return m_width_isSet;
}

bool OAITemplateDefinition_layout::is_width_Valid() const{
    return m_width_isValid;
}

bool OAITemplateDefinition_layout::isSet() const {
...
bool OAITemplateDefinition_layout::isValid() const {
