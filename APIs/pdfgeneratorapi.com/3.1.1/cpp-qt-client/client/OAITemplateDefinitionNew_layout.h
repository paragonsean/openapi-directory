...
/*
 * OAITemplateDefinitionNew_layout.h
 *
 * Defines template layout (e.g page format, margins).
 */

#ifndef OAITemplateDefinitionNew_layout_H
#define OAITemplateDefinitionNew_layout_H

#include <QJsonObject>

#include "OAITemplateDefinition_layout_margins.h"
#include "OAITemplateDefinition_layout_repeatLayout.h"
#include <QString>
...
namespace OpenAPI {
class OAITemplateDefinition_layout_margins;
class OAITemplateDefinition_layout_repeatLayout;

class OAITemplateDefinitionNew_layout : public OAIObject {
public:
    OAITemplateDefinitionNew_layout();
    OAITemplateDefinitionNew_layout(QString json);
    ~OAITemplateDefinitionNew_layout() override;
    ...
    qint32 getEmptyLabels() const;
    void setEmptyLabels(const qint32 &empty_labels);
    bool is_empty_labels_Set() const;
    bool is_empty_labels_Valid() const;
    ...
    OAITemplateDefinition_layout_margins getMargins() const;
    void setMargins(const OAITemplateDefinition_layout_margins &margins);
    bool is_margins_Set() const;
    bool is_margins_Valid() const;
    ...
    OAITemplateDefinition_layout_repeatLayout getRepeatLayout() const;
    void setRepeatLayout(const OAITemplateDefinition_layout_repeatLayout &repeat_layout);
    bool is_repeat_layout_Set() const;
    bool is_repeat_layout_Valid() const;

    qint32 getRotaion() const;
    void setRotaion(const qint32 &rotaion);
    bool is_rotaion_Set() const;
    bool is_rotaion_Valid() const;
...
private:
    ...
    qint32 m_empty_labels;
    bool m_empty_labels_isSet;
    bool m_empty_labels_isValid;
    ...
    OAITemplateDefinition_layout_margins m_margins;
    bool m_margins_isSet;
    bool m_margins_isValid;

    QString m_orientation;
    bool m_orientation_isSet;
    bool m_orientation_isValid;

    OAITemplateDefinition_layout_repeatLayout m_repeat_layout;
    bool m_repeat_layout_isSet;
    bool m_repeat_layout_isValid;

    qint32 m_rotaion;
    bool m_rotaion_isSet;
    bool m_rotaion_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinitionNew_layout)

#endif // OAITemplateDefinitionNew_layout_H
