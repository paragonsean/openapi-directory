...
OAITemplateDefinition_editor::OAITemplateDefinition_editor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateDefinition_editor::OAITemplateDefinition_editor() {
    this->initializeModel();
}

OAITemplateDefinition_editor::~OAITemplateDefinition_editor() {}

void OAITemplateDefinition_editor::initializeModel() {

    m_height_multiplier_isSet = false;
    m_height_multiplier_isValid = false;
}

void OAITemplateDefinition_editor::fromJson(QString jsonString) {
...
void OAITemplateDefinition_editor::fromJsonObject(QJsonObject json) {

    m_height_multiplier_isValid = ::OpenAPI::fromJsonValue(m_height_multiplier, json[QString("heightMultiplier")]);
    m_height_multiplier_isSet = !json[QString("heightMultiplier")].isNull() && m_height_multiplier_isValid;
}

QString OAITemplateDefinition_editor::asJson() const {
...
QJsonObject OAITemplateDefinition_editor::asJsonObject() const {
    QJsonObject obj;
    if (m_height_multiplier_isSet) {
        obj.insert(QString("heightMultiplier"), ::OpenAPI::toJsonValue(m_height_multiplier));
    }
    return obj;
}

double OAITemplateDefinition_editor::getHeightMultiplier() const {
    return m_height_multiplier;
}
void OAITemplateDefinition_editor::setHeightMultiplier(const double &height_multiplier) {
    m_height_multiplier = height_multiplier;
    m_height_multiplier_isSet = true;
}

bool OAITemplateDefinition_editor::is_height_multiplier_Set() const{
    return m_height_multiplier_isSet;
}

bool OAITemplateDefinition_editor::is_height_multiplier_Valid() const{
    return m_height_multiplier_isValid;
}

bool OAITemplateDefinition_editor::isSet() const {
...
bool OAITemplateDefinition_editor::isValid() const {
