...
OAITemplateDefinition_dataSettings::OAITemplateDefinition_dataSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateDefinition_dataSettings::OAITemplateDefinition_dataSettings() {
    this->initializeModel();
}

OAITemplateDefinition_dataSettings::~OAITemplateDefinition_dataSettings() {}

void OAITemplateDefinition_dataSettings::initializeModel() {
...
void OAITemplateDefinition_dataSettings::fromJson(QString jsonString) {
...
void OAITemplateDefinition_dataSettings::fromJsonObject(QJsonObject json) {
...
QString OAITemplateDefinition_dataSettings::asJson() const {
...
QJsonObject OAITemplateDefinition_dataSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_filter_by.size() > 0) {
...
QList<OAIObject> OAITemplateDefinition_dataSettings::getFilterBy() const {
    return m_filter_by;
}
void OAITemplateDefinition_dataSettings::setFilterBy(const QList<OAIObject> &filter_by) {
    m_filter_by = filter_by;
    m_filter_by_isSet = true;
}

bool OAITemplateDefinition_dataSettings::is_filter_by_Set() const{
    return m_filter_by_isSet;
}

bool OAITemplateDefinition_dataSettings::is_filter_by_Valid() const{
    return m_filter_by_isValid;
}

QList<OAIObject> OAITemplateDefinition_dataSettings::getSortBy() const {
    return m_sort_by;
}
void OAITemplateDefinition_dataSettings::setSortBy(const QList<OAIObject> &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAITemplateDefinition_dataSettings::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAITemplateDefinition_dataSettings::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

bool OAITemplateDefinition_dataSettings::isSet() const {
...
bool OAITemplateDefinition_dataSettings::isValid() const {
