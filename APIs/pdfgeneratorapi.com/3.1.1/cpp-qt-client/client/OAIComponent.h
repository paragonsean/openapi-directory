...
public:
    ...
    bool is_cls_Set() const;
    bool is_cls_Valid() const;

    QString getDataIndex() const;
    void setDataIndex(const QString &data_index);
    bool is_data_index_Set() const;
    bool is_data_index_Valid() const;
    ...
    void setZindex(const qint32 &zindex);
...
private:
    ...
    QString m_data_index;
    bool m_data_index_isSet;
    bool m_data_index_isValid;
