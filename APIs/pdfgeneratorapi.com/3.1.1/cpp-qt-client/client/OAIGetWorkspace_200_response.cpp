...
OAIGetWorkspace_200_response::OAIGetWorkspace_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetWorkspace_200_response::OAIGetWorkspace_200_response() {
    this->initializeModel();
}

OAIGetWorkspace_200_response::~OAIGetWorkspace_200_response() {}

void OAIGetWorkspace_200_response::initializeModel() {

    m_response_isSet = false;
    m_response_isValid = false;
}

void OAIGetWorkspace_200_response::fromJson(QString jsonString) {
...
void OAIGetWorkspace_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetWorkspace_200_response::asJson() const {
...
QJsonObject OAIGetWorkspace_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_response.isSet()) {
...
OAIWorkspace OAIGetWorkspace_200_response::getResponse() const {
    return m_response;
}
void OAIGetWorkspace_200_response::setResponse(const OAIWorkspace &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIGetWorkspace_200_response::is_response_Set() const{
    return m_response_isSet;
}

bool OAIGetWorkspace_200_response::is_response_Valid() const{
    return m_response_isValid;
}

bool OAIGetWorkspace_200_response::isSet() const {
...
bool OAIGetWorkspace_200_response::isValid() const {
