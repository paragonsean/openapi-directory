...
#include "OAIMergeTemplates_200_response.h"
...
OAIMergeTemplates_200_response::OAIMergeTemplates_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeTemplates_200_response::OAIMergeTemplates_200_response() {
    this->initializeModel();
}

OAIMergeTemplates_200_response::~OAIMergeTemplates_200_response() {}

void OAIMergeTemplates_200_response::initializeModel() {
...
void OAIMergeTemplates_200_response::fromJson(QString jsonString) {
...
void OAIMergeTemplates_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIMergeTemplates_200_response::asJson() const {
...
QJsonObject OAIMergeTemplates_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIMergeTemplates_200_response_meta OAIMergeTemplates_200_response::getMeta() const {
    return m_meta;
}
void OAIMergeTemplates_200_response::setMeta(const OAIMergeTemplates_200_response_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIMergeTemplates_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIMergeTemplates_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QString OAIMergeTemplates_200_response::getResponse() const {
    return m_response;
}
void OAIMergeTemplates_200_response::setResponse(const QString &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIMergeTemplates_200_response::is_response_Set() const{
    return m_response_isSet;
}

bool OAIMergeTemplates_200_response::is_response_Valid() const{
    return m_response_isValid;
}

bool OAIMergeTemplates_200_response::isSet() const {
...
bool OAIMergeTemplates_200_response::isValid() const {
