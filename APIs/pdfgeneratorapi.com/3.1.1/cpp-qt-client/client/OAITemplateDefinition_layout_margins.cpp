...
OAITemplateDefinition_layout_margins::OAITemplateDefinition_layout_margins(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateDefinition_layout_margins::OAITemplateDefinition_layout_margins() {
    this->initializeModel();
}

OAITemplateDefinition_layout_margins::~OAITemplateDefinition_layout_margins() {}

void OAITemplateDefinition_layout_margins::initializeModel() {
...
void OAITemplateDefinition_layout_margins::fromJson(QString jsonString) {
...
void OAITemplateDefinition_layout_margins::fromJsonObject(QJsonObject json) {
...
QString OAITemplateDefinition_layout_margins::asJson() const {
...
QJsonObject OAITemplateDefinition_layout_margins::asJsonObject() const {
    QJsonObject obj;
    if (m_bottom_isSet) {
...
double OAITemplateDefinition_layout_margins::getBottom() const {
    return m_bottom;
}
void OAITemplateDefinition_layout_margins::setBottom(const double &bottom) {
    m_bottom = bottom;
    m_bottom_isSet = true;
}

bool OAITemplateDefinition_layout_margins::is_bottom_Set() const{
    return m_bottom_isSet;
}

bool OAITemplateDefinition_layout_margins::is_bottom_Valid() const{
    return m_bottom_isValid;
}

double OAITemplateDefinition_layout_margins::getLeft() const {
    return m_left;
}
void OAITemplateDefinition_layout_margins::setLeft(const double &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAITemplateDefinition_layout_margins::is_left_Set() const{
    return m_left_isSet;
}

bool OAITemplateDefinition_layout_margins::is_left_Valid() const{
    return m_left_isValid;
}

double OAITemplateDefinition_layout_margins::getRight() const {
    return m_right;
}
void OAITemplateDefinition_layout_margins::setRight(const double &right) {
    m_right = right;
    m_right_isSet = true;
}

bool OAITemplateDefinition_layout_margins::is_right_Set() const{
    return m_right_isSet;
}

bool OAITemplateDefinition_layout_margins::is_right_Valid() const{
    return m_right_isValid;
}

double OAITemplateDefinition_layout_margins::getTop() const {
    return m_top;
}
void OAITemplateDefinition_layout_margins::setTop(const double &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAITemplateDefinition_layout_margins::is_top_Set() const{
    return m_top_isSet;
}

bool OAITemplateDefinition_layout_margins::is_top_Valid() const{
    return m_top_isValid;
}

bool OAITemplateDefinition_layout_margins::isSet() const {
...
bool OAITemplateDefinition_layout_margins::isValid() const {
