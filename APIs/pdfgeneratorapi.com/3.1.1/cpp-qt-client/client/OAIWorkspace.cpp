...
void OAIWorkspace::initializeModel() {
    ...
    m_is_master_workspace_isSet = false;
    m_is_master_workspace_isValid = false;
}
...
void OAIWorkspace::fromJsonObject(QJsonObject json) {
    ...
    m_is_master_workspace_isValid = ::OpenAPI::fromJsonValue(m_is_master_workspace, json[QString("is_master_workspace")]);
    m_is_master_workspace_isSet = !json[QString("is_master_workspace")].isNull() && m_is_master_workspace_isValid;
}
...
QJsonObject OAIWorkspace::asJsonObject() const {
    ...
    if (m_is_master_workspace_isSet) {
        obj.insert(QString("is_master_workspace"), ::OpenAPI::toJsonValue(m_is_master_workspace));
    }
    return obj;
}

QString OAIWorkspace::getCreatedAt() const {
    return m_created_at;
}
void OAIWorkspace::setCreatedAt(const QString &created_at) {
...
qint32 OAIWorkspace::getId() const {
    return m_id;
}
void OAIWorkspace::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAIWorkspace::getIdentifier() const {
    return m_identifier;
}
void OAIWorkspace::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIWorkspace::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIWorkspace::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIWorkspace::isIsMasterWorkspace() const {
    return m_is_master_workspace;
}
void OAIWorkspace::setIsMasterWorkspace(const bool &is_master_workspace) {
    m_is_master_workspace = is_master_workspace;
    m_is_master_workspace_isSet = true;
}

bool OAIWorkspace::is_is_master_workspace_Set() const{
    return m_is_master_workspace_isSet;
}

bool OAIWorkspace::is_is_master_workspace_Valid() const{
    return m_is_master_workspace_isValid;
}
