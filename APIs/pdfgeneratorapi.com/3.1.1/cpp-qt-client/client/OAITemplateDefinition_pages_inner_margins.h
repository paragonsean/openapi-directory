...
/*
 * OAITemplateDefinition_pages_inner_margins.h
 *
 * 
 */

#ifndef OAITemplateDefinition_pages_inner_margins_H
#define OAITemplateDefinition_pages_inner_margins_H
...
class OAITemplateDefinition_pages_inner_margins : public OAIObject {
public:
    OAITemplateDefinition_pages_inner_margins();
    OAITemplateDefinition_pages_inner_margins(QString json);
    ~OAITemplateDefinition_pages_inner_margins() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition_pages_inner_margins)

#endif // OAITemplateDefinition_pages_inner_margins_H
