...
OAIBatchData_inner::OAIBatchData_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchData_inner::OAIBatchData_inner() {
    this->initializeModel();
}

OAIBatchData_inner::~OAIBatchData_inner() {}

void OAIBatchData_inner::initializeModel() {
...
void OAIBatchData_inner::fromJson(QString jsonString) {
...
void OAIBatchData_inner::fromJsonObject(QJsonObject json) {
...
QString OAIBatchData_inner::asJson() const {
...
QJsonObject OAIBatchData_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIData OAIBatchData_inner::getData() const {
    return m_data;
}
void OAIBatchData_inner::setData(const OAIData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIBatchData_inner::is_data_Set() const{
    return m_data_isSet;
}

bool OAIBatchData_inner::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIBatchData_inner::getRTemplate() const {
    return m_r_template;
}
void OAIBatchData_inner::setRTemplate(const qint32 &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAIBatchData_inner::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAIBatchData_inner::is_r_template_Valid() const{
    return m_r_template_isValid;
}

bool OAIBatchData_inner::isSet() const {
...
bool OAIBatchData_inner::isValid() const {
