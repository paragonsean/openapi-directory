...
/*
 * OAITemplateDefinition_layout.h
 *
 * Defines template layout (e.g page format, margins).
 */

#ifndef OAITemplateDefinition_layout_H
#define OAITemplateDefinition_layout_H
...
class OAITemplateDefinition_layout : public OAIObject {
public:
    OAITemplateDefinition_layout();
    OAITemplateDefinition_layout(QString json);
    ~OAITemplateDefinition_layout() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition_layout)

#endif // OAITemplateDefinition_layout_H
