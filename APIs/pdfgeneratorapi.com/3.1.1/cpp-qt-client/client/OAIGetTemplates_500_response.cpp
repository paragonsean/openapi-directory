...
OAIGetTemplates_500_response::OAIGetTemplates_500_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTemplates_500_response::OAIGetTemplates_500_response() {
    this->initializeModel();
}

OAIGetTemplates_500_response::~OAIGetTemplates_500_response() {}

void OAIGetTemplates_500_response::initializeModel() {
...
void OAIGetTemplates_500_response::fromJson(QString jsonString) {
...
void OAIGetTemplates_500_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetTemplates_500_response::asJson() const {
...
QJsonObject OAIGetTemplates_500_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIGetTemplates_500_response::getError() const {
    return m_error;
}
void OAIGetTemplates_500_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGetTemplates_500_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGetTemplates_500_response::is_error_Valid() const{
    return m_error_isValid;
}

qint32 OAIGetTemplates_500_response::getStatus() const {
    return m_status;
}
void OAIGetTemplates_500_response::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTemplates_500_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTemplates_500_response::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetTemplates_500_response::isSet() const {
...
bool OAIGetTemplates_500_response::isValid() const {
