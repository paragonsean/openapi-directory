...
#include "OAIDeleteTemplate_200_response_response.h"
...
OAIDeleteTemplate_200_response_response::OAIDeleteTemplate_200_response_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTemplate_200_response_response::OAIDeleteTemplate_200_response_response() {
    this->initializeModel();
}

OAIDeleteTemplate_200_response_response::~OAIDeleteTemplate_200_response_response() {}

void OAIDeleteTemplate_200_response_response::initializeModel() {

    m_success_isSet = false;
    m_success_isValid = false;
}

void OAIDeleteTemplate_200_response_response::fromJson(QString jsonString) {
...
void OAIDeleteTemplate_200_response_response::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTemplate_200_response_response::asJson() const {
...
QJsonObject OAIDeleteTemplate_200_response_response::asJsonObject() const {
    QJsonObject obj;
    if (m_success_isSet) {
...
bool OAIDeleteTemplate_200_response_response::isSuccess() const {
    return m_success;
}
void OAIDeleteTemplate_200_response_response::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIDeleteTemplate_200_response_response::is_success_Set() const{
    return m_success_isSet;
}

bool OAIDeleteTemplate_200_response_response::is_success_Valid() const{
    return m_success_isValid;
}

bool OAIDeleteTemplate_200_response_response::isSet() const {
...
bool OAIDeleteTemplate_200_response_response::isValid() const {
