...
/*
 * OAITemplateDefinition_editor.h
 *
 * Configuration preferences for the editor
 */

#ifndef OAITemplateDefinition_editor_H
#define OAITemplateDefinition_editor_H
...
class OAITemplateDefinition_editor : public OAIObject {
public:
    OAITemplateDefinition_editor();
    OAITemplateDefinition_editor(QString json);
    ~OAITemplateDefinition_editor() override;
    ...
    void setHeightMultiplier(const double &height_multiplier);
    bool is_height_multiplier_Set() const;
    bool is_height_multiplier_Valid() const;
...
private:
    ...
    double m_height_multiplier;
    bool m_height_multiplier_isSet;
    bool m_height_multiplier_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition_editor)

#endif // OAITemplateDefinition_editor_H
