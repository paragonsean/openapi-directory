...
/*
 * OAITemplateDefinition_layout_margins.h
 *
 * Page margins in units
 */

#ifndef OAITemplateDefinition_layout_margins_H
#define OAITemplateDefinition_layout_margins_H
...
class OAITemplateDefinition_layout_margins : public OAIObject {
public:
    OAITemplateDefinition_layout_margins();
    OAITemplateDefinition_layout_margins(QString json);
    ~OAITemplateDefinition_layout_margins() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition_layout_margins)

#endif // OAITemplateDefinition_layout_margins_H
