...
/*
 * OAIGetTemplates_200_response.h
 *
 * 
 */

#ifndef OAIGetTemplates_200_response_H
#define OAIGetTemplates_200_response_H
...
class OAIGetTemplates_200_response : public OAIObject {
public:
    OAIGetTemplates_200_response();
    OAIGetTemplates_200_response(QString json);
    ~OAIGetTemplates_200_response() override;
    ...
    QList<OAITemplate> getResponse() const;
    void setResponse(const QList<OAITemplate> &response);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTemplates_200_response)

#endif // OAIGetTemplates_200_response_H
