...
#include "OAIDeleteTemplate_200_response.h"
#include "OAIGetTemplates_401_response.h"
#include "OAIGetTemplates_403_response.h"
#include "OAIGetTemplates_404_response.h"
#include "OAIGetTemplates_422_response.h"
#include "OAIGetTemplates_500_response.h"
...
public:
    ...
    */
    virtual void deleteWorkspace(const QString &workspace_id);

    /**
    * @param[in]  workspace_id QString [required]
    */
    virtual void getWorkspace(const QString &workspace_id);
...
Q_SIGNALS:
    ...
    void deleteWorkspaceSignal(OAIDeleteTemplate_200_response summary);
    void getWorkspaceSignal(OAIGetWorkspace_200_response summary);


    void deleteWorkspaceSignalFull(OAIHttpRequestWorker *worker, OAIDeleteTemplate_200_response summary);
    ...
    void deleteWorkspaceSignalE(OAIDeleteTemplate_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteWorkspaceSignalError(OAIDeleteTemplate_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
