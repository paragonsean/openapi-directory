...
public:
    ...
    /**
    * @param[in]  template_id qint32 [required]
    * @param[in]  oai_data OAIData [required]
    * @param[in]  name QString [optional]
    * @param[in]  format QString [optional]
    * @param[in]  output QString [optional]
    */
    virtual void mergeTemplate(const qint32 &template_id, const OAIData &oai_data, const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &format = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &output = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  oai_batch_data_inner QList<OAIBatchData_inner> [required]
    * @param[in]  name QString [optional]
    * @param[in]  format QString [optional]
    * @param[in]  output QString [optional]
    */
    virtual void mergeTemplates(const QList<OAIBatchData_inner> &oai_batch_data_inner, const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &format = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &output = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void mergeTemplateCallback(OAIHttpRequestWorker *worker);
    void mergeTemplatesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void mergeTemplateSignal(OAIMergeTemplates_200_response summary);
    void mergeTemplatesSignal(OAIMergeTemplates_200_response summary);


    void mergeTemplateSignalFull(OAIHttpRequestWorker *worker, OAIMergeTemplates_200_response summary);
    void mergeTemplatesSignalFull(OAIHttpRequestWorker *worker, OAIMergeTemplates_200_response summary);

    Q_DECL_DEPRECATED_X("Use mergeTemplateSignalError() instead")
    void mergeTemplateSignalE(OAIMergeTemplates_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void mergeTemplateSignalError(OAIMergeTemplates_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use mergeTemplatesSignalError() instead")
    void mergeTemplatesSignalE(OAIMergeTemplates_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void mergeTemplatesSignalError(OAIMergeTemplates_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use mergeTemplateSignalErrorFull() instead")
    void mergeTemplateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void mergeTemplateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use mergeTemplatesSignalErrorFull() instead")
    void mergeTemplatesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void mergeTemplatesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
