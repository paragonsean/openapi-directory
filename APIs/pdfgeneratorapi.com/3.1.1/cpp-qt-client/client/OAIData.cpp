...
qint32 OAIData::getId() const {
    return m_id;
}
void OAIData::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAIData::getName() const {
    return m_name;
}
void OAIData::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIData::is_name_Set() const{
    return m_name_isSet;
}

bool OAIData::is_name_Valid() const{
