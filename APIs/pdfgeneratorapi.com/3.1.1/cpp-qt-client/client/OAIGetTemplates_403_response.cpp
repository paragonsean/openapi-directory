...
#include "OAIGetTemplates_403_response.h"
...
OAIGetTemplates_403_response::OAIGetTemplates_403_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTemplates_403_response::OAIGetTemplates_403_response() {
    this->initializeModel();
}

OAIGetTemplates_403_response::~OAIGetTemplates_403_response() {}

void OAIGetTemplates_403_response::initializeModel() {
...
void OAIGetTemplates_403_response::fromJson(QString jsonString) {
...
void OAIGetTemplates_403_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetTemplates_403_response::asJson() const {
...
QJsonObject OAIGetTemplates_403_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIGetTemplates_403_response::getError() const {
    return m_error;
}
void OAIGetTemplates_403_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGetTemplates_403_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGetTemplates_403_response::is_error_Valid() const{
    return m_error_isValid;
}

qint32 OAIGetTemplates_403_response::getStatus() const {
    return m_status;
}
void OAIGetTemplates_403_response::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTemplates_403_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTemplates_403_response::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetTemplates_403_response::isSet() const {
...
bool OAIGetTemplates_403_response::isValid() const {
