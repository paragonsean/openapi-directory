...
/*
 * OAIMergeTemplates_200_response.h
 *
 * 
 */

#ifndef OAIMergeTemplates_200_response_H
#define OAIMergeTemplates_200_response_H
...
namespace OpenAPI {
class OAIMergeTemplates_200_response_meta;

class OAIMergeTemplates_200_response : public OAIObject {
public:
    OAIMergeTemplates_200_response();
    OAIMergeTemplates_200_response(QString json);
    ~OAIMergeTemplates_200_response() override;
    ...
    OAIMergeTemplates_200_response_meta getMeta() const;
    void setMeta(const OAIMergeTemplates_200_response_meta &meta);
...
private:
    ...
    OAIMergeTemplates_200_response_meta m_meta;
    bool m_meta_isSet;
    bool m_meta_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeTemplates_200_response)

#endif // OAIMergeTemplates_200_response_H
