...
#include "OAIGetTemplates_422_response.h"
...
OAIGetTemplates_422_response::OAIGetTemplates_422_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTemplates_422_response::OAIGetTemplates_422_response() {
    this->initializeModel();
}

OAIGetTemplates_422_response::~OAIGetTemplates_422_response() {}

void OAIGetTemplates_422_response::initializeModel() {
...
void OAIGetTemplates_422_response::fromJson(QString jsonString) {
...
void OAIGetTemplates_422_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetTemplates_422_response::asJson() const {
...
QJsonObject OAIGetTemplates_422_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIGetTemplates_422_response::getError() const {
    return m_error;
}
void OAIGetTemplates_422_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGetTemplates_422_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGetTemplates_422_response::is_error_Valid() const{
    return m_error_isValid;
}

qint32 OAIGetTemplates_422_response::getStatus() const {
    return m_status;
}
void OAIGetTemplates_422_response::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTemplates_422_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTemplates_422_response::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetTemplates_422_response::isSet() const {
...
bool OAIGetTemplates_422_response::isValid() const {
