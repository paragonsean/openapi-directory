...
#include "OAIGetTemplates_401_response.h"
...
OAIGetTemplates_401_response::OAIGetTemplates_401_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTemplates_401_response::OAIGetTemplates_401_response() {
    this->initializeModel();
}

OAIGetTemplates_401_response::~OAIGetTemplates_401_response() {}

void OAIGetTemplates_401_response::initializeModel() {
...
void OAIGetTemplates_401_response::fromJson(QString jsonString) {
...
void OAIGetTemplates_401_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetTemplates_401_response::asJson() const {
...
QJsonObject OAIGetTemplates_401_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIGetTemplates_401_response::getError() const {
    return m_error;
}
void OAIGetTemplates_401_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGetTemplates_401_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGetTemplates_401_response::is_error_Valid() const{
    return m_error_isValid;
}

qint32 OAIGetTemplates_401_response::getStatus() const {
    return m_status;
}
void OAIGetTemplates_401_response::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTemplates_401_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTemplates_401_response::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetTemplates_401_response::isSet() const {
...
bool OAIGetTemplates_401_response::isValid() const {
