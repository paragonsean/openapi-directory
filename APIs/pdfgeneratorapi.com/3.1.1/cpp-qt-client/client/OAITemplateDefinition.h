...
/*
 * OAITemplateDefinition.h
 *
 * 
 */

#ifndef OAITemplateDefinition_H
#define OAITemplateDefinition_H

#include <QJsonObject>

#include "OAITemplateDefinition_dataSettings.h"
#include "OAITemplateDefinition_editor.h"
#include "OAITemplateDefinition_layout.h"
...
namespace OpenAPI {
class OAITemplateDefinition_dataSettings;
class OAITemplateDefinition_editor;
class OAITemplateDefinition_layout;
class OAITemplateDefinition_pages_inner;

class OAITemplateDefinition : public OAIObject {
public:
    OAITemplateDefinition();
    OAITemplateDefinition(QString json);
    ~OAITemplateDefinition() override;
    ...
    OAITemplateDefinition_dataSettings getDataSettings() const;
    void setDataSettings(const OAITemplateDefinition_dataSettings &data_settings);
    bool is_data_settings_Set() const;
    bool is_data_settings_Valid() const;

    OAITemplateDefinition_editor getEditor() const;
    void setEditor(const OAITemplateDefinition_editor &editor);
    ...
    OAITemplateDefinition_layout getLayout() const;
    void setLayout(const OAITemplateDefinition_layout &layout);
    ...
    QList<OAITemplateDefinition_pages_inner> getPages() const;
    void setPages(const QList<OAITemplateDefinition_pages_inner> &pages);
...
private:
    ...
    OAITemplateDefinition_dataSettings m_data_settings;
    bool m_data_settings_isSet;
    bool m_data_settings_isValid;

    OAITemplateDefinition_editor m_editor;
    bool m_editor_isSet;
    ...
    OAITemplateDefinition_layout m_layout;
    bool m_layout_isSet;
    ...
    QList<OAITemplateDefinition_pages_inner> m_pages;
    bool m_pages_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinition)

#endif // OAITemplateDefinition_H
