...
#include "OAITemplateDefinition_pages_inner_margins.h"
...
OAITemplateDefinition_pages_inner_margins::OAITemplateDefinition_pages_inner_margins(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateDefinition_pages_inner_margins::OAITemplateDefinition_pages_inner_margins() {
    this->initializeModel();
}

OAITemplateDefinition_pages_inner_margins::~OAITemplateDefinition_pages_inner_margins() {}

void OAITemplateDefinition_pages_inner_margins::initializeModel() {
...
void OAITemplateDefinition_pages_inner_margins::fromJson(QString jsonString) {
...
void OAITemplateDefinition_pages_inner_margins::fromJsonObject(QJsonObject json) {
...
QString OAITemplateDefinition_pages_inner_margins::asJson() const {
...
QJsonObject OAITemplateDefinition_pages_inner_margins::asJsonObject() const {
    QJsonObject obj;
    if (m_bottom_isSet) {
...
double OAITemplateDefinition_pages_inner_margins::getBottom() const {
    return m_bottom;
}
void OAITemplateDefinition_pages_inner_margins::setBottom(const double &bottom) {
    m_bottom = bottom;
    m_bottom_isSet = true;
}

bool OAITemplateDefinition_pages_inner_margins::is_bottom_Set() const{
    return m_bottom_isSet;
}

bool OAITemplateDefinition_pages_inner_margins::is_bottom_Valid() const{
    return m_bottom_isValid;
}

double OAITemplateDefinition_pages_inner_margins::getRight() const {
    return m_right;
}
void OAITemplateDefinition_pages_inner_margins::setRight(const double &right) {
    m_right = right;
    m_right_isSet = true;
}

bool OAITemplateDefinition_pages_inner_margins::is_right_Set() const{
    return m_right_isSet;
}

bool OAITemplateDefinition_pages_inner_margins::is_right_Valid() const{
    return m_right_isValid;
}

bool OAITemplateDefinition_pages_inner_margins::isSet() const {
...
bool OAITemplateDefinition_pages_inner_margins::isValid() const {
