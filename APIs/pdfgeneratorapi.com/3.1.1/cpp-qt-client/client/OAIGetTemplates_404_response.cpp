...
OAIGetTemplates_404_response::OAIGetTemplates_404_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTemplates_404_response::OAIGetTemplates_404_response() {
    this->initializeModel();
}

OAIGetTemplates_404_response::~OAIGetTemplates_404_response() {}

void OAIGetTemplates_404_response::initializeModel() {
...
void OAIGetTemplates_404_response::fromJson(QString jsonString) {
...
void OAIGetTemplates_404_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetTemplates_404_response::asJson() const {
...
QJsonObject OAIGetTemplates_404_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIGetTemplates_404_response::getError() const {
    return m_error;
}
void OAIGetTemplates_404_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGetTemplates_404_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGetTemplates_404_response::is_error_Valid() const{
    return m_error_isValid;
}

qint32 OAIGetTemplates_404_response::getStatus() const {
    return m_status;
}
void OAIGetTemplates_404_response::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTemplates_404_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTemplates_404_response::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIGetTemplates_404_response::isSet() const {
...
bool OAIGetTemplates_404_response::isValid() const {
