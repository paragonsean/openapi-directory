...
/*
 * OAICreateTemplate_200_response.h
 *
 * 
 */

#ifndef OAICreateTemplate_200_response_H
#define OAICreateTemplate_200_response_H
...
namespace OpenAPI {
class OAITemplateDefinition;

class OAICreateTemplate_200_response : public OAIObject {
public:
    OAICreateTemplate_200_response();
    OAICreateTemplate_200_response(QString json);
    ~OAICreateTemplate_200_response() override;
    ...
    OAITemplateDefinition getResponse() const;
    void setResponse(const OAITemplateDefinition &response);
...
private:
    ...
    OAITemplateDefinition m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTemplate_200_response)

#endif // OAICreateTemplate_200_response_H
