...
/*
 * OAITemplateDefinitionNew.h
 *
 * Template configuration
 */

#ifndef OAITemplateDefinitionNew_H
#define OAITemplateDefinitionNew_H
...
namespace OpenAPI {
class OAITemplateDefinitionNew_layout;
class OAITemplateDefinition_pages_inner;

class OAITemplateDefinitionNew : public OAIObject {
public:
    OAITemplateDefinitionNew();
    OAITemplateDefinitionNew(QString json);
    ~OAITemplateDefinitionNew() override;
    ...
    OAITemplateDefinitionNew_layout getLayout() const;
    void setLayout(const OAITemplateDefinitionNew_layout &layout);
...
private:
    ...
    OAITemplateDefinitionNew_layout m_layout;
    bool m_layout_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateDefinitionNew)

#endif // OAITemplateDefinitionNew_H
