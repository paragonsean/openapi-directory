...
public class EncryptRequest {
  public static final String SERIALIZED_NAME_PLAIN_VALUE = "plainValue";
  @SerializedName(SERIALIZED_NAME_PLAIN_VALUE)
  private String plainValue = "";

  public EncryptRequest() {
  }

  public EncryptRequest plainValue(String plainValue) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.plainValue, encryptRequest.plainValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(plainValue);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("plainValue") != null && !jsonObj.get("plainValue").isJsonNull()) && !jsonObj.get("plainValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `plainValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("plainValue").toString()));
      }
  }
