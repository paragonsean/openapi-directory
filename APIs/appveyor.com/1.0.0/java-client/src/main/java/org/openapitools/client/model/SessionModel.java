...
public class SessionModel {
  ...
  private List<SessionUserAccountModel> accounts = new ArrayList<>();

  public static final String SERIALIZED_NAME_SETUP_REQUIRED = "setupRequired";
  @SerializedName(SERIALIZED_NAME_SETUP_REQUIRED)
  private Boolean setupRequired;

  public static final String SERIALIZED_NAME_TWO_FACTOR_AUTH_REQUIRED = "twoFactorAuthRequired";
  @SerializedName(SERIALIZED_NAME_TWO_FACTOR_AUTH_REQUIRED)
  private Boolean twoFactorAuthRequired;

  public static final String SERIALIZED_NAME_USER = "user";
  @SerializedName(SERIALIZED_NAME_USER)
  private SessionUserModel user;

  public SessionModel() {
  }

  public SessionModel accounts(List<SessionUserAccountModel> accounts) {
    this.accounts = accounts;
    return this;
  }

  public SessionModel addAccountsItem(SessionUserAccountModel accountsItem) {
  ...
  public List<SessionUserAccountModel> getAccounts() {
    return accounts;
  }

  public void setAccounts(List<SessionUserAccountModel> accounts) {
    this.accounts = accounts;
  }


  public SessionModel setupRequired(Boolean setupRequired) {
  ...
  public SessionModel twoFactorAuthRequired(Boolean twoFactorAuthRequired) {
  ...
  public SessionModel user(SessionUserModel user) {
    this.user = user;
    return this;
  }
  ...
  public void setUser(SessionUserModel user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accounts, sessionModel.accounts) &&
        Objects.equals(this.setupRequired, sessionModel.setupRequired) &&
        Objects.equals(this.twoFactorAuthRequired, sessionModel.twoFactorAuthRequired) &&
        Objects.equals(this.user, sessionModel.user);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accounts, setupRequired, twoFactorAuthRequired, user);
  }
  ...
  public String toString() {
    ...
    sb.append("    setupRequired: ").append(toIndentedString(setupRequired)).append("\n");
    sb.append("    twoFactorAuthRequired: ").append(toIndentedString(twoFactorAuthRequired)).append("\n");
  ...
  static {
    ...
    openapiFields.add("setupRequired");
    openapiFields.add("twoFactorAuthRequired");
      ...
      if (jsonObj.get("accounts") != null && !jsonObj.get("accounts").isJsonNull()) {
        ...
        if (jsonArrayaccounts != null) {
          ...
          for (int i = 0; i < jsonArrayaccounts.size(); i++) {
            SessionUserAccountModel.validateJsonElement(jsonArrayaccounts.get(i));
          };
        }
      }
      // validate the optional field `user`
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        SessionUserModel.validateJsonElement(jsonObj.get("user"));
      }
  }
