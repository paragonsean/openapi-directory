...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.DeploymentEnvironmentSettings();
  });
  ...
  describe('DeploymentEnvironmentSettings', function() {
    it('should create an instance of DeploymentEnvironmentSettings', function() {
      // uncomment below and update the code to test DeploymentEnvironmentSettings
      //var instance = new AppVeyorRestApi.DeploymentEnvironmentSettings();
      //expect(instance).to.be.a(AppVeyorRestApi.DeploymentEnvironmentSettings);
    });
