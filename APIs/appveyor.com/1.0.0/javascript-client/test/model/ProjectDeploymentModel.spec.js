...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.ProjectDeploymentModel();
  });
  ...
  describe('ProjectDeploymentModel', function() {
    it('should create an instance of ProjectDeploymentModel', function() {
      // uncomment below and update the code to test ProjectDeploymentModel
      //var instance = new AppVeyorRestApi.ProjectDeploymentModel();
      //expect(instance).to.be.a(AppVeyorRestApi.ProjectDeploymentModel);
    });
