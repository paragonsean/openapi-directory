...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.BuildLookupModel();
  });
  ...
  describe('BuildLookupModel', function() {
    it('should create an instance of BuildLookupModel', function() {
      // uncomment below and update the code to test BuildLookupModel
      //var instance = new AppVeyorRestApi.BuildLookupModel();
      //expect(instance).to.be.a(AppVeyorRestApi.BuildLookupModel);
    });
