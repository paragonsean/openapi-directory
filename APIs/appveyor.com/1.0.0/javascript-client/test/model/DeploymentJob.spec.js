...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.DeploymentJob();
  });
  ...
  describe('DeploymentJob', function() {
    it('should create an instance of DeploymentJob', function() {
      ...
      //var instance = new AppVeyorRestApi.DeploymentJob();
      //expect(instance).to.be.a(AppVeyorRestApi.DeploymentJob);
    });
    ...
    it('should have the property messagesCount (base name: "messagesCount")', function() {
