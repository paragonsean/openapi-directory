...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.RoleAce();
  });
  ...
  describe('RoleAce', function() {
    it('should create an instance of RoleAce', function() {
      // uncomment below and update the code to test RoleAce
      //var instance = new AppVeyorRestApi.RoleAce();
      //expect(instance).to.be.a(AppVeyorRestApi.RoleAce);
    });
