...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.DeploymentLookupModel();
  });
  ...
  describe('DeploymentLookupModel', function() {
    it('should create an instance of DeploymentLookupModel', function() {
      // uncomment below and update the code to test DeploymentLookupModel
      //var instance = new AppVeyorRestApi.DeploymentLookupModel();
      //expect(instance).to.be.a(AppVeyorRestApi.DeploymentLookupModel);
    });
