...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.EnvironmentDeploymentModel();
  });
  ...
  describe('EnvironmentDeploymentModel', function() {
    it('should create an instance of EnvironmentDeploymentModel', function() {
      // uncomment below and update the code to test EnvironmentDeploymentModel
      //var instance = new AppVeyorRestApi.EnvironmentDeploymentModel();
      //expect(instance).to.be.a(AppVeyorRestApi.EnvironmentDeploymentModel);
    });
