...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppVeyorRestApi.EnvironmentApi();
  });
  ...
  describe('EnvironmentApi', function() {
    describe('addEnvironment', function() {
      it('should call addEnvironment successfully', function(done) {
        //uncomment below and update the code to test addEnvironment
        //instance.addEnvironment(function(error) {
    ...
    describe('getEnvironmentDeployments', function() {
      it('should call getEnvironmentDeployments successfully', function(done) {
        //uncomment below and update the code to test getEnvironmentDeployments
        //instance.getEnvironmentDeployments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEnvironmentSettings', function() {
      it('should call getEnvironmentSettings successfully', function(done) {
        //uncomment below and update the code to test getEnvironmentSettings
        //instance.getEnvironmentSettings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
