...
/*
 * OAIProjectDeploymentModel.h
 *
 * 
 */

#ifndef OAIProjectDeploymentModel_H
#define OAIProjectDeploymentModel_H
...
class OAIDeploymentEnvironmentLookupModel;

class OAIProjectDeploymentModel : public OAIObject {
public:
    OAIProjectDeploymentModel();
    OAIProjectDeploymentModel(QString json);
    ~OAIProjectDeploymentModel() override;
    ...
    OAIDeploymentEnvironmentLookupModel getEnvironment() const;
    void setEnvironment(const OAIDeploymentEnvironmentLookupModel &environment);
...
private:
    ...
    OAIDeploymentEnvironmentLookupModel m_environment;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectDeploymentModel)

#endif // OAIProjectDeploymentModel_H
