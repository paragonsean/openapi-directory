...
/*
 * OAIProjectWithConfiguration.h
 *
 * 
 */

#ifndef OAIProjectWithConfiguration_H
#define OAIProjectWithConfiguration_H
...
class OAIProjectConfiguration;

class OAIProjectWithConfiguration : public OAIObject {
public:
    OAIProjectWithConfiguration();
    OAIProjectWithConfiguration(QString json);
    ~OAIProjectWithConfiguration() override;
    ...
    qint32 getBuildPriority() const;
    void setBuildPriority(const qint32 &build_priority);
    bool is_build_priority_Set() const;
    bool is_build_priority_Valid() const;

    OAIProjectConfiguration getConfiguration() const;
    void setConfiguration(const OAIProjectConfiguration &configuration);
    bool is_configuration_Set() const;
    bool is_configuration_Valid() const;

    QString getCustomYmlName() const;
    void setCustomYmlName(const QString &custom_yml_name);
    bool is_custom_yml_name_Set() const;
    bool is_custom_yml_name_Valid() const;

    bool isIgnoreAppveyorYml() const;
    void setIgnoreAppveyorYml(const bool &ignore_appveyor_yml);
    bool is_ignore_appveyor_yml_Set() const;
    bool is_ignore_appveyor_yml_Valid() const;
    ...
    QString getScheduleCrontabExpression() const;
    void setScheduleCrontabExpression(const QString &schedule_crontab_expression);
    bool is_schedule_crontab_expression_Set() const;
    bool is_schedule_crontab_expression_Valid() const;
    ...
    QString getStatusBadgeId() const;
    void setStatusBadgeId(const QString &status_badge_id);
    bool is_status_badge_id_Set() const;
    bool is_status_badge_id_Valid() const;

    QString getVersionFormat() const;
    void setVersionFormat(const QString &version_format);
    bool is_version_format_Set() const;
    bool is_version_format_Valid() const;
...
private:
    ...
    qint32 m_build_priority;
    bool m_build_priority_isSet;
    bool m_build_priority_isValid;

    OAIProjectConfiguration m_configuration;
    bool m_configuration_isSet;
    bool m_configuration_isValid;

    QString m_custom_yml_name;
    bool m_custom_yml_name_isSet;
    bool m_custom_yml_name_isValid;

    bool m_ignore_appveyor_yml;
    bool m_ignore_appveyor_yml_isSet;
    bool m_ignore_appveyor_yml_isValid;
    ...
    QString m_schedule_crontab_expression;
    bool m_schedule_crontab_expression_isSet;
    bool m_schedule_crontab_expression_isValid;

    QString m_ssh_public_key;
    bool m_ssh_public_key_isSet;
    bool m_ssh_public_key_isValid;

    QString m_status_badge_id;
    bool m_status_badge_id_isSet;
    bool m_status_badge_id_isValid;

    QString m_version_format;
    bool m_version_format_isSet;
    bool m_version_format_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectWithConfiguration)

#endif // OAIProjectWithConfiguration_H
