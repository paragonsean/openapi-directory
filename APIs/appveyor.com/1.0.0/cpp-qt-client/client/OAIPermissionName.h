...
#ifndef OAIPermissionName_H
#define OAIPermissionName_H
...
class OAIPermissionName : public OAIEnum {
public:
    OAIPermissionName();
    OAIPermissionName(QString json);
    ~OAIPermissionName() override;
    ...
    OAIPermissionName::eOAIPermissionName getValue() const;
    void setValue(const OAIPermissionName::eOAIPermissionName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPermissionName)

#endif // OAIPermissionName_H
