...
/*
 * OAIEnvironmentDeploymentModel.h
 *
 * 
 */

#ifndef OAIEnvironmentDeploymentModel_H
#define OAIEnvironmentDeploymentModel_H
...
class OAIProjectLookupModel;

class OAIEnvironmentDeploymentModel : public OAIObject {
public:
    OAIEnvironmentDeploymentModel();
    OAIEnvironmentDeploymentModel(QString json);
    ~OAIEnvironmentDeploymentModel() override;
    ...
    OAIProjectLookupModel getProject() const;
    void setProject(const OAIProjectLookupModel &project);
...
private:
    ...
    OAIProjectLookupModel m_project;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironmentDeploymentModel)

#endif // OAIEnvironmentDeploymentModel_H
