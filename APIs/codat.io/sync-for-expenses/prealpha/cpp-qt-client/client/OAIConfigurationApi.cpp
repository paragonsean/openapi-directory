...
void OAIConfigurationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getCompanyConfiguration", defaultConf);
    _serverIndices.insert("getCompanyConfiguration", 0);
    _serverConfigs.insert("saveCompanyConfiguration", defaultConf);
    _serverIndices.insert("saveCompanyConfiguration", 0);
}
...
void OAIConfigurationApi::getCompanyConfiguration(const QString &company_id) {
    QString fullPath = QString(_serverConfigs["getCompanyConfiguration"][_serverIndices.value("getCompanyConfiguration")].URL()+"/companies/{companyId}/sync/expenses/config");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIConfigurationApi::getCompanyConfigurationCallback);
...
void OAIConfigurationApi::getCompanyConfigurationCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICompanyConfiguration output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getCompanyConfigurationSignal(output);
        Q_EMIT getCompanyConfigurationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getCompanyConfigurationSignalE(output, error_type, error_str);
        Q_EMIT getCompanyConfigurationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getCompanyConfigurationSignalError(output, error_type, error_str);
        Q_EMIT getCompanyConfigurationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIConfigurationApi::saveCompanyConfiguration(const QString &company_id, const ::OpenAPI::OptionalParam<OAICompanyConfiguration> &oai_company_configuration) {
    QString fullPath = QString(_serverConfigs["saveCompanyConfiguration"][_serverIndices.value("saveCompanyConfiguration")].URL()+"/companies/{companyId}/sync/expenses/config");
    ...
    if (oai_company_configuration.hasValue()){

        
        QByteArray output = oai_company_configuration.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIConfigurationApi::saveCompanyConfigurationCallback);
    connect(this, &OAIConfigurationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIConfigurationApi::saveCompanyConfigurationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT saveCompanyConfigurationSignal(output);
        Q_EMIT saveCompanyConfigurationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT saveCompanyConfigurationSignalE(output, error_type, error_str);
        Q_EMIT saveCompanyConfigurationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT saveCompanyConfigurationSignalError(output, error_type, error_str);
        Q_EMIT saveCompanyConfigurationSignalErrorFull(worker, error_type, error_str);
    }
}
