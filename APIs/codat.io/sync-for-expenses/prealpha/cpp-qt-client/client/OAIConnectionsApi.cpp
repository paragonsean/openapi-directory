...
void OAIConnectionsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("createPartnerExpenseConnection", defaultConf);
    _serverIndices.insert("createPartnerExpenseConnection", 0);
}
...
void OAIConnectionsApi::createPartnerExpenseConnection(const QString &company_id) {
    QString fullPath = QString(_serverConfigs["createPartnerExpenseConnection"][_serverIndices.value("createPartnerExpenseConnection")].URL()+"/companies/{companyId}/sync/expenses/connections/partnerExpense");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIConnectionsApi::createPartnerExpenseConnectionCallback);
...
void OAIConnectionsApi::createPartnerExpenseConnectionCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createPartnerExpenseConnectionSignal(output);
        Q_EMIT createPartnerExpenseConnectionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createPartnerExpenseConnectionSignalE(output, error_type, error_str);
        Q_EMIT createPartnerExpenseConnectionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createPartnerExpenseConnectionSignalError(output, error_type, error_str);
        Q_EMIT createPartnerExpenseConnectionSignalErrorFull(worker, error_type, error_str);
    }
}
