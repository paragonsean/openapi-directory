...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodatExpenseApi.SyncApi();
  });
  ...
  describe('SyncApi', function() {
    describe('intiateSync', function() {
      it('should call intiateSync successfully', function(done) {
        //uncomment below and update the code to test intiateSync
        //instance.intiateSync(function(error) {
