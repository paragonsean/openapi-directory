...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodatExpenseApi.CodatErrorMessageValidationErrorsInner();
  });
  ...
  describe('CodatErrorMessageValidationErrorsInner', function() {
    it('should create an instance of CodatErrorMessageValidationErrorsInner', function() {
      // uncomment below and update the code to test CodatErrorMessageValidationErrorsInner
      //var instance = new CodatExpenseApi.CodatErrorMessageValidationErrorsInner();
      //expect(instance).to.be.a(CodatExpenseApi.CodatErrorMessageValidationErrorsInner);
    });
