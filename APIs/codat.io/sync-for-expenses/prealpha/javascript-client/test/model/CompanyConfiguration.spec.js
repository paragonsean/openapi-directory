...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodatExpenseApi.CompanyConfiguration();
  });
  ...
  describe('CompanyConfiguration', function() {
    it('should create an instance of CompanyConfiguration', function() {
      ...
      //var instance = new CodatExpenseApi.CompanyConfiguration();
      //expect(instance).to.be.a(CodatExpenseApi.CompanyConfiguration);
    });
