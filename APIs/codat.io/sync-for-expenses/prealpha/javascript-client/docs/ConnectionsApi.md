# CodatExpenseApi.ConnectionsApi
...
let apiInstance = new CodatExpenseApi.ConnectionsApi();
let companyId = "8a210b68-6988-11ed-a1eb-0242ac120002"; // String | 
apiInstance.createPartnerExpenseConnection(companyId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
