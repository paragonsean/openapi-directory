...
|------------ | ------------- | ------------- | -------------|
|**hasChildren** | **Boolean** | Boolean of whether the tracking category has child categories. |  [optional] |
|**id** | **String** | Unique identifier of the tracking category. |  [optional] |
...
|**name** | **String** | Name of the tracking category as it appears in the accounting software. |  [optional] |
|**parentId** | **String** | ID of the parent tracking category |  [optional] |
