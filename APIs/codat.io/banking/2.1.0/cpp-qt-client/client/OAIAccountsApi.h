...
public:
    ...
    */
    virtual void listAccounts(const QString &company_id, const QString &connection_id, const qint32 &page, const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &query = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order_by = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void listAccountsSignal(OAIAccounts summary);


    void listAccountsSignalFull(OAIHttpRequestWorker *worker, OAIAccounts summary);

    Q_DECL_DEPRECATED_X("Use listAccountsSignalError() instead")
    void listAccountsSignalE(OAIAccounts summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listAccountsSignalError(OAIAccounts summary, QNetworkReply::NetworkError error_type, const QString &error_str);
