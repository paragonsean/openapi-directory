...
void OAIAccountsApi::listAccounts(const QString &company_id, const QString &connection_id, const qint32 &page, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &query, const ::OpenAPI::OptionalParam<QString> &order_by) {
    QString fullPath = QString(_serverConfigs["listAccounts"][_serverIndices.value("listAccounts")].URL()+"/companies/{companyId}/connections/{connectionId}/data/banking-accounts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::listAccountsCallback);
...
void OAIAccountsApi::listAccountsCallback(OAIHttpRequestWorker *worker) {
