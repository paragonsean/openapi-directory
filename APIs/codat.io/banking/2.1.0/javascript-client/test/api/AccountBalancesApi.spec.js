...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BankingApi.AccountBalancesApi();
  });
  ...
  describe('AccountBalancesApi', function() {
    describe('listAccountBalances', function() {
      it('should call listAccountBalances successfully', function(done) {
        //uncomment below and update the code to test listAccountBalances
        //instance.listAccountBalances(function(error) {
