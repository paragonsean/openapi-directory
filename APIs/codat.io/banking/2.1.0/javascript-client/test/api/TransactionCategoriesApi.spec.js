...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BankingApi.TransactionCategoriesApi();
  });
  ...
  describe('TransactionCategoriesApi', function() {
    describe('listTransactionCategories', function() {
      it('should call listTransactionCategories successfully', function(done) {
        //uncomment below and update the code to test listTransactionCategories
        //instance.listTransactionCategories(function(error) {
