...
<a id="listTransactionCategories"></a>
# **listTransactionCategories**
> TransactionCategories listTransactionCategories(page, pageSize, query, orderBy)
...
import org.openapitools.client.api.TransactionCategoriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TransactionCategoriesApi apiInstance = new TransactionCategoriesApi(defaultClient);
    ...
    try {
      TransactionCategories result = apiInstance.listTransactionCategories(page, pageSize, query, orderBy);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransactionCategoriesApi#listTransactionCategories");
