...
|------------- | ------------- | -------------|
| [**listAccountBalances**](AccountBalancesApi.md#listAccountBalances) | **GET** /companies/{companyId}/connections/{connectionId}/data/banking-accountBalances | List account balances |


<a id="listAccountBalances"></a>
# **listAccountBalances**
> AccountBalances listAccountBalances(companyId, connectionId, page, pageSize, query, orderBy)
