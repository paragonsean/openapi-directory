...
> Transactions listBankTransactions(page, pageSize, query, orderBy)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Transactions result = apiInstance.listBankTransactions(page, pageSize, query, orderBy);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransactionsApi#listBankTransactions");
