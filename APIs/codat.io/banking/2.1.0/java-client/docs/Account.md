...
|**balance** | [**AccountBalanceAmounts**](AccountBalanceAmounts.md) | An object containing bank balance data. |  |
|**currency** | **String** | The currency code for the account. |  |
|**holder** | **String** | The name of the person or company who holds the account. |  [optional] |
|**id** | **String** | The ID of the account from the provider. |  |
|**identifiers** | [**AccountIdentifiers**](AccountIdentifiers.md) |  |  |
|**informalName** | **String** | The friendly name of the account, chosen by the holder. This may not have been set by the account holder and therefore is not always available. |  [optional] |
|**institution** | [**AccountInstitution**](AccountInstitution.md) |  |  |
