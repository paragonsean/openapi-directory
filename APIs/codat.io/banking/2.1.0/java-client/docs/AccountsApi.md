...
<a id="listAccounts"></a>
# **listAccounts**
> Accounts listAccounts(companyId, connectionId, page, pageSize, query, orderBy)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Accounts result = apiInstance.listAccounts(companyId, connectionId, page, pageSize, query, orderBy);
