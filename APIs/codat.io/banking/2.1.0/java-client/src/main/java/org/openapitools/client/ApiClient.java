...
public class ApiClient {
    ...
    private String basePath = "https://api.codat.io";
    ...
    public ApiClient() {
        ...
        authentications.put("auth_header", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.codat.io
