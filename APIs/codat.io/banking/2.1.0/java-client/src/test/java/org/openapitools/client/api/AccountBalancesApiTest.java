...
/**
 * API tests for AccountBalancesApi
 */
@Disabled
public class AccountBalancesApiTest {

    private final AccountBalancesApi api = new AccountBalancesApi();
    ...
    public void listAccountBalancesTest() throws ApiException {
        ...
        String query = null;
        String orderBy = null;
        AccountBalances response = api.listAccountBalances(companyId, connectionId, page, pageSize, query, orderBy);
