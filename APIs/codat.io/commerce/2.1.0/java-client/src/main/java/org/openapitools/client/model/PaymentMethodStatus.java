 ...
 */
@JsonAdapter(PaymentMethodStatus.Adapter.class)
public enum PaymentMethodStatus {
  ...
  public static class Adapter extends TypeAdapter<PaymentMethodStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PaymentMethodStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PaymentMethodStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PaymentMethodStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PaymentMethodStatus.fromValue(value);
  }
}
