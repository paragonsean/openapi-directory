...
public class OrdersApi {
     ...
     */
    public okhttp3.Call listOrdersCall(Integer page, Integer pageSize, String query, String orderBy, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/companies/{companyId}/connections/{connectionId}/data/commerce-orders";
    ...
    private okhttp3.Call listOrdersValidateBeforeCall(Integer page, Integer pageSize, String query, String orderBy, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'page' is set
        if (page == null) {
            throw new ApiException("Missing the required parameter 'page' when calling listOrders(Async)");
        }

        return listOrdersCall(page, pageSize, query, orderBy, _callback);
     ...
     */
    public Orders listOrders(Integer page, Integer pageSize, String query, String orderBy) throws ApiException {
        ApiResponse<Orders> localVarResp = listOrdersWithHttpInfo(page, pageSize, query, orderBy);
     ...
     */
    public ApiResponse<Orders> listOrdersWithHttpInfo(Integer page, Integer pageSize, String query, String orderBy) throws ApiException {
        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(page, pageSize, query, orderBy, null);
     ...
     */
    public okhttp3.Call listOrdersAsync(Integer page, Integer pageSize, String query, String orderBy, final ApiCallback<Orders> _callback) throws ApiException {

        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(page, pageSize, query, orderBy, _callback);
        Type localVarReturnType = new TypeToken<Orders>(){}.getType();
