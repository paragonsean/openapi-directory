...
#include <iostream>
#include "../client/OAICompanyInfoApi.h"
...
void Example::exampleFunction1(){
     OAICompanyInfoApi apiInstance;
     
      // Configure API key authorization: auth_header
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAICompanyInfoApi::getCompanyInfoSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAICompanyInfoApi::getCompanyInfoSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.getCompanyInfo(company_idconnection_id);
