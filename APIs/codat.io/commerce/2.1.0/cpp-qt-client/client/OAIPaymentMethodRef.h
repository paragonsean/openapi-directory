...
/*
 * OAIPaymentMethodRef.h
 *
 * The payment method the payment is linked to in the commerce platform.
 */

#ifndef OAIPaymentMethodRef_H
#define OAIPaymentMethodRef_H
...
class OAIPaymentMethodRef : public OAIObject {
public:
    OAIPaymentMethodRef();
    OAIPaymentMethodRef(QString json);
    ~OAIPaymentMethodRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodRef)

#endif // OAIPaymentMethodRef_H
