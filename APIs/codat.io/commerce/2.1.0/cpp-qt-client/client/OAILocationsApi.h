...
#include "OAILocationsResponse.h"
#include <QString>
...
public:
    ...
    */
    virtual void listLocations(const QString &company_id, const QString &connection_id);
...
Q_SIGNALS:
    ...
    void listLocationsSignal(OAILocationsResponse summary);


    void listLocationsSignalFull(OAIHttpRequestWorker *worker, OAILocationsResponse summary);

    Q_DECL_DEPRECATED_X("Use listLocationsSignalError() instead")
    void listLocationsSignalE(OAILocationsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listLocationsSignalError(OAILocationsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
