...
#ifndef OAILocationRef_H
#define OAILocationRef_H
...
class OAILocationRef : public OAIObject {
public:
    OAILocationRef();
    OAILocationRef(QString json);
    ~OAILocationRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationRef)

#endif // OAILocationRef_H
