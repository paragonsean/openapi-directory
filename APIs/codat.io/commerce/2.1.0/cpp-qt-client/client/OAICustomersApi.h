...
public:
    ...
    */
    virtual void listCustomers(const qint32 &page, const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &query = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order_by = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void listCustomersSignal(OAICustomers summary);


    void listCustomersSignalFull(OAIHttpRequestWorker *worker, OAICustomers summary);

    Q_DECL_DEPRECATED_X("Use listCustomersSignalError() instead")
    void listCustomersSignalE(OAICustomers summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listCustomersSignalError(OAICustomers summary, QNetworkReply::NetworkError error_type, const QString &error_str);
