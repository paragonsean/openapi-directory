...
public:
    ...
    */
    virtual void listDisputes(const qint32 &page, const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &query = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order_by = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void listDisputesSignal(OAIDisputes summary);


    void listDisputesSignalFull(OAIHttpRequestWorker *worker, OAIDisputes summary);

    Q_DECL_DEPRECATED_X("Use listDisputesSignalError() instead")
    void listDisputesSignalE(OAIDisputes summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listDisputesSignalError(OAIDisputes summary, QNetworkReply::NetworkError error_type, const QString &error_str);
