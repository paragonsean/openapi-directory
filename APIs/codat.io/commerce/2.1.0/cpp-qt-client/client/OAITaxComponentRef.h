...
class OAITaxComponentRef : public OAIObject {
public:
    OAITaxComponentRef();
    OAITaxComponentRef(QString json);
    ~OAITaxComponentRef() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxComponentRef)

#endif // OAITaxComponentRef_H
