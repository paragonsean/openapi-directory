...
void OAIProductsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("listProductCategories", defaultConf);
    _serverIndices.insert("listProductCategories", 0);
...
void OAIProductsApi::listProductCategories(const qint32 &page, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &query, const ::OpenAPI::OptionalParam<QString> &order_by) {
    QString fullPath = QString(_serverConfigs["listProductCategories"][_serverIndices.value("listProductCategories")].URL()+"/companies/{companyId}/connections/{connectionId}/data/commerce-productCategories");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::listProductCategoriesCallback);
...
void OAIProductsApi::listProductCategoriesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProductCategories output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listProductCategoriesSignal(output);
        Q_EMIT listProductCategoriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listProductCategoriesSignalE(output, error_type, error_str);
        Q_EMIT listProductCategoriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listProductCategoriesSignalError(output, error_type, error_str);
        Q_EMIT listProductCategoriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProductsApi::listProducts(const qint32 &page, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &query, const ::OpenAPI::OptionalParam<QString> &order_by) {
    QString fullPath = QString(_serverConfigs["listProducts"][_serverIndices.value("listProducts")].URL()+"/companies/{companyId}/connections/{connectionId}/data/commerce-products");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::listProductsCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProductsApi::listProductsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
