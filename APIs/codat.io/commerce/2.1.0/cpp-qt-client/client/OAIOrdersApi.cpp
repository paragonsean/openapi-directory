...
void OAIOrdersApi::listOrders(const qint32 &page, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &query, const ::OpenAPI::OptionalParam<QString> &order_by) {
    QString fullPath = QString(_serverConfigs["listOrders"][_serverIndices.value("listOrders")].URL()+"/companies/{companyId}/connections/{connectionId}/data/commerce-orders");
