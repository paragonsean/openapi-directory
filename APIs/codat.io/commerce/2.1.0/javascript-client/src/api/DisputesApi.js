...
import Disputes from '../model/Disputes';
...
export default class DisputesApi {
    ...
    */
     ...
     * @param {module:model/Disputes} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/Disputes}
     */
    listDisputes(page, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'page' is set
      if (page === undefined || page === null) {
        throw new Error("Missing the required parameter 'page' when calling listDisputes");
      }
