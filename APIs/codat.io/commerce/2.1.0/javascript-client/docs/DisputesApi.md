# CommerceApi.DisputesApi

All URIs are relative to *https://api.codat.io*

Method | HTTP request | Description
------------- | ------------- | -------------
[**listDisputes**](DisputesApi.md#listDisputes) | **GET** /companies/{companyId}/connections/{connectionId}/data/commerce-disputes | List disputes



## listDisputes

> Disputes listDisputes(page, opts)
...
let apiInstance = new CommerceApi.DisputesApi();
...
apiInstance.listDisputes(page, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
