...
**ancestorRefs** | [**[RecordRef]**](RecordRef.md) | A collection of parent product categories implicitly ordered with the immediate parent last in the list. | [optional] 
**hasChildren** | **Boolean** | A boolean indicating whether there are other product categories beneath this one in the hierarchy. | [optional] 
**id** | **String** | The unique identifier of the product category | [optional] 
**name** | **String** | The name of the product category | [optional] 
