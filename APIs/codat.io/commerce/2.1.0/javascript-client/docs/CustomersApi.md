...
> Customers listCustomers(page, opts)
...
let apiInstance = new CommerceApi.CustomersApi();
...
apiInstance.listCustomers(page, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
