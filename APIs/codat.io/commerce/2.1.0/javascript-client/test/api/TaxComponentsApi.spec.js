...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.TaxComponentsApi();
  });
  ...
  describe('TaxComponentsApi', function() {
    describe('getTaxComponents', function() {
      it('should call getTaxComponents successfully', function(done) {
        //uncomment below and update the code to test getTaxComponents
        //instance.getTaxComponents(function(error) {
