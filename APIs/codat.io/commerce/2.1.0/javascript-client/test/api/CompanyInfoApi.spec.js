...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.CompanyInfoApi();
  });
  ...
  describe('CompanyInfoApi', function() {
    describe('getCompanyInfo', function() {
      it('should call getCompanyInfo successfully', function(done) {
        //uncomment below and update the code to test getCompanyInfo
        //instance.getCompanyInfo(function(error) {
