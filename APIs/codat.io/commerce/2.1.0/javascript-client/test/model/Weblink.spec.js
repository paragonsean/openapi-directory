...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.Weblink();
  });
  ...
  describe('Weblink', function() {
    it('should create an instance of Weblink', function() {
      // uncomment below and update the code to test Weblink
      //var instance = new CommerceApi.Weblink();
      //expect(instance).to.be.a(CommerceApi.Weblink);
    });
