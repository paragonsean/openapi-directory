...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.TaxComponentRef();
  });
  ...
  describe('TaxComponentRef', function() {
    it('should create an instance of TaxComponentRef', function() {
      // uncomment below and update the code to test TaxComponentRef
      //var instance = new CommerceApi.TaxComponentRef();
      //expect(instance).to.be.a(CommerceApi.TaxComponentRef);
    });
