...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.ProductVariantRef();
  });
  ...
  describe('ProductVariantRef', function() {
    it('should create an instance of ProductVariantRef', function() {
      // uncomment below and update the code to test ProductVariantRef
      //var instance = new CommerceApi.ProductVariantRef();
      //expect(instance).to.be.a(CommerceApi.ProductVariantRef);
    });
