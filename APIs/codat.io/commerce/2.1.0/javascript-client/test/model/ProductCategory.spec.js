...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.ProductCategory();
  });
  ...
  describe('ProductCategory', function() {
    it('should create an instance of ProductCategory', function() {
      ...
      //var instance = new CommerceApi.ProductCategory();
      //expect(instance).to.be.a(CommerceApi.ProductCategory);
    });
    ...
    it('should have the property ancestorRefs (base name: "ancestorRefs")', function() {
      // uncomment below and update the code to test the property ancestorRefs
      //var instance = new CommerceApi.ProductCategory();
      //expect(instance).to.be();
    });
