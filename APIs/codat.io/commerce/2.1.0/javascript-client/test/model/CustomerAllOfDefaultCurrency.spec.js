...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.CustomerAllOfDefaultCurrency();
  });
  ...
  describe('CustomerAllOfDefaultCurrency', function() {
    it('should create an instance of CustomerAllOfDefaultCurrency', function() {
      // uncomment below and update the code to test CustomerAllOfDefaultCurrency
      //var instance = new CommerceApi.CustomerAllOfDefaultCurrency();
      //expect(instance).to.be.a(CommerceApi.CustomerAllOfDefaultCurrency);
    });
