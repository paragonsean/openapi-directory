...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.Locations();
  });
  ...
  describe('Locations', function() {
    it('should create an instance of Locations', function() {
      // uncomment below and update the code to test Locations
      //var instance = new CommerceApi.Locations();
      //expect(instance).to.be.a(CommerceApi.Locations);
    });
