...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.OrderAllOfCurrency();
  });
  ...
  describe('OrderAllOfCurrency', function() {
    it('should create an instance of OrderAllOfCurrency', function() {
      // uncomment below and update the code to test OrderAllOfCurrency
      //var instance = new CommerceApi.OrderAllOfCurrency();
      //expect(instance).to.be.a(CommerceApi.OrderAllOfCurrency);
    });
