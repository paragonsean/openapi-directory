...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.CustomerRef();
  });
  ...
  describe('CustomerRef', function() {
    it('should create an instance of CustomerRef', function() {
      // uncomment below and update the code to test CustomerRef
      //var instance = new CommerceApi.CustomerRef();
      //expect(instance).to.be.a(CommerceApi.CustomerRef);
    });
