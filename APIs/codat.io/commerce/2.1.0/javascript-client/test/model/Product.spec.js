...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.Product();
  });
  ...
  describe('Product', function() {
    it('should create an instance of Product', function() {
      ...
      //var instance = new CommerceApi.Product();
      //expect(instance).to.be.a(CommerceApi.Product);
    });
    ...
    it('should have the property categorization (base name: "categorization")', function() {
      // uncomment below and update the code to test the property categorization
      //var instance = new CommerceApi.Product();
      //expect(instance).to.be();
    });
