...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.Dispute();
  });
  ...
  describe('Dispute', function() {
    it('should create an instance of Dispute', function() {
      ...
      //var instance = new CommerceApi.Dispute();
      //expect(instance).to.be.a(CommerceApi.Dispute);
    });
    ...
    it('should have the property disputedTransactions (base name: "disputedTransactions")', function() {
      // uncomment below and update the code to test the property disputedTransactions
      //var instance = new CommerceApi.Dispute();
      //expect(instance).to.be();
    });
