...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.Payment();
  });
  ...
  describe('Payment', function() {
    it('should create an instance of Payment', function() {
      ...
      //var instance = new CommerceApi.Payment();
      //expect(instance).to.be.a(CommerceApi.Payment);
    });
    ...
    it('should have the property paymentMethodRef (base name: "paymentMethodRef")', function() {
      // uncomment below and update the code to test the property paymentMethodRef
      //var instance = new CommerceApi.Payment();
      //expect(instance).to.be();
    });

    it('should have the property paymentProvider (base name: "paymentProvider")', function() {
