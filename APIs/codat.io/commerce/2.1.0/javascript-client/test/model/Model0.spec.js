...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.Model0();
  });
  ...
  describe('Model0', function() {
    it('should create an instance of Model0', function() {
      // uncomment below and update the code to test Model0
      //var instance = new CommerceApi.Model0();
      //expect(instance).to.be.a(CommerceApi.Model0);
    });
