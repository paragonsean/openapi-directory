...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.PaymentMethodRef();
  });
  ...
  describe('PaymentMethodRef', function() {
    it('should create an instance of PaymentMethodRef', function() {
      // uncomment below and update the code to test PaymentMethodRef
      //var instance = new CommerceApi.PaymentMethodRef();
      //expect(instance).to.be.a(CommerceApi.PaymentMethodRef);
    });
