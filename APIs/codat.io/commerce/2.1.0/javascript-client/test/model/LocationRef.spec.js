...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommerceApi.LocationRef();
  });
  ...
  describe('LocationRef', function() {
    it('should create an instance of LocationRef', function() {
      // uncomment below and update the code to test LocationRef
      //var instance = new CommerceApi.LocationRef();
      //expect(instance).to.be.a(CommerceApi.LocationRef);
    });
