...
/*
 * OAIRetrieveComments_200_response_results_inner_parent.h
 *
 * 
 */

#ifndef OAIRetrieveComments_200_response_results_inner_parent_H
#define OAIRetrieveComments_200_response_results_inner_parent_H
...
class OAIRetrieveComments_200_response_results_inner_parent : public OAIObject {
public:
    OAIRetrieveComments_200_response_results_inner_parent();
    OAIRetrieveComments_200_response_results_inner_parent(QString json);
    ~OAIRetrieveComments_200_response_results_inner_parent() override;
    ...
    void setBlockId(const QString &block_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieveComments_200_response_results_inner_parent)

#endif // OAIRetrieveComments_200_response_results_inner_parent_H
