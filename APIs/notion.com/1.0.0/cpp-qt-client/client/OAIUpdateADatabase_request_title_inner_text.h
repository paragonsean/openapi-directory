...
/*
 * OAIUpdateADatabase_request_title_inner_text.h
 *
 * 
 */

#ifndef OAIUpdateADatabase_request_title_inner_text_H
#define OAIUpdateADatabase_request_title_inner_text_H
...
class OAIUpdateADatabase_request_title_inner_text : public OAIObject {
public:
    OAIUpdateADatabase_request_title_inner_text();
    OAIUpdateADatabase_request_title_inner_text(QString json);
    ~OAIUpdateADatabase_request_title_inner_text() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateADatabase_request_title_inner_text)

#endif // OAIUpdateADatabase_request_title_inner_text_H
