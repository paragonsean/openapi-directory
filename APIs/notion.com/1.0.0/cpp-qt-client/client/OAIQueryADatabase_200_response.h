...
/*
 * OAIQueryADatabase_200_response.h
 *
 * 
 */

#ifndef OAIQueryADatabase_200_response_H
#define OAIQueryADatabase_200_response_H
...
namespace OpenAPI {
class OAIQueryADatabase_200_response_results_inner;

class OAIQueryADatabase_200_response : public OAIObject {
public:
    OAIQueryADatabase_200_response();
    OAIQueryADatabase_200_response(QString json);
    ~OAIQueryADatabase_200_response() override;
    ...
    QList<OAIQueryADatabase_200_response_results_inner> getResults() const;
    void setResults(const QList<OAIQueryADatabase_200_response_results_inner> &results);
...
private:
    ...
    QList<OAIQueryADatabase_200_response_results_inner> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryADatabase_200_response)

#endif // OAIQueryADatabase_200_response_H
