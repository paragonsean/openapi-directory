...
/*
 * OAIQueryADatabase_200_response_results_inner_parent.h
 *
 * 
 */

#ifndef OAIQueryADatabase_200_response_results_inner_parent_H
#define OAIQueryADatabase_200_response_results_inner_parent_H
...
class OAIQueryADatabase_200_response_results_inner_parent : public OAIObject {
public:
    OAIQueryADatabase_200_response_results_inner_parent();
    OAIQueryADatabase_200_response_results_inner_parent(QString json);
    ~OAIQueryADatabase_200_response_results_inner_parent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryADatabase_200_response_results_inner_parent)

#endif // OAIQueryADatabase_200_response_results_inner_parent_H
