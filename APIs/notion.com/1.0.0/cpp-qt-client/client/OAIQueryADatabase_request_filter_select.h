...
/*
 * OAIQueryADatabase_request_filter_select.h
 *
 * 
 */

#ifndef OAIQueryADatabase_request_filter_select_H
#define OAIQueryADatabase_request_filter_select_H
...
class OAIQueryADatabase_request_filter_select : public OAIObject {
public:
    OAIQueryADatabase_request_filter_select();
    OAIQueryADatabase_request_filter_select(QString json);
    ~OAIQueryADatabase_request_filter_select() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryADatabase_request_filter_select)

#endif // OAIQueryADatabase_request_filter_select_H
