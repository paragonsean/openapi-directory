...
/*
 * OAIRetrieveADatabase_200_response_title_inner_text.h
 *
 * 
 */

#ifndef OAIRetrieveADatabase_200_response_title_inner_text_H
#define OAIRetrieveADatabase_200_response_title_inner_text_H
...
class OAIRetrieveADatabase_200_response_title_inner_text : public OAIObject {
public:
    OAIRetrieveADatabase_200_response_title_inner_text();
    OAIRetrieveADatabase_200_response_title_inner_text(QString json);
    ~OAIRetrieveADatabase_200_response_title_inner_text() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieveADatabase_200_response_title_inner_text)

#endif // OAIRetrieveADatabase_200_response_title_inner_text_H
