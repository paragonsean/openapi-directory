...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.DatabasesApi();
  });
  ...
  describe('DatabasesApi', function() {
    describe('queryADatabase', function() {
      it('should call queryADatabase successfully', function(done) {
        //uncomment below and update the code to test queryADatabase
        //instance.queryADatabase(function(error) {
    ...
    describe('retrieveADatabase', function() {
      it('should call retrieveADatabase successfully', function(done) {
        //uncomment below and update the code to test retrieveADatabase
        //instance.retrieveADatabase(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateADatabase', function() {
      it('should call updateADatabase successfully', function(done) {
        //uncomment below and update the code to test updateADatabase
        //instance.updateADatabase(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
