...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.PagesApi();
  });
  ...
  describe('PagesApi', function() {
    describe('retrieveAPage', function() {
      it('should call retrieveAPage successfully', function(done) {
        //uncomment below and update the code to test retrieveAPage
        //instance.retrieveAPage(function(error) {
    ...
    describe('retrieveAPagePropertyItem', function() {
      it('should call retrieveAPagePropertyItem successfully', function(done) {
        //uncomment below and update the code to test retrieveAPagePropertyItem
        //instance.retrieveAPagePropertyItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updatePageProperties', function() {
      it('should call updatePageProperties successfully', function(done) {
        //uncomment below and update the code to test updatePageProperties
        //instance.updatePageProperties(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
