...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.CommentsApi();
  });
  ...
  describe('CommentsApi', function() {
    describe('retrieveComments', function() {
      it('should call retrieveComments successfully', function(done) {
        //uncomment below and update the code to test retrieveComments
        //instance.retrieveComments(function(error) {
