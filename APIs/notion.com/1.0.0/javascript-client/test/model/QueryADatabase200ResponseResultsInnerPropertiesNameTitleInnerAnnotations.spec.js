...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerAnnotations();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerAnnotations', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerAnnotations', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerAnnotations
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerAnnotations();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerAnnotations);
    });
