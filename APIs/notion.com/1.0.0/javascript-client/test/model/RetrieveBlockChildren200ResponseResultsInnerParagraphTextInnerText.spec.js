...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraphTextInnerText();
  });
  ...
  describe('RetrieveBlockChildren200ResponseResultsInnerParagraphTextInnerText', function() {
    it('should create an instance of RetrieveBlockChildren200ResponseResultsInnerParagraphTextInnerText', function() {
      // uncomment below and update the code to test RetrieveBlockChildren200ResponseResultsInnerParagraphTextInnerText
      //var instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraphTextInnerText();
      //expect(instance).to.be.a(NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraphTextInnerText);
    });
