...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerText();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerText', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerText', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerText
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerText();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInnerText);
    });
