...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesAuthor();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesAuthor', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesAuthor', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesAuthor
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesAuthor();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesAuthor);
    });
