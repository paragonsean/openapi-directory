...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2TextInner();
  });
  ...
  describe('AppendBlockChildrenRequestChildrenInnerHeading2TextInner', function() {
    it('should create an instance of AppendBlockChildrenRequestChildrenInnerHeading2TextInner', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequestChildrenInnerHeading2TextInner
      //var instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2TextInner();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2TextInner);
    });
