...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesName();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesName', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesName', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesName
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesName();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesName);
    });
