...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200Response();
  });
  ...
  describe('UpdatePageProperties200Response', function() {
    it('should create an instance of UpdatePageProperties200Response', function() {
      // uncomment below and update the code to test UpdatePageProperties200Response
      //var instance = new NotionApi.UpdatePageProperties200Response();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200Response);
    });
