...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesRead();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesRead', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesRead', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesRead
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesRead();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesRead);
    });
