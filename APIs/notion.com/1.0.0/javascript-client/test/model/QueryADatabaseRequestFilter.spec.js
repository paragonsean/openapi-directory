...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabaseRequestFilter();
  });
  ...
  describe('QueryADatabaseRequestFilter', function() {
    it('should create an instance of QueryADatabaseRequestFilter', function() {
      // uncomment below and update the code to test QueryADatabaseRequestFilter
      //var instance = new NotionApi.QueryADatabaseRequestFilter();
      //expect(instance).to.be.a(NotionApi.QueryADatabaseRequestFilter);
    });
