...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublisherSelect();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesPublisherSelect', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesPublisherSelect', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesPublisherSelect
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublisherSelect();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublisherSelect);
    });
