...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesScore5();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesScore5', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesScore5', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesScore5
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesScore5();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesScore5);
    });
