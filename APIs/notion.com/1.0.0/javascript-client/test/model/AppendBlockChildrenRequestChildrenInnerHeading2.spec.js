...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2();
  });
  ...
  describe('AppendBlockChildrenRequestChildrenInnerHeading2', function() {
    it('should create an instance of AppendBlockChildrenRequestChildrenInnerHeading2', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequestChildrenInnerHeading2
      //var instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2);
    });
