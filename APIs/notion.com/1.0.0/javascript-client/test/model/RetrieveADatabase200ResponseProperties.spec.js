...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponseProperties();
  });
  ...
  describe('RetrieveADatabase200ResponseProperties', function() {
    it('should create an instance of RetrieveADatabase200ResponseProperties', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponseProperties
      //var instance = new NotionApi.RetrieveADatabase200ResponseProperties();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponseProperties);
    });
