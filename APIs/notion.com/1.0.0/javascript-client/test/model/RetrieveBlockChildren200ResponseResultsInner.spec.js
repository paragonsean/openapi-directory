...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInner();
  });
  ...
  describe('RetrieveBlockChildren200ResponseResultsInner', function() {
    it('should create an instance of RetrieveBlockChildren200ResponseResultsInner', function() {
      // uncomment below and update the code to test RetrieveBlockChildren200ResponseResultsInner
      //var instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInner();
      //expect(instance).to.be.a(NotionApi.RetrieveBlockChildren200ResponseResultsInner);
    });
