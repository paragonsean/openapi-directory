...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponsePropertiesPublisher();
  });
  ...
  describe('UpdateADatabase200ResponsePropertiesPublisher', function() {
    it('should create an instance of UpdateADatabase200ResponsePropertiesPublisher', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponsePropertiesPublisher
      //var instance = new NotionApi.UpdateADatabase200ResponsePropertiesPublisher();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponsePropertiesPublisher);
    });
