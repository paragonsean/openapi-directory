...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublisher();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesPublisher', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesPublisher', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesPublisher
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublisher();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesPublisher);
    });
