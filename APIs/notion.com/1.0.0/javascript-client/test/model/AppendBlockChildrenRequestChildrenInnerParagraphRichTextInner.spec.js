...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInner();
  });
  ...
  describe('AppendBlockChildrenRequestChildrenInnerParagraphRichTextInner', function() {
    it('should create an instance of AppendBlockChildrenRequestChildrenInnerParagraphRichTextInner', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequestChildrenInnerParagraphRichTextInner
      //var instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInner();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInner);
    });
