...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesScore5Select();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesScore5Select', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesScore5Select', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesScore5Select
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesScore5Select();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesScore5Select);
    });
