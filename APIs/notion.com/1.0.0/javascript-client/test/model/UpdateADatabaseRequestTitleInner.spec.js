...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabaseRequestTitleInner();
  });
  ...
  describe('UpdateADatabaseRequestTitleInner', function() {
    it('should create an instance of UpdateADatabaseRequestTitleInner', function() {
      // uncomment below and update the code to test UpdateADatabaseRequestTitleInner
      //var instance = new NotionApi.UpdateADatabaseRequestTitleInner();
      //expect(instance).to.be.a(NotionApi.UpdateADatabaseRequestTitleInner);
    });
