...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2TextInnerText();
  });
  ...
  describe('AppendBlockChildrenRequestChildrenInnerHeading2TextInnerText', function() {
    it('should create an instance of AppendBlockChildrenRequestChildrenInnerHeading2TextInnerText', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequestChildrenInnerHeading2TextInnerText
      //var instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2TextInnerText();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequestChildrenInnerHeading2TextInnerText);
    });
