...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesNameTitleInner();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesNameTitleInner', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesNameTitleInner', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesNameTitleInner
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesNameTitleInner();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesNameTitleInner);
    });
