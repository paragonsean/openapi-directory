...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesSummaryRichTextInnerText();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesSummaryRichTextInnerText', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesSummaryRichTextInnerText', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesSummaryRichTextInnerText
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesSummaryRichTextInnerText();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesSummaryRichTextInnerText);
    });
