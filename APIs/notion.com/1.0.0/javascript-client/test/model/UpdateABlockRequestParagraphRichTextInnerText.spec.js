...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateABlockRequestParagraphRichTextInnerText();
  });
  ...
  describe('UpdateABlockRequestParagraphRichTextInnerText', function() {
    it('should create an instance of UpdateABlockRequestParagraphRichTextInnerText', function() {
      // uncomment below and update the code to test UpdateABlockRequestParagraphRichTextInnerText
      //var instance = new NotionApi.UpdateABlockRequestParagraphRichTextInnerText();
      //expect(instance).to.be.a(NotionApi.UpdateABlockRequestParagraphRichTextInnerText);
    });
