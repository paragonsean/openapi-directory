...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesAuthor();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesAuthor', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesAuthor', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesAuthor
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesAuthor();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesAuthor);
    });
