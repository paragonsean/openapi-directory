...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublisherSelect();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesPublisherSelect', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesPublisherSelect', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesPublisherSelect
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublisherSelect();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesPublisherSelect);
    });
