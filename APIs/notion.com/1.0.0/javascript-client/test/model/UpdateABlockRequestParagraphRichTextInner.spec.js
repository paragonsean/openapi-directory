...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateABlockRequestParagraphRichTextInner();
  });
  ...
  describe('UpdateABlockRequestParagraphRichTextInner', function() {
    it('should create an instance of UpdateABlockRequestParagraphRichTextInner', function() {
      // uncomment below and update the code to test UpdateABlockRequestParagraphRichTextInner
      //var instance = new NotionApi.UpdateABlockRequestParagraphRichTextInner();
      //expect(instance).to.be.a(NotionApi.UpdateABlockRequestParagraphRichTextInner);
    });
