...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesLink();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesLink', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesLink', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesLink
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesLink();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesLink);
    });
