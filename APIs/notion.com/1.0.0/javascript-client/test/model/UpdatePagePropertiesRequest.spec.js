...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePagePropertiesRequest();
  });
  ...
  describe('UpdatePagePropertiesRequest', function() {
    it('should create an instance of UpdatePagePropertiesRequest', function() {
      // uncomment below and update the code to test UpdatePagePropertiesRequest
      //var instance = new NotionApi.UpdatePagePropertiesRequest();
      //expect(instance).to.be.a(NotionApi.UpdatePagePropertiesRequest);
    });
