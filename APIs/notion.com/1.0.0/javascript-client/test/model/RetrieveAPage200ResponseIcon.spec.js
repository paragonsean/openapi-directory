...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAPage200ResponseIcon();
  });
  ...
  describe('RetrieveAPage200ResponseIcon', function() {
    it('should create an instance of RetrieveAPage200ResponseIcon', function() {
      // uncomment below and update the code to test RetrieveAPage200ResponseIcon
      //var instance = new NotionApi.RetrieveAPage200ResponseIcon();
      //expect(instance).to.be.a(NotionApi.RetrieveAPage200ResponseIcon);
    });
