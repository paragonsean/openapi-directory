...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesLink();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesLink', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesLink', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesLink
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesLink();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesLink);
    });
