...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveComments200ResponseResultsInnerRichTextInnerText();
  });
  ...
  describe('RetrieveComments200ResponseResultsInnerRichTextInnerText', function() {
    it('should create an instance of RetrieveComments200ResponseResultsInnerRichTextInnerText', function() {
      // uncomment below and update the code to test RetrieveComments200ResponseResultsInnerRichTextInnerText
      //var instance = new NotionApi.RetrieveComments200ResponseResultsInnerRichTextInnerText();
      //expect(instance).to.be.a(NotionApi.RetrieveComments200ResponseResultsInnerRichTextInnerText);
    });
