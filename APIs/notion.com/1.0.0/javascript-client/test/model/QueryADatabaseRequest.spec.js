...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabaseRequest();
  });
  ...
  describe('QueryADatabaseRequest', function() {
    it('should create an instance of QueryADatabaseRequest', function() {
      // uncomment below and update the code to test QueryADatabaseRequest
      //var instance = new NotionApi.QueryADatabaseRequest();
      //expect(instance).to.be.a(NotionApi.QueryADatabaseRequest);
    });
