...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAPage200ResponseParent();
  });
  ...
  describe('RetrieveAPage200ResponseParent', function() {
    it('should create an instance of RetrieveAPage200ResponseParent', function() {
      // uncomment below and update the code to test RetrieveAPage200ResponseParent
      //var instance = new NotionApi.RetrieveAPage200ResponseParent();
      //expect(instance).to.be.a(NotionApi.RetrieveAPage200ResponseParent);
    });
