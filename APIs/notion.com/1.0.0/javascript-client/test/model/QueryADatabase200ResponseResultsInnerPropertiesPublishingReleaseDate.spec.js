...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDate();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDate', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDate', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDate
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDate();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDate);
    });
