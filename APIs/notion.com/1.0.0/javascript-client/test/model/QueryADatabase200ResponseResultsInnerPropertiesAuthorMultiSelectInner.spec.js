...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesAuthorMultiSelectInner();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesAuthorMultiSelectInner', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesAuthorMultiSelectInner', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesAuthorMultiSelectInner
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesAuthorMultiSelectInner();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesAuthorMultiSelectInner);
    });
