...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesType();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesType', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesType', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesType
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesType();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesType);
    });
