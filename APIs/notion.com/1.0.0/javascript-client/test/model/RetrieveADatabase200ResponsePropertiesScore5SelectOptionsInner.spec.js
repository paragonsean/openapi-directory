...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesScore5SelectOptionsInner();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesScore5SelectOptionsInner', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesScore5SelectOptionsInner', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesScore5SelectOptionsInner
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesScore5SelectOptionsInner();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesScore5SelectOptionsInner);
    });
