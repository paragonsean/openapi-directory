...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesStatus();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesStatus', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesStatus', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesStatus
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesStatus();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesStatus);
    });
