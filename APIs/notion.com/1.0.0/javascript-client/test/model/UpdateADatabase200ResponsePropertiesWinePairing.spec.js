...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponsePropertiesWinePairing();
  });
  ...
  describe('UpdateADatabase200ResponsePropertiesWinePairing', function() {
    it('should create an instance of UpdateADatabase200ResponsePropertiesWinePairing', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponsePropertiesWinePairing
      //var instance = new NotionApi.UpdateADatabase200ResponsePropertiesWinePairing();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponsePropertiesWinePairing);
    });
