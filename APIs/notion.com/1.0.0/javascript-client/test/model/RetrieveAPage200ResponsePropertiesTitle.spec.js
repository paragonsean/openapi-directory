...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAPage200ResponsePropertiesTitle();
  });
  ...
  describe('RetrieveAPage200ResponsePropertiesTitle', function() {
    it('should create an instance of RetrieveAPage200ResponsePropertiesTitle', function() {
      // uncomment below and update the code to test RetrieveAPage200ResponsePropertiesTitle
      //var instance = new NotionApi.RetrieveAPage200ResponsePropertiesTitle();
      //expect(instance).to.be.a(NotionApi.RetrieveAPage200ResponsePropertiesTitle);
    });
