...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveComments200ResponseResultsInnerCreatedBy();
  });
  ...
  describe('RetrieveComments200ResponseResultsInnerCreatedBy', function() {
    it('should create an instance of RetrieveComments200ResponseResultsInnerCreatedBy', function() {
      // uncomment below and update the code to test RetrieveComments200ResponseResultsInnerCreatedBy
      //var instance = new NotionApi.RetrieveComments200ResponseResultsInnerCreatedBy();
      //expect(instance).to.be.a(NotionApi.RetrieveComments200ResponseResultsInnerCreatedBy);
    });
