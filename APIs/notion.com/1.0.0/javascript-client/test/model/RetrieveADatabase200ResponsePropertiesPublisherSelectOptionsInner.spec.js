...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublisherSelectOptionsInner();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesPublisherSelectOptionsInner', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesPublisherSelectOptionsInner', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesPublisherSelectOptionsInner
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublisherSelectOptionsInner();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesPublisherSelectOptionsInner);
    });
