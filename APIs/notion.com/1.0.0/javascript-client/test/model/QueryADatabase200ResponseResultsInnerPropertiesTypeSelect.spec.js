...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesTypeSelect();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesTypeSelect', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesTypeSelect', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesTypeSelect
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesTypeSelect();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesTypeSelect);
    });
