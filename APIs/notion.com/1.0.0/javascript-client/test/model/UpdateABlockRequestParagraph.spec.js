...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateABlockRequestParagraph();
  });
  ...
  describe('UpdateABlockRequestParagraph', function() {
    it('should create an instance of UpdateABlockRequestParagraph', function() {
      // uncomment below and update the code to test UpdateABlockRequestParagraph
      //var instance = new NotionApi.UpdateABlockRequestParagraph();
      //expect(instance).to.be.a(NotionApi.UpdateABlockRequestParagraph);
    });
