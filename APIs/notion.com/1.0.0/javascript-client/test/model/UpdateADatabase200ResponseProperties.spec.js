...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponseProperties();
  });
  ...
  describe('UpdateADatabase200ResponseProperties', function() {
    it('should create an instance of UpdateADatabase200ResponseProperties', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponseProperties
      //var instance = new NotionApi.UpdateADatabase200ResponseProperties();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponseProperties);
    });
    ...
    it('should have the property winePairing (base name: "Wine Pairing")', function() {
