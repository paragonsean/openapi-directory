...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveComments200ResponseResultsInner();
  });
  ...
  describe('RetrieveComments200ResponseResultsInner', function() {
    it('should create an instance of RetrieveComments200ResponseResultsInner', function() {
      // uncomment below and update the code to test RetrieveComments200ResponseResultsInner
      //var instance = new NotionApi.RetrieveComments200ResponseResultsInner();
      //expect(instance).to.be.a(NotionApi.RetrieveComments200ResponseResultsInner);
    });
    ...
    it('should have the property discussionId (base name: "discussion_id")', function() {
      // uncomment below and update the code to test the property discussionId
      //var instance = new NotionApi.RetrieveComments200ResponseResultsInner();
      //expect(instance).to.be();
    });
