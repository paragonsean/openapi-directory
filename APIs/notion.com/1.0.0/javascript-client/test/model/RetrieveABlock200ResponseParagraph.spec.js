...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveABlock200ResponseParagraph();
  });
  ...
  describe('RetrieveABlock200ResponseParagraph', function() {
    it('should create an instance of RetrieveABlock200ResponseParagraph', function() {
      // uncomment below and update the code to test RetrieveABlock200ResponseParagraph
      //var instance = new NotionApi.RetrieveABlock200ResponseParagraph();
      //expect(instance).to.be.a(NotionApi.RetrieveABlock200ResponseParagraph);
    });
