...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesPublisher();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesPublisher', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesPublisher', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesPublisher
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesPublisher();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesPublisher);
    });
