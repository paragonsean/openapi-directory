...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesAuthorMultiSelectInner();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesAuthorMultiSelectInner', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesAuthorMultiSelectInner', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesAuthorMultiSelectInner
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesAuthorMultiSelectInner();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesAuthorMultiSelectInner);
    });
