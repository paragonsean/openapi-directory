...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesNameTitleInnerText();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesNameTitleInnerText', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesNameTitleInnerText', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesNameTitleInnerText
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesNameTitleInnerText();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesNameTitleInnerText);
    });
