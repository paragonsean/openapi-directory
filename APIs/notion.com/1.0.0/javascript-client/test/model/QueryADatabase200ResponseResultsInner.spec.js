...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInner();
  });
  ...
  describe('QueryADatabase200ResponseResultsInner', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInner', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInner
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInner();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInner);
    });
