...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDateDate();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDateDate', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDateDate', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDateDate
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDateDate();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublishingReleaseDateDate);
    });
