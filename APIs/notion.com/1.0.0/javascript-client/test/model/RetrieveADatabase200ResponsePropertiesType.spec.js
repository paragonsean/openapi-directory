...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesType();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesType', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesType', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesType
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesType();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesType);
    });
