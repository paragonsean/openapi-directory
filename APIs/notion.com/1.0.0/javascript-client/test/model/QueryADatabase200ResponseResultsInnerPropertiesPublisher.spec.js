...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublisher();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesPublisher', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesPublisher', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesPublisher
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublisher();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesPublisher);
    });
