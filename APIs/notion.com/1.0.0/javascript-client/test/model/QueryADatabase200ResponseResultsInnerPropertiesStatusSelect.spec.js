...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesStatusSelect();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesStatusSelect', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesStatusSelect', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesStatusSelect
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesStatusSelect();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesStatusSelect);
    });
