...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponsePropertiesPublishingReleaseDate();
  });
  ...
  describe('UpdateADatabase200ResponsePropertiesPublishingReleaseDate', function() {
    it('should create an instance of UpdateADatabase200ResponsePropertiesPublishingReleaseDate', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponsePropertiesPublishingReleaseDate
      //var instance = new NotionApi.UpdateADatabase200ResponsePropertiesPublishingReleaseDate();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponsePropertiesPublishingReleaseDate);
    });
