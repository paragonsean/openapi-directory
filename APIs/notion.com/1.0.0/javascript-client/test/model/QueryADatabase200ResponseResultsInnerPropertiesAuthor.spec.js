...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesAuthor();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesAuthor', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesAuthor', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesAuthor
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesAuthor();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesAuthor);
    });
