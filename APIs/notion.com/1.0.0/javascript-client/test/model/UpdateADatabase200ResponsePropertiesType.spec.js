...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponsePropertiesType();
  });
  ...
  describe('UpdateADatabase200ResponsePropertiesType', function() {
    it('should create an instance of UpdateADatabase200ResponsePropertiesType', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponsePropertiesType
      //var instance = new NotionApi.UpdateADatabase200ResponsePropertiesType();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponsePropertiesType);
    });
