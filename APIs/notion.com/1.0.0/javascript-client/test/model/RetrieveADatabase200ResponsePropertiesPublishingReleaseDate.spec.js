...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublishingReleaseDate();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesPublishingReleaseDate', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesPublishingReleaseDate', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesPublishingReleaseDate
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesPublishingReleaseDate();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesPublishingReleaseDate);
    });
