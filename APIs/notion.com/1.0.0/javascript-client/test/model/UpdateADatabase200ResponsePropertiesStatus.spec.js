...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponsePropertiesStatus();
  });
  ...
  describe('UpdateADatabase200ResponsePropertiesStatus', function() {
    it('should create an instance of UpdateADatabase200ResponsePropertiesStatus', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponsePropertiesStatus
      //var instance = new NotionApi.UpdateADatabase200ResponsePropertiesStatus();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponsePropertiesStatus);
    });
