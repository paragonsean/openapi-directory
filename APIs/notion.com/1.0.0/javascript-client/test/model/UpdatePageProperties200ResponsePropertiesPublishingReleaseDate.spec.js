...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesPublishingReleaseDate();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesPublishingReleaseDate', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesPublishingReleaseDate', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesPublishingReleaseDate
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesPublishingReleaseDate();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesPublishingReleaseDate);
    });
