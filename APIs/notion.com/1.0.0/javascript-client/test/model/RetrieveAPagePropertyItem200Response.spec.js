...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAPagePropertyItem200Response();
  });
  ...
  describe('RetrieveAPagePropertyItem200Response', function() {
    it('should create an instance of RetrieveAPagePropertyItem200Response', function() {
      // uncomment below and update the code to test RetrieveAPagePropertyItem200Response
      //var instance = new NotionApi.RetrieveAPagePropertyItem200Response();
      //expect(instance).to.be.a(NotionApi.RetrieveAPagePropertyItem200Response);
    });
