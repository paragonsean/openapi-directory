...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesType();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesType', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesType', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesType
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesType();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesType);
    });
