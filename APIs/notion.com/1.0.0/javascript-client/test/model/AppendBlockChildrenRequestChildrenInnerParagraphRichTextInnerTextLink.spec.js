...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerTextLink();
  });
  ...
  describe('AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerTextLink', function() {
    it('should create an instance of AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerTextLink', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerTextLink
      //var instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerTextLink();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerTextLink);
    });
