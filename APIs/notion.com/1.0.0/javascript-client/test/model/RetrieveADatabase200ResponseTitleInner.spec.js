...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponseTitleInner();
  });
  ...
  describe('RetrieveADatabase200ResponseTitleInner', function() {
    it('should create an instance of RetrieveADatabase200ResponseTitleInner', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponseTitleInner
      //var instance = new NotionApi.RetrieveADatabase200ResponseTitleInner();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponseTitleInner);
    });
