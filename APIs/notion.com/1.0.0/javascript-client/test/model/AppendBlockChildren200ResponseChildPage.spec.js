...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildren200ResponseChildPage();
  });
  ...
  describe('AppendBlockChildren200ResponseChildPage', function() {
    it('should create an instance of AppendBlockChildren200ResponseChildPage', function() {
      // uncomment below and update the code to test AppendBlockChildren200ResponseChildPage
      //var instance = new NotionApi.AppendBlockChildren200ResponseChildPage();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildren200ResponseChildPage);
    });
