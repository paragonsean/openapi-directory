...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesSummaryRichTextInner();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesSummaryRichTextInner', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesSummaryRichTextInner', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesSummaryRichTextInner
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesSummaryRichTextInner();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesSummaryRichTextInner);
    });
