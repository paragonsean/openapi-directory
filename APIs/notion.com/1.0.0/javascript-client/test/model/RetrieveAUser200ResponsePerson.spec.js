...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAUser200ResponsePerson();
  });
  ...
  describe('RetrieveAUser200ResponsePerson', function() {
    it('should create an instance of RetrieveAUser200ResponsePerson', function() {
      // uncomment below and update the code to test RetrieveAUser200ResponsePerson
      //var instance = new NotionApi.RetrieveAUser200ResponsePerson();
      //expect(instance).to.be.a(NotionApi.RetrieveAUser200ResponsePerson);
    });
