...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesStatus();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesStatus', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesStatus', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesStatus
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesStatus();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesStatus);
    });
