...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePagePropertiesRequestPropertiesStatusSelect();
  });
  ...
  describe('UpdatePagePropertiesRequestPropertiesStatusSelect', function() {
    it('should create an instance of UpdatePagePropertiesRequestPropertiesStatusSelect', function() {
      // uncomment below and update the code to test UpdatePagePropertiesRequestPropertiesStatusSelect
      //var instance = new NotionApi.UpdatePagePropertiesRequestPropertiesStatusSelect();
      //expect(instance).to.be.a(NotionApi.UpdatePagePropertiesRequestPropertiesStatusSelect);
    });
