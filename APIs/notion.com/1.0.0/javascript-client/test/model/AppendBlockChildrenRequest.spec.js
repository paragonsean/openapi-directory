...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequest();
  });
  ...
  describe('AppendBlockChildrenRequest', function() {
    it('should create an instance of AppendBlockChildrenRequest', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequest
      //var instance = new NotionApi.AppendBlockChildrenRequest();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequest);
    });
