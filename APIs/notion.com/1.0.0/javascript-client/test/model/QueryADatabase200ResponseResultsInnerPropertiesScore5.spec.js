...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesScore5();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesScore5', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesScore5', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesScore5
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesScore5();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesScore5);
    });
