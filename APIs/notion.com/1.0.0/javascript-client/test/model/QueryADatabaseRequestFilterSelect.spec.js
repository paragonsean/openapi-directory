...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabaseRequestFilterSelect();
  });
  ...
  describe('QueryADatabaseRequestFilterSelect', function() {
    it('should create an instance of QueryADatabaseRequestFilterSelect', function() {
      // uncomment below and update the code to test QueryADatabaseRequestFilterSelect
      //var instance = new NotionApi.QueryADatabaseRequestFilterSelect();
      //expect(instance).to.be.a(NotionApi.QueryADatabaseRequestFilterSelect);
    });
