...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveABlock200ResponseParagraphTextInnerAnnotations();
  });
  ...
  describe('RetrieveABlock200ResponseParagraphTextInnerAnnotations', function() {
    it('should create an instance of RetrieveABlock200ResponseParagraphTextInnerAnnotations', function() {
      // uncomment below and update the code to test RetrieveABlock200ResponseParagraphTextInnerAnnotations
      //var instance = new NotionApi.RetrieveABlock200ResponseParagraphTextInnerAnnotations();
      //expect(instance).to.be.a(NotionApi.RetrieveABlock200ResponseParagraphTextInnerAnnotations);
    });
