...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveABlock200ResponseParagraphTextInner();
  });
  ...
  describe('RetrieveABlock200ResponseParagraphTextInner', function() {
    it('should create an instance of RetrieveABlock200ResponseParagraphTextInner', function() {
      // uncomment below and update the code to test RetrieveABlock200ResponseParagraphTextInner
      //var instance = new NotionApi.RetrieveABlock200ResponseParagraphTextInner();
      //expect(instance).to.be.a(NotionApi.RetrieveABlock200ResponseParagraphTextInner);
    });
