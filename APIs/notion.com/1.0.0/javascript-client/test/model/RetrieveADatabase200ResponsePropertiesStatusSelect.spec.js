...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesStatusSelect();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesStatusSelect', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesStatusSelect', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesStatusSelect
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesStatusSelect();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesStatusSelect);
    });
