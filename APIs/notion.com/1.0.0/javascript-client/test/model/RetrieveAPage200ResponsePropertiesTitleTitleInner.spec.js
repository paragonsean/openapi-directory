...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAPage200ResponsePropertiesTitleTitleInner();
  });
  ...
  describe('RetrieveAPage200ResponsePropertiesTitleTitleInner', function() {
    it('should create an instance of RetrieveAPage200ResponsePropertiesTitleTitleInner', function() {
      // uncomment below and update the code to test RetrieveAPage200ResponsePropertiesTitleTitleInner
      //var instance = new NotionApi.RetrieveAPage200ResponsePropertiesTitleTitleInner();
      //expect(instance).to.be.a(NotionApi.RetrieveAPage200ResponsePropertiesTitleTitleInner);
    });
