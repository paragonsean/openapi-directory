...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesAuthorMultiSelectOptionsInner();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesAuthorMultiSelectOptionsInner', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesAuthorMultiSelectOptionsInner', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesAuthorMultiSelectOptionsInner
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesAuthorMultiSelectOptionsInner();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesAuthorMultiSelectOptionsInner);
    });
