...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesScore5Select();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesScore5Select', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesScore5Select', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesScore5Select
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesScore5Select();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesScore5Select);
    });
