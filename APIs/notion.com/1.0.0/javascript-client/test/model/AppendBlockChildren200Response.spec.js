...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildren200Response();
  });
  ...
  describe('AppendBlockChildren200Response', function() {
    it('should create an instance of AppendBlockChildren200Response', function() {
      // uncomment below and update the code to test AppendBlockChildren200Response
      //var instance = new NotionApi.AppendBlockChildren200Response();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildren200Response);
    });

    it('should have the property childPage (base name: "child_page")', function() {
      // uncomment below and update the code to test the property childPage
      //var instance = new NotionApi.AppendBlockChildren200Response();
