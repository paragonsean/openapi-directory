...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePagePropertiesRequestPropertiesStatus();
  });
  ...
  describe('UpdatePagePropertiesRequestPropertiesStatus', function() {
    it('should create an instance of UpdatePagePropertiesRequestPropertiesStatus', function() {
      // uncomment below and update the code to test UpdatePagePropertiesRequestPropertiesStatus
      //var instance = new NotionApi.UpdatePagePropertiesRequestPropertiesStatus();
      //expect(instance).to.be.a(NotionApi.UpdatePagePropertiesRequestPropertiesStatus);
    });
