...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesName();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesName', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesName', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesName
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesName();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesName);
    });
