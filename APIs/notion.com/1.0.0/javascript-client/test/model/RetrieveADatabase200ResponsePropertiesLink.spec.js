...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesLink();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesLink', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesLink', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesLink
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesLink();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesLink);
    });
