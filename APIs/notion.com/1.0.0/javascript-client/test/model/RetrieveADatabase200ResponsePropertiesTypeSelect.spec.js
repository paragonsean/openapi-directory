...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesTypeSelect();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesTypeSelect', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesTypeSelect', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesTypeSelect
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesTypeSelect();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesTypeSelect);
    });
