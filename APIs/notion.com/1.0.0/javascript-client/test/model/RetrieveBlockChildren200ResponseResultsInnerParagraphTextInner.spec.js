...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraphTextInner();
  });
  ...
  describe('RetrieveBlockChildren200ResponseResultsInnerParagraphTextInner', function() {
    it('should create an instance of RetrieveBlockChildren200ResponseResultsInnerParagraphTextInner', function() {
      // uncomment below and update the code to test RetrieveBlockChildren200ResponseResultsInnerParagraphTextInner
      //var instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraphTextInner();
      //expect(instance).to.be.a(NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraphTextInner);
    });
