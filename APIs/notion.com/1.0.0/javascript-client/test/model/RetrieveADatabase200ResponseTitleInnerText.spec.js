...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponseTitleInnerText();
  });
  ...
  describe('RetrieveADatabase200ResponseTitleInnerText', function() {
    it('should create an instance of RetrieveADatabase200ResponseTitleInnerText', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponseTitleInnerText
      //var instance = new NotionApi.RetrieveADatabase200ResponseTitleInnerText();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponseTitleInnerText);
    });
