...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerText();
  });
  ...
  describe('AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerText', function() {
    it('should create an instance of AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerText', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerText
      //var instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerText();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequestChildrenInnerParagraphRichTextInnerText);
    });
