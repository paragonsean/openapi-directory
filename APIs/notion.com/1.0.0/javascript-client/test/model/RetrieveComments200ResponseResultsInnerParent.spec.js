...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveComments200ResponseResultsInnerParent();
  });
  ...
  describe('RetrieveComments200ResponseResultsInnerParent', function() {
    it('should create an instance of RetrieveComments200ResponseResultsInnerParent', function() {
      // uncomment below and update the code to test RetrieveComments200ResponseResultsInnerParent
      //var instance = new NotionApi.RetrieveComments200ResponseResultsInnerParent();
      //expect(instance).to.be.a(NotionApi.RetrieveComments200ResponseResultsInnerParent);
    });
