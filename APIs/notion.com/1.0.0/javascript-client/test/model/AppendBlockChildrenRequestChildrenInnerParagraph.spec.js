...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraph();
  });
  ...
  describe('AppendBlockChildrenRequestChildrenInnerParagraph', function() {
    it('should create an instance of AppendBlockChildrenRequestChildrenInnerParagraph', function() {
      // uncomment below and update the code to test AppendBlockChildrenRequestChildrenInnerParagraph
      //var instance = new NotionApi.AppendBlockChildrenRequestChildrenInnerParagraph();
      //expect(instance).to.be.a(NotionApi.AppendBlockChildrenRequestChildrenInnerParagraph);
    });
