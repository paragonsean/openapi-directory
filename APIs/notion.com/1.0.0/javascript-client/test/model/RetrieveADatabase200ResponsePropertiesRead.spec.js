...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesRead();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesRead', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesRead', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesRead
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesRead();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesRead);
    });
