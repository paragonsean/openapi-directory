...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.DeleteABlock200ResponseCreatedBy();
  });
  ...
  describe('DeleteABlock200ResponseCreatedBy', function() {
    it('should create an instance of DeleteABlock200ResponseCreatedBy', function() {
      // uncomment below and update the code to test DeleteABlock200ResponseCreatedBy
      //var instance = new NotionApi.DeleteABlock200ResponseCreatedBy();
      //expect(instance).to.be.a(NotionApi.DeleteABlock200ResponseCreatedBy);
    });
