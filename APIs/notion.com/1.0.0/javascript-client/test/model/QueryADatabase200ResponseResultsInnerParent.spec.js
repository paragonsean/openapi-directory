...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerParent();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerParent', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerParent', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerParent
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerParent();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerParent);
    });
