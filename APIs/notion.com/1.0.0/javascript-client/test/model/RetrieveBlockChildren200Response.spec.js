...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveBlockChildren200Response();
  });
  ...
  describe('RetrieveBlockChildren200Response', function() {
    it('should create an instance of RetrieveBlockChildren200Response', function() {
      // uncomment below and update the code to test RetrieveBlockChildren200Response
      //var instance = new NotionApi.RetrieveBlockChildren200Response();
      //expect(instance).to.be.a(NotionApi.RetrieveBlockChildren200Response);
    });
