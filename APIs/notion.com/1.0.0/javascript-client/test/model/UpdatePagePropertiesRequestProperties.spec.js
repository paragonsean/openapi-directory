...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePagePropertiesRequestProperties();
  });
  ...
  describe('UpdatePagePropertiesRequestProperties', function() {
    it('should create an instance of UpdatePagePropertiesRequestProperties', function() {
      // uncomment below and update the code to test UpdatePagePropertiesRequestProperties
      //var instance = new NotionApi.UpdatePagePropertiesRequestProperties();
      //expect(instance).to.be.a(NotionApi.UpdatePagePropertiesRequestProperties);
    });
