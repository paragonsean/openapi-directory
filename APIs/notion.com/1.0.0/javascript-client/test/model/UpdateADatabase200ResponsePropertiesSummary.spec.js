...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponsePropertiesSummary();
  });
  ...
  describe('UpdateADatabase200ResponsePropertiesSummary', function() {
    it('should create an instance of UpdateADatabase200ResponsePropertiesSummary', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponsePropertiesSummary
      //var instance = new NotionApi.UpdateADatabase200ResponsePropertiesSummary();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponsePropertiesSummary);
    });
