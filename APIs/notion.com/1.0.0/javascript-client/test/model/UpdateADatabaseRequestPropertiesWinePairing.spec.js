...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabaseRequestPropertiesWinePairing();
  });
  ...
  describe('UpdateADatabaseRequestPropertiesWinePairing', function() {
    it('should create an instance of UpdateADatabaseRequestPropertiesWinePairing', function() {
      // uncomment below and update the code to test UpdateADatabaseRequestPropertiesWinePairing
      //var instance = new NotionApi.UpdateADatabaseRequestPropertiesWinePairing();
      //expect(instance).to.be.a(NotionApi.UpdateADatabaseRequestPropertiesWinePairing);
    });
