...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabase200ResponsePropertiesScore5();
  });
  ...
  describe('UpdateADatabase200ResponsePropertiesScore5', function() {
    it('should create an instance of UpdateADatabase200ResponsePropertiesScore5', function() {
      // uncomment below and update the code to test UpdateADatabase200ResponsePropertiesScore5
      //var instance = new NotionApi.UpdateADatabase200ResponsePropertiesScore5();
      //expect(instance).to.be.a(NotionApi.UpdateADatabase200ResponsePropertiesScore5);
    });
