...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInner();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesNameTitleInner', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesNameTitleInner', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesNameTitleInner
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInner();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesNameTitleInner);
    });
