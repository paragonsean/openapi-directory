...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabaseRequest();
  });
  ...
  describe('UpdateADatabaseRequest', function() {
    it('should create an instance of UpdateADatabaseRequest', function() {
      // uncomment below and update the code to test UpdateADatabaseRequest
      //var instance = new NotionApi.UpdateADatabaseRequest();
      //expect(instance).to.be.a(NotionApi.UpdateADatabaseRequest);
    });
