...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponseParent();
  });
  ...
  describe('RetrieveADatabase200ResponseParent', function() {
    it('should create an instance of RetrieveADatabase200ResponseParent', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponseParent
      //var instance = new NotionApi.RetrieveADatabase200ResponseParent();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponseParent);
    });
