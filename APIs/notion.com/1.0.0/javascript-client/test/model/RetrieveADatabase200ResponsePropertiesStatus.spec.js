...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesStatus();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesStatus', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesStatus', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesStatus
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesStatus();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesStatus);
    });
