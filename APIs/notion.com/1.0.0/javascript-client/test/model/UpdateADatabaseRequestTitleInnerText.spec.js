...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabaseRequestTitleInnerText();
  });
  ...
  describe('UpdateADatabaseRequestTitleInnerText', function() {
    it('should create an instance of UpdateADatabaseRequestTitleInnerText', function() {
      // uncomment below and update the code to test UpdateADatabaseRequestTitleInnerText
      //var instance = new NotionApi.UpdateADatabaseRequestTitleInnerText();
      //expect(instance).to.be.a(NotionApi.UpdateADatabaseRequestTitleInnerText);
    });
