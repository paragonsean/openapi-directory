...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAPage200ResponsePropertiesTitleTitleInnerText();
  });
  ...
  describe('RetrieveAPage200ResponsePropertiesTitleTitleInnerText', function() {
    it('should create an instance of RetrieveAPage200ResponsePropertiesTitleTitleInnerText', function() {
      // uncomment below and update the code to test RetrieveAPage200ResponsePropertiesTitleTitleInnerText
      //var instance = new NotionApi.RetrieveAPage200ResponsePropertiesTitleTitleInnerText();
      //expect(instance).to.be.a(NotionApi.RetrieveAPage200ResponsePropertiesTitleTitleInnerText);
    });
