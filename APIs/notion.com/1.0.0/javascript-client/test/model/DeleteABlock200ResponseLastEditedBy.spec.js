...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.DeleteABlock200ResponseLastEditedBy();
  });
  ...
  describe('DeleteABlock200ResponseLastEditedBy', function() {
    it('should create an instance of DeleteABlock200ResponseLastEditedBy', function() {
      // uncomment below and update the code to test DeleteABlock200ResponseLastEditedBy
      //var instance = new NotionApi.DeleteABlock200ResponseLastEditedBy();
      //expect(instance).to.be.a(NotionApi.DeleteABlock200ResponseLastEditedBy);
    });
