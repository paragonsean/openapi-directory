...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateADatabaseRequestProperties();
  });
  ...
  describe('UpdateADatabaseRequestProperties', function() {
    it('should create an instance of UpdateADatabaseRequestProperties', function() {
      // uncomment below and update the code to test UpdateADatabaseRequestProperties
      //var instance = new NotionApi.UpdateADatabaseRequestProperties();
      //expect(instance).to.be.a(NotionApi.UpdateADatabaseRequestProperties);
    });
