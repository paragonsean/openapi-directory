...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesSummary();
  });
  ...
  describe('QueryADatabase200ResponseResultsInnerPropertiesSummary', function() {
    it('should create an instance of QueryADatabase200ResponseResultsInnerPropertiesSummary', function() {
      // uncomment below and update the code to test QueryADatabase200ResponseResultsInnerPropertiesSummary
      //var instance = new NotionApi.QueryADatabase200ResponseResultsInnerPropertiesSummary();
      //expect(instance).to.be.a(NotionApi.QueryADatabase200ResponseResultsInnerPropertiesSummary);
    });
