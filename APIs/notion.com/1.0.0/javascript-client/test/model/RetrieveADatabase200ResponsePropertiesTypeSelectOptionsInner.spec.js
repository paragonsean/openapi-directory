...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesTypeSelectOptionsInner();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesTypeSelectOptionsInner', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesTypeSelectOptionsInner', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesTypeSelectOptionsInner
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesTypeSelectOptionsInner();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesTypeSelectOptionsInner);
    });
