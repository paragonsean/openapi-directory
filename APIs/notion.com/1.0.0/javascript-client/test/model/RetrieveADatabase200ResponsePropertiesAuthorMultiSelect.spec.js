...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesAuthorMultiSelect();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesAuthorMultiSelect', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesAuthorMultiSelect', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesAuthorMultiSelect
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesAuthorMultiSelect();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesAuthorMultiSelect);
    });
