...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveABlock200ResponseParagraphTextInnerText();
  });
  ...
  describe('RetrieveABlock200ResponseParagraphTextInnerText', function() {
    it('should create an instance of RetrieveABlock200ResponseParagraphTextInnerText', function() {
      // uncomment below and update the code to test RetrieveABlock200ResponseParagraphTextInnerText
      //var instance = new NotionApi.RetrieveABlock200ResponseParagraphTextInnerText();
      //expect(instance).to.be.a(NotionApi.RetrieveABlock200ResponseParagraphTextInnerText);
    });
