...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesSummary();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesSummary', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesSummary', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesSummary
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesSummary();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesSummary);
    });
