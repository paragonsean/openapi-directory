...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdateABlockRequest();
  });
  ...
  describe('UpdateABlockRequest', function() {
    it('should create an instance of UpdateABlockRequest', function() {
      // uncomment below and update the code to test UpdateABlockRequest
      //var instance = new NotionApi.UpdateABlockRequest();
      //expect(instance).to.be.a(NotionApi.UpdateABlockRequest);
    });
