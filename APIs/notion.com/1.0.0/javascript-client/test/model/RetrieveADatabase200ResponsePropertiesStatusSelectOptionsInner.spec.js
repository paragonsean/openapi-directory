...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveADatabase200ResponsePropertiesStatusSelectOptionsInner();
  });
  ...
  describe('RetrieveADatabase200ResponsePropertiesStatusSelectOptionsInner', function() {
    it('should create an instance of RetrieveADatabase200ResponsePropertiesStatusSelectOptionsInner', function() {
      // uncomment below and update the code to test RetrieveADatabase200ResponsePropertiesStatusSelectOptionsInner
      //var instance = new NotionApi.RetrieveADatabase200ResponsePropertiesStatusSelectOptionsInner();
      //expect(instance).to.be.a(NotionApi.RetrieveADatabase200ResponsePropertiesStatusSelectOptionsInner);
    });
