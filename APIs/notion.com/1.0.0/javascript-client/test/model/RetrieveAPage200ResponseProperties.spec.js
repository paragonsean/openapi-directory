...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveAPage200ResponseProperties();
  });
  ...
  describe('RetrieveAPage200ResponseProperties', function() {
    it('should create an instance of RetrieveAPage200ResponseProperties', function() {
      // uncomment below and update the code to test RetrieveAPage200ResponseProperties
      //var instance = new NotionApi.RetrieveAPage200ResponseProperties();
      //expect(instance).to.be.a(NotionApi.RetrieveAPage200ResponseProperties);
    });
