...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponsePropertiesPublishingReleaseDateDate();
  });
  ...
  describe('UpdatePageProperties200ResponsePropertiesPublishingReleaseDateDate', function() {
    it('should create an instance of UpdatePageProperties200ResponsePropertiesPublishingReleaseDateDate', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponsePropertiesPublishingReleaseDateDate
      //var instance = new NotionApi.UpdatePageProperties200ResponsePropertiesPublishingReleaseDateDate();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponsePropertiesPublishingReleaseDateDate);
    });
