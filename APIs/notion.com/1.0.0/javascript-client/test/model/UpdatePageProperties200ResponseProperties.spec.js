...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.UpdatePageProperties200ResponseProperties();
  });
  ...
  describe('UpdatePageProperties200ResponseProperties', function() {
    it('should create an instance of UpdatePageProperties200ResponseProperties', function() {
      // uncomment below and update the code to test UpdatePageProperties200ResponseProperties
      //var instance = new NotionApi.UpdatePageProperties200ResponseProperties();
      //expect(instance).to.be.a(NotionApi.UpdatePageProperties200ResponseProperties);
    });
