...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraph();
  });
  ...
  describe('RetrieveBlockChildren200ResponseResultsInnerParagraph', function() {
    it('should create an instance of RetrieveBlockChildren200ResponseResultsInnerParagraph', function() {
      // uncomment below and update the code to test RetrieveBlockChildren200ResponseResultsInnerParagraph
      //var instance = new NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraph();
      //expect(instance).to.be.a(NotionApi.RetrieveBlockChildren200ResponseResultsInnerParagraph);
    });
