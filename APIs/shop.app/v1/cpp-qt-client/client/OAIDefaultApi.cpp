...
void OAIDefaultApi::details(const QString &ids) {
    QString fullPath = QString(_serverConfigs["details"][_serverIndices.value("details")].URL()+"/openai/details");
...
void OAIDefaultApi::search(const ::OpenAPI::OptionalParam<QString> &query, const ::OpenAPI::OptionalParam<double> &price_min, const ::OpenAPI::OptionalParam<double> &price_max, const ::OpenAPI::OptionalParam<QString> &similar_to_id, const ::OpenAPI::OptionalParam<QString> &num_results) {
    QString fullPath = QString(_serverConfigs["search"][_serverIndices.value("search")].URL()+"/openai/search");
    ...
    if (similar_to_id.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "similar_to_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("similar_to_id")).append(querySuffix).append(QUrl::toPercentEncoding(similar_to_id.stringValue()));
    }
    if (num_results.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "num_results", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("num_results")).append(querySuffix).append(QUrl::toPercentEncoding(num_results.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
