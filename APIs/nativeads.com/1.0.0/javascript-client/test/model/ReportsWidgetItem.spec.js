...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NativeAdsPublisherApi.ReportsWidgetItem();
  });
  ...
  describe('ReportsWidgetItem', function() {
    it('should create an instance of ReportsWidgetItem', function() {
      // uncomment below and update the code to test ReportsWidgetItem
      //var instance = new NativeAdsPublisherApi.ReportsWidgetItem();
      //expect(instance).to.be.a(NativeAdsPublisherApi.ReportsWidgetItem);
    });
