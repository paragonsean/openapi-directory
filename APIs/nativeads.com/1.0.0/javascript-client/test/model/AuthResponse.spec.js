...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NativeAdsPublisherApi.AuthResponse();
  });
  ...
  describe('AuthResponse', function() {
    it('should create an instance of AuthResponse', function() {
      ...
      //var instance = new NativeAdsPublisherApi.AuthResponse();
      //expect(instance).to.be.a(NativeAdsPublisherApi.AuthResponse);
    });
