...
/**
 * The ReportsWebsiteItem model module.
 * @module model/ReportsWebsiteItem
 * @version 1.0.0
 */
class ReportsWebsiteItem {
    /**
     * Constructs a new <code>ReportsWebsiteItem</code>.
     * @alias module:model/ReportsWebsiteItem
     */
    constructor() { 
        
        ReportsWebsiteItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReportsWebsiteItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportsWebsiteItem} obj Optional instance to populate.
     * @return {module:model/ReportsWebsiteItem} The populated <code>ReportsWebsiteItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportsWebsiteItem();
    ...
    /**
     * Validates the JSON data with respect to <code>ReportsWebsiteItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportsWebsiteItem</code>.
     */
 ...
 */
ReportsWebsiteItem.prototype['clicks'] = undefined;

/**
 * @member {String} cpc
 */
ReportsWebsiteItem.prototype['cpc'] = undefined;

/**
 * @member {String} ctr
 */
ReportsWebsiteItem.prototype['ctr'] = undefined;

/**
 * @member {String} date
 */
ReportsWebsiteItem.prototype['date'] = undefined;

/**
 * @member {String} earnings
 */
ReportsWebsiteItem.prototype['earnings'] = undefined;

/**
 * @member {String} impressions
 */
ReportsWebsiteItem.prototype['impressions'] = undefined;

/**
 * @member {String} net_ecpm
 */
ReportsWebsiteItem.prototype['net_ecpm'] = undefined;

/**
 * @member {String} rpm
 */
ReportsWebsiteItem.prototype['rpm'] = undefined;
...
export default ReportsWebsiteItem;
