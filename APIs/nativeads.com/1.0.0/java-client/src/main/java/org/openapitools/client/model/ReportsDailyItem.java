...
public class ReportsDailyItem {
  ...
  public ReportsDailyItem() {
  }

  public ReportsDailyItem clicks(String clicks) {
    this.clicks = clicks;
    return this;
  }
  ...
  public ReportsDailyItem cpc(String cpc) {
    this.cpc = cpc;
    return this;
  }
  ...
  public ReportsDailyItem ctr(String ctr) {
    this.ctr = ctr;
    return this;
  }
  ...
  public ReportsDailyItem date(String date) {
    this.date = date;
    return this;
  }
  ...
  public ReportsDailyItem earnings(String earnings) {
  ...
  public ReportsDailyItem impressions(String impressions) {
  ...
  public ReportsDailyItem netEcpm(String netEcpm) {
  ...
  public ReportsDailyItem rpm(String rpm) {
    this.rpm = rpm;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReportsDailyItem reportsDailyItem = (ReportsDailyItem) o;
    return Objects.equals(this.clicks, reportsDailyItem.clicks) &&
        Objects.equals(this.cpc, reportsDailyItem.cpc) &&
        Objects.equals(this.ctr, reportsDailyItem.ctr) &&
        Objects.equals(this.date, reportsDailyItem.date) &&
        Objects.equals(this.earnings, reportsDailyItem.earnings) &&
        Objects.equals(this.impressions, reportsDailyItem.impressions) &&
        Objects.equals(this.netEcpm, reportsDailyItem.netEcpm) &&
        Objects.equals(this.rpm, reportsDailyItem.rpm);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportsDailyItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportsDailyItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportsDailyItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportsDailyItem is not found in the empty JSON string", ReportsDailyItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportsDailyItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportsDailyItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportsDailyItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportsDailyItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportsDailyItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportsDailyItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportsDailyItem>() {
           @Override
           public void write(JsonWriter out, ReportsDailyItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportsDailyItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportsDailyItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportsDailyItem
   * @throws IOException if the JSON string is invalid with respect to ReportsDailyItem
   */
  public static ReportsDailyItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportsDailyItem.class);
  }

  /**
   * Convert an instance of ReportsDailyItem to an JSON string
   *
   * @return JSON string
   */
