...
/*
 * OAIReportsDailyResponse.h
 *
 * 
 */

#ifndef OAIReportsDailyResponse_H
#define OAIReportsDailyResponse_H
...
namespace OpenAPI {
class OAIReportsDailyItem;
class OAITotals;

class OAIReportsDailyResponse : public OAIObject {
public:
    OAIReportsDailyResponse();
    OAIReportsDailyResponse(QString json);
    ~OAIReportsDailyResponse() override;
    ...
    QList<OAIReportsDailyItem> getItems() const;
    void setItems(const QList<OAIReportsDailyItem> &items);
...
private:
    ...
    QList<OAIReportsDailyItem> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportsDailyResponse)

#endif // OAIReportsDailyResponse_H
