...
void OAIAuthApi::initializeServerConfigs() {
    ...
    QUrl("https://api.nativeads.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("authDefaultLoginPost", defaultConf);
    _serverIndices.insert("authDefaultLoginPost", 0);
}
...
void OAIAuthApi::authDefaultLoginPost(const QString &username, const QString &password) {
    QString fullPath = QString(_serverConfigs["authDefaultLoginPost"][_serverIndices.value("authDefaultLoginPost")].URL()+"/auth/default/login");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authDefaultLoginPostCallback);
...
void OAIAuthApi::authDefaultLoginPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authDefaultLoginPostSignal(output);
        Q_EMIT authDefaultLoginPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authDefaultLoginPostSignalE(output, error_type, error_str);
        Q_EMIT authDefaultLoginPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authDefaultLoginPostSignalError(output, error_type, error_str);
        Q_EMIT authDefaultLoginPostSignalErrorFull(worker, error_type, error_str);
    }
}
