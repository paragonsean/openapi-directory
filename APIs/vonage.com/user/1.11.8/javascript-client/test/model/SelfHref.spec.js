...
(function(root, factory) {
  ...
  describe('SelfHref', function() {
    it('should create an instance of SelfHref', function() {
      // uncomment below and update the code to test SelfHref
      //var instance = new UserApi.SelfHref();
      //expect(instance).to.be.a(UserApi.SelfHref);
    });
