...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UserApi.UserHalResponse();
  });
  ...
  describe('UserHalResponse', function() {
    it('should create an instance of UserHalResponse', function() {
      // uncomment below and update the code to test UserHalResponse
      //var instance = new UserApi.UserHalResponse();
      //expect(instance).to.be.a(UserApi.UserHalResponse);
    });
