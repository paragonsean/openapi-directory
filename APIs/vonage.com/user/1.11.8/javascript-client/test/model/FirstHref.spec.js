...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UserApi.FirstHref();
  });
  ...
  describe('FirstHref', function() {
    it('should create an instance of FirstHref', function() {
      // uncomment below and update the code to test FirstHref
      //var instance = new UserApi.FirstHref();
      //expect(instance).to.be.a(UserApi.FirstHref);
    });
