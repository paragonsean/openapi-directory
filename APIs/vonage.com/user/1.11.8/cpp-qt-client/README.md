...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::userCtrl_getUserByIDSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::userCtrl_getUserByIDSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      double user_id = create(); // double | The Vonage Business Cloud user ID
      apiInstance.userCtrl_getUserByID(account_iduser_id);
