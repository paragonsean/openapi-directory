...
/*
 * OAIUsersHalResponse.h
 *
 * 
 */

#ifndef OAIUsersHalResponse_H
#define OAIUsersHalResponse_H
...
namespace OpenAPI {
class OAIUsersEmbeddedObject;
class OAILinks;

class OAIUsersHalResponse : public OAIObject {
public:
    OAIUsersHalResponse();
    OAIUsersHalResponse(QString json);
    ~OAIUsersHalResponse() override;
    ...
    OAIUsersEmbeddedObject getEmbedded() const;
    void setEmbedded(const OAIUsersEmbeddedObject &_embedded);
...
private:
    ...
    OAIUsersEmbeddedObject m__embedded;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsersHalResponse)

#endif // OAIUsersHalResponse_H
