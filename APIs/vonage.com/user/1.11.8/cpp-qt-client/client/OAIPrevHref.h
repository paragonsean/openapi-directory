...
#ifndef OAIPrevHref_H
#define OAIPrevHref_H
...
class OAIPrevHref : public OAIObject {
public:
    OAIPrevHref();
    OAIPrevHref(QString json);
    ~OAIPrevHref() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrevHref)
