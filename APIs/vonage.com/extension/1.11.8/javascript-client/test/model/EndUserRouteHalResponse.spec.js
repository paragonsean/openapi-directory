...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExtensionApi.EndUserRouteHalResponse();
  });
  ...
  describe('EndUserRouteHalResponse', function() {
    it('should create an instance of EndUserRouteHalResponse', function() {
      // uncomment below and update the code to test EndUserRouteHalResponse
      //var instance = new ExtensionApi.EndUserRouteHalResponse();
      //expect(instance).to.be.a(ExtensionApi.EndUserRouteHalResponse);
    });
