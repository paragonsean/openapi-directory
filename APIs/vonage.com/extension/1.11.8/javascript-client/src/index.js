...
import EndUserRoute from './model/EndUserRoute';
import EndUserRouteEmbeddedObject from './model/EndUserRouteEmbeddedObject';
...
/**
* The Vonage Business Cloud Extension API enables you to retrieve information about extensions.  Your application must subscribe to the Provisioning API suite to use this API. .<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var ExtensionApi = require('index'); // See note below*.
* var xxxSvc = new ExtensionApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new ExtensionApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new ExtensionApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new ExtensionApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
     ...
     * @property {module:model/BasicUser}
     */
    BasicUser,
    ...
    /**
     * The EndUserRoute model constructor.
     * @property {module:model/EndUserRoute}
     */
    EndUserRoute,

    /**
     * The EndUserRouteEmbeddedObject model constructor.
     * @property {module:model/EndUserRouteEmbeddedObject}
     */
    EndUserRouteEmbeddedObject,

    /**
     * The EndUserRouteHalResponse model constructor.
     * @property {module:model/EndUserRouteHalResponse}
     */
