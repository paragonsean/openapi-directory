...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.vonage.com/t/vbc.prod/provisioning') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.vonage.com/t/vbc.prod/provisioning
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.11.8/Javascript'
        };
