...
public class Line {
  public static final String SERIALIZED_NAME_HANDSET_NAME = "handset_name";
  @SerializedName(SERIALIZED_NAME_HANDSET_NAME)
  private String handsetName;

  public static final String SERIALIZED_NAME_SIP_ID = "sip_id";
  @SerializedName(SERIALIZED_NAME_SIP_ID)
  private String sipId;

  public Line() {
  }

  public Line handsetName(String handsetName) {
  ...
  public Line sipId(String sipId) {
    this.sipId = sipId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Line line = (Line) o;
    return Objects.equals(this.handsetName, line.handsetName) &&
        Objects.equals(this.sipId, line.sipId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handsetName, sipId);
  }
  ...
  public String toString() {
    ...
    sb.append("    handsetName: ").append(toIndentedString(handsetName)).append("\n");
  ...
  static {
    ...
    openapiFields.add("handset_name");
    openapiFields.add("sip_id");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("handset_name") != null && !jsonObj.get("handset_name").isJsonNull()) && !jsonObj.get("handset_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `handset_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("handset_name").toString()));
      }
      if ((jsonObj.get("sip_id") != null && !jsonObj.get("sip_id").isJsonNull()) && !jsonObj.get("sip_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sip_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sip_id").toString()));
      }
  }
