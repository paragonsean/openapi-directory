...
/*
 * OAIEndUserRouteHalResponse.h
 *
 * 
 */

#ifndef OAIEndUserRouteHalResponse_H
#define OAIEndUserRouteHalResponse_H
...
namespace OpenAPI {
class OAIEndUserRouteEmbeddedObject;
class OAILinks;

class OAIEndUserRouteHalResponse : public OAIObject {
public:
    OAIEndUserRouteHalResponse();
    OAIEndUserRouteHalResponse(QString json);
    ~OAIEndUserRouteHalResponse() override;
    ...
    OAIEndUserRouteEmbeddedObject getEmbedded() const;
    void setEmbedded(const OAIEndUserRouteEmbeddedObject &_embedded);
...
private:
    ...
    OAIEndUserRouteEmbeddedObject m__embedded;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndUserRouteHalResponse)

#endif // OAIEndUserRouteHalResponse_H
