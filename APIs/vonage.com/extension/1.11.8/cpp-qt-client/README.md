...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::extensionCtrl_getAccountExtensionByIDSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::extensionCtrl_getAccountExtensionByIDSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      double extension_number = create(); // double | The extension number
      apiInstance.extensionCtrl_getAccountExtensionByID(account_idextension_number);
