...
#ifndef OAILastHref_H
#define OAILastHref_H
...
class OAILastHref : public OAIObject {
public:
    OAILastHref();
    OAILastHref(QString json);
    ~OAILastHref() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILastHref)
