...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.vonage.com/t/vbc.prod/reports"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getCallLogs", defaultConf);
    _serverIndices.insert("getCallLogs", 0);
}
...
void OAIDefaultApi::getCallLogs(const QString &account_id, const QString &startgte, const QString &startlte, const double &page_size, const double &page, const ::OpenAPI::OptionalParam<QString> &endgte, const ::OpenAPI::OptionalParam<QString> &endlte, const ::OpenAPI::OptionalParam<QString> &to, const ::OpenAPI::OptionalParam<QString> &from, const ::OpenAPI::OptionalParam<QString> &source_user, const ::OpenAPI::OptionalParam<QString> &destination_user, const ::OpenAPI::OptionalParam<QString> &direction) {
    QString fullPath = QString(_serverConfigs["getCallLogs"][_serverIndices.value("getCallLogs")].URL()+"/accounts/{account_id}/call-logs");
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "start:gte", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("start:gte")).append(querySuffix).append(QUrl::toPercentEncoding(startgte));
    }
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "start:lte", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("start:lte")).append(querySuffix).append(QUrl::toPercentEncoding(startlte));
    }
    if (endgte.hasValue())
    {
        queryStyle = "form";
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "end:gte", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("end:gte")).append(querySuffix).append(QUrl::toPercentEncoding(endgte.stringValue()));
    }
    if (endlte.hasValue())
    {
        queryStyle = "form";
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "end:lte", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("end:lte")).append(querySuffix).append(QUrl::toPercentEncoding(endlte.stringValue()));
    }
    ...
    if (source_user.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "source_user", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("source_user")).append(querySuffix).append(QUrl::toPercentEncoding(source_user.stringValue()));
    }
    if (destination_user.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "destination_user", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("destination_user")).append(querySuffix).append(QUrl::toPercentEncoding(destination_user.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getCallLogsCallback);
...
void OAIDefaultApi::getCallLogsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICallLogsHalResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getCallLogsSignal(output);
        Q_EMIT getCallLogsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getCallLogsSignalE(output, error_type, error_str);
        Q_EMIT getCallLogsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getCallLogsSignalError(output, error_type, error_str);
        Q_EMIT getCallLogsSignalErrorFull(worker, error_type, error_str);
    }
}
