...
#ifndef OAISelfHref_H
#define OAISelfHref_H
...
class OAISelfHref : public OAIObject {
public:
    OAISelfHref();
    OAISelfHref(QString json);
    ~OAISelfHref() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISelfHref)
