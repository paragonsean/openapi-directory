...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CallLogsHalResponse();
  });
  ...
  describe('CallLogsHalResponse', function() {
    it('should create an instance of CallLogsHalResponse', function() {
      // uncomment below and update the code to test CallLogsHalResponse
      //var instance = new ReportsApi.CallLogsHalResponse();
      //expect(instance).to.be.a(ReportsApi.CallLogsHalResponse);
    });
    ...
    it('should have the property totalPage (base name: "total_page")', function() {
