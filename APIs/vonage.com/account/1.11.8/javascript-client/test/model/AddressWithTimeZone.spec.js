...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.AddressWithTimeZone();
  });
  ...
  describe('AddressWithTimeZone', function() {
    it('should create an instance of AddressWithTimeZone', function() {
      // uncomment below and update the code to test AddressWithTimeZone
      //var instance = new AccountApi.AddressWithTimeZone();
      //expect(instance).to.be.a(AccountApi.AddressWithTimeZone);
    });
