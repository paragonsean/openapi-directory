...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.LocationHalResponse();
  });
  ...
  describe('LocationHalResponse', function() {
    it('should create an instance of LocationHalResponse', function() {
      // uncomment below and update the code to test LocationHalResponse
      //var instance = new AccountApi.LocationHalResponse();
      //expect(instance).to.be.a(AccountApi.LocationHalResponse);
    });
