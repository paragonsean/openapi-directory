...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.AccountHalResponse();
  });
  ...
  describe('AccountHalResponse', function() {
    it('should create an instance of AccountHalResponse', function() {
      // uncomment below and update the code to test AccountHalResponse
      //var instance = new AccountApi.AccountHalResponse();
      //expect(instance).to.be.a(AccountApi.AccountHalResponse);
    });
