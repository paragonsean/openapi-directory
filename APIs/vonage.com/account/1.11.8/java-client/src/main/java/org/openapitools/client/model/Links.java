...
public class Links {
  ...
  public Links last(LastHref last) {
    this.last = last;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public LastHref getLast() {
    return last;
  }

  public void setLast(LastHref last) {
    this.last = last;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("last") != null && !jsonObj.get("last").isJsonNull()) {
        LastHref.validateJsonElement(jsonObj.get("last"));
      }
