...
from openapi_server.models.last_href import LastHref
...
class Links(Model):
    ...
    def __init__(self, first: FirstHref=None, last: LastHref=None, next: NextHref=None, prev: PrevHref=None, _self: SelfHref=None):
