...
/*
 * OAILocationsHalResponse.h
 *
 * 
 */

#ifndef OAILocationsHalResponse_H
#define OAILocationsHalResponse_H
...
namespace OpenAPI {
class OAILocationsEmbeddedObject;
class OAILinks;

class OAILocationsHalResponse : public OAIObject {
public:
    OAILocationsHalResponse();
    OAILocationsHalResponse(QString json);
    ~OAILocationsHalResponse() override;
    ...
    OAILocationsEmbeddedObject getEmbedded() const;
    void setEmbedded(const OAILocationsEmbeddedObject &_embedded);
...
private:
    ...
    OAILocationsEmbeddedObject m__embedded;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationsHalResponse)

#endif // OAILocationsHalResponse_H
