...
public:
    ...
    OAIAddressWithTimeZone getAddress() const;
    void setAddress(const OAIAddressWithTimeZone &address);
...
private:
    ...
    OAIAddressWithTimeZone m_address;
