...
/*
 * OAILocationHalResponse.h
 *
 * 
 */

#ifndef OAILocationHalResponse_H
#define OAILocationHalResponse_H
...
namespace OpenAPI {
class OAILocationEmbeddedObject;
class OAILinks;

class OAILocationHalResponse : public OAIObject {
public:
    OAILocationHalResponse();
    OAILocationHalResponse(QString json);
    ~OAILocationHalResponse() override;
    ...
    OAILocationEmbeddedObject getEmbedded() const;
    void setEmbedded(const OAILocationEmbeddedObject &_embedded);
...
private:
    ...
    OAILocationEmbeddedObject m__embedded;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationHalResponse)

#endif // OAILocationHalResponse_H
