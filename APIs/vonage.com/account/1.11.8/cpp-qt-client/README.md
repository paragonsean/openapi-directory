...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::accountCtrl_getAccountServicesByAccountIDSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::accountCtrl_getAccountServicesByAccountIDSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      double account_id = create(); // double | The Vonage Business Cloud account ID
      apiInstance.accountCtrl_getAccountServicesByAccountID(account_id);
