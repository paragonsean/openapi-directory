...
#ifndef OAICallTransfer_H
#define OAICallTransfer_H
...
class OAICallTransfer : public OAIObject {
public:
    OAICallTransfer();
    OAICallTransfer(QString json);
    ~OAICallTransfer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICallTransfer)

#endif // OAICallTransfer_H
