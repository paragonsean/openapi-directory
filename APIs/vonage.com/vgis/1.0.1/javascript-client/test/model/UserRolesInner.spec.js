...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VonageIntegrationSuite.UserRolesInner();
  });
  ...
  describe('UserRolesInner', function() {
    it('should create an instance of UserRolesInner', function() {
      // uncomment below and update the code to test UserRolesInner
      //var instance = new VonageIntegrationSuite.UserRolesInner();
      //expect(instance).to.be.a(VonageIntegrationSuite.UserRolesInner);
    });
