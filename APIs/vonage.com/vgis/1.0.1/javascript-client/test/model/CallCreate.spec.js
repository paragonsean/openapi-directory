...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VonageIntegrationSuite.CallCreate();
  });
  ...
  describe('CallCreate', function() {
    it('should create an instance of CallCreate', function() {
      // uncomment below and update the code to test CallCreate
      //var instance = new VonageIntegrationSuite.CallCreate();
      //expect(instance).to.be.a(VonageIntegrationSuite.CallCreate);
    });
