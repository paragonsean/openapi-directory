...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VonageIntegrationSuite.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new VonageIntegrationSuite.ErrorResponse();
      //expect(instance).to.be.a(VonageIntegrationSuite.ErrorResponse);
    });
