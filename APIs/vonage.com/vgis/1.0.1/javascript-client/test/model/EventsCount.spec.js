...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VonageIntegrationSuite.EventsCount();
  });
  ...
  describe('EventsCount', function() {
    it('should create an instance of EventsCount', function() {
      // uncomment below and update the code to test EventsCount
      //var instance = new VonageIntegrationSuite.EventsCount();
      //expect(instance).to.be.a(VonageIntegrationSuite.EventsCount);
    });
