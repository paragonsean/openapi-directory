...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VonageIntegrationSuite.CallTransfer();
  });
  ...
  describe('CallTransfer', function() {
    it('should create an instance of CallTransfer', function() {
      // uncomment below and update the code to test CallTransfer
      //var instance = new VonageIntegrationSuite.CallTransfer();
      //expect(instance).to.be.a(VonageIntegrationSuite.CallTransfer);
    });
