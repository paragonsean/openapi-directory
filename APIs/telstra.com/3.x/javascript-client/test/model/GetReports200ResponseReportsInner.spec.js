...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagingApiV3X.GetReports200ResponseReportsInner();
  });
  ...
  describe('GetReports200ResponseReportsInner', function() {
    it('should create an instance of GetReports200ResponseReportsInner', function() {
      // uncomment below and update the code to test GetReports200ResponseReportsInner
      //var instance = new MessagingApiV3X.GetReports200ResponseReportsInner();
      //expect(instance).to.be.a(MessagingApiV3X.GetReports200ResponseReportsInner);
    });

    it('should have the property reportExpiry (base name: "reportExpiry")', function() {
      // uncomment below and update the code to test the property reportExpiry
      //var instance = new MessagingApiV3X.GetReports200ResponseReportsInner();
