...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagingApiV3X.Multimedia();
  });
  ...
  describe('Multimedia', function() {
    it('should create an instance of Multimedia', function() {
      // uncomment below and update the code to test Multimedia
      //var instance = new MessagingApiV3X.Multimedia();
      //expect(instance).to.be.a(MessagingApiV3X.Multimedia);
    });
