...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagingApiV3X.CreateTrialNumbersRequest();
  });
  ...
  describe('CreateTrialNumbersRequest', function() {
    it('should create an instance of CreateTrialNumbersRequest', function() {
      // uncomment below and update the code to test CreateTrialNumbersRequest
      //var instance = new MessagingApiV3X.CreateTrialNumbersRequest();
      //expect(instance).to.be.a(MessagingApiV3X.CreateTrialNumbersRequest);
    });
