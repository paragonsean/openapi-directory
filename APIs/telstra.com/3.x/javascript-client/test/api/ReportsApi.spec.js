...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagingApiV3X.ReportsApi();
  });
  ...
  describe('ReportsApi', function() {
    ...
    describe('messagesReport', function() {
      it('should call messagesReport successfully', function(done) {
        //uncomment below and update the code to test messagesReport
        //instance.messagesReport(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
