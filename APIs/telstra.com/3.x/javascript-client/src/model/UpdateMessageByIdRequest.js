...
/**
 * The UpdateMessageByIdRequest model module.
 * @module model/UpdateMessageByIdRequest
 * @version 3.x
 */
class UpdateMessageByIdRequest {
    /**
     * Constructs a new <code>UpdateMessageByIdRequest</code>.
     * @alias module:model/UpdateMessageByIdRequest
     ...
     * @param to {String} This is the mobile number you want to send your message to. Write Australian numbers in national format (e.g. 0412345678) and international numbers (paid plans only) in E.164 format (e.g. +441234567890).  Use a string for a single recipient, and an array of strings for multiple recipients, e.g. \"to\": [\"0412345678\", \"+441234567890\"]. If you're using the Free Trial, you can include up to 5 recipient numbers in the array. If you're using a paid plan, you can bulk send up to 500 messages at once. 
     */
    constructor(from, to) { 
        
        UpdateMessageByIdRequest.initialize(this, from, to);
    }
    ...
    /**
     * Constructs a <code>UpdateMessageByIdRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMessageByIdRequest} obj Optional instance to populate.
     * @return {module:model/UpdateMessageByIdRequest} The populated <code>UpdateMessageByIdRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMessageByIdRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMessageByIdRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMessageByIdRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateMessageByIdRequest.RequiredProperties) {
...
UpdateMessageByIdRequest.RequiredProperties = ["from", "to"];
 ...
 * @default false
 */
UpdateMessageByIdRequest.prototype['deliveryNotification'] = false;
 ...
 * @member {String} from
 */
UpdateMessageByIdRequest.prototype['from'] = undefined;
 ...
 */
UpdateMessageByIdRequest.prototype['messageContent'] = undefined;
 ...
 */
UpdateMessageByIdRequest.prototype['multimedia'] = undefined;
 ...
 * @default 10
 */
UpdateMessageByIdRequest.prototype['retryTimeout'] = 10;
 ...
 */
UpdateMessageByIdRequest.prototype['scheduleSend'] = undefined;
 ...
 */
UpdateMessageByIdRequest.prototype['statusCallbackUrl'] = undefined;
 ...
 */
UpdateMessageByIdRequest.prototype['tags'] = undefined;
 ...
 * @member {String} to
 */
UpdateMessageByIdRequest.prototype['to'] = undefined;
...
export default UpdateMessageByIdRequest;
