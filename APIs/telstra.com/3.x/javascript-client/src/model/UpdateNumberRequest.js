...
/**
 * The UpdateNumberRequest model module.
 * @module model/UpdateNumberRequest
 * @version 3.x
 */
class UpdateNumberRequest {
    /**
     * Constructs a new <code>UpdateNumberRequest</code>.
     * @alias module:model/UpdateNumberRequest
     */
    constructor() { 
        
        UpdateNumberRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateNumberRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNumberRequest} obj Optional instance to populate.
     * @return {module:model/UpdateNumberRequest} The populated <code>UpdateNumberRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNumberRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNumberRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNumberRequest</code>.
     */
 ...
 */
UpdateNumberRequest.prototype['replyCallbackUrl'] = undefined;
 ...
 */
UpdateNumberRequest.prototype['tags'] = undefined;
...
export default UpdateNumberRequest;
