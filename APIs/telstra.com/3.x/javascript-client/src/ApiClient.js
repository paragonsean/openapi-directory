...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://products.api.telstra.com/messaging/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://products.api.telstra.com/messaging/v3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3.x/Javascript'
        };
