# MessagingApiV3X.MessagesReport201Response
...
**reportId** | **String** | When your report is ready for download, you can use this UUID to fetch it with the GET /reports/{reportId} endpoint.  | [optional] 
