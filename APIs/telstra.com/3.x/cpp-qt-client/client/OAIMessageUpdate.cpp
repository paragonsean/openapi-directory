...
OAIMessageUpdate::OAIMessageUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessageUpdate::OAIMessageUpdate() {
    this->initializeModel();
}

OAIMessageUpdate::~OAIMessageUpdate() {}

void OAIMessageUpdate::initializeModel() {
...
void OAIMessageUpdate::fromJson(QString jsonString) {
...
void OAIMessageUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIMessageUpdate::asJson() const {
...
QJsonObject OAIMessageUpdate::asJsonObject() const {
    QJsonObject obj;
...
bool OAIMessageUpdate::isDeliveryNotification() const {
    return m_delivery_notification;
}
void OAIMessageUpdate::setDeliveryNotification(const bool &delivery_notification) {
    m_delivery_notification = delivery_notification;
    m_delivery_notification_isSet = true;
}

bool OAIMessageUpdate::is_delivery_notification_Set() const{
    return m_delivery_notification_isSet;
}

bool OAIMessageUpdate::is_delivery_notification_Valid() const{
    return m_delivery_notification_isValid;
}

QString OAIMessageUpdate::getFrom() const {
    return m_from;
}
void OAIMessageUpdate::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIMessageUpdate::is_from_Set() const{
    return m_from_isSet;
}

bool OAIMessageUpdate::is_from_Valid() const{
    return m_from_isValid;
}

QString OAIMessageUpdate::getMessageContent() const {
    return m_message_content;
}
void OAIMessageUpdate::setMessageContent(const QString &message_content) {
    m_message_content = message_content;
    m_message_content_isSet = true;
}

bool OAIMessageUpdate::is_message_content_Set() const{
    return m_message_content_isSet;
}

bool OAIMessageUpdate::is_message_content_Valid() const{
    return m_message_content_isValid;
}

QString OAIMessageUpdate::getMessageId() const {
    return m_message_id;
}
void OAIMessageUpdate::setMessageId(const QString &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIMessageUpdate::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIMessageUpdate::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QList<OAIMultimediaGet> OAIMessageUpdate::getMultimedia() const {
    return m_multimedia;
}
void OAIMessageUpdate::setMultimedia(const QList<OAIMultimediaGet> &multimedia) {
    m_multimedia = multimedia;
    m_multimedia_isSet = true;
}

bool OAIMessageUpdate::is_multimedia_Set() const{
    return m_multimedia_isSet;
}

bool OAIMessageUpdate::is_multimedia_Valid() const{
    return m_multimedia_isValid;
}

qint32 OAIMessageUpdate::getQueuePriority() const {
    return m_queue_priority;
}
void OAIMessageUpdate::setQueuePriority(const qint32 &queue_priority) {
    m_queue_priority = queue_priority;
    m_queue_priority_isSet = true;
}

bool OAIMessageUpdate::is_queue_priority_Set() const{
    return m_queue_priority_isSet;
}

bool OAIMessageUpdate::is_queue_priority_Valid() const{
    return m_queue_priority_isValid;
}

qint32 OAIMessageUpdate::getRetryTimeout() const {
    return m_retry_timeout;
}
void OAIMessageUpdate::setRetryTimeout(const qint32 &retry_timeout) {
    m_retry_timeout = retry_timeout;
    m_retry_timeout_isSet = true;
}

bool OAIMessageUpdate::is_retry_timeout_Set() const{
    return m_retry_timeout_isSet;
}

bool OAIMessageUpdate::is_retry_timeout_Valid() const{
    return m_retry_timeout_isValid;
}

QDateTime OAIMessageUpdate::getScheduleSend() const {
    return m_schedule_send;
}
void OAIMessageUpdate::setScheduleSend(const QDateTime &schedule_send) {
    m_schedule_send = schedule_send;
    m_schedule_send_isSet = true;
}

bool OAIMessageUpdate::is_schedule_send_Set() const{
    return m_schedule_send_isSet;
}

bool OAIMessageUpdate::is_schedule_send_Valid() const{
    return m_schedule_send_isValid;
}

QString OAIMessageUpdate::getStatus() const {
    return m_status;
}
void OAIMessageUpdate::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMessageUpdate::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMessageUpdate::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIMessageUpdate::getStatusCallbackUrl() const {
    return m_status_callback_url;
}
void OAIMessageUpdate::setStatusCallbackUrl(const QString &status_callback_url) {
    m_status_callback_url = status_callback_url;
    m_status_callback_url_isSet = true;
}

bool OAIMessageUpdate::is_status_callback_url_Set() const{
    return m_status_callback_url_isSet;
}

bool OAIMessageUpdate::is_status_callback_url_Valid() const{
    return m_status_callback_url_isValid;
}

QList<QString> OAIMessageUpdate::getTags() const {
    return m_tags;
}
void OAIMessageUpdate::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIMessageUpdate::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIMessageUpdate::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIMessageUpdate::getTo() const {
    return m_to;
}
void OAIMessageUpdate::setTo(const QString &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAIMessageUpdate::is_to_Set() const{
    return m_to_isSet;
}

bool OAIMessageUpdate::is_to_Valid() const{
    return m_to_isValid;
}

bool OAIMessageUpdate::isSet() const {
...
bool OAIMessageUpdate::isValid() const {
