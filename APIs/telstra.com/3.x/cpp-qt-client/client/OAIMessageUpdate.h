...
#ifndef OAIMessageUpdate_H
#define OAIMessageUpdate_H
...
class OAIMessageUpdate : public OAIObject {
public:
    OAIMessageUpdate();
    OAIMessageUpdate(QString json);
    ~OAIMessageUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageUpdate)

#endif // OAIMessageUpdate_H
