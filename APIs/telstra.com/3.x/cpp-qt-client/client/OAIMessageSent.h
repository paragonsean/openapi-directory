...
#ifndef OAIMessageSent_H
#define OAIMessageSent_H
...
class OAIMessageSent : public OAIObject {
public:
    OAIMessageSent();
    OAIMessageSent(QString json);
    ~OAIMessageSent() override;
    ...
    OAIMessageSent_messageId getMessageId() const;
    void setMessageId(const OAIMessageSent_messageId &message_id);
    ...
    OAIMessageSent_to getTo() const;
    void setTo(const OAIMessageSent_to &to);
...
private:
    ...
    OAIMessageSent_messageId m_message_id;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageSent)

#endif // OAIMessageSent_H
