...
bool OAISendMessages_request::isDeliveryNotification() const {
    return m_delivery_notification;
}
void OAISendMessages_request::setDeliveryNotification(const bool &delivery_notification) {
    m_delivery_notification = delivery_notification;
    m_delivery_notification_isSet = true;
}

bool OAISendMessages_request::is_delivery_notification_Set() const{
    return m_delivery_notification_isSet;
}

bool OAISendMessages_request::is_delivery_notification_Valid() const{
    return m_delivery_notification_isValid;
}

QString OAISendMessages_request::getFrom() const {
    return m_from;
}
void OAISendMessages_request::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAISendMessages_request::is_from_Set() const{
    return m_from_isSet;
}

bool OAISendMessages_request::is_from_Valid() const{
    return m_from_isValid;
}

QString OAISendMessages_request::getMessageContent() const {
    return m_message_content;
}
void OAISendMessages_request::setMessageContent(const QString &message_content) {
    m_message_content = message_content;
    m_message_content_isSet = true;
}

bool OAISendMessages_request::is_message_content_Set() const{
    return m_message_content_isSet;
}

bool OAISendMessages_request::is_message_content_Valid() const{
    return m_message_content_isValid;
}

QList<OAIMultimedia> OAISendMessages_request::getMultimedia() const {
    return m_multimedia;
}
void OAISendMessages_request::setMultimedia(const QList<OAIMultimedia> &multimedia) {
    m_multimedia = multimedia;
    m_multimedia_isSet = true;
}

bool OAISendMessages_request::is_multimedia_Set() const{
    return m_multimedia_isSet;
}

bool OAISendMessages_request::is_multimedia_Valid() const{
    return m_multimedia_isValid;
}

qint32 OAISendMessages_request::getRetryTimeout() const {
    return m_retry_timeout;
}
void OAISendMessages_request::setRetryTimeout(const qint32 &retry_timeout) {
    m_retry_timeout = retry_timeout;
    m_retry_timeout_isSet = true;
}

bool OAISendMessages_request::is_retry_timeout_Set() const{
    return m_retry_timeout_isSet;
}

bool OAISendMessages_request::is_retry_timeout_Valid() const{
    return m_retry_timeout_isValid;
}

QDateTime OAISendMessages_request::getScheduleSend() const {
    return m_schedule_send;
}
void OAISendMessages_request::setScheduleSend(const QDateTime &schedule_send) {
    m_schedule_send = schedule_send;
    m_schedule_send_isSet = true;
}

bool OAISendMessages_request::is_schedule_send_Set() const{
    return m_schedule_send_isSet;
}

bool OAISendMessages_request::is_schedule_send_Valid() const{
    return m_schedule_send_isValid;
}

QString OAISendMessages_request::getStatusCallbackUrl() const {
    return m_status_callback_url;
}
void OAISendMessages_request::setStatusCallbackUrl(const QString &status_callback_url) {
    m_status_callback_url = status_callback_url;
    m_status_callback_url_isSet = true;
}

bool OAISendMessages_request::is_status_callback_url_Set() const{
    return m_status_callback_url_isSet;
}

bool OAISendMessages_request::is_status_callback_url_Valid() const{
    return m_status_callback_url_isValid;
}

QList<QString> OAISendMessages_request::getTags() const {
    return m_tags;
}
void OAISendMessages_request::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAISendMessages_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAISendMessages_request::is_tags_Valid() const{
    return m_tags_isValid;
}

OAISendMessages_request_to OAISendMessages_request::getTo() const {
    return m_to;
}
void OAISendMessages_request::setTo(const OAISendMessages_request_to &to) {
    m_to = to;
    m_to_isSet = true;
}

bool OAISendMessages_request::is_to_Set() const{
    return m_to_isSet;
}

bool OAISendMessages_request::is_to_Valid() const{
    return m_to_isValid;
}
