...
|------------ | ------------- | ------------- | -------------|
|**reportExpiry** | **LocalDate** | The expiry date of your report. After this date, you will be unable to download your report.  |  [optional] |
|**reportId** | **UUID** | Use this UUID to fetch your report with the GET /reports/{reportId} endpoint.  |  [optional] |
