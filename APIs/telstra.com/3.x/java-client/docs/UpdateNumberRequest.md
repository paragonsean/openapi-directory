...
|**tags** | **List&lt;String&gt;** | Create your own tags and use them to fetch, sort and report on your Virtual Numbers through our other endpoints. You can assign up to 10 tags per number.   Note that if you don&#39;t include this field, any pre-existing tags will be wiped.  |  [optional] |
