...
public class ApiClient {
    ...
    private String basePath = "https://products.api.telstra.com/messaging/v3";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://products.api.telstra.com/v2/oauth/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.x/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://products.api.telstra.com/messaging/v3
