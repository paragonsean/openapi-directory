...
public class UpdateNumberRequest {
  ...
  public String toString() {
    ...
    sb.append("class UpdateNumberRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNumberRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNumberRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNumberRequest is not found in the empty JSON string", UpdateNumberRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNumberRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNumberRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNumberRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNumberRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNumberRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNumberRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNumberRequest>() {
           @Override
           public void write(JsonWriter out, UpdateNumberRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNumberRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNumberRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNumberRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateNumberRequest
   */
  public static UpdateNumberRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNumberRequest.class);
  }

  /**
   * Convert an instance of UpdateNumberRequest to an JSON string
   *
   * @return JSON string
   */
