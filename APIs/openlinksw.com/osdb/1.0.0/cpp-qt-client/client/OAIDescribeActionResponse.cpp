...
QString OAIDescribeActionResponse::getApi() const {
    return m_api;
}
void OAIDescribeActionResponse::setApi(const QString &api) {
    m_api = api;
    m_api_isSet = true;
}

bool OAIDescribeActionResponse::is_api_Set() const{
    return m_api_isSet;
}

bool OAIDescribeActionResponse::is_api_Valid() const{
    return m_api_isValid;
}

QString OAIDescribeActionResponse::getMethod() const {
    return m_method;
}
void OAIDescribeActionResponse::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIDescribeActionResponse::is_method_Set() const{
    return m_method_isSet;
}

bool OAIDescribeActionResponse::is_method_Valid() const{
    return m_method_isValid;
}

OAIActionDescription OAIDescribeActionResponse::getResponse() const {
    return m_response;
}
void OAIDescribeActionResponse::setResponse(const OAIActionDescription &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIDescribeActionResponse::is_response_Set() const{
    return m_response_isSet;
}

bool OAIDescribeActionResponse::is_response_Valid() const{
    return m_response_isValid;
}

QString OAIDescribeActionResponse::getStatus() const {
    return m_status;
}
void OAIDescribeActionResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}
