...
QString OAIListServicesResponse::getApi() const {
    return m_api;
}
void OAIListServicesResponse::setApi(const QString &api) {
    m_api = api;
    m_api_isSet = true;
}

bool OAIListServicesResponse::is_api_Set() const{
    return m_api_isSet;
}

bool OAIListServicesResponse::is_api_Valid() const{
    return m_api_isValid;
}

QString OAIListServicesResponse::getMethod() const {
    return m_method;
}
void OAIListServicesResponse::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIListServicesResponse::is_method_Set() const{
    return m_method_isSet;
}

bool OAIListServicesResponse::is_method_Valid() const{
    return m_method_isValid;
}

QList<OAIServiceDescription> OAIListServicesResponse::getResponse() const {
    return m_response;
}
void OAIListServicesResponse::setResponse(const QList<OAIServiceDescription> &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIListServicesResponse::is_response_Set() const{
    return m_response_isSet;
}

bool OAIListServicesResponse::is_response_Valid() const{
    return m_response_isValid;
}

QString OAIListServicesResponse::getStatus() const {
    return m_status;
}
void OAIListServicesResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIListServicesResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIListServicesResponse::is_status_Valid() const{
