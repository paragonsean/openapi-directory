...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsdbRestApiV1.ListServicesResponse();
  });
  ...
  describe('ListServicesResponse', function() {
    it('should create an instance of ListServicesResponse', function() {
      ...
      //var instance = new OsdbRestApiV1.ListServicesResponse();
      //expect(instance).to.be.a(OsdbRestApiV1.ListServicesResponse);
    });
