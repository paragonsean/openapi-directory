...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsdbRestApiV1.DescribeActionResponse();
  });
  ...
  describe('DescribeActionResponse', function() {
    it('should create an instance of DescribeActionResponse', function() {
      ...
      //var instance = new OsdbRestApiV1.DescribeActionResponse();
      //expect(instance).to.be.a(OsdbRestApiV1.DescribeActionResponse);
    });
