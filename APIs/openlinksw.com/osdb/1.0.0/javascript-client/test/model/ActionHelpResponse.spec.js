...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsdbRestApiV1.ActionHelpResponse();
  });
  ...
  describe('ActionHelpResponse', function() {
    it('should create an instance of ActionHelpResponse', function() {
      // uncomment below and update the code to test ActionHelpResponse
      //var instance = new OsdbRestApiV1.ActionHelpResponse();
      //expect(instance).to.be.a(OsdbRestApiV1.ActionHelpResponse);
    });
