...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsdbRestApiV1.ListActionsResponse();
  });
  ...
  describe('ListActionsResponse', function() {
    it('should create an instance of ListActionsResponse', function() {
      ...
      //var instance = new OsdbRestApiV1.ListActionsResponse();
      //expect(instance).to.be.a(OsdbRestApiV1.ListActionsResponse);
    });
