...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsdbRestApiV1.DescribeServiceResponse();
  });
  ...
  describe('DescribeServiceResponse', function() {
    it('should create an instance of DescribeServiceResponse', function() {
      ...
      //var instance = new OsdbRestApiV1.DescribeServiceResponse();
      //expect(instance).to.be.a(OsdbRestApiV1.DescribeServiceResponse);
    });
