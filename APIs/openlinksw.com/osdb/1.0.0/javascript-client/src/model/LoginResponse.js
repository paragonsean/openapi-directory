...
import LoginResponseResponse from './LoginResponseResponse';
...
class LoginResponse {
     ...
     * @param response {module:model/LoginResponseResponse} 
     * @param status {module:model/LoginResponse.StatusEnum} 
     */
    constructor(api, method, response, status) { 
        
        LoginResponse.initialize(this, api, method, response, status);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = LoginResponseResponse.constructFromObject(data['response']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['response']) { // data not null
          LoginResponseResponse.validateJSON(data['response']);
        }
        // ensure the json data is a string
...
LoginResponse.RequiredProperties = ["api", "method", "response", "status"];

/**
 * The path of the REST API method
 * @member {String} api
 */
LoginResponse.prototype['api'] = undefined;

/**
 * The name of the REST API method
 * @member {String} method
 */
LoginResponse.prototype['method'] = undefined;

/**
 * @member {module:model/LoginResponseResponse} response
 */
 ...
 * @default 'success'
 */
LoginResponse.prototype['status'] = 'success';
