...
public:
    ...
    QString getEllStatus() const;
    void setEllStatus(const QString &ell_status);
    bool is_ell_status_Set() const;
    bool is_ell_status_Valid() const;
    ...
    void setGraduationYear(const QString &graduation_year);
    bool is_graduation_year_Set() const;
    bool is_graduation_year_Valid() const;

    QString getHispanicEthnicity() const;
    void setHispanicEthnicity(const QString &hispanic_ethnicity);
    bool is_hispanic_ethnicity_Set() const;
    bool is_hispanic_ethnicity_Valid() const;
    ...
    void setStudentNumber(const QString &student_number);
    bool is_student_number_Set() const;
    bool is_student_number_Valid() const;
...
private:
    ...
    QString m_ell_status;
    bool m_ell_status_isSet;
    bool m_ell_status_isValid;
    ...
    QString m_graduation_year;
    bool m_graduation_year_isSet;
    bool m_graduation_year_isValid;

    QString m_hispanic_ethnicity;
    bool m_hispanic_ethnicity_isSet;
    bool m_hispanic_ethnicity_isValid;
    ...
    bool m_student_number_isSet;
    bool m_student_number_isValid;
};
