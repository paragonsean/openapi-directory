...
public class Credentials {
  public static final String SERIALIZED_NAME_DISTRICT_USERNAME = "district_username";
  @SerializedName(SERIALIZED_NAME_DISTRICT_USERNAME)
  ...
  static {
    ...
    openapiFields.add("district_username");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("district_username") != null && !jsonObj.get("district_username").isJsonNull()) && !jsonObj.get("district_username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `district_username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("district_username").toString()));
      }
  }
