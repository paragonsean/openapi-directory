...
public class LicenseVideo {
  ...
  public LicenseVideo authCookie(Cookie authCookie) {
  ...
  public LicenseVideo editorialAcknowledgement(Boolean editorialAcknowledgement) {
  ...
  public LicenseVideo metadata(Object metadata) {
  ...
  public LicenseVideo price(BigDecimal price) {
    this.price = price;
    return this;
  }
  ...
  public LicenseVideo searchId(String searchId) {
  ...
  @Deprecated
  public LicenseVideo showModal(Boolean showModal) {
  ...
  public LicenseVideo size(SizeEnum size) {
    this.size = size;
    return this;
  }
  ...
  public LicenseVideo subscriptionId(String subscriptionId) {
  ...
  public LicenseVideo videoId(String videoId) {
  ...
  public boolean equals(Object o) {
    ...
    LicenseVideo licenseVideo = (LicenseVideo) o;
    return Objects.equals(this.authCookie, licenseVideo.authCookie) &&
        Objects.equals(this.editorialAcknowledgement, licenseVideo.editorialAcknowledgement) &&
        Objects.equals(this.metadata, licenseVideo.metadata) &&
        Objects.equals(this.price, licenseVideo.price) &&
        Objects.equals(this.searchId, licenseVideo.searchId) &&
        Objects.equals(this.showModal, licenseVideo.showModal) &&
        Objects.equals(this.size, licenseVideo.size) &&
        Objects.equals(this.subscriptionId, licenseVideo.subscriptionId) &&
        Objects.equals(this.videoId, licenseVideo.videoId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authCookie, editorialAcknowledgement, metadata, price, searchId, showModal, size, subscriptionId, videoId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LicenseVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LicenseVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LicenseVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LicenseVideo is not found in the empty JSON string", LicenseVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LicenseVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LicenseVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LicenseVideo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LicenseVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LicenseVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LicenseVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LicenseVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<LicenseVideo>() {
           @Override
           public void write(JsonWriter out, LicenseVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LicenseVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LicenseVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LicenseVideo
   * @throws IOException if the JSON string is invalid with respect to LicenseVideo
   */
  public static LicenseVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LicenseVideo.class);
  }

  /**
   * Convert an instance of LicenseVideo to an JSON string
   *
   * @return JSON string
   */
