...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("customer_accessCode", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.shutterstock.com/v2/oauth/access_token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.1.32/java");
