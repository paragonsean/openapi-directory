...
public class ImageInsights {
  ...
  public ImageInsights labels(List<String> labels) {
    this.labels = labels;
    return this;
  }

  public ImageInsights addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.labels, imageInsights.labels);
  }
