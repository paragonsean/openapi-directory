...
public class Collection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(coverItem, createdTime, id, itemsUpdatedTime, name, shareCode, shareUrl, totalItemCount, updatedTime);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("cover_item") != null && !jsonObj.get("cover_item").isJsonNull()) {
        CollectionItem.validateJsonElement(jsonObj.get("cover_item"));
      }
