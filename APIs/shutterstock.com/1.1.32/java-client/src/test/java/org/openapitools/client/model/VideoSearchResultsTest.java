...
/**
 * Model tests for VideoSearchResults
 */
public class VideoSearchResultsTest {
    private final VideoSearchResults model = new VideoSearchResults();
