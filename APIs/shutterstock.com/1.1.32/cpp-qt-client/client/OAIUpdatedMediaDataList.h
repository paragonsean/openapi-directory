...
/*
 * OAIUpdatedMediaDataList.h
 *
 * List of updated media
 */

#ifndef OAIUpdatedMediaDataList_H
#define OAIUpdatedMediaDataList_H
...
namespace OpenAPI {
class OAIUpdatedMedia;
class OAIError;

class OAIUpdatedMediaDataList : public OAIObject {
public:
    OAIUpdatedMediaDataList();
    OAIUpdatedMediaDataList(QString json);
    ~OAIUpdatedMediaDataList() override;
    ...
    QList<OAIUpdatedMedia> getData() const;
    void setData(const QList<OAIUpdatedMedia> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatedMediaDataList)

#endif // OAIUpdatedMediaDataList_H
