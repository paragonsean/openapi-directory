...
/*
 * OAIRedownloadImage.h
 *
 * Data required to redownload an image
 */

#ifndef OAIRedownloadImage_H
#define OAIRedownloadImage_H
...
class OAIRedownloadImage : public OAIObject {
public:
    OAIRedownloadImage();
    OAIRedownloadImage(QString json);
    ~OAIRedownloadImage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedownloadImage)

#endif // OAIRedownloadImage_H
