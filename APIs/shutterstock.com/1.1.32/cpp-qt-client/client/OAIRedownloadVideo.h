...
/*
 * OAIRedownloadVideo.h
 *
 * Data required to redownload a video
 */

#ifndef OAIRedownloadVideo_H
#define OAIRedownloadVideo_H
...
class OAIRedownloadVideo : public OAIObject {
public:
    OAIRedownloadVideo();
    OAIRedownloadVideo(QString json);
    ~OAIRedownloadVideo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedownloadVideo)

#endif // OAIRedownloadVideo_H
