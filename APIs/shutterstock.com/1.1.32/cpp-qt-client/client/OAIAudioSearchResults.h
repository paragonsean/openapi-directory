...
/*
 * OAIAudioSearchResults.h
 *
 * Audio search results
 */

#ifndef OAIAudioSearchResults_H
#define OAIAudioSearchResults_H
...
class OAIAudioSearchResults : public OAIObject {
public:
    OAIAudioSearchResults();
    OAIAudioSearchResults(QString json);
    ~OAIAudioSearchResults() override;
    ...
    QList<OAIAudio> getData() const;
    void setData(const QList<OAIAudio> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudioSearchResults)

#endif // OAIAudioSearchResults_H
