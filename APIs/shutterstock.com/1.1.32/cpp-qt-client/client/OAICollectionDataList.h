...
/*
 * OAICollectionDataList.h
 *
 * List of collections
 */

#ifndef OAICollectionDataList_H
#define OAICollectionDataList_H
...
class OAICollectionDataList : public OAIObject {
public:
    OAICollectionDataList();
    OAICollectionDataList(QString json);
    ~OAICollectionDataList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionDataList)

#endif // OAICollectionDataList_H
