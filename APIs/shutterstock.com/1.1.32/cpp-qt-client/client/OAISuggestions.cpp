...
QList<QString> OAISuggestions::getData() const {
    return m_data;
}
void OAISuggestions::setData(const QList<QString> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAISuggestions::is_data_Set() const{
    return m_data_isSet;
}

bool OAISuggestions::is_data_Valid() const{
