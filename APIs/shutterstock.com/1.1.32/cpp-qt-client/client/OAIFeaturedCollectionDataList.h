...
/*
 * OAIFeaturedCollectionDataList.h
 *
 * List of featured collections
 */

#ifndef OAIFeaturedCollectionDataList_H
#define OAIFeaturedCollectionDataList_H
...
namespace OpenAPI {
class OAIFeaturedCollection;
class OAIError;

class OAIFeaturedCollectionDataList : public OAIObject {
public:
    OAIFeaturedCollectionDataList();
    OAIFeaturedCollectionDataList(QString json);
    ~OAIFeaturedCollectionDataList() override;
    ...
    QList<OAIFeaturedCollection> getData() const;
    void setData(const QList<OAIFeaturedCollection> &data);
...
private:
    ...
    QList<OAIFeaturedCollection> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeaturedCollectionDataList)

#endif // OAIFeaturedCollectionDataList_H
