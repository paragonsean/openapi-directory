...
/*
 * OAIEditorialContentDataList.h
 *
 * List of editorial items
 */

#ifndef OAIEditorialContentDataList_H
#define OAIEditorialContentDataList_H
...
class OAIEditorialContentDataList : public OAIObject {
public:
    OAIEditorialContentDataList();
    OAIEditorialContentDataList(QString json);
    ~OAIEditorialContentDataList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditorialContentDataList)

#endif // OAIEditorialContentDataList_H
