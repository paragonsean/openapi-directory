...
/*
 * OAIEditorialVideoContent.h
 *
 * Metadata about editorial content
 */

#ifndef OAIEditorialVideoContent_H
#define OAIEditorialVideoContent_H
...
namespace OpenAPI {
class OAIEditorialVideoAssets;
class OAIEditorialCategory;

class OAIEditorialVideoContent : public OAIObject {
public:
    OAIEditorialVideoContent();
    OAIEditorialVideoContent(QString json);
    ~OAIEditorialVideoContent() override;
    ...
    OAIEditorialVideoAssets getAssets() const;
    void setAssets(const OAIEditorialVideoAssets &assets);
...
private:
    ...
    OAIEditorialVideoAssets m_assets;
    bool m_assets_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditorialVideoContent)

#endif // OAIEditorialVideoContent_H
