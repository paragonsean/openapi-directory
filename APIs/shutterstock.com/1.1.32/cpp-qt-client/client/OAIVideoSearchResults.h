...
/*
 * OAIVideoSearchResults.h
 *
 * Video search results
 */

#ifndef OAIVideoSearchResults_H
#define OAIVideoSearchResults_H
...
class OAIVideoSearchResults : public OAIObject {
public:
    OAIVideoSearchResults();
    OAIVideoSearchResults(QString json);
    ~OAIVideoSearchResults() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoSearchResults)

#endif // OAIVideoSearchResults_H
