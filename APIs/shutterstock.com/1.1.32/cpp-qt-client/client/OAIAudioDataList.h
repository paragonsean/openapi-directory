...
#ifndef OAIAudioDataList_H
#define OAIAudioDataList_H
...
class OAIAudioDataList : public OAIObject {
public:
    OAIAudioDataList();
    OAIAudioDataList(QString json);
    ~OAIAudioDataList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudioDataList)

#endif // OAIAudioDataList_H
