...
/*
 * OAILicenseAudioResultDataList.h
 *
 * List of audio license results
 */

#ifndef OAILicenseAudioResultDataList_H
#define OAILicenseAudioResultDataList_H
...
namespace OpenAPI {
class OAILicenseAudioResult;
class OAIError;

class OAILicenseAudioResultDataList : public OAIObject {
public:
    OAILicenseAudioResultDataList();
    OAILicenseAudioResultDataList(QString json);
    ~OAILicenseAudioResultDataList() override;
    ...
    QList<OAILicenseAudioResult> getData() const;
    void setData(const QList<OAILicenseAudioResult> &data);
...
private:
    ...
    QList<OAILicenseAudioResult> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseAudioResultDataList)

#endif // OAILicenseAudioResultDataList_H
