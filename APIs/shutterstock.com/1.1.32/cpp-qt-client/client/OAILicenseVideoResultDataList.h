...
/*
 * OAILicenseVideoResultDataList.h
 *
 * List of video license results
 */

#ifndef OAILicenseVideoResultDataList_H
#define OAILicenseVideoResultDataList_H
...
namespace OpenAPI {
class OAILicenseVideoResult;
class OAIError;

class OAILicenseVideoResultDataList : public OAIObject {
public:
    OAILicenseVideoResultDataList();
    OAILicenseVideoResultDataList(QString json);
    ~OAILicenseVideoResultDataList() override;
    ...
    QList<OAILicenseVideoResult> getData() const;
    void setData(const QList<OAILicenseVideoResult> &data);
...
private:
    ...
    QList<OAILicenseVideoResult> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseVideoResultDataList)

#endif // OAILicenseVideoResultDataList_H
