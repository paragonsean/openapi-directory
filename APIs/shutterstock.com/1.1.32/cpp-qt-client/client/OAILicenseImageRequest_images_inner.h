...
/*
 * OAILicenseImageRequest_images_inner.h
 *
 * 
 */

#ifndef OAILicenseImageRequest_images_inner_H
#define OAILicenseImageRequest_images_inner_H
...
class OAILicenseImageRequest_images_inner : public OAIObject {
public:
    OAILicenseImageRequest_images_inner();
    OAILicenseImageRequest_images_inner(QString json);
    ~OAILicenseImageRequest_images_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseImageRequest_images_inner)

#endif // OAILicenseImageRequest_images_inner_H
