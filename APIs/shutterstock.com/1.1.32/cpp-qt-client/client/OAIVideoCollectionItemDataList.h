...
/*
 * OAIVideoCollectionItemDataList.h
 *
 * List of items in a collection
 */

#ifndef OAIVideoCollectionItemDataList_H
#define OAIVideoCollectionItemDataList_H
...
class OAIVideoCollectionItemDataList : public OAIObject {
public:
    OAIVideoCollectionItemDataList();
    OAIVideoCollectionItemDataList(QString json);
    ~OAIVideoCollectionItemDataList() override;
    ...
    QList<OAICollectionItem> getData() const;
    void setData(const QList<OAICollectionItem> &data);
...
private:
    ...
    QList<OAICollectionItem> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoCollectionItemDataList)

#endif // OAIVideoCollectionItemDataList_H
