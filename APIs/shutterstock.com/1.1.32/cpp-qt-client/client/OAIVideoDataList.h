...
#ifndef OAIVideoDataList_H
#define OAIVideoDataList_H
...
class OAIVideoDataList : public OAIObject {
public:
    OAIVideoDataList();
    OAIVideoDataList(QString json);
    ~OAIVideoDataList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoDataList)

#endif // OAIVideoDataList_H
