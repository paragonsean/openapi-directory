...
/*
 * OAIEditorialImageLivefeedList.h
 *
 * List of editorial livefeeds
 */

#ifndef OAIEditorialImageLivefeedList_H
#define OAIEditorialImageLivefeedList_H
...
namespace OpenAPI {
class OAIEditorialLivefeed;

class OAIEditorialImageLivefeedList : public OAIObject {
public:
    OAIEditorialImageLivefeedList();
    OAIEditorialImageLivefeedList(QString json);
    ~OAIEditorialImageLivefeedList() override;
    ...
    QList<OAIEditorialLivefeed> getData() const;
    void setData(const QList<OAIEditorialLivefeed> &data);
...
private:
    ...
    QList<OAIEditorialLivefeed> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditorialImageLivefeedList)

#endif // OAIEditorialImageLivefeedList_H
