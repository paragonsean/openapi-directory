...
/*
 * OAICollectionItemDataList.h
 *
 * List of items in a collection
 */

#ifndef OAICollectionItemDataList_H
#define OAICollectionItemDataList_H
...
class OAICollectionItemDataList : public OAIObject {
public:
    OAICollectionItemDataList();
    OAICollectionItemDataList(QString json);
    ~OAICollectionItemDataList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionItemDataList)

#endif // OAICollectionItemDataList_H
