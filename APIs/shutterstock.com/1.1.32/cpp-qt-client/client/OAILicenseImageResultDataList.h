...
/*
 * OAILicenseImageResultDataList.h
 *
 * List of information about licensed images
 */

#ifndef OAILicenseImageResultDataList_H
#define OAILicenseImageResultDataList_H
...
namespace OpenAPI {
class OAILicenseImageResult;
class OAIError;

class OAILicenseImageResultDataList : public OAIObject {
public:
    OAILicenseImageResultDataList();
    OAILicenseImageResultDataList(QString json);
    ~OAILicenseImageResultDataList() override;
    ...
    QList<OAILicenseImageResult> getData() const;
    void setData(const QList<OAILicenseImageResult> &data);
...
private:
    ...
    QList<OAILicenseImageResult> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseImageResultDataList)

#endif // OAILicenseImageResultDataList_H
