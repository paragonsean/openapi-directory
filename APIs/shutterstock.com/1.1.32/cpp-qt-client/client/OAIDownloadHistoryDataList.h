...
/*
 * OAIDownloadHistoryDataList.h
 *
 * List of download events
 */

#ifndef OAIDownloadHistoryDataList_H
#define OAIDownloadHistoryDataList_H
...
namespace OpenAPI {
class OAIDownloadHistory;
class OAIError;

class OAIDownloadHistoryDataList : public OAIObject {
public:
    OAIDownloadHistoryDataList();
    OAIDownloadHistoryDataList(QString json);
    ~OAIDownloadHistoryDataList() override;
    ...
    QList<OAIDownloadHistory> getData() const;
    void setData(const QList<OAIDownloadHistory> &data);
...
private:
    ...
    QList<OAIDownloadHistory> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDownloadHistoryDataList)

#endif // OAIDownloadHistoryDataList_H
