...
/*
 * OAIEditorialLivefeedList.h
 *
 * List of editorial livefeeds
 */

#ifndef OAIEditorialLivefeedList_H
#define OAIEditorialLivefeedList_H
...
class OAIEditorialLivefeedList : public OAIObject {
public:
    OAIEditorialLivefeedList();
    OAIEditorialLivefeedList(QString json);
    ~OAIEditorialLivefeedList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditorialLivefeedList)

#endif // OAIEditorialLivefeedList_H
