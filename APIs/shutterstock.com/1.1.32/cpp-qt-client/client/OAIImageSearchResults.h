...
/*
 * OAIImageSearchResults.h
 *
 * Image search results
 */

#ifndef OAIImageSearchResults_H
#define OAIImageSearchResults_H
...
class OAIImageSearchResults : public OAIObject {
public:
    OAIImageSearchResults();
    OAIImageSearchResults(QString json);
    ~OAIImageSearchResults() override;
    ...
    OAIInsights getInsights() const;
    void setInsights(const OAIInsights &insights);
    ...
    OAIObject getSpellcheckInfo() const;
    void setSpellcheckInfo(const OAIObject &spellcheck_info);
    bool is_spellcheck_info_Set() const;
    bool is_spellcheck_info_Valid() const;
...
private:
    ...
    OAIObject m_spellcheck_info;
    bool m_spellcheck_info_isSet;
    bool m_spellcheck_info_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageSearchResults)

#endif // OAIImageSearchResults_H
