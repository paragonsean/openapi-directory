...
/*
 * OAIRecommendationDataList.h
 *
 * List of recommended images
 */

#ifndef OAIRecommendationDataList_H
#define OAIRecommendationDataList_H
...
class OAIRecommendationDataList : public OAIObject {
public:
    OAIRecommendationDataList();
    OAIRecommendationDataList(QString json);
    ~OAIRecommendationDataList() override;
    ...
    QList<OAIRecommendation> getData() const;
    void setData(const QList<OAIRecommendation> &data);
...
private:
    ...
    QList<OAIRecommendation> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecommendationDataList)

#endif // OAIRecommendationDataList_H
