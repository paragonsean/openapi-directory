...
#ifndef OAILicenseImage_H
#define OAILicenseImage_H
...
namespace OpenAPI {
class OAICookie;
class OAICustomSizeDimensions;

class OAILicenseImage : public OAIObject {
public:
    OAILicenseImage();
    OAILicenseImage(QString json);
    ~OAILicenseImage() override;
    ...
    OAICustomSizeDimensions getCustomDimensions() const;
    void setCustomDimensions(const OAICustomSizeDimensions &custom_dimensions);
...
private:
    ...
    OAICustomSizeDimensions m_custom_dimensions;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseImage)

#endif // OAILicenseImage_H
