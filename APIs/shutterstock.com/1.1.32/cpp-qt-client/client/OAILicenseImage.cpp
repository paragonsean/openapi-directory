...
OAILicenseImage::OAILicenseImage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILicenseImage::OAILicenseImage() {
    this->initializeModel();
}

OAILicenseImage::~OAILicenseImage() {}

void OAILicenseImage::initializeModel() {
...
void OAILicenseImage::fromJson(QString jsonString) {
...
void OAILicenseImage::fromJsonObject(QJsonObject json) {
...
QString OAILicenseImage::asJson() const {
...
QJsonObject OAILicenseImage::asJsonObject() const {
    QJsonObject obj;
...
OAICookie OAILicenseImage::getAuthCookie() const {
    return m_auth_cookie;
}
void OAILicenseImage::setAuthCookie(const OAICookie &auth_cookie) {
    m_auth_cookie = auth_cookie;
    m_auth_cookie_isSet = true;
}

bool OAILicenseImage::is_auth_cookie_Set() const{
    return m_auth_cookie_isSet;
}

bool OAILicenseImage::is_auth_cookie_Valid() const{
    return m_auth_cookie_isValid;
}

OAICustomSizeDimensions OAILicenseImage::getCustomDimensions() const {
    return m_custom_dimensions;
}
void OAILicenseImage::setCustomDimensions(const OAICustomSizeDimensions &custom_dimensions) {
    m_custom_dimensions = custom_dimensions;
    m_custom_dimensions_isSet = true;
}

bool OAILicenseImage::is_custom_dimensions_Set() const{
    return m_custom_dimensions_isSet;
}

bool OAILicenseImage::is_custom_dimensions_Valid() const{
    return m_custom_dimensions_isValid;
}

bool OAILicenseImage::isEditorialAcknowledgement() const {
    return m_editorial_acknowledgement;
}
void OAILicenseImage::setEditorialAcknowledgement(const bool &editorial_acknowledgement) {
    m_editorial_acknowledgement = editorial_acknowledgement;
    m_editorial_acknowledgement_isSet = true;
}

bool OAILicenseImage::is_editorial_acknowledgement_Set() const{
    return m_editorial_acknowledgement_isSet;
}

bool OAILicenseImage::is_editorial_acknowledgement_Valid() const{
    return m_editorial_acknowledgement_isValid;
}

QString OAILicenseImage::getFormat() const {
    return m_format;
}
void OAILicenseImage::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAILicenseImage::is_format_Set() const{
    return m_format_isSet;
}

bool OAILicenseImage::is_format_Valid() const{
    return m_format_isValid;
}

QString OAILicenseImage::getImageId() const {
    return m_image_id;
}
void OAILicenseImage::setImageId(const QString &image_id) {
    m_image_id = image_id;
    m_image_id_isSet = true;
}

bool OAILicenseImage::is_image_id_Set() const{
    return m_image_id_isSet;
}

bool OAILicenseImage::is_image_id_Valid() const{
    return m_image_id_isValid;
}

OAIObject OAILicenseImage::getMetadata() const {
    return m_metadata;
}
void OAILicenseImage::setMetadata(const OAIObject &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAILicenseImage::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAILicenseImage::is_metadata_Valid() const{
    return m_metadata_isValid;
}

double OAILicenseImage::getPrice() const {
    return m_price;
}
void OAILicenseImage::setPrice(const double &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAILicenseImage::is_price_Set() const{
    return m_price_isSet;
}

bool OAILicenseImage::is_price_Valid() const{
    return m_price_isValid;
}

QString OAILicenseImage::getSearchId() const {
    return m_search_id;
}
void OAILicenseImage::setSearchId(const QString &search_id) {
    m_search_id = search_id;
    m_search_id_isSet = true;
}

bool OAILicenseImage::is_search_id_Set() const{
    return m_search_id_isSet;
}

bool OAILicenseImage::is_search_id_Valid() const{
    return m_search_id_isValid;
}

bool OAILicenseImage::isShowModal() const {
    return m_show_modal;
}
void OAILicenseImage::setShowModal(const bool &show_modal) {
    m_show_modal = show_modal;
    m_show_modal_isSet = true;
}

bool OAILicenseImage::is_show_modal_Set() const{
    return m_show_modal_isSet;
}

bool OAILicenseImage::is_show_modal_Valid() const{
    return m_show_modal_isValid;
}

QString OAILicenseImage::getSize() const {
    return m_size;
}
void OAILicenseImage::setSize(const QString &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAILicenseImage::is_size_Set() const{
    return m_size_isSet;
}

bool OAILicenseImage::is_size_Valid() const{
    return m_size_isValid;
}

QString OAILicenseImage::getSubscriptionId() const {
    return m_subscription_id;
}
void OAILicenseImage::setSubscriptionId(const QString &subscription_id) {
    m_subscription_id = subscription_id;
    m_subscription_id_isSet = true;
}

bool OAILicenseImage::is_subscription_id_Set() const{
    return m_subscription_id_isSet;
}

bool OAILicenseImage::is_subscription_id_Valid() const{
    return m_subscription_id_isValid;
}

QString OAILicenseImage::getVerificationCode() const {
    return m_verification_code;
}
void OAILicenseImage::setVerificationCode(const QString &verification_code) {
    m_verification_code = verification_code;
    m_verification_code_isSet = true;
}

bool OAILicenseImage::is_verification_code_Set() const{
    return m_verification_code_isSet;
}

bool OAILicenseImage::is_verification_code_Valid() const{
    return m_verification_code_isValid;
}

bool OAILicenseImage::isSet() const {
...
bool OAILicenseImage::isValid() const {
