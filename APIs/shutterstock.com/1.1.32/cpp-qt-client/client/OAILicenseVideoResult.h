...
/*
 * OAILicenseVideoResult.h
 *
 * The response to a licensing request for a video
 */

#ifndef OAILicenseVideoResult_H
#define OAILicenseVideoResult_H
...
class OAILicenseVideoResult : public OAIObject {
public:
    OAILicenseVideoResult();
    OAILicenseVideoResult(QString json);
    ~OAILicenseVideoResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseVideoResult)

#endif // OAILicenseVideoResult_H
