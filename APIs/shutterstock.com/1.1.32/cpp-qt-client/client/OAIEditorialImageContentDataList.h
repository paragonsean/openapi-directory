...
/*
 * OAIEditorialImageContentDataList.h
 *
 * List of editorial items
 */

#ifndef OAIEditorialImageContentDataList_H
#define OAIEditorialImageContentDataList_H
...
class OAIEditorialImageContentDataList : public OAIObject {
public:
    OAIEditorialImageContentDataList();
    OAIEditorialImageContentDataList(QString json);
    ~OAIEditorialImageContentDataList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditorialImageContentDataList)

#endif // OAIEditorialImageContentDataList_H
