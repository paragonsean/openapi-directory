...
#ifndef OAILicenseVideo_H
#define OAILicenseVideo_H
...
class OAILicenseVideo : public OAIObject {
public:
    OAILicenseVideo();
    OAILicenseVideo(QString json);
    ~OAILicenseVideo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseVideo)

#endif // OAILicenseVideo_H
