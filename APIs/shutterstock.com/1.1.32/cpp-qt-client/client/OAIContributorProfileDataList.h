...
/*
 * OAIContributorProfileDataList.h
 *
 * List of contributor profiles
 */

#ifndef OAIContributorProfileDataList_H
#define OAIContributorProfileDataList_H
...
namespace OpenAPI {
class OAIContributorProfile;
class OAIError;

class OAIContributorProfileDataList : public OAIObject {
public:
    OAIContributorProfileDataList();
    OAIContributorProfileDataList(QString json);
    ~OAIContributorProfileDataList() override;
    ...
    QList<OAIContributorProfile> getData() const;
    void setData(const QList<OAIContributorProfile> &data);
...
private:
    ...
    QList<OAIContributorProfile> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContributorProfileDataList)

#endif // OAIContributorProfileDataList_H
