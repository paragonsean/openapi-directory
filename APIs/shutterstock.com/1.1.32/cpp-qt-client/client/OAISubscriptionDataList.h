...
/*
 * OAISubscriptionDataList.h
 *
 * List of subscriptions
 */

#ifndef OAISubscriptionDataList_H
#define OAISubscriptionDataList_H
...
class OAISubscriptionDataList : public OAIObject {
public:
    OAISubscriptionDataList();
    OAISubscriptionDataList(QString json);
    ~OAISubscriptionDataList() override;
    ...
    QList<OAISubscription> getData() const;
    void setData(const QList<OAISubscription> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscriptionDataList)

#endif // OAISubscriptionDataList_H
