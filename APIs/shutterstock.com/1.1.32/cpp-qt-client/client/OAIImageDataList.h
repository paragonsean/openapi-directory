...
#ifndef OAIImageDataList_H
#define OAIImageDataList_H
...
class OAIImageDataList : public OAIObject {
public:
    OAIImageDataList();
    OAIImageDataList(QString json);
    ~OAIImageDataList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageDataList)

#endif // OAIImageDataList_H
