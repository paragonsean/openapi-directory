...
public:
    ...
    */
    virtual void echo(const ::OpenAPI::OptionalParam<QString> &text = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void validate(const qint32 &id, const ::OpenAPI::OptionalParam<QList<QString>> &tag = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QString> &user_agent = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void echoSignal(OAITestEcho summary);
    void validateSignal(OAITestValidate summary);


    void echoSignalFull(OAIHttpRequestWorker *worker, OAITestEcho summary);
    void validateSignalFull(OAIHttpRequestWorker *worker, OAITestValidate summary);

    Q_DECL_DEPRECATED_X("Use echoSignalError() instead")
    void echoSignalE(OAITestEcho summary, QNetworkReply::NetworkError error_type, QString error_str);
    void echoSignalError(OAITestEcho summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use validateSignalError() instead")
    void validateSignalE(OAITestValidate summary, QNetworkReply::NetworkError error_type, QString error_str);
    void validateSignalError(OAITestValidate summary, QNetworkReply::NetworkError error_type, const QString &error_str);
