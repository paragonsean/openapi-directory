...
namespace OpenAPI {
class OAIEditorialVideoContent;
...
public:
    ...
    QList<OAIEditorialVideoContent> getData() const;
    void setData(const QList<OAIEditorialVideoContent> &data);
...
private:
    ...
    QList<OAIEditorialVideoContent> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
