...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.AudioDataList();
  });
  ...
  describe('AudioDataList', function() {
    it('should create an instance of AudioDataList', function() {
      // uncomment below and update the code to test AudioDataList
      //var instance = new ShutterstockApiExplorer.AudioDataList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.AudioDataList);
    });
