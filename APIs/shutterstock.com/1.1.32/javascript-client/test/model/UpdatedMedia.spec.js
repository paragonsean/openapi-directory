...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.UpdatedMedia();
  });
  ...
  describe('UpdatedMedia', function() {
    it('should create an instance of UpdatedMedia', function() {
      // uncomment below and update the code to test UpdatedMedia
      //var instance = new ShutterstockApiExplorer.UpdatedMedia();
      //expect(instance).to.be.a(ShutterstockApiExplorer.UpdatedMedia);
    });
