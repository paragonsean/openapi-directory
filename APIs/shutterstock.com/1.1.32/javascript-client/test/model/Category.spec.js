...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.Category();
  });
  ...
  describe('Category', function() {
    it('should create an instance of Category', function() {
      ...
      //var instance = new ShutterstockApiExplorer.Category();
      //expect(instance).to.be.a(ShutterstockApiExplorer.Category);
    });
