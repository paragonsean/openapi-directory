...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.EditorialLivefeedList();
  });
  ...
  describe('EditorialLivefeedList', function() {
    it('should create an instance of EditorialLivefeedList', function() {
      // uncomment below and update the code to test EditorialLivefeedList
      //var instance = new ShutterstockApiExplorer.EditorialLivefeedList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.EditorialLivefeedList);
    });
