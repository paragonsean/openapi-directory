...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.ImageDataList();
  });
  ...
  describe('ImageDataList', function() {
    it('should create an instance of ImageDataList', function() {
      // uncomment below and update the code to test ImageDataList
      //var instance = new ShutterstockApiExplorer.ImageDataList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.ImageDataList);
    });
