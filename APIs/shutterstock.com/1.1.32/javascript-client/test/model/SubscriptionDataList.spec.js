...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.SubscriptionDataList();
  });
  ...
  describe('SubscriptionDataList', function() {
    it('should create an instance of SubscriptionDataList', function() {
      // uncomment below and update the code to test SubscriptionDataList
      //var instance = new ShutterstockApiExplorer.SubscriptionDataList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.SubscriptionDataList);
    });
