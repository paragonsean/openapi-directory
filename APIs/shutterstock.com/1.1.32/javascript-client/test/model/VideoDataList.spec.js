...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.VideoDataList();
  });
  ...
  describe('VideoDataList', function() {
    it('should create an instance of VideoDataList', function() {
      // uncomment below and update the code to test VideoDataList
      //var instance = new ShutterstockApiExplorer.VideoDataList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.VideoDataList);
    });
