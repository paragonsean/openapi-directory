...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.AudioSearchResults();
  });
  ...
  describe('AudioSearchResults', function() {
    it('should create an instance of AudioSearchResults', function() {
      // uncomment below and update the code to test AudioSearchResults
      //var instance = new ShutterstockApiExplorer.AudioSearchResults();
      //expect(instance).to.be.a(ShutterstockApiExplorer.AudioSearchResults);
    });
