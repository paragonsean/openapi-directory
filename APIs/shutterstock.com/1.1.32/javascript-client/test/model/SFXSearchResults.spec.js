...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.SFXSearchResults();
  });
  ...
  describe('SFXSearchResults', function() {
    it('should create an instance of SFXSearchResults', function() {
      // uncomment below and update the code to test SFXSearchResults
      //var instance = new ShutterstockApiExplorer.SFXSearchResults();
      //expect(instance).to.be.a(ShutterstockApiExplorer.SFXSearchResults);
    });
