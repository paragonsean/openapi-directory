...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.Recommendation();
  });
  ...
  describe('Recommendation', function() {
    it('should create an instance of Recommendation', function() {
      ...
      //var instance = new ShutterstockApiExplorer.Recommendation();
      //expect(instance).to.be.a(ShutterstockApiExplorer.Recommendation);
    });
