...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.CategoryDataList();
  });
  ...
  describe('CategoryDataList', function() {
    it('should create an instance of CategoryDataList', function() {
      // uncomment below and update the code to test CategoryDataList
      //var instance = new ShutterstockApiExplorer.CategoryDataList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.CategoryDataList);
    });
