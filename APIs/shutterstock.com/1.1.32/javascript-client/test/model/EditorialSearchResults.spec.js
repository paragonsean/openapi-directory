...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.EditorialSearchResults();
  });
  ...
  describe('EditorialSearchResults', function() {
    it('should create an instance of EditorialSearchResults', function() {
      // uncomment below and update the code to test EditorialSearchResults
      //var instance = new ShutterstockApiExplorer.EditorialSearchResults();
      //expect(instance).to.be.a(ShutterstockApiExplorer.EditorialSearchResults);
    });
