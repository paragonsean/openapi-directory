...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.Contributor();
  });
  ...
  describe('Contributor', function() {
    it('should create an instance of Contributor', function() {
      ...
      //var instance = new ShutterstockApiExplorer.Contributor();
      //expect(instance).to.be.a(ShutterstockApiExplorer.Contributor);
    });
