...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.UpdatedMediaDataList();
  });
  ...
  describe('UpdatedMediaDataList', function() {
    it('should create an instance of UpdatedMediaDataList', function() {
      // uncomment below and update the code to test UpdatedMediaDataList
      //var instance = new ShutterstockApiExplorer.UpdatedMediaDataList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.UpdatedMediaDataList);
    });
