...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.ImageSearchResults();
  });
  ...
  describe('ImageSearchResults', function() {
    it('should create an instance of ImageSearchResults', function() {
      // uncomment below and update the code to test ImageSearchResults
      //var instance = new ShutterstockApiExplorer.ImageSearchResults();
      //expect(instance).to.be.a(ShutterstockApiExplorer.ImageSearchResults);
    });
    ...
    it('should have the property spellcheckInfo (base name: "spellcheck_info")', function() {
      // uncomment below and update the code to test the property spellcheckInfo
      //var instance = new ShutterstockApiExplorer.ImageSearchResults();
      //expect(instance).to.be();
    });
