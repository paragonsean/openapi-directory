...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.CreateAudioRender();
  });
  ...
  describe('CreateAudioRender', function() {
    it('should create an instance of CreateAudioRender', function() {
      // uncomment below and update the code to test CreateAudioRender
      //var instance = new ShutterstockApiExplorer.CreateAudioRender();
      //expect(instance).to.be.a(ShutterstockApiExplorer.CreateAudioRender);
    });
