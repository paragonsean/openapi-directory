...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.LicenseAudio();
  });
  ...
  describe('LicenseAudio', function() {
    it('should create an instance of LicenseAudio', function() {
      // uncomment below and update the code to test LicenseAudio
      //var instance = new ShutterstockApiExplorer.LicenseAudio();
      //expect(instance).to.be.a(ShutterstockApiExplorer.LicenseAudio);
    });
