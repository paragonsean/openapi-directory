...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.CollectionDataList();
  });
  ...
  describe('CollectionDataList', function() {
    it('should create an instance of CollectionDataList', function() {
      // uncomment below and update the code to test CollectionDataList
      //var instance = new ShutterstockApiExplorer.CollectionDataList();
      //expect(instance).to.be.a(ShutterstockApiExplorer.CollectionDataList);
    });
