...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShutterstockApiExplorer.VideoSearchResults();
  });
  ...
  describe('VideoSearchResults', function() {
    it('should create an instance of VideoSearchResults', function() {
      // uncomment below and update the code to test VideoSearchResults
      //var instance = new ShutterstockApiExplorer.VideoSearchResults();
      //expect(instance).to.be.a(ShutterstockApiExplorer.VideoSearchResults);
    });
