...
class CollectionUpdateRequest {
    ...
    constructor(name) { 
        ...
        CollectionUpdateRequest.initialize(this, name);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CollectionUpdateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CollectionUpdateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CollectionUpdateRequest.RequiredProperties) {
...
CollectionUpdateRequest.RequiredProperties = ["name"];

/**
 * The new name of the collection
 * @member {String} name
 */
CollectionUpdateRequest.prototype['name'] = undefined;
