...
class LicenseVideoResultDataList {
    ...
    constructor() { 
        ...
        LicenseVideoResultDataList.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LicenseVideoResultDataList();
    ...
    /**
     * Validates the JSON data with respect to <code>LicenseVideoResultDataList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LicenseVideoResultDataList</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                LicenseVideoResult.validateJSON(item);
            };
        }
 ...
 */
LicenseVideoResultDataList.prototype['data'] = undefined;

/**
 * Error list; appears only if there was an error
 * @member {Array.<module:model/Error>} errors
 */
LicenseVideoResultDataList.prototype['errors'] = undefined;

/**
 * Server-generated message, if any
 * @member {String} message
 */
LicenseVideoResultDataList.prototype['message'] = undefined;

/**
 * Current page that is returned
 * @member {Number} page
 */
LicenseVideoResultDataList.prototype['page'] = undefined;

/**
 * Number of results per page
 * @member {Number} per_page
 */
LicenseVideoResultDataList.prototype['per_page'] = undefined;

/**
 * Total count of all results across all pages
 * @member {Number} total_count
 */
LicenseVideoResultDataList.prototype['total_count'] = undefined;
...
export default LicenseVideoResultDataList;
