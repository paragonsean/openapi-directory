...
class CollectionItemDataList {
    ...
    constructor() { 
        ...
        CollectionItemDataList.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CollectionItemDataList();
    ...
    /**
     * Validates the JSON data with respect to <code>CollectionItemDataList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CollectionItemDataList</code>.
     */
 ...
 */
CollectionItemDataList.prototype['data'] = undefined;

/**
 * Error list; appears only if there was an error
 * @member {Array.<module:model/Error>} errors
 */
CollectionItemDataList.prototype['errors'] = undefined;

/**
 * Server-generated message, if any
 * @member {String} message
 */
CollectionItemDataList.prototype['message'] = undefined;

/**
 * The current page of results
 * @member {Number} page
 */
CollectionItemDataList.prototype['page'] = undefined;

/**
 * The number of results per page
 * @member {Number} per_page
 */
CollectionItemDataList.prototype['per_page'] = undefined;

/**
 * The total number of results across all pages
 * @member {Number} total_count
 */
CollectionItemDataList.prototype['total_count'] = undefined;
...
export default CollectionItemDataList;
