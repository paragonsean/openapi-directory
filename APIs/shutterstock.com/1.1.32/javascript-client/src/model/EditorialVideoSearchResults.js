...
class EditorialVideoSearchResults {
    ...
    constructor(data, totalCount) { 
        ...
        EditorialVideoSearchResults.initialize(this, data, totalCount);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of EditorialVideoSearchResults.RequiredProperties) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                EditorialVideoContent.validateJSON(item);
            };
        }
...
EditorialVideoSearchResults.RequiredProperties = ["data", "total_count"];

/**
 * Editorial items
 * @member {Array.<module:model/EditorialVideoContent>} data
 */
EditorialVideoSearchResults.prototype['data'] = undefined;

/**
 * Optional error message
 * @member {String} message
 */
EditorialVideoSearchResults.prototype['message'] = undefined;

/**
 * Cursor value that represents the next page of results
 * @member {String} next
 */
EditorialVideoSearchResults.prototype['next'] = undefined;

/**
 * Current page of the response
 * @member {Number} page
 */
EditorialVideoSearchResults.prototype['page'] = undefined;

/**
 * Number of results per page
 * @member {Number} per_page
 */
EditorialVideoSearchResults.prototype['per_page'] = undefined;

/**
 * Cursor value that represents the previous page of results
 * @member {String} prev
 */
EditorialVideoSearchResults.prototype['prev'] = undefined;

/**
 * Unique identifier for the search request
 * @member {String} search_id
 */
EditorialVideoSearchResults.prototype['search_id'] = undefined;

/**
 * Total count of all results
 * @member {Number} total_count
 */
EditorialVideoSearchResults.prototype['total_count'] = undefined;
