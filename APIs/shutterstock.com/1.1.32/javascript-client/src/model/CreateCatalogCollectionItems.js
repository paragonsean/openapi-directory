...
class CreateCatalogCollectionItems {
    ...
    constructor(items) { 
        ...
        CreateCatalogCollectionItems.initialize(this, items);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCatalogCollectionItems();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCatalogCollectionItems</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCatalogCollectionItems</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCatalogCollectionItems.RequiredProperties) {
...
CreateCatalogCollectionItems.RequiredProperties = ["items"];

/**
 * @member {Array.<module:model/CreateCatalogCollectionItem>} items
 */
CreateCatalogCollectionItems.prototype['items'] = undefined;
...
export default CreateCatalogCollectionItems;
