...
class CollectionCreateResponse {
    ...
    constructor(id) { 
        ...
        CollectionCreateResponse.initialize(this, id);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CollectionCreateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CollectionCreateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CollectionCreateResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CollectionCreateResponse.RequiredProperties) {
...
CollectionCreateResponse.RequiredProperties = ["id"];

/**
 * ID of the new collection
 * @member {String} id
 */
CollectionCreateResponse.prototype['id'] = undefined;
...
export default CollectionCreateResponse;
