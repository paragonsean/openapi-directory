...
class EditorialLivefeed(Model):
    ...
    def __init__(self, cover_item: EditorialCoverItem=None, created_time: datetime=None, id: str=None, name: str=None, total_item_count: int=None):
        """EditorialLivefeed - a model defined in OpenAPI

        :param cover_item: The cover_item of this EditorialLivefeed.
        :param created_time: The created_time of this EditorialLivefeed.
        :param id: The id of this EditorialLivefeed.
        :param name: The name of this EditorialLivefeed.
        :param total_item_count: The total_item_count of this EditorialLivefeed.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EditorialLivefeed':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EditorialLivefeed of this EditorialLivefeed.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def cover_item(self):
        """Gets the cover_item of this EditorialLivefeed.


        :return: The cover_item of this EditorialLivefeed.
    ...
    def created_time(self):
        """Gets the created_time of this EditorialLivefeed.

        When the livefeed was initially created

        :return: The created_time of this EditorialLivefeed.
        :rtype: datetime
        """
    ...
    @property
    def id(self):
        """Gets the id of this EditorialLivefeed.

        Livefeed ID

        :return: The id of this EditorialLivefeed.
        :rtype: str
        """
        return self._id
    ...
    @property
    def name(self):
        """Gets the name of this EditorialLivefeed.

        Name of the livefeed

        :return: The name of this EditorialLivefeed.
        :rtype: str
        """
        return self._name
    ...
    def total_item_count(self):
        """Gets the total_item_count of this EditorialLivefeed.

        Total count of items in the livefeed

        :return: The total_item_count of this EditorialLivefeed.
        :rtype: int
        """
