...
(function(root, factory) {
  ...
  describe('AuthenticationApiControllerApi', function() {
    ...
    describe('setForgotPassword', function() {
      it('should call setForgotPassword successfully', function(done) {
        //uncomment below and update the code to test setForgotPassword
        //instance.setForgotPassword(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('validateMailToken', function() {
      it('should call validateMailToken successfully', function(done) {
        //uncomment below and update the code to test validateMailToken
        //instance.validateMailToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
