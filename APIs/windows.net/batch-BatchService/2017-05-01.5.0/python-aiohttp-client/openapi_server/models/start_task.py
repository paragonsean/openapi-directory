...
class StartTask(Model):
    ...
    def __init__(self, command_line: str=None, environment_settings: List[EnvironmentSetting]=None, max_task_retry_count: int=None, resource_files: List[ResourceFile]=None, user_identity: UserIdentity=None, wait_for_success: bool=None):
