...
class JobPreparationTaskExecutionInformation(Model):
    ...
    def __init__(self, end_time: datetime=None, exit_code: int=None, failure_info: TaskFailureInformation=None, last_retry_time: datetime=None, result: TaskExecutionResult=None, retry_count: int=None, start_time: datetime=None, state: str=None, task_root_directory: str=None, task_root_directory_url: str=None):
