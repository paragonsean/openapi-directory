...
public class CloudTask {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinityInfo, applicationPackageReferences, authenticationTokenSettings, commandLine, constraints, creationTime, dependsOn, displayName, eTag, environmentSettings, executionInfo, exitConditions, id, lastModified, multiInstanceSettings, nodeInfo, outputFiles, previousState, previousStateTransitionTime, resourceFiles, state, stateTransitionTime, stats, url, userIdentity);
  }
