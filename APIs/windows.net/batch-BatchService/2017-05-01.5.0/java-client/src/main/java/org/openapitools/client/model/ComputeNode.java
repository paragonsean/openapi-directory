...
public class ComputeNode {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinityId, allocationTime, certificateReferences, errors, id, ipAddress, isDedicated, lastBootTime, recentTasks, runningTasksCount, schedulingState, startTask, startTaskInfo, state, stateTransitionTime, totalTasksRun, totalTasksSucceeded, url, vmSize);
  }
