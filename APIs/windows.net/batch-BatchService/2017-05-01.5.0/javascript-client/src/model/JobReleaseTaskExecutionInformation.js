...
class JobReleaseTaskExecutionInformation {
     ...
     * @param state {module:model/JobReleaseTaskExecutionInformation.StateEnum} running - the task is currently running (including retrying). completed - the task has exited, or the Batch service was unable to start the task due to scheduling errors.
     */
