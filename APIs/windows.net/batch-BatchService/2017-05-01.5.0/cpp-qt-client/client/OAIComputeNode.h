...
public:
    ...
    bool isIsDedicated() const;
    void setIsDedicated(const bool &is_dedicated);
    bool is_is_dedicated_Set() const;
    bool is_is_dedicated_Valid() const;
    ...
    qint32 getTotalTasksSucceeded() const;
    void setTotalTasksSucceeded(const qint32 &total_tasks_succeeded);
    bool is_total_tasks_succeeded_Set() const;
    bool is_total_tasks_succeeded_Valid() const;
...
private:
    ...
    bool m_is_dedicated;
    bool m_is_dedicated_isSet;
    bool m_is_dedicated_isValid;
    ...
    qint32 m_total_tasks_succeeded;
    bool m_total_tasks_succeeded_isSet;
    bool m_total_tasks_succeeded_isValid;
