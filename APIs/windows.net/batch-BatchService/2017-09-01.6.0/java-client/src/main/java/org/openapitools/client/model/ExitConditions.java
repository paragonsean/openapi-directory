...
public class ExitConditions {
  ...
  public static final String SERIALIZED_NAME_FILE_UPLOAD_ERROR = "fileUploadError";
  @SerializedName(SERIALIZED_NAME_FILE_UPLOAD_ERROR)
  private ExitOptions fileUploadError;

  public static final String SERIALIZED_NAME_PRE_PROCESSING_ERROR = "preProcessingError";
  @SerializedName(SERIALIZED_NAME_PRE_PROCESSING_ERROR)
  ...
  public ExitConditions fileUploadError(ExitOptions fileUploadError) {
  ...
  public void setFileUploadError(ExitOptions fileUploadError) {
    this.fileUploadError = fileUploadError;
  }


  public ExitConditions preProcessingError(ExitOptions preProcessingError) {
    this.preProcessingError = preProcessingError;
    return this;
  }

  /**
   * Get preProcessingError
  ...
  public void setPreProcessingError(ExitOptions preProcessingError) {
    this.preProcessingError = preProcessingError;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._default, exitConditions._default) &&
        ...
        Objects.equals(this.fileUploadError, exitConditions.fileUploadError) &&
        Objects.equals(this.preProcessingError, exitConditions.preProcessingError);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_default, exitCodeRanges, exitCodes, fileUploadError, preProcessingError);
  }
  ...
  public String toString() {
    ...
    sb.append("    fileUploadError: ").append(toIndentedString(fileUploadError)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fileUploadError");
    openapiFields.add("preProcessingError");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("fileUploadError") != null && !jsonObj.get("fileUploadError").isJsonNull()) {
        ExitOptions.validateJsonElement(jsonObj.get("fileUploadError"));
      }
      // validate the optional field `preProcessingError`
      if (jsonObj.get("preProcessingError") != null && !jsonObj.get("preProcessingError").isJsonNull()) {
        ExitOptions.validateJsonElement(jsonObj.get("preProcessingError"));
      }
  }
