...
QString OAITaskCounts::getValidationStatus() const {
    return m_validation_status;
}
void OAITaskCounts::setValidationStatus(const QString &validation_status) {
    m_validation_status = validation_status;
    m_validation_status_isSet = true;
}

bool OAITaskCounts::is_validation_status_Set() const{
    return m_validation_status_isSet;
}

bool OAITaskCounts::is_validation_status_Valid() const{
...
bool OAITaskCounts::isValid() const {
    ...
    return m_active_isValid && m_completed_isValid && m_failed_isValid && m_running_isValid && m_succeeded_isValid && m_validation_status_isValid && true;
}
