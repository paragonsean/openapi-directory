...
QList<OAIApplicationPackageReference> OAICloudTask::getApplicationPackageReferences() const {
    return m_application_package_references;
}
void OAICloudTask::setApplicationPackageReferences(const QList<OAIApplicationPackageReference> &application_package_references) {
    m_application_package_references = application_package_references;
    m_application_package_references_isSet = true;
}

bool OAICloudTask::is_application_package_references_Set() const{
    return m_application_package_references_isSet;
}

bool OAICloudTask::is_application_package_references_Valid() const{
    return m_application_package_references_isValid;
}

OAIAuthenticationTokenSettings OAICloudTask::getAuthenticationTokenSettings() const {
    return m_authentication_token_settings;
}
void OAICloudTask::setAuthenticationTokenSettings(const OAIAuthenticationTokenSettings &authentication_token_settings) {
    m_authentication_token_settings = authentication_token_settings;
    m_authentication_token_settings_isSet = true;
}

bool OAICloudTask::is_authentication_token_settings_Set() const{
    return m_authentication_token_settings_isSet;
}

bool OAICloudTask::is_authentication_token_settings_Valid() const{
...
OAITaskContainerSettings OAICloudTask::getContainerSettings() const {
    return m_container_settings;
}
void OAICloudTask::setContainerSettings(const OAITaskContainerSettings &container_settings) {
    m_container_settings = container_settings;
    m_container_settings_isSet = true;
}

bool OAICloudTask::is_container_settings_Set() const{
    return m_container_settings_isSet;
}

bool OAICloudTask::is_container_settings_Valid() const{
...
OAIExitConditions OAICloudTask::getExitConditions() const {
    return m_exit_conditions;
}
void OAICloudTask::setExitConditions(const OAIExitConditions &exit_conditions) {
    m_exit_conditions = exit_conditions;
    m_exit_conditions_isSet = true;
}

bool OAICloudTask::is_exit_conditions_Set() const{
    return m_exit_conditions_isSet;
}

bool OAICloudTask::is_exit_conditions_Valid() const{
...
QList<OAIOutputFile> OAICloudTask::getOutputFiles() const {
    return m_output_files;
}
void OAICloudTask::setOutputFiles(const QList<OAIOutputFile> &output_files) {
    m_output_files = output_files;
    m_output_files_isSet = true;
}

bool OAICloudTask::is_output_files_Set() const{
    return m_output_files_isSet;
}

bool OAICloudTask::is_output_files_Valid() const{
    return m_output_files_isValid;
}

OAITaskState OAICloudTask::getPreviousState() const {
    return m_previous_state;
}
void OAICloudTask::setPreviousState(const OAITaskState &previous_state) {
...
OAITaskState OAICloudTask::getState() const {
    return m_state;
}
void OAICloudTask::setState(const OAITaskState &state) {
    m_state = state;
    m_state_isSet = true;
}
...
OAIUserIdentity OAICloudTask::getUserIdentity() const {
    return m_user_identity;
}
void OAICloudTask::setUserIdentity(const OAIUserIdentity &user_identity) {
    m_user_identity = user_identity;
    m_user_identity_isSet = true;
}

bool OAICloudTask::is_user_identity_Set() const{
    return m_user_identity_isSet;
}

bool OAICloudTask::is_user_identity_Valid() const{
