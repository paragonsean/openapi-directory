...
public:
    ...
    OAIJobScheduleState getPreviousState() const;
    void setPreviousState(const OAIJobScheduleState &previous_state);
    ...
    OAIJobScheduleState getState() const;
    void setState(const OAIJobScheduleState &state);
...
private:
    ...
    OAIJobScheduleState m_previous_state;
