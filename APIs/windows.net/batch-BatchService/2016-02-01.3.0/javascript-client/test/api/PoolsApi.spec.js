...
(function(root, factory) {
  ...
  describe('PoolsApi', function() {
    ...
    describe('poolGetAllPoolsLifetimeStatistics', function() {
      it('should call poolGetAllPoolsLifetimeStatistics successfully', function(done) {
        //uncomment below and update the code to test poolGetAllPoolsLifetimeStatistics
        //instance.poolGetAllPoolsLifetimeStatistics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('poolListPoolUsageMetrics', function() {
      it('should call poolListPoolUsageMetrics successfully', function(done) {
        //uncomment below and update the code to test poolListPoolUsageMetrics
        //instance.poolListPoolUsageMetrics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
