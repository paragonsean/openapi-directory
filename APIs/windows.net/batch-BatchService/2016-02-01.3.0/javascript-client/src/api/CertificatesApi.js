...
export default class CertificatesApi {
    ...
    */
     ...
     * @param {module:model/CertificateAddParameter} certificateAddParameter The certificate to be added.
     ...
     */
    certificateAdd(apiVersion, certificateAddParameter, opts, callback) {
      opts = opts || {};
      let postBody = certificateAddParameter;
      ...
      if (certificateAddParameter === undefined || certificateAddParameter === null) {
        throw new Error("Missing the required parameter 'certificateAddParameter' when calling certificateAdd");
      }
