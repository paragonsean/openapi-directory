...
export default class ComputeNodesApi {
    ...
    */
     ...
     * @param {module:model/ComputeNodeUser} computeNodeUser The user account to be created.
     ...
     */
    computeNodeAddUser(poolId, nodeId, apiVersion, computeNodeUser, opts, callback) {
      opts = opts || {};
      let postBody = computeNodeUser;
      ...
      // verify the required parameter 'computeNodeUser' is set
      if (computeNodeUser === undefined || computeNodeUser === null) {
        throw new Error("Missing the required parameter 'computeNodeUser' when calling computeNodeAddUser");
      }
     ...
     * @param {String} poolId The id of the pool that contains the compute node.
     * @param {String} nodeId The id of the compute node that you want to disable task scheduling.
     * @param {String} apiVersion Client API Version.
     * @param {Object} opts Optional parameters
     * @param {Number} [timeout = 30)] The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds.
     * @param {String} [clientRequestId] The caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.
