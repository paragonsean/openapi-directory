...
export default class TasksApi {
    ...
    */
     ...
     * @param {module:model/TaskAddParameter} taskAddParameter The task to be added.
     ...
     * @param {String} apiVersion Client API Version.
     * @param {module:model/TaskAddCollectionParameter} taskAddCollectionParameter The tasks to be added.
     * @param {Object} opts Optional parameters
     * @param {Number} [timeout = 30)] The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds.
     * @param {String} [clientRequestId] The caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.
     * @param {Boolean} [returnClientRequestId] Whether the server should return the client-request-id identifier in the response.
     ...
     */
    taskAddCollection(jobId, apiVersion, taskAddCollectionParameter, opts, callback) {
      opts = opts || {};
      let postBody = taskAddCollectionParameter;
      // verify the required parameter 'jobId' is set
      if (jobId === undefined || jobId === null) {
      ...
      if (taskAddCollectionParameter === undefined || taskAddCollectionParameter === null) {
        throw new Error("Missing the required parameter 'taskAddCollectionParameter' when calling taskAddCollection");
      }
