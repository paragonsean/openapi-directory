...
class TaskExecutionInformation {
     ...
     * @param requeueCount {Number} The number of times the task has been requeued by the Batch service as the result of a user request.
     * @param retryCount {Number} The number of times the task has been retried by the Batch service.
     */
