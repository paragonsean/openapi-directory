...
class StartTaskInformation {
     ...
     * @param startTime {Date} The time at which the start task started running.
     * @param state {module:model/StartTaskInformation.StateEnum} The state of the start task on the compute node.
     */
