...
class TaskStatistics {
     ...
     * @param kernelCPUTime {String} The total kernel mode CPU time (summed across all cores and all compute nodes) consumed by the task.
     ...
     * @param readIOGiB {Number} The total gibibytes read from disk by the task.
     * @param readIOps {Number} The total number of disk read operations made by the task.
     ...
     * @param userCPUTime {String} The total user mode CPU time (summed across all cores and all compute nodes) consumed by the task.
     * @param waitTime {String} The total wait time of the task. The wait time for a task is defined as the elapsed time between the creation of the task and the start of task execution. (If the task is retried due to failures, the wait time is the time to the most recent task execution.)
     * @param wallClockTime {String} The total wall clock time of the task.
     * @param writeIOGiB {Number} The total gibibytes written to disk by the task.
     * @param writeIOps {Number} The total number of disk write operations made by the task.
     */
