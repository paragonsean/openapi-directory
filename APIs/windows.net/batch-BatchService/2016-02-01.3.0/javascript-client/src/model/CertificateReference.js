...
class CertificateReference {
     ...
     * @param thumbprint {String} The thumbprint of the certificate.
     * @param thumbprintAlgorithm {String} The algorithm with which the thumbprint is associated. This must be sha1.
     */
