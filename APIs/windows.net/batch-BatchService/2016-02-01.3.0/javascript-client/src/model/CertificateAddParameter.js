...
class CertificateAddParameter {
     ...
     * @param data {String} The base64-encoded contents of the certificate. The maximum size is 10KB.
     * @param thumbprint {String} The X.509 thumbprint of the certificate. This is a sequence of up to 40 hex digits (it may include spaces but these are removed).
     * @param thumbprintAlgorithm {String} The algorithm used to derive the thumbprint. This must be sha1.
     */
