...
bool OAIJobManagerTask::isRunElevated() const {
    return m_run_elevated;
}
void OAIJobManagerTask::setRunElevated(const bool &run_elevated) {
    m_run_elevated = run_elevated;
    m_run_elevated_isSet = true;
}

bool OAIJobManagerTask::is_run_elevated_Set() const{
    return m_run_elevated_isSet;
}

bool OAIJobManagerTask::is_run_elevated_Valid() const{
