...
bool OAIStartTask::isRunElevated() const {
    return m_run_elevated;
}
void OAIStartTask::setRunElevated(const bool &run_elevated) {
    m_run_elevated = run_elevated;
    m_run_elevated_isSet = true;
}

bool OAIStartTask::is_run_elevated_Set() const{
    return m_run_elevated_isSet;
}

bool OAIStartTask::is_run_elevated_Valid() const{
