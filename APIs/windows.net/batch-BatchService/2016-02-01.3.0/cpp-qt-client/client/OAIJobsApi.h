...
public:
    ...
    * @param[in]  oai_job_add_parameter OAIJobAddParameter [required]
    ...
    * @param[in]  job_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  oai_job_disable_parameter OAIJobDisableParameter [required]
    * @param[in]  timeout qint32 [optional]
    * @param[in]  client_request_id QString [optional]
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
    ...
    * @param[in]  if_unmodified_since QString [optional]
    */
    virtual void jobDisable(const QString &job_id, const QString &api_version, const OAIJobDisableParameter &oai_job_disable_parameter, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_none_match = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_modified_since = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_unmodified_since = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  ocp_date QString [optional]
    */
    virtual void jobGetAllJobsLifetimeStatistics(const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  job_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  oai_job_patch_parameter OAIJobPatchParameter [required]
    * @param[in]  timeout qint32 [optional]
    * @param[in]  client_request_id QString [optional]
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
    ...
    * @param[in]  if_unmodified_since QString [optional]
    */
    virtual void jobPatch(const QString &job_id, const QString &api_version, const OAIJobPatchParameter &oai_job_patch_parameter, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_none_match = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_modified_since = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_unmodified_since = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  if_modified_since QString [optional]
    * @param[in]  if_unmodified_since QString [optional]
    * @param[in]  oai_job_terminate_parameter OAIJobTerminateParameter [optional]
    */
    virtual void jobTerminate(const QString &job_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_none_match = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_modified_since = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_unmodified_since = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIJobTerminateParameter> &oai_job_terminate_parameter = ::OpenAPI::OptionalParam<OAIJobTerminateParameter>());

    /**
    * @param[in]  job_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  oai_job_update_parameter OAIJobUpdateParameter [required]
    * @param[in]  timeout qint32 [optional]
    * @param[in]  client_request_id QString [optional]
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
...
private:
    ...
    void jobGetAllJobsLifetimeStatisticsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void jobGetAllJobsLifetimeStatisticsSignal(OAIJobStatistics summary);
    ...
    void jobGetAllJobsLifetimeStatisticsSignalFull(OAIHttpRequestWorker *worker, OAIJobStatistics summary);
    ...
    Q_DECL_DEPRECATED_X("Use jobGetAllJobsLifetimeStatisticsSignalError() instead")
    void jobGetAllJobsLifetimeStatisticsSignalE(OAIJobStatistics summary, QNetworkReply::NetworkError error_type, QString error_str);
    void jobGetAllJobsLifetimeStatisticsSignalError(OAIJobStatistics summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use jobGetAllJobsLifetimeStatisticsSignalErrorFull() instead")
    void jobGetAllJobsLifetimeStatisticsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void jobGetAllJobsLifetimeStatisticsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
