...
public:
    ...
    * @param[in]  oai_compute_node_user OAIComputeNodeUser [required]
    ...
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
    * @param[in]  oai_node_disable_scheduling_parameter OAINodeDisableSchedulingParameter [optional]
    */
    virtual void computeNodeDisableScheduling(const QString &pool_id, const QString &node_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAINodeDisableSchedulingParameter> &oai_node_disable_scheduling_parameter = ::OpenAPI::OptionalParam<OAINodeDisableSchedulingParameter>());
    ...
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
    * @param[in]  oai_node_reboot_parameter OAINodeRebootParameter [optional]
    */
    virtual void computeNodeReboot(const QString &pool_id, const QString &node_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAINodeRebootParameter> &oai_node_reboot_parameter = ::OpenAPI::OptionalParam<OAINodeRebootParameter>());
    ...
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
    * @param[in]  oai_node_reimage_parameter OAINodeReimageParameter [optional]
    */
    virtual void computeNodeReimage(const QString &pool_id, const QString &node_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAINodeReimageParameter> &oai_node_reimage_parameter = ::OpenAPI::OptionalParam<OAINodeReimageParameter>());
    ...
    * @param[in]  user_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  oai_node_update_user_parameter OAINodeUpdateUserParameter [required]
    * @param[in]  timeout qint32 [optional]
    * @param[in]  client_request_id QString [optional]
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
    */
    virtual void computeNodeUpdateUser(const QString &pool_id, const QString &node_id, const QString &user_name, const QString &api_version, const OAINodeUpdateUserParameter &oai_node_update_user_parameter, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  pool_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  oai_node_remove_parameter OAINodeRemoveParameter [required]
    * @param[in]  timeout qint32 [optional]
    * @param[in]  client_request_id QString [optional]
    * @param[in]  return_client_request_id bool [optional]
    * @param[in]  ocp_date QString [optional]
...
Q_SIGNALS:
    ...
    void computeNodeGetRemoteDesktopSignal(OAIHttpFileElement summary);
    ...
    void computeNodeGetRemoteDesktopSignalFull(OAIHttpRequestWorker *worker, OAIHttpFileElement summary);
    ...
    void computeNodeGetRemoteDesktopSignalE(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, QString error_str);
    void computeNodeGetRemoteDesktopSignalError(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, const QString &error_str);
