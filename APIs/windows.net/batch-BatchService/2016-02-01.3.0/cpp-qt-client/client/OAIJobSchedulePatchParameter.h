...
/*
 * OAIJobSchedulePatchParameter.h
 *
 * Parameters for a CloudJobScheduleOperations.Patch request.
 */

#ifndef OAIJobSchedulePatchParameter_H
#define OAIJobSchedulePatchParameter_H
...
class OAIJobSchedulePatchParameter : public OAIObject {
public:
    OAIJobSchedulePatchParameter();
    OAIJobSchedulePatchParameter(QString json);
    ~OAIJobSchedulePatchParameter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobSchedulePatchParameter)

#endif // OAIJobSchedulePatchParameter_H
