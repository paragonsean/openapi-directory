...
void OAIFilesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fileGetNodeFilePropertiesFromComputeNode", defaultConf);
    _serverIndices.insert("fileGetNodeFilePropertiesFromComputeNode", 0);
    _serverConfigs.insert("fileGetNodeFilePropertiesFromTask", defaultConf);
    _serverIndices.insert("fileGetNodeFilePropertiesFromTask", 0);
...
void OAIFilesApi::fileDeleteFromComputeNode(const QString &pool_id, const QString &node_id, const QString &file_name, const QString &api_version, const ::OpenAPI::OptionalParam<bool> &recursive, const ::OpenAPI::OptionalParam<qint32> &timeout, const ::OpenAPI::OptionalParam<QString> &client_request_id, const ::OpenAPI::OptionalParam<bool> &return_client_request_id, const ::OpenAPI::OptionalParam<QString> &ocp_date) {
    QString fullPath = QString(_serverConfigs["fileDeleteFromComputeNode"][_serverIndices.value("fileDeleteFromComputeNode")].URL()+"/pools/{poolId}/nodes/{nodeId}/files/{fileName}");
...
void OAIFilesApi::fileDeleteFromTask(const QString &job_id, const QString &task_id, const QString &file_name, const QString &api_version, const ::OpenAPI::OptionalParam<bool> &recursive, const ::OpenAPI::OptionalParam<qint32> &timeout, const ::OpenAPI::OptionalParam<QString> &client_request_id, const ::OpenAPI::OptionalParam<bool> &return_client_request_id, const ::OpenAPI::OptionalParam<QString> &ocp_date) {
    QString fullPath = QString(_serverConfigs["fileDeleteFromTask"][_serverIndices.value("fileDeleteFromTask")].URL()+"/jobs/{jobId}/tasks/{taskId}/files/{fileName}");
...
void OAIFilesApi::fileGetFromTask(const QString &job_id, const QString &task_id, const QString &file_name, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout, const ::OpenAPI::OptionalParam<QString> &client_request_id, const ::OpenAPI::OptionalParam<bool> &return_client_request_id, const ::OpenAPI::OptionalParam<QString> &ocp_date, const ::OpenAPI::OptionalParam<QString> &ocp_range, const ::OpenAPI::OptionalParam<QString> &if_modified_since, const ::OpenAPI::OptionalParam<QString> &if_unmodified_since) {
    QString fullPath = QString(_serverConfigs["fileGetFromTask"][_serverIndices.value("fileGetFromTask")].URL()+"/jobs/{jobId}/tasks/{taskId}/files/{fileName}");
...
void OAIFilesApi::fileGetNodeFilePropertiesFromComputeNode(const QString &pool_id, const QString &node_id, const QString &file_name, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout, const ::OpenAPI::OptionalParam<QString> &client_request_id, const ::OpenAPI::OptionalParam<bool> &return_client_request_id, const ::OpenAPI::OptionalParam<QString> &ocp_date, const ::OpenAPI::OptionalParam<QString> &if_modified_since, const ::OpenAPI::OptionalParam<QString> &if_unmodified_since) {
    QString fullPath = QString(_serverConfigs["fileGetNodeFilePropertiesFromComputeNode"][_serverIndices.value("fileGetNodeFilePropertiesFromComputeNode")].URL()+"/pools/{poolId}/nodes/{nodeId}/files/{fileName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::fileGetNodeFilePropertiesFromComputeNodeCallback);
    connect(this, &OAIFilesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIFilesApi::fileGetNodeFilePropertiesFromComputeNodeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fileGetNodeFilePropertiesFromComputeNodeSignal();
        Q_EMIT fileGetNodeFilePropertiesFromComputeNodeSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fileGetNodeFilePropertiesFromComputeNodeSignalE(error_type, error_str);
        Q_EMIT fileGetNodeFilePropertiesFromComputeNodeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fileGetNodeFilePropertiesFromComputeNodeSignalError(error_type, error_str);
        Q_EMIT fileGetNodeFilePropertiesFromComputeNodeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIFilesApi::fileGetNodeFilePropertiesFromTask(const QString &job_id, const QString &task_id, const QString &file_name, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout, const ::OpenAPI::OptionalParam<QString> &client_request_id, const ::OpenAPI::OptionalParam<bool> &return_client_request_id, const ::OpenAPI::OptionalParam<QString> &ocp_date, const ::OpenAPI::OptionalParam<QString> &if_modified_since, const ::OpenAPI::OptionalParam<QString> &if_unmodified_since) {
    QString fullPath = QString(_serverConfigs["fileGetNodeFilePropertiesFromTask"][_serverIndices.value("fileGetNodeFilePropertiesFromTask")].URL()+"/jobs/{jobId}/tasks/{taskId}/files/{fileName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::fileGetNodeFilePropertiesFromTaskCallback);
    connect(this, &OAIFilesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIFilesApi::fileGetNodeFilePropertiesFromTaskCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fileGetNodeFilePropertiesFromTaskSignal();
        Q_EMIT fileGetNodeFilePropertiesFromTaskSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fileGetNodeFilePropertiesFromTaskSignalE(error_type, error_str);
        Q_EMIT fileGetNodeFilePropertiesFromTaskSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fileGetNodeFilePropertiesFromTaskSignalError(error_type, error_str);
        Q_EMIT fileGetNodeFilePropertiesFromTaskSignalErrorFull(worker, error_type, error_str);
    }
}
