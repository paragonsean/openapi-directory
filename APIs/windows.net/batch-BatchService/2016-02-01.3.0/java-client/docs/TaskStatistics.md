...
|**readIOGiB** | **Double** | The total gibibytes read from disk by the task. |  |
|**readIOps** | **Long** | The total number of disk read operations made by the task. |  |
...
|**writeIOGiB** | **Double** | The total gibibytes written to disk by the task. |  |
|**writeIOps** | **Long** | The total number of disk write operations made by the task. |  |
