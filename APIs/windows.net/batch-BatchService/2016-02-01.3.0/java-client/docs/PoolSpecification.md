...
|**certificateReferences** | [**List&lt;CertificateReference&gt;**](CertificateReference.md) | A list of certificates to be installed on each compute node in the pool. |  [optional] |
...
|**targetDedicated** | **Integer** | The desired number of compute nodes in the pool. |  [optional] |
