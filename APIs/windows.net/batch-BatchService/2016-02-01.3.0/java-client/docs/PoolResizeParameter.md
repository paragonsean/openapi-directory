...
|------------ | ------------- | ------------- | -------------|
|**nodeDeallocationOption** | [**NodeDeallocationOptionEnum**](#NodeDeallocationOptionEnum) | When nodes may be removed from the pool, if the pool size is decreasing. |  [optional] |
