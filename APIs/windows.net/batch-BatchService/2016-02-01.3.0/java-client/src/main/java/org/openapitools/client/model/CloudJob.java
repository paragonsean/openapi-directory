...
public class CloudJob {
  ...
  public CloudJob previousState(PreviousStateEnum previousState) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commonEnvironmentSettings, constraints, creationTime, displayName, eTag, executionInfo, id, jobManagerTask, jobPreparationTask, jobReleaseTask, lastModified, metadata, poolInfo, previousState, previousStateTransitionTime, priority, state, stateTransitionTime, stats, url, usesTaskDependencies);
  }
