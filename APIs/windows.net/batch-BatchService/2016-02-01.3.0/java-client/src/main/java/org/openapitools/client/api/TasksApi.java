...
public class TasksApi {
     ...
     * @param taskAddParameter The task to be added. (required)
     ...
     * @param apiVersion Client API Version. (required)
     * @param taskAddCollectionParameter The tasks to be added. (required)
     * @param timeout The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds. (optional, default to 30)
     * @param clientRequestId The caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. (optional)
     * @param returnClientRequestId Whether the server should return the client-request-id identifier in the response. (optional)
     * @param ocpDate The time the request was issued. If not specified, this header will be automatically populated with the current system clock time. (optional)
     ...
     */
    public okhttp3.Call taskAddCollectionCall(String jobId, String apiVersion, TaskAddCollectionParameter taskAddCollectionParameter, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = taskAddCollectionParameter;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call taskAddCollectionValidateBeforeCall(String jobId, String apiVersion, TaskAddCollectionParameter taskAddCollectionParameter, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
        ...
        // verify the required parameter 'taskAddCollectionParameter' is set
        if (taskAddCollectionParameter == null) {
            throw new ApiException("Missing the required parameter 'taskAddCollectionParameter' when calling taskAddCollection(Async)");
        }

        return taskAddCollectionCall(jobId, apiVersion, taskAddCollectionParameter, timeout, clientRequestId, returnClientRequestId, ocpDate, _callback);
     ...
     */
    public TaskAddCollectionResult taskAddCollection(String jobId, String apiVersion, TaskAddCollectionParameter taskAddCollectionParameter, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate) throws ApiException {
        ApiResponse<TaskAddCollectionResult> localVarResp = taskAddCollectionWithHttpInfo(jobId, apiVersion, taskAddCollectionParameter, timeout, clientRequestId, returnClientRequestId, ocpDate);
     ...
     */
    public ApiResponse<TaskAddCollectionResult> taskAddCollectionWithHttpInfo(String jobId, String apiVersion, TaskAddCollectionParameter taskAddCollectionParameter, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate) throws ApiException {
        okhttp3.Call localVarCall = taskAddCollectionValidateBeforeCall(jobId, apiVersion, taskAddCollectionParameter, timeout, clientRequestId, returnClientRequestId, ocpDate, null);
     ...
     */
    public okhttp3.Call taskAddCollectionAsync(String jobId, String apiVersion, TaskAddCollectionParameter taskAddCollectionParameter, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate, final ApiCallback<TaskAddCollectionResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = taskAddCollectionValidateBeforeCall(jobId, apiVersion, taskAddCollectionParameter, timeout, clientRequestId, returnClientRequestId, ocpDate, _callback);
        Type localVarReturnType = new TypeToken<TaskAddCollectionResult>(){}.getType();
