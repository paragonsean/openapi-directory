...
class CloudTask(Model):
    ...
    def __init__(self, affinity_info: AffinityInformation=None, command_line: str=None, constraints: TaskConstraints=None, creation_time: datetime=None, depends_on: TaskDependencies=None, display_name: str=None, e_tag: str=None, environment_settings: List[EnvironmentSetting]=None, execution_info: TaskExecutionInformation=None, id: str=None, last_modified: datetime=None, multi_instance_settings: MultiInstanceSettings=None, node_info: ComputeNodeInformation=None, previous_state: str=None, previous_state_transition_time: datetime=None, resource_files: List[ResourceFile]=None, run_elevated: bool=None, state: str=None, state_transition_time: datetime=None, stats: TaskStatistics=None, url: str=None):
