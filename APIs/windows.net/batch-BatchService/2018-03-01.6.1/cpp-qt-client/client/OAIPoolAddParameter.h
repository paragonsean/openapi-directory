...
/*
 * OAIPoolAddParameter.h
 *
 * 
 */

#ifndef OAIPoolAddParameter_H
#define OAIPoolAddParameter_H
...
class OAIPoolAddParameter : public OAIObject {
public:
    OAIPoolAddParameter();
    OAIPoolAddParameter(QString json);
    ~OAIPoolAddParameter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoolAddParameter)

#endif // OAIPoolAddParameter_H
