...
public:
    ...
    * @param[in]  ocp_date QString [optional]
    */
    virtual void poolGetAllLifetimeStatistics(const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void poolGetAllLifetimeStatisticsCallback(OAIHttpRequestWorker *worker);
    void poolListCallback(OAIHttpRequestWorker *worker);
    void poolListUsageMetricsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void poolGetAllLifetimeStatisticsSignal(OAIPoolStatistics summary);
    void poolListSignal(OAICloudPoolListResult summary);
    void poolListUsageMetricsSignal(OAIPoolListUsageMetricsResult summary);
    ...
    void poolGetAllLifetimeStatisticsSignalFull(OAIHttpRequestWorker *worker, OAIPoolStatistics summary);
    void poolListSignalFull(OAIHttpRequestWorker *worker, OAICloudPoolListResult summary);
    void poolListUsageMetricsSignalFull(OAIHttpRequestWorker *worker, OAIPoolListUsageMetricsResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use poolGetAllLifetimeStatisticsSignalError() instead")
    void poolGetAllLifetimeStatisticsSignalE(OAIPoolStatistics summary, QNetworkReply::NetworkError error_type, QString error_str);
    void poolGetAllLifetimeStatisticsSignalError(OAIPoolStatistics summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use poolListUsageMetricsSignalError() instead")
    void poolListUsageMetricsSignalE(OAIPoolListUsageMetricsResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void poolListUsageMetricsSignalError(OAIPoolListUsageMetricsResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use poolGetAllLifetimeStatisticsSignalErrorFull() instead")
    void poolGetAllLifetimeStatisticsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void poolGetAllLifetimeStatisticsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use poolListUsageMetricsSignalErrorFull() instead")
    void poolListUsageMetricsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void poolListUsageMetricsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
