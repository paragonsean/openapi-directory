...
public class FilesApi {
     ...
     */
    public Object fileGetFromComputeNode(String poolId, String nodeId, String filePath, String apiVersion, Integer timeout, UUID clientRequestId, Boolean returnClientRequestId, String ocpDate, String ocpRange, String ifModifiedSince, String ifUnmodifiedSince) throws ApiException {
        ApiResponse<Object> localVarResp = fileGetFromComputeNodeWithHttpInfo(poolId, nodeId, filePath, apiVersion, timeout, clientRequestId, returnClientRequestId, ocpDate, ocpRange, ifModifiedSince, ifUnmodifiedSince);
     ...
     */
    public ApiResponse<Object> fileGetFromComputeNodeWithHttpInfo(String poolId, String nodeId, String filePath, String apiVersion, Integer timeout, UUID clientRequestId, Boolean returnClientRequestId, String ocpDate, String ocpRange, String ifModifiedSince, String ifUnmodifiedSince) throws ApiException {
     ...
     */
    public okhttp3.Call fileGetFromComputeNodeAsync(String poolId, String nodeId, String filePath, String apiVersion, Integer timeout, UUID clientRequestId, Boolean returnClientRequestId, String ocpDate, String ocpRange, String ifModifiedSince, String ifUnmodifiedSince, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public Object fileGetFromTask(String jobId, String taskId, String filePath, String apiVersion, Integer timeout, UUID clientRequestId, Boolean returnClientRequestId, String ocpDate, String ocpRange, String ifModifiedSince, String ifUnmodifiedSince) throws ApiException {
        ApiResponse<Object> localVarResp = fileGetFromTaskWithHttpInfo(jobId, taskId, filePath, apiVersion, timeout, clientRequestId, returnClientRequestId, ocpDate, ocpRange, ifModifiedSince, ifUnmodifiedSince);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> fileGetFromTaskWithHttpInfo(String jobId, String taskId, String filePath, String apiVersion, Integer timeout, UUID clientRequestId, Boolean returnClientRequestId, String ocpDate, String ocpRange, String ifModifiedSince, String ifUnmodifiedSince) throws ApiException {
     ...
     */
    public okhttp3.Call fileGetFromTaskAsync(String jobId, String taskId, String filePath, String apiVersion, Integer timeout, UUID clientRequestId, Boolean returnClientRequestId, String ocpDate, String ocpRange, String ifModifiedSince, String ifUnmodifiedSince, final ApiCallback<Object> _callback) throws ApiException {
     ...
     * @param apiVersion Client API Version. (required)
     * @param $filter An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-compute-node-files. (optional)
     ...
     * @param apiVersion Client API Version. (required)
     * @param $filter An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-task-files. (optional)
