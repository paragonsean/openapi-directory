...
class VirtualMachineConfiguration(Model):
    ...
    def __init__(self, container_configuration: ContainerConfiguration=None, data_disks: List[DataDisk]=None, image_reference: ImageReference=None, license_type: str=None, node_agent_skuid: str=None, os_disk: OSDisk=None, windows_configuration: WindowsConfiguration=None):
