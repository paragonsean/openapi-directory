...
class CloudTask(Model):
    ...
    def __init__(self, affinity_info: AffinityInformation=None, application_package_references: List[ApplicationPackageReference]=None, authentication_token_settings: AuthenticationTokenSettings=None, command_line: str=None, constraints: TaskConstraints=None, container_settings: TaskContainerSettings=None, creation_time: datetime=None, depends_on: TaskDependencies=None, display_name: str=None, e_tag: str=None, environment_settings: List[EnvironmentSetting]=None, execution_info: TaskExecutionInformation=None, exit_conditions: ExitConditions=None, id: str=None, last_modified: datetime=None, multi_instance_settings: MultiInstanceSettings=None, node_info: ComputeNodeInformation=None, output_files: List[OutputFile]=None, previous_state: TaskState=None, previous_state_transition_time: datetime=None, resource_files: List[ResourceFile]=None, state: TaskState=None, state_transition_time: datetime=None, stats: TaskStatistics=None, url: str=None, user_identity: UserIdentity=None):
        ...
        :param container_settings: The container_settings of this CloudTask.
        ...
        :param output_files: The output_files of this CloudTask.
    ...
    def container_settings(self):
        """Gets the container_settings of this CloudTask.


        :return: The container_settings of this CloudTask.
    ...
    def container_settings(self, container_settings):
        """Sets the container_settings of this CloudTask.
    ...
    def output_files(self, output_files):
        """Sets the output_files of this CloudTask.
