...
class TaskAddParameter(Model):
    ...
    def __init__(self, affinity_info: AffinityInformation=None, application_package_references: List[ApplicationPackageReference]=None, authentication_token_settings: AuthenticationTokenSettings=None, command_line: str=None, constraints: TaskConstraints=None, container_settings: TaskContainerSettings=None, depends_on: TaskDependencies=None, display_name: str=None, environment_settings: List[EnvironmentSetting]=None, exit_conditions: ExitConditions=None, id: str=None, multi_instance_settings: MultiInstanceSettings=None, output_files: List[OutputFile]=None, resource_files: List[ResourceFile]=None, user_identity: UserIdentity=None):
        ...
        :param container_settings: The container_settings of this TaskAddParameter.
        ...
        :param output_files: The output_files of this TaskAddParameter.
    ...
    def container_settings(self):
        """Gets the container_settings of this TaskAddParameter.


        :return: The container_settings of this TaskAddParameter.
    ...
    def container_settings(self, container_settings):
        """Sets the container_settings of this TaskAddParameter.
    ...
    def output_files(self, output_files):
        """Sets the output_files of this TaskAddParameter.
