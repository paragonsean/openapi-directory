...
class ComputeNode(Model):
    ...
    def __init__(self, affinity_id: str=None, allocation_time: datetime=None, certificate_references: List[CertificateReference]=None, endpoint_configuration: ComputeNodeEndpointConfiguration=None, errors: List[ComputeNodeError]=None, id: str=None, ip_address: str=None, is_dedicated: bool=None, last_boot_time: datetime=None, node_agent_info: NodeAgentInformation=None, recent_tasks: List[TaskInformation]=None, running_tasks_count: int=None, scheduling_state: str=None, start_task: StartTask=None, start_task_info: StartTaskInformation=None, state: str=None, state_transition_time: datetime=None, total_tasks_run: int=None, total_tasks_succeeded: int=None, url: str=None, vm_size: str=None):
        ...
        :param node_agent_info: The node_agent_info of this ComputeNode.
        ...
        self.openapi_types = {
            ...
            'node_agent_info': NodeAgentInformation,
        ...
        self._node_agent_info = node_agent_info
    ...
    @property
    def node_agent_info(self):
        """Gets the node_agent_info of this ComputeNode.


        :return: The node_agent_info of this ComputeNode.
        :rtype: NodeAgentInformation
        """
        return self._node_agent_info

    @node_agent_info.setter
    def node_agent_info(self, node_agent_info):
        """Sets the node_agent_info of this ComputeNode.


        :param node_agent_info: The node_agent_info of this ComputeNode.
        :type node_agent_info: NodeAgentInformation
        """
