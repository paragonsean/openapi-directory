...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BatchService.NodeUpdateUserParameter();
  });
  ...
  describe('NodeUpdateUserParameter', function() {
    it('should create an instance of NodeUpdateUserParameter', function() {
      // uncomment below and update the code to test NodeUpdateUserParameter
      //var instance = new BatchService.NodeUpdateUserParameter();
      //expect(instance).to.be.a(BatchService.NodeUpdateUserParameter);
    });
