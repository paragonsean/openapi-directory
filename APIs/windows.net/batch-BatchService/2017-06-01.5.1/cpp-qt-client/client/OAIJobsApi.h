...
public:
    ...
    * @param[in]  ocp_date QString [optional]
    */
    virtual void jobGetTaskCounts(const QString &job_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void jobGetTaskCountsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void jobGetTaskCountsSignal(OAITaskCounts summary);
    ...
    void jobGetTaskCountsSignalFull(OAIHttpRequestWorker *worker, OAITaskCounts summary);
    ...
    Q_DECL_DEPRECATED_X("Use jobGetTaskCountsSignalError() instead")
    void jobGetTaskCountsSignalE(OAITaskCounts summary, QNetworkReply::NetworkError error_type, QString error_str);
    void jobGetTaskCountsSignalError(OAITaskCounts summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use jobGetTaskCountsSignalErrorFull() instead")
    void jobGetTaskCountsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void jobGetTaskCountsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
