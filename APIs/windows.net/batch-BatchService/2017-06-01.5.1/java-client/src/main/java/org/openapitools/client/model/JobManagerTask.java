...
public class JobManagerTask {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowLowPriorityNode, applicationPackageReferences, authenticationTokenSettings, commandLine, constraints, displayName, environmentSettings, id, killJobOnCompletion, outputFiles, resourceFiles, runExclusive, userIdentity);
  }
