...
public class JobsApi {
     ...
     * @param jobId The ID of the job. (required)
     * @param apiVersion Client API Version. (required)
     * @param $filter An OData $filter clause. To get the status of the Job Preparation and Job Release tasks on a specific compute node, use \&quot;nodeId eq &#39;{desired-node-id}&#39;\&quot; (optional)
     * @param $select An OData $select clause. (optional)
