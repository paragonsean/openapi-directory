...
public class Example {
  public static void main(String[] args) {
    ...
    String jobId = "jobId_example"; // String | The ID of the job.
    String apiVersion = "apiVersion_example"; // String | Client API Version.
    String $filter = "$filter_example"; // String | An OData $filter clause. To get the status of the Job Preparation and Job Release tasks on a specific compute node, use \"nodeId eq '{desired-node-id}'\"
    String $select = "$select_example"; // String | An OData $select clause.
