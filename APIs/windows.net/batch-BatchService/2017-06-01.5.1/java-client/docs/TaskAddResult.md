...
|**status** | [**StatusEnum**](#StatusEnum) | Values are:   success - Task was added successfully.  clienterror - Task failed to add due to a client error and should not be retried without modifying the request as appropriate.  servererror - Task failed to add due to a server error and can be retried without modification. |  |
|**taskId** | **String** |  |  |
