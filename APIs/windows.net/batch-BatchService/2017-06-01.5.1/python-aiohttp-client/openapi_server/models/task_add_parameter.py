...
class TaskAddParameter(Model):
    ...
    def __init__(self, affinity_info: AffinityInformation=None, application_package_references: List[ApplicationPackageReference]=None, authentication_token_settings: AuthenticationTokenSettings=None, command_line: str=None, constraints: TaskConstraints=None, depends_on: TaskDependencies=None, display_name: str=None, environment_settings: List[EnvironmentSetting]=None, exit_conditions: ExitConditions=None, id: str=None, multi_instance_settings: MultiInstanceSettings=None, output_files: List[OutputFile]=None, resource_files: List[ResourceFile]=None, user_identity: UserIdentity=None):
