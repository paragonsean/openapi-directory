...
class TaskInformation(Model):
    ...
    def __init__(self, execution_info: TaskExecutionInformation=None, job_id: str=None, subtask_id: int=None, task_id: str=None, task_state: TaskState=None, task_url: str=None):
    ...
    def task_state(self, task_state):
        ...
        :param task_state: The task_state of this TaskInformation.
        :type task_state: TaskState
        """
        if task_state is None:
            raise ValueError("Invalid value for `task_state`, must not be `None`")
