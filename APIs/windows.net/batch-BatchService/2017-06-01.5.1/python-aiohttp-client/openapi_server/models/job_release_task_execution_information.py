...
class JobReleaseTaskExecutionInformation(Model):
    ...
    def __init__(self, end_time: datetime=None, exit_code: int=None, failure_info: TaskFailureInformation=None, result: TaskExecutionResult=None, start_time: datetime=None, state: str=None, task_root_directory: str=None, task_root_directory_url: str=None):
    ...
    def state(self):
        ...
        Values are:   running - the task is currently running (including retrying).  completed - the task has exited, or the Batch service was unable to start the task due to task preparation errors (such as resource file download failures).
