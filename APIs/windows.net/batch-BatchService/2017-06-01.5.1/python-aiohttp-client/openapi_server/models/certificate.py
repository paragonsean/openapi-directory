...
class Certificate(Model):
    ...
    def __init__(self, delete_certificate_error: DeleteCertificateError=None, previous_state: CertificateState=None, previous_state_transition_time: datetime=None, public_data: str=None, state: CertificateState=None, state_transition_time: datetime=None, thumbprint: str=None, thumbprint_algorithm: str=None, url: str=None):
        ...
        self.openapi_types = {
            ...
            'previous_state': CertificateState,
    ...
    def previous_state(self, previous_state):
        ...
        :param previous_state: The previous_state of this Certificate.
        :type previous_state: CertificateState
        """
