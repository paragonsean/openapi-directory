...
class CertificateReference(Model):
    ...
    def store_location(self, store_location):
        ...
        """
        allowed_values = ["currentUser", "localMachine"]  # noqa: E501
    ...
    def visibility(self):
        ...
        Values are:   starttask - The user account under which the start task is run.  task - The accounts under which job tasks are run.  remoteuser - The accounts under which users remotely access the node.   You can specify more than one visibility in this collection. The default is all accounts.
    ...
    def visibility(self, visibility):
        ...
        """
        allowed_values = ["startTask", "task", "remoteUser"]  # noqa: E501
