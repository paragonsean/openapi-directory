...
class InboundNATPool(Model):
    ...
    def __init__(self, backend_port: int=None, frontend_port_range_end: int=None, frontend_port_range_start: int=None, name: str=None, network_security_group_rules: List[NetworkSecurityGroupRule]=None, protocol: str=None):
