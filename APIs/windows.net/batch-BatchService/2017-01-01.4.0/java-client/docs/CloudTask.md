...
|**previousState** | **TaskState** |  |  [optional] |
|**previousStateTransitionTime** | **OffsetDateTime** | This property is not set if the task is in its initial Active state. |  [optional] |
