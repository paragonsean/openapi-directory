...
public class JobManagerTask {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationPackageReferences, authenticationTokenSettings, commandLine, constraints, displayName, environmentSettings, id, killJobOnCompletion, resourceFiles, runExclusive, userIdentity);
  }
