...
public class PoolSpecification {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationPackageReferences, autoScaleEvaluationInterval, autoScaleFormula, certificateReferences, cloudServiceConfiguration, displayName, enableAutoScale, enableInterNodeCommunication, maxTasksPerNode, metadata, networkConfiguration, resizeTimeout, startTask, targetDedicated, taskSchedulingPolicy, userAccounts, virtualMachineConfiguration, vmSize);
  }
