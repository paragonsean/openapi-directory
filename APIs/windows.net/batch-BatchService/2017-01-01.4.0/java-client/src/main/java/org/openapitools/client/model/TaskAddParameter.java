...
public class TaskAddParameter {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinityInfo, applicationPackageReferences, authenticationTokenSettings, commandLine, constraints, dependsOn, displayName, environmentSettings, exitConditions, id, multiInstanceSettings, resourceFiles, userIdentity);
  }
