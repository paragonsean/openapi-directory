...
/*
 * OAIStartTaskInformation.h
 *
 * 
 */

#ifndef OAIStartTaskInformation_H
#define OAIStartTaskInformation_H
...
class OAIStartTaskInformation : public OAIObject {
public:
    OAIStartTaskInformation();
    OAIStartTaskInformation(QString json);
    ~OAIStartTaskInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTaskInformation)

#endif // OAIStartTaskInformation_H
