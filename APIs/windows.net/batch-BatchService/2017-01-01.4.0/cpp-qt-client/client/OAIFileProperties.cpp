...
QString OAIFileProperties::getFileMode() const {
    return m_file_mode;
}
void OAIFileProperties::setFileMode(const QString &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIFileProperties::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIFileProperties::is_file_mode_Valid() const{
