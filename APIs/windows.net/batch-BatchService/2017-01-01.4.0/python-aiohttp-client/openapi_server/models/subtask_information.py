...
class SubtaskInformation(Model):
    ...
    def __init__(self, end_time: datetime=None, exit_code: int=None, id: int=None, node_info: ComputeNodeInformation=None, previous_state: SubtaskState=None, previous_state_transition_time: datetime=None, scheduling_error: TaskSchedulingError=None, start_time: datetime=None, state: SubtaskState=None, state_transition_time: datetime=None):
