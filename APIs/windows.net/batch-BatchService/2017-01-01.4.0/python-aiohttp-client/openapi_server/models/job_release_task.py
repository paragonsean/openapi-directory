...
class JobReleaseTask(Model):
    ...
    def __init__(self, command_line: str=None, environment_settings: List[EnvironmentSetting]=None, id: str=None, max_wall_clock_time: str=None, resource_files: List[ResourceFile]=None, retention_time: str=None, user_identity: UserIdentity=None):
