...
------------ | ------------- | ------------- | -------------
**nodeDeallocationOption** | **String** | Sets when nodes may be removed from the pool, if the pool size is decreasing. | [optional] 
...
**targetDedicated** | **Number** | Sets the desired number of compute nodes in the pool. | 
