...
**environmentSettings** | [**[EnvironmentSetting]**](EnvironmentSetting.md) | Gets or sets a list of environment variable settings for the start task. | [optional] 
**maxTaskRetryCount** | **Number** | Gets or sets the maximum number of times the task may be retried. | [optional] 
