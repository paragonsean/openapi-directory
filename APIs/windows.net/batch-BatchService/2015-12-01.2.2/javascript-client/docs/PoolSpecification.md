...
**certificateReferences** | [**[CertificateReference]**](CertificateReference.md) | Gets or sets a list of certificates to be installed on each compute node in the pool. | [optional] 
...
**targetDedicated** | **Number** | Gets or sets the desired number of compute nodes in the pool. | [optional] 
