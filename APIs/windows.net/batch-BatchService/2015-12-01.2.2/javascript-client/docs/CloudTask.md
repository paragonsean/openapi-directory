...
**creationTime** | **Date** | Gets or sets the creation time of the task. | [optional] 
...
**lastModified** | **Date** | Gets or sets the last modified time of the task. | [optional] 
...
**previousState** | **String** | Gets or sets the previous state of the task. This property is not set if the task is in its initial Active state. | [optional] 
**previousStateTransitionTime** | **Date** | Gets or sets the time at which the task entered its previous state. This property is not set if the task is in its initial Active state. | [optional] 
...
**state** | **String** | Gets or sets the current state of the task. | [optional] 
**stateTransitionTime** | **Date** | Gets or sets the time at which the task entered its current state. | [optional] 
