...
class CertificateAddParameter {
     ...
     * @param data {String} Gets or sets the base64-encoded contents of the .pfx file containing the certificate. The maximum size is 10KB. This property is not populated by the Get Certificate operation.
     * @param thumbprint {String} Get or sets the X.509 thumbprint of the certificate. This is a sequence of up to 40 hex digits (it may include spaces but these are removed).
     * @param thumbprintAlgorithm {String} Gets or sets the algorithm used to derive the thumbprint. This must be sha1.
     */
