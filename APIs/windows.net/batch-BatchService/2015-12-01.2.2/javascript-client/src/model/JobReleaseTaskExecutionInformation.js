...
class JobReleaseTaskExecutionInformation {
     ...
     * @param startTime {Date} Gets or sets the time at which the Job Release task started running.
     * @param state {module:model/JobReleaseTaskExecutionInformation.StateEnum} Gets or sets the current running state of the Job Release task on the compute node.
     */
