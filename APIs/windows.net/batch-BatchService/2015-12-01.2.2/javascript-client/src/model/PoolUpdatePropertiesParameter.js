...
class PoolUpdatePropertiesParameter {
     ...
     * @param applicationPackageReferences {Array.<module:model/ApplicationPackageReference>} Sets a list of application packages to be installed on each compute node in the pool. If you specify an empty collection, any existing application packages references are removed from the pool.
     * @param certificateReferences {Array.<module:model/CertificateReference>} Sets a list of certificates to be installed on each compute node in the pool. If you specify an empty collection, any existing certificate references are removed from the pool.
     * @param metadata {Array.<module:model/MetadataItem>} Sets a list of name-value pairs associated with the pool as metadata. If you specify an empty collection, any existing metadata is removed from the pool.
     */
