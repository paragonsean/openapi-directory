...
class ApplicationSummary {
     ...
     * @param displayName {String} Gets or sets the display name for the application.
     * @param id {String} Gets or sets a string that uniquely identifies the application within the account.
