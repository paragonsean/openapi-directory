...
class TaskAddParameter {
     ...
     * @param commandLine {String} Gets or sets the command line of the task. For multi-instance tasks, the command line is executed on the primary subtask after all the subtasks have finished executing the coordination command line.
     * @param id {String} Gets or sets a string that uniquely identifies the task within the job. The id can contain any combination of alphanumeric characters including hyphens and underscores, and cannot contain more than 64 characters.
     */
 ...
 */
TaskAddParameter.prototype['runElevated'] = undefined;
