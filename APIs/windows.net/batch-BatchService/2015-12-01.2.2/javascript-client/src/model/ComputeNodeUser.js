...
class ComputeNodeUser {
     ...
     * @param name {String} Gets or sets the user name of the account.
     * @param password {String} Gets or sets the password of the account.
     */
    constructor(name, password) { 
        
        ComputeNodeUser.initialize(this, name, password);
    }
...
ComputeNodeUser.RequiredProperties = ["name", "password"];
