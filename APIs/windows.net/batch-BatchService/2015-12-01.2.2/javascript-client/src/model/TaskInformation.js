...
class TaskInformation {
     ...
     * @param taskState {module:model/TaskInformation.TaskStateEnum} Gets or sets the current state of the task.
     */
 ...
 * @member {module:model/TaskInformation.TaskStateEnum} taskState
 */
