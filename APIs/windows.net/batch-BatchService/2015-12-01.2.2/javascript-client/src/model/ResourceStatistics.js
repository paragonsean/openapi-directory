...
class ResourceStatistics {
     ...
     * @param avgCPUPercentage {Number} Gets or sets the average CPU usage across all nodes in the pool (percentage per node).
     * @param avgDiskGiB {Number} Gets or sets the average used disk space in GiB across all nodes in the pool.
     * @param avgMemoryGiB {Number} Gets or sets the average memory usage in GiB across all nodes in the pool.
     * @param diskReadGiB {Number} Gets or sets the total amount of data in GiB of disk reads across all nodes in the pool.
     * @param diskReadIOps {Number} Gets or sets the total number of disk read operations across all nodes in the pool.
     * @param diskWriteGiB {Number} Gets or sets the total amount of data in GiB of disk writes across all nodes in the pool.
     * @param diskWriteIOps {Number} Gets or sets the total number of disk write operations across all nodes in the pool.
     ...
     * @param networkReadGiB {Number} Gets or sets the total amount of data in GiB of network reads across all nodes in the pool.
     * @param networkWriteGiB {Number} Gets or sets the total amount of data in GiB of network writes across all nodes in the pool.
     * @param peakDiskGiB {Number} Gets or sets the peak used disk space in GiB across all nodes in the pool.
     * @param peakMemoryGiB {Number} Gets or sets the peak memory usage in GiB across all nodes in the pool.
