...
class CertificateReference {
     ...
     * @param thumbprint {String} Gets or sets the thumbprint of the certificate.
     * @param thumbprintAlgorithm {String} Gets or sets the algorithm with which the thumbprint is associated.  This must be sha1.
     */
