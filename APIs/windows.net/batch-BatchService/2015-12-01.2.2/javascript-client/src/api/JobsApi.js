...
export default class JobsApi {
    ...
    */
     ...
     * @param {module:model/JobAddParameter} jobAddParameter Specifies the job to be added.
     ...
     */
    jobAdd(apiVersion, jobAddParameter, opts, callback) {
      opts = opts || {};
      let postBody = jobAddParameter;
      ...
      if (jobAddParameter === undefined || jobAddParameter === null) {
        throw new Error("Missing the required parameter 'jobAddParameter' when calling jobAdd");
      }
    ...
    /**
     * Callback function to receive the result of the jobGetAllJobsLifetimeStatistics operation.
     * @callback module:api/JobsApi~jobGetAllJobsLifetimeStatisticsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Boolean} [returnClientRequestId] Specifies if the server should return the client-request-id identifier in the response.
     * @param {String} [ocpDate] The time the request was issued. If not specified, this header will be automatically populated with the current system clock time.
     * @param {module:api/JobsApi~jobGetAllJobsLifetimeStatisticsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JobStatistics}
     */
    jobGetAllJobsLifetimeStatistics(apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling jobGetAllJobsLifetimeStatistics");
      }
