...
public class CloudPool {
  ...
  public CloudPool currentOSVersion(String currentOSVersion) {
  ...
  public CloudPool osFamily(String osFamily) {
  ...
  public CloudPool targetOSVersion(String targetOSVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allocationState, cloudPool.allocationState) &&
        ...
        Objects.equals(this.currentOSVersion, cloudPool.currentOSVersion) &&
        ...
        Objects.equals(this.osFamily, cloudPool.osFamily) &&
        ...
        Objects.equals(this.targetOSVersion, cloudPool.targetOSVersion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allocationState, allocationStateTransitionTime, applicationPackageReferences, autoScaleEvaluationInterval, autoScaleFormula, autoScaleRun, certificateReferences, creationTime, currentDedicated, currentOSVersion, displayName, eTag, enableAutoScale, enableInterNodeCommunication, id, lastModified, maxTasksPerNode, metadata, osFamily, resizeError, resizeTimeout, startTask, state, stateTransitionTime, stats, targetDedicated, targetOSVersion, taskSchedulingPolicy, url, vmSize);
  }
