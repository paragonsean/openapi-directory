...
public class JobSpecification {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commonEnvironmentSettings, constraints, displayName, jobManagerTask, jobPreparationTask, jobReleaseTask, metadata, poolInfo, priority, usesTaskDependencies);
  }
