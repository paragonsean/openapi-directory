...
public class CloudTask {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinityInfo, commandLine, constraints, creationTime, dependsOn, displayName, eTag, environmentSettings, executionInfo, id, lastModified, multiInstanceSettings, nodeInfo, previousState, previousStateTransitionTime, resourceFiles, runElevated, state, stateTransitionTime, stats, url);
  }
