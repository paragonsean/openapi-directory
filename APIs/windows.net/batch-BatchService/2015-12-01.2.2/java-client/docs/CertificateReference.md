...
|------------ | ------------- | ------------- | -------------|
|**storeLocation** | [**StoreLocationEnum**](#StoreLocationEnum) | Gets or sets the location of the certificate store on the compute node into which to install the certificate. The default value is CurrentUser. |  [optional] |
