...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean recursive = true; // Boolean | Sets whether to delete children of a directory. If the fileName parameter represents a directory instead of a file, you can set Recursive to true to delete the directory and all of the files and subdirectories in it. If Recursive is false then the directory must be empty or deletion will fail.
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean returnClientRequestId = true; // Boolean | Specifies if the server should return the client-request-id identifier in the response.
    String ocpDate = "ocpDate_example"; // String | The time the request was issued. If not specified, this header will be automatically populated with the current system clock time.
    String ocpRange = "ocpRange_example"; // String | Specifies the byte range to be retrieved. The default is to retrieve the entire file.  The format is startRange-endRange.
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Found the file |  * Content-Length - Gets the length of the file. <br>  * Content-Type - Gets the content type of the file. <br>  * ETag - Gets the content of the ETag HTTP response header. <br>  * Last-Modified - Gets the content of the Last-Modified HTTP response header. <br>  * client-request-id - Gets the ClientRequestId provided by the client during the request, if present and requested to be returned. <br>  * ocp-batch-file-isdirectory - Gets whether the object represents a directory. <br>  * ocp-batch-file-url - Gets the URL of the file. <br>  * ocp-creation-time - Gets the file creation time. <br>  * request-id - Gets the value that uniquely identifies a request. <br>  |
| **0** | Error from the Batch service |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean recursive = true; // Boolean | Sets whether to list children of a directory.
