...
|**numFailedTasks** | **Long** | Gets or sets the total number of tasks in the job that failed during the given time range. |  |
|**numSucceededTasks** | **Long** | Gets or sets the total number of tasks successfully completed in the job during the given time range. |  |
|**numTaskRetries** | **Long** | Gets or sets the total number of retries on all the tasks in the job during the given time range. |  |
|**readIOGiB** | **Double** | Gets or sets the total amount of data in GiB of I/O read by all the tasks in the job. |  |
|**readIOps** | **Long** | Gets or sets the total number of I/O read operations performed by all the tasks in the job. |  |
...
|**writeIOGiB** | **Double** | Gets or sets the total amount of data in GiB of I/O written by all the tasks in the job. |  |
|**writeIOps** | **Long** | Gets or sets the total number of I/O write operations performed by all the tasks in the job. |  |
