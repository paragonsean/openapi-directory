...
public class Example {
  public static void main(String[] args) {
    ...
    CertificateAddParameter certificateAddParameter = new CertificateAddParameter(); // CertificateAddParameter | Specifies the certificate to be added.
...
| **certificateAddParameter** | [**CertificateAddParameter**](CertificateAddParameter.md)| Specifies the certificate to be added. | |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **202** |  |  * ETag - Gets the content of the ETag HTTP response header. <br>  * Last-Modified - Gets the content of the Last-Modified HTTP response header. <br>  * client-request-id - Gets the ClientRequestId provided by the client during the request, if present and requested to be returned. <br>  * request-id - Gets the value that uniquely identifies a request. <br>  |
| **0** | Error from the Batch service |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Gets the list of certificates. |  * ETag - Gets the content of the ETag HTTP response header. <br>  * Last-Modified - Gets the content of the Last-Modified HTTP response header. <br>  * client-request-id - Gets the ClientRequestId provided by the client during the request, if present and requested to be returned. <br>  * request-id - Gets the value that uniquely identifies a request. <br>  |
| **0** | Error from the Batch service |  -  |
