...
public class Example {
  public static void main(String[] args) {
    ...
    ComputeNodeUser computeNodeUser = new ComputeNodeUser(); // ComputeNodeUser | Specifies the user account to be created.
...
| **computeNodeUser** | [**ComputeNodeUser**](ComputeNodeUser.md)| Specifies the user account to be created. | |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** |  |  * client-request-id - Gets the ClientRequestId provided by the client during the request, if present and requested to be returned. <br>  * request-id - Gets the value that uniquely identifies a request. <br>  |
| **0** | Error from the Batch service |  -  |
