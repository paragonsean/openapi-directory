...
|**poolLifetimeOption** | [**PoolLifetimeOptionEnum**](#PoolLifetimeOptionEnum) | Gets or sets the minimum lifetime of created auto pools, and how multiple jobs on a schedule are assigned to pools. |  |
