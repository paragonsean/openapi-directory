...
|------------ | ------------- | ------------- | -------------|
|**maxTaskRetryCount** | **Integer** | Gets or sets the maximum number of times each task may be retried. The Batch service retries a task if its exit code is nonzero. |  [optional] |
