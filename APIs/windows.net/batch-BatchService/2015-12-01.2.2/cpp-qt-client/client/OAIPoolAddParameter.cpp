...
QString OAIPoolAddParameter::getOsFamily() const {
    return m_os_family;
}
void OAIPoolAddParameter::setOsFamily(const QString &os_family) {
    m_os_family = os_family;
    m_os_family_isSet = true;
}

bool OAIPoolAddParameter::is_os_family_Set() const{
    return m_os_family_isSet;
}

bool OAIPoolAddParameter::is_os_family_Valid() const{
...
QString OAIPoolAddParameter::getTargetOsVersion() const {
    return m_target_os_version;
}
void OAIPoolAddParameter::setTargetOsVersion(const QString &target_os_version) {
    m_target_os_version = target_os_version;
    m_target_os_version_isSet = true;
}

bool OAIPoolAddParameter::is_target_os_version_Set() const{
    return m_target_os_version_isSet;
}

bool OAIPoolAddParameter::is_target_os_version_Valid() const{
...
bool OAIPoolAddParameter::isValid() const {
    ...
    return m_id_isValid && m_os_family_isValid && m_vm_size_isValid && true;
}
