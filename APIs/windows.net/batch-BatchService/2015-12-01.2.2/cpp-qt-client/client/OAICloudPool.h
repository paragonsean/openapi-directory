...
public:
    ...
    qint32 getCurrentDedicated() const;
    void setCurrentDedicated(const qint32 &current_dedicated);
    bool is_current_dedicated_Set() const;
    bool is_current_dedicated_Valid() const;
    ...
    OAIResizeError getResizeError() const;
    void setResizeError(const OAIResizeError &resize_error);
    bool is_resize_error_Set() const;
    bool is_resize_error_Valid() const;
...
private:
    ...
    qint32 m_current_dedicated;
    bool m_current_dedicated_isSet;
    bool m_current_dedicated_isValid;
    ...
    OAIResizeError m_resize_error;
    bool m_resize_error_isSet;
    bool m_resize_error_isValid;
