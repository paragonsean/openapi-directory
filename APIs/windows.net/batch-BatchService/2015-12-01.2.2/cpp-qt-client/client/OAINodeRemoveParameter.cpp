...
QString OAINodeRemoveParameter::getNodeDeallocationOption() const {
    return m_node_deallocation_option;
}
void OAINodeRemoveParameter::setNodeDeallocationOption(const QString &node_deallocation_option) {
