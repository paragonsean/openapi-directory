...
QString OAICloudPool::getCurrentOsVersion() const {
    return m_current_os_version;
}
void OAICloudPool::setCurrentOsVersion(const QString &current_os_version) {
    m_current_os_version = current_os_version;
    m_current_os_version_isSet = true;
}

bool OAICloudPool::is_current_os_version_Set() const{
    return m_current_os_version_isSet;
}

bool OAICloudPool::is_current_os_version_Valid() const{
...
QString OAICloudPool::getOsFamily() const {
    return m_os_family;
}
void OAICloudPool::setOsFamily(const QString &os_family) {
    m_os_family = os_family;
    m_os_family_isSet = true;
}

bool OAICloudPool::is_os_family_Set() const{
    return m_os_family_isSet;
}

bool OAICloudPool::is_os_family_Valid() const{
...
QString OAICloudPool::getTargetOsVersion() const {
    return m_target_os_version;
}
void OAICloudPool::setTargetOsVersion(const QString &target_os_version) {
    m_target_os_version = target_os_version;
    m_target_os_version_isSet = true;
}

bool OAICloudPool::is_target_os_version_Set() const{
    return m_target_os_version_isSet;
}

bool OAICloudPool::is_target_os_version_Valid() const{
