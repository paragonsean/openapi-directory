...
class ComputeNode(Model):
    ...
    def __init__(self, affinity_id: str=None, allocation_time: datetime=None, certificate_references: List[CertificateReference]=None, errors: List[ComputeNodeError]=None, id: str=None, ip_address: str=None, last_boot_time: datetime=None, recent_tasks: List[TaskInformation]=None, scheduling_state: str=None, start_task: StartTask=None, start_task_info: StartTaskInformation=None, state: str=None, state_transition_time: datetime=None, total_tasks_run: int=None, url: str=None, vm_size: str=None):
