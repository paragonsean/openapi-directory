...
class PoolSpecification(Model):
    ...
    def __init__(self, application_package_references: List[ApplicationPackageReference]=None, auto_scale_evaluation_interval: str=None, auto_scale_formula: str=None, certificate_references: List[CertificateReference]=None, display_name: str=None, enable_auto_scale: bool=None, enable_inter_node_communication: bool=None, max_tasks_per_node: int=None, metadata: List[MetadataItem]=None, os_family: str=None, resize_timeout: str=None, start_task: StartTask=None, target_dedicated: int=None, target_os_version: str=None, task_scheduling_policy: TaskSchedulingPolicy=None, vm_size: str=None):
        ...
        :param os_family: The os_family of this PoolSpecification.
        ...
        :param target_os_version: The target_os_version of this PoolSpecification.
    ...
    @property
    def os_family(self):
        """Gets the os_family of this PoolSpecification.

        Gets or sets the Azure Guest OS family to be installed on the virtual machines in the pool.

        :return: The os_family of this PoolSpecification.
        :rtype: str
        """
    ...
    def os_family(self, os_family):
        """Sets the os_family of this PoolSpecification.
    ...
    def target_os_version(self):
        """Gets the target_os_version of this PoolSpecification.

        Gets or sets the Azure Guest OS version to be installed on the virtual machines in the pool.

        :return: The target_os_version of this PoolSpecification.
        :rtype: str
        """
    ...
    def target_os_version(self, target_os_version):
        """Sets the target_os_version of this PoolSpecification.
