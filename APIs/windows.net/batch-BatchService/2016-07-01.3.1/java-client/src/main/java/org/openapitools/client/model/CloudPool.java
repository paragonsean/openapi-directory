...
public class CloudPool {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allocationState, allocationStateTransitionTime, applicationPackageReferences, autoScaleEvaluationInterval, autoScaleFormula, autoScaleRun, certificateReferences, cloudServiceConfiguration, creationTime, currentDedicated, displayName, eTag, enableAutoScale, enableInterNodeCommunication, id, lastModified, maxTasksPerNode, metadata, networkConfiguration, resizeError, resizeTimeout, startTask, state, stateTransitionTime, stats, targetDedicated, taskSchedulingPolicy, url, virtualMachineConfiguration, vmSize);
  }
