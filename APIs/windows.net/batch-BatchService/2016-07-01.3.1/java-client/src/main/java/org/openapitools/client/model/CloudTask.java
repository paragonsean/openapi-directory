...
public class CloudTask {
  ...
  public CloudTask previousState(PreviousStateEnum previousState) {
  ...
  public CloudTask runElevated(Boolean runElevated) {
  ...
  public CloudTask state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.affinityInfo, cloudTask.affinityInfo) &&
        ...
        Objects.equals(this.runElevated, cloudTask.runElevated) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinityInfo, applicationPackageReferences, commandLine, constraints, creationTime, dependsOn, displayName, eTag, environmentSettings, executionInfo, exitConditions, id, lastModified, multiInstanceSettings, nodeInfo, previousState, previousStateTransitionTime, resourceFiles, runElevated, state, stateTransitionTime, stats, url);
  }
