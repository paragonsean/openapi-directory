...
public class ApiClient {
    ...
    private String basePath = "https://batch.core.windows.net";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-07-01.3.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://batch.core.windows.net
