...
public class JobAddParameter {
   ...
   */
  @JsonAdapter(OnAllTasksCompleteEnum.Adapter.class)
  public enum OnAllTasksCompleteEnum {
    NO_ACTION("noAction"),
    ...
    OnAllTasksCompleteEnum(String value) {
      this.value = value;
    }
    ...
    public static OnAllTasksCompleteEnum fromValue(String value) {
      for (OnAllTasksCompleteEnum b : OnAllTasksCompleteEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<OnAllTasksCompleteEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OnAllTasksCompleteEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OnAllTasksCompleteEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return OnAllTasksCompleteEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      OnAllTasksCompleteEnum.fromValue(value);
    }
  }
  ...
  private OnAllTasksCompleteEnum onAllTasksComplete;
   ...
   */
  @JsonAdapter(OnTaskFailureEnum.Adapter.class)
  public enum OnTaskFailureEnum {
    NO_ACTION("noAction"),
    ...
    OnTaskFailureEnum(String value) {
      this.value = value;
    }
    ...
    public static OnTaskFailureEnum fromValue(String value) {
      for (OnTaskFailureEnum b : OnTaskFailureEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<OnTaskFailureEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OnTaskFailureEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OnTaskFailureEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return OnTaskFailureEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      OnTaskFailureEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_ON_TASK_FAILURE = "onTaskFailure";
  @SerializedName(SERIALIZED_NAME_ON_TASK_FAILURE)
  private OnTaskFailureEnum onTaskFailure;
  ...
  public JobAddParameter onAllTasksComplete(OnAllTasksCompleteEnum onAllTasksComplete) {
   ...
   */
  @javax.annotation.Nullable
  public OnAllTasksCompleteEnum getOnAllTasksComplete() {
    return onAllTasksComplete;
  }

  public void setOnAllTasksComplete(OnAllTasksCompleteEnum onAllTasksComplete) {
    this.onAllTasksComplete = onAllTasksComplete;
  }


  public JobAddParameter onTaskFailure(OnTaskFailureEnum onTaskFailure) {
   ...
   */
  @javax.annotation.Nullable
  public OnTaskFailureEnum getOnTaskFailure() {
    return onTaskFailure;
  }

  public void setOnTaskFailure(OnTaskFailureEnum onTaskFailure) {
    this.onTaskFailure = onTaskFailure;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("onAllTasksComplete") != null && !jsonObj.get("onAllTasksComplete").isJsonNull()) && !jsonObj.get("onAllTasksComplete").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `onAllTasksComplete` to be a primitive type in the JSON string but got `%s`", jsonObj.get("onAllTasksComplete").toString()));
      }
      ...
      if (jsonObj.get("onAllTasksComplete") != null && !jsonObj.get("onAllTasksComplete").isJsonNull()) {
        OnAllTasksCompleteEnum.validateJsonElement(jsonObj.get("onAllTasksComplete"));
      }
      if ((jsonObj.get("onTaskFailure") != null && !jsonObj.get("onTaskFailure").isJsonNull()) && !jsonObj.get("onTaskFailure").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `onTaskFailure` to be a primitive type in the JSON string but got `%s`", jsonObj.get("onTaskFailure").toString()));
      }
      // validate the optional field `onTaskFailure`
      if (jsonObj.get("onTaskFailure") != null && !jsonObj.get("onTaskFailure").isJsonNull()) {
        OnTaskFailureEnum.validateJsonElement(jsonObj.get("onTaskFailure"));
      }
