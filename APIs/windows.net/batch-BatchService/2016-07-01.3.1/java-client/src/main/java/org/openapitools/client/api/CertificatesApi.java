...
public class CertificatesApi {
     ...
     */
    public okhttp3.Call certificateAddCall(String apiVersion, CertificateAddParameter certificate, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call certificateAddValidateBeforeCall(String apiVersion, CertificateAddParameter certificate, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void certificateAdd(String apiVersion, CertificateAddParameter certificate, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate) throws ApiException {
     ...
     */
    public ApiResponse<Void> certificateAddWithHttpInfo(String apiVersion, CertificateAddParameter certificate, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate) throws ApiException {
     ...
     */
    public okhttp3.Call certificateAddAsync(String apiVersion, CertificateAddParameter certificate, Integer timeout, String clientRequestId, Boolean returnClientRequestId, String ocpDate, final ApiCallback<Void> _callback) throws ApiException {
