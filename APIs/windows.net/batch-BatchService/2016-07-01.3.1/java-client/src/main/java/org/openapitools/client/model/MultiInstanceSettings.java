...
public class MultiInstanceSettings {
  ...
  static {
    ...
    openapiRequiredFields.add("numberOfInstances");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("coordinationCommandLine") != null && !jsonObj.get("coordinationCommandLine").isJsonNull()) && !jsonObj.get("coordinationCommandLine").isJsonPrimitive()) {
