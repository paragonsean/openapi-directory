...
public class PoolAddParameter {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationPackageReferences, autoScaleEvaluationInterval, autoScaleFormula, certificateReferences, cloudServiceConfiguration, displayName, enableAutoScale, enableInterNodeCommunication, id, maxTasksPerNode, metadata, networkConfiguration, resizeTimeout, startTask, targetDedicated, taskSchedulingPolicy, virtualMachineConfiguration, vmSize);
  }
