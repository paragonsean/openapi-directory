...
public class Example {
  public static void main(String[] args) {
    ...
    String $filter = "$filter_example"; // String | An OData $filter clause. If this is not specified the response includes all pools that existed in the account in the time range of the returned aggregation intervals.
