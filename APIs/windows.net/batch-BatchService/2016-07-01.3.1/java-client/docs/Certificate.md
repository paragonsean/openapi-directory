...
|**previousState** | [**PreviousStateEnum**](#PreviousStateEnum) | This property is not set if the certificate is in its initial Active state. |  [optional] |
|**previousStateTransitionTime** | **OffsetDateTime** | This property is not set if the certificate is in its initial Active state. |  [optional] |
