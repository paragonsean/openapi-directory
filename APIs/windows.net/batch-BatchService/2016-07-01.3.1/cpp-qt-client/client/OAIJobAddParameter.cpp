...
QString OAIJobAddParameter::getOnAllTasksComplete() const {
    return m_on_all_tasks_complete;
}
void OAIJobAddParameter::setOnAllTasksComplete(const QString &on_all_tasks_complete) {
...
QString OAIJobAddParameter::getOnTaskFailure() const {
    return m_on_task_failure;
}
void OAIJobAddParameter::setOnTaskFailure(const QString &on_task_failure) {
