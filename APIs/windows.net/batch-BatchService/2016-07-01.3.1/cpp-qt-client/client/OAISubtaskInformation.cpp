...
QString OAISubtaskInformation::getPreviousState() const {
    return m_previous_state;
}
void OAISubtaskInformation::setPreviousState(const QString &previous_state) {
...
QString OAISubtaskInformation::getState() const {
    return m_state;
}
void OAISubtaskInformation::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}
