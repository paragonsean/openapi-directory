...
public:
    ...
    * @param[in]  ocp_date QString [optional]
    */
    virtual void fileDeleteFromTask(const QString &job_id, const QString &task_id, const QString &file_name, const QString &api_version, const ::OpenAPI::OptionalParam<bool> &recursive = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  if_unmodified_since QString [optional]
    */
    virtual void fileGetFromTask(const QString &job_id, const QString &task_id, const QString &file_name, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &timeout = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &client_request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &return_client_request_id = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ocp_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &ocp_range = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_modified_since = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &if_unmodified_since = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fileGetNodeFilePropertiesFromComputeNodeCallback(OAIHttpRequestWorker *worker);
    void fileGetNodeFilePropertiesFromTaskCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void fileGetFromComputeNodeSignal(OAIHttpFileElement summary);
    void fileGetFromTaskSignal(OAIHttpFileElement summary);
    void fileGetNodeFilePropertiesFromComputeNodeSignal();
    void fileGetNodeFilePropertiesFromTaskSignal();
    ...
    void fileGetFromComputeNodeSignalFull(OAIHttpRequestWorker *worker, OAIHttpFileElement summary);
    void fileGetFromTaskSignalFull(OAIHttpRequestWorker *worker, OAIHttpFileElement summary);
    void fileGetNodeFilePropertiesFromComputeNodeSignalFull(OAIHttpRequestWorker *worker);
    void fileGetNodeFilePropertiesFromTaskSignalFull(OAIHttpRequestWorker *worker);
    ...
    void fileGetFromComputeNodeSignalE(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fileGetFromComputeNodeSignalError(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fileGetFromTaskSignalError() instead")
    void fileGetFromTaskSignalE(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fileGetFromTaskSignalError(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fileGetNodeFilePropertiesFromComputeNodeSignalError() instead")
    void fileGetNodeFilePropertiesFromComputeNodeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void fileGetNodeFilePropertiesFromComputeNodeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fileGetNodeFilePropertiesFromTaskSignalError() instead")
    void fileGetNodeFilePropertiesFromTaskSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void fileGetNodeFilePropertiesFromTaskSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use fileGetNodeFilePropertiesFromComputeNodeSignalErrorFull() instead")
    void fileGetNodeFilePropertiesFromComputeNodeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fileGetNodeFilePropertiesFromComputeNodeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fileGetNodeFilePropertiesFromTaskSignalErrorFull() instead")
    void fileGetNodeFilePropertiesFromTaskSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fileGetNodeFilePropertiesFromTaskSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
