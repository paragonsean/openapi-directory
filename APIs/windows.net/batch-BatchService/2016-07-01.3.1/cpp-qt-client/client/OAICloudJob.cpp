...
QString OAICloudJob::getOnAllTasksComplete() const {
    return m_on_all_tasks_complete;
}
void OAICloudJob::setOnAllTasksComplete(const QString &on_all_tasks_complete) {
...
QString OAICloudJob::getOnTaskFailure() const {
    return m_on_task_failure;
}
void OAICloudJob::setOnTaskFailure(const QString &on_task_failure) {
...
QString OAICloudJob::getPreviousState() const {
    return m_previous_state;
}
void OAICloudJob::setPreviousState(const QString &previous_state) {
...
QString OAICloudJob::getState() const {
    return m_state;
}
void OAICloudJob::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}
