...
QString OAIJobSpecification::getOnAllTasksComplete() const {
    return m_on_all_tasks_complete;
}
void OAIJobSpecification::setOnAllTasksComplete(const QString &on_all_tasks_complete) {
...
QString OAIJobSpecification::getOnTaskFailure() const {
    return m_on_task_failure;
}
void OAIJobSpecification::setOnTaskFailure(const QString &on_task_failure) {
