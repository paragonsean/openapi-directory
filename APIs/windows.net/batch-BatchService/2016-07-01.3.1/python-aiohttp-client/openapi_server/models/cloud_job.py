...
class CloudJob(Model):
    ...
    def on_task_failure(self, on_task_failure):
        ...
        :param on_task_failure: The on_task_failure of this CloudJob.
        :type on_task_failure: str
        """
        allowed_values = ["noAction", "performExitOptionsJobAction"]  # noqa: E501
        if on_task_failure not in allowed_values:
            raise ValueError(
                "Invalid value for `on_task_failure` ({0}), must be one of {1}"
                .format(on_task_failure, allowed_values)
            )
    ...
    def previous_state(self, previous_state):
        ...
        """
        allowed_values = ["active", "disabling", "disabled", "enabling", "terminating", "completed", "deleting"]  # noqa: E501
