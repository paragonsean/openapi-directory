...
class AutoPoolSpecification {
     ...
     * @param poolLifetimeOption {module:model/AutoPoolSpecification.PoolLifetimeOptionEnum} When the pool lifetime scope is jobschedule level, the Batch service keeps track of the last autopool created for the jobschedule, and deletes that pool when the jobschedule completes. Batch will also delete this pool if the user updates the auto pool specification in a way that changes this lifetime.
     */
