...
class CloudJob {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('onTaskFailure')) {
                obj['onTaskFailure'] = ApiClient.convertToType(data['onTaskFailure'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['onTaskFailure'] && !(typeof data['onTaskFailure'] === 'string' || data['onTaskFailure'] instanceof String)) {
            throw new Error("Expected the field `onTaskFailure` to be a primitive type in the JSON string but got " + data['onTaskFailure']);
        }
 ...
 * @member {module:model/CloudJob.OnAllTasksCompleteEnum} onAllTasksComplete
 */
 ...
 * @member {module:model/CloudJob.OnTaskFailureEnum} onTaskFailure
 */
 ...
 * @readonly
 */
CloudJob['OnAllTasksCompleteEnum'] = {
...
/**
 * Allowed values for the <code>onTaskFailure</code> property.
 * @enum {String}
 * @readonly
 */
CloudJob['OnTaskFailureEnum'] = {
