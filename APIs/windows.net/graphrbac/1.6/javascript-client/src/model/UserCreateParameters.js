...
class UserCreateParameters {
    ...
    static initialize(obj) { 
        obj['accountEnabled'] = accountEnabled;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('passwordProfile')) {
                obj['passwordProfile'] = PasswordProfile.constructFromObject(data['passwordProfile']);
            }
...
UserCreateParameters.RequiredProperties = ["accountEnabled", "displayName", "mailNickname", "passwordProfile", "userPrincipalName"];

/**
 * Whether the account is enabled.
 * @member {Boolean} accountEnabled
 */
UserCreateParameters.prototype['accountEnabled'] = undefined;

/**
 * The display name of the user.
 * @member {String} displayName
 */
UserCreateParameters.prototype['displayName'] = undefined;

/**
 * The primary email address of the user.
 * @member {String} mail
 */
UserCreateParameters.prototype['mail'] = undefined;

/**
 * The mail alias for the user.
 * @member {String} mailNickname
 */
UserCreateParameters.prototype['mailNickname'] = undefined;

/**
 * @member {module:model/PasswordProfile} passwordProfile
 */
UserCreateParameters.prototype['passwordProfile'] = undefined;
 ...
 */
UserCreateParameters.prototype['userPrincipalName'] = undefined;

/**
 * The given name for the user.
 * @member {String} givenName
 */
UserCreateParameters.prototype['givenName'] = undefined;
 ...
 */
UserCreateParameters.prototype['immutableId'] = undefined;

/**
 * The user's surname (family name or last name).
 * @member {String} surname
 */
UserCreateParameters.prototype['surname'] = undefined;
 ...
 */
UserCreateParameters.prototype['usageLocation'] = undefined;

/**
 * A string value that can be used to classify user types in your directory, such as 'Member' and 'Guest'.
 * @member {module:model/UserCreateParameters.UserTypeEnum} userType
 */
UserCreateParameters.prototype['userType'] = undefined;
 ...
 * @readonly
 */
UserCreateParameters['UserTypeEnum'] = {
