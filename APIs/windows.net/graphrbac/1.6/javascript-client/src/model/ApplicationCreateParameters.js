...
class ApplicationCreateParameters {
    ...
    static validateJSON(data) {
        ...
        for (const property of ApplicationCreateParameters.RequiredProperties) {
...
ApplicationCreateParameters.RequiredProperties = ["displayName"];
 ...
 */
ApplicationCreateParameters.prototype['identifierUris'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['allowGuestsSignIn'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['allowPassthroughUsers'] = undefined;

/**
 * The url for the application logo image stored in a CDN.
 * @member {String} appLogoUrl
 */
ApplicationCreateParameters.prototype['appLogoUrl'] = undefined;

/**
 * The application permissions.
 * @member {Array.<String>} appPermissions
 */
ApplicationCreateParameters.prototype['appPermissions'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['appRoles'] = undefined;

/**
 * Whether the application is available to other tenants.
 * @member {Boolean} availableToOtherTenants
 */
ApplicationCreateParameters.prototype['availableToOtherTenants'] = undefined;

/**
 * A URL provided by the author of the application to report errors when using the application.
 * @member {String} errorUrl
 */
ApplicationCreateParameters.prototype['errorUrl'] = undefined;

/**
 * @member {module:model/GroupMembershipClaims} groupMembershipClaims
 */
ApplicationCreateParameters.prototype['groupMembershipClaims'] = undefined;

/**
 * The home page of the application.
 * @member {String} homepage
 */
ApplicationCreateParameters.prototype['homepage'] = undefined;

/**
 * @member {module:model/InformationalUrl} informationalUrls
 */
ApplicationCreateParameters.prototype['informationalUrls'] = undefined;

/**
 * Specifies whether this application supports device authentication without a user. The default is false.
 * @member {Boolean} isDeviceOnlyAuthSupported
 */
ApplicationCreateParameters.prototype['isDeviceOnlyAuthSupported'] = undefined;

/**
 * A collection of KeyCredential objects.
 * @member {Array.<module:model/KeyCredential>} keyCredentials
 */
ApplicationCreateParameters.prototype['keyCredentials'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['knownClientApplications'] = undefined;

/**
 * the url of the logout page
 * @member {String} logoutUrl
 */
ApplicationCreateParameters.prototype['logoutUrl'] = undefined;

/**
 * Whether to allow implicit grant flow for OAuth2
 * @member {Boolean} oauth2AllowImplicitFlow
 */
ApplicationCreateParameters.prototype['oauth2AllowImplicitFlow'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['oauth2AllowUrlPathMatching'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['oauth2Permissions'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['publicClient'] = undefined;

/**
 * Reliable domain which can be used to identify an application.
 * @member {String} publisherDomain
 */
ApplicationCreateParameters.prototype['publisherDomain'] = undefined;

/**
 * A collection of reply URLs for the application.
 * @member {Array.<String>} replyUrls
 */
ApplicationCreateParameters.prototype['replyUrls'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['requiredResourceAccess'] = undefined;

/**
 * The URL to the SAML metadata for the application.
 * @member {String} samlMetadataUrl
 */
ApplicationCreateParameters.prototype['samlMetadataUrl'] = undefined;
 ...
 */
ApplicationCreateParameters.prototype['signInAudience'] = undefined;

/**
 * The primary Web page.
 * @member {String} wwwHomepage
 */
ApplicationCreateParameters.prototype['wwwHomepage'] = undefined;
