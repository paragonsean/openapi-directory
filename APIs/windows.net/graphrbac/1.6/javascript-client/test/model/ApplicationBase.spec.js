...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraphRbacManagementClient.ApplicationBase();
  });
  ...
  describe('ApplicationBase', function() {
    it('should create an instance of ApplicationBase', function() {
      ...
      //var instance = new GraphRbacManagementClient.ApplicationBase();
      //expect(instance).to.be.a(GraphRbacManagementClient.ApplicationBase);
    });
