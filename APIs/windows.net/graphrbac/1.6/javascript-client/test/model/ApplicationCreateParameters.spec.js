...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraphRbacManagementClient.ApplicationCreateParameters();
  });
  ...
  describe('ApplicationCreateParameters', function() {
    it('should create an instance of ApplicationCreateParameters', function() {
      // uncomment below and update the code to test ApplicationCreateParameters
      //var instance = new GraphRbacManagementClient.ApplicationCreateParameters();
      //expect(instance).to.be.a(GraphRbacManagementClient.ApplicationCreateParameters);
    });
