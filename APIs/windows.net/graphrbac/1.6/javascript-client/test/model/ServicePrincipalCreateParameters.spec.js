...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraphRbacManagementClient.ServicePrincipalCreateParameters();
  });
  ...
  describe('ServicePrincipalCreateParameters', function() {
    it('should create an instance of ServicePrincipalCreateParameters', function() {
      // uncomment below and update the code to test ServicePrincipalCreateParameters
      //var instance = new GraphRbacManagementClient.ServicePrincipalCreateParameters();
      //expect(instance).to.be.a(GraphRbacManagementClient.ServicePrincipalCreateParameters);
    });
