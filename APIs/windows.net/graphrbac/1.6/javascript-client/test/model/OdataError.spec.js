...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraphRbacManagementClient.OdataError();
  });
  ...
  describe('OdataError', function() {
    it('should create an instance of OdataError', function() {
      ...
      //var instance = new GraphRbacManagementClient.OdataError();
      //expect(instance).to.be.a(GraphRbacManagementClient.OdataError);
    });
