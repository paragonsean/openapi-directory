...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraphRbacManagementClient.ApplicationUpdateParameters();
  });
  ...
  describe('ApplicationUpdateParameters', function() {
    it('should create an instance of ApplicationUpdateParameters', function() {
      ...
      //var instance = new GraphRbacManagementClient.ApplicationUpdateParameters();
      //expect(instance).to.be.a(GraphRbacManagementClient.ApplicationUpdateParameters);
    });
