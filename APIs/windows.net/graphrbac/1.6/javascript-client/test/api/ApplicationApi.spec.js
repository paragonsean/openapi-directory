...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GraphRbacManagementClient.ApplicationApi();
  });
  ...
  describe('ApplicationApi', function() {
    ...
    describe('applicationsPatch', function() {
      it('should call applicationsPatch successfully', function(done) {
        //uncomment below and update the code to test applicationsPatch
        //instance.applicationsPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deletedApplicationsHardDelete', function() {
      it('should call deletedApplicationsHardDelete successfully', function(done) {
        //uncomment below and update the code to test deletedApplicationsHardDelete
        //instance.deletedApplicationsHardDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
