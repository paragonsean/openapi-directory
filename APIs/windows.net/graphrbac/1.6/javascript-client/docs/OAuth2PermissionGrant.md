# GraphRbacManagementClient.OAuth2PermissionGrant
...
**consentType** | **String** | Indicates if consent was provided by the administrator (on behalf of the organization) or by an individual. | [optional] 
...
* `AllPrincipals` (value: `"AllPrincipals"`)
