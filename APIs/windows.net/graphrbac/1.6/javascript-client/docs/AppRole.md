# GraphRbacManagementClient.AppRole

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**allowedMemberTypes** | **[String]** | Specifies whether this app role definition can be assigned to users and groups by setting to &#39;User&#39;, or to other applications (that are accessing this application in daemon service scenarios) by setting to &#39;Application&#39;, or to both.  | [optional] 
