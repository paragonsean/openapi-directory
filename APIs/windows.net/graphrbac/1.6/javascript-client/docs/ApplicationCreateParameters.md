# GraphRbacManagementClient.ApplicationCreateParameters
...
**identifierUris** | **[String]** | A collection of URIs for the application. | [optional] 
...
**appPermissions** | **[String]** | The application permissions. | [optional] 
...
**groupMembershipClaims** | [**GroupMembershipClaims**](GroupMembershipClaims.md) |  | [optional] 
...
**keyCredentials** | [**[KeyCredential]**](KeyCredential.md) | A collection of KeyCredential objects. | [optional] 
...
**oauth2Permissions** | [**[OAuth2Permission]**](OAuth2Permission.md) | The collection of OAuth 2.0 permission scopes that the web API (resource) application exposes to client applications. These permission scopes may be granted to client applications during consent. | [optional] 
...
**orgRestrictions** | **[String]** | A list of tenants allowed to access application. | [optional] 
**passwordCredentials** | [**[PasswordCredential]**](PasswordCredential.md) | A collection of PasswordCredential objects | [optional] 
**preAuthorizedApplications** | [**[PreAuthorizedApplication]**](PreAuthorizedApplication.md) | list of pre-authorized applications. | [optional] 
