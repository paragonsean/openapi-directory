...
class UserGetMemberGroupsParameters(Model):
    ...
    def __init__(self, security_enabled_only: bool=None):
        """UserGetMemberGroupsParameters - a model defined in OpenAPI

        :param security_enabled_only: The security_enabled_only of this UserGetMemberGroupsParameters.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UserGetMemberGroupsParameters':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UserGetMemberGroupsParameters of this UserGetMemberGroupsParameters.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def security_enabled_only(self):
        """Gets the security_enabled_only of this UserGetMemberGroupsParameters.
        ...
        :return: The security_enabled_only of this UserGetMemberGroupsParameters.
        :rtype: bool
        """
    ...
    def security_enabled_only(self, security_enabled_only):
        """Sets the security_enabled_only of this UserGetMemberGroupsParameters.
