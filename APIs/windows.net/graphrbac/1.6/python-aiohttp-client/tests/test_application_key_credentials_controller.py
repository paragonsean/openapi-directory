...
async def test_applications_list_key_credentials(client):
    """Test case for applications_list_key_credentials
    ...
    response = await client.request(
        method='GET',
        path='/{tenant_id}/applications/{application_object_id}/keyCredentials'.format(application_object_id='application_object_id_example', tenant_id='tenant_id_example'),
        headers=headers,
        params=params,
        )
...
async def test_applications_update_key_credentials(client):
    """Test case for applications_update_key_credentials
