...
public class ApplicationBase {
  ...
  public ApplicationBase allowGuestsSignIn(Boolean allowGuestsSignIn) {
  ...
  public ApplicationBase allowPassthroughUsers(Boolean allowPassthroughUsers) {
  ...
  public ApplicationBase appLogoUrl(String appLogoUrl) {
  ...
  public ApplicationBase appPermissions(List<String> appPermissions) {
    this.appPermissions = appPermissions;
    return this;
  }

  public ApplicationBase addAppPermissionsItem(String appPermissionsItem) {
  ...
  public ApplicationBase appRoles(List<AppRole> appRoles) {
    this.appRoles = appRoles;
    return this;
  }

  public ApplicationBase addAppRolesItem(AppRole appRolesItem) {
  ...
  public ApplicationBase availableToOtherTenants(Boolean availableToOtherTenants) {
  ...
  public ApplicationBase errorUrl(String errorUrl) {
  ...
  public ApplicationBase groupMembershipClaims(GroupMembershipClaims groupMembershipClaims) {
  ...
  public ApplicationBase homepage(String homepage) {
  ...
  public ApplicationBase informationalUrls(InformationalUrl informationalUrls) {
  ...
  public ApplicationBase isDeviceOnlyAuthSupported(Boolean isDeviceOnlyAuthSupported) {
  ...
  public ApplicationBase keyCredentials(List<KeyCredential> keyCredentials) {
    this.keyCredentials = keyCredentials;
    return this;
  }

  public ApplicationBase addKeyCredentialsItem(KeyCredential keyCredentialsItem) {
  ...
  public ApplicationBase knownClientApplications(List<String> knownClientApplications) {
    this.knownClientApplications = knownClientApplications;
    return this;
  }

  public ApplicationBase addKnownClientApplicationsItem(String knownClientApplicationsItem) {
  ...
  public ApplicationBase logoutUrl(String logoutUrl) {
  ...
  public ApplicationBase oauth2AllowImplicitFlow(Boolean oauth2AllowImplicitFlow) {
  ...
  public ApplicationBase oauth2AllowUrlPathMatching(Boolean oauth2AllowUrlPathMatching) {
  ...
  public ApplicationBase oauth2Permissions(List<OAuth2Permission> oauth2Permissions) {
    this.oauth2Permissions = oauth2Permissions;
    return this;
  }

  public ApplicationBase addOauth2PermissionsItem(OAuth2Permission oauth2PermissionsItem) {
  ...
  public ApplicationBase oauth2RequirePostResponse(Boolean oauth2RequirePostResponse) {
  ...
  public ApplicationBase optionalClaims(OptionalClaims optionalClaims) {
  ...
  public ApplicationBase orgRestrictions(List<String> orgRestrictions) {
    this.orgRestrictions = orgRestrictions;
    return this;
  }

  public ApplicationBase addOrgRestrictionsItem(String orgRestrictionsItem) {
  ...
  public ApplicationBase passwordCredentials(List<PasswordCredential> passwordCredentials) {
    this.passwordCredentials = passwordCredentials;
    return this;
  }

  public ApplicationBase addPasswordCredentialsItem(PasswordCredential passwordCredentialsItem) {
  ...
  public ApplicationBase preAuthorizedApplications(List<PreAuthorizedApplication> preAuthorizedApplications) {
    this.preAuthorizedApplications = preAuthorizedApplications;
    return this;
  }

  public ApplicationBase addPreAuthorizedApplicationsItem(PreAuthorizedApplication preAuthorizedApplicationsItem) {
  ...
  public ApplicationBase publicClient(Boolean publicClient) {
  ...
  public ApplicationBase publisherDomain(String publisherDomain) {
  ...
  public ApplicationBase replyUrls(List<String> replyUrls) {
    this.replyUrls = replyUrls;
    return this;
  }

  public ApplicationBase addReplyUrlsItem(String replyUrlsItem) {
  ...
  public ApplicationBase requiredResourceAccess(List<RequiredResourceAccess> requiredResourceAccess) {
    this.requiredResourceAccess = requiredResourceAccess;
    return this;
  }

  public ApplicationBase addRequiredResourceAccessItem(RequiredResourceAccess requiredResourceAccessItem) {
  ...
  public ApplicationBase samlMetadataUrl(String samlMetadataUrl) {
  ...
  public ApplicationBase signInAudience(String signInAudience) {
  ...
  public ApplicationBase wwwHomepage(String wwwHomepage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowGuestsSignIn, applicationBase.allowGuestsSignIn) &&
        Objects.equals(this.allowPassthroughUsers, applicationBase.allowPassthroughUsers) &&
        Objects.equals(this.appLogoUrl, applicationBase.appLogoUrl) &&
        Objects.equals(this.appPermissions, applicationBase.appPermissions) &&
        Objects.equals(this.appRoles, applicationBase.appRoles) &&
        Objects.equals(this.availableToOtherTenants, applicationBase.availableToOtherTenants) &&
        Objects.equals(this.errorUrl, applicationBase.errorUrl) &&
        Objects.equals(this.groupMembershipClaims, applicationBase.groupMembershipClaims) &&
        Objects.equals(this.homepage, applicationBase.homepage) &&
        Objects.equals(this.informationalUrls, applicationBase.informationalUrls) &&
        Objects.equals(this.isDeviceOnlyAuthSupported, applicationBase.isDeviceOnlyAuthSupported) &&
        Objects.equals(this.keyCredentials, applicationBase.keyCredentials) &&
        Objects.equals(this.knownClientApplications, applicationBase.knownClientApplications) &&
        Objects.equals(this.logoutUrl, applicationBase.logoutUrl) &&
        Objects.equals(this.oauth2AllowImplicitFlow, applicationBase.oauth2AllowImplicitFlow) &&
        Objects.equals(this.oauth2AllowUrlPathMatching, applicationBase.oauth2AllowUrlPathMatching) &&
        Objects.equals(this.oauth2Permissions, applicationBase.oauth2Permissions) &&
        Objects.equals(this.oauth2RequirePostResponse, applicationBase.oauth2RequirePostResponse) &&
        Objects.equals(this.optionalClaims, applicationBase.optionalClaims) &&
        Objects.equals(this.orgRestrictions, applicationBase.orgRestrictions) &&
        Objects.equals(this.passwordCredentials, applicationBase.passwordCredentials) &&
        Objects.equals(this.preAuthorizedApplications, applicationBase.preAuthorizedApplications) &&
        Objects.equals(this.publicClient, applicationBase.publicClient) &&
        Objects.equals(this.publisherDomain, applicationBase.publisherDomain) &&
        Objects.equals(this.replyUrls, applicationBase.replyUrls) &&
        Objects.equals(this.requiredResourceAccess, applicationBase.requiredResourceAccess) &&
        Objects.equals(this.samlMetadataUrl, applicationBase.samlMetadataUrl) &&
        Objects.equals(this.signInAudience, applicationBase.signInAudience) &&
        Objects.equals(this.wwwHomepage, applicationBase.wwwHomepage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowGuestsSignIn, allowPassthroughUsers, appLogoUrl, appPermissions, appRoles, availableToOtherTenants, errorUrl, groupMembershipClaims, homepage, informationalUrls, isDeviceOnlyAuthSupported, keyCredentials, knownClientApplications, logoutUrl, oauth2AllowImplicitFlow, oauth2AllowUrlPathMatching, oauth2Permissions, oauth2RequirePostResponse, optionalClaims, orgRestrictions, passwordCredentials, preAuthorizedApplications, publicClient, publisherDomain, replyUrls, requiredResourceAccess, samlMetadataUrl, signInAudience, wwwHomepage);
  }
