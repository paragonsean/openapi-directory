...
public class ServicePrincipalCreateParameters {
  ...
  public ServicePrincipalCreateParameters appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public ServicePrincipalCreateParameters accountEnabled(Boolean accountEnabled) {
  ...
  public ServicePrincipalCreateParameters appRoleAssignmentRequired(Boolean appRoleAssignmentRequired) {
  ...
  public ServicePrincipalCreateParameters keyCredentials(List<KeyCredential> keyCredentials) {
    this.keyCredentials = keyCredentials;
    return this;
  }

  public ServicePrincipalCreateParameters addKeyCredentialsItem(KeyCredential keyCredentialsItem) {
  ...
  public ServicePrincipalCreateParameters passwordCredentials(List<PasswordCredential> passwordCredentials) {
    this.passwordCredentials = passwordCredentials;
    return this;
  }

  public ServicePrincipalCreateParameters addPasswordCredentialsItem(PasswordCredential passwordCredentialsItem) {
  ...
  public ServicePrincipalCreateParameters servicePrincipalType(String servicePrincipalType) {
  ...
  public ServicePrincipalCreateParameters tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ServicePrincipalCreateParameters addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    ServicePrincipalCreateParameters servicePrincipalCreateParameters = (ServicePrincipalCreateParameters) o;
    return Objects.equals(this.appId, servicePrincipalCreateParameters.appId) &&
        Objects.equals(this.accountEnabled, servicePrincipalCreateParameters.accountEnabled) &&
        Objects.equals(this.appRoleAssignmentRequired, servicePrincipalCreateParameters.appRoleAssignmentRequired) &&
        Objects.equals(this.keyCredentials, servicePrincipalCreateParameters.keyCredentials) &&
        Objects.equals(this.passwordCredentials, servicePrincipalCreateParameters.passwordCredentials) &&
        Objects.equals(this.servicePrincipalType, servicePrincipalCreateParameters.servicePrincipalType) &&
        Objects.equals(this.tags, servicePrincipalCreateParameters.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appId, accountEnabled, appRoleAssignmentRequired, keyCredentials, passwordCredentials, servicePrincipalType, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServicePrincipalCreateParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServicePrincipalCreateParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServicePrincipalCreateParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServicePrincipalCreateParameters is not found in the empty JSON string", ServicePrincipalCreateParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServicePrincipalCreateParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServicePrincipalCreateParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServicePrincipalCreateParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServicePrincipalCreateParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServicePrincipalCreateParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServicePrincipalCreateParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServicePrincipalCreateParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ServicePrincipalCreateParameters>() {
           @Override
           public void write(JsonWriter out, ServicePrincipalCreateParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServicePrincipalCreateParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServicePrincipalCreateParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServicePrincipalCreateParameters
   * @throws IOException if the JSON string is invalid with respect to ServicePrincipalCreateParameters
   */
  public static ServicePrincipalCreateParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServicePrincipalCreateParameters.class);
  }

  /**
   * Convert an instance of ServicePrincipalCreateParameters to an JSON string
   *
   * @return JSON string
   */
