...
public class ServicePrincipalBase {
  ...
  public ServicePrincipalBase accountEnabled(Boolean accountEnabled) {
  ...
  public ServicePrincipalBase appRoleAssignmentRequired(Boolean appRoleAssignmentRequired) {
  ...
  public ServicePrincipalBase keyCredentials(List<KeyCredential> keyCredentials) {
    this.keyCredentials = keyCredentials;
    return this;
  }

  public ServicePrincipalBase addKeyCredentialsItem(KeyCredential keyCredentialsItem) {
  ...
  public ServicePrincipalBase passwordCredentials(List<PasswordCredential> passwordCredentials) {
    this.passwordCredentials = passwordCredentials;
    return this;
  }

  public ServicePrincipalBase addPasswordCredentialsItem(PasswordCredential passwordCredentialsItem) {
  ...
  public ServicePrincipalBase servicePrincipalType(String servicePrincipalType) {
  ...
  public ServicePrincipalBase tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ServicePrincipalBase addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    ServicePrincipalBase servicePrincipalBase = (ServicePrincipalBase) o;
    return Objects.equals(this.accountEnabled, servicePrincipalBase.accountEnabled) &&
        Objects.equals(this.appRoleAssignmentRequired, servicePrincipalBase.appRoleAssignmentRequired) &&
        Objects.equals(this.keyCredentials, servicePrincipalBase.keyCredentials) &&
        Objects.equals(this.passwordCredentials, servicePrincipalBase.passwordCredentials) &&
        Objects.equals(this.servicePrincipalType, servicePrincipalBase.servicePrincipalType) &&
        Objects.equals(this.tags, servicePrincipalBase.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServicePrincipalBase {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServicePrincipalBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServicePrincipalBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServicePrincipalBase is not found in the empty JSON string", ServicePrincipalBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServicePrincipalBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServicePrincipalBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServicePrincipalBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServicePrincipalBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServicePrincipalBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServicePrincipalBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ServicePrincipalBase>() {
           @Override
           public void write(JsonWriter out, ServicePrincipalBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServicePrincipalBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServicePrincipalBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServicePrincipalBase
   * @throws IOException if the JSON string is invalid with respect to ServicePrincipalBase
   */
  public static ServicePrincipalBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServicePrincipalBase.class);
  }

  /**
   * Convert an instance of ServicePrincipalBase to an JSON string
   *
   * @return JSON string
   */
