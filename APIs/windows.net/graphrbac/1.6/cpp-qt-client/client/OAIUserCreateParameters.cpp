...
bool OAIUserCreateParameters::isAccountEnabled() const {
    return m_account_enabled;
}
void OAIUserCreateParameters::setAccountEnabled(const bool &account_enabled) {
    m_account_enabled = account_enabled;
    m_account_enabled_isSet = true;
}

bool OAIUserCreateParameters::is_account_enabled_Set() const{
    return m_account_enabled_isSet;
}

bool OAIUserCreateParameters::is_account_enabled_Valid() const{
    return m_account_enabled_isValid;
}

QString OAIUserCreateParameters::getDisplayName() const {
    return m_display_name;
}
void OAIUserCreateParameters::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIUserCreateParameters::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIUserCreateParameters::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAIUserCreateParameters::getMail() const {
    return m_mail;
}
void OAIUserCreateParameters::setMail(const QString &mail) {
    m_mail = mail;
    m_mail_isSet = true;
}

bool OAIUserCreateParameters::is_mail_Set() const{
    return m_mail_isSet;
}

bool OAIUserCreateParameters::is_mail_Valid() const{
    return m_mail_isValid;
}

QString OAIUserCreateParameters::getMailNickname() const {
    return m_mail_nickname;
}
void OAIUserCreateParameters::setMailNickname(const QString &mail_nickname) {
    m_mail_nickname = mail_nickname;
    m_mail_nickname_isSet = true;
}

bool OAIUserCreateParameters::is_mail_nickname_Set() const{
    return m_mail_nickname_isSet;
}

bool OAIUserCreateParameters::is_mail_nickname_Valid() const{
    return m_mail_nickname_isValid;
}

OAIPasswordProfile OAIUserCreateParameters::getPasswordProfile() const {
    return m_password_profile;
}
void OAIUserCreateParameters::setPasswordProfile(const OAIPasswordProfile &password_profile) {
    m_password_profile = password_profile;
    m_password_profile_isSet = true;
}

bool OAIUserCreateParameters::is_password_profile_Set() const{
    return m_password_profile_isSet;
}

bool OAIUserCreateParameters::is_password_profile_Valid() const{
    return m_password_profile_isValid;
}

QString OAIUserCreateParameters::getUserPrincipalName() const {
    return m_user_principal_name;
}
void OAIUserCreateParameters::setUserPrincipalName(const QString &user_principal_name) {
    m_user_principal_name = user_principal_name;
    m_user_principal_name_isSet = true;
}

bool OAIUserCreateParameters::is_user_principal_name_Set() const{
    return m_user_principal_name_isSet;
}

bool OAIUserCreateParameters::is_user_principal_name_Valid() const{
    return m_user_principal_name_isValid;
}

QString OAIUserCreateParameters::getGivenName() const {
    return m_given_name;
}
void OAIUserCreateParameters::setGivenName(const QString &given_name) {
    m_given_name = given_name;
    m_given_name_isSet = true;
}

bool OAIUserCreateParameters::is_given_name_Set() const{
    return m_given_name_isSet;
}

bool OAIUserCreateParameters::is_given_name_Valid() const{
    return m_given_name_isValid;
}

QString OAIUserCreateParameters::getImmutableId() const {
    return m_immutable_id;
}
void OAIUserCreateParameters::setImmutableId(const QString &immutable_id) {
    m_immutable_id = immutable_id;
    m_immutable_id_isSet = true;
}

bool OAIUserCreateParameters::is_immutable_id_Set() const{
    return m_immutable_id_isSet;
}

bool OAIUserCreateParameters::is_immutable_id_Valid() const{
    return m_immutable_id_isValid;
}

QString OAIUserCreateParameters::getSurname() const {
    return m_surname;
}
void OAIUserCreateParameters::setSurname(const QString &surname) {
    m_surname = surname;
    m_surname_isSet = true;
}

bool OAIUserCreateParameters::is_surname_Set() const{
    return m_surname_isSet;
}

bool OAIUserCreateParameters::is_surname_Valid() const{
    return m_surname_isValid;
}

QString OAIUserCreateParameters::getUsageLocation() const {
    return m_usage_location;
}
void OAIUserCreateParameters::setUsageLocation(const QString &usage_location) {
    m_usage_location = usage_location;
    m_usage_location_isSet = true;
}

bool OAIUserCreateParameters::is_usage_location_Set() const{
    return m_usage_location_isSet;
}

bool OAIUserCreateParameters::is_usage_location_Valid() const{
    return m_usage_location_isValid;
}

QString OAIUserCreateParameters::getUserType() const {
    return m_user_type;
}
void OAIUserCreateParameters::setUserType(const QString &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAIUserCreateParameters::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAIUserCreateParameters::is_user_type_Valid() const{
...
bool OAIUserCreateParameters::isValid() const {
    ...
    return m_account_enabled_isValid && m_display_name_isValid && m_mail_nickname_isValid && m_password_profile_isValid && m_user_principal_name_isValid && true;
}
