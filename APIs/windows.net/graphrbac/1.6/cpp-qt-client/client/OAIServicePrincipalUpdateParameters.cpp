...
OAIServicePrincipalUpdateParameters::OAIServicePrincipalUpdateParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServicePrincipalUpdateParameters::OAIServicePrincipalUpdateParameters() {
    this->initializeModel();
}

OAIServicePrincipalUpdateParameters::~OAIServicePrincipalUpdateParameters() {}

void OAIServicePrincipalUpdateParameters::initializeModel() {
...
void OAIServicePrincipalUpdateParameters::fromJson(QString jsonString) {
...
void OAIServicePrincipalUpdateParameters::fromJsonObject(QJsonObject json) {
...
QString OAIServicePrincipalUpdateParameters::asJson() const {
...
QJsonObject OAIServicePrincipalUpdateParameters::asJsonObject() const {
    QJsonObject obj;
...
bool OAIServicePrincipalUpdateParameters::isAccountEnabled() const {
    return m_account_enabled;
}
void OAIServicePrincipalUpdateParameters::setAccountEnabled(const bool &account_enabled) {
    m_account_enabled = account_enabled;
    m_account_enabled_isSet = true;
}

bool OAIServicePrincipalUpdateParameters::is_account_enabled_Set() const{
    return m_account_enabled_isSet;
}

bool OAIServicePrincipalUpdateParameters::is_account_enabled_Valid() const{
    return m_account_enabled_isValid;
}

bool OAIServicePrincipalUpdateParameters::isAppRoleAssignmentRequired() const {
    return m_app_role_assignment_required;
}
void OAIServicePrincipalUpdateParameters::setAppRoleAssignmentRequired(const bool &app_role_assignment_required) {
    m_app_role_assignment_required = app_role_assignment_required;
    m_app_role_assignment_required_isSet = true;
}

bool OAIServicePrincipalUpdateParameters::is_app_role_assignment_required_Set() const{
    return m_app_role_assignment_required_isSet;
}

bool OAIServicePrincipalUpdateParameters::is_app_role_assignment_required_Valid() const{
    return m_app_role_assignment_required_isValid;
}

QList<OAIKeyCredential> OAIServicePrincipalUpdateParameters::getKeyCredentials() const {
    return m_key_credentials;
}
void OAIServicePrincipalUpdateParameters::setKeyCredentials(const QList<OAIKeyCredential> &key_credentials) {
    m_key_credentials = key_credentials;
    m_key_credentials_isSet = true;
}

bool OAIServicePrincipalUpdateParameters::is_key_credentials_Set() const{
    return m_key_credentials_isSet;
}

bool OAIServicePrincipalUpdateParameters::is_key_credentials_Valid() const{
    return m_key_credentials_isValid;
}

QList<OAIPasswordCredential> OAIServicePrincipalUpdateParameters::getPasswordCredentials() const {
    return m_password_credentials;
}
void OAIServicePrincipalUpdateParameters::setPasswordCredentials(const QList<OAIPasswordCredential> &password_credentials) {
    m_password_credentials = password_credentials;
    m_password_credentials_isSet = true;
}

bool OAIServicePrincipalUpdateParameters::is_password_credentials_Set() const{
    return m_password_credentials_isSet;
}

bool OAIServicePrincipalUpdateParameters::is_password_credentials_Valid() const{
    return m_password_credentials_isValid;
}

QString OAIServicePrincipalUpdateParameters::getServicePrincipalType() const {
    return m_service_principal_type;
}
void OAIServicePrincipalUpdateParameters::setServicePrincipalType(const QString &service_principal_type) {
    m_service_principal_type = service_principal_type;
    m_service_principal_type_isSet = true;
}

bool OAIServicePrincipalUpdateParameters::is_service_principal_type_Set() const{
    return m_service_principal_type_isSet;
}

bool OAIServicePrincipalUpdateParameters::is_service_principal_type_Valid() const{
    return m_service_principal_type_isValid;
}

QList<QString> OAIServicePrincipalUpdateParameters::getTags() const {
    return m_tags;
}
void OAIServicePrincipalUpdateParameters::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIServicePrincipalUpdateParameters::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIServicePrincipalUpdateParameters::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIServicePrincipalUpdateParameters::isSet() const {
...
bool OAIServicePrincipalUpdateParameters::isValid() const {
