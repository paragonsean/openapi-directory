...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("apiV1SuggestGet", defaultConf);
    _serverIndices.insert("apiV1SuggestGet", 0);
}
...
void OAIDefaultApi::apiV1SuggestGet(const QString &term) {
    QString fullPath = QString(_serverConfigs["apiV1SuggestGet"][_serverIndices.value("apiV1SuggestGet")].URL()+"/api/v1/suggest");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::apiV1SuggestGetCallback);
...
void OAIDefaultApi::apiV1SuggestGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_api_v1_suggest_get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiV1SuggestGetSignal(output);
        Q_EMIT apiV1SuggestGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiV1SuggestGetSignalE(output, error_type, error_str);
        Q_EMIT apiV1SuggestGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiV1SuggestGetSignalError(output, error_type, error_str);
        Q_EMIT apiV1SuggestGetSignalErrorFull(worker, error_type, error_str);
    }
}
