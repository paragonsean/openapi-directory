...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("postReviewPost", defaultConf);
    _serverIndices.insert("postReviewPost", 0);
}
...
void OAIDefaultApi::postReviewPost(const QString &user_email, const qint32 &rating, const OAI_post_review_post_request &oai_post_review_post_request, const ::OpenAPI::OptionalParam<QString> &user_name) {
    QString fullPath = QString(_serverConfigs["postReviewPost"][_serverIndices.value("postReviewPost")].URL()+"/post-review");
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "user_email", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("user_email")).append(querySuffix).append(QUrl::toPercentEncoding(user_email));
    }
...

    {
        ...
        QByteArray output = oai_post_review_post_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::postReviewPostCallback);
...
void OAIDefaultApi::postReviewPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_post_review_post_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postReviewPostSignal(output);
        Q_EMIT postReviewPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postReviewPostSignalE(output, error_type, error_str);
        Q_EMIT postReviewPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postReviewPostSignalError(output, error_type, error_str);
        Q_EMIT postReviewPostSignalErrorFull(worker, error_type, error_str);
    }
}
