...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestTheExhibitDayApiWithSwagger.SwaggerApi();
  });
  ...
  describe('SwaggerApi', function() {
    describe('swaggerGet', function() {
      it('should call swaggerGet successfully', function(done) {
        //uncomment below and update the code to test swaggerGet
        //instance.swaggerGet(function(error) {
