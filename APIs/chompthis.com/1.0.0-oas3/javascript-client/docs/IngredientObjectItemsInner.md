# ChompFoodDatabaseApiDocumentation.IngredientObjectItemsInner
...
**components** | [**[IngredientObjectItemsInnerComponentsInner]**](IngredientObjectItemsInnerComponentsInner.md) | An array of objects containing the constituent parts of a food (e.g. bone is a component of meat) | [optional] 
...
**nutrients** | [**[IngredientObjectItemsInnerNutrientsInner]**](IngredientObjectItemsInnerNutrientsInner.md) | An array containing nutrient informatio objects for this food item | [optional] 
**portions** | [**[IngredientObjectItemsInnerPortionsInner]**](IngredientObjectItemsInnerPortionsInner.md) | An array of objects containing information on discrete amounts of a food found in this item | [optional] 
**proteinConversionFactor** | **Number** | The multiplication factor used to calculate protein from nitrogen | [optional] 
