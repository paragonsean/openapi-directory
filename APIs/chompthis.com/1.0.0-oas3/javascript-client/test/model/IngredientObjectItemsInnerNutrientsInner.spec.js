...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChompFoodDatabaseApiDocumentation.IngredientObjectItemsInnerNutrientsInner();
  });
  ...
  describe('IngredientObjectItemsInnerNutrientsInner', function() {
    it('should create an instance of IngredientObjectItemsInnerNutrientsInner', function() {
      // uncomment below and update the code to test IngredientObjectItemsInnerNutrientsInner
      //var instance = new ChompFoodDatabaseApiDocumentation.IngredientObjectItemsInnerNutrientsInner();
      //expect(instance).to.be.a(ChompFoodDatabaseApiDocumentation.IngredientObjectItemsInnerNutrientsInner);
    });
