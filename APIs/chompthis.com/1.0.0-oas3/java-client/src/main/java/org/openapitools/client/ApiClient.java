...
public class ApiClient {
    ...
    private String basePath = "https://chompthis.com/api/v2";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.0-oas3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://chompthis.com/api/v2
