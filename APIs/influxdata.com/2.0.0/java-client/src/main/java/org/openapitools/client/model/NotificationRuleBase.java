...
public class NotificationRuleBase {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, notificationRuleBase.createdAt) &&
        ...
        Objects.equals(this.latestCompleted, notificationRuleBase.latestCompleted) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, description, endpointID, every, id, labels, lastRunError, lastRunStatus, latestCompleted, limit, limitEvery, links, name, offset, orgID, ownerID, runbookLink, sleepUntil, status, statusRules, tagRules, taskID, updatedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotificationRuleBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationRuleBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotificationRuleBase is not found in the empty JSON string", NotificationRuleBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotificationRuleBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotificationRuleBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotificationRuleBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotificationRuleBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotificationRuleBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotificationRuleBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotificationRuleBase.class));

       return (TypeAdapter<T>) new TypeAdapter<NotificationRuleBase>() {
           @Override
           public void write(JsonWriter out, NotificationRuleBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotificationRuleBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotificationRuleBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotificationRuleBase
   * @throws IOException if the JSON string is invalid with respect to NotificationRuleBase
   */
  public static NotificationRuleBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotificationRuleBase.class);
  }

  /**
   * Convert an instance of NotificationRuleBase to an JSON string
   *
   * @return JSON string
   */
