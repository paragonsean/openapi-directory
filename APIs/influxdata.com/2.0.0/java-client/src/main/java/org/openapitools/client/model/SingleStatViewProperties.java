...
public class SingleStatViewProperties {
  ...
  public SingleStatViewProperties shape(ShapeEnum shape) {
    this.shape = shape;
    return this;
  }
  ...
  public SingleStatViewProperties type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.colors, singleStatViewProperties.colors) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(colors, decimalPlaces, note, prefix, queries, shape, showNoteWhenEmpty, staticLegend, suffix, tickPrefix, tickSuffix, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SingleStatViewProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SingleStatViewProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SingleStatViewProperties is not found in the empty JSON string", SingleStatViewProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SingleStatViewProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SingleStatViewProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SingleStatViewProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SingleStatViewProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SingleStatViewProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SingleStatViewProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SingleStatViewProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<SingleStatViewProperties>() {
           @Override
           public void write(JsonWriter out, SingleStatViewProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SingleStatViewProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SingleStatViewProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SingleStatViewProperties
   * @throws IOException if the JSON string is invalid with respect to SingleStatViewProperties
   */
  public static SingleStatViewProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SingleStatViewProperties.class);
  }

  /**
   * Convert an instance of SingleStatViewProperties to an JSON string
   *
   * @return JSON string
   */
