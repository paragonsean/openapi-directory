...
public class TemplateSummarySummaryVariablesInner {
  ...
  public TemplateSummarySummaryVariablesInner() {
  }

  public TemplateSummarySummaryVariablesInner arguments(VariableProperties arguments) {
  ...
  public TemplateSummarySummaryVariablesInner description(String description) {
  ...
  public TemplateSummarySummaryVariablesInner envReferences(List<TemplateEnvReferencesInner> envReferences) {
    this.envReferences = envReferences;
    return this;
  }

  public TemplateSummarySummaryVariablesInner addEnvReferencesItem(TemplateEnvReferencesInner envReferencesItem) {
  ...
  public TemplateSummarySummaryVariablesInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public TemplateSummarySummaryVariablesInner kind(TemplateKind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public TemplateSummarySummaryVariablesInner labelAssociations(List<TemplateSummaryLabel> labelAssociations) {
    this.labelAssociations = labelAssociations;
    return this;
  }

  public TemplateSummarySummaryVariablesInner addLabelAssociationsItem(TemplateSummaryLabel labelAssociationsItem) {
  ...
  public TemplateSummarySummaryVariablesInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TemplateSummarySummaryVariablesInner orgID(String orgID) {
    this.orgID = orgID;
    return this;
  }
  ...
  public TemplateSummarySummaryVariablesInner templateMetaName(String templateMetaName) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateSummarySummaryVariablesInner templateSummarySummaryVariablesInner = (TemplateSummarySummaryVariablesInner) o;
    return Objects.equals(this.arguments, templateSummarySummaryVariablesInner.arguments) &&
        Objects.equals(this.description, templateSummarySummaryVariablesInner.description) &&
        Objects.equals(this.envReferences, templateSummarySummaryVariablesInner.envReferences) &&
        Objects.equals(this.id, templateSummarySummaryVariablesInner.id) &&
        Objects.equals(this.kind, templateSummarySummaryVariablesInner.kind) &&
        Objects.equals(this.labelAssociations, templateSummarySummaryVariablesInner.labelAssociations) &&
        Objects.equals(this.name, templateSummarySummaryVariablesInner.name) &&
        Objects.equals(this.orgID, templateSummarySummaryVariablesInner.orgID) &&
        Objects.equals(this.templateMetaName, templateSummarySummaryVariablesInner.templateMetaName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arguments, description, envReferences, id, kind, labelAssociations, name, orgID, templateMetaName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TemplateSummarySummaryVariablesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateSummarySummaryVariablesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateSummarySummaryVariablesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateSummarySummaryVariablesInner is not found in the empty JSON string", TemplateSummarySummaryVariablesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateSummarySummaryVariablesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateSummarySummaryVariablesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateSummarySummaryVariablesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateSummarySummaryVariablesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateSummarySummaryVariablesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateSummarySummaryVariablesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateSummarySummaryVariablesInner>() {
           @Override
           public void write(JsonWriter out, TemplateSummarySummaryVariablesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateSummarySummaryVariablesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateSummarySummaryVariablesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateSummarySummaryVariablesInner
   * @throws IOException if the JSON string is invalid with respect to TemplateSummarySummaryVariablesInner
   */
  public static TemplateSummarySummaryVariablesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateSummarySummaryVariablesInner.class);
  }

  /**
   * Convert an instance of TemplateSummarySummaryVariablesInner to an JSON string
   *
   * @return JSON string
   */
