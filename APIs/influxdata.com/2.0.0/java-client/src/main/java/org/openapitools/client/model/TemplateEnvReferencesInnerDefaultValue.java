...
public class TemplateEnvReferencesInnerDefaultValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TemplateEnvReferencesInnerDefaultValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TemplateEnvReferencesInnerDefaultValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TemplateEnvReferencesInnerDefaultValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TemplateEnvReferencesInnerDefaultValue>() {
                @Override
                public void write(JsonWriter out, TemplateEnvReferencesInnerDefaultValue value) throws IOException {
                ...
                @Override
                public TemplateEnvReferencesInnerDefaultValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TemplateEnvReferencesInnerDefaultValue ret = new TemplateEnvReferencesInnerDefaultValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for TemplateEnvReferencesInnerDefaultValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TemplateEnvReferencesInnerDefaultValue() {
        super("oneOf", Boolean.TRUE);
    }

    public TemplateEnvReferencesInnerDefaultValue(Object o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TemplateEnvReferencesInnerDefaultValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TemplateEnvReferencesInnerDefaultValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for TemplateEnvReferencesInnerDefaultValue with oneOf schemas: BigDecimal, Boolean, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TemplateEnvReferencesInnerDefaultValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TemplateEnvReferencesInnerDefaultValue
     * @throws IOException if the JSON string is invalid with respect to TemplateEnvReferencesInnerDefaultValue
     */
    public static TemplateEnvReferencesInnerDefaultValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TemplateEnvReferencesInnerDefaultValue.class);
    }

    /**
     * Convert an instance of TemplateEnvReferencesInnerDefaultValue to an JSON string
     *
     * @return JSON string
     */
