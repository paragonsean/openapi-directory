...
public class TelegramNotificationRule {
  ...
  public TelegramNotificationRule() {
  }
  ...
  public TelegramNotificationRule description(String description) {
  ...
  public TelegramNotificationRule endpointID(String endpointID) {
  ...
  public TelegramNotificationRule every(String every) {
    this.every = every;
    return this;
  }
  ...
  public TelegramNotificationRule labels(List<Label> labels) {
    this.labels = labels;
    return this;
  }

  public TelegramNotificationRule addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  public TelegramNotificationRule limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public TelegramNotificationRule limitEvery(Integer limitEvery) {
  ...
  public TelegramNotificationRule links(NotificationRuleBaseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public TelegramNotificationRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TelegramNotificationRule offset(String offset) {
    this.offset = offset;
    return this;
  }
  ...
  public TelegramNotificationRule orgID(String orgID) {
    this.orgID = orgID;
    return this;
  }
  ...
  public TelegramNotificationRule runbookLink(String runbookLink) {
  ...
  public TelegramNotificationRule sleepUntil(String sleepUntil) {
  ...
  public TelegramNotificationRule status(TaskStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public TelegramNotificationRule statusRules(List<StatusRule> statusRules) {
    this.statusRules = statusRules;
    return this;
  }

  public TelegramNotificationRule addStatusRulesItem(StatusRule statusRulesItem) {
  ...
  public TelegramNotificationRule tagRules(List<TagRule> tagRules) {
    this.tagRules = tagRules;
    return this;
  }

  public TelegramNotificationRule addTagRulesItem(TagRule tagRulesItem) {
  ...
  public TelegramNotificationRule taskID(String taskID) {
    this.taskID = taskID;
    return this;
  }
  ...
  public TelegramNotificationRule disableWebPagePreview(Boolean disableWebPagePreview) {
  ...
  public TelegramNotificationRule messageTemplate(String messageTemplate) {
  ...
  public TelegramNotificationRule parseMode(ParseModeEnum parseMode) {
  ...
  public TelegramNotificationRule type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TelegramNotificationRule telegramNotificationRule = (TelegramNotificationRule) o;
    return Objects.equals(this.createdAt, telegramNotificationRule.createdAt) &&
        Objects.equals(this.description, telegramNotificationRule.description) &&
        Objects.equals(this.endpointID, telegramNotificationRule.endpointID) &&
        Objects.equals(this.every, telegramNotificationRule.every) &&
        Objects.equals(this.id, telegramNotificationRule.id) &&
        Objects.equals(this.labels, telegramNotificationRule.labels) &&
        Objects.equals(this.lastRunError, telegramNotificationRule.lastRunError) &&
        Objects.equals(this.lastRunStatus, telegramNotificationRule.lastRunStatus) &&
        Objects.equals(this.latestCompleted, telegramNotificationRule.latestCompleted) &&
        Objects.equals(this.limit, telegramNotificationRule.limit) &&
        Objects.equals(this.limitEvery, telegramNotificationRule.limitEvery) &&
        Objects.equals(this.links, telegramNotificationRule.links) &&
        Objects.equals(this.name, telegramNotificationRule.name) &&
        Objects.equals(this.offset, telegramNotificationRule.offset) &&
        Objects.equals(this.orgID, telegramNotificationRule.orgID) &&
        Objects.equals(this.ownerID, telegramNotificationRule.ownerID) &&
        Objects.equals(this.runbookLink, telegramNotificationRule.runbookLink) &&
        Objects.equals(this.sleepUntil, telegramNotificationRule.sleepUntil) &&
        Objects.equals(this.status, telegramNotificationRule.status) &&
        Objects.equals(this.statusRules, telegramNotificationRule.statusRules) &&
        Objects.equals(this.tagRules, telegramNotificationRule.tagRules) &&
        Objects.equals(this.taskID, telegramNotificationRule.taskID) &&
        Objects.equals(this.updatedAt, telegramNotificationRule.updatedAt) &&
        Objects.equals(this.disableWebPagePreview, telegramNotificationRule.disableWebPagePreview) &&
        Objects.equals(this.messageTemplate, telegramNotificationRule.messageTemplate) &&
        Objects.equals(this.parseMode, telegramNotificationRule.parseMode) &&
        Objects.equals(this.type, telegramNotificationRule.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, description, endpointID, every, id, labels, lastRunError, lastRunStatus, latestCompleted, limit, limitEvery, links, name, offset, orgID, ownerID, runbookLink, sleepUntil, status, statusRules, tagRules, taskID, updatedAt, disableWebPagePreview, messageTemplate, parseMode, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TelegramNotificationRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TelegramNotificationRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TelegramNotificationRule is not found in the empty JSON string", TelegramNotificationRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TelegramNotificationRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TelegramNotificationRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TelegramNotificationRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TelegramNotificationRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TelegramNotificationRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TelegramNotificationRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TelegramNotificationRule.class));

       return (TypeAdapter<T>) new TypeAdapter<TelegramNotificationRule>() {
           @Override
           public void write(JsonWriter out, TelegramNotificationRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TelegramNotificationRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TelegramNotificationRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TelegramNotificationRule
   * @throws IOException if the JSON string is invalid with respect to TelegramNotificationRule
   */
  public static TelegramNotificationRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TelegramNotificationRule.class);
  }

  /**
   * Convert an instance of TelegramNotificationRule to an JSON string
   *
   * @return JSON string
   */
