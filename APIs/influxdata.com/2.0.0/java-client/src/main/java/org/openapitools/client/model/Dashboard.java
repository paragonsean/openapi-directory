...
public class Dashboard {
  ...
  public Dashboard orgID(String orgID) {
    this.orgID = orgID;
    return this;
  }
  ...
  public Dashboard links(DashboardAllOfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Dashboard meta(DashboardAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, dashboard.description) &&
        ...
        Objects.equals(this.orgID, dashboard.orgID) &&
      ...
      if (jsonObj.get("cells") != null && !jsonObj.get("cells").isJsonNull()) {
        ...
        if (jsonArraycells != null) {
          ...
          for (int i = 0; i < jsonArraycells.size(); i++) {
            Cell.validateJsonElement(jsonArraycells.get(i));
          };
        }
      }
