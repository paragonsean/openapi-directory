...
public class Query {
  ...
  public Query extern(ModelFile extern) {
    this.extern = extern;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ModelFile getExtern() {
    return extern;
  }

  public void setExtern(ModelFile extern) {
    this.extern = extern;
  }
  ...
  public boolean equals(Object o) {
    ...
    Query query = (Query) o;
    return Objects.equals(this.dialect, query.dialect) &&
        Objects.equals(this.extern, query.extern) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dialect, extern, now, params, query, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("dialect") != null && !jsonObj.get("dialect").isJsonNull()) {
        Dialect.validateJsonElement(jsonObj.get("dialect"));
      }
      // validate the optional field `extern`
      if (jsonObj.get("extern") != null && !jsonObj.get("extern").isJsonNull()) {
        ModelFile.validateJsonElement(jsonObj.get("extern"));
      }
