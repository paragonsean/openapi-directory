...
public class SlackNotificationRule {
  ...
  public SlackNotificationRule description(String description) {
  ...
  public SlackNotificationRule endpointID(String endpointID) {
  ...
  public SlackNotificationRule every(String every) {
    this.every = every;
    return this;
  }
  ...
  public SlackNotificationRule labels(List<Label> labels) {
    this.labels = labels;
    return this;
  }

  public SlackNotificationRule addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  public SlackNotificationRule limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public SlackNotificationRule limitEvery(Integer limitEvery) {
  ...
  public SlackNotificationRule links(NotificationRuleBaseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public SlackNotificationRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SlackNotificationRule offset(String offset) {
    this.offset = offset;
    return this;
  }
  ...
  public SlackNotificationRule orgID(String orgID) {
    this.orgID = orgID;
    return this;
  }
  ...
  public SlackNotificationRule runbookLink(String runbookLink) {
  ...
  public SlackNotificationRule sleepUntil(String sleepUntil) {
  ...
  public SlackNotificationRule status(TaskStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public SlackNotificationRule statusRules(List<StatusRule> statusRules) {
    this.statusRules = statusRules;
    return this;
  }

  public SlackNotificationRule addStatusRulesItem(StatusRule statusRulesItem) {
  ...
  public SlackNotificationRule tagRules(List<TagRule> tagRules) {
    this.tagRules = tagRules;
    return this;
  }

  public SlackNotificationRule addTagRulesItem(TagRule tagRulesItem) {
  ...
  public SlackNotificationRule taskID(String taskID) {
    this.taskID = taskID;
    return this;
  }
  ...
  public SlackNotificationRule type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, slackNotificationRule.createdAt) &&
        Objects.equals(this.description, slackNotificationRule.description) &&
        Objects.equals(this.endpointID, slackNotificationRule.endpointID) &&
        Objects.equals(this.every, slackNotificationRule.every) &&
        Objects.equals(this.id, slackNotificationRule.id) &&
        Objects.equals(this.labels, slackNotificationRule.labels) &&
        Objects.equals(this.lastRunError, slackNotificationRule.lastRunError) &&
        Objects.equals(this.lastRunStatus, slackNotificationRule.lastRunStatus) &&
        Objects.equals(this.latestCompleted, slackNotificationRule.latestCompleted) &&
        Objects.equals(this.limit, slackNotificationRule.limit) &&
        Objects.equals(this.limitEvery, slackNotificationRule.limitEvery) &&
        Objects.equals(this.links, slackNotificationRule.links) &&
        Objects.equals(this.name, slackNotificationRule.name) &&
        Objects.equals(this.offset, slackNotificationRule.offset) &&
        Objects.equals(this.orgID, slackNotificationRule.orgID) &&
        Objects.equals(this.ownerID, slackNotificationRule.ownerID) &&
        Objects.equals(this.runbookLink, slackNotificationRule.runbookLink) &&
        Objects.equals(this.sleepUntil, slackNotificationRule.sleepUntil) &&
        Objects.equals(this.status, slackNotificationRule.status) &&
        Objects.equals(this.statusRules, slackNotificationRule.statusRules) &&
        Objects.equals(this.tagRules, slackNotificationRule.tagRules) &&
        Objects.equals(this.taskID, slackNotificationRule.taskID) &&
        Objects.equals(this.updatedAt, slackNotificationRule.updatedAt) &&
        ...
        Objects.equals(this.type, slackNotificationRule.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, description, endpointID, every, id, labels, lastRunError, lastRunStatus, latestCompleted, limit, limitEvery, links, name, offset, orgID, ownerID, runbookLink, sleepUntil, status, statusRules, tagRules, taskID, updatedAt, channel, messageTemplate, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SlackNotificationRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SlackNotificationRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SlackNotificationRule is not found in the empty JSON string", SlackNotificationRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SlackNotificationRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SlackNotificationRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SlackNotificationRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SlackNotificationRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SlackNotificationRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SlackNotificationRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SlackNotificationRule.class));

       return (TypeAdapter<T>) new TypeAdapter<SlackNotificationRule>() {
           @Override
           public void write(JsonWriter out, SlackNotificationRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SlackNotificationRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SlackNotificationRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SlackNotificationRule
   * @throws IOException if the JSON string is invalid with respect to SlackNotificationRule
   */
  public static SlackNotificationRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SlackNotificationRule.class);
  }

  /**
   * Convert an instance of SlackNotificationRule to an JSON string
   *
   * @return JSON string
   */
