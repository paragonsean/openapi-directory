...
public class HTTPNotificationRule {
  ...
  public HTTPNotificationRule description(String description) {
  ...
  public HTTPNotificationRule endpointID(String endpointID) {
  ...
  public HTTPNotificationRule every(String every) {
    this.every = every;
    return this;
  }
  ...
  public HTTPNotificationRule labels(List<Label> labels) {
    this.labels = labels;
    return this;
  }

  public HTTPNotificationRule addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  public HTTPNotificationRule limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public HTTPNotificationRule limitEvery(Integer limitEvery) {
  ...
  public HTTPNotificationRule links(NotificationRuleBaseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public HTTPNotificationRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public HTTPNotificationRule offset(String offset) {
    this.offset = offset;
    return this;
  }
  ...
  public HTTPNotificationRule orgID(String orgID) {
    this.orgID = orgID;
    return this;
  }
  ...
  public HTTPNotificationRule runbookLink(String runbookLink) {
  ...
  public HTTPNotificationRule sleepUntil(String sleepUntil) {
  ...
  public HTTPNotificationRule status(TaskStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public HTTPNotificationRule statusRules(List<StatusRule> statusRules) {
    this.statusRules = statusRules;
    return this;
  }

  public HTTPNotificationRule addStatusRulesItem(StatusRule statusRulesItem) {
  ...
  public HTTPNotificationRule tagRules(List<TagRule> tagRules) {
    this.tagRules = tagRules;
    return this;
  }

  public HTTPNotificationRule addTagRulesItem(TagRule tagRulesItem) {
  ...
  public HTTPNotificationRule taskID(String taskID) {
    this.taskID = taskID;
    return this;
  }
  ...
  public HTTPNotificationRule type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public HTTPNotificationRule url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    HTTPNotificationRule htTPNotificationRule = (HTTPNotificationRule) o;
    return Objects.equals(this.createdAt, htTPNotificationRule.createdAt) &&
        Objects.equals(this.description, htTPNotificationRule.description) &&
        Objects.equals(this.endpointID, htTPNotificationRule.endpointID) &&
        Objects.equals(this.every, htTPNotificationRule.every) &&
        Objects.equals(this.id, htTPNotificationRule.id) &&
        Objects.equals(this.labels, htTPNotificationRule.labels) &&
        Objects.equals(this.lastRunError, htTPNotificationRule.lastRunError) &&
        Objects.equals(this.lastRunStatus, htTPNotificationRule.lastRunStatus) &&
        Objects.equals(this.latestCompleted, htTPNotificationRule.latestCompleted) &&
        Objects.equals(this.limit, htTPNotificationRule.limit) &&
        Objects.equals(this.limitEvery, htTPNotificationRule.limitEvery) &&
        Objects.equals(this.links, htTPNotificationRule.links) &&
        Objects.equals(this.name, htTPNotificationRule.name) &&
        Objects.equals(this.offset, htTPNotificationRule.offset) &&
        Objects.equals(this.orgID, htTPNotificationRule.orgID) &&
        Objects.equals(this.ownerID, htTPNotificationRule.ownerID) &&
        Objects.equals(this.runbookLink, htTPNotificationRule.runbookLink) &&
        Objects.equals(this.sleepUntil, htTPNotificationRule.sleepUntil) &&
        Objects.equals(this.status, htTPNotificationRule.status) &&
        Objects.equals(this.statusRules, htTPNotificationRule.statusRules) &&
        Objects.equals(this.tagRules, htTPNotificationRule.tagRules) &&
        Objects.equals(this.taskID, htTPNotificationRule.taskID) &&
        Objects.equals(this.updatedAt, htTPNotificationRule.updatedAt) &&
        Objects.equals(this.type, htTPNotificationRule.type) &&
        Objects.equals(this.url, htTPNotificationRule.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, description, endpointID, every, id, labels, lastRunError, lastRunStatus, latestCompleted, limit, limitEvery, links, name, offset, orgID, ownerID, runbookLink, sleepUntil, status, statusRules, tagRules, taskID, updatedAt, type, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HTTPNotificationRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HTTPNotificationRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HTTPNotificationRule is not found in the empty JSON string", HTTPNotificationRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HTTPNotificationRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HTTPNotificationRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HTTPNotificationRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HTTPNotificationRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HTTPNotificationRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HTTPNotificationRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HTTPNotificationRule.class));

       return (TypeAdapter<T>) new TypeAdapter<HTTPNotificationRule>() {
           @Override
           public void write(JsonWriter out, HTTPNotificationRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HTTPNotificationRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HTTPNotificationRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HTTPNotificationRule
   * @throws IOException if the JSON string is invalid with respect to HTTPNotificationRule
   */
  public static HTTPNotificationRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HTTPNotificationRule.class);
  }

  /**
   * Convert an instance of HTTPNotificationRule to an JSON string
   *
   * @return JSON string
   */
