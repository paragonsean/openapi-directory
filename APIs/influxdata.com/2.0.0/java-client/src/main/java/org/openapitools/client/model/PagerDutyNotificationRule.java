...
public class PagerDutyNotificationRule {
  ...
  public PagerDutyNotificationRule() {
  }
  ...
  public PagerDutyNotificationRule description(String description) {
  ...
  public PagerDutyNotificationRule endpointID(String endpointID) {
  ...
  public PagerDutyNotificationRule every(String every) {
    this.every = every;
    return this;
  }
  ...
  public PagerDutyNotificationRule labels(List<Label> labels) {
    this.labels = labels;
    return this;
  }

  public PagerDutyNotificationRule addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  public PagerDutyNotificationRule limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PagerDutyNotificationRule limitEvery(Integer limitEvery) {
  ...
  public PagerDutyNotificationRule links(NotificationRuleBaseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PagerDutyNotificationRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PagerDutyNotificationRule offset(String offset) {
    this.offset = offset;
    return this;
  }
  ...
  public PagerDutyNotificationRule orgID(String orgID) {
    this.orgID = orgID;
    return this;
  }
  ...
  public PagerDutyNotificationRule runbookLink(String runbookLink) {
  ...
  public PagerDutyNotificationRule sleepUntil(String sleepUntil) {
  ...
  public PagerDutyNotificationRule status(TaskStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public PagerDutyNotificationRule statusRules(List<StatusRule> statusRules) {
    this.statusRules = statusRules;
    return this;
  }

  public PagerDutyNotificationRule addStatusRulesItem(StatusRule statusRulesItem) {
  ...
  public PagerDutyNotificationRule tagRules(List<TagRule> tagRules) {
    this.tagRules = tagRules;
    return this;
  }

  public PagerDutyNotificationRule addTagRulesItem(TagRule tagRulesItem) {
  ...
  public PagerDutyNotificationRule taskID(String taskID) {
    this.taskID = taskID;
    return this;
  }
  ...
  public PagerDutyNotificationRule type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, pagerDutyNotificationRule.createdAt) &&
        Objects.equals(this.description, pagerDutyNotificationRule.description) &&
        Objects.equals(this.endpointID, pagerDutyNotificationRule.endpointID) &&
        Objects.equals(this.every, pagerDutyNotificationRule.every) &&
        Objects.equals(this.id, pagerDutyNotificationRule.id) &&
        Objects.equals(this.labels, pagerDutyNotificationRule.labels) &&
        Objects.equals(this.lastRunError, pagerDutyNotificationRule.lastRunError) &&
        Objects.equals(this.lastRunStatus, pagerDutyNotificationRule.lastRunStatus) &&
        Objects.equals(this.latestCompleted, pagerDutyNotificationRule.latestCompleted) &&
        Objects.equals(this.limit, pagerDutyNotificationRule.limit) &&
        Objects.equals(this.limitEvery, pagerDutyNotificationRule.limitEvery) &&
        Objects.equals(this.links, pagerDutyNotificationRule.links) &&
        Objects.equals(this.name, pagerDutyNotificationRule.name) &&
        Objects.equals(this.offset, pagerDutyNotificationRule.offset) &&
        Objects.equals(this.orgID, pagerDutyNotificationRule.orgID) &&
        Objects.equals(this.ownerID, pagerDutyNotificationRule.ownerID) &&
        Objects.equals(this.runbookLink, pagerDutyNotificationRule.runbookLink) &&
        Objects.equals(this.sleepUntil, pagerDutyNotificationRule.sleepUntil) &&
        Objects.equals(this.status, pagerDutyNotificationRule.status) &&
        Objects.equals(this.statusRules, pagerDutyNotificationRule.statusRules) &&
        Objects.equals(this.tagRules, pagerDutyNotificationRule.tagRules) &&
        Objects.equals(this.taskID, pagerDutyNotificationRule.taskID) &&
        Objects.equals(this.updatedAt, pagerDutyNotificationRule.updatedAt) &&
        Objects.equals(this.messageTemplate, pagerDutyNotificationRule.messageTemplate) &&
        Objects.equals(this.type, pagerDutyNotificationRule.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, description, endpointID, every, id, labels, lastRunError, lastRunStatus, latestCompleted, limit, limitEvery, links, name, offset, orgID, ownerID, runbookLink, sleepUntil, status, statusRules, tagRules, taskID, updatedAt, messageTemplate, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PagerDutyNotificationRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PagerDutyNotificationRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagerDutyNotificationRule is not found in the empty JSON string", PagerDutyNotificationRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PagerDutyNotificationRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagerDutyNotificationRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagerDutyNotificationRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagerDutyNotificationRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagerDutyNotificationRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagerDutyNotificationRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagerDutyNotificationRule.class));

       return (TypeAdapter<T>) new TypeAdapter<PagerDutyNotificationRule>() {
           @Override
           public void write(JsonWriter out, PagerDutyNotificationRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PagerDutyNotificationRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PagerDutyNotificationRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PagerDutyNotificationRule
   * @throws IOException if the JSON string is invalid with respect to PagerDutyNotificationRule
   */
  public static PagerDutyNotificationRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagerDutyNotificationRule.class);
  }

  /**
   * Convert an instance of PagerDutyNotificationRule to an JSON string
   *
   * @return JSON string
   */
