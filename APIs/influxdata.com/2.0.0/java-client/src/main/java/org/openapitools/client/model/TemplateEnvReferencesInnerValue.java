...
public class TemplateEnvReferencesInnerValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TemplateEnvReferencesInnerValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TemplateEnvReferencesInnerValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TemplateEnvReferencesInnerValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TemplateEnvReferencesInnerValue>() {
                @Override
                public void write(JsonWriter out, TemplateEnvReferencesInnerValue value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: BigDecimal, Boolean, Integer, String");
                }

                @Override
                public TemplateEnvReferencesInnerValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TemplateEnvReferencesInnerValue ret = new TemplateEnvReferencesInnerValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for TemplateEnvReferencesInnerValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TemplateEnvReferencesInnerValue() {
        super("oneOf", Boolean.TRUE);
    }

    public TemplateEnvReferencesInnerValue(Object o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TemplateEnvReferencesInnerValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TemplateEnvReferencesInnerValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for TemplateEnvReferencesInnerValue with oneOf schemas: BigDecimal, Boolean, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TemplateEnvReferencesInnerValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TemplateEnvReferencesInnerValue
     * @throws IOException if the JSON string is invalid with respect to TemplateEnvReferencesInnerValue
     */
    public static TemplateEnvReferencesInnerValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TemplateEnvReferencesInnerValue.class);
    }

    /**
     * Convert an instance of TemplateEnvReferencesInnerValue to an JSON string
     *
     * @return JSON string
     */
