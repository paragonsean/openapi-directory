...
public class TemplateApplyEnvRefsValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TemplateApplyEnvRefsValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TemplateApplyEnvRefsValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TemplateApplyEnvRefsValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TemplateApplyEnvRefsValue>() {
                @Override
                public void write(JsonWriter out, TemplateApplyEnvRefsValue value) throws IOException {
                ...
                @Override
                public TemplateApplyEnvRefsValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TemplateApplyEnvRefsValue ret = new TemplateApplyEnvRefsValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for TemplateApplyEnvRefsValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TemplateApplyEnvRefsValue() {
        super("oneOf", Boolean.FALSE);
    }

    public TemplateApplyEnvRefsValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TemplateApplyEnvRefsValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TemplateApplyEnvRefsValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for TemplateApplyEnvRefsValue with oneOf schemas: BigDecimal, Boolean, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TemplateApplyEnvRefsValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TemplateApplyEnvRefsValue
     * @throws IOException if the JSON string is invalid with respect to TemplateApplyEnvRefsValue
     */
    public static TemplateApplyEnvRefsValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TemplateApplyEnvRefsValue.class);
    }

    /**
     * Convert an instance of TemplateApplyEnvRefsValue to an JSON string
     *
     * @return JSON string
     */
