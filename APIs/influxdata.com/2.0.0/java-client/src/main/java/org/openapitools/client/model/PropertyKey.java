...
public class PropertyKey extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PropertyKey.class.getName());
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<PropertyKey>() {
                ...
                public void write(JsonWriter out, PropertyKey value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: Identifier, StringLiteral");
                }
                ...
                public PropertyKey read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        PropertyKey ret = new PropertyKey();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for PropertyKey: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Identifier, StringLiteral");
    }
     ...
     * Identifier, StringLiteral
     *
     * @return The actual instance (Identifier, StringLiteral)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for PropertyKey with oneOf schemas: Identifier, StringLiteral. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
