...
import org.openapitools.client.model.ViewLinks;
...
public class View {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, view.id) &&
        Objects.equals(this.links, view.links) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, links, name, properties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        ViewLinks.validateJsonElement(jsonObj.get("links"));
      }
