...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.Organization();
  });
  ...
  describe('Organization', function() {
    it('should create an instance of Organization', function() {
      ...
      //var instance = new InfluxOssApiService.Organization();
      //expect(instance).to.be.a(InfluxOssApiService.Organization);
    });
