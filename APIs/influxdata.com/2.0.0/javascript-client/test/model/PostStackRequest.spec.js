...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.PostStackRequest();
  });
  ...
  describe('PostStackRequest', function() {
    it('should create an instance of PostStackRequest', function() {
      // uncomment below and update the code to test PostStackRequest
      //var instance = new InfluxOssApiService.PostStackRequest();
      //expect(instance).to.be.a(InfluxOssApiService.PostStackRequest);
    });
