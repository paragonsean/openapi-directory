...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.TemplateSummary();
  });
  ...
  describe('TemplateSummary', function() {
    it('should create an instance of TemplateSummary', function() {
      // uncomment below and update the code to test TemplateSummary
      //var instance = new InfluxOssApiService.TemplateSummary();
      //expect(instance).to.be.a(InfluxOssApiService.TemplateSummary);
    });
