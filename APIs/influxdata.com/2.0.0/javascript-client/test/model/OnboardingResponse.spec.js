...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.OnboardingResponse();
  });
  ...
  describe('OnboardingResponse', function() {
    it('should create an instance of OnboardingResponse', function() {
      ...
      //var instance = new InfluxOssApiService.OnboardingResponse();
      //expect(instance).to.be.a(InfluxOssApiService.OnboardingResponse);
    });
