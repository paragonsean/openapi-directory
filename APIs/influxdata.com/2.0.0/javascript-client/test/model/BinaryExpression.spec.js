...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.BinaryExpression();
  });
  ...
  describe('BinaryExpression', function() {
    it('should create an instance of BinaryExpression', function() {
      // uncomment below and update the code to test BinaryExpression
      //var instance = new InfluxOssApiService.BinaryExpression();
      //expect(instance).to.be.a(InfluxOssApiService.BinaryExpression);
    });
