...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.BandViewProperties();
  });
  ...
  describe('BandViewProperties', function() {
    it('should create an instance of BandViewProperties', function() {
      // uncomment below and update the code to test BandViewProperties
      //var instance = new InfluxOssApiService.BandViewProperties();
      //expect(instance).to.be.a(InfluxOssApiService.BandViewProperties);
    });
