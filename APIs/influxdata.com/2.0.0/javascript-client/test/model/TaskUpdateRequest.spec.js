...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.TaskUpdateRequest();
  });
  ...
  describe('TaskUpdateRequest', function() {
    it('should create an instance of TaskUpdateRequest', function() {
      // uncomment below and update the code to test TaskUpdateRequest
      //var instance = new InfluxOssApiService.TaskUpdateRequest();
      //expect(instance).to.be.a(InfluxOssApiService.TaskUpdateRequest);
    });
