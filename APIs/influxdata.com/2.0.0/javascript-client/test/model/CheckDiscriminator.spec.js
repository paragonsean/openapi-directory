...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.CheckDiscriminator();
  });
  ...
  describe('CheckDiscriminator', function() {
    it('should create an instance of CheckDiscriminator', function() {
      // uncomment below and update the code to test CheckDiscriminator
      //var instance = new InfluxOssApiService.CheckDiscriminator();
      //expect(instance).to.be.a(InfluxOssApiService.CheckDiscriminator);
    });
