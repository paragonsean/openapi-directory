...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.CheckBaseLinks();
  });
  ...
  describe('CheckBaseLinks', function() {
    it('should create an instance of CheckBaseLinks', function() {
      // uncomment below and update the code to test CheckBaseLinks
      //var instance = new InfluxOssApiService.CheckBaseLinks();
      //expect(instance).to.be.a(InfluxOssApiService.CheckBaseLinks);
    });
