...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.TableViewProperties();
  });
  ...
  describe('TableViewProperties', function() {
    it('should create an instance of TableViewProperties', function() {
      // uncomment below and update the code to test TableViewProperties
      //var instance = new InfluxOssApiService.TableViewProperties();
      //expect(instance).to.be.a(InfluxOssApiService.TableViewProperties);
    });
