...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.CreateDashboardRequest();
  });
  ...
  describe('CreateDashboardRequest', function() {
    it('should create an instance of CreateDashboardRequest', function() {
      ...
      //var instance = new InfluxOssApiService.CreateDashboardRequest();
      //expect(instance).to.be.a(InfluxOssApiService.CreateDashboardRequest);
    });
