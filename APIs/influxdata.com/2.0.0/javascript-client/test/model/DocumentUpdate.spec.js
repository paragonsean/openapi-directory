...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.DocumentUpdate();
  });
  ...
  describe('DocumentUpdate', function() {
    it('should create an instance of DocumentUpdate', function() {
      ...
      //var instance = new InfluxOssApiService.DocumentUpdate();
      //expect(instance).to.be.a(InfluxOssApiService.DocumentUpdate);
    });
