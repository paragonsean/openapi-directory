...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.SlackNotificationRule();
  });
  ...
  describe('SlackNotificationRule', function() {
    it('should create an instance of SlackNotificationRule', function() {
      // uncomment below and update the code to test SlackNotificationRule
      //var instance = new InfluxOssApiService.SlackNotificationRule();
      //expect(instance).to.be.a(InfluxOssApiService.SlackNotificationRule);
    });
