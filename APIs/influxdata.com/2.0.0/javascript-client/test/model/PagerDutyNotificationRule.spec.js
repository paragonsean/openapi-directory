...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.PagerDutyNotificationRule();
  });
  ...
  describe('PagerDutyNotificationRule', function() {
    it('should create an instance of PagerDutyNotificationRule', function() {
      // uncomment below and update the code to test PagerDutyNotificationRule
      //var instance = new InfluxOssApiService.PagerDutyNotificationRule();
      //expect(instance).to.be.a(InfluxOssApiService.PagerDutyNotificationRule);
    });
