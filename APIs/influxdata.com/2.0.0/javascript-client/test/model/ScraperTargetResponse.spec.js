...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.ScraperTargetResponse();
  });
  ...
  describe('ScraperTargetResponse', function() {
    it('should create an instance of ScraperTargetResponse', function() {
      // uncomment below and update the code to test ScraperTargetResponse
      //var instance = new InfluxOssApiService.ScraperTargetResponse();
      //expect(instance).to.be.a(InfluxOssApiService.ScraperTargetResponse);
    });
