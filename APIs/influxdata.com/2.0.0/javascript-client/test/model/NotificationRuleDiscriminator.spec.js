...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.NotificationRuleDiscriminator();
  });
  ...
  describe('NotificationRuleDiscriminator', function() {
    it('should create an instance of NotificationRuleDiscriminator', function() {
      // uncomment below and update the code to test NotificationRuleDiscriminator
      //var instance = new InfluxOssApiService.NotificationRuleDiscriminator();
      //expect(instance).to.be.a(InfluxOssApiService.NotificationRuleDiscriminator);
    });
