...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.DashboardAllOfLinks();
  });
  ...
  describe('DashboardAllOfLinks', function() {
    it('should create an instance of DashboardAllOfLinks', function() {
      // uncomment below and update the code to test DashboardAllOfLinks
      //var instance = new InfluxOssApiService.DashboardAllOfLinks();
      //expect(instance).to.be.a(InfluxOssApiService.DashboardAllOfLinks);
    });
