...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.TemplateApplyTemplate();
  });
  ...
  describe('TemplateApplyTemplate', function() {
    it('should create an instance of TemplateApplyTemplate', function() {
      // uncomment below and update the code to test TemplateApplyTemplate
      //var instance = new InfluxOssApiService.TemplateApplyTemplate();
      //expect(instance).to.be.a(InfluxOssApiService.TemplateApplyTemplate);
    });
