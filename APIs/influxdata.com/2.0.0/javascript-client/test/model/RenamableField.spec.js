...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.RenamableField();
  });
  ...
  describe('RenamableField', function() {
    it('should create an instance of RenamableField', function() {
      // uncomment below and update the code to test RenamableField
      //var instance = new InfluxOssApiService.RenamableField();
      //expect(instance).to.be.a(InfluxOssApiService.RenamableField);
    });
