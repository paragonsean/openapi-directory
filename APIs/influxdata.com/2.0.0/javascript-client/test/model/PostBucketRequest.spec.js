...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.PostBucketRequest();
  });
  ...
  describe('PostBucketRequest', function() {
    it('should create an instance of PostBucketRequest', function() {
      // uncomment below and update the code to test PostBucketRequest
      //var instance = new InfluxOssApiService.PostBucketRequest();
      //expect(instance).to.be.a(InfluxOssApiService.PostBucketRequest);
    });
