...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.LogicalExpression();
  });
  ...
  describe('LogicalExpression', function() {
    it('should create an instance of LogicalExpression', function() {
      ...
      //var instance = new InfluxOssApiService.LogicalExpression();
      //expect(instance).to.be.a(InfluxOssApiService.LogicalExpression);
    });
