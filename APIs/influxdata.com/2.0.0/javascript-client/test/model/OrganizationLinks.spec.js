...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.OrganizationLinks();
  });
  ...
  describe('OrganizationLinks', function() {
    it('should create an instance of OrganizationLinks', function() {
      ...
      //var instance = new InfluxOssApiService.OrganizationLinks();
      //expect(instance).to.be.a(InfluxOssApiService.OrganizationLinks);
    });
