...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.NotificationRuleBase();
  });
  ...
  describe('NotificationRuleBase', function() {
    it('should create an instance of NotificationRuleBase', function() {
      // uncomment below and update the code to test NotificationRuleBase
      //var instance = new InfluxOssApiService.NotificationRuleBase();
      //expect(instance).to.be.a(InfluxOssApiService.NotificationRuleBase);
    });
