...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.TelegrafAllOfLinks();
  });
  ...
  describe('TelegrafAllOfLinks', function() {
    it('should create an instance of TelegrafAllOfLinks', function() {
      // uncomment below and update the code to test TelegrafAllOfLinks
      //var instance = new InfluxOssApiService.TelegrafAllOfLinks();
      //expect(instance).to.be.a(InfluxOssApiService.TelegrafAllOfLinks);
    });
