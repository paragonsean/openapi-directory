...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.XYViewProperties();
  });
  ...
  describe('XYViewProperties', function() {
    it('should create an instance of XYViewProperties', function() {
      // uncomment below and update the code to test XYViewProperties
      //var instance = new InfluxOssApiService.XYViewProperties();
      //expect(instance).to.be.a(InfluxOssApiService.XYViewProperties);
    });
