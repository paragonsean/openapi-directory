...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.CheckBase();
  });
  ...
  describe('CheckBase', function() {
    it('should create an instance of CheckBase', function() {
      // uncomment below and update the code to test CheckBase
      //var instance = new InfluxOssApiService.CheckBase();
      //expect(instance).to.be.a(InfluxOssApiService.CheckBase);
    });
