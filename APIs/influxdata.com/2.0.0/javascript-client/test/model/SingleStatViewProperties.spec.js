...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.SingleStatViewProperties();
  });
  ...
  describe('SingleStatViewProperties', function() {
    it('should create an instance of SingleStatViewProperties', function() {
      // uncomment below and update the code to test SingleStatViewProperties
      //var instance = new InfluxOssApiService.SingleStatViewProperties();
      //expect(instance).to.be.a(InfluxOssApiService.SingleStatViewProperties);
    });
