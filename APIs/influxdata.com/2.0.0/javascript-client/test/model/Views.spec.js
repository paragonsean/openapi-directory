...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.Views();
  });
  ...
  describe('Views', function() {
    it('should create an instance of Views', function() {
      // uncomment below and update the code to test Views
      //var instance = new InfluxOssApiService.Views();
      //expect(instance).to.be.a(InfluxOssApiService.Views);
    });
