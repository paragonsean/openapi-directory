...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.BuilderConfig();
  });
  ...
  describe('BuilderConfig', function() {
    it('should create an instance of BuilderConfig', function() {
      ...
      //var instance = new InfluxOssApiService.BuilderConfig();
      //expect(instance).to.be.a(InfluxOssApiService.BuilderConfig);
    });

    it('should have the property aggregateWindow (base name: "aggregateWindow")', function() {
