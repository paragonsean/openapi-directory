...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.MemberExpression();
  });
  ...
  describe('MemberExpression', function() {
    it('should create an instance of MemberExpression', function() {
      // uncomment below and update the code to test MemberExpression
      //var instance = new InfluxOssApiService.MemberExpression();
      //expect(instance).to.be.a(InfluxOssApiService.MemberExpression);
    });
