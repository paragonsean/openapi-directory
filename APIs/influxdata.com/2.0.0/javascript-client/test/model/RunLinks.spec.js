...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.RunLinks();
  });
  ...
  describe('RunLinks', function() {
    it('should create an instance of RunLinks', function() {
      // uncomment below and update the code to test RunLinks
      //var instance = new InfluxOssApiService.RunLinks();
      //expect(instance).to.be.a(InfluxOssApiService.RunLinks);
    });
