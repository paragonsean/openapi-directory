...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.SMTPNotificationRuleBase();
  });
  ...
  describe('SMTPNotificationRuleBase', function() {
    it('should create an instance of SMTPNotificationRuleBase', function() {
      // uncomment below and update the code to test SMTPNotificationRuleBase
      //var instance = new InfluxOssApiService.SMTPNotificationRuleBase();
      //expect(instance).to.be.a(InfluxOssApiService.SMTPNotificationRuleBase);
    });
