...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.ScatterViewProperties();
  });
  ...
  describe('ScatterViewProperties', function() {
    it('should create an instance of ScatterViewProperties', function() {
      // uncomment below and update the code to test ScatterViewProperties
      //var instance = new InfluxOssApiService.ScatterViewProperties();
      //expect(instance).to.be.a(InfluxOssApiService.ScatterViewProperties);
    });
