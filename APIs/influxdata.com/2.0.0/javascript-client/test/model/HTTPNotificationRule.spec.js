...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.HTTPNotificationRule();
  });
  ...
  describe('HTTPNotificationRule', function() {
    it('should create an instance of HTTPNotificationRule', function() {
      // uncomment below and update the code to test HTTPNotificationRule
      //var instance = new InfluxOssApiService.HTTPNotificationRule();
      //expect(instance).to.be.a(InfluxOssApiService.HTTPNotificationRule);
    });
