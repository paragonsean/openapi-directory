...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.Organizations();
  });
  ...
  describe('Organizations', function() {
    it('should create an instance of Organizations', function() {
      ...
      //var instance = new InfluxOssApiService.Organizations();
      //expect(instance).to.be.a(InfluxOssApiService.Organizations);
    });
