...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.PostQueryRequest();
  });
  ...
  describe('PostQueryRequest', function() {
    it('should create an instance of PostQueryRequest', function() {
      // uncomment below and update the code to test PostQueryRequest
      //var instance = new InfluxOssApiService.PostQueryRequest();
      //expect(instance).to.be.a(InfluxOssApiService.PostQueryRequest);
    });
