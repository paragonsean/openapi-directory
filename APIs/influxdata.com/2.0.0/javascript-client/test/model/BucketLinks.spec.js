...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.BucketLinks();
  });
  ...
  describe('BucketLinks', function() {
    it('should create an instance of BucketLinks', function() {
      // uncomment below and update the code to test BucketLinks
      //var instance = new InfluxOssApiService.BucketLinks();
      //expect(instance).to.be.a(InfluxOssApiService.BucketLinks);
    });
