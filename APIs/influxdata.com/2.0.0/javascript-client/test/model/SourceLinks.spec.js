...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.SourceLinks();
  });
  ...
  describe('SourceLinks', function() {
    it('should create an instance of SourceLinks', function() {
      // uncomment below and update the code to test SourceLinks
      //var instance = new InfluxOssApiService.SourceLinks();
      //expect(instance).to.be.a(InfluxOssApiService.SourceLinks);
    });
