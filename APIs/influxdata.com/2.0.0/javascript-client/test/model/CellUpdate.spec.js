...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.CellUpdate();
  });
  ...
  describe('CellUpdate', function() {
    it('should create an instance of CellUpdate', function() {
      // uncomment below and update the code to test CellUpdate
      //var instance = new InfluxOssApiService.CellUpdate();
      //expect(instance).to.be.a(InfluxOssApiService.CellUpdate);
    });
