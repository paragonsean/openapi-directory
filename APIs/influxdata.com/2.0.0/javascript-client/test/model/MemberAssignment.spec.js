...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.MemberAssignment();
  });
  ...
  describe('MemberAssignment', function() {
    it('should create an instance of MemberAssignment', function() {
      // uncomment below and update the code to test MemberAssignment
      //var instance = new InfluxOssApiService.MemberAssignment();
      //expect(instance).to.be.a(InfluxOssApiService.MemberAssignment);
    });
