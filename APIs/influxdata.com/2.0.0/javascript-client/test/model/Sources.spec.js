...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.Sources();
  });
  ...
  describe('Sources', function() {
    it('should create an instance of Sources', function() {
      // uncomment below and update the code to test Sources
      //var instance = new InfluxOssApiService.Sources();
      //expect(instance).to.be.a(InfluxOssApiService.Sources);
    });
