...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.ConditionalExpression();
  });
  ...
  describe('ConditionalExpression', function() {
    it('should create an instance of ConditionalExpression', function() {
      // uncomment below and update the code to test ConditionalExpression
      //var instance = new InfluxOssApiService.ConditionalExpression();
      //expect(instance).to.be.a(InfluxOssApiService.ConditionalExpression);
    });
