...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.TelegrafPlugins();
  });
  ...
  describe('TelegrafPlugins', function() {
    it('should create an instance of TelegrafPlugins', function() {
      // uncomment below and update the code to test TelegrafPlugins
      //var instance = new InfluxOssApiService.TelegrafPlugins();
      //expect(instance).to.be.a(InfluxOssApiService.TelegrafPlugins);
    });
