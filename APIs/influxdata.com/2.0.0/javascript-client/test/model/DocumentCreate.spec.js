...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.DocumentCreate();
  });
  ...
  describe('DocumentCreate', function() {
    it('should create an instance of DocumentCreate', function() {
      ...
      //var instance = new InfluxOssApiService.DocumentCreate();
      //expect(instance).to.be.a(InfluxOssApiService.DocumentCreate);
    });
