...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.UnaryExpression();
  });
  ...
  describe('UnaryExpression', function() {
    it('should create an instance of UnaryExpression', function() {
      // uncomment below and update the code to test UnaryExpression
      //var instance = new InfluxOssApiService.UnaryExpression();
      //expect(instance).to.be.a(InfluxOssApiService.UnaryExpression);
    });
