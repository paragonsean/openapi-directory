...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.PipeExpression();
  });
  ...
  describe('PipeExpression', function() {
    it('should create an instance of PipeExpression', function() {
      // uncomment below and update the code to test PipeExpression
      //var instance = new InfluxOssApiService.PipeExpression();
      //expect(instance).to.be.a(InfluxOssApiService.PipeExpression);
    });
