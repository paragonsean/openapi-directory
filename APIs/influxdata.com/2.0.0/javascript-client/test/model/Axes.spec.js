...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.Axes();
  });
  ...
  describe('Axes', function() {
    it('should create an instance of Axes', function() {
      // uncomment below and update the code to test Axes
      //var instance = new InfluxOssApiService.Axes();
      //expect(instance).to.be.a(InfluxOssApiService.Axes);
    });
