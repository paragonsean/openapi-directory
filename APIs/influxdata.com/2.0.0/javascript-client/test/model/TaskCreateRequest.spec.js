...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.TaskCreateRequest();
  });
  ...
  describe('TaskCreateRequest', function() {
    it('should create an instance of TaskCreateRequest', function() {
      ...
      //var instance = new InfluxOssApiService.TaskCreateRequest();
      //expect(instance).to.be.a(InfluxOssApiService.TaskCreateRequest);
    });
