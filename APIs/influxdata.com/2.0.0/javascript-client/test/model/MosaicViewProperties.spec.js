...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.MosaicViewProperties();
  });
  ...
  describe('MosaicViewProperties', function() {
    it('should create an instance of MosaicViewProperties', function() {
      // uncomment below and update the code to test MosaicViewProperties
      //var instance = new InfluxOssApiService.MosaicViewProperties();
      //expect(instance).to.be.a(InfluxOssApiService.MosaicViewProperties);
    });
