...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfluxOssApiService.ThresholdCheck();
  });
  ...
  describe('ThresholdCheck', function() {
    it('should create an instance of ThresholdCheck', function() {
      // uncomment below and update the code to test ThresholdCheck
      //var instance = new InfluxOssApiService.ThresholdCheck();
      //expect(instance).to.be.a(InfluxOssApiService.ThresholdCheck);
    });
    ...
    it('should have the property statusMessageTemplate (base name: "statusMessageTemplate")', function() {
      // uncomment below and update the code to test the property statusMessageTemplate
      //var instance = new InfluxOssApiService.ThresholdCheck();
      //expect(instance).to.be();
    });
