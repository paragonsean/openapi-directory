...
/**
 * The HeatmapViewProperties model module.
 * @module model/HeatmapViewProperties
 * @version 2.0.0
 */
class HeatmapViewProperties {
    /**
     * Constructs a new <code>HeatmapViewProperties</code>.
     * @alias module:model/HeatmapViewProperties
     ...
     * @param shape {module:model/HeatmapViewProperties.ShapeEnum} 
     * @param showNoteWhenEmpty {Boolean} If true, will display note when empty
     * @param type {module:model/HeatmapViewProperties.TypeEnum} 
     ...
     */
    constructor(binSize, colors, note, queries, shape, showNoteWhenEmpty, type, xAxisLabel, xColumn, xDomain, xPrefix, xSuffix, yAxisLabel, yColumn, yDomain, yPrefix, ySuffix) { 
        
        HeatmapViewProperties.initialize(this, binSize, colors, note, queries, shape, showNoteWhenEmpty, type, xAxisLabel, xColumn, xDomain, xPrefix, xSuffix, yAxisLabel, yColumn, yDomain, yPrefix, ySuffix);
    }
     ...
     */
    static initialize(obj, binSize, colors, note, queries, shape, showNoteWhenEmpty, type, xAxisLabel, xColumn, xDomain, xPrefix, xSuffix, yAxisLabel, yColumn, yDomain, yPrefix, ySuffix) { 
        obj['binSize'] = binSize;
        obj['colors'] = colors;
        obj['note'] = note;
        obj['queries'] = queries;
    ...
    /**
     * Constructs a <code>HeatmapViewProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HeatmapViewProperties} obj Optional instance to populate.
     * @return {module:model/HeatmapViewProperties} The populated <code>HeatmapViewProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HeatmapViewProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>HeatmapViewProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HeatmapViewProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HeatmapViewProperties.RequiredProperties) {
...
HeatmapViewProperties.RequiredProperties = ["binSize", "colors", "note", "queries", "shape", "showNoteWhenEmpty", "type", "xAxisLabel", "xColumn", "xDomain", "xPrefix", "xSuffix", "yAxisLabel", "yColumn", "yDomain", "yPrefix", "ySuffix"];

/**
 * @member {Number} binSize
 */
HeatmapViewProperties.prototype['binSize'] = undefined;

/**
 * Colors define color encoding of data into a visualization
 * @member {Array.<String>} colors
 */
HeatmapViewProperties.prototype['colors'] = undefined;

/**
 * @member {Array.<String>} generateXAxisTicks
 */
HeatmapViewProperties.prototype['generateXAxisTicks'] = undefined;

/**
 * @member {Array.<String>} generateYAxisTicks
 */
HeatmapViewProperties.prototype['generateYAxisTicks'] = undefined;

/**
 * @member {Boolean} legendColorizeRows
 */
HeatmapViewProperties.prototype['legendColorizeRows'] = undefined;

/**
 * @member {Boolean} legendHide
 */
HeatmapViewProperties.prototype['legendHide'] = undefined;

/**
 * @member {Number} legendOpacity
 */
HeatmapViewProperties.prototype['legendOpacity'] = undefined;

/**
 * @member {Number} legendOrientationThreshold
 */
HeatmapViewProperties.prototype['legendOrientationThreshold'] = undefined;

/**
 * @member {String} note
 */
HeatmapViewProperties.prototype['note'] = undefined;

/**
 * @member {Array.<module:model/DashboardQuery>} queries
 */
HeatmapViewProperties.prototype['queries'] = undefined;

/**
 * @member {module:model/HeatmapViewProperties.ShapeEnum} shape
 */
HeatmapViewProperties.prototype['shape'] = undefined;

/**
 * If true, will display note when empty
 * @member {Boolean} showNoteWhenEmpty
 */
HeatmapViewProperties.prototype['showNoteWhenEmpty'] = undefined;

/**
 * @member {String} timeFormat
 */
HeatmapViewProperties.prototype['timeFormat'] = undefined;

/**
 * @member {module:model/HeatmapViewProperties.TypeEnum} type
 */
HeatmapViewProperties.prototype['type'] = undefined;

/**
 * @member {String} xAxisLabel
 */
HeatmapViewProperties.prototype['xAxisLabel'] = undefined;

/**
 * @member {String} xColumn
 */
HeatmapViewProperties.prototype['xColumn'] = undefined;

/**
 * @member {Array.<Number>} xDomain
 */
HeatmapViewProperties.prototype['xDomain'] = undefined;

/**
 * @member {String} xPrefix
 */
HeatmapViewProperties.prototype['xPrefix'] = undefined;

/**
 * @member {String} xSuffix
 */
HeatmapViewProperties.prototype['xSuffix'] = undefined;

/**
 * @member {Number} xTickStart
 */
HeatmapViewProperties.prototype['xTickStart'] = undefined;

/**
 * @member {Number} xTickStep
 */
HeatmapViewProperties.prototype['xTickStep'] = undefined;

/**
 * @member {Number} xTotalTicks
 */
HeatmapViewProperties.prototype['xTotalTicks'] = undefined;

/**
 * @member {String} yAxisLabel
 */
HeatmapViewProperties.prototype['yAxisLabel'] = undefined;

/**
 * @member {String} yColumn
 */
HeatmapViewProperties.prototype['yColumn'] = undefined;

/**
 * @member {Array.<Number>} yDomain
 */
HeatmapViewProperties.prototype['yDomain'] = undefined;

/**
 * @member {String} yPrefix
 */
HeatmapViewProperties.prototype['yPrefix'] = undefined;

/**
 * @member {String} ySuffix
 */
HeatmapViewProperties.prototype['ySuffix'] = undefined;

/**
 * @member {Number} yTickStart
 */
HeatmapViewProperties.prototype['yTickStart'] = undefined;

/**
 * @member {Number} yTickStep
 */
HeatmapViewProperties.prototype['yTickStep'] = undefined;

/**
 * @member {Number} yTotalTicks
 */
HeatmapViewProperties.prototype['yTotalTicks'] = undefined;
...
export default HeatmapViewProperties;
