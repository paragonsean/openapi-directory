...
/**
 * The GaugeViewProperties model module.
 * @module model/GaugeViewProperties
 * @version 2.0.0
 */
class GaugeViewProperties {
    /**
     * Constructs a new <code>GaugeViewProperties</code>.
     * @alias module:model/GaugeViewProperties
     ...
     * @param shape {module:model/GaugeViewProperties.ShapeEnum} 
     * @param showNoteWhenEmpty {Boolean} If true, will display note when empty
     * @param suffix {String} 
     * @param tickPrefix {String} 
     * @param tickSuffix {String} 
     * @param type {module:model/GaugeViewProperties.TypeEnum} 
     */
    constructor(colors, decimalPlaces, note, prefix, queries, shape, showNoteWhenEmpty, suffix, tickPrefix, tickSuffix, type) { 
        
        GaugeViewProperties.initialize(this, colors, decimalPlaces, note, prefix, queries, shape, showNoteWhenEmpty, suffix, tickPrefix, tickSuffix, type);
    }
    ...
    /**
     * Constructs a <code>GaugeViewProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GaugeViewProperties} obj Optional instance to populate.
     * @return {module:model/GaugeViewProperties} The populated <code>GaugeViewProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GaugeViewProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>GaugeViewProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GaugeViewProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GaugeViewProperties.RequiredProperties) {
...
GaugeViewProperties.RequiredProperties = ["colors", "decimalPlaces", "note", "prefix", "queries", "shape", "showNoteWhenEmpty", "suffix", "tickPrefix", "tickSuffix", "type"];

/**
 * Colors define color encoding of data into a visualization
 * @member {Array.<module:model/DashboardColor>} colors
 */
GaugeViewProperties.prototype['colors'] = undefined;

/**
 * @member {module:model/DecimalPlaces} decimalPlaces
 */
GaugeViewProperties.prototype['decimalPlaces'] = undefined;

/**
 * @member {String} note
 */
GaugeViewProperties.prototype['note'] = undefined;

/**
 * @member {String} prefix
 */
GaugeViewProperties.prototype['prefix'] = undefined;

/**
 * @member {Array.<module:model/DashboardQuery>} queries
 */
GaugeViewProperties.prototype['queries'] = undefined;

/**
 * @member {module:model/GaugeViewProperties.ShapeEnum} shape
 */
GaugeViewProperties.prototype['shape'] = undefined;

/**
 * If true, will display note when empty
 * @member {Boolean} showNoteWhenEmpty
 */
GaugeViewProperties.prototype['showNoteWhenEmpty'] = undefined;

/**
 * @member {String} suffix
 */
GaugeViewProperties.prototype['suffix'] = undefined;

/**
 * @member {String} tickPrefix
 */
GaugeViewProperties.prototype['tickPrefix'] = undefined;

/**
 * @member {String} tickSuffix
 */
GaugeViewProperties.prototype['tickSuffix'] = undefined;

/**
 * @member {module:model/GaugeViewProperties.TypeEnum} type
 */
GaugeViewProperties.prototype['type'] = undefined;
...
export default GaugeViewProperties;
