...
import HTTPNotificationRuleBase from './HTTPNotificationRuleBase';
...
/**
 * The HTTPNotificationRule model module.
 * @module model/HTTPNotificationRule
 * @version 2.0.0
 */
class HTTPNotificationRule {
    /**
     * Constructs a new <code>HTTPNotificationRule</code>.
     * @alias module:model/HTTPNotificationRule
     * @implements module:model/NotificationRuleBase
     * @implements module:model/HTTPNotificationRuleBase
     ...
     * @param type {module:model/HTTPNotificationRule.TypeEnum} 
     */
    constructor(endpointID, name, orgID, status, statusRules, type) { 
        NotificationRuleBase.initialize(this, endpointID, name, orgID, status, statusRules);HTTPNotificationRuleBase.initialize(this, type);
        HTTPNotificationRule.initialize(this, endpointID, name, orgID, status, statusRules, type);
    }
     ...
     */
    static initialize(obj, endpointID, name, orgID, status, statusRules, type) { 
    ...
    /**
     * Constructs a <code>HTTPNotificationRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HTTPNotificationRule} obj Optional instance to populate.
     * @return {module:model/HTTPNotificationRule} The populated <code>HTTPNotificationRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HTTPNotificationRule();
            NotificationRuleBase.constructFromObject(data, obj);
            HTTPNotificationRuleBase.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>HTTPNotificationRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HTTPNotificationRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HTTPNotificationRule.RequiredProperties) {
...
HTTPNotificationRule.RequiredProperties = ["endpointID", "name", "orgID", "status", "statusRules", "type"];

/**
 * @member {Date} createdAt
 */
HTTPNotificationRule.prototype['createdAt'] = undefined;

/**
 * An optional description of the notification rule.
 * @member {String} description
 */
HTTPNotificationRule.prototype['description'] = undefined;

/**
 * @member {String} endpointID
 */
HTTPNotificationRule.prototype['endpointID'] = undefined;

/**
 * The notification repetition interval.
 * @member {String} every
 */
HTTPNotificationRule.prototype['every'] = undefined;

/**
 * @member {String} id
 */
HTTPNotificationRule.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
HTTPNotificationRule.prototype['labels'] = undefined;

/**
 * @member {String} lastRunError
 */
HTTPNotificationRule.prototype['lastRunError'] = undefined;

/**
 * @member {module:model/HTTPNotificationRule.LastRunStatusEnum} lastRunStatus
 */
HTTPNotificationRule.prototype['lastRunStatus'] = undefined;

/**
 * Timestamp of latest scheduled, completed run, RFC3339.
 * @member {Date} latestCompleted
 */
HTTPNotificationRule.prototype['latestCompleted'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limitEvery cannot be empty.
 * @member {Number} limit
 */
HTTPNotificationRule.prototype['limit'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limit cannot be empty.
 * @member {Number} limitEvery
 */
HTTPNotificationRule.prototype['limitEvery'] = undefined;

/**
 * @member {module:model/NotificationRuleBaseLinks} links
 */
HTTPNotificationRule.prototype['links'] = undefined;

/**
 * Human-readable name describing the notification rule.
 * @member {String} name
 */
HTTPNotificationRule.prototype['name'] = undefined;

/**
 * Duration to delay after the schedule, before executing check.
 * @member {String} offset
 */
HTTPNotificationRule.prototype['offset'] = undefined;

/**
 * The ID of the organization that owns this notification rule.
 * @member {String} orgID
 */
HTTPNotificationRule.prototype['orgID'] = undefined;

/**
 * The ID of creator used to create this notification rule.
 * @member {String} ownerID
 */
HTTPNotificationRule.prototype['ownerID'] = undefined;

/**
 * @member {String} runbookLink
 */
HTTPNotificationRule.prototype['runbookLink'] = undefined;

/**
 * @member {String} sleepUntil
 */
HTTPNotificationRule.prototype['sleepUntil'] = undefined;

/**
 * @member {module:model/TaskStatusType} status
 */
HTTPNotificationRule.prototype['status'] = undefined;

/**
 * List of status rules the notification rule attempts to match.
 * @member {Array.<module:model/StatusRule>} statusRules
 */
HTTPNotificationRule.prototype['statusRules'] = undefined;

/**
 * List of tag rules the notification rule attempts to match.
 * @member {Array.<module:model/TagRule>} tagRules
 */
HTTPNotificationRule.prototype['tagRules'] = undefined;

/**
 * The ID of the task associated with this notification rule.
 * @member {String} taskID
 */
HTTPNotificationRule.prototype['taskID'] = undefined;

/**
 * @member {Date} updatedAt
 */
HTTPNotificationRule.prototype['updatedAt'] = undefined;

/**
 * @member {module:model/HTTPNotificationRule.TypeEnum} type
 */
HTTPNotificationRule.prototype['type'] = undefined;

/**
 * @member {String} url
 */
HTTPNotificationRule.prototype['url'] = undefined;
...
// Implement HTTPNotificationRuleBase interface:
/**
 ...
 * @readonly
 */
HTTPNotificationRule['LastRunStatusEnum'] = {
...
export default HTTPNotificationRule;
