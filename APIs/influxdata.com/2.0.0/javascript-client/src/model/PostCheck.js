...
/**
 * The PostCheck model module.
 * @module model/PostCheck
 * @version 2.0.0
 */
class PostCheck {
    /**
     * Constructs a new <code>PostCheck</code>.
     * @alias module:model/PostCheck
     ...
     * @param type {module:model/PostCheck.TypeEnum} 
     */
    constructor(name, orgID, query, type) { 
        CheckDiscriminator.initialize(this, name, orgID, query, type);
        PostCheck.initialize(this, name, orgID, query, type);
    }
    ...
    /**
     * Constructs a <code>PostCheck</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCheck} obj Optional instance to populate.
     * @return {module:model/PostCheck} The populated <code>PostCheck</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCheck();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCheck</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCheck</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostCheck.RequiredProperties) {
...
PostCheck.RequiredProperties = ["name", "orgID", "query", "type"];
