...
/**
 * The ScraperTargetRequest model module.
 * @module model/ScraperTargetRequest
 * @version 2.0.0
 */
class ScraperTargetRequest {
    /**
     * Constructs a new <code>ScraperTargetRequest</code>.
     * @alias module:model/ScraperTargetRequest
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ScraperTargetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScraperTargetRequest} obj Optional instance to populate.
     * @return {module:model/ScraperTargetRequest} The populated <code>ScraperTargetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScraperTargetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ScraperTargetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScraperTargetRequest</code>.
     */
...
export default ScraperTargetRequest;
