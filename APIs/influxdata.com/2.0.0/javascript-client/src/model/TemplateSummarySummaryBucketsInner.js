...
/**
 * The TemplateSummarySummaryBucketsInner model module.
 * @module model/TemplateSummarySummaryBucketsInner
 * @version 2.0.0
 */
class TemplateSummarySummaryBucketsInner {
    /**
     * Constructs a new <code>TemplateSummarySummaryBucketsInner</code>.
     * @alias module:model/TemplateSummarySummaryBucketsInner
     */
    constructor() { 
        
        TemplateSummarySummaryBucketsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateSummarySummaryBucketsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateSummarySummaryBucketsInner} obj Optional instance to populate.
     * @return {module:model/TemplateSummarySummaryBucketsInner} The populated <code>TemplateSummarySummaryBucketsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateSummarySummaryBucketsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateSummarySummaryBucketsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateSummarySummaryBucketsInner</code>.
     */
 ...
 */
TemplateSummarySummaryBucketsInner.prototype['description'] = undefined;

/**
 * @member {Array.<module:model/TemplateEnvReferencesInner>} envReferences
 */
TemplateSummarySummaryBucketsInner.prototype['envReferences'] = undefined;

/**
 * @member {String} id
 */
TemplateSummarySummaryBucketsInner.prototype['id'] = undefined;

/**
 * @member {module:model/TemplateKind} kind
 */
TemplateSummarySummaryBucketsInner.prototype['kind'] = undefined;

/**
 * @member {Array.<module:model/TemplateSummaryLabel>} labelAssociations
 */
TemplateSummarySummaryBucketsInner.prototype['labelAssociations'] = undefined;

/**
 * @member {String} name
 */
TemplateSummarySummaryBucketsInner.prototype['name'] = undefined;

/**
 * @member {String} orgID
 */
TemplateSummarySummaryBucketsInner.prototype['orgID'] = undefined;

/**
 * @member {Number} retentionPeriod
 */
TemplateSummarySummaryBucketsInner.prototype['retentionPeriod'] = undefined;

/**
 * @member {String} templateMetaName
 */
TemplateSummarySummaryBucketsInner.prototype['templateMetaName'] = undefined;
...
export default TemplateSummarySummaryBucketsInner;
