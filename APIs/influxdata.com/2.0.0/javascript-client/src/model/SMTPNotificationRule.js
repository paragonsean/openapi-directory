...
import SMTPNotificationRuleBase from './SMTPNotificationRuleBase';
import StatusRule from './StatusRule';
import TagRule from './TagRule';
import TaskStatusType from './TaskStatusType';

/**
 * The SMTPNotificationRule model module.
 * @module model/SMTPNotificationRule
 * @version 2.0.0
 */
class SMTPNotificationRule {
    /**
     * Constructs a new <code>SMTPNotificationRule</code>.
     * @alias module:model/SMTPNotificationRule
     * @implements module:model/NotificationRuleBase
     * @implements module:model/SMTPNotificationRuleBase
     ...
     * @param to {String} 
     * @param type {module:model/SMTPNotificationRule.TypeEnum} 
     */
    constructor(endpointID, name, orgID, status, statusRules, subjectTemplate, to, type) { 
        NotificationRuleBase.initialize(this, endpointID, name, orgID, status, statusRules);SMTPNotificationRuleBase.initialize(this, subjectTemplate, to, type);
        SMTPNotificationRule.initialize(this, endpointID, name, orgID, status, statusRules, subjectTemplate, to, type);
    }
     ...
     */
    static initialize(obj, endpointID, name, orgID, status, statusRules, subjectTemplate, to, type) { 
    ...
    /**
     * Constructs a <code>SMTPNotificationRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SMTPNotificationRule} obj Optional instance to populate.
     * @return {module:model/SMTPNotificationRule} The populated <code>SMTPNotificationRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SMTPNotificationRule();
            NotificationRuleBase.constructFromObject(data, obj);
            SMTPNotificationRuleBase.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SMTPNotificationRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SMTPNotificationRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SMTPNotificationRule.RequiredProperties) {
...
SMTPNotificationRule.RequiredProperties = ["endpointID", "name", "orgID", "status", "statusRules", "subjectTemplate", "to", "type"];

/**
 * @member {Date} createdAt
 */
SMTPNotificationRule.prototype['createdAt'] = undefined;

/**
 * An optional description of the notification rule.
 * @member {String} description
 */
SMTPNotificationRule.prototype['description'] = undefined;

/**
 * @member {String} endpointID
 */
SMTPNotificationRule.prototype['endpointID'] = undefined;

/**
 * The notification repetition interval.
 * @member {String} every
 */
SMTPNotificationRule.prototype['every'] = undefined;

/**
 * @member {String} id
 */
SMTPNotificationRule.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
SMTPNotificationRule.prototype['labels'] = undefined;

/**
 * @member {String} lastRunError
 */
SMTPNotificationRule.prototype['lastRunError'] = undefined;

/**
 * @member {module:model/SMTPNotificationRule.LastRunStatusEnum} lastRunStatus
 */
SMTPNotificationRule.prototype['lastRunStatus'] = undefined;

/**
 * Timestamp of latest scheduled, completed run, RFC3339.
 * @member {Date} latestCompleted
 */
SMTPNotificationRule.prototype['latestCompleted'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limitEvery cannot be empty.
 * @member {Number} limit
 */
SMTPNotificationRule.prototype['limit'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limit cannot be empty.
 * @member {Number} limitEvery
 */
SMTPNotificationRule.prototype['limitEvery'] = undefined;

/**
 * @member {module:model/NotificationRuleBaseLinks} links
 */
SMTPNotificationRule.prototype['links'] = undefined;

/**
 * Human-readable name describing the notification rule.
 * @member {String} name
 */
SMTPNotificationRule.prototype['name'] = undefined;

/**
 * Duration to delay after the schedule, before executing check.
 * @member {String} offset
 */
SMTPNotificationRule.prototype['offset'] = undefined;

/**
 * The ID of the organization that owns this notification rule.
 * @member {String} orgID
 */
SMTPNotificationRule.prototype['orgID'] = undefined;

/**
 * The ID of creator used to create this notification rule.
 * @member {String} ownerID
 */
SMTPNotificationRule.prototype['ownerID'] = undefined;

/**
 * @member {String} runbookLink
 */
SMTPNotificationRule.prototype['runbookLink'] = undefined;

/**
 * @member {String} sleepUntil
 */
SMTPNotificationRule.prototype['sleepUntil'] = undefined;

/**
 * @member {module:model/TaskStatusType} status
 */
SMTPNotificationRule.prototype['status'] = undefined;

/**
 * List of status rules the notification rule attempts to match.
 * @member {Array.<module:model/StatusRule>} statusRules
 */
SMTPNotificationRule.prototype['statusRules'] = undefined;

/**
 * List of tag rules the notification rule attempts to match.
 * @member {Array.<module:model/TagRule>} tagRules
 */
SMTPNotificationRule.prototype['tagRules'] = undefined;

/**
 * The ID of the task associated with this notification rule.
 * @member {String} taskID
 */
SMTPNotificationRule.prototype['taskID'] = undefined;

/**
 * @member {Date} updatedAt
 */
SMTPNotificationRule.prototype['updatedAt'] = undefined;

/**
 * @member {String} bodyTemplate
 */
SMTPNotificationRule.prototype['bodyTemplate'] = undefined;

/**
 * @member {String} subjectTemplate
 */
SMTPNotificationRule.prototype['subjectTemplate'] = undefined;

/**
 * @member {String} to
 */
SMTPNotificationRule.prototype['to'] = undefined;

/**
 * @member {module:model/SMTPNotificationRule.TypeEnum} type
 */
SMTPNotificationRule.prototype['type'] = undefined;
...
// Implement SMTPNotificationRuleBase interface:
/**
 * @member {String} bodyTemplate
 */
 ...
 * @readonly
 */
SMTPNotificationRule['LastRunStatusEnum'] = {
...
export default SMTPNotificationRule;
