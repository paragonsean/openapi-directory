...
/**
 * The BucketLinks model module.
 * @module model/BucketLinks
 * @version 2.0.0
 */
class BucketLinks {
    /**
     * Constructs a new <code>BucketLinks</code>.
     * @alias module:model/BucketLinks
     */
    constructor() { 
        
        BucketLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BucketLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BucketLinks} obj Optional instance to populate.
     * @return {module:model/BucketLinks} The populated <code>BucketLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BucketLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>BucketLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BucketLinks</code>.
     */
 ...
 */
BucketLinks.prototype['labels'] = undefined;

/**
 * URI of resource.
 * @member {String} members
 */
BucketLinks.prototype['members'] = undefined;

/**
 * URI of resource.
 * @member {String} org
 */
BucketLinks.prototype['org'] = undefined;

/**
 * URI of resource.
 * @member {String} owners
 */
BucketLinks.prototype['owners'] = undefined;

/**
 * URI of resource.
 * @member {String} self
 */
BucketLinks.prototype['self'] = undefined;

/**
 * URI of resource.
 * @member {String} write
 */
BucketLinks.prototype['write'] = undefined;
