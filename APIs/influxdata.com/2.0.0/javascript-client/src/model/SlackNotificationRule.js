...
import SlackNotificationRuleBase from './SlackNotificationRuleBase';
import StatusRule from './StatusRule';
import TagRule from './TagRule';
import TaskStatusType from './TaskStatusType';

/**
 * The SlackNotificationRule model module.
 * @module model/SlackNotificationRule
 * @version 2.0.0
 */
class SlackNotificationRule {
    /**
     * Constructs a new <code>SlackNotificationRule</code>.
     * @alias module:model/SlackNotificationRule
     * @implements module:model/NotificationRuleBase
     * @implements module:model/SlackNotificationRuleBase
     ...
     * @param type {module:model/SlackNotificationRule.TypeEnum} 
     */
    constructor(endpointID, name, orgID, status, statusRules, messageTemplate, type) { 
        NotificationRuleBase.initialize(this, endpointID, name, orgID, status, statusRules);SlackNotificationRuleBase.initialize(this, messageTemplate, type);
        SlackNotificationRule.initialize(this, endpointID, name, orgID, status, statusRules, messageTemplate, type);
    }
    ...
    /**
     * Constructs a <code>SlackNotificationRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SlackNotificationRule} obj Optional instance to populate.
     * @return {module:model/SlackNotificationRule} The populated <code>SlackNotificationRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlackNotificationRule();
            NotificationRuleBase.constructFromObject(data, obj);
            SlackNotificationRuleBase.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SlackNotificationRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SlackNotificationRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SlackNotificationRule.RequiredProperties) {
...
SlackNotificationRule.RequiredProperties = ["endpointID", "name", "orgID", "status", "statusRules", "messageTemplate", "type"];

/**
 * @member {Date} createdAt
 */
SlackNotificationRule.prototype['createdAt'] = undefined;

/**
 * An optional description of the notification rule.
 * @member {String} description
 */
SlackNotificationRule.prototype['description'] = undefined;

/**
 * @member {String} endpointID
 */
SlackNotificationRule.prototype['endpointID'] = undefined;

/**
 * The notification repetition interval.
 * @member {String} every
 */
SlackNotificationRule.prototype['every'] = undefined;

/**
 * @member {String} id
 */
SlackNotificationRule.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
SlackNotificationRule.prototype['labels'] = undefined;

/**
 * @member {String} lastRunError
 */
SlackNotificationRule.prototype['lastRunError'] = undefined;

/**
 * @member {module:model/SlackNotificationRule.LastRunStatusEnum} lastRunStatus
 */
SlackNotificationRule.prototype['lastRunStatus'] = undefined;

/**
 * Timestamp of latest scheduled, completed run, RFC3339.
 * @member {Date} latestCompleted
 */
SlackNotificationRule.prototype['latestCompleted'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limitEvery cannot be empty.
 * @member {Number} limit
 */
SlackNotificationRule.prototype['limit'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limit cannot be empty.
 * @member {Number} limitEvery
 */
SlackNotificationRule.prototype['limitEvery'] = undefined;

/**
 * @member {module:model/NotificationRuleBaseLinks} links
 */
SlackNotificationRule.prototype['links'] = undefined;

/**
 * Human-readable name describing the notification rule.
 * @member {String} name
 */
SlackNotificationRule.prototype['name'] = undefined;

/**
 * Duration to delay after the schedule, before executing check.
 * @member {String} offset
 */
SlackNotificationRule.prototype['offset'] = undefined;

/**
 * The ID of the organization that owns this notification rule.
 * @member {String} orgID
 */
SlackNotificationRule.prototype['orgID'] = undefined;

/**
 * The ID of creator used to create this notification rule.
 * @member {String} ownerID
 */
SlackNotificationRule.prototype['ownerID'] = undefined;

/**
 * @member {String} runbookLink
 */
SlackNotificationRule.prototype['runbookLink'] = undefined;

/**
 * @member {String} sleepUntil
 */
SlackNotificationRule.prototype['sleepUntil'] = undefined;

/**
 * @member {module:model/TaskStatusType} status
 */
SlackNotificationRule.prototype['status'] = undefined;

/**
 * List of status rules the notification rule attempts to match.
 * @member {Array.<module:model/StatusRule>} statusRules
 */
SlackNotificationRule.prototype['statusRules'] = undefined;

/**
 * List of tag rules the notification rule attempts to match.
 * @member {Array.<module:model/TagRule>} tagRules
 */
SlackNotificationRule.prototype['tagRules'] = undefined;

/**
 * The ID of the task associated with this notification rule.
 * @member {String} taskID
 */
SlackNotificationRule.prototype['taskID'] = undefined;

/**
 * @member {Date} updatedAt
 */
SlackNotificationRule.prototype['updatedAt'] = undefined;

/**
 * @member {String} channel
 */
SlackNotificationRule.prototype['channel'] = undefined;

/**
 * @member {String} messageTemplate
 */
SlackNotificationRule.prototype['messageTemplate'] = undefined;

/**
 * @member {module:model/SlackNotificationRule.TypeEnum} type
 */
SlackNotificationRule.prototype['type'] = undefined;
...
// Implement SlackNotificationRuleBase interface:
/**
 * @member {String} channel
 */
 ...
 * @readonly
 */
SlackNotificationRule['LastRunStatusEnum'] = {
 ...
 * @readonly
 */
SlackNotificationRule['TypeEnum'] = {
...
export default SlackNotificationRule;
