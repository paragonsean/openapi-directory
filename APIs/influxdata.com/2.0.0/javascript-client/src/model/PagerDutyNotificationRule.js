...
import PagerDutyNotificationRuleBase from './PagerDutyNotificationRuleBase';
import StatusRule from './StatusRule';
import TagRule from './TagRule';
import TaskStatusType from './TaskStatusType';

/**
 * The PagerDutyNotificationRule model module.
 * @module model/PagerDutyNotificationRule
 * @version 2.0.0
 */
class PagerDutyNotificationRule {
    /**
     * Constructs a new <code>PagerDutyNotificationRule</code>.
     * @alias module:model/PagerDutyNotificationRule
     * @implements module:model/NotificationRuleBase
     * @implements module:model/PagerDutyNotificationRuleBase
     ...
     * @param type {module:model/PagerDutyNotificationRule.TypeEnum} 
     */
    constructor(endpointID, name, orgID, status, statusRules, messageTemplate, type) { 
        NotificationRuleBase.initialize(this, endpointID, name, orgID, status, statusRules);PagerDutyNotificationRuleBase.initialize(this, messageTemplate, type);
        PagerDutyNotificationRule.initialize(this, endpointID, name, orgID, status, statusRules, messageTemplate, type);
    }
    ...
    /**
     * Constructs a <code>PagerDutyNotificationRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PagerDutyNotificationRule} obj Optional instance to populate.
     * @return {module:model/PagerDutyNotificationRule} The populated <code>PagerDutyNotificationRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PagerDutyNotificationRule();
            NotificationRuleBase.constructFromObject(data, obj);
            PagerDutyNotificationRuleBase.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PagerDutyNotificationRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PagerDutyNotificationRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PagerDutyNotificationRule.RequiredProperties) {
...
PagerDutyNotificationRule.RequiredProperties = ["endpointID", "name", "orgID", "status", "statusRules", "messageTemplate", "type"];

/**
 * @member {Date} createdAt
 */
PagerDutyNotificationRule.prototype['createdAt'] = undefined;

/**
 * An optional description of the notification rule.
 * @member {String} description
 */
PagerDutyNotificationRule.prototype['description'] = undefined;

/**
 * @member {String} endpointID
 */
PagerDutyNotificationRule.prototype['endpointID'] = undefined;

/**
 * The notification repetition interval.
 * @member {String} every
 */
PagerDutyNotificationRule.prototype['every'] = undefined;

/**
 * @member {String} id
 */
PagerDutyNotificationRule.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PagerDutyNotificationRule.prototype['labels'] = undefined;

/**
 * @member {String} lastRunError
 */
PagerDutyNotificationRule.prototype['lastRunError'] = undefined;

/**
 * @member {module:model/PagerDutyNotificationRule.LastRunStatusEnum} lastRunStatus
 */
PagerDutyNotificationRule.prototype['lastRunStatus'] = undefined;

/**
 * Timestamp of latest scheduled, completed run, RFC3339.
 * @member {Date} latestCompleted
 */
PagerDutyNotificationRule.prototype['latestCompleted'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limitEvery cannot be empty.
 * @member {Number} limit
 */
PagerDutyNotificationRule.prototype['limit'] = undefined;

/**
 * Don't notify me more than &lt;limit&gt; times every &lt;limitEvery&gt; seconds. If set, limit cannot be empty.
 * @member {Number} limitEvery
 */
PagerDutyNotificationRule.prototype['limitEvery'] = undefined;

/**
 * @member {module:model/NotificationRuleBaseLinks} links
 */
PagerDutyNotificationRule.prototype['links'] = undefined;

/**
 * Human-readable name describing the notification rule.
 * @member {String} name
 */
PagerDutyNotificationRule.prototype['name'] = undefined;

/**
 * Duration to delay after the schedule, before executing check.
 * @member {String} offset
 */
PagerDutyNotificationRule.prototype['offset'] = undefined;

/**
 * The ID of the organization that owns this notification rule.
 * @member {String} orgID
 */
PagerDutyNotificationRule.prototype['orgID'] = undefined;

/**
 * The ID of creator used to create this notification rule.
 * @member {String} ownerID
 */
PagerDutyNotificationRule.prototype['ownerID'] = undefined;

/**
 * @member {String} runbookLink
 */
PagerDutyNotificationRule.prototype['runbookLink'] = undefined;

/**
 * @member {String} sleepUntil
 */
PagerDutyNotificationRule.prototype['sleepUntil'] = undefined;

/**
 * @member {module:model/TaskStatusType} status
 */
PagerDutyNotificationRule.prototype['status'] = undefined;

/**
 * List of status rules the notification rule attempts to match.
 * @member {Array.<module:model/StatusRule>} statusRules
 */
PagerDutyNotificationRule.prototype['statusRules'] = undefined;

/**
 * List of tag rules the notification rule attempts to match.
 * @member {Array.<module:model/TagRule>} tagRules
 */
PagerDutyNotificationRule.prototype['tagRules'] = undefined;

/**
 * The ID of the task associated with this notification rule.
 * @member {String} taskID
 */
PagerDutyNotificationRule.prototype['taskID'] = undefined;

/**
 * @member {Date} updatedAt
 */
PagerDutyNotificationRule.prototype['updatedAt'] = undefined;

/**
 * @member {String} messageTemplate
 */
PagerDutyNotificationRule.prototype['messageTemplate'] = undefined;

/**
 * @member {module:model/PagerDutyNotificationRule.TypeEnum} type
 */
PagerDutyNotificationRule.prototype['type'] = undefined;
...
// Implement PagerDutyNotificationRuleBase interface:
/**
 * @member {String} messageTemplate
 */
 ...
 * @readonly
 */
PagerDutyNotificationRule['LastRunStatusEnum'] = {
 ...
 * @readonly
 */
PagerDutyNotificationRule['TypeEnum'] = {
...
export default PagerDutyNotificationRule;
