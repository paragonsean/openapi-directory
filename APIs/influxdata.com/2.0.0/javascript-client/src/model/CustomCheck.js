...
/**
 * The CustomCheck model module.
 * @module model/CustomCheck
 * @version 2.0.0
 */
class CustomCheck {
    /**
     * Constructs a new <code>CustomCheck</code>.
     * @alias module:model/CustomCheck
     ...
     * @param type {module:model/CustomCheck.TypeEnum} 
     */
    constructor(name, orgID, query, type) { 
        CheckBase.initialize(this, name, orgID, query);
        CustomCheck.initialize(this, name, orgID, query, type);
    }
    ...
    /**
     * Constructs a <code>CustomCheck</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomCheck} obj Optional instance to populate.
     * @return {module:model/CustomCheck} The populated <code>CustomCheck</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomCheck();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomCheck</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomCheck</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomCheck.RequiredProperties) {
...
CustomCheck.RequiredProperties = ["name", "orgID", "query", "type"];

/**
 * @member {Date} createdAt
 */
CustomCheck.prototype['createdAt'] = undefined;

/**
 * An optional description of the check.
 * @member {String} description
 */
CustomCheck.prototype['description'] = undefined;

/**
 * @member {String} id
 */
CustomCheck.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
CustomCheck.prototype['labels'] = undefined;

/**
 * @member {String} lastRunError
 */
CustomCheck.prototype['lastRunError'] = undefined;

/**
 * @member {module:model/CustomCheck.LastRunStatusEnum} lastRunStatus
 */
CustomCheck.prototype['lastRunStatus'] = undefined;

/**
 * Timestamp of latest scheduled, completed run, RFC3339.
 * @member {Date} latestCompleted
 */
CustomCheck.prototype['latestCompleted'] = undefined;

/**
 * @member {module:model/CheckBaseLinks} links
 */
CustomCheck.prototype['links'] = undefined;

/**
 * @member {String} name
 */
CustomCheck.prototype['name'] = undefined;

/**
 * The ID of the organization that owns this check.
 * @member {String} orgID
 */
CustomCheck.prototype['orgID'] = undefined;

/**
 * The ID of creator used to create this check.
 * @member {String} ownerID
 */
CustomCheck.prototype['ownerID'] = undefined;

/**
 * @member {module:model/DashboardQuery} query
 */
CustomCheck.prototype['query'] = undefined;

/**
 * @member {module:model/TaskStatusType} status
 */
CustomCheck.prototype['status'] = undefined;

/**
 * The ID of the task associated with this check.
 * @member {String} taskID
 */
CustomCheck.prototype['taskID'] = undefined;

/**
 * @member {Date} updatedAt
 */
CustomCheck.prototype['updatedAt'] = undefined;

/**
 * @member {module:model/CustomCheck.TypeEnum} type
 */
CustomCheck.prototype['type'] = undefined;
