...
QList<OAIDictItem> OAIExpression::getElements() const {
    return m_elements;
}
void OAIExpression::setElements(const QList<OAIDictItem> &elements) {
    m_elements = elements;
    m_elements_isSet = true;
}

bool OAIExpression::is_elements_Set() const{
    return m_elements_isSet;
}

bool OAIExpression::is_elements_Valid() const{
...
OAINode OAIExpression::getBody() const {
    return m_body;
}
void OAIExpression::setBody(const OAINode &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIExpression::is_body_Set() const{
    return m_body_isSet;
}

bool OAIExpression::is_body_Valid() const{
    return m_body_isValid;
}

QList<OAIProperty> OAIExpression::getParams() const {
    return m_params;
}
void OAIExpression::setParams(const QList<OAIProperty> &params) {
    m_params = params;
    m_params_isSet = true;
}

bool OAIExpression::is_params_Set() const{
    return m_params_isSet;
}

bool OAIExpression::is_params_Valid() const{
    return m_params_isValid;
}

OAIExpression OAIExpression::getLeft() const {
    return m_left;
}
void OAIExpression::setLeft(const OAIExpression &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIExpression::is_left_Set() const{
    return m_left_isSet;
}

bool OAIExpression::is_left_Valid() const{
    return m_left_isValid;
}

QString OAIExpression::getROperator() const {
    return m_r_operator;
}
void OAIExpression::setROperator(const QString &r_operator) {
    m_r_operator = r_operator;
    m_r_operator_isSet = true;
}

bool OAIExpression::is_r_operator_Set() const{
    return m_r_operator_isSet;
}

bool OAIExpression::is_r_operator_Valid() const{
    return m_r_operator_isValid;
}

OAIExpression OAIExpression::getRight() const {
    return m_right;
}
void OAIExpression::setRight(const OAIExpression &right) {
    m_right = right;
    m_right_isSet = true;
}

bool OAIExpression::is_right_Set() const{
    return m_right_isSet;
}

bool OAIExpression::is_right_Valid() const{
    return m_right_isValid;
}

QList<OAIExpression> OAIExpression::getArguments() const {
    return m_arguments;
}
void OAIExpression::setArguments(const QList<OAIExpression> &arguments) {
    m_arguments = arguments;
    m_arguments_isSet = true;
}

bool OAIExpression::is_arguments_Set() const{
    return m_arguments_isSet;
}

bool OAIExpression::is_arguments_Valid() const{
    return m_arguments_isValid;
}

OAIExpression OAIExpression::getCallee() const {
    return m_callee;
}
void OAIExpression::setCallee(const OAIExpression &callee) {
    m_callee = callee;
    m_callee_isSet = true;
}

bool OAIExpression::is_callee_Set() const{
    return m_callee_isSet;
}

bool OAIExpression::is_callee_Valid() const{
    return m_callee_isValid;
}

OAIExpression OAIExpression::getAlternate() const {
    return m_alternate;
}
void OAIExpression::setAlternate(const OAIExpression &alternate) {
    m_alternate = alternate;
    m_alternate_isSet = true;
}

bool OAIExpression::is_alternate_Set() const{
    return m_alternate_isSet;
}

bool OAIExpression::is_alternate_Valid() const{
    return m_alternate_isValid;
}

OAIExpression OAIExpression::getConsequent() const {
    return m_consequent;
}
void OAIExpression::setConsequent(const OAIExpression &consequent) {
    m_consequent = consequent;
    m_consequent_isSet = true;
}

bool OAIExpression::is_consequent_Set() const{
    return m_consequent_isSet;
}

bool OAIExpression::is_consequent_Valid() const{
    return m_consequent_isValid;
}

OAIExpression OAIExpression::getTest() const {
    return m_test;
}
void OAIExpression::setTest(const OAIExpression &test) {
    m_test = test;
    m_test_isSet = true;
}

bool OAIExpression::is_test_Set() const{
    return m_test_isSet;
}

bool OAIExpression::is_test_Valid() const{
    return m_test_isValid;
}

OAIExpression OAIExpression::getObject() const {
    return m_object;
}
void OAIExpression::setObject(const OAIExpression &object) {
    m_object = object;
    m_object_isSet = true;
}

bool OAIExpression::is_object_Set() const{
    return m_object_isSet;
}

bool OAIExpression::is_object_Valid() const{
    return m_object_isValid;
}

OAIPropertyKey OAIExpression::getProperty() const {
    return m_property;
}
void OAIExpression::setProperty(const OAIPropertyKey &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIExpression::is_property_Set() const{
    return m_property_isSet;
}

bool OAIExpression::is_property_Valid() const{
    return m_property_isValid;
}

OAIExpression OAIExpression::getArray() const {
    return m_array;
}
void OAIExpression::setArray(const OAIExpression &array) {
    m_array = array;
    m_array_isSet = true;
}

bool OAIExpression::is_array_Set() const{
    return m_array_isSet;
}

bool OAIExpression::is_array_Valid() const{
    return m_array_isValid;
}

OAIExpression OAIExpression::getIndex() const {
    return m_index;
}
void OAIExpression::setIndex(const OAIExpression &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAIExpression::is_index_Set() const{
    return m_index_isSet;
}

bool OAIExpression::is_index_Valid() const{
    return m_index_isValid;
}

QList<OAIProperty> OAIExpression::getProperties() const {
    return m_properties;
}
void OAIExpression::setProperties(const QList<OAIProperty> &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIExpression::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIExpression::is_properties_Valid() const{
    return m_properties_isValid;
}

OAIExpression OAIExpression::getExpression() const {
    return m_expression;
}
void OAIExpression::setExpression(const OAIExpression &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAIExpression::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAIExpression::is_expression_Valid() const{
    return m_expression_isValid;
}

OAIExpression OAIExpression::getArgument() const {
    return m_argument;
}
void OAIExpression::setArgument(const OAIExpression &argument) {
    m_argument = argument;
    m_argument_isSet = true;
}

bool OAIExpression::is_argument_Set() const{
    return m_argument_isSet;
}

bool OAIExpression::is_argument_Valid() const{
    return m_argument_isValid;
}

OAICallExpression OAIExpression::getCall() const {
    return m_call;
}
void OAIExpression::setCall(const OAICallExpression &call) {
    m_call = call;
    m_call_isSet = true;
}

bool OAIExpression::is_call_Set() const{
    return m_call_isSet;
}

bool OAIExpression::is_call_Valid() const{
...
QList<OAIDuration> OAIExpression::getValues() const {
    return m_values;
}
void OAIExpression::setValues(const QList<OAIDuration> &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIExpression::is_values_Set() const{
    return m_values_isSet;
}

bool OAIExpression::is_values_Valid() const{
    return m_values_isValid;
}

QString OAIExpression::getName() const {
    return m_name;
}
void OAIExpression::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIExpression::is_name_Set() const{
    return m_name_isSet;
}

bool OAIExpression::is_name_Valid() const{
