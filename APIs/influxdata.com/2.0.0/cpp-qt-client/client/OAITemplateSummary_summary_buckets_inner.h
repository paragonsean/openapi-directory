...
/*
 * OAITemplateSummary_summary_buckets_inner.h
 *
 * 
 */

#ifndef OAITemplateSummary_summary_buckets_inner_H
#define OAITemplateSummary_summary_buckets_inner_H
...
class OAITemplateSummary_summary_buckets_inner : public OAIObject {
public:
    OAITemplateSummary_summary_buckets_inner();
    OAITemplateSummary_summary_buckets_inner(QString json);
    ~OAITemplateSummary_summary_buckets_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateSummary_summary_buckets_inner)

#endif // OAITemplateSummary_summary_buckets_inner_H
