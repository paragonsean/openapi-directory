...
/*
 * OAIPagerDutyNotificationRule.h
 *
 * 
 */

#ifndef OAIPagerDutyNotificationRule_H
#define OAIPagerDutyNotificationRule_H
...
class OAIPagerDutyNotificationRule : public OAIObject {
public:
    OAIPagerDutyNotificationRule();
    OAIPagerDutyNotificationRule(QString json);
    ~OAIPagerDutyNotificationRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagerDutyNotificationRule)

#endif // OAIPagerDutyNotificationRule_H
