...
public:
    ...
    */
    virtual void getHealth(const ::OpenAPI::OptionalParam<QString> &zap_trace_span = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void getHealthSignal(OAIHealthCheck summary);


    void getHealthSignalFull(OAIHttpRequestWorker *worker, OAIHealthCheck summary);

    Q_DECL_DEPRECATED_X("Use getHealthSignalError() instead")
    void getHealthSignalE(OAIHealthCheck summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getHealthSignalError(OAIHealthCheck summary, QNetworkReply::NetworkError error_type, const QString &error_str);
