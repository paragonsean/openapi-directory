...
#ifndef OAIVariable_links_H
#define OAIVariable_links_H
...
class OAIVariable_links : public OAIObject {
public:
    OAIVariable_links();
    OAIVariable_links(QString json);
    ~OAIVariable_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariable_links)

#endif // OAIVariable_links_H
