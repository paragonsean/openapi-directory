...
#ifndef OAIThresholdCheck_H
#define OAIThresholdCheck_H
...
class OAIThresholdCheck : public OAIObject {
public:
    OAIThresholdCheck();
    OAIThresholdCheck(QString json);
    ~OAIThresholdCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThresholdCheck)

#endif // OAIThresholdCheck_H
