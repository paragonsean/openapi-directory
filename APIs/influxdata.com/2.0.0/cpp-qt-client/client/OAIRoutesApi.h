...
public:
    ...
    */
    virtual void getRoutes(const ::OpenAPI::OptionalParam<QString> &zap_trace_span = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void getRoutesSignal(OAIRoutes summary);


    void getRoutesSignalFull(OAIHttpRequestWorker *worker, OAIRoutes summary);

    Q_DECL_DEPRECATED_X("Use getRoutesSignalError() instead")
    void getRoutesSignalE(OAIRoutes summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getRoutesSignalError(OAIRoutes summary, QNetworkReply::NetworkError error_type, const QString &error_str);
