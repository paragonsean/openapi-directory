...
/*
 * OAIReturnStatement.h
 *
 * Defines an expression to return
 */

#ifndef OAIReturnStatement_H
#define OAIReturnStatement_H
...
class OAIReturnStatement : public OAIObject {
public:
    OAIReturnStatement();
    OAIReturnStatement(QString json);
    ~OAIReturnStatement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnStatement)

#endif // OAIReturnStatement_H
