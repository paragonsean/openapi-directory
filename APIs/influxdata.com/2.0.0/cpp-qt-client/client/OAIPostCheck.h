...
#ifndef OAIPostCheck_H
#define OAIPostCheck_H
...
class OAIPostCheck : public OAIObject {
public:
    OAIPostCheck();
    OAIPostCheck(QString json);
    ~OAIPostCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCheck)

#endif // OAIPostCheck_H
