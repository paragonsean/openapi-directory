...
/*
 * OAIGreaterThreshold.h
 *
 * 
 */

#ifndef OAIGreaterThreshold_H
#define OAIGreaterThreshold_H
...
class OAIGreaterThreshold : public OAIObject {
public:
    OAIGreaterThreshold();
    OAIGreaterThreshold(QString json);
    ~OAIGreaterThreshold() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGreaterThreshold)

#endif // OAIGreaterThreshold_H
