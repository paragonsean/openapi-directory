...
/*
 * OAINotificationEndpointDiscriminator.h
 *
 * 
 */

#ifndef OAINotificationEndpointDiscriminator_H
#define OAINotificationEndpointDiscriminator_H
...
class OAINotificationEndpointDiscriminator : public OAIObject {
public:
    OAINotificationEndpointDiscriminator();
    OAINotificationEndpointDiscriminator(QString json);
    ~OAINotificationEndpointDiscriminator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationEndpointDiscriminator)

#endif // OAINotificationEndpointDiscriminator_H
