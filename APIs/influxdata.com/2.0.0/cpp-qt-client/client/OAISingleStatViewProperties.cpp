...
OAISingleStatViewProperties::OAISingleStatViewProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISingleStatViewProperties::OAISingleStatViewProperties() {
    this->initializeModel();
}

OAISingleStatViewProperties::~OAISingleStatViewProperties() {}

void OAISingleStatViewProperties::initializeModel() {
...
void OAISingleStatViewProperties::fromJson(QString jsonString) {
...
void OAISingleStatViewProperties::fromJsonObject(QJsonObject json) {
...
QString OAISingleStatViewProperties::asJson() const {
...
QJsonObject OAISingleStatViewProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_colors.size() > 0) {
...
QList<OAIDashboardColor> OAISingleStatViewProperties::getColors() const {
    return m_colors;
}
void OAISingleStatViewProperties::setColors(const QList<OAIDashboardColor> &colors) {
    m_colors = colors;
    m_colors_isSet = true;
}

bool OAISingleStatViewProperties::is_colors_Set() const{
    return m_colors_isSet;
}

bool OAISingleStatViewProperties::is_colors_Valid() const{
    return m_colors_isValid;
}

OAIDecimalPlaces OAISingleStatViewProperties::getDecimalPlaces() const {
    return m_decimal_places;
}
void OAISingleStatViewProperties::setDecimalPlaces(const OAIDecimalPlaces &decimal_places) {
    m_decimal_places = decimal_places;
    m_decimal_places_isSet = true;
}

bool OAISingleStatViewProperties::is_decimal_places_Set() const{
    return m_decimal_places_isSet;
}

bool OAISingleStatViewProperties::is_decimal_places_Valid() const{
    return m_decimal_places_isValid;
}

QString OAISingleStatViewProperties::getNote() const {
    return m_note;
}
void OAISingleStatViewProperties::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAISingleStatViewProperties::is_note_Set() const{
    return m_note_isSet;
}

bool OAISingleStatViewProperties::is_note_Valid() const{
    return m_note_isValid;
}

QString OAISingleStatViewProperties::getPrefix() const {
    return m_prefix;
}
void OAISingleStatViewProperties::setPrefix(const QString &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAISingleStatViewProperties::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAISingleStatViewProperties::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QList<OAIDashboardQuery> OAISingleStatViewProperties::getQueries() const {
    return m_queries;
}
void OAISingleStatViewProperties::setQueries(const QList<OAIDashboardQuery> &queries) {
    m_queries = queries;
    m_queries_isSet = true;
}

bool OAISingleStatViewProperties::is_queries_Set() const{
    return m_queries_isSet;
}

bool OAISingleStatViewProperties::is_queries_Valid() const{
    return m_queries_isValid;
}

QString OAISingleStatViewProperties::getShape() const {
    return m_shape;
}
void OAISingleStatViewProperties::setShape(const QString &shape) {
    m_shape = shape;
    m_shape_isSet = true;
}

bool OAISingleStatViewProperties::is_shape_Set() const{
    return m_shape_isSet;
}

bool OAISingleStatViewProperties::is_shape_Valid() const{
    return m_shape_isValid;
}

bool OAISingleStatViewProperties::isShowNoteWhenEmpty() const {
    return m_show_note_when_empty;
}
void OAISingleStatViewProperties::setShowNoteWhenEmpty(const bool &show_note_when_empty) {
    m_show_note_when_empty = show_note_when_empty;
    m_show_note_when_empty_isSet = true;
}

bool OAISingleStatViewProperties::is_show_note_when_empty_Set() const{
    return m_show_note_when_empty_isSet;
}

bool OAISingleStatViewProperties::is_show_note_when_empty_Valid() const{
    return m_show_note_when_empty_isValid;
}

OAIStaticLegend OAISingleStatViewProperties::getStaticLegend() const {
    return m_static_legend;
}
void OAISingleStatViewProperties::setStaticLegend(const OAIStaticLegend &static_legend) {
    m_static_legend = static_legend;
    m_static_legend_isSet = true;
}

bool OAISingleStatViewProperties::is_static_legend_Set() const{
    return m_static_legend_isSet;
}

bool OAISingleStatViewProperties::is_static_legend_Valid() const{
    return m_static_legend_isValid;
}

QString OAISingleStatViewProperties::getSuffix() const {
    return m_suffix;
}
void OAISingleStatViewProperties::setSuffix(const QString &suffix) {
    m_suffix = suffix;
    m_suffix_isSet = true;
}

bool OAISingleStatViewProperties::is_suffix_Set() const{
    return m_suffix_isSet;
}

bool OAISingleStatViewProperties::is_suffix_Valid() const{
    return m_suffix_isValid;
}

QString OAISingleStatViewProperties::getTickPrefix() const {
    return m_tick_prefix;
}
void OAISingleStatViewProperties::setTickPrefix(const QString &tick_prefix) {
    m_tick_prefix = tick_prefix;
    m_tick_prefix_isSet = true;
}

bool OAISingleStatViewProperties::is_tick_prefix_Set() const{
    return m_tick_prefix_isSet;
}

bool OAISingleStatViewProperties::is_tick_prefix_Valid() const{
    return m_tick_prefix_isValid;
}

QString OAISingleStatViewProperties::getTickSuffix() const {
    return m_tick_suffix;
}
void OAISingleStatViewProperties::setTickSuffix(const QString &tick_suffix) {
    m_tick_suffix = tick_suffix;
    m_tick_suffix_isSet = true;
}

bool OAISingleStatViewProperties::is_tick_suffix_Set() const{
    return m_tick_suffix_isSet;
}

bool OAISingleStatViewProperties::is_tick_suffix_Valid() const{
    return m_tick_suffix_isValid;
}

QString OAISingleStatViewProperties::getType() const {
    return m_type;
}
void OAISingleStatViewProperties::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISingleStatViewProperties::is_type_Set() const{
    return m_type_isSet;
}

bool OAISingleStatViewProperties::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISingleStatViewProperties::isSet() const {
...
bool OAISingleStatViewProperties::isValid() const {
