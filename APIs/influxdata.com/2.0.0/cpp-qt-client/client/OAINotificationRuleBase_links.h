...
/*
 * OAINotificationRuleBase_links.h
 *
 * 
 */

#ifndef OAINotificationRuleBase_links_H
#define OAINotificationRuleBase_links_H
...
class OAINotificationRuleBase_links : public OAIObject {
public:
    OAINotificationRuleBase_links();
    OAINotificationRuleBase_links(QString json);
    ~OAINotificationRuleBase_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationRuleBase_links)

#endif // OAINotificationRuleBase_links_H
