...
/*
 * OAITelegramNotificationRule.h
 *
 * 
 */

#ifndef OAITelegramNotificationRule_H
#define OAITelegramNotificationRule_H
...
class OAITelegramNotificationRule : public OAIObject {
public:
    OAITelegramNotificationRule();
    OAITelegramNotificationRule(QString json);
    ~OAITelegramNotificationRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITelegramNotificationRule)

#endif // OAITelegramNotificationRule_H
