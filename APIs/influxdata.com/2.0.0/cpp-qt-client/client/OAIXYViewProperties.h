...
/*
 * OAIXYViewProperties.h
 *
 * 
 */

#ifndef OAIXYViewProperties_H
#define OAIXYViewProperties_H
...
class OAIXYViewProperties : public OAIObject {
public:
    OAIXYViewProperties();
    OAIXYViewProperties(QString json);
    ~OAIXYViewProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXYViewProperties)

#endif // OAIXYViewProperties_H
