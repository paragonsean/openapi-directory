...
/*
 * OAIMosaicViewProperties.h
 *
 * 
 */

#ifndef OAIMosaicViewProperties_H
#define OAIMosaicViewProperties_H
...
class OAIMosaicViewProperties : public OAIObject {
public:
    OAIMosaicViewProperties();
    OAIMosaicViewProperties(QString json);
    ~OAIMosaicViewProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMosaicViewProperties)

#endif // OAIMosaicViewProperties_H
