...
OAITemplateSummary_diff::OAITemplateSummary_diff(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateSummary_diff::OAITemplateSummary_diff() {
    this->initializeModel();
}

OAITemplateSummary_diff::~OAITemplateSummary_diff() {}

void OAITemplateSummary_diff::initializeModel() {
...
void OAITemplateSummary_diff::fromJson(QString jsonString) {
...
void OAITemplateSummary_diff::fromJsonObject(QJsonObject json) {
...
QString OAITemplateSummary_diff::asJson() const {
...
QJsonObject OAITemplateSummary_diff::asJsonObject() const {
    QJsonObject obj;
    if (m_buckets.size() > 0) {
...
QList<OAITemplateSummary_diff_buckets_inner> OAITemplateSummary_diff::getBuckets() const {
    return m_buckets;
}
void OAITemplateSummary_diff::setBuckets(const QList<OAITemplateSummary_diff_buckets_inner> &buckets) {
    m_buckets = buckets;
    m_buckets_isSet = true;
}

bool OAITemplateSummary_diff::is_buckets_Set() const{
    return m_buckets_isSet;
}

bool OAITemplateSummary_diff::is_buckets_Valid() const{
    return m_buckets_isValid;
}

QList<OAITemplateSummary_diff_checks_inner> OAITemplateSummary_diff::getChecks() const {
    return m_checks;
}
void OAITemplateSummary_diff::setChecks(const QList<OAITemplateSummary_diff_checks_inner> &checks) {
    m_checks = checks;
    m_checks_isSet = true;
}

bool OAITemplateSummary_diff::is_checks_Set() const{
    return m_checks_isSet;
}

bool OAITemplateSummary_diff::is_checks_Valid() const{
    return m_checks_isValid;
}

QList<OAITemplateSummary_diff_dashboards_inner> OAITemplateSummary_diff::getDashboards() const {
    return m_dashboards;
}
void OAITemplateSummary_diff::setDashboards(const QList<OAITemplateSummary_diff_dashboards_inner> &dashboards) {
    m_dashboards = dashboards;
    m_dashboards_isSet = true;
}

bool OAITemplateSummary_diff::is_dashboards_Set() const{
    return m_dashboards_isSet;
}

bool OAITemplateSummary_diff::is_dashboards_Valid() const{
    return m_dashboards_isValid;
}

QList<OAITemplateSummary_diff_labelMappings_inner> OAITemplateSummary_diff::getLabelMappings() const {
    return m_label_mappings;
}
void OAITemplateSummary_diff::setLabelMappings(const QList<OAITemplateSummary_diff_labelMappings_inner> &label_mappings) {
    m_label_mappings = label_mappings;
    m_label_mappings_isSet = true;
}

bool OAITemplateSummary_diff::is_label_mappings_Set() const{
    return m_label_mappings_isSet;
}

bool OAITemplateSummary_diff::is_label_mappings_Valid() const{
    return m_label_mappings_isValid;
}

QList<OAITemplateSummary_diff_labels_inner> OAITemplateSummary_diff::getLabels() const {
    return m_labels;
}
void OAITemplateSummary_diff::setLabels(const QList<OAITemplateSummary_diff_labels_inner> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAITemplateSummary_diff::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAITemplateSummary_diff::is_labels_Valid() const{
    return m_labels_isValid;
}

QList<OAITemplateSummary_diff_notificationEndpoints_inner> OAITemplateSummary_diff::getNotificationEndpoints() const {
    return m_notification_endpoints;
}
void OAITemplateSummary_diff::setNotificationEndpoints(const QList<OAITemplateSummary_diff_notificationEndpoints_inner> &notification_endpoints) {
    m_notification_endpoints = notification_endpoints;
    m_notification_endpoints_isSet = true;
}

bool OAITemplateSummary_diff::is_notification_endpoints_Set() const{
    return m_notification_endpoints_isSet;
}

bool OAITemplateSummary_diff::is_notification_endpoints_Valid() const{
    return m_notification_endpoints_isValid;
}

QList<OAITemplateSummary_diff_notificationRules_inner> OAITemplateSummary_diff::getNotificationRules() const {
    return m_notification_rules;
}
void OAITemplateSummary_diff::setNotificationRules(const QList<OAITemplateSummary_diff_notificationRules_inner> &notification_rules) {
    m_notification_rules = notification_rules;
    m_notification_rules_isSet = true;
}

bool OAITemplateSummary_diff::is_notification_rules_Set() const{
    return m_notification_rules_isSet;
}

bool OAITemplateSummary_diff::is_notification_rules_Valid() const{
    return m_notification_rules_isValid;
}

QList<OAITemplateSummary_diff_tasks_inner> OAITemplateSummary_diff::getTasks() const {
    return m_tasks;
}
void OAITemplateSummary_diff::setTasks(const QList<OAITemplateSummary_diff_tasks_inner> &tasks) {
    m_tasks = tasks;
    m_tasks_isSet = true;
}

bool OAITemplateSummary_diff::is_tasks_Set() const{
    return m_tasks_isSet;
}

bool OAITemplateSummary_diff::is_tasks_Valid() const{
    return m_tasks_isValid;
}

QList<OAITemplateSummary_diff_telegrafConfigs_inner> OAITemplateSummary_diff::getTelegrafConfigs() const {
    return m_telegraf_configs;
}
void OAITemplateSummary_diff::setTelegrafConfigs(const QList<OAITemplateSummary_diff_telegrafConfigs_inner> &telegraf_configs) {
    m_telegraf_configs = telegraf_configs;
    m_telegraf_configs_isSet = true;
}

bool OAITemplateSummary_diff::is_telegraf_configs_Set() const{
    return m_telegraf_configs_isSet;
}

bool OAITemplateSummary_diff::is_telegraf_configs_Valid() const{
    return m_telegraf_configs_isValid;
}

QList<OAITemplateSummary_diff_variables_inner> OAITemplateSummary_diff::getVariables() const {
    return m_variables;
}
void OAITemplateSummary_diff::setVariables(const QList<OAITemplateSummary_diff_variables_inner> &variables) {
    m_variables = variables;
    m_variables_isSet = true;
}

bool OAITemplateSummary_diff::is_variables_Set() const{
    return m_variables_isSet;
}

bool OAITemplateSummary_diff::is_variables_Valid() const{
    return m_variables_isValid;
}

bool OAITemplateSummary_diff::isSet() const {
...
bool OAITemplateSummary_diff::isValid() const {
