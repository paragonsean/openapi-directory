...
/*
 * OAINotificationEndpointBase.h
 *
 * 
 */

#ifndef OAINotificationEndpointBase_H
#define OAINotificationEndpointBase_H
...
class OAINotificationEndpointBase : public OAIObject {
public:
    OAINotificationEndpointBase();
    OAINotificationEndpointBase(QString json);
    ~OAINotificationEndpointBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationEndpointBase)

#endif // OAINotificationEndpointBase_H
