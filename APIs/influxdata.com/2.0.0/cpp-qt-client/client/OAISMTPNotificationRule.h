...
/*
 * OAISMTPNotificationRule.h
 *
 * 
 */

#ifndef OAISMTPNotificationRule_H
#define OAISMTPNotificationRule_H
...
class OAISMTPNotificationRule : public OAIObject {
public:
    OAISMTPNotificationRule();
    OAISMTPNotificationRule(QString json);
    ~OAISMTPNotificationRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMTPNotificationRule)

#endif // OAISMTPNotificationRule_H
