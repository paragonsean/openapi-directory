...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("postSignin", defaultConf);
    _serverIndices.insert("postSignin", 0);
    _serverConfigs.insert("postSignout", defaultConf);
    _serverIndices.insert("postSignout", 0);
}
...
void OAIDefaultApi::postSignin(const ::OpenAPI::OptionalParam<QString> &zap_trace_span) {
    QString fullPath = QString(_serverConfigs["postSignin"][_serverIndices.value("postSignin")].URL()+"/signin");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::postSigninCallback);
...
void OAIDefaultApi::postSigninCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postSigninSignal();
        Q_EMIT postSigninSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postSigninSignalE(error_type, error_str);
        Q_EMIT postSigninSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postSigninSignalError(error_type, error_str);
        Q_EMIT postSigninSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::postSignout(const ::OpenAPI::OptionalParam<QString> &zap_trace_span) {
    QString fullPath = QString(_serverConfigs["postSignout"][_serverIndices.value("postSignout")].URL()+"/signout");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::postSignoutCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::postSignoutCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postSignoutSignal();
        Q_EMIT postSignoutSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postSignoutSignalE(error_type, error_str);
        Q_EMIT postSignoutSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postSignoutSignalError(error_type, error_str);
        Q_EMIT postSignoutSignalErrorFull(worker, error_type, error_str);
    }
}
