...
/*
 * OAITelegraf_allOf_links.h
 *
 * 
 */

#ifndef OAITelegraf_allOf_links_H
#define OAITelegraf_allOf_links_H
...
class OAITelegraf_allOf_links : public OAIObject {
public:
    OAITelegraf_allOf_links();
    OAITelegraf_allOf_links(QString json);
    ~OAITelegraf_allOf_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITelegraf_allOf_links)

#endif // OAITelegraf_allOf_links_H
