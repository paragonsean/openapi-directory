...
/*
 * OAITemplateSummary_summary_variables_inner.h
 *
 * 
 */

#ifndef OAITemplateSummary_summary_variables_inner_H
#define OAITemplateSummary_summary_variables_inner_H
...
class OAITemplateSummary_summary_variables_inner : public OAIObject {
public:
    OAITemplateSummary_summary_variables_inner();
    OAITemplateSummary_summary_variables_inner(QString json);
    ~OAITemplateSummary_summary_variables_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateSummary_summary_variables_inner)

#endif // OAITemplateSummary_summary_variables_inner_H
