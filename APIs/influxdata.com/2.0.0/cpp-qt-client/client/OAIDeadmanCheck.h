...
#ifndef OAIDeadmanCheck_H
#define OAIDeadmanCheck_H
...
class OAIDeadmanCheck : public OAIObject {
public:
    OAIDeadmanCheck();
    OAIDeadmanCheck(QString json);
    ~OAIDeadmanCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeadmanCheck)

#endif // OAIDeadmanCheck_H
