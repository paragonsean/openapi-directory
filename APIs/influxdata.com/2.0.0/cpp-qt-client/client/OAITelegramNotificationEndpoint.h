...
/*
 * OAITelegramNotificationEndpoint.h
 *
 * 
 */

#ifndef OAITelegramNotificationEndpoint_H
#define OAITelegramNotificationEndpoint_H
...
class OAITelegramNotificationEndpoint : public OAIObject {
public:
    OAITelegramNotificationEndpoint();
    OAITelegramNotificationEndpoint(QString json);
    ~OAITelegramNotificationEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITelegramNotificationEndpoint)

#endif // OAITelegramNotificationEndpoint_H
