...
/*
 * OAIHTTPNotificationEndpoint.h
 *
 * 
 */

#ifndef OAIHTTPNotificationEndpoint_H
#define OAIHTTPNotificationEndpoint_H
...
class OAIHTTPNotificationEndpoint : public OAIObject {
public:
    OAIHTTPNotificationEndpoint();
    OAIHTTPNotificationEndpoint(QString json);
    ~OAIHTTPNotificationEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHTTPNotificationEndpoint)

#endif // OAIHTTPNotificationEndpoint_H
