...
#ifndef OAICustomCheck_H
#define OAICustomCheck_H
...
class OAICustomCheck : public OAIObject {
public:
    OAICustomCheck();
    OAICustomCheck(QString json);
    ~OAICustomCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomCheck)

#endif // OAICustomCheck_H
