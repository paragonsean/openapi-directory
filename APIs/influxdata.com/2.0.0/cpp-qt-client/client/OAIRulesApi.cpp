...
void OAIRulesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getNotificationRulesIDQuery", defaultConf);
    _serverIndices.insert("getNotificationRulesIDQuery", 0);
}
...
void OAIRulesApi::getNotificationRulesIDQuery(const QString &rule_id, const ::OpenAPI::OptionalParam<QString> &zap_trace_span) {
    QString fullPath = QString(_serverConfigs["getNotificationRulesIDQuery"][_serverIndices.value("getNotificationRulesIDQuery")].URL()+"/notificationRules/{ruleID}/query");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRulesApi::getNotificationRulesIDQueryCallback);
...
void OAIRulesApi::getNotificationRulesIDQueryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNotificationRulesIDQuerySignal(output);
        Q_EMIT getNotificationRulesIDQuerySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNotificationRulesIDQuerySignalE(output, error_type, error_str);
        Q_EMIT getNotificationRulesIDQuerySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNotificationRulesIDQuerySignalError(output, error_type, error_str);
        Q_EMIT getNotificationRulesIDQuerySignalErrorFull(worker, error_type, error_str);
    }
}
