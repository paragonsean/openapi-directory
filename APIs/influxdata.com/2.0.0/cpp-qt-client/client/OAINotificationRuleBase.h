...
/*
 * OAINotificationRuleBase.h
 *
 * 
 */

#ifndef OAINotificationRuleBase_H
#define OAINotificationRuleBase_H
...
class OAINotificationRuleBase : public OAIObject {
public:
    OAINotificationRuleBase();
    OAINotificationRuleBase(QString json);
    ~OAINotificationRuleBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationRuleBase)

#endif // OAINotificationRuleBase_H
