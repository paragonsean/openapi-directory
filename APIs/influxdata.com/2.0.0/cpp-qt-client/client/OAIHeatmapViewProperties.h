...
/*
 * OAIHeatmapViewProperties.h
 *
 * 
 */

#ifndef OAIHeatmapViewProperties_H
#define OAIHeatmapViewProperties_H
...
class OAIHeatmapViewProperties : public OAIObject {
public:
    OAIHeatmapViewProperties();
    OAIHeatmapViewProperties(QString json);
    ~OAIHeatmapViewProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeatmapViewProperties)

#endif // OAIHeatmapViewProperties_H
