...
/*
 * OAILinePlusSingleStatProperties.h
 *
 * 
 */

#ifndef OAILinePlusSingleStatProperties_H
#define OAILinePlusSingleStatProperties_H
...
class OAILinePlusSingleStatProperties : public OAIObject {
public:
    OAILinePlusSingleStatProperties();
    OAILinePlusSingleStatProperties(QString json);
    ~OAILinePlusSingleStatProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinePlusSingleStatProperties)

#endif // OAILinePlusSingleStatProperties_H
