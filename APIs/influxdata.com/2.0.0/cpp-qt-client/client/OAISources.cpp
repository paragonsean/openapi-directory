...
OAIResourceMembers_links OAISources::getLinks() const {
    return m_links;
}
void OAISources::setLinks(const OAIResourceMembers_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAISources::is_links_Set() const{
    return m_links_isSet;
}

bool OAISources::is_links_Valid() const{
