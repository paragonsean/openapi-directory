...
/*
 * OAISlackNotificationRule.h
 *
 * 
 */

#ifndef OAISlackNotificationRule_H
#define OAISlackNotificationRule_H
...
class OAISlackNotificationRule : public OAIObject {
public:
    OAISlackNotificationRule();
    OAISlackNotificationRule(QString json);
    ~OAISlackNotificationRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlackNotificationRule)

#endif // OAISlackNotificationRule_H
