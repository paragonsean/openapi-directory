...
/*
 * OAIPostNotificationRule.h
 *
 * 
 */

#ifndef OAIPostNotificationRule_H
#define OAIPostNotificationRule_H
...
class OAIPostNotificationRule : public OAIObject {
public:
    OAIPostNotificationRule();
    OAIPostNotificationRule(QString json);
    ~OAIPostNotificationRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostNotificationRule)

#endif // OAIPostNotificationRule_H
