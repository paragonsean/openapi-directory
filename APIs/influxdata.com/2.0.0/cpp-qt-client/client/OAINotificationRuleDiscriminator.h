...
/*
 * OAINotificationRuleDiscriminator.h
 *
 * 
 */

#ifndef OAINotificationRuleDiscriminator_H
#define OAINotificationRuleDiscriminator_H
...
class OAINotificationRuleDiscriminator : public OAIObject {
public:
    OAINotificationRuleDiscriminator();
    OAINotificationRuleDiscriminator(QString json);
    ~OAINotificationRuleDiscriminator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationRuleDiscriminator)

#endif // OAINotificationRuleDiscriminator_H
