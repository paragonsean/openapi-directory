...
async def test_delete_dashboards_id_cells_id(client):
...
async def test_get_dashboards_id_cells_id_view(client):
...
async def test_patch_dashboards_id_cells_id(client):
...
async def test_patch_dashboards_id_cells_id_view(client):
...
async def test_post_dashboards_id_cells(client):
...
async def test_put_dashboards_id_cells(client):
