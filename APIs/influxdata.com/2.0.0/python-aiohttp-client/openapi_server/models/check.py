...
class Check(Model):
    ...
    def __init__(self, created_at: datetime=None, description: str=None, id: str=None, labels: List[Label]=None, last_run_error: str=None, last_run_status: str=None, latest_completed: datetime=None, links: CheckBaseLinks=None, name: str=None, org_id: str=None, owner_id: str=None, query: DashboardQuery=None, status: TaskStatusType=None, task_id: str=None, updated_at: datetime=None, every: str=None, level: CheckStatusLevel=None, offset: str=None, report_zero: bool=None, stale_time: str=None, status_message_template: str=None, tags: List[DeadmanCheckAllOfTags]=None, time_since: str=None, type: str=None, thresholds: List[Threshold]=None):
        ...
        :param labels: The labels of this Check.
        :param last_run_error: The last_run_error of this Check.
        :param last_run_status: The last_run_status of this Check.
        :param latest_completed: The latest_completed of this Check.
        :param links: The links of this Check.
        :param name: The name of this Check.
        :param org_id: The org_id of this Check.
        :param owner_id: The owner_id of this Check.
        :param query: The query of this Check.
        :param status: The status of this Check.
        :param task_id: The task_id of this Check.
        :param updated_at: The updated_at of this Check.
        :param every: The every of this Check.
        :param level: The level of this Check.
        :param offset: The offset of this Check.
        :param report_zero: The report_zero of this Check.
        :param stale_time: The stale_time of this Check.
        :param status_message_template: The status_message_template of this Check.
        :param tags: The tags of this Check.
        :param time_since: The time_since of this Check.
        :param type: The type of this Check.
        :param thresholds: The thresholds of this Check.
        """
        self.openapi_types = {
            'created_at': datetime,
            'description': str,
    ...
    @property
    def labels(self):
        """Gets the labels of this Check.


        :return: The labels of this Check.
        :rtype: List[Label]
        """
        return self._labels
    ...
    def last_run_error(self):
        """Gets the last_run_error of this Check.


        :return: The last_run_error of this Check.
        :rtype: str
        """
    ...
    def last_run_error(self, last_run_error):
        """Sets the last_run_error of this Check.
    ...
    def last_run_status(self):
        """Gets the last_run_status of this Check.


        :return: The last_run_status of this Check.
        :rtype: str
        """
    ...
    def last_run_status(self, last_run_status):
        """Sets the last_run_status of this Check.
    ...
    def latest_completed(self):
        """Gets the latest_completed of this Check.

        Timestamp of latest scheduled, completed run, RFC3339.

        :return: The latest_completed of this Check.
        :rtype: datetime
        """
    ...
    def latest_completed(self, latest_completed):
        """Sets the latest_completed of this Check.
    ...
    @property
    def links(self):
        """Gets the links of this Check.


        :return: The links of this Check.
    ...
    @property
    def org_id(self):
        """Gets the org_id of this Check.

        The ID of the organization that owns this check.

        :return: The org_id of this Check.
        :rtype: str
        """
        return self._org_id
    ...
    @property
    def owner_id(self):
        """Gets the owner_id of this Check.

        The ID of creator used to create this check.

        :return: The owner_id of this Check.
        :rtype: str
        """
    ...
    def owner_id(self, owner_id):
        """Sets the owner_id of this Check.
    ...
    @property
    def query(self):
        """Gets the query of this Check.


        :return: The query of this Check.
    ...
    @property
    def task_id(self):
        """Gets the task_id of this Check.

        The ID of the task associated with this check.

        :return: The task_id of this Check.
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        """Sets the task_id of this Check.
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this Check.


        :return: The updated_at of this Check.
        :rtype: datetime
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this Check.
    ...
    @property
    def every(self):
        """Gets the every of this Check.

        Check repetition interval.

        :return: The every of this Check.
        :rtype: str
        """
        return self._every
    ...
    @property
    def level(self):
        """Gets the level of this Check.


        :return: The level of this Check.
    ...
    @property
    def offset(self):
        """Gets the offset of this Check.

        Duration to delay after the schedule, before executing check.

        :return: The offset of this Check.
        :rtype: str
        """
        return self._offset
    ...
    def report_zero(self):
        """Gets the report_zero of this Check.

        If only zero values reported since time, trigger an alert

        :return: The report_zero of this Check.
        :rtype: bool
        """
    ...
    def report_zero(self, report_zero):
        """Sets the report_zero of this Check.
    ...
    def stale_time(self, stale_time):
        """Sets the stale_time of this Check.
    ...
    def status_message_template(self):
        """Gets the status_message_template of this Check.

        The template used to generate and write a status message.

        :return: The status_message_template of this Check.
        :rtype: str
        """
    ...
    def status_message_template(self, status_message_template):
        """Sets the status_message_template of this Check.
    ...
    @property
    def time_since(self):
        """Gets the time_since of this Check.

        String duration before deadman triggers.

        :return: The time_since of this Check.
        :rtype: str
        """
    ...
    def time_since(self, time_since):
        """Sets the time_since of this Check.
    ...
    @property
    def thresholds(self):
        """Gets the thresholds of this Check.


        :return: The thresholds of this Check.
    ...
    def thresholds(self, thresholds):
        """Sets the thresholds of this Check.
