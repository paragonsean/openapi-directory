...
class DeadmanCheck(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, created_at: datetime=None, description: str=None, id: str=None, labels: List[Label]=None, last_run_error: str=None, last_run_status: str=None, latest_completed: datetime=None, links: CheckBaseLinks=None, name: str=None, org_id: str=None, owner_id: str=None, query: DashboardQuery=None, status: TaskStatusType=None, task_id: str=None, updated_at: datetime=None, every: str=None, level: CheckStatusLevel=None, offset: str=None, report_zero: bool=None, stale_time: str=None, status_message_template: str=None, tags: List[DeadmanCheckAllOfTags]=None, time_since: str=None, type: str=None):
        """DeadmanCheck - a model defined in OpenAPI

        :param created_at: The created_at of this DeadmanCheck.
        :param description: The description of this DeadmanCheck.
        :param id: The id of this DeadmanCheck.
        :param labels: The labels of this DeadmanCheck.
        :param last_run_error: The last_run_error of this DeadmanCheck.
        :param last_run_status: The last_run_status of this DeadmanCheck.
        :param latest_completed: The latest_completed of this DeadmanCheck.
        :param links: The links of this DeadmanCheck.
        :param name: The name of this DeadmanCheck.
        :param org_id: The org_id of this DeadmanCheck.
        :param owner_id: The owner_id of this DeadmanCheck.
        :param query: The query of this DeadmanCheck.
        :param status: The status of this DeadmanCheck.
        :param task_id: The task_id of this DeadmanCheck.
        :param updated_at: The updated_at of this DeadmanCheck.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeadmanCheck':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeadmanCheck of this DeadmanCheck.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def created_at(self):
        """Gets the created_at of this DeadmanCheck.


        :return: The created_at of this DeadmanCheck.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this DeadmanCheck.
    ...
    def description(self):
        """Gets the description of this DeadmanCheck.

        An optional description of the check.

        :return: The description of this DeadmanCheck.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DeadmanCheck.
    ...
    @property
    def id(self):
        """Gets the id of this DeadmanCheck.


        :return: The id of this DeadmanCheck.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DeadmanCheck.
    ...
    @property
    def labels(self):
        """Gets the labels of this DeadmanCheck.


        :return: The labels of this DeadmanCheck.
        :rtype: List[Label]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this DeadmanCheck.
    ...
    def last_run_error(self):
        """Gets the last_run_error of this DeadmanCheck.


        :return: The last_run_error of this DeadmanCheck.
        :rtype: str
        """
    ...
    def last_run_error(self, last_run_error):
        """Sets the last_run_error of this DeadmanCheck.
    ...
    def last_run_status(self):
        """Gets the last_run_status of this DeadmanCheck.


        :return: The last_run_status of this DeadmanCheck.
        :rtype: str
        """
    ...
    def last_run_status(self, last_run_status):
        """Sets the last_run_status of this DeadmanCheck.
    ...
    def latest_completed(self):
        """Gets the latest_completed of this DeadmanCheck.

        Timestamp of latest scheduled, completed run, RFC3339.

        :return: The latest_completed of this DeadmanCheck.
        :rtype: datetime
        """
    ...
    def latest_completed(self, latest_completed):
        """Sets the latest_completed of this DeadmanCheck.
    ...
    @property
    def links(self):
        """Gets the links of this DeadmanCheck.


        :return: The links of this DeadmanCheck.
    ...
    def links(self, links):
        """Sets the links of this DeadmanCheck.
    ...
    @property
    def name(self):
        """Gets the name of this DeadmanCheck.


        :return: The name of this DeadmanCheck.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeadmanCheck.
    ...
    @property
    def org_id(self):
        """Gets the org_id of this DeadmanCheck.

        The ID of the organization that owns this check.

        :return: The org_id of this DeadmanCheck.
        :rtype: str
        """
        return self._org_id
    ...
    def org_id(self, org_id):
        """Sets the org_id of this DeadmanCheck.
    ...
    @property
    def owner_id(self):
        """Gets the owner_id of this DeadmanCheck.

        The ID of creator used to create this check.

        :return: The owner_id of this DeadmanCheck.
        :rtype: str
        """
    ...
    def owner_id(self, owner_id):
        """Sets the owner_id of this DeadmanCheck.
    ...
    @property
    def query(self):
        """Gets the query of this DeadmanCheck.


        :return: The query of this DeadmanCheck.
    ...
    def query(self, query):
        """Sets the query of this DeadmanCheck.
    ...
    @property
    def status(self):
        """Gets the status of this DeadmanCheck.


        :return: The status of this DeadmanCheck.
    ...
    def status(self, status):
        """Sets the status of this DeadmanCheck.
    ...
    @property
    def task_id(self):
        """Gets the task_id of this DeadmanCheck.

        The ID of the task associated with this check.

        :return: The task_id of this DeadmanCheck.
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        """Sets the task_id of this DeadmanCheck.
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this DeadmanCheck.


        :return: The updated_at of this DeadmanCheck.
        :rtype: datetime
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this DeadmanCheck.
    ...
    @property
    def every(self):
        """Gets the every of this DeadmanCheck.
    ...
    def every(self, every):
        """Sets the every of this DeadmanCheck.
    ...
    @property
    def level(self):
        """Gets the level of this DeadmanCheck.
    ...
    @property
    def offset(self):
        """Gets the offset of this DeadmanCheck.
    ...
    def offset(self, offset):
        """Sets the offset of this DeadmanCheck.
    ...
    def report_zero(self):
        """Gets the report_zero of this DeadmanCheck.
    ...
    @property
    def stale_time(self):
        """Gets the stale_time of this DeadmanCheck.
    ...
    def status_message_template(self):
        """Gets the status_message_template of this DeadmanCheck.
    ...
    def status_message_template(self, status_message_template):
        """Sets the status_message_template of this DeadmanCheck.
    ...
    @property
    def tags(self):
        """Gets the tags of this DeadmanCheck.
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this DeadmanCheck.
    ...
    @property
    def time_since(self):
        """Gets the time_since of this DeadmanCheck.
    ...
    @property
    def type(self):
        """Gets the type of this DeadmanCheck.
