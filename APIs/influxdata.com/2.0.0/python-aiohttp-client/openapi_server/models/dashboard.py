...
class Dashboard(Model):
    ...
    def __init__(self, description: str=None, name: str=None, org_id: str=None, cells: List[Cell]=None, id: str=None, labels: List[Label]=None, links: DashboardAllOfLinks=None, meta: DashboardAllOfMeta=None):
        ...
        :param org_id: The org_id of this Dashboard.
    ...
    @property
    def org_id(self):
        """Gets the org_id of this Dashboard.

        The ID of the organization that owns the dashboard.

        :return: The org_id of this Dashboard.
        :rtype: str
        """
        return self._org_id
    ...
    def org_id(self, org_id):
        """Sets the org_id of this Dashboard.
    ...
    @property
    def cells(self):
        """Gets the cells of this Dashboard.
    ...
    @property
    def links(self):
        """Gets the links of this Dashboard.
    ...
    @property
    def meta(self):
        """Gets the meta of this Dashboard.
