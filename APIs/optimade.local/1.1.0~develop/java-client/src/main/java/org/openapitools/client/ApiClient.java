...
public class ApiClient {
    ...
    private String basePath = "http://optimade.local";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.1.0~develop/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://optimade.local
