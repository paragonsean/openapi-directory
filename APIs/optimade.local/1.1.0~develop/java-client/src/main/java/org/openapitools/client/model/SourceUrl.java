...
public class SourceUrl extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SourceUrl.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SourceUrl.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SourceUrl' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SourceUrl>() {
                @Override
                public void write(JsonWriter out, SourceUrl value) throws IOException {
                ...
                @Override
                public SourceUrl read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for SourceUrl: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to SourceUrl
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for SourceUrl with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of SourceUrl given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SourceUrl
     * @throws IOException if the JSON string is invalid with respect to SourceUrl
     */
    public static SourceUrl fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SourceUrl.class);
    }

    /**
     * Convert an instance of SourceUrl to an JSON string
     *
     * @return JSON string
     */
