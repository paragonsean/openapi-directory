...
public class First extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!First.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'First' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<First>() {
                @Override
                public void write(JsonWriter out, First value) throws IOException {
                ...
                @Override
                public First read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for First: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to First
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for First with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of First given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of First
     * @throws IOException if the JSON string is invalid with respect to First
     */
    public static First fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, First.class);
    }

    /**
     * Convert an instance of First to an JSON string
     *
     * @return JSON string
     */
