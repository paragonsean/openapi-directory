...
public class Homepage1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Homepage1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Homepage1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Homepage1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Homepage1>() {
                @Override
                public void write(JsonWriter out, Homepage1 value) throws IOException {
                ...
                @Override
                public Homepage1 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Homepage1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Homepage1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Homepage1 with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Homepage1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Homepage1
     * @throws IOException if the JSON string is invalid with respect to Homepage1
     */
    public static Homepage1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Homepage1.class);
    }

    /**
     * Convert an instance of Homepage1 to an JSON string
     *
     * @return JSON string
     */
