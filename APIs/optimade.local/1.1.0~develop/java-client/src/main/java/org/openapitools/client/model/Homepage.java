...
public class Homepage extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Homepage.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Homepage' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Homepage>() {
                @Override
                public void write(JsonWriter out, Homepage value) throws IOException {
                ...
                @Override
                public Homepage read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Homepage: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Homepage
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Homepage with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Homepage given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Homepage
     * @throws IOException if the JSON string is invalid with respect to Homepage
     */
    public static Homepage fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Homepage.class);
    }

    /**
     * Convert an instance of Homepage to an JSON string
     *
     * @return JSON string
     */
