...
public class Homepage2 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Homepage2.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Homepage2.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Homepage2' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Homepage2>() {
                @Override
                public void write(JsonWriter out, Homepage2 value) throws IOException {
                ...
                @Override
                public Homepage2 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Homepage2: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Homepage2
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Homepage2 with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Homepage2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Homepage2
     * @throws IOException if the JSON string is invalid with respect to Homepage2
     */
    public static Homepage2 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Homepage2.class);
    }

    /**
     * Convert an instance of Homepage2 to an JSON string
     *
     * @return JSON string
     */
