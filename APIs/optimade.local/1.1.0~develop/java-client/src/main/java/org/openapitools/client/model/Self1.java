...
public class Self1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Self1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Self1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Self1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Self1>() {
                @Override
                public void write(JsonWriter out, Self1 value) throws IOException {
                ...
                @Override
                public Self1 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Self1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Self1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Self1 with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Self1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Self1
     * @throws IOException if the JSON string is invalid with respect to Self1
     */
    public static Self1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Self1.class);
    }

    /**
     * Convert an instance of Self1 to an JSON string
     *
     * @return JSON string
     */
