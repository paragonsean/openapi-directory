...
public class Related1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Related1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Related1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Related1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Related1>() {
                @Override
                public void write(JsonWriter out, Related1 value) throws IOException {
                ...
                @Override
                public Related1 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Related1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Related1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Related1 with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Related1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Related1
     * @throws IOException if the JSON string is invalid with respect to Related1
     */
    public static Related1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Related1.class);
    }

    /**
     * Convert an instance of Related1 to an JSON string
     *
     * @return JSON string
     */
