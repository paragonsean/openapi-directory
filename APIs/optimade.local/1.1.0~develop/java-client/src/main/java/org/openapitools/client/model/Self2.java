...
public class Self2 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Self2.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Self2.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Self2' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Self2>() {
                @Override
                public void write(JsonWriter out, Self2 value) throws IOException {
                ...
                @Override
                public Self2 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Self2: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Self2
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Self2 with anyOf schemas: Link, URI. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Self2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Self2
     * @throws IOException if the JSON string is invalid with respect to Self2
     */
    public static Self2 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Self2.class);
    }

    /**
     * Convert an instance of Self2 to an JSON string
     *
     * @return JSON string
     */
