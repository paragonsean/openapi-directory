...
public class LinksApi {
    ...
    /**
     * Build call for getLinksLinksGet
     ...
     */
    public okhttp3.Call getLinksLinksGetCall(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getLinksLinksGetValidateBeforeCall(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint, final ApiCallback _callback) throws ApiException {
        return getLinksLinksGetCall(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint, _callback);
     ...
     */
    public LinksResponse getLinksLinksGet(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint) throws ApiException {
        ApiResponse<LinksResponse> localVarResp = getLinksLinksGetWithHttpInfo(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint);
     ...
     */
    public ApiResponse<LinksResponse> getLinksLinksGetWithHttpInfo(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint) throws ApiException {
        okhttp3.Call localVarCall = getLinksLinksGetValidateBeforeCall(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint, null);
     ...
     */
    public okhttp3.Call getLinksLinksGetAsync(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint, final ApiCallback<LinksResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLinksLinksGetValidateBeforeCall(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint, _callback);
        Type localVarReturnType = new TypeToken<LinksResponse>(){}.getType();
