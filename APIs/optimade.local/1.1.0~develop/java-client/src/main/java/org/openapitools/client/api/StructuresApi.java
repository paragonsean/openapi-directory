...
public class StructuresApi {
    ...
    /**
     * Build call for getSingleStructureStructuresEntryIdGet
     ...
     */
    public okhttp3.Call getSingleStructureStructuresEntryIdGetCall(String entryId, String responseFormat, String emailAddress, String responseFields, String include, String apiHint, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/structures/{entry_id}"
    ...
    private okhttp3.Call getSingleStructureStructuresEntryIdGetValidateBeforeCall(String entryId, String responseFormat, String emailAddress, String responseFields, String include, String apiHint, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'entryId' is set
        if (entryId == null) {
            throw new ApiException("Missing the required parameter 'entryId' when calling getSingleStructureStructuresEntryIdGet(Async)");
        }

        return getSingleStructureStructuresEntryIdGetCall(entryId, responseFormat, emailAddress, responseFields, include, apiHint, _callback);
     ...
     */
    public StructureResponseOne getSingleStructureStructuresEntryIdGet(String entryId, String responseFormat, String emailAddress, String responseFields, String include, String apiHint) throws ApiException {
        ApiResponse<StructureResponseOne> localVarResp = getSingleStructureStructuresEntryIdGetWithHttpInfo(entryId, responseFormat, emailAddress, responseFields, include, apiHint);
     ...
     * @param include A server MAY implement the JSON API concept of returning [compound documents](https://jsonapi.org/format/1.0/#document-compound-documents) by utilizing the &#x60;include&#x60; query parameter as specified by [JSON API 1.0](https://jsonapi.org/format/1.0/#fetching-includes).  All related resource objects MUST be returned as part of an array value for the top-level &#x60;included&#x60; field, see the section JSON Response Schema: Common Fields.  The value of &#x60;include&#x60; MUST be a comma-separated list of \&quot;relationship paths\&quot;, as defined in the [JSON API](https://jsonapi.org/format/1.0/#fetching-includes). If relationship paths are not supported, or a server is unable to identify a relationship path a &#x60;400 Bad Request&#x60; response MUST be made.  The **default value** for &#x60;include&#x60; is &#x60;references&#x60;. This means &#x60;references&#x60; entries MUST always be included under the top-level field &#x60;included&#x60; as default, since a server assumes if &#x60;include&#x60; is not specified by a client in the request, it is still specified as &#x60;include&#x3D;references&#x60;. Note, if a client explicitly specifies &#x60;include&#x60; and leaves out &#x60;references&#x60;, &#x60;references&#x60; resource objects MUST NOT be included under the top-level field &#x60;included&#x60;, as per the definition of &#x60;included&#x60;, see section JSON Response Schema: Common Fields.  &gt; **Note**: A query with the parameter &#x60;include&#x60; set to the empty string means no related resource objects are to be returned under the top-level field &#x60;included&#x60;. (optional, default to references)
     * @param apiHint If the client provides the parameter, the value SHOULD have the format &#x60;vMAJOR&#x60; or &#x60;vMAJOR.MINOR&#x60;, where MAJOR is a major version and MINOR is a minor version of the API. For example, if a client appends &#x60;api_hint&#x3D;v1.0&#x60; to the query string, the hint provided is for major version 1 and minor version 0. (optional, default to )
     * @return ApiResponse&lt;StructureResponseOne&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<StructureResponseOne> getSingleStructureStructuresEntryIdGetWithHttpInfo(String entryId, String responseFormat, String emailAddress, String responseFields, String include, String apiHint) throws ApiException {
        okhttp3.Call localVarCall = getSingleStructureStructuresEntryIdGetValidateBeforeCall(entryId, responseFormat, emailAddress, responseFields, include, apiHint, null);
        Type localVarReturnType = new TypeToken<StructureResponseOne>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Single Structure (asynchronously)
     * 
     * @param entryId  (required)
     * @param responseFormat The output format requested (see section Response Format). Defaults to the format string &#39;json&#39;, which specifies the standard output format described in this specification. Example: &#x60;http://example.com/v1/structures?response_format&#x3D;xml&#x60; (optional, default to json)
     * @param emailAddress An email address of the user making the request. The email SHOULD be that of a person and not an automatic system. Example: &#x60;http://example.com/v1/structures?email_address&#x3D;user@example.com&#x60; (optional, default to )
     ...
     */
    public okhttp3.Call getSingleStructureStructuresEntryIdGetAsync(String entryId, String responseFormat, String emailAddress, String responseFields, String include, String apiHint, final ApiCallback<StructureResponseOne> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSingleStructureStructuresEntryIdGetValidateBeforeCall(entryId, responseFormat, emailAddress, responseFields, include, apiHint, _callback);
        Type localVarReturnType = new TypeToken<StructureResponseOne>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getStructuresStructuresGet
     ...
     */
    public okhttp3.Call getStructuresStructuresGetCall(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStructuresStructuresGetValidateBeforeCall(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint, final ApiCallback _callback) throws ApiException {
        return getStructuresStructuresGetCall(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint, _callback);
     ...
     */
    public StructureResponseMany getStructuresStructuresGet(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint) throws ApiException {
        ApiResponse<StructureResponseMany> localVarResp = getStructuresStructuresGetWithHttpInfo(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint);
        return localVarResp.getData();
    }
     ...
     * @param include A server MAY implement the JSON API concept of returning [compound documents](https://jsonapi.org/format/1.0/#document-compound-documents) by utilizing the &#x60;include&#x60; query parameter as specified by [JSON API 1.0](https://jsonapi.org/format/1.0/#fetching-includes).  All related resource objects MUST be returned as part of an array value for the top-level &#x60;included&#x60; field, see the section JSON Response Schema: Common Fields.  The value of &#x60;include&#x60; MUST be a comma-separated list of \&quot;relationship paths\&quot;, as defined in the [JSON API](https://jsonapi.org/format/1.0/#fetching-includes). If relationship paths are not supported, or a server is unable to identify a relationship path a &#x60;400 Bad Request&#x60; response MUST be made.  The **default value** for &#x60;include&#x60; is &#x60;references&#x60;. This means &#x60;references&#x60; entries MUST always be included under the top-level field &#x60;included&#x60; as default, since a server assumes if &#x60;include&#x60; is not specified by a client in the request, it is still specified as &#x60;include&#x3D;references&#x60;. Note, if a client explicitly specifies &#x60;include&#x60; and leaves out &#x60;references&#x60;, &#x60;references&#x60; resource objects MUST NOT be included under the top-level field &#x60;included&#x60;, as per the definition of &#x60;included&#x60;, see section JSON Response Schema: Common Fields.  &gt; **Note**: A query with the parameter &#x60;include&#x60; set to the empty string means no related resource objects are to be returned under the top-level field &#x60;included&#x60;. (optional, default to references)
     * @param apiHint If the client provides the parameter, the value SHOULD have the format &#x60;vMAJOR&#x60; or &#x60;vMAJOR.MINOR&#x60;, where MAJOR is a major version and MINOR is a minor version of the API. For example, if a client appends &#x60;api_hint&#x3D;v1.0&#x60; to the query string, the hint provided is for major version 1 and minor version 0. (optional, default to )
     * @return ApiResponse&lt;StructureResponseMany&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<StructureResponseMany> getStructuresStructuresGetWithHttpInfo(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint) throws ApiException {
        okhttp3.Call localVarCall = getStructuresStructuresGetValidateBeforeCall(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint, null);
        Type localVarReturnType = new TypeToken<StructureResponseMany>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getStructuresStructuresGetAsync(String filter, String responseFormat, String emailAddress, String responseFields, String sort, Integer pageLimit, Integer pageOffset, Integer pageNumber, Integer pageCursor, Integer pageAbove, Integer pageBelow, String include, String apiHint, final ApiCallback<StructureResponseMany> _callback) throws ApiException {

        okhttp3.Call localVarCall = getStructuresStructuresGetValidateBeforeCall(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint, _callback);
        Type localVarReturnType = new TypeToken<StructureResponseMany>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
