...
|------------- | ------------- | -------------|
| [**getReferencesReferencesGet**](ReferencesApi.md#getReferencesReferencesGet) | **GET** /references | Get References |
| [**getSingleReferenceReferencesEntryIdGet**](ReferencesApi.md#getSingleReferenceReferencesEntryIdGet) | **GET** /references/{entry_id} | Get Single Reference |


<a id="getReferencesReferencesGet"></a>
# **getReferencesReferencesGet**
> ReferenceResponseMany getReferencesReferencesGet(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ReferenceResponseMany result = apiInstance.getReferencesReferencesGet(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ReferencesApi#getReferencesReferencesGet");
...
[**ReferenceResponseMany**](ReferenceResponseMany.md)
...
<a id="getSingleReferenceReferencesEntryIdGet"></a>
# **getSingleReferenceReferencesEntryIdGet**
> ReferenceResponseOne getSingleReferenceReferencesEntryIdGet(entryId, responseFormat, emailAddress, responseFields, include, apiHint)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiHint = ""; // String | If the client provides the parameter, the value SHOULD have the format `vMAJOR` or `vMAJOR.MINOR`, where MAJOR is a major version and MINOR is a minor version of the API. For example, if a client appends `api_hint=v1.0` to the query string, the hint provided is for major version 1 and minor version 0.
    try {
      ReferenceResponseOne result = apiInstance.getSingleReferenceReferencesEntryIdGet(entryId, responseFormat, emailAddress, responseFields, include, apiHint);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ReferencesApi#getSingleReferenceReferencesEntryIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**ReferenceResponseOne**](ReferenceResponseOne.md)
