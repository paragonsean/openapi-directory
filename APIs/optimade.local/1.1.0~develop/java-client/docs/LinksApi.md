...
<a id="getLinksLinksGet"></a>
# **getLinksLinksGet**
> LinksResponse getLinksLinksGet(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      LinksResponse result = apiInstance.getLinksLinksGet(filter, responseFormat, emailAddress, responseFields, sort, pageLimit, pageOffset, pageNumber, pageCursor, pageAbove, pageBelow, include, apiHint);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LinksApi#getLinksLinksGet");
