...
|**dataAvailable** | **Integer** | An integer containing the total number of data resource objects available in the database for the endpoint. |  [optional] |
|**dataReturned** | **Integer** | An integer containing the total number of data resource objects returned for the current &#x60;filter&#x60; query, independent of pagination. |  [optional] |
