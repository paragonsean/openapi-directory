...
#ifndef OAIOptimadeError_H
#define OAIOptimadeError_H
...
class OAIOptimadeError : public OAIObject {
public:
    OAIOptimadeError();
    OAIOptimadeError(QString json);
    ~OAIOptimadeError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOptimadeError)

#endif // OAIOptimadeError_H
