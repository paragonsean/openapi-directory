...
#ifndef OAIBase_Url_H
#define OAIBase_Url_H
...
class OAIBase_Url : public OAIObject {
public:
    OAIBase_Url();
    OAIBase_Url(QString json);
    ~OAIBase_Url() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBase_Url)
