...
QString OAIAbout::getHref() const {
    return m_href;
}
void OAIAbout::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAIAbout::is_href_Set() const{
    return m_href_isSet;
}

bool OAIAbout::is_href_Valid() const{
    return m_href_isValid;
}

OAIObject OAIAbout::getMeta() const {
    return m_meta;
}
void OAIAbout::setMeta(const OAIObject &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIAbout::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIAbout::is_meta_Valid() const{
