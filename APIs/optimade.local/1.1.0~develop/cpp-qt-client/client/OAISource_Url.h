...
#ifndef OAISource_Url_H
#define OAISource_Url_H
...
class OAISource_Url : public OAIObject {
public:
    OAISource_Url();
    OAISource_Url(QString json);
    ~OAISource_Url() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISource_Url)

#endif // OAISource_Url_H
