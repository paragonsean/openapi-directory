...
namespace OpenAPI {
class OAIStructureResourceAttributes;
class OAIResourceLinks;
class OAIEntryRelationships;

class OAIData_6 : public OAIObject {
public:
    OAIData_6();
    OAIData_6(QString json);
    ~OAIData_6() override;
    ...
    OAIStructureResourceAttributes getAttributes() const;
    void setAttributes(const OAIStructureResourceAttributes &attributes);
...
private:
    ...
    OAIStructureResourceAttributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIData_6)
