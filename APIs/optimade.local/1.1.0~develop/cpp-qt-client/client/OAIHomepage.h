...
#ifndef OAIHomepage_H
#define OAIHomepage_H
...
class OAIHomepage : public OAIObject {
public:
    OAIHomepage();
    OAIHomepage(QString json);
    ~OAIHomepage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHomepage)
