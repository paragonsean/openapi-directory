...
#ifndef OAIHomepage_2_H
#define OAIHomepage_2_H
...
class OAIHomepage_2 : public OAIObject {
public:
    OAIHomepage_2();
    OAIHomepage_2(QString json);
    ~OAIHomepage_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHomepage_2)

#endif // OAIHomepage_2_H
