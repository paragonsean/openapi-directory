...
#ifndef OAILinksResponse_H
#define OAILinksResponse_H
...
class OAILinksResponse : public OAIObject {
public:
    OAILinksResponse();
    OAILinksResponse(QString json);
    ~OAILinksResponse() override;
    ...
    OAIData_1 getData() const;
    void setData(const OAIData_1 &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAILinksResponse)

#endif // OAILinksResponse_H
