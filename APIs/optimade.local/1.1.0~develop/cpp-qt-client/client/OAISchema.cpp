...
QString OAISchema::getHref() const {
    return m_href;
}
void OAISchema::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAISchema::is_href_Set() const{
    return m_href_isSet;
}

bool OAISchema::is_href_Valid() const{
    return m_href_isValid;
}

OAIObject OAISchema::getMeta() const {
    return m_meta;
}
void OAISchema::setMeta(const OAIObject &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAISchema::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAISchema::is_meta_Valid() const{
