...
#ifndef OAILinksResource_H
#define OAILinksResource_H
...
namespace OpenAPI {
class OAILinksResourceAttributes;
class OAIResourceLinks;
class OAIEntryRelationships;

class OAILinksResource : public OAIObject {
public:
    OAILinksResource();
    OAILinksResource(QString json);
    ~OAILinksResource() override;
    ...
    OAILinksResourceAttributes getAttributes() const;
    void setAttributes(const OAILinksResourceAttributes &attributes);
...
private:
    ...
    OAILinksResourceAttributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinksResource)

#endif // OAILinksResource_H
