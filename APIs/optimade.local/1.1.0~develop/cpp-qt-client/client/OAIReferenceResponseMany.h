...
/*
 * OAIReferenceResponseMany.h
 *
 * errors are not allowed
 */

#ifndef OAIReferenceResponseMany_H
#define OAIReferenceResponseMany_H
...
class OAIReferenceResponseMany : public OAIObject {
public:
    OAIReferenceResponseMany();
    OAIReferenceResponseMany(QString json);
    ~OAIReferenceResponseMany() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceResponseMany)

#endif // OAIReferenceResponseMany_H
