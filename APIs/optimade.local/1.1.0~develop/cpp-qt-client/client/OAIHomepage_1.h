...
#ifndef OAIHomepage_1_H
#define OAIHomepage_1_H
...
class OAIHomepage_1 : public OAIObject {
public:
    OAIHomepage_1();
    OAIHomepage_1(QString json);
    ~OAIHomepage_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHomepage_1)

#endif // OAIHomepage_1_H
