...
/*
 * OAIStructureResource.h
 *
 * Representing a structure.
 */

#ifndef OAIStructureResource_H
#define OAIStructureResource_H
...
class OAIStructureResource : public OAIObject {
public:
    OAIStructureResource();
    OAIStructureResource(QString json);
    ~OAIStructureResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStructureResource)

#endif // OAIStructureResource_H
