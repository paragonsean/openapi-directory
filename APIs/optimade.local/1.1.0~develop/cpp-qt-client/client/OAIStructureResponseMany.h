...
/*
 * OAIStructureResponseMany.h
 *
 * errors are not allowed
 */

#ifndef OAIStructureResponseMany_H
#define OAIStructureResponseMany_H
...
class OAIStructureResponseMany : public OAIObject {
public:
    OAIStructureResponseMany();
    OAIStructureResponseMany(QString json);
    ~OAIStructureResponseMany() override;
    ...
    OAIData_5 getData() const;
    void setData(const OAIData_5 &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStructureResponseMany)

#endif // OAIStructureResponseMany_H
