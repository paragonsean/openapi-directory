...
OAIResourceLinks OAIResource::getLinks() const {
    return m_links;
}
void OAIResource::setLinks(const OAIResourceLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIResource::is_links_Set() const{
    return m_links_isSet;
}

bool OAIResource::is_links_Valid() const{
    return m_links_isValid;
}

OAIObject OAIResource::getMeta() const {
    return m_meta;
}
void OAIResource::setMeta(const OAIObject &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIResource::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIResource::is_meta_Valid() const{
    return m_meta_isValid;
}

OAIObject OAIResource::getRelationships() const {
    return m_relationships;
}
void OAIResource::setRelationships(const OAIObject &relationships) {
