# OptimadeApi.EntryResource

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**attributes** | [**EntryResourceAttributes**](EntryResourceAttributes.md) | A dictionary, containing key-value pairs representing the entry&#39;s properties, except for &#x60;type&#x60; and &#x60;id&#x60;. Database-provider-specific properties need to include the database-provider-specific prefix (see section on Database-Provider-Specific Namespace Prefixes). | 
