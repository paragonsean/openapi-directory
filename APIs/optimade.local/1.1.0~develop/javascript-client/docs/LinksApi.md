# OptimadeApi.LinksApi

All URIs are relative to *http://optimade.local*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getLinksLinksGet**](LinksApi.md#getLinksLinksGet) | **GET** /links | Get Links



## getLinksLinksGet

> LinksResponse getLinksLinksGet(opts)
...
let apiInstance = new OptimadeApi.LinksApi();
let opts = {
...
apiInstance.getLinksLinksGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
