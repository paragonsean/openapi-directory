...
import BaseInfoResource from './BaseInfoResource';
...
class InfoResponse {
     ...
     * @param data {module:model/BaseInfoResource} The implementations /info data
     * @param meta {module:model/ResponseMeta} A meta object containing non-standard information
     */
    constructor(data, meta) { 
        
        InfoResponse.initialize(this, data, meta);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], BaseInfoResource);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of InfoResponse.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          BaseInfoResource.validateJSON(data['data']);
        }
