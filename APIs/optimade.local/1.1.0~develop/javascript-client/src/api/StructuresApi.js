...
export default class StructuresApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getSingleStructureStructuresEntryIdGet operation.
     * @callback module:api/StructuresApi~getSingleStructureStructuresEntryIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StructureResponseOne} data The data returned by the service call.
     ...
     * @param {module:api/StructuresApi~getSingleStructureStructuresEntryIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StructureResponseOne}
     */
    getSingleStructureStructuresEntryIdGet(entryId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'entryId' is set
      if (entryId === undefined || entryId === null) {
        throw new Error("Missing the required parameter 'entryId' when calling getSingleStructureStructuresEntryIdGet");
      }
      ...
      let returnType = StructureResponseOne;
      return this.apiClient.callApi(
        '/structures/{entry_id}', 'GET',
    ...
    /**
     * Callback function to receive the result of the getStructuresStructuresGet operation.
     * @callback module:api/StructuresApi~getStructuresStructuresGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StructureResponseMany} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [include = 'references')] A server MAY implement the JSON API concept of returning [compound documents](https://jsonapi.org/format/1.0/#document-compound-documents) by utilizing the `include` query parameter as specified by [JSON API 1.0](https://jsonapi.org/format/1.0/#fetching-includes).  All related resource objects MUST be returned as part of an array value for the top-level `included` field, see the section JSON Response Schema: Common Fields.  The value of `include` MUST be a comma-separated list of \"relationship paths\", as defined in the [JSON API](https://jsonapi.org/format/1.0/#fetching-includes). If relationship paths are not supported, or a server is unable to identify a relationship path a `400 Bad Request` response MUST be made.  The **default value** for `include` is `references`. This means `references` entries MUST always be included under the top-level field `included` as default, since a server assumes if `include` is not specified by a client in the request, it is still specified as `include=references`. Note, if a client explicitly specifies `include` and leaves out `references`, `references` resource objects MUST NOT be included under the top-level field `included`, as per the definition of `included`, see section JSON Response Schema: Common Fields.  > **Note**: A query with the parameter `include` set to the empty string means no related resource objects are to be returned under the top-level field `included`.
     * @param {String} [apiHint = '')] If the client provides the parameter, the value SHOULD have the format `vMAJOR` or `vMAJOR.MINOR`, where MAJOR is a major version and MINOR is a minor version of the API. For example, if a client appends `api_hint=v1.0` to the query string, the hint provided is for major version 1 and minor version 0.
     * @param {module:api/StructuresApi~getStructuresStructuresGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StructureResponseMany}
     */
    getStructuresStructuresGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = StructureResponseMany;
      return this.apiClient.callApi(
        '/structures', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
