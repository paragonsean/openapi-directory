...
export default class LinksApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getLinksLinksGet operation.
     * @callback module:api/LinksApi~getLinksLinksGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LinksResponse} data The data returned by the service call.
     ...
     * @param {module:api/LinksApi~getLinksLinksGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LinksResponse}
     */
    getLinksLinksGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
