...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OptimadeApi.ReferenceResponseOne();
  });
  ...
  describe('ReferenceResponseOne', function() {
    it('should create an instance of ReferenceResponseOne', function() {
      // uncomment below and update the code to test ReferenceResponseOne
      //var instance = new OptimadeApi.ReferenceResponseOne();
      //expect(instance).to.be.a(OptimadeApi.ReferenceResponseOne);
    });
