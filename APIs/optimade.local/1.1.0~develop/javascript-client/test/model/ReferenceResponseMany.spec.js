...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OptimadeApi.ReferenceResponseMany();
  });
  ...
  describe('ReferenceResponseMany', function() {
    it('should create an instance of ReferenceResponseMany', function() {
      // uncomment below and update the code to test ReferenceResponseMany
      //var instance = new OptimadeApi.ReferenceResponseMany();
      //expect(instance).to.be.a(OptimadeApi.ReferenceResponseMany);
    });
