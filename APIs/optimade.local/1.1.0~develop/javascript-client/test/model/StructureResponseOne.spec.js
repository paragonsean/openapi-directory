...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OptimadeApi.StructureResponseOne();
  });
  ...
  describe('StructureResponseOne', function() {
    it('should create an instance of StructureResponseOne', function() {
      // uncomment below and update the code to test StructureResponseOne
      //var instance = new OptimadeApi.StructureResponseOne();
      //expect(instance).to.be.a(OptimadeApi.StructureResponseOne);
    });
