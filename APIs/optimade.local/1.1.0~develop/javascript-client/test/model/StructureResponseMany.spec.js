...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OptimadeApi.StructureResponseMany();
  });
  ...
  describe('StructureResponseMany', function() {
    it('should create an instance of StructureResponseMany', function() {
      // uncomment below and update the code to test StructureResponseMany
      //var instance = new OptimadeApi.StructureResponseMany();
      //expect(instance).to.be.a(OptimadeApi.StructureResponseMany);
    });
