...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OptimadeApi.LinksResponse();
  });
  ...
  describe('LinksResponse', function() {
    it('should create an instance of LinksResponse', function() {
      // uncomment below and update the code to test LinksResponse
      //var instance = new OptimadeApi.LinksResponse();
      //expect(instance).to.be.a(OptimadeApi.LinksResponse);
    });
