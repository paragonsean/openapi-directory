...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OptimadeApi.ToplevelLinks();
  });
  ...
  describe('ToplevelLinks', function() {
    it('should create an instance of ToplevelLinks', function() {
      // uncomment below and update the code to test ToplevelLinks
      //var instance = new OptimadeApi.ToplevelLinks();
      //expect(instance).to.be.a(OptimadeApi.ToplevelLinks);
    });
