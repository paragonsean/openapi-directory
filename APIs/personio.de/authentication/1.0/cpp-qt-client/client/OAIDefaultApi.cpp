...
void OAIDefaultApi::authPost(const QString &client_id, const QString &client_secret) {
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("client_secret")).append(querySuffix).append(QUrl::toPercentEncoding(client_secret));
    }
...
void OAIDefaultApi::authPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAuthenticationTokenResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authPostSignal(output);
        Q_EMIT authPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authPostSignalE(output, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authPostSignalError(output, error_type, error_str);
