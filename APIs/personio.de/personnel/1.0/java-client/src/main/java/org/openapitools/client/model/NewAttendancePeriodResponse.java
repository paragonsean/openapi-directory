...
import org.openapitools.client.model.NewAttendancePeriodResponseAllOfData;
...
public class NewAttendancePeriodResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, newAttendancePeriodResponse.data) &&
        Objects.equals(this.success, newAttendancePeriodResponse.success);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewAttendancePeriodResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewAttendancePeriodResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewAttendancePeriodResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewAttendancePeriodResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      NewAttendancePeriodResponseAllOfData.validateJsonElement(jsonObj.get("data"));
  }
