...
public class ApiClient {
    ...
    private String basePath = "https://api.personio.de/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("auth", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.personio.de/v1
