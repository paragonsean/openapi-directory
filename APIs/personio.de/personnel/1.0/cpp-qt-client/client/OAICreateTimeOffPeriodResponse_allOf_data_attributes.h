...
/*
 * OAICreateTimeOffPeriodResponse_allOf_data_attributes.h
 *
 * 
 */

#ifndef OAICreateTimeOffPeriodResponse_allOf_data_attributes_H
#define OAICreateTimeOffPeriodResponse_allOf_data_attributes_H
...
class OAICreateTimeOffPeriodResponse_allOf_data_attributes : public OAIObject {
public:
    OAICreateTimeOffPeriodResponse_allOf_data_attributes();
    OAICreateTimeOffPeriodResponse_allOf_data_attributes(QString json);
    ~OAICreateTimeOffPeriodResponse_allOf_data_attributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTimeOffPeriodResponse_allOf_data_attributes)

#endif // OAICreateTimeOffPeriodResponse_allOf_data_attributes_H
