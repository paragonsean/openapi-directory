...
OAIObject OAIDepartment::getValue() const {
    return m_value;
}
void OAIDepartment::setValue(const OAIObject &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDepartment::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDepartment::is_value_Valid() const{
    return m_value_isValid;
}

QString OAIDepartment::getLabel() const {
    return m_label;
}
void OAIDepartment::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIDepartment::is_label_Set() const{
    return m_label_isSet;
}

bool OAIDepartment::is_label_Valid() const{
