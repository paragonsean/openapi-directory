...
/**
 * The CreateTimeOffPeriodResponseAllOfDataAttributes model module.
 * @module model/CreateTimeOffPeriodResponseAllOfDataAttributes
 * @version 1.0
 */
class CreateTimeOffPeriodResponseAllOfDataAttributes {
    /**
     * Constructs a new <code>CreateTimeOffPeriodResponseAllOfDataAttributes</code>.
     * @alias module:model/CreateTimeOffPeriodResponseAllOfDataAttributes
     */
    constructor() { 
        
        CreateTimeOffPeriodResponseAllOfDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTimeOffPeriodResponseAllOfDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTimeOffPeriodResponseAllOfDataAttributes} obj Optional instance to populate.
     * @return {module:model/CreateTimeOffPeriodResponseAllOfDataAttributes} The populated <code>CreateTimeOffPeriodResponseAllOfDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTimeOffPeriodResponseAllOfDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTimeOffPeriodResponseAllOfDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTimeOffPeriodResponseAllOfDataAttributes</code>.
     */
 ...
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['certificate'] = undefined;

/**
 * @member {String} created_at
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['created_at'] = undefined;

/**
 * @member {Number} days_count
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['days_count'] = undefined;

/**
 * @member {module:model/AbsencePeriodsResponseAllOfDataEmployee} employee
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['employee'] = undefined;

/**
 * @member {String} end_date
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['end_date'] = undefined;

/**
 * @member {Number} half_day_end
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['half_day_end'] = undefined;

/**
 * @member {Number} half_day_start
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['half_day_start'] = undefined;

/**
 * @member {Number} id
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['id'] = undefined;

/**
 * @member {String} start_date
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['start_date'] = undefined;

/**
 * @member {String} status
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['status'] = undefined;

/**
 * @member {module:model/AbsencePeriodsResponseAllOfDataTimeOffType} time_off_type
 */
CreateTimeOffPeriodResponseAllOfDataAttributes.prototype['time_off_type'] = undefined;
...
export default CreateTimeOffPeriodResponseAllOfDataAttributes;
