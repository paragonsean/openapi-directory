...
import org.openapitools.client.model.GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner;
...
public class GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner {
  ...
  private Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> equipment = new LinkedHashSet<>();

  public static final String SERIALIZED_NAME_INGREDIENTS = "ingredients";
  @SerializedName(SERIALIZED_NAME_INGREDIENTS)
  private Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> ingredients = new LinkedHashSet<>();
  ...
  public GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner equipment(Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> equipment) {
    this.equipment = equipment;
    return this;
  }

  public GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner addEquipmentItem(GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner equipmentItem) {
  ...
  public Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> getEquipment() {
    return equipment;
  }

  public void setEquipment(Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> equipment) {
    this.equipment = equipment;
  }


  public GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner ingredients(Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> ingredients) {
    this.ingredients = ingredients;
    return this;
  }

  public GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner addIngredientsItem(GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner ingredientsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> getIngredients() {
    return ingredients;
  }

  public void setIngredients(Set<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> ingredients) {
    this.ingredients = ingredients;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.equipment, getAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.equipment) &&
        Objects.equals(this.ingredients, getAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.ingredients) &&
        Objects.equals(this.number, getAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.number) &&
      ...
      if (jsonObj.get("equipment") != null && !jsonObj.get("equipment").isJsonNull()) {
        ...
        if (jsonArrayequipment != null) {
          ...
          for (int i = 0; i < jsonArrayequipment.size(); i++) {
            GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner.validateJsonElement(jsonArrayequipment.get(i));
          };
        }
      }
      if (jsonObj.get("ingredients") != null && !jsonObj.get("ingredients").isJsonNull()) {
        ...
        if (jsonArrayingredients != null) {
          ...
          for (int i = 0; i < jsonArrayingredients.size(); i++) {
            GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner.validateJsonElement(jsonArrayingredients.get(i));
          };
        }
      }
