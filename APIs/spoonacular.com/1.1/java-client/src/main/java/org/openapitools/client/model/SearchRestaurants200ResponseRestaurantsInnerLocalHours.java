...
public class SearchRestaurants200ResponseRestaurantsInnerLocalHours {
  ...
  private SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery delivery;

  public static final String SERIALIZED_NAME_DINE_IN = "dine_in";
  @SerializedName(SERIALIZED_NAME_DINE_IN)
  private SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery dineIn;

  public static final String SERIALIZED_NAME_OPERATIONAL = "operational";
  @SerializedName(SERIALIZED_NAME_OPERATIONAL)
  private SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery operational;

  public static final String SERIALIZED_NAME_PICKUP = "pickup";
  @SerializedName(SERIALIZED_NAME_PICKUP)
  private SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery pickup;

  public SearchRestaurants200ResponseRestaurantsInnerLocalHours() {
  }

  public SearchRestaurants200ResponseRestaurantsInnerLocalHours delivery(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery delivery) {
  ...
  public SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery getDelivery() {
    return delivery;
  }

  public void setDelivery(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery delivery) {
    this.delivery = delivery;
  }


  public SearchRestaurants200ResponseRestaurantsInnerLocalHours dineIn(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery dineIn) {
    this.dineIn = dineIn;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery getDineIn() {
    return dineIn;
  }

  public void setDineIn(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery dineIn) {
    this.dineIn = dineIn;
  }


  public SearchRestaurants200ResponseRestaurantsInnerLocalHours operational(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery operational) {
   ...
   */
  @javax.annotation.Nullable
  public SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery getOperational() {
    return operational;
  }

  public void setOperational(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery operational) {
    this.operational = operational;
  }


  public SearchRestaurants200ResponseRestaurantsInnerLocalHours pickup(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery pickup) {
    this.pickup = pickup;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery getPickup() {
    return pickup;
  }

  public void setPickup(SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery pickup) {
    this.pickup = pickup;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.delivery, searchRestaurants200ResponseRestaurantsInnerLocalHours.delivery) &&
        Objects.equals(this.dineIn, searchRestaurants200ResponseRestaurantsInnerLocalHours.dineIn) &&
        Objects.equals(this.operational, searchRestaurants200ResponseRestaurantsInnerLocalHours.operational) &&
        Objects.equals(this.pickup, searchRestaurants200ResponseRestaurantsInnerLocalHours.pickup);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delivery, dineIn, operational, pickup);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("delivery") != null && !jsonObj.get("delivery").isJsonNull()) {
        SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery.validateJsonElement(jsonObj.get("delivery"));
      }
      // validate the optional field `dine_in`
      if (jsonObj.get("dine_in") != null && !jsonObj.get("dine_in").isJsonNull()) {
        SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery.validateJsonElement(jsonObj.get("dine_in"));
      }
      // validate the optional field `operational`
      if (jsonObj.get("operational") != null && !jsonObj.get("operational").isJsonNull()) {
        SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery.validateJsonElement(jsonObj.get("operational"));
      }
      // validate the optional field `pickup`
      if (jsonObj.get("pickup") != null && !jsonObj.get("pickup").isJsonNull()) {
        SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery.validateJsonElement(jsonObj.get("pickup"));
      }
  }
