...
public class ApiClient {
    ...
    private String basePath = "https://api.spoonacular.com";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKeyScheme", new ApiKeyAuth("header", "x-api-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.spoonacular.com
