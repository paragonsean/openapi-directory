...
public class MealPlanningApi {
     ...
     * @param hash The private hash for the username. (required)
     * @param addToMealPlanRequest  (required)
     * @return AddToShoppingList200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://spoonacular.com/food-api/docs#Add-to-Shopping-List">Add to Shopping List Documentation</a>
     */
    public AddToShoppingList200Response addToShoppingList(String username, String hash, AddToMealPlanRequest addToMealPlanRequest) throws ApiException {
        ApiResponse<AddToShoppingList200Response> localVarResp = addToShoppingListWithHttpInfo(username, hash, addToMealPlanRequest);
        return localVarResp.getData();
    }
     ...
     * @param hash The private hash for the username. (required)
     * @param addToMealPlanRequest  (required)
     * @return ApiResponse&lt;AddToShoppingList200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://spoonacular.com/food-api/docs#Add-to-Shopping-List">Add to Shopping List Documentation</a>
     */
    public ApiResponse<AddToShoppingList200Response> addToShoppingListWithHttpInfo(String username, String hash, AddToMealPlanRequest addToMealPlanRequest) throws ApiException {
        okhttp3.Call localVarCall = addToShoppingListValidateBeforeCall(username, hash, addToMealPlanRequest, null);
        Type localVarReturnType = new TypeToken<AddToShoppingList200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://spoonacular.com/food-api/docs#Add-to-Shopping-List">Add to Shopping List Documentation</a>
     */
    public okhttp3.Call addToShoppingListAsync(String username, String hash, AddToMealPlanRequest addToMealPlanRequest, final ApiCallback<AddToShoppingList200Response> _callback) throws ApiException {
     ...
     * @see <a href="https://spoonacular.com/food-api/docs#Generate-Shopping-List">Generate Shopping List Documentation</a>
     */
    public AddToShoppingList200Response generateShoppingList(String username, String startDate, String endDate, String hash, GenerateShoppingListRequest generateShoppingListRequest) throws ApiException {
        ApiResponse<AddToShoppingList200Response> localVarResp = generateShoppingListWithHttpInfo(username, startDate, endDate, hash, generateShoppingListRequest);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://spoonacular.com/food-api/docs#Generate-Shopping-List">Generate Shopping List Documentation</a>
     */
    public ApiResponse<AddToShoppingList200Response> generateShoppingListWithHttpInfo(String username, String startDate, String endDate, String hash, GenerateShoppingListRequest generateShoppingListRequest) throws ApiException {
     ...
     * @see <a href="https://spoonacular.com/food-api/docs#Generate-Shopping-List">Generate Shopping List Documentation</a>
     */
    public okhttp3.Call generateShoppingListAsync(String username, String startDate, String endDate, String hash, GenerateShoppingListRequest generateShoppingListRequest, final ApiCallback<AddToShoppingList200Response> _callback) throws ApiException {
