...
import org.openapitools.client.model.AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner;
...
public class AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner {
  ...
  private Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> equipment = new LinkedHashSet<>();

  public static final String SERIALIZED_NAME_INGREDIENTS = "ingredients";
  @SerializedName(SERIALIZED_NAME_INGREDIENTS)
  private Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> ingredients = new LinkedHashSet<>();
  ...
  public AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner equipment(Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> equipment) {
    this.equipment = equipment;
    return this;
  }

  public AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner addEquipmentItem(AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner equipmentItem) {
  ...
  public Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> getEquipment() {
    return equipment;
  }

  public void setEquipment(Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> equipment) {
    this.equipment = equipment;
  }


  public AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner ingredients(Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> ingredients) {
    this.ingredients = ingredients;
    return this;
  }

  public AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner addIngredientsItem(AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner ingredientsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> getIngredients() {
    return ingredients;
  }

  public void setIngredients(Set<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner> ingredients) {
    this.ingredients = ingredients;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.equipment, analyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.equipment) &&
        Objects.equals(this.ingredients, analyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.ingredients) &&
        Objects.equals(this.number, analyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.number) &&
        Objects.equals(this.step, analyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.step);
  }

  @Override
  public int hashCode() {
    return Objects.hash(equipment, ingredients, number, step);
  }
      ...
      if (jsonObj.get("equipment") != null && !jsonObj.get("equipment").isJsonNull()) {
        ...
        if (jsonArrayequipment != null) {
          ...
          for (int i = 0; i < jsonArrayequipment.size(); i++) {
            AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner.validateJsonElement(jsonArrayequipment.get(i));
          };
        }
      }
      if (jsonObj.get("ingredients") != null && !jsonObj.get("ingredients").isJsonNull()) {
        ...
        if (jsonArrayingredients != null) {
          ...
          for (int i = 0; i < jsonArrayingredients.size(); i++) {
            AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerEquipmentInner.validateJsonElement(jsonArrayingredients.get(i));
          };
        }
      }
