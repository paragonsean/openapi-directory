...
public class AddMealPlanTemplate200ResponseItemsInnerValue {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, imageType, servings, title);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddMealPlanTemplate200ResponseItemsInnerValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddMealPlanTemplate200ResponseItemsInnerValue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
