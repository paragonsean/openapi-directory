...
import org.openapitools.client.api.MealPlanningApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    AddToMealPlanRequest addToMealPlanRequest = new AddToMealPlanRequest(); // AddToMealPlanRequest | 
    try {
      AddToShoppingList200Response result = apiInstance.addToShoppingList(username, hash, addToMealPlanRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AddToShoppingList200Response result = apiInstance.generateShoppingList(username, startDate, endDate, hash, generateShoppingListRequest);
      System.out.println(result);
    } catch (ApiException e) {
