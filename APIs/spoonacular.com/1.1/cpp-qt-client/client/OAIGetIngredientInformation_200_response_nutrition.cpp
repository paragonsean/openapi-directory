...
OAIGetIngredientInformation_200_response_nutrition_caloricBreakdown OAIGetIngredientInformation_200_response_nutrition::getCaloricBreakdown() const {
    return m_caloric_breakdown;
}
void OAIGetIngredientInformation_200_response_nutrition::setCaloricBreakdown(const OAIGetIngredientInformation_200_response_nutrition_caloricBreakdown &caloric_breakdown) {
...
QSet<OAIGetIngredientInformation_200_response_nutrition_nutrients_inner> OAIGetIngredientInformation_200_response_nutrition::getNutrients() const {
    return m_nutrients;
}
void OAIGetIngredientInformation_200_response_nutrition::setNutrients(const QSet<OAIGetIngredientInformation_200_response_nutrition_nutrients_inner> &nutrients) {
...
QSet<OAIGetIngredientInformation_200_response_nutrition_properties_inner> OAIGetIngredientInformation_200_response_nutrition::getProperties() const {
    return m_properties;
}
void OAIGetIngredientInformation_200_response_nutrition::setProperties(const QSet<OAIGetIngredientInformation_200_response_nutrition_properties_inner> &properties) {
...
OAIGetIngredientInformation_200_response_nutrition_weightPerServing OAIGetIngredientInformation_200_response_nutrition::getWeightPerServing() const {
    return m_weight_per_serving;
}
void OAIGetIngredientInformation_200_response_nutrition::setWeightPerServing(const OAIGetIngredientInformation_200_response_nutrition_weightPerServing &weight_per_serving) {
...
bool OAIGetIngredientInformation_200_response_nutrition::isValid() const {
    ...
    return m_caloric_breakdown_isValid && m_nutrients_isValid && m_properties_isValid && m_weight_per_serving_isValid && true;
}
