...
OAIGetIngredientInformation_200_response_estimatedCost OAIParseIngredients_200_response_inner::getEstimatedCost() const {
    return m_estimated_cost;
}
void OAIParseIngredients_200_response_inner::setEstimatedCost(const OAIGetIngredientInformation_200_response_estimatedCost &estimated_cost) {
...
bool OAIParseIngredients_200_response_inner::isValid() const {
    ...
    return m_aisle_isValid && m_amount_isValid && m_consistency_isValid && m_estimated_cost_isValid && m_id_isValid && m_image_isValid && m_meta_isValid && m_name_isValid && m_name_clean_isValid && m_nutrition_isValid && m_original_isValid && m_original_name_isValid && m_possible_units_isValid && m_unit_isValid && m_unit_long_isValid && m_unit_short_isValid && true;
}
