...
OAIGetIngredientInformation_200_response_nutrition_weightPerServing OAIGetShoppingList_200_response_aisles_inner_items_inner_measures::getMetric() const {
    return m_metric;
}
void OAIGetShoppingList_200_response_aisles_inner_items_inner_measures::setMetric(const OAIGetIngredientInformation_200_response_nutrition_weightPerServing &metric) {
    m_metric = metric;
    m_metric_isSet = true;
}
...
OAIGetIngredientInformation_200_response_nutrition_weightPerServing OAIGetShoppingList_200_response_aisles_inner_items_inner_measures::getOriginal() const {
    return m_original;
}
void OAIGetShoppingList_200_response_aisles_inner_items_inner_measures::setOriginal(const OAIGetIngredientInformation_200_response_nutrition_weightPerServing &original) {
    m_original = original;
...
OAIGetIngredientInformation_200_response_nutrition_weightPerServing OAIGetShoppingList_200_response_aisles_inner_items_inner_measures::getUs() const {
    return m_us;
}
void OAIGetShoppingList_200_response_aisles_inner_items_inner_measures::setUs(const OAIGetIngredientInformation_200_response_nutrition_weightPerServing &us) {
    m_us = us;
    m_us_isSet = true;
}
...
bool OAIGetShoppingList_200_response_aisles_inner_items_inner_measures::isValid() const {
    ...
    return m_metric_isValid && m_original_isValid && m_us_isValid && true;
}
