...
QSet<OAIExtractRecipeFromWebsite_200_response_extendedIngredients_inner> OAIGetRandomRecipes_200_response_recipes_inner::getExtendedIngredients() const {
    return m_extended_ingredients;
}
void OAIGetRandomRecipes_200_response_recipes_inner::setExtendedIngredients(const QSet<OAIExtractRecipeFromWebsite_200_response_extendedIngredients_inner> &extended_ingredients) {
...
OAIExtractRecipeFromWebsite_200_response_winePairing OAIGetRandomRecipes_200_response_recipes_inner::getWinePairing() const {
    return m_wine_pairing;
}
void OAIGetRandomRecipes_200_response_recipes_inner::setWinePairing(const OAIExtractRecipeFromWebsite_200_response_winePairing &wine_pairing) {
...
bool OAIGetRandomRecipes_200_response_recipes_inner::isValid() const {
    ...
    return m_aggregate_likes_isValid && m_cheap_isValid && m_credits_text_isValid && m_dairy_free_isValid && m_gaps_isValid && m_gluten_free_isValid && m_health_score_isValid && m_id_isValid && m_image_isValid && m_image_type_isValid && m_instructions_isValid && m_ketogenic_isValid && m_license_isValid && m_low_fodmap_isValid && m_price_per_serving_isValid && m_ready_in_minutes_isValid && m_servings_isValid && m_source_name_isValid && m_source_url_isValid && m_spoonacular_score_isValid && m_spoonacular_source_url_isValid && m_summary_isValid && m_sustainable_isValid && m_title_isValid && m_vegan_isValid && m_vegetarian_isValid && m_very_healthy_isValid && m_very_popular_isValid && m_weight_watcher_smart_points_isValid && m_whole30_isValid && true;
}
