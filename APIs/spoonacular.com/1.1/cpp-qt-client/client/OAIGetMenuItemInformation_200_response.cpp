...
OAIGetMenuItemInformation_200_response_nutrition OAIGetMenuItemInformation_200_response::getNutrition() const {
    return m_nutrition;
}
void OAIGetMenuItemInformation_200_response::setNutrition(const OAIGetMenuItemInformation_200_response_nutrition &nutrition) {
...
OAISearchMenuItems_200_response_menuItems_inner_servings OAIGetMenuItemInformation_200_response::getServings() const {
    return m_servings;
}
void OAIGetMenuItemInformation_200_response::setServings(const OAISearchMenuItems_200_response_menuItems_inner_servings &servings) {
    m_servings = servings;
...
bool OAIGetMenuItemInformation_200_response::isValid() const {
    ...
    return m_badges_isValid && m_breadcrumbs_isValid && m_id_isValid && m_image_type_isValid && m_likes_isValid && m_nutrition_isValid && m_restaurant_chain_isValid && m_servings_isValid && m_title_isValid && true;
}
