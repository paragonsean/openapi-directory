...
/*
 * OAIGetMenuItemInformation_200_response_nutrition.h
 *
 * 
 */

#ifndef OAIGetMenuItemInformation_200_response_nutrition_H
#define OAIGetMenuItemInformation_200_response_nutrition_H
...
class OAIGetMenuItemInformation_200_response_nutrition : public OAIObject {
public:
    OAIGetMenuItemInformation_200_response_nutrition();
    OAIGetMenuItemInformation_200_response_nutrition(QString json);
    ~OAIGetMenuItemInformation_200_response_nutrition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMenuItemInformation_200_response_nutrition)

#endif // OAIGetMenuItemInformation_200_response_nutrition_H
