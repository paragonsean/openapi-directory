...
namespace OpenAPI {
class OAIGenerateMealPlan_200_response_meals_inner;
...
public:
    ...
    QSet<OAIGenerateMealPlan_200_response_meals_inner> getMeals() const;
    void setMeals(const QSet<OAIGenerateMealPlan_200_response_meals_inner> &meals);
...
private:
    ...
    QSet<OAIGenerateMealPlan_200_response_meals_inner> m_meals;
    bool m_meals_isSet;
