...
public:
    ...
    OAIGetIngredientInformation_200_response_nutrition_weightPerServing getMetric() const;
    void setMetric(const OAIGetIngredientInformation_200_response_nutrition_weightPerServing &metric);
    bool is_metric_Set() const;
    bool is_metric_Valid() const;

    OAIGetIngredientInformation_200_response_nutrition_weightPerServing getOriginal() const;
    void setOriginal(const OAIGetIngredientInformation_200_response_nutrition_weightPerServing &original);
    bool is_original_Set() const;
    bool is_original_Valid() const;

    OAIGetIngredientInformation_200_response_nutrition_weightPerServing getUs() const;
    void setUs(const OAIGetIngredientInformation_200_response_nutrition_weightPerServing &us);
...
private:
    ...
    OAIGetIngredientInformation_200_response_nutrition_weightPerServing m_metric;
    bool m_metric_isSet;
    bool m_metric_isValid;

    OAIGetIngredientInformation_200_response_nutrition_weightPerServing m_original;
    bool m_original_isSet;
    bool m_original_isValid;

    OAIGetIngredientInformation_200_response_nutrition_weightPerServing m_us;
    bool m_us_isSet;
    bool m_us_isValid;
};
