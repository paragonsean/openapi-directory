...
void OAIGenerateShoppingList_request::fromJsonObject(QJsonObject json) {
    ...
    m_end_date_isValid = ::OpenAPI::fromJsonValue(m_end_date, json[QString("end-date")]);
    ...
    m_start_date_isValid = ::OpenAPI::fromJsonValue(m_start_date, json[QString("start-date")]);
...
QJsonObject OAIGenerateShoppingList_request::asJsonObject() const {
    QJsonObject obj;
    if (m_end_date_isSet) {
        obj.insert(QString("end-date"), ::OpenAPI::toJsonValue(m_end_date));
    }
    if (m_hash_isSet) {
        obj.insert(QString("hash"), ::OpenAPI::toJsonValue(m_hash));
    }
    if (m_start_date_isSet) {
        obj.insert(QString("start-date"), ::OpenAPI::toJsonValue(m_start_date));
    }
    if (m_username_isSet) {
...
bool OAIGenerateShoppingList_request::isValid() const {
    ...
    return m_end_date_isValid && m_hash_isValid && m_start_date_isValid && m_username_isValid && true;
}
