...
OAIImageAnalysisByURL_200_response_nutrition_calories OAIGuessNutritionByDishName_200_response::getCalories() const {
    return m_calories;
}
void OAIGuessNutritionByDishName_200_response::setCalories(const OAIImageAnalysisByURL_200_response_nutrition_calories &calories) {
    m_calories = calories;
...
OAIImageAnalysisByURL_200_response_nutrition_calories OAIGuessNutritionByDishName_200_response::getCarbs() const {
    return m_carbs;
}
void OAIGuessNutritionByDishName_200_response::setCarbs(const OAIImageAnalysisByURL_200_response_nutrition_calories &carbs) {
    m_carbs = carbs;
    m_carbs_isSet = true;
}
...
OAIImageAnalysisByURL_200_response_nutrition_calories OAIGuessNutritionByDishName_200_response::getFat() const {
    return m_fat;
}
void OAIGuessNutritionByDishName_200_response::setFat(const OAIImageAnalysisByURL_200_response_nutrition_calories &fat) {
    m_fat = fat;
    m_fat_isSet = true;
}
...
OAIImageAnalysisByURL_200_response_nutrition_calories OAIGuessNutritionByDishName_200_response::getProtein() const {
    return m_protein;
}
void OAIGuessNutritionByDishName_200_response::setProtein(const OAIImageAnalysisByURL_200_response_nutrition_calories &protein) {
    m_protein = protein;
