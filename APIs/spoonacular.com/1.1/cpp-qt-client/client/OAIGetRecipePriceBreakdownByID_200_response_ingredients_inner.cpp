...
OAIGetRecipeIngredientsByID_200_response_ingredients_inner_amount OAIGetRecipePriceBreakdownByID_200_response_ingredients_inner::getAmount() const {
    return m_amount;
}
void OAIGetRecipePriceBreakdownByID_200_response_ingredients_inner::setAmount(const OAIGetRecipeIngredientsByID_200_response_ingredients_inner_amount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}
