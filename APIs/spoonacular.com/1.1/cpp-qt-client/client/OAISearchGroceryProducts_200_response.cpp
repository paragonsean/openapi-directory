...
QSet<OAISearchGroceryProducts_200_response_products_inner> OAISearchGroceryProducts_200_response::getProducts() const {
    return m_products;
}
void OAISearchGroceryProducts_200_response::setProducts(const QSet<OAISearchGroceryProducts_200_response_products_inner> &products) {
    m_products = products;
...
bool OAISearchGroceryProducts_200_response::isValid() const {
    ...
    return m_number_isValid && m_offset_isValid && m_products_isValid && m_total_products_isValid && m_type_isValid && true;
}
