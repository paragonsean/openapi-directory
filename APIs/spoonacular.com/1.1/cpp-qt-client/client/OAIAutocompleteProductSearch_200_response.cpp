...
QSet<OAIAutocompleteMenuItemSearch_200_response_results_inner> OAIAutocompleteProductSearch_200_response::getResults() const {
    return m_results;
}
void OAIAutocompleteProductSearch_200_response::setResults(const QSet<OAIAutocompleteMenuItemSearch_200_response_results_inner> &results) {
    m_results = results;
