...
#include "OAISearchRecipes_200_response_results_inner.h"
...
OAISearchRecipes_200_response_results_inner::OAISearchRecipes_200_response_results_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchRecipes_200_response_results_inner::OAISearchRecipes_200_response_results_inner() {
    this->initializeModel();
}

OAISearchRecipes_200_response_results_inner::~OAISearchRecipes_200_response_results_inner() {}

void OAISearchRecipes_200_response_results_inner::initializeModel() {
...
void OAISearchRecipes_200_response_results_inner::fromJsonObject(QJsonObject json) {
...
QJsonObject OAISearchRecipes_200_response_results_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_calories_isSet) {
...
qint32 OAISearchRecipes_200_response_results_inner::getId() const {
    return m_id;
}
void OAISearchRecipes_200_response_results_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISearchRecipes_200_response_results_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAISearchRecipes_200_response_results_inner::is_id_Valid() const{
    return m_id_isValid;
}
...
void OAISearchRecipes_200_response_results_inner::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAISearchRecipes_200_response_results_inner::is_image_Set() const{
    return m_image_isSet;
}

bool OAISearchRecipes_200_response_results_inner::is_image_Valid() const{
    return m_image_isValid;
}

QString OAISearchRecipes_200_response_results_inner::getImageType() const {
    return m_image_type;
}
void OAISearchRecipes_200_response_results_inner::setImageType(const QString &image_type) {
    m_image_type = image_type;
    m_image_type_isSet = true;
}

bool OAISearchRecipes_200_response_results_inner::is_image_type_Set() const{
    return m_image_type_isSet;
}

bool OAISearchRecipes_200_response_results_inner::is_image_type_Valid() const{
...
QString OAISearchRecipes_200_response_results_inner::getTitle() const {
    return m_title;
}
void OAISearchRecipes_200_response_results_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAISearchRecipes_200_response_results_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAISearchRecipes_200_response_results_inner::is_title_Valid() const{
