...
#include "OAIGetMenuItemInformation_200_response_nutrition.h"
...
namespace OpenAPI {
class OAIGetMenuItemInformation_200_response_nutrition;
class OAISearchMenuItems_200_response_menuItems_inner_servings;
...
public:
    ...
    OAIGetMenuItemInformation_200_response_nutrition getNutrition() const;
    void setNutrition(const OAIGetMenuItemInformation_200_response_nutrition &nutrition);
    ...
    OAISearchMenuItems_200_response_menuItems_inner_servings getServings() const;
    void setServings(const OAISearchMenuItems_200_response_menuItems_inner_servings &servings);
...
private:
    ...
    OAIGetMenuItemInformation_200_response_nutrition m_nutrition;
    ...
    OAISearchMenuItems_200_response_menuItems_inner_servings m_servings;
