...
bool OAIGetRecipeTasteByID_200_response::isValid() const {
    ...
    return m_bitterness_isValid && m_fattiness_isValid && m_saltiness_isValid && m_savoriness_isValid && m_sourness_isValid && m_spiciness_isValid && m_sweetness_isValid && true;
}
