...
#ifndef OAIGetWinePairing_200_response_productMatches_inner_H
#define OAIGetWinePairing_200_response_productMatches_inner_H
...
class OAIGetWinePairing_200_response_productMatches_inner : public OAIObject {
public:
    OAIGetWinePairing_200_response_productMatches_inner();
    OAIGetWinePairing_200_response_productMatches_inner(QString json);
    ~OAIGetWinePairing_200_response_productMatches_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWinePairing_200_response_productMatches_inner)

#endif // OAIGetWinePairing_200_response_productMatches_inner_H
