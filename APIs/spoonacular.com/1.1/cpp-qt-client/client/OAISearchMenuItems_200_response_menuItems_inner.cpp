...
OAISearchMenuItems_200_response_menuItems_inner_servings OAISearchMenuItems_200_response_menuItems_inner::getServings() const {
    return m_servings;
}
void OAISearchMenuItems_200_response_menuItems_inner::setServings(const OAISearchMenuItems_200_response_menuItems_inner_servings &servings) {
    m_servings = servings;
...
bool OAISearchMenuItems_200_response_menuItems_inner::isValid() const {
    ...
    return m_id_isValid && m_image_isValid && m_image_type_isValid && m_restaurant_chain_isValid && m_title_isValid && true;
}
