...
namespace OpenAPI {
class OAIGetAnalyzedRecipeInstructions_200_response_parsedInstructions_inner_steps_inner_equipment_inner;
...
public:
    ...
    QSet<OAIGetAnalyzedRecipeInstructions_200_response_parsedInstructions_inner_steps_inner_equipment_inner> getEquipment() const;
    void setEquipment(const QSet<OAIGetAnalyzedRecipeInstructions_200_response_parsedInstructions_inner_steps_inner_equipment_inner> &equipment);
    bool is_equipment_Set() const;
    bool is_equipment_Valid() const;

    QSet<OAIGetAnalyzedRecipeInstructions_200_response_parsedInstructions_inner_steps_inner_equipment_inner> getIngredients() const;
    void setIngredients(const QSet<OAIGetAnalyzedRecipeInstructions_200_response_parsedInstructions_inner_steps_inner_equipment_inner> &ingredients);
...
private:
    ...
    QSet<OAIGetAnalyzedRecipeInstructions_200_response_parsedInstructions_inner_steps_inner_equipment_inner> m_equipment;
    bool m_equipment_isSet;
    bool m_equipment_isValid;

    QSet<OAIGetAnalyzedRecipeInstructions_200_response_parsedInstructions_inner_steps_inner_equipment_inner> m_ingredients;
