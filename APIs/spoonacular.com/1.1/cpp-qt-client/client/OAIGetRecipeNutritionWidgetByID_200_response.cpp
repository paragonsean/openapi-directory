...
void OAIGetRecipeNutritionWidgetByID_200_response::fromJsonObject(QJsonObject json) {
    ...
    m_bad_isValid = ::OpenAPI::fromJsonValue(m_bad, json[QString("bad")]);
...
QJsonObject OAIGetRecipeNutritionWidgetByID_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_bad.size() > 0) {
        obj.insert(QString("bad"), ::OpenAPI::toJsonValue(m_bad));
    }
    if (m_calories_isSet) {
...
QSet<OAIGetRecipeNutritionWidgetByID_200_response_bad_inner> OAIGetRecipeNutritionWidgetByID_200_response::getGood() const {
    return m_good;
}
void OAIGetRecipeNutritionWidgetByID_200_response::setGood(const QSet<OAIGetRecipeNutritionWidgetByID_200_response_bad_inner> &good) {
    m_good = good;
    m_good_isSet = true;
}
...
bool OAIGetRecipeNutritionWidgetByID_200_response::isValid() const {
    ...
    return m_bad_isValid && m_calories_isValid && m_carbs_isValid && m_fat_isValid && m_good_isValid && m_protein_isValid && true;
}
