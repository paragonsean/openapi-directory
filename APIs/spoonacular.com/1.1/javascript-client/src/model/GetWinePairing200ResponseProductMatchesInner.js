...
class GetWinePairing200ResponseProductMatchesInner {
     ...
     * @param title {String} 
     */
    constructor(averageRating, id, imageUrl, link, price, ratingCount, score, title) { 
        
        GetWinePairing200ResponseProductMatchesInner.initialize(this, averageRating, id, imageUrl, link, price, ratingCount, score, title);
    }
     ...
     */
    static initialize(obj, averageRating, id, imageUrl, link, price, ratingCount, score, title) { 
...
GetWinePairing200ResponseProductMatchesInner.RequiredProperties = ["averageRating", "id", "imageUrl", "link", "price", "ratingCount", "score", "title"];
