...
class ClearMealPlanDayRequest {
     ...
     */
    constructor(date, hash, username) { 
        
        ClearMealPlanDayRequest.initialize(this, date, hash, username);
    }
     ...
     */
    static initialize(obj, date, hash, username) { 
        obj['date'] = date;
        obj['hash'] = hash;
...
ClearMealPlanDayRequest.RequiredProperties = ["date", "hash", "username"];
