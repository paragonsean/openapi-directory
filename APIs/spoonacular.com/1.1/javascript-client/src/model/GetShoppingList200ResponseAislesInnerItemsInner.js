...
class GetShoppingList200ResponseAislesInnerItemsInner {
     ...
     */
    constructor(aisle, cost, id, ingredientId, name, pantryItem) { 
        
        GetShoppingList200ResponseAislesInnerItemsInner.initialize(this, aisle, cost, id, ingredientId, name, pantryItem);
    }
     ...
     */
    static initialize(obj, aisle, cost, id, ingredientId, name, pantryItem) { 
        obj['aisle'] = aisle;
        obj['cost'] = cost;
        obj['id'] = id;
...
GetShoppingList200ResponseAislesInnerItemsInner.RequiredProperties = ["aisle", "cost", "id", "ingredientId", "name", "pantryItem"];
