...
class AnalyzeARecipeSearchQuery200Response {
     ...
     */
    constructor(cuisines, dishes, ingredients, modifiers) { 
        
        AnalyzeARecipeSearchQuery200Response.initialize(this, cuisines, dishes, ingredients, modifiers);
    }
     ...
     */
    static initialize(obj, cuisines, dishes, ingredients, modifiers) { 
...
AnalyzeARecipeSearchQuery200Response.RequiredProperties = ["cuisines", "dishes", "ingredients", "modifiers"];
