...
class GetMealPlanTemplate200ResponseDaysInnerItemsInnerValue {
     ...
     * @param title {String} 
     */
    constructor(id, imageType, title) { 
        
        GetMealPlanTemplate200ResponseDaysInnerItemsInnerValue.initialize(this, id, imageType, title);
    }
     ...
     */
    static initialize(obj, id, imageType, title) { 
        obj['id'] = id;
...
GetMealPlanTemplate200ResponseDaysInnerItemsInnerValue.RequiredProperties = ["id", "imageType", "title"];
