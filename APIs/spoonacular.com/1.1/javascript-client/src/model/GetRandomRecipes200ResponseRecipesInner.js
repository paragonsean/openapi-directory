...
class GetRandomRecipes200ResponseRecipesInner {
     ...
     */
    constructor(aggregateLikes, cheap, creditsText, dairyFree, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30) { 
        
        GetRandomRecipes200ResponseRecipesInner.initialize(this, aggregateLikes, cheap, creditsText, dairyFree, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30);
    }
     ...
     */
    static initialize(obj, aggregateLikes, cheap, creditsText, dairyFree, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30) { 
...
GetRandomRecipes200ResponseRecipesInner.RequiredProperties = ["aggregateLikes", "cheap", "creditsText", "dairyFree", "gaps", "glutenFree", "healthScore", "id", "image", "imageType", "instructions", "ketogenic", "license", "lowFodmap", "pricePerServing", "readyInMinutes", "servings", "sourceName", "sourceUrl", "spoonacularScore", "spoonacularSourceUrl", "summary", "sustainable", "title", "vegan", "vegetarian", "veryHealthy", "veryPopular", "weightWatcherSmartPoints", "whole30"];
