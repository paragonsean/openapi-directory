...
class GetRecipeInformationBulk200ResponseInner {
    ...
    constructor(aggregateLikes, analyzedInstructions, cheap, creditsText, cuisines, dairyFree, diets, dishTypes, extendedIngredients, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, occasions, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30, winePairing) { 
        ...
        GetRecipeInformationBulk200ResponseInner.initialize(this, aggregateLikes, analyzedInstructions, cheap, creditsText, cuisines, dairyFree, diets, dishTypes, extendedIngredients, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, occasions, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30, winePairing);
    }
...
GetRecipeInformationBulk200ResponseInner.RequiredProperties = ["aggregateLikes", "analyzedInstructions", "cheap", "creditsText", "cuisines", "dairyFree", "diets", "dishTypes", "extendedIngredients", "gaps", "glutenFree", "healthScore", "id", "image", "imageType", "instructions", "ketogenic", "license", "lowFodmap", "occasions", "pricePerServing", "readyInMinutes", "servings", "sourceName", "sourceUrl", "spoonacularScore", "spoonacularSourceUrl", "summary", "sustainable", "title", "vegan", "vegetarian", "veryHealthy", "veryPopular", "weightWatcherSmartPoints", "whole30", "winePairing"];
