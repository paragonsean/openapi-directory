...
import ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner from './ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner';
import ExtractRecipeFromWebsite200ResponseWinePairing from './ExtractRecipeFromWebsite200ResponseWinePairing';

/**
 * The ExtractRecipeFromWebsite200Response model module.
 * @module model/ExtractRecipeFromWebsite200Response
 * @version 1.1
 */
class ExtractRecipeFromWebsite200Response {
    /**
     * Constructs a new <code>ExtractRecipeFromWebsite200Response</code>.
     * 
     * @alias module:model/ExtractRecipeFromWebsite200Response
     ...
     * @param extendedIngredients {Array.<module:model/ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner>} 
     * @param gaps {String} 
     ...
     * @param winePairing {module:model/ExtractRecipeFromWebsite200ResponseWinePairing} 
     */
    constructor(aggregateLikes, analyzedInstructions, cheap, creditsText, cuisines, dairyFree, diets, dishTypes, extendedIngredients, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, occasions, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30, winePairing) { 
        
        ExtractRecipeFromWebsite200Response.initialize(this, aggregateLikes, analyzedInstructions, cheap, creditsText, cuisines, dairyFree, diets, dishTypes, extendedIngredients, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, occasions, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30, winePairing);
    }
     ...
     */
    static initialize(obj, aggregateLikes, analyzedInstructions, cheap, creditsText, cuisines, dairyFree, diets, dishTypes, extendedIngredients, gaps, glutenFree, healthScore, id, image, imageType, instructions, ketogenic, license, lowFodmap, occasions, pricePerServing, readyInMinutes, servings, sourceName, sourceUrl, spoonacularScore, spoonacularSourceUrl, summary, sustainable, title, vegan, vegetarian, veryHealthy, veryPopular, weightWatcherSmartPoints, whole30, winePairing) { 
    ...
    /**
     * Constructs a <code>ExtractRecipeFromWebsite200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtractRecipeFromWebsite200Response} obj Optional instance to populate.
     * @return {module:model/ExtractRecipeFromWebsite200Response} The populated <code>ExtractRecipeFromWebsite200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtractRecipeFromWebsite200Response();
            ...
            if (data.hasOwnProperty('extendedIngredients')) {
                obj['extendedIngredients'] = ApiClient.convertToType(data['extendedIngredients'], [ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner]);
            }
            ...
            if (data.hasOwnProperty('winePairing')) {
                obj['winePairing'] = ExtractRecipeFromWebsite200ResponseWinePairing.constructFromObject(data['winePairing']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExtractRecipeFromWebsite200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtractRecipeFromWebsite200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExtractRecipeFromWebsite200Response.RequiredProperties) {
        ...
        if (data['extendedIngredients']) { // data not null
            ...
            for (const item of data['extendedIngredients']) {
                ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['winePairing']) { // data not null
          ExtractRecipeFromWebsite200ResponseWinePairing.validateJSON(data['winePairing']);
        }
...
ExtractRecipeFromWebsite200Response.RequiredProperties = ["aggregateLikes", "analyzedInstructions", "cheap", "creditsText", "cuisines", "dairyFree", "diets", "dishTypes", "extendedIngredients", "gaps", "glutenFree", "healthScore", "id", "image", "imageType", "instructions", "ketogenic", "license", "lowFodmap", "occasions", "pricePerServing", "readyInMinutes", "servings", "sourceName", "sourceUrl", "spoonacularScore", "spoonacularSourceUrl", "summary", "sustainable", "title", "vegan", "vegetarian", "veryHealthy", "veryPopular", "weightWatcherSmartPoints", "whole30", "winePairing"];

/**
 * @member {Number} aggregateLikes
 */
ExtractRecipeFromWebsite200Response.prototype['aggregateLikes'] = undefined;

/**
 * @member {Array.<Object>} analyzedInstructions
 */
ExtractRecipeFromWebsite200Response.prototype['analyzedInstructions'] = undefined;

/**
 * @member {Boolean} cheap
 */
ExtractRecipeFromWebsite200Response.prototype['cheap'] = undefined;

/**
 * @member {String} creditsText
 */
ExtractRecipeFromWebsite200Response.prototype['creditsText'] = undefined;

/**
 * @member {Array.<String>} cuisines
 */
ExtractRecipeFromWebsite200Response.prototype['cuisines'] = undefined;

/**
 * @member {Boolean} dairyFree
 */
ExtractRecipeFromWebsite200Response.prototype['dairyFree'] = undefined;

/**
 * @member {Array.<String>} diets
 */
ExtractRecipeFromWebsite200Response.prototype['diets'] = undefined;

/**
 * @member {Array.<String>} dishTypes
 */
ExtractRecipeFromWebsite200Response.prototype['dishTypes'] = undefined;

/**
 * @member {Array.<module:model/ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner>} extendedIngredients
 */
ExtractRecipeFromWebsite200Response.prototype['extendedIngredients'] = undefined;

/**
 * @member {String} gaps
 */
ExtractRecipeFromWebsite200Response.prototype['gaps'] = undefined;

/**
 * @member {Boolean} glutenFree
 */
ExtractRecipeFromWebsite200Response.prototype['glutenFree'] = undefined;

/**
 * @member {Number} healthScore
 */
ExtractRecipeFromWebsite200Response.prototype['healthScore'] = undefined;

/**
 * @member {Number} id
 */
ExtractRecipeFromWebsite200Response.prototype['id'] = undefined;

/**
 * @member {String} image
 */
ExtractRecipeFromWebsite200Response.prototype['image'] = undefined;

/**
 * @member {String} imageType
 */
ExtractRecipeFromWebsite200Response.prototype['imageType'] = undefined;

/**
 * @member {String} instructions
 */
ExtractRecipeFromWebsite200Response.prototype['instructions'] = undefined;

/**
 * @member {Boolean} ketogenic
 */
ExtractRecipeFromWebsite200Response.prototype['ketogenic'] = undefined;

/**
 * @member {String} license
 */
ExtractRecipeFromWebsite200Response.prototype['license'] = undefined;

/**
 * @member {Boolean} lowFodmap
 */
ExtractRecipeFromWebsite200Response.prototype['lowFodmap'] = undefined;

/**
 * @member {Array.<String>} occasions
 */
ExtractRecipeFromWebsite200Response.prototype['occasions'] = undefined;

/**
 * @member {Number} pricePerServing
 */
ExtractRecipeFromWebsite200Response.prototype['pricePerServing'] = undefined;

/**
 * @member {Number} readyInMinutes
 */
ExtractRecipeFromWebsite200Response.prototype['readyInMinutes'] = undefined;

/**
 * @member {Number} servings
 */
ExtractRecipeFromWebsite200Response.prototype['servings'] = undefined;

/**
 * @member {String} sourceName
 */
ExtractRecipeFromWebsite200Response.prototype['sourceName'] = undefined;

/**
 * @member {String} sourceUrl
 */
ExtractRecipeFromWebsite200Response.prototype['sourceUrl'] = undefined;

/**
 * @member {Number} spoonacularScore
 */
ExtractRecipeFromWebsite200Response.prototype['spoonacularScore'] = undefined;

/**
 * @member {String} spoonacularSourceUrl
 */
ExtractRecipeFromWebsite200Response.prototype['spoonacularSourceUrl'] = undefined;

/**
 * @member {String} summary
 */
ExtractRecipeFromWebsite200Response.prototype['summary'] = undefined;

/**
 * @member {Boolean} sustainable
 */
ExtractRecipeFromWebsite200Response.prototype['sustainable'] = undefined;

/**
 * @member {String} title
 */
ExtractRecipeFromWebsite200Response.prototype['title'] = undefined;

/**
 * @member {Boolean} vegan
 */
ExtractRecipeFromWebsite200Response.prototype['vegan'] = undefined;

/**
 * @member {Boolean} vegetarian
 */
ExtractRecipeFromWebsite200Response.prototype['vegetarian'] = undefined;

/**
 * @member {Boolean} veryHealthy
 */
ExtractRecipeFromWebsite200Response.prototype['veryHealthy'] = undefined;

/**
 * @member {Boolean} veryPopular
 */
ExtractRecipeFromWebsite200Response.prototype['veryPopular'] = undefined;

/**
 * @member {Number} weightWatcherSmartPoints
 */
ExtractRecipeFromWebsite200Response.prototype['weightWatcherSmartPoints'] = undefined;

/**
 * @member {Boolean} whole30
 */
ExtractRecipeFromWebsite200Response.prototype['whole30'] = undefined;

/**
 * @member {module:model/ExtractRecipeFromWebsite200ResponseWinePairing} winePairing
 */
ExtractRecipeFromWebsite200Response.prototype['winePairing'] = undefined;
...
export default ExtractRecipeFromWebsite200Response;
