...
class DeleteFromMealPlanRequest {
     ...
     */
    constructor(hash, id, username) { 
        
        DeleteFromMealPlanRequest.initialize(this, hash, id, username);
    }
     ...
     */
    static initialize(obj, hash, id, username) { 
        obj['hash'] = hash;
        obj['id'] = id;
...
DeleteFromMealPlanRequest.RequiredProperties = ["hash", "id", "username"];
