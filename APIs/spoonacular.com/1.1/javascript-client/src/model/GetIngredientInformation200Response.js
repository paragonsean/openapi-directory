...
class GetIngredientInformation200Response {
     ...
     */
    constructor(aisle, amount, categoryPath, consistency, estimatedCost, id, image, meta, name, nameClean, nutrition, original, originalName, possibleUnits, shoppingListUnits, unit, unitLong, unitShort) { 
        
        GetIngredientInformation200Response.initialize(this, aisle, amount, categoryPath, consistency, estimatedCost, id, image, meta, name, nameClean, nutrition, original, originalName, possibleUnits, shoppingListUnits, unit, unitLong, unitShort);
    }
     ...
     */
    static initialize(obj, aisle, amount, categoryPath, consistency, estimatedCost, id, image, meta, name, nameClean, nutrition, original, originalName, possibleUnits, shoppingListUnits, unit, unitLong, unitShort) { 
        obj['aisle'] = aisle;
        obj['amount'] = amount;
...
GetIngredientInformation200Response.RequiredProperties = ["aisle", "amount", "categoryPath", "consistency", "estimatedCost", "id", "image", "meta", "name", "nameClean", "nutrition", "original", "originalName", "possibleUnits", "shoppingListUnits", "unit", "unitLong", "unitShort"];
