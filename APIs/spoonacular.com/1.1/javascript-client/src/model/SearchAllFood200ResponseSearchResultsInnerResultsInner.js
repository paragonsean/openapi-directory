...
class SearchAllFood200ResponseSearchResultsInnerResultsInner {
     ...
     * @param type {String} 
     */
    constructor(content, id, image, link, name, relevance, type) { 
        
        SearchAllFood200ResponseSearchResultsInnerResultsInner.initialize(this, content, id, image, link, name, relevance, type);
    }
     ...
     */
    static initialize(obj, content, id, image, link, name, relevance, type) { 
        obj['content'] = content;
        obj['id'] = id;
        obj['image'] = image;
        obj['link'] = link;
...
SearchAllFood200ResponseSearchResultsInnerResultsInner.RequiredProperties = ["content", "id", "image", "link", "name", "relevance", "type"];
