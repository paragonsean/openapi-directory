...
class GetMealPlanTemplate200ResponseDaysInnerItemsInner {
     ...
     * @param type {String} 
     */
    constructor(id, position, slot, type) { 
        
        GetMealPlanTemplate200ResponseDaysInnerItemsInner.initialize(this, id, position, slot, type);
    }
     ...
     */
    static initialize(obj, id, position, slot, type) { 
        obj['id'] = id;
...
GetMealPlanTemplate200ResponseDaysInnerItemsInner.RequiredProperties = ["id", "position", "slot", "type"];
