...
import SearchGroceryProducts200ResponseProductsInner from './SearchGroceryProducts200ResponseProductsInner';
...
class SearchGroceryProducts200Response {
     ...
     * @param number {Number} 
     * @param offset {Number} 
     * @param products {Array.<module:model/SearchGroceryProducts200ResponseProductsInner>} 
     * @param totalProducts {Number} 
     * @param type {String} 
     */
    constructor(number, offset, products, totalProducts, type) { 
        
        SearchGroceryProducts200Response.initialize(this, number, offset, products, totalProducts, type);
    }
     ...
     */
    static initialize(obj, number, offset, products, totalProducts, type) { 
        obj['number'] = number;
        obj['offset'] = offset;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('products')) {
                obj['products'] = ApiClient.convertToType(data['products'], [SearchGroceryProducts200ResponseProductsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['products']) { // data not null
            ...
            for (const item of data['products']) {
                SearchGroceryProducts200ResponseProductsInner.validateJSON(item);
            };
        }
...
SearchGroceryProducts200Response.RequiredProperties = ["number", "offset", "products", "totalProducts", "type"];
...
/**
 * @member {Array.<module:model/SearchGroceryProducts200ResponseProductsInner>} products
 */
