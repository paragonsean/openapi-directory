...
class ConvertAmounts200Response {
     ...
     */
    constructor(answer, sourceAmount, sourceUnit, targetAmount, targetUnit) { 
        
        ConvertAmounts200Response.initialize(this, answer, sourceAmount, sourceUnit, targetAmount, targetUnit);
    }
     ...
     */
    static initialize(obj, answer, sourceAmount, sourceUnit, targetAmount, targetUnit) { 
        obj['answer'] = answer;
...
ConvertAmounts200Response.RequiredProperties = ["answer", "sourceAmount", "sourceUnit", "targetAmount", "targetUnit"];
