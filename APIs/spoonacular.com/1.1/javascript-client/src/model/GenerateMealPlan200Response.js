...
import GenerateMealPlan200ResponseMealsInner from './GenerateMealPlan200ResponseMealsInner';
...
class GenerateMealPlan200Response {
     ...
     * @param meals {Array.<module:model/GenerateMealPlan200ResponseMealsInner>} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meals')) {
                obj['meals'] = ApiClient.convertToType(data['meals'], [GenerateMealPlan200ResponseMealsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['meals']) { // data not null
            ...
            for (const item of data['meals']) {
                GenerateMealPlan200ResponseMealsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/GenerateMealPlan200ResponseMealsInner>} meals
 */
