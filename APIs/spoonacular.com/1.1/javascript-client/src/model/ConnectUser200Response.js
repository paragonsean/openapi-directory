...
class ConnectUser200Response {
     ...
     */
    constructor(hash, username) { 
        
        ConnectUser200Response.initialize(this, hash, username);
    }
     ...
     */
    static initialize(obj, hash, username) { 
        obj['hash'] = hash;
...
ConnectUser200Response.RequiredProperties = ["hash", "username"];
