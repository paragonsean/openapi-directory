...
class SearchFoodVideos200ResponseVideosInner {
     ...
     */
    constructor(length, rating, shortTitle, thumbnail, title, views, youTubeId) { 
        
        SearchFoodVideos200ResponseVideosInner.initialize(this, length, rating, shortTitle, thumbnail, title, views, youTubeId);
    }
     ...
     */
    static initialize(obj, length, rating, shortTitle, thumbnail, title, views, youTubeId) { 
        obj['length'] = length;
        obj['rating'] = rating;
...
SearchFoodVideos200ResponseVideosInner.RequiredProperties = ["length", "rating", "shortTitle", "thumbnail", "title", "views", "youTubeId"];
