...
class SearchAllFood200Response {
     ...
     */
    constructor(limit, offset, query, searchResults, totalResults) { 
        
        SearchAllFood200Response.initialize(this, limit, offset, query, searchResults, totalResults);
    }
     ...
     */
    static initialize(obj, limit, offset, query, searchResults, totalResults) { 
        obj['limit'] = limit;
        obj['offset'] = offset;
        obj['query'] = query;
...
SearchAllFood200Response.RequiredProperties = ["limit", "offset", "query", "searchResults", "totalResults"];
