...
class MapIngredientsToGroceryProducts200ResponseInner {
     ...
     */
    constructor(ingredientImage, meta, original, originalName, products) { 
        
        MapIngredientsToGroceryProducts200ResponseInner.initialize(this, ingredientImage, meta, original, originalName, products);
    }
     ...
     */
    static initialize(obj, ingredientImage, meta, original, originalName, products) { 
...
MapIngredientsToGroceryProducts200ResponseInner.RequiredProperties = ["ingredientImage", "meta", "original", "originalName", "products"];
