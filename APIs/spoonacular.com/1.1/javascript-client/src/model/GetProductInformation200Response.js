 ...
 * @module model/GetProductInformation200Response
 * @version 1.1
 */
class GetProductInformation200Response {
     ...
     * 
     * @alias module:model/GetProductInformation200Response
     * @param aisle {String} 
     ...
     * @param ingredients {Array.<module:model/GetProductInformation200ResponseIngredientsInner>} 
     * @param likes {Number} 
     ...
     * @param title {String} 
     */
    constructor(aisle, badges, breadcrumbs, id, imageType, importantBadges, ingredientCount, ingredientList, ingredients, likes, nutrition, price, servings, spoonacularScore, title) { 
        
        GetProductInformation200Response.initialize(this, aisle, badges, breadcrumbs, id, imageType, importantBadges, ingredientCount, ingredientList, ingredients, likes, nutrition, price, servings, spoonacularScore, title);
    }
     ...
     */
    static initialize(obj, aisle, badges, breadcrumbs, id, imageType, importantBadges, ingredientCount, ingredientList, ingredients, likes, nutrition, price, servings, spoonacularScore, title) { 
        obj['aisle'] = aisle;
        obj['badges'] = badges;
     ...
     * @param {module:model/GetProductInformation200Response} obj Optional instance to populate.
     * @return {module:model/GetProductInformation200Response} The populated <code>GetProductInformation200Response</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetProductInformation200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetProductInformation200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetProductInformation200Response.RequiredProperties) {
        ...
        if (data['ingredients']) { // data not null
            ...
            for (const item of data['ingredients']) {
                GetProductInformation200ResponseIngredientsInner.validateJSON(item);
            };
        }
...
GetProductInformation200Response.RequiredProperties = ["aisle", "badges", "breadcrumbs", "id", "imageType", "importantBadges", "ingredientCount", "ingredientList", "ingredients", "likes", "nutrition", "price", "servings", "spoonacularScore", "title"];
...
/**
 * @member {Array.<module:model/GetProductInformation200ResponseIngredientsInner>} ingredients
 */
