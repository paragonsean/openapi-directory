...
class SearchCustomFoods200ResponseCustomFoodsInner {
     ...
     * @param title {String} 
     */
    constructor(id, imageUrl, price, servings, title) { 
        
        SearchCustomFoods200ResponseCustomFoodsInner.initialize(this, id, imageUrl, price, servings, title);
    }
     ...
     */
    static initialize(obj, id, imageUrl, price, servings, title) { 
        obj['id'] = id;
...
SearchCustomFoods200ResponseCustomFoodsInner.RequiredProperties = ["id", "imageUrl", "price", "servings", "title"];
