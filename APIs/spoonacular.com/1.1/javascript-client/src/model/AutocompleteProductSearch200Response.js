...
import AutocompleteMenuItemSearch200ResponseResultsInner from './AutocompleteMenuItemSearch200ResponseResultsInner';
...
class AutocompleteProductSearch200Response {
     ...
     * @param results {Array.<module:model/AutocompleteMenuItemSearch200ResponseResultsInner>} 
     */
    constructor(results) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [AutocompleteMenuItemSearch200ResponseResultsInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                AutocompleteMenuItemSearch200ResponseResultsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/AutocompleteMenuItemSearch200ResponseResultsInner>} results
 */
