...
class GetWineRecommendation200ResponseRecommendedWinesInner {
     ...
     * @param title {String} 
     */
    constructor(averageRating, description, id, imageUrl, link, price, ratingCount, score, title) { 
        
        GetWineRecommendation200ResponseRecommendedWinesInner.initialize(this, averageRating, description, id, imageUrl, link, price, ratingCount, score, title);
    }
     ...
     */
    static initialize(obj, averageRating, description, id, imageUrl, link, price, ratingCount, score, title) { 
...
GetWineRecommendation200ResponseRecommendedWinesInner.RequiredProperties = ["averageRating", "description", "id", "imageUrl", "link", "price", "ratingCount", "score", "title"];
