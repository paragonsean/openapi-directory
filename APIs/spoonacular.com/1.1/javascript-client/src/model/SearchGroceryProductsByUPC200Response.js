...
class SearchGroceryProductsByUPC200Response {
     ...
     * @param title {String} 
     */
    constructor(badges, breadcrumbs, generatedText, id, imageType, importantBadges, ingredientList, ingredients, likes, nutrition, price, servings, spoonacularScore, title) { 
        
        SearchGroceryProductsByUPC200Response.initialize(this, badges, breadcrumbs, generatedText, id, imageType, importantBadges, ingredientList, ingredients, likes, nutrition, price, servings, spoonacularScore, title);
    }
     ...
     */
    static initialize(obj, badges, breadcrumbs, generatedText, id, imageType, importantBadges, ingredientList, ingredients, likes, nutrition, price, servings, spoonacularScore, title) { 
        obj['badges'] = badges;
...
SearchGroceryProductsByUPC200Response.RequiredProperties = ["badges", "breadcrumbs", "generatedText", "id", "imageType", "importantBadges", "ingredientList", "ingredients", "likes", "nutrition", "price", "servings", "spoonacularScore", "title"];
