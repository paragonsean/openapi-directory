...
class GetRecipeNutritionWidgetByID200ResponseBadInner {
     ...
     */
    constructor(amount, indented, name, percentOfDailyNeeds) { 
        
        GetRecipeNutritionWidgetByID200ResponseBadInner.initialize(this, amount, indented, name, percentOfDailyNeeds);
    }
     ...
     */
    static initialize(obj, amount, indented, name, percentOfDailyNeeds) { 
        obj['amount'] = amount;
...
GetRecipeNutritionWidgetByID200ResponseBadInner.RequiredProperties = ["amount", "indented", "name", "percentOfDailyNeeds"];
