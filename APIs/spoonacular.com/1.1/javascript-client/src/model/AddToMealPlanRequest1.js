...
class AddToMealPlanRequest1 {
     ...
     */
    constructor(date, position, slot, type, value) { 
        
        AddToMealPlanRequest1.initialize(this, date, position, slot, type, value);
    }
     ...
     */
    static initialize(obj, date, position, slot, type, value) { 
        obj['date'] = date;
...
AddToMealPlanRequest1.RequiredProperties = ["date", "position", "slot", "type", "value"];
