...
export default class RecipesApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SearchGroceryProducts200ResponseProductsInner>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Array.<module:model/SearchGroceryProducts200ResponseProductsInner>}
     */
    autocompleteRecipeSearch(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [SearchGroceryProducts200ResponseProductsInner];
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ExtractRecipeFromWebsite200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ExtractRecipeFromWebsite200Response}
     */
    extractRecipeFromWebsite(url, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ExtractRecipeFromWebsite200Response;
      return this.apiClient.callApi(
        '/recipes/extract', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/GenerateMealPlan200ResponseMealsInner>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Array.<module:model/GenerateMealPlan200ResponseMealsInner>}
     */
    getSimilarRecipes(id, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [GenerateMealPlan200ResponseMealsInner];
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the ingredientsByIDImage_0 operation.
     * @callback module:api/RecipesApi~ingredientsByIDImage_0Callback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RecipesApi~ingredientsByIDImage_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    ingredientsByIDImage_0(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling ingredientsByIDImage_0");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SearchRecipes200ResponseResultsInner>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Array.<module:model/SearchRecipes200ResponseResultsInner>}
     */
    searchRecipesByNutrients(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [SearchRecipes200ResponseResultsInner];
      return this.apiClient.callApi(
