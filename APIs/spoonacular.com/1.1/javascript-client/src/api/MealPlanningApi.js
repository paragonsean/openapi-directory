...
export default class MealPlanningApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/AddToShoppingList200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/AddToShoppingList200Response}
     */
    addToShoppingList(username, hash, addToMealPlanRequest, callback) {
      ...
      let contentTypes = ['', 'application/json'];
      let accepts = ['application/json'];
      let returnType = AddToShoppingList200Response;
      return this.apiClient.callApi(
