...
(function(root, factory) {
  ...
  describe('RecipesApi', function() {
    ...
    describe('ingredientsByIDImage_0', function() {
      it('should call ingredientsByIDImage_0 successfully', function(done) {
        //uncomment below and update the code to test ingredientsByIDImage_0
        //instance.ingredientsByIDImage_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
