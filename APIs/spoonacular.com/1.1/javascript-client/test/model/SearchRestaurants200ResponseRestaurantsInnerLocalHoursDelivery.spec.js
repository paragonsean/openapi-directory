...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery();
  });
  ...
  describe('SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery', function() {
    it('should create an instance of SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery', function() {
      // uncomment below and update the code to test SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery
      //var instance = new SpoonacularApi.SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery();
      //expect(instance).to.be.a(SpoonacularApi.SearchRestaurants200ResponseRestaurantsInnerLocalHoursDelivery);
    });
