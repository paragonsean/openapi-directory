...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GenerateMealPlan200ResponseMealsInner();
  });
  ...
  describe('GenerateMealPlan200ResponseMealsInner', function() {
    it('should create an instance of GenerateMealPlan200ResponseMealsInner', function() {
      // uncomment below and update the code to test GenerateMealPlan200ResponseMealsInner
      //var instance = new SpoonacularApi.GenerateMealPlan200ResponseMealsInner();
      //expect(instance).to.be.a(SpoonacularApi.GenerateMealPlan200ResponseMealsInner);
    });
