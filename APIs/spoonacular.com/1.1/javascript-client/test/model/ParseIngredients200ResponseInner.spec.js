...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.ParseIngredients200ResponseInner();
  });
  ...
  describe('ParseIngredients200ResponseInner', function() {
    it('should create an instance of ParseIngredients200ResponseInner', function() {
      // uncomment below and update the code to test ParseIngredients200ResponseInner
      //var instance = new SpoonacularApi.ParseIngredients200ResponseInner();
      //expect(instance).to.be.a(SpoonacularApi.ParseIngredients200ResponseInner);
    });
