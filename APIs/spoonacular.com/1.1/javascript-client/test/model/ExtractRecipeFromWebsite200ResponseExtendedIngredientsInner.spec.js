...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner();
  });
  ...
  describe('ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner', function() {
    it('should create an instance of ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner', function() {
      // uncomment below and update the code to test ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner
      //var instance = new SpoonacularApi.ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner();
      //expect(instance).to.be.a(SpoonacularApi.ExtractRecipeFromWebsite200ResponseExtendedIngredientsInner);
    });
