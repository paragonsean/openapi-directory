...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetMenuItemInformation200Response();
  });
  ...
  describe('GetMenuItemInformation200Response', function() {
    it('should create an instance of GetMenuItemInformation200Response', function() {
      // uncomment below and update the code to test GetMenuItemInformation200Response
      //var instance = new SpoonacularApi.GetMenuItemInformation200Response();
      //expect(instance).to.be.a(SpoonacularApi.GetMenuItemInformation200Response);
    });
