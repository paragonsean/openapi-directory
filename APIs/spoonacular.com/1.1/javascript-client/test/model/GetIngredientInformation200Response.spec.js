...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetIngredientInformation200Response();
  });
  ...
  describe('GetIngredientInformation200Response', function() {
    it('should create an instance of GetIngredientInformation200Response', function() {
      // uncomment below and update the code to test GetIngredientInformation200Response
      //var instance = new SpoonacularApi.GetIngredientInformation200Response();
      //expect(instance).to.be.a(SpoonacularApi.GetIngredientInformation200Response);
    });
    ...
    it('should have the property nameClean (base name: "nameClean")', function() {
