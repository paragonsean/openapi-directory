...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.ParseIngredients200ResponseInnerNutrition();
  });
  ...
  describe('ParseIngredients200ResponseInnerNutrition', function() {
    it('should create an instance of ParseIngredients200ResponseInnerNutrition', function() {
      // uncomment below and update the code to test ParseIngredients200ResponseInnerNutrition
      //var instance = new SpoonacularApi.ParseIngredients200ResponseInnerNutrition();
      //expect(instance).to.be.a(SpoonacularApi.ParseIngredients200ResponseInnerNutrition);
    });
