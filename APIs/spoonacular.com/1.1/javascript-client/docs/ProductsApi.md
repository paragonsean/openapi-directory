...
let apiInstance = new SpoonacularApi.ProductsApi();
let classifyGroceryProductRequest = {"plu_code":"","title":"Kroger Vitamin A & D Reduced Fat 2% Milk","upc":""}; // ClassifyGroceryProductRequest | 
let opts = {
...
let apiInstance = new SpoonacularApi.ProductsApi();
let classifyGroceryProductBulkRequestInner = [{"plu_code":"","title":"Kroger Vitamin A & D Reduced Fat 2% Milk","upc":""}]; // [ClassifyGroceryProductBulkRequestInner] | 
let opts = {
  'locale': "en_US" // String | The display name of the returned category, supported is en_US (for American English) and en_GB (for British English).
};
