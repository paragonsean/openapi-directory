...
> [SearchGroceryProducts200ResponseProductsInner] autocompleteRecipeSearch(opts)
...
[**[SearchGroceryProducts200ResponseProductsInner]**](SearchGroceryProducts200ResponseProductsInner.md)
...
> ExtractRecipeFromWebsite200Response extractRecipeFromWebsite(url, opts)
...
> ExtractRecipeFromWebsite200Response getRecipeInformation(id, opts)
...
> [GenerateMealPlan200ResponseMealsInner] getSimilarRecipes(id, opts)
...
[**[GenerateMealPlan200ResponseMealsInner]**](GenerateMealPlan200ResponseMealsInner.md)
...
> Object ingredientsByIDImage_0(id, opts)
...
apiInstance.ingredientsByIDImage_0(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [SearchRecipes200ResponseResultsInner] searchRecipesByNutrients(opts)
...
[**[SearchRecipes200ResponseResultsInner]**](SearchRecipes200ResponseResultsInner.md)
