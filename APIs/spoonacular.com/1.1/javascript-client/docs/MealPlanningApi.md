...
> AddToShoppingList200Response addToShoppingList(username, hash, addToMealPlanRequest)
...
> AddToShoppingList200Response generateShoppingList(username, startDate, endDate, hash, generateShoppingListRequest)
