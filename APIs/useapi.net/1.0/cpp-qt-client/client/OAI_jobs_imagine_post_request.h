...
/*
 * OAI_jobs_imagine_post_request.h
 *
 * 
 */

#ifndef OAI_jobs_imagine_post_request_H
#define OAI_jobs_imagine_post_request_H
...
class OAI_jobs_imagine_post_request : public OAIObject {
public:
    OAI_jobs_imagine_post_request();
    OAI_jobs_imagine_post_request(QString json);
    ~OAI_jobs_imagine_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_jobs_imagine_post_request)

#endif // OAI_jobs_imagine_post_request_H
