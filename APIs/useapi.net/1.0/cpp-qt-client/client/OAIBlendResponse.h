...
#ifndef OAIBlendResponse_H
#define OAIBlendResponse_H
...
class OAIBlendResponse : public OAIObject {
public:
    OAIBlendResponse();
    OAIBlendResponse(QString json);
    ~OAIBlendResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlendResponse)

#endif // OAIBlendResponse_H
