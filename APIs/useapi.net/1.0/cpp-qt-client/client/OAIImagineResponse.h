...
/*
 * OAIImagineResponse.h
 *
 * 
 */

#ifndef OAIImagineResponse_H
#define OAIImagineResponse_H
...
class OAIImagineResponse : public OAIObject {
public:
    OAIImagineResponse();
    OAIImagineResponse(QString json);
    ~OAIImagineResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImagineResponse)

#endif // OAIImagineResponse_H
