...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchLyApiV1.APIResponseSimilarityResponse();
  });
  ...
  describe('APIResponseSimilarityResponse', function() {
    it('should create an instance of APIResponseSimilarityResponse', function() {
      // uncomment below and update the code to test APIResponseSimilarityResponse
      //var instance = new SearchLyApiV1.APIResponseSimilarityResponse();
      //expect(instance).to.be.a(SearchLyApiV1.APIResponseSimilarityResponse);
    });

    it('should have the property similarityList (base name: "similarity_list")', function() {
      // uncomment below and update the code to test the property similarityList
      //var instance = new SearchLyApiV1.APIResponseSimilarityResponse();
