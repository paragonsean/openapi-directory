...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchLyApiV1.APIResponseSongResponseResultsInner();
  });
  ...
  describe('APIResponseSongResponseResultsInner', function() {
    it('should create an instance of APIResponseSongResponseResultsInner', function() {
      // uncomment below and update the code to test APIResponseSongResponseResultsInner
      //var instance = new SearchLyApiV1.APIResponseSongResponseResultsInner();
      //expect(instance).to.be.a(SearchLyApiV1.APIResponseSongResponseResultsInner);
    });
