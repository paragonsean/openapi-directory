...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchLyApiV1.SrcSearchlyApiV1ControllersSimilarityByContentRequest();
  });
  ...
  describe('SrcSearchlyApiV1ControllersSimilarityByContentRequest', function() {
    it('should create an instance of SrcSearchlyApiV1ControllersSimilarityByContentRequest', function() {
      // uncomment below and update the code to test SrcSearchlyApiV1ControllersSimilarityByContentRequest
      //var instance = new SearchLyApiV1.SrcSearchlyApiV1ControllersSimilarityByContentRequest();
      //expect(instance).to.be.a(SearchLyApiV1.SrcSearchlyApiV1ControllersSimilarityByContentRequest);
    });
