...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchLyApiV1.APIResponseSong();
  });
  ...
  describe('APIResponseSong', function() {
    it('should create an instance of APIResponseSong', function() {
      // uncomment below and update the code to test APIResponseSong
      //var instance = new SearchLyApiV1.APIResponseSong();
      //expect(instance).to.be.a(SearchLyApiV1.APIResponseSong);
    });
