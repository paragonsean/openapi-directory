...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchLyApiV1.APIResponseSimilarity();
  });
  ...
  describe('APIResponseSimilarity', function() {
    it('should create an instance of APIResponseSimilarity', function() {
      // uncomment below and update the code to test APIResponseSimilarity
      //var instance = new SearchLyApiV1.APIResponseSimilarity();
      //expect(instance).to.be.a(SearchLyApiV1.APIResponseSimilarity);
    });
