...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchLyApiV1.SimilarityApi();
  });
  ...
  describe('SimilarityApi', function() {
    describe('srcSearchlyApiV1ControllersSimilarityByContent', function() {
      it('should call srcSearchlyApiV1ControllersSimilarityByContent successfully', function(done) {
        //uncomment below and update the code to test srcSearchlyApiV1ControllersSimilarityByContent
        //instance.srcSearchlyApiV1ControllersSimilarityByContent(function(error) {
    ...
    describe('srcSearchlyApiV1ControllersSimilarityBySong', function() {
      it('should call srcSearchlyApiV1ControllersSimilarityBySong successfully', function(done) {
        //uncomment below and update the code to test srcSearchlyApiV1ControllersSimilarityBySong
        //instance.srcSearchlyApiV1ControllersSimilarityBySong(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
