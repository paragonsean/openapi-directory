...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchLyApiV1.SongApi();
  });
  ...
  describe('SongApi', function() {
    describe('srcSearchlyApiV1ControllersSongSearch', function() {
      it('should call srcSearchlyApiV1ControllersSongSearch successfully', function(done) {
        //uncomment below and update the code to test srcSearchlyApiV1ControllersSongSearch
        //instance.srcSearchlyApiV1ControllersSongSearch(function(error) {
