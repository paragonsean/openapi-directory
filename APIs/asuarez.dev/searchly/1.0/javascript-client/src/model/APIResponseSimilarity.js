...
import APIResponseSimilarityResponse from './APIResponseSimilarityResponse';

/**
 * The APIResponseSimilarity model module.
 * @module model/APIResponseSimilarity
 * @version 1.0
 */
class APIResponseSimilarity {
    /**
     * Constructs a new <code>APIResponseSimilarity</code>.
     * @alias module:model/APIResponseSimilarity
     */
    constructor() { 
        
        APIResponseSimilarity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>APIResponseSimilarity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/APIResponseSimilarity} obj Optional instance to populate.
     * @return {module:model/APIResponseSimilarity} The populated <code>APIResponseSimilarity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new APIResponseSimilarity();
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = APIResponseSimilarityResponse.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>APIResponseSimilarity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>APIResponseSimilarity</code>.
     */
    static validateJSON(data) {
        ...
        if (data['response']) { // data not null
          APIResponseSimilarityResponse.validateJSON(data['response']);
        }
 ...
 */
APIResponseSimilarity.prototype['error'] = undefined;

/**
 * Error message if the request was unsuccessful.
 * @member {String} message
 */
APIResponseSimilarity.prototype['message'] = undefined;

/**
 * @member {module:model/APIResponseSimilarityResponse} response
 */
APIResponseSimilarity.prototype['response'] = undefined;
...
export default APIResponseSimilarity;
