...
/**
 * The APIResponseSongResponseResultsInner model module.
 * @module model/APIResponseSongResponseResultsInner
 * @version 1.0
 */
class APIResponseSongResponseResultsInner {
    /**
     * Constructs a new <code>APIResponseSongResponseResultsInner</code>.
     * Song item.
     * @alias module:model/APIResponseSongResponseResultsInner
     */
    constructor() { 
        
        APIResponseSongResponseResultsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>APIResponseSongResponseResultsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/APIResponseSongResponseResultsInner} obj Optional instance to populate.
     * @return {module:model/APIResponseSongResponseResultsInner} The populated <code>APIResponseSongResponseResultsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new APIResponseSongResponseResultsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>APIResponseSongResponseResultsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>APIResponseSongResponseResultsInner</code>.
     */
 ...
 * @member {Number} id
 */
APIResponseSongResponseResultsInner.prototype['id'] = undefined;

/**
 * Song and Artist name.
 * @member {String} name
 */
APIResponseSongResponseResultsInner.prototype['name'] = undefined;
...
export default APIResponseSongResponseResultsInner;
