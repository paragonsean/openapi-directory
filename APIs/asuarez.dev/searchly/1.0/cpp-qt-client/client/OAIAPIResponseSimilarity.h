...
/*
 * OAIAPIResponseSimilarity.h
 *
 * 
 */

#ifndef OAIAPIResponseSimilarity_H
#define OAIAPIResponseSimilarity_H
...
namespace OpenAPI {
class OAIAPIResponseSimilarity_response;

class OAIAPIResponseSimilarity : public OAIObject {
public:
    OAIAPIResponseSimilarity();
    OAIAPIResponseSimilarity(QString json);
    ~OAIAPIResponseSimilarity() override;
    ...
    OAIAPIResponseSimilarity_response getResponse() const;
    void setResponse(const OAIAPIResponseSimilarity_response &response);
...
private:
    ...
    OAIAPIResponseSimilarity_response m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPIResponseSimilarity)

#endif // OAIAPIResponseSimilarity_H
