...
/*
 * OAIAPIResponseSong.h
 *
 * 
 */

#ifndef OAIAPIResponseSong_H
#define OAIAPIResponseSong_H
...
namespace OpenAPI {
class OAIAPIResponseSong_response;

class OAIAPIResponseSong : public OAIObject {
public:
    OAIAPIResponseSong();
    OAIAPIResponseSong(QString json);
    ~OAIAPIResponseSong() override;
    ...
    OAIAPIResponseSong_response getResponse() const;
    void setResponse(const OAIAPIResponseSong_response &response);
...
private:
    ...
    OAIAPIResponseSong_response m_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPIResponseSong)

#endif // OAIAPIResponseSong_H
