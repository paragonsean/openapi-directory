...
/*
 * OAIAPIResponseSong_response.h
 *
 * Contains the response data if the request was successful.
 */

#ifndef OAIAPIResponseSong_response_H
#define OAIAPIResponseSong_response_H
...
namespace OpenAPI {
class OAIAPIResponseSong_response_results_inner;

class OAIAPIResponseSong_response : public OAIObject {
public:
    OAIAPIResponseSong_response();
    OAIAPIResponseSong_response(QString json);
    ~OAIAPIResponseSong_response() override;
    ...
    QList<OAIAPIResponseSong_response_results_inner> getResults() const;
    void setResults(const QList<OAIAPIResponseSong_response_results_inner> &results);
...
private:
    ...
    QList<OAIAPIResponseSong_response_results_inner> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPIResponseSong_response)

#endif // OAIAPIResponseSong_response_H
