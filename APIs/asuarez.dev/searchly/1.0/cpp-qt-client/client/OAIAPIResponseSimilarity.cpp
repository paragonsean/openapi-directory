...
OAIAPIResponseSimilarity::OAIAPIResponseSimilarity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPIResponseSimilarity::OAIAPIResponseSimilarity() {
    this->initializeModel();
}

OAIAPIResponseSimilarity::~OAIAPIResponseSimilarity() {}

void OAIAPIResponseSimilarity::initializeModel() {
...
void OAIAPIResponseSimilarity::fromJson(QString jsonString) {
...
void OAIAPIResponseSimilarity::fromJsonObject(QJsonObject json) {
...
QString OAIAPIResponseSimilarity::asJson() const {
...
QJsonObject OAIAPIResponseSimilarity::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
bool OAIAPIResponseSimilarity::isError() const {
    return m_error;
}
void OAIAPIResponseSimilarity::setError(const bool &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIAPIResponseSimilarity::is_error_Set() const{
    return m_error_isSet;
}

bool OAIAPIResponseSimilarity::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIAPIResponseSimilarity::getMessage() const {
    return m_message;
}
void OAIAPIResponseSimilarity::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAPIResponseSimilarity::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAPIResponseSimilarity::is_message_Valid() const{
    return m_message_isValid;
}

OAIAPIResponseSimilarity_response OAIAPIResponseSimilarity::getResponse() const {
    return m_response;
}
void OAIAPIResponseSimilarity::setResponse(const OAIAPIResponseSimilarity_response &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIAPIResponseSimilarity::is_response_Set() const{
    return m_response_isSet;
}

bool OAIAPIResponseSimilarity::is_response_Valid() const{
    return m_response_isValid;
}

bool OAIAPIResponseSimilarity::isSet() const {
...
bool OAIAPIResponseSimilarity::isValid() const {
