...
class RfChannel(Model):
    ...
    def __init__(self, label: str=None, value: str=None):
        """RfChannel - a model defined in OpenAPI

        :param label: The label of this RfChannel.
        :param value: The value of this RfChannel.
        """
        self.openapi_types = {
            'label': str,
            'value': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RfChannel':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Rf_channel of this RfChannel.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def label(self):
        """Gets the label of this RfChannel.


        :return: The label of this RfChannel.
        :rtype: str
        """
        return self._label
    ...
    @property
    def value(self):
        """Gets the value of this RfChannel.


        :return: The value of this RfChannel.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this RfChannel.
