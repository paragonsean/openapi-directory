...
class Circuit(Model):
    ...
    def __init__(self, cid: str=None, comments: str=None, commit_rate: int=None, created: datetime=None, custom_fields: object=None, description: str=None, display: str=None, id: int=None, install_date: date=None, last_updated: datetime=None, provider: NestedProvider=None, status: Status1=None, tags: List[NestedTag]=None, tenant: NestedTenant=None, termination_a: CircuitCircuitTermination=None, termination_date: date=None, termination_z: CircuitCircuitTermination=None, type: NestedCircuitType=None, url: str=None):
        ...
        :param display: The display of this Circuit.
        ...
        :param termination_date: The termination_date of this Circuit.
        :param termination_z: The termination_z of this Circuit.
        :param type: The type of this Circuit.
        :param url: The url of this Circuit.
        """
        self.openapi_types = {
            'cid': str,
            'comments': str,
    ...
    @property
    def display(self):
        """Gets the display of this Circuit.


        :return: The display of this Circuit.
        :rtype: str
        """
    ...
    def display(self, display):
        """Sets the display of this Circuit.
    ...
    def termination_date(self):
        """Gets the termination_date of this Circuit.


        :return: The termination_date of this Circuit.
        :rtype: date
        """
    ...
    def termination_date(self, termination_date):
        """Sets the termination_date of this Circuit.
    ...
    @property
    def url(self):
        """Gets the url of this Circuit.


        :return: The url of this Circuit.
        :rtype: str
        """
        return self._url
