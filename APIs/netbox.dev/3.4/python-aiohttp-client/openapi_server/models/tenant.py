...
class Tenant(Model):
    ...
    def __init__(self, circuit_count: int=None, cluster_count: int=None, comments: str=None, created: datetime=None, custom_fields: object=None, description: str=None, device_count: int=None, display: str=None, group: NestedTenantGroup=None, id: int=None, ipaddress_count: int=None, last_updated: datetime=None, name: str=None, prefix_count: int=None, rack_count: int=None, site_count: int=None, slug: str=None, tags: List[NestedTag]=None, url: str=None, virtualmachine_count: int=None, vlan_count: int=None, vrf_count: int=None):
        ...
        :param display: The display of this Tenant.
        ...
        :param url: The url of this Tenant.
    ...
    @property
    def display(self):
        """Gets the display of this Tenant.


        :return: The display of this Tenant.
        :rtype: str
        """
    ...
    def display(self, display):
        """Sets the display of this Tenant.
    ...
    @property
    def url(self):
        """Gets the url of this Tenant.


        :return: The url of this Tenant.
        :rtype: str
        """
        return self._url
