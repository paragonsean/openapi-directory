...
class NestedDeviceType(Model):
    ...
    def __init__(self, device_count: int=None, display: str=None, id: int=None, manufacturer: NestedManufacturer=None, model: str=None, slug: str=None, url: str=None):
        """NestedDeviceType - a model defined in OpenAPI

        :param device_count: The device_count of this NestedDeviceType.
        :param display: The display of this NestedDeviceType.
    ...
    @property
    def display(self):
        """Gets the display of this NestedDeviceType.


        :return: The display of this NestedDeviceType.
        :rtype: str
        """
    ...
    def display(self, display):
        """Sets the display of this NestedDeviceType.
