...
class Service(Model):
    ...
    def __init__(self, comments: str=None, created: datetime=None, custom_fields: object=None, description: str=None, device: NestedDevice=None, display: str=None, id: int=None, ipaddresses: list[NestedIPAddress]=None, last_updated: datetime=None, name: str=None, ports: List[int]=None, protocol: Protocol=None, tags: List[NestedTag]=None, url: str=None, virtual_machine: NestedVirtualMachine=None):
        """Service - a model defined in OpenAPI

        :param comments: The comments of this Service.
        ...
        :param display: The display of this Service.
    ...
    @property
    def comments(self):
        """Gets the comments of this Service.


        :return: The comments of this Service.
        :rtype: str
        """
    ...
    @property
    def display(self):
        """Gets the display of this Service.


        :return: The display of this Service.
        :rtype: str
        """
