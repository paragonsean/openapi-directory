...
class VLAN(Model):
    ...
    def __init__(self, comments: str=None, created: datetime=None, custom_fields: object=None, description: str=None, display: str=None, group: NestedVLANGroup=None, id: int=None, l2vpn_termination: NestedL2VPNTermination=None, last_updated: datetime=None, name: str=None, prefix_count: int=None, role: NestedRole=None, site: NestedSite=None, status: Status5=None, tags: List[NestedTag]=None, tenant: NestedTenant=None, url: str=None, vid: int=None):
        """VLAN - a model defined in OpenAPI

        :param comments: The comments of this VLAN.
        ...
        :param display: The display of this VLAN.
        :param group: The group of this VLAN.
        :param id: The id of this VLAN.
        :param l2vpn_termination: The l2vpn_termination of this VLAN.
        ...
        :param url: The url of this VLAN.
    ...
    @property
    def comments(self):
        """Gets the comments of this VLAN.


        :return: The comments of this VLAN.
        :rtype: str
        """
    ...
    def comments(self, comments):
        """Sets the comments of this VLAN.
    ...
    @property
    def display(self):
        """Gets the display of this VLAN.


        :return: The display of this VLAN.
        :rtype: str
        """
    ...
    def l2vpn_termination(self):
        """Gets the l2vpn_termination of this VLAN.


        :return: The l2vpn_termination of this VLAN.
    ...
    def l2vpn_termination(self, l2vpn_termination):
        """Sets the l2vpn_termination of this VLAN.
    ...
    @property
    def url(self):
        """Gets the url of this VLAN.


        :return: The url of this VLAN.
        :rtype: str
        """
        return self._url
