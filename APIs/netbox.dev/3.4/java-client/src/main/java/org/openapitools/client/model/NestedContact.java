...
public class NestedContact {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.display, nestedContact.display) &&
        Objects.equals(this.id, nestedContact.id) &&
        Objects.equals(this.name, nestedContact.name) &&
        Objects.equals(this.url, nestedContact.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NestedContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NestedContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NestedContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NestedContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<NestedContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NestedContact.class));
