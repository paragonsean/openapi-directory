...
public class WritableJournalEntry {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assignedObject, writableJournalEntry.assignedObject) &&
        ...
        Objects.equals(this.id, writableJournalEntry.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to WritableJournalEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WritableJournalEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WritableJournalEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableJournalEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
