...
public class NestedWirelessLANGroup {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.depth, nestedWirelessLANGroup.depth) &&
        Objects.equals(this.display, nestedWirelessLANGroup.display) &&
        Objects.equals(this.id, nestedWirelessLANGroup.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(depth, display, id, name, slug, url, wirelesslanCount);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NestedWirelessLANGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NestedWirelessLANGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NestedWirelessLANGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NestedWirelessLANGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
