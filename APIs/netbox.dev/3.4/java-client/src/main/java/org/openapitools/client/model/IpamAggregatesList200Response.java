...
public class IpamAggregatesList200Response {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, ipamAggregatesList200Response.count) &&
        Objects.equals(this.next, ipamAggregatesList200Response.next) &&
        Objects.equals(this.previous, ipamAggregatesList200Response.previous) &&
        Objects.equals(this.results, ipamAggregatesList200Response.results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IpamAggregatesList200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpamAggregatesList200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpamAggregatesList200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpamAggregatesList200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        Aggregate.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<IpamAggregatesList200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IpamAggregatesList200Response.class));
