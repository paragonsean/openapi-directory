...
public class Airflow {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, airflow.label) &&
        Objects.equals(this.value, airflow.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Airflow
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Airflow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Airflow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Airflow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Airflow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Airflow.class));
