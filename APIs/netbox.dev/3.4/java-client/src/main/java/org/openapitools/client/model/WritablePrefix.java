...
public class WritablePrefix {
  ...
  public WritablePrefix comments(String comments) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.depth, writablePrefix.depth) &&
        Objects.equals(this.children, writablePrefix.children) &&
        Objects.equals(this.comments, writablePrefix.comments) &&
        ...
        Objects.equals(this.id, writablePrefix.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to WritablePrefix
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WritablePrefix.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WritablePrefix.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritablePrefix` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
