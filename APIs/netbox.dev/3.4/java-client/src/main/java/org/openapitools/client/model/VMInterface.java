...
public class VMInterface {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bridge, vmInterface.bridge) &&
        ...
        Objects.equals(this.id, vmInterface.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to VMInterface
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VMInterface.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VMInterface.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VMInterface` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bridge") != null && !jsonObj.get("bridge").isJsonNull()) {
        NestedVMInterface.validateJsonElement(jsonObj.get("bridge"));
      }
      ...
      if (jsonObj.get("parent") != null && !jsonObj.get("parent").isJsonNull()) {
        NestedVMInterface.validateJsonElement(jsonObj.get("parent"));
      }
