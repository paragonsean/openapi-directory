...
public class DcimModuleBaysList200Response {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, dcimModuleBaysList200Response.count) &&
        Objects.equals(this.next, dcimModuleBaysList200Response.next) &&
        Objects.equals(this.previous, dcimModuleBaysList200Response.previous) &&
        Objects.equals(this.results, dcimModuleBaysList200Response.results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DcimModuleBaysList200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DcimModuleBaysList200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DcimModuleBaysList200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DcimModuleBaysList200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        ModuleBay.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<DcimModuleBaysList200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DcimModuleBaysList200Response.class));
