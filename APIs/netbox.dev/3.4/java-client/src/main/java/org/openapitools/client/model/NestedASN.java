...
public class NestedASN {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.asn, nestedASN.asn) &&
        Objects.equals(this.display, nestedASN.display) &&
        Objects.equals(this.id, nestedASN.id) &&
        Objects.equals(this.url, nestedASN.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(asn, display, id, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NestedASN
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NestedASN.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NestedASN.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NestedASN` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
