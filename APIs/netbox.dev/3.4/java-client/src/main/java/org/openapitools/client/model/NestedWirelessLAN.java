...
public class NestedWirelessLAN {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.display, nestedWirelessLAN.display) &&
        Objects.equals(this.id, nestedWirelessLAN.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to NestedWirelessLAN
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NestedWirelessLAN.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NestedWirelessLAN.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NestedWirelessLAN` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<NestedWirelessLAN> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NestedWirelessLAN.class));
