...
public class ContactGroup {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.depth, contactGroup.depth) &&
        ...
        Objects.equals(this.id, contactGroup.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(depth, contactCount, created, customFields, description, display, id, lastUpdated, name, parent, slug, tags, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ContactGroup.openapiRequiredFields) {
      ...
      if (jsonObj.get("parent") != null && !jsonObj.get("parent").isJsonNull()) {
        NestedContactGroup.validateJsonElement(jsonObj.get("parent"));
      }
