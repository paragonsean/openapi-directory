...
public class DcimDeviceBaysList200Response {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, dcimDeviceBaysList200Response.count) &&
        Objects.equals(this.next, dcimDeviceBaysList200Response.next) &&
        Objects.equals(this.previous, dcimDeviceBaysList200Response.previous) &&
        Objects.equals(this.results, dcimDeviceBaysList200Response.results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DcimDeviceBaysList200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DcimDeviceBaysList200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DcimDeviceBaysList200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DcimDeviceBaysList200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        DeviceBay.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<DcimDeviceBaysList200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DcimDeviceBaysList200Response.class));
