...
public class ApiClient {
    ...
    private String basePath = "https://demo.netbox.dev/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demo.netbox.dev/api
