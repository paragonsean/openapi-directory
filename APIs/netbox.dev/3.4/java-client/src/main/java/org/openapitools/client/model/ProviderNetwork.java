...
public class ProviderNetwork {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.comments, providerNetwork.comments) &&
        ...
        Objects.equals(this.id, providerNetwork.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProviderNetwork
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProviderNetwork.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProviderNetwork.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProviderNetwork` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ProviderNetwork> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderNetwork.class));
