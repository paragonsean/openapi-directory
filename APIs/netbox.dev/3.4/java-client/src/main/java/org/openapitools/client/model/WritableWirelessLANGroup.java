...
public class WritableWirelessLANGroup {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.depth, writableWirelessLANGroup.depth) &&
        ...
        Objects.equals(this.id, writableWirelessLANGroup.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to WritableWirelessLANGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WritableWirelessLANGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WritableWirelessLANGroup is not found in the empty JSON string", WritableWirelessLANGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WritableWirelessLANGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableWirelessLANGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WritableWirelessLANGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WritableWirelessLANGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WritableWirelessLANGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WritableWirelessLANGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WritableWirelessLANGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<WritableWirelessLANGroup>() {
           @Override
           public void write(JsonWriter out, WritableWirelessLANGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WritableWirelessLANGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WritableWirelessLANGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WritableWirelessLANGroup
   * @throws IOException if the JSON string is invalid with respect to WritableWirelessLANGroup
   */
  public static WritableWirelessLANGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WritableWirelessLANGroup.class);
  }

  /**
   * Convert an instance of WritableWirelessLANGroup to an JSON string
   *
   * @return JSON string
   */
