...
public class ModuleNestedModuleBay {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.display, moduleNestedModuleBay.display) &&
        Objects.equals(this.id, moduleNestedModuleBay.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModuleNestedModuleBay
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModuleNestedModuleBay.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModuleNestedModuleBay.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModuleNestedModuleBay` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
