...
class DeviceWithConfigContext {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = Status3.constructFromObject(data['status']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['status']) { // data not null
          Status3.validateJSON(data['status']);
        }
 ...
 */
DeviceWithConfigContext.prototype['airflow'] = undefined;
 ...
 */
DeviceWithConfigContext.prototype['description'] = undefined;
 ...
 */
DeviceWithConfigContext.prototype['display'] = undefined;
 ...
 */
DeviceWithConfigContext.prototype['location'] = undefined;
...
/**
 * @member {module:model/Status3} status
 */
 ...
 * @member {String} url
 */
DeviceWithConfigContext.prototype['url'] = undefined;
