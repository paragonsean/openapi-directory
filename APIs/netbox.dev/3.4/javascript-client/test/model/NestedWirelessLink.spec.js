...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedWirelessLink();
  });
  ...
  describe('NestedWirelessLink', function() {
    it('should create an instance of NestedWirelessLink', function() {
      // uncomment below and update the code to test NestedWirelessLink
      //var instance = new NetBoxApi.NestedWirelessLink();
      //expect(instance).to.be.a(NetBoxApi.NestedWirelessLink);
    });
