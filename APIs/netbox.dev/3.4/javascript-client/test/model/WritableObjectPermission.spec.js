...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableObjectPermission();
  });
  ...
  describe('WritableObjectPermission', function() {
    it('should create an instance of WritableObjectPermission', function() {
      // uncomment below and update the code to test WritableObjectPermission
      //var instance = new NetBoxApi.WritableObjectPermission();
      //expect(instance).to.be.a(NetBoxApi.WritableObjectPermission);
    });
