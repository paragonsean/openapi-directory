...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedModuleType();
  });
  ...
  describe('NestedModuleType', function() {
    it('should create an instance of NestedModuleType', function() {
      // uncomment below and update the code to test NestedModuleType
      //var instance = new NetBoxApi.NestedModuleType();
      //expect(instance).to.be.a(NetBoxApi.NestedModuleType);
    });
