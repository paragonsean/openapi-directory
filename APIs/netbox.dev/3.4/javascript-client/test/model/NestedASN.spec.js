...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedASN();
  });
  ...
  describe('NestedASN', function() {
    it('should create an instance of NestedASN', function() {
      // uncomment below and update the code to test NestedASN
      //var instance = new NetBoxApi.NestedASN();
      //expect(instance).to.be.a(NetBoxApi.NestedASN);
    });
