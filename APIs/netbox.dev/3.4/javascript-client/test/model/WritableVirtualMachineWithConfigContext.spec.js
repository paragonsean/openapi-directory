...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableVirtualMachineWithConfigContext();
  });
  ...
  describe('WritableVirtualMachineWithConfigContext', function() {
    it('should create an instance of WritableVirtualMachineWithConfigContext', function() {
      // uncomment below and update the code to test WritableVirtualMachineWithConfigContext
      //var instance = new NetBoxApi.WritableVirtualMachineWithConfigContext();
      //expect(instance).to.be.a(NetBoxApi.WritableVirtualMachineWithConfigContext);
    });
