...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableProviderNetwork();
  });
  ...
  describe('WritableProviderNetwork', function() {
    it('should create an instance of WritableProviderNetwork', function() {
      // uncomment below and update the code to test WritableProviderNetwork
      //var instance = new NetBoxApi.WritableProviderNetwork();
      //expect(instance).to.be.a(NetBoxApi.WritableProviderNetwork);
    });
