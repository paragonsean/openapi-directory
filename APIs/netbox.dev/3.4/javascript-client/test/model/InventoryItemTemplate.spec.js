...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.InventoryItemTemplate();
  });
  ...
  describe('InventoryItemTemplate', function() {
    it('should create an instance of InventoryItemTemplate', function() {
      // uncomment below and update the code to test InventoryItemTemplate
      //var instance = new NetBoxApi.InventoryItemTemplate();
      //expect(instance).to.be.a(NetBoxApi.InventoryItemTemplate);
    });
