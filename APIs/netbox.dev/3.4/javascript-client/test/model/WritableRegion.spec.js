...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableRegion();
  });
  ...
  describe('WritableRegion', function() {
    it('should create an instance of WritableRegion', function() {
      // uncomment below and update the code to test WritableRegion
      //var instance = new NetBoxApi.WritableRegion();
      //expect(instance).to.be.a(NetBoxApi.WritableRegion);
    });
