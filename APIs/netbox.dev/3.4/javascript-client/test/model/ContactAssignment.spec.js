...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.ContactAssignment();
  });
  ...
  describe('ContactAssignment', function() {
    it('should create an instance of ContactAssignment', function() {
      // uncomment below and update the code to test ContactAssignment
      //var instance = new NetBoxApi.ContactAssignment();
      //expect(instance).to.be.a(NetBoxApi.ContactAssignment);
    });
