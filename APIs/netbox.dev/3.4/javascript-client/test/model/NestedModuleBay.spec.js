...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedModuleBay();
  });
  ...
  describe('NestedModuleBay', function() {
    it('should create an instance of NestedModuleBay', function() {
      // uncomment below and update the code to test NestedModuleBay
      //var instance = new NetBoxApi.NestedModuleBay();
      //expect(instance).to.be.a(NetBoxApi.NestedModuleBay);
    });
