...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableServiceTemplate();
  });
  ...
  describe('WritableServiceTemplate', function() {
    it('should create an instance of WritableServiceTemplate', function() {
      // uncomment below and update the code to test WritableServiceTemplate
      //var instance = new NetBoxApi.WritableServiceTemplate();
      //expect(instance).to.be.a(NetBoxApi.WritableServiceTemplate);
    });
