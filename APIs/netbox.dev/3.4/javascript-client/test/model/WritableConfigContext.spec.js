...
(function(root, factory) {
  ...
  describe('WritableConfigContext', function() {
    ...
    it('should have the property clusterTypes (base name: "cluster_types")', function() {
      // uncomment below and update the code to test the property clusterTypes
      //var instance = new NetBoxApi.WritableConfigContext();
      //expect(instance).to.be();
    });
    ...
    it('should have the property deviceTypes (base name: "device_types")', function() {
    ...
    it('should have the property siteGroups (base name: "site_groups")', function() {
      // uncomment below and update the code to test the property siteGroups
      //var instance = new NetBoxApi.WritableConfigContext();
      //expect(instance).to.be();
    });
