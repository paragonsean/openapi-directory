...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritablePrefix();
  });
  ...
  describe('WritablePrefix', function() {
    it('should create an instance of WritablePrefix', function() {
      // uncomment below and update the code to test WritablePrefix
      //var instance = new NetBoxApi.WritablePrefix();
      //expect(instance).to.be.a(NetBoxApi.WritablePrefix);
    });
    ...
    it('should have the property markUtilized (base name: "mark_utilized")', function() {
      // uncomment below and update the code to test the property markUtilized
      //var instance = new NetBoxApi.WritablePrefix();
      //expect(instance).to.be();
    });
