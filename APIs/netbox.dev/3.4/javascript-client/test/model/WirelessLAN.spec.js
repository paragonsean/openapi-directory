...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WirelessLAN();
  });
  ...
  describe('WirelessLAN', function() {
    it('should create an instance of WirelessLAN', function() {
      // uncomment below and update the code to test WirelessLAN
      //var instance = new NetBoxApi.WirelessLAN();
      //expect(instance).to.be.a(NetBoxApi.WirelessLAN);
    });

    it('should have the property authCipher (base name: "auth_cipher")', function() {
      // uncomment below and update the code to test the property authCipher
      //var instance = new NetBoxApi.WirelessLAN();
      //expect(instance).to.be();
    });

    it('should have the property authPsk (base name: "auth_psk")', function() {
      // uncomment below and update the code to test the property authPsk
      //var instance = new NetBoxApi.WirelessLAN();
      //expect(instance).to.be();
    });
