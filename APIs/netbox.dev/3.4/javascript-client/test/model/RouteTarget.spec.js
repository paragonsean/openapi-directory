...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.RouteTarget();
  });
  ...
  describe('RouteTarget', function() {
    it('should create an instance of RouteTarget', function() {
      // uncomment below and update the code to test RouteTarget
      //var instance = new NetBoxApi.RouteTarget();
      //expect(instance).to.be.a(NetBoxApi.RouteTarget);
    });
