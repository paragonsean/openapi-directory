...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableASN();
  });
  ...
  describe('WritableASN', function() {
    it('should create an instance of WritableASN', function() {
      // uncomment below and update the code to test WritableASN
      //var instance = new NetBoxApi.WritableASN();
      //expect(instance).to.be.a(NetBoxApi.WritableASN);
    });
    ...
    it('should have the property providerCount (base name: "provider_count")', function() {
      // uncomment below and update the code to test the property providerCount
      //var instance = new NetBoxApi.WritableASN();
      //expect(instance).to.be();
    });
