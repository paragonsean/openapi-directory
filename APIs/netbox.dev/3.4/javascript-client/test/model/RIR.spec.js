...
(function(root, factory) {
  ...
  describe('RIR', function() {
    it('should create an instance of RIR', function() {
      // uncomment below and update the code to test RIR
      //var instance = new NetBoxApi.RIR();
      //expect(instance).to.be.a(NetBoxApi.RIR);
    });

    it('should have the property aggregateCount (base name: "aggregate_count")', function() {
      // uncomment below and update the code to test the property aggregateCount
      //var instance = new NetBoxApi.RIR();
