...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.VirtualDeviceContext();
  });
  ...
  describe('VirtualDeviceContext', function() {
    it('should create an instance of VirtualDeviceContext', function() {
      // uncomment below and update the code to test VirtualDeviceContext
      //var instance = new NetBoxApi.VirtualDeviceContext();
      //expect(instance).to.be.a(NetBoxApi.VirtualDeviceContext);
    });
    ...
    it('should have the property interfaceCount (base name: "interface_count")', function() {
