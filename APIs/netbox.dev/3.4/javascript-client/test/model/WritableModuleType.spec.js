...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableModuleType();
  });
  ...
  describe('WritableModuleType', function() {
    it('should create an instance of WritableModuleType', function() {
      // uncomment below and update the code to test WritableModuleType
      //var instance = new NetBoxApi.WritableModuleType();
      //expect(instance).to.be.a(NetBoxApi.WritableModuleType);
    });
