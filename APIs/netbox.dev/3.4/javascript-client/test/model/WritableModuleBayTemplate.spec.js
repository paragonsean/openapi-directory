...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableModuleBayTemplate();
  });
  ...
  describe('WritableModuleBayTemplate', function() {
    it('should create an instance of WritableModuleBayTemplate', function() {
      // uncomment below and update the code to test WritableModuleBayTemplate
      //var instance = new NetBoxApi.WritableModuleBayTemplate();
      //expect(instance).to.be.a(NetBoxApi.WritableModuleBayTemplate);
    });
