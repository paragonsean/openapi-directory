...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableVirtualDeviceContext();
  });
  ...
  describe('WritableVirtualDeviceContext', function() {
    it('should create an instance of WritableVirtualDeviceContext', function() {
      // uncomment below and update the code to test WritableVirtualDeviceContext
      //var instance = new NetBoxApi.WritableVirtualDeviceContext();
      //expect(instance).to.be.a(NetBoxApi.WritableVirtualDeviceContext);
    });
