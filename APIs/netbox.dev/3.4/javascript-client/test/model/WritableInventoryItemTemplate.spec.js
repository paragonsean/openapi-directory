...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableInventoryItemTemplate();
  });
  ...
  describe('WritableInventoryItemTemplate', function() {
    it('should create an instance of WritableInventoryItemTemplate', function() {
      // uncomment below and update the code to test WritableInventoryItemTemplate
      //var instance = new NetBoxApi.WritableInventoryItemTemplate();
      //expect(instance).to.be.a(NetBoxApi.WritableInventoryItemTemplate);
    });
