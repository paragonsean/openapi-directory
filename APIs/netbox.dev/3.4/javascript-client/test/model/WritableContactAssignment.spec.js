...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableContactAssignment();
  });
  ...
  describe('WritableContactAssignment', function() {
    it('should create an instance of WritableContactAssignment', function() {
      // uncomment below and update the code to test WritableContactAssignment
      //var instance = new NetBoxApi.WritableContactAssignment();
      //expect(instance).to.be.a(NetBoxApi.WritableContactAssignment);
    });
