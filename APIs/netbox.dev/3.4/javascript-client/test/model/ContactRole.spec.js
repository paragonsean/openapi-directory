...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.ContactRole();
  });
  ...
  describe('ContactRole', function() {
    it('should create an instance of ContactRole', function() {
      // uncomment below and update the code to test ContactRole
      //var instance = new NetBoxApi.ContactRole();
      //expect(instance).to.be.a(NetBoxApi.ContactRole);
    });
