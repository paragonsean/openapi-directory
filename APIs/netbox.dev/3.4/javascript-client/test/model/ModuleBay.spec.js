...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.ModuleBay();
  });
  ...
  describe('ModuleBay', function() {
    it('should create an instance of ModuleBay', function() {
      // uncomment below and update the code to test ModuleBay
      //var instance = new NetBoxApi.ModuleBay();
      //expect(instance).to.be.a(NetBoxApi.ModuleBay);
    });
