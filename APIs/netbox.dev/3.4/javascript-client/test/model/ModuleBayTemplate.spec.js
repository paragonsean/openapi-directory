...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.ModuleBayTemplate();
  });
  ...
  describe('ModuleBayTemplate', function() {
    it('should create an instance of ModuleBayTemplate', function() {
      // uncomment below and update the code to test ModuleBayTemplate
      //var instance = new NetBoxApi.ModuleBayTemplate();
      //expect(instance).to.be.a(NetBoxApi.ModuleBayTemplate);
    });
