...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableContactGroup();
  });
  ...
  describe('WritableContactGroup', function() {
    it('should create an instance of WritableContactGroup', function() {
      // uncomment below and update the code to test WritableContactGroup
      //var instance = new NetBoxApi.WritableContactGroup();
      //expect(instance).to.be.a(NetBoxApi.WritableContactGroup);
    });
