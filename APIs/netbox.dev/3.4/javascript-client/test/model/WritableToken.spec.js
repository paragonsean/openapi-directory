...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableToken();
  });
  ...
  describe('WritableToken', function() {
    it('should create an instance of WritableToken', function() {
      // uncomment below and update the code to test WritableToken
      //var instance = new NetBoxApi.WritableToken();
      //expect(instance).to.be.a(NetBoxApi.WritableToken);
    });
