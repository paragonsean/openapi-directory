...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableContact();
  });
  ...
  describe('WritableContact', function() {
    it('should create an instance of WritableContact', function() {
      // uncomment below and update the code to test WritableContact
      //var instance = new NetBoxApi.WritableContact();
      //expect(instance).to.be.a(NetBoxApi.WritableContact);
    });
