...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.SiteGroup();
  });
  ...
  describe('SiteGroup', function() {
    it('should create an instance of SiteGroup', function() {
      // uncomment below and update the code to test SiteGroup
      //var instance = new NetBoxApi.SiteGroup();
      //expect(instance).to.be.a(NetBoxApi.SiteGroup);
    });
