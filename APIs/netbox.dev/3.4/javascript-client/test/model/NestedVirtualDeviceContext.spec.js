...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedVirtualDeviceContext();
  });
  ...
  describe('NestedVirtualDeviceContext', function() {
    it('should create an instance of NestedVirtualDeviceContext', function() {
      // uncomment below and update the code to test NestedVirtualDeviceContext
      //var instance = new NetBoxApi.NestedVirtualDeviceContext();
      //expect(instance).to.be.a(NetBoxApi.NestedVirtualDeviceContext);
    });
