...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedWirelessLAN();
  });
  ...
  describe('NestedWirelessLAN', function() {
    it('should create an instance of NestedWirelessLAN', function() {
      // uncomment below and update the code to test NestedWirelessLAN
      //var instance = new NetBoxApi.NestedWirelessLAN();
      //expect(instance).to.be.a(NetBoxApi.NestedWirelessLAN);
    });
