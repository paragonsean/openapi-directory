...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableUser();
  });
  ...
  describe('WritableUser', function() {
    it('should create an instance of WritableUser', function() {
      // uncomment below and update the code to test WritableUser
      //var instance = new NetBoxApi.WritableUser();
      //expect(instance).to.be.a(NetBoxApi.WritableUser);
    });
