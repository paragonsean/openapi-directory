...
(function(root, factory) {
  ...
  describe('L2VPN', function() {
    it('should create an instance of L2VPN', function() {
      // uncomment below and update the code to test L2VPN
      //var instance = new NetBoxApi.L2VPN();
      //expect(instance).to.be.a(NetBoxApi.L2VPN);
    });
