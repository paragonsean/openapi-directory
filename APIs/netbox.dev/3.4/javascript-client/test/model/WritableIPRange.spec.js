...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableIPRange();
  });
  ...
  describe('WritableIPRange', function() {
    it('should create an instance of WritableIPRange', function() {
      // uncomment below and update the code to test WritableIPRange
      //var instance = new NetBoxApi.WritableIPRange();
      //expect(instance).to.be.a(NetBoxApi.WritableIPRange);
    });
