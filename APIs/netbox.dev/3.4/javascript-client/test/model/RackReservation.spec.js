...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.RackReservation();
  });
  ...
  describe('RackReservation', function() {
    it('should create an instance of RackReservation', function() {
      // uncomment below and update the code to test RackReservation
      //var instance = new NetBoxApi.RackReservation();
      //expect(instance).to.be.a(NetBoxApi.RackReservation);
    });
