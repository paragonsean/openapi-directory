...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedL2VPN();
  });
  ...
  describe('NestedL2VPN', function() {
    it('should create an instance of NestedL2VPN', function() {
      // uncomment below and update the code to test NestedL2VPN
      //var instance = new NetBoxApi.NestedL2VPN();
      //expect(instance).to.be.a(NetBoxApi.NestedL2VPN);
    });
