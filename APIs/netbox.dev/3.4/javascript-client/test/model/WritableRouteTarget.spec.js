...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableRouteTarget();
  });
  ...
  describe('WritableRouteTarget', function() {
    it('should create an instance of WritableRouteTarget', function() {
      // uncomment below and update the code to test WritableRouteTarget
      //var instance = new NetBoxApi.WritableRouteTarget();
      //expect(instance).to.be.a(NetBoxApi.WritableRouteTarget);
    });
