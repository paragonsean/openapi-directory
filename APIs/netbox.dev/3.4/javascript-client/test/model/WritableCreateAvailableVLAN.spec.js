...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableCreateAvailableVLAN();
  });
  ...
  describe('WritableCreateAvailableVLAN', function() {
    it('should create an instance of WritableCreateAvailableVLAN', function() {
      // uncomment below and update the code to test WritableCreateAvailableVLAN
      //var instance = new NetBoxApi.WritableCreateAvailableVLAN();
      //expect(instance).to.be.a(NetBoxApi.WritableCreateAvailableVLAN);
    });
