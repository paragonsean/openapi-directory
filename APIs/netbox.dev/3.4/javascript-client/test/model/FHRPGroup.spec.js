...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.FHRPGroup();
  });
  ...
  describe('FHRPGroup', function() {
    it('should create an instance of FHRPGroup', function() {
      // uncomment below and update the code to test FHRPGroup
      //var instance = new NetBoxApi.FHRPGroup();
      //expect(instance).to.be.a(NetBoxApi.FHRPGroup);
    });
