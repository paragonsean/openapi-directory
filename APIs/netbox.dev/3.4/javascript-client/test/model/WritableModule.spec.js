...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableModule();
  });
  ...
  describe('WritableModule', function() {
    it('should create an instance of WritableModule', function() {
      // uncomment below and update the code to test WritableModule
      //var instance = new NetBoxApi.WritableModule();
      //expect(instance).to.be.a(NetBoxApi.WritableModule);
    });
