...
(function(root, factory) {
  ...
  describe('Cable', function() {
    ...
    it('should have the property aTerminations (base name: "a_terminations")', function() {
      // uncomment below and update the code to test the property aTerminations
      //var instance = new NetBoxApi.Cable();
      //expect(instance).to.be();
    });

    it('should have the property bTerminations (base name: "b_terminations")', function() {
      // uncomment below and update the code to test the property bTerminations
      //var instance = new NetBoxApi.Cable();
      //expect(instance).to.be();
    });
