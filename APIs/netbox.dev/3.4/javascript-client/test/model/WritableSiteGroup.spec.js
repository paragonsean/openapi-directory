...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableSiteGroup();
  });
  ...
  describe('WritableSiteGroup', function() {
    it('should create an instance of WritableSiteGroup', function() {
      // uncomment below and update the code to test WritableSiteGroup
      //var instance = new NetBoxApi.WritableSiteGroup();
      //expect(instance).to.be.a(NetBoxApi.WritableSiteGroup);
    });
