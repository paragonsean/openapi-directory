...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.PowerPanel();
  });
  ...
  describe('PowerPanel', function() {
    it('should create an instance of PowerPanel', function() {
      // uncomment below and update the code to test PowerPanel
      //var instance = new NetBoxApi.PowerPanel();
      //expect(instance).to.be.a(NetBoxApi.PowerPanel);
    });
