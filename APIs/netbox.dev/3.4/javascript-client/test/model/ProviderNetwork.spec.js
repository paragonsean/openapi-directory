...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.ProviderNetwork();
  });
  ...
  describe('ProviderNetwork', function() {
    it('should create an instance of ProviderNetwork', function() {
      // uncomment below and update the code to test ProviderNetwork
      //var instance = new NetBoxApi.ProviderNetwork();
      //expect(instance).to.be.a(NetBoxApi.ProviderNetwork);
    });
