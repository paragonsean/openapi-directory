...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableWirelessLAN();
  });
  ...
  describe('WritableWirelessLAN', function() {
    it('should create an instance of WritableWirelessLAN', function() {
      // uncomment below and update the code to test WritableWirelessLAN
      //var instance = new NetBoxApi.WritableWirelessLAN();
      //expect(instance).to.be.a(NetBoxApi.WritableWirelessLAN);
    });
