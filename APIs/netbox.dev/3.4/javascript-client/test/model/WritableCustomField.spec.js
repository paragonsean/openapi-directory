...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableCustomField();
  });
  ...
  describe('WritableCustomField', function() {
    it('should create an instance of WritableCustomField', function() {
      // uncomment below and update the code to test WritableCustomField
      //var instance = new NetBoxApi.WritableCustomField();
      //expect(instance).to.be.a(NetBoxApi.WritableCustomField);
    });
