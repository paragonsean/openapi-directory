...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.PrefixLength();
  });
  ...
  describe('PrefixLength', function() {
    it('should create an instance of PrefixLength', function() {
      // uncomment below and update the code to test PrefixLength
      //var instance = new NetBoxApi.PrefixLength();
      //expect(instance).to.be.a(NetBoxApi.PrefixLength);
    });
