...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableLocation();
  });
  ...
  describe('WritableLocation', function() {
    it('should create an instance of WritableLocation', function() {
      // uncomment below and update the code to test WritableLocation
      //var instance = new NetBoxApi.WritableLocation();
      //expect(instance).to.be.a(NetBoxApi.WritableLocation);
    });
