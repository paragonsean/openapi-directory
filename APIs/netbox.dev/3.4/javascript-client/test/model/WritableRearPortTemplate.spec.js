...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.WritableRearPortTemplate();
  });
  ...
  describe('WritableRearPortTemplate', function() {
    it('should create an instance of WritableRearPortTemplate', function() {
      // uncomment below and update the code to test WritableRearPortTemplate
      //var instance = new NetBoxApi.WritableRearPortTemplate();
      //expect(instance).to.be.a(NetBoxApi.WritableRearPortTemplate);
    });
