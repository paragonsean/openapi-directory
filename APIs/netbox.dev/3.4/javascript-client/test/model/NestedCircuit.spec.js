...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetBoxApi.NestedCircuit();
  });
  ...
  describe('NestedCircuit', function() {
    it('should create an instance of NestedCircuit', function() {
      // uncomment below and update the code to test NestedCircuit
      //var instance = new NetBoxApi.NestedCircuit();
      //expect(instance).to.be.a(NetBoxApi.NestedCircuit);
    });
