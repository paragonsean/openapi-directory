...
/*
 * OAIServiceTemplate.h
 *
 * 
 */

#ifndef OAIServiceTemplate_H
#define OAIServiceTemplate_H
...
class OAIServiceTemplate : public OAIObject {
public:
    OAIServiceTemplate();
    OAIServiceTemplate(QString json);
    ~OAIServiceTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceTemplate)

#endif // OAIServiceTemplate_H
