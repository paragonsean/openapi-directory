...
OAIObject OAIIPAddress::getAssignedObject() const {
    return m_assigned_object;
}
void OAIIPAddress::setAssignedObject(const OAIObject &assigned_object) {
    m_assigned_object = assigned_object;
    m_assigned_object_isSet = true;
}

bool OAIIPAddress::is_assigned_object_Set() const{
    return m_assigned_object_isSet;
}

bool OAIIPAddress::is_assigned_object_Valid() const{
    return m_assigned_object_isValid;
}

qint32 OAIIPAddress::getAssignedObjectId() const {
    return m_assigned_object_id;
}
void OAIIPAddress::setAssignedObjectId(const qint32 &assigned_object_id) {
    m_assigned_object_id = assigned_object_id;
    m_assigned_object_id_isSet = true;
}

bool OAIIPAddress::is_assigned_object_id_Set() const{
    return m_assigned_object_id_isSet;
}

bool OAIIPAddress::is_assigned_object_id_Valid() const{
    return m_assigned_object_id_isValid;
}

QString OAIIPAddress::getAssignedObjectType() const {
    return m_assigned_object_type;
}
void OAIIPAddress::setAssignedObjectType(const QString &assigned_object_type) {
    m_assigned_object_type = assigned_object_type;
    m_assigned_object_type_isSet = true;
}

bool OAIIPAddress::is_assigned_object_type_Set() const{
    return m_assigned_object_type_isSet;
}

bool OAIIPAddress::is_assigned_object_type_Valid() const{
    return m_assigned_object_type_isValid;
}

QString OAIIPAddress::getComments() const {
    return m_comments;
}
void OAIIPAddress::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIIPAddress::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIIPAddress::is_comments_Valid() const{
    return m_comments_isValid;
}

QDateTime OAIIPAddress::getCreated() const {
    return m_created;
}
void OAIIPAddress::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAIIPAddress::getDisplay() const {
    return m_display;
}
void OAIIPAddress::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIIPAddress::is_display_Set() const{
    return m_display_isSet;
}

bool OAIIPAddress::is_display_Valid() const{
    return m_display_isValid;
}

QString OAIIPAddress::getDnsName() const {
    return m_dns_name;
}
void OAIIPAddress::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAIIPAddress::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAIIPAddress::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

OAIFamily OAIIPAddress::getFamily() const {
    return m_family;
}
void OAIIPAddress::setFamily(const OAIFamily &family) {
    m_family = family;
    m_family_isSet = true;
}
...
QList<OAINestedIPAddress> OAIIPAddress::getNatOutside() const {
    return m_nat_outside;
}
void OAIIPAddress::setNatOutside(const QList<OAINestedIPAddress> &nat_outside) {
...
OAIStatus_4 OAIIPAddress::getStatus() const {
    return m_status;
}
void OAIIPAddress::setStatus(const OAIStatus_4 &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QList<OAINestedTag> OAIIPAddress::getTags() const {
    return m_tags;
}
void OAIIPAddress::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIIPAddress::getUrl() const {
    return m_url;
}
void OAIIPAddress::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIIPAddress::is_url_Set() const{
    return m_url_isSet;
}

bool OAIIPAddress::is_url_Valid() const{
