...
#ifndef OAIRouteTarget_H
#define OAIRouteTarget_H
...
class OAIRouteTarget : public OAIObject {
public:
    OAIRouteTarget();
    OAIRouteTarget(QString json);
    ~OAIRouteTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteTarget)

#endif // OAIRouteTarget_H
