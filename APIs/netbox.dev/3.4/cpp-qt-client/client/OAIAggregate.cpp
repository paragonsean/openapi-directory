...
QString OAIAggregate::getComments() const {
    return m_comments;
}
void OAIAggregate::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIAggregate::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIAggregate::is_comments_Valid() const{
    return m_comments_isValid;
}

QDateTime OAIAggregate::getCreated() const {
    return m_created;
}
void OAIAggregate::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAIAggregate::getDisplay() const {
    return m_display;
}
void OAIAggregate::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIAggregate::is_display_Set() const{
    return m_display_isSet;
}

bool OAIAggregate::is_display_Valid() const{
    return m_display_isValid;
}

OAIFamily OAIAggregate::getFamily() const {
    return m_family;
}
void OAIAggregate::setFamily(const OAIFamily &family) {
    m_family = family;
    m_family_isSet = true;
}
...
QList<OAINestedTag> OAIAggregate::getTags() const {
    return m_tags;
}
void OAIAggregate::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
OAINestedTenant OAIAggregate::getTenant() const {
    return m_tenant;
}
void OAIAggregate::setTenant(const OAINestedTenant &tenant) {
    m_tenant = tenant;
    m_tenant_isSet = true;
}

bool OAIAggregate::is_tenant_Set() const{
    return m_tenant_isSet;
}

bool OAIAggregate::is_tenant_Valid() const{
    return m_tenant_isValid;
}

QString OAIAggregate::getUrl() const {
    return m_url;
}
void OAIAggregate::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIAggregate::is_url_Set() const{
    return m_url_isSet;
}

bool OAIAggregate::is_url_Valid() const{
