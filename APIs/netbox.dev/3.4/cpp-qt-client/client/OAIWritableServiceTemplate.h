...
/*
 * OAIWritableServiceTemplate.h
 *
 * 
 */

#ifndef OAIWritableServiceTemplate_H
#define OAIWritableServiceTemplate_H
...
class OAIWritableServiceTemplate : public OAIObject {
public:
    OAIWritableServiceTemplate();
    OAIWritableServiceTemplate(QString json);
    ~OAIWritableServiceTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableServiceTemplate)

#endif // OAIWritableServiceTemplate_H
