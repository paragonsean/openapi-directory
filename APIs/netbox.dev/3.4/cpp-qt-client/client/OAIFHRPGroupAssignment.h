...
/*
 * OAIFHRPGroupAssignment.h
 *
 * 
 */

#ifndef OAIFHRPGroupAssignment_H
#define OAIFHRPGroupAssignment_H
...
namespace OpenAPI {
class OAINestedFHRPGroup;

class OAIFHRPGroupAssignment : public OAIObject {
public:
    OAIFHRPGroupAssignment();
    OAIFHRPGroupAssignment(QString json);
    ~OAIFHRPGroupAssignment() override;
    ...
    OAINestedFHRPGroup getGroup() const;
    void setGroup(const OAINestedFHRPGroup &group);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFHRPGroupAssignment)

#endif // OAIFHRPGroupAssignment_H
