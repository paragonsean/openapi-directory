...
/*
 * OAIWritableConfigContext.h
 *
 * 
 */

#ifndef OAIWritableConfigContext_H
#define OAIWritableConfigContext_H
...
class OAIWritableConfigContext : public OAIObject {
public:
    OAIWritableConfigContext();
    OAIWritableConfigContext(QString json);
    ~OAIWritableConfigContext() override;
    ...
    QSet<qint32> getClusterGroups() const;
    void setClusterGroups(const QSet<qint32> &cluster_groups);
    bool is_cluster_groups_Set() const;
    bool is_cluster_groups_Valid() const;

    QSet<qint32> getClusterTypes() const;
    void setClusterTypes(const QSet<qint32> &cluster_types);
    bool is_cluster_types_Set() const;
    bool is_cluster_types_Valid() const;

    QSet<qint32> getClusters() const;
    void setClusters(const QSet<qint32> &clusters);
    ...
    QSet<qint32> getDeviceTypes() const;
    void setDeviceTypes(const QSet<qint32> &device_types);
    ...
    QSet<qint32> getLocations() const;
    void setLocations(const QSet<qint32> &locations);
    ...
    QSet<qint32> getPlatforms() const;
    void setPlatforms(const QSet<qint32> &platforms);
    bool is_platforms_Set() const;
    bool is_platforms_Valid() const;

    QSet<qint32> getRegions() const;
    void setRegions(const QSet<qint32> &regions);
    bool is_regions_Set() const;
    bool is_regions_Valid() const;

    QSet<qint32> getRoles() const;
    void setRoles(const QSet<qint32> &roles);
    bool is_roles_Set() const;
    bool is_roles_Valid() const;

    QSet<qint32> getSiteGroups() const;
    void setSiteGroups(const QSet<qint32> &site_groups);
    bool is_site_groups_Set() const;
    bool is_site_groups_Valid() const;

    QSet<qint32> getSites() const;
    void setSites(const QSet<qint32> &sites);
    ...
    QSet<qint32> getTenantGroups() const;
    void setTenantGroups(const QSet<qint32> &tenant_groups);
    bool is_tenant_groups_Set() const;
    bool is_tenant_groups_Valid() const;

    QSet<qint32> getTenants() const;
    void setTenants(const QSet<qint32> &tenants);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableConfigContext)

#endif // OAIWritableConfigContext_H
