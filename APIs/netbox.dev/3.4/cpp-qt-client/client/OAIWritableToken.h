...
#ifndef OAIWritableToken_H
#define OAIWritableToken_H
...
class OAIWritableToken : public OAIObject {
public:
    OAIWritableToken();
    OAIWritableToken(QString json);
    ~OAIWritableToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableToken)

#endif // OAIWritableToken_H
