...
/*
 * OAINestedVirtualChassis.h
 *
 * 
 */

#ifndef OAINestedVirtualChassis_H
#define OAINestedVirtualChassis_H
...
class OAINestedVirtualChassis : public OAIObject {
public:
    OAINestedVirtualChassis();
    OAINestedVirtualChassis(QString json);
    ~OAINestedVirtualChassis() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedVirtualChassis)

#endif // OAINestedVirtualChassis_H
