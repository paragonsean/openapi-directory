...
#ifndef OAIRearPort_H
#define OAIRearPort_H
...
class OAIRearPort : public OAIObject {
public:
    OAIRearPort();
    OAIRearPort(QString json);
    ~OAIRearPort() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRearPort)
