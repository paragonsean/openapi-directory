...
#ifndef OAINestedRack_H
#define OAINestedRack_H
...
class OAINestedRack : public OAIObject {
public:
    OAINestedRack();
    OAINestedRack(QString json);
    ~OAINestedRack() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedRack)

#endif // OAINestedRack_H
