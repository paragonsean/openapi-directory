...
QDateTime OAICluster::getCreated() const {
    return m_created;
}
void OAICluster::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAICluster::getDisplay() const {
    return m_display;
}
void OAICluster::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAICluster::is_display_Set() const{
    return m_display_isSet;
}

bool OAICluster::is_display_Valid() const{
...
OAIStatus_2 OAICluster::getStatus() const {
    return m_status;
}
void OAICluster::setStatus(const OAIStatus_2 &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QList<OAINestedTag> OAICluster::getTags() const {
    return m_tags;
}
void OAICluster::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAICluster::getUrl() const {
    return m_url;
}
void OAICluster::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAICluster::is_url_Set() const{
    return m_url_isSet;
}

bool OAICluster::is_url_Valid() const{
