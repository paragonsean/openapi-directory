...
#ifndef OAINestedTag_H
#define OAINestedTag_H
...
class OAINestedTag : public OAIObject {
public:
    OAINestedTag();
    OAINestedTag(QString json);
    ~OAINestedTag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedTag)

#endif // OAINestedTag_H
