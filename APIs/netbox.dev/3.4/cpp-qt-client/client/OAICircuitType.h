...
#ifndef OAICircuitType_H
#define OAICircuitType_H
...
class OAICircuitType : public OAIObject {
public:
    OAICircuitType();
    OAICircuitType(QString json);
    ~OAICircuitType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICircuitType)

#endif // OAICircuitType_H
