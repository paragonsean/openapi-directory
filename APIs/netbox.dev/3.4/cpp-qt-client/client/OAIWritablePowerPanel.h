...
/*
 * OAIWritablePowerPanel.h
 *
 * 
 */

#ifndef OAIWritablePowerPanel_H
#define OAIWritablePowerPanel_H
...
class OAIWritablePowerPanel : public OAIObject {
public:
    OAIWritablePowerPanel();
    OAIWritablePowerPanel(QString json);
    ~OAIWritablePowerPanel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritablePowerPanel)

#endif // OAIWritablePowerPanel_H
