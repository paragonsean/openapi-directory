...
OAIAirflow OAIDevice::getAirflow() const {
    return m_airflow;
}
void OAIDevice::setAirflow(const OAIAirflow &airflow) {
    m_airflow = airflow;
    m_airflow_isSet = true;
}

bool OAIDevice::is_airflow_Set() const{
    return m_airflow_isSet;
}

bool OAIDevice::is_airflow_Valid() const{
...
QDateTime OAIDevice::getCreated() const {
    return m_created;
}
void OAIDevice::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAIDevice::getDisplay() const {
    return m_display;
}
void OAIDevice::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIDevice::is_display_Set() const{
    return m_display_isSet;
}

bool OAIDevice::is_display_Valid() const{
...
OAIObject OAIDevice::getLocalContextData() const {
    return m_local_context_data;
}
void OAIDevice::setLocalContextData(const OAIObject &local_context_data) {
...
OAINestedLocation OAIDevice::getLocation() const {
    return m_location;
}
void OAIDevice::setLocation(const OAINestedLocation &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDevice::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDevice::is_location_Valid() const{
...
double OAIDevice::getPosition() const {
    return m_position;
}
void OAIDevice::setPosition(const double &position) {
    m_position = position;
...
OAIStatus_3 OAIDevice::getStatus() const {
    return m_status;
}
void OAIDevice::setStatus(const OAIStatus_3 &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QList<OAINestedTag> OAIDevice::getTags() const {
    return m_tags;
}
void OAIDevice::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIDevice::getUrl() const {
    return m_url;
}
void OAIDevice::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIDevice::is_url_Set() const{
    return m_url_isSet;
}

bool OAIDevice::is_url_Valid() const{
