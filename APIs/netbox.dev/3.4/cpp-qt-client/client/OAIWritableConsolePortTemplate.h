...
/*
 * OAIWritableConsolePortTemplate.h
 *
 * 
 */

#ifndef OAIWritableConsolePortTemplate_H
#define OAIWritableConsolePortTemplate_H
...
class OAIWritableConsolePortTemplate : public OAIObject {
public:
    OAIWritableConsolePortTemplate();
    OAIWritableConsolePortTemplate(QString json);
    ~OAIWritableConsolePortTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableConsolePortTemplate)

#endif // OAIWritableConsolePortTemplate_H
