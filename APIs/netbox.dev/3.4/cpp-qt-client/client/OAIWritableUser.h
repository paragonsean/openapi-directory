...
#ifndef OAIWritableUser_H
#define OAIWritableUser_H
...
class OAIWritableUser : public OAIObject {
public:
    OAIWritableUser();
    OAIWritableUser(QString json);
    ~OAIWritableUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableUser)

#endif // OAIWritableUser_H
