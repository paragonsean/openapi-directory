...
QSet<OAINestedASN> OAIProvider::getAsns() const {
    return m_asns;
}
void OAIProvider::setAsns(const QSet<OAINestedASN> &asns) {
    m_asns = asns;
    m_asns_isSet = true;
}

bool OAIProvider::is_asns_Set() const{
    return m_asns_isSet;
}

bool OAIProvider::is_asns_Valid() const{
...
QDateTime OAIProvider::getCreated() const {
    return m_created;
}
void OAIProvider::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAIProvider::getDisplay() const {
    return m_display;
}
void OAIProvider::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIProvider::is_display_Set() const{
    return m_display_isSet;
}

bool OAIProvider::is_display_Valid() const{
...
QList<OAINestedTag> OAIProvider::getTags() const {
    return m_tags;
}
void OAIProvider::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIProvider::getUrl() const {
    return m_url;
}
void OAIProvider::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIProvider::is_url_Set() const{
    return m_url_isSet;
}

bool OAIProvider::is_url_Valid() const{
