...
/*
 * OAIWritableInventoryItemTemplate.h
 *
 * 
 */

#ifndef OAIWritableInventoryItemTemplate_H
#define OAIWritableInventoryItemTemplate_H
...
class OAIWritableInventoryItemTemplate : public OAIObject {
public:
    OAIWritableInventoryItemTemplate();
    OAIWritableInventoryItemTemplate(QString json);
    ~OAIWritableInventoryItemTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableInventoryItemTemplate)

#endif // OAIWritableInventoryItemTemplate_H
