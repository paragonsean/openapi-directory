...
#ifndef OAIModuleType_H
#define OAIModuleType_H
...
class OAIModuleType : public OAIObject {
public:
    OAIModuleType();
    OAIModuleType(QString json);
    ~OAIModuleType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModuleType)

#endif // OAIModuleType_H
