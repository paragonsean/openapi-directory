...
/*
 * OAIVirtualDeviceContext.h
 *
 * 
 */

#ifndef OAIVirtualDeviceContext_H
#define OAIVirtualDeviceContext_H
...
class OAIVirtualDeviceContext : public OAIObject {
public:
    OAIVirtualDeviceContext();
    OAIVirtualDeviceContext(QString json);
    ~OAIVirtualDeviceContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualDeviceContext)

#endif // OAIVirtualDeviceContext_H
