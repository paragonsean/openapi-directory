...
bool OAIWritableConsolePort::isOccupied() const {
    return m__occupied;
}
void OAIWritableConsolePort::setOccupied(const bool &_occupied) {
    m__occupied = _occupied;
    m__occupied_isSet = true;
}

bool OAIWritableConsolePort::is__occupied_Set() const{
    return m__occupied_isSet;
}

bool OAIWritableConsolePort::is__occupied_Valid() const{
...
QString OAIWritableConsolePort::getCableEnd() const {
    return m_cable_end;
}
void OAIWritableConsolePort::setCableEnd(const QString &cable_end) {
    m_cable_end = cable_end;
    m_cable_end_isSet = true;
}

bool OAIWritableConsolePort::is_cable_end_Set() const{
    return m_cable_end_isSet;
}

bool OAIWritableConsolePort::is_cable_end_Valid() const{
    return m_cable_end_isValid;
}

QList<QString> OAIWritableConsolePort::getConnectedEndpoints() const {
    return m_connected_endpoints;
}
void OAIWritableConsolePort::setConnectedEndpoints(const QList<QString> &connected_endpoints) {
    m_connected_endpoints = connected_endpoints;
    m_connected_endpoints_isSet = true;
}

bool OAIWritableConsolePort::is_connected_endpoints_Set() const{
    return m_connected_endpoints_isSet;
}

bool OAIWritableConsolePort::is_connected_endpoints_Valid() const{
    return m_connected_endpoints_isValid;
}

bool OAIWritableConsolePort::isConnectedEndpointsReachable() const {
    return m_connected_endpoints_reachable;
}
void OAIWritableConsolePort::setConnectedEndpointsReachable(const bool &connected_endpoints_reachable) {
    m_connected_endpoints_reachable = connected_endpoints_reachable;
    m_connected_endpoints_reachable_isSet = true;
}

bool OAIWritableConsolePort::is_connected_endpoints_reachable_Set() const{
    return m_connected_endpoints_reachable_isSet;
}

bool OAIWritableConsolePort::is_connected_endpoints_reachable_Valid() const{
    return m_connected_endpoints_reachable_isValid;
}

QString OAIWritableConsolePort::getConnectedEndpointsType() const {
    return m_connected_endpoints_type;
}
void OAIWritableConsolePort::setConnectedEndpointsType(const QString &connected_endpoints_type) {
    m_connected_endpoints_type = connected_endpoints_type;
    m_connected_endpoints_type_isSet = true;
}

bool OAIWritableConsolePort::is_connected_endpoints_type_Set() const{
    return m_connected_endpoints_type_isSet;
}

bool OAIWritableConsolePort::is_connected_endpoints_type_Valid() const{
    return m_connected_endpoints_type_isValid;
}

QDateTime OAIWritableConsolePort::getCreated() const {
    return m_created;
}
void OAIWritableConsolePort::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIWritableConsolePort::is_created_Set() const{
    return m_created_isSet;
}

bool OAIWritableConsolePort::is_created_Valid() const{
    return m_created_isValid;
}

OAIObject OAIWritableConsolePort::getCustomFields() const {
    return m_custom_fields;
}
void OAIWritableConsolePort::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIWritableConsolePort::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIWritableConsolePort::is_custom_fields_Valid() const{
...
QString OAIWritableConsolePort::getDisplay() const {
    return m_display;
}
void OAIWritableConsolePort::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIWritableConsolePort::is_display_Set() const{
    return m_display_isSet;
}

bool OAIWritableConsolePort::is_display_Valid() const{
...
QString OAIWritableConsolePort::getLabel() const {
    return m_label;
}
void OAIWritableConsolePort::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIWritableConsolePort::is_label_Set() const{
    return m_label_isSet;
}

bool OAIWritableConsolePort::is_label_Valid() const{
    return m_label_isValid;
}

QDateTime OAIWritableConsolePort::getLastUpdated() const {
    return m_last_updated;
}
void OAIWritableConsolePort::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIWritableConsolePort::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIWritableConsolePort::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

QList<QString> OAIWritableConsolePort::getLinkPeers() const {
    return m_link_peers;
}
void OAIWritableConsolePort::setLinkPeers(const QList<QString> &link_peers) {
    m_link_peers = link_peers;
    m_link_peers_isSet = true;
}

bool OAIWritableConsolePort::is_link_peers_Set() const{
    return m_link_peers_isSet;
}

bool OAIWritableConsolePort::is_link_peers_Valid() const{
    return m_link_peers_isValid;
}

QString OAIWritableConsolePort::getLinkPeersType() const {
    return m_link_peers_type;
}
void OAIWritableConsolePort::setLinkPeersType(const QString &link_peers_type) {
    m_link_peers_type = link_peers_type;
    m_link_peers_type_isSet = true;
}

bool OAIWritableConsolePort::is_link_peers_type_Set() const{
    return m_link_peers_type_isSet;
}

bool OAIWritableConsolePort::is_link_peers_type_Valid() const{
    return m_link_peers_type_isValid;
}

bool OAIWritableConsolePort::isMarkConnected() const {
    return m_mark_connected;
}
void OAIWritableConsolePort::setMarkConnected(const bool &mark_connected) {
    m_mark_connected = mark_connected;
    m_mark_connected_isSet = true;
}

bool OAIWritableConsolePort::is_mark_connected_Set() const{
    return m_mark_connected_isSet;
}

bool OAIWritableConsolePort::is_mark_connected_Valid() const{
    return m_mark_connected_isValid;
}

qint32 OAIWritableConsolePort::getModule() const {
    return m_module;
}
void OAIWritableConsolePort::setModule(const qint32 &module) {
    m_module = module;
    m_module_isSet = true;
}

bool OAIWritableConsolePort::is_module_Set() const{
    return m_module_isSet;
}

bool OAIWritableConsolePort::is_module_Valid() const{
...
qint32 OAIWritableConsolePort::getSpeed() const {
    return m_speed;
}
void OAIWritableConsolePort::setSpeed(const qint32 &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIWritableConsolePort::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIWritableConsolePort::is_speed_Valid() const{
    return m_speed_isValid;
}

QList<OAINestedTag> OAIWritableConsolePort::getTags() const {
    return m_tags;
}
void OAIWritableConsolePort::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIWritableConsolePort::getUrl() const {
    return m_url;
}
void OAIWritableConsolePort::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWritableConsolePort::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWritableConsolePort::is_url_Valid() const{
