...
bool OAIWritablePowerFeed::isOccupied() const {
    return m__occupied;
}
void OAIWritablePowerFeed::setOccupied(const bool &_occupied) {
    m__occupied = _occupied;
    m__occupied_isSet = true;
}

bool OAIWritablePowerFeed::is__occupied_Set() const{
    return m__occupied_isSet;
}

bool OAIWritablePowerFeed::is__occupied_Valid() const{
...
OAINestedCable OAIWritablePowerFeed::getCable() const {
    return m_cable;
}
void OAIWritablePowerFeed::setCable(const OAINestedCable &cable) {
    m_cable = cable;
    m_cable_isSet = true;
}

bool OAIWritablePowerFeed::is_cable_Set() const{
    return m_cable_isSet;
}

bool OAIWritablePowerFeed::is_cable_Valid() const{
    return m_cable_isValid;
}

QString OAIWritablePowerFeed::getCableEnd() const {
    return m_cable_end;
}
void OAIWritablePowerFeed::setCableEnd(const QString &cable_end) {
    m_cable_end = cable_end;
    m_cable_end_isSet = true;
}

bool OAIWritablePowerFeed::is_cable_end_Set() const{
    return m_cable_end_isSet;
}

bool OAIWritablePowerFeed::is_cable_end_Valid() const{
...
QList<QString> OAIWritablePowerFeed::getConnectedEndpoints() const {
    return m_connected_endpoints;
}
void OAIWritablePowerFeed::setConnectedEndpoints(const QList<QString> &connected_endpoints) {
    m_connected_endpoints = connected_endpoints;
    m_connected_endpoints_isSet = true;
}

bool OAIWritablePowerFeed::is_connected_endpoints_Set() const{
    return m_connected_endpoints_isSet;
}

bool OAIWritablePowerFeed::is_connected_endpoints_Valid() const{
    return m_connected_endpoints_isValid;
}

bool OAIWritablePowerFeed::isConnectedEndpointsReachable() const {
    return m_connected_endpoints_reachable;
}
void OAIWritablePowerFeed::setConnectedEndpointsReachable(const bool &connected_endpoints_reachable) {
    m_connected_endpoints_reachable = connected_endpoints_reachable;
    m_connected_endpoints_reachable_isSet = true;
}

bool OAIWritablePowerFeed::is_connected_endpoints_reachable_Set() const{
    return m_connected_endpoints_reachable_isSet;
}

bool OAIWritablePowerFeed::is_connected_endpoints_reachable_Valid() const{
    return m_connected_endpoints_reachable_isValid;
}

QString OAIWritablePowerFeed::getConnectedEndpointsType() const {
    return m_connected_endpoints_type;
}
void OAIWritablePowerFeed::setConnectedEndpointsType(const QString &connected_endpoints_type) {
    m_connected_endpoints_type = connected_endpoints_type;
    m_connected_endpoints_type_isSet = true;
}

bool OAIWritablePowerFeed::is_connected_endpoints_type_Set() const{
    return m_connected_endpoints_type_isSet;
}

bool OAIWritablePowerFeed::is_connected_endpoints_type_Valid() const{
    return m_connected_endpoints_type_isValid;
}

QDateTime OAIWritablePowerFeed::getCreated() const {
    return m_created;
}
void OAIWritablePowerFeed::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAIWritablePowerFeed::getDescription() const {
    return m_description;
}
void OAIWritablePowerFeed::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIWritablePowerFeed::is_description_Set() const{
    return m_description_isSet;
}

bool OAIWritablePowerFeed::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIWritablePowerFeed::getDisplay() const {
    return m_display;
}
void OAIWritablePowerFeed::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIWritablePowerFeed::is_display_Set() const{
    return m_display_isSet;
}

bool OAIWritablePowerFeed::is_display_Valid() const{
...
QList<QString> OAIWritablePowerFeed::getLinkPeers() const {
    return m_link_peers;
}
void OAIWritablePowerFeed::setLinkPeers(const QList<QString> &link_peers) {
    m_link_peers = link_peers;
    m_link_peers_isSet = true;
}

bool OAIWritablePowerFeed::is_link_peers_Set() const{
    return m_link_peers_isSet;
}

bool OAIWritablePowerFeed::is_link_peers_Valid() const{
    return m_link_peers_isValid;
}

QString OAIWritablePowerFeed::getLinkPeersType() const {
    return m_link_peers_type;
}
void OAIWritablePowerFeed::setLinkPeersType(const QString &link_peers_type) {
    m_link_peers_type = link_peers_type;
    m_link_peers_type_isSet = true;
}

bool OAIWritablePowerFeed::is_link_peers_type_Set() const{
    return m_link_peers_type_isSet;
}

bool OAIWritablePowerFeed::is_link_peers_type_Valid() const{
    return m_link_peers_type_isValid;
}

bool OAIWritablePowerFeed::isMarkConnected() const {
    return m_mark_connected;
}
void OAIWritablePowerFeed::setMarkConnected(const bool &mark_connected) {
    m_mark_connected = mark_connected;
    m_mark_connected_isSet = true;
}

bool OAIWritablePowerFeed::is_mark_connected_Set() const{
    return m_mark_connected_isSet;
}

bool OAIWritablePowerFeed::is_mark_connected_Valid() const{
...
QList<OAINestedTag> OAIWritablePowerFeed::getTags() const {
    return m_tags;
}
void OAIWritablePowerFeed::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIWritablePowerFeed::getUrl() const {
    return m_url;
}
void OAIWritablePowerFeed::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWritablePowerFeed::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWritablePowerFeed::is_url_Valid() const{
