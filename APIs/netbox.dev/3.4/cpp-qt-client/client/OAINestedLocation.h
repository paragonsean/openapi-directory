...
#ifndef OAINestedLocation_H
#define OAINestedLocation_H
...
class OAINestedLocation : public OAIObject {
public:
    OAINestedLocation();
    OAINestedLocation(QString json);
    ~OAINestedLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedLocation)

#endif // OAINestedLocation_H
