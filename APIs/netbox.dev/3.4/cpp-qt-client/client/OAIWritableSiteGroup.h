...
/*
 * OAIWritableSiteGroup.h
 *
 * 
 */

#ifndef OAIWritableSiteGroup_H
#define OAIWritableSiteGroup_H
...
class OAIWritableSiteGroup : public OAIObject {
public:
    OAIWritableSiteGroup();
    OAIWritableSiteGroup(QString json);
    ~OAIWritableSiteGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWritableSiteGroup)

#endif // OAIWritableSiteGroup_H
