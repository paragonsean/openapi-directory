...
/*
 * OAINestedSiteGroup.h
 *
 * 
 */

#ifndef OAINestedSiteGroup_H
#define OAINestedSiteGroup_H
...
class OAINestedSiteGroup : public OAIObject {
public:
    OAINestedSiteGroup();
    OAINestedSiteGroup(QString json);
    ~OAINestedSiteGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedSiteGroup)

#endif // OAINestedSiteGroup_H
