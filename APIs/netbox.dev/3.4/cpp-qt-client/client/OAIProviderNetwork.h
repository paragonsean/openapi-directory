...
/*
 * OAIProviderNetwork.h
 *
 * 
 */

#ifndef OAIProviderNetwork_H
#define OAIProviderNetwork_H
...
class OAIProviderNetwork : public OAIObject {
public:
    OAIProviderNetwork();
    OAIProviderNetwork(QString json);
    ~OAIProviderNetwork() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProviderNetwork)

#endif // OAIProviderNetwork_H
