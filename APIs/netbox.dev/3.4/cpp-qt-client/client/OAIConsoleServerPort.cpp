...
bool OAIConsoleServerPort::isOccupied() const {
    return m__occupied;
}
void OAIConsoleServerPort::setOccupied(const bool &_occupied) {
    m__occupied = _occupied;
    m__occupied_isSet = true;
}

bool OAIConsoleServerPort::is__occupied_Set() const{
    return m__occupied_isSet;
}

bool OAIConsoleServerPort::is__occupied_Valid() const{
...
QString OAIConsoleServerPort::getCableEnd() const {
    return m_cable_end;
}
void OAIConsoleServerPort::setCableEnd(const QString &cable_end) {
    m_cable_end = cable_end;
    m_cable_end_isSet = true;
}

bool OAIConsoleServerPort::is_cable_end_Set() const{
    return m_cable_end_isSet;
}

bool OAIConsoleServerPort::is_cable_end_Valid() const{
    return m_cable_end_isValid;
}

QList<QString> OAIConsoleServerPort::getConnectedEndpoints() const {
    return m_connected_endpoints;
}
void OAIConsoleServerPort::setConnectedEndpoints(const QList<QString> &connected_endpoints) {
    m_connected_endpoints = connected_endpoints;
    m_connected_endpoints_isSet = true;
}

bool OAIConsoleServerPort::is_connected_endpoints_Set() const{
    return m_connected_endpoints_isSet;
}

bool OAIConsoleServerPort::is_connected_endpoints_Valid() const{
    return m_connected_endpoints_isValid;
}

bool OAIConsoleServerPort::isConnectedEndpointsReachable() const {
    return m_connected_endpoints_reachable;
}
void OAIConsoleServerPort::setConnectedEndpointsReachable(const bool &connected_endpoints_reachable) {
    m_connected_endpoints_reachable = connected_endpoints_reachable;
    m_connected_endpoints_reachable_isSet = true;
}

bool OAIConsoleServerPort::is_connected_endpoints_reachable_Set() const{
    return m_connected_endpoints_reachable_isSet;
}

bool OAIConsoleServerPort::is_connected_endpoints_reachable_Valid() const{
    return m_connected_endpoints_reachable_isValid;
}

QString OAIConsoleServerPort::getConnectedEndpointsType() const {
    return m_connected_endpoints_type;
}
void OAIConsoleServerPort::setConnectedEndpointsType(const QString &connected_endpoints_type) {
    m_connected_endpoints_type = connected_endpoints_type;
    m_connected_endpoints_type_isSet = true;
}

bool OAIConsoleServerPort::is_connected_endpoints_type_Set() const{
    return m_connected_endpoints_type_isSet;
}

bool OAIConsoleServerPort::is_connected_endpoints_type_Valid() const{
    return m_connected_endpoints_type_isValid;
}

QDateTime OAIConsoleServerPort::getCreated() const {
    return m_created;
}
void OAIConsoleServerPort::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIConsoleServerPort::is_created_Set() const{
    return m_created_isSet;
}

bool OAIConsoleServerPort::is_created_Valid() const{
    return m_created_isValid;
}

OAIObject OAIConsoleServerPort::getCustomFields() const {
    return m_custom_fields;
}
void OAIConsoleServerPort::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAIConsoleServerPort::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAIConsoleServerPort::is_custom_fields_Valid() const{
...
QString OAIConsoleServerPort::getDisplay() const {
    return m_display;
}
void OAIConsoleServerPort::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIConsoleServerPort::is_display_Set() const{
    return m_display_isSet;
}

bool OAIConsoleServerPort::is_display_Valid() const{
...
QString OAIConsoleServerPort::getLabel() const {
    return m_label;
}
void OAIConsoleServerPort::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIConsoleServerPort::is_label_Set() const{
    return m_label_isSet;
}

bool OAIConsoleServerPort::is_label_Valid() const{
    return m_label_isValid;
}

QDateTime OAIConsoleServerPort::getLastUpdated() const {
    return m_last_updated;
}
void OAIConsoleServerPort::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIConsoleServerPort::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIConsoleServerPort::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

QList<QString> OAIConsoleServerPort::getLinkPeers() const {
    return m_link_peers;
}
void OAIConsoleServerPort::setLinkPeers(const QList<QString> &link_peers) {
    m_link_peers = link_peers;
    m_link_peers_isSet = true;
}

bool OAIConsoleServerPort::is_link_peers_Set() const{
    return m_link_peers_isSet;
}

bool OAIConsoleServerPort::is_link_peers_Valid() const{
    return m_link_peers_isValid;
}

QString OAIConsoleServerPort::getLinkPeersType() const {
    return m_link_peers_type;
}
void OAIConsoleServerPort::setLinkPeersType(const QString &link_peers_type) {
    m_link_peers_type = link_peers_type;
    m_link_peers_type_isSet = true;
}

bool OAIConsoleServerPort::is_link_peers_type_Set() const{
    return m_link_peers_type_isSet;
}

bool OAIConsoleServerPort::is_link_peers_type_Valid() const{
    return m_link_peers_type_isValid;
}

bool OAIConsoleServerPort::isMarkConnected() const {
    return m_mark_connected;
}
void OAIConsoleServerPort::setMarkConnected(const bool &mark_connected) {
    m_mark_connected = mark_connected;
    m_mark_connected_isSet = true;
}

bool OAIConsoleServerPort::is_mark_connected_Set() const{
    return m_mark_connected_isSet;
}

bool OAIConsoleServerPort::is_mark_connected_Valid() const{
    return m_mark_connected_isValid;
}

OAIComponentNestedModule OAIConsoleServerPort::getModule() const {
    return m_module;
}
void OAIConsoleServerPort::setModule(const OAIComponentNestedModule &module) {
    m_module = module;
    m_module_isSet = true;
}

bool OAIConsoleServerPort::is_module_Set() const{
    return m_module_isSet;
}

bool OAIConsoleServerPort::is_module_Valid() const{
...
OAISpeed OAIConsoleServerPort::getSpeed() const {
    return m_speed;
}
void OAIConsoleServerPort::setSpeed(const OAISpeed &speed) {
    m_speed = speed;
    m_speed_isSet = true;
}

bool OAIConsoleServerPort::is_speed_Set() const{
    return m_speed_isSet;
}

bool OAIConsoleServerPort::is_speed_Valid() const{
    return m_speed_isValid;
}

QList<OAINestedTag> OAIConsoleServerPort::getTags() const {
    return m_tags;
}
void OAIConsoleServerPort::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIConsoleServerPort::getUrl() const {
    return m_url;
}
void OAIConsoleServerPort::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIConsoleServerPort::is_url_Set() const{
    return m_url_isSet;
}

bool OAIConsoleServerPort::is_url_Valid() const{
