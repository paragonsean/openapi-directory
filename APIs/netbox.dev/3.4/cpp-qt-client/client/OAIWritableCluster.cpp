...
QDateTime OAIWritableCluster::getCreated() const {
    return m_created;
}
void OAIWritableCluster::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAIWritableCluster::getDescription() const {
    return m_description;
}
void OAIWritableCluster::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIWritableCluster::is_description_Set() const{
    return m_description_isSet;
}

bool OAIWritableCluster::is_description_Valid() const{
...
QString OAIWritableCluster::getDisplay() const {
    return m_display;
}
void OAIWritableCluster::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIWritableCluster::is_display_Set() const{
    return m_display_isSet;
}

bool OAIWritableCluster::is_display_Valid() const{
...
QString OAIWritableCluster::getStatus() const {
    return m_status;
}
void OAIWritableCluster::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIWritableCluster::is_status_Set() const{
    return m_status_isSet;
}

bool OAIWritableCluster::is_status_Valid() const{
    return m_status_isValid;
}

QList<OAINestedTag> OAIWritableCluster::getTags() const {
    return m_tags;
}
void OAIWritableCluster::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIWritableCluster::getUrl() const {
    return m_url;
}
void OAIWritableCluster::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWritableCluster::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWritableCluster::is_url_Valid() const{
