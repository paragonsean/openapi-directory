...
QList<OAIGenericObject> OAICable::getATerminations() const {
    return m_a_terminations;
}
void OAICable::setATerminations(const QList<OAIGenericObject> &a_terminations) {
    m_a_terminations = a_terminations;
    m_a_terminations_isSet = true;
}

bool OAICable::is_a_terminations_Set() const{
    return m_a_terminations_isSet;
}

bool OAICable::is_a_terminations_Valid() const{
    return m_a_terminations_isValid;
}

QList<OAIGenericObject> OAICable::getBTerminations() const {
    return m_b_terminations;
}
void OAICable::setBTerminations(const QList<OAIGenericObject> &b_terminations) {
    m_b_terminations = b_terminations;
    m_b_terminations_isSet = true;
}

bool OAICable::is_b_terminations_Set() const{
    return m_b_terminations_isSet;
}

bool OAICable::is_b_terminations_Valid() const{
...
QString OAICable::getComments() const {
    return m_comments;
}
void OAICable::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAICable::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAICable::is_comments_Valid() const{
    return m_comments_isValid;
}

QDateTime OAICable::getCreated() const {
    return m_created;
}
void OAICable::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAICable::is_created_Set() const{
    return m_created_isSet;
}

bool OAICable::is_created_Valid() const{
    return m_created_isValid;
}

OAIObject OAICable::getCustomFields() const {
    return m_custom_fields;
}
void OAICable::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAICable::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAICable::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAICable::getDescription() const {
    return m_description;
}
void OAICable::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICable::is_description_Set() const{
    return m_description_isSet;
}

bool OAICable::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICable::getDisplay() const {
    return m_display;
}
void OAICable::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAICable::is_display_Set() const{
    return m_display_isSet;
}

bool OAICable::is_display_Valid() const{
...
QDateTime OAICable::getLastUpdated() const {
    return m_last_updated;
}
void OAICable::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAICable::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAICable::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

double OAICable::getLength() const {
    return m_length;
}
void OAICable::setLength(const double &length) {
    m_length = length;
    m_length_isSet = true;
}
...
QList<OAINestedTag> OAICable::getTags() const {
    return m_tags;
}
void OAICable::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICable::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICable::is_tags_Valid() const{
    return m_tags_isValid;
}

OAINestedTenant OAICable::getTenant() const {
    return m_tenant;
}
void OAICable::setTenant(const OAINestedTenant &tenant) {
    m_tenant = tenant;
    m_tenant_isSet = true;
}

bool OAICable::is_tenant_Set() const{
    return m_tenant_isSet;
}

bool OAICable::is_tenant_Valid() const{
...
QString OAICable::getUrl() const {
    return m_url;
}
void OAICable::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAICable::is_url_Set() const{
    return m_url_isSet;
}

bool OAICable::is_url_Valid() const{
