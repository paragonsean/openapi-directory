...
OAIObject OAIVirtualMachineWithConfigContext::getConfigContext() const {
    return m_config_context;
}
void OAIVirtualMachineWithConfigContext::setConfigContext(const OAIObject &config_context) {
...
QDateTime OAIVirtualMachineWithConfigContext::getCreated() const {
    return m_created;
}
void OAIVirtualMachineWithConfigContext::setCreated(const QDateTime &created) {
    m_created = created;
...
QString OAIVirtualMachineWithConfigContext::getDescription() const {
    return m_description;
}
void OAIVirtualMachineWithConfigContext::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIVirtualMachineWithConfigContext::is_description_Set() const{
    return m_description_isSet;
}

bool OAIVirtualMachineWithConfigContext::is_description_Valid() const{
    return m_description_isValid;
}

OAINestedDevice OAIVirtualMachineWithConfigContext::getDevice() const {
    return m_device;
}
void OAIVirtualMachineWithConfigContext::setDevice(const OAINestedDevice &device) {
    m_device = device;
    m_device_isSet = true;
}

bool OAIVirtualMachineWithConfigContext::is_device_Set() const{
    return m_device_isSet;
}

bool OAIVirtualMachineWithConfigContext::is_device_Valid() const{
...
QString OAIVirtualMachineWithConfigContext::getDisplay() const {
    return m_display;
}
void OAIVirtualMachineWithConfigContext::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAIVirtualMachineWithConfigContext::is_display_Set() const{
    return m_display_isSet;
}

bool OAIVirtualMachineWithConfigContext::is_display_Valid() const{
...
OAIObject OAIVirtualMachineWithConfigContext::getLocalContextData() const {
    return m_local_context_data;
}
void OAIVirtualMachineWithConfigContext::setLocalContextData(const OAIObject &local_context_data) {
...
OAINestedIPAddress OAIVirtualMachineWithConfigContext::getPrimaryIp() const {
    return m_primary_ip;
}
void OAIVirtualMachineWithConfigContext::setPrimaryIp(const OAINestedIPAddress &primary_ip) {
...
OAINestedIPAddress OAIVirtualMachineWithConfigContext::getPrimaryIp4() const {
    return m_primary_ip4;
}
void OAIVirtualMachineWithConfigContext::setPrimaryIp4(const OAINestedIPAddress &primary_ip4) {
...
OAINestedIPAddress OAIVirtualMachineWithConfigContext::getPrimaryIp6() const {
    return m_primary_ip6;
}
void OAIVirtualMachineWithConfigContext::setPrimaryIp6(const OAINestedIPAddress &primary_ip6) {
...
OAINestedSite OAIVirtualMachineWithConfigContext::getSite() const {
    return m_site;
}
void OAIVirtualMachineWithConfigContext::setSite(const OAINestedSite &site) {
    m_site = site;
    m_site_isSet = true;
}

bool OAIVirtualMachineWithConfigContext::is_site_Set() const{
    return m_site_isSet;
}

bool OAIVirtualMachineWithConfigContext::is_site_Valid() const{
    return m_site_isValid;
}

OAIStatus_8 OAIVirtualMachineWithConfigContext::getStatus() const {
    return m_status;
}
void OAIVirtualMachineWithConfigContext::setStatus(const OAIStatus_8 &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QList<OAINestedTag> OAIVirtualMachineWithConfigContext::getTags() const {
    return m_tags;
}
void OAIVirtualMachineWithConfigContext::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIVirtualMachineWithConfigContext::getUrl() const {
    return m_url;
}
void OAIVirtualMachineWithConfigContext::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIVirtualMachineWithConfigContext::is_url_Set() const{
    return m_url_isSet;
}

bool OAIVirtualMachineWithConfigContext::is_url_Valid() const{
    return m_url_isValid;
}

double OAIVirtualMachineWithConfigContext::getVcpus() const {
    return m_vcpus;
}
void OAIVirtualMachineWithConfigContext::setVcpus(const double &vcpus) {
    m_vcpus = vcpus;
    m_vcpus_isSet = true;
}
