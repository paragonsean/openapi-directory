...
QSet<OAINestedASN> OAISite::getAsns() const {
    return m_asns;
}
void OAISite::setAsns(const QSet<OAINestedASN> &asns) {
    m_asns = asns;
    m_asns_isSet = true;
}

bool OAISite::is_asns_Set() const{
    return m_asns_isSet;
}

bool OAISite::is_asns_Valid() const{
    return m_asns_isValid;
}

qint32 OAISite::getCircuitCount() const {
    return m_circuit_count;
}
void OAISite::setCircuitCount(const qint32 &circuit_count) {
    m_circuit_count = circuit_count;
    m_circuit_count_isSet = true;
}

bool OAISite::is_circuit_count_Set() const{
    return m_circuit_count_isSet;
}

bool OAISite::is_circuit_count_Valid() const{
    return m_circuit_count_isValid;
}

QString OAISite::getComments() const {
    return m_comments;
}
void OAISite::setComments(const QString &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAISite::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAISite::is_comments_Valid() const{
    return m_comments_isValid;
}

QDateTime OAISite::getCreated() const {
    return m_created;
}
void OAISite::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAISite::is_created_Set() const{
    return m_created_isSet;
}

bool OAISite::is_created_Valid() const{
    return m_created_isValid;
}

OAIObject OAISite::getCustomFields() const {
    return m_custom_fields;
}
void OAISite::setCustomFields(const OAIObject &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAISite::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAISite::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

QString OAISite::getDescription() const {
    return m_description;
}
void OAISite::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISite::is_description_Set() const{
    return m_description_isSet;
}

bool OAISite::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAISite::getDeviceCount() const {
    return m_device_count;
}
void OAISite::setDeviceCount(const qint32 &device_count) {
    m_device_count = device_count;
    m_device_count_isSet = true;
}

bool OAISite::is_device_count_Set() const{
    return m_device_count_isSet;
}

bool OAISite::is_device_count_Valid() const{
    return m_device_count_isValid;
}

QString OAISite::getDisplay() const {
    return m_display;
}
void OAISite::setDisplay(const QString &display) {
    m_display = display;
    m_display_isSet = true;
}

bool OAISite::is_display_Set() const{
    return m_display_isSet;
}

bool OAISite::is_display_Valid() const{
    return m_display_isValid;
}

QString OAISite::getFacility() const {
    return m_facility;
}
void OAISite::setFacility(const QString &facility) {
    m_facility = facility;
    m_facility_isSet = true;
}

bool OAISite::is_facility_Set() const{
    return m_facility_isSet;
}

bool OAISite::is_facility_Valid() const{
    return m_facility_isValid;
}

OAINestedSiteGroup OAISite::getGroup() const {
    return m_group;
}
void OAISite::setGroup(const OAINestedSiteGroup &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAISite::is_group_Set() const{
    return m_group_isSet;
}

bool OAISite::is_group_Valid() const{
    return m_group_isValid;
}

qint32 OAISite::getId() const {
    return m_id;
}
void OAISite::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QDateTime OAISite::getLastUpdated() const {
    return m_last_updated;
}
void OAISite::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAISite::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAISite::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

double OAISite::getLatitude() const {
    return m_latitude;
}
void OAISite::setLatitude(const double &latitude) {
    m_latitude = latitude;
    m_latitude_isSet = true;
}

bool OAISite::is_latitude_Set() const{
    return m_latitude_isSet;
}

bool OAISite::is_latitude_Valid() const{
    return m_latitude_isValid;
}

double OAISite::getLongitude() const {
    return m_longitude;
}
void OAISite::setLongitude(const double &longitude) {
    m_longitude = longitude;
    m_longitude_isSet = true;
}

bool OAISite::is_longitude_Set() const{
    return m_longitude_isSet;
}

bool OAISite::is_longitude_Valid() const{
...
QString OAISite::getPhysicalAddress() const {
    return m_physical_address;
}
void OAISite::setPhysicalAddress(const QString &physical_address) {
    m_physical_address = physical_address;
    m_physical_address_isSet = true;
}

bool OAISite::is_physical_address_Set() const{
    return m_physical_address_isSet;
}

bool OAISite::is_physical_address_Valid() const{
    return m_physical_address_isValid;
}

qint32 OAISite::getPrefixCount() const {
    return m_prefix_count;
}
void OAISite::setPrefixCount(const qint32 &prefix_count) {
    m_prefix_count = prefix_count;
    m_prefix_count_isSet = true;
}

bool OAISite::is_prefix_count_Set() const{
    return m_prefix_count_isSet;
}

bool OAISite::is_prefix_count_Valid() const{
    return m_prefix_count_isValid;
}

qint32 OAISite::getRackCount() const {
    return m_rack_count;
}
void OAISite::setRackCount(const qint32 &rack_count) {
    m_rack_count = rack_count;
    m_rack_count_isSet = true;
}

bool OAISite::is_rack_count_Set() const{
    return m_rack_count_isSet;
}

bool OAISite::is_rack_count_Valid() const{
    return m_rack_count_isValid;
}

OAINestedRegion OAISite::getRegion() const {
    return m_region;
}
void OAISite::setRegion(const OAINestedRegion &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAISite::is_region_Set() const{
    return m_region_isSet;
}

bool OAISite::is_region_Valid() const{
    return m_region_isValid;
}

QString OAISite::getShippingAddress() const {
    return m_shipping_address;
}
void OAISite::setShippingAddress(const QString &shipping_address) {
    m_shipping_address = shipping_address;
    m_shipping_address_isSet = true;
}

bool OAISite::is_shipping_address_Set() const{
    return m_shipping_address_isSet;
}

bool OAISite::is_shipping_address_Valid() const{
    return m_shipping_address_isValid;
}

QString OAISite::getSlug() const {
    return m_slug;
}
void OAISite::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAISite::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAISite::is_slug_Valid() const{
    return m_slug_isValid;
}

OAIStatus_7 OAISite::getStatus() const {
    return m_status;
}
void OAISite::setStatus(const OAIStatus_7 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISite::is_status_Set() const{
    return m_status_isSet;
}

bool OAISite::is_status_Valid() const{
    return m_status_isValid;
}

QList<OAINestedTag> OAISite::getTags() const {
    return m_tags;
}
void OAISite::setTags(const QList<OAINestedTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
OAINestedTenant OAISite::getTenant() const {
    return m_tenant;
}
void OAISite::setTenant(const OAINestedTenant &tenant) {
    m_tenant = tenant;
    m_tenant_isSet = true;
}

bool OAISite::is_tenant_Set() const{
    return m_tenant_isSet;
}

bool OAISite::is_tenant_Valid() const{
    return m_tenant_isValid;
}

QString OAISite::getTimeZone() const {
    return m_time_zone;
}
void OAISite::setTimeZone(const QString &time_zone) {
    m_time_zone = time_zone;
    m_time_zone_isSet = true;
}

bool OAISite::is_time_zone_Set() const{
    return m_time_zone_isSet;
}

bool OAISite::is_time_zone_Valid() const{
...
qint32 OAISite::getVirtualmachineCount() const {
    return m_virtualmachine_count;
}
void OAISite::setVirtualmachineCount(const qint32 &virtualmachine_count) {
    m_virtualmachine_count = virtualmachine_count;
    m_virtualmachine_count_isSet = true;
}

bool OAISite::is_virtualmachine_count_Set() const{
    return m_virtualmachine_count_isSet;
}

bool OAISite::is_virtualmachine_count_Valid() const{
    return m_virtualmachine_count_isValid;
}

qint32 OAISite::getVlanCount() const {
    return m_vlan_count;
}
void OAISite::setVlanCount(const qint32 &vlan_count) {
    m_vlan_count = vlan_count;
    m_vlan_count_isSet = true;
}

bool OAISite::is_vlan_count_Set() const{
    return m_vlan_count_isSet;
}

bool OAISite::is_vlan_count_Valid() const{
