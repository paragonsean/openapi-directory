...
#ifndef OAINestedPlatform_H
#define OAINestedPlatform_H
...
class OAINestedPlatform : public OAIObject {
public:
    OAINestedPlatform();
    OAINestedPlatform(QString json);
    ~OAINestedPlatform() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINestedPlatform)

#endif // OAINestedPlatform_H
