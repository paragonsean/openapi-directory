...
#ifndef OAIWirelessLink_H
#define OAIWirelessLink_H
...
class OAIWirelessLink : public OAIObject {
public:
    OAIWirelessLink();
    OAIWirelessLink(QString json);
    ~OAIWirelessLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWirelessLink)

#endif // OAIWirelessLink_H
