...
#ifndef OAISiteGroup_H
#define OAISiteGroup_H
...
class OAISiteGroup : public OAIObject {
public:
    OAISiteGroup();
    OAISiteGroup(QString json);
    ~OAISiteGroup() override;
    ...
    OAINestedSiteGroup getParent() const;
    void setParent(const OAINestedSiteGroup &parent);
...
Q_DECLARE_METATYPE(OpenAPI::OAISiteGroup)

#endif // OAISiteGroup_H
