...
namespace OpenAPI {
class OAIFilter_logic;
class OAIType_1;
class OAIUi_visibility;
...
public:
    ...
    OAIFilter_logic getFilterLogic() const;
    void setFilterLogic(const OAIFilter_logic &filter_logic);
    ...
    OAIUi_visibility getUiVisibility() const;
    void setUiVisibility(const OAIUi_visibility &ui_visibility);
...
private:
    ...
    OAIFilter_logic m_filter_logic;
    ...
    OAIUi_visibility m_ui_visibility;
