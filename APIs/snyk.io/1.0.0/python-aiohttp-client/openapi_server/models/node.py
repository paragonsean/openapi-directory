...
class Node(Model):
    ...
    def __init__(self, deps: List[object]=None, node_id: str=None, pkg_id: str=None):
        ...
        :param deps: The deps of this Node.
        :param node_id: The node_id of this Node.
        :param pkg_id: The pkg_id of this Node.
        """
        self.openapi_types = {
            'deps': List[object],
            'node_id': str,
    ...
    @property
    def deps(self):
        """Gets the deps of this Node.

        An array of package ids this package depends on.

        :return: The deps of this Node.
        :rtype: List[object]
        """
        return self._deps
