...
class Project(Model):
    ...
    def __init__(self, attributes: ProjectAttributes=None, branch: str=None, browse_url: str=None, created: str=None, hostname: str=None, id: str=None, image_base_image: str=None, image_cluster: str=None, image_id: str=None, image_platform: str=None, image_tag: str=None, importing_user: RetrieveASingleProject200ResponseImportingUser=None, is_monitored: bool=None, issue_counts_by_severity: RetrieveASingleProject200ResponseIssueCountsBySeverity=None, last_tested_date: str=None, name: str=None, origin: str=None, owner: object=None, read_only: bool=None, remediation: RetrieveASingleProject200ResponseRemediation=None, remote_repo_url: str=None, tags: List[object]=None, target_reference: str=None, test_frequency: str=None, total_dependencies: float=None, type: str=None):
        ...
        :param attributes: The attributes of this Project.
        :param branch: The branch of this Project.
        :param browse_url: The browse_url of this Project.
        :param created: The created of this Project.
        :param hostname: The hostname of this Project.
        :param id: The id of this Project.
        :param image_base_image: The image_base_image of this Project.
        :param image_cluster: The image_cluster of this Project.
        :param image_id: The image_id of this Project.
        :param image_platform: The image_platform of this Project.
        :param image_tag: The image_tag of this Project.
        :param importing_user: The importing_user of this Project.
        :param is_monitored: The is_monitored of this Project.
        :param issue_counts_by_severity: The issue_counts_by_severity of this Project.
        :param last_tested_date: The last_tested_date of this Project.
        :param name: The name of this Project.
        :param origin: The origin of this Project.
        :param owner: The owner of this Project.
        :param read_only: The read_only of this Project.
        :param remediation: The remediation of this Project.
        :param remote_repo_url: The remote_repo_url of this Project.
        :param tags: The tags of this Project.
        :param target_reference: The target_reference of this Project.
        :param test_frequency: The test_frequency of this Project.
        :param total_dependencies: The total_dependencies of this Project.
    ...
    @property
    def attributes(self):
        """Gets the attributes of this Project.


        :return: The attributes of this Project.
    ...
    def attributes(self, attributes):
        """Sets the attributes of this Project.
    ...
    @property
    def branch(self):
        """Gets the branch of this Project.

        The monitored branch (if available)

        :return: The branch of this Project.
        :rtype: str
        """
        return self._branch
    ...
    def branch(self, branch):
        """Sets the branch of this Project.
    ...
    @property
    def browse_url(self):
        """Gets the browse_url of this Project.

        URL with project overview

        :return: The browse_url of this Project.
        :rtype: str
        """
    ...
    def browse_url(self, browse_url):
        """Sets the browse_url of this Project.
    ...
    @property
    def hostname(self):
        """Gets the hostname of this Project.

        The hostname for a CLI project, null if not set

        :return: The hostname of this Project.
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this Project.
    ...
    def image_base_image(self):
        """Gets the image_base_image of this Project.

        For docker projects shows the base image

        :return: The image_base_image of this Project.
        :rtype: str
        """
    ...
    def image_base_image(self, image_base_image):
        """Sets the image_base_image of this Project.
    ...
    def image_cluster(self):
        """Gets the image_cluster of this Project.

        For Kubernetes projects shows the origin cluster name

        :return: The image_cluster of this Project.
        :rtype: str
        """
    ...
    def image_cluster(self, image_cluster):
        """Sets the image_cluster of this Project.
    ...
    @property
    def image_id(self):
        """Gets the image_id of this Project.

        For docker projects shows the ID of the image

        :return: The image_id of this Project.
        :rtype: str
        """
    ...
    def image_id(self, image_id):
        """Sets the image_id of this Project.
    ...
    def image_platform(self):
        """Gets the image_platform of this Project.

        For docker projects shows the platform of the image

        :return: The image_platform of this Project.
        :rtype: str
        """
    ...
    def image_platform(self, image_platform):
        """Sets the image_platform of this Project.
    ...
    @property
    def image_tag(self):
        """Gets the image_tag of this Project.

        For docker projects shows the tag of the image

        :return: The image_tag of this Project.
        :rtype: str
        """
    ...
    def image_tag(self, image_tag):
        """Sets the image_tag of this Project.
    ...
    def importing_user(self):
        """Gets the importing_user of this Project.


        :return: The importing_user of this Project.
    ...
    def importing_user(self, importing_user):
        """Sets the importing_user of this Project.
    ...
    def is_monitored(self):
        """Gets the is_monitored of this Project.

        Describes if a project is currently monitored or it is de-activated

        :return: The is_monitored of this Project.
        :rtype: bool
        """
    ...
    def is_monitored(self, is_monitored):
        """Sets the is_monitored of this Project.
    ...
    def issue_counts_by_severity(self):
        """Gets the issue_counts_by_severity of this Project.


        :return: The issue_counts_by_severity of this Project.
    ...
    def issue_counts_by_severity(self, issue_counts_by_severity):
        """Sets the issue_counts_by_severity of this Project.
    ...
    def last_tested_date(self):
        """Gets the last_tested_date of this Project.

        The date on which the most recent test was conducted for this project

        :return: The last_tested_date of this Project.
        :rtype: str
        """
    ...
    def last_tested_date(self, last_tested_date):
        """Sets the last_tested_date of this Project.
    ...
    @property
    def origin(self):
        """Gets the origin of this Project.

        The origin the project was added from

        :return: The origin of this Project.
        :rtype: str
        """
        return self._origin
    ...
    @property
    def read_only(self):
        """Gets the read_only of this Project.

        Whether the project is read-only

        :return: The read_only of this Project.
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        """Sets the read_only of this Project.
    ...
    def remediation(self):
        """Gets the remediation of this Project.


        :return: The remediation of this Project.
    ...
    def remediation(self, remediation):
        """Sets the remediation of this Project.
    ...
    def remote_repo_url(self, remote_repo_url):
        """Sets the remote_repo_url of this Project.
    ...
    def target_reference(self):
        """Gets the target_reference of this Project.
        ...
        :return: The target_reference of this Project.
        :rtype: str
        """
    ...
    def target_reference(self, target_reference):
        """Sets the target_reference of this Project.
    ...
    def test_frequency(self):
        """Gets the test_frequency of this Project.

        The frequency of automated Snyk re-test. Can be 'daily', 'weekly or 'never'

        :return: The test_frequency of this Project.
        :rtype: str
        """
    ...
    def test_frequency(self, test_frequency):
        """Sets the test_frequency of this Project.
    ...
    def total_dependencies(self):
        """Gets the total_dependencies of this Project.

        Number of dependencies of the project

        :return: The total_dependencies of this Project.
        :rtype: float
        """
    ...
    def total_dependencies(self, total_dependencies):
        """Sets the total_dependencies of this Project.
