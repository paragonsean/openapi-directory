...
class AddIgnoreRequest(Model):
    ...
    def __init__(self, disregard_if_fixable: bool=None, expires: str=None, ignore_path: str=None, reason: str=None, reason_type: str=None):
        """AddIgnoreRequest - a model defined in OpenAPI

        :param disregard_if_fixable: The disregard_if_fixable of this AddIgnoreRequest.
        :param expires: The expires of this AddIgnoreRequest.
        :param ignore_path: The ignore_path of this AddIgnoreRequest.
        :param reason: The reason of this AddIgnoreRequest.
        :param reason_type: The reason_type of this AddIgnoreRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddIgnoreRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Add_ignore_request of this AddIgnoreRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def disregard_if_fixable(self):
        """Gets the disregard_if_fixable of this AddIgnoreRequest.

        Only ignore the issue if no upgrade or patch is available.

        :return: The disregard_if_fixable of this AddIgnoreRequest.
        :rtype: bool
        """
    ...
    def disregard_if_fixable(self, disregard_if_fixable):
        """Sets the disregard_if_fixable of this AddIgnoreRequest.
    ...
    @property
    def expires(self):
        """Gets the expires of this AddIgnoreRequest.

        The timestamp that the issue will no longer be ignored.

        :return: The expires of this AddIgnoreRequest.
        :rtype: str
        """
    ...
    def expires(self, expires):
        """Sets the expires of this AddIgnoreRequest.
    ...
    def ignore_path(self):
        """Gets the ignore_path of this AddIgnoreRequest.

        The path to ignore (default is `*` which represents all paths).

        :return: The ignore_path of this AddIgnoreRequest.
        :rtype: str
        """
    ...
    def ignore_path(self, ignore_path):
        """Sets the ignore_path of this AddIgnoreRequest.
    ...
    @property
    def reason(self):
        """Gets the reason of this AddIgnoreRequest.

        The reason that the issue was ignored.

        :return: The reason of this AddIgnoreRequest.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        """Sets the reason of this AddIgnoreRequest.
    ...
    def reason_type(self):
        """Gets the reason_type of this AddIgnoreRequest.

        The classification of the ignore.

        :return: The reason_type of this AddIgnoreRequest.
        :rtype: str
        """
    ...
    def reason_type(self, reason_type):
        """Sets the reason_type of this AddIgnoreRequest.
