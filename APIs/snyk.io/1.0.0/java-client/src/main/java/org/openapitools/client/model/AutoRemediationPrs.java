...
public class AutoRemediationPrs {
  ...
  public AutoRemediationPrs() {
  }

  public AutoRemediationPrs backlogPrsEnabled(Boolean backlogPrsEnabled) {
  ...
  public AutoRemediationPrs freshPrsEnabled(Boolean freshPrsEnabled) {
  ...
  public AutoRemediationPrs usePatchRemediation(Boolean usePatchRemediation) {
  ...
  public boolean equals(Object o) {
    ...
    AutoRemediationPrs autoRemediationPrs = (AutoRemediationPrs) o;
    return Objects.equals(this.backlogPrsEnabled, autoRemediationPrs.backlogPrsEnabled) &&
        Objects.equals(this.freshPrsEnabled, autoRemediationPrs.freshPrsEnabled) &&
        Objects.equals(this.usePatchRemediation, autoRemediationPrs.usePatchRemediation);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoRemediationPrs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoRemediationPrs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoRemediationPrs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoRemediationPrs is not found in the empty JSON string", AutoRemediationPrs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoRemediationPrs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoRemediationPrs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoRemediationPrs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoRemediationPrs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoRemediationPrs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoRemediationPrs.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoRemediationPrs>() {
           @Override
           public void write(JsonWriter out, AutoRemediationPrs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoRemediationPrs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoRemediationPrs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoRemediationPrs
   * @throws IOException if the JSON string is invalid with respect to AutoRemediationPrs
   */
  public static AutoRemediationPrs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoRemediationPrs.class);
  }

  /**
   * Convert an instance of AutoRemediationPrs to an JSON string
   *
   * @return JSON string
   */
