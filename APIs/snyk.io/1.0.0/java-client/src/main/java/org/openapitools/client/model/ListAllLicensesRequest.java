...
import org.openapitools.client.model.ListAllLicensesRequestFilters;
...
public class ListAllLicensesRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private ListAllLicensesRequestFilters filters;

  public ListAllLicensesRequest() {
  }

  public ListAllLicensesRequest filters(ListAllLicensesRequestFilters filters) {
  ...
  public ListAllLicensesRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(ListAllLicensesRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllLicensesRequest listAllLicensesRequest = (ListAllLicensesRequest) o;
    return Objects.equals(this.filters, listAllLicensesRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllLicensesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllLicensesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllLicensesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllLicensesRequest is not found in the empty JSON string", ListAllLicensesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllLicensesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllLicensesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ListAllLicensesRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllLicensesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllLicensesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllLicensesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllLicensesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllLicensesRequest>() {
           @Override
           public void write(JsonWriter out, ListAllLicensesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllLicensesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllLicensesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllLicensesRequest
   * @throws IOException if the JSON string is invalid with respect to ListAllLicensesRequest
   */
  public static ListAllLicensesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllLicensesRequest.class);
  }

  /**
   * Convert an instance of ListAllLicensesRequest to an JSON string
   *
   * @return JSON string
   */
