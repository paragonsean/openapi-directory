...
public class GradleFile {
  ...
  public GradleFile contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    GradleFile gradleFile = (GradleFile) o;
    return Objects.equals(this.contents, gradleFile.contents);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GradleFile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GradleFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GradleFile is not found in the empty JSON string", GradleFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GradleFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GradleFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GradleFile.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GradleFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GradleFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GradleFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GradleFile.class));

       return (TypeAdapter<T>) new TypeAdapter<GradleFile>() {
           @Override
           public void write(JsonWriter out, GradleFile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GradleFile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GradleFile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GradleFile
   * @throws IOException if the JSON string is invalid with respect to GradleFile
   */
  public static GradleFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GradleFile.class);
  }

  /**
   * Convert an instance of GradleFile to an JSON string
   *
   * @return JSON string
   */
