...
public class MonitorPackageInfo {
  ...
  public MonitorPackageInfo() {
  }

  public MonitorPackageInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MonitorPackageInfo version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorPackageInfo monitorPackageInfo = (MonitorPackageInfo) o;
    return Objects.equals(this.name, monitorPackageInfo.name) &&
        Objects.equals(this.version, monitorPackageInfo.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorPackageInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorPackageInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorPackageInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorPackageInfo is not found in the empty JSON string", MonitorPackageInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorPackageInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorPackageInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorPackageInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorPackageInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorPackageInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorPackageInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorPackageInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorPackageInfo>() {
           @Override
           public void write(JsonWriter out, MonitorPackageInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorPackageInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorPackageInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorPackageInfo
   * @throws IOException if the JSON string is invalid with respect to MonitorPackageInfo
   */
  public static MonitorPackageInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorPackageInfo.class);
  }

  /**
   * Convert an instance of MonitorPackageInfo to an JSON string
   *
   * @return JSON string
   */
