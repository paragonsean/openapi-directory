...
public class ListAllProjectsRequestFiltersTags {
  public static final String SERIALIZED_NAME_INCLUDES = "includes";
  @SerializedName(SERIALIZED_NAME_INCLUDES)
  private List<Object> includes = new ArrayList<>();

  public ListAllProjectsRequestFiltersTags() {
  }

  public ListAllProjectsRequestFiltersTags includes(List<Object> includes) {
    this.includes = includes;
    return this;
  }

  public ListAllProjectsRequestFiltersTags addIncludesItem(Object includesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectsRequestFiltersTags listAllProjectsRequestFiltersTags = (ListAllProjectsRequestFiltersTags) o;
    return Objects.equals(this.includes, listAllProjectsRequestFiltersTags.includes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjectsRequestFiltersTags {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectsRequestFiltersTags
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectsRequestFiltersTags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectsRequestFiltersTags is not found in the empty JSON string", ListAllProjectsRequestFiltersTags.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectsRequestFiltersTags.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectsRequestFiltersTags` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectsRequestFiltersTags.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectsRequestFiltersTags' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectsRequestFiltersTags> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectsRequestFiltersTags.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectsRequestFiltersTags>() {
           @Override
           public void write(JsonWriter out, ListAllProjectsRequestFiltersTags value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectsRequestFiltersTags read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectsRequestFiltersTags given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectsRequestFiltersTags
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectsRequestFiltersTags
   */
  public static ListAllProjectsRequestFiltersTags fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectsRequestFiltersTags.class);
  }

  /**
   * Convert an instance of ListAllProjectsRequestFiltersTags to an JSON string
   *
   * @return JSON string
   */
