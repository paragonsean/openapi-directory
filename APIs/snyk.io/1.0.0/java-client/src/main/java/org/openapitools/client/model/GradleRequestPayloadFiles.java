...
import org.openapitools.client.model.GradleFile;
...
public class GradleRequestPayloadFiles {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private GradleFile target;

  public GradleRequestPayloadFiles() {
  }

  public GradleRequestPayloadFiles target(GradleFile target) {
    this.target = target;
    return this;
  }
  ...
  public GradleFile getTarget() {
    return target;
  }

  public void setTarget(GradleFile target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    GradleRequestPayloadFiles gradleRequestPayloadFiles = (GradleRequestPayloadFiles) o;
    return Objects.equals(this.target, gradleRequestPayloadFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class GradleRequestPayloadFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GradleRequestPayloadFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GradleRequestPayloadFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GradleRequestPayloadFiles is not found in the empty JSON string", GradleRequestPayloadFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GradleRequestPayloadFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GradleRequestPayloadFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GradleRequestPayloadFiles.openapiRequiredFields) {
      ...
      GradleFile.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GradleRequestPayloadFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GradleRequestPayloadFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GradleRequestPayloadFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GradleRequestPayloadFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<GradleRequestPayloadFiles>() {
           @Override
           public void write(JsonWriter out, GradleRequestPayloadFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GradleRequestPayloadFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GradleRequestPayloadFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GradleRequestPayloadFiles
   * @throws IOException if the JSON string is invalid with respect to GradleRequestPayloadFiles
   */
  public static GradleRequestPayloadFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GradleRequestPayloadFiles.class);
  }

  /**
   * Convert an instance of GradleRequestPayloadFiles to an JSON string
   *
   * @return JSON string
   */
