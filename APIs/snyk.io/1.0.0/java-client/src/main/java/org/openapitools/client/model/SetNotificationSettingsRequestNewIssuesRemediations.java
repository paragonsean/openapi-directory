...
public class SetNotificationSettingsRequestNewIssuesRemediations {
  ...
  public static final String SERIALIZED_NAME_ISSUE_SEVERITY = "issueSeverity";
  ...
  public SetNotificationSettingsRequestNewIssuesRemediations() {
  }

  public SetNotificationSettingsRequestNewIssuesRemediations enabled(Boolean enabled) {
  ...
  public SetNotificationSettingsRequestNewIssuesRemediations issueSeverity(IssueSeverityEnum issueSeverity) {
  ...
  public SetNotificationSettingsRequestNewIssuesRemediations issueType(IssueTypeEnum issueType) {
  ...
  public boolean equals(Object o) {
    ...
    SetNotificationSettingsRequestNewIssuesRemediations setNotificationSettingsRequestNewIssuesRemediations = (SetNotificationSettingsRequestNewIssuesRemediations) o;
    return Objects.equals(this.enabled, setNotificationSettingsRequestNewIssuesRemediations.enabled) &&
        Objects.equals(this.issueSeverity, setNotificationSettingsRequestNewIssuesRemediations.issueSeverity) &&
        Objects.equals(this.issueType, setNotificationSettingsRequestNewIssuesRemediations.issueType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, issueSeverity, issueType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetNotificationSettingsRequestNewIssuesRemediations {\n");
  ...
  static {
    ...
    openapiFields.add("issueSeverity");
    openapiFields.add("issueType");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("enabled");
    openapiRequiredFields.add("issueSeverity");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetNotificationSettingsRequestNewIssuesRemediations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetNotificationSettingsRequestNewIssuesRemediations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetNotificationSettingsRequestNewIssuesRemediations is not found in the empty JSON string", SetNotificationSettingsRequestNewIssuesRemediations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetNotificationSettingsRequestNewIssuesRemediations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetNotificationSettingsRequestNewIssuesRemediations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetNotificationSettingsRequestNewIssuesRemediations.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("issueSeverity").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `issueSeverity` to be a primitive type in the JSON string but got `%s`", jsonObj.get("issueSeverity").toString()));
      }
      // validate the required field `issueSeverity`
      IssueSeverityEnum.validateJsonElement(jsonObj.get("issueSeverity"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetNotificationSettingsRequestNewIssuesRemediations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetNotificationSettingsRequestNewIssuesRemediations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetNotificationSettingsRequestNewIssuesRemediations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetNotificationSettingsRequestNewIssuesRemediations.class));

       return (TypeAdapter<T>) new TypeAdapter<SetNotificationSettingsRequestNewIssuesRemediations>() {
           @Override
           public void write(JsonWriter out, SetNotificationSettingsRequestNewIssuesRemediations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetNotificationSettingsRequestNewIssuesRemediations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetNotificationSettingsRequestNewIssuesRemediations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetNotificationSettingsRequestNewIssuesRemediations
   * @throws IOException if the JSON string is invalid with respect to SetNotificationSettingsRequestNewIssuesRemediations
   */
  public static SetNotificationSettingsRequestNewIssuesRemediations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetNotificationSettingsRequestNewIssuesRemediations.class);
  }

  /**
   * Convert an instance of SetNotificationSettingsRequestNewIssuesRemediations to an JSON string
   *
   * @return JSON string
   */
