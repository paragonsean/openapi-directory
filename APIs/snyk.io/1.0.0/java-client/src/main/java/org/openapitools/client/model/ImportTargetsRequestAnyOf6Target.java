...
public class ImportTargetsRequestAnyOf6Target {
  public static final String SERIALIZED_NAME_APP_ID = "appId";
  @SerializedName(SERIALIZED_NAME_APP_ID)
  private String appId;

  public ImportTargetsRequestAnyOf6Target() {
  }

  public ImportTargetsRequestAnyOf6Target appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf6Target importTargetsRequestAnyOf6Target = (ImportTargetsRequestAnyOf6Target) o;
    return Objects.equals(this.appId, importTargetsRequestAnyOf6Target.appId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf6Target {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf6Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf6Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf6Target is not found in the empty JSON string", ImportTargetsRequestAnyOf6Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf6Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf6Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf6Target.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf6Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf6Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf6Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf6Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf6Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf6Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf6Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf6Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf6Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf6Target
   */
  public static ImportTargetsRequestAnyOf6Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf6Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf6Target to an JSON string
   *
   * @return JSON string
   */
