...
public class ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner {
  ...
  public ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner() {
  }

  public ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner fixVersion(String fixVersion) {
  ...
  public ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner listAllProjectSnapshotIssuePaths200ResponsePathsInnerInner = (ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner) o;
    return Objects.equals(this.fixVersion, listAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.fixVersion) &&
        Objects.equals(this.name, listAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.name) &&
        Objects.equals(this.version, listAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fixVersion, name, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner is not found in the empty JSON string", ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner>() {
           @Override
           public void write(JsonWriter out, ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner
   */
  public static ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner.class);
  }

  /**
   * Convert an instance of ListAllProjectSnapshotIssuePaths200ResponsePathsInnerInner to an JSON string
   *
   * @return JSON string
   */
