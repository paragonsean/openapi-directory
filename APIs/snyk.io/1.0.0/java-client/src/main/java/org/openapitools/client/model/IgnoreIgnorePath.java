...
import org.openapitools.client.model.IgnoreIgnorePathIgnoredBy;
...
public class IgnoreIgnorePath {
  ...
  public static final String SERIALIZED_NAME_IGNORED_BY = "ignoredBy";
  @SerializedName(SERIALIZED_NAME_IGNORED_BY)
  private IgnoreIgnorePathIgnoredBy ignoredBy;
  ...
  public IgnoreIgnorePath() {
  }

  public IgnoreIgnorePath created(String created) {
  ...
  public IgnoreIgnorePath disregardIfFixable(Boolean disregardIfFixable) {
  ...
  public IgnoreIgnorePath expires(String expires) {
  ...
  public IgnoreIgnorePath ignoredBy(IgnoreIgnorePathIgnoredBy ignoredBy) {
   ...
   */
  @javax.annotation.Nullable
  public IgnoreIgnorePathIgnoredBy getIgnoredBy() {
    return ignoredBy;
  }

  public void setIgnoredBy(IgnoreIgnorePathIgnoredBy ignoredBy) {
    this.ignoredBy = ignoredBy;
  }


  public IgnoreIgnorePath reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public IgnoreIgnorePath reasonType(ReasonTypeEnum reasonType) {
  ...
  public boolean equals(Object o) {
    ...
    IgnoreIgnorePath ignoreIgnorePath = (IgnoreIgnorePath) o;
    return Objects.equals(this.created, ignoreIgnorePath.created) &&
        Objects.equals(this.disregardIfFixable, ignoreIgnorePath.disregardIfFixable) &&
        Objects.equals(this.expires, ignoreIgnorePath.expires) &&
        Objects.equals(this.ignoredBy, ignoreIgnorePath.ignoredBy) &&
        Objects.equals(this.reason, ignoreIgnorePath.reason) &&
        Objects.equals(this.reasonType, ignoreIgnorePath.reasonType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, disregardIfFixable, expires, ignoredBy, reason, reasonType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IgnoreIgnorePath {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IgnoreIgnorePath
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IgnoreIgnorePath.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IgnoreIgnorePath is not found in the empty JSON string", IgnoreIgnorePath.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IgnoreIgnorePath.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IgnoreIgnorePath` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `ignoredBy`
      if (jsonObj.get("ignoredBy") != null && !jsonObj.get("ignoredBy").isJsonNull()) {
        IgnoreIgnorePathIgnoredBy.validateJsonElement(jsonObj.get("ignoredBy"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IgnoreIgnorePath.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IgnoreIgnorePath' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IgnoreIgnorePath> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IgnoreIgnorePath.class));

       return (TypeAdapter<T>) new TypeAdapter<IgnoreIgnorePath>() {
           @Override
           public void write(JsonWriter out, IgnoreIgnorePath value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IgnoreIgnorePath read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IgnoreIgnorePath given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IgnoreIgnorePath
   * @throws IOException if the JSON string is invalid with respect to IgnoreIgnorePath
   */
  public static IgnoreIgnorePath fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IgnoreIgnorePath.class);
  }

  /**
   * Convert an instance of IgnoreIgnorePath to an JSON string
   *
   * @return JSON string
   */
