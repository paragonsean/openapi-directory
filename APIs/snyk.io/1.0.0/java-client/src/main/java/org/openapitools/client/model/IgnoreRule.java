...
public class IgnoreRule {
  public static final String SERIALIZED_NAME_DISREGARD_IF_FIXABLE = "disregardIfFixable";
  @SerializedName(SERIALIZED_NAME_DISREGARD_IF_FIXABLE)
  private Boolean disregardIfFixable;

  public static final String SERIALIZED_NAME_EXPIRES = "expires";
  @SerializedName(SERIALIZED_NAME_EXPIRES)
  private String expires;

  public static final String SERIALIZED_NAME_IGNORE_PATH = "ignorePath";
   ...
   */
  @JsonAdapter(ReasonTypeEnum.Adapter.class)
  public enum ReasonTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<ReasonTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ReasonTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ReasonTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ReasonTypeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ReasonTypeEnum.fromValue(value);
    }
  }
  ...
  public IgnoreRule disregardIfFixable(Boolean disregardIfFixable) {
    this.disregardIfFixable = disregardIfFixable;
    return this;
  }

  /**
   * Only ignore the issue if no upgrade or patch is available.
   * @return disregardIfFixable
   */
  @javax.annotation.Nonnull
  public Boolean getDisregardIfFixable() {
    return disregardIfFixable;
  }

  public void setDisregardIfFixable(Boolean disregardIfFixable) {
    this.disregardIfFixable = disregardIfFixable;
  }


  public IgnoreRule expires(String expires) {
  ...
  public IgnoreRule ignorePath(String ignorePath) {
  ...
  public IgnoreRule reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public IgnoreRule reasonType(ReasonTypeEnum reasonType) {
  ...
  public boolean equals(Object o) {
    ...
    IgnoreRule ignoreRule = (IgnoreRule) o;
    return Objects.equals(this.disregardIfFixable, ignoreRule.disregardIfFixable) &&
        Objects.equals(this.expires, ignoreRule.expires) &&
        Objects.equals(this.ignorePath, ignoreRule.ignorePath) &&
        Objects.equals(this.reason, ignoreRule.reason) &&
        Objects.equals(this.reasonType, ignoreRule.reasonType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disregardIfFixable, expires, ignorePath, reason, reasonType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IgnoreRule {\n");
    sb.append("    disregardIfFixable: ").append(toIndentedString(disregardIfFixable)).append("\n");
  ...
  static {
    ...
    openapiFields.add("disregardIfFixable");
    openapiFields.add("expires");
    openapiFields.add("ignorePath");
    openapiFields.add("reason");
    openapiFields.add("reasonType");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("disregardIfFixable");
    openapiRequiredFields.add("reasonType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IgnoreRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IgnoreRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IgnoreRule is not found in the empty JSON string", IgnoreRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IgnoreRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IgnoreRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IgnoreRule.openapiRequiredFields) {
      ...
      if ((jsonObj.get("ignorePath") != null && !jsonObj.get("ignorePath").isJsonNull()) && !jsonObj.get("ignorePath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ignorePath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ignorePath").toString()));
      }
      if ((jsonObj.get("reason") != null && !jsonObj.get("reason").isJsonNull()) && !jsonObj.get("reason").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reason` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reason").toString()));
      }
      if (!jsonObj.get("reasonType").isJsonPrimitive()) {
      ...
      // validate the required field `reasonType`
      ReasonTypeEnum.validateJsonElement(jsonObj.get("reasonType"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IgnoreRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IgnoreRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IgnoreRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IgnoreRule.class));

       return (TypeAdapter<T>) new TypeAdapter<IgnoreRule>() {
           @Override
           public void write(JsonWriter out, IgnoreRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IgnoreRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IgnoreRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IgnoreRule
   * @throws IOException if the JSON string is invalid with respect to IgnoreRule
   */
  public static IgnoreRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IgnoreRule.class);
  }

  /**
   * Convert an instance of IgnoreRule to an JSON string
   *
   * @return JSON string
   */
