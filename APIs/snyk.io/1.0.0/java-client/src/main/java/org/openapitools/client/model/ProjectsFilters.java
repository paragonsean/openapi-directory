...
import org.openapitools.client.model.ProjectsFiltersFilters;
...
public class ProjectsFilters {
  ...
  private ProjectsFiltersFilters filters;

  public ProjectsFilters() {
  }

  public ProjectsFilters filters(ProjectsFiltersFilters filters) {
  ...
  public ProjectsFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(ProjectsFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectsFilters projectsFilters = (ProjectsFilters) o;
    return Objects.equals(this.filters, projectsFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectsFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectsFilters is not found in the empty JSON string", ProjectsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ProjectsFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectsFilters>() {
           @Override
           public void write(JsonWriter out, ProjectsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectsFilters
   * @throws IOException if the JSON string is invalid with respect to ProjectsFilters
   */
  public static ProjectsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectsFilters.class);
  }

  /**
   * Convert an instance of ProjectsFilters to an JSON string
   *
   * @return JSON string
   */
