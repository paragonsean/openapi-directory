...
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner;
...
public class GetProjectDependencyGraph200ResponseDepGraphPkgManager {
  ...
  private List<GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner> repositories = new ArrayList<>();

  public static final String SERIALIZED_NAME_VERSION = "version";
  @SerializedName(SERIALIZED_NAME_VERSION)
  private String version;

  public GetProjectDependencyGraph200ResponseDepGraphPkgManager() {
  }

  public GetProjectDependencyGraph200ResponseDepGraphPkgManager name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetProjectDependencyGraph200ResponseDepGraphPkgManager repositories(List<GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner> repositories) {
    this.repositories = repositories;
    return this;
  }

  public GetProjectDependencyGraph200ResponseDepGraphPkgManager addRepositoriesItem(GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner repositoriesItem) {
  ...
  public List<GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner> getRepositories() {
    return repositories;
  }

  public void setRepositories(List<GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner> repositories) {
    this.repositories = repositories;
  }


  public GetProjectDependencyGraph200ResponseDepGraphPkgManager version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraphPkgManager getProjectDependencyGraph200ResponseDepGraphPkgManager = (GetProjectDependencyGraph200ResponseDepGraphPkgManager) o;
    return Objects.equals(this.name, getProjectDependencyGraph200ResponseDepGraphPkgManager.name) &&
        Objects.equals(this.repositories, getProjectDependencyGraph200ResponseDepGraphPkgManager.repositories) &&
        Objects.equals(this.version, getProjectDependencyGraph200ResponseDepGraphPkgManager.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, repositories, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProjectDependencyGraph200ResponseDepGraphPkgManager {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgManager
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgManager.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraphPkgManager is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraphPkgManager.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgManager.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraphPkgManager` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraphPkgManager.openapiRequiredFields) {
      ...
      if (jsonObj.get("repositories") != null && !jsonObj.get("repositories").isJsonNull()) {
        ...
        if (jsonArrayrepositories != null) {
          ...
          for (int i = 0; i < jsonArrayrepositories.size(); i++) {
            GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.validateJsonElement(jsonArrayrepositories.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraphPkgManager.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraphPkgManager' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgManager> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraphPkgManager.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgManager>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraphPkgManager value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraphPkgManager read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraphPkgManager given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraphPkgManager
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgManager
   */
  public static GetProjectDependencyGraph200ResponseDepGraphPkgManager fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraphPkgManager.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraphPkgManager to an JSON string
   *
   * @return JSON string
   */
