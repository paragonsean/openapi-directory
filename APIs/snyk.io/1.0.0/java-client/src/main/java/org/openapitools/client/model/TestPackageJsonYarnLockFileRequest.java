...
import org.openapitools.client.model.TestPackageJsonPackageLockJsonFileRequestFiles;
...
public class TestPackageJsonYarnLockFileRequest {
  /**
  ...
  private EncodingEnum encoding = EncodingEnum.PLAIN;

  public static final String SERIALIZED_NAME_FILES = "files";
  @SerializedName(SERIALIZED_NAME_FILES)
  private TestPackageJsonPackageLockJsonFileRequestFiles files;

  public TestPackageJsonYarnLockFileRequest() {
  }

  public TestPackageJsonYarnLockFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestPackageJsonYarnLockFileRequest files(TestPackageJsonPackageLockJsonFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestPackageJsonPackageLockJsonFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestPackageJsonPackageLockJsonFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestPackageJsonYarnLockFileRequest testPackageJsonYarnLockFileRequest = (TestPackageJsonYarnLockFileRequest) o;
    return Objects.equals(this.encoding, testPackageJsonYarnLockFileRequest.encoding) &&
        Objects.equals(this.files, testPackageJsonYarnLockFileRequest.files);
  }

  @Override
  public int hashCode() {
    return Objects.hash(encoding, files);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestPackageJsonYarnLockFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestPackageJsonYarnLockFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestPackageJsonYarnLockFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestPackageJsonYarnLockFileRequest is not found in the empty JSON string", TestPackageJsonYarnLockFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestPackageJsonYarnLockFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestPackageJsonYarnLockFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestPackageJsonYarnLockFileRequest.openapiRequiredFields) {
      ...
      TestPackageJsonPackageLockJsonFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestPackageJsonYarnLockFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestPackageJsonYarnLockFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestPackageJsonYarnLockFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestPackageJsonYarnLockFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestPackageJsonYarnLockFileRequest>() {
           @Override
           public void write(JsonWriter out, TestPackageJsonYarnLockFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestPackageJsonYarnLockFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestPackageJsonYarnLockFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestPackageJsonYarnLockFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestPackageJsonYarnLockFileRequest
   */
  public static TestPackageJsonYarnLockFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestPackageJsonYarnLockFileRequest.class);
  }

  /**
   * Convert an instance of TestPackageJsonYarnLockFileRequest to an JSON string
   *
   * @return JSON string
   */
