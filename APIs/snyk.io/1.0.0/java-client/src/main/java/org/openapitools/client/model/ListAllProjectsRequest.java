...
import org.openapitools.client.model.ListAllProjectsRequestFilters;
...
public class ListAllProjectsRequest {
  ...
  private ListAllProjectsRequestFilters filters;

  public ListAllProjectsRequest() {
  }

  public ListAllProjectsRequest filters(ListAllProjectsRequestFilters filters) {
  ...
  public ListAllProjectsRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(ListAllProjectsRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectsRequest listAllProjectsRequest = (ListAllProjectsRequest) o;
    return Objects.equals(this.filters, listAllProjectsRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjectsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectsRequest is not found in the empty JSON string", ListAllProjectsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ListAllProjectsRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectsRequest>() {
           @Override
           public void write(JsonWriter out, ListAllProjectsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectsRequest
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectsRequest
   */
  public static ListAllProjectsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectsRequest.class);
  }

  /**
   * Convert an instance of ListAllProjectsRequest to an JSON string
   *
   * @return JSON string
   */
