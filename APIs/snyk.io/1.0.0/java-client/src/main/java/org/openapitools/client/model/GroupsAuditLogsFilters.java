...
public class GroupsAuditLogsFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetGroupLevelAuditLogsRequestFilters filters;

  public GroupsAuditLogsFilters() {
  }

  public GroupsAuditLogsFilters filters(GetGroupLevelAuditLogsRequestFilters filters) {
  ...
  public boolean equals(Object o) {
    ...
    GroupsAuditLogsFilters groupsAuditLogsFilters = (GroupsAuditLogsFilters) o;
    return Objects.equals(this.filters, groupsAuditLogsFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsAuditLogsFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupsAuditLogsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupsAuditLogsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupsAuditLogsFilters is not found in the empty JSON string", GroupsAuditLogsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupsAuditLogsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupsAuditLogsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupsAuditLogsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupsAuditLogsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupsAuditLogsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupsAuditLogsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupsAuditLogsFilters>() {
           @Override
           public void write(JsonWriter out, GroupsAuditLogsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupsAuditLogsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GroupsAuditLogsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GroupsAuditLogsFilters
   * @throws IOException if the JSON string is invalid with respect to GroupsAuditLogsFilters
   */
  public static GroupsAuditLogsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupsAuditLogsFilters.class);
  }

  /**
   * Convert an instance of GroupsAuditLogsFilters to an JSON string
   *
   * @return JSON string
   */
