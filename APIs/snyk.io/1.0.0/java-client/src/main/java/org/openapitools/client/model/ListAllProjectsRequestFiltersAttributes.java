...
public class ListAllProjectsRequestFiltersAttributes {
  ...
  public ListAllProjectsRequestFiltersAttributes() {
  }

  public ListAllProjectsRequestFiltersAttributes criticality(List<Object> criticality) {
    this.criticality = criticality;
    return this;
  }

  public ListAllProjectsRequestFiltersAttributes addCriticalityItem(Object criticalityItem) {
  ...
  public ListAllProjectsRequestFiltersAttributes environment(List<Object> environment) {
    this.environment = environment;
    return this;
  }

  public ListAllProjectsRequestFiltersAttributes addEnvironmentItem(Object environmentItem) {
  ...
  public ListAllProjectsRequestFiltersAttributes lifecycle(List<Object> lifecycle) {
    this.lifecycle = lifecycle;
    return this;
  }

  public ListAllProjectsRequestFiltersAttributes addLifecycleItem(Object lifecycleItem) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectsRequestFiltersAttributes listAllProjectsRequestFiltersAttributes = (ListAllProjectsRequestFiltersAttributes) o;
    return Objects.equals(this.criticality, listAllProjectsRequestFiltersAttributes.criticality) &&
        Objects.equals(this.environment, listAllProjectsRequestFiltersAttributes.environment) &&
        Objects.equals(this.lifecycle, listAllProjectsRequestFiltersAttributes.lifecycle);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjectsRequestFiltersAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectsRequestFiltersAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectsRequestFiltersAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectsRequestFiltersAttributes is not found in the empty JSON string", ListAllProjectsRequestFiltersAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectsRequestFiltersAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectsRequestFiltersAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectsRequestFiltersAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectsRequestFiltersAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectsRequestFiltersAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectsRequestFiltersAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectsRequestFiltersAttributes>() {
           @Override
           public void write(JsonWriter out, ListAllProjectsRequestFiltersAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectsRequestFiltersAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectsRequestFiltersAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectsRequestFiltersAttributes
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectsRequestFiltersAttributes
   */
  public static ListAllProjectsRequestFiltersAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectsRequestFiltersAttributes.class);
  }

  /**
   * Convert an instance of ListAllProjectsRequestFiltersAttributes to an JSON string
   *
   * @return JSON string
   */
