...
public class NotificationSettingResponse {
  ...
  public NotificationSettingResponse enabled(Boolean enabled) {
  ...
  public NotificationSettingResponse issueSeverity(IssueSeverityEnum issueSeverity) {
  ...
  public NotificationSettingResponse issueType(IssueTypeEnum issueType) {
  ...
  public NotificationSettingResponse inherited(Boolean inherited) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationSettingResponse notificationSettingResponse = (NotificationSettingResponse) o;
    return Objects.equals(this.enabled, notificationSettingResponse.enabled) &&
        Objects.equals(this.issueSeverity, notificationSettingResponse.issueSeverity) &&
        Objects.equals(this.issueType, notificationSettingResponse.issueType) &&
        Objects.equals(this.inherited, notificationSettingResponse.inherited);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, issueSeverity, issueType, inherited);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NotificationSettingResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotificationSettingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationSettingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotificationSettingResponse is not found in the empty JSON string", NotificationSettingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotificationSettingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotificationSettingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotificationSettingResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotificationSettingResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotificationSettingResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotificationSettingResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotificationSettingResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NotificationSettingResponse>() {
           @Override
           public void write(JsonWriter out, NotificationSettingResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotificationSettingResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotificationSettingResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotificationSettingResponse
   * @throws IOException if the JSON string is invalid with respect to NotificationSettingResponse
   */
  public static NotificationSettingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotificationSettingResponse.class);
  }

  /**
   * Convert an instance of NotificationSettingResponse to an JSON string
   *
   * @return JSON string
   */
