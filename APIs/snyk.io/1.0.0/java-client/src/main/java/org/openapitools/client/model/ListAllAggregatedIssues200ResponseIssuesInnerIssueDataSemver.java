...
public class ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver {
  public static final String SERIALIZED_NAME_UNAFFECTED = "unaffected";
  @SerializedName(SERIALIZED_NAME_UNAFFECTED)
  private String unaffected;

  public static final String SERIALIZED_NAME_VULNERABLE = "vulnerable";
  @SerializedName(SERIALIZED_NAME_VULNERABLE)
  private List<Object> vulnerable = new ArrayList<>();

  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver() {
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver unaffected(String unaffected) {
  ...
  public void setUnaffected(String unaffected) {
    this.unaffected = unaffected;
  }


  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver vulnerable(List<Object> vulnerable) {
    this.vulnerable = vulnerable;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver addVulnerableItem(Object vulnerableItem) {
    if (this.vulnerable == null) {
      this.vulnerable = new ArrayList<>();
    }
    this.vulnerable.add(vulnerableItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getVulnerable() {
    return vulnerable;
  }

  public void setVulnerable(List<Object> vulnerable) {
    this.vulnerable = vulnerable;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver listAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver = (ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver) o;
    return Objects.equals(this.unaffected, listAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.unaffected) &&
        Objects.equals(this.vulnerable, listAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.vulnerable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(unaffected, vulnerable);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver {\n");
    sb.append("    unaffected: ").append(toIndentedString(unaffected)).append("\n");
    sb.append("    vulnerable: ").append(toIndentedString(vulnerable)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("unaffected");
    openapiFields.add("vulnerable");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver is not found in the empty JSON string", ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("unaffected") != null && !jsonObj.get("unaffected").isJsonNull()) && !jsonObj.get("unaffected").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `unaffected` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unaffected").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("vulnerable") != null && !jsonObj.get("vulnerable").isJsonNull() && !jsonObj.get("vulnerable").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `vulnerable` to be an array in the JSON string but got `%s`", jsonObj.get("vulnerable").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver
   */
  public static ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver to an JSON string
   *
   * @return JSON string
   */
