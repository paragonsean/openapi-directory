...
public class TestSbtFileRequest {
  /**
  ...
  public TestSbtFileRequest() {
  }

  public TestSbtFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestSbtFileRequest files(TestGradleFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestSbtFileRequest testSbtFileRequest = (TestSbtFileRequest) o;
    return Objects.equals(this.encoding, testSbtFileRequest.encoding) &&
        Objects.equals(this.files, testSbtFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestSbtFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestSbtFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestSbtFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestSbtFileRequest is not found in the empty JSON string", TestSbtFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestSbtFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestSbtFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestSbtFileRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestSbtFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestSbtFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestSbtFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestSbtFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestSbtFileRequest>() {
           @Override
           public void write(JsonWriter out, TestSbtFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestSbtFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestSbtFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestSbtFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestSbtFileRequest
   */
  public static TestSbtFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestSbtFileRequest.class);
  }

  /**
   * Convert an instance of TestSbtFileRequest to an JSON string
   *
   * @return JSON string
   */
