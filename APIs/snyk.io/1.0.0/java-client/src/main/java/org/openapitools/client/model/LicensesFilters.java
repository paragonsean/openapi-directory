...
import org.openapitools.client.model.LicensesFiltersFilters;
...
public class LicensesFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private LicensesFiltersFilters filters;

  public LicensesFilters() {
  }

  public LicensesFilters filters(LicensesFiltersFilters filters) {
  ...
  public LicensesFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(LicensesFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    LicensesFilters licensesFilters = (LicensesFilters) o;
    return Objects.equals(this.filters, licensesFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class LicensesFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LicensesFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LicensesFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LicensesFilters is not found in the empty JSON string", LicensesFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LicensesFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LicensesFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        LicensesFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LicensesFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LicensesFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LicensesFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LicensesFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<LicensesFilters>() {
           @Override
           public void write(JsonWriter out, LicensesFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LicensesFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LicensesFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LicensesFilters
   * @throws IOException if the JSON string is invalid with respect to LicensesFilters
   */
  public static LicensesFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LicensesFilters.class);
  }

  /**
   * Convert an instance of LicensesFilters to an JSON string
   *
   * @return JSON string
   */
