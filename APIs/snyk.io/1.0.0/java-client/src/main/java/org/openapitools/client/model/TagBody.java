...
public class TagBody {
  ...
  public TagBody value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, tagBody.key) &&
        Objects.equals(this.value, tagBody.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TagBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagBody is not found in the empty JSON string", TagBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TagBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TagBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagBody.class));

       return (TypeAdapter<T>) new TypeAdapter<TagBody>() {
           @Override
           public void write(JsonWriter out, TagBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TagBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TagBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TagBody
   * @throws IOException if the JSON string is invalid with respect to TagBody
   */
  public static TagBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagBody.class);
  }

  /**
   * Convert an instance of TagBody to an JSON string
   *
   * @return JSON string
   */
