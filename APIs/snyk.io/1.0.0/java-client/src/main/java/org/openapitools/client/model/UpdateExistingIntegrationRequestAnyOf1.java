...
public class UpdateExistingIntegrationRequestAnyOf1 {
  ...
  public UpdateExistingIntegrationRequestAnyOf1() {
  }

  public UpdateExistingIntegrationRequestAnyOf1 credentials(AddNewIntegrationRequestAnyOfCredentials credentials) {
  ...
  public UpdateExistingIntegrationRequestAnyOf1 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateExistingIntegrationRequestAnyOf1 updateExistingIntegrationRequestAnyOf1 = (UpdateExistingIntegrationRequestAnyOf1) o;
    return Objects.equals(this.credentials, updateExistingIntegrationRequestAnyOf1.credentials) &&
        Objects.equals(this.type, updateExistingIntegrationRequestAnyOf1.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateExistingIntegrationRequestAnyOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateExistingIntegrationRequestAnyOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateExistingIntegrationRequestAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateExistingIntegrationRequestAnyOf1 is not found in the empty JSON string", UpdateExistingIntegrationRequestAnyOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateExistingIntegrationRequestAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateExistingIntegrationRequestAnyOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateExistingIntegrationRequestAnyOf1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateExistingIntegrationRequestAnyOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateExistingIntegrationRequestAnyOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateExistingIntegrationRequestAnyOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateExistingIntegrationRequestAnyOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateExistingIntegrationRequestAnyOf1>() {
           @Override
           public void write(JsonWriter out, UpdateExistingIntegrationRequestAnyOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateExistingIntegrationRequestAnyOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateExistingIntegrationRequestAnyOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateExistingIntegrationRequestAnyOf1
   * @throws IOException if the JSON string is invalid with respect to UpdateExistingIntegrationRequestAnyOf1
   */
  public static UpdateExistingIntegrationRequestAnyOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateExistingIntegrationRequestAnyOf1.class);
  }

  /**
   * Convert an instance of UpdateExistingIntegrationRequestAnyOf1 to an JSON string
   *
   * @return JSON string
   */
