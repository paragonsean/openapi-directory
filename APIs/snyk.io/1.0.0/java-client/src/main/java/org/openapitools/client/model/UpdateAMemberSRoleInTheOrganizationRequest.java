...
public class UpdateAMemberSRoleInTheOrganizationRequest {
  public static final String SERIALIZED_NAME_ROLE_PUBLIC_ID = "rolePublicId";
  @SerializedName(SERIALIZED_NAME_ROLE_PUBLIC_ID)
  private String rolePublicId;

  public UpdateAMemberSRoleInTheOrganizationRequest() {
  }

  public UpdateAMemberSRoleInTheOrganizationRequest rolePublicId(String rolePublicId) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAMemberSRoleInTheOrganizationRequest updateAMemberSRoleInTheOrganizationRequest = (UpdateAMemberSRoleInTheOrganizationRequest) o;
    return Objects.equals(this.rolePublicId, updateAMemberSRoleInTheOrganizationRequest.rolePublicId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rolePublicId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateAMemberSRoleInTheOrganizationRequest {\n");
    sb.append("    rolePublicId: ").append(toIndentedString(rolePublicId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("rolePublicId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAMemberSRoleInTheOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAMemberSRoleInTheOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAMemberSRoleInTheOrganizationRequest is not found in the empty JSON string", UpdateAMemberSRoleInTheOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAMemberSRoleInTheOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAMemberSRoleInTheOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("rolePublicId") != null && !jsonObj.get("rolePublicId").isJsonNull()) && !jsonObj.get("rolePublicId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rolePublicId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rolePublicId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAMemberSRoleInTheOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAMemberSRoleInTheOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAMemberSRoleInTheOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAMemberSRoleInTheOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAMemberSRoleInTheOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAMemberSRoleInTheOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAMemberSRoleInTheOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAMemberSRoleInTheOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAMemberSRoleInTheOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAMemberSRoleInTheOrganizationRequest
   */
  public static UpdateAMemberSRoleInTheOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAMemberSRoleInTheOrganizationRequest.class);
  }

  /**
   * Convert an instance of UpdateAMemberSRoleInTheOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
