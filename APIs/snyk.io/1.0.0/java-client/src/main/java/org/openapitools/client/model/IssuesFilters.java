...
import org.openapitools.client.model.IssuesFiltersFilters;
...
public class IssuesFilters {
  ...
  private IssuesFiltersFilters filters;

  public IssuesFilters() {
  }

  public IssuesFilters filters(IssuesFiltersFilters filters) {
  ...
  public IssuesFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(IssuesFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    IssuesFilters issuesFilters = (IssuesFilters) o;
    return Objects.equals(this.filters, issuesFilters.filters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuesFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuesFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssuesFilters is not found in the empty JSON string", IssuesFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssuesFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssuesFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        IssuesFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssuesFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssuesFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssuesFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssuesFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<IssuesFilters>() {
           @Override
           public void write(JsonWriter out, IssuesFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssuesFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssuesFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssuesFilters
   * @throws IOException if the JSON string is invalid with respect to IssuesFilters
   */
  public static IssuesFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssuesFilters.class);
  }

  /**
   * Convert an instance of IssuesFilters to an JSON string
   *
   * @return JSON string
   */
