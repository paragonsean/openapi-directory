...
import org.openapitools.client.model.TestComposerJsonComposerLockFileRequestFiles;
...
public class ComposerRequestPayload {
  /**
  ...
  private TestComposerJsonComposerLockFileRequestFiles files;

  public ComposerRequestPayload() {
  }

  public ComposerRequestPayload encoding(EncodingEnum encoding) {
  ...
  public ComposerRequestPayload files(TestComposerJsonComposerLockFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestComposerJsonComposerLockFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestComposerJsonComposerLockFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    ComposerRequestPayload composerRequestPayload = (ComposerRequestPayload) o;
    return Objects.equals(this.encoding, composerRequestPayload.encoding) &&
        Objects.equals(this.files, composerRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComposerRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComposerRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComposerRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComposerRequestPayload is not found in the empty JSON string", ComposerRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComposerRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComposerRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ComposerRequestPayload.openapiRequiredFields) {
      ...
      TestComposerJsonComposerLockFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComposerRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComposerRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComposerRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComposerRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<ComposerRequestPayload>() {
           @Override
           public void write(JsonWriter out, ComposerRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComposerRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComposerRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComposerRequestPayload
   * @throws IOException if the JSON string is invalid with respect to ComposerRequestPayload
   */
  public static ComposerRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComposerRequestPayload.class);
  }

  /**
   * Convert an instance of ComposerRequestPayload to an JSON string
   *
   * @return JSON string
   */
