...
public class TestVendorJsonFileRequestFilesTarget {
  public static final String SERIALIZED_NAME_CONTENTS = "contents";
  @SerializedName(SERIALIZED_NAME_CONTENTS)
  private String contents;

  public TestVendorJsonFileRequestFilesTarget() {
  }

  public TestVendorJsonFileRequestFilesTarget contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    TestVendorJsonFileRequestFilesTarget testVendorJsonFileRequestFilesTarget = (TestVendorJsonFileRequestFilesTarget) o;
    return Objects.equals(this.contents, testVendorJsonFileRequestFilesTarget.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestVendorJsonFileRequestFilesTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestVendorJsonFileRequestFilesTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestVendorJsonFileRequestFilesTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestVendorJsonFileRequestFilesTarget is not found in the empty JSON string", TestVendorJsonFileRequestFilesTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestVendorJsonFileRequestFilesTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestVendorJsonFileRequestFilesTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestVendorJsonFileRequestFilesTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestVendorJsonFileRequestFilesTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestVendorJsonFileRequestFilesTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestVendorJsonFileRequestFilesTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<TestVendorJsonFileRequestFilesTarget>() {
           @Override
           public void write(JsonWriter out, TestVendorJsonFileRequestFilesTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestVendorJsonFileRequestFilesTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestVendorJsonFileRequestFilesTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestVendorJsonFileRequestFilesTarget
   * @throws IOException if the JSON string is invalid with respect to TestVendorJsonFileRequestFilesTarget
   */
  public static TestVendorJsonFileRequestFilesTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestVendorJsonFileRequestFilesTarget.class);
  }

  /**
   * Convert an instance of TestVendorJsonFileRequestFilesTarget to an JSON string
   *
   * @return JSON string
   */
