...
public class GetOrganizationLevelAuditLogsRequestFilters {
  ...
  public GetOrganizationLevelAuditLogsRequestFilters() {
  }

  public GetOrganizationLevelAuditLogsRequestFilters email(String email) {
    this.email = email;
    return this;
  }
  ...
  public GetOrganizationLevelAuditLogsRequestFilters event(EventEnum event) {
    this.event = event;
    return this;
  }
  ...
  public GetOrganizationLevelAuditLogsRequestFilters excludeEvent(ExcludeEventEnum excludeEvent) {
  ...
  public GetOrganizationLevelAuditLogsRequestFilters projectId(String projectId) {
  ...
  public GetOrganizationLevelAuditLogsRequestFilters userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetOrganizationLevelAuditLogsRequestFilters getOrganizationLevelAuditLogsRequestFilters = (GetOrganizationLevelAuditLogsRequestFilters) o;
    return Objects.equals(this.email, getOrganizationLevelAuditLogsRequestFilters.email) &&
        Objects.equals(this.event, getOrganizationLevelAuditLogsRequestFilters.event) &&
        Objects.equals(this.excludeEvent, getOrganizationLevelAuditLogsRequestFilters.excludeEvent) &&
        Objects.equals(this.projectId, getOrganizationLevelAuditLogsRequestFilters.projectId) &&
        Objects.equals(this.userId, getOrganizationLevelAuditLogsRequestFilters.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOrganizationLevelAuditLogsRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOrganizationLevelAuditLogsRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOrganizationLevelAuditLogsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOrganizationLevelAuditLogsRequestFilters is not found in the empty JSON string", GetOrganizationLevelAuditLogsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOrganizationLevelAuditLogsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOrganizationLevelAuditLogsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOrganizationLevelAuditLogsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOrganizationLevelAuditLogsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOrganizationLevelAuditLogsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOrganizationLevelAuditLogsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOrganizationLevelAuditLogsRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetOrganizationLevelAuditLogsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOrganizationLevelAuditLogsRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOrganizationLevelAuditLogsRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOrganizationLevelAuditLogsRequestFilters
   * @throws IOException if the JSON string is invalid with respect to GetOrganizationLevelAuditLogsRequestFilters
   */
  public static GetOrganizationLevelAuditLogsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOrganizationLevelAuditLogsRequestFilters.class);
  }

  /**
   * Convert an instance of GetOrganizationLevelAuditLogsRequestFilters to an JSON string
   *
   * @return JSON string
   */
