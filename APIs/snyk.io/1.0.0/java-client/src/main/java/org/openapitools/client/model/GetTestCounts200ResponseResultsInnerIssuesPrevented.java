...
public class GetTestCounts200ResponseResultsInnerIssuesPrevented {
  ...
  public GetTestCounts200ResponseResultsInnerIssuesPrevented() {
  }

  public GetTestCounts200ResponseResultsInnerIssuesPrevented false(BigDecimal false) {
    this.false = false;
    return this;
  }
  ...
  public GetTestCounts200ResponseResultsInnerIssuesPrevented true(BigDecimal true) {
    this.true = true;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTestCounts200ResponseResultsInnerIssuesPrevented getTestCounts200ResponseResultsInnerIssuesPrevented = (GetTestCounts200ResponseResultsInnerIssuesPrevented) o;
    return Objects.equals(this.false, getTestCounts200ResponseResultsInnerIssuesPrevented.false) &&
        Objects.equals(this.true, getTestCounts200ResponseResultsInnerIssuesPrevented.true);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTestCounts200ResponseResultsInnerIssuesPrevented {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTestCounts200ResponseResultsInnerIssuesPrevented
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTestCounts200ResponseResultsInnerIssuesPrevented.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTestCounts200ResponseResultsInnerIssuesPrevented is not found in the empty JSON string", GetTestCounts200ResponseResultsInnerIssuesPrevented.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTestCounts200ResponseResultsInnerIssuesPrevented.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTestCounts200ResponseResultsInnerIssuesPrevented` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTestCounts200ResponseResultsInnerIssuesPrevented.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTestCounts200ResponseResultsInnerIssuesPrevented' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTestCounts200ResponseResultsInnerIssuesPrevented> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTestCounts200ResponseResultsInnerIssuesPrevented.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTestCounts200ResponseResultsInnerIssuesPrevented>() {
           @Override
           public void write(JsonWriter out, GetTestCounts200ResponseResultsInnerIssuesPrevented value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTestCounts200ResponseResultsInnerIssuesPrevented read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTestCounts200ResponseResultsInnerIssuesPrevented given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTestCounts200ResponseResultsInnerIssuesPrevented
   * @throws IOException if the JSON string is invalid with respect to GetTestCounts200ResponseResultsInnerIssuesPrevented
   */
  public static GetTestCounts200ResponseResultsInnerIssuesPrevented fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTestCounts200ResponseResultsInnerIssuesPrevented.class);
  }

  /**
   * Convert an instance of GetTestCounts200ResponseResultsInnerIssuesPrevented to an JSON string
   *
   * @return JSON string
   */
