...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf3BitbucketCloudCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf3 {
  public static final String SERIALIZED_NAME_BITBUCKET_CLOUD_CREDENTIALS = "BitbucketCloudCredentials";
  @SerializedName(SERIALIZED_NAME_BITBUCKET_CLOUD_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf3BitbucketCloudCredentials bitbucketCloudCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf3() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf3 bitbucketCloudCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf3BitbucketCloudCredentials bitbucketCloudCredentials) {
    this.bitbucketCloudCredentials = bitbucketCloudCredentials;
    return this;
  }

  /**
   * Get bitbucketCloudCredentials
   * @return bitbucketCloudCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf3BitbucketCloudCredentials getBitbucketCloudCredentials() {
    return bitbucketCloudCredentials;
  }

  public void setBitbucketCloudCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf3BitbucketCloudCredentials bitbucketCloudCredentials) {
    this.bitbucketCloudCredentials = bitbucketCloudCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf3 addNewIntegrationRequestAnyOfCredentialsOneOf3 = (AddNewIntegrationRequestAnyOfCredentialsOneOf3) o;
    return Objects.equals(this.bitbucketCloudCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf3.bitbucketCloudCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bitbucketCloudCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf3 {\n");
    sb.append("    bitbucketCloudCredentials: ").append(toIndentedString(bitbucketCloudCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("BitbucketCloudCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf3 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `BitbucketCloudCredentials`
      if (jsonObj.get("BitbucketCloudCredentials") != null && !jsonObj.get("BitbucketCloudCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf3BitbucketCloudCredentials.validateJsonElement(jsonObj.get("BitbucketCloudCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf3.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf3>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf3
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf3
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf3.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf3 to an JSON string
   *
   * @return JSON string
   */
