...
import org.openapitools.client.model.TestDepGraphRequestDepGraphGraph;
...
public class TestDepGraphRequestDepGraph {
  ...
  public TestDepGraphRequestDepGraph() {
  }

  public TestDepGraphRequestDepGraph graph(TestDepGraphRequestDepGraphGraph graph) {
    this.graph = graph;
    return this;
  }
  ...
  public TestDepGraphRequestDepGraphGraph getGraph() {
    return graph;
  }

  public void setGraph(TestDepGraphRequestDepGraphGraph graph) {
    this.graph = graph;
  }


  public TestDepGraphRequestDepGraph pkgManager(MonitorDepGraphRequestDepGraphPkgManager pkgManager) {
  ...
  public TestDepGraphRequestDepGraph pkgs(List<Object> pkgs) {
    this.pkgs = pkgs;
    return this;
  }

  public TestDepGraphRequestDepGraph addPkgsItem(Object pkgsItem) {
    if (this.pkgs == null) {
  ...
  public TestDepGraphRequestDepGraph schemaVersion(String schemaVersion) {
  ...
  public boolean equals(Object o) {
    ...
    TestDepGraphRequestDepGraph testDepGraphRequestDepGraph = (TestDepGraphRequestDepGraph) o;
    return Objects.equals(this.graph, testDepGraphRequestDepGraph.graph) &&
        Objects.equals(this.pkgManager, testDepGraphRequestDepGraph.pkgManager) &&
        Objects.equals(this.pkgs, testDepGraphRequestDepGraph.pkgs) &&
        Objects.equals(this.schemaVersion, testDepGraphRequestDepGraph.schemaVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestDepGraphRequestDepGraph {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestDepGraphRequestDepGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestDepGraphRequestDepGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestDepGraphRequestDepGraph is not found in the empty JSON string", TestDepGraphRequestDepGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestDepGraphRequestDepGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestDepGraphRequestDepGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestDepGraphRequestDepGraph.openapiRequiredFields) {
      ...
      TestDepGraphRequestDepGraphGraph.validateJsonElement(jsonObj.get("graph"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestDepGraphRequestDepGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestDepGraphRequestDepGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestDepGraphRequestDepGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestDepGraphRequestDepGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<TestDepGraphRequestDepGraph>() {
           @Override
           public void write(JsonWriter out, TestDepGraphRequestDepGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestDepGraphRequestDepGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestDepGraphRequestDepGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestDepGraphRequestDepGraph
   * @throws IOException if the JSON string is invalid with respect to TestDepGraphRequestDepGraph
   */
  public static TestDepGraphRequestDepGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestDepGraphRequestDepGraph.class);
  }

  /**
   * Convert an instance of TestDepGraphRequestDepGraph to an JSON string
   *
   * @return JSON string
   */
