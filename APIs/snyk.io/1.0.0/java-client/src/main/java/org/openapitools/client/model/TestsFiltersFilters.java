...
public class TestsFiltersFilters {
  ...
  public TestsFiltersFilters() {
  }

  public TestsFiltersFilters isPrivate(Boolean isPrivate) {
  ...
  public TestsFiltersFilters issuesPrevented(Boolean issuesPrevented) {
  ...
  public TestsFiltersFilters orgs(List<Object> orgs) {
    this.orgs = orgs;
    return this;
  }

  public TestsFiltersFilters addOrgsItem(Object orgsItem) {
    if (this.orgs == null) {
  ...
  public TestsFiltersFilters projects(List<Object> projects) {
    this.projects = projects;
    return this;
  }

  public TestsFiltersFilters addProjectsItem(Object projectsItem) {
  ...
  public boolean equals(Object o) {
    ...
    TestsFiltersFilters testsFiltersFilters = (TestsFiltersFilters) o;
    return Objects.equals(this.isPrivate, testsFiltersFilters.isPrivate) &&
        Objects.equals(this.issuesPrevented, testsFiltersFilters.issuesPrevented) &&
        Objects.equals(this.orgs, testsFiltersFilters.orgs) &&
        Objects.equals(this.projects, testsFiltersFilters.projects);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestsFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestsFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestsFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestsFiltersFilters is not found in the empty JSON string", TestsFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestsFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestsFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestsFiltersFilters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestsFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestsFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestsFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestsFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<TestsFiltersFilters>() {
           @Override
           public void write(JsonWriter out, TestsFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestsFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestsFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestsFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to TestsFiltersFilters
   */
  public static TestsFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestsFiltersFilters.class);
  }

  /**
   * Convert an instance of TestsFiltersFilters to an JSON string
   *
   * @return JSON string
   */
