...
public class GetListOfIssues200ResponseResultsInnerOneOf1 {
  public static final String SERIALIZED_NAME_PROJECT = "project";
  @SerializedName(SERIALIZED_NAME_PROJECT)
  private GetListOfIssues200ResponseResultsInnerOneOf1Project project;

  public GetListOfIssues200ResponseResultsInnerOneOf1() {
  }

  public GetListOfIssues200ResponseResultsInnerOneOf1 project(GetListOfIssues200ResponseResultsInnerOneOf1Project project) {
  ...
  public GetListOfIssues200ResponseResultsInnerOneOf1Project getProject() {
    return project;
  }

  public void setProject(GetListOfIssues200ResponseResultsInnerOneOf1Project project) {
    this.project = project;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetListOfIssues200ResponseResultsInnerOneOf1 getListOfIssues200ResponseResultsInnerOneOf1 = (GetListOfIssues200ResponseResultsInnerOneOf1) o;
    return Objects.equals(this.project, getListOfIssues200ResponseResultsInnerOneOf1.project);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetListOfIssues200ResponseResultsInnerOneOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetListOfIssues200ResponseResultsInnerOneOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetListOfIssues200ResponseResultsInnerOneOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListOfIssues200ResponseResultsInnerOneOf1 is not found in the empty JSON string", GetListOfIssues200ResponseResultsInnerOneOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetListOfIssues200ResponseResultsInnerOneOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetListOfIssues200ResponseResultsInnerOneOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetListOfIssues200ResponseResultsInnerOneOf1.openapiRequiredFields) {
      ...
      GetListOfIssues200ResponseResultsInnerOneOf1Project.validateJsonElement(jsonObj.get("project"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListOfIssues200ResponseResultsInnerOneOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListOfIssues200ResponseResultsInnerOneOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssues200ResponseResultsInnerOneOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf1>() {
           @Override
           public void write(JsonWriter out, GetListOfIssues200ResponseResultsInnerOneOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetListOfIssues200ResponseResultsInnerOneOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetListOfIssues200ResponseResultsInnerOneOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetListOfIssues200ResponseResultsInnerOneOf1
   * @throws IOException if the JSON string is invalid with respect to GetListOfIssues200ResponseResultsInnerOneOf1
   */
  public static GetListOfIssues200ResponseResultsInnerOneOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListOfIssues200ResponseResultsInnerOneOf1.class);
  }

  /**
   * Convert an instance of GetListOfIssues200ResponseResultsInnerOneOf1 to an JSON string
   *
   * @return JSON string
   */
