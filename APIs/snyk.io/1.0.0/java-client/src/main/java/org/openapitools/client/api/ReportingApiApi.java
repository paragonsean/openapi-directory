...
import org.openapitools.client.model.GetIssueCounts200Response;
import org.openapitools.client.model.GetIssueCounts400Response;
import org.openapitools.client.model.GetIssueCountsRequest;
import org.openapitools.client.model.GetListOfIssues200Response;
import org.openapitools.client.model.GetListOfIssuesRequest;
import org.openapitools.client.model.GetProjectCounts200Response;
import org.openapitools.client.model.GetProjectCountsRequest;
import org.openapitools.client.model.GetTestCounts200Response;
import org.openapitools.client.model.GetTestCountsRequest;
...
public class ReportingApiApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ReportingApiApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ReportingApiApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getIssueCounts
     * @param from The date you wish to fetch results from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to fetch results until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param groupBy The field to group results by (optional)
     * @param getIssueCountsRequest  (optional)
     ...
     */
    public okhttp3.Call getIssueCountsCall(String from, String to, String groupBy, GetIssueCountsRequest getIssueCountsRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = getIssueCountsRequest;

        // create path and map variables
        String localVarPath = "/reporting/counts/issues";
    ...
    private okhttp3.Call getIssueCountsValidateBeforeCall(String from, String to, String groupBy, GetIssueCountsRequest getIssueCountsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getIssueCounts(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getIssueCounts(Async)");
        }

        return getIssueCountsCall(from, to, groupBy, getIssueCountsRequest, _callback);
     ...
     */
    public GetIssueCounts200Response getIssueCounts(String from, String to, String groupBy, GetIssueCountsRequest getIssueCountsRequest) throws ApiException {
        ApiResponse<GetIssueCounts200Response> localVarResp = getIssueCountsWithHttpInfo(from, to, groupBy, getIssueCountsRequest);
     ...
     * @param groupBy The field to group results by (optional)
     * @param getIssueCountsRequest  (optional)
     * @return ApiResponse&lt;GetIssueCounts200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetIssueCounts200Response> getIssueCountsWithHttpInfo(String from, String to, String groupBy, GetIssueCountsRequest getIssueCountsRequest) throws ApiException {
        okhttp3.Call localVarCall = getIssueCountsValidateBeforeCall(from, to, groupBy, getIssueCountsRequest, null);
        Type localVarReturnType = new TypeToken<GetIssueCounts200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get issue counts (asynchronously)
     * 
     * @param from The date you wish to fetch results from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to fetch results until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param groupBy The field to group results by (optional)
     ...
     */
    public okhttp3.Call getIssueCountsAsync(String from, String to, String groupBy, GetIssueCountsRequest getIssueCountsRequest, final ApiCallback<GetIssueCounts200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIssueCountsValidateBeforeCall(from, to, groupBy, getIssueCountsRequest, _callback);
        Type localVarReturnType = new TypeToken<GetIssueCounts200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getLatestIssueCounts
     * @param groupBy The field to group results by (optional)
     * @param getIssueCountsRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getLatestIssueCountsCall(String groupBy, GetIssueCountsRequest getIssueCountsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/reporting/counts/issues/latest";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLatestIssueCountsValidateBeforeCall(String groupBy, GetIssueCountsRequest getIssueCountsRequest, final ApiCallback _callback) throws ApiException {
        return getLatestIssueCountsCall(groupBy, getIssueCountsRequest, _callback);
     ...
     */
    public GetIssueCounts200Response getLatestIssueCounts(String groupBy, GetIssueCountsRequest getIssueCountsRequest) throws ApiException {
        ApiResponse<GetIssueCounts200Response> localVarResp = getLatestIssueCountsWithHttpInfo(groupBy, getIssueCountsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetIssueCounts200Response> getLatestIssueCountsWithHttpInfo(String groupBy, GetIssueCountsRequest getIssueCountsRequest) throws ApiException {
        okhttp3.Call localVarCall = getLatestIssueCountsValidateBeforeCall(groupBy, getIssueCountsRequest, null);
        Type localVarReturnType = new TypeToken<GetIssueCounts200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get latest issue counts (asynchronously)
     * 
     * @param groupBy The field to group results by (optional)
     * @param getIssueCountsRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getLatestIssueCountsAsync(String groupBy, GetIssueCountsRequest getIssueCountsRequest, final ApiCallback<GetIssueCounts200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLatestIssueCountsValidateBeforeCall(groupBy, getIssueCountsRequest, _callback);
        Type localVarReturnType = new TypeToken<GetIssueCounts200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getLatestProjectCounts
     * @param getProjectCountsRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getLatestProjectCountsCall(GetProjectCountsRequest getProjectCountsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = getProjectCountsRequest;

        // create path and map variables
        String localVarPath = "/reporting/counts/projects/latest";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLatestProjectCountsValidateBeforeCall(GetProjectCountsRequest getProjectCountsRequest, final ApiCallback _callback) throws ApiException {
        return getLatestProjectCountsCall(getProjectCountsRequest, _callback);
     ...
     * 
     * @param getProjectCountsRequest  (optional)
     * @return GetProjectCounts200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetProjectCounts200Response getLatestProjectCounts(GetProjectCountsRequest getProjectCountsRequest) throws ApiException {
        ApiResponse<GetProjectCounts200Response> localVarResp = getLatestProjectCountsWithHttpInfo(getProjectCountsRequest);
        return localVarResp.getData();
    }
     ...
     * 
     * @param getProjectCountsRequest  (optional)
     * @return ApiResponse&lt;GetProjectCounts200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetProjectCounts200Response> getLatestProjectCountsWithHttpInfo(GetProjectCountsRequest getProjectCountsRequest) throws ApiException {
        okhttp3.Call localVarCall = getLatestProjectCountsValidateBeforeCall(getProjectCountsRequest, null);
        Type localVarReturnType = new TypeToken<GetProjectCounts200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get latest project counts (asynchronously)
     * 
     * @param getProjectCountsRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getLatestProjectCountsAsync(GetProjectCountsRequest getProjectCountsRequest, final ApiCallback<GetProjectCounts200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLatestProjectCountsValidateBeforeCall(getProjectCountsRequest, _callback);
        Type localVarReturnType = new TypeToken<GetProjectCounts200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getListOfIssues
     * @param from The date you wish to fetch results from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to fetch results until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param page The page of results to request (optional)
     * @param perPage The number of results to return per page (Maximum: 1000) (optional)
     * @param sortBy The key to sort results by (optional)
     * @param order The direction to sort results. (optional)
     * @param groupBy Set to issue to group the same issue in multiple projects (optional)
     * @param getListOfIssuesRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getListOfIssuesCall(String from, String to, BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = getListOfIssuesRequest;

        // create path and map variables
        String localVarPath = "/reporting/issues/";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getListOfIssuesValidateBeforeCall(String from, String to, BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getListOfIssues(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getListOfIssues(Async)");
        }

        return getListOfIssuesCall(from, to, page, perPage, sortBy, order, groupBy, getListOfIssuesRequest, _callback);
     ...
     * @param groupBy Set to issue to group the same issue in multiple projects (optional)
     * @param getListOfIssuesRequest  (optional)
     * @return GetListOfIssues200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetListOfIssues200Response getListOfIssues(String from, String to, BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest) throws ApiException {
        ApiResponse<GetListOfIssues200Response> localVarResp = getListOfIssuesWithHttpInfo(from, to, page, perPage, sortBy, order, groupBy, getListOfIssuesRequest);
        return localVarResp.getData();
    }
     ...
     * @param groupBy Set to issue to group the same issue in multiple projects (optional)
     * @param getListOfIssuesRequest  (optional)
     * @return ApiResponse&lt;GetListOfIssues200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetListOfIssues200Response> getListOfIssuesWithHttpInfo(String from, String to, BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest) throws ApiException {
        okhttp3.Call localVarCall = getListOfIssuesValidateBeforeCall(from, to, page, perPage, sortBy, order, groupBy, getListOfIssuesRequest, null);
        Type localVarReturnType = new TypeToken<GetListOfIssues200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get list of issues (asynchronously)
     * 
     * @param from The date you wish to fetch results from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to fetch results until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param page The page of results to request (optional)
     ...
     */
    public okhttp3.Call getListOfIssuesAsync(String from, String to, BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest, final ApiCallback<GetListOfIssues200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getListOfIssuesValidateBeforeCall(from, to, page, perPage, sortBy, order, groupBy, getListOfIssuesRequest, _callback);
        Type localVarReturnType = new TypeToken<GetListOfIssues200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getListOfLatestIssues
     * @param page The page of results to request (optional)
     * @param perPage The number of results to return per page (Maximum: 1000) (optional)
     * @param sortBy The key to sort results by (optional)
     * @param order The direction to sort results. (optional)
     ...
     */
    public okhttp3.Call getListOfLatestIssuesCall(BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/reporting/issues/latest";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getListOfLatestIssuesValidateBeforeCall(BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest, final ApiCallback _callback) throws ApiException {
        return getListOfLatestIssuesCall(page, perPage, sortBy, order, groupBy, getListOfIssuesRequest, _callback);
     ...
     */
    public GetListOfIssues200Response getListOfLatestIssues(BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest) throws ApiException {
        ApiResponse<GetListOfIssues200Response> localVarResp = getListOfLatestIssuesWithHttpInfo(page, perPage, sortBy, order, groupBy, getListOfIssuesRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetListOfIssues200Response> getListOfLatestIssuesWithHttpInfo(BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest) throws ApiException {
        okhttp3.Call localVarCall = getListOfLatestIssuesValidateBeforeCall(page, perPage, sortBy, order, groupBy, getListOfIssuesRequest, null);
        Type localVarReturnType = new TypeToken<GetListOfIssues200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get list of latest issues (asynchronously)
     * 
     * @param page The page of results to request (optional)
     * @param perPage The number of results to return per page (Maximum: 1000) (optional)
     * @param sortBy The key to sort results by (optional)
     ...
     */
    public okhttp3.Call getListOfLatestIssuesAsync(BigDecimal page, BigDecimal perPage, String sortBy, String order, String groupBy, GetListOfIssuesRequest getListOfIssuesRequest, final ApiCallback<GetListOfIssues200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getListOfLatestIssuesValidateBeforeCall(page, perPage, sortBy, order, groupBy, getListOfIssuesRequest, _callback);
        Type localVarReturnType = new TypeToken<GetListOfIssues200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getProjectCounts
     * @param from The date you wish to fetch results from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to fetch results until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param getProjectCountsRequest  (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getProjectCountsCall(String from, String to, GetProjectCountsRequest getProjectCountsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/reporting/counts/projects";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectCountsValidateBeforeCall(String from, String to, GetProjectCountsRequest getProjectCountsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getProjectCounts(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getProjectCounts(Async)");
        }

        return getProjectCountsCall(from, to, getProjectCountsRequest, _callback);
     ...
     */
    public GetProjectCounts200Response getProjectCounts(String from, String to, GetProjectCountsRequest getProjectCountsRequest) throws ApiException {
        ApiResponse<GetProjectCounts200Response> localVarResp = getProjectCountsWithHttpInfo(from, to, getProjectCountsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetProjectCounts200Response> getProjectCountsWithHttpInfo(String from, String to, GetProjectCountsRequest getProjectCountsRequest) throws ApiException {
        okhttp3.Call localVarCall = getProjectCountsValidateBeforeCall(from, to, getProjectCountsRequest, null);
        Type localVarReturnType = new TypeToken<GetProjectCounts200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get project counts (asynchronously)
     * 
     * @param from The date you wish to fetch results from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to fetch results until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param getProjectCountsRequest  (optional)
     ...
     */
    public okhttp3.Call getProjectCountsAsync(String from, String to, GetProjectCountsRequest getProjectCountsRequest, final ApiCallback<GetProjectCounts200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectCountsValidateBeforeCall(from, to, getProjectCountsRequest, _callback);
        Type localVarReturnType = new TypeToken<GetProjectCounts200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getTestCounts
     * @param from The date you wish to count tests from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to count tests until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param groupBy The field to group results by (optional)
     * @param getTestCountsRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getTestCountsCall(String from, String to, String groupBy, GetTestCountsRequest getTestCountsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = getTestCountsRequest;

        // create path and map variables
        String localVarPath = "/reporting/counts/tests";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTestCountsValidateBeforeCall(String from, String to, String groupBy, GetTestCountsRequest getTestCountsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'from' is set
        if (from == null) {
            throw new ApiException("Missing the required parameter 'from' when calling getTestCounts(Async)");
        }

        // verify the required parameter 'to' is set
        if (to == null) {
            throw new ApiException("Missing the required parameter 'to' when calling getTestCounts(Async)");
        }

        return getTestCountsCall(from, to, groupBy, getTestCountsRequest, _callback);
     ...
     * @param groupBy The field to group results by (optional)
     * @param getTestCountsRequest  (optional)
     * @return GetTestCounts200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetTestCounts200Response getTestCounts(String from, String to, String groupBy, GetTestCountsRequest getTestCountsRequest) throws ApiException {
        ApiResponse<GetTestCounts200Response> localVarResp = getTestCountsWithHttpInfo(from, to, groupBy, getTestCountsRequest);
        return localVarResp.getData();
    }
     ...
     * @param groupBy The field to group results by (optional)
     * @param getTestCountsRequest  (optional)
     * @return ApiResponse&lt;GetTestCounts200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetTestCounts200Response> getTestCountsWithHttpInfo(String from, String to, String groupBy, GetTestCountsRequest getTestCountsRequest) throws ApiException {
        okhttp3.Call localVarCall = getTestCountsValidateBeforeCall(from, to, groupBy, getTestCountsRequest, null);
        Type localVarReturnType = new TypeToken<GetTestCounts200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get test counts (asynchronously)
     * 
     * @param from The date you wish to count tests from, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param to The date you wish to count tests until, in the format &#x60;YYYY-MM-DD&#x60; (required)
     * @param groupBy The field to group results by (optional)
     ...
     */
    public okhttp3.Call getTestCountsAsync(String from, String to, String groupBy, GetTestCountsRequest getTestCountsRequest, final ApiCallback<GetTestCounts200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTestCountsValidateBeforeCall(from, to, groupBy, getTestCountsRequest, _callback);
        Type localVarReturnType = new TypeToken<GetTestCounts200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
