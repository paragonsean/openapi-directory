...
import org.openapitools.client.model.AggregatedProjectIssuesIssuesInnerIssueData;
import org.openapitools.client.model.ListAllAggregatedIssues200ResponseIssuesInnerFixInfo;
import org.openapitools.client.model.ListAllAggregatedIssues200ResponseIssuesInnerLinks;
import org.openapitools.client.model.ListAllAggregatedIssues200ResponseIssuesInnerPriority;
...
public class AggregatedProjectIssuesIssuesInner {
  public static final String SERIALIZED_NAME_FIX_INFO = "fixInfo";
  @SerializedName(SERIALIZED_NAME_FIX_INFO)
  private ListAllAggregatedIssues200ResponseIssuesInnerFixInfo fixInfo;
  ...
  private List<Object> ignoreReasons = new ArrayList<>();

  public static final String SERIALIZED_NAME_INTRODUCED_THROUGH = "introducedThrough";
  @SerializedName(SERIALIZED_NAME_INTRODUCED_THROUGH)
  private List<Object> introducedThrough = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_ISSUE_DATA = "issueData";
  @SerializedName(SERIALIZED_NAME_ISSUE_DATA)
  private AggregatedProjectIssuesIssuesInnerIssueData issueData;
  ...
  private ListAllAggregatedIssues200ResponseIssuesInnerLinks links;

  public static final String SERIALIZED_NAME_PKG_NAME = "pkgName";
  @SerializedName(SERIALIZED_NAME_PKG_NAME)
  private String pkgName;

  public static final String SERIALIZED_NAME_PKG_VERSIONS = "pkgVersions";
  @SerializedName(SERIALIZED_NAME_PKG_VERSIONS)
  private List<String> pkgVersions = new ArrayList<>();

  public static final String SERIALIZED_NAME_PRIORITY = "priority";
  @SerializedName(SERIALIZED_NAME_PRIORITY)
  private ListAllAggregatedIssues200ResponseIssuesInnerPriority priority;

  public AggregatedProjectIssuesIssuesInner() {
  }

  public AggregatedProjectIssuesIssuesInner fixInfo(ListAllAggregatedIssues200ResponseIssuesInnerFixInfo fixInfo) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo getFixInfo() {
    return fixInfo;
  }

  public void setFixInfo(ListAllAggregatedIssues200ResponseIssuesInnerFixInfo fixInfo) {
    this.fixInfo = fixInfo;
  }


  public AggregatedProjectIssuesIssuesInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AggregatedProjectIssuesIssuesInner ignoreReasons(List<Object> ignoreReasons) {
    this.ignoreReasons = ignoreReasons;
    return this;
  }

  public AggregatedProjectIssuesIssuesInner addIgnoreReasonsItem(Object ignoreReasonsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getIgnoreReasons() {
    return ignoreReasons;
  }

  public void setIgnoreReasons(List<Object> ignoreReasons) {
    this.ignoreReasons = ignoreReasons;
  }


  public AggregatedProjectIssuesIssuesInner introducedThrough(List<Object> introducedThrough) {
    this.introducedThrough = introducedThrough;
    return this;
  }

  public AggregatedProjectIssuesIssuesInner addIntroducedThroughItem(Object introducedThroughItem) {
    if (this.introducedThrough == null) {
      this.introducedThrough = new ArrayList<>();
    }
    this.introducedThrough.add(introducedThroughItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getIntroducedThrough() {
    return introducedThrough;
  }

  public void setIntroducedThrough(List<Object> introducedThrough) {
    this.introducedThrough = introducedThrough;
  }


  public AggregatedProjectIssuesIssuesInner isIgnored(Boolean isIgnored) {
  ...
  public AggregatedProjectIssuesIssuesInner isPatched(Boolean isPatched) {
  ...
  public AggregatedProjectIssuesIssuesInner issueData(AggregatedProjectIssuesIssuesInnerIssueData issueData) {
   ...
   */
  @javax.annotation.Nonnull
  public AggregatedProjectIssuesIssuesInnerIssueData getIssueData() {
    return issueData;
  }

  public void setIssueData(AggregatedProjectIssuesIssuesInnerIssueData issueData) {
    this.issueData = issueData;
  }


  public AggregatedProjectIssuesIssuesInner issueType(String issueType) {
  ...
  public AggregatedProjectIssuesIssuesInner links(ListAllAggregatedIssues200ResponseIssuesInnerLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ListAllAggregatedIssues200ResponseIssuesInnerLinks getLinks() {
    return links;
  }

  public void setLinks(ListAllAggregatedIssues200ResponseIssuesInnerLinks links) {
    this.links = links;
  }


  public AggregatedProjectIssuesIssuesInner pkgName(String pkgName) {
  ...
  public AggregatedProjectIssuesIssuesInner pkgVersions(List<String> pkgVersions) {
    this.pkgVersions = pkgVersions;
    return this;
  }

  public AggregatedProjectIssuesIssuesInner addPkgVersionsItem(String pkgVersionsItem) {
    if (this.pkgVersions == null) {
      this.pkgVersions = new ArrayList<>();
    }
    this.pkgVersions.add(pkgVersionsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public List<String> getPkgVersions() {
    return pkgVersions;
  }

  public void setPkgVersions(List<String> pkgVersions) {
    this.pkgVersions = pkgVersions;
  }


  public AggregatedProjectIssuesIssuesInner priority(ListAllAggregatedIssues200ResponseIssuesInnerPriority priority) {
   ...
   */
  @javax.annotation.Nullable
  public ListAllAggregatedIssues200ResponseIssuesInnerPriority getPriority() {
    return priority;
  }

  public void setPriority(ListAllAggregatedIssues200ResponseIssuesInnerPriority priority) {
    this.priority = priority;
  }
  ...
  public boolean equals(Object o) {
    ...
    AggregatedProjectIssuesIssuesInner aggregatedProjectIssuesIssuesInner = (AggregatedProjectIssuesIssuesInner) o;
    return Objects.equals(this.fixInfo, aggregatedProjectIssuesIssuesInner.fixInfo) &&
        Objects.equals(this.id, aggregatedProjectIssuesIssuesInner.id) &&
        Objects.equals(this.ignoreReasons, aggregatedProjectIssuesIssuesInner.ignoreReasons) &&
        Objects.equals(this.introducedThrough, aggregatedProjectIssuesIssuesInner.introducedThrough) &&
        Objects.equals(this.isIgnored, aggregatedProjectIssuesIssuesInner.isIgnored) &&
        Objects.equals(this.isPatched, aggregatedProjectIssuesIssuesInner.isPatched) &&
        Objects.equals(this.issueData, aggregatedProjectIssuesIssuesInner.issueData) &&
        Objects.equals(this.issueType, aggregatedProjectIssuesIssuesInner.issueType) &&
        Objects.equals(this.links, aggregatedProjectIssuesIssuesInner.links) &&
        Objects.equals(this.pkgName, aggregatedProjectIssuesIssuesInner.pkgName) &&
        Objects.equals(this.pkgVersions, aggregatedProjectIssuesIssuesInner.pkgVersions) &&
        Objects.equals(this.priority, aggregatedProjectIssuesIssuesInner.priority);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fixInfo, id, ignoreReasons, introducedThrough, isIgnored, isPatched, issueData, issueType, links, pkgName, pkgVersions, priority);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AggregatedProjectIssuesIssuesInner {\n");
    sb.append("    fixInfo: ").append(toIndentedString(fixInfo)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    ignoreReasons: ").append(toIndentedString(ignoreReasons)).append("\n");
    sb.append("    introducedThrough: ").append(toIndentedString(introducedThrough)).append("\n");
    sb.append("    isIgnored: ").append(toIndentedString(isIgnored)).append("\n");
    sb.append("    isPatched: ").append(toIndentedString(isPatched)).append("\n");
    sb.append("    issueData: ").append(toIndentedString(issueData)).append("\n");
    sb.append("    issueType: ").append(toIndentedString(issueType)).append("\n");
    sb.append("    links: ").append(toIndentedString(links)).append("\n");
    sb.append("    pkgName: ").append(toIndentedString(pkgName)).append("\n");
    sb.append("    pkgVersions: ").append(toIndentedString(pkgVersions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fixInfo");
    openapiFields.add("id");
    openapiFields.add("ignoreReasons");
    openapiFields.add("introducedThrough");
    openapiFields.add("isIgnored");
    openapiFields.add("isPatched");
    openapiFields.add("issueData");
    openapiFields.add("issueType");
    openapiFields.add("links");
    openapiFields.add("pkgName");
    openapiFields.add("pkgVersions");
    openapiFields.add("priority");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("id");
    openapiRequiredFields.add("isIgnored");
    openapiRequiredFields.add("isPatched");
    openapiRequiredFields.add("issueData");
    openapiRequiredFields.add("issueType");
    openapiRequiredFields.add("pkgName");
    openapiRequiredFields.add("pkgVersions");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregatedProjectIssuesIssuesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregatedProjectIssuesIssuesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregatedProjectIssuesIssuesInner is not found in the empty JSON string", AggregatedProjectIssuesIssuesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregatedProjectIssuesIssuesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AggregatedProjectIssuesIssuesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AggregatedProjectIssuesIssuesInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("fixInfo") != null && !jsonObj.get("fixInfo").isJsonNull()) {
        ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.validateJsonElement(jsonObj.get("fixInfo"));
      }
      if (!jsonObj.get("id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("id").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("ignoreReasons") != null && !jsonObj.get("ignoreReasons").isJsonNull() && !jsonObj.get("ignoreReasons").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("introducedThrough") != null && !jsonObj.get("introducedThrough").isJsonNull() && !jsonObj.get("introducedThrough").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `introducedThrough` to be an array in the JSON string but got `%s`", jsonObj.get("introducedThrough").toString()));
      }
      // validate the required field `issueData`
      AggregatedProjectIssuesIssuesInnerIssueData.validateJsonElement(jsonObj.get("issueData"));
      if (!jsonObj.get("issueType").isJsonPrimitive()) {
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        ListAllAggregatedIssues200ResponseIssuesInnerLinks.validateJsonElement(jsonObj.get("links"));
      }
      if (!jsonObj.get("pkgName").isJsonPrimitive()) {
      ...
      if (jsonObj.get("pkgVersions") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("pkgVersions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `pkgVersions` to be an array in the JSON string but got `%s`", jsonObj.get("pkgVersions").toString()));
      }
      // validate the optional field `priority`
      if (jsonObj.get("priority") != null && !jsonObj.get("priority").isJsonNull()) {
        ListAllAggregatedIssues200ResponseIssuesInnerPriority.validateJsonElement(jsonObj.get("priority"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregatedProjectIssuesIssuesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregatedProjectIssuesIssuesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregatedProjectIssuesIssuesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregatedProjectIssuesIssuesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregatedProjectIssuesIssuesInner>() {
           @Override
           public void write(JsonWriter out, AggregatedProjectIssuesIssuesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregatedProjectIssuesIssuesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregatedProjectIssuesIssuesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregatedProjectIssuesIssuesInner
   * @throws IOException if the JSON string is invalid with respect to AggregatedProjectIssuesIssuesInner
   */
  public static AggregatedProjectIssuesIssuesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregatedProjectIssuesIssuesInner.class);
  }

  /**
   * Convert an instance of AggregatedProjectIssuesIssuesInner to an JSON string
   *
   * @return JSON string
   */
