...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf15HarborCrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf15 {
  public static final String SERIALIZED_NAME_HARBOR_CR_CREDENTIALS = "HarborCrCredentials";
  @SerializedName(SERIALIZED_NAME_HARBOR_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf15HarborCrCredentials harborCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf15() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf15 harborCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf15HarborCrCredentials harborCrCredentials) {
    this.harborCrCredentials = harborCrCredentials;
    return this;
  }

  /**
   * Get harborCrCredentials
   * @return harborCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf15HarborCrCredentials getHarborCrCredentials() {
    return harborCrCredentials;
  }

  public void setHarborCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf15HarborCrCredentials harborCrCredentials) {
    this.harborCrCredentials = harborCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf15 addNewIntegrationRequestAnyOfCredentialsOneOf15 = (AddNewIntegrationRequestAnyOfCredentialsOneOf15) o;
    return Objects.equals(this.harborCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf15.harborCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(harborCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf15 {\n");
    sb.append("    harborCrCredentials: ").append(toIndentedString(harborCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("HarborCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf15
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf15.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf15 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf15.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf15.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf15` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `HarborCrCredentials`
      if (jsonObj.get("HarborCrCredentials") != null && !jsonObj.get("HarborCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf15HarborCrCredentials.validateJsonElement(jsonObj.get("HarborCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf15.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf15>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf15 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf15 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf15 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf15
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf15
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf15.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf15 to an JSON string
   *
   * @return JSON string
   */
