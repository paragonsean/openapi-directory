...
import org.openapitools.client.model.TestVendorJsonFileRequestFiles;
...
public class TestVendorJsonFileRequest {
  /**
  ...
  private TestVendorJsonFileRequestFiles files;

  public TestVendorJsonFileRequest() {
  }

  public TestVendorJsonFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestVendorJsonFileRequest files(TestVendorJsonFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestVendorJsonFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestVendorJsonFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestVendorJsonFileRequest testVendorJsonFileRequest = (TestVendorJsonFileRequest) o;
    return Objects.equals(this.encoding, testVendorJsonFileRequest.encoding) &&
        Objects.equals(this.files, testVendorJsonFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestVendorJsonFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestVendorJsonFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestVendorJsonFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestVendorJsonFileRequest is not found in the empty JSON string", TestVendorJsonFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestVendorJsonFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestVendorJsonFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestVendorJsonFileRequest.openapiRequiredFields) {
      ...
      TestVendorJsonFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestVendorJsonFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestVendorJsonFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestVendorJsonFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestVendorJsonFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestVendorJsonFileRequest>() {
           @Override
           public void write(JsonWriter out, TestVendorJsonFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestVendorJsonFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestVendorJsonFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestVendorJsonFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestVendorJsonFileRequest
   */
  public static TestVendorJsonFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestVendorJsonFileRequest.class);
  }

  /**
   * Convert an instance of TestVendorJsonFileRequest to an JSON string
   *
   * @return JSON string
   */
