...
import org.openapitools.client.model.ProjectCountsFiltersFilters;
...
public class ProjectCountsFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private ProjectCountsFiltersFilters filters;

  public ProjectCountsFilters() {
  }

  public ProjectCountsFilters filters(ProjectCountsFiltersFilters filters) {
  ...
  public ProjectCountsFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(ProjectCountsFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectCountsFilters projectCountsFilters = (ProjectCountsFilters) o;
    return Objects.equals(this.filters, projectCountsFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectCountsFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectCountsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCountsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectCountsFilters is not found in the empty JSON string", ProjectCountsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectCountsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectCountsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ProjectCountsFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectCountsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectCountsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectCountsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectCountsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectCountsFilters>() {
           @Override
           public void write(JsonWriter out, ProjectCountsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectCountsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectCountsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectCountsFilters
   * @throws IOException if the JSON string is invalid with respect to ProjectCountsFilters
   */
  public static ProjectCountsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectCountsFilters.class);
  }

  /**
   * Convert an instance of ProjectCountsFilters to an JSON string
   *
   * @return JSON string
   */
