...
public class MonitorNode {
  ...
  private List<Object> deps = new ArrayList<>();
  ...
  public MonitorNode deps(List<Object> deps) {
    this.deps = deps;
    return this;
  }

  public MonitorNode addDepsItem(Object depsItem) {
    if (this.deps == null) {
  ...
  public List<Object> getDeps() {
    return deps;
  }

  public void setDeps(List<Object> deps) {
    this.deps = deps;
  }


  public MonitorNode nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public MonitorNode pkgId(String pkgId) {
    this.pkgId = pkgId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitorNode monitorNode = (MonitorNode) o;
    return Objects.equals(this.deps, monitorNode.deps) &&
        Objects.equals(this.nodeId, monitorNode.nodeId) &&
        Objects.equals(this.pkgId, monitorNode.pkgId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorNode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorNode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorNode is not found in the empty JSON string", MonitorNode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorNode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorNode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorNode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorNode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorNode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorNode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorNode.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorNode>() {
           @Override
           public void write(JsonWriter out, MonitorNode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorNode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorNode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorNode
   * @throws IOException if the JSON string is invalid with respect to MonitorNode
   */
  public static MonitorNode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorNode.class);
  }

  /**
   * Convert an instance of MonitorNode to an JSON string
   *
   * @return JSON string
   */
