...
public class GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo {
  ...
  public GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo() {
  }

  public GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo getProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo = (GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo) o;
    return Objects.equals(this.name, getProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.name) &&
        Objects.equals(this.version, getProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo
   */
  public static GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo to an JSON string
   *
   * @return JSON string
   */
