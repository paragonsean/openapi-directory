...
public class ViewOrganizationSettings200ResponseRequestAccess {
  public static final String SERIALIZED_NAME_ENABLED = "enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public ViewOrganizationSettings200ResponseRequestAccess() {
  }

  public ViewOrganizationSettings200ResponseRequestAccess enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    ViewOrganizationSettings200ResponseRequestAccess viewOrganizationSettings200ResponseRequestAccess = (ViewOrganizationSettings200ResponseRequestAccess) o;
    return Objects.equals(this.enabled, viewOrganizationSettings200ResponseRequestAccess.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewOrganizationSettings200ResponseRequestAccess {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewOrganizationSettings200ResponseRequestAccess
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewOrganizationSettings200ResponseRequestAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewOrganizationSettings200ResponseRequestAccess is not found in the empty JSON string", ViewOrganizationSettings200ResponseRequestAccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewOrganizationSettings200ResponseRequestAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewOrganizationSettings200ResponseRequestAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewOrganizationSettings200ResponseRequestAccess.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewOrganizationSettings200ResponseRequestAccess.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewOrganizationSettings200ResponseRequestAccess' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewOrganizationSettings200ResponseRequestAccess> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewOrganizationSettings200ResponseRequestAccess.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewOrganizationSettings200ResponseRequestAccess>() {
           @Override
           public void write(JsonWriter out, ViewOrganizationSettings200ResponseRequestAccess value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewOrganizationSettings200ResponseRequestAccess read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewOrganizationSettings200ResponseRequestAccess given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewOrganizationSettings200ResponseRequestAccess
   * @throws IOException if the JSON string is invalid with respect to ViewOrganizationSettings200ResponseRequestAccess
   */
  public static ViewOrganizationSettings200ResponseRequestAccess fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewOrganizationSettings200ResponseRequestAccess.class);
  }

  /**
   * Convert an instance of ViewOrganizationSettings200ResponseRequestAccess to an JSON string
   *
   * @return JSON string
   */
