...
import org.openapitools.client.model.ImportTargetsRequestAnyOf5Target;
...
public class ImportTargetsRequestAnyOf5 {
  ...
  private ImportTargetsRequestAnyOf5Target target;

  public ImportTargetsRequestAnyOf5() {
  }

  public ImportTargetsRequestAnyOf5 files(List<Object> files) {
    this.files = files;
    return this;
  }

  public ImportTargetsRequestAnyOf5 addFilesItem(Object filesItem) {
    if (this.files == null) {
  ...
  public ImportTargetsRequestAnyOf5 target(ImportTargetsRequestAnyOf5Target target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportTargetsRequestAnyOf5Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf5Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf5 importTargetsRequestAnyOf5 = (ImportTargetsRequestAnyOf5) o;
    return Objects.equals(this.files, importTargetsRequestAnyOf5.files) &&
        Objects.equals(this.target, importTargetsRequestAnyOf5.target);
  }

  @Override
  public int hashCode() {
    return Objects.hash(files, target);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportTargetsRequestAnyOf5 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf5
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf5 is not found in the empty JSON string", ImportTargetsRequestAnyOf5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf5Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf5.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf5>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf5 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf5 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf5
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf5
   */
  public static ImportTargetsRequestAnyOf5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf5.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf5 to an JSON string
   *
   * @return JSON string
   */
