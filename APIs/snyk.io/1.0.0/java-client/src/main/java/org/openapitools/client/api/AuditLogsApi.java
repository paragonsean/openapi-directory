...
import org.openapitools.client.model.GetGroupLevelAuditLogsRequest;
import org.openapitools.client.model.GetOrganizationLevelAuditLogsRequest;
...
public class AuditLogsApi {
    ...
    /**
     * Build call for getGroupLevelAuditLogs
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access to this group. (required)
     * @param from The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months. (optional)
     * @param to The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months. (optional)
     * @param page The page of results to request. Audit logs are returned in page sizes of 100 (optional)
     * @param sortOrder The sort order of the returned audit logs by date. Values: &#x60;ASC&#x60;, &#x60;DESC&#x60;. Default: &#x60;DESC&#x60;. (optional)
     * @param getGroupLevelAuditLogsRequest  (optional)
     ...
     */
    public okhttp3.Call getGroupLevelAuditLogsCall(String groupId, String from, String to, BigDecimal page, String sortOrder, GetGroupLevelAuditLogsRequest getGroupLevelAuditLogsRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = getGroupLevelAuditLogsRequest;

        // create path and map variables
        String localVarPath = "/group/{groupId}/audit"
    ...
    private okhttp3.Call getGroupLevelAuditLogsValidateBeforeCall(String groupId, String from, String to, BigDecimal page, String sortOrder, GetGroupLevelAuditLogsRequest getGroupLevelAuditLogsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling getGroupLevelAuditLogs(Async)");
        }

        return getGroupLevelAuditLogsCall(groupId, from, to, page, sortOrder, getGroupLevelAuditLogsRequest, _callback);
     ...
     */
    public void getGroupLevelAuditLogs(String groupId, String from, String to, BigDecimal page, String sortOrder, GetGroupLevelAuditLogsRequest getGroupLevelAuditLogsRequest) throws ApiException {
        getGroupLevelAuditLogsWithHttpInfo(groupId, from, to, page, sortOrder, getGroupLevelAuditLogsRequest);
    }
     ...
     */
    public ApiResponse<Void> getGroupLevelAuditLogsWithHttpInfo(String groupId, String from, String to, BigDecimal page, String sortOrder, GetGroupLevelAuditLogsRequest getGroupLevelAuditLogsRequest) throws ApiException {
        okhttp3.Call localVarCall = getGroupLevelAuditLogsValidateBeforeCall(groupId, from, to, page, sortOrder, getGroupLevelAuditLogsRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get group level audit logs (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access to this group. (required)
     * @param from The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months. (optional)
     * @param to The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months. (optional)
     ...
     */
    public okhttp3.Call getGroupLevelAuditLogsAsync(String groupId, String from, String to, BigDecimal page, String sortOrder, GetGroupLevelAuditLogsRequest getGroupLevelAuditLogsRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupLevelAuditLogsValidateBeforeCall(groupId, from, to, page, sortOrder, getGroupLevelAuditLogsRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getOrganizationLevelAuditLogs
     * @param orgId The organization ID. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param from The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months. (optional)
     * @param to The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months. (optional)
     * @param page The page of results to request. Audit logs are returned in page sizes of 100. (optional)
     * @param sortOrder The sort order of the returned audit logs by date. Values: &#x60;ASC&#x60;, &#x60;DESC&#x60;. Default: &#x60;DESC&#x60;. (optional)
     * @param getOrganizationLevelAuditLogsRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getOrganizationLevelAuditLogsCall(String orgId, String from, String to, BigDecimal page, String sortOrder, GetOrganizationLevelAuditLogsRequest getOrganizationLevelAuditLogsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = getOrganizationLevelAuditLogsRequest;

        // create path and map variables
        String localVarPath = "/org/{orgId}/audit"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrganizationLevelAuditLogsValidateBeforeCall(String orgId, String from, String to, BigDecimal page, String sortOrder, GetOrganizationLevelAuditLogsRequest getOrganizationLevelAuditLogsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling getOrganizationLevelAuditLogs(Async)");
        }

        return getOrganizationLevelAuditLogsCall(orgId, from, to, page, sortOrder, getOrganizationLevelAuditLogsRequest, _callback);
     ...
     */
    public void getOrganizationLevelAuditLogs(String orgId, String from, String to, BigDecimal page, String sortOrder, GetOrganizationLevelAuditLogsRequest getOrganizationLevelAuditLogsRequest) throws ApiException {
        getOrganizationLevelAuditLogsWithHttpInfo(orgId, from, to, page, sortOrder, getOrganizationLevelAuditLogsRequest);
    }
     ...
     */
    public ApiResponse<Void> getOrganizationLevelAuditLogsWithHttpInfo(String orgId, String from, String to, BigDecimal page, String sortOrder, GetOrganizationLevelAuditLogsRequest getOrganizationLevelAuditLogsRequest) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationLevelAuditLogsValidateBeforeCall(orgId, from, to, page, sortOrder, getOrganizationLevelAuditLogsRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get organization level audit logs (asynchronously)
     * 
     * @param orgId The organization ID. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param from The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months. (optional)
     * @param to The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months. (optional)
     ...
     */
    public okhttp3.Call getOrganizationLevelAuditLogsAsync(String orgId, String from, String to, BigDecimal page, String sortOrder, GetOrganizationLevelAuditLogsRequest getOrganizationLevelAuditLogsRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationLevelAuditLogsValidateBeforeCall(orgId, from, to, page, sortOrder, getOrganizationLevelAuditLogsRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
