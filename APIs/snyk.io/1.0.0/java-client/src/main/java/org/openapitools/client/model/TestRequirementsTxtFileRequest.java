...
import org.openapitools.client.model.TestRequirementsTxtFileRequestFiles;
...
public class TestRequirementsTxtFileRequest {
  /**
  ...
  private EncodingEnum encoding = EncodingEnum.BASE64;

  public static final String SERIALIZED_NAME_FILES = "files";
  @SerializedName(SERIALIZED_NAME_FILES)
  private TestRequirementsTxtFileRequestFiles files;

  public TestRequirementsTxtFileRequest() {
  }

  public TestRequirementsTxtFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestRequirementsTxtFileRequest files(TestRequirementsTxtFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestRequirementsTxtFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestRequirementsTxtFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestRequirementsTxtFileRequest testRequirementsTxtFileRequest = (TestRequirementsTxtFileRequest) o;
    return Objects.equals(this.encoding, testRequirementsTxtFileRequest.encoding) &&
        Objects.equals(this.files, testRequirementsTxtFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestRequirementsTxtFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestRequirementsTxtFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestRequirementsTxtFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestRequirementsTxtFileRequest is not found in the empty JSON string", TestRequirementsTxtFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestRequirementsTxtFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestRequirementsTxtFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestRequirementsTxtFileRequest.openapiRequiredFields) {
      ...
      TestRequirementsTxtFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestRequirementsTxtFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestRequirementsTxtFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestRequirementsTxtFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestRequirementsTxtFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestRequirementsTxtFileRequest>() {
           @Override
           public void write(JsonWriter out, TestRequirementsTxtFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestRequirementsTxtFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestRequirementsTxtFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestRequirementsTxtFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestRequirementsTxtFileRequest
   */
  public static TestRequirementsTxtFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestRequirementsTxtFileRequest.class);
  }

  /**
   * Convert an instance of TestRequirementsTxtFileRequest to an JSON string
   *
   * @return JSON string
   */
