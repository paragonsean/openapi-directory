...
public class SimpleNotificationSettingResponse {
  ...
  public SimpleNotificationSettingResponse() {
  }

  public SimpleNotificationSettingResponse enabled(Boolean enabled) {
  ...
  public SimpleNotificationSettingResponse inherited(Boolean inherited) {
  ...
  public boolean equals(Object o) {
    ...
    SimpleNotificationSettingResponse simpleNotificationSettingResponse = (SimpleNotificationSettingResponse) o;
    return Objects.equals(this.enabled, simpleNotificationSettingResponse.enabled) &&
        Objects.equals(this.inherited, simpleNotificationSettingResponse.inherited);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, inherited);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SimpleNotificationSettingResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimpleNotificationSettingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimpleNotificationSettingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimpleNotificationSettingResponse is not found in the empty JSON string", SimpleNotificationSettingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleNotificationSettingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimpleNotificationSettingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimpleNotificationSettingResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimpleNotificationSettingResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimpleNotificationSettingResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimpleNotificationSettingResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimpleNotificationSettingResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SimpleNotificationSettingResponse>() {
           @Override
           public void write(JsonWriter out, SimpleNotificationSettingResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimpleNotificationSettingResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SimpleNotificationSettingResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SimpleNotificationSettingResponse
   * @throws IOException if the JSON string is invalid with respect to SimpleNotificationSettingResponse
   */
  public static SimpleNotificationSettingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimpleNotificationSettingResponse.class);
  }

  /**
   * Convert an instance of SimpleNotificationSettingResponse to an JSON string
   *
   * @return JSON string
   */
