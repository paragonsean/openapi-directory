...
public class GetProjectCounts200ResponseResultsInner {
  ...
  public GetProjectCounts200ResponseResultsInner() {
  }

  public GetProjectCounts200ResponseResultsInner count(BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  public GetProjectCounts200ResponseResultsInner day(String day) {
    this.day = day;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectCounts200ResponseResultsInner getProjectCounts200ResponseResultsInner = (GetProjectCounts200ResponseResultsInner) o;
    return Objects.equals(this.count, getProjectCounts200ResponseResultsInner.count) &&
        Objects.equals(this.day, getProjectCounts200ResponseResultsInner.day);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, day);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProjectCounts200ResponseResultsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectCounts200ResponseResultsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectCounts200ResponseResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectCounts200ResponseResultsInner is not found in the empty JSON string", GetProjectCounts200ResponseResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectCounts200ResponseResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectCounts200ResponseResultsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectCounts200ResponseResultsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectCounts200ResponseResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectCounts200ResponseResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectCounts200ResponseResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectCounts200ResponseResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectCounts200ResponseResultsInner>() {
           @Override
           public void write(JsonWriter out, GetProjectCounts200ResponseResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectCounts200ResponseResultsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectCounts200ResponseResultsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectCounts200ResponseResultsInner
   * @throws IOException if the JSON string is invalid with respect to GetProjectCounts200ResponseResultsInner
   */
  public static GetProjectCounts200ResponseResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectCounts200ResponseResultsInner.class);
  }

  /**
   * Convert an instance of GetProjectCounts200ResponseResultsInner to an JSON string
   *
   * @return JSON string
   */
