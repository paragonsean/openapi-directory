...
import org.openapitools.client.model.TestMavenFileRequestFilesTarget;
...
public class TestMavenFileRequestFiles {
  ...
  private TestMavenFileRequestFilesTarget target;

  public TestMavenFileRequestFiles() {
  }

  public TestMavenFileRequestFiles additional(List<Object> additional) {
    this.additional = additional;
    return this;
  }

  public TestMavenFileRequestFiles addAdditionalItem(Object additionalItem) {
  ...
  public TestMavenFileRequestFiles target(TestMavenFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
  ...
  public TestMavenFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestMavenFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestMavenFileRequestFiles testMavenFileRequestFiles = (TestMavenFileRequestFiles) o;
    return Objects.equals(this.additional, testMavenFileRequestFiles.additional) &&
        Objects.equals(this.target, testMavenFileRequestFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestMavenFileRequestFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestMavenFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestMavenFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestMavenFileRequestFiles is not found in the empty JSON string", TestMavenFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestMavenFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestMavenFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestMavenFileRequestFiles.openapiRequiredFields) {
      ...
      TestMavenFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestMavenFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestMavenFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestMavenFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestMavenFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestMavenFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestMavenFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestMavenFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestMavenFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestMavenFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestMavenFileRequestFiles
   */
  public static TestMavenFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestMavenFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestMavenFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
