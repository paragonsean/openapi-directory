...
public class MonitorGraph {
  ...
  public MonitorGraph nodes(List<Object> nodes) {
    this.nodes = nodes;
    return this;
  }

  public MonitorGraph addNodesItem(Object nodesItem) {
    if (this.nodes == null) {
  ...
  public MonitorGraph rootNodeId(String rootNodeId) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorGraph monitorGraph = (MonitorGraph) o;
    return Objects.equals(this.nodes, monitorGraph.nodes) &&
        Objects.equals(this.rootNodeId, monitorGraph.rootNodeId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorGraph is not found in the empty JSON string", MonitorGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorGraph.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorGraph>() {
           @Override
           public void write(JsonWriter out, MonitorGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorGraph
   * @throws IOException if the JSON string is invalid with respect to MonitorGraph
   */
  public static MonitorGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorGraph.class);
  }

  /**
   * Convert an instance of MonitorGraph to an JSON string
   *
   * @return JSON string
   */
