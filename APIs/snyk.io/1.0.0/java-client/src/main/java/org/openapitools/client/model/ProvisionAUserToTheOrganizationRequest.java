...
public class ProvisionAUserToTheOrganizationRequest {
  ...
  public ProvisionAUserToTheOrganizationRequest() {
  }

  public ProvisionAUserToTheOrganizationRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ProvisionAUserToTheOrganizationRequest role(String role) {
    this.role = role;
    return this;
  }
  ...
  public ProvisionAUserToTheOrganizationRequest rolePublicId(String rolePublicId) {
  ...
  public boolean equals(Object o) {
    ...
    ProvisionAUserToTheOrganizationRequest provisionAUserToTheOrganizationRequest = (ProvisionAUserToTheOrganizationRequest) o;
    return Objects.equals(this.email, provisionAUserToTheOrganizationRequest.email) &&
        Objects.equals(this.role, provisionAUserToTheOrganizationRequest.role) &&
        Objects.equals(this.rolePublicId, provisionAUserToTheOrganizationRequest.rolePublicId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, role, rolePublicId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProvisionAUserToTheOrganizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProvisionAUserToTheOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionAUserToTheOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisionAUserToTheOrganizationRequest is not found in the empty JSON string", ProvisionAUserToTheOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionAUserToTheOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisionAUserToTheOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProvisionAUserToTheOrganizationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisionAUserToTheOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisionAUserToTheOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisionAUserToTheOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisionAUserToTheOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisionAUserToTheOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, ProvisionAUserToTheOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisionAUserToTheOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProvisionAUserToTheOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProvisionAUserToTheOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to ProvisionAUserToTheOrganizationRequest
   */
  public static ProvisionAUserToTheOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisionAUserToTheOrganizationRequest.class);
  }

  /**
   * Convert an instance of ProvisionAUserToTheOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
