...
public class ProjectCounts {
  ...
  public ProjectCounts results(List<GetProjectCounts200ResponseResultsInner> results) {
    this.results = results;
    return this;
  }

  public ProjectCounts addResultsItem(GetProjectCounts200ResponseResultsInner resultsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.results, projectCounts.results);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ProjectCounts.openapiRequiredFields) {
