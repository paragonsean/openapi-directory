...
public class ProjectMove {
  ...
  public ProjectMove targetOrgId(String targetOrgId) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectMove projectMove = (ProjectMove) o;
    return Objects.equals(this.targetOrgId, projectMove.targetOrgId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectMove
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectMove.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectMove is not found in the empty JSON string", ProjectMove.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectMove.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectMove` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectMove.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectMove' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectMove> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectMove.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectMove>() {
           @Override
           public void write(JsonWriter out, ProjectMove value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectMove read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectMove given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectMove
   * @throws IOException if the JSON string is invalid with respect to ProjectMove
   */
  public static ProjectMove fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectMove.class);
  }

  /**
   * Convert an instance of ProjectMove to an JSON string
   *
   * @return JSON string
   */
