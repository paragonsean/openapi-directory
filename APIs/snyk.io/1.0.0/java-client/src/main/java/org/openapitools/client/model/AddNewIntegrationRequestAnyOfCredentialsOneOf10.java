...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf10 {
  public static final String SERIALIZED_NAME_GIT_HUB_CR_CREDENTIALS = "GitHubCrCredentials";
  @SerializedName(SERIALIZED_NAME_GIT_HUB_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials gitHubCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf10() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf10 gitHubCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials gitHubCrCredentials) {
    this.gitHubCrCredentials = gitHubCrCredentials;
    return this;
  }

  /**
   * Get gitHubCrCredentials
   * @return gitHubCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials getGitHubCrCredentials() {
    return gitHubCrCredentials;
  }

  public void setGitHubCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials gitHubCrCredentials) {
    this.gitHubCrCredentials = gitHubCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf10 addNewIntegrationRequestAnyOfCredentialsOneOf10 = (AddNewIntegrationRequestAnyOfCredentialsOneOf10) o;
    return Objects.equals(this.gitHubCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf10.gitHubCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gitHubCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf10 {\n");
    sb.append("    gitHubCrCredentials: ").append(toIndentedString(gitHubCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("GitHubCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf10
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf10.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf10 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf10.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf10.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf10` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GitHubCrCredentials`
      if (jsonObj.get("GitHubCrCredentials") != null && !jsonObj.get("GitHubCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.validateJsonElement(jsonObj.get("GitHubCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf10.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf10>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf10 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf10 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf10 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf10
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf10
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf10.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf10 to an JSON string
   *
   * @return JSON string
   */
