...
import org.openapitools.client.model.ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts;
...
public class ListAllProjectSnapshots200ResponseSnapshotsInner {
  ...
  public static final String SERIALIZED_NAME_ISSUE_COUNTS = "issueCounts";
  @SerializedName(SERIALIZED_NAME_ISSUE_COUNTS)
  private ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts issueCounts;
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner() {
  }

  public ListAllProjectSnapshots200ResponseSnapshotsInner created(String created) {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner imageBaseImage(String imageBaseImage) {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner imageId(String imageId) {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner imagePlatform(String imagePlatform) {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner imageTag(String imageTag) {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner issueCounts(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts issueCounts) {
   ...
   */
  @javax.annotation.Nonnull
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts getIssueCounts() {
    return issueCounts;
  }

  public void setIssueCounts(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts issueCounts) {
    this.issueCounts = issueCounts;
  }


  public ListAllProjectSnapshots200ResponseSnapshotsInner method(MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInner totalDependencies(BigDecimal totalDependencies) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectSnapshots200ResponseSnapshotsInner listAllProjectSnapshots200ResponseSnapshotsInner = (ListAllProjectSnapshots200ResponseSnapshotsInner) o;
    return Objects.equals(this.created, listAllProjectSnapshots200ResponseSnapshotsInner.created) &&
        Objects.equals(this.id, listAllProjectSnapshots200ResponseSnapshotsInner.id) &&
        Objects.equals(this.imageBaseImage, listAllProjectSnapshots200ResponseSnapshotsInner.imageBaseImage) &&
        Objects.equals(this.imageId, listAllProjectSnapshots200ResponseSnapshotsInner.imageId) &&
        Objects.equals(this.imagePlatform, listAllProjectSnapshots200ResponseSnapshotsInner.imagePlatform) &&
        Objects.equals(this.imageTag, listAllProjectSnapshots200ResponseSnapshotsInner.imageTag) &&
        Objects.equals(this.issueCounts, listAllProjectSnapshots200ResponseSnapshotsInner.issueCounts) &&
        Objects.equals(this.method, listAllProjectSnapshots200ResponseSnapshotsInner.method) &&
        Objects.equals(this.totalDependencies, listAllProjectSnapshots200ResponseSnapshotsInner.totalDependencies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, id, imageBaseImage, imageId, imagePlatform, imageTag, issueCounts, method, totalDependencies);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllProjectSnapshots200ResponseSnapshotsInner {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("issueCounts");
    openapiRequiredFields.add("totalDependencies");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectSnapshots200ResponseSnapshotsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectSnapshots200ResponseSnapshotsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectSnapshots200ResponseSnapshotsInner is not found in the empty JSON string", ListAllProjectSnapshots200ResponseSnapshotsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectSnapshots200ResponseSnapshotsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectSnapshots200ResponseSnapshotsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllProjectSnapshots200ResponseSnapshotsInner.openapiRequiredFields) {
      ...
      // validate the required field `issueCounts`
      ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.validateJsonElement(jsonObj.get("issueCounts"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectSnapshots200ResponseSnapshotsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectSnapshots200ResponseSnapshotsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectSnapshots200ResponseSnapshotsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectSnapshots200ResponseSnapshotsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectSnapshots200ResponseSnapshotsInner>() {
           @Override
           public void write(JsonWriter out, ListAllProjectSnapshots200ResponseSnapshotsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectSnapshots200ResponseSnapshotsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectSnapshots200ResponseSnapshotsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectSnapshots200ResponseSnapshotsInner
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectSnapshots200ResponseSnapshotsInner
   */
  public static ListAllProjectSnapshots200ResponseSnapshotsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectSnapshots200ResponseSnapshotsInner.class);
  }

  /**
   * Convert an instance of ListAllProjectSnapshots200ResponseSnapshotsInner to an JSON string
   *
   * @return JSON string
   */
