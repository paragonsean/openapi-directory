...
import org.openapitools.client.model.ProjectIssuesFiltersFiltersPriorityScore;
...
public class ProjectIssuesFiltersFilters {
  ...
  private ProjectIssuesFiltersFiltersPriorityScore priorityScore;
  ...
  public ProjectIssuesFiltersFilters() {
  }

  public ProjectIssuesFiltersFilters exploitMaturity(List<Object> exploitMaturity) {
    this.exploitMaturity = exploitMaturity;
    return this;
  }

  public ProjectIssuesFiltersFilters addExploitMaturityItem(Object exploitMaturityItem) {
  ...
  public ProjectIssuesFiltersFilters ignored(Boolean ignored) {
  ...
  public ProjectIssuesFiltersFilters patched(Boolean patched) {
  ...
  public ProjectIssuesFiltersFilters priorityScore(ProjectIssuesFiltersFiltersPriorityScore priorityScore) {
   ...
   */
  @javax.annotation.Nullable
  public ProjectIssuesFiltersFiltersPriorityScore getPriorityScore() {
    return priorityScore;
  }

  public void setPriorityScore(ProjectIssuesFiltersFiltersPriorityScore priorityScore) {
    this.priorityScore = priorityScore;
  }


  public ProjectIssuesFiltersFilters severities(List<Object> severities) {
    this.severities = severities;
    return this;
  }

  public ProjectIssuesFiltersFilters addSeveritiesItem(Object severitiesItem) {
  ...
  public ProjectIssuesFiltersFilters types(List<Object> types) {
    this.types = types;
    return this;
  }

  public ProjectIssuesFiltersFilters addTypesItem(Object typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectIssuesFiltersFilters projectIssuesFiltersFilters = (ProjectIssuesFiltersFilters) o;
    return Objects.equals(this.exploitMaturity, projectIssuesFiltersFilters.exploitMaturity) &&
        Objects.equals(this.ignored, projectIssuesFiltersFilters.ignored) &&
        Objects.equals(this.patched, projectIssuesFiltersFilters.patched) &&
        Objects.equals(this.priorityScore, projectIssuesFiltersFilters.priorityScore) &&
        Objects.equals(this.severities, projectIssuesFiltersFilters.severities) &&
        Objects.equals(this.types, projectIssuesFiltersFilters.types);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exploitMaturity, ignored, patched, priorityScore, severities, types);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectIssuesFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectIssuesFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectIssuesFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectIssuesFiltersFilters is not found in the empty JSON string", ProjectIssuesFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectIssuesFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectIssuesFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("priorityScore") != null && !jsonObj.get("priorityScore").isJsonNull()) {
        ProjectIssuesFiltersFiltersPriorityScore.validateJsonElement(jsonObj.get("priorityScore"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectIssuesFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectIssuesFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectIssuesFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectIssuesFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectIssuesFiltersFilters>() {
           @Override
           public void write(JsonWriter out, ProjectIssuesFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectIssuesFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectIssuesFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectIssuesFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to ProjectIssuesFiltersFilters
   */
  public static ProjectIssuesFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectIssuesFiltersFilters.class);
  }

  /**
   * Convert an instance of ProjectIssuesFiltersFilters to an JSON string
   *
   * @return JSON string
   */
