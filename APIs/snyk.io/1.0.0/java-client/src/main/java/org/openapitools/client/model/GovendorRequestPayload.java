...
public class GovendorRequestPayload {
  /**
  ...
  public GovendorRequestPayload() {
  }

  public GovendorRequestPayload encoding(EncodingEnum encoding) {
  ...
  public GovendorRequestPayload files(TestVendorJsonFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GovendorRequestPayload govendorRequestPayload = (GovendorRequestPayload) o;
    return Objects.equals(this.encoding, govendorRequestPayload.encoding) &&
        Objects.equals(this.files, govendorRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class GovendorRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GovendorRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GovendorRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GovendorRequestPayload is not found in the empty JSON string", GovendorRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GovendorRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GovendorRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GovendorRequestPayload.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GovendorRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GovendorRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GovendorRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GovendorRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<GovendorRequestPayload>() {
           @Override
           public void write(JsonWriter out, GovendorRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GovendorRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GovendorRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GovendorRequestPayload
   * @throws IOException if the JSON string is invalid with respect to GovendorRequestPayload
   */
  public static GovendorRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GovendorRequestPayload.class);
  }

  /**
   * Convert an instance of GovendorRequestPayload to an JSON string
   *
   * @return JSON string
   */
