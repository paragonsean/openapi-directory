...
public class MonitorDepGraphRequestDepGraphGraph {
  ...
  public MonitorDepGraphRequestDepGraphGraph() {
  }

  public MonitorDepGraphRequestDepGraphGraph nodes(List<Object> nodes) {
    this.nodes = nodes;
    return this;
  }

  public MonitorDepGraphRequestDepGraphGraph addNodesItem(Object nodesItem) {
    if (this.nodes == null) {
  ...
  public MonitorDepGraphRequestDepGraphGraph rootNodeId(String rootNodeId) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorDepGraphRequestDepGraphGraph monitorDepGraphRequestDepGraphGraph = (MonitorDepGraphRequestDepGraphGraph) o;
    return Objects.equals(this.nodes, monitorDepGraphRequestDepGraphGraph.nodes) &&
        Objects.equals(this.rootNodeId, monitorDepGraphRequestDepGraphGraph.rootNodeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorDepGraphRequestDepGraphGraph {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorDepGraphRequestDepGraphGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorDepGraphRequestDepGraphGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorDepGraphRequestDepGraphGraph is not found in the empty JSON string", MonitorDepGraphRequestDepGraphGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorDepGraphRequestDepGraphGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorDepGraphRequestDepGraphGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorDepGraphRequestDepGraphGraph.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorDepGraphRequestDepGraphGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorDepGraphRequestDepGraphGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorDepGraphRequestDepGraphGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorDepGraphRequestDepGraphGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorDepGraphRequestDepGraphGraph>() {
           @Override
           public void write(JsonWriter out, MonitorDepGraphRequestDepGraphGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorDepGraphRequestDepGraphGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorDepGraphRequestDepGraphGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorDepGraphRequestDepGraphGraph
   * @throws IOException if the JSON string is invalid with respect to MonitorDepGraphRequestDepGraphGraph
   */
  public static MonitorDepGraphRequestDepGraphGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorDepGraphRequestDepGraphGraph.class);
  }

  /**
   * Convert an instance of MonitorDepGraphRequestDepGraphGraph to an JSON string
   *
   * @return JSON string
   */
