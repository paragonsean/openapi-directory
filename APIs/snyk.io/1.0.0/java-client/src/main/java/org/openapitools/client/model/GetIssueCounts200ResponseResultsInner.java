...
import org.openapitools.client.model.GetIssueCounts200ResponseResultsInnerFixable;
import org.openapitools.client.model.GetIssueCounts200ResponseResultsInnerSeverity;
...
public class GetIssueCounts200ResponseResultsInner {
  ...
  private GetIssueCounts200ResponseResultsInnerFixable fixable;

  public static final String SERIALIZED_NAME_SEVERITY = "severity";
  @SerializedName(SERIALIZED_NAME_SEVERITY)
  private GetIssueCounts200ResponseResultsInnerSeverity severity;

  public GetIssueCounts200ResponseResultsInner() {
  }

  public GetIssueCounts200ResponseResultsInner count(BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  public GetIssueCounts200ResponseResultsInner day(String day) {
    this.day = day;
    return this;
  }
  ...
  public GetIssueCounts200ResponseResultsInner fixable(GetIssueCounts200ResponseResultsInnerFixable fixable) {
  ...
  public GetIssueCounts200ResponseResultsInnerFixable getFixable() {
    return fixable;
  }

  public void setFixable(GetIssueCounts200ResponseResultsInnerFixable fixable) {
    this.fixable = fixable;
  }


  public GetIssueCounts200ResponseResultsInner severity(GetIssueCounts200ResponseResultsInnerSeverity severity) {
   ...
   */
  @javax.annotation.Nullable
  public GetIssueCounts200ResponseResultsInnerSeverity getSeverity() {
    return severity;
  }

  public void setSeverity(GetIssueCounts200ResponseResultsInnerSeverity severity) {
    this.severity = severity;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCounts200ResponseResultsInner getIssueCounts200ResponseResultsInner = (GetIssueCounts200ResponseResultsInner) o;
    return Objects.equals(this.count, getIssueCounts200ResponseResultsInner.count) &&
        Objects.equals(this.day, getIssueCounts200ResponseResultsInner.day) &&
        Objects.equals(this.fixable, getIssueCounts200ResponseResultsInner.fixable) &&
        Objects.equals(this.severity, getIssueCounts200ResponseResultsInner.severity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, day, fixable, severity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetIssueCounts200ResponseResultsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCounts200ResponseResultsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCounts200ResponseResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCounts200ResponseResultsInner is not found in the empty JSON string", GetIssueCounts200ResponseResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCounts200ResponseResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCounts200ResponseResultsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIssueCounts200ResponseResultsInner.openapiRequiredFields) {
      ...
      // validate the optional field `fixable`
      if (jsonObj.get("fixable") != null && !jsonObj.get("fixable").isJsonNull()) {
        GetIssueCounts200ResponseResultsInnerFixable.validateJsonElement(jsonObj.get("fixable"));
      }
      // validate the optional field `severity`
      if (jsonObj.get("severity") != null && !jsonObj.get("severity").isJsonNull()) {
        GetIssueCounts200ResponseResultsInnerSeverity.validateJsonElement(jsonObj.get("severity"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCounts200ResponseResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCounts200ResponseResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCounts200ResponseResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCounts200ResponseResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCounts200ResponseResultsInner>() {
           @Override
           public void write(JsonWriter out, GetIssueCounts200ResponseResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCounts200ResponseResultsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCounts200ResponseResultsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCounts200ResponseResultsInner
   * @throws IOException if the JSON string is invalid with respect to GetIssueCounts200ResponseResultsInner
   */
  public static GetIssueCounts200ResponseResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCounts200ResponseResultsInner.class);
  }

  /**
   * Convert an instance of GetIssueCounts200ResponseResultsInner to an JSON string
   *
   * @return JSON string
   */
