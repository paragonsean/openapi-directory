...
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraph;
...
public class GetProjectDependencyGraph200Response {
  public static final String SERIALIZED_NAME_DEP_GRAPH = "depGraph";
  @SerializedName(SERIALIZED_NAME_DEP_GRAPH)
  private GetProjectDependencyGraph200ResponseDepGraph depGraph;

  public GetProjectDependencyGraph200Response() {
  }

  public GetProjectDependencyGraph200Response depGraph(GetProjectDependencyGraph200ResponseDepGraph depGraph) {
  ...
  public GetProjectDependencyGraph200ResponseDepGraph getDepGraph() {
    return depGraph;
  }

  public void setDepGraph(GetProjectDependencyGraph200ResponseDepGraph depGraph) {
    this.depGraph = depGraph;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200Response getProjectDependencyGraph200Response = (GetProjectDependencyGraph200Response) o;
    return Objects.equals(this.depGraph, getProjectDependencyGraph200Response.depGraph);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectDependencyGraph200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200Response is not found in the empty JSON string", GetProjectDependencyGraph200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200Response.openapiRequiredFields) {
      ...
      GetProjectDependencyGraph200ResponseDepGraph.validateJsonElement(jsonObj.get("depGraph"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200Response>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200Response
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200Response
   */
  public static GetProjectDependencyGraph200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200Response.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200Response to an JSON string
   *
   * @return JSON string
   */
