...
import org.openapitools.client.model.GetIssueCountsRequestFilters;
...
public class GetIssueCountsRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetIssueCountsRequestFilters filters;

  public GetIssueCountsRequest() {
  }

  public GetIssueCountsRequest filters(GetIssueCountsRequestFilters filters) {
  ...
  public GetIssueCountsRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(GetIssueCountsRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCountsRequest getIssueCountsRequest = (GetIssueCountsRequest) o;
    return Objects.equals(this.filters, getIssueCountsRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIssueCountsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCountsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCountsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCountsRequest is not found in the empty JSON string", GetIssueCountsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCountsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCountsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        GetIssueCountsRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCountsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCountsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCountsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCountsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCountsRequest>() {
           @Override
           public void write(JsonWriter out, GetIssueCountsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCountsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCountsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCountsRequest
   * @throws IOException if the JSON string is invalid with respect to GetIssueCountsRequest
   */
  public static GetIssueCountsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCountsRequest.class);
  }

  /**
   * Convert an instance of GetIssueCountsRequest to an JSON string
   *
   * @return JSON string
   */
