...
import org.openapitools.client.model.UpdateOrganizationSettingsRequestRequestAccess;
...
public class OrgSettingsRequest {
  ...
  private UpdateOrganizationSettingsRequestRequestAccess requestAccess;

  public OrgSettingsRequest() {
  }

  public OrgSettingsRequest requestAccess(UpdateOrganizationSettingsRequestRequestAccess requestAccess) {
  ...
  public UpdateOrganizationSettingsRequestRequestAccess getRequestAccess() {
    return requestAccess;
  }

  public void setRequestAccess(UpdateOrganizationSettingsRequestRequestAccess requestAccess) {
    this.requestAccess = requestAccess;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrgSettingsRequest orgSettingsRequest = (OrgSettingsRequest) o;
    return Objects.equals(this.requestAccess, orgSettingsRequest.requestAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgSettingsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgSettingsRequest is not found in the empty JSON string", OrgSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrgSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `requestAccess`
      if (jsonObj.get("requestAccess") != null && !jsonObj.get("requestAccess").isJsonNull()) {
        UpdateOrganizationSettingsRequestRequestAccess.validateJsonElement(jsonObj.get("requestAccess"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgSettingsRequest>() {
           @Override
           public void write(JsonWriter out, OrgSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgSettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgSettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgSettingsRequest
   * @throws IOException if the JSON string is invalid with respect to OrgSettingsRequest
   */
  public static OrgSettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgSettingsRequest.class);
  }

  /**
   * Convert an instance of OrgSettingsRequest to an JSON string
   *
   * @return JSON string
   */
