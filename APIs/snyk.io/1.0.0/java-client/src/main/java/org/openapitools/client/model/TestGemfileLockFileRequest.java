...
public class TestGemfileLockFileRequest {
  /**
  ...
  public TestGemfileLockFileRequest() {
  }

  public TestGemfileLockFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestGemfileLockFileRequest files(TestGemfileLockFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestGemfileLockFileRequest testGemfileLockFileRequest = (TestGemfileLockFileRequest) o;
    return Objects.equals(this.encoding, testGemfileLockFileRequest.encoding) &&
        Objects.equals(this.files, testGemfileLockFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGemfileLockFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGemfileLockFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGemfileLockFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGemfileLockFileRequest is not found in the empty JSON string", TestGemfileLockFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGemfileLockFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGemfileLockFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestGemfileLockFileRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGemfileLockFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGemfileLockFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGemfileLockFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGemfileLockFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGemfileLockFileRequest>() {
           @Override
           public void write(JsonWriter out, TestGemfileLockFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGemfileLockFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGemfileLockFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGemfileLockFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestGemfileLockFileRequest
   */
  public static TestGemfileLockFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGemfileLockFileRequest.class);
  }

  /**
   * Convert an instance of TestGemfileLockFileRequest to an JSON string
   *
   * @return JSON string
   */
