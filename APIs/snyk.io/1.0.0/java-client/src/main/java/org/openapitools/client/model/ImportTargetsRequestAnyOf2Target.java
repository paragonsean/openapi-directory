...
public class ImportTargetsRequestAnyOf2Target {
  ...
  public ImportTargetsRequestAnyOf2Target() {
  }

  public ImportTargetsRequestAnyOf2Target name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf2Target owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf2Target importTargetsRequestAnyOf2Target = (ImportTargetsRequestAnyOf2Target) o;
    return Objects.equals(this.name, importTargetsRequestAnyOf2Target.name) &&
        Objects.equals(this.owner, importTargetsRequestAnyOf2Target.owner);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf2Target {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf2Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf2Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf2Target is not found in the empty JSON string", ImportTargetsRequestAnyOf2Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf2Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf2Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf2Target.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf2Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf2Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf2Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf2Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf2Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf2Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf2Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf2Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf2Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf2Target
   */
  public static ImportTargetsRequestAnyOf2Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf2Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf2Target to an JSON string
   *
   * @return JSON string
   */
