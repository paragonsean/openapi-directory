...
public class AddATagToAProject200Response {
  public static final String SERIALIZED_NAME_TAGS = "tags";
  @SerializedName(SERIALIZED_NAME_TAGS)
  private List<Object> tags = new ArrayList<>();

  public AddATagToAProject200Response() {
  }

  public AddATagToAProject200Response tags(List<Object> tags) {
    this.tags = tags;
    return this;
  }

  public AddATagToAProject200Response addTagsItem(Object tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    AddATagToAProject200Response addATagToAProject200Response = (AddATagToAProject200Response) o;
    return Objects.equals(this.tags, addATagToAProject200Response.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddATagToAProject200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddATagToAProject200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddATagToAProject200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddATagToAProject200Response is not found in the empty JSON string", AddATagToAProject200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddATagToAProject200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddATagToAProject200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddATagToAProject200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddATagToAProject200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddATagToAProject200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddATagToAProject200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddATagToAProject200Response>() {
           @Override
           public void write(JsonWriter out, AddATagToAProject200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddATagToAProject200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddATagToAProject200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddATagToAProject200Response
   * @throws IOException if the JSON string is invalid with respect to AddATagToAProject200Response
   */
  public static AddATagToAProject200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddATagToAProject200Response.class);
  }

  /**
   * Convert an instance of AddATagToAProject200Response to an JSON string
   *
   * @return JSON string
   */
