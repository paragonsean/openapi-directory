...
public class TestGopkgTomlGopkgLockFileRequestFilesTarget {
  public static final String SERIALIZED_NAME_CONTENTS = "contents";
  @SerializedName(SERIALIZED_NAME_CONTENTS)
  private String contents;

  public TestGopkgTomlGopkgLockFileRequestFilesTarget() {
  }

  public TestGopkgTomlGopkgLockFileRequestFilesTarget contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    TestGopkgTomlGopkgLockFileRequestFilesTarget testGopkgTomlGopkgLockFileRequestFilesTarget = (TestGopkgTomlGopkgLockFileRequestFilesTarget) o;
    return Objects.equals(this.contents, testGopkgTomlGopkgLockFileRequestFilesTarget.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGopkgTomlGopkgLockFileRequestFilesTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGopkgTomlGopkgLockFileRequestFilesTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGopkgTomlGopkgLockFileRequestFilesTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGopkgTomlGopkgLockFileRequestFilesTarget is not found in the empty JSON string", TestGopkgTomlGopkgLockFileRequestFilesTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGopkgTomlGopkgLockFileRequestFilesTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGopkgTomlGopkgLockFileRequestFilesTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGopkgTomlGopkgLockFileRequestFilesTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGopkgTomlGopkgLockFileRequestFilesTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGopkgTomlGopkgLockFileRequestFilesTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGopkgTomlGopkgLockFileRequestFilesTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGopkgTomlGopkgLockFileRequestFilesTarget>() {
           @Override
           public void write(JsonWriter out, TestGopkgTomlGopkgLockFileRequestFilesTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGopkgTomlGopkgLockFileRequestFilesTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGopkgTomlGopkgLockFileRequestFilesTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGopkgTomlGopkgLockFileRequestFilesTarget
   * @throws IOException if the JSON string is invalid with respect to TestGopkgTomlGopkgLockFileRequestFilesTarget
   */
  public static TestGopkgTomlGopkgLockFileRequestFilesTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGopkgTomlGopkgLockFileRequestFilesTarget.class);
  }

  /**
   * Convert an instance of TestGopkgTomlGopkgLockFileRequestFilesTarget to an JSON string
   *
   * @return JSON string
   */
