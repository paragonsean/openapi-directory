...
import org.openapitools.client.model.GetMyDetails200Response;
import org.openapitools.client.model.GetUserDetails200Response;
import org.openapitools.client.model.ModifyProjectNotificationSettingsRequest;
...
public class UsersApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 401 </td><td> &#x60;API_KEY&#x60; is invalid. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getMyDetailsCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getMyDetailsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getMyDetailsCall(_callback);
     ...
     * Get My Details
     * 
     * @return GetMyDetails200Response
     ...
     */
    public GetMyDetails200Response getMyDetails() throws ApiException {
        ApiResponse<GetMyDetails200Response> localVarResp = getMyDetailsWithHttpInfo();
     ...
     * Get My Details
     * 
     * @return ApiResponse&lt;GetMyDetails200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetMyDetails200Response> getMyDetailsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getMyDetailsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetMyDetails200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get My Details (asynchronously)
     * 
     ...
     */
    public okhttp3.Call getMyDetailsAsync(final ApiCallback<GetMyDetails200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMyDetailsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetMyDetails200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getOrganizationNotificationSettings
     ...
     */
    public okhttp3.Call getOrganizationNotificationSettingsCall(String orgId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/user/me/notification-settings/org/{orgId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrganizationNotificationSettingsValidateBeforeCall(String orgId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling getOrganizationNotificationSettings(Async)");
        }

        return getOrganizationNotificationSettingsCall(orgId, _callback);
     ...
     */
    public OrgOrgIdNotificationSettingsGet200Response getOrganizationNotificationSettings(String orgId) throws ApiException {
        ApiResponse<OrgOrgIdNotificationSettingsGet200Response> localVarResp = getOrganizationNotificationSettingsWithHttpInfo(orgId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OrgOrgIdNotificationSettingsGet200Response> getOrganizationNotificationSettingsWithHttpInfo(String orgId) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationNotificationSettingsValidateBeforeCall(orgId, null);
     ...
     */
    public okhttp3.Call getOrganizationNotificationSettingsAsync(String orgId, final ApiCallback<OrgOrgIdNotificationSettingsGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationNotificationSettingsValidateBeforeCall(orgId, _callback);
        Type localVarReturnType = new TypeToken<OrgOrgIdNotificationSettingsGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getProjectNotificationSettings
     * @param orgId The organization ID. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param projectId The project ID to return notification settings for. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getProjectNotificationSettingsCall(String orgId, String projectId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/user/me/notification-settings/org/{orgId}/project/{projectId}"
            .replace("{" + "orgId" + "}", localVarApiClient.escapeString(orgId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectNotificationSettingsValidateBeforeCall(String orgId, String projectId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling getProjectNotificationSettings(Async)");
        }

        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling getProjectNotificationSettings(Async)");
        }

        return getProjectNotificationSettingsCall(orgId, projectId, _callback);
     ...
     */
    public OrgOrgIdNotificationSettingsGet200Response getProjectNotificationSettings(String orgId, String projectId) throws ApiException {
        ApiResponse<OrgOrgIdNotificationSettingsGet200Response> localVarResp = getProjectNotificationSettingsWithHttpInfo(orgId, projectId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OrgOrgIdNotificationSettingsGet200Response> getProjectNotificationSettingsWithHttpInfo(String orgId, String projectId) throws ApiException {
        okhttp3.Call localVarCall = getProjectNotificationSettingsValidateBeforeCall(orgId, projectId, null);
        Type localVarReturnType = new TypeToken<OrgOrgIdNotificationSettingsGet200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get project notification settings (asynchronously)
     * 
     * @param orgId The organization ID. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param projectId The project ID to return notification settings for. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getProjectNotificationSettingsAsync(String orgId, String projectId, final ApiCallback<OrgOrgIdNotificationSettingsGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectNotificationSettingsValidateBeforeCall(orgId, projectId, _callback);
        Type localVarReturnType = new TypeToken<OrgOrgIdNotificationSettingsGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param userId The users ID. The &#x60;API_KEY&#x60; must have admin access to at least one group or organization where the requested user is a member and must have the &#x60;api&#x60; entitlement on their preferred organization. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The provided &#x60;id&#x60; is not in a valid format. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> &#x60;API_KEY&#x60; is invalid. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The requested user could not be found or caller does not have sufficient permissions. </td><td>  -  </td></tr>
     </table>
     */
    ...
    private okhttp3.Call getUserDetailsValidateBeforeCall(String userId, final ApiCallback _callback) throws ApiException {
        ...
        return getUserDetailsCall(userId, _callback);
     ...
     */
    public GetUserDetails200Response getUserDetails(String userId) throws ApiException {
        ApiResponse<GetUserDetails200Response> localVarResp = getUserDetailsWithHttpInfo(userId);
        return localVarResp.getData();
    }
     ...
     * 
     * @param userId The users ID. The &#x60;API_KEY&#x60; must have admin access to at least one group or organization where the requested user is a member and must have the &#x60;api&#x60; entitlement on their preferred organization. (required)
     * @return ApiResponse&lt;GetUserDetails200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetUserDetails200Response> getUserDetailsWithHttpInfo(String userId) throws ApiException {
        okhttp3.Call localVarCall = getUserDetailsValidateBeforeCall(userId, null);
        Type localVarReturnType = new TypeToken<GetUserDetails200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getUserDetailsAsync(String userId, final ApiCallback<GetUserDetails200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for modifyOrganizationNotificationSettings
     ...
     */
    public okhttp3.Call modifyOrganizationNotificationSettingsCall(String orgId, SetNotificationSettingsRequest setNotificationSettingsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call modifyOrganizationNotificationSettingsValidateBeforeCall(String orgId, SetNotificationSettingsRequest setNotificationSettingsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling modifyOrganizationNotificationSettings(Async)");
        }

        return modifyOrganizationNotificationSettingsCall(orgId, setNotificationSettingsRequest, _callback);
     ...
     */
    public OrgOrgIdNotificationSettingsGet200Response modifyOrganizationNotificationSettings(String orgId, SetNotificationSettingsRequest setNotificationSettingsRequest) throws ApiException {
        ApiResponse<OrgOrgIdNotificationSettingsGet200Response> localVarResp = modifyOrganizationNotificationSettingsWithHttpInfo(orgId, setNotificationSettingsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OrgOrgIdNotificationSettingsGet200Response> modifyOrganizationNotificationSettingsWithHttpInfo(String orgId, SetNotificationSettingsRequest setNotificationSettingsRequest) throws ApiException {
        okhttp3.Call localVarCall = modifyOrganizationNotificationSettingsValidateBeforeCall(orgId, setNotificationSettingsRequest, null);
        Type localVarReturnType = new TypeToken<OrgOrgIdNotificationSettingsGet200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Modify organization notification settings (asynchronously)
     * 
     * @param orgId Automatically added (required)
     * @param setNotificationSettingsRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call modifyOrganizationNotificationSettingsAsync(String orgId, SetNotificationSettingsRequest setNotificationSettingsRequest, final ApiCallback<OrgOrgIdNotificationSettingsGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = modifyOrganizationNotificationSettingsValidateBeforeCall(orgId, setNotificationSettingsRequest, _callback);
        Type localVarReturnType = new TypeToken<OrgOrgIdNotificationSettingsGet200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for modifyProjectNotificationSettings
     * @param orgId Automatically added (required)
     * @param projectId Automatically added (required)
     * @param modifyProjectNotificationSettingsRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call modifyProjectNotificationSettingsCall(String orgId, String projectId, ModifyProjectNotificationSettingsRequest modifyProjectNotificationSettingsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = modifyProjectNotificationSettingsRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call modifyProjectNotificationSettingsValidateBeforeCall(String orgId, String projectId, ModifyProjectNotificationSettingsRequest modifyProjectNotificationSettingsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling modifyProjectNotificationSettings(Async)");
        }

        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling modifyProjectNotificationSettings(Async)");
        }

        return modifyProjectNotificationSettingsCall(orgId, projectId, modifyProjectNotificationSettingsRequest, _callback);
     ...
     */
    public void modifyProjectNotificationSettings(String orgId, String projectId, ModifyProjectNotificationSettingsRequest modifyProjectNotificationSettingsRequest) throws ApiException {
        modifyProjectNotificationSettingsWithHttpInfo(orgId, projectId, modifyProjectNotificationSettingsRequest);
    }
     ...
     */
    public ApiResponse<Void> modifyProjectNotificationSettingsWithHttpInfo(String orgId, String projectId, ModifyProjectNotificationSettingsRequest modifyProjectNotificationSettingsRequest) throws ApiException {
        okhttp3.Call localVarCall = modifyProjectNotificationSettingsValidateBeforeCall(orgId, projectId, modifyProjectNotificationSettingsRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Modify project notification settings (asynchronously)
     * 
     * @param orgId Automatically added (required)
     * @param projectId Automatically added (required)
     * @param modifyProjectNotificationSettingsRequest  (optional)
     ...
     */
    public okhttp3.Call modifyProjectNotificationSettingsAsync(String orgId, String projectId, ModifyProjectNotificationSettingsRequest modifyProjectNotificationSettingsRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = modifyProjectNotificationSettingsValidateBeforeCall(orgId, projectId, modifyProjectNotificationSettingsRequest, _callback);
