...
import org.openapitools.client.model.ListAllAggregatedIssuesRequestFiltersPriorityScore;
...
public class ListAllAggregatedIssuesRequestFiltersPriority {
  public static final String SERIALIZED_NAME_SCORE = "score";
  @SerializedName(SERIALIZED_NAME_SCORE)
  private ListAllAggregatedIssuesRequestFiltersPriorityScore score;

  public ListAllAggregatedIssuesRequestFiltersPriority() {
  }

  public ListAllAggregatedIssuesRequestFiltersPriority score(ListAllAggregatedIssuesRequestFiltersPriorityScore score) {
    this.score = score;
    return this;
  }
  ...
  public ListAllAggregatedIssuesRequestFiltersPriorityScore getScore() {
    return score;
  }

  public void setScore(ListAllAggregatedIssuesRequestFiltersPriorityScore score) {
    this.score = score;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssuesRequestFiltersPriority listAllAggregatedIssuesRequestFiltersPriority = (ListAllAggregatedIssuesRequestFiltersPriority) o;
    return Objects.equals(this.score, listAllAggregatedIssuesRequestFiltersPriority.score);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllAggregatedIssuesRequestFiltersPriority {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssuesRequestFiltersPriority
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssuesRequestFiltersPriority.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssuesRequestFiltersPriority is not found in the empty JSON string", ListAllAggregatedIssuesRequestFiltersPriority.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssuesRequestFiltersPriority.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssuesRequestFiltersPriority` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `score`
      if (jsonObj.get("score") != null && !jsonObj.get("score").isJsonNull()) {
        ListAllAggregatedIssuesRequestFiltersPriorityScore.validateJsonElement(jsonObj.get("score"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssuesRequestFiltersPriority.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssuesRequestFiltersPriority' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssuesRequestFiltersPriority> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssuesRequestFiltersPriority.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssuesRequestFiltersPriority>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssuesRequestFiltersPriority value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssuesRequestFiltersPriority read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssuesRequestFiltersPriority given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssuesRequestFiltersPriority
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssuesRequestFiltersPriority
   */
  public static ListAllAggregatedIssuesRequestFiltersPriority fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssuesRequestFiltersPriority.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssuesRequestFiltersPriority to an JSON string
   *
   * @return JSON string
   */
