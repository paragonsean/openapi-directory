...
import org.openapitools.client.model.ListAllLicenses200ResponseResultsInnerDependenciesInner;
...
public class ListAllLicenses200ResponseResultsInner {
  public static final String SERIALIZED_NAME_DEPENDENCIES = "dependencies";
  @SerializedName(SERIALIZED_NAME_DEPENDENCIES)
  private List<ListAllLicenses200ResponseResultsInnerDependenciesInner> dependencies = new ArrayList<>();
  ...
  public ListAllLicenses200ResponseResultsInner() {
  }

  public ListAllLicenses200ResponseResultsInner dependencies(List<ListAllLicenses200ResponseResultsInnerDependenciesInner> dependencies) {
    this.dependencies = dependencies;
    return this;
  }

  public ListAllLicenses200ResponseResultsInner addDependenciesItem(ListAllLicenses200ResponseResultsInnerDependenciesInner dependenciesItem) {
  ...
  public List<ListAllLicenses200ResponseResultsInnerDependenciesInner> getDependencies() {
    return dependencies;
  }

  public void setDependencies(List<ListAllLicenses200ResponseResultsInnerDependenciesInner> dependencies) {
    this.dependencies = dependencies;
  }


  public ListAllLicenses200ResponseResultsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllLicenses200ResponseResultsInner instructions(String instructions) {
  ...
  public ListAllLicenses200ResponseResultsInner projects(List<ListAllDependencies200ResponseResultsInnerProjectsInner> projects) {
    this.projects = projects;
    return this;
  }

  public ListAllLicenses200ResponseResultsInner addProjectsItem(ListAllDependencies200ResponseResultsInnerProjectsInner projectsItem) {
  ...
  public ListAllLicenses200ResponseResultsInner severity(SeverityEnum severity) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllLicenses200ResponseResultsInner listAllLicenses200ResponseResultsInner = (ListAllLicenses200ResponseResultsInner) o;
    return Objects.equals(this.dependencies, listAllLicenses200ResponseResultsInner.dependencies) &&
        Objects.equals(this.id, listAllLicenses200ResponseResultsInner.id) &&
        Objects.equals(this.instructions, listAllLicenses200ResponseResultsInner.instructions) &&
        Objects.equals(this.projects, listAllLicenses200ResponseResultsInner.projects) &&
        Objects.equals(this.severity, listAllLicenses200ResponseResultsInner.severity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dependencies, id, instructions, projects, severity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllLicenses200ResponseResultsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllLicenses200ResponseResultsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllLicenses200ResponseResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllLicenses200ResponseResultsInner is not found in the empty JSON string", ListAllLicenses200ResponseResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllLicenses200ResponseResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllLicenses200ResponseResultsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllLicenses200ResponseResultsInner.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydependencies.size(); i++) {
        ListAllLicenses200ResponseResultsInnerDependenciesInner.validateJsonElement(jsonArraydependencies.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllLicenses200ResponseResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllLicenses200ResponseResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllLicenses200ResponseResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllLicenses200ResponseResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllLicenses200ResponseResultsInner>() {
           @Override
           public void write(JsonWriter out, ListAllLicenses200ResponseResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllLicenses200ResponseResultsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllLicenses200ResponseResultsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllLicenses200ResponseResultsInner
   * @throws IOException if the JSON string is invalid with respect to ListAllLicenses200ResponseResultsInner
   */
  public static ListAllLicenses200ResponseResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllLicenses200ResponseResultsInner.class);
  }

  /**
   * Convert an instance of ListAllLicenses200ResponseResultsInner to an JSON string
   *
   * @return JSON string
   */
