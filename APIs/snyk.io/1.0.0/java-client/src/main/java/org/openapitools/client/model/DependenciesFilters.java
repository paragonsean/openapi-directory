...
import org.openapitools.client.model.DependenciesFiltersFilters;
...
public class DependenciesFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private DependenciesFiltersFilters filters;

  public DependenciesFilters() {
  }

  public DependenciesFilters filters(DependenciesFiltersFilters filters) {
  ...
  public DependenciesFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(DependenciesFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    DependenciesFilters dependenciesFilters = (DependenciesFilters) o;
    return Objects.equals(this.filters, dependenciesFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class DependenciesFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DependenciesFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependenciesFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DependenciesFilters is not found in the empty JSON string", DependenciesFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DependenciesFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DependenciesFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        DependenciesFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependenciesFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependenciesFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependenciesFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependenciesFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<DependenciesFilters>() {
           @Override
           public void write(JsonWriter out, DependenciesFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DependenciesFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DependenciesFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DependenciesFilters
   * @throws IOException if the JSON string is invalid with respect to DependenciesFilters
   */
  public static DependenciesFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependenciesFilters.class);
  }

  /**
   * Convert an instance of DependenciesFilters to an JSON string
   *
   * @return JSON string
   */
