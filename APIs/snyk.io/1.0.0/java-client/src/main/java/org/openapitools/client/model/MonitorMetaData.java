...
public class MonitorMetaData {
  ...
  public MonitorMetaData targetFramework(String targetFramework) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorMetaData monitorMetaData = (MonitorMetaData) o;
    return Objects.equals(this.targetFramework, monitorMetaData.targetFramework);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorMetaData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorMetaData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorMetaData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorMetaData is not found in the empty JSON string", MonitorMetaData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorMetaData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorMetaData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorMetaData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorMetaData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorMetaData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorMetaData.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorMetaData>() {
           @Override
           public void write(JsonWriter out, MonitorMetaData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorMetaData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorMetaData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorMetaData
   * @throws IOException if the JSON string is invalid with respect to MonitorMetaData
   */
  public static MonitorMetaData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorMetaData.class);
  }

  /**
   * Convert an instance of MonitorMetaData to an JSON string
   *
   * @return JSON string
   */
