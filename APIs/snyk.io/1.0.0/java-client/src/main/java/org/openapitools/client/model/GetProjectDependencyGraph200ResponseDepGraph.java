...
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraphGraph;
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraphPkgManager;
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraphPkgsInner;
...
public class GetProjectDependencyGraph200ResponseDepGraph {
  public static final String SERIALIZED_NAME_GRAPH = "graph";
  @SerializedName(SERIALIZED_NAME_GRAPH)
  private GetProjectDependencyGraph200ResponseDepGraphGraph graph;

  public static final String SERIALIZED_NAME_PKG_MANAGER = "pkgManager";
  @SerializedName(SERIALIZED_NAME_PKG_MANAGER)
  private GetProjectDependencyGraph200ResponseDepGraphPkgManager pkgManager;

  public static final String SERIALIZED_NAME_PKGS = "pkgs";
  @SerializedName(SERIALIZED_NAME_PKGS)
  private List<GetProjectDependencyGraph200ResponseDepGraphPkgsInner> pkgs = new ArrayList<>();

  public static final String SERIALIZED_NAME_SCHEMA_VERSION = "schemaVersion";
  @SerializedName(SERIALIZED_NAME_SCHEMA_VERSION)
  private String schemaVersion;

  public GetProjectDependencyGraph200ResponseDepGraph() {
  }

  public GetProjectDependencyGraph200ResponseDepGraph graph(GetProjectDependencyGraph200ResponseDepGraphGraph graph) {
    this.graph = graph;
    return this;
  }
  ...
  public GetProjectDependencyGraph200ResponseDepGraphGraph getGraph() {
    return graph;
  }

  public void setGraph(GetProjectDependencyGraph200ResponseDepGraphGraph graph) {
    this.graph = graph;
  }


  public GetProjectDependencyGraph200ResponseDepGraph pkgManager(GetProjectDependencyGraph200ResponseDepGraphPkgManager pkgManager) {
   ...
   */
  @javax.annotation.Nonnull
  public GetProjectDependencyGraph200ResponseDepGraphPkgManager getPkgManager() {
    return pkgManager;
  }

  public void setPkgManager(GetProjectDependencyGraph200ResponseDepGraphPkgManager pkgManager) {
    this.pkgManager = pkgManager;
  }


  public GetProjectDependencyGraph200ResponseDepGraph pkgs(List<GetProjectDependencyGraph200ResponseDepGraphPkgsInner> pkgs) {
    this.pkgs = pkgs;
    return this;
  }

  public GetProjectDependencyGraph200ResponseDepGraph addPkgsItem(GetProjectDependencyGraph200ResponseDepGraphPkgsInner pkgsItem) {
    if (this.pkgs == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<GetProjectDependencyGraph200ResponseDepGraphPkgsInner> getPkgs() {
    return pkgs;
  }

  public void setPkgs(List<GetProjectDependencyGraph200ResponseDepGraphPkgsInner> pkgs) {
    this.pkgs = pkgs;
  }


  public GetProjectDependencyGraph200ResponseDepGraph schemaVersion(String schemaVersion) {
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraph getProjectDependencyGraph200ResponseDepGraph = (GetProjectDependencyGraph200ResponseDepGraph) o;
    return Objects.equals(this.graph, getProjectDependencyGraph200ResponseDepGraph.graph) &&
        Objects.equals(this.pkgManager, getProjectDependencyGraph200ResponseDepGraph.pkgManager) &&
        Objects.equals(this.pkgs, getProjectDependencyGraph200ResponseDepGraph.pkgs) &&
        Objects.equals(this.schemaVersion, getProjectDependencyGraph200ResponseDepGraph.schemaVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectDependencyGraph200ResponseDepGraph {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraph is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraph.openapiRequiredFields) {
      ...
      GetProjectDependencyGraph200ResponseDepGraphGraph.validateJsonElement(jsonObj.get("graph"));
      // validate the required field `pkgManager`
      GetProjectDependencyGraph200ResponseDepGraphPkgManager.validateJsonElement(jsonObj.get("pkgManager"));
      // ensure the json data is an array
      if (!jsonObj.get("pkgs").isJsonArray()) {
      ...
      JsonArray jsonArraypkgs = jsonObj.getAsJsonArray("pkgs");
      // validate the required field `pkgs` (array)
      for (int i = 0; i < jsonArraypkgs.size(); i++) {
        GetProjectDependencyGraph200ResponseDepGraphPkgsInner.validateJsonElement(jsonArraypkgs.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraph>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraph
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraph
   */
  public static GetProjectDependencyGraph200ResponseDepGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraph.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraph to an JSON string
   *
   * @return JSON string
   */
