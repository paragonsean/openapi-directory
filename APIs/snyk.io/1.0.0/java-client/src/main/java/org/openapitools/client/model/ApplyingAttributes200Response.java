...
import org.openapitools.client.model.ApplyingAttributes200ResponseAttributes;
...
public class ApplyingAttributes200Response {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private ApplyingAttributes200ResponseAttributes attributes;

  public ApplyingAttributes200Response() {
  }

  public ApplyingAttributes200Response attributes(ApplyingAttributes200ResponseAttributes attributes) {
  ...
  public ApplyingAttributes200ResponseAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(ApplyingAttributes200ResponseAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApplyingAttributes200Response applyingAttributes200Response = (ApplyingAttributes200Response) o;
    return Objects.equals(this.attributes, applyingAttributes200Response.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplyingAttributes200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplyingAttributes200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplyingAttributes200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplyingAttributes200Response is not found in the empty JSON string", ApplyingAttributes200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplyingAttributes200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplyingAttributes200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        ApplyingAttributes200ResponseAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplyingAttributes200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplyingAttributes200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplyingAttributes200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplyingAttributes200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplyingAttributes200Response>() {
           @Override
           public void write(JsonWriter out, ApplyingAttributes200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplyingAttributes200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplyingAttributes200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplyingAttributes200Response
   * @throws IOException if the JSON string is invalid with respect to ApplyingAttributes200Response
   */
  public static ApplyingAttributes200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplyingAttributes200Response.class);
  }

  /**
   * Convert an instance of ApplyingAttributes200Response to an JSON string
   *
   * @return JSON string
   */
