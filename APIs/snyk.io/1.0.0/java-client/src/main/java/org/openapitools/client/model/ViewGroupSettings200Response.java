...
import org.openapitools.client.model.ViewGroupSettings200ResponseRequestAccess;
...
public class ViewGroupSettings200Response {
  public static final String SERIALIZED_NAME_REQUEST_ACCESS = "requestAccess";
  @SerializedName(SERIALIZED_NAME_REQUEST_ACCESS)
  private ViewGroupSettings200ResponseRequestAccess requestAccess;

  public static final String SERIALIZED_NAME_SESSION_LENGTH = "sessionLength";
  @SerializedName(SERIALIZED_NAME_SESSION_LENGTH)
  private BigDecimal sessionLength;

  public ViewGroupSettings200Response() {
  }

  public ViewGroupSettings200Response requestAccess(ViewGroupSettings200ResponseRequestAccess requestAccess) {
  ...
  public ViewGroupSettings200ResponseRequestAccess getRequestAccess() {
    return requestAccess;
  }

  public void setRequestAccess(ViewGroupSettings200ResponseRequestAccess requestAccess) {
    this.requestAccess = requestAccess;
  }


  public ViewGroupSettings200Response sessionLength(BigDecimal sessionLength) {
  ...
  public void setSessionLength(BigDecimal sessionLength) {
    this.sessionLength = sessionLength;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewGroupSettings200Response viewGroupSettings200Response = (ViewGroupSettings200Response) o;
    return Objects.equals(this.requestAccess, viewGroupSettings200Response.requestAccess) &&
        Objects.equals(this.sessionLength, viewGroupSettings200Response.sessionLength);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestAccess, sessionLength);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewGroupSettings200Response {\n");
  ...
  static {
    ...
    openapiFields.add("sessionLength");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewGroupSettings200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewGroupSettings200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewGroupSettings200Response is not found in the empty JSON string", ViewGroupSettings200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewGroupSettings200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewGroupSettings200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `requestAccess`
      if (jsonObj.get("requestAccess") != null && !jsonObj.get("requestAccess").isJsonNull()) {
        ViewGroupSettings200ResponseRequestAccess.validateJsonElement(jsonObj.get("requestAccess"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewGroupSettings200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewGroupSettings200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewGroupSettings200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewGroupSettings200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewGroupSettings200Response>() {
           @Override
           public void write(JsonWriter out, ViewGroupSettings200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewGroupSettings200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewGroupSettings200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewGroupSettings200Response
   * @throws IOException if the JSON string is invalid with respect to ViewGroupSettings200Response
   */
  public static ViewGroupSettings200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewGroupSettings200Response.class);
  }

  /**
   * Convert an instance of ViewGroupSettings200Response to an JSON string
   *
   * @return JSON string
   */
