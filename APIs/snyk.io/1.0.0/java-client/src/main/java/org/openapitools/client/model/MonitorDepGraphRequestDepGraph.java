...
import org.openapitools.client.model.MonitorDepGraphRequestDepGraphGraph;
import org.openapitools.client.model.MonitorDepGraphRequestDepGraphPkgManager;
...
public class MonitorDepGraphRequestDepGraph {
  ...
  public MonitorDepGraphRequestDepGraph() {
  }

  public MonitorDepGraphRequestDepGraph graph(MonitorDepGraphRequestDepGraphGraph graph) {
    this.graph = graph;
    return this;
  }
  ...
  public MonitorDepGraphRequestDepGraphGraph getGraph() {
    return graph;
  }

  public void setGraph(MonitorDepGraphRequestDepGraphGraph graph) {
    this.graph = graph;
  }


  public MonitorDepGraphRequestDepGraph pkgManager(MonitorDepGraphRequestDepGraphPkgManager pkgManager) {
   ...
   */
  @javax.annotation.Nonnull
  public MonitorDepGraphRequestDepGraphPkgManager getPkgManager() {
    return pkgManager;
  }

  public void setPkgManager(MonitorDepGraphRequestDepGraphPkgManager pkgManager) {
    this.pkgManager = pkgManager;
  }


  public MonitorDepGraphRequestDepGraph pkgs(List<Object> pkgs) {
    this.pkgs = pkgs;
    return this;
  }

  public MonitorDepGraphRequestDepGraph addPkgsItem(Object pkgsItem) {
    if (this.pkgs == null) {
  ...
  public MonitorDepGraphRequestDepGraph schemaVersion(String schemaVersion) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorDepGraphRequestDepGraph monitorDepGraphRequestDepGraph = (MonitorDepGraphRequestDepGraph) o;
    return Objects.equals(this.graph, monitorDepGraphRequestDepGraph.graph) &&
        Objects.equals(this.pkgManager, monitorDepGraphRequestDepGraph.pkgManager) &&
        Objects.equals(this.pkgs, monitorDepGraphRequestDepGraph.pkgs) &&
        Objects.equals(this.schemaVersion, monitorDepGraphRequestDepGraph.schemaVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorDepGraphRequestDepGraph {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorDepGraphRequestDepGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorDepGraphRequestDepGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorDepGraphRequestDepGraph is not found in the empty JSON string", MonitorDepGraphRequestDepGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorDepGraphRequestDepGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorDepGraphRequestDepGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorDepGraphRequestDepGraph.openapiRequiredFields) {
      ...
      MonitorDepGraphRequestDepGraphGraph.validateJsonElement(jsonObj.get("graph"));
      // validate the required field `pkgManager`
      MonitorDepGraphRequestDepGraphPkgManager.validateJsonElement(jsonObj.get("pkgManager"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorDepGraphRequestDepGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorDepGraphRequestDepGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorDepGraphRequestDepGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorDepGraphRequestDepGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorDepGraphRequestDepGraph>() {
           @Override
           public void write(JsonWriter out, MonitorDepGraphRequestDepGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorDepGraphRequestDepGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorDepGraphRequestDepGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorDepGraphRequestDepGraph
   * @throws IOException if the JSON string is invalid with respect to MonitorDepGraphRequestDepGraph
   */
  public static MonitorDepGraphRequestDepGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorDepGraphRequestDepGraph.class);
  }

  /**
   * Convert an instance of MonitorDepGraphRequestDepGraph to an JSON string
   *
   * @return JSON string
   */
