...
import org.openapitools.client.model.TestsFiltersFilters;
...
public class TestsFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private TestsFiltersFilters filters;

  public TestsFilters() {
  }

  public TestsFilters filters(TestsFiltersFilters filters) {
  ...
  public TestsFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(TestsFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestsFilters testsFilters = (TestsFilters) o;
    return Objects.equals(this.filters, testsFilters.filters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestsFilters is not found in the empty JSON string", TestsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        TestsFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<TestsFilters>() {
           @Override
           public void write(JsonWriter out, TestsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestsFilters
   * @throws IOException if the JSON string is invalid with respect to TestsFilters
   */
  public static TestsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestsFilters.class);
  }

  /**
   * Convert an instance of TestsFilters to an JSON string
   *
   * @return JSON string
   */
