...
public class RetrieveASingleProject200ResponseImportingUser {
  ...
  public RetrieveASingleProject200ResponseImportingUser() {
  }

  public RetrieveASingleProject200ResponseImportingUser email(String email) {
    this.email = email;
    return this;
  }
  ...
  public RetrieveASingleProject200ResponseImportingUser id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RetrieveASingleProject200ResponseImportingUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RetrieveASingleProject200ResponseImportingUser username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    RetrieveASingleProject200ResponseImportingUser retrieveASingleProject200ResponseImportingUser = (RetrieveASingleProject200ResponseImportingUser) o;
    return Objects.equals(this.email, retrieveASingleProject200ResponseImportingUser.email) &&
        Objects.equals(this.id, retrieveASingleProject200ResponseImportingUser.id) &&
        Objects.equals(this.name, retrieveASingleProject200ResponseImportingUser.name) &&
        Objects.equals(this.username, retrieveASingleProject200ResponseImportingUser.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveASingleProject200ResponseImportingUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveASingleProject200ResponseImportingUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveASingleProject200ResponseImportingUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveASingleProject200ResponseImportingUser is not found in the empty JSON string", RetrieveASingleProject200ResponseImportingUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveASingleProject200ResponseImportingUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveASingleProject200ResponseImportingUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveASingleProject200ResponseImportingUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveASingleProject200ResponseImportingUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveASingleProject200ResponseImportingUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveASingleProject200ResponseImportingUser.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveASingleProject200ResponseImportingUser>() {
           @Override
           public void write(JsonWriter out, RetrieveASingleProject200ResponseImportingUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveASingleProject200ResponseImportingUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveASingleProject200ResponseImportingUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveASingleProject200ResponseImportingUser
   * @throws IOException if the JSON string is invalid with respect to RetrieveASingleProject200ResponseImportingUser
   */
  public static RetrieveASingleProject200ResponseImportingUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveASingleProject200ResponseImportingUser.class);
  }

  /**
   * Convert an instance of RetrieveASingleProject200ResponseImportingUser to an JSON string
   *
   * @return JSON string
   */
