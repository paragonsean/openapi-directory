...
public class YarnRequestPayload {
  /**
  ...
  public YarnRequestPayload() {
  }

  public YarnRequestPayload encoding(EncodingEnum encoding) {
  ...
  public YarnRequestPayload files(TestPackageJsonPackageLockJsonFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    YarnRequestPayload yarnRequestPayload = (YarnRequestPayload) o;
    return Objects.equals(this.encoding, yarnRequestPayload.encoding) &&
        Objects.equals(this.files, yarnRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class YarnRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to YarnRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!YarnRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in YarnRequestPayload is not found in the empty JSON string", YarnRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!YarnRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `YarnRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : YarnRequestPayload.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!YarnRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'YarnRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<YarnRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(YarnRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<YarnRequestPayload>() {
           @Override
           public void write(JsonWriter out, YarnRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public YarnRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of YarnRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of YarnRequestPayload
   * @throws IOException if the JSON string is invalid with respect to YarnRequestPayload
   */
  public static YarnRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, YarnRequestPayload.class);
  }

  /**
   * Convert an instance of YarnRequestPayload to an JSON string
   *
   * @return JSON string
   */
