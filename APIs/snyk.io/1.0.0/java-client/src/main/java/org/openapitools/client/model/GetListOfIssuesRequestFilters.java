...
import org.openapitools.client.model.GetIssueCountsRequestFiltersPriorityScore;
...
public class GetListOfIssuesRequestFilters {
  ...
  private List<Object> exploitMaturity = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_PATCHED = "patched";
  @SerializedName(SERIALIZED_NAME_PATCHED)
  private Boolean patched;

  public static final String SERIALIZED_NAME_PRIORITY_SCORE = "priorityScore";
  @SerializedName(SERIALIZED_NAME_PRIORITY_SCORE)
  private GetIssueCountsRequestFiltersPriorityScore priorityScore;
  ...
  public GetListOfIssuesRequestFilters() {
  }

  public GetListOfIssuesRequestFilters exploitMaturity(List<Object> exploitMaturity) {
    this.exploitMaturity = exploitMaturity;
    return this;
  }

  public GetListOfIssuesRequestFilters addExploitMaturityItem(Object exploitMaturityItem) {
    if (this.exploitMaturity == null) {
      this.exploitMaturity = new ArrayList<>();
    }
    this.exploitMaturity.add(exploitMaturityItem);
    return this;
  }
  ...
  public List<Object> getExploitMaturity() {
    return exploitMaturity;
  }

  public void setExploitMaturity(List<Object> exploitMaturity) {
    this.exploitMaturity = exploitMaturity;
  }


  public GetListOfIssuesRequestFilters fixable(Boolean fixable) {
  ...
  public GetListOfIssuesRequestFilters identifier(String identifier) {
  ...
  public GetListOfIssuesRequestFilters ignored(Boolean ignored) {
  ...
  public GetListOfIssuesRequestFilters isFixed(Boolean isFixed) {
  ...
  public GetListOfIssuesRequestFilters isPatchable(Boolean isPatchable) {
  ...
  public GetListOfIssuesRequestFilters isPinnable(Boolean isPinnable) {
  ...
  public GetListOfIssuesRequestFilters isUpgradable(Boolean isUpgradable) {
  ...
  public GetListOfIssuesRequestFilters issues(Object issues) {
    this.issues = issues;
    return this;
  }
  ...
  public GetListOfIssuesRequestFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public GetListOfIssuesRequestFilters addLanguagesItem(Object languagesItem) {
  ...
  public GetListOfIssuesRequestFilters orgs(Object orgs) {
    this.orgs = orgs;
    return this;
  }
  ...
  public void setOrgs(Object orgs) {
    this.orgs = orgs;
  }


  public GetListOfIssuesRequestFilters patched(Boolean patched) {
  ...
  public GetListOfIssuesRequestFilters priorityScore(GetIssueCountsRequestFiltersPriorityScore priorityScore) {
   ...
   */
  @javax.annotation.Nullable
  public GetIssueCountsRequestFiltersPriorityScore getPriorityScore() {
    return priorityScore;
  }

  public void setPriorityScore(GetIssueCountsRequestFiltersPriorityScore priorityScore) {
    this.priorityScore = priorityScore;
  }


  public GetListOfIssuesRequestFilters projects(Object projects) {
  ...
  public GetListOfIssuesRequestFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public GetListOfIssuesRequestFilters addSeverityItem(Object severityItem) {
  ...
  public GetListOfIssuesRequestFilters types(List<Object> types) {
    this.types = types;
    return this;
  }

  public GetListOfIssuesRequestFilters addTypesItem(Object typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetListOfIssuesRequestFilters getListOfIssuesRequestFilters = (GetListOfIssuesRequestFilters) o;
    return Objects.equals(this.exploitMaturity, getListOfIssuesRequestFilters.exploitMaturity) &&
        Objects.equals(this.fixable, getListOfIssuesRequestFilters.fixable) &&
        Objects.equals(this.identifier, getListOfIssuesRequestFilters.identifier) &&
        Objects.equals(this.ignored, getListOfIssuesRequestFilters.ignored) &&
        Objects.equals(this.isFixed, getListOfIssuesRequestFilters.isFixed) &&
        Objects.equals(this.isPatchable, getListOfIssuesRequestFilters.isPatchable) &&
        Objects.equals(this.isPinnable, getListOfIssuesRequestFilters.isPinnable) &&
        Objects.equals(this.isUpgradable, getListOfIssuesRequestFilters.isUpgradable) &&
        Objects.equals(this.issues, getListOfIssuesRequestFilters.issues) &&
        Objects.equals(this.languages, getListOfIssuesRequestFilters.languages) &&
        Objects.equals(this.orgs, getListOfIssuesRequestFilters.orgs) &&
        Objects.equals(this.patched, getListOfIssuesRequestFilters.patched) &&
        Objects.equals(this.priorityScore, getListOfIssuesRequestFilters.priorityScore) &&
        Objects.equals(this.projects, getListOfIssuesRequestFilters.projects) &&
        Objects.equals(this.severity, getListOfIssuesRequestFilters.severity) &&
        Objects.equals(this.types, getListOfIssuesRequestFilters.types);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(exploitMaturity, fixable, identifier, ignored, isFixed, isPatchable, isPinnable, isUpgradable, issues, languages, orgs, patched, priorityScore, projects, severity, types);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetListOfIssuesRequestFilters {\n");
    ...
    sb.append("    patched: ").append(toIndentedString(patched)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetListOfIssuesRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetListOfIssuesRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListOfIssuesRequestFilters is not found in the empty JSON string", GetListOfIssuesRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetListOfIssuesRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetListOfIssuesRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetListOfIssuesRequestFilters.openapiRequiredFields) {
      ...
      if (jsonObj.get("exploitMaturity") != null && !jsonObj.get("exploitMaturity").isJsonNull() && !jsonObj.get("exploitMaturity").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `exploitMaturity` to be an array in the JSON string but got `%s`", jsonObj.get("exploitMaturity").toString()));
      }
      ...
      if (jsonObj.get("priorityScore") != null && !jsonObj.get("priorityScore").isJsonNull()) {
        GetIssueCountsRequestFiltersPriorityScore.validateJsonElement(jsonObj.get("priorityScore"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListOfIssuesRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListOfIssuesRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListOfIssuesRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssuesRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListOfIssuesRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetListOfIssuesRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetListOfIssuesRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetListOfIssuesRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetListOfIssuesRequestFilters
   * @throws IOException if the JSON string is invalid with respect to GetListOfIssuesRequestFilters
   */
  public static GetListOfIssuesRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListOfIssuesRequestFilters.class);
  }

  /**
   * Convert an instance of GetListOfIssuesRequestFilters to an JSON string
   *
   * @return JSON string
   */
