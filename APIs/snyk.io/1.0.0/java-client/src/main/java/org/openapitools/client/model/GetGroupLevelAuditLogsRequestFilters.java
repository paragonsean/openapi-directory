...
public class GetGroupLevelAuditLogsRequestFilters {
   ...
   */
  @JsonAdapter(ExcludeEventEnum.Adapter.class)
  public enum ExcludeEventEnum {
    API_ACCESS("api.access"),
    ...
    public static ExcludeEventEnum fromValue(String value) {
      for (ExcludeEventEnum b : ExcludeEventEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ExcludeEventEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ExcludeEventEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ExcludeEventEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ExcludeEventEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ExcludeEventEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_EXCLUDE_EVENT = "excludeEvent";
  @SerializedName(SERIALIZED_NAME_EXCLUDE_EVENT)
  private ExcludeEventEnum excludeEvent;
  ...
  public GetGroupLevelAuditLogsRequestFilters() {
  }

  public GetGroupLevelAuditLogsRequestFilters email(String email) {
    this.email = email;
    return this;
  }
  ...
  public GetGroupLevelAuditLogsRequestFilters event(EventEnum event) {
    this.event = event;
    return this;
  }
  ...
  public GetGroupLevelAuditLogsRequestFilters excludeEvent(ExcludeEventEnum excludeEvent) {
   ...
   */
  @javax.annotation.Nullable
  public ExcludeEventEnum getExcludeEvent() {
    return excludeEvent;
  }

  public void setExcludeEvent(ExcludeEventEnum excludeEvent) {
    this.excludeEvent = excludeEvent;
  }


  public GetGroupLevelAuditLogsRequestFilters projectId(String projectId) {
  ...
  public GetGroupLevelAuditLogsRequestFilters userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetGroupLevelAuditLogsRequestFilters getGroupLevelAuditLogsRequestFilters = (GetGroupLevelAuditLogsRequestFilters) o;
    return Objects.equals(this.email, getGroupLevelAuditLogsRequestFilters.email) &&
        Objects.equals(this.event, getGroupLevelAuditLogsRequestFilters.event) &&
        Objects.equals(this.excludeEvent, getGroupLevelAuditLogsRequestFilters.excludeEvent) &&
        Objects.equals(this.projectId, getGroupLevelAuditLogsRequestFilters.projectId) &&
        Objects.equals(this.userId, getGroupLevelAuditLogsRequestFilters.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, event, excludeEvent, projectId, userId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetGroupLevelAuditLogsRequestFilters {\n");
    sb.append("    email: ").append(toIndentedString(email)).append("\n");
    sb.append("    event: ").append(toIndentedString(event)).append("\n");
    sb.append("    excludeEvent: ").append(toIndentedString(excludeEvent)).append("\n");
  ...
  static {
    ...
    openapiFields.add("excludeEvent");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetGroupLevelAuditLogsRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetGroupLevelAuditLogsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetGroupLevelAuditLogsRequestFilters is not found in the empty JSON string", GetGroupLevelAuditLogsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetGroupLevelAuditLogsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetGroupLevelAuditLogsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("excludeEvent") != null && !jsonObj.get("excludeEvent").isJsonNull()) && !jsonObj.get("excludeEvent").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `excludeEvent` to be a primitive type in the JSON string but got `%s`", jsonObj.get("excludeEvent").toString()));
      }
      // validate the optional field `excludeEvent`
      if (jsonObj.get("excludeEvent") != null && !jsonObj.get("excludeEvent").isJsonNull()) {
        ExcludeEventEnum.validateJsonElement(jsonObj.get("excludeEvent"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetGroupLevelAuditLogsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetGroupLevelAuditLogsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetGroupLevelAuditLogsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetGroupLevelAuditLogsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetGroupLevelAuditLogsRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetGroupLevelAuditLogsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetGroupLevelAuditLogsRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetGroupLevelAuditLogsRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetGroupLevelAuditLogsRequestFilters
   * @throws IOException if the JSON string is invalid with respect to GetGroupLevelAuditLogsRequestFilters
   */
  public static GetGroupLevelAuditLogsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetGroupLevelAuditLogsRequestFilters.class);
  }

  /**
   * Convert an instance of GetGroupLevelAuditLogsRequestFilters to an JSON string
   *
   * @return JSON string
   */
