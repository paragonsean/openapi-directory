...
public class AddMemberBody {
  ...
  public AddMemberBody() {
  }

  public AddMemberBody role(String role) {
    this.role = role;
    return this;
  }
  ...
  public AddMemberBody userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddMemberBody addMemberBody = (AddMemberBody) o;
    return Objects.equals(this.role, addMemberBody.role) &&
        Objects.equals(this.userId, addMemberBody.userId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddMemberBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddMemberBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddMemberBody is not found in the empty JSON string", AddMemberBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddMemberBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddMemberBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddMemberBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddMemberBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddMemberBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddMemberBody.class));

       return (TypeAdapter<T>) new TypeAdapter<AddMemberBody>() {
           @Override
           public void write(JsonWriter out, AddMemberBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddMemberBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddMemberBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddMemberBody
   * @throws IOException if the JSON string is invalid with respect to AddMemberBody
   */
  public static AddMemberBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddMemberBody.class);
  }

  /**
   * Convert an instance of AddMemberBody to an JSON string
   *
   * @return JSON string
   */
