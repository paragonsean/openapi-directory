...
import org.openapitools.client.model.TestPackageJsonPackageLockJsonFileRequestFilesTarget;
...
public class TestPackageJsonPackageLockJsonFileRequestFiles {
  public static final String SERIALIZED_NAME_ADDITIONAL = "additional";
  @SerializedName(SERIALIZED_NAME_ADDITIONAL)
  private List<Object> additional = new ArrayList<>();

  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private TestPackageJsonPackageLockJsonFileRequestFilesTarget target;

  public TestPackageJsonPackageLockJsonFileRequestFiles() {
  }

  public TestPackageJsonPackageLockJsonFileRequestFiles additional(List<Object> additional) {
    this.additional = additional;
    return this;
  }

  public TestPackageJsonPackageLockJsonFileRequestFiles addAdditionalItem(Object additionalItem) {
  ...
  public TestPackageJsonPackageLockJsonFileRequestFiles target(TestPackageJsonPackageLockJsonFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
  ...
  public TestPackageJsonPackageLockJsonFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestPackageJsonPackageLockJsonFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestPackageJsonPackageLockJsonFileRequestFiles testPackageJsonPackageLockJsonFileRequestFiles = (TestPackageJsonPackageLockJsonFileRequestFiles) o;
    return Objects.equals(this.additional, testPackageJsonPackageLockJsonFileRequestFiles.additional) &&
        Objects.equals(this.target, testPackageJsonPackageLockJsonFileRequestFiles.target);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additional, target);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestPackageJsonPackageLockJsonFileRequestFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestPackageJsonPackageLockJsonFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestPackageJsonPackageLockJsonFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestPackageJsonPackageLockJsonFileRequestFiles is not found in the empty JSON string", TestPackageJsonPackageLockJsonFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestPackageJsonPackageLockJsonFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestPackageJsonPackageLockJsonFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestPackageJsonPackageLockJsonFileRequestFiles.openapiRequiredFields) {
      ...
      TestPackageJsonPackageLockJsonFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestPackageJsonPackageLockJsonFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestPackageJsonPackageLockJsonFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestPackageJsonPackageLockJsonFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestPackageJsonPackageLockJsonFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestPackageJsonPackageLockJsonFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestPackageJsonPackageLockJsonFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestPackageJsonPackageLockJsonFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestPackageJsonPackageLockJsonFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestPackageJsonPackageLockJsonFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestPackageJsonPackageLockJsonFileRequestFiles
   */
  public static TestPackageJsonPackageLockJsonFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestPackageJsonPackageLockJsonFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestPackageJsonPackageLockJsonFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
