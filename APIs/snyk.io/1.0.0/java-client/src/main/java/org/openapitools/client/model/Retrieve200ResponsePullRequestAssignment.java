...
public class Retrieve200ResponsePullRequestAssignment {
  ...
  public Retrieve200ResponsePullRequestAssignment() {
  }

  public Retrieve200ResponsePullRequestAssignment assignees(List<Object> assignees) {
    this.assignees = assignees;
    return this;
  }

  public Retrieve200ResponsePullRequestAssignment addAssigneesItem(Object assigneesItem) {
  ...
  public Retrieve200ResponsePullRequestAssignment enabled(Boolean enabled) {
  ...
  public Retrieve200ResponsePullRequestAssignment type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Retrieve200ResponsePullRequestAssignment retrieve200ResponsePullRequestAssignment = (Retrieve200ResponsePullRequestAssignment) o;
    return Objects.equals(this.assignees, retrieve200ResponsePullRequestAssignment.assignees) &&
        Objects.equals(this.enabled, retrieve200ResponsePullRequestAssignment.enabled) &&
        Objects.equals(this.type, retrieve200ResponsePullRequestAssignment.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assignees, enabled, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Retrieve200ResponsePullRequestAssignment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Retrieve200ResponsePullRequestAssignment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Retrieve200ResponsePullRequestAssignment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Retrieve200ResponsePullRequestAssignment is not found in the empty JSON string", Retrieve200ResponsePullRequestAssignment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Retrieve200ResponsePullRequestAssignment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Retrieve200ResponsePullRequestAssignment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Retrieve200ResponsePullRequestAssignment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Retrieve200ResponsePullRequestAssignment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Retrieve200ResponsePullRequestAssignment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Retrieve200ResponsePullRequestAssignment.class));

       return (TypeAdapter<T>) new TypeAdapter<Retrieve200ResponsePullRequestAssignment>() {
           @Override
           public void write(JsonWriter out, Retrieve200ResponsePullRequestAssignment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Retrieve200ResponsePullRequestAssignment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Retrieve200ResponsePullRequestAssignment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Retrieve200ResponsePullRequestAssignment
   * @throws IOException if the JSON string is invalid with respect to Retrieve200ResponsePullRequestAssignment
   */
  public static Retrieve200ResponsePullRequestAssignment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Retrieve200ResponsePullRequestAssignment.class);
  }

  /**
   * Convert an instance of Retrieve200ResponsePullRequestAssignment to an JSON string
   *
   * @return JSON string
   */
