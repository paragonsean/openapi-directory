...
import org.openapitools.client.model.ListAllProjects200ResponseOrg;
import org.openapitools.client.model.ProjectWithoutRemediation;
...
public class ListAllProjects {
  ...
  private ListAllProjects200ResponseOrg org;

  public static final String SERIALIZED_NAME_PROJECTS = "projects";
  @SerializedName(SERIALIZED_NAME_PROJECTS)
  private List<ProjectWithoutRemediation> projects = new ArrayList<>();

  public ListAllProjects() {
  }

  public ListAllProjects org(ListAllProjects200ResponseOrg org) {
    this.org = org;
    return this;
  }
  ...
  public ListAllProjects200ResponseOrg getOrg() {
    return org;
  }

  public void setOrg(ListAllProjects200ResponseOrg org) {
    this.org = org;
  }


  public ListAllProjects projects(List<ProjectWithoutRemediation> projects) {
    this.projects = projects;
    return this;
  }

  public ListAllProjects addProjectsItem(ProjectWithoutRemediation projectsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProjectWithoutRemediation> getProjects() {
    return projects;
  }

  public void setProjects(List<ProjectWithoutRemediation> projects) {
    this.projects = projects;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjects listAllProjects = (ListAllProjects) o;
    return Objects.equals(this.org, listAllProjects.org) &&
        Objects.equals(this.projects, listAllProjects.projects);
  }

  @Override
  public int hashCode() {
    return Objects.hash(org, projects);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllProjects {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjects
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjects is not found in the empty JSON string", ListAllProjects.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjects.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjects` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `org`
      if (jsonObj.get("org") != null && !jsonObj.get("org").isJsonNull()) {
        ListAllProjects200ResponseOrg.validateJsonElement(jsonObj.get("org"));
      }
      if (jsonObj.get("projects") != null && !jsonObj.get("projects").isJsonNull()) {
        ...
        if (jsonArrayprojects != null) {
          ...
          for (int i = 0; i < jsonArrayprojects.size(); i++) {
            ProjectWithoutRemediation.validateJsonElement(jsonArrayprojects.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjects.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjects' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjects> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjects.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjects>() {
           @Override
           public void write(JsonWriter out, ListAllProjects value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjects read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjects given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjects
   * @throws IOException if the JSON string is invalid with respect to ListAllProjects
   */
  public static ListAllProjects fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjects.class);
  }

  /**
   * Convert an instance of ListAllProjects to an JSON string
   *
   * @return JSON string
   */
