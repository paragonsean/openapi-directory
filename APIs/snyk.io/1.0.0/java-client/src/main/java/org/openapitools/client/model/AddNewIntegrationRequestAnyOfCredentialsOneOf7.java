...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf7EcrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf7 {
  public static final String SERIALIZED_NAME_ECR_CREDENTIALS = "EcrCredentials";
  @SerializedName(SERIALIZED_NAME_ECR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf7EcrCredentials ecrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf7() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf7 ecrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf7EcrCredentials ecrCredentials) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf7EcrCredentials getEcrCredentials() {
    return ecrCredentials;
  }

  public void setEcrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf7EcrCredentials ecrCredentials) {
    this.ecrCredentials = ecrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf7 addNewIntegrationRequestAnyOfCredentialsOneOf7 = (AddNewIntegrationRequestAnyOfCredentialsOneOf7) o;
    return Objects.equals(this.ecrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf7.ecrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ecrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf7 {\n");
    sb.append("    ecrCredentials: ").append(toIndentedString(ecrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("EcrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf7
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf7.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf7 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf7.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf7` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `EcrCredentials`
      if (jsonObj.get("EcrCredentials") != null && !jsonObj.get("EcrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf7EcrCredentials.validateJsonElement(jsonObj.get("EcrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf7.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf7>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf7 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf7 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf7 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf7
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf7
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf7.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf7 to an JSON string
   *
   * @return JSON string
   */
