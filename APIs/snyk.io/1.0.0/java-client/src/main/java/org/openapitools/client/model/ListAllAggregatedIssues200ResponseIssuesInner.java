...
import org.openapitools.client.model.ListAllAggregatedIssues200ResponseIssuesInnerIssueData;
...
public class ListAllAggregatedIssues200ResponseIssuesInner {
  ...
  private ListAllAggregatedIssues200ResponseIssuesInnerIssueData issueData;
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner() {
  }

  public ListAllAggregatedIssues200ResponseIssuesInner fixInfo(ListAllAggregatedIssues200ResponseIssuesInnerFixInfo fixInfo) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner ignoreReasons(List<Object> ignoreReasons) {
    this.ignoreReasons = ignoreReasons;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInner addIgnoreReasonsItem(Object ignoreReasonsItem) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner introducedThrough(List<Object> introducedThrough) {
    this.introducedThrough = introducedThrough;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInner addIntroducedThroughItem(Object introducedThroughItem) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner isIgnored(Boolean isIgnored) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner isPatched(Boolean isPatched) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner issueData(ListAllAggregatedIssues200ResponseIssuesInnerIssueData issueData) {
   ...
   */
  @javax.annotation.Nonnull
  public ListAllAggregatedIssues200ResponseIssuesInnerIssueData getIssueData() {
    return issueData;
  }

  public void setIssueData(ListAllAggregatedIssues200ResponseIssuesInnerIssueData issueData) {
    this.issueData = issueData;
  }


  public ListAllAggregatedIssues200ResponseIssuesInner issueType(String issueType) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner links(ListAllAggregatedIssues200ResponseIssuesInnerLinks links) {
    this.links = links;
    return this;
  }
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner pkgName(String pkgName) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner pkgVersions(List<String> pkgVersions) {
    this.pkgVersions = pkgVersions;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInner addPkgVersionsItem(String pkgVersionsItem) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInner priority(ListAllAggregatedIssues200ResponseIssuesInnerPriority priority) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssues200ResponseIssuesInner listAllAggregatedIssues200ResponseIssuesInner = (ListAllAggregatedIssues200ResponseIssuesInner) o;
    return Objects.equals(this.fixInfo, listAllAggregatedIssues200ResponseIssuesInner.fixInfo) &&
        Objects.equals(this.id, listAllAggregatedIssues200ResponseIssuesInner.id) &&
        Objects.equals(this.ignoreReasons, listAllAggregatedIssues200ResponseIssuesInner.ignoreReasons) &&
        Objects.equals(this.introducedThrough, listAllAggregatedIssues200ResponseIssuesInner.introducedThrough) &&
        Objects.equals(this.isIgnored, listAllAggregatedIssues200ResponseIssuesInner.isIgnored) &&
        Objects.equals(this.isPatched, listAllAggregatedIssues200ResponseIssuesInner.isPatched) &&
        Objects.equals(this.issueData, listAllAggregatedIssues200ResponseIssuesInner.issueData) &&
        Objects.equals(this.issueType, listAllAggregatedIssues200ResponseIssuesInner.issueType) &&
        Objects.equals(this.links, listAllAggregatedIssues200ResponseIssuesInner.links) &&
        Objects.equals(this.pkgName, listAllAggregatedIssues200ResponseIssuesInner.pkgName) &&
        Objects.equals(this.pkgVersions, listAllAggregatedIssues200ResponseIssuesInner.pkgVersions) &&
        Objects.equals(this.priority, listAllAggregatedIssues200ResponseIssuesInner.priority);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllAggregatedIssues200ResponseIssuesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssues200ResponseIssuesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssues200ResponseIssuesInner is not found in the empty JSON string", ListAllAggregatedIssues200ResponseIssuesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssues200ResponseIssuesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssues200ResponseIssuesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllAggregatedIssues200ResponseIssuesInner.openapiRequiredFields) {
      ...
      ListAllAggregatedIssues200ResponseIssuesInnerIssueData.validateJsonElement(jsonObj.get("issueData"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssues200ResponseIssuesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssues200ResponseIssuesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssues200ResponseIssuesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInner>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssues200ResponseIssuesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssues200ResponseIssuesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssues200ResponseIssuesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssues200ResponseIssuesInner
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInner
   */
  public static ListAllAggregatedIssues200ResponseIssuesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssues200ResponseIssuesInner.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssues200ResponseIssuesInner to an JSON string
   *
   * @return JSON string
   */
