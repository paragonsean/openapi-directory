...
import org.openapitools.client.model.GetListOfIssuesRequestFilters;
...
public class GetListOfIssuesRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetListOfIssuesRequestFilters filters;

  public GetListOfIssuesRequest() {
  }

  public GetListOfIssuesRequest filters(GetListOfIssuesRequestFilters filters) {
  ...
  public GetListOfIssuesRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(GetListOfIssuesRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetListOfIssuesRequest getListOfIssuesRequest = (GetListOfIssuesRequest) o;
    return Objects.equals(this.filters, getListOfIssuesRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetListOfIssuesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetListOfIssuesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetListOfIssuesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListOfIssuesRequest is not found in the empty JSON string", GetListOfIssuesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetListOfIssuesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetListOfIssuesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        GetListOfIssuesRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListOfIssuesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListOfIssuesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListOfIssuesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssuesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListOfIssuesRequest>() {
           @Override
           public void write(JsonWriter out, GetListOfIssuesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetListOfIssuesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetListOfIssuesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetListOfIssuesRequest
   * @throws IOException if the JSON string is invalid with respect to GetListOfIssuesRequest
   */
  public static GetListOfIssuesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListOfIssuesRequest.class);
  }

  /**
   * Convert an instance of GetListOfIssuesRequest to an JSON string
   *
   * @return JSON string
   */
