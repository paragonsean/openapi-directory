...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf8GcrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf8 {
  public static final String SERIALIZED_NAME_GCR_CREDENTIALS = "GcrCredentials";
  @SerializedName(SERIALIZED_NAME_GCR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf8GcrCredentials gcrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf8() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf8 gcrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf8GcrCredentials gcrCredentials) {
    this.gcrCredentials = gcrCredentials;
    return this;
  }
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf8GcrCredentials getGcrCredentials() {
    return gcrCredentials;
  }

  public void setGcrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf8GcrCredentials gcrCredentials) {
    this.gcrCredentials = gcrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf8 addNewIntegrationRequestAnyOfCredentialsOneOf8 = (AddNewIntegrationRequestAnyOfCredentialsOneOf8) o;
    return Objects.equals(this.gcrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf8.gcrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gcrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf8 {\n");
    sb.append("    gcrCredentials: ").append(toIndentedString(gcrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("GcrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf8
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf8.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf8 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf8.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf8.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf8` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GcrCredentials`
      if (jsonObj.get("GcrCredentials") != null && !jsonObj.get("GcrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf8GcrCredentials.validateJsonElement(jsonObj.get("GcrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf8.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf8>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf8 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf8 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf8 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf8
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf8
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf8.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf8 to an JSON string
   *
   * @return JSON string
   */
