...
public class GetListOfIssues200ResponseResultsInnerIssueIdentifiers {
  public static final String SERIALIZED_NAME_C_V_E = "CVE";
  @SerializedName(SERIALIZED_NAME_C_V_E)
  private List<Object> CVE = new ArrayList<>();

  public static final String SERIALIZED_NAME_C_W_E = "CWE";
  @SerializedName(SERIALIZED_NAME_C_W_E)
  private List<Object> CWE = new ArrayList<>();

  public static final String SERIALIZED_NAME_O_S_V_D_B = "OSVDB";
  @SerializedName(SERIALIZED_NAME_O_S_V_D_B)
  private List<Object> OSVDB = new ArrayList<>();

  public GetListOfIssues200ResponseResultsInnerIssueIdentifiers() {
  }

  public GetListOfIssues200ResponseResultsInnerIssueIdentifiers CVE(List<Object> CVE) {
    this.CVE = CVE;
    return this;
  }

  public GetListOfIssues200ResponseResultsInnerIssueIdentifiers addCVEItem(Object CVEItem) {
    if (this.CVE == null) {
  ...
  public List<Object> getCVE() {
    return CVE;
  }

  public void setCVE(List<Object> CVE) {
    this.CVE = CVE;
  }


  public GetListOfIssues200ResponseResultsInnerIssueIdentifiers CWE(List<Object> CWE) {
    this.CWE = CWE;
    return this;
  }

  public GetListOfIssues200ResponseResultsInnerIssueIdentifiers addCWEItem(Object CWEItem) {
    if (this.CWE == null) {
  ...
  public void setCWE(List<Object> CWE) {
    this.CWE = CWE;
  }


  public GetListOfIssues200ResponseResultsInnerIssueIdentifiers OSVDB(List<Object> OSVDB) {
    this.OSVDB = OSVDB;
    return this;
  }

  public GetListOfIssues200ResponseResultsInnerIssueIdentifiers addOSVDBItem(Object OSVDBItem) {
    if (this.OSVDB == null) {
      this.OSVDB = new ArrayList<>();
    }
    this.OSVDB.add(OSVDBItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getOSVDB() {
    return OSVDB;
  }

  public void setOSVDB(List<Object> OSVDB) {
    this.OSVDB = OSVDB;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetListOfIssues200ResponseResultsInnerIssueIdentifiers getListOfIssues200ResponseResultsInnerIssueIdentifiers = (GetListOfIssues200ResponseResultsInnerIssueIdentifiers) o;
    return Objects.equals(this.CVE, getListOfIssues200ResponseResultsInnerIssueIdentifiers.CVE) &&
        Objects.equals(this.CWE, getListOfIssues200ResponseResultsInnerIssueIdentifiers.CWE) &&
        Objects.equals(this.OSVDB, getListOfIssues200ResponseResultsInnerIssueIdentifiers.OSVDB);
  }

  @Override
  public int hashCode() {
    return Objects.hash(CVE, CWE, OSVDB);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetListOfIssues200ResponseResultsInnerIssueIdentifiers {\n");
    sb.append("    CVE: ").append(toIndentedString(CVE)).append("\n");
    sb.append("    CWE: ").append(toIndentedString(CWE)).append("\n");
    sb.append("    OSVDB: ").append(toIndentedString(OSVDB)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetListOfIssues200ResponseResultsInnerIssueIdentifiers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetListOfIssues200ResponseResultsInnerIssueIdentifiers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListOfIssues200ResponseResultsInnerIssueIdentifiers is not found in the empty JSON string", GetListOfIssues200ResponseResultsInnerIssueIdentifiers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetListOfIssues200ResponseResultsInnerIssueIdentifiers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetListOfIssues200ResponseResultsInnerIssueIdentifiers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("OSVDB") != null && !jsonObj.get("OSVDB").isJsonNull() && !jsonObj.get("OSVDB").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `OSVDB` to be an array in the JSON string but got `%s`", jsonObj.get("OSVDB").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListOfIssues200ResponseResultsInnerIssueIdentifiers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListOfIssues200ResponseResultsInnerIssueIdentifiers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListOfIssues200ResponseResultsInnerIssueIdentifiers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssues200ResponseResultsInnerIssueIdentifiers.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListOfIssues200ResponseResultsInnerIssueIdentifiers>() {
           @Override
           public void write(JsonWriter out, GetListOfIssues200ResponseResultsInnerIssueIdentifiers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetListOfIssues200ResponseResultsInnerIssueIdentifiers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetListOfIssues200ResponseResultsInnerIssueIdentifiers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetListOfIssues200ResponseResultsInnerIssueIdentifiers
   * @throws IOException if the JSON string is invalid with respect to GetListOfIssues200ResponseResultsInnerIssueIdentifiers
   */
  public static GetListOfIssues200ResponseResultsInnerIssueIdentifiers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListOfIssues200ResponseResultsInnerIssueIdentifiers.class);
  }

  /**
   * Convert an instance of GetListOfIssues200ResponseResultsInnerIssueIdentifiers to an JSON string
   *
   * @return JSON string
   */
