...
public class OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations {
  ...
  public OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations() {
  }

  public OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations enabled(Boolean enabled) {
  ...
  public OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations inherited(Boolean inherited) {
  ...
  public OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations issueSeverity(IssueSeverityEnum issueSeverity) {
  ...
  public OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations issueType(IssueTypeEnum issueType) {
  ...
  public boolean equals(Object o) {
    ...
    OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations orgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations = (OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations) o;
    return Objects.equals(this.enabled, orgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.enabled) &&
        Objects.equals(this.inherited, orgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.inherited) &&
        Objects.equals(this.issueSeverity, orgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.issueSeverity) &&
        Objects.equals(this.issueType, orgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.issueType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, inherited, issueSeverity, issueType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations is not found in the empty JSON string", OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations>() {
           @Override
           public void write(JsonWriter out, OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations
   * @throws IOException if the JSON string is invalid with respect to OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations
   */
  public static OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.class);
  }

  /**
   * Convert an instance of OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations to an JSON string
   *
   * @return JSON string
   */
