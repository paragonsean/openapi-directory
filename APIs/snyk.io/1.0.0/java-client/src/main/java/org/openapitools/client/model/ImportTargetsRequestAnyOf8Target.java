...
public class ImportTargetsRequestAnyOf8Target {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public ImportTargetsRequestAnyOf8Target() {
  }

  public ImportTargetsRequestAnyOf8Target name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf8Target importTargetsRequestAnyOf8Target = (ImportTargetsRequestAnyOf8Target) o;
    return Objects.equals(this.name, importTargetsRequestAnyOf8Target.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf8Target {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf8Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf8Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf8Target is not found in the empty JSON string", ImportTargetsRequestAnyOf8Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf8Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf8Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf8Target.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf8Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf8Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf8Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf8Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf8Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf8Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf8Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf8Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf8Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf8Target
   */
  public static ImportTargetsRequestAnyOf8Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf8Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf8Target to an JSON string
   *
   * @return JSON string
   */
