...
public class OrgSettingsResponse {
  ...
  public OrgSettingsResponse requestAccess(ViewOrganizationSettings200ResponseRequestAccess requestAccess) {
  ...
  public boolean equals(Object o) {
    ...
    OrgSettingsResponse orgSettingsResponse = (OrgSettingsResponse) o;
    return Objects.equals(this.requestAccess, orgSettingsResponse.requestAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgSettingsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgSettingsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgSettingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgSettingsResponse is not found in the empty JSON string", OrgSettingsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgSettingsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrgSettingsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgSettingsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgSettingsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgSettingsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgSettingsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgSettingsResponse>() {
           @Override
           public void write(JsonWriter out, OrgSettingsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgSettingsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgSettingsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgSettingsResponse
   * @throws IOException if the JSON string is invalid with respect to OrgSettingsResponse
   */
  public static OrgSettingsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgSettingsResponse.class);
  }

  /**
   * Convert an instance of OrgSettingsResponse to an JSON string
   *
   * @return JSON string
   */
