...
public class TestRequirementsTxtFileRequestFilesTarget {
  public static final String SERIALIZED_NAME_CONTENTS = "contents";
  @SerializedName(SERIALIZED_NAME_CONTENTS)
  private String contents;

  public TestRequirementsTxtFileRequestFilesTarget() {
  }

  public TestRequirementsTxtFileRequestFilesTarget contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    TestRequirementsTxtFileRequestFilesTarget testRequirementsTxtFileRequestFilesTarget = (TestRequirementsTxtFileRequestFilesTarget) o;
    return Objects.equals(this.contents, testRequirementsTxtFileRequestFilesTarget.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestRequirementsTxtFileRequestFilesTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestRequirementsTxtFileRequestFilesTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestRequirementsTxtFileRequestFilesTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestRequirementsTxtFileRequestFilesTarget is not found in the empty JSON string", TestRequirementsTxtFileRequestFilesTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestRequirementsTxtFileRequestFilesTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestRequirementsTxtFileRequestFilesTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestRequirementsTxtFileRequestFilesTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestRequirementsTxtFileRequestFilesTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestRequirementsTxtFileRequestFilesTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestRequirementsTxtFileRequestFilesTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestRequirementsTxtFileRequestFilesTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<TestRequirementsTxtFileRequestFilesTarget>() {
           @Override
           public void write(JsonWriter out, TestRequirementsTxtFileRequestFilesTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestRequirementsTxtFileRequestFilesTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestRequirementsTxtFileRequestFilesTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestRequirementsTxtFileRequestFilesTarget
   * @throws IOException if the JSON string is invalid with respect to TestRequirementsTxtFileRequestFilesTarget
   */
  public static TestRequirementsTxtFileRequestFilesTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestRequirementsTxtFileRequestFilesTarget.class);
  }

  /**
   * Convert an instance of TestRequirementsTxtFileRequestFilesTarget to an JSON string
   *
   * @return JSON string
   */
