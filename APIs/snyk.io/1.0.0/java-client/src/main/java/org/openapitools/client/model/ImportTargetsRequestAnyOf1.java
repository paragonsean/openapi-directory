...
import org.openapitools.client.model.ImportTargetsRequestAnyOf1Target;
...
public class ImportTargetsRequestAnyOf1 {
  ...
  private ImportTargetsRequestAnyOf1Target target;

  public ImportTargetsRequestAnyOf1() {
  }

  public ImportTargetsRequestAnyOf1 exclusionGlobs(String exclusionGlobs) {
  ...
  public ImportTargetsRequestAnyOf1 files(List<Object> files) {
    this.files = files;
    return this;
  }

  public ImportTargetsRequestAnyOf1 addFilesItem(Object filesItem) {
    if (this.files == null) {
  ...
  public ImportTargetsRequestAnyOf1 target(ImportTargetsRequestAnyOf1Target target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportTargetsRequestAnyOf1Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf1Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf1 importTargetsRequestAnyOf1 = (ImportTargetsRequestAnyOf1) o;
    return Objects.equals(this.exclusionGlobs, importTargetsRequestAnyOf1.exclusionGlobs) &&
        Objects.equals(this.files, importTargetsRequestAnyOf1.files) &&
        Objects.equals(this.target, importTargetsRequestAnyOf1.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf1 is not found in the empty JSON string", ImportTargetsRequestAnyOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf1Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf1>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf1
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf1
   */
  public static ImportTargetsRequestAnyOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf1.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf1 to an JSON string
   *
   * @return JSON string
   */
