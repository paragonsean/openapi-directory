...
public class MonitorRepository {
  ...
  public MonitorRepository alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitorRepository monitorRepository = (MonitorRepository) o;
    return Objects.equals(this.alias, monitorRepository.alias);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorRepository {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorRepository is not found in the empty JSON string", MonitorRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorRepository>() {
           @Override
           public void write(JsonWriter out, MonitorRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorRepository
   * @throws IOException if the JSON string is invalid with respect to MonitorRepository
   */
  public static MonitorRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorRepository.class);
  }

  /**
   * Convert an instance of MonitorRepository to an JSON string
   *
   * @return JSON string
   */
