...
public class UpdateOrganizationSettingsRequest {
  ...
  public UpdateOrganizationSettingsRequest requestAccess(UpdateOrganizationSettingsRequestRequestAccess requestAccess) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateOrganizationSettingsRequest updateOrganizationSettingsRequest = (UpdateOrganizationSettingsRequest) o;
    return Objects.equals(this.requestAccess, updateOrganizationSettingsRequest.requestAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateOrganizationSettingsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOrganizationSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOrganizationSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOrganizationSettingsRequest is not found in the empty JSON string", UpdateOrganizationSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOrganizationSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOrganizationSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOrganizationSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOrganizationSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOrganizationSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOrganizationSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOrganizationSettingsRequest>() {
           @Override
           public void write(JsonWriter out, UpdateOrganizationSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOrganizationSettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOrganizationSettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOrganizationSettingsRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateOrganizationSettingsRequest
   */
  public static UpdateOrganizationSettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOrganizationSettingsRequest.class);
  }

  /**
   * Convert an instance of UpdateOrganizationSettingsRequest to an JSON string
   *
   * @return JSON string
   */
