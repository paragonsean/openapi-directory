...
public class GraphDependency {
  ...
  public GraphDependency nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GraphDependency graphDependency = (GraphDependency) o;
    return Objects.equals(this.nodeId, graphDependency.nodeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GraphDependency {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GraphDependency
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GraphDependency.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GraphDependency is not found in the empty JSON string", GraphDependency.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GraphDependency.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GraphDependency` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GraphDependency.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GraphDependency.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GraphDependency' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GraphDependency> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GraphDependency.class));

       return (TypeAdapter<T>) new TypeAdapter<GraphDependency>() {
           @Override
           public void write(JsonWriter out, GraphDependency value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GraphDependency read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GraphDependency given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GraphDependency
   * @throws IOException if the JSON string is invalid with respect to GraphDependency
   */
  public static GraphDependency fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GraphDependency.class);
  }

  /**
   * Convert an instance of GraphDependency to an JSON string
   *
   * @return JSON string
   */
