...
import org.openapitools.client.model.ImportTargetsRequestAnyOf3Target;
...
public class ImportTargetsRequestAnyOf3 {
  ...
  private ImportTargetsRequestAnyOf3Target target;

  public ImportTargetsRequestAnyOf3() {
  }

  public ImportTargetsRequestAnyOf3 exclusionGlobs(String exclusionGlobs) {
  ...
  public ImportTargetsRequestAnyOf3 files(List<Object> files) {
    this.files = files;
    return this;
  }

  public ImportTargetsRequestAnyOf3 addFilesItem(Object filesItem) {
    if (this.files == null) {
  ...
  public ImportTargetsRequestAnyOf3 target(ImportTargetsRequestAnyOf3Target target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportTargetsRequestAnyOf3Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf3Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf3 importTargetsRequestAnyOf3 = (ImportTargetsRequestAnyOf3) o;
    return Objects.equals(this.exclusionGlobs, importTargetsRequestAnyOf3.exclusionGlobs) &&
        Objects.equals(this.files, importTargetsRequestAnyOf3.files) &&
        Objects.equals(this.target, importTargetsRequestAnyOf3.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf3 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf3 is not found in the empty JSON string", ImportTargetsRequestAnyOf3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf3Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf3.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf3>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf3
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf3
   */
  public static ImportTargetsRequestAnyOf3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf3.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf3 to an JSON string
   *
   * @return JSON string
   */
