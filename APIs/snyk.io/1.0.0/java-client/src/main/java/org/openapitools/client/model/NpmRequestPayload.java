...
public class NpmRequestPayload {
  /**
  ...
  public NpmRequestPayload() {
  }

  public NpmRequestPayload encoding(EncodingEnum encoding) {
  ...
  public NpmRequestPayload files(TestPackageJsonPackageLockJsonFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NpmRequestPayload npmRequestPayload = (NpmRequestPayload) o;
    return Objects.equals(this.encoding, npmRequestPayload.encoding) &&
        Objects.equals(this.files, npmRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class NpmRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NpmRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NpmRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NpmRequestPayload is not found in the empty JSON string", NpmRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NpmRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NpmRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NpmRequestPayload.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NpmRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NpmRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NpmRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NpmRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<NpmRequestPayload>() {
           @Override
           public void write(JsonWriter out, NpmRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NpmRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NpmRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NpmRequestPayload
   * @throws IOException if the JSON string is invalid with respect to NpmRequestPayload
   */
  public static NpmRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NpmRequestPayload.class);
  }

  /**
   * Convert an instance of NpmRequestPayload to an JSON string
   *
   * @return JSON string
   */
