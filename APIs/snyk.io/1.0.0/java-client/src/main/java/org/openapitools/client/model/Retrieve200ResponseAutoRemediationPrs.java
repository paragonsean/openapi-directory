...
public class Retrieve200ResponseAutoRemediationPrs {
  ...
  public Retrieve200ResponseAutoRemediationPrs() {
  }

  public Retrieve200ResponseAutoRemediationPrs backlogPrsEnabled(Boolean backlogPrsEnabled) {
  ...
  public Retrieve200ResponseAutoRemediationPrs freshPrsEnabled(Boolean freshPrsEnabled) {
  ...
  public Retrieve200ResponseAutoRemediationPrs usePatchRemediation(Boolean usePatchRemediation) {
  ...
  public boolean equals(Object o) {
    ...
    Retrieve200ResponseAutoRemediationPrs retrieve200ResponseAutoRemediationPrs = (Retrieve200ResponseAutoRemediationPrs) o;
    return Objects.equals(this.backlogPrsEnabled, retrieve200ResponseAutoRemediationPrs.backlogPrsEnabled) &&
        Objects.equals(this.freshPrsEnabled, retrieve200ResponseAutoRemediationPrs.freshPrsEnabled) &&
        Objects.equals(this.usePatchRemediation, retrieve200ResponseAutoRemediationPrs.usePatchRemediation);
  }
  ...
  public String toString() {
    ...
    sb.append("class Retrieve200ResponseAutoRemediationPrs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Retrieve200ResponseAutoRemediationPrs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Retrieve200ResponseAutoRemediationPrs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Retrieve200ResponseAutoRemediationPrs is not found in the empty JSON string", Retrieve200ResponseAutoRemediationPrs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Retrieve200ResponseAutoRemediationPrs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Retrieve200ResponseAutoRemediationPrs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Retrieve200ResponseAutoRemediationPrs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Retrieve200ResponseAutoRemediationPrs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Retrieve200ResponseAutoRemediationPrs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Retrieve200ResponseAutoRemediationPrs.class));

       return (TypeAdapter<T>) new TypeAdapter<Retrieve200ResponseAutoRemediationPrs>() {
           @Override
           public void write(JsonWriter out, Retrieve200ResponseAutoRemediationPrs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Retrieve200ResponseAutoRemediationPrs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Retrieve200ResponseAutoRemediationPrs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Retrieve200ResponseAutoRemediationPrs
   * @throws IOException if the JSON string is invalid with respect to Retrieve200ResponseAutoRemediationPrs
   */
  public static Retrieve200ResponseAutoRemediationPrs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Retrieve200ResponseAutoRemediationPrs.class);
  }

  /**
   * Convert an instance of Retrieve200ResponseAutoRemediationPrs to an JSON string
   *
   * @return JSON string
   */
