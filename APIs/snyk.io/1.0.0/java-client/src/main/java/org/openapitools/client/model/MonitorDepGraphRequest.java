...
import org.openapitools.client.model.MonitorDepGraphRequestDepGraph;
import org.openapitools.client.model.MonitorDepGraphRequestMeta;
...
public class MonitorDepGraphRequest {
  public static final String SERIALIZED_NAME_DEP_GRAPH = "depGraph";
  @SerializedName(SERIALIZED_NAME_DEP_GRAPH)
  private MonitorDepGraphRequestDepGraph depGraph;

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private MonitorDepGraphRequestMeta meta;

  public MonitorDepGraphRequest() {
  }

  public MonitorDepGraphRequest depGraph(MonitorDepGraphRequestDepGraph depGraph) {
  ...
  public MonitorDepGraphRequestDepGraph getDepGraph() {
    return depGraph;
  }

  public void setDepGraph(MonitorDepGraphRequestDepGraph depGraph) {
    this.depGraph = depGraph;
  }


  public MonitorDepGraphRequest meta(MonitorDepGraphRequestMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public MonitorDepGraphRequestMeta getMeta() {
    return meta;
  }

  public void setMeta(MonitorDepGraphRequestMeta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitorDepGraphRequest monitorDepGraphRequest = (MonitorDepGraphRequest) o;
    return Objects.equals(this.depGraph, monitorDepGraphRequest.depGraph) &&
        Objects.equals(this.meta, monitorDepGraphRequest.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorDepGraphRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorDepGraphRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorDepGraphRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorDepGraphRequest is not found in the empty JSON string", MonitorDepGraphRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorDepGraphRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorDepGraphRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorDepGraphRequest.openapiRequiredFields) {
      ...
      MonitorDepGraphRequestDepGraph.validateJsonElement(jsonObj.get("depGraph"));
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        MonitorDepGraphRequestMeta.validateJsonElement(jsonObj.get("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorDepGraphRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorDepGraphRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorDepGraphRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorDepGraphRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorDepGraphRequest>() {
           @Override
           public void write(JsonWriter out, MonitorDepGraphRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorDepGraphRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorDepGraphRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorDepGraphRequest
   * @throws IOException if the JSON string is invalid with respect to MonitorDepGraphRequest
   */
  public static MonitorDepGraphRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorDepGraphRequest.class);
  }

  /**
   * Convert an instance of MonitorDepGraphRequest to an JSON string
   *
   * @return JSON string
   */
