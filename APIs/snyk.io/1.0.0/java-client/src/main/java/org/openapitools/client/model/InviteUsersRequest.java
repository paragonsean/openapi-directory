...
public class InviteUsersRequest {
  ...
  public InviteUsersRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  public InviteUsersRequest isAdmin(Boolean isAdmin) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, inviteUsersRequest.email) &&
        Objects.equals(this.isAdmin, inviteUsersRequest.isAdmin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, isAdmin);
  }
