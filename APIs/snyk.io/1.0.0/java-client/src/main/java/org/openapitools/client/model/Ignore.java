...
import org.openapitools.client.model.IgnoreIgnorePath;
...
public class Ignore {
  ...
  private IgnoreIgnorePath ignorePath;

  public Ignore() {
  }

  public Ignore ignorePath(IgnoreIgnorePath ignorePath) {
  ...
  public IgnoreIgnorePath getIgnorePath() {
    return ignorePath;
  }

  public void setIgnorePath(IgnoreIgnorePath ignorePath) {
    this.ignorePath = ignorePath;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ignorePath, ignore.ignorePath);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("ignorePath");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ignore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ignore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ignore is not found in the empty JSON string", Ignore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ignore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ignore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Ignore.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `ignorePath`
      IgnoreIgnorePath.validateJsonElement(jsonObj.get("ignorePath"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ignore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ignore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ignore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ignore.class));

       return (TypeAdapter<T>) new TypeAdapter<Ignore>() {
           @Override
           public void write(JsonWriter out, Ignore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ignore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ignore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ignore
   * @throws IOException if the JSON string is invalid with respect to Ignore
   */
  public static Ignore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ignore.class);
  }

  /**
   * Convert an instance of Ignore to an JSON string
   *
   * @return JSON string
   */
