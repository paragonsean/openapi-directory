...
public class DeleteTagBody {
  ...
  public DeleteTagBody() {
  }

  public DeleteTagBody force(Boolean force) {
    this.force = force;
    return this;
  }
  ...
  public DeleteTagBody key(String key) {
    this.key = key;
    return this;
  }
  ...
  public DeleteTagBody value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteTagBody deleteTagBody = (DeleteTagBody) o;
    return Objects.equals(this.force, deleteTagBody.force) &&
        Objects.equals(this.key, deleteTagBody.key) &&
        Objects.equals(this.value, deleteTagBody.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTagBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTagBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTagBody is not found in the empty JSON string", DeleteTagBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTagBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTagBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTagBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTagBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTagBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTagBody.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTagBody>() {
           @Override
           public void write(JsonWriter out, DeleteTagBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTagBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTagBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTagBody
   * @throws IOException if the JSON string is invalid with respect to DeleteTagBody
   */
  public static DeleteTagBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTagBody.class);
  }

  /**
   * Convert an instance of DeleteTagBody to an JSON string
   *
   * @return JSON string
   */
