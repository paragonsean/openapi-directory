...
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner;
...
public class GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner {
  public static final String SERIALIZED_NAME_DEPS = "deps";
  @SerializedName(SERIALIZED_NAME_DEPS)
  private List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner> deps = new ArrayList<>();

  public static final String SERIALIZED_NAME_NODE_ID = "nodeId";
  @SerializedName(SERIALIZED_NAME_NODE_ID)
  private String nodeId;

  public static final String SERIALIZED_NAME_PKG_ID = "pkgId";
  @SerializedName(SERIALIZED_NAME_PKG_ID)
  private String pkgId;

  public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner() {
  }

  public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner deps(List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner> deps) {
    this.deps = deps;
    return this;
  }

  public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner addDepsItem(GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner depsItem) {
    if (this.deps == null) {
  ...
  public List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner> getDeps() {
    return deps;
  }

  public void setDeps(List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner> deps) {
    this.deps = deps;
  }


  public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner pkgId(String pkgId) {
    this.pkgId = pkgId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner getProjectDependencyGraph200ResponseDepGraphGraphNodesInner = (GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner) o;
    return Objects.equals(this.deps, getProjectDependencyGraph200ResponseDepGraphGraphNodesInner.deps) &&
        Objects.equals(this.nodeId, getProjectDependencyGraph200ResponseDepGraphGraphNodesInner.nodeId) &&
        Objects.equals(this.pkgId, getProjectDependencyGraph200ResponseDepGraphGraphNodesInner.pkgId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deps, nodeId, pkgId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner {\n");
  ...
  static {
    ...
    openapiFields.add("deps");
    openapiFields.add("nodeId");
    openapiFields.add("pkgId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("deps");
    openapiRequiredFields.add("nodeId");
    openapiRequiredFields.add("pkgId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.openapiRequiredFields) {
      ...
      if (!jsonObj.get("deps").isJsonArray()) {
      ...
      JsonArray jsonArraydeps = jsonObj.getAsJsonArray("deps");
      // validate the required field `deps` (array)
      for (int i = 0; i < jsonArraydeps.size(); i++) {
        GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.validateJsonElement(jsonArraydeps.get(i));
      };
      ...
      if (!jsonObj.get("pkgId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `pkgId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pkgId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner
   */
  public static GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner to an JSON string
   *
   * @return JSON string
   */
