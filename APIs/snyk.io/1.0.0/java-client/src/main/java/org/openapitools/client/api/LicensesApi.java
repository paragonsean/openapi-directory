...
import org.openapitools.client.model.ListAllLicenses200Response;
import org.openapitools.client.model.ListAllLicensesRequest;
...
public class LicensesApi {
     ...
     */
    public okhttp3.Call listAllLicensesCall(String orgId, String sortBy, String order, ListAllLicensesRequest listAllLicensesRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = listAllLicensesRequest;

        // create path and map variables
        String localVarPath = "/org/{orgId}/licenses"
    ...
    private okhttp3.Call listAllLicensesValidateBeforeCall(String orgId, String sortBy, String order, ListAllLicensesRequest listAllLicensesRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling listAllLicenses(Async)");
        }

        return listAllLicensesCall(orgId, sortBy, order, listAllLicensesRequest, _callback);
     ...
     * @param order The direction to sort results by. (optional, default to asc)
     * @param listAllLicensesRequest  (optional)
     * @return ListAllLicenses200Response
     ...
     */
    public ListAllLicenses200Response listAllLicenses(String orgId, String sortBy, String order, ListAllLicensesRequest listAllLicensesRequest) throws ApiException {
        ApiResponse<ListAllLicenses200Response> localVarResp = listAllLicensesWithHttpInfo(orgId, sortBy, order, listAllLicensesRequest);
     ...
     * @param order The direction to sort results by. (optional, default to asc)
     * @param listAllLicensesRequest  (optional)
     * @return ApiResponse&lt;ListAllLicenses200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListAllLicenses200Response> listAllLicensesWithHttpInfo(String orgId, String sortBy, String order, ListAllLicensesRequest listAllLicensesRequest) throws ApiException {
        okhttp3.Call localVarCall = listAllLicensesValidateBeforeCall(orgId, sortBy, order, listAllLicensesRequest, null);
        Type localVarReturnType = new TypeToken<ListAllLicenses200Response>(){}.getType();
     ...
     */
    public okhttp3.Call listAllLicensesAsync(String orgId, String sortBy, String order, ListAllLicensesRequest listAllLicensesRequest, final ApiCallback<ListAllLicenses200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllLicensesValidateBeforeCall(orgId, sortBy, order, listAllLicensesRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAllLicenses200Response>(){}.getType();
