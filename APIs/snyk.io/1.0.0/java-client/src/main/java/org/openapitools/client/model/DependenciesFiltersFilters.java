...
public class DependenciesFiltersFilters {
  ...
  public DependenciesFiltersFilters() {
  }

  public DependenciesFiltersFilters depStatus(String depStatus) {
  ...
  public DependenciesFiltersFilters dependencies(List<Object> dependencies) {
    this.dependencies = dependencies;
    return this;
  }

  public DependenciesFiltersFilters addDependenciesItem(Object dependenciesItem) {
  ...
  public DependenciesFiltersFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public DependenciesFiltersFilters addLanguagesItem(Object languagesItem) {
  ...
  public DependenciesFiltersFilters licenses(List<Object> licenses) {
    this.licenses = licenses;
    return this;
  }

  public DependenciesFiltersFilters addLicensesItem(Object licensesItem) {
  ...
  public DependenciesFiltersFilters projects(List<Object> projects) {
    this.projects = projects;
    return this;
  }

  public DependenciesFiltersFilters addProjectsItem(Object projectsItem) {
  ...
  public DependenciesFiltersFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public DependenciesFiltersFilters addSeverityItem(Object severityItem) {
  ...
  public boolean equals(Object o) {
    ...
    DependenciesFiltersFilters dependenciesFiltersFilters = (DependenciesFiltersFilters) o;
    return Objects.equals(this.depStatus, dependenciesFiltersFilters.depStatus) &&
        Objects.equals(this.dependencies, dependenciesFiltersFilters.dependencies) &&
        Objects.equals(this.languages, dependenciesFiltersFilters.languages) &&
        Objects.equals(this.licenses, dependenciesFiltersFilters.licenses) &&
        Objects.equals(this.projects, dependenciesFiltersFilters.projects) &&
        Objects.equals(this.severity, dependenciesFiltersFilters.severity);
  }
  ...
  public String toString() {
    ...
    sb.append("class DependenciesFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DependenciesFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DependenciesFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DependenciesFiltersFilters is not found in the empty JSON string", DependenciesFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DependenciesFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DependenciesFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependenciesFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependenciesFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependenciesFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependenciesFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<DependenciesFiltersFilters>() {
           @Override
           public void write(JsonWriter out, DependenciesFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DependenciesFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DependenciesFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DependenciesFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to DependenciesFiltersFilters
   */
  public static DependenciesFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependenciesFiltersFilters.class);
  }

  /**
   * Convert an instance of DependenciesFiltersFilters to an JSON string
   *
   * @return JSON string
   */
