...
import org.openapitools.client.model.GetProjectCounts200ResponseResultsInner;
...
public class GetProjectCounts200Response {
  public static final String SERIALIZED_NAME_RESULTS = "results";
  @SerializedName(SERIALIZED_NAME_RESULTS)
  private List<GetProjectCounts200ResponseResultsInner> results = new ArrayList<>();

  public GetProjectCounts200Response() {
  }

  public GetProjectCounts200Response results(List<GetProjectCounts200ResponseResultsInner> results) {
    this.results = results;
    return this;
  }

  public GetProjectCounts200Response addResultsItem(GetProjectCounts200ResponseResultsInner resultsItem) {
  ...
  public List<GetProjectCounts200ResponseResultsInner> getResults() {
    return results;
  }

  public void setResults(List<GetProjectCounts200ResponseResultsInner> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectCounts200Response getProjectCounts200Response = (GetProjectCounts200Response) o;
    return Objects.equals(this.results, getProjectCounts200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectCounts200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectCounts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectCounts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectCounts200Response is not found in the empty JSON string", GetProjectCounts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectCounts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectCounts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectCounts200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        GetProjectCounts200ResponseResultsInner.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectCounts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectCounts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectCounts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectCounts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectCounts200Response>() {
           @Override
           public void write(JsonWriter out, GetProjectCounts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectCounts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectCounts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectCounts200Response
   * @throws IOException if the JSON string is invalid with respect to GetProjectCounts200Response
   */
  public static GetProjectCounts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectCounts200Response.class);
  }

  /**
   * Convert an instance of GetProjectCounts200Response to an JSON string
   *
   * @return JSON string
   */
