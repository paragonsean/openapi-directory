...
public class PullRequestAssignment {
  ...
  public PullRequestAssignment assignees(List<Object> assignees) {
    this.assignees = assignees;
    return this;
  }

  public PullRequestAssignment addAssigneesItem(Object assigneesItem) {
  ...
  public PullRequestAssignment enabled(Boolean enabled) {
  ...
  public PullRequestAssignment type(AssignmentType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PullRequestAssignment pullRequestAssignment = (PullRequestAssignment) o;
    return Objects.equals(this.assignees, pullRequestAssignment.assignees) &&
        Objects.equals(this.enabled, pullRequestAssignment.enabled) &&
        Objects.equals(this.type, pullRequestAssignment.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestAssignment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestAssignment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestAssignment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestAssignment is not found in the empty JSON string", PullRequestAssignment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestAssignment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestAssignment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestAssignment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestAssignment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestAssignment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestAssignment.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestAssignment>() {
           @Override
           public void write(JsonWriter out, PullRequestAssignment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestAssignment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestAssignment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestAssignment
   * @throws IOException if the JSON string is invalid with respect to PullRequestAssignment
   */
  public static PullRequestAssignment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestAssignment.class);
  }

  /**
   * Convert an instance of PullRequestAssignment to an JSON string
   *
   * @return JSON string
   */
