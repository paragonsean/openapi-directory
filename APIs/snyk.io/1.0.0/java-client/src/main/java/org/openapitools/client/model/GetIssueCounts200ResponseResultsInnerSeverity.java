...
public class GetIssueCounts200ResponseResultsInnerSeverity {
  ...
  public GetIssueCounts200ResponseResultsInnerSeverity() {
  }

  public GetIssueCounts200ResponseResultsInnerSeverity critical(BigDecimal critical) {
  ...
  public GetIssueCounts200ResponseResultsInnerSeverity high(BigDecimal high) {
    this.high = high;
    return this;
  }
  ...
  public GetIssueCounts200ResponseResultsInnerSeverity low(BigDecimal low) {
    this.low = low;
    return this;
  }
  ...
  public GetIssueCounts200ResponseResultsInnerSeverity medium(BigDecimal medium) {
    this.medium = medium;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCounts200ResponseResultsInnerSeverity getIssueCounts200ResponseResultsInnerSeverity = (GetIssueCounts200ResponseResultsInnerSeverity) o;
    return Objects.equals(this.critical, getIssueCounts200ResponseResultsInnerSeverity.critical) &&
        Objects.equals(this.high, getIssueCounts200ResponseResultsInnerSeverity.high) &&
        Objects.equals(this.low, getIssueCounts200ResponseResultsInnerSeverity.low) &&
        Objects.equals(this.medium, getIssueCounts200ResponseResultsInnerSeverity.medium);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIssueCounts200ResponseResultsInnerSeverity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCounts200ResponseResultsInnerSeverity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCounts200ResponseResultsInnerSeverity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCounts200ResponseResultsInnerSeverity is not found in the empty JSON string", GetIssueCounts200ResponseResultsInnerSeverity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCounts200ResponseResultsInnerSeverity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCounts200ResponseResultsInnerSeverity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCounts200ResponseResultsInnerSeverity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCounts200ResponseResultsInnerSeverity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCounts200ResponseResultsInnerSeverity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCounts200ResponseResultsInnerSeverity.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCounts200ResponseResultsInnerSeverity>() {
           @Override
           public void write(JsonWriter out, GetIssueCounts200ResponseResultsInnerSeverity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCounts200ResponseResultsInnerSeverity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCounts200ResponseResultsInnerSeverity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCounts200ResponseResultsInnerSeverity
   * @throws IOException if the JSON string is invalid with respect to GetIssueCounts200ResponseResultsInnerSeverity
   */
  public static GetIssueCounts200ResponseResultsInnerSeverity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCounts200ResponseResultsInnerSeverity.class);
  }

  /**
   * Convert an instance of GetIssueCounts200ResponseResultsInnerSeverity to an JSON string
   *
   * @return JSON string
   */
