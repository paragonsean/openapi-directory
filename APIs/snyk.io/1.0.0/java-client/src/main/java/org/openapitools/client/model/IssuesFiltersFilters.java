...
import org.openapitools.client.model.PriorityScore;
...
public class IssuesFiltersFilters {
  ...
  private List<Object> issues = new ArrayList<>();
  ...
  private List<Object> orgs = new ArrayList<>();
  ...
  public IssuesFiltersFilters() {
  }

  public IssuesFiltersFilters exploitMaturity(List<Object> exploitMaturity) {
    this.exploitMaturity = exploitMaturity;
    return this;
  }

  public IssuesFiltersFilters addExploitMaturityItem(Object exploitMaturityItem) {
  ...
  public IssuesFiltersFilters fixable(Boolean fixable) {
  ...
  public IssuesFiltersFilters identifier(String identifier) {
  ...
  public IssuesFiltersFilters ignored(Boolean ignored) {
  ...
  public IssuesFiltersFilters isFixed(Boolean isFixed) {
  ...
  public IssuesFiltersFilters isPatchable(Boolean isPatchable) {
  ...
  public IssuesFiltersFilters isPinnable(Boolean isPinnable) {
  ...
  public IssuesFiltersFilters isUpgradable(Boolean isUpgradable) {
  ...
  public IssuesFiltersFilters issues(List<Object> issues) {
    this.issues = issues;
    return this;
  }

  public IssuesFiltersFilters addIssuesItem(Object issuesItem) {
    if (this.issues == null) {
  ...
  public IssuesFiltersFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public IssuesFiltersFilters addLanguagesItem(Object languagesItem) {
  ...
  public IssuesFiltersFilters orgs(List<Object> orgs) {
    this.orgs = orgs;
    return this;
  }

  public IssuesFiltersFilters addOrgsItem(Object orgsItem) {
    if (this.orgs == null) {
  ...
  public IssuesFiltersFilters patched(Boolean patched) {
  ...
  public IssuesFiltersFilters priorityScore(PriorityScore priorityScore) {
   ...
   */
  @javax.annotation.Nullable
  public PriorityScore getPriorityScore() {
    return priorityScore;
  }

  public void setPriorityScore(PriorityScore priorityScore) {
    this.priorityScore = priorityScore;
  }


  public IssuesFiltersFilters projects(List<Object> projects) {
    this.projects = projects;
    return this;
  }

  public IssuesFiltersFilters addProjectsItem(Object projectsItem) {
  ...
  public IssuesFiltersFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public IssuesFiltersFilters addSeverityItem(Object severityItem) {
  ...
  public IssuesFiltersFilters types(List<Object> types) {
    this.types = types;
    return this;
  }

  public IssuesFiltersFilters addTypesItem(Object typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    IssuesFiltersFilters issuesFiltersFilters = (IssuesFiltersFilters) o;
    return Objects.equals(this.exploitMaturity, issuesFiltersFilters.exploitMaturity) &&
        Objects.equals(this.fixable, issuesFiltersFilters.fixable) &&
        Objects.equals(this.identifier, issuesFiltersFilters.identifier) &&
        Objects.equals(this.ignored, issuesFiltersFilters.ignored) &&
        Objects.equals(this.isFixed, issuesFiltersFilters.isFixed) &&
        Objects.equals(this.isPatchable, issuesFiltersFilters.isPatchable) &&
        Objects.equals(this.isPinnable, issuesFiltersFilters.isPinnable) &&
        Objects.equals(this.isUpgradable, issuesFiltersFilters.isUpgradable) &&
        Objects.equals(this.issues, issuesFiltersFilters.issues) &&
        Objects.equals(this.languages, issuesFiltersFilters.languages) &&
        Objects.equals(this.orgs, issuesFiltersFilters.orgs) &&
        Objects.equals(this.patched, issuesFiltersFilters.patched) &&
        Objects.equals(this.priorityScore, issuesFiltersFilters.priorityScore) &&
        Objects.equals(this.projects, issuesFiltersFilters.projects) &&
        Objects.equals(this.severity, issuesFiltersFilters.severity) &&
        Objects.equals(this.types, issuesFiltersFilters.types);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssuesFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuesFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuesFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssuesFiltersFilters is not found in the empty JSON string", IssuesFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssuesFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssuesFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IssuesFiltersFilters.openapiRequiredFields) {
      ...
      if (jsonObj.get("orgs") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("orgs").isJsonArray()) {
      ...
      if (jsonObj.get("priorityScore") != null && !jsonObj.get("priorityScore").isJsonNull()) {
        PriorityScore.validateJsonElement(jsonObj.get("priorityScore"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssuesFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssuesFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssuesFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssuesFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<IssuesFiltersFilters>() {
           @Override
           public void write(JsonWriter out, IssuesFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssuesFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssuesFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssuesFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to IssuesFiltersFilters
   */
  public static IssuesFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssuesFiltersFilters.class);
  }

  /**
   * Convert an instance of IssuesFiltersFilters to an JSON string
   *
   * @return JSON string
   */
