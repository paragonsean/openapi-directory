...
public class GetImportJobDetails200Response {
  ...
  public GetImportJobDetails200Response() {
  }

  public GetImportJobDetails200Response created(String created) {
  ...
  public GetImportJobDetails200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetImportJobDetails200Response logs(List<Object> logs) {
    this.logs = logs;
    return this;
  }

  public GetImportJobDetails200Response addLogsItem(Object logsItem) {
    if (this.logs == null) {
  ...
  public GetImportJobDetails200Response status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetImportJobDetails200Response getImportJobDetails200Response = (GetImportJobDetails200Response) o;
    return Objects.equals(this.created, getImportJobDetails200Response.created) &&
        Objects.equals(this.id, getImportJobDetails200Response.id) &&
        Objects.equals(this.logs, getImportJobDetails200Response.logs) &&
        Objects.equals(this.status, getImportJobDetails200Response.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, id, logs, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetImportJobDetails200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImportJobDetails200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImportJobDetails200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImportJobDetails200Response is not found in the empty JSON string", GetImportJobDetails200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImportJobDetails200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImportJobDetails200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImportJobDetails200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImportJobDetails200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImportJobDetails200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImportJobDetails200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImportJobDetails200Response>() {
           @Override
           public void write(JsonWriter out, GetImportJobDetails200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImportJobDetails200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImportJobDetails200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImportJobDetails200Response
   * @throws IOException if the JSON string is invalid with respect to GetImportJobDetails200Response
   */
  public static GetImportJobDetails200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImportJobDetails200Response.class);
  }

  /**
   * Convert an instance of GetImportJobDetails200Response to an JSON string
   *
   * @return JSON string
   */
