...
public class IssueCountsFiltersFilters {
  ...
  public IssueCountsFiltersFilters() {
  }

  public IssueCountsFiltersFilters fixable(Boolean fixable) {
  ...
  public IssueCountsFiltersFilters ignored(Boolean ignored) {
  ...
  public IssueCountsFiltersFilters isPatchable(Boolean isPatchable) {
  ...
  public IssueCountsFiltersFilters isPinnable(Boolean isPinnable) {
  ...
  public IssueCountsFiltersFilters isUpgradable(Boolean isUpgradable) {
  ...
  public IssueCountsFiltersFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public IssueCountsFiltersFilters addLanguagesItem(Object languagesItem) {
  ...
  public IssueCountsFiltersFilters orgs(List<Object> orgs) {
    this.orgs = orgs;
    return this;
  }

  public IssueCountsFiltersFilters addOrgsItem(Object orgsItem) {
    if (this.orgs == null) {
  ...
  public IssueCountsFiltersFilters patched(Boolean patched) {
  ...
  public IssueCountsFiltersFilters priorityScore(PriorityScore priorityScore) {
  ...
  public IssueCountsFiltersFilters projects(List<Object> projects) {
    this.projects = projects;
    return this;
  }

  public IssueCountsFiltersFilters addProjectsItem(Object projectsItem) {
  ...
  public IssueCountsFiltersFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public IssueCountsFiltersFilters addSeverityItem(Object severityItem) {
  ...
  public IssueCountsFiltersFilters types(List<Object> types) {
    this.types = types;
    return this;
  }

  public IssueCountsFiltersFilters addTypesItem(Object typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    IssueCountsFiltersFilters issueCountsFiltersFilters = (IssueCountsFiltersFilters) o;
    return Objects.equals(this.fixable, issueCountsFiltersFilters.fixable) &&
        Objects.equals(this.ignored, issueCountsFiltersFilters.ignored) &&
        Objects.equals(this.isPatchable, issueCountsFiltersFilters.isPatchable) &&
        Objects.equals(this.isPinnable, issueCountsFiltersFilters.isPinnable) &&
        Objects.equals(this.isUpgradable, issueCountsFiltersFilters.isUpgradable) &&
        Objects.equals(this.languages, issueCountsFiltersFilters.languages) &&
        Objects.equals(this.orgs, issueCountsFiltersFilters.orgs) &&
        Objects.equals(this.patched, issueCountsFiltersFilters.patched) &&
        Objects.equals(this.priorityScore, issueCountsFiltersFilters.priorityScore) &&
        Objects.equals(this.projects, issueCountsFiltersFilters.projects) &&
        Objects.equals(this.severity, issueCountsFiltersFilters.severity) &&
        Objects.equals(this.types, issueCountsFiltersFilters.types);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueCountsFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueCountsFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueCountsFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssueCountsFiltersFilters is not found in the empty JSON string", IssueCountsFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueCountsFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssueCountsFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IssueCountsFiltersFilters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssueCountsFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssueCountsFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssueCountsFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssueCountsFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<IssueCountsFiltersFilters>() {
           @Override
           public void write(JsonWriter out, IssueCountsFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssueCountsFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssueCountsFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssueCountsFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to IssueCountsFiltersFilters
   */
  public static IssueCountsFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssueCountsFiltersFilters.class);
  }

  /**
   * Convert an instance of IssueCountsFiltersFilters to an JSON string
   *
   * @return JSON string
   */
