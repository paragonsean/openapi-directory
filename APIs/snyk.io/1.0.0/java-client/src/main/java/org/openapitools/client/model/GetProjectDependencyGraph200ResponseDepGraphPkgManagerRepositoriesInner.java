...
public class GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner {
  public static final String SERIALIZED_NAME_ALIAS = "alias";
  @SerializedName(SERIALIZED_NAME_ALIAS)
  private String alias;

  public GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner() {
  }

  public GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner getProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner = (GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner) o;
    return Objects.equals(this.alias, getProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.alias);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner
   */
  public static GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraphPkgManagerRepositoriesInner to an JSON string
   *
   * @return JSON string
   */
