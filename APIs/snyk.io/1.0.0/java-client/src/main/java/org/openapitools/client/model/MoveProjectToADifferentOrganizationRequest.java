...
public class MoveProjectToADifferentOrganizationRequest {
  public static final String SERIALIZED_NAME_TARGET_ORG_ID = "targetOrgId";
  @SerializedName(SERIALIZED_NAME_TARGET_ORG_ID)
  private String targetOrgId;

  public MoveProjectToADifferentOrganizationRequest() {
  }

  public MoveProjectToADifferentOrganizationRequest targetOrgId(String targetOrgId) {
  ...
  public boolean equals(Object o) {
    ...
    MoveProjectToADifferentOrganizationRequest moveProjectToADifferentOrganizationRequest = (MoveProjectToADifferentOrganizationRequest) o;
    return Objects.equals(this.targetOrgId, moveProjectToADifferentOrganizationRequest.targetOrgId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetOrgId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MoveProjectToADifferentOrganizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MoveProjectToADifferentOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MoveProjectToADifferentOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MoveProjectToADifferentOrganizationRequest is not found in the empty JSON string", MoveProjectToADifferentOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MoveProjectToADifferentOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MoveProjectToADifferentOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("targetOrgId") != null && !jsonObj.get("targetOrgId").isJsonNull()) && !jsonObj.get("targetOrgId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `targetOrgId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetOrgId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MoveProjectToADifferentOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MoveProjectToADifferentOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MoveProjectToADifferentOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MoveProjectToADifferentOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MoveProjectToADifferentOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, MoveProjectToADifferentOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MoveProjectToADifferentOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MoveProjectToADifferentOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MoveProjectToADifferentOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to MoveProjectToADifferentOrganizationRequest
   */
  public static MoveProjectToADifferentOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MoveProjectToADifferentOrganizationRequest.class);
  }

  /**
   * Convert an instance of MoveProjectToADifferentOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
