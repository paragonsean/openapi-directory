...
import org.openapitools.client.model.ListAllProjectSnapshotsRequestFilters;
...
public class ListAllProjectSnapshotsRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private ListAllProjectSnapshotsRequestFilters filters;

  public ListAllProjectSnapshotsRequest() {
  }

  public ListAllProjectSnapshotsRequest filters(ListAllProjectSnapshotsRequestFilters filters) {
  ...
  public ListAllProjectSnapshotsRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(ListAllProjectSnapshotsRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectSnapshotsRequest listAllProjectSnapshotsRequest = (ListAllProjectSnapshotsRequest) o;
    return Objects.equals(this.filters, listAllProjectSnapshotsRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjectSnapshotsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectSnapshotsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectSnapshotsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectSnapshotsRequest is not found in the empty JSON string", ListAllProjectSnapshotsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectSnapshotsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectSnapshotsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ListAllProjectSnapshotsRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectSnapshotsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectSnapshotsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectSnapshotsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectSnapshotsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectSnapshotsRequest>() {
           @Override
           public void write(JsonWriter out, ListAllProjectSnapshotsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectSnapshotsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectSnapshotsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectSnapshotsRequest
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectSnapshotsRequest
   */
  public static ListAllProjectSnapshotsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectSnapshotsRequest.class);
  }

  /**
   * Convert an instance of ListAllProjectSnapshotsRequest to an JSON string
   *
   * @return JSON string
   */
