...
public class TestPackageJsonPackageLockJsonFileRequestFilesTarget {
  public static final String SERIALIZED_NAME_CONTENTS = "contents";
  @SerializedName(SERIALIZED_NAME_CONTENTS)
  private String contents;

  public TestPackageJsonPackageLockJsonFileRequestFilesTarget() {
  }

  public TestPackageJsonPackageLockJsonFileRequestFilesTarget contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    TestPackageJsonPackageLockJsonFileRequestFilesTarget testPackageJsonPackageLockJsonFileRequestFilesTarget = (TestPackageJsonPackageLockJsonFileRequestFilesTarget) o;
    return Objects.equals(this.contents, testPackageJsonPackageLockJsonFileRequestFilesTarget.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestPackageJsonPackageLockJsonFileRequestFilesTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestPackageJsonPackageLockJsonFileRequestFilesTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestPackageJsonPackageLockJsonFileRequestFilesTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestPackageJsonPackageLockJsonFileRequestFilesTarget is not found in the empty JSON string", TestPackageJsonPackageLockJsonFileRequestFilesTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestPackageJsonPackageLockJsonFileRequestFilesTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestPackageJsonPackageLockJsonFileRequestFilesTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestPackageJsonPackageLockJsonFileRequestFilesTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestPackageJsonPackageLockJsonFileRequestFilesTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestPackageJsonPackageLockJsonFileRequestFilesTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestPackageJsonPackageLockJsonFileRequestFilesTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestPackageJsonPackageLockJsonFileRequestFilesTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<TestPackageJsonPackageLockJsonFileRequestFilesTarget>() {
           @Override
           public void write(JsonWriter out, TestPackageJsonPackageLockJsonFileRequestFilesTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestPackageJsonPackageLockJsonFileRequestFilesTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestPackageJsonPackageLockJsonFileRequestFilesTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestPackageJsonPackageLockJsonFileRequestFilesTarget
   * @throws IOException if the JSON string is invalid with respect to TestPackageJsonPackageLockJsonFileRequestFilesTarget
   */
  public static TestPackageJsonPackageLockJsonFileRequestFilesTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestPackageJsonPackageLockJsonFileRequestFilesTarget.class);
  }

  /**
   * Convert an instance of TestPackageJsonPackageLockJsonFileRequestFilesTarget to an JSON string
   *
   * @return JSON string
   */
