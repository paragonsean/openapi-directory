...
public class ImportTargetsRequestAnyOf3Target {
  ...
  public static final String SERIALIZED_NAME_REPO_SLUG = "repoSlug";
  @SerializedName(SERIALIZED_NAME_REPO_SLUG)
  private String repoSlug;

  public ImportTargetsRequestAnyOf3Target() {
  }

  public ImportTargetsRequestAnyOf3Target branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf3Target name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf3Target projectKey(String projectKey) {
  ...
  public ImportTargetsRequestAnyOf3Target repoSlug(String repoSlug) {
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf3Target importTargetsRequestAnyOf3Target = (ImportTargetsRequestAnyOf3Target) o;
    return Objects.equals(this.branch, importTargetsRequestAnyOf3Target.branch) &&
        Objects.equals(this.name, importTargetsRequestAnyOf3Target.name) &&
        Objects.equals(this.projectKey, importTargetsRequestAnyOf3Target.projectKey) &&
        Objects.equals(this.repoSlug, importTargetsRequestAnyOf3Target.repoSlug);
  }

  @Override
  public int hashCode() {
    return Objects.hash(branch, name, projectKey, repoSlug);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportTargetsRequestAnyOf3Target {\n");
  ...
  static {
    ...
    openapiFields.add("repoSlug");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("projectKey");
    openapiRequiredFields.add("repoSlug");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf3Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf3Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf3Target is not found in the empty JSON string", ImportTargetsRequestAnyOf3Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf3Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf3Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf3Target.openapiRequiredFields) {
      ...
      if (!jsonObj.get("repoSlug").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `repoSlug` to be a primitive type in the JSON string but got `%s`", jsonObj.get("repoSlug").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf3Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf3Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf3Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf3Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf3Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf3Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf3Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf3Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf3Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf3Target
   */
  public static ImportTargetsRequestAnyOf3Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf3Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf3Target to an JSON string
   *
   * @return JSON string
   */
