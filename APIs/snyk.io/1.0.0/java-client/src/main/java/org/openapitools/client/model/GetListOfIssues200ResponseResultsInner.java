...
import org.openapitools.client.model.GetListOfIssues200ResponseResultsInnerOneOf;
import org.openapitools.client.model.GetListOfIssues200ResponseResultsInnerOneOf1;
import org.openapitools.client.model.GetListOfIssues200ResponseResultsInnerOneOf1Project;
...
public class GetListOfIssues200ResponseResultsInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetListOfIssues200ResponseResultsInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetListOfIssues200ResponseResultsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetListOfIssues200ResponseResultsInner' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf> adapterGetListOfIssues200ResponseResultsInnerOneOf = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssues200ResponseResultsInnerOneOf.class));
            final TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf1> adapterGetListOfIssues200ResponseResultsInnerOneOf1 = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssues200ResponseResultsInnerOneOf1.class));

            return (TypeAdapter<T>) new TypeAdapter<GetListOfIssues200ResponseResultsInner>() {
                @Override
                public void write(JsonWriter out, GetListOfIssues200ResponseResultsInner value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `GetListOfIssues200ResponseResultsInnerOneOf`
                    if (value.getActualInstance() instanceof GetListOfIssues200ResponseResultsInnerOneOf) {
                        JsonElement element = adapterGetListOfIssues200ResponseResultsInnerOneOf.toJsonTree((GetListOfIssues200ResponseResultsInnerOneOf)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `GetListOfIssues200ResponseResultsInnerOneOf1`
                    if (value.getActualInstance() instanceof GetListOfIssues200ResponseResultsInnerOneOf1) {
                        JsonElement element = adapterGetListOfIssues200ResponseResultsInnerOneOf1.toJsonTree((GetListOfIssues200ResponseResultsInnerOneOf1)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: GetListOfIssues200ResponseResultsInnerOneOf, GetListOfIssues200ResponseResultsInnerOneOf1");
                }

                @Override
                public GetListOfIssues200ResponseResultsInner read(JsonReader in) throws IOException {
                    ...
                    // deserialize GetListOfIssues200ResponseResultsInnerOneOf
                    try {
                        // validate the JSON object to see if any exception is thrown
                        GetListOfIssues200ResponseResultsInnerOneOf.validateJsonElement(jsonElement);
                        actualAdapter = adapterGetListOfIssues200ResponseResultsInnerOneOf;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'GetListOfIssues200ResponseResultsInnerOneOf'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for GetListOfIssues200ResponseResultsInnerOneOf failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'GetListOfIssues200ResponseResultsInnerOneOf'", e);
                    }
                    // deserialize GetListOfIssues200ResponseResultsInnerOneOf1
                    try {
                        // validate the JSON object to see if any exception is thrown
                        GetListOfIssues200ResponseResultsInnerOneOf1.validateJsonElement(jsonElement);
                        actualAdapter = adapterGetListOfIssues200ResponseResultsInnerOneOf1;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'GetListOfIssues200ResponseResultsInnerOneOf1'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for GetListOfIssues200ResponseResultsInnerOneOf1 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'GetListOfIssues200ResponseResultsInnerOneOf1'", e);
                    }

                    if (match == 1) {
                        GetListOfIssues200ResponseResultsInner ret = new GetListOfIssues200ResponseResultsInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetListOfIssues200ResponseResultsInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetListOfIssues200ResponseResultsInner() {
        super("oneOf", Boolean.FALSE);
    }

    public GetListOfIssues200ResponseResultsInner(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("GetListOfIssues200ResponseResultsInnerOneOf", GetListOfIssues200ResponseResultsInnerOneOf.class);
        schemas.put("GetListOfIssues200ResponseResultsInnerOneOf1", GetListOfIssues200ResponseResultsInnerOneOf1.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return GetListOfIssues200ResponseResultsInner.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * GetListOfIssues200ResponseResultsInnerOneOf, GetListOfIssues200ResponseResultsInnerOneOf1
     *
     * It could be an instance of the 'oneOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof GetListOfIssues200ResponseResultsInnerOneOf) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof GetListOfIssues200ResponseResultsInnerOneOf1) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be GetListOfIssues200ResponseResultsInnerOneOf, GetListOfIssues200ResponseResultsInnerOneOf1");
    }
     ...
     * GetListOfIssues200ResponseResultsInnerOneOf, GetListOfIssues200ResponseResultsInnerOneOf1
     *
     * @return The actual instance (GetListOfIssues200ResponseResultsInnerOneOf, GetListOfIssues200ResponseResultsInnerOneOf1)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `GetListOfIssues200ResponseResultsInnerOneOf`. If the actual instance is not `GetListOfIssues200ResponseResultsInnerOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `GetListOfIssues200ResponseResultsInnerOneOf`
     * @throws ClassCastException if the instance is not `GetListOfIssues200ResponseResultsInnerOneOf`
     */
    public GetListOfIssues200ResponseResultsInnerOneOf getGetListOfIssues200ResponseResultsInnerOneOf() throws ClassCastException {
        return (GetListOfIssues200ResponseResultsInnerOneOf)super.getActualInstance();
    }
    /**
     * Get the actual instance of `GetListOfIssues200ResponseResultsInnerOneOf1`. If the actual instance is not `GetListOfIssues200ResponseResultsInnerOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `GetListOfIssues200ResponseResultsInnerOneOf1`
     * @throws ClassCastException if the instance is not `GetListOfIssues200ResponseResultsInnerOneOf1`
     */
    public GetListOfIssues200ResponseResultsInnerOneOf1 getGetListOfIssues200ResponseResultsInnerOneOf1() throws ClassCastException {
        return (GetListOfIssues200ResponseResultsInnerOneOf1)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetListOfIssues200ResponseResultsInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate oneOf schemas one by one
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with GetListOfIssues200ResponseResultsInnerOneOf
        try {
            GetListOfIssues200ResponseResultsInnerOneOf.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with GetListOfIssues200ResponseResultsInnerOneOf1
        try {
            GetListOfIssues200ResponseResultsInnerOneOf1.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for GetListOfIssues200ResponseResultsInner with oneOf schemas: GetListOfIssues200ResponseResultsInnerOneOf, GetListOfIssues200ResponseResultsInnerOneOf1. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of GetListOfIssues200ResponseResultsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetListOfIssues200ResponseResultsInner
     * @throws IOException if the JSON string is invalid with respect to GetListOfIssues200ResponseResultsInner
     */
    public static GetListOfIssues200ResponseResultsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetListOfIssues200ResponseResultsInner.class);
    }

    /**
     * Convert an instance of GetListOfIssues200ResponseResultsInner to an JSON string
     *
     * @return JSON string
     */
