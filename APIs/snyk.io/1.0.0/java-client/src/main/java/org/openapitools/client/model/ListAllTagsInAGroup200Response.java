...
public class ListAllTagsInAGroup200Response {
  public static final String SERIALIZED_NAME_TAGS = "tags";
  @SerializedName(SERIALIZED_NAME_TAGS)
  private List<Object> tags = new ArrayList<>();

  public ListAllTagsInAGroup200Response() {
  }

  public ListAllTagsInAGroup200Response tags(List<Object> tags) {
    this.tags = tags;
    return this;
  }

  public ListAllTagsInAGroup200Response addTagsItem(Object tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllTagsInAGroup200Response listAllTagsInAGroup200Response = (ListAllTagsInAGroup200Response) o;
    return Objects.equals(this.tags, listAllTagsInAGroup200Response.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllTagsInAGroup200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllTagsInAGroup200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllTagsInAGroup200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllTagsInAGroup200Response is not found in the empty JSON string", ListAllTagsInAGroup200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllTagsInAGroup200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllTagsInAGroup200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllTagsInAGroup200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllTagsInAGroup200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllTagsInAGroup200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllTagsInAGroup200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllTagsInAGroup200Response>() {
           @Override
           public void write(JsonWriter out, ListAllTagsInAGroup200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllTagsInAGroup200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllTagsInAGroup200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllTagsInAGroup200Response
   * @throws IOException if the JSON string is invalid with respect to ListAllTagsInAGroup200Response
   */
  public static ListAllTagsInAGroup200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllTagsInAGroup200Response.class);
  }

  /**
   * Convert an instance of ListAllTagsInAGroup200Response to an JSON string
   *
   * @return JSON string
   */
