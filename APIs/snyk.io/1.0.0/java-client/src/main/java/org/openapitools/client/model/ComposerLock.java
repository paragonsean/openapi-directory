...
public class ComposerLock {
  ...
  public ComposerLock contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    ComposerLock composerLock = (ComposerLock) o;
    return Objects.equals(this.contents, composerLock.contents);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComposerLock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComposerLock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComposerLock is not found in the empty JSON string", ComposerLock.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComposerLock.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComposerLock` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComposerLock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComposerLock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComposerLock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComposerLock.class));

       return (TypeAdapter<T>) new TypeAdapter<ComposerLock>() {
           @Override
           public void write(JsonWriter out, ComposerLock value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComposerLock read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComposerLock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComposerLock
   * @throws IOException if the JSON string is invalid with respect to ComposerLock
   */
  public static ComposerLock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComposerLock.class);
  }

  /**
   * Convert an instance of ComposerLock to an JSON string
   *
   * @return JSON string
   */
