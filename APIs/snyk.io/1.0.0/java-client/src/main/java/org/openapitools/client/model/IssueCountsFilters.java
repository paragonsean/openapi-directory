...
import org.openapitools.client.model.IssueCountsFiltersFilters;
...
public class IssueCountsFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private IssueCountsFiltersFilters filters;

  public IssueCountsFilters() {
  }

  public IssueCountsFilters filters(IssueCountsFiltersFilters filters) {
  ...
  public IssueCountsFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(IssueCountsFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    IssueCountsFilters issueCountsFilters = (IssueCountsFilters) o;
    return Objects.equals(this.filters, issueCountsFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueCountsFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueCountsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueCountsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssueCountsFilters is not found in the empty JSON string", IssueCountsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueCountsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssueCountsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        IssueCountsFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssueCountsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssueCountsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssueCountsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssueCountsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<IssueCountsFilters>() {
           @Override
           public void write(JsonWriter out, IssueCountsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssueCountsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssueCountsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssueCountsFilters
   * @throws IOException if the JSON string is invalid with respect to IssueCountsFilters
   */
  public static IssueCountsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssueCountsFilters.class);
  }

  /**
   * Convert an instance of IssueCountsFilters to an JSON string
   *
   * @return JSON string
   */
