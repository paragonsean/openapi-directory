...
public class ImportTargetsRequestAnyOf5Target {
  public static final String SERIALIZED_NAME_FUNCTION_ID = "functionId";
  @SerializedName(SERIALIZED_NAME_FUNCTION_ID)
  private String functionId;

  public ImportTargetsRequestAnyOf5Target() {
  }

  public ImportTargetsRequestAnyOf5Target functionId(String functionId) {
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf5Target importTargetsRequestAnyOf5Target = (ImportTargetsRequestAnyOf5Target) o;
    return Objects.equals(this.functionId, importTargetsRequestAnyOf5Target.functionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf5Target {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf5Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf5Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf5Target is not found in the empty JSON string", ImportTargetsRequestAnyOf5Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf5Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf5Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf5Target.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf5Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf5Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf5Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf5Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf5Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf5Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf5Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf5Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf5Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf5Target
   */
  public static ImportTargetsRequestAnyOf5Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf5Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf5Target to an JSON string
   *
   * @return JSON string
   */
