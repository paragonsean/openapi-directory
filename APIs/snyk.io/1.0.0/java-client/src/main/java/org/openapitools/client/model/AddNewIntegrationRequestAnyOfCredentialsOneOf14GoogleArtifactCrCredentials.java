...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials password(String password) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials registryBase(String registryBase) {
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials addNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials = (AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials) o;
    return Objects.equals(this.password, addNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.password) &&
        Objects.equals(this.registryBase, addNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.registryBase);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials to an JSON string
   *
   * @return JSON string
   */
