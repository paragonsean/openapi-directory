...
public class GetIssueCounts200Response {
  public static final String SERIALIZED_NAME_RESULTS = "results";
  @SerializedName(SERIALIZED_NAME_RESULTS)
  private List<GetIssueCounts200ResponseResultsInner> results = new ArrayList<>();

  public GetIssueCounts200Response() {
  }

  public GetIssueCounts200Response results(List<GetIssueCounts200ResponseResultsInner> results) {
    this.results = results;
    return this;
  }

  public GetIssueCounts200Response addResultsItem(GetIssueCounts200ResponseResultsInner resultsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCounts200Response getIssueCounts200Response = (GetIssueCounts200Response) o;
    return Objects.equals(this.results, getIssueCounts200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIssueCounts200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCounts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCounts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCounts200Response is not found in the empty JSON string", GetIssueCounts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCounts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCounts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIssueCounts200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCounts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCounts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCounts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCounts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCounts200Response>() {
           @Override
           public void write(JsonWriter out, GetIssueCounts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCounts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCounts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCounts200Response
   * @throws IOException if the JSON string is invalid with respect to GetIssueCounts200Response
   */
  public static GetIssueCounts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCounts200Response.class);
  }

  /**
   * Convert an instance of GetIssueCounts200Response to an JSON string
   *
   * @return JSON string
   */
