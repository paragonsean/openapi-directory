...
public class RetrieveASingleProject200ResponseAttributes {
  ...
  public RetrieveASingleProject200ResponseAttributes() {
  }

  public RetrieveASingleProject200ResponseAttributes criticality(List<Object> criticality) {
    this.criticality = criticality;
    return this;
  }

  public RetrieveASingleProject200ResponseAttributes addCriticalityItem(Object criticalityItem) {
  ...
  public RetrieveASingleProject200ResponseAttributes environment(List<Object> environment) {
    this.environment = environment;
    return this;
  }

  public RetrieveASingleProject200ResponseAttributes addEnvironmentItem(Object environmentItem) {
  ...
  public RetrieveASingleProject200ResponseAttributes lifecycle(List<Object> lifecycle) {
    this.lifecycle = lifecycle;
    return this;
  }

  public RetrieveASingleProject200ResponseAttributes addLifecycleItem(Object lifecycleItem) {
  ...
  public boolean equals(Object o) {
    ...
    RetrieveASingleProject200ResponseAttributes retrieveASingleProject200ResponseAttributes = (RetrieveASingleProject200ResponseAttributes) o;
    return Objects.equals(this.criticality, retrieveASingleProject200ResponseAttributes.criticality) &&
        Objects.equals(this.environment, retrieveASingleProject200ResponseAttributes.environment) &&
        Objects.equals(this.lifecycle, retrieveASingleProject200ResponseAttributes.lifecycle);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveASingleProject200ResponseAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveASingleProject200ResponseAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveASingleProject200ResponseAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveASingleProject200ResponseAttributes is not found in the empty JSON string", RetrieveASingleProject200ResponseAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveASingleProject200ResponseAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveASingleProject200ResponseAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveASingleProject200ResponseAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveASingleProject200ResponseAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveASingleProject200ResponseAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveASingleProject200ResponseAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveASingleProject200ResponseAttributes>() {
           @Override
           public void write(JsonWriter out, RetrieveASingleProject200ResponseAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveASingleProject200ResponseAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveASingleProject200ResponseAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveASingleProject200ResponseAttributes
   * @throws IOException if the JSON string is invalid with respect to RetrieveASingleProject200ResponseAttributes
   */
  public static RetrieveASingleProject200ResponseAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveASingleProject200ResponseAttributes.class);
  }

  /**
   * Convert an instance of RetrieveASingleProject200ResponseAttributes to an JSON string
   *
   * @return JSON string
   */
