...
public class UpdateExistingIntegrationRequestAnyOf {
  ...
  public UpdateExistingIntegrationRequestAnyOf() {
  }

  public UpdateExistingIntegrationRequestAnyOf broker(AddNewIntegrationRequestAnyOf1Broker broker) {
    this.broker = broker;
    return this;
  }
  ...
  public UpdateExistingIntegrationRequestAnyOf type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateExistingIntegrationRequestAnyOf updateExistingIntegrationRequestAnyOf = (UpdateExistingIntegrationRequestAnyOf) o;
    return Objects.equals(this.broker, updateExistingIntegrationRequestAnyOf.broker) &&
        Objects.equals(this.type, updateExistingIntegrationRequestAnyOf.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateExistingIntegrationRequestAnyOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateExistingIntegrationRequestAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateExistingIntegrationRequestAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateExistingIntegrationRequestAnyOf is not found in the empty JSON string", UpdateExistingIntegrationRequestAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateExistingIntegrationRequestAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateExistingIntegrationRequestAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateExistingIntegrationRequestAnyOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateExistingIntegrationRequestAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateExistingIntegrationRequestAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateExistingIntegrationRequestAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateExistingIntegrationRequestAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateExistingIntegrationRequestAnyOf>() {
           @Override
           public void write(JsonWriter out, UpdateExistingIntegrationRequestAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateExistingIntegrationRequestAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateExistingIntegrationRequestAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateExistingIntegrationRequestAnyOf
   * @throws IOException if the JSON string is invalid with respect to UpdateExistingIntegrationRequestAnyOf
   */
  public static UpdateExistingIntegrationRequestAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateExistingIntegrationRequestAnyOf.class);
  }

  /**
   * Convert an instance of UpdateExistingIntegrationRequestAnyOf to an JSON string
   *
   * @return JSON string
   */
