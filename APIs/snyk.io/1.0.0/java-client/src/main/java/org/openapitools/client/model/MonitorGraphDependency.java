...
public class MonitorGraphDependency {
  ...
  public MonitorGraphDependency() {
  }

  public MonitorGraphDependency nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitorGraphDependency monitorGraphDependency = (MonitorGraphDependency) o;
    return Objects.equals(this.nodeId, monitorGraphDependency.nodeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorGraphDependency {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorGraphDependency
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorGraphDependency.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorGraphDependency is not found in the empty JSON string", MonitorGraphDependency.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorGraphDependency.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorGraphDependency` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorGraphDependency.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorGraphDependency.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorGraphDependency' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorGraphDependency> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorGraphDependency.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorGraphDependency>() {
           @Override
           public void write(JsonWriter out, MonitorGraphDependency value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorGraphDependency read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorGraphDependency given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorGraphDependency
   * @throws IOException if the JSON string is invalid with respect to MonitorGraphDependency
   */
  public static MonitorGraphDependency fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorGraphDependency.class);
  }

  /**
   * Convert an instance of MonitorGraphDependency to an JSON string
   *
   * @return JSON string
   */
