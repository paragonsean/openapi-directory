...
public class AddNewIntegrationRequestAnyOf1 {
  ...
  public AddNewIntegrationRequestAnyOf1() {
  }

  public AddNewIntegrationRequestAnyOf1 broker(AddNewIntegrationRequestAnyOf1Broker broker) {
    this.broker = broker;
    return this;
  }
  ...
  public AddNewIntegrationRequestAnyOf1 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOf1 addNewIntegrationRequestAnyOf1 = (AddNewIntegrationRequestAnyOf1) o;
    return Objects.equals(this.broker, addNewIntegrationRequestAnyOf1.broker) &&
        Objects.equals(this.type, addNewIntegrationRequestAnyOf1.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(broker, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOf1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOf1 is not found in the empty JSON string", AddNewIntegrationRequestAnyOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOf1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOf1>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOf1
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOf1
   */
  public static AddNewIntegrationRequestAnyOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOf1.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOf1 to an JSON string
   *
   * @return JSON string
   */
