...
import org.openapitools.client.model.MonitorPackageInfo;
...
public class MonitorPackage {
  ...
  private MonitorPackageInfo info;

  public MonitorPackage() {
  }

  public MonitorPackage id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MonitorPackage info(MonitorPackageInfo info) {
    this.info = info;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public MonitorPackageInfo getInfo() {
    return info;
  }

  public void setInfo(MonitorPackageInfo info) {
    this.info = info;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitorPackage monitorPackage = (MonitorPackage) o;
    return Objects.equals(this.id, monitorPackage.id) &&
        Objects.equals(this.info, monitorPackage.info);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorPackage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorPackage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorPackage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorPackage is not found in the empty JSON string", MonitorPackage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorPackage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorPackage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorPackage.openapiRequiredFields) {
      ...
      MonitorPackageInfo.validateJsonElement(jsonObj.get("info"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorPackage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorPackage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorPackage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorPackage.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorPackage>() {
           @Override
           public void write(JsonWriter out, MonitorPackage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorPackage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorPackage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorPackage
   * @throws IOException if the JSON string is invalid with respect to MonitorPackage
   */
  public static MonitorPackage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorPackage.class);
  }

  /**
   * Convert an instance of MonitorPackage to an JSON string
   *
   * @return JSON string
   */
