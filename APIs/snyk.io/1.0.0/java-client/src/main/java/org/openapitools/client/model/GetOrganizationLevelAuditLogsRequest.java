...
import org.openapitools.client.model.GetOrganizationLevelAuditLogsRequestFilters;
...
public class GetOrganizationLevelAuditLogsRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetOrganizationLevelAuditLogsRequestFilters filters;

  public GetOrganizationLevelAuditLogsRequest() {
  }

  public GetOrganizationLevelAuditLogsRequest filters(GetOrganizationLevelAuditLogsRequestFilters filters) {
  ...
  public GetOrganizationLevelAuditLogsRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(GetOrganizationLevelAuditLogsRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetOrganizationLevelAuditLogsRequest getOrganizationLevelAuditLogsRequest = (GetOrganizationLevelAuditLogsRequest) o;
    return Objects.equals(this.filters, getOrganizationLevelAuditLogsRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOrganizationLevelAuditLogsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOrganizationLevelAuditLogsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOrganizationLevelAuditLogsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOrganizationLevelAuditLogsRequest is not found in the empty JSON string", GetOrganizationLevelAuditLogsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOrganizationLevelAuditLogsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOrganizationLevelAuditLogsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        GetOrganizationLevelAuditLogsRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOrganizationLevelAuditLogsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOrganizationLevelAuditLogsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOrganizationLevelAuditLogsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOrganizationLevelAuditLogsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOrganizationLevelAuditLogsRequest>() {
           @Override
           public void write(JsonWriter out, GetOrganizationLevelAuditLogsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOrganizationLevelAuditLogsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOrganizationLevelAuditLogsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOrganizationLevelAuditLogsRequest
   * @throws IOException if the JSON string is invalid with respect to GetOrganizationLevelAuditLogsRequest
   */
  public static GetOrganizationLevelAuditLogsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOrganizationLevelAuditLogsRequest.class);
  }

  /**
   * Convert an instance of GetOrganizationLevelAuditLogsRequest to an JSON string
   *
   * @return JSON string
   */
