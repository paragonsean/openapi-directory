...
public class ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers() {
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers CVE(List<Object> CVE) {
    this.CVE = CVE;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers addCVEItem(Object CVEItem) {
    if (this.CVE == null) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers CWE(List<Object> CWE) {
    this.CWE = CWE;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers addCWEItem(Object CWEItem) {
    if (this.CWE == null) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers OSVDB(List<Object> OSVDB) {
    this.OSVDB = OSVDB;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers addOSVDBItem(Object OSVDBItem) {
    if (this.OSVDB == null) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers listAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers = (ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers) o;
    return Objects.equals(this.CVE, listAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.CVE) &&
        Objects.equals(this.CWE, listAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.CWE) &&
        Objects.equals(this.OSVDB, listAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.OSVDB);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers is not found in the empty JSON string", ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers
   */
  public static ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers to an JSON string
   *
   * @return JSON string
   */
