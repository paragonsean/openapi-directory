...
import org.openapitools.client.model.OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations;
import org.openapitools.client.model.OrgOrgIdNotificationSettingsGet200ResponseProjectImported;
...
public class OrgOrgIdNotificationSettingsGet200Response {
  ...
  private OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations newIssuesRemediations;
  ...
  private OrgOrgIdNotificationSettingsGet200ResponseProjectImported projectImported;

  public static final String SERIALIZED_NAME_TEST_LIMIT = "test-limit";
  @SerializedName(SERIALIZED_NAME_TEST_LIMIT)
  private OrgOrgIdNotificationSettingsGet200ResponseProjectImported testLimit;

  public static final String SERIALIZED_NAME_WEEKLY_REPORT = "weekly-report";
  @SerializedName(SERIALIZED_NAME_WEEKLY_REPORT)
  private OrgOrgIdNotificationSettingsGet200ResponseProjectImported weeklyReport;

  public OrgOrgIdNotificationSettingsGet200Response() {
  }

  public OrgOrgIdNotificationSettingsGet200Response newIssuesRemediations(OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations newIssuesRemediations) {
  ...
  public OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations getNewIssuesRemediations() {
    return newIssuesRemediations;
  }

  public void setNewIssuesRemediations(OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations newIssuesRemediations) {
    this.newIssuesRemediations = newIssuesRemediations;
  }


  public OrgOrgIdNotificationSettingsGet200Response projectImported(OrgOrgIdNotificationSettingsGet200ResponseProjectImported projectImported) {
   ...
   */
  @javax.annotation.Nullable
  public OrgOrgIdNotificationSettingsGet200ResponseProjectImported getProjectImported() {
    return projectImported;
  }

  public void setProjectImported(OrgOrgIdNotificationSettingsGet200ResponseProjectImported projectImported) {
    this.projectImported = projectImported;
  }


  public OrgOrgIdNotificationSettingsGet200Response testLimit(OrgOrgIdNotificationSettingsGet200ResponseProjectImported testLimit) {
   ...
   */
  @javax.annotation.Nullable
  public OrgOrgIdNotificationSettingsGet200ResponseProjectImported getTestLimit() {
    return testLimit;
  }

  public void setTestLimit(OrgOrgIdNotificationSettingsGet200ResponseProjectImported testLimit) {
    this.testLimit = testLimit;
  }


  public OrgOrgIdNotificationSettingsGet200Response weeklyReport(OrgOrgIdNotificationSettingsGet200ResponseProjectImported weeklyReport) {
   ...
   */
  @javax.annotation.Nullable
  public OrgOrgIdNotificationSettingsGet200ResponseProjectImported getWeeklyReport() {
    return weeklyReport;
  }

  public void setWeeklyReport(OrgOrgIdNotificationSettingsGet200ResponseProjectImported weeklyReport) {
    this.weeklyReport = weeklyReport;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrgOrgIdNotificationSettingsGet200Response orgOrgIdNotificationSettingsGet200Response = (OrgOrgIdNotificationSettingsGet200Response) o;
    return Objects.equals(this.newIssuesRemediations, orgOrgIdNotificationSettingsGet200Response.newIssuesRemediations) &&
        Objects.equals(this.projectImported, orgOrgIdNotificationSettingsGet200Response.projectImported) &&
        Objects.equals(this.testLimit, orgOrgIdNotificationSettingsGet200Response.testLimit) &&
        Objects.equals(this.weeklyReport, orgOrgIdNotificationSettingsGet200Response.weeklyReport);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgOrgIdNotificationSettingsGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgOrgIdNotificationSettingsGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgOrgIdNotificationSettingsGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgOrgIdNotificationSettingsGet200Response is not found in the empty JSON string", OrgOrgIdNotificationSettingsGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgOrgIdNotificationSettingsGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrgOrgIdNotificationSettingsGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("new-issues-remediations") != null && !jsonObj.get("new-issues-remediations").isJsonNull()) {
        OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.validateJsonElement(jsonObj.get("new-issues-remediations"));
      }
      // validate the optional field `project-imported`
      if (jsonObj.get("project-imported") != null && !jsonObj.get("project-imported").isJsonNull()) {
        OrgOrgIdNotificationSettingsGet200ResponseProjectImported.validateJsonElement(jsonObj.get("project-imported"));
      }
      // validate the optional field `test-limit`
      if (jsonObj.get("test-limit") != null && !jsonObj.get("test-limit").isJsonNull()) {
        OrgOrgIdNotificationSettingsGet200ResponseProjectImported.validateJsonElement(jsonObj.get("test-limit"));
      }
      // validate the optional field `weekly-report`
      if (jsonObj.get("weekly-report") != null && !jsonObj.get("weekly-report").isJsonNull()) {
        OrgOrgIdNotificationSettingsGet200ResponseProjectImported.validateJsonElement(jsonObj.get("weekly-report"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgOrgIdNotificationSettingsGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgOrgIdNotificationSettingsGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgOrgIdNotificationSettingsGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgOrgIdNotificationSettingsGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgOrgIdNotificationSettingsGet200Response>() {
           @Override
           public void write(JsonWriter out, OrgOrgIdNotificationSettingsGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgOrgIdNotificationSettingsGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgOrgIdNotificationSettingsGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgOrgIdNotificationSettingsGet200Response
   * @throws IOException if the JSON string is invalid with respect to OrgOrgIdNotificationSettingsGet200Response
   */
  public static OrgOrgIdNotificationSettingsGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgOrgIdNotificationSettingsGet200Response.class);
  }

  /**
   * Convert an instance of OrgOrgIdNotificationSettingsGet200Response to an JSON string
   *
   * @return JSON string
   */
