...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOf1Broker;
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentials;
...
public class UpdateExistingIntegrationRequestAnyOf2 {
  public static final String SERIALIZED_NAME_BROKER = "broker";
  @SerializedName(SERIALIZED_NAME_BROKER)
  private AddNewIntegrationRequestAnyOf1Broker broker;

  public static final String SERIALIZED_NAME_CREDENTIALS = "credentials";
  @SerializedName(SERIALIZED_NAME_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentials credentials;
  ...
  public UpdateExistingIntegrationRequestAnyOf2() {
  }

  public UpdateExistingIntegrationRequestAnyOf2 broker(AddNewIntegrationRequestAnyOf1Broker broker) {
    this.broker = broker;
    return this;
  }
  ...
  public AddNewIntegrationRequestAnyOf1Broker getBroker() {
    return broker;
  }

  public void setBroker(AddNewIntegrationRequestAnyOf1Broker broker) {
    this.broker = broker;
  }


  public UpdateExistingIntegrationRequestAnyOf2 credentials(AddNewIntegrationRequestAnyOfCredentials credentials) {
   ...
   */
  @javax.annotation.Nonnull
  public AddNewIntegrationRequestAnyOfCredentials getCredentials() {
    return credentials;
  }

  public void setCredentials(AddNewIntegrationRequestAnyOfCredentials credentials) {
    this.credentials = credentials;
  }


  public UpdateExistingIntegrationRequestAnyOf2 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateExistingIntegrationRequestAnyOf2 updateExistingIntegrationRequestAnyOf2 = (UpdateExistingIntegrationRequestAnyOf2) o;
    return Objects.equals(this.broker, updateExistingIntegrationRequestAnyOf2.broker) &&
        Objects.equals(this.credentials, updateExistingIntegrationRequestAnyOf2.credentials) &&
        Objects.equals(this.type, updateExistingIntegrationRequestAnyOf2.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(broker, credentials, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateExistingIntegrationRequestAnyOf2 {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("broker");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateExistingIntegrationRequestAnyOf2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateExistingIntegrationRequestAnyOf2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateExistingIntegrationRequestAnyOf2 is not found in the empty JSON string", UpdateExistingIntegrationRequestAnyOf2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateExistingIntegrationRequestAnyOf2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateExistingIntegrationRequestAnyOf2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateExistingIntegrationRequestAnyOf2.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `broker`
      AddNewIntegrationRequestAnyOf1Broker.validateJsonElement(jsonObj.get("broker"));
      // validate the required field `credentials`
      AddNewIntegrationRequestAnyOfCredentials.validateJsonElement(jsonObj.get("credentials"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateExistingIntegrationRequestAnyOf2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateExistingIntegrationRequestAnyOf2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateExistingIntegrationRequestAnyOf2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateExistingIntegrationRequestAnyOf2.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateExistingIntegrationRequestAnyOf2>() {
           @Override
           public void write(JsonWriter out, UpdateExistingIntegrationRequestAnyOf2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateExistingIntegrationRequestAnyOf2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateExistingIntegrationRequestAnyOf2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateExistingIntegrationRequestAnyOf2
   * @throws IOException if the JSON string is invalid with respect to UpdateExistingIntegrationRequestAnyOf2
   */
  public static UpdateExistingIntegrationRequestAnyOf2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateExistingIntegrationRequestAnyOf2.class);
  }

  /**
   * Convert an instance of UpdateExistingIntegrationRequestAnyOf2 to an JSON string
   *
   * @return JSON string
   */
