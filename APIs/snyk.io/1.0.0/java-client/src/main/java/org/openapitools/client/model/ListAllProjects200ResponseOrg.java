...
public class ListAllProjects200ResponseOrg {
  ...
  public ListAllProjects200ResponseOrg() {
  }

  public ListAllProjects200ResponseOrg id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllProjects200ResponseOrg name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjects200ResponseOrg listAllProjects200ResponseOrg = (ListAllProjects200ResponseOrg) o;
    return Objects.equals(this.id, listAllProjects200ResponseOrg.id) &&
        Objects.equals(this.name, listAllProjects200ResponseOrg.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjects200ResponseOrg {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjects200ResponseOrg
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjects200ResponseOrg.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjects200ResponseOrg is not found in the empty JSON string", ListAllProjects200ResponseOrg.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjects200ResponseOrg.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjects200ResponseOrg` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjects200ResponseOrg.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjects200ResponseOrg' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjects200ResponseOrg> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjects200ResponseOrg.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjects200ResponseOrg>() {
           @Override
           public void write(JsonWriter out, ListAllProjects200ResponseOrg value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjects200ResponseOrg read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjects200ResponseOrg given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjects200ResponseOrg
   * @throws IOException if the JSON string is invalid with respect to ListAllProjects200ResponseOrg
   */
  public static ListAllProjects200ResponseOrg fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjects200ResponseOrg.class);
  }

  /**
   * Convert an instance of ListAllProjects200ResponseOrg to an JSON string
   *
   * @return JSON string
   */
