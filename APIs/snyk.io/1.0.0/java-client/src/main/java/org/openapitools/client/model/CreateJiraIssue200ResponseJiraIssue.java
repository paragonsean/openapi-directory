...
public class CreateJiraIssue200ResponseJiraIssue {
  ...
  public CreateJiraIssue200ResponseJiraIssue() {
  }

  public CreateJiraIssue200ResponseJiraIssue id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateJiraIssue200ResponseJiraIssue key(String key) {
    this.key = key;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateJiraIssue200ResponseJiraIssue createJiraIssue200ResponseJiraIssue = (CreateJiraIssue200ResponseJiraIssue) o;
    return Objects.equals(this.id, createJiraIssue200ResponseJiraIssue.id) &&
        Objects.equals(this.key, createJiraIssue200ResponseJiraIssue.key);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJiraIssue200ResponseJiraIssue {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJiraIssue200ResponseJiraIssue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJiraIssue200ResponseJiraIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJiraIssue200ResponseJiraIssue is not found in the empty JSON string", CreateJiraIssue200ResponseJiraIssue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJiraIssue200ResponseJiraIssue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJiraIssue200ResponseJiraIssue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJiraIssue200ResponseJiraIssue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJiraIssue200ResponseJiraIssue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJiraIssue200ResponseJiraIssue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJiraIssue200ResponseJiraIssue.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJiraIssue200ResponseJiraIssue>() {
           @Override
           public void write(JsonWriter out, CreateJiraIssue200ResponseJiraIssue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJiraIssue200ResponseJiraIssue read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJiraIssue200ResponseJiraIssue given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJiraIssue200ResponseJiraIssue
   * @throws IOException if the JSON string is invalid with respect to CreateJiraIssue200ResponseJiraIssue
   */
  public static CreateJiraIssue200ResponseJiraIssue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJiraIssue200ResponseJiraIssue.class);
  }

  /**
   * Convert an instance of CreateJiraIssue200ResponseJiraIssue to an JSON string
   *
   * @return JSON string
   */
