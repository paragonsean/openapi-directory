...
import org.openapitools.client.model.GetTestCountsRequestFilters;
...
public class GetTestCountsRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetTestCountsRequestFilters filters;

  public GetTestCountsRequest() {
  }

  public GetTestCountsRequest filters(GetTestCountsRequestFilters filters) {
  ...
  public GetTestCountsRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(GetTestCountsRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTestCountsRequest getTestCountsRequest = (GetTestCountsRequest) o;
    return Objects.equals(this.filters, getTestCountsRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTestCountsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTestCountsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTestCountsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTestCountsRequest is not found in the empty JSON string", GetTestCountsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTestCountsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTestCountsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        GetTestCountsRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTestCountsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTestCountsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTestCountsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTestCountsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTestCountsRequest>() {
           @Override
           public void write(JsonWriter out, GetTestCountsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTestCountsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTestCountsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTestCountsRequest
   * @throws IOException if the JSON string is invalid with respect to GetTestCountsRequest
   */
  public static GetTestCountsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTestCountsRequest.class);
  }

  /**
   * Convert an instance of GetTestCountsRequest to an JSON string
   *
   * @return JSON string
   */
