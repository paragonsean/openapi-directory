...
import org.openapitools.client.model.UpdateAProjectRequestOwner;
...
public class UpdateAProjectRequest {
  ...
  private UpdateAProjectRequestOwner owner;

  public UpdateAProjectRequest() {
  }

  public UpdateAProjectRequest branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public UpdateAProjectRequest owner(UpdateAProjectRequestOwner owner) {
    this.owner = owner;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public UpdateAProjectRequestOwner getOwner() {
    return owner;
  }

  public void setOwner(UpdateAProjectRequestOwner owner) {
    this.owner = owner;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.branch, updateAProjectRequest.branch) &&
        Objects.equals(this.owner, updateAProjectRequest.owner);
  }

  @Override
  public int hashCode() {
    return Objects.hash(branch, owner);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAProjectRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAProjectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAProjectRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAProjectRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("owner") != null && !jsonObj.get("owner").isJsonNull()) {
        UpdateAProjectRequestOwner.validateJsonElement(jsonObj.get("owner"));
      }
  }
