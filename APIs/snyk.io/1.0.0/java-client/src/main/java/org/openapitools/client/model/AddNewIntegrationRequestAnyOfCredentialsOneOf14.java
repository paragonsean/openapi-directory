...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf14 {
  public static final String SERIALIZED_NAME_GOOGLE_ARTIFACT_CR_CREDENTIALS = "GoogleArtifactCrCredentials";
  @SerializedName(SERIALIZED_NAME_GOOGLE_ARTIFACT_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials googleArtifactCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf14() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf14 googleArtifactCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials googleArtifactCrCredentials) {
    this.googleArtifactCrCredentials = googleArtifactCrCredentials;
    return this;
  }

  /**
   * Get googleArtifactCrCredentials
   * @return googleArtifactCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials getGoogleArtifactCrCredentials() {
    return googleArtifactCrCredentials;
  }

  public void setGoogleArtifactCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials googleArtifactCrCredentials) {
    this.googleArtifactCrCredentials = googleArtifactCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf14 addNewIntegrationRequestAnyOfCredentialsOneOf14 = (AddNewIntegrationRequestAnyOfCredentialsOneOf14) o;
    return Objects.equals(this.googleArtifactCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf14.googleArtifactCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(googleArtifactCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf14 {\n");
    sb.append("    googleArtifactCrCredentials: ").append(toIndentedString(googleArtifactCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("GoogleArtifactCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf14
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf14.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf14 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf14.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf14.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf14` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GoogleArtifactCrCredentials`
      if (jsonObj.get("GoogleArtifactCrCredentials") != null && !jsonObj.get("GoogleArtifactCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf14GoogleArtifactCrCredentials.validateJsonElement(jsonObj.get("GoogleArtifactCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf14.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf14>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf14 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf14 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf14 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf14
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf14
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf14.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf14 to an JSON string
   *
   * @return JSON string
   */
