...
public class SetNotificationSettingsRequestProjectImported {
  public static final String SERIALIZED_NAME_ENABLED = "enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public SetNotificationSettingsRequestProjectImported() {
  }

  public SetNotificationSettingsRequestProjectImported enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    SetNotificationSettingsRequestProjectImported setNotificationSettingsRequestProjectImported = (SetNotificationSettingsRequestProjectImported) o;
    return Objects.equals(this.enabled, setNotificationSettingsRequestProjectImported.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetNotificationSettingsRequestProjectImported {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetNotificationSettingsRequestProjectImported
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetNotificationSettingsRequestProjectImported.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetNotificationSettingsRequestProjectImported is not found in the empty JSON string", SetNotificationSettingsRequestProjectImported.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetNotificationSettingsRequestProjectImported.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetNotificationSettingsRequestProjectImported` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetNotificationSettingsRequestProjectImported.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetNotificationSettingsRequestProjectImported.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetNotificationSettingsRequestProjectImported' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetNotificationSettingsRequestProjectImported> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetNotificationSettingsRequestProjectImported.class));

       return (TypeAdapter<T>) new TypeAdapter<SetNotificationSettingsRequestProjectImported>() {
           @Override
           public void write(JsonWriter out, SetNotificationSettingsRequestProjectImported value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetNotificationSettingsRequestProjectImported read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetNotificationSettingsRequestProjectImported given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetNotificationSettingsRequestProjectImported
   * @throws IOException if the JSON string is invalid with respect to SetNotificationSettingsRequestProjectImported
   */
  public static SetNotificationSettingsRequestProjectImported fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetNotificationSettingsRequestProjectImported.class);
  }

  /**
   * Convert an instance of SetNotificationSettingsRequestProjectImported to an JSON string
   *
   * @return JSON string
   */
