...
import org.openapitools.client.model.GetTestCounts200ResponseResultsInnerIsPrivate;
import org.openapitools.client.model.GetTestCounts200ResponseResultsInnerIssuesPrevented;
...
public class GetTestCounts200ResponseResultsInner {
  ...
  private GetTestCounts200ResponseResultsInnerIsPrivate isPrivate;
  ...
  private GetTestCounts200ResponseResultsInnerIssuesPrevented issuesPrevented;

  public GetTestCounts200ResponseResultsInner() {
  }

  public GetTestCounts200ResponseResultsInner count(BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  public GetTestCounts200ResponseResultsInner isPrivate(GetTestCounts200ResponseResultsInnerIsPrivate isPrivate) {
  ...
  public GetTestCounts200ResponseResultsInnerIsPrivate getIsPrivate() {
    return isPrivate;
  }

  public void setIsPrivate(GetTestCounts200ResponseResultsInnerIsPrivate isPrivate) {
    this.isPrivate = isPrivate;
  }


  public GetTestCounts200ResponseResultsInner issuesPrevented(GetTestCounts200ResponseResultsInnerIssuesPrevented issuesPrevented) {
   ...
   */
  @javax.annotation.Nullable
  public GetTestCounts200ResponseResultsInnerIssuesPrevented getIssuesPrevented() {
    return issuesPrevented;
  }

  public void setIssuesPrevented(GetTestCounts200ResponseResultsInnerIssuesPrevented issuesPrevented) {
    this.issuesPrevented = issuesPrevented;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTestCounts200ResponseResultsInner getTestCounts200ResponseResultsInner = (GetTestCounts200ResponseResultsInner) o;
    return Objects.equals(this.count, getTestCounts200ResponseResultsInner.count) &&
        Objects.equals(this.isPrivate, getTestCounts200ResponseResultsInner.isPrivate) &&
        Objects.equals(this.issuesPrevented, getTestCounts200ResponseResultsInner.issuesPrevented);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, isPrivate, issuesPrevented);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetTestCounts200ResponseResultsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTestCounts200ResponseResultsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTestCounts200ResponseResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTestCounts200ResponseResultsInner is not found in the empty JSON string", GetTestCounts200ResponseResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTestCounts200ResponseResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTestCounts200ResponseResultsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTestCounts200ResponseResultsInner.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `isPrivate`
      if (jsonObj.get("isPrivate") != null && !jsonObj.get("isPrivate").isJsonNull()) {
        GetTestCounts200ResponseResultsInnerIsPrivate.validateJsonElement(jsonObj.get("isPrivate"));
      }
      // validate the optional field `issuesPrevented`
      if (jsonObj.get("issuesPrevented") != null && !jsonObj.get("issuesPrevented").isJsonNull()) {
        GetTestCounts200ResponseResultsInnerIssuesPrevented.validateJsonElement(jsonObj.get("issuesPrevented"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTestCounts200ResponseResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTestCounts200ResponseResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTestCounts200ResponseResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTestCounts200ResponseResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTestCounts200ResponseResultsInner>() {
           @Override
           public void write(JsonWriter out, GetTestCounts200ResponseResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTestCounts200ResponseResultsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTestCounts200ResponseResultsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTestCounts200ResponseResultsInner
   * @throws IOException if the JSON string is invalid with respect to GetTestCounts200ResponseResultsInner
   */
  public static GetTestCounts200ResponseResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTestCounts200ResponseResultsInner.class);
  }

  /**
   * Convert an instance of GetTestCounts200ResponseResultsInner to an JSON string
   *
   * @return JSON string
   */
