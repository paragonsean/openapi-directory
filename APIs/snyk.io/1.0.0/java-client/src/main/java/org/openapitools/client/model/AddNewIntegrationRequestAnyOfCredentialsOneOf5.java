...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf5DigitalOceanCrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf5 {
  public static final String SERIALIZED_NAME_DIGITAL_OCEAN_CR_CREDENTIALS = "DigitalOceanCrCredentials";
  @SerializedName(SERIALIZED_NAME_DIGITAL_OCEAN_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf5DigitalOceanCrCredentials digitalOceanCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf5() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf5 digitalOceanCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf5DigitalOceanCrCredentials digitalOceanCrCredentials) {
    this.digitalOceanCrCredentials = digitalOceanCrCredentials;
    return this;
  }

  /**
   * Get digitalOceanCrCredentials
   * @return digitalOceanCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf5DigitalOceanCrCredentials getDigitalOceanCrCredentials() {
    return digitalOceanCrCredentials;
  }

  public void setDigitalOceanCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf5DigitalOceanCrCredentials digitalOceanCrCredentials) {
    this.digitalOceanCrCredentials = digitalOceanCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf5 addNewIntegrationRequestAnyOfCredentialsOneOf5 = (AddNewIntegrationRequestAnyOfCredentialsOneOf5) o;
    return Objects.equals(this.digitalOceanCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf5.digitalOceanCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(digitalOceanCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf5 {\n");
    sb.append("    digitalOceanCrCredentials: ").append(toIndentedString(digitalOceanCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DigitalOceanCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf5
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf5 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DigitalOceanCrCredentials`
      if (jsonObj.get("DigitalOceanCrCredentials") != null && !jsonObj.get("DigitalOceanCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf5DigitalOceanCrCredentials.validateJsonElement(jsonObj.get("DigitalOceanCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf5.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf5>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf5 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf5 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf5
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf5
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf5.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf5 to an JSON string
   *
   * @return JSON string
   */
