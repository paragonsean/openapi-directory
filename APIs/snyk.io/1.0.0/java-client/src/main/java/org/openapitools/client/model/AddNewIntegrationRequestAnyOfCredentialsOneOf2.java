...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf2 {
  public static final String SERIALIZED_NAME_AZURE_REPOS_CREDENTIALS = "AzureReposCredentials";
  @SerializedName(SERIALIZED_NAME_AZURE_REPOS_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf2AzureReposCredentials azureReposCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf2() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf2 azureReposCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf2AzureReposCredentials azureReposCredentials) {
    this.azureReposCredentials = azureReposCredentials;
    return this;
  }

  /**
   * Get azureReposCredentials
   * @return azureReposCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf2AzureReposCredentials getAzureReposCredentials() {
    return azureReposCredentials;
  }

  public void setAzureReposCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf2AzureReposCredentials azureReposCredentials) {
    this.azureReposCredentials = azureReposCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf2 addNewIntegrationRequestAnyOfCredentialsOneOf2 = (AddNewIntegrationRequestAnyOfCredentialsOneOf2) o;
    return Objects.equals(this.azureReposCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf2.azureReposCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(azureReposCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf2 {\n");
    sb.append("    azureReposCredentials: ").append(toIndentedString(azureReposCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("AzureReposCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf2 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AzureReposCredentials`
      if (jsonObj.get("AzureReposCredentials") != null && !jsonObj.get("AzureReposCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf2AzureReposCredentials.validateJsonElement(jsonObj.get("AzureReposCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf2.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf2>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf2
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf2
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf2.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf2 to an JSON string
   *
   * @return JSON string
   */
