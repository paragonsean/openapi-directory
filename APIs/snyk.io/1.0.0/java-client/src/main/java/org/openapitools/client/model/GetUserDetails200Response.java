...
public class GetUserDetails200Response {
  ...
  public GetUserDetails200Response() {
  }

  public GetUserDetails200Response email(String email) {
    this.email = email;
    return this;
  }
  ...
  public GetUserDetails200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetUserDetails200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetUserDetails200Response username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    GetUserDetails200Response getUserDetails200Response = (GetUserDetails200Response) o;
    return Objects.equals(this.email, getUserDetails200Response.email) &&
        Objects.equals(this.id, getUserDetails200Response.id) &&
        Objects.equals(this.name, getUserDetails200Response.name) &&
        Objects.equals(this.username, getUserDetails200Response.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUserDetails200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUserDetails200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserDetails200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUserDetails200Response is not found in the empty JSON string", GetUserDetails200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserDetails200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUserDetails200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUserDetails200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUserDetails200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUserDetails200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUserDetails200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUserDetails200Response>() {
           @Override
           public void write(JsonWriter out, GetUserDetails200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUserDetails200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUserDetails200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserDetails200Response
   * @throws IOException if the JSON string is invalid with respect to GetUserDetails200Response
   */
  public static GetUserDetails200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserDetails200Response.class);
  }

  /**
   * Convert an instance of GetUserDetails200Response to an JSON string
   *
   * @return JSON string
   */
