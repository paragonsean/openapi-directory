...
import org.openapitools.client.model.PkgManager;
...
public class DepGraphData {
  ...
  public static final String SERIALIZED_NAME_PKG_MANAGER = "pkgManager";
  @SerializedName(SERIALIZED_NAME_PKG_MANAGER)
  private PkgManager pkgManager;

  public static final String SERIALIZED_NAME_PKGS = "pkgs";
  @SerializedName(SERIALIZED_NAME_PKGS)
  private List<Object> pkgs = new ArrayList<>();
  ...
  public DepGraphData graph(Graph graph) {
    this.graph = graph;
    return this;
  }
  ...
  public DepGraphData pkgManager(PkgManager pkgManager) {
   ...
   */
  @javax.annotation.Nonnull
  public PkgManager getPkgManager() {
    return pkgManager;
  }

  public void setPkgManager(PkgManager pkgManager) {
    this.pkgManager = pkgManager;
  }


  public DepGraphData pkgs(List<Object> pkgs) {
    this.pkgs = pkgs;
    return this;
  }

  public DepGraphData addPkgsItem(Object pkgsItem) {
    if (this.pkgs == null) {
      this.pkgs = new ArrayList<>();
    }
    this.pkgs.add(pkgsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public List<Object> getPkgs() {
    return pkgs;
  }

  public void setPkgs(List<Object> pkgs) {
    this.pkgs = pkgs;
  }


  public DepGraphData schemaVersion(String schemaVersion) {
  ...
  public boolean equals(Object o) {
    ...
    DepGraphData depGraphData = (DepGraphData) o;
    return Objects.equals(this.graph, depGraphData.graph) &&
        Objects.equals(this.pkgManager, depGraphData.pkgManager) &&
        Objects.equals(this.pkgs, depGraphData.pkgs) &&
        Objects.equals(this.schemaVersion, depGraphData.schemaVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(graph, pkgManager, pkgs, schemaVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DepGraphData {\n");
    sb.append("    graph: ").append(toIndentedString(graph)).append("\n");
    sb.append("    pkgManager: ").append(toIndentedString(pkgManager)).append("\n");
    sb.append("    pkgs: ").append(toIndentedString(pkgs)).append("\n");
  ...
  static {
    ...
    openapiFields.add("pkgManager");
    openapiFields.add("pkgs");
    openapiFields.add("schemaVersion");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("graph");
    openapiRequiredFields.add("pkgManager");
    openapiRequiredFields.add("pkgs");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepGraphData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepGraphData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepGraphData is not found in the empty JSON string", DepGraphData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepGraphData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepGraphData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DepGraphData.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `graph`
      Graph.validateJsonElement(jsonObj.get("graph"));
      // validate the required field `pkgManager`
      PkgManager.validateJsonElement(jsonObj.get("pkgManager"));
      // ensure the required json array is present
      if (jsonObj.get("pkgs") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("pkgs").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `pkgs` to be an array in the JSON string but got `%s`", jsonObj.get("pkgs").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepGraphData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepGraphData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepGraphData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepGraphData.class));

       return (TypeAdapter<T>) new TypeAdapter<DepGraphData>() {
           @Override
           public void write(JsonWriter out, DepGraphData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepGraphData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepGraphData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepGraphData
   * @throws IOException if the JSON string is invalid with respect to DepGraphData
   */
  public static DepGraphData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepGraphData.class);
  }

  /**
   * Convert an instance of DepGraphData to an JSON string
   *
   * @return JSON string
   */
