...
public class GetTestCountsRequestFilters {
  public static final String SERIALIZED_NAME_IS_PRIVATE = "isPrivate";
  @SerializedName(SERIALIZED_NAME_IS_PRIVATE)
  private Boolean isPrivate;

  public static final String SERIALIZED_NAME_ISSUES_PREVENTED = "issuesPrevented";
  @SerializedName(SERIALIZED_NAME_ISSUES_PREVENTED)
  private Boolean issuesPrevented;
  ...
  public GetTestCountsRequestFilters() {
  }

  public GetTestCountsRequestFilters isPrivate(Boolean isPrivate) {
  ...
  public GetTestCountsRequestFilters issuesPrevented(Boolean issuesPrevented) {
    this.issuesPrevented = issuesPrevented;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Boolean getIssuesPrevented() {
    return issuesPrevented;
  }

  public void setIssuesPrevented(Boolean issuesPrevented) {
    this.issuesPrevented = issuesPrevented;
  }


  public GetTestCountsRequestFilters orgs(Object orgs) {
    this.orgs = orgs;
    return this;
  }
  ...
  public GetTestCountsRequestFilters projects(Object projects) {
  ...
  public boolean equals(Object o) {
    ...
    GetTestCountsRequestFilters getTestCountsRequestFilters = (GetTestCountsRequestFilters) o;
    return Objects.equals(this.isPrivate, getTestCountsRequestFilters.isPrivate) &&
        Objects.equals(this.issuesPrevented, getTestCountsRequestFilters.issuesPrevented) &&
        Objects.equals(this.orgs, getTestCountsRequestFilters.orgs) &&
        Objects.equals(this.projects, getTestCountsRequestFilters.projects);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isPrivate, issuesPrevented, orgs, projects);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTestCountsRequestFilters {\n");
    sb.append("    isPrivate: ").append(toIndentedString(isPrivate)).append("\n");
    sb.append("    issuesPrevented: ").append(toIndentedString(issuesPrevented)).append("\n");
  ...
  static {
    ...
    openapiFields.add("issuesPrevented");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTestCountsRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTestCountsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTestCountsRequestFilters is not found in the empty JSON string", GetTestCountsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTestCountsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTestCountsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTestCountsRequestFilters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTestCountsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTestCountsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTestCountsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTestCountsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTestCountsRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetTestCountsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTestCountsRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTestCountsRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTestCountsRequestFilters
   * @throws IOException if the JSON string is invalid with respect to GetTestCountsRequestFilters
   */
  public static GetTestCountsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTestCountsRequestFilters.class);
  }

  /**
   * Convert an instance of GetTestCountsRequestFilters to an JSON string
   *
   * @return JSON string
   */
