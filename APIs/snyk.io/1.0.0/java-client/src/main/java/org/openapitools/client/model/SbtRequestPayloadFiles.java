...
import org.openapitools.client.model.SBTFile;
...
public class SbtRequestPayloadFiles {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private SBTFile target;

  public SbtRequestPayloadFiles() {
  }

  public SbtRequestPayloadFiles target(SBTFile target) {
    this.target = target;
    return this;
  }
  ...
  public SBTFile getTarget() {
    return target;
  }

  public void setTarget(SBTFile target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    SbtRequestPayloadFiles sbtRequestPayloadFiles = (SbtRequestPayloadFiles) o;
    return Objects.equals(this.target, sbtRequestPayloadFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class SbtRequestPayloadFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SbtRequestPayloadFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SbtRequestPayloadFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SbtRequestPayloadFiles is not found in the empty JSON string", SbtRequestPayloadFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SbtRequestPayloadFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SbtRequestPayloadFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SbtRequestPayloadFiles.openapiRequiredFields) {
      ...
      SBTFile.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SbtRequestPayloadFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SbtRequestPayloadFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SbtRequestPayloadFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SbtRequestPayloadFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<SbtRequestPayloadFiles>() {
           @Override
           public void write(JsonWriter out, SbtRequestPayloadFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SbtRequestPayloadFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SbtRequestPayloadFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SbtRequestPayloadFiles
   * @throws IOException if the JSON string is invalid with respect to SbtRequestPayloadFiles
   */
  public static SbtRequestPayloadFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SbtRequestPayloadFiles.class);
  }

  /**
   * Convert an instance of SbtRequestPayloadFiles to an JSON string
   *
   * @return JSON string
   */
