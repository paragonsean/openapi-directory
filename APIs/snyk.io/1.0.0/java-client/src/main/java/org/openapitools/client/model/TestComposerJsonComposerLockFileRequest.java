...
public class TestComposerJsonComposerLockFileRequest {
  /**
  ...
  public TestComposerJsonComposerLockFileRequest() {
  }

  public TestComposerJsonComposerLockFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestComposerJsonComposerLockFileRequest files(TestComposerJsonComposerLockFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestComposerJsonComposerLockFileRequest testComposerJsonComposerLockFileRequest = (TestComposerJsonComposerLockFileRequest) o;
    return Objects.equals(this.encoding, testComposerJsonComposerLockFileRequest.encoding) &&
        Objects.equals(this.files, testComposerJsonComposerLockFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestComposerJsonComposerLockFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestComposerJsonComposerLockFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestComposerJsonComposerLockFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestComposerJsonComposerLockFileRequest is not found in the empty JSON string", TestComposerJsonComposerLockFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestComposerJsonComposerLockFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestComposerJsonComposerLockFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestComposerJsonComposerLockFileRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestComposerJsonComposerLockFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestComposerJsonComposerLockFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestComposerJsonComposerLockFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestComposerJsonComposerLockFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestComposerJsonComposerLockFileRequest>() {
           @Override
           public void write(JsonWriter out, TestComposerJsonComposerLockFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestComposerJsonComposerLockFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestComposerJsonComposerLockFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestComposerJsonComposerLockFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestComposerJsonComposerLockFileRequest
   */
  public static TestComposerJsonComposerLockFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestComposerJsonComposerLockFileRequest.class);
  }

  /**
   * Convert an instance of TestComposerJsonComposerLockFileRequest to an JSON string
   *
   * @return JSON string
   */
