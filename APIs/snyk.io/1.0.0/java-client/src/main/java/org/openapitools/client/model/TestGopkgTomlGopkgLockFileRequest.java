...
public class TestGopkgTomlGopkgLockFileRequest {
  /**
  ...
  public TestGopkgTomlGopkgLockFileRequest() {
  }

  public TestGopkgTomlGopkgLockFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestGopkgTomlGopkgLockFileRequest files(TestGopkgTomlGopkgLockFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestGopkgTomlGopkgLockFileRequest testGopkgTomlGopkgLockFileRequest = (TestGopkgTomlGopkgLockFileRequest) o;
    return Objects.equals(this.encoding, testGopkgTomlGopkgLockFileRequest.encoding) &&
        Objects.equals(this.files, testGopkgTomlGopkgLockFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGopkgTomlGopkgLockFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGopkgTomlGopkgLockFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGopkgTomlGopkgLockFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGopkgTomlGopkgLockFileRequest is not found in the empty JSON string", TestGopkgTomlGopkgLockFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGopkgTomlGopkgLockFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGopkgTomlGopkgLockFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestGopkgTomlGopkgLockFileRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGopkgTomlGopkgLockFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGopkgTomlGopkgLockFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGopkgTomlGopkgLockFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGopkgTomlGopkgLockFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGopkgTomlGopkgLockFileRequest>() {
           @Override
           public void write(JsonWriter out, TestGopkgTomlGopkgLockFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGopkgTomlGopkgLockFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGopkgTomlGopkgLockFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGopkgTomlGopkgLockFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestGopkgTomlGopkgLockFileRequest
   */
  public static TestGopkgTomlGopkgLockFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGopkgTomlGopkgLockFileRequest.class);
  }

  /**
   * Convert an instance of TestGopkgTomlGopkgLockFileRequest to an JSON string
   *
   * @return JSON string
   */
