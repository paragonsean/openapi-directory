...
public class ProjectIssuesFiltersFiltersPriorityScore {
  ...
  public ProjectIssuesFiltersFiltersPriorityScore() {
  }

  public ProjectIssuesFiltersFiltersPriorityScore max(BigDecimal max) {
    this.max = max;
    return this;
  }
  ...
  public ProjectIssuesFiltersFiltersPriorityScore min(BigDecimal min) {
    this.min = min;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectIssuesFiltersFiltersPriorityScore projectIssuesFiltersFiltersPriorityScore = (ProjectIssuesFiltersFiltersPriorityScore) o;
    return Objects.equals(this.max, projectIssuesFiltersFiltersPriorityScore.max) &&
        Objects.equals(this.min, projectIssuesFiltersFiltersPriorityScore.min);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectIssuesFiltersFiltersPriorityScore {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectIssuesFiltersFiltersPriorityScore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectIssuesFiltersFiltersPriorityScore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectIssuesFiltersFiltersPriorityScore is not found in the empty JSON string", ProjectIssuesFiltersFiltersPriorityScore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectIssuesFiltersFiltersPriorityScore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectIssuesFiltersFiltersPriorityScore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectIssuesFiltersFiltersPriorityScore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectIssuesFiltersFiltersPriorityScore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectIssuesFiltersFiltersPriorityScore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectIssuesFiltersFiltersPriorityScore.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectIssuesFiltersFiltersPriorityScore>() {
           @Override
           public void write(JsonWriter out, ProjectIssuesFiltersFiltersPriorityScore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectIssuesFiltersFiltersPriorityScore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectIssuesFiltersFiltersPriorityScore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectIssuesFiltersFiltersPriorityScore
   * @throws IOException if the JSON string is invalid with respect to ProjectIssuesFiltersFiltersPriorityScore
   */
  public static ProjectIssuesFiltersFiltersPriorityScore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectIssuesFiltersFiltersPriorityScore.class);
  }

  /**
   * Convert an instance of ProjectIssuesFiltersFiltersPriorityScore to an JSON string
   *
   * @return JSON string
   */
