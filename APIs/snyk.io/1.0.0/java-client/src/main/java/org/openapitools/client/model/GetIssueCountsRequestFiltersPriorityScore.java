...
public class GetIssueCountsRequestFiltersPriorityScore {
  ...
  public GetIssueCountsRequestFiltersPriorityScore() {
  }

  public GetIssueCountsRequestFiltersPriorityScore max(BigDecimal max) {
    this.max = max;
    return this;
  }
  ...
  public GetIssueCountsRequestFiltersPriorityScore min(BigDecimal min) {
    this.min = min;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCountsRequestFiltersPriorityScore getIssueCountsRequestFiltersPriorityScore = (GetIssueCountsRequestFiltersPriorityScore) o;
    return Objects.equals(this.max, getIssueCountsRequestFiltersPriorityScore.max) &&
        Objects.equals(this.min, getIssueCountsRequestFiltersPriorityScore.min);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIssueCountsRequestFiltersPriorityScore {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCountsRequestFiltersPriorityScore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCountsRequestFiltersPriorityScore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCountsRequestFiltersPriorityScore is not found in the empty JSON string", GetIssueCountsRequestFiltersPriorityScore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCountsRequestFiltersPriorityScore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCountsRequestFiltersPriorityScore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCountsRequestFiltersPriorityScore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCountsRequestFiltersPriorityScore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCountsRequestFiltersPriorityScore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCountsRequestFiltersPriorityScore.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCountsRequestFiltersPriorityScore>() {
           @Override
           public void write(JsonWriter out, GetIssueCountsRequestFiltersPriorityScore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCountsRequestFiltersPriorityScore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCountsRequestFiltersPriorityScore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCountsRequestFiltersPriorityScore
   * @throws IOException if the JSON string is invalid with respect to GetIssueCountsRequestFiltersPriorityScore
   */
  public static GetIssueCountsRequestFiltersPriorityScore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCountsRequestFiltersPriorityScore.class);
  }

  /**
   * Convert an instance of GetIssueCountsRequestFiltersPriorityScore to an JSON string
   *
   * @return JSON string
   */
