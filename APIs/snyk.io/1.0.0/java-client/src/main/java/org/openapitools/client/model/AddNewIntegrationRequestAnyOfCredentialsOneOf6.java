...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf6 {
  public static final String SERIALIZED_NAME_DOCKER_HUB_CREDENTIALS = "DockerHubCredentials";
  @SerializedName(SERIALIZED_NAME_DOCKER_HUB_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials dockerHubCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf6() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf6 dockerHubCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials dockerHubCredentials) {
    this.dockerHubCredentials = dockerHubCredentials;
    return this;
  }
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials getDockerHubCredentials() {
    return dockerHubCredentials;
  }

  public void setDockerHubCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials dockerHubCredentials) {
    this.dockerHubCredentials = dockerHubCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf6 addNewIntegrationRequestAnyOfCredentialsOneOf6 = (AddNewIntegrationRequestAnyOfCredentialsOneOf6) o;
    return Objects.equals(this.dockerHubCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf6.dockerHubCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dockerHubCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf6 {\n");
    sb.append("    dockerHubCredentials: ").append(toIndentedString(dockerHubCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DockerHubCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf6
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf6.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf6 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf6.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf6` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DockerHubCredentials`
      if (jsonObj.get("DockerHubCredentials") != null && !jsonObj.get("DockerHubCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.validateJsonElement(jsonObj.get("DockerHubCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf6.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf6>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf6 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf6 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf6 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf6
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf6
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf6.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf6 to an JSON string
   *
   * @return JSON string
   */
