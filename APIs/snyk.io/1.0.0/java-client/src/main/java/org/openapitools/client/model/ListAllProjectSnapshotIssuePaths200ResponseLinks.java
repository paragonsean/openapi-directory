...
public class ListAllProjectSnapshotIssuePaths200ResponseLinks {
  ...
  public ListAllProjectSnapshotIssuePaths200ResponseLinks() {
  }

  public ListAllProjectSnapshotIssuePaths200ResponseLinks last(String last) {
    this.last = last;
    return this;
  }
  ...
  public ListAllProjectSnapshotIssuePaths200ResponseLinks next(String next) {
    this.next = next;
    return this;
  }
  ...
  public ListAllProjectSnapshotIssuePaths200ResponseLinks prev(String prev) {
    this.prev = prev;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectSnapshotIssuePaths200ResponseLinks listAllProjectSnapshotIssuePaths200ResponseLinks = (ListAllProjectSnapshotIssuePaths200ResponseLinks) o;
    return Objects.equals(this.last, listAllProjectSnapshotIssuePaths200ResponseLinks.last) &&
        Objects.equals(this.next, listAllProjectSnapshotIssuePaths200ResponseLinks.next) &&
        Objects.equals(this.prev, listAllProjectSnapshotIssuePaths200ResponseLinks.prev);
  }

  @Override
  public int hashCode() {
    return Objects.hash(last, next, prev);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllProjectSnapshotIssuePaths200ResponseLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectSnapshotIssuePaths200ResponseLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectSnapshotIssuePaths200ResponseLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectSnapshotIssuePaths200ResponseLinks is not found in the empty JSON string", ListAllProjectSnapshotIssuePaths200ResponseLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectSnapshotIssuePaths200ResponseLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectSnapshotIssuePaths200ResponseLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectSnapshotIssuePaths200ResponseLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectSnapshotIssuePaths200ResponseLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectSnapshotIssuePaths200ResponseLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectSnapshotIssuePaths200ResponseLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectSnapshotIssuePaths200ResponseLinks>() {
           @Override
           public void write(JsonWriter out, ListAllProjectSnapshotIssuePaths200ResponseLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectSnapshotIssuePaths200ResponseLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectSnapshotIssuePaths200ResponseLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectSnapshotIssuePaths200ResponseLinks
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectSnapshotIssuePaths200ResponseLinks
   */
  public static ListAllProjectSnapshotIssuePaths200ResponseLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectSnapshotIssuePaths200ResponseLinks.class);
  }

  /**
   * Convert an instance of ListAllProjectSnapshotIssuePaths200ResponseLinks to an JSON string
   *
   * @return JSON string
   */
