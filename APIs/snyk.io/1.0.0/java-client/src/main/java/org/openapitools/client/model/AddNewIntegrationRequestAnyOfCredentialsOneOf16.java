...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf16NexusCrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf16 {
  public static final String SERIALIZED_NAME_NEXUS_CR_CREDENTIALS = "NexusCrCredentials";
  @SerializedName(SERIALIZED_NAME_NEXUS_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf16NexusCrCredentials nexusCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf16() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf16 nexusCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf16NexusCrCredentials nexusCrCredentials) {
    this.nexusCrCredentials = nexusCrCredentials;
    return this;
  }

  /**
   * Get nexusCrCredentials
   * @return nexusCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf16NexusCrCredentials getNexusCrCredentials() {
    return nexusCrCredentials;
  }

  public void setNexusCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf16NexusCrCredentials nexusCrCredentials) {
    this.nexusCrCredentials = nexusCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf16 addNewIntegrationRequestAnyOfCredentialsOneOf16 = (AddNewIntegrationRequestAnyOfCredentialsOneOf16) o;
    return Objects.equals(this.nexusCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf16.nexusCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nexusCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf16 {\n");
    sb.append("    nexusCrCredentials: ").append(toIndentedString(nexusCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("NexusCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf16
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf16.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf16 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf16.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf16.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf16` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `NexusCrCredentials`
      if (jsonObj.get("NexusCrCredentials") != null && !jsonObj.get("NexusCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf16NexusCrCredentials.validateJsonElement(jsonObj.get("NexusCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf16.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf16' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf16> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf16.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf16>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf16 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf16 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf16 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf16
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf16
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf16 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf16.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf16 to an JSON string
   *
   * @return JSON string
   */
