...
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner;
...
public class GetProjectDependencyGraph200ResponseDepGraphGraph {
  public static final String SERIALIZED_NAME_NODES = "nodes";
  @SerializedName(SERIALIZED_NAME_NODES)
  private List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner> nodes = new ArrayList<>();

  public static final String SERIALIZED_NAME_ROOT_NODE_ID = "rootNodeId";
  @SerializedName(SERIALIZED_NAME_ROOT_NODE_ID)
  private String rootNodeId;

  public GetProjectDependencyGraph200ResponseDepGraphGraph() {
  }

  public GetProjectDependencyGraph200ResponseDepGraphGraph nodes(List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner> nodes) {
    this.nodes = nodes;
    return this;
  }

  public GetProjectDependencyGraph200ResponseDepGraphGraph addNodesItem(GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner nodesItem) {
    if (this.nodes == null) {
  ...
  public List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner> getNodes() {
    return nodes;
  }

  public void setNodes(List<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner> nodes) {
    this.nodes = nodes;
  }


  public GetProjectDependencyGraph200ResponseDepGraphGraph rootNodeId(String rootNodeId) {
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraphGraph getProjectDependencyGraph200ResponseDepGraphGraph = (GetProjectDependencyGraph200ResponseDepGraphGraph) o;
    return Objects.equals(this.nodes, getProjectDependencyGraph200ResponseDepGraphGraph.nodes) &&
        Objects.equals(this.rootNodeId, getProjectDependencyGraph200ResponseDepGraphGraph.rootNodeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectDependencyGraph200ResponseDepGraphGraph {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraphGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraphGraph is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraphGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraphGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraphGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraphGraph.openapiRequiredFields) {
      ...
      if (jsonObj.get("nodes") != null && !jsonObj.get("nodes").isJsonNull()) {
        ...
        if (jsonArraynodes != null) {
          ...
          for (int i = 0; i < jsonArraynodes.size(); i++) {
            GetProjectDependencyGraph200ResponseDepGraphGraphNodesInner.validateJsonElement(jsonArraynodes.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraphGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraphGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraphGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphGraph>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraphGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraphGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraphGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraphGraph
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphGraph
   */
  public static GetProjectDependencyGraph200ResponseDepGraphGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraphGraph.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraphGraph to an JSON string
   *
   * @return JSON string
   */
