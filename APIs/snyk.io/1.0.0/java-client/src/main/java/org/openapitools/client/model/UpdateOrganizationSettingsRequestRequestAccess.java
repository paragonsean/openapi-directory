...
public class UpdateOrganizationSettingsRequestRequestAccess {
  public static final String SERIALIZED_NAME_ENABLED = "enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public UpdateOrganizationSettingsRequestRequestAccess() {
  }

  public UpdateOrganizationSettingsRequestRequestAccess enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateOrganizationSettingsRequestRequestAccess updateOrganizationSettingsRequestRequestAccess = (UpdateOrganizationSettingsRequestRequestAccess) o;
    return Objects.equals(this.enabled, updateOrganizationSettingsRequestRequestAccess.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateOrganizationSettingsRequestRequestAccess {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOrganizationSettingsRequestRequestAccess
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOrganizationSettingsRequestRequestAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateOrganizationSettingsRequestRequestAccess is not found in the empty JSON string", UpdateOrganizationSettingsRequestRequestAccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOrganizationSettingsRequestRequestAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateOrganizationSettingsRequestRequestAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateOrganizationSettingsRequestRequestAccess.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOrganizationSettingsRequestRequestAccess.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOrganizationSettingsRequestRequestAccess' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOrganizationSettingsRequestRequestAccess> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOrganizationSettingsRequestRequestAccess.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOrganizationSettingsRequestRequestAccess>() {
           @Override
           public void write(JsonWriter out, UpdateOrganizationSettingsRequestRequestAccess value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOrganizationSettingsRequestRequestAccess read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOrganizationSettingsRequestRequestAccess given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOrganizationSettingsRequestRequestAccess
   * @throws IOException if the JSON string is invalid with respect to UpdateOrganizationSettingsRequestRequestAccess
   */
  public static UpdateOrganizationSettingsRequestRequestAccess fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOrganizationSettingsRequestRequestAccess.class);
  }

  /**
   * Convert an instance of UpdateOrganizationSettingsRequestRequestAccess to an JSON string
   *
   * @return JSON string
   */
