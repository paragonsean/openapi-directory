...
public class ListAllAggregatedIssuesRequestFiltersPriorityScore {
  ...
  public ListAllAggregatedIssuesRequestFiltersPriorityScore() {
  }

  public ListAllAggregatedIssuesRequestFiltersPriorityScore max(BigDecimal max) {
    this.max = max;
    return this;
  }
  ...
  public ListAllAggregatedIssuesRequestFiltersPriorityScore min(BigDecimal min) {
    this.min = min;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssuesRequestFiltersPriorityScore listAllAggregatedIssuesRequestFiltersPriorityScore = (ListAllAggregatedIssuesRequestFiltersPriorityScore) o;
    return Objects.equals(this.max, listAllAggregatedIssuesRequestFiltersPriorityScore.max) &&
        Objects.equals(this.min, listAllAggregatedIssuesRequestFiltersPriorityScore.min);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllAggregatedIssuesRequestFiltersPriorityScore {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssuesRequestFiltersPriorityScore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssuesRequestFiltersPriorityScore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssuesRequestFiltersPriorityScore is not found in the empty JSON string", ListAllAggregatedIssuesRequestFiltersPriorityScore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssuesRequestFiltersPriorityScore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssuesRequestFiltersPriorityScore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssuesRequestFiltersPriorityScore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssuesRequestFiltersPriorityScore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssuesRequestFiltersPriorityScore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssuesRequestFiltersPriorityScore.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssuesRequestFiltersPriorityScore>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssuesRequestFiltersPriorityScore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssuesRequestFiltersPriorityScore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssuesRequestFiltersPriorityScore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssuesRequestFiltersPriorityScore
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssuesRequestFiltersPriorityScore
   */
  public static ListAllAggregatedIssuesRequestFiltersPriorityScore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssuesRequestFiltersPriorityScore.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssuesRequestFiltersPriorityScore to an JSON string
   *
   * @return JSON string
   */
