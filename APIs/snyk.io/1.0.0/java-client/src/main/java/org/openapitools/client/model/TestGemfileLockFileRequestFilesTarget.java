...
public class TestGemfileLockFileRequestFilesTarget {
  public static final String SERIALIZED_NAME_CONTENTS = "contents";
  @SerializedName(SERIALIZED_NAME_CONTENTS)
  private String contents;

  public TestGemfileLockFileRequestFilesTarget() {
  }

  public TestGemfileLockFileRequestFilesTarget contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    TestGemfileLockFileRequestFilesTarget testGemfileLockFileRequestFilesTarget = (TestGemfileLockFileRequestFilesTarget) o;
    return Objects.equals(this.contents, testGemfileLockFileRequestFilesTarget.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGemfileLockFileRequestFilesTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGemfileLockFileRequestFilesTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGemfileLockFileRequestFilesTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGemfileLockFileRequestFilesTarget is not found in the empty JSON string", TestGemfileLockFileRequestFilesTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGemfileLockFileRequestFilesTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGemfileLockFileRequestFilesTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestGemfileLockFileRequestFilesTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGemfileLockFileRequestFilesTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGemfileLockFileRequestFilesTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGemfileLockFileRequestFilesTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGemfileLockFileRequestFilesTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGemfileLockFileRequestFilesTarget>() {
           @Override
           public void write(JsonWriter out, TestGemfileLockFileRequestFilesTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGemfileLockFileRequestFilesTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGemfileLockFileRequestFilesTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGemfileLockFileRequestFilesTarget
   * @throws IOException if the JSON string is invalid with respect to TestGemfileLockFileRequestFilesTarget
   */
  public static TestGemfileLockFileRequestFilesTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGemfileLockFileRequestFilesTarget.class);
  }

  /**
   * Convert an instance of TestGemfileLockFileRequestFilesTarget to an JSON string
   *
   * @return JSON string
   */
