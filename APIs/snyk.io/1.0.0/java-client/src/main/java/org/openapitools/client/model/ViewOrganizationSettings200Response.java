...
import org.openapitools.client.model.ViewOrganizationSettings200ResponseRequestAccess;
...
public class ViewOrganizationSettings200Response {
  public static final String SERIALIZED_NAME_REQUEST_ACCESS = "requestAccess";
  @SerializedName(SERIALIZED_NAME_REQUEST_ACCESS)
  private ViewOrganizationSettings200ResponseRequestAccess requestAccess;

  public ViewOrganizationSettings200Response() {
  }

  public ViewOrganizationSettings200Response requestAccess(ViewOrganizationSettings200ResponseRequestAccess requestAccess) {
  ...
  public ViewOrganizationSettings200ResponseRequestAccess getRequestAccess() {
    return requestAccess;
  }

  public void setRequestAccess(ViewOrganizationSettings200ResponseRequestAccess requestAccess) {
    this.requestAccess = requestAccess;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewOrganizationSettings200Response viewOrganizationSettings200Response = (ViewOrganizationSettings200Response) o;
    return Objects.equals(this.requestAccess, viewOrganizationSettings200Response.requestAccess);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestAccess);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewOrganizationSettings200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewOrganizationSettings200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewOrganizationSettings200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewOrganizationSettings200Response is not found in the empty JSON string", ViewOrganizationSettings200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewOrganizationSettings200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewOrganizationSettings200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `requestAccess`
      if (jsonObj.get("requestAccess") != null && !jsonObj.get("requestAccess").isJsonNull()) {
        ViewOrganizationSettings200ResponseRequestAccess.validateJsonElement(jsonObj.get("requestAccess"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewOrganizationSettings200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewOrganizationSettings200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewOrganizationSettings200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewOrganizationSettings200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewOrganizationSettings200Response>() {
           @Override
           public void write(JsonWriter out, ViewOrganizationSettings200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewOrganizationSettings200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewOrganizationSettings200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewOrganizationSettings200Response
   * @throws IOException if the JSON string is invalid with respect to ViewOrganizationSettings200Response
   */
  public static ViewOrganizationSettings200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewOrganizationSettings200Response.class);
  }

  /**
   * Convert an instance of ViewOrganizationSettings200Response to an JSON string
   *
   * @return JSON string
   */
