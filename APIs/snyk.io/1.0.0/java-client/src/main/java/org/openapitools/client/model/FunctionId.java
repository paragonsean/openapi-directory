...
public class FunctionId {
  public static final String SERIALIZED_NAME_CLASS_NAME_QUESTION_MARK = "className?";
  @SerializedName(SERIALIZED_NAME_CLASS_NAME_QUESTION_MARK)
  private String classNameQuestionMark;

  public static final String SERIALIZED_NAME_FILE_PATH_QUESTION_MARK = "filePath?";
  @SerializedName(SERIALIZED_NAME_FILE_PATH_QUESTION_MARK)
  private String filePathQuestionMark;
  ...
  public FunctionId classNameQuestionMark(String classNameQuestionMark) {
    this.classNameQuestionMark = classNameQuestionMark;
    return this;
  }

  /**
   * Class name (Java only).
   * @return classNameQuestionMark
   */
  @javax.annotation.Nullable
  public String getClassNameQuestionMark() {
    return classNameQuestionMark;
  }

  public void setClassNameQuestionMark(String classNameQuestionMark) {
    this.classNameQuestionMark = classNameQuestionMark;
  }


  public FunctionId filePathQuestionMark(String filePathQuestionMark) {
    this.filePathQuestionMark = filePathQuestionMark;
    return this;
  }

  /**
   * Path to file (Javascript only).
   * @return filePathQuestionMark
   */
  @javax.annotation.Nullable
  public String getFilePathQuestionMark() {
    return filePathQuestionMark;
  }

  public void setFilePathQuestionMark(String filePathQuestionMark) {
    this.filePathQuestionMark = filePathQuestionMark;
  }


  public FunctionId functionName(String functionName) {
  ...
  public boolean equals(Object o) {
    ...
    FunctionId functionId = (FunctionId) o;
    return Objects.equals(this.classNameQuestionMark, functionId.classNameQuestionMark) &&
        Objects.equals(this.filePathQuestionMark, functionId.filePathQuestionMark) &&
        Objects.equals(this.functionName, functionId.functionName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(classNameQuestionMark, filePathQuestionMark, functionName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FunctionId {\n");
    sb.append("    classNameQuestionMark: ").append(toIndentedString(classNameQuestionMark)).append("\n");
    sb.append("    filePathQuestionMark: ").append(toIndentedString(filePathQuestionMark)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FunctionId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FunctionId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FunctionId is not found in the empty JSON string", FunctionId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FunctionId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FunctionId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FunctionId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FunctionId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FunctionId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FunctionId.class));

       return (TypeAdapter<T>) new TypeAdapter<FunctionId>() {
           @Override
           public void write(JsonWriter out, FunctionId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FunctionId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FunctionId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FunctionId
   * @throws IOException if the JSON string is invalid with respect to FunctionId
   */
  public static FunctionId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FunctionId.class);
  }

  /**
   * Convert an instance of FunctionId to an JSON string
   *
   * @return JSON string
   */
