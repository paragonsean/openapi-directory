...
public class GetTestCounts200ResponseResultsInnerIsPrivate {
  ...
  public GetTestCounts200ResponseResultsInnerIsPrivate() {
  }

  public GetTestCounts200ResponseResultsInnerIsPrivate false(BigDecimal false) {
    this.false = false;
    return this;
  }
  ...
  public void setFalse(BigDecimal false) {
    this.false = false;
  }


  public GetTestCounts200ResponseResultsInnerIsPrivate true(BigDecimal true) {
    this.true = true;
    return this;
  }
  ...
  public void setTrue(BigDecimal true) {
    this.true = true;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTestCounts200ResponseResultsInnerIsPrivate getTestCounts200ResponseResultsInnerIsPrivate = (GetTestCounts200ResponseResultsInnerIsPrivate) o;
    return Objects.equals(this.false, getTestCounts200ResponseResultsInnerIsPrivate.false) &&
        Objects.equals(this.true, getTestCounts200ResponseResultsInnerIsPrivate.true);
  }

  @Override
  public int hashCode() {
    return Objects.hash(false, true);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetTestCounts200ResponseResultsInnerIsPrivate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTestCounts200ResponseResultsInnerIsPrivate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTestCounts200ResponseResultsInnerIsPrivate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTestCounts200ResponseResultsInnerIsPrivate is not found in the empty JSON string", GetTestCounts200ResponseResultsInnerIsPrivate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTestCounts200ResponseResultsInnerIsPrivate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTestCounts200ResponseResultsInnerIsPrivate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTestCounts200ResponseResultsInnerIsPrivate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTestCounts200ResponseResultsInnerIsPrivate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTestCounts200ResponseResultsInnerIsPrivate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTestCounts200ResponseResultsInnerIsPrivate.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTestCounts200ResponseResultsInnerIsPrivate>() {
           @Override
           public void write(JsonWriter out, GetTestCounts200ResponseResultsInnerIsPrivate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTestCounts200ResponseResultsInnerIsPrivate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTestCounts200ResponseResultsInnerIsPrivate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTestCounts200ResponseResultsInnerIsPrivate
   * @throws IOException if the JSON string is invalid with respect to GetTestCounts200ResponseResultsInnerIsPrivate
   */
  public static GetTestCounts200ResponseResultsInnerIsPrivate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTestCounts200ResponseResultsInnerIsPrivate.class);
  }

  /**
   * Convert an instance of GetTestCounts200ResponseResultsInnerIsPrivate to an JSON string
   *
   * @return JSON string
   */
