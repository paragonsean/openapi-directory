...
public class ImportTargetsRequestAnyOf1Target {
  ...
  public ImportTargetsRequestAnyOf1Target() {
  }

  public ImportTargetsRequestAnyOf1Target branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf1Target id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf1Target importTargetsRequestAnyOf1Target = (ImportTargetsRequestAnyOf1Target) o;
    return Objects.equals(this.branch, importTargetsRequestAnyOf1Target.branch) &&
        Objects.equals(this.id, importTargetsRequestAnyOf1Target.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf1Target {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf1Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf1Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf1Target is not found in the empty JSON string", ImportTargetsRequestAnyOf1Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf1Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf1Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf1Target.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf1Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf1Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf1Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf1Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf1Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf1Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf1Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf1Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf1Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf1Target
   */
  public static ImportTargetsRequestAnyOf1Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf1Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf1Target to an JSON string
   *
   * @return JSON string
   */
