...
public class GetListOfIssues200ResponseResultsInnerOneOf {
  public static final String SERIALIZED_NAME_PROJECTS = "projects";
  @SerializedName(SERIALIZED_NAME_PROJECTS)
  private List<Object> projects = new ArrayList<>();

  public GetListOfIssues200ResponseResultsInnerOneOf() {
  }

  public GetListOfIssues200ResponseResultsInnerOneOf projects(List<Object> projects) {
    this.projects = projects;
    return this;
  }

  public GetListOfIssues200ResponseResultsInnerOneOf addProjectsItem(Object projectsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetListOfIssues200ResponseResultsInnerOneOf getListOfIssues200ResponseResultsInnerOneOf = (GetListOfIssues200ResponseResultsInnerOneOf) o;
    return Objects.equals(this.projects, getListOfIssues200ResponseResultsInnerOneOf.projects);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetListOfIssues200ResponseResultsInnerOneOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetListOfIssues200ResponseResultsInnerOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetListOfIssues200ResponseResultsInnerOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListOfIssues200ResponseResultsInnerOneOf is not found in the empty JSON string", GetListOfIssues200ResponseResultsInnerOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetListOfIssues200ResponseResultsInnerOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetListOfIssues200ResponseResultsInnerOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetListOfIssues200ResponseResultsInnerOneOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListOfIssues200ResponseResultsInnerOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListOfIssues200ResponseResultsInnerOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssues200ResponseResultsInnerOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf>() {
           @Override
           public void write(JsonWriter out, GetListOfIssues200ResponseResultsInnerOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetListOfIssues200ResponseResultsInnerOneOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetListOfIssues200ResponseResultsInnerOneOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetListOfIssues200ResponseResultsInnerOneOf
   * @throws IOException if the JSON string is invalid with respect to GetListOfIssues200ResponseResultsInnerOneOf
   */
  public static GetListOfIssues200ResponseResultsInnerOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListOfIssues200ResponseResultsInnerOneOf.class);
  }

  /**
   * Convert an instance of GetListOfIssues200ResponseResultsInnerOneOf to an JSON string
   *
   * @return JSON string
   */
