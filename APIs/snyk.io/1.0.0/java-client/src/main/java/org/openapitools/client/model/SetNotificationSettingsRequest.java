...
import org.openapitools.client.model.SetNotificationSettingsRequestProjectImported;
...
public class SetNotificationSettingsRequest {
  ...
  private SetNotificationSettingsRequestProjectImported projectImported;

  public static final String SERIALIZED_NAME_TEST_LIMIT = "test-limit";
  @SerializedName(SERIALIZED_NAME_TEST_LIMIT)
  private SetNotificationSettingsRequestProjectImported testLimit;

  public static final String SERIALIZED_NAME_WEEKLY_REPORT = "weekly-report";
  @SerializedName(SERIALIZED_NAME_WEEKLY_REPORT)
  private SetNotificationSettingsRequestProjectImported weeklyReport;

  public SetNotificationSettingsRequest() {
  }

  public SetNotificationSettingsRequest newIssuesRemediations(SetNotificationSettingsRequestNewIssuesRemediations newIssuesRemediations) {
  ...
  public SetNotificationSettingsRequest projectImported(SetNotificationSettingsRequestProjectImported projectImported) {
   ...
   */
  @javax.annotation.Nullable
  public SetNotificationSettingsRequestProjectImported getProjectImported() {
    return projectImported;
  }

  public void setProjectImported(SetNotificationSettingsRequestProjectImported projectImported) {
    this.projectImported = projectImported;
  }


  public SetNotificationSettingsRequest testLimit(SetNotificationSettingsRequestProjectImported testLimit) {
   ...
   */
  @javax.annotation.Nullable
  public SetNotificationSettingsRequestProjectImported getTestLimit() {
    return testLimit;
  }

  public void setTestLimit(SetNotificationSettingsRequestProjectImported testLimit) {
    this.testLimit = testLimit;
  }


  public SetNotificationSettingsRequest weeklyReport(SetNotificationSettingsRequestProjectImported weeklyReport) {
   ...
   */
  @javax.annotation.Nullable
  public SetNotificationSettingsRequestProjectImported getWeeklyReport() {
    return weeklyReport;
  }

  public void setWeeklyReport(SetNotificationSettingsRequestProjectImported weeklyReport) {
    this.weeklyReport = weeklyReport;
  }
  ...
  public boolean equals(Object o) {
    ...
    SetNotificationSettingsRequest setNotificationSettingsRequest = (SetNotificationSettingsRequest) o;
    return Objects.equals(this.newIssuesRemediations, setNotificationSettingsRequest.newIssuesRemediations) &&
        Objects.equals(this.projectImported, setNotificationSettingsRequest.projectImported) &&
        Objects.equals(this.testLimit, setNotificationSettingsRequest.testLimit) &&
        Objects.equals(this.weeklyReport, setNotificationSettingsRequest.weeklyReport);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetNotificationSettingsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetNotificationSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetNotificationSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetNotificationSettingsRequest is not found in the empty JSON string", SetNotificationSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetNotificationSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetNotificationSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("project-imported") != null && !jsonObj.get("project-imported").isJsonNull()) {
        SetNotificationSettingsRequestProjectImported.validateJsonElement(jsonObj.get("project-imported"));
      }
      // validate the optional field `test-limit`
      if (jsonObj.get("test-limit") != null && !jsonObj.get("test-limit").isJsonNull()) {
        SetNotificationSettingsRequestProjectImported.validateJsonElement(jsonObj.get("test-limit"));
      }
      // validate the optional field `weekly-report`
      if (jsonObj.get("weekly-report") != null && !jsonObj.get("weekly-report").isJsonNull()) {
        SetNotificationSettingsRequestProjectImported.validateJsonElement(jsonObj.get("weekly-report"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetNotificationSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetNotificationSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetNotificationSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetNotificationSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetNotificationSettingsRequest>() {
           @Override
           public void write(JsonWriter out, SetNotificationSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetNotificationSettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetNotificationSettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetNotificationSettingsRequest
   * @throws IOException if the JSON string is invalid with respect to SetNotificationSettingsRequest
   */
  public static SetNotificationSettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetNotificationSettingsRequest.class);
  }

  /**
   * Convert an instance of SetNotificationSettingsRequest to an JSON string
   *
   * @return JSON string
   */
