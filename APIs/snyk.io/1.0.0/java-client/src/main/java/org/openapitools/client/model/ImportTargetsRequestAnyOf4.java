...
import org.openapitools.client.model.ImportTargetsRequestAnyOf4Target;
...
public class ImportTargetsRequestAnyOf4 {
  ...
  private ImportTargetsRequestAnyOf4Target target;

  public ImportTargetsRequestAnyOf4() {
  }

  public ImportTargetsRequestAnyOf4 files(List<Object> files) {
    this.files = files;
    return this;
  }

  public ImportTargetsRequestAnyOf4 addFilesItem(Object filesItem) {
    if (this.files == null) {
  ...
  public ImportTargetsRequestAnyOf4 target(ImportTargetsRequestAnyOf4Target target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportTargetsRequestAnyOf4Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf4Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf4 importTargetsRequestAnyOf4 = (ImportTargetsRequestAnyOf4) o;
    return Objects.equals(this.files, importTargetsRequestAnyOf4.files) &&
        Objects.equals(this.target, importTargetsRequestAnyOf4.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf4 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf4 is not found in the empty JSON string", ImportTargetsRequestAnyOf4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf4Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf4.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf4>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf4
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf4
   */
  public static ImportTargetsRequestAnyOf4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf4.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf4 to an JSON string
   *
   * @return JSON string
   */
