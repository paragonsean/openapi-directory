...
import org.openapitools.client.model.TestGemfileLockFileRequestFilesTarget;
...
public class TestGemfileLockFileRequestFiles {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private TestGemfileLockFileRequestFilesTarget target;

  public TestGemfileLockFileRequestFiles() {
  }

  public TestGemfileLockFileRequestFiles target(TestGemfileLockFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
  ...
  public TestGemfileLockFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestGemfileLockFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestGemfileLockFileRequestFiles testGemfileLockFileRequestFiles = (TestGemfileLockFileRequestFiles) o;
    return Objects.equals(this.target, testGemfileLockFileRequestFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGemfileLockFileRequestFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGemfileLockFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGemfileLockFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGemfileLockFileRequestFiles is not found in the empty JSON string", TestGemfileLockFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGemfileLockFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGemfileLockFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestGemfileLockFileRequestFiles.openapiRequiredFields) {
      ...
      TestGemfileLockFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGemfileLockFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGemfileLockFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGemfileLockFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGemfileLockFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGemfileLockFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestGemfileLockFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGemfileLockFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGemfileLockFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGemfileLockFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestGemfileLockFileRequestFiles
   */
  public static TestGemfileLockFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGemfileLockFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestGemfileLockFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
