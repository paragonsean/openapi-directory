...
public class PackageLockJsonFile {
  ...
  public PackageLockJsonFile() {
  }

  public PackageLockJsonFile contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    PackageLockJsonFile packageLockJsonFile = (PackageLockJsonFile) o;
    return Objects.equals(this.contents, packageLockJsonFile.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageLockJsonFile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageLockJsonFile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageLockJsonFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageLockJsonFile is not found in the empty JSON string", PackageLockJsonFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageLockJsonFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageLockJsonFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageLockJsonFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageLockJsonFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageLockJsonFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageLockJsonFile.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageLockJsonFile>() {
           @Override
           public void write(JsonWriter out, PackageLockJsonFile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageLockJsonFile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageLockJsonFile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageLockJsonFile
   * @throws IOException if the JSON string is invalid with respect to PackageLockJsonFile
   */
  public static PackageLockJsonFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageLockJsonFile.class);
  }

  /**
   * Convert an instance of PackageLockJsonFile to an JSON string
   *
   * @return JSON string
   */
