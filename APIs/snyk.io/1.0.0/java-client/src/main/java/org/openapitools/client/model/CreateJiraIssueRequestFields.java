...
public class CreateJiraIssueRequestFields {
  ...
  public CreateJiraIssueRequestFields() {
  }

  public CreateJiraIssueRequestFields issuetype(Object issuetype) {
  ...
  public CreateJiraIssueRequestFields project(Object project) {
  ...
  public CreateJiraIssueRequestFields summary(String summary) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJiraIssueRequestFields createJiraIssueRequestFields = (CreateJiraIssueRequestFields) o;
    return Objects.equals(this.issuetype, createJiraIssueRequestFields.issuetype) &&
        Objects.equals(this.project, createJiraIssueRequestFields.project) &&
        Objects.equals(this.summary, createJiraIssueRequestFields.summary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issuetype, project, summary);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateJiraIssueRequestFields {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJiraIssueRequestFields
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJiraIssueRequestFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJiraIssueRequestFields is not found in the empty JSON string", CreateJiraIssueRequestFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJiraIssueRequestFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJiraIssueRequestFields` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJiraIssueRequestFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJiraIssueRequestFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJiraIssueRequestFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJiraIssueRequestFields.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJiraIssueRequestFields>() {
           @Override
           public void write(JsonWriter out, CreateJiraIssueRequestFields value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJiraIssueRequestFields read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJiraIssueRequestFields given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJiraIssueRequestFields
   * @throws IOException if the JSON string is invalid with respect to CreateJiraIssueRequestFields
   */
  public static CreateJiraIssueRequestFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJiraIssueRequestFields.class);
  }

  /**
   * Convert an instance of CreateJiraIssueRequestFields to an JSON string
   *
   * @return JSON string
   */
