...
public class ViewGroupSettings200ResponseRequestAccess {
  public static final String SERIALIZED_NAME_ENABLED = "enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public ViewGroupSettings200ResponseRequestAccess() {
  }

  public ViewGroupSettings200ResponseRequestAccess enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    ViewGroupSettings200ResponseRequestAccess viewGroupSettings200ResponseRequestAccess = (ViewGroupSettings200ResponseRequestAccess) o;
    return Objects.equals(this.enabled, viewGroupSettings200ResponseRequestAccess.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewGroupSettings200ResponseRequestAccess {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewGroupSettings200ResponseRequestAccess
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewGroupSettings200ResponseRequestAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewGroupSettings200ResponseRequestAccess is not found in the empty JSON string", ViewGroupSettings200ResponseRequestAccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewGroupSettings200ResponseRequestAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewGroupSettings200ResponseRequestAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ViewGroupSettings200ResponseRequestAccess.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewGroupSettings200ResponseRequestAccess.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewGroupSettings200ResponseRequestAccess' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewGroupSettings200ResponseRequestAccess> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewGroupSettings200ResponseRequestAccess.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewGroupSettings200ResponseRequestAccess>() {
           @Override
           public void write(JsonWriter out, ViewGroupSettings200ResponseRequestAccess value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewGroupSettings200ResponseRequestAccess read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewGroupSettings200ResponseRequestAccess given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewGroupSettings200ResponseRequestAccess
   * @throws IOException if the JSON string is invalid with respect to ViewGroupSettings200ResponseRequestAccess
   */
  public static ViewGroupSettings200ResponseRequestAccess fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewGroupSettings200ResponseRequestAccess.class);
  }

  /**
   * Convert an instance of ViewGroupSettings200ResponseRequestAccess to an JSON string
   *
   * @return JSON string
   */
