...
import org.openapitools.client.model.ProjectIssuesFiltersFilters;
...
public class ProjectIssuesFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private ProjectIssuesFiltersFilters filters;

  public ProjectIssuesFilters() {
  }

  public ProjectIssuesFilters filters(ProjectIssuesFiltersFilters filters) {
  ...
  public ProjectIssuesFiltersFilters getFilters() {
    return filters;
  }

  public void setFilters(ProjectIssuesFiltersFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectIssuesFilters projectIssuesFilters = (ProjectIssuesFilters) o;
    return Objects.equals(this.filters, projectIssuesFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectIssuesFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectIssuesFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectIssuesFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectIssuesFilters is not found in the empty JSON string", ProjectIssuesFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectIssuesFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectIssuesFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ProjectIssuesFiltersFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectIssuesFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectIssuesFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectIssuesFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectIssuesFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectIssuesFilters>() {
           @Override
           public void write(JsonWriter out, ProjectIssuesFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectIssuesFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectIssuesFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectIssuesFilters
   * @throws IOException if the JSON string is invalid with respect to ProjectIssuesFilters
   */
  public static ProjectIssuesFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectIssuesFilters.class);
  }

  /**
   * Convert an instance of ProjectIssuesFilters to an JSON string
   *
   * @return JSON string
   */
