...
public class DeletePendingUserProvision200Response {
  public static final String SERIALIZED_NAME_OK = "ok";
  @SerializedName(SERIALIZED_NAME_OK)
  private Boolean ok;

  public DeletePendingUserProvision200Response() {
  }

  public DeletePendingUserProvision200Response ok(Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeletePendingUserProvision200Response deletePendingUserProvision200Response = (DeletePendingUserProvision200Response) o;
    return Objects.equals(this.ok, deletePendingUserProvision200Response.ok);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletePendingUserProvision200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePendingUserProvision200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePendingUserProvision200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePendingUserProvision200Response is not found in the empty JSON string", DeletePendingUserProvision200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePendingUserProvision200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePendingUserProvision200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePendingUserProvision200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePendingUserProvision200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePendingUserProvision200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePendingUserProvision200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePendingUserProvision200Response>() {
           @Override
           public void write(JsonWriter out, DeletePendingUserProvision200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePendingUserProvision200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePendingUserProvision200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePendingUserProvision200Response
   * @throws IOException if the JSON string is invalid with respect to DeletePendingUserProvision200Response
   */
  public static DeletePendingUserProvision200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePendingUserProvision200Response.class);
  }

  /**
   * Convert an instance of DeletePendingUserProvision200Response to an JSON string
   *
   * @return JSON string
   */
