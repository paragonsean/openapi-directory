...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials password(String password) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials addNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials = (AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials) o;
    return Objects.equals(this.password, addNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.password) &&
        Objects.equals(this.username, addNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf6DockerHubCredentials to an JSON string
   *
   * @return JSON string
   */
