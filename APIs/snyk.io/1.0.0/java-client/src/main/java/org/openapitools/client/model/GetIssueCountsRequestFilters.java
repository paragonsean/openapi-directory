...
public class GetIssueCountsRequestFilters {
  ...
  public GetIssueCountsRequestFilters() {
  }

  public GetIssueCountsRequestFilters fixable(Boolean fixable) {
  ...
  public GetIssueCountsRequestFilters ignored(Boolean ignored) {
  ...
  public GetIssueCountsRequestFilters isPatchable(Boolean isPatchable) {
  ...
  public GetIssueCountsRequestFilters isPinnable(Boolean isPinnable) {
  ...
  public GetIssueCountsRequestFilters isUpgradable(Boolean isUpgradable) {
  ...
  public GetIssueCountsRequestFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public GetIssueCountsRequestFilters addLanguagesItem(Object languagesItem) {
  ...
  public GetIssueCountsRequestFilters orgs(Object orgs) {
    this.orgs = orgs;
    return this;
  }
  ...
  public GetIssueCountsRequestFilters patched(Boolean patched) {
  ...
  public GetIssueCountsRequestFilters priorityScore(GetIssueCountsRequestFiltersPriorityScore priorityScore) {
  ...
  public GetIssueCountsRequestFilters projects(Object projects) {
  ...
  public GetIssueCountsRequestFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public GetIssueCountsRequestFilters addSeverityItem(Object severityItem) {
  ...
  public GetIssueCountsRequestFilters types(List<Object> types) {
    this.types = types;
    return this;
  }

  public GetIssueCountsRequestFilters addTypesItem(Object typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCountsRequestFilters getIssueCountsRequestFilters = (GetIssueCountsRequestFilters) o;
    return Objects.equals(this.fixable, getIssueCountsRequestFilters.fixable) &&
        Objects.equals(this.ignored, getIssueCountsRequestFilters.ignored) &&
        Objects.equals(this.isPatchable, getIssueCountsRequestFilters.isPatchable) &&
        Objects.equals(this.isPinnable, getIssueCountsRequestFilters.isPinnable) &&
        Objects.equals(this.isUpgradable, getIssueCountsRequestFilters.isUpgradable) &&
        Objects.equals(this.languages, getIssueCountsRequestFilters.languages) &&
        Objects.equals(this.orgs, getIssueCountsRequestFilters.orgs) &&
        Objects.equals(this.patched, getIssueCountsRequestFilters.patched) &&
        Objects.equals(this.priorityScore, getIssueCountsRequestFilters.priorityScore) &&
        Objects.equals(this.projects, getIssueCountsRequestFilters.projects) &&
        Objects.equals(this.severity, getIssueCountsRequestFilters.severity) &&
        Objects.equals(this.types, getIssueCountsRequestFilters.types);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fixable, ignored, isPatchable, isPinnable, isUpgradable, languages, orgs, patched, priorityScore, projects, severity, types);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIssueCountsRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCountsRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCountsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCountsRequestFilters is not found in the empty JSON string", GetIssueCountsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCountsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCountsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIssueCountsRequestFilters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCountsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCountsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCountsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCountsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCountsRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetIssueCountsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCountsRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCountsRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCountsRequestFilters
   * @throws IOException if the JSON string is invalid with respect to GetIssueCountsRequestFilters
   */
  public static GetIssueCountsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCountsRequestFilters.class);
  }

  /**
   * Convert an instance of GetIssueCountsRequestFilters to an JSON string
   *
   * @return JSON string
   */
