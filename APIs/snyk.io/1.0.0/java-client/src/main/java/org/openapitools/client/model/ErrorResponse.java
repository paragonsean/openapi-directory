...
import org.openapitools.client.model.GetIssueCounts400ResponseError;
...
public class ErrorResponse {
  ...
  private GetIssueCounts400ResponseError error;
  ...
  public ErrorResponse error(GetIssueCounts400ResponseError error) {
    this.error = error;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public GetIssueCounts400ResponseError getError() {
    return error;
  }

  public void setError(GetIssueCounts400ResponseError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, errorResponse.code) &&
        ...
        Objects.equals(this.ok, errorResponse.ok);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, error, ok);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      GetIssueCounts400ResponseError.validateJsonElement(jsonObj.get("error"));
  }
