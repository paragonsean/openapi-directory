...
public class OrgAuditLogsFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetOrganizationLevelAuditLogsRequestFilters filters;

  public OrgAuditLogsFilters() {
  }

  public OrgAuditLogsFilters filters(GetOrganizationLevelAuditLogsRequestFilters filters) {
  ...
  public boolean equals(Object o) {
    ...
    OrgAuditLogsFilters orgAuditLogsFilters = (OrgAuditLogsFilters) o;
    return Objects.equals(this.filters, orgAuditLogsFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgAuditLogsFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgAuditLogsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgAuditLogsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgAuditLogsFilters is not found in the empty JSON string", OrgAuditLogsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgAuditLogsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrgAuditLogsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgAuditLogsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgAuditLogsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgAuditLogsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgAuditLogsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgAuditLogsFilters>() {
           @Override
           public void write(JsonWriter out, OrgAuditLogsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgAuditLogsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgAuditLogsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgAuditLogsFilters
   * @throws IOException if the JSON string is invalid with respect to OrgAuditLogsFilters
   */
  public static OrgAuditLogsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgAuditLogsFilters.class);
  }

  /**
   * Convert an instance of OrgAuditLogsFilters to an JSON string
   *
   * @return JSON string
   */
