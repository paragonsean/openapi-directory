...
import org.openapitools.client.model.GetGroupLevelAuditLogsRequestFilters;
...
public class GetGroupLevelAuditLogsRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetGroupLevelAuditLogsRequestFilters filters;

  public GetGroupLevelAuditLogsRequest() {
  }

  public GetGroupLevelAuditLogsRequest filters(GetGroupLevelAuditLogsRequestFilters filters) {
  ...
  public GetGroupLevelAuditLogsRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(GetGroupLevelAuditLogsRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetGroupLevelAuditLogsRequest getGroupLevelAuditLogsRequest = (GetGroupLevelAuditLogsRequest) o;
    return Objects.equals(this.filters, getGroupLevelAuditLogsRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetGroupLevelAuditLogsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetGroupLevelAuditLogsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetGroupLevelAuditLogsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetGroupLevelAuditLogsRequest is not found in the empty JSON string", GetGroupLevelAuditLogsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetGroupLevelAuditLogsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetGroupLevelAuditLogsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        GetGroupLevelAuditLogsRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetGroupLevelAuditLogsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetGroupLevelAuditLogsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetGroupLevelAuditLogsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetGroupLevelAuditLogsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetGroupLevelAuditLogsRequest>() {
           @Override
           public void write(JsonWriter out, GetGroupLevelAuditLogsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetGroupLevelAuditLogsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetGroupLevelAuditLogsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetGroupLevelAuditLogsRequest
   * @throws IOException if the JSON string is invalid with respect to GetGroupLevelAuditLogsRequest
   */
  public static GetGroupLevelAuditLogsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetGroupLevelAuditLogsRequest.class);
  }

  /**
   * Convert an instance of GetGroupLevelAuditLogsRequest to an JSON string
   *
   * @return JSON string
   */
