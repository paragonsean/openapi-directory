...
import org.openapitools.client.model.ImportTargetsRequestAnyOf6Target;
...
public class ImportTargetsRequestAnyOf6 {
  ...
  private ImportTargetsRequestAnyOf6Target target;

  public ImportTargetsRequestAnyOf6() {
  }

  public ImportTargetsRequestAnyOf6 files(List<Object> files) {
    this.files = files;
    return this;
  }

  public ImportTargetsRequestAnyOf6 addFilesItem(Object filesItem) {
    if (this.files == null) {
  ...
  public ImportTargetsRequestAnyOf6 target(ImportTargetsRequestAnyOf6Target target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportTargetsRequestAnyOf6Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf6Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf6 importTargetsRequestAnyOf6 = (ImportTargetsRequestAnyOf6) o;
    return Objects.equals(this.files, importTargetsRequestAnyOf6.files) &&
        Objects.equals(this.target, importTargetsRequestAnyOf6.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf6 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf6
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf6.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf6 is not found in the empty JSON string", ImportTargetsRequestAnyOf6.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf6` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf6Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf6.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf6>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf6 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf6 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf6 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf6
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf6
   */
  public static ImportTargetsRequestAnyOf6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf6.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf6 to an JSON string
   *
   * @return JSON string
   */
