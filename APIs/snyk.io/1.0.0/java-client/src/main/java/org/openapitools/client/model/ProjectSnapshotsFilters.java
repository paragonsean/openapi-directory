...
public class ProjectSnapshotsFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private ListAllProjectSnapshotsRequestFilters filters;

  public ProjectSnapshotsFilters() {
  }

  public ProjectSnapshotsFilters filters(ListAllProjectSnapshotsRequestFilters filters) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectSnapshotsFilters projectSnapshotsFilters = (ProjectSnapshotsFilters) o;
    return Objects.equals(this.filters, projectSnapshotsFilters.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectSnapshotsFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectSnapshotsFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSnapshotsFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectSnapshotsFilters is not found in the empty JSON string", ProjectSnapshotsFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSnapshotsFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSnapshotsFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectSnapshotsFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectSnapshotsFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectSnapshotsFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectSnapshotsFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectSnapshotsFilters>() {
           @Override
           public void write(JsonWriter out, ProjectSnapshotsFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectSnapshotsFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectSnapshotsFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectSnapshotsFilters
   * @throws IOException if the JSON string is invalid with respect to ProjectSnapshotsFilters
   */
  public static ProjectSnapshotsFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectSnapshotsFilters.class);
  }

  /**
   * Convert an instance of ProjectSnapshotsFilters to an JSON string
   *
   * @return JSON string
   */
