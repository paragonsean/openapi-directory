...
public class ApplyingAttributesRequest {
  ...
  public ApplyingAttributesRequest() {
  }

  public ApplyingAttributesRequest criticality(List<Object> criticality) {
    this.criticality = criticality;
    return this;
  }

  public ApplyingAttributesRequest addCriticalityItem(Object criticalityItem) {
  ...
  public ApplyingAttributesRequest environment(List<Object> environment) {
    this.environment = environment;
    return this;
  }

  public ApplyingAttributesRequest addEnvironmentItem(Object environmentItem) {
  ...
  public ApplyingAttributesRequest lifecycle(List<Object> lifecycle) {
    this.lifecycle = lifecycle;
    return this;
  }

  public ApplyingAttributesRequest addLifecycleItem(Object lifecycleItem) {
  ...
  public boolean equals(Object o) {
    ...
    ApplyingAttributesRequest applyingAttributesRequest = (ApplyingAttributesRequest) o;
    return Objects.equals(this.criticality, applyingAttributesRequest.criticality) &&
        Objects.equals(this.environment, applyingAttributesRequest.environment) &&
        Objects.equals(this.lifecycle, applyingAttributesRequest.lifecycle);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplyingAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplyingAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplyingAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplyingAttributesRequest is not found in the empty JSON string", ApplyingAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplyingAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplyingAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplyingAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplyingAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplyingAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplyingAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplyingAttributesRequest>() {
           @Override
           public void write(JsonWriter out, ApplyingAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplyingAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplyingAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplyingAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to ApplyingAttributesRequest
   */
  public static ApplyingAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplyingAttributesRequest.class);
  }

  /**
   * Convert an instance of ApplyingAttributesRequest to an JSON string
   *
   * @return JSON string
   */
