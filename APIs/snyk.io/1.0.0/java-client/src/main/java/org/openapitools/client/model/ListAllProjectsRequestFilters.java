...
import org.openapitools.client.model.ListAllProjectsRequestFiltersAttributes;
...
public class ListAllProjectsRequestFilters {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private ListAllProjectsRequestFiltersAttributes attributes;
  ...
  public ListAllProjectsRequestFilters() {
  }

  public ListAllProjectsRequestFilters attributes(ListAllProjectsRequestFiltersAttributes attributes) {
  ...
  public ListAllProjectsRequestFiltersAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(ListAllProjectsRequestFiltersAttributes attributes) {
    this.attributes = attributes;
  }


  public ListAllProjectsRequestFilters isMonitored(Boolean isMonitored) {
  ...
  public ListAllProjectsRequestFilters name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ListAllProjectsRequestFilters origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public ListAllProjectsRequestFilters tags(ListAllProjectsRequestFiltersTags tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ListAllProjectsRequestFilters type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectsRequestFilters listAllProjectsRequestFilters = (ListAllProjectsRequestFilters) o;
    return Objects.equals(this.attributes, listAllProjectsRequestFilters.attributes) &&
        Objects.equals(this.isMonitored, listAllProjectsRequestFilters.isMonitored) &&
        Objects.equals(this.name, listAllProjectsRequestFilters.name) &&
        Objects.equals(this.origin, listAllProjectsRequestFilters.origin) &&
        Objects.equals(this.tags, listAllProjectsRequestFilters.tags) &&
        Objects.equals(this.type, listAllProjectsRequestFilters.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjectsRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectsRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectsRequestFilters is not found in the empty JSON string", ListAllProjectsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        ListAllProjectsRequestFiltersAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectsRequestFilters>() {
           @Override
           public void write(JsonWriter out, ListAllProjectsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectsRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectsRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectsRequestFilters
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectsRequestFilters
   */
  public static ListAllProjectsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectsRequestFilters.class);
  }

  /**
   * Convert an instance of ListAllProjectsRequestFilters to an JSON string
   *
   * @return JSON string
   */
