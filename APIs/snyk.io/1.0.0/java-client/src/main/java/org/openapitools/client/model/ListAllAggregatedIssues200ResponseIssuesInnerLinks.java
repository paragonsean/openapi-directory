...
public class ListAllAggregatedIssues200ResponseIssuesInnerLinks {
  public static final String SERIALIZED_NAME_PATHS = "paths";
  @SerializedName(SERIALIZED_NAME_PATHS)
  private String paths;

  public ListAllAggregatedIssues200ResponseIssuesInnerLinks() {
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerLinks paths(String paths) {
    this.paths = paths;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssues200ResponseIssuesInnerLinks listAllAggregatedIssues200ResponseIssuesInnerLinks = (ListAllAggregatedIssues200ResponseIssuesInnerLinks) o;
    return Objects.equals(this.paths, listAllAggregatedIssues200ResponseIssuesInnerLinks.paths);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllAggregatedIssues200ResponseIssuesInnerLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssues200ResponseIssuesInnerLinks is not found in the empty JSON string", ListAllAggregatedIssues200ResponseIssuesInnerLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssues200ResponseIssuesInnerLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("paths") != null && !jsonObj.get("paths").isJsonNull()) && !jsonObj.get("paths").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `paths` to be a primitive type in the JSON string but got `%s`", jsonObj.get("paths").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssues200ResponseIssuesInnerLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssues200ResponseIssuesInnerLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssues200ResponseIssuesInnerLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerLinks>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssues200ResponseIssuesInnerLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssues200ResponseIssuesInnerLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssues200ResponseIssuesInnerLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssues200ResponseIssuesInnerLinks
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerLinks
   */
  public static ListAllAggregatedIssues200ResponseIssuesInnerLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssues200ResponseIssuesInnerLinks.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssues200ResponseIssuesInnerLinks to an JSON string
   *
   * @return JSON string
   */
