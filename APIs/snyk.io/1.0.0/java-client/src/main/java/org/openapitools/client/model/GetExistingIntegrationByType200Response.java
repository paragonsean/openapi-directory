...
public class GetExistingIntegrationByType200Response {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;

  public GetExistingIntegrationByType200Response() {
  }

  public GetExistingIntegrationByType200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetExistingIntegrationByType200Response getExistingIntegrationByType200Response = (GetExistingIntegrationByType200Response) o;
    return Objects.equals(this.id, getExistingIntegrationByType200Response.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetExistingIntegrationByType200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetExistingIntegrationByType200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetExistingIntegrationByType200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetExistingIntegrationByType200Response is not found in the empty JSON string", GetExistingIntegrationByType200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetExistingIntegrationByType200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetExistingIntegrationByType200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetExistingIntegrationByType200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetExistingIntegrationByType200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetExistingIntegrationByType200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetExistingIntegrationByType200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetExistingIntegrationByType200Response>() {
           @Override
           public void write(JsonWriter out, GetExistingIntegrationByType200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetExistingIntegrationByType200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetExistingIntegrationByType200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetExistingIntegrationByType200Response
   * @throws IOException if the JSON string is invalid with respect to GetExistingIntegrationByType200Response
   */
  public static GetExistingIntegrationByType200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetExistingIntegrationByType200Response.class);
  }

  /**
   * Convert an instance of GetExistingIntegrationByType200Response to an JSON string
   *
   * @return JSON string
   */
