...
public class EntitlementsApi {
    ...
    /**
     * Build call for getAnOrganizationsEntitlementValue
     * @param orgId The organization ID to query the entitlement for. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param entitlementKey The entitlement to query. (required)
     ...
     */
    public okhttp3.Call getAnOrganizationsEntitlementValueCall(String orgId, String entitlementKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/org/{orgId}/entitlement/{entitlementKey}"
            .replace("{" + "orgId" + "}", localVarApiClient.escapeString(orgId.toString()))
            .replace("{" + "entitlementKey" + "}", localVarApiClient.escapeString(entitlementKey.toString()));
    ...
    private okhttp3.Call getAnOrganizationsEntitlementValueValidateBeforeCall(String orgId, String entitlementKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling getAnOrganizationsEntitlementValue(Async)");
        }

        // verify the required parameter 'entitlementKey' is set
        if (entitlementKey == null) {
            throw new ApiException("Missing the required parameter 'entitlementKey' when calling getAnOrganizationsEntitlementValue(Async)");
        }

        return getAnOrganizationsEntitlementValueCall(orgId, entitlementKey, _callback);
     ...
     */
    public void getAnOrganizationsEntitlementValue(String orgId, String entitlementKey) throws ApiException {
        getAnOrganizationsEntitlementValueWithHttpInfo(orgId, entitlementKey);
    }
     ...
     */
    public ApiResponse<Void> getAnOrganizationsEntitlementValueWithHttpInfo(String orgId, String entitlementKey) throws ApiException {
        okhttp3.Call localVarCall = getAnOrganizationsEntitlementValueValidateBeforeCall(orgId, entitlementKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get an organization&#39;s entitlement value (asynchronously)
     * 
     * @param orgId The organization ID to query the entitlement for. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param entitlementKey The entitlement to query. (required)
     ...
     */
    public okhttp3.Call getAnOrganizationsEntitlementValueAsync(String orgId, String entitlementKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAnOrganizationsEntitlementValueValidateBeforeCall(orgId, entitlementKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for listAllEntitlements
     * @param orgId The organization ID to list entitlements for. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listAllEntitlementsCall(String orgId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/org/{orgId}/entitlements"
            .replace("{" + "orgId" + "}", localVarApiClient.escapeString(orgId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllEntitlementsValidateBeforeCall(String orgId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling listAllEntitlements(Async)");
        }

        return listAllEntitlementsCall(orgId, _callback);
     ...
     */
    public void listAllEntitlements(String orgId) throws ApiException {
        listAllEntitlementsWithHttpInfo(orgId);
    }
     ...
     */
    public ApiResponse<Void> listAllEntitlementsWithHttpInfo(String orgId) throws ApiException {
        okhttp3.Call localVarCall = listAllEntitlementsValidateBeforeCall(orgId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call listAllEntitlementsAsync(String orgId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllEntitlementsValidateBeforeCall(orgId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
