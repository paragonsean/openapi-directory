...
public class PipRequestPayload {
  /**
  ...
  public PipRequestPayload() {
  }

  public PipRequestPayload encoding(EncodingEnum encoding) {
  ...
  public PipRequestPayload files(TestRequirementsTxtFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PipRequestPayload pipRequestPayload = (PipRequestPayload) o;
    return Objects.equals(this.encoding, pipRequestPayload.encoding) &&
        Objects.equals(this.files, pipRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PipRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PipRequestPayload is not found in the empty JSON string", PipRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PipRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PipRequestPayload.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PipRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PipRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PipRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PipRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<PipRequestPayload>() {
           @Override
           public void write(JsonWriter out, PipRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PipRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PipRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PipRequestPayload
   * @throws IOException if the JSON string is invalid with respect to PipRequestPayload
   */
  public static PipRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PipRequestPayload.class);
  }

  /**
   * Convert an instance of PipRequestPayload to an JSON string
   *
   * @return JSON string
   */
