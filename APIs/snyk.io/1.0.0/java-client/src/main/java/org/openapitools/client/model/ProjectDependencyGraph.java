...
public class ProjectDependencyGraph {
  ...
  public ProjectDependencyGraph depGraph(GetProjectDependencyGraph200ResponseDepGraph depGraph) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectDependencyGraph projectDependencyGraph = (ProjectDependencyGraph) o;
    return Objects.equals(this.depGraph, projectDependencyGraph.depGraph);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectDependencyGraph {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectDependencyGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectDependencyGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectDependencyGraph is not found in the empty JSON string", ProjectDependencyGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectDependencyGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectDependencyGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectDependencyGraph.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectDependencyGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectDependencyGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectDependencyGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectDependencyGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectDependencyGraph>() {
           @Override
           public void write(JsonWriter out, ProjectDependencyGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectDependencyGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectDependencyGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectDependencyGraph
   * @throws IOException if the JSON string is invalid with respect to ProjectDependencyGraph
   */
  public static ProjectDependencyGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectDependencyGraph.class);
  }

  /**
   * Convert an instance of ProjectDependencyGraph to an JSON string
   *
   * @return JSON string
   */
