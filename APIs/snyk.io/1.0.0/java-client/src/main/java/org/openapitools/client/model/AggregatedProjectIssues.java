...
import org.openapitools.client.model.AggregatedProjectIssuesIssuesInner;
...
public class AggregatedProjectIssues {
  public static final String SERIALIZED_NAME_ISSUES = "issues";
  @SerializedName(SERIALIZED_NAME_ISSUES)
  private List<AggregatedProjectIssuesIssuesInner> issues = new ArrayList<>();

  public AggregatedProjectIssues() {
  }

  public AggregatedProjectIssues issues(List<AggregatedProjectIssuesIssuesInner> issues) {
    this.issues = issues;
    return this;
  }

  public AggregatedProjectIssues addIssuesItem(AggregatedProjectIssuesIssuesInner issuesItem) {
    if (this.issues == null) {
  ...
  public List<AggregatedProjectIssuesIssuesInner> getIssues() {
    return issues;
  }

  public void setIssues(List<AggregatedProjectIssuesIssuesInner> issues) {
    this.issues = issues;
  }
  ...
  public boolean equals(Object o) {
    ...
    AggregatedProjectIssues aggregatedProjectIssues = (AggregatedProjectIssues) o;
    return Objects.equals(this.issues, aggregatedProjectIssues.issues);
  }
  ...
  public String toString() {
    ...
    sb.append("class AggregatedProjectIssues {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregatedProjectIssues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregatedProjectIssues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregatedProjectIssues is not found in the empty JSON string", AggregatedProjectIssues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregatedProjectIssues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AggregatedProjectIssues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("issues") != null && !jsonObj.get("issues").isJsonNull()) {
        ...
        if (jsonArrayissues != null) {
          ...
          for (int i = 0; i < jsonArrayissues.size(); i++) {
            AggregatedProjectIssuesIssuesInner.validateJsonElement(jsonArrayissues.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregatedProjectIssues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregatedProjectIssues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregatedProjectIssues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregatedProjectIssues.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregatedProjectIssues>() {
           @Override
           public void write(JsonWriter out, AggregatedProjectIssues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregatedProjectIssues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregatedProjectIssues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregatedProjectIssues
   * @throws IOException if the JSON string is invalid with respect to AggregatedProjectIssues
   */
  public static AggregatedProjectIssues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregatedProjectIssues.class);
  }

  /**
   * Convert an instance of AggregatedProjectIssues to an JSON string
   *
   * @return JSON string
   */
