...
import org.openapitools.client.model.ImportTargetsRequestAnyOfTarget;
...
public class ImportTargetsRequestAnyOf {
  ...
  private ImportTargetsRequestAnyOfTarget target;

  public ImportTargetsRequestAnyOf() {
  }

  public ImportTargetsRequestAnyOf exclusionGlobs(String exclusionGlobs) {
  ...
  public ImportTargetsRequestAnyOf files(List<Object> files) {
    this.files = files;
    return this;
  }

  public ImportTargetsRequestAnyOf addFilesItem(Object filesItem) {
    if (this.files == null) {
  ...
  public ImportTargetsRequestAnyOf target(ImportTargetsRequestAnyOfTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportTargetsRequestAnyOfTarget getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOfTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf importTargetsRequestAnyOf = (ImportTargetsRequestAnyOf) o;
    return Objects.equals(this.exclusionGlobs, importTargetsRequestAnyOf.exclusionGlobs) &&
        Objects.equals(this.files, importTargetsRequestAnyOf.files) &&
        Objects.equals(this.target, importTargetsRequestAnyOf.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf is not found in the empty JSON string", ImportTargetsRequestAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOfTarget.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf
   */
  public static ImportTargetsRequestAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf to an JSON string
   *
   * @return JSON string
   */
