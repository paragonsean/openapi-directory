...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf13 {
  public static final String SERIALIZED_NAME_GIT_LAB_CR_CREDENTIALS = "GitLabCrCredentials";
  @SerializedName(SERIALIZED_NAME_GIT_LAB_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials gitLabCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf13() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf13 gitLabCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials gitLabCrCredentials) {
    this.gitLabCrCredentials = gitLabCrCredentials;
    return this;
  }

  /**
   * Get gitLabCrCredentials
   * @return gitLabCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials getGitLabCrCredentials() {
    return gitLabCrCredentials;
  }

  public void setGitLabCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials gitLabCrCredentials) {
    this.gitLabCrCredentials = gitLabCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf13 addNewIntegrationRequestAnyOfCredentialsOneOf13 = (AddNewIntegrationRequestAnyOfCredentialsOneOf13) o;
    return Objects.equals(this.gitLabCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf13.gitLabCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gitLabCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf13 {\n");
    sb.append("    gitLabCrCredentials: ").append(toIndentedString(gitLabCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("GitLabCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf13
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf13.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf13 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf13.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf13.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf13` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GitLabCrCredentials`
      if (jsonObj.get("GitLabCrCredentials") != null && !jsonObj.get("GitLabCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.validateJsonElement(jsonObj.get("GitLabCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf13.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf13>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf13 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf13 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf13 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf13
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf13
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf13.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf13 to an JSON string
   *
   * @return JSON string
   */
