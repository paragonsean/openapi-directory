...
public class MonitorPkgManager {
  ...
  public MonitorPkgManager() {
  }

  public MonitorPkgManager name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MonitorPkgManager repositories(List<Object> repositories) {
    this.repositories = repositories;
    return this;
  }

  public MonitorPkgManager addRepositoriesItem(Object repositoriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorPkgManager monitorPkgManager = (MonitorPkgManager) o;
    return Objects.equals(this.name, monitorPkgManager.name) &&
        Objects.equals(this.repositories, monitorPkgManager.repositories);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorPkgManager {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorPkgManager
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorPkgManager.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorPkgManager is not found in the empty JSON string", MonitorPkgManager.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorPkgManager.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorPkgManager` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorPkgManager.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorPkgManager.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorPkgManager' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorPkgManager> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorPkgManager.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorPkgManager>() {
           @Override
           public void write(JsonWriter out, MonitorPkgManager value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorPkgManager read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorPkgManager given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorPkgManager
   * @throws IOException if the JSON string is invalid with respect to MonitorPkgManager
   */
  public static MonitorPkgManager fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorPkgManager.class);
  }

  /**
   * Convert an instance of MonitorPkgManager to an JSON string
   *
   * @return JSON string
   */
