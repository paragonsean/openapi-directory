...
public class LicensesFiltersFilters {
  ...
  public LicensesFiltersFilters() {
  }

  public LicensesFiltersFilters dependencies(List<Object> dependencies) {
    this.dependencies = dependencies;
    return this;
  }

  public LicensesFiltersFilters addDependenciesItem(Object dependenciesItem) {
  ...
  public LicensesFiltersFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public LicensesFiltersFilters addLanguagesItem(Object languagesItem) {
  ...
  public LicensesFiltersFilters licenses(List<Object> licenses) {
    this.licenses = licenses;
    return this;
  }

  public LicensesFiltersFilters addLicensesItem(Object licensesItem) {
  ...
  public LicensesFiltersFilters projects(List<Object> projects) {
    this.projects = projects;
    return this;
  }

  public LicensesFiltersFilters addProjectsItem(Object projectsItem) {
  ...
  public LicensesFiltersFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public LicensesFiltersFilters addSeverityItem(Object severityItem) {
  ...
  public boolean equals(Object o) {
    ...
    LicensesFiltersFilters licensesFiltersFilters = (LicensesFiltersFilters) o;
    return Objects.equals(this.dependencies, licensesFiltersFilters.dependencies) &&
        Objects.equals(this.languages, licensesFiltersFilters.languages) &&
        Objects.equals(this.licenses, licensesFiltersFilters.licenses) &&
        Objects.equals(this.projects, licensesFiltersFilters.projects) &&
        Objects.equals(this.severity, licensesFiltersFilters.severity);
  }
  ...
  public String toString() {
    ...
    sb.append("class LicensesFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LicensesFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LicensesFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LicensesFiltersFilters is not found in the empty JSON string", LicensesFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LicensesFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LicensesFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LicensesFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LicensesFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LicensesFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LicensesFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<LicensesFiltersFilters>() {
           @Override
           public void write(JsonWriter out, LicensesFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LicensesFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LicensesFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LicensesFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to LicensesFiltersFilters
   */
  public static LicensesFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LicensesFiltersFilters.class);
  }

  /**
   * Convert an instance of LicensesFiltersFilters to an JSON string
   *
   * @return JSON string
   */
