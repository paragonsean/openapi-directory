...
public class MonitorDepGraphRequestDepGraphPkgManager {
  ...
  public MonitorDepGraphRequestDepGraphPkgManager() {
  }

  public MonitorDepGraphRequestDepGraphPkgManager name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MonitorDepGraphRequestDepGraphPkgManager repositories(List<Object> repositories) {
    this.repositories = repositories;
    return this;
  }

  public MonitorDepGraphRequestDepGraphPkgManager addRepositoriesItem(Object repositoriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorDepGraphRequestDepGraphPkgManager monitorDepGraphRequestDepGraphPkgManager = (MonitorDepGraphRequestDepGraphPkgManager) o;
    return Objects.equals(this.name, monitorDepGraphRequestDepGraphPkgManager.name) &&
        Objects.equals(this.repositories, monitorDepGraphRequestDepGraphPkgManager.repositories);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorDepGraphRequestDepGraphPkgManager {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorDepGraphRequestDepGraphPkgManager
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorDepGraphRequestDepGraphPkgManager.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorDepGraphRequestDepGraphPkgManager is not found in the empty JSON string", MonitorDepGraphRequestDepGraphPkgManager.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorDepGraphRequestDepGraphPkgManager.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorDepGraphRequestDepGraphPkgManager` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorDepGraphRequestDepGraphPkgManager.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorDepGraphRequestDepGraphPkgManager.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorDepGraphRequestDepGraphPkgManager' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorDepGraphRequestDepGraphPkgManager> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorDepGraphRequestDepGraphPkgManager.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorDepGraphRequestDepGraphPkgManager>() {
           @Override
           public void write(JsonWriter out, MonitorDepGraphRequestDepGraphPkgManager value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorDepGraphRequestDepGraphPkgManager read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorDepGraphRequestDepGraphPkgManager given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorDepGraphRequestDepGraphPkgManager
   * @throws IOException if the JSON string is invalid with respect to MonitorDepGraphRequestDepGraphPkgManager
   */
  public static MonitorDepGraphRequestDepGraphPkgManager fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorDepGraphRequestDepGraphPkgManager.class);
  }

  /**
   * Convert an instance of MonitorDepGraphRequestDepGraphPkgManager to an JSON string
   *
   * @return JSON string
   */
