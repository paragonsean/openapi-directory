...
public class AllIgnores {
  ...
  public AllIgnores issueId(List<Object> issueId) {
    this.issueId = issueId;
    return this;
  }

  public AllIgnores addIssueIdItem(Object issueIdItem) {
  ...
  public boolean equals(Object o) {
    ...
    AllIgnores allIgnores = (AllIgnores) o;
    return Objects.equals(this.issueId, allIgnores.issueId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllIgnores
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllIgnores.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllIgnores is not found in the empty JSON string", AllIgnores.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllIgnores.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllIgnores` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllIgnores.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllIgnores.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllIgnores' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllIgnores> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllIgnores.class));

       return (TypeAdapter<T>) new TypeAdapter<AllIgnores>() {
           @Override
           public void write(JsonWriter out, AllIgnores value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllIgnores read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllIgnores given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllIgnores
   * @throws IOException if the JSON string is invalid with respect to AllIgnores
   */
  public static AllIgnores fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllIgnores.class);
  }

  /**
   * Convert an instance of AllIgnores to an JSON string
   *
   * @return JSON string
   */
