...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOf;
import org.openapitools.client.model.AddNewIntegrationRequestAnyOf1;
...
public class AddNewIntegrationRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AddNewIntegrationRequest.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AddNewIntegrationRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AddNewIntegrationRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AddNewIntegrationRequestAnyOf> adapterAddNewIntegrationRequestAnyOf = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOf.class));
            final TypeAdapter<AddNewIntegrationRequestAnyOf1> adapterAddNewIntegrationRequestAnyOf1 = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOf1.class));

            return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequest>() {
                @Override
                public void write(JsonWriter out, AddNewIntegrationRequest value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `AddNewIntegrationRequestAnyOf`
                    if (value.getActualInstance() instanceof AddNewIntegrationRequestAnyOf) {
                        JsonElement element = adapterAddNewIntegrationRequestAnyOf.toJsonTree((AddNewIntegrationRequestAnyOf)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `AddNewIntegrationRequestAnyOf1`
                    if (value.getActualInstance() instanceof AddNewIntegrationRequestAnyOf1) {
                        JsonElement element = adapterAddNewIntegrationRequestAnyOf1.toJsonTree((AddNewIntegrationRequestAnyOf1)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: AddNewIntegrationRequestAnyOf, AddNewIntegrationRequestAnyOf1");
                }

                @Override
                public AddNewIntegrationRequest read(JsonReader in) throws IOException {
                    ...
                    // deserialize AddNewIntegrationRequestAnyOf
                    try {
                        // validate the JSON object to see if any exception is thrown
                        AddNewIntegrationRequestAnyOf.validateJsonElement(jsonElement);
                        actualAdapter = adapterAddNewIntegrationRequestAnyOf;
                        AddNewIntegrationRequest ret = new AddNewIntegrationRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AddNewIntegrationRequestAnyOf failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AddNewIntegrationRequestAnyOf'", e);
                    }
                    // deserialize AddNewIntegrationRequestAnyOf1
                    try {
                        // validate the JSON object to see if any exception is thrown
                        AddNewIntegrationRequestAnyOf1.validateJsonElement(jsonElement);
                        actualAdapter = adapterAddNewIntegrationRequestAnyOf1;
                        AddNewIntegrationRequest ret = new AddNewIntegrationRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AddNewIntegrationRequestAnyOf1 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AddNewIntegrationRequestAnyOf1'", e);
                    }

                    throw new IOException(String.format("Failed deserialization for AddNewIntegrationRequest: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AddNewIntegrationRequest() {
        super("anyOf", Boolean.FALSE);
    }

    public AddNewIntegrationRequest(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("AddNewIntegrationRequestAnyOf", AddNewIntegrationRequestAnyOf.class);
        schemas.put("AddNewIntegrationRequestAnyOf1", AddNewIntegrationRequestAnyOf1.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return AddNewIntegrationRequest.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * AddNewIntegrationRequestAnyOf, AddNewIntegrationRequestAnyOf1
     *
     * It could be an instance of the 'anyOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof AddNewIntegrationRequestAnyOf) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof AddNewIntegrationRequestAnyOf1) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be AddNewIntegrationRequestAnyOf, AddNewIntegrationRequestAnyOf1");
    }
     ...
     * AddNewIntegrationRequestAnyOf, AddNewIntegrationRequestAnyOf1
     *
     * @return The actual instance (AddNewIntegrationRequestAnyOf, AddNewIntegrationRequestAnyOf1)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `AddNewIntegrationRequestAnyOf`. If the actual instance is not `AddNewIntegrationRequestAnyOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AddNewIntegrationRequestAnyOf`
     * @throws ClassCastException if the instance is not `AddNewIntegrationRequestAnyOf`
     */
    public AddNewIntegrationRequestAnyOf getAddNewIntegrationRequestAnyOf() throws ClassCastException {
        return (AddNewIntegrationRequestAnyOf)super.getActualInstance();
    }
    /**
     * Get the actual instance of `AddNewIntegrationRequestAnyOf1`. If the actual instance is not `AddNewIntegrationRequestAnyOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AddNewIntegrationRequestAnyOf1`
     * @throws ClassCastException if the instance is not `AddNewIntegrationRequestAnyOf1`
     */
    public AddNewIntegrationRequestAnyOf1 getAddNewIntegrationRequestAnyOf1() throws ClassCastException {
        return (AddNewIntegrationRequestAnyOf1)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate anyOf schemas one by one
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with AddNewIntegrationRequestAnyOf
        try {
            AddNewIntegrationRequestAnyOf.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with AddNewIntegrationRequestAnyOf1
        try {
            AddNewIntegrationRequestAnyOf1.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        throw new IOException(String.format("The JSON string is invalid for AddNewIntegrationRequest with anyOf schemas: AddNewIntegrationRequestAnyOf, AddNewIntegrationRequestAnyOf1. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of AddNewIntegrationRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AddNewIntegrationRequest
     * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequest
     */
    public static AddNewIntegrationRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequest.class);
    }

    /**
     * Convert an instance of AddNewIntegrationRequest to an JSON string
     *
     * @return JSON string
     */
