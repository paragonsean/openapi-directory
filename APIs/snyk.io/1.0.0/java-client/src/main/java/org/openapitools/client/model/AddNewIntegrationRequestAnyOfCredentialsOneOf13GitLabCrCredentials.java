...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials password(String password) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials registryBase(String registryBase) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials addNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials = (AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials) o;
    return Objects.equals(this.password, addNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.password) &&
        Objects.equals(this.registryBase, addNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.registryBase) &&
        Objects.equals(this.username, addNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf13GitLabCrCredentials to an JSON string
   *
   * @return JSON string
   */
