...
public class CreateJiraIssue200Response {
  ...
  public CreateJiraIssue200Response() {
  }

  public CreateJiraIssue200Response jiraIssue(CreateJiraIssue200ResponseJiraIssue jiraIssue) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJiraIssue200Response createJiraIssue200Response = (CreateJiraIssue200Response) o;
    return Objects.equals(this.jiraIssue, createJiraIssue200Response.jiraIssue);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJiraIssue200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJiraIssue200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJiraIssue200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJiraIssue200Response is not found in the empty JSON string", CreateJiraIssue200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJiraIssue200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJiraIssue200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJiraIssue200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJiraIssue200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJiraIssue200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJiraIssue200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJiraIssue200Response>() {
           @Override
           public void write(JsonWriter out, CreateJiraIssue200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJiraIssue200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJiraIssue200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJiraIssue200Response
   * @throws IOException if the JSON string is invalid with respect to CreateJiraIssue200Response
   */
  public static CreateJiraIssue200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJiraIssue200Response.class);
  }

  /**
   * Convert an instance of CreateJiraIssue200Response to an JSON string
   *
   * @return JSON string
   */
