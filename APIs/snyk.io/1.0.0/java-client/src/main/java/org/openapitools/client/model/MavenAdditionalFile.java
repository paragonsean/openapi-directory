...
public class MavenAdditionalFile {
  ...
  public MavenAdditionalFile() {
  }

  public MavenAdditionalFile contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    MavenAdditionalFile mavenAdditionalFile = (MavenAdditionalFile) o;
    return Objects.equals(this.contents, mavenAdditionalFile.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class MavenAdditionalFile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MavenAdditionalFile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MavenAdditionalFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MavenAdditionalFile is not found in the empty JSON string", MavenAdditionalFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MavenAdditionalFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MavenAdditionalFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MavenAdditionalFile.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MavenAdditionalFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MavenAdditionalFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MavenAdditionalFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MavenAdditionalFile.class));

       return (TypeAdapter<T>) new TypeAdapter<MavenAdditionalFile>() {
           @Override
           public void write(JsonWriter out, MavenAdditionalFile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MavenAdditionalFile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MavenAdditionalFile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MavenAdditionalFile
   * @throws IOException if the JSON string is invalid with respect to MavenAdditionalFile
   */
  public static MavenAdditionalFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MavenAdditionalFile.class);
  }

  /**
   * Convert an instance of MavenAdditionalFile to an JSON string
   *
   * @return JSON string
   */
