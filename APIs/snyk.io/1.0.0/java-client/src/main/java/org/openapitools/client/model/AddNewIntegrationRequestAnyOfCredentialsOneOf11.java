...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf11 {
  public static final String SERIALIZED_NAME_GIT_HUB_ENTERPRISE_CREDENTIALS = "GitHubEnterpriseCredentials";
  @SerializedName(SERIALIZED_NAME_GIT_HUB_ENTERPRISE_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials gitHubEnterpriseCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf11() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf11 gitHubEnterpriseCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials gitHubEnterpriseCredentials) {
    this.gitHubEnterpriseCredentials = gitHubEnterpriseCredentials;
    return this;
  }

  /**
   * Get gitHubEnterpriseCredentials
   * @return gitHubEnterpriseCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials getGitHubEnterpriseCredentials() {
    return gitHubEnterpriseCredentials;
  }

  public void setGitHubEnterpriseCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials gitHubEnterpriseCredentials) {
    this.gitHubEnterpriseCredentials = gitHubEnterpriseCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf11 addNewIntegrationRequestAnyOfCredentialsOneOf11 = (AddNewIntegrationRequestAnyOfCredentialsOneOf11) o;
    return Objects.equals(this.gitHubEnterpriseCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf11.gitHubEnterpriseCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gitHubEnterpriseCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf11 {\n");
    sb.append("    gitHubEnterpriseCredentials: ").append(toIndentedString(gitHubEnterpriseCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("GitHubEnterpriseCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf11 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf11.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GitHubEnterpriseCredentials`
      if (jsonObj.get("GitHubEnterpriseCredentials") != null && !jsonObj.get("GitHubEnterpriseCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.validateJsonElement(jsonObj.get("GitHubEnterpriseCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf11.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf11>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf11 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf11 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf11 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf11
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf11
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf11.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf11 to an JSON string
   *
   * @return JSON string
   */
