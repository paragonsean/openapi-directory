...
public class GetListOfIssues200ResponseResultsInnerIssueSemver {
  ...
  public GetListOfIssues200ResponseResultsInnerIssueSemver() {
  }

  public GetListOfIssues200ResponseResultsInnerIssueSemver unaffected(String unaffected) {
  ...
  public GetListOfIssues200ResponseResultsInnerIssueSemver vulnerable(List<Object> vulnerable) {
    this.vulnerable = vulnerable;
    return this;
  }

  public GetListOfIssues200ResponseResultsInnerIssueSemver addVulnerableItem(Object vulnerableItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetListOfIssues200ResponseResultsInnerIssueSemver getListOfIssues200ResponseResultsInnerIssueSemver = (GetListOfIssues200ResponseResultsInnerIssueSemver) o;
    return Objects.equals(this.unaffected, getListOfIssues200ResponseResultsInnerIssueSemver.unaffected) &&
        Objects.equals(this.vulnerable, getListOfIssues200ResponseResultsInnerIssueSemver.vulnerable);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetListOfIssues200ResponseResultsInnerIssueSemver {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetListOfIssues200ResponseResultsInnerIssueSemver
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetListOfIssues200ResponseResultsInnerIssueSemver.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListOfIssues200ResponseResultsInnerIssueSemver is not found in the empty JSON string", GetListOfIssues200ResponseResultsInnerIssueSemver.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetListOfIssues200ResponseResultsInnerIssueSemver.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetListOfIssues200ResponseResultsInnerIssueSemver` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListOfIssues200ResponseResultsInnerIssueSemver.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListOfIssues200ResponseResultsInnerIssueSemver' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListOfIssues200ResponseResultsInnerIssueSemver> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssues200ResponseResultsInnerIssueSemver.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListOfIssues200ResponseResultsInnerIssueSemver>() {
           @Override
           public void write(JsonWriter out, GetListOfIssues200ResponseResultsInnerIssueSemver value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetListOfIssues200ResponseResultsInnerIssueSemver read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetListOfIssues200ResponseResultsInnerIssueSemver given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetListOfIssues200ResponseResultsInnerIssueSemver
   * @throws IOException if the JSON string is invalid with respect to GetListOfIssues200ResponseResultsInnerIssueSemver
   */
  public static GetListOfIssues200ResponseResultsInnerIssueSemver fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListOfIssues200ResponseResultsInnerIssueSemver.class);
  }

  /**
   * Convert an instance of GetListOfIssues200ResponseResultsInnerIssueSemver to an JSON string
   *
   * @return JSON string
   */
