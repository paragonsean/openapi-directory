...
public class NewIssuesNotificationSettingRequest {
  ...
  public NewIssuesNotificationSettingRequest() {
  }

  public NewIssuesNotificationSettingRequest enabled(Boolean enabled) {
  ...
  public NewIssuesNotificationSettingRequest issueSeverity(IssueSeverityEnum issueSeverity) {
  ...
  public NewIssuesNotificationSettingRequest issueType(IssueTypeEnum issueType) {
  ...
  public boolean equals(Object o) {
    ...
    NewIssuesNotificationSettingRequest newIssuesNotificationSettingRequest = (NewIssuesNotificationSettingRequest) o;
    return Objects.equals(this.enabled, newIssuesNotificationSettingRequest.enabled) &&
        Objects.equals(this.issueSeverity, newIssuesNotificationSettingRequest.issueSeverity) &&
        Objects.equals(this.issueType, newIssuesNotificationSettingRequest.issueType);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewIssuesNotificationSettingRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewIssuesNotificationSettingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewIssuesNotificationSettingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewIssuesNotificationSettingRequest is not found in the empty JSON string", NewIssuesNotificationSettingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewIssuesNotificationSettingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewIssuesNotificationSettingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewIssuesNotificationSettingRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewIssuesNotificationSettingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewIssuesNotificationSettingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewIssuesNotificationSettingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewIssuesNotificationSettingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NewIssuesNotificationSettingRequest>() {
           @Override
           public void write(JsonWriter out, NewIssuesNotificationSettingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewIssuesNotificationSettingRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewIssuesNotificationSettingRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewIssuesNotificationSettingRequest
   * @throws IOException if the JSON string is invalid with respect to NewIssuesNotificationSettingRequest
   */
  public static NewIssuesNotificationSettingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewIssuesNotificationSettingRequest.class);
  }

  /**
   * Convert an instance of NewIssuesNotificationSettingRequest to an JSON string
   *
   * @return JSON string
   */
