...
public class Patch {
  ...
  public Patch comments(List<Object> comments) {
    this.comments = comments;
    return this;
  }

  public Patch addCommentsItem(Object commentsItem) {
  ...
  public Patch modificationTime(String modificationTime) {
  ...
  public Patch urls(List<Object> urls) {
    this.urls = urls;
    return this;
  }

  public Patch addUrlsItem(Object urlsItem) {
    if (this.urls == null) {
  ...
  public boolean equals(Object o) {
    ...
    Patch patch = (Patch) o;
    return Objects.equals(this.comments, patch.comments) &&
        Objects.equals(this.id, patch.id) &&
        Objects.equals(this.modificationTime, patch.modificationTime) &&
        Objects.equals(this.urls, patch.urls) &&
        Objects.equals(this.version, patch.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comments, id, modificationTime, urls, version);
  }
