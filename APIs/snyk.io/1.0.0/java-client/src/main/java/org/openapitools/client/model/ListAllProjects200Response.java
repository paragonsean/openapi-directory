...
import org.openapitools.client.model.ListAllProjects200ResponseProjectsInner;
...
public class ListAllProjects200Response {
  ...
  private List<ListAllProjects200ResponseProjectsInner> projects = new ArrayList<>();

  public ListAllProjects200Response() {
  }

  public ListAllProjects200Response org(ListAllProjects200ResponseOrg org) {
    this.org = org;
    return this;
  }
  ...
  public ListAllProjects200Response projects(List<ListAllProjects200ResponseProjectsInner> projects) {
    this.projects = projects;
    return this;
  }

  public ListAllProjects200Response addProjectsItem(ListAllProjects200ResponseProjectsInner projectsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ListAllProjects200ResponseProjectsInner> getProjects() {
    return projects;
  }

  public void setProjects(List<ListAllProjects200ResponseProjectsInner> projects) {
    this.projects = projects;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjects200Response listAllProjects200Response = (ListAllProjects200Response) o;
    return Objects.equals(this.org, listAllProjects200Response.org) &&
        Objects.equals(this.projects, listAllProjects200Response.projects);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjects200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjects200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjects200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjects200Response is not found in the empty JSON string", ListAllProjects200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjects200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjects200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("projects") != null && !jsonObj.get("projects").isJsonNull()) {
        ...
        if (jsonArrayprojects != null) {
          ...
          for (int i = 0; i < jsonArrayprojects.size(); i++) {
            ListAllProjects200ResponseProjectsInner.validateJsonElement(jsonArrayprojects.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjects200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjects200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjects200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjects200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjects200Response>() {
           @Override
           public void write(JsonWriter out, ListAllProjects200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjects200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjects200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjects200Response
   * @throws IOException if the JSON string is invalid with respect to ListAllProjects200Response
   */
  public static ListAllProjects200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjects200Response.class);
  }

  /**
   * Convert an instance of ListAllProjects200Response to an JSON string
   *
   * @return JSON string
   */
