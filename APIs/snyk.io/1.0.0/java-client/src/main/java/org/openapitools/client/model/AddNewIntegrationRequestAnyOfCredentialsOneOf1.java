...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf1 {
  public static final String SERIALIZED_NAME_ARTIFACTORY_CR_CREDENTIALS = "ArtifactoryCrCredentials";
  @SerializedName(SERIALIZED_NAME_ARTIFACTORY_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf1ArtifactoryCrCredentials artifactoryCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf1() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf1 artifactoryCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf1ArtifactoryCrCredentials artifactoryCrCredentials) {
    this.artifactoryCrCredentials = artifactoryCrCredentials;
    return this;
  }

  /**
   * Get artifactoryCrCredentials
   * @return artifactoryCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf1ArtifactoryCrCredentials getArtifactoryCrCredentials() {
    return artifactoryCrCredentials;
  }

  public void setArtifactoryCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf1ArtifactoryCrCredentials artifactoryCrCredentials) {
    this.artifactoryCrCredentials = artifactoryCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf1 addNewIntegrationRequestAnyOfCredentialsOneOf1 = (AddNewIntegrationRequestAnyOfCredentialsOneOf1) o;
    return Objects.equals(this.artifactoryCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf1.artifactoryCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(artifactoryCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf1 {\n");
    sb.append("    artifactoryCrCredentials: ").append(toIndentedString(artifactoryCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ArtifactoryCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf1 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ArtifactoryCrCredentials`
      if (jsonObj.get("ArtifactoryCrCredentials") != null && !jsonObj.get("ArtifactoryCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf1ArtifactoryCrCredentials.validateJsonElement(jsonObj.get("ArtifactoryCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf1>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf1
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf1
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf1.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf1 to an JSON string
   *
   * @return JSON string
   */
