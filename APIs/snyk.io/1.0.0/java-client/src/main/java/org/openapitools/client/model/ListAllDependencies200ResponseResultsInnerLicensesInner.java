...
public class ListAllDependencies200ResponseResultsInnerLicensesInner {
  ...
  public ListAllDependencies200ResponseResultsInnerLicensesInner() {
  }

  public ListAllDependencies200ResponseResultsInnerLicensesInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllDependencies200ResponseResultsInnerLicensesInner license(String license) {
  ...
  public ListAllDependencies200ResponseResultsInnerLicensesInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllDependencies200ResponseResultsInnerLicensesInner listAllDependencies200ResponseResultsInnerLicensesInner = (ListAllDependencies200ResponseResultsInnerLicensesInner) o;
    return Objects.equals(this.id, listAllDependencies200ResponseResultsInnerLicensesInner.id) &&
        Objects.equals(this.license, listAllDependencies200ResponseResultsInnerLicensesInner.license) &&
        Objects.equals(this.title, listAllDependencies200ResponseResultsInnerLicensesInner.title);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, license, title);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllDependencies200ResponseResultsInnerLicensesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllDependencies200ResponseResultsInnerLicensesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllDependencies200ResponseResultsInnerLicensesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllDependencies200ResponseResultsInnerLicensesInner is not found in the empty JSON string", ListAllDependencies200ResponseResultsInnerLicensesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllDependencies200ResponseResultsInnerLicensesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllDependencies200ResponseResultsInnerLicensesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllDependencies200ResponseResultsInnerLicensesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllDependencies200ResponseResultsInnerLicensesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllDependencies200ResponseResultsInnerLicensesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllDependencies200ResponseResultsInnerLicensesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllDependencies200ResponseResultsInnerLicensesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllDependencies200ResponseResultsInnerLicensesInner>() {
           @Override
           public void write(JsonWriter out, ListAllDependencies200ResponseResultsInnerLicensesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllDependencies200ResponseResultsInnerLicensesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllDependencies200ResponseResultsInnerLicensesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllDependencies200ResponseResultsInnerLicensesInner
   * @throws IOException if the JSON string is invalid with respect to ListAllDependencies200ResponseResultsInnerLicensesInner
   */
  public static ListAllDependencies200ResponseResultsInnerLicensesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllDependencies200ResponseResultsInnerLicensesInner.class);
  }

  /**
   * Convert an instance of ListAllDependencies200ResponseResultsInnerLicensesInner to an JSON string
   *
   * @return JSON string
   */
