...
public class ListAllDependenciesRequestFilters {
  public static final String SERIALIZED_NAME_DEP_STATUS = "depStatus";
  @SerializedName(SERIALIZED_NAME_DEP_STATUS)
  ...
  private List<Object> severity = new ArrayList<>();

  public ListAllDependenciesRequestFilters() {
  }

  public ListAllDependenciesRequestFilters depStatus(String depStatus) {
  ...
  public ListAllDependenciesRequestFilters dependencies(Object dependencies) {
  ...
  public ListAllDependenciesRequestFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public ListAllDependenciesRequestFilters addLanguagesItem(Object languagesItem) {
  ...
  public ListAllDependenciesRequestFilters licenses(Object licenses) {
  ...
  public ListAllDependenciesRequestFilters projects(Object projects) {
  ...
  public ListAllDependenciesRequestFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public ListAllDependenciesRequestFilters addSeverityItem(Object severityItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getSeverity() {
    return severity;
  }

  public void setSeverity(List<Object> severity) {
    this.severity = severity;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllDependenciesRequestFilters listAllDependenciesRequestFilters = (ListAllDependenciesRequestFilters) o;
    return Objects.equals(this.depStatus, listAllDependenciesRequestFilters.depStatus) &&
        Objects.equals(this.dependencies, listAllDependenciesRequestFilters.dependencies) &&
        Objects.equals(this.languages, listAllDependenciesRequestFilters.languages) &&
        Objects.equals(this.licenses, listAllDependenciesRequestFilters.licenses) &&
        Objects.equals(this.projects, listAllDependenciesRequestFilters.projects) &&
        Objects.equals(this.severity, listAllDependenciesRequestFilters.severity);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(depStatus, dependencies, languages, licenses, projects, severity);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllDependenciesRequestFilters {\n");
    sb.append("    depStatus: ").append(toIndentedString(depStatus)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllDependenciesRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllDependenciesRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllDependenciesRequestFilters is not found in the empty JSON string", ListAllDependenciesRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllDependenciesRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllDependenciesRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("depStatus") != null && !jsonObj.get("depStatus").isJsonNull()) && !jsonObj.get("depStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `depStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("depStatus").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllDependenciesRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllDependenciesRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllDependenciesRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllDependenciesRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllDependenciesRequestFilters>() {
           @Override
           public void write(JsonWriter out, ListAllDependenciesRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllDependenciesRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllDependenciesRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllDependenciesRequestFilters
   * @throws IOException if the JSON string is invalid with respect to ListAllDependenciesRequestFilters
   */
  public static ListAllDependenciesRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllDependenciesRequestFilters.class);
  }

  /**
   * Convert an instance of ListAllDependenciesRequestFilters to an JSON string
   *
   * @return JSON string
   */
