...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials token(String token) {
    this.token = token;
    return this;
  }
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials addNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials = (AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials) o;
    return Objects.equals(this.token, addNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.token) &&
        Objects.equals(this.url, addNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf11GitHubEnterpriseCredentials to an JSON string
   *
   * @return JSON string
   */
