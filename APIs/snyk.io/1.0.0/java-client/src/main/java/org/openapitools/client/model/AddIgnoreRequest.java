...
public class AddIgnoreRequest {
  ...
  public AddIgnoreRequest() {
  }

  public AddIgnoreRequest disregardIfFixable(Boolean disregardIfFixable) {
  ...
  public AddIgnoreRequest expires(String expires) {
  ...
  public AddIgnoreRequest ignorePath(String ignorePath) {
  ...
  public AddIgnoreRequest reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public AddIgnoreRequest reasonType(ReasonTypeEnum reasonType) {
  ...
  public boolean equals(Object o) {
    ...
    AddIgnoreRequest addIgnoreRequest = (AddIgnoreRequest) o;
    return Objects.equals(this.disregardIfFixable, addIgnoreRequest.disregardIfFixable) &&
        Objects.equals(this.expires, addIgnoreRequest.expires) &&
        Objects.equals(this.ignorePath, addIgnoreRequest.ignorePath) &&
        Objects.equals(this.reason, addIgnoreRequest.reason) &&
        Objects.equals(this.reasonType, addIgnoreRequest.reasonType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddIgnoreRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddIgnoreRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddIgnoreRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddIgnoreRequest is not found in the empty JSON string", AddIgnoreRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddIgnoreRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddIgnoreRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddIgnoreRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddIgnoreRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddIgnoreRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddIgnoreRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddIgnoreRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddIgnoreRequest>() {
           @Override
           public void write(JsonWriter out, AddIgnoreRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddIgnoreRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddIgnoreRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddIgnoreRequest
   * @throws IOException if the JSON string is invalid with respect to AddIgnoreRequest
   */
  public static AddIgnoreRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddIgnoreRequest.class);
  }

  /**
   * Convert an instance of AddIgnoreRequest to an JSON string
   *
   * @return JSON string
   */
