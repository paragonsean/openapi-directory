...
public class DeleteTagFromGroupRequest {
  ...
  public DeleteTagFromGroupRequest() {
  }

  public DeleteTagFromGroupRequest force(Boolean force) {
    this.force = force;
    return this;
  }
  ...
  public DeleteTagFromGroupRequest key(String key) {
    this.key = key;
    return this;
  }
  ...
  public DeleteTagFromGroupRequest value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteTagFromGroupRequest deleteTagFromGroupRequest = (DeleteTagFromGroupRequest) o;
    return Objects.equals(this.force, deleteTagFromGroupRequest.force) &&
        Objects.equals(this.key, deleteTagFromGroupRequest.key) &&
        Objects.equals(this.value, deleteTagFromGroupRequest.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(force, key, value);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteTagFromGroupRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTagFromGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTagFromGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTagFromGroupRequest is not found in the empty JSON string", DeleteTagFromGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTagFromGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTagFromGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTagFromGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTagFromGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTagFromGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTagFromGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTagFromGroupRequest>() {
           @Override
           public void write(JsonWriter out, DeleteTagFromGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTagFromGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTagFromGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTagFromGroupRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteTagFromGroupRequest
   */
  public static DeleteTagFromGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTagFromGroupRequest.class);
  }

  /**
   * Convert an instance of DeleteTagFromGroupRequest to an JSON string
   *
   * @return JSON string
   */
