...
import org.openapitools.client.model.DepGraphData;
...
public class GraphRequestPayload {
  ...
  private DepGraphData depGraph;

  public GraphRequestPayload() {
  }

  public GraphRequestPayload depGraph(DepGraphData depGraph) {
  ...
  public DepGraphData getDepGraph() {
    return depGraph;
  }

  public void setDepGraph(DepGraphData depGraph) {
    this.depGraph = depGraph;
  }
  ...
  public boolean equals(Object o) {
    ...
    GraphRequestPayload graphRequestPayload = (GraphRequestPayload) o;
    return Objects.equals(this.depGraph, graphRequestPayload.depGraph);
  }
  ...
  public String toString() {
    ...
    sb.append("class GraphRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GraphRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GraphRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GraphRequestPayload is not found in the empty JSON string", GraphRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GraphRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GraphRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GraphRequestPayload.openapiRequiredFields) {
      ...
      DepGraphData.validateJsonElement(jsonObj.get("depGraph"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GraphRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GraphRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GraphRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GraphRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<GraphRequestPayload>() {
           @Override
           public void write(JsonWriter out, GraphRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GraphRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GraphRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GraphRequestPayload
   * @throws IOException if the JSON string is invalid with respect to GraphRequestPayload
   */
  public static GraphRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GraphRequestPayload.class);
  }

  /**
   * Convert an instance of GraphRequestPayload to an JSON string
   *
   * @return JSON string
   */
