...
import org.openapitools.client.model.MonitorDepGraphData;
import org.openapitools.client.model.MonitorMetaData;
...
public class MonitorGraphPayload {
  public static final String SERIALIZED_NAME_DEP_GRAPH = "depGraph";
  @SerializedName(SERIALIZED_NAME_DEP_GRAPH)
  private MonitorDepGraphData depGraph;

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private MonitorMetaData meta;

  public MonitorGraphPayload() {
  }

  public MonitorGraphPayload depGraph(MonitorDepGraphData depGraph) {
  ...
  public MonitorDepGraphData getDepGraph() {
    return depGraph;
  }

  public void setDepGraph(MonitorDepGraphData depGraph) {
    this.depGraph = depGraph;
  }


  public MonitorGraphPayload meta(MonitorMetaData meta) {
    this.meta = meta;
    return this;
  }
  ...
  public MonitorMetaData getMeta() {
    return meta;
  }

  public void setMeta(MonitorMetaData meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitorGraphPayload monitorGraphPayload = (MonitorGraphPayload) o;
    return Objects.equals(this.depGraph, monitorGraphPayload.depGraph) &&
        Objects.equals(this.meta, monitorGraphPayload.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(depGraph, meta);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MonitorGraphPayload {\n");
    sb.append("    depGraph: ").append(toIndentedString(depGraph)).append("\n");
  ...
  static {
    ...
    openapiFields.add("depGraph");
    openapiFields.add("meta");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("depGraph");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorGraphPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorGraphPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorGraphPayload is not found in the empty JSON string", MonitorGraphPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorGraphPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorGraphPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorGraphPayload.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `depGraph`
      MonitorDepGraphData.validateJsonElement(jsonObj.get("depGraph"));
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        MonitorMetaData.validateJsonElement(jsonObj.get("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorGraphPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorGraphPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorGraphPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorGraphPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorGraphPayload>() {
           @Override
           public void write(JsonWriter out, MonitorGraphPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorGraphPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorGraphPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorGraphPayload
   * @throws IOException if the JSON string is invalid with respect to MonitorGraphPayload
   */
  public static MonitorGraphPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorGraphPayload.class);
  }

  /**
   * Convert an instance of MonitorGraphPayload to an JSON string
   *
   * @return JSON string
   */
