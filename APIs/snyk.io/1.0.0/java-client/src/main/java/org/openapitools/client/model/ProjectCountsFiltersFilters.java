...
public class ProjectCountsFiltersFilters {
  ...
  public ProjectCountsFiltersFilters() {
  }

  public ProjectCountsFiltersFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public ProjectCountsFiltersFilters addLanguagesItem(Object languagesItem) {
  ...
  public ProjectCountsFiltersFilters orgs(List<Object> orgs) {
    this.orgs = orgs;
    return this;
  }

  public ProjectCountsFiltersFilters addOrgsItem(Object orgsItem) {
    if (this.orgs == null) {
  ...
  public ProjectCountsFiltersFilters projects(List<Object> projects) {
    this.projects = projects;
    return this;
  }

  public ProjectCountsFiltersFilters addProjectsItem(Object projectsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectCountsFiltersFilters projectCountsFiltersFilters = (ProjectCountsFiltersFilters) o;
    return Objects.equals(this.languages, projectCountsFiltersFilters.languages) &&
        Objects.equals(this.orgs, projectCountsFiltersFilters.orgs) &&
        Objects.equals(this.projects, projectCountsFiltersFilters.projects);
  }

  @Override
  public int hashCode() {
    return Objects.hash(languages, orgs, projects);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectCountsFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectCountsFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCountsFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectCountsFiltersFilters is not found in the empty JSON string", ProjectCountsFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectCountsFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectCountsFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProjectCountsFiltersFilters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectCountsFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectCountsFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectCountsFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectCountsFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectCountsFiltersFilters>() {
           @Override
           public void write(JsonWriter out, ProjectCountsFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectCountsFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectCountsFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectCountsFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to ProjectCountsFiltersFilters
   */
  public static ProjectCountsFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectCountsFiltersFilters.class);
  }

  /**
   * Convert an instance of ProjectCountsFiltersFilters to an JSON string
   *
   * @return JSON string
   */
