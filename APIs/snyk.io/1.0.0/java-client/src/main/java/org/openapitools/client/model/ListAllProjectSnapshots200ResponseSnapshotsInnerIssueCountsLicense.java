...
public class ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense() {
  }

  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense critical(BigDecimal critical) {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense high(BigDecimal high) {
    this.high = high;
    return this;
  }
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense low(BigDecimal low) {
    this.low = low;
    return this;
  }
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense medium(BigDecimal medium) {
    this.medium = medium;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense listAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense = (ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense) o;
    return Objects.equals(this.critical, listAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.critical) &&
        Objects.equals(this.high, listAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.high) &&
        Objects.equals(this.low, listAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.low) &&
        Objects.equals(this.medium, listAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.medium);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense is not found in the empty JSON string", ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense>() {
           @Override
           public void write(JsonWriter out, ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense
   */
  public static ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.class);
  }

  /**
   * Convert an instance of ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense to an JSON string
   *
   * @return JSON string
   */
