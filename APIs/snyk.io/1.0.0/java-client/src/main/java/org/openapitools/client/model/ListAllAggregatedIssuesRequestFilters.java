...
import org.openapitools.client.model.ListAllAggregatedIssuesRequestFiltersPriority;
...
public class ListAllAggregatedIssuesRequestFilters {
  ...
  private ListAllAggregatedIssuesRequestFiltersPriority priority;

  public static final String SERIALIZED_NAME_SEVERITIES = "severities";
  @SerializedName(SERIALIZED_NAME_SEVERITIES)
  private List<Object> severities = new ArrayList<>();

  public static final String SERIALIZED_NAME_TYPES = "types";
  @SerializedName(SERIALIZED_NAME_TYPES)
  private List<Object> types = new ArrayList<>();

  public ListAllAggregatedIssuesRequestFilters() {
  }

  public ListAllAggregatedIssuesRequestFilters exploitMaturity(List<Object> exploitMaturity) {
    this.exploitMaturity = exploitMaturity;
    return this;
  }

  public ListAllAggregatedIssuesRequestFilters addExploitMaturityItem(Object exploitMaturityItem) {
  ...
  public ListAllAggregatedIssuesRequestFilters ignored(Boolean ignored) {
  ...
  public ListAllAggregatedIssuesRequestFilters patched(Boolean patched) {
  ...
  public ListAllAggregatedIssuesRequestFilters priority(ListAllAggregatedIssuesRequestFiltersPriority priority) {
   ...
   */
  @javax.annotation.Nullable
  public ListAllAggregatedIssuesRequestFiltersPriority getPriority() {
    return priority;
  }

  public void setPriority(ListAllAggregatedIssuesRequestFiltersPriority priority) {
    this.priority = priority;
  }


  public ListAllAggregatedIssuesRequestFilters severities(List<Object> severities) {
    this.severities = severities;
    return this;
  }

  public ListAllAggregatedIssuesRequestFilters addSeveritiesItem(Object severitiesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getSeverities() {
    return severities;
  }

  public void setSeverities(List<Object> severities) {
    this.severities = severities;
  }


  public ListAllAggregatedIssuesRequestFilters types(List<Object> types) {
    this.types = types;
    return this;
  }

  public ListAllAggregatedIssuesRequestFilters addTypesItem(Object typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssuesRequestFilters listAllAggregatedIssuesRequestFilters = (ListAllAggregatedIssuesRequestFilters) o;
    return Objects.equals(this.exploitMaturity, listAllAggregatedIssuesRequestFilters.exploitMaturity) &&
        Objects.equals(this.ignored, listAllAggregatedIssuesRequestFilters.ignored) &&
        Objects.equals(this.patched, listAllAggregatedIssuesRequestFilters.patched) &&
        Objects.equals(this.priority, listAllAggregatedIssuesRequestFilters.priority) &&
        Objects.equals(this.severities, listAllAggregatedIssuesRequestFilters.severities) &&
        Objects.equals(this.types, listAllAggregatedIssuesRequestFilters.types);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exploitMaturity, ignored, patched, priority, severities, types);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllAggregatedIssuesRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssuesRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssuesRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssuesRequestFilters is not found in the empty JSON string", ListAllAggregatedIssuesRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssuesRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssuesRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("priority") != null && !jsonObj.get("priority").isJsonNull()) {
        ListAllAggregatedIssuesRequestFiltersPriority.validateJsonElement(jsonObj.get("priority"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssuesRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssuesRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssuesRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssuesRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssuesRequestFilters>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssuesRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssuesRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssuesRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssuesRequestFilters
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssuesRequestFilters
   */
  public static ListAllAggregatedIssuesRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssuesRequestFilters.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssuesRequestFilters to an JSON string
   *
   * @return JSON string
   */
