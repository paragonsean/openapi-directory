...
public class TestPackageJsonPackageLockJsonFileRequest {
  /**
  ...
  public TestPackageJsonPackageLockJsonFileRequest() {
  }

  public TestPackageJsonPackageLockJsonFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestPackageJsonPackageLockJsonFileRequest files(TestPackageJsonPackageLockJsonFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestPackageJsonPackageLockJsonFileRequest testPackageJsonPackageLockJsonFileRequest = (TestPackageJsonPackageLockJsonFileRequest) o;
    return Objects.equals(this.encoding, testPackageJsonPackageLockJsonFileRequest.encoding) &&
        Objects.equals(this.files, testPackageJsonPackageLockJsonFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestPackageJsonPackageLockJsonFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestPackageJsonPackageLockJsonFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestPackageJsonPackageLockJsonFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestPackageJsonPackageLockJsonFileRequest is not found in the empty JSON string", TestPackageJsonPackageLockJsonFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestPackageJsonPackageLockJsonFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestPackageJsonPackageLockJsonFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestPackageJsonPackageLockJsonFileRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestPackageJsonPackageLockJsonFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestPackageJsonPackageLockJsonFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestPackageJsonPackageLockJsonFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestPackageJsonPackageLockJsonFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestPackageJsonPackageLockJsonFileRequest>() {
           @Override
           public void write(JsonWriter out, TestPackageJsonPackageLockJsonFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestPackageJsonPackageLockJsonFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestPackageJsonPackageLockJsonFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestPackageJsonPackageLockJsonFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestPackageJsonPackageLockJsonFileRequest
   */
  public static TestPackageJsonPackageLockJsonFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestPackageJsonPackageLockJsonFileRequest.class);
  }

  /**
   * Convert an instance of TestPackageJsonPackageLockJsonFileRequest to an JSON string
   *
   * @return JSON string
   */
