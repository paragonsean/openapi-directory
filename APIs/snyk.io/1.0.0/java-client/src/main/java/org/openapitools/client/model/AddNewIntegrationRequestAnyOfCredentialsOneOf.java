...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOfAcrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf {
  public static final String SERIALIZED_NAME_ACR_CREDENTIALS = "AcrCredentials";
  @SerializedName(SERIALIZED_NAME_ACR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOfAcrCredentials acrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf acrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOfAcrCredentials acrCredentials) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOfAcrCredentials getAcrCredentials() {
    return acrCredentials;
  }

  public void setAcrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOfAcrCredentials acrCredentials) {
    this.acrCredentials = acrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf addNewIntegrationRequestAnyOfCredentialsOneOf = (AddNewIntegrationRequestAnyOfCredentialsOneOf) o;
    return Objects.equals(this.acrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf.acrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AcrCredentials`
      if (jsonObj.get("AcrCredentials") != null && !jsonObj.get("AcrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOfAcrCredentials.validateJsonElement(jsonObj.get("AcrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf to an JSON string
   *
   * @return JSON string
   */
