...
public class ImportTargetsRequestAnyOf4Target {
  public static final String SERIALIZED_NAME_APP_ID = "appId";
  @SerializedName(SERIALIZED_NAME_APP_ID)
  private String appId;

  public static final String SERIALIZED_NAME_SLUG_ID = "slugId";
  @SerializedName(SERIALIZED_NAME_SLUG_ID)
  private String slugId;

  public ImportTargetsRequestAnyOf4Target() {
  }

  public ImportTargetsRequestAnyOf4Target appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf4Target slugId(String slugId) {
    this.slugId = slugId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf4Target importTargetsRequestAnyOf4Target = (ImportTargetsRequestAnyOf4Target) o;
    return Objects.equals(this.appId, importTargetsRequestAnyOf4Target.appId) &&
        Objects.equals(this.slugId, importTargetsRequestAnyOf4Target.slugId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appId, slugId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportTargetsRequestAnyOf4Target {\n");
  ...
  static {
    ...
    openapiFields.add("slugId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("appId");
    openapiRequiredFields.add("slugId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf4Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf4Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf4Target is not found in the empty JSON string", ImportTargetsRequestAnyOf4Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf4Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf4Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf4Target.openapiRequiredFields) {
      ...
      if (!jsonObj.get("slugId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `slugId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("slugId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf4Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf4Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf4Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf4Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf4Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf4Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf4Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf4Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf4Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf4Target
   */
  public static ImportTargetsRequestAnyOf4Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf4Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf4Target to an JSON string
   *
   * @return JSON string
   */
