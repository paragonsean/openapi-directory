...
import org.openapitools.client.model.ListAllProjectsRequestFiltersTags;
...
public class ProjectsFiltersFilters {
  ...
  private ListAllProjectsRequestFiltersTags tags;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public ProjectsFiltersFilters() {
  }

  public ProjectsFiltersFilters attributes(ProjectAttributes attributes) {
  ...
  public ProjectsFiltersFilters isMonitored(Boolean isMonitored) {
  ...
  public ProjectsFiltersFilters name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectsFiltersFilters origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public ProjectsFiltersFilters tags(ListAllProjectsRequestFiltersTags tags) {
    this.tags = tags;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ListAllProjectsRequestFiltersTags getTags() {
    return tags;
  }

  public void setTags(ListAllProjectsRequestFiltersTags tags) {
    this.tags = tags;
  }


  public ProjectsFiltersFilters type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectsFiltersFilters projectsFiltersFilters = (ProjectsFiltersFilters) o;
    return Objects.equals(this.attributes, projectsFiltersFilters.attributes) &&
        Objects.equals(this.isMonitored, projectsFiltersFilters.isMonitored) &&
        Objects.equals(this.name, projectsFiltersFilters.name) &&
        Objects.equals(this.origin, projectsFiltersFilters.origin) &&
        Objects.equals(this.tags, projectsFiltersFilters.tags) &&
        Objects.equals(this.type, projectsFiltersFilters.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, isMonitored, name, origin, tags, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProjectsFiltersFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectsFiltersFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectsFiltersFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectsFiltersFilters is not found in the empty JSON string", ProjectsFiltersFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectsFiltersFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectsFiltersFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("tags") != null && !jsonObj.get("tags").isJsonNull()) {
        ListAllProjectsRequestFiltersTags.validateJsonElement(jsonObj.get("tags"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectsFiltersFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectsFiltersFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectsFiltersFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectsFiltersFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectsFiltersFilters>() {
           @Override
           public void write(JsonWriter out, ProjectsFiltersFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectsFiltersFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectsFiltersFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectsFiltersFilters
   * @throws IOException if the JSON string is invalid with respect to ProjectsFiltersFilters
   */
  public static ProjectsFiltersFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectsFiltersFilters.class);
  }

  /**
   * Convert an instance of ProjectsFiltersFilters to an JSON string
   *
   * @return JSON string
   */
