...
public class ListAllAggregatedIssues200ResponseIssuesInnerFixInfo {
  public static final String SERIALIZED_NAME_FIXED_IN = "fixedIn";
  @SerializedName(SERIALIZED_NAME_FIXED_IN)
  private List<Object> fixedIn = new ArrayList<>();

  public static final String SERIALIZED_NAME_IS_FIXABLE = "isFixable";
  @SerializedName(SERIALIZED_NAME_IS_FIXABLE)
  private Boolean isFixable;

  public static final String SERIALIZED_NAME_IS_PARTIALLY_FIXABLE = "isPartiallyFixable";
  @SerializedName(SERIALIZED_NAME_IS_PARTIALLY_FIXABLE)
  private Boolean isPartiallyFixable;
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo() {
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo fixedIn(List<Object> fixedIn) {
    this.fixedIn = fixedIn;
    return this;
  }

  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo addFixedInItem(Object fixedInItem) {
    if (this.fixedIn == null) {
      this.fixedIn = new ArrayList<>();
    }
    this.fixedIn.add(fixedInItem);
    return this;
  }
  ...
  public List<Object> getFixedIn() {
    return fixedIn;
  }

  public void setFixedIn(List<Object> fixedIn) {
    this.fixedIn = fixedIn;
  }


  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo isFixable(Boolean isFixable) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo isPartiallyFixable(Boolean isPartiallyFixable) {
    this.isPartiallyFixable = isPartiallyFixable;
    return this;
  }

  /**
   * Whether any of the issue&#39;s paths can be fixed. Paths that are already patched are not considered fixable unless they have an alternative remediation (e.g. pinning or upgrading).  An upgrade path where the only changes are in transitive dependencies is only considered fixable if the package manager supports it.
   * @return isPartiallyFixable
   */
  @javax.annotation.Nullable
  public Boolean getIsPartiallyFixable() {
    return isPartiallyFixable;
  }

  public void setIsPartiallyFixable(Boolean isPartiallyFixable) {
    this.isPartiallyFixable = isPartiallyFixable;
  }


  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo isPatchable(Boolean isPatchable) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo isPinnable(Boolean isPinnable) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo isUpgradable(Boolean isUpgradable) {
  ...
  public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo nearestFixedInVersion(String nearestFixedInVersion) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssues200ResponseIssuesInnerFixInfo listAllAggregatedIssues200ResponseIssuesInnerFixInfo = (ListAllAggregatedIssues200ResponseIssuesInnerFixInfo) o;
    return Objects.equals(this.fixedIn, listAllAggregatedIssues200ResponseIssuesInnerFixInfo.fixedIn) &&
        Objects.equals(this.isFixable, listAllAggregatedIssues200ResponseIssuesInnerFixInfo.isFixable) &&
        Objects.equals(this.isPartiallyFixable, listAllAggregatedIssues200ResponseIssuesInnerFixInfo.isPartiallyFixable) &&
        Objects.equals(this.isPatchable, listAllAggregatedIssues200ResponseIssuesInnerFixInfo.isPatchable) &&
        Objects.equals(this.isPinnable, listAllAggregatedIssues200ResponseIssuesInnerFixInfo.isPinnable) &&
        Objects.equals(this.isUpgradable, listAllAggregatedIssues200ResponseIssuesInnerFixInfo.isUpgradable) &&
        Objects.equals(this.nearestFixedInVersion, listAllAggregatedIssues200ResponseIssuesInnerFixInfo.nearestFixedInVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fixedIn, isFixable, isPartiallyFixable, isPatchable, isPinnable, isUpgradable, nearestFixedInVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllAggregatedIssues200ResponseIssuesInnerFixInfo {\n");
    sb.append("    fixedIn: ").append(toIndentedString(fixedIn)).append("\n");
    sb.append("    isFixable: ").append(toIndentedString(isFixable)).append("\n");
    sb.append("    isPartiallyFixable: ").append(toIndentedString(isPartiallyFixable)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fixedIn");
    openapiFields.add("isFixable");
    openapiFields.add("isPartiallyFixable");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerFixInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssues200ResponseIssuesInnerFixInfo is not found in the empty JSON string", ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssues200ResponseIssuesInnerFixInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("fixedIn") != null && !jsonObj.get("fixedIn").isJsonNull() && !jsonObj.get("fixedIn").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `fixedIn` to be an array in the JSON string but got `%s`", jsonObj.get("fixedIn").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssues200ResponseIssuesInnerFixInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerFixInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssues200ResponseIssuesInnerFixInfo>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssues200ResponseIssuesInnerFixInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssues200ResponseIssuesInnerFixInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssues200ResponseIssuesInnerFixInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssues200ResponseIssuesInnerFixInfo
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssues200ResponseIssuesInnerFixInfo
   */
  public static ListAllAggregatedIssues200ResponseIssuesInnerFixInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssues200ResponseIssuesInnerFixInfo to an JSON string
   *
   * @return JSON string
   */
