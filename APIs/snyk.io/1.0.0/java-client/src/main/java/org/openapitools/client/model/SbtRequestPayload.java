...
import org.openapitools.client.model.SbtRequestPayloadFiles;
...
public class SbtRequestPayload {
  /**
  ...
  private SbtRequestPayloadFiles files;

  public SbtRequestPayload() {
  }

  public SbtRequestPayload encoding(EncodingEnum encoding) {
  ...
  public SbtRequestPayload files(SbtRequestPayloadFiles files) {
    this.files = files;
    return this;
  }
  ...
  public SbtRequestPayloadFiles getFiles() {
    return files;
  }

  public void setFiles(SbtRequestPayloadFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    SbtRequestPayload sbtRequestPayload = (SbtRequestPayload) o;
    return Objects.equals(this.encoding, sbtRequestPayload.encoding) &&
        Objects.equals(this.files, sbtRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class SbtRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SbtRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SbtRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SbtRequestPayload is not found in the empty JSON string", SbtRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SbtRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SbtRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SbtRequestPayload.openapiRequiredFields) {
      ...
      SbtRequestPayloadFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SbtRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SbtRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SbtRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SbtRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<SbtRequestPayload>() {
           @Override
           public void write(JsonWriter out, SbtRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SbtRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SbtRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SbtRequestPayload
   * @throws IOException if the JSON string is invalid with respect to SbtRequestPayload
   */
  public static SbtRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SbtRequestPayload.class);
  }

  /**
   * Convert an instance of SbtRequestPayload to an JSON string
   *
   * @return JSON string
   */
