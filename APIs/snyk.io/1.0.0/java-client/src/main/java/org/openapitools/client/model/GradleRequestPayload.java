...
import org.openapitools.client.model.GradleRequestPayloadFiles;
...
public class GradleRequestPayload {
  /**
  ...
  private GradleRequestPayloadFiles files;

  public GradleRequestPayload() {
  }

  public GradleRequestPayload encoding(EncodingEnum encoding) {
  ...
  public GradleRequestPayload files(GradleRequestPayloadFiles files) {
    this.files = files;
    return this;
  }
  ...
  public GradleRequestPayloadFiles getFiles() {
    return files;
  }

  public void setFiles(GradleRequestPayloadFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    GradleRequestPayload gradleRequestPayload = (GradleRequestPayload) o;
    return Objects.equals(this.encoding, gradleRequestPayload.encoding) &&
        Objects.equals(this.files, gradleRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class GradleRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GradleRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GradleRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GradleRequestPayload is not found in the empty JSON string", GradleRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GradleRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GradleRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GradleRequestPayload.openapiRequiredFields) {
      ...
      GradleRequestPayloadFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GradleRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GradleRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GradleRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GradleRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<GradleRequestPayload>() {
           @Override
           public void write(JsonWriter out, GradleRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GradleRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GradleRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GradleRequestPayload
   * @throws IOException if the JSON string is invalid with respect to GradleRequestPayload
   */
  public static GradleRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GradleRequestPayload.class);
  }

  /**
   * Convert an instance of GradleRequestPayload to an JSON string
   *
   * @return JSON string
   */
