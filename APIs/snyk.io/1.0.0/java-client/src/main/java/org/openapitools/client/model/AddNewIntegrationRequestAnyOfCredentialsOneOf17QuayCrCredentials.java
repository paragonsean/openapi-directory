...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials password(String password) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials registryBase(String registryBase) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials addNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials = (AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials) o;
    return Objects.equals(this.password, addNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.password) &&
        Objects.equals(this.registryBase, addNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.registryBase) &&
        Objects.equals(this.username, addNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials to an JSON string
   *
   * @return JSON string
   */
