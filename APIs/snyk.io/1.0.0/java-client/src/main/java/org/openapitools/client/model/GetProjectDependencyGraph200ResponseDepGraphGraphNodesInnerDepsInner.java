...
public class GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner {
  public static final String SERIALIZED_NAME_NODE_ID = "nodeId";
  @SerializedName(SERIALIZED_NAME_NODE_ID)
  private String nodeId;

  public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner() {
  }

  public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner getProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner = (GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner) o;
    return Objects.equals(this.nodeId, getProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.nodeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner
   */
  public static GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraphGraphNodesInnerDepsInner to an JSON string
   *
   * @return JSON string
   */
