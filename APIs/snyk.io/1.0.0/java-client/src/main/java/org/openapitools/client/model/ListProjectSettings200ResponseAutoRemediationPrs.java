...
public class ListProjectSettings200ResponseAutoRemediationPrs {
  public static final String SERIALIZED_NAME_BACKLOG_PRS_ENABLED = "backlogPrsEnabled";
  @SerializedName(SERIALIZED_NAME_BACKLOG_PRS_ENABLED)
  private Boolean backlogPrsEnabled;

  public static final String SERIALIZED_NAME_FRESH_PRS_ENABLED = "freshPrsEnabled";
  @SerializedName(SERIALIZED_NAME_FRESH_PRS_ENABLED)
  private Boolean freshPrsEnabled;

  public static final String SERIALIZED_NAME_USE_PATCH_REMEDIATION = "usePatchRemediation";
  @SerializedName(SERIALIZED_NAME_USE_PATCH_REMEDIATION)
  private Boolean usePatchRemediation;

  public ListProjectSettings200ResponseAutoRemediationPrs() {
  }

  public ListProjectSettings200ResponseAutoRemediationPrs backlogPrsEnabled(Boolean backlogPrsEnabled) {
    this.backlogPrsEnabled = backlogPrsEnabled;
    return this;
  }

  /**
   * If true, allows automatic remediation of newly identified issues, or older issues where a fix has been identified
   * @return backlogPrsEnabled
   */
  @javax.annotation.Nullable
  public Boolean getBacklogPrsEnabled() {
    return backlogPrsEnabled;
  }

  public void setBacklogPrsEnabled(Boolean backlogPrsEnabled) {
    this.backlogPrsEnabled = backlogPrsEnabled;
  }


  public ListProjectSettings200ResponseAutoRemediationPrs freshPrsEnabled(Boolean freshPrsEnabled) {
    this.freshPrsEnabled = freshPrsEnabled;
    return this;
  }

  /**
   * If true, allows automatic remediation of prioritized backlog issues
   * @return freshPrsEnabled
   */
  @javax.annotation.Nullable
  public Boolean getFreshPrsEnabled() {
    return freshPrsEnabled;
  }

  public void setFreshPrsEnabled(Boolean freshPrsEnabled) {
    this.freshPrsEnabled = freshPrsEnabled;
  }


  public ListProjectSettings200ResponseAutoRemediationPrs usePatchRemediation(Boolean usePatchRemediation) {
    this.usePatchRemediation = usePatchRemediation;
    return this;
  }

  /**
   * If true, allows using patched remediation
   * @return usePatchRemediation
   */
  @javax.annotation.Nullable
  public Boolean getUsePatchRemediation() {
    return usePatchRemediation;
  }

  public void setUsePatchRemediation(Boolean usePatchRemediation) {
    this.usePatchRemediation = usePatchRemediation;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListProjectSettings200ResponseAutoRemediationPrs listProjectSettings200ResponseAutoRemediationPrs = (ListProjectSettings200ResponseAutoRemediationPrs) o;
    return Objects.equals(this.backlogPrsEnabled, listProjectSettings200ResponseAutoRemediationPrs.backlogPrsEnabled) &&
        Objects.equals(this.freshPrsEnabled, listProjectSettings200ResponseAutoRemediationPrs.freshPrsEnabled) &&
        Objects.equals(this.usePatchRemediation, listProjectSettings200ResponseAutoRemediationPrs.usePatchRemediation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backlogPrsEnabled, freshPrsEnabled, usePatchRemediation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListProjectSettings200ResponseAutoRemediationPrs {\n");
    sb.append("    backlogPrsEnabled: ").append(toIndentedString(backlogPrsEnabled)).append("\n");
    sb.append("    freshPrsEnabled: ").append(toIndentedString(freshPrsEnabled)).append("\n");
    sb.append("    usePatchRemediation: ").append(toIndentedString(usePatchRemediation)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("backlogPrsEnabled");
    openapiFields.add("freshPrsEnabled");
    openapiFields.add("usePatchRemediation");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListProjectSettings200ResponseAutoRemediationPrs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListProjectSettings200ResponseAutoRemediationPrs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProjectSettings200ResponseAutoRemediationPrs is not found in the empty JSON string", ListProjectSettings200ResponseAutoRemediationPrs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListProjectSettings200ResponseAutoRemediationPrs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListProjectSettings200ResponseAutoRemediationPrs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProjectSettings200ResponseAutoRemediationPrs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProjectSettings200ResponseAutoRemediationPrs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProjectSettings200ResponseAutoRemediationPrs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProjectSettings200ResponseAutoRemediationPrs.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProjectSettings200ResponseAutoRemediationPrs>() {
           @Override
           public void write(JsonWriter out, ListProjectSettings200ResponseAutoRemediationPrs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListProjectSettings200ResponseAutoRemediationPrs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListProjectSettings200ResponseAutoRemediationPrs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListProjectSettings200ResponseAutoRemediationPrs
   * @throws IOException if the JSON string is invalid with respect to ListProjectSettings200ResponseAutoRemediationPrs
   */
  public static ListProjectSettings200ResponseAutoRemediationPrs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProjectSettings200ResponseAutoRemediationPrs.class);
  }

  /**
   * Convert an instance of ListProjectSettings200ResponseAutoRemediationPrs to an JSON string
   *
   * @return JSON string
   */
