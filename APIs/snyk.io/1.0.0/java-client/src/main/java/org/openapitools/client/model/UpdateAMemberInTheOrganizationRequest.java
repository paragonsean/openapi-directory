...
public class UpdateAMemberInTheOrganizationRequest {
  public static final String SERIALIZED_NAME_ROLE = "role";
  @SerializedName(SERIALIZED_NAME_ROLE)
  private String role;

  public UpdateAMemberInTheOrganizationRequest() {
  }

  public UpdateAMemberInTheOrganizationRequest role(String role) {
    this.role = role;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateAMemberInTheOrganizationRequest updateAMemberInTheOrganizationRequest = (UpdateAMemberInTheOrganizationRequest) o;
    return Objects.equals(this.role, updateAMemberInTheOrganizationRequest.role);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAMemberInTheOrganizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAMemberInTheOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAMemberInTheOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAMemberInTheOrganizationRequest is not found in the empty JSON string", UpdateAMemberInTheOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAMemberInTheOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAMemberInTheOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAMemberInTheOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAMemberInTheOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAMemberInTheOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAMemberInTheOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAMemberInTheOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAMemberInTheOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAMemberInTheOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAMemberInTheOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAMemberInTheOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAMemberInTheOrganizationRequest
   */
  public static UpdateAMemberInTheOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAMemberInTheOrganizationRequest.class);
  }

  /**
   * Convert an instance of UpdateAMemberInTheOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
