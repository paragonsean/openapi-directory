...
public class TestComposerJsonComposerLockFileRequestFilesTarget {
  public static final String SERIALIZED_NAME_CONTENTS = "contents";
  @SerializedName(SERIALIZED_NAME_CONTENTS)
  private String contents;

  public TestComposerJsonComposerLockFileRequestFilesTarget() {
  }

  public TestComposerJsonComposerLockFileRequestFilesTarget contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    TestComposerJsonComposerLockFileRequestFilesTarget testComposerJsonComposerLockFileRequestFilesTarget = (TestComposerJsonComposerLockFileRequestFilesTarget) o;
    return Objects.equals(this.contents, testComposerJsonComposerLockFileRequestFilesTarget.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestComposerJsonComposerLockFileRequestFilesTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestComposerJsonComposerLockFileRequestFilesTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestComposerJsonComposerLockFileRequestFilesTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestComposerJsonComposerLockFileRequestFilesTarget is not found in the empty JSON string", TestComposerJsonComposerLockFileRequestFilesTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestComposerJsonComposerLockFileRequestFilesTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestComposerJsonComposerLockFileRequestFilesTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestComposerJsonComposerLockFileRequestFilesTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestComposerJsonComposerLockFileRequestFilesTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestComposerJsonComposerLockFileRequestFilesTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestComposerJsonComposerLockFileRequestFilesTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<TestComposerJsonComposerLockFileRequestFilesTarget>() {
           @Override
           public void write(JsonWriter out, TestComposerJsonComposerLockFileRequestFilesTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestComposerJsonComposerLockFileRequestFilesTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestComposerJsonComposerLockFileRequestFilesTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestComposerJsonComposerLockFileRequestFilesTarget
   * @throws IOException if the JSON string is invalid with respect to TestComposerJsonComposerLockFileRequestFilesTarget
   */
  public static TestComposerJsonComposerLockFileRequestFilesTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestComposerJsonComposerLockFileRequestFilesTarget.class);
  }

  /**
   * Convert an instance of TestComposerJsonComposerLockFileRequestFilesTarget to an JSON string
   *
   * @return JSON string
   */
