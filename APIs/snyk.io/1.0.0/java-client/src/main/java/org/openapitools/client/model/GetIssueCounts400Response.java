...
public class GetIssueCounts400Response {
  ...
  public GetIssueCounts400Response() {
  }

  public GetIssueCounts400Response code(BigDecimal code) {
    this.code = code;
    return this;
  }
  ...
  public GetIssueCounts400Response error(GetIssueCounts400ResponseError error) {
    this.error = error;
    return this;
  }
  ...
  public GetIssueCounts400Response ok(Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCounts400Response getIssueCounts400Response = (GetIssueCounts400Response) o;
    return Objects.equals(this.code, getIssueCounts400Response.code) &&
        Objects.equals(this.error, getIssueCounts400Response.error) &&
        Objects.equals(this.ok, getIssueCounts400Response.ok);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIssueCounts400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCounts400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCounts400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCounts400Response is not found in the empty JSON string", GetIssueCounts400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCounts400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCounts400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIssueCounts400Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCounts400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCounts400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCounts400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCounts400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCounts400Response>() {
           @Override
           public void write(JsonWriter out, GetIssueCounts400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCounts400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCounts400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCounts400Response
   * @throws IOException if the JSON string is invalid with respect to GetIssueCounts400Response
   */
  public static GetIssueCounts400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCounts400Response.class);
  }

  /**
   * Convert an instance of GetIssueCounts400Response to an JSON string
   *
   * @return JSON string
   */
