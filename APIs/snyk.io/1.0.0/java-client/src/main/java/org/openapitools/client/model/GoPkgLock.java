...
public class GoPkgLock {
  ...
  public GoPkgLock contents(String contents) {
  ...
  public boolean equals(Object o) {
    ...
    GoPkgLock goPkgLock = (GoPkgLock) o;
    return Objects.equals(this.contents, goPkgLock.contents);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoPkgLock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoPkgLock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoPkgLock is not found in the empty JSON string", GoPkgLock.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoPkgLock.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoPkgLock` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoPkgLock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoPkgLock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoPkgLock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoPkgLock.class));

       return (TypeAdapter<T>) new TypeAdapter<GoPkgLock>() {
           @Override
           public void write(JsonWriter out, GoPkgLock value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoPkgLock read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoPkgLock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoPkgLock
   * @throws IOException if the JSON string is invalid with respect to GoPkgLock
   */
  public static GoPkgLock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoPkgLock.class);
  }

  /**
   * Convert an instance of GoPkgLock to an JSON string
   *
   * @return JSON string
   */
