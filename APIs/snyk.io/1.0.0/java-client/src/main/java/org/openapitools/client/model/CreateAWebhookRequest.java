...
public class CreateAWebhookRequest {
  ...
  public CreateAWebhookRequest() {
  }

  public CreateAWebhookRequest secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public CreateAWebhookRequest url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAWebhookRequest createAWebhookRequest = (CreateAWebhookRequest) o;
    return Objects.equals(this.secret, createAWebhookRequest.secret) &&
        Objects.equals(this.url, createAWebhookRequest.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAWebhookRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAWebhookRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAWebhookRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAWebhookRequest is not found in the empty JSON string", CreateAWebhookRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAWebhookRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAWebhookRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAWebhookRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAWebhookRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAWebhookRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAWebhookRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAWebhookRequest>() {
           @Override
           public void write(JsonWriter out, CreateAWebhookRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAWebhookRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAWebhookRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAWebhookRequest
   * @throws IOException if the JSON string is invalid with respect to CreateAWebhookRequest
   */
  public static CreateAWebhookRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAWebhookRequest.class);
  }

  /**
   * Convert an instance of CreateAWebhookRequest to an JSON string
   *
   * @return JSON string
   */
