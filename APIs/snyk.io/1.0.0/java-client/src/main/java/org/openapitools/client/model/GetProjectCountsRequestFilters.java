...
public class GetProjectCountsRequestFilters {
  ...
  public GetProjectCountsRequestFilters() {
  }

  public GetProjectCountsRequestFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public GetProjectCountsRequestFilters addLanguagesItem(Object languagesItem) {
  ...
  public GetProjectCountsRequestFilters orgs(Object orgs) {
    this.orgs = orgs;
    return this;
  }
  ...
  public GetProjectCountsRequestFilters projects(Object projects) {
  ...
  public boolean equals(Object o) {
    ...
    GetProjectCountsRequestFilters getProjectCountsRequestFilters = (GetProjectCountsRequestFilters) o;
    return Objects.equals(this.languages, getProjectCountsRequestFilters.languages) &&
        Objects.equals(this.orgs, getProjectCountsRequestFilters.orgs) &&
        Objects.equals(this.projects, getProjectCountsRequestFilters.projects);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectCountsRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectCountsRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectCountsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectCountsRequestFilters is not found in the empty JSON string", GetProjectCountsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectCountsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectCountsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectCountsRequestFilters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectCountsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectCountsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectCountsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectCountsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectCountsRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetProjectCountsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectCountsRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectCountsRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectCountsRequestFilters
   * @throws IOException if the JSON string is invalid with respect to GetProjectCountsRequestFilters
   */
  public static GetProjectCountsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectCountsRequestFilters.class);
  }

  /**
   * Convert an instance of GetProjectCountsRequestFilters to an JSON string
   *
   * @return JSON string
   */
