...
public class MonitorDepGraphRequestMeta {
  ...
  public MonitorDepGraphRequestMeta() {
  }

  public MonitorDepGraphRequestMeta targetFramework(String targetFramework) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorDepGraphRequestMeta monitorDepGraphRequestMeta = (MonitorDepGraphRequestMeta) o;
    return Objects.equals(this.targetFramework, monitorDepGraphRequestMeta.targetFramework);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targetFramework);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MonitorDepGraphRequestMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorDepGraphRequestMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorDepGraphRequestMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorDepGraphRequestMeta is not found in the empty JSON string", MonitorDepGraphRequestMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorDepGraphRequestMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorDepGraphRequestMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorDepGraphRequestMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorDepGraphRequestMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorDepGraphRequestMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorDepGraphRequestMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorDepGraphRequestMeta>() {
           @Override
           public void write(JsonWriter out, MonitorDepGraphRequestMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorDepGraphRequestMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorDepGraphRequestMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorDepGraphRequestMeta
   * @throws IOException if the JSON string is invalid with respect to MonitorDepGraphRequestMeta
   */
  public static MonitorDepGraphRequestMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorDepGraphRequestMeta.class);
  }

  /**
   * Convert an instance of MonitorDepGraphRequestMeta to an JSON string
   *
   * @return JSON string
   */
