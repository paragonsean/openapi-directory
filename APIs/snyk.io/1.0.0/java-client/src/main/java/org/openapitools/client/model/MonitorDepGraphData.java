...
import org.openapitools.client.model.MonitorGraph;
import org.openapitools.client.model.MonitorPkgManager;
...
public class MonitorDepGraphData {
  ...
  private MonitorPkgManager pkgManager;
  ...
  public MonitorDepGraphData() {
  }

  public MonitorDepGraphData graph(MonitorGraph graph) {
    this.graph = graph;
    return this;
  }
  ...
  public MonitorGraph getGraph() {
    return graph;
  }

  public void setGraph(MonitorGraph graph) {
    this.graph = graph;
  }


  public MonitorDepGraphData pkgManager(MonitorPkgManager pkgManager) {
   ...
   */
  @javax.annotation.Nonnull
  public MonitorPkgManager getPkgManager() {
    return pkgManager;
  }

  public void setPkgManager(MonitorPkgManager pkgManager) {
    this.pkgManager = pkgManager;
  }


  public MonitorDepGraphData pkgs(List<Object> pkgs) {
    this.pkgs = pkgs;
    return this;
  }

  public MonitorDepGraphData addPkgsItem(Object pkgsItem) {
    if (this.pkgs == null) {
  ...
  public MonitorDepGraphData schemaVersion(String schemaVersion) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorDepGraphData monitorDepGraphData = (MonitorDepGraphData) o;
    return Objects.equals(this.graph, monitorDepGraphData.graph) &&
        Objects.equals(this.pkgManager, monitorDepGraphData.pkgManager) &&
        Objects.equals(this.pkgs, monitorDepGraphData.pkgs) &&
        Objects.equals(this.schemaVersion, monitorDepGraphData.schemaVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorDepGraphData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorDepGraphData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorDepGraphData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorDepGraphData is not found in the empty JSON string", MonitorDepGraphData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorDepGraphData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorDepGraphData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorDepGraphData.openapiRequiredFields) {
      ...
      MonitorGraph.validateJsonElement(jsonObj.get("graph"));
      // validate the required field `pkgManager`
      MonitorPkgManager.validateJsonElement(jsonObj.get("pkgManager"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorDepGraphData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorDepGraphData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorDepGraphData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorDepGraphData.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorDepGraphData>() {
           @Override
           public void write(JsonWriter out, MonitorDepGraphData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorDepGraphData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorDepGraphData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorDepGraphData
   * @throws IOException if the JSON string is invalid with respect to MonitorDepGraphData
   */
  public static MonitorDepGraphData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorDepGraphData.class);
  }

  /**
   * Convert an instance of MonitorDepGraphData to an JSON string
   *
   * @return JSON string
   */
