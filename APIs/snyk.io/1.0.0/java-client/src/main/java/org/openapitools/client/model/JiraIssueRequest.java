...
public class JiraIssueRequest {
  ...
  public JiraIssueRequest fields(CreateJiraIssueRequestFields fields) {
    this.fields = fields;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JiraIssueRequest jiraIssueRequest = (JiraIssueRequest) o;
    return Objects.equals(this.fields, jiraIssueRequest.fields);
  }
  ...
  public String toString() {
    ...
    sb.append("class JiraIssueRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JiraIssueRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JiraIssueRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JiraIssueRequest is not found in the empty JSON string", JiraIssueRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JiraIssueRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JiraIssueRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JiraIssueRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JiraIssueRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JiraIssueRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JiraIssueRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<JiraIssueRequest>() {
           @Override
           public void write(JsonWriter out, JiraIssueRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JiraIssueRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JiraIssueRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JiraIssueRequest
   * @throws IOException if the JSON string is invalid with respect to JiraIssueRequest
   */
  public static JiraIssueRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JiraIssueRequest.class);
  }

  /**
   * Convert an instance of JiraIssueRequest to an JSON string
   *
   * @return JSON string
   */
