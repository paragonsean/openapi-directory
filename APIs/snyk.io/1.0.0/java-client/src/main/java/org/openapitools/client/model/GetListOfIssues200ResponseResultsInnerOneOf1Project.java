...
public class GetListOfIssues200ResponseResultsInnerOneOf1Project {
  ...
  public static final String SERIALIZED_NAME_TARGET_FILE = "targetFile";
  ...
  public GetListOfIssues200ResponseResultsInnerOneOf1Project() {
  }

  public GetListOfIssues200ResponseResultsInnerOneOf1Project id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetListOfIssues200ResponseResultsInnerOneOf1Project name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetListOfIssues200ResponseResultsInnerOneOf1Project packageManager(String packageManager) {
  ...
  public GetListOfIssues200ResponseResultsInnerOneOf1Project source(String source) {
    this.source = source;
    return this;
  }
  ...
  public GetListOfIssues200ResponseResultsInnerOneOf1Project targetFile(String targetFile) {
  ...
  public GetListOfIssues200ResponseResultsInnerOneOf1Project url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetListOfIssues200ResponseResultsInnerOneOf1Project getListOfIssues200ResponseResultsInnerOneOf1Project = (GetListOfIssues200ResponseResultsInnerOneOf1Project) o;
    return Objects.equals(this.id, getListOfIssues200ResponseResultsInnerOneOf1Project.id) &&
        Objects.equals(this.name, getListOfIssues200ResponseResultsInnerOneOf1Project.name) &&
        Objects.equals(this.packageManager, getListOfIssues200ResponseResultsInnerOneOf1Project.packageManager) &&
        Objects.equals(this.source, getListOfIssues200ResponseResultsInnerOneOf1Project.source) &&
        Objects.equals(this.targetFile, getListOfIssues200ResponseResultsInnerOneOf1Project.targetFile) &&
        Objects.equals(this.url, getListOfIssues200ResponseResultsInnerOneOf1Project.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, packageManager, source, targetFile, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetListOfIssues200ResponseResultsInnerOneOf1Project {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("packageManager");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetListOfIssues200ResponseResultsInnerOneOf1Project
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetListOfIssues200ResponseResultsInnerOneOf1Project.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListOfIssues200ResponseResultsInnerOneOf1Project is not found in the empty JSON string", GetListOfIssues200ResponseResultsInnerOneOf1Project.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetListOfIssues200ResponseResultsInnerOneOf1Project.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetListOfIssues200ResponseResultsInnerOneOf1Project` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetListOfIssues200ResponseResultsInnerOneOf1Project.openapiRequiredFields) {
      ...
      if (!jsonObj.get("packageManager").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("targetFile") != null && !jsonObj.get("targetFile").isJsonNull()) && !jsonObj.get("targetFile").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `targetFile` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetFile").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListOfIssues200ResponseResultsInnerOneOf1Project.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListOfIssues200ResponseResultsInnerOneOf1Project' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf1Project> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListOfIssues200ResponseResultsInnerOneOf1Project.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListOfIssues200ResponseResultsInnerOneOf1Project>() {
           @Override
           public void write(JsonWriter out, GetListOfIssues200ResponseResultsInnerOneOf1Project value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetListOfIssues200ResponseResultsInnerOneOf1Project read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetListOfIssues200ResponseResultsInnerOneOf1Project given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetListOfIssues200ResponseResultsInnerOneOf1Project
   * @throws IOException if the JSON string is invalid with respect to GetListOfIssues200ResponseResultsInnerOneOf1Project
   */
  public static GetListOfIssues200ResponseResultsInnerOneOf1Project fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListOfIssues200ResponseResultsInnerOneOf1Project.class);
  }

  /**
   * Convert an instance of GetListOfIssues200ResponseResultsInnerOneOf1Project to an JSON string
   *
   * @return JSON string
   */
