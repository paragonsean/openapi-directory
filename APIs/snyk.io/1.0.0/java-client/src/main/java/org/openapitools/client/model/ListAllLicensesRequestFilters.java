...
public class ListAllLicensesRequestFilters {
  ...
  public ListAllLicensesRequestFilters() {
  }

  public ListAllLicensesRequestFilters dependencies(Object dependencies) {
  ...
  public ListAllLicensesRequestFilters languages(List<Object> languages) {
    this.languages = languages;
    return this;
  }

  public ListAllLicensesRequestFilters addLanguagesItem(Object languagesItem) {
  ...
  public ListAllLicensesRequestFilters licenses(Object licenses) {
  ...
  public ListAllLicensesRequestFilters projects(Object projects) {
  ...
  public ListAllLicensesRequestFilters severity(List<Object> severity) {
    this.severity = severity;
    return this;
  }

  public ListAllLicensesRequestFilters addSeverityItem(Object severityItem) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllLicensesRequestFilters listAllLicensesRequestFilters = (ListAllLicensesRequestFilters) o;
    return Objects.equals(this.dependencies, listAllLicensesRequestFilters.dependencies) &&
        Objects.equals(this.languages, listAllLicensesRequestFilters.languages) &&
        Objects.equals(this.licenses, listAllLicensesRequestFilters.licenses) &&
        Objects.equals(this.projects, listAllLicensesRequestFilters.projects) &&
        Objects.equals(this.severity, listAllLicensesRequestFilters.severity);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dependencies, languages, licenses, projects, severity);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllLicensesRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllLicensesRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllLicensesRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllLicensesRequestFilters is not found in the empty JSON string", ListAllLicensesRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllLicensesRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllLicensesRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllLicensesRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllLicensesRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllLicensesRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllLicensesRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllLicensesRequestFilters>() {
           @Override
           public void write(JsonWriter out, ListAllLicensesRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllLicensesRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllLicensesRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllLicensesRequestFilters
   * @throws IOException if the JSON string is invalid with respect to ListAllLicensesRequestFilters
   */
  public static ListAllLicensesRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllLicensesRequestFilters.class);
  }

  /**
   * Convert an instance of ListAllLicensesRequestFilters to an JSON string
   *
   * @return JSON string
   */
