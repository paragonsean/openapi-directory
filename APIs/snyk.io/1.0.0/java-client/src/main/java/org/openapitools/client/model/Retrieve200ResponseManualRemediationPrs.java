...
public class Retrieve200ResponseManualRemediationPrs {
  ...
  public Retrieve200ResponseManualRemediationPrs() {
  }

  public Retrieve200ResponseManualRemediationPrs usePatchRemediation(Boolean usePatchRemediation) {
  ...
  public boolean equals(Object o) {
    ...
    Retrieve200ResponseManualRemediationPrs retrieve200ResponseManualRemediationPrs = (Retrieve200ResponseManualRemediationPrs) o;
    return Objects.equals(this.usePatchRemediation, retrieve200ResponseManualRemediationPrs.usePatchRemediation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(usePatchRemediation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Retrieve200ResponseManualRemediationPrs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Retrieve200ResponseManualRemediationPrs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Retrieve200ResponseManualRemediationPrs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Retrieve200ResponseManualRemediationPrs is not found in the empty JSON string", Retrieve200ResponseManualRemediationPrs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Retrieve200ResponseManualRemediationPrs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Retrieve200ResponseManualRemediationPrs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Retrieve200ResponseManualRemediationPrs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Retrieve200ResponseManualRemediationPrs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Retrieve200ResponseManualRemediationPrs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Retrieve200ResponseManualRemediationPrs.class));

       return (TypeAdapter<T>) new TypeAdapter<Retrieve200ResponseManualRemediationPrs>() {
           @Override
           public void write(JsonWriter out, Retrieve200ResponseManualRemediationPrs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Retrieve200ResponseManualRemediationPrs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Retrieve200ResponseManualRemediationPrs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Retrieve200ResponseManualRemediationPrs
   * @throws IOException if the JSON string is invalid with respect to Retrieve200ResponseManualRemediationPrs
   */
  public static Retrieve200ResponseManualRemediationPrs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Retrieve200ResponseManualRemediationPrs.class);
  }

  /**
   * Convert an instance of Retrieve200ResponseManualRemediationPrs to an JSON string
   *
   * @return JSON string
   */
