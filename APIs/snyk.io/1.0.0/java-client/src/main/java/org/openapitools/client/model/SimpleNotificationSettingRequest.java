...
public class SimpleNotificationSettingRequest {
  public static final String SERIALIZED_NAME_ENABLED = "enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public SimpleNotificationSettingRequest() {
  }

  public SimpleNotificationSettingRequest enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    SimpleNotificationSettingRequest simpleNotificationSettingRequest = (SimpleNotificationSettingRequest) o;
    return Objects.equals(this.enabled, simpleNotificationSettingRequest.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class SimpleNotificationSettingRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimpleNotificationSettingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimpleNotificationSettingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimpleNotificationSettingRequest is not found in the empty JSON string", SimpleNotificationSettingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleNotificationSettingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimpleNotificationSettingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimpleNotificationSettingRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimpleNotificationSettingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimpleNotificationSettingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimpleNotificationSettingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimpleNotificationSettingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SimpleNotificationSettingRequest>() {
           @Override
           public void write(JsonWriter out, SimpleNotificationSettingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimpleNotificationSettingRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SimpleNotificationSettingRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SimpleNotificationSettingRequest
   * @throws IOException if the JSON string is invalid with respect to SimpleNotificationSettingRequest
   */
  public static SimpleNotificationSettingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimpleNotificationSettingRequest.class);
  }

  /**
   * Convert an instance of SimpleNotificationSettingRequest to an JSON string
   *
   * @return JSON string
   */
