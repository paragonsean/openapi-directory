...
public class GroupsApi {
    ...
    /**
     * Build call for addAMemberToAnOrganizationWithinAGroup
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param orgId The organization ID we want to add the member to. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param addAMemberToAnOrganizationWithinAGroupRequest  (optional)
     ...
     */
    public okhttp3.Call addAMemberToAnOrganizationWithinAGroupCall(String groupId, String orgId, AddAMemberToAnOrganizationWithinAGroupRequest addAMemberToAnOrganizationWithinAGroupRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = addAMemberToAnOrganizationWithinAGroupRequest;

        // create path and map variables
        String localVarPath = "/group/{groupId}/org/{orgId}/members"
    ...
    private okhttp3.Call addAMemberToAnOrganizationWithinAGroupValidateBeforeCall(String groupId, String orgId, AddAMemberToAnOrganizationWithinAGroupRequest addAMemberToAnOrganizationWithinAGroupRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling addAMemberToAnOrganizationWithinAGroup(Async)");
        }

        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling addAMemberToAnOrganizationWithinAGroup(Async)");
        }

        return addAMemberToAnOrganizationWithinAGroupCall(groupId, orgId, addAMemberToAnOrganizationWithinAGroupRequest, _callback);
     ...
     */
    public void addAMemberToAnOrganizationWithinAGroup(String groupId, String orgId, AddAMemberToAnOrganizationWithinAGroupRequest addAMemberToAnOrganizationWithinAGroupRequest) throws ApiException {
        addAMemberToAnOrganizationWithinAGroupWithHttpInfo(groupId, orgId, addAMemberToAnOrganizationWithinAGroupRequest);
    }
     ...
     */
    public ApiResponse<Void> addAMemberToAnOrganizationWithinAGroupWithHttpInfo(String groupId, String orgId, AddAMemberToAnOrganizationWithinAGroupRequest addAMemberToAnOrganizationWithinAGroupRequest) throws ApiException {
        okhttp3.Call localVarCall = addAMemberToAnOrganizationWithinAGroupValidateBeforeCall(groupId, orgId, addAMemberToAnOrganizationWithinAGroupRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add a member to an organization within a group (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param orgId The organization ID we want to add the member to. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param addAMemberToAnOrganizationWithinAGroupRequest  (optional)
     ...
     */
    public okhttp3.Call addAMemberToAnOrganizationWithinAGroupAsync(String groupId, String orgId, AddAMemberToAnOrganizationWithinAGroupRequest addAMemberToAnOrganizationWithinAGroupRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addAMemberToAnOrganizationWithinAGroupValidateBeforeCall(groupId, orgId, addAMemberToAnOrganizationWithinAGroupRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteTagFromGroup
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param deleteTagFromGroupRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteTagFromGroupCall(String groupId, DeleteTagFromGroupRequest deleteTagFromGroupRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = deleteTagFromGroupRequest;

        // create path and map variables
        String localVarPath = "/group/{groupId}/tags/delete"
            .replace("{" + "groupId" + "}", localVarApiClient.escapeString(groupId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTagFromGroupValidateBeforeCall(String groupId, DeleteTagFromGroupRequest deleteTagFromGroupRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling deleteTagFromGroup(Async)");
        }

        return deleteTagFromGroupCall(groupId, deleteTagFromGroupRequest, _callback);
     ...
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param deleteTagFromGroupRequest  (optional)
     * @return DeleteTagFromGroup200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public DeleteTagFromGroup200Response deleteTagFromGroup(String groupId, DeleteTagFromGroupRequest deleteTagFromGroupRequest) throws ApiException {
        ApiResponse<DeleteTagFromGroup200Response> localVarResp = deleteTagFromGroupWithHttpInfo(groupId, deleteTagFromGroupRequest);
     ...
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param deleteTagFromGroupRequest  (optional)
     * @return ApiResponse&lt;DeleteTagFromGroup200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeleteTagFromGroup200Response> deleteTagFromGroupWithHttpInfo(String groupId, DeleteTagFromGroupRequest deleteTagFromGroupRequest) throws ApiException {
        okhttp3.Call localVarCall = deleteTagFromGroupValidateBeforeCall(groupId, deleteTagFromGroupRequest, null);
        Type localVarReturnType = new TypeToken<DeleteTagFromGroup200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete tag from group (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param deleteTagFromGroupRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call deleteTagFromGroupAsync(String groupId, DeleteTagFromGroupRequest deleteTagFromGroupRequest, final ApiCallback<DeleteTagFromGroup200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteTagFromGroupValidateBeforeCall(groupId, deleteTagFromGroupRequest, _callback);
        Type localVarReturnType = new TypeToken<DeleteTagFromGroup200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listAllMembersInAGroup
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call listAllMembersInAGroupCall(String groupId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/group/{groupId}/members"
            .replace("{" + "groupId" + "}", localVarApiClient.escapeString(groupId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllMembersInAGroupValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling listAllMembersInAGroup(Async)");
        }

        return listAllMembersInAGroupCall(groupId, _callback);
     ...
     */
    public List<Object> listAllMembersInAGroup(String groupId) throws ApiException {
        ApiResponse<List<Object>> localVarResp = listAllMembersInAGroupWithHttpInfo(groupId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Object>> listAllMembersInAGroupWithHttpInfo(String groupId) throws ApiException {
        okhttp3.Call localVarCall = listAllMembersInAGroupValidateBeforeCall(groupId, null);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List all members in a group (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call listAllMembersInAGroupAsync(String groupId, final ApiCallback<List<Object>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllMembersInAGroupValidateBeforeCall(groupId, _callback);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listAllOrganizationsInAGroup
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have READ access to this group and LIST organizations access in this group. (required)
     * @param perPage The number of results to return (maximum is 100). (optional, default to 100)
     * @param page For pagination - offset (from which to start returning results). (optional)
     * @param name Only organizations that have a name that **starts with** this value (case insensitive) will be returned. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listAllOrganizationsInAGroupCall(String groupId, BigDecimal perPage, BigDecimal page, String name, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/group/{groupId}/orgs"
            .replace("{" + "groupId" + "}", localVarApiClient.escapeString(groupId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllOrganizationsInAGroupValidateBeforeCall(String groupId, BigDecimal perPage, BigDecimal page, String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling listAllOrganizationsInAGroup(Async)");
        }

        return listAllOrganizationsInAGroupCall(groupId, perPage, page, name, _callback);
     ...
     */
    public void listAllOrganizationsInAGroup(String groupId, BigDecimal perPage, BigDecimal page, String name) throws ApiException {
        listAllOrganizationsInAGroupWithHttpInfo(groupId, perPage, page, name);
    }
     ...
     */
    public ApiResponse<Void> listAllOrganizationsInAGroupWithHttpInfo(String groupId, BigDecimal perPage, BigDecimal page, String name) throws ApiException {
        okhttp3.Call localVarCall = listAllOrganizationsInAGroupValidateBeforeCall(groupId, perPage, page, name, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * List all organizations in a group (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have READ access to this group and LIST organizations access in this group. (required)
     * @param perPage The number of results to return (maximum is 100). (optional, default to 100)
     * @param page For pagination - offset (from which to start returning results). (optional)
     ...
     */
    public okhttp3.Call listAllOrganizationsInAGroupAsync(String groupId, BigDecimal perPage, BigDecimal page, String name, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllOrganizationsInAGroupValidateBeforeCall(groupId, perPage, page, name, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for listAllRolesInAGroup
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have READ access to this group. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listAllRolesInAGroupCall(String groupId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/group/{groupId}/roles"
            .replace("{" + "groupId" + "}", localVarApiClient.escapeString(groupId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllRolesInAGroupValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling listAllRolesInAGroup(Async)");
        }

        return listAllRolesInAGroupCall(groupId, _callback);
     ...
     */
    public void listAllRolesInAGroup(String groupId) throws ApiException {
        listAllRolesInAGroupWithHttpInfo(groupId);
    }
     ...
     */
    public ApiResponse<Void> listAllRolesInAGroupWithHttpInfo(String groupId) throws ApiException {
        okhttp3.Call localVarCall = listAllRolesInAGroupValidateBeforeCall(groupId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * List all roles in a group (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have READ access to this group. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call listAllRolesInAGroupAsync(String groupId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllRolesInAGroupValidateBeforeCall(groupId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for listAllTagsInAGroup
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param perPage The number of results to return (the default is 1000). (optional)
     ...
     */
    public okhttp3.Call listAllTagsInAGroupCall(String groupId, BigDecimal perPage, BigDecimal page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/group/{groupId}/tags"
            .replace("{" + "groupId" + "}", localVarApiClient.escapeString(groupId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllTagsInAGroupValidateBeforeCall(String groupId, BigDecimal perPage, BigDecimal page, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling listAllTagsInAGroup(Async)");
        }

        return listAllTagsInAGroupCall(groupId, perPage, page, _callback);
     ...
     * @param perPage The number of results to return (the default is 1000). (optional)
     * @param page The offset from which to start returning results from. (optional)
     * @return ListAllTagsInAGroup200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ListAllTagsInAGroup200Response listAllTagsInAGroup(String groupId, BigDecimal perPage, BigDecimal page) throws ApiException {
        ApiResponse<ListAllTagsInAGroup200Response> localVarResp = listAllTagsInAGroupWithHttpInfo(groupId, perPage, page);
        return localVarResp.getData();
    }
     ...
     * @param perPage The number of results to return (the default is 1000). (optional)
     * @param page The offset from which to start returning results from. (optional)
     * @return ApiResponse&lt;ListAllTagsInAGroup200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListAllTagsInAGroup200Response> listAllTagsInAGroupWithHttpInfo(String groupId, BigDecimal perPage, BigDecimal page) throws ApiException {
        okhttp3.Call localVarCall = listAllTagsInAGroupValidateBeforeCall(groupId, perPage, page, null);
        Type localVarReturnType = new TypeToken<ListAllTagsInAGroup200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List all tags in a group (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have access admin to this group. (required)
     * @param perPage The number of results to return (the default is 1000). (optional)
     * @param page The offset from which to start returning results from. (optional)
     ...
     */
    public okhttp3.Call listAllTagsInAGroupAsync(String groupId, BigDecimal perPage, BigDecimal page, final ApiCallback<ListAllTagsInAGroup200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllTagsInAGroupValidateBeforeCall(groupId, perPage, page, _callback);
        Type localVarReturnType = new TypeToken<ListAllTagsInAGroup200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateGroupSettings
     * @param groupId Automatically added (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateGroupSettingsCall(String groupId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/group/{groupId}/settings"
            .replace("{" + "groupId" + "}", localVarApiClient.escapeString(groupId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateGroupSettingsValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling updateGroupSettings(Async)");
        }

        return updateGroupSettingsCall(groupId, _callback);
     ...
     * 
     * @param groupId Automatically added (required)
     * @return ViewGroupSettings200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ViewGroupSettings200Response updateGroupSettings(String groupId) throws ApiException {
        ApiResponse<ViewGroupSettings200Response> localVarResp = updateGroupSettingsWithHttpInfo(groupId);
        return localVarResp.getData();
    }
     ...
     * 
     * @param groupId Automatically added (required)
     * @return ApiResponse&lt;ViewGroupSettings200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ViewGroupSettings200Response> updateGroupSettingsWithHttpInfo(String groupId) throws ApiException {
        okhttp3.Call localVarCall = updateGroupSettingsValidateBeforeCall(groupId, null);
        Type localVarReturnType = new TypeToken<ViewGroupSettings200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateGroupSettingsAsync(String groupId, final ApiCallback<ViewGroupSettings200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateGroupSettingsValidateBeforeCall(groupId, _callback);
        Type localVarReturnType = new TypeToken<ViewGroupSettings200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for viewGroupSettings
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have admin access to this group. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call viewGroupSettingsCall(String groupId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call viewGroupSettingsValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling viewGroupSettings(Async)");
        }

        return viewGroupSettingsCall(groupId, _callback);
     ...
     */
    public ViewGroupSettings200Response viewGroupSettings(String groupId) throws ApiException {
        ApiResponse<ViewGroupSettings200Response> localVarResp = viewGroupSettingsWithHttpInfo(groupId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ViewGroupSettings200Response> viewGroupSettingsWithHttpInfo(String groupId) throws ApiException {
        okhttp3.Call localVarCall = viewGroupSettingsValidateBeforeCall(groupId, null);
        Type localVarReturnType = new TypeToken<ViewGroupSettings200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * View group settings (asynchronously)
     * 
     * @param groupId The group ID. The &#x60;API_KEY&#x60; must have admin access to this group. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call viewGroupSettingsAsync(String groupId, final ApiCallback<ViewGroupSettings200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = viewGroupSettingsValidateBeforeCall(groupId, _callback);
        Type localVarReturnType = new TypeToken<ViewGroupSettings200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
