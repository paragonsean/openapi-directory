...
public class PkgManager {
  ...
  public PkgManager name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PkgManager repositories(List<Object> repositories) {
    this.repositories = repositories;
    return this;
  }

  public PkgManager addRepositoriesItem(Object repositoriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PkgManager pkgManager = (PkgManager) o;
    return Objects.equals(this.name, pkgManager.name) &&
        Objects.equals(this.repositories, pkgManager.repositories);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PkgManager
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PkgManager.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PkgManager is not found in the empty JSON string", PkgManager.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PkgManager.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PkgManager` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PkgManager.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PkgManager.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PkgManager' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PkgManager> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PkgManager.class));

       return (TypeAdapter<T>) new TypeAdapter<PkgManager>() {
           @Override
           public void write(JsonWriter out, PkgManager value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PkgManager read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PkgManager given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PkgManager
   * @throws IOException if the JSON string is invalid with respect to PkgManager
   */
  public static PkgManager fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PkgManager.class);
  }

  /**
   * Convert an instance of PkgManager to an JSON string
   *
   * @return JSON string
   */
