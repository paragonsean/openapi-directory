...
import org.openapitools.client.model.TestGradleFileRequestFilesTarget;
...
public class TestGradleFileRequestFiles {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private TestGradleFileRequestFilesTarget target;

  public TestGradleFileRequestFiles() {
  }

  public TestGradleFileRequestFiles target(TestGradleFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
  ...
  public TestGradleFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestGradleFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestGradleFileRequestFiles testGradleFileRequestFiles = (TestGradleFileRequestFiles) o;
    return Objects.equals(this.target, testGradleFileRequestFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGradleFileRequestFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGradleFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGradleFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGradleFileRequestFiles is not found in the empty JSON string", TestGradleFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGradleFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGradleFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestGradleFileRequestFiles.openapiRequiredFields) {
      ...
      TestGradleFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGradleFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGradleFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGradleFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGradleFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGradleFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestGradleFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGradleFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGradleFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGradleFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestGradleFileRequestFiles
   */
  public static TestGradleFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGradleFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestGradleFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
