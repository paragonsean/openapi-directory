...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf17 {
  public static final String SERIALIZED_NAME_QUAY_CR_CREDENTIALS = "QuayCrCredentials";
  @SerializedName(SERIALIZED_NAME_QUAY_CR_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials quayCrCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf17() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf17 quayCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials quayCrCredentials) {
    this.quayCrCredentials = quayCrCredentials;
    return this;
  }

  /**
   * Get quayCrCredentials
   * @return quayCrCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials getQuayCrCredentials() {
    return quayCrCredentials;
  }

  public void setQuayCrCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials quayCrCredentials) {
    this.quayCrCredentials = quayCrCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf17 addNewIntegrationRequestAnyOfCredentialsOneOf17 = (AddNewIntegrationRequestAnyOfCredentialsOneOf17) o;
    return Objects.equals(this.quayCrCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf17.quayCrCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quayCrCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf17 {\n");
    sb.append("    quayCrCredentials: ").append(toIndentedString(quayCrCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("QuayCrCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf17
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf17.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf17 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf17.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf17.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf17` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `QuayCrCredentials`
      if (jsonObj.get("QuayCrCredentials") != null && !jsonObj.get("QuayCrCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf17QuayCrCredentials.validateJsonElement(jsonObj.get("QuayCrCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf17.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf17' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf17> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf17.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf17>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf17 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf17 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf17 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf17
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf17
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf17 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf17.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf17 to an JSON string
   *
   * @return JSON string
   */
