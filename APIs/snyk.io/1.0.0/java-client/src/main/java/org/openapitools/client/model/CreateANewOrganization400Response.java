...
public class CreateANewOrganization400Response {
  public static final String SERIALIZED_NAME_ERROR_REF = "errorRef";
  @SerializedName(SERIALIZED_NAME_ERROR_REF)
  ...
  public CreateANewOrganization400Response() {
  }

  public CreateANewOrganization400Response errorRef(String errorRef) {
  ...
  public CreateANewOrganization400Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    CreateANewOrganization400Response createANewOrganization400Response = (CreateANewOrganization400Response) o;
    return Objects.equals(this.errorRef, createANewOrganization400Response.errorRef) &&
        Objects.equals(this.message, createANewOrganization400Response.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errorRef, message);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateANewOrganization400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateANewOrganization400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateANewOrganization400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateANewOrganization400Response is not found in the empty JSON string", CreateANewOrganization400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateANewOrganization400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateANewOrganization400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("errorRef") != null && !jsonObj.get("errorRef").isJsonNull()) && !jsonObj.get("errorRef").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `errorRef` to be a primitive type in the JSON string but got `%s`", jsonObj.get("errorRef").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateANewOrganization400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateANewOrganization400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateANewOrganization400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateANewOrganization400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateANewOrganization400Response>() {
           @Override
           public void write(JsonWriter out, CreateANewOrganization400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateANewOrganization400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateANewOrganization400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateANewOrganization400Response
   * @throws IOException if the JSON string is invalid with respect to CreateANewOrganization400Response
   */
  public static CreateANewOrganization400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateANewOrganization400Response.class);
  }

  /**
   * Convert an instance of CreateANewOrganization400Response to an JSON string
   *
   * @return JSON string
   */
