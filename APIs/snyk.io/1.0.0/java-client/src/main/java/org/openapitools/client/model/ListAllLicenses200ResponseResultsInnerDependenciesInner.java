...
public class ListAllLicenses200ResponseResultsInnerDependenciesInner {
  ...
  public ListAllLicenses200ResponseResultsInnerDependenciesInner() {
  }

  public ListAllLicenses200ResponseResultsInnerDependenciesInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllLicenses200ResponseResultsInnerDependenciesInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ListAllLicenses200ResponseResultsInnerDependenciesInner packageManager(String packageManager) {
  ...
  public ListAllLicenses200ResponseResultsInnerDependenciesInner version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllLicenses200ResponseResultsInnerDependenciesInner listAllLicenses200ResponseResultsInnerDependenciesInner = (ListAllLicenses200ResponseResultsInnerDependenciesInner) o;
    return Objects.equals(this.id, listAllLicenses200ResponseResultsInnerDependenciesInner.id) &&
        Objects.equals(this.name, listAllLicenses200ResponseResultsInnerDependenciesInner.name) &&
        Objects.equals(this.packageManager, listAllLicenses200ResponseResultsInnerDependenciesInner.packageManager) &&
        Objects.equals(this.version, listAllLicenses200ResponseResultsInnerDependenciesInner.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, packageManager, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllLicenses200ResponseResultsInnerDependenciesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllLicenses200ResponseResultsInnerDependenciesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllLicenses200ResponseResultsInnerDependenciesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllLicenses200ResponseResultsInnerDependenciesInner is not found in the empty JSON string", ListAllLicenses200ResponseResultsInnerDependenciesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllLicenses200ResponseResultsInnerDependenciesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllLicenses200ResponseResultsInnerDependenciesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllLicenses200ResponseResultsInnerDependenciesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllLicenses200ResponseResultsInnerDependenciesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllLicenses200ResponseResultsInnerDependenciesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllLicenses200ResponseResultsInnerDependenciesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllLicenses200ResponseResultsInnerDependenciesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllLicenses200ResponseResultsInnerDependenciesInner>() {
           @Override
           public void write(JsonWriter out, ListAllLicenses200ResponseResultsInnerDependenciesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllLicenses200ResponseResultsInnerDependenciesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllLicenses200ResponseResultsInnerDependenciesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllLicenses200ResponseResultsInnerDependenciesInner
   * @throws IOException if the JSON string is invalid with respect to ListAllLicenses200ResponseResultsInnerDependenciesInner
   */
  public static ListAllLicenses200ResponseResultsInnerDependenciesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllLicenses200ResponseResultsInnerDependenciesInner.class);
  }

  /**
   * Convert an instance of ListAllLicenses200ResponseResultsInnerDependenciesInner to an JSON string
   *
   * @return JSON string
   */
