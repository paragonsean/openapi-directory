...
public class TestDepGraphRequestDepGraphGraph {
  public static final String SERIALIZED_NAME_NODES = "nodes";
  @SerializedName(SERIALIZED_NAME_NODES)
  private List<Object> nodes = new ArrayList<>();

  public static final String SERIALIZED_NAME_ROOT_NODE_ID = "rootNodeId";
  @SerializedName(SERIALIZED_NAME_ROOT_NODE_ID)
  private String rootNodeId;

  public TestDepGraphRequestDepGraphGraph() {
  }

  public TestDepGraphRequestDepGraphGraph nodes(List<Object> nodes) {
    this.nodes = nodes;
    return this;
  }

  public TestDepGraphRequestDepGraphGraph addNodesItem(Object nodesItem) {
    if (this.nodes == null) {
  ...
  public TestDepGraphRequestDepGraphGraph rootNodeId(String rootNodeId) {
  ...
  public boolean equals(Object o) {
    ...
    TestDepGraphRequestDepGraphGraph testDepGraphRequestDepGraphGraph = (TestDepGraphRequestDepGraphGraph) o;
    return Objects.equals(this.nodes, testDepGraphRequestDepGraphGraph.nodes) &&
        Objects.equals(this.rootNodeId, testDepGraphRequestDepGraphGraph.rootNodeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nodes, rootNodeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestDepGraphRequestDepGraphGraph {\n");
  ...
  static {
    ...
    openapiFields.add("rootNodeId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("nodes");
    openapiRequiredFields.add("rootNodeId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestDepGraphRequestDepGraphGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestDepGraphRequestDepGraphGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestDepGraphRequestDepGraphGraph is not found in the empty JSON string", TestDepGraphRequestDepGraphGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestDepGraphRequestDepGraphGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestDepGraphRequestDepGraphGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestDepGraphRequestDepGraphGraph.openapiRequiredFields) {
      ...
      if (!jsonObj.get("rootNodeId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rootNodeId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rootNodeId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestDepGraphRequestDepGraphGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestDepGraphRequestDepGraphGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestDepGraphRequestDepGraphGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestDepGraphRequestDepGraphGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<TestDepGraphRequestDepGraphGraph>() {
           @Override
           public void write(JsonWriter out, TestDepGraphRequestDepGraphGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestDepGraphRequestDepGraphGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestDepGraphRequestDepGraphGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestDepGraphRequestDepGraphGraph
   * @throws IOException if the JSON string is invalid with respect to TestDepGraphRequestDepGraphGraph
   */
  public static TestDepGraphRequestDepGraphGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestDepGraphRequestDepGraphGraph.class);
  }

  /**
   * Convert an instance of TestDepGraphRequestDepGraphGraph to an JSON string
   *
   * @return JSON string
   */
