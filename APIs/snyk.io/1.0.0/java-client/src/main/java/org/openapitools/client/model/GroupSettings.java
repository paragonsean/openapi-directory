...
public class GroupSettings {
  ...
  public GroupSettings requestAccess(ViewGroupSettings200ResponseRequestAccess requestAccess) {
  ...
  public GroupSettings sessionLength(BigDecimal sessionLength) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestAccess, groupSettings.requestAccess) &&
        Objects.equals(this.sessionLength, groupSettings.sessionLength);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupSettings is not found in the empty JSON string", GroupSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupSettings>() {
           @Override
           public void write(JsonWriter out, GroupSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GroupSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GroupSettings
   * @throws IOException if the JSON string is invalid with respect to GroupSettings
   */
  public static GroupSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupSettings.class);
  }

  /**
   * Convert an instance of GroupSettings to an JSON string
   *
   * @return JSON string
   */
