...
import org.openapitools.client.model.GetProjectCountsRequestFilters;
...
public class GetProjectCountsRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private GetProjectCountsRequestFilters filters;

  public GetProjectCountsRequest() {
  }

  public GetProjectCountsRequest filters(GetProjectCountsRequestFilters filters) {
  ...
  public GetProjectCountsRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(GetProjectCountsRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectCountsRequest getProjectCountsRequest = (GetProjectCountsRequest) o;
    return Objects.equals(this.filters, getProjectCountsRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectCountsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectCountsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectCountsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectCountsRequest is not found in the empty JSON string", GetProjectCountsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectCountsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectCountsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        GetProjectCountsRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectCountsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectCountsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectCountsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectCountsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectCountsRequest>() {
           @Override
           public void write(JsonWriter out, GetProjectCountsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectCountsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectCountsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectCountsRequest
   * @throws IOException if the JSON string is invalid with respect to GetProjectCountsRequest
   */
  public static GetProjectCountsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectCountsRequest.class);
  }

  /**
   * Convert an instance of GetProjectCountsRequest to an JSON string
   *
   * @return JSON string
   */
