...
import org.openapitools.client.model.ImportTargetsRequestAnyOf2Target;
...
public class ImportTargetsRequestAnyOf2 {
  public static final String SERIALIZED_NAME_EXCLUSION_GLOBS = "exclusionGlobs";
  @SerializedName(SERIALIZED_NAME_EXCLUSION_GLOBS)
  private String exclusionGlobs;
  ...
  private ImportTargetsRequestAnyOf2Target target;

  public ImportTargetsRequestAnyOf2() {
  }

  public ImportTargetsRequestAnyOf2 exclusionGlobs(String exclusionGlobs) {
  ...
  public String getExclusionGlobs() {
    return exclusionGlobs;
  }

  public void setExclusionGlobs(String exclusionGlobs) {
    this.exclusionGlobs = exclusionGlobs;
  }


  public ImportTargetsRequestAnyOf2 files(List<Object> files) {
    this.files = files;
    return this;
  }

  public ImportTargetsRequestAnyOf2 addFilesItem(Object filesItem) {
    if (this.files == null) {
  ...
  public ImportTargetsRequestAnyOf2 target(ImportTargetsRequestAnyOf2Target target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportTargetsRequestAnyOf2Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf2Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf2 importTargetsRequestAnyOf2 = (ImportTargetsRequestAnyOf2) o;
    return Objects.equals(this.exclusionGlobs, importTargetsRequestAnyOf2.exclusionGlobs) &&
        Objects.equals(this.files, importTargetsRequestAnyOf2.files) &&
        Objects.equals(this.target, importTargetsRequestAnyOf2.target);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exclusionGlobs, files, target);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportTargetsRequestAnyOf2 {\n");
    sb.append("    exclusionGlobs: ").append(toIndentedString(exclusionGlobs)).append("\n");
  ...
  static {
    ...
    openapiFields.add("exclusionGlobs");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf2 is not found in the empty JSON string", ImportTargetsRequestAnyOf2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("exclusionGlobs") != null && !jsonObj.get("exclusionGlobs").isJsonNull()) && !jsonObj.get("exclusionGlobs").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `exclusionGlobs` to be a primitive type in the JSON string but got `%s`", jsonObj.get("exclusionGlobs").toString()));
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf2Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf2.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf2>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf2
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf2
   */
  public static ImportTargetsRequestAnyOf2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf2.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf2 to an JSON string
   *
   * @return JSON string
   */
