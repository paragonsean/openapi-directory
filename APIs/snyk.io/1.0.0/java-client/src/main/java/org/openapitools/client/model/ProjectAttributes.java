...
public class ProjectAttributes {
  ...
  public ProjectAttributes criticality(List<Object> criticality) {
    this.criticality = criticality;
    return this;
  }

  public ProjectAttributes addCriticalityItem(Object criticalityItem) {
  ...
  public ProjectAttributes environment(List<Object> environment) {
    this.environment = environment;
    return this;
  }

  public ProjectAttributes addEnvironmentItem(Object environmentItem) {
  ...
  public ProjectAttributes lifecycle(List<Object> lifecycle) {
    this.lifecycle = lifecycle;
    return this;
  }

  public ProjectAttributes addLifecycleItem(Object lifecycleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.criticality, projectAttributes.criticality) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
