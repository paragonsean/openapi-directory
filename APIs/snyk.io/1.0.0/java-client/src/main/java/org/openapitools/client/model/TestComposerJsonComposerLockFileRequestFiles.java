...
import org.openapitools.client.model.TestComposerJsonComposerLockFileRequestFilesTarget;
...
public class TestComposerJsonComposerLockFileRequestFiles {
  ...
  private TestComposerJsonComposerLockFileRequestFilesTarget target;

  public TestComposerJsonComposerLockFileRequestFiles() {
  }

  public TestComposerJsonComposerLockFileRequestFiles additional(List<Object> additional) {
    this.additional = additional;
    return this;
  }

  public TestComposerJsonComposerLockFileRequestFiles addAdditionalItem(Object additionalItem) {
  ...
  public TestComposerJsonComposerLockFileRequestFiles target(TestComposerJsonComposerLockFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public TestComposerJsonComposerLockFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestComposerJsonComposerLockFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestComposerJsonComposerLockFileRequestFiles testComposerJsonComposerLockFileRequestFiles = (TestComposerJsonComposerLockFileRequestFiles) o;
    return Objects.equals(this.additional, testComposerJsonComposerLockFileRequestFiles.additional) &&
        Objects.equals(this.target, testComposerJsonComposerLockFileRequestFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestComposerJsonComposerLockFileRequestFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestComposerJsonComposerLockFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestComposerJsonComposerLockFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestComposerJsonComposerLockFileRequestFiles is not found in the empty JSON string", TestComposerJsonComposerLockFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestComposerJsonComposerLockFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestComposerJsonComposerLockFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestComposerJsonComposerLockFileRequestFiles.openapiRequiredFields) {
      ...
      TestComposerJsonComposerLockFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestComposerJsonComposerLockFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestComposerJsonComposerLockFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestComposerJsonComposerLockFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestComposerJsonComposerLockFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestComposerJsonComposerLockFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestComposerJsonComposerLockFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestComposerJsonComposerLockFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestComposerJsonComposerLockFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestComposerJsonComposerLockFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestComposerJsonComposerLockFileRequestFiles
   */
  public static TestComposerJsonComposerLockFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestComposerJsonComposerLockFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestComposerJsonComposerLockFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
