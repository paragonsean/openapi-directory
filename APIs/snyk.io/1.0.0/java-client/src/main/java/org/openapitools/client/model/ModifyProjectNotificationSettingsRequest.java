...
import org.openapitools.client.model.SetNotificationSettingsRequestNewIssuesRemediations;
...
public class ModifyProjectNotificationSettingsRequest {
  ...
  private SetNotificationSettingsRequestNewIssuesRemediations newIssuesRemediations;

  public ModifyProjectNotificationSettingsRequest() {
  }

  public ModifyProjectNotificationSettingsRequest newIssuesRemediations(SetNotificationSettingsRequestNewIssuesRemediations newIssuesRemediations) {
  ...
  public SetNotificationSettingsRequestNewIssuesRemediations getNewIssuesRemediations() {
    return newIssuesRemediations;
  }

  public void setNewIssuesRemediations(SetNotificationSettingsRequestNewIssuesRemediations newIssuesRemediations) {
    this.newIssuesRemediations = newIssuesRemediations;
  }
  ...
  public boolean equals(Object o) {
    ...
    ModifyProjectNotificationSettingsRequest modifyProjectNotificationSettingsRequest = (ModifyProjectNotificationSettingsRequest) o;
    return Objects.equals(this.newIssuesRemediations, modifyProjectNotificationSettingsRequest.newIssuesRemediations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(newIssuesRemediations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModifyProjectNotificationSettingsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyProjectNotificationSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyProjectNotificationSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyProjectNotificationSettingsRequest is not found in the empty JSON string", ModifyProjectNotificationSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyProjectNotificationSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyProjectNotificationSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("new-issues-remediations") != null && !jsonObj.get("new-issues-remediations").isJsonNull()) {
        SetNotificationSettingsRequestNewIssuesRemediations.validateJsonElement(jsonObj.get("new-issues-remediations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyProjectNotificationSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyProjectNotificationSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyProjectNotificationSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyProjectNotificationSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyProjectNotificationSettingsRequest>() {
           @Override
           public void write(JsonWriter out, ModifyProjectNotificationSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyProjectNotificationSettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyProjectNotificationSettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyProjectNotificationSettingsRequest
   * @throws IOException if the JSON string is invalid with respect to ModifyProjectNotificationSettingsRequest
   */
  public static ModifyProjectNotificationSettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyProjectNotificationSettingsRequest.class);
  }

  /**
   * Convert an instance of ModifyProjectNotificationSettingsRequest to an JSON string
   *
   * @return JSON string
   */
