...
public class ListAllAggregatedIssuesRequest {
  ...
  public ListAllAggregatedIssuesRequest() {
  }

  public ListAllAggregatedIssuesRequest filters(ListAllAggregatedIssuesRequestFilters filters) {
  ...
  public ListAllAggregatedIssuesRequest includeDescription(Boolean includeDescription) {
  ...
  public ListAllAggregatedIssuesRequest includeIntroducedThrough(Boolean includeIntroducedThrough) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssuesRequest listAllAggregatedIssuesRequest = (ListAllAggregatedIssuesRequest) o;
    return Objects.equals(this.filters, listAllAggregatedIssuesRequest.filters) &&
        Objects.equals(this.includeDescription, listAllAggregatedIssuesRequest.includeDescription) &&
        Objects.equals(this.includeIntroducedThrough, listAllAggregatedIssuesRequest.includeIntroducedThrough);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllAggregatedIssuesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssuesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssuesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssuesRequest is not found in the empty JSON string", ListAllAggregatedIssuesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssuesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssuesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssuesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssuesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssuesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssuesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssuesRequest>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssuesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssuesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssuesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssuesRequest
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssuesRequest
   */
  public static ListAllAggregatedIssuesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssuesRequest.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssuesRequest to an JSON string
   *
   * @return JSON string
   */
