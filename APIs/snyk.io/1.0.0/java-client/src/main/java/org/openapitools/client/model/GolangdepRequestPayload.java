...
import org.openapitools.client.model.TestGopkgTomlGopkgLockFileRequestFiles;
...
public class GolangdepRequestPayload {
  /**
  ...
  private TestGopkgTomlGopkgLockFileRequestFiles files;

  public GolangdepRequestPayload() {
  }

  public GolangdepRequestPayload encoding(EncodingEnum encoding) {
  ...
  public GolangdepRequestPayload files(TestGopkgTomlGopkgLockFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestGopkgTomlGopkgLockFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestGopkgTomlGopkgLockFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    GolangdepRequestPayload golangdepRequestPayload = (GolangdepRequestPayload) o;
    return Objects.equals(this.encoding, golangdepRequestPayload.encoding) &&
        Objects.equals(this.files, golangdepRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class GolangdepRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GolangdepRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GolangdepRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GolangdepRequestPayload is not found in the empty JSON string", GolangdepRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GolangdepRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GolangdepRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GolangdepRequestPayload.openapiRequiredFields) {
      ...
      TestGopkgTomlGopkgLockFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GolangdepRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GolangdepRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GolangdepRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GolangdepRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<GolangdepRequestPayload>() {
           @Override
           public void write(JsonWriter out, GolangdepRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GolangdepRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GolangdepRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GolangdepRequestPayload
   * @throws IOException if the JSON string is invalid with respect to GolangdepRequestPayload
   */
  public static GolangdepRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GolangdepRequestPayload.class);
  }

  /**
   * Convert an instance of GolangdepRequestPayload to an JSON string
   *
   * @return JSON string
   */
