...
import org.openapitools.client.model.MavenFile;
...
public class MavenRequestPayloadFiles {
  ...
  private MavenFile target;

  public MavenRequestPayloadFiles() {
  }

  public MavenRequestPayloadFiles additional(List<Object> additional) {
    this.additional = additional;
    return this;
  }

  public MavenRequestPayloadFiles addAdditionalItem(Object additionalItem) {
  ...
  public MavenRequestPayloadFiles target(MavenFile target) {
    this.target = target;
    return this;
  }
  ...
  public MavenFile getTarget() {
    return target;
  }

  public void setTarget(MavenFile target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    MavenRequestPayloadFiles mavenRequestPayloadFiles = (MavenRequestPayloadFiles) o;
    return Objects.equals(this.additional, mavenRequestPayloadFiles.additional) &&
        Objects.equals(this.target, mavenRequestPayloadFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class MavenRequestPayloadFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MavenRequestPayloadFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MavenRequestPayloadFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MavenRequestPayloadFiles is not found in the empty JSON string", MavenRequestPayloadFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MavenRequestPayloadFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MavenRequestPayloadFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MavenRequestPayloadFiles.openapiRequiredFields) {
      ...
      MavenFile.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MavenRequestPayloadFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MavenRequestPayloadFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MavenRequestPayloadFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MavenRequestPayloadFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<MavenRequestPayloadFiles>() {
           @Override
           public void write(JsonWriter out, MavenRequestPayloadFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MavenRequestPayloadFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MavenRequestPayloadFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MavenRequestPayloadFiles
   * @throws IOException if the JSON string is invalid with respect to MavenRequestPayloadFiles
   */
  public static MavenRequestPayloadFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MavenRequestPayloadFiles.class);
  }

  /**
   * Convert an instance of MavenRequestPayloadFiles to an JSON string
   *
   * @return JSON string
   */
