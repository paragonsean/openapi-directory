...
public class ListAllDependencies200ResponseResultsInnerProjectsInner {
  ...
  public ListAllDependencies200ResponseResultsInnerProjectsInner() {
  }

  public ListAllDependencies200ResponseResultsInnerProjectsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ListAllDependencies200ResponseResultsInnerProjectsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllDependencies200ResponseResultsInnerProjectsInner listAllDependencies200ResponseResultsInnerProjectsInner = (ListAllDependencies200ResponseResultsInnerProjectsInner) o;
    return Objects.equals(this.id, listAllDependencies200ResponseResultsInnerProjectsInner.id) &&
        Objects.equals(this.name, listAllDependencies200ResponseResultsInnerProjectsInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllDependencies200ResponseResultsInnerProjectsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllDependencies200ResponseResultsInnerProjectsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllDependencies200ResponseResultsInnerProjectsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllDependencies200ResponseResultsInnerProjectsInner is not found in the empty JSON string", ListAllDependencies200ResponseResultsInnerProjectsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllDependencies200ResponseResultsInnerProjectsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllDependencies200ResponseResultsInnerProjectsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllDependencies200ResponseResultsInnerProjectsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllDependencies200ResponseResultsInnerProjectsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllDependencies200ResponseResultsInnerProjectsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllDependencies200ResponseResultsInnerProjectsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllDependencies200ResponseResultsInnerProjectsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllDependencies200ResponseResultsInnerProjectsInner>() {
           @Override
           public void write(JsonWriter out, ListAllDependencies200ResponseResultsInnerProjectsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllDependencies200ResponseResultsInnerProjectsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllDependencies200ResponseResultsInnerProjectsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllDependencies200ResponseResultsInnerProjectsInner
   * @throws IOException if the JSON string is invalid with respect to ListAllDependencies200ResponseResultsInnerProjectsInner
   */
  public static ListAllDependencies200ResponseResultsInnerProjectsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllDependencies200ResponseResultsInnerProjectsInner.class);
  }

  /**
   * Convert an instance of ListAllDependencies200ResponseResultsInnerProjectsInner to an JSON string
   *
   * @return JSON string
   */
