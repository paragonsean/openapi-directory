...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf4BitbucketServerCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf4 {
  public static final String SERIALIZED_NAME_BITBUCKET_SERVER_CREDENTIALS = "BitbucketServerCredentials";
  @SerializedName(SERIALIZED_NAME_BITBUCKET_SERVER_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf4BitbucketServerCredentials bitbucketServerCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf4() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf4 bitbucketServerCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf4BitbucketServerCredentials bitbucketServerCredentials) {
    this.bitbucketServerCredentials = bitbucketServerCredentials;
    return this;
  }

  /**
   * Get bitbucketServerCredentials
   * @return bitbucketServerCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf4BitbucketServerCredentials getBitbucketServerCredentials() {
    return bitbucketServerCredentials;
  }

  public void setBitbucketServerCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf4BitbucketServerCredentials bitbucketServerCredentials) {
    this.bitbucketServerCredentials = bitbucketServerCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf4 addNewIntegrationRequestAnyOfCredentialsOneOf4 = (AddNewIntegrationRequestAnyOfCredentialsOneOf4) o;
    return Objects.equals(this.bitbucketServerCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf4.bitbucketServerCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bitbucketServerCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf4 {\n");
    sb.append("    bitbucketServerCredentials: ").append(toIndentedString(bitbucketServerCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("BitbucketServerCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf4 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `BitbucketServerCredentials`
      if (jsonObj.get("BitbucketServerCredentials") != null && !jsonObj.get("BitbucketServerCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf4BitbucketServerCredentials.validateJsonElement(jsonObj.get("BitbucketServerCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf4.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf4>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf4
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf4
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf4.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf4 to an JSON string
   *
   * @return JSON string
   */
