...
import org.openapitools.client.model.NewIssuesNotificationSettingRequest;
import org.openapitools.client.model.SimpleNotificationSettingRequest;
...
public class NotificationSettingsRequest {
  public static final String SERIALIZED_NAME_NEW_ISSUES_REMEDIATIONS = "new-issues-remediations";
  @SerializedName(SERIALIZED_NAME_NEW_ISSUES_REMEDIATIONS)
  private NewIssuesNotificationSettingRequest newIssuesRemediations;

  public static final String SERIALIZED_NAME_PROJECT_IMPORTED = "project-imported";
  @SerializedName(SERIALIZED_NAME_PROJECT_IMPORTED)
  private SimpleNotificationSettingRequest projectImported;

  public static final String SERIALIZED_NAME_TEST_LIMIT = "test-limit";
  @SerializedName(SERIALIZED_NAME_TEST_LIMIT)
  private SimpleNotificationSettingRequest testLimit;

  public static final String SERIALIZED_NAME_WEEKLY_REPORT = "weekly-report";
  @SerializedName(SERIALIZED_NAME_WEEKLY_REPORT)
  private SimpleNotificationSettingRequest weeklyReport;

  public NotificationSettingsRequest() {
  }

  public NotificationSettingsRequest newIssuesRemediations(NewIssuesNotificationSettingRequest newIssuesRemediations) {
    this.newIssuesRemediations = newIssuesRemediations;
    return this;
  }

  /**
   * Get newIssuesRemediations
   * @return newIssuesRemediations
   */
  @javax.annotation.Nullable
  public NewIssuesNotificationSettingRequest getNewIssuesRemediations() {
    return newIssuesRemediations;
  }

  public void setNewIssuesRemediations(NewIssuesNotificationSettingRequest newIssuesRemediations) {
    this.newIssuesRemediations = newIssuesRemediations;
  }


  public NotificationSettingsRequest projectImported(SimpleNotificationSettingRequest projectImported) {
   ...
   */
  @javax.annotation.Nullable
  public SimpleNotificationSettingRequest getProjectImported() {
    return projectImported;
  }

  public void setProjectImported(SimpleNotificationSettingRequest projectImported) {
    this.projectImported = projectImported;
  }


  public NotificationSettingsRequest testLimit(SimpleNotificationSettingRequest testLimit) {
   ...
   */
  @javax.annotation.Nullable
  public SimpleNotificationSettingRequest getTestLimit() {
    return testLimit;
  }

  public void setTestLimit(SimpleNotificationSettingRequest testLimit) {
    this.testLimit = testLimit;
  }


  public NotificationSettingsRequest weeklyReport(SimpleNotificationSettingRequest weeklyReport) {
   ...
   */
  @javax.annotation.Nullable
  public SimpleNotificationSettingRequest getWeeklyReport() {
    return weeklyReport;
  }

  public void setWeeklyReport(SimpleNotificationSettingRequest weeklyReport) {
    this.weeklyReport = weeklyReport;
  }
  ...
  public boolean equals(Object o) {
    ...
    NotificationSettingsRequest notificationSettingsRequest = (NotificationSettingsRequest) o;
    return Objects.equals(this.newIssuesRemediations, notificationSettingsRequest.newIssuesRemediations) &&
        Objects.equals(this.projectImported, notificationSettingsRequest.projectImported) &&
        Objects.equals(this.testLimit, notificationSettingsRequest.testLimit) &&
        Objects.equals(this.weeklyReport, notificationSettingsRequest.weeklyReport);
  }

  @Override
  public int hashCode() {
    return Objects.hash(newIssuesRemediations, projectImported, testLimit, weeklyReport);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NotificationSettingsRequest {\n");
    sb.append("    newIssuesRemediations: ").append(toIndentedString(newIssuesRemediations)).append("\n");
    sb.append("    projectImported: ").append(toIndentedString(projectImported)).append("\n");
    sb.append("    testLimit: ").append(toIndentedString(testLimit)).append("\n");
    sb.append("    weeklyReport: ").append(toIndentedString(weeklyReport)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("new-issues-remediations");
    openapiFields.add("project-imported");
    openapiFields.add("test-limit");
    openapiFields.add("weekly-report");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotificationSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotificationSettingsRequest is not found in the empty JSON string", NotificationSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotificationSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotificationSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `new-issues-remediations`
      if (jsonObj.get("new-issues-remediations") != null && !jsonObj.get("new-issues-remediations").isJsonNull()) {
        NewIssuesNotificationSettingRequest.validateJsonElement(jsonObj.get("new-issues-remediations"));
      }
      // validate the optional field `project-imported`
      if (jsonObj.get("project-imported") != null && !jsonObj.get("project-imported").isJsonNull()) {
        SimpleNotificationSettingRequest.validateJsonElement(jsonObj.get("project-imported"));
      }
      // validate the optional field `test-limit`
      if (jsonObj.get("test-limit") != null && !jsonObj.get("test-limit").isJsonNull()) {
        SimpleNotificationSettingRequest.validateJsonElement(jsonObj.get("test-limit"));
      }
      // validate the optional field `weekly-report`
      if (jsonObj.get("weekly-report") != null && !jsonObj.get("weekly-report").isJsonNull()) {
        SimpleNotificationSettingRequest.validateJsonElement(jsonObj.get("weekly-report"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotificationSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotificationSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotificationSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotificationSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NotificationSettingsRequest>() {
           @Override
           public void write(JsonWriter out, NotificationSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotificationSettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotificationSettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotificationSettingsRequest
   * @throws IOException if the JSON string is invalid with respect to NotificationSettingsRequest
   */
  public static NotificationSettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotificationSettingsRequest.class);
  }

  /**
   * Convert an instance of NotificationSettingsRequest to an JSON string
   *
   * @return JSON string
   */
