...
import org.openapitools.client.model.MavenRequestPayloadFiles;
...
public class MavenRequestPayload {
  /**
  ...
  private MavenRequestPayloadFiles files;

  public MavenRequestPayload() {
  }

  public MavenRequestPayload encoding(EncodingEnum encoding) {
  ...
  public MavenRequestPayload files(MavenRequestPayloadFiles files) {
    this.files = files;
    return this;
  }
  ...
  public MavenRequestPayloadFiles getFiles() {
    return files;
  }

  public void setFiles(MavenRequestPayloadFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    MavenRequestPayload mavenRequestPayload = (MavenRequestPayload) o;
    return Objects.equals(this.encoding, mavenRequestPayload.encoding) &&
        Objects.equals(this.files, mavenRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class MavenRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MavenRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MavenRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MavenRequestPayload is not found in the empty JSON string", MavenRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MavenRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MavenRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MavenRequestPayload.openapiRequiredFields) {
      ...
      MavenRequestPayloadFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MavenRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MavenRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MavenRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MavenRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<MavenRequestPayload>() {
           @Override
           public void write(JsonWriter out, MavenRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MavenRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MavenRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MavenRequestPayload
   * @throws IOException if the JSON string is invalid with respect to MavenRequestPayload
   */
  public static MavenRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MavenRequestPayload.class);
  }

  /**
   * Convert an instance of MavenRequestPayload to an JSON string
   *
   * @return JSON string
   */
