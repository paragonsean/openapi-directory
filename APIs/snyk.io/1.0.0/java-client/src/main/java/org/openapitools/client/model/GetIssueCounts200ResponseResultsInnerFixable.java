...
public class GetIssueCounts200ResponseResultsInnerFixable {
  ...
  public GetIssueCounts200ResponseResultsInnerFixable() {
  }

  public GetIssueCounts200ResponseResultsInnerFixable false(BigDecimal false) {
    this.false = false;
    return this;
  }
  ...
  public GetIssueCounts200ResponseResultsInnerFixable true(BigDecimal true) {
    this.true = true;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCounts200ResponseResultsInnerFixable getIssueCounts200ResponseResultsInnerFixable = (GetIssueCounts200ResponseResultsInnerFixable) o;
    return Objects.equals(this.false, getIssueCounts200ResponseResultsInnerFixable.false) &&
        Objects.equals(this.true, getIssueCounts200ResponseResultsInnerFixable.true);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIssueCounts200ResponseResultsInnerFixable {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCounts200ResponseResultsInnerFixable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCounts200ResponseResultsInnerFixable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCounts200ResponseResultsInnerFixable is not found in the empty JSON string", GetIssueCounts200ResponseResultsInnerFixable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCounts200ResponseResultsInnerFixable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCounts200ResponseResultsInnerFixable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCounts200ResponseResultsInnerFixable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCounts200ResponseResultsInnerFixable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCounts200ResponseResultsInnerFixable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCounts200ResponseResultsInnerFixable.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCounts200ResponseResultsInnerFixable>() {
           @Override
           public void write(JsonWriter out, GetIssueCounts200ResponseResultsInnerFixable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCounts200ResponseResultsInnerFixable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCounts200ResponseResultsInnerFixable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCounts200ResponseResultsInnerFixable
   * @throws IOException if the JSON string is invalid with respect to GetIssueCounts200ResponseResultsInnerFixable
   */
  public static GetIssueCounts200ResponseResultsInnerFixable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCounts200ResponseResultsInnerFixable.class);
  }

  /**
   * Convert an instance of GetIssueCounts200ResponseResultsInnerFixable to an JSON string
   *
   * @return JSON string
   */
