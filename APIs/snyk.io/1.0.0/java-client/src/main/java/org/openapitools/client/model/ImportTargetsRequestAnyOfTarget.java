...
public class ImportTargetsRequestAnyOfTarget {
  ...
  public ImportTargetsRequestAnyOfTarget() {
  }

  public ImportTargetsRequestAnyOfTarget branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOfTarget name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOfTarget owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOfTarget importTargetsRequestAnyOfTarget = (ImportTargetsRequestAnyOfTarget) o;
    return Objects.equals(this.branch, importTargetsRequestAnyOfTarget.branch) &&
        Objects.equals(this.name, importTargetsRequestAnyOfTarget.name) &&
        Objects.equals(this.owner, importTargetsRequestAnyOfTarget.owner);
  }

  @Override
  public int hashCode() {
    return Objects.hash(branch, name, owner);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportTargetsRequestAnyOfTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOfTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOfTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOfTarget is not found in the empty JSON string", ImportTargetsRequestAnyOfTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOfTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOfTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOfTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOfTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOfTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOfTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOfTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOfTarget>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOfTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOfTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOfTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOfTarget
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOfTarget
   */
  public static ImportTargetsRequestAnyOfTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOfTarget.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOfTarget to an JSON string
   *
   * @return JSON string
   */
