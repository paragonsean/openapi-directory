...
import org.openapitools.client.model.TestGradleFileRequestFiles;
...
public class TestGradleFileRequest {
  /**
  ...
  private TestGradleFileRequestFiles files;

  public TestGradleFileRequest() {
  }

  public TestGradleFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestGradleFileRequest files(TestGradleFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestGradleFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestGradleFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestGradleFileRequest testGradleFileRequest = (TestGradleFileRequest) o;
    return Objects.equals(this.encoding, testGradleFileRequest.encoding) &&
        Objects.equals(this.files, testGradleFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGradleFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGradleFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGradleFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGradleFileRequest is not found in the empty JSON string", TestGradleFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGradleFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGradleFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestGradleFileRequest.openapiRequiredFields) {
      ...
      TestGradleFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGradleFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGradleFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGradleFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGradleFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGradleFileRequest>() {
           @Override
           public void write(JsonWriter out, TestGradleFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGradleFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGradleFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGradleFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestGradleFileRequest
   */
  public static TestGradleFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGradleFileRequest.class);
  }

  /**
   * Convert an instance of TestGradleFileRequest to an JSON string
   *
   * @return JSON string
   */
