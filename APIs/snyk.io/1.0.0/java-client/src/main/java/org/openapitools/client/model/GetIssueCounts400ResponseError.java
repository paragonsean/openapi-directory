...
public class GetIssueCounts400ResponseError {
  ...
  public GetIssueCounts400ResponseError() {
  }

  public GetIssueCounts400ResponseError innerErrors(List<Object> innerErrors) {
    this.innerErrors = innerErrors;
    return this;
  }

  public GetIssueCounts400ResponseError addInnerErrorsItem(Object innerErrorsItem) {
  ...
  public GetIssueCounts400ResponseError name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetIssueCounts400ResponseError getIssueCounts400ResponseError = (GetIssueCounts400ResponseError) o;
    return Objects.equals(this.innerErrors, getIssueCounts400ResponseError.innerErrors) &&
        Objects.equals(this.name, getIssueCounts400ResponseError.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(innerErrors, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetIssueCounts400ResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIssueCounts400ResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIssueCounts400ResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIssueCounts400ResponseError is not found in the empty JSON string", GetIssueCounts400ResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIssueCounts400ResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIssueCounts400ResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIssueCounts400ResponseError.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIssueCounts400ResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIssueCounts400ResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIssueCounts400ResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIssueCounts400ResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIssueCounts400ResponseError>() {
           @Override
           public void write(JsonWriter out, GetIssueCounts400ResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIssueCounts400ResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIssueCounts400ResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIssueCounts400ResponseError
   * @throws IOException if the JSON string is invalid with respect to GetIssueCounts400ResponseError
   */
  public static GetIssueCounts400ResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIssueCounts400ResponseError.class);
  }

  /**
   * Convert an instance of GetIssueCounts400ResponseError to an JSON string
   *
   * @return JSON string
   */
