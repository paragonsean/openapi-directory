...
import org.openapitools.client.model.FunctionId;
...
public class Function {
  ...
  public Function functionId(FunctionId functionId) {
  ...
  public Function version(List<Object> version) {
    this.version = version;
    return this;
  }

  public Function addVersionItem(Object versionItem) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("functionId") != null && !jsonObj.get("functionId").isJsonNull()) {
        FunctionId.validateJsonElement(jsonObj.get("functionId"));
      }
