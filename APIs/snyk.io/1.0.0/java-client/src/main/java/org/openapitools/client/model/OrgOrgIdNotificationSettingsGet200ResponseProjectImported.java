...
public class OrgOrgIdNotificationSettingsGet200ResponseProjectImported {
  ...
  public OrgOrgIdNotificationSettingsGet200ResponseProjectImported() {
  }

  public OrgOrgIdNotificationSettingsGet200ResponseProjectImported enabled(Boolean enabled) {
  ...
  public OrgOrgIdNotificationSettingsGet200ResponseProjectImported inherited(Boolean inherited) {
  ...
  public boolean equals(Object o) {
    ...
    OrgOrgIdNotificationSettingsGet200ResponseProjectImported orgOrgIdNotificationSettingsGet200ResponseProjectImported = (OrgOrgIdNotificationSettingsGet200ResponseProjectImported) o;
    return Objects.equals(this.enabled, orgOrgIdNotificationSettingsGet200ResponseProjectImported.enabled) &&
        Objects.equals(this.inherited, orgOrgIdNotificationSettingsGet200ResponseProjectImported.inherited);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgOrgIdNotificationSettingsGet200ResponseProjectImported {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgOrgIdNotificationSettingsGet200ResponseProjectImported
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgOrgIdNotificationSettingsGet200ResponseProjectImported.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgOrgIdNotificationSettingsGet200ResponseProjectImported is not found in the empty JSON string", OrgOrgIdNotificationSettingsGet200ResponseProjectImported.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgOrgIdNotificationSettingsGet200ResponseProjectImported.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrgOrgIdNotificationSettingsGet200ResponseProjectImported` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrgOrgIdNotificationSettingsGet200ResponseProjectImported.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgOrgIdNotificationSettingsGet200ResponseProjectImported.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgOrgIdNotificationSettingsGet200ResponseProjectImported' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgOrgIdNotificationSettingsGet200ResponseProjectImported> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgOrgIdNotificationSettingsGet200ResponseProjectImported.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgOrgIdNotificationSettingsGet200ResponseProjectImported>() {
           @Override
           public void write(JsonWriter out, OrgOrgIdNotificationSettingsGet200ResponseProjectImported value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgOrgIdNotificationSettingsGet200ResponseProjectImported read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgOrgIdNotificationSettingsGet200ResponseProjectImported given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgOrgIdNotificationSettingsGet200ResponseProjectImported
   * @throws IOException if the JSON string is invalid with respect to OrgOrgIdNotificationSettingsGet200ResponseProjectImported
   */
  public static OrgOrgIdNotificationSettingsGet200ResponseProjectImported fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgOrgIdNotificationSettingsGet200ResponseProjectImported.class);
  }

  /**
   * Convert an instance of OrgOrgIdNotificationSettingsGet200ResponseProjectImported to an JSON string
   *
   * @return JSON string
   */
