...
public class ImportTargetsRequestAnyOf9Target {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public ImportTargetsRequestAnyOf9Target() {
  }

  public ImportTargetsRequestAnyOf9Target name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf9Target importTargetsRequestAnyOf9Target = (ImportTargetsRequestAnyOf9Target) o;
    return Objects.equals(this.name, importTargetsRequestAnyOf9Target.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf9Target {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf9Target
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf9Target.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf9Target is not found in the empty JSON string", ImportTargetsRequestAnyOf9Target.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf9Target.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf9Target` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportTargetsRequestAnyOf9Target.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf9Target.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf9Target' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf9Target> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf9Target.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf9Target>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf9Target value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf9Target read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf9Target given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf9Target
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf9Target
   */
  public static ImportTargetsRequestAnyOf9Target fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf9Target.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf9Target to an JSON string
   *
   * @return JSON string
   */
