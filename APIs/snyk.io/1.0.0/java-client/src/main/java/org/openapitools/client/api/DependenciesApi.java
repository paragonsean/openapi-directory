...
import org.openapitools.client.model.ListAllDependencies200Response;
import org.openapitools.client.model.ListAllDependenciesRequest;
...
public class DependenciesApi {
    ...
    /**
     * Build call for listAllDependencies
     * @param orgId The organization ID to list projects for. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param sortBy The field to sort results by. (optional, default to dependency)
     * @param order The direction to sort results by. (optional, default to asc)
     * @param page The page of results to fetch. (optional, default to 1)
     * @param perPage The number of results to fetch per page (maximum is 1000). (optional, default to 20)
     * @param listAllDependenciesRequest  (optional)
     ...
     */
    public okhttp3.Call listAllDependenciesCall(String orgId, String sortBy, String order, BigDecimal page, BigDecimal perPage, ListAllDependenciesRequest listAllDependenciesRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = listAllDependenciesRequest;

        // create path and map variables
        String localVarPath = "/org/{orgId}/dependencies"
    ...
    private okhttp3.Call listAllDependenciesValidateBeforeCall(String orgId, String sortBy, String order, BigDecimal page, BigDecimal perPage, ListAllDependenciesRequest listAllDependenciesRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling listAllDependencies(Async)");
        }

        return listAllDependenciesCall(orgId, sortBy, order, page, perPage, listAllDependenciesRequest, _callback);
     ...
     * @param perPage The number of results to fetch per page (maximum is 1000). (optional, default to 20)
     * @param listAllDependenciesRequest  (optional)
     * @return ListAllDependencies200Response
     ...
     */
    public ListAllDependencies200Response listAllDependencies(String orgId, String sortBy, String order, BigDecimal page, BigDecimal perPage, ListAllDependenciesRequest listAllDependenciesRequest) throws ApiException {
        ApiResponse<ListAllDependencies200Response> localVarResp = listAllDependenciesWithHttpInfo(orgId, sortBy, order, page, perPage, listAllDependenciesRequest);
     ...
     * @param perPage The number of results to fetch per page (maximum is 1000). (optional, default to 20)
     * @param listAllDependenciesRequest  (optional)
     * @return ApiResponse&lt;ListAllDependencies200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListAllDependencies200Response> listAllDependenciesWithHttpInfo(String orgId, String sortBy, String order, BigDecimal page, BigDecimal perPage, ListAllDependenciesRequest listAllDependenciesRequest) throws ApiException {
        okhttp3.Call localVarCall = listAllDependenciesValidateBeforeCall(orgId, sortBy, order, page, perPage, listAllDependenciesRequest, null);
        Type localVarReturnType = new TypeToken<ListAllDependencies200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List all dependencies (asynchronously)
     * 
     * @param orgId The organization ID to list projects for. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param sortBy The field to sort results by. (optional, default to dependency)
     * @param order The direction to sort results by. (optional, default to asc)
     ...
     */
    public okhttp3.Call listAllDependenciesAsync(String orgId, String sortBy, String order, BigDecimal page, BigDecimal perPage, ListAllDependenciesRequest listAllDependenciesRequest, final ApiCallback<ListAllDependencies200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllDependenciesValidateBeforeCall(orgId, sortBy, order, page, perPage, listAllDependenciesRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAllDependencies200Response>(){}.getType();
