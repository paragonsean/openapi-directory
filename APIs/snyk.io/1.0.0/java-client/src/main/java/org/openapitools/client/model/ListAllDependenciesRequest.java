...
import org.openapitools.client.model.ListAllDependenciesRequestFilters;
...
public class ListAllDependenciesRequest {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private ListAllDependenciesRequestFilters filters;

  public ListAllDependenciesRequest() {
  }

  public ListAllDependenciesRequest filters(ListAllDependenciesRequestFilters filters) {
  ...
  public ListAllDependenciesRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(ListAllDependenciesRequestFilters filters) {
    this.filters = filters;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllDependenciesRequest listAllDependenciesRequest = (ListAllDependenciesRequest) o;
    return Objects.equals(this.filters, listAllDependenciesRequest.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllDependenciesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllDependenciesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllDependenciesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllDependenciesRequest is not found in the empty JSON string", ListAllDependenciesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllDependenciesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllDependenciesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ListAllDependenciesRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllDependenciesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllDependenciesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllDependenciesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllDependenciesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllDependenciesRequest>() {
           @Override
           public void write(JsonWriter out, ListAllDependenciesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllDependenciesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllDependenciesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllDependenciesRequest
   * @throws IOException if the JSON string is invalid with respect to ListAllDependenciesRequest
   */
  public static ListAllDependenciesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllDependenciesRequest.class);
  }

  /**
   * Convert an instance of ListAllDependenciesRequest to an JSON string
   *
   * @return JSON string
   */
