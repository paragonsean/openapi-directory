...
import org.openapitools.client.model.GetIssueCounts200ResponseResultsInner;
...
public class IssueCounts {
  ...
  private List<GetIssueCounts200ResponseResultsInner> results = new ArrayList<>();

  public IssueCounts() {
  }

  public IssueCounts results(List<GetIssueCounts200ResponseResultsInner> results) {
    this.results = results;
    return this;
  }

  public IssueCounts addResultsItem(GetIssueCounts200ResponseResultsInner resultsItem) {
  ...
  public List<GetIssueCounts200ResponseResultsInner> getResults() {
    return results;
  }

  public void setResults(List<GetIssueCounts200ResponseResultsInner> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    IssueCounts issueCounts = (IssueCounts) o;
    return Objects.equals(this.results, issueCounts.results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueCounts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueCounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssueCounts is not found in the empty JSON string", IssueCounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueCounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssueCounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IssueCounts.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        GetIssueCounts200ResponseResultsInner.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssueCounts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssueCounts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssueCounts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssueCounts.class));

       return (TypeAdapter<T>) new TypeAdapter<IssueCounts>() {
           @Override
           public void write(JsonWriter out, IssueCounts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssueCounts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssueCounts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssueCounts
   * @throws IOException if the JSON string is invalid with respect to IssueCounts
   */
  public static IssueCounts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssueCounts.class);
  }

  /**
   * Convert an instance of IssueCounts to an JSON string
   *
   * @return JSON string
   */
