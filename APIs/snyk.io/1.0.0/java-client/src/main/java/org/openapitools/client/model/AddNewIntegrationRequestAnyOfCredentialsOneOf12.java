...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf12GitLabCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf12 {
  public static final String SERIALIZED_NAME_GIT_LAB_CREDENTIALS = "GitLabCredentials";
  @SerializedName(SERIALIZED_NAME_GIT_LAB_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf12GitLabCredentials gitLabCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf12() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf12 gitLabCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf12GitLabCredentials gitLabCredentials) {
    this.gitLabCredentials = gitLabCredentials;
    return this;
  }

  /**
   * Get gitLabCredentials
   * @return gitLabCredentials
   */
  @javax.annotation.Nullable
  public AddNewIntegrationRequestAnyOfCredentialsOneOf12GitLabCredentials getGitLabCredentials() {
    return gitLabCredentials;
  }

  public void setGitLabCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf12GitLabCredentials gitLabCredentials) {
    this.gitLabCredentials = gitLabCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf12 addNewIntegrationRequestAnyOfCredentialsOneOf12 = (AddNewIntegrationRequestAnyOfCredentialsOneOf12) o;
    return Objects.equals(this.gitLabCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf12.gitLabCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gitLabCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf12 {\n");
    sb.append("    gitLabCredentials: ").append(toIndentedString(gitLabCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("GitLabCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf12
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf12.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf12 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf12.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf12.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf12` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GitLabCredentials`
      if (jsonObj.get("GitLabCredentials") != null && !jsonObj.get("GitLabCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf12GitLabCredentials.validateJsonElement(jsonObj.get("GitLabCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf12.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf12>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf12 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf12 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf12 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf12
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf12
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf12.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf12 to an JSON string
   *
   * @return JSON string
   */
