...
public class AddNewIntegrationRequestAnyOf1Broker {
  public static final String SERIALIZED_NAME_ENABLED = "enabled";
  @SerializedName(SERIALIZED_NAME_ENABLED)
  private Boolean enabled;

  public AddNewIntegrationRequestAnyOf1Broker() {
  }

  public AddNewIntegrationRequestAnyOf1Broker enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOf1Broker addNewIntegrationRequestAnyOf1Broker = (AddNewIntegrationRequestAnyOf1Broker) o;
    return Objects.equals(this.enabled, addNewIntegrationRequestAnyOf1Broker.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOf1Broker {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOf1Broker
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOf1Broker.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOf1Broker is not found in the empty JSON string", AddNewIntegrationRequestAnyOf1Broker.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOf1Broker.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOf1Broker` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOf1Broker.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOf1Broker' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOf1Broker> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOf1Broker.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOf1Broker>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOf1Broker value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOf1Broker read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOf1Broker given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOf1Broker
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOf1Broker
   */
  public static AddNewIntegrationRequestAnyOf1Broker fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOf1Broker.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOf1Broker to an JSON string
   *
   * @return JSON string
   */
