...
import org.openapitools.client.model.UpdateExistingIntegrationRequestAnyOf;
import org.openapitools.client.model.UpdateExistingIntegrationRequestAnyOf1;
import org.openapitools.client.model.UpdateExistingIntegrationRequestAnyOf2;
...
public class UpdateExistingIntegrationRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateExistingIntegrationRequest.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateExistingIntegrationRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateExistingIntegrationRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UpdateExistingIntegrationRequestAnyOf> adapterUpdateExistingIntegrationRequestAnyOf = gson.getDelegateAdapter(this, TypeToken.get(UpdateExistingIntegrationRequestAnyOf.class));
            final TypeAdapter<UpdateExistingIntegrationRequestAnyOf1> adapterUpdateExistingIntegrationRequestAnyOf1 = gson.getDelegateAdapter(this, TypeToken.get(UpdateExistingIntegrationRequestAnyOf1.class));
            final TypeAdapter<UpdateExistingIntegrationRequestAnyOf2> adapterUpdateExistingIntegrationRequestAnyOf2 = gson.getDelegateAdapter(this, TypeToken.get(UpdateExistingIntegrationRequestAnyOf2.class));

            return (TypeAdapter<T>) new TypeAdapter<UpdateExistingIntegrationRequest>() {
                @Override
                public void write(JsonWriter out, UpdateExistingIntegrationRequest value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `UpdateExistingIntegrationRequestAnyOf`
                    if (value.getActualInstance() instanceof UpdateExistingIntegrationRequestAnyOf) {
                        JsonElement element = adapterUpdateExistingIntegrationRequestAnyOf.toJsonTree((UpdateExistingIntegrationRequestAnyOf)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `UpdateExistingIntegrationRequestAnyOf1`
                    if (value.getActualInstance() instanceof UpdateExistingIntegrationRequestAnyOf1) {
                        JsonElement element = adapterUpdateExistingIntegrationRequestAnyOf1.toJsonTree((UpdateExistingIntegrationRequestAnyOf1)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `UpdateExistingIntegrationRequestAnyOf2`
                    if (value.getActualInstance() instanceof UpdateExistingIntegrationRequestAnyOf2) {
                        JsonElement element = adapterUpdateExistingIntegrationRequestAnyOf2.toJsonTree((UpdateExistingIntegrationRequestAnyOf2)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: UpdateExistingIntegrationRequestAnyOf, UpdateExistingIntegrationRequestAnyOf1, UpdateExistingIntegrationRequestAnyOf2");
                }

                @Override
                public UpdateExistingIntegrationRequest read(JsonReader in) throws IOException {
                    ...
                    // deserialize UpdateExistingIntegrationRequestAnyOf
                    try {
                        // validate the JSON object to see if any exception is thrown
                        UpdateExistingIntegrationRequestAnyOf.validateJsonElement(jsonElement);
                        actualAdapter = adapterUpdateExistingIntegrationRequestAnyOf;
                        UpdateExistingIntegrationRequest ret = new UpdateExistingIntegrationRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for UpdateExistingIntegrationRequestAnyOf failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'UpdateExistingIntegrationRequestAnyOf'", e);
                    }
                    // deserialize UpdateExistingIntegrationRequestAnyOf1
                    try {
                        // validate the JSON object to see if any exception is thrown
                        UpdateExistingIntegrationRequestAnyOf1.validateJsonElement(jsonElement);
                        actualAdapter = adapterUpdateExistingIntegrationRequestAnyOf1;
                        UpdateExistingIntegrationRequest ret = new UpdateExistingIntegrationRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for UpdateExistingIntegrationRequestAnyOf1 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'UpdateExistingIntegrationRequestAnyOf1'", e);
                    }
                    // deserialize UpdateExistingIntegrationRequestAnyOf2
                    try {
                        // validate the JSON object to see if any exception is thrown
                        UpdateExistingIntegrationRequestAnyOf2.validateJsonElement(jsonElement);
                        actualAdapter = adapterUpdateExistingIntegrationRequestAnyOf2;
                        UpdateExistingIntegrationRequest ret = new UpdateExistingIntegrationRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for UpdateExistingIntegrationRequestAnyOf2 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'UpdateExistingIntegrationRequestAnyOf2'", e);
                    }

                    throw new IOException(String.format("Failed deserialization for UpdateExistingIntegrationRequest: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateExistingIntegrationRequest() {
        super("anyOf", Boolean.FALSE);
    }

    public UpdateExistingIntegrationRequest(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("UpdateExistingIntegrationRequestAnyOf", UpdateExistingIntegrationRequestAnyOf.class);
        schemas.put("UpdateExistingIntegrationRequestAnyOf1", UpdateExistingIntegrationRequestAnyOf1.class);
        schemas.put("UpdateExistingIntegrationRequestAnyOf2", UpdateExistingIntegrationRequestAnyOf2.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return UpdateExistingIntegrationRequest.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * UpdateExistingIntegrationRequestAnyOf, UpdateExistingIntegrationRequestAnyOf1, UpdateExistingIntegrationRequestAnyOf2
     *
     * It could be an instance of the 'anyOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof UpdateExistingIntegrationRequestAnyOf) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof UpdateExistingIntegrationRequestAnyOf1) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof UpdateExistingIntegrationRequestAnyOf2) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be UpdateExistingIntegrationRequestAnyOf, UpdateExistingIntegrationRequestAnyOf1, UpdateExistingIntegrationRequestAnyOf2");
    }
     ...
     * UpdateExistingIntegrationRequestAnyOf, UpdateExistingIntegrationRequestAnyOf1, UpdateExistingIntegrationRequestAnyOf2
     *
     * @return The actual instance (UpdateExistingIntegrationRequestAnyOf, UpdateExistingIntegrationRequestAnyOf1, UpdateExistingIntegrationRequestAnyOf2)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `UpdateExistingIntegrationRequestAnyOf`. If the actual instance is not `UpdateExistingIntegrationRequestAnyOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UpdateExistingIntegrationRequestAnyOf`
     * @throws ClassCastException if the instance is not `UpdateExistingIntegrationRequestAnyOf`
     */
    public UpdateExistingIntegrationRequestAnyOf getUpdateExistingIntegrationRequestAnyOf() throws ClassCastException {
        return (UpdateExistingIntegrationRequestAnyOf)super.getActualInstance();
    }
    /**
     * Get the actual instance of `UpdateExistingIntegrationRequestAnyOf1`. If the actual instance is not `UpdateExistingIntegrationRequestAnyOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UpdateExistingIntegrationRequestAnyOf1`
     * @throws ClassCastException if the instance is not `UpdateExistingIntegrationRequestAnyOf1`
     */
    public UpdateExistingIntegrationRequestAnyOf1 getUpdateExistingIntegrationRequestAnyOf1() throws ClassCastException {
        return (UpdateExistingIntegrationRequestAnyOf1)super.getActualInstance();
    }
    /**
     * Get the actual instance of `UpdateExistingIntegrationRequestAnyOf2`. If the actual instance is not `UpdateExistingIntegrationRequestAnyOf2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UpdateExistingIntegrationRequestAnyOf2`
     * @throws ClassCastException if the instance is not `UpdateExistingIntegrationRequestAnyOf2`
     */
    public UpdateExistingIntegrationRequestAnyOf2 getUpdateExistingIntegrationRequestAnyOf2() throws ClassCastException {
        return (UpdateExistingIntegrationRequestAnyOf2)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateExistingIntegrationRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate anyOf schemas one by one
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with UpdateExistingIntegrationRequestAnyOf
        try {
            UpdateExistingIntegrationRequestAnyOf.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with UpdateExistingIntegrationRequestAnyOf1
        try {
            UpdateExistingIntegrationRequestAnyOf1.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        // validate the json string with UpdateExistingIntegrationRequestAnyOf2
        try {
            UpdateExistingIntegrationRequestAnyOf2.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        throw new IOException(String.format("The JSON string is invalid for UpdateExistingIntegrationRequest with anyOf schemas: UpdateExistingIntegrationRequestAnyOf, UpdateExistingIntegrationRequestAnyOf1, UpdateExistingIntegrationRequestAnyOf2. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateExistingIntegrationRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateExistingIntegrationRequest
     * @throws IOException if the JSON string is invalid with respect to UpdateExistingIntegrationRequest
     */
    public static UpdateExistingIntegrationRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateExistingIntegrationRequest.class);
    }

    /**
     * Convert an instance of UpdateExistingIntegrationRequest to an JSON string
     *
     * @return JSON string
     */
