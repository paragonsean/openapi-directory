...
import org.openapitools.client.model.ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense;
...
public class ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts {
  public static final String SERIALIZED_NAME_LICENSE = "license";
  @SerializedName(SERIALIZED_NAME_LICENSE)
  private ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense license;

  public static final String SERIALIZED_NAME_SAST = "sast";
  @SerializedName(SERIALIZED_NAME_SAST)
  private ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense sast;

  public static final String SERIALIZED_NAME_VULN = "vuln";
  @SerializedName(SERIALIZED_NAME_VULN)
  private ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense vuln;

  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts() {
  }

  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts license(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense license) {
  ...
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense getLicense() {
    return license;
  }

  public void setLicense(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense license) {
    this.license = license;
  }


  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts sast(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense sast) {
    this.sast = sast;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense getSast() {
    return sast;
  }

  public void setSast(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense sast) {
    this.sast = sast;
  }


  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts vuln(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense vuln) {
    this.vuln = vuln;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense getVuln() {
    return vuln;
  }

  public void setVuln(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense vuln) {
    this.vuln = vuln;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts listAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts = (ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts) o;
    return Objects.equals(this.license, listAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.license) &&
        Objects.equals(this.sast, listAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.sast) &&
        Objects.equals(this.vuln, listAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.vuln);
  }

  @Override
  public int hashCode() {
    return Objects.hash(license, sast, vuln);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts {\n");
    sb.append("    license: ").append(toIndentedString(license)).append("\n");
    sb.append("    sast: ").append(toIndentedString(sast)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts is not found in the empty JSON string", ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `license`
      if (jsonObj.get("license") != null && !jsonObj.get("license").isJsonNull()) {
        ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.validateJsonElement(jsonObj.get("license"));
      }
      // validate the optional field `sast`
      if (jsonObj.get("sast") != null && !jsonObj.get("sast").isJsonNull()) {
        ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.validateJsonElement(jsonObj.get("sast"));
      }
      // validate the optional field `vuln`
      if (jsonObj.get("vuln") != null && !jsonObj.get("vuln").isJsonNull()) {
        ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCountsLicense.validateJsonElement(jsonObj.get("vuln"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts>() {
           @Override
           public void write(JsonWriter out, ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts
   */
  public static ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.class);
  }

  /**
   * Convert an instance of ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts to an JSON string
   *
   * @return JSON string
   */
