...
public class IgnoreIgnorePathIgnoredBy {
  ...
  public IgnoreIgnorePathIgnoredBy() {
  }

  public IgnoreIgnorePathIgnoredBy email(String email) {
    this.email = email;
    return this;
  }
  ...
  public IgnoreIgnorePathIgnoredBy id(String id) {
    this.id = id;
    return this;
  }
  ...
  public IgnoreIgnorePathIgnoredBy name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IgnoreIgnorePathIgnoredBy ignoreIgnorePathIgnoredBy = (IgnoreIgnorePathIgnoredBy) o;
    return Objects.equals(this.email, ignoreIgnorePathIgnoredBy.email) &&
        Objects.equals(this.id, ignoreIgnorePathIgnoredBy.id) &&
        Objects.equals(this.name, ignoreIgnorePathIgnoredBy.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class IgnoreIgnorePathIgnoredBy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IgnoreIgnorePathIgnoredBy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IgnoreIgnorePathIgnoredBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IgnoreIgnorePathIgnoredBy is not found in the empty JSON string", IgnoreIgnorePathIgnoredBy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IgnoreIgnorePathIgnoredBy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IgnoreIgnorePathIgnoredBy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IgnoreIgnorePathIgnoredBy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IgnoreIgnorePathIgnoredBy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IgnoreIgnorePathIgnoredBy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IgnoreIgnorePathIgnoredBy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IgnoreIgnorePathIgnoredBy.class));

       return (TypeAdapter<T>) new TypeAdapter<IgnoreIgnorePathIgnoredBy>() {
           @Override
           public void write(JsonWriter out, IgnoreIgnorePathIgnoredBy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IgnoreIgnorePathIgnoredBy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IgnoreIgnorePathIgnoredBy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IgnoreIgnorePathIgnoredBy
   * @throws IOException if the JSON string is invalid with respect to IgnoreIgnorePathIgnoredBy
   */
  public static IgnoreIgnorePathIgnoredBy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IgnoreIgnorePathIgnoredBy.class);
  }

  /**
   * Convert an instance of IgnoreIgnorePathIgnoredBy to an JSON string
   *
   * @return JSON string
   */
