...
public class RetrieveASingleProject200ResponseRemediation {
  ...
  public RetrieveASingleProject200ResponseRemediation() {
  }

  public RetrieveASingleProject200ResponseRemediation patch(Object patch) {
    this.patch = patch;
    return this;
  }
  ...
  public RetrieveASingleProject200ResponseRemediation pin(Object pin) {
    this.pin = pin;
    return this;
  }
  ...
  public RetrieveASingleProject200ResponseRemediation upgrade(Object upgrade) {
  ...
  public boolean equals(Object o) {
    ...
    RetrieveASingleProject200ResponseRemediation retrieveASingleProject200ResponseRemediation = (RetrieveASingleProject200ResponseRemediation) o;
    return Objects.equals(this.patch, retrieveASingleProject200ResponseRemediation.patch) &&
        Objects.equals(this.pin, retrieveASingleProject200ResponseRemediation.pin) &&
        Objects.equals(this.upgrade, retrieveASingleProject200ResponseRemediation.upgrade);
  }

  @Override
  public int hashCode() {
    return Objects.hash(patch, pin, upgrade);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RetrieveASingleProject200ResponseRemediation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveASingleProject200ResponseRemediation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveASingleProject200ResponseRemediation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveASingleProject200ResponseRemediation is not found in the empty JSON string", RetrieveASingleProject200ResponseRemediation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveASingleProject200ResponseRemediation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveASingleProject200ResponseRemediation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveASingleProject200ResponseRemediation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveASingleProject200ResponseRemediation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveASingleProject200ResponseRemediation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveASingleProject200ResponseRemediation.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveASingleProject200ResponseRemediation>() {
           @Override
           public void write(JsonWriter out, RetrieveASingleProject200ResponseRemediation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveASingleProject200ResponseRemediation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveASingleProject200ResponseRemediation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveASingleProject200ResponseRemediation
   * @throws IOException if the JSON string is invalid with respect to RetrieveASingleProject200ResponseRemediation
   */
  public static RetrieveASingleProject200ResponseRemediation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveASingleProject200ResponseRemediation.class);
  }

  /**
   * Convert an instance of RetrieveASingleProject200ResponseRemediation to an JSON string
   *
   * @return JSON string
   */
