...
public class ImportTargetsRequestAnyOf9 {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private ImportTargetsRequestAnyOf9Target target;

  public ImportTargetsRequestAnyOf9() {
  }

  public ImportTargetsRequestAnyOf9 target(ImportTargetsRequestAnyOf9Target target) {
    this.target = target;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf9Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf9Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf9 importTargetsRequestAnyOf9 = (ImportTargetsRequestAnyOf9) o;
    return Objects.equals(this.target, importTargetsRequestAnyOf9.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf9 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf9
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf9.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf9 is not found in the empty JSON string", ImportTargetsRequestAnyOf9.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf9.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf9` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `target`
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf9Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf9.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf9>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf9 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf9 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf9 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf9
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf9
   */
  public static ImportTargetsRequestAnyOf9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf9.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf9 to an JSON string
   *
   * @return JSON string
   */
