...
public class CloneAnIntegrationWithSettingsAndCredentialsRequest {
  public static final String SERIALIZED_NAME_DESTINATION_ORG_PUBLIC_ID = "destinationOrgPublicId";
  @SerializedName(SERIALIZED_NAME_DESTINATION_ORG_PUBLIC_ID)
  private String destinationOrgPublicId;

  public CloneAnIntegrationWithSettingsAndCredentialsRequest() {
  }

  public CloneAnIntegrationWithSettingsAndCredentialsRequest destinationOrgPublicId(String destinationOrgPublicId) {
    this.destinationOrgPublicId = destinationOrgPublicId;
    return this;
  }

  /**
   * The organization public ID. The &#x60;API_KEY&#x60; must have access to this organization.
   * @return destinationOrgPublicId
   */
  @javax.annotation.Nonnull
  public String getDestinationOrgPublicId() {
    return destinationOrgPublicId;
  }

  public void setDestinationOrgPublicId(String destinationOrgPublicId) {
    this.destinationOrgPublicId = destinationOrgPublicId;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloneAnIntegrationWithSettingsAndCredentialsRequest cloneAnIntegrationWithSettingsAndCredentialsRequest = (CloneAnIntegrationWithSettingsAndCredentialsRequest) o;
    return Objects.equals(this.destinationOrgPublicId, cloneAnIntegrationWithSettingsAndCredentialsRequest.destinationOrgPublicId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(destinationOrgPublicId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CloneAnIntegrationWithSettingsAndCredentialsRequest {\n");
    sb.append("    destinationOrgPublicId: ").append(toIndentedString(destinationOrgPublicId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("destinationOrgPublicId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("destinationOrgPublicId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloneAnIntegrationWithSettingsAndCredentialsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloneAnIntegrationWithSettingsAndCredentialsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloneAnIntegrationWithSettingsAndCredentialsRequest is not found in the empty JSON string", CloneAnIntegrationWithSettingsAndCredentialsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloneAnIntegrationWithSettingsAndCredentialsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloneAnIntegrationWithSettingsAndCredentialsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloneAnIntegrationWithSettingsAndCredentialsRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("destinationOrgPublicId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `destinationOrgPublicId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("destinationOrgPublicId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloneAnIntegrationWithSettingsAndCredentialsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloneAnIntegrationWithSettingsAndCredentialsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloneAnIntegrationWithSettingsAndCredentialsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloneAnIntegrationWithSettingsAndCredentialsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CloneAnIntegrationWithSettingsAndCredentialsRequest>() {
           @Override
           public void write(JsonWriter out, CloneAnIntegrationWithSettingsAndCredentialsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloneAnIntegrationWithSettingsAndCredentialsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloneAnIntegrationWithSettingsAndCredentialsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloneAnIntegrationWithSettingsAndCredentialsRequest
   * @throws IOException if the JSON string is invalid with respect to CloneAnIntegrationWithSettingsAndCredentialsRequest
   */
  public static CloneAnIntegrationWithSettingsAndCredentialsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloneAnIntegrationWithSettingsAndCredentialsRequest.class);
  }

  /**
   * Convert an instance of CloneAnIntegrationWithSettingsAndCredentialsRequest to an JSON string
   *
   * @return JSON string
   */
