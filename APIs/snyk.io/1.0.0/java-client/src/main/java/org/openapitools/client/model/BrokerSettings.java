...
public class BrokerSettings {
  ...
  public BrokerSettings enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    BrokerSettings brokerSettings = (BrokerSettings) o;
    return Objects.equals(this.enabled, brokerSettings.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrokerSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BrokerSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BrokerSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BrokerSettings is not found in the empty JSON string", BrokerSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BrokerSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BrokerSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BrokerSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BrokerSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BrokerSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BrokerSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<BrokerSettings>() {
           @Override
           public void write(JsonWriter out, BrokerSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BrokerSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BrokerSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BrokerSettings
   * @throws IOException if the JSON string is invalid with respect to BrokerSettings
   */
  public static BrokerSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BrokerSettings.class);
  }

  /**
   * Convert an instance of BrokerSettings to an JSON string
   *
   * @return JSON string
   */
