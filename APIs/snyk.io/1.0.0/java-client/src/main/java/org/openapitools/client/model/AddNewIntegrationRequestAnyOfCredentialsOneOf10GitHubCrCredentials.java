...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials password(String password) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials registryBase(String registryBase) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials addNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials = (AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials) o;
    return Objects.equals(this.password, addNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.password) &&
        Objects.equals(this.registryBase, addNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.registryBase) &&
        Objects.equals(this.username, addNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.username);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf10GitHubCrCredentials to an JSON string
   *
   * @return JSON string
   */
