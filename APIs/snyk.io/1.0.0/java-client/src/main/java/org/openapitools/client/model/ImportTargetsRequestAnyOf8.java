...
import org.openapitools.client.model.ImportTargetsRequestAnyOf8Target;
...
public class ImportTargetsRequestAnyOf8 {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private ImportTargetsRequestAnyOf8Target target;

  public ImportTargetsRequestAnyOf8() {
  }

  public ImportTargetsRequestAnyOf8 target(ImportTargetsRequestAnyOf8Target target) {
    this.target = target;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf8Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf8Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf8 importTargetsRequestAnyOf8 = (ImportTargetsRequestAnyOf8) o;
    return Objects.equals(this.target, importTargetsRequestAnyOf8.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf8 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf8
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf8.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf8 is not found in the empty JSON string", ImportTargetsRequestAnyOf8.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf8.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf8` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `target`
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf8Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf8.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf8>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf8 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf8 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf8 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf8
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf8
   */
  public static ImportTargetsRequestAnyOf8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf8.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf8 to an JSON string
   *
   * @return JSON string
   */
