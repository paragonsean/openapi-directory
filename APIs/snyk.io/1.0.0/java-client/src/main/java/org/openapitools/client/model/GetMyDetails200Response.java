...
public class GetMyDetails200Response {
  ...
  public GetMyDetails200Response() {
  }

  public GetMyDetails200Response email(String email) {
    this.email = email;
    return this;
  }
  ...
  public GetMyDetails200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetMyDetails200Response orgs(Object orgs) {
    this.orgs = orgs;
    return this;
  }
  ...
  public GetMyDetails200Response username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    GetMyDetails200Response getMyDetails200Response = (GetMyDetails200Response) o;
    return Objects.equals(this.email, getMyDetails200Response.email) &&
        Objects.equals(this.id, getMyDetails200Response.id) &&
        Objects.equals(this.orgs, getMyDetails200Response.orgs) &&
        Objects.equals(this.username, getMyDetails200Response.username);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, id, orgs, username);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMyDetails200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMyDetails200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMyDetails200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMyDetails200Response is not found in the empty JSON string", GetMyDetails200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMyDetails200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMyDetails200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMyDetails200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMyDetails200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMyDetails200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMyDetails200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMyDetails200Response>() {
           @Override
           public void write(JsonWriter out, GetMyDetails200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMyDetails200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMyDetails200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMyDetails200Response
   * @throws IOException if the JSON string is invalid with respect to GetMyDetails200Response
   */
  public static GetMyDetails200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMyDetails200Response.class);
  }

  /**
   * Convert an instance of GetMyDetails200Response to an JSON string
   *
   * @return JSON string
   */
