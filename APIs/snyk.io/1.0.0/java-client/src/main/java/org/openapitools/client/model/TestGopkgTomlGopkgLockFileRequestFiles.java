...
import org.openapitools.client.model.TestGopkgTomlGopkgLockFileRequestFilesTarget;
...
public class TestGopkgTomlGopkgLockFileRequestFiles {
  ...
  private TestGopkgTomlGopkgLockFileRequestFilesTarget target;

  public TestGopkgTomlGopkgLockFileRequestFiles() {
  }

  public TestGopkgTomlGopkgLockFileRequestFiles additional(List<Object> additional) {
    this.additional = additional;
    return this;
  }

  public TestGopkgTomlGopkgLockFileRequestFiles addAdditionalItem(Object additionalItem) {
  ...
  public TestGopkgTomlGopkgLockFileRequestFiles target(TestGopkgTomlGopkgLockFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public TestGopkgTomlGopkgLockFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestGopkgTomlGopkgLockFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestGopkgTomlGopkgLockFileRequestFiles testGopkgTomlGopkgLockFileRequestFiles = (TestGopkgTomlGopkgLockFileRequestFiles) o;
    return Objects.equals(this.additional, testGopkgTomlGopkgLockFileRequestFiles.additional) &&
        Objects.equals(this.target, testGopkgTomlGopkgLockFileRequestFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGopkgTomlGopkgLockFileRequestFiles {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("additional");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGopkgTomlGopkgLockFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGopkgTomlGopkgLockFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGopkgTomlGopkgLockFileRequestFiles is not found in the empty JSON string", TestGopkgTomlGopkgLockFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGopkgTomlGopkgLockFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGopkgTomlGopkgLockFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestGopkgTomlGopkgLockFileRequestFiles.openapiRequiredFields) {
      ...
      if (jsonObj.get("additional") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("additional").isJsonArray()) {
      ...
      TestGopkgTomlGopkgLockFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGopkgTomlGopkgLockFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGopkgTomlGopkgLockFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGopkgTomlGopkgLockFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGopkgTomlGopkgLockFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGopkgTomlGopkgLockFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestGopkgTomlGopkgLockFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGopkgTomlGopkgLockFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGopkgTomlGopkgLockFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGopkgTomlGopkgLockFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestGopkgTomlGopkgLockFileRequestFiles
   */
  public static TestGopkgTomlGopkgLockFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGopkgTomlGopkgLockFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestGopkgTomlGopkgLockFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
