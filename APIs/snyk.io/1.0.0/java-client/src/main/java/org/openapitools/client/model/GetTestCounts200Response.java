...
import org.openapitools.client.model.GetTestCounts200ResponseResultsInner;
...
public class GetTestCounts200Response {
  public static final String SERIALIZED_NAME_RESULTS = "results";
  @SerializedName(SERIALIZED_NAME_RESULTS)
  private List<GetTestCounts200ResponseResultsInner> results = new ArrayList<>();

  public GetTestCounts200Response() {
  }

  public GetTestCounts200Response results(List<GetTestCounts200ResponseResultsInner> results) {
    this.results = results;
    return this;
  }

  public GetTestCounts200Response addResultsItem(GetTestCounts200ResponseResultsInner resultsItem) {
  ...
  public List<GetTestCounts200ResponseResultsInner> getResults() {
    return results;
  }

  public void setResults(List<GetTestCounts200ResponseResultsInner> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTestCounts200Response getTestCounts200Response = (GetTestCounts200Response) o;
    return Objects.equals(this.results, getTestCounts200Response.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTestCounts200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTestCounts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTestCounts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTestCounts200Response is not found in the empty JSON string", GetTestCounts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTestCounts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTestCounts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTestCounts200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        GetTestCounts200ResponseResultsInner.validateJsonElement(jsonArrayresults.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTestCounts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTestCounts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTestCounts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTestCounts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTestCounts200Response>() {
           @Override
           public void write(JsonWriter out, GetTestCounts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTestCounts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTestCounts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTestCounts200Response
   * @throws IOException if the JSON string is invalid with respect to GetTestCounts200Response
   */
  public static GetTestCounts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTestCounts200Response.class);
  }

  /**
   * Convert an instance of GetTestCounts200Response to an JSON string
   *
   * @return JSON string
   */
