...
public class AddAMemberToAnOrganizationWithinAGroupRequest {
  ...
  public AddAMemberToAnOrganizationWithinAGroupRequest() {
  }

  public AddAMemberToAnOrganizationWithinAGroupRequest role(String role) {
    this.role = role;
    return this;
  }
  ...
  public AddAMemberToAnOrganizationWithinAGroupRequest userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddAMemberToAnOrganizationWithinAGroupRequest addAMemberToAnOrganizationWithinAGroupRequest = (AddAMemberToAnOrganizationWithinAGroupRequest) o;
    return Objects.equals(this.role, addAMemberToAnOrganizationWithinAGroupRequest.role) &&
        Objects.equals(this.userId, addAMemberToAnOrganizationWithinAGroupRequest.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddAMemberToAnOrganizationWithinAGroupRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddAMemberToAnOrganizationWithinAGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddAMemberToAnOrganizationWithinAGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAMemberToAnOrganizationWithinAGroupRequest is not found in the empty JSON string", AddAMemberToAnOrganizationWithinAGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddAMemberToAnOrganizationWithinAGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddAMemberToAnOrganizationWithinAGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAMemberToAnOrganizationWithinAGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAMemberToAnOrganizationWithinAGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAMemberToAnOrganizationWithinAGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAMemberToAnOrganizationWithinAGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAMemberToAnOrganizationWithinAGroupRequest>() {
           @Override
           public void write(JsonWriter out, AddAMemberToAnOrganizationWithinAGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddAMemberToAnOrganizationWithinAGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddAMemberToAnOrganizationWithinAGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddAMemberToAnOrganizationWithinAGroupRequest
   * @throws IOException if the JSON string is invalid with respect to AddAMemberToAnOrganizationWithinAGroupRequest
   */
  public static AddAMemberToAnOrganizationWithinAGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAMemberToAnOrganizationWithinAGroupRequest.class);
  }

  /**
   * Convert an instance of AddAMemberToAnOrganizationWithinAGroupRequest to an JSON string
   *
   * @return JSON string
   */
