...
public class RetrieveASingleProject200ResponseIssueCountsBySeverity {
  ...
  public RetrieveASingleProject200ResponseIssueCountsBySeverity() {
  }

  public RetrieveASingleProject200ResponseIssueCountsBySeverity critical(BigDecimal critical) {
  ...
  public RetrieveASingleProject200ResponseIssueCountsBySeverity high(BigDecimal high) {
    this.high = high;
    return this;
  }
  ...
  public RetrieveASingleProject200ResponseIssueCountsBySeverity low(BigDecimal low) {
    this.low = low;
    return this;
  }
  ...
  public RetrieveASingleProject200ResponseIssueCountsBySeverity medium(BigDecimal medium) {
    this.medium = medium;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetrieveASingleProject200ResponseIssueCountsBySeverity retrieveASingleProject200ResponseIssueCountsBySeverity = (RetrieveASingleProject200ResponseIssueCountsBySeverity) o;
    return Objects.equals(this.critical, retrieveASingleProject200ResponseIssueCountsBySeverity.critical) &&
        Objects.equals(this.high, retrieveASingleProject200ResponseIssueCountsBySeverity.high) &&
        Objects.equals(this.low, retrieveASingleProject200ResponseIssueCountsBySeverity.low) &&
        Objects.equals(this.medium, retrieveASingleProject200ResponseIssueCountsBySeverity.medium);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrieveASingleProject200ResponseIssueCountsBySeverity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetrieveASingleProject200ResponseIssueCountsBySeverity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveASingleProject200ResponseIssueCountsBySeverity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveASingleProject200ResponseIssueCountsBySeverity is not found in the empty JSON string", RetrieveASingleProject200ResponseIssueCountsBySeverity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveASingleProject200ResponseIssueCountsBySeverity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveASingleProject200ResponseIssueCountsBySeverity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveASingleProject200ResponseIssueCountsBySeverity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveASingleProject200ResponseIssueCountsBySeverity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveASingleProject200ResponseIssueCountsBySeverity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveASingleProject200ResponseIssueCountsBySeverity.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveASingleProject200ResponseIssueCountsBySeverity>() {
           @Override
           public void write(JsonWriter out, RetrieveASingleProject200ResponseIssueCountsBySeverity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveASingleProject200ResponseIssueCountsBySeverity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetrieveASingleProject200ResponseIssueCountsBySeverity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetrieveASingleProject200ResponseIssueCountsBySeverity
   * @throws IOException if the JSON string is invalid with respect to RetrieveASingleProject200ResponseIssueCountsBySeverity
   */
  public static RetrieveASingleProject200ResponseIssueCountsBySeverity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveASingleProject200ResponseIssueCountsBySeverity.class);
  }

  /**
   * Convert an instance of RetrieveASingleProject200ResponseIssueCountsBySeverity to an JSON string
   *
   * @return JSON string
   */
