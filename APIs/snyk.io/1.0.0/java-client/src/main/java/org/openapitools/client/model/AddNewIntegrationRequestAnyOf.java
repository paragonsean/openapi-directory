...
public class AddNewIntegrationRequestAnyOf {
  ...
  public AddNewIntegrationRequestAnyOf() {
  }

  public AddNewIntegrationRequestAnyOf credentials(AddNewIntegrationRequestAnyOfCredentials credentials) {
  ...
  public AddNewIntegrationRequestAnyOf type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOf addNewIntegrationRequestAnyOf = (AddNewIntegrationRequestAnyOf) o;
    return Objects.equals(this.credentials, addNewIntegrationRequestAnyOf.credentials) &&
        Objects.equals(this.type, addNewIntegrationRequestAnyOf.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddNewIntegrationRequestAnyOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOf is not found in the empty JSON string", AddNewIntegrationRequestAnyOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNewIntegrationRequestAnyOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOf>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOf
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOf
   */
  public static AddNewIntegrationRequestAnyOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOf.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOf to an JSON string
   *
   * @return JSON string
   */
