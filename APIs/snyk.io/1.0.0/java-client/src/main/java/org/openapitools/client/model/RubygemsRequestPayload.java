...
import org.openapitools.client.model.TestGemfileLockFileRequestFiles;
...
public class RubygemsRequestPayload {
  /**
  ...
  private TestGemfileLockFileRequestFiles files;

  public RubygemsRequestPayload() {
  }

  public RubygemsRequestPayload encoding(EncodingEnum encoding) {
  ...
  public RubygemsRequestPayload files(TestGemfileLockFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestGemfileLockFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestGemfileLockFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    RubygemsRequestPayload rubygemsRequestPayload = (RubygemsRequestPayload) o;
    return Objects.equals(this.encoding, rubygemsRequestPayload.encoding) &&
        Objects.equals(this.files, rubygemsRequestPayload.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class RubygemsRequestPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RubygemsRequestPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RubygemsRequestPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RubygemsRequestPayload is not found in the empty JSON string", RubygemsRequestPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RubygemsRequestPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RubygemsRequestPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RubygemsRequestPayload.openapiRequiredFields) {
      ...
      TestGemfileLockFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RubygemsRequestPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RubygemsRequestPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RubygemsRequestPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RubygemsRequestPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<RubygemsRequestPayload>() {
           @Override
           public void write(JsonWriter out, RubygemsRequestPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RubygemsRequestPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RubygemsRequestPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RubygemsRequestPayload
   * @throws IOException if the JSON string is invalid with respect to RubygemsRequestPayload
   */
  public static RubygemsRequestPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RubygemsRequestPayload.class);
  }

  /**
   * Convert an instance of RubygemsRequestPayload to an JSON string
   *
   * @return JSON string
   */
