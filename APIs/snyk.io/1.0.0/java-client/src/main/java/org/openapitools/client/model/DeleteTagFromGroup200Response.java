...
public class DeleteTagFromGroup200Response {
  ...
  public DeleteTagFromGroup200Response() {
  }

  public DeleteTagFromGroup200Response force(Boolean force) {
    this.force = force;
    return this;
  }
  ...
  public DeleteTagFromGroup200Response key(String key) {
    this.key = key;
    return this;
  }
  ...
  public DeleteTagFromGroup200Response value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteTagFromGroup200Response deleteTagFromGroup200Response = (DeleteTagFromGroup200Response) o;
    return Objects.equals(this.force, deleteTagFromGroup200Response.force) &&
        Objects.equals(this.key, deleteTagFromGroup200Response.key) &&
        Objects.equals(this.value, deleteTagFromGroup200Response.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteTagFromGroup200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTagFromGroup200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTagFromGroup200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTagFromGroup200Response is not found in the empty JSON string", DeleteTagFromGroup200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTagFromGroup200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTagFromGroup200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTagFromGroup200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTagFromGroup200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTagFromGroup200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTagFromGroup200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTagFromGroup200Response>() {
           @Override
           public void write(JsonWriter out, DeleteTagFromGroup200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTagFromGroup200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTagFromGroup200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTagFromGroup200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteTagFromGroup200Response
   */
  public static DeleteTagFromGroup200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTagFromGroup200Response.class);
  }

  /**
   * Convert an instance of DeleteTagFromGroup200Response to an JSON string
   *
   * @return JSON string
   */
