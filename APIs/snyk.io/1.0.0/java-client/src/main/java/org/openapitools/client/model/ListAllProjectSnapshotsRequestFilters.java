...
public class ListAllProjectSnapshotsRequestFilters {
  public static final String SERIALIZED_NAME_IMAGE_ID = "imageId";
  @SerializedName(SERIALIZED_NAME_IMAGE_ID)
  private String imageId;

  public ListAllProjectSnapshotsRequestFilters() {
  }

  public ListAllProjectSnapshotsRequestFilters imageId(String imageId) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllProjectSnapshotsRequestFilters listAllProjectSnapshotsRequestFilters = (ListAllProjectSnapshotsRequestFilters) o;
    return Objects.equals(this.imageId, listAllProjectSnapshotsRequestFilters.imageId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllProjectSnapshotsRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllProjectSnapshotsRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllProjectSnapshotsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllProjectSnapshotsRequestFilters is not found in the empty JSON string", ListAllProjectSnapshotsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllProjectSnapshotsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllProjectSnapshotsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllProjectSnapshotsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllProjectSnapshotsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllProjectSnapshotsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllProjectSnapshotsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllProjectSnapshotsRequestFilters>() {
           @Override
           public void write(JsonWriter out, ListAllProjectSnapshotsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllProjectSnapshotsRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllProjectSnapshotsRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllProjectSnapshotsRequestFilters
   * @throws IOException if the JSON string is invalid with respect to ListAllProjectSnapshotsRequestFilters
   */
  public static ListAllProjectSnapshotsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllProjectSnapshotsRequestFilters.class);
  }

  /**
   * Convert an instance of ListAllProjectSnapshotsRequestFilters to an JSON string
   *
   * @return JSON string
   */
