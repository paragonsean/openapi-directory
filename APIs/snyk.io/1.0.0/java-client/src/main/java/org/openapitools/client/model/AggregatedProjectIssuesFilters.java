...
import org.openapitools.client.model.ListAllAggregatedIssuesRequestFilters;
...
public class AggregatedProjectIssuesFilters {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private ListAllAggregatedIssuesRequestFilters filters;

  public static final String SERIALIZED_NAME_INCLUDE_DESCRIPTION = "includeDescription";
  @SerializedName(SERIALIZED_NAME_INCLUDE_DESCRIPTION)
  private Boolean includeDescription;

  public static final String SERIALIZED_NAME_INCLUDE_INTRODUCED_THROUGH = "includeIntroducedThrough";
  @SerializedName(SERIALIZED_NAME_INCLUDE_INTRODUCED_THROUGH)
  private Boolean includeIntroducedThrough;

  public AggregatedProjectIssuesFilters() {
  }

  public AggregatedProjectIssuesFilters filters(ListAllAggregatedIssuesRequestFilters filters) {
  ...
  public ListAllAggregatedIssuesRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(ListAllAggregatedIssuesRequestFilters filters) {
    this.filters = filters;
  }


  public AggregatedProjectIssuesFilters includeDescription(Boolean includeDescription) {
  ...
  public AggregatedProjectIssuesFilters includeIntroducedThrough(Boolean includeIntroducedThrough) {
    this.includeIntroducedThrough = includeIntroducedThrough;
    return this;
  }
   ...
   * @return includeIntroducedThrough
   */
  @javax.annotation.Nullable
  public Boolean getIncludeIntroducedThrough() {
    return includeIntroducedThrough;
  }

  public void setIncludeIntroducedThrough(Boolean includeIntroducedThrough) {
    this.includeIntroducedThrough = includeIntroducedThrough;
  }
  ...
  public boolean equals(Object o) {
    ...
    AggregatedProjectIssuesFilters aggregatedProjectIssuesFilters = (AggregatedProjectIssuesFilters) o;
    return Objects.equals(this.filters, aggregatedProjectIssuesFilters.filters) &&
        Objects.equals(this.includeDescription, aggregatedProjectIssuesFilters.includeDescription) &&
        Objects.equals(this.includeIntroducedThrough, aggregatedProjectIssuesFilters.includeIntroducedThrough);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filters, includeDescription, includeIntroducedThrough);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AggregatedProjectIssuesFilters {\n");
    sb.append("    filters: ").append(toIndentedString(filters)).append("\n");
    sb.append("    includeDescription: ").append(toIndentedString(includeDescription)).append("\n");
    sb.append("    includeIntroducedThrough: ").append(toIndentedString(includeIntroducedThrough)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("includeDescription");
    openapiFields.add("includeIntroducedThrough");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AggregatedProjectIssuesFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregatedProjectIssuesFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregatedProjectIssuesFilters is not found in the empty JSON string", AggregatedProjectIssuesFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AggregatedProjectIssuesFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AggregatedProjectIssuesFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `filters`
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        ListAllAggregatedIssuesRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregatedProjectIssuesFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregatedProjectIssuesFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregatedProjectIssuesFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregatedProjectIssuesFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregatedProjectIssuesFilters>() {
           @Override
           public void write(JsonWriter out, AggregatedProjectIssuesFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AggregatedProjectIssuesFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AggregatedProjectIssuesFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AggregatedProjectIssuesFilters
   * @throws IOException if the JSON string is invalid with respect to AggregatedProjectIssuesFilters
   */
  public static AggregatedProjectIssuesFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregatedProjectIssuesFilters.class);
  }

  /**
   * Convert an instance of AggregatedProjectIssuesFilters to an JSON string
   *
   * @return JSON string
   */
