...
import org.openapitools.client.model.TestVendorJsonFileRequestFilesTarget;
...
public class TestVendorJsonFileRequestFiles {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private TestVendorJsonFileRequestFilesTarget target;

  public TestVendorJsonFileRequestFiles() {
  }

  public TestVendorJsonFileRequestFiles target(TestVendorJsonFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
  ...
  public TestVendorJsonFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestVendorJsonFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestVendorJsonFileRequestFiles testVendorJsonFileRequestFiles = (TestVendorJsonFileRequestFiles) o;
    return Objects.equals(this.target, testVendorJsonFileRequestFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestVendorJsonFileRequestFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestVendorJsonFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestVendorJsonFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestVendorJsonFileRequestFiles is not found in the empty JSON string", TestVendorJsonFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestVendorJsonFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestVendorJsonFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestVendorJsonFileRequestFiles.openapiRequiredFields) {
      ...
      TestVendorJsonFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestVendorJsonFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestVendorJsonFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestVendorJsonFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestVendorJsonFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestVendorJsonFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestVendorJsonFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestVendorJsonFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestVendorJsonFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestVendorJsonFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestVendorJsonFileRequestFiles
   */
  public static TestVendorJsonFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestVendorJsonFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestVendorJsonFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
