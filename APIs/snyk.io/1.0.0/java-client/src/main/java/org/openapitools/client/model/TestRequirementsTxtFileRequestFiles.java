...
import org.openapitools.client.model.TestRequirementsTxtFileRequestFilesTarget;
...
public class TestRequirementsTxtFileRequestFiles {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private TestRequirementsTxtFileRequestFilesTarget target;

  public TestRequirementsTxtFileRequestFiles() {
  }

  public TestRequirementsTxtFileRequestFiles target(TestRequirementsTxtFileRequestFilesTarget target) {
    this.target = target;
    return this;
  }
  ...
  public TestRequirementsTxtFileRequestFilesTarget getTarget() {
    return target;
  }

  public void setTarget(TestRequirementsTxtFileRequestFilesTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestRequirementsTxtFileRequestFiles testRequirementsTxtFileRequestFiles = (TestRequirementsTxtFileRequestFiles) o;
    return Objects.equals(this.target, testRequirementsTxtFileRequestFiles.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestRequirementsTxtFileRequestFiles {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestRequirementsTxtFileRequestFiles
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestRequirementsTxtFileRequestFiles.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestRequirementsTxtFileRequestFiles is not found in the empty JSON string", TestRequirementsTxtFileRequestFiles.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestRequirementsTxtFileRequestFiles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestRequirementsTxtFileRequestFiles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestRequirementsTxtFileRequestFiles.openapiRequiredFields) {
      ...
      TestRequirementsTxtFileRequestFilesTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestRequirementsTxtFileRequestFiles.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestRequirementsTxtFileRequestFiles' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestRequirementsTxtFileRequestFiles> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestRequirementsTxtFileRequestFiles.class));

       return (TypeAdapter<T>) new TypeAdapter<TestRequirementsTxtFileRequestFiles>() {
           @Override
           public void write(JsonWriter out, TestRequirementsTxtFileRequestFiles value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestRequirementsTxtFileRequestFiles read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestRequirementsTxtFileRequestFiles given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestRequirementsTxtFileRequestFiles
   * @throws IOException if the JSON string is invalid with respect to TestRequirementsTxtFileRequestFiles
   */
  public static TestRequirementsTxtFileRequestFiles fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestRequirementsTxtFileRequestFiles.class);
  }

  /**
   * Convert an instance of TestRequirementsTxtFileRequestFiles to an JSON string
   *
   * @return JSON string
   */
