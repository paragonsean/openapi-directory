...
public class UpdateAProjectRequestOwner {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;

  public UpdateAProjectRequestOwner() {
  }

  public UpdateAProjectRequestOwner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateAProjectRequestOwner updateAProjectRequestOwner = (UpdateAProjectRequestOwner) o;
    return Objects.equals(this.id, updateAProjectRequestOwner.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAProjectRequestOwner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAProjectRequestOwner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAProjectRequestOwner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAProjectRequestOwner is not found in the empty JSON string", UpdateAProjectRequestOwner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAProjectRequestOwner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAProjectRequestOwner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAProjectRequestOwner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAProjectRequestOwner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAProjectRequestOwner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAProjectRequestOwner.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAProjectRequestOwner>() {
           @Override
           public void write(JsonWriter out, UpdateAProjectRequestOwner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAProjectRequestOwner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAProjectRequestOwner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAProjectRequestOwner
   * @throws IOException if the JSON string is invalid with respect to UpdateAProjectRequestOwner
   */
  public static UpdateAProjectRequestOwner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAProjectRequestOwner.class);
  }

  /**
   * Convert an instance of UpdateAProjectRequestOwner to an JSON string
   *
   * @return JSON string
   */
