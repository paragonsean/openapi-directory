...
public class ApplyingAttributes200ResponseAttributes {
  ...
  private List<Object> environment = new ArrayList<>();

  public static final String SERIALIZED_NAME_LIFECYCLE = "lifecycle";
  @SerializedName(SERIALIZED_NAME_LIFECYCLE)
  private List<Object> lifecycle = new ArrayList<>();

  public ApplyingAttributes200ResponseAttributes() {
  }

  public ApplyingAttributes200ResponseAttributes criticality(List<Object> criticality) {
    this.criticality = criticality;
    return this;
  }

  public ApplyingAttributes200ResponseAttributes addCriticalityItem(Object criticalityItem) {
    if (this.criticality == null) {
      this.criticality = new ArrayList<>();
    }
    this.criticality.add(criticalityItem);
    return this;
  }
  ...
  public List<Object> getCriticality() {
    return criticality;
  }

  public void setCriticality(List<Object> criticality) {
    this.criticality = criticality;
  }


  public ApplyingAttributes200ResponseAttributes environment(List<Object> environment) {
    this.environment = environment;
    return this;
  }

  public ApplyingAttributes200ResponseAttributes addEnvironmentItem(Object environmentItem) {
  ...
  public ApplyingAttributes200ResponseAttributes lifecycle(List<Object> lifecycle) {
    this.lifecycle = lifecycle;
    return this;
  }

  public ApplyingAttributes200ResponseAttributes addLifecycleItem(Object lifecycleItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Object> getLifecycle() {
    return lifecycle;
  }

  public void setLifecycle(List<Object> lifecycle) {
    this.lifecycle = lifecycle;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApplyingAttributes200ResponseAttributes applyingAttributes200ResponseAttributes = (ApplyingAttributes200ResponseAttributes) o;
    return Objects.equals(this.criticality, applyingAttributes200ResponseAttributes.criticality) &&
        Objects.equals(this.environment, applyingAttributes200ResponseAttributes.environment) &&
        Objects.equals(this.lifecycle, applyingAttributes200ResponseAttributes.lifecycle);
  }

  @Override
  public int hashCode() {
    return Objects.hash(criticality, environment, lifecycle);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApplyingAttributes200ResponseAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplyingAttributes200ResponseAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplyingAttributes200ResponseAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplyingAttributes200ResponseAttributes is not found in the empty JSON string", ApplyingAttributes200ResponseAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplyingAttributes200ResponseAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplyingAttributes200ResponseAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("criticality") != null && !jsonObj.get("criticality").isJsonNull() && !jsonObj.get("criticality").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `criticality` to be an array in the JSON string but got `%s`", jsonObj.get("criticality").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("lifecycle") != null && !jsonObj.get("lifecycle").isJsonNull() && !jsonObj.get("lifecycle").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplyingAttributes200ResponseAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplyingAttributes200ResponseAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplyingAttributes200ResponseAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplyingAttributes200ResponseAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplyingAttributes200ResponseAttributes>() {
           @Override
           public void write(JsonWriter out, ApplyingAttributes200ResponseAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplyingAttributes200ResponseAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplyingAttributes200ResponseAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplyingAttributes200ResponseAttributes
   * @throws IOException if the JSON string is invalid with respect to ApplyingAttributes200ResponseAttributes
   */
  public static ApplyingAttributes200ResponseAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplyingAttributes200ResponseAttributes.class);
  }

  /**
   * Convert an instance of ApplyingAttributes200ResponseAttributes to an JSON string
   *
   * @return JSON string
   */
