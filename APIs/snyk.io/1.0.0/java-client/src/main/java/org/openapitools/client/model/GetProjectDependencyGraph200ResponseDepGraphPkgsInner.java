...
import org.openapitools.client.model.GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo;
...
public class GetProjectDependencyGraph200ResponseDepGraphPkgsInner {
  ...
  private GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo info;

  public GetProjectDependencyGraph200ResponseDepGraphPkgsInner() {
  }

  public GetProjectDependencyGraph200ResponseDepGraphPkgsInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetProjectDependencyGraph200ResponseDepGraphPkgsInner info(GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo info) {
    this.info = info;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo getInfo() {
    return info;
  }

  public void setInfo(GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo info) {
    this.info = info;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectDependencyGraph200ResponseDepGraphPkgsInner getProjectDependencyGraph200ResponseDepGraphPkgsInner = (GetProjectDependencyGraph200ResponseDepGraphPkgsInner) o;
    return Objects.equals(this.id, getProjectDependencyGraph200ResponseDepGraphPkgsInner.id) &&
        Objects.equals(this.info, getProjectDependencyGraph200ResponseDepGraphPkgsInner.info);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectDependencyGraph200ResponseDepGraphPkgsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectDependencyGraph200ResponseDepGraphPkgsInner is not found in the empty JSON string", GetProjectDependencyGraph200ResponseDepGraphPkgsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectDependencyGraph200ResponseDepGraphPkgsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectDependencyGraph200ResponseDepGraphPkgsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectDependencyGraph200ResponseDepGraphPkgsInner.openapiRequiredFields) {
      ...
      GetProjectDependencyGraph200ResponseDepGraphPkgsInnerInfo.validateJsonElement(jsonObj.get("info"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectDependencyGraph200ResponseDepGraphPkgsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectDependencyGraph200ResponseDepGraphPkgsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectDependencyGraph200ResponseDepGraphPkgsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectDependencyGraph200ResponseDepGraphPkgsInner>() {
           @Override
           public void write(JsonWriter out, GetProjectDependencyGraph200ResponseDepGraphPkgsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectDependencyGraph200ResponseDepGraphPkgsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectDependencyGraph200ResponseDepGraphPkgsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectDependencyGraph200ResponseDepGraphPkgsInner
   * @throws IOException if the JSON string is invalid with respect to GetProjectDependencyGraph200ResponseDepGraphPkgsInner
   */
  public static GetProjectDependencyGraph200ResponseDepGraphPkgsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectDependencyGraph200ResponseDepGraphPkgsInner.class);
  }

  /**
   * Convert an instance of GetProjectDependencyGraph200ResponseDepGraphPkgsInner to an JSON string
   *
   * @return JSON string
   */
