...
import org.openapitools.client.model.AddNewIntegrationRequestAnyOfCredentialsOneOf9GitHubCredentials;
...
public class AddNewIntegrationRequestAnyOfCredentialsOneOf9 {
  public static final String SERIALIZED_NAME_GIT_HUB_CREDENTIALS = "GitHubCredentials";
  @SerializedName(SERIALIZED_NAME_GIT_HUB_CREDENTIALS)
  private AddNewIntegrationRequestAnyOfCredentialsOneOf9GitHubCredentials gitHubCredentials;

  public AddNewIntegrationRequestAnyOfCredentialsOneOf9() {
  }

  public AddNewIntegrationRequestAnyOfCredentialsOneOf9 gitHubCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf9GitHubCredentials gitHubCredentials) {
  ...
  public AddNewIntegrationRequestAnyOfCredentialsOneOf9GitHubCredentials getGitHubCredentials() {
    return gitHubCredentials;
  }

  public void setGitHubCredentials(AddNewIntegrationRequestAnyOfCredentialsOneOf9GitHubCredentials gitHubCredentials) {
    this.gitHubCredentials = gitHubCredentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddNewIntegrationRequestAnyOfCredentialsOneOf9 addNewIntegrationRequestAnyOfCredentialsOneOf9 = (AddNewIntegrationRequestAnyOfCredentialsOneOf9) o;
    return Objects.equals(this.gitHubCredentials, addNewIntegrationRequestAnyOfCredentialsOneOf9.gitHubCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gitHubCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNewIntegrationRequestAnyOfCredentialsOneOf9 {\n");
    sb.append("    gitHubCredentials: ").append(toIndentedString(gitHubCredentials)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("GitHubCredentials");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf9
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf9.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNewIntegrationRequestAnyOfCredentialsOneOf9 is not found in the empty JSON string", AddNewIntegrationRequestAnyOfCredentialsOneOf9.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNewIntegrationRequestAnyOfCredentialsOneOf9.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddNewIntegrationRequestAnyOfCredentialsOneOf9` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GitHubCredentials`
      if (jsonObj.get("GitHubCredentials") != null && !jsonObj.get("GitHubCredentials").isJsonNull()) {
        AddNewIntegrationRequestAnyOfCredentialsOneOf9GitHubCredentials.validateJsonElement(jsonObj.get("GitHubCredentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNewIntegrationRequestAnyOfCredentialsOneOf9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNewIntegrationRequestAnyOfCredentialsOneOf9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNewIntegrationRequestAnyOfCredentialsOneOf9.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNewIntegrationRequestAnyOfCredentialsOneOf9>() {
           @Override
           public void write(JsonWriter out, AddNewIntegrationRequestAnyOfCredentialsOneOf9 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddNewIntegrationRequestAnyOfCredentialsOneOf9 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf9 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddNewIntegrationRequestAnyOfCredentialsOneOf9
   * @throws IOException if the JSON string is invalid with respect to AddNewIntegrationRequestAnyOfCredentialsOneOf9
   */
  public static AddNewIntegrationRequestAnyOfCredentialsOneOf9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNewIntegrationRequestAnyOfCredentialsOneOf9.class);
  }

  /**
   * Convert an instance of AddNewIntegrationRequestAnyOfCredentialsOneOf9 to an JSON string
   *
   * @return JSON string
   */
