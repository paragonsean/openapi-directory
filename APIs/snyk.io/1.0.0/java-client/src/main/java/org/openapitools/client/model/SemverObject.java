...
public class SemverObject {
  ...
  public SemverObject unaffected(String unaffected) {
  ...
  public SemverObject vulnerable(String vulnerable) {
  ...
  public boolean equals(Object o) {
    ...
    SemverObject semverObject = (SemverObject) o;
    return Objects.equals(this.unaffected, semverObject.unaffected) &&
        Objects.equals(this.vulnerable, semverObject.vulnerable);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SemverObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SemverObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SemverObject is not found in the empty JSON string", SemverObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SemverObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SemverObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("vulnerable") != null && !jsonObj.get("vulnerable").isJsonNull()) && !jsonObj.get("vulnerable").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `vulnerable` to be a primitive type in the JSON string but got `%s`", jsonObj.get("vulnerable").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SemverObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SemverObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SemverObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SemverObject.class));

       return (TypeAdapter<T>) new TypeAdapter<SemverObject>() {
           @Override
           public void write(JsonWriter out, SemverObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SemverObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SemverObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SemverObject
   * @throws IOException if the JSON string is invalid with respect to SemverObject
   */
  public static SemverObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SemverObject.class);
  }

  /**
   * Convert an instance of SemverObject to an JSON string
   *
   * @return JSON string
   */
