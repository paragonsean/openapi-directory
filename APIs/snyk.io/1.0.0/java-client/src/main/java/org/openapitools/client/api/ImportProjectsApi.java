...
import org.openapitools.client.model.GetImportJobDetails200Response;
import org.openapitools.client.model.ImportTargetsRequest;
...
public class ImportProjectsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ImportProjectsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ImportProjectsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getImportJobDetails
     ...
     * @param jobId The ID of the job. This can be found in the Location response header from the corresponding POST request that triggered the import job. (required)
     ...
     */
    public okhttp3.Call getImportJobDetailsCall(String orgId, String integrationId, String jobId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/org/{orgId}/integrations/{integrationId}/import/{jobId}"
    ...
    private okhttp3.Call getImportJobDetailsValidateBeforeCall(String orgId, String integrationId, String jobId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling getImportJobDetails(Async)");
        }

        // verify the required parameter 'integrationId' is set
        if (integrationId == null) {
            throw new ApiException("Missing the required parameter 'integrationId' when calling getImportJobDetails(Async)");
        }

        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling getImportJobDetails(Async)");
        }

        return getImportJobDetailsCall(orgId, integrationId, jobId, _callback);
     ...
     * @param integrationId The unique identifier for the configured integration. This can be found on the [Integration page in the Settings area](https://app.snyk.io/manage/integrations) for all integrations that have been configured. (required)
     * @param jobId The ID of the job. This can be found in the Location response header from the corresponding POST request that triggered the import job. (required)
     * @return GetImportJobDetails200Response
     ...
     */
    public GetImportJobDetails200Response getImportJobDetails(String orgId, String integrationId, String jobId) throws ApiException {
        ApiResponse<GetImportJobDetails200Response> localVarResp = getImportJobDetailsWithHttpInfo(orgId, integrationId, jobId);
     ...
     * @param integrationId The unique identifier for the configured integration. This can be found on the [Integration page in the Settings area](https://app.snyk.io/manage/integrations) for all integrations that have been configured. (required)
     * @param jobId The ID of the job. This can be found in the Location response header from the corresponding POST request that triggered the import job. (required)
     * @return ApiResponse&lt;GetImportJobDetails200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetImportJobDetails200Response> getImportJobDetailsWithHttpInfo(String orgId, String integrationId, String jobId) throws ApiException {
        okhttp3.Call localVarCall = getImportJobDetailsValidateBeforeCall(orgId, integrationId, jobId, null);
        Type localVarReturnType = new TypeToken<GetImportJobDetails200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get import job details (asynchronously)
     * 
     * @param orgId The organization ID. The &#x60;API_KEY&#x60; must have admin access to this organization. (required)
     * @param integrationId The unique identifier for the configured integration. This can be found on the [Integration page in the Settings area](https://app.snyk.io/manage/integrations) for all integrations that have been configured. (required)
     * @param jobId The ID of the job. This can be found in the Location response header from the corresponding POST request that triggered the import job. (required)
     ...
     */
    public okhttp3.Call getImportJobDetailsAsync(String orgId, String integrationId, String jobId, final ApiCallback<GetImportJobDetails200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getImportJobDetailsValidateBeforeCall(orgId, integrationId, jobId, _callback);
        Type localVarReturnType = new TypeToken<GetImportJobDetails200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for importTargets
     * @param orgId The organization ID. The &#x60;API_KEY&#x60; must have admin access to this organization. (required)
     * @param integrationId The unique identifier for the configured integration. This can be found on the [Integration page in the Settings area](https://app.snyk.io/manage/integrations) for all integrations that have been configured. (required)
     * @param importTargetsRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call importTargetsCall(String orgId, String integrationId, ImportTargetsRequest importTargetsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = importTargetsRequest;

        // create path and map variables
        String localVarPath = "/org/{orgId}/integrations/{integrationId}/import"
            .replace("{" + "orgId" + "}", localVarApiClient.escapeString(orgId.toString()))
            .replace("{" + "integrationId" + "}", localVarApiClient.escapeString(integrationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importTargetsValidateBeforeCall(String orgId, String integrationId, ImportTargetsRequest importTargetsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling importTargets(Async)");
        }

        // verify the required parameter 'integrationId' is set
        if (integrationId == null) {
            throw new ApiException("Missing the required parameter 'integrationId' when calling importTargets(Async)");
        }

        return importTargetsCall(orgId, integrationId, importTargetsRequest, _callback);
     ...
     */
    public void importTargets(String orgId, String integrationId, ImportTargetsRequest importTargetsRequest) throws ApiException {
        importTargetsWithHttpInfo(orgId, integrationId, importTargetsRequest);
    }
     ...
     */
    public ApiResponse<Void> importTargetsWithHttpInfo(String orgId, String integrationId, ImportTargetsRequest importTargetsRequest) throws ApiException {
        okhttp3.Call localVarCall = importTargetsValidateBeforeCall(orgId, integrationId, importTargetsRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Import targets (asynchronously)
     * 
     * @param orgId The organization ID. The &#x60;API_KEY&#x60; must have admin access to this organization. (required)
     * @param integrationId The unique identifier for the configured integration. This can be found on the [Integration page in the Settings area](https://app.snyk.io/manage/integrations) for all integrations that have been configured. (required)
     * @param importTargetsRequest  (optional)
     ...
     */
    public okhttp3.Call importTargetsAsync(String orgId, String integrationId, ImportTargetsRequest importTargetsRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = importTargetsValidateBeforeCall(orgId, integrationId, importTargetsRequest, _callback);
