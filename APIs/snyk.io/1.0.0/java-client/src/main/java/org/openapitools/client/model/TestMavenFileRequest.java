...
import org.openapitools.client.model.TestMavenFileRequestFiles;
...
public class TestMavenFileRequest {
  /**
  ...
  private TestMavenFileRequestFiles files;

  public TestMavenFileRequest() {
  }

  public TestMavenFileRequest encoding(EncodingEnum encoding) {
  ...
  public TestMavenFileRequest files(TestMavenFileRequestFiles files) {
    this.files = files;
    return this;
  }
  ...
  public TestMavenFileRequestFiles getFiles() {
    return files;
  }

  public void setFiles(TestMavenFileRequestFiles files) {
    this.files = files;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestMavenFileRequest testMavenFileRequest = (TestMavenFileRequest) o;
    return Objects.equals(this.encoding, testMavenFileRequest.encoding) &&
        Objects.equals(this.files, testMavenFileRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestMavenFileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestMavenFileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestMavenFileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestMavenFileRequest is not found in the empty JSON string", TestMavenFileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestMavenFileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestMavenFileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestMavenFileRequest.openapiRequiredFields) {
      ...
      TestMavenFileRequestFiles.validateJsonElement(jsonObj.get("files"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestMavenFileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestMavenFileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestMavenFileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestMavenFileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestMavenFileRequest>() {
           @Override
           public void write(JsonWriter out, TestMavenFileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestMavenFileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestMavenFileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestMavenFileRequest
   * @throws IOException if the JSON string is invalid with respect to TestMavenFileRequest
   */
  public static TestMavenFileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestMavenFileRequest.class);
  }

  /**
   * Convert an instance of TestMavenFileRequest to an JSON string
   *
   * @return JSON string
   */
