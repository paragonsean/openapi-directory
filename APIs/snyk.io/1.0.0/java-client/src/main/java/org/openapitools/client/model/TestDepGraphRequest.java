...
import org.openapitools.client.model.TestDepGraphRequestDepGraph;
...
public class TestDepGraphRequest {
  public static final String SERIALIZED_NAME_DEP_GRAPH = "depGraph";
  @SerializedName(SERIALIZED_NAME_DEP_GRAPH)
  private TestDepGraphRequestDepGraph depGraph;

  public TestDepGraphRequest() {
  }

  public TestDepGraphRequest depGraph(TestDepGraphRequestDepGraph depGraph) {
  ...
  public TestDepGraphRequestDepGraph getDepGraph() {
    return depGraph;
  }

  public void setDepGraph(TestDepGraphRequestDepGraph depGraph) {
    this.depGraph = depGraph;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestDepGraphRequest testDepGraphRequest = (TestDepGraphRequest) o;
    return Objects.equals(this.depGraph, testDepGraphRequest.depGraph);
  }

  @Override
  public int hashCode() {
    return Objects.hash(depGraph);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestDepGraphRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestDepGraphRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestDepGraphRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestDepGraphRequest is not found in the empty JSON string", TestDepGraphRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestDepGraphRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestDepGraphRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestDepGraphRequest.openapiRequiredFields) {
      ...
      TestDepGraphRequestDepGraph.validateJsonElement(jsonObj.get("depGraph"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestDepGraphRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestDepGraphRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestDepGraphRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestDepGraphRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestDepGraphRequest>() {
           @Override
           public void write(JsonWriter out, TestDepGraphRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestDepGraphRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestDepGraphRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestDepGraphRequest
   * @throws IOException if the JSON string is invalid with respect to TestDepGraphRequest
   */
  public static TestDepGraphRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestDepGraphRequest.class);
  }

  /**
   * Convert an instance of TestDepGraphRequest to an JSON string
   *
   * @return JSON string
   */
