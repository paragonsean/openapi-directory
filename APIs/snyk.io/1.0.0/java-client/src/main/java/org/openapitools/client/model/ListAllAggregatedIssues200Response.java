...
import org.openapitools.client.model.ListAllAggregatedIssues200ResponseIssuesInner;
...
public class ListAllAggregatedIssues200Response {
  public static final String SERIALIZED_NAME_ISSUES = "issues";
  @SerializedName(SERIALIZED_NAME_ISSUES)
  private List<ListAllAggregatedIssues200ResponseIssuesInner> issues = new ArrayList<>();

  public ListAllAggregatedIssues200Response() {
  }

  public ListAllAggregatedIssues200Response issues(List<ListAllAggregatedIssues200ResponseIssuesInner> issues) {
    this.issues = issues;
    return this;
  }

  public ListAllAggregatedIssues200Response addIssuesItem(ListAllAggregatedIssues200ResponseIssuesInner issuesItem) {
    if (this.issues == null) {
  ...
  public List<ListAllAggregatedIssues200ResponseIssuesInner> getIssues() {
    return issues;
  }

  public void setIssues(List<ListAllAggregatedIssues200ResponseIssuesInner> issues) {
    this.issues = issues;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAllAggregatedIssues200Response listAllAggregatedIssues200Response = (ListAllAggregatedIssues200Response) o;
    return Objects.equals(this.issues, listAllAggregatedIssues200Response.issues);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllAggregatedIssues200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllAggregatedIssues200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllAggregatedIssues200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllAggregatedIssues200Response is not found in the empty JSON string", ListAllAggregatedIssues200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllAggregatedIssues200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllAggregatedIssues200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("issues") != null && !jsonObj.get("issues").isJsonNull()) {
        ...
        if (jsonArrayissues != null) {
          ...
          for (int i = 0; i < jsonArrayissues.size(); i++) {
            ListAllAggregatedIssues200ResponseIssuesInner.validateJsonElement(jsonArrayissues.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllAggregatedIssues200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllAggregatedIssues200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllAggregatedIssues200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllAggregatedIssues200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllAggregatedIssues200Response>() {
           @Override
           public void write(JsonWriter out, ListAllAggregatedIssues200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllAggregatedIssues200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllAggregatedIssues200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllAggregatedIssues200Response
   * @throws IOException if the JSON string is invalid with respect to ListAllAggregatedIssues200Response
   */
  public static ListAllAggregatedIssues200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllAggregatedIssues200Response.class);
  }

  /**
   * Convert an instance of ListAllAggregatedIssues200Response to an JSON string
   *
   * @return JSON string
   */
