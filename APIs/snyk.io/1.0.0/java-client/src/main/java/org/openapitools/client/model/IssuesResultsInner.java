...
import org.openapitools.client.model.GetListOfIssues200ResponseResultsInnerIssue;
...
public class IssuesResultsInner {
  ...
  private GetListOfIssues200ResponseResultsInnerIssue issue;

  public static final String SERIALIZED_NAME_PATCHED_DATE = "patchedDate";
  @SerializedName(SERIALIZED_NAME_PATCHED_DATE)
  private String patchedDate;

  public IssuesResultsInner() {
  }

  public IssuesResultsInner fixedDate(String fixedDate) {
  ...
  public IssuesResultsInner introducedDate(String introducedDate) {
  ...
  public IssuesResultsInner isFixed(Boolean isFixed) {
  ...
  public IssuesResultsInner issue(GetListOfIssues200ResponseResultsInnerIssue issue) {
    this.issue = issue;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public GetListOfIssues200ResponseResultsInnerIssue getIssue() {
    return issue;
  }

  public void setIssue(GetListOfIssues200ResponseResultsInnerIssue issue) {
    this.issue = issue;
  }


  public IssuesResultsInner patchedDate(String patchedDate) {
   ...
   */
  @javax.annotation.Nullable
  public String getPatchedDate() {
    return patchedDate;
  }

  public void setPatchedDate(String patchedDate) {
    this.patchedDate = patchedDate;
  }
  ...
  public boolean equals(Object o) {
    ...
    IssuesResultsInner issuesResultsInner = (IssuesResultsInner) o;
    return Objects.equals(this.fixedDate, issuesResultsInner.fixedDate) &&
        Objects.equals(this.introducedDate, issuesResultsInner.introducedDate) &&
        Objects.equals(this.isFixed, issuesResultsInner.isFixed) &&
        Objects.equals(this.issue, issuesResultsInner.issue) &&
        Objects.equals(this.patchedDate, issuesResultsInner.patchedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fixedDate, introducedDate, isFixed, issue, patchedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IssuesResultsInner {\n");
    ...
    sb.append("    patchedDate: ").append(toIndentedString(patchedDate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("patchedDate");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("introducedDate");
    openapiRequiredFields.add("isFixed");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuesResultsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuesResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssuesResultsInner is not found in the empty JSON string", IssuesResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssuesResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssuesResultsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IssuesResultsInner.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("fixedDate") != null && !jsonObj.get("fixedDate").isJsonNull()) && !jsonObj.get("fixedDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fixedDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fixedDate").toString()));
      }
      if (!jsonObj.get("introducedDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `introducedDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("introducedDate").toString()));
      }
      // validate the required field `issue`
      GetListOfIssues200ResponseResultsInnerIssue.validateJsonElement(jsonObj.get("issue"));
      if ((jsonObj.get("patchedDate") != null && !jsonObj.get("patchedDate").isJsonNull()) && !jsonObj.get("patchedDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `patchedDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("patchedDate").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssuesResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssuesResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssuesResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssuesResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<IssuesResultsInner>() {
           @Override
           public void write(JsonWriter out, IssuesResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssuesResultsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssuesResultsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssuesResultsInner
   * @throws IOException if the JSON string is invalid with respect to IssuesResultsInner
   */
  public static IssuesResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssuesResultsInner.class);
  }

  /**
   * Convert an instance of IssuesResultsInner to an JSON string
   *
   * @return JSON string
   */
