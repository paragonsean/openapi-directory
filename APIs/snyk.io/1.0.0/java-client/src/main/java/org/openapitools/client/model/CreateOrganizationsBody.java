...
public class CreateOrganizationsBody {
  ...
  public CreateOrganizationsBody() {
  }

  public CreateOrganizationsBody groupId(String groupId) {
  ...
  public CreateOrganizationsBody name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateOrganizationsBody sourceOrgId(String sourceOrgId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOrganizationsBody createOrganizationsBody = (CreateOrganizationsBody) o;
    return Objects.equals(this.groupId, createOrganizationsBody.groupId) &&
        Objects.equals(this.name, createOrganizationsBody.name) &&
        Objects.equals(this.sourceOrgId, createOrganizationsBody.sourceOrgId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOrganizationsBody {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOrganizationsBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOrganizationsBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOrganizationsBody is not found in the empty JSON string", CreateOrganizationsBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrganizationsBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrganizationsBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateOrganizationsBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOrganizationsBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOrganizationsBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOrganizationsBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrganizationsBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrganizationsBody>() {
           @Override
           public void write(JsonWriter out, CreateOrganizationsBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOrganizationsBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOrganizationsBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOrganizationsBody
   * @throws IOException if the JSON string is invalid with respect to CreateOrganizationsBody
   */
  public static CreateOrganizationsBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOrganizationsBody.class);
  }

  /**
   * Convert an instance of CreateOrganizationsBody to an JSON string
   *
   * @return JSON string
   */
