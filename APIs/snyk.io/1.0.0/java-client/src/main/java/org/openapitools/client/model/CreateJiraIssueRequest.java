...
import org.openapitools.client.model.CreateJiraIssueRequestFields;
...
public class CreateJiraIssueRequest {
  ...
  private CreateJiraIssueRequestFields fields;

  public CreateJiraIssueRequest() {
  }

  public CreateJiraIssueRequest fields(CreateJiraIssueRequestFields fields) {
    this.fields = fields;
    return this;
  }
  ...
  public CreateJiraIssueRequestFields getFields() {
    return fields;
  }

  public void setFields(CreateJiraIssueRequestFields fields) {
    this.fields = fields;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateJiraIssueRequest createJiraIssueRequest = (CreateJiraIssueRequest) o;
    return Objects.equals(this.fields, createJiraIssueRequest.fields);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJiraIssueRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJiraIssueRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJiraIssueRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJiraIssueRequest is not found in the empty JSON string", CreateJiraIssueRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJiraIssueRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJiraIssueRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `fields`
      if (jsonObj.get("fields") != null && !jsonObj.get("fields").isJsonNull()) {
        CreateJiraIssueRequestFields.validateJsonElement(jsonObj.get("fields"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJiraIssueRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJiraIssueRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJiraIssueRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJiraIssueRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJiraIssueRequest>() {
           @Override
           public void write(JsonWriter out, CreateJiraIssueRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJiraIssueRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJiraIssueRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJiraIssueRequest
   * @throws IOException if the JSON string is invalid with respect to CreateJiraIssueRequest
   */
  public static CreateJiraIssueRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJiraIssueRequest.class);
  }

  /**
   * Convert an instance of CreateJiraIssueRequest to an JSON string
   *
   * @return JSON string
   */
