...
import org.openapitools.client.model.ImportTargetsRequestAnyOf7Target;
...
public class ImportTargetsRequestAnyOf7 {
  public static final String SERIALIZED_NAME_TARGET = "target";
  @SerializedName(SERIALIZED_NAME_TARGET)
  private ImportTargetsRequestAnyOf7Target target;

  public ImportTargetsRequestAnyOf7() {
  }

  public ImportTargetsRequestAnyOf7 target(ImportTargetsRequestAnyOf7Target target) {
    this.target = target;
    return this;
  }
  ...
  public ImportTargetsRequestAnyOf7Target getTarget() {
    return target;
  }

  public void setTarget(ImportTargetsRequestAnyOf7Target target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportTargetsRequestAnyOf7 importTargetsRequestAnyOf7 = (ImportTargetsRequestAnyOf7) o;
    return Objects.equals(this.target, importTargetsRequestAnyOf7.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportTargetsRequestAnyOf7 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportTargetsRequestAnyOf7
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportTargetsRequestAnyOf7.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportTargetsRequestAnyOf7 is not found in the empty JSON string", ImportTargetsRequestAnyOf7.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportTargetsRequestAnyOf7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportTargetsRequestAnyOf7` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `target`
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        ImportTargetsRequestAnyOf7Target.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportTargetsRequestAnyOf7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportTargetsRequestAnyOf7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportTargetsRequestAnyOf7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportTargetsRequestAnyOf7.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportTargetsRequestAnyOf7>() {
           @Override
           public void write(JsonWriter out, ImportTargetsRequestAnyOf7 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportTargetsRequestAnyOf7 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportTargetsRequestAnyOf7 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportTargetsRequestAnyOf7
   * @throws IOException if the JSON string is invalid with respect to ImportTargetsRequestAnyOf7
   */
  public static ImportTargetsRequestAnyOf7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportTargetsRequestAnyOf7.class);
  }

  /**
   * Convert an instance of ImportTargetsRequestAnyOf7 to an JSON string
   *
   * @return JSON string
   */
