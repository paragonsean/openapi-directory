...
import org.openapitools.client.model.MonitorDepGraphRequest;
...
public class MonitorApi {
     ...
     */
    public okhttp3.Call monitorDepGraphCall(String org, MonitorDepGraphRequest monitorDepGraphRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = monitorDepGraphRequest;

        // create path and map variables
        String localVarPath = "/monitor/dep-graph";
    ...
    private okhttp3.Call monitorDepGraphValidateBeforeCall(String org, MonitorDepGraphRequest monitorDepGraphRequest, final ApiCallback _callback) throws ApiException {
        return monitorDepGraphCall(org, monitorDepGraphRequest, _callback);
     ...
     */
    public void monitorDepGraph(String org, MonitorDepGraphRequest monitorDepGraphRequest) throws ApiException {
        monitorDepGraphWithHttpInfo(org, monitorDepGraphRequest);
    }
     ...
     */
    public ApiResponse<Void> monitorDepGraphWithHttpInfo(String org, MonitorDepGraphRequest monitorDepGraphRequest) throws ApiException {
        okhttp3.Call localVarCall = monitorDepGraphValidateBeforeCall(org, monitorDepGraphRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Monitor Dep Graph (asynchronously)
     * Use this endpoint to monitor a [DepGraph data object](https://github.com/snyk/dep-graph#depgraphdata).
     * @param org The organization to test the package with. See \&quot;The Snyk organization for a request\&quot; above. (optional)
     * @param monitorDepGraphRequest  (optional)
     ...
     */
    public okhttp3.Call monitorDepGraphAsync(String org, MonitorDepGraphRequest monitorDepGraphRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = monitorDepGraphValidateBeforeCall(org, monitorDepGraphRequest, _callback);
