...
import org.openapitools.client.model.CreateAWebhookRequest;
...
public class WebhooksApi {
     ...
     */
    public okhttp3.Call createAWebhookCall(String orgId, CreateAWebhookRequest createAWebhookRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createAWebhookRequest;

        // create path and map variables
        String localVarPath = "/org/{orgId}/webhooks"
    ...
    private okhttp3.Call createAWebhookValidateBeforeCall(String orgId, CreateAWebhookRequest createAWebhookRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling createAWebhook(Async)");
        }

        return createAWebhookCall(orgId, createAWebhookRequest, _callback);
     ...
     */
    public void createAWebhook(String orgId, CreateAWebhookRequest createAWebhookRequest) throws ApiException {
        createAWebhookWithHttpInfo(orgId, createAWebhookRequest);
    }
     ...
     */
    public ApiResponse<Void> createAWebhookWithHttpInfo(String orgId, CreateAWebhookRequest createAWebhookRequest) throws ApiException {
        okhttp3.Call localVarCall = createAWebhookValidateBeforeCall(orgId, createAWebhookRequest, null);
     ...
     */
    public okhttp3.Call createAWebhookAsync(String orgId, CreateAWebhookRequest createAWebhookRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAWebhookValidateBeforeCall(orgId, createAWebhookRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteAWebhook
     * @param orgId Automatically added (required)
     * @param webhookId Automatically added (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteAWebhookCall(String orgId, String webhookId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/org/{orgId}/webhooks/{webhookId}"
            .replace("{" + "orgId" + "}", localVarApiClient.escapeString(orgId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAWebhookValidateBeforeCall(String orgId, String webhookId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling deleteAWebhook(Async)");
        }

        // verify the required parameter 'webhookId' is set
        if (webhookId == null) {
            throw new ApiException("Missing the required parameter 'webhookId' when calling deleteAWebhook(Async)");
        }

        return deleteAWebhookCall(orgId, webhookId, _callback);
     ...
     */
    public void deleteAWebhook(String orgId, String webhookId) throws ApiException {
        deleteAWebhookWithHttpInfo(orgId, webhookId);
    }
     ...
     */
    public ApiResponse<Void> deleteAWebhookWithHttpInfo(String orgId, String webhookId) throws ApiException {
        okhttp3.Call localVarCall = deleteAWebhookValidateBeforeCall(orgId, webhookId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call deleteAWebhookAsync(String orgId, String webhookId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAWebhookValidateBeforeCall(orgId, webhookId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call listWebhooksCall(String orgId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listWebhooksValidateBeforeCall(String orgId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling listWebhooks(Async)");
        }

        return listWebhooksCall(orgId, _callback);
     ...
     */
    public void listWebhooks(String orgId) throws ApiException {
        listWebhooksWithHttpInfo(orgId);
    }
     ...
     */
    public ApiResponse<Void> listWebhooksWithHttpInfo(String orgId) throws ApiException {
        okhttp3.Call localVarCall = listWebhooksValidateBeforeCall(orgId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call listWebhooksAsync(String orgId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = listWebhooksValidateBeforeCall(orgId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for pingAWebhook
     ...
     */
    public okhttp3.Call pingAWebhookCall(String orgId, String webhookId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/org/{orgId}/webhooks/{webhookId}/ping"
            .replace("{" + "orgId" + "}", localVarApiClient.escapeString(orgId.toString()))
            .replace("{" + "webhookId" + "}", localVarApiClient.escapeString(webhookId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pingAWebhookValidateBeforeCall(String orgId, String webhookId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling pingAWebhook(Async)");
        }

        // verify the required parameter 'webhookId' is set
        if (webhookId == null) {
            throw new ApiException("Missing the required parameter 'webhookId' when calling pingAWebhook(Async)");
        }

        return pingAWebhookCall(orgId, webhookId, _callback);
     ...
     */
    public void pingAWebhook(String orgId, String webhookId) throws ApiException {
        pingAWebhookWithHttpInfo(orgId, webhookId);
    }
     ...
     */
    public ApiResponse<Void> pingAWebhookWithHttpInfo(String orgId, String webhookId) throws ApiException {
        okhttp3.Call localVarCall = pingAWebhookValidateBeforeCall(orgId, webhookId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Ping a webhook (asynchronously)
     * 
     * @param orgId The organization ID the project belongs to. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param webhookId The webhook ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call pingAWebhookAsync(String orgId, String webhookId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = pingAWebhookValidateBeforeCall(orgId, webhookId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for retrieveAWebhook
     * @param orgId The organization ID the project belongs to. The &#x60;API_KEY&#x60; must have access to this organization. (required)
     * @param webhookId The webhook ID. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call retrieveAWebhookCall(String orgId, String webhookId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveAWebhookValidateBeforeCall(String orgId, String webhookId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'orgId' is set
        if (orgId == null) {
            throw new ApiException("Missing the required parameter 'orgId' when calling retrieveAWebhook(Async)");
        }

        // verify the required parameter 'webhookId' is set
        if (webhookId == null) {
            throw new ApiException("Missing the required parameter 'webhookId' when calling retrieveAWebhook(Async)");
        }

        return retrieveAWebhookCall(orgId, webhookId, _callback);
     ...
     */
    public void retrieveAWebhook(String orgId, String webhookId) throws ApiException {
        retrieveAWebhookWithHttpInfo(orgId, webhookId);
    }
     ...
     */
    public ApiResponse<Void> retrieveAWebhookWithHttpInfo(String orgId, String webhookId) throws ApiException {
        okhttp3.Call localVarCall = retrieveAWebhookValidateBeforeCall(orgId, webhookId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call retrieveAWebhookAsync(String orgId, String webhookId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = retrieveAWebhookValidateBeforeCall(orgId, webhookId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
