...
public class CreateANewOrganizationRequest {
  ...
  public static final String SERIALIZED_NAME_SOURCE_ORG_ID = "sourceOrgId";
  @SerializedName(SERIALIZED_NAME_SOURCE_ORG_ID)
  private String sourceOrgId;

  public CreateANewOrganizationRequest() {
  }

  public CreateANewOrganizationRequest groupId(String groupId) {
  ...
  public CreateANewOrganizationRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateANewOrganizationRequest sourceOrgId(String sourceOrgId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateANewOrganizationRequest createANewOrganizationRequest = (CreateANewOrganizationRequest) o;
    return Objects.equals(this.groupId, createANewOrganizationRequest.groupId) &&
        Objects.equals(this.name, createANewOrganizationRequest.name) &&
        Objects.equals(this.sourceOrgId, createANewOrganizationRequest.sourceOrgId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, name, sourceOrgId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateANewOrganizationRequest {\n");
    sb.append("    groupId: ").append(toIndentedString(groupId)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    sourceOrgId: ").append(toIndentedString(sourceOrgId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateANewOrganizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateANewOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateANewOrganizationRequest is not found in the empty JSON string", CreateANewOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateANewOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateANewOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateANewOrganizationRequest.openapiRequiredFields) {
      ...
      if ((jsonObj.get("sourceOrgId") != null && !jsonObj.get("sourceOrgId").isJsonNull()) && !jsonObj.get("sourceOrgId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sourceOrgId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sourceOrgId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateANewOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateANewOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateANewOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateANewOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateANewOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, CreateANewOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateANewOrganizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateANewOrganizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateANewOrganizationRequest
   * @throws IOException if the JSON string is invalid with respect to CreateANewOrganizationRequest
   */
  public static CreateANewOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateANewOrganizationRequest.class);
  }

  /**
   * Convert an instance of CreateANewOrganizationRequest to an JSON string
   *
   * @return JSON string
   */
