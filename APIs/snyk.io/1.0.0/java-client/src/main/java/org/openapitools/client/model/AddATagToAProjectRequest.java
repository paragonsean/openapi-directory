...
public class AddATagToAProjectRequest {
  ...
  public AddATagToAProjectRequest() {
  }

  public AddATagToAProjectRequest key(String key) {
    this.key = key;
    return this;
  }
  ...
  public AddATagToAProjectRequest value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddATagToAProjectRequest addATagToAProjectRequest = (AddATagToAProjectRequest) o;
    return Objects.equals(this.key, addATagToAProjectRequest.key) &&
        Objects.equals(this.value, addATagToAProjectRequest.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddATagToAProjectRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddATagToAProjectRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddATagToAProjectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddATagToAProjectRequest is not found in the empty JSON string", AddATagToAProjectRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddATagToAProjectRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddATagToAProjectRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddATagToAProjectRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddATagToAProjectRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddATagToAProjectRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddATagToAProjectRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddATagToAProjectRequest>() {
           @Override
           public void write(JsonWriter out, AddATagToAProjectRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddATagToAProjectRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddATagToAProjectRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddATagToAProjectRequest
   * @throws IOException if the JSON string is invalid with respect to AddATagToAProjectRequest
   */
  public static AddATagToAProjectRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddATagToAProjectRequest.class);
  }

  /**
   * Convert an instance of AddATagToAProjectRequest to an JSON string
   *
   * @return JSON string
   */
