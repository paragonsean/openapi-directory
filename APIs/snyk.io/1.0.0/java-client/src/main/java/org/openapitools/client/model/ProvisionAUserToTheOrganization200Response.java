...
public class ProvisionAUserToTheOrganization200Response {
  ...
  public ProvisionAUserToTheOrganization200Response() {
  }

  public ProvisionAUserToTheOrganization200Response created(String created) {
  ...
  public ProvisionAUserToTheOrganization200Response email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ProvisionAUserToTheOrganization200Response role(String role) {
    this.role = role;
    return this;
  }
  ...
  public ProvisionAUserToTheOrganization200Response rolePublicId(String rolePublicId) {
  ...
  public boolean equals(Object o) {
    ...
    ProvisionAUserToTheOrganization200Response provisionAUserToTheOrganization200Response = (ProvisionAUserToTheOrganization200Response) o;
    return Objects.equals(this.created, provisionAUserToTheOrganization200Response.created) &&
        Objects.equals(this.email, provisionAUserToTheOrganization200Response.email) &&
        Objects.equals(this.role, provisionAUserToTheOrganization200Response.role) &&
        Objects.equals(this.rolePublicId, provisionAUserToTheOrganization200Response.rolePublicId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, email, role, rolePublicId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProvisionAUserToTheOrganization200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProvisionAUserToTheOrganization200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionAUserToTheOrganization200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisionAUserToTheOrganization200Response is not found in the empty JSON string", ProvisionAUserToTheOrganization200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionAUserToTheOrganization200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisionAUserToTheOrganization200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisionAUserToTheOrganization200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisionAUserToTheOrganization200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisionAUserToTheOrganization200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisionAUserToTheOrganization200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisionAUserToTheOrganization200Response>() {
           @Override
           public void write(JsonWriter out, ProvisionAUserToTheOrganization200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisionAUserToTheOrganization200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProvisionAUserToTheOrganization200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProvisionAUserToTheOrganization200Response
   * @throws IOException if the JSON string is invalid with respect to ProvisionAUserToTheOrganization200Response
   */
  public static ProvisionAUserToTheOrganization200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisionAUserToTheOrganization200Response.class);
  }

  /**
   * Convert an instance of ProvisionAUserToTheOrganization200Response to an JSON string
   *
   * @return JSON string
   */
