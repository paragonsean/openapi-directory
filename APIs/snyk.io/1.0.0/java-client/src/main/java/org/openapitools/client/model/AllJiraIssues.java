...
public class AllJiraIssues {
  public static final String SERIALIZED_NAME_ISSUE_ID = "issueId";
  @SerializedName(SERIALIZED_NAME_ISSUE_ID)
  private List<Object> issueId = new ArrayList<>();

  public AllJiraIssues() {
  }

  public AllJiraIssues issueId(List<Object> issueId) {
    this.issueId = issueId;
    return this;
  }

  public AllJiraIssues addIssueIdItem(Object issueIdItem) {
  ...
  public List<Object> getIssueId() {
    return issueId;
  }

  public void setIssueId(List<Object> issueId) {
    this.issueId = issueId;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllJiraIssues allJiraIssues = (AllJiraIssues) o;
    return Objects.equals(this.issueId, allJiraIssues.issueId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllJiraIssues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllJiraIssues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllJiraIssues is not found in the empty JSON string", AllJiraIssues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllJiraIssues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllJiraIssues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AllJiraIssues.openapiRequiredFields) {
      ...
      if (jsonObj.get("issueId") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("issueId").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllJiraIssues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllJiraIssues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllJiraIssues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllJiraIssues.class));

       return (TypeAdapter<T>) new TypeAdapter<AllJiraIssues>() {
           @Override
           public void write(JsonWriter out, AllJiraIssues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllJiraIssues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllJiraIssues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllJiraIssues
   * @throws IOException if the JSON string is invalid with respect to AllJiraIssues
   */
  public static AllJiraIssues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllJiraIssues.class);
  }

  /**
   * Convert an instance of AllJiraIssues to an JSON string
   *
   * @return JSON string
   */
