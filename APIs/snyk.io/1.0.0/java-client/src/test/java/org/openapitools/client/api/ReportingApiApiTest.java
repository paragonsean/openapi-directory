...
/**
 * API tests for ReportingApiApi
 */
@Disabled
public class ReportingApiApiTest {

    private final ReportingApiApi api = new ReportingApiApi();
     ...
     */
    @Test
    public void getIssueCountsTest() throws ApiException {
        String from = null;
        String to = null;
        String groupBy = null;
        GetIssueCountsRequest getIssueCountsRequest = null;
        GetIssueCounts200Response response = api.getIssueCounts(from, to, groupBy, getIssueCountsRequest);
     ...
     */
    @Test
    public void getLatestIssueCountsTest() throws ApiException {
        String groupBy = null;
        GetIssueCountsRequest getIssueCountsRequest = null;
        GetIssueCounts200Response response = api.getLatestIssueCounts(groupBy, getIssueCountsRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getLatestProjectCountsTest() throws ApiException {
        GetProjectCountsRequest getProjectCountsRequest = null;
        GetProjectCounts200Response response = api.getLatestProjectCounts(getProjectCountsRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getListOfIssuesTest() throws ApiException {
        String from = null;
        String to = null;
        ...
        String order = null;
        String groupBy = null;
        GetListOfIssuesRequest getListOfIssuesRequest = null;
        GetListOfIssues200Response response = api.getListOfIssues(from, to, page, perPage, sortBy, order, groupBy, getListOfIssuesRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getListOfLatestIssuesTest() throws ApiException {
        BigDecimal page = null;
        BigDecimal perPage = null;
        String sortBy = null;
        String order = null;
        String groupBy = null;
        GetListOfIssuesRequest getListOfIssuesRequest = null;
        GetListOfIssues200Response response = api.getListOfLatestIssues(page, perPage, sortBy, order, groupBy, getListOfIssuesRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getProjectCountsTest() throws ApiException {
        String from = null;
        String to = null;
        GetProjectCountsRequest getProjectCountsRequest = null;
        GetProjectCounts200Response response = api.getProjectCounts(from, to, getProjectCountsRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTestCountsTest() throws ApiException {
        String from = null;
        String to = null;
        String groupBy = null;
        GetTestCountsRequest getTestCountsRequest = null;
        GetTestCounts200Response response = api.getTestCounts(from, to, groupBy, getTestCountsRequest);
        // TODO: test validations
    }
