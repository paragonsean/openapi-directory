...
|**dependenciesWithIssues** | **List&lt;Object&gt;** | The identifiers of dependencies with issues that are depended upon as a result of this dependency |  [optional] |
|**deprecatedVersions** | **List&lt;Object&gt;** | The numbers for those versions that are marked as deprecated |  [optional] |
...
|**issuesCritical** | **BigDecimal** | The number of critical severity issues in this dependency |  [optional] |
|**issuesHigh** | **BigDecimal** | The number of high severity issues in this dependency |  [optional] |
|**issuesLow** | **BigDecimal** | The number of low severity issues in this dependency |  [optional] |
|**issuesMedium** | **BigDecimal** | The number of medium severity issues in this dependency |  [optional] |
