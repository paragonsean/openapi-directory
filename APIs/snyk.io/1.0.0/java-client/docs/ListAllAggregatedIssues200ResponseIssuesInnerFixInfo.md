...
|------------ | ------------- | ------------- | -------------|
|**fixedIn** | **List&lt;Object&gt;** | The set of versions in which this issue has been fixed. If the issue spanned multiple versions (i.e. &#x60;1.x&#x60; and &#x60;2.x&#x60;) then there will be multiple &#x60;fixedIn&#x60; entries |  [optional] |
