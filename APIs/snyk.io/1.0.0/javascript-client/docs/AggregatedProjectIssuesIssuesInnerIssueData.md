# SnykApi.AggregatedProjectIssuesIssuesInnerIssueData
...
**credit** | **[Object]** | The list of people responsible for first uncovering or reporting the issue (Non-IaC projects only) | [optional] 
**cvssScore** | **Number** | The CVSS score that results from running the CVSSv3 string (Non-IaC projects only) | [optional] 
...
**patches** | **[Object]** | A list of patches available for the given issue (Non-IaC projects only) | [optional] 
