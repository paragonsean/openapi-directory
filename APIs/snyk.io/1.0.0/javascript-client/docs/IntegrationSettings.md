...
**autoDepUpgradeIgnoredDependencies** | **[Object]** | A list of strings defining what dependencies should be ignored | [optional] 
**autoDepUpgradeLimit** | **Number** | A limit on how many automatic dependency upgrade PRs can be opened simultaneously | [optional] 
