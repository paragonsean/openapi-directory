# SnykApi.GetListOfIssues200ResponseResultsInnerIssue
...
**credit** | **[Object]** | The list of people responsible for first uncovering or reporting the issue (not applicable to licenses) | [optional] 
**cvssScore** | **Number** | The CVSS score that results from running the CVSSv3 string (not applicable to licenses) | [optional] 
...
**ignored** | **[Object]** | The list of ignore rules that were applied to the issue (only present if issue was ignored and no &#x60;groupBy&#x60; in the API request) | [optional] 
...
**patches** | **[Object]** | A list of patches available for the given issue (not applicable to licenses) | [optional] 
**priorityScore** | **Number** | The priority score ranging between 0-1000 | [optional] 
...
**uniqueSeveritiesList** | **[Object]** | A list of all severities in issue per projects | [optional] 
