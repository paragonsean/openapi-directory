# SnykApi.RetrieveASingleProject200Response
...
**hostname** | **String** | The hostname for a CLI project, null if not set | [optional] 
...
**remediation** | [**RetrieveASingleProject200ResponseRemediation**](RetrieveASingleProject200ResponseRemediation.md) |  | [optional] 
**remoteRepoUrl** | **String** | The project remote repository url. Only set for projects imported via the Snyk CLI tool. | [optional] 
**tags** | **[Object]** | List of applied tags | [optional] 
...
**totalDependencies** | **Number** | Number of dependencies of the project | [optional] 
