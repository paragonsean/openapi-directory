# SnykApi.ListAllAggregatedIssues200ResponseIssuesInner
...
**ignoreReasons** | **[Object]** | The list of reasons why the issue was ignored | [optional] 
**introducedThrough** | **[Object]** | The list of what introduced the issue (it is available only for container project with Dockerfile) | [optional] 
...
**issueData** | [**ListAllAggregatedIssues200ResponseIssuesInnerIssueData**](ListAllAggregatedIssues200ResponseIssuesInnerIssueData.md) |  | 
...
**pkgVersions** | **[String]** | List of affected package versions (Non-IaC projects only) | 
