...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SnykApi.ListAllAggregatedIssues200ResponseIssuesInnerIssueData();
  });
  ...
  describe('ListAllAggregatedIssues200ResponseIssuesInnerIssueData', function() {
    it('should create an instance of ListAllAggregatedIssues200ResponseIssuesInnerIssueData', function() {
      // uncomment below and update the code to test ListAllAggregatedIssues200ResponseIssuesInnerIssueData
      //var instance = new SnykApi.ListAllAggregatedIssues200ResponseIssuesInnerIssueData();
      //expect(instance).to.be.a(SnykApi.ListAllAggregatedIssues200ResponseIssuesInnerIssueData);
    });
