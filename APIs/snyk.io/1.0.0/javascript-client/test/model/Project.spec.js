...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.SnykApi);
  }
}(this, function(expect, SnykApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new SnykApi.Project();
  });
  ...
  describe('Project', function() {
    it('should create an instance of Project', function() {
      ...
      //var instance = new SnykApi.Project();
      //expect(instance).to.be.a(SnykApi.Project);
    });
    ...
    it('should have the property browseUrl (base name: "browseUrl")', function() {
      // uncomment below and update the code to test the property browseUrl
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });
    ...
    it('should have the property imageBaseImage (base name: "imageBaseImage")', function() {
      // uncomment below and update the code to test the property imageBaseImage
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });

    it('should have the property imageCluster (base name: "imageCluster")', function() {
      // uncomment below and update the code to test the property imageCluster
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });
    ...
    it('should have the property imagePlatform (base name: "imagePlatform")', function() {
      // uncomment below and update the code to test the property imagePlatform
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });
    ...
    it('should have the property importingUser (base name: "importingUser")', function() {
      // uncomment below and update the code to test the property importingUser
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });
    ...
    it('should have the property issueCountsBySeverity (base name: "issueCountsBySeverity")', function() {
      // uncomment below and update the code to test the property issueCountsBySeverity
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });

    it('should have the property lastTestedDate (base name: "lastTestedDate")', function() {
      // uncomment below and update the code to test the property lastTestedDate
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });
    ...
    it('should have the property remoteRepoUrl (base name: "remoteRepoUrl")', function() {
      // uncomment below and update the code to test the property remoteRepoUrl
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });
    ...
    it('should have the property targetReference (base name: "targetReference")', function() {
      // uncomment below and update the code to test the property targetReference
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });

    it('should have the property testFrequency (base name: "testFrequency")', function() {
      // uncomment below and update the code to test the property testFrequency
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });

    it('should have the property totalDependencies (base name: "totalDependencies")', function() {
      // uncomment below and update the code to test the property totalDependencies
      //var instance = new SnykApi.Project();
      //expect(instance).to.be();
    });
