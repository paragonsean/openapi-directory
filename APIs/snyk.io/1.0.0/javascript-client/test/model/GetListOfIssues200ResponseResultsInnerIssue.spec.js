...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
  });
  ...
  describe('GetListOfIssues200ResponseResultsInnerIssue', function() {
    it('should create an instance of GetListOfIssues200ResponseResultsInnerIssue', function() {
      // uncomment below and update the code to test GetListOfIssues200ResponseResultsInnerIssue
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be.a(SnykApi.GetListOfIssues200ResponseResultsInnerIssue);
    });
    ...
    it('should have the property isIgnored (base name: "isIgnored")', function() {
      // uncomment below and update the code to test the property isIgnored
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be();
    });

    it('should have the property isPatchable (base name: "isPatchable")', function() {
      // uncomment below and update the code to test the property isPatchable
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be();
    });

    it('should have the property isPatched (base name: "isPatched")', function() {
      // uncomment below and update the code to test the property isPatched
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be();
    });

    it('should have the property isPinnable (base name: "isPinnable")', function() {
      // uncomment below and update the code to test the property isPinnable
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be();
    });
    ...
    it('should have the property jiraIssueUrl (base name: "jiraIssueUrl")', function() {
      // uncomment below and update the code to test the property jiraIssueUrl
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be();
    });
    ...
    it('should have the property priorityScore (base name: "priorityScore")', function() {
      // uncomment below and update the code to test the property priorityScore
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be();
    });
    ...
    it('should have the property uniqueSeveritiesList (base name: "uniqueSeveritiesList")', function() {
      // uncomment below and update the code to test the property uniqueSeveritiesList
      //var instance = new SnykApi.GetListOfIssues200ResponseResultsInnerIssue();
      //expect(instance).to.be();
    });
