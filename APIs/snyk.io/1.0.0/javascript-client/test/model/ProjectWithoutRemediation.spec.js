...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SnykApi.ProjectWithoutRemediation();
  });
  ...
  describe('ProjectWithoutRemediation', function() {
    it('should create an instance of ProjectWithoutRemediation', function() {
      // uncomment below and update the code to test ProjectWithoutRemediation
      //var instance = new SnykApi.ProjectWithoutRemediation();
      //expect(instance).to.be.a(SnykApi.ProjectWithoutRemediation);
    });
