...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
  });
  ...
  describe('AggregatedProjectIssuesIssuesInnerIssueData', function() {
    it('should create an instance of AggregatedProjectIssuesIssuesInnerIssueData', function() {
      // uncomment below and update the code to test AggregatedProjectIssuesIssuesInnerIssueData
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be.a(SnykApi.AggregatedProjectIssuesIssuesInnerIssueData);
    });
    ...
    it('should have the property disclosureTime (base name: "disclosureTime")', function() {
      // uncomment below and update the code to test the property disclosureTime
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });

    it('should have the property exploitMaturity (base name: "exploitMaturity")', function() {
      // uncomment below and update the code to test the property exploitMaturity
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isMaliciousPackage (base name: "isMaliciousPackage")', function() {
      // uncomment below and update the code to test the property isMaliciousPackage
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nearestFixedInVersion (base name: "nearestFixedInVersion")', function() {
      // uncomment below and update the code to test the property nearestFixedInVersion
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });

    it('should have the property originalSeverity (base name: "originalSeverity")', function() {
      // uncomment below and update the code to test the property originalSeverity
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property publicationTime (base name: "publicationTime")', function() {
      // uncomment below and update the code to test the property publicationTime
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });

    it('should have the property semver (base name: "semver")', function() {
      // uncomment below and update the code to test the property semver
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });
    ...
    it('should have the property violatedPolicyPublicId (base name: "violatedPolicyPublicId")', function() {
      // uncomment below and update the code to test the property violatedPolicyPublicId
      //var instance = new SnykApi.AggregatedProjectIssuesIssuesInnerIssueData();
      //expect(instance).to.be();
    });
