...
export default class IntegrationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addNewIntegration operation.
     * @callback module:api/IntegrationsApi~addNewIntegrationCallback
     ...
     * @param {module:model/AddNewIntegrationRequest} [addNewIntegrationRequest] 
     * @param {module:api/IntegrationsApi~addNewIntegrationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addNewIntegration(orgId, opts, callback) {
      opts = opts || {};
      let postBody = opts['addNewIntegrationRequest'];
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling addNewIntegration");
      }
    ...
    /**
     * Callback function to receive the result of the cloneAnIntegrationWithSettingsAndCredentials operation.
     * @callback module:api/IntegrationsApi~cloneAnIntegrationWithSettingsAndCredentialsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} orgId Source organization public ID to clone integration settings from. The `API_KEY` must have access to this organization.
     * @param {String} integrationId Source integration public ID to clone.
     * @param {Object} opts Optional parameters
     * @param {module:model/CloneAnIntegrationWithSettingsAndCredentialsRequest} [cloneAnIntegrationWithSettingsAndCredentialsRequest] 
     * @param {module:api/IntegrationsApi~cloneAnIntegrationWithSettingsAndCredentialsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    cloneAnIntegrationWithSettingsAndCredentials(orgId, integrationId, opts, callback) {
      opts = opts || {};
      let postBody = opts['cloneAnIntegrationWithSettingsAndCredentialsRequest'];
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling cloneAnIntegrationWithSettingsAndCredentials");
      }
      // verify the required parameter 'integrationId' is set
      if (integrationId === undefined || integrationId === null) {
        throw new Error("Missing the required parameter 'integrationId' when calling cloneAnIntegrationWithSettingsAndCredentials");
      }
     ...
     * @callback module:api/IntegrationsApi~deleteCredentialsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/IntegrationsApi~deleteCredentialsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteCredentials(orgId, integrationId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling deleteCredentials");
      }
      // verify the required parameter 'integrationId' is set
      if (integrationId === undefined || integrationId === null) {
        throw new Error("Missing the required parameter 'integrationId' when calling deleteCredentials");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/org/{orgId}/integrations/{integrationId}/authentication', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getExistingIntegrationByType operation.
     * @callback module:api/IntegrationsApi~getExistingIntegrationByTypeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetExistingIntegrationByType200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {String} orgId The `API_KEY` must have admin access to this organization.
     * @param {String} type Integration type.
     * @param {module:api/IntegrationsApi~getExistingIntegrationByTypeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetExistingIntegrationByType200Response}
     */
    getExistingIntegrationByType(orgId, type, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling getExistingIntegrationByType");
      }
      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getExistingIntegrationByType");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json; charset=utf-8'];
      let returnType = GetExistingIntegrationByType200Response;
      return this.apiClient.callApi(
        '/org/{orgId}/integrations/{type}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * List
     * 
     * @param {String} orgId The organization public ID. The `API_KEY` must have admin access to this organization.
    ...
    list(orgId, callback) {
      ...
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling list");
      }
    ...
    /**
     * Callback function to receive the result of the provisionNewBrokerToken operation.
     * @callback module:api/IntegrationsApi~provisionNewBrokerTokenCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} orgId The `API_KEY` must have access to this organization.
     * @param {String} integrationId 
     * @param {module:api/IntegrationsApi~provisionNewBrokerTokenCallback} callback The callback function, accepting three arguments: error, data, response
     */
    provisionNewBrokerToken(orgId, integrationId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling provisionNewBrokerToken");
      }
      // verify the required parameter 'integrationId' is set
      if (integrationId === undefined || integrationId === null) {
        throw new Error("Missing the required parameter 'integrationId' when calling provisionNewBrokerToken");
      }
     ...
     * @callback module:api/IntegrationsApi~retrieveCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Retrieve200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {String} orgId The organization ID. The `API_KEY` must have admin access to this organization.
     * @param {String} integrationId The unique identifier for the configured integration. This can be found on the [Integration page in the Settings area](https://app.snyk.io/manage/integrations) for all integrations that have been configured.
     * @param {module:api/IntegrationsApi~retrieveCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Retrieve200Response}
     */
    retrieve(orgId, integrationId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling retrieve");
      }
      // verify the required parameter 'integrationId' is set
      if (integrationId === undefined || integrationId === null) {
        throw new Error("Missing the required parameter 'integrationId' when calling retrieve");
      }
      ...
      let contentTypes = [];
      let accepts = ['*/*'];
      let returnType = Retrieve200Response;
      return this.apiClient.callApi(
        '/org/{orgId}/integrations/{integrationId}/settings', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the switchBetweenBrokerTokens operation.
     * @callback module:api/IntegrationsApi~switchBetweenBrokerTokensCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} orgId The `API_KEY` must have access to this organization.
     * @param {String} integrationId 
     * @param {module:api/IntegrationsApi~switchBetweenBrokerTokensCallback} callback The callback function, accepting three arguments: error, data, response
     */
    switchBetweenBrokerTokens(orgId, integrationId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling switchBetweenBrokerTokens");
      }
      // verify the required parameter 'integrationId' is set
      if (integrationId === undefined || integrationId === null) {
        throw new Error("Missing the required parameter 'integrationId' when calling switchBetweenBrokerTokens");
      }
     ...
     * @callback module:api/IntegrationsApi~updateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Retrieve200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/IntegrationsApi~updateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Retrieve200Response}
     */
    update(orgId, integrationId, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateRequest'];
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling update");
      }
      // verify the required parameter 'integrationId' is set
      if (integrationId === undefined || integrationId === null) {
        throw new Error("Missing the required parameter 'integrationId' when calling update");
      }
      ...
      let returnType = Retrieve200Response;
      return this.apiClient.callApi(
        '/org/{orgId}/integrations/{integrationId}/settings', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateExistingIntegration operation.
     * @callback module:api/IntegrationsApi~updateExistingIntegrationCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} integrationId The unique identifier for the configured integration. This can be found on the [Integration page in the Settings area](https://app.snyk.io/manage/integrations) for all integrations that have been configured.
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateExistingIntegrationRequest} [updateExistingIntegrationRequest] 
     * @param {module:api/IntegrationsApi~updateExistingIntegrationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateExistingIntegration(orgId, integrationId, opts, callback) {
      opts = opts || {};
      let postBody = opts['updateExistingIntegrationRequest'];
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling updateExistingIntegration");
      }
      // verify the required parameter 'integrationId' is set
      if (integrationId === undefined || integrationId === null) {
        throw new Error("Missing the required parameter 'integrationId' when calling updateExistingIntegration");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/org/{orgId}/integrations/{integrationId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
