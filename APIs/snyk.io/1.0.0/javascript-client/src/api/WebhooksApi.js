...
export default class WebhooksApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createAWebhook operation.
     * @callback module:api/WebhooksApi~createAWebhookCallback
     ...
     * @param {module:model/CreateAWebhookRequest} [createAWebhookRequest] 
     * @param {module:api/WebhooksApi~createAWebhookCallback} callback The callback function, accepting three arguments: error, data, response
     */
    createAWebhook(orgId, opts, callback) {
      opts = opts || {};
      let postBody = opts['createAWebhookRequest'];
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling createAWebhook");
      }
    ...
    /**
     * Callback function to receive the result of the deleteAWebhook operation.
     * @callback module:api/WebhooksApi~deleteAWebhookCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} webhookId Automatically added
     * @param {module:api/WebhooksApi~deleteAWebhookCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteAWebhook(orgId, webhookId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling deleteAWebhook");
      }
      // verify the required parameter 'webhookId' is set
      if (webhookId === undefined || webhookId === null) {
        throw new Error("Missing the required parameter 'webhookId' when calling deleteAWebhook");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/org/{orgId}/webhooks/{webhookId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    listWebhooks(orgId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling listWebhooks");
      }
    ...
    /**
     * Callback function to receive the result of the pingAWebhook operation.
     * @callback module:api/WebhooksApi~pingAWebhookCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/WebhooksApi~pingAWebhookCallback} callback The callback function, accepting three arguments: error, data, response
     */
    pingAWebhook(orgId, webhookId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling pingAWebhook");
      }
      // verify the required parameter 'webhookId' is set
      if (webhookId === undefined || webhookId === null) {
        throw new Error("Missing the required parameter 'webhookId' when calling pingAWebhook");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/org/{orgId}/webhooks/{webhookId}/ping', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the retrieveAWebhook operation.
     * @callback module:api/WebhooksApi~retrieveAWebhookCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} orgId The organization ID the project belongs to. The `API_KEY` must have access to this organization.
     * @param {String} webhookId The webhook ID.
     * @param {module:api/WebhooksApi~retrieveAWebhookCallback} callback The callback function, accepting three arguments: error, data, response
     */
    retrieveAWebhook(orgId, webhookId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling retrieveAWebhook");
      }
      // verify the required parameter 'webhookId' is set
      if (webhookId === undefined || webhookId === null) {
        throw new Error("Missing the required parameter 'webhookId' when calling retrieveAWebhook");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/org/{orgId}/webhooks/{webhookId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
