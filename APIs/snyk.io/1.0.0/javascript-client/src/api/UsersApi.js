...
export default class UsersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getMyDetails operation.
     * @callback module:api/UsersApi~getMyDetailsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetMyDetails200Response} data The data returned by the service call.
     ...
     * Get My Details
     * 
     * @param {module:api/UsersApi~getMyDetailsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetMyDetails200Response}
     */
    getMyDetails(callback) {
      ...
      let returnType = GetMyDetails200Response;
    ...
    /**
     * Callback function to receive the result of the getOrganizationNotificationSettings operation.
     * @callback module:api/UsersApi~getOrganizationNotificationSettingsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsersApi~getOrganizationNotificationSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrgOrgIdNotificationSettingsGet200Response}
     */
    getOrganizationNotificationSettings(orgId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling getOrganizationNotificationSettings");
      }
      ...
      return this.apiClient.callApi(
        '/user/me/notification-settings/org/{orgId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getProjectNotificationSettings operation.
     * @callback module:api/UsersApi~getProjectNotificationSettingsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrgOrgIdNotificationSettingsGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {String} orgId The organization ID. The `API_KEY` must have access to this organization.
     * @param {String} projectId The project ID to return notification settings for.
     * @param {module:api/UsersApi~getProjectNotificationSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrgOrgIdNotificationSettingsGet200Response}
     */
    getProjectNotificationSettings(orgId, projectId, callback) {
      let postBody = null;
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling getProjectNotificationSettings");
      }
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
        throw new Error("Missing the required parameter 'projectId' when calling getProjectNotificationSettings");
      }
      ...
      let returnType = OrgOrgIdNotificationSettingsGet200Response;
      return this.apiClient.callApi(
        '/user/me/notification-settings/org/{orgId}/project/{projectId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/UsersApi~getUserDetailsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetUserDetails200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Get User Details
     * 
     * @param {String} userId The users ID. The `API_KEY` must have admin access to at least one group or organization where the requested user is a member and must have the `api` entitlement on their preferred organization.
     ...
     * data is of type: {@link module:model/GetUserDetails200Response}
     */
    getUserDetails(userId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json; charset=utf-8'];
      let returnType = GetUserDetails200Response;
      return this.apiClient.callApi(
        '/user/{userId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the modifyOrganizationNotificationSettings operation.
     * @callback module:api/UsersApi~modifyOrganizationNotificationSettingsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrgOrgIdNotificationSettingsGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UsersApi~modifyOrganizationNotificationSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrgOrgIdNotificationSettingsGet200Response}
     */
    modifyOrganizationNotificationSettings(orgId, opts, callback) {
      opts = opts || {};
      let postBody = opts['setNotificationSettingsRequest'];
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling modifyOrganizationNotificationSettings");
      }
      ...
      let returnType = OrgOrgIdNotificationSettingsGet200Response;
      return this.apiClient.callApi(
        '/user/me/notification-settings/org/{orgId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the modifyProjectNotificationSettings operation.
     * @callback module:api/UsersApi~modifyProjectNotificationSettingsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ModifyProjectNotificationSettingsRequest} [modifyProjectNotificationSettingsRequest] 
     * @param {module:api/UsersApi~modifyProjectNotificationSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    modifyProjectNotificationSettings(orgId, projectId, opts, callback) {
      opts = opts || {};
      let postBody = opts['modifyProjectNotificationSettingsRequest'];
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling modifyProjectNotificationSettings");
      }
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
        throw new Error("Missing the required parameter 'projectId' when calling modifyProjectNotificationSettings");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/user/me/notification-settings/org/{orgId}/project/{projectId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
