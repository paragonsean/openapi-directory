...
* @module api/ReportingAPIApi
* @version 1.0.0
*/
export default class ReportingAPIApi {

    /**
    * Constructs a new ReportingAPIApi. 
    * @alias module:api/ReportingAPIApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getIssueCounts operation.
     * @callback module:api/ReportingAPIApi~getIssueCountsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetIssueCounts200Response} data The data returned by the service call.
     ...
     * Get issue counts
     * 
     * @param {String} from The date you wish to fetch results from, in the format `YYYY-MM-DD`
     * @param {String} to The date you wish to fetch results until, in the format `YYYY-MM-DD`
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [groupBy] The field to group results by
     * @param {module:model/GetIssueCountsRequest} [getIssueCountsRequest] 
     * @param {module:api/ReportingAPIApi~getIssueCountsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetIssueCounts200Response}
     */
    getIssueCounts(from, to, opts, callback) {
      opts = opts || {};
      let postBody = opts['getIssueCountsRequest'];
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getIssueCounts");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getIssueCounts");
      }
      ...
      let returnType = GetIssueCounts200Response;
      return this.apiClient.callApi(
        '/reporting/counts/issues', 'POST',
    ...
    /**
     * Callback function to receive the result of the getLatestIssueCounts operation.
     * @callback module:api/ReportingAPIApi~getLatestIssueCountsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetIssueCounts200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} [groupBy] The field to group results by
     * @param {module:model/GetIssueCountsRequest} [getIssueCountsRequest] 
     * @param {module:api/ReportingAPIApi~getLatestIssueCountsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetIssueCounts200Response}
     */
    getLatestIssueCounts(opts, callback) {
      opts = opts || {};
      let postBody = opts['getIssueCountsRequest'];
      ...
      let returnType = GetIssueCounts200Response;
      return this.apiClient.callApi(
        '/reporting/counts/issues/latest', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getLatestProjectCounts operation.
     * @callback module:api/ReportingAPIApi~getLatestProjectCountsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetProjectCounts200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Object} opts Optional parameters
     * @param {module:model/GetProjectCountsRequest} [getProjectCountsRequest] 
     * @param {module:api/ReportingAPIApi~getLatestProjectCountsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetProjectCounts200Response}
     */
    getLatestProjectCounts(opts, callback) {
      opts = opts || {};
      let postBody = opts['getProjectCountsRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json; charset=utf-8'];
      let returnType = GetProjectCounts200Response;
      return this.apiClient.callApi(
        '/reporting/counts/projects/latest', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getListOfIssues operation.
     * @callback module:api/ReportingAPIApi~getListOfIssuesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetListOfIssues200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} to The date you wish to fetch results until, in the format `YYYY-MM-DD`
     * @param {Object} opts Optional parameters
     * @param {Number} [page] The page of results to request
     * @param {Number} [perPage] The number of results to return per page (Maximum: 1000)
     * @param {module:model/String} [sortBy] The key to sort results by
     * @param {String} [order] The direction to sort results.
     * @param {module:model/String} [groupBy] Set to issue to group the same issue in multiple projects
     * @param {module:model/GetListOfIssuesRequest} [getListOfIssuesRequest] 
     * @param {module:api/ReportingAPIApi~getListOfIssuesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetListOfIssues200Response}
     */
    getListOfIssues(from, to, opts, callback) {
      opts = opts || {};
      let postBody = opts['getListOfIssuesRequest'];
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getListOfIssues");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getListOfIssues");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json; charset=utf-8'];
      let returnType = GetListOfIssues200Response;
      return this.apiClient.callApi(
        '/reporting/issues/', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getListOfLatestIssues operation.
     * @callback module:api/ReportingAPIApi~getListOfLatestIssuesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetListOfIssues200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} [groupBy] Set to issue to group the same issue in multiple projects
     * @param {module:model/GetListOfIssuesRequest} [getListOfIssuesRequest] 
     * @param {module:api/ReportingAPIApi~getListOfLatestIssuesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetListOfIssues200Response}
     */
    getListOfLatestIssues(opts, callback) {
      opts = opts || {};
      let postBody = opts['getListOfIssuesRequest'];
    ...
    /**
     * Callback function to receive the result of the getProjectCounts operation.
     * @callback module:api/ReportingAPIApi~getProjectCountsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetProjectCounts200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/GetProjectCountsRequest} [getProjectCountsRequest] 
     * @param {module:api/ReportingAPIApi~getProjectCountsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetProjectCounts200Response}
     */
    getProjectCounts(from, to, opts, callback) {
      opts = opts || {};
      let postBody = opts['getProjectCountsRequest'];
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getProjectCounts");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getProjectCounts");
      }
      ...
      let returnType = GetProjectCounts200Response;
      return this.apiClient.callApi(
        '/reporting/counts/projects', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getTestCounts operation.
     * @callback module:api/ReportingAPIApi~getTestCountsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetTestCounts200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Get test counts
     * 
     * @param {String} from The date you wish to count tests from, in the format `YYYY-MM-DD`
     * @param {String} to The date you wish to count tests until, in the format `YYYY-MM-DD`
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [groupBy] The field to group results by
     * @param {module:model/GetTestCountsRequest} [getTestCountsRequest] 
     * @param {module:api/ReportingAPIApi~getTestCountsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetTestCounts200Response}
     */
    getTestCounts(from, to, opts, callback) {
      opts = opts || {};
      let postBody = opts['getTestCountsRequest'];
      // verify the required parameter 'from' is set
      if (from === undefined || from === null) {
        throw new Error("Missing the required parameter 'from' when calling getTestCounts");
      }
      // verify the required parameter 'to' is set
      if (to === undefined || to === null) {
        throw new Error("Missing the required parameter 'to' when calling getTestCounts");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json; charset=utf-8'];
      let returnType = GetTestCounts200Response;
      return this.apiClient.callApi(
        '/reporting/counts/tests', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
