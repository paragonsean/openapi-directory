...
export default class GroupsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addAMemberToAnOrganizationWithinAGroup operation.
     * @callback module:api/GroupsApi~addAMemberToAnOrganizationWithinAGroupCallback
     ...
     * 
     * @param {String} groupId The group ID. The `API_KEY` must have access admin to this group.
     * @param {String} orgId The organization ID we want to add the member to. The `API_KEY` must have access to this organization.
     * @param {Object} opts Optional parameters
     * @param {module:model/AddAMemberToAnOrganizationWithinAGroupRequest} [addAMemberToAnOrganizationWithinAGroupRequest] 
     * @param {module:api/GroupsApi~addAMemberToAnOrganizationWithinAGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addAMemberToAnOrganizationWithinAGroup(groupId, orgId, opts, callback) {
      opts = opts || {};
      let postBody = opts['addAMemberToAnOrganizationWithinAGroupRequest'];
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling addAMemberToAnOrganizationWithinAGroup");
      }
      // verify the required parameter 'orgId' is set
      if (orgId === undefined || orgId === null) {
        throw new Error("Missing the required parameter 'orgId' when calling addAMemberToAnOrganizationWithinAGroup");
      }
      ...
      return this.apiClient.callApi(
        '/group/{groupId}/org/{orgId}/members', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteTagFromGroup operation.
     * @callback module:api/GroupsApi~deleteTagFromGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteTagFromGroup200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} groupId The group ID. The `API_KEY` must have access admin to this group.
     * @param {Object} opts Optional parameters
     * @param {module:model/DeleteTagFromGroupRequest} [deleteTagFromGroupRequest] 
     * @param {module:api/GroupsApi~deleteTagFromGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteTagFromGroup200Response}
     */
    deleteTagFromGroup(groupId, opts, callback) {
      opts = opts || {};
      let postBody = opts['deleteTagFromGroupRequest'];
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling deleteTagFromGroup");
      }
      ...
      let returnType = DeleteTagFromGroup200Response;
      return this.apiClient.callApi(
        '/group/{groupId}/tags/delete', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listAllMembersInAGroup operation.
     * @callback module:api/GroupsApi~listAllMembersInAGroupCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {String} groupId The group ID. The `API_KEY` must have access admin to this group.
     * @param {module:api/GroupsApi~listAllMembersInAGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    listAllMembersInAGroup(groupId, callback) {
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling listAllMembersInAGroup");
      }
    ...
    /**
     * Callback function to receive the result of the listAllOrganizationsInAGroup operation.
     * @callback module:api/GroupsApi~listAllOrganizationsInAGroupCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {String} groupId The group ID. The `API_KEY` must have READ access to this group and LIST organizations access in this group.
     * @param {Object} opts Optional parameters
     * @param {Number} [perPage = 100)] The number of results to return (maximum is 100).
     * @param {Number} [page] For pagination - offset (from which to start returning results).
     * @param {String} [name] Only organizations that have a name that **starts with** this value (case insensitive) will be returned.
     * @param {module:api/GroupsApi~listAllOrganizationsInAGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    listAllOrganizationsInAGroup(groupId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling listAllOrganizationsInAGroup");
      }
    ...
    /**
     * Callback function to receive the result of the listAllRolesInAGroup operation.
     * @callback module:api/GroupsApi~listAllRolesInAGroupCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {String} groupId The group ID. The `API_KEY` must have READ access to this group.
     * @param {module:api/GroupsApi~listAllRolesInAGroupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    listAllRolesInAGroup(groupId, callback) {
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling listAllRolesInAGroup");
      }
    ...
    /**
     * Callback function to receive the result of the listAllTagsInAGroup operation.
     * @callback module:api/GroupsApi~listAllTagsInAGroupCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListAllTagsInAGroup200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} groupId The group ID. The `API_KEY` must have access admin to this group.
     * @param {Object} opts Optional parameters
     * @param {Number} [perPage] The number of results to return (the default is 1000).
     * @param {Number} [page] The offset from which to start returning results from.
     * @param {module:api/GroupsApi~listAllTagsInAGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListAllTagsInAGroup200Response}
     */
    listAllTagsInAGroup(groupId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling listAllTagsInAGroup");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json; charset=utf-8'];
      let returnType = ListAllTagsInAGroup200Response;
      return this.apiClient.callApi(
        '/group/{groupId}/tags', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateGroupSettings operation.
     * @callback module:api/GroupsApi~updateGroupSettingsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ViewGroupSettings200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {String} groupId Automatically added
     * @param {module:api/GroupsApi~updateGroupSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ViewGroupSettings200Response}
     */
    updateGroupSettings(groupId, callback) {
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling updateGroupSettings");
      }
      ...
      let contentTypes = [];
      let accepts = ['*/*'];
      let returnType = ViewGroupSettings200Response;
      return this.apiClient.callApi(
        '/group/{groupId}/settings', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the viewGroupSettings operation.
     * @callback module:api/GroupsApi~viewGroupSettingsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ViewGroupSettings200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * View group settings
     * 
     * @param {String} groupId The group ID. The `API_KEY` must have admin access to this group.
     * @param {module:api/GroupsApi~viewGroupSettingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ViewGroupSettings200Response}
     */
    viewGroupSettings(groupId, callback) {
      let postBody = null;
      // verify the required parameter 'groupId' is set
      if (groupId === undefined || groupId === null) {
        throw new Error("Missing the required parameter 'groupId' when calling viewGroupSettings");
      }
