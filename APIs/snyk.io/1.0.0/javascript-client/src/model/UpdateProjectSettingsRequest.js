...
import ListProjectSettings200ResponseAutoRemediationPrs from './ListProjectSettings200ResponseAutoRemediationPrs';
import Retrieve200ResponsePullRequestAssignment from './Retrieve200ResponsePullRequestAssignment';

/**
 * The UpdateProjectSettingsRequest model module.
 * @module model/UpdateProjectSettingsRequest
 * @version 1.0.0
 */
class UpdateProjectSettingsRequest {
    /**
     * Constructs a new <code>UpdateProjectSettingsRequest</code>.
     * @alias module:model/UpdateProjectSettingsRequest
     */
    constructor() { 
        
        UpdateProjectSettingsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateProjectSettingsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateProjectSettingsRequest} obj Optional instance to populate.
     * @return {module:model/UpdateProjectSettingsRequest} The populated <code>UpdateProjectSettingsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateProjectSettingsRequest();

            if (data.hasOwnProperty('autoDepUpgradeEnabled')) {
                obj['autoDepUpgradeEnabled'] = ApiClient.convertToType(data['autoDepUpgradeEnabled'], 'Boolean');
            }
            if (data.hasOwnProperty('autoDepUpgradeIgnoredDependencies')) {
                obj['autoDepUpgradeIgnoredDependencies'] = ApiClient.convertToType(data['autoDepUpgradeIgnoredDependencies'], [Object]);
            }
            if (data.hasOwnProperty('autoDepUpgradeLimit')) {
                obj['autoDepUpgradeLimit'] = ApiClient.convertToType(data['autoDepUpgradeLimit'], 'Number');
            }
            if (data.hasOwnProperty('autoDepUpgradeMinAge')) {
                obj['autoDepUpgradeMinAge'] = ApiClient.convertToType(data['autoDepUpgradeMinAge'], 'Number');
            }
            if (data.hasOwnProperty('autoRemediationPrs')) {
                obj['autoRemediationPrs'] = ListProjectSettings200ResponseAutoRemediationPrs.constructFromObject(data['autoRemediationPrs']);
            }
            if (data.hasOwnProperty('pullRequestAssignment')) {
                obj['pullRequestAssignment'] = Retrieve200ResponsePullRequestAssignment.constructFromObject(data['pullRequestAssignment']);
            }
            if (data.hasOwnProperty('pullRequestFailOnAnyVulns')) {
                obj['pullRequestFailOnAnyVulns'] = ApiClient.convertToType(data['pullRequestFailOnAnyVulns'], 'Boolean');
            }
            if (data.hasOwnProperty('pullRequestFailOnlyForHighSeverity')) {
                obj['pullRequestFailOnlyForHighSeverity'] = ApiClient.convertToType(data['pullRequestFailOnlyForHighSeverity'], 'Boolean');
            }
            if (data.hasOwnProperty('pullRequestTestEnabled')) {
                obj['pullRequestTestEnabled'] = ApiClient.convertToType(data['pullRequestTestEnabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateProjectSettingsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateProjectSettingsRequest</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['autoDepUpgradeIgnoredDependencies'])) {
            throw new Error("Expected the field `autoDepUpgradeIgnoredDependencies` to be an array in the JSON data but got " + data['autoDepUpgradeIgnoredDependencies']);
        }
        // validate the optional field `autoRemediationPrs`
        if (data['autoRemediationPrs']) { // data not null
          ListProjectSettings200ResponseAutoRemediationPrs.validateJSON(data['autoRemediationPrs']);
        }
        // validate the optional field `pullRequestAssignment`
        if (data['pullRequestAssignment']) { // data not null
          Retrieve200ResponsePullRequestAssignment.validateJSON(data['pullRequestAssignment']);
        }
 ...
 * @member {Boolean} autoDepUpgradeEnabled
 */
UpdateProjectSettingsRequest.prototype['autoDepUpgradeEnabled'] = undefined;

/**
 * An array of comma-separated strings with names of dependencies you wish Snyk to ignore to upgrade.
 * @member {Array.<Object>} autoDepUpgradeIgnoredDependencies
 */
UpdateProjectSettingsRequest.prototype['autoDepUpgradeIgnoredDependencies'] = undefined;

/**
 * The limit on auto dependency upgrade PRs.
 * @member {Number} autoDepUpgradeLimit
 */
UpdateProjectSettingsRequest.prototype['autoDepUpgradeLimit'] = undefined;

/**
 * The age (in days) that an automatic dependency check is valid for
 * @member {Number} autoDepUpgradeMinAge
 */
UpdateProjectSettingsRequest.prototype['autoDepUpgradeMinAge'] = undefined;

/**
 * @member {module:model/ListProjectSettings200ResponseAutoRemediationPrs} autoRemediationPrs
 */
UpdateProjectSettingsRequest.prototype['autoRemediationPrs'] = undefined;

/**
 * @member {module:model/Retrieve200ResponsePullRequestAssignment} pullRequestAssignment
 */
UpdateProjectSettingsRequest.prototype['pullRequestAssignment'] = undefined;
 ...
 * @member {Boolean} pullRequestFailOnAnyVulns
 */
UpdateProjectSettingsRequest.prototype['pullRequestFailOnAnyVulns'] = undefined;

/**
 * If set to `true`, fail Snyk Test only for high and critical severity vulnerabilities
 * @member {Boolean} pullRequestFailOnlyForHighSeverity
 */
UpdateProjectSettingsRequest.prototype['pullRequestFailOnlyForHighSeverity'] = undefined;

/**
 * If set to `true`, Snyk Test checks PRs for vulnerabilities.:cq
 * @member {Boolean} pullRequestTestEnabled
 */
UpdateProjectSettingsRequest.prototype['pullRequestTestEnabled'] = undefined;
...
export default UpdateProjectSettingsRequest;
