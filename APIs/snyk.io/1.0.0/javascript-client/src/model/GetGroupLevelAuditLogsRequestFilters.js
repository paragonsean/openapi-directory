...
/**
 * The GetGroupLevelAuditLogsRequestFilters model module.
 * @module model/GetGroupLevelAuditLogsRequestFilters
 * @version 1.0.0
 */
class GetGroupLevelAuditLogsRequestFilters {
    /**
     * Constructs a new <code>GetGroupLevelAuditLogsRequestFilters</code>.
     * @alias module:model/GetGroupLevelAuditLogsRequestFilters
     */
    constructor() { 
        
        GetGroupLevelAuditLogsRequestFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupLevelAuditLogsRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupLevelAuditLogsRequestFilters} obj Optional instance to populate.
     * @return {module:model/GetGroupLevelAuditLogsRequestFilters} The populated <code>GetGroupLevelAuditLogsRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupLevelAuditLogsRequestFilters();
            ...
            if (data.hasOwnProperty('excludeEvent')) {
                obj['excludeEvent'] = ApiClient.convertToType(data['excludeEvent'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupLevelAuditLogsRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupLevelAuditLogsRequestFilters</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['excludeEvent'] && !(typeof data['excludeEvent'] === 'string' || data['excludeEvent'] instanceof String)) {
            throw new Error("Expected the field `excludeEvent` to be a primitive type in the JSON string but got " + data['excludeEvent']);
        }
        // ensure the json data is a string
 ...
 * @member {String} email
 */
GetGroupLevelAuditLogsRequestFilters.prototype['email'] = undefined;

/**
 * Will return only logs for this specific event. Only one of event and excludeEvent may be specified in a request.
 * @member {module:model/GetGroupLevelAuditLogsRequestFilters.EventEnum} event
 */
GetGroupLevelAuditLogsRequestFilters.prototype['event'] = undefined;

/**
 * Will return logs except logs for this event. Only one of event and excludeEvent may be specified in a request.
 * @member {module:model/GetGroupLevelAuditLogsRequestFilters.ExcludeEventEnum} excludeEvent
 */
GetGroupLevelAuditLogsRequestFilters.prototype['excludeEvent'] = undefined;

/**
 * Will return only logs for this specific project.
 * @member {String} projectId
 */
GetGroupLevelAuditLogsRequestFilters.prototype['projectId'] = undefined;

/**
 * User public ID. Will fetch only audit logs originated from this user's actions.
 * @member {String} userId
 */
GetGroupLevelAuditLogsRequestFilters.prototype['userId'] = undefined;
 ...
 * @readonly
 */
GetGroupLevelAuditLogsRequestFilters['EventEnum'] = {
    ...
    /**
     * value: "group.cloud_config.settings.edit"
     * @const
     */
    "group.cloud_config.settings.edit": "group.cloud_config.settings.edit",
    ...
    /**
     * value: "group.feature_flags.edit"
     * @const
     */
    "group.feature_flags.edit": "group.feature_flags.edit",

    /**
     * value: "group.notification_settings.edit"
     * @const
     */
    "group.notification_settings.edit": "group.notification_settings.edit",

    /**
     * value: "group.org.add"
     * @const
     */
    "group.org.add": "group.org.add",

    /**
     * value: "group.org.remove"
     * @const
     */
    "group.org.remove": "group.org.remove",

    /**
     * value: "group.policy.create"
     * @const
     */
    "group.policy.create": "group.policy.create",

    /**
     * value: "group.policy.delete"
     * @const
     */
    "group.policy.delete": "group.policy.delete",

    /**
     * value: "group.policy.edit"
     * @const
     */
    "group.policy.edit": "group.policy.edit",

    /**
     * value: "group.request_access_settings.edit"
     * @const
     */
    "group.request_access_settings.edit": "group.request_access_settings.edit",

    /**
     * value: "group.role.create"
     * @const
     */
    "group.role.create": "group.role.create",

    /**
     * value: "group.role.edit"
     * @const
     */
    "group.role.edit": "group.role.edit",

    /**
     * value: "group.service_account.create"
     * @const
     */
    "group.service_account.create": "group.service_account.create",

    /**
     * value: "group.service_account.delete"
     * @const
     */
    "group.service_account.delete": "group.service_account.delete",

    /**
     * value: "group.service_account.edit"
     * @const
     */
    "group.service_account.edit": "group.service_account.edit",

    /**
     * value: "group.settings.edit"
     * @const
     */
    "group.settings.edit": "group.settings.edit",

    /**
     * value: "group.settings.feature_flag.edit"
     * @const
     */
    "group.settings.feature_flag.edit": "group.settings.feature_flag.edit",

    /**
     * value: "group.sso.auth0_connection.create"
     * @const
     */
    "group.sso.auth0_connection.create": "group.sso.auth0_connection.create",

    /**
     * value: "group.sso.auth0_connection.edit"
     * @const
     */
    "group.sso.auth0_connection.edit": "group.sso.auth0_connection.edit",

    /**
     * value: "group.sso.add"
     * @const
     */
    "group.sso.add": "group.sso.add",

    /**
     * value: "group.sso.create"
     * @const
     */
    "group.sso.create": "group.sso.create",

    /**
     * value: "group.sso.delete"
     * @const
     */
    "group.sso.delete": "group.sso.delete",

    /**
     * value: "group.sso.edit"
     * @const
     */
    "group.sso.edit": "group.sso.edit",

    /**
     * value: "group.sso.membership.sync"
     * @const
     */
    "group.sso.membership.sync": "group.sso.membership.sync",

    /**
     * value: "group.sso.remove"
     * @const
     */
    "group.sso.remove": "group.sso.remove",

    /**
     * value: "group.tag.create"
     * @const
     */
    "group.tag.create": "group.tag.create",

    /**
     * value: "group.tag.delete"
     * @const
     */
    "group.tag.delete": "group.tag.delete",

    /**
     * value: "group.user.add"
     * @const
     */
    "group.user.add": "group.user.add",

    /**
     * value: "group.user.provision.accept"
     * @const
     */
    "group.user.provision.accept": "group.user.provision.accept",

    /**
     * value: "group.user.provision.create"
     * @const
     */
    "group.user.provision.create": "group.user.provision.create",

    /**
     * value: "group.user.provision.delete"
     * @const
     */
    "group.user.provision.delete": "group.user.provision.delete",

    /**
     * value: "group.user.remove"
     * @const
     */
    "group.user.remove": "group.user.remove",

    /**
     * value: "group.user.role.edit"
     * @const
     */
    "group.user.role.edit": "group.user.role.edit"
};


/**
 * Allowed values for the <code>excludeEvent</code> property.
 * @enum {String}
 * @readonly
 */
GetGroupLevelAuditLogsRequestFilters['ExcludeEventEnum'] = {
...
export default GetGroupLevelAuditLogsRequestFilters;
