...
/**
 * The AggregatedProjectIssuesIssuesInnerIssueData model module.
 * @module model/AggregatedProjectIssuesIssuesInnerIssueData
 * @version 1.0.0
 */
class AggregatedProjectIssuesIssuesInnerIssueData {
    /**
     * Constructs a new <code>AggregatedProjectIssuesIssuesInnerIssueData</code>.
     * The details of the issue
     * @alias module:model/AggregatedProjectIssuesIssuesInnerIssueData
     ...
     */
    constructor(exploitMaturity, id, originalSeverity, path, severity, title, url, violatedPolicyPublicId) { 
        
        AggregatedProjectIssuesIssuesInnerIssueData.initialize(this, exploitMaturity, id, originalSeverity, path, severity, title, url, violatedPolicyPublicId);
    }
     ...
     */
    static initialize(obj, exploitMaturity, id, originalSeverity, path, severity, title, url, violatedPolicyPublicId) { 
    ...
    /**
     * Constructs a <code>AggregatedProjectIssuesIssuesInnerIssueData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AggregatedProjectIssuesIssuesInnerIssueData} obj Optional instance to populate.
     * @return {module:model/AggregatedProjectIssuesIssuesInnerIssueData} The populated <code>AggregatedProjectIssuesIssuesInnerIssueData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AggregatedProjectIssuesIssuesInnerIssueData();
    ...
    /**
     * Validates the JSON data with respect to <code>AggregatedProjectIssuesIssuesInnerIssueData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AggregatedProjectIssuesIssuesInnerIssueData</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AggregatedProjectIssuesIssuesInnerIssueData.RequiredProperties) {
...
AggregatedProjectIssuesIssuesInnerIssueData.RequiredProperties = ["exploitMaturity", "id", "originalSeverity", "path", "severity", "title", "url", "violatedPolicyPublicId"];

/**
 * The CVSS v3 string that signifies how the CVSS score was calculated (Non-IaC projects only)
 * @member {String} CVSSv3
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['CVSSv3'] = undefined;
 ...
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['credit'] = undefined;

/**
 * The CVSS score that results from running the CVSSv3 string (Non-IaC projects only)
 * @member {Number} cvssScore
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['cvssScore'] = undefined;

/**
 * @member {String} description
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['description'] = undefined;

/**
 * The date that the vulnerability was first disclosed
 * @member {String} disclosureTime
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['disclosureTime'] = undefined;

/**
 * The exploit maturity of the issue
 * @member {String} exploitMaturity
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['exploitMaturity'] = undefined;

/**
 * The identifier of the issue
 * @member {String} id
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['id'] = undefined;

/**
 * @member {module:model/ListAllAggregatedIssues200ResponseIssuesInnerIssueDataIdentifiers} identifiers
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['identifiers'] = undefined;

/**
 * Whether the issue is intentional, indicating a malicious package
 * @member {Boolean} isMaliciousPackage
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['isMaliciousPackage'] = undefined;

/**
 * The language of the issue (Non-IaC projects only)
 * @member {String} language
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['language'] = undefined;
 ...
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['nearestFixedInVersion'] = undefined;
 ...
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['originalSeverity'] = undefined;

/**
 * A list of patches available for the given issue (Non-IaC projects only)
 * @member {Array.<Object>} patches
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['patches'] = undefined;

/**
 * Path to the resource property violating the policy within the scanned project. (IaC projects only)
 * @member {String} path
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['path'] = undefined;

/**
 * The date that the vulnerability was first published by Snyk (Non-IaC projects only)
 * @member {String} publicationTime
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['publicationTime'] = undefined;

/**
 * @member {module:model/ListAllAggregatedIssues200ResponseIssuesInnerIssueDataSemver} semver
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['semver'] = undefined;

/**
 * The severity status of the issue, after policies are applied
 * @member {String} severity
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['severity'] = undefined;

/**
 * The issue title
 * @member {String} title
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['title'] = undefined;

/**
 * URL to a page containing information about the issue
 * @member {String} url
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['url'] = undefined;

/**
 * The ID of the violated policy in the issue (IaC projects only)
 * @member {String} violatedPolicyPublicId
 */
AggregatedProjectIssuesIssuesInnerIssueData.prototype['violatedPolicyPublicId'] = undefined;
...
export default AggregatedProjectIssuesIssuesInnerIssueData;
