...
/**
 * The SetNotificationSettingsRequestNewIssuesRemediations model module.
 * @module model/SetNotificationSettingsRequestNewIssuesRemediations
 * @version 1.0.0
 */
class SetNotificationSettingsRequestNewIssuesRemediations {
    /**
     * Constructs a new <code>SetNotificationSettingsRequestNewIssuesRemediations</code>.
     * @alias module:model/SetNotificationSettingsRequestNewIssuesRemediations
     * @param enabled {Boolean} Whether notifications should be sent
     * @param issueSeverity {module:model/SetNotificationSettingsRequestNewIssuesRemediations.IssueSeverityEnum} The severity levels of issues to send notifications for (only applicable for `new-remediations-vulnerabilities` notificationType)
     * @param issueType {module:model/SetNotificationSettingsRequestNewIssuesRemediations.IssueTypeEnum} Filter the types of issue to include in notifications (only applicable for `new-remediations-vulnerabilities` notificationType)
     */
    constructor(enabled, issueSeverity, issueType) { 
        
        SetNotificationSettingsRequestNewIssuesRemediations.initialize(this, enabled, issueSeverity, issueType);
    }
    ...
    /**
     * Constructs a <code>SetNotificationSettingsRequestNewIssuesRemediations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetNotificationSettingsRequestNewIssuesRemediations} obj Optional instance to populate.
     * @return {module:model/SetNotificationSettingsRequestNewIssuesRemediations} The populated <code>SetNotificationSettingsRequestNewIssuesRemediations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetNotificationSettingsRequestNewIssuesRemediations();
    ...
    /**
     * Validates the JSON data with respect to <code>SetNotificationSettingsRequestNewIssuesRemediations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetNotificationSettingsRequestNewIssuesRemediations</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetNotificationSettingsRequestNewIssuesRemediations.RequiredProperties) {
...
SetNotificationSettingsRequestNewIssuesRemediations.RequiredProperties = ["enabled", "issueSeverity", "issueType"];

/**
 * Whether notifications should be sent
 * @member {Boolean} enabled
 */
SetNotificationSettingsRequestNewIssuesRemediations.prototype['enabled'] = undefined;
 ...
 * @member {module:model/SetNotificationSettingsRequestNewIssuesRemediations.IssueSeverityEnum} issueSeverity
 */
SetNotificationSettingsRequestNewIssuesRemediations.prototype['issueSeverity'] = undefined;
 ...
 * @member {module:model/SetNotificationSettingsRequestNewIssuesRemediations.IssueTypeEnum} issueType
 */
SetNotificationSettingsRequestNewIssuesRemediations.prototype['issueType'] = undefined;
 ...
 * @readonly
 */
SetNotificationSettingsRequestNewIssuesRemediations['IssueSeverityEnum'] = {
 ...
 * @readonly
 */
SetNotificationSettingsRequestNewIssuesRemediations['IssueTypeEnum'] = {
...
export default SetNotificationSettingsRequestNewIssuesRemediations;
