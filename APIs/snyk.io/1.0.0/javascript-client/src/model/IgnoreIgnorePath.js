...
import IgnoreIgnorePathIgnoredBy from './IgnoreIgnorePathIgnoredBy';

/**
 * The IgnoreIgnorePath model module.
 * @module model/IgnoreIgnorePath
 * @version 1.0.0
 */
class IgnoreIgnorePath {
    /**
     * Constructs a new <code>IgnoreIgnorePath</code>.
     * The path that should be ignored. Wildcards can be specified with a &#x60;*&#x60;.
     * @alias module:model/IgnoreIgnorePath
     */
    constructor() { 
        
        IgnoreIgnorePath.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IgnoreIgnorePath</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IgnoreIgnorePath} obj Optional instance to populate.
     * @return {module:model/IgnoreIgnorePath} The populated <code>IgnoreIgnorePath</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IgnoreIgnorePath();
            ...
            if (data.hasOwnProperty('ignoredBy')) {
                obj['ignoredBy'] = IgnoreIgnorePathIgnoredBy.constructFromObject(data['ignoredBy']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IgnoreIgnorePath</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IgnoreIgnorePath</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ignoredBy']) { // data not null
          IgnoreIgnorePathIgnoredBy.validateJSON(data['ignoredBy']);
        }
        // ensure the json data is a string
 ...
 */
IgnoreIgnorePath.prototype['created'] = undefined;

/**
 * Only ignore the issue if no upgrade or patch is available.
 * @member {Boolean} disregardIfFixable
 */
IgnoreIgnorePath.prototype['disregardIfFixable'] = undefined;

/**
 * The timestamp that the issue will no longer be ignored.
 * @member {String} expires
 */
IgnoreIgnorePath.prototype['expires'] = undefined;

/**
 * @member {module:model/IgnoreIgnorePathIgnoredBy} ignoredBy
 */
IgnoreIgnorePath.prototype['ignoredBy'] = undefined;

/**
 * The reason that the issue was ignored.
 * @member {String} reason
 */
IgnoreIgnorePath.prototype['reason'] = undefined;

/**
 * The classification of the ignore.
 * @member {module:model/IgnoreIgnorePath.ReasonTypeEnum} reasonType
 */
IgnoreIgnorePath.prototype['reasonType'] = undefined;
 ...
 * @readonly
 */
IgnoreIgnorePath['ReasonTypeEnum'] = {
...
export default IgnoreIgnorePath;
