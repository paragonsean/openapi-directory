...
import GetListOfIssues200ResponseResultsInnerIssueIdentifiers from './GetListOfIssues200ResponseResultsInnerIssueIdentifiers';
import GetListOfIssues200ResponseResultsInnerIssueSemver from './GetListOfIssues200ResponseResultsInnerIssueSemver';

/**
 * The GetListOfIssues200ResponseResultsInnerIssue model module.
 * @module model/GetListOfIssues200ResponseResultsInnerIssue
 * @version 1.0.0
 */
class GetListOfIssues200ResponseResultsInnerIssue {
    /**
     * Constructs a new <code>GetListOfIssues200ResponseResultsInnerIssue</code>.
     * @alias module:model/GetListOfIssues200ResponseResultsInnerIssue
     ...
     * @param _package {String} The name of the package that the issue relates to
     * @param severity {String} The severity status of the issue, after policies are applied
     * @param title {String} The issue title
     * @param type {String} The issue type, can be \"vuln\", \"license\"
     * @param url {String} URL to a page containing information about the issue
     * @param version {String} The version of the package that the issue relates to
     */
    constructor(exploitMaturity, id, originalSeverity, _package, severity, title, type, url, version) { 
        
        GetListOfIssues200ResponseResultsInnerIssue.initialize(this, exploitMaturity, id, originalSeverity, _package, severity, title, type, url, version);
    }
     ...
     */
    static initialize(obj, exploitMaturity, id, originalSeverity, _package, severity, title, type, url, version) { 
    ...
    /**
     * Constructs a <code>GetListOfIssues200ResponseResultsInnerIssue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetListOfIssues200ResponseResultsInnerIssue} obj Optional instance to populate.
     * @return {module:model/GetListOfIssues200ResponseResultsInnerIssue} The populated <code>GetListOfIssues200ResponseResultsInnerIssue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetListOfIssues200ResponseResultsInnerIssue();
            ...
            if (data.hasOwnProperty('identifiers')) {
                obj['identifiers'] = GetListOfIssues200ResponseResultsInnerIssueIdentifiers.constructFromObject(data['identifiers']);
            }
            if (data.hasOwnProperty('ignored')) {
                obj['ignored'] = ApiClient.convertToType(data['ignored'], [Object]);
            }
            if (data.hasOwnProperty('isIgnored')) {
                obj['isIgnored'] = ApiClient.convertToType(data['isIgnored'], 'Boolean');
            }
            if (data.hasOwnProperty('isPatchable')) {
                obj['isPatchable'] = ApiClient.convertToType(data['isPatchable'], 'Boolean');
            }
            if (data.hasOwnProperty('isPatched')) {
                obj['isPatched'] = ApiClient.convertToType(data['isPatched'], 'Boolean');
            }
            if (data.hasOwnProperty('isPinnable')) {
                obj['isPinnable'] = ApiClient.convertToType(data['isPinnable'], 'Boolean');
            }
            if (data.hasOwnProperty('isUpgradable')) {
                obj['isUpgradable'] = ApiClient.convertToType(data['isUpgradable'], 'Boolean');
            }
            if (data.hasOwnProperty('jiraIssueUrl')) {
                obj['jiraIssueUrl'] = ApiClient.convertToType(data['jiraIssueUrl'], 'String');
            }
            ...
            if (data.hasOwnProperty('priorityScore')) {
                obj['priorityScore'] = ApiClient.convertToType(data['priorityScore'], 'Number');
            }
            ...
            if (data.hasOwnProperty('semver')) {
                obj['semver'] = GetListOfIssues200ResponseResultsInnerIssueSemver.constructFromObject(data['semver']);
            }
            ...
            if (data.hasOwnProperty('uniqueSeveritiesList')) {
                obj['uniqueSeveritiesList'] = ApiClient.convertToType(data['uniqueSeveritiesList'], [Object]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetListOfIssues200ResponseResultsInnerIssue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetListOfIssues200ResponseResultsInnerIssue</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetListOfIssues200ResponseResultsInnerIssue.RequiredProperties) {
        ...
        if (data['identifiers']) { // data not null
          GetListOfIssues200ResponseResultsInnerIssueIdentifiers.validateJSON(data['identifiers']);
        }
        // ensure the json data is an array
        ...
        // ensure the json data is a string
        if (data['jiraIssueUrl'] && !(typeof data['jiraIssueUrl'] === 'string' || data['jiraIssueUrl'] instanceof String)) {
            throw new Error("Expected the field `jiraIssueUrl` to be a primitive type in the JSON string but got " + data['jiraIssueUrl']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['packageManager'] && !(typeof data['packageManager'] === 'string' || data['packageManager'] instanceof String)) {
            throw new Error("Expected the field `packageManager` to be a primitive type in the JSON string but got " + data['packageManager']);
        }
        // ensure the json data is an array
        ...
        if (data['semver']) { // data not null
          GetListOfIssues200ResponseResultsInnerIssueSemver.validateJSON(data['semver']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['uniqueSeveritiesList'])) {
            throw new Error("Expected the field `uniqueSeveritiesList` to be an array in the JSON data but got " + data['uniqueSeveritiesList']);
        }
        // ensure the json data is a string
...
GetListOfIssues200ResponseResultsInnerIssue.RequiredProperties = ["exploitMaturity", "id", "originalSeverity", "package", "severity", "title", "type", "url", "version"];

/**
 * The CVSS v3 string that signifies how the CVSS score was calculated (not applicable to licenses)
 * @member {String} CVSSv3
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['CVSSv3'] = undefined;
 ...
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['credit'] = undefined;

/**
 * The CVSS score that results from running the CVSSv3 string (not applicable to licenses)
 * @member {Number} cvssScore
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['cvssScore'] = undefined;

/**
 * The date that the vulnerability was first disclosed (not applicable to licenses)
 * @member {String} disclosureTime
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['disclosureTime'] = undefined;

/**
 * The exploit maturity of the issue
 * @member {String} exploitMaturity
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['exploitMaturity'] = undefined;

/**
 * The identifier of the issue
 * @member {String} id
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['id'] = undefined;

/**
 * @member {module:model/GetListOfIssues200ResponseResultsInnerIssueIdentifiers} identifiers
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['identifiers'] = undefined;
 ...
 * @member {Array.<Object>} ignored
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['ignored'] = undefined;

/**
 * Whether the issue has been ignored (only present if there is no `groupBy` in the API request)
 * @member {Boolean} isIgnored
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['isIgnored'] = undefined;

/**
 * Whether the issue can be patched
 * @member {Boolean} isPatchable
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['isPatchable'] = undefined;

/**
 * Whether the issue has been patched (not applicable to licenses and only present if there is no `groupBy` in the API request)
 * @member {Boolean} isPatched
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['isPatched'] = undefined;

/**
 * Whether the issue can be pinned
 * @member {Boolean} isPinnable
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['isPinnable'] = undefined;

/**
 * Whether the issue can be fixed by upgrading to a later version of the dependency
 * @member {Boolean} isUpgradable
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['isUpgradable'] = undefined;

/**
 * The link to the Jira issue attached to the vulnerability
 * @member {String} jiraIssueUrl
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['jiraIssueUrl'] = undefined;

/**
 * The language of the issue
 * @member {String} language
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['language'] = undefined;
 ...
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['originalSeverity'] = undefined;

/**
 * The name of the package that the issue relates to
 * @member {String} package
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['package'] = undefined;

/**
 * The package manager of the issue
 * @member {String} packageManager
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['packageManager'] = undefined;

/**
 * A list of patches available for the given issue (not applicable to licenses)
 * @member {Array.<Object>} patches
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['patches'] = undefined;

/**
 * The priority score ranging between 0-1000
 * @member {Number} priorityScore
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['priorityScore'] = undefined;

/**
 * The date that the vulnerability was first published by Snyk (not applicable to licenses)
 * @member {String} publicationTime
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['publicationTime'] = undefined;

/**
 * @member {module:model/GetListOfIssues200ResponseResultsInnerIssueSemver} semver
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['semver'] = undefined;

/**
 * The severity status of the issue, after policies are applied
 * @member {String} severity
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['severity'] = undefined;

/**
 * The issue title
 * @member {String} title
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['title'] = undefined;

/**
 * The issue type, can be \"vuln\", \"license\"
 * @member {String} type
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['type'] = undefined;

/**
 * A list of all severities in issue per projects
 * @member {Array.<Object>} uniqueSeveritiesList
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['uniqueSeveritiesList'] = undefined;

/**
 * URL to a page containing information about the issue
 * @member {String} url
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['url'] = undefined;

/**
 * The version of the package that the issue relates to
 * @member {String} version
 */
GetListOfIssues200ResponseResultsInnerIssue.prototype['version'] = undefined;
...
export default GetListOfIssues200ResponseResultsInnerIssue;
