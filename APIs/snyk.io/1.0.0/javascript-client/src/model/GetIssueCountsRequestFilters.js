...
/**
 * The GetIssueCountsRequestFilters model module.
 * @module model/GetIssueCountsRequestFilters
 * @version 1.0.0
 */
class GetIssueCountsRequestFilters {
    /**
     * Constructs a new <code>GetIssueCountsRequestFilters</code>.
     * @alias module:model/GetIssueCountsRequestFilters
     * @param orgs {Object} The list of org IDs to filter the results by
     */
    constructor(orgs) { 
        
        GetIssueCountsRequestFilters.initialize(this, orgs);
    }
    ...
    /**
     * Constructs a <code>GetIssueCountsRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetIssueCountsRequestFilters} obj Optional instance to populate.
     * @return {module:model/GetIssueCountsRequestFilters} The populated <code>GetIssueCountsRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIssueCountsRequestFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>GetIssueCountsRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIssueCountsRequestFilters</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetIssueCountsRequestFilters.RequiredProperties) {
...
GetIssueCountsRequestFilters.RequiredProperties = ["orgs"];
 ...
 */
GetIssueCountsRequestFilters.prototype['fixable'] = undefined;
 ...
 */
GetIssueCountsRequestFilters.prototype['ignored'] = undefined;
 ...
 */
GetIssueCountsRequestFilters.prototype['isPatchable'] = undefined;
 ...
 */
GetIssueCountsRequestFilters.prototype['isPinnable'] = undefined;
 ...
 */
GetIssueCountsRequestFilters.prototype['isUpgradable'] = undefined;

/**
 * The type of languages to filter the results by
 * @member {Array.<Object>} languages
 */
GetIssueCountsRequestFilters.prototype['languages'] = undefined;

/**
 * The list of org IDs to filter the results by
 * @member {Object} orgs
 */
GetIssueCountsRequestFilters.prototype['orgs'] = undefined;
...
export default GetIssueCountsRequestFilters;
