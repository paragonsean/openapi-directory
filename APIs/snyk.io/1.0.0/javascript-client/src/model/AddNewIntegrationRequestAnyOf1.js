...
/**
 * The AddNewIntegrationRequestAnyOf1 model module.
 * @module model/AddNewIntegrationRequestAnyOf1
 * @version 1.0.0
 */
class AddNewIntegrationRequestAnyOf1 {
    /**
     * Constructs a new <code>AddNewIntegrationRequestAnyOf1</code>.
     * @alias module:model/AddNewIntegrationRequestAnyOf1
     * @param broker {module:model/AddNewIntegrationRequestAnyOf1Broker} 
     * @param type {module:model/AddNewIntegrationRequestAnyOf1.TypeEnum} integration type
     */
    constructor(broker, type) { 
        
        AddNewIntegrationRequestAnyOf1.initialize(this, broker, type);
    }
    ...
    /**
     * Constructs a <code>AddNewIntegrationRequestAnyOf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddNewIntegrationRequestAnyOf1} obj Optional instance to populate.
     * @return {module:model/AddNewIntegrationRequestAnyOf1} The populated <code>AddNewIntegrationRequestAnyOf1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddNewIntegrationRequestAnyOf1();
    ...
    /**
     * Validates the JSON data with respect to <code>AddNewIntegrationRequestAnyOf1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddNewIntegrationRequestAnyOf1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddNewIntegrationRequestAnyOf1.RequiredProperties) {
...
AddNewIntegrationRequestAnyOf1.RequiredProperties = ["broker", "type"];

/**
 * @member {module:model/AddNewIntegrationRequestAnyOf1Broker} broker
 */
AddNewIntegrationRequestAnyOf1.prototype['broker'] = undefined;

/**
 * integration type
 * @member {module:model/AddNewIntegrationRequestAnyOf1.TypeEnum} type
 */
AddNewIntegrationRequestAnyOf1.prototype['type'] = undefined;
 ...
 * @readonly
 */
AddNewIntegrationRequestAnyOf1['TypeEnum'] = {
...
export default AddNewIntegrationRequestAnyOf1;
