...
import PullRequestAssignment from './PullRequestAssignment';
...
class IntegrationSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('pullRequestAssignment')) {
                obj['pullRequestAssignment'] = PullRequestAssignment.constructFromObject(data['pullRequestAssignment']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['pullRequestAssignment']) { // data not null
          PullRequestAssignment.validateJSON(data['pullRequestAssignment']);
        }
 ...
 */
IntegrationSettings.prototype['dockerfileSCMEnabled'] = undefined;

/**
 * @member {module:model/Retrieve200ResponseManualRemediationPrs} manualRemediationPrs
 */
IntegrationSettings.prototype['manualRemediationPrs'] = undefined;

/**
 * @member {module:model/PullRequestAssignment} pullRequestAssignment
 */
IntegrationSettings.prototype['pullRequestAssignment'] = undefined;
 ...
 */
IntegrationSettings.prototype['pullRequestFailOnAnyVulns'] = undefined;
 ...
 */
IntegrationSettings.prototype['pullRequestFailOnlyForHighSeverity'] = undefined;

/**
 * If opened PRs should be tested
 * @member {Boolean} pullRequestTestEnabled
 */
IntegrationSettings.prototype['pullRequestTestEnabled'] = undefined;
