...
/**
 * The NewIssuesNotificationSettingRequest model module.
 * @module model/NewIssuesNotificationSettingRequest
 * @version 1.0.0
 */
class NewIssuesNotificationSettingRequest {
    /**
     * Constructs a new <code>NewIssuesNotificationSettingRequest</code>.
     * @alias module:model/NewIssuesNotificationSettingRequest
     * @param enabled {Boolean} Whether notifications should be sent
     * @param issueSeverity {module:model/NewIssuesNotificationSettingRequest.IssueSeverityEnum} The severity levels of issues to send notifications for (only applicable for `new-remediations-vulnerabilities` notificationType)
     * @param issueType {module:model/NewIssuesNotificationSettingRequest.IssueTypeEnum} Filter the types of issue to include in notifications (only applicable for `new-remediations-vulnerabilities` notificationType)
     */
    ...
    /**
     * Constructs a <code>NewIssuesNotificationSettingRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewIssuesNotificationSettingRequest} obj Optional instance to populate.
     * @return {module:model/NewIssuesNotificationSettingRequest} The populated <code>NewIssuesNotificationSettingRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewIssuesNotificationSettingRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>NewIssuesNotificationSettingRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewIssuesNotificationSettingRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewIssuesNotificationSettingRequest.RequiredProperties) {
...
NewIssuesNotificationSettingRequest.RequiredProperties = ["enabled", "issueSeverity", "issueType"];
 ...
 * @readonly
 */
NewIssuesNotificationSettingRequest['IssueSeverityEnum'] = {
 ...
 * @readonly
 */
NewIssuesNotificationSettingRequest['IssueTypeEnum'] = {
...
export default NewIssuesNotificationSettingRequest;
