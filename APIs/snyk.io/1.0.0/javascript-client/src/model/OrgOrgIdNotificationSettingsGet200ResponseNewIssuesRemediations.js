...
/**
 * The OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations model module.
 * @module model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations
 * @version 1.0.0
 */
class OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations {
    /**
     * Constructs a new <code>OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations</code>.
     * @alias module:model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations
     * @param enabled {Boolean} Whether notifications should be sent
     * @param issueSeverity {module:model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.IssueSeverityEnum} The severity levels of issues to send notifications for (only applicable for `new-remediations-vulnerabilities` notificationType)
     * @param issueType {module:model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.IssueTypeEnum} Filter the types of issue to include in notifications (only applicable for `new-remediations-vulnerabilities` notificationType)
     */
    constructor(enabled, issueSeverity, issueType) { 
        
        OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.initialize(this, enabled, issueSeverity, issueType);
    }
     ...
     */
    static initialize(obj, enabled, issueSeverity, issueType) { 
        obj['enabled'] = enabled;
        obj['issueSeverity'] = issueSeverity;
        obj['issueType'] = issueType;
    }

    /**
     * Constructs a <code>OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations} obj Optional instance to populate.
     * @return {module:model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations} The populated <code>OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations();
            ...
            if (data.hasOwnProperty('issueSeverity')) {
                obj['issueSeverity'] = ApiClient.convertToType(data['issueSeverity'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['issueSeverity'] && !(typeof data['issueSeverity'] === 'string' || data['issueSeverity'] instanceof String)) {
            throw new Error("Expected the field `issueSeverity` to be a primitive type in the JSON string but got " + data['issueSeverity']);
        }
        // ensure the json data is a string
...
OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.RequiredProperties = ["enabled", "issueSeverity", "issueType"];

/**
 * Whether notifications should be sent
 * @member {Boolean} enabled
 */
OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.prototype['enabled'] = undefined;

/**
 * Whether the setting was found on the requested context directly or inherited from a parent
 * @member {Boolean} inherited
 */
OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.prototype['inherited'] = undefined;
 ...
 * @member {module:model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.IssueSeverityEnum} issueSeverity
 */
OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.prototype['issueSeverity'] = undefined;
 ...
 * @member {module:model/OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.IssueTypeEnum} issueType
 */
OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations.prototype['issueType'] = undefined;
...
/**
 * Allowed values for the <code>issueSeverity</code> property.
 * @enum {String}
 * @readonly
 */
OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations['IssueSeverityEnum'] = {
 ...
 * @readonly
 */
OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations['IssueTypeEnum'] = {
...
export default OrgOrgIdNotificationSettingsGet200ResponseNewIssuesRemediations;
