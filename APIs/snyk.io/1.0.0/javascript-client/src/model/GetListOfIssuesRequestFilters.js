...
import GetIssueCountsRequestFiltersPriorityScore from './GetIssueCountsRequestFiltersPriorityScore';

/**
 * The GetListOfIssuesRequestFilters model module.
 * @module model/GetListOfIssuesRequestFilters
 * @version 1.0.0
 */
class GetListOfIssuesRequestFilters {
    /**
     * Constructs a new <code>GetListOfIssuesRequestFilters</code>.
     * @alias module:model/GetListOfIssuesRequestFilters
     * @param orgs {Object} The list of org IDs to filter the results by
     */
    constructor(orgs) { 
        
        GetListOfIssuesRequestFilters.initialize(this, orgs);
    }
     ...
     */
    static initialize(obj, orgs) { 
        obj['orgs'] = orgs;
    }

    /**
     * Constructs a <code>GetListOfIssuesRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetListOfIssuesRequestFilters} obj Optional instance to populate.
     * @return {module:model/GetListOfIssuesRequestFilters} The populated <code>GetListOfIssuesRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetListOfIssuesRequestFilters();

            if (data.hasOwnProperty('exploitMaturity')) {
                obj['exploitMaturity'] = ApiClient.convertToType(data['exploitMaturity'], [Object]);
            }
            if (data.hasOwnProperty('fixable')) {
                obj['fixable'] = ApiClient.convertToType(data['fixable'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('issues')) {
                obj['issues'] = ApiClient.convertToType(data['issues'], Object);
            }
            if (data.hasOwnProperty('languages')) {
                obj['languages'] = ApiClient.convertToType(data['languages'], [Object]);
            }
            if (data.hasOwnProperty('orgs')) {
                obj['orgs'] = ApiClient.convertToType(data['orgs'], Object);
            }
            if (data.hasOwnProperty('patched')) {
                obj['patched'] = ApiClient.convertToType(data['patched'], 'Boolean');
            }
            if (data.hasOwnProperty('priorityScore')) {
                obj['priorityScore'] = GetIssueCountsRequestFiltersPriorityScore.constructFromObject(data['priorityScore']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetListOfIssuesRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetListOfIssuesRequestFilters</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetListOfIssuesRequestFilters.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['exploitMaturity'])) {
            throw new Error("Expected the field `exploitMaturity` to be an array in the JSON data but got " + data['exploitMaturity']);
        }
        ...
        // validate the optional field `priorityScore`
        if (data['priorityScore']) { // data not null
          GetIssueCountsRequestFiltersPriorityScore.validateJSON(data['priorityScore']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['severity'])) {
            throw new Error("Expected the field `severity` to be an array in the JSON data but got " + data['severity']);
        }
        // ensure the json data is an array
...
GetListOfIssuesRequestFilters.RequiredProperties = ["orgs"];

/**
 * The exploit maturity levels of issues to filter the results by
 * @member {Array.<Object>} exploitMaturity
 */
GetListOfIssuesRequestFilters.prototype['exploitMaturity'] = undefined;
 ...
 * @member {Boolean} fixable
 */
GetListOfIssuesRequestFilters.prototype['fixable'] = undefined;

/**
 * Search term to filter issue name by, or an exact CVE or CWE
 * @member {String} identifier
 */
GetListOfIssuesRequestFilters.prototype['identifier'] = undefined;
 ...
 */
GetListOfIssuesRequestFilters.prototype['ignored'] = undefined;
 ...
 */
GetListOfIssuesRequestFilters.prototype['isFixed'] = undefined;
 ...
 */
GetListOfIssuesRequestFilters.prototype['isPatchable'] = undefined;
 ...
 */
GetListOfIssuesRequestFilters.prototype['isPinnable'] = undefined;
 ...
 */
GetListOfIssuesRequestFilters.prototype['isUpgradable'] = undefined;

/**
 * The list of issue IDs to filter issues by
 * @member {Object} issues
 */
GetListOfIssuesRequestFilters.prototype['issues'] = undefined;

/**
 * The type of languages to filter the results by
 * @member {Array.<Object>} languages
 */
GetListOfIssuesRequestFilters.prototype['languages'] = undefined;

/**
 * The list of org IDs to filter the results by
 * @member {Object} orgs
 */
GetListOfIssuesRequestFilters.prototype['orgs'] = undefined;

/**
 * If set to `true`, only include issues which are patched, if set to `false`, only include issues which are not patched
 * @member {Boolean} patched
 */
GetListOfIssuesRequestFilters.prototype['patched'] = undefined;

/**
 * @member {module:model/GetIssueCountsRequestFiltersPriorityScore} priorityScore
 */
GetListOfIssuesRequestFilters.prototype['priorityScore'] = undefined;

/**
 * The list of project IDs to filter issues by, max projects allowed is 1000
 * @member {Object} projects
 */
GetListOfIssuesRequestFilters.prototype['projects'] = undefined;

/**
 * The severity levels of issues to filter the results by
 * @member {Array.<Object>} severity
 */
GetListOfIssuesRequestFilters.prototype['severity'] = undefined;

/**
 * The type of issues to filter the results by
 * @member {Array.<Object>} types
 */
GetListOfIssuesRequestFilters.prototype['types'] = undefined;
...
export default GetListOfIssuesRequestFilters;
