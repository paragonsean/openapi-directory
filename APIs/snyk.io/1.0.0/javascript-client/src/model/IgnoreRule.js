...
/**
 * The IgnoreRule model module.
 * @module model/IgnoreRule
 * @version 1.0.0
 */
class IgnoreRule {
    /**
     * Constructs a new <code>IgnoreRule</code>.
     * @alias module:model/IgnoreRule
     * @param disregardIfFixable {Boolean} Only ignore the issue if no upgrade or patch is available.
     * @param reasonType {module:model/IgnoreRule.ReasonTypeEnum} The classification of the ignore.
     */
    constructor(disregardIfFixable, reasonType) { 
        
        IgnoreRule.initialize(this, disregardIfFixable, reasonType);
    }
    ...
    /**
     * Constructs a <code>IgnoreRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IgnoreRule} obj Optional instance to populate.
     * @return {module:model/IgnoreRule} The populated <code>IgnoreRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IgnoreRule();
    ...
    /**
     * Validates the JSON data with respect to <code>IgnoreRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IgnoreRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IgnoreRule.RequiredProperties) {
...
IgnoreRule.RequiredProperties = ["disregardIfFixable", "reasonType"];

/**
 * Only ignore the issue if no upgrade or patch is available.
 * @member {Boolean} disregardIfFixable
 */
IgnoreRule.prototype['disregardIfFixable'] = undefined;

/**
 * The timestamp that the issue will no longer be ignored.
 * @member {String} expires
 */
IgnoreRule.prototype['expires'] = undefined;

/**
 * The path to ignore (default is `*` which represents all paths).
 * @member {String} ignorePath
 */
IgnoreRule.prototype['ignorePath'] = undefined;

/**
 * The reason that the issue was ignored.
 * @member {String} reason
 */
IgnoreRule.prototype['reason'] = undefined;

/**
 * The classification of the ignore.
 * @member {module:model/IgnoreRule.ReasonTypeEnum} reasonType
 */
IgnoreRule.prototype['reasonType'] = undefined;
