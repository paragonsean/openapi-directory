...
import Retrieve200ResponseAutoRemediationPrs from './Retrieve200ResponseAutoRemediationPrs';
import Retrieve200ResponseManualRemediationPrs from './Retrieve200ResponseManualRemediationPrs';
...
class UpdateRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('autoRemediationPrs')) {
                obj['autoRemediationPrs'] = Retrieve200ResponseAutoRemediationPrs.constructFromObject(data['autoRemediationPrs']);
            }
            if (data.hasOwnProperty('dockerfileSCMEnabled')) {
                obj['dockerfileSCMEnabled'] = ApiClient.convertToType(data['dockerfileSCMEnabled'], 'Boolean');
            }
            if (data.hasOwnProperty('manualRemediationPrs')) {
                obj['manualRemediationPrs'] = Retrieve200ResponseManualRemediationPrs.constructFromObject(data['manualRemediationPrs']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['autoRemediationPrs']) { // data not null
          Retrieve200ResponseAutoRemediationPrs.validateJSON(data['autoRemediationPrs']);
        }
        // validate the optional field `manualRemediationPrs`
        if (data['manualRemediationPrs']) { // data not null
          Retrieve200ResponseManualRemediationPrs.validateJSON(data['manualRemediationPrs']);
        }
 ...
 */
UpdateRequest.prototype['autoDepUpgradeEnabled'] = undefined;

/**
 * A list of strings defining what dependencies should be ignored
 * @member {Array.<Object>} autoDepUpgradeIgnoredDependencies
 */
UpdateRequest.prototype['autoDepUpgradeIgnoredDependencies'] = undefined;

/**
 * A limit on how many automatic dependency upgrade PRs can be opened simultaneously
 * @member {Number} autoDepUpgradeLimit
 */
UpdateRequest.prototype['autoDepUpgradeLimit'] = undefined;

/**
 * The age (in days) that an automatic dependency check is valid for
 * @member {Number} autoDepUpgradeMinAge
 */
UpdateRequest.prototype['autoDepUpgradeMinAge'] = undefined;

/**
 * @member {module:model/Retrieve200ResponseAutoRemediationPrs} autoRemediationPrs
 */
UpdateRequest.prototype['autoRemediationPrs'] = undefined;
 ...
 * @member {Boolean} dockerfileSCMEnabled
 */
UpdateRequest.prototype['dockerfileSCMEnabled'] = undefined;

/**
 * @member {module:model/Retrieve200ResponseManualRemediationPrs} manualRemediationPrs
 */
UpdateRequest.prototype['manualRemediationPrs'] = undefined;

/**
 * @member {module:model/Retrieve200ResponsePullRequestAssignment} pullRequestAssignment
 */
UpdateRequest.prototype['pullRequestAssignment'] = undefined;
 ...
 */
UpdateRequest.prototype['pullRequestFailOnAnyVulns'] = undefined;
 ...
 */
UpdateRequest.prototype['pullRequestFailOnlyForHighSeverity'] = undefined;

/**
 * If opened PRs should be tested
 * @member {Boolean} pullRequestTestEnabled
 */
UpdateRequest.prototype['pullRequestTestEnabled'] = undefined;
