...
import RetrieveASingleProject200ResponseRemediation from './RetrieveASingleProject200ResponseRemediation';
...
class Project {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('remediation')) {
                obj['remediation'] = RetrieveASingleProject200ResponseRemediation.constructFromObject(data['remediation']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          ProjectAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['remediation']) { // data not null
          RetrieveASingleProject200ResponseRemediation.validateJSON(data['remediation']);
        }
        // ensure the json data is a string
 ...
 */
Project.prototype['attributes'] = undefined;

/**
 * The monitored branch (if available)
 * @member {String} branch
 */
Project.prototype['branch'] = undefined;

/**
 * URL with project overview
 * @member {String} browseUrl
 */
Project.prototype['browseUrl'] = undefined;
 ...
 */
Project.prototype['hostname'] = undefined;
 ...
 */
Project.prototype['origin'] = undefined;
 ...
 */
Project.prototype['readOnly'] = undefined;

/**
 * @member {module:model/RetrieveASingleProject200ResponseRemediation} remediation
 */
Project.prototype['remediation'] = undefined;

/**
 * The project remote repository url. Only set for projects imported via the Snyk CLI tool.
 * @member {String} remoteRepoUrl
 */
Project.prototype['remoteRepoUrl'] = undefined;
