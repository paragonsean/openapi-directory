...
/**
 * The ProjectWithoutRemediation model module.
 * @module model/ProjectWithoutRemediation
 * @version 1.0.0
 */
class ProjectWithoutRemediation {
    /**
     * Constructs a new <code>ProjectWithoutRemediation</code>.
     * @alias module:model/ProjectWithoutRemediation
     */
    constructor() { 
        
        ProjectWithoutRemediation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectWithoutRemediation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectWithoutRemediation} obj Optional instance to populate.
     * @return {module:model/ProjectWithoutRemediation} The populated <code>ProjectWithoutRemediation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectWithoutRemediation();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectWithoutRemediation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectWithoutRemediation</code>.
     */
 ...
 */
ProjectWithoutRemediation.prototype['attributes'] = undefined;

/**
 * The monitored branch (if available)
 * @member {String} branch
 */
ProjectWithoutRemediation.prototype['branch'] = undefined;

/**
 * URL with project overview
 * @member {String} browseUrl
 */
ProjectWithoutRemediation.prototype['browseUrl'] = undefined;

/**
 * The date that the project was created on
 * @member {String} created
 */
ProjectWithoutRemediation.prototype['created'] = undefined;

/**
 * The project identifier
 * @member {String} id
 */
ProjectWithoutRemediation.prototype['id'] = undefined;

/**
 * For docker projects shows the base image
 * @member {String} imageBaseImage
 */
ProjectWithoutRemediation.prototype['imageBaseImage'] = undefined;

/**
 * For Kubernetes projects shows the origin cluster name
 * @member {String} imageCluster
 */
ProjectWithoutRemediation.prototype['imageCluster'] = undefined;

/**
 * For docker projects shows the ID of the image
 * @member {String} imageId
 */
ProjectWithoutRemediation.prototype['imageId'] = undefined;

/**
 * For docker projects shows the platform of the image
 * @member {String} imagePlatform
 */
ProjectWithoutRemediation.prototype['imagePlatform'] = undefined;

/**
 * For docker projects shows the tag of the image
 * @member {String} imageTag
 */
ProjectWithoutRemediation.prototype['imageTag'] = undefined;

/**
 * @member {module:model/RetrieveASingleProject200ResponseImportingUser} importingUser
 */
ProjectWithoutRemediation.prototype['importingUser'] = undefined;

/**
 * Describes if a project is currently monitored or it is de-activated
 * @member {Boolean} isMonitored
 */
ProjectWithoutRemediation.prototype['isMonitored'] = undefined;

/**
 * @member {module:model/RetrieveASingleProject200ResponseIssueCountsBySeverity} issueCountsBySeverity
 */
ProjectWithoutRemediation.prototype['issueCountsBySeverity'] = undefined;

/**
 * The date on which the most recent test was conducted for this project
 * @member {String} lastTestedDate
 */
ProjectWithoutRemediation.prototype['lastTestedDate'] = undefined;

/**
 * @member {String} name
 */
ProjectWithoutRemediation.prototype['name'] = undefined;

/**
 * The origin the project was added from
 * @member {String} origin
 */
ProjectWithoutRemediation.prototype['origin'] = undefined;
 ...
 * @member {Object} owner
 */
ProjectWithoutRemediation.prototype['owner'] = undefined;

/**
 * Whether the project is read-only
 * @member {Boolean} readOnly
 */
ProjectWithoutRemediation.prototype['readOnly'] = undefined;

/**
 * The project remote repository url. Only set for projects imported via the Snyk CLI tool.
 * @member {String} remoteRepoUrl
 */
ProjectWithoutRemediation.prototype['remoteRepoUrl'] = undefined;

/**
 * List of applied tags
 * @member {Array.<Object>} tags
 */
ProjectWithoutRemediation.prototype['tags'] = undefined;
 ...
 */
ProjectWithoutRemediation.prototype['targetReference'] = undefined;

/**
 * The frequency of automated Snyk re-test. Can be 'daily', 'weekly or 'never'
 * @member {String} testFrequency
 */
ProjectWithoutRemediation.prototype['testFrequency'] = undefined;

/**
 * Number of dependencies of the project
 * @member {Number} totalDependencies
 */
ProjectWithoutRemediation.prototype['totalDependencies'] = undefined;

/**
 * The package manager of the project
 * @member {String} type
 */
ProjectWithoutRemediation.prototype['type'] = undefined;
...
export default ProjectWithoutRemediation;
