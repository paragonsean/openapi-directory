...
/**
 * The AddNewIntegrationRequestAnyOf model module.
 * @module model/AddNewIntegrationRequestAnyOf
 * @version 1.0.0
 */
class AddNewIntegrationRequestAnyOf {
    /**
     * Constructs a new <code>AddNewIntegrationRequestAnyOf</code>.
     * @alias module:model/AddNewIntegrationRequestAnyOf
     * @param credentials {module:model/AddNewIntegrationRequestAnyOfCredentials} 
     * @param type {module:model/AddNewIntegrationRequestAnyOf.TypeEnum} integration type
     */
    constructor(credentials, type) { 
        
        AddNewIntegrationRequestAnyOf.initialize(this, credentials, type);
    }
    ...
    /**
     * Constructs a <code>AddNewIntegrationRequestAnyOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddNewIntegrationRequestAnyOf} obj Optional instance to populate.
     * @return {module:model/AddNewIntegrationRequestAnyOf} The populated <code>AddNewIntegrationRequestAnyOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddNewIntegrationRequestAnyOf();
    ...
    /**
     * Validates the JSON data with respect to <code>AddNewIntegrationRequestAnyOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddNewIntegrationRequestAnyOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddNewIntegrationRequestAnyOf.RequiredProperties) {
...
AddNewIntegrationRequestAnyOf.RequiredProperties = ["credentials", "type"];

/**
 * @member {module:model/AddNewIntegrationRequestAnyOfCredentials} credentials
 */
AddNewIntegrationRequestAnyOf.prototype['credentials'] = undefined;

/**
 * integration type
 * @member {module:model/AddNewIntegrationRequestAnyOf.TypeEnum} type
 */
AddNewIntegrationRequestAnyOf.prototype['type'] = undefined;
 ...
 * @readonly
 */
AddNewIntegrationRequestAnyOf['TypeEnum'] = {
...
export default AddNewIntegrationRequestAnyOf;
