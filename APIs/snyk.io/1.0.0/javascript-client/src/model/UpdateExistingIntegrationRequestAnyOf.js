...
import AddNewIntegrationRequestAnyOf1Broker from './AddNewIntegrationRequestAnyOf1Broker';

/**
 * The UpdateExistingIntegrationRequestAnyOf model module.
 * @module model/UpdateExistingIntegrationRequestAnyOf
 * @version 1.0.0
 */
class UpdateExistingIntegrationRequestAnyOf {
    /**
     * Constructs a new <code>UpdateExistingIntegrationRequestAnyOf</code>.
     * @alias module:model/UpdateExistingIntegrationRequestAnyOf
     * @param broker {module:model/AddNewIntegrationRequestAnyOf1Broker} 
     * @param type {module:model/UpdateExistingIntegrationRequestAnyOf.TypeEnum} integration type
     */
    constructor(broker, type) { 
        
        UpdateExistingIntegrationRequestAnyOf.initialize(this, broker, type);
    }
     ...
     */
    static initialize(obj, broker, type) { 
        obj['broker'] = broker;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>UpdateExistingIntegrationRequestAnyOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateExistingIntegrationRequestAnyOf} obj Optional instance to populate.
     * @return {module:model/UpdateExistingIntegrationRequestAnyOf} The populated <code>UpdateExistingIntegrationRequestAnyOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateExistingIntegrationRequestAnyOf();

            if (data.hasOwnProperty('broker')) {
                obj['broker'] = AddNewIntegrationRequestAnyOf1Broker.constructFromObject(data['broker']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateExistingIntegrationRequestAnyOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateExistingIntegrationRequestAnyOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateExistingIntegrationRequestAnyOf.RequiredProperties) {
        ...
        if (data['broker']) { // data not null
          AddNewIntegrationRequestAnyOf1Broker.validateJSON(data['broker']);
        }
...
UpdateExistingIntegrationRequestAnyOf.RequiredProperties = ["broker", "type"];

/**
 * @member {module:model/AddNewIntegrationRequestAnyOf1Broker} broker
 */
UpdateExistingIntegrationRequestAnyOf.prototype['broker'] = undefined;

/**
 * integration type
 * @member {module:model/UpdateExistingIntegrationRequestAnyOf.TypeEnum} type
 */
UpdateExistingIntegrationRequestAnyOf.prototype['type'] = undefined;
 ...
 * @readonly
 */
UpdateExistingIntegrationRequestAnyOf['TypeEnum'] = {
     ...
     * @const
     */
    "digitalocean-cr": "digitalocean-cr",
     ...
     * @const
     */
    "google-artifact-cr": "google-artifact-cr",
...
export default UpdateExistingIntegrationRequestAnyOf;
