...
import ListAllDependencies200ResponseResultsInnerLicensesInner from './ListAllDependencies200ResponseResultsInnerLicensesInner';
import ListAllDependencies200ResponseResultsInnerProjectsInner from './ListAllDependencies200ResponseResultsInnerProjectsInner';

/**
 * The ListAllDependencies200ResponseResultsInner model module.
 * @module model/ListAllDependencies200ResponseResultsInner
 * @version 1.0.0
 */
class ListAllDependencies200ResponseResultsInner {
    /**
     * Constructs a new <code>ListAllDependencies200ResponseResultsInner</code>.
     * @alias module:model/ListAllDependencies200ResponseResultsInner
     * @param id {String} The identifier of the package
     * @param licenses {Array.<module:model/ListAllDependencies200ResponseResultsInnerLicensesInner>} The licenses of the dependency
     * @param name {String} The name of the package
     * @param projects {Array.<module:model/ListAllDependencies200ResponseResultsInnerProjectsInner>} The projects which depend on the dependency
     * @param type {String} The package type of the dependency
     * @param version {String} The version of the package
     */
    constructor(id, licenses, name, projects, type, version) { 
        
        ListAllDependencies200ResponseResultsInner.initialize(this, id, licenses, name, projects, type, version);
    }
     ...
     */
    static initialize(obj, id, licenses, name, projects, type, version) { 
        obj['id'] = id;
    ...
    /**
     * Constructs a <code>ListAllDependencies200ResponseResultsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAllDependencies200ResponseResultsInner} obj Optional instance to populate.
     * @return {module:model/ListAllDependencies200ResponseResultsInner} The populated <code>ListAllDependencies200ResponseResultsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAllDependencies200ResponseResultsInner();

            if (data.hasOwnProperty('copyright')) {
                obj['copyright'] = ApiClient.convertToType(data['copyright'], [Object]);
            }
            if (data.hasOwnProperty('dependenciesWithIssues')) {
                obj['dependenciesWithIssues'] = ApiClient.convertToType(data['dependenciesWithIssues'], [Object]);
            }
            if (data.hasOwnProperty('deprecatedVersions')) {
                obj['deprecatedVersions'] = ApiClient.convertToType(data['deprecatedVersions'], [Object]);
            }
            if (data.hasOwnProperty('firstPublishedDate')) {
                obj['firstPublishedDate'] = ApiClient.convertToType(data['firstPublishedDate'], 'String');
            }
            ...
            if (data.hasOwnProperty('issuesCritical')) {
                obj['issuesCritical'] = ApiClient.convertToType(data['issuesCritical'], 'Number');
            }
            if (data.hasOwnProperty('issuesHigh')) {
                obj['issuesHigh'] = ApiClient.convertToType(data['issuesHigh'], 'Number');
            }
            if (data.hasOwnProperty('issuesLow')) {
                obj['issuesLow'] = ApiClient.convertToType(data['issuesLow'], 'Number');
            }
            if (data.hasOwnProperty('issuesMedium')) {
                obj['issuesMedium'] = ApiClient.convertToType(data['issuesMedium'], 'Number');
            }
            if (data.hasOwnProperty('latestVersion')) {
                obj['latestVersion'] = ApiClient.convertToType(data['latestVersion'], 'String');
            }
            if (data.hasOwnProperty('latestVersionPublishedDate')) {
                obj['latestVersionPublishedDate'] = ApiClient.convertToType(data['latestVersionPublishedDate'], 'String');
            }
            if (data.hasOwnProperty('licenses')) {
                obj['licenses'] = ApiClient.convertToType(data['licenses'], [ListAllDependencies200ResponseResultsInnerLicensesInner]);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('projects')) {
                obj['projects'] = ApiClient.convertToType(data['projects'], [ListAllDependencies200ResponseResultsInnerProjectsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAllDependencies200ResponseResultsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAllDependencies200ResponseResultsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAllDependencies200ResponseResultsInner.RequiredProperties) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['dependenciesWithIssues'])) {
            throw new Error("Expected the field `dependenciesWithIssues` to be an array in the JSON data but got " + data['dependenciesWithIssues']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['deprecatedVersions'])) {
            throw new Error("Expected the field `deprecatedVersions` to be an array in the JSON data but got " + data['deprecatedVersions']);
        }
        // ensure the json data is a string
        if (data['firstPublishedDate'] && !(typeof data['firstPublishedDate'] === 'string' || data['firstPublishedDate'] instanceof String)) {
            throw new Error("Expected the field `firstPublishedDate` to be a primitive type in the JSON string but got " + data['firstPublishedDate']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['latestVersionPublishedDate'] && !(typeof data['latestVersionPublishedDate'] === 'string' || data['latestVersionPublishedDate'] instanceof String)) {
            throw new Error("Expected the field `latestVersionPublishedDate` to be a primitive type in the JSON string but got " + data['latestVersionPublishedDate']);
        }
        if (data['licenses']) { // data not null
            ...
            for (const item of data['licenses']) {
                ListAllDependencies200ResponseResultsInnerLicensesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['projects']) { // data not null
            ...
            for (const item of data['projects']) {
                ListAllDependencies200ResponseResultsInnerProjectsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
ListAllDependencies200ResponseResultsInner.RequiredProperties = ["id", "licenses", "name", "projects", "type", "version"];

/**
 * The copyright notices for the package
 * @member {Array.<Object>} copyright
 */
ListAllDependencies200ResponseResultsInner.prototype['copyright'] = undefined;

/**
 * The identifiers of dependencies with issues that are depended upon as a result of this dependency
 * @member {Array.<Object>} dependenciesWithIssues
 */
ListAllDependencies200ResponseResultsInner.prototype['dependenciesWithIssues'] = undefined;

/**
 * The numbers for those versions that are marked as deprecated
 * @member {Array.<Object>} deprecatedVersions
 */
ListAllDependencies200ResponseResultsInner.prototype['deprecatedVersions'] = undefined;

/**
 * The timestamp for when the specified package was first published.
 * @member {String} firstPublishedDate
 */
ListAllDependencies200ResponseResultsInner.prototype['firstPublishedDate'] = undefined;

/**
 * The identifier of the package
 * @member {String} id
 */
ListAllDependencies200ResponseResultsInner.prototype['id'] = undefined;

/**
 * True if the latest version of the package is marked as deprecated; False otherwise.
 * @member {Boolean} isDeprecated
 */
ListAllDependencies200ResponseResultsInner.prototype['isDeprecated'] = undefined;

/**
 * The number of critical severity issues in this dependency
 * @member {Number} issuesCritical
 */
ListAllDependencies200ResponseResultsInner.prototype['issuesCritical'] = undefined;

/**
 * The number of high severity issues in this dependency
 * @member {Number} issuesHigh
 */
ListAllDependencies200ResponseResultsInner.prototype['issuesHigh'] = undefined;

/**
 * The number of low severity issues in this dependency
 * @member {Number} issuesLow
 */
ListAllDependencies200ResponseResultsInner.prototype['issuesLow'] = undefined;

/**
 * The number of medium severity issues in this dependency
 * @member {Number} issuesMedium
 */
ListAllDependencies200ResponseResultsInner.prototype['issuesMedium'] = undefined;

/**
 * The latest version available for the specified package
 * @member {String} latestVersion
 */
ListAllDependencies200ResponseResultsInner.prototype['latestVersion'] = undefined;

/**
 * The timestamp for when the latest version of the specified package was published.
 * @member {String} latestVersionPublishedDate
 */
ListAllDependencies200ResponseResultsInner.prototype['latestVersionPublishedDate'] = undefined;

/**
 * The licenses of the dependency
 * @member {Array.<module:model/ListAllDependencies200ResponseResultsInnerLicensesInner>} licenses
 */
ListAllDependencies200ResponseResultsInner.prototype['licenses'] = undefined;

/**
 * The name of the package
 * @member {String} name
 */
ListAllDependencies200ResponseResultsInner.prototype['name'] = undefined;

/**
 * The projects which depend on the dependency
 * @member {Array.<module:model/ListAllDependencies200ResponseResultsInnerProjectsInner>} projects
 */
ListAllDependencies200ResponseResultsInner.prototype['projects'] = undefined;

/**
 * The package type of the dependency
 * @member {String} type
 */
ListAllDependencies200ResponseResultsInner.prototype['type'] = undefined;

/**
 * The version of the package
 * @member {String} version
 */
ListAllDependencies200ResponseResultsInner.prototype['version'] = undefined;
...
export default ListAllDependencies200ResponseResultsInner;
