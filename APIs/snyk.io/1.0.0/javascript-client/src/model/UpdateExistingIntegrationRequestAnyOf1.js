...
/**
 * The UpdateExistingIntegrationRequestAnyOf1 model module.
 * @module model/UpdateExistingIntegrationRequestAnyOf1
 * @version 1.0.0
 */
class UpdateExistingIntegrationRequestAnyOf1 {
    /**
     * Constructs a new <code>UpdateExistingIntegrationRequestAnyOf1</code>.
     * @alias module:model/UpdateExistingIntegrationRequestAnyOf1
     * @param credentials {module:model/AddNewIntegrationRequestAnyOfCredentials} 
     * @param type {module:model/UpdateExistingIntegrationRequestAnyOf1.TypeEnum} integration type
     */
    constructor(credentials, type) { 
        
        UpdateExistingIntegrationRequestAnyOf1.initialize(this, credentials, type);
    }
    ...
    /**
     * Constructs a <code>UpdateExistingIntegrationRequestAnyOf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateExistingIntegrationRequestAnyOf1} obj Optional instance to populate.
     * @return {module:model/UpdateExistingIntegrationRequestAnyOf1} The populated <code>UpdateExistingIntegrationRequestAnyOf1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateExistingIntegrationRequestAnyOf1();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateExistingIntegrationRequestAnyOf1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateExistingIntegrationRequestAnyOf1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateExistingIntegrationRequestAnyOf1.RequiredProperties) {
...
UpdateExistingIntegrationRequestAnyOf1.RequiredProperties = ["credentials", "type"];

/**
 * @member {module:model/AddNewIntegrationRequestAnyOfCredentials} credentials
 */
UpdateExistingIntegrationRequestAnyOf1.prototype['credentials'] = undefined;

/**
 * integration type
 * @member {module:model/UpdateExistingIntegrationRequestAnyOf1.TypeEnum} type
 */
UpdateExistingIntegrationRequestAnyOf1.prototype['type'] = undefined;
 ...
 * @readonly
 */
UpdateExistingIntegrationRequestAnyOf1['TypeEnum'] = {
...
export default UpdateExistingIntegrationRequestAnyOf1;
