...
import RetrieveASingleProject200ResponseAttributes from './RetrieveASingleProject200ResponseAttributes';
import RetrieveASingleProject200ResponseImportingUser from './RetrieveASingleProject200ResponseImportingUser';
import RetrieveASingleProject200ResponseIssueCountsBySeverity from './RetrieveASingleProject200ResponseIssueCountsBySeverity';

/**
 * The ListAllProjects200ResponseProjectsInner model module.
 * @module model/ListAllProjects200ResponseProjectsInner
 * @version 1.0.0
 */
class ListAllProjects200ResponseProjectsInner {
    /**
     * Constructs a new <code>ListAllProjects200ResponseProjectsInner</code>.
     * @alias module:model/ListAllProjects200ResponseProjectsInner
     */
    constructor() { 
        
        ListAllProjects200ResponseProjectsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAllProjects200ResponseProjectsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAllProjects200ResponseProjectsInner} obj Optional instance to populate.
     * @return {module:model/ListAllProjects200ResponseProjectsInner} The populated <code>ListAllProjects200ResponseProjectsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAllProjects200ResponseProjectsInner();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = RetrieveASingleProject200ResponseAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('branch')) {
                obj['branch'] = ApiClient.convertToType(data['branch'], 'String');
            }
            if (data.hasOwnProperty('browseUrl')) {
                obj['browseUrl'] = ApiClient.convertToType(data['browseUrl'], 'String');
            }
            ...
            if (data.hasOwnProperty('imageBaseImage')) {
                obj['imageBaseImage'] = ApiClient.convertToType(data['imageBaseImage'], 'String');
            }
            if (data.hasOwnProperty('imageCluster')) {
                obj['imageCluster'] = ApiClient.convertToType(data['imageCluster'], 'String');
            }
            if (data.hasOwnProperty('imageId')) {
                obj['imageId'] = ApiClient.convertToType(data['imageId'], 'String');
            }
            if (data.hasOwnProperty('imagePlatform')) {
                obj['imagePlatform'] = ApiClient.convertToType(data['imagePlatform'], 'String');
            }
            if (data.hasOwnProperty('imageTag')) {
                obj['imageTag'] = ApiClient.convertToType(data['imageTag'], 'String');
            }
            if (data.hasOwnProperty('importingUser')) {
                obj['importingUser'] = RetrieveASingleProject200ResponseImportingUser.constructFromObject(data['importingUser']);
            }
            if (data.hasOwnProperty('isMonitored')) {
                obj['isMonitored'] = ApiClient.convertToType(data['isMonitored'], 'Boolean');
            }
            if (data.hasOwnProperty('issueCountsBySeverity')) {
                obj['issueCountsBySeverity'] = RetrieveASingleProject200ResponseIssueCountsBySeverity.constructFromObject(data['issueCountsBySeverity']);
            }
            if (data.hasOwnProperty('lastTestedDate')) {
                obj['lastTestedDate'] = ApiClient.convertToType(data['lastTestedDate'], 'String');
            }
            ...
            if (data.hasOwnProperty('remoteRepoUrl')) {
                obj['remoteRepoUrl'] = ApiClient.convertToType(data['remoteRepoUrl'], 'String');
            }
            if (data.hasOwnProperty('tags')) {
                obj['tags'] = ApiClient.convertToType(data['tags'], [Object]);
            }
            if (data.hasOwnProperty('targetReference')) {
                obj['targetReference'] = ApiClient.convertToType(data['targetReference'], 'String');
            }
            if (data.hasOwnProperty('testFrequency')) {
                obj['testFrequency'] = ApiClient.convertToType(data['testFrequency'], 'String');
            }
            if (data.hasOwnProperty('totalDependencies')) {
                obj['totalDependencies'] = ApiClient.convertToType(data['totalDependencies'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAllProjects200ResponseProjectsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAllProjects200ResponseProjectsInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          RetrieveASingleProject200ResponseAttributes.validateJSON(data['attributes']);
        }
        ...
        // ensure the json data is a string
        if (data['browseUrl'] && !(typeof data['browseUrl'] === 'string' || data['browseUrl'] instanceof String)) {
            throw new Error("Expected the field `browseUrl` to be a primitive type in the JSON string but got " + data['browseUrl']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['imageBaseImage'] && !(typeof data['imageBaseImage'] === 'string' || data['imageBaseImage'] instanceof String)) {
            throw new Error("Expected the field `imageBaseImage` to be a primitive type in the JSON string but got " + data['imageBaseImage']);
        }
        // ensure the json data is a string
        if (data['imageCluster'] && !(typeof data['imageCluster'] === 'string' || data['imageCluster'] instanceof String)) {
            throw new Error("Expected the field `imageCluster` to be a primitive type in the JSON string but got " + data['imageCluster']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['imagePlatform'] && !(typeof data['imagePlatform'] === 'string' || data['imagePlatform'] instanceof String)) {
            throw new Error("Expected the field `imagePlatform` to be a primitive type in the JSON string but got " + data['imagePlatform']);
        }
        // ensure the json data is a string
        ...
        if (data['importingUser']) { // data not null
          RetrieveASingleProject200ResponseImportingUser.validateJSON(data['importingUser']);
        }
        // validate the optional field `issueCountsBySeverity`
        if (data['issueCountsBySeverity']) { // data not null
          RetrieveASingleProject200ResponseIssueCountsBySeverity.validateJSON(data['issueCountsBySeverity']);
        }
        // ensure the json data is a string
        if (data['lastTestedDate'] && !(typeof data['lastTestedDate'] === 'string' || data['lastTestedDate'] instanceof String)) {
            throw new Error("Expected the field `lastTestedDate` to be a primitive type in the JSON string but got " + data['lastTestedDate']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['remoteRepoUrl'] && !(typeof data['remoteRepoUrl'] === 'string' || data['remoteRepoUrl'] instanceof String)) {
            throw new Error("Expected the field `remoteRepoUrl` to be a primitive type in the JSON string but got " + data['remoteRepoUrl']);
        }
        ...
        // ensure the json data is a string
        if (data['targetReference'] && !(typeof data['targetReference'] === 'string' || data['targetReference'] instanceof String)) {
            throw new Error("Expected the field `targetReference` to be a primitive type in the JSON string but got " + data['targetReference']);
        }
        // ensure the json data is a string
        if (data['testFrequency'] && !(typeof data['testFrequency'] === 'string' || data['testFrequency'] instanceof String)) {
            throw new Error("Expected the field `testFrequency` to be a primitive type in the JSON string but got " + data['testFrequency']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/RetrieveASingleProject200ResponseAttributes} attributes
 */
ListAllProjects200ResponseProjectsInner.prototype['attributes'] = undefined;

/**
 * The monitored branch (if available)
 * @member {String} branch
 */
ListAllProjects200ResponseProjectsInner.prototype['branch'] = undefined;

/**
 * URL with project overview
 * @member {String} browseUrl
 */
ListAllProjects200ResponseProjectsInner.prototype['browseUrl'] = undefined;

/**
 * The date that the project was created on
 * @member {String} created
 */
ListAllProjects200ResponseProjectsInner.prototype['created'] = undefined;

/**
 * The project identifier
 * @member {String} id
 */
ListAllProjects200ResponseProjectsInner.prototype['id'] = undefined;

/**
 * For docker projects shows the base image
 * @member {String} imageBaseImage
 */
ListAllProjects200ResponseProjectsInner.prototype['imageBaseImage'] = undefined;

/**
 * For Kubernetes projects shows the origin cluster name
 * @member {String} imageCluster
 */
ListAllProjects200ResponseProjectsInner.prototype['imageCluster'] = undefined;

/**
 * For docker projects shows the ID of the image
 * @member {String} imageId
 */
ListAllProjects200ResponseProjectsInner.prototype['imageId'] = undefined;

/**
 * For docker projects shows the platform of the image
 * @member {String} imagePlatform
 */
ListAllProjects200ResponseProjectsInner.prototype['imagePlatform'] = undefined;

/**
 * For docker projects shows the tag of the image
 * @member {String} imageTag
 */
ListAllProjects200ResponseProjectsInner.prototype['imageTag'] = undefined;

/**
 * @member {module:model/RetrieveASingleProject200ResponseImportingUser} importingUser
 */
ListAllProjects200ResponseProjectsInner.prototype['importingUser'] = undefined;

/**
 * Describes if a project is currently monitored or it is de-activated
 * @member {Boolean} isMonitored
 */
ListAllProjects200ResponseProjectsInner.prototype['isMonitored'] = undefined;

/**
 * @member {module:model/RetrieveASingleProject200ResponseIssueCountsBySeverity} issueCountsBySeverity
 */
ListAllProjects200ResponseProjectsInner.prototype['issueCountsBySeverity'] = undefined;

/**
 * The date on which the most recent test was conducted for this project
 * @member {String} lastTestedDate
 */
ListAllProjects200ResponseProjectsInner.prototype['lastTestedDate'] = undefined;

/**
 * @member {String} name
 */
ListAllProjects200ResponseProjectsInner.prototype['name'] = undefined;

/**
 * The origin the project was added from
 * @member {String} origin
 */
ListAllProjects200ResponseProjectsInner.prototype['origin'] = undefined;
 ...
 * @member {Object} owner
 */
ListAllProjects200ResponseProjectsInner.prototype['owner'] = undefined;

/**
 * Whether the project is read-only
 * @member {Boolean} readOnly
 */
ListAllProjects200ResponseProjectsInner.prototype['readOnly'] = undefined;

/**
 * The project remote repository url. Only set for projects imported via the Snyk CLI tool.
 * @member {String} remoteRepoUrl
 */
ListAllProjects200ResponseProjectsInner.prototype['remoteRepoUrl'] = undefined;

/**
 * List of applied tags
 * @member {Array.<Object>} tags
 */
ListAllProjects200ResponseProjectsInner.prototype['tags'] = undefined;
 ...
 * @member {String} targetReference
 */
ListAllProjects200ResponseProjectsInner.prototype['targetReference'] = undefined;

/**
 * The frequency of automated Snyk re-test. Can be 'daily', 'weekly or 'never'
 * @member {String} testFrequency
 */
ListAllProjects200ResponseProjectsInner.prototype['testFrequency'] = undefined;

/**
 * Number of dependencies of the project
 * @member {Number} totalDependencies
 */
ListAllProjects200ResponseProjectsInner.prototype['totalDependencies'] = undefined;

/**
 * The package manager of the project
 * @member {String} type
 */
ListAllProjects200ResponseProjectsInner.prototype['type'] = undefined;
...
export default ListAllProjects200ResponseProjectsInner;
