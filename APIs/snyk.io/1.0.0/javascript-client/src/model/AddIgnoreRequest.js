...
/**
 * The AddIgnoreRequest model module.
 * @module model/AddIgnoreRequest
 * @version 1.0.0
 */
class AddIgnoreRequest {
    /**
     * Constructs a new <code>AddIgnoreRequest</code>.
     * @alias module:model/AddIgnoreRequest
     * @param disregardIfFixable {Boolean} Only ignore the issue if no upgrade or patch is available.
     * @param reasonType {module:model/AddIgnoreRequest.ReasonTypeEnum} The classification of the ignore.
     */
    constructor(disregardIfFixable, reasonType) { 
        
        AddIgnoreRequest.initialize(this, disregardIfFixable, reasonType);
    }
     ...
     */
    static initialize(obj, disregardIfFixable, reasonType) { 
        obj['disregardIfFixable'] = disregardIfFixable;
        obj['reasonType'] = reasonType;
    }

    /**
     * Constructs a <code>AddIgnoreRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddIgnoreRequest} obj Optional instance to populate.
     * @return {module:model/AddIgnoreRequest} The populated <code>AddIgnoreRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddIgnoreRequest();

            if (data.hasOwnProperty('disregardIfFixable')) {
                obj['disregardIfFixable'] = ApiClient.convertToType(data['disregardIfFixable'], 'Boolean');
            }
            if (data.hasOwnProperty('expires')) {
                obj['expires'] = ApiClient.convertToType(data['expires'], 'String');
            }
            if (data.hasOwnProperty('ignorePath')) {
                obj['ignorePath'] = ApiClient.convertToType(data['ignorePath'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AddIgnoreRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddIgnoreRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddIgnoreRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['ignorePath'] && !(typeof data['ignorePath'] === 'string' || data['ignorePath'] instanceof String)) {
            throw new Error("Expected the field `ignorePath` to be a primitive type in the JSON string but got " + data['ignorePath']);
        }
        // ensure the json data is a string
...
AddIgnoreRequest.RequiredProperties = ["disregardIfFixable", "reasonType"];

/**
 * Only ignore the issue if no upgrade or patch is available.
 * @member {Boolean} disregardIfFixable
 */
AddIgnoreRequest.prototype['disregardIfFixable'] = undefined;

/**
 * The timestamp that the issue will no longer be ignored.
 * @member {String} expires
 */
AddIgnoreRequest.prototype['expires'] = undefined;

/**
 * The path to ignore (default is `*` which represents all paths).
 * @member {String} ignorePath
 */
AddIgnoreRequest.prototype['ignorePath'] = undefined;

/**
 * The reason that the issue was ignored.
 * @member {String} reason
 */
AddIgnoreRequest.prototype['reason'] = undefined;

/**
 * The classification of the ignore.
 * @member {module:model/AddIgnoreRequest.ReasonTypeEnum} reasonType
 */
AddIgnoreRequest.prototype['reasonType'] = undefined;
...
/**
 * Allowed values for the <code>reasonType</code> property.
 * @enum {String}
 * @readonly
 */
AddIgnoreRequest['ReasonTypeEnum'] = {
...
export default AddIgnoreRequest;
