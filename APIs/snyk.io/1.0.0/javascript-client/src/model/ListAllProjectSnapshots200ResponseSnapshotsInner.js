...
import ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts from './ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts';

/**
 * The ListAllProjectSnapshots200ResponseSnapshotsInner model module.
 * @module model/ListAllProjectSnapshots200ResponseSnapshotsInner
 * @version 1.0.0
 */
class ListAllProjectSnapshots200ResponseSnapshotsInner {
    /**
     * Constructs a new <code>ListAllProjectSnapshots200ResponseSnapshotsInner</code>.
     * @alias module:model/ListAllProjectSnapshots200ResponseSnapshotsInner
     * @param created {String} The date that the snapshot was taken
     * @param id {String} The snapshot identifier
     * @param issueCounts {module:model/ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts} 
     * @param totalDependencies {Number} Number of dependencies of the project
     */
    constructor(created, id, issueCounts, totalDependencies) { 
        
        ListAllProjectSnapshots200ResponseSnapshotsInner.initialize(this, created, id, issueCounts, totalDependencies);
    }
     ...
     */
    static initialize(obj, created, id, issueCounts, totalDependencies) { 
        obj['created'] = created;
        obj['id'] = id;
        obj['issueCounts'] = issueCounts;
        obj['totalDependencies'] = totalDependencies;
    }

    /**
     * Constructs a <code>ListAllProjectSnapshots200ResponseSnapshotsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAllProjectSnapshots200ResponseSnapshotsInner} obj Optional instance to populate.
     * @return {module:model/ListAllProjectSnapshots200ResponseSnapshotsInner} The populated <code>ListAllProjectSnapshots200ResponseSnapshotsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAllProjectSnapshots200ResponseSnapshotsInner();
            ...
            if (data.hasOwnProperty('issueCounts')) {
                obj['issueCounts'] = ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.constructFromObject(data['issueCounts']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAllProjectSnapshots200ResponseSnapshotsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAllProjectSnapshots200ResponseSnapshotsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAllProjectSnapshots200ResponseSnapshotsInner.RequiredProperties) {
        ...
        if (data['issueCounts']) { // data not null
          ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts.validateJSON(data['issueCounts']);
        }
        // ensure the json data is a string
...
ListAllProjectSnapshots200ResponseSnapshotsInner.RequiredProperties = ["created", "id", "issueCounts", "totalDependencies"];

/**
 * The date that the snapshot was taken
 * @member {String} created
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['created'] = undefined;

/**
 * The snapshot identifier
 * @member {String} id
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['id'] = undefined;

/**
 * @member {String} imageBaseImage
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['imageBaseImage'] = undefined;

/**
 * @member {String} imageId
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['imageId'] = undefined;

/**
 * @member {String} imagePlatform
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['imagePlatform'] = undefined;

/**
 * @member {String} imageTag
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['imageTag'] = undefined;

/**
 * @member {module:model/ListAllProjectSnapshots200ResponseSnapshotsInnerIssueCounts} issueCounts
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['issueCounts'] = undefined;

/**
 * The method by which this snapshot was created.
 * @member {module:model/ListAllProjectSnapshots200ResponseSnapshotsInner.MethodEnum} method
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['method'] = undefined;

/**
 * Number of dependencies of the project
 * @member {Number} totalDependencies
 */
ListAllProjectSnapshots200ResponseSnapshotsInner.prototype['totalDependencies'] = undefined;
 ...
 * @readonly
 */
ListAllProjectSnapshots200ResponseSnapshotsInner['MethodEnum'] = {
...
export default ListAllProjectSnapshots200ResponseSnapshotsInner;
