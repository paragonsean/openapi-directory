...
import AddNewIntegrationRequestAnyOfCredentials from './AddNewIntegrationRequestAnyOfCredentials';

/**
 * The UpdateExistingIntegrationRequestAnyOf2 model module.
 * @module model/UpdateExistingIntegrationRequestAnyOf2
 * @version 1.0.0
 */
class UpdateExistingIntegrationRequestAnyOf2 {
    /**
     * Constructs a new <code>UpdateExistingIntegrationRequestAnyOf2</code>.
     * @alias module:model/UpdateExistingIntegrationRequestAnyOf2
     * @param broker {module:model/AddNewIntegrationRequestAnyOf1Broker} 
     * @param credentials {module:model/AddNewIntegrationRequestAnyOfCredentials} 
     * @param type {module:model/UpdateExistingIntegrationRequestAnyOf2.TypeEnum} integration type
     */
    constructor(broker, credentials, type) { 
        
        UpdateExistingIntegrationRequestAnyOf2.initialize(this, broker, credentials, type);
    }
     ...
     */
    static initialize(obj, broker, credentials, type) { 
        obj['broker'] = broker;
    ...
    /**
     * Constructs a <code>UpdateExistingIntegrationRequestAnyOf2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateExistingIntegrationRequestAnyOf2} obj Optional instance to populate.
     * @return {module:model/UpdateExistingIntegrationRequestAnyOf2} The populated <code>UpdateExistingIntegrationRequestAnyOf2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateExistingIntegrationRequestAnyOf2();

            if (data.hasOwnProperty('broker')) {
                obj['broker'] = AddNewIntegrationRequestAnyOf1Broker.constructFromObject(data['broker']);
            }
            if (data.hasOwnProperty('credentials')) {
                obj['credentials'] = AddNewIntegrationRequestAnyOfCredentials.constructFromObject(data['credentials']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateExistingIntegrationRequestAnyOf2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateExistingIntegrationRequestAnyOf2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateExistingIntegrationRequestAnyOf2.RequiredProperties) {
        ...
        if (data['credentials']) { // data not null
          AddNewIntegrationRequestAnyOfCredentials.validateJSON(data['credentials']);
        }
...
UpdateExistingIntegrationRequestAnyOf2.RequiredProperties = ["broker", "credentials", "type"];

/**
 * @member {module:model/AddNewIntegrationRequestAnyOf1Broker} broker
 */
UpdateExistingIntegrationRequestAnyOf2.prototype['broker'] = undefined;

/**
 * @member {module:model/AddNewIntegrationRequestAnyOfCredentials} credentials
 */
UpdateExistingIntegrationRequestAnyOf2.prototype['credentials'] = undefined;

/**
 * integration type
 * @member {module:model/UpdateExistingIntegrationRequestAnyOf2.TypeEnum} type
 */
UpdateExistingIntegrationRequestAnyOf2.prototype['type'] = undefined;
 ...
 * @readonly
 */
UpdateExistingIntegrationRequestAnyOf2['TypeEnum'] = {
...
export default UpdateExistingIntegrationRequestAnyOf2;
