...
import AggregatedProjectIssuesIssuesInnerIssueData from './AggregatedProjectIssuesIssuesInnerIssueData';
import ListAllAggregatedIssues200ResponseIssuesInnerFixInfo from './ListAllAggregatedIssues200ResponseIssuesInnerFixInfo';
import ListAllAggregatedIssues200ResponseIssuesInnerLinks from './ListAllAggregatedIssues200ResponseIssuesInnerLinks';
import ListAllAggregatedIssues200ResponseIssuesInnerPriority from './ListAllAggregatedIssues200ResponseIssuesInnerPriority';

/**
 * The AggregatedProjectIssuesIssuesInner model module.
 * @module model/AggregatedProjectIssuesIssuesInner
 * @version 1.0.0
 */
class AggregatedProjectIssuesIssuesInner {
    /**
     * Constructs a new <code>AggregatedProjectIssuesIssuesInner</code>.
     * @alias module:model/AggregatedProjectIssuesIssuesInner
     * @param id {String} The identifier of the issue
     * @param isIgnored {Boolean} Whether the issue has been ignored
     * @param isPatched {Boolean} Whether the issue has been patched (Non-IaC projects only)
     * @param issueData {module:model/AggregatedProjectIssuesIssuesInnerIssueData} 
     * @param issueType {String} type of the issue ('vuln', 'license' or 'configuration')
     * @param pkgName {String} The package name (Non-IaC projects only)
     * @param pkgVersions {Array.<String>} List of affected package versions (Non-IaC projects only)
     */
    constructor(id, isIgnored, isPatched, issueData, issueType, pkgName, pkgVersions) { 
        
        AggregatedProjectIssuesIssuesInner.initialize(this, id, isIgnored, isPatched, issueData, issueType, pkgName, pkgVersions);
    }
     ...
     */
    static initialize(obj, id, isIgnored, isPatched, issueData, issueType, pkgName, pkgVersions) { 
        obj['id'] = id;
        obj['isIgnored'] = isIgnored;
        obj['isPatched'] = isPatched;
        obj['issueData'] = issueData;
        obj['issueType'] = issueType;
        obj['pkgName'] = pkgName;
        obj['pkgVersions'] = pkgVersions;
    }

    /**
     * Constructs a <code>AggregatedProjectIssuesIssuesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AggregatedProjectIssuesIssuesInner} obj Optional instance to populate.
     * @return {module:model/AggregatedProjectIssuesIssuesInner} The populated <code>AggregatedProjectIssuesIssuesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AggregatedProjectIssuesIssuesInner();

            if (data.hasOwnProperty('fixInfo')) {
                obj['fixInfo'] = ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.constructFromObject(data['fixInfo']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('ignoreReasons')) {
                obj['ignoreReasons'] = ApiClient.convertToType(data['ignoreReasons'], [Object]);
            }
            if (data.hasOwnProperty('introducedThrough')) {
                obj['introducedThrough'] = ApiClient.convertToType(data['introducedThrough'], [Object]);
            }
            ...
            if (data.hasOwnProperty('issueData')) {
                obj['issueData'] = AggregatedProjectIssuesIssuesInnerIssueData.constructFromObject(data['issueData']);
            }
            if (data.hasOwnProperty('issueType')) {
                obj['issueType'] = ApiClient.convertToType(data['issueType'], 'String');
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ListAllAggregatedIssues200ResponseIssuesInnerLinks.constructFromObject(data['links']);
            }
            if (data.hasOwnProperty('pkgName')) {
                obj['pkgName'] = ApiClient.convertToType(data['pkgName'], 'String');
            }
            if (data.hasOwnProperty('pkgVersions')) {
                obj['pkgVersions'] = ApiClient.convertToType(data['pkgVersions'], ['String']);
            }
            if (data.hasOwnProperty('priority')) {
                obj['priority'] = ListAllAggregatedIssues200ResponseIssuesInnerPriority.constructFromObject(data['priority']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AggregatedProjectIssuesIssuesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AggregatedProjectIssuesIssuesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AggregatedProjectIssuesIssuesInner.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `fixInfo`
        if (data['fixInfo']) { // data not null
          ListAllAggregatedIssues200ResponseIssuesInnerFixInfo.validateJSON(data['fixInfo']);
        }
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['introducedThrough'])) {
            throw new Error("Expected the field `introducedThrough` to be an array in the JSON data but got " + data['introducedThrough']);
        }
        // validate the optional field `issueData`
        if (data['issueData']) { // data not null
          AggregatedProjectIssuesIssuesInnerIssueData.validateJSON(data['issueData']);
        }
        // ensure the json data is a string
        ...
        if (data['links']) { // data not null
          ListAllAggregatedIssues200ResponseIssuesInnerLinks.validateJSON(data['links']);
        }
        // ensure the json data is a string
        if (data['pkgName'] && !(typeof data['pkgName'] === 'string' || data['pkgName'] instanceof String)) {
            throw new Error("Expected the field `pkgName` to be a primitive type in the JSON string but got " + data['pkgName']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['pkgVersions'])) {
            throw new Error("Expected the field `pkgVersions` to be an array in the JSON data but got " + data['pkgVersions']);
        }
        // validate the optional field `priority`
        if (data['priority']) { // data not null
          ListAllAggregatedIssues200ResponseIssuesInnerPriority.validateJSON(data['priority']);
        }
...
AggregatedProjectIssuesIssuesInner.RequiredProperties = ["id", "isIgnored", "isPatched", "issueData", "issueType", "pkgName", "pkgVersions"];

/**
 * @member {module:model/ListAllAggregatedIssues200ResponseIssuesInnerFixInfo} fixInfo
 */
AggregatedProjectIssuesIssuesInner.prototype['fixInfo'] = undefined;

/**
 * The identifier of the issue
 * @member {String} id
 */
AggregatedProjectIssuesIssuesInner.prototype['id'] = undefined;

/**
 * The list of reasons why the issue was ignored
 * @member {Array.<Object>} ignoreReasons
 */
AggregatedProjectIssuesIssuesInner.prototype['ignoreReasons'] = undefined;

/**
 * The list of what introduced the issue (it is available only for container project with Dockerfile)
 * @member {Array.<Object>} introducedThrough
 */
AggregatedProjectIssuesIssuesInner.prototype['introducedThrough'] = undefined;

/**
 * Whether the issue has been ignored
 * @member {Boolean} isIgnored
 */
AggregatedProjectIssuesIssuesInner.prototype['isIgnored'] = undefined;

/**
 * Whether the issue has been patched (Non-IaC projects only)
 * @member {Boolean} isPatched
 */
AggregatedProjectIssuesIssuesInner.prototype['isPatched'] = undefined;

/**
 * @member {module:model/AggregatedProjectIssuesIssuesInnerIssueData} issueData
 */
AggregatedProjectIssuesIssuesInner.prototype['issueData'] = undefined;

/**
 * type of the issue ('vuln', 'license' or 'configuration')
 * @member {String} issueType
 */
AggregatedProjectIssuesIssuesInner.prototype['issueType'] = undefined;

/**
 * @member {module:model/ListAllAggregatedIssues200ResponseIssuesInnerLinks} links
 */
AggregatedProjectIssuesIssuesInner.prototype['links'] = undefined;

/**
 * The package name (Non-IaC projects only)
 * @member {String} pkgName
 */
AggregatedProjectIssuesIssuesInner.prototype['pkgName'] = undefined;

/**
 * List of affected package versions (Non-IaC projects only)
 * @member {Array.<String>} pkgVersions
 */
AggregatedProjectIssuesIssuesInner.prototype['pkgVersions'] = undefined;

/**
 * @member {module:model/ListAllAggregatedIssues200ResponseIssuesInnerPriority} priority
 */
AggregatedProjectIssuesIssuesInner.prototype['priority'] = undefined;
...
export default AggregatedProjectIssuesIssuesInner;
