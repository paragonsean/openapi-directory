...
import NewIssuesNotificationSettingRequest from './NewIssuesNotificationSettingRequest';

/**
 * The NotificationSettingResponse model module.
 * @module model/NotificationSettingResponse
 * @version 1.0.0
 */
class NotificationSettingResponse {
    /**
     * Constructs a new <code>NotificationSettingResponse</code>.
     * @alias module:model/NotificationSettingResponse
     * @implements module:model/NewIssuesNotificationSettingRequest
     * @param enabled {Boolean} Whether notifications should be sent
     * @param issueSeverity {module:model/NotificationSettingResponse.IssueSeverityEnum} The severity levels of issues to send notifications for (only applicable for `new-remediations-vulnerabilities` notificationType)
     * @param issueType {module:model/NotificationSettingResponse.IssueTypeEnum} Filter the types of issue to include in notifications (only applicable for `new-remediations-vulnerabilities` notificationType)
     */
    constructor(enabled, issueSeverity, issueType) { 
        NewIssuesNotificationSettingRequest.initialize(this, enabled, issueSeverity, issueType);
        NotificationSettingResponse.initialize(this, enabled, issueSeverity, issueType);
    }
    ...
    /**
     * Constructs a <code>NotificationSettingResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotificationSettingResponse} obj Optional instance to populate.
     * @return {module:model/NotificationSettingResponse} The populated <code>NotificationSettingResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotificationSettingResponse();
            NewIssuesNotificationSettingRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>NotificationSettingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotificationSettingResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotificationSettingResponse.RequiredProperties) {
...
NotificationSettingResponse.RequiredProperties = ["enabled", "issueSeverity", "issueType"];

/**
 * Whether notifications should be sent
 * @member {Boolean} enabled
 */
NotificationSettingResponse.prototype['enabled'] = undefined;
 ...
 * @member {module:model/NotificationSettingResponse.IssueSeverityEnum} issueSeverity
 */
NotificationSettingResponse.prototype['issueSeverity'] = undefined;
 ...
 * @member {module:model/NotificationSettingResponse.IssueTypeEnum} issueType
 */
NotificationSettingResponse.prototype['issueType'] = undefined;

/**
 * Whether the setting was found on the requested context directly or inherited from a parent
 * @member {Boolean} inherited
 */
NotificationSettingResponse.prototype['inherited'] = undefined;


// Implement NewIssuesNotificationSettingRequest interface:
/**
 * Whether notifications should be sent
 * @member {Boolean} enabled
 */
NewIssuesNotificationSettingRequest.prototype['enabled'] = undefined;
/**
 * The severity levels of issues to send notifications for (only applicable for `new-remediations-vulnerabilities` notificationType)
 * @member {module:model/NewIssuesNotificationSettingRequest.IssueSeverityEnum} issueSeverity
 */
NewIssuesNotificationSettingRequest.prototype['issueSeverity'] = undefined;
/**
 * Filter the types of issue to include in notifications (only applicable for `new-remediations-vulnerabilities` notificationType)
 * @member {module:model/NewIssuesNotificationSettingRequest.IssueTypeEnum} issueType
 */
NewIssuesNotificationSettingRequest.prototype['issueType'] = undefined;
 ...
 * @readonly
 */
NotificationSettingResponse['IssueSeverityEnum'] = {
 ...
 * @readonly
 */
NotificationSettingResponse['IssueTypeEnum'] = {
...
export default NotificationSettingResponse;
