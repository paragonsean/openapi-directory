...
import ListAllLicenses200ResponseResultsInnerDependenciesInner from './ListAllLicenses200ResponseResultsInnerDependenciesInner';

/**
 * The ListAllLicenses200ResponseResultsInner model module.
 * @module model/ListAllLicenses200ResponseResultsInner
 * @version 1.0.0
 */
class ListAllLicenses200ResponseResultsInner {
    /**
     * Constructs a new <code>ListAllLicenses200ResponseResultsInner</code>.
     * @alias module:model/ListAllLicenses200ResponseResultsInner
     * @param dependencies {Array.<module:model/ListAllLicenses200ResponseResultsInnerDependenciesInner>} The dependencies of projects in the organization which have the license
     * @param id {String} The identifier of the license
     * @param projects {Array.<module:model/ListAllDependencies200ResponseResultsInnerProjectsInner>} The projects which contain the license
     */
    constructor(dependencies, id, projects) { 
        
        ListAllLicenses200ResponseResultsInner.initialize(this, dependencies, id, projects);
    }
     ...
     */
    static initialize(obj, dependencies, id, projects) { 
    ...
    /**
     * Constructs a <code>ListAllLicenses200ResponseResultsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAllLicenses200ResponseResultsInner} obj Optional instance to populate.
     * @return {module:model/ListAllLicenses200ResponseResultsInner} The populated <code>ListAllLicenses200ResponseResultsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAllLicenses200ResponseResultsInner();

            if (data.hasOwnProperty('dependencies')) {
                obj['dependencies'] = ApiClient.convertToType(data['dependencies'], [ListAllLicenses200ResponseResultsInnerDependenciesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAllLicenses200ResponseResultsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAllLicenses200ResponseResultsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAllLicenses200ResponseResultsInner.RequiredProperties) {
        ...
        if (data['dependencies']) { // data not null
            ...
            for (const item of data['dependencies']) {
                ListAllLicenses200ResponseResultsInnerDependenciesInner.validateJSON(item);
            };
        }
...
ListAllLicenses200ResponseResultsInner.RequiredProperties = ["dependencies", "id", "projects"];

/**
 * The dependencies of projects in the organization which have the license
 * @member {Array.<module:model/ListAllLicenses200ResponseResultsInnerDependenciesInner>} dependencies
 */
ListAllLicenses200ResponseResultsInner.prototype['dependencies'] = undefined;

/**
 * The identifier of the license
 * @member {String} id
 */
ListAllLicenses200ResponseResultsInner.prototype['id'] = undefined;

/**
 * Custom instructions assigned to this license
 * @member {String} instructions
 */
ListAllLicenses200ResponseResultsInner.prototype['instructions'] = undefined;
 ...
 */
ListAllLicenses200ResponseResultsInner.prototype['projects'] = undefined;

/**
 * The severity assigned to this license
 * @member {module:model/ListAllLicenses200ResponseResultsInner.SeverityEnum} severity
 */
ListAllLicenses200ResponseResultsInner.prototype['severity'] = undefined;
 ...
 * @readonly
 */
ListAllLicenses200ResponseResultsInner['SeverityEnum'] = {
...
export default ListAllLicenses200ResponseResultsInner;
