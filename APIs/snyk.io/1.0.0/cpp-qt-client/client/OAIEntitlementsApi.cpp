...
OAIEntitlementsApi::OAIEntitlementsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIEntitlementsApi::~OAIEntitlementsApi() {
}

void OAIEntitlementsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_an_organizations_entitlement_value", defaultConf);
    _serverIndices.insert("get_an_organizations_entitlement_value", 0);
    _serverConfigs.insert("list_all_entitlements", defaultConf);
    _serverIndices.insert("list_all_entitlements", 0);
}
...
*/
int OAIEntitlementsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIEntitlementsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIEntitlementsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIEntitlementsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIEntitlementsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIEntitlementsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIEntitlementsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIEntitlementsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIEntitlementsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIEntitlementsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEntitlementsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEntitlementsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIEntitlementsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIEntitlementsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIEntitlementsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIEntitlementsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIEntitlementsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIEntitlementsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIEntitlementsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIEntitlementsApi::get_an_organizations_entitlement_value(const QString &org_id, const QString &entitlement_key) {
    QString fullPath = QString(_serverConfigs["get_an_organizations_entitlement_value"][_serverIndices.value("get_an_organizations_entitlement_value")].URL()+"/org/{orgId}/entitlement/{entitlementKey}");
    ...
    {
        QString entitlement_keyPathParam("{");
        entitlement_keyPathParam.append("entitlementKey").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "entitlementKey", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"entitlementKey"+pathSuffix : pathPrefix;
        fullPath.replace(entitlement_keyPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(entitlement_key)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEntitlementsApi::get_an_organizations_entitlement_valueCallback);
    connect(this, &OAIEntitlementsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIEntitlementsApi::get_an_organizations_entitlement_valueCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_an_organizations_entitlement_valueSignal();
        Q_EMIT get_an_organizations_entitlement_valueSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_an_organizations_entitlement_valueSignalE(error_type, error_str);
        Q_EMIT get_an_organizations_entitlement_valueSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_an_organizations_entitlement_valueSignalError(error_type, error_str);
        Q_EMIT get_an_organizations_entitlement_valueSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEntitlementsApi::list_all_entitlements(const QString &org_id) {
    QString fullPath = QString(_serverConfigs["list_all_entitlements"][_serverIndices.value("list_all_entitlements")].URL()+"/org/{orgId}/entitlements");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEntitlementsApi::list_all_entitlementsCallback);
    connect(this, &OAIEntitlementsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEntitlementsApi::list_all_entitlementsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_all_entitlementsSignal();
        Q_EMIT list_all_entitlementsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_all_entitlementsSignalE(error_type, error_str);
        Q_EMIT list_all_entitlementsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_all_entitlementsSignalError(error_type, error_str);
        Q_EMIT list_all_entitlementsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEntitlementsApi::tokenAvailable(){
