...
#include "OAIList_all_projects_request_filters.h"
...
OAIList_all_projects_request_filters::OAIList_all_projects_request_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_projects_request_filters::OAIList_all_projects_request_filters() {
    this->initializeModel();
}

OAIList_all_projects_request_filters::~OAIList_all_projects_request_filters() {}

void OAIList_all_projects_request_filters::initializeModel() {
...
void OAIList_all_projects_request_filters::fromJson(QString jsonString) {
...
void OAIList_all_projects_request_filters::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_projects_request_filters::asJson() const {
...
QJsonObject OAIList_all_projects_request_filters::asJsonObject() const {
    QJsonObject obj;
...
OAIList_all_projects_request_filters_attributes OAIList_all_projects_request_filters::getAttributes() const {
    return m_attributes;
}
void OAIList_all_projects_request_filters::setAttributes(const OAIList_all_projects_request_filters_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIList_all_projects_request_filters::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIList_all_projects_request_filters::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIList_all_projects_request_filters::isIsMonitored() const {
    return m_is_monitored;
}
void OAIList_all_projects_request_filters::setIsMonitored(const bool &is_monitored) {
    m_is_monitored = is_monitored;
    m_is_monitored_isSet = true;
}

bool OAIList_all_projects_request_filters::is_is_monitored_Set() const{
    return m_is_monitored_isSet;
}

bool OAIList_all_projects_request_filters::is_is_monitored_Valid() const{
    return m_is_monitored_isValid;
}

QString OAIList_all_projects_request_filters::getName() const {
    return m_name;
}
void OAIList_all_projects_request_filters::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIList_all_projects_request_filters::is_name_Set() const{
    return m_name_isSet;
}

bool OAIList_all_projects_request_filters::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIList_all_projects_request_filters::getOrigin() const {
    return m_origin;
}
void OAIList_all_projects_request_filters::setOrigin(const QString &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIList_all_projects_request_filters::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIList_all_projects_request_filters::is_origin_Valid() const{
    return m_origin_isValid;
}

OAIList_all_projects_request_filters_tags OAIList_all_projects_request_filters::getTags() const {
    return m_tags;
}
void OAIList_all_projects_request_filters::setTags(const OAIList_all_projects_request_filters_tags &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIList_all_projects_request_filters::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIList_all_projects_request_filters::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIList_all_projects_request_filters::getType() const {
    return m_type;
}
void OAIList_all_projects_request_filters::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIList_all_projects_request_filters::is_type_Set() const{
    return m_type_isSet;
}

bool OAIList_all_projects_request_filters::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIList_all_projects_request_filters::isSet() const {
...
bool OAIList_all_projects_request_filters::isValid() const {
