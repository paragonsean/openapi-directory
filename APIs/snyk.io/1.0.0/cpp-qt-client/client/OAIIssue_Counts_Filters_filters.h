...
/*
 * OAIIssue_Counts_Filters_filters.h
 *
 * 
 */

#ifndef OAIIssue_Counts_Filters_filters_H
#define OAIIssue_Counts_Filters_filters_H
...
class OAIIssue_Counts_Filters_filters : public OAIObject {
public:
    OAIIssue_Counts_Filters_filters();
    OAIIssue_Counts_Filters_filters(QString json);
    ~OAIIssue_Counts_Filters_filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssue_Counts_Filters_filters)

#endif // OAIIssue_Counts_Filters_filters_H
