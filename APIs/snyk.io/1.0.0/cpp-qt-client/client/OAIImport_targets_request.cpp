...
#include "OAIImport_targets_request.h"
...
OAIImport_targets_request::OAIImport_targets_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImport_targets_request::OAIImport_targets_request() {
    this->initializeModel();
}

OAIImport_targets_request::~OAIImport_targets_request() {}

void OAIImport_targets_request::initializeModel() {
...
void OAIImport_targets_request::fromJson(QString jsonString) {
...
void OAIImport_targets_request::fromJsonObject(QJsonObject json) {
...
QString OAIImport_targets_request::asJson() const {
...
QJsonObject OAIImport_targets_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIImport_targets_request::getExclusionGlobs() const {
    return m_exclusion_globs;
}
void OAIImport_targets_request::setExclusionGlobs(const QString &exclusion_globs) {
    m_exclusion_globs = exclusion_globs;
    m_exclusion_globs_isSet = true;
}

bool OAIImport_targets_request::is_exclusion_globs_Set() const{
    return m_exclusion_globs_isSet;
}

bool OAIImport_targets_request::is_exclusion_globs_Valid() const{
    return m_exclusion_globs_isValid;
}

QList<OAIObject> OAIImport_targets_request::getFiles() const {
    return m_files;
}
void OAIImport_targets_request::setFiles(const QList<OAIObject> &files) {
    m_files = files;
    m_files_isSet = true;
}

bool OAIImport_targets_request::is_files_Set() const{
    return m_files_isSet;
}

bool OAIImport_targets_request::is_files_Valid() const{
    return m_files_isValid;
}

OAIImport_targets_request_anyOf_9_target OAIImport_targets_request::getTarget() const {
    return m_target;
}
void OAIImport_targets_request::setTarget(const OAIImport_targets_request_anyOf_9_target &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIImport_targets_request::is_target_Set() const{
    return m_target_isSet;
}

bool OAIImport_targets_request::is_target_Valid() const{
    return m_target_isValid;
}

bool OAIImport_targets_request::isSet() const {
...
bool OAIImport_targets_request::isValid() const {
