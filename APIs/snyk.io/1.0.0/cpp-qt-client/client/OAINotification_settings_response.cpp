...
#include "OAINotification_settings_response.h"
...
OAINotification_settings_response::OAINotification_settings_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotification_settings_response::OAINotification_settings_response() {
    this->initializeModel();
}

OAINotification_settings_response::~OAINotification_settings_response() {}

void OAINotification_settings_response::initializeModel() {

    m_new_issues_remediations_isSet = false;
    m_new_issues_remediations_isValid = false;

    m_project_imported_isSet = false;
    m_project_imported_isValid = false;

    m_test_limit_isSet = false;
    m_test_limit_isValid = false;

    m_weekly_report_isSet = false;
    m_weekly_report_isValid = false;
}

void OAINotification_settings_response::fromJson(QString jsonString) {
...
void OAINotification_settings_response::fromJsonObject(QJsonObject json) {

    m_new_issues_remediations_isValid = ::OpenAPI::fromJsonValue(m_new_issues_remediations, json[QString("new-issues-remediations")]);
    m_new_issues_remediations_isSet = !json[QString("new-issues-remediations")].isNull() && m_new_issues_remediations_isValid;

    m_project_imported_isValid = ::OpenAPI::fromJsonValue(m_project_imported, json[QString("project-imported")]);
    m_project_imported_isSet = !json[QString("project-imported")].isNull() && m_project_imported_isValid;

    m_test_limit_isValid = ::OpenAPI::fromJsonValue(m_test_limit, json[QString("test-limit")]);
    m_test_limit_isSet = !json[QString("test-limit")].isNull() && m_test_limit_isValid;

    m_weekly_report_isValid = ::OpenAPI::fromJsonValue(m_weekly_report, json[QString("weekly-report")]);
    m_weekly_report_isSet = !json[QString("weekly-report")].isNull() && m_weekly_report_isValid;
}

QString OAINotification_settings_response::asJson() const {
...
QJsonObject OAINotification_settings_response::asJsonObject() const {
    QJsonObject obj;
    if (m_new_issues_remediations.isSet()) {
        obj.insert(QString("new-issues-remediations"), ::OpenAPI::toJsonValue(m_new_issues_remediations));
    }
    if (m_project_imported.isSet()) {
        obj.insert(QString("project-imported"), ::OpenAPI::toJsonValue(m_project_imported));
    }
    if (m_test_limit.isSet()) {
        obj.insert(QString("test-limit"), ::OpenAPI::toJsonValue(m_test_limit));
    }
    if (m_weekly_report.isSet()) {
        obj.insert(QString("weekly-report"), ::OpenAPI::toJsonValue(m_weekly_report));
    }
    return obj;
}

OAINotification_setting_response OAINotification_settings_response::getNewIssuesRemediations() const {
    return m_new_issues_remediations;
}
void OAINotification_settings_response::setNewIssuesRemediations(const OAINotification_setting_response &new_issues_remediations) {
    m_new_issues_remediations = new_issues_remediations;
    m_new_issues_remediations_isSet = true;
}

bool OAINotification_settings_response::is_new_issues_remediations_Set() const{
    return m_new_issues_remediations_isSet;
}

bool OAINotification_settings_response::is_new_issues_remediations_Valid() const{
    return m_new_issues_remediations_isValid;
}

OAISimple_notification_setting_response OAINotification_settings_response::getProjectImported() const {
    return m_project_imported;
}
void OAINotification_settings_response::setProjectImported(const OAISimple_notification_setting_response &project_imported) {
    m_project_imported = project_imported;
    m_project_imported_isSet = true;
}

bool OAINotification_settings_response::is_project_imported_Set() const{
    return m_project_imported_isSet;
}

bool OAINotification_settings_response::is_project_imported_Valid() const{
    return m_project_imported_isValid;
}

OAISimple_notification_setting_response OAINotification_settings_response::getTestLimit() const {
    return m_test_limit;
}
void OAINotification_settings_response::setTestLimit(const OAISimple_notification_setting_response &test_limit) {
    m_test_limit = test_limit;
    m_test_limit_isSet = true;
}

bool OAINotification_settings_response::is_test_limit_Set() const{
    return m_test_limit_isSet;
}

bool OAINotification_settings_response::is_test_limit_Valid() const{
    return m_test_limit_isValid;
}

OAISimple_notification_setting_response OAINotification_settings_response::getWeeklyReport() const {
    return m_weekly_report;
}
void OAINotification_settings_response::setWeeklyReport(const OAISimple_notification_setting_response &weekly_report) {
    m_weekly_report = weekly_report;
    m_weekly_report_isSet = true;
}

bool OAINotification_settings_response::is_weekly_report_Set() const{
    return m_weekly_report_isSet;
}

bool OAINotification_settings_response::is_weekly_report_Valid() const{
    return m_weekly_report_isValid;
}

bool OAINotification_settings_response::isSet() const {
...
bool OAINotification_settings_response::isValid() const {
