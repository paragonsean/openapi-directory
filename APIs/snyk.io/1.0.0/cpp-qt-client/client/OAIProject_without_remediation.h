...
/*
 * OAIProject_without_remediation.h
 *
 * 
 */

#ifndef OAIProject_without_remediation_H
#define OAIProject_without_remediation_H

#include <QJsonObject>

#include "OAIObject.h"
#include "OAIProject_attributes.h"
#include "OAIRetrieve_a_single_project_200_response_importingUser.h"
#include "OAIRetrieve_a_single_project_200_response_issueCountsBySeverity.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIProject_attributes;
class OAIRetrieve_a_single_project_200_response_importingUser;
class OAIRetrieve_a_single_project_200_response_issueCountsBySeverity;

class OAIProject_without_remediation : public OAIObject {
public:
    OAIProject_without_remediation();
    OAIProject_without_remediation(QString json);
    ~OAIProject_without_remediation() override;
    ...
    OAIProject_attributes getAttributes() const;
    void setAttributes(const OAIProject_attributes &attributes);
    ...
    QString getBrowseUrl() const;
    void setBrowseUrl(const QString &browse_url);
    bool is_browse_url_Set() const;
    bool is_browse_url_Valid() const;
    ...
    QString getImageBaseImage() const;
    void setImageBaseImage(const QString &image_base_image);
    bool is_image_base_image_Set() const;
    bool is_image_base_image_Valid() const;

    QString getImageCluster() const;
    void setImageCluster(const QString &image_cluster);
    bool is_image_cluster_Set() const;
    bool is_image_cluster_Valid() const;
    ...
    QString getImagePlatform() const;
    void setImagePlatform(const QString &image_platform);
    bool is_image_platform_Set() const;
    bool is_image_platform_Valid() const;
    ...
    OAIRetrieve_a_single_project_200_response_importingUser getImportingUser() const;
    void setImportingUser(const OAIRetrieve_a_single_project_200_response_importingUser &importing_user);
    bool is_importing_user_Set() const;
    bool is_importing_user_Valid() const;

    bool isIsMonitored() const;
    void setIsMonitored(const bool &is_monitored);
    bool is_is_monitored_Set() const;
    bool is_is_monitored_Valid() const;

    OAIRetrieve_a_single_project_200_response_issueCountsBySeverity getIssueCountsBySeverity() const;
    void setIssueCountsBySeverity(const OAIRetrieve_a_single_project_200_response_issueCountsBySeverity &issue_counts_by_severity);
    bool is_issue_counts_by_severity_Set() const;
    bool is_issue_counts_by_severity_Valid() const;

    QString getLastTestedDate() const;
    void setLastTestedDate(const QString &last_tested_date);
    bool is_last_tested_date_Set() const;
    bool is_last_tested_date_Valid() const;
    ...
    QString getRemoteRepoUrl() const;
    void setRemoteRepoUrl(const QString &remote_repo_url);
    bool is_remote_repo_url_Set() const;
    bool is_remote_repo_url_Valid() const;
    ...
    void setTargetReference(const QString &target_reference);
    bool is_target_reference_Set() const;
    bool is_target_reference_Valid() const;

    QString getTestFrequency() const;
    void setTestFrequency(const QString &test_frequency);
    bool is_test_frequency_Set() const;
    bool is_test_frequency_Valid() const;

    double getTotalDependencies() const;
    void setTotalDependencies(const double &total_dependencies);
    bool is_total_dependencies_Set() const;
    bool is_total_dependencies_Valid() const;
...
private:
    ...
    OAIProject_attributes m_attributes;
    ...
    QString m_browse_url;
    bool m_browse_url_isSet;
    bool m_browse_url_isValid;
    ...
    QString m_image_base_image;
    bool m_image_base_image_isSet;
    bool m_image_base_image_isValid;

    QString m_image_cluster;
    bool m_image_cluster_isSet;
    bool m_image_cluster_isValid;

    QString m_image_id;
    bool m_image_id_isSet;
    bool m_image_id_isValid;

    QString m_image_platform;
    bool m_image_platform_isSet;
    bool m_image_platform_isValid;

    QString m_image_tag;
    bool m_image_tag_isSet;
    bool m_image_tag_isValid;

    OAIRetrieve_a_single_project_200_response_importingUser m_importing_user;
    bool m_importing_user_isSet;
    bool m_importing_user_isValid;

    bool m_is_monitored;
    bool m_is_monitored_isSet;
    bool m_is_monitored_isValid;

    OAIRetrieve_a_single_project_200_response_issueCountsBySeverity m_issue_counts_by_severity;
    bool m_issue_counts_by_severity_isSet;
    bool m_issue_counts_by_severity_isValid;

    QString m_last_tested_date;
    bool m_last_tested_date_isSet;
    bool m_last_tested_date_isValid;
    ...
    QString m_remote_repo_url;
    bool m_remote_repo_url_isSet;
    bool m_remote_repo_url_isValid;

    QList<QJsonValue> m_tags;
    bool m_tags_isSet;
    bool m_tags_isValid;

    QString m_target_reference;
    bool m_target_reference_isSet;
    bool m_target_reference_isValid;

    QString m_test_frequency;
    bool m_test_frequency_isSet;
    bool m_test_frequency_isValid;

    double m_total_dependencies;
    bool m_total_dependencies_isSet;
    bool m_total_dependencies_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProject_without_remediation)

#endif // OAIProject_without_remediation_H
