...
OAIGet_issue_counts_400_response::OAIGet_issue_counts_400_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_issue_counts_400_response::OAIGet_issue_counts_400_response() {
    this->initializeModel();
}

OAIGet_issue_counts_400_response::~OAIGet_issue_counts_400_response() {}

void OAIGet_issue_counts_400_response::initializeModel() {
...
void OAIGet_issue_counts_400_response::fromJson(QString jsonString) {
...
void OAIGet_issue_counts_400_response::fromJsonObject(QJsonObject json) {
...
QString OAIGet_issue_counts_400_response::asJson() const {
...
QJsonObject OAIGet_issue_counts_400_response::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
double OAIGet_issue_counts_400_response::getCode() const {
    return m_code;
}
void OAIGet_issue_counts_400_response::setCode(const double &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIGet_issue_counts_400_response::is_code_Set() const{
    return m_code_isSet;
}

bool OAIGet_issue_counts_400_response::is_code_Valid() const{
    return m_code_isValid;
}

OAIGet_issue_counts_400_response_error OAIGet_issue_counts_400_response::getError() const {
    return m_error;
}
void OAIGet_issue_counts_400_response::setError(const OAIGet_issue_counts_400_response_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIGet_issue_counts_400_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIGet_issue_counts_400_response::is_error_Valid() const{
    return m_error_isValid;
}

bool OAIGet_issue_counts_400_response::isOk() const {
    return m_ok;
}
void OAIGet_issue_counts_400_response::setOk(const bool &ok) {
    m_ok = ok;
    m_ok_isSet = true;
}

bool OAIGet_issue_counts_400_response::is_ok_Set() const{
    return m_ok_isSet;
}

bool OAIGet_issue_counts_400_response::is_ok_Valid() const{
    return m_ok_isValid;
}

bool OAIGet_issue_counts_400_response::isSet() const {
...
bool OAIGet_issue_counts_400_response::isValid() const {
