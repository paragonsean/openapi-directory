...
#include "OAIList_all_project_snapshots_200_response_snapshots_inner.h"
...
OAIList_all_project_snapshots_200_response_snapshots_inner::OAIList_all_project_snapshots_200_response_snapshots_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_project_snapshots_200_response_snapshots_inner::OAIList_all_project_snapshots_200_response_snapshots_inner() {
    this->initializeModel();
}

OAIList_all_project_snapshots_200_response_snapshots_inner::~OAIList_all_project_snapshots_200_response_snapshots_inner() {}

void OAIList_all_project_snapshots_200_response_snapshots_inner::initializeModel() {
    ...
    m_issue_counts_isSet = false;
    m_issue_counts_isValid = false;
...
void OAIList_all_project_snapshots_200_response_snapshots_inner::fromJson(QString jsonString) {
...
void OAIList_all_project_snapshots_200_response_snapshots_inner::fromJsonObject(QJsonObject json) {
    ...
    m_issue_counts_isValid = ::OpenAPI::fromJsonValue(m_issue_counts, json[QString("issueCounts")]);
    m_issue_counts_isSet = !json[QString("issueCounts")].isNull() && m_issue_counts_isValid;
...
QString OAIList_all_project_snapshots_200_response_snapshots_inner::asJson() const {
...
QJsonObject OAIList_all_project_snapshots_200_response_snapshots_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
    ...
    if (m_issue_counts.isSet()) {
        obj.insert(QString("issueCounts"), ::OpenAPI::toJsonValue(m_issue_counts));
    }
    if (m_method_isSet) {
...
QString OAIList_all_project_snapshots_200_response_snapshots_inner::getCreated() const {
    return m_created;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_created_Set() const{
    return m_created_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_created_Valid() const{
    return m_created_isValid;
}

QString OAIList_all_project_snapshots_200_response_snapshots_inner::getId() const {
    return m_id;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIList_all_project_snapshots_200_response_snapshots_inner::getImageBaseImage() const {
    return m_image_base_image;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setImageBaseImage(const QString &image_base_image) {
    m_image_base_image = image_base_image;
    m_image_base_image_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_base_image_Set() const{
    return m_image_base_image_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_base_image_Valid() const{
    return m_image_base_image_isValid;
}

QString OAIList_all_project_snapshots_200_response_snapshots_inner::getImageId() const {
    return m_image_id;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setImageId(const QString &image_id) {
    m_image_id = image_id;
    m_image_id_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_id_Set() const{
    return m_image_id_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_id_Valid() const{
    return m_image_id_isValid;
}

QString OAIList_all_project_snapshots_200_response_snapshots_inner::getImagePlatform() const {
    return m_image_platform;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setImagePlatform(const QString &image_platform) {
    m_image_platform = image_platform;
    m_image_platform_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_platform_Set() const{
    return m_image_platform_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_platform_Valid() const{
    return m_image_platform_isValid;
}

QString OAIList_all_project_snapshots_200_response_snapshots_inner::getImageTag() const {
    return m_image_tag;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setImageTag(const QString &image_tag) {
    m_image_tag = image_tag;
    m_image_tag_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_tag_Set() const{
    return m_image_tag_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_image_tag_Valid() const{
    return m_image_tag_isValid;
}

OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts OAIList_all_project_snapshots_200_response_snapshots_inner::getIssueCounts() const {
    return m_issue_counts;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setIssueCounts(const OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts &issue_counts) {
    m_issue_counts = issue_counts;
    m_issue_counts_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_issue_counts_Set() const{
    return m_issue_counts_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_issue_counts_Valid() const{
    return m_issue_counts_isValid;
}

QString OAIList_all_project_snapshots_200_response_snapshots_inner::getMethod() const {
    return m_method;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setMethod(const QString &method) {
    m_method = method;
    m_method_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_method_Set() const{
    return m_method_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_method_Valid() const{
    return m_method_isValid;
}

double OAIList_all_project_snapshots_200_response_snapshots_inner::getTotalDependencies() const {
    return m_total_dependencies;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner::setTotalDependencies(const double &total_dependencies) {
    m_total_dependencies = total_dependencies;
    m_total_dependencies_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_total_dependencies_Set() const{
    return m_total_dependencies_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::is_total_dependencies_Valid() const{
    return m_total_dependencies_isValid;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner::isSet() const {
...
bool OAIList_all_project_snapshots_200_response_snapshots_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_created_isValid && m_id_isValid && m_issue_counts_isValid && m_total_dependencies_isValid && true;
}
