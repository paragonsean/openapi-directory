...
#include "OAIRetrieve_a_single_project_200_response_remediation.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
class OAIRetrieve_a_single_project_200_response_remediation;
...
public:
    ...
    OAIRetrieve_a_single_project_200_response_remediation getRemediation() const;
    void setRemediation(const OAIRetrieve_a_single_project_200_response_remediation &remediation);
...
private:
    ...
    OAIRetrieve_a_single_project_200_response_remediation m_remediation;
