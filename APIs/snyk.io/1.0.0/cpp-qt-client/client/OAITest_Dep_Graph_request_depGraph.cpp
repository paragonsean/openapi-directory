...
#include "OAITest_Dep_Graph_request_depGraph.h"
...
OAITest_Dep_Graph_request_depGraph::OAITest_Dep_Graph_request_depGraph(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITest_Dep_Graph_request_depGraph::OAITest_Dep_Graph_request_depGraph() {
    this->initializeModel();
}

OAITest_Dep_Graph_request_depGraph::~OAITest_Dep_Graph_request_depGraph() {}

void OAITest_Dep_Graph_request_depGraph::initializeModel() {
...
void OAITest_Dep_Graph_request_depGraph::fromJson(QString jsonString) {
...
void OAITest_Dep_Graph_request_depGraph::fromJsonObject(QJsonObject json) {
...
QString OAITest_Dep_Graph_request_depGraph::asJson() const {
...
QJsonObject OAITest_Dep_Graph_request_depGraph::asJsonObject() const {
    QJsonObject obj;
    if (m_graph.isSet()) {
...
OAITest_Dep_Graph_request_depGraph_graph OAITest_Dep_Graph_request_depGraph::getGraph() const {
    return m_graph;
}
void OAITest_Dep_Graph_request_depGraph::setGraph(const OAITest_Dep_Graph_request_depGraph_graph &graph) {
    m_graph = graph;
    m_graph_isSet = true;
}

bool OAITest_Dep_Graph_request_depGraph::is_graph_Set() const{
    return m_graph_isSet;
}

bool OAITest_Dep_Graph_request_depGraph::is_graph_Valid() const{
    return m_graph_isValid;
}

OAIMonitor_Dep_Graph_request_depGraph_pkgManager OAITest_Dep_Graph_request_depGraph::getPkgManager() const {
    return m_pkg_manager;
}
void OAITest_Dep_Graph_request_depGraph::setPkgManager(const OAIMonitor_Dep_Graph_request_depGraph_pkgManager &pkg_manager) {
    m_pkg_manager = pkg_manager;
    m_pkg_manager_isSet = true;
}

bool OAITest_Dep_Graph_request_depGraph::is_pkg_manager_Set() const{
    return m_pkg_manager_isSet;
}

bool OAITest_Dep_Graph_request_depGraph::is_pkg_manager_Valid() const{
    return m_pkg_manager_isValid;
}

QList<QJsonValue> OAITest_Dep_Graph_request_depGraph::getPkgs() const {
    return m_pkgs;
}
void OAITest_Dep_Graph_request_depGraph::setPkgs(const QList<QJsonValue> &pkgs) {
    m_pkgs = pkgs;
    m_pkgs_isSet = true;
}

bool OAITest_Dep_Graph_request_depGraph::is_pkgs_Set() const{
    return m_pkgs_isSet;
}

bool OAITest_Dep_Graph_request_depGraph::is_pkgs_Valid() const{
    return m_pkgs_isValid;
}

QString OAITest_Dep_Graph_request_depGraph::getSchemaVersion() const {
    return m_schema_version;
}
void OAITest_Dep_Graph_request_depGraph::setSchemaVersion(const QString &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAITest_Dep_Graph_request_depGraph::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAITest_Dep_Graph_request_depGraph::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

bool OAITest_Dep_Graph_request_depGraph::isSet() const {
...
bool OAITest_Dep_Graph_request_depGraph::isValid() const {
