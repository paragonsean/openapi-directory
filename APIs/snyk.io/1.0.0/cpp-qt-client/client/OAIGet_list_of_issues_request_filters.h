...
/*
 * OAIGet_list_of_issues_request_filters.h
 *
 * 
 */

#ifndef OAIGet_list_of_issues_request_filters_H
#define OAIGet_list_of_issues_request_filters_H
...
class OAIGet_list_of_issues_request_filters : public OAIObject {
public:
    OAIGet_list_of_issues_request_filters();
    OAIGet_list_of_issues_request_filters(QString json);
    ~OAIGet_list_of_issues_request_filters() override;
    ...
    QJsonValue getIssues() const;
    void setIssues(const QJsonValue &issues);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_list_of_issues_request_filters)

#endif // OAIGet_list_of_issues_request_filters_H
