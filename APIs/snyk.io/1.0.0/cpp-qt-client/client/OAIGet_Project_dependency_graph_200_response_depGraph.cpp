...
#include "OAIGet_Project_dependency_graph_200_response_depGraph.h"
...
OAIGet_Project_dependency_graph_200_response_depGraph::OAIGet_Project_dependency_graph_200_response_depGraph(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_Project_dependency_graph_200_response_depGraph::OAIGet_Project_dependency_graph_200_response_depGraph() {
    this->initializeModel();
}

OAIGet_Project_dependency_graph_200_response_depGraph::~OAIGet_Project_dependency_graph_200_response_depGraph() {}

void OAIGet_Project_dependency_graph_200_response_depGraph::initializeModel() {
...
void OAIGet_Project_dependency_graph_200_response_depGraph::fromJson(QString jsonString) {
...
void OAIGet_Project_dependency_graph_200_response_depGraph::fromJsonObject(QJsonObject json) {
...
QString OAIGet_Project_dependency_graph_200_response_depGraph::asJson() const {
...
QJsonObject OAIGet_Project_dependency_graph_200_response_depGraph::asJsonObject() const {
    QJsonObject obj;
    if (m_graph.isSet()) {
...
OAIGet_Project_dependency_graph_200_response_depGraph_graph OAIGet_Project_dependency_graph_200_response_depGraph::getGraph() const {
    return m_graph;
}
void OAIGet_Project_dependency_graph_200_response_depGraph::setGraph(const OAIGet_Project_dependency_graph_200_response_depGraph_graph &graph) {
    m_graph = graph;
    m_graph_isSet = true;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_graph_Set() const{
    return m_graph_isSet;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_graph_Valid() const{
    return m_graph_isValid;
}

OAIGet_Project_dependency_graph_200_response_depGraph_pkgManager OAIGet_Project_dependency_graph_200_response_depGraph::getPkgManager() const {
    return m_pkg_manager;
}
void OAIGet_Project_dependency_graph_200_response_depGraph::setPkgManager(const OAIGet_Project_dependency_graph_200_response_depGraph_pkgManager &pkg_manager) {
    m_pkg_manager = pkg_manager;
    m_pkg_manager_isSet = true;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_pkg_manager_Set() const{
    return m_pkg_manager_isSet;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_pkg_manager_Valid() const{
    return m_pkg_manager_isValid;
}

QList<OAIGet_Project_dependency_graph_200_response_depGraph_pkgs_inner> OAIGet_Project_dependency_graph_200_response_depGraph::getPkgs() const {
    return m_pkgs;
}
void OAIGet_Project_dependency_graph_200_response_depGraph::setPkgs(const QList<OAIGet_Project_dependency_graph_200_response_depGraph_pkgs_inner> &pkgs) {
    m_pkgs = pkgs;
    m_pkgs_isSet = true;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_pkgs_Set() const{
    return m_pkgs_isSet;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_pkgs_Valid() const{
    return m_pkgs_isValid;
}

QString OAIGet_Project_dependency_graph_200_response_depGraph::getSchemaVersion() const {
    return m_schema_version;
}
void OAIGet_Project_dependency_graph_200_response_depGraph::setSchemaVersion(const QString &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

bool OAIGet_Project_dependency_graph_200_response_depGraph::isSet() const {
...
bool OAIGet_Project_dependency_graph_200_response_depGraph::isValid() const {
