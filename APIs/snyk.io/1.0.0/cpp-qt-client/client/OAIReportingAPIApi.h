...
#ifndef OAI_OAIReportingAPIApi_H
#define OAI_OAIReportingAPIApi_H
...
#include "OAIGet_issue_counts_200_response.h"
#include "OAIGet_issue_counts_400_response.h"
#include "OAIGet_issue_counts_request.h"
#include "OAIGet_list_of_issues_200_response.h"
#include "OAIGet_list_of_issues_request.h"
#include "OAIGet_project_counts_200_response.h"
#include "OAIGet_project_counts_request.h"
#include "OAIGet_test_counts_200_response.h"
#include "OAIGet_test_counts_request.h"
#include <QString>
...
class OAIReportingAPIApi : public QObject {
    Q_OBJECT

public:
    OAIReportingAPIApi(const int timeOut = 0);
    ~OAIReportingAPIApi();
    ...
    * @param[in]  oai_get_issue_counts_request OAIGet_issue_counts_request [optional]
    */
    virtual void get_issue_counts(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<QString> &group_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGet_issue_counts_request> &oai_get_issue_counts_request = ::OpenAPI::OptionalParam<OAIGet_issue_counts_request>());

    /**
    * @param[in]  group_by QString [optional]
    * @param[in]  oai_get_issue_counts_request OAIGet_issue_counts_request [optional]
    */
    virtual void get_latest_issue_counts(const ::OpenAPI::OptionalParam<QString> &group_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGet_issue_counts_request> &oai_get_issue_counts_request = ::OpenAPI::OptionalParam<OAIGet_issue_counts_request>());

    /**
    * @param[in]  oai_get_project_counts_request OAIGet_project_counts_request [optional]
    */
    virtual void get_latest_project_counts(const ::OpenAPI::OptionalParam<OAIGet_project_counts_request> &oai_get_project_counts_request = ::OpenAPI::OptionalParam<OAIGet_project_counts_request>());
    ...
    * @param[in]  group_by QString [optional]
    * @param[in]  oai_get_list_of_issues_request OAIGet_list_of_issues_request [optional]
    */
    virtual void get_list_of_issues(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<double> &page = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<double> &per_page = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<QString> &sort_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &group_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGet_list_of_issues_request> &oai_get_list_of_issues_request = ::OpenAPI::OptionalParam<OAIGet_list_of_issues_request>());
    ...
    * @param[in]  oai_get_list_of_issues_request OAIGet_list_of_issues_request [optional]
    */
    virtual void get_list_of_latest_issues(const ::OpenAPI::OptionalParam<double> &page = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<double> &per_page = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<QString> &sort_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &group_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGet_list_of_issues_request> &oai_get_list_of_issues_request = ::OpenAPI::OptionalParam<OAIGet_list_of_issues_request>());
    ...
    * @param[in]  oai_get_project_counts_request OAIGet_project_counts_request [optional]
    */
    virtual void get_project_counts(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<OAIGet_project_counts_request> &oai_get_project_counts_request = ::OpenAPI::OptionalParam<OAIGet_project_counts_request>());

    /**
    * @param[in]  from QString [required]
    * @param[in]  to QString [required]
    * @param[in]  group_by QString [optional]
    * @param[in]  oai_get_test_counts_request OAIGet_test_counts_request [optional]
    */
    virtual void get_test_counts(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<QString> &group_by = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGet_test_counts_request> &oai_get_test_counts_request = ::OpenAPI::OptionalParam<OAIGet_test_counts_request>());
...
private:
    ...
    void get_issue_countsCallback(OAIHttpRequestWorker *worker);
    void get_latest_issue_countsCallback(OAIHttpRequestWorker *worker);
    void get_latest_project_countsCallback(OAIHttpRequestWorker *worker);
    void get_list_of_issuesCallback(OAIHttpRequestWorker *worker);
    void get_list_of_latest_issuesCallback(OAIHttpRequestWorker *worker);
    void get_project_countsCallback(OAIHttpRequestWorker *worker);
    void get_test_countsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_issue_countsSignal(OAIGet_issue_counts_200_response summary);
    void get_latest_issue_countsSignal(OAIGet_issue_counts_200_response summary);
    void get_latest_project_countsSignal(OAIGet_project_counts_200_response summary);
    void get_list_of_issuesSignal(OAIGet_list_of_issues_200_response summary);
    void get_list_of_latest_issuesSignal(OAIGet_list_of_issues_200_response summary);
    void get_project_countsSignal(OAIGet_project_counts_200_response summary);
    void get_test_countsSignal(OAIGet_test_counts_200_response summary);


    void get_issue_countsSignalFull(OAIHttpRequestWorker *worker, OAIGet_issue_counts_200_response summary);
    void get_latest_issue_countsSignalFull(OAIHttpRequestWorker *worker, OAIGet_issue_counts_200_response summary);
    void get_latest_project_countsSignalFull(OAIHttpRequestWorker *worker, OAIGet_project_counts_200_response summary);
    void get_list_of_issuesSignalFull(OAIHttpRequestWorker *worker, OAIGet_list_of_issues_200_response summary);
    void get_list_of_latest_issuesSignalFull(OAIHttpRequestWorker *worker, OAIGet_list_of_issues_200_response summary);
    void get_project_countsSignalFull(OAIHttpRequestWorker *worker, OAIGet_project_counts_200_response summary);
    void get_test_countsSignalFull(OAIHttpRequestWorker *worker, OAIGet_test_counts_200_response summary);

    Q_DECL_DEPRECATED_X("Use get_issue_countsSignalError() instead")
    void get_issue_countsSignalE(OAIGet_issue_counts_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_issue_countsSignalError(OAIGet_issue_counts_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_latest_issue_countsSignalError() instead")
    void get_latest_issue_countsSignalE(OAIGet_issue_counts_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_latest_issue_countsSignalError(OAIGet_issue_counts_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_latest_project_countsSignalError() instead")
    void get_latest_project_countsSignalE(OAIGet_project_counts_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_latest_project_countsSignalError(OAIGet_project_counts_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_list_of_issuesSignalError() instead")
    void get_list_of_issuesSignalE(OAIGet_list_of_issues_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_list_of_issuesSignalError(OAIGet_list_of_issues_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_list_of_latest_issuesSignalError() instead")
    void get_list_of_latest_issuesSignalE(OAIGet_list_of_issues_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_list_of_latest_issuesSignalError(OAIGet_list_of_issues_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_project_countsSignalError() instead")
    void get_project_countsSignalE(OAIGet_project_counts_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_project_countsSignalError(OAIGet_project_counts_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_test_countsSignalError() instead")
    void get_test_countsSignalE(OAIGet_test_counts_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_test_countsSignalError(OAIGet_test_counts_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_issue_countsSignalErrorFull() instead")
    void get_issue_countsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_issue_countsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_latest_issue_countsSignalErrorFull() instead")
    void get_latest_issue_countsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_latest_issue_countsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_latest_project_countsSignalErrorFull() instead")
    void get_latest_project_countsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_latest_project_countsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_list_of_issuesSignalErrorFull() instead")
    void get_list_of_issuesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_list_of_issuesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_list_of_latest_issuesSignalErrorFull() instead")
    void get_list_of_latest_issuesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_list_of_latest_issuesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_project_countsSignalErrorFull() instead")
    void get_project_countsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_project_countsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_test_countsSignalErrorFull() instead")
    void get_test_countsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_test_countsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
