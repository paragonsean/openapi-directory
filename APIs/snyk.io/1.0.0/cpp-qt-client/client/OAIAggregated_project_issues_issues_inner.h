...
/*
 * OAIAggregated_project_issues_issues_inner.h
 *
 * 
 */

#ifndef OAIAggregated_project_issues_issues_inner_H
#define OAIAggregated_project_issues_issues_inner_H
...
class OAIAggregated_project_issues_issues_inner_issueData;
...
class OAIAggregated_project_issues_issues_inner : public OAIObject {
public:
    OAIAggregated_project_issues_issues_inner();
    OAIAggregated_project_issues_issues_inner(QString json);
    ~OAIAggregated_project_issues_issues_inner() override;
    ...
    OAIAggregated_project_issues_issues_inner_issueData getIssueData() const;
    void setIssueData(const OAIAggregated_project_issues_issues_inner_issueData &issue_data);
...
private:
    ...
    OAIAggregated_project_issues_issues_inner_issueData m_issue_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAggregated_project_issues_issues_inner)

#endif // OAIAggregated_project_issues_issues_inner_H
