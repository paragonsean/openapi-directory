...
OAIMonitorNode::OAIMonitorNode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMonitorNode::OAIMonitorNode() {
    this->initializeModel();
}

OAIMonitorNode::~OAIMonitorNode() {}

void OAIMonitorNode::initializeModel() {

    m_deps_isSet = false;
    m_deps_isValid = false;

    m_node_id_isSet = false;
    m_node_id_isValid = false;

    m_pkg_id_isSet = false;
    m_pkg_id_isValid = false;
}

void OAIMonitorNode::fromJson(QString jsonString) {
...
void OAIMonitorNode::fromJsonObject(QJsonObject json) {

    m_deps_isValid = ::OpenAPI::fromJsonValue(m_deps, json[QString("deps")]);
    m_deps_isSet = !json[QString("deps")].isNull() && m_deps_isValid;
    ...
    m_pkg_id_isValid = ::OpenAPI::fromJsonValue(m_pkg_id, json[QString("pkgId")]);
    m_pkg_id_isSet = !json[QString("pkgId")].isNull() && m_pkg_id_isValid;
}

QString OAIMonitorNode::asJson() const {
...
QJsonObject OAIMonitorNode::asJsonObject() const {
    QJsonObject obj;
    if (m_deps.size() > 0) {
        obj.insert(QString("deps"), ::OpenAPI::toJsonValue(m_deps));
    }
    if (m_node_id_isSet) {
        obj.insert(QString("nodeId"), ::OpenAPI::toJsonValue(m_node_id));
    }
    if (m_pkg_id_isSet) {
        obj.insert(QString("pkgId"), ::OpenAPI::toJsonValue(m_pkg_id));
    }
    return obj;
}

QList<QJsonValue> OAIMonitorNode::getDeps() const {
    return m_deps;
}
void OAIMonitorNode::setDeps(const QList<QJsonValue> &deps) {
    m_deps = deps;
    m_deps_isSet = true;
}

bool OAIMonitorNode::is_deps_Set() const{
    return m_deps_isSet;
}

bool OAIMonitorNode::is_deps_Valid() const{
    return m_deps_isValid;
}

QString OAIMonitorNode::getNodeId() const {
    return m_node_id;
}
void OAIMonitorNode::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAIMonitorNode::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAIMonitorNode::is_node_id_Valid() const{
    return m_node_id_isValid;
}

QString OAIMonitorNode::getPkgId() const {
    return m_pkg_id;
}
void OAIMonitorNode::setPkgId(const QString &pkg_id) {
    m_pkg_id = pkg_id;
    m_pkg_id_isSet = true;
}

bool OAIMonitorNode::is_pkg_id_Set() const{
    return m_pkg_id_isSet;
}

bool OAIMonitorNode::is_pkg_id_Valid() const{
    return m_pkg_id_isValid;
}

bool OAIMonitorNode::isSet() const {
...
bool OAIMonitorNode::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_node_id_isValid && m_pkg_id_isValid && true;
}
