...
#include "OAIUpdate_existing_integration_request_anyOf_2.h"
...
OAIUpdate_existing_integration_request_anyOf_2::OAIUpdate_existing_integration_request_anyOf_2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdate_existing_integration_request_anyOf_2::OAIUpdate_existing_integration_request_anyOf_2() {
    this->initializeModel();
}

OAIUpdate_existing_integration_request_anyOf_2::~OAIUpdate_existing_integration_request_anyOf_2() {}

void OAIUpdate_existing_integration_request_anyOf_2::initializeModel() {
...
void OAIUpdate_existing_integration_request_anyOf_2::fromJson(QString jsonString) {
...
void OAIUpdate_existing_integration_request_anyOf_2::fromJsonObject(QJsonObject json) {
...
QString OAIUpdate_existing_integration_request_anyOf_2::asJson() const {
...
QJsonObject OAIUpdate_existing_integration_request_anyOf_2::asJsonObject() const {
    QJsonObject obj;
    if (m_broker.isSet()) {
...
OAIAdd_new_integration_request_anyOf_1_broker OAIUpdate_existing_integration_request_anyOf_2::getBroker() const {
    return m_broker;
}
void OAIUpdate_existing_integration_request_anyOf_2::setBroker(const OAIAdd_new_integration_request_anyOf_1_broker &broker) {
    m_broker = broker;
    m_broker_isSet = true;
}

bool OAIUpdate_existing_integration_request_anyOf_2::is_broker_Set() const{
    return m_broker_isSet;
}

bool OAIUpdate_existing_integration_request_anyOf_2::is_broker_Valid() const{
    return m_broker_isValid;
}

OAIAdd_new_integration_request_anyOf_credentials OAIUpdate_existing_integration_request_anyOf_2::getCredentials() const {
    return m_credentials;
}
void OAIUpdate_existing_integration_request_anyOf_2::setCredentials(const OAIAdd_new_integration_request_anyOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIUpdate_existing_integration_request_anyOf_2::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIUpdate_existing_integration_request_anyOf_2::is_credentials_Valid() const{
    return m_credentials_isValid;
}

QString OAIUpdate_existing_integration_request_anyOf_2::getType() const {
    return m_type;
}
void OAIUpdate_existing_integration_request_anyOf_2::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdate_existing_integration_request_anyOf_2::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdate_existing_integration_request_anyOf_2::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIUpdate_existing_integration_request_anyOf_2::isSet() const {
...
bool OAIUpdate_existing_integration_request_anyOf_2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_broker_isValid && m_credentials_isValid && m_type_isValid && true;
}
