...
OAIDelete_tag_body::OAIDelete_tag_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDelete_tag_body::OAIDelete_tag_body() {
    this->initializeModel();
}

OAIDelete_tag_body::~OAIDelete_tag_body() {}

void OAIDelete_tag_body::initializeModel() {
...
void OAIDelete_tag_body::fromJson(QString jsonString) {
...
void OAIDelete_tag_body::fromJsonObject(QJsonObject json) {
...
QString OAIDelete_tag_body::asJson() const {
...
QJsonObject OAIDelete_tag_body::asJsonObject() const {
    QJsonObject obj;
    if (m_force_isSet) {
...
bool OAIDelete_tag_body::isForce() const {
    return m_force;
}
void OAIDelete_tag_body::setForce(const bool &force) {
    m_force = force;
    m_force_isSet = true;
}

bool OAIDelete_tag_body::is_force_Set() const{
    return m_force_isSet;
}

bool OAIDelete_tag_body::is_force_Valid() const{
    return m_force_isValid;
}

QString OAIDelete_tag_body::getKey() const {
    return m_key;
}
void OAIDelete_tag_body::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIDelete_tag_body::is_key_Set() const{
    return m_key_isSet;
}

bool OAIDelete_tag_body::is_key_Valid() const{
    return m_key_isValid;
}

QString OAIDelete_tag_body::getValue() const {
    return m_value;
}
void OAIDelete_tag_body::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDelete_tag_body::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDelete_tag_body::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIDelete_tag_body::isSet() const {
...
bool OAIDelete_tag_body::isValid() const {
