...
#include "OAIList_all_licenses_request_filters.h"
...
OAIList_all_licenses_request_filters::OAIList_all_licenses_request_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_licenses_request_filters::OAIList_all_licenses_request_filters() {
    this->initializeModel();
}

OAIList_all_licenses_request_filters::~OAIList_all_licenses_request_filters() {}

void OAIList_all_licenses_request_filters::initializeModel() {
...
void OAIList_all_licenses_request_filters::fromJson(QString jsonString) {
...
void OAIList_all_licenses_request_filters::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_licenses_request_filters::asJson() const {
...
QJsonObject OAIList_all_licenses_request_filters::asJsonObject() const {
    QJsonObject obj;
...
QJsonValue OAIList_all_licenses_request_filters::getDependencies() const {
    return m_dependencies;
}
void OAIList_all_licenses_request_filters::setDependencies(const QJsonValue &dependencies) {
    m_dependencies = dependencies;
    m_dependencies_isSet = true;
}

bool OAIList_all_licenses_request_filters::is_dependencies_Set() const{
    return m_dependencies_isSet;
}

bool OAIList_all_licenses_request_filters::is_dependencies_Valid() const{
    return m_dependencies_isValid;
}

QList<QJsonValue> OAIList_all_licenses_request_filters::getLanguages() const {
    return m_languages;
}
void OAIList_all_licenses_request_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIList_all_licenses_request_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIList_all_licenses_request_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QJsonValue OAIList_all_licenses_request_filters::getLicenses() const {
    return m_licenses;
}
void OAIList_all_licenses_request_filters::setLicenses(const QJsonValue &licenses) {
    m_licenses = licenses;
    m_licenses_isSet = true;
}

bool OAIList_all_licenses_request_filters::is_licenses_Set() const{
    return m_licenses_isSet;
}

bool OAIList_all_licenses_request_filters::is_licenses_Valid() const{
    return m_licenses_isValid;
}

QJsonValue OAIList_all_licenses_request_filters::getProjects() const {
    return m_projects;
}
void OAIList_all_licenses_request_filters::setProjects(const QJsonValue &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIList_all_licenses_request_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIList_all_licenses_request_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

QList<QJsonValue> OAIList_all_licenses_request_filters::getSeverity() const {
    return m_severity;
}
void OAIList_all_licenses_request_filters::setSeverity(const QList<QJsonValue> &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIList_all_licenses_request_filters::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIList_all_licenses_request_filters::is_severity_Valid() const{
    return m_severity_isValid;
}

bool OAIList_all_licenses_request_filters::isSet() const {
...
bool OAIList_all_licenses_request_filters::isValid() const {
