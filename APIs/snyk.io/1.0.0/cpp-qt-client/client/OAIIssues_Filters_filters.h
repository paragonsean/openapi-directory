...
/*
 * OAIIssues_Filters_filters.h
 *
 * 
 */

#ifndef OAIIssues_Filters_filters_H
#define OAIIssues_Filters_filters_H

#include <QJsonObject>

#include "OAIPriorityScore.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIPriorityScore;

class OAIIssues_Filters_filters : public OAIObject {
public:
    OAIIssues_Filters_filters();
    OAIIssues_Filters_filters(QString json);
    ~OAIIssues_Filters_filters() override;
    ...
    QList<QJsonValue> getExploitMaturity() const;
    void setExploitMaturity(const QList<QJsonValue> &exploit_maturity);
    ...
    void setIsFixed(const bool &is_fixed);
    bool is_is_fixed_Set() const;
    bool is_is_fixed_Valid() const;
    ...
    QList<QJsonValue> getIssues() const;
    void setIssues(const QList<QJsonValue> &issues);
    ...
    QList<QJsonValue> getOrgs() const;
    void setOrgs(const QList<QJsonValue> &orgs);
    ...
    OAIPriorityScore getPriorityScore() const;
    void setPriorityScore(const OAIPriorityScore &priority_score);
    bool is_priority_score_Set() const;
    bool is_priority_score_Valid() const;

    QList<QJsonValue> getProjects() const;
    void setProjects(const QList<QJsonValue> &projects);
...
private:
    ...
    QList<QJsonValue> m_exploit_maturity;
    ...
    bool m_is_fixed;
    bool m_is_fixed_isSet;
    bool m_is_fixed_isValid;
    ...
    OAIPriorityScore m_priority_score;
    bool m_priority_score_isSet;
    bool m_priority_score_isValid;

    QList<QJsonValue> m_projects;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssues_Filters_filters)

#endif // OAIIssues_Filters_filters_H
