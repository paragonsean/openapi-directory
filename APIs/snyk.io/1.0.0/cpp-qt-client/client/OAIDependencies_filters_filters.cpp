...
#include "OAIDependencies_filters_filters.h"
...
OAIDependencies_filters_filters::OAIDependencies_filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDependencies_filters_filters::OAIDependencies_filters_filters() {
    this->initializeModel();
}

OAIDependencies_filters_filters::~OAIDependencies_filters_filters() {}

void OAIDependencies_filters_filters::initializeModel() {
...
void OAIDependencies_filters_filters::fromJson(QString jsonString) {
...
void OAIDependencies_filters_filters::fromJsonObject(QJsonObject json) {
...
QString OAIDependencies_filters_filters::asJson() const {
...
QJsonObject OAIDependencies_filters_filters::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDependencies_filters_filters::getDepStatus() const {
    return m_dep_status;
}
void OAIDependencies_filters_filters::setDepStatus(const QString &dep_status) {
    m_dep_status = dep_status;
    m_dep_status_isSet = true;
}

bool OAIDependencies_filters_filters::is_dep_status_Set() const{
    return m_dep_status_isSet;
}

bool OAIDependencies_filters_filters::is_dep_status_Valid() const{
    return m_dep_status_isValid;
}

QList<QJsonValue> OAIDependencies_filters_filters::getDependencies() const {
    return m_dependencies;
}
void OAIDependencies_filters_filters::setDependencies(const QList<QJsonValue> &dependencies) {
    m_dependencies = dependencies;
    m_dependencies_isSet = true;
}

bool OAIDependencies_filters_filters::is_dependencies_Set() const{
    return m_dependencies_isSet;
}

bool OAIDependencies_filters_filters::is_dependencies_Valid() const{
    return m_dependencies_isValid;
}

QList<QJsonValue> OAIDependencies_filters_filters::getLanguages() const {
    return m_languages;
}
void OAIDependencies_filters_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIDependencies_filters_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIDependencies_filters_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QList<QJsonValue> OAIDependencies_filters_filters::getLicenses() const {
    return m_licenses;
}
void OAIDependencies_filters_filters::setLicenses(const QList<QJsonValue> &licenses) {
    m_licenses = licenses;
    m_licenses_isSet = true;
}

bool OAIDependencies_filters_filters::is_licenses_Set() const{
    return m_licenses_isSet;
}

bool OAIDependencies_filters_filters::is_licenses_Valid() const{
    return m_licenses_isValid;
}

QList<QJsonValue> OAIDependencies_filters_filters::getProjects() const {
    return m_projects;
}
void OAIDependencies_filters_filters::setProjects(const QList<QJsonValue> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIDependencies_filters_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIDependencies_filters_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

QList<QJsonValue> OAIDependencies_filters_filters::getSeverity() const {
    return m_severity;
}
void OAIDependencies_filters_filters::setSeverity(const QList<QJsonValue> &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIDependencies_filters_filters::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIDependencies_filters_filters::is_severity_Valid() const{
    return m_severity_isValid;
}

bool OAIDependencies_filters_filters::isSet() const {
...
bool OAIDependencies_filters_filters::isValid() const {
