...
#include "OAITests_Filters_filters.h"
...
OAITests_Filters_filters::OAITests_Filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITests_Filters_filters::OAITests_Filters_filters() {
    this->initializeModel();
}

OAITests_Filters_filters::~OAITests_Filters_filters() {}

void OAITests_Filters_filters::initializeModel() {
...
void OAITests_Filters_filters::fromJson(QString jsonString) {
...
void OAITests_Filters_filters::fromJsonObject(QJsonObject json) {
...
QString OAITests_Filters_filters::asJson() const {
...
QJsonObject OAITests_Filters_filters::asJsonObject() const {
    QJsonObject obj;
...
bool OAITests_Filters_filters::isIsPrivate() const {
    return m_is_private;
}
void OAITests_Filters_filters::setIsPrivate(const bool &is_private) {
    m_is_private = is_private;
    m_is_private_isSet = true;
}

bool OAITests_Filters_filters::is_is_private_Set() const{
    return m_is_private_isSet;
}

bool OAITests_Filters_filters::is_is_private_Valid() const{
    return m_is_private_isValid;
}

bool OAITests_Filters_filters::isIssuesPrevented() const {
    return m_issues_prevented;
}
void OAITests_Filters_filters::setIssuesPrevented(const bool &issues_prevented) {
    m_issues_prevented = issues_prevented;
    m_issues_prevented_isSet = true;
}

bool OAITests_Filters_filters::is_issues_prevented_Set() const{
    return m_issues_prevented_isSet;
}

bool OAITests_Filters_filters::is_issues_prevented_Valid() const{
    return m_issues_prevented_isValid;
}

QList<QJsonValue> OAITests_Filters_filters::getOrgs() const {
    return m_orgs;
}
void OAITests_Filters_filters::setOrgs(const QList<QJsonValue> &orgs) {
    m_orgs = orgs;
    m_orgs_isSet = true;
}

bool OAITests_Filters_filters::is_orgs_Set() const{
    return m_orgs_isSet;
}

bool OAITests_Filters_filters::is_orgs_Valid() const{
    return m_orgs_isValid;
}

QList<QJsonValue> OAITests_Filters_filters::getProjects() const {
    return m_projects;
}
void OAITests_Filters_filters::setProjects(const QList<QJsonValue> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAITests_Filters_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAITests_Filters_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

bool OAITests_Filters_filters::isSet() const {
...
bool OAITests_Filters_filters::isValid() const {
