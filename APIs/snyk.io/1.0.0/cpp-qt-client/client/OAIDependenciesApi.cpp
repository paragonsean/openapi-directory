...
OAIDependenciesApi::OAIDependenciesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIDependenciesApi::~OAIDependenciesApi() {
}

void OAIDependenciesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("list_all_dependencies", defaultConf);
    _serverIndices.insert("list_all_dependencies", 0);
}
...
*/
int OAIDependenciesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIDependenciesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIDependenciesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIDependenciesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIDependenciesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIDependenciesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIDependenciesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIDependenciesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIDependenciesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIDependenciesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDependenciesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDependenciesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIDependenciesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIDependenciesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIDependenciesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIDependenciesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIDependenciesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIDependenciesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIDependenciesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIDependenciesApi::list_all_dependencies(const QString &org_id, const ::OpenAPI::OptionalParam<QString> &sort_by, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<double> &page, const ::OpenAPI::OptionalParam<double> &per_page, const ::OpenAPI::OptionalParam<OAIList_all_dependencies_request> &oai_list_all_dependencies_request) {
    QString fullPath = QString(_serverConfigs["list_all_dependencies"][_serverIndices.value("list_all_dependencies")].URL()+"/org/{orgId}/dependencies");
    ...
    if (oai_list_all_dependencies_request.hasValue()){

        
        QByteArray output = oai_list_all_dependencies_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDependenciesApi::list_all_dependenciesCallback);
    connect(this, &OAIDependenciesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIDependenciesApi::list_all_dependenciesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIList_all_dependencies_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_all_dependenciesSignal(output);
        Q_EMIT list_all_dependenciesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_all_dependenciesSignalE(output, error_type, error_str);
        Q_EMIT list_all_dependenciesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_all_dependenciesSignalError(output, error_type, error_str);
        Q_EMIT list_all_dependenciesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDependenciesApi::tokenAvailable(){
