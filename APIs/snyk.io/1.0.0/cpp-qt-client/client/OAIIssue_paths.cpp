...
OAIIssue_paths::OAIIssue_paths(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIssue_paths::OAIIssue_paths() {
    this->initializeModel();
}

OAIIssue_paths::~OAIIssue_paths() {}

void OAIIssue_paths::initializeModel() {
...
void OAIIssue_paths::fromJson(QString jsonString) {
...
void OAIIssue_paths::fromJsonObject(QJsonObject json) {
...
QString OAIIssue_paths::asJson() const {
...
QJsonObject OAIIssue_paths::asJsonObject() const {
    QJsonObject obj;
    if (m_links.isSet()) {
...
OAIList_all_project_snapshot_issue_paths_200_response_links OAIIssue_paths::getLinks() const {
    return m_links;
}
void OAIIssue_paths::setLinks(const OAIList_all_project_snapshot_issue_paths_200_response_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIIssue_paths::is_links_Set() const{
    return m_links_isSet;
}

bool OAIIssue_paths::is_links_Valid() const{
    return m_links_isValid;
}

QList<QList<OAIList_all_project_snapshot_issue_paths_200_response_paths_inner_inner>> OAIIssue_paths::getPaths() const {
    return m_paths;
}
void OAIIssue_paths::setPaths(const QList<QList<OAIList_all_project_snapshot_issue_paths_200_response_paths_inner_inner>> &paths) {
    m_paths = paths;
    m_paths_isSet = true;
}

bool OAIIssue_paths::is_paths_Set() const{
    return m_paths_isSet;
}

bool OAIIssue_paths::is_paths_Valid() const{
    return m_paths_isValid;
}

QString OAIIssue_paths::getSnapshotId() const {
    return m_snapshot_id;
}
void OAIIssue_paths::setSnapshotId(const QString &snapshot_id) {
    m_snapshot_id = snapshot_id;
    m_snapshot_id_isSet = true;
}

bool OAIIssue_paths::is_snapshot_id_Set() const{
    return m_snapshot_id_isSet;
}

bool OAIIssue_paths::is_snapshot_id_Valid() const{
    return m_snapshot_id_isValid;
}

double OAIIssue_paths::getTotal() const {
    return m_total;
}
void OAIIssue_paths::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIIssue_paths::is_total_Set() const{
    return m_total_isSet;
}

bool OAIIssue_paths::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIIssue_paths::isSet() const {
...
bool OAIIssue_paths::isValid() const {
