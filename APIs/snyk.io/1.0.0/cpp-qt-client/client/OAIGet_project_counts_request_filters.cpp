...
#include "OAIGet_project_counts_request_filters.h"
...
OAIGet_project_counts_request_filters::OAIGet_project_counts_request_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_project_counts_request_filters::OAIGet_project_counts_request_filters() {
    this->initializeModel();
}

OAIGet_project_counts_request_filters::~OAIGet_project_counts_request_filters() {}

void OAIGet_project_counts_request_filters::initializeModel() {
...
void OAIGet_project_counts_request_filters::fromJson(QString jsonString) {
...
void OAIGet_project_counts_request_filters::fromJsonObject(QJsonObject json) {
...
QString OAIGet_project_counts_request_filters::asJson() const {
...
QJsonObject OAIGet_project_counts_request_filters::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIGet_project_counts_request_filters::getLanguages() const {
    return m_languages;
}
void OAIGet_project_counts_request_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIGet_project_counts_request_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIGet_project_counts_request_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QJsonValue OAIGet_project_counts_request_filters::getOrgs() const {
    return m_orgs;
}
void OAIGet_project_counts_request_filters::setOrgs(const QJsonValue &orgs) {
    m_orgs = orgs;
    m_orgs_isSet = true;
}

bool OAIGet_project_counts_request_filters::is_orgs_Set() const{
    return m_orgs_isSet;
}

bool OAIGet_project_counts_request_filters::is_orgs_Valid() const{
    return m_orgs_isValid;
}

QJsonValue OAIGet_project_counts_request_filters::getProjects() const {
    return m_projects;
}
void OAIGet_project_counts_request_filters::setProjects(const QJsonValue &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIGet_project_counts_request_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIGet_project_counts_request_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

bool OAIGet_project_counts_request_filters::isSet() const {
...
bool OAIGet_project_counts_request_filters::isValid() const {
