...
/*
 * OAIGet_issue_counts_request_filters.h
 *
 * 
 */

#ifndef OAIGet_issue_counts_request_filters_H
#define OAIGet_issue_counts_request_filters_H

#include <QJsonObject>

#include "OAIGet_issue_counts_request_filters_priorityScore.h"
#include <QJsonValue>
#include <QList>
...
namespace OpenAPI {
class OAIGet_issue_counts_request_filters_priorityScore;

class OAIGet_issue_counts_request_filters : public OAIObject {
public:
    OAIGet_issue_counts_request_filters();
    OAIGet_issue_counts_request_filters(QString json);
    ~OAIGet_issue_counts_request_filters() override;
    ...
    void setFixable(const bool &fixable);
    bool is_fixable_Set() const;
    bool is_fixable_Valid() const;
    ...
    bool isIsPatchable() const;
    void setIsPatchable(const bool &is_patchable);
    bool is_is_patchable_Set() const;
    bool is_is_patchable_Valid() const;

    bool isIsPinnable() const;
    void setIsPinnable(const bool &is_pinnable);
    bool is_is_pinnable_Set() const;
    bool is_is_pinnable_Valid() const;
    ...
    QList<QJsonValue> getLanguages() const;
    void setLanguages(const QList<QJsonValue> &languages);
    bool is_languages_Set() const;
    bool is_languages_Valid() const;

    QJsonValue getOrgs() const;
    void setOrgs(const QJsonValue &orgs);
    bool is_orgs_Set() const;
    bool is_orgs_Valid() const;

    bool isPatched() const;
    void setPatched(const bool &patched);
    bool is_patched_Set() const;
    bool is_patched_Valid() const;

    OAIGet_issue_counts_request_filters_priorityScore getPriorityScore() const;
    void setPriorityScore(const OAIGet_issue_counts_request_filters_priorityScore &priority_score);
    bool is_priority_score_Set() const;
    bool is_priority_score_Valid() const;

    QJsonValue getProjects() const;
    void setProjects(const QJsonValue &projects);
    bool is_projects_Set() const;
    bool is_projects_Valid() const;

    QList<QJsonValue> getSeverity() const;
    void setSeverity(const QList<QJsonValue> &severity);
    bool is_severity_Set() const;
    bool is_severity_Valid() const;

    QList<QJsonValue> getTypes() const;
    void setTypes(const QList<QJsonValue> &types);
...
private:
    ...
    bool m_fixable;
    bool m_fixable_isSet;
    bool m_fixable_isValid;
    ...
    bool m_is_patchable;
    bool m_is_patchable_isSet;
    bool m_is_patchable_isValid;

    bool m_is_pinnable;
    bool m_is_pinnable_isSet;
    bool m_is_pinnable_isValid;

    bool m_is_upgradable;
    bool m_is_upgradable_isSet;
    bool m_is_upgradable_isValid;

    QList<QJsonValue> m_languages;
    ...
    bool m_patched;
    bool m_patched_isSet;
    bool m_patched_isValid;

    OAIGet_issue_counts_request_filters_priorityScore m_priority_score;
    bool m_priority_score_isSet;
    bool m_priority_score_isValid;

    QJsonValue m_projects;
    bool m_projects_isSet;
    bool m_projects_isValid;

    QList<QJsonValue> m_severity;
    bool m_severity_isSet;
    bool m_severity_isValid;

    QList<QJsonValue> m_types;
    bool m_types_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_issue_counts_request_filters)

#endif // OAIGet_issue_counts_request_filters_H
