...
/*
 * OAIRetrieve_a_single_project_200_response.h
 *
 * 
 */

#ifndef OAIRetrieve_a_single_project_200_response_H
#define OAIRetrieve_a_single_project_200_response_H
...
class OAIRetrieve_a_single_project_200_response : public OAIObject {
public:
    OAIRetrieve_a_single_project_200_response();
    OAIRetrieve_a_single_project_200_response(QString json);
    ~OAIRetrieve_a_single_project_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieve_a_single_project_200_response)

#endif // OAIRetrieve_a_single_project_200_response_H
