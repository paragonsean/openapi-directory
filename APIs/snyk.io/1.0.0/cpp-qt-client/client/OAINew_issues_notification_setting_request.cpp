...
#include "OAINew_issues_notification_setting_request.h"
...
OAINew_issues_notification_setting_request::OAINew_issues_notification_setting_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINew_issues_notification_setting_request::OAINew_issues_notification_setting_request() {
    this->initializeModel();
}

OAINew_issues_notification_setting_request::~OAINew_issues_notification_setting_request() {}

void OAINew_issues_notification_setting_request::initializeModel() {
...
void OAINew_issues_notification_setting_request::fromJson(QString jsonString) {
...
void OAINew_issues_notification_setting_request::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("enabled")]);
    m_enabled_isSet = !json[QString("enabled")].isNull() && m_enabled_isValid;

    m_issue_severity_isValid = ::OpenAPI::fromJsonValue(m_issue_severity, json[QString("issueSeverity")]);
    m_issue_severity_isSet = !json[QString("issueSeverity")].isNull() && m_issue_severity_isValid;
...
QString OAINew_issues_notification_setting_request::asJson() const {
...
QJsonObject OAINew_issues_notification_setting_request::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
        obj.insert(QString("enabled"), ::OpenAPI::toJsonValue(m_enabled));
    }
    if (m_issue_severity_isSet) {
        obj.insert(QString("issueSeverity"), ::OpenAPI::toJsonValue(m_issue_severity));
    }
...
bool OAINew_issues_notification_setting_request::isEnabled() const {
    return m_enabled;
}
void OAINew_issues_notification_setting_request::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAINew_issues_notification_setting_request::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAINew_issues_notification_setting_request::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAINew_issues_notification_setting_request::getIssueSeverity() const {
    return m_issue_severity;
}
void OAINew_issues_notification_setting_request::setIssueSeverity(const QString &issue_severity) {
    m_issue_severity = issue_severity;
    m_issue_severity_isSet = true;
}

bool OAINew_issues_notification_setting_request::is_issue_severity_Set() const{
    return m_issue_severity_isSet;
}

bool OAINew_issues_notification_setting_request::is_issue_severity_Valid() const{
    return m_issue_severity_isValid;
}

QString OAINew_issues_notification_setting_request::getIssueType() const {
    return m_issue_type;
}
void OAINew_issues_notification_setting_request::setIssueType(const QString &issue_type) {
    m_issue_type = issue_type;
    m_issue_type_isSet = true;
}

bool OAINew_issues_notification_setting_request::is_issue_type_Set() const{
    return m_issue_type_isSet;
}

bool OAINew_issues_notification_setting_request::is_issue_type_Valid() const{
    return m_issue_type_isValid;
}

bool OAINew_issues_notification_setting_request::isSet() const {
...
bool OAINew_issues_notification_setting_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_enabled_isValid && m_issue_severity_isValid && m_issue_type_isValid && true;
}
