...
OAIRetrieve_a_single_project_200_response_remediation::OAIRetrieve_a_single_project_200_response_remediation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetrieve_a_single_project_200_response_remediation::OAIRetrieve_a_single_project_200_response_remediation() {
    this->initializeModel();
}

OAIRetrieve_a_single_project_200_response_remediation::~OAIRetrieve_a_single_project_200_response_remediation() {}

void OAIRetrieve_a_single_project_200_response_remediation::initializeModel() {
...
void OAIRetrieve_a_single_project_200_response_remediation::fromJson(QString jsonString) {
...
void OAIRetrieve_a_single_project_200_response_remediation::fromJsonObject(QJsonObject json) {
...
QString OAIRetrieve_a_single_project_200_response_remediation::asJson() const {
...
QJsonObject OAIRetrieve_a_single_project_200_response_remediation::asJsonObject() const {
    QJsonObject obj;
    if (m_patch_isSet) {
...
OAIObject OAIRetrieve_a_single_project_200_response_remediation::getPatch() const {
    return m_patch;
}
void OAIRetrieve_a_single_project_200_response_remediation::setPatch(const OAIObject &patch) {
    m_patch = patch;
    m_patch_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_remediation::is_patch_Set() const{
    return m_patch_isSet;
}

bool OAIRetrieve_a_single_project_200_response_remediation::is_patch_Valid() const{
    return m_patch_isValid;
}

OAIObject OAIRetrieve_a_single_project_200_response_remediation::getPin() const {
    return m_pin;
}
void OAIRetrieve_a_single_project_200_response_remediation::setPin(const OAIObject &pin) {
    m_pin = pin;
    m_pin_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_remediation::is_pin_Set() const{
    return m_pin_isSet;
}

bool OAIRetrieve_a_single_project_200_response_remediation::is_pin_Valid() const{
    return m_pin_isValid;
}

OAIObject OAIRetrieve_a_single_project_200_response_remediation::getUpgrade() const {
    return m_upgrade;
}
void OAIRetrieve_a_single_project_200_response_remediation::setUpgrade(const OAIObject &upgrade) {
    m_upgrade = upgrade;
    m_upgrade_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_remediation::is_upgrade_Set() const{
    return m_upgrade_isSet;
}

bool OAIRetrieve_a_single_project_200_response_remediation::is_upgrade_Valid() const{
    return m_upgrade_isValid;
}

bool OAIRetrieve_a_single_project_200_response_remediation::isSet() const {
...
bool OAIRetrieve_a_single_project_200_response_remediation::isValid() const {
