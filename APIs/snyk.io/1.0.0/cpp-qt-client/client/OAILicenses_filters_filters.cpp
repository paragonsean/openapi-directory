...
#include "OAILicenses_filters_filters.h"
...
OAILicenses_filters_filters::OAILicenses_filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILicenses_filters_filters::OAILicenses_filters_filters() {
    this->initializeModel();
}

OAILicenses_filters_filters::~OAILicenses_filters_filters() {}

void OAILicenses_filters_filters::initializeModel() {
...
void OAILicenses_filters_filters::fromJson(QString jsonString) {
...
void OAILicenses_filters_filters::fromJsonObject(QJsonObject json) {
...
QString OAILicenses_filters_filters::asJson() const {
...
QJsonObject OAILicenses_filters_filters::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAILicenses_filters_filters::getDependencies() const {
    return m_dependencies;
}
void OAILicenses_filters_filters::setDependencies(const QList<QJsonValue> &dependencies) {
    m_dependencies = dependencies;
    m_dependencies_isSet = true;
}

bool OAILicenses_filters_filters::is_dependencies_Set() const{
    return m_dependencies_isSet;
}

bool OAILicenses_filters_filters::is_dependencies_Valid() const{
    return m_dependencies_isValid;
}

QList<QJsonValue> OAILicenses_filters_filters::getLanguages() const {
    return m_languages;
}
void OAILicenses_filters_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAILicenses_filters_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAILicenses_filters_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QList<QJsonValue> OAILicenses_filters_filters::getLicenses() const {
    return m_licenses;
}
void OAILicenses_filters_filters::setLicenses(const QList<QJsonValue> &licenses) {
    m_licenses = licenses;
    m_licenses_isSet = true;
}

bool OAILicenses_filters_filters::is_licenses_Set() const{
    return m_licenses_isSet;
}

bool OAILicenses_filters_filters::is_licenses_Valid() const{
    return m_licenses_isValid;
}

QList<QJsonValue> OAILicenses_filters_filters::getProjects() const {
    return m_projects;
}
void OAILicenses_filters_filters::setProjects(const QList<QJsonValue> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAILicenses_filters_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAILicenses_filters_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

QList<QJsonValue> OAILicenses_filters_filters::getSeverity() const {
    return m_severity;
}
void OAILicenses_filters_filters::setSeverity(const QList<QJsonValue> &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAILicenses_filters_filters::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAILicenses_filters_filters::is_severity_Valid() const{
    return m_severity_isValid;
}

bool OAILicenses_filters_filters::isSet() const {
...
bool OAILicenses_filters_filters::isValid() const {
