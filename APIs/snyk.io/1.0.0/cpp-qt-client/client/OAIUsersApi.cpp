...
void OAIUsersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_My_Details", defaultConf);
    _serverIndices.insert("get_My_Details", 0);
    _serverConfigs.insert("get_User_Details", defaultConf);
    _serverIndices.insert("get_User_Details", 0);
    _serverConfigs.insert("get_organization_notification_settings", defaultConf);
    _serverIndices.insert("get_organization_notification_settings", 0);
    _serverConfigs.insert("get_project_notification_settings", defaultConf);
    _serverIndices.insert("get_project_notification_settings", 0);
    _serverConfigs.insert("modify_organization_notification_settings", defaultConf);
    _serverIndices.insert("modify_organization_notification_settings", 0);
    _serverConfigs.insert("modify_project_notification_settings", defaultConf);
    _serverIndices.insert("modify_project_notification_settings", 0);
}
...
void OAIUsersApi::get_My_Details() {
    QString fullPath = QString(_serverConfigs["get_My_Details"][_serverIndices.value("get_My_Details")].URL()+"/user/me");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::get_My_DetailsCallback);
...
void OAIUsersApi::get_My_DetailsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGet_My_Details_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_My_DetailsSignal(output);
        Q_EMIT get_My_DetailsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_My_DetailsSignalE(output, error_type, error_str);
        Q_EMIT get_My_DetailsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_My_DetailsSignalError(output, error_type, error_str);
        Q_EMIT get_My_DetailsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUsersApi::get_User_Details(const QString &user_id) {
    QString fullPath = QString(_serverConfigs["get_User_Details"][_serverIndices.value("get_User_Details")].URL()+"/user/{userId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::get_User_DetailsCallback);
    connect(this, &OAIUsersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUsersApi::get_User_DetailsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGet_User_Details_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_User_DetailsSignal(output);
        Q_EMIT get_User_DetailsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_User_DetailsSignalE(output, error_type, error_str);
        Q_EMIT get_User_DetailsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_User_DetailsSignalError(output, error_type, error_str);
        Q_EMIT get_User_DetailsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUsersApi::get_organization_notification_settings(const QString &org_id) {
    QString fullPath = QString(_serverConfigs["get_organization_notification_settings"][_serverIndices.value("get_organization_notification_settings")].URL()+"/user/me/notification-settings/org/{orgId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::get_organization_notification_settingsCallback);
    connect(this, &OAIUsersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUsersApi::get_organization_notification_settingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_organization_notification_settingsSignal(output);
        Q_EMIT get_organization_notification_settingsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_organization_notification_settingsSignalE(output, error_type, error_str);
        Q_EMIT get_organization_notification_settingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_organization_notification_settingsSignalError(output, error_type, error_str);
        Q_EMIT get_organization_notification_settingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUsersApi::get_project_notification_settings(const QString &org_id, const QString &project_id) {
    QString fullPath = QString(_serverConfigs["get_project_notification_settings"][_serverIndices.value("get_project_notification_settings")].URL()+"/user/me/notification-settings/org/{orgId}/project/{projectId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::get_project_notification_settingsCallback);
    connect(this, &OAIUsersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUsersApi::get_project_notification_settingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_project_notification_settingsSignal(output);
        Q_EMIT get_project_notification_settingsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_project_notification_settingsSignalE(output, error_type, error_str);
        Q_EMIT get_project_notification_settingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_project_notification_settingsSignalError(output, error_type, error_str);
        Q_EMIT get_project_notification_settingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUsersApi::modify_organization_notification_settings(const QString &org_id, const ::OpenAPI::OptionalParam<OAISet_notification_settings_request> &oai_set_notification_settings_request) {
    QString fullPath = QString(_serverConfigs["modify_organization_notification_settings"][_serverIndices.value("modify_organization_notification_settings")].URL()+"/user/me/notification-settings/org/{orgId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::modify_organization_notification_settingsCallback);
    connect(this, &OAIUsersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUsersApi::modify_organization_notification_settingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT modify_organization_notification_settingsSignal(output);
        Q_EMIT modify_organization_notification_settingsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT modify_organization_notification_settingsSignalE(output, error_type, error_str);
        Q_EMIT modify_organization_notification_settingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT modify_organization_notification_settingsSignalError(output, error_type, error_str);
        Q_EMIT modify_organization_notification_settingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUsersApi::modify_project_notification_settings(const QString &org_id, const QString &project_id, const ::OpenAPI::OptionalParam<OAIModify_project_notification_settings_request> &oai_modify_project_notification_settings_request) {
    QString fullPath = QString(_serverConfigs["modify_project_notification_settings"][_serverIndices.value("modify_project_notification_settings")].URL()+"/user/me/notification-settings/org/{orgId}/project/{projectId}");
    ...
    if (oai_modify_project_notification_settings_request.hasValue()){

        
        QByteArray output = oai_modify_project_notification_settings_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::modify_project_notification_settingsCallback);
    connect(this, &OAIUsersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUsersApi::modify_project_notification_settingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT modify_project_notification_settingsSignal();
        Q_EMIT modify_project_notification_settingsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT modify_project_notification_settingsSignalE(error_type, error_str);
        Q_EMIT modify_project_notification_settingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT modify_project_notification_settingsSignalError(error_type, error_str);
        Q_EMIT modify_project_notification_settingsSignalErrorFull(worker, error_type, error_str);
    }
}
