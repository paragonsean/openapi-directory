...
QList<QJsonValue> OAIPatch::getComments() const {
    return m_comments;
}
void OAIPatch::setComments(const QList<QJsonValue> &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIPatch::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIPatch::is_comments_Valid() const{
    return m_comments_isValid;
}

QString OAIPatch::getId() const {
    return m_id;
}
void OAIPatch::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPatch::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPatch::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPatch::getModificationTime() const {
    return m_modification_time;
}
void OAIPatch::setModificationTime(const QString &modification_time) {
    m_modification_time = modification_time;
    m_modification_time_isSet = true;
}

bool OAIPatch::is_modification_time_Set() const{
    return m_modification_time_isSet;
}

bool OAIPatch::is_modification_time_Valid() const{
    return m_modification_time_isValid;
}

QList<QJsonValue> OAIPatch::getUrls() const {
    return m_urls;
}
void OAIPatch::setUrls(const QList<QJsonValue> &urls) {
    m_urls = urls;
    m_urls_isSet = true;
}

bool OAIPatch::is_urls_Set() const{
    return m_urls_isSet;
}

bool OAIPatch::is_urls_Valid() const{
    return m_urls_isValid;
}

QString OAIPatch::getVersion() const {
    return m_version;
}
void OAIPatch::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPatch::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPatch::is_version_Valid() const{
