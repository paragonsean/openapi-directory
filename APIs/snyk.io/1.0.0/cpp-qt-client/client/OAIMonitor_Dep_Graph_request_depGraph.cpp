...
#include "OAIMonitor_Dep_Graph_request_depGraph.h"
...
OAIMonitor_Dep_Graph_request_depGraph::OAIMonitor_Dep_Graph_request_depGraph(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMonitor_Dep_Graph_request_depGraph::OAIMonitor_Dep_Graph_request_depGraph() {
    this->initializeModel();
}

OAIMonitor_Dep_Graph_request_depGraph::~OAIMonitor_Dep_Graph_request_depGraph() {}

void OAIMonitor_Dep_Graph_request_depGraph::initializeModel() {

    m_graph_isSet = false;
    m_graph_isValid = false;

    m_pkg_manager_isSet = false;
    m_pkg_manager_isValid = false;

    m_pkgs_isSet = false;
    m_pkgs_isValid = false;

    m_schema_version_isSet = false;
    m_schema_version_isValid = false;
}

void OAIMonitor_Dep_Graph_request_depGraph::fromJson(QString jsonString) {
...
void OAIMonitor_Dep_Graph_request_depGraph::fromJsonObject(QJsonObject json) {

    m_graph_isValid = ::OpenAPI::fromJsonValue(m_graph, json[QString("graph")]);
    m_graph_isSet = !json[QString("graph")].isNull() && m_graph_isValid;

    m_pkg_manager_isValid = ::OpenAPI::fromJsonValue(m_pkg_manager, json[QString("pkgManager")]);
    m_pkg_manager_isSet = !json[QString("pkgManager")].isNull() && m_pkg_manager_isValid;

    m_pkgs_isValid = ::OpenAPI::fromJsonValue(m_pkgs, json[QString("pkgs")]);
    m_pkgs_isSet = !json[QString("pkgs")].isNull() && m_pkgs_isValid;
...
QString OAIMonitor_Dep_Graph_request_depGraph::asJson() const {
...
QJsonObject OAIMonitor_Dep_Graph_request_depGraph::asJsonObject() const {
    QJsonObject obj;
    if (m_graph.isSet()) {
        obj.insert(QString("graph"), ::OpenAPI::toJsonValue(m_graph));
    }
    if (m_pkg_manager.isSet()) {
        obj.insert(QString("pkgManager"), ::OpenAPI::toJsonValue(m_pkg_manager));
    }
    if (m_pkgs.size() > 0) {
        obj.insert(QString("pkgs"), ::OpenAPI::toJsonValue(m_pkgs));
    }
...
OAIMonitor_Dep_Graph_request_depGraph_graph OAIMonitor_Dep_Graph_request_depGraph::getGraph() const {
    return m_graph;
}
void OAIMonitor_Dep_Graph_request_depGraph::setGraph(const OAIMonitor_Dep_Graph_request_depGraph_graph &graph) {
    m_graph = graph;
    m_graph_isSet = true;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_graph_Set() const{
    return m_graph_isSet;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_graph_Valid() const{
    return m_graph_isValid;
}

OAIMonitor_Dep_Graph_request_depGraph_pkgManager OAIMonitor_Dep_Graph_request_depGraph::getPkgManager() const {
    return m_pkg_manager;
}
void OAIMonitor_Dep_Graph_request_depGraph::setPkgManager(const OAIMonitor_Dep_Graph_request_depGraph_pkgManager &pkg_manager) {
    m_pkg_manager = pkg_manager;
    m_pkg_manager_isSet = true;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_pkg_manager_Set() const{
    return m_pkg_manager_isSet;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_pkg_manager_Valid() const{
    return m_pkg_manager_isValid;
}

QList<QJsonValue> OAIMonitor_Dep_Graph_request_depGraph::getPkgs() const {
    return m_pkgs;
}
void OAIMonitor_Dep_Graph_request_depGraph::setPkgs(const QList<QJsonValue> &pkgs) {
    m_pkgs = pkgs;
    m_pkgs_isSet = true;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_pkgs_Set() const{
    return m_pkgs_isSet;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_pkgs_Valid() const{
    return m_pkgs_isValid;
}

QString OAIMonitor_Dep_Graph_request_depGraph::getSchemaVersion() const {
    return m_schema_version;
}
void OAIMonitor_Dep_Graph_request_depGraph::setSchemaVersion(const QString &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAIMonitor_Dep_Graph_request_depGraph::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

bool OAIMonitor_Dep_Graph_request_depGraph::isSet() const {
...
bool OAIMonitor_Dep_Graph_request_depGraph::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_graph_isValid && m_pkg_manager_isValid && m_pkgs_isValid && m_schema_version_isValid && true;
}
