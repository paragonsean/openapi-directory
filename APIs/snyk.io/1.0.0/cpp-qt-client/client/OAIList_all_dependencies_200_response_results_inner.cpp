...
#include "OAIList_all_dependencies_200_response_results_inner.h"
...
OAIList_all_dependencies_200_response_results_inner::OAIList_all_dependencies_200_response_results_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_dependencies_200_response_results_inner::OAIList_all_dependencies_200_response_results_inner() {
    this->initializeModel();
}

OAIList_all_dependencies_200_response_results_inner::~OAIList_all_dependencies_200_response_results_inner() {}

void OAIList_all_dependencies_200_response_results_inner::initializeModel() {

    m_copyright_isSet = false;
    m_copyright_isValid = false;

    m_dependencies_with_issues_isSet = false;
    m_dependencies_with_issues_isValid = false;

    m_deprecated_versions_isSet = false;
    m_deprecated_versions_isValid = false;
    ...
    m_issues_critical_isSet = false;
    m_issues_critical_isValid = false;

    m_issues_high_isSet = false;
    m_issues_high_isValid = false;

    m_issues_low_isSet = false;
    m_issues_low_isValid = false;

    m_issues_medium_isSet = false;
    m_issues_medium_isValid = false;

    m_latest_version_isSet = false;
    m_latest_version_isValid = false;

    m_latest_version_published_date_isSet = false;
    m_latest_version_published_date_isValid = false;
...
void OAIList_all_dependencies_200_response_results_inner::fromJson(QString jsonString) {
...
void OAIList_all_dependencies_200_response_results_inner::fromJsonObject(QJsonObject json) {
    ...
    m_dependencies_with_issues_isValid = ::OpenAPI::fromJsonValue(m_dependencies_with_issues, json[QString("dependenciesWithIssues")]);
    m_dependencies_with_issues_isSet = !json[QString("dependenciesWithIssues")].isNull() && m_dependencies_with_issues_isValid;

    m_deprecated_versions_isValid = ::OpenAPI::fromJsonValue(m_deprecated_versions, json[QString("deprecatedVersions")]);
    m_deprecated_versions_isSet = !json[QString("deprecatedVersions")].isNull() && m_deprecated_versions_isValid;

    m_first_published_date_isValid = ::OpenAPI::fromJsonValue(m_first_published_date, json[QString("firstPublishedDate")]);
    m_first_published_date_isSet = !json[QString("firstPublishedDate")].isNull() && m_first_published_date_isValid;
    ...
    m_issues_critical_isValid = ::OpenAPI::fromJsonValue(m_issues_critical, json[QString("issuesCritical")]);
    m_issues_critical_isSet = !json[QString("issuesCritical")].isNull() && m_issues_critical_isValid;

    m_issues_high_isValid = ::OpenAPI::fromJsonValue(m_issues_high, json[QString("issuesHigh")]);
    m_issues_high_isSet = !json[QString("issuesHigh")].isNull() && m_issues_high_isValid;

    m_issues_low_isValid = ::OpenAPI::fromJsonValue(m_issues_low, json[QString("issuesLow")]);
    m_issues_low_isSet = !json[QString("issuesLow")].isNull() && m_issues_low_isValid;

    m_issues_medium_isValid = ::OpenAPI::fromJsonValue(m_issues_medium, json[QString("issuesMedium")]);
    m_issues_medium_isSet = !json[QString("issuesMedium")].isNull() && m_issues_medium_isValid;
    ...
    m_latest_version_published_date_isValid = ::OpenAPI::fromJsonValue(m_latest_version_published_date, json[QString("latestVersionPublishedDate")]);
    m_latest_version_published_date_isSet = !json[QString("latestVersionPublishedDate")].isNull() && m_latest_version_published_date_isValid;
...
QString OAIList_all_dependencies_200_response_results_inner::asJson() const {
...
QJsonObject OAIList_all_dependencies_200_response_results_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_copyright.size() > 0) {
        obj.insert(QString("copyright"), ::OpenAPI::toJsonValue(m_copyright));
    }
    if (m_dependencies_with_issues.size() > 0) {
        obj.insert(QString("dependenciesWithIssues"), ::OpenAPI::toJsonValue(m_dependencies_with_issues));
    }
    if (m_deprecated_versions.size() > 0) {
        obj.insert(QString("deprecatedVersions"), ::OpenAPI::toJsonValue(m_deprecated_versions));
    }
    if (m_first_published_date_isSet) {
        obj.insert(QString("firstPublishedDate"), ::OpenAPI::toJsonValue(m_first_published_date));
    }
    if (m_id_isSet) {
    ...
    if (m_issues_critical_isSet) {
        obj.insert(QString("issuesCritical"), ::OpenAPI::toJsonValue(m_issues_critical));
    }
    if (m_issues_high_isSet) {
        obj.insert(QString("issuesHigh"), ::OpenAPI::toJsonValue(m_issues_high));
    }
    if (m_issues_low_isSet) {
        obj.insert(QString("issuesLow"), ::OpenAPI::toJsonValue(m_issues_low));
    }
    if (m_issues_medium_isSet) {
        obj.insert(QString("issuesMedium"), ::OpenAPI::toJsonValue(m_issues_medium));
    }
    if (m_latest_version_isSet) {
        obj.insert(QString("latestVersion"), ::OpenAPI::toJsonValue(m_latest_version));
    }
    if (m_latest_version_published_date_isSet) {
        obj.insert(QString("latestVersionPublishedDate"), ::OpenAPI::toJsonValue(m_latest_version_published_date));
    }
...
QList<QJsonValue> OAIList_all_dependencies_200_response_results_inner::getCopyright() const {
    return m_copyright;
}
void OAIList_all_dependencies_200_response_results_inner::setCopyright(const QList<QJsonValue> &copyright) {
    m_copyright = copyright;
    m_copyright_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_copyright_Set() const{
    return m_copyright_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_copyright_Valid() const{
    return m_copyright_isValid;
}

QList<QJsonValue> OAIList_all_dependencies_200_response_results_inner::getDependenciesWithIssues() const {
    return m_dependencies_with_issues;
}
void OAIList_all_dependencies_200_response_results_inner::setDependenciesWithIssues(const QList<QJsonValue> &dependencies_with_issues) {
    m_dependencies_with_issues = dependencies_with_issues;
    m_dependencies_with_issues_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_dependencies_with_issues_Set() const{
    return m_dependencies_with_issues_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_dependencies_with_issues_Valid() const{
    return m_dependencies_with_issues_isValid;
}

QList<QJsonValue> OAIList_all_dependencies_200_response_results_inner::getDeprecatedVersions() const {
    return m_deprecated_versions;
}
void OAIList_all_dependencies_200_response_results_inner::setDeprecatedVersions(const QList<QJsonValue> &deprecated_versions) {
    m_deprecated_versions = deprecated_versions;
    m_deprecated_versions_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_deprecated_versions_Set() const{
    return m_deprecated_versions_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_deprecated_versions_Valid() const{
    return m_deprecated_versions_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner::getFirstPublishedDate() const {
    return m_first_published_date;
}
void OAIList_all_dependencies_200_response_results_inner::setFirstPublishedDate(const QString &first_published_date) {
    m_first_published_date = first_published_date;
    m_first_published_date_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_first_published_date_Set() const{
    return m_first_published_date_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_first_published_date_Valid() const{
    return m_first_published_date_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner::getId() const {
    return m_id;
}
void OAIList_all_dependencies_200_response_results_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIList_all_dependencies_200_response_results_inner::isIsDeprecated() const {
    return m_is_deprecated;
}
void OAIList_all_dependencies_200_response_results_inner::setIsDeprecated(const bool &is_deprecated) {
    m_is_deprecated = is_deprecated;
    m_is_deprecated_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_is_deprecated_Set() const{
    return m_is_deprecated_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_is_deprecated_Valid() const{
    return m_is_deprecated_isValid;
}

double OAIList_all_dependencies_200_response_results_inner::getIssuesCritical() const {
    return m_issues_critical;
}
void OAIList_all_dependencies_200_response_results_inner::setIssuesCritical(const double &issues_critical) {
    m_issues_critical = issues_critical;
    m_issues_critical_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_critical_Set() const{
    return m_issues_critical_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_critical_Valid() const{
    return m_issues_critical_isValid;
}

double OAIList_all_dependencies_200_response_results_inner::getIssuesHigh() const {
    return m_issues_high;
}
void OAIList_all_dependencies_200_response_results_inner::setIssuesHigh(const double &issues_high) {
    m_issues_high = issues_high;
    m_issues_high_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_high_Set() const{
    return m_issues_high_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_high_Valid() const{
    return m_issues_high_isValid;
}

double OAIList_all_dependencies_200_response_results_inner::getIssuesLow() const {
    return m_issues_low;
}
void OAIList_all_dependencies_200_response_results_inner::setIssuesLow(const double &issues_low) {
    m_issues_low = issues_low;
    m_issues_low_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_low_Set() const{
    return m_issues_low_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_low_Valid() const{
    return m_issues_low_isValid;
}

double OAIList_all_dependencies_200_response_results_inner::getIssuesMedium() const {
    return m_issues_medium;
}
void OAIList_all_dependencies_200_response_results_inner::setIssuesMedium(const double &issues_medium) {
    m_issues_medium = issues_medium;
    m_issues_medium_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_medium_Set() const{
    return m_issues_medium_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_issues_medium_Valid() const{
    return m_issues_medium_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner::getLatestVersion() const {
    return m_latest_version;
}
void OAIList_all_dependencies_200_response_results_inner::setLatestVersion(const QString &latest_version) {
    m_latest_version = latest_version;
    m_latest_version_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_latest_version_Set() const{
    return m_latest_version_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_latest_version_Valid() const{
    return m_latest_version_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner::getLatestVersionPublishedDate() const {
    return m_latest_version_published_date;
}
void OAIList_all_dependencies_200_response_results_inner::setLatestVersionPublishedDate(const QString &latest_version_published_date) {
    m_latest_version_published_date = latest_version_published_date;
    m_latest_version_published_date_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_latest_version_published_date_Set() const{
    return m_latest_version_published_date_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_latest_version_published_date_Valid() const{
    return m_latest_version_published_date_isValid;
}

QList<OAIList_all_dependencies_200_response_results_inner_licenses_inner> OAIList_all_dependencies_200_response_results_inner::getLicenses() const {
    return m_licenses;
}
void OAIList_all_dependencies_200_response_results_inner::setLicenses(const QList<OAIList_all_dependencies_200_response_results_inner_licenses_inner> &licenses) {
    m_licenses = licenses;
    m_licenses_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_licenses_Set() const{
    return m_licenses_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_licenses_Valid() const{
    return m_licenses_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner::getName() const {
    return m_name;
}
void OAIList_all_dependencies_200_response_results_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIList_all_dependencies_200_response_results_inner_projects_inner> OAIList_all_dependencies_200_response_results_inner::getProjects() const {
    return m_projects;
}
void OAIList_all_dependencies_200_response_results_inner::setProjects(const QList<OAIList_all_dependencies_200_response_results_inner_projects_inner> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_projects_Valid() const{
    return m_projects_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner::getType() const {
    return m_type;
}
void OAIList_all_dependencies_200_response_results_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner::getVersion() const {
    return m_version;
}
void OAIList_all_dependencies_200_response_results_inner::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner::is_version_Set() const{
    return m_version_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIList_all_dependencies_200_response_results_inner::isSet() const {
...
bool OAIList_all_dependencies_200_response_results_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_licenses_isValid && m_name_isValid && m_projects_isValid && m_type_isValid && m_version_isValid && true;
}
