...
#include "OAIApplying_attributes_200_response_attributes.h"
...
OAIApplying_attributes_200_response_attributes::OAIApplying_attributes_200_response_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplying_attributes_200_response_attributes::OAIApplying_attributes_200_response_attributes() {
    this->initializeModel();
}

OAIApplying_attributes_200_response_attributes::~OAIApplying_attributes_200_response_attributes() {}

void OAIApplying_attributes_200_response_attributes::initializeModel() {
...
void OAIApplying_attributes_200_response_attributes::fromJson(QString jsonString) {
...
void OAIApplying_attributes_200_response_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIApplying_attributes_200_response_attributes::asJson() const {
...
QJsonObject OAIApplying_attributes_200_response_attributes::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIApplying_attributes_200_response_attributes::getCriticality() const {
    return m_criticality;
}
void OAIApplying_attributes_200_response_attributes::setCriticality(const QList<QJsonValue> &criticality) {
    m_criticality = criticality;
    m_criticality_isSet = true;
}

bool OAIApplying_attributes_200_response_attributes::is_criticality_Set() const{
    return m_criticality_isSet;
}

bool OAIApplying_attributes_200_response_attributes::is_criticality_Valid() const{
    return m_criticality_isValid;
}

QList<QJsonValue> OAIApplying_attributes_200_response_attributes::getEnvironment() const {
    return m_environment;
}
void OAIApplying_attributes_200_response_attributes::setEnvironment(const QList<QJsonValue> &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAIApplying_attributes_200_response_attributes::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAIApplying_attributes_200_response_attributes::is_environment_Valid() const{
    return m_environment_isValid;
}

QList<QJsonValue> OAIApplying_attributes_200_response_attributes::getLifecycle() const {
    return m_lifecycle;
}
void OAIApplying_attributes_200_response_attributes::setLifecycle(const QList<QJsonValue> &lifecycle) {
    m_lifecycle = lifecycle;
    m_lifecycle_isSet = true;
}

bool OAIApplying_attributes_200_response_attributes::is_lifecycle_Set() const{
    return m_lifecycle_isSet;
}

bool OAIApplying_attributes_200_response_attributes::is_lifecycle_Valid() const{
    return m_lifecycle_isValid;
}

bool OAIApplying_attributes_200_response_attributes::isSet() const {
...
bool OAIApplying_attributes_200_response_attributes::isValid() const {
