...
OAIList_all_dependencies_200_response_results_inner_licenses_inner::OAIList_all_dependencies_200_response_results_inner_licenses_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_dependencies_200_response_results_inner_licenses_inner::OAIList_all_dependencies_200_response_results_inner_licenses_inner() {
    this->initializeModel();
}

OAIList_all_dependencies_200_response_results_inner_licenses_inner::~OAIList_all_dependencies_200_response_results_inner_licenses_inner() {}

void OAIList_all_dependencies_200_response_results_inner_licenses_inner::initializeModel() {
...
void OAIList_all_dependencies_200_response_results_inner_licenses_inner::fromJson(QString jsonString) {
...
void OAIList_all_dependencies_200_response_results_inner_licenses_inner::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_dependencies_200_response_results_inner_licenses_inner::asJson() const {
...
QJsonObject OAIList_all_dependencies_200_response_results_inner_licenses_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIList_all_dependencies_200_response_results_inner_licenses_inner::getId() const {
    return m_id;
}
void OAIList_all_dependencies_200_response_results_inner_licenses_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner_licenses_inner::getLicense() const {
    return m_license;
}
void OAIList_all_dependencies_200_response_results_inner_licenses_inner::setLicense(const QString &license) {
    m_license = license;
    m_license_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::is_license_Set() const{
    return m_license_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::is_license_Valid() const{
    return m_license_isValid;
}

QString OAIList_all_dependencies_200_response_results_inner_licenses_inner::getTitle() const {
    return m_title;
}
void OAIList_all_dependencies_200_response_results_inner_licenses_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::isSet() const {
...
bool OAIList_all_dependencies_200_response_results_inner_licenses_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_license_isValid && m_title_isValid && true;
}
