...
#include "OAIIgnore_ignorePath.h"
...
OAIIgnore_ignorePath::OAIIgnore_ignorePath(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIgnore_ignorePath::OAIIgnore_ignorePath() {
    this->initializeModel();
}

OAIIgnore_ignorePath::~OAIIgnore_ignorePath() {}

void OAIIgnore_ignorePath::initializeModel() {
    ...
    m_ignored_by_isSet = false;
    m_ignored_by_isValid = false;
...
void OAIIgnore_ignorePath::fromJson(QString jsonString) {
...
void OAIIgnore_ignorePath::fromJsonObject(QJsonObject json) {
    ...
    m_ignored_by_isValid = ::OpenAPI::fromJsonValue(m_ignored_by, json[QString("ignoredBy")]);
    m_ignored_by_isSet = !json[QString("ignoredBy")].isNull() && m_ignored_by_isValid;
...
QString OAIIgnore_ignorePath::asJson() const {
...
QJsonObject OAIIgnore_ignorePath::asJsonObject() const {
    QJsonObject obj;
    if (m_created_isSet) {
    ...
    if (m_ignored_by.isSet()) {
        obj.insert(QString("ignoredBy"), ::OpenAPI::toJsonValue(m_ignored_by));
    }
    if (m_reason_isSet) {
...
QString OAIIgnore_ignorePath::getCreated() const {
    return m_created;
}
void OAIIgnore_ignorePath::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIIgnore_ignorePath::is_created_Set() const{
    return m_created_isSet;
}

bool OAIIgnore_ignorePath::is_created_Valid() const{
    return m_created_isValid;
}

bool OAIIgnore_ignorePath::isDisregardIfFixable() const {
    return m_disregard_if_fixable;
}
void OAIIgnore_ignorePath::setDisregardIfFixable(const bool &disregard_if_fixable) {
    m_disregard_if_fixable = disregard_if_fixable;
    m_disregard_if_fixable_isSet = true;
}

bool OAIIgnore_ignorePath::is_disregard_if_fixable_Set() const{
    return m_disregard_if_fixable_isSet;
}

bool OAIIgnore_ignorePath::is_disregard_if_fixable_Valid() const{
    return m_disregard_if_fixable_isValid;
}

QString OAIIgnore_ignorePath::getExpires() const {
    return m_expires;
}
void OAIIgnore_ignorePath::setExpires(const QString &expires) {
    m_expires = expires;
    m_expires_isSet = true;
}

bool OAIIgnore_ignorePath::is_expires_Set() const{
    return m_expires_isSet;
}

bool OAIIgnore_ignorePath::is_expires_Valid() const{
    return m_expires_isValid;
}

OAIIgnore_ignorePath_ignoredBy OAIIgnore_ignorePath::getIgnoredBy() const {
    return m_ignored_by;
}
void OAIIgnore_ignorePath::setIgnoredBy(const OAIIgnore_ignorePath_ignoredBy &ignored_by) {
    m_ignored_by = ignored_by;
    m_ignored_by_isSet = true;
}

bool OAIIgnore_ignorePath::is_ignored_by_Set() const{
    return m_ignored_by_isSet;
}

bool OAIIgnore_ignorePath::is_ignored_by_Valid() const{
    return m_ignored_by_isValid;
}

QString OAIIgnore_ignorePath::getReason() const {
    return m_reason;
}
void OAIIgnore_ignorePath::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIIgnore_ignorePath::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIIgnore_ignorePath::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIIgnore_ignorePath::getReasonType() const {
    return m_reason_type;
}
void OAIIgnore_ignorePath::setReasonType(const QString &reason_type) {
    m_reason_type = reason_type;
    m_reason_type_isSet = true;
}

bool OAIIgnore_ignorePath::is_reason_type_Set() const{
    return m_reason_type_isSet;
}

bool OAIIgnore_ignorePath::is_reason_type_Valid() const{
    return m_reason_type_isValid;
}

bool OAIIgnore_ignorePath::isSet() const {
...
bool OAIIgnore_ignorePath::isValid() const {
