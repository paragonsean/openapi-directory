...
#include "OAIAdd_new_integration_request.h"
#include "OAIClone_an_integration__with_settings_and_credentials__request.h"
#include "OAIGet_existing_integration_by_type_200_response.h"
#include "OAIObject.h"
#include "OAIRetrieve_200_response.h"
#include "OAIUpdate_existing_integration_request.h"
...
public:
    ...
    * @param[in]  oai_add_new_integration_request OAIAdd_new_integration_request [optional]
    */
    virtual void add_new_integration(const QString &org_id, const ::OpenAPI::OptionalParam<OAIAdd_new_integration_request> &oai_add_new_integration_request = ::OpenAPI::OptionalParam<OAIAdd_new_integration_request>());

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  integration_id QString [required]
    * @param[in]  oai_clone_an_integration__with_settings_and_credentials__request OAIClone_an_integration__with_settings_and_credentials__request [optional]
    */
    virtual void clone_an_integration__with_settings_and_credentials(const QString &org_id, const QString &integration_id, const ::OpenAPI::OptionalParam<OAIClone_an_integration__with_settings_and_credentials__request> &oai_clone_an_integration__with_settings_and_credentials__request = ::OpenAPI::OptionalParam<OAIClone_an_integration__with_settings_and_credentials__request>());

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  integration_id QString [required]
    */
    virtual void delete_credentials(const QString &org_id, const QString &integration_id);

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  type QString [required]
    */
    virtual void get_existing_integration_by_type(const QString &org_id, const QString &type);

    /**
    * @param[in]  org_id QString [required]
    */
    virtual void list(const QString &org_id);

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  integration_id QString [required]
    */
    virtual void provision_new_broker_token(const QString &org_id, const QString &integration_id);

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  integration_id QString [required]
    */
    virtual void retrieve(const QString &org_id, const QString &integration_id);

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  integration_id QString [required]
    */
    virtual void switch_between_broker_tokens(const QString &org_id, const QString &integration_id);

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  integration_id QString [required]
    * @param[in]  oai_update_request OAIUpdate_request [optional]
    */
    virtual void update(const QString &org_id, const QString &integration_id, const ::OpenAPI::OptionalParam<OAIUpdate_request> &oai_update_request = ::OpenAPI::OptionalParam<OAIUpdate_request>());

    /**
    * @param[in]  org_id QString [required]
    * @param[in]  integration_id QString [required]
    * @param[in]  oai_update_existing_integration_request OAIUpdate_existing_integration_request [optional]
    */
    virtual void update_existing_integration(const QString &org_id, const QString &integration_id, const ::OpenAPI::OptionalParam<OAIUpdate_existing_integration_request> &oai_update_existing_integration_request = ::OpenAPI::OptionalParam<OAIUpdate_existing_integration_request>());
...
private:
    ...
    void add_new_integrationCallback(OAIHttpRequestWorker *worker);
    void clone_an_integration__with_settings_and_credentialsCallback(OAIHttpRequestWorker *worker);
    void delete_credentialsCallback(OAIHttpRequestWorker *worker);
    void get_existing_integration_by_typeCallback(OAIHttpRequestWorker *worker);
    void listCallback(OAIHttpRequestWorker *worker);
    void provision_new_broker_tokenCallback(OAIHttpRequestWorker *worker);
    void retrieveCallback(OAIHttpRequestWorker *worker);
    void switch_between_broker_tokensCallback(OAIHttpRequestWorker *worker);
    void updateCallback(OAIHttpRequestWorker *worker);
    void update_existing_integrationCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_new_integrationSignal();
    void clone_an_integration__with_settings_and_credentialsSignal();
    void delete_credentialsSignal();
    void get_existing_integration_by_typeSignal(OAIGet_existing_integration_by_type_200_response summary);
    void listSignal(OAIObject summary);
    void provision_new_broker_tokenSignal();
    void retrieveSignal(OAIRetrieve_200_response summary);
    void switch_between_broker_tokensSignal();
    void updateSignal(OAIRetrieve_200_response summary);
    void update_existing_integrationSignal();


    void add_new_integrationSignalFull(OAIHttpRequestWorker *worker);
    void clone_an_integration__with_settings_and_credentialsSignalFull(OAIHttpRequestWorker *worker);
    void delete_credentialsSignalFull(OAIHttpRequestWorker *worker);
    void get_existing_integration_by_typeSignalFull(OAIHttpRequestWorker *worker, OAIGet_existing_integration_by_type_200_response summary);
    void listSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void provision_new_broker_tokenSignalFull(OAIHttpRequestWorker *worker);
    void retrieveSignalFull(OAIHttpRequestWorker *worker, OAIRetrieve_200_response summary);
    void switch_between_broker_tokensSignalFull(OAIHttpRequestWorker *worker);
    void updateSignalFull(OAIHttpRequestWorker *worker, OAIRetrieve_200_response summary);
    void update_existing_integrationSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use add_new_integrationSignalError() instead")
    void add_new_integrationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_new_integrationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use clone_an_integration__with_settings_and_credentialsSignalError() instead")
    void clone_an_integration__with_settings_and_credentialsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void clone_an_integration__with_settings_and_credentialsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_credentialsSignalError() instead")
    void delete_credentialsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void delete_credentialsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_existing_integration_by_typeSignalError() instead")
    void get_existing_integration_by_typeSignalE(OAIGet_existing_integration_by_type_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_existing_integration_by_typeSignalError(OAIGet_existing_integration_by_type_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use listSignalError() instead")
    void listSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use provision_new_broker_tokenSignalError() instead")
    void provision_new_broker_tokenSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void provision_new_broker_tokenSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use retrieveSignalError() instead")
    void retrieveSignalE(OAIRetrieve_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void retrieveSignalError(OAIRetrieve_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use switch_between_broker_tokensSignalError() instead")
    void switch_between_broker_tokensSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void switch_between_broker_tokensSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateSignalError() instead")
    void updateSignalE(OAIRetrieve_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateSignalError(OAIRetrieve_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use update_existing_integrationSignalError() instead")
    void update_existing_integrationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void update_existing_integrationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_new_integrationSignalErrorFull() instead")
    void add_new_integrationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_new_integrationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use clone_an_integration__with_settings_and_credentialsSignalErrorFull() instead")
    void clone_an_integration__with_settings_and_credentialsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void clone_an_integration__with_settings_and_credentialsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_credentialsSignalErrorFull() instead")
    void delete_credentialsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void delete_credentialsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_existing_integration_by_typeSignalErrorFull() instead")
    void get_existing_integration_by_typeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_existing_integration_by_typeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use provision_new_broker_tokenSignalErrorFull() instead")
    void provision_new_broker_tokenSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void provision_new_broker_tokenSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use switch_between_broker_tokensSignalErrorFull() instead")
    void switch_between_broker_tokensSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void switch_between_broker_tokensSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use update_existing_integrationSignalErrorFull() instead")
    void update_existing_integrationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void update_existing_integrationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
