...
#include "OAIImport_targets_request_anyOf.h"
...
OAIImport_targets_request_anyOf::OAIImport_targets_request_anyOf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImport_targets_request_anyOf::OAIImport_targets_request_anyOf() {
    this->initializeModel();
}

OAIImport_targets_request_anyOf::~OAIImport_targets_request_anyOf() {}

void OAIImport_targets_request_anyOf::initializeModel() {
...
void OAIImport_targets_request_anyOf::fromJson(QString jsonString) {
...
void OAIImport_targets_request_anyOf::fromJsonObject(QJsonObject json) {
...
QString OAIImport_targets_request_anyOf::asJson() const {
...
QJsonObject OAIImport_targets_request_anyOf::asJsonObject() const {
    QJsonObject obj;
...
QString OAIImport_targets_request_anyOf::getExclusionGlobs() const {
    return m_exclusion_globs;
}
void OAIImport_targets_request_anyOf::setExclusionGlobs(const QString &exclusion_globs) {
    m_exclusion_globs = exclusion_globs;
    m_exclusion_globs_isSet = true;
}

bool OAIImport_targets_request_anyOf::is_exclusion_globs_Set() const{
    return m_exclusion_globs_isSet;
}

bool OAIImport_targets_request_anyOf::is_exclusion_globs_Valid() const{
    return m_exclusion_globs_isValid;
}

QList<QJsonValue> OAIImport_targets_request_anyOf::getFiles() const {
    return m_files;
}
void OAIImport_targets_request_anyOf::setFiles(const QList<QJsonValue> &files) {
    m_files = files;
    m_files_isSet = true;
}

bool OAIImport_targets_request_anyOf::is_files_Set() const{
    return m_files_isSet;
}

bool OAIImport_targets_request_anyOf::is_files_Valid() const{
    return m_files_isValid;
}

OAIImport_targets_request_anyOf_target OAIImport_targets_request_anyOf::getTarget() const {
    return m_target;
}
void OAIImport_targets_request_anyOf::setTarget(const OAIImport_targets_request_anyOf_target &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIImport_targets_request_anyOf::is_target_Set() const{
    return m_target_isSet;
}

bool OAIImport_targets_request_anyOf::is_target_Valid() const{
    return m_target_isValid;
}

bool OAIImport_targets_request_anyOf::isSet() const {
...
bool OAIImport_targets_request_anyOf::isValid() const {
