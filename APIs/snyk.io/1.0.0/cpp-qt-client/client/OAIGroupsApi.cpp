...
void OAIGroupsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("add_a_member_to_an_organization_within_a_group", defaultConf);
    _serverIndices.insert("add_a_member_to_an_organization_within_a_group", 0);
    _serverConfigs.insert("delete_tag_from_group", defaultConf);
    _serverIndices.insert("delete_tag_from_group", 0);
    _serverConfigs.insert("list_all_members_in_a_group", defaultConf);
    _serverIndices.insert("list_all_members_in_a_group", 0);
    _serverConfigs.insert("list_all_organizations_in_a_group", defaultConf);
    _serverIndices.insert("list_all_organizations_in_a_group", 0);
    _serverConfigs.insert("list_all_roles_in_a_group", defaultConf);
    _serverIndices.insert("list_all_roles_in_a_group", 0);
    _serverConfigs.insert("list_all_tags_in_a_group", defaultConf);
    _serverIndices.insert("list_all_tags_in_a_group", 0);
    _serverConfigs.insert("update_group_settings", defaultConf);
    _serverIndices.insert("update_group_settings", 0);
    _serverConfigs.insert("view_group_settings", defaultConf);
    _serverIndices.insert("view_group_settings", 0);
}
...
void OAIGroupsApi::add_a_member_to_an_organization_within_a_group(const QString &group_id, const QString &org_id, const ::OpenAPI::OptionalParam<OAIAdd_a_member_to_an_organization_within_a_group_request> &oai_add_a_member_to_an_organization_within_a_group_request) {
    QString fullPath = QString(_serverConfigs["add_a_member_to_an_organization_within_a_group"][_serverIndices.value("add_a_member_to_an_organization_within_a_group")].URL()+"/group/{groupId}/org/{orgId}/members");
    ...
    if (oai_add_a_member_to_an_organization_within_a_group_request.hasValue()){

        
        QByteArray output = oai_add_a_member_to_an_organization_within_a_group_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::add_a_member_to_an_organization_within_a_groupCallback);
...
void OAIGroupsApi::add_a_member_to_an_organization_within_a_groupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_a_member_to_an_organization_within_a_groupSignal();
        Q_EMIT add_a_member_to_an_organization_within_a_groupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_a_member_to_an_organization_within_a_groupSignalE(error_type, error_str);
        Q_EMIT add_a_member_to_an_organization_within_a_groupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_a_member_to_an_organization_within_a_groupSignalError(error_type, error_str);
        Q_EMIT add_a_member_to_an_organization_within_a_groupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGroupsApi::delete_tag_from_group(const QString &group_id, const ::OpenAPI::OptionalParam<OAIDelete_tag_from_group_request> &oai_delete_tag_from_group_request) {
    QString fullPath = QString(_serverConfigs["delete_tag_from_group"][_serverIndices.value("delete_tag_from_group")].URL()+"/group/{groupId}/tags/delete");
    ...
    if (oai_delete_tag_from_group_request.hasValue()){

        
        QByteArray output = oai_delete_tag_from_group_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::delete_tag_from_groupCallback);
    connect(this, &OAIGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGroupsApi::delete_tag_from_groupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIDelete_tag_from_group_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT delete_tag_from_groupSignal(output);
        Q_EMIT delete_tag_from_groupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT delete_tag_from_groupSignalE(output, error_type, error_str);
        Q_EMIT delete_tag_from_groupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT delete_tag_from_groupSignalError(output, error_type, error_str);
        Q_EMIT delete_tag_from_groupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGroupsApi::list_all_members_in_a_group(const QString &group_id) {
    QString fullPath = QString(_serverConfigs["list_all_members_in_a_group"][_serverIndices.value("list_all_members_in_a_group")].URL()+"/group/{groupId}/members");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::list_all_members_in_a_groupCallback);
    connect(this, &OAIGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGroupsApi::list_all_members_in_a_groupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_all_members_in_a_groupSignal(output);
        Q_EMIT list_all_members_in_a_groupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_all_members_in_a_groupSignalE(output, error_type, error_str);
        Q_EMIT list_all_members_in_a_groupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_all_members_in_a_groupSignalError(output, error_type, error_str);
        Q_EMIT list_all_members_in_a_groupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGroupsApi::list_all_organizations_in_a_group(const QString &group_id, const ::OpenAPI::OptionalParam<double> &per_page, const ::OpenAPI::OptionalParam<double> &page, const ::OpenAPI::OptionalParam<QString> &name) {
    QString fullPath = QString(_serverConfigs["list_all_organizations_in_a_group"][_serverIndices.value("list_all_organizations_in_a_group")].URL()+"/group/{groupId}/orgs");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::list_all_organizations_in_a_groupCallback);
    connect(this, &OAIGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGroupsApi::list_all_organizations_in_a_groupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_all_organizations_in_a_groupSignal();
        Q_EMIT list_all_organizations_in_a_groupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_all_organizations_in_a_groupSignalE(error_type, error_str);
        Q_EMIT list_all_organizations_in_a_groupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_all_organizations_in_a_groupSignalError(error_type, error_str);
        Q_EMIT list_all_organizations_in_a_groupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGroupsApi::list_all_roles_in_a_group(const QString &group_id) {
    QString fullPath = QString(_serverConfigs["list_all_roles_in_a_group"][_serverIndices.value("list_all_roles_in_a_group")].URL()+"/group/{groupId}/roles");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::list_all_roles_in_a_groupCallback);
    connect(this, &OAIGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGroupsApi::list_all_roles_in_a_groupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_all_roles_in_a_groupSignal();
        Q_EMIT list_all_roles_in_a_groupSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_all_roles_in_a_groupSignalE(error_type, error_str);
        Q_EMIT list_all_roles_in_a_groupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_all_roles_in_a_groupSignalError(error_type, error_str);
        Q_EMIT list_all_roles_in_a_groupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGroupsApi::list_all_tags_in_a_group(const QString &group_id, const ::OpenAPI::OptionalParam<double> &per_page, const ::OpenAPI::OptionalParam<double> &page) {
    QString fullPath = QString(_serverConfigs["list_all_tags_in_a_group"][_serverIndices.value("list_all_tags_in_a_group")].URL()+"/group/{groupId}/tags");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::list_all_tags_in_a_groupCallback);
    connect(this, &OAIGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGroupsApi::list_all_tags_in_a_groupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIList_all_tags_in_a_group_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_all_tags_in_a_groupSignal(output);
        Q_EMIT list_all_tags_in_a_groupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_all_tags_in_a_groupSignalE(output, error_type, error_str);
        Q_EMIT list_all_tags_in_a_groupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_all_tags_in_a_groupSignalError(output, error_type, error_str);
        Q_EMIT list_all_tags_in_a_groupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGroupsApi::update_group_settings(const QString &group_id) {
    QString fullPath = QString(_serverConfigs["update_group_settings"][_serverIndices.value("update_group_settings")].URL()+"/group/{groupId}/settings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::update_group_settingsCallback);
    connect(this, &OAIGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGroupsApi::update_group_settingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIView_group_settings_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT update_group_settingsSignal(output);
        Q_EMIT update_group_settingsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT update_group_settingsSignalE(output, error_type, error_str);
        Q_EMIT update_group_settingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT update_group_settingsSignalError(output, error_type, error_str);
        Q_EMIT update_group_settingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGroupsApi::view_group_settings(const QString &group_id) {
    QString fullPath = QString(_serverConfigs["view_group_settings"][_serverIndices.value("view_group_settings")].URL()+"/group/{groupId}/settings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGroupsApi::view_group_settingsCallback);
    connect(this, &OAIGroupsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIGroupsApi::view_group_settingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT view_group_settingsSignal(output);
        Q_EMIT view_group_settingsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT view_group_settingsSignalE(output, error_type, error_str);
        Q_EMIT view_group_settingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT view_group_settingsSignalError(output, error_type, error_str);
        Q_EMIT view_group_settingsSignalErrorFull(worker, error_type, error_str);
    }
}
