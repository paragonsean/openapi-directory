...
/*
 * OAIList_all_Aggregated_issues_200_response_issues_inner.h
 *
 * 
 */

#ifndef OAIList_all_Aggregated_issues_200_response_issues_inner_H
#define OAIList_all_Aggregated_issues_200_response_issues_inner_H

#include <QJsonObject>

#include "OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo.h"
#include "OAIList_all_Aggregated_issues_200_response_issues_inner_issueData.h"
#include "OAIList_all_Aggregated_issues_200_response_issues_inner_links.h"
#include "OAIList_all_Aggregated_issues_200_response_issues_inner_priority.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo;
class OAIList_all_Aggregated_issues_200_response_issues_inner_issueData;
class OAIList_all_Aggregated_issues_200_response_issues_inner_links;
class OAIList_all_Aggregated_issues_200_response_issues_inner_priority;

class OAIList_all_Aggregated_issues_200_response_issues_inner : public OAIObject {
public:
    OAIList_all_Aggregated_issues_200_response_issues_inner();
    OAIList_all_Aggregated_issues_200_response_issues_inner(QString json);
    ~OAIList_all_Aggregated_issues_200_response_issues_inner() override;
    ...
    OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo getFixInfo() const;
    void setFixInfo(const OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo &fix_info);
    bool is_fix_info_Set() const;
    bool is_fix_info_Valid() const;
    ...
    QList<QJsonValue> getIgnoreReasons() const;
    void setIgnoreReasons(const QList<QJsonValue> &ignore_reasons);
    bool is_ignore_reasons_Set() const;
    bool is_ignore_reasons_Valid() const;

    QList<QJsonValue> getIntroducedThrough() const;
    void setIntroducedThrough(const QList<QJsonValue> &introduced_through);
    bool is_introduced_through_Set() const;
    bool is_introduced_through_Valid() const;
    ...
    bool isIsPatched() const;
    void setIsPatched(const bool &is_patched);
    bool is_is_patched_Set() const;
    bool is_is_patched_Valid() const;

    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData getIssueData() const;
    void setIssueData(const OAIList_all_Aggregated_issues_200_response_issues_inner_issueData &issue_data);
    bool is_issue_data_Set() const;
    bool is_issue_data_Valid() const;
    ...
    OAIList_all_Aggregated_issues_200_response_issues_inner_links getLinks() const;
    void setLinks(const OAIList_all_Aggregated_issues_200_response_issues_inner_links &links);
    bool is_links_Set() const;
    bool is_links_Valid() const;

    QString getPkgName() const;
    void setPkgName(const QString &pkg_name);
    bool is_pkg_name_Set() const;
    bool is_pkg_name_Valid() const;

    QList<QString> getPkgVersions() const;
    void setPkgVersions(const QList<QString> &pkg_versions);
    bool is_pkg_versions_Set() const;
    bool is_pkg_versions_Valid() const;

    OAIList_all_Aggregated_issues_200_response_issues_inner_priority getPriority() const;
    void setPriority(const OAIList_all_Aggregated_issues_200_response_issues_inner_priority &priority);
...
private:
    ...
    OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo m_fix_info;
    bool m_fix_info_isSet;
    bool m_fix_info_isValid;

    QString m_id;
    bool m_id_isSet;
    bool m_id_isValid;

    QList<QJsonValue> m_ignore_reasons;
    bool m_ignore_reasons_isSet;
    bool m_ignore_reasons_isValid;

    QList<QJsonValue> m_introduced_through;
    bool m_introduced_through_isSet;
    bool m_introduced_through_isValid;
    ...
    bool m_is_patched;
    bool m_is_patched_isSet;
    bool m_is_patched_isValid;

    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData m_issue_data;
    bool m_issue_data_isSet;
    bool m_issue_data_isValid;

    QString m_issue_type;
    bool m_issue_type_isSet;
    bool m_issue_type_isValid;

    OAIList_all_Aggregated_issues_200_response_issues_inner_links m_links;
    bool m_links_isSet;
    bool m_links_isValid;

    QString m_pkg_name;
    bool m_pkg_name_isSet;
    bool m_pkg_name_isValid;

    QList<QString> m_pkg_versions;
    bool m_pkg_versions_isSet;
    bool m_pkg_versions_isValid;

    OAIList_all_Aggregated_issues_200_response_issues_inner_priority m_priority;
...
Q_DECLARE_METATYPE(OpenAPI::OAIList_all_Aggregated_issues_200_response_issues_inner)

#endif // OAIList_all_Aggregated_issues_200_response_issues_inner_H
