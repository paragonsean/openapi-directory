...
void OAILicensesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("list_all_licenses", defaultConf);
    _serverIndices.insert("list_all_licenses", 0);
}
...
void OAILicensesApi::list_all_licenses(const QString &org_id, const ::OpenAPI::OptionalParam<QString> &sort_by, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<OAIList_all_licenses_request> &oai_list_all_licenses_request) {
    QString fullPath = QString(_serverConfigs["list_all_licenses"][_serverIndices.value("list_all_licenses")].URL()+"/org/{orgId}/licenses");
    ...
    if (oai_list_all_licenses_request.hasValue()){

        
        QByteArray output = oai_list_all_licenses_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILicensesApi::list_all_licensesCallback);
...
void OAILicensesApi::list_all_licensesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIList_all_licenses_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_all_licensesSignal(output);
        Q_EMIT list_all_licensesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_all_licensesSignalE(output, error_type, error_str);
        Q_EMIT list_all_licensesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_all_licensesSignalError(output, error_type, error_str);
        Q_EMIT list_all_licensesSignalErrorFull(worker, error_type, error_str);
    }
}
