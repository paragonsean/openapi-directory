...
#include "OAIList_all_Aggregated_issues_200_response_issues_inner.h"
...
OAIList_all_Aggregated_issues_200_response_issues_inner::OAIList_all_Aggregated_issues_200_response_issues_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_Aggregated_issues_200_response_issues_inner::OAIList_all_Aggregated_issues_200_response_issues_inner() {
    this->initializeModel();
}

OAIList_all_Aggregated_issues_200_response_issues_inner::~OAIList_all_Aggregated_issues_200_response_issues_inner() {}

void OAIList_all_Aggregated_issues_200_response_issues_inner::initializeModel() {

    m_fix_info_isSet = false;
    m_fix_info_isValid = false;
    ...
    m_introduced_through_isSet = false;
    m_introduced_through_isValid = false;
    ...
    m_issue_data_isSet = false;
    m_issue_data_isValid = false;
    ...
    m_pkg_name_isSet = false;
    m_pkg_name_isValid = false;

    m_pkg_versions_isSet = false;
    m_pkg_versions_isValid = false;

    m_priority_isSet = false;
    m_priority_isValid = false;
}

void OAIList_all_Aggregated_issues_200_response_issues_inner::fromJson(QString jsonString) {
...
void OAIList_all_Aggregated_issues_200_response_issues_inner::fromJsonObject(QJsonObject json) {

    m_fix_info_isValid = ::OpenAPI::fromJsonValue(m_fix_info, json[QString("fixInfo")]);
    m_fix_info_isSet = !json[QString("fixInfo")].isNull() && m_fix_info_isValid;
    ...
    m_introduced_through_isValid = ::OpenAPI::fromJsonValue(m_introduced_through, json[QString("introducedThrough")]);
    m_introduced_through_isSet = !json[QString("introducedThrough")].isNull() && m_introduced_through_isValid;
    ...
    m_issue_data_isValid = ::OpenAPI::fromJsonValue(m_issue_data, json[QString("issueData")]);
    m_issue_data_isSet = !json[QString("issueData")].isNull() && m_issue_data_isValid;
    ...
    m_pkg_name_isValid = ::OpenAPI::fromJsonValue(m_pkg_name, json[QString("pkgName")]);
    m_pkg_name_isSet = !json[QString("pkgName")].isNull() && m_pkg_name_isValid;

    m_pkg_versions_isValid = ::OpenAPI::fromJsonValue(m_pkg_versions, json[QString("pkgVersions")]);
    m_pkg_versions_isSet = !json[QString("pkgVersions")].isNull() && m_pkg_versions_isValid;

    m_priority_isValid = ::OpenAPI::fromJsonValue(m_priority, json[QString("priority")]);
    m_priority_isSet = !json[QString("priority")].isNull() && m_priority_isValid;
}

QString OAIList_all_Aggregated_issues_200_response_issues_inner::asJson() const {
...
QJsonObject OAIList_all_Aggregated_issues_200_response_issues_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_fix_info.isSet()) {
        obj.insert(QString("fixInfo"), ::OpenAPI::toJsonValue(m_fix_info));
    }
    if (m_id_isSet) {
    ...
    if (m_introduced_through.size() > 0) {
        obj.insert(QString("introducedThrough"), ::OpenAPI::toJsonValue(m_introduced_through));
    }
    ...
    if (m_issue_data.isSet()) {
        obj.insert(QString("issueData"), ::OpenAPI::toJsonValue(m_issue_data));
    }
    ...
    if (m_pkg_name_isSet) {
        obj.insert(QString("pkgName"), ::OpenAPI::toJsonValue(m_pkg_name));
    }
    if (m_pkg_versions.size() > 0) {
        obj.insert(QString("pkgVersions"), ::OpenAPI::toJsonValue(m_pkg_versions));
    }
    if (m_priority.isSet()) {
...
OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo OAIList_all_Aggregated_issues_200_response_issues_inner::getFixInfo() const {
    return m_fix_info;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setFixInfo(const OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo &fix_info) {
    m_fix_info = fix_info;
    m_fix_info_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_fix_info_Set() const{
    return m_fix_info_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_fix_info_Valid() const{
    return m_fix_info_isValid;
}

QString OAIList_all_Aggregated_issues_200_response_issues_inner::getId() const {
    return m_id;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_id_Valid() const{
    return m_id_isValid;
}

QList<QJsonValue> OAIList_all_Aggregated_issues_200_response_issues_inner::getIgnoreReasons() const {
    return m_ignore_reasons;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setIgnoreReasons(const QList<QJsonValue> &ignore_reasons) {
    m_ignore_reasons = ignore_reasons;
    m_ignore_reasons_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_ignore_reasons_Set() const{
    return m_ignore_reasons_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_ignore_reasons_Valid() const{
    return m_ignore_reasons_isValid;
}

QList<QJsonValue> OAIList_all_Aggregated_issues_200_response_issues_inner::getIntroducedThrough() const {
    return m_introduced_through;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setIntroducedThrough(const QList<QJsonValue> &introduced_through) {
    m_introduced_through = introduced_through;
    m_introduced_through_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_introduced_through_Set() const{
    return m_introduced_through_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_introduced_through_Valid() const{
    return m_introduced_through_isValid;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::isIsIgnored() const {
    return m_is_ignored;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setIsIgnored(const bool &is_ignored) {
    m_is_ignored = is_ignored;
    m_is_ignored_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_is_ignored_Set() const{
    return m_is_ignored_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_is_ignored_Valid() const{
    return m_is_ignored_isValid;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::isIsPatched() const {
    return m_is_patched;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setIsPatched(const bool &is_patched) {
    m_is_patched = is_patched;
    m_is_patched_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_is_patched_Set() const{
    return m_is_patched_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_is_patched_Valid() const{
    return m_is_patched_isValid;
}

OAIList_all_Aggregated_issues_200_response_issues_inner_issueData OAIList_all_Aggregated_issues_200_response_issues_inner::getIssueData() const {
    return m_issue_data;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setIssueData(const OAIList_all_Aggregated_issues_200_response_issues_inner_issueData &issue_data) {
    m_issue_data = issue_data;
    m_issue_data_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_issue_data_Set() const{
    return m_issue_data_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_issue_data_Valid() const{
    return m_issue_data_isValid;
}

QString OAIList_all_Aggregated_issues_200_response_issues_inner::getIssueType() const {
    return m_issue_type;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setIssueType(const QString &issue_type) {
    m_issue_type = issue_type;
    m_issue_type_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_issue_type_Set() const{
    return m_issue_type_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_issue_type_Valid() const{
    return m_issue_type_isValid;
}

OAIList_all_Aggregated_issues_200_response_issues_inner_links OAIList_all_Aggregated_issues_200_response_issues_inner::getLinks() const {
    return m_links;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setLinks(const OAIList_all_Aggregated_issues_200_response_issues_inner_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_links_Set() const{
    return m_links_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_links_Valid() const{
    return m_links_isValid;
}

QString OAIList_all_Aggregated_issues_200_response_issues_inner::getPkgName() const {
    return m_pkg_name;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setPkgName(const QString &pkg_name) {
    m_pkg_name = pkg_name;
    m_pkg_name_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_pkg_name_Set() const{
    return m_pkg_name_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_pkg_name_Valid() const{
    return m_pkg_name_isValid;
}

QList<QString> OAIList_all_Aggregated_issues_200_response_issues_inner::getPkgVersions() const {
    return m_pkg_versions;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setPkgVersions(const QList<QString> &pkg_versions) {
    m_pkg_versions = pkg_versions;
    m_pkg_versions_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_pkg_versions_Set() const{
    return m_pkg_versions_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_pkg_versions_Valid() const{
    return m_pkg_versions_isValid;
}

OAIList_all_Aggregated_issues_200_response_issues_inner_priority OAIList_all_Aggregated_issues_200_response_issues_inner::getPriority() const {
    return m_priority;
}
void OAIList_all_Aggregated_issues_200_response_issues_inner::setPriority(const OAIList_all_Aggregated_issues_200_response_issues_inner_priority &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::is_priority_Valid() const{
    return m_priority_isValid;
}

bool OAIList_all_Aggregated_issues_200_response_issues_inner::isSet() const {
...
bool OAIList_all_Aggregated_issues_200_response_issues_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_is_ignored_isValid && m_is_patched_isValid && m_issue_data_isValid && m_issue_type_isValid && m_pkg_name_isValid && m_pkg_versions_isValid && true;
}
