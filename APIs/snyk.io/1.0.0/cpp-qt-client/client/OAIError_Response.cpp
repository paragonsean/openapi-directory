...
OAIGet_issue_counts_400_response_error OAIError_Response::getError() const {
    return m_error;
}
void OAIError_Response::setError(const OAIGet_issue_counts_400_response_error &error) {
    m_error = error;
    m_error_isSet = true;
}
...
bool OAIError_Response::isOk() const {
    return m_ok;
}
void OAIError_Response::setOk(const bool &ok) {
    m_ok = ok;
    m_ok_isSet = true;
}

bool OAIError_Response::is_ok_Set() const{
    return m_ok_isSet;
}

bool OAIError_Response::is_ok_Valid() const{
    return m_ok_isValid;
}
...
bool OAIError_Response::isValid() const {
    ...
    return m_code_isValid && m_error_isValid && m_ok_isValid && true;
}
