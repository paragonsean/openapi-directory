...
#include "OAIGet_issue_counts_request_filters.h"
...
OAIGet_issue_counts_request_filters::OAIGet_issue_counts_request_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_issue_counts_request_filters::OAIGet_issue_counts_request_filters() {
    this->initializeModel();
}

OAIGet_issue_counts_request_filters::~OAIGet_issue_counts_request_filters() {}

void OAIGet_issue_counts_request_filters::initializeModel() {
...
void OAIGet_issue_counts_request_filters::fromJson(QString jsonString) {
...
void OAIGet_issue_counts_request_filters::fromJsonObject(QJsonObject json) {
...
QString OAIGet_issue_counts_request_filters::asJson() const {
...
QJsonObject OAIGet_issue_counts_request_filters::asJsonObject() const {
    QJsonObject obj;
    if (m_fixable_isSet) {
...
bool OAIGet_issue_counts_request_filters::isFixable() const {
    return m_fixable;
}
void OAIGet_issue_counts_request_filters::setFixable(const bool &fixable) {
    m_fixable = fixable;
    m_fixable_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_fixable_Set() const{
    return m_fixable_isSet;
}

bool OAIGet_issue_counts_request_filters::is_fixable_Valid() const{
    return m_fixable_isValid;
}

bool OAIGet_issue_counts_request_filters::isIgnored() const {
    return m_ignored;
}
void OAIGet_issue_counts_request_filters::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIGet_issue_counts_request_filters::is_ignored_Valid() const{
    return m_ignored_isValid;
}

bool OAIGet_issue_counts_request_filters::isIsPatchable() const {
    return m_is_patchable;
}
void OAIGet_issue_counts_request_filters::setIsPatchable(const bool &is_patchable) {
    m_is_patchable = is_patchable;
    m_is_patchable_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_is_patchable_Set() const{
    return m_is_patchable_isSet;
}

bool OAIGet_issue_counts_request_filters::is_is_patchable_Valid() const{
    return m_is_patchable_isValid;
}

bool OAIGet_issue_counts_request_filters::isIsPinnable() const {
    return m_is_pinnable;
}
void OAIGet_issue_counts_request_filters::setIsPinnable(const bool &is_pinnable) {
    m_is_pinnable = is_pinnable;
    m_is_pinnable_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_is_pinnable_Set() const{
    return m_is_pinnable_isSet;
}

bool OAIGet_issue_counts_request_filters::is_is_pinnable_Valid() const{
    return m_is_pinnable_isValid;
}

bool OAIGet_issue_counts_request_filters::isIsUpgradable() const {
    return m_is_upgradable;
}
void OAIGet_issue_counts_request_filters::setIsUpgradable(const bool &is_upgradable) {
    m_is_upgradable = is_upgradable;
    m_is_upgradable_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_is_upgradable_Set() const{
    return m_is_upgradable_isSet;
}

bool OAIGet_issue_counts_request_filters::is_is_upgradable_Valid() const{
    return m_is_upgradable_isValid;
}

QList<QJsonValue> OAIGet_issue_counts_request_filters::getLanguages() const {
    return m_languages;
}
void OAIGet_issue_counts_request_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIGet_issue_counts_request_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QJsonValue OAIGet_issue_counts_request_filters::getOrgs() const {
    return m_orgs;
}
void OAIGet_issue_counts_request_filters::setOrgs(const QJsonValue &orgs) {
    m_orgs = orgs;
    m_orgs_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_orgs_Set() const{
    return m_orgs_isSet;
}

bool OAIGet_issue_counts_request_filters::is_orgs_Valid() const{
    return m_orgs_isValid;
}

bool OAIGet_issue_counts_request_filters::isPatched() const {
    return m_patched;
}
void OAIGet_issue_counts_request_filters::setPatched(const bool &patched) {
    m_patched = patched;
    m_patched_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_patched_Set() const{
    return m_patched_isSet;
}

bool OAIGet_issue_counts_request_filters::is_patched_Valid() const{
    return m_patched_isValid;
}

OAIGet_issue_counts_request_filters_priorityScore OAIGet_issue_counts_request_filters::getPriorityScore() const {
    return m_priority_score;
}
void OAIGet_issue_counts_request_filters::setPriorityScore(const OAIGet_issue_counts_request_filters_priorityScore &priority_score) {
    m_priority_score = priority_score;
    m_priority_score_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_priority_score_Set() const{
    return m_priority_score_isSet;
}

bool OAIGet_issue_counts_request_filters::is_priority_score_Valid() const{
    return m_priority_score_isValid;
}

QJsonValue OAIGet_issue_counts_request_filters::getProjects() const {
    return m_projects;
}
void OAIGet_issue_counts_request_filters::setProjects(const QJsonValue &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIGet_issue_counts_request_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

QList<QJsonValue> OAIGet_issue_counts_request_filters::getSeverity() const {
    return m_severity;
}
void OAIGet_issue_counts_request_filters::setSeverity(const QList<QJsonValue> &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIGet_issue_counts_request_filters::is_severity_Valid() const{
    return m_severity_isValid;
}

QList<QJsonValue> OAIGet_issue_counts_request_filters::getTypes() const {
    return m_types;
}
void OAIGet_issue_counts_request_filters::setTypes(const QList<QJsonValue> &types) {
    m_types = types;
    m_types_isSet = true;
}

bool OAIGet_issue_counts_request_filters::is_types_Set() const{
    return m_types_isSet;
}

bool OAIGet_issue_counts_request_filters::is_types_Valid() const{
    return m_types_isValid;
}

bool OAIGet_issue_counts_request_filters::isSet() const {
...
bool OAIGet_issue_counts_request_filters::isValid() const {
