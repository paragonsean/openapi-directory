...
#include "OAIProvision_a_user_to_the_organization_request.h"
...
OAIProvision_a_user_to_the_organization_request::OAIProvision_a_user_to_the_organization_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvision_a_user_to_the_organization_request::OAIProvision_a_user_to_the_organization_request() {
    this->initializeModel();
}

OAIProvision_a_user_to_the_organization_request::~OAIProvision_a_user_to_the_organization_request() {}

void OAIProvision_a_user_to_the_organization_request::initializeModel() {
    ...
    m_role_public_id_isSet = false;
    m_role_public_id_isValid = false;
}

void OAIProvision_a_user_to_the_organization_request::fromJson(QString jsonString) {
...
void OAIProvision_a_user_to_the_organization_request::fromJsonObject(QJsonObject json) {
    ...
    m_role_public_id_isValid = ::OpenAPI::fromJsonValue(m_role_public_id, json[QString("rolePublicId")]);
    m_role_public_id_isSet = !json[QString("rolePublicId")].isNull() && m_role_public_id_isValid;
}

QString OAIProvision_a_user_to_the_organization_request::asJson() const {
...
QJsonObject OAIProvision_a_user_to_the_organization_request::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
    ...
    if (m_role_public_id_isSet) {
        obj.insert(QString("rolePublicId"), ::OpenAPI::toJsonValue(m_role_public_id));
    }
    return obj;
}

QString OAIProvision_a_user_to_the_organization_request::getEmail() const {
    return m_email;
}
void OAIProvision_a_user_to_the_organization_request::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIProvision_a_user_to_the_organization_request::is_email_Set() const{
    return m_email_isSet;
}

bool OAIProvision_a_user_to_the_organization_request::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIProvision_a_user_to_the_organization_request::getRole() const {
    return m_role;
}
void OAIProvision_a_user_to_the_organization_request::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIProvision_a_user_to_the_organization_request::is_role_Set() const{
    return m_role_isSet;
}

bool OAIProvision_a_user_to_the_organization_request::is_role_Valid() const{
    return m_role_isValid;
}

QString OAIProvision_a_user_to_the_organization_request::getRolePublicId() const {
    return m_role_public_id;
}
void OAIProvision_a_user_to_the_organization_request::setRolePublicId(const QString &role_public_id) {
    m_role_public_id = role_public_id;
    m_role_public_id_isSet = true;
}

bool OAIProvision_a_user_to_the_organization_request::is_role_public_id_Set() const{
    return m_role_public_id_isSet;
}

bool OAIProvision_a_user_to_the_organization_request::is_role_public_id_Valid() const{
    return m_role_public_id_isValid;
}

bool OAIProvision_a_user_to_the_organization_request::isSet() const {
...
bool OAIProvision_a_user_to_the_organization_request::isValid() const {
