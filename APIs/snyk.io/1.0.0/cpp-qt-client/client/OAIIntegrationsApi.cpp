...
void OAIIntegrationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("add_new_integration", defaultConf);
    _serverIndices.insert("add_new_integration", 0);
    _serverConfigs.insert("clone_an_integration__with_settings_and_credentials", defaultConf);
    _serverIndices.insert("clone_an_integration__with_settings_and_credentials", 0);
    _serverConfigs.insert("delete_credentials", defaultConf);
    _serverIndices.insert("delete_credentials", 0);
    _serverConfigs.insert("get_existing_integration_by_type", defaultConf);
    _serverIndices.insert("get_existing_integration_by_type", 0);
    _serverConfigs.insert("list", defaultConf);
    _serverIndices.insert("list", 0);
    _serverConfigs.insert("provision_new_broker_token", defaultConf);
    _serverIndices.insert("provision_new_broker_token", 0);
    _serverConfigs.insert("retrieve", defaultConf);
    _serverIndices.insert("retrieve", 0);
    _serverConfigs.insert("switch_between_broker_tokens", defaultConf);
    _serverIndices.insert("switch_between_broker_tokens", 0);
    _serverConfigs.insert("update", defaultConf);
    _serverIndices.insert("update", 0);
    _serverConfigs.insert("update_existing_integration", defaultConf);
    _serverIndices.insert("update_existing_integration", 0);
}
...
void OAIIntegrationsApi::add_new_integration(const QString &org_id, const ::OpenAPI::OptionalParam<OAIAdd_new_integration_request> &oai_add_new_integration_request) {
    QString fullPath = QString(_serverConfigs["add_new_integration"][_serverIndices.value("add_new_integration")].URL()+"/org/{orgId}/integrations");
    ...
    if (oai_add_new_integration_request.hasValue()){

        
        QByteArray output = oai_add_new_integration_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::add_new_integrationCallback);
...
void OAIIntegrationsApi::add_new_integrationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_new_integrationSignal();
        Q_EMIT add_new_integrationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_new_integrationSignalE(error_type, error_str);
        Q_EMIT add_new_integrationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_new_integrationSignalError(error_type, error_str);
        Q_EMIT add_new_integrationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIntegrationsApi::clone_an_integration__with_settings_and_credentials(const QString &org_id, const QString &integration_id, const ::OpenAPI::OptionalParam<OAIClone_an_integration__with_settings_and_credentials__request> &oai_clone_an_integration__with_settings_and_credentials__request) {
    QString fullPath = QString(_serverConfigs["clone_an_integration__with_settings_and_credentials"][_serverIndices.value("clone_an_integration__with_settings_and_credentials")].URL()+"/org/{orgId}/integrations/{integrationId}/clone");
    ...
    if (oai_clone_an_integration__with_settings_and_credentials__request.hasValue()){

        
        QByteArray output = oai_clone_an_integration__with_settings_and_credentials__request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::clone_an_integration__with_settings_and_credentialsCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::clone_an_integration__with_settings_and_credentialsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT clone_an_integration__with_settings_and_credentialsSignal();
        Q_EMIT clone_an_integration__with_settings_and_credentialsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT clone_an_integration__with_settings_and_credentialsSignalE(error_type, error_str);
        Q_EMIT clone_an_integration__with_settings_and_credentialsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT clone_an_integration__with_settings_and_credentialsSignalError(error_type, error_str);
        Q_EMIT clone_an_integration__with_settings_and_credentialsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIntegrationsApi::delete_credentials(const QString &org_id, const QString &integration_id) {
    QString fullPath = QString(_serverConfigs["delete_credentials"][_serverIndices.value("delete_credentials")].URL()+"/org/{orgId}/integrations/{integrationId}/authentication");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::delete_credentialsCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::delete_credentialsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT delete_credentialsSignal();
        Q_EMIT delete_credentialsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT delete_credentialsSignalE(error_type, error_str);
        Q_EMIT delete_credentialsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT delete_credentialsSignalError(error_type, error_str);
        Q_EMIT delete_credentialsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIntegrationsApi::get_existing_integration_by_type(const QString &org_id, const QString &type) {
    QString fullPath = QString(_serverConfigs["get_existing_integration_by_type"][_serverIndices.value("get_existing_integration_by_type")].URL()+"/org/{orgId}/integrations/{type}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::get_existing_integration_by_typeCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::get_existing_integration_by_typeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGet_existing_integration_by_type_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_existing_integration_by_typeSignal(output);
        Q_EMIT get_existing_integration_by_typeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_existing_integration_by_typeSignalE(output, error_type, error_str);
        Q_EMIT get_existing_integration_by_typeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_existing_integration_by_typeSignalError(output, error_type, error_str);
        Q_EMIT get_existing_integration_by_typeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIntegrationsApi::list(const QString &org_id) {
    QString fullPath = QString(_serverConfigs["list"][_serverIndices.value("list")].URL()+"/org/{orgId}/integrations");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::listCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIIntegrationsApi::provision_new_broker_token(const QString &org_id, const QString &integration_id) {
    QString fullPath = QString(_serverConfigs["provision_new_broker_token"][_serverIndices.value("provision_new_broker_token")].URL()+"/org/{orgId}/integrations/{integrationId}/authentication/provision-token");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::provision_new_broker_tokenCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::provision_new_broker_tokenCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT provision_new_broker_tokenSignal();
        Q_EMIT provision_new_broker_tokenSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT provision_new_broker_tokenSignalE(error_type, error_str);
        Q_EMIT provision_new_broker_tokenSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT provision_new_broker_tokenSignalError(error_type, error_str);
        Q_EMIT provision_new_broker_tokenSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIntegrationsApi::retrieve(const QString &org_id, const QString &integration_id) {
    QString fullPath = QString(_serverConfigs["retrieve"][_serverIndices.value("retrieve")].URL()+"/org/{orgId}/integrations/{integrationId}/settings");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::retrieveCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::retrieveCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIRetrieve_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIIntegrationsApi::switch_between_broker_tokens(const QString &org_id, const QString &integration_id) {
    QString fullPath = QString(_serverConfigs["switch_between_broker_tokens"][_serverIndices.value("switch_between_broker_tokens")].URL()+"/org/{orgId}/integrations/{integrationId}/authentication/switch-token");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::switch_between_broker_tokensCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::switch_between_broker_tokensCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT switch_between_broker_tokensSignal();
        Q_EMIT switch_between_broker_tokensSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT switch_between_broker_tokensSignalE(error_type, error_str);
        Q_EMIT switch_between_broker_tokensSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT switch_between_broker_tokensSignalError(error_type, error_str);
        Q_EMIT switch_between_broker_tokensSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIntegrationsApi::update(const QString &org_id, const QString &integration_id, const ::OpenAPI::OptionalParam<OAIUpdate_request> &oai_update_request) {
    QString fullPath = QString(_serverConfigs["update"][_serverIndices.value("update")].URL()+"/org/{orgId}/integrations/{integrationId}/settings");
    ...
    if (oai_update_request.hasValue()){

        
        QByteArray output = oai_update_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::updateCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::updateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIIntegrationsApi::update_existing_integration(const QString &org_id, const QString &integration_id, const ::OpenAPI::OptionalParam<OAIUpdate_existing_integration_request> &oai_update_existing_integration_request) {
    QString fullPath = QString(_serverConfigs["update_existing_integration"][_serverIndices.value("update_existing_integration")].URL()+"/org/{orgId}/integrations/{integrationId}");
    ...
    if (oai_update_existing_integration_request.hasValue()){

        
        QByteArray output = oai_update_existing_integration_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIntegrationsApi::update_existing_integrationCallback);
    connect(this, &OAIIntegrationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIntegrationsApi::update_existing_integrationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT update_existing_integrationSignal();
        Q_EMIT update_existing_integrationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT update_existing_integrationSignalE(error_type, error_str);
        Q_EMIT update_existing_integrationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT update_existing_integrationSignalError(error_type, error_str);
        Q_EMIT update_existing_integrationSignalErrorFull(worker, error_type, error_str);
    }
}
