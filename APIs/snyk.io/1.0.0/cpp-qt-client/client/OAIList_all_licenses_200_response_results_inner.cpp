...
#include "OAIList_all_licenses_200_response_results_inner.h"
...
OAIList_all_licenses_200_response_results_inner::OAIList_all_licenses_200_response_results_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_licenses_200_response_results_inner::OAIList_all_licenses_200_response_results_inner() {
    this->initializeModel();
}

OAIList_all_licenses_200_response_results_inner::~OAIList_all_licenses_200_response_results_inner() {}

void OAIList_all_licenses_200_response_results_inner::initializeModel() {
...
void OAIList_all_licenses_200_response_results_inner::fromJson(QString jsonString) {
...
void OAIList_all_licenses_200_response_results_inner::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_licenses_200_response_results_inner::asJson() const {
...
QJsonObject OAIList_all_licenses_200_response_results_inner::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIList_all_licenses_200_response_results_inner_dependencies_inner> OAIList_all_licenses_200_response_results_inner::getDependencies() const {
    return m_dependencies;
}
void OAIList_all_licenses_200_response_results_inner::setDependencies(const QList<OAIList_all_licenses_200_response_results_inner_dependencies_inner> &dependencies) {
    m_dependencies = dependencies;
    m_dependencies_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner::is_dependencies_Set() const{
    return m_dependencies_isSet;
}

bool OAIList_all_licenses_200_response_results_inner::is_dependencies_Valid() const{
    return m_dependencies_isValid;
}

QString OAIList_all_licenses_200_response_results_inner::getId() const {
    return m_id;
}
void OAIList_all_licenses_200_response_results_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIList_all_licenses_200_response_results_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIList_all_licenses_200_response_results_inner::getInstructions() const {
    return m_instructions;
}
void OAIList_all_licenses_200_response_results_inner::setInstructions(const QString &instructions) {
    m_instructions = instructions;
    m_instructions_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner::is_instructions_Set() const{
    return m_instructions_isSet;
}

bool OAIList_all_licenses_200_response_results_inner::is_instructions_Valid() const{
    return m_instructions_isValid;
}

QList<OAIList_all_dependencies_200_response_results_inner_projects_inner> OAIList_all_licenses_200_response_results_inner::getProjects() const {
    return m_projects;
}
void OAIList_all_licenses_200_response_results_inner::setProjects(const QList<OAIList_all_dependencies_200_response_results_inner_projects_inner> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIList_all_licenses_200_response_results_inner::is_projects_Valid() const{
    return m_projects_isValid;
}

QString OAIList_all_licenses_200_response_results_inner::getSeverity() const {
    return m_severity;
}
void OAIList_all_licenses_200_response_results_inner::setSeverity(const QString &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIList_all_licenses_200_response_results_inner::is_severity_Valid() const{
    return m_severity_isValid;
}

bool OAIList_all_licenses_200_response_results_inner::isSet() const {
...
bool OAIList_all_licenses_200_response_results_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_dependencies_isValid && m_id_isValid && m_projects_isValid && true;
}
