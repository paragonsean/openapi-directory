...
#include "OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license.h"
...
OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license() {
    this->initializeModel();
}

OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::~OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license() {}

void OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::initializeModel() {
...
void OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::fromJson(QString jsonString) {
...
void OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::asJson() const {
...
QJsonObject OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::asJsonObject() const {
    QJsonObject obj;
    if (m_critical_isSet) {
...
double OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::getCritical() const {
    return m_critical;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::setCritical(const double &critical) {
    m_critical = critical;
    m_critical_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_critical_Set() const{
    return m_critical_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_critical_Valid() const{
    return m_critical_isValid;
}

double OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::getHigh() const {
    return m_high;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::setHigh(const double &high) {
    m_high = high;
    m_high_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_high_Set() const{
    return m_high_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_high_Valid() const{
    return m_high_isValid;
}

double OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::getLow() const {
    return m_low;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::setLow(const double &low) {
    m_low = low;
    m_low_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_low_Set() const{
    return m_low_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_low_Valid() const{
    return m_low_isValid;
}

double OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::getMedium() const {
    return m_medium;
}
void OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::setMedium(const double &medium) {
    m_medium = medium;
    m_medium_isSet = true;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_medium_Set() const{
    return m_medium_isSet;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::is_medium_Valid() const{
    return m_medium_isValid;
}

bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::isSet() const {
...
bool OAIList_all_project_snapshots_200_response_snapshots_inner_issueCounts_license::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_critical_isValid && m_high_isValid && m_low_isValid && m_medium_isValid && true;
}
