...
#include "OAIList_all_projects_request_filters_attributes.h"
...
OAIList_all_projects_request_filters_attributes::OAIList_all_projects_request_filters_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_projects_request_filters_attributes::OAIList_all_projects_request_filters_attributes() {
    this->initializeModel();
}

OAIList_all_projects_request_filters_attributes::~OAIList_all_projects_request_filters_attributes() {}

void OAIList_all_projects_request_filters_attributes::initializeModel() {
...
void OAIList_all_projects_request_filters_attributes::fromJson(QString jsonString) {
...
void OAIList_all_projects_request_filters_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_projects_request_filters_attributes::asJson() const {
...
QJsonObject OAIList_all_projects_request_filters_attributes::asJsonObject() const {
    QJsonObject obj;
    if (m_criticality.size() > 0) {
        obj.insert(QString("criticality"), ::OpenAPI::toJsonValue(m_criticality));
    }
    if (m_environment.size() > 0) {
        obj.insert(QString("environment"), ::OpenAPI::toJsonValue(m_environment));
    }
    if (m_lifecycle.size() > 0) {
        obj.insert(QString("lifecycle"), ::OpenAPI::toJsonValue(m_lifecycle));
    }
    return obj;
}

QList<QJsonValue> OAIList_all_projects_request_filters_attributes::getCriticality() const {
    return m_criticality;
}
void OAIList_all_projects_request_filters_attributes::setCriticality(const QList<QJsonValue> &criticality) {
    m_criticality = criticality;
    m_criticality_isSet = true;
}

bool OAIList_all_projects_request_filters_attributes::is_criticality_Set() const{
    return m_criticality_isSet;
}

bool OAIList_all_projects_request_filters_attributes::is_criticality_Valid() const{
    return m_criticality_isValid;
}

QList<QJsonValue> OAIList_all_projects_request_filters_attributes::getEnvironment() const {
    return m_environment;
}
void OAIList_all_projects_request_filters_attributes::setEnvironment(const QList<QJsonValue> &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAIList_all_projects_request_filters_attributes::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAIList_all_projects_request_filters_attributes::is_environment_Valid() const{
    return m_environment_isValid;
}

QList<QJsonValue> OAIList_all_projects_request_filters_attributes::getLifecycle() const {
    return m_lifecycle;
}
void OAIList_all_projects_request_filters_attributes::setLifecycle(const QList<QJsonValue> &lifecycle) {
    m_lifecycle = lifecycle;
    m_lifecycle_isSet = true;
}

bool OAIList_all_projects_request_filters_attributes::is_lifecycle_Set() const{
    return m_lifecycle_isSet;
}

bool OAIList_all_projects_request_filters_attributes::is_lifecycle_Valid() const{
    return m_lifecycle_isValid;
}

bool OAIList_all_projects_request_filters_attributes::isSet() const {
...
bool OAIList_all_projects_request_filters_attributes::isValid() const {
