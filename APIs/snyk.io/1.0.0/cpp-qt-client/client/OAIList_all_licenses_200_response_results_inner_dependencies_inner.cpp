...
#include "OAIList_all_licenses_200_response_results_inner_dependencies_inner.h"
...
OAIList_all_licenses_200_response_results_inner_dependencies_inner::OAIList_all_licenses_200_response_results_inner_dependencies_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_licenses_200_response_results_inner_dependencies_inner::OAIList_all_licenses_200_response_results_inner_dependencies_inner() {
    this->initializeModel();
}

OAIList_all_licenses_200_response_results_inner_dependencies_inner::~OAIList_all_licenses_200_response_results_inner_dependencies_inner() {}

void OAIList_all_licenses_200_response_results_inner_dependencies_inner::initializeModel() {
...
void OAIList_all_licenses_200_response_results_inner_dependencies_inner::fromJson(QString jsonString) {
...
void OAIList_all_licenses_200_response_results_inner_dependencies_inner::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_licenses_200_response_results_inner_dependencies_inner::asJson() const {
...
QJsonObject OAIList_all_licenses_200_response_results_inner_dependencies_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIList_all_licenses_200_response_results_inner_dependencies_inner::getId() const {
    return m_id;
}
void OAIList_all_licenses_200_response_results_inner_dependencies_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIList_all_licenses_200_response_results_inner_dependencies_inner::getName() const {
    return m_name;
}
void OAIList_all_licenses_200_response_results_inner_dependencies_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIList_all_licenses_200_response_results_inner_dependencies_inner::getPackageManager() const {
    return m_package_manager;
}
void OAIList_all_licenses_200_response_results_inner_dependencies_inner::setPackageManager(const QString &package_manager) {
    m_package_manager = package_manager;
    m_package_manager_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_package_manager_Set() const{
    return m_package_manager_isSet;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_package_manager_Valid() const{
    return m_package_manager_isValid;
}

QString OAIList_all_licenses_200_response_results_inner_dependencies_inner::getVersion() const {
    return m_version;
}
void OAIList_all_licenses_200_response_results_inner_dependencies_inner::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_version_Set() const{
    return m_version_isSet;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::isSet() const {
...
bool OAIList_all_licenses_200_response_results_inner_dependencies_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_name_isValid && m_package_manager_isValid && m_version_isValid && true;
}
