...
OAIFunctionId::OAIFunctionId(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFunctionId::OAIFunctionId() {
    this->initializeModel();
}

OAIFunctionId::~OAIFunctionId() {}

void OAIFunctionId::initializeModel() {
...
void OAIFunctionId::fromJson(QString jsonString) {
...
void OAIFunctionId::fromJsonObject(QJsonObject json) {
...
QString OAIFunctionId::asJson() const {
...
QJsonObject OAIFunctionId::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFunctionId::getClassName() const {
    return m_class_name;
}
void OAIFunctionId::setClassName(const QString &class_name) {
    m_class_name = class_name;
    m_class_name_isSet = true;
}

bool OAIFunctionId::is_class_name_Set() const{
    return m_class_name_isSet;
}

bool OAIFunctionId::is_class_name_Valid() const{
    return m_class_name_isValid;
}

QString OAIFunctionId::getFilePath() const {
    return m_file_path;
}
void OAIFunctionId::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIFunctionId::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIFunctionId::is_file_path_Valid() const{
    return m_file_path_isValid;
}

QString OAIFunctionId::getFunctionName() const {
    return m_function_name;
}
void OAIFunctionId::setFunctionName(const QString &function_name) {
    m_function_name = function_name;
    m_function_name_isSet = true;
}

bool OAIFunctionId::is_function_name_Set() const{
    return m_function_name_isSet;
}

bool OAIFunctionId::is_function_name_Valid() const{
    return m_function_name_isValid;
}

bool OAIFunctionId::isSet() const {
...
bool OAIFunctionId::isValid() const {
