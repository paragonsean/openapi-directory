...
/*
 * OAIList_all_Aggregated_issues_200_response_issues_inner_issueData.h
 *
 * The details of the issue
 */

#ifndef OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_H
#define OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_H

#include <QJsonObject>

#include "OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_identifiers.h"
#include "OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_semver.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_identifiers;
class OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_semver;

class OAIList_all_Aggregated_issues_200_response_issues_inner_issueData : public OAIObject {
public:
    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData();
    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData(QString json);
    ~OAIList_all_Aggregated_issues_200_response_issues_inner_issueData() override;
    ...
    QString getCvssv3() const;
    void setCvssv3(const QString &cvssv3);
    bool is_cvssv3_Set() const;
    bool is_cvssv3_Valid() const;

    QList<QJsonValue> getCredit() const;
    void setCredit(const QList<QJsonValue> &credit);
    bool is_credit_Set() const;
    bool is_credit_Valid() const;

    double getCvssScore() const;
    void setCvssScore(const double &cvss_score);
    ...
    QString getDisclosureTime() const;
    void setDisclosureTime(const QString &disclosure_time);
    bool is_disclosure_time_Set() const;
    bool is_disclosure_time_Valid() const;

    QString getExploitMaturity() const;
    void setExploitMaturity(const QString &exploit_maturity);
    bool is_exploit_maturity_Set() const;
    bool is_exploit_maturity_Valid() const;
    ...
    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_identifiers getIdentifiers() const;
    void setIdentifiers(const OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_identifiers &identifiers);
    bool is_identifiers_Set() const;
    bool is_identifiers_Valid() const;

    bool isIsMaliciousPackage() const;
    void setIsMaliciousPackage(const bool &is_malicious_package);
    bool is_is_malicious_package_Set() const;
    bool is_is_malicious_package_Valid() const;
    ...
    QString getNearestFixedInVersion() const;
    void setNearestFixedInVersion(const QString &nearest_fixed_in_version);
    bool is_nearest_fixed_in_version_Set() const;
    bool is_nearest_fixed_in_version_Valid() const;

    QString getOriginalSeverity() const;
    void setOriginalSeverity(const QString &original_severity);
    bool is_original_severity_Set() const;
    bool is_original_severity_Valid() const;

    QList<QJsonValue> getPatches() const;
    void setPatches(const QList<QJsonValue> &patches);
    bool is_patches_Set() const;
    bool is_patches_Valid() const;
    ...
    QString getPublicationTime() const;
    void setPublicationTime(const QString &publication_time);
    bool is_publication_time_Set() const;
    bool is_publication_time_Valid() const;

    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_semver getSemver() const;
    void setSemver(const OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_semver &semver);
    bool is_semver_Set() const;
    bool is_semver_Valid() const;
    ...
    QString getViolatedPolicyPublicId() const;
    void setViolatedPolicyPublicId(const QString &violated_policy_public_id);
    bool is_violated_policy_public_id_Set() const;
    bool is_violated_policy_public_id_Valid() const;
...
private:
    ...
    QString m_disclosure_time;
    bool m_disclosure_time_isSet;
    bool m_disclosure_time_isValid;

    QString m_exploit_maturity;
    bool m_exploit_maturity_isSet;
    bool m_exploit_maturity_isValid;

    QString m_id;
    bool m_id_isSet;
    bool m_id_isValid;

    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_identifiers m_identifiers;
    bool m_identifiers_isSet;
    bool m_identifiers_isValid;

    bool m_is_malicious_package;
    bool m_is_malicious_package_isSet;
    bool m_is_malicious_package_isValid;

    QString m_language;
    bool m_language_isSet;
    bool m_language_isValid;

    QString m_nearest_fixed_in_version;
    bool m_nearest_fixed_in_version_isSet;
    bool m_nearest_fixed_in_version_isValid;

    QString m_original_severity;
    bool m_original_severity_isSet;
    bool m_original_severity_isValid;

    QList<QJsonValue> m_patches;
    bool m_patches_isSet;
    bool m_patches_isValid;

    QString m_path;
    bool m_path_isSet;
    bool m_path_isValid;

    QString m_publication_time;
    bool m_publication_time_isSet;
    bool m_publication_time_isValid;

    OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_semver m_semver;
    bool m_semver_isSet;
    bool m_semver_isValid;
    ...
    QString m_violated_policy_public_id;
    bool m_violated_policy_public_id_isSet;
    bool m_violated_policy_public_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIList_all_Aggregated_issues_200_response_issues_inner_issueData)

#endif // OAIList_all_Aggregated_issues_200_response_issues_inner_issueData_H
