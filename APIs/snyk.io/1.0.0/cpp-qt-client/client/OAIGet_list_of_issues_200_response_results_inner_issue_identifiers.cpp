...
#include "OAIGet_list_of_issues_200_response_results_inner_issue_identifiers.h"
...
OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::OAIGet_list_of_issues_200_response_results_inner_issue_identifiers(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::OAIGet_list_of_issues_200_response_results_inner_issue_identifiers() {
    this->initializeModel();
}

OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::~OAIGet_list_of_issues_200_response_results_inner_issue_identifiers() {}

void OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::initializeModel() {
    ...
    m_osvdb_isSet = false;
    m_osvdb_isValid = false;
}

void OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::fromJson(QString jsonString) {
...
void OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::fromJsonObject(QJsonObject json) {
    ...
    m_osvdb_isValid = ::OpenAPI::fromJsonValue(m_osvdb, json[QString("OSVDB")]);
    m_osvdb_isSet = !json[QString("OSVDB")].isNull() && m_osvdb_isValid;
}

QString OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::asJson() const {
...
QJsonObject OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::asJsonObject() const {
    QJsonObject obj;
    if (m_cve.size() > 0) {
    ...
    if (m_osvdb.size() > 0) {
        obj.insert(QString("OSVDB"), ::OpenAPI::toJsonValue(m_osvdb));
    }
    return obj;
}

QList<QJsonValue> OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::getCve() const {
    return m_cve;
}
void OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::setCve(const QList<QJsonValue> &cve) {
    m_cve = cve;
    m_cve_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::is_cve_Set() const{
    return m_cve_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::is_cve_Valid() const{
    return m_cve_isValid;
}

QList<QJsonValue> OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::getCwe() const {
    return m_cwe;
}
void OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::setCwe(const QList<QJsonValue> &cwe) {
    m_cwe = cwe;
    m_cwe_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::is_cwe_Set() const{
    return m_cwe_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::is_cwe_Valid() const{
    return m_cwe_isValid;
}

QList<QJsonValue> OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::getOsvdb() const {
    return m_osvdb;
}
void OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::setOsvdb(const QList<QJsonValue> &osvdb) {
    m_osvdb = osvdb;
    m_osvdb_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::is_osvdb_Set() const{
    return m_osvdb_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::is_osvdb_Valid() const{
    return m_osvdb_isValid;
}

bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::isSet() const {
...
bool OAIGet_list_of_issues_200_response_results_inner_issue_identifiers::isValid() const {
