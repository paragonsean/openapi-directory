...
#include "OAIAggregated_project_issues_filters.h"
...
OAIAggregated_project_issues_filters::OAIAggregated_project_issues_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAggregated_project_issues_filters::OAIAggregated_project_issues_filters() {
    this->initializeModel();
}

OAIAggregated_project_issues_filters::~OAIAggregated_project_issues_filters() {}

void OAIAggregated_project_issues_filters::initializeModel() {
...
void OAIAggregated_project_issues_filters::fromJson(QString jsonString) {
...
void OAIAggregated_project_issues_filters::fromJsonObject(QJsonObject json) {
...
QString OAIAggregated_project_issues_filters::asJson() const {
...
QJsonObject OAIAggregated_project_issues_filters::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
OAIList_all_Aggregated_issues_request_filters OAIAggregated_project_issues_filters::getFilters() const {
    return m_filters;
}
void OAIAggregated_project_issues_filters::setFilters(const OAIList_all_Aggregated_issues_request_filters &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIAggregated_project_issues_filters::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIAggregated_project_issues_filters::is_filters_Valid() const{
    return m_filters_isValid;
}

bool OAIAggregated_project_issues_filters::isIncludeDescription() const {
    return m_include_description;
}
void OAIAggregated_project_issues_filters::setIncludeDescription(const bool &include_description) {
    m_include_description = include_description;
    m_include_description_isSet = true;
}

bool OAIAggregated_project_issues_filters::is_include_description_Set() const{
    return m_include_description_isSet;
}

bool OAIAggregated_project_issues_filters::is_include_description_Valid() const{
    return m_include_description_isValid;
}

bool OAIAggregated_project_issues_filters::isIncludeIntroducedThrough() const {
    return m_include_introduced_through;
}
void OAIAggregated_project_issues_filters::setIncludeIntroducedThrough(const bool &include_introduced_through) {
    m_include_introduced_through = include_introduced_through;
    m_include_introduced_through_isSet = true;
}

bool OAIAggregated_project_issues_filters::is_include_introduced_through_Set() const{
    return m_include_introduced_through_isSet;
}

bool OAIAggregated_project_issues_filters::is_include_introduced_through_Valid() const{
    return m_include_introduced_through_isValid;
}

bool OAIAggregated_project_issues_filters::isSet() const {
...
bool OAIAggregated_project_issues_filters::isValid() const {
