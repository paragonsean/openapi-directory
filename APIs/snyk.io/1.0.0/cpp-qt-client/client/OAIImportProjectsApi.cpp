...
#include "OAIImportProjectsApi.h"
...
OAIImportProjectsApi::OAIImportProjectsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIImportProjectsApi::~OAIImportProjectsApi() {
}

void OAIImportProjectsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_import_job_details", defaultConf);
    _serverIndices.insert("get_import_job_details", 0);
    _serverConfigs.insert("import_targets", defaultConf);
    _serverIndices.insert("import_targets", 0);
}
...
*/
int OAIImportProjectsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIImportProjectsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIImportProjectsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIImportProjectsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIImportProjectsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIImportProjectsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIImportProjectsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIImportProjectsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIImportProjectsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIImportProjectsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIImportProjectsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIImportProjectsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIImportProjectsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIImportProjectsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIImportProjectsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIImportProjectsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIImportProjectsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIImportProjectsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIImportProjectsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIImportProjectsApi::get_import_job_details(const QString &org_id, const QString &integration_id, const QString &job_id) {
    QString fullPath = QString(_serverConfigs["get_import_job_details"][_serverIndices.value("get_import_job_details")].URL()+"/org/{orgId}/integrations/{integrationId}/import/{jobId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImportProjectsApi::get_import_job_detailsCallback);
    connect(this, &OAIImportProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIImportProjectsApi::get_import_job_detailsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGet_import_job_details_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_import_job_detailsSignal(output);
        Q_EMIT get_import_job_detailsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_import_job_detailsSignalE(output, error_type, error_str);
        Q_EMIT get_import_job_detailsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_import_job_detailsSignalError(output, error_type, error_str);
        Q_EMIT get_import_job_detailsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIImportProjectsApi::import_targets(const QString &org_id, const QString &integration_id, const ::OpenAPI::OptionalParam<OAIImport_targets_request> &oai_import_targets_request) {
    QString fullPath = QString(_serverConfigs["import_targets"][_serverIndices.value("import_targets")].URL()+"/org/{orgId}/integrations/{integrationId}/import");
    ...
    if (oai_import_targets_request.hasValue()){

        
        QByteArray output = oai_import_targets_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIImportProjectsApi::import_targetsCallback);
    connect(this, &OAIImportProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIImportProjectsApi::import_targetsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT import_targetsSignal();
        Q_EMIT import_targetsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT import_targetsSignalE(error_type, error_str);
        Q_EMIT import_targetsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT import_targetsSignalError(error_type, error_str);
        Q_EMIT import_targetsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIImportProjectsApi::tokenAvailable(){
