...
#include "OAIAggregated_project_issues_issues_inner.h"
...
OAIAggregated_project_issues_issues_inner::OAIAggregated_project_issues_issues_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAggregated_project_issues_issues_inner::OAIAggregated_project_issues_issues_inner() {
    this->initializeModel();
}

OAIAggregated_project_issues_issues_inner::~OAIAggregated_project_issues_issues_inner() {}

void OAIAggregated_project_issues_issues_inner::initializeModel() {
...
void OAIAggregated_project_issues_issues_inner::fromJson(QString jsonString) {
...
void OAIAggregated_project_issues_issues_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAggregated_project_issues_issues_inner::asJson() const {
...
QJsonObject OAIAggregated_project_issues_issues_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_fix_info.isSet()) {
...
OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo OAIAggregated_project_issues_issues_inner::getFixInfo() const {
    return m_fix_info;
}
void OAIAggregated_project_issues_issues_inner::setFixInfo(const OAIList_all_Aggregated_issues_200_response_issues_inner_fixInfo &fix_info) {
    m_fix_info = fix_info;
    m_fix_info_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_fix_info_Set() const{
    return m_fix_info_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_fix_info_Valid() const{
    return m_fix_info_isValid;
}

QString OAIAggregated_project_issues_issues_inner::getId() const {
    return m_id;
}
void OAIAggregated_project_issues_issues_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_id_Valid() const{
    return m_id_isValid;
}

QList<QJsonValue> OAIAggregated_project_issues_issues_inner::getIgnoreReasons() const {
    return m_ignore_reasons;
}
void OAIAggregated_project_issues_issues_inner::setIgnoreReasons(const QList<QJsonValue> &ignore_reasons) {
    m_ignore_reasons = ignore_reasons;
    m_ignore_reasons_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_ignore_reasons_Set() const{
    return m_ignore_reasons_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_ignore_reasons_Valid() const{
    return m_ignore_reasons_isValid;
}

QList<QJsonValue> OAIAggregated_project_issues_issues_inner::getIntroducedThrough() const {
    return m_introduced_through;
}
void OAIAggregated_project_issues_issues_inner::setIntroducedThrough(const QList<QJsonValue> &introduced_through) {
    m_introduced_through = introduced_through;
    m_introduced_through_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_introduced_through_Set() const{
    return m_introduced_through_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_introduced_through_Valid() const{
    return m_introduced_through_isValid;
}

bool OAIAggregated_project_issues_issues_inner::isIsIgnored() const {
    return m_is_ignored;
}
void OAIAggregated_project_issues_issues_inner::setIsIgnored(const bool &is_ignored) {
    m_is_ignored = is_ignored;
    m_is_ignored_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_is_ignored_Set() const{
    return m_is_ignored_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_is_ignored_Valid() const{
    return m_is_ignored_isValid;
}

bool OAIAggregated_project_issues_issues_inner::isIsPatched() const {
    return m_is_patched;
}
void OAIAggregated_project_issues_issues_inner::setIsPatched(const bool &is_patched) {
    m_is_patched = is_patched;
    m_is_patched_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_is_patched_Set() const{
    return m_is_patched_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_is_patched_Valid() const{
    return m_is_patched_isValid;
}

OAIAggregated_project_issues_issues_inner_issueData OAIAggregated_project_issues_issues_inner::getIssueData() const {
    return m_issue_data;
}
void OAIAggregated_project_issues_issues_inner::setIssueData(const OAIAggregated_project_issues_issues_inner_issueData &issue_data) {
    m_issue_data = issue_data;
    m_issue_data_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_issue_data_Set() const{
    return m_issue_data_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_issue_data_Valid() const{
    return m_issue_data_isValid;
}

QString OAIAggregated_project_issues_issues_inner::getIssueType() const {
    return m_issue_type;
}
void OAIAggregated_project_issues_issues_inner::setIssueType(const QString &issue_type) {
    m_issue_type = issue_type;
    m_issue_type_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_issue_type_Set() const{
    return m_issue_type_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_issue_type_Valid() const{
    return m_issue_type_isValid;
}

OAIList_all_Aggregated_issues_200_response_issues_inner_links OAIAggregated_project_issues_issues_inner::getLinks() const {
    return m_links;
}
void OAIAggregated_project_issues_issues_inner::setLinks(const OAIList_all_Aggregated_issues_200_response_issues_inner_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_links_Set() const{
    return m_links_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_links_Valid() const{
    return m_links_isValid;
}

QString OAIAggregated_project_issues_issues_inner::getPkgName() const {
    return m_pkg_name;
}
void OAIAggregated_project_issues_issues_inner::setPkgName(const QString &pkg_name) {
    m_pkg_name = pkg_name;
    m_pkg_name_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_pkg_name_Set() const{
    return m_pkg_name_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_pkg_name_Valid() const{
    return m_pkg_name_isValid;
}

QList<QString> OAIAggregated_project_issues_issues_inner::getPkgVersions() const {
    return m_pkg_versions;
}
void OAIAggregated_project_issues_issues_inner::setPkgVersions(const QList<QString> &pkg_versions) {
    m_pkg_versions = pkg_versions;
    m_pkg_versions_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_pkg_versions_Set() const{
    return m_pkg_versions_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_pkg_versions_Valid() const{
    return m_pkg_versions_isValid;
}

OAIList_all_Aggregated_issues_200_response_issues_inner_priority OAIAggregated_project_issues_issues_inner::getPriority() const {
    return m_priority;
}
void OAIAggregated_project_issues_issues_inner::setPriority(const OAIList_all_Aggregated_issues_200_response_issues_inner_priority &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIAggregated_project_issues_issues_inner::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIAggregated_project_issues_issues_inner::is_priority_Valid() const{
    return m_priority_isValid;
}

bool OAIAggregated_project_issues_issues_inner::isSet() const {
...
bool OAIAggregated_project_issues_issues_inner::isValid() const {
