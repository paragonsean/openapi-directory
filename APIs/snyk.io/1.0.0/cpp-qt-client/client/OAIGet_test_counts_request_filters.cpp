...
#include "OAIGet_test_counts_request_filters.h"
...
OAIGet_test_counts_request_filters::OAIGet_test_counts_request_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_test_counts_request_filters::OAIGet_test_counts_request_filters() {
    this->initializeModel();
}

OAIGet_test_counts_request_filters::~OAIGet_test_counts_request_filters() {}

void OAIGet_test_counts_request_filters::initializeModel() {

    m_is_private_isSet = false;
    m_is_private_isValid = false;

    m_issues_prevented_isSet = false;
    m_issues_prevented_isValid = false;
...
void OAIGet_test_counts_request_filters::fromJson(QString jsonString) {
...
void OAIGet_test_counts_request_filters::fromJsonObject(QJsonObject json) {
    ...
    m_issues_prevented_isValid = ::OpenAPI::fromJsonValue(m_issues_prevented, json[QString("issuesPrevented")]);
    m_issues_prevented_isSet = !json[QString("issuesPrevented")].isNull() && m_issues_prevented_isValid;
...
QString OAIGet_test_counts_request_filters::asJson() const {
...
QJsonObject OAIGet_test_counts_request_filters::asJsonObject() const {
    QJsonObject obj;
    if (m_is_private_isSet) {
        obj.insert(QString("isPrivate"), ::OpenAPI::toJsonValue(m_is_private));
    }
    if (m_issues_prevented_isSet) {
        obj.insert(QString("issuesPrevented"), ::OpenAPI::toJsonValue(m_issues_prevented));
    }
    if (m_orgs_isSet) {
...
bool OAIGet_test_counts_request_filters::isIsPrivate() const {
    return m_is_private;
}
void OAIGet_test_counts_request_filters::setIsPrivate(const bool &is_private) {
    m_is_private = is_private;
    m_is_private_isSet = true;
}

bool OAIGet_test_counts_request_filters::is_is_private_Set() const{
    return m_is_private_isSet;
}

bool OAIGet_test_counts_request_filters::is_is_private_Valid() const{
    return m_is_private_isValid;
}

bool OAIGet_test_counts_request_filters::isIssuesPrevented() const {
    return m_issues_prevented;
}
void OAIGet_test_counts_request_filters::setIssuesPrevented(const bool &issues_prevented) {
    m_issues_prevented = issues_prevented;
    m_issues_prevented_isSet = true;
}

bool OAIGet_test_counts_request_filters::is_issues_prevented_Set() const{
    return m_issues_prevented_isSet;
}

bool OAIGet_test_counts_request_filters::is_issues_prevented_Valid() const{
    return m_issues_prevented_isValid;
}

QJsonValue OAIGet_test_counts_request_filters::getOrgs() const {
    return m_orgs;
}
void OAIGet_test_counts_request_filters::setOrgs(const QJsonValue &orgs) {
    m_orgs = orgs;
    m_orgs_isSet = true;
}

bool OAIGet_test_counts_request_filters::is_orgs_Set() const{
    return m_orgs_isSet;
}

bool OAIGet_test_counts_request_filters::is_orgs_Valid() const{
    return m_orgs_isValid;
}

QJsonValue OAIGet_test_counts_request_filters::getProjects() const {
    return m_projects;
}
void OAIGet_test_counts_request_filters::setProjects(const QJsonValue &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIGet_test_counts_request_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIGet_test_counts_request_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

bool OAIGet_test_counts_request_filters::isSet() const {
...
bool OAIGet_test_counts_request_filters::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_orgs_isValid && true;
}
