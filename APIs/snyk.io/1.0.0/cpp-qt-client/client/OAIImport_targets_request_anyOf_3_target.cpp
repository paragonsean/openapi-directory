...
#include "OAIImport_targets_request_anyOf_3_target.h"
...
OAIImport_targets_request_anyOf_3_target::OAIImport_targets_request_anyOf_3_target(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImport_targets_request_anyOf_3_target::OAIImport_targets_request_anyOf_3_target() {
    this->initializeModel();
}

OAIImport_targets_request_anyOf_3_target::~OAIImport_targets_request_anyOf_3_target() {}

void OAIImport_targets_request_anyOf_3_target::initializeModel() {
    ...
    m_repo_slug_isSet = false;
    m_repo_slug_isValid = false;
}

void OAIImport_targets_request_anyOf_3_target::fromJson(QString jsonString) {
...
void OAIImport_targets_request_anyOf_3_target::fromJsonObject(QJsonObject json) {
    ...
    m_repo_slug_isValid = ::OpenAPI::fromJsonValue(m_repo_slug, json[QString("repoSlug")]);
    m_repo_slug_isSet = !json[QString("repoSlug")].isNull() && m_repo_slug_isValid;
}

QString OAIImport_targets_request_anyOf_3_target::asJson() const {
...
QJsonObject OAIImport_targets_request_anyOf_3_target::asJsonObject() const {
    QJsonObject obj;
    if (m_branch_isSet) {
    ...
    if (m_repo_slug_isSet) {
        obj.insert(QString("repoSlug"), ::OpenAPI::toJsonValue(m_repo_slug));
    }
    return obj;
}

QString OAIImport_targets_request_anyOf_3_target::getBranch() const {
    return m_branch;
}
void OAIImport_targets_request_anyOf_3_target::setBranch(const QString &branch) {
    m_branch = branch;
    m_branch_isSet = true;
}

bool OAIImport_targets_request_anyOf_3_target::is_branch_Set() const{
    return m_branch_isSet;
}

bool OAIImport_targets_request_anyOf_3_target::is_branch_Valid() const{
    return m_branch_isValid;
}

QString OAIImport_targets_request_anyOf_3_target::getName() const {
    return m_name;
}
void OAIImport_targets_request_anyOf_3_target::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIImport_targets_request_anyOf_3_target::is_name_Set() const{
    return m_name_isSet;
}

bool OAIImport_targets_request_anyOf_3_target::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIImport_targets_request_anyOf_3_target::getProjectKey() const {
    return m_project_key;
}
void OAIImport_targets_request_anyOf_3_target::setProjectKey(const QString &project_key) {
    m_project_key = project_key;
    m_project_key_isSet = true;
}

bool OAIImport_targets_request_anyOf_3_target::is_project_key_Set() const{
    return m_project_key_isSet;
}

bool OAIImport_targets_request_anyOf_3_target::is_project_key_Valid() const{
    return m_project_key_isValid;
}

QString OAIImport_targets_request_anyOf_3_target::getRepoSlug() const {
    return m_repo_slug;
}
void OAIImport_targets_request_anyOf_3_target::setRepoSlug(const QString &repo_slug) {
    m_repo_slug = repo_slug;
    m_repo_slug_isSet = true;
}

bool OAIImport_targets_request_anyOf_3_target::is_repo_slug_Set() const{
    return m_repo_slug_isSet;
}

bool OAIImport_targets_request_anyOf_3_target::is_repo_slug_Valid() const{
    return m_repo_slug_isValid;
}

bool OAIImport_targets_request_anyOf_3_target::isSet() const {
...
bool OAIImport_targets_request_anyOf_3_target::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_project_key_isValid && m_repo_slug_isValid && true;
}
