...
#include "OAIMonitorDepGraphData.h"
...
OAIMonitorDepGraphData::OAIMonitorDepGraphData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMonitorDepGraphData::OAIMonitorDepGraphData() {
    this->initializeModel();
}

OAIMonitorDepGraphData::~OAIMonitorDepGraphData() {}

void OAIMonitorDepGraphData::initializeModel() {
...
void OAIMonitorDepGraphData::fromJson(QString jsonString) {
...
void OAIMonitorDepGraphData::fromJsonObject(QJsonObject json) {
...
QString OAIMonitorDepGraphData::asJson() const {
...
QJsonObject OAIMonitorDepGraphData::asJsonObject() const {
    QJsonObject obj;
    if (m_graph.isSet()) {
...
OAIMonitorGraph OAIMonitorDepGraphData::getGraph() const {
    return m_graph;
}
void OAIMonitorDepGraphData::setGraph(const OAIMonitorGraph &graph) {
    m_graph = graph;
    m_graph_isSet = true;
}

bool OAIMonitorDepGraphData::is_graph_Set() const{
    return m_graph_isSet;
}

bool OAIMonitorDepGraphData::is_graph_Valid() const{
    return m_graph_isValid;
}

OAIMonitorPkgManager OAIMonitorDepGraphData::getPkgManager() const {
    return m_pkg_manager;
}
void OAIMonitorDepGraphData::setPkgManager(const OAIMonitorPkgManager &pkg_manager) {
    m_pkg_manager = pkg_manager;
    m_pkg_manager_isSet = true;
}

bool OAIMonitorDepGraphData::is_pkg_manager_Set() const{
    return m_pkg_manager_isSet;
}

bool OAIMonitorDepGraphData::is_pkg_manager_Valid() const{
    return m_pkg_manager_isValid;
}

QList<QJsonValue> OAIMonitorDepGraphData::getPkgs() const {
    return m_pkgs;
}
void OAIMonitorDepGraphData::setPkgs(const QList<QJsonValue> &pkgs) {
    m_pkgs = pkgs;
    m_pkgs_isSet = true;
}

bool OAIMonitorDepGraphData::is_pkgs_Set() const{
    return m_pkgs_isSet;
}

bool OAIMonitorDepGraphData::is_pkgs_Valid() const{
    return m_pkgs_isValid;
}

QString OAIMonitorDepGraphData::getSchemaVersion() const {
    return m_schema_version;
}
void OAIMonitorDepGraphData::setSchemaVersion(const QString &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAIMonitorDepGraphData::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAIMonitorDepGraphData::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

bool OAIMonitorDepGraphData::isSet() const {
...
bool OAIMonitorDepGraphData::isValid() const {
