...
void OAIMonitorApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("monitor_Dep_Graph", defaultConf);
    _serverIndices.insert("monitor_Dep_Graph", 0);
}
...
void OAIMonitorApi::monitor_Dep_Graph(const ::OpenAPI::OptionalParam<QString> &org, const ::OpenAPI::OptionalParam<OAIMonitor_Dep_Graph_request> &oai_monitor_dep_graph_request) {
    QString fullPath = QString(_serverConfigs["monitor_Dep_Graph"][_serverIndices.value("monitor_Dep_Graph")].URL()+"/monitor/dep-graph");
    ...
    if (oai_monitor_dep_graph_request.hasValue()){

        
        QByteArray output = oai_monitor_dep_graph_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMonitorApi::monitor_Dep_GraphCallback);
...
void OAIMonitorApi::monitor_Dep_GraphCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT monitor_Dep_GraphSignal();
        Q_EMIT monitor_Dep_GraphSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT monitor_Dep_GraphSignalE(error_type, error_str);
        Q_EMIT monitor_Dep_GraphSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT monitor_Dep_GraphSignalError(error_type, error_str);
        Q_EMIT monitor_Dep_GraphSignalErrorFull(worker, error_type, error_str);
    }
}
