...
#include "OAIGet_organization_level_audit_logs_request_filters.h"
...
OAIGet_organization_level_audit_logs_request_filters::OAIGet_organization_level_audit_logs_request_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_organization_level_audit_logs_request_filters::OAIGet_organization_level_audit_logs_request_filters() {
    this->initializeModel();
}

OAIGet_organization_level_audit_logs_request_filters::~OAIGet_organization_level_audit_logs_request_filters() {}

void OAIGet_organization_level_audit_logs_request_filters::initializeModel() {
    ...
    m_exclude_event_isSet = false;
    m_exclude_event_isValid = false;
...
void OAIGet_organization_level_audit_logs_request_filters::fromJson(QString jsonString) {
...
void OAIGet_organization_level_audit_logs_request_filters::fromJsonObject(QJsonObject json) {
    ...
    m_exclude_event_isValid = ::OpenAPI::fromJsonValue(m_exclude_event, json[QString("excludeEvent")]);
    m_exclude_event_isSet = !json[QString("excludeEvent")].isNull() && m_exclude_event_isValid;
...
QString OAIGet_organization_level_audit_logs_request_filters::asJson() const {
...
QJsonObject OAIGet_organization_level_audit_logs_request_filters::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
    ...
    if (m_exclude_event_isSet) {
        obj.insert(QString("excludeEvent"), ::OpenAPI::toJsonValue(m_exclude_event));
    }
...
QString OAIGet_organization_level_audit_logs_request_filters::getEmail() const {
    return m_email;
}
void OAIGet_organization_level_audit_logs_request_filters::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_email_Set() const{
    return m_email_isSet;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIGet_organization_level_audit_logs_request_filters::getEvent() const {
    return m_event;
}
void OAIGet_organization_level_audit_logs_request_filters::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_event_Set() const{
    return m_event_isSet;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_event_Valid() const{
    return m_event_isValid;
}

QString OAIGet_organization_level_audit_logs_request_filters::getExcludeEvent() const {
    return m_exclude_event;
}
void OAIGet_organization_level_audit_logs_request_filters::setExcludeEvent(const QString &exclude_event) {
    m_exclude_event = exclude_event;
    m_exclude_event_isSet = true;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_exclude_event_Set() const{
    return m_exclude_event_isSet;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_exclude_event_Valid() const{
    return m_exclude_event_isValid;
}

QString OAIGet_organization_level_audit_logs_request_filters::getProjectId() const {
    return m_project_id;
}
void OAIGet_organization_level_audit_logs_request_filters::setProjectId(const QString &project_id) {
    m_project_id = project_id;
    m_project_id_isSet = true;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_project_id_Set() const{
    return m_project_id_isSet;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_project_id_Valid() const{
    return m_project_id_isValid;
}

QString OAIGet_organization_level_audit_logs_request_filters::getUserId() const {
    return m_user_id;
}
void OAIGet_organization_level_audit_logs_request_filters::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIGet_organization_level_audit_logs_request_filters::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIGet_organization_level_audit_logs_request_filters::isSet() const {
...
bool OAIGet_organization_level_audit_logs_request_filters::isValid() const {
