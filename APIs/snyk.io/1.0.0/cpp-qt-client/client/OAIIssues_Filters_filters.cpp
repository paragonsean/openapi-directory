...
#include "OAIIssues_Filters_filters.h"
...
OAIIssues_Filters_filters::OAIIssues_Filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIssues_Filters_filters::OAIIssues_Filters_filters() {
    this->initializeModel();
}

OAIIssues_Filters_filters::~OAIIssues_Filters_filters() {}

void OAIIssues_Filters_filters::initializeModel() {

    m_exploit_maturity_isSet = false;
    m_exploit_maturity_isValid = false;

    m_fixable_isSet = false;
    m_fixable_isValid = false;
    ...
    m_is_fixed_isSet = false;
    m_is_fixed_isValid = false;
...
void OAIIssues_Filters_filters::fromJson(QString jsonString) {
...
void OAIIssues_Filters_filters::fromJsonObject(QJsonObject json) {
    ...
    m_fixable_isValid = ::OpenAPI::fromJsonValue(m_fixable, json[QString("fixable")]);
    m_fixable_isSet = !json[QString("fixable")].isNull() && m_fixable_isValid;
    ...
    m_is_fixed_isValid = ::OpenAPI::fromJsonValue(m_is_fixed, json[QString("isFixed")]);
    m_is_fixed_isSet = !json[QString("isFixed")].isNull() && m_is_fixed_isValid;
...
QString OAIIssues_Filters_filters::asJson() const {
...
QJsonObject OAIIssues_Filters_filters::asJsonObject() const {
    QJsonObject obj;
    if (m_exploit_maturity.size() > 0) {
        obj.insert(QString("exploitMaturity"), ::OpenAPI::toJsonValue(m_exploit_maturity));
    }
    if (m_fixable_isSet) {
        obj.insert(QString("fixable"), ::OpenAPI::toJsonValue(m_fixable));
    }
    ...
    if (m_is_fixed_isSet) {
        obj.insert(QString("isFixed"), ::OpenAPI::toJsonValue(m_is_fixed));
    }
...
QList<QJsonValue> OAIIssues_Filters_filters::getExploitMaturity() const {
    return m_exploit_maturity;
}
void OAIIssues_Filters_filters::setExploitMaturity(const QList<QJsonValue> &exploit_maturity) {
    m_exploit_maturity = exploit_maturity;
    m_exploit_maturity_isSet = true;
}

bool OAIIssues_Filters_filters::is_exploit_maturity_Set() const{
    return m_exploit_maturity_isSet;
}

bool OAIIssues_Filters_filters::is_exploit_maturity_Valid() const{
    return m_exploit_maturity_isValid;
}

bool OAIIssues_Filters_filters::isFixable() const {
    return m_fixable;
}
void OAIIssues_Filters_filters::setFixable(const bool &fixable) {
    m_fixable = fixable;
    m_fixable_isSet = true;
}

bool OAIIssues_Filters_filters::is_fixable_Set() const{
    return m_fixable_isSet;
}

bool OAIIssues_Filters_filters::is_fixable_Valid() const{
    return m_fixable_isValid;
}

QString OAIIssues_Filters_filters::getIdentifier() const {
    return m_identifier;
}
void OAIIssues_Filters_filters::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIIssues_Filters_filters::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIIssues_Filters_filters::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIIssues_Filters_filters::isIgnored() const {
    return m_ignored;
}
void OAIIssues_Filters_filters::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIIssues_Filters_filters::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIIssues_Filters_filters::is_ignored_Valid() const{
    return m_ignored_isValid;
}

bool OAIIssues_Filters_filters::isIsFixed() const {
    return m_is_fixed;
}
void OAIIssues_Filters_filters::setIsFixed(const bool &is_fixed) {
    m_is_fixed = is_fixed;
    m_is_fixed_isSet = true;
}

bool OAIIssues_Filters_filters::is_is_fixed_Set() const{
    return m_is_fixed_isSet;
}

bool OAIIssues_Filters_filters::is_is_fixed_Valid() const{
    return m_is_fixed_isValid;
}

bool OAIIssues_Filters_filters::isIsPatchable() const {
    return m_is_patchable;
}
void OAIIssues_Filters_filters::setIsPatchable(const bool &is_patchable) {
    m_is_patchable = is_patchable;
    m_is_patchable_isSet = true;
}

bool OAIIssues_Filters_filters::is_is_patchable_Set() const{
    return m_is_patchable_isSet;
}

bool OAIIssues_Filters_filters::is_is_patchable_Valid() const{
    return m_is_patchable_isValid;
}

bool OAIIssues_Filters_filters::isIsPinnable() const {
    return m_is_pinnable;
}
void OAIIssues_Filters_filters::setIsPinnable(const bool &is_pinnable) {
    m_is_pinnable = is_pinnable;
    m_is_pinnable_isSet = true;
}

bool OAIIssues_Filters_filters::is_is_pinnable_Set() const{
    return m_is_pinnable_isSet;
}

bool OAIIssues_Filters_filters::is_is_pinnable_Valid() const{
    return m_is_pinnable_isValid;
}

bool OAIIssues_Filters_filters::isIsUpgradable() const {
    return m_is_upgradable;
}
void OAIIssues_Filters_filters::setIsUpgradable(const bool &is_upgradable) {
    m_is_upgradable = is_upgradable;
    m_is_upgradable_isSet = true;
}

bool OAIIssues_Filters_filters::is_is_upgradable_Set() const{
    return m_is_upgradable_isSet;
}

bool OAIIssues_Filters_filters::is_is_upgradable_Valid() const{
    return m_is_upgradable_isValid;
}

QList<QJsonValue> OAIIssues_Filters_filters::getIssues() const {
    return m_issues;
}
void OAIIssues_Filters_filters::setIssues(const QList<QJsonValue> &issues) {
    m_issues = issues;
    m_issues_isSet = true;
}

bool OAIIssues_Filters_filters::is_issues_Set() const{
    return m_issues_isSet;
}

bool OAIIssues_Filters_filters::is_issues_Valid() const{
    return m_issues_isValid;
}

QList<QJsonValue> OAIIssues_Filters_filters::getLanguages() const {
    return m_languages;
}
void OAIIssues_Filters_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIIssues_Filters_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIIssues_Filters_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QList<QJsonValue> OAIIssues_Filters_filters::getOrgs() const {
    return m_orgs;
}
void OAIIssues_Filters_filters::setOrgs(const QList<QJsonValue> &orgs) {
    m_orgs = orgs;
    m_orgs_isSet = true;
}

bool OAIIssues_Filters_filters::is_orgs_Set() const{
    return m_orgs_isSet;
}

bool OAIIssues_Filters_filters::is_orgs_Valid() const{
    return m_orgs_isValid;
}

bool OAIIssues_Filters_filters::isPatched() const {
    return m_patched;
}
void OAIIssues_Filters_filters::setPatched(const bool &patched) {
    m_patched = patched;
    m_patched_isSet = true;
}

bool OAIIssues_Filters_filters::is_patched_Set() const{
    return m_patched_isSet;
}

bool OAIIssues_Filters_filters::is_patched_Valid() const{
    return m_patched_isValid;
}

OAIPriorityScore OAIIssues_Filters_filters::getPriorityScore() const {
    return m_priority_score;
}
void OAIIssues_Filters_filters::setPriorityScore(const OAIPriorityScore &priority_score) {
    m_priority_score = priority_score;
    m_priority_score_isSet = true;
}

bool OAIIssues_Filters_filters::is_priority_score_Set() const{
    return m_priority_score_isSet;
}

bool OAIIssues_Filters_filters::is_priority_score_Valid() const{
    return m_priority_score_isValid;
}

QList<QJsonValue> OAIIssues_Filters_filters::getProjects() const {
    return m_projects;
}
void OAIIssues_Filters_filters::setProjects(const QList<QJsonValue> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIIssues_Filters_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIIssues_Filters_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

QList<QJsonValue> OAIIssues_Filters_filters::getSeverity() const {
    return m_severity;
}
void OAIIssues_Filters_filters::setSeverity(const QList<QJsonValue> &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIIssues_Filters_filters::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIIssues_Filters_filters::is_severity_Valid() const{
    return m_severity_isValid;
}

QList<QJsonValue> OAIIssues_Filters_filters::getTypes() const {
    return m_types;
}
void OAIIssues_Filters_filters::setTypes(const QList<QJsonValue> &types) {
    m_types = types;
    m_types_isSet = true;
}

bool OAIIssues_Filters_filters::is_types_Set() const{
    return m_types_isSet;
}

bool OAIIssues_Filters_filters::is_types_Valid() const{
    return m_types_isValid;
}

bool OAIIssues_Filters_filters::isSet() const {
...
bool OAIIssues_Filters_filters::isValid() const {
