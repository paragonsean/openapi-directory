...
OAIDepGraphData::OAIDepGraphData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepGraphData::OAIDepGraphData() {
    this->initializeModel();
}

OAIDepGraphData::~OAIDepGraphData() {}

void OAIDepGraphData::initializeModel() {
...
void OAIDepGraphData::fromJson(QString jsonString) {
...
void OAIDepGraphData::fromJsonObject(QJsonObject json) {
...
QString OAIDepGraphData::asJson() const {
...
QJsonObject OAIDepGraphData::asJsonObject() const {
    QJsonObject obj;
    if (m_graph.isSet()) {
...
OAIGraph OAIDepGraphData::getGraph() const {
    return m_graph;
}
void OAIDepGraphData::setGraph(const OAIGraph &graph) {
    m_graph = graph;
    m_graph_isSet = true;
}

bool OAIDepGraphData::is_graph_Set() const{
    return m_graph_isSet;
}

bool OAIDepGraphData::is_graph_Valid() const{
    return m_graph_isValid;
}

OAIPkgManager OAIDepGraphData::getPkgManager() const {
    return m_pkg_manager;
}
void OAIDepGraphData::setPkgManager(const OAIPkgManager &pkg_manager) {
    m_pkg_manager = pkg_manager;
    m_pkg_manager_isSet = true;
}

bool OAIDepGraphData::is_pkg_manager_Set() const{
    return m_pkg_manager_isSet;
}

bool OAIDepGraphData::is_pkg_manager_Valid() const{
    return m_pkg_manager_isValid;
}

QList<QJsonValue> OAIDepGraphData::getPkgs() const {
    return m_pkgs;
}
void OAIDepGraphData::setPkgs(const QList<QJsonValue> &pkgs) {
    m_pkgs = pkgs;
    m_pkgs_isSet = true;
}

bool OAIDepGraphData::is_pkgs_Set() const{
    return m_pkgs_isSet;
}

bool OAIDepGraphData::is_pkgs_Valid() const{
    return m_pkgs_isValid;
}

QString OAIDepGraphData::getSchemaVersion() const {
    return m_schema_version;
}
void OAIDepGraphData::setSchemaVersion(const QString &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAIDepGraphData::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAIDepGraphData::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

bool OAIDepGraphData::isSet() const {
...
bool OAIDepGraphData::isValid() const {
