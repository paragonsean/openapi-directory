...
#include "OAIGet_issue_counts_200_response_results_inner.h"
...
OAIGet_issue_counts_200_response_results_inner::OAIGet_issue_counts_200_response_results_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_issue_counts_200_response_results_inner::OAIGet_issue_counts_200_response_results_inner() {
    this->initializeModel();
}

OAIGet_issue_counts_200_response_results_inner::~OAIGet_issue_counts_200_response_results_inner() {}

void OAIGet_issue_counts_200_response_results_inner::initializeModel() {
...
void OAIGet_issue_counts_200_response_results_inner::fromJson(QString jsonString) {
...
void OAIGet_issue_counts_200_response_results_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGet_issue_counts_200_response_results_inner::asJson() const {
...
QJsonObject OAIGet_issue_counts_200_response_results_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
double OAIGet_issue_counts_200_response_results_inner::getCount() const {
    return m_count;
}
void OAIGet_issue_counts_200_response_results_inner::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner::is_count_Set() const{
    return m_count_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIGet_issue_counts_200_response_results_inner::getDay() const {
    return m_day;
}
void OAIGet_issue_counts_200_response_results_inner::setDay(const QString &day) {
    m_day = day;
    m_day_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner::is_day_Set() const{
    return m_day_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner::is_day_Valid() const{
    return m_day_isValid;
}

OAIGet_issue_counts_200_response_results_inner_fixable OAIGet_issue_counts_200_response_results_inner::getFixable() const {
    return m_fixable;
}
void OAIGet_issue_counts_200_response_results_inner::setFixable(const OAIGet_issue_counts_200_response_results_inner_fixable &fixable) {
    m_fixable = fixable;
    m_fixable_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner::is_fixable_Set() const{
    return m_fixable_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner::is_fixable_Valid() const{
    return m_fixable_isValid;
}

OAIGet_issue_counts_200_response_results_inner_severity OAIGet_issue_counts_200_response_results_inner::getSeverity() const {
    return m_severity;
}
void OAIGet_issue_counts_200_response_results_inner::setSeverity(const OAIGet_issue_counts_200_response_results_inner_severity &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner::is_severity_Valid() const{
    return m_severity_isValid;
}

bool OAIGet_issue_counts_200_response_results_inner::isSet() const {
...
bool OAIGet_issue_counts_200_response_results_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_count_isValid && m_day_isValid && true;
}
