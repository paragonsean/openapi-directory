...
/*
 * OAIList_all_dependencies_200_response_results_inner.h
 *
 * 
 */

#ifndef OAIList_all_dependencies_200_response_results_inner_H
#define OAIList_all_dependencies_200_response_results_inner_H

#include <QJsonObject>

#include "OAIList_all_dependencies_200_response_results_inner_licenses_inner.h"
#include "OAIList_all_dependencies_200_response_results_inner_projects_inner.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIList_all_dependencies_200_response_results_inner_licenses_inner;
class OAIList_all_dependencies_200_response_results_inner_projects_inner;

class OAIList_all_dependencies_200_response_results_inner : public OAIObject {
public:
    OAIList_all_dependencies_200_response_results_inner();
    OAIList_all_dependencies_200_response_results_inner(QString json);
    ~OAIList_all_dependencies_200_response_results_inner() override;
    ...
    QList<QJsonValue> getCopyright() const;
    void setCopyright(const QList<QJsonValue> &copyright);
    bool is_copyright_Set() const;
    bool is_copyright_Valid() const;

    QList<QJsonValue> getDependenciesWithIssues() const;
    void setDependenciesWithIssues(const QList<QJsonValue> &dependencies_with_issues);
    bool is_dependencies_with_issues_Set() const;
    bool is_dependencies_with_issues_Valid() const;

    QList<QJsonValue> getDeprecatedVersions() const;
    void setDeprecatedVersions(const QList<QJsonValue> &deprecated_versions);
    bool is_deprecated_versions_Set() const;
    bool is_deprecated_versions_Valid() const;
    ...
    double getIssuesCritical() const;
    void setIssuesCritical(const double &issues_critical);
    bool is_issues_critical_Set() const;
    bool is_issues_critical_Valid() const;

    double getIssuesHigh() const;
    void setIssuesHigh(const double &issues_high);
    bool is_issues_high_Set() const;
    bool is_issues_high_Valid() const;

    double getIssuesLow() const;
    void setIssuesLow(const double &issues_low);
    bool is_issues_low_Set() const;
    bool is_issues_low_Valid() const;

    double getIssuesMedium() const;
    void setIssuesMedium(const double &issues_medium);
    bool is_issues_medium_Set() const;
    bool is_issues_medium_Valid() const;
    ...
    QString getLatestVersionPublishedDate() const;
    void setLatestVersionPublishedDate(const QString &latest_version_published_date);
    bool is_latest_version_published_date_Set() const;
    bool is_latest_version_published_date_Valid() const;

    QList<OAIList_all_dependencies_200_response_results_inner_licenses_inner> getLicenses() const;
    void setLicenses(const QList<OAIList_all_dependencies_200_response_results_inner_licenses_inner> &licenses);
    ...
    QList<OAIList_all_dependencies_200_response_results_inner_projects_inner> getProjects() const;
    void setProjects(const QList<OAIList_all_dependencies_200_response_results_inner_projects_inner> &projects);
...
private:
    ...
    QList<QJsonValue> m_copyright;
    bool m_copyright_isSet;
    bool m_copyright_isValid;

    QList<QJsonValue> m_dependencies_with_issues;
    bool m_dependencies_with_issues_isSet;
    bool m_dependencies_with_issues_isValid;

    QList<QJsonValue> m_deprecated_versions;
    bool m_deprecated_versions_isSet;
    bool m_deprecated_versions_isValid;
    ...
    double m_issues_critical;
    bool m_issues_critical_isSet;
    bool m_issues_critical_isValid;

    double m_issues_high;
    bool m_issues_high_isSet;
    bool m_issues_high_isValid;

    double m_issues_low;
    bool m_issues_low_isSet;
    bool m_issues_low_isValid;

    double m_issues_medium;
    bool m_issues_medium_isSet;
    bool m_issues_medium_isValid;

    QString m_latest_version;
    bool m_latest_version_isSet;
    bool m_latest_version_isValid;

    QString m_latest_version_published_date;
    bool m_latest_version_published_date_isSet;
    bool m_latest_version_published_date_isValid;

    QList<OAIList_all_dependencies_200_response_results_inner_licenses_inner> m_licenses;
    ...
    QList<OAIList_all_dependencies_200_response_results_inner_projects_inner> m_projects;
...
Q_DECLARE_METATYPE(OpenAPI::OAIList_all_dependencies_200_response_results_inner)

#endif // OAIList_all_dependencies_200_response_results_inner_H
