...
#include "OAIList_all_Aggregated_issues_request_filters.h"
...
OAIList_all_Aggregated_issues_request_filters::OAIList_all_Aggregated_issues_request_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_Aggregated_issues_request_filters::OAIList_all_Aggregated_issues_request_filters() {
    this->initializeModel();
}

OAIList_all_Aggregated_issues_request_filters::~OAIList_all_Aggregated_issues_request_filters() {}

void OAIList_all_Aggregated_issues_request_filters::initializeModel() {
    ...
    m_patched_isSet = false;
    m_patched_isValid = false;
...
void OAIList_all_Aggregated_issues_request_filters::fromJson(QString jsonString) {
...
void OAIList_all_Aggregated_issues_request_filters::fromJsonObject(QJsonObject json) {
    ...
    m_patched_isValid = ::OpenAPI::fromJsonValue(m_patched, json[QString("patched")]);
    m_patched_isSet = !json[QString("patched")].isNull() && m_patched_isValid;
...
QString OAIList_all_Aggregated_issues_request_filters::asJson() const {
...
QJsonObject OAIList_all_Aggregated_issues_request_filters::asJsonObject() const {
    QJsonObject obj;
    if (m_exploit_maturity.size() > 0) {
    ...
    if (m_patched_isSet) {
        obj.insert(QString("patched"), ::OpenAPI::toJsonValue(m_patched));
    }
    if (m_priority.isSet()) {
...
QList<QJsonValue> OAIList_all_Aggregated_issues_request_filters::getExploitMaturity() const {
    return m_exploit_maturity;
}
void OAIList_all_Aggregated_issues_request_filters::setExploitMaturity(const QList<QJsonValue> &exploit_maturity) {
    m_exploit_maturity = exploit_maturity;
    m_exploit_maturity_isSet = true;
}

bool OAIList_all_Aggregated_issues_request_filters::is_exploit_maturity_Set() const{
    return m_exploit_maturity_isSet;
}

bool OAIList_all_Aggregated_issues_request_filters::is_exploit_maturity_Valid() const{
    return m_exploit_maturity_isValid;
}

bool OAIList_all_Aggregated_issues_request_filters::isIgnored() const {
    return m_ignored;
}
void OAIList_all_Aggregated_issues_request_filters::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIList_all_Aggregated_issues_request_filters::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIList_all_Aggregated_issues_request_filters::is_ignored_Valid() const{
    return m_ignored_isValid;
}

bool OAIList_all_Aggregated_issues_request_filters::isPatched() const {
    return m_patched;
}
void OAIList_all_Aggregated_issues_request_filters::setPatched(const bool &patched) {
    m_patched = patched;
    m_patched_isSet = true;
}

bool OAIList_all_Aggregated_issues_request_filters::is_patched_Set() const{
    return m_patched_isSet;
}

bool OAIList_all_Aggregated_issues_request_filters::is_patched_Valid() const{
    return m_patched_isValid;
}

OAIList_all_Aggregated_issues_request_filters_priority OAIList_all_Aggregated_issues_request_filters::getPriority() const {
    return m_priority;
}
void OAIList_all_Aggregated_issues_request_filters::setPriority(const OAIList_all_Aggregated_issues_request_filters_priority &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIList_all_Aggregated_issues_request_filters::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIList_all_Aggregated_issues_request_filters::is_priority_Valid() const{
    return m_priority_isValid;
}

QList<QJsonValue> OAIList_all_Aggregated_issues_request_filters::getSeverities() const {
    return m_severities;
}
void OAIList_all_Aggregated_issues_request_filters::setSeverities(const QList<QJsonValue> &severities) {
    m_severities = severities;
    m_severities_isSet = true;
}

bool OAIList_all_Aggregated_issues_request_filters::is_severities_Set() const{
    return m_severities_isSet;
}

bool OAIList_all_Aggregated_issues_request_filters::is_severities_Valid() const{
    return m_severities_isValid;
}

QList<QJsonValue> OAIList_all_Aggregated_issues_request_filters::getTypes() const {
    return m_types;
}
void OAIList_all_Aggregated_issues_request_filters::setTypes(const QList<QJsonValue> &types) {
    m_types = types;
    m_types_isSet = true;
}

bool OAIList_all_Aggregated_issues_request_filters::is_types_Set() const{
    return m_types_isSet;
}

bool OAIList_all_Aggregated_issues_request_filters::is_types_Valid() const{
    return m_types_isValid;
}

bool OAIList_all_Aggregated_issues_request_filters::isSet() const {
...
bool OAIList_all_Aggregated_issues_request_filters::isValid() const {
