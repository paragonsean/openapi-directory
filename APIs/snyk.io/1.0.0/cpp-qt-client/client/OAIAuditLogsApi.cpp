...
void OAIAuditLogsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_group_level_audit_logs", defaultConf);
    _serverIndices.insert("get_group_level_audit_logs", 0);
    _serverConfigs.insert("get_organization_level_audit_logs", defaultConf);
    _serverIndices.insert("get_organization_level_audit_logs", 0);
}
...
void OAIAuditLogsApi::get_group_level_audit_logs(const QString &group_id, const ::OpenAPI::OptionalParam<QString> &from, const ::OpenAPI::OptionalParam<QString> &to, const ::OpenAPI::OptionalParam<double> &page, const ::OpenAPI::OptionalParam<QString> &sort_order, const ::OpenAPI::OptionalParam<OAIGet_group_level_audit_logs_request> &oai_get_group_level_audit_logs_request) {
    QString fullPath = QString(_serverConfigs["get_group_level_audit_logs"][_serverIndices.value("get_group_level_audit_logs")].URL()+"/group/{groupId}/audit");
    ...
    if (oai_get_group_level_audit_logs_request.hasValue()){

        
        QByteArray output = oai_get_group_level_audit_logs_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuditLogsApi::get_group_level_audit_logsCallback);
...
void OAIAuditLogsApi::get_group_level_audit_logsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_group_level_audit_logsSignal();
        Q_EMIT get_group_level_audit_logsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_group_level_audit_logsSignalE(error_type, error_str);
        Q_EMIT get_group_level_audit_logsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_group_level_audit_logsSignalError(error_type, error_str);
        Q_EMIT get_group_level_audit_logsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuditLogsApi::get_organization_level_audit_logs(const QString &org_id, const ::OpenAPI::OptionalParam<QString> &from, const ::OpenAPI::OptionalParam<QString> &to, const ::OpenAPI::OptionalParam<double> &page, const ::OpenAPI::OptionalParam<QString> &sort_order, const ::OpenAPI::OptionalParam<OAIGet_organization_level_audit_logs_request> &oai_get_organization_level_audit_logs_request) {
    QString fullPath = QString(_serverConfigs["get_organization_level_audit_logs"][_serverIndices.value("get_organization_level_audit_logs")].URL()+"/org/{orgId}/audit");
    ...
    if (oai_get_organization_level_audit_logs_request.hasValue()){

        
        QByteArray output = oai_get_organization_level_audit_logs_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuditLogsApi::get_organization_level_audit_logsCallback);
    connect(this, &OAIAuditLogsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAuditLogsApi::get_organization_level_audit_logsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_organization_level_audit_logsSignal();
        Q_EMIT get_organization_level_audit_logsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_organization_level_audit_logsSignalE(error_type, error_str);
        Q_EMIT get_organization_level_audit_logsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_organization_level_audit_logsSignalError(error_type, error_str);
        Q_EMIT get_organization_level_audit_logsSignalErrorFull(worker, error_type, error_str);
    }
}
