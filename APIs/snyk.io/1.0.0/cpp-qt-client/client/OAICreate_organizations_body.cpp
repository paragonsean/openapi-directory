...
#include "OAICreate_organizations_body.h"
...
OAICreate_organizations_body::OAICreate_organizations_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreate_organizations_body::OAICreate_organizations_body() {
    this->initializeModel();
}

OAICreate_organizations_body::~OAICreate_organizations_body() {}

void OAICreate_organizations_body::initializeModel() {
    ...
    m_source_org_id_isSet = false;
    m_source_org_id_isValid = false;
}

void OAICreate_organizations_body::fromJson(QString jsonString) {
...
void OAICreate_organizations_body::fromJsonObject(QJsonObject json) {
    ...
    m_source_org_id_isValid = ::OpenAPI::fromJsonValue(m_source_org_id, json[QString("sourceOrgId")]);
    m_source_org_id_isSet = !json[QString("sourceOrgId")].isNull() && m_source_org_id_isValid;
}

QString OAICreate_organizations_body::asJson() const {
...
QJsonObject OAICreate_organizations_body::asJsonObject() const {
    QJsonObject obj;
    if (m_group_id_isSet) {
    ...
    if (m_source_org_id_isSet) {
        obj.insert(QString("sourceOrgId"), ::OpenAPI::toJsonValue(m_source_org_id));
    }
    return obj;
}

QString OAICreate_organizations_body::getGroupId() const {
    return m_group_id;
}
void OAICreate_organizations_body::setGroupId(const QString &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAICreate_organizations_body::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAICreate_organizations_body::is_group_id_Valid() const{
    return m_group_id_isValid;
}

QString OAICreate_organizations_body::getName() const {
    return m_name;
}
void OAICreate_organizations_body::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreate_organizations_body::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreate_organizations_body::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreate_organizations_body::getSourceOrgId() const {
    return m_source_org_id;
}
void OAICreate_organizations_body::setSourceOrgId(const QString &source_org_id) {
    m_source_org_id = source_org_id;
    m_source_org_id_isSet = true;
}

bool OAICreate_organizations_body::is_source_org_id_Set() const{
    return m_source_org_id_isSet;
}

bool OAICreate_organizations_body::is_source_org_id_Valid() const{
    return m_source_org_id_isValid;
}

bool OAICreate_organizations_body::isSet() const {
...
bool OAICreate_organizations_body::isValid() const {
