...
OAICreate_a_new_organization_request::OAICreate_a_new_organization_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreate_a_new_organization_request::OAICreate_a_new_organization_request() {
    this->initializeModel();
}

OAICreate_a_new_organization_request::~OAICreate_a_new_organization_request() {}

void OAICreate_a_new_organization_request::initializeModel() {
...
void OAICreate_a_new_organization_request::fromJson(QString jsonString) {
...
void OAICreate_a_new_organization_request::fromJsonObject(QJsonObject json) {
...
QString OAICreate_a_new_organization_request::asJson() const {
...
QJsonObject OAICreate_a_new_organization_request::asJsonObject() const {
    QJsonObject obj;
    if (m_group_id_isSet) {
...
QString OAICreate_a_new_organization_request::getGroupId() const {
    return m_group_id;
}
void OAICreate_a_new_organization_request::setGroupId(const QString &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAICreate_a_new_organization_request::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAICreate_a_new_organization_request::is_group_id_Valid() const{
    return m_group_id_isValid;
}

QString OAICreate_a_new_organization_request::getName() const {
    return m_name;
}
void OAICreate_a_new_organization_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreate_a_new_organization_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreate_a_new_organization_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreate_a_new_organization_request::getSourceOrgId() const {
    return m_source_org_id;
}
void OAICreate_a_new_organization_request::setSourceOrgId(const QString &source_org_id) {
    m_source_org_id = source_org_id;
    m_source_org_id_isSet = true;
}

bool OAICreate_a_new_organization_request::is_source_org_id_Set() const{
    return m_source_org_id_isSet;
}

bool OAICreate_a_new_organization_request::is_source_org_id_Valid() const{
    return m_source_org_id_isValid;
}

bool OAICreate_a_new_organization_request::isSet() const {
...
bool OAICreate_a_new_organization_request::isValid() const {
