...
#include "OAIGet_test_counts_200_response_results_inner.h"
...
OAIGet_test_counts_200_response_results_inner::OAIGet_test_counts_200_response_results_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_test_counts_200_response_results_inner::OAIGet_test_counts_200_response_results_inner() {
    this->initializeModel();
}

OAIGet_test_counts_200_response_results_inner::~OAIGet_test_counts_200_response_results_inner() {}

void OAIGet_test_counts_200_response_results_inner::initializeModel() {
...
void OAIGet_test_counts_200_response_results_inner::fromJson(QString jsonString) {
...
void OAIGet_test_counts_200_response_results_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGet_test_counts_200_response_results_inner::asJson() const {
...
QJsonObject OAIGet_test_counts_200_response_results_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
        obj.insert(QString("count"), ::OpenAPI::toJsonValue(m_count));
    }
    if (m_is_private.isSet()) {
        obj.insert(QString("isPrivate"), ::OpenAPI::toJsonValue(m_is_private));
    }
    if (m_issues_prevented.isSet()) {
        obj.insert(QString("issuesPrevented"), ::OpenAPI::toJsonValue(m_issues_prevented));
    }
    return obj;
}

double OAIGet_test_counts_200_response_results_inner::getCount() const {
    return m_count;
}
void OAIGet_test_counts_200_response_results_inner::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIGet_test_counts_200_response_results_inner::is_count_Set() const{
    return m_count_isSet;
}

bool OAIGet_test_counts_200_response_results_inner::is_count_Valid() const{
    return m_count_isValid;
}

OAIGet_test_counts_200_response_results_inner_isPrivate OAIGet_test_counts_200_response_results_inner::getIsPrivate() const {
    return m_is_private;
}
void OAIGet_test_counts_200_response_results_inner::setIsPrivate(const OAIGet_test_counts_200_response_results_inner_isPrivate &is_private) {
    m_is_private = is_private;
    m_is_private_isSet = true;
}

bool OAIGet_test_counts_200_response_results_inner::is_is_private_Set() const{
    return m_is_private_isSet;
}

bool OAIGet_test_counts_200_response_results_inner::is_is_private_Valid() const{
    return m_is_private_isValid;
}

OAIGet_test_counts_200_response_results_inner_issuesPrevented OAIGet_test_counts_200_response_results_inner::getIssuesPrevented() const {
    return m_issues_prevented;
}
void OAIGet_test_counts_200_response_results_inner::setIssuesPrevented(const OAIGet_test_counts_200_response_results_inner_issuesPrevented &issues_prevented) {
    m_issues_prevented = issues_prevented;
    m_issues_prevented_isSet = true;
}

bool OAIGet_test_counts_200_response_results_inner::is_issues_prevented_Set() const{
    return m_issues_prevented_isSet;
}

bool OAIGet_test_counts_200_response_results_inner::is_issues_prevented_Valid() const{
    return m_issues_prevented_isValid;
}

bool OAIGet_test_counts_200_response_results_inner::isSet() const {
...
bool OAIGet_test_counts_200_response_results_inner::isValid() const {
