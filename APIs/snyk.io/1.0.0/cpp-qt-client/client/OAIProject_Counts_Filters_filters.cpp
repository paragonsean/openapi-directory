...
#include "OAIProject_Counts_Filters_filters.h"
...
OAIProject_Counts_Filters_filters::OAIProject_Counts_Filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProject_Counts_Filters_filters::OAIProject_Counts_Filters_filters() {
    this->initializeModel();
}

OAIProject_Counts_Filters_filters::~OAIProject_Counts_Filters_filters() {}

void OAIProject_Counts_Filters_filters::initializeModel() {
...
void OAIProject_Counts_Filters_filters::fromJson(QString jsonString) {
...
void OAIProject_Counts_Filters_filters::fromJsonObject(QJsonObject json) {
...
QString OAIProject_Counts_Filters_filters::asJson() const {
...
QJsonObject OAIProject_Counts_Filters_filters::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIProject_Counts_Filters_filters::getLanguages() const {
    return m_languages;
}
void OAIProject_Counts_Filters_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIProject_Counts_Filters_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIProject_Counts_Filters_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QList<QJsonValue> OAIProject_Counts_Filters_filters::getOrgs() const {
    return m_orgs;
}
void OAIProject_Counts_Filters_filters::setOrgs(const QList<QJsonValue> &orgs) {
    m_orgs = orgs;
    m_orgs_isSet = true;
}

bool OAIProject_Counts_Filters_filters::is_orgs_Set() const{
    return m_orgs_isSet;
}

bool OAIProject_Counts_Filters_filters::is_orgs_Valid() const{
    return m_orgs_isValid;
}

QList<QJsonValue> OAIProject_Counts_Filters_filters::getProjects() const {
    return m_projects;
}
void OAIProject_Counts_Filters_filters::setProjects(const QList<QJsonValue> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIProject_Counts_Filters_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIProject_Counts_Filters_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

bool OAIProject_Counts_Filters_filters::isSet() const {
...
bool OAIProject_Counts_Filters_filters::isValid() const {
