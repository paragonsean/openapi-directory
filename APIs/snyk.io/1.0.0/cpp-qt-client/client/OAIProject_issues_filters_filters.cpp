...
#include "OAIProject_issues_filters_filters.h"
...
OAIProject_issues_filters_filters::OAIProject_issues_filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProject_issues_filters_filters::OAIProject_issues_filters_filters() {
    this->initializeModel();
}

OAIProject_issues_filters_filters::~OAIProject_issues_filters_filters() {}

void OAIProject_issues_filters_filters::initializeModel() {
...
void OAIProject_issues_filters_filters::fromJson(QString jsonString) {
...
void OAIProject_issues_filters_filters::fromJsonObject(QJsonObject json) {
...
QString OAIProject_issues_filters_filters::asJson() const {
...
QJsonObject OAIProject_issues_filters_filters::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIProject_issues_filters_filters::getExploitMaturity() const {
    return m_exploit_maturity;
}
void OAIProject_issues_filters_filters::setExploitMaturity(const QList<QJsonValue> &exploit_maturity) {
    m_exploit_maturity = exploit_maturity;
    m_exploit_maturity_isSet = true;
}

bool OAIProject_issues_filters_filters::is_exploit_maturity_Set() const{
    return m_exploit_maturity_isSet;
}

bool OAIProject_issues_filters_filters::is_exploit_maturity_Valid() const{
    return m_exploit_maturity_isValid;
}

bool OAIProject_issues_filters_filters::isIgnored() const {
    return m_ignored;
}
void OAIProject_issues_filters_filters::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIProject_issues_filters_filters::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIProject_issues_filters_filters::is_ignored_Valid() const{
    return m_ignored_isValid;
}

bool OAIProject_issues_filters_filters::isPatched() const {
    return m_patched;
}
void OAIProject_issues_filters_filters::setPatched(const bool &patched) {
    m_patched = patched;
    m_patched_isSet = true;
}

bool OAIProject_issues_filters_filters::is_patched_Set() const{
    return m_patched_isSet;
}

bool OAIProject_issues_filters_filters::is_patched_Valid() const{
    return m_patched_isValid;
}

OAIProject_issues_filters_filters_priorityScore OAIProject_issues_filters_filters::getPriorityScore() const {
    return m_priority_score;
}
void OAIProject_issues_filters_filters::setPriorityScore(const OAIProject_issues_filters_filters_priorityScore &priority_score) {
    m_priority_score = priority_score;
    m_priority_score_isSet = true;
}

bool OAIProject_issues_filters_filters::is_priority_score_Set() const{
    return m_priority_score_isSet;
}

bool OAIProject_issues_filters_filters::is_priority_score_Valid() const{
    return m_priority_score_isValid;
}

QList<QJsonValue> OAIProject_issues_filters_filters::getSeverities() const {
    return m_severities;
}
void OAIProject_issues_filters_filters::setSeverities(const QList<QJsonValue> &severities) {
    m_severities = severities;
    m_severities_isSet = true;
}

bool OAIProject_issues_filters_filters::is_severities_Set() const{
    return m_severities_isSet;
}

bool OAIProject_issues_filters_filters::is_severities_Valid() const{
    return m_severities_isValid;
}

QList<QJsonValue> OAIProject_issues_filters_filters::getTypes() const {
    return m_types;
}
void OAIProject_issues_filters_filters::setTypes(const QList<QJsonValue> &types) {
    m_types = types;
    m_types_isSet = true;
}

bool OAIProject_issues_filters_filters::is_types_Set() const{
    return m_types_isSet;
}

bool OAIProject_issues_filters_filters::is_types_Valid() const{
    return m_types_isValid;
}

bool OAIProject_issues_filters_filters::isSet() const {
...
bool OAIProject_issues_filters_filters::isValid() const {
