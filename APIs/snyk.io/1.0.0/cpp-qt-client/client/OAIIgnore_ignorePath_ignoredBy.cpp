...
#include "OAIIgnore_ignorePath_ignoredBy.h"
...
OAIIgnore_ignorePath_ignoredBy::OAIIgnore_ignorePath_ignoredBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIgnore_ignorePath_ignoredBy::OAIIgnore_ignorePath_ignoredBy() {
    this->initializeModel();
}

OAIIgnore_ignorePath_ignoredBy::~OAIIgnore_ignorePath_ignoredBy() {}

void OAIIgnore_ignorePath_ignoredBy::initializeModel() {
...
void OAIIgnore_ignorePath_ignoredBy::fromJson(QString jsonString) {
...
void OAIIgnore_ignorePath_ignoredBy::fromJsonObject(QJsonObject json) {
...
QString OAIIgnore_ignorePath_ignoredBy::asJson() const {
...
QJsonObject OAIIgnore_ignorePath_ignoredBy::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QString OAIIgnore_ignorePath_ignoredBy::getEmail() const {
    return m_email;
}
void OAIIgnore_ignorePath_ignoredBy::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIIgnore_ignorePath_ignoredBy::is_email_Set() const{
    return m_email_isSet;
}

bool OAIIgnore_ignorePath_ignoredBy::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIIgnore_ignorePath_ignoredBy::getId() const {
    return m_id;
}
void OAIIgnore_ignorePath_ignoredBy::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIgnore_ignorePath_ignoredBy::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIgnore_ignorePath_ignoredBy::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIIgnore_ignorePath_ignoredBy::getName() const {
    return m_name;
}
void OAIIgnore_ignorePath_ignoredBy::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIIgnore_ignorePath_ignoredBy::is_name_Set() const{
    return m_name_isSet;
}

bool OAIIgnore_ignorePath_ignoredBy::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIIgnore_ignorePath_ignoredBy::isSet() const {
...
bool OAIIgnore_ignorePath_ignoredBy::isValid() const {
