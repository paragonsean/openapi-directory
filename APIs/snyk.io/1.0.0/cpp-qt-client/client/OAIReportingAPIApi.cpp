...
OAIReportingAPIApi::OAIReportingAPIApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIReportingAPIApi::~OAIReportingAPIApi() {
}

void OAIReportingAPIApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_issue_counts", defaultConf);
    _serverIndices.insert("get_issue_counts", 0);
    _serverConfigs.insert("get_latest_issue_counts", defaultConf);
    _serverIndices.insert("get_latest_issue_counts", 0);
    _serverConfigs.insert("get_latest_project_counts", defaultConf);
    _serverIndices.insert("get_latest_project_counts", 0);
    _serverConfigs.insert("get_list_of_issues", defaultConf);
    _serverIndices.insert("get_list_of_issues", 0);
    _serverConfigs.insert("get_list_of_latest_issues", defaultConf);
    _serverIndices.insert("get_list_of_latest_issues", 0);
    _serverConfigs.insert("get_project_counts", defaultConf);
    _serverIndices.insert("get_project_counts", 0);
    _serverConfigs.insert("get_test_counts", defaultConf);
    _serverIndices.insert("get_test_counts", 0);
}
...
*/
int OAIReportingAPIApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIReportingAPIApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIReportingAPIApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIReportingAPIApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIReportingAPIApi::setUsername(const QString &username) {
    _username = username;
}

void OAIReportingAPIApi::setPassword(const QString &password) {
    _password = password;
}


void OAIReportingAPIApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIReportingAPIApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIReportingAPIApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIReportingAPIApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIReportingAPIApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIReportingAPIApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIReportingAPIApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIReportingAPIApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIReportingAPIApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIReportingAPIApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIReportingAPIApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIReportingAPIApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIReportingAPIApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIReportingAPIApi::get_issue_counts(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<QString> &group_by, const ::OpenAPI::OptionalParam<OAIGet_issue_counts_request> &oai_get_issue_counts_request) {
    QString fullPath = QString(_serverConfigs["get_issue_counts"][_serverIndices.value("get_issue_counts")].URL()+"/reporting/counts/issues");
    ...
    if (oai_get_issue_counts_request.hasValue()){

        
        QByteArray output = oai_get_issue_counts_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportingAPIApi::get_issue_countsCallback);
    connect(this, &OAIReportingAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIReportingAPIApi::get_issue_countsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGet_issue_counts_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_issue_countsSignal(output);
        Q_EMIT get_issue_countsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_issue_countsSignalE(output, error_type, error_str);
        Q_EMIT get_issue_countsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_issue_countsSignalError(output, error_type, error_str);
        Q_EMIT get_issue_countsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportingAPIApi::get_latest_issue_counts(const ::OpenAPI::OptionalParam<QString> &group_by, const ::OpenAPI::OptionalParam<OAIGet_issue_counts_request> &oai_get_issue_counts_request) {
    QString fullPath = QString(_serverConfigs["get_latest_issue_counts"][_serverIndices.value("get_latest_issue_counts")].URL()+"/reporting/counts/issues/latest");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportingAPIApi::get_latest_issue_countsCallback);
    connect(this, &OAIReportingAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportingAPIApi::get_latest_issue_countsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_latest_issue_countsSignal(output);
        Q_EMIT get_latest_issue_countsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_latest_issue_countsSignalE(output, error_type, error_str);
        Q_EMIT get_latest_issue_countsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_latest_issue_countsSignalError(output, error_type, error_str);
        Q_EMIT get_latest_issue_countsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportingAPIApi::get_latest_project_counts(const ::OpenAPI::OptionalParam<OAIGet_project_counts_request> &oai_get_project_counts_request) {
    QString fullPath = QString(_serverConfigs["get_latest_project_counts"][_serverIndices.value("get_latest_project_counts")].URL()+"/reporting/counts/projects/latest");
    ...
    if (oai_get_project_counts_request.hasValue()){

        
        QByteArray output = oai_get_project_counts_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportingAPIApi::get_latest_project_countsCallback);
    connect(this, &OAIReportingAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportingAPIApi::get_latest_project_countsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGet_project_counts_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_latest_project_countsSignal(output);
        Q_EMIT get_latest_project_countsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_latest_project_countsSignalE(output, error_type, error_str);
        Q_EMIT get_latest_project_countsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_latest_project_countsSignalError(output, error_type, error_str);
        Q_EMIT get_latest_project_countsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportingAPIApi::get_list_of_issues(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<double> &page, const ::OpenAPI::OptionalParam<double> &per_page, const ::OpenAPI::OptionalParam<QString> &sort_by, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<QString> &group_by, const ::OpenAPI::OptionalParam<OAIGet_list_of_issues_request> &oai_get_list_of_issues_request) {
    QString fullPath = QString(_serverConfigs["get_list_of_issues"][_serverIndices.value("get_list_of_issues")].URL()+"/reporting/issues/");
    ...
    if (oai_get_list_of_issues_request.hasValue()){

        
        QByteArray output = oai_get_list_of_issues_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportingAPIApi::get_list_of_issuesCallback);
    connect(this, &OAIReportingAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportingAPIApi::get_list_of_issuesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGet_list_of_issues_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_list_of_issuesSignal(output);
        Q_EMIT get_list_of_issuesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_list_of_issuesSignalE(output, error_type, error_str);
        Q_EMIT get_list_of_issuesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_list_of_issuesSignalError(output, error_type, error_str);
        Q_EMIT get_list_of_issuesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportingAPIApi::get_list_of_latest_issues(const ::OpenAPI::OptionalParam<double> &page, const ::OpenAPI::OptionalParam<double> &per_page, const ::OpenAPI::OptionalParam<QString> &sort_by, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<QString> &group_by, const ::OpenAPI::OptionalParam<OAIGet_list_of_issues_request> &oai_get_list_of_issues_request) {
    QString fullPath = QString(_serverConfigs["get_list_of_latest_issues"][_serverIndices.value("get_list_of_latest_issues")].URL()+"/reporting/issues/latest");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportingAPIApi::get_list_of_latest_issuesCallback);
    connect(this, &OAIReportingAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportingAPIApi::get_list_of_latest_issuesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_list_of_latest_issuesSignal(output);
        Q_EMIT get_list_of_latest_issuesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_list_of_latest_issuesSignalE(output, error_type, error_str);
        Q_EMIT get_list_of_latest_issuesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_list_of_latest_issuesSignalError(output, error_type, error_str);
        Q_EMIT get_list_of_latest_issuesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportingAPIApi::get_project_counts(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<OAIGet_project_counts_request> &oai_get_project_counts_request) {
    QString fullPath = QString(_serverConfigs["get_project_counts"][_serverIndices.value("get_project_counts")].URL()+"/reporting/counts/projects");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportingAPIApi::get_project_countsCallback);
    connect(this, &OAIReportingAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportingAPIApi::get_project_countsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_project_countsSignal(output);
        Q_EMIT get_project_countsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_project_countsSignalE(output, error_type, error_str);
        Q_EMIT get_project_countsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_project_countsSignalError(output, error_type, error_str);
        Q_EMIT get_project_countsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportingAPIApi::get_test_counts(const QString &from, const QString &to, const ::OpenAPI::OptionalParam<QString> &group_by, const ::OpenAPI::OptionalParam<OAIGet_test_counts_request> &oai_get_test_counts_request) {
    QString fullPath = QString(_serverConfigs["get_test_counts"][_serverIndices.value("get_test_counts")].URL()+"/reporting/counts/tests");
    ...
    if (oai_get_test_counts_request.hasValue()){

        
        QByteArray output = oai_get_test_counts_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportingAPIApi::get_test_countsCallback);
    connect(this, &OAIReportingAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReportingAPIApi::get_test_countsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGet_test_counts_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_test_countsSignal(output);
        Q_EMIT get_test_countsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_test_countsSignalE(output, error_type, error_str);
        Q_EMIT get_test_countsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_test_countsSignalError(output, error_type, error_str);
        Q_EMIT get_test_countsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReportingAPIApi::tokenAvailable(){
