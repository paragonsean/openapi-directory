...
#include "OAIAutoRemediationPrs.h"
...
OAIAutoRemediationPrs::OAIAutoRemediationPrs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoRemediationPrs::OAIAutoRemediationPrs() {
    this->initializeModel();
}

OAIAutoRemediationPrs::~OAIAutoRemediationPrs() {}

void OAIAutoRemediationPrs::initializeModel() {

    m_backlog_prs_enabled_isSet = false;
    m_backlog_prs_enabled_isValid = false;

    m_fresh_prs_enabled_isSet = false;
    m_fresh_prs_enabled_isValid = false;

    m_use_patch_remediation_isSet = false;
    m_use_patch_remediation_isValid = false;
}

void OAIAutoRemediationPrs::fromJson(QString jsonString) {
...
void OAIAutoRemediationPrs::fromJsonObject(QJsonObject json) {

    m_backlog_prs_enabled_isValid = ::OpenAPI::fromJsonValue(m_backlog_prs_enabled, json[QString("backlogPrsEnabled")]);
    m_backlog_prs_enabled_isSet = !json[QString("backlogPrsEnabled")].isNull() && m_backlog_prs_enabled_isValid;

    m_fresh_prs_enabled_isValid = ::OpenAPI::fromJsonValue(m_fresh_prs_enabled, json[QString("freshPrsEnabled")]);
    m_fresh_prs_enabled_isSet = !json[QString("freshPrsEnabled")].isNull() && m_fresh_prs_enabled_isValid;

    m_use_patch_remediation_isValid = ::OpenAPI::fromJsonValue(m_use_patch_remediation, json[QString("usePatchRemediation")]);
    m_use_patch_remediation_isSet = !json[QString("usePatchRemediation")].isNull() && m_use_patch_remediation_isValid;
}

QString OAIAutoRemediationPrs::asJson() const {
...
QJsonObject OAIAutoRemediationPrs::asJsonObject() const {
    QJsonObject obj;
    if (m_backlog_prs_enabled_isSet) {
        obj.insert(QString("backlogPrsEnabled"), ::OpenAPI::toJsonValue(m_backlog_prs_enabled));
    }
    if (m_fresh_prs_enabled_isSet) {
        obj.insert(QString("freshPrsEnabled"), ::OpenAPI::toJsonValue(m_fresh_prs_enabled));
    }
    if (m_use_patch_remediation_isSet) {
        obj.insert(QString("usePatchRemediation"), ::OpenAPI::toJsonValue(m_use_patch_remediation));
    }
    return obj;
}

bool OAIAutoRemediationPrs::isBacklogPrsEnabled() const {
    return m_backlog_prs_enabled;
}
void OAIAutoRemediationPrs::setBacklogPrsEnabled(const bool &backlog_prs_enabled) {
    m_backlog_prs_enabled = backlog_prs_enabled;
    m_backlog_prs_enabled_isSet = true;
}

bool OAIAutoRemediationPrs::is_backlog_prs_enabled_Set() const{
    return m_backlog_prs_enabled_isSet;
}

bool OAIAutoRemediationPrs::is_backlog_prs_enabled_Valid() const{
    return m_backlog_prs_enabled_isValid;
}

bool OAIAutoRemediationPrs::isFreshPrsEnabled() const {
    return m_fresh_prs_enabled;
}
void OAIAutoRemediationPrs::setFreshPrsEnabled(const bool &fresh_prs_enabled) {
    m_fresh_prs_enabled = fresh_prs_enabled;
    m_fresh_prs_enabled_isSet = true;
}

bool OAIAutoRemediationPrs::is_fresh_prs_enabled_Set() const{
    return m_fresh_prs_enabled_isSet;
}

bool OAIAutoRemediationPrs::is_fresh_prs_enabled_Valid() const{
    return m_fresh_prs_enabled_isValid;
}

bool OAIAutoRemediationPrs::isUsePatchRemediation() const {
    return m_use_patch_remediation;
}
void OAIAutoRemediationPrs::setUsePatchRemediation(const bool &use_patch_remediation) {
    m_use_patch_remediation = use_patch_remediation;
    m_use_patch_remediation_isSet = true;
}

bool OAIAutoRemediationPrs::is_use_patch_remediation_Set() const{
    return m_use_patch_remediation_isSet;
}

bool OAIAutoRemediationPrs::is_use_patch_remediation_Valid() const{
    return m_use_patch_remediation_isValid;
}

bool OAIAutoRemediationPrs::isSet() const {
...
bool OAIAutoRemediationPrs::isValid() const {
