...
/*
 * OAIGet_list_of_issues_200_response_results_inner_issue.h
 *
 * 
 */

#ifndef OAIGet_list_of_issues_200_response_results_inner_issue_H
#define OAIGet_list_of_issues_200_response_results_inner_issue_H

#include <QJsonObject>

#include "OAIGet_list_of_issues_200_response_results_inner_issue_identifiers.h"
#include "OAIGet_list_of_issues_200_response_results_inner_issue_semver.h"
#include <QJsonValue>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGet_list_of_issues_200_response_results_inner_issue_identifiers;
class OAIGet_list_of_issues_200_response_results_inner_issue_semver;

class OAIGet_list_of_issues_200_response_results_inner_issue : public OAIObject {
public:
    OAIGet_list_of_issues_200_response_results_inner_issue();
    OAIGet_list_of_issues_200_response_results_inner_issue(QString json);
    ~OAIGet_list_of_issues_200_response_results_inner_issue() override;
    ...
    OAIGet_list_of_issues_200_response_results_inner_issue_identifiers getIdentifiers() const;
    void setIdentifiers(const OAIGet_list_of_issues_200_response_results_inner_issue_identifiers &identifiers);
    bool is_identifiers_Set() const;
    bool is_identifiers_Valid() const;

    QList<QJsonValue> getIgnored() const;
    void setIgnored(const QList<QJsonValue> &ignored);
    ...
    QString getJiraIssueUrl() const;
    void setJiraIssueUrl(const QString &jira_issue_url);
    bool is_jira_issue_url_Set() const;
    bool is_jira_issue_url_Valid() const;
    ...
    OAIGet_list_of_issues_200_response_results_inner_issue_semver getSemver() const;
    void setSemver(const OAIGet_list_of_issues_200_response_results_inner_issue_semver &semver);
    ...
    QList<QJsonValue> getUniqueSeveritiesList() const;
    void setUniqueSeveritiesList(const QList<QJsonValue> &unique_severities_list);
    bool is_unique_severities_list_Set() const;
    bool is_unique_severities_list_Valid() const;
...
private:
    ...
    OAIGet_list_of_issues_200_response_results_inner_issue_identifiers m_identifiers;
    bool m_identifiers_isSet;
    bool m_identifiers_isValid;

    QList<QJsonValue> m_ignored;
    ...
    QString m_jira_issue_url;
    bool m_jira_issue_url_isSet;
    bool m_jira_issue_url_isValid;
    ...
    OAIGet_list_of_issues_200_response_results_inner_issue_semver m_semver;
    bool m_semver_isSet;
    ...
    QList<QJsonValue> m_unique_severities_list;
    bool m_unique_severities_list_isSet;
    bool m_unique_severities_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_list_of_issues_200_response_results_inner_issue)

#endif // OAIGet_list_of_issues_200_response_results_inner_issue_H
