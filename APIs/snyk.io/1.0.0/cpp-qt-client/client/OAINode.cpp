...
QList<QJsonValue> OAINode::getDeps() const {
    return m_deps;
}
void OAINode::setDeps(const QList<QJsonValue> &deps) {
    m_deps = deps;
    m_deps_isSet = true;
}

bool OAINode::is_deps_Set() const{
    return m_deps_isSet;
}

bool OAINode::is_deps_Valid() const{
...
QString OAINode::getPkgId() const {
    return m_pkg_id;
}
void OAINode::setPkgId(const QString &pkg_id) {
    m_pkg_id = pkg_id;
    m_pkg_id_isSet = true;
}

bool OAINode::is_pkg_id_Set() const{
    return m_pkg_id_isSet;
}

bool OAINode::is_pkg_id_Valid() const{
