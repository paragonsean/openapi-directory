...
#include "OAIRetrieve_a_single_project_200_response_attributes.h"
...
OAIRetrieve_a_single_project_200_response_attributes::OAIRetrieve_a_single_project_200_response_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetrieve_a_single_project_200_response_attributes::OAIRetrieve_a_single_project_200_response_attributes() {
    this->initializeModel();
}

OAIRetrieve_a_single_project_200_response_attributes::~OAIRetrieve_a_single_project_200_response_attributes() {}

void OAIRetrieve_a_single_project_200_response_attributes::initializeModel() {
...
void OAIRetrieve_a_single_project_200_response_attributes::fromJson(QString jsonString) {
...
void OAIRetrieve_a_single_project_200_response_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIRetrieve_a_single_project_200_response_attributes::asJson() const {
...
QJsonObject OAIRetrieve_a_single_project_200_response_attributes::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIRetrieve_a_single_project_200_response_attributes::getCriticality() const {
    return m_criticality;
}
void OAIRetrieve_a_single_project_200_response_attributes::setCriticality(const QList<QJsonValue> &criticality) {
    m_criticality = criticality;
    m_criticality_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_attributes::is_criticality_Set() const{
    return m_criticality_isSet;
}

bool OAIRetrieve_a_single_project_200_response_attributes::is_criticality_Valid() const{
    return m_criticality_isValid;
}

QList<QJsonValue> OAIRetrieve_a_single_project_200_response_attributes::getEnvironment() const {
    return m_environment;
}
void OAIRetrieve_a_single_project_200_response_attributes::setEnvironment(const QList<QJsonValue> &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_attributes::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAIRetrieve_a_single_project_200_response_attributes::is_environment_Valid() const{
    return m_environment_isValid;
}

QList<QJsonValue> OAIRetrieve_a_single_project_200_response_attributes::getLifecycle() const {
    return m_lifecycle;
}
void OAIRetrieve_a_single_project_200_response_attributes::setLifecycle(const QList<QJsonValue> &lifecycle) {
    m_lifecycle = lifecycle;
    m_lifecycle_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_attributes::is_lifecycle_Set() const{
    return m_lifecycle_isSet;
}

bool OAIRetrieve_a_single_project_200_response_attributes::is_lifecycle_Valid() const{
    return m_lifecycle_isValid;
}

bool OAIRetrieve_a_single_project_200_response_attributes::isSet() const {
...
bool OAIRetrieve_a_single_project_200_response_attributes::isValid() const {
