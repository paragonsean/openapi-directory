...
OAIAdd_new_integration_request::OAIAdd_new_integration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_new_integration_request::OAIAdd_new_integration_request() {
    this->initializeModel();
}

OAIAdd_new_integration_request::~OAIAdd_new_integration_request() {}

void OAIAdd_new_integration_request::initializeModel() {
...
void OAIAdd_new_integration_request::fromJson(QString jsonString) {
...
void OAIAdd_new_integration_request::fromJsonObject(QJsonObject json) {
...
QString OAIAdd_new_integration_request::asJson() const {
...
QJsonObject OAIAdd_new_integration_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAdd_new_integration_request_anyOf_credentials OAIAdd_new_integration_request::getCredentials() const {
    return m_credentials;
}
void OAIAdd_new_integration_request::setCredentials(const OAIAdd_new_integration_request_anyOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIAdd_new_integration_request::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIAdd_new_integration_request::is_credentials_Valid() const{
    return m_credentials_isValid;
}

QString OAIAdd_new_integration_request::getType() const {
    return m_type;
}
void OAIAdd_new_integration_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAdd_new_integration_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAdd_new_integration_request::is_type_Valid() const{
    return m_type_isValid;
}

OAIAdd_new_integration_request_anyOf_1_broker OAIAdd_new_integration_request::getBroker() const {
    return m_broker;
}
void OAIAdd_new_integration_request::setBroker(const OAIAdd_new_integration_request_anyOf_1_broker &broker) {
    m_broker = broker;
    m_broker_isSet = true;
}

bool OAIAdd_new_integration_request::is_broker_Set() const{
    return m_broker_isSet;
}

bool OAIAdd_new_integration_request::is_broker_Valid() const{
    return m_broker_isValid;
}

bool OAIAdd_new_integration_request::isSet() const {
...
bool OAIAdd_new_integration_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_credentials_isValid && m_type_isValid && m_broker_isValid && true;
}
