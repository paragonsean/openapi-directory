...
#include "OAIGet_issue_counts_200_response_results_inner_severity.h"
...
OAIGet_issue_counts_200_response_results_inner_severity::OAIGet_issue_counts_200_response_results_inner_severity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_issue_counts_200_response_results_inner_severity::OAIGet_issue_counts_200_response_results_inner_severity() {
    this->initializeModel();
}

OAIGet_issue_counts_200_response_results_inner_severity::~OAIGet_issue_counts_200_response_results_inner_severity() {}

void OAIGet_issue_counts_200_response_results_inner_severity::initializeModel() {
...
void OAIGet_issue_counts_200_response_results_inner_severity::fromJson(QString jsonString) {
...
void OAIGet_issue_counts_200_response_results_inner_severity::fromJsonObject(QJsonObject json) {
...
QString OAIGet_issue_counts_200_response_results_inner_severity::asJson() const {
...
QJsonObject OAIGet_issue_counts_200_response_results_inner_severity::asJsonObject() const {
    QJsonObject obj;
    if (m_critical_isSet) {
...
double OAIGet_issue_counts_200_response_results_inner_severity::getCritical() const {
    return m_critical;
}
void OAIGet_issue_counts_200_response_results_inner_severity::setCritical(const double &critical) {
    m_critical = critical;
    m_critical_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_critical_Set() const{
    return m_critical_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_critical_Valid() const{
    return m_critical_isValid;
}

double OAIGet_issue_counts_200_response_results_inner_severity::getHigh() const {
    return m_high;
}
void OAIGet_issue_counts_200_response_results_inner_severity::setHigh(const double &high) {
    m_high = high;
    m_high_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_high_Set() const{
    return m_high_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_high_Valid() const{
    return m_high_isValid;
}

double OAIGet_issue_counts_200_response_results_inner_severity::getLow() const {
    return m_low;
}
void OAIGet_issue_counts_200_response_results_inner_severity::setLow(const double &low) {
    m_low = low;
    m_low_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_low_Set() const{
    return m_low_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_low_Valid() const{
    return m_low_isValid;
}

double OAIGet_issue_counts_200_response_results_inner_severity::getMedium() const {
    return m_medium;
}
void OAIGet_issue_counts_200_response_results_inner_severity::setMedium(const double &medium) {
    m_medium = medium;
    m_medium_isSet = true;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_medium_Set() const{
    return m_medium_isSet;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::is_medium_Valid() const{
    return m_medium_isValid;
}

bool OAIGet_issue_counts_200_response_results_inner_severity::isSet() const {
...
bool OAIGet_issue_counts_200_response_results_inner_severity::isValid() const {
