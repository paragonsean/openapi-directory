...
#include "OAIList_all_project_snapshot_issue_paths_200_response_links.h"
...
OAIList_all_project_snapshot_issue_paths_200_response_links::OAIList_all_project_snapshot_issue_paths_200_response_links(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_project_snapshot_issue_paths_200_response_links::OAIList_all_project_snapshot_issue_paths_200_response_links() {
    this->initializeModel();
}

OAIList_all_project_snapshot_issue_paths_200_response_links::~OAIList_all_project_snapshot_issue_paths_200_response_links() {}

void OAIList_all_project_snapshot_issue_paths_200_response_links::initializeModel() {
...
void OAIList_all_project_snapshot_issue_paths_200_response_links::fromJson(QString jsonString) {
...
void OAIList_all_project_snapshot_issue_paths_200_response_links::fromJsonObject(QJsonObject json) {
...
QString OAIList_all_project_snapshot_issue_paths_200_response_links::asJson() const {
...
QJsonObject OAIList_all_project_snapshot_issue_paths_200_response_links::asJsonObject() const {
    QJsonObject obj;
    if (m_last_isSet) {
...
QString OAIList_all_project_snapshot_issue_paths_200_response_links::getLast() const {
    return m_last;
}
void OAIList_all_project_snapshot_issue_paths_200_response_links::setLast(const QString &last) {
    m_last = last;
    m_last_isSet = true;
}

bool OAIList_all_project_snapshot_issue_paths_200_response_links::is_last_Set() const{
    return m_last_isSet;
}

bool OAIList_all_project_snapshot_issue_paths_200_response_links::is_last_Valid() const{
    return m_last_isValid;
}

QString OAIList_all_project_snapshot_issue_paths_200_response_links::getNext() const {
    return m_next;
}
void OAIList_all_project_snapshot_issue_paths_200_response_links::setNext(const QString &next) {
    m_next = next;
    m_next_isSet = true;
}

bool OAIList_all_project_snapshot_issue_paths_200_response_links::is_next_Set() const{
    return m_next_isSet;
}

bool OAIList_all_project_snapshot_issue_paths_200_response_links::is_next_Valid() const{
    return m_next_isValid;
}

QString OAIList_all_project_snapshot_issue_paths_200_response_links::getPrev() const {
    return m_prev;
}
void OAIList_all_project_snapshot_issue_paths_200_response_links::setPrev(const QString &prev) {
    m_prev = prev;
    m_prev_isSet = true;
}

bool OAIList_all_project_snapshot_issue_paths_200_response_links::is_prev_Set() const{
    return m_prev_isSet;
}

bool OAIList_all_project_snapshot_issue_paths_200_response_links::is_prev_Valid() const{
    return m_prev_isValid;
}

bool OAIList_all_project_snapshot_issue_paths_200_response_links::isSet() const {
...
bool OAIList_all_project_snapshot_issue_paths_200_response_links::isValid() const {
