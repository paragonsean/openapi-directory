...
#include "OAIList_all_Aggregated_issues_request.h"
...
OAIList_all_Aggregated_issues_request::OAIList_all_Aggregated_issues_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_all_Aggregated_issues_request::OAIList_all_Aggregated_issues_request() {
    this->initializeModel();
}

OAIList_all_Aggregated_issues_request::~OAIList_all_Aggregated_issues_request() {}

void OAIList_all_Aggregated_issues_request::initializeModel() {

    m_filters_isSet = false;
    m_filters_isValid = false;

    m_include_description_isSet = false;
    m_include_description_isValid = false;

    m_include_introduced_through_isSet = false;
    m_include_introduced_through_isValid = false;
}

void OAIList_all_Aggregated_issues_request::fromJson(QString jsonString) {
...
void OAIList_all_Aggregated_issues_request::fromJsonObject(QJsonObject json) {

    m_filters_isValid = ::OpenAPI::fromJsonValue(m_filters, json[QString("filters")]);
    m_filters_isSet = !json[QString("filters")].isNull() && m_filters_isValid;

    m_include_description_isValid = ::OpenAPI::fromJsonValue(m_include_description, json[QString("includeDescription")]);
    m_include_description_isSet = !json[QString("includeDescription")].isNull() && m_include_description_isValid;

    m_include_introduced_through_isValid = ::OpenAPI::fromJsonValue(m_include_introduced_through, json[QString("includeIntroducedThrough")]);
    m_include_introduced_through_isSet = !json[QString("includeIntroducedThrough")].isNull() && m_include_introduced_through_isValid;
}

QString OAIList_all_Aggregated_issues_request::asJson() const {
...
QJsonObject OAIList_all_Aggregated_issues_request::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
        obj.insert(QString("filters"), ::OpenAPI::toJsonValue(m_filters));
    }
    if (m_include_description_isSet) {
        obj.insert(QString("includeDescription"), ::OpenAPI::toJsonValue(m_include_description));
    }
    if (m_include_introduced_through_isSet) {
        obj.insert(QString("includeIntroducedThrough"), ::OpenAPI::toJsonValue(m_include_introduced_through));
    }
    return obj;
}

OAIList_all_Aggregated_issues_request_filters OAIList_all_Aggregated_issues_request::getFilters() const {
    return m_filters;
}
void OAIList_all_Aggregated_issues_request::setFilters(const OAIList_all_Aggregated_issues_request_filters &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIList_all_Aggregated_issues_request::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIList_all_Aggregated_issues_request::is_filters_Valid() const{
    return m_filters_isValid;
}

bool OAIList_all_Aggregated_issues_request::isIncludeDescription() const {
    return m_include_description;
}
void OAIList_all_Aggregated_issues_request::setIncludeDescription(const bool &include_description) {
    m_include_description = include_description;
    m_include_description_isSet = true;
}

bool OAIList_all_Aggregated_issues_request::is_include_description_Set() const{
    return m_include_description_isSet;
}

bool OAIList_all_Aggregated_issues_request::is_include_description_Valid() const{
    return m_include_description_isValid;
}

bool OAIList_all_Aggregated_issues_request::isIncludeIntroducedThrough() const {
    return m_include_introduced_through;
}
void OAIList_all_Aggregated_issues_request::setIncludeIntroducedThrough(const bool &include_introduced_through) {
    m_include_introduced_through = include_introduced_through;
    m_include_introduced_through_isSet = true;
}

bool OAIList_all_Aggregated_issues_request::is_include_introduced_through_Set() const{
    return m_include_introduced_through_isSet;
}

bool OAIList_all_Aggregated_issues_request::is_include_introduced_through_Valid() const{
    return m_include_introduced_through_isValid;
}

bool OAIList_all_Aggregated_issues_request::isSet() const {
...
bool OAIList_all_Aggregated_issues_request::isValid() const {
