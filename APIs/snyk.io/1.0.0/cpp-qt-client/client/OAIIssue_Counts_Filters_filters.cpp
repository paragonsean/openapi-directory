...
#include "OAIIssue_Counts_Filters_filters.h"
...
OAIIssue_Counts_Filters_filters::OAIIssue_Counts_Filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIssue_Counts_Filters_filters::OAIIssue_Counts_Filters_filters() {
    this->initializeModel();
}

OAIIssue_Counts_Filters_filters::~OAIIssue_Counts_Filters_filters() {}

void OAIIssue_Counts_Filters_filters::initializeModel() {
...
void OAIIssue_Counts_Filters_filters::fromJson(QString jsonString) {
...
void OAIIssue_Counts_Filters_filters::fromJsonObject(QJsonObject json) {
...
QString OAIIssue_Counts_Filters_filters::asJson() const {
...
QJsonObject OAIIssue_Counts_Filters_filters::asJsonObject() const {
    QJsonObject obj;
    if (m_fixable_isSet) {
...
bool OAIIssue_Counts_Filters_filters::isFixable() const {
    return m_fixable;
}
void OAIIssue_Counts_Filters_filters::setFixable(const bool &fixable) {
    m_fixable = fixable;
    m_fixable_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_fixable_Set() const{
    return m_fixable_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_fixable_Valid() const{
    return m_fixable_isValid;
}

bool OAIIssue_Counts_Filters_filters::isIgnored() const {
    return m_ignored;
}
void OAIIssue_Counts_Filters_filters::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_ignored_Valid() const{
    return m_ignored_isValid;
}

bool OAIIssue_Counts_Filters_filters::isIsPatchable() const {
    return m_is_patchable;
}
void OAIIssue_Counts_Filters_filters::setIsPatchable(const bool &is_patchable) {
    m_is_patchable = is_patchable;
    m_is_patchable_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_is_patchable_Set() const{
    return m_is_patchable_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_is_patchable_Valid() const{
    return m_is_patchable_isValid;
}

bool OAIIssue_Counts_Filters_filters::isIsPinnable() const {
    return m_is_pinnable;
}
void OAIIssue_Counts_Filters_filters::setIsPinnable(const bool &is_pinnable) {
    m_is_pinnable = is_pinnable;
    m_is_pinnable_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_is_pinnable_Set() const{
    return m_is_pinnable_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_is_pinnable_Valid() const{
    return m_is_pinnable_isValid;
}

bool OAIIssue_Counts_Filters_filters::isIsUpgradable() const {
    return m_is_upgradable;
}
void OAIIssue_Counts_Filters_filters::setIsUpgradable(const bool &is_upgradable) {
    m_is_upgradable = is_upgradable;
    m_is_upgradable_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_is_upgradable_Set() const{
    return m_is_upgradable_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_is_upgradable_Valid() const{
    return m_is_upgradable_isValid;
}

QList<QJsonValue> OAIIssue_Counts_Filters_filters::getLanguages() const {
    return m_languages;
}
void OAIIssue_Counts_Filters_filters::setLanguages(const QList<QJsonValue> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_languages_Valid() const{
    return m_languages_isValid;
}

QList<QJsonValue> OAIIssue_Counts_Filters_filters::getOrgs() const {
    return m_orgs;
}
void OAIIssue_Counts_Filters_filters::setOrgs(const QList<QJsonValue> &orgs) {
    m_orgs = orgs;
    m_orgs_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_orgs_Set() const{
    return m_orgs_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_orgs_Valid() const{
    return m_orgs_isValid;
}

bool OAIIssue_Counts_Filters_filters::isPatched() const {
    return m_patched;
}
void OAIIssue_Counts_Filters_filters::setPatched(const bool &patched) {
    m_patched = patched;
    m_patched_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_patched_Set() const{
    return m_patched_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_patched_Valid() const{
    return m_patched_isValid;
}

OAIPriorityScore OAIIssue_Counts_Filters_filters::getPriorityScore() const {
    return m_priority_score;
}
void OAIIssue_Counts_Filters_filters::setPriorityScore(const OAIPriorityScore &priority_score) {
    m_priority_score = priority_score;
    m_priority_score_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_priority_score_Set() const{
    return m_priority_score_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_priority_score_Valid() const{
    return m_priority_score_isValid;
}

QList<QJsonValue> OAIIssue_Counts_Filters_filters::getProjects() const {
    return m_projects;
}
void OAIIssue_Counts_Filters_filters::setProjects(const QList<QJsonValue> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_projects_Valid() const{
    return m_projects_isValid;
}

QList<QJsonValue> OAIIssue_Counts_Filters_filters::getSeverity() const {
    return m_severity;
}
void OAIIssue_Counts_Filters_filters::setSeverity(const QList<QJsonValue> &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_severity_Valid() const{
    return m_severity_isValid;
}

QList<QJsonValue> OAIIssue_Counts_Filters_filters::getTypes() const {
    return m_types;
}
void OAIIssue_Counts_Filters_filters::setTypes(const QList<QJsonValue> &types) {
    m_types = types;
    m_types_isSet = true;
}

bool OAIIssue_Counts_Filters_filters::is_types_Set() const{
    return m_types_isSet;
}

bool OAIIssue_Counts_Filters_filters::is_types_Valid() const{
    return m_types_isValid;
}

bool OAIIssue_Counts_Filters_filters::isSet() const {
...
bool OAIIssue_Counts_Filters_filters::isValid() const {
