...
#include "OAIImport_targets_request_anyOf_2.h"
...
OAIImport_targets_request_anyOf_2::OAIImport_targets_request_anyOf_2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImport_targets_request_anyOf_2::OAIImport_targets_request_anyOf_2() {
    this->initializeModel();
}

OAIImport_targets_request_anyOf_2::~OAIImport_targets_request_anyOf_2() {}

void OAIImport_targets_request_anyOf_2::initializeModel() {

    m_exclusion_globs_isSet = false;
    m_exclusion_globs_isValid = false;
...
void OAIImport_targets_request_anyOf_2::fromJson(QString jsonString) {
...
void OAIImport_targets_request_anyOf_2::fromJsonObject(QJsonObject json) {

    m_exclusion_globs_isValid = ::OpenAPI::fromJsonValue(m_exclusion_globs, json[QString("exclusionGlobs")]);
    m_exclusion_globs_isSet = !json[QString("exclusionGlobs")].isNull() && m_exclusion_globs_isValid;
...
QString OAIImport_targets_request_anyOf_2::asJson() const {
...
QJsonObject OAIImport_targets_request_anyOf_2::asJsonObject() const {
    QJsonObject obj;
    if (m_exclusion_globs_isSet) {
        obj.insert(QString("exclusionGlobs"), ::OpenAPI::toJsonValue(m_exclusion_globs));
    }
    if (m_files.size() > 0) {
...
QString OAIImport_targets_request_anyOf_2::getExclusionGlobs() const {
    return m_exclusion_globs;
}
void OAIImport_targets_request_anyOf_2::setExclusionGlobs(const QString &exclusion_globs) {
    m_exclusion_globs = exclusion_globs;
    m_exclusion_globs_isSet = true;
}

bool OAIImport_targets_request_anyOf_2::is_exclusion_globs_Set() const{
    return m_exclusion_globs_isSet;
}

bool OAIImport_targets_request_anyOf_2::is_exclusion_globs_Valid() const{
    return m_exclusion_globs_isValid;
}

QList<QJsonValue> OAIImport_targets_request_anyOf_2::getFiles() const {
    return m_files;
}
void OAIImport_targets_request_anyOf_2::setFiles(const QList<QJsonValue> &files) {
    m_files = files;
    m_files_isSet = true;
}

bool OAIImport_targets_request_anyOf_2::is_files_Set() const{
    return m_files_isSet;
}

bool OAIImport_targets_request_anyOf_2::is_files_Valid() const{
    return m_files_isValid;
}

OAIImport_targets_request_anyOf_2_target OAIImport_targets_request_anyOf_2::getTarget() const {
    return m_target;
}
void OAIImport_targets_request_anyOf_2::setTarget(const OAIImport_targets_request_anyOf_2_target &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIImport_targets_request_anyOf_2::is_target_Set() const{
    return m_target_isSet;
}

bool OAIImport_targets_request_anyOf_2::is_target_Valid() const{
    return m_target_isValid;
}

bool OAIImport_targets_request_anyOf_2::isSet() const {
...
bool OAIImport_targets_request_anyOf_2::isValid() const {
