...
bool OAIUpdate_request::isAutoDepUpgradeEnabled() const {
    return m_auto_dep_upgrade_enabled;
}
void OAIUpdate_request::setAutoDepUpgradeEnabled(const bool &auto_dep_upgrade_enabled) {
    m_auto_dep_upgrade_enabled = auto_dep_upgrade_enabled;
    m_auto_dep_upgrade_enabled_isSet = true;
}

bool OAIUpdate_request::is_auto_dep_upgrade_enabled_Set() const{
    return m_auto_dep_upgrade_enabled_isSet;
}

bool OAIUpdate_request::is_auto_dep_upgrade_enabled_Valid() const{
    return m_auto_dep_upgrade_enabled_isValid;
}

QList<QJsonValue> OAIUpdate_request::getAutoDepUpgradeIgnoredDependencies() const {
    return m_auto_dep_upgrade_ignored_dependencies;
}
void OAIUpdate_request::setAutoDepUpgradeIgnoredDependencies(const QList<QJsonValue> &auto_dep_upgrade_ignored_dependencies) {
...
bool OAIUpdate_request::is_auto_dep_upgrade_ignored_dependencies_Set() const{
    return m_auto_dep_upgrade_ignored_dependencies_isSet;
}

bool OAIUpdate_request::is_auto_dep_upgrade_ignored_dependencies_Valid() const{
    return m_auto_dep_upgrade_ignored_dependencies_isValid;
}

double OAIUpdate_request::getAutoDepUpgradeLimit() const {
    return m_auto_dep_upgrade_limit;
}
void OAIUpdate_request::setAutoDepUpgradeLimit(const double &auto_dep_upgrade_limit) {
    m_auto_dep_upgrade_limit = auto_dep_upgrade_limit;
    m_auto_dep_upgrade_limit_isSet = true;
}

bool OAIUpdate_request::is_auto_dep_upgrade_limit_Set() const{
    return m_auto_dep_upgrade_limit_isSet;
}

bool OAIUpdate_request::is_auto_dep_upgrade_limit_Valid() const{
    return m_auto_dep_upgrade_limit_isValid;
}

double OAIUpdate_request::getAutoDepUpgradeMinAge() const {
    return m_auto_dep_upgrade_min_age;
}
void OAIUpdate_request::setAutoDepUpgradeMinAge(const double &auto_dep_upgrade_min_age) {
    m_auto_dep_upgrade_min_age = auto_dep_upgrade_min_age;
    m_auto_dep_upgrade_min_age_isSet = true;
}

bool OAIUpdate_request::is_auto_dep_upgrade_min_age_Set() const{
    return m_auto_dep_upgrade_min_age_isSet;
}

bool OAIUpdate_request::is_auto_dep_upgrade_min_age_Valid() const{
    return m_auto_dep_upgrade_min_age_isValid;
}

OAIRetrieve_200_response_autoRemediationPrs OAIUpdate_request::getAutoRemediationPrs() const {
    return m_auto_remediation_prs;
}
void OAIUpdate_request::setAutoRemediationPrs(const OAIRetrieve_200_response_autoRemediationPrs &auto_remediation_prs) {
    m_auto_remediation_prs = auto_remediation_prs;
    m_auto_remediation_prs_isSet = true;
}

bool OAIUpdate_request::is_auto_remediation_prs_Set() const{
    return m_auto_remediation_prs_isSet;
}

bool OAIUpdate_request::is_auto_remediation_prs_Valid() const{
    return m_auto_remediation_prs_isValid;
}

bool OAIUpdate_request::isDockerfileScmEnabled() const {
    return m_dockerfile_scm_enabled;
}
void OAIUpdate_request::setDockerfileScmEnabled(const bool &dockerfile_scm_enabled) {
    m_dockerfile_scm_enabled = dockerfile_scm_enabled;
    m_dockerfile_scm_enabled_isSet = true;
}

bool OAIUpdate_request::is_dockerfile_scm_enabled_Set() const{
    return m_dockerfile_scm_enabled_isSet;
}

bool OAIUpdate_request::is_dockerfile_scm_enabled_Valid() const{
    return m_dockerfile_scm_enabled_isValid;
}

OAIRetrieve_200_response_manualRemediationPrs OAIUpdate_request::getManualRemediationPrs() const {
    return m_manual_remediation_prs;
}
void OAIUpdate_request::setManualRemediationPrs(const OAIRetrieve_200_response_manualRemediationPrs &manual_remediation_prs) {
    m_manual_remediation_prs = manual_remediation_prs;
    m_manual_remediation_prs_isSet = true;
}

bool OAIUpdate_request::is_manual_remediation_prs_Set() const{
    return m_manual_remediation_prs_isSet;
}

bool OAIUpdate_request::is_manual_remediation_prs_Valid() const{
    return m_manual_remediation_prs_isValid;
}

OAIRetrieve_200_response_pullRequestAssignment OAIUpdate_request::getPullRequestAssignment() const {
    return m_pull_request_assignment;
}
void OAIUpdate_request::setPullRequestAssignment(const OAIRetrieve_200_response_pullRequestAssignment &pull_request_assignment) {
    m_pull_request_assignment = pull_request_assignment;
    m_pull_request_assignment_isSet = true;
}

bool OAIUpdate_request::is_pull_request_assignment_Set() const{
    return m_pull_request_assignment_isSet;
}

bool OAIUpdate_request::is_pull_request_assignment_Valid() const{
    return m_pull_request_assignment_isValid;
}

bool OAIUpdate_request::isPullRequestFailOnAnyVulns() const {
    return m_pull_request_fail_on_any_vulns;
}
void OAIUpdate_request::setPullRequestFailOnAnyVulns(const bool &pull_request_fail_on_any_vulns) {
    m_pull_request_fail_on_any_vulns = pull_request_fail_on_any_vulns;
    m_pull_request_fail_on_any_vulns_isSet = true;
}

bool OAIUpdate_request::is_pull_request_fail_on_any_vulns_Set() const{
    return m_pull_request_fail_on_any_vulns_isSet;
}

bool OAIUpdate_request::is_pull_request_fail_on_any_vulns_Valid() const{
    return m_pull_request_fail_on_any_vulns_isValid;
}

bool OAIUpdate_request::isPullRequestFailOnlyForHighSeverity() const {
    return m_pull_request_fail_only_for_high_severity;
}
void OAIUpdate_request::setPullRequestFailOnlyForHighSeverity(const bool &pull_request_fail_only_for_high_severity) {
...
bool OAIUpdate_request::is_pull_request_fail_only_for_high_severity_Set() const{
    return m_pull_request_fail_only_for_high_severity_isSet;
}

bool OAIUpdate_request::is_pull_request_fail_only_for_high_severity_Valid() const{
    return m_pull_request_fail_only_for_high_severity_isValid;
}

bool OAIUpdate_request::isPullRequestTestEnabled() const {
    return m_pull_request_test_enabled;
}
void OAIUpdate_request::setPullRequestTestEnabled(const bool &pull_request_test_enabled) {
    m_pull_request_test_enabled = pull_request_test_enabled;
    m_pull_request_test_enabled_isSet = true;
}

bool OAIUpdate_request::is_pull_request_test_enabled_Set() const{
    return m_pull_request_test_enabled_isSet;
}

bool OAIUpdate_request::is_pull_request_test_enabled_Valid() const{
