...
OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::OAIRetrieve_a_single_project_200_response_issueCountsBySeverity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::OAIRetrieve_a_single_project_200_response_issueCountsBySeverity() {
    this->initializeModel();
}

OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::~OAIRetrieve_a_single_project_200_response_issueCountsBySeverity() {}

void OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::initializeModel() {
...
void OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::fromJson(QString jsonString) {
...
void OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::fromJsonObject(QJsonObject json) {
...
QString OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::asJson() const {
...
QJsonObject OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::asJsonObject() const {
    QJsonObject obj;
    if (m_critical_isSet) {
...
double OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::getCritical() const {
    return m_critical;
}
void OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::setCritical(const double &critical) {
    m_critical = critical;
    m_critical_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_critical_Set() const{
    return m_critical_isSet;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_critical_Valid() const{
    return m_critical_isValid;
}

double OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::getHigh() const {
    return m_high;
}
void OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::setHigh(const double &high) {
    m_high = high;
    m_high_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_high_Set() const{
    return m_high_isSet;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_high_Valid() const{
    return m_high_isValid;
}

double OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::getLow() const {
    return m_low;
}
void OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::setLow(const double &low) {
    m_low = low;
    m_low_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_low_Set() const{
    return m_low_isSet;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_low_Valid() const{
    return m_low_isValid;
}

double OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::getMedium() const {
    return m_medium;
}
void OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::setMedium(const double &medium) {
    m_medium = medium;
    m_medium_isSet = true;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_medium_Set() const{
    return m_medium_isSet;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::is_medium_Valid() const{
    return m_medium_isValid;
}

bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::isSet() const {
...
bool OAIRetrieve_a_single_project_200_response_issueCountsBySeverity::isValid() const {
