...
/*
 * OAIAggregated_project_issues_issues_inner_issueData.h
 *
 * The details of the issue
 */

#ifndef OAIAggregated_project_issues_issues_inner_issueData_H
#define OAIAggregated_project_issues_issues_inner_issueData_H
...
class OAIAggregated_project_issues_issues_inner_issueData : public OAIObject {
public:
    OAIAggregated_project_issues_issues_inner_issueData();
    OAIAggregated_project_issues_issues_inner_issueData(QString json);
    ~OAIAggregated_project_issues_issues_inner_issueData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAggregated_project_issues_issues_inner_issueData)

#endif // OAIAggregated_project_issues_issues_inner_issueData_H
