...
#include "OAIAdd_ignore_request.h"
...
OAIAdd_ignore_request::OAIAdd_ignore_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdd_ignore_request::OAIAdd_ignore_request() {
    this->initializeModel();
}

OAIAdd_ignore_request::~OAIAdd_ignore_request() {}

void OAIAdd_ignore_request::initializeModel() {

    m_disregard_if_fixable_isSet = false;
    m_disregard_if_fixable_isValid = false;

    m_expires_isSet = false;
    m_expires_isValid = false;

    m_ignore_path_isSet = false;
    m_ignore_path_isValid = false;
...
void OAIAdd_ignore_request::fromJson(QString jsonString) {
...
void OAIAdd_ignore_request::fromJsonObject(QJsonObject json) {

    m_disregard_if_fixable_isValid = ::OpenAPI::fromJsonValue(m_disregard_if_fixable, json[QString("disregardIfFixable")]);
    m_disregard_if_fixable_isSet = !json[QString("disregardIfFixable")].isNull() && m_disregard_if_fixable_isValid;
    ...
    m_ignore_path_isValid = ::OpenAPI::fromJsonValue(m_ignore_path, json[QString("ignorePath")]);
    m_ignore_path_isSet = !json[QString("ignorePath")].isNull() && m_ignore_path_isValid;
...
QString OAIAdd_ignore_request::asJson() const {
...
QJsonObject OAIAdd_ignore_request::asJsonObject() const {
    QJsonObject obj;
    if (m_disregard_if_fixable_isSet) {
        obj.insert(QString("disregardIfFixable"), ::OpenAPI::toJsonValue(m_disregard_if_fixable));
    }
    if (m_expires_isSet) {
        obj.insert(QString("expires"), ::OpenAPI::toJsonValue(m_expires));
    }
    if (m_ignore_path_isSet) {
        obj.insert(QString("ignorePath"), ::OpenAPI::toJsonValue(m_ignore_path));
    }
    if (m_reason_isSet) {
...
bool OAIAdd_ignore_request::isDisregardIfFixable() const {
    return m_disregard_if_fixable;
}
void OAIAdd_ignore_request::setDisregardIfFixable(const bool &disregard_if_fixable) {
    m_disregard_if_fixable = disregard_if_fixable;
    m_disregard_if_fixable_isSet = true;
}

bool OAIAdd_ignore_request::is_disregard_if_fixable_Set() const{
    return m_disregard_if_fixable_isSet;
}

bool OAIAdd_ignore_request::is_disregard_if_fixable_Valid() const{
    return m_disregard_if_fixable_isValid;
}

QString OAIAdd_ignore_request::getExpires() const {
    return m_expires;
}
void OAIAdd_ignore_request::setExpires(const QString &expires) {
    m_expires = expires;
    m_expires_isSet = true;
}

bool OAIAdd_ignore_request::is_expires_Set() const{
    return m_expires_isSet;
}

bool OAIAdd_ignore_request::is_expires_Valid() const{
    return m_expires_isValid;
}

QString OAIAdd_ignore_request::getIgnorePath() const {
    return m_ignore_path;
}
void OAIAdd_ignore_request::setIgnorePath(const QString &ignore_path) {
    m_ignore_path = ignore_path;
    m_ignore_path_isSet = true;
}

bool OAIAdd_ignore_request::is_ignore_path_Set() const{
    return m_ignore_path_isSet;
}

bool OAIAdd_ignore_request::is_ignore_path_Valid() const{
    return m_ignore_path_isValid;
}

QString OAIAdd_ignore_request::getReason() const {
    return m_reason;
}
void OAIAdd_ignore_request::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIAdd_ignore_request::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIAdd_ignore_request::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIAdd_ignore_request::getReasonType() const {
    return m_reason_type;
}
void OAIAdd_ignore_request::setReasonType(const QString &reason_type) {
    m_reason_type = reason_type;
    m_reason_type_isSet = true;
}

bool OAIAdd_ignore_request::is_reason_type_Set() const{
    return m_reason_type_isSet;
}

bool OAIAdd_ignore_request::is_reason_type_Valid() const{
    return m_reason_type_isValid;
}

bool OAIAdd_ignore_request::isSet() const {
...
bool OAIAdd_ignore_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_disregard_if_fixable_isValid && m_reason_type_isValid && true;
}
