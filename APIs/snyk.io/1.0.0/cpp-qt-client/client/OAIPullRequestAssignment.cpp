...
#include "OAIPullRequestAssignment.h"
...
OAIPullRequestAssignment::OAIPullRequestAssignment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestAssignment::OAIPullRequestAssignment() {
    this->initializeModel();
}

OAIPullRequestAssignment::~OAIPullRequestAssignment() {}

void OAIPullRequestAssignment::initializeModel() {
...
void OAIPullRequestAssignment::fromJson(QString jsonString) {
...
void OAIPullRequestAssignment::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestAssignment::asJson() const {
...
QJsonObject OAIPullRequestAssignment::asJsonObject() const {
    QJsonObject obj;
...
QList<QJsonValue> OAIPullRequestAssignment::getAssignees() const {
    return m_assignees;
}
void OAIPullRequestAssignment::setAssignees(const QList<QJsonValue> &assignees) {
    m_assignees = assignees;
    m_assignees_isSet = true;
}

bool OAIPullRequestAssignment::is_assignees_Set() const{
    return m_assignees_isSet;
}

bool OAIPullRequestAssignment::is_assignees_Valid() const{
    return m_assignees_isValid;
}

bool OAIPullRequestAssignment::isEnabled() const {
    return m_enabled;
}
void OAIPullRequestAssignment::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIPullRequestAssignment::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIPullRequestAssignment::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAIAssignmentType OAIPullRequestAssignment::getType() const {
    return m_type;
}
void OAIPullRequestAssignment::setType(const OAIAssignmentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPullRequestAssignment::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPullRequestAssignment::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPullRequestAssignment::isSet() const {
...
bool OAIPullRequestAssignment::isValid() const {
