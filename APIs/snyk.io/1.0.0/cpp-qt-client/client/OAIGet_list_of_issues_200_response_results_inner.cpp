...
#include "OAIGet_list_of_issues_200_response_results_inner.h"
...
OAIGet_list_of_issues_200_response_results_inner::OAIGet_list_of_issues_200_response_results_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_list_of_issues_200_response_results_inner::OAIGet_list_of_issues_200_response_results_inner() {
    this->initializeModel();
}

OAIGet_list_of_issues_200_response_results_inner::~OAIGet_list_of_issues_200_response_results_inner() {}

void OAIGet_list_of_issues_200_response_results_inner::initializeModel() {
...
void OAIGet_list_of_issues_200_response_results_inner::fromJson(QString jsonString) {
...
void OAIGet_list_of_issues_200_response_results_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGet_list_of_issues_200_response_results_inner::asJson() const {
...
QJsonObject OAIGet_list_of_issues_200_response_results_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGet_list_of_issues_200_response_results_inner::getFixedDate() const {
    return m_fixed_date;
}
void OAIGet_list_of_issues_200_response_results_inner::setFixedDate(const QString &fixed_date) {
    m_fixed_date = fixed_date;
    m_fixed_date_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_fixed_date_Set() const{
    return m_fixed_date_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_fixed_date_Valid() const{
    return m_fixed_date_isValid;
}

QString OAIGet_list_of_issues_200_response_results_inner::getIntroducedDate() const {
    return m_introduced_date;
}
void OAIGet_list_of_issues_200_response_results_inner::setIntroducedDate(const QString &introduced_date) {
    m_introduced_date = introduced_date;
    m_introduced_date_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_introduced_date_Set() const{
    return m_introduced_date_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_introduced_date_Valid() const{
    return m_introduced_date_isValid;
}

bool OAIGet_list_of_issues_200_response_results_inner::isIsFixed() const {
    return m_is_fixed;
}
void OAIGet_list_of_issues_200_response_results_inner::setIsFixed(const bool &is_fixed) {
    m_is_fixed = is_fixed;
    m_is_fixed_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_is_fixed_Set() const{
    return m_is_fixed_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_is_fixed_Valid() const{
    return m_is_fixed_isValid;
}

OAIGet_list_of_issues_200_response_results_inner_issue OAIGet_list_of_issues_200_response_results_inner::getIssue() const {
    return m_issue;
}
void OAIGet_list_of_issues_200_response_results_inner::setIssue(const OAIGet_list_of_issues_200_response_results_inner_issue &issue) {
    m_issue = issue;
    m_issue_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_issue_Set() const{
    return m_issue_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_issue_Valid() const{
    return m_issue_isValid;
}

QString OAIGet_list_of_issues_200_response_results_inner::getPatchedDate() const {
    return m_patched_date;
}
void OAIGet_list_of_issues_200_response_results_inner::setPatchedDate(const QString &patched_date) {
    m_patched_date = patched_date;
    m_patched_date_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_patched_date_Set() const{
    return m_patched_date_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_patched_date_Valid() const{
    return m_patched_date_isValid;
}

QList<OAIObject> OAIGet_list_of_issues_200_response_results_inner::getProjects() const {
    return m_projects;
}
void OAIGet_list_of_issues_200_response_results_inner::setProjects(const QList<OAIObject> &projects) {
    m_projects = projects;
    m_projects_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_projects_Set() const{
    return m_projects_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_projects_Valid() const{
    return m_projects_isValid;
}

OAIGet_list_of_issues_200_response_results_inner_oneOf_1_project OAIGet_list_of_issues_200_response_results_inner::getProject() const {
    return m_project;
}
void OAIGet_list_of_issues_200_response_results_inner::setProject(const OAIGet_list_of_issues_200_response_results_inner_oneOf_1_project &project) {
    m_project = project;
    m_project_isSet = true;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_project_Set() const{
    return m_project_isSet;
}

bool OAIGet_list_of_issues_200_response_results_inner::is_project_Valid() const{
    return m_project_isValid;
}

bool OAIGet_list_of_issues_200_response_results_inner::isSet() const {
...
bool OAIGet_list_of_issues_200_response_results_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_introduced_date_isValid && m_is_fixed_isValid && m_issue_isValid && m_projects_isValid && m_project_isValid && true;
}
