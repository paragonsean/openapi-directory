...
void OAIIntegrationType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("acr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::ACR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("artifactory-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::ARTIFACTORY_CR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("azure-repos", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::AZURE_REPOS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("bitbucket-cloud", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::BITBUCKET_CLOUD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("bitbucket-server", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::BITBUCKET_SERVER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("digitalocean-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::DIGITALOCEAN_CR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("docker-hub", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::DOCKER_HUB;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ecr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::ECR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("gcr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::GCR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("github", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::GITHUB;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("github-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::GITHUB_CR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("github-enterprise", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::GITHUB_ENTERPRISE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("gitlab", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::GITLAB;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("gitlab-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::GITLAB_CR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("google-artifact-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::GOOGLE_ARTIFACT_CR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("harbor-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::HARBOR_CR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("nexus-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::NEXUS_CR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("quay-cr", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIntegrationType::QUAY_CR;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIIntegrationType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIIntegrationType::ACR:
            val = "acr";
            break;
        case eOAIIntegrationType::ARTIFACTORY_CR:
            val = "artifactory-cr";
            break;
        case eOAIIntegrationType::AZURE_REPOS:
            val = "azure-repos";
            break;
        case eOAIIntegrationType::BITBUCKET_CLOUD:
            val = "bitbucket-cloud";
            break;
        case eOAIIntegrationType::BITBUCKET_SERVER:
            val = "bitbucket-server";
            break;
        case eOAIIntegrationType::DIGITALOCEAN_CR:
            val = "digitalocean-cr";
            break;
        case eOAIIntegrationType::DOCKER_HUB:
            val = "docker-hub";
            break;
        case eOAIIntegrationType::ECR:
            val = "ecr";
            break;
        case eOAIIntegrationType::GCR:
            val = "gcr";
            break;
        case eOAIIntegrationType::GITHUB:
            val = "github";
            break;
        case eOAIIntegrationType::GITHUB_CR:
            val = "github-cr";
            break;
        case eOAIIntegrationType::GITHUB_ENTERPRISE:
            val = "github-enterprise";
            break;
        case eOAIIntegrationType::GITLAB:
            val = "gitlab";
            break;
        case eOAIIntegrationType::GITLAB_CR:
            val = "gitlab-cr";
            break;
        case eOAIIntegrationType::GOOGLE_ARTIFACT_CR:
            val = "google-artifact-cr";
            break;
        case eOAIIntegrationType::HARBOR_CR:
            val = "harbor-cr";
            break;
        case eOAIIntegrationType::NEXUS_CR:
            val = "nexus-cr";
            break;
        case eOAIIntegrationType::QUAY_CR:
            val = "quay-cr";
            break;
        default:
            break;
