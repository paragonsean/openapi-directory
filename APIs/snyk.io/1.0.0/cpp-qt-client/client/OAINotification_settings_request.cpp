...
#include "OAINotification_settings_request.h"
...
OAINotification_settings_request::OAINotification_settings_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotification_settings_request::OAINotification_settings_request() {
    this->initializeModel();
}

OAINotification_settings_request::~OAINotification_settings_request() {}

void OAINotification_settings_request::initializeModel() {
...
void OAINotification_settings_request::fromJson(QString jsonString) {
...
void OAINotification_settings_request::fromJsonObject(QJsonObject json) {
...
QString OAINotification_settings_request::asJson() const {
...
QJsonObject OAINotification_settings_request::asJsonObject() const {
    QJsonObject obj;
...
OAINew_issues_notification_setting_request OAINotification_settings_request::getNewIssuesRemediations() const {
    return m_new_issues_remediations;
}
void OAINotification_settings_request::setNewIssuesRemediations(const OAINew_issues_notification_setting_request &new_issues_remediations) {
    m_new_issues_remediations = new_issues_remediations;
    m_new_issues_remediations_isSet = true;
}

bool OAINotification_settings_request::is_new_issues_remediations_Set() const{
    return m_new_issues_remediations_isSet;
}

bool OAINotification_settings_request::is_new_issues_remediations_Valid() const{
    return m_new_issues_remediations_isValid;
}

OAISimple_notification_setting_request OAINotification_settings_request::getProjectImported() const {
    return m_project_imported;
}
void OAINotification_settings_request::setProjectImported(const OAISimple_notification_setting_request &project_imported) {
    m_project_imported = project_imported;
    m_project_imported_isSet = true;
}

bool OAINotification_settings_request::is_project_imported_Set() const{
    return m_project_imported_isSet;
}

bool OAINotification_settings_request::is_project_imported_Valid() const{
    return m_project_imported_isValid;
}

OAISimple_notification_setting_request OAINotification_settings_request::getTestLimit() const {
    return m_test_limit;
}
void OAINotification_settings_request::setTestLimit(const OAISimple_notification_setting_request &test_limit) {
    m_test_limit = test_limit;
    m_test_limit_isSet = true;
}

bool OAINotification_settings_request::is_test_limit_Set() const{
    return m_test_limit_isSet;
}

bool OAINotification_settings_request::is_test_limit_Valid() const{
    return m_test_limit_isValid;
}

OAISimple_notification_setting_request OAINotification_settings_request::getWeeklyReport() const {
    return m_weekly_report;
}
void OAINotification_settings_request::setWeeklyReport(const OAISimple_notification_setting_request &weekly_report) {
    m_weekly_report = weekly_report;
    m_weekly_report_isSet = true;
}

bool OAINotification_settings_request::is_weekly_report_Set() const{
    return m_weekly_report_isSet;
}

bool OAINotification_settings_request::is_weekly_report_Valid() const{
    return m_weekly_report_isValid;
}

bool OAINotification_settings_request::isSet() const {
...
bool OAINotification_settings_request::isValid() const {
