...
#include "OAIProjects_filters_filters.h"
...
OAIProjects_filters_filters::OAIProjects_filters_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjects_filters_filters::OAIProjects_filters_filters() {
    this->initializeModel();
}

OAIProjects_filters_filters::~OAIProjects_filters_filters() {}

void OAIProjects_filters_filters::initializeModel() {
...
void OAIProjects_filters_filters::fromJson(QString jsonString) {
...
void OAIProjects_filters_filters::fromJsonObject(QJsonObject json) {
...
QString OAIProjects_filters_filters::asJson() const {
...
QJsonObject OAIProjects_filters_filters::asJsonObject() const {
    QJsonObject obj;
...
OAIProject_attributes OAIProjects_filters_filters::getAttributes() const {
    return m_attributes;
}
void OAIProjects_filters_filters::setAttributes(const OAIProject_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIProjects_filters_filters::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIProjects_filters_filters::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIProjects_filters_filters::isIsMonitored() const {
    return m_is_monitored;
}
void OAIProjects_filters_filters::setIsMonitored(const bool &is_monitored) {
    m_is_monitored = is_monitored;
    m_is_monitored_isSet = true;
}

bool OAIProjects_filters_filters::is_is_monitored_Set() const{
    return m_is_monitored_isSet;
}

bool OAIProjects_filters_filters::is_is_monitored_Valid() const{
    return m_is_monitored_isValid;
}

QString OAIProjects_filters_filters::getName() const {
    return m_name;
}
void OAIProjects_filters_filters::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProjects_filters_filters::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProjects_filters_filters::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIProjects_filters_filters::getOrigin() const {
    return m_origin;
}
void OAIProjects_filters_filters::setOrigin(const QString &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIProjects_filters_filters::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIProjects_filters_filters::is_origin_Valid() const{
    return m_origin_isValid;
}

OAIList_all_projects_request_filters_tags OAIProjects_filters_filters::getTags() const {
    return m_tags;
}
void OAIProjects_filters_filters::setTags(const OAIList_all_projects_request_filters_tags &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIProjects_filters_filters::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIProjects_filters_filters::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIProjects_filters_filters::getType() const {
    return m_type;
}
void OAIProjects_filters_filters::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIProjects_filters_filters::is_type_Set() const{
    return m_type_isSet;
}

bool OAIProjects_filters_filters::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIProjects_filters_filters::isSet() const {
...
bool OAIProjects_filters_filters::isValid() const {
