...
OAIUpdate_existing_integration_request::OAIUpdate_existing_integration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdate_existing_integration_request::OAIUpdate_existing_integration_request() {
    this->initializeModel();
}

OAIUpdate_existing_integration_request::~OAIUpdate_existing_integration_request() {}

void OAIUpdate_existing_integration_request::initializeModel() {
...
void OAIUpdate_existing_integration_request::fromJson(QString jsonString) {
...
void OAIUpdate_existing_integration_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdate_existing_integration_request::asJson() const {
...
QJsonObject OAIUpdate_existing_integration_request::asJsonObject() const {
    QJsonObject obj;
    if (m_broker.isSet()) {
...
OAIAdd_new_integration_request_anyOf_1_broker OAIUpdate_existing_integration_request::getBroker() const {
    return m_broker;
}
void OAIUpdate_existing_integration_request::setBroker(const OAIAdd_new_integration_request_anyOf_1_broker &broker) {
    m_broker = broker;
    m_broker_isSet = true;
}

bool OAIUpdate_existing_integration_request::is_broker_Set() const{
    return m_broker_isSet;
}

bool OAIUpdate_existing_integration_request::is_broker_Valid() const{
    return m_broker_isValid;
}

QString OAIUpdate_existing_integration_request::getType() const {
    return m_type;
}
void OAIUpdate_existing_integration_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdate_existing_integration_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdate_existing_integration_request::is_type_Valid() const{
    return m_type_isValid;
}

OAIAdd_new_integration_request_anyOf_credentials OAIUpdate_existing_integration_request::getCredentials() const {
    return m_credentials;
}
void OAIUpdate_existing_integration_request::setCredentials(const OAIAdd_new_integration_request_anyOf_credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIUpdate_existing_integration_request::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIUpdate_existing_integration_request::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIUpdate_existing_integration_request::isSet() const {
...
bool OAIUpdate_existing_integration_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_broker_isValid && m_type_isValid && m_credentials_isValid && true;
}
