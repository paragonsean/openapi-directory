...
OAIProject_attributes OAIProject::getAttributes() const {
    return m_attributes;
}
void OAIProject::setAttributes(const OAIProject_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIProject::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIProject::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIProject::getBranch() const {
    return m_branch;
}
void OAIProject::setBranch(const QString &branch) {
    m_branch = branch;
    m_branch_isSet = true;
}

bool OAIProject::is_branch_Set() const{
    return m_branch_isSet;
}

bool OAIProject::is_branch_Valid() const{
    return m_branch_isValid;
}

QString OAIProject::getBrowseUrl() const {
    return m_browse_url;
}
void OAIProject::setBrowseUrl(const QString &browse_url) {
    m_browse_url = browse_url;
    m_browse_url_isSet = true;
}

bool OAIProject::is_browse_url_Set() const{
    return m_browse_url_isSet;
}

bool OAIProject::is_browse_url_Valid() const{
...
QString OAIProject::getHostname() const {
    return m_hostname;
}
void OAIProject::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAIProject::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAIProject::is_hostname_Valid() const{
...
QString OAIProject::getImageBaseImage() const {
    return m_image_base_image;
}
void OAIProject::setImageBaseImage(const QString &image_base_image) {
    m_image_base_image = image_base_image;
    m_image_base_image_isSet = true;
}

bool OAIProject::is_image_base_image_Set() const{
    return m_image_base_image_isSet;
}

bool OAIProject::is_image_base_image_Valid() const{
    return m_image_base_image_isValid;
}

QString OAIProject::getImageCluster() const {
    return m_image_cluster;
}
void OAIProject::setImageCluster(const QString &image_cluster) {
    m_image_cluster = image_cluster;
    m_image_cluster_isSet = true;
}

bool OAIProject::is_image_cluster_Set() const{
    return m_image_cluster_isSet;
}

bool OAIProject::is_image_cluster_Valid() const{
    return m_image_cluster_isValid;
}

QString OAIProject::getImageId() const {
    return m_image_id;
}
void OAIProject::setImageId(const QString &image_id) {
    m_image_id = image_id;
    m_image_id_isSet = true;
}

bool OAIProject::is_image_id_Set() const{
    return m_image_id_isSet;
}

bool OAIProject::is_image_id_Valid() const{
    return m_image_id_isValid;
}

QString OAIProject::getImagePlatform() const {
    return m_image_platform;
}
void OAIProject::setImagePlatform(const QString &image_platform) {
    m_image_platform = image_platform;
    m_image_platform_isSet = true;
}

bool OAIProject::is_image_platform_Set() const{
    return m_image_platform_isSet;
}

bool OAIProject::is_image_platform_Valid() const{
    return m_image_platform_isValid;
}

QString OAIProject::getImageTag() const {
    return m_image_tag;
}
void OAIProject::setImageTag(const QString &image_tag) {
    m_image_tag = image_tag;
    m_image_tag_isSet = true;
}

bool OAIProject::is_image_tag_Set() const{
    return m_image_tag_isSet;
}

bool OAIProject::is_image_tag_Valid() const{
    return m_image_tag_isValid;
}

OAIRetrieve_a_single_project_200_response_importingUser OAIProject::getImportingUser() const {
    return m_importing_user;
}
void OAIProject::setImportingUser(const OAIRetrieve_a_single_project_200_response_importingUser &importing_user) {
    m_importing_user = importing_user;
    m_importing_user_isSet = true;
}

bool OAIProject::is_importing_user_Set() const{
    return m_importing_user_isSet;
}

bool OAIProject::is_importing_user_Valid() const{
    return m_importing_user_isValid;
}

bool OAIProject::isIsMonitored() const {
    return m_is_monitored;
}
void OAIProject::setIsMonitored(const bool &is_monitored) {
    m_is_monitored = is_monitored;
    m_is_monitored_isSet = true;
}

bool OAIProject::is_is_monitored_Set() const{
    return m_is_monitored_isSet;
}

bool OAIProject::is_is_monitored_Valid() const{
    return m_is_monitored_isValid;
}

OAIRetrieve_a_single_project_200_response_issueCountsBySeverity OAIProject::getIssueCountsBySeverity() const {
    return m_issue_counts_by_severity;
}
void OAIProject::setIssueCountsBySeverity(const OAIRetrieve_a_single_project_200_response_issueCountsBySeverity &issue_counts_by_severity) {
    m_issue_counts_by_severity = issue_counts_by_severity;
    m_issue_counts_by_severity_isSet = true;
}

bool OAIProject::is_issue_counts_by_severity_Set() const{
    return m_issue_counts_by_severity_isSet;
}

bool OAIProject::is_issue_counts_by_severity_Valid() const{
    return m_issue_counts_by_severity_isValid;
}

QString OAIProject::getLastTestedDate() const {
    return m_last_tested_date;
}
void OAIProject::setLastTestedDate(const QString &last_tested_date) {
    m_last_tested_date = last_tested_date;
    m_last_tested_date_isSet = true;
}

bool OAIProject::is_last_tested_date_Set() const{
    return m_last_tested_date_isSet;
}

bool OAIProject::is_last_tested_date_Valid() const{
...
QString OAIProject::getOrigin() const {
    return m_origin;
}
void OAIProject::setOrigin(const QString &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIProject::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIProject::is_origin_Valid() const{
    return m_origin_isValid;
}

OAIObject OAIProject::getOwner() const {
    return m_owner;
}
void OAIProject::setOwner(const OAIObject &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}
...
bool OAIProject::isReadOnly() const {
    return m_read_only;
}
void OAIProject::setReadOnly(const bool &read_only) {
    m_read_only = read_only;
    m_read_only_isSet = true;
}

bool OAIProject::is_read_only_Set() const{
    return m_read_only_isSet;
}

bool OAIProject::is_read_only_Valid() const{
    return m_read_only_isValid;
}

OAIRetrieve_a_single_project_200_response_remediation OAIProject::getRemediation() const {
    return m_remediation;
}
void OAIProject::setRemediation(const OAIRetrieve_a_single_project_200_response_remediation &remediation) {
    m_remediation = remediation;
    m_remediation_isSet = true;
}

bool OAIProject::is_remediation_Set() const{
    return m_remediation_isSet;
}

bool OAIProject::is_remediation_Valid() const{
    return m_remediation_isValid;
}

QString OAIProject::getRemoteRepoUrl() const {
    return m_remote_repo_url;
}
void OAIProject::setRemoteRepoUrl(const QString &remote_repo_url) {
    m_remote_repo_url = remote_repo_url;
    m_remote_repo_url_isSet = true;
}

bool OAIProject::is_remote_repo_url_Set() const{
    return m_remote_repo_url_isSet;
}

bool OAIProject::is_remote_repo_url_Valid() const{
    return m_remote_repo_url_isValid;
}

QList<QJsonValue> OAIProject::getTags() const {
    return m_tags;
}
void OAIProject::setTags(const QList<QJsonValue> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIProject::getTargetReference() const {
    return m_target_reference;
}
void OAIProject::setTargetReference(const QString &target_reference) {
    m_target_reference = target_reference;
    m_target_reference_isSet = true;
}

bool OAIProject::is_target_reference_Set() const{
    return m_target_reference_isSet;
}

bool OAIProject::is_target_reference_Valid() const{
    return m_target_reference_isValid;
}

QString OAIProject::getTestFrequency() const {
    return m_test_frequency;
}
void OAIProject::setTestFrequency(const QString &test_frequency) {
    m_test_frequency = test_frequency;
    m_test_frequency_isSet = true;
}

bool OAIProject::is_test_frequency_Set() const{
    return m_test_frequency_isSet;
}

bool OAIProject::is_test_frequency_Valid() const{
    return m_test_frequency_isValid;
}

double OAIProject::getTotalDependencies() const {
    return m_total_dependencies;
}
void OAIProject::setTotalDependencies(const double &total_dependencies) {
    m_total_dependencies = total_dependencies;
    m_total_dependencies_isSet = true;
}

bool OAIProject::is_total_dependencies_Set() const{
    return m_total_dependencies_isSet;
}

bool OAIProject::is_total_dependencies_Valid() const{
