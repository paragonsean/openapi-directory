...
OAIIgnore_rule::OAIIgnore_rule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIgnore_rule::OAIIgnore_rule() {
    this->initializeModel();
}

OAIIgnore_rule::~OAIIgnore_rule() {}

void OAIIgnore_rule::initializeModel() {
...
void OAIIgnore_rule::fromJson(QString jsonString) {
...
void OAIIgnore_rule::fromJsonObject(QJsonObject json) {
...
QString OAIIgnore_rule::asJson() const {
...
QJsonObject OAIIgnore_rule::asJsonObject() const {
    QJsonObject obj;
...
bool OAIIgnore_rule::isDisregardIfFixable() const {
    return m_disregard_if_fixable;
}
void OAIIgnore_rule::setDisregardIfFixable(const bool &disregard_if_fixable) {
    m_disregard_if_fixable = disregard_if_fixable;
    m_disregard_if_fixable_isSet = true;
}

bool OAIIgnore_rule::is_disregard_if_fixable_Set() const{
    return m_disregard_if_fixable_isSet;
}

bool OAIIgnore_rule::is_disregard_if_fixable_Valid() const{
    return m_disregard_if_fixable_isValid;
}

QString OAIIgnore_rule::getExpires() const {
    return m_expires;
}
void OAIIgnore_rule::setExpires(const QString &expires) {
    m_expires = expires;
    m_expires_isSet = true;
}

bool OAIIgnore_rule::is_expires_Set() const{
    return m_expires_isSet;
}

bool OAIIgnore_rule::is_expires_Valid() const{
    return m_expires_isValid;
}

QString OAIIgnore_rule::getIgnorePath() const {
    return m_ignore_path;
}
void OAIIgnore_rule::setIgnorePath(const QString &ignore_path) {
    m_ignore_path = ignore_path;
    m_ignore_path_isSet = true;
}

bool OAIIgnore_rule::is_ignore_path_Set() const{
    return m_ignore_path_isSet;
}

bool OAIIgnore_rule::is_ignore_path_Valid() const{
    return m_ignore_path_isValid;
}

QString OAIIgnore_rule::getReason() const {
    return m_reason;
}
void OAIIgnore_rule::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIIgnore_rule::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIIgnore_rule::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIIgnore_rule::getReasonType() const {
    return m_reason_type;
}
void OAIIgnore_rule::setReasonType(const QString &reason_type) {
    m_reason_type = reason_type;
    m_reason_type_isSet = true;
}

bool OAIIgnore_rule::is_reason_type_Set() const{
    return m_reason_type_isSet;
}

bool OAIIgnore_rule::is_reason_type_Valid() const{
    return m_reason_type_isValid;
}

bool OAIIgnore_rule::isSet() const {
...
bool OAIIgnore_rule::isValid() const {
