...
void OAIWebhooksApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("create_a_webhook", defaultConf);
    _serverIndices.insert("create_a_webhook", 0);
    _serverConfigs.insert("delete_a_webhook", defaultConf);
    _serverIndices.insert("delete_a_webhook", 0);
    _serverConfigs.insert("list_webhooks", defaultConf);
    _serverIndices.insert("list_webhooks", 0);
    _serverConfigs.insert("ping_a_webhook", defaultConf);
    _serverIndices.insert("ping_a_webhook", 0);
    _serverConfigs.insert("retrieve_a_webhook", defaultConf);
    _serverIndices.insert("retrieve_a_webhook", 0);
}
...
void OAIWebhooksApi::create_a_webhook(const QString &org_id, const ::OpenAPI::OptionalParam<OAICreate_a_webhook_request> &oai_create_a_webhook_request) {
    QString fullPath = QString(_serverConfigs["create_a_webhook"][_serverIndices.value("create_a_webhook")].URL()+"/org/{orgId}/webhooks");
    ...
    if (oai_create_a_webhook_request.hasValue()){

        
        QByteArray output = oai_create_a_webhook_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::create_a_webhookCallback);
...
void OAIWebhooksApi::create_a_webhookCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT create_a_webhookSignal();
        Q_EMIT create_a_webhookSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT create_a_webhookSignalE(error_type, error_str);
        Q_EMIT create_a_webhookSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT create_a_webhookSignalError(error_type, error_str);
        Q_EMIT create_a_webhookSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWebhooksApi::delete_a_webhook(const QString &org_id, const QString &webhook_id) {
    QString fullPath = QString(_serverConfigs["delete_a_webhook"][_serverIndices.value("delete_a_webhook")].URL()+"/org/{orgId}/webhooks/{webhookId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::delete_a_webhookCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::delete_a_webhookCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT delete_a_webhookSignal();
        Q_EMIT delete_a_webhookSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT delete_a_webhookSignalE(error_type, error_str);
        Q_EMIT delete_a_webhookSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT delete_a_webhookSignalError(error_type, error_str);
        Q_EMIT delete_a_webhookSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWebhooksApi::list_webhooks(const QString &org_id) {
    QString fullPath = QString(_serverConfigs["list_webhooks"][_serverIndices.value("list_webhooks")].URL()+"/org/{orgId}/webhooks");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::list_webhooksCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::list_webhooksCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT list_webhooksSignal();
        Q_EMIT list_webhooksSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT list_webhooksSignalE(error_type, error_str);
        Q_EMIT list_webhooksSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT list_webhooksSignalError(error_type, error_str);
        Q_EMIT list_webhooksSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWebhooksApi::ping_a_webhook(const QString &org_id, const QString &webhook_id) {
    QString fullPath = QString(_serverConfigs["ping_a_webhook"][_serverIndices.value("ping_a_webhook")].URL()+"/org/{orgId}/webhooks/{webhookId}/ping");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::ping_a_webhookCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::ping_a_webhookCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ping_a_webhookSignal();
        Q_EMIT ping_a_webhookSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ping_a_webhookSignalE(error_type, error_str);
        Q_EMIT ping_a_webhookSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ping_a_webhookSignalError(error_type, error_str);
        Q_EMIT ping_a_webhookSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWebhooksApi::retrieve_a_webhook(const QString &org_id, const QString &webhook_id) {
    QString fullPath = QString(_serverConfigs["retrieve_a_webhook"][_serverIndices.value("retrieve_a_webhook")].URL()+"/org/{orgId}/webhooks/{webhookId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::retrieve_a_webhookCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::retrieve_a_webhookCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT retrieve_a_webhookSignal();
        Q_EMIT retrieve_a_webhookSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT retrieve_a_webhookSignalE(error_type, error_str);
        Q_EMIT retrieve_a_webhookSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT retrieve_a_webhookSignalError(error_type, error_str);
        Q_EMIT retrieve_a_webhookSignalErrorFull(worker, error_type, error_str);
    }
}
