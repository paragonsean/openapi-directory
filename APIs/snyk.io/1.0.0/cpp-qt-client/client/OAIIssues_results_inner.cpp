...
#include "OAIIssues_results_inner.h"
...
OAIIssues_results_inner::OAIIssues_results_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIssues_results_inner::OAIIssues_results_inner() {
    this->initializeModel();
}

OAIIssues_results_inner::~OAIIssues_results_inner() {}

void OAIIssues_results_inner::initializeModel() {

    m_fixed_date_isSet = false;
    m_fixed_date_isValid = false;

    m_introduced_date_isSet = false;
    m_introduced_date_isValid = false;
    ...
    m_patched_date_isSet = false;
    m_patched_date_isValid = false;
}

void OAIIssues_results_inner::fromJson(QString jsonString) {
...
void OAIIssues_results_inner::fromJsonObject(QJsonObject json) {
    ...
    m_introduced_date_isValid = ::OpenAPI::fromJsonValue(m_introduced_date, json[QString("introducedDate")]);
    m_introduced_date_isSet = !json[QString("introducedDate")].isNull() && m_introduced_date_isValid;
    ...
    m_patched_date_isValid = ::OpenAPI::fromJsonValue(m_patched_date, json[QString("patchedDate")]);
    m_patched_date_isSet = !json[QString("patchedDate")].isNull() && m_patched_date_isValid;
}

QString OAIIssues_results_inner::asJson() const {
...
QJsonObject OAIIssues_results_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_fixed_date_isSet) {
        obj.insert(QString("fixedDate"), ::OpenAPI::toJsonValue(m_fixed_date));
    }
    if (m_introduced_date_isSet) {
        obj.insert(QString("introducedDate"), ::OpenAPI::toJsonValue(m_introduced_date));
    }
    if (m_is_fixed_isSet) {
    ...
    if (m_patched_date_isSet) {
        obj.insert(QString("patchedDate"), ::OpenAPI::toJsonValue(m_patched_date));
    }
    return obj;
}

QString OAIIssues_results_inner::getFixedDate() const {
    return m_fixed_date;
}
void OAIIssues_results_inner::setFixedDate(const QString &fixed_date) {
    m_fixed_date = fixed_date;
    m_fixed_date_isSet = true;
}

bool OAIIssues_results_inner::is_fixed_date_Set() const{
    return m_fixed_date_isSet;
}

bool OAIIssues_results_inner::is_fixed_date_Valid() const{
    return m_fixed_date_isValid;
}

QString OAIIssues_results_inner::getIntroducedDate() const {
    return m_introduced_date;
}
void OAIIssues_results_inner::setIntroducedDate(const QString &introduced_date) {
    m_introduced_date = introduced_date;
    m_introduced_date_isSet = true;
}

bool OAIIssues_results_inner::is_introduced_date_Set() const{
    return m_introduced_date_isSet;
}

bool OAIIssues_results_inner::is_introduced_date_Valid() const{
    return m_introduced_date_isValid;
}

bool OAIIssues_results_inner::isIsFixed() const {
    return m_is_fixed;
}
void OAIIssues_results_inner::setIsFixed(const bool &is_fixed) {
    m_is_fixed = is_fixed;
    m_is_fixed_isSet = true;
}

bool OAIIssues_results_inner::is_is_fixed_Set() const{
    return m_is_fixed_isSet;
}

bool OAIIssues_results_inner::is_is_fixed_Valid() const{
    return m_is_fixed_isValid;
}

OAIGet_list_of_issues_200_response_results_inner_issue OAIIssues_results_inner::getIssue() const {
    return m_issue;
}
void OAIIssues_results_inner::setIssue(const OAIGet_list_of_issues_200_response_results_inner_issue &issue) {
    m_issue = issue;
    m_issue_isSet = true;
}

bool OAIIssues_results_inner::is_issue_Set() const{
    return m_issue_isSet;
}

bool OAIIssues_results_inner::is_issue_Valid() const{
    return m_issue_isValid;
}

QString OAIIssues_results_inner::getPatchedDate() const {
    return m_patched_date;
}
void OAIIssues_results_inner::setPatchedDate(const QString &patched_date) {
    m_patched_date = patched_date;
    m_patched_date_isSet = true;
}

bool OAIIssues_results_inner::is_patched_date_Set() const{
    return m_patched_date_isSet;
}

bool OAIIssues_results_inner::is_patched_date_Valid() const{
    return m_patched_date_isValid;
}

bool OAIIssues_results_inner::isSet() const {
...
bool OAIIssues_results_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_introduced_date_isValid && m_is_fixed_isValid && m_issue_isValid && true;
}
