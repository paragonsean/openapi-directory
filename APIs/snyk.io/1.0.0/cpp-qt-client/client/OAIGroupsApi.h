...
#include "OAIAdd_a_member_to_an_organization_within_a_group_request.h"
#include "OAIDelete_tag_from_group_200_response.h"
#include "OAIDelete_tag_from_group_request.h"
#include "OAIList_all_tags_in_a_group_200_response.h"
#include "OAIView_group_settings_200_response.h"
#include <QJsonValue>
#include <QString>
...
public:
    ...
    * @param[in]  oai_add_a_member_to_an_organization_within_a_group_request OAIAdd_a_member_to_an_organization_within_a_group_request [optional]
    */
    virtual void add_a_member_to_an_organization_within_a_group(const QString &group_id, const QString &org_id, const ::OpenAPI::OptionalParam<OAIAdd_a_member_to_an_organization_within_a_group_request> &oai_add_a_member_to_an_organization_within_a_group_request = ::OpenAPI::OptionalParam<OAIAdd_a_member_to_an_organization_within_a_group_request>());

    /**
    * @param[in]  group_id QString [required]
    * @param[in]  oai_delete_tag_from_group_request OAIDelete_tag_from_group_request [optional]
    */
    virtual void delete_tag_from_group(const QString &group_id, const ::OpenAPI::OptionalParam<OAIDelete_tag_from_group_request> &oai_delete_tag_from_group_request = ::OpenAPI::OptionalParam<OAIDelete_tag_from_group_request>());

    /**
    * @param[in]  group_id QString [required]
    */
    virtual void list_all_members_in_a_group(const QString &group_id);
    ...
    */
    virtual void list_all_organizations_in_a_group(const QString &group_id, const ::OpenAPI::OptionalParam<double> &per_page = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<double> &page = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  group_id QString [required]
    */
    virtual void list_all_roles_in_a_group(const QString &group_id);
    ...
    * @param[in]  page double [optional]
    */
    virtual void list_all_tags_in_a_group(const QString &group_id, const ::OpenAPI::OptionalParam<double> &per_page = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<double> &page = ::OpenAPI::OptionalParam<double>());

    /**
    * @param[in]  group_id QString [required]
    */
    virtual void update_group_settings(const QString &group_id);

    /**
    * @param[in]  group_id QString [required]
    */
    virtual void view_group_settings(const QString &group_id);
...
private:
    ...
    void add_a_member_to_an_organization_within_a_groupCallback(OAIHttpRequestWorker *worker);
    void delete_tag_from_groupCallback(OAIHttpRequestWorker *worker);
    void list_all_members_in_a_groupCallback(OAIHttpRequestWorker *worker);
    void list_all_organizations_in_a_groupCallback(OAIHttpRequestWorker *worker);
    void list_all_roles_in_a_groupCallback(OAIHttpRequestWorker *worker);
    void list_all_tags_in_a_groupCallback(OAIHttpRequestWorker *worker);
    void update_group_settingsCallback(OAIHttpRequestWorker *worker);
    void view_group_settingsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_a_member_to_an_organization_within_a_groupSignal();
    void delete_tag_from_groupSignal(OAIDelete_tag_from_group_200_response summary);
    void list_all_members_in_a_groupSignal(QList<QJsonValue> summary);
    void list_all_organizations_in_a_groupSignal();
    void list_all_roles_in_a_groupSignal();
    void list_all_tags_in_a_groupSignal(OAIList_all_tags_in_a_group_200_response summary);
    void update_group_settingsSignal(OAIView_group_settings_200_response summary);
    void view_group_settingsSignal(OAIView_group_settings_200_response summary);


    void add_a_member_to_an_organization_within_a_groupSignalFull(OAIHttpRequestWorker *worker);
    void delete_tag_from_groupSignalFull(OAIHttpRequestWorker *worker, OAIDelete_tag_from_group_200_response summary);
    void list_all_members_in_a_groupSignalFull(OAIHttpRequestWorker *worker, QList<QJsonValue> summary);
    void list_all_organizations_in_a_groupSignalFull(OAIHttpRequestWorker *worker);
    void list_all_roles_in_a_groupSignalFull(OAIHttpRequestWorker *worker);
    void list_all_tags_in_a_groupSignalFull(OAIHttpRequestWorker *worker, OAIList_all_tags_in_a_group_200_response summary);
    void update_group_settingsSignalFull(OAIHttpRequestWorker *worker, OAIView_group_settings_200_response summary);
    void view_group_settingsSignalFull(OAIHttpRequestWorker *worker, OAIView_group_settings_200_response summary);

    Q_DECL_DEPRECATED_X("Use add_a_member_to_an_organization_within_a_groupSignalError() instead")
    void add_a_member_to_an_organization_within_a_groupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_a_member_to_an_organization_within_a_groupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_tag_from_groupSignalError() instead")
    void delete_tag_from_groupSignalE(OAIDelete_tag_from_group_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void delete_tag_from_groupSignalError(OAIDelete_tag_from_group_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_members_in_a_groupSignalError() instead")
    void list_all_members_in_a_groupSignalE(QList<QJsonValue> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_members_in_a_groupSignalError(QList<QJsonValue> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_organizations_in_a_groupSignalError() instead")
    void list_all_organizations_in_a_groupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_organizations_in_a_groupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_roles_in_a_groupSignalError() instead")
    void list_all_roles_in_a_groupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_roles_in_a_groupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_tags_in_a_groupSignalError() instead")
    void list_all_tags_in_a_groupSignalE(OAIList_all_tags_in_a_group_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_tags_in_a_groupSignalError(OAIList_all_tags_in_a_group_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use update_group_settingsSignalError() instead")
    void update_group_settingsSignalE(OAIView_group_settings_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void update_group_settingsSignalError(OAIView_group_settings_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use view_group_settingsSignalError() instead")
    void view_group_settingsSignalE(OAIView_group_settings_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void view_group_settingsSignalError(OAIView_group_settings_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_a_member_to_an_organization_within_a_groupSignalErrorFull() instead")
    void add_a_member_to_an_organization_within_a_groupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_a_member_to_an_organization_within_a_groupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_tag_from_groupSignalErrorFull() instead")
    void delete_tag_from_groupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void delete_tag_from_groupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_members_in_a_groupSignalErrorFull() instead")
    void list_all_members_in_a_groupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_members_in_a_groupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_organizations_in_a_groupSignalErrorFull() instead")
    void list_all_organizations_in_a_groupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_organizations_in_a_groupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_roles_in_a_groupSignalErrorFull() instead")
    void list_all_roles_in_a_groupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_roles_in_a_groupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use list_all_tags_in_a_groupSignalErrorFull() instead")
    void list_all_tags_in_a_groupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void list_all_tags_in_a_groupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use update_group_settingsSignalErrorFull() instead")
    void update_group_settingsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void update_group_settingsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use view_group_settingsSignalErrorFull() instead")
    void view_group_settingsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void view_group_settingsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
