...
class Example : public QObject {
    ...
    double create();
    QString create();
    OAIGet_group_level_audit_logs_request create();
public Q_SLOTS:
...
QString Example::create(){
    QString obj;
OAIGet_group_level_audit_logs_request Example::create(){
    OAIGet_group_level_audit_logs_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAuditLogsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAuditLogsApi::get_group_level_audit_logsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAuditLogsApi::get_group_level_audit_logsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString group_id = create(); // QString | The group ID. The `API_KEY` must have access to this group.
      ...
      QString from = create(); // QString | The date you wish to fetch results from, in the format YYYY-MM-DD. Default is 3 months ago. Please note that logs are only available for past 3 months.
      ...
      QString to = create(); // QString | The date you wish to fetch results until, in the format YYYY-MM-DD. Default is today. Please note that logs are only available for past 3 months.
      ...
      double page = create(); // double | The page of results to request. Audit logs are returned in page sizes of 100
      ...
      QString sort_order = create(); // QString | The sort order of the returned audit logs by date. Values: `ASC`, `DESC`. Default: `DESC`.
      ...
      OAIGet_group_level_audit_logs_request oai_get_group_level_audit_logs_request = create(); // OAIGet_group_level_audit_logs_request | 
      apiInstance.get_group_level_audit_logs(group_idfromtopagesort_orderoai_get_group_level_audit_logs_request);
