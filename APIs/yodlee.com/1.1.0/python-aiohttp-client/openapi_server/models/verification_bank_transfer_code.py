...
class VerificationBankTransferCode(Model):
    ...
    def __init__(self, id: str=None, type: str=None):
        """VerificationBankTransferCode - a model defined in OpenAPI

        :param id: The id of this VerificationBankTransferCode.
        :param type: The type of this VerificationBankTransferCode.
        """
        self.openapi_types = {
            'id': str,
            'type': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VerificationBankTransferCode':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The VerificationBankTransferCode of this VerificationBankTransferCode.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this VerificationBankTransferCode.
        ...
        :return: The id of this VerificationBankTransferCode.
        :rtype: str
        """
        return self._id
    ...
    @property
    def type(self):
        """Gets the type of this VerificationBankTransferCode.
        ...
        :return: The type of this VerificationBankTransferCode.
        :rtype: str
        """
        return self._type
