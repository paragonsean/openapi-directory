...
class UpdateCobrandNotificationEvent(Model):
    ...
    def __init__(self, callback_url: str=None):
        """UpdateCobrandNotificationEvent - a model defined in OpenAPI

        :param callback_url: The callback_url of this UpdateCobrandNotificationEvent.
        """
        self.openapi_types = {
            'callback_url': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateCobrandNotificationEvent':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateCobrandNotificationEvent of this UpdateCobrandNotificationEvent.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def callback_url(self):
        """Gets the callback_url of this UpdateCobrandNotificationEvent.

        URL to which the notification should be posted.<br><br><b>Endpoints</b>:<ul><li>GET cobrand/config/notifications/events</li></ul>

        :return: The callback_url of this UpdateCobrandNotificationEvent.
        :rtype: str
        """
