...
/*
 * OAIUpdateAccountInfo.h
 *
 * 
 */

#ifndef OAIUpdateAccountInfo_H
#define OAIUpdateAccountInfo_H
...
class OAIUpdateAccountInfo : public OAIObject {
public:
    OAIUpdateAccountInfo();
    OAIUpdateAccountInfo(QString json);
    ~OAIUpdateAccountInfo() override;
    ...
    QString getIsEbillEnrolled() const;
    void setIsEbillEnrolled(const QString &is_ebill_enrolled);
    bool is_is_ebill_enrolled_Set() const;
    bool is_is_ebill_enrolled_Valid() const;
...
private:
    ...
    QString m_is_ebill_enrolled;
    bool m_is_ebill_enrolled_isSet;
    bool m_is_ebill_enrolled_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccountInfo)

#endif // OAIUpdateAccountInfo_H
