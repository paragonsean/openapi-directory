...
/*
 * OAIDataExtractsProviderAccount.h
 *
 * 
 */

#ifndef OAIDataExtractsProviderAccount_H
#define OAIDataExtractsProviderAccount_H
...
class OAIDataExtractsProviderAccount : public OAIObject {
public:
    OAIDataExtractsProviderAccount();
    OAIDataExtractsProviderAccount(QString json);
    ~OAIDataExtractsProviderAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataExtractsProviderAccount)

#endif // OAIDataExtractsProviderAccount_H
