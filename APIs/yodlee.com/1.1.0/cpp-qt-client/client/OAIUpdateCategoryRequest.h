...
/*
 * OAIUpdateCategoryRequest.h
 *
 * 
 */

#ifndef OAIUpdateCategoryRequest_H
#define OAIUpdateCategoryRequest_H
...
class OAIUpdateCategoryRequest : public OAIObject {
public:
    OAIUpdateCategoryRequest();
    OAIUpdateCategoryRequest(QString json);
    ~OAIUpdateCategoryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCategoryRequest)

#endif // OAIUpdateCategoryRequest_H
