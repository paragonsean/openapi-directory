...
/*
 * OAIUserResponsePreferences.h
 *
 * 
 */

#ifndef OAIUserResponsePreferences_H
#define OAIUserResponsePreferences_H
...
class OAIUserResponsePreferences : public OAIObject {
public:
    OAIUserResponsePreferences();
    OAIUserResponsePreferences(QString json);
    ~OAIUserResponsePreferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserResponsePreferences)

#endif // OAIUserResponsePreferences_H
