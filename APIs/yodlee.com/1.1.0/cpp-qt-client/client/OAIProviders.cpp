...
OAIProviders::OAIProviders(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProviders::OAIProviders() {
    this->initializeModel();
}

OAIProviders::~OAIProviders() {}

void OAIProviders::initializeModel() {
...
void OAIProviders::fromJson(QString jsonString) {
...
void OAIProviders::fromJsonObject(QJsonObject json) {
...
QString OAIProviders::asJson() const {
...
QJsonObject OAIProviders::asJsonObject() const {
    QJsonObject obj;
    if (m_priority_isSet) {
...
QString OAIProviders::getPriority() const {
    return m_priority;
}
void OAIProviders::setPriority(const QString &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIProviders::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIProviders::is_priority_Valid() const{
    return m_priority_isValid;
}

QList<QString> OAIProviders::getAccountType() const {
    return m_account_type;
}
void OAIProviders::setAccountType(const QList<QString> &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIProviders::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIProviders::is_account_type_Valid() const{
    return m_account_type_isValid;
}

QList<qint64> OAIProviders::getAssociatedProviderIds() const {
    return m_associated_provider_ids;
}
void OAIProviders::setAssociatedProviderIds(const QList<qint64> &associated_provider_ids) {
    m_associated_provider_ids = associated_provider_ids;
    m_associated_provider_ids_isSet = true;
}

bool OAIProviders::is_associated_provider_ids_Set() const{
    return m_associated_provider_ids_isSet;
}

bool OAIProviders::is_associated_provider_ids_Valid() const{
    return m_associated_provider_ids_isValid;
}

QList<QString> OAIProviders::getAuthParameter() const {
    return m_auth_parameter;
}
void OAIProviders::setAuthParameter(const QList<QString> &auth_parameter) {
    m_auth_parameter = auth_parameter;
    m_auth_parameter_isSet = true;
}

bool OAIProviders::is_auth_parameter_Set() const{
    return m_auth_parameter_isSet;
}

bool OAIProviders::is_auth_parameter_Valid() const{
    return m_auth_parameter_isValid;
}

QString OAIProviders::getAuthType() const {
    return m_auth_type;
}
void OAIProviders::setAuthType(const QString &auth_type) {
    m_auth_type = auth_type;
    m_auth_type_isSet = true;
}

bool OAIProviders::is_auth_type_Set() const{
    return m_auth_type_isSet;
}

bool OAIProviders::is_auth_type_Valid() const{
    return m_auth_type_isValid;
}

QString OAIProviders::getBaseUrl() const {
    return m_base_url;
}
void OAIProviders::setBaseUrl(const QString &base_url) {
    m_base_url = base_url;
    m_base_url_isSet = true;
}

bool OAIProviders::is_base_url_Set() const{
    return m_base_url_isSet;
}

bool OAIProviders::is_base_url_Valid() const{
    return m_base_url_isValid;
}

QList<OAICapability> OAIProviders::getCapability() const {
    return m_capability;
}
void OAIProviders::setCapability(const QList<OAICapability> &capability) {
    m_capability = capability;
    m_capability_isSet = true;
}

bool OAIProviders::is_capability_Set() const{
    return m_capability_isSet;
}

bool OAIProviders::is_capability_Valid() const{
    return m_capability_isValid;
}

QString OAIProviders::getCountryIsoCode() const {
    return m_country_iso_code;
}
void OAIProviders::setCountryIsoCode(const QString &country_iso_code) {
    m_country_iso_code = country_iso_code;
    m_country_iso_code_isSet = true;
}

bool OAIProviders::is_country_iso_code_Set() const{
    return m_country_iso_code_isSet;
}

bool OAIProviders::is_country_iso_code_Valid() const{
    return m_country_iso_code_isValid;
}

QList<OAIProvidersDataset> OAIProviders::getDataset() const {
    return m_dataset;
}
void OAIProviders::setDataset(const QList<OAIProvidersDataset> &dataset) {
    m_dataset = dataset;
    m_dataset_isSet = true;
}

bool OAIProviders::is_dataset_Set() const{
    return m_dataset_isSet;
}

bool OAIProviders::is_dataset_Valid() const{
    return m_dataset_isValid;
}

QString OAIProviders::getFavicon() const {
    return m_favicon;
}
void OAIProviders::setFavicon(const QString &favicon) {
    m_favicon = favicon;
    m_favicon_isSet = true;
}

bool OAIProviders::is_favicon_Set() const{
    return m_favicon_isSet;
}

bool OAIProviders::is_favicon_Valid() const{
    return m_favicon_isValid;
}

QString OAIProviders::getForgetPasswordUrl() const {
    return m_forget_password_url;
}
void OAIProviders::setForgetPasswordUrl(const QString &forget_password_url) {
    m_forget_password_url = forget_password_url;
    m_forget_password_url_isSet = true;
}

bool OAIProviders::is_forget_password_url_Set() const{
    return m_forget_password_url_isSet;
}

bool OAIProviders::is_forget_password_url_Valid() const{
    return m_forget_password_url_isValid;
}

QString OAIProviders::getHelp() const {
    return m_help;
}
void OAIProviders::setHelp(const QString &help) {
    m_help = help;
    m_help_isSet = true;
}

bool OAIProviders::is_help_Set() const{
    return m_help_isSet;
}

bool OAIProviders::is_help_Valid() const{
    return m_help_isValid;
}

qint64 OAIProviders::getId() const {
    return m_id;
}
void OAIProviders::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProviders::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProviders::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIProviders::getIsAddedByUser() const {
    return m_is_added_by_user;
}
void OAIProviders::setIsAddedByUser(const QString &is_added_by_user) {
    m_is_added_by_user = is_added_by_user;
    m_is_added_by_user_isSet = true;
}

bool OAIProviders::is_is_added_by_user_Set() const{
    return m_is_added_by_user_isSet;
}

bool OAIProviders::is_is_added_by_user_Valid() const{
    return m_is_added_by_user_isValid;
}

bool OAIProviders::isIsAutoRefreshEnabled() const {
    return m_is_auto_refresh_enabled;
}
void OAIProviders::setIsAutoRefreshEnabled(const bool &is_auto_refresh_enabled) {
    m_is_auto_refresh_enabled = is_auto_refresh_enabled;
    m_is_auto_refresh_enabled_isSet = true;
}

bool OAIProviders::is_is_auto_refresh_enabled_Set() const{
    return m_is_auto_refresh_enabled_isSet;
}

bool OAIProviders::is_is_auto_refresh_enabled_Valid() const{
    return m_is_auto_refresh_enabled_isValid;
}

bool OAIProviders::isIsConsentRequired() const {
    return m_is_consent_required;
}
void OAIProviders::setIsConsentRequired(const bool &is_consent_required) {
    m_is_consent_required = is_consent_required;
    m_is_consent_required_isSet = true;
}

bool OAIProviders::is_is_consent_required_Set() const{
    return m_is_consent_required_isSet;
}

bool OAIProviders::is_is_consent_required_Valid() const{
    return m_is_consent_required_isValid;
}

QString OAIProviders::getLanguageIsoCode() const {
    return m_language_iso_code;
}
void OAIProviders::setLanguageIsoCode(const QString &language_iso_code) {
    m_language_iso_code = language_iso_code;
    m_language_iso_code_isSet = true;
}

bool OAIProviders::is_language_iso_code_Set() const{
    return m_language_iso_code_isSet;
}

bool OAIProviders::is_language_iso_code_Valid() const{
    return m_language_iso_code_isValid;
}

QString OAIProviders::getLastModified() const {
    return m_last_modified;
}
void OAIProviders::setLastModified(const QString &last_modified) {
    m_last_modified = last_modified;
    m_last_modified_isSet = true;
}

bool OAIProviders::is_last_modified_Set() const{
    return m_last_modified_isSet;
}

bool OAIProviders::is_last_modified_Valid() const{
    return m_last_modified_isValid;
}

QString OAIProviders::getLoginHelp() const {
    return m_login_help;
}
void OAIProviders::setLoginHelp(const QString &login_help) {
    m_login_help = login_help;
    m_login_help_isSet = true;
}

bool OAIProviders::is_login_help_Set() const{
    return m_login_help_isSet;
}

bool OAIProviders::is_login_help_Valid() const{
    return m_login_help_isValid;
}

QString OAIProviders::getLoginUrl() const {
    return m_login_url;
}
void OAIProviders::setLoginUrl(const QString &login_url) {
    m_login_url = login_url;
    m_login_url_isSet = true;
}

bool OAIProviders::is_login_url_Set() const{
    return m_login_url_isSet;
}

bool OAIProviders::is_login_url_Valid() const{
    return m_login_url_isValid;
}

QString OAIProviders::getLogo() const {
    return m_logo;
}
void OAIProviders::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAIProviders::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAIProviders::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAIProviders::getName() const {
    return m_name;
}
void OAIProviders::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProviders::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProviders::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIProviders::getPrimaryLanguageIsoCode() const {
    return m_primary_language_iso_code;
}
void OAIProviders::setPrimaryLanguageIsoCode(const QString &primary_language_iso_code) {
    m_primary_language_iso_code = primary_language_iso_code;
    m_primary_language_iso_code_isSet = true;
}

bool OAIProviders::is_primary_language_iso_code_Set() const{
    return m_primary_language_iso_code_isSet;
}

bool OAIProviders::is_primary_language_iso_code_Valid() const{
    return m_primary_language_iso_code_isValid;
}

QString OAIProviders::getStatus() const {
    return m_status;
}
void OAIProviders::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIProviders::is_status_Set() const{
    return m_status_isSet;
}

bool OAIProviders::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIProviders::isSet() const {
...
bool OAIProviders::isValid() const {
