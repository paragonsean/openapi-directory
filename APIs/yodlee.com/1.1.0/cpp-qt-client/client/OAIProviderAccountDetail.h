...
/*
 * OAIProviderAccountDetail.h
 *
 * 
 */

#ifndef OAIProviderAccountDetail_H
#define OAIProviderAccountDetail_H
...
class OAIProviderAccountDetail : public OAIObject {
public:
    OAIProviderAccountDetail();
    OAIProviderAccountDetail(QString json);
    ~OAIProviderAccountDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProviderAccountDetail)

#endif // OAIProviderAccountDetail_H
