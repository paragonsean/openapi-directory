...
OAIDerivedHolding::OAIDerivedHolding(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDerivedHolding::OAIDerivedHolding() {
    this->initializeModel();
}

OAIDerivedHolding::~OAIDerivedHolding() {}

void OAIDerivedHolding::initializeModel() {
...
void OAIDerivedHolding::fromJson(QString jsonString) {
...
void OAIDerivedHolding::fromJsonObject(QJsonObject json) {
...
QString OAIDerivedHolding::asJson() const {
...
QJsonObject OAIDerivedHolding::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_asset_classification.isSet()) {
...
qint64 OAIDerivedHolding::getAccountId() const {
    return m_account_id;
}
void OAIDerivedHolding::setAccountId(const qint64 &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIDerivedHolding::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIDerivedHolding::is_account_id_Valid() const{
    return m_account_id_isValid;
}

OAIMoney OAIDerivedHolding::getAccruedIncome() const {
    return m_accrued_income;
}
void OAIDerivedHolding::setAccruedIncome(const OAIMoney &accrued_income) {
    m_accrued_income = accrued_income;
    m_accrued_income_isSet = true;
}

bool OAIDerivedHolding::is_accrued_income_Set() const{
    return m_accrued_income_isSet;
}

bool OAIDerivedHolding::is_accrued_income_Valid() const{
    return m_accrued_income_isValid;
}

OAIMoney OAIDerivedHolding::getAccruedInterest() const {
    return m_accrued_interest;
}
void OAIDerivedHolding::setAccruedInterest(const OAIMoney &accrued_interest) {
    m_accrued_interest = accrued_interest;
    m_accrued_interest_isSet = true;
}

bool OAIDerivedHolding::is_accrued_interest_Set() const{
    return m_accrued_interest_isSet;
}

bool OAIDerivedHolding::is_accrued_interest_Valid() const{
    return m_accrued_interest_isValid;
}

OAIAssetClassification OAIDerivedHolding::getAssetClassification() const {
    return m_asset_classification;
}
void OAIDerivedHolding::setAssetClassification(const OAIAssetClassification &asset_classification) {
    m_asset_classification = asset_classification;
    m_asset_classification_isSet = true;
}

bool OAIDerivedHolding::is_asset_classification_Set() const{
    return m_asset_classification_isSet;
}

bool OAIDerivedHolding::is_asset_classification_Valid() const{
    return m_asset_classification_isValid;
}

double OAIDerivedHolding::getContractQuantity() const {
    return m_contract_quantity;
}
void OAIDerivedHolding::setContractQuantity(const double &contract_quantity) {
    m_contract_quantity = contract_quantity;
    m_contract_quantity_isSet = true;
}

bool OAIDerivedHolding::is_contract_quantity_Set() const{
    return m_contract_quantity_isSet;
}

bool OAIDerivedHolding::is_contract_quantity_Valid() const{
    return m_contract_quantity_isValid;
}

OAIMoney OAIDerivedHolding::getCostBasis() const {
    return m_cost_basis;
}
void OAIDerivedHolding::setCostBasis(const OAIMoney &cost_basis) {
    m_cost_basis = cost_basis;
    m_cost_basis_isSet = true;
}

bool OAIDerivedHolding::is_cost_basis_Set() const{
    return m_cost_basis_isSet;
}

bool OAIDerivedHolding::is_cost_basis_Valid() const{
    return m_cost_basis_isValid;
}

double OAIDerivedHolding::getCouponRate() const {
    return m_coupon_rate;
}
void OAIDerivedHolding::setCouponRate(const double &coupon_rate) {
    m_coupon_rate = coupon_rate;
    m_coupon_rate_isSet = true;
}

bool OAIDerivedHolding::is_coupon_rate_Set() const{
    return m_coupon_rate_isSet;
}

bool OAIDerivedHolding::is_coupon_rate_Valid() const{
    return m_coupon_rate_isValid;
}

QString OAIDerivedHolding::getCreatedDate() const {
    return m_created_date;
}
void OAIDerivedHolding::setCreatedDate(const QString &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIDerivedHolding::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIDerivedHolding::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAIDerivedHolding::getCusipNumber() const {
    return m_cusip_number;
}
void OAIDerivedHolding::setCusipNumber(const QString &cusip_number) {
    m_cusip_number = cusip_number;
    m_cusip_number_isSet = true;
}

bool OAIDerivedHolding::is_cusip_number_Set() const{
    return m_cusip_number_isSet;
}

bool OAIDerivedHolding::is_cusip_number_Valid() const{
    return m_cusip_number_isValid;
}

QString OAIDerivedHolding::getDescription() const {
    return m_description;
}
void OAIDerivedHolding::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDerivedHolding::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDerivedHolding::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDerivedHolding::getEnrichedDescription() const {
    return m_enriched_description;
}
void OAIDerivedHolding::setEnrichedDescription(const QString &enriched_description) {
    m_enriched_description = enriched_description;
    m_enriched_description_isSet = true;
}

bool OAIDerivedHolding::is_enriched_description_Set() const{
    return m_enriched_description_isSet;
}

bool OAIDerivedHolding::is_enriched_description_Valid() const{
    return m_enriched_description_isValid;
}

double OAIDerivedHolding::getExercisedQuantity() const {
    return m_exercised_quantity;
}
void OAIDerivedHolding::setExercisedQuantity(const double &exercised_quantity) {
    m_exercised_quantity = exercised_quantity;
    m_exercised_quantity_isSet = true;
}

bool OAIDerivedHolding::is_exercised_quantity_Set() const{
    return m_exercised_quantity_isSet;
}

bool OAIDerivedHolding::is_exercised_quantity_Valid() const{
    return m_exercised_quantity_isValid;
}

QString OAIDerivedHolding::getExpirationDate() const {
    return m_expiration_date;
}
void OAIDerivedHolding::setExpirationDate(const QString &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAIDerivedHolding::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAIDerivedHolding::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

QString OAIDerivedHolding::getGrantDate() const {
    return m_grant_date;
}
void OAIDerivedHolding::setGrantDate(const QString &grant_date) {
    m_grant_date = grant_date;
    m_grant_date_isSet = true;
}

bool OAIDerivedHolding::is_grant_date_Set() const{
    return m_grant_date_isSet;
}

bool OAIDerivedHolding::is_grant_date_Valid() const{
    return m_grant_date_isValid;
}

QString OAIDerivedHolding::getHoldingType() const {
    return m_holding_type;
}
void OAIDerivedHolding::setHoldingType(const QString &holding_type) {
    m_holding_type = holding_type;
    m_holding_type_isSet = true;
}

bool OAIDerivedHolding::is_holding_type_Set() const{
    return m_holding_type_isSet;
}

bool OAIDerivedHolding::is_holding_type_Valid() const{
    return m_holding_type_isValid;
}

qint64 OAIDerivedHolding::getId() const {
    return m_id;
}
void OAIDerivedHolding::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDerivedHolding::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDerivedHolding::is_id_Valid() const{
    return m_id_isValid;
}

double OAIDerivedHolding::getInterestRate() const {
    return m_interest_rate;
}
void OAIDerivedHolding::setInterestRate(const double &interest_rate) {
    m_interest_rate = interest_rate;
    m_interest_rate_isSet = true;
}

bool OAIDerivedHolding::is_interest_rate_Set() const{
    return m_interest_rate_isSet;
}

bool OAIDerivedHolding::is_interest_rate_Valid() const{
    return m_interest_rate_isValid;
}

bool OAIDerivedHolding::isIsShort() const {
    return m_is_short;
}
void OAIDerivedHolding::setIsShort(const bool &is_short) {
    m_is_short = is_short;
    m_is_short_isSet = true;
}

bool OAIDerivedHolding::is_is_short_Set() const{
    return m_is_short_isSet;
}

bool OAIDerivedHolding::is_is_short_Valid() const{
    return m_is_short_isValid;
}

QString OAIDerivedHolding::getIsin() const {
    return m_isin;
}
void OAIDerivedHolding::setIsin(const QString &isin) {
    m_isin = isin;
    m_isin_isSet = true;
}

bool OAIDerivedHolding::is_isin_Set() const{
    return m_isin_isSet;
}

bool OAIDerivedHolding::is_isin_Valid() const{
    return m_isin_isValid;
}

QString OAIDerivedHolding::getLastUpdated() const {
    return m_last_updated;
}
void OAIDerivedHolding::setLastUpdated(const QString &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIDerivedHolding::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIDerivedHolding::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

QString OAIDerivedHolding::getMatchStatus() const {
    return m_match_status;
}
void OAIDerivedHolding::setMatchStatus(const QString &match_status) {
    m_match_status = match_status;
    m_match_status_isSet = true;
}

bool OAIDerivedHolding::is_match_status_Set() const{
    return m_match_status_isSet;
}

bool OAIDerivedHolding::is_match_status_Valid() const{
    return m_match_status_isValid;
}

QString OAIDerivedHolding::getMaturityDate() const {
    return m_maturity_date;
}
void OAIDerivedHolding::setMaturityDate(const QString &maturity_date) {
    m_maturity_date = maturity_date;
    m_maturity_date_isSet = true;
}

bool OAIDerivedHolding::is_maturity_date_Set() const{
    return m_maturity_date_isSet;
}

bool OAIDerivedHolding::is_maturity_date_Valid() const{
    return m_maturity_date_isValid;
}

QString OAIDerivedHolding::getOptionType() const {
    return m_option_type;
}
void OAIDerivedHolding::setOptionType(const QString &option_type) {
    m_option_type = option_type;
    m_option_type_isSet = true;
}

bool OAIDerivedHolding::is_option_type_Set() const{
    return m_option_type_isSet;
}

bool OAIDerivedHolding::is_option_type_Valid() const{
    return m_option_type_isValid;
}

OAIMoney OAIDerivedHolding::getPrice() const {
    return m_price;
}
void OAIDerivedHolding::setPrice(const OAIMoney &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIDerivedHolding::is_price_Set() const{
    return m_price_isSet;
}

bool OAIDerivedHolding::is_price_Valid() const{
    return m_price_isValid;
}

qint64 OAIDerivedHolding::getProviderAccountId() const {
    return m_provider_account_id;
}
void OAIDerivedHolding::setProviderAccountId(const qint64 &provider_account_id) {
    m_provider_account_id = provider_account_id;
    m_provider_account_id_isSet = true;
}

bool OAIDerivedHolding::is_provider_account_id_Set() const{
    return m_provider_account_id_isSet;
}

bool OAIDerivedHolding::is_provider_account_id_Valid() const{
    return m_provider_account_id_isValid;
}

double OAIDerivedHolding::getQuantity() const {
    return m_quantity;
}
void OAIDerivedHolding::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIDerivedHolding::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIDerivedHolding::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAIDerivedHolding::getSecurityStyle() const {
    return m_security_style;
}
void OAIDerivedHolding::setSecurityStyle(const QString &security_style) {
    m_security_style = security_style;
    m_security_style_isSet = true;
}

bool OAIDerivedHolding::is_security_style_Set() const{
    return m_security_style_isSet;
}

bool OAIDerivedHolding::is_security_style_Valid() const{
    return m_security_style_isValid;
}

QString OAIDerivedHolding::getSecurityType() const {
    return m_security_type;
}
void OAIDerivedHolding::setSecurityType(const QString &security_type) {
    m_security_type = security_type;
    m_security_type_isSet = true;
}

bool OAIDerivedHolding::is_security_type_Set() const{
    return m_security_type_isSet;
}

bool OAIDerivedHolding::is_security_type_Valid() const{
    return m_security_type_isValid;
}

QString OAIDerivedHolding::getSedol() const {
    return m_sedol;
}
void OAIDerivedHolding::setSedol(const QString &sedol) {
    m_sedol = sedol;
    m_sedol_isSet = true;
}

bool OAIDerivedHolding::is_sedol_Set() const{
    return m_sedol_isSet;
}

bool OAIDerivedHolding::is_sedol_Valid() const{
    return m_sedol_isValid;
}

OAIMoney OAIDerivedHolding::getSpread() const {
    return m_spread;
}
void OAIDerivedHolding::setSpread(const OAIMoney &spread) {
    m_spread = spread;
    m_spread_isSet = true;
}

bool OAIDerivedHolding::is_spread_Set() const{
    return m_spread_isSet;
}

bool OAIDerivedHolding::is_spread_Valid() const{
    return m_spread_isValid;
}

OAIMoney OAIDerivedHolding::getStrikePrice() const {
    return m_strike_price;
}
void OAIDerivedHolding::setStrikePrice(const OAIMoney &strike_price) {
    m_strike_price = strike_price;
    m_strike_price_isSet = true;
}

bool OAIDerivedHolding::is_strike_price_Set() const{
    return m_strike_price_isSet;
}

bool OAIDerivedHolding::is_strike_price_Valid() const{
    return m_strike_price_isValid;
}

QString OAIDerivedHolding::getSymbol() const {
    return m_symbol;
}
void OAIDerivedHolding::setSymbol(const QString &symbol) {
    m_symbol = symbol;
    m_symbol_isSet = true;
}

bool OAIDerivedHolding::is_symbol_Set() const{
    return m_symbol_isSet;
}

bool OAIDerivedHolding::is_symbol_Valid() const{
    return m_symbol_isValid;
}

QString OAIDerivedHolding::getTerm() const {
    return m_term;
}
void OAIDerivedHolding::setTerm(const QString &term) {
    m_term = term;
    m_term_isSet = true;
}

bool OAIDerivedHolding::is_term_Set() const{
    return m_term_isSet;
}

bool OAIDerivedHolding::is_term_Valid() const{
    return m_term_isValid;
}

double OAIDerivedHolding::getUnvestedQuantity() const {
    return m_unvested_quantity;
}
void OAIDerivedHolding::setUnvestedQuantity(const double &unvested_quantity) {
    m_unvested_quantity = unvested_quantity;
    m_unvested_quantity_isSet = true;
}

bool OAIDerivedHolding::is_unvested_quantity_Set() const{
    return m_unvested_quantity_isSet;
}

bool OAIDerivedHolding::is_unvested_quantity_Valid() const{
    return m_unvested_quantity_isValid;
}

OAIMoney OAIDerivedHolding::getUnvestedValue() const {
    return m_unvested_value;
}
void OAIDerivedHolding::setUnvestedValue(const OAIMoney &unvested_value) {
    m_unvested_value = unvested_value;
    m_unvested_value_isSet = true;
}

bool OAIDerivedHolding::is_unvested_value_Set() const{
    return m_unvested_value_isSet;
}

bool OAIDerivedHolding::is_unvested_value_Valid() const{
    return m_unvested_value_isValid;
}

OAIMoney OAIDerivedHolding::getValue() const {
    return m_value;
}
void OAIDerivedHolding::setValue(const OAIMoney &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDerivedHolding::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDerivedHolding::is_value_Valid() const{
    return m_value_isValid;
}

double OAIDerivedHolding::getVestedQuantity() const {
    return m_vested_quantity;
}
void OAIDerivedHolding::setVestedQuantity(const double &vested_quantity) {
    m_vested_quantity = vested_quantity;
    m_vested_quantity_isSet = true;
}

bool OAIDerivedHolding::is_vested_quantity_Set() const{
    return m_vested_quantity_isSet;
}

bool OAIDerivedHolding::is_vested_quantity_Valid() const{
    return m_vested_quantity_isValid;
}

double OAIDerivedHolding::getVestedSharesExercisable() const {
    return m_vested_shares_exercisable;
}
void OAIDerivedHolding::setVestedSharesExercisable(const double &vested_shares_exercisable) {
    m_vested_shares_exercisable = vested_shares_exercisable;
    m_vested_shares_exercisable_isSet = true;
}

bool OAIDerivedHolding::is_vested_shares_exercisable_Set() const{
    return m_vested_shares_exercisable_isSet;
}

bool OAIDerivedHolding::is_vested_shares_exercisable_Valid() const{
    return m_vested_shares_exercisable_isValid;
}

OAIMoney OAIDerivedHolding::getVestedValue() const {
    return m_vested_value;
}
void OAIDerivedHolding::setVestedValue(const OAIMoney &vested_value) {
    m_vested_value = vested_value;
    m_vested_value_isSet = true;
}

bool OAIDerivedHolding::is_vested_value_Set() const{
    return m_vested_value_isSet;
}

bool OAIDerivedHolding::is_vested_value_Valid() const{
    return m_vested_value_isValid;
}

QString OAIDerivedHolding::getVestingDate() const {
    return m_vesting_date;
}
void OAIDerivedHolding::setVestingDate(const QString &vesting_date) {
    m_vesting_date = vesting_date;
    m_vesting_date_isSet = true;
}

bool OAIDerivedHolding::is_vesting_date_Set() const{
    return m_vesting_date_isSet;
}

bool OAIDerivedHolding::is_vesting_date_Valid() const{
    return m_vesting_date_isValid;
}

bool OAIDerivedHolding::isSet() const {
...
bool OAIDerivedHolding::isValid() const {
