...
#ifndef OAIDerivedHolding_H
#define OAIDerivedHolding_H
...
namespace OpenAPI {
class OAIMoney;
class OAIAssetClassification;

class OAIDerivedHolding : public OAIObject {
public:
    OAIDerivedHolding();
    OAIDerivedHolding(QString json);
    ~OAIDerivedHolding() override;
    ...
    OAIAssetClassification getAssetClassification() const;
    void setAssetClassification(const OAIAssetClassification &asset_classification);
    bool is_asset_classification_Set() const;
    bool is_asset_classification_Valid() const;
...
private:
    ...
    OAIAssetClassification m_asset_classification;
    bool m_asset_classification_isSet;
    bool m_asset_classification_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDerivedHolding)

#endif // OAIDerivedHolding_H
