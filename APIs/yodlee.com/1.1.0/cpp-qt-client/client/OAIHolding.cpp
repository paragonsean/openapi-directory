...
void OAIHolding::initializeModel() {
    ...
    m_asset_classification_isSet = false;
    m_asset_classification_isValid = false;
...
void OAIHolding::fromJsonObject(QJsonObject json) {
    ...
    m_asset_classification_isValid = ::OpenAPI::fromJsonValue(m_asset_classification, json[QString("assetClassification")]);
    m_asset_classification_isSet = !json[QString("assetClassification")].isNull() && m_asset_classification_isValid;
...
QJsonObject OAIHolding::asJsonObject() const {
    ...
    if (m_asset_classification.size() > 0) {
        obj.insert(QString("assetClassification"), ::OpenAPI::toJsonValue(m_asset_classification));
    }
...
qint64 OAIHolding::getAccountId() const {
    return m_account_id;
}
void OAIHolding::setAccountId(const qint64 &account_id) {
...
OAIMoney OAIHolding::getAccruedIncome() const {
    return m_accrued_income;
}
void OAIHolding::setAccruedIncome(const OAIMoney &accrued_income) {
    m_accrued_income = accrued_income;
    m_accrued_income_isSet = true;
}

bool OAIHolding::is_accrued_income_Set() const{
    return m_accrued_income_isSet;
}

bool OAIHolding::is_accrued_income_Valid() const{
    return m_accrued_income_isValid;
}

OAIMoney OAIHolding::getAccruedInterest() const {
    return m_accrued_interest;
}
void OAIHolding::setAccruedInterest(const OAIMoney &accrued_interest) {
    m_accrued_interest = accrued_interest;
    m_accrued_interest_isSet = true;
}

bool OAIHolding::is_accrued_interest_Set() const{
    return m_accrued_interest_isSet;
}

bool OAIHolding::is_accrued_interest_Valid() const{
    return m_accrued_interest_isValid;
}

QList<OAIAssetClassification> OAIHolding::getAssetClassification() const {
    return m_asset_classification;
}
void OAIHolding::setAssetClassification(const QList<OAIAssetClassification> &asset_classification) {
    m_asset_classification = asset_classification;
    m_asset_classification_isSet = true;
}

bool OAIHolding::is_asset_classification_Set() const{
    return m_asset_classification_isSet;
}

bool OAIHolding::is_asset_classification_Valid() const{
    return m_asset_classification_isValid;
}

double OAIHolding::getContractQuantity() const {
    return m_contract_quantity;
}
void OAIHolding::setContractQuantity(const double &contract_quantity) {
    m_contract_quantity = contract_quantity;
    m_contract_quantity_isSet = true;
}

bool OAIHolding::is_contract_quantity_Set() const{
    return m_contract_quantity_isSet;
}

bool OAIHolding::is_contract_quantity_Valid() const{
    return m_contract_quantity_isValid;
}

OAIMoney OAIHolding::getCostBasis() const {
    return m_cost_basis;
}
void OAIHolding::setCostBasis(const OAIMoney &cost_basis) {
...
double OAIHolding::getCouponRate() const {
    return m_coupon_rate;
}
void OAIHolding::setCouponRate(const double &coupon_rate) {
    m_coupon_rate = coupon_rate;
    m_coupon_rate_isSet = true;
}

bool OAIHolding::is_coupon_rate_Set() const{
    return m_coupon_rate_isSet;
}

bool OAIHolding::is_coupon_rate_Valid() const{
    return m_coupon_rate_isValid;
}

QString OAIHolding::getCreatedDate() const {
    return m_created_date;
}
void OAIHolding::setCreatedDate(const QString &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIHolding::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIHolding::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAIHolding::getCusipNumber() const {
    return m_cusip_number;
}
void OAIHolding::setCusipNumber(const QString &cusip_number) {
    m_cusip_number = cusip_number;
    m_cusip_number_isSet = true;
}

bool OAIHolding::is_cusip_number_Set() const{
    return m_cusip_number_isSet;
}

bool OAIHolding::is_cusip_number_Valid() const{
    return m_cusip_number_isValid;
}

QString OAIHolding::getDescription() const {
    return m_description;
}
void OAIHolding::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIHolding::is_description_Set() const{
    return m_description_isSet;
}

bool OAIHolding::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIHolding::getEnrichedDescription() const {
    return m_enriched_description;
}
void OAIHolding::setEnrichedDescription(const QString &enriched_description) {
    m_enriched_description = enriched_description;
    m_enriched_description_isSet = true;
}

bool OAIHolding::is_enriched_description_Set() const{
    return m_enriched_description_isSet;
}

bool OAIHolding::is_enriched_description_Valid() const{
    return m_enriched_description_isValid;
}

double OAIHolding::getExercisedQuantity() const {
    return m_exercised_quantity;
}
void OAIHolding::setExercisedQuantity(const double &exercised_quantity) {
    m_exercised_quantity = exercised_quantity;
    m_exercised_quantity_isSet = true;
}

bool OAIHolding::is_exercised_quantity_Set() const{
    return m_exercised_quantity_isSet;
}

bool OAIHolding::is_exercised_quantity_Valid() const{
    return m_exercised_quantity_isValid;
}

QString OAIHolding::getExpirationDate() const {
    return m_expiration_date;
}
void OAIHolding::setExpirationDate(const QString &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAIHolding::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAIHolding::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

QString OAIHolding::getGrantDate() const {
    return m_grant_date;
}
void OAIHolding::setGrantDate(const QString &grant_date) {
    m_grant_date = grant_date;
    m_grant_date_isSet = true;
}

bool OAIHolding::is_grant_date_Set() const{
    return m_grant_date_isSet;
}

bool OAIHolding::is_grant_date_Valid() const{
    return m_grant_date_isValid;
}

QString OAIHolding::getHoldingType() const {
    return m_holding_type;
}
void OAIHolding::setHoldingType(const QString &holding_type) {
    m_holding_type = holding_type;
    m_holding_type_isSet = true;
}

bool OAIHolding::is_holding_type_Set() const{
    return m_holding_type_isSet;
}

bool OAIHolding::is_holding_type_Valid() const{
    return m_holding_type_isValid;
}

qint64 OAIHolding::getId() const {
    return m_id;
}
void OAIHolding::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIHolding::is_id_Set() const{
    return m_id_isSet;
}

bool OAIHolding::is_id_Valid() const{
    return m_id_isValid;
}

double OAIHolding::getInterestRate() const {
    return m_interest_rate;
}
void OAIHolding::setInterestRate(const double &interest_rate) {
    m_interest_rate = interest_rate;
    m_interest_rate_isSet = true;
}

bool OAIHolding::is_interest_rate_Set() const{
    return m_interest_rate_isSet;
}

bool OAIHolding::is_interest_rate_Valid() const{
    return m_interest_rate_isValid;
}

bool OAIHolding::isIsShort() const {
    return m_is_short;
}
void OAIHolding::setIsShort(const bool &is_short) {
    m_is_short = is_short;
    m_is_short_isSet = true;
}

bool OAIHolding::is_is_short_Set() const{
    return m_is_short_isSet;
}

bool OAIHolding::is_is_short_Valid() const{
    return m_is_short_isValid;
}

QString OAIHolding::getIsin() const {
    return m_isin;
}
void OAIHolding::setIsin(const QString &isin) {
    m_isin = isin;
    m_isin_isSet = true;
}

bool OAIHolding::is_isin_Set() const{
    return m_isin_isSet;
}

bool OAIHolding::is_isin_Valid() const{
    return m_isin_isValid;
}

QString OAIHolding::getLastUpdated() const {
    return m_last_updated;
}
void OAIHolding::setLastUpdated(const QString &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIHolding::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIHolding::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

QString OAIHolding::getMatchStatus() const {
    return m_match_status;
}
void OAIHolding::setMatchStatus(const QString &match_status) {
    m_match_status = match_status;
    m_match_status_isSet = true;
}

bool OAIHolding::is_match_status_Set() const{
    return m_match_status_isSet;
}

bool OAIHolding::is_match_status_Valid() const{
    return m_match_status_isValid;
}

QString OAIHolding::getMaturityDate() const {
    return m_maturity_date;
}
void OAIHolding::setMaturityDate(const QString &maturity_date) {
    m_maturity_date = maturity_date;
    m_maturity_date_isSet = true;
}

bool OAIHolding::is_maturity_date_Set() const{
    return m_maturity_date_isSet;
}

bool OAIHolding::is_maturity_date_Valid() const{
    return m_maturity_date_isValid;
}

QString OAIHolding::getOptionType() const {
    return m_option_type;
}
void OAIHolding::setOptionType(const QString &option_type) {
    m_option_type = option_type;
    m_option_type_isSet = true;
}

bool OAIHolding::is_option_type_Set() const{
    return m_option_type_isSet;
}

bool OAIHolding::is_option_type_Valid() const{
    return m_option_type_isValid;
}

OAIMoney OAIHolding::getPrice() const {
    return m_price;
}
void OAIHolding::setPrice(const OAIMoney &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIHolding::is_price_Set() const{
    return m_price_isSet;
}

bool OAIHolding::is_price_Valid() const{
    return m_price_isValid;
}

qint64 OAIHolding::getProviderAccountId() const {
    return m_provider_account_id;
}
void OAIHolding::setProviderAccountId(const qint64 &provider_account_id) {
    m_provider_account_id = provider_account_id;
    m_provider_account_id_isSet = true;
}

bool OAIHolding::is_provider_account_id_Set() const{
    return m_provider_account_id_isSet;
}

bool OAIHolding::is_provider_account_id_Valid() const{
...
QString OAIHolding::getSecurityStyle() const {
    return m_security_style;
}
void OAIHolding::setSecurityStyle(const QString &security_style) {
    m_security_style = security_style;
    m_security_style_isSet = true;
}

bool OAIHolding::is_security_style_Set() const{
    return m_security_style_isSet;
}

bool OAIHolding::is_security_style_Valid() const{
    return m_security_style_isValid;
}

QString OAIHolding::getSecurityType() const {
    return m_security_type;
}
void OAIHolding::setSecurityType(const QString &security_type) {
    m_security_type = security_type;
    m_security_type_isSet = true;
}

bool OAIHolding::is_security_type_Set() const{
    return m_security_type_isSet;
}

bool OAIHolding::is_security_type_Valid() const{
    return m_security_type_isValid;
}

QString OAIHolding::getSedol() const {
    return m_sedol;
}
void OAIHolding::setSedol(const QString &sedol) {
    m_sedol = sedol;
    m_sedol_isSet = true;
}

bool OAIHolding::is_sedol_Set() const{
    return m_sedol_isSet;
}

bool OAIHolding::is_sedol_Valid() const{
    return m_sedol_isValid;
}

OAIMoney OAIHolding::getSpread() const {
    return m_spread;
}
void OAIHolding::setSpread(const OAIMoney &spread) {
    m_spread = spread;
    m_spread_isSet = true;
}

bool OAIHolding::is_spread_Set() const{
    return m_spread_isSet;
}

bool OAIHolding::is_spread_Valid() const{
    return m_spread_isValid;
}

OAIMoney OAIHolding::getStrikePrice() const {
    return m_strike_price;
}
void OAIHolding::setStrikePrice(const OAIMoney &strike_price) {
    m_strike_price = strike_price;
    m_strike_price_isSet = true;
}

bool OAIHolding::is_strike_price_Set() const{
    return m_strike_price_isSet;
}

bool OAIHolding::is_strike_price_Valid() const{
    return m_strike_price_isValid;
}

QString OAIHolding::getSymbol() const {
    return m_symbol;
}
void OAIHolding::setSymbol(const QString &symbol) {
    m_symbol = symbol;
    m_symbol_isSet = true;
}

bool OAIHolding::is_symbol_Set() const{
    return m_symbol_isSet;
}

bool OAIHolding::is_symbol_Valid() const{
    return m_symbol_isValid;
}

QString OAIHolding::getTerm() const {
    return m_term;
}
void OAIHolding::setTerm(const QString &term) {
    m_term = term;
    m_term_isSet = true;
}

bool OAIHolding::is_term_Set() const{
    return m_term_isSet;
}

bool OAIHolding::is_term_Valid() const{
    return m_term_isValid;
}

double OAIHolding::getUnvestedQuantity() const {
    return m_unvested_quantity;
}
void OAIHolding::setUnvestedQuantity(const double &unvested_quantity) {
    m_unvested_quantity = unvested_quantity;
    m_unvested_quantity_isSet = true;
}

bool OAIHolding::is_unvested_quantity_Set() const{
    return m_unvested_quantity_isSet;
}

bool OAIHolding::is_unvested_quantity_Valid() const{
    return m_unvested_quantity_isValid;
}

OAIMoney OAIHolding::getUnvestedValue() const {
    return m_unvested_value;
}
void OAIHolding::setUnvestedValue(const OAIMoney &unvested_value) {
    m_unvested_value = unvested_value;
    m_unvested_value_isSet = true;
}

bool OAIHolding::is_unvested_value_Set() const{
    return m_unvested_value_isSet;
}

bool OAIHolding::is_unvested_value_Valid() const{
    return m_unvested_value_isValid;
}

OAIMoney OAIHolding::getValue() const {
    return m_value;
}
void OAIHolding::setValue(const OAIMoney &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIHolding::is_value_Set() const{
    return m_value_isSet;
}

bool OAIHolding::is_value_Valid() const{
    return m_value_isValid;
}

double OAIHolding::getVestedQuantity() const {
    return m_vested_quantity;
}
void OAIHolding::setVestedQuantity(const double &vested_quantity) {
    m_vested_quantity = vested_quantity;
    m_vested_quantity_isSet = true;
}

bool OAIHolding::is_vested_quantity_Set() const{
    return m_vested_quantity_isSet;
}

bool OAIHolding::is_vested_quantity_Valid() const{
    return m_vested_quantity_isValid;
}

double OAIHolding::getVestedSharesExercisable() const {
    return m_vested_shares_exercisable;
}
void OAIHolding::setVestedSharesExercisable(const double &vested_shares_exercisable) {
    m_vested_shares_exercisable = vested_shares_exercisable;
    m_vested_shares_exercisable_isSet = true;
}

bool OAIHolding::is_vested_shares_exercisable_Set() const{
    return m_vested_shares_exercisable_isSet;
}

bool OAIHolding::is_vested_shares_exercisable_Valid() const{
    return m_vested_shares_exercisable_isValid;
}

OAIMoney OAIHolding::getVestedValue() const {
    return m_vested_value;
}
void OAIHolding::setVestedValue(const OAIMoney &vested_value) {
    m_vested_value = vested_value;
    m_vested_value_isSet = true;
}

bool OAIHolding::is_vested_value_Set() const{
    return m_vested_value_isSet;
}

bool OAIHolding::is_vested_value_Valid() const{
    return m_vested_value_isValid;
}

QString OAIHolding::getVestingDate() const {
    return m_vesting_date;
}
void OAIHolding::setVestingDate(const QString &vesting_date) {
    m_vesting_date = vesting_date;
    m_vesting_date_isSet = true;
}

bool OAIHolding::is_vesting_date_Set() const{
    return m_vesting_date_isSet;
}

bool OAIHolding::is_vesting_date_Valid() const{
