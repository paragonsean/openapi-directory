...
OAIUser OAIUserResponse::getUser() const {
    return m_user;
}
void OAIUserResponse::setUser(const OAIUser &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIUserResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIUserResponse::is_user_Valid() const{
