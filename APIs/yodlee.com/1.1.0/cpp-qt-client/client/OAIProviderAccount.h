...
/*
 * OAIProviderAccount.h
 *
 * 
 */

#ifndef OAIProviderAccount_H
#define OAIProviderAccount_H
...
class OAIProviderAccount : public OAIObject {
public:
    OAIProviderAccount();
    OAIProviderAccount(QString json);
    ~OAIProviderAccount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProviderAccount)

#endif // OAIProviderAccount_H
