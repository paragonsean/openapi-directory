...
OAICreateAccountInfo OAICreateAccountRequest::getAccount() const {
    return m_account;
}
void OAICreateAccountRequest::setAccount(const OAICreateAccountInfo &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAICreateAccountRequest::is_account_Set() const{
    return m_account_isSet;
}

bool OAICreateAccountRequest::is_account_Valid() const{
