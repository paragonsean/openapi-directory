...
QString OAIAccountAddress::getAddress1() const {
    return m_address1;
}
void OAIAccountAddress::setAddress1(const QString &address1) {
    m_address1 = address1;
    m_address1_isSet = true;
}

bool OAIAccountAddress::is_address1_Set() const{
    return m_address1_isSet;
}

bool OAIAccountAddress::is_address1_Valid() const{
    return m_address1_isValid;
}

QString OAIAccountAddress::getAddress2() const {
    return m_address2;
}
void OAIAccountAddress::setAddress2(const QString &address2) {
    m_address2 = address2;
    m_address2_isSet = true;
}

bool OAIAccountAddress::is_address2_Set() const{
    return m_address2_isSet;
}

bool OAIAccountAddress::is_address2_Valid() const{
    return m_address2_isValid;
}

QString OAIAccountAddress::getAddress3() const {
    return m_address3;
}
void OAIAccountAddress::setAddress3(const QString &address3) {
    m_address3 = address3;
    m_address3_isSet = true;
}

bool OAIAccountAddress::is_address3_Set() const{
    return m_address3_isSet;
}

bool OAIAccountAddress::is_address3_Valid() const{
    return m_address3_isValid;
}

QString OAIAccountAddress::getCity() const {
    return m_city;
}
void OAIAccountAddress::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIAccountAddress::is_city_Set() const{
    return m_city_isSet;
}

bool OAIAccountAddress::is_city_Valid() const{
...
QString OAIAccountAddress::getSourceType() const {
    return m_source_type;
}
void OAIAccountAddress::setSourceType(const QString &source_type) {
    m_source_type = source_type;
    m_source_type_isSet = true;
}

bool OAIAccountAddress::is_source_type_Set() const{
    return m_source_type_isSet;
}

bool OAIAccountAddress::is_source_type_Valid() const{
    return m_source_type_isValid;
}

QString OAIAccountAddress::getState() const {
    return m_state;
}
void OAIAccountAddress::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIAccountAddress::is_state_Set() const{
    return m_state_isSet;
}

bool OAIAccountAddress::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIAccountAddress::getStreet() const {
    return m_street;
}
void OAIAccountAddress::setStreet(const QString &street) {
    m_street = street;
    m_street_isSet = true;
}

bool OAIAccountAddress::is_street_Set() const{
    return m_street_isSet;
}

bool OAIAccountAddress::is_street_Valid() const{
    return m_street_isValid;
}

QString OAIAccountAddress::getType() const {
    return m_type;
}
void OAIAccountAddress::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAccountAddress::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAccountAddress::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIAccountAddress::getZip() const {
    return m_zip;
}
void OAIAccountAddress::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAIAccountAddress::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAIAccountAddress::is_zip_Valid() const{
