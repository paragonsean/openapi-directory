...
#ifndef OAIProviders_H
#define OAIProviders_H
...
class OAIProviders : public OAIObject {
public:
    OAIProviders();
    OAIProviders(QString json);
    ~OAIProviders() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProviders)

#endif // OAIProviders_H
