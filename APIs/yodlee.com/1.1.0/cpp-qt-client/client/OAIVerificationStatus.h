...
class OAIVerificationStatus : public OAIObject {
public:
    ...
    qint64 getRemainingAttempts() const;
    void setRemainingAttempts(const qint64 &remaining_attempts);
    bool is_remaining_attempts_Set() const;
    bool is_remaining_attempts_Valid() const;
...
private:
    ...
    qint64 m_remaining_attempts;
    bool m_remaining_attempts_isSet;
    bool m_remaining_attempts_isValid;
