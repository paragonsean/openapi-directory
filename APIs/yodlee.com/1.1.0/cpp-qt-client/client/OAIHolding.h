...
public:
    ...
    QList<OAIAssetClassification> getAssetClassification() const;
    void setAssetClassification(const QList<OAIAssetClassification> &asset_classification);
...
private:
    ...
    QList<OAIAssetClassification> m_asset_classification;
