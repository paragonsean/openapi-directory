...
/*
 * OAIEvaluateAccountAddress.h
 *
 * 
 */

#ifndef OAIEvaluateAccountAddress_H
#define OAIEvaluateAccountAddress_H
...
class OAIEvaluateAccountAddress : public OAIObject {
public:
    OAIEvaluateAccountAddress();
    OAIEvaluateAccountAddress(QString json);
    ~OAIEvaluateAccountAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluateAccountAddress)

#endif // OAIEvaluateAccountAddress_H
