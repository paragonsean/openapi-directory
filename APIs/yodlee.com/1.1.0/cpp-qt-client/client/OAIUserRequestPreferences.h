...
/*
 * OAIUserRequestPreferences.h
 *
 * 
 */

#ifndef OAIUserRequestPreferences_H
#define OAIUserRequestPreferences_H
...
class OAIUserRequestPreferences : public OAIObject {
public:
    OAIUserRequestPreferences();
    OAIUserRequestPreferences(QString json);
    ~OAIUserRequestPreferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserRequestPreferences)

#endif // OAIUserRequestPreferences_H
