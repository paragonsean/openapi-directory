  ...
  describe('AccountsApi', function() {
    describe('createManualAccount', function() {
      it('should call createManualAccount successfully', function(done) {
        //uncomment below and update the code to test createManualAccount
        //instance.createManualAccount(function(error) {
    ...
    describe('evaluateAddress', function() {
      it('should call evaluateAddress successfully', function(done) {
        //uncomment below and update the code to test evaluateAddress
        //instance.evaluateAddress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getHistoricalBalances', function() {
      it('should call getHistoricalBalances successfully', function(done) {
        //uncomment below and update the code to test getHistoricalBalances
        //instance.getHistoricalBalances(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
