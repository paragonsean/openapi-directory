...
(function(root, factory) {
  ...
  describe('RuleClause', function() {
    it('should create an instance of RuleClause', function() {
      // uncomment below and update the code to test RuleClause
      //var instance = new YodleeCoreApis.RuleClause();
    ...
    it('should have the property ruleClauseId (base name: "ruleClauseId")', function() {
      // uncomment below and update the code to test the property ruleClauseId
      //var instance = new YodleeCoreApis.RuleClause();
      //expect(instance).to.be();
    });
