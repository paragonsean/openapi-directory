...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.ProviderAccount();
  });
  ...
  describe('ProviderAccount', function() {
    it('should create an instance of ProviderAccount', function() {
      // uncomment below and update the code to test ProviderAccount
      //var instance = new YodleeCoreApis.ProviderAccount();
      //expect(instance).to.be.a(YodleeCoreApis.ProviderAccount);
    });
