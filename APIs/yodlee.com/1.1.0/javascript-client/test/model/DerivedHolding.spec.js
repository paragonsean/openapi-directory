...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.DerivedHolding();
  });
  ...
  describe('DerivedHolding', function() {
    it('should create an instance of DerivedHolding', function() {
      // uncomment below and update the code to test DerivedHolding
      //var instance = new YodleeCoreApis.DerivedHolding();
      //expect(instance).to.be.a(YodleeCoreApis.DerivedHolding);
    });
