...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.UpdateUserRequest();
  });
  ...
  describe('UpdateUserRequest', function() {
    it('should create an instance of UpdateUserRequest', function() {
      ...
      //var instance = new YodleeCoreApis.UpdateUserRequest();
      //expect(instance).to.be.a(YodleeCoreApis.UpdateUserRequest);
    });
