...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.ProviderAccountDetail();
  });
  ...
  describe('ProviderAccountDetail', function() {
    it('should create an instance of ProviderAccountDetail', function() {
      // uncomment below and update the code to test ProviderAccountDetail
      //var instance = new YodleeCoreApis.ProviderAccountDetail();
      //expect(instance).to.be.a(YodleeCoreApis.ProviderAccountDetail);
    });
    ...
    it('should have the property loginForm (base name: "loginForm")', function() {
      // uncomment below and update the code to test the property loginForm
      //var instance = new YodleeCoreApis.ProviderAccountDetail();
      //expect(instance).to.be();
    });
