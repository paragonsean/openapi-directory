...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.YodleeError();
  });
  ...
  describe('YodleeError', function() {
    it('should create an instance of YodleeError', function() {
      // uncomment below and update the code to test YodleeError
      //var instance = new YodleeCoreApis.YodleeError();
      //expect(instance).to.be.a(YodleeCoreApis.YodleeError);
    });
