...
(function(root, factory) {
  ...
  describe('LoanPayoffDetails', function() {
    it('should create an instance of LoanPayoffDetails', function() {
      // uncomment below and update the code to test LoanPayoffDetails
      //var instance = new YodleeCoreApis.LoanPayoffDetails();
    ...
    it('should have the property payByDate (base name: "payByDate")', function() {
      // uncomment below and update the code to test the property payByDate
      //var instance = new YodleeCoreApis.LoanPayoffDetails();
      //expect(instance).to.be();
    });

    it('should have the property payoffAmount (base name: "payoffAmount")', function() {
      // uncomment below and update the code to test the property payoffAmount
      //var instance = new YodleeCoreApis.LoanPayoffDetails();
      //expect(instance).to.be();
    });
