...
(function(root, factory) {
  ...
  describe('CoverageAmount', function() {
    it('should create an instance of CoverageAmount', function() {
      // uncomment below and update the code to test CoverageAmount
      //var instance = new YodleeCoreApis.CoverageAmount();
    ...
    it('should have the property met (base name: "met")', function() {
      // uncomment below and update the code to test the property met
      //var instance = new YodleeCoreApis.CoverageAmount();
      //expect(instance).to.be();
    });
