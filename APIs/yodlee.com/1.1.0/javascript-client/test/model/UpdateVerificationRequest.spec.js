...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.UpdateVerificationRequest();
  });
  ...
  describe('UpdateVerificationRequest', function() {
    it('should create an instance of UpdateVerificationRequest', function() {
      // uncomment below and update the code to test UpdateVerificationRequest
      //var instance = new YodleeCoreApis.UpdateVerificationRequest();
      //expect(instance).to.be.a(YodleeCoreApis.UpdateVerificationRequest);
    });
