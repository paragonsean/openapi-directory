...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.CreatedAccountInfo();
  });
  ...
  describe('CreatedAccountInfo', function() {
    it('should create an instance of CreatedAccountInfo', function() {
      // uncomment below and update the code to test CreatedAccountInfo
      //var instance = new YodleeCoreApis.CreatedAccountInfo();
      //expect(instance).to.be.a(YodleeCoreApis.CreatedAccountInfo);
    });
