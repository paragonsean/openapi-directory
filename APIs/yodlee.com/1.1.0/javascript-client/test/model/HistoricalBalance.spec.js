...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.HistoricalBalance();
  });
  ...
  describe('HistoricalBalance', function() {
    it('should create an instance of HistoricalBalance', function() {
      // uncomment below and update the code to test HistoricalBalance
      //var instance = new YodleeCoreApis.HistoricalBalance();
      //expect(instance).to.be.a(YodleeCoreApis.HistoricalBalance);
    });
