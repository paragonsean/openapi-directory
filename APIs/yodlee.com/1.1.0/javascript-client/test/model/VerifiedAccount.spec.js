...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.VerifiedAccount();
  });
  ...
  describe('VerifiedAccount', function() {
    it('should create an instance of VerifiedAccount', function() {
      // uncomment below and update the code to test VerifiedAccount
      //var instance = new YodleeCoreApis.VerifiedAccount();
      //expect(instance).to.be.a(YodleeCoreApis.VerifiedAccount);
    });
