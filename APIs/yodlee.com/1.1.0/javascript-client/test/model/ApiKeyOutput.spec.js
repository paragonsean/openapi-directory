...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.ApiKeyOutput();
  });
  ...
  describe('ApiKeyOutput', function() {
    it('should create an instance of ApiKeyOutput', function() {
      // uncomment below and update the code to test ApiKeyOutput
      //var instance = new YodleeCoreApis.ApiKeyOutput();
      //expect(instance).to.be.a(YodleeCoreApis.ApiKeyOutput);
    });
