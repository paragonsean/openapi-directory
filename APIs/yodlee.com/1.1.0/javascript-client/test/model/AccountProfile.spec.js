...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.AccountProfile();
  });
  ...
  describe('AccountProfile', function() {
    it('should create an instance of AccountProfile', function() {
      // uncomment below and update the code to test AccountProfile
      //var instance = new YodleeCoreApis.AccountProfile();
      //expect(instance).to.be.a(YodleeCoreApis.AccountProfile);
    });
