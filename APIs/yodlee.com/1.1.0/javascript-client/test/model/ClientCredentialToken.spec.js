...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.ClientCredentialToken();
  });
  ...
  describe('ClientCredentialToken', function() {
    it('should create an instance of ClientCredentialToken', function() {
      // uncomment below and update the code to test ClientCredentialToken
      //var instance = new YodleeCoreApis.ClientCredentialToken();
      //expect(instance).to.be.a(YodleeCoreApis.ClientCredentialToken);
    });
