...
(function(root, factory) {
  ...
  describe('RewardBalance', function() {
    it('should create an instance of RewardBalance', function() {
      // uncomment below and update the code to test RewardBalance
      //var instance = new YodleeCoreApis.RewardBalance();
    ...
    it('should have the property balanceToLevel (base name: "balanceToLevel")', function() {
      // uncomment below and update the code to test the property balanceToLevel
      //var instance = new YodleeCoreApis.RewardBalance();
      //expect(instance).to.be();
    });

    it('should have the property balanceToReward (base name: "balanceToReward")', function() {
      // uncomment below and update the code to test the property balanceToReward
      //var instance = new YodleeCoreApis.RewardBalance();
      //expect(instance).to.be();
    });
