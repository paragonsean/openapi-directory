...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YodleeCoreApis.VerificationStatus();
  });
  ...
  describe('VerificationStatus', function() {
    it('should create an instance of VerificationStatus', function() {
      ...
      //var instance = new YodleeCoreApis.VerificationStatus();
      //expect(instance).to.be.a(YodleeCoreApis.VerificationStatus);
    });
    ...
    it('should have the property remainingAttempts (base name: "remainingAttempts")', function() {
      // uncomment below and update the code to test the property remainingAttempts
      //var instance = new YodleeCoreApis.VerificationStatus();
      //expect(instance).to.be();
    });
