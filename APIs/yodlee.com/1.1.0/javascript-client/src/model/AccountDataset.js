...
class AccountDataset {
    ...
    constructor() { 
        ...
        AccountDataset.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountDataset</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountDataset</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['nextUpdateScheduled'] && !(typeof data['nextUpdateScheduled'] === 'string' || data['nextUpdateScheduled'] instanceof String)) {
            throw new Error("Expected the field `nextUpdateScheduled` to be a primitive type in the JSON string but got " + data['nextUpdateScheduled']);
        }
        // ensure the json data is a string
        if (data['updateEligibility'] && !(typeof data['updateEligibility'] === 'string' || data['updateEligibility'] instanceof String)) {
            throw new Error("Expected the field `updateEligibility` to be a primitive type in the JSON string but got " + data['updateEligibility']);
        }
