    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('apiKey')) {
                obj['apiKey'] = ApiClient.convertToType(data['apiKey'], [ApiKeyOutput]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['apiKey']) { // data not null
            ...
            if (!Array.isArray(data['apiKey'])) {
                throw new Error("Expected the field `apiKey` to be an array in the JSON data but got " + data['apiKey']);
            }
            // validate the optional field `apiKey` (array)
            for (const item of data['apiKey']) {
                ApiKeyOutput.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ApiKeyOutput>} apiKey
 */
ApiKeyResponse.prototype['apiKey'] = undefined;
