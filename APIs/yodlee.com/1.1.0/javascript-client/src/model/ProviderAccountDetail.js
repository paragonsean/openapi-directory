...
/**
 * The ProviderAccountDetail model module.
 * @module model/ProviderAccountDetail
 * @version 1.1.0
 */
class ProviderAccountDetail {
    /**
     * Constructs a new <code>ProviderAccountDetail</code>.
     * @alias module:model/ProviderAccountDetail
     * @param consentId {Number} Consent Id generated through POST Consent.<br><br><b>Endpoints</b>:<ul><li>GET providerAccounts</li><li>POST providerAccounts</li><li>PUT providerAccounts/{providerAccountId}</li><li>GET providerAccounts/{providerAccountId}</li></ul>
     */
    constructor(consentId) { 
        
        ProviderAccountDetail.initialize(this, consentId);
    }
    ...
    /**
     * Constructs a <code>ProviderAccountDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProviderAccountDetail} obj Optional instance to populate.
     * @return {module:model/ProviderAccountDetail} The populated <code>ProviderAccountDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProviderAccountDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>ProviderAccountDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProviderAccountDetail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProviderAccountDetail.RequiredProperties) {
...
ProviderAccountDetail.RequiredProperties = ["consentId"];
 ...
 * @member {module:model/ProviderAccountDetail.AggregationSourceEnum} aggregationSource
 */
ProviderAccountDetail.prototype['aggregationSource'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['consentId'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['createdDate'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['dataset'] = undefined;
 ...
 * @member {Number} id
 */
ProviderAccountDetail.prototype['id'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['isManual'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['lastUpdated'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['loginForm'] = undefined;
 ...
 * @member {module:model/ProviderAccountDetail.OauthMigrationStatusEnum} oauthMigrationStatus
 */
ProviderAccountDetail.prototype['oauthMigrationStatus'] = undefined;

/**
 * @member {module:model/ProviderAccountPreferences} preferences
 */
ProviderAccountDetail.prototype['preferences'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['providerId'] = undefined;
 ...
 */
ProviderAccountDetail.prototype['requestId'] = undefined;
 ...
 * @member {module:model/ProviderAccountDetail.StatusEnum} status
 */
ProviderAccountDetail.prototype['status'] = undefined;
 ...
 * @readonly
 */
ProviderAccountDetail['AggregationSourceEnum'] = {
 ...
 * @readonly
 */
ProviderAccountDetail['OauthMigrationStatusEnum'] = {
 ...
 * @readonly
 */
ProviderAccountDetail['StatusEnum'] = {
