 ...
 * @version 1.1.0
 */
class CreateConfigsNotificationEvent {
    /**
    ...
    constructor() { 
        ...
        CreateConfigsNotificationEvent.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateConfigsNotificationEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateConfigsNotificationEvent</code>.
     */
...
export default CreateConfigsNotificationEvent;
