...
class DerivedNetworthHistoricalBalance {
    ...
    constructor() { 
        ...
        DerivedNetworthHistoricalBalance.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DerivedNetworthHistoricalBalance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DerivedNetworthHistoricalBalance</code>.
     */
 ...
 * @member {String} date
 */
DerivedNetworthHistoricalBalance.prototype['date'] = undefined;
...
export default DerivedNetworthHistoricalBalance;
