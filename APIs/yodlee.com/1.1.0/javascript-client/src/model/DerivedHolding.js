...
/**
 * The DerivedHolding model module.
 * @module model/DerivedHolding
 * @version 1.1.0
 */
class DerivedHolding {
    /**
     * Constructs a new <code>DerivedHolding</code>.
     * @alias module:model/DerivedHolding
     */
    constructor() { 
        
        DerivedHolding.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DerivedHolding</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DerivedHolding} obj Optional instance to populate.
     * @return {module:model/DerivedHolding} The populated <code>DerivedHolding</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DerivedHolding();
            ...
            if (data.hasOwnProperty('assetClassification')) {
                obj['assetClassification'] = AssetClassification.constructFromObject(data['assetClassification']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DerivedHolding</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DerivedHolding</code>.
     */
    static validateJSON(data) {
        ...
        if (data['assetClassification']) { // data not null
          AssetClassification.validateJSON(data['assetClassification']);
        }
 ...
 */
DerivedHolding.prototype['accountId'] = undefined;

/**
 * @member {module:model/Money} accruedIncome
 */
DerivedHolding.prototype['accruedIncome'] = undefined;

/**
 * @member {module:model/Money} accruedInterest
 */
DerivedHolding.prototype['accruedInterest'] = undefined;

/**
 * @member {module:model/AssetClassification} assetClassification
 */
DerivedHolding.prototype['assetClassification'] = undefined;
 ...
 */
DerivedHolding.prototype['contractQuantity'] = undefined;

/**
 * @member {module:model/Money} costBasis
 */
DerivedHolding.prototype['costBasis'] = undefined;

/**
 * The stated interest rate for a bond.<br><br><b>Applicable containers</b>: investment<br>
 * @member {Number} couponRate
 */
DerivedHolding.prototype['couponRate'] = undefined;
 ...
 */
DerivedHolding.prototype['createdDate'] = undefined;
 ...
 */
DerivedHolding.prototype['cusipNumber'] = undefined;
 ...
 */
DerivedHolding.prototype['description'] = undefined;
 ...
 */
DerivedHolding.prototype['enrichedDescription'] = undefined;
 ...
 */
DerivedHolding.prototype['exercisedQuantity'] = undefined;
 ...
 */
DerivedHolding.prototype['expirationDate'] = undefined;
 ...
 */
DerivedHolding.prototype['grantDate'] = undefined;

/**
 * Type of holding<br><br><b>Applicable containers</b>: investment, insurance<br>
 * @member {module:model/DerivedHolding.HoldingTypeEnum} holdingType
 */
DerivedHolding.prototype['holdingType'] = undefined;
 ...
 * @member {Number} id
 */
DerivedHolding.prototype['id'] = undefined;
 ...
 * @member {String} isin
 */
DerivedHolding.prototype['isin'] = undefined;
 ...
 */
DerivedHolding.prototype['lastUpdated'] = undefined;
 ...
 * @member {module:model/DerivedHolding.OptionTypeEnum} optionType
 */
DerivedHolding.prototype['optionType'] = undefined;

/**
 * @member {module:model/Money} price
 */
DerivedHolding.prototype['price'] = undefined;
 ...
 */
DerivedHolding.prototype['providerAccountId'] = undefined;
 ...
 */
DerivedHolding.prototype['quantity'] = undefined;
 ...
 */
DerivedHolding.prototype['securityStyle'] = undefined;
 ...
 */
DerivedHolding.prototype['securityType'] = undefined;
 ...
 * @member {String} sedol
 */
DerivedHolding.prototype['sedol'] = undefined;

/**
 * @member {module:model/Money} spread
 */
DerivedHolding.prototype['spread'] = undefined;

/**
 * @member {module:model/Money} strikePrice
 */
DerivedHolding.prototype['strikePrice'] = undefined;

/**
 * The symbol of the security.<br><br><b>Applicable containers</b>: investment<br>
 * @member {String} symbol
 */
DerivedHolding.prototype['symbol'] = undefined;
 ...
 * @member {String} term
 */
DerivedHolding.prototype['term'] = undefined;
 ...
 */
DerivedHolding.prototype['unvestedQuantity'] = undefined;

/**
 * @member {module:model/Money} unvestedValue
 */
DerivedHolding.prototype['unvestedValue'] = undefined;

/**
 * @member {module:model/Money} value
 */
DerivedHolding.prototype['value'] = undefined;
 ...
 */
DerivedHolding.prototype['vestedQuantity'] = undefined;
 ...
 */
DerivedHolding.prototype['vestedSharesExercisable'] = undefined;

/**
 * @member {module:model/Money} vestedValue
 */
DerivedHolding.prototype['vestedValue'] = undefined;
 ...
 */
DerivedHolding.prototype['vestingDate'] = undefined;
 ...
 * @readonly
 */
DerivedHolding['HoldingTypeEnum'] = {
