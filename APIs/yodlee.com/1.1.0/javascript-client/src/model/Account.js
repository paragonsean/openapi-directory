...
class Account {
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `autoRefresh`
        if (data['autoRefresh']) { // data not null
          AutoRefresh.validateJSON(data['autoRefresh']);
        }
        ...
        // validate the optional field `fullAccountNumberList`
        if (data['fullAccountNumberList']) { // data not null
          FullAccountNumberList.validateJSON(data['fullAccountNumberList']);
        }
        // ensure the json data is a string
        ...
        // validate the optional field `paymentProfile`
        if (data['paymentProfile']) { // data not null
          PaymentProfile.validateJSON(data['paymentProfile']);
        }
        // ensure the json data is a string
        ...
        if (data['profile']) { // data not null
          AccountProfile.validateJSON(data['profile']);
        }
        // ensure the json data is a string
 ...
 */
Account.prototype['401kLoan'] = undefined;
