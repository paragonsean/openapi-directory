...
To use the link you just defined in your project, switch to the directory you want to use your yodlee_core_apis from, and run:
...
var createAccountRequest = new YodleeCoreApis.CreateAccountRequest(); // {CreateAccountRequest} accountParam
...
api.createManualAccount(createAccountRequest, callback);
...
*YodleeCoreApis.ConfigsApi* | [**getPublicEncryptionKey**](docs/ConfigsApi.md#getPublicEncryptionKey) | **GET** /configs/publicKey | Get Public Key
...
*YodleeCoreApis.VerificationApi* | [**initiateMatchingOrChallengeDepositeVerification**](docs/VerificationApi.md#initiateMatchingOrChallengeDepositeVerification) | **POST** /verification | Initiaite Matching Service and Challenge Deposit
...
## Documentation for Models
 ...
 - [YodleeCoreApis.ConfigsPublicKey](docs/ConfigsPublicKey.md)
 - [YodleeCoreApis.ConfigsPublicKeyResponse](docs/ConfigsPublicKeyResponse.md)
