...
/**
 * Model tests for CreateAccountInfo
 */
public class CreateAccountInfoTest {
    private final CreateAccountInfo model = new CreateAccountInfo();
