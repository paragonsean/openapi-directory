...
public class ProviderAccount {
  ...
  public ProviderAccount consentId(Long consentId) {
  ...
  public ProviderAccount preferences(ProviderAccountPreferences preferences) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aggregationSource, providerAccount.aggregationSource) &&
        Objects.equals(this.consentId, providerAccount.consentId) &&
        Objects.equals(this.createdDate, providerAccount.createdDate) &&
        Objects.equals(this.dataset, providerAccount.dataset) &&
        Objects.equals(this.id, providerAccount.id) &&
        Objects.equals(this.isManual, providerAccount.isManual) &&
        Objects.equals(this.lastUpdated, providerAccount.lastUpdated) &&
        Objects.equals(this.oauthMigrationStatus, providerAccount.oauthMigrationStatus) &&
        Objects.equals(this.preferences, providerAccount.preferences) &&
        Objects.equals(this.providerId, providerAccount.providerId) &&
        Objects.equals(this.requestId, providerAccount.requestId) &&
        Objects.equals(this.status, providerAccount.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregationSource, consentId, createdDate, dataset, id, isManual, lastUpdated, oauthMigrationStatus, preferences, providerId, requestId, status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProviderAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProviderAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProviderAccount is not found in the empty JSON string", ProviderAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProviderAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProviderAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProviderAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProviderAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProviderAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<ProviderAccount>() {
           @Override
           public void write(JsonWriter out, ProviderAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProviderAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProviderAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProviderAccount
   * @throws IOException if the JSON string is invalid with respect to ProviderAccount
   */
  public static ProviderAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProviderAccount.class);
  }

  /**
   * Convert an instance of ProviderAccount to an JSON string
   *
   * @return JSON string
   */
