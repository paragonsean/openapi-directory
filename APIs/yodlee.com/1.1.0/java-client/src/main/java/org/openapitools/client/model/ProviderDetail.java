...
public class ProviderDetail {
  ...
  public boolean equals(Object o) {
    ...
    ProviderDetail providerDetail = (ProviderDetail) o;
    return Objects.equals(this.PRIORITY, providerDetail.PRIORITY) &&
        Objects.equals(this.accountType, providerDetail.accountType) &&
        Objects.equals(this.associatedProviderIds, providerDetail.associatedProviderIds) &&
        Objects.equals(this.authParameter, providerDetail.authParameter) &&
        Objects.equals(this.authType, providerDetail.authType) &&
        Objects.equals(this.baseUrl, providerDetail.baseUrl) &&
        Objects.equals(this.capability, providerDetail.capability) &&
        Objects.equals(this.countryISOCode, providerDetail.countryISOCode) &&
        Objects.equals(this.dataset, providerDetail.dataset) &&
        Objects.equals(this.favicon, providerDetail.favicon) &&
        Objects.equals(this.help, providerDetail.help) &&
        Objects.equals(this.id, providerDetail.id) &&
        Objects.equals(this.isAddedByUser, providerDetail.isAddedByUser) &&
        Objects.equals(this.isAutoRefreshEnabled, providerDetail.isAutoRefreshEnabled) &&
        Objects.equals(this.isConsentRequired, providerDetail.isConsentRequired) &&
        Objects.equals(this.languageISOCode, providerDetail.languageISOCode) &&
        Objects.equals(this.lastModified, providerDetail.lastModified) &&
        Objects.equals(this.loginForm, providerDetail.loginForm) &&
        Objects.equals(this.loginUrl, providerDetail.loginUrl) &&
        Objects.equals(this.logo, providerDetail.logo) &&
        Objects.equals(this.name, providerDetail.name) &&
        Objects.equals(this.primaryLanguageISOCode, providerDetail.primaryLanguageISOCode) &&
        Objects.equals(this.status, providerDetail.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(PRIORITY, accountType, associatedProviderIds, authParameter, authType, baseUrl, capability, countryISOCode, dataset, favicon, help, id, isAddedByUser, isAutoRefreshEnabled, isConsentRequired, languageISOCode, lastModified, loginForm, loginUrl, logo, name, primaryLanguageISOCode, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProviderDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProviderDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProviderDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProviderDetail is not found in the empty JSON string", ProviderDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProviderDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProviderDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProviderDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProviderDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProviderDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<ProviderDetail>() {
           @Override
           public void write(JsonWriter out, ProviderDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProviderDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProviderDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProviderDetail
   * @throws IOException if the JSON string is invalid with respect to ProviderDetail
   */
  public static ProviderDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProviderDetail.class);
  }

  /**
   * Convert an instance of ProviderDetail to an JSON string
   *
   * @return JSON string
   */
