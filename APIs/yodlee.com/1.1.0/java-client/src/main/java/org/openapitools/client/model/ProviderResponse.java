...
import org.openapitools.client.model.Providers;
...
public class ProviderResponse {
  ...
  private List<Providers> provider = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.provider, providerResponse.provider);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProviderResponse is not found in the empty JSON string", ProviderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProviderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProviderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("provider") != null && !jsonObj.get("provider").isJsonNull()) {
        ...
        if (jsonArrayprovider != null) {
          ...
          for (int i = 0; i < jsonArrayprovider.size(); i++) {
            Providers.validateJsonElement(jsonArrayprovider.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderResponse.class));
