...
public class Holding {
  ...
  private List<AssetClassification> assetClassification = new ArrayList<>();
  ...
  public Holding(
     Long accountId, 
     List<AssetClassification> assetClassification, 
  ...
  public Holding accruedIncome(Money accruedIncome) {
  ...
  public Holding accruedInterest(Money accruedInterest) {
  ...
  public Holding costBasis(Money costBasis) {
  ...
  public Holding price(Money price) {
    this.price = price;
    return this;
  }
  ...
  public Holding spread(Money spread) {
    this.spread = spread;
    return this;
  }
  ...
  public Holding strikePrice(Money strikePrice) {
  ...
  public Holding unvestedValue(Money unvestedValue) {
  ...
  public Holding value(Money value) {
    this.value = value;
    return this;
  }
  ...
  public Holding vestedValue(Money vestedValue) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, holding.accountId) &&
        Objects.equals(this.accruedIncome, holding.accruedIncome) &&
        Objects.equals(this.accruedInterest, holding.accruedInterest) &&
        Objects.equals(this.assetClassification, holding.assetClassification) &&
        Objects.equals(this.contractQuantity, holding.contractQuantity) &&
        Objects.equals(this.costBasis, holding.costBasis) &&
        Objects.equals(this.couponRate, holding.couponRate) &&
        Objects.equals(this.createdDate, holding.createdDate) &&
        Objects.equals(this.cusipNumber, holding.cusipNumber) &&
        Objects.equals(this.description, holding.description) &&
        Objects.equals(this.enrichedDescription, holding.enrichedDescription) &&
        Objects.equals(this.exercisedQuantity, holding.exercisedQuantity) &&
        Objects.equals(this.expirationDate, holding.expirationDate) &&
        Objects.equals(this.grantDate, holding.grantDate) &&
        Objects.equals(this.holdingType, holding.holdingType) &&
        Objects.equals(this.id, holding.id) &&
        Objects.equals(this.interestRate, holding.interestRate) &&
        Objects.equals(this.isShort, holding.isShort) &&
        Objects.equals(this.isin, holding.isin) &&
        Objects.equals(this.lastUpdated, holding.lastUpdated) &&
        Objects.equals(this.matchStatus, holding.matchStatus) &&
        Objects.equals(this.maturityDate, holding.maturityDate) &&
        Objects.equals(this.optionType, holding.optionType) &&
        Objects.equals(this.price, holding.price) &&
        Objects.equals(this.providerAccountId, holding.providerAccountId) &&
        Objects.equals(this.quantity, holding.quantity) &&
        Objects.equals(this.securityStyle, holding.securityStyle) &&
        Objects.equals(this.securityType, holding.securityType) &&
        Objects.equals(this.sedol, holding.sedol) &&
        Objects.equals(this.spread, holding.spread) &&
        Objects.equals(this.strikePrice, holding.strikePrice) &&
        Objects.equals(this.symbol, holding.symbol) &&
        Objects.equals(this.term, holding.term) &&
        Objects.equals(this.unvestedQuantity, holding.unvestedQuantity) &&
        Objects.equals(this.unvestedValue, holding.unvestedValue) &&
        Objects.equals(this.value, holding.value) &&
        Objects.equals(this.vestedQuantity, holding.vestedQuantity) &&
        Objects.equals(this.vestedSharesExercisable, holding.vestedSharesExercisable) &&
        Objects.equals(this.vestedValue, holding.vestedValue) &&
        Objects.equals(this.vestingDate, holding.vestingDate);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("assetClassification") != null && !jsonObj.get("assetClassification").isJsonNull()) {
        JsonArray jsonArrayassetClassification = jsonObj.getAsJsonArray("assetClassification");
        if (jsonArrayassetClassification != null) {
          // ensure the json data is an array
          if (!jsonObj.get("assetClassification").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `assetClassification` to be an array in the JSON string but got `%s`", jsonObj.get("assetClassification").toString()));
          }

          // validate the optional field `assetClassification` (array)
          for (int i = 0; i < jsonArrayassetClassification.size(); i++) {
            AssetClassification.validateJsonElement(jsonArrayassetClassification.get(i));
          };
        }
      }
