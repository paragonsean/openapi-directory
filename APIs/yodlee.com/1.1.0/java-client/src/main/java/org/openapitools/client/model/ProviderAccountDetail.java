...
public class ProviderAccountDetail {
  ...
  public ProviderAccountDetail consentId(Long consentId) {
  ...
  public ProviderAccountDetail preferences(ProviderAccountPreferences preferences) {
  ...
  public boolean equals(Object o) {
    ...
    ProviderAccountDetail providerAccountDetail = (ProviderAccountDetail) o;
    return Objects.equals(this.aggregationSource, providerAccountDetail.aggregationSource) &&
        Objects.equals(this.consentId, providerAccountDetail.consentId) &&
        Objects.equals(this.createdDate, providerAccountDetail.createdDate) &&
        Objects.equals(this.dataset, providerAccountDetail.dataset) &&
        Objects.equals(this.id, providerAccountDetail.id) &&
        Objects.equals(this.isManual, providerAccountDetail.isManual) &&
        Objects.equals(this.lastUpdated, providerAccountDetail.lastUpdated) &&
        Objects.equals(this.loginForm, providerAccountDetail.loginForm) &&
        Objects.equals(this.oauthMigrationStatus, providerAccountDetail.oauthMigrationStatus) &&
        Objects.equals(this.preferences, providerAccountDetail.preferences) &&
        Objects.equals(this.providerId, providerAccountDetail.providerId) &&
        Objects.equals(this.requestId, providerAccountDetail.requestId) &&
        Objects.equals(this.status, providerAccountDetail.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregationSource, consentId, createdDate, dataset, id, isManual, lastUpdated, loginForm, oauthMigrationStatus, preferences, providerId, requestId, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProviderAccountDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProviderAccountDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProviderAccountDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProviderAccountDetail is not found in the empty JSON string", ProviderAccountDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProviderAccountDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProviderAccountDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProviderAccountDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProviderAccountDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProviderAccountDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProviderAccountDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderAccountDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<ProviderAccountDetail>() {
           @Override
           public void write(JsonWriter out, ProviderAccountDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProviderAccountDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProviderAccountDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProviderAccountDetail
   * @throws IOException if the JSON string is invalid with respect to ProviderAccountDetail
   */
  public static ProviderAccountDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProviderAccountDetail.class);
  }

  /**
   * Convert an instance of ProviderAccountDetail to an JSON string
   *
   * @return JSON string
   */
