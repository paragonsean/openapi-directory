...
public class Account {
  ...
  public static final String SERIALIZED_NAME_FULL_ACCOUNT_NUMBER_LIST = "fullAccountNumberList";
  @SerializedName(SERIALIZED_NAME_FULL_ACCOUNT_NUMBER_LIST)
  ...
  public static final String SERIALIZED_NAME_PAYMENT_PROFILE = "paymentProfile";
  ...
  public Account _401kLoan(Money _401kLoan) {
  ...
  public Account address(AccountAddress address) {
  ...
  public Account amountDue(Money amountDue) {
  ...
  public Account annuityBalance(Money annuityBalance) {
  ...
  public Account autoRefresh(AutoRefresh autoRefresh) {
  ...
  public Account availableBalance(Money availableBalance) {
  ...
  public Account availableCash(Money availableCash) {
  ...
  public Account availableCredit(Money availableCredit) {
  ...
  public Account balance(Money balance) {
  ...
  public Account cash(Money cash) {
    this.cash = cash;
    return this;
  }
  ...
  public Account cashApr(Double cashApr) {
  ...
  public Account cashValue(Money cashValue) {
  ...
  public Account currentBalance(Money currentBalance) {
  ...
  public Account deathBenefit(Money deathBenefit) {
  ...
  public Account escrowBalance(Money escrowBalance) {
  ...
  public Account faceAmount(Money faceAmount) {
  ...
  public Account fullAccountNumberList(FullAccountNumberList fullAccountNumberList) {
  ...
  public void setFullAccountNumberList(FullAccountNumberList fullAccountNumberList) {
    this.fullAccountNumberList = fullAccountNumberList;
  }
  ...
  public Account homeValue(Money homeValue) {
  ...
  public Account interestPaidLastYear(Money interestPaidLastYear) {
  ...
  public Account interestPaidYTD(Money interestPaidYTD) {
  ...
  public Account lastEmployeeContributionAmount(Money lastEmployeeContributionAmount) {
  ...
  public Account lastPayment(Money lastPayment) {
  ...
  public Account lastPaymentAmount(Money lastPaymentAmount) {
  ...
  public Account loanPayoffAmount(Money loanPayoffAmount) {
  ...
  public Account loanPayoffDetails(LoanPayoffDetails loanPayoffDetails) {
  ...
  public Account marginBalance(Money marginBalance) {
  ...
  public Account maturityAmount(Money maturityAmount) {
  ...
  public Account minimumAmountDue(Money minimumAmountDue) {
  ...
  public Account moneyMarketBalance(Money moneyMarketBalance) {
  ...
  public Account originalLoanAmount(Money originalLoanAmount) {
  ...
  public Account overDraftLimit(Money overDraftLimit) {
  ...
  public Account paymentProfile(PaymentProfile paymentProfile) {
  ...
  public Account premium(Money premium) {
  ...
  public Account principalBalance(Money principalBalance) {
  ...
  public Account profile(AccountProfile profile) {
  ...
  public Account recurringPayment(Money recurringPayment) {
  ...
  public Account remainingBalance(Money remainingBalance) {
  ...
  public Account runningBalance(Money runningBalance) {
  ...
  public Account shortBalance(Money shortBalance) {
  ...
  public Account totalCashLimit(Money totalCashLimit) {
  ...
  public Account totalCreditLimit(Money totalCreditLimit) {
  ...
  public Account totalCreditLine(Money totalCreditLine) {
  ...
  public Account totalUnvestedBalance(Money totalUnvestedBalance) {
  ...
  public Account totalVestedBalance(Money totalVestedBalance) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._401kLoan, account._401kLoan) &&
        Objects.equals(this.CONTAINER, account.CONTAINER) &&
        ...
        Objects.equals(this.aggregationSource, account.aggregationSource) &&
        Objects.equals(this.amountDue, account.amountDue) &&
        Objects.equals(this.annualPercentageYield, account.annualPercentageYield) &&
        Objects.equals(this.annuityBalance, account.annuityBalance) &&
        Objects.equals(this.apr, account.apr) &&
        Objects.equals(this.associatedProviderAccountId, account.associatedProviderAccountId) &&
        Objects.equals(this.autoRefresh, account.autoRefresh) &&
        Objects.equals(this.availableBalance, account.availableBalance) &&
        Objects.equals(this.availableCash, account.availableCash) &&
        Objects.equals(this.availableCredit, account.availableCredit) &&
        Objects.equals(this.balance, account.balance) &&
        Objects.equals(this.bankTransferCode, account.bankTransferCode) &&
        Objects.equals(this.cash, account.cash) &&
        Objects.equals(this.cashApr, account.cashApr) &&
        Objects.equals(this.cashValue, account.cashValue) &&
        Objects.equals(this.classification, account.classification) &&
        Objects.equals(this.collateral, account.collateral) &&
        Objects.equals(this.coverage, account.coverage) &&
        Objects.equals(this.createdDate, account.createdDate) &&
        Objects.equals(this.currentBalance, account.currentBalance) &&
        Objects.equals(this.currentLevel, account.currentLevel) &&
        Objects.equals(this.dataset, account.dataset) &&
        Objects.equals(this.deathBenefit, account.deathBenefit) &&
        Objects.equals(this.derivedApr, account.derivedApr) &&
        Objects.equals(this.displayedName, account.displayedName) &&
        Objects.equals(this.dueDate, account.dueDate) &&
        Objects.equals(this.enrollmentDate, account.enrollmentDate) &&
        Objects.equals(this.escrowBalance, account.escrowBalance) &&
        Objects.equals(this.estimatedDate, account.estimatedDate) &&
        Objects.equals(this.expirationDate, account.expirationDate) &&
        Objects.equals(this.faceAmount, account.faceAmount) &&
        Objects.equals(this.frequency, account.frequency) &&
        Objects.equals(this.fullAccountNumber, account.fullAccountNumber) &&
        Objects.equals(this.fullAccountNumberList, account.fullAccountNumberList) &&
        Objects.equals(this.guarantor, account.guarantor) &&
        Objects.equals(this.holder, account.holder) &&
        Objects.equals(this.homeInsuranceType, account.homeInsuranceType) &&
        Objects.equals(this.homeValue, account.homeValue) &&
        Objects.equals(this.id, account.id) &&
        Objects.equals(this.includeInNetWorth, account.includeInNetWorth) &&
        Objects.equals(this.interestPaidLastYear, account.interestPaidLastYear) &&
        Objects.equals(this.interestPaidYTD, account.interestPaidYTD) &&
        Objects.equals(this.interestRate, account.interestRate) &&
        Objects.equals(this.interestRateType, account.interestRateType) &&
        Objects.equals(this.isAsset, account.isAsset) &&
        Objects.equals(this.isManual, account.isManual) &&
        Objects.equals(this.lastEmployeeContributionAmount, account.lastEmployeeContributionAmount) &&
        Objects.equals(this.lastEmployeeContributionDate, account.lastEmployeeContributionDate) &&
        ...
        Objects.equals(this.lender, account.lender) &&
        Objects.equals(this.lifeInsuranceType, account.lifeInsuranceType) &&
        Objects.equals(this.loanPayByDate, account.loanPayByDate) &&
        Objects.equals(this.loanPayoffAmount, account.loanPayoffAmount) &&
        Objects.equals(this.loanPayoffDetails, account.loanPayoffDetails) &&
        Objects.equals(this.marginBalance, account.marginBalance) &&
        Objects.equals(this.maturityAmount, account.maturityAmount) &&
        Objects.equals(this.maturityDate, account.maturityDate) &&
        Objects.equals(this.memo, account.memo) &&
        Objects.equals(this.minimumAmountDue, account.minimumAmountDue) &&
        Objects.equals(this.moneyMarketBalance, account.moneyMarketBalance) &&
        Objects.equals(this.nextLevel, account.nextLevel) &&
        Objects.equals(this.nickname, account.nickname) &&
        Objects.equals(this.oauthMigrationStatus, account.oauthMigrationStatus) &&
        Objects.equals(this.originalLoanAmount, account.originalLoanAmount) &&
        Objects.equals(this.originationDate, account.originationDate) &&
        Objects.equals(this.overDraftLimit, account.overDraftLimit) &&
        Objects.equals(this.paymentProfile, account.paymentProfile) &&
        Objects.equals(this.policyEffectiveDate, account.policyEffectiveDate) &&
        Objects.equals(this.policyFromDate, account.policyFromDate) &&
        Objects.equals(this.policyStatus, account.policyStatus) &&
        Objects.equals(this.policyTerm, account.policyTerm) &&
        Objects.equals(this.policyToDate, account.policyToDate) &&
        Objects.equals(this.premium, account.premium) &&
        Objects.equals(this.premiumPaymentTerm, account.premiumPaymentTerm) &&
        Objects.equals(this.primaryRewardUnit, account.primaryRewardUnit) &&
        Objects.equals(this.principalBalance, account.principalBalance) &&
        Objects.equals(this.profile, account.profile) &&
        ...
        Objects.equals(this.recurringPayment, account.recurringPayment) &&
        Objects.equals(this.remainingBalance, account.remainingBalance) &&
        Objects.equals(this.repaymentPlanType, account.repaymentPlanType) &&
        Objects.equals(this.rewardBalance, account.rewardBalance) &&
        Objects.equals(this.runningBalance, account.runningBalance) &&
        Objects.equals(this.shortBalance, account.shortBalance) &&
        Objects.equals(this.sourceAccountStatus, account.sourceAccountStatus) &&
        Objects.equals(this.sourceId, account.sourceId) &&
        Objects.equals(this.term, account.term) &&
        Objects.equals(this.totalCashLimit, account.totalCashLimit) &&
        Objects.equals(this.totalCreditLimit, account.totalCreditLimit) &&
        Objects.equals(this.totalCreditLine, account.totalCreditLine) &&
        Objects.equals(this.totalUnvestedBalance, account.totalUnvestedBalance) &&
        Objects.equals(this.totalVestedBalance, account.totalVestedBalance) &&
        Objects.equals(this.userClassification, account.userClassification) &&
        Objects.equals(this.valuationType, account.valuationType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_401kLoan, CONTAINER, accountName, accountNumber, accountStatus, accountType, address, aggregationSource, amountDue, annualPercentageYield, annuityBalance, apr, associatedProviderAccountId, autoRefresh, availableBalance, availableCash, availableCredit, balance, bankTransferCode, cash, cashApr, cashValue, classification, collateral, coverage, createdDate, currentBalance, currentLevel, dataset, deathBenefit, derivedApr, displayedName, dueDate, enrollmentDate, escrowBalance, estimatedDate, expirationDate, faceAmount, frequency, fullAccountNumber, fullAccountNumberList, guarantor, holder, homeInsuranceType, homeValue, id, includeInNetWorth, interestPaidLastYear, interestPaidYTD, interestRate, interestRateType, isAsset, isManual, lastEmployeeContributionAmount, lastEmployeeContributionDate, lastPayment, lastPaymentAmount, lastPaymentDate, lastUpdated, lender, lifeInsuranceType, loanPayByDate, loanPayoffAmount, loanPayoffDetails, marginBalance, maturityAmount, maturityDate, memo, minimumAmountDue, moneyMarketBalance, nextLevel, nickname, oauthMigrationStatus, originalLoanAmount, originationDate, overDraftLimit, paymentProfile, policyEffectiveDate, policyFromDate, policyStatus, policyTerm, policyToDate, premium, premiumPaymentTerm, primaryRewardUnit, principalBalance, profile, providerAccountId, providerId, providerName, recurringPayment, remainingBalance, repaymentPlanType, rewardBalance, runningBalance, shortBalance, sourceAccountStatus, sourceId, term, totalCashLimit, totalCreditLimit, totalCreditLine, totalUnvestedBalance, totalVestedBalance, userClassification, valuationType);
  }
  ...
  static {
    ...
    openapiFields.add("fullAccountNumberList");
    ...
    openapiFields.add("paymentProfile");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("autoRefresh") != null && !jsonObj.get("autoRefresh").isJsonNull()) {
        AutoRefresh.validateJsonElement(jsonObj.get("autoRefresh"));
      }
      ...
      if (jsonObj.get("fullAccountNumberList") != null && !jsonObj.get("fullAccountNumberList").isJsonNull()) {
        FullAccountNumberList.validateJsonElement(jsonObj.get("fullAccountNumberList"));
      }
      ...
      if (jsonObj.get("paymentProfile") != null && !jsonObj.get("paymentProfile").isJsonNull()) {
        PaymentProfile.validateJsonElement(jsonObj.get("paymentProfile"));
      }
      ...
      if (jsonObj.get("profile") != null && !jsonObj.get("profile").isJsonNull()) {
        AccountProfile.validateJsonElement(jsonObj.get("profile"));
      }
