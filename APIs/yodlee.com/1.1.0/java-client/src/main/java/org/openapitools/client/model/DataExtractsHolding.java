...
public class DataExtractsHolding {
  ...
  public DataExtractsHolding accruedIncome(Money accruedIncome) {
  ...
  public DataExtractsHolding accruedInterest(Money accruedInterest) {
  ...
  public DataExtractsHolding costBasis(Money costBasis) {
  ...
  public DataExtractsHolding price(Money price) {
    this.price = price;
    return this;
  }
  ...
  public DataExtractsHolding spread(Money spread) {
    this.spread = spread;
    return this;
  }
  ...
  public DataExtractsHolding strikePrice(Money strikePrice) {
  ...
  public DataExtractsHolding unvestedValue(Money unvestedValue) {
  ...
  public DataExtractsHolding value(Money value) {
    this.value = value;
    return this;
  }
  ...
  public DataExtractsHolding vestedValue(Money vestedValue) {
  ...
  public boolean equals(Object o) {
    ...
    DataExtractsHolding dataExtractsHolding = (DataExtractsHolding) o;
    return Objects.equals(this.accountId, dataExtractsHolding.accountId) &&
        Objects.equals(this.accruedIncome, dataExtractsHolding.accruedIncome) &&
        Objects.equals(this.accruedInterest, dataExtractsHolding.accruedInterest) &&
        Objects.equals(this.contractQuantity, dataExtractsHolding.contractQuantity) &&
        Objects.equals(this.costBasis, dataExtractsHolding.costBasis) &&
        Objects.equals(this.couponRate, dataExtractsHolding.couponRate) &&
        Objects.equals(this.createdDate, dataExtractsHolding.createdDate) &&
        Objects.equals(this.cusipNumber, dataExtractsHolding.cusipNumber) &&
        Objects.equals(this.description, dataExtractsHolding.description) &&
        Objects.equals(this.enrichedDescription, dataExtractsHolding.enrichedDescription) &&
        Objects.equals(this.exercisedQuantity, dataExtractsHolding.exercisedQuantity) &&
        Objects.equals(this.expirationDate, dataExtractsHolding.expirationDate) &&
        Objects.equals(this.grantDate, dataExtractsHolding.grantDate) &&
        Objects.equals(this.holdingType, dataExtractsHolding.holdingType) &&
        Objects.equals(this.id, dataExtractsHolding.id) &&
        Objects.equals(this.interestRate, dataExtractsHolding.interestRate) &&
        Objects.equals(this.isShort, dataExtractsHolding.isShort) &&
        Objects.equals(this.isin, dataExtractsHolding.isin) &&
        Objects.equals(this.lastUpdated, dataExtractsHolding.lastUpdated) &&
        Objects.equals(this.matchStatus, dataExtractsHolding.matchStatus) &&
        Objects.equals(this.maturityDate, dataExtractsHolding.maturityDate) &&
        Objects.equals(this.optionType, dataExtractsHolding.optionType) &&
        Objects.equals(this.price, dataExtractsHolding.price) &&
        Objects.equals(this.providerAccountId, dataExtractsHolding.providerAccountId) &&
        Objects.equals(this.quantity, dataExtractsHolding.quantity) &&
        Objects.equals(this.securityStyle, dataExtractsHolding.securityStyle) &&
        Objects.equals(this.securityType, dataExtractsHolding.securityType) &&
        Objects.equals(this.sedol, dataExtractsHolding.sedol) &&
        Objects.equals(this.spread, dataExtractsHolding.spread) &&
        Objects.equals(this.strikePrice, dataExtractsHolding.strikePrice) &&
        Objects.equals(this.symbol, dataExtractsHolding.symbol) &&
        Objects.equals(this.term, dataExtractsHolding.term) &&
        Objects.equals(this.unvestedQuantity, dataExtractsHolding.unvestedQuantity) &&
        Objects.equals(this.unvestedValue, dataExtractsHolding.unvestedValue) &&
        Objects.equals(this.value, dataExtractsHolding.value) &&
        Objects.equals(this.vestedQuantity, dataExtractsHolding.vestedQuantity) &&
        Objects.equals(this.vestedSharesExercisable, dataExtractsHolding.vestedSharesExercisable) &&
        Objects.equals(this.vestedValue, dataExtractsHolding.vestedValue) &&
        Objects.equals(this.vestingDate, dataExtractsHolding.vestingDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, accruedIncome, accruedInterest, contractQuantity, costBasis, couponRate, createdDate, cusipNumber, description, enrichedDescription, exercisedQuantity, expirationDate, grantDate, holdingType, id, interestRate, isShort, isin, lastUpdated, matchStatus, maturityDate, optionType, price, providerAccountId, quantity, securityStyle, securityType, sedol, spread, strikePrice, symbol, term, unvestedQuantity, unvestedValue, value, vestedQuantity, vestedSharesExercisable, vestedValue, vestingDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DataExtractsHolding {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataExtractsHolding
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataExtractsHolding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataExtractsHolding is not found in the empty JSON string", DataExtractsHolding.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataExtractsHolding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataExtractsHolding` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataExtractsHolding.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataExtractsHolding' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataExtractsHolding> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataExtractsHolding.class));

       return (TypeAdapter<T>) new TypeAdapter<DataExtractsHolding>() {
           @Override
           public void write(JsonWriter out, DataExtractsHolding value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataExtractsHolding read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataExtractsHolding given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataExtractsHolding
   * @throws IOException if the JSON string is invalid with respect to DataExtractsHolding
   */
  public static DataExtractsHolding fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataExtractsHolding.class);
  }

  /**
   * Convert an instance of DataExtractsHolding to an JSON string
   *
   * @return JSON string
   */
