...
public class UpdateAccountInfo {
  ...
  public static final String SERIALIZED_NAME_IS_EBILL_ENROLLED = "isEbillEnrolled";
  @SerializedName(SERIALIZED_NAME_IS_EBILL_ENROLLED)
  ...
  public UpdateAccountInfo accountName(String accountName) {
  ...
  public UpdateAccountInfo accountNumber(String accountNumber) {
  ...
  public UpdateAccountInfo accountStatus(AccountStatusEnum accountStatus) {
  ...
  public UpdateAccountInfo address(AccountAddress address) {
  ...
  public UpdateAccountInfo amountDue(Money amountDue) {
  ...
  public UpdateAccountInfo balance(Money balance) {
  ...
  public UpdateAccountInfo container(ContainerEnum container) {
  ...
  public UpdateAccountInfo dueDate(String dueDate) {
  ...
  public UpdateAccountInfo frequency(FrequencyEnum frequency) {
  ...
  public UpdateAccountInfo homeValue(Money homeValue) {
  ...
  public UpdateAccountInfo includeInNetWorth(String includeInNetWorth) {
  ...
  public UpdateAccountInfo isEbillEnrolled(String isEbillEnrolled) {
  ...
  public UpdateAccountInfo memo(String memo) {
    this.memo = memo;
    return this;
  }
  ...
  public UpdateAccountInfo nickname(String nickname) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAccountInfo updateAccountInfo = (UpdateAccountInfo) o;
    return Objects.equals(this.accountName, updateAccountInfo.accountName) &&
        Objects.equals(this.accountNumber, updateAccountInfo.accountNumber) &&
        Objects.equals(this.accountStatus, updateAccountInfo.accountStatus) &&
        Objects.equals(this.address, updateAccountInfo.address) &&
        Objects.equals(this.amountDue, updateAccountInfo.amountDue) &&
        Objects.equals(this.balance, updateAccountInfo.balance) &&
        Objects.equals(this.container, updateAccountInfo.container) &&
        Objects.equals(this.dueDate, updateAccountInfo.dueDate) &&
        Objects.equals(this.frequency, updateAccountInfo.frequency) &&
        Objects.equals(this.homeValue, updateAccountInfo.homeValue) &&
        Objects.equals(this.includeInNetWorth, updateAccountInfo.includeInNetWorth) &&
        Objects.equals(this.isEbillEnrolled, updateAccountInfo.isEbillEnrolled) &&
        Objects.equals(this.memo, updateAccountInfo.memo) &&
        Objects.equals(this.nickname, updateAccountInfo.nickname);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountName, accountNumber, accountStatus, address, amountDue, balance, container, dueDate, frequency, homeValue, includeInNetWorth, isEbillEnrolled, memo, nickname);
  }
  ...
  public String toString() {
    ...
    sb.append("    isEbillEnrolled: ").append(toIndentedString(isEbillEnrolled)).append("\n");
  ...
  static {
    ...
    openapiFields.add("isEbillEnrolled");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAccountInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAccountInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAccountInfo is not found in the empty JSON string", UpdateAccountInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAccountInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAccountInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("isEbillEnrolled") != null && !jsonObj.get("isEbillEnrolled").isJsonNull()) && !jsonObj.get("isEbillEnrolled").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `isEbillEnrolled` to be a primitive type in the JSON string but got `%s`", jsonObj.get("isEbillEnrolled").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAccountInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAccountInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAccountInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAccountInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAccountInfo>() {
           @Override
           public void write(JsonWriter out, UpdateAccountInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAccountInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAccountInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAccountInfo
   * @throws IOException if the JSON string is invalid with respect to UpdateAccountInfo
   */
  public static UpdateAccountInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAccountInfo.class);
  }

  /**
   * Convert an instance of UpdateAccountInfo to an JSON string
   *
   * @return JSON string
   */
