...
public class Row {
  ...
  public static final String SERIALIZED_NAME_FIELD_ROW_CHOICE = "fieldRowChoice";
  @SerializedName(SERIALIZED_NAME_FIELD_ROW_CHOICE)
  ...
  public Row field(List<Field> field) {
    this.field = field;
    return this;
  }

  public Row addFieldItem(Field fieldItem) {
    if (this.field == null) {
  ...
  public Row fieldRowChoice(String fieldRowChoice) {
  ...
  public boolean equals(Object o) {
    ...
    Row row = (Row) o;
    return Objects.equals(this.field, row.field) &&
        Objects.equals(this.fieldRowChoice, row.fieldRowChoice) &&
        Objects.equals(this.form, row.form) &&
        Objects.equals(this.id, row.id) &&
        Objects.equals(this.label, row.label);
  }

  @Override
  public int hashCode() {
    return Objects.hash(field, fieldRowChoice, form, id, label);
  }
  ...
  public String toString() {
    ...
    sb.append("    fieldRowChoice: ").append(toIndentedString(fieldRowChoice)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fieldRowChoice");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("fieldRowChoice") != null && !jsonObj.get("fieldRowChoice").isJsonNull()) && !jsonObj.get("fieldRowChoice").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fieldRowChoice` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fieldRowChoice").toString()));
      }
