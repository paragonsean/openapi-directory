...
public class VerificationStatus {
  ...
  public VerificationStatus account(VerificationAccount account) {
  ...
  public VerificationStatus accountId(Long accountId) {
  ...
  public VerificationStatus providerAccountId(Long providerAccountId) {
  ...
  public VerificationStatus verificationType(VerificationTypeEnum verificationType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, verificationStatus.account) &&
        Objects.equals(this.accountId, verificationStatus.accountId) &&
        Objects.equals(this.providerAccountId, verificationStatus.providerAccountId) &&
        Objects.equals(this.reason, verificationStatus.reason) &&
        Objects.equals(this.remainingAttempts, verificationStatus.remainingAttempts) &&
        Objects.equals(this.verificationDate, verificationStatus.verificationDate) &&
        Objects.equals(this.verificationId, verificationStatus.verificationId) &&
        Objects.equals(this.verificationStatus, verificationStatus.verificationStatus) &&
        Objects.equals(this.verificationType, verificationStatus.verificationType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, accountId, providerAccountId, reason, remainingAttempts, verificationDate, verificationId, verificationStatus, verificationType);
  }
  ...
  static {
    ...
    openapiFields.add("remainingAttempts");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerificationStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerificationStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerificationStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerificationStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
