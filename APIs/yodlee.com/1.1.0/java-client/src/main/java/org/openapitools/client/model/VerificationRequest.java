...
public class VerificationRequest {
  ...
  public VerificationRequest verification(Verification verification) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.verification, verificationRequest.verification);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerificationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerificationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
