...
public class DataExtractsProviderAccount {
  ...
  public DataExtractsProviderAccount() {
  }
  ...
  public boolean equals(Object o) {
    ...
    DataExtractsProviderAccount dataExtractsProviderAccount = (DataExtractsProviderAccount) o;
    return Objects.equals(this.aggregationSource, dataExtractsProviderAccount.aggregationSource) &&
        Objects.equals(this.createdDate, dataExtractsProviderAccount.createdDate) &&
        Objects.equals(this.dataset, dataExtractsProviderAccount.dataset) &&
        Objects.equals(this.id, dataExtractsProviderAccount.id) &&
        Objects.equals(this.isDeleted, dataExtractsProviderAccount.isDeleted) &&
        Objects.equals(this.isManual, dataExtractsProviderAccount.isManual) &&
        Objects.equals(this.lastUpdated, dataExtractsProviderAccount.lastUpdated) &&
        Objects.equals(this.oauthMigrationStatus, dataExtractsProviderAccount.oauthMigrationStatus) &&
        Objects.equals(this.providerId, dataExtractsProviderAccount.providerId) &&
        Objects.equals(this.requestId, dataExtractsProviderAccount.requestId) &&
        Objects.equals(this.status, dataExtractsProviderAccount.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregationSource, createdDate, dataset, id, isDeleted, isManual, lastUpdated, oauthMigrationStatus, providerId, requestId, status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataExtractsProviderAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataExtractsProviderAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataExtractsProviderAccount is not found in the empty JSON string", DataExtractsProviderAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataExtractsProviderAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataExtractsProviderAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataExtractsProviderAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataExtractsProviderAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataExtractsProviderAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataExtractsProviderAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<DataExtractsProviderAccount>() {
           @Override
           public void write(JsonWriter out, DataExtractsProviderAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataExtractsProviderAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataExtractsProviderAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataExtractsProviderAccount
   * @throws IOException if the JSON string is invalid with respect to DataExtractsProviderAccount
   */
  public static DataExtractsProviderAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataExtractsProviderAccount.class);
  }

  /**
   * Convert an instance of DataExtractsProviderAccount to an JSON string
   *
   * @return JSON string
   */
