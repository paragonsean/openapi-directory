...
OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response() {
    this->initializeModel();
}

OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::~OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response() {}

void OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::initializeModel() {

    m_dose_isSet = false;
    m_dose_isValid = false;
}

void OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::fromJson(QString jsonString) {
...
void OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::fromJsonObject(QJsonObject json) {

    m_dose_isValid = ::OpenAPI::fromJsonValue(m_dose, json[QString("dose")]);
    m_dose_isSet = !json[QString("dose")].isNull() && m_dose_isValid;
}

QString OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::asJson() const {
...
QJsonObject OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_dose.isSet()) {
        obj.insert(QString("dose"), ::OpenAPI::toJsonValue(m_dose));
    }
    return obj;
}

OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response_dose OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::getDose() const {
    return m_dose;
}
void OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::setDose(const OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response_dose &dose) {
    m_dose = dose;
    m_dose_isSet = true;
}

bool OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::is_dose_Set() const{
    return m_dose_isSet;
}

bool OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::is_dose_Valid() const{
    return m_dose_isValid;
}

bool OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::isSet() const {
...
bool OAIApp_api_icaro_endpoints_ICARO_ambient_dose_200_response::isValid() const {
