...
/*
 * OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response.h
 *
 * 
 */

#ifndef OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response_H
#define OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response_H
...
namespace OpenAPI {
class OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response_dose_rate;

class OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response : public OAIObject {
public:
    OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response();
    OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response(QString json);
    ~OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response() override;
    ...
    OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response_dose_rate getDoseRate() const;
    void setDoseRate(const OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response_dose_rate &dose_rate);
    bool is_dose_rate_Set() const;
    bool is_dose_rate_Valid() const;
...
private:
    ...
    OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response_dose_rate m_dose_rate;
    bool m_dose_rate_isSet;
    bool m_dose_rate_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response)

#endif // OAIApp_api_parma_endpoints_PARMA_effective_dose_200_response_H
