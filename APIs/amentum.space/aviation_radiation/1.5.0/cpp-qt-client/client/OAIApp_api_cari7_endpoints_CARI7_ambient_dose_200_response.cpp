...
OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response() {
    this->initializeModel();
}

OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::~OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response() {}

void OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::initializeModel() {

    m_dose_rate_isSet = false;
    m_dose_rate_isValid = false;
}

void OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::fromJson(QString jsonString) {
...
void OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::asJson() const {
...
QJsonObject OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response_dose_rate OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::getDoseRate() const {
    return m_dose_rate;
}
void OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::setDoseRate(const OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response_dose_rate &dose_rate) {
    m_dose_rate = dose_rate;
    m_dose_rate_isSet = true;
}

bool OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::is_dose_rate_Set() const{
    return m_dose_rate_isSet;
}

bool OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::is_dose_rate_Valid() const{
    return m_dose_rate_isValid;
}

bool OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::isSet() const {
...
bool OAIApp_api_cari7_endpoints_CARI7_ambient_dose_200_response::isValid() const {
