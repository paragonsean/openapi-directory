...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiCari7EndpointsCARI7AmbientDose200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiCari7EndpointsCARI7EffectiveDose200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiIcaroEndpointsICAROAmbientDose200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiIcaroEndpointsICAROAmbientDose200ResponseDose.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiIcaroEndpointsICAROEffectiveDose200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiParmaEndpointsPARMAAmbientDose200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiParmaEndpointsPARMADifferentialIntensity200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiParmaEndpointsPARMADifferentialIntensity200ResponseEnergies.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiParmaEndpointsPARMAEffectiveDose200Response.CustomTypeAdapterFactory());
