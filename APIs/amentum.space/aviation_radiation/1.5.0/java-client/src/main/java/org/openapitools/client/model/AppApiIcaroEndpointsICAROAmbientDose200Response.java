...
public class AppApiIcaroEndpointsICAROAmbientDose200Response {
  ...
  public AppApiIcaroEndpointsICAROAmbientDose200Response dose(AppApiIcaroEndpointsICAROAmbientDose200ResponseDose dose) {
    this.dose = dose;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AppApiIcaroEndpointsICAROAmbientDose200Response appApiIcaroEndpointsICAROAmbientDose200Response = (AppApiIcaroEndpointsICAROAmbientDose200Response) o;
    return Objects.equals(this.dose, appApiIcaroEndpointsICAROAmbientDose200Response.dose);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppApiIcaroEndpointsICAROAmbientDose200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppApiIcaroEndpointsICAROAmbientDose200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppApiIcaroEndpointsICAROAmbientDose200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppApiIcaroEndpointsICAROAmbientDose200Response is not found in the empty JSON string", AppApiIcaroEndpointsICAROAmbientDose200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppApiIcaroEndpointsICAROAmbientDose200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppApiIcaroEndpointsICAROAmbientDose200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppApiIcaroEndpointsICAROAmbientDose200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppApiIcaroEndpointsICAROAmbientDose200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppApiIcaroEndpointsICAROAmbientDose200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppApiIcaroEndpointsICAROAmbientDose200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AppApiIcaroEndpointsICAROAmbientDose200Response>() {
           @Override
           public void write(JsonWriter out, AppApiIcaroEndpointsICAROAmbientDose200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppApiIcaroEndpointsICAROAmbientDose200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppApiIcaroEndpointsICAROAmbientDose200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppApiIcaroEndpointsICAROAmbientDose200Response
   * @throws IOException if the JSON string is invalid with respect to AppApiIcaroEndpointsICAROAmbientDose200Response
   */
  public static AppApiIcaroEndpointsICAROAmbientDose200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppApiIcaroEndpointsICAROAmbientDose200Response.class);
  }

  /**
   * Convert an instance of AppApiIcaroEndpointsICAROAmbientDose200Response to an JSON string
   *
   * @return JSON string
   */
