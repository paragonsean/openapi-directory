...
/**
 * API tests for Cari7Api
 */
@Disabled
public class Cari7ApiTest {

    private final Cari7Api api = new Cari7Api();
     ...
     */
    @Test
    public void appApiCari7EndpointsCARI7AmbientDoseTest() throws ApiException {
        ...
        AppApiCari7EndpointsCARI7AmbientDose200Response response = api.appApiCari7EndpointsCARI7AmbientDose(altitude, latitude, longitude, year, month, day, utc, particle);
     ...
     */
    @Test
    public void appApiCari7EndpointsCARI7EffectiveDoseTest() throws ApiException {
        BigDecimal altitude = null;
        BigDecimal latitude = null;
        BigDecimal longitude = null;
        Integer year = null;
        ...
        Integer utc = null;
        String particle = null;
        AppApiCari7EndpointsCARI7EffectiveDose200Response response = api.appApiCari7EndpointsCARI7EffectiveDose(altitude, latitude, longitude, year, month, day, utc, particle);
        // TODO: test validations
    }
