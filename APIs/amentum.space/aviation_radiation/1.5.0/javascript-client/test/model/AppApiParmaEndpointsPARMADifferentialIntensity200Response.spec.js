...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200Response();
  });
  ...
  describe('AppApiParmaEndpointsPARMADifferentialIntensity200Response', function() {
    it('should create an instance of AppApiParmaEndpointsPARMADifferentialIntensity200Response', function() {
      // uncomment below and update the code to test AppApiParmaEndpointsPARMADifferentialIntensity200Response
      //var instance = new AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200Response();
      //expect(instance).to.be.a(AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200Response);
    });

    it('should have the property energies (base name: "energies")', function() {
      // uncomment below and update the code to test the property energies
      //var instance = new AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200Response();
      //expect(instance).to.be();
    });

    it('should have the property intensities (base name: "intensities")', function() {
      // uncomment below and update the code to test the property intensities
      //var instance = new AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200Response();
      //expect(instance).to.be();
    });
