...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200ResponseEnergies();
  });
  ...
  describe('AppApiParmaEndpointsPARMADifferentialIntensity200ResponseEnergies', function() {
    it('should create an instance of AppApiParmaEndpointsPARMADifferentialIntensity200ResponseEnergies', function() {
      // uncomment below and update the code to test AppApiParmaEndpointsPARMADifferentialIntensity200ResponseEnergies
      //var instance = new AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200ResponseEnergies();
      //expect(instance).to.be.a(AviationRadiationApi.AppApiParmaEndpointsPARMADifferentialIntensity200ResponseEnergies);
    });
