...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.AppApiIcaroEndpointsICAROAmbientDose200ResponseDose();
  });
  ...
  describe('AppApiIcaroEndpointsICAROAmbientDose200ResponseDose', function() {
    it('should create an instance of AppApiIcaroEndpointsICAROAmbientDose200ResponseDose', function() {
      // uncomment below and update the code to test AppApiIcaroEndpointsICAROAmbientDose200ResponseDose
      //var instance = new AviationRadiationApi.AppApiIcaroEndpointsICAROAmbientDose200ResponseDose();
      //expect(instance).to.be.a(AviationRadiationApi.AppApiIcaroEndpointsICAROAmbientDose200ResponseDose);
    });
