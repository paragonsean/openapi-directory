...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.AppApiIcaroEndpointsICAROEffectiveDose200Response();
  });
  ...
  describe('AppApiIcaroEndpointsICAROEffectiveDose200Response', function() {
    it('should create an instance of AppApiIcaroEndpointsICAROEffectiveDose200Response', function() {
      // uncomment below and update the code to test AppApiIcaroEndpointsICAROEffectiveDose200Response
      //var instance = new AviationRadiationApi.AppApiIcaroEndpointsICAROEffectiveDose200Response();
      //expect(instance).to.be.a(AviationRadiationApi.AppApiIcaroEndpointsICAROEffectiveDose200Response);
    });
