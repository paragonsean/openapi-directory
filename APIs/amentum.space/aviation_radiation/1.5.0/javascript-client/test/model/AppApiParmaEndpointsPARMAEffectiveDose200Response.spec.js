...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.AppApiParmaEndpointsPARMAEffectiveDose200Response();
  });
  ...
  describe('AppApiParmaEndpointsPARMAEffectiveDose200Response', function() {
    it('should create an instance of AppApiParmaEndpointsPARMAEffectiveDose200Response', function() {
      // uncomment below and update the code to test AppApiParmaEndpointsPARMAEffectiveDose200Response
      //var instance = new AviationRadiationApi.AppApiParmaEndpointsPARMAEffectiveDose200Response();
      //expect(instance).to.be.a(AviationRadiationApi.AppApiParmaEndpointsPARMAEffectiveDose200Response);
    });
