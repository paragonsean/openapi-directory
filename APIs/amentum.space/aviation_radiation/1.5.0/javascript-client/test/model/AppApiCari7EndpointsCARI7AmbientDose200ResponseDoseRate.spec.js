...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate();
  });
  ...
  describe('AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate', function() {
    it('should create an instance of AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate', function() {
      // uncomment below and update the code to test AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate
      //var instance = new AviationRadiationApi.AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate();
      //expect(instance).to.be.a(AviationRadiationApi.AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate);
    });
