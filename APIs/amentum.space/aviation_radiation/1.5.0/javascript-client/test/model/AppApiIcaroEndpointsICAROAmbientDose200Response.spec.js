...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.AppApiIcaroEndpointsICAROAmbientDose200Response();
  });
  ...
  describe('AppApiIcaroEndpointsICAROAmbientDose200Response', function() {
    it('should create an instance of AppApiIcaroEndpointsICAROAmbientDose200Response', function() {
      // uncomment below and update the code to test AppApiIcaroEndpointsICAROAmbientDose200Response
      //var instance = new AviationRadiationApi.AppApiIcaroEndpointsICAROAmbientDose200Response();
      //expect(instance).to.be.a(AviationRadiationApi.AppApiIcaroEndpointsICAROAmbientDose200Response);
    });

    it('should have the property dose (base name: "dose")', function() {
      // uncomment below and update the code to test the property dose
      //var instance = new AviationRadiationApi.AppApiIcaroEndpointsICAROAmbientDose200Response();
