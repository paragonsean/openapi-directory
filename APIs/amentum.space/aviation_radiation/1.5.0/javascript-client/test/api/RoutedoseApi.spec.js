...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.RoutedoseApi();
  });
  ...
  describe('RoutedoseApi', function() {
    describe('appApiIcaroEndpointsICAROAmbientDose', function() {
      it('should call appApiIcaroEndpointsICAROAmbientDose successfully', function(done) {
        //uncomment below and update the code to test appApiIcaroEndpointsICAROAmbientDose
        //instance.appApiIcaroEndpointsICAROAmbientDose(function(error) {
    ...
    describe('appApiIcaroEndpointsICAROEffectiveDose', function() {
      it('should call appApiIcaroEndpointsICAROEffectiveDose successfully', function(done) {
        //uncomment below and update the code to test appApiIcaroEndpointsICAROEffectiveDose
        //instance.appApiIcaroEndpointsICAROEffectiveDose(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
