...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.ParmaApi();
  });
  ...
  describe('ParmaApi', function() {
    describe('appApiParmaEndpointsPARMAAmbientDose', function() {
      it('should call appApiParmaEndpointsPARMAAmbientDose successfully', function(done) {
        //uncomment below and update the code to test appApiParmaEndpointsPARMAAmbientDose
        //instance.appApiParmaEndpointsPARMAAmbientDose(function(error) {
    ...
    describe('appApiParmaEndpointsPARMADifferentialIntensity', function() {
      it('should call appApiParmaEndpointsPARMADifferentialIntensity successfully', function(done) {
        //uncomment below and update the code to test appApiParmaEndpointsPARMADifferentialIntensity
        //instance.appApiParmaEndpointsPARMADifferentialIntensity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('appApiParmaEndpointsPARMAEffectiveDose', function() {
      it('should call appApiParmaEndpointsPARMAEffectiveDose successfully', function(done) {
        //uncomment below and update the code to test appApiParmaEndpointsPARMAEffectiveDose
        //instance.appApiParmaEndpointsPARMAEffectiveDose(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
