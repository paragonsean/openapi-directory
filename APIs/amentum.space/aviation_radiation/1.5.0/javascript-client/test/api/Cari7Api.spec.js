...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AviationRadiationApi.Cari7Api();
  });
  ...
  describe('Cari7Api', function() {
    describe('appApiCari7EndpointsCARI7AmbientDose', function() {
      it('should call appApiCari7EndpointsCARI7AmbientDose successfully', function(done) {
        //uncomment below and update the code to test appApiCari7EndpointsCARI7AmbientDose
        //instance.appApiCari7EndpointsCARI7AmbientDose(function(error) {
    ...
    describe('appApiCari7EndpointsCARI7EffectiveDose', function() {
      it('should call appApiCari7EndpointsCARI7EffectiveDose successfully', function(done) {
        //uncomment below and update the code to test appApiCari7EndpointsCARI7EffectiveDose
        //instance.appApiCari7EndpointsCARI7EffectiveDose(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
