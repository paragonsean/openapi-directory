...
/**
 * The AppApiIcaroEndpointsICAROEffectiveDose200Response model module.
 * @module model/AppApiIcaroEndpointsICAROEffectiveDose200Response
 * @version 1.5.0
 */
class AppApiIcaroEndpointsICAROEffectiveDose200Response {
    /**
     * Constructs a new <code>AppApiIcaroEndpointsICAROEffectiveDose200Response</code>.
     * @alias module:model/AppApiIcaroEndpointsICAROEffectiveDose200Response
     */
    constructor() { 
        
        AppApiIcaroEndpointsICAROEffectiveDose200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppApiIcaroEndpointsICAROEffectiveDose200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppApiIcaroEndpointsICAROEffectiveDose200Response} obj Optional instance to populate.
     * @return {module:model/AppApiIcaroEndpointsICAROEffectiveDose200Response} The populated <code>AppApiIcaroEndpointsICAROEffectiveDose200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppApiIcaroEndpointsICAROEffectiveDose200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>AppApiIcaroEndpointsICAROEffectiveDose200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppApiIcaroEndpointsICAROEffectiveDose200Response</code>.
     */
 ...
 */
AppApiIcaroEndpointsICAROEffectiveDose200Response.prototype['dose'] = undefined;
...
export default AppApiIcaroEndpointsICAROEffectiveDose200Response;
