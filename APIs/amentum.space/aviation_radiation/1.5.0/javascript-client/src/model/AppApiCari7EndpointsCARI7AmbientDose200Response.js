...
import AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate from './AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate';

/**
 * The AppApiCari7EndpointsCARI7AmbientDose200Response model module.
 * @module model/AppApiCari7EndpointsCARI7AmbientDose200Response
 * @version 1.5.0
 */
class AppApiCari7EndpointsCARI7AmbientDose200Response {
    /**
     * Constructs a new <code>AppApiCari7EndpointsCARI7AmbientDose200Response</code>.
     * @alias module:model/AppApiCari7EndpointsCARI7AmbientDose200Response
     */
    constructor() { 
        
        AppApiCari7EndpointsCARI7AmbientDose200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppApiCari7EndpointsCARI7AmbientDose200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppApiCari7EndpointsCARI7AmbientDose200Response} obj Optional instance to populate.
     * @return {module:model/AppApiCari7EndpointsCARI7AmbientDose200Response} The populated <code>AppApiCari7EndpointsCARI7AmbientDose200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppApiCari7EndpointsCARI7AmbientDose200Response();

            if (data.hasOwnProperty('dose rate')) {
                obj['dose rate'] = AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate.constructFromObject(data['dose rate']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AppApiCari7EndpointsCARI7AmbientDose200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppApiCari7EndpointsCARI7AmbientDose200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `dose rate`
        if (data['dose rate']) { // data not null
          AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate.validateJSON(data['dose rate']);
        }
...
/**
 * @member {module:model/AppApiCari7EndpointsCARI7AmbientDose200ResponseDoseRate} dose rate
 */
AppApiCari7EndpointsCARI7AmbientDose200Response.prototype['dose rate'] = undefined;
...
export default AppApiCari7EndpointsCARI7AmbientDose200Response;
