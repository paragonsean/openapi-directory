...
/**
 * The AppApiParmaEndpointsPARMAAmbientDose200Response model module.
 * @module model/AppApiParmaEndpointsPARMAAmbientDose200Response
 * @version 1.5.0
 */
class AppApiParmaEndpointsPARMAAmbientDose200Response {
    /**
     * Constructs a new <code>AppApiParmaEndpointsPARMAAmbientDose200Response</code>.
     * @alias module:model/AppApiParmaEndpointsPARMAAmbientDose200Response
     */
    constructor() { 
        
        AppApiParmaEndpointsPARMAAmbientDose200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppApiParmaEndpointsPARMAAmbientDose200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppApiParmaEndpointsPARMAAmbientDose200Response} obj Optional instance to populate.
     * @return {module:model/AppApiParmaEndpointsPARMAAmbientDose200Response} The populated <code>AppApiParmaEndpointsPARMAAmbientDose200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppApiParmaEndpointsPARMAAmbientDose200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>AppApiParmaEndpointsPARMAAmbientDose200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppApiParmaEndpointsPARMAAmbientDose200Response</code>.
     */
 ...
 */
AppApiParmaEndpointsPARMAAmbientDose200Response.prototype['dose rate'] = undefined;
...
export default AppApiParmaEndpointsPARMAAmbientDose200Response;
