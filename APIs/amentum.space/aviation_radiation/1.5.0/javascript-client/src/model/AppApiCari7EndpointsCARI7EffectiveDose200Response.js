...
/**
 * The AppApiCari7EndpointsCARI7EffectiveDose200Response model module.
 * @module model/AppApiCari7EndpointsCARI7EffectiveDose200Response
 * @version 1.5.0
 */
class AppApiCari7EndpointsCARI7EffectiveDose200Response {
    /**
     * Constructs a new <code>AppApiCari7EndpointsCARI7EffectiveDose200Response</code>.
     * @alias module:model/AppApiCari7EndpointsCARI7EffectiveDose200Response
     */
    constructor() { 
        
        AppApiCari7EndpointsCARI7EffectiveDose200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppApiCari7EndpointsCARI7EffectiveDose200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppApiCari7EndpointsCARI7EffectiveDose200Response} obj Optional instance to populate.
     * @return {module:model/AppApiCari7EndpointsCARI7EffectiveDose200Response} The populated <code>AppApiCari7EndpointsCARI7EffectiveDose200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppApiCari7EndpointsCARI7EffectiveDose200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>AppApiCari7EndpointsCARI7EffectiveDose200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppApiCari7EndpointsCARI7EffectiveDose200Response</code>.
     */
 ...
 */
AppApiCari7EndpointsCARI7EffectiveDose200Response.prototype['dose rate'] = undefined;
...
export default AppApiCari7EndpointsCARI7EffectiveDose200Response;
