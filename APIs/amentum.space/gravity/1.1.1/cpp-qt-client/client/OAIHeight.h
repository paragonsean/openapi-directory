...
namespace OpenAPI {
class OAIHeight_height;

class OAIHeight : public OAIObject {
public:
    OAIHeight();
    OAIHeight(QString json);
    ~OAIHeight() override;
    ...
    OAIHeight_height getHeight() const;
    void setHeight(const OAIHeight_height &height);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeight)
