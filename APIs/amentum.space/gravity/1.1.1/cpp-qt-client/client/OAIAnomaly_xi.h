...
#ifndef OAIAnomaly_xi_H
#define OAIAnomaly_xi_H
...
class OAIAnomaly_xi : public OAIObject {
public:
    OAIAnomaly_xi();
    OAIAnomaly_xi(QString json);
    ~OAIAnomaly_xi() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnomaly_xi)

#endif // OAIAnomaly_xi_H
