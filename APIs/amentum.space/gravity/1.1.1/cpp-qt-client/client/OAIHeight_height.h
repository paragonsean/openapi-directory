...
#ifndef OAIHeight_height_H
#define OAIHeight_height_H
...
class OAIHeight_height : public OAIObject {
public:
    OAIHeight_height();
    OAIHeight_height(QString json);
    ~OAIHeight_height() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeight_height)

#endif // OAIHeight_height_H
