...
OAIAnomaly_eta::OAIAnomaly_eta(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnomaly_eta::OAIAnomaly_eta() {
    this->initializeModel();
}

OAIAnomaly_eta::~OAIAnomaly_eta() {}

void OAIAnomaly_eta::initializeModel() {
...
void OAIAnomaly_eta::fromJson(QString jsonString) {
...
void OAIAnomaly_eta::fromJsonObject(QJsonObject json) {
...
QString OAIAnomaly_eta::asJson() const {
...
QJsonObject OAIAnomaly_eta::asJsonObject() const {
    QJsonObject obj;
    if (m_units_isSet) {
...
QString OAIAnomaly_eta::getUnits() const {
    return m_units;
}
void OAIAnomaly_eta::setUnits(const QString &units) {
    m_units = units;
    m_units_isSet = true;
}

bool OAIAnomaly_eta::is_units_Set() const{
    return m_units_isSet;
}

bool OAIAnomaly_eta::is_units_Valid() const{
    return m_units_isValid;
}

double OAIAnomaly_eta::getValue() const {
    return m_value;
}
void OAIAnomaly_eta::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIAnomaly_eta::is_value_Set() const{
    return m_value_isSet;
}

bool OAIAnomaly_eta::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIAnomaly_eta::isSet() const {
...
bool OAIAnomaly_eta::isValid() const {
