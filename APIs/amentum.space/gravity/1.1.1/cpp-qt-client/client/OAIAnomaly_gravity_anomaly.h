...
/*
 * OAIAnomaly_gravity_anomaly.h
 *
 * Gravity anomaly (mGal) 
 */

#ifndef OAIAnomaly_gravity_anomaly_H
#define OAIAnomaly_gravity_anomaly_H
...
class OAIAnomaly_gravity_anomaly : public OAIObject {
public:
    OAIAnomaly_gravity_anomaly();
    OAIAnomaly_gravity_anomaly(QString json);
    ~OAIAnomaly_gravity_anomaly() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnomaly_gravity_anomaly)

#endif // OAIAnomaly_gravity_anomaly_H
