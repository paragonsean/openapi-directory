...
OAIAnomaly_gravity_anomaly::OAIAnomaly_gravity_anomaly(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnomaly_gravity_anomaly::OAIAnomaly_gravity_anomaly() {
    this->initializeModel();
}

OAIAnomaly_gravity_anomaly::~OAIAnomaly_gravity_anomaly() {}

void OAIAnomaly_gravity_anomaly::initializeModel() {
...
void OAIAnomaly_gravity_anomaly::fromJson(QString jsonString) {
...
void OAIAnomaly_gravity_anomaly::fromJsonObject(QJsonObject json) {
...
QString OAIAnomaly_gravity_anomaly::asJson() const {
...
QJsonObject OAIAnomaly_gravity_anomaly::asJsonObject() const {
    QJsonObject obj;
    if (m_units_isSet) {
...
QString OAIAnomaly_gravity_anomaly::getUnits() const {
    return m_units;
}
void OAIAnomaly_gravity_anomaly::setUnits(const QString &units) {
    m_units = units;
    m_units_isSet = true;
}

bool OAIAnomaly_gravity_anomaly::is_units_Set() const{
    return m_units_isSet;
}

bool OAIAnomaly_gravity_anomaly::is_units_Valid() const{
    return m_units_isValid;
}

double OAIAnomaly_gravity_anomaly::getValue() const {
    return m_value;
}
void OAIAnomaly_gravity_anomaly::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIAnomaly_gravity_anomaly::is_value_Set() const{
    return m_value_isSet;
}

bool OAIAnomaly_gravity_anomaly::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIAnomaly_gravity_anomaly::isSet() const {
...
bool OAIAnomaly_gravity_anomaly::isValid() const {
