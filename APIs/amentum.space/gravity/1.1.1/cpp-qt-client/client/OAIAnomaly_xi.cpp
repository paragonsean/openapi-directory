...
OAIAnomaly_xi::OAIAnomaly_xi(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnomaly_xi::OAIAnomaly_xi() {
    this->initializeModel();
}

OAIAnomaly_xi::~OAIAnomaly_xi() {}

void OAIAnomaly_xi::initializeModel() {
...
void OAIAnomaly_xi::fromJson(QString jsonString) {
...
void OAIAnomaly_xi::fromJsonObject(QJsonObject json) {
...
QString OAIAnomaly_xi::asJson() const {
...
QJsonObject OAIAnomaly_xi::asJsonObject() const {
    QJsonObject obj;
    if (m_units_isSet) {
...
QString OAIAnomaly_xi::getUnits() const {
    return m_units;
}
void OAIAnomaly_xi::setUnits(const QString &units) {
    m_units = units;
    m_units_isSet = true;
}

bool OAIAnomaly_xi::is_units_Set() const{
    return m_units_isSet;
}

bool OAIAnomaly_xi::is_units_Valid() const{
    return m_units_isValid;
}

double OAIAnomaly_xi::getValue() const {
    return m_value;
}
void OAIAnomaly_xi::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIAnomaly_xi::is_value_Set() const{
    return m_value_isSet;
}

bool OAIAnomaly_xi::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIAnomaly_xi::isSet() const {
...
bool OAIAnomaly_xi::isValid() const {
