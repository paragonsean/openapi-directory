...
public class AnomalyEta {
  ...
  public AnomalyEta units(String units) {
    this.units = units;
    return this;
  }
  ...
  public AnomalyEta value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AnomalyEta anomalyEta = (AnomalyEta) o;
    return Objects.equals(this.units, anomalyEta.units) &&
        Objects.equals(this.value, anomalyEta.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnomalyEta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnomalyEta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnomalyEta is not found in the empty JSON string", AnomalyEta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnomalyEta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnomalyEta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnomalyEta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnomalyEta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnomalyEta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnomalyEta.class));

       return (TypeAdapter<T>) new TypeAdapter<AnomalyEta>() {
           @Override
           public void write(JsonWriter out, AnomalyEta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnomalyEta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnomalyEta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnomalyEta
   * @throws IOException if the JSON string is invalid with respect to AnomalyEta
   */
  public static AnomalyEta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnomalyEta.class);
  }

  /**
   * Convert an instance of AnomalyEta to an JSON string
   *
   * @return JSON string
   */
