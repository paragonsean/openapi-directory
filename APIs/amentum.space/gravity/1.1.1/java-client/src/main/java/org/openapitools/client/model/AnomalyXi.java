...
public class AnomalyXi {
  ...
  public AnomalyXi units(String units) {
    this.units = units;
    return this;
  }
  ...
  public AnomalyXi value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AnomalyXi anomalyXi = (AnomalyXi) o;
    return Objects.equals(this.units, anomalyXi.units) &&
        Objects.equals(this.value, anomalyXi.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnomalyXi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnomalyXi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnomalyXi is not found in the empty JSON string", AnomalyXi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnomalyXi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnomalyXi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnomalyXi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnomalyXi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnomalyXi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnomalyXi.class));

       return (TypeAdapter<T>) new TypeAdapter<AnomalyXi>() {
           @Override
           public void write(JsonWriter out, AnomalyXi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnomalyXi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnomalyXi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnomalyXi
   * @throws IOException if the JSON string is invalid with respect to AnomalyXi
   */
  public static AnomalyXi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnomalyXi.class);
  }

  /**
   * Convert an instance of AnomalyXi to an JSON string
   *
   * @return JSON string
   */
