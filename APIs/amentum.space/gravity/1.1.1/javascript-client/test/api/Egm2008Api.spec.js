...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GravityApi.Egm2008Api();
  });
  ...
  describe('Egm2008Api', function() {
    describe('appApiEgm2008EndpointsEGM2008CalculateAnomaly', function() {
      it('should call appApiEgm2008EndpointsEGM2008CalculateAnomaly successfully', function(done) {
        //uncomment below and update the code to test appApiEgm2008EndpointsEGM2008CalculateAnomaly
        //instance.appApiEgm2008EndpointsEGM2008CalculateAnomaly(function(error) {
    ...
    describe('appApiEgm2008EndpointsEGM2008CalculateHeight', function() {
      it('should call appApiEgm2008EndpointsEGM2008CalculateHeight successfully', function(done) {
        //uncomment below and update the code to test appApiEgm2008EndpointsEGM2008CalculateHeight
        //instance.appApiEgm2008EndpointsEGM2008CalculateHeight(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
