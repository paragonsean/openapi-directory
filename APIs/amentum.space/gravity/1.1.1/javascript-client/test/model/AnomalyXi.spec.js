...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GravityApi.AnomalyXi();
  });
  ...
  describe('AnomalyXi', function() {
    it('should create an instance of AnomalyXi', function() {
      // uncomment below and update the code to test AnomalyXi
      //var instance = new GravityApi.AnomalyXi();
      //expect(instance).to.be.a(GravityApi.AnomalyXi);
    });
