...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GravityApi.Height();
  });
  ...
  describe('Height', function() {
    it('should create an instance of Height', function() {
      // uncomment below and update the code to test Height
      //var instance = new GravityApi.Height();
      //expect(instance).to.be.a(GravityApi.Height);
    });
