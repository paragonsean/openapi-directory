...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GravityApi.HeightHeight();
  });
  ...
  describe('HeightHeight', function() {
    it('should create an instance of HeightHeight', function() {
      // uncomment below and update the code to test HeightHeight
      //var instance = new GravityApi.HeightHeight();
      //expect(instance).to.be.a(GravityApi.HeightHeight);
    });
