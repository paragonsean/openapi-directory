...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GravityApi.AnomalyEta();
  });
  ...
  describe('AnomalyEta', function() {
    it('should create an instance of AnomalyEta', function() {
      // uncomment below and update the code to test AnomalyEta
      //var instance = new GravityApi.AnomalyEta();
      //expect(instance).to.be.a(GravityApi.AnomalyEta);
    });
