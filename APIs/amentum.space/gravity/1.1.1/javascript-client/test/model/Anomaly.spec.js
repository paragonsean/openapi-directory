...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GravityApi.Anomaly();
  });
  ...
  describe('Anomaly', function() {
    it('should create an instance of Anomaly', function() {
      ...
      //var instance = new GravityApi.Anomaly();
      //expect(instance).to.be.a(GravityApi.Anomaly);
    });
    ...
    it('should have the property gravityAnomaly (base name: "gravity_anomaly")', function() {
      // uncomment below and update the code to test the property gravityAnomaly
      //var instance = new GravityApi.Anomaly();
      //expect(instance).to.be();
    });

    it('should have the property xi (base name: "xi")', function() {
      // uncomment below and update the code to test the property xi
      //var instance = new GravityApi.Anomaly();
      //expect(instance).to.be();
    });
