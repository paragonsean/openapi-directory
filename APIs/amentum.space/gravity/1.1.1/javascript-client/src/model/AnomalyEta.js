...
/**
 * The AnomalyEta model module.
 * @module model/AnomalyEta
 * @version 1.1.1
 */
class AnomalyEta {
    /**
     * Constructs a new <code>AnomalyEta</code>.
     * Eta (arcsec) - easterly component of deflection of vertical.
     * @alias module:model/AnomalyEta
     */
    constructor() { 
        
        AnomalyEta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AnomalyEta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnomalyEta} obj Optional instance to populate.
     * @return {module:model/AnomalyEta} The populated <code>AnomalyEta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnomalyEta();
    ...
    /**
     * Validates the JSON data with respect to <code>AnomalyEta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnomalyEta</code>.
     */
 ...
 * @member {String} units
 */
AnomalyEta.prototype['units'] = undefined;

/**
 * @member {Number} value
 */
AnomalyEta.prototype['value'] = undefined;
