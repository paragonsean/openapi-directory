...
/**
 * The HeightHeight model module.
 * @module model/HeightHeight
 * @version 1.1.1
 */
class HeightHeight {
    /**
     * Constructs a new <code>HeightHeight</code>.
     * Geoid height (m) 
     * @alias module:model/HeightHeight
     */
    constructor() { 
        
        HeightHeight.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HeightHeight</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HeightHeight} obj Optional instance to populate.
     * @return {module:model/HeightHeight} The populated <code>HeightHeight</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HeightHeight();
    ...
    /**
     * Validates the JSON data with respect to <code>HeightHeight</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HeightHeight</code>.
     */
 ...
 * @member {String} units
 */
HeightHeight.prototype['units'] = undefined;

/**
 * @member {Number} value
 */
HeightHeight.prototype['value'] = undefined;
