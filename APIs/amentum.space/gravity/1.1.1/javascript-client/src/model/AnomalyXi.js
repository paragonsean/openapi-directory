...
/**
 * The AnomalyXi model module.
 * @module model/AnomalyXi
 * @version 1.1.1
 */
class AnomalyXi {
    /**
     * Constructs a new <code>AnomalyXi</code>.
     * Xi (arcsec) - northerly component of deflection of vertical. 
     * @alias module:model/AnomalyXi
     */
    constructor() { 
        
        AnomalyXi.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AnomalyXi</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnomalyXi} obj Optional instance to populate.
     * @return {module:model/AnomalyXi} The populated <code>AnomalyXi</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnomalyXi();
    ...
    /**
     * Validates the JSON data with respect to <code>AnomalyXi</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnomalyXi</code>.
     */
 ...
 * @member {String} units
 */
AnomalyXi.prototype['units'] = undefined;

/**
 * @member {Number} value
 */
AnomalyXi.prototype['value'] = undefined;
