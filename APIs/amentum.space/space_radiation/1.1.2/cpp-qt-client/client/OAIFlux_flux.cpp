...
OAIFlux_flux::OAIFlux_flux(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFlux_flux::OAIFlux_flux() {
    this->initializeModel();
}

OAIFlux_flux::~OAIFlux_flux() {}

void OAIFlux_flux::initializeModel() {
...
void OAIFlux_flux::fromJson(QString jsonString) {
...
void OAIFlux_flux::fromJsonObject(QJsonObject json) {
...
QString OAIFlux_flux::asJson() const {
...
QJsonObject OAIFlux_flux::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<double> OAIFlux_flux::getData() const {
    return m_data;
}
void OAIFlux_flux::setData(const QList<double> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIFlux_flux::is_data_Set() const{
    return m_data_isSet;
}

bool OAIFlux_flux::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIFlux_flux::getUnits() const {
    return m_units;
}
void OAIFlux_flux::setUnits(const QString &units) {
    m_units = units;
    m_units_isSet = true;
}

bool OAIFlux_flux::is_units_Set() const{
    return m_units_isSet;
}

bool OAIFlux_flux::is_units_Valid() const{
    return m_units_isValid;
}

bool OAIFlux_flux::isSet() const {
...
bool OAIFlux_flux::isValid() const {
