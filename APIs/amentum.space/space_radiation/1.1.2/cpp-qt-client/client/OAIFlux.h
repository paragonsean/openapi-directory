...
#include "OAIFlux_flux.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIFlux_energies;
class OAIFlux_flux;

class OAIFlux : public OAIObject {
public:
    OAIFlux();
    OAIFlux(QString json);
    ~OAIFlux() override;
    ...
    OAIFlux_energies getEnergies() const;
    void setEnergies(const OAIFlux_energies &energies);
    bool is_energies_Set() const;
    bool is_energies_Valid() const;

    OAIFlux_flux getFlux() const;
    void setFlux(const OAIFlux_flux &flux);
...
private:
    ...
    OAIFlux_energies m_energies;
    bool m_energies_isSet;
    bool m_energies_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlux)
