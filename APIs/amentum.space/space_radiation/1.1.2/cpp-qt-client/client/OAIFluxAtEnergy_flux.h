...
/*
 * OAIFluxAtEnergy_flux.h
 *
 * Particle flux value and units. 
 */

#ifndef OAIFluxAtEnergy_flux_H
#define OAIFluxAtEnergy_flux_H
...
class OAIFluxAtEnergy_flux : public OAIObject {
public:
    OAIFluxAtEnergy_flux();
    OAIFluxAtEnergy_flux(QString json);
    ~OAIFluxAtEnergy_flux() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFluxAtEnergy_flux)

#endif // OAIFluxAtEnergy_flux_H
