...
#ifndef OAIFlux_flux_H
#define OAIFlux_flux_H
...
class OAIFlux_flux : public OAIObject {
public:
    OAIFlux_flux();
    OAIFlux_flux(QString json);
    ~OAIFlux_flux() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlux_flux)

#endif // OAIFlux_flux_H
