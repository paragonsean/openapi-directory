...
/**
 * API tests for GcrApi
 */
@Disabled
public class GcrApiTest {

    private final GcrApi api = new GcrApi();
     ...
     */
    @Test
    public void appApiEndpointsGCRCalculateDlrFluxTest() throws ApiException {
        Integer year = null;
        Integer month = null;
        Integer day = null;
        BigDecimal z = null;
        BigDecimal energy = null;
        FluxAtEnergy response = api.appApiEndpointsGCRCalculateDlrFlux(year, month, day, z, energy);
