...
public class FluxAtEnergyFlux {
  ...
  public FluxAtEnergyFlux() {
  }

  public FluxAtEnergyFlux units(String units) {
    this.units = units;
    return this;
  }
  ...
  public FluxAtEnergyFlux value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FluxAtEnergyFlux fluxAtEnergyFlux = (FluxAtEnergyFlux) o;
    return Objects.equals(this.units, fluxAtEnergyFlux.units) &&
        Objects.equals(this.value, fluxAtEnergyFlux.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class FluxAtEnergyFlux {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FluxAtEnergyFlux
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FluxAtEnergyFlux.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FluxAtEnergyFlux is not found in the empty JSON string", FluxAtEnergyFlux.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FluxAtEnergyFlux.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FluxAtEnergyFlux` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FluxAtEnergyFlux.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FluxAtEnergyFlux' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FluxAtEnergyFlux> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FluxAtEnergyFlux.class));

       return (TypeAdapter<T>) new TypeAdapter<FluxAtEnergyFlux>() {
           @Override
           public void write(JsonWriter out, FluxAtEnergyFlux value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FluxAtEnergyFlux read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FluxAtEnergyFlux given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FluxAtEnergyFlux
   * @throws IOException if the JSON string is invalid with respect to FluxAtEnergyFlux
   */
  public static FluxAtEnergyFlux fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FluxAtEnergyFlux.class);
  }

  /**
   * Convert an instance of FluxAtEnergyFlux to an JSON string
   *
   * @return JSON string
   */
