...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceRadiationApi.FluxAtEnergy();
  });
  ...
  describe('FluxAtEnergy', function() {
    it('should create an instance of FluxAtEnergy', function() {
      // uncomment below and update the code to test FluxAtEnergy
      //var instance = new SpaceRadiationApi.FluxAtEnergy();
      //expect(instance).to.be.a(SpaceRadiationApi.FluxAtEnergy);
    });
