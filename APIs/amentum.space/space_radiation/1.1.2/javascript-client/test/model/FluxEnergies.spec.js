...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceRadiationApi.FluxEnergies();
  });
  ...
  describe('FluxEnergies', function() {
    it('should create an instance of FluxEnergies', function() {
      // uncomment below and update the code to test FluxEnergies
      //var instance = new SpaceRadiationApi.FluxEnergies();
      //expect(instance).to.be.a(SpaceRadiationApi.FluxEnergies);
    });
