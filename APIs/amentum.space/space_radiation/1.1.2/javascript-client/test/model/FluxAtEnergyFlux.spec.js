...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceRadiationApi.FluxAtEnergyFlux();
  });
  ...
  describe('FluxAtEnergyFlux', function() {
    it('should create an instance of FluxAtEnergyFlux', function() {
      // uncomment below and update the code to test FluxAtEnergyFlux
      //var instance = new SpaceRadiationApi.FluxAtEnergyFlux();
      //expect(instance).to.be.a(SpaceRadiationApi.FluxAtEnergyFlux);
    });
