...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceRadiationApi.Flux();
  });
  ...
  describe('Flux', function() {
    it('should create an instance of Flux', function() {
      // uncomment below and update the code to test Flux
      //var instance = new SpaceRadiationApi.Flux();
      //expect(instance).to.be.a(SpaceRadiationApi.Flux);
    });
