...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceRadiationApi.FluxFlux();
  });
  ...
  describe('FluxFlux', function() {
    it('should create an instance of FluxFlux', function() {
      // uncomment below and update the code to test FluxFlux
      //var instance = new SpaceRadiationApi.FluxFlux();
      //expect(instance).to.be.a(SpaceRadiationApi.FluxFlux);
    });
