...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceRadiationApi.GcrApi();
  });
  ...
  describe('GcrApi', function() {
    describe('appApiEndpointsGCRCalculateDlrFlux', function() {
      it('should call appApiEndpointsGCRCalculateDlrFlux successfully', function(done) {
        //uncomment below and update the code to test appApiEndpointsGCRCalculateDlrFlux
        //instance.appApiEndpointsGCRCalculateDlrFlux(function(error) {
