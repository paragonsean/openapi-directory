...
import FluxEnergies from './FluxEnergies';
import FluxFlux from './FluxFlux';

/**
 * The Flux model module.
 * @module model/Flux
 * @version 1.1.2
 */
class Flux {
    /**
     * Constructs a new <code>Flux</code>.
     * @alias module:model/Flux
     */
    constructor() { 
        
        Flux.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Flux</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Flux} obj Optional instance to populate.
     * @return {module:model/Flux} The populated <code>Flux</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('energies')) {
                obj['energies'] = FluxEnergies.constructFromObject(data['energies']);
            }
            if (data.hasOwnProperty('flux')) {
                obj['flux'] = FluxFlux.constructFromObject(data['flux']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Flux</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Flux</code>.
     */
    static validateJSON(data) {
        // validate the optional field `energies`
        if (data['energies']) { // data not null
          FluxEnergies.validateJSON(data['energies']);
        }
        // validate the optional field `flux`
        if (data['flux']) { // data not null
          FluxFlux.validateJSON(data['flux']);
        }
...
/**
 * @member {module:model/FluxEnergies} energies
 */
Flux.prototype['energies'] = undefined;

/**
 * @member {module:model/FluxFlux} flux
 */
Flux.prototype['flux'] = undefined;
