...
/**
 * The FluxAtEnergyFlux model module.
 * @module model/FluxAtEnergyFlux
 * @version 1.1.2
 */
class FluxAtEnergyFlux {
    /**
     * Constructs a new <code>FluxAtEnergyFlux</code>.
     * Particle flux value and units. 
     * @alias module:model/FluxAtEnergyFlux
     */
    constructor() { 
        
        FluxAtEnergyFlux.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FluxAtEnergyFlux</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FluxAtEnergyFlux} obj Optional instance to populate.
     * @return {module:model/FluxAtEnergyFlux} The populated <code>FluxAtEnergyFlux</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FluxAtEnergyFlux();
    ...
    /**
     * Validates the JSON data with respect to <code>FluxAtEnergyFlux</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FluxAtEnergyFlux</code>.
     */
 ...
 * @member {String} units
 */
FluxAtEnergyFlux.prototype['units'] = undefined;

/**
 * @member {Number} value
 */
FluxAtEnergyFlux.prototype['value'] = undefined;
...
export default FluxAtEnergyFlux;
