...
/**
 * The FluxFlux model module.
 * @module model/FluxFlux
 * @version 1.1.2
 */
class FluxFlux {
    /**
     * Constructs a new <code>FluxFlux</code>.
     * Corresponding omnidirectional flux values, and their units. 
     * @alias module:model/FluxFlux
     */
    constructor() { 
        
        FluxFlux.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FluxFlux</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FluxFlux} obj Optional instance to populate.
     * @return {module:model/FluxFlux} The populated <code>FluxFlux</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FluxFlux();
    ...
    /**
     * Validates the JSON data with respect to <code>FluxFlux</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FluxFlux</code>.
     */
 ...
 */
FluxFlux.prototype['data'] = undefined;

/**
 * @member {String} units
 */
FluxFlux.prototype['units'] = undefined;
