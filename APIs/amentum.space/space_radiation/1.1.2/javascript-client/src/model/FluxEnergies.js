...
/**
 * The FluxEnergies model module.
 * @module model/FluxEnergies
 * @version 1.1.2
 */
class FluxEnergies {
    /**
     * Constructs a new <code>FluxEnergies</code>.
     * Particle energies at which omnidirectional flux values are calculated, and their units. 
     * @alias module:model/FluxEnergies
     */
    constructor() { 
        
        FluxEnergies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FluxEnergies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FluxEnergies} obj Optional instance to populate.
     * @return {module:model/FluxEnergies} The populated <code>FluxEnergies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FluxEnergies();
    ...
    /**
     * Validates the JSON data with respect to <code>FluxEnergies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FluxEnergies</code>.
     */
 ...
 */
FluxEnergies.prototype['data'] = undefined;

/**
 * @member {String} units
 */
FluxEnergies.prototype['units'] = undefined;
