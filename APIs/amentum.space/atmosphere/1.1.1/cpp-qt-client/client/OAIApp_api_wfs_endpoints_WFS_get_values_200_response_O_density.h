...
/*
 * OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density.h
 *
 * Oxygen atomic density in (/m3). 
 */

#ifndef OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density_H
#define OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density_H
...
class OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density : public OAIObject {
public:
    OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density();
    OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density(QString json);
    ~OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density)

#endif // OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O_density_H
