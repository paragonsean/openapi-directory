...
/*
 * OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral.h
 *
 * Temperature of the atmosphere in (K). 
 */

#ifndef OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral_H
#define OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral_H
...
class OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral : public OAIObject {
public:
    OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral();
    OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral(QString json);
    ~OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral)

#endif // OAIApp_api_wfs_endpoints_WFS_get_values_200_response_temp_neutral_H
