...
/*
 * OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density.h
 *
 * Moleculary oxygen density in (/m3). 
 */

#ifndef OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density_H
#define OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density_H
...
class OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density : public OAIObject {
public:
    OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density();
    OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density(QString json);
    ~OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density)

#endif // OAIApp_api_wfs_endpoints_WFS_get_values_200_response_O2_density_H
