...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseTotalMassDensity();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponseTotalMassDensity', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponseTotalMassDensity', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponseTotalMassDensity
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseTotalMassDensity();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseTotalMassDensity);
    });
