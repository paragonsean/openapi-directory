...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseUpwardWindNeutral();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponseUpwardWindNeutral', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponseUpwardWindNeutral', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponseUpwardWindNeutral
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseUpwardWindNeutral();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseUpwardWindNeutral);
    });
