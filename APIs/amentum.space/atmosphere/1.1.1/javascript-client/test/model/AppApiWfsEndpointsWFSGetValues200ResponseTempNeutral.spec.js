...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseTempNeutral();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponseTempNeutral', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponseTempNeutral', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponseTempNeutral
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseTempNeutral();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseTempNeutral);
    });
