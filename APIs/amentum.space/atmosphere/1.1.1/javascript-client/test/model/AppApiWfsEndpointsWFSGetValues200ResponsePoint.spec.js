...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponsePoint();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponsePoint', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponsePoint', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponsePoint
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponsePoint();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponsePoint);
    });
