...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiEndpointsNRLMSISE00SampleAtmosphere200ResponseAp();
  });
  ...
  describe('AppApiEndpointsNRLMSISE00SampleAtmosphere200ResponseAp', function() {
    it('should create an instance of AppApiEndpointsNRLMSISE00SampleAtmosphere200ResponseAp', function() {
      // uncomment below and update the code to test AppApiEndpointsNRLMSISE00SampleAtmosphere200ResponseAp
      //var instance = new AtmosphereApi.AppApiEndpointsNRLMSISE00SampleAtmosphere200ResponseAp();
      //expect(instance).to.be.a(AtmosphereApi.AppApiEndpointsNRLMSISE00SampleAtmosphere200ResponseAp);
    });
