...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseODensity();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponseODensity', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponseODensity', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponseODensity
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseODensity();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseODensity);
    });
