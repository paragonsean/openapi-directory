...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseN2Density();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponseN2Density', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponseN2Density', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponseN2Density
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseN2Density();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseN2Density);
    });
