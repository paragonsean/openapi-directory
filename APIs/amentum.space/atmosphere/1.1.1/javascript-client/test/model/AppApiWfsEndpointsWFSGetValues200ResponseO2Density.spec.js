...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseO2Density();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponseO2Density', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponseO2Density', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponseO2Density
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseO2Density();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseO2Density);
    });
