...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiEndpointsJB2008SampleAtmosphere200ResponseAtAltTemp();
  });
  ...
  describe('AppApiEndpointsJB2008SampleAtmosphere200ResponseAtAltTemp', function() {
    it('should create an instance of AppApiEndpointsJB2008SampleAtmosphere200ResponseAtAltTemp', function() {
      // uncomment below and update the code to test AppApiEndpointsJB2008SampleAtmosphere200ResponseAtAltTemp
      //var instance = new AtmosphereApi.AppApiEndpointsJB2008SampleAtmosphere200ResponseAtAltTemp();
      //expect(instance).to.be.a(AtmosphereApi.AppApiEndpointsJB2008SampleAtmosphere200ResponseAtAltTemp);
    });
