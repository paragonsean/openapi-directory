...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseNorthwardWindNeutral();
  });
  ...
  describe('AppApiWfsEndpointsWFSGetValues200ResponseNorthwardWindNeutral', function() {
    it('should create an instance of AppApiWfsEndpointsWFSGetValues200ResponseNorthwardWindNeutral', function() {
      // uncomment below and update the code to test AppApiWfsEndpointsWFSGetValues200ResponseNorthwardWindNeutral
      //var instance = new AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseNorthwardWindNeutral();
      //expect(instance).to.be.a(AtmosphereApi.AppApiWfsEndpointsWFSGetValues200ResponseNorthwardWindNeutral);
    });
