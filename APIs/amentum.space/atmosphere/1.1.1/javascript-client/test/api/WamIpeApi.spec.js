...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.WamIpeApi();
  });
  ...
  describe('WamIpeApi', function() {
    describe('appApiWfsEndpointsWFSGetValues', function() {
      it('should call appApiWfsEndpointsWFSGetValues successfully', function(done) {
        //uncomment below and update the code to test appApiWfsEndpointsWFSGetValues
        //instance.appApiWfsEndpointsWFSGetValues(function(error) {
