...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmosphereApi.Nrlmsise00Api();
  });
  ...
  describe('Nrlmsise00Api', function() {
    describe('appApiEndpointsNRLMSISE00SampleAtmosphere', function() {
      it('should call appApiEndpointsNRLMSISE00SampleAtmosphere successfully', function(done) {
        //uncomment below and update the code to test appApiEndpointsNRLMSISE00SampleAtmosphere
        //instance.appApiEndpointsNRLMSISE00SampleAtmosphere(function(error) {
