...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation();
  });
  ...
  describe('AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation', function() {
    it('should create an instance of AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation', function() {
      // uncomment below and update the code to test AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation
      //var instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation();
      //expect(instance).to.be.a(GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation);
    });
