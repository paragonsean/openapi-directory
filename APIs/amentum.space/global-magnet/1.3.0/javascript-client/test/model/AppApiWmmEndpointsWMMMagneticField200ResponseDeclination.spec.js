...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseDeclination();
  });
  ...
  describe('AppApiWmmEndpointsWMMMagneticField200ResponseDeclination', function() {
    it('should create an instance of AppApiWmmEndpointsWMMMagneticField200ResponseDeclination', function() {
      // uncomment below and update the code to test AppApiWmmEndpointsWMMMagneticField200ResponseDeclination
      //var instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseDeclination();
      //expect(instance).to.be.a(GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseDeclination);
    });
