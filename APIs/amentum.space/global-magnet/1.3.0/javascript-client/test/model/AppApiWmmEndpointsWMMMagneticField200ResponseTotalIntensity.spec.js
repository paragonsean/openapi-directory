...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseTotalIntensity();
  });
  ...
  describe('AppApiWmmEndpointsWMMMagneticField200ResponseTotalIntensity', function() {
    it('should create an instance of AppApiWmmEndpointsWMMMagneticField200ResponseTotalIntensity', function() {
      // uncomment below and update the code to test AppApiWmmEndpointsWMMMagneticField200ResponseTotalIntensity
      //var instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseTotalIntensity();
      //expect(instance).to.be.a(GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseTotalIntensity);
    });
