...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseInclination();
  });
  ...
  describe('AppApiWmmEndpointsWMMMagneticField200ResponseInclination', function() {
    it('should create an instance of AppApiWmmEndpointsWMMMagneticField200ResponseInclination', function() {
      // uncomment below and update the code to test AppApiWmmEndpointsWMMMagneticField200ResponseInclination
      //var instance = new GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseInclination();
      //expect(instance).to.be.a(GeomagApi.AppApiWmmEndpointsWMMMagneticField200ResponseInclination);
    });
