...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeomagApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('appApiWmmEndpointsWMMMagneticField', function() {
      it('should call appApiWmmEndpointsWMMMagneticField successfully', function(done) {
        //uncomment below and update the code to test appApiWmmEndpointsWMMMagneticField
        //instance.appApiWmmEndpointsWMMMagneticField(function(error) {
