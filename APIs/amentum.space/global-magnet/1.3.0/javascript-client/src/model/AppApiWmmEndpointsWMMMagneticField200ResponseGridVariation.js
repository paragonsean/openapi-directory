...
/**
 * The AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation model module.
 * @module model/AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation
 * @version 1.3.0
 */
class AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation {
    /**
     * Constructs a new <code>AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation</code>.
     ...
     * @alias module:model/AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation
     */
    constructor() { 
        
        AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation} obj Optional instance to populate.
     * @return {module:model/AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation} The populated <code>AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation();
    ...
    /**
     * Validates the JSON data with respect to <code>AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation</code>.
     */
 ...
 * @member {String} units
 */
AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation.prototype['units'] = undefined;

/**
 * @member {Number} value
 */
AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation.prototype['value'] = undefined;
...
export default AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation;
