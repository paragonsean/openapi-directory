...
/**
 * The AppApiWmmEndpointsWMMMagneticField200ResponseInclination model module.
 * @module model/AppApiWmmEndpointsWMMMagneticField200ResponseInclination
 * @version 1.3.0
 */
class AppApiWmmEndpointsWMMMagneticField200ResponseInclination {
    /**
     * Constructs a new <code>AppApiWmmEndpointsWMMMagneticField200ResponseInclination</code>.
     ...
     * @alias module:model/AppApiWmmEndpointsWMMMagneticField200ResponseInclination
     */
    constructor() { 
        
        AppApiWmmEndpointsWMMMagneticField200ResponseInclination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppApiWmmEndpointsWMMMagneticField200ResponseInclination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppApiWmmEndpointsWMMMagneticField200ResponseInclination} obj Optional instance to populate.
     * @return {module:model/AppApiWmmEndpointsWMMMagneticField200ResponseInclination} The populated <code>AppApiWmmEndpointsWMMMagneticField200ResponseInclination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppApiWmmEndpointsWMMMagneticField200ResponseInclination();
    ...
    /**
     * Validates the JSON data with respect to <code>AppApiWmmEndpointsWMMMagneticField200ResponseInclination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppApiWmmEndpointsWMMMagneticField200ResponseInclination</code>.
     */
 ...
 * @member {String} units
 */
AppApiWmmEndpointsWMMMagneticField200ResponseInclination.prototype['units'] = undefined;

/**
 * @member {Number} value
 */
AppApiWmmEndpointsWMMMagneticField200ResponseInclination.prototype['value'] = undefined;
...
export default AppApiWmmEndpointsWMMMagneticField200ResponseInclination;
