...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiWmmEndpointsWMMMagneticField200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiWmmEndpointsWMMMagneticField200ResponseDeclination.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiWmmEndpointsWMMMagneticField200ResponseGridVariation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiWmmEndpointsWMMMagneticField200ResponseInclination.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AppApiWmmEndpointsWMMMagneticField200ResponseTotalIntensity.CustomTypeAdapterFactory());
