...
/*
 * OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity.h
 *
 * Total magnetic field intensity in nano Teslas. 
 */

#ifndef OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity_H
#define OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity_H
...
class OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity : public OAIObject {
public:
    OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity();
    OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity(QString json);
    ~OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity)

#endif // OAIApp_api_wmm_endpoints_WMM_magnetic_field_200_response_total_intensity_H
