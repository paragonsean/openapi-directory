...
public class ApiClient {
    ...
    private String basePath = "https://restapi.kumpeapps.com/v5";
    ...
    public ApiClient() {
        ...
        authentications.put("app_key", new ApiKeyAuth("header", "X-Auth"));
        authentications.put("auth_key", new ApiKeyAuth("header", "X-Auth"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://restapi.kumpeapps.com/v5
