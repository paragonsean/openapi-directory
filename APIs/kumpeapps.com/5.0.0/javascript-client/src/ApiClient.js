...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://restapi.kumpeapps.com/v5') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://restapi.kumpeapps.com/v5
         */
        ...
        this.authentications = {
            'app_key': {type: 'apiKey', 'in': 'header', name: 'X-Auth'},
            'auth_key': {type: 'apiKey', 'in': 'header', name: 'X-Auth'}
        }
