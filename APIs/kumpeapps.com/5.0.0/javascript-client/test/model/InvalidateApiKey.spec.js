...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KumpeAppsApi.InvalidateApiKey();
  });
  ...
  describe('InvalidateApiKey', function() {
    it('should create an instance of InvalidateApiKey', function() {
      // uncomment below and update the code to test InvalidateApiKey
      //var instance = new KumpeAppsApi.InvalidateApiKey();
      //expect(instance).to.be.a(KumpeAppsApi.InvalidateApiKey);
    });
