...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KumpeAppsApi.Nodata();
  });
  ...
  describe('Nodata', function() {
    it('should create an instance of Nodata', function() {
      // uncomment below and update the code to test Nodata
      //var instance = new KumpeAppsApi.Nodata();
      //expect(instance).to.be.a(KumpeAppsApi.Nodata);
    });
