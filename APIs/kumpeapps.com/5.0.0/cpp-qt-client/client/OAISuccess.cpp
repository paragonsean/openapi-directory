...
QString OAISuccess::getMessage() const {
    return m_message;
}
void OAISuccess::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAISuccess::is_message_Set() const{
    return m_message_isSet;
}

bool OAISuccess::is_message_Valid() const{
