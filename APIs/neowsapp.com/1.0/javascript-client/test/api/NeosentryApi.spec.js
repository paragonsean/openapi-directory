...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeoWsNearEarthObjectWebService.NeosentryApi();
  });
  ...
  describe('NeosentryApi', function() {
    describe('retrieveSentryRiskData', function() {
      it('should call retrieveSentryRiskData successfully', function(done) {
        //uncomment below and update the code to test retrieveSentryRiskData
        //instance.retrieveSentryRiskData(function(error) {
    ...
    describe('retrieveSentryRiskDataById', function() {
      it('should call retrieveSentryRiskDataById successfully', function(done) {
        //uncomment below and update the code to test retrieveSentryRiskDataById
        //instance.retrieveSentryRiskDataById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
