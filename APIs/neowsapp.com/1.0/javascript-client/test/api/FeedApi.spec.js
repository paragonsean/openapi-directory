...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeoWsNearEarthObjectWebService.FeedApi();
  });
  ...
  describe('FeedApi', function() {
    describe('retrieveNEOFeedToday', function() {
      it('should call retrieveNEOFeedToday successfully', function(done) {
        //uncomment below and update the code to test retrieveNEOFeedToday
        //instance.retrieveNEOFeedToday(function(error) {
    ...
    describe('retrieveNearEarthObjectFeed', function() {
      it('should call retrieveNearEarthObjectFeed successfully', function(done) {
        //uncomment below and update the code to test retrieveNearEarthObjectFeed
        //instance.retrieveNearEarthObjectFeed(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
