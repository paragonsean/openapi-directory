...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeoWsNearEarthObjectWebService.StatsApi();
  });
  ...
  describe('StatsApi', function() {
    describe('retrieveCurrentNeoStatistics', function() {
      it('should call retrieveCurrentNeoStatistics successfully', function(done) {
        //uncomment below and update the code to test retrieveCurrentNeoStatistics
        //instance.retrieveCurrentNeoStatistics(function(error) {
