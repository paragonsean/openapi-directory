...
void Example::exampleFunction1(){
     OAIFeedApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAIFeedApi::retrieveNEOFeedTodaySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIFeedApi::retrieveNEOFeedTodaySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      bool detailed = create(); // bool | detailed
      apiInstance.retrieveNEOFeedToday(detailed);
