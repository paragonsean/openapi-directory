...
import.io
- API version: 1.0
  - Build date: 2024-10-12T10:03:56.484539-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*ExtractionImportIoApi* | [**extractorExtractorIdGet**](docs/ExtractionImportIoApi.md#extractorExtractorIdGet) | **GET** /extractor/{extractorId} | Query by extractor endpoint, adhoc runs only.
