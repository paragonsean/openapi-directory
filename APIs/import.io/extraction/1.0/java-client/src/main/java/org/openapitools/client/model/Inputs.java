...
public class Inputs {
  public static final String SERIALIZED_NAME_EXAMPLE_INPUT = "Example Input";
  @SerializedName(SERIALIZED_NAME_EXAMPLE_INPUT)
  private String exampleInput;

  public static final String SERIALIZED_NAME_URL = "_url";
  ...
  public Inputs exampleInput(String exampleInput) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.exampleInput, inputs.exampleInput) &&
        Objects.equals(this.url, inputs.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exampleInput, url);
  }
  ...
  static {
    ...
    openapiFields.add("Example Input");
    openapiFields.add("_url");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("_url");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Inputs.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("Example Input") != null && !jsonObj.get("Example Input").isJsonNull()) && !jsonObj.get("Example Input").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `Example Input` to be a primitive type in the JSON string but got `%s`", jsonObj.get("Example Input").toString()));
      }
      if (!jsonObj.get("_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("_url").toString()));
      }
  }
