...
public class ApiClient {
    ...
    private String basePath = "https://extraction.import.io";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("query", "_apikey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://extraction.import.io
