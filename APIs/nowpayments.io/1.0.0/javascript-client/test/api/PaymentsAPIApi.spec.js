...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.PaymentsAPIApi();
  });
  ...
  describe('PaymentsAPIApi', function() {
    describe('getEstimatedPrice', function() {
      it('should call getEstimatedPrice successfully', function(done) {
        //uncomment below and update the code to test getEstimatedPrice
        //instance.getEstimatedPrice(function(error) {
    ...
    describe('getListOfPayments', function() {
      it('should call getListOfPayments successfully', function(done) {
        //uncomment below and update the code to test getListOfPayments
        //instance.getListOfPayments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPaymentStatus', function() {
      it('should call getPaymentStatus successfully', function(done) {
        //uncomment below and update the code to test getPaymentStatus
        //instance.getPaymentStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTheMinimumPaymentAmount', function() {
      it('should call getTheMinimumPaymentAmount successfully', function(done) {
        //uncomment below and update the code to test getTheMinimumPaymentAmount
        //instance.getTheMinimumPaymentAmount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUpdatePaymentEstimate', function() {
      it('should call getUpdatePaymentEstimate successfully', function(done) {
        //uncomment below and update the code to test getUpdatePaymentEstimate
        //instance.getUpdatePaymentEstimate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
