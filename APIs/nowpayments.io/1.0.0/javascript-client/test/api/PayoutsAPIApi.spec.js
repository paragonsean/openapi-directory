...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.PayoutsAPIApi();
  });
  ...
  describe('PayoutsAPIApi', function() {
    describe('verifyPayout', function() {
      it('should call verifyPayout successfully', function(done) {
        //uncomment below and update the code to test verifyPayout
        //instance.verifyPayout(function(error) {
