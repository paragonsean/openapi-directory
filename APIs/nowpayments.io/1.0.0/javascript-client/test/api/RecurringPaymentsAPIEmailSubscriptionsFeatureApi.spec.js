...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.RecurringPaymentsAPIEmailSubscriptionsFeatureApi();
  });
  ...
  describe('RecurringPaymentsAPIEmailSubscriptionsFeatureApi', function() {
    describe('deleteRecurringPayment', function() {
      it('should call deleteRecurringPayment successfully', function(done) {
        //uncomment below and update the code to test deleteRecurringPayment
        //instance.deleteRecurringPayment(function(error) {
    ...
    describe('getManyPlans', function() {
      it('should call getManyPlans successfully', function(done) {
        //uncomment below and update the code to test getManyPlans
        //instance.getManyPlans(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getManyRecurringPayments', function() {
      it('should call getManyRecurringPayments successfully', function(done) {
        //uncomment below and update the code to test getManyRecurringPayments
        //instance.getManyRecurringPayments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getOnePlan', function() {
      it('should call getOnePlan successfully', function(done) {
        //uncomment below and update the code to test getOnePlan
        //instance.getOnePlan(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getOneRecurringPayment', function() {
      it('should call getOneRecurringPayment successfully', function(done) {
        //uncomment below and update the code to test getOneRecurringPayment
        //instance.getOneRecurringPayment(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
