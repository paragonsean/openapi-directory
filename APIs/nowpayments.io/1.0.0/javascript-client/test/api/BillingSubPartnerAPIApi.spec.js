...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.BillingSubPartnerAPIApi();
  });
  ...
  describe('BillingSubPartnerAPIApi', function() {
    describe('getAllTransfers', function() {
      it('should call getAllTransfers successfully', function(done) {
        //uncomment below and update the code to test getAllTransfers
        //instance.getAllTransfers(function(error) {
    ...
    describe('getSubPartnerBalance', function() {
      it('should call getSubPartnerBalance successfully', function(done) {
        //uncomment below and update the code to test getSubPartnerBalance
        //instance.getSubPartnerBalance(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSubPartners', function() {
      it('should call getSubPartners successfully', function(done) {
        //uncomment below and update the code to test getSubPartners
        //instance.getSubPartners(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
