...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsddtrc20();
  });
  ...
  describe('GetSubPartnerBalance200ResponseResultBalancesUsddtrc20', function() {
    it('should create an instance of GetSubPartnerBalance200ResponseResultBalancesUsddtrc20', function() {
      // uncomment below and update the code to test GetSubPartnerBalance200ResponseResultBalancesUsddtrc20
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsddtrc20();
      //expect(instance).to.be.a(NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsddtrc20);
    });
    ...
    it('should have the property pendingAmount (base name: "pendingAmount")', function() {
      // uncomment below and update the code to test the property pendingAmount
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsddtrc20();
      //expect(instance).to.be();
    });
