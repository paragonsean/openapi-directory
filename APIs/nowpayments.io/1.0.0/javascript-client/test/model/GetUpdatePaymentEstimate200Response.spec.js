...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.NowPaymentsApi);
  }
}(this, function(expect, NowPaymentsApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new NowPaymentsApi.GetUpdatePaymentEstimate200Response();
  });
  ...
  describe('GetUpdatePaymentEstimate200Response', function() {
    it('should create an instance of GetUpdatePaymentEstimate200Response', function() {
      // uncomment below and update the code to test GetUpdatePaymentEstimate200Response
      //var instance = new NowPaymentsApi.GetUpdatePaymentEstimate200Response();
      //expect(instance).to.be.a(NowPaymentsApi.GetUpdatePaymentEstimate200Response);
    });

    it('should have the property expirationEstimateDate (base name: "expiration_estimate_date")', function() {
      // uncomment below and update the code to test the property expirationEstimateDate
      //var instance = new NowPaymentsApi.GetUpdatePaymentEstimate200Response();
