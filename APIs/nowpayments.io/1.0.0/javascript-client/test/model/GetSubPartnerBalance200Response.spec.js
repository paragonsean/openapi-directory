...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetSubPartnerBalance200Response();
  });
  ...
  describe('GetSubPartnerBalance200Response', function() {
    it('should create an instance of GetSubPartnerBalance200Response', function() {
      // uncomment below and update the code to test GetSubPartnerBalance200Response
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200Response();
      //expect(instance).to.be.a(NowPaymentsApi.GetSubPartnerBalance200Response);
    });
