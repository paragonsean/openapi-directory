...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.DeleteRecurringPayment200Response();
  });
  ...
  describe('DeleteRecurringPayment200Response', function() {
    it('should create an instance of DeleteRecurringPayment200Response', function() {
      // uncomment below and update the code to test DeleteRecurringPayment200Response
      //var instance = new NowPaymentsApi.DeleteRecurringPayment200Response();
      //expect(instance).to.be.a(NowPaymentsApi.DeleteRecurringPayment200Response);
    });
