...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetTheMinimumPaymentAmount200Response();
  });
  ...
  describe('GetTheMinimumPaymentAmount200Response', function() {
    it('should create an instance of GetTheMinimumPaymentAmount200Response', function() {
      // uncomment below and update the code to test GetTheMinimumPaymentAmount200Response
      //var instance = new NowPaymentsApi.GetTheMinimumPaymentAmount200Response();
      //expect(instance).to.be.a(NowPaymentsApi.GetTheMinimumPaymentAmount200Response);
    });

    it('should have the property currencyFrom (base name: "currency_from")', function() {
      // uncomment below and update the code to test the property currencyFrom
      //var instance = new NowPaymentsApi.GetTheMinimumPaymentAmount200Response();
      //expect(instance).to.be();
    });

    it('should have the property currencyTo (base name: "currency_to")', function() {
      // uncomment below and update the code to test the property currencyTo
      //var instance = new NowPaymentsApi.GetTheMinimumPaymentAmount200Response();
      //expect(instance).to.be();
    });

    it('should have the property fiatEquivalent (base name: "fiat_equivalent")', function() {
      // uncomment below and update the code to test the property fiatEquivalent
      //var instance = new NowPaymentsApi.GetTheMinimumPaymentAmount200Response();
      //expect(instance).to.be();
    });
