...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetManyPlans200ResponseResultInner();
  });
  ...
  describe('GetManyPlans200ResponseResultInner', function() {
    it('should create an instance of GetManyPlans200ResponseResultInner', function() {
      // uncomment below and update the code to test GetManyPlans200ResponseResultInner
      //var instance = new NowPaymentsApi.GetManyPlans200ResponseResultInner();
      //expect(instance).to.be.a(NowPaymentsApi.GetManyPlans200ResponseResultInner);
    });
    ...
    it('should have the property ipnCallbackUrl (base name: "ipn_callback_url")', function() {
      // uncomment below and update the code to test the property ipnCallbackUrl
      //var instance = new NowPaymentsApi.GetManyPlans200ResponseResultInner();
      //expect(instance).to.be();
    });

    it('should have the property partiallyPaidUrl (base name: "partially_paid_url")', function() {
      // uncomment below and update the code to test the property partiallyPaidUrl
      //var instance = new NowPaymentsApi.GetManyPlans200ResponseResultInner();
      //expect(instance).to.be();
    });
