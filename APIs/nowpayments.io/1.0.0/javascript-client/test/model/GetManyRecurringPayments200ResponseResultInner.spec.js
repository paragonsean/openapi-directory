...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetManyRecurringPayments200ResponseResultInner();
  });
  ...
  describe('GetManyRecurringPayments200ResponseResultInner', function() {
    it('should create an instance of GetManyRecurringPayments200ResponseResultInner', function() {
      // uncomment below and update the code to test GetManyRecurringPayments200ResponseResultInner
      //var instance = new NowPaymentsApi.GetManyRecurringPayments200ResponseResultInner();
      //expect(instance).to.be.a(NowPaymentsApi.GetManyRecurringPayments200ResponseResultInner);
    });
