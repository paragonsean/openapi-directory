...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.VerifyPayoutRequest();
  });
  ...
  describe('VerifyPayoutRequest', function() {
    it('should create an instance of VerifyPayoutRequest', function() {
      // uncomment below and update the code to test VerifyPayoutRequest
      //var instance = new NowPaymentsApi.VerifyPayoutRequest();
      //expect(instance).to.be.a(NowPaymentsApi.VerifyPayoutRequest);
    });
