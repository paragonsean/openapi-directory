...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetListOfPayments200ResponseDataInner();
  });
  ...
  describe('GetListOfPayments200ResponseDataInner', function() {
    it('should create an instance of GetListOfPayments200ResponseDataInner', function() {
      // uncomment below and update the code to test GetListOfPayments200ResponseDataInner
      //var instance = new NowPaymentsApi.GetListOfPayments200ResponseDataInner();
      //expect(instance).to.be.a(NowPaymentsApi.GetListOfPayments200ResponseDataInner);
    });

    it('should have the property actuallyPaid (base name: "actually_paid")', function() {
      // uncomment below and update the code to test the property actuallyPaid
      //var instance = new NowPaymentsApi.GetListOfPayments200ResponseDataInner();
      //expect(instance).to.be();
    });

    it('should have the property orderDescription (base name: "order_description")', function() {
      // uncomment below and update the code to test the property orderDescription
      //var instance = new NowPaymentsApi.GetListOfPayments200ResponseDataInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property outcomeAmount (base name: "outcome_amount")', function() {
      // uncomment below and update the code to test the property outcomeAmount
      //var instance = new NowPaymentsApi.GetListOfPayments200ResponseDataInner();
      //expect(instance).to.be();
    });

    it('should have the property outcomeCurrency (base name: "outcome_currency")', function() {
      // uncomment below and update the code to test the property outcomeCurrency
      //var instance = new NowPaymentsApi.GetListOfPayments200ResponseDataInner();
      //expect(instance).to.be();
    });

    it('should have the property payAddress (base name: "pay_address")', function() {
      // uncomment below and update the code to test the property payAddress
      //var instance = new NowPaymentsApi.GetListOfPayments200ResponseDataInner();
      //expect(instance).to.be();
    });
