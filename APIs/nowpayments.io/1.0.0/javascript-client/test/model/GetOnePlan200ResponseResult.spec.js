...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetOnePlan200ResponseResult();
  });
  ...
  describe('GetOnePlan200ResponseResult', function() {
    it('should create an instance of GetOnePlan200ResponseResult', function() {
      // uncomment below and update the code to test GetOnePlan200ResponseResult
      //var instance = new NowPaymentsApi.GetOnePlan200ResponseResult();
      //expect(instance).to.be.a(NowPaymentsApi.GetOnePlan200ResponseResult);
    });
