...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetOneRecurringPayment200ResponseResultSubscriber();
  });
  ...
  describe('GetOneRecurringPayment200ResponseResultSubscriber', function() {
    it('should create an instance of GetOneRecurringPayment200ResponseResultSubscriber', function() {
      // uncomment below and update the code to test GetOneRecurringPayment200ResponseResultSubscriber
      //var instance = new NowPaymentsApi.GetOneRecurringPayment200ResponseResultSubscriber();
      //expect(instance).to.be.a(NowPaymentsApi.GetOneRecurringPayment200ResponseResultSubscriber);
    });
