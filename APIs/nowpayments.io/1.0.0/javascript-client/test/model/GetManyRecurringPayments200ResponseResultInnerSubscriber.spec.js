...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetManyRecurringPayments200ResponseResultInnerSubscriber();
  });
  ...
  describe('GetManyRecurringPayments200ResponseResultInnerSubscriber', function() {
    it('should create an instance of GetManyRecurringPayments200ResponseResultInnerSubscriber', function() {
      // uncomment below and update the code to test GetManyRecurringPayments200ResponseResultInnerSubscriber
      //var instance = new NowPaymentsApi.GetManyRecurringPayments200ResponseResultInnerSubscriber();
      //expect(instance).to.be.a(NowPaymentsApi.GetManyRecurringPayments200ResponseResultInnerSubscriber);
    });
    ...
    it('should have the property subPartnerId (base name: "sub_partner_id")', function() {
