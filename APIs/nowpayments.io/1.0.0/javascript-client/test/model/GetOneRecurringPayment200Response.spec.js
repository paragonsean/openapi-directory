...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetOneRecurringPayment200Response();
  });
  ...
  describe('GetOneRecurringPayment200Response', function() {
    it('should create an instance of GetOneRecurringPayment200Response', function() {
      // uncomment below and update the code to test GetOneRecurringPayment200Response
      //var instance = new NowPaymentsApi.GetOneRecurringPayment200Response();
      //expect(instance).to.be.a(NowPaymentsApi.GetOneRecurringPayment200Response);
    });
