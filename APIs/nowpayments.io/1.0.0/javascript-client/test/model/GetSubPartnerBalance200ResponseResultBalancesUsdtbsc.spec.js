...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsdtbsc();
  });
  ...
  describe('GetSubPartnerBalance200ResponseResultBalancesUsdtbsc', function() {
    it('should create an instance of GetSubPartnerBalance200ResponseResultBalancesUsdtbsc', function() {
      // uncomment below and update the code to test GetSubPartnerBalance200ResponseResultBalancesUsdtbsc
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsdtbsc();
      //expect(instance).to.be.a(NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsdtbsc);
    });
