...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetEstimatedPrice200Response();
  });
  ...
  describe('GetEstimatedPrice200Response', function() {
    it('should create an instance of GetEstimatedPrice200Response', function() {
      // uncomment below and update the code to test GetEstimatedPrice200Response
      //var instance = new NowPaymentsApi.GetEstimatedPrice200Response();
      //expect(instance).to.be.a(NowPaymentsApi.GetEstimatedPrice200Response);
    });
    ...
    it('should have the property estimatedAmount (base name: "estimated_amount")', function() {
