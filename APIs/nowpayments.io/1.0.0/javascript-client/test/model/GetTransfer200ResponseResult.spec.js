...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetTransfer200ResponseResult();
  });
  ...
  describe('GetTransfer200ResponseResult', function() {
    it('should create an instance of GetTransfer200ResponseResult', function() {
      // uncomment below and update the code to test GetTransfer200ResponseResult
      //var instance = new NowPaymentsApi.GetTransfer200ResponseResult();
      //expect(instance).to.be.a(NowPaymentsApi.GetTransfer200ResponseResult);
    });
