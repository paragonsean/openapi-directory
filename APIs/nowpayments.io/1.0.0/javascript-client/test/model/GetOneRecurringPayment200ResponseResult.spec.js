...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetOneRecurringPayment200ResponseResult();
  });
  ...
  describe('GetOneRecurringPayment200ResponseResult', function() {
    it('should create an instance of GetOneRecurringPayment200ResponseResult', function() {
      // uncomment below and update the code to test GetOneRecurringPayment200ResponseResult
      //var instance = new NowPaymentsApi.GetOneRecurringPayment200ResponseResult();
      //expect(instance).to.be.a(NowPaymentsApi.GetOneRecurringPayment200ResponseResult);
    });
    ...
    it('should have the property subscriptionPlanId (base name: "subscription_plan_id")', function() {
