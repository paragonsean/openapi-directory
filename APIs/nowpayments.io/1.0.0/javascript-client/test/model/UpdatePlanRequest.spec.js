...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.UpdatePlanRequest();
  });
  ...
  describe('UpdatePlanRequest', function() {
    it('should create an instance of UpdatePlanRequest', function() {
      // uncomment below and update the code to test UpdatePlanRequest
      //var instance = new NowPaymentsApi.UpdatePlanRequest();
      //expect(instance).to.be.a(NowPaymentsApi.UpdatePlanRequest);
    });
    ...
    it('should have the property intervalDay (base name: "interval_day")', function() {
      // uncomment below and update the code to test the property intervalDay
      //var instance = new NowPaymentsApi.UpdatePlanRequest();
      //expect(instance).to.be();
    });
