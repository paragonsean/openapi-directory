...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetManyRecurringPayments200Response();
  });
  ...
  describe('GetManyRecurringPayments200Response', function() {
    it('should create an instance of GetManyRecurringPayments200Response', function() {
      // uncomment below and update the code to test GetManyRecurringPayments200Response
      //var instance = new NowPaymentsApi.GetManyRecurringPayments200Response();
      //expect(instance).to.be.a(NowPaymentsApi.GetManyRecurringPayments200Response);
    });
