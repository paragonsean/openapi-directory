...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetOneRecurringPayment404Response();
  });
  ...
  describe('GetOneRecurringPayment404Response', function() {
    it('should create an instance of GetOneRecurringPayment404Response', function() {
      // uncomment below and update the code to test GetOneRecurringPayment404Response
      //var instance = new NowPaymentsApi.GetOneRecurringPayment404Response();
      //expect(instance).to.be.a(NowPaymentsApi.GetOneRecurringPayment404Response);
    });
