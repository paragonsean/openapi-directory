...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResult();
  });
  ...
  describe('GetSubPartnerBalance200ResponseResult', function() {
    it('should create an instance of GetSubPartnerBalance200ResponseResult', function() {
      // uncomment below and update the code to test GetSubPartnerBalance200ResponseResult
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResult();
      //expect(instance).to.be.a(NowPaymentsApi.GetSubPartnerBalance200ResponseResult);
    });
    ...
    it('should have the property subPartnerId (base name: "subPartnerId")', function() {
      // uncomment below and update the code to test the property subPartnerId
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResult();
      //expect(instance).to.be();
    });
