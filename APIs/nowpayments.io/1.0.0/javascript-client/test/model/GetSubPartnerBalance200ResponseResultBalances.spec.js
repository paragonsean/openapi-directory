...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalances();
  });
  ...
  describe('GetSubPartnerBalance200ResponseResultBalances', function() {
    it('should create an instance of GetSubPartnerBalance200ResponseResultBalances', function() {
      // uncomment below and update the code to test GetSubPartnerBalance200ResponseResultBalances
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalances();
      //expect(instance).to.be.a(NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalances);
    });

    it('should have the property usddtrc20 (base name: "usddtrc20")', function() {
      // uncomment below and update the code to test the property usddtrc20
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalances();
      //expect(instance).to.be();
    });

    it('should have the property usdtbsc (base name: "usdtbsc")', function() {
      // uncomment below and update the code to test the property usdtbsc
      //var instance = new NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalances();
      //expect(instance).to.be();
    });
