...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NowPaymentsApi.GetAllTransfers200ResponseResultInner();
  });
  ...
  describe('GetAllTransfers200ResponseResultInner', function() {
    it('should create an instance of GetAllTransfers200ResponseResultInner', function() {
      // uncomment below and update the code to test GetAllTransfers200ResponseResultInner
      //var instance = new NowPaymentsApi.GetAllTransfers200ResponseResultInner();
      //expect(instance).to.be.a(NowPaymentsApi.GetAllTransfers200ResponseResultInner);
    });
    ...
    it('should have the property fromSubId (base name: "from_sub_id")', function() {
      // uncomment below and update the code to test the property fromSubId
      //var instance = new NowPaymentsApi.GetAllTransfers200ResponseResultInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property toSubId (base name: "to_sub_id")', function() {
      // uncomment below and update the code to test the property toSubId
      //var instance = new NowPaymentsApi.GetAllTransfers200ResponseResultInner();
      //expect(instance).to.be();
    });
