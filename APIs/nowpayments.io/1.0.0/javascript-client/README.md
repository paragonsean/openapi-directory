...
NowPaymentsApi - JavaScript client for now_payments_api
...
```shell
npm install now_payments_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your now_payments_api from, and run:
...
```javascript
var NowPaymentsApi = require('now_payments_api');


var api = new NowPaymentsApi.BillingSubPartnerAPIApi()
var opts = {
...
api.getAllTransfers(opts, callback);
...
------------ | ------------- | ------------- | -------------
*NowPaymentsApi.BillingSubPartnerAPIApi* | [**getAllTransfers**](docs/BillingSubPartnerAPIApi.md#getAllTransfers) | **GET** /v1/sub-partner/transfers | Get all transfers
*NowPaymentsApi.BillingSubPartnerAPIApi* | [**getSubPartnerBalance**](docs/BillingSubPartnerAPIApi.md#getSubPartnerBalance) | **GET** /v1/sub-partner/balance/{id} | Get sub-partner balance
*NowPaymentsApi.BillingSubPartnerAPIApi* | [**getSubPartners**](docs/BillingSubPartnerAPIApi.md#getSubPartners) | **GET** /v1/sub-partner | Get sub-partners
*NowPaymentsApi.BillingSubPartnerAPIApi* | [**getTransfer**](docs/BillingSubPartnerAPIApi.md#getTransfer) | **GET** /v1/sub-partner/transfer/{id} | Get transfer
*NowPaymentsApi.PaymentsAPIApi* | [**getEstimatedPrice**](docs/PaymentsAPIApi.md#getEstimatedPrice) | **GET** /v1/estimate | Get estimated price
*NowPaymentsApi.PaymentsAPIApi* | [**getListOfPayments**](docs/PaymentsAPIApi.md#getListOfPayments) | **GET** /v1/payment/ | Get list of payments
*NowPaymentsApi.PaymentsAPIApi* | [**getPaymentStatus**](docs/PaymentsAPIApi.md#getPaymentStatus) | **GET** /v1/payment/{payment_id} | Get payment status
*NowPaymentsApi.PaymentsAPIApi* | [**getTheMinimumPaymentAmount**](docs/PaymentsAPIApi.md#getTheMinimumPaymentAmount) | **GET** /v1/min-amount | Get the minimum payment amount
*NowPaymentsApi.PaymentsAPIApi* | [**getUpdatePaymentEstimate**](docs/PaymentsAPIApi.md#getUpdatePaymentEstimate) | **POST** /v1/payment/{id}/update-merchant-estimate | Get/Update payment estimate
*NowPaymentsApi.PayoutsAPIApi* | [**verifyPayout**](docs/PayoutsAPIApi.md#verifyPayout) | **POST** /v1/payout/{withdrawals-id}/verify | Verify payout
*NowPaymentsApi.RecurringPaymentsAPIEmailSubscriptionsFeatureApi* | [**deleteRecurringPayment**](docs/RecurringPaymentsAPIEmailSubscriptionsFeatureApi.md#deleteRecurringPayment) | **DELETE** /v1/subscriptions/{sub_id} | Delete recurring payment
*NowPaymentsApi.RecurringPaymentsAPIEmailSubscriptionsFeatureApi* | [**getManyPlans**](docs/RecurringPaymentsAPIEmailSubscriptionsFeatureApi.md#getManyPlans) | **GET** /v1/subscriptions/plans | Get many plans
*NowPaymentsApi.RecurringPaymentsAPIEmailSubscriptionsFeatureApi* | [**getManyRecurringPayments**](docs/RecurringPaymentsAPIEmailSubscriptionsFeatureApi.md#getManyRecurringPayments) | **GET** /v1/subscriptions | Get many recurring payments
*NowPaymentsApi.RecurringPaymentsAPIEmailSubscriptionsFeatureApi* | [**getOnePlan**](docs/RecurringPaymentsAPIEmailSubscriptionsFeatureApi.md#getOnePlan) | **GET** /v1/subscriptions/plans/{plan-id} | Get one plan
*NowPaymentsApi.RecurringPaymentsAPIEmailSubscriptionsFeatureApi* | [**getOneRecurringPayment**](docs/RecurringPaymentsAPIEmailSubscriptionsFeatureApi.md#getOneRecurringPayment) | **GET** /v1/subscriptions/{sub_id} | Get one recurring payment
*NowPaymentsApi.RecurringPaymentsAPIEmailSubscriptionsFeatureApi* | [**updatePlan**](docs/RecurringPaymentsAPIEmailSubscriptionsFeatureApi.md#updatePlan) | **PATCH** /v1/subscriptions/plans/{plan-id} | Update plan


## Documentation for Models

 - [NowPaymentsApi.DeleteRecurringPayment200Response](docs/DeleteRecurringPayment200Response.md)
 - [NowPaymentsApi.GetAllTransfers200Response](docs/GetAllTransfers200Response.md)
 - [NowPaymentsApi.GetAllTransfers200ResponseResultInner](docs/GetAllTransfers200ResponseResultInner.md)
 - [NowPaymentsApi.GetEstimatedPrice200Response](docs/GetEstimatedPrice200Response.md)
 - [NowPaymentsApi.GetListOfPayments200Response](docs/GetListOfPayments200Response.md)
 - [NowPaymentsApi.GetListOfPayments200ResponseDataInner](docs/GetListOfPayments200ResponseDataInner.md)
 - [NowPaymentsApi.GetManyPlans200Response](docs/GetManyPlans200Response.md)
 - [NowPaymentsApi.GetManyPlans200ResponseResultInner](docs/GetManyPlans200ResponseResultInner.md)
 - [NowPaymentsApi.GetManyRecurringPayments200Response](docs/GetManyRecurringPayments200Response.md)
 - [NowPaymentsApi.GetManyRecurringPayments200ResponseResultInner](docs/GetManyRecurringPayments200ResponseResultInner.md)
 - [NowPaymentsApi.GetManyRecurringPayments200ResponseResultInnerSubscriber](docs/GetManyRecurringPayments200ResponseResultInnerSubscriber.md)
 - [NowPaymentsApi.GetOnePlan200Response](docs/GetOnePlan200Response.md)
 - [NowPaymentsApi.GetOnePlan200ResponseResult](docs/GetOnePlan200ResponseResult.md)
 - [NowPaymentsApi.GetOnePlan404Response](docs/GetOnePlan404Response.md)
 - [NowPaymentsApi.GetOneRecurringPayment200Response](docs/GetOneRecurringPayment200Response.md)
 - [NowPaymentsApi.GetOneRecurringPayment200ResponseResult](docs/GetOneRecurringPayment200ResponseResult.md)
 - [NowPaymentsApi.GetOneRecurringPayment200ResponseResultSubscriber](docs/GetOneRecurringPayment200ResponseResultSubscriber.md)
 - [NowPaymentsApi.GetOneRecurringPayment404Response](docs/GetOneRecurringPayment404Response.md)
 - [NowPaymentsApi.GetPaymentStatus200Response](docs/GetPaymentStatus200Response.md)
 - [NowPaymentsApi.GetSubPartnerBalance200Response](docs/GetSubPartnerBalance200Response.md)
 - [NowPaymentsApi.GetSubPartnerBalance200ResponseResult](docs/GetSubPartnerBalance200ResponseResult.md)
 - [NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalances](docs/GetSubPartnerBalance200ResponseResultBalances.md)
 - [NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsddtrc20](docs/GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.md)
 - [NowPaymentsApi.GetSubPartnerBalance200ResponseResultBalancesUsdtbsc](docs/GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.md)
 - [NowPaymentsApi.GetTheMinimumPaymentAmount200Response](docs/GetTheMinimumPaymentAmount200Response.md)
 - [NowPaymentsApi.GetTransfer200Response](docs/GetTransfer200Response.md)
 - [NowPaymentsApi.GetTransfer200ResponseResult](docs/GetTransfer200ResponseResult.md)
 - [NowPaymentsApi.GetUpdatePaymentEstimate200Response](docs/GetUpdatePaymentEstimate200Response.md)
 - [NowPaymentsApi.UpdatePlanRequest](docs/UpdatePlanRequest.md)
 - [NowPaymentsApi.VerifyPayoutRequest](docs/VerifyPayoutRequest.md)
