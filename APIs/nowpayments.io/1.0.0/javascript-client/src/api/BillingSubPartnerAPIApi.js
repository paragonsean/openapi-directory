...
/**
* BillingSubPartnerAPI service.
* @module api/BillingSubPartnerAPIApi
* @version 1.0.0
*/
export default class BillingSubPartnerAPIApi {

    /**
    * Constructs a new BillingSubPartnerAPIApi. 
    * @alias module:api/BillingSubPartnerAPIApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllTransfers operation.
     * @callback module:api/BillingSubPartnerAPIApi~getAllTransfersCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetAllTransfers200Response} data The data returned by the service call.
     ...
     * @param {String} [status] string or array of string  \"WAITING\"/\"CREATED\"/\"FINISHED\"/\"REJECTED\" (optional)
     ...
     * @param {module:api/BillingSubPartnerAPIApi~getAllTransfersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetAllTransfers200Response}
     */
    getAllTransfers(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = GetAllTransfers200Response;
      return this.apiClient.callApi(
        '/v1/sub-partner/transfers', 'GET',
    ...
    /**
     * Callback function to receive the result of the getSubPartnerBalance operation.
     * @callback module:api/BillingSubPartnerAPIApi~getSubPartnerBalanceCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetSubPartnerBalance200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/BillingSubPartnerAPIApi~getSubPartnerBalanceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetSubPartnerBalance200Response}
     */
    getSubPartnerBalance(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getSubPartnerBalance");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetSubPartnerBalance200Response;
      return this.apiClient.callApi(
        '/v1/sub-partner/balance/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getSubPartners operation.
     * @callback module:api/BillingSubPartnerAPIApi~getSubPartnersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} [limit] (optional) default 10
     * @param {String} [order] ASC / DESC (optional) default ASC
     * @param {module:api/BillingSubPartnerAPIApi~getSubPartnersCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getSubPartners(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @callback module:api/BillingSubPartnerAPIApi~getTransferCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetTransfer200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id 
     * @param {module:api/BillingSubPartnerAPIApi~getTransferCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetTransfer200Response}
     */
    getTransfer(id, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetTransfer200Response;
      return this.apiClient.callApi(
        '/v1/sub-partner/transfer/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
