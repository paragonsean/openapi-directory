...
/**
* PayoutsAPI service.
* @module api/PayoutsAPIApi
* @version 1.0.0
*/
export default class PayoutsAPIApi {

    /**
    * Constructs a new PayoutsAPIApi. 
    * @alias module:api/PayoutsAPIApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the verifyPayout operation.
     * @callback module:api/PayoutsAPIApi~verifyPayoutCallback
     ...
     * @param {String} withdrawalsId 
     * @param {Object} opts Optional parameters
     * @param {String} [xApiKey] 
     * @param {module:model/VerifyPayoutRequest} [verifyPayoutRequest] 
     * @param {module:api/PayoutsAPIApi~verifyPayoutCallback} callback The callback function, accepting three arguments: error, data, response
     */
    verifyPayout(withdrawalsId, opts, callback) {
      opts = opts || {};
      let postBody = opts['verifyPayoutRequest'];
      // verify the required parameter 'withdrawalsId' is set
      if (withdrawalsId === undefined || withdrawalsId === null) {
        throw new Error("Missing the required parameter 'withdrawalsId' when calling verifyPayout");
      }

      let pathParams = {
        'withdrawals-id': withdrawalsId
      };
      let queryParams = {
      };
      let headerParams = {
      ...
      return this.apiClient.callApi(
        '/v1/payout/{withdrawals-id}/verify', 'POST',
