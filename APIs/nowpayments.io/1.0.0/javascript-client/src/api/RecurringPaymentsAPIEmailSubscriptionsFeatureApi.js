...
/**
* RecurringPaymentsAPIEmailSubscriptionsFeature service.
* @module api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi
* @version 1.0.0
*/
export default class RecurringPaymentsAPIEmailSubscriptionsFeatureApi {

    /**
    * Constructs a new RecurringPaymentsAPIEmailSubscriptionsFeatureApi. 
    * @alias module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteRecurringPayment operation.
     * @callback module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~deleteRecurringPaymentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteRecurringPayment200Response} data The data returned by the service call.
     ...
     * @param {String} subId 
     * @param {module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~deleteRecurringPaymentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteRecurringPayment200Response}
     */
    deleteRecurringPayment(subId, callback) {
      let postBody = null;
      // verify the required parameter 'subId' is set
      if (subId === undefined || subId === null) {
        throw new Error("Missing the required parameter 'subId' when calling deleteRecurringPayment");
      }
      ...
      let returnType = DeleteRecurringPayment200Response;
      return this.apiClient.callApi(
        '/v1/subscriptions/{sub_id}', 'DELETE',
    ...
    /**
     * Callback function to receive the result of the getManyPlans operation.
     * @callback module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getManyPlansCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetManyPlans200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getManyPlansCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetManyPlans200Response}
     */
    getManyPlans(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetManyPlans200Response;
      return this.apiClient.callApi(
        '/v1/subscriptions/plans', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getManyRecurringPayments operation.
     * @callback module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getManyRecurringPaymentsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetManyRecurringPayments200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [isActive] true / false
     * @param {String} [limit] 
     * @param {String} [offset] 
     * @param {String} [xApiKey] 
     * @param {module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getManyRecurringPaymentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetManyRecurringPayments200Response}
     */
    getManyRecurringPayments(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'status': opts['status'],
        'subscription_plan_id': opts['subscriptionPlanId'],
      ...
      let contentTypes = ['text/plain'];
      let accepts = ['application/json'];
      let returnType = GetManyRecurringPayments200Response;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getOnePlan operation.
     * @callback module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getOnePlanCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetOnePlan200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xApiKey] 
     * @param {module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getOnePlanCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetOnePlan200Response}
     */
    getOnePlan(planId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'planId' is set
      if (planId === undefined || planId === null) {
        throw new Error("Missing the required parameter 'planId' when calling getOnePlan");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetOnePlan200Response;
      return this.apiClient.callApi(
        '/v1/subscriptions/plans/{plan-id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getOneRecurringPayment operation.
     * @callback module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getOneRecurringPaymentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetOneRecurringPayment200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xApiKey] 
     * @param {module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~getOneRecurringPaymentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetOneRecurringPayment200Response}
     */
    getOneRecurringPayment(subId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'subId' is set
      if (subId === undefined || subId === null) {
        throw new Error("Missing the required parameter 'subId' when calling getOneRecurringPayment");
      }
      ...
      let contentTypes = ['text/plain'];
      let accepts = ['application/json'];
      let returnType = GetOneRecurringPayment200Response;
      return this.apiClient.callApi(
        '/v1/subscriptions/{sub_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~updatePlanCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/RecurringPaymentsAPIEmailSubscriptionsFeatureApi~updatePlanCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updatePlan(planId, opts, callback) {
      opts = opts || {};
      let postBody = opts['updatePlanRequest'];
      // verify the required parameter 'planId' is set
      if (planId === undefined || planId === null) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v1/subscriptions/plans/{plan-id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
