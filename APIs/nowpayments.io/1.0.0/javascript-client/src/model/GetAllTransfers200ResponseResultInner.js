...
/**
 * The GetAllTransfers200ResponseResultInner model module.
 * @module model/GetAllTransfers200ResponseResultInner
 * @version 1.0.0
 */
class GetAllTransfers200ResponseResultInner {
    /**
     * Constructs a new <code>GetAllTransfers200ResponseResultInner</code>.
     * @alias module:model/GetAllTransfers200ResponseResultInner
     */
    constructor() { 
        
        GetAllTransfers200ResponseResultInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAllTransfers200ResponseResultInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAllTransfers200ResponseResultInner} obj Optional instance to populate.
     * @return {module:model/GetAllTransfers200ResponseResultInner} The populated <code>GetAllTransfers200ResponseResultInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAllTransfers200ResponseResultInner();
            ...
            if (data.hasOwnProperty('from_sub_id')) {
                obj['from_sub_id'] = ApiClient.convertToType(data['from_sub_id'], 'String');
            }
            ...
            if (data.hasOwnProperty('to_sub_id')) {
                obj['to_sub_id'] = ApiClient.convertToType(data['to_sub_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAllTransfers200ResponseResultInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAllTransfers200ResponseResultInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['from_sub_id'] && !(typeof data['from_sub_id'] === 'string' || data['from_sub_id'] instanceof String)) {
            throw new Error("Expected the field `from_sub_id` to be a primitive type in the JSON string but got " + data['from_sub_id']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['to_sub_id'] && !(typeof data['to_sub_id'] === 'string' || data['to_sub_id'] instanceof String)) {
            throw new Error("Expected the field `to_sub_id` to be a primitive type in the JSON string but got " + data['to_sub_id']);
        }
        // ensure the json data is a string
 ...
 */
GetAllTransfers200ResponseResultInner.prototype['amount'] = undefined;

/**
 * @member {String} created_at
 */
GetAllTransfers200ResponseResultInner.prototype['created_at'] = undefined;

/**
 * @member {String} currency
 */
GetAllTransfers200ResponseResultInner.prototype['currency'] = undefined;

/**
 * @member {String} from_sub_id
 */
GetAllTransfers200ResponseResultInner.prototype['from_sub_id'] = undefined;

/**
 * @member {String} id
 */
GetAllTransfers200ResponseResultInner.prototype['id'] = undefined;

/**
 * @member {String} status
 */
GetAllTransfers200ResponseResultInner.prototype['status'] = undefined;

/**
 * @member {String} to_sub_id
 */
GetAllTransfers200ResponseResultInner.prototype['to_sub_id'] = undefined;

/**
 * @member {String} updated_at
 */
GetAllTransfers200ResponseResultInner.prototype['updated_at'] = undefined;
...
export default GetAllTransfers200ResponseResultInner;
