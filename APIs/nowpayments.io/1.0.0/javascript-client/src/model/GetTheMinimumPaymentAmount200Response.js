...
/**
 * The GetTheMinimumPaymentAmount200Response model module.
 * @module model/GetTheMinimumPaymentAmount200Response
 * @version 1.0.0
 */
class GetTheMinimumPaymentAmount200Response {
    /**
     * Constructs a new <code>GetTheMinimumPaymentAmount200Response</code>.
     * @alias module:model/GetTheMinimumPaymentAmount200Response
     */
    constructor() { 
        
        GetTheMinimumPaymentAmount200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTheMinimumPaymentAmount200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTheMinimumPaymentAmount200Response} obj Optional instance to populate.
     * @return {module:model/GetTheMinimumPaymentAmount200Response} The populated <code>GetTheMinimumPaymentAmount200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTheMinimumPaymentAmount200Response();
            ...
            if (data.hasOwnProperty('fiat_equivalent')) {
                obj['fiat_equivalent'] = ApiClient.convertToType(data['fiat_equivalent'], 'Number');
            }
            if (data.hasOwnProperty('min_amount')) {
                obj['min_amount'] = ApiClient.convertToType(data['min_amount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTheMinimumPaymentAmount200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTheMinimumPaymentAmount200Response</code>.
     */
 ...
 */
GetTheMinimumPaymentAmount200Response.prototype['currency_from'] = undefined;

/**
 * @member {String} currency_to
 */
GetTheMinimumPaymentAmount200Response.prototype['currency_to'] = undefined;

/**
 * @member {Number} fiat_equivalent
 */
GetTheMinimumPaymentAmount200Response.prototype['fiat_equivalent'] = undefined;

/**
 * @member {Number} min_amount
 */
GetTheMinimumPaymentAmount200Response.prototype['min_amount'] = undefined;
...
export default GetTheMinimumPaymentAmount200Response;
