...
import GetTransfer200ResponseResult from './GetTransfer200ResponseResult';

/**
 * The GetTransfer200Response model module.
 * @module model/GetTransfer200Response
 * @version 1.0.0
 */
class GetTransfer200Response {
    /**
     * Constructs a new <code>GetTransfer200Response</code>.
     * @alias module:model/GetTransfer200Response
     */
    constructor() { 
        
        GetTransfer200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTransfer200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTransfer200Response} obj Optional instance to populate.
     * @return {module:model/GetTransfer200Response} The populated <code>GetTransfer200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTransfer200Response();

            if (data.hasOwnProperty('result')) {
                obj['result'] = GetTransfer200ResponseResult.constructFromObject(data['result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransfer200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransfer200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `result`
        if (data['result']) { // data not null
          GetTransfer200ResponseResult.validateJSON(data['result']);
        }
...
/**
 * @member {module:model/GetTransfer200ResponseResult} result
 */
GetTransfer200Response.prototype['result'] = undefined;
...
export default GetTransfer200Response;
