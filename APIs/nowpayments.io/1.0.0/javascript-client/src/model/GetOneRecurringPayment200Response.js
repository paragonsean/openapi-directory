...
import GetOneRecurringPayment200ResponseResult from './GetOneRecurringPayment200ResponseResult';

/**
 * The GetOneRecurringPayment200Response model module.
 * @module model/GetOneRecurringPayment200Response
 * @version 1.0.0
 */
class GetOneRecurringPayment200Response {
    /**
     * Constructs a new <code>GetOneRecurringPayment200Response</code>.
     * @alias module:model/GetOneRecurringPayment200Response
     */
    constructor() { 
        
        GetOneRecurringPayment200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOneRecurringPayment200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOneRecurringPayment200Response} obj Optional instance to populate.
     * @return {module:model/GetOneRecurringPayment200Response} The populated <code>GetOneRecurringPayment200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOneRecurringPayment200Response();

            if (data.hasOwnProperty('result')) {
                obj['result'] = GetOneRecurringPayment200ResponseResult.constructFromObject(data['result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOneRecurringPayment200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOneRecurringPayment200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `result`
        if (data['result']) { // data not null
          GetOneRecurringPayment200ResponseResult.validateJSON(data['result']);
        }
...
/**
 * @member {module:model/GetOneRecurringPayment200ResponseResult} result
 */
GetOneRecurringPayment200Response.prototype['result'] = undefined;
...
export default GetOneRecurringPayment200Response;
