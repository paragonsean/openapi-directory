...
import GetSubPartnerBalance200ResponseResult from './GetSubPartnerBalance200ResponseResult';

/**
 * The GetSubPartnerBalance200Response model module.
 * @module model/GetSubPartnerBalance200Response
 * @version 1.0.0
 */
class GetSubPartnerBalance200Response {
    /**
     * Constructs a new <code>GetSubPartnerBalance200Response</code>.
     * @alias module:model/GetSubPartnerBalance200Response
     */
    constructor() { 
        
        GetSubPartnerBalance200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSubPartnerBalance200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSubPartnerBalance200Response} obj Optional instance to populate.
     * @return {module:model/GetSubPartnerBalance200Response} The populated <code>GetSubPartnerBalance200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSubPartnerBalance200Response();

            if (data.hasOwnProperty('result')) {
                obj['result'] = GetSubPartnerBalance200ResponseResult.constructFromObject(data['result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSubPartnerBalance200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSubPartnerBalance200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `result`
        if (data['result']) { // data not null
          GetSubPartnerBalance200ResponseResult.validateJSON(data['result']);
        }
...
/**
 * @member {module:model/GetSubPartnerBalance200ResponseResult} result
 */
GetSubPartnerBalance200Response.prototype['result'] = undefined;
...
export default GetSubPartnerBalance200Response;
