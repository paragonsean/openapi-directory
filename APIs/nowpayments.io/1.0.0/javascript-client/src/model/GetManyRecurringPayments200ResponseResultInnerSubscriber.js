...
/**
 * The GetManyRecurringPayments200ResponseResultInnerSubscriber model module.
 * @module model/GetManyRecurringPayments200ResponseResultInnerSubscriber
 * @version 1.0.0
 */
class GetManyRecurringPayments200ResponseResultInnerSubscriber {
    /**
     * Constructs a new <code>GetManyRecurringPayments200ResponseResultInnerSubscriber</code>.
     * @alias module:model/GetManyRecurringPayments200ResponseResultInnerSubscriber
     */
    constructor() { 
        
        GetManyRecurringPayments200ResponseResultInnerSubscriber.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetManyRecurringPayments200ResponseResultInnerSubscriber</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetManyRecurringPayments200ResponseResultInnerSubscriber} obj Optional instance to populate.
     * @return {module:model/GetManyRecurringPayments200ResponseResultInnerSubscriber} The populated <code>GetManyRecurringPayments200ResponseResultInnerSubscriber</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetManyRecurringPayments200ResponseResultInnerSubscriber();
    ...
    /**
     * Validates the JSON data with respect to <code>GetManyRecurringPayments200ResponseResultInnerSubscriber</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetManyRecurringPayments200ResponseResultInnerSubscriber</code>.
     */
 ...
 * @member {String} email
 */
GetManyRecurringPayments200ResponseResultInnerSubscriber.prototype['email'] = undefined;

/**
 * @member {String} sub_partner_id
 */
GetManyRecurringPayments200ResponseResultInnerSubscriber.prototype['sub_partner_id'] = undefined;
...
export default GetManyRecurringPayments200ResponseResultInnerSubscriber;
