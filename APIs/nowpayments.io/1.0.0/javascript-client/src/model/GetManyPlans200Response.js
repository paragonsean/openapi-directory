...
import GetManyPlans200ResponseResultInner from './GetManyPlans200ResponseResultInner';

/**
 * The GetManyPlans200Response model module.
 * @module model/GetManyPlans200Response
 * @version 1.0.0
 */
class GetManyPlans200Response {
    /**
     * Constructs a new <code>GetManyPlans200Response</code>.
     * @alias module:model/GetManyPlans200Response
     */
    constructor() { 
        
        GetManyPlans200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetManyPlans200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetManyPlans200Response} obj Optional instance to populate.
     * @return {module:model/GetManyPlans200Response} The populated <code>GetManyPlans200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetManyPlans200Response();

            if (data.hasOwnProperty('count')) {
                obj['count'] = ApiClient.convertToType(data['count'], 'Number');
            }
            if (data.hasOwnProperty('result')) {
                obj['result'] = ApiClient.convertToType(data['result'], [GetManyPlans200ResponseResultInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetManyPlans200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetManyPlans200Response</code>.
     */
    static validateJSON(data) {
        if (data['result']) { // data not null
            ...
            for (const item of data['result']) {
                GetManyPlans200ResponseResultInner.validateJSON(item);
            };
        }
 ...
 * @member {Number} count
 */
GetManyPlans200Response.prototype['count'] = undefined;

/**
 * @member {Array.<module:model/GetManyPlans200ResponseResultInner>} result
 */
GetManyPlans200Response.prototype['result'] = undefined;
...
export default GetManyPlans200Response;
