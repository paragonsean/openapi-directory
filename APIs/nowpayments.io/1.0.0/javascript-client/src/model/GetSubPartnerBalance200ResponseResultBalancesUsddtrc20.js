...
/**
 * The GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 model module.
 * @module model/GetSubPartnerBalance200ResponseResultBalancesUsddtrc20
 * @version 1.0.0
 */
class GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 {
    /**
     * Constructs a new <code>GetSubPartnerBalance200ResponseResultBalancesUsddtrc20</code>.
     * @alias module:model/GetSubPartnerBalance200ResponseResultBalancesUsddtrc20
     */
    constructor() { 
        
        GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSubPartnerBalance200ResponseResultBalancesUsddtrc20</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSubPartnerBalance200ResponseResultBalancesUsddtrc20} obj Optional instance to populate.
     * @return {module:model/GetSubPartnerBalance200ResponseResultBalancesUsddtrc20} The populated <code>GetSubPartnerBalance200ResponseResultBalancesUsddtrc20</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSubPartnerBalance200ResponseResultBalancesUsddtrc20();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSubPartnerBalance200ResponseResultBalancesUsddtrc20</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSubPartnerBalance200ResponseResultBalancesUsddtrc20</code>.
     */
 ...
 */
GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.prototype['amount'] = undefined;

/**
 * @member {Number} pendingAmount
 */
GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.prototype['pendingAmount'] = undefined;
...
export default GetSubPartnerBalance200ResponseResultBalancesUsddtrc20;
