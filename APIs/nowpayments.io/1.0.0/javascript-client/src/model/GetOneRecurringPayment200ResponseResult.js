...
import GetOneRecurringPayment200ResponseResultSubscriber from './GetOneRecurringPayment200ResponseResultSubscriber';

/**
 * The GetOneRecurringPayment200ResponseResult model module.
 * @module model/GetOneRecurringPayment200ResponseResult
 * @version 1.0.0
 */
class GetOneRecurringPayment200ResponseResult {
    /**
     * Constructs a new <code>GetOneRecurringPayment200ResponseResult</code>.
     * @alias module:model/GetOneRecurringPayment200ResponseResult
     */
    constructor() { 
        
        GetOneRecurringPayment200ResponseResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOneRecurringPayment200ResponseResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOneRecurringPayment200ResponseResult} obj Optional instance to populate.
     * @return {module:model/GetOneRecurringPayment200ResponseResult} The populated <code>GetOneRecurringPayment200ResponseResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOneRecurringPayment200ResponseResult();
            ...
            if (data.hasOwnProperty('subscriber')) {
                obj['subscriber'] = GetOneRecurringPayment200ResponseResultSubscriber.constructFromObject(data['subscriber']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOneRecurringPayment200ResponseResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOneRecurringPayment200ResponseResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['subscriber']) { // data not null
          GetOneRecurringPayment200ResponseResultSubscriber.validateJSON(data['subscriber']);
        }
        // ensure the json data is a string
 ...
 */
GetOneRecurringPayment200ResponseResult.prototype['created_at'] = undefined;

/**
 * @member {String} expire_date
 */
GetOneRecurringPayment200ResponseResult.prototype['expire_date'] = undefined;

/**
 * @member {String} id
 */
GetOneRecurringPayment200ResponseResult.prototype['id'] = undefined;

/**
 * @member {Boolean} is_active
 */
GetOneRecurringPayment200ResponseResult.prototype['is_active'] = undefined;

/**
 * @member {String} status
 */
GetOneRecurringPayment200ResponseResult.prototype['status'] = undefined;

/**
 * @member {module:model/GetOneRecurringPayment200ResponseResultSubscriber} subscriber
 */
GetOneRecurringPayment200ResponseResult.prototype['subscriber'] = undefined;

/**
 * @member {String} subscription_plan_id
 */
GetOneRecurringPayment200ResponseResult.prototype['subscription_plan_id'] = undefined;

/**
 * @member {String} updated_at
 */
GetOneRecurringPayment200ResponseResult.prototype['updated_at'] = undefined;
...
export default GetOneRecurringPayment200ResponseResult;
