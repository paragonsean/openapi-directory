...
import GetListOfPayments200ResponseDataInner from './GetListOfPayments200ResponseDataInner';

/**
 * The GetListOfPayments200Response model module.
 * @module model/GetListOfPayments200Response
 * @version 1.0.0
 */
class GetListOfPayments200Response {
    /**
     * Constructs a new <code>GetListOfPayments200Response</code>.
     * @alias module:model/GetListOfPayments200Response
     */
    constructor() { 
        
        GetListOfPayments200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetListOfPayments200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetListOfPayments200Response} obj Optional instance to populate.
     * @return {module:model/GetListOfPayments200Response} The populated <code>GetListOfPayments200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetListOfPayments200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetListOfPayments200ResponseDataInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetListOfPayments200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetListOfPayments200Response</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                GetListOfPayments200ResponseDataInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/GetListOfPayments200ResponseDataInner>} data
 */
GetListOfPayments200Response.prototype['data'] = undefined;

/**
 * @member {Number} limit
 */
GetListOfPayments200Response.prototype['limit'] = undefined;

/**
 * @member {Number} page
 */
GetListOfPayments200Response.prototype['page'] = undefined;

/**
 * @member {Number} pagesCount
 */
GetListOfPayments200Response.prototype['pagesCount'] = undefined;

/**
 * @member {Number} total
 */
GetListOfPayments200Response.prototype['total'] = undefined;
...
export default GetListOfPayments200Response;
