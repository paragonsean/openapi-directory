...
/**
 * The GetUpdatePaymentEstimate200Response model module.
 * @module model/GetUpdatePaymentEstimate200Response
 * @version 1.0.0
 */
class GetUpdatePaymentEstimate200Response {
    /**
     * Constructs a new <code>GetUpdatePaymentEstimate200Response</code>.
     * @alias module:model/GetUpdatePaymentEstimate200Response
     */
    constructor() { 
        
        GetUpdatePaymentEstimate200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUpdatePaymentEstimate200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUpdatePaymentEstimate200Response} obj Optional instance to populate.
     * @return {module:model/GetUpdatePaymentEstimate200Response} The populated <code>GetUpdatePaymentEstimate200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUpdatePaymentEstimate200Response();

            if (data.hasOwnProperty('expiration_estimate_date')) {
                obj['expiration_estimate_date'] = ApiClient.convertToType(data['expiration_estimate_date'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetUpdatePaymentEstimate200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUpdatePaymentEstimate200Response</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['expiration_estimate_date'] && !(typeof data['expiration_estimate_date'] === 'string' || data['expiration_estimate_date'] instanceof String)) {
            throw new Error("Expected the field `expiration_estimate_date` to be a primitive type in the JSON string but got " + data['expiration_estimate_date']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} expiration_estimate_date
 */
GetUpdatePaymentEstimate200Response.prototype['expiration_estimate_date'] = undefined;

/**
 * @member {String} id
 */
GetUpdatePaymentEstimate200Response.prototype['id'] = undefined;

/**
 * @member {Number} pay_amount
 */
GetUpdatePaymentEstimate200Response.prototype['pay_amount'] = undefined;

/**
 * @member {String} token_id
 */
GetUpdatePaymentEstimate200Response.prototype['token_id'] = undefined;
...
export default GetUpdatePaymentEstimate200Response;
