...
/**
 * The GetOnePlan200ResponseResult model module.
 * @module model/GetOnePlan200ResponseResult
 * @version 1.0.0
 */
class GetOnePlan200ResponseResult {
    /**
     * Constructs a new <code>GetOnePlan200ResponseResult</code>.
     * @alias module:model/GetOnePlan200ResponseResult
     */
    constructor() { 
        
        GetOnePlan200ResponseResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOnePlan200ResponseResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOnePlan200ResponseResult} obj Optional instance to populate.
     * @return {module:model/GetOnePlan200ResponseResult} The populated <code>GetOnePlan200ResponseResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOnePlan200ResponseResult();

            if (data.hasOwnProperty('amount')) {
                obj['amount'] = ApiClient.convertToType(data['amount'], 'Number');
            }
            if (data.hasOwnProperty('cancel_url')) {
                obj['cancel_url'] = ApiClient.convertToType(data['cancel_url'], Object);
            }
            ...
            if (data.hasOwnProperty('interval_day')) {
                obj['interval_day'] = ApiClient.convertToType(data['interval_day'], 'String');
            }
            if (data.hasOwnProperty('ipn_callback_url')) {
                obj['ipn_callback_url'] = ApiClient.convertToType(data['ipn_callback_url'], Object);
            }
            if (data.hasOwnProperty('partially_paid_url')) {
                obj['partially_paid_url'] = ApiClient.convertToType(data['partially_paid_url'], Object);
            }
            if (data.hasOwnProperty('success_url')) {
                obj['success_url'] = ApiClient.convertToType(data['success_url'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOnePlan200ResponseResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOnePlan200ResponseResult</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['interval_day'] && !(typeof data['interval_day'] === 'string' || data['interval_day'] instanceof String)) {
            throw new Error("Expected the field `interval_day` to be a primitive type in the JSON string but got " + data['interval_day']);
        }
        // ensure the json data is a string
 ...
 */
GetOnePlan200ResponseResult.prototype['amount'] = undefined;

/**
 * @member {Object} cancel_url
 */
GetOnePlan200ResponseResult.prototype['cancel_url'] = undefined;

/**
 * @member {String} created_at
 */
GetOnePlan200ResponseResult.prototype['created_at'] = undefined;

/**
 * @member {String} currency
 */
GetOnePlan200ResponseResult.prototype['currency'] = undefined;

/**
 * @member {String} id
 */
GetOnePlan200ResponseResult.prototype['id'] = undefined;

/**
 * @member {String} interval_day
 */
GetOnePlan200ResponseResult.prototype['interval_day'] = undefined;

/**
 * @member {Object} ipn_callback_url
 */
GetOnePlan200ResponseResult.prototype['ipn_callback_url'] = undefined;

/**
 * @member {Object} partially_paid_url
 */
GetOnePlan200ResponseResult.prototype['partially_paid_url'] = undefined;

/**
 * @member {Object} success_url
 */
GetOnePlan200ResponseResult.prototype['success_url'] = undefined;

/**
 * @member {String} title
 */
GetOnePlan200ResponseResult.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
GetOnePlan200ResponseResult.prototype['updated_at'] = undefined;
...
export default GetOnePlan200ResponseResult;
