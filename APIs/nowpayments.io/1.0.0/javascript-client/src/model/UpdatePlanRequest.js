...
class UpdatePlanRequest {
    ...
    constructor() { 
        ...
        UpdatePlanRequest.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('interval_day')) {
                obj['interval_day'] = ApiClient.convertToType(data['interval_day'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePlanRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePlanRequest</code>.
     */
 ...
 */
UpdatePlanRequest.prototype['amount'] = undefined;

/**
 * @member {String} currency
 */
UpdatePlanRequest.prototype['currency'] = undefined;

/**
 * @member {Number} interval_day
 */
UpdatePlanRequest.prototype['interval_day'] = undefined;

/**
 * @member {String} title
 */
UpdatePlanRequest.prototype['title'] = undefined;
