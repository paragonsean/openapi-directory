...
import GetOnePlan200ResponseResult from './GetOnePlan200ResponseResult';

/**
 * The GetOnePlan200Response model module.
 * @module model/GetOnePlan200Response
 * @version 1.0.0
 */
class GetOnePlan200Response {
    /**
     * Constructs a new <code>GetOnePlan200Response</code>.
     * @alias module:model/GetOnePlan200Response
     */
    constructor() { 
        
        GetOnePlan200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOnePlan200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOnePlan200Response} obj Optional instance to populate.
     * @return {module:model/GetOnePlan200Response} The populated <code>GetOnePlan200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOnePlan200Response();

            if (data.hasOwnProperty('result')) {
                obj['result'] = GetOnePlan200ResponseResult.constructFromObject(data['result']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOnePlan200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOnePlan200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `result`
        if (data['result']) { // data not null
          GetOnePlan200ResponseResult.validateJSON(data['result']);
        }
...
/**
 * @member {module:model/GetOnePlan200ResponseResult} result
 */
GetOnePlan200Response.prototype['result'] = undefined;
...
export default GetOnePlan200Response;
