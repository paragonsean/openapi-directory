...
/**
 * The GetOneRecurringPayment404Response model module.
 * @module model/GetOneRecurringPayment404Response
 * @version 1.0.0
 */
class GetOneRecurringPayment404Response {
    /**
     * Constructs a new <code>GetOneRecurringPayment404Response</code>.
     * @alias module:model/GetOneRecurringPayment404Response
     */
    constructor() { 
        
        GetOneRecurringPayment404Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOneRecurringPayment404Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOneRecurringPayment404Response} obj Optional instance to populate.
     * @return {module:model/GetOneRecurringPayment404Response} The populated <code>GetOneRecurringPayment404Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOneRecurringPayment404Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetOneRecurringPayment404Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOneRecurringPayment404Response</code>.
     */
 ...
 * @member {String} code
 */
GetOneRecurringPayment404Response.prototype['code'] = undefined;

/**
 * @member {String} message
 */
GetOneRecurringPayment404Response.prototype['message'] = undefined;

/**
 * @member {Boolean} status
 */
GetOneRecurringPayment404Response.prototype['status'] = undefined;

/**
 * @member {Number} statusCode
 */
GetOneRecurringPayment404Response.prototype['statusCode'] = undefined;
...
export default GetOneRecurringPayment404Response;
