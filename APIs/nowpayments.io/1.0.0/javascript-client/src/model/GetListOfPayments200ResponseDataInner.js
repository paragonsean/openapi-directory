...
/**
 * The GetListOfPayments200ResponseDataInner model module.
 * @module model/GetListOfPayments200ResponseDataInner
 * @version 1.0.0
 */
class GetListOfPayments200ResponseDataInner {
    /**
     * Constructs a new <code>GetListOfPayments200ResponseDataInner</code>.
     * @alias module:model/GetListOfPayments200ResponseDataInner
     */
    constructor() { 
        
        GetListOfPayments200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetListOfPayments200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetListOfPayments200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/GetListOfPayments200ResponseDataInner} The populated <code>GetListOfPayments200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetListOfPayments200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetListOfPayments200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetListOfPayments200ResponseDataInner</code>.
     */
 ...
 */
GetListOfPayments200ResponseDataInner.prototype['actually_paid'] = undefined;

/**
 * @member {String} order_description
 */
GetListOfPayments200ResponseDataInner.prototype['order_description'] = undefined;

/**
 * @member {String} order_id
 */
GetListOfPayments200ResponseDataInner.prototype['order_id'] = undefined;

/**
 * @member {Number} outcome_amount
 */
GetListOfPayments200ResponseDataInner.prototype['outcome_amount'] = undefined;

/**
 * @member {String} outcome_currency
 */
GetListOfPayments200ResponseDataInner.prototype['outcome_currency'] = undefined;

/**
 * @member {String} pay_address
 */
GetListOfPayments200ResponseDataInner.prototype['pay_address'] = undefined;

/**
 * @member {Number} pay_amount
 */
GetListOfPayments200ResponseDataInner.prototype['pay_amount'] = undefined;

/**
 * @member {String} pay_currency
 */
GetListOfPayments200ResponseDataInner.prototype['pay_currency'] = undefined;

/**
 * @member {Number} payment_id
 */
GetListOfPayments200ResponseDataInner.prototype['payment_id'] = undefined;

/**
 * @member {String} payment_status
 */
GetListOfPayments200ResponseDataInner.prototype['payment_status'] = undefined;

/**
 * @member {Number} price_amount
 */
GetListOfPayments200ResponseDataInner.prototype['price_amount'] = undefined;

/**
 * @member {String} price_currency
 */
GetListOfPayments200ResponseDataInner.prototype['price_currency'] = undefined;

/**
 * @member {String} purchase_id
 */
GetListOfPayments200ResponseDataInner.prototype['purchase_id'] = undefined;
...
export default GetListOfPayments200ResponseDataInner;
