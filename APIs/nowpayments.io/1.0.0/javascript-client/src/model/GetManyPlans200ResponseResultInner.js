...
/**
 * The GetManyPlans200ResponseResultInner model module.
 * @module model/GetManyPlans200ResponseResultInner
 * @version 1.0.0
 */
class GetManyPlans200ResponseResultInner {
    /**
     * Constructs a new <code>GetManyPlans200ResponseResultInner</code>.
     * @alias module:model/GetManyPlans200ResponseResultInner
     */
    constructor() { 
        
        GetManyPlans200ResponseResultInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetManyPlans200ResponseResultInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetManyPlans200ResponseResultInner} obj Optional instance to populate.
     * @return {module:model/GetManyPlans200ResponseResultInner} The populated <code>GetManyPlans200ResponseResultInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetManyPlans200ResponseResultInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetManyPlans200ResponseResultInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetManyPlans200ResponseResultInner</code>.
     */
 ...
 */
GetManyPlans200ResponseResultInner.prototype['amount'] = undefined;

/**
 * @member {Object} cancel_url
 */
GetManyPlans200ResponseResultInner.prototype['cancel_url'] = undefined;

/**
 * @member {String} created_at
 */
GetManyPlans200ResponseResultInner.prototype['created_at'] = undefined;

/**
 * @member {String} currency
 */
GetManyPlans200ResponseResultInner.prototype['currency'] = undefined;

/**
 * @member {String} id
 */
GetManyPlans200ResponseResultInner.prototype['id'] = undefined;

/**
 * @member {String} interval_day
 */
GetManyPlans200ResponseResultInner.prototype['interval_day'] = undefined;

/**
 * @member {Object} ipn_callback_url
 */
GetManyPlans200ResponseResultInner.prototype['ipn_callback_url'] = undefined;

/**
 * @member {Object} partially_paid_url
 */
GetManyPlans200ResponseResultInner.prototype['partially_paid_url'] = undefined;

/**
 * @member {Object} success_url
 */
GetManyPlans200ResponseResultInner.prototype['success_url'] = undefined;

/**
 * @member {String} title
 */
GetManyPlans200ResponseResultInner.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
GetManyPlans200ResponseResultInner.prototype['updated_at'] = undefined;
...
export default GetManyPlans200ResponseResultInner;
