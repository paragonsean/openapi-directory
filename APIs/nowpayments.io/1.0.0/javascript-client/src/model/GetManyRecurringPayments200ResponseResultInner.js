...
import GetManyRecurringPayments200ResponseResultInnerSubscriber from './GetManyRecurringPayments200ResponseResultInnerSubscriber';

/**
 * The GetManyRecurringPayments200ResponseResultInner model module.
 * @module model/GetManyRecurringPayments200ResponseResultInner
 * @version 1.0.0
 */
class GetManyRecurringPayments200ResponseResultInner {
    /**
     * Constructs a new <code>GetManyRecurringPayments200ResponseResultInner</code>.
     * @alias module:model/GetManyRecurringPayments200ResponseResultInner
     */
    constructor() { 
        
        GetManyRecurringPayments200ResponseResultInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetManyRecurringPayments200ResponseResultInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetManyRecurringPayments200ResponseResultInner} obj Optional instance to populate.
     * @return {module:model/GetManyRecurringPayments200ResponseResultInner} The populated <code>GetManyRecurringPayments200ResponseResultInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetManyRecurringPayments200ResponseResultInner();
            ...
            if (data.hasOwnProperty('subscriber')) {
                obj['subscriber'] = GetManyRecurringPayments200ResponseResultInnerSubscriber.constructFromObject(data['subscriber']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetManyRecurringPayments200ResponseResultInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetManyRecurringPayments200ResponseResultInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['subscriber']) { // data not null
          GetManyRecurringPayments200ResponseResultInnerSubscriber.validateJSON(data['subscriber']);
        }
        // ensure the json data is a string
 ...
 */
GetManyRecurringPayments200ResponseResultInner.prototype['created_at'] = undefined;

/**
 * @member {String} expire_date
 */
GetManyRecurringPayments200ResponseResultInner.prototype['expire_date'] = undefined;

/**
 * @member {String} id
 */
GetManyRecurringPayments200ResponseResultInner.prototype['id'] = undefined;

/**
 * @member {Boolean} is_active
 */
GetManyRecurringPayments200ResponseResultInner.prototype['is_active'] = undefined;

/**
 * @member {String} status
 */
GetManyRecurringPayments200ResponseResultInner.prototype['status'] = undefined;

/**
 * @member {module:model/GetManyRecurringPayments200ResponseResultInnerSubscriber} subscriber
 */
GetManyRecurringPayments200ResponseResultInner.prototype['subscriber'] = undefined;

/**
 * @member {String} subscription_plan_id
 */
GetManyRecurringPayments200ResponseResultInner.prototype['subscription_plan_id'] = undefined;

/**
 * @member {String} updated_at
 */
GetManyRecurringPayments200ResponseResultInner.prototype['updated_at'] = undefined;
...
export default GetManyRecurringPayments200ResponseResultInner;
