...
/**
 * The GetOneRecurringPayment200ResponseResultSubscriber model module.
 * @module model/GetOneRecurringPayment200ResponseResultSubscriber
 * @version 1.0.0
 */
class GetOneRecurringPayment200ResponseResultSubscriber {
    /**
     * Constructs a new <code>GetOneRecurringPayment200ResponseResultSubscriber</code>.
     * @alias module:model/GetOneRecurringPayment200ResponseResultSubscriber
     */
    constructor() { 
        
        GetOneRecurringPayment200ResponseResultSubscriber.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOneRecurringPayment200ResponseResultSubscriber</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOneRecurringPayment200ResponseResultSubscriber} obj Optional instance to populate.
     * @return {module:model/GetOneRecurringPayment200ResponseResultSubscriber} The populated <code>GetOneRecurringPayment200ResponseResultSubscriber</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOneRecurringPayment200ResponseResultSubscriber();

            if (data.hasOwnProperty('sub_partner_id')) {
                obj['sub_partner_id'] = ApiClient.convertToType(data['sub_partner_id'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOneRecurringPayment200ResponseResultSubscriber</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOneRecurringPayment200ResponseResultSubscriber</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['sub_partner_id'] && !(typeof data['sub_partner_id'] === 'string' || data['sub_partner_id'] instanceof String)) {
            throw new Error("Expected the field `sub_partner_id` to be a primitive type in the JSON string but got " + data['sub_partner_id']);
        }
...
/**
 * @member {String} sub_partner_id
 */
GetOneRecurringPayment200ResponseResultSubscriber.prototype['sub_partner_id'] = undefined;
...
export default GetOneRecurringPayment200ResponseResultSubscriber;
