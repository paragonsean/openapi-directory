...
import GetAllTransfers200ResponseResultInner from './GetAllTransfers200ResponseResultInner';

/**
 * The GetAllTransfers200Response model module.
 * @module model/GetAllTransfers200Response
 * @version 1.0.0
 */
class GetAllTransfers200Response {
    /**
     * Constructs a new <code>GetAllTransfers200Response</code>.
     * @alias module:model/GetAllTransfers200Response
     */
    constructor() { 
        
        GetAllTransfers200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAllTransfers200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAllTransfers200Response} obj Optional instance to populate.
     * @return {module:model/GetAllTransfers200Response} The populated <code>GetAllTransfers200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAllTransfers200Response();

            if (data.hasOwnProperty('count')) {
                obj['count'] = ApiClient.convertToType(data['count'], 'Number');
            }
            if (data.hasOwnProperty('result')) {
                obj['result'] = ApiClient.convertToType(data['result'], [GetAllTransfers200ResponseResultInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAllTransfers200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAllTransfers200Response</code>.
     */
    static validateJSON(data) {
        if (data['result']) { // data not null
            ...
            for (const item of data['result']) {
                GetAllTransfers200ResponseResultInner.validateJSON(item);
            };
        }
 ...
 * @member {Number} count
 */
GetAllTransfers200Response.prototype['count'] = undefined;

/**
 * @member {Array.<module:model/GetAllTransfers200ResponseResultInner>} result
 */
GetAllTransfers200Response.prototype['result'] = undefined;
...
export default GetAllTransfers200Response;
