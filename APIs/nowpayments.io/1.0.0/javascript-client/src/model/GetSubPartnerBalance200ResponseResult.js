...
import GetSubPartnerBalance200ResponseResultBalances from './GetSubPartnerBalance200ResponseResultBalances';

/**
 * The GetSubPartnerBalance200ResponseResult model module.
 * @module model/GetSubPartnerBalance200ResponseResult
 * @version 1.0.0
 */
class GetSubPartnerBalance200ResponseResult {
    /**
     * Constructs a new <code>GetSubPartnerBalance200ResponseResult</code>.
     * @alias module:model/GetSubPartnerBalance200ResponseResult
     */
    constructor() { 
        
        GetSubPartnerBalance200ResponseResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSubPartnerBalance200ResponseResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSubPartnerBalance200ResponseResult} obj Optional instance to populate.
     * @return {module:model/GetSubPartnerBalance200ResponseResult} The populated <code>GetSubPartnerBalance200ResponseResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSubPartnerBalance200ResponseResult();

            if (data.hasOwnProperty('balances')) {
                obj['balances'] = GetSubPartnerBalance200ResponseResultBalances.constructFromObject(data['balances']);
            }
            if (data.hasOwnProperty('subPartnerId')) {
                obj['subPartnerId'] = ApiClient.convertToType(data['subPartnerId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSubPartnerBalance200ResponseResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSubPartnerBalance200ResponseResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `balances`
        if (data['balances']) { // data not null
          GetSubPartnerBalance200ResponseResultBalances.validateJSON(data['balances']);
        }
        // ensure the json data is a string
        if (data['subPartnerId'] && !(typeof data['subPartnerId'] === 'string' || data['subPartnerId'] instanceof String)) {
            throw new Error("Expected the field `subPartnerId` to be a primitive type in the JSON string but got " + data['subPartnerId']);
        }
...
/**
 * @member {module:model/GetSubPartnerBalance200ResponseResultBalances} balances
 */
GetSubPartnerBalance200ResponseResult.prototype['balances'] = undefined;

/**
 * @member {String} subPartnerId
 */
GetSubPartnerBalance200ResponseResult.prototype['subPartnerId'] = undefined;
...
export default GetSubPartnerBalance200ResponseResult;
