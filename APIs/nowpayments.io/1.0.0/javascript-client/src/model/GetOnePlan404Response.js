...
/**
 * The GetOnePlan404Response model module.
 * @module model/GetOnePlan404Response
 * @version 1.0.0
 */
class GetOnePlan404Response {
    /**
     * Constructs a new <code>GetOnePlan404Response</code>.
     * @alias module:model/GetOnePlan404Response
     */
    constructor() { 
        
        GetOnePlan404Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOnePlan404Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOnePlan404Response} obj Optional instance to populate.
     * @return {module:model/GetOnePlan404Response} The populated <code>GetOnePlan404Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOnePlan404Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetOnePlan404Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOnePlan404Response</code>.
     */
 ...
 * @member {String} code
 */
GetOnePlan404Response.prototype['code'] = undefined;

/**
 * @member {String} message
 */
GetOnePlan404Response.prototype['message'] = undefined;

/**
 * @member {Boolean} status
 */
GetOnePlan404Response.prototype['status'] = undefined;

/**
 * @member {Number} statusCode
 */
GetOnePlan404Response.prototype['statusCode'] = undefined;
...
export default GetOnePlan404Response;
