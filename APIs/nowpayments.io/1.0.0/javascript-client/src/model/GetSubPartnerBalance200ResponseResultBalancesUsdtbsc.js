...
/**
 * The GetSubPartnerBalance200ResponseResultBalancesUsdtbsc model module.
 * @module model/GetSubPartnerBalance200ResponseResultBalancesUsdtbsc
 * @version 1.0.0
 */
class GetSubPartnerBalance200ResponseResultBalancesUsdtbsc {
    /**
     * Constructs a new <code>GetSubPartnerBalance200ResponseResultBalancesUsdtbsc</code>.
     * @alias module:model/GetSubPartnerBalance200ResponseResultBalancesUsdtbsc
     */
    constructor() { 
        
        GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSubPartnerBalance200ResponseResultBalancesUsdtbsc</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSubPartnerBalance200ResponseResultBalancesUsdtbsc} obj Optional instance to populate.
     * @return {module:model/GetSubPartnerBalance200ResponseResultBalancesUsdtbsc} The populated <code>GetSubPartnerBalance200ResponseResultBalancesUsdtbsc</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSubPartnerBalance200ResponseResultBalancesUsdtbsc();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSubPartnerBalance200ResponseResultBalancesUsdtbsc</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSubPartnerBalance200ResponseResultBalancesUsdtbsc</code>.
     */
 ...
 */
GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.prototype['amount'] = undefined;

/**
 * @member {Number} pendingAmount
 */
GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.prototype['pendingAmount'] = undefined;
...
export default GetSubPartnerBalance200ResponseResultBalancesUsdtbsc;
