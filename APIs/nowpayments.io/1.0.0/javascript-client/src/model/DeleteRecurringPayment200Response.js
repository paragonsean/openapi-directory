...
/**
 * The DeleteRecurringPayment200Response model module.
 * @module model/DeleteRecurringPayment200Response
 * @version 1.0.0
 */
class DeleteRecurringPayment200Response {
    /**
     * Constructs a new <code>DeleteRecurringPayment200Response</code>.
     * @alias module:model/DeleteRecurringPayment200Response
     */
    constructor() { 
        
        DeleteRecurringPayment200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteRecurringPayment200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRecurringPayment200Response} obj Optional instance to populate.
     * @return {module:model/DeleteRecurringPayment200Response} The populated <code>DeleteRecurringPayment200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRecurringPayment200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRecurringPayment200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRecurringPayment200Response</code>.
     */
 ...
 */
DeleteRecurringPayment200Response.prototype['result'] = undefined;
...
export default DeleteRecurringPayment200Response;
