...
/**
 * The GetEstimatedPrice200Response model module.
 * @module model/GetEstimatedPrice200Response
 * @version 1.0.0
 */
class GetEstimatedPrice200Response {
    /**
     * Constructs a new <code>GetEstimatedPrice200Response</code>.
     * @alias module:model/GetEstimatedPrice200Response
     */
    constructor() { 
        
        GetEstimatedPrice200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEstimatedPrice200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetEstimatedPrice200Response} obj Optional instance to populate.
     * @return {module:model/GetEstimatedPrice200Response} The populated <code>GetEstimatedPrice200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEstimatedPrice200Response();
            ...
            if (data.hasOwnProperty('estimated_amount')) {
                obj['estimated_amount'] = ApiClient.convertToType(data['estimated_amount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEstimatedPrice200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEstimatedPrice200Response</code>.
     */
 ...
 */
GetEstimatedPrice200Response.prototype['amount_from'] = undefined;

/**
 * @member {String} currency_from
 */
GetEstimatedPrice200Response.prototype['currency_from'] = undefined;

/**
 * @member {String} currency_to
 */
GetEstimatedPrice200Response.prototype['currency_to'] = undefined;

/**
 * @member {Number} estimated_amount
 */
GetEstimatedPrice200Response.prototype['estimated_amount'] = undefined;
...
export default GetEstimatedPrice200Response;
