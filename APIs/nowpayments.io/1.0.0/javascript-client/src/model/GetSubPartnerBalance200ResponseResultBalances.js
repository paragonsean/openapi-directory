...
import GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 from './GetSubPartnerBalance200ResponseResultBalancesUsddtrc20';
import GetSubPartnerBalance200ResponseResultBalancesUsdtbsc from './GetSubPartnerBalance200ResponseResultBalancesUsdtbsc';

/**
 * The GetSubPartnerBalance200ResponseResultBalances model module.
 * @module model/GetSubPartnerBalance200ResponseResultBalances
 * @version 1.0.0
 */
class GetSubPartnerBalance200ResponseResultBalances {
    /**
     * Constructs a new <code>GetSubPartnerBalance200ResponseResultBalances</code>.
     * @alias module:model/GetSubPartnerBalance200ResponseResultBalances
     */
    constructor() { 
        
        GetSubPartnerBalance200ResponseResultBalances.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSubPartnerBalance200ResponseResultBalances</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSubPartnerBalance200ResponseResultBalances} obj Optional instance to populate.
     * @return {module:model/GetSubPartnerBalance200ResponseResultBalances} The populated <code>GetSubPartnerBalance200ResponseResultBalances</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSubPartnerBalance200ResponseResultBalances();

            if (data.hasOwnProperty('usddtrc20')) {
                obj['usddtrc20'] = GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.constructFromObject(data['usddtrc20']);
            }
            if (data.hasOwnProperty('usdtbsc')) {
                obj['usdtbsc'] = GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.constructFromObject(data['usdtbsc']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSubPartnerBalance200ResponseResultBalances</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSubPartnerBalance200ResponseResultBalances</code>.
     */
    static validateJSON(data) {
        // validate the optional field `usddtrc20`
        if (data['usddtrc20']) { // data not null
          GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.validateJSON(data['usddtrc20']);
        }
        // validate the optional field `usdtbsc`
        if (data['usdtbsc']) { // data not null
          GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.validateJSON(data['usdtbsc']);
        }
...
/**
 * @member {module:model/GetSubPartnerBalance200ResponseResultBalancesUsddtrc20} usddtrc20
 */
GetSubPartnerBalance200ResponseResultBalances.prototype['usddtrc20'] = undefined;

/**
 * @member {module:model/GetSubPartnerBalance200ResponseResultBalancesUsdtbsc} usdtbsc
 */
GetSubPartnerBalance200ResponseResultBalances.prototype['usdtbsc'] = undefined;
...
export default GetSubPartnerBalance200ResponseResultBalances;
