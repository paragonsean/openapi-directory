...
import GetManyRecurringPayments200ResponseResultInner from './GetManyRecurringPayments200ResponseResultInner';

/**
 * The GetManyRecurringPayments200Response model module.
 * @module model/GetManyRecurringPayments200Response
 * @version 1.0.0
 */
class GetManyRecurringPayments200Response {
    /**
     * Constructs a new <code>GetManyRecurringPayments200Response</code>.
     * @alias module:model/GetManyRecurringPayments200Response
     */
    constructor() { 
        
        GetManyRecurringPayments200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetManyRecurringPayments200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetManyRecurringPayments200Response} obj Optional instance to populate.
     * @return {module:model/GetManyRecurringPayments200Response} The populated <code>GetManyRecurringPayments200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetManyRecurringPayments200Response();

            if (data.hasOwnProperty('count')) {
                obj['count'] = ApiClient.convertToType(data['count'], 'Number');
            }
            if (data.hasOwnProperty('result')) {
                obj['result'] = ApiClient.convertToType(data['result'], [GetManyRecurringPayments200ResponseResultInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetManyRecurringPayments200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetManyRecurringPayments200Response</code>.
     */
    static validateJSON(data) {
        if (data['result']) { // data not null
            ...
            for (const item of data['result']) {
                GetManyRecurringPayments200ResponseResultInner.validateJSON(item);
            };
        }
 ...
 * @member {Number} count
 */
GetManyRecurringPayments200Response.prototype['count'] = undefined;

/**
 * @member {Array.<module:model/GetManyRecurringPayments200ResponseResultInner>} result
 */
GetManyRecurringPayments200Response.prototype['result'] = undefined;
...
export default GetManyRecurringPayments200Response;
