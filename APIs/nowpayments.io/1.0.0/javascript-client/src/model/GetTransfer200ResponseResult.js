...
/**
 * The GetTransfer200ResponseResult model module.
 * @module model/GetTransfer200ResponseResult
 * @version 1.0.0
 */
class GetTransfer200ResponseResult {
    /**
     * Constructs a new <code>GetTransfer200ResponseResult</code>.
     * @alias module:model/GetTransfer200ResponseResult
     */
    constructor() { 
        
        GetTransfer200ResponseResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTransfer200ResponseResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTransfer200ResponseResult} obj Optional instance to populate.
     * @return {module:model/GetTransfer200ResponseResult} The populated <code>GetTransfer200ResponseResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTransfer200ResponseResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransfer200ResponseResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransfer200ResponseResult</code>.
     */
 ...
 */
GetTransfer200ResponseResult.prototype['amount'] = undefined;

/**
 * @member {String} created_at
 */
GetTransfer200ResponseResult.prototype['created_at'] = undefined;

/**
 * @member {String} currency
 */
GetTransfer200ResponseResult.prototype['currency'] = undefined;

/**
 * @member {String} from_sub_id
 */
GetTransfer200ResponseResult.prototype['from_sub_id'] = undefined;

/**
 * @member {String} id
 */
GetTransfer200ResponseResult.prototype['id'] = undefined;

/**
 * @member {String} status
 */
GetTransfer200ResponseResult.prototype['status'] = undefined;

/**
 * @member {String} to_sub_id
 */
GetTransfer200ResponseResult.prototype['to_sub_id'] = undefined;

/**
 * @member {String} updated_at
 */
GetTransfer200ResponseResult.prototype['updated_at'] = undefined;
...
export default GetTransfer200ResponseResult;
