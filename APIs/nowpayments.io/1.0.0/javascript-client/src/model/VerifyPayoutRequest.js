...
/**
 * The VerifyPayoutRequest model module.
 * @module model/VerifyPayoutRequest
 * @version 1.0.0
 */
class VerifyPayoutRequest {
    /**
     * Constructs a new <code>VerifyPayoutRequest</code>.
     * @alias module:model/VerifyPayoutRequest
     */
    constructor() { 
        
        VerifyPayoutRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VerifyPayoutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VerifyPayoutRequest} obj Optional instance to populate.
     * @return {module:model/VerifyPayoutRequest} The populated <code>VerifyPayoutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VerifyPayoutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>VerifyPayoutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VerifyPayoutRequest</code>.
     */
 ...
 */
VerifyPayoutRequest.prototype['verification_code'] = undefined;
...
export default VerifyPayoutRequest;
