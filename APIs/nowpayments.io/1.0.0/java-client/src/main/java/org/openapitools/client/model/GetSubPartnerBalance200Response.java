...
import org.openapitools.client.model.GetSubPartnerBalance200ResponseResult;
...
public class GetSubPartnerBalance200Response {
  public static final String SERIALIZED_NAME_RESULT = "result";
  @SerializedName(SERIALIZED_NAME_RESULT)
  private GetSubPartnerBalance200ResponseResult result;

  public GetSubPartnerBalance200Response() {
  }

  public GetSubPartnerBalance200Response result(GetSubPartnerBalance200ResponseResult result) {
    this.result = result;
    return this;
  }
  ...
  public GetSubPartnerBalance200ResponseResult getResult() {
    return result;
  }

  public void setResult(GetSubPartnerBalance200ResponseResult result) {
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetSubPartnerBalance200Response getSubPartnerBalance200Response = (GetSubPartnerBalance200Response) o;
    return Objects.equals(this.result, getSubPartnerBalance200Response.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSubPartnerBalance200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSubPartnerBalance200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSubPartnerBalance200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSubPartnerBalance200Response is not found in the empty JSON string", GetSubPartnerBalance200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSubPartnerBalance200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSubPartnerBalance200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `result`
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        GetSubPartnerBalance200ResponseResult.validateJsonElement(jsonObj.get("result"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSubPartnerBalance200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSubPartnerBalance200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSubPartnerBalance200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSubPartnerBalance200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSubPartnerBalance200Response>() {
           @Override
           public void write(JsonWriter out, GetSubPartnerBalance200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSubPartnerBalance200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSubPartnerBalance200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSubPartnerBalance200Response
   * @throws IOException if the JSON string is invalid with respect to GetSubPartnerBalance200Response
   */
  public static GetSubPartnerBalance200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSubPartnerBalance200Response.class);
  }

  /**
   * Convert an instance of GetSubPartnerBalance200Response to an JSON string
   *
   * @return JSON string
   */
