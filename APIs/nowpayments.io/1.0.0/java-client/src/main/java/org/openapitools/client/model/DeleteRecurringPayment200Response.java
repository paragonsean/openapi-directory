...
public class DeleteRecurringPayment200Response {
  public static final String SERIALIZED_NAME_RESULT = "result";
  @SerializedName(SERIALIZED_NAME_RESULT)
  private String result;

  public DeleteRecurringPayment200Response() {
  }

  public DeleteRecurringPayment200Response result(String result) {
    this.result = result;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteRecurringPayment200Response deleteRecurringPayment200Response = (DeleteRecurringPayment200Response) o;
    return Objects.equals(this.result, deleteRecurringPayment200Response.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRecurringPayment200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRecurringPayment200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRecurringPayment200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRecurringPayment200Response is not found in the empty JSON string", DeleteRecurringPayment200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRecurringPayment200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRecurringPayment200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRecurringPayment200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRecurringPayment200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRecurringPayment200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRecurringPayment200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRecurringPayment200Response>() {
           @Override
           public void write(JsonWriter out, DeleteRecurringPayment200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRecurringPayment200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRecurringPayment200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRecurringPayment200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteRecurringPayment200Response
   */
  public static DeleteRecurringPayment200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRecurringPayment200Response.class);
  }

  /**
   * Convert an instance of DeleteRecurringPayment200Response to an JSON string
   *
   * @return JSON string
   */
