...
public class GetEstimatedPrice200Response {
  ...
  public static final String SERIALIZED_NAME_ESTIMATED_AMOUNT = "estimated_amount";
  @SerializedName(SERIALIZED_NAME_ESTIMATED_AMOUNT)
  private BigDecimal estimatedAmount;

  public GetEstimatedPrice200Response() {
  }

  public GetEstimatedPrice200Response amountFrom(BigDecimal amountFrom) {
  ...
  public GetEstimatedPrice200Response currencyFrom(String currencyFrom) {
  ...
  public GetEstimatedPrice200Response currencyTo(String currencyTo) {
  ...
  public GetEstimatedPrice200Response estimatedAmount(BigDecimal estimatedAmount) {
  ...
  public boolean equals(Object o) {
    ...
    GetEstimatedPrice200Response getEstimatedPrice200Response = (GetEstimatedPrice200Response) o;
    return Objects.equals(this.amountFrom, getEstimatedPrice200Response.amountFrom) &&
        Objects.equals(this.currencyFrom, getEstimatedPrice200Response.currencyFrom) &&
        Objects.equals(this.currencyTo, getEstimatedPrice200Response.currencyTo) &&
        Objects.equals(this.estimatedAmount, getEstimatedPrice200Response.estimatedAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amountFrom, currencyFrom, currencyTo, estimatedAmount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetEstimatedPrice200Response {\n");
  ...
  static {
    ...
    openapiFields.add("estimated_amount");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEstimatedPrice200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEstimatedPrice200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEstimatedPrice200Response is not found in the empty JSON string", GetEstimatedPrice200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEstimatedPrice200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEstimatedPrice200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEstimatedPrice200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEstimatedPrice200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEstimatedPrice200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEstimatedPrice200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEstimatedPrice200Response>() {
           @Override
           public void write(JsonWriter out, GetEstimatedPrice200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEstimatedPrice200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEstimatedPrice200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEstimatedPrice200Response
   * @throws IOException if the JSON string is invalid with respect to GetEstimatedPrice200Response
   */
  public static GetEstimatedPrice200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEstimatedPrice200Response.class);
  }

  /**
   * Convert an instance of GetEstimatedPrice200Response to an JSON string
   *
   * @return JSON string
   */
