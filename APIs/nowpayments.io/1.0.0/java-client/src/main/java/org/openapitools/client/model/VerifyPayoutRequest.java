...
public class VerifyPayoutRequest {
  ...
  public VerifyPayoutRequest() {
  }

  public VerifyPayoutRequest verificationCode(String verificationCode) {
  ...
  public boolean equals(Object o) {
    ...
    VerifyPayoutRequest verifyPayoutRequest = (VerifyPayoutRequest) o;
    return Objects.equals(this.verificationCode, verifyPayoutRequest.verificationCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class VerifyPayoutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifyPayoutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyPayoutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerifyPayoutRequest is not found in the empty JSON string", VerifyPayoutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyPayoutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerifyPayoutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifyPayoutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifyPayoutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifyPayoutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifyPayoutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifyPayoutRequest>() {
           @Override
           public void write(JsonWriter out, VerifyPayoutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifyPayoutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifyPayoutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifyPayoutRequest
   * @throws IOException if the JSON string is invalid with respect to VerifyPayoutRequest
   */
  public static VerifyPayoutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifyPayoutRequest.class);
  }

  /**
   * Convert an instance of VerifyPayoutRequest to an JSON string
   *
   * @return JSON string
   */
