...
public class GetOnePlan200ResponseResult {
  ...
  public GetOnePlan200ResponseResult() {
  }

  public GetOnePlan200ResponseResult amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public GetOnePlan200ResponseResult cancelUrl(Object cancelUrl) {
  ...
  public GetOnePlan200ResponseResult createdAt(String createdAt) {
  ...
  public GetOnePlan200ResponseResult currency(String currency) {
  ...
  public GetOnePlan200ResponseResult id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetOnePlan200ResponseResult intervalDay(String intervalDay) {
  ...
  public GetOnePlan200ResponseResult ipnCallbackUrl(Object ipnCallbackUrl) {
  ...
  public GetOnePlan200ResponseResult partiallyPaidUrl(Object partiallyPaidUrl) {
  ...
  public GetOnePlan200ResponseResult successUrl(Object successUrl) {
  ...
  public GetOnePlan200ResponseResult title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GetOnePlan200ResponseResult updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    GetOnePlan200ResponseResult getOnePlan200ResponseResult = (GetOnePlan200ResponseResult) o;
    return Objects.equals(this.amount, getOnePlan200ResponseResult.amount) &&
        Objects.equals(this.cancelUrl, getOnePlan200ResponseResult.cancelUrl) &&
        Objects.equals(this.createdAt, getOnePlan200ResponseResult.createdAt) &&
        Objects.equals(this.currency, getOnePlan200ResponseResult.currency) &&
        Objects.equals(this.id, getOnePlan200ResponseResult.id) &&
        Objects.equals(this.intervalDay, getOnePlan200ResponseResult.intervalDay) &&
        Objects.equals(this.ipnCallbackUrl, getOnePlan200ResponseResult.ipnCallbackUrl) &&
        Objects.equals(this.partiallyPaidUrl, getOnePlan200ResponseResult.partiallyPaidUrl) &&
        Objects.equals(this.successUrl, getOnePlan200ResponseResult.successUrl) &&
        Objects.equals(this.title, getOnePlan200ResponseResult.title) &&
        Objects.equals(this.updatedAt, getOnePlan200ResponseResult.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOnePlan200ResponseResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOnePlan200ResponseResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOnePlan200ResponseResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOnePlan200ResponseResult is not found in the empty JSON string", GetOnePlan200ResponseResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOnePlan200ResponseResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOnePlan200ResponseResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOnePlan200ResponseResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOnePlan200ResponseResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOnePlan200ResponseResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOnePlan200ResponseResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOnePlan200ResponseResult>() {
           @Override
           public void write(JsonWriter out, GetOnePlan200ResponseResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOnePlan200ResponseResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOnePlan200ResponseResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOnePlan200ResponseResult
   * @throws IOException if the JSON string is invalid with respect to GetOnePlan200ResponseResult
   */
  public static GetOnePlan200ResponseResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOnePlan200ResponseResult.class);
  }

  /**
   * Convert an instance of GetOnePlan200ResponseResult to an JSON string
   *
   * @return JSON string
   */
