...
import org.openapitools.client.model.VerifyPayoutRequest;
...
public class PayoutsApiApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PayoutsApiApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PayoutsApiApi(ApiClient apiClient) {
    ...
    /**
     * Build call for verifyPayout
     * @param withdrawalsId  (required)
     * @param xApiKey  (optional)
     * @param verifyPayoutRequest  (optional)
     ...
     */
    public okhttp3.Call verifyPayoutCall(String withdrawalsId, String xApiKey, VerifyPayoutRequest verifyPayoutRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = verifyPayoutRequest;

        // create path and map variables
        String localVarPath = "/v1/payout/{withdrawals-id}/verify"
            .replace("{" + "withdrawals-id" + "}", localVarApiClient.escapeString(withdrawalsId.toString()));
    ...
    private okhttp3.Call verifyPayoutValidateBeforeCall(String withdrawalsId, String xApiKey, VerifyPayoutRequest verifyPayoutRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'withdrawalsId' is set
        if (withdrawalsId == null) {
            throw new ApiException("Missing the required parameter 'withdrawalsId' when calling verifyPayout(Async)");
        }

        return verifyPayoutCall(withdrawalsId, xApiKey, verifyPayoutRequest, _callback);
     ...
     */
    public void verifyPayout(String withdrawalsId, String xApiKey, VerifyPayoutRequest verifyPayoutRequest) throws ApiException {
        verifyPayoutWithHttpInfo(withdrawalsId, xApiKey, verifyPayoutRequest);
    }
     ...
     */
    public ApiResponse<Void> verifyPayoutWithHttpInfo(String withdrawalsId, String xApiKey, VerifyPayoutRequest verifyPayoutRequest) throws ApiException {
        okhttp3.Call localVarCall = verifyPayoutValidateBeforeCall(withdrawalsId, xApiKey, verifyPayoutRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Verify payout (asynchronously)
     * This method is required to verify payouts by using your 2fa code.   You’ll have 10 attempts to verify the payout. If it is not verified after 10 attempts, the payout will remain in ‘creating’ status.   Payout will be processed only when it is verified.  Make sure to have your 2fa authentication enabled in your NOWPayments Account (in Account Settings).   When 2fa is disabled, the code automatically goes to your registration email.   The code sent by email is valid for one hour.  Next is a description of the required request fields:  - :batch-withdrawal-id - payout id you received in &#x60;2. Create payout&#x60; method - verification_code - 2fa code you received with your Google Auth app or via email       In order to establish an automatic verification of payouts, you should switch 2FA through the application.   There are several libraries for different frameworks aimed on generating a 2FA codes based on a secret key from your account settings.   e.g: Speakeasy for JavaScript.   We do not recommend to change any default settings.    &#x60;&#x60;&#x60; const 2faVerificationCode &#x3D; speakeasy.totp({       your_2fa_secret_key,       encoding: &#39;base32&#39;, }) &#x60;&#x60;&#x60;
     * @param withdrawalsId  (required)
     * @param xApiKey  (optional)
     * @param verifyPayoutRequest  (optional)
     ...
     */
    public okhttp3.Call verifyPayoutAsync(String withdrawalsId, String xApiKey, VerifyPayoutRequest verifyPayoutRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifyPayoutValidateBeforeCall(withdrawalsId, xApiKey, verifyPayoutRequest, _callback);
