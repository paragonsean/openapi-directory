...
public class GetUpdatePaymentEstimate200Response {
  public static final String SERIALIZED_NAME_EXPIRATION_ESTIMATE_DATE = "expiration_estimate_date";
  @SerializedName(SERIALIZED_NAME_EXPIRATION_ESTIMATE_DATE)
  ...
  public GetUpdatePaymentEstimate200Response() {
  }

  public GetUpdatePaymentEstimate200Response expirationEstimateDate(String expirationEstimateDate) {
    this.expirationEstimateDate = expirationEstimateDate;
    return this;
  }

  /**
   * Get expirationEstimateDate
   * @return expirationEstimateDate
   */
  @javax.annotation.Nullable
  public String getExpirationEstimateDate() {
    return expirationEstimateDate;
  }

  public void setExpirationEstimateDate(String expirationEstimateDate) {
    this.expirationEstimateDate = expirationEstimateDate;
  }


  public GetUpdatePaymentEstimate200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetUpdatePaymentEstimate200Response payAmount(BigDecimal payAmount) {
  ...
  public GetUpdatePaymentEstimate200Response tokenId(String tokenId) {
  ...
  public boolean equals(Object o) {
    ...
    GetUpdatePaymentEstimate200Response getUpdatePaymentEstimate200Response = (GetUpdatePaymentEstimate200Response) o;
    return Objects.equals(this.expirationEstimateDate, getUpdatePaymentEstimate200Response.expirationEstimateDate) &&
        Objects.equals(this.id, getUpdatePaymentEstimate200Response.id) &&
        Objects.equals(this.payAmount, getUpdatePaymentEstimate200Response.payAmount) &&
        Objects.equals(this.tokenId, getUpdatePaymentEstimate200Response.tokenId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expirationEstimateDate, id, payAmount, tokenId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetUpdatePaymentEstimate200Response {\n");
    sb.append("    expirationEstimateDate: ").append(toIndentedString(expirationEstimateDate)).append("\n");
  ...
  static {
    ...
    openapiFields.add("expiration_estimate_date");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUpdatePaymentEstimate200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUpdatePaymentEstimate200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUpdatePaymentEstimate200Response is not found in the empty JSON string", GetUpdatePaymentEstimate200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUpdatePaymentEstimate200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUpdatePaymentEstimate200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("expiration_estimate_date") != null && !jsonObj.get("expiration_estimate_date").isJsonNull()) && !jsonObj.get("expiration_estimate_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `expiration_estimate_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("expiration_estimate_date").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUpdatePaymentEstimate200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUpdatePaymentEstimate200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUpdatePaymentEstimate200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUpdatePaymentEstimate200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUpdatePaymentEstimate200Response>() {
           @Override
           public void write(JsonWriter out, GetUpdatePaymentEstimate200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUpdatePaymentEstimate200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUpdatePaymentEstimate200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUpdatePaymentEstimate200Response
   * @throws IOException if the JSON string is invalid with respect to GetUpdatePaymentEstimate200Response
   */
  public static GetUpdatePaymentEstimate200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUpdatePaymentEstimate200Response.class);
  }

  /**
   * Convert an instance of GetUpdatePaymentEstimate200Response to an JSON string
   *
   * @return JSON string
   */
