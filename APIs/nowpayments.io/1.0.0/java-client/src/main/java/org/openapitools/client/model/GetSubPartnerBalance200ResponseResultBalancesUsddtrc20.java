...
public class GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 {
  ...
  public GetSubPartnerBalance200ResponseResultBalancesUsddtrc20() {
  }

  public GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 pendingAmount(BigDecimal pendingAmount) {
  ...
  public boolean equals(Object o) {
    ...
    GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 getSubPartnerBalance200ResponseResultBalancesUsddtrc20 = (GetSubPartnerBalance200ResponseResultBalancesUsddtrc20) o;
    return Objects.equals(this.amount, getSubPartnerBalance200ResponseResultBalancesUsddtrc20.amount) &&
        Objects.equals(this.pendingAmount, getSubPartnerBalance200ResponseResultBalancesUsddtrc20.pendingAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, pendingAmount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSubPartnerBalance200ResponseResultBalancesUsddtrc20
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 is not found in the empty JSON string", GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSubPartnerBalance200ResponseResultBalancesUsddtrc20` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSubPartnerBalance200ResponseResultBalancesUsddtrc20' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSubPartnerBalance200ResponseResultBalancesUsddtrc20> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSubPartnerBalance200ResponseResultBalancesUsddtrc20>() {
           @Override
           public void write(JsonWriter out, GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSubPartnerBalance200ResponseResultBalancesUsddtrc20
   * @throws IOException if the JSON string is invalid with respect to GetSubPartnerBalance200ResponseResultBalancesUsddtrc20
   */
  public static GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.class);
  }

  /**
   * Convert an instance of GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 to an JSON string
   *
   * @return JSON string
   */
