...
import org.openapitools.client.model.GetSubPartnerBalance200ResponseResultBalancesUsddtrc20;
import org.openapitools.client.model.GetSubPartnerBalance200ResponseResultBalancesUsdtbsc;
...
public class GetSubPartnerBalance200ResponseResultBalances {
  public static final String SERIALIZED_NAME_USDDTRC20 = "usddtrc20";
  @SerializedName(SERIALIZED_NAME_USDDTRC20)
  private GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 usddtrc20;

  public static final String SERIALIZED_NAME_USDTBSC = "usdtbsc";
  @SerializedName(SERIALIZED_NAME_USDTBSC)
  private GetSubPartnerBalance200ResponseResultBalancesUsdtbsc usdtbsc;

  public GetSubPartnerBalance200ResponseResultBalances() {
  }

  public GetSubPartnerBalance200ResponseResultBalances usddtrc20(GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 usddtrc20) {
  ...
  public GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 getUsddtrc20() {
    return usddtrc20;
  }

  public void setUsddtrc20(GetSubPartnerBalance200ResponseResultBalancesUsddtrc20 usddtrc20) {
    this.usddtrc20 = usddtrc20;
  }


  public GetSubPartnerBalance200ResponseResultBalances usdtbsc(GetSubPartnerBalance200ResponseResultBalancesUsdtbsc usdtbsc) {
   ...
   */
  @javax.annotation.Nullable
  public GetSubPartnerBalance200ResponseResultBalancesUsdtbsc getUsdtbsc() {
    return usdtbsc;
  }

  public void setUsdtbsc(GetSubPartnerBalance200ResponseResultBalancesUsdtbsc usdtbsc) {
    this.usdtbsc = usdtbsc;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetSubPartnerBalance200ResponseResultBalances getSubPartnerBalance200ResponseResultBalances = (GetSubPartnerBalance200ResponseResultBalances) o;
    return Objects.equals(this.usddtrc20, getSubPartnerBalance200ResponseResultBalances.usddtrc20) &&
        Objects.equals(this.usdtbsc, getSubPartnerBalance200ResponseResultBalances.usdtbsc);
  }

  @Override
  public int hashCode() {
    return Objects.hash(usddtrc20, usdtbsc);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetSubPartnerBalance200ResponseResultBalances {\n");
    sb.append("    usddtrc20: ").append(toIndentedString(usddtrc20)).append("\n");
    sb.append("    usdtbsc: ").append(toIndentedString(usdtbsc)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("usddtrc20");
    openapiFields.add("usdtbsc");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSubPartnerBalance200ResponseResultBalances
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSubPartnerBalance200ResponseResultBalances.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSubPartnerBalance200ResponseResultBalances is not found in the empty JSON string", GetSubPartnerBalance200ResponseResultBalances.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSubPartnerBalance200ResponseResultBalances.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSubPartnerBalance200ResponseResultBalances` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `usddtrc20`
      if (jsonObj.get("usddtrc20") != null && !jsonObj.get("usddtrc20").isJsonNull()) {
        GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.validateJsonElement(jsonObj.get("usddtrc20"));
      }
      // validate the optional field `usdtbsc`
      if (jsonObj.get("usdtbsc") != null && !jsonObj.get("usdtbsc").isJsonNull()) {
        GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.validateJsonElement(jsonObj.get("usdtbsc"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSubPartnerBalance200ResponseResultBalances.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSubPartnerBalance200ResponseResultBalances' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSubPartnerBalance200ResponseResultBalances> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSubPartnerBalance200ResponseResultBalances.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSubPartnerBalance200ResponseResultBalances>() {
           @Override
           public void write(JsonWriter out, GetSubPartnerBalance200ResponseResultBalances value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSubPartnerBalance200ResponseResultBalances read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSubPartnerBalance200ResponseResultBalances given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSubPartnerBalance200ResponseResultBalances
   * @throws IOException if the JSON string is invalid with respect to GetSubPartnerBalance200ResponseResultBalances
   */
  public static GetSubPartnerBalance200ResponseResultBalances fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSubPartnerBalance200ResponseResultBalances.class);
  }

  /**
   * Convert an instance of GetSubPartnerBalance200ResponseResultBalances to an JSON string
   *
   * @return JSON string
   */
