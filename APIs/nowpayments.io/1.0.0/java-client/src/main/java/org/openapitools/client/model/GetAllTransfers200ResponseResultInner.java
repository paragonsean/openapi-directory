...
public class GetAllTransfers200ResponseResultInner {
  ...
  public static final String SERIALIZED_NAME_FROM_SUB_ID = "from_sub_id";
  @SerializedName(SERIALIZED_NAME_FROM_SUB_ID)
  ...
  public static final String SERIALIZED_NAME_TO_SUB_ID = "to_sub_id";
  @SerializedName(SERIALIZED_NAME_TO_SUB_ID)
  ...
  public GetAllTransfers200ResponseResultInner() {
  }

  public GetAllTransfers200ResponseResultInner amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public GetAllTransfers200ResponseResultInner createdAt(String createdAt) {
  ...
  public GetAllTransfers200ResponseResultInner currency(String currency) {
  ...
  public GetAllTransfers200ResponseResultInner fromSubId(String fromSubId) {
  ...
  public GetAllTransfers200ResponseResultInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetAllTransfers200ResponseResultInner status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetAllTransfers200ResponseResultInner toSubId(String toSubId) {
  ...
  public GetAllTransfers200ResponseResultInner updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    GetAllTransfers200ResponseResultInner getAllTransfers200ResponseResultInner = (GetAllTransfers200ResponseResultInner) o;
    return Objects.equals(this.amount, getAllTransfers200ResponseResultInner.amount) &&
        Objects.equals(this.createdAt, getAllTransfers200ResponseResultInner.createdAt) &&
        Objects.equals(this.currency, getAllTransfers200ResponseResultInner.currency) &&
        Objects.equals(this.fromSubId, getAllTransfers200ResponseResultInner.fromSubId) &&
        Objects.equals(this.id, getAllTransfers200ResponseResultInner.id) &&
        Objects.equals(this.status, getAllTransfers200ResponseResultInner.status) &&
        Objects.equals(this.toSubId, getAllTransfers200ResponseResultInner.toSubId) &&
        Objects.equals(this.updatedAt, getAllTransfers200ResponseResultInner.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, createdAt, currency, fromSubId, id, status, toSubId, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAllTransfers200ResponseResultInner {\n");
    sb.append("    amount: ").append(toIndentedString(amount)).append("\n");
    sb.append("    createdAt: ").append(toIndentedString(createdAt)).append("\n");
    sb.append("    currency: ").append(toIndentedString(currency)).append("\n");
    sb.append("    fromSubId: ").append(toIndentedString(fromSubId)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    status: ").append(toIndentedString(status)).append("\n");
    sb.append("    toSubId: ").append(toIndentedString(toSubId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("from_sub_id");
    openapiFields.add("id");
    openapiFields.add("status");
    openapiFields.add("to_sub_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAllTransfers200ResponseResultInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAllTransfers200ResponseResultInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAllTransfers200ResponseResultInner is not found in the empty JSON string", GetAllTransfers200ResponseResultInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAllTransfers200ResponseResultInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAllTransfers200ResponseResultInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("from_sub_id") != null && !jsonObj.get("from_sub_id").isJsonNull()) && !jsonObj.get("from_sub_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `from_sub_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("from_sub_id").toString()));
      }
      ...
      if ((jsonObj.get("to_sub_id") != null && !jsonObj.get("to_sub_id").isJsonNull()) && !jsonObj.get("to_sub_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `to_sub_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("to_sub_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAllTransfers200ResponseResultInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAllTransfers200ResponseResultInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAllTransfers200ResponseResultInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAllTransfers200ResponseResultInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAllTransfers200ResponseResultInner>() {
           @Override
           public void write(JsonWriter out, GetAllTransfers200ResponseResultInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAllTransfers200ResponseResultInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAllTransfers200ResponseResultInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAllTransfers200ResponseResultInner
   * @throws IOException if the JSON string is invalid with respect to GetAllTransfers200ResponseResultInner
   */
  public static GetAllTransfers200ResponseResultInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAllTransfers200ResponseResultInner.class);
  }

  /**
   * Convert an instance of GetAllTransfers200ResponseResultInner to an JSON string
   *
   * @return JSON string
   */
