...
import org.openapitools.client.model.GetOneRecurringPayment200ResponseResult;
...
public class GetOneRecurringPayment200Response {
  public static final String SERIALIZED_NAME_RESULT = "result";
  @SerializedName(SERIALIZED_NAME_RESULT)
  private GetOneRecurringPayment200ResponseResult result;

  public GetOneRecurringPayment200Response() {
  }

  public GetOneRecurringPayment200Response result(GetOneRecurringPayment200ResponseResult result) {
    this.result = result;
    return this;
  }
  ...
  public GetOneRecurringPayment200ResponseResult getResult() {
    return result;
  }

  public void setResult(GetOneRecurringPayment200ResponseResult result) {
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetOneRecurringPayment200Response getOneRecurringPayment200Response = (GetOneRecurringPayment200Response) o;
    return Objects.equals(this.result, getOneRecurringPayment200Response.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOneRecurringPayment200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOneRecurringPayment200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOneRecurringPayment200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOneRecurringPayment200Response is not found in the empty JSON string", GetOneRecurringPayment200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOneRecurringPayment200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOneRecurringPayment200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `result`
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        GetOneRecurringPayment200ResponseResult.validateJsonElement(jsonObj.get("result"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOneRecurringPayment200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOneRecurringPayment200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOneRecurringPayment200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOneRecurringPayment200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOneRecurringPayment200Response>() {
           @Override
           public void write(JsonWriter out, GetOneRecurringPayment200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOneRecurringPayment200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOneRecurringPayment200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOneRecurringPayment200Response
   * @throws IOException if the JSON string is invalid with respect to GetOneRecurringPayment200Response
   */
  public static GetOneRecurringPayment200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOneRecurringPayment200Response.class);
  }

  /**
   * Convert an instance of GetOneRecurringPayment200Response to an JSON string
   *
   * @return JSON string
   */
