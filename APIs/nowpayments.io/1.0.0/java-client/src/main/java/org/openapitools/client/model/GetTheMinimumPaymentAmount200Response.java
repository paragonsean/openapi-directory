...
public class GetTheMinimumPaymentAmount200Response {
  ...
  public static final String SERIALIZED_NAME_FIAT_EQUIVALENT = "fiat_equivalent";
  @SerializedName(SERIALIZED_NAME_FIAT_EQUIVALENT)
  ...
  public GetTheMinimumPaymentAmount200Response() {
  }

  public GetTheMinimumPaymentAmount200Response currencyFrom(String currencyFrom) {
  ...
  public GetTheMinimumPaymentAmount200Response currencyTo(String currencyTo) {
  ...
  public GetTheMinimumPaymentAmount200Response fiatEquivalent(BigDecimal fiatEquivalent) {
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getFiatEquivalent() {
    return fiatEquivalent;
  }

  public void setFiatEquivalent(BigDecimal fiatEquivalent) {
    this.fiatEquivalent = fiatEquivalent;
  }


  public GetTheMinimumPaymentAmount200Response minAmount(BigDecimal minAmount) {
  ...
  public boolean equals(Object o) {
    ...
    GetTheMinimumPaymentAmount200Response getTheMinimumPaymentAmount200Response = (GetTheMinimumPaymentAmount200Response) o;
    return Objects.equals(this.currencyFrom, getTheMinimumPaymentAmount200Response.currencyFrom) &&
        Objects.equals(this.currencyTo, getTheMinimumPaymentAmount200Response.currencyTo) &&
        Objects.equals(this.fiatEquivalent, getTheMinimumPaymentAmount200Response.fiatEquivalent) &&
        Objects.equals(this.minAmount, getTheMinimumPaymentAmount200Response.minAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currencyFrom, currencyTo, fiatEquivalent, minAmount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetTheMinimumPaymentAmount200Response {\n");
    ...
    sb.append("    fiatEquivalent: ").append(toIndentedString(fiatEquivalent)).append("\n");
  ...
  static {
    ...
    openapiFields.add("fiat_equivalent");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTheMinimumPaymentAmount200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTheMinimumPaymentAmount200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTheMinimumPaymentAmount200Response is not found in the empty JSON string", GetTheMinimumPaymentAmount200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTheMinimumPaymentAmount200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTheMinimumPaymentAmount200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("currency_from") != null && !jsonObj.get("currency_from").isJsonNull()) && !jsonObj.get("currency_from").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("currency_to") != null && !jsonObj.get("currency_to").isJsonNull()) && !jsonObj.get("currency_to").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTheMinimumPaymentAmount200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTheMinimumPaymentAmount200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTheMinimumPaymentAmount200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTheMinimumPaymentAmount200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTheMinimumPaymentAmount200Response>() {
           @Override
           public void write(JsonWriter out, GetTheMinimumPaymentAmount200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTheMinimumPaymentAmount200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTheMinimumPaymentAmount200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTheMinimumPaymentAmount200Response
   * @throws IOException if the JSON string is invalid with respect to GetTheMinimumPaymentAmount200Response
   */
  public static GetTheMinimumPaymentAmount200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTheMinimumPaymentAmount200Response.class);
  }

  /**
   * Convert an instance of GetTheMinimumPaymentAmount200Response to an JSON string
   *
   * @return JSON string
   */
