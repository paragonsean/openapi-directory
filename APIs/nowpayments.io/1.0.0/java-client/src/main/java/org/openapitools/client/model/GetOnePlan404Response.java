...
public class GetOnePlan404Response {
  ...
  public GetOnePlan404Response() {
  }

  public GetOnePlan404Response code(String code) {
    this.code = code;
    return this;
  }
  ...
  public GetOnePlan404Response message(String message) {
  ...
  public GetOnePlan404Response status(Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public GetOnePlan404Response statusCode(BigDecimal statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GetOnePlan404Response getOnePlan404Response = (GetOnePlan404Response) o;
    return Objects.equals(this.code, getOnePlan404Response.code) &&
        Objects.equals(this.message, getOnePlan404Response.message) &&
        Objects.equals(this.status, getOnePlan404Response.status) &&
        Objects.equals(this.statusCode, getOnePlan404Response.statusCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, status, statusCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetOnePlan404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOnePlan404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOnePlan404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOnePlan404Response is not found in the empty JSON string", GetOnePlan404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOnePlan404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOnePlan404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOnePlan404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOnePlan404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOnePlan404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOnePlan404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOnePlan404Response>() {
           @Override
           public void write(JsonWriter out, GetOnePlan404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOnePlan404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOnePlan404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOnePlan404Response
   * @throws IOException if the JSON string is invalid with respect to GetOnePlan404Response
   */
  public static GetOnePlan404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOnePlan404Response.class);
  }

  /**
   * Convert an instance of GetOnePlan404Response to an JSON string
   *
   * @return JSON string
   */
