...
import org.openapitools.client.model.GetTransfer200ResponseResult;
...
public class GetTransfer200Response {
  public static final String SERIALIZED_NAME_RESULT = "result";
  @SerializedName(SERIALIZED_NAME_RESULT)
  private GetTransfer200ResponseResult result;

  public GetTransfer200Response() {
  }

  public GetTransfer200Response result(GetTransfer200ResponseResult result) {
    this.result = result;
    return this;
  }
  ...
  public GetTransfer200ResponseResult getResult() {
    return result;
  }

  public void setResult(GetTransfer200ResponseResult result) {
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTransfer200Response getTransfer200Response = (GetTransfer200Response) o;
    return Objects.equals(this.result, getTransfer200Response.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTransfer200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTransfer200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTransfer200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTransfer200Response is not found in the empty JSON string", GetTransfer200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTransfer200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTransfer200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `result`
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        GetTransfer200ResponseResult.validateJsonElement(jsonObj.get("result"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTransfer200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTransfer200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTransfer200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTransfer200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTransfer200Response>() {
           @Override
           public void write(JsonWriter out, GetTransfer200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTransfer200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTransfer200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTransfer200Response
   * @throws IOException if the JSON string is invalid with respect to GetTransfer200Response
   */
  public static GetTransfer200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransfer200Response.class);
  }

  /**
   * Convert an instance of GetTransfer200Response to an JSON string
   *
   * @return JSON string
   */
