...
public class UpdatePlanRequest {
  ...
  private BigDecimal intervalDay;
  ...
  public UpdatePlanRequest amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public UpdatePlanRequest intervalDay(BigDecimal intervalDay) {
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getIntervalDay() {
    return intervalDay;
  }

  public void setIntervalDay(BigDecimal intervalDay) {
    this.intervalDay = intervalDay;
  }


  public UpdatePlanRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, updatePlanRequest.amount) &&
        Objects.equals(this.currency, updatePlanRequest.currency) &&
        Objects.equals(this.intervalDay, updatePlanRequest.intervalDay) &&
        Objects.equals(this.title, updatePlanRequest.title);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, intervalDay, title);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePlanRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePlanRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
