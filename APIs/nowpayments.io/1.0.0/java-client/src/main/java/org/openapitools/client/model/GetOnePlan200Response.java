...
import org.openapitools.client.model.GetOnePlan200ResponseResult;
...
public class GetOnePlan200Response {
  public static final String SERIALIZED_NAME_RESULT = "result";
  @SerializedName(SERIALIZED_NAME_RESULT)
  private GetOnePlan200ResponseResult result;

  public GetOnePlan200Response() {
  }

  public GetOnePlan200Response result(GetOnePlan200ResponseResult result) {
    this.result = result;
    return this;
  }
  ...
  public GetOnePlan200ResponseResult getResult() {
    return result;
  }

  public void setResult(GetOnePlan200ResponseResult result) {
    this.result = result;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetOnePlan200Response getOnePlan200Response = (GetOnePlan200Response) o;
    return Objects.equals(this.result, getOnePlan200Response.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOnePlan200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOnePlan200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOnePlan200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOnePlan200Response is not found in the empty JSON string", GetOnePlan200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOnePlan200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOnePlan200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `result`
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        GetOnePlan200ResponseResult.validateJsonElement(jsonObj.get("result"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOnePlan200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOnePlan200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOnePlan200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOnePlan200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOnePlan200Response>() {
           @Override
           public void write(JsonWriter out, GetOnePlan200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOnePlan200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOnePlan200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOnePlan200Response
   * @throws IOException if the JSON string is invalid with respect to GetOnePlan200Response
   */
  public static GetOnePlan200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOnePlan200Response.class);
  }

  /**
   * Convert an instance of GetOnePlan200Response to an JSON string
   *
   * @return JSON string
   */
