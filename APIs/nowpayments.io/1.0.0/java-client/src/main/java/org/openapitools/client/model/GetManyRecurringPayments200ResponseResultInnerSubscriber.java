...
public class GetManyRecurringPayments200ResponseResultInnerSubscriber {
  public static final String SERIALIZED_NAME_EMAIL = "email";
  @SerializedName(SERIALIZED_NAME_EMAIL)
  private String email;

  public static final String SERIALIZED_NAME_SUB_PARTNER_ID = "sub_partner_id";
  @SerializedName(SERIALIZED_NAME_SUB_PARTNER_ID)
  private String subPartnerId;

  public GetManyRecurringPayments200ResponseResultInnerSubscriber() {
  }

  public GetManyRecurringPayments200ResponseResultInnerSubscriber email(String email) {
    this.email = email;
    return this;
  }
  ...
  public GetManyRecurringPayments200ResponseResultInnerSubscriber subPartnerId(String subPartnerId) {
  ...
  public boolean equals(Object o) {
    ...
    GetManyRecurringPayments200ResponseResultInnerSubscriber getManyRecurringPayments200ResponseResultInnerSubscriber = (GetManyRecurringPayments200ResponseResultInnerSubscriber) o;
    return Objects.equals(this.email, getManyRecurringPayments200ResponseResultInnerSubscriber.email) &&
        Objects.equals(this.subPartnerId, getManyRecurringPayments200ResponseResultInnerSubscriber.subPartnerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, subPartnerId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetManyRecurringPayments200ResponseResultInnerSubscriber {\n");
  ...
  static {
    ...
    openapiFields.add("sub_partner_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetManyRecurringPayments200ResponseResultInnerSubscriber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetManyRecurringPayments200ResponseResultInnerSubscriber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetManyRecurringPayments200ResponseResultInnerSubscriber is not found in the empty JSON string", GetManyRecurringPayments200ResponseResultInnerSubscriber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetManyRecurringPayments200ResponseResultInnerSubscriber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetManyRecurringPayments200ResponseResultInnerSubscriber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sub_partner_id") != null && !jsonObj.get("sub_partner_id").isJsonNull()) && !jsonObj.get("sub_partner_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sub_partner_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sub_partner_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetManyRecurringPayments200ResponseResultInnerSubscriber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetManyRecurringPayments200ResponseResultInnerSubscriber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetManyRecurringPayments200ResponseResultInnerSubscriber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetManyRecurringPayments200ResponseResultInnerSubscriber.class));

       return (TypeAdapter<T>) new TypeAdapter<GetManyRecurringPayments200ResponseResultInnerSubscriber>() {
           @Override
           public void write(JsonWriter out, GetManyRecurringPayments200ResponseResultInnerSubscriber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetManyRecurringPayments200ResponseResultInnerSubscriber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetManyRecurringPayments200ResponseResultInnerSubscriber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetManyRecurringPayments200ResponseResultInnerSubscriber
   * @throws IOException if the JSON string is invalid with respect to GetManyRecurringPayments200ResponseResultInnerSubscriber
   */
  public static GetManyRecurringPayments200ResponseResultInnerSubscriber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetManyRecurringPayments200ResponseResultInnerSubscriber.class);
  }

  /**
   * Convert an instance of GetManyRecurringPayments200ResponseResultInnerSubscriber to an JSON string
   *
   * @return JSON string
   */
