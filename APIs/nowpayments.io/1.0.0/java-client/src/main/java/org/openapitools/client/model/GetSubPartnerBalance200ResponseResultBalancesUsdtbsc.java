...
public class GetSubPartnerBalance200ResponseResultBalancesUsdtbsc {
  ...
  public GetSubPartnerBalance200ResponseResultBalancesUsdtbsc() {
  }

  public GetSubPartnerBalance200ResponseResultBalancesUsdtbsc amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public GetSubPartnerBalance200ResponseResultBalancesUsdtbsc pendingAmount(BigDecimal pendingAmount) {
  ...
  public boolean equals(Object o) {
    ...
    GetSubPartnerBalance200ResponseResultBalancesUsdtbsc getSubPartnerBalance200ResponseResultBalancesUsdtbsc = (GetSubPartnerBalance200ResponseResultBalancesUsdtbsc) o;
    return Objects.equals(this.amount, getSubPartnerBalance200ResponseResultBalancesUsdtbsc.amount) &&
        Objects.equals(this.pendingAmount, getSubPartnerBalance200ResponseResultBalancesUsdtbsc.pendingAmount);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSubPartnerBalance200ResponseResultBalancesUsdtbsc {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSubPartnerBalance200ResponseResultBalancesUsdtbsc
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSubPartnerBalance200ResponseResultBalancesUsdtbsc is not found in the empty JSON string", GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSubPartnerBalance200ResponseResultBalancesUsdtbsc` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSubPartnerBalance200ResponseResultBalancesUsdtbsc' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSubPartnerBalance200ResponseResultBalancesUsdtbsc> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSubPartnerBalance200ResponseResultBalancesUsdtbsc>() {
           @Override
           public void write(JsonWriter out, GetSubPartnerBalance200ResponseResultBalancesUsdtbsc value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSubPartnerBalance200ResponseResultBalancesUsdtbsc read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSubPartnerBalance200ResponseResultBalancesUsdtbsc given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSubPartnerBalance200ResponseResultBalancesUsdtbsc
   * @throws IOException if the JSON string is invalid with respect to GetSubPartnerBalance200ResponseResultBalancesUsdtbsc
   */
  public static GetSubPartnerBalance200ResponseResultBalancesUsdtbsc fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.class);
  }

  /**
   * Convert an instance of GetSubPartnerBalance200ResponseResultBalancesUsdtbsc to an JSON string
   *
   * @return JSON string
   */
