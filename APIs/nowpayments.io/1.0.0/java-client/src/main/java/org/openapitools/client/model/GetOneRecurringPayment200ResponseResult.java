...
import org.openapitools.client.model.GetOneRecurringPayment200ResponseResultSubscriber;
...
public class GetOneRecurringPayment200ResponseResult {
  ...
  private GetOneRecurringPayment200ResponseResultSubscriber subscriber;
  ...
  public GetOneRecurringPayment200ResponseResult() {
  }

  public GetOneRecurringPayment200ResponseResult createdAt(String createdAt) {
  ...
  public GetOneRecurringPayment200ResponseResult expireDate(String expireDate) {
  ...
  public GetOneRecurringPayment200ResponseResult id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetOneRecurringPayment200ResponseResult isActive(Boolean isActive) {
  ...
  public GetOneRecurringPayment200ResponseResult status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetOneRecurringPayment200ResponseResult subscriber(GetOneRecurringPayment200ResponseResultSubscriber subscriber) {
   ...
   */
  @javax.annotation.Nullable
  public GetOneRecurringPayment200ResponseResultSubscriber getSubscriber() {
    return subscriber;
  }

  public void setSubscriber(GetOneRecurringPayment200ResponseResultSubscriber subscriber) {
    this.subscriber = subscriber;
  }


  public GetOneRecurringPayment200ResponseResult subscriptionPlanId(String subscriptionPlanId) {
  ...
  public GetOneRecurringPayment200ResponseResult updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    GetOneRecurringPayment200ResponseResult getOneRecurringPayment200ResponseResult = (GetOneRecurringPayment200ResponseResult) o;
    return Objects.equals(this.createdAt, getOneRecurringPayment200ResponseResult.createdAt) &&
        Objects.equals(this.expireDate, getOneRecurringPayment200ResponseResult.expireDate) &&
        Objects.equals(this.id, getOneRecurringPayment200ResponseResult.id) &&
        Objects.equals(this.isActive, getOneRecurringPayment200ResponseResult.isActive) &&
        Objects.equals(this.status, getOneRecurringPayment200ResponseResult.status) &&
        Objects.equals(this.subscriber, getOneRecurringPayment200ResponseResult.subscriber) &&
        Objects.equals(this.subscriptionPlanId, getOneRecurringPayment200ResponseResult.subscriptionPlanId) &&
        Objects.equals(this.updatedAt, getOneRecurringPayment200ResponseResult.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, expireDate, id, isActive, status, subscriber, subscriptionPlanId, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetOneRecurringPayment200ResponseResult {\n");
  ...
  static {
    ...
    openapiFields.add("subscription_plan_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOneRecurringPayment200ResponseResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOneRecurringPayment200ResponseResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOneRecurringPayment200ResponseResult is not found in the empty JSON string", GetOneRecurringPayment200ResponseResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOneRecurringPayment200ResponseResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOneRecurringPayment200ResponseResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("subscriber") != null && !jsonObj.get("subscriber").isJsonNull()) {
        GetOneRecurringPayment200ResponseResultSubscriber.validateJsonElement(jsonObj.get("subscriber"));
      }
      if ((jsonObj.get("subscription_plan_id") != null && !jsonObj.get("subscription_plan_id").isJsonNull()) && !jsonObj.get("subscription_plan_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `subscription_plan_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("subscription_plan_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOneRecurringPayment200ResponseResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOneRecurringPayment200ResponseResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOneRecurringPayment200ResponseResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOneRecurringPayment200ResponseResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOneRecurringPayment200ResponseResult>() {
           @Override
           public void write(JsonWriter out, GetOneRecurringPayment200ResponseResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOneRecurringPayment200ResponseResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOneRecurringPayment200ResponseResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOneRecurringPayment200ResponseResult
   * @throws IOException if the JSON string is invalid with respect to GetOneRecurringPayment200ResponseResult
   */
  public static GetOneRecurringPayment200ResponseResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOneRecurringPayment200ResponseResult.class);
  }

  /**
   * Convert an instance of GetOneRecurringPayment200ResponseResult to an JSON string
   *
   * @return JSON string
   */
