...
public class GetOneRecurringPayment404Response {
  ...
  public GetOneRecurringPayment404Response() {
  }

  public GetOneRecurringPayment404Response code(String code) {
    this.code = code;
    return this;
  }
  ...
  public GetOneRecurringPayment404Response message(String message) {
  ...
  public GetOneRecurringPayment404Response status(Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public GetOneRecurringPayment404Response statusCode(BigDecimal statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GetOneRecurringPayment404Response getOneRecurringPayment404Response = (GetOneRecurringPayment404Response) o;
    return Objects.equals(this.code, getOneRecurringPayment404Response.code) &&
        Objects.equals(this.message, getOneRecurringPayment404Response.message) &&
        Objects.equals(this.status, getOneRecurringPayment404Response.status) &&
        Objects.equals(this.statusCode, getOneRecurringPayment404Response.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOneRecurringPayment404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOneRecurringPayment404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOneRecurringPayment404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOneRecurringPayment404Response is not found in the empty JSON string", GetOneRecurringPayment404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOneRecurringPayment404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOneRecurringPayment404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOneRecurringPayment404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOneRecurringPayment404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOneRecurringPayment404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOneRecurringPayment404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOneRecurringPayment404Response>() {
           @Override
           public void write(JsonWriter out, GetOneRecurringPayment404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOneRecurringPayment404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOneRecurringPayment404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOneRecurringPayment404Response
   * @throws IOException if the JSON string is invalid with respect to GetOneRecurringPayment404Response
   */
  public static GetOneRecurringPayment404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOneRecurringPayment404Response.class);
  }

  /**
   * Convert an instance of GetOneRecurringPayment404Response to an JSON string
   *
   * @return JSON string
   */
