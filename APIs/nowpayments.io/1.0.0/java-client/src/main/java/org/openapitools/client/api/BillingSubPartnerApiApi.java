...
public class BillingSubPartnerApiApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public BillingSubPartnerApiApi() {
        this(Configuration.getDefaultApiClient());
    }

    public BillingSubPartnerApiApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAllTransfers
     * @param id int or array of int (optional) (optional)
     * @param status string or array of string  \&quot;WAITING\&quot;/\&quot;CREATED\&quot;/\&quot;FINISHED\&quot;/\&quot;REJECTED\&quot; (optional) (optional)
     * @param limit (optional) default 10 (optional)
     * @param offset (optional) default 0 (optional)
     * @param order ASC / DESC (optional) default ASC (optional)
     ...
     */
    public okhttp3.Call getAllTransfersCall(String id, String status, String limit, String offset, String order, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/sub-partner/transfers";
    ...
    private okhttp3.Call getAllTransfersValidateBeforeCall(String id, String status, String limit, String offset, String order, final ApiCallback _callback) throws ApiException {
        return getAllTransfersCall(id, status, limit, offset, order, _callback);
     ...
     * @param offset (optional) default 0 (optional)
     * @param order ASC / DESC (optional) default ASC (optional)
     * @return GetAllTransfers200Response
     ...
     */
    public GetAllTransfers200Response getAllTransfers(String id, String status, String limit, String offset, String order) throws ApiException {
        ApiResponse<GetAllTransfers200Response> localVarResp = getAllTransfersWithHttpInfo(id, status, limit, offset, order);
     ...
     * @param offset (optional) default 0 (optional)
     * @param order ASC / DESC (optional) default ASC (optional)
     * @return ApiResponse&lt;GetAllTransfers200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetAllTransfers200Response> getAllTransfersWithHttpInfo(String id, String status, String limit, String offset, String order) throws ApiException {
        okhttp3.Call localVarCall = getAllTransfersValidateBeforeCall(id, status, limit, offset, order, null);
        Type localVarReturnType = new TypeToken<GetAllTransfers200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all transfers (asynchronously)
     * Returns the entire list of transfers created by your sub-partners.
     * @param id int or array of int (optional) (optional)
     * @param status string or array of string  \&quot;WAITING\&quot;/\&quot;CREATED\&quot;/\&quot;FINISHED\&quot;/\&quot;REJECTED\&quot; (optional) (optional)
     * @param limit (optional) default 10 (optional)
     ...
     */
    public okhttp3.Call getAllTransfersAsync(String id, String status, String limit, String offset, String order, final ApiCallback<GetAllTransfers200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllTransfersValidateBeforeCall(id, status, limit, offset, order, _callback);
        Type localVarReturnType = new TypeToken<GetAllTransfers200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getSubPartnerBalance
     * @param id  (required)
     ...
     */
    public okhttp3.Call getSubPartnerBalanceCall(String id, String xApiKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/sub-partner/balance/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSubPartnerBalanceValidateBeforeCall(String id, String xApiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getSubPartnerBalance(Async)");
        }

        return getSubPartnerBalanceCall(id, xApiKey, _callback);
     ...
     * @param id  (required)
     * @param xApiKey  (optional)
     * @return GetSubPartnerBalance200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetSubPartnerBalance200Response getSubPartnerBalance(String id, String xApiKey) throws ApiException {
        ApiResponse<GetSubPartnerBalance200Response> localVarResp = getSubPartnerBalanceWithHttpInfo(id, xApiKey);
        return localVarResp.getData();
    }
     ...
     * @param id  (required)
     * @param xApiKey  (optional)
     * @return ApiResponse&lt;GetSubPartnerBalance200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetSubPartnerBalance200Response> getSubPartnerBalanceWithHttpInfo(String id, String xApiKey) throws ApiException {
        okhttp3.Call localVarCall = getSubPartnerBalanceValidateBeforeCall(id, xApiKey, null);
        Type localVarReturnType = new TypeToken<GetSubPartnerBalance200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get sub-partner balance (asynchronously)
     * This request can be made only from a whitelisted IP.   If IP whitelisting is disabled, this request can be made by any user that has an API key.
     * @param id  (required)
     * @param xApiKey  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getSubPartnerBalanceAsync(String id, String xApiKey, final ApiCallback<GetSubPartnerBalance200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSubPartnerBalanceValidateBeforeCall(id, xApiKey, _callback);
        Type localVarReturnType = new TypeToken<GetSubPartnerBalance200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getSubPartners
     * @param id int or array of int (optional) (optional)
     * @param offset (optional) default 0 (optional)
     * @param limit (optional) default 10 (optional)
     * @param order ASC / DESC (optional) default ASC (optional)
     ...
     */
    public okhttp3.Call getSubPartnersCall(String id, String offset, String limit, String order, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/sub-partner";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSubPartnersValidateBeforeCall(String id, String offset, String limit, String order, final ApiCallback _callback) throws ApiException {
        return getSubPartnersCall(id, offset, limit, order, _callback);
     ...
     */
    public void getSubPartners(String id, String offset, String limit, String order) throws ApiException {
        getSubPartnersWithHttpInfo(id, offset, limit, order);
    }
     ...
     */
    public ApiResponse<Void> getSubPartnersWithHttpInfo(String id, String offset, String limit, String order) throws ApiException {
        okhttp3.Call localVarCall = getSubPartnersValidateBeforeCall(id, offset, limit, order, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get sub-partners (asynchronously)
     * This method returns the entire list of your sub-partners.
     * @param id int or array of int (optional) (optional)
     * @param offset (optional) default 0 (optional)
     * @param limit (optional) default 10 (optional)
     ...
     */
    public okhttp3.Call getSubPartnersAsync(String id, String offset, String limit, String order, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSubPartnersValidateBeforeCall(id, offset, limit, order, _callback);
     ...
     */
    public okhttp3.Call getTransferCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/sub-partner/transfer/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTransferValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getTransfer(Async)");
        }

        return getTransferCall(id, _callback);
     ...
     */
    public GetTransfer200Response getTransfer(String id) throws ApiException {
        ApiResponse<GetTransfer200Response> localVarResp = getTransferWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Get the actual information about the transfer. You need to provide the transfer ID in the request.
     * @param id  (required)
     * @return ApiResponse&lt;GetTransfer200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetTransfer200Response> getTransferWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getTransferValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<GetTransfer200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getTransferAsync(String id, final ApiCallback<GetTransfer200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTransferValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<GetTransfer200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
