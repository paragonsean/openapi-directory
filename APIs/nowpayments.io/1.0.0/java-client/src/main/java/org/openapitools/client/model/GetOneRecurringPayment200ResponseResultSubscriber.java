...
public class GetOneRecurringPayment200ResponseResultSubscriber {
  ...
  public GetOneRecurringPayment200ResponseResultSubscriber() {
  }

  public GetOneRecurringPayment200ResponseResultSubscriber subPartnerId(String subPartnerId) {
  ...
  public boolean equals(Object o) {
    ...
    GetOneRecurringPayment200ResponseResultSubscriber getOneRecurringPayment200ResponseResultSubscriber = (GetOneRecurringPayment200ResponseResultSubscriber) o;
    return Objects.equals(this.subPartnerId, getOneRecurringPayment200ResponseResultSubscriber.subPartnerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subPartnerId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetOneRecurringPayment200ResponseResultSubscriber {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOneRecurringPayment200ResponseResultSubscriber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOneRecurringPayment200ResponseResultSubscriber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOneRecurringPayment200ResponseResultSubscriber is not found in the empty JSON string", GetOneRecurringPayment200ResponseResultSubscriber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOneRecurringPayment200ResponseResultSubscriber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOneRecurringPayment200ResponseResultSubscriber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOneRecurringPayment200ResponseResultSubscriber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOneRecurringPayment200ResponseResultSubscriber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOneRecurringPayment200ResponseResultSubscriber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOneRecurringPayment200ResponseResultSubscriber.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOneRecurringPayment200ResponseResultSubscriber>() {
           @Override
           public void write(JsonWriter out, GetOneRecurringPayment200ResponseResultSubscriber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOneRecurringPayment200ResponseResultSubscriber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOneRecurringPayment200ResponseResultSubscriber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOneRecurringPayment200ResponseResultSubscriber
   * @throws IOException if the JSON string is invalid with respect to GetOneRecurringPayment200ResponseResultSubscriber
   */
  public static GetOneRecurringPayment200ResponseResultSubscriber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOneRecurringPayment200ResponseResultSubscriber.class);
  }

  /**
   * Convert an instance of GetOneRecurringPayment200ResponseResultSubscriber to an JSON string
   *
   * @return JSON string
   */
