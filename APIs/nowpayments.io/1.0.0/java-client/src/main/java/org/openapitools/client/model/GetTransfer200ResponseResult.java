...
public class GetTransfer200ResponseResult {
  ...
  public GetTransfer200ResponseResult() {
  }

  public GetTransfer200ResponseResult amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public GetTransfer200ResponseResult createdAt(String createdAt) {
  ...
  public GetTransfer200ResponseResult currency(String currency) {
  ...
  public GetTransfer200ResponseResult fromSubId(String fromSubId) {
  ...
  public GetTransfer200ResponseResult id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetTransfer200ResponseResult status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetTransfer200ResponseResult toSubId(String toSubId) {
  ...
  public GetTransfer200ResponseResult updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    GetTransfer200ResponseResult getTransfer200ResponseResult = (GetTransfer200ResponseResult) o;
    return Objects.equals(this.amount, getTransfer200ResponseResult.amount) &&
        Objects.equals(this.createdAt, getTransfer200ResponseResult.createdAt) &&
        Objects.equals(this.currency, getTransfer200ResponseResult.currency) &&
        Objects.equals(this.fromSubId, getTransfer200ResponseResult.fromSubId) &&
        Objects.equals(this.id, getTransfer200ResponseResult.id) &&
        Objects.equals(this.status, getTransfer200ResponseResult.status) &&
        Objects.equals(this.toSubId, getTransfer200ResponseResult.toSubId) &&
        Objects.equals(this.updatedAt, getTransfer200ResponseResult.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTransfer200ResponseResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTransfer200ResponseResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTransfer200ResponseResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTransfer200ResponseResult is not found in the empty JSON string", GetTransfer200ResponseResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTransfer200ResponseResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTransfer200ResponseResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTransfer200ResponseResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTransfer200ResponseResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTransfer200ResponseResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTransfer200ResponseResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTransfer200ResponseResult>() {
           @Override
           public void write(JsonWriter out, GetTransfer200ResponseResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTransfer200ResponseResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTransfer200ResponseResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTransfer200ResponseResult
   * @throws IOException if the JSON string is invalid with respect to GetTransfer200ResponseResult
   */
  public static GetTransfer200ResponseResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransfer200ResponseResult.class);
  }

  /**
   * Convert an instance of GetTransfer200ResponseResult to an JSON string
   *
   * @return JSON string
   */
