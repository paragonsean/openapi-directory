...
/**
 * API tests for RecurringPaymentsApiEmailSubscriptionsFeatureApi
 */
@Disabled
public class RecurringPaymentsApiEmailSubscriptionsFeatureApiTest {

    private final RecurringPaymentsApiEmailSubscriptionsFeatureApi api = new RecurringPaymentsApiEmailSubscriptionsFeatureApi();
     ...
     */
    @Test
    public void deleteRecurringPaymentTest() throws ApiException {
        String subId = null;
        DeleteRecurringPayment200Response response = api.deleteRecurringPayment(subId);
     ...
     */
    @Test
    public void getManyPlansTest() throws ApiException {
        String limit = null;
        String offset = null;
        String xApiKey = null;
        GetManyPlans200Response response = api.getManyPlans(limit, offset, xApiKey);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getManyRecurringPaymentsTest() throws ApiException {
        String status = null;
        ...
        String offset = null;
        String xApiKey = null;
        GetManyRecurringPayments200Response response = api.getManyRecurringPayments(status, subscriptionPlanId, isActive, limit, offset, xApiKey);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getOnePlanTest() throws ApiException {
        String planId = null;
        String xApiKey = null;
        GetOnePlan200Response response = api.getOnePlan(planId, xApiKey);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getOneRecurringPaymentTest() throws ApiException {
        String subId = null;
        String xApiKey = null;
        GetOneRecurringPayment200Response response = api.getOneRecurringPayment(subId, xApiKey);
        // TODO: test validations
    }
    ...
    public void updatePlanTest() throws ApiException {
        ...
        api.updatePlan(planId, updatePlanRequest);
        // TODO: test validations
    }
