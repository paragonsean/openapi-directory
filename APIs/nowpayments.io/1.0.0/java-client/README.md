...
NOWPayments API
- API version: 1.0.0
  - Build date: 2024-10-12T12:30:50.751981-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*BillingSubPartnerApiApi* | [**getAllTransfers**](docs/BillingSubPartnerApiApi.md#getAllTransfers) | **GET** /v1/sub-partner/transfers | Get all transfers
*BillingSubPartnerApiApi* | [**getSubPartnerBalance**](docs/BillingSubPartnerApiApi.md#getSubPartnerBalance) | **GET** /v1/sub-partner/balance/{id} | Get sub-partner balance
*BillingSubPartnerApiApi* | [**getSubPartners**](docs/BillingSubPartnerApiApi.md#getSubPartners) | **GET** /v1/sub-partner | Get sub-partners
*BillingSubPartnerApiApi* | [**getTransfer**](docs/BillingSubPartnerApiApi.md#getTransfer) | **GET** /v1/sub-partner/transfer/{id} | Get transfer
*PaymentsApiApi* | [**getEstimatedPrice**](docs/PaymentsApiApi.md#getEstimatedPrice) | **GET** /v1/estimate | Get estimated price
*PaymentsApiApi* | [**getListOfPayments**](docs/PaymentsApiApi.md#getListOfPayments) | **GET** /v1/payment/ | Get list of payments
*PaymentsApiApi* | [**getPaymentStatus**](docs/PaymentsApiApi.md#getPaymentStatus) | **GET** /v1/payment/{payment_id} | Get payment status
*PaymentsApiApi* | [**getTheMinimumPaymentAmount**](docs/PaymentsApiApi.md#getTheMinimumPaymentAmount) | **GET** /v1/min-amount | Get the minimum payment amount
*PaymentsApiApi* | [**getUpdatePaymentEstimate**](docs/PaymentsApiApi.md#getUpdatePaymentEstimate) | **POST** /v1/payment/{id}/update-merchant-estimate | Get/Update payment estimate
*PayoutsApiApi* | [**verifyPayout**](docs/PayoutsApiApi.md#verifyPayout) | **POST** /v1/payout/{withdrawals-id}/verify | Verify payout
*RecurringPaymentsApiEmailSubscriptionsFeatureApi* | [**deleteRecurringPayment**](docs/RecurringPaymentsApiEmailSubscriptionsFeatureApi.md#deleteRecurringPayment) | **DELETE** /v1/subscriptions/{sub_id} | Delete recurring payment
*RecurringPaymentsApiEmailSubscriptionsFeatureApi* | [**getManyPlans**](docs/RecurringPaymentsApiEmailSubscriptionsFeatureApi.md#getManyPlans) | **GET** /v1/subscriptions/plans | Get many plans
*RecurringPaymentsApiEmailSubscriptionsFeatureApi* | [**getManyRecurringPayments**](docs/RecurringPaymentsApiEmailSubscriptionsFeatureApi.md#getManyRecurringPayments) | **GET** /v1/subscriptions | Get many recurring payments
*RecurringPaymentsApiEmailSubscriptionsFeatureApi* | [**getOnePlan**](docs/RecurringPaymentsApiEmailSubscriptionsFeatureApi.md#getOnePlan) | **GET** /v1/subscriptions/plans/{plan-id} | Get one plan
*RecurringPaymentsApiEmailSubscriptionsFeatureApi* | [**getOneRecurringPayment**](docs/RecurringPaymentsApiEmailSubscriptionsFeatureApi.md#getOneRecurringPayment) | **GET** /v1/subscriptions/{sub_id} | Get one recurring payment
*RecurringPaymentsApiEmailSubscriptionsFeatureApi* | [**updatePlan**](docs/RecurringPaymentsApiEmailSubscriptionsFeatureApi.md#updatePlan) | **PATCH** /v1/subscriptions/plans/{plan-id} | Update plan


## Documentation for Models

 - [DeleteRecurringPayment200Response](docs/DeleteRecurringPayment200Response.md)
 - [GetAllTransfers200Response](docs/GetAllTransfers200Response.md)
 - [GetAllTransfers200ResponseResultInner](docs/GetAllTransfers200ResponseResultInner.md)
 - [GetEstimatedPrice200Response](docs/GetEstimatedPrice200Response.md)
 - [GetListOfPayments200Response](docs/GetListOfPayments200Response.md)
 - [GetListOfPayments200ResponseDataInner](docs/GetListOfPayments200ResponseDataInner.md)
 - [GetManyPlans200Response](docs/GetManyPlans200Response.md)
 - [GetManyPlans200ResponseResultInner](docs/GetManyPlans200ResponseResultInner.md)
 - [GetManyRecurringPayments200Response](docs/GetManyRecurringPayments200Response.md)
 - [GetManyRecurringPayments200ResponseResultInner](docs/GetManyRecurringPayments200ResponseResultInner.md)
 - [GetManyRecurringPayments200ResponseResultInnerSubscriber](docs/GetManyRecurringPayments200ResponseResultInnerSubscriber.md)
 - [GetOnePlan200Response](docs/GetOnePlan200Response.md)
 - [GetOnePlan200ResponseResult](docs/GetOnePlan200ResponseResult.md)
 - [GetOnePlan404Response](docs/GetOnePlan404Response.md)
 - [GetOneRecurringPayment200Response](docs/GetOneRecurringPayment200Response.md)
 - [GetOneRecurringPayment200ResponseResult](docs/GetOneRecurringPayment200ResponseResult.md)
 - [GetOneRecurringPayment200ResponseResultSubscriber](docs/GetOneRecurringPayment200ResponseResultSubscriber.md)
 - [GetOneRecurringPayment404Response](docs/GetOneRecurringPayment404Response.md)
 - [GetPaymentStatus200Response](docs/GetPaymentStatus200Response.md)
 - [GetSubPartnerBalance200Response](docs/GetSubPartnerBalance200Response.md)
 - [GetSubPartnerBalance200ResponseResult](docs/GetSubPartnerBalance200ResponseResult.md)
 - [GetSubPartnerBalance200ResponseResultBalances](docs/GetSubPartnerBalance200ResponseResultBalances.md)
 - [GetSubPartnerBalance200ResponseResultBalancesUsddtrc20](docs/GetSubPartnerBalance200ResponseResultBalancesUsddtrc20.md)
 - [GetSubPartnerBalance200ResponseResultBalancesUsdtbsc](docs/GetSubPartnerBalance200ResponseResultBalancesUsdtbsc.md)
 - [GetTheMinimumPaymentAmount200Response](docs/GetTheMinimumPaymentAmount200Response.md)
 - [GetTransfer200Response](docs/GetTransfer200Response.md)
 - [GetTransfer200ResponseResult](docs/GetTransfer200ResponseResult.md)
 - [GetUpdatePaymentEstimate200Response](docs/GetUpdatePaymentEstimate200Response.md)
 - [UpdatePlanRequest](docs/UpdatePlanRequest.md)
 - [VerifyPayoutRequest](docs/VerifyPayoutRequest.md)
