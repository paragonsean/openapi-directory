...
/*
 * OAIGetSubPartnerBalance_200_response_result.h
 *
 * 
 */

#ifndef OAIGetSubPartnerBalance_200_response_result_H
#define OAIGetSubPartnerBalance_200_response_result_H

#include <QJsonObject>

#include "OAIGetSubPartnerBalance_200_response_result_balances.h"
#include <QString>
...
namespace OpenAPI {
class OAIGetSubPartnerBalance_200_response_result_balances;

class OAIGetSubPartnerBalance_200_response_result : public OAIObject {
public:
    OAIGetSubPartnerBalance_200_response_result();
    OAIGetSubPartnerBalance_200_response_result(QString json);
    ~OAIGetSubPartnerBalance_200_response_result() override;
    ...
    OAIGetSubPartnerBalance_200_response_result_balances getBalances() const;
    void setBalances(const OAIGetSubPartnerBalance_200_response_result_balances &balances);
    bool is_balances_Set() const;
    bool is_balances_Valid() const;

    QString getSubPartnerId() const;
    void setSubPartnerId(const QString &sub_partner_id);
    bool is_sub_partner_id_Set() const;
    bool is_sub_partner_id_Valid() const;
...
private:
    ...
    OAIGetSubPartnerBalance_200_response_result_balances m_balances;
    bool m_balances_isSet;
    bool m_balances_isValid;

    QString m_sub_partner_id;
    bool m_sub_partner_id_isSet;
    bool m_sub_partner_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetSubPartnerBalance_200_response_result)

#endif // OAIGetSubPartnerBalance_200_response_result_H
