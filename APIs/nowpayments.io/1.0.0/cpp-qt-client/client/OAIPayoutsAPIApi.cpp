...
OAIPayoutsAPIApi::OAIPayoutsAPIApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPayoutsAPIApi::~OAIPayoutsAPIApi() {
}

void OAIPayoutsAPIApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("verifyPayout", defaultConf);
    _serverIndices.insert("verifyPayout", 0);
}
...
*/
int OAIPayoutsAPIApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPayoutsAPIApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPayoutsAPIApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPayoutsAPIApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPayoutsAPIApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPayoutsAPIApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPayoutsAPIApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPayoutsAPIApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPayoutsAPIApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPayoutsAPIApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPayoutsAPIApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPayoutsAPIApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPayoutsAPIApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPayoutsAPIApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPayoutsAPIApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPayoutsAPIApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPayoutsAPIApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPayoutsAPIApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPayoutsAPIApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPayoutsAPIApi::verifyPayout(const QString &withdrawals_id, const ::OpenAPI::OptionalParam<QString> &x_api_key, const ::OpenAPI::OptionalParam<OAIVerifyPayout_request> &oai_verify_payout_request) {
    QString fullPath = QString(_serverConfigs["verifyPayout"][_serverIndices.value("verifyPayout")].URL()+"/v1/payout/{withdrawals-id}/verify");
    
    
    {
        QString withdrawals_idPathParam("{");
        withdrawals_idPathParam.append("withdrawals-id").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "withdrawals-id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"withdrawals-id"+pathSuffix : pathPrefix;
        fullPath.replace(withdrawals_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(withdrawals_id)));
    }
    ...
    if (oai_verify_payout_request.hasValue()){

        
        QByteArray output = oai_verify_payout_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPayoutsAPIApi::verifyPayoutCallback);
    connect(this, &OAIPayoutsAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIPayoutsAPIApi::verifyPayoutCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT verifyPayoutSignal();
        Q_EMIT verifyPayoutSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT verifyPayoutSignalE(error_type, error_str);
        Q_EMIT verifyPayoutSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT verifyPayoutSignalError(error_type, error_str);
        Q_EMIT verifyPayoutSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPayoutsAPIApi::tokenAvailable(){
