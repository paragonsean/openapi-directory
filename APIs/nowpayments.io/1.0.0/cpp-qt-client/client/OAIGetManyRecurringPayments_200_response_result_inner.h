...
/*
 * OAIGetManyRecurringPayments_200_response_result_inner.h
 *
 * 
 */

#ifndef OAIGetManyRecurringPayments_200_response_result_inner_H
#define OAIGetManyRecurringPayments_200_response_result_inner_H

#include <QJsonObject>

#include "OAIGetManyRecurringPayments_200_response_result_inner_subscriber.h"
#include <QString>
...
namespace OpenAPI {
class OAIGetManyRecurringPayments_200_response_result_inner_subscriber;

class OAIGetManyRecurringPayments_200_response_result_inner : public OAIObject {
public:
    OAIGetManyRecurringPayments_200_response_result_inner();
    OAIGetManyRecurringPayments_200_response_result_inner(QString json);
    ~OAIGetManyRecurringPayments_200_response_result_inner() override;
    ...
    void setExpireDate(const QString &expire_date);
    bool is_expire_date_Set() const;
    bool is_expire_date_Valid() const;
    ...
    OAIGetManyRecurringPayments_200_response_result_inner_subscriber getSubscriber() const;
    void setSubscriber(const OAIGetManyRecurringPayments_200_response_result_inner_subscriber &subscriber);
    bool is_subscriber_Set() const;
    bool is_subscriber_Valid() const;

    QString getSubscriptionPlanId() const;
    void setSubscriptionPlanId(const QString &subscription_plan_id);
...
private:
    ...
    bool m_expire_date_isSet;
    bool m_expire_date_isValid;
    ...
    OAIGetManyRecurringPayments_200_response_result_inner_subscriber m_subscriber;
    bool m_subscriber_isSet;
    bool m_subscriber_isValid;

    QString m_subscription_plan_id;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetManyRecurringPayments_200_response_result_inner)

#endif // OAIGetManyRecurringPayments_200_response_result_inner_H
