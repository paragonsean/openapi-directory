...
#include "OAIBillingSubPartnerAPIApi.h"
...
OAIBillingSubPartnerAPIApi::OAIBillingSubPartnerAPIApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBillingSubPartnerAPIApi::~OAIBillingSubPartnerAPIApi() {
}

void OAIBillingSubPartnerAPIApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getAllTransfers", defaultConf);
    _serverIndices.insert("getAllTransfers", 0);
    _serverConfigs.insert("getSubPartnerBalance", defaultConf);
    _serverIndices.insert("getSubPartnerBalance", 0);
    _serverConfigs.insert("getSubPartners", defaultConf);
    _serverIndices.insert("getSubPartners", 0);
...
*/
int OAIBillingSubPartnerAPIApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBillingSubPartnerAPIApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBillingSubPartnerAPIApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBillingSubPartnerAPIApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBillingSubPartnerAPIApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBillingSubPartnerAPIApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBillingSubPartnerAPIApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBillingSubPartnerAPIApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBillingSubPartnerAPIApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBillingSubPartnerAPIApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBillingSubPartnerAPIApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBillingSubPartnerAPIApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBillingSubPartnerAPIApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBillingSubPartnerAPIApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBillingSubPartnerAPIApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBillingSubPartnerAPIApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBillingSubPartnerAPIApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBillingSubPartnerAPIApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBillingSubPartnerAPIApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBillingSubPartnerAPIApi::getAllTransfers(const ::OpenAPI::OptionalParam<QString> &id, const ::OpenAPI::OptionalParam<QString> &status, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &offset, const ::OpenAPI::OptionalParam<QString> &order) {
    QString fullPath = QString(_serverConfigs["getAllTransfers"][_serverIndices.value("getAllTransfers")].URL()+"/v1/sub-partner/transfers");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBillingSubPartnerAPIApi::getAllTransfersCallback);
    connect(this, &OAIBillingSubPartnerAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIBillingSubPartnerAPIApi::getAllTransfersCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetAllTransfers_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAllTransfersSignal(output);
        Q_EMIT getAllTransfersSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAllTransfersSignalE(output, error_type, error_str);
        Q_EMIT getAllTransfersSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAllTransfersSignalError(output, error_type, error_str);
        Q_EMIT getAllTransfersSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBillingSubPartnerAPIApi::getSubPartnerBalance(const QString &id, const ::OpenAPI::OptionalParam<QString> &x_api_key) {
    QString fullPath = QString(_serverConfigs["getSubPartnerBalance"][_serverIndices.value("getSubPartnerBalance")].URL()+"/v1/sub-partner/balance/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBillingSubPartnerAPIApi::getSubPartnerBalanceCallback);
    connect(this, &OAIBillingSubPartnerAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBillingSubPartnerAPIApi::getSubPartnerBalanceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetSubPartnerBalance_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getSubPartnerBalanceSignal(output);
        Q_EMIT getSubPartnerBalanceSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getSubPartnerBalanceSignalE(output, error_type, error_str);
        Q_EMIT getSubPartnerBalanceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getSubPartnerBalanceSignalError(output, error_type, error_str);
        Q_EMIT getSubPartnerBalanceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBillingSubPartnerAPIApi::getSubPartners(const ::OpenAPI::OptionalParam<QString> &id, const ::OpenAPI::OptionalParam<QString> &offset, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &order) {
    QString fullPath = QString(_serverConfigs["getSubPartners"][_serverIndices.value("getSubPartners")].URL()+"/v1/sub-partner");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBillingSubPartnerAPIApi::getSubPartnersCallback);
    connect(this, &OAIBillingSubPartnerAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBillingSubPartnerAPIApi::getSubPartnersCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getSubPartnersSignal();
        Q_EMIT getSubPartnersSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getSubPartnersSignalE(error_type, error_str);
        Q_EMIT getSubPartnersSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getSubPartnersSignalError(error_type, error_str);
        Q_EMIT getSubPartnersSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBillingSubPartnerAPIApi::getTransfer(const QString &id) {
    QString fullPath = QString(_serverConfigs["getTransfer"][_serverIndices.value("getTransfer")].URL()+"/v1/sub-partner/transfer/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBillingSubPartnerAPIApi::getTransferCallback);
    connect(this, &OAIBillingSubPartnerAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBillingSubPartnerAPIApi::getTransferCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetTransfer_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIBillingSubPartnerAPIApi::tokenAvailable(){
