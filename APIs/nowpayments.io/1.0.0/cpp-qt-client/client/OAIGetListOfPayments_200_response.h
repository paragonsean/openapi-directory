...
/*
 * OAIGetListOfPayments_200_response.h
 *
 * 
 */

#ifndef OAIGetListOfPayments_200_response_H
#define OAIGetListOfPayments_200_response_H

#include <QJsonObject>

#include "OAIGetListOfPayments_200_response_data_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAIGetListOfPayments_200_response_data_inner;

class OAIGetListOfPayments_200_response : public OAIObject {
public:
    OAIGetListOfPayments_200_response();
    OAIGetListOfPayments_200_response(QString json);
    ~OAIGetListOfPayments_200_response() override;
    ...
    QList<OAIGetListOfPayments_200_response_data_inner> getData() const;
    void setData(const QList<OAIGetListOfPayments_200_response_data_inner> &data);
    ...
    double getPagesCount() const;
    void setPagesCount(const double &pages_count);
...
private:
    ...
    QList<OAIGetListOfPayments_200_response_data_inner> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetListOfPayments_200_response)

#endif // OAIGetListOfPayments_200_response_H
