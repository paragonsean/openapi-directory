...
/*
 * OAIGetEstimatedPrice_200_response.h
 *
 * 
 */

#ifndef OAIGetEstimatedPrice_200_response_H
#define OAIGetEstimatedPrice_200_response_H
...
class OAIGetEstimatedPrice_200_response : public OAIObject {
public:
    OAIGetEstimatedPrice_200_response();
    OAIGetEstimatedPrice_200_response(QString json);
    ~OAIGetEstimatedPrice_200_response() override;
    ...
    void setAmountFrom(const double &amount_from);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEstimatedPrice_200_response)

#endif // OAIGetEstimatedPrice_200_response_H
