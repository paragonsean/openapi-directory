...
/*
 * OAIGetTheMinimumPaymentAmount_200_response.h
 *
 * 
 */

#ifndef OAIGetTheMinimumPaymentAmount_200_response_H
#define OAIGetTheMinimumPaymentAmount_200_response_H
...
class OAIGetTheMinimumPaymentAmount_200_response : public OAIObject {
public:
    OAIGetTheMinimumPaymentAmount_200_response();
    OAIGetTheMinimumPaymentAmount_200_response(QString json);
    ~OAIGetTheMinimumPaymentAmount_200_response() override;
    ...
    double getFiatEquivalent() const;
    void setFiatEquivalent(const double &fiat_equivalent);
    bool is_fiat_equivalent_Set() const;
    bool is_fiat_equivalent_Valid() const;

    double getMinAmount() const;
    void setMinAmount(const double &min_amount);
...
private:
    ...
    double m_fiat_equivalent;
    bool m_fiat_equivalent_isSet;
    bool m_fiat_equivalent_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTheMinimumPaymentAmount_200_response)

#endif // OAIGetTheMinimumPaymentAmount_200_response_H
