...
#ifndef OAI_OAIPayoutsAPIApi_H
#define OAI_OAIPayoutsAPIApi_H
...
#include "OAIVerifyPayout_request.h"
#include <QString>
...
class OAIPayoutsAPIApi : public QObject {
    Q_OBJECT

public:
    OAIPayoutsAPIApi(const int timeOut = 0);
    ~OAIPayoutsAPIApi();
    ...
    /**
    * @param[in]  withdrawals_id QString [required]
    * @param[in]  x_api_key QString [optional]
    * @param[in]  oai_verify_payout_request OAIVerifyPayout_request [optional]
    */
    virtual void verifyPayout(const QString &withdrawals_id, const ::OpenAPI::OptionalParam<QString> &x_api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIVerifyPayout_request> &oai_verify_payout_request = ::OpenAPI::OptionalParam<OAIVerifyPayout_request>());
...
private:
    ...
    void verifyPayoutCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void verifyPayoutSignal();


    void verifyPayoutSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use verifyPayoutSignalError() instead")
    void verifyPayoutSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void verifyPayoutSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use verifyPayoutSignalErrorFull() instead")
    void verifyPayoutSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void verifyPayoutSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
