...
/*
 * OAIGetAllTransfers_200_response_result_inner.h
 *
 * 
 */

#ifndef OAIGetAllTransfers_200_response_result_inner_H
#define OAIGetAllTransfers_200_response_result_inner_H
...
class OAIGetAllTransfers_200_response_result_inner : public OAIObject {
public:
    OAIGetAllTransfers_200_response_result_inner();
    OAIGetAllTransfers_200_response_result_inner(QString json);
    ~OAIGetAllTransfers_200_response_result_inner() override;
    ...
    QString getFromSubId() const;
    void setFromSubId(const QString &from_sub_id);
    bool is_from_sub_id_Set() const;
    bool is_from_sub_id_Valid() const;
    ...
    QString getToSubId() const;
    void setToSubId(const QString &to_sub_id);
    bool is_to_sub_id_Set() const;
    bool is_to_sub_id_Valid() const;
...
private:
    ...
    QString m_from_sub_id;
    bool m_from_sub_id_isSet;
    bool m_from_sub_id_isValid;
    ...
    QString m_to_sub_id;
    bool m_to_sub_id_isSet;
    bool m_to_sub_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAllTransfers_200_response_result_inner)

#endif // OAIGetAllTransfers_200_response_result_inner_H
