...
/*
 * OAIGetOneRecurringPayment_200_response_result_subscriber.h
 *
 * 
 */

#ifndef OAIGetOneRecurringPayment_200_response_result_subscriber_H
#define OAIGetOneRecurringPayment_200_response_result_subscriber_H
...
class OAIGetOneRecurringPayment_200_response_result_subscriber : public OAIObject {
public:
    OAIGetOneRecurringPayment_200_response_result_subscriber();
    OAIGetOneRecurringPayment_200_response_result_subscriber(QString json);
    ~OAIGetOneRecurringPayment_200_response_result_subscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOneRecurringPayment_200_response_result_subscriber)

#endif // OAIGetOneRecurringPayment_200_response_result_subscriber_H
