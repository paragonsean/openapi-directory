...
/*
 * OAIGetOneRecurringPayment_404_response.h
 *
 * 
 */

#ifndef OAIGetOneRecurringPayment_404_response_H
#define OAIGetOneRecurringPayment_404_response_H
...
class OAIGetOneRecurringPayment_404_response : public OAIObject {
public:
    OAIGetOneRecurringPayment_404_response();
    OAIGetOneRecurringPayment_404_response(QString json);
    ~OAIGetOneRecurringPayment_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOneRecurringPayment_404_response)

#endif // OAIGetOneRecurringPayment_404_response_H
