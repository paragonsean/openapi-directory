...
#include "OAIGetManyRecurringPayments_200_response.h"
...
OAIGetManyRecurringPayments_200_response::OAIGetManyRecurringPayments_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetManyRecurringPayments_200_response::OAIGetManyRecurringPayments_200_response() {
    this->initializeModel();
}

OAIGetManyRecurringPayments_200_response::~OAIGetManyRecurringPayments_200_response() {}

void OAIGetManyRecurringPayments_200_response::initializeModel() {
...
void OAIGetManyRecurringPayments_200_response::fromJson(QString jsonString) {
...
void OAIGetManyRecurringPayments_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetManyRecurringPayments_200_response::asJson() const {
...
QJsonObject OAIGetManyRecurringPayments_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
double OAIGetManyRecurringPayments_200_response::getCount() const {
    return m_count;
}
void OAIGetManyRecurringPayments_200_response::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIGetManyRecurringPayments_200_response::is_count_Set() const{
    return m_count_isSet;
}

bool OAIGetManyRecurringPayments_200_response::is_count_Valid() const{
    return m_count_isValid;
}

QList<OAIGetManyRecurringPayments_200_response_result_inner> OAIGetManyRecurringPayments_200_response::getResult() const {
    return m_result;
}
void OAIGetManyRecurringPayments_200_response::setResult(const QList<OAIGetManyRecurringPayments_200_response_result_inner> &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIGetManyRecurringPayments_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIGetManyRecurringPayments_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIGetManyRecurringPayments_200_response::isSet() const {
...
bool OAIGetManyRecurringPayments_200_response::isValid() const {
