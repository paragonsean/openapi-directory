...
/*
 * OAIUpdatePlan_request.h
 *
 * 
 */

#ifndef OAIUpdatePlan_request_H
#define OAIUpdatePlan_request_H
...
class OAIUpdatePlan_request : public OAIObject {
public:
    OAIUpdatePlan_request();
    OAIUpdatePlan_request(QString json);
    ~OAIUpdatePlan_request() override;
    ...
    double getIntervalDay() const;
    void setIntervalDay(const double &interval_day);
    bool is_interval_day_Set() const;
    bool is_interval_day_Valid() const;
...
private:
    ...
    double m_interval_day;
    bool m_interval_day_isSet;
    bool m_interval_day_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePlan_request)

#endif // OAIUpdatePlan_request_H
