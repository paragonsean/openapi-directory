...
/*
 * OAIGetManyRecurringPayments_200_response_result_inner_subscriber.h
 *
 * 
 */

#ifndef OAIGetManyRecurringPayments_200_response_result_inner_subscriber_H
#define OAIGetManyRecurringPayments_200_response_result_inner_subscriber_H
...
class OAIGetManyRecurringPayments_200_response_result_inner_subscriber : public OAIObject {
public:
    OAIGetManyRecurringPayments_200_response_result_inner_subscriber();
    OAIGetManyRecurringPayments_200_response_result_inner_subscriber(QString json);
    ~OAIGetManyRecurringPayments_200_response_result_inner_subscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetManyRecurringPayments_200_response_result_inner_subscriber)

#endif // OAIGetManyRecurringPayments_200_response_result_inner_subscriber_H
