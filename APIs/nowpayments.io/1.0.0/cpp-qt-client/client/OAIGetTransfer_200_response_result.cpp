...
#include "OAIGetTransfer_200_response_result.h"
...
OAIGetTransfer_200_response_result::OAIGetTransfer_200_response_result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTransfer_200_response_result::OAIGetTransfer_200_response_result() {
    this->initializeModel();
}

OAIGetTransfer_200_response_result::~OAIGetTransfer_200_response_result() {}

void OAIGetTransfer_200_response_result::initializeModel() {
    ...
    m_from_sub_id_isSet = false;
    m_from_sub_id_isValid = false;
    ...
    m_to_sub_id_isSet = false;
    m_to_sub_id_isValid = false;

    m_updated_at_isSet = false;
    m_updated_at_isValid = false;
}

void OAIGetTransfer_200_response_result::fromJson(QString jsonString) {
...
void OAIGetTransfer_200_response_result::fromJsonObject(QJsonObject json) {
    ...
    m_from_sub_id_isValid = ::OpenAPI::fromJsonValue(m_from_sub_id, json[QString("from_sub_id")]);
    m_from_sub_id_isSet = !json[QString("from_sub_id")].isNull() && m_from_sub_id_isValid;
    ...
    m_to_sub_id_isValid = ::OpenAPI::fromJsonValue(m_to_sub_id, json[QString("to_sub_id")]);
    m_to_sub_id_isSet = !json[QString("to_sub_id")].isNull() && m_to_sub_id_isValid;

    m_updated_at_isValid = ::OpenAPI::fromJsonValue(m_updated_at, json[QString("updated_at")]);
    m_updated_at_isSet = !json[QString("updated_at")].isNull() && m_updated_at_isValid;
}

QString OAIGetTransfer_200_response_result::asJson() const {
...
QJsonObject OAIGetTransfer_200_response_result::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
    ...
    if (m_from_sub_id_isSet) {
        obj.insert(QString("from_sub_id"), ::OpenAPI::toJsonValue(m_from_sub_id));
    }
    if (m_id_isSet) {
    ...
    if (m_to_sub_id_isSet) {
        obj.insert(QString("to_sub_id"), ::OpenAPI::toJsonValue(m_to_sub_id));
    }
...
QString OAIGetTransfer_200_response_result::getAmount() const {
    return m_amount;
}
void OAIGetTransfer_200_response_result::setAmount(const QString &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIGetTransfer_200_response_result::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIGetTransfer_200_response_result::getCreatedAt() const {
    return m_created_at;
}
void OAIGetTransfer_200_response_result::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetTransfer_200_response_result::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIGetTransfer_200_response_result::getCurrency() const {
    return m_currency;
}
void OAIGetTransfer_200_response_result::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIGetTransfer_200_response_result::is_currency_Valid() const{
    return m_currency_isValid;
}

QString OAIGetTransfer_200_response_result::getFromSubId() const {
    return m_from_sub_id;
}
void OAIGetTransfer_200_response_result::setFromSubId(const QString &from_sub_id) {
    m_from_sub_id = from_sub_id;
    m_from_sub_id_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_from_sub_id_Set() const{
    return m_from_sub_id_isSet;
}

bool OAIGetTransfer_200_response_result::is_from_sub_id_Valid() const{
    return m_from_sub_id_isValid;
}

QString OAIGetTransfer_200_response_result::getId() const {
    return m_id;
}
void OAIGetTransfer_200_response_result::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetTransfer_200_response_result::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetTransfer_200_response_result::getStatus() const {
    return m_status;
}
void OAIGetTransfer_200_response_result::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetTransfer_200_response_result::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIGetTransfer_200_response_result::getToSubId() const {
    return m_to_sub_id;
}
void OAIGetTransfer_200_response_result::setToSubId(const QString &to_sub_id) {
    m_to_sub_id = to_sub_id;
    m_to_sub_id_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_to_sub_id_Set() const{
    return m_to_sub_id_isSet;
}

bool OAIGetTransfer_200_response_result::is_to_sub_id_Valid() const{
    return m_to_sub_id_isValid;
}

QString OAIGetTransfer_200_response_result::getUpdatedAt() const {
    return m_updated_at;
}
void OAIGetTransfer_200_response_result::setUpdatedAt(const QString &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIGetTransfer_200_response_result::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIGetTransfer_200_response_result::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIGetTransfer_200_response_result::isSet() const {
...
bool OAIGetTransfer_200_response_result::isValid() const {
