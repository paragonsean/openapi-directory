...
OAIGetUpdatePaymentEstimate_200_response::OAIGetUpdatePaymentEstimate_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUpdatePaymentEstimate_200_response::OAIGetUpdatePaymentEstimate_200_response() {
    this->initializeModel();
}

OAIGetUpdatePaymentEstimate_200_response::~OAIGetUpdatePaymentEstimate_200_response() {}

void OAIGetUpdatePaymentEstimate_200_response::initializeModel() {

    m_expiration_estimate_date_isSet = false;
    m_expiration_estimate_date_isValid = false;
...
void OAIGetUpdatePaymentEstimate_200_response::fromJson(QString jsonString) {
...
void OAIGetUpdatePaymentEstimate_200_response::fromJsonObject(QJsonObject json) {

    m_expiration_estimate_date_isValid = ::OpenAPI::fromJsonValue(m_expiration_estimate_date, json[QString("expiration_estimate_date")]);
    m_expiration_estimate_date_isSet = !json[QString("expiration_estimate_date")].isNull() && m_expiration_estimate_date_isValid;
...
QString OAIGetUpdatePaymentEstimate_200_response::asJson() const {
...
QJsonObject OAIGetUpdatePaymentEstimate_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_expiration_estimate_date_isSet) {
        obj.insert(QString("expiration_estimate_date"), ::OpenAPI::toJsonValue(m_expiration_estimate_date));
    }
    if (m_id_isSet) {
...
QString OAIGetUpdatePaymentEstimate_200_response::getExpirationEstimateDate() const {
    return m_expiration_estimate_date;
}
void OAIGetUpdatePaymentEstimate_200_response::setExpirationEstimateDate(const QString &expiration_estimate_date) {
    m_expiration_estimate_date = expiration_estimate_date;
    m_expiration_estimate_date_isSet = true;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_expiration_estimate_date_Set() const{
    return m_expiration_estimate_date_isSet;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_expiration_estimate_date_Valid() const{
    return m_expiration_estimate_date_isValid;
}

QString OAIGetUpdatePaymentEstimate_200_response::getId() const {
    return m_id;
}
void OAIGetUpdatePaymentEstimate_200_response::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_id_Valid() const{
    return m_id_isValid;
}

double OAIGetUpdatePaymentEstimate_200_response::getPayAmount() const {
    return m_pay_amount;
}
void OAIGetUpdatePaymentEstimate_200_response::setPayAmount(const double &pay_amount) {
    m_pay_amount = pay_amount;
    m_pay_amount_isSet = true;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_pay_amount_Set() const{
    return m_pay_amount_isSet;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_pay_amount_Valid() const{
    return m_pay_amount_isValid;
}

QString OAIGetUpdatePaymentEstimate_200_response::getTokenId() const {
    return m_token_id;
}
void OAIGetUpdatePaymentEstimate_200_response::setTokenId(const QString &token_id) {
    m_token_id = token_id;
    m_token_id_isSet = true;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_token_id_Set() const{
    return m_token_id_isSet;
}

bool OAIGetUpdatePaymentEstimate_200_response::is_token_id_Valid() const{
    return m_token_id_isValid;
}

bool OAIGetUpdatePaymentEstimate_200_response::isSet() const {
...
bool OAIGetUpdatePaymentEstimate_200_response::isValid() const {
