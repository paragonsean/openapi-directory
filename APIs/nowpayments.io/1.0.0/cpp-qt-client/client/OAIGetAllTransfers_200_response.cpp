...
#include "OAIGetAllTransfers_200_response.h"
...
OAIGetAllTransfers_200_response::OAIGetAllTransfers_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAllTransfers_200_response::OAIGetAllTransfers_200_response() {
    this->initializeModel();
}

OAIGetAllTransfers_200_response::~OAIGetAllTransfers_200_response() {}

void OAIGetAllTransfers_200_response::initializeModel() {
...
void OAIGetAllTransfers_200_response::fromJson(QString jsonString) {
...
void OAIGetAllTransfers_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetAllTransfers_200_response::asJson() const {
...
QJsonObject OAIGetAllTransfers_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
double OAIGetAllTransfers_200_response::getCount() const {
    return m_count;
}
void OAIGetAllTransfers_200_response::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIGetAllTransfers_200_response::is_count_Set() const{
    return m_count_isSet;
}

bool OAIGetAllTransfers_200_response::is_count_Valid() const{
    return m_count_isValid;
}

QList<OAIGetAllTransfers_200_response_result_inner> OAIGetAllTransfers_200_response::getResult() const {
    return m_result;
}
void OAIGetAllTransfers_200_response::setResult(const QList<OAIGetAllTransfers_200_response_result_inner> &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIGetAllTransfers_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIGetAllTransfers_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIGetAllTransfers_200_response::isSet() const {
...
bool OAIGetAllTransfers_200_response::isValid() const {
