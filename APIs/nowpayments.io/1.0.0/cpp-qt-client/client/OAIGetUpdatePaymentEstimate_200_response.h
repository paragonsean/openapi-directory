...
/*
 * OAIGetUpdatePaymentEstimate_200_response.h
 *
 * 
 */

#ifndef OAIGetUpdatePaymentEstimate_200_response_H
#define OAIGetUpdatePaymentEstimate_200_response_H
...
class OAIGetUpdatePaymentEstimate_200_response : public OAIObject {
public:
    OAIGetUpdatePaymentEstimate_200_response();
    OAIGetUpdatePaymentEstimate_200_response(QString json);
    ~OAIGetUpdatePaymentEstimate_200_response() override;
    ...
    QString getExpirationEstimateDate() const;
    void setExpirationEstimateDate(const QString &expiration_estimate_date);
    bool is_expiration_estimate_date_Set() const;
    bool is_expiration_estimate_date_Valid() const;
...
private:
    ...
    QString m_expiration_estimate_date;
    bool m_expiration_estimate_date_isSet;
    bool m_expiration_estimate_date_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUpdatePaymentEstimate_200_response)

#endif // OAIGetUpdatePaymentEstimate_200_response_H
