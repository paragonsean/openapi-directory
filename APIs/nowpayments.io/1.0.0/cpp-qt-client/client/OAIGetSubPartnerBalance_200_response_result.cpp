...
#include "OAIGetSubPartnerBalance_200_response_result.h"
...
OAIGetSubPartnerBalance_200_response_result::OAIGetSubPartnerBalance_200_response_result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSubPartnerBalance_200_response_result::OAIGetSubPartnerBalance_200_response_result() {
    this->initializeModel();
}

OAIGetSubPartnerBalance_200_response_result::~OAIGetSubPartnerBalance_200_response_result() {}

void OAIGetSubPartnerBalance_200_response_result::initializeModel() {
...
void OAIGetSubPartnerBalance_200_response_result::fromJson(QString jsonString) {
...
void OAIGetSubPartnerBalance_200_response_result::fromJsonObject(QJsonObject json) {
    ...
    m_sub_partner_id_isValid = ::OpenAPI::fromJsonValue(m_sub_partner_id, json[QString("subPartnerId")]);
    m_sub_partner_id_isSet = !json[QString("subPartnerId")].isNull() && m_sub_partner_id_isValid;
}

QString OAIGetSubPartnerBalance_200_response_result::asJson() const {
...
QJsonObject OAIGetSubPartnerBalance_200_response_result::asJsonObject() const {
    QJsonObject obj;
    if (m_balances.isSet()) {
        obj.insert(QString("balances"), ::OpenAPI::toJsonValue(m_balances));
    }
    if (m_sub_partner_id_isSet) {
        obj.insert(QString("subPartnerId"), ::OpenAPI::toJsonValue(m_sub_partner_id));
    }
    return obj;
}

OAIGetSubPartnerBalance_200_response_result_balances OAIGetSubPartnerBalance_200_response_result::getBalances() const {
    return m_balances;
}
void OAIGetSubPartnerBalance_200_response_result::setBalances(const OAIGetSubPartnerBalance_200_response_result_balances &balances) {
    m_balances = balances;
    m_balances_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result::is_balances_Set() const{
    return m_balances_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result::is_balances_Valid() const{
    return m_balances_isValid;
}

QString OAIGetSubPartnerBalance_200_response_result::getSubPartnerId() const {
    return m_sub_partner_id;
}
void OAIGetSubPartnerBalance_200_response_result::setSubPartnerId(const QString &sub_partner_id) {
    m_sub_partner_id = sub_partner_id;
    m_sub_partner_id_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result::is_sub_partner_id_Set() const{
    return m_sub_partner_id_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result::is_sub_partner_id_Valid() const{
    return m_sub_partner_id_isValid;
}

bool OAIGetSubPartnerBalance_200_response_result::isSet() const {
...
bool OAIGetSubPartnerBalance_200_response_result::isValid() const {
