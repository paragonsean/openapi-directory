...
/*
 * OAIGetPaymentStatus_200_response.h
 *
 * 
 */

#ifndef OAIGetPaymentStatus_200_response_H
#define OAIGetPaymentStatus_200_response_H
...
class OAIGetPaymentStatus_200_response : public OAIObject {
public:
    OAIGetPaymentStatus_200_response();
    OAIGetPaymentStatus_200_response(QString json);
    ~OAIGetPaymentStatus_200_response() override;
    ...
    double getActuallyPaid() const;
    void setActuallyPaid(const double &actually_paid);
    bool is_actually_paid_Set() const;
    bool is_actually_paid_Valid() const;
    ...
    void setOrderDescription(const QString &order_description);
    bool is_order_description_Set() const;
    bool is_order_description_Valid() const;
    ...
    double getOutcomeAmount() const;
    void setOutcomeAmount(const double &outcome_amount);
    bool is_outcome_amount_Set() const;
    bool is_outcome_amount_Valid() const;

    QString getOutcomeCurrency() const;
    void setOutcomeCurrency(const QString &outcome_currency);
    bool is_outcome_currency_Set() const;
    bool is_outcome_currency_Valid() const;

    QString getPayAddress() const;
    void setPayAddress(const QString &pay_address);
    bool is_pay_address_Set() const;
    bool is_pay_address_Valid() const;
    ...
    double getPaymentId() const;
    void setPaymentId(const double &payment_id);
...
private:
    ...
    double m_actually_paid;
    bool m_actually_paid_isSet;
    bool m_actually_paid_isValid;

    QString m_created_at;
    bool m_created_at_isSet;
    bool m_created_at_isValid;

    QString m_order_description;
    bool m_order_description_isSet;
    bool m_order_description_isValid;

    QString m_order_id;
    bool m_order_id_isSet;
    bool m_order_id_isValid;

    double m_outcome_amount;
    bool m_outcome_amount_isSet;
    bool m_outcome_amount_isValid;

    QString m_outcome_currency;
    bool m_outcome_currency_isSet;
    bool m_outcome_currency_isValid;

    QString m_pay_address;
    bool m_pay_address_isSet;
    bool m_pay_address_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPaymentStatus_200_response)

#endif // OAIGetPaymentStatus_200_response_H
