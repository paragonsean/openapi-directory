...
OAIGetManyPlans_200_response::OAIGetManyPlans_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetManyPlans_200_response::OAIGetManyPlans_200_response() {
    this->initializeModel();
}

OAIGetManyPlans_200_response::~OAIGetManyPlans_200_response() {}

void OAIGetManyPlans_200_response::initializeModel() {
...
void OAIGetManyPlans_200_response::fromJson(QString jsonString) {
...
void OAIGetManyPlans_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetManyPlans_200_response::asJson() const {
...
QJsonObject OAIGetManyPlans_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_count_isSet) {
...
double OAIGetManyPlans_200_response::getCount() const {
    return m_count;
}
void OAIGetManyPlans_200_response::setCount(const double &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIGetManyPlans_200_response::is_count_Set() const{
    return m_count_isSet;
}

bool OAIGetManyPlans_200_response::is_count_Valid() const{
    return m_count_isValid;
}

QList<OAIGetManyPlans_200_response_result_inner> OAIGetManyPlans_200_response::getResult() const {
    return m_result;
}
void OAIGetManyPlans_200_response::setResult(const QList<OAIGetManyPlans_200_response_result_inner> &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIGetManyPlans_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIGetManyPlans_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIGetManyPlans_200_response::isSet() const {
...
bool OAIGetManyPlans_200_response::isValid() const {
