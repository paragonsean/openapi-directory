...
/*
 * OAIGetOneRecurringPayment_200_response_result.h
 *
 * 
 */

#ifndef OAIGetOneRecurringPayment_200_response_result_H
#define OAIGetOneRecurringPayment_200_response_result_H
...
namespace OpenAPI {
class OAIGetOneRecurringPayment_200_response_result_subscriber;

class OAIGetOneRecurringPayment_200_response_result : public OAIObject {
public:
    OAIGetOneRecurringPayment_200_response_result();
    OAIGetOneRecurringPayment_200_response_result(QString json);
    ~OAIGetOneRecurringPayment_200_response_result() override;
    ...
    OAIGetOneRecurringPayment_200_response_result_subscriber getSubscriber() const;
    void setSubscriber(const OAIGetOneRecurringPayment_200_response_result_subscriber &subscriber);
...
private:
    ...
    OAIGetOneRecurringPayment_200_response_result_subscriber m_subscriber;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOneRecurringPayment_200_response_result)

#endif // OAIGetOneRecurringPayment_200_response_result_H
