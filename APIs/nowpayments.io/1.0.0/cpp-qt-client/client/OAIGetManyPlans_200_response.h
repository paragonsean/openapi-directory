...
/*
 * OAIGetManyPlans_200_response.h
 *
 * 
 */

#ifndef OAIGetManyPlans_200_response_H
#define OAIGetManyPlans_200_response_H
...
namespace OpenAPI {
class OAIGetManyPlans_200_response_result_inner;

class OAIGetManyPlans_200_response : public OAIObject {
public:
    OAIGetManyPlans_200_response();
    OAIGetManyPlans_200_response(QString json);
    ~OAIGetManyPlans_200_response() override;
    ...
    QList<OAIGetManyPlans_200_response_result_inner> getResult() const;
    void setResult(const QList<OAIGetManyPlans_200_response_result_inner> &result);
...
private:
    ...
    QList<OAIGetManyPlans_200_response_result_inner> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetManyPlans_200_response)

#endif // OAIGetManyPlans_200_response_H
