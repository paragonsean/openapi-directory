...
/*
 * OAIGetOnePlan_200_response.h
 *
 * 
 */

#ifndef OAIGetOnePlan_200_response_H
#define OAIGetOnePlan_200_response_H
...
namespace OpenAPI {
class OAIGetOnePlan_200_response_result;

class OAIGetOnePlan_200_response : public OAIObject {
public:
    OAIGetOnePlan_200_response();
    OAIGetOnePlan_200_response(QString json);
    ~OAIGetOnePlan_200_response() override;
    ...
    OAIGetOnePlan_200_response_result getResult() const;
    void setResult(const OAIGetOnePlan_200_response_result &result);
...
private:
    ...
    OAIGetOnePlan_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOnePlan_200_response)

#endif // OAIGetOnePlan_200_response_H
