...
#include "OAIGetOnePlan_200_response_result.h"
...
OAIGetOnePlan_200_response_result::OAIGetOnePlan_200_response_result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOnePlan_200_response_result::OAIGetOnePlan_200_response_result() {
    this->initializeModel();
}

OAIGetOnePlan_200_response_result::~OAIGetOnePlan_200_response_result() {}

void OAIGetOnePlan_200_response_result::initializeModel() {
    ...
    m_interval_day_isSet = false;
    m_interval_day_isValid = false;

    m_ipn_callback_url_isSet = false;
    m_ipn_callback_url_isValid = false;

    m_partially_paid_url_isSet = false;
    m_partially_paid_url_isValid = false;
...
void OAIGetOnePlan_200_response_result::fromJson(QString jsonString) {
...
void OAIGetOnePlan_200_response_result::fromJsonObject(QJsonObject json) {
    ...
    m_interval_day_isValid = ::OpenAPI::fromJsonValue(m_interval_day, json[QString("interval_day")]);
    m_interval_day_isSet = !json[QString("interval_day")].isNull() && m_interval_day_isValid;

    m_ipn_callback_url_isValid = ::OpenAPI::fromJsonValue(m_ipn_callback_url, json[QString("ipn_callback_url")]);
    m_ipn_callback_url_isSet = !json[QString("ipn_callback_url")].isNull() && m_ipn_callback_url_isValid;

    m_partially_paid_url_isValid = ::OpenAPI::fromJsonValue(m_partially_paid_url, json[QString("partially_paid_url")]);
    m_partially_paid_url_isSet = !json[QString("partially_paid_url")].isNull() && m_partially_paid_url_isValid;

    m_success_url_isValid = ::OpenAPI::fromJsonValue(m_success_url, json[QString("success_url")]);
    m_success_url_isSet = !json[QString("success_url")].isNull() && m_success_url_isValid;
...
QString OAIGetOnePlan_200_response_result::asJson() const {
...
QJsonObject OAIGetOnePlan_200_response_result::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
    ...
    if (m_interval_day_isSet) {
        obj.insert(QString("interval_day"), ::OpenAPI::toJsonValue(m_interval_day));
    }
    if (m_ipn_callback_url_isSet) {
        obj.insert(QString("ipn_callback_url"), ::OpenAPI::toJsonValue(m_ipn_callback_url));
    }
    if (m_partially_paid_url_isSet) {
        obj.insert(QString("partially_paid_url"), ::OpenAPI::toJsonValue(m_partially_paid_url));
    }
    if (m_success_url_isSet) {
        obj.insert(QString("success_url"), ::OpenAPI::toJsonValue(m_success_url));
    }
    if (m_title_isSet) {
...
double OAIGetOnePlan_200_response_result::getAmount() const {
    return m_amount;
}
void OAIGetOnePlan_200_response_result::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIGetOnePlan_200_response_result::is_amount_Valid() const{
    return m_amount_isValid;
}

QJsonValue OAIGetOnePlan_200_response_result::getCancelUrl() const {
    return m_cancel_url;
}
void OAIGetOnePlan_200_response_result::setCancelUrl(const QJsonValue &cancel_url) {
    m_cancel_url = cancel_url;
    m_cancel_url_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_cancel_url_Set() const{
    return m_cancel_url_isSet;
}

bool OAIGetOnePlan_200_response_result::is_cancel_url_Valid() const{
    return m_cancel_url_isValid;
}

QString OAIGetOnePlan_200_response_result::getCreatedAt() const {
    return m_created_at;
}
void OAIGetOnePlan_200_response_result::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetOnePlan_200_response_result::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIGetOnePlan_200_response_result::getCurrency() const {
    return m_currency;
}
void OAIGetOnePlan_200_response_result::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIGetOnePlan_200_response_result::is_currency_Valid() const{
    return m_currency_isValid;
}

QString OAIGetOnePlan_200_response_result::getId() const {
    return m_id;
}
void OAIGetOnePlan_200_response_result::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetOnePlan_200_response_result::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetOnePlan_200_response_result::getIntervalDay() const {
    return m_interval_day;
}
void OAIGetOnePlan_200_response_result::setIntervalDay(const QString &interval_day) {
    m_interval_day = interval_day;
    m_interval_day_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_interval_day_Set() const{
    return m_interval_day_isSet;
}

bool OAIGetOnePlan_200_response_result::is_interval_day_Valid() const{
    return m_interval_day_isValid;
}

QJsonValue OAIGetOnePlan_200_response_result::getIpnCallbackUrl() const {
    return m_ipn_callback_url;
}
void OAIGetOnePlan_200_response_result::setIpnCallbackUrl(const QJsonValue &ipn_callback_url) {
    m_ipn_callback_url = ipn_callback_url;
    m_ipn_callback_url_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_ipn_callback_url_Set() const{
    return m_ipn_callback_url_isSet;
}

bool OAIGetOnePlan_200_response_result::is_ipn_callback_url_Valid() const{
    return m_ipn_callback_url_isValid;
}

QJsonValue OAIGetOnePlan_200_response_result::getPartiallyPaidUrl() const {
    return m_partially_paid_url;
}
void OAIGetOnePlan_200_response_result::setPartiallyPaidUrl(const QJsonValue &partially_paid_url) {
    m_partially_paid_url = partially_paid_url;
    m_partially_paid_url_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_partially_paid_url_Set() const{
    return m_partially_paid_url_isSet;
}

bool OAIGetOnePlan_200_response_result::is_partially_paid_url_Valid() const{
    return m_partially_paid_url_isValid;
}

QJsonValue OAIGetOnePlan_200_response_result::getSuccessUrl() const {
    return m_success_url;
}
void OAIGetOnePlan_200_response_result::setSuccessUrl(const QJsonValue &success_url) {
    m_success_url = success_url;
    m_success_url_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_success_url_Set() const{
    return m_success_url_isSet;
}

bool OAIGetOnePlan_200_response_result::is_success_url_Valid() const{
    return m_success_url_isValid;
}

QString OAIGetOnePlan_200_response_result::getTitle() const {
    return m_title;
}
void OAIGetOnePlan_200_response_result::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_title_Set() const{
    return m_title_isSet;
}

bool OAIGetOnePlan_200_response_result::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIGetOnePlan_200_response_result::getUpdatedAt() const {
    return m_updated_at;
}
void OAIGetOnePlan_200_response_result::setUpdatedAt(const QString &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIGetOnePlan_200_response_result::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIGetOnePlan_200_response_result::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIGetOnePlan_200_response_result::isSet() const {
...
bool OAIGetOnePlan_200_response_result::isValid() const {
