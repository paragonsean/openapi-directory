...
#ifndef OAI_OAIRecurringPaymentsAPIEmailSubscriptionsFeatureApi_H
#define OAI_OAIRecurringPaymentsAPIEmailSubscriptionsFeatureApi_H
...
#include "OAIGetManyPlans_200_response.h"
#include "OAIGetManyRecurringPayments_200_response.h"
#include "OAIGetOnePlan_200_response.h"
#include "OAIGetOnePlan_404_response.h"
#include "OAIGetOneRecurringPayment_200_response.h"
#include "OAIGetOneRecurringPayment_404_response.h"
#include "OAIUpdatePlan_request.h"
#include <QString>
...
class OAIRecurringPaymentsAPIEmailSubscriptionsFeatureApi : public QObject {
    Q_OBJECT

public:
    OAIRecurringPaymentsAPIEmailSubscriptionsFeatureApi(const int timeOut = 0);
    ~OAIRecurringPaymentsAPIEmailSubscriptionsFeatureApi();
    ...
    */
    virtual void deleteRecurringPayment(const QString &sub_id);
    ...
    */
    virtual void getManyPlans(const ::OpenAPI::OptionalParam<QString> &limit = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &offset = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_api_key = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  status QString [optional]
    * @param[in]  subscription_plan_id QString [optional]
    * @param[in]  is_active QString [optional]
    * @param[in]  limit QString [optional]
    * @param[in]  offset QString [optional]
    * @param[in]  x_api_key QString [optional]
    */
    virtual void getManyRecurringPayments(const ::OpenAPI::OptionalParam<QString> &status = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &subscription_plan_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &is_active = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &limit = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &offset = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_api_key = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  plan_id QString [required]
    * @param[in]  x_api_key QString [optional]
    */
    virtual void getOnePlan(const QString &plan_id, const ::OpenAPI::OptionalParam<QString> &x_api_key = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  sub_id QString [required]
    * @param[in]  x_api_key QString [optional]
    */
    virtual void getOneRecurringPayment(const QString &sub_id, const ::OpenAPI::OptionalParam<QString> &x_api_key = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  plan_id QString [required]
    * @param[in]  oai_update_plan_request OAIUpdatePlan_request [optional]
    */
    virtual void updatePlan(const QString &plan_id, const ::OpenAPI::OptionalParam<OAIUpdatePlan_request> &oai_update_plan_request = ::OpenAPI::OptionalParam<OAIUpdatePlan_request>());
...
private:
    ...
    void deleteRecurringPaymentCallback(OAIHttpRequestWorker *worker);
    void getManyPlansCallback(OAIHttpRequestWorker *worker);
    void getManyRecurringPaymentsCallback(OAIHttpRequestWorker *worker);
    void getOnePlanCallback(OAIHttpRequestWorker *worker);
    void getOneRecurringPaymentCallback(OAIHttpRequestWorker *worker);
    void updatePlanCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void deleteRecurringPaymentSignal(OAIDeleteRecurringPayment_200_response summary);
    void getManyPlansSignal(OAIGetManyPlans_200_response summary);
    void getManyRecurringPaymentsSignal(OAIGetManyRecurringPayments_200_response summary);
    void getOnePlanSignal(OAIGetOnePlan_200_response summary);
    void getOneRecurringPaymentSignal(OAIGetOneRecurringPayment_200_response summary);
    void updatePlanSignal();


    void deleteRecurringPaymentSignalFull(OAIHttpRequestWorker *worker, OAIDeleteRecurringPayment_200_response summary);
    void getManyPlansSignalFull(OAIHttpRequestWorker *worker, OAIGetManyPlans_200_response summary);
    void getManyRecurringPaymentsSignalFull(OAIHttpRequestWorker *worker, OAIGetManyRecurringPayments_200_response summary);
    void getOnePlanSignalFull(OAIHttpRequestWorker *worker, OAIGetOnePlan_200_response summary);
    void getOneRecurringPaymentSignalFull(OAIHttpRequestWorker *worker, OAIGetOneRecurringPayment_200_response summary);
    void updatePlanSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use deleteRecurringPaymentSignalError() instead")
    void deleteRecurringPaymentSignalE(OAIDeleteRecurringPayment_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteRecurringPaymentSignalError(OAIDeleteRecurringPayment_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getManyPlansSignalError() instead")
    void getManyPlansSignalE(OAIGetManyPlans_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getManyPlansSignalError(OAIGetManyPlans_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getManyRecurringPaymentsSignalError() instead")
    void getManyRecurringPaymentsSignalE(OAIGetManyRecurringPayments_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getManyRecurringPaymentsSignalError(OAIGetManyRecurringPayments_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOnePlanSignalError() instead")
    void getOnePlanSignalE(OAIGetOnePlan_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOnePlanSignalError(OAIGetOnePlan_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOneRecurringPaymentSignalError() instead")
    void getOneRecurringPaymentSignalE(OAIGetOneRecurringPayment_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOneRecurringPaymentSignalError(OAIGetOneRecurringPayment_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updatePlanSignalError() instead")
    void updatePlanSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void updatePlanSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use deleteRecurringPaymentSignalErrorFull() instead")
    void deleteRecurringPaymentSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteRecurringPaymentSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getManyPlansSignalErrorFull() instead")
    void getManyPlansSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getManyPlansSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getManyRecurringPaymentsSignalErrorFull() instead")
    void getManyRecurringPaymentsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getManyRecurringPaymentsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOnePlanSignalErrorFull() instead")
    void getOnePlanSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getOnePlanSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOneRecurringPaymentSignalErrorFull() instead")
    void getOneRecurringPaymentSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getOneRecurringPaymentSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updatePlanSignalErrorFull() instead")
    void updatePlanSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updatePlanSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
