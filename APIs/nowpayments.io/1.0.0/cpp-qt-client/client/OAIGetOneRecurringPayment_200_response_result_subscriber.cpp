...
#include "OAIGetOneRecurringPayment_200_response_result_subscriber.h"
...
OAIGetOneRecurringPayment_200_response_result_subscriber::OAIGetOneRecurringPayment_200_response_result_subscriber(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOneRecurringPayment_200_response_result_subscriber::OAIGetOneRecurringPayment_200_response_result_subscriber() {
    this->initializeModel();
}

OAIGetOneRecurringPayment_200_response_result_subscriber::~OAIGetOneRecurringPayment_200_response_result_subscriber() {}

void OAIGetOneRecurringPayment_200_response_result_subscriber::initializeModel() {

    m_sub_partner_id_isSet = false;
    m_sub_partner_id_isValid = false;
}

void OAIGetOneRecurringPayment_200_response_result_subscriber::fromJson(QString jsonString) {
...
void OAIGetOneRecurringPayment_200_response_result_subscriber::fromJsonObject(QJsonObject json) {
...
QString OAIGetOneRecurringPayment_200_response_result_subscriber::asJson() const {
...
QJsonObject OAIGetOneRecurringPayment_200_response_result_subscriber::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetOneRecurringPayment_200_response_result_subscriber::getSubPartnerId() const {
    return m_sub_partner_id;
}
void OAIGetOneRecurringPayment_200_response_result_subscriber::setSubPartnerId(const QString &sub_partner_id) {
    m_sub_partner_id = sub_partner_id;
    m_sub_partner_id_isSet = true;
}

bool OAIGetOneRecurringPayment_200_response_result_subscriber::is_sub_partner_id_Set() const{
    return m_sub_partner_id_isSet;
}

bool OAIGetOneRecurringPayment_200_response_result_subscriber::is_sub_partner_id_Valid() const{
    return m_sub_partner_id_isValid;
}

bool OAIGetOneRecurringPayment_200_response_result_subscriber::isSet() const {
...
bool OAIGetOneRecurringPayment_200_response_result_subscriber::isValid() const {
