...
/*
 * OAIVerifyPayout_request.h
 *
 * 
 */

#ifndef OAIVerifyPayout_request_H
#define OAIVerifyPayout_request_H
...
class OAIVerifyPayout_request : public OAIObject {
public:
    OAIVerifyPayout_request();
    OAIVerifyPayout_request(QString json);
    ~OAIVerifyPayout_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyPayout_request)

#endif // OAIVerifyPayout_request_H
