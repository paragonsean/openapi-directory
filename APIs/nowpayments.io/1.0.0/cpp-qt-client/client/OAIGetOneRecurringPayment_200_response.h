...
/*
 * OAIGetOneRecurringPayment_200_response.h
 *
 * 
 */

#ifndef OAIGetOneRecurringPayment_200_response_H
#define OAIGetOneRecurringPayment_200_response_H
...
namespace OpenAPI {
class OAIGetOneRecurringPayment_200_response_result;

class OAIGetOneRecurringPayment_200_response : public OAIObject {
public:
    OAIGetOneRecurringPayment_200_response();
    OAIGetOneRecurringPayment_200_response(QString json);
    ~OAIGetOneRecurringPayment_200_response() override;
    ...
    OAIGetOneRecurringPayment_200_response_result getResult() const;
    void setResult(const OAIGetOneRecurringPayment_200_response_result &result);
...
private:
    ...
    OAIGetOneRecurringPayment_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOneRecurringPayment_200_response)

#endif // OAIGetOneRecurringPayment_200_response_H
