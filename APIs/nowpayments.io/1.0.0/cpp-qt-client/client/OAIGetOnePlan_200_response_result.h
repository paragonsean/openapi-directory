...
/*
 * OAIGetOnePlan_200_response_result.h
 *
 * 
 */

#ifndef OAIGetOnePlan_200_response_result_H
#define OAIGetOnePlan_200_response_result_H
...
class OAIGetOnePlan_200_response_result : public OAIObject {
public:
    OAIGetOnePlan_200_response_result();
    OAIGetOnePlan_200_response_result(QString json);
    ~OAIGetOnePlan_200_response_result() override;
    ...
    QJsonValue getCancelUrl() const;
    void setCancelUrl(const QJsonValue &cancel_url);
    ...
    QString getIntervalDay() const;
    void setIntervalDay(const QString &interval_day);
    bool is_interval_day_Set() const;
    bool is_interval_day_Valid() const;

    QJsonValue getIpnCallbackUrl() const;
    void setIpnCallbackUrl(const QJsonValue &ipn_callback_url);
    bool is_ipn_callback_url_Set() const;
    bool is_ipn_callback_url_Valid() const;

    QJsonValue getPartiallyPaidUrl() const;
    void setPartiallyPaidUrl(const QJsonValue &partially_paid_url);
    bool is_partially_paid_url_Set() const;
    bool is_partially_paid_url_Valid() const;

    QJsonValue getSuccessUrl() const;
    void setSuccessUrl(const QJsonValue &success_url);
...
private:
    ...
    QString m_interval_day;
    bool m_interval_day_isSet;
    bool m_interval_day_isValid;

    QJsonValue m_ipn_callback_url;
    bool m_ipn_callback_url_isSet;
    bool m_ipn_callback_url_isValid;

    QJsonValue m_partially_paid_url;
    bool m_partially_paid_url_isSet;
    bool m_partially_paid_url_isValid;

    QJsonValue m_success_url;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOnePlan_200_response_result)

#endif // OAIGetOnePlan_200_response_result_H
