...
#include "OAIGetSubPartnerBalance_200_response.h"
...
OAIGetSubPartnerBalance_200_response::OAIGetSubPartnerBalance_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSubPartnerBalance_200_response::OAIGetSubPartnerBalance_200_response() {
    this->initializeModel();
}

OAIGetSubPartnerBalance_200_response::~OAIGetSubPartnerBalance_200_response() {}

void OAIGetSubPartnerBalance_200_response::initializeModel() {

    m_result_isSet = false;
    m_result_isValid = false;
}

void OAIGetSubPartnerBalance_200_response::fromJson(QString jsonString) {
...
void OAIGetSubPartnerBalance_200_response::fromJsonObject(QJsonObject json) {

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;
}

QString OAIGetSubPartnerBalance_200_response::asJson() const {
...
QJsonObject OAIGetSubPartnerBalance_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_result.isSet()) {
...
OAIGetSubPartnerBalance_200_response_result OAIGetSubPartnerBalance_200_response::getResult() const {
    return m_result;
}
void OAIGetSubPartnerBalance_200_response::setResult(const OAIGetSubPartnerBalance_200_response_result &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIGetSubPartnerBalance_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIGetSubPartnerBalance_200_response::isSet() const {
...
bool OAIGetSubPartnerBalance_200_response::isValid() const {
