...
/*
 * OAIDeleteRecurringPayment_200_response.h
 *
 * 
 */

#ifndef OAIDeleteRecurringPayment_200_response_H
#define OAIDeleteRecurringPayment_200_response_H
...
class OAIDeleteRecurringPayment_200_response : public OAIObject {
public:
    OAIDeleteRecurringPayment_200_response();
    OAIDeleteRecurringPayment_200_response(QString json);
    ~OAIDeleteRecurringPayment_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRecurringPayment_200_response)

#endif // OAIDeleteRecurringPayment_200_response_H
