...
/*
 * OAIGetManyPlans_200_response_result_inner.h
 *
 * 
 */

#ifndef OAIGetManyPlans_200_response_result_inner_H
#define OAIGetManyPlans_200_response_result_inner_H
...
class OAIGetManyPlans_200_response_result_inner : public OAIObject {
public:
    OAIGetManyPlans_200_response_result_inner();
    OAIGetManyPlans_200_response_result_inner(QString json);
    ~OAIGetManyPlans_200_response_result_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetManyPlans_200_response_result_inner)

#endif // OAIGetManyPlans_200_response_result_inner_H
