...
#include "OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc.h"
...
OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc() {
    this->initializeModel();
}

OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::~OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc() {}

void OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::initializeModel() {

    m_amount_isSet = false;
    m_amount_isValid = false;

    m_pending_amount_isSet = false;
    m_pending_amount_isValid = false;
}

void OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::fromJson(QString jsonString) {
...
void OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::fromJsonObject(QJsonObject json) {

    m_amount_isValid = ::OpenAPI::fromJsonValue(m_amount, json[QString("amount")]);
    m_amount_isSet = !json[QString("amount")].isNull() && m_amount_isValid;

    m_pending_amount_isValid = ::OpenAPI::fromJsonValue(m_pending_amount, json[QString("pendingAmount")]);
    m_pending_amount_isSet = !json[QString("pendingAmount")].isNull() && m_pending_amount_isValid;
}

QString OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::asJson() const {
...
QJsonObject OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
        obj.insert(QString("amount"), ::OpenAPI::toJsonValue(m_amount));
    }
    if (m_pending_amount_isSet) {
        obj.insert(QString("pendingAmount"), ::OpenAPI::toJsonValue(m_pending_amount));
    }
    return obj;
}

double OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::getAmount() const {
    return m_amount;
}
void OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::getPendingAmount() const {
    return m_pending_amount;
}
void OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::setPendingAmount(const double &pending_amount) {
    m_pending_amount = pending_amount;
    m_pending_amount_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::is_pending_amount_Set() const{
    return m_pending_amount_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::is_pending_amount_Valid() const{
    return m_pending_amount_isValid;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::isSet() const {
...
bool OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc::isValid() const {
