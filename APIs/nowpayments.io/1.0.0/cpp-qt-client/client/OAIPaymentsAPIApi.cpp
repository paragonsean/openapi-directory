...
OAIPaymentsAPIApi::OAIPaymentsAPIApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPaymentsAPIApi::~OAIPaymentsAPIApi() {
}

void OAIPaymentsAPIApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getEstimatedPrice", defaultConf);
    _serverIndices.insert("getEstimatedPrice", 0);
    _serverConfigs.insert("getListOfPayments", defaultConf);
    _serverIndices.insert("getListOfPayments", 0);
    _serverConfigs.insert("getPaymentStatus", defaultConf);
    _serverIndices.insert("getPaymentStatus", 0);
    _serverConfigs.insert("getTheMinimumPaymentAmount", defaultConf);
    _serverIndices.insert("getTheMinimumPaymentAmount", 0);
    _serverConfigs.insert("getUpdatePaymentEstimate", defaultConf);
    _serverIndices.insert("getUpdatePaymentEstimate", 0);
}
...
*/
int OAIPaymentsAPIApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPaymentsAPIApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPaymentsAPIApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPaymentsAPIApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPaymentsAPIApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPaymentsAPIApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPaymentsAPIApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPaymentsAPIApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPaymentsAPIApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPaymentsAPIApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPaymentsAPIApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPaymentsAPIApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPaymentsAPIApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPaymentsAPIApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPaymentsAPIApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPaymentsAPIApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPaymentsAPIApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPaymentsAPIApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPaymentsAPIApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPaymentsAPIApi::getEstimatedPrice(const ::OpenAPI::OptionalParam<QString> &amount, const ::OpenAPI::OptionalParam<QString> &currency_from, const ::OpenAPI::OptionalParam<QString> &currency_to, const ::OpenAPI::OptionalParam<QString> &x_api_key) {
    QString fullPath = QString(_serverConfigs["getEstimatedPrice"][_serverIndices.value("getEstimatedPrice")].URL()+"/v1/estimate");
    ...
    if (currency_from.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "currency_from", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("currency_from")).append(querySuffix).append(QUrl::toPercentEncoding(currency_from.stringValue()));
    }
    if (currency_to.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "currency_to", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("currency_to")).append(querySuffix).append(QUrl::toPercentEncoding(currency_to.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentsAPIApi::getEstimatedPriceCallback);
    connect(this, &OAIPaymentsAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIPaymentsAPIApi::getEstimatedPriceCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetEstimatedPrice_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getEstimatedPriceSignal(output);
        Q_EMIT getEstimatedPriceSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getEstimatedPriceSignalE(output, error_type, error_str);
        Q_EMIT getEstimatedPriceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getEstimatedPriceSignalError(output, error_type, error_str);
        Q_EMIT getEstimatedPriceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentsAPIApi::getListOfPayments(const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &page, const ::OpenAPI::OptionalParam<QString> &sort_by, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<QString> &date_from, const ::OpenAPI::OptionalParam<QString> &date_to, const ::OpenAPI::OptionalParam<QString> &x_api_key) {
    QString fullPath = QString(_serverConfigs["getListOfPayments"][_serverIndices.value("getListOfPayments")].URL()+"/v1/payment/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentsAPIApi::getListOfPaymentsCallback);
    connect(this, &OAIPaymentsAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPaymentsAPIApi::getListOfPaymentsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetListOfPayments_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getListOfPaymentsSignal(output);
        Q_EMIT getListOfPaymentsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getListOfPaymentsSignalE(output, error_type, error_str);
        Q_EMIT getListOfPaymentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getListOfPaymentsSignalError(output, error_type, error_str);
        Q_EMIT getListOfPaymentsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentsAPIApi::getPaymentStatus(const QString &payment_id, const ::OpenAPI::OptionalParam<QString> &x_api_key) {
    QString fullPath = QString(_serverConfigs["getPaymentStatus"][_serverIndices.value("getPaymentStatus")].URL()+"/v1/payment/{payment_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentsAPIApi::getPaymentStatusCallback);
    connect(this, &OAIPaymentsAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPaymentsAPIApi::getPaymentStatusCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetPaymentStatus_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPaymentStatusSignal(output);
        Q_EMIT getPaymentStatusSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPaymentStatusSignalE(output, error_type, error_str);
        Q_EMIT getPaymentStatusSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPaymentStatusSignalError(output, error_type, error_str);
        Q_EMIT getPaymentStatusSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentsAPIApi::getTheMinimumPaymentAmount(const ::OpenAPI::OptionalParam<QString> &currency_from, const ::OpenAPI::OptionalParam<QString> &currency_to, const ::OpenAPI::OptionalParam<QString> &x_api_key) {
    QString fullPath = QString(_serverConfigs["getTheMinimumPaymentAmount"][_serverIndices.value("getTheMinimumPaymentAmount")].URL()+"/v1/min-amount");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentsAPIApi::getTheMinimumPaymentAmountCallback);
    connect(this, &OAIPaymentsAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPaymentsAPIApi::getTheMinimumPaymentAmountCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetTheMinimumPaymentAmount_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTheMinimumPaymentAmountSignal(output);
        Q_EMIT getTheMinimumPaymentAmountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTheMinimumPaymentAmountSignalE(output, error_type, error_str);
        Q_EMIT getTheMinimumPaymentAmountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTheMinimumPaymentAmountSignalError(output, error_type, error_str);
        Q_EMIT getTheMinimumPaymentAmountSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentsAPIApi::getUpdatePaymentEstimate(const QString &id, const ::OpenAPI::OptionalParam<QString> &x_api_key) {
    QString fullPath = QString(_serverConfigs["getUpdatePaymentEstimate"][_serverIndices.value("getUpdatePaymentEstimate")].URL()+"/v1/payment/{id}/update-merchant-estimate");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentsAPIApi::getUpdatePaymentEstimateCallback);
    connect(this, &OAIPaymentsAPIApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPaymentsAPIApi::getUpdatePaymentEstimateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetUpdatePaymentEstimate_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUpdatePaymentEstimateSignal(output);
        Q_EMIT getUpdatePaymentEstimateSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUpdatePaymentEstimateSignalE(output, error_type, error_str);
        Q_EMIT getUpdatePaymentEstimateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUpdatePaymentEstimateSignalError(output, error_type, error_str);
        Q_EMIT getUpdatePaymentEstimateSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentsAPIApi::tokenAvailable(){
