...
#include "OAIDeleteRecurringPayment_200_response.h"
...
OAIDeleteRecurringPayment_200_response::OAIDeleteRecurringPayment_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRecurringPayment_200_response::OAIDeleteRecurringPayment_200_response() {
    this->initializeModel();
}

OAIDeleteRecurringPayment_200_response::~OAIDeleteRecurringPayment_200_response() {}

void OAIDeleteRecurringPayment_200_response::initializeModel() {

    m_result_isSet = false;
    m_result_isValid = false;
}

void OAIDeleteRecurringPayment_200_response::fromJson(QString jsonString) {
...
void OAIDeleteRecurringPayment_200_response::fromJsonObject(QJsonObject json) {

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;
}

QString OAIDeleteRecurringPayment_200_response::asJson() const {
...
QJsonObject OAIDeleteRecurringPayment_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_result_isSet) {
...
QString OAIDeleteRecurringPayment_200_response::getResult() const {
    return m_result;
}
void OAIDeleteRecurringPayment_200_response::setResult(const QString &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIDeleteRecurringPayment_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIDeleteRecurringPayment_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIDeleteRecurringPayment_200_response::isSet() const {
...
bool OAIDeleteRecurringPayment_200_response::isValid() const {
