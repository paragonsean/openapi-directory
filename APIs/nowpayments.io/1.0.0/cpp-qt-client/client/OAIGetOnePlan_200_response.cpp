...
OAIGetOnePlan_200_response::OAIGetOnePlan_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOnePlan_200_response::OAIGetOnePlan_200_response() {
    this->initializeModel();
}

OAIGetOnePlan_200_response::~OAIGetOnePlan_200_response() {}

void OAIGetOnePlan_200_response::initializeModel() {

    m_result_isSet = false;
    m_result_isValid = false;
}

void OAIGetOnePlan_200_response::fromJson(QString jsonString) {
...
void OAIGetOnePlan_200_response::fromJsonObject(QJsonObject json) {

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;
}

QString OAIGetOnePlan_200_response::asJson() const {
...
QJsonObject OAIGetOnePlan_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_result.isSet()) {
...
OAIGetOnePlan_200_response_result OAIGetOnePlan_200_response::getResult() const {
    return m_result;
}
void OAIGetOnePlan_200_response::setResult(const OAIGetOnePlan_200_response_result &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIGetOnePlan_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIGetOnePlan_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIGetOnePlan_200_response::isSet() const {
...
bool OAIGetOnePlan_200_response::isValid() const {
