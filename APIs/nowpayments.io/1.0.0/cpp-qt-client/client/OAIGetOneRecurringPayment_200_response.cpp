...
OAIGetOneRecurringPayment_200_response::OAIGetOneRecurringPayment_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOneRecurringPayment_200_response::OAIGetOneRecurringPayment_200_response() {
    this->initializeModel();
}

OAIGetOneRecurringPayment_200_response::~OAIGetOneRecurringPayment_200_response() {}

void OAIGetOneRecurringPayment_200_response::initializeModel() {

    m_result_isSet = false;
    m_result_isValid = false;
}

void OAIGetOneRecurringPayment_200_response::fromJson(QString jsonString) {
...
void OAIGetOneRecurringPayment_200_response::fromJsonObject(QJsonObject json) {

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;
}

QString OAIGetOneRecurringPayment_200_response::asJson() const {
...
QJsonObject OAIGetOneRecurringPayment_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_result.isSet()) {
...
OAIGetOneRecurringPayment_200_response_result OAIGetOneRecurringPayment_200_response::getResult() const {
    return m_result;
}
void OAIGetOneRecurringPayment_200_response::setResult(const OAIGetOneRecurringPayment_200_response_result &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIGetOneRecurringPayment_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIGetOneRecurringPayment_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIGetOneRecurringPayment_200_response::isSet() const {
...
bool OAIGetOneRecurringPayment_200_response::isValid() const {
