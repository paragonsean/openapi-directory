...
#include "OAIGetTransfer_200_response.h"
...
OAIGetTransfer_200_response::OAIGetTransfer_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTransfer_200_response::OAIGetTransfer_200_response() {
    this->initializeModel();
}

OAIGetTransfer_200_response::~OAIGetTransfer_200_response() {}

void OAIGetTransfer_200_response::initializeModel() {

    m_result_isSet = false;
    m_result_isValid = false;
}

void OAIGetTransfer_200_response::fromJson(QString jsonString) {
...
void OAIGetTransfer_200_response::fromJsonObject(QJsonObject json) {

    m_result_isValid = ::OpenAPI::fromJsonValue(m_result, json[QString("result")]);
    m_result_isSet = !json[QString("result")].isNull() && m_result_isValid;
}

QString OAIGetTransfer_200_response::asJson() const {
...
QJsonObject OAIGetTransfer_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_result.isSet()) {
...
OAIGetTransfer_200_response_result OAIGetTransfer_200_response::getResult() const {
    return m_result;
}
void OAIGetTransfer_200_response::setResult(const OAIGetTransfer_200_response_result &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIGetTransfer_200_response::is_result_Set() const{
    return m_result_isSet;
}

bool OAIGetTransfer_200_response::is_result_Valid() const{
    return m_result_isValid;
}

bool OAIGetTransfer_200_response::isSet() const {
...
bool OAIGetTransfer_200_response::isValid() const {
