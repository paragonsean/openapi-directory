...
/*
 * OAIGetTransfer_200_response.h
 *
 * 
 */

#ifndef OAIGetTransfer_200_response_H
#define OAIGetTransfer_200_response_H
...
namespace OpenAPI {
class OAIGetTransfer_200_response_result;

class OAIGetTransfer_200_response : public OAIObject {
public:
    OAIGetTransfer_200_response();
    OAIGetTransfer_200_response(QString json);
    ~OAIGetTransfer_200_response() override;
    ...
    OAIGetTransfer_200_response_result getResult() const;
    void setResult(const OAIGetTransfer_200_response_result &result);
...
private:
    ...
    OAIGetTransfer_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTransfer_200_response)

#endif // OAIGetTransfer_200_response_H
