...
OAIGetManyRecurringPayments_200_response_result_inner_subscriber::OAIGetManyRecurringPayments_200_response_result_inner_subscriber(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetManyRecurringPayments_200_response_result_inner_subscriber::OAIGetManyRecurringPayments_200_response_result_inner_subscriber() {
    this->initializeModel();
}

OAIGetManyRecurringPayments_200_response_result_inner_subscriber::~OAIGetManyRecurringPayments_200_response_result_inner_subscriber() {}

void OAIGetManyRecurringPayments_200_response_result_inner_subscriber::initializeModel() {

    m_email_isSet = false;
    m_email_isValid = false;

    m_sub_partner_id_isSet = false;
    m_sub_partner_id_isValid = false;
}

void OAIGetManyRecurringPayments_200_response_result_inner_subscriber::fromJson(QString jsonString) {
...
void OAIGetManyRecurringPayments_200_response_result_inner_subscriber::fromJsonObject(QJsonObject json) {

    m_email_isValid = ::OpenAPI::fromJsonValue(m_email, json[QString("email")]);
    m_email_isSet = !json[QString("email")].isNull() && m_email_isValid;

    m_sub_partner_id_isValid = ::OpenAPI::fromJsonValue(m_sub_partner_id, json[QString("sub_partner_id")]);
    m_sub_partner_id_isSet = !json[QString("sub_partner_id")].isNull() && m_sub_partner_id_isValid;
}

QString OAIGetManyRecurringPayments_200_response_result_inner_subscriber::asJson() const {
...
QJsonObject OAIGetManyRecurringPayments_200_response_result_inner_subscriber::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
        obj.insert(QString("email"), ::OpenAPI::toJsonValue(m_email));
    }
    if (m_sub_partner_id_isSet) {
        obj.insert(QString("sub_partner_id"), ::OpenAPI::toJsonValue(m_sub_partner_id));
    }
    return obj;
}

QString OAIGetManyRecurringPayments_200_response_result_inner_subscriber::getEmail() const {
    return m_email;
}
void OAIGetManyRecurringPayments_200_response_result_inner_subscriber::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIGetManyRecurringPayments_200_response_result_inner_subscriber::is_email_Set() const{
    return m_email_isSet;
}

bool OAIGetManyRecurringPayments_200_response_result_inner_subscriber::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIGetManyRecurringPayments_200_response_result_inner_subscriber::getSubPartnerId() const {
    return m_sub_partner_id;
}
void OAIGetManyRecurringPayments_200_response_result_inner_subscriber::setSubPartnerId(const QString &sub_partner_id) {
    m_sub_partner_id = sub_partner_id;
    m_sub_partner_id_isSet = true;
}

bool OAIGetManyRecurringPayments_200_response_result_inner_subscriber::is_sub_partner_id_Set() const{
    return m_sub_partner_id_isSet;
}

bool OAIGetManyRecurringPayments_200_response_result_inner_subscriber::is_sub_partner_id_Valid() const{
    return m_sub_partner_id_isValid;
}

bool OAIGetManyRecurringPayments_200_response_result_inner_subscriber::isSet() const {
...
bool OAIGetManyRecurringPayments_200_response_result_inner_subscriber::isValid() const {
