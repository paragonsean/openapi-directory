...
OAIGetSubPartnerBalance_200_response_result_balances::OAIGetSubPartnerBalance_200_response_result_balances(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSubPartnerBalance_200_response_result_balances::OAIGetSubPartnerBalance_200_response_result_balances() {
    this->initializeModel();
}

OAIGetSubPartnerBalance_200_response_result_balances::~OAIGetSubPartnerBalance_200_response_result_balances() {}

void OAIGetSubPartnerBalance_200_response_result_balances::initializeModel() {

    m_usddtrc20_isSet = false;
    m_usddtrc20_isValid = false;

    m_usdtbsc_isSet = false;
    m_usdtbsc_isValid = false;
}

void OAIGetSubPartnerBalance_200_response_result_balances::fromJson(QString jsonString) {
...
void OAIGetSubPartnerBalance_200_response_result_balances::fromJsonObject(QJsonObject json) {

    m_usddtrc20_isValid = ::OpenAPI::fromJsonValue(m_usddtrc20, json[QString("usddtrc20")]);
    m_usddtrc20_isSet = !json[QString("usddtrc20")].isNull() && m_usddtrc20_isValid;

    m_usdtbsc_isValid = ::OpenAPI::fromJsonValue(m_usdtbsc, json[QString("usdtbsc")]);
    m_usdtbsc_isSet = !json[QString("usdtbsc")].isNull() && m_usdtbsc_isValid;
}

QString OAIGetSubPartnerBalance_200_response_result_balances::asJson() const {
...
QJsonObject OAIGetSubPartnerBalance_200_response_result_balances::asJsonObject() const {
    QJsonObject obj;
    if (m_usddtrc20.isSet()) {
        obj.insert(QString("usddtrc20"), ::OpenAPI::toJsonValue(m_usddtrc20));
    }
    if (m_usdtbsc.isSet()) {
        obj.insert(QString("usdtbsc"), ::OpenAPI::toJsonValue(m_usdtbsc));
    }
    return obj;
}

OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20 OAIGetSubPartnerBalance_200_response_result_balances::getUsddtrc20() const {
    return m_usddtrc20;
}
void OAIGetSubPartnerBalance_200_response_result_balances::setUsddtrc20(const OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20 &usddtrc20) {
    m_usddtrc20 = usddtrc20;
    m_usddtrc20_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result_balances::is_usddtrc20_Set() const{
    return m_usddtrc20_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result_balances::is_usddtrc20_Valid() const{
    return m_usddtrc20_isValid;
}

OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc OAIGetSubPartnerBalance_200_response_result_balances::getUsdtbsc() const {
    return m_usdtbsc;
}
void OAIGetSubPartnerBalance_200_response_result_balances::setUsdtbsc(const OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc &usdtbsc) {
    m_usdtbsc = usdtbsc;
    m_usdtbsc_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result_balances::is_usdtbsc_Set() const{
    return m_usdtbsc_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result_balances::is_usdtbsc_Valid() const{
    return m_usdtbsc_isValid;
}

bool OAIGetSubPartnerBalance_200_response_result_balances::isSet() const {
...
bool OAIGetSubPartnerBalance_200_response_result_balances::isValid() const {
