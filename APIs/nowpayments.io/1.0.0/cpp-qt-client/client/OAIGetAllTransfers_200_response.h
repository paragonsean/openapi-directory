...
/*
 * OAIGetAllTransfers_200_response.h
 *
 * 
 */

#ifndef OAIGetAllTransfers_200_response_H
#define OAIGetAllTransfers_200_response_H
...
namespace OpenAPI {
class OAIGetAllTransfers_200_response_result_inner;

class OAIGetAllTransfers_200_response : public OAIObject {
public:
    OAIGetAllTransfers_200_response();
    OAIGetAllTransfers_200_response(QString json);
    ~OAIGetAllTransfers_200_response() override;
    ...
    QList<OAIGetAllTransfers_200_response_result_inner> getResult() const;
    void setResult(const QList<OAIGetAllTransfers_200_response_result_inner> &result);
...
private:
    ...
    QList<OAIGetAllTransfers_200_response_result_inner> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAllTransfers_200_response)

#endif // OAIGetAllTransfers_200_response_H
