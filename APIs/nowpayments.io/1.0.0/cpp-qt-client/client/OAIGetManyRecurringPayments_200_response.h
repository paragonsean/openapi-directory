...
/*
 * OAIGetManyRecurringPayments_200_response.h
 *
 * 
 */

#ifndef OAIGetManyRecurringPayments_200_response_H
#define OAIGetManyRecurringPayments_200_response_H
...
namespace OpenAPI {
class OAIGetManyRecurringPayments_200_response_result_inner;

class OAIGetManyRecurringPayments_200_response : public OAIObject {
public:
    OAIGetManyRecurringPayments_200_response();
    OAIGetManyRecurringPayments_200_response(QString json);
    ~OAIGetManyRecurringPayments_200_response() override;
    ...
    QList<OAIGetManyRecurringPayments_200_response_result_inner> getResult() const;
    void setResult(const QList<OAIGetManyRecurringPayments_200_response_result_inner> &result);
...
private:
    ...
    QList<OAIGetManyRecurringPayments_200_response_result_inner> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetManyRecurringPayments_200_response)

#endif // OAIGetManyRecurringPayments_200_response_H
