...
OAIGetTheMinimumPaymentAmount_200_response::OAIGetTheMinimumPaymentAmount_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTheMinimumPaymentAmount_200_response::OAIGetTheMinimumPaymentAmount_200_response() {
    this->initializeModel();
}

OAIGetTheMinimumPaymentAmount_200_response::~OAIGetTheMinimumPaymentAmount_200_response() {}

void OAIGetTheMinimumPaymentAmount_200_response::initializeModel() {
    ...
    m_fiat_equivalent_isSet = false;
    m_fiat_equivalent_isValid = false;

    m_min_amount_isSet = false;
    m_min_amount_isValid = false;
}

void OAIGetTheMinimumPaymentAmount_200_response::fromJson(QString jsonString) {
...
void OAIGetTheMinimumPaymentAmount_200_response::fromJsonObject(QJsonObject json) {
    ...
    m_fiat_equivalent_isValid = ::OpenAPI::fromJsonValue(m_fiat_equivalent, json[QString("fiat_equivalent")]);
    m_fiat_equivalent_isSet = !json[QString("fiat_equivalent")].isNull() && m_fiat_equivalent_isValid;

    m_min_amount_isValid = ::OpenAPI::fromJsonValue(m_min_amount, json[QString("min_amount")]);
    m_min_amount_isSet = !json[QString("min_amount")].isNull() && m_min_amount_isValid;
}

QString OAIGetTheMinimumPaymentAmount_200_response::asJson() const {
...
QJsonObject OAIGetTheMinimumPaymentAmount_200_response::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_fiat_equivalent_isSet) {
        obj.insert(QString("fiat_equivalent"), ::OpenAPI::toJsonValue(m_fiat_equivalent));
    }
    if (m_min_amount_isSet) {
        obj.insert(QString("min_amount"), ::OpenAPI::toJsonValue(m_min_amount));
    }
    return obj;
}

QString OAIGetTheMinimumPaymentAmount_200_response::getCurrencyFrom() const {
    return m_currency_from;
}
void OAIGetTheMinimumPaymentAmount_200_response::setCurrencyFrom(const QString &currency_from) {
    m_currency_from = currency_from;
    m_currency_from_isSet = true;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_currency_from_Set() const{
    return m_currency_from_isSet;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_currency_from_Valid() const{
    return m_currency_from_isValid;
}

QString OAIGetTheMinimumPaymentAmount_200_response::getCurrencyTo() const {
    return m_currency_to;
}
void OAIGetTheMinimumPaymentAmount_200_response::setCurrencyTo(const QString &currency_to) {
    m_currency_to = currency_to;
    m_currency_to_isSet = true;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_currency_to_Set() const{
    return m_currency_to_isSet;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_currency_to_Valid() const{
    return m_currency_to_isValid;
}

double OAIGetTheMinimumPaymentAmount_200_response::getFiatEquivalent() const {
    return m_fiat_equivalent;
}
void OAIGetTheMinimumPaymentAmount_200_response::setFiatEquivalent(const double &fiat_equivalent) {
    m_fiat_equivalent = fiat_equivalent;
    m_fiat_equivalent_isSet = true;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_fiat_equivalent_Set() const{
    return m_fiat_equivalent_isSet;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_fiat_equivalent_Valid() const{
    return m_fiat_equivalent_isValid;
}

double OAIGetTheMinimumPaymentAmount_200_response::getMinAmount() const {
    return m_min_amount;
}
void OAIGetTheMinimumPaymentAmount_200_response::setMinAmount(const double &min_amount) {
    m_min_amount = min_amount;
    m_min_amount_isSet = true;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_min_amount_Set() const{
    return m_min_amount_isSet;
}

bool OAIGetTheMinimumPaymentAmount_200_response::is_min_amount_Valid() const{
    return m_min_amount_isValid;
}

bool OAIGetTheMinimumPaymentAmount_200_response::isSet() const {
...
bool OAIGetTheMinimumPaymentAmount_200_response::isValid() const {
