...
#ifndef OAI_OAIBillingSubPartnerAPIApi_H
#define OAI_OAIBillingSubPartnerAPIApi_H
...
class OAIBillingSubPartnerAPIApi : public QObject {
    Q_OBJECT

public:
    OAIBillingSubPartnerAPIApi(const int timeOut = 0);
    ~OAIBillingSubPartnerAPIApi();
    ...
    */
    virtual void getAllTransfers(const ::OpenAPI::OptionalParam<QString> &id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &status = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &limit = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &offset = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id QString [required]
    * @param[in]  x_api_key QString [optional]
    */
    virtual void getSubPartnerBalance(const QString &id, const ::OpenAPI::OptionalParam<QString> &x_api_key = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  order QString [optional]
    */
    virtual void getSubPartners(const ::OpenAPI::OptionalParam<QString> &id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &offset = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &limit = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void getTransfer(const QString &id);
...
private:
    ...
    void getAllTransfersCallback(OAIHttpRequestWorker *worker);
    void getSubPartnerBalanceCallback(OAIHttpRequestWorker *worker);
    void getSubPartnersCallback(OAIHttpRequestWorker *worker);
    void getTransferCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getAllTransfersSignal(OAIGetAllTransfers_200_response summary);
    void getSubPartnerBalanceSignal(OAIGetSubPartnerBalance_200_response summary);
    void getSubPartnersSignal();
    void getTransferSignal(OAIGetTransfer_200_response summary);


    void getAllTransfersSignalFull(OAIHttpRequestWorker *worker, OAIGetAllTransfers_200_response summary);
    void getSubPartnerBalanceSignalFull(OAIHttpRequestWorker *worker, OAIGetSubPartnerBalance_200_response summary);
    void getSubPartnersSignalFull(OAIHttpRequestWorker *worker);
    void getTransferSignalFull(OAIHttpRequestWorker *worker, OAIGetTransfer_200_response summary);

    Q_DECL_DEPRECATED_X("Use getAllTransfersSignalError() instead")
    void getAllTransfersSignalE(OAIGetAllTransfers_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAllTransfersSignalError(OAIGetAllTransfers_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSubPartnerBalanceSignalError() instead")
    void getSubPartnerBalanceSignalE(OAIGetSubPartnerBalance_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSubPartnerBalanceSignalError(OAIGetSubPartnerBalance_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSubPartnersSignalError() instead")
    void getSubPartnersSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void getSubPartnersSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getTransferSignalError() instead")
    void getTransferSignalE(OAIGetTransfer_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTransferSignalError(OAIGetTransfer_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getAllTransfersSignalErrorFull() instead")
    void getAllTransfersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAllTransfersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSubPartnerBalanceSignalErrorFull() instead")
    void getSubPartnerBalanceSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSubPartnerBalanceSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getSubPartnersSignalErrorFull() instead")
    void getSubPartnersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getSubPartnersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
