...
/*
 * OAIGetSubPartnerBalance_200_response_result_balances.h
 *
 * 
 */

#ifndef OAIGetSubPartnerBalance_200_response_result_balances_H
#define OAIGetSubPartnerBalance_200_response_result_balances_H

#include <QJsonObject>

#include "OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20.h"
...
namespace OpenAPI {
class OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20;
class OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc;

class OAIGetSubPartnerBalance_200_response_result_balances : public OAIObject {
public:
    OAIGetSubPartnerBalance_200_response_result_balances();
    OAIGetSubPartnerBalance_200_response_result_balances(QString json);
    ~OAIGetSubPartnerBalance_200_response_result_balances() override;
    ...
    OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20 getUsddtrc20() const;
    void setUsddtrc20(const OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20 &usddtrc20);
    bool is_usddtrc20_Set() const;
    bool is_usddtrc20_Valid() const;

    OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc getUsdtbsc() const;
    void setUsdtbsc(const OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc &usdtbsc);
    bool is_usdtbsc_Set() const;
    bool is_usdtbsc_Valid() const;
...
private:
    ...
    OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20 m_usddtrc20;
    bool m_usddtrc20_isSet;
    bool m_usddtrc20_isValid;

    OAIGetSubPartnerBalance_200_response_result_balances_usdtbsc m_usdtbsc;
    bool m_usdtbsc_isSet;
    bool m_usdtbsc_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetSubPartnerBalance_200_response_result_balances)

#endif // OAIGetSubPartnerBalance_200_response_result_balances_H
