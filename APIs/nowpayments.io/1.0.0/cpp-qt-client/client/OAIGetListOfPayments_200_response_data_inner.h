...
/*
 * OAIGetListOfPayments_200_response_data_inner.h
 *
 * 
 */

#ifndef OAIGetListOfPayments_200_response_data_inner_H
#define OAIGetListOfPayments_200_response_data_inner_H
...
class OAIGetListOfPayments_200_response_data_inner : public OAIObject {
public:
    OAIGetListOfPayments_200_response_data_inner();
    OAIGetListOfPayments_200_response_data_inner(QString json);
    ~OAIGetListOfPayments_200_response_data_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetListOfPayments_200_response_data_inner)

#endif // OAIGetListOfPayments_200_response_data_inner_H
