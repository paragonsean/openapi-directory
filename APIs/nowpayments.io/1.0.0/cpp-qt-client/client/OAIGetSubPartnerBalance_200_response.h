...
/*
 * OAIGetSubPartnerBalance_200_response.h
 *
 * 
 */

#ifndef OAIGetSubPartnerBalance_200_response_H
#define OAIGetSubPartnerBalance_200_response_H
...
namespace OpenAPI {
class OAIGetSubPartnerBalance_200_response_result;

class OAIGetSubPartnerBalance_200_response : public OAIObject {
public:
    OAIGetSubPartnerBalance_200_response();
    OAIGetSubPartnerBalance_200_response(QString json);
    ~OAIGetSubPartnerBalance_200_response() override;
    ...
    OAIGetSubPartnerBalance_200_response_result getResult() const;
    void setResult(const OAIGetSubPartnerBalance_200_response_result &result);
...
private:
    ...
    OAIGetSubPartnerBalance_200_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSubPartnerBalance_200_response)

#endif // OAIGetSubPartnerBalance_200_response_H
