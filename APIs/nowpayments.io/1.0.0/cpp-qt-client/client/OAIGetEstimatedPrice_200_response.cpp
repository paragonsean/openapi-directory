...
OAIGetEstimatedPrice_200_response::OAIGetEstimatedPrice_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEstimatedPrice_200_response::OAIGetEstimatedPrice_200_response() {
    this->initializeModel();
}

OAIGetEstimatedPrice_200_response::~OAIGetEstimatedPrice_200_response() {}

void OAIGetEstimatedPrice_200_response::initializeModel() {
...
void OAIGetEstimatedPrice_200_response::fromJson(QString jsonString) {
...
void OAIGetEstimatedPrice_200_response::fromJsonObject(QJsonObject json) {
    ...
    m_estimated_amount_isValid = ::OpenAPI::fromJsonValue(m_estimated_amount, json[QString("estimated_amount")]);
    m_estimated_amount_isSet = !json[QString("estimated_amount")].isNull() && m_estimated_amount_isValid;
}

QString OAIGetEstimatedPrice_200_response::asJson() const {
...
QJsonObject OAIGetEstimatedPrice_200_response::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_estimated_amount_isSet) {
        obj.insert(QString("estimated_amount"), ::OpenAPI::toJsonValue(m_estimated_amount));
    }
    return obj;
}

double OAIGetEstimatedPrice_200_response::getAmountFrom() const {
    return m_amount_from;
}
void OAIGetEstimatedPrice_200_response::setAmountFrom(const double &amount_from) {
    m_amount_from = amount_from;
    m_amount_from_isSet = true;
}

bool OAIGetEstimatedPrice_200_response::is_amount_from_Set() const{
    return m_amount_from_isSet;
}

bool OAIGetEstimatedPrice_200_response::is_amount_from_Valid() const{
    return m_amount_from_isValid;
}

QString OAIGetEstimatedPrice_200_response::getCurrencyFrom() const {
    return m_currency_from;
}
void OAIGetEstimatedPrice_200_response::setCurrencyFrom(const QString &currency_from) {
    m_currency_from = currency_from;
    m_currency_from_isSet = true;
}

bool OAIGetEstimatedPrice_200_response::is_currency_from_Set() const{
    return m_currency_from_isSet;
}

bool OAIGetEstimatedPrice_200_response::is_currency_from_Valid() const{
    return m_currency_from_isValid;
}

QString OAIGetEstimatedPrice_200_response::getCurrencyTo() const {
    return m_currency_to;
}
void OAIGetEstimatedPrice_200_response::setCurrencyTo(const QString &currency_to) {
    m_currency_to = currency_to;
    m_currency_to_isSet = true;
}

bool OAIGetEstimatedPrice_200_response::is_currency_to_Set() const{
    return m_currency_to_isSet;
}

bool OAIGetEstimatedPrice_200_response::is_currency_to_Valid() const{
    return m_currency_to_isValid;
}

double OAIGetEstimatedPrice_200_response::getEstimatedAmount() const {
    return m_estimated_amount;
}
void OAIGetEstimatedPrice_200_response::setEstimatedAmount(const double &estimated_amount) {
    m_estimated_amount = estimated_amount;
    m_estimated_amount_isSet = true;
}

bool OAIGetEstimatedPrice_200_response::is_estimated_amount_Set() const{
    return m_estimated_amount_isSet;
}

bool OAIGetEstimatedPrice_200_response::is_estimated_amount_Valid() const{
    return m_estimated_amount_isValid;
}

bool OAIGetEstimatedPrice_200_response::isSet() const {
...
bool OAIGetEstimatedPrice_200_response::isValid() const {
