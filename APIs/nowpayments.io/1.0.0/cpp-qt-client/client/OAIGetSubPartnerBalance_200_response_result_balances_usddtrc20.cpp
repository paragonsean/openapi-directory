...
OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20() {
    this->initializeModel();
}

OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::~OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20() {}

void OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::initializeModel() {
...
void OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::fromJson(QString jsonString) {
...
void OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::fromJsonObject(QJsonObject json) {
...
QString OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::asJson() const {
...
QJsonObject OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::getAmount() const {
    return m_amount;
}
void OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::getPendingAmount() const {
    return m_pending_amount;
}
void OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::setPendingAmount(const double &pending_amount) {
    m_pending_amount = pending_amount;
    m_pending_amount_isSet = true;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::is_pending_amount_Set() const{
    return m_pending_amount_isSet;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::is_pending_amount_Valid() const{
    return m_pending_amount_isValid;
}

bool OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::isSet() const {
...
bool OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20::isValid() const {
