...
OAIGetOneRecurringPayment_404_response::OAIGetOneRecurringPayment_404_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOneRecurringPayment_404_response::OAIGetOneRecurringPayment_404_response() {
    this->initializeModel();
}

OAIGetOneRecurringPayment_404_response::~OAIGetOneRecurringPayment_404_response() {}

void OAIGetOneRecurringPayment_404_response::initializeModel() {
...
void OAIGetOneRecurringPayment_404_response::fromJson(QString jsonString) {
...
void OAIGetOneRecurringPayment_404_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetOneRecurringPayment_404_response::asJson() const {
...
QJsonObject OAIGetOneRecurringPayment_404_response::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIGetOneRecurringPayment_404_response::getCode() const {
    return m_code;
}
void OAIGetOneRecurringPayment_404_response::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIGetOneRecurringPayment_404_response::is_code_Set() const{
    return m_code_isSet;
}

bool OAIGetOneRecurringPayment_404_response::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIGetOneRecurringPayment_404_response::getMessage() const {
    return m_message;
}
void OAIGetOneRecurringPayment_404_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIGetOneRecurringPayment_404_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIGetOneRecurringPayment_404_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIGetOneRecurringPayment_404_response::isStatus() const {
    return m_status;
}
void OAIGetOneRecurringPayment_404_response::setStatus(const bool &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetOneRecurringPayment_404_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetOneRecurringPayment_404_response::is_status_Valid() const{
    return m_status_isValid;
}

double OAIGetOneRecurringPayment_404_response::getStatusCode() const {
    return m_status_code;
}
void OAIGetOneRecurringPayment_404_response::setStatusCode(const double &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIGetOneRecurringPayment_404_response::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIGetOneRecurringPayment_404_response::is_status_code_Valid() const{
    return m_status_code_isValid;
}

bool OAIGetOneRecurringPayment_404_response::isSet() const {
...
bool OAIGetOneRecurringPayment_404_response::isValid() const {
