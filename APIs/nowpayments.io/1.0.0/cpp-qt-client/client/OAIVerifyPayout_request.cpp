...
OAIVerifyPayout_request::OAIVerifyPayout_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifyPayout_request::OAIVerifyPayout_request() {
    this->initializeModel();
}

OAIVerifyPayout_request::~OAIVerifyPayout_request() {}

void OAIVerifyPayout_request::initializeModel() {

    m_verification_code_isSet = false;
    m_verification_code_isValid = false;
}

void OAIVerifyPayout_request::fromJson(QString jsonString) {
...
void OAIVerifyPayout_request::fromJsonObject(QJsonObject json) {
...
QString OAIVerifyPayout_request::asJson() const {
...
QJsonObject OAIVerifyPayout_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVerifyPayout_request::getVerificationCode() const {
    return m_verification_code;
}
void OAIVerifyPayout_request::setVerificationCode(const QString &verification_code) {
    m_verification_code = verification_code;
    m_verification_code_isSet = true;
}

bool OAIVerifyPayout_request::is_verification_code_Set() const{
    return m_verification_code_isSet;
}

bool OAIVerifyPayout_request::is_verification_code_Valid() const{
    return m_verification_code_isValid;
}

bool OAIVerifyPayout_request::isSet() const {
...
bool OAIVerifyPayout_request::isValid() const {
