...
OAIUpdatePlan_request::OAIUpdatePlan_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePlan_request::OAIUpdatePlan_request() {
    this->initializeModel();
}

OAIUpdatePlan_request::~OAIUpdatePlan_request() {}

void OAIUpdatePlan_request::initializeModel() {
...
void OAIUpdatePlan_request::fromJson(QString jsonString) {
...
void OAIUpdatePlan_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePlan_request::asJson() const {
...
QJsonObject OAIUpdatePlan_request::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAIUpdatePlan_request::getAmount() const {
    return m_amount;
}
void OAIUpdatePlan_request::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIUpdatePlan_request::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIUpdatePlan_request::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIUpdatePlan_request::getCurrency() const {
    return m_currency;
}
void OAIUpdatePlan_request::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIUpdatePlan_request::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIUpdatePlan_request::is_currency_Valid() const{
    return m_currency_isValid;
}

double OAIUpdatePlan_request::getIntervalDay() const {
    return m_interval_day;
}
void OAIUpdatePlan_request::setIntervalDay(const double &interval_day) {
    m_interval_day = interval_day;
    m_interval_day_isSet = true;
}

bool OAIUpdatePlan_request::is_interval_day_Set() const{
    return m_interval_day_isSet;
}

bool OAIUpdatePlan_request::is_interval_day_Valid() const{
    return m_interval_day_isValid;
}

QString OAIUpdatePlan_request::getTitle() const {
    return m_title;
}
void OAIUpdatePlan_request::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIUpdatePlan_request::is_title_Set() const{
    return m_title_isSet;
}

bool OAIUpdatePlan_request::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIUpdatePlan_request::isSet() const {
...
bool OAIUpdatePlan_request::isValid() const {
