...
/*
 * OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20.h
 *
 * 
 */

#ifndef OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20_H
#define OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20_H
...
class OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20 : public OAIObject {
public:
    OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20();
    OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20(QString json);
    ~OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20() override;
    ...
    void setPendingAmount(const double &pending_amount);
    bool is_pending_amount_Set() const;
    bool is_pending_amount_Valid() const;
...
private:
    ...
    double m_pending_amount;
    bool m_pending_amount_isSet;
    bool m_pending_amount_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20)

#endif // OAIGetSubPartnerBalance_200_response_result_balances_usddtrc20_H
