...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenUvGlobalRealTimeUvIndexForecastApi.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new OpenUvGlobalRealTimeUvIndexForecastApi.Error();
      //expect(instance).to.be.a(OpenUvGlobalRealTimeUvIndexForecastApi.Error);
    });
