...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenUvGlobalRealTimeUvIndexForecastApi.Forecast();
  });
  ...
  describe('Forecast', function() {
    it('should create an instance of Forecast', function() {
      ...
      //var instance = new OpenUvGlobalRealTimeUvIndexForecastApi.Forecast();
      //expect(instance).to.be.a(OpenUvGlobalRealTimeUvIndexForecastApi.Forecast);
    });
