# AdvicentFactFinderService.LiabilityModel
...
**liabilityType** | **Number** |  | [optional] 
**loanDate** | **Date** |  | [optional] 
**originalPrincipal** | **Number** |  | [optional] 
...
* `SetPrincipal` (value: `"SetPrincipal"`)
