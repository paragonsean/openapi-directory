...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.DisabilityInsurancePolicyModel();
  });
  ...
  describe('DisabilityInsurancePolicyModel', function() {
    it('should create an instance of DisabilityInsurancePolicyModel', function() {
      // uncomment below and update the code to test DisabilityInsurancePolicyModel
      //var instance = new AdvicentFactFinderService.DisabilityInsurancePolicyModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.DisabilityInsurancePolicyModel);
    });
