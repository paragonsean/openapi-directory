...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.IAccountHoldingDomainObject();
  });
  ...
  describe('IAccountHoldingDomainObject', function() {
    it('should create an instance of IAccountHoldingDomainObject', function() {
      // uncomment below and update the code to test IAccountHoldingDomainObject
      //var instance = new AdvicentFactFinderService.IAccountHoldingDomainObject();
      //expect(instance).to.be.a(AdvicentFactFinderService.IAccountHoldingDomainObject);
    });

    it('should have the property accountHoldingId (base name: "accountHoldingId")', function() {
      // uncomment below and update the code to test the property accountHoldingId
      //var instance = new AdvicentFactFinderService.IAccountHoldingDomainObject();
    ...
    it('should have the property heldAway (base name: "heldAway")', function() {
      // uncomment below and update the code to test the property heldAway
      //var instance = new AdvicentFactFinderService.IAccountHoldingDomainObject();
      //expect(instance).to.be();
    });
