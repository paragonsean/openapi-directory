...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.EducationExpenseModel();
  });
  ...
  describe('EducationExpenseModel', function() {
    it('should create an instance of EducationExpenseModel', function() {
      // uncomment below and update the code to test EducationExpenseModel
      //var instance = new AdvicentFactFinderService.EducationExpenseModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.EducationExpenseModel);
    });
