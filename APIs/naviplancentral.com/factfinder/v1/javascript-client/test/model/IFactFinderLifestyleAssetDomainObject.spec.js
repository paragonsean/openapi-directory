...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.IFactFinderLifestyleAssetDomainObject();
  });
  ...
  describe('IFactFinderLifestyleAssetDomainObject', function() {
    it('should create an instance of IFactFinderLifestyleAssetDomainObject', function() {
      // uncomment below and update the code to test IFactFinderLifestyleAssetDomainObject
      //var instance = new AdvicentFactFinderService.IFactFinderLifestyleAssetDomainObject();
      //expect(instance).to.be.a(AdvicentFactFinderService.IFactFinderLifestyleAssetDomainObject);
    });
    ...
    it('should have the property lifestyleAssetId (base name: "lifestyleAssetId")', function() {
      // uncomment below and update the code to test the property lifestyleAssetId
      //var instance = new AdvicentFactFinderService.IFactFinderLifestyleAssetDomainObject();
      //expect(instance).to.be();
    });
