...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.ICriticalIllnessInsurancePolicyDomainObject();
  });
  ...
  describe('ICriticalIllnessInsurancePolicyDomainObject', function() {
    it('should create an instance of ICriticalIllnessInsurancePolicyDomainObject', function() {
      // uncomment below and update the code to test ICriticalIllnessInsurancePolicyDomainObject
      //var instance = new AdvicentFactFinderService.ICriticalIllnessInsurancePolicyDomainObject();
      //expect(instance).to.be.a(AdvicentFactFinderService.ICriticalIllnessInsurancePolicyDomainObject);
    });
    ...
    it('should have the property criticalIllnessInsurancePolicyId (base name: "criticalIllnessInsurancePolicyId")', function() {
      // uncomment below and update the code to test the property criticalIllnessInsurancePolicyId
      //var instance = new AdvicentFactFinderService.ICriticalIllnessInsurancePolicyDomainObject();
      //expect(instance).to.be();
    });
