...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.LongTermCareInsurancePolicyModel();
  });
  ...
  describe('LongTermCareInsurancePolicyModel', function() {
    it('should create an instance of LongTermCareInsurancePolicyModel', function() {
      // uncomment below and update the code to test LongTermCareInsurancePolicyModel
      //var instance = new AdvicentFactFinderService.LongTermCareInsurancePolicyModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.LongTermCareInsurancePolicyModel);
    });
