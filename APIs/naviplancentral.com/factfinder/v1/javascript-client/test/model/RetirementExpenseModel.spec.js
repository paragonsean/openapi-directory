...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.RetirementExpenseModel();
  });
  ...
  describe('RetirementExpenseModel', function() {
    it('should create an instance of RetirementExpenseModel', function() {
      // uncomment below and update the code to test RetirementExpenseModel
      //var instance = new AdvicentFactFinderService.RetirementExpenseModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.RetirementExpenseModel);
    });
