...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.IDisabilityInsurancePolicyDomainObject();
  });
  ...
  describe('IDisabilityInsurancePolicyDomainObject', function() {
    it('should create an instance of IDisabilityInsurancePolicyDomainObject', function() {
      // uncomment below and update the code to test IDisabilityInsurancePolicyDomainObject
      //var instance = new AdvicentFactFinderService.IDisabilityInsurancePolicyDomainObject();
      //expect(instance).to.be.a(AdvicentFactFinderService.IDisabilityInsurancePolicyDomainObject);
    });
    ...
    it('should have the property disabilityInsurancePolicyId (base name: "disabilityInsurancePolicyId")', function() {
      // uncomment below and update the code to test the property disabilityInsurancePolicyId
      //var instance = new AdvicentFactFinderService.IDisabilityInsurancePolicyDomainObject();
      //expect(instance).to.be();
    });
