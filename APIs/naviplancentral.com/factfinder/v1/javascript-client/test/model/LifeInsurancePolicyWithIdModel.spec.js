...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.LifeInsurancePolicyWithIdModel();
  });
  ...
  describe('LifeInsurancePolicyWithIdModel', function() {
    it('should create an instance of LifeInsurancePolicyWithIdModel', function() {
      // uncomment below and update the code to test LifeInsurancePolicyWithIdModel
      //var instance = new AdvicentFactFinderService.LifeInsurancePolicyWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.LifeInsurancePolicyWithIdModel);
    });
