...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.DemographicsDependentModel();
  });
  ...
  describe('DemographicsDependentModel', function() {
    it('should create an instance of DemographicsDependentModel', function() {
      // uncomment below and update the code to test DemographicsDependentModel
      //var instance = new AdvicentFactFinderService.DemographicsDependentModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.DemographicsDependentModel);
    });
