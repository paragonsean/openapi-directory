...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.RealEstateAssetWithIdModel();
  });
  ...
  describe('RealEstateAssetWithIdModel', function() {
    it('should create an instance of RealEstateAssetWithIdModel', function() {
      // uncomment below and update the code to test RealEstateAssetWithIdModel
      //var instance = new AdvicentFactFinderService.RealEstateAssetWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.RealEstateAssetWithIdModel);
    });
