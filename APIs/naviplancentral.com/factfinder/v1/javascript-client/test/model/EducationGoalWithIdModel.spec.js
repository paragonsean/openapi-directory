...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.EducationGoalWithIdModel();
  });
  ...
  describe('EducationGoalWithIdModel', function() {
    it('should create an instance of EducationGoalWithIdModel', function() {
      // uncomment below and update the code to test EducationGoalWithIdModel
      //var instance = new AdvicentFactFinderService.EducationGoalWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.EducationGoalWithIdModel);
    });
