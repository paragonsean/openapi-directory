...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.AccountHoldingWithIdModel();
  });
  ...
  describe('AccountHoldingWithIdModel', function() {
    it('should create an instance of AccountHoldingWithIdModel', function() {
      // uncomment below and update the code to test AccountHoldingWithIdModel
      //var instance = new AdvicentFactFinderService.AccountHoldingWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.AccountHoldingWithIdModel);
    });
