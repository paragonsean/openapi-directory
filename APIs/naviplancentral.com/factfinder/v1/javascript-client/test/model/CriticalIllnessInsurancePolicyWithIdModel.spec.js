...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.CriticalIllnessInsurancePolicyWithIdModel();
  });
  ...
  describe('CriticalIllnessInsurancePolicyWithIdModel', function() {
    it('should create an instance of CriticalIllnessInsurancePolicyWithIdModel', function() {
      // uncomment below and update the code to test CriticalIllnessInsurancePolicyWithIdModel
      //var instance = new AdvicentFactFinderService.CriticalIllnessInsurancePolicyWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.CriticalIllnessInsurancePolicyWithIdModel);
    });
