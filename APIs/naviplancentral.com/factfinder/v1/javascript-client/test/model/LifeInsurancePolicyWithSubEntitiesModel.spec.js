...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.LifeInsurancePolicyWithSubEntitiesModel();
  });
  ...
  describe('LifeInsurancePolicyWithSubEntitiesModel', function() {
    it('should create an instance of LifeInsurancePolicyWithSubEntitiesModel', function() {
      // uncomment below and update the code to test LifeInsurancePolicyWithSubEntitiesModel
      //var instance = new AdvicentFactFinderService.LifeInsurancePolicyWithSubEntitiesModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.LifeInsurancePolicyWithSubEntitiesModel);
    });
