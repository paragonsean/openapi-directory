...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.LifestyleAssetWithIdModel();
  });
  ...
  describe('LifestyleAssetWithIdModel', function() {
    it('should create an instance of LifestyleAssetWithIdModel', function() {
      // uncomment below and update the code to test LifestyleAssetWithIdModel
      //var instance = new AdvicentFactFinderService.LifestyleAssetWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.LifestyleAssetWithIdModel);
    });
