...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.EducationGoalModel();
  });
  ...
  describe('EducationGoalModel', function() {
    it('should create an instance of EducationGoalModel', function() {
      // uncomment below and update the code to test EducationGoalModel
      //var instance = new AdvicentFactFinderService.EducationGoalModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.EducationGoalModel);
    });
