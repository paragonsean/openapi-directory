...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.DisabilityInsurancePolicyWithIdModel();
  });
  ...
  describe('DisabilityInsurancePolicyWithIdModel', function() {
    it('should create an instance of DisabilityInsurancePolicyWithIdModel', function() {
      // uncomment below and update the code to test DisabilityInsurancePolicyWithIdModel
      //var instance = new AdvicentFactFinderService.DisabilityInsurancePolicyWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.DisabilityInsurancePolicyWithIdModel);
    });
