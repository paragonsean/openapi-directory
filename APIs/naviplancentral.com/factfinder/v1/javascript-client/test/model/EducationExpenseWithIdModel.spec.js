...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.EducationExpenseWithIdModel();
  });
  ...
  describe('EducationExpenseWithIdModel', function() {
    it('should create an instance of EducationExpenseWithIdModel', function() {
      // uncomment below and update the code to test EducationExpenseWithIdModel
      //var instance = new AdvicentFactFinderService.EducationExpenseWithIdModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.EducationExpenseWithIdModel);
    });
