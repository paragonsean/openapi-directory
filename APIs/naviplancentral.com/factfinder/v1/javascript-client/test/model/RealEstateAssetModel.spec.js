...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvicentFactFinderService.RealEstateAssetModel();
  });
  ...
  describe('RealEstateAssetModel', function() {
    it('should create an instance of RealEstateAssetModel', function() {
      // uncomment below and update the code to test RealEstateAssetModel
      //var instance = new AdvicentFactFinderService.RealEstateAssetModel();
      //expect(instance).to.be.a(AdvicentFactFinderService.RealEstateAssetModel);
    });
