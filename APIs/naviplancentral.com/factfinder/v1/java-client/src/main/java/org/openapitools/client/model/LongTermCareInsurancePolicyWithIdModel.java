...
public class LongTermCareInsurancePolicyWithIdModel {
  ...
  public LongTermCareInsurancePolicyWithIdModel() {
  }

  public LongTermCareInsurancePolicyWithIdModel benefit(Double benefit) {
  ...
  public LongTermCareInsurancePolicyWithIdModel benefitFrequency(Integer benefitFrequency) {
  ...
  public LongTermCareInsurancePolicyWithIdModel description(String description) {
  ...
  public LongTermCareInsurancePolicyWithIdModel externalDestinationId(String externalDestinationId) {
  ...
  public LongTermCareInsurancePolicyWithIdModel factFinderId(Integer factFinderId) {
  ...
  public LongTermCareInsurancePolicyWithIdModel insurancePolicyId(Integer insurancePolicyId) {
  ...
  public LongTermCareInsurancePolicyWithIdModel insured(InsuredEnum insured) {
  ...
  public LongTermCareInsurancePolicyWithIdModel links(List<ObjectLink> links) {
    this.links = links;
    return this;
  }

  public LongTermCareInsurancePolicyWithIdModel addLinksItem(ObjectLink linksItem) {
    if (this.links == null) {
  ...
  public LongTermCareInsurancePolicyWithIdModel premium(Double premium) {
  ...
  public LongTermCareInsurancePolicyWithIdModel premiumFrequency(Integer premiumFrequency) {
  ...
  public boolean equals(Object o) {
    ...
    LongTermCareInsurancePolicyWithIdModel longTermCareInsurancePolicyWithIdModel = (LongTermCareInsurancePolicyWithIdModel) o;
    return Objects.equals(this.benefit, longTermCareInsurancePolicyWithIdModel.benefit) &&
        Objects.equals(this.benefitFrequency, longTermCareInsurancePolicyWithIdModel.benefitFrequency) &&
        Objects.equals(this.description, longTermCareInsurancePolicyWithIdModel.description) &&
        Objects.equals(this.externalDestinationId, longTermCareInsurancePolicyWithIdModel.externalDestinationId) &&
        Objects.equals(this.factFinderId, longTermCareInsurancePolicyWithIdModel.factFinderId) &&
        Objects.equals(this.insurancePolicyId, longTermCareInsurancePolicyWithIdModel.insurancePolicyId) &&
        Objects.equals(this.insured, longTermCareInsurancePolicyWithIdModel.insured) &&
        Objects.equals(this.links, longTermCareInsurancePolicyWithIdModel.links) &&
        Objects.equals(this.premium, longTermCareInsurancePolicyWithIdModel.premium) &&
        Objects.equals(this.premiumFrequency, longTermCareInsurancePolicyWithIdModel.premiumFrequency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(benefit, benefitFrequency, description, externalDestinationId, factFinderId, insurancePolicyId, insured, links, premium, premiumFrequency);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LongTermCareInsurancePolicyWithIdModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LongTermCareInsurancePolicyWithIdModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongTermCareInsurancePolicyWithIdModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongTermCareInsurancePolicyWithIdModel is not found in the empty JSON string", LongTermCareInsurancePolicyWithIdModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongTermCareInsurancePolicyWithIdModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongTermCareInsurancePolicyWithIdModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongTermCareInsurancePolicyWithIdModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongTermCareInsurancePolicyWithIdModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongTermCareInsurancePolicyWithIdModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongTermCareInsurancePolicyWithIdModel.class));

       return (TypeAdapter<T>) new TypeAdapter<LongTermCareInsurancePolicyWithIdModel>() {
           @Override
           public void write(JsonWriter out, LongTermCareInsurancePolicyWithIdModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongTermCareInsurancePolicyWithIdModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LongTermCareInsurancePolicyWithIdModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LongTermCareInsurancePolicyWithIdModel
   * @throws IOException if the JSON string is invalid with respect to LongTermCareInsurancePolicyWithIdModel
   */
  public static LongTermCareInsurancePolicyWithIdModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongTermCareInsurancePolicyWithIdModel.class);
  }

  /**
   * Convert an instance of LongTermCareInsurancePolicyWithIdModel to an JSON string
   *
   * @return JSON string
   */
