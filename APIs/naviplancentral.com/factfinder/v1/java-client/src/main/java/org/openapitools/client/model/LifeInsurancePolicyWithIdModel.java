...
public class LifeInsurancePolicyWithIdModel {
  /**
  ...
  public LifeInsurancePolicyWithIdModel() {
  }

  public LifeInsurancePolicyWithIdModel beneficiary(BeneficiaryEnum beneficiary) {
  ...
  public LifeInsurancePolicyWithIdModel beneficiaryDependentId(Integer beneficiaryDependentId) {
  ...
  public LifeInsurancePolicyWithIdModel benefit(Double benefit) {
  ...
  public LifeInsurancePolicyWithIdModel description(String description) {
  ...
  public LifeInsurancePolicyWithIdModel externalDestinationId(String externalDestinationId) {
  ...
  public LifeInsurancePolicyWithIdModel factFinderId(Integer factFinderId) {
  ...
  public LifeInsurancePolicyWithIdModel frequency(Integer frequency) {
  ...
  public LifeInsurancePolicyWithIdModel generalAccountMarketValue(Double generalAccountMarketValue) {
  ...
  public LifeInsurancePolicyWithIdModel insurancePolicyId(Integer insurancePolicyId) {
  ...
  public LifeInsurancePolicyWithIdModel insured(InsuredEnum insured) {
  ...
  public LifeInsurancePolicyWithIdModel links(List<ObjectLink> links) {
    this.links = links;
    return this;
  }

  public LifeInsurancePolicyWithIdModel addLinksItem(ObjectLink linksItem) {
    if (this.links == null) {
  ...
  public LifeInsurancePolicyWithIdModel payer(PayerEnum payer) {
    this.payer = payer;
    return this;
  }
  ...
  public LifeInsurancePolicyWithIdModel policyType(Integer policyType) {
  ...
  public LifeInsurancePolicyWithIdModel premium(Double premium) {
  ...
  public boolean equals(Object o) {
    ...
    LifeInsurancePolicyWithIdModel lifeInsurancePolicyWithIdModel = (LifeInsurancePolicyWithIdModel) o;
    return Objects.equals(this.beneficiary, lifeInsurancePolicyWithIdModel.beneficiary) &&
        Objects.equals(this.beneficiaryDependentId, lifeInsurancePolicyWithIdModel.beneficiaryDependentId) &&
        Objects.equals(this.benefit, lifeInsurancePolicyWithIdModel.benefit) &&
        Objects.equals(this.description, lifeInsurancePolicyWithIdModel.description) &&
        Objects.equals(this.externalDestinationId, lifeInsurancePolicyWithIdModel.externalDestinationId) &&
        Objects.equals(this.factFinderId, lifeInsurancePolicyWithIdModel.factFinderId) &&
        Objects.equals(this.frequency, lifeInsurancePolicyWithIdModel.frequency) &&
        Objects.equals(this.generalAccountMarketValue, lifeInsurancePolicyWithIdModel.generalAccountMarketValue) &&
        Objects.equals(this.insurancePolicyId, lifeInsurancePolicyWithIdModel.insurancePolicyId) &&
        Objects.equals(this.insured, lifeInsurancePolicyWithIdModel.insured) &&
        Objects.equals(this.links, lifeInsurancePolicyWithIdModel.links) &&
        Objects.equals(this.payer, lifeInsurancePolicyWithIdModel.payer) &&
        Objects.equals(this.policyType, lifeInsurancePolicyWithIdModel.policyType) &&
        Objects.equals(this.premium, lifeInsurancePolicyWithIdModel.premium);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beneficiary, beneficiaryDependentId, benefit, description, externalDestinationId, factFinderId, frequency, generalAccountMarketValue, insurancePolicyId, insured, links, payer, policyType, premium);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LifeInsurancePolicyWithIdModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LifeInsurancePolicyWithIdModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LifeInsurancePolicyWithIdModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LifeInsurancePolicyWithIdModel is not found in the empty JSON string", LifeInsurancePolicyWithIdModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LifeInsurancePolicyWithIdModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LifeInsurancePolicyWithIdModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LifeInsurancePolicyWithIdModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LifeInsurancePolicyWithIdModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LifeInsurancePolicyWithIdModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LifeInsurancePolicyWithIdModel.class));

       return (TypeAdapter<T>) new TypeAdapter<LifeInsurancePolicyWithIdModel>() {
           @Override
           public void write(JsonWriter out, LifeInsurancePolicyWithIdModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LifeInsurancePolicyWithIdModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LifeInsurancePolicyWithIdModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LifeInsurancePolicyWithIdModel
   * @throws IOException if the JSON string is invalid with respect to LifeInsurancePolicyWithIdModel
   */
  public static LifeInsurancePolicyWithIdModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LifeInsurancePolicyWithIdModel.class);
  }

  /**
   * Convert an instance of LifeInsurancePolicyWithIdModel to an JSON string
   *
   * @return JSON string
   */
