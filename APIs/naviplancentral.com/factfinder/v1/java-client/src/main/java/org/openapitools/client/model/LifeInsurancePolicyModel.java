...
public class LifeInsurancePolicyModel {
  /**
  ...
  public LifeInsurancePolicyModel() {
  }

  public LifeInsurancePolicyModel beneficiary(BeneficiaryEnum beneficiary) {
  ...
  public LifeInsurancePolicyModel beneficiaryDependentId(Integer beneficiaryDependentId) {
  ...
  public LifeInsurancePolicyModel benefit(Double benefit) {
  ...
  public LifeInsurancePolicyModel description(String description) {
  ...
  public LifeInsurancePolicyModel externalDestinationId(String externalDestinationId) {
  ...
  public LifeInsurancePolicyModel factFinderId(Integer factFinderId) {
  ...
  public LifeInsurancePolicyModel frequency(Integer frequency) {
  ...
  public LifeInsurancePolicyModel generalAccountMarketValue(Double generalAccountMarketValue) {
  ...
  public LifeInsurancePolicyModel insured(InsuredEnum insured) {
  ...
  public LifeInsurancePolicyModel payer(PayerEnum payer) {
    this.payer = payer;
    return this;
  }
  ...
  public LifeInsurancePolicyModel policyType(Integer policyType) {
  ...
  public LifeInsurancePolicyModel premium(Double premium) {
  ...
  public boolean equals(Object o) {
    ...
    LifeInsurancePolicyModel lifeInsurancePolicyModel = (LifeInsurancePolicyModel) o;
    return Objects.equals(this.beneficiary, lifeInsurancePolicyModel.beneficiary) &&
        Objects.equals(this.beneficiaryDependentId, lifeInsurancePolicyModel.beneficiaryDependentId) &&
        Objects.equals(this.benefit, lifeInsurancePolicyModel.benefit) &&
        Objects.equals(this.description, lifeInsurancePolicyModel.description) &&
        Objects.equals(this.externalDestinationId, lifeInsurancePolicyModel.externalDestinationId) &&
        Objects.equals(this.factFinderId, lifeInsurancePolicyModel.factFinderId) &&
        Objects.equals(this.frequency, lifeInsurancePolicyModel.frequency) &&
        Objects.equals(this.generalAccountMarketValue, lifeInsurancePolicyModel.generalAccountMarketValue) &&
        Objects.equals(this.insured, lifeInsurancePolicyModel.insured) &&
        Objects.equals(this.payer, lifeInsurancePolicyModel.payer) &&
        Objects.equals(this.policyType, lifeInsurancePolicyModel.policyType) &&
        Objects.equals(this.premium, lifeInsurancePolicyModel.premium);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beneficiary, beneficiaryDependentId, benefit, description, externalDestinationId, factFinderId, frequency, generalAccountMarketValue, insured, payer, policyType, premium);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LifeInsurancePolicyModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LifeInsurancePolicyModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LifeInsurancePolicyModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LifeInsurancePolicyModel is not found in the empty JSON string", LifeInsurancePolicyModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LifeInsurancePolicyModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LifeInsurancePolicyModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LifeInsurancePolicyModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LifeInsurancePolicyModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LifeInsurancePolicyModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LifeInsurancePolicyModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LifeInsurancePolicyModel.class));

       return (TypeAdapter<T>) new TypeAdapter<LifeInsurancePolicyModel>() {
           @Override
           public void write(JsonWriter out, LifeInsurancePolicyModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LifeInsurancePolicyModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LifeInsurancePolicyModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LifeInsurancePolicyModel
   * @throws IOException if the JSON string is invalid with respect to LifeInsurancePolicyModel
   */
  public static LifeInsurancePolicyModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LifeInsurancePolicyModel.class);
  }

  /**
   * Convert an instance of LifeInsurancePolicyModel to an JSON string
   *
   * @return JSON string
   */
