...
public class FactFinderPopulatableEntityModel {
  ...
  public FactFinderPopulatableEntityModel() {
  }

  public FactFinderPopulatableEntityModel householdId(Integer householdId) {
  ...
  public FactFinderPopulatableEntityModel modules(List<ModulesEnum> modules) {
    this.modules = modules;
    return this;
  }

  public FactFinderPopulatableEntityModel addModulesItem(ModulesEnum modulesItem) {
  ...
  public FactFinderPopulatableEntityModel planId(Integer planId) {
    this.planId = planId;
    return this;
  }
  ...
  public FactFinderPopulatableEntityModel planLevel(PlanLevelEnum planLevel) {
  ...
  public boolean equals(Object o) {
    ...
    FactFinderPopulatableEntityModel factFinderPopulatableEntityModel = (FactFinderPopulatableEntityModel) o;
    return Objects.equals(this.householdId, factFinderPopulatableEntityModel.householdId) &&
        Objects.equals(this.modules, factFinderPopulatableEntityModel.modules) &&
        Objects.equals(this.planId, factFinderPopulatableEntityModel.planId) &&
        Objects.equals(this.planLevel, factFinderPopulatableEntityModel.planLevel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(householdId, modules, planId, planLevel);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FactFinderPopulatableEntityModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FactFinderPopulatableEntityModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FactFinderPopulatableEntityModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FactFinderPopulatableEntityModel is not found in the empty JSON string", FactFinderPopulatableEntityModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FactFinderPopulatableEntityModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FactFinderPopulatableEntityModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FactFinderPopulatableEntityModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FactFinderPopulatableEntityModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FactFinderPopulatableEntityModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FactFinderPopulatableEntityModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FactFinderPopulatableEntityModel.class));

       return (TypeAdapter<T>) new TypeAdapter<FactFinderPopulatableEntityModel>() {
           @Override
           public void write(JsonWriter out, FactFinderPopulatableEntityModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FactFinderPopulatableEntityModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FactFinderPopulatableEntityModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FactFinderPopulatableEntityModel
   * @throws IOException if the JSON string is invalid with respect to FactFinderPopulatableEntityModel
   */
  public static FactFinderPopulatableEntityModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FactFinderPopulatableEntityModel.class);
  }

  /**
   * Convert an instance of FactFinderPopulatableEntityModel to an JSON string
   *
   * @return JSON string
   */
