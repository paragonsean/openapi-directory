...
public class IDemographicsDependentDomainObject {
  ...
  public IDemographicsDependentDomainObject() {
  }

  public IDemographicsDependentDomainObject birthDate(OffsetDateTime birthDate) {
  ...
  public IDemographicsDependentDomainObject demographicsId(Integer demographicsId) {
  ...
  public IDemographicsDependentDomainObject dependentId(Integer dependentId) {
  ...
  public IDemographicsDependentDomainObject dependentOf(DependentOfEnum dependentOf) {
  ...
  public IDemographicsDependentDomainObject externalDestinationId(String externalDestinationId) {
  ...
  public IDemographicsDependentDomainObject firstName(String firstName) {
  ...
  public IDemographicsDependentDomainObject lastName(String lastName) {
  ...
  public IDemographicsDependentDomainObject relationship(RelationshipEnum relationship) {
  ...
  public boolean equals(Object o) {
    ...
    IDemographicsDependentDomainObject idemographicsDependentDomainObject = (IDemographicsDependentDomainObject) o;
    return Objects.equals(this.birthDate, idemographicsDependentDomainObject.birthDate) &&
        Objects.equals(this.demographicsId, idemographicsDependentDomainObject.demographicsId) &&
        Objects.equals(this.dependentId, idemographicsDependentDomainObject.dependentId) &&
        Objects.equals(this.dependentOf, idemographicsDependentDomainObject.dependentOf) &&
        Objects.equals(this.externalDestinationId, idemographicsDependentDomainObject.externalDestinationId) &&
        Objects.equals(this.firstName, idemographicsDependentDomainObject.firstName) &&
        Objects.equals(this.lastName, idemographicsDependentDomainObject.lastName) &&
        Objects.equals(this.relationship, idemographicsDependentDomainObject.relationship);
  }

  @Override
  public int hashCode() {
    return Objects.hash(birthDate, demographicsId, dependentId, dependentOf, externalDestinationId, firstName, lastName, relationship);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IDemographicsDependentDomainObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IDemographicsDependentDomainObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IDemographicsDependentDomainObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IDemographicsDependentDomainObject is not found in the empty JSON string", IDemographicsDependentDomainObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IDemographicsDependentDomainObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IDemographicsDependentDomainObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IDemographicsDependentDomainObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IDemographicsDependentDomainObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IDemographicsDependentDomainObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IDemographicsDependentDomainObject.class));

       return (TypeAdapter<T>) new TypeAdapter<IDemographicsDependentDomainObject>() {
           @Override
           public void write(JsonWriter out, IDemographicsDependentDomainObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IDemographicsDependentDomainObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IDemographicsDependentDomainObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IDemographicsDependentDomainObject
   * @throws IOException if the JSON string is invalid with respect to IDemographicsDependentDomainObject
   */
  public static IDemographicsDependentDomainObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IDemographicsDependentDomainObject.class);
  }

  /**
   * Convert an instance of IDemographicsDependentDomainObject to an JSON string
   *
   * @return JSON string
   */
