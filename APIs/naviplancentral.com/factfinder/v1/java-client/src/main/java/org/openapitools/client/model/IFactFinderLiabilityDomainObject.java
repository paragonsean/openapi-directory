...
public class IFactFinderLiabilityDomainObject {
  ...
  public IFactFinderLiabilityDomainObject() {
  }

  public IFactFinderLiabilityDomainObject balance(Double balance) {
  ...
  public IFactFinderLiabilityDomainObject balanceAsOfDate(OffsetDateTime balanceAsOfDate) {
  ...
  public IFactFinderLiabilityDomainObject description(String description) {
  ...
  public IFactFinderLiabilityDomainObject externalDestinationId(String externalDestinationId) {
  ...
  public IFactFinderLiabilityDomainObject externalSourceId(String externalSourceId) {
  ...
  public IFactFinderLiabilityDomainObject factFinderId(Integer factFinderId) {
  ...
  public IFactFinderLiabilityDomainObject frequency(Integer frequency) {
  ...
  public IFactFinderLiabilityDomainObject importSource(String importSource) {
  ...
  public IFactFinderLiabilityDomainObject interestRate(Double interestRate) {
  ...
  public IFactFinderLiabilityDomainObject lastUpdated(OffsetDateTime lastUpdated) {
  ...
  public IFactFinderLiabilityDomainObject liabilityId(Integer liabilityId) {
  ...
  public IFactFinderLiabilityDomainObject liabilityType(Integer liabilityType) {
  ...
  public IFactFinderLiabilityDomainObject loanDate(OffsetDateTime loanDate) {
  ...
  public IFactFinderLiabilityDomainObject originalPrincipal(Double originalPrincipal) {
  ...
  public IFactFinderLiabilityDomainObject owner(OwnerEnum owner) {
    this.owner = owner;
    return this;
  }
  ...
  public IFactFinderLiabilityDomainObject payment(Double payment) {
  ...
  public IFactFinderLiabilityDomainObject paymentType(PaymentTypeEnum paymentType) {
  ...
  public boolean equals(Object o) {
    ...
    IFactFinderLiabilityDomainObject ifactFinderLiabilityDomainObject = (IFactFinderLiabilityDomainObject) o;
    return Objects.equals(this.balance, ifactFinderLiabilityDomainObject.balance) &&
        Objects.equals(this.balanceAsOfDate, ifactFinderLiabilityDomainObject.balanceAsOfDate) &&
        Objects.equals(this.description, ifactFinderLiabilityDomainObject.description) &&
        Objects.equals(this.externalDestinationId, ifactFinderLiabilityDomainObject.externalDestinationId) &&
        Objects.equals(this.externalSourceId, ifactFinderLiabilityDomainObject.externalSourceId) &&
        Objects.equals(this.factFinderId, ifactFinderLiabilityDomainObject.factFinderId) &&
        Objects.equals(this.frequency, ifactFinderLiabilityDomainObject.frequency) &&
        Objects.equals(this.importSource, ifactFinderLiabilityDomainObject.importSource) &&
        Objects.equals(this.interestRate, ifactFinderLiabilityDomainObject.interestRate) &&
        Objects.equals(this.lastUpdated, ifactFinderLiabilityDomainObject.lastUpdated) &&
        Objects.equals(this.liabilityId, ifactFinderLiabilityDomainObject.liabilityId) &&
        Objects.equals(this.liabilityType, ifactFinderLiabilityDomainObject.liabilityType) &&
        Objects.equals(this.loanDate, ifactFinderLiabilityDomainObject.loanDate) &&
        Objects.equals(this.originalPrincipal, ifactFinderLiabilityDomainObject.originalPrincipal) &&
        Objects.equals(this.owner, ifactFinderLiabilityDomainObject.owner) &&
        Objects.equals(this.payment, ifactFinderLiabilityDomainObject.payment) &&
        Objects.equals(this.paymentType, ifactFinderLiabilityDomainObject.paymentType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(balance, balanceAsOfDate, description, externalDestinationId, externalSourceId, factFinderId, frequency, importSource, interestRate, lastUpdated, liabilityId, liabilityType, loanDate, originalPrincipal, owner, payment, paymentType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IFactFinderLiabilityDomainObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IFactFinderLiabilityDomainObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IFactFinderLiabilityDomainObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IFactFinderLiabilityDomainObject is not found in the empty JSON string", IFactFinderLiabilityDomainObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IFactFinderLiabilityDomainObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IFactFinderLiabilityDomainObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("importSource") != null && !jsonObj.get("importSource").isJsonNull()) && !jsonObj.get("importSource").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `importSource` to be a primitive type in the JSON string but got `%s`", jsonObj.get("importSource").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IFactFinderLiabilityDomainObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IFactFinderLiabilityDomainObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IFactFinderLiabilityDomainObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IFactFinderLiabilityDomainObject.class));

       return (TypeAdapter<T>) new TypeAdapter<IFactFinderLiabilityDomainObject>() {
           @Override
           public void write(JsonWriter out, IFactFinderLiabilityDomainObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IFactFinderLiabilityDomainObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IFactFinderLiabilityDomainObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IFactFinderLiabilityDomainObject
   * @throws IOException if the JSON string is invalid with respect to IFactFinderLiabilityDomainObject
   */
  public static IFactFinderLiabilityDomainObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IFactFinderLiabilityDomainObject.class);
  }

  /**
   * Convert an instance of IFactFinderLiabilityDomainObject to an JSON string
   *
   * @return JSON string
   */
