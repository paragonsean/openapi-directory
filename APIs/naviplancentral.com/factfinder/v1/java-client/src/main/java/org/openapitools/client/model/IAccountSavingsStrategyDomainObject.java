...
public class IAccountSavingsStrategyDomainObject {
  ...
  public IAccountSavingsStrategyDomainObject() {
  }

  public IAccountSavingsStrategyDomainObject accountId(Integer accountId) {
  ...
  public IAccountSavingsStrategyDomainObject employerSavingsAmount(Double employerSavingsAmount) {
  ...
  public IAccountSavingsStrategyDomainObject employerSavingsAmountType(EmployerSavingsAmountTypeEnum employerSavingsAmountType) {
  ...
  public IAccountSavingsStrategyDomainObject endDate(OffsetDateTime endDate) {
  ...
  public IAccountSavingsStrategyDomainObject externalDestinationId(String externalDestinationId) {
  ...
  public IAccountSavingsStrategyDomainObject frequencyId(Integer frequencyId) {
  ...
  public IAccountSavingsStrategyDomainObject mandatoryAmount(Double mandatoryAmount) {
  ...
  public IAccountSavingsStrategyDomainObject mandatoryAmountType(MandatoryAmountTypeEnum mandatoryAmountType) {
  ...
  public IAccountSavingsStrategyDomainObject postTaxSavingsAmount(Double postTaxSavingsAmount) {
  ...
  public IAccountSavingsStrategyDomainObject postTaxSavingsAmountType(PostTaxSavingsAmountTypeEnum postTaxSavingsAmountType) {
  ...
  public IAccountSavingsStrategyDomainObject preTaxSavingsAmount(Double preTaxSavingsAmount) {
  ...
  public IAccountSavingsStrategyDomainObject preTaxSavingsAmountType(PreTaxSavingsAmountTypeEnum preTaxSavingsAmountType) {
  ...
  public IAccountSavingsStrategyDomainObject savingsStrategyId(Integer savingsStrategyId) {
  ...
  public IAccountSavingsStrategyDomainObject startDate(OffsetDateTime startDate) {
  ...
  public boolean equals(Object o) {
    ...
    IAccountSavingsStrategyDomainObject iaccountSavingsStrategyDomainObject = (IAccountSavingsStrategyDomainObject) o;
    return Objects.equals(this.accountId, iaccountSavingsStrategyDomainObject.accountId) &&
        Objects.equals(this.employerSavingsAmount, iaccountSavingsStrategyDomainObject.employerSavingsAmount) &&
        Objects.equals(this.employerSavingsAmountType, iaccountSavingsStrategyDomainObject.employerSavingsAmountType) &&
        Objects.equals(this.endDate, iaccountSavingsStrategyDomainObject.endDate) &&
        Objects.equals(this.externalDestinationId, iaccountSavingsStrategyDomainObject.externalDestinationId) &&
        Objects.equals(this.frequencyId, iaccountSavingsStrategyDomainObject.frequencyId) &&
        Objects.equals(this.mandatoryAmount, iaccountSavingsStrategyDomainObject.mandatoryAmount) &&
        Objects.equals(this.mandatoryAmountType, iaccountSavingsStrategyDomainObject.mandatoryAmountType) &&
        Objects.equals(this.postTaxSavingsAmount, iaccountSavingsStrategyDomainObject.postTaxSavingsAmount) &&
        Objects.equals(this.postTaxSavingsAmountType, iaccountSavingsStrategyDomainObject.postTaxSavingsAmountType) &&
        Objects.equals(this.preTaxSavingsAmount, iaccountSavingsStrategyDomainObject.preTaxSavingsAmount) &&
        Objects.equals(this.preTaxSavingsAmountType, iaccountSavingsStrategyDomainObject.preTaxSavingsAmountType) &&
        Objects.equals(this.savingsStrategyId, iaccountSavingsStrategyDomainObject.savingsStrategyId) &&
        Objects.equals(this.startDate, iaccountSavingsStrategyDomainObject.startDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class IAccountSavingsStrategyDomainObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IAccountSavingsStrategyDomainObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IAccountSavingsStrategyDomainObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IAccountSavingsStrategyDomainObject is not found in the empty JSON string", IAccountSavingsStrategyDomainObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IAccountSavingsStrategyDomainObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IAccountSavingsStrategyDomainObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IAccountSavingsStrategyDomainObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IAccountSavingsStrategyDomainObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IAccountSavingsStrategyDomainObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IAccountSavingsStrategyDomainObject.class));

       return (TypeAdapter<T>) new TypeAdapter<IAccountSavingsStrategyDomainObject>() {
           @Override
           public void write(JsonWriter out, IAccountSavingsStrategyDomainObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IAccountSavingsStrategyDomainObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IAccountSavingsStrategyDomainObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IAccountSavingsStrategyDomainObject
   * @throws IOException if the JSON string is invalid with respect to IAccountSavingsStrategyDomainObject
   */
  public static IAccountSavingsStrategyDomainObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IAccountSavingsStrategyDomainObject.class);
  }

  /**
   * Convert an instance of IAccountSavingsStrategyDomainObject to an JSON string
   *
   * @return JSON string
   */
