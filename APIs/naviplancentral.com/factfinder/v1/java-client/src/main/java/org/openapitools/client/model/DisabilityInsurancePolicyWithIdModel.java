...
public class DisabilityInsurancePolicyWithIdModel {
  ...
  public DisabilityInsurancePolicyWithIdModel() {
  }

  public DisabilityInsurancePolicyWithIdModel benefit(Double benefit) {
  ...
  public DisabilityInsurancePolicyWithIdModel benefitFrequency(Integer benefitFrequency) {
  ...
  public DisabilityInsurancePolicyWithIdModel benefitType(BenefitTypeEnum benefitType) {
  ...
  public DisabilityInsurancePolicyWithIdModel description(String description) {
  ...
  public DisabilityInsurancePolicyWithIdModel externalDestinationId(String externalDestinationId) {
  ...
  public DisabilityInsurancePolicyWithIdModel factFinderId(Integer factFinderId) {
  ...
  public DisabilityInsurancePolicyWithIdModel insurancePolicyId(Integer insurancePolicyId) {
  ...
  public DisabilityInsurancePolicyWithIdModel insured(InsuredEnum insured) {
  ...
  public DisabilityInsurancePolicyWithIdModel links(List<ObjectLink> links) {
    this.links = links;
    return this;
  }

  public DisabilityInsurancePolicyWithIdModel addLinksItem(ObjectLink linksItem) {
    if (this.links == null) {
  ...
  public DisabilityInsurancePolicyWithIdModel policyType(Integer policyType) {
  ...
  public DisabilityInsurancePolicyWithIdModel premium(Double premium) {
  ...
  public DisabilityInsurancePolicyWithIdModel premiumFrequency(Integer premiumFrequency) {
  ...
  public boolean equals(Object o) {
    ...
    DisabilityInsurancePolicyWithIdModel disabilityInsurancePolicyWithIdModel = (DisabilityInsurancePolicyWithIdModel) o;
    return Objects.equals(this.benefit, disabilityInsurancePolicyWithIdModel.benefit) &&
        Objects.equals(this.benefitFrequency, disabilityInsurancePolicyWithIdModel.benefitFrequency) &&
        Objects.equals(this.benefitType, disabilityInsurancePolicyWithIdModel.benefitType) &&
        Objects.equals(this.description, disabilityInsurancePolicyWithIdModel.description) &&
        Objects.equals(this.externalDestinationId, disabilityInsurancePolicyWithIdModel.externalDestinationId) &&
        Objects.equals(this.factFinderId, disabilityInsurancePolicyWithIdModel.factFinderId) &&
        Objects.equals(this.insurancePolicyId, disabilityInsurancePolicyWithIdModel.insurancePolicyId) &&
        Objects.equals(this.insured, disabilityInsurancePolicyWithIdModel.insured) &&
        Objects.equals(this.links, disabilityInsurancePolicyWithIdModel.links) &&
        Objects.equals(this.policyType, disabilityInsurancePolicyWithIdModel.policyType) &&
        Objects.equals(this.premium, disabilityInsurancePolicyWithIdModel.premium) &&
        Objects.equals(this.premiumFrequency, disabilityInsurancePolicyWithIdModel.premiumFrequency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(benefit, benefitFrequency, benefitType, description, externalDestinationId, factFinderId, insurancePolicyId, insured, links, policyType, premium, premiumFrequency);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisabilityInsurancePolicyWithIdModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisabilityInsurancePolicyWithIdModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisabilityInsurancePolicyWithIdModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisabilityInsurancePolicyWithIdModel is not found in the empty JSON string", DisabilityInsurancePolicyWithIdModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisabilityInsurancePolicyWithIdModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisabilityInsurancePolicyWithIdModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisabilityInsurancePolicyWithIdModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisabilityInsurancePolicyWithIdModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisabilityInsurancePolicyWithIdModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisabilityInsurancePolicyWithIdModel.class));

       return (TypeAdapter<T>) new TypeAdapter<DisabilityInsurancePolicyWithIdModel>() {
           @Override
           public void write(JsonWriter out, DisabilityInsurancePolicyWithIdModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisabilityInsurancePolicyWithIdModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisabilityInsurancePolicyWithIdModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisabilityInsurancePolicyWithIdModel
   * @throws IOException if the JSON string is invalid with respect to DisabilityInsurancePolicyWithIdModel
   */
  public static DisabilityInsurancePolicyWithIdModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisabilityInsurancePolicyWithIdModel.class);
  }

  /**
   * Convert an instance of DisabilityInsurancePolicyWithIdModel to an JSON string
   *
   * @return JSON string
   */
