...
public class ExpenseWithIdModel {
  ...
  public ExpenseWithIdModel() {
  }

  public ExpenseWithIdModel annualPeriod(Integer annualPeriod) {
  ...
  public ExpenseWithIdModel description(String description) {
  ...
  public ExpenseWithIdModel endDate(OffsetDateTime endDate) {
  ...
  public ExpenseWithIdModel expenseAmount(Double expenseAmount) {
  ...
  public ExpenseWithIdModel expenseId(Integer expenseId) {
  ...
  public ExpenseWithIdModel expenseTypeId(Integer expenseTypeId) {
  ...
  public ExpenseWithIdModel externalDestinationId(String externalDestinationId) {
  ...
  public ExpenseWithIdModel factFinderId(Integer factFinderId) {
  ...
  public ExpenseWithIdModel frequency(Integer frequency) {
  ...
  public ExpenseWithIdModel links(List<ObjectLink> links) {
    this.links = links;
    return this;
  }

  public ExpenseWithIdModel addLinksItem(ObjectLink linksItem) {
    if (this.links == null) {
  ...
  public ExpenseWithIdModel member(MemberEnum member) {
    this.member = member;
    return this;
  }
  ...
  public ExpenseWithIdModel startDate(OffsetDateTime startDate) {
  ...
  public boolean equals(Object o) {
    ...
    ExpenseWithIdModel expenseWithIdModel = (ExpenseWithIdModel) o;
    return Objects.equals(this.annualPeriod, expenseWithIdModel.annualPeriod) &&
        Objects.equals(this.description, expenseWithIdModel.description) &&
        Objects.equals(this.endDate, expenseWithIdModel.endDate) &&
        Objects.equals(this.expenseAmount, expenseWithIdModel.expenseAmount) &&
        Objects.equals(this.expenseId, expenseWithIdModel.expenseId) &&
        Objects.equals(this.expenseTypeId, expenseWithIdModel.expenseTypeId) &&
        Objects.equals(this.externalDestinationId, expenseWithIdModel.externalDestinationId) &&
        Objects.equals(this.factFinderId, expenseWithIdModel.factFinderId) &&
        Objects.equals(this.frequency, expenseWithIdModel.frequency) &&
        Objects.equals(this.links, expenseWithIdModel.links) &&
        Objects.equals(this.member, expenseWithIdModel.member) &&
        Objects.equals(this.startDate, expenseWithIdModel.startDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(annualPeriod, description, endDate, expenseAmount, expenseId, expenseTypeId, externalDestinationId, factFinderId, frequency, links, member, startDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpenseWithIdModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpenseWithIdModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExpenseWithIdModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpenseWithIdModel is not found in the empty JSON string", ExpenseWithIdModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpenseWithIdModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpenseWithIdModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpenseWithIdModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpenseWithIdModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpenseWithIdModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpenseWithIdModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpenseWithIdModel>() {
           @Override
           public void write(JsonWriter out, ExpenseWithIdModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExpenseWithIdModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExpenseWithIdModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExpenseWithIdModel
   * @throws IOException if the JSON string is invalid with respect to ExpenseWithIdModel
   */
  public static ExpenseWithIdModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpenseWithIdModel.class);
  }

  /**
   * Convert an instance of ExpenseWithIdModel to an JSON string
   *
   * @return JSON string
   */
