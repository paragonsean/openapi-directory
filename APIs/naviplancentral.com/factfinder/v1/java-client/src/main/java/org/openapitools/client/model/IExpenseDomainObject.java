...
public class IExpenseDomainObject {
  ...
  public IExpenseDomainObject() {
  }

  public IExpenseDomainObject annualPeriod(Integer annualPeriod) {
  ...
  public IExpenseDomainObject description(String description) {
  ...
  public IExpenseDomainObject endDate(OffsetDateTime endDate) {
  ...
  public IExpenseDomainObject expenseAmount(Double expenseAmount) {
  ...
  public IExpenseDomainObject expenseId(Integer expenseId) {
  ...
  public IExpenseDomainObject expenseTypeId(Integer expenseTypeId) {
  ...
  public IExpenseDomainObject externalDestinationId(String externalDestinationId) {
  ...
  public IExpenseDomainObject factFinderId(Integer factFinderId) {
  ...
  public IExpenseDomainObject frequency(Integer frequency) {
  ...
  public IExpenseDomainObject member(MemberEnum member) {
    this.member = member;
    return this;
  }
  ...
  public IExpenseDomainObject startDate(OffsetDateTime startDate) {
  ...
  public boolean equals(Object o) {
    ...
    IExpenseDomainObject iexpenseDomainObject = (IExpenseDomainObject) o;
    return Objects.equals(this.annualPeriod, iexpenseDomainObject.annualPeriod) &&
        Objects.equals(this.description, iexpenseDomainObject.description) &&
        Objects.equals(this.endDate, iexpenseDomainObject.endDate) &&
        Objects.equals(this.expenseAmount, iexpenseDomainObject.expenseAmount) &&
        Objects.equals(this.expenseId, iexpenseDomainObject.expenseId) &&
        Objects.equals(this.expenseTypeId, iexpenseDomainObject.expenseTypeId) &&
        Objects.equals(this.externalDestinationId, iexpenseDomainObject.externalDestinationId) &&
        Objects.equals(this.factFinderId, iexpenseDomainObject.factFinderId) &&
        Objects.equals(this.frequency, iexpenseDomainObject.frequency) &&
        Objects.equals(this.member, iexpenseDomainObject.member) &&
        Objects.equals(this.startDate, iexpenseDomainObject.startDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(annualPeriod, description, endDate, expenseAmount, expenseId, expenseTypeId, externalDestinationId, factFinderId, frequency, member, startDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IExpenseDomainObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IExpenseDomainObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IExpenseDomainObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IExpenseDomainObject is not found in the empty JSON string", IExpenseDomainObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IExpenseDomainObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IExpenseDomainObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IExpenseDomainObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IExpenseDomainObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IExpenseDomainObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IExpenseDomainObject.class));

       return (TypeAdapter<T>) new TypeAdapter<IExpenseDomainObject>() {
           @Override
           public void write(JsonWriter out, IExpenseDomainObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IExpenseDomainObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IExpenseDomainObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IExpenseDomainObject
   * @throws IOException if the JSON string is invalid with respect to IExpenseDomainObject
   */
  public static IExpenseDomainObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IExpenseDomainObject.class);
  }

  /**
   * Convert an instance of IExpenseDomainObject to an JSON string
   *
   * @return JSON string
   */
