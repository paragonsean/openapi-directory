...
QString OAILifestyleAssetModel::getDescription() const {
    return m_description;
}
void OAILifestyleAssetModel::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAILifestyleAssetModel::is_description_Set() const{
    return m_description_isSet;
}

bool OAILifestyleAssetModel::is_description_Valid() const{
    return m_description_isValid;
}

QString OAILifestyleAssetModel::getExternalDestinationId() const {
    return m_external_destination_id;
}
void OAILifestyleAssetModel::setExternalDestinationId(const QString &external_destination_id) {
    m_external_destination_id = external_destination_id;
    m_external_destination_id_isSet = true;
}

bool OAILifestyleAssetModel::is_external_destination_id_Set() const{
    return m_external_destination_id_isSet;
}

bool OAILifestyleAssetModel::is_external_destination_id_Valid() const{
    return m_external_destination_id_isValid;
}

qint32 OAILifestyleAssetModel::getFactFinderId() const {
    return m_fact_finder_id;
}
void OAILifestyleAssetModel::setFactFinderId(const qint32 &fact_finder_id) {
    m_fact_finder_id = fact_finder_id;
    m_fact_finder_id_isSet = true;
}

bool OAILifestyleAssetModel::is_fact_finder_id_Set() const{
    return m_fact_finder_id_isSet;
}

bool OAILifestyleAssetModel::is_fact_finder_id_Valid() const{
    return m_fact_finder_id_isValid;
}

double OAILifestyleAssetModel::getMarketValue() const {
    return m_market_value;
}
void OAILifestyleAssetModel::setMarketValue(const double &market_value) {
    m_market_value = market_value;
    m_market_value_isSet = true;
}

bool OAILifestyleAssetModel::is_market_value_Set() const{
    return m_market_value_isSet;
}

bool OAILifestyleAssetModel::is_market_value_Valid() const{
    return m_market_value_isValid;
}

QString OAILifestyleAssetModel::getOwner() const {
    return m_owner;
}
void OAILifestyleAssetModel::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAILifestyleAssetModel::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAILifestyleAssetModel::is_owner_Valid() const{
    return m_owner_isValid;
}

double OAILifestyleAssetModel::getPurchaseAmount() const {
    return m_purchase_amount;
}
void OAILifestyleAssetModel::setPurchaseAmount(const double &purchase_amount) {
    m_purchase_amount = purchase_amount;
    m_purchase_amount_isSet = true;
}

bool OAILifestyleAssetModel::is_purchase_amount_Set() const{
    return m_purchase_amount_isSet;
}

bool OAILifestyleAssetModel::is_purchase_amount_Valid() const{
    return m_purchase_amount_isValid;
}

QDateTime OAILifestyleAssetModel::getPurchaseDate() const {
    return m_purchase_date;
}
void OAILifestyleAssetModel::setPurchaseDate(const QDateTime &purchase_date) {
    m_purchase_date = purchase_date;
    m_purchase_date_isSet = true;
}

bool OAILifestyleAssetModel::is_purchase_date_Set() const{
    return m_purchase_date_isSet;
}

bool OAILifestyleAssetModel::is_purchase_date_Valid() const{
    return m_purchase_date_isValid;
}

qint32 OAILifestyleAssetModel::getType() const {
    return m_type;
}
void OAILifestyleAssetModel::setType(const qint32 &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILifestyleAssetModel::is_type_Set() const{
    return m_type_isSet;
}

bool OAILifestyleAssetModel::is_type_Valid() const{
