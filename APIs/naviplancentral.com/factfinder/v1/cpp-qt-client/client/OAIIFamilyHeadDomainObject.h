...
/*
 * OAIIFamilyHeadDomainObject.h
 *
 * 
 */

#ifndef OAIIFamilyHeadDomainObject_H
#define OAIIFamilyHeadDomainObject_H
...
class OAIIFamilyHeadDomainObject : public OAIObject {
public:
    OAIIFamilyHeadDomainObject();
    OAIIFamilyHeadDomainObject(QString json);
    ~OAIIFamilyHeadDomainObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIFamilyHeadDomainObject)

#endif // OAIIFamilyHeadDomainObject_H
