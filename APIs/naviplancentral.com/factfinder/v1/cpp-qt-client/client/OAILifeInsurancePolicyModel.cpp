...
OAILifeInsurancePolicyModel::OAILifeInsurancePolicyModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILifeInsurancePolicyModel::OAILifeInsurancePolicyModel() {
    this->initializeModel();
}

OAILifeInsurancePolicyModel::~OAILifeInsurancePolicyModel() {}

void OAILifeInsurancePolicyModel::initializeModel() {
...
void OAILifeInsurancePolicyModel::fromJson(QString jsonString) {
...
void OAILifeInsurancePolicyModel::fromJsonObject(QJsonObject json) {
...
QString OAILifeInsurancePolicyModel::asJson() const {
...
QJsonObject OAILifeInsurancePolicyModel::asJsonObject() const {
    QJsonObject obj;
...
QString OAILifeInsurancePolicyModel::getBeneficiary() const {
    return m_beneficiary;
}
void OAILifeInsurancePolicyModel::setBeneficiary(const QString &beneficiary) {
    m_beneficiary = beneficiary;
    m_beneficiary_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_beneficiary_Set() const{
    return m_beneficiary_isSet;
}

bool OAILifeInsurancePolicyModel::is_beneficiary_Valid() const{
    return m_beneficiary_isValid;
}

qint32 OAILifeInsurancePolicyModel::getBeneficiaryDependentId() const {
    return m_beneficiary_dependent_id;
}
void OAILifeInsurancePolicyModel::setBeneficiaryDependentId(const qint32 &beneficiary_dependent_id) {
    m_beneficiary_dependent_id = beneficiary_dependent_id;
    m_beneficiary_dependent_id_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_beneficiary_dependent_id_Set() const{
    return m_beneficiary_dependent_id_isSet;
}

bool OAILifeInsurancePolicyModel::is_beneficiary_dependent_id_Valid() const{
    return m_beneficiary_dependent_id_isValid;
}

double OAILifeInsurancePolicyModel::getBenefit() const {
    return m_benefit;
}
void OAILifeInsurancePolicyModel::setBenefit(const double &benefit) {
    m_benefit = benefit;
    m_benefit_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_benefit_Set() const{
    return m_benefit_isSet;
}

bool OAILifeInsurancePolicyModel::is_benefit_Valid() const{
    return m_benefit_isValid;
}

QString OAILifeInsurancePolicyModel::getDescription() const {
    return m_description;
}
void OAILifeInsurancePolicyModel::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_description_Set() const{
    return m_description_isSet;
}

bool OAILifeInsurancePolicyModel::is_description_Valid() const{
    return m_description_isValid;
}

QString OAILifeInsurancePolicyModel::getExternalDestinationId() const {
    return m_external_destination_id;
}
void OAILifeInsurancePolicyModel::setExternalDestinationId(const QString &external_destination_id) {
    m_external_destination_id = external_destination_id;
    m_external_destination_id_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_external_destination_id_Set() const{
    return m_external_destination_id_isSet;
}

bool OAILifeInsurancePolicyModel::is_external_destination_id_Valid() const{
    return m_external_destination_id_isValid;
}

qint32 OAILifeInsurancePolicyModel::getFactFinderId() const {
    return m_fact_finder_id;
}
void OAILifeInsurancePolicyModel::setFactFinderId(const qint32 &fact_finder_id) {
    m_fact_finder_id = fact_finder_id;
    m_fact_finder_id_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_fact_finder_id_Set() const{
    return m_fact_finder_id_isSet;
}

bool OAILifeInsurancePolicyModel::is_fact_finder_id_Valid() const{
    return m_fact_finder_id_isValid;
}

qint32 OAILifeInsurancePolicyModel::getFrequency() const {
    return m_frequency;
}
void OAILifeInsurancePolicyModel::setFrequency(const qint32 &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAILifeInsurancePolicyModel::is_frequency_Valid() const{
    return m_frequency_isValid;
}

double OAILifeInsurancePolicyModel::getGeneralAccountMarketValue() const {
    return m_general_account_market_value;
}
void OAILifeInsurancePolicyModel::setGeneralAccountMarketValue(const double &general_account_market_value) {
    m_general_account_market_value = general_account_market_value;
    m_general_account_market_value_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_general_account_market_value_Set() const{
    return m_general_account_market_value_isSet;
}

bool OAILifeInsurancePolicyModel::is_general_account_market_value_Valid() const{
    return m_general_account_market_value_isValid;
}

QString OAILifeInsurancePolicyModel::getInsured() const {
    return m_insured;
}
void OAILifeInsurancePolicyModel::setInsured(const QString &insured) {
    m_insured = insured;
    m_insured_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_insured_Set() const{
    return m_insured_isSet;
}

bool OAILifeInsurancePolicyModel::is_insured_Valid() const{
    return m_insured_isValid;
}

QString OAILifeInsurancePolicyModel::getPayer() const {
    return m_payer;
}
void OAILifeInsurancePolicyModel::setPayer(const QString &payer) {
    m_payer = payer;
    m_payer_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_payer_Set() const{
    return m_payer_isSet;
}

bool OAILifeInsurancePolicyModel::is_payer_Valid() const{
    return m_payer_isValid;
}

qint32 OAILifeInsurancePolicyModel::getPolicyType() const {
    return m_policy_type;
}
void OAILifeInsurancePolicyModel::setPolicyType(const qint32 &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAILifeInsurancePolicyModel::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

double OAILifeInsurancePolicyModel::getPremium() const {
    return m_premium;
}
void OAILifeInsurancePolicyModel::setPremium(const double &premium) {
    m_premium = premium;
    m_premium_isSet = true;
}

bool OAILifeInsurancePolicyModel::is_premium_Set() const{
    return m_premium_isSet;
}

bool OAILifeInsurancePolicyModel::is_premium_Valid() const{
    return m_premium_isValid;
}

bool OAILifeInsurancePolicyModel::isSet() const {
...
bool OAILifeInsurancePolicyModel::isValid() const {
