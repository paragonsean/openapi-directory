...
/*
 * OAIDemographicsDependentModel.h
 *
 * 
 */

#ifndef OAIDemographicsDependentModel_H
#define OAIDemographicsDependentModel_H
...
class OAIDemographicsDependentModel : public OAIObject {
public:
    OAIDemographicsDependentModel();
    OAIDemographicsDependentModel(QString json);
    ~OAIDemographicsDependentModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDemographicsDependentModel)

#endif // OAIDemographicsDependentModel_H
