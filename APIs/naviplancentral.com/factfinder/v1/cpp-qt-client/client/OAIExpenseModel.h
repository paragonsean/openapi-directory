...
#ifndef OAIExpenseModel_H
#define OAIExpenseModel_H
...
class OAIExpenseModel : public OAIObject {
public:
    OAIExpenseModel();
    OAIExpenseModel(QString json);
    ~OAIExpenseModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpenseModel)

#endif // OAIExpenseModel_H
