...
/*
 * OAIIFactFinderLifestyleAssetDomainObject.h
 *
 * 
 */

#ifndef OAIIFactFinderLifestyleAssetDomainObject_H
#define OAIIFactFinderLifestyleAssetDomainObject_H
...
class OAIIFactFinderLifestyleAssetDomainObject : public OAIObject {
public:
    OAIIFactFinderLifestyleAssetDomainObject();
    OAIIFactFinderLifestyleAssetDomainObject(QString json);
    ~OAIIFactFinderLifestyleAssetDomainObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIFactFinderLifestyleAssetDomainObject)

#endif // OAIIFactFinderLifestyleAssetDomainObject_H
