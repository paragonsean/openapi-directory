...
/*
 * OAIIExpenseDomainObject.h
 *
 * 
 */

#ifndef OAIIExpenseDomainObject_H
#define OAIIExpenseDomainObject_H
...
class OAIIExpenseDomainObject : public OAIObject {
public:
    OAIIExpenseDomainObject();
    OAIIExpenseDomainObject(QString json);
    ~OAIIExpenseDomainObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIExpenseDomainObject)

#endif // OAIIExpenseDomainObject_H
