...
/*
 * OAIIAccountSavingsStrategyDomainObject.h
 *
 * 
 */

#ifndef OAIIAccountSavingsStrategyDomainObject_H
#define OAIIAccountSavingsStrategyDomainObject_H
...
class OAIIAccountSavingsStrategyDomainObject : public OAIObject {
public:
    OAIIAccountSavingsStrategyDomainObject();
    OAIIAccountSavingsStrategyDomainObject(QString json);
    ~OAIIAccountSavingsStrategyDomainObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIAccountSavingsStrategyDomainObject)

#endif // OAIIAccountSavingsStrategyDomainObject_H
