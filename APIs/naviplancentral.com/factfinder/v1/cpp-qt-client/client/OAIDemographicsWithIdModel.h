...
/*
 * OAIDemographicsWithIdModel.h
 *
 * 
 */

#ifndef OAIDemographicsWithIdModel_H
#define OAIDemographicsWithIdModel_H
...
class OAIDemographicsWithIdModel : public OAIObject {
public:
    OAIDemographicsWithIdModel();
    OAIDemographicsWithIdModel(QString json);
    ~OAIDemographicsWithIdModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDemographicsWithIdModel)

#endif // OAIDemographicsWithIdModel_H
