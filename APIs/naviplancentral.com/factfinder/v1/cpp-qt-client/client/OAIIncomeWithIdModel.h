...
/*
 * OAIIncomeWithIdModel.h
 *
 * 
 */

#ifndef OAIIncomeWithIdModel_H
#define OAIIncomeWithIdModel_H
...
class OAIIncomeWithIdModel : public OAIObject {
public:
    OAIIncomeWithIdModel();
    OAIIncomeWithIdModel(QString json);
    ~OAIIncomeWithIdModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIncomeWithIdModel)

#endif // OAIIncomeWithIdModel_H
