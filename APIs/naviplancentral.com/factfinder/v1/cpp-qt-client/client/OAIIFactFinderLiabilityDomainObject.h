...
/*
 * OAIIFactFinderLiabilityDomainObject.h
 *
 * 
 */

#ifndef OAIIFactFinderLiabilityDomainObject_H
#define OAIIFactFinderLiabilityDomainObject_H
...
class OAIIFactFinderLiabilityDomainObject : public OAIObject {
public:
    OAIIFactFinderLiabilityDomainObject();
    OAIIFactFinderLiabilityDomainObject(QString json);
    ~OAIIFactFinderLiabilityDomainObject() override;
    ...
    void setImportSource(const QString &import_source);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIFactFinderLiabilityDomainObject)

#endif // OAIIFactFinderLiabilityDomainObject_H
