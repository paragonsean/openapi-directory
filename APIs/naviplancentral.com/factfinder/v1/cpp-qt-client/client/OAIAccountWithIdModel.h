...
/*
 * OAIAccountWithIdModel.h
 *
 * 
 */

#ifndef OAIAccountWithIdModel_H
#define OAIAccountWithIdModel_H
...
class OAIAccountWithIdModel : public OAIObject {
public:
    OAIAccountWithIdModel();
    OAIAccountWithIdModel(QString json);
    ~OAIAccountWithIdModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountWithIdModel)

#endif // OAIAccountWithIdModel_H
