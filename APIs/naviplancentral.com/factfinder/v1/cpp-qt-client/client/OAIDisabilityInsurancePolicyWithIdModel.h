...
/*
 * OAIDisabilityInsurancePolicyWithIdModel.h
 *
 * 
 */

#ifndef OAIDisabilityInsurancePolicyWithIdModel_H
#define OAIDisabilityInsurancePolicyWithIdModel_H
...
class OAIDisabilityInsurancePolicyWithIdModel : public OAIObject {
public:
    OAIDisabilityInsurancePolicyWithIdModel();
    OAIDisabilityInsurancePolicyWithIdModel(QString json);
    ~OAIDisabilityInsurancePolicyWithIdModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisabilityInsurancePolicyWithIdModel)

#endif // OAIDisabilityInsurancePolicyWithIdModel_H
