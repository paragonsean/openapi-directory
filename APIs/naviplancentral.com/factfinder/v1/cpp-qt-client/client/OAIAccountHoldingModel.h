...
/*
 * OAIAccountHoldingModel.h
 *
 * 
 */

#ifndef OAIAccountHoldingModel_H
#define OAIAccountHoldingModel_H
...
class OAIAccountHoldingModel : public OAIObject {
public:
    OAIAccountHoldingModel();
    OAIAccountHoldingModel(QString json);
    ~OAIAccountHoldingModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountHoldingModel)

#endif // OAIAccountHoldingModel_H
