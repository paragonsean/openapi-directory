...
/*
 * OAICriticalIllnessInsurancePolicyModel.h
 *
 * 
 */

#ifndef OAICriticalIllnessInsurancePolicyModel_H
#define OAICriticalIllnessInsurancePolicyModel_H
...
class OAICriticalIllnessInsurancePolicyModel : public OAIObject {
public:
    OAICriticalIllnessInsurancePolicyModel();
    OAICriticalIllnessInsurancePolicyModel(QString json);
    ~OAICriticalIllnessInsurancePolicyModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICriticalIllnessInsurancePolicyModel)

#endif // OAICriticalIllnessInsurancePolicyModel_H
