...
QList<OAILiabilityWithIdModel> OAILiabilitiesModel::getLiabilities() const {
    return m_liabilities;
}
void OAILiabilitiesModel::setLiabilities(const QList<OAILiabilityWithIdModel> &liabilities) {
