...
/*
 * OAIRealEstateAssetModel.h
 *
 * 
 */

#ifndef OAIRealEstateAssetModel_H
#define OAIRealEstateAssetModel_H
...
class OAIRealEstateAssetModel : public OAIObject {
public:
    OAIRealEstateAssetModel();
    OAIRealEstateAssetModel(QString json);
    ~OAIRealEstateAssetModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRealEstateAssetModel)

#endif // OAIRealEstateAssetModel_H
