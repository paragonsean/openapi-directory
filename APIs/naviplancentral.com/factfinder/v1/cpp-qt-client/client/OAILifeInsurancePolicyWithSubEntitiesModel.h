...
/*
 * OAILifeInsurancePolicyWithSubEntitiesModel.h
 *
 * 
 */

#ifndef OAILifeInsurancePolicyWithSubEntitiesModel_H
#define OAILifeInsurancePolicyWithSubEntitiesModel_H
...
class OAILifeInsurancePolicyWithSubEntitiesModel : public OAIObject {
public:
    OAILifeInsurancePolicyWithSubEntitiesModel();
    OAILifeInsurancePolicyWithSubEntitiesModel(QString json);
    ~OAILifeInsurancePolicyWithSubEntitiesModel() override;
    ...
    QList<OAILifeInsurancePolicySubaccountWithIdModel> getSubaccounts() const;
    void setSubaccounts(const QList<OAILifeInsurancePolicySubaccountWithIdModel> &subaccounts);
...
private:
    ...
    QList<OAILifeInsurancePolicySubaccountWithIdModel> m_subaccounts;
...
Q_DECLARE_METATYPE(OpenAPI::OAILifeInsurancePolicyWithSubEntitiesModel)

#endif // OAILifeInsurancePolicyWithSubEntitiesModel_H
