...
OAIFactFinderEntityModel::OAIFactFinderEntityModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFactFinderEntityModel::OAIFactFinderEntityModel() {
    this->initializeModel();
}

OAIFactFinderEntityModel::~OAIFactFinderEntityModel() {}

void OAIFactFinderEntityModel::initializeModel() {
...
void OAIFactFinderEntityModel::fromJson(QString jsonString) {
...
void OAIFactFinderEntityModel::fromJsonObject(QJsonObject json) {
...
QString OAIFactFinderEntityModel::asJson() const {
...
QJsonObject OAIFactFinderEntityModel::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIFactFinderEntityModel::getHouseholdId() const {
    return m_household_id;
}
void OAIFactFinderEntityModel::setHouseholdId(const qint32 &household_id) {
    m_household_id = household_id;
    m_household_id_isSet = true;
}

bool OAIFactFinderEntityModel::is_household_id_Set() const{
    return m_household_id_isSet;
}

bool OAIFactFinderEntityModel::is_household_id_Valid() const{
    return m_household_id_isValid;
}

QList<QString> OAIFactFinderEntityModel::getModules() const {
    return m_modules;
}
void OAIFactFinderEntityModel::setModules(const QList<QString> &modules) {
    m_modules = modules;
    m_modules_isSet = true;
}

bool OAIFactFinderEntityModel::is_modules_Set() const{
    return m_modules_isSet;
}

bool OAIFactFinderEntityModel::is_modules_Valid() const{
    return m_modules_isValid;
}

QString OAIFactFinderEntityModel::getPlanLevel() const {
    return m_plan_level;
}
void OAIFactFinderEntityModel::setPlanLevel(const QString &plan_level) {
    m_plan_level = plan_level;
    m_plan_level_isSet = true;
}

bool OAIFactFinderEntityModel::is_plan_level_Set() const{
    return m_plan_level_isSet;
}

bool OAIFactFinderEntityModel::is_plan_level_Valid() const{
    return m_plan_level_isValid;
}

bool OAIFactFinderEntityModel::isSet() const {
...
bool OAIFactFinderEntityModel::isValid() const {
