...
/*
 * OAIRetirementExpenseWithIdModel.h
 *
 * 
 */

#ifndef OAIRetirementExpenseWithIdModel_H
#define OAIRetirementExpenseWithIdModel_H
...
class OAIRetirementExpenseWithIdModel : public OAIObject {
public:
    OAIRetirementExpenseWithIdModel();
    OAIRetirementExpenseWithIdModel(QString json);
    ~OAIRetirementExpenseWithIdModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetirementExpenseWithIdModel)

#endif // OAIRetirementExpenseWithIdModel_H
