...
/*
 * OAIFactFinderEntityModel.h
 *
 * 
 */

#ifndef OAIFactFinderEntityModel_H
#define OAIFactFinderEntityModel_H
...
class OAIFactFinderEntityModel : public OAIObject {
public:
    OAIFactFinderEntityModel();
    OAIFactFinderEntityModel(QString json);
    ~OAIFactFinderEntityModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFactFinderEntityModel)

#endif // OAIFactFinderEntityModel_H
