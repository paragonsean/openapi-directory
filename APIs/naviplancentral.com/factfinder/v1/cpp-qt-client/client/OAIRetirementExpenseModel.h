...
/*
 * OAIRetirementExpenseModel.h
 *
 * 
 */

#ifndef OAIRetirementExpenseModel_H
#define OAIRetirementExpenseModel_H
...
class OAIRetirementExpenseModel : public OAIObject {
public:
    OAIRetirementExpenseModel();
    OAIRetirementExpenseModel(QString json);
    ~OAIRetirementExpenseModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetirementExpenseModel)

#endif // OAIRetirementExpenseModel_H
