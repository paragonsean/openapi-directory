...
public class ApiClient {
    ...
    private String basePath = "https://demo.uat.naviplancentral.com/plan";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://demo.uat.naviplancentral.com/plan",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "http://demo.uat.naviplancentral.com/plan",
      "No description provided",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demo.uat.naviplancentral.com/plan
