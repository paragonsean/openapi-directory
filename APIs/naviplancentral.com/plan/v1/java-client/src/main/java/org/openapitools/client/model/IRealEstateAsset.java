...
public class IRealEstateAsset {
  ...
  public IRealEstateAsset currentYearNetRentalIncome(Currency currentYearNetRentalIncome) {
  ...
  public IRealEstateAsset marketValueAsOf(CurrencyWithDate marketValueAsOf) {
  ...
  public IRealEstateAsset preTaxGrowthRate(Percent preTaxGrowthRate) {
  ...
  public IRealEstateAsset purchaseAmount(Currency purchaseAmount) {
  ...
  public IRealEstateAsset purchaseDate(Date purchaseDate) {
  ...
  public IRealEstateAsset standardDeviation(Percent standardDeviation) {
  ...
  public IRealEstateAsset startOfYearCostBasis(Currency startOfYearCostBasis) {
  ...
  public IRealEstateAsset startOfYearMarketValue(Currency startOfYearMarketValue) {
  ...
  public boolean equals(Object o) {
    ...
    IRealEstateAsset irealEstateAsset = (IRealEstateAsset) o;
    return Objects.equals(this.currentYearNetRentalIncome, irealEstateAsset.currentYearNetRentalIncome) &&
        Objects.equals(this.description, irealEstateAsset.description) &&
        Objects.equals(this.id, irealEstateAsset.id) &&
        Objects.equals(this.marketValueAsOf, irealEstateAsset.marketValueAsOf) &&
        Objects.equals(this.owner, irealEstateAsset.owner) &&
        Objects.equals(this.preTaxGrowthRate, irealEstateAsset.preTaxGrowthRate) &&
        Objects.equals(this.purchaseAmount, irealEstateAsset.purchaseAmount) &&
        Objects.equals(this.purchaseDate, irealEstateAsset.purchaseDate) &&
        Objects.equals(this.standardDeviation, irealEstateAsset.standardDeviation) &&
        Objects.equals(this.startOfYearCostBasis, irealEstateAsset.startOfYearCostBasis) &&
        Objects.equals(this.startOfYearMarketValue, irealEstateAsset.startOfYearMarketValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentYearNetRentalIncome, description, id, marketValueAsOf, owner, preTaxGrowthRate, purchaseAmount, purchaseDate, standardDeviation, startOfYearCostBasis, startOfYearMarketValue);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IRealEstateAsset {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IRealEstateAsset
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IRealEstateAsset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IRealEstateAsset is not found in the empty JSON string", IRealEstateAsset.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IRealEstateAsset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IRealEstateAsset` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IRealEstateAsset.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IRealEstateAsset' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IRealEstateAsset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IRealEstateAsset.class));

       return (TypeAdapter<T>) new TypeAdapter<IRealEstateAsset>() {
           @Override
           public void write(JsonWriter out, IRealEstateAsset value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IRealEstateAsset read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IRealEstateAsset given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IRealEstateAsset
   * @throws IOException if the JSON string is invalid with respect to IRealEstateAsset
   */
  public static IRealEstateAsset fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IRealEstateAsset.class);
  }

  /**
   * Convert an instance of IRealEstateAsset to an JSON string
   *
   * @return JSON string
   */
