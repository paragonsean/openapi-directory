...
<a id="businessEntitiesGetByIdPlanid"></a>
...
import org.openapitools.client.api.BusinessEntitiesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    BusinessEntitiesApi apiInstance = new BusinessEntitiesApi(defaultClient);
    Integer id = 56; // Integer | ID of business entity to retrieve
    String planId = "planId_example"; // String | Id of the plan to retrieve data from (e.g. 1001-11-3).
    try {
      BusinessEntityModel result = apiInstance.businessEntitiesGetByIdPlanid(id, planId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BusinessEntitiesApi#businessEntitiesGetByIdPlanid");
...
|------------- | ------------- | ------------- | -------------|
| **id** | **Integer**| ID of business entity to retrieve | |
...
<a id="businessEntitiesGetByPlanid"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String planId = "planId_example"; // String | Id of the plan to retrieve data from (e.g. 1001-11-3).
    try {
      BusinessEntitiesModel result = apiInstance.businessEntitiesGetByPlanid(planId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BusinessEntitiesApi#businessEntitiesGetByPlanid");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
