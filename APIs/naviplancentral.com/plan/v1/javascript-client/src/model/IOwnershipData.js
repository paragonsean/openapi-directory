...
/**
 * The IOwnershipData model module.
 * @module model/IOwnershipData
 * @version v1
 */
class IOwnershipData {
    /**
     * Constructs a new <code>IOwnershipData</code>.
     * @alias module:model/IOwnershipData
     */
    constructor() { 
        
        IOwnershipData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IOwnershipData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IOwnershipData} obj Optional instance to populate.
     * @return {module:model/IOwnershipData} The populated <code>IOwnershipData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IOwnershipData();
    ...
    /**
     * Validates the JSON data with respect to <code>IOwnershipData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IOwnershipData</code>.
     */
 ...
 */
IOwnershipData.prototype['marketValue'] = undefined;

/**
 * @member {module:model/IOwnershipData.OwnerEnum} owner
 */
IOwnershipData.prototype['owner'] = undefined;

/**
 * @member {String} ownersName
 */
IOwnershipData.prototype['ownersName'] = undefined;

/**
 * @member {module:model/Percent} ownershipPercent
 */
IOwnershipData.prototype['ownershipPercent'] = undefined;

/**
 * @member {Number} shares
 */
IOwnershipData.prototype['shares'] = undefined;
