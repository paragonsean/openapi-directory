...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaviPlanApi.IFamily();
  });
  ...
  describe('IFamily', function() {
    it('should create an instance of IFamily', function() {
      // uncomment below and update the code to test IFamily
      //var instance = new NaviPlanApi.IFamily();
      //expect(instance).to.be.a(NaviPlanApi.IFamily);
    });
    ...
    it('should have the property headFullNames (base name: "headFullNames")', function() {
      // uncomment below and update the code to test the property headFullNames
      //var instance = new NaviPlanApi.IFamily();
      //expect(instance).to.be();
    });
