...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaviPlanApi.IFamilyMember();
  });
  ...
  describe('IFamilyMember', function() {
    it('should create an instance of IFamilyMember', function() {
      // uncomment below and update the code to test IFamilyMember
      //var instance = new NaviPlanApi.IFamilyMember();
      //expect(instance).to.be.a(NaviPlanApi.IFamilyMember);
    });
