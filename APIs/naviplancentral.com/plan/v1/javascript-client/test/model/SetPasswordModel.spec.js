...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaviPlanApi.SetPasswordModel();
  });
  ...
  describe('SetPasswordModel', function() {
    it('should create an instance of SetPasswordModel', function() {
      // uncomment below and update the code to test SetPasswordModel
      //var instance = new NaviPlanApi.SetPasswordModel();
      //expect(instance).to.be.a(NaviPlanApi.SetPasswordModel);
    });
