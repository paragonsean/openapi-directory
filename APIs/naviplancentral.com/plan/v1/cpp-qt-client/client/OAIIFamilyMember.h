...
#ifndef OAIIFamilyMember_H
#define OAIIFamilyMember_H
...
class OAIIFamilyMember : public OAIObject {
public:
    OAIIFamilyMember();
    OAIIFamilyMember(QString json);
    ~OAIIFamilyMember() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIFamilyMember)

#endif // OAIIFamilyMember_H
