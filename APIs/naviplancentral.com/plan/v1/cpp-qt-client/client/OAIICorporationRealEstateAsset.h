...
/*
 * OAIICorporationRealEstateAsset.h
 *
 * 
 */

#ifndef OAIICorporationRealEstateAsset_H
#define OAIICorporationRealEstateAsset_H
...
class OAIICorporationRealEstateAsset : public OAIObject {
public:
    OAIICorporationRealEstateAsset();
    OAIICorporationRealEstateAsset(QString json);
    ~OAIICorporationRealEstateAsset() override;
    ...
    OAIDescriptiveBoolean getIsActiveBusinessIncome() const;
    void setIsActiveBusinessIncome(const OAIDescriptiveBoolean &is_active_business_income);
    bool is_is_active_business_income_Set() const;
    bool is_is_active_business_income_Valid() const;
...
private:
    ...
    OAIDescriptiveBoolean m_is_active_business_income;
    bool m_is_active_business_income_isSet;
    bool m_is_active_business_income_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIICorporationRealEstateAsset)

#endif // OAIICorporationRealEstateAsset_H
