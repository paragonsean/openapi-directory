# Json2VideoApi.SceneElementsInner
...
**height** | **Number** | Desired text element height, but can be overriden by the component defaults. A value of &lt;code&gt;-1&lt;/code&gt; means inherits scenes or movie height | [optional] [default to -1]
...
**width** | **Number** | Desired text element width, but can be overriden by the component defaults. A value of &lt;code&gt;-1&lt;/code&gt; means inherits scenes or movie width | [optional] [default to -1]
**html** | **String** | HTML snippet to render. Compatible with HTML5, CSS3 and Javascript | 
**tailwindcss** | **Boolean** | Enables usage of TailwindCSS for the HTML snippet | [optional] [default to false]
