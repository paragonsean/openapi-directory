...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Json2VideoApi.VisualElementRotate();
  });
  ...
  describe('VisualElementRotate', function() {
    it('should create an instance of VisualElementRotate', function() {
      // uncomment below and update the code to test VisualElementRotate
      //var instance = new Json2VideoApi.VisualElementRotate();
      //expect(instance).to.be.a(Json2VideoApi.VisualElementRotate);
    });
