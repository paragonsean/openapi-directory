...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Json2VideoApi.AudioElement();
  });
  ...
  describe('AudioElement', function() {
    it('should create an instance of AudioElement', function() {
      // uncomment below and update the code to test AudioElement
      //var instance = new Json2VideoApi.AudioElement();
      //expect(instance).to.be.a(Json2VideoApi.AudioElement);
    });
