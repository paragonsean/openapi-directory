...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Json2VideoApi.VisualElement();
  });
  ...
  describe('VisualElement', function() {
    it('should create an instance of VisualElement', function() {
      // uncomment below and update the code to test VisualElement
      //var instance = new Json2VideoApi.VisualElement();
      //expect(instance).to.be.a(Json2VideoApi.VisualElement);
    });
