...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Json2VideoApi.VisualElementCrop();
  });
  ...
  describe('VisualElementCrop', function() {
    it('should create an instance of VisualElementCrop', function() {
      // uncomment below and update the code to test VisualElementCrop
      //var instance = new Json2VideoApi.VisualElementCrop();
      //expect(instance).to.be.a(Json2VideoApi.VisualElementCrop);
    });
