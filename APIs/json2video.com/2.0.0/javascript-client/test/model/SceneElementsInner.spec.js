...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Json2VideoApi.SceneElementsInner();
  });
  ...
  describe('SceneElementsInner', function() {
    it('should create an instance of SceneElementsInner', function() {
      // uncomment below and update the code to test SceneElementsInner
      //var instance = new Json2VideoApi.SceneElementsInner();
      //expect(instance).to.be.a(Json2VideoApi.SceneElementsInner);
    });
