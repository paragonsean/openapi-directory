...
/**
 * The SceneElementsInner model module.
 * @module model/SceneElementsInner
 * @version 2.0.0
 */
class SceneElementsInner {
    /**
     * Constructs a new <code>SceneElementsInner</code>.
     * @alias module:model/SceneElementsInner
     * @param {(module:model/Audio|module:model/Component|module:model/Html|module:model/Image|module:model/Text|module:model/Video|module:model/Voice)} instance The actual instance to initialize SceneElementsInner.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `SceneElementsInner` with oneOf schemas Audio, Component, Html, Image, Text, Video, Voice. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `SceneElementsInner` with oneOf schemas Audio, Component, Html, Image, Text, Video, Voice. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>SceneElementsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SceneElementsInner} obj Optional instance to populate.
     * @return {module:model/SceneElementsInner} The populated <code>SceneElementsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        return new SceneElementsInner(data);
    }

    /**
     * Gets the actual instance, which can be <code>Audio</code>, <code>Component</code>, <code>Html</code>, <code>Image</code>, <code>Text</code>, <code>Video</code>, <code>Voice</code>.
     * @return {(module:model/Audio|module:model/Component|module:model/Html|module:model/Image|module:model/Text|module:model/Video|module:model/Voice)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>Audio</code>, <code>Component</code>, <code>Html</code>, <code>Image</code>, <code>Text</code>, <code>Video</code>, <code>Voice</code>.
     * @param {(module:model/Audio|module:model/Component|module:model/Html|module:model/Image|module:model/Text|module:model/Video|module:model/Voice)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = SceneElementsInner.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/SceneElementsInner} An instance of SceneElementsInner.
     */
    static fromJSON = function(json_string){
        return SceneElementsInner.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 * @member {String} src
 */
SceneElementsInner.prototype['src'] = undefined;

/**
 * @member {module:model/SceneElementsInner.TypeEnum} type
 */
SceneElementsInner.prototype['type'] = undefined;
 ...
 * @default true
 */
SceneElementsInner.prototype['cache'] = true;

/**
 * Used for adding your comments
 * @member {String} comment
 */
SceneElementsInner.prototype['comment'] = undefined;
 ...
 * @default -1
 */
SceneElementsInner.prototype['duration'] = -1;
 ...
 * @default 0
 */
SceneElementsInner.prototype['start'] = 0;
 ...
 * @default 0
 */
SceneElementsInner.prototype['x'] = 0;
 ...
 * @default 0
 */
SceneElementsInner.prototype['y'] = 0;
 ...
 * @default false
 */
SceneElementsInner.prototype['muted'] = false;

/**
 * @member {Number} volume
 * @default 5
 */
SceneElementsInner.prototype['volume'] = 5;
 ...
 * @default -1
 */
SceneElementsInner.prototype['height'] = -1;

/**
 * Settings to be passed to the component
 * @member {Object} settings
 */
SceneElementsInner.prototype['settings'] = undefined;
 ...
 * @default '001'
 */
SceneElementsInner.prototype['style'] = '001';

/**
 * The sentence or sentences to be converted to voice audio
 * @member {String} text
 */
SceneElementsInner.prototype['text'] = undefined;
 ...
 * @default -1
 */
SceneElementsInner.prototype['width'] = -1;

/**
 * HTML snippet to render. Compatible with HTML5, CSS3 and Javascript
 * @member {String} html
 */
SceneElementsInner.prototype['html'] = undefined;
 ...
 * @default false
 */
SceneElementsInner.prototype['tailwindcss'] = false;
 ...
 */
SceneElementsInner.prototype['component'] = undefined;
 ...
 */
SceneElementsInner.prototype['voice'] = 'en-GB-LibbyNeural';


SceneElementsInner.OneOf = ["Audio", "Component", "Html", "Image", "Text", "Video", "Voice"];

export default SceneElementsInner;
