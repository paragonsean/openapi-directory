...
/**
 * The VisualElement model module.
 * @module model/VisualElement
 * @version 2.0.0
 */
class VisualElement {
    /**
     * Constructs a new <code>VisualElement</code>.
     * @alias module:model/VisualElement
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VisualElement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VisualElement} obj Optional instance to populate.
     * @return {module:model/VisualElement} The populated <code>VisualElement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VisualElement();
    ...
    /**
     * Validates the JSON data with respect to <code>VisualElement</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VisualElement</code>.
     */
