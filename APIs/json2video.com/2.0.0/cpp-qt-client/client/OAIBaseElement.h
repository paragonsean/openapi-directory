...
#ifndef OAIBaseElement_H
#define OAIBaseElement_H
...
class OAIBaseElement : public OAIObject {
public:
    OAIBaseElement();
    OAIBaseElement(QString json);
    ~OAIBaseElement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseElement)

#endif // OAIBaseElement_H
