...
/*
 * OAIScene_elements_inner.h
 *
 * 
 */

#ifndef OAIScene_elements_inner_H
#define OAIScene_elements_inner_H
...
class OAIScene_elements_inner : public OAIObject {
public:
    OAIScene_elements_inner();
    OAIScene_elements_inner(QString json);
    ~OAIScene_elements_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScene_elements_inner)

#endif // OAIScene_elements_inner_H
