...
bool OAIComponent::isCache() const {
    return m_cache;
}
void OAIComponent::setCache(const bool &cache) {
    m_cache = cache;
    m_cache_isSet = true;
}

bool OAIComponent::is_cache_Set() const{
    return m_cache_isSet;
}

bool OAIComponent::is_cache_Valid() const{
...
float OAIComponent::getDuration() const {
    return m_duration;
}
void OAIComponent::setDuration(const float &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIComponent::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIComponent::is_duration_Valid() const{
    return m_duration_isValid;
}

float OAIComponent::getExtraTime() const {
    return m_extra_time;
}
void OAIComponent::setExtraTime(const float &extra_time) {
    m_extra_time = extra_time;
    m_extra_time_isSet = true;
}

bool OAIComponent::is_extra_time_Set() const{
    return m_extra_time_isSet;
}

bool OAIComponent::is_extra_time_Valid() const{
    return m_extra_time_isValid;
}

float OAIComponent::getFadeIn() const {
    return m_fade_in;
}
void OAIComponent::setFadeIn(const float &fade_in) {
    m_fade_in = fade_in;
    m_fade_in_isSet = true;
}

bool OAIComponent::is_fade_in_Set() const{
    return m_fade_in_isSet;
}

bool OAIComponent::is_fade_in_Valid() const{
    return m_fade_in_isValid;
}

float OAIComponent::getFadeOut() const {
    return m_fade_out;
}
void OAIComponent::setFadeOut(const float &fade_out) {
    m_fade_out = fade_out;
    m_fade_out_isSet = true;
}

bool OAIComponent::is_fade_out_Set() const{
    return m_fade_out_isSet;
}

bool OAIComponent::is_fade_out_Valid() const{
    return m_fade_out_isValid;
}

float OAIComponent::getStart() const {
    return m_start;
}
void OAIComponent::setStart(const float &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAIComponent::is_start_Set() const{
    return m_start_isSet;
}

bool OAIComponent::is_start_Valid() const{
    return m_start_isValid;
}

double OAIComponent::getZIndex() const {
    return m_z_index;
}
void OAIComponent::setZIndex(const double &z_index) {
    m_z_index = z_index;
    m_z_index_isSet = true;
}

bool OAIComponent::is_z_index_Set() const{
    return m_z_index_isSet;
}

bool OAIComponent::is_z_index_Valid() const{
    return m_z_index_isValid;
}

OAIVisualElement_chroma_key OAIComponent::getChromaKey() const {
    return m_chroma_key;
}
void OAIComponent::setChromaKey(const OAIVisualElement_chroma_key &chroma_key) {
    m_chroma_key = chroma_key;
    m_chroma_key_isSet = true;
}

bool OAIComponent::is_chroma_key_Set() const{
    return m_chroma_key_isSet;
}

bool OAIComponent::is_chroma_key_Valid() const{
    return m_chroma_key_isValid;
}

OAIVisualElement_crop OAIComponent::getCrop() const {
    return m_crop;
}
void OAIComponent::setCrop(const OAIVisualElement_crop &crop) {
    m_crop = crop;
    m_crop_isSet = true;
}

bool OAIComponent::is_crop_Set() const{
    return m_crop_isSet;
}

bool OAIComponent::is_crop_Valid() const{
    return m_crop_isValid;
}

QString OAIComponent::getPan() const {
    return m_pan;
}
void OAIComponent::setPan(const QString &pan) {
    m_pan = pan;
    m_pan_isSet = true;
}

bool OAIComponent::is_pan_Set() const{
    return m_pan_isSet;
}

bool OAIComponent::is_pan_Valid() const{
    return m_pan_isValid;
}

QString OAIComponent::getPosition() const {
    return m_position;
}
void OAIComponent::setPosition(const QString &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIComponent::is_position_Set() const{
    return m_position_isSet;
}

bool OAIComponent::is_position_Valid() const{
    return m_position_isValid;
}

OAIVisualElement_rotate OAIComponent::getRotate() const {
    return m_rotate;
}
void OAIComponent::setRotate(const OAIVisualElement_rotate &rotate) {
    m_rotate = rotate;
    m_rotate_isSet = true;
}

bool OAIComponent::is_rotate_Set() const{
    return m_rotate_isSet;
}

bool OAIComponent::is_rotate_Valid() const{
    return m_rotate_isValid;
}

OAIVisualElement_scale OAIComponent::getScale() const {
    return m_scale;
}
void OAIComponent::setScale(const OAIVisualElement_scale &scale) {
    m_scale = scale;
    m_scale_isSet = true;
}

bool OAIComponent::is_scale_Set() const{
    return m_scale_isSet;
}

bool OAIComponent::is_scale_Valid() const{
    return m_scale_isValid;
}

double OAIComponent::getX() const {
    return m_x;
}
void OAIComponent::setX(const double &x) {
    m_x = x;
    m_x_isSet = true;
}

bool OAIComponent::is_x_Set() const{
    return m_x_isSet;
}

bool OAIComponent::is_x_Valid() const{
    return m_x_isValid;
}

double OAIComponent::getY() const {
    return m_y;
}
void OAIComponent::setY(const double &y) {
    m_y = y;
    m_y_isSet = true;
}

bool OAIComponent::is_y_Set() const{
    return m_y_isSet;
}

bool OAIComponent::is_y_Valid() const{
    return m_y_isValid;
}

qint32 OAIComponent::getZoom() const {
    return m_zoom;
}
void OAIComponent::setZoom(const qint32 &zoom) {
    m_zoom = zoom;
    m_zoom_isSet = true;
}

bool OAIComponent::is_zoom_Set() const{
    return m_zoom_isSet;
}

bool OAIComponent::is_zoom_Valid() const{
    return m_zoom_isValid;
}

QString OAIComponent::getComponent() const {
    return m_component;
}
void OAIComponent::setComponent(const QString &component) {
    m_component = component;
    m_component_isSet = true;
}

bool OAIComponent::is_component_Set() const{
    return m_component_isSet;
}

bool OAIComponent::is_component_Valid() const{
    return m_component_isValid;
}

qint32 OAIComponent::getHeight() const {
    return m_height;
}
void OAIComponent::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}
...
OAIObject OAIComponent::getSettings() const {
    return m_settings;
}
void OAIComponent::setSettings(const OAIObject &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIComponent::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIComponent::is_settings_Valid() const{
...
qint32 OAIComponent::getWidth() const {
    return m_width;
}
void OAIComponent::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}
...
bool OAIComponent::isValid() const {
    ...
    return m_component_isValid && m_type_isValid && true;
}
