...
#ifndef OAIVisualElement_H
#define OAIVisualElement_H
...
class OAIVisualElement : public OAIObject {
public:
    OAIVisualElement();
    OAIVisualElement(QString json);
    ~OAIVisualElement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVisualElement)

#endif // OAIVisualElement_H
