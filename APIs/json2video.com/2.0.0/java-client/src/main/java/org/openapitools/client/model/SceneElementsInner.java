...
public class SceneElementsInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SceneElementsInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SceneElementsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SceneElementsInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SceneElementsInner>() {
                @Override
                public void write(JsonWriter out, SceneElementsInner value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: Audio, Component, Html, Image, Text, Video, Voice");
                }

                @Override
                public SceneElementsInner read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        SceneElementsInner ret = new SceneElementsInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for SceneElementsInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SceneElementsInner(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return SceneElementsInner.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * Audio, Component, Html, Image, Text, Video, Voice
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Audio, Component, Html, Image, Text, Video, Voice");
    }
     ...
     * Audio, Component, Html, Image, Text, Video, Voice
     *
     * @return The actual instance (Audio, Component, Html, Image, Text, Video, Voice)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to SceneElementsInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for SceneElementsInner with oneOf schemas: Audio, Component, Html, Image, Text, Video, Voice. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of SceneElementsInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SceneElementsInner
     * @throws IOException if the JSON string is invalid with respect to SceneElementsInner
     */
    public static SceneElementsInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SceneElementsInner.class);
    }

    /**
     * Convert an instance of SceneElementsInner to an JSON string
     *
     * @return JSON string
     */
