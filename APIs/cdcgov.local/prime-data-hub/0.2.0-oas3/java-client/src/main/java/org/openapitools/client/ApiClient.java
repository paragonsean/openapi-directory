...
public class ApiClient {
    ...
    private String basePath = "http://cdcgov.local";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "x-functions-key"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://hhs-prime.okta.com/oauth/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.2.0-oas3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://cdcgov.local
