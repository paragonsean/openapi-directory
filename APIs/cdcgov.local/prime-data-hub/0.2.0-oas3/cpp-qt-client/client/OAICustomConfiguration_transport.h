...
/*
 * OAICustomConfiguration_transport.h
 *
 * The transport to use
 */

#ifndef OAICustomConfiguration_transport_H
#define OAICustomConfiguration_transport_H
...
class OAICustomConfiguration_transport : public OAIObject {
public:
    OAICustomConfiguration_transport();
    OAICustomConfiguration_transport(QString json);
    ~OAICustomConfiguration_transport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomConfiguration_transport)

#endif // OAICustomConfiguration_transport_H
