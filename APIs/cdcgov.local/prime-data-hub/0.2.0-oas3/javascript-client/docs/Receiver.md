...
**jurisdictionalFilters** | [**[ReceiverJurisdictionalFiltersInner]**](ReceiverJurisdictionalFiltersInner.md) | What items to include in the report. | [optional] 
...
**translations** | [**[ReceiverTranslationsInner]**](ReceiverTranslationsInner.md) | How the report is translated from the sender. A report can be sent in multiple ways. | [optional] 
