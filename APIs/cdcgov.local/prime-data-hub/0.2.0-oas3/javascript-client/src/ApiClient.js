...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://cdcgov.local') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://cdcgov.local
         */
        ...
        this.authentications = {
            'ApiKeyAuth': {type: 'apiKey', 'in': 'header', name: 'x-functions-key'},
            'OAuth2': {type: 'oauth2'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/0.2.0-oas3/Javascript'
        };
