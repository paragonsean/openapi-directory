...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrimeReportStream.StandardHL7Configuration();
  });
  ...
  describe('StandardHL7Configuration', function() {
    it('should create an instance of StandardHL7Configuration', function() {
      // uncomment below and update the code to test StandardHL7Configuration
      //var instance = new PrimeReportStream.StandardHL7Configuration();
      //expect(instance).to.be.a(PrimeReportStream.StandardHL7Configuration);
    });
