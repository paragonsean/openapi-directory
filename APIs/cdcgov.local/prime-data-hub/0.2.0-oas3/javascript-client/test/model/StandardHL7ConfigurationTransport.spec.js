...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PrimeReportStream.StandardHL7ConfigurationTransport();
  });
  ...
  describe('StandardHL7ConfigurationTransport', function() {
    it('should create an instance of StandardHL7ConfigurationTransport', function() {
      // uncomment below and update the code to test StandardHL7ConfigurationTransport
      //var instance = new PrimeReportStream.StandardHL7ConfigurationTransport();
      //expect(instance).to.be.a(PrimeReportStream.StandardHL7ConfigurationTransport);
    });
