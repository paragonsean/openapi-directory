# StreamChatApi.ReactionRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**messageId** | **String** | ID of a message user reacted to | [optional] 
**score** | **Number** | Reaction score. If not specified reaction has score of 1 | [optional] 
