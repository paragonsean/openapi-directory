...
let apiInstance = new StreamChatApi.TestingApi();
let checkPushRequest = new StreamChatApi.CheckPushRequest(); // CheckPushRequest | 
apiInstance.checkPush_0(checkPushRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new StreamChatApi.TestingApi();
let checkSQSRequest = new StreamChatApi.CheckSQSRequest(); // CheckSQSRequest | 
apiInstance.checkSQS_0(checkSQSRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
