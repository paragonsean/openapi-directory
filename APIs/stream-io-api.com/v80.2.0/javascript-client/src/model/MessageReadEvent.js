...
/**
 * The MessageReadEvent model module.
 * @module model/MessageReadEvent
 * @version v80.2.0
 */
class MessageReadEvent {
    /**
     * Constructs a new <code>MessageReadEvent</code>.
     * @alias module:model/MessageReadEvent
    ...
    constructor(channelId, channelType, cid, createdAt, type) { 
        ...
        MessageReadEvent.initialize(this, channelId, channelType, cid, createdAt, type);
    }
    ...
    static initialize(obj, channelId, channelType, cid, createdAt, type) { 
        ...
        obj['type'] = type || 'message.read';
    }

    /**
     * Constructs a <code>MessageReadEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageReadEvent} obj Optional instance to populate.
     * @return {module:model/MessageReadEvent} The populated <code>MessageReadEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageReadEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageReadEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageReadEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MessageReadEvent.RequiredProperties) {
...
MessageReadEvent.RequiredProperties = ["channel_id", "channel_type", "cid", "created_at", "type"];

/**
 * @member {String} channel_id
 */
MessageReadEvent.prototype['channel_id'] = undefined;

/**
 * @member {String} channel_type
 */
MessageReadEvent.prototype['channel_type'] = undefined;

/**
 * @member {String} cid
 */
MessageReadEvent.prototype['cid'] = undefined;

/**
 * @member {Date} created_at
 */
MessageReadEvent.prototype['created_at'] = undefined;

/**
 * @member {String} last_read_message_id
 */
MessageReadEvent.prototype['last_read_message_id'] = undefined;

/**
 * @member {String} team
 */
MessageReadEvent.prototype['team'] = undefined;

/**
 * @member {String} type
 * @default 'message.read'
 */
MessageReadEvent.prototype['type'] = 'message.read';

/**
 * @member {module:model/UserObject} user
 */
MessageReadEvent.prototype['user'] = undefined;
...
export default MessageReadEvent;
