...
class FileDeleteResponse {
    ...
    constructor(duration) { 
        ...
        FileDeleteResponse.initialize(this, duration);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of FileDeleteResponse.RequiredProperties) {
...
FileDeleteResponse.RequiredProperties = ["duration"];

/**
 * Duration of the request in human-readable format
 * @member {String} duration
 */
FileDeleteResponse.prototype['duration'] = undefined;
