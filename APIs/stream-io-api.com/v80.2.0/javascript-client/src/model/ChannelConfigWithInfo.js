...
/**
 * The ChannelConfigWithInfo model module.
 * @module model/ChannelConfigWithInfo
 * @version v80.2.0
 */
class ChannelConfigWithInfo {
    /**
     * Constructs a new <code>ChannelConfigWithInfo</code>.
     * @alias module:model/ChannelConfigWithInfo
     * @param automod {module:model/ChannelConfigWithInfo.AutomodEnum} 
     * @param automodBehavior {module:model/ChannelConfigWithInfo.AutomodBehaviorEnum} 
    ...
    constructor(automod, automodBehavior, commands, connectEvents, createdAt, customEvents, maxMessageLength, messageRetention, mutes, name, pushNotifications, quotes, reactions, readEvents, reminders, replies, search, typingEvents, updatedAt, uploads, urlEnrichment) { 
        ...
        ChannelConfigWithInfo.initialize(this, automod, automodBehavior, commands, connectEvents, createdAt, customEvents, maxMessageLength, messageRetention, mutes, name, pushNotifications, quotes, reactions, readEvents, reminders, replies, search, typingEvents, updatedAt, uploads, urlEnrichment);
    }
    ...
    /**
     * Constructs a <code>ChannelConfigWithInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelConfigWithInfo} obj Optional instance to populate.
     * @return {module:model/ChannelConfigWithInfo} The populated <code>ChannelConfigWithInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelConfigWithInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelConfigWithInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelConfigWithInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelConfigWithInfo.RequiredProperties) {
...
ChannelConfigWithInfo.RequiredProperties = ["automod", "automod_behavior", "commands", "connect_events", "created_at", "custom_events", "max_message_length", "message_retention", "mutes", "name", "push_notifications", "quotes", "reactions", "read_events", "reminders", "replies", "search", "typing_events", "updated_at", "uploads", "url_enrichment"];

/**
 * @member {module:model/ChannelConfigWithInfo.AutomodEnum} automod
 */
ChannelConfigWithInfo.prototype['automod'] = undefined;

/**
 * @member {module:model/ChannelConfigWithInfo.AutomodBehaviorEnum} automod_behavior
 */
ChannelConfigWithInfo.prototype['automod_behavior'] = undefined;

/**
 * @member {module:model/Thresholds} automod_thresholds
 */
ChannelConfigWithInfo.prototype['automod_thresholds'] = undefined;

/**
 * @member {String} blocklist
 */
ChannelConfigWithInfo.prototype['blocklist'] = undefined;

/**
 * @member {module:model/ChannelConfigWithInfo.BlocklistBehaviorEnum} blocklist_behavior
 */
ChannelConfigWithInfo.prototype['blocklist_behavior'] = undefined;

/**
 * @member {Array.<module:model/Command>} commands
 */
ChannelConfigWithInfo.prototype['commands'] = undefined;

/**
 * @member {Boolean} connect_events
 */
ChannelConfigWithInfo.prototype['connect_events'] = undefined;

/**
 * @member {Date} created_at
 */
ChannelConfigWithInfo.prototype['created_at'] = undefined;

/**
 * @member {Boolean} custom_events
 */
ChannelConfigWithInfo.prototype['custom_events'] = undefined;

/**
 * @member {Object.<String, Array.<String>>} grants
 */
ChannelConfigWithInfo.prototype['grants'] = undefined;

/**
 * @member {Number} max_message_length
 */
ChannelConfigWithInfo.prototype['max_message_length'] = undefined;

/**
 * @member {String} message_retention
 */
ChannelConfigWithInfo.prototype['message_retention'] = undefined;

/**
 * @member {Boolean} mutes
 */
ChannelConfigWithInfo.prototype['mutes'] = undefined;

/**
 * @member {String} name
 */
ChannelConfigWithInfo.prototype['name'] = undefined;

/**
 * @member {Boolean} push_notifications
 */
ChannelConfigWithInfo.prototype['push_notifications'] = undefined;

/**
 * @member {Boolean} quotes
 */
ChannelConfigWithInfo.prototype['quotes'] = undefined;

/**
 * @member {Boolean} reactions
 */
ChannelConfigWithInfo.prototype['reactions'] = undefined;

/**
 * @member {Boolean} read_events
 */
ChannelConfigWithInfo.prototype['read_events'] = undefined;

/**
 * @member {Boolean} reminders
 */
ChannelConfigWithInfo.prototype['reminders'] = undefined;

/**
 * @member {Boolean} replies
 */
ChannelConfigWithInfo.prototype['replies'] = undefined;

/**
 * @member {Boolean} search
 */
ChannelConfigWithInfo.prototype['search'] = undefined;

/**
 * @member {Boolean} typing_events
 */
ChannelConfigWithInfo.prototype['typing_events'] = undefined;

/**
 * @member {Date} updated_at
 */
ChannelConfigWithInfo.prototype['updated_at'] = undefined;

/**
 * @member {Boolean} uploads
 */
ChannelConfigWithInfo.prototype['uploads'] = undefined;

/**
 * @member {Boolean} url_enrichment
 */
ChannelConfigWithInfo.prototype['url_enrichment'] = undefined;
 ...
 * @readonly
 */
ChannelConfigWithInfo['AutomodEnum'] = {
 ...
 * @readonly
 */
ChannelConfigWithInfo['AutomodBehaviorEnum'] = {
 ...
 * @readonly
 */
ChannelConfigWithInfo['BlocklistBehaviorEnum'] = {
...
export default ChannelConfigWithInfo;
