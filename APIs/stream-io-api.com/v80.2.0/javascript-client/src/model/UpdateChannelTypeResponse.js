...
/**
 * The UpdateChannelTypeResponse model module.
 * @module model/UpdateChannelTypeResponse
 * @version v80.2.0
 */
class UpdateChannelTypeResponse {
    /**
     * Constructs a new <code>UpdateChannelTypeResponse</code>.
     * @alias module:model/UpdateChannelTypeResponse
     * @param automod {module:model/UpdateChannelTypeResponse.AutomodEnum} 
     * @param automodBehavior {module:model/UpdateChannelTypeResponse.AutomodBehaviorEnum} 
    ...
    constructor(automod, automodBehavior, commands, connectEvents, createdAt, customEvents, duration, grants, maxMessageLength, messageRetention, mutes, name, permissions, pushNotifications, quotes, reactions, readEvents, reminders, replies, search, typingEvents, updatedAt, uploads, urlEnrichment) { 
        ...
        UpdateChannelTypeResponse.initialize(this, automod, automodBehavior, commands, connectEvents, createdAt, customEvents, duration, grants, maxMessageLength, messageRetention, mutes, name, permissions, pushNotifications, quotes, reactions, readEvents, reminders, replies, search, typingEvents, updatedAt, uploads, urlEnrichment);
    }
    ...
    /**
     * Constructs a <code>UpdateChannelTypeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateChannelTypeResponse} obj Optional instance to populate.
     * @return {module:model/UpdateChannelTypeResponse} The populated <code>UpdateChannelTypeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateChannelTypeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateChannelTypeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateChannelTypeResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateChannelTypeResponse.RequiredProperties) {
...
UpdateChannelTypeResponse.RequiredProperties = ["automod", "automod_behavior", "commands", "connect_events", "created_at", "custom_events", "duration", "grants", "max_message_length", "message_retention", "mutes", "name", "permissions", "push_notifications", "quotes", "reactions", "read_events", "reminders", "replies", "search", "typing_events", "updated_at", "uploads", "url_enrichment"];

/**
 * @member {module:model/UpdateChannelTypeResponse.AutomodEnum} automod
 */
UpdateChannelTypeResponse.prototype['automod'] = undefined;

/**
 * @member {module:model/UpdateChannelTypeResponse.AutomodBehaviorEnum} automod_behavior
 */
UpdateChannelTypeResponse.prototype['automod_behavior'] = undefined;

/**
 * @member {module:model/Thresholds} automod_thresholds
 */
UpdateChannelTypeResponse.prototype['automod_thresholds'] = undefined;

/**
 * @member {String} blocklist
 */
UpdateChannelTypeResponse.prototype['blocklist'] = undefined;

/**
 * @member {module:model/UpdateChannelTypeResponse.BlocklistBehaviorEnum} blocklist_behavior
 */
UpdateChannelTypeResponse.prototype['blocklist_behavior'] = undefined;

/**
 * @member {Array.<String>} commands
 */
UpdateChannelTypeResponse.prototype['commands'] = undefined;

/**
 * @member {Boolean} connect_events
 */
UpdateChannelTypeResponse.prototype['connect_events'] = undefined;

/**
 * @member {Date} created_at
 */
UpdateChannelTypeResponse.prototype['created_at'] = undefined;

/**
 * @member {Boolean} custom_events
 */
UpdateChannelTypeResponse.prototype['custom_events'] = undefined;

/**
 * @member {String} duration
 */
UpdateChannelTypeResponse.prototype['duration'] = undefined;

/**
 * @member {Object.<String, Array.<String>>} grants
 */
UpdateChannelTypeResponse.prototype['grants'] = undefined;

/**
 * @member {Number} max_message_length
 */
UpdateChannelTypeResponse.prototype['max_message_length'] = undefined;

/**
 * @member {String} message_retention
 */
UpdateChannelTypeResponse.prototype['message_retention'] = undefined;

/**
 * @member {Boolean} mutes
 */
UpdateChannelTypeResponse.prototype['mutes'] = undefined;

/**
 * @member {String} name
 */
UpdateChannelTypeResponse.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/PolicyRequest1>} permissions
 */
UpdateChannelTypeResponse.prototype['permissions'] = undefined;

/**
 * @member {Boolean} push_notifications
 */
UpdateChannelTypeResponse.prototype['push_notifications'] = undefined;

/**
 * @member {Boolean} quotes
 */
UpdateChannelTypeResponse.prototype['quotes'] = undefined;

/**
 * @member {Boolean} reactions
 */
UpdateChannelTypeResponse.prototype['reactions'] = undefined;

/**
 * @member {Boolean} read_events
 */
UpdateChannelTypeResponse.prototype['read_events'] = undefined;

/**
 * @member {Boolean} reminders
 */
UpdateChannelTypeResponse.prototype['reminders'] = undefined;

/**
 * @member {Boolean} replies
 */
UpdateChannelTypeResponse.prototype['replies'] = undefined;

/**
 * @member {Boolean} search
 */
UpdateChannelTypeResponse.prototype['search'] = undefined;

/**
 * @member {Boolean} typing_events
 */
UpdateChannelTypeResponse.prototype['typing_events'] = undefined;

/**
 * @member {Date} updated_at
 */
UpdateChannelTypeResponse.prototype['updated_at'] = undefined;

/**
 * @member {Boolean} uploads
 */
UpdateChannelTypeResponse.prototype['uploads'] = undefined;

/**
 * @member {Boolean} url_enrichment
 */
UpdateChannelTypeResponse.prototype['url_enrichment'] = undefined;
 ...
 * @readonly
 */
UpdateChannelTypeResponse['AutomodEnum'] = {
 ...
 * @readonly
 */
UpdateChannelTypeResponse['AutomodBehaviorEnum'] = {
 ...
 * @readonly
 */
UpdateChannelTypeResponse['BlocklistBehaviorEnum'] = {
...
export default UpdateChannelTypeResponse;
