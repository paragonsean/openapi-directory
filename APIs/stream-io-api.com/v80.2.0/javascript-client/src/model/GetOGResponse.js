...
/**
 * The GetOGResponse model module.
 * @module model/GetOGResponse
 * @version v80.2.0
 */
class GetOGResponse {
    /**
     * Constructs a new <code>GetOGResponse</code>.
     * @alias module:model/GetOGResponse
     * @extends Object
     * @param duration {String} 
     */
    constructor(duration) { 
        
        GetOGResponse.initialize(this, duration);
    }
    ...
    /**
     * Constructs a <code>GetOGResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOGResponse} obj Optional instance to populate.
     * @return {module:model/GetOGResponse} The populated <code>GetOGResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOGResponse();
            ...
            if (data.hasOwnProperty('giphy')) {
                obj['giphy'] = Images.constructFromObject(data['giphy']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOGResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOGResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetOGResponse.RequiredProperties) {
        ...
        if (data['giphy']) { // data not null
          Images.validateJSON(data['giphy']);
        }
        // ensure the json data is a string
...
GetOGResponse.RequiredProperties = ["duration"];

/**
 * @member {Array.<module:model/Action>} actions
 */
GetOGResponse.prototype['actions'] = undefined;

/**
 * URL of detected video or audio
 * @member {String} asset_url
 */
GetOGResponse.prototype['asset_url'] = undefined;

/**
 * @member {String} author_icon
 */
GetOGResponse.prototype['author_icon'] = undefined;

/**
 * og:site
 * @member {String} author_link
 */
GetOGResponse.prototype['author_link'] = undefined;

/**
 * og:site_name
 * @member {String} author_name
 */
GetOGResponse.prototype['author_name'] = undefined;

/**
 * @member {String} color
 */
GetOGResponse.prototype['color'] = undefined;

/**
 * @member {String} duration
 */
GetOGResponse.prototype['duration'] = undefined;

/**
 * @member {String} fallback
 */
GetOGResponse.prototype['fallback'] = undefined;

/**
 * @member {Array.<module:model/Field>} fields
 */
GetOGResponse.prototype['fields'] = undefined;

/**
 * @member {String} footer
 */
GetOGResponse.prototype['footer'] = undefined;

/**
 * @member {String} footer_icon
 */
GetOGResponse.prototype['footer_icon'] = undefined;

/**
 * @member {module:model/Images} giphy
 */
GetOGResponse.prototype['giphy'] = undefined;

/**
 * URL of detected image
 * @member {String} image_url
 */
GetOGResponse.prototype['image_url'] = undefined;

/**
 * extracted url from the text
 * @member {String} og_scrape_url
 */
GetOGResponse.prototype['og_scrape_url'] = undefined;

/**
 * @member {Number} original_height
 */
GetOGResponse.prototype['original_height'] = undefined;

/**
 * @member {Number} original_width
 */
GetOGResponse.prototype['original_width'] = undefined;

/**
 * @member {String} pretext
 */
GetOGResponse.prototype['pretext'] = undefined;

/**
 * og:description
 * @member {String} text
 */
GetOGResponse.prototype['text'] = undefined;

/**
 * URL of detected thumb image
 * @member {String} thumb_url
 */
GetOGResponse.prototype['thumb_url'] = undefined;

/**
 * og:title
 * @member {String} title
 */
GetOGResponse.prototype['title'] = undefined;

/**
 * og:url
 * @member {String} title_link
 */
GetOGResponse.prototype['title_link'] = undefined;

/**
 * Attachment type, could be empty, image, audio or video
 * @member {String} type
 */
GetOGResponse.prototype['type'] = undefined;
