...
/**
 * The ChannelConfigWithInfoRequest model module.
 * @module model/ChannelConfigWithInfoRequest
 * @version v80.2.0
 */
class ChannelConfigWithInfoRequest {
    /**
     * Constructs a new <code>ChannelConfigWithInfoRequest</code>.
     * @alias module:model/ChannelConfigWithInfoRequest
     * @param automod {module:model/ChannelConfigWithInfoRequest.AutomodEnum} 
     */
    constructor(automod) { 
        
        ChannelConfigWithInfoRequest.initialize(this, automod);
    }
    ...
    /**
     * Constructs a <code>ChannelConfigWithInfoRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelConfigWithInfoRequest} obj Optional instance to populate.
     * @return {module:model/ChannelConfigWithInfoRequest} The populated <code>ChannelConfigWithInfoRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelConfigWithInfoRequest();
            ...
            if (data.hasOwnProperty('commands')) {
                obj['commands'] = ApiClient.convertToType(data['commands'], [CommandRequest]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelConfigWithInfoRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelConfigWithInfoRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelConfigWithInfoRequest.RequiredProperties) {
        ...
        if (data['commands']) { // data not null
            ...
            for (const item of data['commands']) {
                CommandRequest.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
ChannelConfigWithInfoRequest.RequiredProperties = ["automod"];

/**
 * @member {module:model/ChannelConfigWithInfoRequest.AutomodEnum} automod
 */
ChannelConfigWithInfoRequest.prototype['automod'] = undefined;

/**
 * @member {module:model/ChannelConfigWithInfoRequest.AutomodBehaviorEnum} automod_behavior
 */
ChannelConfigWithInfoRequest.prototype['automod_behavior'] = undefined;

/**
 * @member {module:model/ThresholdsRequest} automod_thresholds
 */
ChannelConfigWithInfoRequest.prototype['automod_thresholds'] = undefined;

/**
 * @member {String} blocklist
 */
ChannelConfigWithInfoRequest.prototype['blocklist'] = undefined;

/**
 * @member {module:model/ChannelConfigWithInfoRequest.BlocklistBehaviorEnum} blocklist_behavior
 */
ChannelConfigWithInfoRequest.prototype['blocklist_behavior'] = undefined;

/**
 * @member {Array.<module:model/CommandRequest>} commands
 */
ChannelConfigWithInfoRequest.prototype['commands'] = undefined;

/**
 * @member {Boolean} connect_events
 */
ChannelConfigWithInfoRequest.prototype['connect_events'] = undefined;

/**
 * @member {Date} created_at
 */
ChannelConfigWithInfoRequest.prototype['created_at'] = undefined;

/**
 * @member {Boolean} custom_events
 */
ChannelConfigWithInfoRequest.prototype['custom_events'] = undefined;

/**
 * @member {Object.<String, Array.<String>>} grants
 */
ChannelConfigWithInfoRequest.prototype['grants'] = undefined;

/**
 * @member {Number} max_message_length
 */
ChannelConfigWithInfoRequest.prototype['max_message_length'] = undefined;

/**
 * @member {String} message_retention
 */
ChannelConfigWithInfoRequest.prototype['message_retention'] = undefined;

/**
 * @member {Boolean} mutes
 */
ChannelConfigWithInfoRequest.prototype['mutes'] = undefined;

/**
 * @member {String} name
 */
ChannelConfigWithInfoRequest.prototype['name'] = undefined;

/**
 * @member {Boolean} push_notifications
 */
ChannelConfigWithInfoRequest.prototype['push_notifications'] = undefined;

/**
 * @member {Boolean} quotes
 */
ChannelConfigWithInfoRequest.prototype['quotes'] = undefined;

/**
 * @member {Boolean} reactions
 */
ChannelConfigWithInfoRequest.prototype['reactions'] = undefined;

/**
 * @member {Boolean} read_events
 */
ChannelConfigWithInfoRequest.prototype['read_events'] = undefined;

/**
 * @member {Boolean} reminders
 */
ChannelConfigWithInfoRequest.prototype['reminders'] = undefined;

/**
 * @member {Boolean} replies
 */
ChannelConfigWithInfoRequest.prototype['replies'] = undefined;

/**
 * @member {Boolean} search
 */
ChannelConfigWithInfoRequest.prototype['search'] = undefined;

/**
 * @member {Boolean} typing_events
 */
ChannelConfigWithInfoRequest.prototype['typing_events'] = undefined;

/**
 * @member {Date} updated_at
 */
ChannelConfigWithInfoRequest.prototype['updated_at'] = undefined;

/**
 * @member {Boolean} uploads
 */
ChannelConfigWithInfoRequest.prototype['uploads'] = undefined;

/**
 * @member {Boolean} url_enrichment
 */
ChannelConfigWithInfoRequest.prototype['url_enrichment'] = undefined;
 ...
 * @readonly
 */
ChannelConfigWithInfoRequest['AutomodEnum'] = {
 ...
 * @readonly
 */
ChannelConfigWithInfoRequest['AutomodBehaviorEnum'] = {
 ...
 * @readonly
 */
ChannelConfigWithInfoRequest['BlocklistBehaviorEnum'] = {
...
export default ChannelConfigWithInfoRequest;
