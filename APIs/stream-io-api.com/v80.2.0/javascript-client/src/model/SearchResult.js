    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('message')) {
                obj['message'] = SearchResultMessage.constructFromObject(data['message']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/SearchResultMessage} message
 */
SearchResult.prototype['message'] = undefined;
