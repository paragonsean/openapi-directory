...
/**
 * The ReactionDeletedEvent model module.
 * @module model/ReactionDeletedEvent
 * @version v80.2.0
 */
class ReactionDeletedEvent {
    /**
     * Constructs a new <code>ReactionDeletedEvent</code>.
     * @alias module:model/ReactionDeletedEvent
    ...
    constructor(channelId, channelType, cid, createdAt, type) { 
        ...
        ReactionDeletedEvent.initialize(this, channelId, channelType, cid, createdAt, type);
    }
    ...
    static initialize(obj, channelId, channelType, cid, createdAt, type) { 
        ...
        obj['type'] = type || 'reaction.deleted';
    }

    /**
     * Constructs a <code>ReactionDeletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReactionDeletedEvent} obj Optional instance to populate.
     * @return {module:model/ReactionDeletedEvent} The populated <code>ReactionDeletedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReactionDeletedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ReactionDeletedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReactionDeletedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReactionDeletedEvent.RequiredProperties) {
...
ReactionDeletedEvent.RequiredProperties = ["channel_id", "channel_type", "cid", "created_at", "type"];

/**
 * @member {String} channel_id
 */
ReactionDeletedEvent.prototype['channel_id'] = undefined;

/**
 * @member {String} channel_type
 */
ReactionDeletedEvent.prototype['channel_type'] = undefined;

/**
 * @member {String} cid
 */
ReactionDeletedEvent.prototype['cid'] = undefined;

/**
 * @member {Date} created_at
 */
ReactionDeletedEvent.prototype['created_at'] = undefined;

/**
 * @member {module:model/Message} message
 */
ReactionDeletedEvent.prototype['message'] = undefined;

/**
 * @member {module:model/Reaction} reaction
 */
ReactionDeletedEvent.prototype['reaction'] = undefined;

/**
 * @member {String} team
 */
ReactionDeletedEvent.prototype['team'] = undefined;

/**
 * @member {Array.<module:model/UserObject>} thread_participants
 */
ReactionDeletedEvent.prototype['thread_participants'] = undefined;

/**
 * @member {String} type
 * @default 'reaction.deleted'
 */
ReactionDeletedEvent.prototype['type'] = 'reaction.deleted';

/**
 * @member {module:model/UserObject} user
 */
ReactionDeletedEvent.prototype['user'] = undefined;
...
export default ReactionDeletedEvent;
