...
class EventResponse {
    ...
    constructor(duration) { 
        ...
        EventResponse.initialize(this, duration);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of EventResponse.RequiredProperties) {
...
EventResponse.RequiredProperties = ["duration"];

/**
 * Duration of the request in human-readable format
 * @member {String} duration
 */
EventResponse.prototype['duration'] = undefined;
