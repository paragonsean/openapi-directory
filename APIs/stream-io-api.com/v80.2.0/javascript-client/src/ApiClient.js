...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://chat.stream-io-api.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://chat.stream-io-api.com
         */
        ...
        this.authentications = {
            ...
            'stream-auth-type': {type: 'apiKey', 'in': 'header', name: 'Stream-Auth-Type'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v80.2.0/Javascript'
        };
