...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelUpdatedEvent();
  });
  ...
  describe('ChannelUpdatedEvent', function() {
    it('should create an instance of ChannelUpdatedEvent', function() {
      // uncomment below and update the code to test ChannelUpdatedEvent
      //var instance = new StreamChatApi.ChannelUpdatedEvent();
      //expect(instance).to.be.a(StreamChatApi.ChannelUpdatedEvent);
    });
