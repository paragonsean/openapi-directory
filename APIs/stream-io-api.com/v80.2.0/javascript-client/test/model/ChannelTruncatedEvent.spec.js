...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelTruncatedEvent();
  });
  ...
  describe('ChannelTruncatedEvent', function() {
    it('should create an instance of ChannelTruncatedEvent', function() {
      // uncomment below and update the code to test ChannelTruncatedEvent
      //var instance = new StreamChatApi.ChannelTruncatedEvent();
      //expect(instance).to.be.a(StreamChatApi.ChannelTruncatedEvent);
    });
