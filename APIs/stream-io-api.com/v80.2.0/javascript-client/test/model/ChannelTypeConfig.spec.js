...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelTypeConfig();
  });
  ...
  describe('ChannelTypeConfig', function() {
    it('should create an instance of ChannelTypeConfig', function() {
      // uncomment below and update the code to test ChannelTypeConfig
      //var instance = new StreamChatApi.ChannelTypeConfig();
      //expect(instance).to.be.a(StreamChatApi.ChannelTypeConfig);
    });
