...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationChannelDeletedEvent();
  });
  ...
  describe('NotificationChannelDeletedEvent', function() {
    it('should create an instance of NotificationChannelDeletedEvent', function() {
      // uncomment below and update the code to test NotificationChannelDeletedEvent
      //var instance = new StreamChatApi.NotificationChannelDeletedEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationChannelDeletedEvent);
    });
