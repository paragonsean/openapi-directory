...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.TypingStartEvent();
  });
  ...
  describe('TypingStartEvent', function() {
    it('should create an instance of TypingStartEvent', function() {
      // uncomment below and update the code to test TypingStartEvent
      //var instance = new StreamChatApi.TypingStartEvent();
      //expect(instance).to.be.a(StreamChatApi.TypingStartEvent);
    });
