...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UserUnbannedEvent();
  });
  ...
  describe('UserUnbannedEvent', function() {
    it('should create an instance of UserUnbannedEvent', function() {
      // uncomment below and update the code to test UserUnbannedEvent
      //var instance = new StreamChatApi.UserUnbannedEvent();
      //expect(instance).to.be.a(StreamChatApi.UserUnbannedEvent);
    });
