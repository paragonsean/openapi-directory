...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ReactionDeletedEvent();
  });
  ...
  describe('ReactionDeletedEvent', function() {
    it('should create an instance of ReactionDeletedEvent', function() {
      // uncomment below and update the code to test ReactionDeletedEvent
      //var instance = new StreamChatApi.ReactionDeletedEvent();
      //expect(instance).to.be.a(StreamChatApi.ReactionDeletedEvent);
    });
