...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UserWatchingStartEvent();
  });
  ...
  describe('UserWatchingStartEvent', function() {
    it('should create an instance of UserWatchingStartEvent', function() {
      // uncomment below and update the code to test UserWatchingStartEvent
      //var instance = new StreamChatApi.UserWatchingStartEvent();
      //expect(instance).to.be.a(StreamChatApi.UserWatchingStartEvent);
    });
