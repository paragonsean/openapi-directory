...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelResponseRequest();
  });
  ...
  describe('ChannelResponseRequest', function() {
    it('should create an instance of ChannelResponseRequest', function() {
      // uncomment below and update the code to test ChannelResponseRequest
      //var instance = new StreamChatApi.ChannelResponseRequest();
      //expect(instance).to.be.a(StreamChatApi.ChannelResponseRequest);
    });
