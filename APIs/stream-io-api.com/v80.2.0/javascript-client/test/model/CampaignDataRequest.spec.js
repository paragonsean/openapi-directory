...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.CampaignDataRequest();
  });
  ...
  describe('CampaignDataRequest', function() {
    it('should create an instance of CampaignDataRequest', function() {
      // uncomment below and update the code to test CampaignDataRequest
      //var instance = new StreamChatApi.CampaignDataRequest();
      //expect(instance).to.be.a(StreamChatApi.CampaignDataRequest);
    });
