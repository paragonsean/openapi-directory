...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.LimitInfo();
  });
  ...
  describe('LimitInfo', function() {
    it('should create an instance of LimitInfo', function() {
      // uncomment below and update the code to test LimitInfo
      //var instance = new StreamChatApi.LimitInfo();
      //expect(instance).to.be.a(StreamChatApi.LimitInfo);
    });
