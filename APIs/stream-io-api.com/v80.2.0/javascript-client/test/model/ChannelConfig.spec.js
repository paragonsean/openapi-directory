...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelConfig();
  });
  ...
  describe('ChannelConfig', function() {
    it('should create an instance of ChannelConfig', function() {
      // uncomment below and update the code to test ChannelConfig
      //var instance = new StreamChatApi.ChannelConfig();
      //expect(instance).to.be.a(StreamChatApi.ChannelConfig);
    });
