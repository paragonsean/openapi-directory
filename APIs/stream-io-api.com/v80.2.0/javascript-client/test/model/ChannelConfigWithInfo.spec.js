...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelConfigWithInfo();
  });
  ...
  describe('ChannelConfigWithInfo', function() {
    it('should create an instance of ChannelConfigWithInfo', function() {
      // uncomment below and update the code to test ChannelConfigWithInfo
      //var instance = new StreamChatApi.ChannelConfigWithInfo();
      //expect(instance).to.be.a(StreamChatApi.ChannelConfigWithInfo);
    });
