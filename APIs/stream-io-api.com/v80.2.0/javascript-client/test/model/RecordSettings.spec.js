...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.RecordSettings();
  });
  ...
  describe('RecordSettings', function() {
    it('should create an instance of RecordSettings', function() {
      // uncomment below and update the code to test RecordSettings
      //var instance = new StreamChatApi.RecordSettings();
      //expect(instance).to.be.a(StreamChatApi.RecordSettings);
    });
