...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UserMutedEvent();
  });
  ...
  describe('UserMutedEvent', function() {
    it('should create an instance of UserMutedEvent', function() {
      // uncomment below and update the code to test UserMutedEvent
      //var instance = new StreamChatApi.UserMutedEvent();
      //expect(instance).to.be.a(StreamChatApi.UserMutedEvent);
    });
