...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelHiddenEvent();
  });
  ...
  describe('ChannelHiddenEvent', function() {
    it('should create an instance of ChannelHiddenEvent', function() {
      // uncomment below and update the code to test ChannelHiddenEvent
      //var instance = new StreamChatApi.ChannelHiddenEvent();
      //expect(instance).to.be.a(StreamChatApi.ChannelHiddenEvent);
    });
