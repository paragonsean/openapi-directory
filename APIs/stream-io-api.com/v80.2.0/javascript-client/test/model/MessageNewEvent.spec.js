...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MessageNewEvent();
  });
  ...
  describe('MessageNewEvent', function() {
    it('should create an instance of MessageNewEvent', function() {
      // uncomment below and update the code to test MessageNewEvent
      //var instance = new StreamChatApi.MessageNewEvent();
      //expect(instance).to.be.a(StreamChatApi.MessageNewEvent);
    });
