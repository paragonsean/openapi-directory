...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MessageFlaggedEvent();
  });
  ...
  describe('MessageFlaggedEvent', function() {
    it('should create an instance of MessageFlaggedEvent', function() {
      // uncomment below and update the code to test MessageFlaggedEvent
      //var instance = new StreamChatApi.MessageFlaggedEvent();
      //expect(instance).to.be.a(StreamChatApi.MessageFlaggedEvent);
    });
