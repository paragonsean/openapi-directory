...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelDeletedEvent();
  });
  ...
  describe('ChannelDeletedEvent', function() {
    it('should create an instance of ChannelDeletedEvent', function() {
      // uncomment below and update the code to test ChannelDeletedEvent
      //var instance = new StreamChatApi.ChannelDeletedEvent();
      //expect(instance).to.be.a(StreamChatApi.ChannelDeletedEvent);
    });
