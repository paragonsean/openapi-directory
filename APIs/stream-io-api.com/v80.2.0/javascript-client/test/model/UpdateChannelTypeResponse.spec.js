...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UpdateChannelTypeResponse();
  });
  ...
  describe('UpdateChannelTypeResponse', function() {
    it('should create an instance of UpdateChannelTypeResponse', function() {
      // uncomment below and update the code to test UpdateChannelTypeResponse
      //var instance = new StreamChatApi.UpdateChannelTypeResponse();
      //expect(instance).to.be.a(StreamChatApi.UpdateChannelTypeResponse);
    });
