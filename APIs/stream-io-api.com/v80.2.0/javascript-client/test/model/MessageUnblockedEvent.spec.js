...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MessageUnblockedEvent();
  });
  ...
  describe('MessageUnblockedEvent', function() {
    it('should create an instance of MessageUnblockedEvent', function() {
      // uncomment below and update the code to test MessageUnblockedEvent
      //var instance = new StreamChatApi.MessageUnblockedEvent();
      //expect(instance).to.be.a(StreamChatApi.MessageUnblockedEvent);
    });
