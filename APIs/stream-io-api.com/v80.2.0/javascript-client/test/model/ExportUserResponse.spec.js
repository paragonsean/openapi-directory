...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ExportUserResponse();
  });
  ...
  describe('ExportUserResponse', function() {
    it('should create an instance of ExportUserResponse', function() {
      // uncomment below and update the code to test ExportUserResponse
      //var instance = new StreamChatApi.ExportUserResponse();
      //expect(instance).to.be.a(StreamChatApi.ExportUserResponse);
    });
