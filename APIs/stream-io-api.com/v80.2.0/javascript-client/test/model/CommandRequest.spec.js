...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.CommandRequest();
  });
  ...
  describe('CommandRequest', function() {
    it('should create an instance of CommandRequest', function() {
      // uncomment below and update the code to test CommandRequest
      //var instance = new StreamChatApi.CommandRequest();
      //expect(instance).to.be.a(StreamChatApi.CommandRequest);
    });
