...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.PushProvider();
  });
  ...
  describe('PushProvider', function() {
    it('should create an instance of PushProvider', function() {
      // uncomment below and update the code to test PushProvider
      //var instance = new StreamChatApi.PushProvider();
      //expect(instance).to.be.a(StreamChatApi.PushProvider);
    });
