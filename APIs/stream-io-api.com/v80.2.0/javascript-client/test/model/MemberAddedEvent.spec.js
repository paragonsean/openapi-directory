...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MemberAddedEvent();
  });
  ...
  describe('MemberAddedEvent', function() {
    it('should create an instance of MemberAddedEvent', function() {
      // uncomment below and update the code to test MemberAddedEvent
      //var instance = new StreamChatApi.MemberAddedEvent();
      //expect(instance).to.be.a(StreamChatApi.MemberAddedEvent);
    });
