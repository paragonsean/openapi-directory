...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MemberRemovedEvent();
  });
  ...
  describe('MemberRemovedEvent', function() {
    it('should create an instance of MemberRemovedEvent', function() {
      // uncomment below and update the code to test MemberRemovedEvent
      //var instance = new StreamChatApi.MemberRemovedEvent();
      //expect(instance).to.be.a(StreamChatApi.MemberRemovedEvent);
    });
