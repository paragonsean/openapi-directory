...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.QueryRecipientsResponse();
  });
  ...
  describe('QueryRecipientsResponse', function() {
    it('should create an instance of QueryRecipientsResponse', function() {
      // uncomment below and update the code to test QueryRecipientsResponse
      //var instance = new StreamChatApi.QueryRecipientsResponse();
      //expect(instance).to.be.a(StreamChatApi.QueryRecipientsResponse);
    });
