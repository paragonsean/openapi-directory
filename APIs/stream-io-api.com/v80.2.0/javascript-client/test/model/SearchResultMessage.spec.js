...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.SearchResultMessage();
  });
  ...
  describe('SearchResultMessage', function() {
    it('should create an instance of SearchResultMessage', function() {
      // uncomment below and update the code to test SearchResultMessage
      //var instance = new StreamChatApi.SearchResultMessage();
      //expect(instance).to.be.a(StreamChatApi.SearchResultMessage);
    });
