...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationInvitedEvent();
  });
  ...
  describe('NotificationInvitedEvent', function() {
    it('should create an instance of NotificationInvitedEvent', function() {
      // uncomment below and update the code to test NotificationInvitedEvent
      //var instance = new StreamChatApi.NotificationInvitedEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationInvitedEvent);
    });
