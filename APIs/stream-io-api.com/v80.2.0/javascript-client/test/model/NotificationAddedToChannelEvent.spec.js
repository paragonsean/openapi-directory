...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationAddedToChannelEvent();
  });
  ...
  describe('NotificationAddedToChannelEvent', function() {
    it('should create an instance of NotificationAddedToChannelEvent', function() {
      // uncomment below and update the code to test NotificationAddedToChannelEvent
      //var instance = new StreamChatApi.NotificationAddedToChannelEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationAddedToChannelEvent);
    });
