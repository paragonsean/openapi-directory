...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UpdateChannelTypeRequest();
  });
  ...
  describe('UpdateChannelTypeRequest', function() {
    it('should create an instance of UpdateChannelTypeRequest', function() {
      // uncomment below and update the code to test UpdateChannelTypeRequest
      //var instance = new StreamChatApi.UpdateChannelTypeRequest();
      //expect(instance).to.be.a(StreamChatApi.UpdateChannelTypeRequest);
    });

    it('should have the property nameFromPath (base name: "NameFromPath")', function() {
      // uncomment below and update the code to test the property nameFromPath
      //var instance = new StreamChatApi.UpdateChannelTypeRequest();
