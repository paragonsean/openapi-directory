...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MessageRequest1();
  });
  ...
  describe('MessageRequest1', function() {
    it('should create an instance of MessageRequest1', function() {
      // uncomment below and update the code to test MessageRequest1
      //var instance = new StreamChatApi.MessageRequest1();
      //expect(instance).to.be.a(StreamChatApi.MessageRequest1);
    });
