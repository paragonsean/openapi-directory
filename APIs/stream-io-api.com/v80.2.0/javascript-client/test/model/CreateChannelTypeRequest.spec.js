...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.CreateChannelTypeRequest();
  });
  ...
  describe('CreateChannelTypeRequest', function() {
    it('should create an instance of CreateChannelTypeRequest', function() {
      // uncomment below and update the code to test CreateChannelTypeRequest
      //var instance = new StreamChatApi.CreateChannelTypeRequest();
      //expect(instance).to.be.a(StreamChatApi.CreateChannelTypeRequest);
    });
