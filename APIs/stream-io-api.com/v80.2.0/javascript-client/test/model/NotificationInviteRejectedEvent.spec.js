...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationInviteRejectedEvent();
  });
  ...
  describe('NotificationInviteRejectedEvent', function() {
    it('should create an instance of NotificationInviteRejectedEvent', function() {
      // uncomment below and update the code to test NotificationInviteRejectedEvent
      //var instance = new StreamChatApi.NotificationInviteRejectedEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationInviteRejectedEvent);
    });
