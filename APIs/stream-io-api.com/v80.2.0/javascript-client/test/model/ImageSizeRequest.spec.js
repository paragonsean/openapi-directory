...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ImageSizeRequest();
  });
  ...
  describe('ImageSizeRequest', function() {
    it('should create an instance of ImageSizeRequest', function() {
      // uncomment below and update the code to test ImageSizeRequest
      //var instance = new StreamChatApi.ImageSizeRequest();
      //expect(instance).to.be.a(StreamChatApi.ImageSizeRequest);
    });
