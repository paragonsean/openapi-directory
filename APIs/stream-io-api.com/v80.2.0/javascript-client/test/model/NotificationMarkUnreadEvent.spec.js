...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationMarkUnreadEvent();
  });
  ...
  describe('NotificationMarkUnreadEvent', function() {
    it('should create an instance of NotificationMarkUnreadEvent', function() {
      // uncomment below and update the code to test NotificationMarkUnreadEvent
      //var instance = new StreamChatApi.NotificationMarkUnreadEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationMarkUnreadEvent);
    });
