...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationRemovedFromChannelEvent();
  });
  ...
  describe('NotificationRemovedFromChannelEvent', function() {
    it('should create an instance of NotificationRemovedFromChannelEvent', function() {
      // uncomment below and update the code to test NotificationRemovedFromChannelEvent
      //var instance = new StreamChatApi.NotificationRemovedFromChannelEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationRemovedFromChannelEvent);
    });
