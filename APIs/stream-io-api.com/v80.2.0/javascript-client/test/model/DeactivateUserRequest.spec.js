...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.DeactivateUserRequest();
  });
  ...
  describe('DeactivateUserRequest', function() {
    it('should create an instance of DeactivateUserRequest', function() {
      ...
      //var instance = new StreamChatApi.DeactivateUserRequest();
      //expect(instance).to.be.a(StreamChatApi.DeactivateUserRequest);
    });
