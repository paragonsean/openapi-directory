...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelKickedEvent();
  });
  ...
  describe('ChannelKickedEvent', function() {
    it('should create an instance of ChannelKickedEvent', function() {
      // uncomment below and update the code to test ChannelKickedEvent
      //var instance = new StreamChatApi.ChannelKickedEvent();
      //expect(instance).to.be.a(StreamChatApi.ChannelKickedEvent);
    });
