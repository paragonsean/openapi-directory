...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationChannelTruncatedEvent();
  });
  ...
  describe('NotificationChannelTruncatedEvent', function() {
    it('should create an instance of NotificationChannelTruncatedEvent', function() {
      // uncomment below and update the code to test NotificationChannelTruncatedEvent
      //var instance = new StreamChatApi.NotificationChannelTruncatedEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationChannelTruncatedEvent);
    });
