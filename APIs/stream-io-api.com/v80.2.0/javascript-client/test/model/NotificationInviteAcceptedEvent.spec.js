...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationInviteAcceptedEvent();
  });
  ...
  describe('NotificationInviteAcceptedEvent', function() {
    it('should create an instance of NotificationInviteAcceptedEvent', function() {
      // uncomment below and update the code to test NotificationInviteAcceptedEvent
      //var instance = new StreamChatApi.NotificationInviteAcceptedEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationInviteAcceptedEvent);
    });
