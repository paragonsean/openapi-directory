...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.TypingStopEvent();
  });
  ...
  describe('TypingStopEvent', function() {
    it('should create an instance of TypingStopEvent', function() {
      // uncomment below and update the code to test TypingStopEvent
      //var instance = new StreamChatApi.TypingStopEvent();
      //expect(instance).to.be.a(StreamChatApi.TypingStopEvent);
    });
