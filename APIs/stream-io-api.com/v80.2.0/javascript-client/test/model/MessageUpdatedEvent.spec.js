...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MessageUpdatedEvent();
  });
  ...
  describe('MessageUpdatedEvent', function() {
    it('should create an instance of MessageUpdatedEvent', function() {
      // uncomment below and update the code to test MessageUpdatedEvent
      //var instance = new StreamChatApi.MessageUpdatedEvent();
      //expect(instance).to.be.a(StreamChatApi.MessageUpdatedEvent);
    });
