...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MessageReadEvent();
  });
  ...
  describe('MessageReadEvent', function() {
    it('should create an instance of MessageReadEvent', function() {
      // uncomment below and update the code to test MessageReadEvent
      //var instance = new StreamChatApi.MessageReadEvent();
      //expect(instance).to.be.a(StreamChatApi.MessageReadEvent);
    });
