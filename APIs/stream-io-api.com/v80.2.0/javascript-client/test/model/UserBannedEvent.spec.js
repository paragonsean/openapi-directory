...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UserBannedEvent();
  });
  ...
  describe('UserBannedEvent', function() {
    it('should create an instance of UserBannedEvent', function() {
      // uncomment below and update the code to test UserBannedEvent
      //var instance = new StreamChatApi.UserBannedEvent();
      //expect(instance).to.be.a(StreamChatApi.UserBannedEvent);
    });
