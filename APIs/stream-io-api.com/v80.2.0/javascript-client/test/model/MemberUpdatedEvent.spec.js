...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.MemberUpdatedEvent();
  });
  ...
  describe('MemberUpdatedEvent', function() {
    it('should create an instance of MemberUpdatedEvent', function() {
      // uncomment below and update the code to test MemberUpdatedEvent
      //var instance = new StreamChatApi.MemberUpdatedEvent();
      //expect(instance).to.be.a(StreamChatApi.MemberUpdatedEvent);
    });
