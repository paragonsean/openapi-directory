...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.NotificationMarkReadEvent();
  });
  ...
  describe('NotificationMarkReadEvent', function() {
    it('should create an instance of NotificationMarkReadEvent', function() {
      // uncomment below and update the code to test NotificationMarkReadEvent
      //var instance = new StreamChatApi.NotificationMarkReadEvent();
      //expect(instance).to.be.a(StreamChatApi.NotificationMarkReadEvent);
    });
