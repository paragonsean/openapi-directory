...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.DeactivateUsersRequest();
  });
  ...
  describe('DeactivateUsersRequest', function() {
    it('should create an instance of DeactivateUsersRequest', function() {
      // uncomment below and update the code to test DeactivateUsersRequest
      //var instance = new StreamChatApi.DeactivateUsersRequest();
      //expect(instance).to.be.a(StreamChatApi.DeactivateUsersRequest);
    });
