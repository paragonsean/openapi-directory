...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ReactionUpdatedEvent();
  });
  ...
  describe('ReactionUpdatedEvent', function() {
    it('should create an instance of ReactionUpdatedEvent', function() {
      // uncomment below and update the code to test ReactionUpdatedEvent
      //var instance = new StreamChatApi.ReactionUpdatedEvent();
      //expect(instance).to.be.a(StreamChatApi.ReactionUpdatedEvent);
    });
