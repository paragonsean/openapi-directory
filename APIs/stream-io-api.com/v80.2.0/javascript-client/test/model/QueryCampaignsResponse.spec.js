...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.QueryCampaignsResponse();
  });
  ...
  describe('QueryCampaignsResponse', function() {
    it('should create an instance of QueryCampaignsResponse', function() {
      // uncomment below and update the code to test QueryCampaignsResponse
      //var instance = new StreamChatApi.QueryCampaignsResponse();
      //expect(instance).to.be.a(StreamChatApi.QueryCampaignsResponse);
    });
