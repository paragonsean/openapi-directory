...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelConfigWithInfoRequest();
  });
  ...
  describe('ChannelConfigWithInfoRequest', function() {
    it('should create an instance of ChannelConfigWithInfoRequest', function() {
      // uncomment below and update the code to test ChannelConfigWithInfoRequest
      //var instance = new StreamChatApi.ChannelConfigWithInfoRequest();
      //expect(instance).to.be.a(StreamChatApi.ChannelConfigWithInfoRequest);
    });
