...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.XiaomiConfigRequest();
  });
  ...
  describe('XiaomiConfigRequest', function() {
    it('should create an instance of XiaomiConfigRequest', function() {
      // uncomment below and update the code to test XiaomiConfigRequest
      //var instance = new StreamChatApi.XiaomiConfigRequest();
      //expect(instance).to.be.a(StreamChatApi.XiaomiConfigRequest);
    });
