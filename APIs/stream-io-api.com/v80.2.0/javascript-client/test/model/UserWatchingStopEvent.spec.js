...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UserWatchingStopEvent();
  });
  ...
  describe('UserWatchingStopEvent', function() {
    it('should create an instance of UserWatchingStopEvent', function() {
      // uncomment below and update the code to test UserWatchingStopEvent
      //var instance = new StreamChatApi.UserWatchingStopEvent();
      //expect(instance).to.be.a(StreamChatApi.UserWatchingStopEvent);
    });
