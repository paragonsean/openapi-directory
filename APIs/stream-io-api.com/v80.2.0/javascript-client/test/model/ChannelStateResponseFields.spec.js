...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelStateResponseFields();
  });
  ...
  describe('ChannelStateResponseFields', function() {
    it('should create an instance of ChannelStateResponseFields', function() {
      // uncomment below and update the code to test ChannelStateResponseFields
      //var instance = new StreamChatApi.ChannelStateResponseFields();
      //expect(instance).to.be.a(StreamChatApi.ChannelStateResponseFields);
    });
