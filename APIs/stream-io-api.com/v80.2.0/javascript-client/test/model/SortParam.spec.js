...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.SortParam();
  });
  ...
  describe('SortParam', function() {
    it('should create an instance of SortParam', function() {
      // uncomment below and update the code to test SortParam
      //var instance = new StreamChatApi.SortParam();
      //expect(instance).to.be.a(StreamChatApi.SortParam);
    });
