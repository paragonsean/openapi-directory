...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.HuaweiConfigRequest();
  });
  ...
  describe('HuaweiConfigRequest', function() {
    it('should create an instance of HuaweiConfigRequest', function() {
      // uncomment below and update the code to test HuaweiConfigRequest
      //var instance = new StreamChatApi.HuaweiConfigRequest();
      //expect(instance).to.be.a(StreamChatApi.HuaweiConfigRequest);
    });
