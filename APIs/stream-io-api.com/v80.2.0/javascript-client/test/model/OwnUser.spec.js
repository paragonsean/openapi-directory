...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.OwnUser();
  });
  ...
  describe('OwnUser', function() {
    it('should create an instance of OwnUser', function() {
      // uncomment below and update the code to test OwnUser
      //var instance = new StreamChatApi.OwnUser();
      //expect(instance).to.be.a(StreamChatApi.OwnUser);
    });
