...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ReactionNewEvent();
  });
  ...
  describe('ReactionNewEvent', function() {
    it('should create an instance of ReactionNewEvent', function() {
      // uncomment below and update the code to test ReactionNewEvent
      //var instance = new StreamChatApi.ReactionNewEvent();
      //expect(instance).to.be.a(StreamChatApi.ReactionNewEvent);
    });
