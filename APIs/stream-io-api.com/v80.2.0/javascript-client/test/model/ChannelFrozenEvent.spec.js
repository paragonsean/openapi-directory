...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelFrozenEvent();
  });
  ...
  describe('ChannelFrozenEvent', function() {
    it('should create an instance of ChannelFrozenEvent', function() {
      // uncomment below and update the code to test ChannelFrozenEvent
      //var instance = new StreamChatApi.ChannelFrozenEvent();
      //expect(instance).to.be.a(StreamChatApi.ChannelFrozenEvent);
    });
