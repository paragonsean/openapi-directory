...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.ChannelUnFrozenEvent();
  });
  ...
  describe('ChannelUnFrozenEvent', function() {
    it('should create an instance of ChannelUnFrozenEvent', function() {
      // uncomment below and update the code to test ChannelUnFrozenEvent
      //var instance = new StreamChatApi.ChannelUnFrozenEvent();
      //expect(instance).to.be.a(StreamChatApi.ChannelUnFrozenEvent);
    });
