...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.LabelThresholds();
  });
  ...
  describe('LabelThresholds', function() {
    it('should create an instance of LabelThresholds', function() {
      // uncomment below and update the code to test LabelThresholds
      //var instance = new StreamChatApi.LabelThresholds();
      //expect(instance).to.be.a(StreamChatApi.LabelThresholds);
    });
