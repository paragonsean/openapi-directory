...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreamChatApi.UserUnmutedEvent();
  });
  ...
  describe('UserUnmutedEvent', function() {
    it('should create an instance of UserUnmutedEvent', function() {
      // uncomment below and update the code to test UserUnmutedEvent
      //var instance = new StreamChatApi.UserUnmutedEvent();
      //expect(instance).to.be.a(StreamChatApi.UserUnmutedEvent);
    });
