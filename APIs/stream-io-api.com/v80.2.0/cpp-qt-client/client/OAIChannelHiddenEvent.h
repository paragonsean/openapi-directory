...
/*
 * OAIChannelHiddenEvent.h
 *
 * 
 */

#ifndef OAIChannelHiddenEvent_H
#define OAIChannelHiddenEvent_H
...
class OAIChannelHiddenEvent : public OAIObject {
public:
    OAIChannelHiddenEvent();
    OAIChannelHiddenEvent(QString json);
    ~OAIChannelHiddenEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelHiddenEvent)

#endif // OAIChannelHiddenEvent_H
