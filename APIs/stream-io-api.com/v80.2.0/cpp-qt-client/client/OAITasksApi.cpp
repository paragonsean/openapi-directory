...
void OAITasksApi::getTask(const QString &id) {
    QString fullPath = QString(_serverConfigs["getTask"][_serverIndices.value("getTask")].URL()+"/tasks/{id}");
...
void OAITasksApi::getTaskCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetTaskResponse output(QString(worker->response));
    worker->deleteLater();
