...
/*
 * OAINotificationRemovedFromChannelEvent.h
 *
 * 
 */

#ifndef OAINotificationRemovedFromChannelEvent_H
#define OAINotificationRemovedFromChannelEvent_H
...
class OAINotificationRemovedFromChannelEvent : public OAIObject {
public:
    OAINotificationRemovedFromChannelEvent();
    OAINotificationRemovedFromChannelEvent(QString json);
    ~OAINotificationRemovedFromChannelEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationRemovedFromChannelEvent)

#endif // OAINotificationRemovedFromChannelEvent_H
