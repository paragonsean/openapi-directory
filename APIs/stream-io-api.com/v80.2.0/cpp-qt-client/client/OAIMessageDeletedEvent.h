...
/*
 * OAIMessageDeletedEvent.h
 *
 * 
 */

#ifndef OAIMessageDeletedEvent_H
#define OAIMessageDeletedEvent_H
...
class OAIMessageDeletedEvent : public OAIObject {
public:
    OAIMessageDeletedEvent();
    OAIMessageDeletedEvent(QString json);
    ~OAIMessageDeletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageDeletedEvent)

#endif // OAIMessageDeletedEvent_H
