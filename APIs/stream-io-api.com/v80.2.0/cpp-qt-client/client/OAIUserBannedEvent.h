...
/*
 * OAIUserBannedEvent.h
 *
 * 
 */

#ifndef OAIUserBannedEvent_H
#define OAIUserBannedEvent_H
...
class OAIUserBannedEvent : public OAIObject {
public:
    OAIUserBannedEvent();
    OAIUserBannedEvent(QString json);
    ~OAIUserBannedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserBannedEvent)

#endif // OAIUserBannedEvent_H
