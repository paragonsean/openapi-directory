...
#ifndef OAIImageData_H
#define OAIImageData_H
...
class OAIImageData : public OAIObject {
public:
    OAIImageData();
    OAIImageData(QString json);
    ~OAIImageData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageData)

#endif // OAIImageData_H
