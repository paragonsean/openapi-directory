...
/*
 * OAIMessageFlaggedEvent.h
 *
 * 
 */

#ifndef OAIMessageFlaggedEvent_H
#define OAIMessageFlaggedEvent_H
...
class OAIMessageFlaggedEvent : public OAIObject {
public:
    OAIMessageFlaggedEvent();
    OAIMessageFlaggedEvent(QString json);
    ~OAIMessageFlaggedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageFlaggedEvent)

#endif // OAIMessageFlaggedEvent_H
