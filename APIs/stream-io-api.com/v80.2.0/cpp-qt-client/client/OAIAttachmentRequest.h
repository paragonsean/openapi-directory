...
/*
 * OAIAttachmentRequest.h
 *
 * 
 */

#ifndef OAIAttachmentRequest_H
#define OAIAttachmentRequest_H
...
namespace OpenAPI {
class OAIActionRequest;
class OAIFieldRequest;
class OAIImagesRequest;

class OAIAttachmentRequest : public OAIObject {
public:
    OAIAttachmentRequest();
    OAIAttachmentRequest(QString json);
    ~OAIAttachmentRequest() override;
    ...
    QList<OAIActionRequest> getActions() const;
    void setActions(const QList<OAIActionRequest> &actions);
    ...
    QList<OAIFieldRequest> getFields() const;
    void setFields(const QList<OAIFieldRequest> &fields);
    ...
    OAIImagesRequest getGiphy() const;
    void setGiphy(const OAIImagesRequest &giphy);
...
private:
    ...
    QList<OAIActionRequest> m_actions;
    ...
    QList<OAIFieldRequest> m_fields;
    bool m_fields_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentRequest)

#endif // OAIAttachmentRequest_H
