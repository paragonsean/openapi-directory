...
/*
 * OAIMessageNewEvent.h
 *
 * 
 */

#ifndef OAIMessageNewEvent_H
#define OAIMessageNewEvent_H
...
class OAIMessageNewEvent : public OAIObject {
public:
    OAIMessageNewEvent();
    OAIMessageNewEvent(QString json);
    ~OAIMessageNewEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageNewEvent)

#endif // OAIMessageNewEvent_H
