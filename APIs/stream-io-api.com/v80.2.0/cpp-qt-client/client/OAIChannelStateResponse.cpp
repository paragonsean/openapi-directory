...
OAIChannelStateResponse::OAIChannelStateResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelStateResponse::OAIChannelStateResponse() {
    this->initializeModel();
}

OAIChannelStateResponse::~OAIChannelStateResponse() {}

void OAIChannelStateResponse::initializeModel() {
...
void OAIChannelStateResponse::fromJson(QString jsonString) {
...
void OAIChannelStateResponse::fromJsonObject(QJsonObject json) {
...
QString OAIChannelStateResponse::asJson() const {
...
QJsonObject OAIChannelStateResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_channel.isSet()) {
...
OAIChannelResponse OAIChannelStateResponse::getChannel() const {
    return m_channel;
}
void OAIChannelStateResponse::setChannel(const OAIChannelResponse &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIChannelStateResponse::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIChannelStateResponse::is_channel_Valid() const{
    return m_channel_isValid;
}

QString OAIChannelStateResponse::getDuration() const {
    return m_duration;
}
void OAIChannelStateResponse::setDuration(const QString &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIChannelStateResponse::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIChannelStateResponse::is_duration_Valid() const{
    return m_duration_isValid;
}

bool OAIChannelStateResponse::isHidden() const {
    return m_hidden;
}
void OAIChannelStateResponse::setHidden(const bool &hidden) {
    m_hidden = hidden;
    m_hidden_isSet = true;
}

bool OAIChannelStateResponse::is_hidden_Set() const{
    return m_hidden_isSet;
}

bool OAIChannelStateResponse::is_hidden_Valid() const{
    return m_hidden_isValid;
}

QDateTime OAIChannelStateResponse::getHideMessagesBefore() const {
    return m_hide_messages_before;
}
void OAIChannelStateResponse::setHideMessagesBefore(const QDateTime &hide_messages_before) {
    m_hide_messages_before = hide_messages_before;
    m_hide_messages_before_isSet = true;
}

bool OAIChannelStateResponse::is_hide_messages_before_Set() const{
    return m_hide_messages_before_isSet;
}

bool OAIChannelStateResponse::is_hide_messages_before_Valid() const{
    return m_hide_messages_before_isValid;
}

QList<OAIChannelMember> OAIChannelStateResponse::getMembers() const {
    return m_members;
}
void OAIChannelStateResponse::setMembers(const QList<OAIChannelMember> &members) {
    m_members = members;
    m_members_isSet = true;
}

bool OAIChannelStateResponse::is_members_Set() const{
    return m_members_isSet;
}

bool OAIChannelStateResponse::is_members_Valid() const{
    return m_members_isValid;
}

OAIChannelMember OAIChannelStateResponse::getMembership() const {
    return m_membership;
}
void OAIChannelStateResponse::setMembership(const OAIChannelMember &membership) {
    m_membership = membership;
    m_membership_isSet = true;
}

bool OAIChannelStateResponse::is_membership_Set() const{
    return m_membership_isSet;
}

bool OAIChannelStateResponse::is_membership_Valid() const{
    return m_membership_isValid;
}

QList<OAIMessage> OAIChannelStateResponse::getMessages() const {
    return m_messages;
}
void OAIChannelStateResponse::setMessages(const QList<OAIMessage> &messages) {
    m_messages = messages;
    m_messages_isSet = true;
}

bool OAIChannelStateResponse::is_messages_Set() const{
    return m_messages_isSet;
}

bool OAIChannelStateResponse::is_messages_Valid() const{
    return m_messages_isValid;
}

QList<OAIPendingMessage> OAIChannelStateResponse::getPendingMessages() const {
    return m_pending_messages;
}
void OAIChannelStateResponse::setPendingMessages(const QList<OAIPendingMessage> &pending_messages) {
    m_pending_messages = pending_messages;
    m_pending_messages_isSet = true;
}

bool OAIChannelStateResponse::is_pending_messages_Set() const{
    return m_pending_messages_isSet;
}

bool OAIChannelStateResponse::is_pending_messages_Valid() const{
    return m_pending_messages_isValid;
}

QList<OAIMessage> OAIChannelStateResponse::getPinnedMessages() const {
    return m_pinned_messages;
}
void OAIChannelStateResponse::setPinnedMessages(const QList<OAIMessage> &pinned_messages) {
    m_pinned_messages = pinned_messages;
    m_pinned_messages_isSet = true;
}

bool OAIChannelStateResponse::is_pinned_messages_Set() const{
    return m_pinned_messages_isSet;
}

bool OAIChannelStateResponse::is_pinned_messages_Valid() const{
    return m_pinned_messages_isValid;
}

QList<OAIRead> OAIChannelStateResponse::getRead() const {
    return m_read;
}
void OAIChannelStateResponse::setRead(const QList<OAIRead> &read) {
    m_read = read;
    m_read_isSet = true;
}

bool OAIChannelStateResponse::is_read_Set() const{
    return m_read_isSet;
}

bool OAIChannelStateResponse::is_read_Valid() const{
    return m_read_isValid;
}

qint32 OAIChannelStateResponse::getWatcherCount() const {
    return m_watcher_count;
}
void OAIChannelStateResponse::setWatcherCount(const qint32 &watcher_count) {
    m_watcher_count = watcher_count;
    m_watcher_count_isSet = true;
}

bool OAIChannelStateResponse::is_watcher_count_Set() const{
    return m_watcher_count_isSet;
}

bool OAIChannelStateResponse::is_watcher_count_Valid() const{
    return m_watcher_count_isValid;
}

QList<OAIUserObject> OAIChannelStateResponse::getWatchers() const {
    return m_watchers;
}
void OAIChannelStateResponse::setWatchers(const QList<OAIUserObject> &watchers) {
    m_watchers = watchers;
    m_watchers_isSet = true;
}

bool OAIChannelStateResponse::is_watchers_Set() const{
    return m_watchers_isSet;
}

bool OAIChannelStateResponse::is_watchers_Valid() const{
    return m_watchers_isValid;
}

bool OAIChannelStateResponse::isSet() const {
...
bool OAIChannelStateResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_duration_isValid && m_members_isValid && m_messages_isValid && m_pinned_messages_isValid && true;
}
