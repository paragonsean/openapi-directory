...
#ifndef OAIGetOGResponse_H
#define OAIGetOGResponse_H
...
class OAIGetOGResponse : public OAIObject {
public:
    OAIGetOGResponse();
    OAIGetOGResponse(QString json);
    ~OAIGetOGResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOGResponse)

#endif // OAIGetOGResponse_H
