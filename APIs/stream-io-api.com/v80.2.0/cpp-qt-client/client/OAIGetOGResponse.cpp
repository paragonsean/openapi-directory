...
OAIGetOGResponse::OAIGetOGResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOGResponse::OAIGetOGResponse() {
    this->initializeModel();
}

OAIGetOGResponse::~OAIGetOGResponse() {}

void OAIGetOGResponse::initializeModel() {
...
void OAIGetOGResponse::fromJson(QString jsonString) {
...
void OAIGetOGResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetOGResponse::asJson() const {
...
QJsonObject OAIGetOGResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_actions.size() > 0) {
...
QList<OAIAction> OAIGetOGResponse::getActions() const {
    return m_actions;
}
void OAIGetOGResponse::setActions(const QList<OAIAction> &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIGetOGResponse::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIGetOGResponse::is_actions_Valid() const{
    return m_actions_isValid;
}

QString OAIGetOGResponse::getAssetUrl() const {
    return m_asset_url;
}
void OAIGetOGResponse::setAssetUrl(const QString &asset_url) {
    m_asset_url = asset_url;
    m_asset_url_isSet = true;
}

bool OAIGetOGResponse::is_asset_url_Set() const{
    return m_asset_url_isSet;
}

bool OAIGetOGResponse::is_asset_url_Valid() const{
    return m_asset_url_isValid;
}

QString OAIGetOGResponse::getAuthorIcon() const {
    return m_author_icon;
}
void OAIGetOGResponse::setAuthorIcon(const QString &author_icon) {
    m_author_icon = author_icon;
    m_author_icon_isSet = true;
}

bool OAIGetOGResponse::is_author_icon_Set() const{
    return m_author_icon_isSet;
}

bool OAIGetOGResponse::is_author_icon_Valid() const{
    return m_author_icon_isValid;
}

QString OAIGetOGResponse::getAuthorLink() const {
    return m_author_link;
}
void OAIGetOGResponse::setAuthorLink(const QString &author_link) {
    m_author_link = author_link;
    m_author_link_isSet = true;
}

bool OAIGetOGResponse::is_author_link_Set() const{
    return m_author_link_isSet;
}

bool OAIGetOGResponse::is_author_link_Valid() const{
    return m_author_link_isValid;
}

QString OAIGetOGResponse::getAuthorName() const {
    return m_author_name;
}
void OAIGetOGResponse::setAuthorName(const QString &author_name) {
    m_author_name = author_name;
    m_author_name_isSet = true;
}

bool OAIGetOGResponse::is_author_name_Set() const{
    return m_author_name_isSet;
}

bool OAIGetOGResponse::is_author_name_Valid() const{
    return m_author_name_isValid;
}

QString OAIGetOGResponse::getColor() const {
    return m_color;
}
void OAIGetOGResponse::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAIGetOGResponse::is_color_Set() const{
    return m_color_isSet;
}

bool OAIGetOGResponse::is_color_Valid() const{
    return m_color_isValid;
}

QString OAIGetOGResponse::getDuration() const {
    return m_duration;
}
void OAIGetOGResponse::setDuration(const QString &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIGetOGResponse::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIGetOGResponse::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAIGetOGResponse::getFallback() const {
    return m_fallback;
}
void OAIGetOGResponse::setFallback(const QString &fallback) {
    m_fallback = fallback;
    m_fallback_isSet = true;
}

bool OAIGetOGResponse::is_fallback_Set() const{
    return m_fallback_isSet;
}

bool OAIGetOGResponse::is_fallback_Valid() const{
    return m_fallback_isValid;
}

QList<OAIField> OAIGetOGResponse::getFields() const {
    return m_fields;
}
void OAIGetOGResponse::setFields(const QList<OAIField> &fields) {
    m_fields = fields;
    m_fields_isSet = true;
}

bool OAIGetOGResponse::is_fields_Set() const{
    return m_fields_isSet;
}

bool OAIGetOGResponse::is_fields_Valid() const{
    return m_fields_isValid;
}

QString OAIGetOGResponse::getFooter() const {
    return m_footer;
}
void OAIGetOGResponse::setFooter(const QString &footer) {
    m_footer = footer;
    m_footer_isSet = true;
}

bool OAIGetOGResponse::is_footer_Set() const{
    return m_footer_isSet;
}

bool OAIGetOGResponse::is_footer_Valid() const{
    return m_footer_isValid;
}

QString OAIGetOGResponse::getFooterIcon() const {
    return m_footer_icon;
}
void OAIGetOGResponse::setFooterIcon(const QString &footer_icon) {
    m_footer_icon = footer_icon;
    m_footer_icon_isSet = true;
}

bool OAIGetOGResponse::is_footer_icon_Set() const{
    return m_footer_icon_isSet;
}

bool OAIGetOGResponse::is_footer_icon_Valid() const{
    return m_footer_icon_isValid;
}

OAIImages OAIGetOGResponse::getGiphy() const {
    return m_giphy;
}
void OAIGetOGResponse::setGiphy(const OAIImages &giphy) {
    m_giphy = giphy;
    m_giphy_isSet = true;
}

bool OAIGetOGResponse::is_giphy_Set() const{
    return m_giphy_isSet;
}

bool OAIGetOGResponse::is_giphy_Valid() const{
    return m_giphy_isValid;
}

QString OAIGetOGResponse::getImageUrl() const {
    return m_image_url;
}
void OAIGetOGResponse::setImageUrl(const QString &image_url) {
    m_image_url = image_url;
    m_image_url_isSet = true;
}

bool OAIGetOGResponse::is_image_url_Set() const{
    return m_image_url_isSet;
}

bool OAIGetOGResponse::is_image_url_Valid() const{
    return m_image_url_isValid;
}

QString OAIGetOGResponse::getOgScrapeUrl() const {
    return m_og_scrape_url;
}
void OAIGetOGResponse::setOgScrapeUrl(const QString &og_scrape_url) {
    m_og_scrape_url = og_scrape_url;
    m_og_scrape_url_isSet = true;
}

bool OAIGetOGResponse::is_og_scrape_url_Set() const{
    return m_og_scrape_url_isSet;
}

bool OAIGetOGResponse::is_og_scrape_url_Valid() const{
    return m_og_scrape_url_isValid;
}

qint32 OAIGetOGResponse::getOriginalHeight() const {
    return m_original_height;
}
void OAIGetOGResponse::setOriginalHeight(const qint32 &original_height) {
    m_original_height = original_height;
    m_original_height_isSet = true;
}

bool OAIGetOGResponse::is_original_height_Set() const{
    return m_original_height_isSet;
}

bool OAIGetOGResponse::is_original_height_Valid() const{
    return m_original_height_isValid;
}

qint32 OAIGetOGResponse::getOriginalWidth() const {
    return m_original_width;
}
void OAIGetOGResponse::setOriginalWidth(const qint32 &original_width) {
    m_original_width = original_width;
    m_original_width_isSet = true;
}

bool OAIGetOGResponse::is_original_width_Set() const{
    return m_original_width_isSet;
}

bool OAIGetOGResponse::is_original_width_Valid() const{
    return m_original_width_isValid;
}

QString OAIGetOGResponse::getPretext() const {
    return m_pretext;
}
void OAIGetOGResponse::setPretext(const QString &pretext) {
    m_pretext = pretext;
    m_pretext_isSet = true;
}

bool OAIGetOGResponse::is_pretext_Set() const{
    return m_pretext_isSet;
}

bool OAIGetOGResponse::is_pretext_Valid() const{
    return m_pretext_isValid;
}

QString OAIGetOGResponse::getText() const {
    return m_text;
}
void OAIGetOGResponse::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIGetOGResponse::is_text_Set() const{
    return m_text_isSet;
}

bool OAIGetOGResponse::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIGetOGResponse::getThumbUrl() const {
    return m_thumb_url;
}
void OAIGetOGResponse::setThumbUrl(const QString &thumb_url) {
    m_thumb_url = thumb_url;
    m_thumb_url_isSet = true;
}

bool OAIGetOGResponse::is_thumb_url_Set() const{
    return m_thumb_url_isSet;
}

bool OAIGetOGResponse::is_thumb_url_Valid() const{
    return m_thumb_url_isValid;
}

QString OAIGetOGResponse::getTitle() const {
    return m_title;
}
void OAIGetOGResponse::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIGetOGResponse::is_title_Set() const{
    return m_title_isSet;
}

bool OAIGetOGResponse::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIGetOGResponse::getTitleLink() const {
    return m_title_link;
}
void OAIGetOGResponse::setTitleLink(const QString &title_link) {
    m_title_link = title_link;
    m_title_link_isSet = true;
}

bool OAIGetOGResponse::is_title_link_Set() const{
    return m_title_link_isSet;
}

bool OAIGetOGResponse::is_title_link_Valid() const{
    return m_title_link_isValid;
}

QString OAIGetOGResponse::getType() const {
    return m_type;
}
void OAIGetOGResponse::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGetOGResponse::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGetOGResponse::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIGetOGResponse::isSet() const {
...
bool OAIGetOGResponse::isValid() const {
