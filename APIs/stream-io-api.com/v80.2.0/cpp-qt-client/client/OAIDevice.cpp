...
QDateTime OAIDevice::getCreatedAt() const {
    return m_created_at;
}
void OAIDevice::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDevice::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDevice::is_created_at_Valid() const{
...
QString OAIDevice::getDisabledReason() const {
    return m_disabled_reason;
}
void OAIDevice::setDisabledReason(const QString &disabled_reason) {
    m_disabled_reason = disabled_reason;
    m_disabled_reason_isSet = true;
}

bool OAIDevice::is_disabled_reason_Set() const{
    return m_disabled_reason_isSet;
}

bool OAIDevice::is_disabled_reason_Valid() const{
...
QString OAIDevice::getPushProvider() const {
    return m_push_provider;
}
void OAIDevice::setPushProvider(const QString &push_provider) {
    m_push_provider = push_provider;
    m_push_provider_isSet = true;
}

bool OAIDevice::is_push_provider_Set() const{
    return m_push_provider_isSet;
}

bool OAIDevice::is_push_provider_Valid() const{
    return m_push_provider_isValid;
}

QString OAIDevice::getPushProviderName() const {
    return m_push_provider_name;
}
void OAIDevice::setPushProviderName(const QString &push_provider_name) {
    m_push_provider_name = push_provider_name;
    m_push_provider_name_isSet = true;
}

bool OAIDevice::is_push_provider_name_Set() const{
    return m_push_provider_name_isSet;
}

bool OAIDevice::is_push_provider_name_Valid() const{
    return m_push_provider_name_isValid;
}

QString OAIDevice::getUserId() const {
    return m_user_id;
}
void OAIDevice::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIDevice::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIDevice::is_user_id_Valid() const{
...
bool OAIDevice::isValid() const {
    ...
    return m_created_at_isValid && m_id_isValid && m_push_provider_isValid && m_user_id_isValid && true;
}
