...
#ifndef OAIChannelConfig_H
#define OAIChannelConfig_H
...
class OAIChannelConfig : public OAIObject {
public:
    OAIChannelConfig();
    OAIChannelConfig(QString json);
    ~OAIChannelConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelConfig)

#endif // OAIChannelConfig_H
