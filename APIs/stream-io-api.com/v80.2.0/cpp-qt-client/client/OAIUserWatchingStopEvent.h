...
/*
 * OAIUserWatchingStopEvent.h
 *
 * 
 */

#ifndef OAIUserWatchingStopEvent_H
#define OAIUserWatchingStopEvent_H
...
class OAIUserWatchingStopEvent : public OAIObject {
public:
    OAIUserWatchingStopEvent();
    OAIUserWatchingStopEvent(QString json);
    ~OAIUserWatchingStopEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserWatchingStopEvent)

#endif // OAIUserWatchingStopEvent_H
