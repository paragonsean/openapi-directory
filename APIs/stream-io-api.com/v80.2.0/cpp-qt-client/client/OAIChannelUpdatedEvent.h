...
/*
 * OAIChannelUpdatedEvent.h
 *
 * 
 */

#ifndef OAIChannelUpdatedEvent_H
#define OAIChannelUpdatedEvent_H
...
class OAIChannelUpdatedEvent : public OAIObject {
public:
    OAIChannelUpdatedEvent();
    OAIChannelUpdatedEvent(QString json);
    ~OAIChannelUpdatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelUpdatedEvent)

#endif // OAIChannelUpdatedEvent_H
