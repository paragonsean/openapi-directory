...
/*
 * OAIChannelKickedEvent.h
 *
 * 
 */

#ifndef OAIChannelKickedEvent_H
#define OAIChannelKickedEvent_H
...
class OAIChannelKickedEvent : public OAIObject {
public:
    OAIChannelKickedEvent();
    OAIChannelKickedEvent(QString json);
    ~OAIChannelKickedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelKickedEvent)

#endif // OAIChannelKickedEvent_H
