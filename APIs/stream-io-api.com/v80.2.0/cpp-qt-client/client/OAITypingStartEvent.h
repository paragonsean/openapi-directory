...
/*
 * OAITypingStartEvent.h
 *
 * 
 */

#ifndef OAITypingStartEvent_H
#define OAITypingStartEvent_H
...
class OAITypingStartEvent : public OAIObject {
public:
    OAITypingStartEvent();
    OAITypingStartEvent(QString json);
    ~OAITypingStartEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITypingStartEvent)

#endif // OAITypingStartEvent_H
