...
/*
 * OAINotificationInvitedEvent.h
 *
 * 
 */

#ifndef OAINotificationInvitedEvent_H
#define OAINotificationInvitedEvent_H
...
class OAINotificationInvitedEvent : public OAIObject {
public:
    OAINotificationInvitedEvent();
    OAINotificationInvitedEvent(QString json);
    ~OAINotificationInvitedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationInvitedEvent)

#endif // OAINotificationInvitedEvent_H
