...
/*
 * OAINotificationInviteAcceptedEvent.h
 *
 * 
 */

#ifndef OAINotificationInviteAcceptedEvent_H
#define OAINotificationInviteAcceptedEvent_H
...
class OAINotificationInviteAcceptedEvent : public OAIObject {
public:
    OAINotificationInviteAcceptedEvent();
    OAINotificationInviteAcceptedEvent(QString json);
    ~OAINotificationInviteAcceptedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationInviteAcceptedEvent)

#endif // OAINotificationInviteAcceptedEvent_H
