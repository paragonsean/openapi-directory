...
/*
 * OAINotificationAddedToChannelEvent.h
 *
 * 
 */

#ifndef OAINotificationAddedToChannelEvent_H
#define OAINotificationAddedToChannelEvent_H
...
class OAINotificationAddedToChannelEvent : public OAIObject {
public:
    OAINotificationAddedToChannelEvent();
    OAINotificationAddedToChannelEvent(QString json);
    ~OAINotificationAddedToChannelEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationAddedToChannelEvent)

#endif // OAINotificationAddedToChannelEvent_H
