...
#ifndef OAIUserMutedEvent_H
#define OAIUserMutedEvent_H
...
class OAIUserMutedEvent : public OAIObject {
public:
    OAIUserMutedEvent();
    OAIUserMutedEvent(QString json);
    ~OAIUserMutedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserMutedEvent)

#endif // OAIUserMutedEvent_H
