...
QString OAIConfig::getAppCertificate() const {
    return m_app_certificate;
}
void OAIConfig::setAppCertificate(const QString &app_certificate) {
    m_app_certificate = app_certificate;
    m_app_certificate_isSet = true;
}

bool OAIConfig::is_app_certificate_Set() const{
    return m_app_certificate_isSet;
}

bool OAIConfig::is_app_certificate_Valid() const{
    return m_app_certificate_isValid;
}

QString OAIConfig::getAppId() const {
    return m_app_id;
}
void OAIConfig::setAppId(const QString &app_id) {
    m_app_id = app_id;
    m_app_id_isSet = true;
}

bool OAIConfig::is_app_id_Set() const{
    return m_app_id_isSet;
}

bool OAIConfig::is_app_id_Valid() const{
    return m_app_id_isValid;
}

QString OAIConfig::getDefaultRole() const {
    return m_default_role;
}
void OAIConfig::setDefaultRole(const QString &default_role) {
    m_default_role = default_role;
    m_default_role_isSet = true;
}

bool OAIConfig::is_default_role_Set() const{
    return m_default_role_isSet;
}

bool OAIConfig::is_default_role_Valid() const{
    return m_default_role_isValid;
}

QMap<QString, QString> OAIConfig::getRoleMap() const {
    return m_role_map;
}
void OAIConfig::setRoleMap(const QMap<QString, QString> &role_map) {
    m_role_map = role_map;
    m_role_map_isSet = true;
}

bool OAIConfig::is_role_map_Set() const{
    return m_role_map_isSet;
}

bool OAIConfig::is_role_map_Valid() const{
