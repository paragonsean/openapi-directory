...
OAIUpdateChannelTypeRequest::OAIUpdateChannelTypeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateChannelTypeRequest::OAIUpdateChannelTypeRequest() {
    this->initializeModel();
}

OAIUpdateChannelTypeRequest::~OAIUpdateChannelTypeRequest() {}

void OAIUpdateChannelTypeRequest::initializeModel() {

    m_name_from_path_isSet = false;
    m_name_from_path_isValid = false;
...
void OAIUpdateChannelTypeRequest::fromJson(QString jsonString) {
...
void OAIUpdateChannelTypeRequest::fromJsonObject(QJsonObject json) {

    m_name_from_path_isValid = ::OpenAPI::fromJsonValue(m_name_from_path, json[QString("NameFromPath")]);
    m_name_from_path_isSet = !json[QString("NameFromPath")].isNull() && m_name_from_path_isValid;
...
QString OAIUpdateChannelTypeRequest::asJson() const {
...
QJsonObject OAIUpdateChannelTypeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_from_path_isSet) {
        obj.insert(QString("NameFromPath"), ::OpenAPI::toJsonValue(m_name_from_path));
    }
    if (m_automod_isSet) {
...
QString OAIUpdateChannelTypeRequest::getNameFromPath() const {
    return m_name_from_path;
}
void OAIUpdateChannelTypeRequest::setNameFromPath(const QString &name_from_path) {
    m_name_from_path = name_from_path;
    m_name_from_path_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_name_from_path_Set() const{
    return m_name_from_path_isSet;
}

bool OAIUpdateChannelTypeRequest::is_name_from_path_Valid() const{
    return m_name_from_path_isValid;
}

QString OAIUpdateChannelTypeRequest::getAutomod() const {
    return m_automod;
}
void OAIUpdateChannelTypeRequest::setAutomod(const QString &automod) {
    m_automod = automod;
    m_automod_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_automod_Set() const{
    return m_automod_isSet;
}

bool OAIUpdateChannelTypeRequest::is_automod_Valid() const{
    return m_automod_isValid;
}

QString OAIUpdateChannelTypeRequest::getAutomodBehavior() const {
    return m_automod_behavior;
}
void OAIUpdateChannelTypeRequest::setAutomodBehavior(const QString &automod_behavior) {
    m_automod_behavior = automod_behavior;
    m_automod_behavior_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_automod_behavior_Set() const{
    return m_automod_behavior_isSet;
}

bool OAIUpdateChannelTypeRequest::is_automod_behavior_Valid() const{
    return m_automod_behavior_isValid;
}

OAIThresholdsRequest OAIUpdateChannelTypeRequest::getAutomodThresholds() const {
    return m_automod_thresholds;
}
void OAIUpdateChannelTypeRequest::setAutomodThresholds(const OAIThresholdsRequest &automod_thresholds) {
    m_automod_thresholds = automod_thresholds;
    m_automod_thresholds_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_automod_thresholds_Set() const{
    return m_automod_thresholds_isSet;
}

bool OAIUpdateChannelTypeRequest::is_automod_thresholds_Valid() const{
    return m_automod_thresholds_isValid;
}

QString OAIUpdateChannelTypeRequest::getBlocklist() const {
    return m_blocklist;
}
void OAIUpdateChannelTypeRequest::setBlocklist(const QString &blocklist) {
    m_blocklist = blocklist;
    m_blocklist_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_blocklist_Set() const{
    return m_blocklist_isSet;
}

bool OAIUpdateChannelTypeRequest::is_blocklist_Valid() const{
    return m_blocklist_isValid;
}

QString OAIUpdateChannelTypeRequest::getBlocklistBehavior() const {
    return m_blocklist_behavior;
}
void OAIUpdateChannelTypeRequest::setBlocklistBehavior(const QString &blocklist_behavior) {
    m_blocklist_behavior = blocklist_behavior;
    m_blocklist_behavior_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_blocklist_behavior_Set() const{
    return m_blocklist_behavior_isSet;
}

bool OAIUpdateChannelTypeRequest::is_blocklist_behavior_Valid() const{
    return m_blocklist_behavior_isValid;
}

QList<QString> OAIUpdateChannelTypeRequest::getCommands() const {
    return m_commands;
}
void OAIUpdateChannelTypeRequest::setCommands(const QList<QString> &commands) {
    m_commands = commands;
    m_commands_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_commands_Set() const{
    return m_commands_isSet;
}

bool OAIUpdateChannelTypeRequest::is_commands_Valid() const{
    return m_commands_isValid;
}

bool OAIUpdateChannelTypeRequest::isConnectEvents() const {
    return m_connect_events;
}
void OAIUpdateChannelTypeRequest::setConnectEvents(const bool &connect_events) {
    m_connect_events = connect_events;
    m_connect_events_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_connect_events_Set() const{
    return m_connect_events_isSet;
}

bool OAIUpdateChannelTypeRequest::is_connect_events_Valid() const{
    return m_connect_events_isValid;
}

bool OAIUpdateChannelTypeRequest::isCustomEvents() const {
    return m_custom_events;
}
void OAIUpdateChannelTypeRequest::setCustomEvents(const bool &custom_events) {
    m_custom_events = custom_events;
    m_custom_events_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_custom_events_Set() const{
    return m_custom_events_isSet;
}

bool OAIUpdateChannelTypeRequest::is_custom_events_Valid() const{
    return m_custom_events_isValid;
}

QMap<QString, QList<QString>> OAIUpdateChannelTypeRequest::getGrants() const {
    return m_grants;
}
void OAIUpdateChannelTypeRequest::setGrants(const QMap<QString, QList<QString>> &grants) {
    m_grants = grants;
    m_grants_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_grants_Set() const{
    return m_grants_isSet;
}

bool OAIUpdateChannelTypeRequest::is_grants_Valid() const{
    return m_grants_isValid;
}

qint32 OAIUpdateChannelTypeRequest::getMaxMessageLength() const {
    return m_max_message_length;
}
void OAIUpdateChannelTypeRequest::setMaxMessageLength(const qint32 &max_message_length) {
    m_max_message_length = max_message_length;
    m_max_message_length_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_max_message_length_Set() const{
    return m_max_message_length_isSet;
}

bool OAIUpdateChannelTypeRequest::is_max_message_length_Valid() const{
    return m_max_message_length_isValid;
}

QString OAIUpdateChannelTypeRequest::getMessageRetention() const {
    return m_message_retention;
}
void OAIUpdateChannelTypeRequest::setMessageRetention(const QString &message_retention) {
    m_message_retention = message_retention;
    m_message_retention_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_message_retention_Set() const{
    return m_message_retention_isSet;
}

bool OAIUpdateChannelTypeRequest::is_message_retention_Valid() const{
    return m_message_retention_isValid;
}

bool OAIUpdateChannelTypeRequest::isMutes() const {
    return m_mutes;
}
void OAIUpdateChannelTypeRequest::setMutes(const bool &mutes) {
    m_mutes = mutes;
    m_mutes_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_mutes_Set() const{
    return m_mutes_isSet;
}

bool OAIUpdateChannelTypeRequest::is_mutes_Valid() const{
    return m_mutes_isValid;
}

QList<OAIPolicyRequest> OAIUpdateChannelTypeRequest::getPermissions() const {
    return m_permissions;
}
void OAIUpdateChannelTypeRequest::setPermissions(const QList<OAIPolicyRequest> &permissions) {
    m_permissions = permissions;
    m_permissions_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_permissions_Set() const{
    return m_permissions_isSet;
}

bool OAIUpdateChannelTypeRequest::is_permissions_Valid() const{
    return m_permissions_isValid;
}

bool OAIUpdateChannelTypeRequest::isPushNotifications() const {
    return m_push_notifications;
}
void OAIUpdateChannelTypeRequest::setPushNotifications(const bool &push_notifications) {
    m_push_notifications = push_notifications;
    m_push_notifications_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_push_notifications_Set() const{
    return m_push_notifications_isSet;
}

bool OAIUpdateChannelTypeRequest::is_push_notifications_Valid() const{
    return m_push_notifications_isValid;
}

bool OAIUpdateChannelTypeRequest::isQuotes() const {
    return m_quotes;
}
void OAIUpdateChannelTypeRequest::setQuotes(const bool &quotes) {
    m_quotes = quotes;
    m_quotes_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_quotes_Set() const{
    return m_quotes_isSet;
}

bool OAIUpdateChannelTypeRequest::is_quotes_Valid() const{
    return m_quotes_isValid;
}

bool OAIUpdateChannelTypeRequest::isReactions() const {
    return m_reactions;
}
void OAIUpdateChannelTypeRequest::setReactions(const bool &reactions) {
    m_reactions = reactions;
    m_reactions_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_reactions_Set() const{
    return m_reactions_isSet;
}

bool OAIUpdateChannelTypeRequest::is_reactions_Valid() const{
    return m_reactions_isValid;
}

bool OAIUpdateChannelTypeRequest::isReadEvents() const {
    return m_read_events;
}
void OAIUpdateChannelTypeRequest::setReadEvents(const bool &read_events) {
    m_read_events = read_events;
    m_read_events_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_read_events_Set() const{
    return m_read_events_isSet;
}

bool OAIUpdateChannelTypeRequest::is_read_events_Valid() const{
    return m_read_events_isValid;
}

bool OAIUpdateChannelTypeRequest::isReminders() const {
    return m_reminders;
}
void OAIUpdateChannelTypeRequest::setReminders(const bool &reminders) {
    m_reminders = reminders;
    m_reminders_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_reminders_Set() const{
    return m_reminders_isSet;
}

bool OAIUpdateChannelTypeRequest::is_reminders_Valid() const{
    return m_reminders_isValid;
}

bool OAIUpdateChannelTypeRequest::isReplies() const {
    return m_replies;
}
void OAIUpdateChannelTypeRequest::setReplies(const bool &replies) {
    m_replies = replies;
    m_replies_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_replies_Set() const{
    return m_replies_isSet;
}

bool OAIUpdateChannelTypeRequest::is_replies_Valid() const{
    return m_replies_isValid;
}

bool OAIUpdateChannelTypeRequest::isSearch() const {
    return m_search;
}
void OAIUpdateChannelTypeRequest::setSearch(const bool &search) {
    m_search = search;
    m_search_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_search_Set() const{
    return m_search_isSet;
}

bool OAIUpdateChannelTypeRequest::is_search_Valid() const{
    return m_search_isValid;
}

bool OAIUpdateChannelTypeRequest::isTypingEvents() const {
    return m_typing_events;
}
void OAIUpdateChannelTypeRequest::setTypingEvents(const bool &typing_events) {
    m_typing_events = typing_events;
    m_typing_events_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_typing_events_Set() const{
    return m_typing_events_isSet;
}

bool OAIUpdateChannelTypeRequest::is_typing_events_Valid() const{
    return m_typing_events_isValid;
}

bool OAIUpdateChannelTypeRequest::isUploads() const {
    return m_uploads;
}
void OAIUpdateChannelTypeRequest::setUploads(const bool &uploads) {
    m_uploads = uploads;
    m_uploads_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_uploads_Set() const{
    return m_uploads_isSet;
}

bool OAIUpdateChannelTypeRequest::is_uploads_Valid() const{
    return m_uploads_isValid;
}

bool OAIUpdateChannelTypeRequest::isUrlEnrichment() const {
    return m_url_enrichment;
}
void OAIUpdateChannelTypeRequest::setUrlEnrichment(const bool &url_enrichment) {
    m_url_enrichment = url_enrichment;
    m_url_enrichment_isSet = true;
}

bool OAIUpdateChannelTypeRequest::is_url_enrichment_Set() const{
    return m_url_enrichment_isSet;
}

bool OAIUpdateChannelTypeRequest::is_url_enrichment_Valid() const{
    return m_url_enrichment_isValid;
}

bool OAIUpdateChannelTypeRequest::isSet() const {
...
bool OAIUpdateChannelTypeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_automod_isValid && true;
}
