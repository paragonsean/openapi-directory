...
/*
 * OAIMemberUpdatedEvent.h
 *
 * 
 */

#ifndef OAIMemberUpdatedEvent_H
#define OAIMemberUpdatedEvent_H
...
class OAIMemberUpdatedEvent : public OAIObject {
public:
    OAIMemberUpdatedEvent();
    OAIMemberUpdatedEvent(QString json);
    ~OAIMemberUpdatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberUpdatedEvent)

#endif // OAIMemberUpdatedEvent_H
