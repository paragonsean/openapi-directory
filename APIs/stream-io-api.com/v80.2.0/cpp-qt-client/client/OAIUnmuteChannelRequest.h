...
/*
 * OAIUnmuteChannelRequest.h
 *
 * 
 */

#ifndef OAIUnmuteChannelRequest_H
#define OAIUnmuteChannelRequest_H
...
class OAIUnmuteChannelRequest : public OAIObject {
public:
    OAIUnmuteChannelRequest();
    OAIUnmuteChannelRequest(QString json);
    ~OAIUnmuteChannelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnmuteChannelRequest)

#endif // OAIUnmuteChannelRequest_H
