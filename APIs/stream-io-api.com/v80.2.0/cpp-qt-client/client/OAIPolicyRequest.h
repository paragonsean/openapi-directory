...
#ifndef OAIPolicyRequest_H
#define OAIPolicyRequest_H
...
class OAIPolicyRequest : public OAIObject {
public:
    OAIPolicyRequest();
    OAIPolicyRequest(QString json);
    ~OAIPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyRequest)

#endif // OAIPolicyRequest_H
