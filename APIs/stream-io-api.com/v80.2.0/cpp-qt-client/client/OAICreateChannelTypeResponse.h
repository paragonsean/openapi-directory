...
/*
 * OAICreateChannelTypeResponse.h
 *
 * 
 */

#ifndef OAICreateChannelTypeResponse_H
#define OAICreateChannelTypeResponse_H
...
class OAICreateChannelTypeResponse : public OAIObject {
public:
    OAICreateChannelTypeResponse();
    OAICreateChannelTypeResponse(QString json);
    ~OAICreateChannelTypeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelTypeResponse)

#endif // OAICreateChannelTypeResponse_H
