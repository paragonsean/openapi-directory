...
#ifndef OAIChannelMember_H
#define OAIChannelMember_H
...
class OAIChannelMember : public OAIObject {
public:
    OAIChannelMember();
    OAIChannelMember(QString json);
    ~OAIChannelMember() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelMember)

#endif // OAIChannelMember_H
