...
/*
 * OAICampaignUpdateableFieldsRequest.h
 *
 * 
 */

#ifndef OAICampaignUpdateableFieldsRequest_H
#define OAICampaignUpdateableFieldsRequest_H
...
class OAICampaignUpdateableFieldsRequest : public OAIObject {
public:
    OAICampaignUpdateableFieldsRequest();
    OAICampaignUpdateableFieldsRequest(QString json);
    ~OAICampaignUpdateableFieldsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignUpdateableFieldsRequest)

#endif // OAICampaignUpdateableFieldsRequest_H
