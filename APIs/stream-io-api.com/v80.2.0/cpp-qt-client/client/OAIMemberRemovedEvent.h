...
/*
 * OAIMemberRemovedEvent.h
 *
 * 
 */

#ifndef OAIMemberRemovedEvent_H
#define OAIMemberRemovedEvent_H
...
class OAIMemberRemovedEvent : public OAIObject {
public:
    OAIMemberRemovedEvent();
    OAIMemberRemovedEvent(QString json);
    ~OAIMemberRemovedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberRemovedEvent)

#endif // OAIMemberRemovedEvent_H
