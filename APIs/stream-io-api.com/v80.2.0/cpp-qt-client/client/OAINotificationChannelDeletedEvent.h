...
/*
 * OAINotificationChannelDeletedEvent.h
 *
 * 
 */

#ifndef OAINotificationChannelDeletedEvent_H
#define OAINotificationChannelDeletedEvent_H
...
class OAINotificationChannelDeletedEvent : public OAIObject {
public:
    OAINotificationChannelDeletedEvent();
    OAINotificationChannelDeletedEvent(QString json);
    ~OAINotificationChannelDeletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationChannelDeletedEvent)

#endif // OAINotificationChannelDeletedEvent_H
