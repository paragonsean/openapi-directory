...
/*
 * OAINotificationMarkUnreadEvent.h
 *
 * 
 */

#ifndef OAINotificationMarkUnreadEvent_H
#define OAINotificationMarkUnreadEvent_H
...
class OAINotificationMarkUnreadEvent : public OAIObject {
public:
    OAINotificationMarkUnreadEvent();
    OAINotificationMarkUnreadEvent(QString json);
    ~OAINotificationMarkUnreadEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationMarkUnreadEvent)

#endif // OAINotificationMarkUnreadEvent_H
