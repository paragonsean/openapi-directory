...
/*
 * OAINotificationNewMessageEvent.h
 *
 * 
 */

#ifndef OAINotificationNewMessageEvent_H
#define OAINotificationNewMessageEvent_H
...
class OAINotificationNewMessageEvent : public OAIObject {
public:
    OAINotificationNewMessageEvent();
    OAINotificationNewMessageEvent(QString json);
    ~OAINotificationNewMessageEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationNewMessageEvent)

#endif // OAINotificationNewMessageEvent_H
