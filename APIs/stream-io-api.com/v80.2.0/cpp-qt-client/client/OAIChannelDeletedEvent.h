...
/*
 * OAIChannelDeletedEvent.h
 *
 * 
 */

#ifndef OAIChannelDeletedEvent_H
#define OAIChannelDeletedEvent_H
...
class OAIChannelDeletedEvent : public OAIObject {
public:
    OAIChannelDeletedEvent();
    OAIChannelDeletedEvent(QString json);
    ~OAIChannelDeletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelDeletedEvent)

#endif // OAIChannelDeletedEvent_H
