...
/*
 * OAIChannelUnFrozenEvent.h
 *
 * 
 */

#ifndef OAIChannelUnFrozenEvent_H
#define OAIChannelUnFrozenEvent_H
...
class OAIChannelUnFrozenEvent : public OAIObject {
public:
    OAIChannelUnFrozenEvent();
    OAIChannelUnFrozenEvent(QString json);
    ~OAIChannelUnFrozenEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelUnFrozenEvent)

#endif // OAIChannelUnFrozenEvent_H
