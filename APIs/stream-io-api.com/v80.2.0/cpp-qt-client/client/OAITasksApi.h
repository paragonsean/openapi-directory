...
public:
    ...
    */
    virtual void getTask(const QString &id);
...
Q_SIGNALS:
    ...
    void getTaskSignal(OAIGetTaskResponse summary);


    void getTaskSignalFull(OAIHttpRequestWorker *worker, OAIGetTaskResponse summary);

    Q_DECL_DEPRECATED_X("Use getTaskSignalError() instead")
    void getTaskSignalE(OAIGetTaskResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTaskSignalError(OAIGetTaskResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
