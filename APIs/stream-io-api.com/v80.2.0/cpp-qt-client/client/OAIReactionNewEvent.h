...
/*
 * OAIReactionNewEvent.h
 *
 * 
 */

#ifndef OAIReactionNewEvent_H
#define OAIReactionNewEvent_H
...
class OAIReactionNewEvent : public OAIObject {
public:
    OAIReactionNewEvent();
    OAIReactionNewEvent(QString json);
    ~OAIReactionNewEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactionNewEvent)

#endif // OAIReactionNewEvent_H
