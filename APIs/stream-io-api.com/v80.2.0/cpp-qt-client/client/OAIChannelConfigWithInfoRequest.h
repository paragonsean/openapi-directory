...
/*
 * OAIChannelConfigWithInfoRequest.h
 *
 * 
 */

#ifndef OAIChannelConfigWithInfoRequest_H
#define OAIChannelConfigWithInfoRequest_H
...
class OAICommandRequest;

class OAIChannelConfigWithInfoRequest : public OAIObject {
public:
    OAIChannelConfigWithInfoRequest();
    OAIChannelConfigWithInfoRequest(QString json);
    ~OAIChannelConfigWithInfoRequest() override;
    ...
    QList<OAICommandRequest> getCommands() const;
    void setCommands(const QList<OAICommandRequest> &commands);
...
private:
    ...
    QList<OAICommandRequest> m_commands;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelConfigWithInfoRequest)

#endif // OAIChannelConfigWithInfoRequest_H
