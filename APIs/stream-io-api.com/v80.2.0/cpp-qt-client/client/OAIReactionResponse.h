...
/*
 * OAIReactionResponse.h
 *
 * 
 */

#ifndef OAIReactionResponse_H
#define OAIReactionResponse_H
...
class OAIReactionResponse : public OAIObject {
public:
    OAIReactionResponse();
    OAIReactionResponse(QString json);
    ~OAIReactionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactionResponse)

#endif // OAIReactionResponse_H
