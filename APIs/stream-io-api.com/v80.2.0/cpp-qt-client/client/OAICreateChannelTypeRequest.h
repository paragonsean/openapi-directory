...
/*
 * OAICreateChannelTypeRequest.h
 *
 * 
 */

#ifndef OAICreateChannelTypeRequest_H
#define OAICreateChannelTypeRequest_H
...
class OAICreateChannelTypeRequest : public OAIObject {
public:
    OAICreateChannelTypeRequest();
    OAICreateChannelTypeRequest(QString json);
    ~OAICreateChannelTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelTypeRequest)

#endif // OAICreateChannelTypeRequest_H
