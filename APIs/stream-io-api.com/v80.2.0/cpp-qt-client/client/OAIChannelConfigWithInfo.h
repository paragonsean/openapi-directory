...
/*
 * OAIChannelConfigWithInfo.h
 *
 * 
 */

#ifndef OAIChannelConfigWithInfo_H
#define OAIChannelConfigWithInfo_H
...
class OAIChannelConfigWithInfo : public OAIObject {
public:
    OAIChannelConfigWithInfo();
    OAIChannelConfigWithInfo(QString json);
    ~OAIChannelConfigWithInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelConfigWithInfo)

#endif // OAIChannelConfigWithInfo_H
