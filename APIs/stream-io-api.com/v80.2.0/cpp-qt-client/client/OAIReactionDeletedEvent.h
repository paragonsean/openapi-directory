...
/*
 * OAIReactionDeletedEvent.h
 *
 * 
 */

#ifndef OAIReactionDeletedEvent_H
#define OAIReactionDeletedEvent_H
...
class OAIReactionDeletedEvent : public OAIObject {
public:
    OAIReactionDeletedEvent();
    OAIReactionDeletedEvent(QString json);
    ~OAIReactionDeletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactionDeletedEvent)

#endif // OAIReactionDeletedEvent_H
