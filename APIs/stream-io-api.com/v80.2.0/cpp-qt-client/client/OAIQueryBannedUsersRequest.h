...
/*
 * OAIQueryBannedUsersRequest.h
 *
 * 
 */

#ifndef OAIQueryBannedUsersRequest_H
#define OAIQueryBannedUsersRequest_H
...
class OAIQueryBannedUsersRequest : public OAIObject {
public:
    OAIQueryBannedUsersRequest();
    OAIQueryBannedUsersRequest(QString json);
    ~OAIQueryBannedUsersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryBannedUsersRequest)

#endif // OAIQueryBannedUsersRequest_H
