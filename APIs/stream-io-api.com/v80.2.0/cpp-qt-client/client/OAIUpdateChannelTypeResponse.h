...
/*
 * OAIUpdateChannelTypeResponse.h
 *
 * 
 */

#ifndef OAIUpdateChannelTypeResponse_H
#define OAIUpdateChannelTypeResponse_H
...
class OAIUpdateChannelTypeResponse : public OAIObject {
public:
    OAIUpdateChannelTypeResponse();
    OAIUpdateChannelTypeResponse(QString json);
    ~OAIUpdateChannelTypeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannelTypeResponse)

#endif // OAIUpdateChannelTypeResponse_H
