...
/*
 * OAIMarkUnreadRequest.h
 *
 * 
 */

#ifndef OAIMarkUnreadRequest_H
#define OAIMarkUnreadRequest_H
...
class OAIMarkUnreadRequest : public OAIObject {
public:
    OAIMarkUnreadRequest();
    OAIMarkUnreadRequest(QString json);
    ~OAIMarkUnreadRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarkUnreadRequest)

#endif // OAIMarkUnreadRequest_H
