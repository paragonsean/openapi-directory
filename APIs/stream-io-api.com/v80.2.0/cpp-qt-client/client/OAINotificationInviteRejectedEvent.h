...
/*
 * OAINotificationInviteRejectedEvent.h
 *
 * 
 */

#ifndef OAINotificationInviteRejectedEvent_H
#define OAINotificationInviteRejectedEvent_H
...
class OAINotificationInviteRejectedEvent : public OAIObject {
public:
    OAINotificationInviteRejectedEvent();
    OAINotificationInviteRejectedEvent(QString json);
    ~OAINotificationInviteRejectedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationInviteRejectedEvent)

#endif // OAINotificationInviteRejectedEvent_H
