...
/*
 * OAIUserUnmutedEvent.h
 *
 * 
 */

#ifndef OAIUserUnmutedEvent_H
#define OAIUserUnmutedEvent_H
...
class OAIUserUnmutedEvent : public OAIObject {
public:
    OAIUserUnmutedEvent();
    OAIUserUnmutedEvent(QString json);
    ~OAIUserUnmutedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserUnmutedEvent)

#endif // OAIUserUnmutedEvent_H
