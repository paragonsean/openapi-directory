...
OAIPushProvider::OAIPushProvider(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPushProvider::OAIPushProvider() {
    this->initializeModel();
}

OAIPushProvider::~OAIPushProvider() {}

void OAIPushProvider::initializeModel() {
...
void OAIPushProvider::fromJson(QString jsonString) {
...
void OAIPushProvider::fromJsonObject(QJsonObject json) {
...
QString OAIPushProvider::asJson() const {
...
QJsonObject OAIPushProvider::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPushProvider::getApnAuthKey() const {
    return m_apn_auth_key;
}
void OAIPushProvider::setApnAuthKey(const QString &apn_auth_key) {
    m_apn_auth_key = apn_auth_key;
    m_apn_auth_key_isSet = true;
}

bool OAIPushProvider::is_apn_auth_key_Set() const{
    return m_apn_auth_key_isSet;
}

bool OAIPushProvider::is_apn_auth_key_Valid() const{
    return m_apn_auth_key_isValid;
}

QString OAIPushProvider::getApnAuthType() const {
    return m_apn_auth_type;
}
void OAIPushProvider::setApnAuthType(const QString &apn_auth_type) {
    m_apn_auth_type = apn_auth_type;
    m_apn_auth_type_isSet = true;
}

bool OAIPushProvider::is_apn_auth_type_Set() const{
    return m_apn_auth_type_isSet;
}

bool OAIPushProvider::is_apn_auth_type_Valid() const{
    return m_apn_auth_type_isValid;
}

bool OAIPushProvider::isApnDevelopment() const {
    return m_apn_development;
}
void OAIPushProvider::setApnDevelopment(const bool &apn_development) {
    m_apn_development = apn_development;
    m_apn_development_isSet = true;
}

bool OAIPushProvider::is_apn_development_Set() const{
    return m_apn_development_isSet;
}

bool OAIPushProvider::is_apn_development_Valid() const{
    return m_apn_development_isValid;
}

QString OAIPushProvider::getApnHost() const {
    return m_apn_host;
}
void OAIPushProvider::setApnHost(const QString &apn_host) {
    m_apn_host = apn_host;
    m_apn_host_isSet = true;
}

bool OAIPushProvider::is_apn_host_Set() const{
    return m_apn_host_isSet;
}

bool OAIPushProvider::is_apn_host_Valid() const{
    return m_apn_host_isValid;
}

QString OAIPushProvider::getApnKeyId() const {
    return m_apn_key_id;
}
void OAIPushProvider::setApnKeyId(const QString &apn_key_id) {
    m_apn_key_id = apn_key_id;
    m_apn_key_id_isSet = true;
}

bool OAIPushProvider::is_apn_key_id_Set() const{
    return m_apn_key_id_isSet;
}

bool OAIPushProvider::is_apn_key_id_Valid() const{
    return m_apn_key_id_isValid;
}

QString OAIPushProvider::getApnNotificationTemplate() const {
    return m_apn_notification_template;
}
void OAIPushProvider::setApnNotificationTemplate(const QString &apn_notification_template) {
    m_apn_notification_template = apn_notification_template;
    m_apn_notification_template_isSet = true;
}

bool OAIPushProvider::is_apn_notification_template_Set() const{
    return m_apn_notification_template_isSet;
}

bool OAIPushProvider::is_apn_notification_template_Valid() const{
    return m_apn_notification_template_isValid;
}

QString OAIPushProvider::getApnP12Cert() const {
    return m_apn_p12_cert;
}
void OAIPushProvider::setApnP12Cert(const QString &apn_p12_cert) {
    m_apn_p12_cert = apn_p12_cert;
    m_apn_p12_cert_isSet = true;
}

bool OAIPushProvider::is_apn_p12_cert_Set() const{
    return m_apn_p12_cert_isSet;
}

bool OAIPushProvider::is_apn_p12_cert_Valid() const{
    return m_apn_p12_cert_isValid;
}

QString OAIPushProvider::getApnTeamId() const {
    return m_apn_team_id;
}
void OAIPushProvider::setApnTeamId(const QString &apn_team_id) {
    m_apn_team_id = apn_team_id;
    m_apn_team_id_isSet = true;
}

bool OAIPushProvider::is_apn_team_id_Set() const{
    return m_apn_team_id_isSet;
}

bool OAIPushProvider::is_apn_team_id_Valid() const{
    return m_apn_team_id_isValid;
}

QString OAIPushProvider::getApnTopic() const {
    return m_apn_topic;
}
void OAIPushProvider::setApnTopic(const QString &apn_topic) {
    m_apn_topic = apn_topic;
    m_apn_topic_isSet = true;
}

bool OAIPushProvider::is_apn_topic_Set() const{
    return m_apn_topic_isSet;
}

bool OAIPushProvider::is_apn_topic_Valid() const{
    return m_apn_topic_isValid;
}

QDateTime OAIPushProvider::getCreatedAt() const {
    return m_created_at;
}
void OAIPushProvider::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIPushProvider::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIPushProvider::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIPushProvider::getDescription() const {
    return m_description;
}
void OAIPushProvider::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPushProvider::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPushProvider::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIPushProvider::getDisabledAt() const {
    return m_disabled_at;
}
void OAIPushProvider::setDisabledAt(const QDateTime &disabled_at) {
    m_disabled_at = disabled_at;
    m_disabled_at_isSet = true;
}

bool OAIPushProvider::is_disabled_at_Set() const{
    return m_disabled_at_isSet;
}

bool OAIPushProvider::is_disabled_at_Valid() const{
    return m_disabled_at_isValid;
}

QString OAIPushProvider::getDisabledReason() const {
    return m_disabled_reason;
}
void OAIPushProvider::setDisabledReason(const QString &disabled_reason) {
    m_disabled_reason = disabled_reason;
    m_disabled_reason_isSet = true;
}

bool OAIPushProvider::is_disabled_reason_Set() const{
    return m_disabled_reason_isSet;
}

bool OAIPushProvider::is_disabled_reason_Valid() const{
    return m_disabled_reason_isValid;
}

QString OAIPushProvider::getFirebaseApnTemplate() const {
    return m_firebase_apn_template;
}
void OAIPushProvider::setFirebaseApnTemplate(const QString &firebase_apn_template) {
    m_firebase_apn_template = firebase_apn_template;
    m_firebase_apn_template_isSet = true;
}

bool OAIPushProvider::is_firebase_apn_template_Set() const{
    return m_firebase_apn_template_isSet;
}

bool OAIPushProvider::is_firebase_apn_template_Valid() const{
    return m_firebase_apn_template_isValid;
}

QString OAIPushProvider::getFirebaseCredentials() const {
    return m_firebase_credentials;
}
void OAIPushProvider::setFirebaseCredentials(const QString &firebase_credentials) {
    m_firebase_credentials = firebase_credentials;
    m_firebase_credentials_isSet = true;
}

bool OAIPushProvider::is_firebase_credentials_Set() const{
    return m_firebase_credentials_isSet;
}

bool OAIPushProvider::is_firebase_credentials_Valid() const{
    return m_firebase_credentials_isValid;
}

QString OAIPushProvider::getFirebaseDataTemplate() const {
    return m_firebase_data_template;
}
void OAIPushProvider::setFirebaseDataTemplate(const QString &firebase_data_template) {
    m_firebase_data_template = firebase_data_template;
    m_firebase_data_template_isSet = true;
}

bool OAIPushProvider::is_firebase_data_template_Set() const{
    return m_firebase_data_template_isSet;
}

bool OAIPushProvider::is_firebase_data_template_Valid() const{
    return m_firebase_data_template_isValid;
}

QString OAIPushProvider::getFirebaseNotificationTemplate() const {
    return m_firebase_notification_template;
}
void OAIPushProvider::setFirebaseNotificationTemplate(const QString &firebase_notification_template) {
    m_firebase_notification_template = firebase_notification_template;
    m_firebase_notification_template_isSet = true;
}

bool OAIPushProvider::is_firebase_notification_template_Set() const{
    return m_firebase_notification_template_isSet;
}

bool OAIPushProvider::is_firebase_notification_template_Valid() const{
    return m_firebase_notification_template_isValid;
}

QString OAIPushProvider::getFirebaseServerKey() const {
    return m_firebase_server_key;
}
void OAIPushProvider::setFirebaseServerKey(const QString &firebase_server_key) {
    m_firebase_server_key = firebase_server_key;
    m_firebase_server_key_isSet = true;
}

bool OAIPushProvider::is_firebase_server_key_Set() const{
    return m_firebase_server_key_isSet;
}

bool OAIPushProvider::is_firebase_server_key_Valid() const{
    return m_firebase_server_key_isValid;
}

QString OAIPushProvider::getHuaweiAppId() const {
    return m_huawei_app_id;
}
void OAIPushProvider::setHuaweiAppId(const QString &huawei_app_id) {
    m_huawei_app_id = huawei_app_id;
    m_huawei_app_id_isSet = true;
}

bool OAIPushProvider::is_huawei_app_id_Set() const{
    return m_huawei_app_id_isSet;
}

bool OAIPushProvider::is_huawei_app_id_Valid() const{
    return m_huawei_app_id_isValid;
}

QString OAIPushProvider::getHuaweiAppSecret() const {
    return m_huawei_app_secret;
}
void OAIPushProvider::setHuaweiAppSecret(const QString &huawei_app_secret) {
    m_huawei_app_secret = huawei_app_secret;
    m_huawei_app_secret_isSet = true;
}

bool OAIPushProvider::is_huawei_app_secret_Set() const{
    return m_huawei_app_secret_isSet;
}

bool OAIPushProvider::is_huawei_app_secret_Valid() const{
    return m_huawei_app_secret_isValid;
}

QString OAIPushProvider::getName() const {
    return m_name;
}
void OAIPushProvider::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPushProvider::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPushProvider::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIPushProvider::getType() const {
    return m_type;
}
void OAIPushProvider::setType(const qint32 &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPushProvider::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPushProvider::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAIPushProvider::getUpdatedAt() const {
    return m_updated_at;
}
void OAIPushProvider::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIPushProvider::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIPushProvider::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIPushProvider::getXiaomiAppSecret() const {
    return m_xiaomi_app_secret;
}
void OAIPushProvider::setXiaomiAppSecret(const QString &xiaomi_app_secret) {
    m_xiaomi_app_secret = xiaomi_app_secret;
    m_xiaomi_app_secret_isSet = true;
}

bool OAIPushProvider::is_xiaomi_app_secret_Set() const{
    return m_xiaomi_app_secret_isSet;
}

bool OAIPushProvider::is_xiaomi_app_secret_Valid() const{
    return m_xiaomi_app_secret_isValid;
}

QString OAIPushProvider::getXiaomiPackageName() const {
    return m_xiaomi_package_name;
}
void OAIPushProvider::setXiaomiPackageName(const QString &xiaomi_package_name) {
    m_xiaomi_package_name = xiaomi_package_name;
    m_xiaomi_package_name_isSet = true;
}

bool OAIPushProvider::is_xiaomi_package_name_Set() const{
    return m_xiaomi_package_name_isSet;
}

bool OAIPushProvider::is_xiaomi_package_name_Valid() const{
    return m_xiaomi_package_name_isValid;
}

bool OAIPushProvider::isSet() const {
...
bool OAIPushProvider::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_created_at_isValid && m_name_isValid && m_type_isValid && m_updated_at_isValid && true;
}
