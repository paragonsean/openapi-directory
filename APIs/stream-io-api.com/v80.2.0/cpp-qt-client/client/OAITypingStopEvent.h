...
/*
 * OAITypingStopEvent.h
 *
 * 
 */

#ifndef OAITypingStopEvent_H
#define OAITypingStopEvent_H
...
class OAITypingStopEvent : public OAIObject {
public:
    OAITypingStopEvent();
    OAITypingStopEvent(QString json);
    ~OAITypingStopEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITypingStopEvent)

#endif // OAITypingStopEvent_H
