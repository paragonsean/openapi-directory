...
/*
 * OAIChannelTruncatedEvent.h
 *
 * 
 */

#ifndef OAIChannelTruncatedEvent_H
#define OAIChannelTruncatedEvent_H
...
class OAIChannelTruncatedEvent : public OAIObject {
public:
    OAIChannelTruncatedEvent();
    OAIChannelTruncatedEvent(QString json);
    ~OAIChannelTruncatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelTruncatedEvent)

#endif // OAIChannelTruncatedEvent_H
