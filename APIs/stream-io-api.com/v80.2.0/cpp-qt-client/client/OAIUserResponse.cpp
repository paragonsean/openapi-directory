...
QDateTime OAIUserResponse::getBanExpires() const {
    return m_ban_expires;
}
void OAIUserResponse::setBanExpires(const QDateTime &ban_expires) {
    m_ban_expires = ban_expires;
    m_ban_expires_isSet = true;
}

bool OAIUserResponse::is_ban_expires_Set() const{
    return m_ban_expires_isSet;
}

bool OAIUserResponse::is_ban_expires_Valid() const{
    return m_ban_expires_isValid;
}

bool OAIUserResponse::isBanned() const {
    return m_banned;
}
void OAIUserResponse::setBanned(const bool &banned) {
    m_banned = banned;
    m_banned_isSet = true;
}

bool OAIUserResponse::is_banned_Set() const{
    return m_banned_isSet;
}

bool OAIUserResponse::is_banned_Valid() const{
    return m_banned_isValid;
}

QDateTime OAIUserResponse::getCreatedAt() const {
    return m_created_at;
}
void OAIUserResponse::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIUserResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIUserResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIUserResponse::getDeactivatedAt() const {
    return m_deactivated_at;
}
void OAIUserResponse::setDeactivatedAt(const QDateTime &deactivated_at) {
    m_deactivated_at = deactivated_at;
    m_deactivated_at_isSet = true;
}

bool OAIUserResponse::is_deactivated_at_Set() const{
    return m_deactivated_at_isSet;
}

bool OAIUserResponse::is_deactivated_at_Valid() const{
    return m_deactivated_at_isValid;
}

QDateTime OAIUserResponse::getDeletedAt() const {
    return m_deleted_at;
}
void OAIUserResponse::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIUserResponse::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIUserResponse::is_deleted_at_Valid() const{
...
bool OAIUserResponse::isInvisible() const {
    return m_invisible;
}
void OAIUserResponse::setInvisible(const bool &invisible) {
    m_invisible = invisible;
    m_invisible_isSet = true;
}

bool OAIUserResponse::is_invisible_Set() const{
    return m_invisible_isSet;
}

bool OAIUserResponse::is_invisible_Valid() const{
    return m_invisible_isValid;
}

QString OAIUserResponse::getLanguage() const {
    return m_language;
}
void OAIUserResponse::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIUserResponse::is_language_Set() const{
    return m_language_isSet;
}

bool OAIUserResponse::is_language_Valid() const{
    return m_language_isValid;
}

QDateTime OAIUserResponse::getLastActive() const {
    return m_last_active;
}
void OAIUserResponse::setLastActive(const QDateTime &last_active) {
    m_last_active = last_active;
    m_last_active_isSet = true;
}

bool OAIUserResponse::is_last_active_Set() const{
    return m_last_active_isSet;
}

bool OAIUserResponse::is_last_active_Valid() const{
    return m_last_active_isValid;
}

bool OAIUserResponse::isOnline() const {
    return m_online;
}
void OAIUserResponse::setOnline(const bool &online) {
    m_online = online;
    m_online_isSet = true;
}

bool OAIUserResponse::is_online_Set() const{
    return m_online_isSet;
}

bool OAIUserResponse::is_online_Valid() const{
    return m_online_isValid;
}

OAIPushNotificationSettings OAIUserResponse::getPushNotifications() const {
    return m_push_notifications;
}
void OAIUserResponse::setPushNotifications(const OAIPushNotificationSettings &push_notifications) {
    m_push_notifications = push_notifications;
    m_push_notifications_isSet = true;
}

bool OAIUserResponse::is_push_notifications_Set() const{
    return m_push_notifications_isSet;
}

bool OAIUserResponse::is_push_notifications_Valid() const{
    return m_push_notifications_isValid;
}

QDateTime OAIUserResponse::getRevokeTokensIssuedBefore() const {
    return m_revoke_tokens_issued_before;
}
void OAIUserResponse::setRevokeTokensIssuedBefore(const QDateTime &revoke_tokens_issued_before) {
    m_revoke_tokens_issued_before = revoke_tokens_issued_before;
    m_revoke_tokens_issued_before_isSet = true;
}

bool OAIUserResponse::is_revoke_tokens_issued_before_Set() const{
    return m_revoke_tokens_issued_before_isSet;
}

bool OAIUserResponse::is_revoke_tokens_issued_before_Valid() const{
    return m_revoke_tokens_issued_before_isValid;
}

QString OAIUserResponse::getRole() const {
    return m_role;
}
void OAIUserResponse::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIUserResponse::is_role_Set() const{
    return m_role_isSet;
}

bool OAIUserResponse::is_role_Valid() const{
    return m_role_isValid;
}

bool OAIUserResponse::isShadowBanned() const {
    return m_shadow_banned;
}
void OAIUserResponse::setShadowBanned(const bool &shadow_banned) {
    m_shadow_banned = shadow_banned;
    m_shadow_banned_isSet = true;
}

bool OAIUserResponse::is_shadow_banned_Set() const{
    return m_shadow_banned_isSet;
}

bool OAIUserResponse::is_shadow_banned_Valid() const{
    return m_shadow_banned_isValid;
}

QList<QString> OAIUserResponse::getTeams() const {
    return m_teams;
}
void OAIUserResponse::setTeams(const QList<QString> &teams) {
    m_teams = teams;
    m_teams_isSet = true;
}

bool OAIUserResponse::is_teams_Set() const{
    return m_teams_isSet;
}

bool OAIUserResponse::is_teams_Valid() const{
    return m_teams_isValid;
}

QDateTime OAIUserResponse::getUpdatedAt() const {
    return m_updated_at;
}
void OAIUserResponse::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIUserResponse::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIUserResponse::is_updated_at_Valid() const{
...
bool OAIUserResponse::isValid() const {
    ...
    return m_banned_isValid && m_id_isValid && m_online_isValid && m_role_isValid && m_shadow_banned_isValid && true;
}
