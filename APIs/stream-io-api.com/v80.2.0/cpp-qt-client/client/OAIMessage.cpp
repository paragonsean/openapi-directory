...
QList<OAIAttachment> OAIMessage::getAttachments() const {
    return m_attachments;
}
void OAIMessage::setAttachments(const QList<OAIAttachment> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIMessage::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIMessage::is_attachments_Valid() const{
    return m_attachments_isValid;
}

bool OAIMessage::isBeforeMessageSendFailed() const {
    return m_before_message_send_failed;
}
void OAIMessage::setBeforeMessageSendFailed(const bool &before_message_send_failed) {
    m_before_message_send_failed = before_message_send_failed;
    m_before_message_send_failed_isSet = true;
}

bool OAIMessage::is_before_message_send_failed_Set() const{
    return m_before_message_send_failed_isSet;
}

bool OAIMessage::is_before_message_send_failed_Valid() const{
    return m_before_message_send_failed_isValid;
}

QString OAIMessage::getCid() const {
    return m_cid;
}
void OAIMessage::setCid(const QString &cid) {
    m_cid = cid;
    m_cid_isSet = true;
}

bool OAIMessage::is_cid_Set() const{
    return m_cid_isSet;
}

bool OAIMessage::is_cid_Valid() const{
    return m_cid_isValid;
}

QString OAIMessage::getCommand() const {
    return m_command;
}
void OAIMessage::setCommand(const QString &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAIMessage::is_command_Set() const{
    return m_command_isSet;
}

bool OAIMessage::is_command_Valid() const{
...
QDateTime OAIMessage::getDeletedAt() const {
    return m_deleted_at;
}
void OAIMessage::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIMessage::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIMessage::is_deleted_at_Valid() const{
    return m_deleted_at_isValid;
}

QString OAIMessage::getHtml() const {
    return m_html;
}
void OAIMessage::setHtml(const QString &html) {
    m_html = html;
    m_html_isSet = true;
}

bool OAIMessage::is_html_Set() const{
    return m_html_isSet;
}

bool OAIMessage::is_html_Valid() const{
    return m_html_isValid;
}

QMap<QString, QString> OAIMessage::getI18n() const {
    return m_i18n;
}
void OAIMessage::setI18n(const QMap<QString, QString> &i18n) {
    m_i18n = i18n;
    m_i18n_isSet = true;
}

bool OAIMessage::is_i18n_Set() const{
    return m_i18n_isSet;
}

bool OAIMessage::is_i18n_Valid() const{
...
QMap<QString, QList<QString>> OAIMessage::getImageLabels() const {
    return m_image_labels;
}
void OAIMessage::setImageLabels(const QMap<QString, QList<QString>> &image_labels) {
    m_image_labels = image_labels;
    m_image_labels_isSet = true;
}

bool OAIMessage::is_image_labels_Set() const{
    return m_image_labels_isSet;
}

bool OAIMessage::is_image_labels_Valid() const{
    return m_image_labels_isValid;
}

QList<OAIReaction> OAIMessage::getLatestReactions() const {
    return m_latest_reactions;
}
void OAIMessage::setLatestReactions(const QList<OAIReaction> &latest_reactions) {
    m_latest_reactions = latest_reactions;
    m_latest_reactions_isSet = true;
}

bool OAIMessage::is_latest_reactions_Set() const{
    return m_latest_reactions_isSet;
}

bool OAIMessage::is_latest_reactions_Valid() const{
    return m_latest_reactions_isValid;
}

QList<OAIUserObject> OAIMessage::getMentionedUsers() const {
    return m_mentioned_users;
}
void OAIMessage::setMentionedUsers(const QList<OAIUserObject> &mentioned_users) {
    m_mentioned_users = mentioned_users;
    m_mentioned_users_isSet = true;
}

bool OAIMessage::is_mentioned_users_Set() const{
    return m_mentioned_users_isSet;
}

bool OAIMessage::is_mentioned_users_Valid() const{
    return m_mentioned_users_isValid;
}

QString OAIMessage::getMml() const {
    return m_mml;
}
void OAIMessage::setMml(const QString &mml) {
    m_mml = mml;
    m_mml_isSet = true;
}

bool OAIMessage::is_mml_Set() const{
    return m_mml_isSet;
}

bool OAIMessage::is_mml_Valid() const{
    return m_mml_isValid;
}

QList<OAIReaction> OAIMessage::getOwnReactions() const {
    return m_own_reactions;
}
void OAIMessage::setOwnReactions(const QList<OAIReaction> &own_reactions) {
    m_own_reactions = own_reactions;
    m_own_reactions_isSet = true;
}

bool OAIMessage::is_own_reactions_Set() const{
    return m_own_reactions_isSet;
}

bool OAIMessage::is_own_reactions_Valid() const{
    return m_own_reactions_isValid;
}

QString OAIMessage::getParentId() const {
    return m_parent_id;
}
void OAIMessage::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAIMessage::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAIMessage::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

QDateTime OAIMessage::getPinExpires() const {
    return m_pin_expires;
}
void OAIMessage::setPinExpires(const QDateTime &pin_expires) {
    m_pin_expires = pin_expires;
    m_pin_expires_isSet = true;
}

bool OAIMessage::is_pin_expires_Set() const{
    return m_pin_expires_isSet;
}

bool OAIMessage::is_pin_expires_Valid() const{
    return m_pin_expires_isValid;
}

bool OAIMessage::isPinned() const {
    return m_pinned;
}
void OAIMessage::setPinned(const bool &pinned) {
    m_pinned = pinned;
    m_pinned_isSet = true;
}

bool OAIMessage::is_pinned_Set() const{
    return m_pinned_isSet;
}

bool OAIMessage::is_pinned_Valid() const{
    return m_pinned_isValid;
}

QDateTime OAIMessage::getPinnedAt() const {
    return m_pinned_at;
}
void OAIMessage::setPinnedAt(const QDateTime &pinned_at) {
    m_pinned_at = pinned_at;
    m_pinned_at_isSet = true;
}

bool OAIMessage::is_pinned_at_Set() const{
    return m_pinned_at_isSet;
}

bool OAIMessage::is_pinned_at_Valid() const{
    return m_pinned_at_isValid;
}

OAIUserObject OAIMessage::getPinnedBy() const {
    return m_pinned_by;
}
void OAIMessage::setPinnedBy(const OAIUserObject &pinned_by) {
    m_pinned_by = pinned_by;
    m_pinned_by_isSet = true;
}

bool OAIMessage::is_pinned_by_Set() const{
    return m_pinned_by_isSet;
}

bool OAIMessage::is_pinned_by_Valid() const{
    return m_pinned_by_isValid;
}

OAIMessage OAIMessage::getQuotedMessage() const {
    return m_quoted_message;
}
void OAIMessage::setQuotedMessage(const OAIMessage &quoted_message) {
    m_quoted_message = quoted_message;
    m_quoted_message_isSet = true;
}

bool OAIMessage::is_quoted_message_Set() const{
    return m_quoted_message_isSet;
}

bool OAIMessage::is_quoted_message_Valid() const{
    return m_quoted_message_isValid;
}

QString OAIMessage::getQuotedMessageId() const {
    return m_quoted_message_id;
}
void OAIMessage::setQuotedMessageId(const QString &quoted_message_id) {
    m_quoted_message_id = quoted_message_id;
    m_quoted_message_id_isSet = true;
}

bool OAIMessage::is_quoted_message_id_Set() const{
    return m_quoted_message_id_isSet;
}

bool OAIMessage::is_quoted_message_id_Valid() const{
    return m_quoted_message_id_isValid;
}

QMap<QString, qint32> OAIMessage::getReactionCounts() const {
    return m_reaction_counts;
}
void OAIMessage::setReactionCounts(const QMap<QString, qint32> &reaction_counts) {
    m_reaction_counts = reaction_counts;
    m_reaction_counts_isSet = true;
}

bool OAIMessage::is_reaction_counts_Set() const{
    return m_reaction_counts_isSet;
}

bool OAIMessage::is_reaction_counts_Valid() const{
    return m_reaction_counts_isValid;
}

QMap<QString, qint32> OAIMessage::getReactionScores() const {
    return m_reaction_scores;
}
void OAIMessage::setReactionScores(const QMap<QString, qint32> &reaction_scores) {
    m_reaction_scores = reaction_scores;
    m_reaction_scores_isSet = true;
}

bool OAIMessage::is_reaction_scores_Set() const{
    return m_reaction_scores_isSet;
}

bool OAIMessage::is_reaction_scores_Valid() const{
    return m_reaction_scores_isValid;
}

qint32 OAIMessage::getReplyCount() const {
    return m_reply_count;
}
void OAIMessage::setReplyCount(const qint32 &reply_count) {
    m_reply_count = reply_count;
    m_reply_count_isSet = true;
}

bool OAIMessage::is_reply_count_Set() const{
    return m_reply_count_isSet;
}

bool OAIMessage::is_reply_count_Valid() const{
    return m_reply_count_isValid;
}

bool OAIMessage::isShadowed() const {
    return m_shadowed;
}
void OAIMessage::setShadowed(const bool &shadowed) {
    m_shadowed = shadowed;
    m_shadowed_isSet = true;
}

bool OAIMessage::is_shadowed_Set() const{
    return m_shadowed_isSet;
}

bool OAIMessage::is_shadowed_Valid() const{
    return m_shadowed_isValid;
}

bool OAIMessage::isShowInChannel() const {
    return m_show_in_channel;
}
void OAIMessage::setShowInChannel(const bool &show_in_channel) {
    m_show_in_channel = show_in_channel;
    m_show_in_channel_isSet = true;
}

bool OAIMessage::is_show_in_channel_Set() const{
    return m_show_in_channel_isSet;
}

bool OAIMessage::is_show_in_channel_Valid() const{
    return m_show_in_channel_isValid;
}

bool OAIMessage::isSilent() const {
    return m_silent;
}
void OAIMessage::setSilent(const bool &silent) {
    m_silent = silent;
    m_silent_isSet = true;
}

bool OAIMessage::is_silent_Set() const{
    return m_silent_isSet;
}

bool OAIMessage::is_silent_Valid() const{
...
QList<OAIUserObject> OAIMessage::getThreadParticipants() const {
    return m_thread_participants;
}
void OAIMessage::setThreadParticipants(const QList<OAIUserObject> &thread_participants) {
    m_thread_participants = thread_participants;
    m_thread_participants_isSet = true;
}

bool OAIMessage::is_thread_participants_Set() const{
    return m_thread_participants_isSet;
}

bool OAIMessage::is_thread_participants_Valid() const{
...
OAIUserObject OAIMessage::getUser() const {
    return m_user;
}
void OAIMessage::setUser(const OAIUserObject &user) {
    m_user = user;
    m_user_isSet = true;
}
