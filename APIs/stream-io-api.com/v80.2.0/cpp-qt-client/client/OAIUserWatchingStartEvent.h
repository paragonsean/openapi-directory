...
/*
 * OAIUserWatchingStartEvent.h
 *
 * 
 */

#ifndef OAIUserWatchingStartEvent_H
#define OAIUserWatchingStartEvent_H
...
class OAIUserWatchingStartEvent : public OAIObject {
public:
    OAIUserWatchingStartEvent();
    OAIUserWatchingStartEvent(QString json);
    ~OAIUserWatchingStartEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserWatchingStartEvent)

#endif // OAIUserWatchingStartEvent_H
