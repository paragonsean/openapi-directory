...
OAIChannelConfigWithInfoRequest::OAIChannelConfigWithInfoRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelConfigWithInfoRequest::OAIChannelConfigWithInfoRequest() {
    this->initializeModel();
}

OAIChannelConfigWithInfoRequest::~OAIChannelConfigWithInfoRequest() {}

void OAIChannelConfigWithInfoRequest::initializeModel() {
...
void OAIChannelConfigWithInfoRequest::fromJson(QString jsonString) {
...
void OAIChannelConfigWithInfoRequest::fromJsonObject(QJsonObject json) {
...
QString OAIChannelConfigWithInfoRequest::asJson() const {
...
QJsonObject OAIChannelConfigWithInfoRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_automod_isSet) {
...
QString OAIChannelConfigWithInfoRequest::getAutomod() const {
    return m_automod;
}
void OAIChannelConfigWithInfoRequest::setAutomod(const QString &automod) {
    m_automod = automod;
    m_automod_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_automod_Set() const{
    return m_automod_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_automod_Valid() const{
    return m_automod_isValid;
}

QString OAIChannelConfigWithInfoRequest::getAutomodBehavior() const {
    return m_automod_behavior;
}
void OAIChannelConfigWithInfoRequest::setAutomodBehavior(const QString &automod_behavior) {
    m_automod_behavior = automod_behavior;
    m_automod_behavior_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_automod_behavior_Set() const{
    return m_automod_behavior_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_automod_behavior_Valid() const{
    return m_automod_behavior_isValid;
}

OAIThresholdsRequest OAIChannelConfigWithInfoRequest::getAutomodThresholds() const {
    return m_automod_thresholds;
}
void OAIChannelConfigWithInfoRequest::setAutomodThresholds(const OAIThresholdsRequest &automod_thresholds) {
    m_automod_thresholds = automod_thresholds;
    m_automod_thresholds_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_automod_thresholds_Set() const{
    return m_automod_thresholds_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_automod_thresholds_Valid() const{
    return m_automod_thresholds_isValid;
}

QString OAIChannelConfigWithInfoRequest::getBlocklist() const {
    return m_blocklist;
}
void OAIChannelConfigWithInfoRequest::setBlocklist(const QString &blocklist) {
    m_blocklist = blocklist;
    m_blocklist_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_blocklist_Set() const{
    return m_blocklist_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_blocklist_Valid() const{
    return m_blocklist_isValid;
}

QString OAIChannelConfigWithInfoRequest::getBlocklistBehavior() const {
    return m_blocklist_behavior;
}
void OAIChannelConfigWithInfoRequest::setBlocklistBehavior(const QString &blocklist_behavior) {
    m_blocklist_behavior = blocklist_behavior;
    m_blocklist_behavior_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_blocklist_behavior_Set() const{
    return m_blocklist_behavior_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_blocklist_behavior_Valid() const{
    return m_blocklist_behavior_isValid;
}

QList<OAICommandRequest> OAIChannelConfigWithInfoRequest::getCommands() const {
    return m_commands;
}
void OAIChannelConfigWithInfoRequest::setCommands(const QList<OAICommandRequest> &commands) {
    m_commands = commands;
    m_commands_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_commands_Set() const{
    return m_commands_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_commands_Valid() const{
    return m_commands_isValid;
}

bool OAIChannelConfigWithInfoRequest::isConnectEvents() const {
    return m_connect_events;
}
void OAIChannelConfigWithInfoRequest::setConnectEvents(const bool &connect_events) {
    m_connect_events = connect_events;
    m_connect_events_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_connect_events_Set() const{
    return m_connect_events_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_connect_events_Valid() const{
    return m_connect_events_isValid;
}

QDateTime OAIChannelConfigWithInfoRequest::getCreatedAt() const {
    return m_created_at;
}
void OAIChannelConfigWithInfoRequest::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_created_at_Valid() const{
    return m_created_at_isValid;
}

bool OAIChannelConfigWithInfoRequest::isCustomEvents() const {
    return m_custom_events;
}
void OAIChannelConfigWithInfoRequest::setCustomEvents(const bool &custom_events) {
    m_custom_events = custom_events;
    m_custom_events_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_custom_events_Set() const{
    return m_custom_events_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_custom_events_Valid() const{
    return m_custom_events_isValid;
}

QMap<QString, QList<QString>> OAIChannelConfigWithInfoRequest::getGrants() const {
    return m_grants;
}
void OAIChannelConfigWithInfoRequest::setGrants(const QMap<QString, QList<QString>> &grants) {
    m_grants = grants;
    m_grants_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_grants_Set() const{
    return m_grants_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_grants_Valid() const{
    return m_grants_isValid;
}

qint32 OAIChannelConfigWithInfoRequest::getMaxMessageLength() const {
    return m_max_message_length;
}
void OAIChannelConfigWithInfoRequest::setMaxMessageLength(const qint32 &max_message_length) {
    m_max_message_length = max_message_length;
    m_max_message_length_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_max_message_length_Set() const{
    return m_max_message_length_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_max_message_length_Valid() const{
    return m_max_message_length_isValid;
}

QString OAIChannelConfigWithInfoRequest::getMessageRetention() const {
    return m_message_retention;
}
void OAIChannelConfigWithInfoRequest::setMessageRetention(const QString &message_retention) {
    m_message_retention = message_retention;
    m_message_retention_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_message_retention_Set() const{
    return m_message_retention_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_message_retention_Valid() const{
    return m_message_retention_isValid;
}

bool OAIChannelConfigWithInfoRequest::isMutes() const {
    return m_mutes;
}
void OAIChannelConfigWithInfoRequest::setMutes(const bool &mutes) {
    m_mutes = mutes;
    m_mutes_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_mutes_Set() const{
    return m_mutes_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_mutes_Valid() const{
    return m_mutes_isValid;
}

QString OAIChannelConfigWithInfoRequest::getName() const {
    return m_name;
}
void OAIChannelConfigWithInfoRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIChannelConfigWithInfoRequest::isPushNotifications() const {
    return m_push_notifications;
}
void OAIChannelConfigWithInfoRequest::setPushNotifications(const bool &push_notifications) {
    m_push_notifications = push_notifications;
    m_push_notifications_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_push_notifications_Set() const{
    return m_push_notifications_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_push_notifications_Valid() const{
    return m_push_notifications_isValid;
}

bool OAIChannelConfigWithInfoRequest::isQuotes() const {
    return m_quotes;
}
void OAIChannelConfigWithInfoRequest::setQuotes(const bool &quotes) {
    m_quotes = quotes;
    m_quotes_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_quotes_Set() const{
    return m_quotes_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_quotes_Valid() const{
    return m_quotes_isValid;
}

bool OAIChannelConfigWithInfoRequest::isReactions() const {
    return m_reactions;
}
void OAIChannelConfigWithInfoRequest::setReactions(const bool &reactions) {
    m_reactions = reactions;
    m_reactions_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_reactions_Set() const{
    return m_reactions_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_reactions_Valid() const{
    return m_reactions_isValid;
}

bool OAIChannelConfigWithInfoRequest::isReadEvents() const {
    return m_read_events;
}
void OAIChannelConfigWithInfoRequest::setReadEvents(const bool &read_events) {
    m_read_events = read_events;
    m_read_events_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_read_events_Set() const{
    return m_read_events_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_read_events_Valid() const{
    return m_read_events_isValid;
}

bool OAIChannelConfigWithInfoRequest::isReminders() const {
    return m_reminders;
}
void OAIChannelConfigWithInfoRequest::setReminders(const bool &reminders) {
    m_reminders = reminders;
    m_reminders_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_reminders_Set() const{
    return m_reminders_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_reminders_Valid() const{
    return m_reminders_isValid;
}

bool OAIChannelConfigWithInfoRequest::isReplies() const {
    return m_replies;
}
void OAIChannelConfigWithInfoRequest::setReplies(const bool &replies) {
    m_replies = replies;
    m_replies_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_replies_Set() const{
    return m_replies_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_replies_Valid() const{
    return m_replies_isValid;
}

bool OAIChannelConfigWithInfoRequest::isSearch() const {
    return m_search;
}
void OAIChannelConfigWithInfoRequest::setSearch(const bool &search) {
    m_search = search;
    m_search_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_search_Set() const{
    return m_search_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_search_Valid() const{
    return m_search_isValid;
}

bool OAIChannelConfigWithInfoRequest::isTypingEvents() const {
    return m_typing_events;
}
void OAIChannelConfigWithInfoRequest::setTypingEvents(const bool &typing_events) {
    m_typing_events = typing_events;
    m_typing_events_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_typing_events_Set() const{
    return m_typing_events_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_typing_events_Valid() const{
    return m_typing_events_isValid;
}

QDateTime OAIChannelConfigWithInfoRequest::getUpdatedAt() const {
    return m_updated_at;
}
void OAIChannelConfigWithInfoRequest::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIChannelConfigWithInfoRequest::isUploads() const {
    return m_uploads;
}
void OAIChannelConfigWithInfoRequest::setUploads(const bool &uploads) {
    m_uploads = uploads;
    m_uploads_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_uploads_Set() const{
    return m_uploads_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_uploads_Valid() const{
    return m_uploads_isValid;
}

bool OAIChannelConfigWithInfoRequest::isUrlEnrichment() const {
    return m_url_enrichment;
}
void OAIChannelConfigWithInfoRequest::setUrlEnrichment(const bool &url_enrichment) {
    m_url_enrichment = url_enrichment;
    m_url_enrichment_isSet = true;
}

bool OAIChannelConfigWithInfoRequest::is_url_enrichment_Set() const{
    return m_url_enrichment_isSet;
}

bool OAIChannelConfigWithInfoRequest::is_url_enrichment_Valid() const{
    return m_url_enrichment_isValid;
}

bool OAIChannelConfigWithInfoRequest::isSet() const {
...
bool OAIChannelConfigWithInfoRequest::isValid() const {
