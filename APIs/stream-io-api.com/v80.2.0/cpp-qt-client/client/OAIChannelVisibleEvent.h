...
/*
 * OAIChannelVisibleEvent.h
 *
 * 
 */

#ifndef OAIChannelVisibleEvent_H
#define OAIChannelVisibleEvent_H
...
class OAIChannelVisibleEvent : public OAIObject {
public:
    OAIChannelVisibleEvent();
    OAIChannelVisibleEvent(QString json);
    ~OAIChannelVisibleEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelVisibleEvent)

#endif // OAIChannelVisibleEvent_H
