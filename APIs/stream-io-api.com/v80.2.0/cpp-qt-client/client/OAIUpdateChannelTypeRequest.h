...
/*
 * OAIUpdateChannelTypeRequest.h
 *
 * 
 */

#ifndef OAIUpdateChannelTypeRequest_H
#define OAIUpdateChannelTypeRequest_H
...
namespace OpenAPI {
class OAIThresholdsRequest;
class OAIPolicyRequest;

class OAIUpdateChannelTypeRequest : public OAIObject {
public:
    OAIUpdateChannelTypeRequest();
    OAIUpdateChannelTypeRequest(QString json);
    ~OAIUpdateChannelTypeRequest() override;
    ...
    QString getNameFromPath() const;
    void setNameFromPath(const QString &name_from_path);
    bool is_name_from_path_Set() const;
    bool is_name_from_path_Valid() const;
    ...
    OAIThresholdsRequest getAutomodThresholds() const;
    void setAutomodThresholds(const OAIThresholdsRequest &automod_thresholds);
    ...
    QList<OAIPolicyRequest> getPermissions() const;
    void setPermissions(const QList<OAIPolicyRequest> &permissions);
...
private:
    ...
    QString m_name_from_path;
    bool m_name_from_path_isSet;
    bool m_name_from_path_isValid;
    ...
    OAIThresholdsRequest m_automod_thresholds;
    ...
    QList<OAIPolicyRequest> m_permissions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannelTypeRequest)

#endif // OAIUpdateChannelTypeRequest_H
