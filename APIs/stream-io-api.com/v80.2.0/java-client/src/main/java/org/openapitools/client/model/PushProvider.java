...
public class PushProvider {
  ...
  public PushProvider apnAuthKey(String apnAuthKey) {
  ...
  public PushProvider apnAuthType(String apnAuthType) {
  ...
  public PushProvider apnDevelopment(Boolean apnDevelopment) {
  ...
  public PushProvider apnHost(String apnHost) {
  ...
  public PushProvider apnKeyId(String apnKeyId) {
  ...
  public PushProvider apnNotificationTemplate(String apnNotificationTemplate) {
  ...
  public PushProvider apnP12Cert(String apnP12Cert) {
  ...
  public PushProvider apnTeamId(String apnTeamId) {
  ...
  public PushProvider apnTopic(String apnTopic) {
  ...
  public PushProvider createdAt(OffsetDateTime createdAt) {
  ...
  public PushProvider description(String description) {
  ...
  public PushProvider disabledAt(OffsetDateTime disabledAt) {
  ...
  public PushProvider disabledReason(String disabledReason) {
  ...
  public PushProvider firebaseApnTemplate(String firebaseApnTemplate) {
  ...
  public PushProvider firebaseCredentials(String firebaseCredentials) {
  ...
  public PushProvider firebaseDataTemplate(String firebaseDataTemplate) {
  ...
  public PushProvider firebaseNotificationTemplate(String firebaseNotificationTemplate) {
  ...
  public PushProvider firebaseServerKey(String firebaseServerKey) {
  ...
  public PushProvider huaweiAppId(String huaweiAppId) {
  ...
  public PushProvider huaweiAppSecret(String huaweiAppSecret) {
  ...
  public PushProvider type(Integer type) {
    this.type = type;
    return this;
  }
  ...
  public PushProvider updatedAt(OffsetDateTime updatedAt) {
  ...
  public PushProvider xiaomiAppSecret(String xiaomiAppSecret) {
  ...
  public PushProvider xiaomiPackageName(String xiaomiPackageName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apnAuthKey, pushProvider.apnAuthKey) &&
        Objects.equals(this.apnAuthType, pushProvider.apnAuthType) &&
        Objects.equals(this.apnDevelopment, pushProvider.apnDevelopment) &&
        Objects.equals(this.apnHost, pushProvider.apnHost) &&
        Objects.equals(this.apnKeyId, pushProvider.apnKeyId) &&
        Objects.equals(this.apnNotificationTemplate, pushProvider.apnNotificationTemplate) &&
        Objects.equals(this.apnP12Cert, pushProvider.apnP12Cert) &&
        Objects.equals(this.apnTeamId, pushProvider.apnTeamId) &&
        Objects.equals(this.apnTopic, pushProvider.apnTopic) &&
        Objects.equals(this.createdAt, pushProvider.createdAt) &&
        Objects.equals(this.description, pushProvider.description) &&
        Objects.equals(this.disabledAt, pushProvider.disabledAt) &&
        Objects.equals(this.disabledReason, pushProvider.disabledReason) &&
        Objects.equals(this.firebaseApnTemplate, pushProvider.firebaseApnTemplate) &&
        Objects.equals(this.firebaseCredentials, pushProvider.firebaseCredentials) &&
        Objects.equals(this.firebaseDataTemplate, pushProvider.firebaseDataTemplate) &&
        Objects.equals(this.firebaseNotificationTemplate, pushProvider.firebaseNotificationTemplate) &&
        Objects.equals(this.firebaseServerKey, pushProvider.firebaseServerKey) &&
        Objects.equals(this.huaweiAppId, pushProvider.huaweiAppId) &&
        Objects.equals(this.huaweiAppSecret, pushProvider.huaweiAppSecret) &&
        Objects.equals(this.name, pushProvider.name) &&
        Objects.equals(this.type, pushProvider.type) &&
        Objects.equals(this.updatedAt, pushProvider.updatedAt) &&
        Objects.equals(this.xiaomiAppSecret, pushProvider.xiaomiAppSecret) &&
        Objects.equals(this.xiaomiPackageName, pushProvider.xiaomiPackageName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PushProvider
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PushProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PushProvider is not found in the empty JSON string", PushProvider.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PushProvider.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PushProvider` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PushProvider.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PushProvider.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PushProvider' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PushProvider> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PushProvider.class));

       return (TypeAdapter<T>) new TypeAdapter<PushProvider>() {
           @Override
           public void write(JsonWriter out, PushProvider value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PushProvider read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PushProvider given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PushProvider
   * @throws IOException if the JSON string is invalid with respect to PushProvider
   */
  public static PushProvider fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PushProvider.class);
  }

  /**
   * Convert an instance of PushProvider to an JSON string
   *
   * @return JSON string
   */
