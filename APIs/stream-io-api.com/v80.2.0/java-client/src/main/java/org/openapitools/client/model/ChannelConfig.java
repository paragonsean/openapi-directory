...
public class ChannelConfig {
  ...
  public ChannelConfig automod(AutomodEnum automod) {
  ...
  public ChannelConfig automodBehavior(AutomodBehaviorEnum automodBehavior) {
  ...
  public ChannelConfig automodThresholds(Thresholds automodThresholds) {
  ...
  public ChannelConfig blocklist(String blocklist) {
  ...
  public ChannelConfig blocklistBehavior(BlocklistBehaviorEnum blocklistBehavior) {
  ...
  public ChannelConfig commands(List<String> commands) {
    this.commands = commands;
    return this;
  }

  public ChannelConfig addCommandsItem(String commandsItem) {
  ...
  public ChannelConfig connectEvents(Boolean connectEvents) {
  ...
  public ChannelConfig createdAt(OffsetDateTime createdAt) {
  ...
  public ChannelConfig customEvents(Boolean customEvents) {
  ...
  public ChannelConfig maxMessageLength(Integer maxMessageLength) {
  ...
  public ChannelConfig messageRetention(String messageRetention) {
  ...
  public ChannelConfig mutes(Boolean mutes) {
    this.mutes = mutes;
    return this;
  }
  ...
  public ChannelConfig pushNotifications(Boolean pushNotifications) {
  ...
  public ChannelConfig quotes(Boolean quotes) {
    this.quotes = quotes;
    return this;
  }
  ...
  public ChannelConfig reactions(Boolean reactions) {
  ...
  public ChannelConfig readEvents(Boolean readEvents) {
  ...
  public ChannelConfig reminders(Boolean reminders) {
  ...
  public ChannelConfig replies(Boolean replies) {
  ...
  public ChannelConfig search(Boolean search) {
    this.search = search;
    return this;
  }
  ...
  public ChannelConfig typingEvents(Boolean typingEvents) {
  ...
  public ChannelConfig updatedAt(OffsetDateTime updatedAt) {
  ...
  public ChannelConfig uploads(Boolean uploads) {
  ...
  public ChannelConfig urlEnrichment(Boolean urlEnrichment) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.automod, channelConfig.automod) &&
        Objects.equals(this.automodBehavior, channelConfig.automodBehavior) &&
        Objects.equals(this.automodThresholds, channelConfig.automodThresholds) &&
        Objects.equals(this.blocklist, channelConfig.blocklist) &&
        Objects.equals(this.blocklistBehavior, channelConfig.blocklistBehavior) &&
        Objects.equals(this.commands, channelConfig.commands) &&
        Objects.equals(this.connectEvents, channelConfig.connectEvents) &&
        Objects.equals(this.createdAt, channelConfig.createdAt) &&
        Objects.equals(this.customEvents, channelConfig.customEvents) &&
        Objects.equals(this.maxMessageLength, channelConfig.maxMessageLength) &&
        Objects.equals(this.messageRetention, channelConfig.messageRetention) &&
        Objects.equals(this.mutes, channelConfig.mutes) &&
        Objects.equals(this.name, channelConfig.name) &&
        Objects.equals(this.pushNotifications, channelConfig.pushNotifications) &&
        Objects.equals(this.quotes, channelConfig.quotes) &&
        Objects.equals(this.reactions, channelConfig.reactions) &&
        Objects.equals(this.readEvents, channelConfig.readEvents) &&
        Objects.equals(this.reminders, channelConfig.reminders) &&
        Objects.equals(this.replies, channelConfig.replies) &&
        Objects.equals(this.search, channelConfig.search) &&
        Objects.equals(this.typingEvents, channelConfig.typingEvents) &&
        Objects.equals(this.updatedAt, channelConfig.updatedAt) &&
        Objects.equals(this.uploads, channelConfig.uploads) &&
        Objects.equals(this.urlEnrichment, channelConfig.urlEnrichment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(automod, automodBehavior, automodThresholds, blocklist, blocklistBehavior, commands, connectEvents, createdAt, customEvents, maxMessageLength, messageRetention, mutes, name, pushNotifications, quotes, reactions, readEvents, reminders, replies, search, typingEvents, updatedAt, uploads, urlEnrichment);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelConfig is not found in the empty JSON string", ChannelConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChannelConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelConfig>() {
           @Override
           public void write(JsonWriter out, ChannelConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelConfig
   * @throws IOException if the JSON string is invalid with respect to ChannelConfig
   */
  public static ChannelConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelConfig.class);
  }

  /**
   * Convert an instance of ChannelConfig to an JSON string
   *
   * @return JSON string
   */
