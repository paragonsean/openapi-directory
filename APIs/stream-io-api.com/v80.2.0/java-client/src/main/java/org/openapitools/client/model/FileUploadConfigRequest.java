...
public class FileUploadConfigRequest {
  ...
  public FileUploadConfigRequest allowedFileExtensions(List<String> allowedFileExtensions) {
    this.allowedFileExtensions = allowedFileExtensions;
    return this;
  }

  public FileUploadConfigRequest addAllowedFileExtensionsItem(String allowedFileExtensionsItem) {
  ...
  public FileUploadConfigRequest allowedMimeTypes(List<String> allowedMimeTypes) {
    this.allowedMimeTypes = allowedMimeTypes;
    return this;
  }

  public FileUploadConfigRequest addAllowedMimeTypesItem(String allowedMimeTypesItem) {
  ...
  public FileUploadConfigRequest blockedFileExtensions(List<String> blockedFileExtensions) {
    this.blockedFileExtensions = blockedFileExtensions;
    return this;
  }

  public FileUploadConfigRequest addBlockedFileExtensionsItem(String blockedFileExtensionsItem) {
  ...
  public FileUploadConfigRequest blockedMimeTypes(List<String> blockedMimeTypes) {
    this.blockedMimeTypes = blockedMimeTypes;
    return this;
  }

  public FileUploadConfigRequest addBlockedMimeTypesItem(String blockedMimeTypesItem) {
  ...
  public boolean equals(Object o) {
    ...
    FileUploadConfigRequest fileUploadConfigRequest = (FileUploadConfigRequest) o;
    return Objects.equals(this.allowedFileExtensions, fileUploadConfigRequest.allowedFileExtensions) &&
        Objects.equals(this.allowedMimeTypes, fileUploadConfigRequest.allowedMimeTypes) &&
        Objects.equals(this.blockedFileExtensions, fileUploadConfigRequest.blockedFileExtensions) &&
        Objects.equals(this.blockedMimeTypes, fileUploadConfigRequest.blockedMimeTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileUploadConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileUploadConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileUploadConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileUploadConfigRequest is not found in the empty JSON string", FileUploadConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileUploadConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileUploadConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("allowed_file_extensions") != null && !jsonObj.get("allowed_file_extensions").isJsonNull() && !jsonObj.get("allowed_file_extensions").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("allowed_mime_types") != null && !jsonObj.get("allowed_mime_types").isJsonNull() && !jsonObj.get("allowed_mime_types").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("blocked_file_extensions") != null && !jsonObj.get("blocked_file_extensions").isJsonNull() && !jsonObj.get("blocked_file_extensions").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("blocked_mime_types") != null && !jsonObj.get("blocked_mime_types").isJsonNull() && !jsonObj.get("blocked_mime_types").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileUploadConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileUploadConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileUploadConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileUploadConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FileUploadConfigRequest>() {
           @Override
           public void write(JsonWriter out, FileUploadConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileUploadConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileUploadConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileUploadConfigRequest
   * @throws IOException if the JSON string is invalid with respect to FileUploadConfigRequest
   */
  public static FileUploadConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileUploadConfigRequest.class);
  }

  /**
   * Convert an instance of FileUploadConfigRequest to an JSON string
   *
   * @return JSON string
   */
