...
public class ChannelConfigWithInfoRequest {
  /**
  ...
  private List<CommandRequest> commands = new ArrayList<>();
  ...
  public ChannelConfigWithInfoRequest() {
  }

  public ChannelConfigWithInfoRequest automod(AutomodEnum automod) {
  ...
  public ChannelConfigWithInfoRequest automodBehavior(AutomodBehaviorEnum automodBehavior) {
  ...
  public ChannelConfigWithInfoRequest automodThresholds(ThresholdsRequest automodThresholds) {
  ...
  public ChannelConfigWithInfoRequest blocklist(String blocklist) {
  ...
  public ChannelConfigWithInfoRequest blocklistBehavior(BlocklistBehaviorEnum blocklistBehavior) {
  ...
  public ChannelConfigWithInfoRequest commands(List<CommandRequest> commands) {
    this.commands = commands;
    return this;
  }

  public ChannelConfigWithInfoRequest addCommandsItem(CommandRequest commandsItem) {
  ...
  public void setCommands(List<CommandRequest> commands) {
    this.commands = commands;
  }


  public ChannelConfigWithInfoRequest connectEvents(Boolean connectEvents) {
  ...
  public ChannelConfigWithInfoRequest createdAt(OffsetDateTime createdAt) {
  ...
  public ChannelConfigWithInfoRequest customEvents(Boolean customEvents) {
  ...
  public ChannelConfigWithInfoRequest grants(Map<String, List<String>> grants) {
    this.grants = grants;
    return this;
  }

  public ChannelConfigWithInfoRequest putGrantsItem(String key, List<String> grantsItem) {
    if (this.grants == null) {
  ...
  public ChannelConfigWithInfoRequest maxMessageLength(Integer maxMessageLength) {
  ...
  public ChannelConfigWithInfoRequest messageRetention(String messageRetention) {
  ...
  public ChannelConfigWithInfoRequest mutes(Boolean mutes) {
    this.mutes = mutes;
    return this;
  }
  ...
  public ChannelConfigWithInfoRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ChannelConfigWithInfoRequest pushNotifications(Boolean pushNotifications) {
  ...
  public ChannelConfigWithInfoRequest quotes(Boolean quotes) {
    this.quotes = quotes;
    return this;
  }
  ...
  public ChannelConfigWithInfoRequest reactions(Boolean reactions) {
  ...
  public ChannelConfigWithInfoRequest readEvents(Boolean readEvents) {
  ...
  public ChannelConfigWithInfoRequest reminders(Boolean reminders) {
  ...
  public ChannelConfigWithInfoRequest replies(Boolean replies) {
  ...
  public ChannelConfigWithInfoRequest search(Boolean search) {
    this.search = search;
    return this;
  }
  ...
  public ChannelConfigWithInfoRequest typingEvents(Boolean typingEvents) {
  ...
  public ChannelConfigWithInfoRequest updatedAt(OffsetDateTime updatedAt) {
  ...
  public ChannelConfigWithInfoRequest uploads(Boolean uploads) {
  ...
  public ChannelConfigWithInfoRequest urlEnrichment(Boolean urlEnrichment) {
  ...
  public boolean equals(Object o) {
    ...
    ChannelConfigWithInfoRequest channelConfigWithInfoRequest = (ChannelConfigWithInfoRequest) o;
    return Objects.equals(this.automod, channelConfigWithInfoRequest.automod) &&
        Objects.equals(this.automodBehavior, channelConfigWithInfoRequest.automodBehavior) &&
        Objects.equals(this.automodThresholds, channelConfigWithInfoRequest.automodThresholds) &&
        Objects.equals(this.blocklist, channelConfigWithInfoRequest.blocklist) &&
        Objects.equals(this.blocklistBehavior, channelConfigWithInfoRequest.blocklistBehavior) &&
        Objects.equals(this.commands, channelConfigWithInfoRequest.commands) &&
        Objects.equals(this.connectEvents, channelConfigWithInfoRequest.connectEvents) &&
        Objects.equals(this.createdAt, channelConfigWithInfoRequest.createdAt) &&
        Objects.equals(this.customEvents, channelConfigWithInfoRequest.customEvents) &&
        Objects.equals(this.grants, channelConfigWithInfoRequest.grants) &&
        Objects.equals(this.maxMessageLength, channelConfigWithInfoRequest.maxMessageLength) &&
        Objects.equals(this.messageRetention, channelConfigWithInfoRequest.messageRetention) &&
        Objects.equals(this.mutes, channelConfigWithInfoRequest.mutes) &&
        Objects.equals(this.name, channelConfigWithInfoRequest.name) &&
        Objects.equals(this.pushNotifications, channelConfigWithInfoRequest.pushNotifications) &&
        Objects.equals(this.quotes, channelConfigWithInfoRequest.quotes) &&
        Objects.equals(this.reactions, channelConfigWithInfoRequest.reactions) &&
        Objects.equals(this.readEvents, channelConfigWithInfoRequest.readEvents) &&
        Objects.equals(this.reminders, channelConfigWithInfoRequest.reminders) &&
        Objects.equals(this.replies, channelConfigWithInfoRequest.replies) &&
        Objects.equals(this.search, channelConfigWithInfoRequest.search) &&
        Objects.equals(this.typingEvents, channelConfigWithInfoRequest.typingEvents) &&
        Objects.equals(this.updatedAt, channelConfigWithInfoRequest.updatedAt) &&
        Objects.equals(this.uploads, channelConfigWithInfoRequest.uploads) &&
        Objects.equals(this.urlEnrichment, channelConfigWithInfoRequest.urlEnrichment);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChannelConfigWithInfoRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelConfigWithInfoRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelConfigWithInfoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelConfigWithInfoRequest is not found in the empty JSON string", ChannelConfigWithInfoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelConfigWithInfoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelConfigWithInfoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChannelConfigWithInfoRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("commands") != null && !jsonObj.get("commands").isJsonNull()) {
        ...
        if (jsonArraycommands != null) {
          ...
          for (int i = 0; i < jsonArraycommands.size(); i++) {
            CommandRequest.validateJsonElement(jsonArraycommands.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelConfigWithInfoRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelConfigWithInfoRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelConfigWithInfoRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelConfigWithInfoRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelConfigWithInfoRequest>() {
           @Override
           public void write(JsonWriter out, ChannelConfigWithInfoRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelConfigWithInfoRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelConfigWithInfoRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelConfigWithInfoRequest
   * @throws IOException if the JSON string is invalid with respect to ChannelConfigWithInfoRequest
   */
  public static ChannelConfigWithInfoRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelConfigWithInfoRequest.class);
  }

  /**
   * Convert an instance of ChannelConfigWithInfoRequest to an JSON string
   *
   * @return JSON string
   */
