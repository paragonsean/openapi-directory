...
public class ConnectRequest {
  ...
  public ConnectRequest device(DeviceFields device) {
    this.device = device;
    return this;
  }
  ...
  public DeviceFields getDevice() {
    return device;
  }

  public void setDevice(DeviceFields device) {
    this.device = device;
  }


  public ConnectRequest userDetails(UserObject userDetails) {
  ...
  public void setUserDetails(UserObject userDetails) {
    this.userDetails = userDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.device, connectRequest.device) &&
        Objects.equals(this.userDetails, connectRequest.userDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(device, userDetails);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("device") != null && !jsonObj.get("device").isJsonNull()) {
        DeviceFields.validateJsonElement(jsonObj.get("device"));
      }
  }
