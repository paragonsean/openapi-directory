...
public class FirebaseConfigFields {
  ...
  public FirebaseConfigFields apnTemplate(String apnTemplate) {
  ...
  public FirebaseConfigFields credentialsJson(String credentialsJson) {
  ...
  public FirebaseConfigFields dataTemplate(String dataTemplate) {
  ...
  public FirebaseConfigFields enabled(Boolean enabled) {
  ...
  public FirebaseConfigFields notificationTemplate(String notificationTemplate) {
  ...
  public FirebaseConfigFields serverKey(String serverKey) {
  ...
  public boolean equals(Object o) {
    ...
    FirebaseConfigFields firebaseConfigFields = (FirebaseConfigFields) o;
    return Objects.equals(this.apnTemplate, firebaseConfigFields.apnTemplate) &&
        Objects.equals(this.credentialsJson, firebaseConfigFields.credentialsJson) &&
        Objects.equals(this.dataTemplate, firebaseConfigFields.dataTemplate) &&
        Objects.equals(this.enabled, firebaseConfigFields.enabled) &&
        Objects.equals(this.notificationTemplate, firebaseConfigFields.notificationTemplate) &&
        Objects.equals(this.serverKey, firebaseConfigFields.serverKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apnTemplate, credentialsJson, dataTemplate, enabled, notificationTemplate, serverKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirebaseConfigFields {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("apn_template");
    openapiRequiredFields.add("data_template");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirebaseConfigFields
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirebaseConfigFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirebaseConfigFields is not found in the empty JSON string", FirebaseConfigFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirebaseConfigFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirebaseConfigFields` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirebaseConfigFields.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("apn_template").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("data_template").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirebaseConfigFields.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirebaseConfigFields' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirebaseConfigFields> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirebaseConfigFields.class));

       return (TypeAdapter<T>) new TypeAdapter<FirebaseConfigFields>() {
           @Override
           public void write(JsonWriter out, FirebaseConfigFields value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirebaseConfigFields read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirebaseConfigFields given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirebaseConfigFields
   * @throws IOException if the JSON string is invalid with respect to FirebaseConfigFields
   */
  public static FirebaseConfigFields fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirebaseConfigFields.class);
  }

  /**
   * Convert an instance of FirebaseConfigFields to an JSON string
   *
   * @return JSON string
   */
