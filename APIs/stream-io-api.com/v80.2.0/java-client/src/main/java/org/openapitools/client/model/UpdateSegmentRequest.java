...
public class UpdateSegmentRequest {
  ...
  private SegmentUpdateableFieldsRequest segment;

  public UpdateSegmentRequest() {
  }

  public UpdateSegmentRequest segment(SegmentUpdateableFieldsRequest segment) {
  ...
  public SegmentUpdateableFieldsRequest getSegment() {
    return segment;
  }

  public void setSegment(SegmentUpdateableFieldsRequest segment) {
    this.segment = segment;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.segment, updateSegmentRequest.segment);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSegmentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSegmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSegmentRequest is not found in the empty JSON string", UpdateSegmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSegmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSegmentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSegmentRequest.openapiRequiredFields) {
      ...
      SegmentUpdateableFieldsRequest.validateJsonElement(jsonObj.get("segment"));
  }
