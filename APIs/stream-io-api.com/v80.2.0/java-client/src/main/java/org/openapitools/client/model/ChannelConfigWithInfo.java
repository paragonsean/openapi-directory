...
public class ChannelConfigWithInfo {
  ...
  public ChannelConfigWithInfo automod(AutomodEnum automod) {
  ...
  public ChannelConfigWithInfo automodBehavior(AutomodBehaviorEnum automodBehavior) {
  ...
  public ChannelConfigWithInfo automodThresholds(Thresholds automodThresholds) {
  ...
  public ChannelConfigWithInfo blocklist(String blocklist) {
  ...
  public ChannelConfigWithInfo blocklistBehavior(BlocklistBehaviorEnum blocklistBehavior) {
  ...
  public ChannelConfigWithInfo commands(List<Command> commands) {
    this.commands = commands;
    return this;
  }

  public ChannelConfigWithInfo addCommandsItem(Command commandsItem) {
  ...
  public ChannelConfigWithInfo connectEvents(Boolean connectEvents) {
  ...
  public ChannelConfigWithInfo createdAt(OffsetDateTime createdAt) {
  ...
  public ChannelConfigWithInfo customEvents(Boolean customEvents) {
  ...
  public ChannelConfigWithInfo grants(Map<String, List<String>> grants) {
    this.grants = grants;
    return this;
  }

  public ChannelConfigWithInfo putGrantsItem(String key, List<String> grantsItem) {
    if (this.grants == null) {
  ...
  public ChannelConfigWithInfo maxMessageLength(Integer maxMessageLength) {
  ...
  public ChannelConfigWithInfo messageRetention(String messageRetention) {
  ...
  public ChannelConfigWithInfo mutes(Boolean mutes) {
    this.mutes = mutes;
    return this;
  }
  ...
  public ChannelConfigWithInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ChannelConfigWithInfo pushNotifications(Boolean pushNotifications) {
  ...
  public ChannelConfigWithInfo quotes(Boolean quotes) {
    this.quotes = quotes;
    return this;
  }
  ...
  public ChannelConfigWithInfo reactions(Boolean reactions) {
  ...
  public ChannelConfigWithInfo readEvents(Boolean readEvents) {
  ...
  public ChannelConfigWithInfo reminders(Boolean reminders) {
  ...
  public ChannelConfigWithInfo replies(Boolean replies) {
  ...
  public ChannelConfigWithInfo search(Boolean search) {
    this.search = search;
    return this;
  }
  ...
  public ChannelConfigWithInfo typingEvents(Boolean typingEvents) {
  ...
  public ChannelConfigWithInfo updatedAt(OffsetDateTime updatedAt) {
  ...
  public ChannelConfigWithInfo uploads(Boolean uploads) {
  ...
  public ChannelConfigWithInfo urlEnrichment(Boolean urlEnrichment) {
  ...
  public boolean equals(Object o) {
    ...
    ChannelConfigWithInfo channelConfigWithInfo = (ChannelConfigWithInfo) o;
    return Objects.equals(this.automod, channelConfigWithInfo.automod) &&
        Objects.equals(this.automodBehavior, channelConfigWithInfo.automodBehavior) &&
        Objects.equals(this.automodThresholds, channelConfigWithInfo.automodThresholds) &&
        Objects.equals(this.blocklist, channelConfigWithInfo.blocklist) &&
        Objects.equals(this.blocklistBehavior, channelConfigWithInfo.blocklistBehavior) &&
        Objects.equals(this.commands, channelConfigWithInfo.commands) &&
        Objects.equals(this.connectEvents, channelConfigWithInfo.connectEvents) &&
        Objects.equals(this.createdAt, channelConfigWithInfo.createdAt) &&
        Objects.equals(this.customEvents, channelConfigWithInfo.customEvents) &&
        Objects.equals(this.grants, channelConfigWithInfo.grants) &&
        Objects.equals(this.maxMessageLength, channelConfigWithInfo.maxMessageLength) &&
        Objects.equals(this.messageRetention, channelConfigWithInfo.messageRetention) &&
        Objects.equals(this.mutes, channelConfigWithInfo.mutes) &&
        Objects.equals(this.name, channelConfigWithInfo.name) &&
        Objects.equals(this.pushNotifications, channelConfigWithInfo.pushNotifications) &&
        Objects.equals(this.quotes, channelConfigWithInfo.quotes) &&
        Objects.equals(this.reactions, channelConfigWithInfo.reactions) &&
        Objects.equals(this.readEvents, channelConfigWithInfo.readEvents) &&
        Objects.equals(this.reminders, channelConfigWithInfo.reminders) &&
        Objects.equals(this.replies, channelConfigWithInfo.replies) &&
        Objects.equals(this.search, channelConfigWithInfo.search) &&
        Objects.equals(this.typingEvents, channelConfigWithInfo.typingEvents) &&
        Objects.equals(this.updatedAt, channelConfigWithInfo.updatedAt) &&
        Objects.equals(this.uploads, channelConfigWithInfo.uploads) &&
        Objects.equals(this.urlEnrichment, channelConfigWithInfo.urlEnrichment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(automod, automodBehavior, automodThresholds, blocklist, blocklistBehavior, commands, connectEvents, createdAt, customEvents, grants, maxMessageLength, messageRetention, mutes, name, pushNotifications, quotes, reactions, readEvents, reminders, replies, search, typingEvents, updatedAt, uploads, urlEnrichment);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChannelConfigWithInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelConfigWithInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelConfigWithInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelConfigWithInfo is not found in the empty JSON string", ChannelConfigWithInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelConfigWithInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelConfigWithInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChannelConfigWithInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelConfigWithInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelConfigWithInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelConfigWithInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelConfigWithInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelConfigWithInfo>() {
           @Override
           public void write(JsonWriter out, ChannelConfigWithInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelConfigWithInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelConfigWithInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelConfigWithInfo
   * @throws IOException if the JSON string is invalid with respect to ChannelConfigWithInfo
   */
  public static ChannelConfigWithInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelConfigWithInfo.class);
  }

  /**
   * Convert an instance of ChannelConfigWithInfo to an JSON string
   *
   * @return JSON string
   */
