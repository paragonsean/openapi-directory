...
import org.openapitools.client.api.CustomCommandsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomCommandsApi apiInstance = new CustomCommandsApi(defaultClient);
    CreateCommandRequest createCommandRequest = new CreateCommandRequest(); // CreateCommandRequest | Command
    try {
      CreateCommandResponse result = apiInstance.createCommand(createCommandRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomCommandsApi#createCommand");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DeleteCommandResponse result = apiInstance.deleteCommand(name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomCommandsApi#deleteCommand");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String name = "name_example"; // String | 
    try {
      GetCommandResponse result = apiInstance.getCommand(name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomCommandsApi#getCommand");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomCommandsApi apiInstance = new CustomCommandsApi(defaultClient);
    try {
      ListCommandsResponse result = apiInstance.listCommands();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomCommandsApi#listCommands");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomCommandsApi apiInstance = new CustomCommandsApi(defaultClient);
    String name = "name_example"; // String | 
    UpdateCommandRequest updateCommandRequest = new UpdateCommandRequest(); // UpdateCommandRequest | Command
    try {
      UpdateCommandResponse result = apiInstance.updateCommand(name, updateCommandRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomCommandsApi#updateCommand");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
