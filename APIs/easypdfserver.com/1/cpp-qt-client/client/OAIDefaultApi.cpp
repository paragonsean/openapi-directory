...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.easypdfserver.com"),
    "Main (production) server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("makePdfPost", defaultConf);
    _serverIndices.insert("makePdfPost", 0);
}
...
void OAIDefaultApi::makePdfPost(const OAI_make_pdf_post_request &oai_make_pdf_post_request) {
    QString fullPath = QString(_serverConfigs["makePdfPost"][_serverIndices.value("makePdfPost")].URL()+"/make-pdf");
...

    {
        ...
        QByteArray output = oai_make_pdf_post_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::makePdfPostCallback);
...
void OAIDefaultApi::makePdfPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT makePdfPostSignal(output);
        Q_EMIT makePdfPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT makePdfPostSignalE(output, error_type, error_str);
        Q_EMIT makePdfPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT makePdfPostSignalError(output, error_type, error_str);
        Q_EMIT makePdfPostSignalErrorFull(worker, error_type, error_str);
    }
}
