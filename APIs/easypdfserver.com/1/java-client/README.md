...
EasyPDFServer
- API version: 1
  - Build date: 2024-10-12T11:20:05.341927-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**makePdfPost**](docs/DefaultApi.md#makePdfPost) | **POST** /make-pdf | Generate a PDF from HTML or URL.


## Documentation for Models

 - [MakePdfPostRequest](docs/MakePdfPostRequest.md)
