...
public class ApiClient {
    ...
    private String basePath = "https://api.ibanapi.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key_security", new ApiKeyAuth("query", "api_key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ibanapi.com/v1
