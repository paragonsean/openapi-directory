...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.feedback.eu.pendo.io') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.feedback.eu.pendo.io
         */
        ...
        this.authentications = {
            'userApiKey (query parameter)': {type: 'apiKey', 'in': 'query', name: 'auth-token'},
            'userApiKey (request header)': {type: 'apiKey', 'in': 'header', name: 'auth-token'}
        }
