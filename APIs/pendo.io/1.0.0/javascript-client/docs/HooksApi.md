...
let apiInstance = new PendoFeedbackApi.HooksApi();
let data = new PendoFeedbackApi.HooksPostRequest(); // HooksPostRequest | 
apiInstance.hooksPost(data, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new PendoFeedbackApi.HooksApi();
let data = new PendoFeedbackApi.HooksUnsubscribePostRequest(); // HooksUnsubscribePostRequest | 
apiInstance.hooksUnsubscribePost(data, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
