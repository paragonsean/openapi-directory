...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.HooksApi();
  });
  ...
  describe('HooksApi', function() {
    ...
    describe('hooksUnsubscribePost', function() {
      it('should call hooksUnsubscribePost successfully', function(done) {
        //uncomment below and update the code to test hooksUnsubscribePost
        //instance.hooksUnsubscribePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
