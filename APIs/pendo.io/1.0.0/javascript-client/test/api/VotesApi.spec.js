...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.VotesApi();
  });
  ...
  describe('VotesApi', function() {
    describe('votesGet', function() {
      it('should call votesGet successfully', function(done) {
        //uncomment below and update the code to test votesGet
        //instance.votesGet(function(error) {
    ...
    describe('votesPost', function() {
      it('should call votesPost successfully', function(done) {
        //uncomment below and update the code to test votesPost
        //instance.votesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
