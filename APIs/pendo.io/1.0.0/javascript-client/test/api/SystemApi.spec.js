...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.SystemApi();
  });
  ...
  describe('SystemApi', function() {
    describe('healthCheckPingGet', function() {
      it('should call healthCheckPingGet successfully', function(done) {
        //uncomment below and update the code to test healthCheckPingGet
        //instance.healthCheckPingGet(function(error) {
