...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.UserApi();
  });
  ...
  describe('UserApi', function() {
    ...
    describe('usersIdTagsDelete', function() {
      it('should call usersIdTagsDelete successfully', function(done) {
        //uncomment below and update the code to test usersIdTagsDelete
        //instance.usersIdTagsDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersIdTagsGet', function() {
      it('should call usersIdTagsGet successfully', function(done) {
        //uncomment below and update the code to test usersIdTagsGet
        //instance.usersIdTagsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersIdTagsPost', function() {
      it('should call usersIdTagsPost successfully', function(done) {
        //uncomment below and update the code to test usersIdTagsPost
        //instance.usersIdTagsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersInviteEndUserPost', function() {
      it('should call usersInviteEndUserPost successfully', function(done) {
        //uncomment below and update the code to test usersInviteEndUserPost
        //instance.usersInviteEndUserPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersInviteVendorUserPost', function() {
      it('should call usersInviteVendorUserPost successfully', function(done) {
        //uncomment below and update the code to test usersInviteVendorUserPost
        //instance.usersInviteVendorUserPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vendorUsersPost', function() {
      it('should call vendorUsersPost successfully', function(done) {
        //uncomment below and update the code to test vendorUsersPost
        //instance.vendorUsersPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
