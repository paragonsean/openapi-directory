...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.TeamApi();
  });
  ...
  describe('TeamApi', function() {
    describe('usersInviteVendorUserPost_0', function() {
      it('should call usersInviteVendorUserPost_0 successfully', function(done) {
        //uncomment below and update the code to test usersInviteVendorUserPost_0
        //instance.usersInviteVendorUserPost_0(function(error) {
    ...
    describe('vendorUsersPost_0', function() {
      it('should call vendorUsersPost_0 successfully', function(done) {
        //uncomment below and update the code to test vendorUsersPost_0
        //instance.vendorUsersPost_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
