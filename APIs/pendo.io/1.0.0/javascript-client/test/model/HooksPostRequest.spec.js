...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.HooksPostRequest();
  });
  ...
  describe('HooksPostRequest', function() {
    it('should create an instance of HooksPostRequest', function() {
      // uncomment below and update the code to test HooksPostRequest
      //var instance = new PendoFeedbackApi.HooksPostRequest();
      //expect(instance).to.be.a(PendoFeedbackApi.HooksPostRequest);
    });
