...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.FeatureVote();
  });
  ...
  describe('FeatureVote', function() {
    it('should create an instance of FeatureVote', function() {
      // uncomment below and update the code to test FeatureVote
      //var instance = new PendoFeedbackApi.FeatureVote();
      //expect(instance).to.be.a(PendoFeedbackApi.FeatureVote);
    });
