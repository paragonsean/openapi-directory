...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.UsersIdPutRequest();
  });
  ...
  describe('UsersIdPutRequest', function() {
    it('should create an instance of UsersIdPutRequest', function() {
      ...
      //var instance = new PendoFeedbackApi.UsersIdPutRequest();
      //expect(instance).to.be.a(PendoFeedbackApi.UsersIdPutRequest);
    });
