...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.EndUserPingUser();
  });
  ...
  describe('EndUserPingUser', function() {
    it('should create an instance of EndUserPingUser', function() {
      // uncomment below and update the code to test EndUserPingUser
      //var instance = new PendoFeedbackApi.EndUserPingUser();
      //expect(instance).to.be.a(PendoFeedbackApi.EndUserPingUser);
    });

    it('should have the property allowedProducts (base name: "allowed_products")', function() {
      // uncomment below and update the code to test the property allowedProducts
      //var instance = new PendoFeedbackApi.EndUserPingUser();
