...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.UsersInviteEndUserPostRequest();
  });
  ...
  describe('UsersInviteEndUserPostRequest', function() {
    it('should create an instance of UsersInviteEndUserPostRequest', function() {
      // uncomment below and update the code to test UsersInviteEndUserPostRequest
      //var instance = new PendoFeedbackApi.UsersInviteEndUserPostRequest();
      //expect(instance).to.be.a(PendoFeedbackApi.UsersInviteEndUserPostRequest);
    });

    it('should have the property accountExternalId (base name: "account_external_id")', function() {
      // uncomment below and update the code to test the property accountExternalId
      //var instance = new PendoFeedbackApi.UsersInviteEndUserPostRequest();
    ...
    it('should have the property userExternalId (base name: "user_external_id")', function() {
