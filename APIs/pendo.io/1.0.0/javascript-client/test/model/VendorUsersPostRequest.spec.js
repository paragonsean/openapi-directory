...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.VendorUsersPostRequest();
  });
  ...
  describe('VendorUsersPostRequest', function() {
    it('should create an instance of VendorUsersPostRequest', function() {
      // uncomment below and update the code to test VendorUsersPostRequest
      //var instance = new PendoFeedbackApi.VendorUsersPostRequest();
      //expect(instance).to.be.a(PendoFeedbackApi.VendorUsersPostRequest);
    });
