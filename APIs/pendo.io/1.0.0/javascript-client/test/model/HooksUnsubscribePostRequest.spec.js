...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.HooksUnsubscribePostRequest();
  });
  ...
  describe('HooksUnsubscribePostRequest', function() {
    it('should create an instance of HooksUnsubscribePostRequest', function() {
      // uncomment below and update the code to test HooksUnsubscribePostRequest
      //var instance = new PendoFeedbackApi.HooksUnsubscribePostRequest();
      //expect(instance).to.be.a(PendoFeedbackApi.HooksUnsubscribePostRequest);
    });
