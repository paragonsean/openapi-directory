...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.AccountWithTags();
  });
  ...
  describe('AccountWithTags', function() {
    it('should create an instance of AccountWithTags', function() {
      // uncomment below and update the code to test AccountWithTags
      //var instance = new PendoFeedbackApi.AccountWithTags();
      //expect(instance).to.be.a(PendoFeedbackApi.AccountWithTags);
    });
    ...
    it('should have the property isPaying (base name: "is_paying")', function() {
      // uncomment below and update the code to test the property isPaying
      //var instance = new PendoFeedbackApi.AccountWithTags();
      //expect(instance).to.be();
    });
