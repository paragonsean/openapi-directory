...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.EndUserPing();
  });
  ...
  describe('EndUserPing', function() {
    it('should create an instance of EndUserPing', function() {
      // uncomment below and update the code to test EndUserPing
      //var instance = new PendoFeedbackApi.EndUserPing();
      //expect(instance).to.be.a(PendoFeedbackApi.EndUserPing);
    });
