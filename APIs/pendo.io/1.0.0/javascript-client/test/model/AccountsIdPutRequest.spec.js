...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PendoFeedbackApi.AccountsIdPutRequest();
  });
  ...
  describe('AccountsIdPutRequest', function() {
    it('should create an instance of AccountsIdPutRequest', function() {
      // uncomment below and update the code to test AccountsIdPutRequest
      //var instance = new PendoFeedbackApi.AccountsIdPutRequest();
      //expect(instance).to.be.a(PendoFeedbackApi.AccountsIdPutRequest);
    });

    it('should have the property monthlyValue (base name: "monthly_value")', function() {
      // uncomment below and update the code to test the property monthlyValue
      //var instance = new PendoFeedbackApi.AccountsIdPutRequest();
