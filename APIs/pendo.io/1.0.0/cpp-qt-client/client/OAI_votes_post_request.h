...
/*
 * OAI_votes_post_request.h
 *
 * 
 */

#ifndef OAI_votes_post_request_H
#define OAI_votes_post_request_H
...
namespace OpenAPI {
class OAIFeatureVote;

class OAI_votes_post_request : public OAIObject {
public:
    OAI_votes_post_request();
    OAI_votes_post_request(QString json);
    ~OAI_votes_post_request() override;
    ...
    QList<OAIFeatureVote> getVotes() const;
    void setVotes(const QList<OAIFeatureVote> &votes);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_votes_post_request)

#endif // OAI_votes_post_request_H
