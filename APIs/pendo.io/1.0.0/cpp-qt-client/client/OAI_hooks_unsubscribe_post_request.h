...
/*
 * OAI_hooks_unsubscribe_post_request.h
 *
 * 
 */

#ifndef OAI_hooks_unsubscribe_post_request_H
#define OAI_hooks_unsubscribe_post_request_H
...
class OAI_hooks_unsubscribe_post_request : public OAIObject {
public:
    OAI_hooks_unsubscribe_post_request();
    OAI_hooks_unsubscribe_post_request(QString json);
    ~OAI_hooks_unsubscribe_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_hooks_unsubscribe_post_request)

#endif // OAI_hooks_unsubscribe_post_request_H
