...
/*
 * OAI_users_invite_vendor_user_post_request.h
 *
 * 
 */

#ifndef OAI_users_invite_vendor_user_post_request_H
#define OAI_users_invite_vendor_user_post_request_H
...
class OAI_users_invite_vendor_user_post_request : public OAIObject {
public:
    OAI_users_invite_vendor_user_post_request();
    OAI_users_invite_vendor_user_post_request(QString json);
    ~OAI_users_invite_vendor_user_post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_users_invite_vendor_user_post_request)

#endif // OAI_users_invite_vendor_user_post_request_H
