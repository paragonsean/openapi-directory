...
#ifndef OAIEndUserPing_H
#define OAIEndUserPing_H

#include <QJsonObject>

#include "OAIAccountWithTags.h"
...
namespace OpenAPI {
class OAIAccountWithTags;
class OAIEndUserPing_user;

class OAIEndUserPing : public OAIObject {
public:
    OAIEndUserPing();
    OAIEndUserPing(QString json);
    ~OAIEndUserPing() override;
    ...
    OAIAccountWithTags getAccount() const;
    void setAccount(const OAIAccountWithTags &account);
    ...
    OAIEndUserPing_user getUser() const;
    void setUser(const OAIEndUserPing_user &user);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndUserPing)

#endif // OAIEndUserPing_H
