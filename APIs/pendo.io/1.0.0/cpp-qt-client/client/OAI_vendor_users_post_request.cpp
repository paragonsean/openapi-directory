...
OAI_vendor_users_post_request::OAI_vendor_users_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_vendor_users_post_request::OAI_vendor_users_post_request() {
    this->initializeModel();
}

OAI_vendor_users_post_request::~OAI_vendor_users_post_request() {}

void OAI_vendor_users_post_request::initializeModel() {
...
void OAI_vendor_users_post_request::fromJson(QString jsonString) {
...
void OAI_vendor_users_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_vendor_users_post_request::asJson() const {
...
QJsonObject OAI_vendor_users_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QString OAI_vendor_users_post_request::getEmail() const {
    return m_email;
}
void OAI_vendor_users_post_request::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAI_vendor_users_post_request::is_email_Set() const{
    return m_email_isSet;
}

bool OAI_vendor_users_post_request::is_email_Valid() const{
    return m_email_isValid;
}

QString OAI_vendor_users_post_request::getExternalId() const {
    return m_external_id;
}
void OAI_vendor_users_post_request::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAI_vendor_users_post_request::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAI_vendor_users_post_request::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAI_vendor_users_post_request::getFullName() const {
    return m_full_name;
}
void OAI_vendor_users_post_request::setFullName(const QString &full_name) {
    m_full_name = full_name;
    m_full_name_isSet = true;
}

bool OAI_vendor_users_post_request::is_full_name_Set() const{
    return m_full_name_isSet;
}

bool OAI_vendor_users_post_request::is_full_name_Valid() const{
    return m_full_name_isValid;
}

double OAI_vendor_users_post_request::getPermissionGroupId() const {
    return m_permission_group_id;
}
void OAI_vendor_users_post_request::setPermissionGroupId(const double &permission_group_id) {
    m_permission_group_id = permission_group_id;
    m_permission_group_id_isSet = true;
}

bool OAI_vendor_users_post_request::is_permission_group_id_Set() const{
    return m_permission_group_id_isSet;
}

bool OAI_vendor_users_post_request::is_permission_group_id_Valid() const{
    return m_permission_group_id_isValid;
}

QString OAI_vendor_users_post_request::getTeam() const {
    return m_team;
}
void OAI_vendor_users_post_request::setTeam(const QString &team) {
    m_team = team;
    m_team_isSet = true;
}

bool OAI_vendor_users_post_request::is_team_Set() const{
    return m_team_isSet;
}

bool OAI_vendor_users_post_request::is_team_Valid() const{
    return m_team_isValid;
}

bool OAI_vendor_users_post_request::isSet() const {
...
bool OAI_vendor_users_post_request::isValid() const {
