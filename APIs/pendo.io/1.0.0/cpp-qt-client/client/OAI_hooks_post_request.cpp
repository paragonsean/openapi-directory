...
#include "OAI_hooks_post_request.h"
...
OAI_hooks_post_request::OAI_hooks_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_hooks_post_request::OAI_hooks_post_request() {
    this->initializeModel();
}

OAI_hooks_post_request::~OAI_hooks_post_request() {}

void OAI_hooks_post_request::initializeModel() {
...
void OAI_hooks_post_request::fromJson(QString jsonString) {
...
void OAI_hooks_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_hooks_post_request::asJson() const {
...
QJsonObject OAI_hooks_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_event_isSet) {
...
QString OAI_hooks_post_request::getEvent() const {
    return m_event;
}
void OAI_hooks_post_request::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAI_hooks_post_request::is_event_Set() const{
    return m_event_isSet;
}

bool OAI_hooks_post_request::is_event_Valid() const{
    return m_event_isValid;
}

QString OAI_hooks_post_request::getTargetUrl() const {
    return m_target_url;
}
void OAI_hooks_post_request::setTargetUrl(const QString &target_url) {
    m_target_url = target_url;
    m_target_url_isSet = true;
}

bool OAI_hooks_post_request::is_target_url_Set() const{
    return m_target_url_isSet;
}

bool OAI_hooks_post_request::is_target_url_Valid() const{
    return m_target_url_isValid;
}

bool OAI_hooks_post_request::isSet() const {
...
bool OAI_hooks_post_request::isValid() const {
