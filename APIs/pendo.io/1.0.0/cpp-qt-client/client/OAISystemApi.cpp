...
void OAISystemApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("healthCheckPingGet", defaultConf);
    _serverIndices.insert("healthCheckPingGet", 0);
}
...
void OAISystemApi::healthCheckPingGet() {
    QString fullPath = QString(_serverConfigs["healthCheckPingGet"][_serverIndices.value("healthCheckPingGet")].URL()+"/health-check/ping");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISystemApi::healthCheckPingGetCallback);
...
void OAISystemApi::healthCheckPingGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT healthCheckPingGetSignal();
        Q_EMIT healthCheckPingGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT healthCheckPingGetSignalE(error_type, error_str);
        Q_EMIT healthCheckPingGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT healthCheckPingGetSignalError(error_type, error_str);
        Q_EMIT healthCheckPingGetSignalErrorFull(worker, error_type, error_str);
    }
}
