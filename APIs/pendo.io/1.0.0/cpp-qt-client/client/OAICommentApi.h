...
public:
    ...
    /**
    * @param[in]  case_id qint32 [required]
    */
    virtual void commentsGet(const qint32 &case_id);
...
Q_SIGNALS:
    ...
    void commentsGetSignal(QList<OAIComment> summary);


    void commentsGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIComment> summary);

    Q_DECL_DEPRECATED_X("Use commentsGetSignalError() instead")
    void commentsGetSignalE(QList<OAIComment> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void commentsGetSignalError(QList<OAIComment> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
