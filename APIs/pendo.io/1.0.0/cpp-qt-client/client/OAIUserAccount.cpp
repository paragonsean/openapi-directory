...
QString OAIUserAccount::getId() const {
    return m_id;
}
void OAIUserAccount::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
...
float OAIUserAccount::getMonthlyValue() const {
    return m_monthly_value;
}
void OAIUserAccount::setMonthlyValue(const float &monthly_value) {
    m_monthly_value = monthly_value;
    m_monthly_value_isSet = true;
}

bool OAIUserAccount::is_monthly_value_Set() const{
    return m_monthly_value_isSet;
}

bool OAIUserAccount::is_monthly_value_Valid() const{
...
QString OAIUserAccount::getStatus() const {
    return m_status;
}
void OAIUserAccount::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUserAccount::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUserAccount::is_status_Valid() const{
