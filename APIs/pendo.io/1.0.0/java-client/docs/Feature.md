...
|**effort** | **Integer** | How much Effort is assigned to the development of this Feature. Not visible to EndUsers |  [optional] |
...
|**mergedToFeatureId** | **Integer** | If this Feature was merged into another, the ID of the preserved Feature |  [optional] |
...
|**resolvedByUserId** | **Integer** |  |  [optional] |
...
|**uploads** | **List&lt;String&gt;** |  |  [optional] |
|**vendorId** | **Integer** |  |  [optional] |
|**viewCount** | **Integer** | How many times has this Feature been viewed. May only be visible to VendorUsers, depending on config |  [optional] |
