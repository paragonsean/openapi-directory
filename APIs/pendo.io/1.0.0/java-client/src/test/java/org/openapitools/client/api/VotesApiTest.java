...
/**
 * API tests for VotesApi
 */
@Disabled
public class VotesApiTest {

    private final VotesApi api = new VotesApi();

    /**
     * @throws ApiException if the Api call fails
     */
    @Test
    public void votesGetTest() throws ApiException {
        Integer userId = null;
        ...
        List<Vote> response = api.votesGet(userId, featureId, positive, negative, offset, limit);
     ...
     */
    @Test
    public void votesPostTest() throws ApiException {
        VotesPostRequest data = null;
        api.votesPost(data);
        // TODO: test validations
    }
