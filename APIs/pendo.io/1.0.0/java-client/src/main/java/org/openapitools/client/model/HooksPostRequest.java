...
public class HooksPostRequest {
  ...
  public HooksPostRequest() {
  }

  public HooksPostRequest event(String event) {
    this.event = event;
    return this;
  }
  ...
  public HooksPostRequest targetUrl(String targetUrl) {
  ...
  public boolean equals(Object o) {
    ...
    HooksPostRequest hooksPostRequest = (HooksPostRequest) o;
    return Objects.equals(this.event, hooksPostRequest.event) &&
        Objects.equals(this.targetUrl, hooksPostRequest.targetUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class HooksPostRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HooksPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HooksPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HooksPostRequest is not found in the empty JSON string", HooksPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HooksPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HooksPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HooksPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HooksPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HooksPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HooksPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<HooksPostRequest>() {
           @Override
           public void write(JsonWriter out, HooksPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HooksPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HooksPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HooksPostRequest
   * @throws IOException if the JSON string is invalid with respect to HooksPostRequest
   */
  public static HooksPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HooksPostRequest.class);
  }

  /**
   * Convert an instance of HooksPostRequest to an JSON string
   *
   * @return JSON string
   */
