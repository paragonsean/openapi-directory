...
public class ApiClient {
    ...
    private String basePath = "https://api.feedback.eu.pendo.io";
    ...
    public ApiClient() {
        ...
        authentications.put("userApiKey (query parameter)", new ApiKeyAuth("query", "auth-token"));
        authentications.put("userApiKey (request header)", new ApiKeyAuth("header", "auth-token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.feedback.eu.pendo.io
