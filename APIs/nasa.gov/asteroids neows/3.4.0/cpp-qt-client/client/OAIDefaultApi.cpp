...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://techport.nasa.gov/api"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://techport.nasa.gov/api"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("apiGet", defaultConf);
    _serverIndices.insert("apiGet", 0);
    _serverConfigs.insert("apiProjectsFormatGet", defaultConf);
    _serverIndices.insert("apiProjectsFormatGet", 0);
    _serverConfigs.insert("apiProjectsIdFormatGet", defaultConf);
    _serverIndices.insert("apiProjectsIdFormatGet", 0);
}
...
void OAIDefaultApi::apiProjectsFormatGet(const QDate &updated_since, const QString &format, const QString &_format) {
    QString fullPath = QString(_serverConfigs["apiProjectsFormatGet"][_serverIndices.value("apiProjectsFormatGet")].URL()+"/api/projects{.format}");
    
    
    {
        QString _formatPathParam("{");
        _formatPathParam.append(".format").append("}");
        ...
        fullPath.replace(_formatPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(_format)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::apiProjectsFormatGetCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::apiProjectsFormatGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAI_api_projects__format__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiProjectsFormatGetSignal(output);
        Q_EMIT apiProjectsFormatGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiProjectsFormatGetSignalE(output, error_type, error_str);
        Q_EMIT apiProjectsFormatGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiProjectsFormatGetSignalError(output, error_type, error_str);
        Q_EMIT apiProjectsFormatGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::apiProjectsIdFormatGet(const qint64 &id, const QString &format, const QString &_format) {
    QString fullPath = QString(_serverConfigs["apiProjectsIdFormatGet"][_serverIndices.value("apiProjectsIdFormatGet")].URL()+"/api/projects/{id}{.format}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::apiProjectsIdFormatGetCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::apiProjectsIdFormatGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiProjectsIdFormatGetSignal(output);
        Q_EMIT apiProjectsIdFormatGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiProjectsIdFormatGetSignalE(output, error_type, error_str);
        Q_EMIT apiProjectsIdFormatGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiProjectsIdFormatGetSignalError(output, error_type, error_str);
        Q_EMIT apiProjectsIdFormatGetSignalErrorFull(worker, error_type, error_str);
    }
}
