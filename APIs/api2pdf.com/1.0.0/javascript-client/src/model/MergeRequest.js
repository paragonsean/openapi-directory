...
class MergeRequest {
    ...
    constructor(urls) { 
        ...
        MergeRequest.initialize(this, urls);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of MergeRequest.RequiredProperties) {
...
MergeRequest.RequiredProperties = ["urls"];

/**
 * @member {String} fileName
 */
MergeRequest.prototype['fileName'] = undefined;

/**
 * @member {Boolean} inlinePdf
 */
MergeRequest.prototype['inlinePdf'] = undefined;

/**
 * @member {Array.<String>} urls
 */
MergeRequest.prototype['urls'] = undefined;
