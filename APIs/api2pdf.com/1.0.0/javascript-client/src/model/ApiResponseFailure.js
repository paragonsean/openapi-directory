...
/**
 * The ApiResponseFailure model module.
 * @module model/ApiResponseFailure
 * @version 1.0.0
 */
class ApiResponseFailure {
    /**
     * Constructs a new <code>ApiResponseFailure</code>.
     * @alias module:model/ApiResponseFailure
     */
    constructor() { 
        
        ApiResponseFailure.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiResponseFailure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiResponseFailure} obj Optional instance to populate.
     * @return {module:model/ApiResponseFailure} The populated <code>ApiResponseFailure</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiResponseFailure();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiResponseFailure</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiResponseFailure</code>.
     */
 ...
 */
ApiResponseFailure.prototype['reason'] = undefined;

/**
 * Will be false if the operation failed
 * @member {Boolean} success
 */
ApiResponseFailure.prototype['success'] = undefined;
...
export default ApiResponseFailure;
