...
/**
 * The ApiResponseSuccess model module.
 * @module model/ApiResponseSuccess
 * @version 1.0.0
 */
class ApiResponseSuccess {
    /**
     * Constructs a new <code>ApiResponseSuccess</code>.
     * @alias module:model/ApiResponseSuccess
     */
    constructor() { 
        
        ApiResponseSuccess.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiResponseSuccess</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiResponseSuccess} obj Optional instance to populate.
     * @return {module:model/ApiResponseSuccess} The populated <code>ApiResponseSuccess</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiResponseSuccess();

            if (data.hasOwnProperty('cost')) {
                obj['cost'] = ApiClient.convertToType(data['cost'], 'Number');
            }
            if (data.hasOwnProperty('mbIn')) {
                obj['mbIn'] = ApiClient.convertToType(data['mbIn'], 'Number');
            }
            if (data.hasOwnProperty('mbOut')) {
                obj['mbOut'] = ApiClient.convertToType(data['mbOut'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiResponseSuccess</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiResponseSuccess</code>.
     */
