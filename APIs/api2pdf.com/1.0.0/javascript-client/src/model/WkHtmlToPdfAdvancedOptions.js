...
/**
 * The WkHtmlToPdfAdvancedOptions model module.
 * @module model/WkHtmlToPdfAdvancedOptions
 * @version 1.0.0
 */
class WkHtmlToPdfAdvancedOptions {
    /**
     * Constructs a new <code>WkHtmlToPdfAdvancedOptions</code>.
     * @alias module:model/WkHtmlToPdfAdvancedOptions
     */
    constructor() { 
        
        WkHtmlToPdfAdvancedOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WkHtmlToPdfAdvancedOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WkHtmlToPdfAdvancedOptions} obj Optional instance to populate.
     * @return {module:model/WkHtmlToPdfAdvancedOptions} The populated <code>WkHtmlToPdfAdvancedOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WkHtmlToPdfAdvancedOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>WkHtmlToPdfAdvancedOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WkHtmlToPdfAdvancedOptions</code>.
     */
 ...
 */
WkHtmlToPdfAdvancedOptions.prototype['orientation'] = undefined;

/**
 * @member {String} pageSize
 */
WkHtmlToPdfAdvancedOptions.prototype['pageSize'] = undefined;
...
export default WkHtmlToPdfAdvancedOptions;
