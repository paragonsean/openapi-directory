...
/**
* MergeCombinePdfs service.
* @module api/MergeCombinePdfsApi
* @version 1.0.0
*/
export default class MergeCombinePdfsApi {

    /**
    * Constructs a new MergeCombinePdfsApi. 
    * @alias module:api/MergeCombinePdfsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the mergePost operation.
     * @callback module:api/MergeCombinePdfsApi~mergePostCallback
