...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://v2018.api2pdf.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://v2018.api2pdf.com
         */
        ...
        this.authentications = {
            'HeaderApiKey': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
            'QueryApiKey': {type: 'apiKey', 'in': 'query', name: 'apikey'}
        }
