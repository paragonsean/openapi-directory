...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.MergeCombinePdfsApi();
  });
  ...
  describe('MergeCombinePdfsApi', function() {
    describe('mergePost', function() {
      it('should call mergePost successfully', function(done) {
        //uncomment below and update the code to test mergePost
        //instance.mergePost(function(error) {
