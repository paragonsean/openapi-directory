...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.HeadlessChromeApi();
  });
  ...
  describe('HeadlessChromeApi', function() {
    describe('chromeFromHtmlPost', function() {
      it('should call chromeFromHtmlPost successfully', function(done) {
        //uncomment below and update the code to test chromeFromHtmlPost
        //instance.chromeFromHtmlPost(function(error) {
    ...
    describe('chromeFromUrlGET', function() {
      it('should call chromeFromUrlGET successfully', function(done) {
        //uncomment below and update the code to test chromeFromUrlGET
        //instance.chromeFromUrlGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('chromeFromUrlPost', function() {
      it('should call chromeFromUrlPost successfully', function(done) {
        //uncomment below and update the code to test chromeFromUrlPost
        //instance.chromeFromUrlPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
