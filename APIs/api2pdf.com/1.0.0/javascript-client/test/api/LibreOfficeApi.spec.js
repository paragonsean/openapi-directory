...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.LibreOfficeApi();
  });
  ...
  describe('LibreOfficeApi', function() {
    describe('libreConvertPost', function() {
      it('should call libreConvertPost successfully', function(done) {
        //uncomment below and update the code to test libreConvertPost
        //instance.libreConvertPost(function(error) {
