...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkhtmltopdfApi();
  });
  ...
  describe('WkhtmltopdfApi', function() {
    describe('wkhtmltopdfFromHtmlPost', function() {
      it('should call wkhtmltopdfFromHtmlPost successfully', function(done) {
        //uncomment below and update the code to test wkhtmltopdfFromHtmlPost
        //instance.wkhtmltopdfFromHtmlPost(function(error) {
    ...
    describe('wkhtmltopdfFromUrlGET', function() {
      it('should call wkhtmltopdfFromUrlGET successfully', function(done) {
        //uncomment below and update the code to test wkhtmltopdfFromUrlGET
        //instance.wkhtmltopdfFromUrlGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('wkhtmltopdfFromUrlPost', function() {
      it('should call wkhtmltopdfFromUrlPost successfully', function(done) {
        //uncomment below and update the code to test wkhtmltopdfFromUrlPost
        //instance.wkhtmltopdfFromUrlPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
