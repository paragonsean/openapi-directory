...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ZXINGZebraCrossingBarCodesApi();
  });
  ...
  describe('ZXINGZebraCrossingBarCodesApi', function() {
    describe('zebraGET', function() {
      it('should call zebraGET successfully', function(done) {
        //uncomment below and update the code to test zebraGET
        //instance.zebraGET(function(error) {
