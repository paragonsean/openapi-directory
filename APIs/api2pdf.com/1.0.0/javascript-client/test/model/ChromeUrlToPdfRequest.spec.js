...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ChromeUrlToPdfRequest();
  });
  ...
  describe('ChromeUrlToPdfRequest', function() {
    it('should create an instance of ChromeUrlToPdfRequest', function() {
      // uncomment below and update the code to test ChromeUrlToPdfRequest
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ChromeUrlToPdfRequest();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.ChromeUrlToPdfRequest);
    });
