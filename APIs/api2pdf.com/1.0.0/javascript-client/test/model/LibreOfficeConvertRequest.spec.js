...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.LibreOfficeConvertRequest();
  });
  ...
  describe('LibreOfficeConvertRequest', function() {
    it('should create an instance of LibreOfficeConvertRequest', function() {
      // uncomment below and update the code to test LibreOfficeConvertRequest
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.LibreOfficeConvertRequest();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.LibreOfficeConvertRequest);
    });
