...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfHtmlToPdfRequest();
  });
  ...
  describe('WkHtmlToPdfHtmlToPdfRequest', function() {
    it('should create an instance of WkHtmlToPdfHtmlToPdfRequest', function() {
      // uncomment below and update the code to test WkHtmlToPdfHtmlToPdfRequest
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfHtmlToPdfRequest();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfHtmlToPdfRequest);
    });
