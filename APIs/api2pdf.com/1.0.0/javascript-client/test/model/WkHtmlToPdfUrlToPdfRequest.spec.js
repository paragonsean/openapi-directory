...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfUrlToPdfRequest();
  });
  ...
  describe('WkHtmlToPdfUrlToPdfRequest', function() {
    it('should create an instance of WkHtmlToPdfUrlToPdfRequest', function() {
      // uncomment below and update the code to test WkHtmlToPdfUrlToPdfRequest
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfUrlToPdfRequest();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfUrlToPdfRequest);
    });
    ...
    it('should have the property inlinePdf (base name: "inlinePdf")', function() {
      // uncomment below and update the code to test the property inlinePdf
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfUrlToPdfRequest();
      //expect(instance).to.be();
    });
