...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.MergeRequest();
  });
  ...
  describe('MergeRequest', function() {
    it('should create an instance of MergeRequest', function() {
      ...
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.MergeRequest();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.MergeRequest);
    });
