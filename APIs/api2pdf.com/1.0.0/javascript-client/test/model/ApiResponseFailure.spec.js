...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseFailure();
  });
  ...
  describe('ApiResponseFailure', function() {
    it('should create an instance of ApiResponseFailure', function() {
      // uncomment below and update the code to test ApiResponseFailure
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseFailure();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseFailure);
    });
