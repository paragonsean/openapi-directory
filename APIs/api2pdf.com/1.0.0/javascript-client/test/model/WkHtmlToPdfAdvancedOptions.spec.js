...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfAdvancedOptions();
  });
  ...
  describe('WkHtmlToPdfAdvancedOptions', function() {
    it('should create an instance of WkHtmlToPdfAdvancedOptions', function() {
      // uncomment below and update the code to test WkHtmlToPdfAdvancedOptions
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfAdvancedOptions();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.WkHtmlToPdfAdvancedOptions);
    });
