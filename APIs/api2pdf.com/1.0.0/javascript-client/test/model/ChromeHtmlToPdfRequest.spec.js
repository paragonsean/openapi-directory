...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ChromeHtmlToPdfRequest();
  });
  ...
  describe('ChromeHtmlToPdfRequest', function() {
    it('should create an instance of ChromeHtmlToPdfRequest', function() {
      // uncomment below and update the code to test ChromeHtmlToPdfRequest
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ChromeHtmlToPdfRequest();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.ChromeHtmlToPdfRequest);
    });
