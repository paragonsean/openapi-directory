...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseSuccess();
  });
  ...
  describe('ApiResponseSuccess', function() {
    it('should create an instance of ApiResponseSuccess', function() {
      // uncomment below and update the code to test ApiResponseSuccess
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseSuccess();
      //expect(instance).to.be.a(Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseSuccess);
    });
    ...
    it('should have the property mbIn (base name: "mbIn")', function() {
      // uncomment below and update the code to test the property mbIn
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseSuccess();
      //expect(instance).to.be();
    });

    it('should have the property mbOut (base name: "mbOut")', function() {
      // uncomment below and update the code to test the property mbOut
      //var instance = new Api2PdfPdfGenerationPoweredByAwsLambda.ApiResponseSuccess();
      //expect(instance).to.be();
    });
