...
/**
 * API tests for ZxingZebraCrossingBarCodesApi
 */
@Disabled
public class ZxingZebraCrossingBarCodesApiTest {

    private final ZxingZebraCrossingBarCodesApi api = new ZxingZebraCrossingBarCodesApi();
     ...
     */
    @Test
    public void zebraGETTest() throws ApiException {
        String format = null;
        String value = null;
        Boolean showlabel = null;
        Integer height = null;
        Integer width = null;
        File response = api.zebraGET(format, value, showlabel, height, width);
