...
/**
 * API tests for WkhtmltopdfApi
 */
@Disabled
public class WkhtmltopdfApiTest {

    private final WkhtmltopdfApi api = new WkhtmltopdfApi();
     ...
     */
    @Test
    public void wkhtmltopdfFromHtmlPostTest() throws ApiException {
        WkHtmlToPdfHtmlToPdfRequest wkHtmlToPdfHtmlToPdfRequest = null;
        ApiResponseSuccess response = api.wkhtmltopdfFromHtmlPost(wkHtmlToPdfHtmlToPdfRequest);
     ...
     */
    @Test
    public void wkhtmltopdfFromUrlGETTest() throws ApiException {
        String url = null;
        String output = null;
        ApiResponseSuccess response = api.wkhtmltopdfFromUrlGET(url, output);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void wkhtmltopdfFromUrlPostTest() throws ApiException {
        WkHtmlToPdfUrlToPdfRequest wkHtmlToPdfUrlToPdfRequest = null;
        ApiResponseSuccess response = api.wkhtmltopdfFromUrlPost(wkHtmlToPdfUrlToPdfRequest);
        // TODO: test validations
    }
