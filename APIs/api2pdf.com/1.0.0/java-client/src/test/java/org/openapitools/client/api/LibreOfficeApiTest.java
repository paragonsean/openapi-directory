...
/**
 * API tests for LibreOfficeApi
 */
@Disabled
public class LibreOfficeApiTest {

    private final LibreOfficeApi api = new LibreOfficeApi();
     ...
     */
    @Test
    public void libreConvertPostTest() throws ApiException {
        LibreOfficeConvertRequest libreOfficeConvertRequest = null;
        ApiResponseSuccess response = api.libreConvertPost(libreOfficeConvertRequest);
