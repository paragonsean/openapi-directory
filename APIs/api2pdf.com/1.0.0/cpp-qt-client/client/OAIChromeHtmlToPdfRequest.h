...
/*
 * OAIChromeHtmlToPdfRequest.h
 *
 * 
 */

#ifndef OAIChromeHtmlToPdfRequest_H
#define OAIChromeHtmlToPdfRequest_H
...
class OAIChromeHtmlToPdfRequest : public OAIObject {
public:
    OAIChromeHtmlToPdfRequest();
    OAIChromeHtmlToPdfRequest(QString json);
    ~OAIChromeHtmlToPdfRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChromeHtmlToPdfRequest)

#endif // OAIChromeHtmlToPdfRequest_H
