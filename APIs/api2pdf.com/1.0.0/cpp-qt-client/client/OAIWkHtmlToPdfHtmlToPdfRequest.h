...
/*
 * OAIWkHtmlToPdfHtmlToPdfRequest.h
 *
 * 
 */

#ifndef OAIWkHtmlToPdfHtmlToPdfRequest_H
#define OAIWkHtmlToPdfHtmlToPdfRequest_H
...
namespace OpenAPI {
class OAIWkHtmlToPdfAdvancedOptions;

class OAIWkHtmlToPdfHtmlToPdfRequest : public OAIObject {
public:
    OAIWkHtmlToPdfHtmlToPdfRequest();
    OAIWkHtmlToPdfHtmlToPdfRequest(QString json);
    ~OAIWkHtmlToPdfHtmlToPdfRequest() override;
    ...
    OAIWkHtmlToPdfAdvancedOptions getOptions() const;
    void setOptions(const OAIWkHtmlToPdfAdvancedOptions &options);
...
private:
    ...
    OAIWkHtmlToPdfAdvancedOptions m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWkHtmlToPdfHtmlToPdfRequest)

#endif // OAIWkHtmlToPdfHtmlToPdfRequest_H
