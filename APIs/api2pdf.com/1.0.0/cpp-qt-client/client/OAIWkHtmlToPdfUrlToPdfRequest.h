...
/*
 * OAIWkHtmlToPdfUrlToPdfRequest.h
 *
 * 
 */

#ifndef OAIWkHtmlToPdfUrlToPdfRequest_H
#define OAIWkHtmlToPdfUrlToPdfRequest_H
...
class OAIWkHtmlToPdfUrlToPdfRequest : public OAIObject {
public:
    OAIWkHtmlToPdfUrlToPdfRequest();
    OAIWkHtmlToPdfUrlToPdfRequest(QString json);
    ~OAIWkHtmlToPdfUrlToPdfRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWkHtmlToPdfUrlToPdfRequest)

#endif // OAIWkHtmlToPdfUrlToPdfRequest_H
