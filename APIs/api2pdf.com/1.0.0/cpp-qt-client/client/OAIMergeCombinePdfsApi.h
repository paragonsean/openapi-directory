...
#ifndef OAI_OAIMergeCombinePdfsApi_H
#define OAI_OAIMergeCombinePdfsApi_H
...
class OAIMergeCombinePdfsApi : public QObject {
    Q_OBJECT

public:
    OAIMergeCombinePdfsApi(const int timeOut = 0);
    ~OAIMergeCombinePdfsApi();
    ...
    /**
    * @param[in]  oai_merge_request OAIMergeRequest [optional]
    */
    virtual void mergePost(const ::OpenAPI::OptionalParam<OAIMergeRequest> &oai_merge_request = ::OpenAPI::OptionalParam<OAIMergeRequest>());
...
private:
    ...
    void mergePostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void mergePostSignal(OAIApiResponseSuccess summary);


    void mergePostSignalFull(OAIHttpRequestWorker *worker, OAIApiResponseSuccess summary);

    Q_DECL_DEPRECATED_X("Use mergePostSignalError() instead")
    void mergePostSignalE(OAIApiResponseSuccess summary, QNetworkReply::NetworkError error_type, QString error_str);
    void mergePostSignalError(OAIApiResponseSuccess summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use mergePostSignalErrorFull() instead")
    void mergePostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void mergePostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
