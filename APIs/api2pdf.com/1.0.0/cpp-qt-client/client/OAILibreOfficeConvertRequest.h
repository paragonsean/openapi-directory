...
/*
 * OAILibreOfficeConvertRequest.h
 *
 * 
 */

#ifndef OAILibreOfficeConvertRequest_H
#define OAILibreOfficeConvertRequest_H
...
class OAILibreOfficeConvertRequest : public OAIObject {
public:
    OAILibreOfficeConvertRequest();
    OAILibreOfficeConvertRequest(QString json);
    ~OAILibreOfficeConvertRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILibreOfficeConvertRequest)

#endif // OAILibreOfficeConvertRequest_H
