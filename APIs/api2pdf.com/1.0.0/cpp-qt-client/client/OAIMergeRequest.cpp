...
QString OAIMergeRequest::getFileName() const {
    return m_file_name;
}
void OAIMergeRequest::setFileName(const QString &file_name) {
    m_file_name = file_name;
    m_file_name_isSet = true;
}

bool OAIMergeRequest::is_file_name_Set() const{
    return m_file_name_isSet;
}

bool OAIMergeRequest::is_file_name_Valid() const{
    return m_file_name_isValid;
}

bool OAIMergeRequest::isInlinePdf() const {
    return m_inline_pdf;
}
void OAIMergeRequest::setInlinePdf(const bool &inline_pdf) {
    m_inline_pdf = inline_pdf;
    m_inline_pdf_isSet = true;
}

bool OAIMergeRequest::is_inline_pdf_Set() const{
    return m_inline_pdf_isSet;
}

bool OAIMergeRequest::is_inline_pdf_Valid() const{
    return m_inline_pdf_isValid;
}

QList<QString> OAIMergeRequest::getUrls() const {
    return m_urls;
}
void OAIMergeRequest::setUrls(const QList<QString> &urls) {
    m_urls = urls;
    m_urls_isSet = true;
}

bool OAIMergeRequest::is_urls_Set() const{
    return m_urls_isSet;
}

bool OAIMergeRequest::is_urls_Valid() const{
