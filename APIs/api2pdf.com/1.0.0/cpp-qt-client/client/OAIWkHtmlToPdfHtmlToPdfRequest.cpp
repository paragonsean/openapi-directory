...
OAIWkHtmlToPdfHtmlToPdfRequest::OAIWkHtmlToPdfHtmlToPdfRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWkHtmlToPdfHtmlToPdfRequest::OAIWkHtmlToPdfHtmlToPdfRequest() {
    this->initializeModel();
}

OAIWkHtmlToPdfHtmlToPdfRequest::~OAIWkHtmlToPdfHtmlToPdfRequest() {}

void OAIWkHtmlToPdfHtmlToPdfRequest::initializeModel() {
...
void OAIWkHtmlToPdfHtmlToPdfRequest::fromJson(QString jsonString) {
...
void OAIWkHtmlToPdfHtmlToPdfRequest::fromJsonObject(QJsonObject json) {
...
QString OAIWkHtmlToPdfHtmlToPdfRequest::asJson() const {
...
QJsonObject OAIWkHtmlToPdfHtmlToPdfRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWkHtmlToPdfHtmlToPdfRequest::getFileName() const {
    return m_file_name;
}
void OAIWkHtmlToPdfHtmlToPdfRequest::setFileName(const QString &file_name) {
    m_file_name = file_name;
    m_file_name_isSet = true;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_file_name_Set() const{
    return m_file_name_isSet;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_file_name_Valid() const{
    return m_file_name_isValid;
}

QString OAIWkHtmlToPdfHtmlToPdfRequest::getHtml() const {
    return m_html;
}
void OAIWkHtmlToPdfHtmlToPdfRequest::setHtml(const QString &html) {
    m_html = html;
    m_html_isSet = true;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_html_Set() const{
    return m_html_isSet;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_html_Valid() const{
    return m_html_isValid;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::isInlinePdf() const {
    return m_inline_pdf;
}
void OAIWkHtmlToPdfHtmlToPdfRequest::setInlinePdf(const bool &inline_pdf) {
    m_inline_pdf = inline_pdf;
    m_inline_pdf_isSet = true;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_inline_pdf_Set() const{
    return m_inline_pdf_isSet;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_inline_pdf_Valid() const{
    return m_inline_pdf_isValid;
}

OAIWkHtmlToPdfAdvancedOptions OAIWkHtmlToPdfHtmlToPdfRequest::getOptions() const {
    return m_options;
}
void OAIWkHtmlToPdfHtmlToPdfRequest::setOptions(const OAIWkHtmlToPdfAdvancedOptions &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_options_Set() const{
    return m_options_isSet;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::is_options_Valid() const{
    return m_options_isValid;
}

bool OAIWkHtmlToPdfHtmlToPdfRequest::isSet() const {
...
bool OAIWkHtmlToPdfHtmlToPdfRequest::isValid() const {
