...
/*
 * OAIWkHtmlToPdfAdvancedOptions.h
 *
 * 
 */

#ifndef OAIWkHtmlToPdfAdvancedOptions_H
#define OAIWkHtmlToPdfAdvancedOptions_H
...
class OAIWkHtmlToPdfAdvancedOptions : public OAIObject {
public:
    OAIWkHtmlToPdfAdvancedOptions();
    OAIWkHtmlToPdfAdvancedOptions(QString json);
    ~OAIWkHtmlToPdfAdvancedOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWkHtmlToPdfAdvancedOptions)

#endif // OAIWkHtmlToPdfAdvancedOptions_H
