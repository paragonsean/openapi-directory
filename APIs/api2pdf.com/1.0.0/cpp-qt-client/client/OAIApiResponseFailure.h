...
/*
 * OAIApiResponseFailure.h
 *
 * 
 */

#ifndef OAIApiResponseFailure_H
#define OAIApiResponseFailure_H
...
class OAIApiResponseFailure : public OAIObject {
public:
    OAIApiResponseFailure();
    OAIApiResponseFailure(QString json);
    ~OAIApiResponseFailure() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiResponseFailure)

#endif // OAIApiResponseFailure_H
