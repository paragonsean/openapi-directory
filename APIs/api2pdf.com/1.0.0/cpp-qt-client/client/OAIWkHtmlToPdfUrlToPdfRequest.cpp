...
OAIWkHtmlToPdfUrlToPdfRequest::OAIWkHtmlToPdfUrlToPdfRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWkHtmlToPdfUrlToPdfRequest::OAIWkHtmlToPdfUrlToPdfRequest() {
    this->initializeModel();
}

OAIWkHtmlToPdfUrlToPdfRequest::~OAIWkHtmlToPdfUrlToPdfRequest() {}

void OAIWkHtmlToPdfUrlToPdfRequest::initializeModel() {
...
void OAIWkHtmlToPdfUrlToPdfRequest::fromJson(QString jsonString) {
...
void OAIWkHtmlToPdfUrlToPdfRequest::fromJsonObject(QJsonObject json) {
...
QString OAIWkHtmlToPdfUrlToPdfRequest::asJson() const {
...
QJsonObject OAIWkHtmlToPdfUrlToPdfRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWkHtmlToPdfUrlToPdfRequest::getFileName() const {
    return m_file_name;
}
void OAIWkHtmlToPdfUrlToPdfRequest::setFileName(const QString &file_name) {
    m_file_name = file_name;
    m_file_name_isSet = true;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_file_name_Set() const{
    return m_file_name_isSet;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_file_name_Valid() const{
    return m_file_name_isValid;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::isInlinePdf() const {
    return m_inline_pdf;
}
void OAIWkHtmlToPdfUrlToPdfRequest::setInlinePdf(const bool &inline_pdf) {
    m_inline_pdf = inline_pdf;
    m_inline_pdf_isSet = true;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_inline_pdf_Set() const{
    return m_inline_pdf_isSet;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_inline_pdf_Valid() const{
    return m_inline_pdf_isValid;
}

OAIWkHtmlToPdfAdvancedOptions OAIWkHtmlToPdfUrlToPdfRequest::getOptions() const {
    return m_options;
}
void OAIWkHtmlToPdfUrlToPdfRequest::setOptions(const OAIWkHtmlToPdfAdvancedOptions &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_options_Set() const{
    return m_options_isSet;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_options_Valid() const{
    return m_options_isValid;
}

QString OAIWkHtmlToPdfUrlToPdfRequest::getUrl() const {
    return m_url;
}
void OAIWkHtmlToPdfUrlToPdfRequest::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIWkHtmlToPdfUrlToPdfRequest::isSet() const {
...
bool OAIWkHtmlToPdfUrlToPdfRequest::isValid() const {
