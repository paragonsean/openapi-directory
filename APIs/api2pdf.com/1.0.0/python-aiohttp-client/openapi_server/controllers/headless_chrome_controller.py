...
async def chrome_from_html_post(request: web.Request, body=None) -> web.Response:
    ...
    """
    body = ChromeHtmlToPdfRequest.from_dict(body)
    return web.Response(status=200)


async def chrome_from_url_get(request: web.Request, url, output=None) -> web.Response:
    """Convert URL to PDF
...
async def chrome_from_url_post(request: web.Request, body=None) -> web.Response:
    """Convert URL to PDF
    ...
    """
    body = ChromeUrlToPdfRequest.from_dict(body)
    return web.Response(status=200)
