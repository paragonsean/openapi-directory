...
public:
    ...
    */
    virtual void rootGet(const QString &key, const QString &ip, const ::OpenAPI::OptionalParam<QString> &format = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &lang = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void rootGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
