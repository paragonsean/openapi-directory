...
void OAIDefaultApi::rootGet(const QString &key, const QString &ip, const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &lang) {
...
void OAIDefaultApi::rootGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT rootGetSignal();
        Q_EMIT rootGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT rootGetSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT rootGetSignalError(error_type, error_str);
