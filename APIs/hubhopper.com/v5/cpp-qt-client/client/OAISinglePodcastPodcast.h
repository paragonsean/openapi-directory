...
/*
 * OAISinglePodcastPodcast.h
 *
 * 
 */

#ifndef OAISinglePodcastPodcast_H
#define OAISinglePodcastPodcast_H
...
class OAISinglePodcastPodcast : public OAIObject {
public:
    OAISinglePodcastPodcast();
    OAISinglePodcastPodcast(QString json);
    ~OAISinglePodcastPodcast() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISinglePodcastPodcast)

#endif // OAISinglePodcastPodcast_H
