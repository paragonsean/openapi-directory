...
void Example::exampleFunction1(){
     OAICategoryApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAICategoryApi::categoriesCategoryIdGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAICategoryApi::categoriesCategoryIdGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString category_id = create(); // QString | Unique qualifier for a category.
