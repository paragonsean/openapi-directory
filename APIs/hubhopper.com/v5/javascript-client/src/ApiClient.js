...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://apis.hubhopper.com/partner') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://apis.hubhopper.com/partner
         */
        ...
        this.authentications = {
            ...
            'partner_id': {type: 'apiKey', 'in': 'header', name: 'hhPartnerId'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v5/Javascript'
        };
