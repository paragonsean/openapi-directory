...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HubhopperPartnerIntegrationApiSProduction.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new HubhopperPartnerIntegrationApiSProduction.Error();
      //expect(instance).to.be.a(HubhopperPartnerIntegrationApiSProduction.Error);
    });
