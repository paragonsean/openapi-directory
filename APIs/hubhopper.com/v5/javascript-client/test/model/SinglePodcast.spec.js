...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HubhopperPartnerIntegrationApiSProduction.SinglePodcast();
  });
  ...
  describe('SinglePodcast', function() {
    it('should create an instance of SinglePodcast', function() {
      // uncomment below and update the code to test SinglePodcast
      //var instance = new HubhopperPartnerIntegrationApiSProduction.SinglePodcast();
      //expect(instance).to.be.a(HubhopperPartnerIntegrationApiSProduction.SinglePodcast);
    });
