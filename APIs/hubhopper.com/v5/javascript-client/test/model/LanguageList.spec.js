...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HubhopperPartnerIntegrationApiSProduction.LanguageList();
  });
  ...
  describe('LanguageList', function() {
    it('should create an instance of LanguageList', function() {
      // uncomment below and update the code to test LanguageList
      //var instance = new HubhopperPartnerIntegrationApiSProduction.LanguageList();
      //expect(instance).to.be.a(HubhopperPartnerIntegrationApiSProduction.LanguageList);
    });
