...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HubhopperPartnerIntegrationApiSProduction.CategoryList();
  });
  ...
  describe('CategoryList', function() {
    it('should create an instance of CategoryList', function() {
      ...
      //var instance = new HubhopperPartnerIntegrationApiSProduction.CategoryList();
      //expect(instance).to.be.a(HubhopperPartnerIntegrationApiSProduction.CategoryList);
    });
