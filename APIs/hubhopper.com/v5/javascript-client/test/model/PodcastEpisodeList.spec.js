...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HubhopperPartnerIntegrationApiSProduction.PodcastEpisodeList();
  });
  ...
  describe('PodcastEpisodeList', function() {
    it('should create an instance of PodcastEpisodeList', function() {
      ...
      //var instance = new HubhopperPartnerIntegrationApiSProduction.PodcastEpisodeList();
      //expect(instance).to.be.a(HubhopperPartnerIntegrationApiSProduction.PodcastEpisodeList);
    });
