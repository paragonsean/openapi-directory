...
public class ConnectionUpdate {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.breakingChange, connectionUpdate.breakingChange) &&
        Objects.equals(this.connectionId, connectionUpdate.connectionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(breakingChange, connectionId, geography, name, namespaceDefinition, namespaceFormat, nonBreakingChangesPreference, notifySchemaChanges, operationIds, prefix, resourceRequirements, schedule, scheduleData, scheduleType, sourceCatalogId, status, syncCatalog);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionUpdate is not found in the empty JSON string", ConnectionUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectionUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectionUpdate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionUpdate>() {
           @Override
           public void write(JsonWriter out, ConnectionUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectionUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectionUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectionUpdate
   * @throws IOException if the JSON string is invalid with respect to ConnectionUpdate
   */
  public static ConnectionUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionUpdate.class);
  }

  /**
   * Convert an instance of ConnectionUpdate to an JSON string
   *
   * @return JSON string
   */
