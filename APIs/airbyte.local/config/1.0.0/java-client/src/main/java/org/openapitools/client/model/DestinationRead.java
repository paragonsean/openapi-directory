...
public class DestinationRead {
  ...
  public DestinationRead connectionConfiguration(Object connectionConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectionConfiguration, destinationRead.connectionConfiguration) &&
        Objects.equals(this.destinationDefinitionId, destinationRead.destinationDefinitionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionConfiguration, destinationDefinitionId, destinationId, destinationName, icon, name, workspaceId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinationRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinationRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestinationRead is not found in the empty JSON string", DestinationRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinationRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DestinationRead.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestinationRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestinationRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestinationRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestinationRead.class));

       return (TypeAdapter<T>) new TypeAdapter<DestinationRead>() {
           @Override
           public void write(JsonWriter out, DestinationRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DestinationRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DestinationRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DestinationRead
   * @throws IOException if the JSON string is invalid with respect to DestinationRead
   */
  public static DestinationRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestinationRead.class);
  }

  /**
   * Convert an instance of DestinationRead to an JSON string
   *
   * @return JSON string
   */
