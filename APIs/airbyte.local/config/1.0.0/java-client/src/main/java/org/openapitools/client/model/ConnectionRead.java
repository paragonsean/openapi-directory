...
public class ConnectionRead {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.breakingChange, connectionRead.breakingChange) &&
        Objects.equals(this.connectionId, connectionRead.connectionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(breakingChange, connectionId, destinationId, geography, name, namespaceDefinition, namespaceFormat, nonBreakingChangesPreference, notifySchemaChanges, operationIds, prefix, resourceRequirements, schedule, scheduleData, scheduleType, sourceCatalogId, sourceId, status, syncCatalog);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("breakingChange");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionRead is not found in the empty JSON string", ConnectionRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectionRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectionRead.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionRead.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionRead>() {
           @Override
           public void write(JsonWriter out, ConnectionRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectionRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectionRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectionRead
   * @throws IOException if the JSON string is invalid with respect to ConnectionRead
   */
  public static ConnectionRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionRead.class);
  }

  /**
   * Convert an instance of ConnectionRead to an JSON string
   *
   * @return JSON string
   */
