...
public class WebhookConfigWrite {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authToken, webhookConfigWrite.authToken) &&
        Objects.equals(this.name, webhookConfigWrite.name) &&
        Objects.equals(this.validationUrl, webhookConfigWrite.validationUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authToken, name, validationUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookConfigWrite
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookConfigWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookConfigWrite is not found in the empty JSON string", WebhookConfigWrite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookConfigWrite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookConfigWrite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookConfigWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookConfigWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookConfigWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookConfigWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookConfigWrite>() {
           @Override
           public void write(JsonWriter out, WebhookConfigWrite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookConfigWrite read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookConfigWrite given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookConfigWrite
   * @throws IOException if the JSON string is invalid with respect to WebhookConfigWrite
   */
  public static WebhookConfigWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookConfigWrite.class);
  }

  /**
   * Convert an instance of WebhookConfigWrite to an JSON string
   *
   * @return JSON string
   */
