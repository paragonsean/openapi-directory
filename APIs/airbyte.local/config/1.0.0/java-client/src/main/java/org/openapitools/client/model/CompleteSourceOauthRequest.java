...
public class CompleteSourceOauthRequest {
  ...
  public CompleteSourceOauthRequest oAuthInputConfiguration(Object oAuthInputConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.oAuthInputConfiguration, completeSourceOauthRequest.oAuthInputConfiguration) &&
        ...
        Objects.equals(this.sourceDefinitionId, completeSourceOauthRequest.sourceDefinitionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(oAuthInputConfiguration, queryParams, redirectUrl, sourceDefinitionId, sourceId, workspaceId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompleteSourceOauthRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompleteSourceOauthRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompleteSourceOauthRequest is not found in the empty JSON string", CompleteSourceOauthRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompleteSourceOauthRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompleteSourceOauthRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompleteSourceOauthRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompleteSourceOauthRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompleteSourceOauthRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompleteSourceOauthRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompleteSourceOauthRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CompleteSourceOauthRequest>() {
           @Override
           public void write(JsonWriter out, CompleteSourceOauthRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompleteSourceOauthRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompleteSourceOauthRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompleteSourceOauthRequest
   * @throws IOException if the JSON string is invalid with respect to CompleteSourceOauthRequest
   */
  public static CompleteSourceOauthRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompleteSourceOauthRequest.class);
  }

  /**
   * Convert an instance of CompleteSourceOauthRequest to an JSON string
   *
   * @return JSON string
   */
