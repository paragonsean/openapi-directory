...
public class SourceDefinitionCreate {
  ...
  public SourceDefinitionCreate() {
  }

  public SourceDefinitionCreate dockerImageTag(String dockerImageTag) {
  ...
  public SourceDefinitionCreate dockerRepository(String dockerRepository) {
  ...
  public SourceDefinitionCreate documentationUrl(URI documentationUrl) {
  ...
  public SourceDefinitionCreate icon(String icon) {
    this.icon = icon;
    return this;
  }
  ...
  public SourceDefinitionCreate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SourceDefinitionCreate resourceRequirements(ActorDefinitionResourceRequirements resourceRequirements) {
  ...
  public boolean equals(Object o) {
    ...
    SourceDefinitionCreate sourceDefinitionCreate = (SourceDefinitionCreate) o;
    return Objects.equals(this.dockerImageTag, sourceDefinitionCreate.dockerImageTag) &&
        Objects.equals(this.dockerRepository, sourceDefinitionCreate.dockerRepository) &&
        Objects.equals(this.documentationUrl, sourceDefinitionCreate.documentationUrl) &&
        Objects.equals(this.icon, sourceDefinitionCreate.icon) &&
        Objects.equals(this.name, sourceDefinitionCreate.name) &&
        Objects.equals(this.resourceRequirements, sourceDefinitionCreate.resourceRequirements);
  }
  ...
  public String toString() {
    ...
    sb.append("class SourceDefinitionCreate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SourceDefinitionCreate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SourceDefinitionCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceDefinitionCreate is not found in the empty JSON string", SourceDefinitionCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SourceDefinitionCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceDefinitionCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SourceDefinitionCreate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceDefinitionCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceDefinitionCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceDefinitionCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceDefinitionCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceDefinitionCreate>() {
           @Override
           public void write(JsonWriter out, SourceDefinitionCreate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SourceDefinitionCreate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SourceDefinitionCreate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SourceDefinitionCreate
   * @throws IOException if the JSON string is invalid with respect to SourceDefinitionCreate
   */
  public static SourceDefinitionCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceDefinitionCreate.class);
  }

  /**
   * Convert an instance of SourceDefinitionCreate to an JSON string
   *
   * @return JSON string
   */
