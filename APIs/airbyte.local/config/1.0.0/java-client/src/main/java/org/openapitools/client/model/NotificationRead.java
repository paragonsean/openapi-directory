...
public class NotificationRead {
  ...
  public NotificationRead status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, notificationRead.message) &&
        Objects.equals(this.status, notificationRead.status);
  }
