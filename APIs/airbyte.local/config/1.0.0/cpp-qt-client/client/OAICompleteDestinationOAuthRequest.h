...
/*
 * OAICompleteDestinationOAuthRequest.h
 *
 * 
 */

#ifndef OAICompleteDestinationOAuthRequest_H
#define OAICompleteDestinationOAuthRequest_H
...
class OAICompleteDestinationOAuthRequest : public OAIObject {
public:
    OAICompleteDestinationOAuthRequest();
    OAICompleteDestinationOAuthRequest(QString json);
    ~OAICompleteDestinationOAuthRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompleteDestinationOAuthRequest)

#endif // OAICompleteDestinationOAuthRequest_H
