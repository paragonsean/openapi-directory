...
/*
 * OAIImportRequestBody.h
 *
 * 
 */

#ifndef OAIImportRequestBody_H
#define OAIImportRequestBody_H
...
class OAIImportRequestBody : public OAIObject {
public:
    OAIImportRequestBody();
    OAIImportRequestBody(QString json);
    ~OAIImportRequestBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportRequestBody)

#endif // OAIImportRequestBody_H
