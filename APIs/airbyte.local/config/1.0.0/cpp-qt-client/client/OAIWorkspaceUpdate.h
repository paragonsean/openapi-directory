...
class OAIWorkspaceUpdate : public OAIObject {
public:
    OAIWorkspaceUpdate();
    OAIWorkspaceUpdate(QString json);
    ~OAIWorkspaceUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkspaceUpdate)

#endif // OAIWorkspaceUpdate_H
