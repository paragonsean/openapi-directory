...
OAIDestinationCreate::OAIDestinationCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDestinationCreate::OAIDestinationCreate() {
    this->initializeModel();
}

OAIDestinationCreate::~OAIDestinationCreate() {}

void OAIDestinationCreate::initializeModel() {
...
void OAIDestinationCreate::fromJson(QString jsonString) {
...
void OAIDestinationCreate::fromJsonObject(QJsonObject json) {
...
QString OAIDestinationCreate::asJson() const {
...
QJsonObject OAIDestinationCreate::asJsonObject() const {
    QJsonObject obj;
...
QJsonValue OAIDestinationCreate::getConnectionConfiguration() const {
    return m_connection_configuration;
}
void OAIDestinationCreate::setConnectionConfiguration(const QJsonValue &connection_configuration) {
    m_connection_configuration = connection_configuration;
    m_connection_configuration_isSet = true;
}

bool OAIDestinationCreate::is_connection_configuration_Set() const{
    return m_connection_configuration_isSet;
}

bool OAIDestinationCreate::is_connection_configuration_Valid() const{
    return m_connection_configuration_isValid;
}

QString OAIDestinationCreate::getDestinationDefinitionId() const {
    return m_destination_definition_id;
}
void OAIDestinationCreate::setDestinationDefinitionId(const QString &destination_definition_id) {
    m_destination_definition_id = destination_definition_id;
    m_destination_definition_id_isSet = true;
}

bool OAIDestinationCreate::is_destination_definition_id_Set() const{
    return m_destination_definition_id_isSet;
}

bool OAIDestinationCreate::is_destination_definition_id_Valid() const{
    return m_destination_definition_id_isValid;
}

QString OAIDestinationCreate::getName() const {
    return m_name;
}
void OAIDestinationCreate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDestinationCreate::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDestinationCreate::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDestinationCreate::getWorkspaceId() const {
    return m_workspace_id;
}
void OAIDestinationCreate::setWorkspaceId(const QString &workspace_id) {
    m_workspace_id = workspace_id;
    m_workspace_id_isSet = true;
}

bool OAIDestinationCreate::is_workspace_id_Set() const{
    return m_workspace_id_isSet;
}

bool OAIDestinationCreate::is_workspace_id_Valid() const{
    return m_workspace_id_isValid;
}

bool OAIDestinationCreate::isSet() const {
...
bool OAIDestinationCreate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_connection_configuration_isValid && m_destination_definition_id_isValid && m_name_isValid && m_workspace_id_isValid && true;
}
