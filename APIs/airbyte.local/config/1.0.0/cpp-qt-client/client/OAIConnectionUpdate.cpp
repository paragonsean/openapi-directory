...
bool OAIConnectionUpdate::isBreakingChange() const {
    return m_breaking_change;
}
void OAIConnectionUpdate::setBreakingChange(const bool &breaking_change) {
    m_breaking_change = breaking_change;
    m_breaking_change_isSet = true;
}

bool OAIConnectionUpdate::is_breaking_change_Set() const{
    return m_breaking_change_isSet;
}

bool OAIConnectionUpdate::is_breaking_change_Valid() const{
    return m_breaking_change_isValid;
}

QString OAIConnectionUpdate::getConnectionId() const {
    return m_connection_id;
}
void OAIConnectionUpdate::setConnectionId(const QString &connection_id) {
    m_connection_id = connection_id;
    m_connection_id_isSet = true;
}

bool OAIConnectionUpdate::is_connection_id_Set() const{
    return m_connection_id_isSet;
}

bool OAIConnectionUpdate::is_connection_id_Valid() const{
    return m_connection_id_isValid;
}

OAIGeography OAIConnectionUpdate::getGeography() const {
    return m_geography;
}
void OAIConnectionUpdate::setGeography(const OAIGeography &geography) {
    m_geography = geography;
    m_geography_isSet = true;
}

bool OAIConnectionUpdate::is_geography_Set() const{
    return m_geography_isSet;
}

bool OAIConnectionUpdate::is_geography_Valid() const{
    return m_geography_isValid;
}

QString OAIConnectionUpdate::getName() const {
    return m_name;
}
void OAIConnectionUpdate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIConnectionUpdate::is_name_Set() const{
    return m_name_isSet;
}

bool OAIConnectionUpdate::is_name_Valid() const{
    return m_name_isValid;
}

OAINamespaceDefinitionType OAIConnectionUpdate::getNamespaceDefinition() const {
    return m_namespace_definition;
}
void OAIConnectionUpdate::setNamespaceDefinition(const OAINamespaceDefinitionType &namespace_definition) {
    m_namespace_definition = namespace_definition;
    m_namespace_definition_isSet = true;
}

bool OAIConnectionUpdate::is_namespace_definition_Set() const{
    return m_namespace_definition_isSet;
}

bool OAIConnectionUpdate::is_namespace_definition_Valid() const{
    return m_namespace_definition_isValid;
}

QString OAIConnectionUpdate::getNamespaceFormat() const {
    return m_namespace_format;
}
void OAIConnectionUpdate::setNamespaceFormat(const QString &namespace_format) {
    m_namespace_format = namespace_format;
    m_namespace_format_isSet = true;
}

bool OAIConnectionUpdate::is_namespace_format_Set() const{
    return m_namespace_format_isSet;
}

bool OAIConnectionUpdate::is_namespace_format_Valid() const{
    return m_namespace_format_isValid;
}

OAINonBreakingChangesPreference OAIConnectionUpdate::getNonBreakingChangesPreference() const {
    return m_non_breaking_changes_preference;
}
void OAIConnectionUpdate::setNonBreakingChangesPreference(const OAINonBreakingChangesPreference &non_breaking_changes_preference) {
    m_non_breaking_changes_preference = non_breaking_changes_preference;
    m_non_breaking_changes_preference_isSet = true;
}

bool OAIConnectionUpdate::is_non_breaking_changes_preference_Set() const{
    return m_non_breaking_changes_preference_isSet;
}

bool OAIConnectionUpdate::is_non_breaking_changes_preference_Valid() const{
    return m_non_breaking_changes_preference_isValid;
}

bool OAIConnectionUpdate::isNotifySchemaChanges() const {
    return m_notify_schema_changes;
}
void OAIConnectionUpdate::setNotifySchemaChanges(const bool &notify_schema_changes) {
    m_notify_schema_changes = notify_schema_changes;
    m_notify_schema_changes_isSet = true;
}

bool OAIConnectionUpdate::is_notify_schema_changes_Set() const{
    return m_notify_schema_changes_isSet;
}

bool OAIConnectionUpdate::is_notify_schema_changes_Valid() const{
    return m_notify_schema_changes_isValid;
}

QList<QString> OAIConnectionUpdate::getOperationIds() const {
    return m_operation_ids;
}
void OAIConnectionUpdate::setOperationIds(const QList<QString> &operation_ids) {
    m_operation_ids = operation_ids;
    m_operation_ids_isSet = true;
}

bool OAIConnectionUpdate::is_operation_ids_Set() const{
    return m_operation_ids_isSet;
}

bool OAIConnectionUpdate::is_operation_ids_Valid() const{
    return m_operation_ids_isValid;
}

QString OAIConnectionUpdate::getPrefix() const {
    return m_prefix;
}
void OAIConnectionUpdate::setPrefix(const QString &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAIConnectionUpdate::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAIConnectionUpdate::is_prefix_Valid() const{
    return m_prefix_isValid;
}

OAIResourceRequirements OAIConnectionUpdate::getResourceRequirements() const {
    return m_resource_requirements;
}
void OAIConnectionUpdate::setResourceRequirements(const OAIResourceRequirements &resource_requirements) {
    m_resource_requirements = resource_requirements;
    m_resource_requirements_isSet = true;
}

bool OAIConnectionUpdate::is_resource_requirements_Set() const{
    return m_resource_requirements_isSet;
}

bool OAIConnectionUpdate::is_resource_requirements_Valid() const{
    return m_resource_requirements_isValid;
}

OAIConnectionSchedule OAIConnectionUpdate::getSchedule() const {
    return m_schedule;
}
void OAIConnectionUpdate::setSchedule(const OAIConnectionSchedule &schedule) {
    m_schedule = schedule;
    m_schedule_isSet = true;
}

bool OAIConnectionUpdate::is_schedule_Set() const{
    return m_schedule_isSet;
}

bool OAIConnectionUpdate::is_schedule_Valid() const{
    return m_schedule_isValid;
}

OAIConnectionScheduleData OAIConnectionUpdate::getScheduleData() const {
    return m_schedule_data;
}
void OAIConnectionUpdate::setScheduleData(const OAIConnectionScheduleData &schedule_data) {
    m_schedule_data = schedule_data;
    m_schedule_data_isSet = true;
}

bool OAIConnectionUpdate::is_schedule_data_Set() const{
    return m_schedule_data_isSet;
}

bool OAIConnectionUpdate::is_schedule_data_Valid() const{
    return m_schedule_data_isValid;
}

OAIConnectionScheduleType OAIConnectionUpdate::getScheduleType() const {
    return m_schedule_type;
}
void OAIConnectionUpdate::setScheduleType(const OAIConnectionScheduleType &schedule_type) {
    m_schedule_type = schedule_type;
    m_schedule_type_isSet = true;
}

bool OAIConnectionUpdate::is_schedule_type_Set() const{
    return m_schedule_type_isSet;
}

bool OAIConnectionUpdate::is_schedule_type_Valid() const{
    return m_schedule_type_isValid;
}

QString OAIConnectionUpdate::getSourceCatalogId() const {
    return m_source_catalog_id;
}
void OAIConnectionUpdate::setSourceCatalogId(const QString &source_catalog_id) {
    m_source_catalog_id = source_catalog_id;
    m_source_catalog_id_isSet = true;
}

bool OAIConnectionUpdate::is_source_catalog_id_Set() const{
    return m_source_catalog_id_isSet;
}

bool OAIConnectionUpdate::is_source_catalog_id_Valid() const{
    return m_source_catalog_id_isValid;
}

OAIConnectionStatus OAIConnectionUpdate::getStatus() const {
    return m_status;
}
void OAIConnectionUpdate::setStatus(const OAIConnectionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIConnectionUpdate::is_status_Set() const{
    return m_status_isSet;
}

bool OAIConnectionUpdate::is_status_Valid() const{
    return m_status_isValid;
}

OAIAirbyteCatalog OAIConnectionUpdate::getSyncCatalog() const {
    return m_sync_catalog;
}
void OAIConnectionUpdate::setSyncCatalog(const OAIAirbyteCatalog &sync_catalog) {
    m_sync_catalog = sync_catalog;
    m_sync_catalog_isSet = true;
}

bool OAIConnectionUpdate::is_sync_catalog_Set() const{
    return m_sync_catalog_isSet;
}

bool OAIConnectionUpdate::is_sync_catalog_Valid() const{
