...
#ifndef OAISourceRead_H
#define OAISourceRead_H
...
class OAISourceRead : public OAIObject {
public:
    OAISourceRead();
    OAISourceRead(QString json);
    ~OAISourceRead() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceRead)

#endif // OAISourceRead_H
