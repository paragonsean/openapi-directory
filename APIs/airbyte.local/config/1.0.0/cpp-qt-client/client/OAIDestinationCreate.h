...
/*
 * OAIDestinationCreate.h
 *
 * 
 */

#ifndef OAIDestinationCreate_H
#define OAIDestinationCreate_H
...
class OAIDestinationCreate : public OAIObject {
public:
    OAIDestinationCreate();
    OAIDestinationCreate(QString json);
    ~OAIDestinationCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationCreate)

#endif // OAIDestinationCreate_H
