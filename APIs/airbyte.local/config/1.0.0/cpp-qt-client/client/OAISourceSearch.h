...
#ifndef OAISourceSearch_H
#define OAISourceSearch_H
...
class OAISourceSearch : public OAIObject {
public:
    OAISourceSearch();
    OAISourceSearch(QString json);
    ~OAISourceSearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceSearch)

#endif // OAISourceSearch_H
