...
/*
 * OAIDestinationSearch.h
 *
 * 
 */

#ifndef OAIDestinationSearch_H
#define OAIDestinationSearch_H
...
class OAIDestinationSearch : public OAIObject {
public:
    OAIDestinationSearch();
    OAIDestinationSearch(QString json);
    ~OAIDestinationSearch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationSearch)

#endif // OAIDestinationSearch_H
