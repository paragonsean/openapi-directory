...
Q_SIGNALS:
    ...
    void getHealthCheckSignal(OAIHealthCheckRead summary);


    void getHealthCheckSignalFull(OAIHttpRequestWorker *worker, OAIHealthCheckRead summary);

    Q_DECL_DEPRECATED_X("Use getHealthCheckSignalError() instead")
    void getHealthCheckSignalE(OAIHealthCheckRead summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getHealthCheckSignalError(OAIHealthCheckRead summary, QNetworkReply::NetworkError error_type, const QString &error_str);
