...
/*
 * OAISourceDefinitionCreate.h
 *
 * 
 */

#ifndef OAISourceDefinitionCreate_H
#define OAISourceDefinitionCreate_H
...
class OAISourceDefinitionCreate : public OAIObject {
public:
    OAISourceDefinitionCreate();
    OAISourceDefinitionCreate(QString json);
    ~OAISourceDefinitionCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceDefinitionCreate)

#endif // OAISourceDefinitionCreate_H
