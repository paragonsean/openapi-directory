...
/*
 * OAIDestinationOauthConsentRequest.h
 *
 * 
 */

#ifndef OAIDestinationOauthConsentRequest_H
#define OAIDestinationOauthConsentRequest_H
...
class OAIDestinationOauthConsentRequest : public OAIObject {
public:
    OAIDestinationOauthConsentRequest();
    OAIDestinationOauthConsentRequest(QString json);
    ~OAIDestinationOauthConsentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationOauthConsentRequest)

#endif // OAIDestinationOauthConsentRequest_H
