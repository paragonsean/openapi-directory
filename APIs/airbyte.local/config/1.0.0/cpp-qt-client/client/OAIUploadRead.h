...
#ifndef OAIUploadRead_H
#define OAIUploadRead_H
...
class OAIUploadRead : public OAIObject {
public:
    OAIUploadRead();
    OAIUploadRead(QString json);
    ~OAIUploadRead() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadRead)

#endif // OAIUploadRead_H
