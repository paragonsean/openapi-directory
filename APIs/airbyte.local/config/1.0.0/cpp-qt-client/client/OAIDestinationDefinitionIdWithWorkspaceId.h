...
/*
 * OAIDestinationDefinitionIdWithWorkspaceId.h
 *
 * 
 */

#ifndef OAIDestinationDefinitionIdWithWorkspaceId_H
#define OAIDestinationDefinitionIdWithWorkspaceId_H
...
class OAIDestinationDefinitionIdWithWorkspaceId : public OAIObject {
public:
    OAIDestinationDefinitionIdWithWorkspaceId();
    OAIDestinationDefinitionIdWithWorkspaceId(QString json);
    ~OAIDestinationDefinitionIdWithWorkspaceId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationDefinitionIdWithWorkspaceId)

#endif // OAIDestinationDefinitionIdWithWorkspaceId_H
