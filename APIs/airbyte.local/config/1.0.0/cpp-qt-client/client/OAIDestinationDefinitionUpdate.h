...
/*
 * OAIDestinationDefinitionUpdate.h
 *
 * 
 */

#ifndef OAIDestinationDefinitionUpdate_H
#define OAIDestinationDefinitionUpdate_H
...
class OAIDestinationDefinitionUpdate : public OAIObject {
public:
    OAIDestinationDefinitionUpdate();
    OAIDestinationDefinitionUpdate(QString json);
    ~OAIDestinationDefinitionUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationDefinitionUpdate)

#endif // OAIDestinationDefinitionUpdate_H
