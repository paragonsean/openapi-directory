...
OAISourceDefinitionCreate::OAISourceDefinitionCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISourceDefinitionCreate::OAISourceDefinitionCreate() {
    this->initializeModel();
}

OAISourceDefinitionCreate::~OAISourceDefinitionCreate() {}

void OAISourceDefinitionCreate::initializeModel() {
...
void OAISourceDefinitionCreate::fromJson(QString jsonString) {
...
void OAISourceDefinitionCreate::fromJsonObject(QJsonObject json) {
...
QString OAISourceDefinitionCreate::asJson() const {
...
QJsonObject OAISourceDefinitionCreate::asJsonObject() const {
    QJsonObject obj;
...
QString OAISourceDefinitionCreate::getDockerImageTag() const {
    return m_docker_image_tag;
}
void OAISourceDefinitionCreate::setDockerImageTag(const QString &docker_image_tag) {
    m_docker_image_tag = docker_image_tag;
    m_docker_image_tag_isSet = true;
}

bool OAISourceDefinitionCreate::is_docker_image_tag_Set() const{
    return m_docker_image_tag_isSet;
}

bool OAISourceDefinitionCreate::is_docker_image_tag_Valid() const{
    return m_docker_image_tag_isValid;
}

QString OAISourceDefinitionCreate::getDockerRepository() const {
    return m_docker_repository;
}
void OAISourceDefinitionCreate::setDockerRepository(const QString &docker_repository) {
    m_docker_repository = docker_repository;
    m_docker_repository_isSet = true;
}

bool OAISourceDefinitionCreate::is_docker_repository_Set() const{
    return m_docker_repository_isSet;
}

bool OAISourceDefinitionCreate::is_docker_repository_Valid() const{
    return m_docker_repository_isValid;
}

QString OAISourceDefinitionCreate::getDocumentationUrl() const {
    return m_documentation_url;
}
void OAISourceDefinitionCreate::setDocumentationUrl(const QString &documentation_url) {
    m_documentation_url = documentation_url;
    m_documentation_url_isSet = true;
}

bool OAISourceDefinitionCreate::is_documentation_url_Set() const{
    return m_documentation_url_isSet;
}

bool OAISourceDefinitionCreate::is_documentation_url_Valid() const{
    return m_documentation_url_isValid;
}

QString OAISourceDefinitionCreate::getIcon() const {
    return m_icon;
}
void OAISourceDefinitionCreate::setIcon(const QString &icon) {
    m_icon = icon;
    m_icon_isSet = true;
}

bool OAISourceDefinitionCreate::is_icon_Set() const{
    return m_icon_isSet;
}

bool OAISourceDefinitionCreate::is_icon_Valid() const{
    return m_icon_isValid;
}

QString OAISourceDefinitionCreate::getName() const {
    return m_name;
}
void OAISourceDefinitionCreate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISourceDefinitionCreate::is_name_Set() const{
    return m_name_isSet;
}

bool OAISourceDefinitionCreate::is_name_Valid() const{
    return m_name_isValid;
}

OAIActorDefinitionResourceRequirements OAISourceDefinitionCreate::getResourceRequirements() const {
    return m_resource_requirements;
}
void OAISourceDefinitionCreate::setResourceRequirements(const OAIActorDefinitionResourceRequirements &resource_requirements) {
    m_resource_requirements = resource_requirements;
    m_resource_requirements_isSet = true;
}

bool OAISourceDefinitionCreate::is_resource_requirements_Set() const{
    return m_resource_requirements_isSet;
}

bool OAISourceDefinitionCreate::is_resource_requirements_Valid() const{
    return m_resource_requirements_isValid;
}

bool OAISourceDefinitionCreate::isSet() const {
...
bool OAISourceDefinitionCreate::isValid() const {
