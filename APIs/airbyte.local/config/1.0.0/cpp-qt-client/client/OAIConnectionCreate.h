...
/*
 * OAIConnectionCreate.h
 *
 * 
 */

#ifndef OAIConnectionCreate_H
#define OAIConnectionCreate_H
...
class OAIConnectionCreate : public OAIObject {
public:
    OAIConnectionCreate();
    OAIConnectionCreate(QString json);
    ~OAIConnectionCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionCreate)

#endif // OAIConnectionCreate_H
