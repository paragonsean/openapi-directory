...
/*
 * OAIDestinationCoreConfig.h
 *
 * 
 */

#ifndef OAIDestinationCoreConfig_H
#define OAIDestinationCoreConfig_H
...
class OAIDestinationCoreConfig : public OAIObject {
public:
    OAIDestinationCoreConfig();
    OAIDestinationCoreConfig(QString json);
    ~OAIDestinationCoreConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationCoreConfig)

#endif // OAIDestinationCoreConfig_H
