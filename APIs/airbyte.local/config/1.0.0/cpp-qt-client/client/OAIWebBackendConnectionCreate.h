...
/*
 * OAIWebBackendConnectionCreate.h
 *
 * 
 */

#ifndef OAIWebBackendConnectionCreate_H
#define OAIWebBackendConnectionCreate_H
...
namespace OpenAPI {
class OAIOperationCreate;
class OAIResourceRequirements;
class OAIConnectionSchedule;
class OAIConnectionScheduleData;
class OAIAirbyteCatalog;

class OAIWebBackendConnectionCreate : public OAIObject {
public:
    OAIWebBackendConnectionCreate();
    OAIWebBackendConnectionCreate(QString json);
    ~OAIWebBackendConnectionCreate() override;
    ...
    QList<OAIOperationCreate> getOperations() const;
    void setOperations(const QList<OAIOperationCreate> &operations);
...
private:
    ...
    QList<OAIOperationCreate> m_operations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebBackendConnectionCreate)

#endif // OAIWebBackendConnectionCreate_H
