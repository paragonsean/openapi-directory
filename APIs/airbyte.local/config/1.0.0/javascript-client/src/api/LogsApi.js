...
export default class LogsApi {
    ...
    */
    ...
    /**
     * Get logs
     * @param {module:model/LogsRequestBody} logsRequestBody 
     ...
     */
    getLogs(logsRequestBody, callback) {
      let postBody = logsRequestBody;
      // verify the required parameter 'logsRequestBody' is set
      if (logsRequestBody === undefined || logsRequestBody === null) {
        throw new Error("Missing the required parameter 'logsRequestBody' when calling getLogs");
      }
