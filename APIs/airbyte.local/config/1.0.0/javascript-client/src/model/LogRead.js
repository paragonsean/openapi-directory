...
class LogRead {
     ...
     * @param logLines {Array.<String>} 
     */
    constructor(logLines) { 
        
        LogRead.initialize(this, logLines);
    }
     ...
     */
    static initialize(obj, logLines) { 
        obj['logLines'] = logLines;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('logLines')) {
                obj['logLines'] = ApiClient.convertToType(data['logLines'], ['String']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of LogRead.RequiredProperties) {
        ...
        if (!Array.isArray(data['logLines'])) {
            throw new Error("Expected the field `logLines` to be an array in the JSON data but got " + data['logLines']);
        }
...
LogRead.RequiredProperties = ["logLines"];

/**
 * @member {Array.<String>} logLines
 */
LogRead.prototype['logLines'] = undefined;
