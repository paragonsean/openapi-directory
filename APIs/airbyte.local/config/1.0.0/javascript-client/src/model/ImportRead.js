...
class ImportRead {
     ...
     * @param status {module:model/ImportRead.StatusEnum} 
     */
    constructor(status) { 
        
        ImportRead.initialize(this, status);
    }
...
ImportRead.RequiredProperties = ["status"];

/**
 * @member {String} reason
 */
ImportRead.prototype['reason'] = undefined;

/**
 * @member {module:model/ImportRead.StatusEnum} status
 */
ImportRead.prototype['status'] = undefined;
