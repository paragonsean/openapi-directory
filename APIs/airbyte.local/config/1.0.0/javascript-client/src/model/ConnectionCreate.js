...
class ConnectionCreate {
    ...
    constructor(destinationId, sourceId, status) { 
        ...
        ConnectionCreate.initialize(this, destinationId, sourceId, status);
    }
...
ConnectionCreate.RequiredProperties = ["destinationId", "sourceId", "status"];

/**
 * @member {String} destinationId
 */
ConnectionCreate.prototype['destinationId'] = undefined;

/**
 * @member {module:model/Geography} geography
 */
ConnectionCreate.prototype['geography'] = undefined;

/**
 * Optional name of the connection
 * @member {String} name
 */
ConnectionCreate.prototype['name'] = undefined;

/**
 * @member {module:model/NamespaceDefinitionType} namespaceDefinition
 */
ConnectionCreate.prototype['namespaceDefinition'] = undefined;

/**
 * Used when namespaceDefinition is 'customformat'. If blank then behaves like namespaceDefinition = 'destination'. If \"${SOURCE_NAMESPACE}\" then behaves like namespaceDefinition = 'source'.
 * @member {String} namespaceFormat
 */
ConnectionCreate.prototype['namespaceFormat'] = undefined;

/**
 * @member {module:model/NonBreakingChangesPreference} nonBreakingChangesPreference
 */
ConnectionCreate.prototype['nonBreakingChangesPreference'] = undefined;

/**
 * @member {Boolean} notifySchemaChanges
 */
ConnectionCreate.prototype['notifySchemaChanges'] = undefined;

/**
 * @member {Array.<String>} operationIds
 */
ConnectionCreate.prototype['operationIds'] = undefined;

/**
 * Prefix that will be prepended to the name of each stream when it is written to the destination.
 * @member {String} prefix
 */
ConnectionCreate.prototype['prefix'] = undefined;

/**
 * @member {module:model/ResourceRequirements} resourceRequirements
 */
ConnectionCreate.prototype['resourceRequirements'] = undefined;

/**
 * @member {module:model/ConnectionSchedule} schedule
 */
ConnectionCreate.prototype['schedule'] = undefined;

/**
 * @member {module:model/ConnectionScheduleData} scheduleData
 */
ConnectionCreate.prototype['scheduleData'] = undefined;

/**
 * @member {module:model/ConnectionScheduleType} scheduleType
 */
ConnectionCreate.prototype['scheduleType'] = undefined;

/**
 * @member {String} sourceCatalogId
 */
ConnectionCreate.prototype['sourceCatalogId'] = undefined;

/**
 * @member {String} sourceId
 */
ConnectionCreate.prototype['sourceId'] = undefined;

/**
 * @member {module:model/ConnectionStatus} status
 */
ConnectionCreate.prototype['status'] = undefined;

/**
 * @member {module:model/AirbyteCatalog} syncCatalog
 */
ConnectionCreate.prototype['syncCatalog'] = undefined;
