...
/**
 * The CompleteSourceOauthRequest model module.
 * @module model/CompleteSourceOauthRequest
 * @version 1.0.0
 */
class CompleteSourceOauthRequest {
    /**
     * Constructs a new <code>CompleteSourceOauthRequest</code>.
     * @alias module:model/CompleteSourceOauthRequest
     * @param sourceDefinitionId {String} 
     * @param workspaceId {String} 
     */
    constructor(sourceDefinitionId, workspaceId) { 
        
        CompleteSourceOauthRequest.initialize(this, sourceDefinitionId, workspaceId);
    }
     ...
     */
    static initialize(obj, sourceDefinitionId, workspaceId) { 
        obj['sourceDefinitionId'] = sourceDefinitionId;
        obj['workspaceId'] = workspaceId;
    }

    /**
     * Constructs a <code>CompleteSourceOauthRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompleteSourceOauthRequest} obj Optional instance to populate.
     * @return {module:model/CompleteSourceOauthRequest} The populated <code>CompleteSourceOauthRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompleteSourceOauthRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CompleteSourceOauthRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompleteSourceOauthRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CompleteSourceOauthRequest.RequiredProperties) {
...
CompleteSourceOauthRequest.RequiredProperties = ["sourceDefinitionId", "workspaceId"];
 ...
 */
CompleteSourceOauthRequest.prototype['oAuthInputConfiguration'] = undefined;
 ...
 */
CompleteSourceOauthRequest.prototype['queryParams'] = undefined;
 ...
 */
CompleteSourceOauthRequest.prototype['redirectUrl'] = undefined;

/**
 * @member {String} sourceDefinitionId
 */
CompleteSourceOauthRequest.prototype['sourceDefinitionId'] = undefined;

/**
 * @member {String} sourceId
 */
CompleteSourceOauthRequest.prototype['sourceId'] = undefined;

/**
 * @member {String} workspaceId
 */
CompleteSourceOauthRequest.prototype['workspaceId'] = undefined;
...
export default CompleteSourceOauthRequest;
