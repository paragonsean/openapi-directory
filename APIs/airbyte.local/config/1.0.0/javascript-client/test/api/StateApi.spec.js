...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.StateApi();
  });
  ...
  describe('StateApi', function() {
    describe('createOrUpdateState', function() {
      it('should call createOrUpdateState successfully', function(done) {
        //uncomment below and update the code to test createOrUpdateState
        //instance.createOrUpdateState(function(error) {
