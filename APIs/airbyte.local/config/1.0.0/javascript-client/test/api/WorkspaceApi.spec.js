...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.WorkspaceApi();
  });
  ...
  describe('WorkspaceApi', function() {
    ...
    describe('getWorkspaceByConnectionId', function() {
      it('should call getWorkspaceByConnectionId successfully', function(done) {
        //uncomment below and update the code to test getWorkspaceByConnectionId
        //instance.getWorkspaceByConnectionId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getWorkspaceBySlug', function() {
      it('should call getWorkspaceBySlug successfully', function(done) {
        //uncomment below and update the code to test getWorkspaceBySlug
        //instance.getWorkspaceBySlug(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateWorkspaceFeedback', function() {
      it('should call updateWorkspaceFeedback successfully', function(done) {
        //uncomment below and update the code to test updateWorkspaceFeedback
        //instance.updateWorkspaceFeedback(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateWorkspaceName', function() {
      it('should call updateWorkspaceName successfully', function(done) {
        //uncomment below and update the code to test updateWorkspaceName
        //instance.updateWorkspaceName(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
