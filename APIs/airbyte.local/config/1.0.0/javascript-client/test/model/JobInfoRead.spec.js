...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.JobInfoRead();
  });
  ...
  describe('JobInfoRead', function() {
    it('should create an instance of JobInfoRead', function() {
      // uncomment below and update the code to test JobInfoRead
      //var instance = new AirbyteConfigurationApi.JobInfoRead();
      //expect(instance).to.be.a(AirbyteConfigurationApi.JobInfoRead);
    });
