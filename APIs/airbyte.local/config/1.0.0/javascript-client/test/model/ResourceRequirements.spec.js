...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.ResourceRequirements();
  });
  ...
  describe('ResourceRequirements', function() {
    it('should create an instance of ResourceRequirements', function() {
      ...
      //var instance = new AirbyteConfigurationApi.ResourceRequirements();
      //expect(instance).to.be.a(AirbyteConfigurationApi.ResourceRequirements);
    });
