...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.SynchronousJobRead();
  });
  ...
  describe('SynchronousJobRead', function() {
    it('should create an instance of SynchronousJobRead', function() {
      // uncomment below and update the code to test SynchronousJobRead
      //var instance = new AirbyteConfigurationApi.SynchronousJobRead();
      //expect(instance).to.be.a(AirbyteConfigurationApi.SynchronousJobRead);
    });
    ...
    it('should have the property connectorConfigurationUpdated (base name: "connectorConfigurationUpdated")', function() {
      // uncomment below and update the code to test the property connectorConfigurationUpdated
      //var instance = new AirbyteConfigurationApi.SynchronousJobRead();
      //expect(instance).to.be();
    });
