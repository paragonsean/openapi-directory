...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.JobRead();
  });
  ...
  describe('JobRead', function() {
    it('should create an instance of JobRead', function() {
      // uncomment below and update the code to test JobRead
      //var instance = new AirbyteConfigurationApi.JobRead();
      //expect(instance).to.be.a(AirbyteConfigurationApi.JobRead);
    });
    ...
    it('should have the property resetConfig (base name: "resetConfig")', function() {
      // uncomment below and update the code to test the property resetConfig
      //var instance = new AirbyteConfigurationApi.JobRead();
      //expect(instance).to.be();
    });
