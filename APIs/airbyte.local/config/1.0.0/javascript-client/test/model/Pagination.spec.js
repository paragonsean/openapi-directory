...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.Pagination();
  });
  ...
  describe('Pagination', function() {
    it('should create an instance of Pagination', function() {
      ...
      //var instance = new AirbyteConfigurationApi.Pagination();
      //expect(instance).to.be.a(AirbyteConfigurationApi.Pagination);
    });
