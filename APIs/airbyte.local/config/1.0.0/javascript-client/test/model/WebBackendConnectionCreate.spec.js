...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.WebBackendConnectionCreate();
  });
  ...
  describe('WebBackendConnectionCreate', function() {
    it('should create an instance of WebBackendConnectionCreate', function() {
      // uncomment below and update the code to test WebBackendConnectionCreate
      //var instance = new AirbyteConfigurationApi.WebBackendConnectionCreate();
      //expect(instance).to.be.a(AirbyteConfigurationApi.WebBackendConnectionCreate);
    });
