...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.ImportRequestBody();
  });
  ...
  describe('ImportRequestBody', function() {
    it('should create an instance of ImportRequestBody', function() {
      // uncomment below and update the code to test ImportRequestBody
      //var instance = new AirbyteConfigurationApi.ImportRequestBody();
      //expect(instance).to.be.a(AirbyteConfigurationApi.ImportRequestBody);
    });
