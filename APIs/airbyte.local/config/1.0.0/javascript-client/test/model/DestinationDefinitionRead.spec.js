...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.DestinationDefinitionRead();
  });
  ...
  describe('DestinationDefinitionRead', function() {
    it('should create an instance of DestinationDefinitionRead', function() {
      // uncomment below and update the code to test DestinationDefinitionRead
      //var instance = new AirbyteConfigurationApi.DestinationDefinitionRead();
      //expect(instance).to.be.a(AirbyteConfigurationApi.DestinationDefinitionRead);
    });

    it('should have the property destinationDefinitionId (base name: "destinationDefinitionId")', function() {
      // uncomment below and update the code to test the property destinationDefinitionId
      //var instance = new AirbyteConfigurationApi.DestinationDefinitionRead();
    ...
    it('should have the property normalizationConfig (base name: "normalizationConfig")', function() {
      // uncomment below and update the code to test the property normalizationConfig
      //var instance = new AirbyteConfigurationApi.DestinationDefinitionRead();
      //expect(instance).to.be();
    });
    ...
    it('should have the property releaseStage (base name: "releaseStage")', function() {
      // uncomment below and update the code to test the property releaseStage
      //var instance = new AirbyteConfigurationApi.DestinationDefinitionRead();
      //expect(instance).to.be();
    });
    ...
    it('should have the property supportsDbt (base name: "supportsDbt")', function() {
      // uncomment below and update the code to test the property supportsDbt
      //var instance = new AirbyteConfigurationApi.DestinationDefinitionRead();
      //expect(instance).to.be();
    });
