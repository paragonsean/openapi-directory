...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.JobTypeResourceLimit();
  });
  ...
  describe('JobTypeResourceLimit', function() {
    it('should create an instance of JobTypeResourceLimit', function() {
      // uncomment below and update the code to test JobTypeResourceLimit
      //var instance = new AirbyteConfigurationApi.JobTypeResourceLimit();
      //expect(instance).to.be.a(AirbyteConfigurationApi.JobTypeResourceLimit);
    });
