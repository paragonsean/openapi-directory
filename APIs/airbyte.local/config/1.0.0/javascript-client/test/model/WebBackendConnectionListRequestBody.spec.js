...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.WebBackendConnectionListRequestBody();
  });
  ...
  describe('WebBackendConnectionListRequestBody', function() {
    it('should create an instance of WebBackendConnectionListRequestBody', function() {
      // uncomment below and update the code to test WebBackendConnectionListRequestBody
      //var instance = new AirbyteConfigurationApi.WebBackendConnectionListRequestBody();
      //expect(instance).to.be.a(AirbyteConfigurationApi.WebBackendConnectionListRequestBody);
    });
