...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.ConnectionSchedule();
  });
  ...
  describe('ConnectionSchedule', function() {
    it('should create an instance of ConnectionSchedule', function() {
      // uncomment below and update the code to test ConnectionSchedule
      //var instance = new AirbyteConfigurationApi.ConnectionSchedule();
      //expect(instance).to.be.a(AirbyteConfigurationApi.ConnectionSchedule);
    });
