...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.SourceDefinitionRead();
  });
  ...
  describe('SourceDefinitionRead', function() {
    it('should create an instance of SourceDefinitionRead', function() {
      // uncomment below and update the code to test SourceDefinitionRead
      //var instance = new AirbyteConfigurationApi.SourceDefinitionRead();
      //expect(instance).to.be.a(AirbyteConfigurationApi.SourceDefinitionRead);
    });
