...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.AttemptInfoRead();
  });
  ...
  describe('AttemptInfoRead', function() {
    it('should create an instance of AttemptInfoRead', function() {
      // uncomment below and update the code to test AttemptInfoRead
      //var instance = new AirbyteConfigurationApi.AttemptInfoRead();
      //expect(instance).to.be.a(AirbyteConfigurationApi.AttemptInfoRead);
    });
