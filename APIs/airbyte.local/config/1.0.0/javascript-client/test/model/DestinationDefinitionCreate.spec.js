...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirbyteConfigurationApi.DestinationDefinitionCreate();
  });
  ...
  describe('DestinationDefinitionCreate', function() {
    it('should create an instance of DestinationDefinitionCreate', function() {
      // uncomment below and update the code to test DestinationDefinitionCreate
      //var instance = new AirbyteConfigurationApi.DestinationDefinitionCreate();
      //expect(instance).to.be.a(AirbyteConfigurationApi.DestinationDefinitionCreate);
    });
