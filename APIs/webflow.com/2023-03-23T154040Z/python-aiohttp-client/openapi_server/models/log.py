...
class Log(Model):
    ...
    def __init__(self, events: List[object]=None, log_id: str=None, start_time: str=None, transition_execution_id: str=None, transition_id: LogTransitionId=None, workflow_execution_id: str=None, workflow_id: str=None):
        ...
        :param events: The events of this Log.
        :param log_id: The log_id of this Log.
        :param start_time: The start_time of this Log.
        :param transition_execution_id: The transition_execution_id of this Log.
        :param transition_id: The transition_id of this Log.
        :param workflow_execution_id: The workflow_execution_id of this Log.
        :param workflow_id: The workflow_id of this Log.
        """
        self.openapi_types = {
            'events': List[object],
            'log_id': str,
    ...
    @property
    def events(self):
        """Gets the events of this Log.


        :return: The events of this Log.
        :rtype: List[object]
        """
        return self._events
    ...
    @property
    def log_id(self):
        """Gets the log_id of this Log.


        :return: The log_id of this Log.
        :rtype: str
        """
        return self._log_id
    ...
    def transition_execution_id(self):
        """Gets the transition_execution_id of this Log.


        :return: The transition_execution_id of this Log.
        :rtype: str
        """
    ...
    def transition_execution_id(self, transition_execution_id):
        """Sets the transition_execution_id of this Log.
    ...
    def transition_id(self):
        """Gets the transition_id of this Log.


        :return: The transition_id of this Log.
    ...
    def transition_id(self, transition_id):
        """Sets the transition_id of this Log.
    ...
    def workflow_execution_id(self):
        """Gets the workflow_execution_id of this Log.


        :return: The workflow_execution_id of this Log.
        :rtype: str
        """
    ...
    def workflow_execution_id(self, workflow_execution_id):
        """Sets the workflow_execution_id of this Log.
    ...
    def workflow_id(self):
        """Gets the workflow_id of this Log.


        :return: The workflow_id of this Log.
        :rtype: str
        """
    ...
    def workflow_id(self, workflow_id):
        """Sets the workflow_id of this Log.
