...
class DeploymentEnvironment(Model):
    ...
    def __init__(self, deployment_environment_id: str=None, description: str=None, model_deployment_units: int=None, name: str=None, organization_id: str=None, status: str=None):
        ...
        :param description: The description of this DeploymentEnvironment.
        :param model_deployment_units: The model_deployment_units of this DeploymentEnvironment.
        :param name: The name of this DeploymentEnvironment.
        :param organization_id: The organization_id of this DeploymentEnvironment.
        :param status: The status of this DeploymentEnvironment.
        """
        self.openapi_types = {
    ...
    def description(self):
        """Gets the description of this DeploymentEnvironment.


        :return: The description of this DeploymentEnvironment.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DeploymentEnvironment.
    ...
    def model_deployment_units(self):
        """Gets the model_deployment_units of this DeploymentEnvironment.


        :return: The model_deployment_units of this DeploymentEnvironment.
        :rtype: int
        """
    ...
    def model_deployment_units(self, model_deployment_units):
        """Sets the model_deployment_units of this DeploymentEnvironment.
    ...
    def organization_id(self):
        """Gets the organization_id of this DeploymentEnvironment.


        :return: The organization_id of this DeploymentEnvironment.
        :rtype: str
        """
    ...
    def organization_id(self, organization_id):
        """Sets the organization_id of this DeploymentEnvironment.
    ...
    @property
    def status(self):
        """Gets the status of this DeploymentEnvironment.


        :return: The status of this DeploymentEnvironment.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this DeploymentEnvironment.
