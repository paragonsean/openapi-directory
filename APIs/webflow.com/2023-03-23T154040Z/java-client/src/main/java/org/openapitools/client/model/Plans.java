...
public class Plans {
  ...
  private List<PlansPlansInner> plans = new ArrayList<>();

  public Plans() {
  }

  public Plans nextToken(String nextToken) {
  ...
  public Plans plans(List<PlansPlansInner> plans) {
    this.plans = plans;
    return this;
  }

  public Plans addPlansItem(PlansPlansInner plansItem) {
    if (this.plans == null) {
  ...
  public List<PlansPlansInner> getPlans() {
    return plans;
  }

  public void setPlans(List<PlansPlansInner> plans) {
    this.plans = plans;
  }
  ...
  public boolean equals(Object o) {
    ...
    Plans plans = (Plans) o;
    return Objects.equals(this.nextToken, plans.nextToken) &&
        Objects.equals(this.plans, plans.plans);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, plans);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayplans.size(); i++) {
        PlansPlansInner.validateJsonElement(jsonArrayplans.get(i));
      };
  }
