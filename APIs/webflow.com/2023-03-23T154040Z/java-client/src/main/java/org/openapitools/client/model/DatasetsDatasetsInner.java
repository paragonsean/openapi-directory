...
public class DatasetsDatasetsInner {
  ...
  public DatasetsDatasetsInner() {
  }

  public DatasetsDatasetsInner containsPersonallyIdentifiableInformation(Boolean containsPersonallyIdentifiableInformation) {
  ...
  public DatasetsDatasetsInner createdBy(String createdBy) {
  ...
  public DatasetsDatasetsInner createdTime(String createdTime) {
  ...
  public DatasetsDatasetsInner datasetId(String datasetId) {
  ...
  public DatasetsDatasetsInner description(String description) {
  ...
  public DatasetsDatasetsInner groundTruthSummary(Object groundTruthSummary) {
  ...
  public DatasetsDatasetsInner metadata(Object metadata) {
  ...
  public DatasetsDatasetsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DatasetsDatasetsInner numberOfDocuments(Integer numberOfDocuments) {
  ...
  public DatasetsDatasetsInner retentionInDays(Integer retentionInDays) {
  ...
  public DatasetsDatasetsInner storageLocation(StorageLocationEnum storageLocation) {
  ...
  public DatasetsDatasetsInner updatedBy(String updatedBy) {
  ...
  public DatasetsDatasetsInner updatedTime(String updatedTime) {
  ...
  public DatasetsDatasetsInner version(Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    DatasetsDatasetsInner datasetsDatasetsInner = (DatasetsDatasetsInner) o;
    return Objects.equals(this.containsPersonallyIdentifiableInformation, datasetsDatasetsInner.containsPersonallyIdentifiableInformation) &&
        Objects.equals(this.createdBy, datasetsDatasetsInner.createdBy) &&
        Objects.equals(this.createdTime, datasetsDatasetsInner.createdTime) &&
        Objects.equals(this.datasetId, datasetsDatasetsInner.datasetId) &&
        Objects.equals(this.description, datasetsDatasetsInner.description) &&
        Objects.equals(this.groundTruthSummary, datasetsDatasetsInner.groundTruthSummary) &&
        Objects.equals(this.metadata, datasetsDatasetsInner.metadata) &&
        Objects.equals(this.name, datasetsDatasetsInner.name) &&
        Objects.equals(this.numberOfDocuments, datasetsDatasetsInner.numberOfDocuments) &&
        Objects.equals(this.retentionInDays, datasetsDatasetsInner.retentionInDays) &&
        Objects.equals(this.storageLocation, datasetsDatasetsInner.storageLocation) &&
        Objects.equals(this.updatedBy, datasetsDatasetsInner.updatedBy) &&
        Objects.equals(this.updatedTime, datasetsDatasetsInner.updatedTime) &&
        Objects.equals(this.version, datasetsDatasetsInner.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatasetsDatasetsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetsDatasetsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetsDatasetsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetsDatasetsInner is not found in the empty JSON string", DatasetsDatasetsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetsDatasetsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetsDatasetsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatasetsDatasetsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetsDatasetsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetsDatasetsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetsDatasetsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetsDatasetsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetsDatasetsInner>() {
           @Override
           public void write(JsonWriter out, DatasetsDatasetsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetsDatasetsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetsDatasetsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetsDatasetsInner
   * @throws IOException if the JSON string is invalid with respect to DatasetsDatasetsInner
   */
  public static DatasetsDatasetsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetsDatasetsInner.class);
  }

  /**
   * Convert an instance of DatasetsDatasetsInner to an JSON string
   *
   * @return JSON string
   */
