...
public class AppClientsAppClientsInner {
  ...
  public AppClientsAppClientsInner() {
  }

  public AppClientsAppClientsInner appClientId(String appClientId) {
  ...
  public AppClientsAppClientsInner callbackUrls(List<String> callbackUrls) {
    this.callbackUrls = callbackUrls;
    return this;
  }

  public AppClientsAppClientsInner addCallbackUrlsItem(String callbackUrlsItem) {
  ...
  public AppClientsAppClientsInner clientId(String clientId) {
  ...
  public AppClientsAppClientsInner clientSecret(String clientSecret) {
  ...
  public AppClientsAppClientsInner createdBy(String createdBy) {
  ...
  public AppClientsAppClientsInner createdTime(String createdTime) {
  ...
  public AppClientsAppClientsInner defaultLoginUrl(String defaultLoginUrl) {
  ...
  public AppClientsAppClientsInner description(String description) {
  ...
  public AppClientsAppClientsInner hasSecret(Boolean hasSecret) {
  ...
  public AppClientsAppClientsInner loginUrls(List<String> loginUrls) {
    this.loginUrls = loginUrls;
    return this;
  }

  public AppClientsAppClientsInner addLoginUrlsItem(String loginUrlsItem) {
  ...
  public AppClientsAppClientsInner logoutUrls(List<String> logoutUrls) {
    this.logoutUrls = logoutUrls;
    return this;
  }

  public AppClientsAppClientsInner addLogoutUrlsItem(String logoutUrlsItem) {
  ...
  public AppClientsAppClientsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AppClientsAppClientsInner updatedBy(String updatedBy) {
  ...
  public AppClientsAppClientsInner updatedTime(String updatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    AppClientsAppClientsInner appClientsAppClientsInner = (AppClientsAppClientsInner) o;
    return Objects.equals(this.appClientId, appClientsAppClientsInner.appClientId) &&
        Objects.equals(this.callbackUrls, appClientsAppClientsInner.callbackUrls) &&
        Objects.equals(this.clientId, appClientsAppClientsInner.clientId) &&
        Objects.equals(this.clientSecret, appClientsAppClientsInner.clientSecret) &&
        Objects.equals(this.createdBy, appClientsAppClientsInner.createdBy) &&
        Objects.equals(this.createdTime, appClientsAppClientsInner.createdTime) &&
        Objects.equals(this.defaultLoginUrl, appClientsAppClientsInner.defaultLoginUrl) &&
        Objects.equals(this.description, appClientsAppClientsInner.description) &&
        Objects.equals(this.hasSecret, appClientsAppClientsInner.hasSecret) &&
        Objects.equals(this.loginUrls, appClientsAppClientsInner.loginUrls) &&
        Objects.equals(this.logoutUrls, appClientsAppClientsInner.logoutUrls) &&
        Objects.equals(this.name, appClientsAppClientsInner.name) &&
        Objects.equals(this.updatedBy, appClientsAppClientsInner.updatedBy) &&
        Objects.equals(this.updatedTime, appClientsAppClientsInner.updatedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppClientsAppClientsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppClientsAppClientsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppClientsAppClientsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppClientsAppClientsInner is not found in the empty JSON string", AppClientsAppClientsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppClientsAppClientsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppClientsAppClientsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppClientsAppClientsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppClientsAppClientsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppClientsAppClientsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppClientsAppClientsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppClientsAppClientsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AppClientsAppClientsInner>() {
           @Override
           public void write(JsonWriter out, AppClientsAppClientsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppClientsAppClientsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppClientsAppClientsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppClientsAppClientsInner
   * @throws IOException if the JSON string is invalid with respect to AppClientsAppClientsInner
   */
  public static AppClientsAppClientsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppClientsAppClientsInner.class);
  }

  /**
   * Convert an instance of AppClientsAppClientsInner to an JSON string
   *
   * @return JSON string
   */
