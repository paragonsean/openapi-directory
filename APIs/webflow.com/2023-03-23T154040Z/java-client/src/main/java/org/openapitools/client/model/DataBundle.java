...
public class DataBundle {
  ...
  public DataBundle createdBy(String createdBy) {
  ...
  public DataBundle createdTime(String createdTime) {
  ...
  public DataBundle dataBundleId(String dataBundleId) {
  ...
  public DataBundle datasets(List<DataBundleDatasetsInner> datasets) {
    this.datasets = datasets;
    return this;
  }

  public DataBundle addDatasetsItem(DataBundleDatasetsInner datasetsItem) {
  ...
  public DataBundle modelId(String modelId) {
  ...
  public DataBundle retentionInDays(Integer retentionInDays) {
  ...
  public DataBundle status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DataBundle summary(Object summary) {
  ...
  public DataBundle updatedBy(String updatedBy) {
  ...
  public DataBundle updatedTime(String updatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, dataBundle.createdBy) &&
        Objects.equals(this.createdTime, dataBundle.createdTime) &&
        Objects.equals(this.dataBundleId, dataBundle.dataBundleId) &&
        Objects.equals(this.datasets, dataBundle.datasets) &&
        Objects.equals(this.description, dataBundle.description) &&
        Objects.equals(this.modelId, dataBundle.modelId) &&
        Objects.equals(this.name, dataBundle.name) &&
        Objects.equals(this.retentionInDays, dataBundle.retentionInDays) &&
        Objects.equals(this.status, dataBundle.status) &&
        Objects.equals(this.summary, dataBundle.summary) &&
        Objects.equals(this.updatedBy, dataBundle.updatedBy) &&
        Objects.equals(this.updatedTime, dataBundle.updatedTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataBundle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataBundle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataBundle is not found in the empty JSON string", DataBundle.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataBundle.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataBundle` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataBundle.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataBundle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataBundle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataBundle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataBundle.class));

       return (TypeAdapter<T>) new TypeAdapter<DataBundle>() {
           @Override
           public void write(JsonWriter out, DataBundle value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataBundle read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataBundle given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataBundle
   * @throws IOException if the JSON string is invalid with respect to DataBundle
   */
  public static DataBundle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataBundle.class);
  }

  /**
   * Convert an instance of DataBundle to an JSON string
   *
   * @return JSON string
   */
