...
import org.openapitools.client.model.UsersUsersInner;
...
public class Users {
  ...
  private List<UsersUsersInner> users = new ArrayList<>();

  public Users() {
  }

  public Users nextToken(String nextToken) {
  ...
  public Users users(List<UsersUsersInner> users) {
    this.users = users;
    return this;
  }

  public Users addUsersItem(UsersUsersInner usersItem) {
    if (this.users == null) {
  ...
  public List<UsersUsersInner> getUsers() {
    return users;
  }

  public void setUsers(List<UsersUsersInner> users) {
    this.users = users;
  }
  ...
  public boolean equals(Object o) {
    ...
    Users users = (Users) o;
    return Objects.equals(this.nextToken, users.nextToken) &&
        Objects.equals(this.users, users.users);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, users);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayusers.size(); i++) {
        UsersUsersInner.validateJsonElement(jsonArrayusers.get(i));
      };
  }
