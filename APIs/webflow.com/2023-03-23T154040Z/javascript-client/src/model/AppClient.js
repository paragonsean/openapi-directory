...
/**
 * The AppClient model module.
 * @module model/AppClient
 * @version 2023-03-23T15:40:40Z
 */
class AppClient {
    /**
     * Constructs a new <code>AppClient</code>.
     * @alias module:model/AppClient
    ...
    constructor(appClientId, callbackUrls, clientId, createdBy, createdTime, defaultLoginUrl, description, hasSecret, loginUrls, logoutUrls, name, updatedBy, updatedTime) { 
        ...
        AppClient.initialize(this, appClientId, callbackUrls, clientId, createdBy, createdTime, defaultLoginUrl, description, hasSecret, loginUrls, logoutUrls, name, updatedBy, updatedTime);
    }
    ...
    /**
     * Constructs a <code>AppClient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppClient} obj Optional instance to populate.
     * @return {module:model/AppClient} The populated <code>AppClient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppClient();
    ...
    /**
     * Validates the JSON data with respect to <code>AppClient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppClient</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AppClient.RequiredProperties) {
...
AppClient.RequiredProperties = ["appClientId", "callbackUrls", "clientId", "createdBy", "createdTime", "defaultLoginUrl", "description", "hasSecret", "loginUrls", "logoutUrls", "name", "updatedBy", "updatedTime"];

/**
 * @member {String} appClientId
 */
AppClient.prototype['appClientId'] = undefined;

/**
 * @member {Array.<String>} callbackUrls
 */
AppClient.prototype['callbackUrls'] = undefined;

/**
 * @member {String} clientId
 */
AppClient.prototype['clientId'] = undefined;

/**
 * @member {String} clientSecret
 */
AppClient.prototype['clientSecret'] = undefined;

/**
 * @member {String} createdBy
 */
AppClient.prototype['createdBy'] = undefined;

/**
 * @member {String} createdTime
 */
AppClient.prototype['createdTime'] = undefined;

/**
 * @member {String} defaultLoginUrl
 */
AppClient.prototype['defaultLoginUrl'] = undefined;

/**
 * @member {String} description
 */
AppClient.prototype['description'] = undefined;

/**
 * @member {Boolean} hasSecret
 */
AppClient.prototype['hasSecret'] = undefined;

/**
 * @member {Array.<String>} loginUrls
 */
AppClient.prototype['loginUrls'] = undefined;

/**
 * @member {Array.<String>} logoutUrls
 */
AppClient.prototype['logoutUrls'] = undefined;

/**
 * @member {String} name
 */
AppClient.prototype['name'] = undefined;

/**
 * @member {String} updatedBy
 */
AppClient.prototype['updatedBy'] = undefined;

/**
 * @member {String} updatedTime
 */
AppClient.prototype['updatedTime'] = undefined;
