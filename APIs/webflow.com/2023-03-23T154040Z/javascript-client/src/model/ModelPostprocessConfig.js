...
/**
 * The ModelPostprocessConfig model module.
 * @module model/ModelPostprocessConfig
 * @version 2023-03-23T15:40:40Z
 */
class ModelPostprocessConfig {
    /**
     * Constructs a new <code>ModelPostprocessConfig</code>.
     * @alias module:model/ModelPostprocessConfig
     * @param {(module:model/ModelPostprocessConfigOneOf|module:model/ModelPostprocessConfigOneOf1)} instance The actual instance to initialize ModelPostprocessConfig.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `ModelPostprocessConfig` with oneOf schemas ModelPostprocessConfigOneOf, ModelPostprocessConfigOneOf1. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `ModelPostprocessConfig` with oneOf schemas ModelPostprocessConfigOneOf, ModelPostprocessConfigOneOf1. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>ModelPostprocessConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelPostprocessConfig} obj Optional instance to populate.
     * @return {module:model/ModelPostprocessConfig} The populated <code>ModelPostprocessConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        return new ModelPostprocessConfig(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = ModelPostprocessConfig.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of ModelPostprocessConfig from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/ModelPostprocessConfig} An instance of ModelPostprocessConfig.
     */
    static fromJSON = function(json_string){
        return ModelPostprocessConfig.constructFromObject(JSON.parse(json_string));
    }
}

/**
 * @member {module:model/ModelPostprocessConfig.StrategyEnum} strategy
 */
ModelPostprocessConfig.prototype['strategy'] = undefined;

/**
 * @member {module:model/ModelPostprocessConfigOneOf1Parameters} parameters
 */
ModelPostprocessConfig.prototype['parameters'] = undefined;


ModelPostprocessConfig.OneOf = ["ModelPostprocessConfigOneOf", "ModelPostprocessConfigOneOf1"];

export default ModelPostprocessConfig;
