...
class PaymentMethod {
    ...
    constructor(createdBy, createdTime, description, details, name, paymentMethodId, updatedBy, updatedTime) { 
        ...
        PaymentMethod.initialize(this, createdBy, createdTime, description, details, name, paymentMethodId, updatedBy, updatedTime);
    }
...
PaymentMethod.RequiredProperties = ["createdBy", "createdTime", "description", "details", "name", "paymentMethodId", "updatedBy", "updatedTime"];

/**
 * @member {String} createdBy
 */
PaymentMethod.prototype['createdBy'] = undefined;

/**
 * @member {String} createdTime
 */
PaymentMethod.prototype['createdTime'] = undefined;
 ...
 */
PaymentMethod.prototype['paymentMethodId'] = undefined;

/**
 * @member {String} stripePublishableKey
 */
PaymentMethod.prototype['stripePublishableKey'] = undefined;

/**
 * @member {String} stripeSetupIntentSecret
 */
PaymentMethod.prototype['stripeSetupIntentSecret'] = undefined;

/**
 * @member {String} updatedBy
 */
PaymentMethod.prototype['updatedBy'] = undefined;

/**
 * @member {String} updatedTime
 */
PaymentMethod.prototype['updatedTime'] = undefined;
