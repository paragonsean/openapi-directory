...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.PostDocuments();
  });
  ...
  describe('PostDocuments', function() {
    it('should create an instance of PostDocuments', function() {
      // uncomment below and update the code to test PostDocuments
      //var instance = new LucidtechApi.PostDocuments();
      //expect(instance).to.be.a(LucidtechApi.PostDocuments);
    });
