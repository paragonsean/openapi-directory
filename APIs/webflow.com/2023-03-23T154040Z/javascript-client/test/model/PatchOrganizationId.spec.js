...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.PatchOrganizationId();
  });
  ...
  describe('PatchOrganizationId', function() {
    it('should create an instance of PatchOrganizationId', function() {
      // uncomment below and update the code to test PatchOrganizationId
      //var instance = new LucidtechApi.PatchOrganizationId();
      //expect(instance).to.be.a(LucidtechApi.PatchOrganizationId);
    });
