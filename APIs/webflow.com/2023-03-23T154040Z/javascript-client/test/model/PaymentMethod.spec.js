...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.PaymentMethod();
  });
  ...
  describe('PaymentMethod', function() {
    it('should create an instance of PaymentMethod', function() {
      ...
      //var instance = new LucidtechApi.PaymentMethod();
      //expect(instance).to.be.a(LucidtechApi.PaymentMethod);
    });
    ...
    it('should have the property stripePublishableKey (base name: "stripePublishableKey")', function() {
      // uncomment below and update the code to test the property stripePublishableKey
      //var instance = new LucidtechApi.PaymentMethod();
      //expect(instance).to.be();
    });

    it('should have the property stripeSetupIntentSecret (base name: "stripeSetupIntentSecret")', function() {
      // uncomment below and update the code to test the property stripeSetupIntentSecret
      //var instance = new LucidtechApi.PaymentMethod();
      //expect(instance).to.be();
    });
