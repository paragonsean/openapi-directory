...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.DatasetsDatasetsInner();
  });
  ...
  describe('DatasetsDatasetsInner', function() {
    it('should create an instance of DatasetsDatasetsInner', function() {
      // uncomment below and update the code to test DatasetsDatasetsInner
      //var instance = new LucidtechApi.DatasetsDatasetsInner();
      //expect(instance).to.be.a(LucidtechApi.DatasetsDatasetsInner);
    });
