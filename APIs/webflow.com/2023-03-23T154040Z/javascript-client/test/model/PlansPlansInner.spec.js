...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.PlansPlansInner();
  });
  ...
  describe('PlansPlansInner', function() {
    it('should create an instance of PlansPlansInner', function() {
      // uncomment below and update the code to test PlansPlansInner
      //var instance = new LucidtechApi.PlansPlansInner();
      //expect(instance).to.be.a(LucidtechApi.PlansPlansInner);
    });
