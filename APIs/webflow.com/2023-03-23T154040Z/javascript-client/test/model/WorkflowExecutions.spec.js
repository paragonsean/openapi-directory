...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.WorkflowExecutions();
  });
  ...
  describe('WorkflowExecutions', function() {
    it('should create an instance of WorkflowExecutions', function() {
      // uncomment below and update the code to test WorkflowExecutions
      //var instance = new LucidtechApi.WorkflowExecutions();
      //expect(instance).to.be.a(LucidtechApi.WorkflowExecutions);
    });
