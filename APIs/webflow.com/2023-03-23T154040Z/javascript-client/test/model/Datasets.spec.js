...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.Datasets();
  });
  ...
  describe('Datasets', function() {
    it('should create an instance of Datasets', function() {
      // uncomment below and update the code to test Datasets
      //var instance = new LucidtechApi.Datasets();
      //expect(instance).to.be.a(LucidtechApi.Datasets);
    });
