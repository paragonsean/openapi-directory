...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.Plans();
  });
  ...
  describe('Plans', function() {
    it('should create an instance of Plans', function() {
      // uncomment below and update the code to test Plans
      //var instance = new LucidtechApi.Plans();
      //expect(instance).to.be.a(LucidtechApi.Plans);
    });
