...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.Workflows();
  });
  ...
  describe('Workflows', function() {
    it('should create an instance of Workflows', function() {
      // uncomment below and update the code to test Workflows
      //var instance = new LucidtechApi.Workflows();
      //expect(instance).to.be.a(LucidtechApi.Workflows);
    });
