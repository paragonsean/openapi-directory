...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.AssetsAssetsInner();
  });
  ...
  describe('AssetsAssetsInner', function() {
    it('should create an instance of AssetsAssetsInner', function() {
      // uncomment below and update the code to test AssetsAssetsInner
      //var instance = new LucidtechApi.AssetsAssetsInner();
      //expect(instance).to.be.a(LucidtechApi.AssetsAssetsInner);
    });
