...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.TransitionExecution();
  });
  ...
  describe('TransitionExecution', function() {
    it('should create an instance of TransitionExecution', function() {
      // uncomment below and update the code to test TransitionExecution
      //var instance = new LucidtechApi.TransitionExecution();
      //expect(instance).to.be.a(LucidtechApi.TransitionExecution);
    });
