...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.Predictions();
  });
  ...
  describe('Predictions', function() {
    it('should create an instance of Predictions', function() {
      // uncomment below and update the code to test Predictions
      //var instance = new LucidtechApi.Predictions();
      //expect(instance).to.be.a(LucidtechApi.Predictions);
    });
