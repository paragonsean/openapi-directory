...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LucidtechApi.PatchTransitionIdParameters();
  });
  ...
  describe('PatchTransitionIdParameters', function() {
    it('should create an instance of PatchTransitionIdParameters', function() {
      // uncomment below and update the code to test PatchTransitionIdParameters
      //var instance = new LucidtechApi.PatchTransitionIdParameters();
      //expect(instance).to.be.a(LucidtechApi.PatchTransitionIdParameters);
    });
