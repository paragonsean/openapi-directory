...
/*
 * OAILogs_logs_inner.h
 *
 * 
 */

#ifndef OAILogs_logs_inner_H
#define OAILogs_logs_inner_H
...
class OAILogs_logs_inner : public OAIObject {
public:
    OAILogs_logs_inner();
    OAILogs_logs_inner(QString json);
    ~OAILogs_logs_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogs_logs_inner)

#endif // OAILogs_logs_inner_H
