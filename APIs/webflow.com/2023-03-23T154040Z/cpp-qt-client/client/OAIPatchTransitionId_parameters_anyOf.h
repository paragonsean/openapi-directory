...
/*
 * OAIPatchTransitionId_parameters_anyOf.h
 *
 * 
 */

#ifndef OAIPatchTransitionId_parameters_anyOf_H
#define OAIPatchTransitionId_parameters_anyOf_H
...
class OAIPatchTransitionId_parameters_anyOf : public OAIObject {
public:
    OAIPatchTransitionId_parameters_anyOf();
    OAIPatchTransitionId_parameters_anyOf(QString json);
    ~OAIPatchTransitionId_parameters_anyOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatchTransitionId_parameters_anyOf)

#endif // OAIPatchTransitionId_parameters_anyOf_H
