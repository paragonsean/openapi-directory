...
/*
 * OAIWorkflowExecutions_executions_inner.h
 *
 * 
 */

#ifndef OAIWorkflowExecutions_executions_inner_H
#define OAIWorkflowExecutions_executions_inner_H
...
class OAIWorkflowExecutions_executions_inner : public OAIObject {
public:
    OAIWorkflowExecutions_executions_inner();
    OAIWorkflowExecutions_executions_inner(QString json);
    ~OAIWorkflowExecutions_executions_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowExecutions_executions_inner)

#endif // OAIWorkflowExecutions_executions_inner_H
