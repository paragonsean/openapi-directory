...
#ifndef OAIDataBundle_H
#define OAIDataBundle_H
...
class OAIDataBundle : public OAIObject {
public:
    OAIDataBundle();
    OAIDataBundle(QString json);
    ~OAIDataBundle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataBundle)

#endif // OAIDataBundle_H
