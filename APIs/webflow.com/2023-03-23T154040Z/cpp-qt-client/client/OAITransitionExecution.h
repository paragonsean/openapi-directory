...
/*
 * OAITransitionExecution.h
 *
 * 
 */

#ifndef OAITransitionExecution_H
#define OAITransitionExecution_H
...
class OAITransitionExecution : public OAIObject {
public:
    OAITransitionExecution();
    OAITransitionExecution(QString json);
    ~OAITransitionExecution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransitionExecution)

#endif // OAITransitionExecution_H
