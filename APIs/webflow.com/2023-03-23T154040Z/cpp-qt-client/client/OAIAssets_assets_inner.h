...
/*
 * OAIAssets_assets_inner.h
 *
 * 
 */

#ifndef OAIAssets_assets_inner_H
#define OAIAssets_assets_inner_H
...
class OAIAssets_assets_inner : public OAIObject {
public:
    OAIAssets_assets_inner();
    OAIAssets_assets_inner(QString json);
    ~OAIAssets_assets_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssets_assets_inner)

#endif // OAIAssets_assets_inner_H
