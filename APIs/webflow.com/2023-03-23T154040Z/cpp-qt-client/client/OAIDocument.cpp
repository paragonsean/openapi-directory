...
QString OAIDocument::getConsentId() const {
    return m_consent_id;
}
void OAIDocument::setConsentId(const QString &consent_id) {
    m_consent_id = consent_id;
    m_consent_id_isSet = true;
}

bool OAIDocument::is_consent_id_Set() const{
    return m_consent_id_isSet;
}

bool OAIDocument::is_consent_id_Valid() const{
...
QString OAIDocument::getContentMd5() const {
    return m_content_md5;
}
void OAIDocument::setContentMd5(const QString &content_md5) {
    m_content_md5 = content_md5;
    m_content_md5_isSet = true;
}

bool OAIDocument::is_content_md5_Set() const{
    return m_content_md5_isSet;
}

bool OAIDocument::is_content_md5_Valid() const{
...
QString OAIDocument::getCreatedBy() const {
    return m_created_by;
}
void OAIDocument::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIDocument::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIDocument::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAIDocument::getCreatedTime() const {
    return m_created_time;
}
void OAIDocument::setCreatedTime(const QString &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDocument::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDocument::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDocument::getDatasetId() const {
    return m_dataset_id;
}
void OAIDocument::setDatasetId(const QString &dataset_id) {
    m_dataset_id = dataset_id;
    m_dataset_id_isSet = true;
}

bool OAIDocument::is_dataset_id_Set() const{
    return m_dataset_id_isSet;
}

bool OAIDocument::is_dataset_id_Valid() const{
...
QList<OAIDocument_groundTruth_inner> OAIDocument::getGroundTruth() const {
    return m_ground_truth;
}
void OAIDocument::setGroundTruth(const QList<OAIDocument_groundTruth_inner> &ground_truth) {
    m_ground_truth = ground_truth;
    m_ground_truth_isSet = true;
}

bool OAIDocument::is_ground_truth_Set() const{
    return m_ground_truth_isSet;
}

bool OAIDocument::is_ground_truth_Valid() const{
    return m_ground_truth_isValid;
}

OAIObject OAIDocument::getMetadata() const {
    return m_metadata;
}
void OAIDocument::setMetadata(const OAIObject &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIDocument::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIDocument::is_metadata_Valid() const{
...
qint32 OAIDocument::getRetentionInDays() const {
    return m_retention_in_days;
}
void OAIDocument::setRetentionInDays(const qint32 &retention_in_days) {
    m_retention_in_days = retention_in_days;
    m_retention_in_days_isSet = true;
}

bool OAIDocument::is_retention_in_days_Set() const{
    return m_retention_in_days_isSet;
}

bool OAIDocument::is_retention_in_days_Valid() const{
    return m_retention_in_days_isValid;
}

QString OAIDocument::getUpdatedBy() const {
    return m_updated_by;
}
void OAIDocument::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAIDocument::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAIDocument::is_updated_by_Valid() const{
    return m_updated_by_isValid;
}

QString OAIDocument::getUpdatedTime() const {
    return m_updated_time;
}
void OAIDocument::setUpdatedTime(const QString &updated_time) {
    m_updated_time = updated_time;
    m_updated_time_isSet = true;
}

bool OAIDocument::is_updated_time_Set() const{
    return m_updated_time_isSet;
}

bool OAIDocument::is_updated_time_Valid() const{
