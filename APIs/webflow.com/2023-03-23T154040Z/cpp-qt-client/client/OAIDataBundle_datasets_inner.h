...
/*
 * OAIDataBundle_datasets_inner.h
 *
 * 
 */

#ifndef OAIDataBundle_datasets_inner_H
#define OAIDataBundle_datasets_inner_H
...
class OAIDataBundle_datasets_inner : public OAIObject {
public:
    OAIDataBundle_datasets_inner();
    OAIDataBundle_datasets_inner(QString json);
    ~OAIDataBundle_datasets_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataBundle_datasets_inner)

#endif // OAIDataBundle_datasets_inner_H
