...
#ifndef OAITheme_Themes_H
#define OAITheme_Themes_H
...
class OAITheme_Themes : public OAIObject {
public:
    OAITheme_Themes();
    OAITheme_Themes(QString json);
    ~OAITheme_Themes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITheme_Themes)

#endif // OAITheme_Themes_H
