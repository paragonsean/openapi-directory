...
#ifndef OAITable_Tables_H
#define OAITable_Tables_H
...
class OAITable_Tables : public OAIObject {
public:
    OAITable_Tables();
    OAITable_Tables(QString json);
    ~OAITable_Tables() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITable_Tables)

#endif // OAITable_Tables_H
