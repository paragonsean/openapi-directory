...
#ifndef OAISlide_Groups_H
#define OAISlide_Groups_H
...
class OAISlide_Groups : public OAIObject {
public:
    OAISlide_Groups();
    OAISlide_Groups(QString json);
    ~OAISlide_Groups() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlide_Groups)

#endif // OAISlide_Groups_H
