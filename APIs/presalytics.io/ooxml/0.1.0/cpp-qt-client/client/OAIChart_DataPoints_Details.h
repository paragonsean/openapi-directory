...
/*
 * OAIChart_DataPoints_Details.h
 *
 * 
 */

#ifndef OAIChart_DataPoints_Details_H
#define OAIChart_DataPoints_Details_H
...
class OAIChart_DataPoints_Details : public OAIObject {
public:
    OAIChart_DataPoints_Details();
    OAIChart_DataPoints_Details(QString json);
    ~OAIChart_DataPoints_Details() override;
    ...
    OAIChart_Columns_Details getColumn() const;
    void setColumn(const OAIChart_Columns_Details &column);
    ...
    OAIChart_Rows_Details getRow() const;
    void setRow(const OAIChart_Rows_Details &row);
...
private:
    ...
    OAIChart_Columns_Details m_column;
    bool m_column_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChart_DataPoints_Details)

#endif // OAIChart_DataPoints_Details_H
