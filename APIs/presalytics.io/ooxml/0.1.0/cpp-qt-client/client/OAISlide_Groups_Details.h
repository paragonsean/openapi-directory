...
/*
 * OAISlide_Groups_Details.h
 *
 * 
 */

#ifndef OAISlide_Groups_Details_H
#define OAISlide_Groups_Details_H
...
class OAISlide_Groups_Details : public OAIObject {
public:
    OAISlide_Groups_Details();
    OAISlide_Groups_Details(QString json);
    ~OAISlide_Groups_Details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlide_Groups_Details)

#endif // OAISlide_Groups_Details_H
