...
/*
 * OAITable_Columns_Details.h
 *
 * 
 */

#ifndef OAITable_Columns_Details_H
#define OAITable_Columns_Details_H
...
class OAITable_Columns_Details : public OAIObject {
public:
    OAITable_Columns_Details();
    OAITable_Columns_Details(QString json);
    ~OAITable_Columns_Details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITable_Columns_Details)

#endif // OAITable_Columns_Details_H
