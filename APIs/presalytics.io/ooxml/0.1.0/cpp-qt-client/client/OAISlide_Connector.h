...
/*
 * OAISlide_Connector.h
 *
 * 
 */

#ifndef OAISlide_Connector_H
#define OAISlide_Connector_H
...
class OAISlide_Connector : public OAIObject {
public:
    OAISlide_Connector();
    OAISlide_Connector(QString json);
    ~OAISlide_Connector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlide_Connector)

#endif // OAISlide_Connector_H
