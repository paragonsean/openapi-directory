...
/*
 * OAIShared_Pictures_Details.h
 *
 * 
 */

#ifndef OAIShared_Pictures_Details_H
#define OAIShared_Pictures_Details_H
...
class OAIShared_Pictures_Details : public OAIObject {
public:
    OAIShared_Pictures_Details();
    OAIShared_Pictures_Details(QString json);
    ~OAIShared_Pictures_Details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShared_Pictures_Details)

#endif // OAIShared_Pictures_Details_H
