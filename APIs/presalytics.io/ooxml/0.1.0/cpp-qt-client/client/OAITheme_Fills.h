...
#ifndef OAITheme_Fills_H
#define OAITheme_Fills_H
...
class OAITheme_Fills : public OAIObject {
public:
    OAITheme_Fills();
    OAITheme_Fills(QString json);
    ~OAITheme_Fills() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITheme_Fills)

#endif // OAITheme_Fills_H
