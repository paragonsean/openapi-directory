...
/*
 * OAITheme_EffectMap.h
 *
 * 
 */

#ifndef OAITheme_EffectMap_H
#define OAITheme_EffectMap_H
...
class OAITheme_EffectMap : public OAIObject {
public:
    OAITheme_EffectMap();
    OAITheme_EffectMap(QString json);
    ~OAITheme_EffectMap() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITheme_EffectMap)

#endif // OAITheme_EffectMap_H
