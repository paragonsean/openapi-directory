...
async def slides_shapetrees_childobjects_get_id(request: web.Request, id) -> web.Response:
...
async def slides_shapetrees_details_get_id(request: web.Request, id) -> web.Response:
    """Slides: Get Details
...
async def slides_shapetrees_get_id(request: web.Request, id) -> web.Response:
...
async def slides_shapetrees_openofficexml_get_id_updated(request: web.Request, id, updated=None) -> web.Response:
...
async def slides_shapetrees_openofficexml_put_id(request: web.Request, id, body=None) -> web.Response:
...
async def slides_shapetrees_svg_get_id_use_cache(request: web.Request, id, use_cache=None) -> web.Response:
    """Slides: Get Svg file
