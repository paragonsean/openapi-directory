...
async def theme_themes_childobjects_get_id(request: web.Request, id) -> web.Response:
...
async def theme_themes_details_get_id(request: web.Request, id) -> web.Response:
    """Theme: Get Details
...
async def theme_themes_get_id(request: web.Request, id) -> web.Response:
    """Themes: Get by Id
...
async def theme_themes_openofficexml_get_id_updated(request: web.Request, id, updated=None) -> web.Response:
...
async def theme_themes_openofficexml_put_id(request: web.Request, id, body=None) -> web.Response:
...
async def theme_themes_svg_get_id_use_cache(request: web.Request, id, use_cache=None) -> web.Response:
    """Theme: Get Svg file
