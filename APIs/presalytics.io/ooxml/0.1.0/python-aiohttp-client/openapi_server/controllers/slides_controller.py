...
async def slides_slides_childobjects_get_id(request: web.Request, id) -> web.Response:
...
async def slides_slides_details_get_id(request: web.Request, id) -> web.Response:
    """Slides: Get Details
...
async def slides_slides_get_id(request: web.Request, id) -> web.Response:
    """Slides: Get by Id
...
async def slides_slides_openofficexml_get_id_updated(request: web.Request, id, updated=None) -> web.Response:
...
async def slides_slides_openofficexml_put_id(request: web.Request, id, body=None) -> web.Response:
...
async def slides_slides_svg_get_id_use_cache(request: web.Request, id, use_cache=None) -> web.Response:
    """Slides: Get Svg file
