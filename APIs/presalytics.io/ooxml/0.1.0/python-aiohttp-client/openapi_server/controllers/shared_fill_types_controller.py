...
async def shared_filltypes_get(request: web.Request, ) -> web.Response:
...
async def shared_filltypes_get_id(request: web.Request, id) -> web.Response:
    """FillTypes: Get by Id
...
async def shared_filltypes_typeid_get_type_id(request: web.Request, type_id) -> web.Response:
