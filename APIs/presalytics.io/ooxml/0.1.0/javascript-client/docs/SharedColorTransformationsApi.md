# OoxmlAutomation.SharedColorTransformationsApi
...
let apiInstance = new OoxmlAutomation.SharedColorTransformationsApi();
let id = "id_example"; // String | 
apiInstance.sharedColortransformationsGetId(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
