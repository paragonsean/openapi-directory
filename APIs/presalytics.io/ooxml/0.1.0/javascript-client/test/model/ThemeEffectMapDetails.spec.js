...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeEffectMapDetails();
  });
  ...
  describe('ThemeEffectMapDetails', function() {
    it('should create an instance of ThemeEffectMapDetails', function() {
      // uncomment below and update the code to test ThemeEffectMapDetails
      //var instance = new OoxmlAutomation.ThemeEffectMapDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeEffectMapDetails);
    });
