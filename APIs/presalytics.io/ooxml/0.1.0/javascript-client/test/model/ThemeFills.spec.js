...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeFills();
  });
  ...
  describe('ThemeFills', function() {
    it('should create an instance of ThemeFills', function() {
      // uncomment below and update the code to test ThemeFills
      //var instance = new OoxmlAutomation.ThemeFills();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeFills);
    });
