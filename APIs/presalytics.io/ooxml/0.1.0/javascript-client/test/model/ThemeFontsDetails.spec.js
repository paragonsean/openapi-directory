...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeFontsDetails();
  });
  ...
  describe('ThemeFontsDetails', function() {
    it('should create an instance of ThemeFontsDetails', function() {
      // uncomment below and update the code to test ThemeFontsDetails
      //var instance = new OoxmlAutomation.ThemeFontsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeFontsDetails);
    });

    it('should have the property bodyFont (base name: "bodyFont")', function() {
      // uncomment below and update the code to test the property bodyFont
      //var instance = new OoxmlAutomation.ThemeFontsDetails();
    ...
    it('should have the property headingFont (base name: "headingFont")', function() {
      // uncomment below and update the code to test the property headingFont
      //var instance = new OoxmlAutomation.ThemeFontsDetails();
      //expect(instance).to.be();
    });
