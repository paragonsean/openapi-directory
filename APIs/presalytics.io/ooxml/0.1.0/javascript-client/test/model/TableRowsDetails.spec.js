...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.TableRowsDetails();
  });
  ...
  describe('TableRowsDetails', function() {
    it('should create an instance of TableRowsDetails', function() {
      // uncomment below and update the code to test TableRowsDetails
      //var instance = new OoxmlAutomation.TableRowsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.TableRowsDetails);
    });
