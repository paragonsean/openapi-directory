...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SlideSmartArtsDetails();
  });
  ...
  describe('SlideSmartArtsDetails', function() {
    it('should create an instance of SlideSmartArtsDetails', function() {
      // uncomment below and update the code to test SlideSmartArtsDetails
      //var instance = new OoxmlAutomation.SlideSmartArtsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.SlideSmartArtsDetails);
    });
