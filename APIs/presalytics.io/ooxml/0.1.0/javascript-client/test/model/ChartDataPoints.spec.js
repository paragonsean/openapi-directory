...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ChartDataPoints();
  });
  ...
  describe('ChartDataPoints', function() {
    it('should create an instance of ChartDataPoints', function() {
      // uncomment below and update the code to test ChartDataPoints
      //var instance = new OoxmlAutomation.ChartDataPoints();
      //expect(instance).to.be.a(OoxmlAutomation.ChartDataPoints);
    });
