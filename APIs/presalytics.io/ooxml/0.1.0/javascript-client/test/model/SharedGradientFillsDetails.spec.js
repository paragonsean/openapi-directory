...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SharedGradientFillsDetails();
  });
  ...
  describe('SharedGradientFillsDetails', function() {
    it('should create an instance of SharedGradientFillsDetails', function() {
      // uncomment below and update the code to test SharedGradientFillsDetails
      //var instance = new OoxmlAutomation.SharedGradientFillsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.SharedGradientFillsDetails);
    });
    ...
    it('should have the property gradientStops (base name: "gradientStops")', function() {
      // uncomment below and update the code to test the property gradientStops
      //var instance = new OoxmlAutomation.SharedGradientFillsDetails();
      //expect(instance).to.be();
    });
