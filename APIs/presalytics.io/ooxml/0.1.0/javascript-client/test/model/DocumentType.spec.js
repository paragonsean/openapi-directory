...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.DocumentType();
  });
  ...
  describe('DocumentType', function() {
    it('should create an instance of DocumentType', function() {
      ...
      //var instance = new OoxmlAutomation.DocumentType();
      //expect(instance).to.be.a(OoxmlAutomation.DocumentType);
    });
    ...
    it('should have the property ooxmlPackageType (base name: "ooxmlPackageType")', function() {
      // uncomment below and update the code to test the property ooxmlPackageType
      //var instance = new OoxmlAutomation.DocumentType();
      //expect(instance).to.be();
    });
