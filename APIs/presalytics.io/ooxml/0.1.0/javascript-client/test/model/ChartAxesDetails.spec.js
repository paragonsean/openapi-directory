...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ChartAxesDetails();
  });
  ...
  describe('ChartAxesDetails', function() {
    it('should create an instance of ChartAxesDetails', function() {
      // uncomment below and update the code to test ChartAxesDetails
      //var instance = new OoxmlAutomation.ChartAxesDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ChartAxesDetails);
    });
