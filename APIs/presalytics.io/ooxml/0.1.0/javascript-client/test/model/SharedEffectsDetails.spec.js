...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SharedEffectsDetails();
  });
  ...
  describe('SharedEffectsDetails', function() {
    it('should create an instance of SharedEffectsDetails', function() {
      // uncomment below and update the code to test SharedEffectsDetails
      //var instance = new OoxmlAutomation.SharedEffectsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.SharedEffectsDetails);
    });
    ...
    it('should have the property effectAttributes (base name: "effectAttributes")', function() {
      // uncomment below and update the code to test the property effectAttributes
      //var instance = new OoxmlAutomation.SharedEffectsDetails();
      //expect(instance).to.be();
    });

    it('should have the property effectMap (base name: "effectMap")', function() {
      // uncomment below and update the code to test the property effectMap
      //var instance = new OoxmlAutomation.SharedEffectsDetails();
      //expect(instance).to.be();
    });

    it('should have the property effectMapId (base name: "effectMapId")', function() {
      // uncomment below and update the code to test the property effectMapId
      //var instance = new OoxmlAutomation.SharedEffectsDetails();
      //expect(instance).to.be();
    });
