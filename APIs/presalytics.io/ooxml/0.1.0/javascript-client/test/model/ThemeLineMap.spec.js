...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeLineMap();
  });
  ...
  describe('ThemeLineMap', function() {
    it('should create an instance of ThemeLineMap', function() {
      // uncomment below and update the code to test ThemeLineMap
      //var instance = new OoxmlAutomation.ThemeLineMap();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeLineMap);
    });
