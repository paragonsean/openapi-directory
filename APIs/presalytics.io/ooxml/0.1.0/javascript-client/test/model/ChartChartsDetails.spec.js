...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ChartChartsDetails();
  });
  ...
  describe('ChartChartsDetails', function() {
    it('should create an instance of ChartChartsDetails', function() {
      // uncomment below and update the code to test ChartChartsDetails
      //var instance = new OoxmlAutomation.ChartChartsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ChartChartsDetails);
    });
    ...
    it('should have the property titleTextContainer (base name: "titleTextContainer")', function() {
      // uncomment below and update the code to test the property titleTextContainer
      //var instance = new OoxmlAutomation.ChartChartsDetails();
      //expect(instance).to.be();
    });
