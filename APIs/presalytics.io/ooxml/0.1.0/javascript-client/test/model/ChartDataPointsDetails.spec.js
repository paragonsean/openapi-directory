...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ChartDataPointsDetails();
  });
  ...
  describe('ChartDataPointsDetails', function() {
    it('should create an instance of ChartDataPointsDetails', function() {
      // uncomment below and update the code to test ChartDataPointsDetails
      //var instance = new OoxmlAutomation.ChartDataPointsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ChartDataPointsDetails);
    });
