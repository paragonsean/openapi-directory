...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeLineMapDetails();
  });
  ...
  describe('ThemeLineMapDetails', function() {
    it('should create an instance of ThemeLineMapDetails', function() {
      // uncomment below and update the code to test ThemeLineMapDetails
      //var instance = new OoxmlAutomation.ThemeLineMapDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeLineMapDetails);
    });
