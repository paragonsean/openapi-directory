...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeEffectMap();
  });
  ...
  describe('ThemeEffectMap', function() {
    it('should create an instance of ThemeEffectMap', function() {
      // uncomment below and update the code to test ThemeEffectMap
      //var instance = new OoxmlAutomation.ThemeEffectMap();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeEffectMap);
    });
