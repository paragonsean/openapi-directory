...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeCustomColors();
  });
  ...
  describe('ThemeCustomColors', function() {
    it('should create an instance of ThemeCustomColors', function() {
      // uncomment below and update the code to test ThemeCustomColors
      //var instance = new OoxmlAutomation.ThemeCustomColors();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeCustomColors);
    });
