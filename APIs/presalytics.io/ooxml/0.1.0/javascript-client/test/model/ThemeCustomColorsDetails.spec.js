...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeCustomColorsDetails();
  });
  ...
  describe('ThemeCustomColorsDetails', function() {
    it('should create an instance of ThemeCustomColorsDetails', function() {
      // uncomment below and update the code to test ThemeCustomColorsDetails
      //var instance = new OoxmlAutomation.ThemeCustomColorsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeCustomColorsDetails);
    });
