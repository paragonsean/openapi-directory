...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SlideGroupElementTypesDetails();
  });
  ...
  describe('SlideGroupElementTypesDetails', function() {
    it('should create an instance of SlideGroupElementTypesDetails', function() {
      // uncomment below and update the code to test SlideGroupElementTypesDetails
      //var instance = new OoxmlAutomation.SlideGroupElementTypesDetails();
      //expect(instance).to.be.a(OoxmlAutomation.SlideGroupElementTypesDetails);
    });
