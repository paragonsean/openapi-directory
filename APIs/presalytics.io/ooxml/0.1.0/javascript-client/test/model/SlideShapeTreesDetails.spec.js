...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SlideShapeTreesDetails();
  });
  ...
  describe('SlideShapeTreesDetails', function() {
    it('should create an instance of SlideShapeTreesDetails', function() {
      // uncomment below and update the code to test SlideShapeTreesDetails
      //var instance = new OoxmlAutomation.SlideShapeTreesDetails();
      //expect(instance).to.be.a(OoxmlAutomation.SlideShapeTreesDetails);
    });
    ...
    it('should have the property groupElements (base name: "groupElements")', function() {
      // uncomment below and update the code to test the property groupElements
      //var instance = new OoxmlAutomation.SlideShapeTreesDetails();
      //expect(instance).to.be();
    });
