...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SlideGroups();
  });
  ...
  describe('SlideGroups', function() {
    it('should create an instance of SlideGroups', function() {
      // uncomment below and update the code to test SlideGroups
      //var instance = new OoxmlAutomation.SlideGroups();
      //expect(instance).to.be.a(OoxmlAutomation.SlideGroups);
    });
