...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SlideSlideMastersDetails();
  });
  ...
  describe('SlideSlideMastersDetails', function() {
    it('should create an instance of SlideSlideMastersDetails', function() {
      // uncomment below and update the code to test SlideSlideMastersDetails
      //var instance = new OoxmlAutomation.SlideSlideMastersDetails();
      //expect(instance).to.be.a(OoxmlAutomation.SlideSlideMastersDetails);
    });
    ...
    it('should have the property parentSlide (base name: "parentSlide")', function() {
      // uncomment below and update the code to test the property parentSlide
      //var instance = new OoxmlAutomation.SlideSlideMastersDetails();
      //expect(instance).to.be();
    });
