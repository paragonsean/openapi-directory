...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeThemes();
  });
  ...
  describe('ThemeThemes', function() {
    it('should create an instance of ThemeThemes', function() {
      // uncomment below and update the code to test ThemeThemes
      //var instance = new OoxmlAutomation.ThemeThemes();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeThemes);
    });
