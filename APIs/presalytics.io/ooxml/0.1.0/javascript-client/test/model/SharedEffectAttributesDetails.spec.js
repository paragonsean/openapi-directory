...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SharedEffectAttributesDetails();
  });
  ...
  describe('SharedEffectAttributesDetails', function() {
    it('should create an instance of SharedEffectAttributesDetails', function() {
      // uncomment below and update the code to test SharedEffectAttributesDetails
      //var instance = new OoxmlAutomation.SharedEffectAttributesDetails();
      //expect(instance).to.be.a(OoxmlAutomation.SharedEffectAttributesDetails);
    });
