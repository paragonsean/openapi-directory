...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SlideShapes();
  });
  ...
  describe('SlideShapes', function() {
    it('should create an instance of SlideShapes', function() {
      // uncomment below and update the code to test SlideShapes
      //var instance = new OoxmlAutomation.SlideShapes();
      //expect(instance).to.be.a(OoxmlAutomation.SlideShapes);
    });
