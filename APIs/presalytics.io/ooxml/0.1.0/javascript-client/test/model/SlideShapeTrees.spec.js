...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.SlideShapeTrees();
  });
  ...
  describe('SlideShapeTrees', function() {
    it('should create an instance of SlideShapeTrees', function() {
      // uncomment below and update the code to test SlideShapeTrees
      //var instance = new OoxmlAutomation.SlideShapeTrees();
      //expect(instance).to.be.a(OoxmlAutomation.SlideShapeTrees);
    });
