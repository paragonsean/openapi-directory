...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ThemeFillsDetails();
  });
  ...
  describe('ThemeFillsDetails', function() {
    it('should create an instance of ThemeFillsDetails', function() {
      // uncomment below and update the code to test ThemeFillsDetails
      //var instance = new OoxmlAutomation.ThemeFillsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.ThemeFillsDetails);
    });
