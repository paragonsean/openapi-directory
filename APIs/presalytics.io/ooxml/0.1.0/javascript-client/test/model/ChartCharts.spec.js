...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.ChartCharts();
  });
  ...
  describe('ChartCharts', function() {
    it('should create an instance of ChartCharts', function() {
      // uncomment below and update the code to test ChartCharts
      //var instance = new OoxmlAutomation.ChartCharts();
      //expect(instance).to.be.a(OoxmlAutomation.ChartCharts);
    });
