...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.TableColumnsDetails();
  });
  ...
  describe('TableColumnsDetails', function() {
    it('should create an instance of TableColumnsDetails', function() {
      // uncomment below and update the code to test TableColumnsDetails
      //var instance = new OoxmlAutomation.TableColumnsDetails();
      //expect(instance).to.be.a(OoxmlAutomation.TableColumnsDetails);
    });
