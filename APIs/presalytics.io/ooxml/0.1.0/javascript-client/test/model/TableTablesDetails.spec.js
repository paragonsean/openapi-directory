...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OoxmlAutomation.TableTablesDetails();
  });
  ...
  describe('TableTablesDetails', function() {
    it('should create an instance of TableTablesDetails', function() {
      // uncomment below and update the code to test TableTablesDetails
      //var instance = new OoxmlAutomation.TableTablesDetails();
      //expect(instance).to.be.a(OoxmlAutomation.TableTablesDetails);
    });
