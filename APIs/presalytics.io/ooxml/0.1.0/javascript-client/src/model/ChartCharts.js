...
/**
 * The ChartCharts model module.
 * @module model/ChartCharts
 * @version 0.1.0
 */
class ChartCharts {
    /**
     * Constructs a new <code>ChartCharts</code>.
     * @alias module:model/ChartCharts
     */
    constructor() { 
        
        ChartCharts.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChartCharts</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChartCharts} obj Optional instance to populate.
     * @return {module:model/ChartCharts} The populated <code>ChartCharts</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChartCharts();
    ...
    /**
     * Validates the JSON data with respect to <code>ChartCharts</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChartCharts</code>.
     */
 ...
 */
ChartCharts.prototype['baseElementBlobUrl'] = undefined;

/**
 * @member {String} changedBaseElementBlobUrl
 */
ChartCharts.prototype['changedBaseElementBlobUrl'] = undefined;

/**
 * @member {String} id
 */
ChartCharts.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ChartCharts.prototype['name'] = undefined;

/**
 * @member {String} packageUri
 */
ChartCharts.prototype['packageUri'] = undefined;

/**
 * @member {String} parentGraphicId
 */
ChartCharts.prototype['parentGraphicId'] = undefined;

/**
 * @member {String} svgBlobUrl
 */
ChartCharts.prototype['svgBlobUrl'] = undefined;
