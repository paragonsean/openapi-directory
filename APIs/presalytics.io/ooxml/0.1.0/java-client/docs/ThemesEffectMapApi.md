...
import org.openapitools.client.api.ThemesEffectMapApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ThemesEffectMapApi apiInstance = new ThemesEffectMapApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      ThemeEffectMap result = apiInstance.themesEffectmapGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ThemesEffectMapApi#themesEffectmapGetId");
