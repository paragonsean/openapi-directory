...
import org.openapitools.client.api.TablesColumnsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TablesColumnsApi apiInstance = new TablesColumnsApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      TableColumns result = apiInstance.tablesColumnsGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TablesColumnsApi#tablesColumnsGetId");
