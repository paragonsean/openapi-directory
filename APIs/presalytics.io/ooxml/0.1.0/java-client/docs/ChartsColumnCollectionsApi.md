...
<a id="chartColumncollectionsGetId"></a>
...
import org.openapitools.client.api.ChartsColumnCollectionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ChartsColumnCollectionsApi apiInstance = new ChartsColumnCollectionsApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      ChartColumnCollections result = apiInstance.chartColumncollectionsGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ChartsColumnCollectionsApi#chartColumncollectionsGetId");
