...
<a id="sharedTextcontainerGetId"></a>
...
import org.openapitools.client.api.SharedTextContainerApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SharedTextContainerApi apiInstance = new SharedTextContainerApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      SharedTextContainer result = apiInstance.sharedTextcontainerGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SharedTextContainerApi#sharedTextcontainerGetId");
