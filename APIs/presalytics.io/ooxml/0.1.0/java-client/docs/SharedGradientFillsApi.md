...
<a id="sharedGradientfillsGetId"></a>
...
import org.openapitools.client.api.SharedGradientFillsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SharedGradientFillsApi apiInstance = new SharedGradientFillsApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      SharedGradientFills result = apiInstance.sharedGradientfillsGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SharedGradientFillsApi#sharedGradientfillsGetId");
