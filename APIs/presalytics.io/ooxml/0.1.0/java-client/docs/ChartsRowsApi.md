...
import org.openapitools.client.api.ChartsRowsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ChartsRowsApi apiInstance = new ChartsRowsApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      ChartRows result = apiInstance.chartRowsGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ChartsRowsApi#chartRowsGetId");
