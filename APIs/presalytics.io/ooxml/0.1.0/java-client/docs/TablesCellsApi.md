...
import org.openapitools.client.api.TablesCellsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TablesCellsApi apiInstance = new TablesCellsApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      TableCells result = apiInstance.tablesCellsGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TablesCellsApi#tablesCellsGetId");
