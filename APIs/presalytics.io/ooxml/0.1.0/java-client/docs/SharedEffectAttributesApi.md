...
<a id="sharedEffectattributesGetId"></a>
...
import org.openapitools.client.api.SharedEffectAttributesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SharedEffectAttributesApi apiInstance = new SharedEffectAttributesApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      SharedEffectAttributes result = apiInstance.sharedEffectattributesGetId(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SharedEffectAttributesApi#sharedEffectattributesGetId");
