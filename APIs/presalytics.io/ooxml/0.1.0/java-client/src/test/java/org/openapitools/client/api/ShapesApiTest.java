 ...
 */
@Disabled
public class ShapesApiTest {

    private final ShapesApi api = new ShapesApi();
     ...
     */
    @Test
    public void slidesShapesChildobjectsGetIdTest() throws ApiException {
        UUID id = null;
        List<ChildObjects> response = api.slidesShapesChildobjectsGetId(id);
     ...
     */
    @Test
    public void slidesShapesDetailsGetIdTest() throws ApiException {
        UUID id = null;
        SlideShapesDetails response = api.slidesShapesDetailsGetId(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesShapesGetIdTest() throws ApiException {
        UUID id = null;
        SlideShapes response = api.slidesShapesGetId(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesShapesOpenofficexmlGetIdUpdatedTest() throws ApiException {
        UUID id = null;
        Boolean updated = null;
        OoxmlDTO response = api.slidesShapesOpenofficexmlGetIdUpdated(id, updated);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesShapesOpenofficexmlPutIdTest() throws ApiException {
        String id = null;
        OoxmlDTO ooxmlDTO = null;
        api.slidesShapesOpenofficexmlPutId(id, ooxmlDTO);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesShapesSvgGetIdUseCacheTest() throws ApiException {
        UUID id = null;
        Boolean useCache = null;
        File response = api.slidesShapesSvgGetIdUseCache(id, useCache);
        // TODO: test validations
    }
