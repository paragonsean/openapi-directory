...
/**
 * API tests for SmartArtsApi
 */
@Disabled
public class SmartArtsApiTest {

    private final SmartArtsApi api = new SmartArtsApi();
     ...
     */
    @Test
    public void slidesSmartartsChildobjectsGetIdTest() throws ApiException {
        UUID id = null;
        List<ChildObjects> response = api.slidesSmartartsChildobjectsGetId(id);
     ...
     */
    @Test
    public void slidesSmartartsDetailsGetIdTest() throws ApiException {
        UUID id = null;
        SlideSmartArtsDetails response = api.slidesSmartartsDetailsGetId(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesSmartartsGetIdTest() throws ApiException {
        UUID id = null;
        SlideSmartArts response = api.slidesSmartartsGetId(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesSmartartsOpenofficexmlGetIdUpdatedTest() throws ApiException {
        UUID id = null;
        Boolean updated = null;
        OoxmlDTO response = api.slidesSmartartsOpenofficexmlGetIdUpdated(id, updated);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesSmartartsOpenofficexmlPutIdTest() throws ApiException {
        String id = null;
        OoxmlDTO ooxmlDTO = null;
        api.slidesSmartartsOpenofficexmlPutId(id, ooxmlDTO);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void slidesSmartartsSvgGetIdUseCacheTest() throws ApiException {
        UUID id = null;
        Boolean useCache = null;
        File response = api.slidesSmartartsSvgGetIdUseCache(id, useCache);
        // TODO: test validations
    }
