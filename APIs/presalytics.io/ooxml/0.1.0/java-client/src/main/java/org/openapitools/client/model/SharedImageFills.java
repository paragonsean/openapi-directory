...
public class SharedImageFills {
  ...
  public SharedImageFills() {
  }

  public SharedImageFills compressionState(String compressionState) {
  ...
  public SharedImageFills dpi(Integer dpi) {
    this.dpi = dpi;
    return this;
  }
  ...
  public SharedImageFills effectsJson(String effectsJson) {
  ...
  public SharedImageFills fillMapId(UUID fillMapId) {
  ...
  public SharedImageFills id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SharedImageFills rotateWithShape(Boolean rotateWithShape) {
  ...
  public SharedImageFills sourceRectangle(String sourceRectangle) {
  ...
  public SharedImageFills stretch(Boolean stretch) {
  ...
  public SharedImageFills tile(String tile) {
    this.tile = tile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SharedImageFills sharedImageFills = (SharedImageFills) o;
    return Objects.equals(this.compressionState, sharedImageFills.compressionState) &&
        Objects.equals(this.dpi, sharedImageFills.dpi) &&
        Objects.equals(this.effectsJson, sharedImageFills.effectsJson) &&
        Objects.equals(this.fillMapId, sharedImageFills.fillMapId) &&
        Objects.equals(this.id, sharedImageFills.id) &&
        Objects.equals(this.rotateWithShape, sharedImageFills.rotateWithShape) &&
        Objects.equals(this.sourceRectangle, sharedImageFills.sourceRectangle) &&
        Objects.equals(this.stretch, sharedImageFills.stretch) &&
        Objects.equals(this.tile, sharedImageFills.tile);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(compressionState, dpi, effectsJson, fillMapId, id, rotateWithShape, sourceRectangle, stretch, tile);
  }
  ...
  public String toString() {
    ...
    sb.append("class SharedImageFills {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SharedImageFills
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SharedImageFills.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SharedImageFills is not found in the empty JSON string", SharedImageFills.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SharedImageFills.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SharedImageFills` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SharedImageFills.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SharedImageFills' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SharedImageFills> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SharedImageFills.class));

       return (TypeAdapter<T>) new TypeAdapter<SharedImageFills>() {
           @Override
           public void write(JsonWriter out, SharedImageFills value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SharedImageFills read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SharedImageFills given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SharedImageFills
   * @throws IOException if the JSON string is invalid with respect to SharedImageFills
   */
  public static SharedImageFills fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SharedImageFills.class);
  }

  /**
   * Convert an instance of SharedImageFills to an JSON string
   *
   * @return JSON string
   */
