...
public class SlideShapeTrees {
  ...
  public SlideShapeTrees() {
  }

  public SlideShapeTrees baseElementBlobUrl(String baseElementBlobUrl) {
  ...
  public SlideShapeTrees changedBaseElementBlobUrl(String changedBaseElementBlobUrl) {
  ...
  public SlideShapeTrees groupElementId(UUID groupElementId) {
  ...
  public SlideShapeTrees hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  public SlideShapeTrees id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SlideShapeTrees name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SlideShapeTrees ooxmlId(Integer ooxmlId) {
  ...
  public SlideShapeTrees packageUri(String packageUri) {
  ...
  public SlideShapeTrees slideId(UUID slideId) {
  ...
  public SlideShapeTrees svgBlobUrl(String svgBlobUrl) {
  ...
  public SlideShapeTrees title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SlideShapeTrees slideShapeTrees = (SlideShapeTrees) o;
    return Objects.equals(this.baseElementBlobUrl, slideShapeTrees.baseElementBlobUrl) &&
        Objects.equals(this.changedBaseElementBlobUrl, slideShapeTrees.changedBaseElementBlobUrl) &&
        Objects.equals(this.groupElementId, slideShapeTrees.groupElementId) &&
        Objects.equals(this.hidden, slideShapeTrees.hidden) &&
        Objects.equals(this.id, slideShapeTrees.id) &&
        Objects.equals(this.name, slideShapeTrees.name) &&
        Objects.equals(this.ooxmlId, slideShapeTrees.ooxmlId) &&
        Objects.equals(this.packageUri, slideShapeTrees.packageUri) &&
        Objects.equals(this.slideId, slideShapeTrees.slideId) &&
        Objects.equals(this.svgBlobUrl, slideShapeTrees.svgBlobUrl) &&
        Objects.equals(this.title, slideShapeTrees.title);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseElementBlobUrl, changedBaseElementBlobUrl, groupElementId, hidden, id, name, ooxmlId, packageUri, slideId, svgBlobUrl, title);
  }
  ...
  public String toString() {
    ...
    sb.append("class SlideShapeTrees {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SlideShapeTrees
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SlideShapeTrees.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SlideShapeTrees is not found in the empty JSON string", SlideShapeTrees.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SlideShapeTrees.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SlideShapeTrees` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SlideShapeTrees.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SlideShapeTrees' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SlideShapeTrees> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SlideShapeTrees.class));

       return (TypeAdapter<T>) new TypeAdapter<SlideShapeTrees>() {
           @Override
           public void write(JsonWriter out, SlideShapeTrees value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SlideShapeTrees read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SlideShapeTrees given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SlideShapeTrees
   * @throws IOException if the JSON string is invalid with respect to SlideShapeTrees
   */
  public static SlideShapeTrees fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SlideShapeTrees.class);
  }

  /**
   * Convert an instance of SlideShapeTrees to an JSON string
   *
   * @return JSON string
   */
