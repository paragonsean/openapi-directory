...
public class SlideColorMaps {
  ...
  public SlideColorMaps() {
  }

  public SlideColorMaps accent1(Integer accent1) {
  ...
  public SlideColorMaps accent2(Integer accent2) {
  ...
  public SlideColorMaps accent3(Integer accent3) {
  ...
  public SlideColorMaps accent4(Integer accent4) {
  ...
  public SlideColorMaps accent5(Integer accent5) {
  ...
  public SlideColorMaps accent6(Integer accent6) {
  ...
  public SlideColorMaps background1(Integer background1) {
  ...
  public SlideColorMaps background2(Integer background2) {
  ...
  public SlideColorMaps followedHyperlink(Integer followedHyperlink) {
  ...
  public SlideColorMaps hyperlink(Integer hyperlink) {
  ...
  public SlideColorMaps id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SlideColorMaps slideMasterId(UUID slideMasterId) {
  ...
  public SlideColorMaps text1(Integer text1) {
    this.text1 = text1;
    return this;
  }
  ...
  public SlideColorMaps text2(Integer text2) {
    this.text2 = text2;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SlideColorMaps slideColorMaps = (SlideColorMaps) o;
    return Objects.equals(this.accent1, slideColorMaps.accent1) &&
        Objects.equals(this.accent2, slideColorMaps.accent2) &&
        Objects.equals(this.accent3, slideColorMaps.accent3) &&
        Objects.equals(this.accent4, slideColorMaps.accent4) &&
        Objects.equals(this.accent5, slideColorMaps.accent5) &&
        Objects.equals(this.accent6, slideColorMaps.accent6) &&
        Objects.equals(this.background1, slideColorMaps.background1) &&
        Objects.equals(this.background2, slideColorMaps.background2) &&
        Objects.equals(this.followedHyperlink, slideColorMaps.followedHyperlink) &&
        Objects.equals(this.hyperlink, slideColorMaps.hyperlink) &&
        Objects.equals(this.id, slideColorMaps.id) &&
        Objects.equals(this.slideMasterId, slideColorMaps.slideMasterId) &&
        Objects.equals(this.text1, slideColorMaps.text1) &&
        Objects.equals(this.text2, slideColorMaps.text2);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accent1, accent2, accent3, accent4, accent5, accent6, background1, background2, followedHyperlink, hyperlink, id, slideMasterId, text1, text2);
  }
  ...
  public String toString() {
    ...
    sb.append("class SlideColorMaps {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SlideColorMaps
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SlideColorMaps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SlideColorMaps is not found in the empty JSON string", SlideColorMaps.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SlideColorMaps.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SlideColorMaps` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SlideColorMaps.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SlideColorMaps' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SlideColorMaps> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SlideColorMaps.class));

       return (TypeAdapter<T>) new TypeAdapter<SlideColorMaps>() {
           @Override
           public void write(JsonWriter out, SlideColorMaps value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SlideColorMaps read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SlideColorMaps given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SlideColorMaps
   * @throws IOException if the JSON string is invalid with respect to SlideColorMaps
   */
  public static SlideColorMaps fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SlideColorMaps.class);
  }

  /**
   * Convert an instance of SlideColorMaps to an JSON string
   *
   * @return JSON string
   */
