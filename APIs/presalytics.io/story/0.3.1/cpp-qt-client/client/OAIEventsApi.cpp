...
void OAIEventsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("storyIdEventsGet", defaultConf);
    _serverIndices.insert("storyIdEventsGet", 0);
    _serverConfigs.insert("storyIdEventsPost", defaultConf);
    _serverIndices.insert("storyIdEventsPost", 0);
}
...
void OAIEventsApi::storyIdEventsGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["storyIdEventsGet"][_serverIndices.value("storyIdEventsGet")].URL()+"/{id}/events");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::storyIdEventsGetCallback);
...
void OAIEventsApi::storyIdEventsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT storyIdEventsGetSignal(output);
        Q_EMIT storyIdEventsGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT storyIdEventsGetSignalE(output, error_type, error_str);
        Q_EMIT storyIdEventsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT storyIdEventsGetSignalError(output, error_type, error_str);
        Q_EMIT storyIdEventsGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEventsApi::storyIdEventsPost(const QString &id, const OAIManage_event &oai_manage_event) {
    QString fullPath = QString(_serverConfigs["storyIdEventsPost"][_serverIndices.value("storyIdEventsPost")].URL()+"/{id}/events");
...

    {
        ...
        QByteArray output = oai_manage_event.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::storyIdEventsPostCallback);
    connect(this, &OAIEventsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEventsApi::storyIdEventsPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT storyIdEventsPostSignal(output);
        Q_EMIT storyIdEventsPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT storyIdEventsPostSignalE(output, error_type, error_str);
        Q_EMIT storyIdEventsPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT storyIdEventsPostSignalError(output, error_type, error_str);
        Q_EMIT storyIdEventsPostSignalErrorFull(worker, error_type, error_str);
    }
}
