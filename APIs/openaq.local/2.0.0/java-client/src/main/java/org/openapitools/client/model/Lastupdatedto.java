...
public class Lastupdatedto extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Lastupdatedto.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Lastupdatedto.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Lastupdatedto' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Lastupdatedto>() {
                @Override
                public void write(JsonWriter out, Lastupdatedto value) throws IOException {
                ...
                @Override
                public Lastupdatedto read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        Lastupdatedto ret = new Lastupdatedto();
                    ...
                    throw new IOException(String.format("Failed deserialization for Lastupdatedto: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Lastupdatedto
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Lastupdatedto with anyOf schemas: LocalDate, OffsetDateTime. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Lastupdatedto given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Lastupdatedto
     * @throws IOException if the JSON string is invalid with respect to Lastupdatedto
     */
    public static Lastupdatedto fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Lastupdatedto.class);
    }

    /**
     * Convert an instance of Lastupdatedto to an JSON string
     *
     * @return JSON string
     */
