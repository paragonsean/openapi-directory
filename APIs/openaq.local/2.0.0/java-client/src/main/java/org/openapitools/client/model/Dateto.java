...
public class Dateto extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Dateto.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Dateto.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Dateto' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Dateto>() {
                @Override
                public void write(JsonWriter out, Dateto value) throws IOException {
                ...
                @Override
                public Dateto read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Dateto: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Dateto
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Dateto with anyOf schemas: LocalDate, OffsetDateTime. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Dateto given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Dateto
     * @throws IOException if the JSON string is invalid with respect to Dateto
     */
    public static Dateto fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Dateto.class);
    }

    /**
     * Convert an instance of Dateto to an JSON string
     *
     * @return JSON string
     */
