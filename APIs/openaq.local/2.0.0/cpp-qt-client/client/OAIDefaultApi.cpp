...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("favicoFaviconIcoGet", defaultConf);
    _serverIndices.insert("favicoFaviconIcoGet", 0);
    _serverConfigs.insert("pongPingGet", defaultConf);
    _serverIndices.insert("pongPingGet", 0);
}
...
void OAIDefaultApi::favicoFaviconIcoGet() {
    QString fullPath = QString(_serverConfigs["favicoFaviconIcoGet"][_serverIndices.value("favicoFaviconIcoGet")].URL()+"/favicon.ico");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::favicoFaviconIcoGetCallback);
...
void OAIDefaultApi::favicoFaviconIcoGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT favicoFaviconIcoGetSignal(output);
        Q_EMIT favicoFaviconIcoGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT favicoFaviconIcoGetSignalE(output, error_type, error_str);
        Q_EMIT favicoFaviconIcoGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT favicoFaviconIcoGetSignalError(output, error_type, error_str);
        Q_EMIT favicoFaviconIcoGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::pongPingGet() {
    QString fullPath = QString(_serverConfigs["pongPingGet"][_serverIndices.value("pongPingGet")].URL()+"/ping");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::pongPingGetCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::pongPingGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT pongPingGetSignal(output);
        Q_EMIT pongPingGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT pongPingGetSignalE(output, error_type, error_str);
        Q_EMIT pongPingGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT pongPingGetSignalError(output, error_type, error_str);
        Q_EMIT pongPingGetSignalErrorFull(worker, error_type, error_str);
    }
}
