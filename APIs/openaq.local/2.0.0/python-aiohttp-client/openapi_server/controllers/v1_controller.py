...
async def cities_getv1_v1_cities_get(request: web.Request, limit=None, page=None, offset=None, sort=None, country_id=None, country=None, city=None, order_by=None, entity=None) -> web.Response:
...
async def countries_get_v1_countries_country_id_get(request: web.Request, country_id, limit=None, page=None, offset=None, sort=None, country=None, order_by=None) -> web.Response:
    """Countries Get
...
async def countries_getv1_v1_countries_get(request: web.Request, limit=None, page=None, offset=None, sort=None, country_id=None, country=None, order_by=None) -> web.Response:
    """Countries Getv1
...
async def latest_v1_get_v1_latest_location_id_get(request: web.Request, location_id, limit=None, page=None, offset=None, sort=None, has_geo=None, parameter_id=None, parameter=None, unit=None, coordinates=None, radius=None, country_id=None, country=None, city=None, location=None, order_by=None, is_mobile=None, is_analysis=None, source_name=None, entity=None, sensor_type=None, model_name=None, manufacturer_name=None, dump_raw=None) -> web.Response:
    """Latest V1 Get
...
async def locationsv1_get_v1_locations_get(request: web.Request, limit=None, page=None, offset=None, sort=None, has_geo=None, parameter_id=None, parameter=None, unit=None, coordinates=None, radius=None, country_id=None, country=None, city=None, location_id=None, location=None, order_by=None, is_mobile=None, is_analysis=None, source_name=None, entity=None, sensor_type=None, model_name=None, manufacturer_name=None, dump_raw=None) -> web.Response:
    """Locationsv1 Get
...
async def locationsv1_get_v1_locations_location_id_get(request: web.Request, location_id, limit=None, page=None, offset=None, sort=None, has_geo=None, parameter_id=None, parameter=None, unit=None, coordinates=None, radius=None, country_id=None, country=None, city=None, location=None, order_by=None, is_mobile=None, is_analysis=None, source_name=None, entity=None, sensor_type=None, model_name=None, manufacturer_name=None, dump_raw=None) -> web.Response:
    """Locationsv1 Get
...
async def parameters_getv1_v1_parameters_get(request: web.Request, limit=None, page=None, offset=None, sort=None, source_name=None, source_id=None, source_slug=None, order_by=None) -> web.Response:
    """Parameters Getv1
...
async def sources_v1_get_v1_sources_get(request: web.Request, limit=None, page=None, offset=None, sort=None, name=None, order_by=None) -> web.Response:
    """Sources V1 Get
