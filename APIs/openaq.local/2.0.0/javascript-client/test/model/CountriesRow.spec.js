...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAq.CountriesRow();
  });
  ...
  describe('CountriesRow', function() {
    it('should create an instance of CountriesRow', function() {
      // uncomment below and update the code to test CountriesRow
      //var instance = new OpenAq.CountriesRow();
      //expect(instance).to.be.a(OpenAq.CountriesRow);
    });
