...
public class ODataQueryOptionsCategoryTypeDto {
  ...
  public ODataQueryOptionsCategoryTypeDto() {
  }
  ...
  public ODataQueryOptionsCategoryTypeDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsCategoryTypeDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsCategoryTypeDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsCategoryTypeDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsCategoryTypeDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsCategoryTypeDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsCategoryTypeDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsCategoryTypeDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsCategoryTypeDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsCategoryTypeDto odataQueryOptionsCategoryTypeDto = (ODataQueryOptionsCategoryTypeDto) o;
    return Objects.equals(this.context, odataQueryOptionsCategoryTypeDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsCategoryTypeDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsCategoryTypeDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsCategoryTypeDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsCategoryTypeDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsCategoryTypeDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsCategoryTypeDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsCategoryTypeDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsCategoryTypeDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsCategoryTypeDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsCategoryTypeDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsCategoryTypeDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsCategoryTypeDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsCategoryTypeDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsCategoryTypeDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsCategoryTypeDto is not found in the empty JSON string", ODataQueryOptionsCategoryTypeDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsCategoryTypeDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsCategoryTypeDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsCategoryTypeDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsCategoryTypeDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsCategoryTypeDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsCategoryTypeDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsCategoryTypeDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsCategoryTypeDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsCategoryTypeDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsCategoryTypeDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsCategoryTypeDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsCategoryTypeDto
   */
  public static ODataQueryOptionsCategoryTypeDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsCategoryTypeDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsCategoryTypeDto to an JSON string
   *
   * @return JSON string
   */
