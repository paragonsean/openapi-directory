...
public class ODataQueryOptionsCashReceiptQueryDto {
  ...
  public ODataQueryOptionsCashReceiptQueryDto() {
  }
  ...
  public ODataQueryOptionsCashReceiptQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsCashReceiptQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsCashReceiptQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsCashReceiptQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsCashReceiptQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsCashReceiptQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsCashReceiptQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsCashReceiptQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsCashReceiptQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsCashReceiptQueryDto odataQueryOptionsCashReceiptQueryDto = (ODataQueryOptionsCashReceiptQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsCashReceiptQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsCashReceiptQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsCashReceiptQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsCashReceiptQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsCashReceiptQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsCashReceiptQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsCashReceiptQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsCashReceiptQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsCashReceiptQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsCashReceiptQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsCashReceiptQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsCashReceiptQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsCashReceiptQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsCashReceiptQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsCashReceiptQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsCashReceiptQueryDto is not found in the empty JSON string", ODataQueryOptionsCashReceiptQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsCashReceiptQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsCashReceiptQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsCashReceiptQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsCashReceiptQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsCashReceiptQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsCashReceiptQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsCashReceiptQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsCashReceiptQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsCashReceiptQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsCashReceiptQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsCashReceiptQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsCashReceiptQueryDto
   */
  public static ODataQueryOptionsCashReceiptQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsCashReceiptQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsCashReceiptQueryDto to an JSON string
   *
   * @return JSON string
   */
