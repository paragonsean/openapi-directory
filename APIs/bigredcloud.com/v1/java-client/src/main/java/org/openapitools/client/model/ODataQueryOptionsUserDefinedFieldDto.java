...
public class ODataQueryOptionsUserDefinedFieldDto {
  ...
  public ODataQueryOptionsUserDefinedFieldDto() {
  }
  ...
  public ODataQueryOptionsUserDefinedFieldDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsUserDefinedFieldDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsUserDefinedFieldDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsUserDefinedFieldDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsUserDefinedFieldDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsUserDefinedFieldDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsUserDefinedFieldDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsUserDefinedFieldDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsUserDefinedFieldDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsUserDefinedFieldDto odataQueryOptionsUserDefinedFieldDto = (ODataQueryOptionsUserDefinedFieldDto) o;
    return Objects.equals(this.context, odataQueryOptionsUserDefinedFieldDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsUserDefinedFieldDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsUserDefinedFieldDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsUserDefinedFieldDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsUserDefinedFieldDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsUserDefinedFieldDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsUserDefinedFieldDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsUserDefinedFieldDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsUserDefinedFieldDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsUserDefinedFieldDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsUserDefinedFieldDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsUserDefinedFieldDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsUserDefinedFieldDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsUserDefinedFieldDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsUserDefinedFieldDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsUserDefinedFieldDto is not found in the empty JSON string", ODataQueryOptionsUserDefinedFieldDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsUserDefinedFieldDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsUserDefinedFieldDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsUserDefinedFieldDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsUserDefinedFieldDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsUserDefinedFieldDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsUserDefinedFieldDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsUserDefinedFieldDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsUserDefinedFieldDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsUserDefinedFieldDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsUserDefinedFieldDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsUserDefinedFieldDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsUserDefinedFieldDto
   */
  public static ODataQueryOptionsUserDefinedFieldDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsUserDefinedFieldDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsUserDefinedFieldDto to an JSON string
   *
   * @return JSON string
   */
