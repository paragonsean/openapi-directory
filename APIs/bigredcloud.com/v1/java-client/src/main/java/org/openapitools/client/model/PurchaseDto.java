...
public class PurchaseDto {
  ...
  public static final String SERIALIZED_NAME_IS_DISCREPANCY_ACCEPTED = "isDiscrepancyAccepted";
  @SerializedName(SERIALIZED_NAME_IS_DISCREPANCY_ACCEPTED)
  private Boolean isDiscrepancyAccepted;
  ...
  public PurchaseDto acCode(String acCode) {
    this.acCode = acCode;
    return this;
  }
  ...
  public PurchaseDto acEntries(List<AcEntryDto> acEntries) {
    this.acEntries = acEntries;
    return this;
  }

  public PurchaseDto addAcEntriesItem(AcEntryDto acEntriesItem) {
  ...
  public PurchaseDto bookTranTypeId(Long bookTranTypeId) {
  ...
  public PurchaseDto customFields(List<AcudfValueDto> customFields) {
    this.customFields = customFields;
    return this;
  }

  public PurchaseDto addCustomFieldsItem(AcudfValueDto customFieldsItem) {
  ...
  public PurchaseDto detailCollection(List<String> detailCollection) {
    this.detailCollection = detailCollection;
    return this;
  }

  public PurchaseDto addDetailCollectionItem(String detailCollectionItem) {
  ...
  public PurchaseDto entryDate(OffsetDateTime entryDate) {
  ...
  public PurchaseDto isDiscrepancyAccepted(Boolean isDiscrepancyAccepted) {
    this.isDiscrepancyAccepted = isDiscrepancyAccepted;
    return this;
  }

  /**
   * Get isDiscrepancyAccepted
   * @return isDiscrepancyAccepted
   */
  @javax.annotation.Nullable
  public Boolean getIsDiscrepancyAccepted() {
    return isDiscrepancyAccepted;
  }

  public void setIsDiscrepancyAccepted(Boolean isDiscrepancyAccepted) {
    this.isDiscrepancyAccepted = isDiscrepancyAccepted;
  }


  public PurchaseDto netGoods(Double netGoods) {
  ...
  public PurchaseDto netServices(Double netServices) {
  ...
  public PurchaseDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  public PurchaseDto postponedAccounting(Boolean postponedAccounting) {
  ...
  public PurchaseDto procDate(OffsetDateTime procDate) {
  ...
  public PurchaseDto reference(String reference) {
  ...
  public PurchaseDto supplierId(Long supplierId) {
  ...
  public PurchaseDto timestamp(byte[] timestamp) {
  ...
  public PurchaseDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public PurchaseDto totalNet(Double totalNet) {
  ...
  public PurchaseDto totalVAT(Double totalVAT) {
  ...
  public PurchaseDto unallocated(Double unallocated) {
  ...
  public PurchaseDto unpaid(Double unpaid) {
    this.unpaid = unpaid;
    return this;
  }
  ...
  public PurchaseDto vatEntries(List<VatEntryDto> vatEntries) {
    this.vatEntries = vatEntries;
    return this;
  }

  public PurchaseDto addVatEntriesItem(VatEntryDto vatEntriesItem) {
  ...
  public PurchaseDto vatTypeId(Long vatTypeId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acCode, purchaseDto.acCode) &&
        Objects.equals(this.acEntries, purchaseDto.acEntries) &&
        Objects.equals(this.bookTranTypeId, purchaseDto.bookTranTypeId) &&
        Objects.equals(this.customFields, purchaseDto.customFields) &&
        Objects.equals(this.detailCollection, purchaseDto.detailCollection) &&
        Objects.equals(this.entryDate, purchaseDto.entryDate) &&
        Objects.equals(this.id, purchaseDto.id) &&
        Objects.equals(this.isDiscrepancyAccepted, purchaseDto.isDiscrepancyAccepted) &&
        Objects.equals(this.netGoods, purchaseDto.netGoods) &&
        Objects.equals(this.netServices, purchaseDto.netServices) &&
        Objects.equals(this.note, purchaseDto.note) &&
        Objects.equals(this.postponedAccounting, purchaseDto.postponedAccounting) &&
        Objects.equals(this.procDate, purchaseDto.procDate) &&
        Objects.equals(this.reference, purchaseDto.reference) &&
        Objects.equals(this.supplierId, purchaseDto.supplierId) &&
        Arrays.equals(this.timestamp, purchaseDto.timestamp) &&
        Objects.equals(this.total, purchaseDto.total) &&
        Objects.equals(this.totalNet, purchaseDto.totalNet) &&
        Objects.equals(this.totalVAT, purchaseDto.totalVAT) &&
        Objects.equals(this.unallocated, purchaseDto.unallocated) &&
        Objects.equals(this.unpaid, purchaseDto.unpaid) &&
        Objects.equals(this.vatEntries, purchaseDto.vatEntries) &&
        Objects.equals(this.vatTypeId, purchaseDto.vatTypeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acCode, acEntries, bookTranTypeId, customFields, detailCollection, entryDate, id, isDiscrepancyAccepted, netGoods, netServices, note, postponedAccounting, procDate, reference, supplierId, Arrays.hashCode(timestamp), total, totalNet, totalVAT, unallocated, unpaid, vatEntries, vatTypeId);
  }
  ...
  public String toString() {
    ...
    sb.append("    isDiscrepancyAccepted: ").append(toIndentedString(isDiscrepancyAccepted)).append("\n");
  ...
  static {
    ...
    openapiFields.add("isDiscrepancyAccepted");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PurchaseDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PurchaseDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PurchaseDto is not found in the empty JSON string", PurchaseDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PurchaseDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PurchaseDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PurchaseDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PurchaseDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PurchaseDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PurchaseDto.class));

       return (TypeAdapter<T>) new TypeAdapter<PurchaseDto>() {
           @Override
           public void write(JsonWriter out, PurchaseDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PurchaseDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PurchaseDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PurchaseDto
   * @throws IOException if the JSON string is invalid with respect to PurchaseDto
   */
  public static PurchaseDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PurchaseDto.class);
  }

  /**
   * Convert an instance of PurchaseDto to an JSON string
   *
   * @return JSON string
   */
