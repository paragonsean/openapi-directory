...
public class ODataQueryOptionsCustomerQueryDto {
  ...
  public ODataQueryOptionsCustomerQueryDto() {
  }
  ...
  public ODataQueryOptionsCustomerQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsCustomerQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsCustomerQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsCustomerQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsCustomerQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsCustomerQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsCustomerQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsCustomerQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsCustomerQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsCustomerQueryDto odataQueryOptionsCustomerQueryDto = (ODataQueryOptionsCustomerQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsCustomerQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsCustomerQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsCustomerQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsCustomerQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsCustomerQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsCustomerQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsCustomerQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsCustomerQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsCustomerQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsCustomerQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsCustomerQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsCustomerQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsCustomerQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsCustomerQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsCustomerQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsCustomerQueryDto is not found in the empty JSON string", ODataQueryOptionsCustomerQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsCustomerQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsCustomerQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsCustomerQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsCustomerQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsCustomerQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsCustomerQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsCustomerQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsCustomerQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsCustomerQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsCustomerQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsCustomerQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsCustomerQueryDto
   */
  public static ODataQueryOptionsCustomerQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsCustomerQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsCustomerQueryDto to an JSON string
   *
   * @return JSON string
   */
