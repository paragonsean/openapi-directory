...
public class ODataQueryOptionsSalesCreditNoteQueryDto {
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto() {
  }
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSalesCreditNoteQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsSalesCreditNoteQueryDto odataQueryOptionsSalesCreditNoteQueryDto = (ODataQueryOptionsSalesCreditNoteQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsSalesCreditNoteQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsSalesCreditNoteQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsSalesCreditNoteQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsSalesCreditNoteQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsSalesCreditNoteQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsSalesCreditNoteQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsSalesCreditNoteQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsSalesCreditNoteQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsSalesCreditNoteQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsSalesCreditNoteQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsSalesCreditNoteQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsSalesCreditNoteQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsSalesCreditNoteQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsSalesCreditNoteQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsSalesCreditNoteQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsSalesCreditNoteQueryDto is not found in the empty JSON string", ODataQueryOptionsSalesCreditNoteQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsSalesCreditNoteQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsSalesCreditNoteQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsSalesCreditNoteQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsSalesCreditNoteQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsSalesCreditNoteQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsSalesCreditNoteQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsSalesCreditNoteQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsSalesCreditNoteQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsSalesCreditNoteQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsSalesCreditNoteQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsSalesCreditNoteQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsSalesCreditNoteQueryDto
   */
  public static ODataQueryOptionsSalesCreditNoteQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsSalesCreditNoteQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsSalesCreditNoteQueryDto to an JSON string
   *
   * @return JSON string
   */
