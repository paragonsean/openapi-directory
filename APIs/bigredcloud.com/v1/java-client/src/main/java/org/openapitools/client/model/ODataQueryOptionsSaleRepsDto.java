...
public class ODataQueryOptionsSaleRepsDto {
  ...
  public ODataQueryOptionsSaleRepsDto() {
  }
  ...
  public ODataQueryOptionsSaleRepsDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsSaleRepsDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSaleRepsDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSaleRepsDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSaleRepsDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSaleRepsDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSaleRepsDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSaleRepsDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSaleRepsDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsSaleRepsDto odataQueryOptionsSaleRepsDto = (ODataQueryOptionsSaleRepsDto) o;
    return Objects.equals(this.context, odataQueryOptionsSaleRepsDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsSaleRepsDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsSaleRepsDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsSaleRepsDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsSaleRepsDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsSaleRepsDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsSaleRepsDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsSaleRepsDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsSaleRepsDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsSaleRepsDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsSaleRepsDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsSaleRepsDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsSaleRepsDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsSaleRepsDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsSaleRepsDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsSaleRepsDto is not found in the empty JSON string", ODataQueryOptionsSaleRepsDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsSaleRepsDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsSaleRepsDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsSaleRepsDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsSaleRepsDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsSaleRepsDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsSaleRepsDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsSaleRepsDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsSaleRepsDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsSaleRepsDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsSaleRepsDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsSaleRepsDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsSaleRepsDto
   */
  public static ODataQueryOptionsSaleRepsDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsSaleRepsDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsSaleRepsDto to an JSON string
   *
   * @return JSON string
   */
