...
public class SalesEntryQueryDto {
  ...
  public SalesEntryQueryDto acCode(String acCode) {
    this.acCode = acCode;
    return this;
  }
  ...
  public SalesEntryQueryDto acEntries(List<AcEntryDto> acEntries) {
    this.acEntries = acEntries;
    return this;
  }

  public SalesEntryQueryDto addAcEntriesItem(AcEntryDto acEntriesItem) {
  ...
  public SalesEntryQueryDto bookTranTypeId(Long bookTranTypeId) {
  ...
  public SalesEntryQueryDto customFields(List<AcudfValueDto> customFields) {
    this.customFields = customFields;
    return this;
  }

  public SalesEntryQueryDto addCustomFieldsItem(AcudfValueDto customFieldsItem) {
  ...
  public SalesEntryQueryDto customerId(Long customerId) {
  ...
  public SalesEntryQueryDto detailCollection(List<String> detailCollection) {
    this.detailCollection = detailCollection;
    return this;
  }

  public SalesEntryQueryDto addDetailCollectionItem(String detailCollectionItem) {
  ...
  public SalesEntryQueryDto details(String details) {
  ...
  public SalesEntryQueryDto entryDate(OffsetDateTime entryDate) {
  ...
  public SalesEntryQueryDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public SalesEntryQueryDto netGoods(Double netGoods) {
  ...
  public SalesEntryQueryDto netServices(Double netServices) {
  ...
  public SalesEntryQueryDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  public SalesEntryQueryDto procDate(OffsetDateTime procDate) {
  ...
  public SalesEntryQueryDto reference(String reference) {
  ...
  public SalesEntryQueryDto timestamp(byte[] timestamp) {
  ...
  public SalesEntryQueryDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public SalesEntryQueryDto totalNet(Double totalNet) {
  ...
  public SalesEntryQueryDto totalVAT(Double totalVAT) {
  ...
  public SalesEntryQueryDto unpaid(Double unpaid) {
    this.unpaid = unpaid;
    return this;
  }
  ...
  public SalesEntryQueryDto vatEntries(List<VatEntryDto> vatEntries) {
    this.vatEntries = vatEntries;
    return this;
  }

  public SalesEntryQueryDto addVatEntriesItem(VatEntryDto vatEntriesItem) {
  ...
  public SalesEntryQueryDto vatTypeId(Long vatTypeId) {
  ...
  public boolean equals(Object o) {
    ...
    SalesEntryQueryDto salesEntryQueryDto = (SalesEntryQueryDto) o;
    return Objects.equals(this.acCode, salesEntryQueryDto.acCode) &&
        Objects.equals(this.acEntries, salesEntryQueryDto.acEntries) &&
        Objects.equals(this.bookTranTypeId, salesEntryQueryDto.bookTranTypeId) &&
        Objects.equals(this.customFields, salesEntryQueryDto.customFields) &&
        Objects.equals(this.customerId, salesEntryQueryDto.customerId) &&
        Objects.equals(this.detailCollection, salesEntryQueryDto.detailCollection) &&
        Objects.equals(this.details, salesEntryQueryDto.details) &&
        Objects.equals(this.entryDate, salesEntryQueryDto.entryDate) &&
        Objects.equals(this.id, salesEntryQueryDto.id) &&
        Objects.equals(this.netGoods, salesEntryQueryDto.netGoods) &&
        Objects.equals(this.netServices, salesEntryQueryDto.netServices) &&
        Objects.equals(this.note, salesEntryQueryDto.note) &&
        Objects.equals(this.procDate, salesEntryQueryDto.procDate) &&
        Objects.equals(this.reference, salesEntryQueryDto.reference) &&
        Arrays.equals(this.timestamp, salesEntryQueryDto.timestamp) &&
        Objects.equals(this.total, salesEntryQueryDto.total) &&
        Objects.equals(this.totalNet, salesEntryQueryDto.totalNet) &&
        Objects.equals(this.totalVAT, salesEntryQueryDto.totalVAT) &&
        Objects.equals(this.unpaid, salesEntryQueryDto.unpaid) &&
        Objects.equals(this.vatEntries, salesEntryQueryDto.vatEntries) &&
        Objects.equals(this.vatTypeId, salesEntryQueryDto.vatTypeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acCode, acEntries, bookTranTypeId, customFields, customerId, detailCollection, details, entryDate, id, netGoods, netServices, note, procDate, reference, Arrays.hashCode(timestamp), total, totalNet, totalVAT, unpaid, vatEntries, vatTypeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SalesEntryQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SalesEntryQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SalesEntryQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SalesEntryQueryDto is not found in the empty JSON string", SalesEntryQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SalesEntryQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SalesEntryQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SalesEntryQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SalesEntryQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SalesEntryQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SalesEntryQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SalesEntryQueryDto>() {
           @Override
           public void write(JsonWriter out, SalesEntryQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SalesEntryQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SalesEntryQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SalesEntryQueryDto
   * @throws IOException if the JSON string is invalid with respect to SalesEntryQueryDto
   */
  public static SalesEntryQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SalesEntryQueryDto.class);
  }

  /**
   * Convert an instance of SalesEntryQueryDto to an JSON string
   *
   * @return JSON string
   */
