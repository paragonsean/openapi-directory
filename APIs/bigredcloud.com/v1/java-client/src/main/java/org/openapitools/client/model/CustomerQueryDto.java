...
public class CustomerQueryDto {
  ...
  public CustomerQueryDto accountName(String accountName) {
  ...
  public CustomerQueryDto accountNumber(String accountNumber) {
  ...
  public CustomerQueryDto additionalEmails(List<String> additionalEmails) {
    this.additionalEmails = additionalEmails;
    return this;
  }

  public CustomerQueryDto addAdditionalEmailsItem(String additionalEmailsItem) {
  ...
  public CustomerQueryDto address(List<String> address) {
    this.address = address;
    return this;
  }

  public CustomerQueryDto addAddressItem(String addressItem) {
  ...
  public CustomerQueryDto authCode(String authCode) {
  ...
  public CustomerQueryDto bank(EFTBankDto bank) {
    this.bank = bank;
    return this;
  }
  ...
  public CustomerQueryDto businessIdentifierCode(String businessIdentifierCode) {
  ...
  public CustomerQueryDto code(String code) {
    this.code = code;
    return this;
  }
  ...
  public CustomerQueryDto contact(String contact) {
  ...
  public CustomerQueryDto delivery(List<String> delivery) {
    this.delivery = delivery;
    return this;
  }

  public CustomerQueryDto addDeliveryItem(String deliveryItem) {
  ...
  public CustomerQueryDto eFTReference(String eFTReference) {
  ...
  public CustomerQueryDto email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CustomerQueryDto fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public CustomerQueryDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public CustomerQueryDto internationalBankAccountNumber(String internationalBankAccountNumber) {
  ...
  public CustomerQueryDto mobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public CustomerQueryDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomerQueryDto ourCode(String ourCode) {
  ...
  public CustomerQueryDto ownerTypeId(Long ownerTypeId) {
  ...
  public CustomerQueryDto phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public CustomerQueryDto timestamp(byte[] timestamp) {
  ...
  public CustomerQueryDto vatAnalysisTypeId(Long vatAnalysisTypeId) {
  ...
  public CustomerQueryDto vatReg(String vatReg) {
    this.vatReg = vatReg;
    return this;
  }
  ...
  public CustomerQueryDto vatType(Long vatType) {
  ...
  public boolean equals(Object o) {
    ...
    CustomerQueryDto customerQueryDto = (CustomerQueryDto) o;
    return Objects.equals(this.accountName, customerQueryDto.accountName) &&
        Objects.equals(this.accountNumber, customerQueryDto.accountNumber) &&
        Objects.equals(this.additionalEmails, customerQueryDto.additionalEmails) &&
        Objects.equals(this.address, customerQueryDto.address) &&
        Objects.equals(this.authCode, customerQueryDto.authCode) &&
        Objects.equals(this.bank, customerQueryDto.bank) &&
        Objects.equals(this.businessIdentifierCode, customerQueryDto.businessIdentifierCode) &&
        Objects.equals(this.code, customerQueryDto.code) &&
        Objects.equals(this.contact, customerQueryDto.contact) &&
        Objects.equals(this.delivery, customerQueryDto.delivery) &&
        Objects.equals(this.eFTReference, customerQueryDto.eFTReference) &&
        Objects.equals(this.email, customerQueryDto.email) &&
        Objects.equals(this.fax, customerQueryDto.fax) &&
        Objects.equals(this.id, customerQueryDto.id) &&
        Objects.equals(this.internationalBankAccountNumber, customerQueryDto.internationalBankAccountNumber) &&
        Objects.equals(this.mobile, customerQueryDto.mobile) &&
        Objects.equals(this.name, customerQueryDto.name) &&
        Objects.equals(this.ourCode, customerQueryDto.ourCode) &&
        Objects.equals(this.ownerTypeId, customerQueryDto.ownerTypeId) &&
        Objects.equals(this.phone, customerQueryDto.phone) &&
        Arrays.equals(this.timestamp, customerQueryDto.timestamp) &&
        Objects.equals(this.vatAnalysisTypeId, customerQueryDto.vatAnalysisTypeId) &&
        Objects.equals(this.vatReg, customerQueryDto.vatReg) &&
        Objects.equals(this.vatType, customerQueryDto.vatType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountName, accountNumber, additionalEmails, address, authCode, bank, businessIdentifierCode, code, contact, delivery, eFTReference, email, fax, id, internationalBankAccountNumber, mobile, name, ourCode, ownerTypeId, phone, Arrays.hashCode(timestamp), vatAnalysisTypeId, vatReg, vatType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomerQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomerQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomerQueryDto is not found in the empty JSON string", CustomerQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerQueryDto>() {
           @Override
           public void write(JsonWriter out, CustomerQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomerQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomerQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomerQueryDto
   * @throws IOException if the JSON string is invalid with respect to CustomerQueryDto
   */
  public static CustomerQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerQueryDto.class);
  }

  /**
   * Convert an instance of CustomerQueryDto to an JSON string
   *
   * @return JSON string
   */
