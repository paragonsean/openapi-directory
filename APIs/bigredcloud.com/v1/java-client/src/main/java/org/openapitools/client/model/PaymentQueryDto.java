...
public class PaymentQueryDto {
  ...
  public PaymentQueryDto acCode(String acCode) {
    this.acCode = acCode;
    return this;
  }
  ...
  public PaymentQueryDto acEntries(List<AcEntryDto> acEntries) {
    this.acEntries = acEntries;
    return this;
  }

  public PaymentQueryDto addAcEntriesItem(AcEntryDto acEntriesItem) {
  ...
  public PaymentQueryDto bankAccountCode(String bankAccountCode) {
  ...
  public PaymentQueryDto bankAccountId(Long bankAccountId) {
  ...
  public PaymentQueryDto bookTranTypeId(Long bookTranTypeId) {
  ...
  public PaymentQueryDto customFields(List<AcudfValueDto> customFields) {
    this.customFields = customFields;
    return this;
  }

  public PaymentQueryDto addCustomFieldsItem(AcudfValueDto customFieldsItem) {
  ...
  public PaymentQueryDto detailCollection(List<String> detailCollection) {
    this.detailCollection = detailCollection;
    return this;
  }

  public PaymentQueryDto addDetailCollectionItem(String detailCollectionItem) {
  ...
  public PaymentQueryDto discount(Double discount) {
  ...
  public PaymentQueryDto entryDate(OffsetDateTime entryDate) {
  ...
  public PaymentQueryDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public PaymentQueryDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  public PaymentQueryDto plaidTransactionId(String plaidTransactionId) {
  ...
  public PaymentQueryDto procDate(OffsetDateTime procDate) {
  ...
  public PaymentQueryDto reference(String reference) {
  ...
  public PaymentQueryDto supplierId(Long supplierId) {
  ...
  public PaymentQueryDto timestamp(byte[] timestamp) {
  ...
  public PaymentQueryDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public PaymentQueryDto transferBankCode(String transferBankCode) {
  ...
  public PaymentQueryDto transferBankId(Long transferBankId) {
  ...
  public PaymentQueryDto unallocated(Double unallocated) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentQueryDto paymentQueryDto = (PaymentQueryDto) o;
    return Objects.equals(this.acCode, paymentQueryDto.acCode) &&
        Objects.equals(this.acEntries, paymentQueryDto.acEntries) &&
        Objects.equals(this.bankAccountCode, paymentQueryDto.bankAccountCode) &&
        Objects.equals(this.bankAccountId, paymentQueryDto.bankAccountId) &&
        Objects.equals(this.bookTranTypeId, paymentQueryDto.bookTranTypeId) &&
        Objects.equals(this.customFields, paymentQueryDto.customFields) &&
        Objects.equals(this.detailCollection, paymentQueryDto.detailCollection) &&
        Objects.equals(this.discount, paymentQueryDto.discount) &&
        Objects.equals(this.entryDate, paymentQueryDto.entryDate) &&
        Objects.equals(this.id, paymentQueryDto.id) &&
        Objects.equals(this.note, paymentQueryDto.note) &&
        Objects.equals(this.plaidTransactionId, paymentQueryDto.plaidTransactionId) &&
        Objects.equals(this.procDate, paymentQueryDto.procDate) &&
        Objects.equals(this.reference, paymentQueryDto.reference) &&
        Objects.equals(this.supplierId, paymentQueryDto.supplierId) &&
        Arrays.equals(this.timestamp, paymentQueryDto.timestamp) &&
        Objects.equals(this.total, paymentQueryDto.total) &&
        Objects.equals(this.transferBankCode, paymentQueryDto.transferBankCode) &&
        Objects.equals(this.transferBankId, paymentQueryDto.transferBankId) &&
        Objects.equals(this.unallocated, paymentQueryDto.unallocated);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentQueryDto is not found in the empty JSON string", PaymentQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentQueryDto>() {
           @Override
           public void write(JsonWriter out, PaymentQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentQueryDto
   * @throws IOException if the JSON string is invalid with respect to PaymentQueryDto
   */
  public static PaymentQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentQueryDto.class);
  }

  /**
   * Convert an instance of PaymentQueryDto to an JSON string
   *
   * @return JSON string
   */
