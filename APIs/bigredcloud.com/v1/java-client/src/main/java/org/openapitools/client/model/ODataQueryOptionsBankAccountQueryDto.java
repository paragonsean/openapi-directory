...
public class ODataQueryOptionsBankAccountQueryDto {
  ...
  public ODataQueryOptionsBankAccountQueryDto() {
  }
  ...
  public ODataQueryOptionsBankAccountQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsBankAccountQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsBankAccountQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsBankAccountQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsBankAccountQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsBankAccountQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsBankAccountQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsBankAccountQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsBankAccountQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsBankAccountQueryDto odataQueryOptionsBankAccountQueryDto = (ODataQueryOptionsBankAccountQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsBankAccountQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsBankAccountQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsBankAccountQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsBankAccountQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsBankAccountQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsBankAccountQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsBankAccountQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsBankAccountQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsBankAccountQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsBankAccountQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsBankAccountQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsBankAccountQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsBankAccountQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsBankAccountQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsBankAccountQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsBankAccountQueryDto is not found in the empty JSON string", ODataQueryOptionsBankAccountQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsBankAccountQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsBankAccountQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsBankAccountQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsBankAccountQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsBankAccountQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsBankAccountQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsBankAccountQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsBankAccountQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsBankAccountQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsBankAccountQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsBankAccountQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsBankAccountQueryDto
   */
  public static ODataQueryOptionsBankAccountQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsBankAccountQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsBankAccountQueryDto to an JSON string
   *
   * @return JSON string
   */
