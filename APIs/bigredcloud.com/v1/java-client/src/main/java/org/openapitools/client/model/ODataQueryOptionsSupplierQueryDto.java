...
public class ODataQueryOptionsSupplierQueryDto {
  ...
  public ODataQueryOptionsSupplierQueryDto() {
  }
  ...
  public ODataQueryOptionsSupplierQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsSupplierQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSupplierQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSupplierQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSupplierQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSupplierQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSupplierQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSupplierQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSupplierQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsSupplierQueryDto odataQueryOptionsSupplierQueryDto = (ODataQueryOptionsSupplierQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsSupplierQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsSupplierQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsSupplierQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsSupplierQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsSupplierQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsSupplierQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsSupplierQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsSupplierQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsSupplierQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsSupplierQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsSupplierQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsSupplierQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsSupplierQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsSupplierQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsSupplierQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsSupplierQueryDto is not found in the empty JSON string", ODataQueryOptionsSupplierQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsSupplierQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsSupplierQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsSupplierQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsSupplierQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsSupplierQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsSupplierQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsSupplierQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsSupplierQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsSupplierQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsSupplierQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsSupplierQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsSupplierQueryDto
   */
  public static ODataQueryOptionsSupplierQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsSupplierQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsSupplierQueryDto to an JSON string
   *
   * @return JSON string
   */
