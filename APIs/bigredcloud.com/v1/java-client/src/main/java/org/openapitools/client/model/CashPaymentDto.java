...
public class CashPaymentDto {
  ...
  public CashPaymentDto acCode(String acCode) {
    this.acCode = acCode;
    return this;
  }
  ...
  public CashPaymentDto acEntries(List<AcEntryDto> acEntries) {
    this.acEntries = acEntries;
    return this;
  }

  public CashPaymentDto addAcEntriesItem(AcEntryDto acEntriesItem) {
  ...
  public CashPaymentDto bankAccountCode(String bankAccountCode) {
  ...
  public CashPaymentDto bankAccountId(Long bankAccountId) {
  ...
  public CashPaymentDto bookTranTypeId(Long bookTranTypeId) {
  ...
  public CashPaymentDto customFields(List<AcudfValueDto> customFields) {
    this.customFields = customFields;
    return this;
  }

  public CashPaymentDto addCustomFieldsItem(AcudfValueDto customFieldsItem) {
  ...
  public CashPaymentDto detailCollection(List<String> detailCollection) {
    this.detailCollection = detailCollection;
    return this;
  }

  public CashPaymentDto addDetailCollectionItem(String detailCollectionItem) {
  ...
  public CashPaymentDto discount(Double discount) {
  ...
  public CashPaymentDto entryDate(OffsetDateTime entryDate) {
  ...
  public CashPaymentDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public CashPaymentDto ledger(Double ledger) {
    this.ledger = ledger;
    return this;
  }
  ...
  public CashPaymentDto lodgement(Double lodgement) {
  ...
  public CashPaymentDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  public CashPaymentDto plaidTransactionId(String plaidTransactionId) {
  ...
  public CashPaymentDto procDate(OffsetDateTime procDate) {
  ...
  public CashPaymentDto supplierId(Long supplierId) {
  ...
  public CashPaymentDto timestamp(byte[] timestamp) {
  ...
  public CashPaymentDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CashPaymentDto cashPaymentDto = (CashPaymentDto) o;
    return Objects.equals(this.acCode, cashPaymentDto.acCode) &&
        Objects.equals(this.acEntries, cashPaymentDto.acEntries) &&
        Objects.equals(this.bankAccountCode, cashPaymentDto.bankAccountCode) &&
        Objects.equals(this.bankAccountId, cashPaymentDto.bankAccountId) &&
        Objects.equals(this.bookTranTypeId, cashPaymentDto.bookTranTypeId) &&
        Objects.equals(this.customFields, cashPaymentDto.customFields) &&
        Objects.equals(this.detailCollection, cashPaymentDto.detailCollection) &&
        Objects.equals(this.discount, cashPaymentDto.discount) &&
        Objects.equals(this.entryDate, cashPaymentDto.entryDate) &&
        Objects.equals(this.id, cashPaymentDto.id) &&
        Objects.equals(this.ledger, cashPaymentDto.ledger) &&
        Objects.equals(this.lodgement, cashPaymentDto.lodgement) &&
        Objects.equals(this.note, cashPaymentDto.note) &&
        Objects.equals(this.plaidTransactionId, cashPaymentDto.plaidTransactionId) &&
        Objects.equals(this.procDate, cashPaymentDto.procDate) &&
        Objects.equals(this.supplierId, cashPaymentDto.supplierId) &&
        Arrays.equals(this.timestamp, cashPaymentDto.timestamp) &&
        Objects.equals(this.total, cashPaymentDto.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acCode, acEntries, bankAccountCode, bankAccountId, bookTranTypeId, customFields, detailCollection, discount, entryDate, id, ledger, lodgement, note, plaidTransactionId, procDate, supplierId, Arrays.hashCode(timestamp), total);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CashPaymentDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CashPaymentDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CashPaymentDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashPaymentDto is not found in the empty JSON string", CashPaymentDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CashPaymentDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CashPaymentDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CashPaymentDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CashPaymentDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CashPaymentDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CashPaymentDto.class));

       return (TypeAdapter<T>) new TypeAdapter<CashPaymentDto>() {
           @Override
           public void write(JsonWriter out, CashPaymentDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CashPaymentDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CashPaymentDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CashPaymentDto
   * @throws IOException if the JSON string is invalid with respect to CashPaymentDto
   */
  public static CashPaymentDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CashPaymentDto.class);
  }

  /**
   * Convert an instance of CashPaymentDto to an JSON string
   *
   * @return JSON string
   */
