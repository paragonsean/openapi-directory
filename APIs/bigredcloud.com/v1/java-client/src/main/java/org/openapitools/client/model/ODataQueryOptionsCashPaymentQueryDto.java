...
public class ODataQueryOptionsCashPaymentQueryDto {
  ...
  public ODataQueryOptionsCashPaymentQueryDto() {
  }
  ...
  public ODataQueryOptionsCashPaymentQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsCashPaymentQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsCashPaymentQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsCashPaymentQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsCashPaymentQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsCashPaymentQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsCashPaymentQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsCashPaymentQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsCashPaymentQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsCashPaymentQueryDto odataQueryOptionsCashPaymentQueryDto = (ODataQueryOptionsCashPaymentQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsCashPaymentQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsCashPaymentQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsCashPaymentQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsCashPaymentQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsCashPaymentQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsCashPaymentQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsCashPaymentQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsCashPaymentQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsCashPaymentQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsCashPaymentQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsCashPaymentQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsCashPaymentQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsCashPaymentQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsCashPaymentQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsCashPaymentQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsCashPaymentQueryDto is not found in the empty JSON string", ODataQueryOptionsCashPaymentQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsCashPaymentQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsCashPaymentQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsCashPaymentQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsCashPaymentQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsCashPaymentQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsCashPaymentQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsCashPaymentQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsCashPaymentQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsCashPaymentQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsCashPaymentQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsCashPaymentQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsCashPaymentQueryDto
   */
  public static ODataQueryOptionsCashPaymentQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsCashPaymentQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsCashPaymentQueryDto to an JSON string
   *
   * @return JSON string
   */
