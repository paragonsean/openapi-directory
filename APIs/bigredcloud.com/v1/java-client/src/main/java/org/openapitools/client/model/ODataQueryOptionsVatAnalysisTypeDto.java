...
public class ODataQueryOptionsVatAnalysisTypeDto {
  ...
  public ODataQueryOptionsVatAnalysisTypeDto() {
  }
  ...
  public ODataQueryOptionsVatAnalysisTypeDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsVatAnalysisTypeDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsVatAnalysisTypeDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsVatAnalysisTypeDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsVatAnalysisTypeDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsVatAnalysisTypeDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsVatAnalysisTypeDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsVatAnalysisTypeDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsVatAnalysisTypeDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsVatAnalysisTypeDto odataQueryOptionsVatAnalysisTypeDto = (ODataQueryOptionsVatAnalysisTypeDto) o;
    return Objects.equals(this.context, odataQueryOptionsVatAnalysisTypeDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsVatAnalysisTypeDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsVatAnalysisTypeDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsVatAnalysisTypeDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsVatAnalysisTypeDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsVatAnalysisTypeDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsVatAnalysisTypeDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsVatAnalysisTypeDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsVatAnalysisTypeDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsVatAnalysisTypeDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsVatAnalysisTypeDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsVatAnalysisTypeDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsVatAnalysisTypeDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsVatAnalysisTypeDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsVatAnalysisTypeDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsVatAnalysisTypeDto is not found in the empty JSON string", ODataQueryOptionsVatAnalysisTypeDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsVatAnalysisTypeDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsVatAnalysisTypeDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsVatAnalysisTypeDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsVatAnalysisTypeDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsVatAnalysisTypeDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsVatAnalysisTypeDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsVatAnalysisTypeDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsVatAnalysisTypeDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsVatAnalysisTypeDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsVatAnalysisTypeDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsVatAnalysisTypeDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsVatAnalysisTypeDto
   */
  public static ODataQueryOptionsVatAnalysisTypeDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsVatAnalysisTypeDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsVatAnalysisTypeDto to an JSON string
   *
   * @return JSON string
   */
