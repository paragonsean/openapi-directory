...
public class CompanyOptionViewModel {
  ...
  public CompanyOptionViewModel allowEntryOfGrossPriceInInvoicing(Boolean allowEntryOfGrossPriceInInvoicing) {
  ...
  public CompanyOptionViewModel creditInputForReverseChargeVAT(Boolean creditInputForReverseChargeVAT) {
  ...
  public CompanyOptionViewModel creditNoteJournalAgeingName(String creditNoteJournalAgeingName) {
  ...
  public CompanyOptionViewModel creditNoteJournalAgeingValue(Integer creditNoteJournalAgeingValue) {
  ...
  public CompanyOptionViewModel discrepancyAllowed(Double discrepancyAllowed) {
  ...
  public CompanyOptionViewModel enableVOCRReporting(Boolean enableVOCRReporting) {
  ...
  public CompanyOptionViewModel marginVatScheme(Boolean marginVatScheme) {
  ...
  public CompanyOptionViewModel printOSItemsOnly(Boolean printOSItemsOnly) {
  ...
  public CompanyOptionViewModel purchasesVatAnalysisType(Long purchasesVatAnalysisType) {
  ...
  public CompanyOptionViewModel salesVatAnalysisType(Long salesVatAnalysisType) {
  ...
  public CompanyOptionViewModel useAllocations(Boolean useAllocations) {
  ...
  public CompanyOptionViewModel useNominal(Boolean useNominal) {
  ...
  public CompanyOptionViewModel useNominalCode(Boolean useNominalCode) {
  ...
  public CompanyOptionViewModel vocrSettingValue(Boolean vocrSettingValue) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyOptionViewModel companyOptionViewModel = (CompanyOptionViewModel) o;
    return Objects.equals(this.allowEntryOfGrossPriceInInvoicing, companyOptionViewModel.allowEntryOfGrossPriceInInvoicing) &&
        Objects.equals(this.creditInputForReverseChargeVAT, companyOptionViewModel.creditInputForReverseChargeVAT) &&
        Objects.equals(this.creditNoteJournalAgeingName, companyOptionViewModel.creditNoteJournalAgeingName) &&
        Objects.equals(this.creditNoteJournalAgeingValue, companyOptionViewModel.creditNoteJournalAgeingValue) &&
        Objects.equals(this.discrepancyAllowed, companyOptionViewModel.discrepancyAllowed) &&
        Objects.equals(this.enableVOCRReporting, companyOptionViewModel.enableVOCRReporting) &&
        Objects.equals(this.marginVatScheme, companyOptionViewModel.marginVatScheme) &&
        Objects.equals(this.printOSItemsOnly, companyOptionViewModel.printOSItemsOnly) &&
        Objects.equals(this.purchasesVatAnalysisType, companyOptionViewModel.purchasesVatAnalysisType) &&
        Objects.equals(this.salesVatAnalysisType, companyOptionViewModel.salesVatAnalysisType) &&
        Objects.equals(this.useAllocations, companyOptionViewModel.useAllocations) &&
        Objects.equals(this.useNominal, companyOptionViewModel.useNominal) &&
        Objects.equals(this.useNominalCode, companyOptionViewModel.useNominalCode) &&
        Objects.equals(this.vocrSettingValue, companyOptionViewModel.vocrSettingValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyOptionViewModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompanyOptionViewModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanyOptionViewModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyOptionViewModel is not found in the empty JSON string", CompanyOptionViewModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyOptionViewModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanyOptionViewModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyOptionViewModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyOptionViewModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyOptionViewModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyOptionViewModel.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyOptionViewModel>() {
           @Override
           public void write(JsonWriter out, CompanyOptionViewModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompanyOptionViewModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompanyOptionViewModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompanyOptionViewModel
   * @throws IOException if the JSON string is invalid with respect to CompanyOptionViewModel
   */
  public static CompanyOptionViewModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyOptionViewModel.class);
  }

  /**
   * Convert an instance of CompanyOptionViewModel to an JSON string
   *
   * @return JSON string
   */
