...
public class ODataQueryOptionsVatRateDto {
  ...
  public ODataQueryOptionsVatRateDto() {
  }
  ...
  public ODataQueryOptionsVatRateDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsVatRateDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsVatRateDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsVatRateDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsVatRateDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsVatRateDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsVatRateDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsVatRateDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsVatRateDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsVatRateDto odataQueryOptionsVatRateDto = (ODataQueryOptionsVatRateDto) o;
    return Objects.equals(this.context, odataQueryOptionsVatRateDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsVatRateDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsVatRateDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsVatRateDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsVatRateDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsVatRateDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsVatRateDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsVatRateDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsVatRateDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsVatRateDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsVatRateDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsVatRateDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsVatRateDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsVatRateDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsVatRateDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsVatRateDto is not found in the empty JSON string", ODataQueryOptionsVatRateDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsVatRateDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsVatRateDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsVatRateDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsVatRateDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsVatRateDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsVatRateDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsVatRateDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsVatRateDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsVatRateDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsVatRateDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsVatRateDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsVatRateDto
   */
  public static ODataQueryOptionsVatRateDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsVatRateDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsVatRateDto to an JSON string
   *
   * @return JSON string
   */
