...
public class ODataQueryOptionsBookTranTypeDto {
  ...
  public ODataQueryOptionsBookTranTypeDto() {
  }
  ...
  public ODataQueryOptionsBookTranTypeDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsBookTranTypeDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsBookTranTypeDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsBookTranTypeDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsBookTranTypeDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsBookTranTypeDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsBookTranTypeDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsBookTranTypeDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsBookTranTypeDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsBookTranTypeDto odataQueryOptionsBookTranTypeDto = (ODataQueryOptionsBookTranTypeDto) o;
    return Objects.equals(this.context, odataQueryOptionsBookTranTypeDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsBookTranTypeDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsBookTranTypeDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsBookTranTypeDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsBookTranTypeDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsBookTranTypeDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsBookTranTypeDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsBookTranTypeDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsBookTranTypeDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsBookTranTypeDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsBookTranTypeDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsBookTranTypeDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsBookTranTypeDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsBookTranTypeDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsBookTranTypeDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsBookTranTypeDto is not found in the empty JSON string", ODataQueryOptionsBookTranTypeDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsBookTranTypeDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsBookTranTypeDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsBookTranTypeDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsBookTranTypeDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsBookTranTypeDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsBookTranTypeDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsBookTranTypeDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsBookTranTypeDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsBookTranTypeDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsBookTranTypeDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsBookTranTypeDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsBookTranTypeDto
   */
  public static ODataQueryOptionsBookTranTypeDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsBookTranTypeDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsBookTranTypeDto to an JSON string
   *
   * @return JSON string
   */
