...
public class ODataQueryOptionsAccountDto {
  ...
  public ODataQueryOptionsAccountDto() {
  }
  ...
  public ODataQueryOptionsAccountDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsAccountDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsAccountDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsAccountDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsAccountDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsAccountDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsAccountDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsAccountDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsAccountDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsAccountDto odataQueryOptionsAccountDto = (ODataQueryOptionsAccountDto) o;
    return Objects.equals(this.context, odataQueryOptionsAccountDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsAccountDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsAccountDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsAccountDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsAccountDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsAccountDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsAccountDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsAccountDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsAccountDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsAccountDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsAccountDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsAccountDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsAccountDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsAccountDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsAccountDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsAccountDto is not found in the empty JSON string", ODataQueryOptionsAccountDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsAccountDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsAccountDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsAccountDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsAccountDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsAccountDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsAccountDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsAccountDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsAccountDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsAccountDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsAccountDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsAccountDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsAccountDto
   */
  public static ODataQueryOptionsAccountDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsAccountDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsAccountDto to an JSON string
   *
   * @return JSON string
   */
