...
public class ODataQueryOptionsOwnerTypeDto {
  ...
  public ODataQueryOptionsOwnerTypeDto() {
  }
  ...
  public ODataQueryOptionsOwnerTypeDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsOwnerTypeDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsOwnerTypeDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsOwnerTypeDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsOwnerTypeDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsOwnerTypeDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsOwnerTypeDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsOwnerTypeDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsOwnerTypeDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsOwnerTypeDto odataQueryOptionsOwnerTypeDto = (ODataQueryOptionsOwnerTypeDto) o;
    return Objects.equals(this.context, odataQueryOptionsOwnerTypeDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsOwnerTypeDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsOwnerTypeDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsOwnerTypeDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsOwnerTypeDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsOwnerTypeDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsOwnerTypeDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsOwnerTypeDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsOwnerTypeDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsOwnerTypeDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsOwnerTypeDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsOwnerTypeDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsOwnerTypeDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsOwnerTypeDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsOwnerTypeDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsOwnerTypeDto is not found in the empty JSON string", ODataQueryOptionsOwnerTypeDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsOwnerTypeDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsOwnerTypeDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsOwnerTypeDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsOwnerTypeDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsOwnerTypeDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsOwnerTypeDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsOwnerTypeDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsOwnerTypeDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsOwnerTypeDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsOwnerTypeDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsOwnerTypeDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsOwnerTypeDto
   */
  public static ODataQueryOptionsOwnerTypeDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsOwnerTypeDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsOwnerTypeDto to an JSON string
   *
   * @return JSON string
   */
