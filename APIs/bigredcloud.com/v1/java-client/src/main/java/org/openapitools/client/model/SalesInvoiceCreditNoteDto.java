...
import org.openapitools.client.model.ProductTranDto;
...
public class SalesInvoiceCreditNoteDto {
  ...
  private List<ProductTranDto> productTrans = new ArrayList<>();
  ...
  public SalesInvoiceCreditNoteDto acCode(String acCode) {
    this.acCode = acCode;
    return this;
  }
  ...
  public SalesInvoiceCreditNoteDto bookTranTypeId(Long bookTranTypeId) {
  ...
  public SalesInvoiceCreditNoteDto customFields(List<AcudfValueDto> customFields) {
    this.customFields = customFields;
    return this;
  }

  public SalesInvoiceCreditNoteDto addCustomFieldsItem(AcudfValueDto customFieldsItem) {
  ...
  public SalesInvoiceCreditNoteDto customerId(Long customerId) {
  ...
  public SalesInvoiceCreditNoteDto deliveryTo(List<String> deliveryTo) {
    this.deliveryTo = deliveryTo;
    return this;
  }

  public SalesInvoiceCreditNoteDto addDeliveryToItem(String deliveryToItem) {
  ...
  public SalesInvoiceCreditNoteDto details(String details) {
  ...
  public SalesInvoiceCreditNoteDto entryDate(OffsetDateTime entryDate) {
  ...
  public SalesInvoiceCreditNoteDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public SalesInvoiceCreditNoteDto loType(String loType) {
    this.loType = loType;
    return this;
  }
  ...
  public SalesInvoiceCreditNoteDto netGoods(Double netGoods) {
  ...
  public SalesInvoiceCreditNoteDto netServices(Double netServices) {
  ...
  public SalesInvoiceCreditNoteDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  public SalesInvoiceCreditNoteDto ourReference(String ourReference) {
  ...
  public SalesInvoiceCreditNoteDto procDate(OffsetDateTime procDate) {
  ...
  public SalesInvoiceCreditNoteDto productTrans(List<ProductTranDto> productTrans) {
    this.productTrans = productTrans;
    return this;
  }

  public SalesInvoiceCreditNoteDto addProductTransItem(ProductTranDto productTransItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProductTranDto> getProductTrans() {
    return productTrans;
  }

  public void setProductTrans(List<ProductTranDto> productTrans) {
    this.productTrans = productTrans;
  }


  public SalesInvoiceCreditNoteDto quoteId(Long quoteId) {
  ...
  public SalesInvoiceCreditNoteDto reference(String reference) {
  ...
  public SalesInvoiceCreditNoteDto saleRepCode(String saleRepCode) {
  ...
  public SalesInvoiceCreditNoteDto saleRepId(Long saleRepId) {
  ...
  public SalesInvoiceCreditNoteDto timestamp(byte[] timestamp) {
  ...
  public SalesInvoiceCreditNoteDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public SalesInvoiceCreditNoteDto totalNet(Double totalNet) {
  ...
  public SalesInvoiceCreditNoteDto totalVAT(Double totalVAT) {
  ...
  public SalesInvoiceCreditNoteDto unpaid(Double unpaid) {
    this.unpaid = unpaid;
    return this;
  }
  ...
  public SalesInvoiceCreditNoteDto vatTypeId(Long vatTypeId) {
  ...
  public SalesInvoiceCreditNoteDto yourReference(String yourReference) {
  ...
  public boolean equals(Object o) {
    ...
    SalesInvoiceCreditNoteDto salesInvoiceCreditNoteDto = (SalesInvoiceCreditNoteDto) o;
    return Objects.equals(this.acCode, salesInvoiceCreditNoteDto.acCode) &&
        Objects.equals(this.bookTranTypeId, salesInvoiceCreditNoteDto.bookTranTypeId) &&
        Objects.equals(this.customFields, salesInvoiceCreditNoteDto.customFields) &&
        Objects.equals(this.customerId, salesInvoiceCreditNoteDto.customerId) &&
        Objects.equals(this.deliveryTo, salesInvoiceCreditNoteDto.deliveryTo) &&
        Objects.equals(this.details, salesInvoiceCreditNoteDto.details) &&
        Objects.equals(this.entryDate, salesInvoiceCreditNoteDto.entryDate) &&
        Objects.equals(this.id, salesInvoiceCreditNoteDto.id) &&
        Objects.equals(this.loType, salesInvoiceCreditNoteDto.loType) &&
        Objects.equals(this.netGoods, salesInvoiceCreditNoteDto.netGoods) &&
        Objects.equals(this.netServices, salesInvoiceCreditNoteDto.netServices) &&
        Objects.equals(this.note, salesInvoiceCreditNoteDto.note) &&
        Objects.equals(this.ourReference, salesInvoiceCreditNoteDto.ourReference) &&
        Objects.equals(this.procDate, salesInvoiceCreditNoteDto.procDate) &&
        Objects.equals(this.productTrans, salesInvoiceCreditNoteDto.productTrans) &&
        Objects.equals(this.quoteId, salesInvoiceCreditNoteDto.quoteId) &&
        Objects.equals(this.reference, salesInvoiceCreditNoteDto.reference) &&
        Objects.equals(this.saleRepCode, salesInvoiceCreditNoteDto.saleRepCode) &&
        Objects.equals(this.saleRepId, salesInvoiceCreditNoteDto.saleRepId) &&
        Arrays.equals(this.timestamp, salesInvoiceCreditNoteDto.timestamp) &&
        Objects.equals(this.total, salesInvoiceCreditNoteDto.total) &&
        Objects.equals(this.totalNet, salesInvoiceCreditNoteDto.totalNet) &&
        Objects.equals(this.totalVAT, salesInvoiceCreditNoteDto.totalVAT) &&
        Objects.equals(this.unpaid, salesInvoiceCreditNoteDto.unpaid) &&
        Objects.equals(this.vatTypeId, salesInvoiceCreditNoteDto.vatTypeId) &&
        Objects.equals(this.yourReference, salesInvoiceCreditNoteDto.yourReference);
  }
  ...
  public String toString() {
    ...
    sb.append("class SalesInvoiceCreditNoteDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SalesInvoiceCreditNoteDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SalesInvoiceCreditNoteDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SalesInvoiceCreditNoteDto is not found in the empty JSON string", SalesInvoiceCreditNoteDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SalesInvoiceCreditNoteDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SalesInvoiceCreditNoteDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("productTrans") != null && !jsonObj.get("productTrans").isJsonNull()) {
        ...
        if (jsonArrayproductTrans != null) {
          ...
          for (int i = 0; i < jsonArrayproductTrans.size(); i++) {
            ProductTranDto.validateJsonElement(jsonArrayproductTrans.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SalesInvoiceCreditNoteDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SalesInvoiceCreditNoteDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SalesInvoiceCreditNoteDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SalesInvoiceCreditNoteDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SalesInvoiceCreditNoteDto>() {
           @Override
           public void write(JsonWriter out, SalesInvoiceCreditNoteDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SalesInvoiceCreditNoteDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SalesInvoiceCreditNoteDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SalesInvoiceCreditNoteDto
   * @throws IOException if the JSON string is invalid with respect to SalesInvoiceCreditNoteDto
   */
  public static SalesInvoiceCreditNoteDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SalesInvoiceCreditNoteDto.class);
  }

  /**
   * Convert an instance of SalesInvoiceCreditNoteDto to an JSON string
   *
   * @return JSON string
   */
