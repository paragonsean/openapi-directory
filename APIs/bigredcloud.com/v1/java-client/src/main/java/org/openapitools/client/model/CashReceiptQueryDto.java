...
public class CashReceiptQueryDto {
  ...
  public CashReceiptQueryDto acCode(String acCode) {
    this.acCode = acCode;
    return this;
  }
  ...
  public CashReceiptQueryDto acEntries(List<AcEntryDto> acEntries) {
    this.acEntries = acEntries;
    return this;
  }

  public CashReceiptQueryDto addAcEntriesItem(AcEntryDto acEntriesItem) {
  ...
  public CashReceiptQueryDto bookTranTypeId(Long bookTranTypeId) {
  ...
  public CashReceiptQueryDto customFields(List<AcudfValueDto> customFields) {
    this.customFields = customFields;
    return this;
  }

  public CashReceiptQueryDto addCustomFieldsItem(AcudfValueDto customFieldsItem) {
  ...
  public CashReceiptQueryDto customerId(Long customerId) {
  ...
  public CashReceiptQueryDto detailCollection(List<String> detailCollection) {
    this.detailCollection = detailCollection;
    return this;
  }

  public CashReceiptQueryDto addDetailCollectionItem(String detailCollectionItem) {
  ...
  public CashReceiptQueryDto discount(Double discount) {
  ...
  public CashReceiptQueryDto entryDate(OffsetDateTime entryDate) {
  ...
  public CashReceiptQueryDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public CashReceiptQueryDto ledger(Double ledger) {
    this.ledger = ledger;
    return this;
  }
  ...
  public CashReceiptQueryDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  public CashReceiptQueryDto plaidTransactionId(String plaidTransactionId) {
  ...
  public CashReceiptQueryDto procDate(OffsetDateTime procDate) {
  ...
  public CashReceiptQueryDto timestamp(byte[] timestamp) {
  ...
  public CashReceiptQueryDto total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public CashReceiptQueryDto unallocated(Double unallocated) {
  ...
  public CashReceiptQueryDto vatEntries(List<VatEntryDto> vatEntries) {
    this.vatEntries = vatEntries;
    return this;
  }

  public CashReceiptQueryDto addVatEntriesItem(VatEntryDto vatEntriesItem) {
  ...
  public CashReceiptQueryDto vatTypeId(Long vatTypeId) {
  ...
  public boolean equals(Object o) {
    ...
    CashReceiptQueryDto cashReceiptQueryDto = (CashReceiptQueryDto) o;
    return Objects.equals(this.acCode, cashReceiptQueryDto.acCode) &&
        Objects.equals(this.acEntries, cashReceiptQueryDto.acEntries) &&
        Objects.equals(this.bookTranTypeId, cashReceiptQueryDto.bookTranTypeId) &&
        Objects.equals(this.customFields, cashReceiptQueryDto.customFields) &&
        Objects.equals(this.customerId, cashReceiptQueryDto.customerId) &&
        Objects.equals(this.detailCollection, cashReceiptQueryDto.detailCollection) &&
        Objects.equals(this.discount, cashReceiptQueryDto.discount) &&
        Objects.equals(this.entryDate, cashReceiptQueryDto.entryDate) &&
        Objects.equals(this.id, cashReceiptQueryDto.id) &&
        Objects.equals(this.ledger, cashReceiptQueryDto.ledger) &&
        Objects.equals(this.note, cashReceiptQueryDto.note) &&
        Objects.equals(this.plaidTransactionId, cashReceiptQueryDto.plaidTransactionId) &&
        Objects.equals(this.procDate, cashReceiptQueryDto.procDate) &&
        Arrays.equals(this.timestamp, cashReceiptQueryDto.timestamp) &&
        Objects.equals(this.total, cashReceiptQueryDto.total) &&
        Objects.equals(this.unallocated, cashReceiptQueryDto.unallocated) &&
        Objects.equals(this.vatEntries, cashReceiptQueryDto.vatEntries) &&
        Objects.equals(this.vatTypeId, cashReceiptQueryDto.vatTypeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CashReceiptQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CashReceiptQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CashReceiptQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashReceiptQueryDto is not found in the empty JSON string", CashReceiptQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CashReceiptQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CashReceiptQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CashReceiptQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CashReceiptQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CashReceiptQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CashReceiptQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<CashReceiptQueryDto>() {
           @Override
           public void write(JsonWriter out, CashReceiptQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CashReceiptQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CashReceiptQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CashReceiptQueryDto
   * @throws IOException if the JSON string is invalid with respect to CashReceiptQueryDto
   */
  public static CashReceiptQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CashReceiptQueryDto.class);
  }

  /**
   * Convert an instance of CashReceiptQueryDto to an JSON string
   *
   * @return JSON string
   */
