...
public class ODataQueryOptionsSalesEntryQueryDto {
  ...
  public ODataQueryOptionsSalesEntryQueryDto() {
  }
  ...
  public ODataQueryOptionsSalesEntryQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsSalesEntryQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSalesEntryQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSalesEntryQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSalesEntryQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSalesEntryQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSalesEntryQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSalesEntryQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSalesEntryQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsSalesEntryQueryDto odataQueryOptionsSalesEntryQueryDto = (ODataQueryOptionsSalesEntryQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsSalesEntryQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsSalesEntryQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsSalesEntryQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsSalesEntryQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsSalesEntryQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsSalesEntryQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsSalesEntryQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsSalesEntryQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsSalesEntryQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsSalesEntryQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsSalesEntryQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsSalesEntryQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsSalesEntryQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsSalesEntryQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsSalesEntryQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsSalesEntryQueryDto is not found in the empty JSON string", ODataQueryOptionsSalesEntryQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsSalesEntryQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsSalesEntryQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsSalesEntryQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsSalesEntryQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsSalesEntryQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsSalesEntryQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsSalesEntryQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsSalesEntryQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsSalesEntryQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsSalesEntryQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsSalesEntryQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsSalesEntryQueryDto
   */
  public static ODataQueryOptionsSalesEntryQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsSalesEntryQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsSalesEntryQueryDto to an JSON string
   *
   * @return JSON string
   */
