...
public class ODataQueryOptionsQuoteDto {
  ...
  public ODataQueryOptionsQuoteDto() {
  }
  ...
  public ODataQueryOptionsQuoteDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsQuoteDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsQuoteDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsQuoteDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsQuoteDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsQuoteDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsQuoteDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsQuoteDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsQuoteDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsQuoteDto odataQueryOptionsQuoteDto = (ODataQueryOptionsQuoteDto) o;
    return Objects.equals(this.context, odataQueryOptionsQuoteDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsQuoteDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsQuoteDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsQuoteDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsQuoteDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsQuoteDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsQuoteDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsQuoteDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsQuoteDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsQuoteDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsQuoteDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsQuoteDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsQuoteDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsQuoteDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsQuoteDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsQuoteDto is not found in the empty JSON string", ODataQueryOptionsQuoteDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsQuoteDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsQuoteDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsQuoteDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsQuoteDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsQuoteDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsQuoteDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsQuoteDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsQuoteDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsQuoteDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsQuoteDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsQuoteDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsQuoteDto
   */
  public static ODataQueryOptionsQuoteDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsQuoteDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsQuoteDto to an JSON string
   *
   * @return JSON string
   */
