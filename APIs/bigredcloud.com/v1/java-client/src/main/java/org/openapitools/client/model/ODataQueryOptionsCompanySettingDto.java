...
public class ODataQueryOptionsCompanySettingDto {
  ...
  public ODataQueryOptionsCompanySettingDto() {
  }
  ...
  public ODataQueryOptionsCompanySettingDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsCompanySettingDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsCompanySettingDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsCompanySettingDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsCompanySettingDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsCompanySettingDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsCompanySettingDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsCompanySettingDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsCompanySettingDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsCompanySettingDto odataQueryOptionsCompanySettingDto = (ODataQueryOptionsCompanySettingDto) o;
    return Objects.equals(this.context, odataQueryOptionsCompanySettingDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsCompanySettingDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsCompanySettingDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsCompanySettingDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsCompanySettingDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsCompanySettingDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsCompanySettingDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsCompanySettingDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsCompanySettingDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsCompanySettingDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsCompanySettingDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsCompanySettingDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsCompanySettingDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsCompanySettingDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsCompanySettingDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsCompanySettingDto is not found in the empty JSON string", ODataQueryOptionsCompanySettingDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsCompanySettingDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsCompanySettingDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsCompanySettingDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsCompanySettingDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsCompanySettingDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsCompanySettingDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsCompanySettingDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsCompanySettingDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsCompanySettingDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsCompanySettingDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsCompanySettingDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsCompanySettingDto
   */
  public static ODataQueryOptionsCompanySettingDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsCompanySettingDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsCompanySettingDto to an JSON string
   *
   * @return JSON string
   */
