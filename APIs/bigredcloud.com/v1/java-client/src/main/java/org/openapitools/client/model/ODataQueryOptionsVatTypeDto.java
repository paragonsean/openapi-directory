...
public class ODataQueryOptionsVatTypeDto {
  ...
  public ODataQueryOptionsVatTypeDto() {
  }
  ...
  public ODataQueryOptionsVatTypeDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsVatTypeDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsVatTypeDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsVatTypeDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsVatTypeDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsVatTypeDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsVatTypeDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsVatTypeDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsVatTypeDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsVatTypeDto odataQueryOptionsVatTypeDto = (ODataQueryOptionsVatTypeDto) o;
    return Objects.equals(this.context, odataQueryOptionsVatTypeDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsVatTypeDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsVatTypeDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsVatTypeDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsVatTypeDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsVatTypeDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsVatTypeDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsVatTypeDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsVatTypeDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsVatTypeDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsVatTypeDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsVatTypeDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsVatTypeDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsVatTypeDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsVatTypeDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsVatTypeDto is not found in the empty JSON string", ODataQueryOptionsVatTypeDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsVatTypeDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsVatTypeDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsVatTypeDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsVatTypeDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsVatTypeDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsVatTypeDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsVatTypeDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsVatTypeDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsVatTypeDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsVatTypeDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsVatTypeDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsVatTypeDto
   */
  public static ODataQueryOptionsVatTypeDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsVatTypeDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsVatTypeDto to an JSON string
   *
   * @return JSON string
   */
