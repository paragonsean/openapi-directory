...
public class ODataQueryOptionsPurchaseQueryDto {
  ...
  public ODataQueryOptionsPurchaseQueryDto() {
  }
  ...
  public ODataQueryOptionsPurchaseQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsPurchaseQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsPurchaseQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsPurchaseQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsPurchaseQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsPurchaseQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsPurchaseQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsPurchaseQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsPurchaseQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsPurchaseQueryDto odataQueryOptionsPurchaseQueryDto = (ODataQueryOptionsPurchaseQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsPurchaseQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsPurchaseQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsPurchaseQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsPurchaseQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsPurchaseQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsPurchaseQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsPurchaseQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsPurchaseQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsPurchaseQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsPurchaseQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsPurchaseQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsPurchaseQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsPurchaseQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsPurchaseQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsPurchaseQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsPurchaseQueryDto is not found in the empty JSON string", ODataQueryOptionsPurchaseQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsPurchaseQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsPurchaseQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsPurchaseQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsPurchaseQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsPurchaseQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsPurchaseQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsPurchaseQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsPurchaseQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsPurchaseQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsPurchaseQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsPurchaseQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsPurchaseQueryDto
   */
  public static ODataQueryOptionsPurchaseQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsPurchaseQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsPurchaseQueryDto to an JSON string
   *
   * @return JSON string
   */
