...
public class SupplierDto {
  ...
  public SupplierDto accountName(String accountName) {
  ...
  public SupplierDto accountNumber(String accountNumber) {
  ...
  public SupplierDto additionalEmails(List<String> additionalEmails) {
    this.additionalEmails = additionalEmails;
    return this;
  }

  public SupplierDto addAdditionalEmailsItem(String additionalEmailsItem) {
  ...
  public SupplierDto address(List<String> address) {
    this.address = address;
    return this;
  }

  public SupplierDto addAddressItem(String addressItem) {
  ...
  public SupplierDto authCode(String authCode) {
  ...
  public SupplierDto bank(EFTBankDto bank) {
    this.bank = bank;
    return this;
  }
  ...
  public SupplierDto businessIdentifierCode(String businessIdentifierCode) {
  ...
  public SupplierDto code(String code) {
    this.code = code;
    return this;
  }
  ...
  public SupplierDto contact(String contact) {
  ...
  public SupplierDto eFTReference(String eFTReference) {
  ...
  public SupplierDto email(String email) {
    this.email = email;
    return this;
  }
  ...
  public SupplierDto fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public SupplierDto internationalBankAccountNumber(String internationalBankAccountNumber) {
  ...
  public SupplierDto ledgerBalance(Double ledgerBalance) {
  ...
  public SupplierDto mobile(String mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public SupplierDto openingBalance(OwnerOpeningBalanceInPeriodsDto openingBalance) {
  ...
  public SupplierDto openingBalances(List<OwnerOpeningBalanceDto> openingBalances) {
    this.openingBalances = openingBalances;
    return this;
  }

  public SupplierDto addOpeningBalancesItem(OwnerOpeningBalanceDto openingBalancesItem) {
  ...
  public SupplierDto ourCode(String ourCode) {
  ...
  public SupplierDto ownerTypeId(Long ownerTypeId) {
  ...
  public SupplierDto phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public SupplierDto postponedAccounting(Boolean postponedAccounting) {
  ...
  public SupplierDto timestamp(byte[] timestamp) {
  ...
  public SupplierDto vatAnalysisTypeId(Long vatAnalysisTypeId) {
  ...
  public SupplierDto vatReg(String vatReg) {
    this.vatReg = vatReg;
    return this;
  }
  ...
  public SupplierDto vatType(Long vatType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountName, supplierDto.accountName) &&
        Objects.equals(this.accountNumber, supplierDto.accountNumber) &&
        Objects.equals(this.additionalEmails, supplierDto.additionalEmails) &&
        Objects.equals(this.address, supplierDto.address) &&
        Objects.equals(this.authCode, supplierDto.authCode) &&
        Objects.equals(this.bank, supplierDto.bank) &&
        Objects.equals(this.businessIdentifierCode, supplierDto.businessIdentifierCode) &&
        Objects.equals(this.code, supplierDto.code) &&
        Objects.equals(this.contact, supplierDto.contact) &&
        Objects.equals(this.eFTReference, supplierDto.eFTReference) &&
        Objects.equals(this.email, supplierDto.email) &&
        Objects.equals(this.fax, supplierDto.fax) &&
        Objects.equals(this.id, supplierDto.id) &&
        Objects.equals(this.internationalBankAccountNumber, supplierDto.internationalBankAccountNumber) &&
        Objects.equals(this.ledgerBalance, supplierDto.ledgerBalance) &&
        Objects.equals(this.mobile, supplierDto.mobile) &&
        Objects.equals(this.name, supplierDto.name) &&
        Objects.equals(this.openingBalance, supplierDto.openingBalance) &&
        Objects.equals(this.openingBalances, supplierDto.openingBalances) &&
        Objects.equals(this.ourCode, supplierDto.ourCode) &&
        Objects.equals(this.ownerTypeId, supplierDto.ownerTypeId) &&
        Objects.equals(this.phone, supplierDto.phone) &&
        Objects.equals(this.postponedAccounting, supplierDto.postponedAccounting) &&
        Arrays.equals(this.timestamp, supplierDto.timestamp) &&
        Objects.equals(this.vatAnalysisTypeId, supplierDto.vatAnalysisTypeId) &&
        Objects.equals(this.vatReg, supplierDto.vatReg) &&
        Objects.equals(this.vatType, supplierDto.vatType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountName, accountNumber, additionalEmails, address, authCode, bank, businessIdentifierCode, code, contact, eFTReference, email, fax, id, internationalBankAccountNumber, ledgerBalance, mobile, name, openingBalance, openingBalances, ourCode, ownerTypeId, phone, postponedAccounting, Arrays.hashCode(timestamp), vatAnalysisTypeId, vatReg, vatType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupplierDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplierDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplierDto is not found in the empty JSON string", SupplierDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplierDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupplierDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplierDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplierDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplierDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplierDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplierDto>() {
           @Override
  ...
  /**
   * Create an instance of SupplierDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupplierDto
   * @throws IOException if the JSON string is invalid with respect to SupplierDto
   */
  public static SupplierDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplierDto.class);
  }

  /**
   * Convert an instance of SupplierDto to an JSON string
   *
   * @return JSON string
   */
