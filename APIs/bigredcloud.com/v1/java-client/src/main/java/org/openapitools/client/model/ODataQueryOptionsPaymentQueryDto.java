...
public class ODataQueryOptionsPaymentQueryDto {
  ...
  public ODataQueryOptionsPaymentQueryDto() {
  }
  ...
  public ODataQueryOptionsPaymentQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsPaymentQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsPaymentQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsPaymentQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsPaymentQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsPaymentQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsPaymentQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsPaymentQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsPaymentQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsPaymentQueryDto odataQueryOptionsPaymentQueryDto = (ODataQueryOptionsPaymentQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsPaymentQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsPaymentQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsPaymentQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsPaymentQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsPaymentQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsPaymentQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsPaymentQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsPaymentQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsPaymentQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsPaymentQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsPaymentQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsPaymentQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsPaymentQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsPaymentQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsPaymentQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsPaymentQueryDto is not found in the empty JSON string", ODataQueryOptionsPaymentQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsPaymentQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsPaymentQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsPaymentQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsPaymentQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsPaymentQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsPaymentQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsPaymentQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsPaymentQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsPaymentQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsPaymentQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsPaymentQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsPaymentQueryDto
   */
  public static ODataQueryOptionsPaymentQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsPaymentQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsPaymentQueryDto to an JSON string
   *
   * @return JSON string
   */
