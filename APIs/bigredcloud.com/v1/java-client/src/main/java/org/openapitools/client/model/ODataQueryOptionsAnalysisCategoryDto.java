...
public class ODataQueryOptionsAnalysisCategoryDto {
  ...
  public ODataQueryOptionsAnalysisCategoryDto() {
  }
  ...
  public ODataQueryOptionsAnalysisCategoryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsAnalysisCategoryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsAnalysisCategoryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsAnalysisCategoryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsAnalysisCategoryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsAnalysisCategoryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsAnalysisCategoryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsAnalysisCategoryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsAnalysisCategoryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsAnalysisCategoryDto odataQueryOptionsAnalysisCategoryDto = (ODataQueryOptionsAnalysisCategoryDto) o;
    return Objects.equals(this.context, odataQueryOptionsAnalysisCategoryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsAnalysisCategoryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsAnalysisCategoryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsAnalysisCategoryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsAnalysisCategoryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsAnalysisCategoryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsAnalysisCategoryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsAnalysisCategoryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsAnalysisCategoryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsAnalysisCategoryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsAnalysisCategoryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsAnalysisCategoryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsAnalysisCategoryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsAnalysisCategoryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsAnalysisCategoryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsAnalysisCategoryDto is not found in the empty JSON string", ODataQueryOptionsAnalysisCategoryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsAnalysisCategoryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsAnalysisCategoryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsAnalysisCategoryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsAnalysisCategoryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsAnalysisCategoryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsAnalysisCategoryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsAnalysisCategoryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsAnalysisCategoryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsAnalysisCategoryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsAnalysisCategoryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsAnalysisCategoryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsAnalysisCategoryDto
   */
  public static ODataQueryOptionsAnalysisCategoryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsAnalysisCategoryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsAnalysisCategoryDto to an JSON string
   *
   * @return JSON string
   */
