...
public class ODataQueryOptionsSalesInvoiceQueryDto {
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto() {
  }
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSalesInvoiceQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsSalesInvoiceQueryDto odataQueryOptionsSalesInvoiceQueryDto = (ODataQueryOptionsSalesInvoiceQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsSalesInvoiceQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsSalesInvoiceQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsSalesInvoiceQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsSalesInvoiceQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsSalesInvoiceQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsSalesInvoiceQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsSalesInvoiceQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsSalesInvoiceQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsSalesInvoiceQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsSalesInvoiceQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsSalesInvoiceQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsSalesInvoiceQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsSalesInvoiceQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsSalesInvoiceQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsSalesInvoiceQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsSalesInvoiceQueryDto is not found in the empty JSON string", ODataQueryOptionsSalesInvoiceQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsSalesInvoiceQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsSalesInvoiceQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsSalesInvoiceQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsSalesInvoiceQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsSalesInvoiceQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsSalesInvoiceQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsSalesInvoiceQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsSalesInvoiceQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsSalesInvoiceQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsSalesInvoiceQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsSalesInvoiceQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsSalesInvoiceQueryDto
   */
  public static ODataQueryOptionsSalesInvoiceQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsSalesInvoiceQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsSalesInvoiceQueryDto to an JSON string
   *
   * @return JSON string
   */
