...
public class ODataQueryOptionsProductDto {
  ...
  public ODataQueryOptionsProductDto() {
  }
  ...
  public ODataQueryOptionsProductDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsProductDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsProductDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsProductDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsProductDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsProductDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsProductDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsProductDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsProductDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsProductDto odataQueryOptionsProductDto = (ODataQueryOptionsProductDto) o;
    return Objects.equals(this.context, odataQueryOptionsProductDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsProductDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsProductDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsProductDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsProductDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsProductDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsProductDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsProductDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsProductDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsProductDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsProductDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsProductDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsProductDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsProductDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsProductDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsProductDto is not found in the empty JSON string", ODataQueryOptionsProductDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsProductDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsProductDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsProductDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsProductDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsProductDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsProductDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsProductDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsProductDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsProductDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsProductDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsProductDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsProductDto
   */
  public static ODataQueryOptionsProductDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsProductDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsProductDto to an JSON string
   *
   * @return JSON string
   */
