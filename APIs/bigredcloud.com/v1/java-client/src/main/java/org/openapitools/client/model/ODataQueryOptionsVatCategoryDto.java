...
public class ODataQueryOptionsVatCategoryDto {
  ...
  public ODataQueryOptionsVatCategoryDto() {
  }
  ...
  public ODataQueryOptionsVatCategoryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsVatCategoryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsVatCategoryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsVatCategoryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsVatCategoryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsVatCategoryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsVatCategoryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsVatCategoryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsVatCategoryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsVatCategoryDto odataQueryOptionsVatCategoryDto = (ODataQueryOptionsVatCategoryDto) o;
    return Objects.equals(this.context, odataQueryOptionsVatCategoryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsVatCategoryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsVatCategoryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsVatCategoryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsVatCategoryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsVatCategoryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsVatCategoryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsVatCategoryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsVatCategoryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsVatCategoryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsVatCategoryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsVatCategoryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsVatCategoryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsVatCategoryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsVatCategoryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsVatCategoryDto is not found in the empty JSON string", ODataQueryOptionsVatCategoryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsVatCategoryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsVatCategoryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsVatCategoryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsVatCategoryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsVatCategoryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsVatCategoryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsVatCategoryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsVatCategoryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsVatCategoryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsVatCategoryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsVatCategoryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsVatCategoryDto
   */
  public static ODataQueryOptionsVatCategoryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsVatCategoryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsVatCategoryDto to an JSON string
   *
   * @return JSON string
   */
