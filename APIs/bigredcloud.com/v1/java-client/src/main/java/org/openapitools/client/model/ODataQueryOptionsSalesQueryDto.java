...
public class ODataQueryOptionsSalesQueryDto {
  ...
  public ODataQueryOptionsSalesQueryDto() {
  }
  ...
  public ODataQueryOptionsSalesQueryDto context(ODataQueryContext context) {
  ...
  public ODataQueryOptionsSalesQueryDto filter(FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSalesQueryDto inlineCount(InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSalesQueryDto orderBy(OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSalesQueryDto rawValues(ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSalesQueryDto selectExpand(SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSalesQueryDto skip(SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSalesQueryDto top(TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSalesQueryDto validator(Object validator) {
  ...
  public boolean equals(Object o) {
    ...
    ODataQueryOptionsSalesQueryDto odataQueryOptionsSalesQueryDto = (ODataQueryOptionsSalesQueryDto) o;
    return Objects.equals(this.context, odataQueryOptionsSalesQueryDto.context) &&
        Objects.equals(this.filter, odataQueryOptionsSalesQueryDto.filter) &&
        Objects.equals(this.ifMatch, odataQueryOptionsSalesQueryDto.ifMatch) &&
        Objects.equals(this.ifNoneMatch, odataQueryOptionsSalesQueryDto.ifNoneMatch) &&
        Objects.equals(this.inlineCount, odataQueryOptionsSalesQueryDto.inlineCount) &&
        Objects.equals(this.orderBy, odataQueryOptionsSalesQueryDto.orderBy) &&
        Objects.equals(this.rawValues, odataQueryOptionsSalesQueryDto.rawValues) &&
        Objects.equals(this.request, odataQueryOptionsSalesQueryDto.request) &&
        Objects.equals(this.selectExpand, odataQueryOptionsSalesQueryDto.selectExpand) &&
        Objects.equals(this.skip, odataQueryOptionsSalesQueryDto.skip) &&
        Objects.equals(this.top, odataQueryOptionsSalesQueryDto.top) &&
        Objects.equals(this.validator, odataQueryOptionsSalesQueryDto.validator);
  }
  ...
  public String toString() {
    ...
    sb.append("class ODataQueryOptionsSalesQueryDto {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ODataQueryOptionsSalesQueryDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ODataQueryOptionsSalesQueryDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ODataQueryOptionsSalesQueryDto is not found in the empty JSON string", ODataQueryOptionsSalesQueryDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ODataQueryOptionsSalesQueryDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ODataQueryOptionsSalesQueryDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ODataQueryOptionsSalesQueryDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ODataQueryOptionsSalesQueryDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ODataQueryOptionsSalesQueryDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ODataQueryOptionsSalesQueryDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ODataQueryOptionsSalesQueryDto>() {
           @Override
           public void write(JsonWriter out, ODataQueryOptionsSalesQueryDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ODataQueryOptionsSalesQueryDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ODataQueryOptionsSalesQueryDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ODataQueryOptionsSalesQueryDto
   * @throws IOException if the JSON string is invalid with respect to ODataQueryOptionsSalesQueryDto
   */
  public static ODataQueryOptionsSalesQueryDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ODataQueryOptionsSalesQueryDto.class);
  }

  /**
   * Convert an instance of ODataQueryOptionsSalesQueryDto to an JSON string
   *
   * @return JSON string
   */
