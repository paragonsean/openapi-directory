...
/**
 * The PaymentQueryDto model module.
 * @module model/PaymentQueryDto
 * @version v1
 */
class PaymentQueryDto {
    /**
     * Constructs a new <code>PaymentQueryDto</code>.
     * @alias module:model/PaymentQueryDto
     */
    constructor() { 
        
        PaymentQueryDto.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentQueryDto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentQueryDto} obj Optional instance to populate.
     * @return {module:model/PaymentQueryDto} The populated <code>PaymentQueryDto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentQueryDto();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentQueryDto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentQueryDto</code>.
     */
 ...
 */
PaymentQueryDto.prototype['acCode'] = undefined;

/**
 * @member {Array.<module:model/AcEntryDto>} acEntries
 */
PaymentQueryDto.prototype['acEntries'] = undefined;

/**
 * @member {String} bankAccountCode
 */
PaymentQueryDto.prototype['bankAccountCode'] = undefined;

/**
 * @member {Number} bankAccountId
 */
PaymentQueryDto.prototype['bankAccountId'] = undefined;

/**
 * @member {Number} bookTranTypeId
 */
PaymentQueryDto.prototype['bookTranTypeId'] = undefined;

/**
 * @member {Array.<module:model/AcudfValueDto>} customFields
 */
PaymentQueryDto.prototype['customFields'] = undefined;

/**
 * @member {Array.<String>} detailCollection
 */
PaymentQueryDto.prototype['detailCollection'] = undefined;

/**
 * @member {Number} discount
 */
PaymentQueryDto.prototype['discount'] = undefined;

/**
 * @member {Date} entryDate
 */
PaymentQueryDto.prototype['entryDate'] = undefined;

/**
 * @member {Number} id
 */
PaymentQueryDto.prototype['id'] = undefined;

/**
 * @member {String} note
 */
PaymentQueryDto.prototype['note'] = undefined;

/**
 * @member {String} plaidTransactionId
 */
PaymentQueryDto.prototype['plaidTransactionId'] = undefined;

/**
 * @member {Date} procDate
 */
PaymentQueryDto.prototype['procDate'] = undefined;

/**
 * @member {String} reference
 */
PaymentQueryDto.prototype['reference'] = undefined;

/**
 * @member {Number} supplierId
 */
PaymentQueryDto.prototype['supplierId'] = undefined;

/**
 * @member {Blob} timestamp
 */
PaymentQueryDto.prototype['timestamp'] = undefined;

/**
 * @member {Number} total
 */
PaymentQueryDto.prototype['total'] = undefined;

/**
 * @member {String} transferBankCode
 */
PaymentQueryDto.prototype['transferBankCode'] = undefined;

/**
 * @member {Number} transferBankId
 */
PaymentQueryDto.prototype['transferBankId'] = undefined;

/**
 * @member {Number} unallocated
 */
PaymentQueryDto.prototype['unallocated'] = undefined;
...
export default PaymentQueryDto;
