...
/**
 * The SalesEntryDto model module.
 * @module model/SalesEntryDto
 * @version v1
 */
class SalesEntryDto {
    /**
     * Constructs a new <code>SalesEntryDto</code>.
     * @alias module:model/SalesEntryDto
     */
    constructor() { 
        
        SalesEntryDto.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SalesEntryDto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SalesEntryDto} obj Optional instance to populate.
     * @return {module:model/SalesEntryDto} The populated <code>SalesEntryDto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SalesEntryDto();
    ...
    /**
     * Validates the JSON data with respect to <code>SalesEntryDto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SalesEntryDto</code>.
     */
 ...
 */
SalesEntryDto.prototype['acCode'] = undefined;

/**
 * @member {Array.<module:model/AcEntryDto>} acEntries
 */
SalesEntryDto.prototype['acEntries'] = undefined;

/**
 * @member {Number} bookTranTypeId
 */
SalesEntryDto.prototype['bookTranTypeId'] = undefined;

/**
 * @member {Array.<module:model/AcudfValueDto>} customFields
 */
SalesEntryDto.prototype['customFields'] = undefined;

/**
 * @member {Number} customerId
 */
SalesEntryDto.prototype['customerId'] = undefined;

/**
 * @member {Array.<String>} detailCollection
 */
SalesEntryDto.prototype['detailCollection'] = undefined;

/**
 * @member {String} details
 */
SalesEntryDto.prototype['details'] = undefined;

/**
 * @member {Date} entryDate
 */
SalesEntryDto.prototype['entryDate'] = undefined;

/**
 * @member {Number} id
 */
SalesEntryDto.prototype['id'] = undefined;

/**
 * @member {Number} netGoods
 */
SalesEntryDto.prototype['netGoods'] = undefined;

/**
 * @member {Number} netServices
 */
SalesEntryDto.prototype['netServices'] = undefined;

/**
 * @member {String} note
 */
SalesEntryDto.prototype['note'] = undefined;

/**
 * @member {Date} procDate
 */
SalesEntryDto.prototype['procDate'] = undefined;

/**
 * @member {String} reference
 */
SalesEntryDto.prototype['reference'] = undefined;

/**
 * @member {Blob} timestamp
 */
SalesEntryDto.prototype['timestamp'] = undefined;

/**
 * @member {Number} total
 */
SalesEntryDto.prototype['total'] = undefined;

/**
 * @member {Number} totalNet
 */
SalesEntryDto.prototype['totalNet'] = undefined;

/**
 * @member {Number} totalVAT
 */
SalesEntryDto.prototype['totalVAT'] = undefined;

/**
 * @member {Number} unpaid
 */
SalesEntryDto.prototype['unpaid'] = undefined;

/**
 * @member {Array.<module:model/VatEntryDto>} vatEntries
 */
SalesEntryDto.prototype['vatEntries'] = undefined;

/**
 * @member {Number} vatTypeId
 */
SalesEntryDto.prototype['vatTypeId'] = undefined;
