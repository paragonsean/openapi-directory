...
/**
 * The CompanyOptionDto model module.
 * @module model/CompanyOptionDto
 * @version v1
 */
class CompanyOptionDto {
    /**
     * Constructs a new <code>CompanyOptionDto</code>.
     * @alias module:model/CompanyOptionDto
     */
    constructor() { 
        
        CompanyOptionDto.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompanyOptionDto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompanyOptionDto} obj Optional instance to populate.
     * @return {module:model/CompanyOptionDto} The populated <code>CompanyOptionDto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompanyOptionDto();
    ...
    /**
     * Validates the JSON data with respect to <code>CompanyOptionDto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompanyOptionDto</code>.
     */
 ...
 */
CompanyOptionDto.prototype['allowEntryOfGrossPriceInInvoicing'] = undefined;

/**
 * @member {Boolean} creditInputForReverseChargeVAT
 */
CompanyOptionDto.prototype['creditInputForReverseChargeVAT'] = undefined;

/**
 * @member {String} creditNoteJournalAgeingName
 */
CompanyOptionDto.prototype['creditNoteJournalAgeingName'] = undefined;

/**
 * @member {Number} creditNoteJournalAgeingValue
 */
CompanyOptionDto.prototype['creditNoteJournalAgeingValue'] = undefined;

/**
 * @member {Number} discrepancyAllowed
 */
CompanyOptionDto.prototype['discrepancyAllowed'] = undefined;

/**
 * @member {Boolean} enableVOCRReporting
 */
CompanyOptionDto.prototype['enableVOCRReporting'] = undefined;

/**
 * @member {Boolean} marginVatScheme
 */
CompanyOptionDto.prototype['marginVatScheme'] = undefined;

/**
 * @member {Boolean} printOSItemsOnly
 */
CompanyOptionDto.prototype['printOSItemsOnly'] = undefined;

/**
 * @member {Number} purchasesVatAnalysisType
 */
CompanyOptionDto.prototype['purchasesVatAnalysisType'] = undefined;

/**
 * @member {Number} salesVatAnalysisType
 */
CompanyOptionDto.prototype['salesVatAnalysisType'] = undefined;

/**
 * @member {Boolean} useAllocations
 */
CompanyOptionDto.prototype['useAllocations'] = undefined;

/**
 * @member {Boolean} useNominal
 */
CompanyOptionDto.prototype['useNominal'] = undefined;

/**
 * @member {Boolean} useNominalCode
 */
CompanyOptionDto.prototype['useNominalCode'] = undefined;

/**
 * @member {Boolean} vocrSettingValue
 */
CompanyOptionDto.prototype['vocrSettingValue'] = undefined;
...
export default CompanyOptionDto;
