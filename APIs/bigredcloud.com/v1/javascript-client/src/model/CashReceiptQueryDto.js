...
/**
 * The CashReceiptQueryDto model module.
 * @module model/CashReceiptQueryDto
 * @version v1
 */
class CashReceiptQueryDto {
    /**
     * Constructs a new <code>CashReceiptQueryDto</code>.
     * @alias module:model/CashReceiptQueryDto
     */
    constructor() { 
        
        CashReceiptQueryDto.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CashReceiptQueryDto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CashReceiptQueryDto} obj Optional instance to populate.
     * @return {module:model/CashReceiptQueryDto} The populated <code>CashReceiptQueryDto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CashReceiptQueryDto();
    ...
    /**
     * Validates the JSON data with respect to <code>CashReceiptQueryDto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CashReceiptQueryDto</code>.
     */
 ...
 */
CashReceiptQueryDto.prototype['acCode'] = undefined;

/**
 * @member {Array.<module:model/AcEntryDto>} acEntries
 */
CashReceiptQueryDto.prototype['acEntries'] = undefined;

/**
 * @member {Number} bookTranTypeId
 */
CashReceiptQueryDto.prototype['bookTranTypeId'] = undefined;

/**
 * @member {Array.<module:model/AcudfValueDto>} customFields
 */
CashReceiptQueryDto.prototype['customFields'] = undefined;

/**
 * @member {Number} customerId
 */
CashReceiptQueryDto.prototype['customerId'] = undefined;

/**
 * @member {Array.<String>} detailCollection
 */
CashReceiptQueryDto.prototype['detailCollection'] = undefined;

/**
 * @member {Number} discount
 */
CashReceiptQueryDto.prototype['discount'] = undefined;

/**
 * @member {Date} entryDate
 */
CashReceiptQueryDto.prototype['entryDate'] = undefined;

/**
 * @member {Number} id
 */
CashReceiptQueryDto.prototype['id'] = undefined;

/**
 * @member {Number} ledger
 */
CashReceiptQueryDto.prototype['ledger'] = undefined;

/**
 * @member {String} note
 */
CashReceiptQueryDto.prototype['note'] = undefined;

/**
 * @member {String} plaidTransactionId
 */
CashReceiptQueryDto.prototype['plaidTransactionId'] = undefined;

/**
 * @member {Date} procDate
 */
CashReceiptQueryDto.prototype['procDate'] = undefined;

/**
 * @member {Blob} timestamp
 */
CashReceiptQueryDto.prototype['timestamp'] = undefined;

/**
 * @member {Number} total
 */
CashReceiptQueryDto.prototype['total'] = undefined;

/**
 * @member {Number} unallocated
 */
CashReceiptQueryDto.prototype['unallocated'] = undefined;

/**
 * @member {Array.<module:model/VatEntryDto>} vatEntries
 */
CashReceiptQueryDto.prototype['vatEntries'] = undefined;

/**
 * @member {Number} vatTypeId
 */
CashReceiptQueryDto.prototype['vatTypeId'] = undefined;
...
export default CashReceiptQueryDto;
