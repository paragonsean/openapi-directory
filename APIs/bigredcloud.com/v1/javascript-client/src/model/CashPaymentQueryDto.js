...
/**
 * The CashPaymentQueryDto model module.
 * @module model/CashPaymentQueryDto
 * @version v1
 */
class CashPaymentQueryDto {
    /**
     * Constructs a new <code>CashPaymentQueryDto</code>.
     * @alias module:model/CashPaymentQueryDto
     */
    constructor() { 
        
        CashPaymentQueryDto.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CashPaymentQueryDto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CashPaymentQueryDto} obj Optional instance to populate.
     * @return {module:model/CashPaymentQueryDto} The populated <code>CashPaymentQueryDto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CashPaymentQueryDto();
    ...
    /**
     * Validates the JSON data with respect to <code>CashPaymentQueryDto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CashPaymentQueryDto</code>.
     */
 ...
 */
CashPaymentQueryDto.prototype['acCode'] = undefined;

/**
 * @member {Array.<module:model/AcEntryDto>} acEntries
 */
CashPaymentQueryDto.prototype['acEntries'] = undefined;

/**
 * @member {String} bankAccountCode
 */
CashPaymentQueryDto.prototype['bankAccountCode'] = undefined;

/**
 * @member {Number} bankAccountId
 */
CashPaymentQueryDto.prototype['bankAccountId'] = undefined;

/**
 * @member {Number} bookTranTypeId
 */
CashPaymentQueryDto.prototype['bookTranTypeId'] = undefined;

/**
 * @member {Array.<module:model/AcudfValueDto>} customFields
 */
CashPaymentQueryDto.prototype['customFields'] = undefined;

/**
 * @member {Array.<String>} detailCollection
 */
CashPaymentQueryDto.prototype['detailCollection'] = undefined;

/**
 * @member {Number} discount
 */
CashPaymentQueryDto.prototype['discount'] = undefined;

/**
 * @member {Date} entryDate
 */
CashPaymentQueryDto.prototype['entryDate'] = undefined;

/**
 * @member {Number} id
 */
CashPaymentQueryDto.prototype['id'] = undefined;

/**
 * @member {Number} ledger
 */
CashPaymentQueryDto.prototype['ledger'] = undefined;

/**
 * @member {Number} lodgement
 */
CashPaymentQueryDto.prototype['lodgement'] = undefined;

/**
 * @member {String} note
 */
CashPaymentQueryDto.prototype['note'] = undefined;

/**
 * @member {String} plaidTransactionId
 */
CashPaymentQueryDto.prototype['plaidTransactionId'] = undefined;

/**
 * @member {Date} procDate
 */
CashPaymentQueryDto.prototype['procDate'] = undefined;

/**
 * @member {Number} supplierId
 */
CashPaymentQueryDto.prototype['supplierId'] = undefined;

/**
 * @member {Blob} timestamp
 */
CashPaymentQueryDto.prototype['timestamp'] = undefined;

/**
 * @member {Number} total
 */
CashPaymentQueryDto.prototype['total'] = undefined;

/**
 * @member {Number} unallocated
 */
CashPaymentQueryDto.prototype['unallocated'] = undefined;
...
export default CashPaymentQueryDto;
