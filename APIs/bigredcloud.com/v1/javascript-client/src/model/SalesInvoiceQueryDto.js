...
/**
 * The SalesInvoiceQueryDto model module.
 * @module model/SalesInvoiceQueryDto
 * @version v1
 */
class SalesInvoiceQueryDto {
    /**
     * Constructs a new <code>SalesInvoiceQueryDto</code>.
     * @alias module:model/SalesInvoiceQueryDto
     */
    constructor() { 
        
        SalesInvoiceQueryDto.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SalesInvoiceQueryDto</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SalesInvoiceQueryDto} obj Optional instance to populate.
     * @return {module:model/SalesInvoiceQueryDto} The populated <code>SalesInvoiceQueryDto</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SalesInvoiceQueryDto();
    ...
    /**
     * Validates the JSON data with respect to <code>SalesInvoiceQueryDto</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SalesInvoiceQueryDto</code>.
     */
 ...
 */
SalesInvoiceQueryDto.prototype['acCode'] = undefined;

/**
 * @member {Number} bookTranTypeId
 */
SalesInvoiceQueryDto.prototype['bookTranTypeId'] = undefined;

/**
 * @member {Array.<module:model/AcudfValueDto>} customFields
 */
SalesInvoiceQueryDto.prototype['customFields'] = undefined;

/**
 * @member {Number} customerId
 */
SalesInvoiceQueryDto.prototype['customerId'] = undefined;

/**
 * @member {Array.<String>} deliveryTo
 */
SalesInvoiceQueryDto.prototype['deliveryTo'] = undefined;

/**
 * @member {String} details
 */
SalesInvoiceQueryDto.prototype['details'] = undefined;

/**
 * @member {Date} entryDate
 */
SalesInvoiceQueryDto.prototype['entryDate'] = undefined;

/**
 * @member {Number} id
 */
SalesInvoiceQueryDto.prototype['id'] = undefined;

/**
 * @member {String} loType
 */
SalesInvoiceQueryDto.prototype['loType'] = undefined;

/**
 * @member {Number} netGoods
 */
SalesInvoiceQueryDto.prototype['netGoods'] = undefined;

/**
 * @member {Number} netServices
 */
SalesInvoiceQueryDto.prototype['netServices'] = undefined;

/**
 * @member {String} note
 */
SalesInvoiceQueryDto.prototype['note'] = undefined;

/**
 * @member {String} ourReference
 */
SalesInvoiceQueryDto.prototype['ourReference'] = undefined;

/**
 * @member {Date} procDate
 */
SalesInvoiceQueryDto.prototype['procDate'] = undefined;

/**
 * @member {Array.<module:model/ProductTranQueryDto>} productTrans
 */
SalesInvoiceQueryDto.prototype['productTrans'] = undefined;

/**
 * @member {Number} quoteId
 */
SalesInvoiceQueryDto.prototype['quoteId'] = undefined;

/**
 * @member {String} reference
 */
SalesInvoiceQueryDto.prototype['reference'] = undefined;

/**
 * @member {String} saleRepCode
 */
SalesInvoiceQueryDto.prototype['saleRepCode'] = undefined;

/**
 * @member {Number} saleRepId
 */
SalesInvoiceQueryDto.prototype['saleRepId'] = undefined;

/**
 * @member {Blob} timestamp
 */
SalesInvoiceQueryDto.prototype['timestamp'] = undefined;

/**
 * @member {Number} total
 */
SalesInvoiceQueryDto.prototype['total'] = undefined;

/**
 * @member {Number} totalNet
 */
SalesInvoiceQueryDto.prototype['totalNet'] = undefined;

/**
 * @member {Number} totalVAT
 */
SalesInvoiceQueryDto.prototype['totalVAT'] = undefined;

/**
 * @member {Number} unpaid
 */
SalesInvoiceQueryDto.prototype['unpaid'] = undefined;

/**
 * @member {Number} vatTypeId
 */
SalesInvoiceQueryDto.prototype['vatTypeId'] = undefined;

/**
 * @member {String} yourReference
 */
SalesInvoiceQueryDto.prototype['yourReference'] = undefined;
...
export default SalesInvoiceQueryDto;
