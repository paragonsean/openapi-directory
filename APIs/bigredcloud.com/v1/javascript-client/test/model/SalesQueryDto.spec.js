...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.SalesQueryDto();
  });
  ...
  describe('SalesQueryDto', function() {
    it('should create an instance of SalesQueryDto', function() {
      // uncomment below and update the code to test SalesQueryDto
      //var instance = new BigRedCloudApi.SalesQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.SalesQueryDto);
    });
