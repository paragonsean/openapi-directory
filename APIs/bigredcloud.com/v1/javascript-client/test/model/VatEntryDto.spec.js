...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.VatEntryDto();
  });
  ...
  describe('VatEntryDto', function() {
    it('should create an instance of VatEntryDto', function() {
      // uncomment below and update the code to test VatEntryDto
      //var instance = new BigRedCloudApi.VatEntryDto();
      //expect(instance).to.be.a(BigRedCloudApi.VatEntryDto);
    });
