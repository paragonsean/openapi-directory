...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.EFTBankDto();
  });
  ...
  describe('EFTBankDto', function() {
    it('should create an instance of EFTBankDto', function() {
      // uncomment below and update the code to test EFTBankDto
      //var instance = new BigRedCloudApi.EFTBankDto();
      //expect(instance).to.be.a(BigRedCloudApi.EFTBankDto);
    });
