...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.AccountDto();
  });
  ...
  describe('AccountDto', function() {
    it('should create an instance of AccountDto', function() {
      // uncomment below and update the code to test AccountDto
      //var instance = new BigRedCloudApi.AccountDto();
      //expect(instance).to.be.a(BigRedCloudApi.AccountDto);
    });
