...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.SalesEntryDto();
  });
  ...
  describe('SalesEntryDto', function() {
    it('should create an instance of SalesEntryDto', function() {
      // uncomment below and update the code to test SalesEntryDto
      //var instance = new BigRedCloudApi.SalesEntryDto();
      //expect(instance).to.be.a(BigRedCloudApi.SalesEntryDto);
    });
