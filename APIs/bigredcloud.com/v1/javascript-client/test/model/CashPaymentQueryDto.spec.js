...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.CashPaymentQueryDto();
  });
  ...
  describe('CashPaymentQueryDto', function() {
    it('should create an instance of CashPaymentQueryDto', function() {
      // uncomment below and update the code to test CashPaymentQueryDto
      //var instance = new BigRedCloudApi.CashPaymentQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.CashPaymentQueryDto);
    });
    ...
    it('should have the property lodgement (base name: "lodgement")', function() {
      // uncomment below and update the code to test the property lodgement
      //var instance = new BigRedCloudApi.CashPaymentQueryDto();
      //expect(instance).to.be();
    });
