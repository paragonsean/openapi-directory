...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.EmailQuoteDto();
  });
  ...
  describe('EmailQuoteDto', function() {
    it('should create an instance of EmailQuoteDto', function() {
      // uncomment below and update the code to test EmailQuoteDto
      //var instance = new BigRedCloudApi.EmailQuoteDto();
      //expect(instance).to.be.a(BigRedCloudApi.EmailQuoteDto);
    });
