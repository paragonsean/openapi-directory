...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.SalesEntryQueryDto();
  });
  ...
  describe('SalesEntryQueryDto', function() {
    it('should create an instance of SalesEntryQueryDto', function() {
      // uncomment below and update the code to test SalesEntryQueryDto
      //var instance = new BigRedCloudApi.SalesEntryQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.SalesEntryQueryDto);
    });
