...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.SupplierQueryDto();
  });
  ...
  describe('SupplierQueryDto', function() {
    it('should create an instance of SupplierQueryDto', function() {
      // uncomment below and update the code to test SupplierQueryDto
      //var instance = new BigRedCloudApi.SupplierQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.SupplierQueryDto);
    });
