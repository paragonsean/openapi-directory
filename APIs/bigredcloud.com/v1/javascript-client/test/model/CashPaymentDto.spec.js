...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.CashPaymentDto();
  });
  ...
  describe('CashPaymentDto', function() {
    it('should create an instance of CashPaymentDto', function() {
      // uncomment below and update the code to test CashPaymentDto
      //var instance = new BigRedCloudApi.CashPaymentDto();
      //expect(instance).to.be.a(BigRedCloudApi.CashPaymentDto);
    });
