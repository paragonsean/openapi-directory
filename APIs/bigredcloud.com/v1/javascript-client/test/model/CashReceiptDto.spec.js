...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.CashReceiptDto();
  });
  ...
  describe('CashReceiptDto', function() {
    it('should create an instance of CashReceiptDto', function() {
      // uncomment below and update the code to test CashReceiptDto
      //var instance = new BigRedCloudApi.CashReceiptDto();
      //expect(instance).to.be.a(BigRedCloudApi.CashReceiptDto);
    });
