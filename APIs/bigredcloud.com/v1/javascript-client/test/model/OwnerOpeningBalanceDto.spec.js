...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.OwnerOpeningBalanceDto();
  });
  ...
  describe('OwnerOpeningBalanceDto', function() {
    it('should create an instance of OwnerOpeningBalanceDto', function() {
      // uncomment below and update the code to test OwnerOpeningBalanceDto
      //var instance = new BigRedCloudApi.OwnerOpeningBalanceDto();
      //expect(instance).to.be.a(BigRedCloudApi.OwnerOpeningBalanceDto);
    });
