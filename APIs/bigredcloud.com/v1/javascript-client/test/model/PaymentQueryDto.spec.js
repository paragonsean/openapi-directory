...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.PaymentQueryDto();
  });
  ...
  describe('PaymentQueryDto', function() {
    it('should create an instance of PaymentQueryDto', function() {
      // uncomment below and update the code to test PaymentQueryDto
      //var instance = new BigRedCloudApi.PaymentQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.PaymentQueryDto);
    });
    ...
    it('should have the property bankAccountCode (base name: "bankAccountCode")', function() {
      // uncomment below and update the code to test the property bankAccountCode
      //var instance = new BigRedCloudApi.PaymentQueryDto();
      //expect(instance).to.be();
    });
    ...
    it('should have the property transferBankCode (base name: "transferBankCode")', function() {
      // uncomment below and update the code to test the property transferBankCode
      //var instance = new BigRedCloudApi.PaymentQueryDto();
      //expect(instance).to.be();
    });

    it('should have the property transferBankId (base name: "transferBankId")', function() {
      // uncomment below and update the code to test the property transferBankId
      //var instance = new BigRedCloudApi.PaymentQueryDto();
      //expect(instance).to.be();
    });
