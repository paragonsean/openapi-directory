...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.PurchaseDto();
  });
  ...
  describe('PurchaseDto', function() {
    it('should create an instance of PurchaseDto', function() {
      // uncomment below and update the code to test PurchaseDto
      //var instance = new BigRedCloudApi.PurchaseDto();
      //expect(instance).to.be.a(BigRedCloudApi.PurchaseDto);
    });
    ...
    it('should have the property isDiscrepancyAccepted (base name: "isDiscrepancyAccepted")', function() {
      // uncomment below and update the code to test the property isDiscrepancyAccepted
      //var instance = new BigRedCloudApi.PurchaseDto();
      //expect(instance).to.be();
    });
