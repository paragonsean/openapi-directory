...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.ProductDto();
  });
  ...
  describe('ProductDto', function() {
    it('should create an instance of ProductDto', function() {
      ...
      //var instance = new BigRedCloudApi.ProductDto();
      //expect(instance).to.be.a(BigRedCloudApi.ProductDto);
    });
    ...
    it('should have the property grossUnitPrice (base name: "grossUnitPrice")', function() {
      // uncomment below and update the code to test the property grossUnitPrice
      //var instance = new BigRedCloudApi.ProductDto();
      //expect(instance).to.be();
    });

    it('should have the property hasDefaultVatRate (base name: "hasDefaultVatRate")', function() {
      // uncomment below and update the code to test the property hasDefaultVatRate
      //var instance = new BigRedCloudApi.ProductDto();
      //expect(instance).to.be();
    });
