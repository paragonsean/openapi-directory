...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.BatchItemQuoteDto();
  });
  ...
  describe('BatchItemQuoteDto', function() {
    it('should create an instance of BatchItemQuoteDto', function() {
      // uncomment below and update the code to test BatchItemQuoteDto
      //var instance = new BigRedCloudApi.BatchItemQuoteDto();
      //expect(instance).to.be.a(BigRedCloudApi.BatchItemQuoteDto);
    });
