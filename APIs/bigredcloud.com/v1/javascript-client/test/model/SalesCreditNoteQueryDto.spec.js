...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.SalesCreditNoteQueryDto();
  });
  ...
  describe('SalesCreditNoteQueryDto', function() {
    it('should create an instance of SalesCreditNoteQueryDto', function() {
      // uncomment below and update the code to test SalesCreditNoteQueryDto
      //var instance = new BigRedCloudApi.SalesCreditNoteQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.SalesCreditNoteQueryDto);
    });
