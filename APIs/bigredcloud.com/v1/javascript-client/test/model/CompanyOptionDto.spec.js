...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.CompanyOptionDto();
  });
  ...
  describe('CompanyOptionDto', function() {
    it('should create an instance of CompanyOptionDto', function() {
      // uncomment below and update the code to test CompanyOptionDto
      //var instance = new BigRedCloudApi.CompanyOptionDto();
      //expect(instance).to.be.a(BigRedCloudApi.CompanyOptionDto);
    });
