...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.CustomerQueryDto();
  });
  ...
  describe('CustomerQueryDto', function() {
    it('should create an instance of CustomerQueryDto', function() {
      // uncomment below and update the code to test CustomerQueryDto
      //var instance = new BigRedCloudApi.CustomerQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.CustomerQueryDto);
    });
