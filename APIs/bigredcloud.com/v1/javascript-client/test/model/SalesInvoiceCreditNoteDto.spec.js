...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.SalesInvoiceCreditNoteDto();
  });
  ...
  describe('SalesInvoiceCreditNoteDto', function() {
    it('should create an instance of SalesInvoiceCreditNoteDto', function() {
      // uncomment below and update the code to test SalesInvoiceCreditNoteDto
      //var instance = new BigRedCloudApi.SalesInvoiceCreditNoteDto();
      //expect(instance).to.be.a(BigRedCloudApi.SalesInvoiceCreditNoteDto);
    });
