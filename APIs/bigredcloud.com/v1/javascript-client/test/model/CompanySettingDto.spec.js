...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.CompanySettingDto();
  });
  ...
  describe('CompanySettingDto', function() {
    it('should create an instance of CompanySettingDto', function() {
      // uncomment below and update the code to test CompanySettingDto
      //var instance = new BigRedCloudApi.CompanySettingDto();
      //expect(instance).to.be.a(BigRedCloudApi.CompanySettingDto);
    });
