...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.QuoteProductTransDto();
  });
  ...
  describe('QuoteProductTransDto', function() {
    it('should create an instance of QuoteProductTransDto', function() {
      // uncomment below and update the code to test QuoteProductTransDto
      //var instance = new BigRedCloudApi.QuoteProductTransDto();
      //expect(instance).to.be.a(BigRedCloudApi.QuoteProductTransDto);
    });
