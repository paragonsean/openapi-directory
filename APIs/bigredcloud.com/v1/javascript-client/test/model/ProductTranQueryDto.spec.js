...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigRedCloudApi.ProductTranQueryDto();
  });
  ...
  describe('ProductTranQueryDto', function() {
    it('should create an instance of ProductTranQueryDto', function() {
      // uncomment below and update the code to test ProductTranQueryDto
      //var instance = new BigRedCloudApi.ProductTranQueryDto();
      //expect(instance).to.be.a(BigRedCloudApi.ProductTranQueryDto);
    });
