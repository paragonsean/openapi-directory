...
/*
 * OAIODataQueryOptions_BookTranTypeDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_BookTranTypeDto__H
#define OAIODataQueryOptions_BookTranTypeDto__H
...
class OAIODataQueryOptions_BookTranTypeDto_ : public OAIObject {
public:
    OAIODataQueryOptions_BookTranTypeDto_();
    OAIODataQueryOptions_BookTranTypeDto_(QString json);
    ~OAIODataQueryOptions_BookTranTypeDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_BookTranTypeDto_)

#endif // OAIODataQueryOptions_BookTranTypeDto__H
