...
/*
 * OAIODataQueryOptions_SalesCreditNoteQueryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_SalesCreditNoteQueryDto__H
#define OAIODataQueryOptions_SalesCreditNoteQueryDto__H
...
class OAIODataQueryOptions_SalesCreditNoteQueryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_SalesCreditNoteQueryDto_();
    OAIODataQueryOptions_SalesCreditNoteQueryDto_(QString json);
    ~OAIODataQueryOptions_SalesCreditNoteQueryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_SalesCreditNoteQueryDto_)

#endif // OAIODataQueryOptions_SalesCreditNoteQueryDto__H
