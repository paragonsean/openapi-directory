...
#include "OAISalesCreditNoteQueryDto.h"
...
OAISalesCreditNoteQueryDto::OAISalesCreditNoteQueryDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISalesCreditNoteQueryDto::OAISalesCreditNoteQueryDto() {
    this->initializeModel();
}

OAISalesCreditNoteQueryDto::~OAISalesCreditNoteQueryDto() {}

void OAISalesCreditNoteQueryDto::initializeModel() {
...
void OAISalesCreditNoteQueryDto::fromJson(QString jsonString) {
...
void OAISalesCreditNoteQueryDto::fromJsonObject(QJsonObject json) {
...
QString OAISalesCreditNoteQueryDto::asJson() const {
...
QJsonObject OAISalesCreditNoteQueryDto::asJsonObject() const {
    QJsonObject obj;
    if (m_ac_code_isSet) {
...
QString OAISalesCreditNoteQueryDto::getAcCode() const {
    return m_ac_code;
}
void OAISalesCreditNoteQueryDto::setAcCode(const QString &ac_code) {
    m_ac_code = ac_code;
    m_ac_code_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_ac_code_Set() const{
    return m_ac_code_isSet;
}

bool OAISalesCreditNoteQueryDto::is_ac_code_Valid() const{
    return m_ac_code_isValid;
}

qint64 OAISalesCreditNoteQueryDto::getBookTranTypeId() const {
    return m_book_tran_type_id;
}
void OAISalesCreditNoteQueryDto::setBookTranTypeId(const qint64 &book_tran_type_id) {
    m_book_tran_type_id = book_tran_type_id;
    m_book_tran_type_id_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_book_tran_type_id_Set() const{
    return m_book_tran_type_id_isSet;
}

bool OAISalesCreditNoteQueryDto::is_book_tran_type_id_Valid() const{
    return m_book_tran_type_id_isValid;
}

QList<OAIAcudfValueDto> OAISalesCreditNoteQueryDto::getCustomFields() const {
    return m_custom_fields;
}
void OAISalesCreditNoteQueryDto::setCustomFields(const QList<OAIAcudfValueDto> &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAISalesCreditNoteQueryDto::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

qint64 OAISalesCreditNoteQueryDto::getCustomerId() const {
    return m_customer_id;
}
void OAISalesCreditNoteQueryDto::setCustomerId(const qint64 &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAISalesCreditNoteQueryDto::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QList<QString> OAISalesCreditNoteQueryDto::getDeliveryTo() const {
    return m_delivery_to;
}
void OAISalesCreditNoteQueryDto::setDeliveryTo(const QList<QString> &delivery_to) {
    m_delivery_to = delivery_to;
    m_delivery_to_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_delivery_to_Set() const{
    return m_delivery_to_isSet;
}

bool OAISalesCreditNoteQueryDto::is_delivery_to_Valid() const{
    return m_delivery_to_isValid;
}

QString OAISalesCreditNoteQueryDto::getDetails() const {
    return m_details;
}
void OAISalesCreditNoteQueryDto::setDetails(const QString &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_details_Set() const{
    return m_details_isSet;
}

bool OAISalesCreditNoteQueryDto::is_details_Valid() const{
    return m_details_isValid;
}

QDateTime OAISalesCreditNoteQueryDto::getEntryDate() const {
    return m_entry_date;
}
void OAISalesCreditNoteQueryDto::setEntryDate(const QDateTime &entry_date) {
    m_entry_date = entry_date;
    m_entry_date_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_entry_date_Set() const{
    return m_entry_date_isSet;
}

bool OAISalesCreditNoteQueryDto::is_entry_date_Valid() const{
    return m_entry_date_isValid;
}

qint64 OAISalesCreditNoteQueryDto::getId() const {
    return m_id;
}
void OAISalesCreditNoteQueryDto::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_id_Set() const{
    return m_id_isSet;
}

bool OAISalesCreditNoteQueryDto::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISalesCreditNoteQueryDto::getLoType() const {
    return m_lo_type;
}
void OAISalesCreditNoteQueryDto::setLoType(const QString &lo_type) {
    m_lo_type = lo_type;
    m_lo_type_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_lo_type_Set() const{
    return m_lo_type_isSet;
}

bool OAISalesCreditNoteQueryDto::is_lo_type_Valid() const{
    return m_lo_type_isValid;
}

double OAISalesCreditNoteQueryDto::getNetGoods() const {
    return m_net_goods;
}
void OAISalesCreditNoteQueryDto::setNetGoods(const double &net_goods) {
    m_net_goods = net_goods;
    m_net_goods_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_net_goods_Set() const{
    return m_net_goods_isSet;
}

bool OAISalesCreditNoteQueryDto::is_net_goods_Valid() const{
    return m_net_goods_isValid;
}

double OAISalesCreditNoteQueryDto::getNetServices() const {
    return m_net_services;
}
void OAISalesCreditNoteQueryDto::setNetServices(const double &net_services) {
    m_net_services = net_services;
    m_net_services_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_net_services_Set() const{
    return m_net_services_isSet;
}

bool OAISalesCreditNoteQueryDto::is_net_services_Valid() const{
    return m_net_services_isValid;
}

QString OAISalesCreditNoteQueryDto::getNote() const {
    return m_note;
}
void OAISalesCreditNoteQueryDto::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAISalesCreditNoteQueryDto::is_note_Valid() const{
    return m_note_isValid;
}

QString OAISalesCreditNoteQueryDto::getOurReference() const {
    return m_our_reference;
}
void OAISalesCreditNoteQueryDto::setOurReference(const QString &our_reference) {
    m_our_reference = our_reference;
    m_our_reference_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_our_reference_Set() const{
    return m_our_reference_isSet;
}

bool OAISalesCreditNoteQueryDto::is_our_reference_Valid() const{
    return m_our_reference_isValid;
}

QDateTime OAISalesCreditNoteQueryDto::getProcDate() const {
    return m_proc_date;
}
void OAISalesCreditNoteQueryDto::setProcDate(const QDateTime &proc_date) {
    m_proc_date = proc_date;
    m_proc_date_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_proc_date_Set() const{
    return m_proc_date_isSet;
}

bool OAISalesCreditNoteQueryDto::is_proc_date_Valid() const{
    return m_proc_date_isValid;
}

QList<OAIProductTranQueryDto> OAISalesCreditNoteQueryDto::getProductTrans() const {
    return m_product_trans;
}
void OAISalesCreditNoteQueryDto::setProductTrans(const QList<OAIProductTranQueryDto> &product_trans) {
    m_product_trans = product_trans;
    m_product_trans_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_product_trans_Set() const{
    return m_product_trans_isSet;
}

bool OAISalesCreditNoteQueryDto::is_product_trans_Valid() const{
    return m_product_trans_isValid;
}

qint64 OAISalesCreditNoteQueryDto::getQuoteId() const {
    return m_quote_id;
}
void OAISalesCreditNoteQueryDto::setQuoteId(const qint64 &quote_id) {
    m_quote_id = quote_id;
    m_quote_id_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_quote_id_Set() const{
    return m_quote_id_isSet;
}

bool OAISalesCreditNoteQueryDto::is_quote_id_Valid() const{
    return m_quote_id_isValid;
}

QString OAISalesCreditNoteQueryDto::getReference() const {
    return m_reference;
}
void OAISalesCreditNoteQueryDto::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAISalesCreditNoteQueryDto::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAISalesCreditNoteQueryDto::getSaleRepCode() const {
    return m_sale_rep_code;
}
void OAISalesCreditNoteQueryDto::setSaleRepCode(const QString &sale_rep_code) {
    m_sale_rep_code = sale_rep_code;
    m_sale_rep_code_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_sale_rep_code_Set() const{
    return m_sale_rep_code_isSet;
}

bool OAISalesCreditNoteQueryDto::is_sale_rep_code_Valid() const{
    return m_sale_rep_code_isValid;
}

qint64 OAISalesCreditNoteQueryDto::getSaleRepId() const {
    return m_sale_rep_id;
}
void OAISalesCreditNoteQueryDto::setSaleRepId(const qint64 &sale_rep_id) {
    m_sale_rep_id = sale_rep_id;
    m_sale_rep_id_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_sale_rep_id_Set() const{
    return m_sale_rep_id_isSet;
}

bool OAISalesCreditNoteQueryDto::is_sale_rep_id_Valid() const{
    return m_sale_rep_id_isValid;
}

QByteArray OAISalesCreditNoteQueryDto::getTimestamp() const {
    return m_timestamp;
}
void OAISalesCreditNoteQueryDto::setTimestamp(const QByteArray &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAISalesCreditNoteQueryDto::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

double OAISalesCreditNoteQueryDto::getTotal() const {
    return m_total;
}
void OAISalesCreditNoteQueryDto::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_total_Set() const{
    return m_total_isSet;
}

bool OAISalesCreditNoteQueryDto::is_total_Valid() const{
    return m_total_isValid;
}

double OAISalesCreditNoteQueryDto::getTotalNet() const {
    return m_total_net;
}
void OAISalesCreditNoteQueryDto::setTotalNet(const double &total_net) {
    m_total_net = total_net;
    m_total_net_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_total_net_Set() const{
    return m_total_net_isSet;
}

bool OAISalesCreditNoteQueryDto::is_total_net_Valid() const{
    return m_total_net_isValid;
}

double OAISalesCreditNoteQueryDto::getTotalVat() const {
    return m_total_vat;
}
void OAISalesCreditNoteQueryDto::setTotalVat(const double &total_vat) {
    m_total_vat = total_vat;
    m_total_vat_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_total_vat_Set() const{
    return m_total_vat_isSet;
}

bool OAISalesCreditNoteQueryDto::is_total_vat_Valid() const{
    return m_total_vat_isValid;
}

double OAISalesCreditNoteQueryDto::getUnpaid() const {
    return m_unpaid;
}
void OAISalesCreditNoteQueryDto::setUnpaid(const double &unpaid) {
    m_unpaid = unpaid;
    m_unpaid_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_unpaid_Set() const{
    return m_unpaid_isSet;
}

bool OAISalesCreditNoteQueryDto::is_unpaid_Valid() const{
    return m_unpaid_isValid;
}

qint64 OAISalesCreditNoteQueryDto::getVatTypeId() const {
    return m_vat_type_id;
}
void OAISalesCreditNoteQueryDto::setVatTypeId(const qint64 &vat_type_id) {
    m_vat_type_id = vat_type_id;
    m_vat_type_id_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_vat_type_id_Set() const{
    return m_vat_type_id_isSet;
}

bool OAISalesCreditNoteQueryDto::is_vat_type_id_Valid() const{
    return m_vat_type_id_isValid;
}

QString OAISalesCreditNoteQueryDto::getYourReference() const {
    return m_your_reference;
}
void OAISalesCreditNoteQueryDto::setYourReference(const QString &your_reference) {
    m_your_reference = your_reference;
    m_your_reference_isSet = true;
}

bool OAISalesCreditNoteQueryDto::is_your_reference_Set() const{
    return m_your_reference_isSet;
}

bool OAISalesCreditNoteQueryDto::is_your_reference_Valid() const{
    return m_your_reference_isValid;
}

bool OAISalesCreditNoteQueryDto::isSet() const {
...
bool OAISalesCreditNoteQueryDto::isValid() const {
