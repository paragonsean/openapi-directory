...
/*
 * OAIODataQueryOptions_VatRateDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_VatRateDto__H
#define OAIODataQueryOptions_VatRateDto__H
...
class OAIODataQueryOptions_VatRateDto_ : public OAIObject {
public:
    OAIODataQueryOptions_VatRateDto_();
    OAIODataQueryOptions_VatRateDto_(QString json);
    ~OAIODataQueryOptions_VatRateDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_VatRateDto_)

#endif // OAIODataQueryOptions_VatRateDto__H
