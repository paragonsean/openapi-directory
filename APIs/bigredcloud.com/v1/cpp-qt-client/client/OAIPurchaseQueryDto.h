...
/*
 * OAIPurchaseQueryDto.h
 *
 * 
 */

#ifndef OAIPurchaseQueryDto_H
#define OAIPurchaseQueryDto_H
...
class OAIPurchaseQueryDto : public OAIObject {
public:
    OAIPurchaseQueryDto();
    OAIPurchaseQueryDto(QString json);
    ~OAIPurchaseQueryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseQueryDto)

#endif // OAIPurchaseQueryDto_H
