...
Q_SIGNALS:
    ...
    void accountsGetSignal(OAIPageResult_AccountDto_ summary);


    void accountsGetSignalFull(OAIHttpRequestWorker *worker, OAIPageResult_AccountDto_ summary);

    Q_DECL_DEPRECATED_X("Use accountsGetSignalError() instead")
    void accountsGetSignalE(OAIPageResult_AccountDto_ summary, QNetworkReply::NetworkError error_type, QString error_str);
    void accountsGetSignalError(OAIPageResult_AccountDto_ summary, QNetworkReply::NetworkError error_type, const QString &error_str);
