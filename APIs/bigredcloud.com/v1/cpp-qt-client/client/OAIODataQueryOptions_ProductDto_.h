...
/*
 * OAIODataQueryOptions_ProductDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_ProductDto__H
#define OAIODataQueryOptions_ProductDto__H
...
class OAIODataQueryOptions_ProductDto_ : public OAIObject {
public:
    OAIODataQueryOptions_ProductDto_();
    OAIODataQueryOptions_ProductDto_(QString json);
    ~OAIODataQueryOptions_ProductDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_ProductDto_)

#endif // OAIODataQueryOptions_ProductDto__H
