...
#ifndef OAIBankAccountDto_H
#define OAIBankAccountDto_H
...
class OAIBankAccountDto : public OAIObject {
public:
    OAIBankAccountDto();
    OAIBankAccountDto(QString json);
    ~OAIBankAccountDto() override;
    ...
    double getOBalance() const;
    void setOBalance(const double &o_balance);
    bool is_o_balance_Set() const;
    bool is_o_balance_Valid() const;
...
private:
    ...
    double m_o_balance;
    bool m_o_balance_isSet;
    bool m_o_balance_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountDto)

#endif // OAIBankAccountDto_H
