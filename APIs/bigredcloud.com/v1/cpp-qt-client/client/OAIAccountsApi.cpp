...
void OAIAccountsApi::accountsGet() {
    QString fullPath = QString(_serverConfigs["accountsGet"][_serverIndices.value("accountsGet")].URL()+"/v1/accounts");
...
void OAIAccountsApi::accountsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPageResult_AccountDto_ output(QString(worker->response));
    worker->deleteLater();
