...
/*
 * OAISalesInvoiceCreditNoteDto.h
 *
 * 
 */

#ifndef OAISalesInvoiceCreditNoteDto_H
#define OAISalesInvoiceCreditNoteDto_H
...
class OAIProductTranDto;

class OAISalesInvoiceCreditNoteDto : public OAIObject {
public:
    OAISalesInvoiceCreditNoteDto();
    OAISalesInvoiceCreditNoteDto(QString json);
    ~OAISalesInvoiceCreditNoteDto() override;
    ...
    QList<OAIProductTranDto> getProductTrans() const;
    void setProductTrans(const QList<OAIProductTranDto> &product_trans);
...
private:
    ...
    QList<OAIProductTranDto> m_product_trans;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesInvoiceCreditNoteDto)

#endif // OAISalesInvoiceCreditNoteDto_H
