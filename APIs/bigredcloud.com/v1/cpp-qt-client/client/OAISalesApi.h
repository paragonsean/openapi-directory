...
#include "OAIPageResult_SalesQueryDto_.h"
#include <QString>
...
Q_SIGNALS:
    ...
    void salesGetSignal(OAIPageResult_SalesQueryDto_ summary);


    void salesGetSignalFull(OAIHttpRequestWorker *worker, OAIPageResult_SalesQueryDto_ summary);

    Q_DECL_DEPRECATED_X("Use salesGetSignalError() instead")
    void salesGetSignalE(OAIPageResult_SalesQueryDto_ summary, QNetworkReply::NetworkError error_type, QString error_str);
    void salesGetSignalError(OAIPageResult_SalesQueryDto_ summary, QNetworkReply::NetworkError error_type, const QString &error_str);
