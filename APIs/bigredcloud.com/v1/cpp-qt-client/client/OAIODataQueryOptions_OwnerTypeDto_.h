...
/*
 * OAIODataQueryOptions_OwnerTypeDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_OwnerTypeDto__H
#define OAIODataQueryOptions_OwnerTypeDto__H
...
class OAIODataQueryOptions_OwnerTypeDto_ : public OAIObject {
public:
    OAIODataQueryOptions_OwnerTypeDto_();
    OAIODataQueryOptions_OwnerTypeDto_(QString json);
    ~OAIODataQueryOptions_OwnerTypeDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_OwnerTypeDto_)

#endif // OAIODataQueryOptions_OwnerTypeDto__H
