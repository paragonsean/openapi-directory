...
/*
 * OAIODataQueryOptions_CategoryTypeDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_CategoryTypeDto__H
#define OAIODataQueryOptions_CategoryTypeDto__H
...
class OAIODataQueryOptions_CategoryTypeDto_ : public OAIObject {
public:
    OAIODataQueryOptions_CategoryTypeDto_();
    OAIODataQueryOptions_CategoryTypeDto_(QString json);
    ~OAIODataQueryOptions_CategoryTypeDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_CategoryTypeDto_)

#endif // OAIODataQueryOptions_CategoryTypeDto__H
