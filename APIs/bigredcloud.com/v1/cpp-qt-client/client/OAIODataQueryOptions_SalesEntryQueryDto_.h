...
/*
 * OAIODataQueryOptions_SalesEntryQueryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_SalesEntryQueryDto__H
#define OAIODataQueryOptions_SalesEntryQueryDto__H
...
class OAIODataQueryOptions_SalesEntryQueryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_SalesEntryQueryDto_();
    OAIODataQueryOptions_SalesEntryQueryDto_(QString json);
    ~OAIODataQueryOptions_SalesEntryQueryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_SalesEntryQueryDto_)

#endif // OAIODataQueryOptions_SalesEntryQueryDto__H
