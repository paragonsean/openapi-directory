...
/*
 * OAISalesInvoiceQueryDto.h
 *
 * 
 */

#ifndef OAISalesInvoiceQueryDto_H
#define OAISalesInvoiceQueryDto_H

#include <QJsonObject>

#include "OAIAcudfValueDto.h"
#include "OAIProductTranQueryDto.h"
#include <QByteArray>
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIProductTranQueryDto;

class OAISalesInvoiceQueryDto : public OAIObject {
public:
    OAISalesInvoiceQueryDto();
    OAISalesInvoiceQueryDto(QString json);
    ~OAISalesInvoiceQueryDto() override;
    ...
    double getNetGoods() const;
    void setNetGoods(const double &net_goods);
    bool is_net_goods_Set() const;
    bool is_net_goods_Valid() const;

    double getNetServices() const;
    void setNetServices(const double &net_services);
    bool is_net_services_Set() const;
    bool is_net_services_Valid() const;
    ...
    QList<OAIProductTranQueryDto> getProductTrans() const;
    void setProductTrans(const QList<OAIProductTranQueryDto> &product_trans);
...
private:
    ...
    double m_net_goods;
    bool m_net_goods_isSet;
    bool m_net_goods_isValid;

    double m_net_services;
    bool m_net_services_isSet;
    bool m_net_services_isValid;
    ...
    QList<OAIProductTranQueryDto> m_product_trans;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesInvoiceQueryDto)

#endif // OAISalesInvoiceQueryDto_H
