...
/*
 * OAICashPaymentQueryDto.h
 *
 * 
 */

#ifndef OAICashPaymentQueryDto_H
#define OAICashPaymentQueryDto_H
...
class OAICashPaymentQueryDto : public OAIObject {
public:
    OAICashPaymentQueryDto();
    OAICashPaymentQueryDto(QString json);
    ~OAICashPaymentQueryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashPaymentQueryDto)

#endif // OAICashPaymentQueryDto_H
