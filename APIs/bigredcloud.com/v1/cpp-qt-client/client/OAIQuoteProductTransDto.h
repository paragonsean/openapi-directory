...
/*
 * OAIQuoteProductTransDto.h
 *
 * 
 */

#ifndef OAIQuoteProductTransDto_H
#define OAIQuoteProductTransDto_H
...
namespace OpenAPI {
class OAIQuoteAcEntriesDto;

class OAIQuoteProductTransDto : public OAIObject {
public:
    OAIQuoteProductTransDto();
    OAIQuoteProductTransDto(QString json);
    ~OAIQuoteProductTransDto() override;
    ...
    QList<OAIQuoteAcEntriesDto> getAcEntries() const;
    void setAcEntries(const QList<OAIQuoteAcEntriesDto> &ac_entries);
...
private:
    ...
    QList<OAIQuoteAcEntriesDto> m_ac_entries;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuoteProductTransDto)

#endif // OAIQuoteProductTransDto_H
