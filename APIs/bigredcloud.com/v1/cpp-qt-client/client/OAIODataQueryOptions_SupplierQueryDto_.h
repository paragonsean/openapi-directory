...
/*
 * OAIODataQueryOptions_SupplierQueryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_SupplierQueryDto__H
#define OAIODataQueryOptions_SupplierQueryDto__H
...
class OAIODataQueryOptions_SupplierQueryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_SupplierQueryDto_();
    OAIODataQueryOptions_SupplierQueryDto_(QString json);
    ~OAIODataQueryOptions_SupplierQueryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_SupplierQueryDto_)

#endif // OAIODataQueryOptions_SupplierQueryDto__H
