...
#ifndef OAISalesEntryDto_H
#define OAISalesEntryDto_H
...
class OAISalesEntryDto : public OAIObject {
public:
    OAISalesEntryDto();
    OAISalesEntryDto(QString json);
    ~OAISalesEntryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesEntryDto)

#endif // OAISalesEntryDto_H
