...
#ifndef OAICashReceiptDto_H
#define OAICashReceiptDto_H
...
class OAICashReceiptDto : public OAIObject {
public:
    OAICashReceiptDto();
    OAICashReceiptDto(QString json);
    ~OAICashReceiptDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashReceiptDto)

#endif // OAICashReceiptDto_H
