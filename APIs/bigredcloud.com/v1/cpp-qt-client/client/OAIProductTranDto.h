...
#ifndef OAIProductTranDto_H
#define OAIProductTranDto_H
...
class OAIProductTranDto : public OAIObject {
public:
    OAIProductTranDto();
    OAIProductTranDto(QString json);
    ~OAIProductTranDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductTranDto)

#endif // OAIProductTranDto_H
