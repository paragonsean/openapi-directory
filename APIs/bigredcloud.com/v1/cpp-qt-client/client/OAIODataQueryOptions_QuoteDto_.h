...
/*
 * OAIODataQueryOptions_QuoteDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_QuoteDto__H
#define OAIODataQueryOptions_QuoteDto__H
...
class OAIODataQueryOptions_QuoteDto_ : public OAIObject {
public:
    OAIODataQueryOptions_QuoteDto_();
    OAIODataQueryOptions_QuoteDto_(QString json);
    ~OAIODataQueryOptions_QuoteDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_QuoteDto_)

#endif // OAIODataQueryOptions_QuoteDto__H
