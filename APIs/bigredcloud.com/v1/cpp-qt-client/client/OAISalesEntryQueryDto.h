...
/*
 * OAISalesEntryQueryDto.h
 *
 * 
 */

#ifndef OAISalesEntryQueryDto_H
#define OAISalesEntryQueryDto_H
...
class OAISalesEntryQueryDto : public OAIObject {
public:
    OAISalesEntryQueryDto();
    OAISalesEntryQueryDto(QString json);
    ~OAISalesEntryQueryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesEntryQueryDto)

#endif // OAISalesEntryQueryDto_H
