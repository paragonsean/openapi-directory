...
/*
 * OAIODataQueryOptions_CompanySettingDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_CompanySettingDto__H
#define OAIODataQueryOptions_CompanySettingDto__H
...
class OAIODataQueryOptions_CompanySettingDto_ : public OAIObject {
public:
    OAIODataQueryOptions_CompanySettingDto_();
    OAIODataQueryOptions_CompanySettingDto_(QString json);
    ~OAIODataQueryOptions_CompanySettingDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_CompanySettingDto_)

#endif // OAIODataQueryOptions_CompanySettingDto__H
