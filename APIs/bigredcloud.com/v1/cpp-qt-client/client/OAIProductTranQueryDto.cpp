...
OAIProductTranQueryDto::OAIProductTranQueryDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProductTranQueryDto::OAIProductTranQueryDto() {
    this->initializeModel();
}

OAIProductTranQueryDto::~OAIProductTranQueryDto() {}

void OAIProductTranQueryDto::initializeModel() {
...
void OAIProductTranQueryDto::fromJson(QString jsonString) {
...
void OAIProductTranQueryDto::fromJsonObject(QJsonObject json) {
...
QString OAIProductTranQueryDto::asJson() const {
...
QJsonObject OAIProductTranQueryDto::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIAcEntryDto> OAIProductTranQueryDto::getAcEntries() const {
    return m_ac_entries;
}
void OAIProductTranQueryDto::setAcEntries(const QList<OAIAcEntryDto> &ac_entries) {
    m_ac_entries = ac_entries;
    m_ac_entries_isSet = true;
}

bool OAIProductTranQueryDto::is_ac_entries_Set() const{
    return m_ac_entries_isSet;
}

bool OAIProductTranQueryDto::is_ac_entries_Valid() const{
    return m_ac_entries_isValid;
}

double OAIProductTranQueryDto::getAmount() const {
    return m_amount;
}
void OAIProductTranQueryDto::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIProductTranQueryDto::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIProductTranQueryDto::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAIProductTranQueryDto::getAmountNet() const {
    return m_amount_net;
}
void OAIProductTranQueryDto::setAmountNet(const double &amount_net) {
    m_amount_net = amount_net;
    m_amount_net_isSet = true;
}

bool OAIProductTranQueryDto::is_amount_net_Set() const{
    return m_amount_net_isSet;
}

bool OAIProductTranQueryDto::is_amount_net_Valid() const{
    return m_amount_net_isValid;
}

qint64 OAIProductTranQueryDto::getId() const {
    return m_id;
}
void OAIProductTranQueryDto::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProductTranQueryDto::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProductTranQueryDto::is_id_Valid() const{
    return m_id_isValid;
}

double OAIProductTranQueryDto::getPercentage() const {
    return m_percentage;
}
void OAIProductTranQueryDto::setPercentage(const double &percentage) {
    m_percentage = percentage;
    m_percentage_isSet = true;
}

bool OAIProductTranQueryDto::is_percentage_Set() const{
    return m_percentage_isSet;
}

bool OAIProductTranQueryDto::is_percentage_Valid() const{
    return m_percentage_isValid;
}

QString OAIProductTranQueryDto::getProductCode() const {
    return m_product_code;
}
void OAIProductTranQueryDto::setProductCode(const QString &product_code) {
    m_product_code = product_code;
    m_product_code_isSet = true;
}

bool OAIProductTranQueryDto::is_product_code_Set() const{
    return m_product_code_isSet;
}

bool OAIProductTranQueryDto::is_product_code_Valid() const{
    return m_product_code_isValid;
}

qint64 OAIProductTranQueryDto::getProductId() const {
    return m_product_id;
}
void OAIProductTranQueryDto::setProductId(const qint64 &product_id) {
    m_product_id = product_id;
    m_product_id_isSet = true;
}

bool OAIProductTranQueryDto::is_product_id_Set() const{
    return m_product_id_isSet;
}

bool OAIProductTranQueryDto::is_product_id_Valid() const{
    return m_product_id_isValid;
}

double OAIProductTranQueryDto::getQuantity() const {
    return m_quantity;
}
void OAIProductTranQueryDto::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIProductTranQueryDto::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIProductTranQueryDto::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QList<QString> OAIProductTranQueryDto::getTranNotes() const {
    return m_tran_notes;
}
void OAIProductTranQueryDto::setTranNotes(const QList<QString> &tran_notes) {
    m_tran_notes = tran_notes;
    m_tran_notes_isSet = true;
}

bool OAIProductTranQueryDto::is_tran_notes_Set() const{
    return m_tran_notes_isSet;
}

bool OAIProductTranQueryDto::is_tran_notes_Valid() const{
    return m_tran_notes_isValid;
}

double OAIProductTranQueryDto::getUnitPrice() const {
    return m_unit_price;
}
void OAIProductTranQueryDto::setUnitPrice(const double &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAIProductTranQueryDto::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAIProductTranQueryDto::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

double OAIProductTranQueryDto::getVat() const {
    return m_vat;
}
void OAIProductTranQueryDto::setVat(const double &vat) {
    m_vat = vat;
    m_vat_isSet = true;
}

bool OAIProductTranQueryDto::is_vat_Set() const{
    return m_vat_isSet;
}

bool OAIProductTranQueryDto::is_vat_Valid() const{
    return m_vat_isValid;
}

qint64 OAIProductTranQueryDto::getVatAnalysisTypeId() const {
    return m_vat_analysis_type_id;
}
void OAIProductTranQueryDto::setVatAnalysisTypeId(const qint64 &vat_analysis_type_id) {
    m_vat_analysis_type_id = vat_analysis_type_id;
    m_vat_analysis_type_id_isSet = true;
}

bool OAIProductTranQueryDto::is_vat_analysis_type_id_Set() const{
    return m_vat_analysis_type_id_isSet;
}

bool OAIProductTranQueryDto::is_vat_analysis_type_id_Valid() const{
    return m_vat_analysis_type_id_isValid;
}

qint64 OAIProductTranQueryDto::getVatRateId() const {
    return m_vat_rate_id;
}
void OAIProductTranQueryDto::setVatRateId(const qint64 &vat_rate_id) {
    m_vat_rate_id = vat_rate_id;
    m_vat_rate_id_isSet = true;
}

bool OAIProductTranQueryDto::is_vat_rate_id_Set() const{
    return m_vat_rate_id_isSet;
}

bool OAIProductTranQueryDto::is_vat_rate_id_Valid() const{
    return m_vat_rate_id_isValid;
}

bool OAIProductTranQueryDto::isSet() const {
...
bool OAIProductTranQueryDto::isValid() const {
