...
/*
 * OAICompanyOptionViewModel.h
 *
 * 
 */

#ifndef OAICompanyOptionViewModel_H
#define OAICompanyOptionViewModel_H
...
class OAICompanyOptionViewModel : public OAIObject {
public:
    OAICompanyOptionViewModel();
    OAICompanyOptionViewModel(QString json);
    ~OAICompanyOptionViewModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyOptionViewModel)

#endif // OAICompanyOptionViewModel_H
