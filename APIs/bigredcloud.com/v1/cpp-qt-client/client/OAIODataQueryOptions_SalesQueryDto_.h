...
/*
 * OAIODataQueryOptions_SalesQueryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_SalesQueryDto__H
#define OAIODataQueryOptions_SalesQueryDto__H
...
class OAIODataQueryOptions_SalesQueryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_SalesQueryDto_();
    OAIODataQueryOptions_SalesQueryDto_(QString json);
    ~OAIODataQueryOptions_SalesQueryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_SalesQueryDto_)

#endif // OAIODataQueryOptions_SalesQueryDto__H
