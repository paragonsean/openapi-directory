...
/*
 * OAISalesCreditNoteQueryDto.h
 *
 * 
 */

#ifndef OAISalesCreditNoteQueryDto_H
#define OAISalesCreditNoteQueryDto_H
...
class OAISalesCreditNoteQueryDto : public OAIObject {
public:
    OAISalesCreditNoteQueryDto();
    OAISalesCreditNoteQueryDto(QString json);
    ~OAISalesCreditNoteQueryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesCreditNoteQueryDto)

#endif // OAISalesCreditNoteQueryDto_H
