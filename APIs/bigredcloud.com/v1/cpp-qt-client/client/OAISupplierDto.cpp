...
QString OAISupplierDto::getAccountName() const {
    return m_account_name;
}
void OAISupplierDto::setAccountName(const QString &account_name) {
    m_account_name = account_name;
    m_account_name_isSet = true;
}

bool OAISupplierDto::is_account_name_Set() const{
    return m_account_name_isSet;
}

bool OAISupplierDto::is_account_name_Valid() const{
    return m_account_name_isValid;
}

QString OAISupplierDto::getAccountNumber() const {
    return m_account_number;
}
void OAISupplierDto::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAISupplierDto::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAISupplierDto::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QList<QString> OAISupplierDto::getAdditionalEmails() const {
    return m_additional_emails;
}
void OAISupplierDto::setAdditionalEmails(const QList<QString> &additional_emails) {
    m_additional_emails = additional_emails;
    m_additional_emails_isSet = true;
}

bool OAISupplierDto::is_additional_emails_Set() const{
    return m_additional_emails_isSet;
}

bool OAISupplierDto::is_additional_emails_Valid() const{
    return m_additional_emails_isValid;
}

QList<QString> OAISupplierDto::getAddress() const {
    return m_address;
}
void OAISupplierDto::setAddress(const QList<QString> &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAISupplierDto::is_address_Set() const{
    return m_address_isSet;
}

bool OAISupplierDto::is_address_Valid() const{
    return m_address_isValid;
}

QString OAISupplierDto::getAuthCode() const {
    return m_auth_code;
}
void OAISupplierDto::setAuthCode(const QString &auth_code) {
    m_auth_code = auth_code;
    m_auth_code_isSet = true;
}

bool OAISupplierDto::is_auth_code_Set() const{
    return m_auth_code_isSet;
}

bool OAISupplierDto::is_auth_code_Valid() const{
    return m_auth_code_isValid;
}

OAIEFTBankDto OAISupplierDto::getBank() const {
    return m_bank;
}
void OAISupplierDto::setBank(const OAIEFTBankDto &bank) {
    m_bank = bank;
    m_bank_isSet = true;
}

bool OAISupplierDto::is_bank_Set() const{
    return m_bank_isSet;
}

bool OAISupplierDto::is_bank_Valid() const{
    return m_bank_isValid;
}

QString OAISupplierDto::getBusinessIdentifierCode() const {
    return m_business_identifier_code;
}
void OAISupplierDto::setBusinessIdentifierCode(const QString &business_identifier_code) {
    m_business_identifier_code = business_identifier_code;
    m_business_identifier_code_isSet = true;
}

bool OAISupplierDto::is_business_identifier_code_Set() const{
    return m_business_identifier_code_isSet;
}

bool OAISupplierDto::is_business_identifier_code_Valid() const{
    return m_business_identifier_code_isValid;
}

QString OAISupplierDto::getCode() const {
    return m_code;
}
void OAISupplierDto::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAISupplierDto::is_code_Set() const{
    return m_code_isSet;
}

bool OAISupplierDto::is_code_Valid() const{
    return m_code_isValid;
}

QString OAISupplierDto::getContact() const {
    return m_contact;
}
void OAISupplierDto::setContact(const QString &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAISupplierDto::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAISupplierDto::is_contact_Valid() const{
    return m_contact_isValid;
}

QString OAISupplierDto::getEFtReference() const {
    return m_e_ft_reference;
}
void OAISupplierDto::setEFtReference(const QString &e_ft_reference) {
    m_e_ft_reference = e_ft_reference;
    m_e_ft_reference_isSet = true;
}

bool OAISupplierDto::is_e_ft_reference_Set() const{
    return m_e_ft_reference_isSet;
}

bool OAISupplierDto::is_e_ft_reference_Valid() const{
    return m_e_ft_reference_isValid;
}

QString OAISupplierDto::getEmail() const {
    return m_email;
}
void OAISupplierDto::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAISupplierDto::is_email_Set() const{
    return m_email_isSet;
}

bool OAISupplierDto::is_email_Valid() const{
    return m_email_isValid;
}

QString OAISupplierDto::getFax() const {
    return m_fax;
}
void OAISupplierDto::setFax(const QString &fax) {
    m_fax = fax;
    m_fax_isSet = true;
}

bool OAISupplierDto::is_fax_Set() const{
    return m_fax_isSet;
}

bool OAISupplierDto::is_fax_Valid() const{
    return m_fax_isValid;
}

qint64 OAISupplierDto::getId() const {
    return m_id;
}
void OAISupplierDto::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAISupplierDto::getInternationalBankAccountNumber() const {
    return m_international_bank_account_number;
}
void OAISupplierDto::setInternationalBankAccountNumber(const QString &international_bank_account_number) {
    m_international_bank_account_number = international_bank_account_number;
    m_international_bank_account_number_isSet = true;
}

bool OAISupplierDto::is_international_bank_account_number_Set() const{
    return m_international_bank_account_number_isSet;
}

bool OAISupplierDto::is_international_bank_account_number_Valid() const{
    return m_international_bank_account_number_isValid;
}

double OAISupplierDto::getLedgerBalance() const {
    return m_ledger_balance;
}
void OAISupplierDto::setLedgerBalance(const double &ledger_balance) {
    m_ledger_balance = ledger_balance;
    m_ledger_balance_isSet = true;
}

bool OAISupplierDto::is_ledger_balance_Set() const{
    return m_ledger_balance_isSet;
}

bool OAISupplierDto::is_ledger_balance_Valid() const{
    return m_ledger_balance_isValid;
}

QString OAISupplierDto::getMobile() const {
    return m_mobile;
}
void OAISupplierDto::setMobile(const QString &mobile) {
    m_mobile = mobile;
    m_mobile_isSet = true;
}

bool OAISupplierDto::is_mobile_Set() const{
    return m_mobile_isSet;
}

bool OAISupplierDto::is_mobile_Valid() const{
...
OAIOwnerOpeningBalanceInPeriodsDto OAISupplierDto::getOpeningBalance() const {
    return m_opening_balance;
}
void OAISupplierDto::setOpeningBalance(const OAIOwnerOpeningBalanceInPeriodsDto &opening_balance) {
    m_opening_balance = opening_balance;
    m_opening_balance_isSet = true;
}

bool OAISupplierDto::is_opening_balance_Set() const{
    return m_opening_balance_isSet;
}

bool OAISupplierDto::is_opening_balance_Valid() const{
    return m_opening_balance_isValid;
}

QList<OAIOwnerOpeningBalanceDto> OAISupplierDto::getOpeningBalances() const {
    return m_opening_balances;
}
void OAISupplierDto::setOpeningBalances(const QList<OAIOwnerOpeningBalanceDto> &opening_balances) {
    m_opening_balances = opening_balances;
    m_opening_balances_isSet = true;
}

bool OAISupplierDto::is_opening_balances_Set() const{
    return m_opening_balances_isSet;
}

bool OAISupplierDto::is_opening_balances_Valid() const{
    return m_opening_balances_isValid;
}

QString OAISupplierDto::getOurCode() const {
    return m_our_code;
}
void OAISupplierDto::setOurCode(const QString &our_code) {
    m_our_code = our_code;
    m_our_code_isSet = true;
}

bool OAISupplierDto::is_our_code_Set() const{
    return m_our_code_isSet;
}

bool OAISupplierDto::is_our_code_Valid() const{
    return m_our_code_isValid;
}

qint64 OAISupplierDto::getOwnerTypeId() const {
    return m_owner_type_id;
}
void OAISupplierDto::setOwnerTypeId(const qint64 &owner_type_id) {
    m_owner_type_id = owner_type_id;
    m_owner_type_id_isSet = true;
}

bool OAISupplierDto::is_owner_type_id_Set() const{
    return m_owner_type_id_isSet;
}

bool OAISupplierDto::is_owner_type_id_Valid() const{
    return m_owner_type_id_isValid;
}

QString OAISupplierDto::getPhone() const {
    return m_phone;
}
void OAISupplierDto::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAISupplierDto::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAISupplierDto::is_phone_Valid() const{
    return m_phone_isValid;
}

bool OAISupplierDto::isPostponedAccounting() const {
    return m_postponed_accounting;
}
void OAISupplierDto::setPostponedAccounting(const bool &postponed_accounting) {
    m_postponed_accounting = postponed_accounting;
    m_postponed_accounting_isSet = true;
}

bool OAISupplierDto::is_postponed_accounting_Set() const{
    return m_postponed_accounting_isSet;
}

bool OAISupplierDto::is_postponed_accounting_Valid() const{
    return m_postponed_accounting_isValid;
}

QByteArray OAISupplierDto::getTimestamp() const {
    return m_timestamp;
}
void OAISupplierDto::setTimestamp(const QByteArray &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAISupplierDto::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAISupplierDto::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

qint64 OAISupplierDto::getVatAnalysisTypeId() const {
    return m_vat_analysis_type_id;
}
void OAISupplierDto::setVatAnalysisTypeId(const qint64 &vat_analysis_type_id) {
    m_vat_analysis_type_id = vat_analysis_type_id;
    m_vat_analysis_type_id_isSet = true;
}

bool OAISupplierDto::is_vat_analysis_type_id_Set() const{
    return m_vat_analysis_type_id_isSet;
}

bool OAISupplierDto::is_vat_analysis_type_id_Valid() const{
    return m_vat_analysis_type_id_isValid;
}

QString OAISupplierDto::getVatReg() const {
    return m_vat_reg;
}
void OAISupplierDto::setVatReg(const QString &vat_reg) {
    m_vat_reg = vat_reg;
    m_vat_reg_isSet = true;
}

bool OAISupplierDto::is_vat_reg_Set() const{
    return m_vat_reg_isSet;
}

bool OAISupplierDto::is_vat_reg_Valid() const{
    return m_vat_reg_isValid;
}

qint64 OAISupplierDto::getVatType() const {
    return m_vat_type;
}
void OAISupplierDto::setVatType(const qint64 &vat_type) {
    m_vat_type = vat_type;
    m_vat_type_isSet = true;
}

bool OAISupplierDto::is_vat_type_Set() const{
    return m_vat_type_isSet;
}

bool OAISupplierDto::is_vat_type_Valid() const{
