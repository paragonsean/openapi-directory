...
/*
 * OAIODataQueryOptions_CustomerQueryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_CustomerQueryDto__H
#define OAIODataQueryOptions_CustomerQueryDto__H
...
class OAIODataQueryOptions_CustomerQueryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_CustomerQueryDto_();
    OAIODataQueryOptions_CustomerQueryDto_(QString json);
    ~OAIODataQueryOptions_CustomerQueryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_CustomerQueryDto_)

#endif // OAIODataQueryOptions_CustomerQueryDto__H
