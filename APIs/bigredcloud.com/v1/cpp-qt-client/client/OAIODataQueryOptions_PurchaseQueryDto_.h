...
/*
 * OAIODataQueryOptions_PurchaseQueryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_PurchaseQueryDto__H
#define OAIODataQueryOptions_PurchaseQueryDto__H
...
class OAIODataQueryOptions_PurchaseQueryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_PurchaseQueryDto_();
    OAIODataQueryOptions_PurchaseQueryDto_(QString json);
    ~OAIODataQueryOptions_PurchaseQueryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_PurchaseQueryDto_)

#endif // OAIODataQueryOptions_PurchaseQueryDto__H
