...
OAICashReceiptQueryDto::OAICashReceiptQueryDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICashReceiptQueryDto::OAICashReceiptQueryDto() {
    this->initializeModel();
}

OAICashReceiptQueryDto::~OAICashReceiptQueryDto() {}

void OAICashReceiptQueryDto::initializeModel() {
...
void OAICashReceiptQueryDto::fromJson(QString jsonString) {
...
void OAICashReceiptQueryDto::fromJsonObject(QJsonObject json) {
...
QString OAICashReceiptQueryDto::asJson() const {
...
QJsonObject OAICashReceiptQueryDto::asJsonObject() const {
    QJsonObject obj;
    if (m_ac_code_isSet) {
...
QString OAICashReceiptQueryDto::getAcCode() const {
    return m_ac_code;
}
void OAICashReceiptQueryDto::setAcCode(const QString &ac_code) {
    m_ac_code = ac_code;
    m_ac_code_isSet = true;
}

bool OAICashReceiptQueryDto::is_ac_code_Set() const{
    return m_ac_code_isSet;
}

bool OAICashReceiptQueryDto::is_ac_code_Valid() const{
    return m_ac_code_isValid;
}

QList<OAIAcEntryDto> OAICashReceiptQueryDto::getAcEntries() const {
    return m_ac_entries;
}
void OAICashReceiptQueryDto::setAcEntries(const QList<OAIAcEntryDto> &ac_entries) {
    m_ac_entries = ac_entries;
    m_ac_entries_isSet = true;
}

bool OAICashReceiptQueryDto::is_ac_entries_Set() const{
    return m_ac_entries_isSet;
}

bool OAICashReceiptQueryDto::is_ac_entries_Valid() const{
    return m_ac_entries_isValid;
}

qint64 OAICashReceiptQueryDto::getBookTranTypeId() const {
    return m_book_tran_type_id;
}
void OAICashReceiptQueryDto::setBookTranTypeId(const qint64 &book_tran_type_id) {
    m_book_tran_type_id = book_tran_type_id;
    m_book_tran_type_id_isSet = true;
}

bool OAICashReceiptQueryDto::is_book_tran_type_id_Set() const{
    return m_book_tran_type_id_isSet;
}

bool OAICashReceiptQueryDto::is_book_tran_type_id_Valid() const{
    return m_book_tran_type_id_isValid;
}

QList<OAIAcudfValueDto> OAICashReceiptQueryDto::getCustomFields() const {
    return m_custom_fields;
}
void OAICashReceiptQueryDto::setCustomFields(const QList<OAIAcudfValueDto> &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAICashReceiptQueryDto::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAICashReceiptQueryDto::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

qint64 OAICashReceiptQueryDto::getCustomerId() const {
    return m_customer_id;
}
void OAICashReceiptQueryDto::setCustomerId(const qint64 &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAICashReceiptQueryDto::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAICashReceiptQueryDto::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QList<QString> OAICashReceiptQueryDto::getDetailCollection() const {
    return m_detail_collection;
}
void OAICashReceiptQueryDto::setDetailCollection(const QList<QString> &detail_collection) {
    m_detail_collection = detail_collection;
    m_detail_collection_isSet = true;
}

bool OAICashReceiptQueryDto::is_detail_collection_Set() const{
    return m_detail_collection_isSet;
}

bool OAICashReceiptQueryDto::is_detail_collection_Valid() const{
    return m_detail_collection_isValid;
}

double OAICashReceiptQueryDto::getDiscount() const {
    return m_discount;
}
void OAICashReceiptQueryDto::setDiscount(const double &discount) {
    m_discount = discount;
    m_discount_isSet = true;
}

bool OAICashReceiptQueryDto::is_discount_Set() const{
    return m_discount_isSet;
}

bool OAICashReceiptQueryDto::is_discount_Valid() const{
    return m_discount_isValid;
}

QDateTime OAICashReceiptQueryDto::getEntryDate() const {
    return m_entry_date;
}
void OAICashReceiptQueryDto::setEntryDate(const QDateTime &entry_date) {
    m_entry_date = entry_date;
    m_entry_date_isSet = true;
}

bool OAICashReceiptQueryDto::is_entry_date_Set() const{
    return m_entry_date_isSet;
}

bool OAICashReceiptQueryDto::is_entry_date_Valid() const{
    return m_entry_date_isValid;
}

qint64 OAICashReceiptQueryDto::getId() const {
    return m_id;
}
void OAICashReceiptQueryDto::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICashReceiptQueryDto::is_id_Set() const{
    return m_id_isSet;
}

bool OAICashReceiptQueryDto::is_id_Valid() const{
    return m_id_isValid;
}

double OAICashReceiptQueryDto::getLedger() const {
    return m_ledger;
}
void OAICashReceiptQueryDto::setLedger(const double &ledger) {
    m_ledger = ledger;
    m_ledger_isSet = true;
}

bool OAICashReceiptQueryDto::is_ledger_Set() const{
    return m_ledger_isSet;
}

bool OAICashReceiptQueryDto::is_ledger_Valid() const{
    return m_ledger_isValid;
}

QString OAICashReceiptQueryDto::getNote() const {
    return m_note;
}
void OAICashReceiptQueryDto::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAICashReceiptQueryDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAICashReceiptQueryDto::is_note_Valid() const{
    return m_note_isValid;
}

QString OAICashReceiptQueryDto::getPlaidTransactionId() const {
    return m_plaid_transaction_id;
}
void OAICashReceiptQueryDto::setPlaidTransactionId(const QString &plaid_transaction_id) {
    m_plaid_transaction_id = plaid_transaction_id;
    m_plaid_transaction_id_isSet = true;
}

bool OAICashReceiptQueryDto::is_plaid_transaction_id_Set() const{
    return m_plaid_transaction_id_isSet;
}

bool OAICashReceiptQueryDto::is_plaid_transaction_id_Valid() const{
    return m_plaid_transaction_id_isValid;
}

QDateTime OAICashReceiptQueryDto::getProcDate() const {
    return m_proc_date;
}
void OAICashReceiptQueryDto::setProcDate(const QDateTime &proc_date) {
    m_proc_date = proc_date;
    m_proc_date_isSet = true;
}

bool OAICashReceiptQueryDto::is_proc_date_Set() const{
    return m_proc_date_isSet;
}

bool OAICashReceiptQueryDto::is_proc_date_Valid() const{
    return m_proc_date_isValid;
}

QByteArray OAICashReceiptQueryDto::getTimestamp() const {
    return m_timestamp;
}
void OAICashReceiptQueryDto::setTimestamp(const QByteArray &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAICashReceiptQueryDto::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAICashReceiptQueryDto::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

double OAICashReceiptQueryDto::getTotal() const {
    return m_total;
}
void OAICashReceiptQueryDto::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAICashReceiptQueryDto::is_total_Set() const{
    return m_total_isSet;
}

bool OAICashReceiptQueryDto::is_total_Valid() const{
    return m_total_isValid;
}

double OAICashReceiptQueryDto::getUnallocated() const {
    return m_unallocated;
}
void OAICashReceiptQueryDto::setUnallocated(const double &unallocated) {
    m_unallocated = unallocated;
    m_unallocated_isSet = true;
}

bool OAICashReceiptQueryDto::is_unallocated_Set() const{
    return m_unallocated_isSet;
}

bool OAICashReceiptQueryDto::is_unallocated_Valid() const{
    return m_unallocated_isValid;
}

QList<OAIVatEntryDto> OAICashReceiptQueryDto::getVatEntries() const {
    return m_vat_entries;
}
void OAICashReceiptQueryDto::setVatEntries(const QList<OAIVatEntryDto> &vat_entries) {
    m_vat_entries = vat_entries;
    m_vat_entries_isSet = true;
}

bool OAICashReceiptQueryDto::is_vat_entries_Set() const{
    return m_vat_entries_isSet;
}

bool OAICashReceiptQueryDto::is_vat_entries_Valid() const{
    return m_vat_entries_isValid;
}

qint64 OAICashReceiptQueryDto::getVatTypeId() const {
    return m_vat_type_id;
}
void OAICashReceiptQueryDto::setVatTypeId(const qint64 &vat_type_id) {
    m_vat_type_id = vat_type_id;
    m_vat_type_id_isSet = true;
}

bool OAICashReceiptQueryDto::is_vat_type_id_Set() const{
    return m_vat_type_id_isSet;
}

bool OAICashReceiptQueryDto::is_vat_type_id_Valid() const{
    return m_vat_type_id_isValid;
}

bool OAICashReceiptQueryDto::isSet() const {
...
bool OAICashReceiptQueryDto::isValid() const {
