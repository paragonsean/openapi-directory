...
OAISalesEntryDto::OAISalesEntryDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISalesEntryDto::OAISalesEntryDto() {
    this->initializeModel();
}

OAISalesEntryDto::~OAISalesEntryDto() {}

void OAISalesEntryDto::initializeModel() {
...
void OAISalesEntryDto::fromJson(QString jsonString) {
...
void OAISalesEntryDto::fromJsonObject(QJsonObject json) {
...
QString OAISalesEntryDto::asJson() const {
...
QJsonObject OAISalesEntryDto::asJsonObject() const {
    QJsonObject obj;
    if (m_ac_code_isSet) {
...
QString OAISalesEntryDto::getAcCode() const {
    return m_ac_code;
}
void OAISalesEntryDto::setAcCode(const QString &ac_code) {
    m_ac_code = ac_code;
    m_ac_code_isSet = true;
}

bool OAISalesEntryDto::is_ac_code_Set() const{
    return m_ac_code_isSet;
}

bool OAISalesEntryDto::is_ac_code_Valid() const{
    return m_ac_code_isValid;
}

QList<OAIAcEntryDto> OAISalesEntryDto::getAcEntries() const {
    return m_ac_entries;
}
void OAISalesEntryDto::setAcEntries(const QList<OAIAcEntryDto> &ac_entries) {
    m_ac_entries = ac_entries;
    m_ac_entries_isSet = true;
}

bool OAISalesEntryDto::is_ac_entries_Set() const{
    return m_ac_entries_isSet;
}

bool OAISalesEntryDto::is_ac_entries_Valid() const{
    return m_ac_entries_isValid;
}

qint64 OAISalesEntryDto::getBookTranTypeId() const {
    return m_book_tran_type_id;
}
void OAISalesEntryDto::setBookTranTypeId(const qint64 &book_tran_type_id) {
    m_book_tran_type_id = book_tran_type_id;
    m_book_tran_type_id_isSet = true;
}

bool OAISalesEntryDto::is_book_tran_type_id_Set() const{
    return m_book_tran_type_id_isSet;
}

bool OAISalesEntryDto::is_book_tran_type_id_Valid() const{
    return m_book_tran_type_id_isValid;
}

QList<OAIAcudfValueDto> OAISalesEntryDto::getCustomFields() const {
    return m_custom_fields;
}
void OAISalesEntryDto::setCustomFields(const QList<OAIAcudfValueDto> &custom_fields) {
    m_custom_fields = custom_fields;
    m_custom_fields_isSet = true;
}

bool OAISalesEntryDto::is_custom_fields_Set() const{
    return m_custom_fields_isSet;
}

bool OAISalesEntryDto::is_custom_fields_Valid() const{
    return m_custom_fields_isValid;
}

qint64 OAISalesEntryDto::getCustomerId() const {
    return m_customer_id;
}
void OAISalesEntryDto::setCustomerId(const qint64 &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAISalesEntryDto::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAISalesEntryDto::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

QList<QString> OAISalesEntryDto::getDetailCollection() const {
    return m_detail_collection;
}
void OAISalesEntryDto::setDetailCollection(const QList<QString> &detail_collection) {
    m_detail_collection = detail_collection;
    m_detail_collection_isSet = true;
}

bool OAISalesEntryDto::is_detail_collection_Set() const{
    return m_detail_collection_isSet;
}

bool OAISalesEntryDto::is_detail_collection_Valid() const{
    return m_detail_collection_isValid;
}

QString OAISalesEntryDto::getDetails() const {
    return m_details;
}
void OAISalesEntryDto::setDetails(const QString &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAISalesEntryDto::is_details_Set() const{
    return m_details_isSet;
}

bool OAISalesEntryDto::is_details_Valid() const{
    return m_details_isValid;
}

QDateTime OAISalesEntryDto::getEntryDate() const {
    return m_entry_date;
}
void OAISalesEntryDto::setEntryDate(const QDateTime &entry_date) {
    m_entry_date = entry_date;
    m_entry_date_isSet = true;
}

bool OAISalesEntryDto::is_entry_date_Set() const{
    return m_entry_date_isSet;
}

bool OAISalesEntryDto::is_entry_date_Valid() const{
    return m_entry_date_isValid;
}

qint64 OAISalesEntryDto::getId() const {
    return m_id;
}
void OAISalesEntryDto::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISalesEntryDto::is_id_Set() const{
    return m_id_isSet;
}

bool OAISalesEntryDto::is_id_Valid() const{
    return m_id_isValid;
}

double OAISalesEntryDto::getNetGoods() const {
    return m_net_goods;
}
void OAISalesEntryDto::setNetGoods(const double &net_goods) {
    m_net_goods = net_goods;
    m_net_goods_isSet = true;
}

bool OAISalesEntryDto::is_net_goods_Set() const{
    return m_net_goods_isSet;
}

bool OAISalesEntryDto::is_net_goods_Valid() const{
    return m_net_goods_isValid;
}

double OAISalesEntryDto::getNetServices() const {
    return m_net_services;
}
void OAISalesEntryDto::setNetServices(const double &net_services) {
    m_net_services = net_services;
    m_net_services_isSet = true;
}

bool OAISalesEntryDto::is_net_services_Set() const{
    return m_net_services_isSet;
}

bool OAISalesEntryDto::is_net_services_Valid() const{
    return m_net_services_isValid;
}

QString OAISalesEntryDto::getNote() const {
    return m_note;
}
void OAISalesEntryDto::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAISalesEntryDto::is_note_Set() const{
    return m_note_isSet;
}

bool OAISalesEntryDto::is_note_Valid() const{
    return m_note_isValid;
}

QDateTime OAISalesEntryDto::getProcDate() const {
    return m_proc_date;
}
void OAISalesEntryDto::setProcDate(const QDateTime &proc_date) {
    m_proc_date = proc_date;
    m_proc_date_isSet = true;
}

bool OAISalesEntryDto::is_proc_date_Set() const{
    return m_proc_date_isSet;
}

bool OAISalesEntryDto::is_proc_date_Valid() const{
    return m_proc_date_isValid;
}

QString OAISalesEntryDto::getReference() const {
    return m_reference;
}
void OAISalesEntryDto::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAISalesEntryDto::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAISalesEntryDto::is_reference_Valid() const{
    return m_reference_isValid;
}

QByteArray OAISalesEntryDto::getTimestamp() const {
    return m_timestamp;
}
void OAISalesEntryDto::setTimestamp(const QByteArray &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAISalesEntryDto::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAISalesEntryDto::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

double OAISalesEntryDto::getTotal() const {
    return m_total;
}
void OAISalesEntryDto::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAISalesEntryDto::is_total_Set() const{
    return m_total_isSet;
}

bool OAISalesEntryDto::is_total_Valid() const{
    return m_total_isValid;
}

double OAISalesEntryDto::getTotalNet() const {
    return m_total_net;
}
void OAISalesEntryDto::setTotalNet(const double &total_net) {
    m_total_net = total_net;
    m_total_net_isSet = true;
}

bool OAISalesEntryDto::is_total_net_Set() const{
    return m_total_net_isSet;
}

bool OAISalesEntryDto::is_total_net_Valid() const{
    return m_total_net_isValid;
}

double OAISalesEntryDto::getTotalVat() const {
    return m_total_vat;
}
void OAISalesEntryDto::setTotalVat(const double &total_vat) {
    m_total_vat = total_vat;
    m_total_vat_isSet = true;
}

bool OAISalesEntryDto::is_total_vat_Set() const{
    return m_total_vat_isSet;
}

bool OAISalesEntryDto::is_total_vat_Valid() const{
    return m_total_vat_isValid;
}

double OAISalesEntryDto::getUnpaid() const {
    return m_unpaid;
}
void OAISalesEntryDto::setUnpaid(const double &unpaid) {
    m_unpaid = unpaid;
    m_unpaid_isSet = true;
}

bool OAISalesEntryDto::is_unpaid_Set() const{
    return m_unpaid_isSet;
}

bool OAISalesEntryDto::is_unpaid_Valid() const{
    return m_unpaid_isValid;
}

QList<OAIVatEntryDto> OAISalesEntryDto::getVatEntries() const {
    return m_vat_entries;
}
void OAISalesEntryDto::setVatEntries(const QList<OAIVatEntryDto> &vat_entries) {
    m_vat_entries = vat_entries;
    m_vat_entries_isSet = true;
}

bool OAISalesEntryDto::is_vat_entries_Set() const{
    return m_vat_entries_isSet;
}

bool OAISalesEntryDto::is_vat_entries_Valid() const{
    return m_vat_entries_isValid;
}

qint64 OAISalesEntryDto::getVatTypeId() const {
    return m_vat_type_id;
}
void OAISalesEntryDto::setVatTypeId(const qint64 &vat_type_id) {
    m_vat_type_id = vat_type_id;
    m_vat_type_id_isSet = true;
}

bool OAISalesEntryDto::is_vat_type_id_Set() const{
    return m_vat_type_id_isSet;
}

bool OAISalesEntryDto::is_vat_type_id_Valid() const{
    return m_vat_type_id_isValid;
}

bool OAISalesEntryDto::isSet() const {
...
bool OAISalesEntryDto::isValid() const {
