...
/*
 * OAISupplierQueryDto.h
 *
 * 
 */

#ifndef OAISupplierQueryDto_H
#define OAISupplierQueryDto_H
...
class OAISupplierQueryDto : public OAIObject {
public:
    OAISupplierQueryDto();
    OAISupplierQueryDto(QString json);
    ~OAISupplierQueryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplierQueryDto)

#endif // OAISupplierQueryDto_H
