...
/*
 * OAIODataQueryOptions_PaymentQueryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_PaymentQueryDto__H
#define OAIODataQueryOptions_PaymentQueryDto__H
...
class OAIODataQueryOptions_PaymentQueryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_PaymentQueryDto_();
    OAIODataQueryOptions_PaymentQueryDto_(QString json);
    ~OAIODataQueryOptions_PaymentQueryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_PaymentQueryDto_)

#endif // OAIODataQueryOptions_PaymentQueryDto__H
