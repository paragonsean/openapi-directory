...
/*
 * OAIODataQueryOptions_SaleRepsDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_SaleRepsDto__H
#define OAIODataQueryOptions_SaleRepsDto__H
...
class OAIODataQueryOptions_SaleRepsDto_ : public OAIObject {
public:
    OAIODataQueryOptions_SaleRepsDto_();
    OAIODataQueryOptions_SaleRepsDto_(QString json);
    ~OAIODataQueryOptions_SaleRepsDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_SaleRepsDto_)

#endif // OAIODataQueryOptions_SaleRepsDto__H
