...
/*
 * OAIODataQueryOptions_VatCategoryDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_VatCategoryDto__H
#define OAIODataQueryOptions_VatCategoryDto__H
...
class OAIODataQueryOptions_VatCategoryDto_ : public OAIObject {
public:
    OAIODataQueryOptions_VatCategoryDto_();
    OAIODataQueryOptions_VatCategoryDto_(QString json);
    ~OAIODataQueryOptions_VatCategoryDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_VatCategoryDto_)

#endif // OAIODataQueryOptions_VatCategoryDto__H
