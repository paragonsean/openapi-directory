...
#ifndef OAITopQueryOption_H
#define OAITopQueryOption_H
...
class OAITopQueryOption : public OAIObject {
public:
    OAITopQueryOption();
    OAITopQueryOption(QString json);
    ~OAITopQueryOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITopQueryOption)

#endif // OAITopQueryOption_H
