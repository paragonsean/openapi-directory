...
/*
 * OAIODataQueryOptions_VatTypeDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_VatTypeDto__H
#define OAIODataQueryOptions_VatTypeDto__H
...
class OAIODataQueryOptions_VatTypeDto_ : public OAIObject {
public:
    OAIODataQueryOptions_VatTypeDto_();
    OAIODataQueryOptions_VatTypeDto_(QString json);
    ~OAIODataQueryOptions_VatTypeDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_VatTypeDto_)

#endif // OAIODataQueryOptions_VatTypeDto__H
