...
/*
 * OAIODataQueryOptions_OwnerTypeGroupDto_.h
 *
 * 
 */

#ifndef OAIODataQueryOptions_OwnerTypeGroupDto__H
#define OAIODataQueryOptions_OwnerTypeGroupDto__H
...
class OAIODataQueryOptions_OwnerTypeGroupDto_ : public OAIObject {
public:
    OAIODataQueryOptions_OwnerTypeGroupDto_();
    OAIODataQueryOptions_OwnerTypeGroupDto_(QString json);
    ~OAIODataQueryOptions_OwnerTypeGroupDto_() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIODataQueryOptions_OwnerTypeGroupDto_)

#endif // OAIODataQueryOptions_OwnerTypeGroupDto__H
