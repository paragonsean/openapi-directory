...
/*
 * OAICustomerQueryDto.h
 *
 * 
 */

#ifndef OAICustomerQueryDto_H
#define OAICustomerQueryDto_H
...
class OAICustomerQueryDto : public OAIObject {
public:
    OAICustomerQueryDto();
    OAICustomerQueryDto(QString json);
    ~OAICustomerQueryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerQueryDto)

#endif // OAICustomerQueryDto_H
