...
/*
 * OAICashReceiptQueryDto.h
 *
 * 
 */

#ifndef OAICashReceiptQueryDto_H
#define OAICashReceiptQueryDto_H
...
class OAICashReceiptQueryDto : public OAIObject {
public:
    OAICashReceiptQueryDto();
    OAICashReceiptQueryDto(QString json);
    ~OAICashReceiptQueryDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashReceiptQueryDto)

#endif // OAICashReceiptQueryDto_H
