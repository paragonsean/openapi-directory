...
#ifndef OAICashPaymentDto_H
#define OAICashPaymentDto_H
...
class OAICashPaymentDto : public OAIObject {
public:
    OAICashPaymentDto();
    OAICashPaymentDto(QString json);
    ~OAICashPaymentDto() override;
    ...
    double getLedger() const;
    void setLedger(const double &ledger);
    bool is_ledger_Set() const;
    bool is_ledger_Valid() const;

    double getLodgement() const;
    void setLodgement(const double &lodgement);
    bool is_lodgement_Set() const;
    bool is_lodgement_Valid() const;
...
private:
    ...
    double m_lodgement;
    bool m_lodgement_isSet;
    bool m_lodgement_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashPaymentDto)

#endif // OAICashPaymentDto_H
