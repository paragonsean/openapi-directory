...
#include "OAIBankAccountQueryDto.h"
...
OAIBankAccountQueryDto::OAIBankAccountQueryDto(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBankAccountQueryDto::OAIBankAccountQueryDto() {
    this->initializeModel();
}

OAIBankAccountQueryDto::~OAIBankAccountQueryDto() {}

void OAIBankAccountQueryDto::initializeModel() {
...
void OAIBankAccountQueryDto::fromJson(QString jsonString) {
...
void OAIBankAccountQueryDto::fromJsonObject(QJsonObject json) {
...
QString OAIBankAccountQueryDto::asJson() const {
...
QJsonObject OAIBankAccountQueryDto::asJsonObject() const {
    QJsonObject obj;
    if (m_ac_code_isSet) {
...
QString OAIBankAccountQueryDto::getAcCode() const {
    return m_ac_code;
}
void OAIBankAccountQueryDto::setAcCode(const QString &ac_code) {
    m_ac_code = ac_code;
    m_ac_code_isSet = true;
}

bool OAIBankAccountQueryDto::is_ac_code_Set() const{
    return m_ac_code_isSet;
}

bool OAIBankAccountQueryDto::is_ac_code_Valid() const{
    return m_ac_code_isValid;
}

QString OAIBankAccountQueryDto::getAccountName() const {
    return m_account_name;
}
void OAIBankAccountQueryDto::setAccountName(const QString &account_name) {
    m_account_name = account_name;
    m_account_name_isSet = true;
}

bool OAIBankAccountQueryDto::is_account_name_Set() const{
    return m_account_name_isSet;
}

bool OAIBankAccountQueryDto::is_account_name_Valid() const{
    return m_account_name_isValid;
}

QString OAIBankAccountQueryDto::getAccountNumber() const {
    return m_account_number;
}
void OAIBankAccountQueryDto::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIBankAccountQueryDto::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIBankAccountQueryDto::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QList<QString> OAIBankAccountQueryDto::getAddress() const {
    return m_address;
}
void OAIBankAccountQueryDto::setAddress(const QList<QString> &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIBankAccountQueryDto::is_address_Set() const{
    return m_address_isSet;
}

bool OAIBankAccountQueryDto::is_address_Valid() const{
    return m_address_isValid;
}

qint32 OAIBankAccountQueryDto::getBankFeedSource() const {
    return m_bank_feed_source;
}
void OAIBankAccountQueryDto::setBankFeedSource(const qint32 &bank_feed_source) {
    m_bank_feed_source = bank_feed_source;
    m_bank_feed_source_isSet = true;
}

bool OAIBankAccountQueryDto::is_bank_feed_source_Set() const{
    return m_bank_feed_source_isSet;
}

bool OAIBankAccountQueryDto::is_bank_feed_source_Valid() const{
    return m_bank_feed_source_isValid;
}

QString OAIBankAccountQueryDto::getBusinessIdentifierCodes() const {
    return m_business_identifier_codes;
}
void OAIBankAccountQueryDto::setBusinessIdentifierCodes(const QString &business_identifier_codes) {
    m_business_identifier_codes = business_identifier_codes;
    m_business_identifier_codes_isSet = true;
}

bool OAIBankAccountQueryDto::is_business_identifier_codes_Set() const{
    return m_business_identifier_codes_isSet;
}

bool OAIBankAccountQueryDto::is_business_identifier_codes_Valid() const{
    return m_business_identifier_codes_isValid;
}

qint64 OAIBankAccountQueryDto::getCategoryId() const {
    return m_category_id;
}
void OAIBankAccountQueryDto::setCategoryId(const qint64 &category_id) {
    m_category_id = category_id;
    m_category_id_isSet = true;
}

bool OAIBankAccountQueryDto::is_category_id_Set() const{
    return m_category_id_isSet;
}

bool OAIBankAccountQueryDto::is_category_id_Valid() const{
    return m_category_id_isValid;
}

QString OAIBankAccountQueryDto::getCreditorScheme() const {
    return m_creditor_scheme;
}
void OAIBankAccountQueryDto::setCreditorScheme(const QString &creditor_scheme) {
    m_creditor_scheme = creditor_scheme;
    m_creditor_scheme_isSet = true;
}

bool OAIBankAccountQueryDto::is_creditor_scheme_Set() const{
    return m_creditor_scheme_isSet;
}

bool OAIBankAccountQueryDto::is_creditor_scheme_Valid() const{
    return m_creditor_scheme_isValid;
}

QString OAIBankAccountQueryDto::getDetails() const {
    return m_details;
}
void OAIBankAccountQueryDto::setDetails(const QString &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIBankAccountQueryDto::is_details_Set() const{
    return m_details_isSet;
}

bool OAIBankAccountQueryDto::is_details_Valid() const{
    return m_details_isValid;
}

qint64 OAIBankAccountQueryDto::getId() const {
    return m_id;
}
void OAIBankAccountQueryDto::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBankAccountQueryDto::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBankAccountQueryDto::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIBankAccountQueryDto::getInternationalBankAccountNumber() const {
    return m_international_bank_account_number;
}
void OAIBankAccountQueryDto::setInternationalBankAccountNumber(const QString &international_bank_account_number) {
    m_international_bank_account_number = international_bank_account_number;
    m_international_bank_account_number_isSet = true;
}

bool OAIBankAccountQueryDto::is_international_bank_account_number_Set() const{
    return m_international_bank_account_number_isSet;
}

bool OAIBankAccountQueryDto::is_international_bank_account_number_Valid() const{
    return m_international_bank_account_number_isValid;
}

bool OAIBankAccountQueryDto::isIsDefaultBank() const {
    return m_is_default_bank;
}
void OAIBankAccountQueryDto::setIsDefaultBank(const bool &is_default_bank) {
    m_is_default_bank = is_default_bank;
    m_is_default_bank_isSet = true;
}

bool OAIBankAccountQueryDto::is_is_default_bank_Set() const{
    return m_is_default_bank_isSet;
}

bool OAIBankAccountQueryDto::is_is_default_bank_Valid() const{
    return m_is_default_bank_isValid;
}

QString OAIBankAccountQueryDto::getLastChq() const {
    return m_last_chq;
}
void OAIBankAccountQueryDto::setLastChq(const QString &last_chq) {
    m_last_chq = last_chq;
    m_last_chq_isSet = true;
}

bool OAIBankAccountQueryDto::is_last_chq_Set() const{
    return m_last_chq_isSet;
}

bool OAIBankAccountQueryDto::is_last_chq_Valid() const{
    return m_last_chq_isValid;
}

QString OAIBankAccountQueryDto::getNominalAcCode() const {
    return m_nominal_ac_code;
}
void OAIBankAccountQueryDto::setNominalAcCode(const QString &nominal_ac_code) {
    m_nominal_ac_code = nominal_ac_code;
    m_nominal_ac_code_isSet = true;
}

bool OAIBankAccountQueryDto::is_nominal_ac_code_Set() const{
    return m_nominal_ac_code_isSet;
}

bool OAIBankAccountQueryDto::is_nominal_ac_code_Valid() const{
    return m_nominal_ac_code_isValid;
}

QString OAIBankAccountQueryDto::getSortCode() const {
    return m_sort_code;
}
void OAIBankAccountQueryDto::setSortCode(const QString &sort_code) {
    m_sort_code = sort_code;
    m_sort_code_isSet = true;
}

bool OAIBankAccountQueryDto::is_sort_code_Set() const{
    return m_sort_code_isSet;
}

bool OAIBankAccountQueryDto::is_sort_code_Valid() const{
    return m_sort_code_isValid;
}

QByteArray OAIBankAccountQueryDto::getTimestamp() const {
    return m_timestamp;
}
void OAIBankAccountQueryDto::setTimestamp(const QByteArray &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIBankAccountQueryDto::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIBankAccountQueryDto::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

bool OAIBankAccountQueryDto::isSet() const {
...
bool OAIBankAccountQueryDto::isValid() const {
