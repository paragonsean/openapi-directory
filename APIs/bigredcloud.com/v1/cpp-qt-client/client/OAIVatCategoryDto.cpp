...
qint64 OAIVatCategoryDto::getId() const {
    return m_id;
}
void OAIVatCategoryDto::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIVatCategoryDto::is_id_Set() const{
    return m_id_isSet;
}

bool OAIVatCategoryDto::is_id_Valid() const{
    return m_id_isValid;
}
