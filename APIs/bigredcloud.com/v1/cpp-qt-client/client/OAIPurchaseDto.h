...
#ifndef OAIPurchaseDto_H
#define OAIPurchaseDto_H
...
class OAIPurchaseDto : public OAIObject {
public:
    OAIPurchaseDto();
    OAIPurchaseDto(QString json);
    ~OAIPurchaseDto() override;
    ...
    bool isIsDiscrepancyAccepted() const;
    void setIsDiscrepancyAccepted(const bool &is_discrepancy_accepted);
    bool is_is_discrepancy_accepted_Set() const;
    bool is_is_discrepancy_accepted_Valid() const;
...
private:
    ...
    bool m_is_discrepancy_accepted;
    bool m_is_discrepancy_accepted_isSet;
    bool m_is_discrepancy_accepted_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseDto)

#endif // OAIPurchaseDto_H
