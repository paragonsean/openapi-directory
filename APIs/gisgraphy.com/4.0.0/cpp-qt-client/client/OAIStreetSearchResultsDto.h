...
/*
 * OAIStreetSearchResultsDto.h
 *
 * 
 */

#ifndef OAIStreetSearchResultsDto_H
#define OAIStreetSearchResultsDto_H
...
namespace OpenAPI {
class OAIStreetDistance;

class OAIStreetSearchResultsDto : public OAIObject {
public:
    OAIStreetSearchResultsDto();
    OAIStreetSearchResultsDto(QString json);
    ~OAIStreetSearchResultsDto() override;
    ...
    QList<OAIStreetDistance> getResult() const;
    void setResult(const QList<OAIStreetDistance> &result);
...
private:
    ...
    QList<OAIStreetDistance> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreetSearchResultsDto)

#endif // OAIStreetSearchResultsDto_H
