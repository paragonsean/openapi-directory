...
/*
 * OAIGisFeatureDistance.h
 *
 * 
 */

#ifndef OAIGisFeatureDistance_H
#define OAIGisFeatureDistance_H
...
class OAIGisFeatureDistance : public OAIObject {
public:
    OAIGisFeatureDistance();
    OAIGisFeatureDistance(QString json);
    ~OAIGisFeatureDistance() override;
    ...
    QString getAdm5Code() const;
    void setAdm5Code(const QString &adm5_code);
    bool is_adm5_code_Set() const;
    bool is_adm5_code_Valid() const;

    QString getAdm5Name() const;
    void setAdm5Name(const QString &adm5_name);
    bool is_adm5_name_Set() const;
    bool is_adm5_name_Valid() const;
    ...
    void setAsciiName(const QString &ascii_name);
    bool is_ascii_name_Set() const;
    bool is_ascii_name_Valid() const;
    ...
    QString getEquivalentFipsCode() const;
    void setEquivalentFipsCode(const QString &equivalent_fips_code);
    bool is_equivalent_fips_code_Set() const;
    bool is_equivalent_fips_code_Valid() const;
    ...
    QString getIso3166Alpha2Code() const;
    void setIso3166Alpha2Code(const QString &iso3166_alpha2_code);
    bool is_iso3166_alpha2_code_Set() const;
    bool is_iso3166_alpha2_code_Valid() const;

    QString getIso3166Alpha3Code() const;
    void setIso3166Alpha3Code(const QString &iso3166_alpha3_code);
    bool is_iso3166_alpha3_code_Set() const;
    bool is_iso3166_alpha3_code_Valid() const;

    QString getIso3166NumericCode() const;
    void setIso3166NumericCode(const QString &iso3166_numeric_code);
    bool is_iso3166_numeric_code_Set() const;
    bool is_iso3166_numeric_code_Valid() const;
...
private:
    ...
    QString m_adm5_code;
    bool m_adm5_code_isSet;
    bool m_adm5_code_isValid;

    QString m_adm5_name;
    bool m_adm5_name_isSet;
    bool m_adm5_name_isValid;
    ...
    bool m_ascii_name_isSet;
    bool m_ascii_name_isValid;
    ...
    QString m_equivalent_fips_code;
    bool m_equivalent_fips_code_isSet;
    bool m_equivalent_fips_code_isValid;
    ...
    QString m_iso3166_alpha2_code;
    bool m_iso3166_alpha2_code_isSet;
    bool m_iso3166_alpha2_code_isValid;

    QString m_iso3166_alpha3_code;
    bool m_iso3166_alpha3_code_isSet;
    bool m_iso3166_alpha3_code_isValid;

    QString m_iso3166_numeric_code;
    bool m_iso3166_numeric_code_isSet;
    bool m_iso3166_numeric_code_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGisFeatureDistance)

#endif // OAIGisFeatureDistance_H
