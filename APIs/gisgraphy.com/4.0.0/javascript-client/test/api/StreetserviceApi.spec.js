...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.StreetserviceApi();
  });
  ...
  describe('StreetserviceApi', function() {
    describe('streetsearch', function() {
      it('should call streetsearch successfully', function(done) {
        //uncomment below and update the code to test streetsearch
        //instance.streetsearch(function(error) {
