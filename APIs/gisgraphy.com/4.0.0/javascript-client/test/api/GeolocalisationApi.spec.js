...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.GeolocalisationApi();
  });
  ...
  describe('GeolocalisationApi', function() {
    describe('geoloc', function() {
      it('should call geoloc successfully', function(done) {
        //uncomment below and update the code to test geoloc
        //instance.geoloc(function(error) {
