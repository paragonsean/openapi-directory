...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.FulltextAutocompleteApi();
  });
  ...
  describe('FulltextAutocompleteApi', function() {
    describe('fulltxtsearch', function() {
      it('should call fulltxtsearch successfully', function(done) {
        //uncomment below and update the code to test fulltxtsearch
        //instance.fulltxtsearch(function(error) {
