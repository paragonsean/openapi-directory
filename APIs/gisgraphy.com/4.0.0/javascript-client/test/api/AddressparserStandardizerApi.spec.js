...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.AddressparserStandardizerApi();
  });
  ...
  describe('AddressparserStandardizerApi', function() {
    describe('addressparsing', function() {
      it('should call addressparsing successfully', function(done) {
        //uncomment below and update the code to test addressparsing
        //instance.addressparsing(function(error) {
