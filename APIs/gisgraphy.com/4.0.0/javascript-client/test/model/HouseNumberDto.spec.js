...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.HouseNumberDto();
  });
  ...
  describe('HouseNumberDto', function() {
    it('should create an instance of HouseNumberDto', function() {
      // uncomment below and update the code to test HouseNumberDto
      //var instance = new GisgraphyWebservices.HouseNumberDto();
      //expect(instance).to.be.a(GisgraphyWebservices.HouseNumberDto);
    });
