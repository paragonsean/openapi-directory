...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.GeolocResultsDto();
  });
  ...
  describe('GeolocResultsDto', function() {
    it('should create an instance of GeolocResultsDto', function() {
      // uncomment below and update the code to test GeolocResultsDto
      //var instance = new GisgraphyWebservices.GeolocResultsDto();
      //expect(instance).to.be.a(GisgraphyWebservices.GeolocResultsDto);
    });
