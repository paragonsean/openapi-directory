...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.FulltextResultsDto();
  });
  ...
  describe('FulltextResultsDto', function() {
    it('should create an instance of FulltextResultsDto', function() {
      // uncomment below and update the code to test FulltextResultsDto
      //var instance = new GisgraphyWebservices.FulltextResultsDto();
      //expect(instance).to.be.a(GisgraphyWebservices.FulltextResultsDto);
    });
