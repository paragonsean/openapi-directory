...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GisgraphyWebservices.StreetSearchResultsDto();
  });
  ...
  describe('StreetSearchResultsDto', function() {
    it('should create an instance of StreetSearchResultsDto', function() {
      // uncomment below and update the code to test StreetSearchResultsDto
      //var instance = new GisgraphyWebservices.StreetSearchResultsDto();
      //expect(instance).to.be.a(GisgraphyWebservices.StreetSearchResultsDto);
    });
