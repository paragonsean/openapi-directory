...
/**
 * API tests for StreetserviceApi
 */
@Disabled
public class StreetserviceApiTest {

    private final StreetserviceApi api = new StreetserviceApi();
     ...
     */
    @Test
    public void streetsearchTest() throws ApiException {
        Double lat = null;
        Double lng = null;
        Double radius = null;
        Boolean oneway = null;
        ...
        Boolean indent = null;
        StreetSearchResultsDto response = api.streetsearch(lat, lng, radius, oneway, distance, streettype, format, from, to, paramCallback, indent);
