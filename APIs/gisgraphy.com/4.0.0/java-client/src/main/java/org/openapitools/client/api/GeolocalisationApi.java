...
public class GeolocalisationApi {
    ...
    public GeolocalisationApi() {
        this(Configuration.getDefaultApiClient());
    }

    public GeolocalisationApi(ApiClient apiClient) {
     ...
     * @param placetype filter search for a given placetype (optional)
     ...
     */
    public okhttp3.Call geolocCall(Double lat, Double lng, Double radius, Boolean distance, String placetype, String format, Integer from, Integer to, String paramCallback, Boolean indent, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/geoloc/search";
        ...
        if (placetype != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("placetype", placetype));
        }
    ...
    private okhttp3.Call geolocValidateBeforeCall(Double lat, Double lng, Double radius, Boolean distance, String placetype, String format, Integer from, Integer to, String paramCallback, Boolean indent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'lat' is set
        if (lat == null) {
            throw new ApiException("Missing the required parameter 'lat' when calling geoloc(Async)");
        }

        // verify the required parameter 'lng' is set
        if (lng == null) {
            throw new ApiException("Missing the required parameter 'lng' when calling geoloc(Async)");
        }

        return geolocCall(lat, lng, radius, distance, placetype, format, from, to, paramCallback, indent, _callback);
     ...
     */
    public GeolocResultsDto geoloc(Double lat, Double lng, Double radius, Boolean distance, String placetype, String format, Integer from, Integer to, String paramCallback, Boolean indent) throws ApiException {
        ApiResponse<GeolocResultsDto> localVarResp = geolocWithHttpInfo(lat, lng, radius, distance, placetype, format, from, to, paramCallback, indent);
     ...
     * @param paramCallback The callback method name (optional), use to wrap the content into a (alphanumeric) Javascript method. Works only for script output formats (JSON, PHP, Ruby, Python) (optional)
     * @param indent indents the results.Default to false. Possible values are true or false (or on when used with the rest service. If you use a checkbox in a web form, to indent the results, the value will be &#39;on&#39; or &#39;off&#39;, so for a simple use : the value of indent can be &#39;true&#39; or &#39;on&#39; (optional, default to false)
     * @return ApiResponse&lt;GeolocResultsDto&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GeolocResultsDto> geolocWithHttpInfo(Double lat, Double lng, Double radius, Boolean distance, String placetype, String format, Integer from, Integer to, String paramCallback, Boolean indent) throws ApiException {
        okhttp3.Call localVarCall = geolocValidateBeforeCall(lat, lng, radius, distance, placetype, format, from, to, paramCallback, indent, null);
        Type localVarReturnType = new TypeToken<GeolocResultsDto>(){}.getType();
     ...
     */
    public okhttp3.Call geolocAsync(Double lat, Double lng, Double radius, Boolean distance, String placetype, String format, Integer from, Integer to, String paramCallback, Boolean indent, final ApiCallback<GeolocResultsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = geolocValidateBeforeCall(lat, lng, radius, distance, placetype, format, from, to, paramCallback, indent, _callback);
        Type localVarReturnType = new TypeToken<GeolocResultsDto>(){}.getType();
