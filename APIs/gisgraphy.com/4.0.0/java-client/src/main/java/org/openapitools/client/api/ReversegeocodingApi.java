...
public class ReversegeocodingApi {
     ...
     */
    public okhttp3.Call reversegeocodeCall(Double lat, Double lng, String format, Integer from, Integer to, String paramCallback, Boolean indent, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/reversegeocoding/reversegeocode";
    ...
    private okhttp3.Call reversegeocodeValidateBeforeCall(Double lat, Double lng, String format, Integer from, Integer to, String paramCallback, Boolean indent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'lat' is set
        if (lat == null) {
            throw new ApiException("Missing the required parameter 'lat' when calling reversegeocode(Async)");
        }

        // verify the required parameter 'lng' is set
        if (lng == null) {
            throw new ApiException("Missing the required parameter 'lng' when calling reversegeocode(Async)");
        }

        return reversegeocodeCall(lat, lng, format, from, to, paramCallback, indent, _callback);
     ...
     */
    public AddressResultsDto reversegeocode(Double lat, Double lng, String format, Integer from, Integer to, String paramCallback, Boolean indent) throws ApiException {
        ApiResponse<AddressResultsDto> localVarResp = reversegeocodeWithHttpInfo(lat, lng, format, from, to, paramCallback, indent);
     ...
     */
    public ApiResponse<AddressResultsDto> reversegeocodeWithHttpInfo(Double lat, Double lng, String format, Integer from, Integer to, String paramCallback, Boolean indent) throws ApiException {
        okhttp3.Call localVarCall = reversegeocodeValidateBeforeCall(lat, lng, format, from, to, paramCallback, indent, null);
        Type localVarReturnType = new TypeToken<AddressResultsDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Reverse geocode an address (asynchronously)
     * The Reverse geocoding service allows to search for an address for a given GPS position.
     * @param lat The latitude (north-south) for the location point to search around. The value is a floating number, between -90 and +90. It uses GPS coordinates (required)
     * @param lng TThe longitude (east-West) for the location point to search around. The value is a floating number between -180 and +180. It uses GPS coordinates. (required)
     * @param format The output format. (optional, default to XML)
     ...
     */
    public okhttp3.Call reversegeocodeAsync(Double lat, Double lng, String format, Integer from, Integer to, String paramCallback, Boolean indent, final ApiCallback<AddressResultsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = reversegeocodeValidateBeforeCall(lat, lng, format, from, to, paramCallback, indent, _callback);
        Type localVarReturnType = new TypeToken<AddressResultsDto>(){}.getType();
