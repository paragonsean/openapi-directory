...
<a id="geoloc"></a>
# **geoloc**
> GeolocResultsDto geoloc(lat, lng, radius, distance, placetype, format, from, to, paramCallback, indent)
...
import org.openapitools.client.api.GeolocalisationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    GeolocalisationApi apiInstance = new GeolocalisationApi(defaultClient);
    ...
    String placetype = "placetype_example"; // String | filter search for a given placetype
    ...
    try {
      GeolocResultsDto result = apiInstance.geoloc(lat, lng, radius, distance, placetype, format, from, to, paramCallback, indent);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GeolocalisationApi#geoloc");
