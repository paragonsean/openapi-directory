...
class NHBugSouth(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, availability_array: List[NHBugNorthAvailabilityArrayInner]=None, months: str=None, months_array: List[int]=None, times_by_month: NHBugSouthTimesByMonth=None):
        """NHBugSouth - a model defined in OpenAPI

        :param availability_array: The availability_array of this NHBugSouth.
        :param months: The months of this NHBugSouth.
        :param months_array: The months_array of this NHBugSouth.
        :param times_by_month: The times_by_month of this NHBugSouth.
        """
        self.openapi_types = {
            'availability_array': List[NHBugNorthAvailabilityArrayInner],
            'months': str,
            'months_array': List[int],
            'times_by_month': NHBugSouthTimesByMonth
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NHBugSouth':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The NHBug_south of this NHBugSouth.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def availability_array(self):
        """Gets the availability_array of this NHBugSouth.
        ...
        :return: The availability_array of this NHBugSouth.
    ...
    def availability_array(self, availability_array):
        """Sets the availability_array of this NHBugSouth.
    ...
    def months(self, months):
        """Sets the months of this NHBugSouth.
    ...
    def months_array(self, months_array):
        """Sets the months_array of this NHBugSouth.
    ...
    def times_by_month(self):
        """Gets the times_by_month of this NHBugSouth.


        :return: The times_by_month of this NHBugSouth.
        :rtype: NHBugSouthTimesByMonth
        """
        return self._times_by_month

    @times_by_month.setter
    def times_by_month(self, times_by_month):
        """Sets the times_by_month of this NHBugSouth.


        :param times_by_month: The times_by_month of this NHBugSouth.
        :type times_by_month: NHBugSouthTimesByMonth
        """
