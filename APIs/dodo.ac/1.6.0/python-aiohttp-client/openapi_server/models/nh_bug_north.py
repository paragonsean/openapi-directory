...
class NHBugNorth(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, availability_array: List[NHBugNorthAvailabilityArrayInner]=None, months: str=None, months_array: List[int]=None, times_by_month: NHBugNorthTimesByMonth=None):
        """NHBugNorth - a model defined in OpenAPI

        :param availability_array: The availability_array of this NHBugNorth.
        :param months: The months of this NHBugNorth.
        :param months_array: The months_array of this NHBugNorth.
        :param times_by_month: The times_by_month of this NHBugNorth.
        """
        self.openapi_types = {
            'availability_array': List[NHBugNorthAvailabilityArrayInner],
            'months': str,
            'months_array': List[int],
            'times_by_month': NHBugNorthTimesByMonth
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NHBugNorth':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The NHBug_north of this NHBugNorth.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def availability_array(self):
        """Gets the availability_array of this NHBugNorth.
        ...
        :return: The availability_array of this NHBugNorth.
    ...
    def availability_array(self, availability_array):
        """Sets the availability_array of this NHBugNorth.
    ...
    def months(self, months):
        """Sets the months of this NHBugNorth.
    ...
    def months_array(self, months_array):
        """Sets the months_array of this NHBugNorth.
    ...
    def times_by_month(self):
        """Gets the times_by_month of this NHBugNorth.


        :return: The times_by_month of this NHBugNorth.
        :rtype: NHBugNorthTimesByMonth
        """
        return self._times_by_month

    @times_by_month.setter
    def times_by_month(self, times_by_month):
        """Sets the times_by_month of this NHBugNorth.


        :param times_by_month: The times_by_month of this NHBugNorth.
        :type times_by_month: NHBugNorthTimesByMonth
        """
