...
**monthsArray** | **[Number]** | An array of integers representing the months the sea creature is available in the Northern hemisphere. | [optional] 
