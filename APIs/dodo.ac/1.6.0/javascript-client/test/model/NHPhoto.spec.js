...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHPhoto();
  });
  ...
  describe('NHPhoto', function() {
    it('should create an instance of NHPhoto', function() {
      // uncomment below and update the code to test NHPhoto
      //var instance = new Nookipedia.NHPhoto();
      //expect(instance).to.be.a(Nookipedia.NHPhoto);
    });
