...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHInterior();
  });
  ...
  describe('NHInterior', function() {
    it('should create an instance of NHInterior', function() {
      // uncomment below and update the code to test NHInterior
      //var instance = new Nookipedia.NHInterior();
      //expect(instance).to.be.a(Nookipedia.NHInterior);
    });
