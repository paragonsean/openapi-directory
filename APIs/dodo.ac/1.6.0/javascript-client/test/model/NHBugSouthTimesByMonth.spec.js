...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHBugSouthTimesByMonth();
  });
  ...
  describe('NHBugSouthTimesByMonth', function() {
    it('should create an instance of NHBugSouthTimesByMonth', function() {
      // uncomment below and update the code to test NHBugSouthTimesByMonth
      //var instance = new Nookipedia.NHBugSouthTimesByMonth();
      //expect(instance).to.be.a(Nookipedia.NHBugSouthTimesByMonth);
    });
