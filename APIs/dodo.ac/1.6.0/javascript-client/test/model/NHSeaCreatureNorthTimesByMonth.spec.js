...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHSeaCreatureNorthTimesByMonth();
  });
  ...
  describe('NHSeaCreatureNorthTimesByMonth', function() {
    it('should create an instance of NHSeaCreatureNorthTimesByMonth', function() {
      // uncomment below and update the code to test NHSeaCreatureNorthTimesByMonth
      //var instance = new Nookipedia.NHSeaCreatureNorthTimesByMonth();
      //expect(instance).to.be.a(Nookipedia.NHSeaCreatureNorthTimesByMonth);
    });
