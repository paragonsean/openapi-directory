...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHClothingVariationsInner();
  });
  ...
  describe('NHClothingVariationsInner', function() {
    it('should create an instance of NHClothingVariationsInner', function() {
      // uncomment below and update the code to test NHClothingVariationsInner
      //var instance = new Nookipedia.NHClothingVariationsInner();
      //expect(instance).to.be.a(Nookipedia.NHClothingVariationsInner);
    });
