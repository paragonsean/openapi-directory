...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHBugNorthTimesByMonth();
  });
  ...
  describe('NHBugNorthTimesByMonth', function() {
    it('should create an instance of NHBugNorthTimesByMonth', function() {
      // uncomment below and update the code to test NHBugNorthTimesByMonth
      //var instance = new Nookipedia.NHBugNorthTimesByMonth();
      //expect(instance).to.be.a(Nookipedia.NHBugNorthTimesByMonth);
    });
