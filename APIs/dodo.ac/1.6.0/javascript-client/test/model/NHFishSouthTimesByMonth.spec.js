...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHFishSouthTimesByMonth();
  });
  ...
  describe('NHFishSouthTimesByMonth', function() {
    it('should create an instance of NHFishSouthTimesByMonth', function() {
      // uncomment below and update the code to test NHFishSouthTimesByMonth
      //var instance = new Nookipedia.NHFishSouthTimesByMonth();
      //expect(instance).to.be.a(Nookipedia.NHFishSouthTimesByMonth);
    });
