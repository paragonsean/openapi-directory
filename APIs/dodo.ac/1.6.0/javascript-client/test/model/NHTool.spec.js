...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHTool();
  });
  ...
  describe('NHTool', function() {
    it('should create an instance of NHTool', function() {
      // uncomment below and update the code to test NHTool
      //var instance = new Nookipedia.NHTool();
      //expect(instance).to.be.a(Nookipedia.NHTool);
    });
