...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHRecipe();
  });
  ...
  describe('NHRecipe', function() {
    it('should create an instance of NHRecipe', function() {
      // uncomment below and update the code to test NHRecipe
      //var instance = new Nookipedia.NHRecipe();
      //expect(instance).to.be.a(Nookipedia.NHRecipe);
    });
    ...
    it('should have the property recipesToUnlock (base name: "recipes_to_unlock")', function() {
      // uncomment below and update the code to test the property recipesToUnlock
      //var instance = new Nookipedia.NHRecipe();
      //expect(instance).to.be();
    });
    ...
    it('should have the property serialId (base name: "serial_id")', function() {
      // uncomment below and update the code to test the property serialId
      //var instance = new Nookipedia.NHRecipe();
      //expect(instance).to.be();
    });
