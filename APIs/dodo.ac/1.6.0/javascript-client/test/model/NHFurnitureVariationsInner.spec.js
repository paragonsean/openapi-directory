...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nookipedia.NHFurnitureVariationsInner();
  });
  ...
  describe('NHFurnitureVariationsInner', function() {
    it('should create an instance of NHFurnitureVariationsInner', function() {
      // uncomment below and update the code to test NHFurnitureVariationsInner
      //var instance = new Nookipedia.NHFurnitureVariationsInner();
      //expect(instance).to.be.a(Nookipedia.NHFurnitureVariationsInner);
    });
