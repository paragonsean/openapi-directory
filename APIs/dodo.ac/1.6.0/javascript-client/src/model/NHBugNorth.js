...
import NHBugNorthTimesByMonth from './NHBugNorthTimesByMonth';

/**
 * The NHBugNorth model module.
 * @module model/NHBugNorth
 * @version 1.6.0
 */
class NHBugNorth {
    /**
     * Constructs a new <code>NHBugNorth</code>.
     * When you can catch the bug in the Northern hemisphere.
     * @alias module:model/NHBugNorth
     */
    constructor() { 
        
        NHBugNorth.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NHBugNorth</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NHBugNorth} obj Optional instance to populate.
     * @return {module:model/NHBugNorth} The populated <code>NHBugNorth</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NHBugNorth();
            ...
            if (data.hasOwnProperty('times_by_month')) {
                obj['times_by_month'] = NHBugNorthTimesByMonth.constructFromObject(data['times_by_month']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NHBugNorth</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NHBugNorth</code>.
     */
    static validateJSON(data) {
        ...
        if (data['times_by_month']) { // data not null
          NHBugNorthTimesByMonth.validateJSON(data['times_by_month']);
        }
 ...
 */
NHBugNorth.prototype['months_array'] = undefined;

/**
 * @member {module:model/NHBugNorthTimesByMonth} times_by_month
 */
NHBugNorth.prototype['times_by_month'] = undefined;
