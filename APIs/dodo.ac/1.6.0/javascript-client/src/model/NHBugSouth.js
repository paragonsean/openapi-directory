...
import NHBugSouthTimesByMonth from './NHBugSouthTimesByMonth';

/**
 * The NHBugSouth model module.
 * @module model/NHBugSouth
 * @version 1.6.0
 */
class NHBugSouth {
    /**
     * Constructs a new <code>NHBugSouth</code>.
     * When you can catch the bug in the Southern hemisphere.
     * @alias module:model/NHBugSouth
     */
    constructor() { 
        
        NHBugSouth.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NHBugSouth</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NHBugSouth} obj Optional instance to populate.
     * @return {module:model/NHBugSouth} The populated <code>NHBugSouth</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NHBugSouth();
            ...
            if (data.hasOwnProperty('times_by_month')) {
                obj['times_by_month'] = NHBugSouthTimesByMonth.constructFromObject(data['times_by_month']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NHBugSouth</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NHBugSouth</code>.
     */
    static validateJSON(data) {
        ...
        if (data['times_by_month']) { // data not null
          NHBugSouthTimesByMonth.validateJSON(data['times_by_month']);
        }
 ...
 */
NHBugSouth.prototype['months_array'] = undefined;

/**
 * @member {module:model/NHBugSouthTimesByMonth} times_by_month
 */
NHBugSouth.prototype['times_by_month'] = undefined;
