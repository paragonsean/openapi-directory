...
import NHFishNorthTimesByMonth from './NHFishNorthTimesByMonth';

/**
 * The NHFishNorth model module.
 * @module model/NHFishNorth
 * @version 1.6.0
 */
class NHFishNorth {
    /**
     * Constructs a new <code>NHFishNorth</code>.
     * When you can catch the fish in the Northern hemisphere.
     * @alias module:model/NHFishNorth
     */
    constructor() { 
        
        NHFishNorth.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NHFishNorth</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NHFishNorth} obj Optional instance to populate.
     * @return {module:model/NHFishNorth} The populated <code>NHFishNorth</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NHFishNorth();
            ...
            if (data.hasOwnProperty('times_by_month')) {
                obj['times_by_month'] = NHFishNorthTimesByMonth.constructFromObject(data['times_by_month']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NHFishNorth</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NHFishNorth</code>.
     */
    static validateJSON(data) {
        ...
        if (data['times_by_month']) { // data not null
          NHFishNorthTimesByMonth.validateJSON(data['times_by_month']);
        }
 ...
 */
NHFishNorth.prototype['months_array'] = undefined;

/**
 * @member {module:model/NHFishNorthTimesByMonth} times_by_month
 */
NHFishNorth.prototype['times_by_month'] = undefined;
