...
/*
 * OAINHBug_north_times_by_month.h
 *
...
#ifndef OAINHBug_north_times_by_month_H
#define OAINHBug_north_times_by_month_H
...
class OAINHBug_north_times_by_month : public OAIObject {
public:
    OAINHBug_north_times_by_month();
    OAINHBug_north_times_by_month(QString json);
    ~OAINHBug_north_times_by_month() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHBug_north_times_by_month)

#endif // OAINHBug_north_times_by_month_H
