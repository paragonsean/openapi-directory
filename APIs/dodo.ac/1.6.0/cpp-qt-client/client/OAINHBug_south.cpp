...
OAINHBug_south::OAINHBug_south(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINHBug_south::OAINHBug_south() {
    this->initializeModel();
}

OAINHBug_south::~OAINHBug_south() {}

void OAINHBug_south::initializeModel() {
...
void OAINHBug_south::fromJson(QString jsonString) {
...
void OAINHBug_south::fromJsonObject(QJsonObject json) {
...
QString OAINHBug_south::asJson() const {
...
QJsonObject OAINHBug_south::asJsonObject() const {
    QJsonObject obj;
...
QList<OAINHBug_north_availability_array_inner> OAINHBug_south::getAvailabilityArray() const {
    return m_availability_array;
}
void OAINHBug_south::setAvailabilityArray(const QList<OAINHBug_north_availability_array_inner> &availability_array) {
    m_availability_array = availability_array;
    m_availability_array_isSet = true;
}

bool OAINHBug_south::is_availability_array_Set() const{
    return m_availability_array_isSet;
}

bool OAINHBug_south::is_availability_array_Valid() const{
    return m_availability_array_isValid;
}

QString OAINHBug_south::getMonths() const {
    return m_months;
}
void OAINHBug_south::setMonths(const QString &months) {
    m_months = months;
    m_months_isSet = true;
}

bool OAINHBug_south::is_months_Set() const{
    return m_months_isSet;
}

bool OAINHBug_south::is_months_Valid() const{
    return m_months_isValid;
}

QList<qint32> OAINHBug_south::getMonthsArray() const {
    return m_months_array;
}
void OAINHBug_south::setMonthsArray(const QList<qint32> &months_array) {
    m_months_array = months_array;
    m_months_array_isSet = true;
}

bool OAINHBug_south::is_months_array_Set() const{
    return m_months_array_isSet;
}

bool OAINHBug_south::is_months_array_Valid() const{
    return m_months_array_isValid;
}

OAINHBug_south_times_by_month OAINHBug_south::getTimesByMonth() const {
    return m_times_by_month;
}
void OAINHBug_south::setTimesByMonth(const OAINHBug_south_times_by_month &times_by_month) {
    m_times_by_month = times_by_month;
    m_times_by_month_isSet = true;
}

bool OAINHBug_south::is_times_by_month_Set() const{
    return m_times_by_month_isSet;
}

bool OAINHBug_south::is_times_by_month_Valid() const{
    return m_times_by_month_isValid;
}

bool OAINHBug_south::isSet() const {
...
bool OAINHBug_south::isValid() const {
