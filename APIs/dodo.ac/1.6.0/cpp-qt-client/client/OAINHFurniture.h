...
#ifndef OAINHFurniture_H
#define OAINHFurniture_H
...
class OAINHFurniture_variations_inner;

class OAINHFurniture : public OAIObject {
public:
    OAINHFurniture();
    OAINHFurniture(QString json);
    ~OAINHFurniture() override;
    ...
    QString getCustomKitType() const;
    void setCustomKitType(const QString &custom_kit_type);
    bool is_custom_kit_type_Set() const;
    bool is_custom_kit_type_Valid() const;
    ...
    QString getCustomPatternPart() const;
    void setCustomPatternPart(const QString &custom_pattern_part);
    bool is_custom_pattern_part_Set() const;
    bool is_custom_pattern_part_Valid() const;
    ...
    bool isDoorDecor() const;
    void setDoorDecor(const bool &door_decor);
    bool is_door_decor_Set() const;
    bool is_door_decor_Valid() const;

    QList<QString> getFunctions() const;
    void setFunctions(const QList<QString> &functions);
    ...
    bool isLucky() const;
    void setLucky(const bool &lucky);
    bool is_lucky_Set() const;
    bool is_lucky_Valid() const;

    QString getLuckySeason() const;
    void setLuckySeason(const QString &lucky_season);
    bool is_lucky_season_Set() const;
    bool is_lucky_season_Valid() const;
    ...
    qint32 getPatternTotal() const;
    void setPatternTotal(const qint32 &pattern_total);
    bool is_pattern_total_Set() const;
    bool is_pattern_total_Valid() const;
    ...
    QList<OAINHFurniture_variations_inner> getVariations() const;
    void setVariations(const QList<OAINHFurniture_variations_inner> &variations);
...
private:
    ...
    QString m_custom_kit_type;
    bool m_custom_kit_type_isSet;
    bool m_custom_kit_type_isValid;

    qint32 m_custom_kits;
    bool m_custom_kits_isSet;
    bool m_custom_kits_isValid;

    QString m_custom_pattern_part;
    bool m_custom_pattern_part_isSet;
    bool m_custom_pattern_part_isValid;
    ...
    bool m_door_decor;
    bool m_door_decor_isSet;
    bool m_door_decor_isValid;

    QList<QString> m_functions;
    ...
    bool m_lucky;
    bool m_lucky_isSet;
    bool m_lucky_isValid;

    QString m_lucky_season;
    bool m_lucky_season_isSet;
    bool m_lucky_season_isValid;
    ...
    qint32 m_pattern_total;
    bool m_pattern_total_isSet;
    bool m_pattern_total_isValid;
    ...
    QList<OAINHFurniture_variations_inner> m_variations;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHFurniture)

#endif // OAINHFurniture_H
