...
/*
 * OAINHFish_north_times_by_month.h
 *
...
#ifndef OAINHFish_north_times_by_month_H
#define OAINHFish_north_times_by_month_H
...
class OAINHFish_north_times_by_month : public OAIObject {
public:
    OAINHFish_north_times_by_month();
    OAINHFish_north_times_by_month(QString json);
    ~OAINHFish_north_times_by_month() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHFish_north_times_by_month)

#endif // OAINHFish_north_times_by_month_H
