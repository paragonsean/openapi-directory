...
/*
 * OAINHBug_south_times_by_month.h
 *
...
#ifndef OAINHBug_south_times_by_month_H
#define OAINHBug_south_times_by_month_H
...
class OAINHBug_south_times_by_month : public OAIObject {
public:
    OAINHBug_south_times_by_month();
    OAINHBug_south_times_by_month(QString json);
    ~OAINHBug_south_times_by_month() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHBug_south_times_by_month)

#endif // OAINHBug_south_times_by_month_H
