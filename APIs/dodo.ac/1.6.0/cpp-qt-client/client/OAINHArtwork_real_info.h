...
/*
 * OAINHArtwork_real_info.h
 *
 * Information about the genuine version of the artwork.
 */

#ifndef OAINHArtwork_real_info_H
#define OAINHArtwork_real_info_H
...
class OAINHArtwork_real_info : public OAIObject {
public:
    OAINHArtwork_real_info();
    OAINHArtwork_real_info(QString json);
    ~OAINHArtwork_real_info() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHArtwork_real_info)

#endif // OAINHArtwork_real_info_H
