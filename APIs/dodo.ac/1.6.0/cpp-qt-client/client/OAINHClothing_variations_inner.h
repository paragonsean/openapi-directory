...
/*
 * OAINHClothing_variations_inner.h
 *
 * 
 */

#ifndef OAINHClothing_variations_inner_H
#define OAINHClothing_variations_inner_H
...
class OAINHClothing_variations_inner : public OAIObject {
public:
    OAINHClothing_variations_inner();
    OAINHClothing_variations_inner(QString json);
    ~OAINHClothing_variations_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHClothing_variations_inner)

#endif // OAINHClothing_variations_inner_H
