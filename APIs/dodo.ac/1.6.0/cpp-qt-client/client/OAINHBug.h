...
namespace OpenAPI {
class OAINHBug_north;
class OAINHBug_south;

class OAINHBug : public OAIObject {
public:
    OAINHBug();
    OAINHBug(QString json);
    ~OAINHBug() override;
    ...
    OAINHBug_north getNorth() const;
    void setNorth(const OAINHBug_north &north);
    ...
    qint32 getSellFlick() const;
    void setSellFlick(const qint32 &sell_flick);
    bool is_sell_flick_Set() const;
    bool is_sell_flick_Valid() const;
    ...
    OAINHBug_south getSouth() const;
    void setSouth(const OAINHBug_south &south);
...
private:
    ...
    qint32 m_sell_flick;
    bool m_sell_flick_isSet;
    bool m_sell_flick_isValid;

    qint32 m_sell_nook;
    bool m_sell_nook_isSet;
    bool m_sell_nook_isValid;

    OAINHBug_south m_south;
    bool m_south_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHBug)
