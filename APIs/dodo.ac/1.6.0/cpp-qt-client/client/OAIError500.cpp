...
QString OAIError500::getDetails() const {
    return m_details;
}
void OAIError500::setDetails(const QString &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIError500::is_details_Set() const{
    return m_details_isSet;
}

bool OAIError500::is_details_Valid() const{
