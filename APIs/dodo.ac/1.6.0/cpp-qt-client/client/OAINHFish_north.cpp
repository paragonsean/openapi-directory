...
OAINHFish_north::OAINHFish_north(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINHFish_north::OAINHFish_north() {
    this->initializeModel();
}

OAINHFish_north::~OAINHFish_north() {}

void OAINHFish_north::initializeModel() {
...
void OAINHFish_north::fromJson(QString jsonString) {
...
void OAINHFish_north::fromJsonObject(QJsonObject json) {
...
QString OAINHFish_north::asJson() const {
...
QJsonObject OAINHFish_north::asJsonObject() const {
    QJsonObject obj;
...
QList<OAINHBug_north_availability_array_inner> OAINHFish_north::getAvailabilityArray() const {
    return m_availability_array;
}
void OAINHFish_north::setAvailabilityArray(const QList<OAINHBug_north_availability_array_inner> &availability_array) {
    m_availability_array = availability_array;
    m_availability_array_isSet = true;
}

bool OAINHFish_north::is_availability_array_Set() const{
    return m_availability_array_isSet;
}

bool OAINHFish_north::is_availability_array_Valid() const{
    return m_availability_array_isValid;
}

QString OAINHFish_north::getMonths() const {
    return m_months;
}
void OAINHFish_north::setMonths(const QString &months) {
    m_months = months;
    m_months_isSet = true;
}

bool OAINHFish_north::is_months_Set() const{
    return m_months_isSet;
}

bool OAINHFish_north::is_months_Valid() const{
    return m_months_isValid;
}

QList<qint32> OAINHFish_north::getMonthsArray() const {
    return m_months_array;
}
void OAINHFish_north::setMonthsArray(const QList<qint32> &months_array) {
    m_months_array = months_array;
    m_months_array_isSet = true;
}

bool OAINHFish_north::is_months_array_Set() const{
    return m_months_array_isSet;
}

bool OAINHFish_north::is_months_array_Valid() const{
    return m_months_array_isValid;
}

OAINHFish_north_times_by_month OAINHFish_north::getTimesByMonth() const {
    return m_times_by_month;
}
void OAINHFish_north::setTimesByMonth(const OAINHFish_north_times_by_month &times_by_month) {
    m_times_by_month = times_by_month;
    m_times_by_month_isSet = true;
}

bool OAINHFish_north::is_times_by_month_Set() const{
    return m_times_by_month_isSet;
}

bool OAINHFish_north::is_times_by_month_Valid() const{
    return m_times_by_month_isValid;
}

bool OAINHFish_north::isSet() const {
...
bool OAINHFish_north::isValid() const {
