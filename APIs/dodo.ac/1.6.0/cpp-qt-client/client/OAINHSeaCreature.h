...
#ifndef OAINHSeaCreature_H
#define OAINHSeaCreature_H
...
namespace OpenAPI {
class OAINHSeaCreature_north;
class OAINHSeaCreature_south;

class OAINHSeaCreature : public OAIObject {
public:
    OAINHSeaCreature();
    OAINHSeaCreature(QString json);
    ~OAINHSeaCreature() override;
    ...
    OAINHSeaCreature_north getNorth() const;
    void setNorth(const OAINHSeaCreature_north &north);
    ...
    QString getShadowMovement() const;
    void setShadowMovement(const QString &shadow_movement);
    bool is_shadow_movement_Set() const;
    bool is_shadow_movement_Valid() const;
    ...
    OAINHSeaCreature_south getSouth() const;
    void setSouth(const OAINHSeaCreature_south &south);
...
private:
    ...
    OAINHSeaCreature_north m_north;
    bool m_north_isSet;
    ...
    QString m_shadow_movement;
    bool m_shadow_movement_isSet;
    bool m_shadow_movement_isValid;

    QString m_shadow_size;
    bool m_shadow_size_isSet;
    bool m_shadow_size_isValid;

    OAINHSeaCreature_south m_south;
    bool m_south_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHSeaCreature)

#endif // OAINHSeaCreature_H
