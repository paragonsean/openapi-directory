...
/*
 * OAINHFish_south_times_by_month.h
 *
...
#ifndef OAINHFish_south_times_by_month_H
#define OAINHFish_south_times_by_month_H
...
class OAINHFish_south_times_by_month : public OAIObject {
public:
    OAINHFish_south_times_by_month();
    OAINHFish_south_times_by_month(QString json);
    ~OAINHFish_south_times_by_month() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINHFish_south_times_by_month)

#endif // OAINHFish_south_times_by_month_H
