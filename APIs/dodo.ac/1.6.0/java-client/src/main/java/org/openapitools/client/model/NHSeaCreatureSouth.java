...
import org.openapitools.client.model.NHSeaCreatureNorthTimesByMonth;
...
public class NHSeaCreatureSouth {
  ...
  private NHSeaCreatureNorthTimesByMonth timesByMonth;

  public NHSeaCreatureSouth() {
  }

  public NHSeaCreatureSouth availabilityArray(List<NHBugNorthAvailabilityArrayInner> availabilityArray) {
    this.availabilityArray = availabilityArray;
    return this;
  }

  public NHSeaCreatureSouth addAvailabilityArrayItem(NHBugNorthAvailabilityArrayInner availabilityArrayItem) {
  ...
  public NHSeaCreatureSouth months(String months) {
    this.months = months;
    return this;
  }
  ...
  public NHSeaCreatureSouth monthsArray(List<Integer> monthsArray) {
    this.monthsArray = monthsArray;
    return this;
  }

  public NHSeaCreatureSouth addMonthsArrayItem(Integer monthsArrayItem) {
  ...
  public NHSeaCreatureSouth timesByMonth(NHSeaCreatureNorthTimesByMonth timesByMonth) {
   ...
   */
  @javax.annotation.Nullable
  public NHSeaCreatureNorthTimesByMonth getTimesByMonth() {
    return timesByMonth;
  }

  public void setTimesByMonth(NHSeaCreatureNorthTimesByMonth timesByMonth) {
    this.timesByMonth = timesByMonth;
  }
  ...
  public boolean equals(Object o) {
    ...
    NHSeaCreatureSouth nhSeaCreatureSouth = (NHSeaCreatureSouth) o;
    return Objects.equals(this.availabilityArray, nhSeaCreatureSouth.availabilityArray) &&
        Objects.equals(this.months, nhSeaCreatureSouth.months) &&
        Objects.equals(this.monthsArray, nhSeaCreatureSouth.monthsArray) &&
        Objects.equals(this.timesByMonth, nhSeaCreatureSouth.timesByMonth);
  }
  ...
  public String toString() {
    ...
    sb.append("class NHSeaCreatureSouth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHSeaCreatureSouth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHSeaCreatureSouth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHSeaCreatureSouth is not found in the empty JSON string", NHSeaCreatureSouth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHSeaCreatureSouth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHSeaCreatureSouth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("times_by_month") != null && !jsonObj.get("times_by_month").isJsonNull()) {
        NHSeaCreatureNorthTimesByMonth.validateJsonElement(jsonObj.get("times_by_month"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHSeaCreatureSouth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHSeaCreatureSouth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHSeaCreatureSouth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHSeaCreatureSouth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHSeaCreatureSouth>() {
           @Override
           public void write(JsonWriter out, NHSeaCreatureSouth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHSeaCreatureSouth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHSeaCreatureSouth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHSeaCreatureSouth
   * @throws IOException if the JSON string is invalid with respect to NHSeaCreatureSouth
   */
  public static NHSeaCreatureSouth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHSeaCreatureSouth.class);
  }

  /**
   * Convert an instance of NHSeaCreatureSouth to an JSON string
   *
   * @return JSON string
   */
