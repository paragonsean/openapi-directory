...
public class NHBugSouthTimesByMonth {
  ...
  public NHBugSouthTimesByMonth _1(String _1) {
    this._1 = _1;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _2(String _2) {
    this._2 = _2;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _3(String _3) {
    this._3 = _3;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _4(String _4) {
    this._4 = _4;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _5(String _5) {
    this._5 = _5;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _6(String _6) {
    this._6 = _6;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _7(String _7) {
    this._7 = _7;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _8(String _8) {
    this._8 = _8;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _9(String _9) {
    this._9 = _9;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _10(String _10) {
    this._10 = _10;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _11(String _11) {
    this._11 = _11;
    return this;
  }
  ...
  public NHBugSouthTimesByMonth _12(String _12) {
    this._12 = _12;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NHBugSouthTimesByMonth nhBugSouthTimesByMonth = (NHBugSouthTimesByMonth) o;
    return Objects.equals(this._1, nhBugSouthTimesByMonth._1) &&
        Objects.equals(this._2, nhBugSouthTimesByMonth._2) &&
        Objects.equals(this._3, nhBugSouthTimesByMonth._3) &&
        Objects.equals(this._4, nhBugSouthTimesByMonth._4) &&
        Objects.equals(this._5, nhBugSouthTimesByMonth._5) &&
        Objects.equals(this._6, nhBugSouthTimesByMonth._6) &&
        Objects.equals(this._7, nhBugSouthTimesByMonth._7) &&
        Objects.equals(this._8, nhBugSouthTimesByMonth._8) &&
        Objects.equals(this._9, nhBugSouthTimesByMonth._9) &&
        Objects.equals(this._10, nhBugSouthTimesByMonth._10) &&
        Objects.equals(this._11, nhBugSouthTimesByMonth._11) &&
        Objects.equals(this._12, nhBugSouthTimesByMonth._12);
  }
  ...
  public String toString() {
    ...
    sb.append("class NHBugSouthTimesByMonth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHBugSouthTimesByMonth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHBugSouthTimesByMonth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHBugSouthTimesByMonth is not found in the empty JSON string", NHBugSouthTimesByMonth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHBugSouthTimesByMonth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHBugSouthTimesByMonth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHBugSouthTimesByMonth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHBugSouthTimesByMonth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHBugSouthTimesByMonth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHBugSouthTimesByMonth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHBugSouthTimesByMonth>() {
           @Override
           public void write(JsonWriter out, NHBugSouthTimesByMonth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHBugSouthTimesByMonth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHBugSouthTimesByMonth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHBugSouthTimesByMonth
   * @throws IOException if the JSON string is invalid with respect to NHBugSouthTimesByMonth
   */
  public static NHBugSouthTimesByMonth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHBugSouthTimesByMonth.class);
  }

  /**
   * Convert an instance of NHBugSouthTimesByMonth to an JSON string
   *
   * @return JSON string
   */
