...
public class NHBugNorth {
  ...
  private NHBugNorthTimesByMonth timesByMonth;

  public NHBugNorth() {
  }

  public NHBugNorth availabilityArray(List<NHBugNorthAvailabilityArrayInner> availabilityArray) {
    this.availabilityArray = availabilityArray;
    return this;
  }

  public NHBugNorth addAvailabilityArrayItem(NHBugNorthAvailabilityArrayInner availabilityArrayItem) {
  ...
  public NHBugNorth months(String months) {
    this.months = months;
    return this;
  }
  ...
  public NHBugNorth monthsArray(List<Integer> monthsArray) {
    this.monthsArray = monthsArray;
    return this;
  }

  public NHBugNorth addMonthsArrayItem(Integer monthsArrayItem) {
  ...
  public NHBugNorth timesByMonth(NHBugNorthTimesByMonth timesByMonth) {
   ...
   */
  @javax.annotation.Nullable
  public NHBugNorthTimesByMonth getTimesByMonth() {
    return timesByMonth;
  }

  public void setTimesByMonth(NHBugNorthTimesByMonth timesByMonth) {
    this.timesByMonth = timesByMonth;
  }
  ...
  public boolean equals(Object o) {
    ...
    NHBugNorth nhBugNorth = (NHBugNorth) o;
    return Objects.equals(this.availabilityArray, nhBugNorth.availabilityArray) &&
        Objects.equals(this.months, nhBugNorth.months) &&
        Objects.equals(this.monthsArray, nhBugNorth.monthsArray) &&
        Objects.equals(this.timesByMonth, nhBugNorth.timesByMonth);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHBugNorth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHBugNorth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHBugNorth is not found in the empty JSON string", NHBugNorth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHBugNorth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHBugNorth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("times_by_month") != null && !jsonObj.get("times_by_month").isJsonNull()) {
        NHBugNorthTimesByMonth.validateJsonElement(jsonObj.get("times_by_month"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHBugNorth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHBugNorth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHBugNorth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHBugNorth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHBugNorth>() {
           @Override
           public void write(JsonWriter out, NHBugNorth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHBugNorth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHBugNorth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHBugNorth
   * @throws IOException if the JSON string is invalid with respect to NHBugNorth
   */
  public static NHBugNorth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHBugNorth.class);
  }

  /**
   * Convert an instance of NHBugNorth to an JSON string
   *
   * @return JSON string
   */
