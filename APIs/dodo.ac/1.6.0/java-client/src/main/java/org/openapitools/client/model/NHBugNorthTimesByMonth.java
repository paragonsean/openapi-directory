...
public class NHBugNorthTimesByMonth {
  ...
  public NHBugNorthTimesByMonth _1(String _1) {
    this._1 = _1;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _2(String _2) {
    this._2 = _2;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _3(String _3) {
    this._3 = _3;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _4(String _4) {
    this._4 = _4;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _5(String _5) {
    this._5 = _5;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _6(String _6) {
    this._6 = _6;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _7(String _7) {
    this._7 = _7;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _8(String _8) {
    this._8 = _8;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _9(String _9) {
    this._9 = _9;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _10(String _10) {
    this._10 = _10;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _11(String _11) {
    this._11 = _11;
    return this;
  }
  ...
  public NHBugNorthTimesByMonth _12(String _12) {
    this._12 = _12;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NHBugNorthTimesByMonth nhBugNorthTimesByMonth = (NHBugNorthTimesByMonth) o;
    return Objects.equals(this._1, nhBugNorthTimesByMonth._1) &&
        Objects.equals(this._2, nhBugNorthTimesByMonth._2) &&
        Objects.equals(this._3, nhBugNorthTimesByMonth._3) &&
        Objects.equals(this._4, nhBugNorthTimesByMonth._4) &&
        Objects.equals(this._5, nhBugNorthTimesByMonth._5) &&
        Objects.equals(this._6, nhBugNorthTimesByMonth._6) &&
        Objects.equals(this._7, nhBugNorthTimesByMonth._7) &&
        Objects.equals(this._8, nhBugNorthTimesByMonth._8) &&
        Objects.equals(this._9, nhBugNorthTimesByMonth._9) &&
        Objects.equals(this._10, nhBugNorthTimesByMonth._10) &&
        Objects.equals(this._11, nhBugNorthTimesByMonth._11) &&
        Objects.equals(this._12, nhBugNorthTimesByMonth._12);
  }
  ...
  public String toString() {
    ...
    sb.append("class NHBugNorthTimesByMonth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHBugNorthTimesByMonth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHBugNorthTimesByMonth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHBugNorthTimesByMonth is not found in the empty JSON string", NHBugNorthTimesByMonth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHBugNorthTimesByMonth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHBugNorthTimesByMonth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHBugNorthTimesByMonth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHBugNorthTimesByMonth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHBugNorthTimesByMonth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHBugNorthTimesByMonth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHBugNorthTimesByMonth>() {
           @Override
           public void write(JsonWriter out, NHBugNorthTimesByMonth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHBugNorthTimesByMonth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHBugNorthTimesByMonth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHBugNorthTimesByMonth
   * @throws IOException if the JSON string is invalid with respect to NHBugNorthTimesByMonth
   */
  public static NHBugNorthTimesByMonth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHBugNorthTimesByMonth.class);
  }

  /**
   * Convert an instance of NHBugNorthTimesByMonth to an JSON string
   *
   * @return JSON string
   */
