...
public class NHFishNorthTimesByMonth {
  ...
  public NHFishNorthTimesByMonth _1(String _1) {
    this._1 = _1;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _2(String _2) {
    this._2 = _2;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _3(String _3) {
    this._3 = _3;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _4(String _4) {
    this._4 = _4;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _5(String _5) {
    this._5 = _5;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _6(String _6) {
    this._6 = _6;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _7(String _7) {
    this._7 = _7;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _8(String _8) {
    this._8 = _8;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _9(String _9) {
    this._9 = _9;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _10(String _10) {
    this._10 = _10;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _11(String _11) {
    this._11 = _11;
    return this;
  }
  ...
  public NHFishNorthTimesByMonth _12(String _12) {
    this._12 = _12;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NHFishNorthTimesByMonth nhFishNorthTimesByMonth = (NHFishNorthTimesByMonth) o;
    return Objects.equals(this._1, nhFishNorthTimesByMonth._1) &&
        Objects.equals(this._2, nhFishNorthTimesByMonth._2) &&
        Objects.equals(this._3, nhFishNorthTimesByMonth._3) &&
        Objects.equals(this._4, nhFishNorthTimesByMonth._4) &&
        Objects.equals(this._5, nhFishNorthTimesByMonth._5) &&
        Objects.equals(this._6, nhFishNorthTimesByMonth._6) &&
        Objects.equals(this._7, nhFishNorthTimesByMonth._7) &&
        Objects.equals(this._8, nhFishNorthTimesByMonth._8) &&
        Objects.equals(this._9, nhFishNorthTimesByMonth._9) &&
        Objects.equals(this._10, nhFishNorthTimesByMonth._10) &&
        Objects.equals(this._11, nhFishNorthTimesByMonth._11) &&
        Objects.equals(this._12, nhFishNorthTimesByMonth._12);
  }
  ...
  public String toString() {
    ...
    sb.append("class NHFishNorthTimesByMonth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHFishNorthTimesByMonth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHFishNorthTimesByMonth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHFishNorthTimesByMonth is not found in the empty JSON string", NHFishNorthTimesByMonth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHFishNorthTimesByMonth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHFishNorthTimesByMonth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHFishNorthTimesByMonth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHFishNorthTimesByMonth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHFishNorthTimesByMonth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHFishNorthTimesByMonth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHFishNorthTimesByMonth>() {
           @Override
           public void write(JsonWriter out, NHFishNorthTimesByMonth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHFishNorthTimesByMonth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHFishNorthTimesByMonth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHFishNorthTimesByMonth
   * @throws IOException if the JSON string is invalid with respect to NHFishNorthTimesByMonth
   */
  public static NHFishNorthTimesByMonth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHFishNorthTimesByMonth.class);
  }

  /**
   * Convert an instance of NHFishNorthTimesByMonth to an JSON string
   *
   * @return JSON string
   */
