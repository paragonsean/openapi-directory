...
public class NHSeaCreatureNorthTimesByMonth {
  ...
  public NHSeaCreatureNorthTimesByMonth _1(String _1) {
    this._1 = _1;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _2(String _2) {
    this._2 = _2;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _3(String _3) {
    this._3 = _3;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _4(String _4) {
    this._4 = _4;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _5(String _5) {
    this._5 = _5;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _6(String _6) {
    this._6 = _6;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _7(String _7) {
    this._7 = _7;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _8(String _8) {
    this._8 = _8;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _9(String _9) {
    this._9 = _9;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _10(String _10) {
    this._10 = _10;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _11(String _11) {
    this._11 = _11;
    return this;
  }
  ...
  public NHSeaCreatureNorthTimesByMonth _12(String _12) {
    this._12 = _12;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NHSeaCreatureNorthTimesByMonth nhSeaCreatureNorthTimesByMonth = (NHSeaCreatureNorthTimesByMonth) o;
    return Objects.equals(this._1, nhSeaCreatureNorthTimesByMonth._1) &&
        Objects.equals(this._2, nhSeaCreatureNorthTimesByMonth._2) &&
        Objects.equals(this._3, nhSeaCreatureNorthTimesByMonth._3) &&
        Objects.equals(this._4, nhSeaCreatureNorthTimesByMonth._4) &&
        Objects.equals(this._5, nhSeaCreatureNorthTimesByMonth._5) &&
        Objects.equals(this._6, nhSeaCreatureNorthTimesByMonth._6) &&
        Objects.equals(this._7, nhSeaCreatureNorthTimesByMonth._7) &&
        Objects.equals(this._8, nhSeaCreatureNorthTimesByMonth._8) &&
        Objects.equals(this._9, nhSeaCreatureNorthTimesByMonth._9) &&
        Objects.equals(this._10, nhSeaCreatureNorthTimesByMonth._10) &&
        Objects.equals(this._11, nhSeaCreatureNorthTimesByMonth._11) &&
        Objects.equals(this._12, nhSeaCreatureNorthTimesByMonth._12);
  }
  ...
  public String toString() {
    ...
    sb.append("class NHSeaCreatureNorthTimesByMonth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHSeaCreatureNorthTimesByMonth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHSeaCreatureNorthTimesByMonth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHSeaCreatureNorthTimesByMonth is not found in the empty JSON string", NHSeaCreatureNorthTimesByMonth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHSeaCreatureNorthTimesByMonth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHSeaCreatureNorthTimesByMonth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHSeaCreatureNorthTimesByMonth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHSeaCreatureNorthTimesByMonth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHSeaCreatureNorthTimesByMonth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHSeaCreatureNorthTimesByMonth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHSeaCreatureNorthTimesByMonth>() {
           @Override
           public void write(JsonWriter out, NHSeaCreatureNorthTimesByMonth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHSeaCreatureNorthTimesByMonth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHSeaCreatureNorthTimesByMonth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHSeaCreatureNorthTimesByMonth
   * @throws IOException if the JSON string is invalid with respect to NHSeaCreatureNorthTimesByMonth
   */
  public static NHSeaCreatureNorthTimesByMonth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHSeaCreatureNorthTimesByMonth.class);
  }

  /**
   * Convert an instance of NHSeaCreatureNorthTimesByMonth to an JSON string
   *
   * @return JSON string
   */
