...
public class NHSeaCreatureNorth {
  ...
  public NHSeaCreatureNorth availabilityArray(List<NHBugNorthAvailabilityArrayInner> availabilityArray) {
    this.availabilityArray = availabilityArray;
    return this;
  }

  public NHSeaCreatureNorth addAvailabilityArrayItem(NHBugNorthAvailabilityArrayInner availabilityArrayItem) {
  ...
  public NHSeaCreatureNorth months(String months) {
    this.months = months;
    return this;
  }
  ...
  public NHSeaCreatureNorth monthsArray(List<Integer> monthsArray) {
    this.monthsArray = monthsArray;
    return this;
  }

  public NHSeaCreatureNorth addMonthsArrayItem(Integer monthsArrayItem) {
  ...
  public NHSeaCreatureNorth timesByMonth(NHSeaCreatureNorthTimesByMonth timesByMonth) {
  ...
  public boolean equals(Object o) {
    ...
    NHSeaCreatureNorth nhSeaCreatureNorth = (NHSeaCreatureNorth) o;
    return Objects.equals(this.availabilityArray, nhSeaCreatureNorth.availabilityArray) &&
        Objects.equals(this.months, nhSeaCreatureNorth.months) &&
        Objects.equals(this.monthsArray, nhSeaCreatureNorth.monthsArray) &&
        Objects.equals(this.timesByMonth, nhSeaCreatureNorth.timesByMonth);
  }
  ...
  public String toString() {
    ...
    sb.append("class NHSeaCreatureNorth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHSeaCreatureNorth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHSeaCreatureNorth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHSeaCreatureNorth is not found in the empty JSON string", NHSeaCreatureNorth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHSeaCreatureNorth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHSeaCreatureNorth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHSeaCreatureNorth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHSeaCreatureNorth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHSeaCreatureNorth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHSeaCreatureNorth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHSeaCreatureNorth>() {
           @Override
           public void write(JsonWriter out, NHSeaCreatureNorth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHSeaCreatureNorth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHSeaCreatureNorth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHSeaCreatureNorth
   * @throws IOException if the JSON string is invalid with respect to NHSeaCreatureNorth
   */
  public static NHSeaCreatureNorth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHSeaCreatureNorth.class);
  }

  /**
   * Convert an instance of NHSeaCreatureNorth to an JSON string
   *
   * @return JSON string
   */
