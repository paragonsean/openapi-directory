...
public class NHFishSouth {
  ...
  private NHFishSouthTimesByMonth timesByMonth;

  public NHFishSouth() {
  }

  public NHFishSouth availabilityArray(List<NHBugNorthAvailabilityArrayInner> availabilityArray) {
    this.availabilityArray = availabilityArray;
    return this;
  }

  public NHFishSouth addAvailabilityArrayItem(NHBugNorthAvailabilityArrayInner availabilityArrayItem) {
  ...
  public NHFishSouth months(String months) {
    this.months = months;
    return this;
  }
  ...
  public NHFishSouth monthsArray(List<Integer> monthsArray) {
    this.monthsArray = monthsArray;
    return this;
  }

  public NHFishSouth addMonthsArrayItem(Integer monthsArrayItem) {
  ...
  public NHFishSouth timesByMonth(NHFishSouthTimesByMonth timesByMonth) {
   ...
   */
  @javax.annotation.Nullable
  public NHFishSouthTimesByMonth getTimesByMonth() {
    return timesByMonth;
  }

  public void setTimesByMonth(NHFishSouthTimesByMonth timesByMonth) {
    this.timesByMonth = timesByMonth;
  }
  ...
  public boolean equals(Object o) {
    ...
    NHFishSouth nhFishSouth = (NHFishSouth) o;
    return Objects.equals(this.availabilityArray, nhFishSouth.availabilityArray) &&
        Objects.equals(this.months, nhFishSouth.months) &&
        Objects.equals(this.monthsArray, nhFishSouth.monthsArray) &&
        Objects.equals(this.timesByMonth, nhFishSouth.timesByMonth);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NHFishSouth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NHFishSouth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NHFishSouth is not found in the empty JSON string", NHFishSouth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NHFishSouth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NHFishSouth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("times_by_month") != null && !jsonObj.get("times_by_month").isJsonNull()) {
        NHFishSouthTimesByMonth.validateJsonElement(jsonObj.get("times_by_month"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NHFishSouth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NHFishSouth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NHFishSouth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NHFishSouth.class));

       return (TypeAdapter<T>) new TypeAdapter<NHFishSouth>() {
           @Override
           public void write(JsonWriter out, NHFishSouth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NHFishSouth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NHFishSouth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NHFishSouth
   * @throws IOException if the JSON string is invalid with respect to NHFishSouth
   */
  public static NHFishSouth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NHFishSouth.class);
  }

  /**
   * Convert an instance of NHFishSouth to an JSON string
   *
   * @return JSON string
   */
