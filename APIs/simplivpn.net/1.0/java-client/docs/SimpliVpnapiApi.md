...
public class Example {
  public static void main(String[] args) {
    ...
    SimpliVpnapiApi apiInstance = new SimpliVpnapiApi(defaultClient);
    EnableUser enableUser = new EnableUser(); // EnableUser | 
    try {
      apiInstance.enableUser(enableUser);
    } catch (ApiException e) {
      System.err.println("Exception when calling SimpliVpnapiApi#enableUser");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    SimpliVpnapiApi apiInstance = new SimpliVpnapiApi(defaultClient);
    try {
      apiInstance.getServerSummaries();
    } catch (ApiException e) {
      System.err.println("Exception when calling SimpliVpnapiApi#getServerSummaries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SimpliVpnapiApi#getServers");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.login(userLogin);
    } catch (ApiException e) {
      System.err.println("Exception when calling SimpliVpnapiApi#login");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling SimpliVpnapiApi#register");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    EnableUser enableUser = new EnableUser(); // EnableUser | 
    try {
      apiInstance.usernameAvailable(enableUser);
    } catch (ApiException e) {
      System.err.println("Exception when calling SimpliVpnapiApi#usernameAvailable");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
