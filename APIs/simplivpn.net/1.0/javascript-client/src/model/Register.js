...
class Register {
    ...
    constructor(password, username) { 
        ...
        Register.initialize(this, password, username);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('await')) {
                obj['await'] = ApiClient.convertToType(data['await'], 'Boolean');
            }
...
Register.RequiredProperties = ["password", "username"];

/**
 * @member {Boolean} await
 */
Register.prototype['await'] = undefined;
