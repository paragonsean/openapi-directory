...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MonVoyagePasCherComPublicApi.CitiesData();
  });
  ...
  describe('CitiesData', function() {
    it('should create an instance of CitiesData', function() {
      // uncomment below and update the code to test CitiesData
      //var instance = new MonVoyagePasCherComPublicApi.CitiesData();
      //expect(instance).to.be.a(MonVoyagePasCherComPublicApi.CitiesData);
    });
