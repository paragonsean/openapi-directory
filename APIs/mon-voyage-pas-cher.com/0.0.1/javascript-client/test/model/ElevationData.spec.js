...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MonVoyagePasCherComPublicApi.ElevationData();
  });
  ...
  describe('ElevationData', function() {
    it('should create an instance of ElevationData', function() {
      // uncomment below and update the code to test ElevationData
      //var instance = new MonVoyagePasCherComPublicApi.ElevationData();
      //expect(instance).to.be.a(MonVoyagePasCherComPublicApi.ElevationData);
    });
