...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MonVoyagePasCherComPublicApi.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new MonVoyagePasCherComPublicApi.ErrorResponse();
      //expect(instance).to.be.a(MonVoyagePasCherComPublicApi.ErrorResponse);
    });
