...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Covid19DataApi.CountryRead();
  });
  ...
  describe('CountryRead', function() {
    it('should create an instance of CountryRead', function() {
      // uncomment below and update the code to test CountryRead
      //var instance = new Covid19DataApi.CountryRead();
      //expect(instance).to.be.a(Covid19DataApi.CountryRead);
    });
