...
public class CompanySearchName200ResponseInner {
  ...
  public CompanySearchName200ResponseInner() {
  }

  public CompanySearchName200ResponseInner address(List<String> address) {
    this.address = address;
    return this;
  }

  public CompanySearchName200ResponseInner addAddressItem(String addressItem) {
  ...
  public CompanySearchName200ResponseInner country(String country) {
  ...
  public CompanySearchName200ResponseInner dateOfIncorporation(String dateOfIncorporation) {
  ...
  public CompanySearchName200ResponseInner extraData(Object extraData) {
  ...
  public CompanySearchName200ResponseInner formattedAddress(List<String> formattedAddress) {
    this.formattedAddress = formattedAddress;
    return this;
  }

  public CompanySearchName200ResponseInner addFormattedAddressItem(String formattedAddressItem) {
  ...
  public CompanySearchName200ResponseInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CompanySearchName200ResponseInner legalForm(String legalForm) {
  ...
  public CompanySearchName200ResponseInner managingDirectors(List<String> managingDirectors) {
    this.managingDirectors = managingDirectors;
    return this;
  }

  public CompanySearchName200ResponseInner addManagingDirectorsItem(String managingDirectorsItem) {
  ...
  public CompanySearchName200ResponseInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CompanySearchName200ResponseInner registrationNumber(String registrationNumber) {
  ...
  public CompanySearchName200ResponseInner requestTime(Integer requestTime) {
  ...
  public CompanySearchName200ResponseInner secretaries(List<String> secretaries) {
    this.secretaries = secretaries;
    return this;
  }

  public CompanySearchName200ResponseInner addSecretariesItem(String secretariesItem) {
  ...
  public CompanySearchName200ResponseInner sicNaceCodes(List<String> sicNaceCodes) {
    this.sicNaceCodes = sicNaceCodes;
    return this;
  }

  public CompanySearchName200ResponseInner addSicNaceCodesItem(String sicNaceCodesItem) {
  ...
  public CompanySearchName200ResponseInner status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompanySearchName200ResponseInner companySearchName200ResponseInner = (CompanySearchName200ResponseInner) o;
    return Objects.equals(this.address, companySearchName200ResponseInner.address) &&
        Objects.equals(this.country, companySearchName200ResponseInner.country) &&
        Objects.equals(this.dateOfIncorporation, companySearchName200ResponseInner.dateOfIncorporation) &&
        Objects.equals(this.extraData, companySearchName200ResponseInner.extraData) &&
        Objects.equals(this.formattedAddress, companySearchName200ResponseInner.formattedAddress) &&
        Objects.equals(this.id, companySearchName200ResponseInner.id) &&
        Objects.equals(this.legalForm, companySearchName200ResponseInner.legalForm) &&
        Objects.equals(this.managingDirectors, companySearchName200ResponseInner.managingDirectors) &&
        Objects.equals(this.name, companySearchName200ResponseInner.name) &&
        Objects.equals(this.registrationNumber, companySearchName200ResponseInner.registrationNumber) &&
        Objects.equals(this.requestTime, companySearchName200ResponseInner.requestTime) &&
        Objects.equals(this.secretaries, companySearchName200ResponseInner.secretaries) &&
        Objects.equals(this.sicNaceCodes, companySearchName200ResponseInner.sicNaceCodes) &&
        Objects.equals(this.status, companySearchName200ResponseInner.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanySearchName200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompanySearchName200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanySearchName200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanySearchName200ResponseInner is not found in the empty JSON string", CompanySearchName200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanySearchName200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanySearchName200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanySearchName200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanySearchName200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanySearchName200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanySearchName200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanySearchName200ResponseInner>() {
           @Override
           public void write(JsonWriter out, CompanySearchName200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompanySearchName200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompanySearchName200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompanySearchName200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to CompanySearchName200ResponseInner
   */
  public static CompanySearchName200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanySearchName200ResponseInner.class);
  }

  /**
   * Convert an instance of CompanySearchName200ResponseInner to an JSON string
   *
   * @return JSON string
   */
