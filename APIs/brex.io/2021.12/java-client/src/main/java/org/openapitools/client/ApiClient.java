...
public class ApiClient {
    ...
    private String basePath = "https://api.kompany.com";
    ...
    public ApiClient() {
        ...
        authentications.put("user_key", new ApiKeyAuth("header", "user_key"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021.12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.kompany.com
