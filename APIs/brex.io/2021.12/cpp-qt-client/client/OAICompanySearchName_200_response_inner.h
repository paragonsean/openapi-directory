...
/*
 * OAICompanySearchName_200_response_inner.h
 *
 * 
 */

#ifndef OAICompanySearchName_200_response_inner_H
#define OAICompanySearchName_200_response_inner_H
...
class OAICompanySearchName_200_response_inner : public OAIObject {
public:
    OAICompanySearchName_200_response_inner();
    OAICompanySearchName_200_response_inner(QString json);
    ~OAICompanySearchName_200_response_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanySearchName_200_response_inner)

#endif // OAICompanySearchName_200_response_inner_H
