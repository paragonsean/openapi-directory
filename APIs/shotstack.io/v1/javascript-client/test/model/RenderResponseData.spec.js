...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shotstack.RenderResponseData();
  });
  ...
  describe('RenderResponseData', function() {
    it('should create an instance of RenderResponseData', function() {
      // uncomment below and update the code to test RenderResponseData
      //var instance = new Shotstack.RenderResponseData();
      //expect(instance).to.be.a(Shotstack.RenderResponseData);
    });
