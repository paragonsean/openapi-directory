...
(function(root, factory) {
  ...
  describe('Poster', function() {
    it('should create an instance of Poster', function() {
      // uncomment below and update the code to test Poster
      //var instance = new Shotstack.Poster();
      //expect(instance).to.be.a(Shotstack.Poster);
    });
