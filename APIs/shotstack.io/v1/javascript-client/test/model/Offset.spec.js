...
(function(root, factory) {
  ...
  describe('Offset', function() {
    it('should create an instance of Offset', function() {
      // uncomment below and update the code to test Offset
      //var instance = new Shotstack.Offset();
      //expect(instance).to.be.a(Shotstack.Offset);
    });
