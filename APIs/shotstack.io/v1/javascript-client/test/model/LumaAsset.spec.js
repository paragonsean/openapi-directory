...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shotstack.LumaAsset();
  });
  ...
  describe('LumaAsset', function() {
    it('should create an instance of LumaAsset', function() {
      // uncomment below and update the code to test LumaAsset
      //var instance = new Shotstack.LumaAsset();
      //expect(instance).to.be.a(Shotstack.LumaAsset);
    });
