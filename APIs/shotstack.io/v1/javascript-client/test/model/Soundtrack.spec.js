...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shotstack.Soundtrack();
  });
  ...
  describe('Soundtrack', function() {
    it('should create an instance of Soundtrack', function() {
      // uncomment below and update the code to test Soundtrack
      //var instance = new Shotstack.Soundtrack();
      //expect(instance).to.be.a(Shotstack.Soundtrack);
    });
