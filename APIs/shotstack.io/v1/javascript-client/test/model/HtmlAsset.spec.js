...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shotstack.HtmlAsset();
  });
  ...
  describe('HtmlAsset', function() {
    it('should create an instance of HtmlAsset', function() {
      // uncomment below and update the code to test HtmlAsset
      //var instance = new Shotstack.HtmlAsset();
      //expect(instance).to.be.a(Shotstack.HtmlAsset);
    });
