...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shotstack.VideoAsset();
  });
  ...
  describe('VideoAsset', function() {
    it('should create an instance of VideoAsset', function() {
      // uncomment below and update the code to test VideoAsset
      //var instance = new Shotstack.VideoAsset();
      //expect(instance).to.be.a(Shotstack.VideoAsset);
    });
