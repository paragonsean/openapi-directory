...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shotstack.AudioAsset();
  });
  ...
  describe('AudioAsset', function() {
    it('should create an instance of AudioAsset', function() {
      // uncomment below and update the code to test AudioAsset
      //var instance = new Shotstack.AudioAsset();
      //expect(instance).to.be.a(Shotstack.AudioAsset);
    });
