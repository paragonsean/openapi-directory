...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Shotstack.ServeApi();
  });
  ...
  describe('ServeApi', function() {
    ...
    describe('getAssetByRenderId', function() {
      it('should call getAssetByRenderId successfully', function(done) {
        //uncomment below and update the code to test getAssetByRenderId
        //instance.getAssetByRenderId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
