...
public class ApiClient {
    ...
    private String basePath = "https://api.shotstack.io/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("DeveloperKey", new ApiKeyAuth("header", "x-api-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.shotstack.io/v1
