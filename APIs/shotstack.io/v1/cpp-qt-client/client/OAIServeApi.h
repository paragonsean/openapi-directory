...
#ifndef OAI_OAIServeApi_H
#define OAI_OAIServeApi_H
...
class OAIServeApi : public QObject {
    Q_OBJECT

public:
    OAIServeApi(const int timeOut = 0);
    ~OAIServeApi();
    ...
    */
    virtual void deleteAsset(const QString &id);

    /**
    * @param[in]  id QString [required]
    */
    virtual void getAsset(const QString &id);

    /**
    * @param[in]  id QString [required]
    */
    virtual void getAssetByRenderId(const QString &id);
...
private:
    ...
    void getAssetByRenderIdCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void deleteAssetSignal();
    void getAssetSignal(OAIAssetResponse summary);
    void getAssetByRenderIdSignal(OAIAssetRenderResponse summary);
    ...
    void getAssetByRenderIdSignalFull(OAIHttpRequestWorker *worker, OAIAssetRenderResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use getAssetByRenderIdSignalError() instead")
    void getAssetByRenderIdSignalE(OAIAssetRenderResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAssetByRenderIdSignalError(OAIAssetRenderResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getAssetByRenderIdSignalErrorFull() instead")
    void getAssetByRenderIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAssetByRenderIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
