...
public class PulsarRulePostTarget {
  ...
  public PulsarRulePostTarget() {
  }

  public PulsarRulePostTarget authentication(PulsarRulePatchTargetAuthentication authentication) {
  ...
  public PulsarRulePostTarget enveloped(Boolean enveloped) {
  ...
  public PulsarRulePostTarget format(String format) {
    this.format = format;
    return this;
  }
  ...
  public PulsarRulePostTarget routingKey(String routingKey) {
  ...
  public PulsarRulePostTarget serviceUrl(String serviceUrl) {
  ...
  public PulsarRulePostTarget tlsTrustCerts(List<String> tlsTrustCerts) {
    this.tlsTrustCerts = tlsTrustCerts;
    return this;
  }

  public PulsarRulePostTarget addTlsTrustCertsItem(String tlsTrustCertsItem) {
  ...
  public PulsarRulePostTarget topic(String topic) {
    this.topic = topic;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PulsarRulePostTarget pulsarRulePostTarget = (PulsarRulePostTarget) o;
    return Objects.equals(this.authentication, pulsarRulePostTarget.authentication) &&
        Objects.equals(this.enveloped, pulsarRulePostTarget.enveloped) &&
        Objects.equals(this.format, pulsarRulePostTarget.format) &&
        Objects.equals(this.routingKey, pulsarRulePostTarget.routingKey) &&
        Objects.equals(this.serviceUrl, pulsarRulePostTarget.serviceUrl) &&
        Objects.equals(this.tlsTrustCerts, pulsarRulePostTarget.tlsTrustCerts) &&
        Objects.equals(this.topic, pulsarRulePostTarget.topic);
  }
  ...
  public String toString() {
    ...
    sb.append("class PulsarRulePostTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PulsarRulePostTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PulsarRulePostTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PulsarRulePostTarget is not found in the empty JSON string", PulsarRulePostTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PulsarRulePostTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PulsarRulePostTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PulsarRulePostTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PulsarRulePostTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PulsarRulePostTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PulsarRulePostTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PulsarRulePostTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<PulsarRulePostTarget>() {
           @Override
           public void write(JsonWriter out, PulsarRulePostTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PulsarRulePostTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PulsarRulePostTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PulsarRulePostTarget
   * @throws IOException if the JSON string is invalid with respect to PulsarRulePostTarget
   */
  public static PulsarRulePostTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PulsarRulePostTarget.class);
  }

  /**
   * Convert an instance of PulsarRulePostTarget to an JSON string
   *
   * @return JSON string
   */
