...
API V1
- API version: v1
  - Build date: 2024-10-12T12:30:01.140542-04:00[America/New_York]
...
*RulesApi* | [**appsAppIdRulesGet**](docs/RulesApi.md#appsAppIdRulesGet) | **GET** /apps/{app_id}/rules | Lists Integration rules
*RulesApi* | [**appsAppIdRulesPost**](docs/RulesApi.md#appsAppIdRulesPost) | **POST** /apps/{app_id}/rules | Creates a Integration Rule
*RulesApi* | [**appsAppIdRulesRuleIdDelete**](docs/RulesApi.md#appsAppIdRulesRuleIdDelete) | **DELETE** /apps/{app_id}/rules/{rule_id} | Deletes a Integration Rule
*RulesApi* | [**appsAppIdRulesRuleIdGet**](docs/RulesApi.md#appsAppIdRulesRuleIdGet) | **GET** /apps/{app_id}/rules/{rule_id} | Gets a Integration Rule by ID
*RulesApi* | [**appsAppIdRulesRuleIdPatch**](docs/RulesApi.md#appsAppIdRulesRuleIdPatch) | **PATCH** /apps/{app_id}/rules/{rule_id} | Updates a Integration Rule
...
## Documentation for Models
 ...
 - [KafkaRulePatch](docs/KafkaRulePatch.md)
 - [KafkaRulePatchTarget](docs/KafkaRulePatchTarget.md)
 - [KafkaRulePatchTargetAuth](docs/KafkaRulePatchTargetAuth.md)
 - [KafkaRulePatchTargetAuthSasl](docs/KafkaRulePatchTargetAuthSasl.md)
 - [KafkaRulePost](docs/KafkaRulePost.md)
 - [KafkaRulePostTarget](docs/KafkaRulePostTarget.md)
 - [KafkaRuleResponse](docs/KafkaRuleResponse.md)
 ...
 - [PulsarRulePatch](docs/PulsarRulePatch.md)
 - [PulsarRulePatchTarget](docs/PulsarRulePatchTarget.md)
 - [PulsarRulePatchTargetAuthentication](docs/PulsarRulePatchTargetAuthentication.md)
 - [PulsarRulePost](docs/PulsarRulePost.md)
 - [PulsarRulePostTarget](docs/PulsarRulePostTarget.md)
 - [PulsarRuleResponse](docs/PulsarRuleResponse.md)
 - [PulsarTokenAuth](docs/PulsarTokenAuth.md)
 - [Queue](docs/Queue.md)
