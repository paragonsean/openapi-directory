...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.AwsSqsRulePatchTarget();
  });
  ...
  describe('AwsSqsRulePatchTarget', function() {
    it('should create an instance of AwsSqsRulePatchTarget', function() {
      // uncomment below and update the code to test AwsSqsRulePatchTarget
      //var instance = new ApiV1.AwsSqsRulePatchTarget();
      //expect(instance).to.be.a(ApiV1.AwsSqsRulePatchTarget);
    });
