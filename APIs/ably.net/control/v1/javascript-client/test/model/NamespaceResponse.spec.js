...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.NamespaceResponse();
  });
  ...
  describe('NamespaceResponse', function() {
    it('should create an instance of NamespaceResponse', function() {
      ...
      //var instance = new ApiV1.NamespaceResponse();
      //expect(instance).to.be.a(ApiV1.NamespaceResponse);
    });
    ...
    it('should have the property exposeTimeserial (base name: "exposeTimeserial")', function() {
      // uncomment below and update the code to test the property exposeTimeserial
      //var instance = new ApiV1.NamespaceResponse();
      //expect(instance).to.be();
    });
