...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.KafkaRulePostTarget();
  });
  ...
  describe('KafkaRulePostTarget', function() {
    it('should create an instance of KafkaRulePostTarget', function() {
      // uncomment below and update the code to test KafkaRulePostTarget
      //var instance = new ApiV1.KafkaRulePostTarget();
      //expect(instance).to.be.a(ApiV1.KafkaRulePostTarget);
    });
