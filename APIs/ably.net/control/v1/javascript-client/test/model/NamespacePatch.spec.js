...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.NamespacePatch();
  });
  ...
  describe('NamespacePatch', function() {
    it('should create an instance of NamespacePatch', function() {
      // uncomment below and update the code to test NamespacePatch
      //var instance = new ApiV1.NamespacePatch();
      //expect(instance).to.be.a(ApiV1.NamespacePatch);
    });
