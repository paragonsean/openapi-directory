...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.KafkaRulePatchTarget();
  });
  ...
  describe('KafkaRulePatchTarget', function() {
    it('should create an instance of KafkaRulePatchTarget', function() {
      // uncomment below and update the code to test KafkaRulePatchTarget
      //var instance = new ApiV1.KafkaRulePatchTarget();
      //expect(instance).to.be.a(ApiV1.KafkaRulePatchTarget);
    });
