...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.PulsarRulePostTarget();
  });
  ...
  describe('PulsarRulePostTarget', function() {
    it('should create an instance of PulsarRulePostTarget', function() {
      // uncomment below and update the code to test PulsarRulePostTarget
      //var instance = new ApiV1.PulsarRulePostTarget();
      //expect(instance).to.be.a(ApiV1.PulsarRulePostTarget);
    });
