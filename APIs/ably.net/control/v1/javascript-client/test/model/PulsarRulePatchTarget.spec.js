...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV1.PulsarRulePatchTarget();
  });
  ...
  describe('PulsarRulePatchTarget', function() {
    it('should create an instance of PulsarRulePatchTarget', function() {
      // uncomment below and update the code to test PulsarRulePatchTarget
      //var instance = new ApiV1.PulsarRulePatchTarget();
      //expect(instance).to.be.a(ApiV1.PulsarRulePatchTarget);
    });
    ...
    it('should have the property tlsTrustCerts (base name: "tlsTrustCerts")', function() {
      // uncomment below and update the code to test the property tlsTrustCerts
      //var instance = new ApiV1.PulsarRulePatchTarget();
      //expect(instance).to.be();
    });
