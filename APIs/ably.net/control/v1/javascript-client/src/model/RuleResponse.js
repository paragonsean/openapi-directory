...
import KafkaRuleResponse from './KafkaRuleResponse';
import PulsarRuleResponse from './PulsarRuleResponse';
...
class RuleResponse {
    ...
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "KafkaRuleResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                KafkaRuleResponse.validateJSON(instance); // throw an exception if no match
                // create KafkaRuleResponse from JS object
                this.actualInstance = KafkaRuleResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into KafkaRuleResponse
            errorMessages.push("Failed to construct KafkaRuleResponse: " + err)
        }

        try {
            if (typeof instance === "PulsarRuleResponse") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                PulsarRuleResponse.validateJSON(instance); // throw an exception if no match
                // create PulsarRuleResponse from JS object
                this.actualInstance = PulsarRuleResponse.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into PulsarRuleResponse
            errorMessages.push("Failed to construct PulsarRuleResponse: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `RuleResponse` with oneOf schemas AmqpExternalRuleResponse, AmqpRuleResponse, AwsKinesisRuleResponse, AwsLambdaRuleResponse, AwsSqsRuleResponse, AzureFunctionRuleResponse, CloudflareWorkerRuleResponse, GoogleCloudFunctionRuleResponse, HttpRuleResponse, IftttRuleResponse, KafkaRuleResponse, PulsarRuleResponse, UnsupportedRuleResponse, ZapierRuleResponse. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `RuleResponse` with oneOf schemas AmqpExternalRuleResponse, AmqpRuleResponse, AwsKinesisRuleResponse, AwsLambdaRuleResponse, AwsSqsRuleResponse, AzureFunctionRuleResponse, CloudflareWorkerRuleResponse, GoogleCloudFunctionRuleResponse, HttpRuleResponse, IftttRuleResponse, KafkaRuleResponse, PulsarRuleResponse, UnsupportedRuleResponse, ZapierRuleResponse. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @param {(module:model/AmqpExternalRuleResponse|module:model/AmqpRuleResponse|module:model/AwsKinesisRuleResponse|module:model/AwsLambdaRuleResponse|module:model/AwsSqsRuleResponse|module:model/AzureFunctionRuleResponse|module:model/CloudflareWorkerRuleResponse|module:model/GoogleCloudFunctionRuleResponse|module:model/HttpRuleResponse|module:model/IftttRuleResponse|module:model/KafkaRuleResponse|module:model/PulsarRuleResponse|module:model/UnsupportedRuleResponse|module:model/ZapierRuleResponse)} obj The actual instance.
     */
