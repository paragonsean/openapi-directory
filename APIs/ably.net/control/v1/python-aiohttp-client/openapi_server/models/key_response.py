...
class KeyResponse(Model):
    ...
    def __init__(self, app_id: str=None, capability: Dict[str, List[str]]=None, created: int=None, id: str=None, key: str=None, modified: int=None, name: str=None, status: int=None):
        ...
        :param status: The status of this KeyResponse.
        """
        self.openapi_types = {
            'app_id': str,
    ...
    @property
    def status(self):
        """Gets the status of this KeyResponse.


        :return: The status of this KeyResponse.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this KeyResponse.
