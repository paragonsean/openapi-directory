...
/*
 * OAIAws_sqs_rule_response.h
 *
 * 
 */

#ifndef OAIAws_sqs_rule_response_H
#define OAIAws_sqs_rule_response_H

#include <QJsonObject>

#include "OAIAws_sqs_rule_response_target.h"
#include "OAIObject.h"
...
class OAIAws_sqs_rule_response_target;

class OAIAws_sqs_rule_response : public OAIObject {
public:
    OAIAws_sqs_rule_response();
    OAIAws_sqs_rule_response(QString json);
    ~OAIAws_sqs_rule_response() override;
    ...
    OAIAws_sqs_rule_response_target getTarget() const;
    void setTarget(const OAIAws_sqs_rule_response_target &target);
...
private:
    ...
    OAIAws_sqs_rule_response_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_sqs_rule_response)

#endif // OAIAws_sqs_rule_response_H
