...
/*
 * OAIHttp_rule_response.h
 *
 * 
 */

#ifndef OAIHttp_rule_response_H
#define OAIHttp_rule_response_H
...
class OAIHttp_rule_response : public OAIObject {
public:
    OAIHttp_rule_response();
    OAIHttp_rule_response(QString json);
    ~OAIHttp_rule_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttp_rule_response)

#endif // OAIHttp_rule_response_H
