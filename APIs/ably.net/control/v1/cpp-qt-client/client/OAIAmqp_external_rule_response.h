...
/*
 * OAIAmqp_external_rule_response.h
 *
 * 
 */

#ifndef OAIAmqp_external_rule_response_H
#define OAIAmqp_external_rule_response_H
...
class OAIAmqp_external_rule_response : public OAIObject {
public:
    OAIAmqp_external_rule_response();
    OAIAmqp_external_rule_response(QString json);
    ~OAIAmqp_external_rule_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmqp_external_rule_response)

#endif // OAIAmqp_external_rule_response_H
