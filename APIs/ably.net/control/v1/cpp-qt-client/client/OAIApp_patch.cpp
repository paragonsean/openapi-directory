...
OAIApp_patch::OAIApp_patch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApp_patch::OAIApp_patch() {
    this->initializeModel();
}

OAIApp_patch::~OAIApp_patch() {}

void OAIApp_patch::initializeModel() {
...
void OAIApp_patch::fromJson(QString jsonString) {
...
void OAIApp_patch::fromJsonObject(QJsonObject json) {
...
QString OAIApp_patch::asJson() const {
...
QJsonObject OAIApp_patch::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApp_patch::getApnsCertificate() const {
    return m_apns_certificate;
}
void OAIApp_patch::setApnsCertificate(const QString &apns_certificate) {
    m_apns_certificate = apns_certificate;
    m_apns_certificate_isSet = true;
}

bool OAIApp_patch::is_apns_certificate_Set() const{
    return m_apns_certificate_isSet;
}

bool OAIApp_patch::is_apns_certificate_Valid() const{
    return m_apns_certificate_isValid;
}

QString OAIApp_patch::getApnsPrivateKey() const {
    return m_apns_private_key;
}
void OAIApp_patch::setApnsPrivateKey(const QString &apns_private_key) {
    m_apns_private_key = apns_private_key;
    m_apns_private_key_isSet = true;
}

bool OAIApp_patch::is_apns_private_key_Set() const{
    return m_apns_private_key_isSet;
}

bool OAIApp_patch::is_apns_private_key_Valid() const{
    return m_apns_private_key_isValid;
}

bool OAIApp_patch::isApnsUseSandboxEndpoint() const {
    return m_apns_use_sandbox_endpoint;
}
void OAIApp_patch::setApnsUseSandboxEndpoint(const bool &apns_use_sandbox_endpoint) {
    m_apns_use_sandbox_endpoint = apns_use_sandbox_endpoint;
    m_apns_use_sandbox_endpoint_isSet = true;
}

bool OAIApp_patch::is_apns_use_sandbox_endpoint_Set() const{
    return m_apns_use_sandbox_endpoint_isSet;
}

bool OAIApp_patch::is_apns_use_sandbox_endpoint_Valid() const{
    return m_apns_use_sandbox_endpoint_isValid;
}

QString OAIApp_patch::getFcmKey() const {
    return m_fcm_key;
}
void OAIApp_patch::setFcmKey(const QString &fcm_key) {
    m_fcm_key = fcm_key;
    m_fcm_key_isSet = true;
}

bool OAIApp_patch::is_fcm_key_Set() const{
    return m_fcm_key_isSet;
}

bool OAIApp_patch::is_fcm_key_Valid() const{
    return m_fcm_key_isValid;
}

QString OAIApp_patch::getName() const {
    return m_name;
}
void OAIApp_patch::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIApp_patch::is_name_Set() const{
    return m_name_isSet;
}

bool OAIApp_patch::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIApp_patch::getStatus() const {
    return m_status;
}
void OAIApp_patch::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIApp_patch::is_status_Set() const{
    return m_status_isSet;
}

bool OAIApp_patch::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIApp_patch::isTlsOnly() const {
    return m_tls_only;
}
void OAIApp_patch::setTlsOnly(const bool &tls_only) {
    m_tls_only = tls_only;
    m_tls_only_isSet = true;
}

bool OAIApp_patch::is_tls_only_Set() const{
    return m_tls_only_isSet;
}

bool OAIApp_patch::is_tls_only_Valid() const{
    return m_tls_only_isValid;
}

bool OAIApp_patch::isSet() const {
...
bool OAIApp_patch::isValid() const {
