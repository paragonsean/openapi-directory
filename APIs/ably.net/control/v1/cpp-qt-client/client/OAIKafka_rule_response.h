...
/*
 * OAIKafka_rule_response.h
 *
 * 
 */

#ifndef OAIKafka_rule_response_H
#define OAIKafka_rule_response_H
...
class OAIKafka_rule_post_target;

class OAIKafka_rule_response : public OAIObject {
public:
    OAIKafka_rule_response();
    OAIKafka_rule_response(QString json);
    ~OAIKafka_rule_response() override;
    ...
    OAIKafka_rule_post_target getTarget() const;
    void setTarget(const OAIKafka_rule_post_target &target);
...
private:
    ...
    OAIKafka_rule_post_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKafka_rule_response)

#endif // OAIKafka_rule_response_H
