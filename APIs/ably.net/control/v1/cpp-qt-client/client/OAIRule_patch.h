...
class OAIPulsar_rule_patch_target;
...
public:
    ...
    OAIPulsar_rule_patch_target getTarget() const;
    void setTarget(const OAIPulsar_rule_patch_target &target);
...
private:
    ...
    OAIPulsar_rule_patch_target m_target;
    bool m_target_isSet;
