...
Q_SIGNALS:
    ...
    void meGetSignal(OAIMe summary);


    void meGetSignalFull(OAIHttpRequestWorker *worker, OAIMe summary);

    Q_DECL_DEPRECATED_X("Use meGetSignalError() instead")
    void meGetSignalE(OAIMe summary, QNetworkReply::NetworkError error_type, QString error_str);
    void meGetSignalError(OAIMe summary, QNetworkReply::NetworkError error_type, const QString &error_str);
