...
/*
 * OAIKafka_rule_post.h
 *
 * 
 */

#ifndef OAIKafka_rule_post_H
#define OAIKafka_rule_post_H
...
class OAIKafka_rule_post : public OAIObject {
public:
    OAIKafka_rule_post();
    OAIKafka_rule_post(QString json);
    ~OAIKafka_rule_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKafka_rule_post)

#endif // OAIKafka_rule_post_H
