...
/*
 * OAIAmqp_rule_patch_target.h
 *
 * 
 */

#ifndef OAIAmqp_rule_patch_target_H
#define OAIAmqp_rule_patch_target_H
...
class OAIAmqp_rule_patch_target : public OAIObject {
public:
    OAIAmqp_rule_patch_target();
    OAIAmqp_rule_patch_target(QString json);
    ~OAIAmqp_rule_patch_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmqp_rule_patch_target)

#endif // OAIAmqp_rule_patch_target_H
