...
#ifndef OAIAmqp_rule_post_H
#define OAIAmqp_rule_post_H

#include <QJsonObject>

#include "OAIAmqp_rule_post_target.h"
...
class OAIAmqp_rule_post_target;

class OAIAmqp_rule_post : public OAIObject {
public:
    OAIAmqp_rule_post();
    OAIAmqp_rule_post(QString json);
    ~OAIAmqp_rule_post() override;
    ...
    OAIAmqp_rule_post_target getTarget() const;
    void setTarget(const OAIAmqp_rule_post_target &target);
...
private:
    ...
    OAIAmqp_rule_post_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmqp_rule_post)

#endif // OAIAmqp_rule_post_H
