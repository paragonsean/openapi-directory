...
/*
 * OAIAws_sqs_rule_patch_target.h
 *
 * 
 */

#ifndef OAIAws_sqs_rule_patch_target_H
#define OAIAws_sqs_rule_patch_target_H
...
class OAIAws_sqs_rule_patch_target : public OAIObject {
public:
    OAIAws_sqs_rule_patch_target();
    OAIAws_sqs_rule_patch_target(QString json);
    ~OAIAws_sqs_rule_patch_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_sqs_rule_patch_target)

#endif // OAIAws_sqs_rule_patch_target_H
