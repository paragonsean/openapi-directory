...
/*
 * OAIPulsar_rule_response.h
 *
 * 
 */

#ifndef OAIPulsar_rule_response_H
#define OAIPulsar_rule_response_H
...
class OAIPulsar_rule_response : public OAIObject {
public:
    OAIPulsar_rule_response();
    OAIPulsar_rule_response(QString json);
    ~OAIPulsar_rule_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPulsar_rule_response)

#endif // OAIPulsar_rule_response_H
