...
/*
 * OAIGoogle_cloud_function_rule_post_target.h
 *
 * 
 */

#ifndef OAIGoogle_cloud_function_rule_post_target_H
#define OAIGoogle_cloud_function_rule_post_target_H
...
class OAIGoogle_cloud_function_rule_post_target : public OAIObject {
public:
    OAIGoogle_cloud_function_rule_post_target();
    OAIGoogle_cloud_function_rule_post_target(QString json);
    ~OAIGoogle_cloud_function_rule_post_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogle_cloud_function_rule_post_target)

#endif // OAIGoogle_cloud_function_rule_post_target_H
