...
bool OAINamespace_patch::isExposeTimeserial() const {
    return m_expose_timeserial;
}
void OAINamespace_patch::setExposeTimeserial(const bool &expose_timeserial) {
    m_expose_timeserial = expose_timeserial;
    m_expose_timeserial_isSet = true;
}

bool OAINamespace_patch::is_expose_timeserial_Set() const{
    return m_expose_timeserial_isSet;
}

bool OAINamespace_patch::is_expose_timeserial_Valid() const{
