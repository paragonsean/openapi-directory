...
qint32 OAIKey_response::getStatus() const {
    return m_status;
}
void OAIKey_response::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIKey_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIKey_response::is_status_Valid() const{
