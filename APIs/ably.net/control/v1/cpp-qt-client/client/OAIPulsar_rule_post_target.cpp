...
OAIPulsar_rule_post_target::OAIPulsar_rule_post_target(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPulsar_rule_post_target::OAIPulsar_rule_post_target() {
    this->initializeModel();
}

OAIPulsar_rule_post_target::~OAIPulsar_rule_post_target() {}

void OAIPulsar_rule_post_target::initializeModel() {
...
void OAIPulsar_rule_post_target::fromJson(QString jsonString) {
...
void OAIPulsar_rule_post_target::fromJsonObject(QJsonObject json) {
...
QString OAIPulsar_rule_post_target::asJson() const {
...
QJsonObject OAIPulsar_rule_post_target::asJsonObject() const {
    QJsonObject obj;
...
OAIPulsar_rule_patch_target_authentication OAIPulsar_rule_post_target::getAuthentication() const {
    return m_authentication;
}
void OAIPulsar_rule_post_target::setAuthentication(const OAIPulsar_rule_patch_target_authentication &authentication) {
    m_authentication = authentication;
    m_authentication_isSet = true;
}

bool OAIPulsar_rule_post_target::is_authentication_Set() const{
    return m_authentication_isSet;
}

bool OAIPulsar_rule_post_target::is_authentication_Valid() const{
    return m_authentication_isValid;
}

bool OAIPulsar_rule_post_target::isEnveloped() const {
    return m_enveloped;
}
void OAIPulsar_rule_post_target::setEnveloped(const bool &enveloped) {
    m_enveloped = enveloped;
    m_enveloped_isSet = true;
}

bool OAIPulsar_rule_post_target::is_enveloped_Set() const{
    return m_enveloped_isSet;
}

bool OAIPulsar_rule_post_target::is_enveloped_Valid() const{
    return m_enveloped_isValid;
}

QString OAIPulsar_rule_post_target::getFormat() const {
    return m_format;
}
void OAIPulsar_rule_post_target::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPulsar_rule_post_target::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPulsar_rule_post_target::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPulsar_rule_post_target::getRoutingKey() const {
    return m_routing_key;
}
void OAIPulsar_rule_post_target::setRoutingKey(const QString &routing_key) {
    m_routing_key = routing_key;
    m_routing_key_isSet = true;
}

bool OAIPulsar_rule_post_target::is_routing_key_Set() const{
    return m_routing_key_isSet;
}

bool OAIPulsar_rule_post_target::is_routing_key_Valid() const{
    return m_routing_key_isValid;
}

QString OAIPulsar_rule_post_target::getServiceUrl() const {
    return m_service_url;
}
void OAIPulsar_rule_post_target::setServiceUrl(const QString &service_url) {
    m_service_url = service_url;
    m_service_url_isSet = true;
}

bool OAIPulsar_rule_post_target::is_service_url_Set() const{
    return m_service_url_isSet;
}

bool OAIPulsar_rule_post_target::is_service_url_Valid() const{
    return m_service_url_isValid;
}

QList<QString> OAIPulsar_rule_post_target::getTlsTrustCerts() const {
    return m_tls_trust_certs;
}
void OAIPulsar_rule_post_target::setTlsTrustCerts(const QList<QString> &tls_trust_certs) {
    m_tls_trust_certs = tls_trust_certs;
    m_tls_trust_certs_isSet = true;
}

bool OAIPulsar_rule_post_target::is_tls_trust_certs_Set() const{
    return m_tls_trust_certs_isSet;
}

bool OAIPulsar_rule_post_target::is_tls_trust_certs_Valid() const{
    return m_tls_trust_certs_isValid;
}

QString OAIPulsar_rule_post_target::getTopic() const {
    return m_topic;
}
void OAIPulsar_rule_post_target::setTopic(const QString &topic) {
    m_topic = topic;
    m_topic_isSet = true;
}

bool OAIPulsar_rule_post_target::is_topic_Set() const{
    return m_topic_isSet;
}

bool OAIPulsar_rule_post_target::is_topic_Valid() const{
    return m_topic_isValid;
}

bool OAIPulsar_rule_post_target::isSet() const {
...
bool OAIPulsar_rule_post_target::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_authentication_isValid && m_service_url_isValid && m_topic_isValid && true;
}
