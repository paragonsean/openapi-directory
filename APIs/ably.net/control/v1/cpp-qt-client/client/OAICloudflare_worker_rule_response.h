...
/*
 * OAICloudflare_worker_rule_response.h
 *
 * 
 */

#ifndef OAICloudflare_worker_rule_response_H
#define OAICloudflare_worker_rule_response_H
...
class OAICloudflare_worker_rule_post_target;

class OAICloudflare_worker_rule_response : public OAIObject {
public:
    OAICloudflare_worker_rule_response();
    OAICloudflare_worker_rule_response(QString json);
    ~OAICloudflare_worker_rule_response() override;
    ...
    OAICloudflare_worker_rule_post_target getTarget() const;
    void setTarget(const OAICloudflare_worker_rule_post_target &target);
...
private:
    ...
    OAICloudflare_worker_rule_post_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudflare_worker_rule_response)

#endif // OAICloudflare_worker_rule_response_H
