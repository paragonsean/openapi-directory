...
#ifndef OAIHttp_rule_post_H
#define OAIHttp_rule_post_H

#include <QJsonObject>

#include "OAIHttp_rule_post_target.h"
...
class OAIHttp_rule_post_target;

class OAIHttp_rule_post : public OAIObject {
public:
    OAIHttp_rule_post();
    OAIHttp_rule_post(QString json);
    ~OAIHttp_rule_post() override;
    ...
    OAIHttp_rule_post_target getTarget() const;
    void setTarget(const OAIHttp_rule_post_target &target);
...
private:
    ...
    OAIHttp_rule_post_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttp_rule_post)

#endif // OAIHttp_rule_post_H
