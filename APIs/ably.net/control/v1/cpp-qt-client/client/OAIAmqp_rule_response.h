...
/*
 * OAIAmqp_rule_response.h
 *
 * 
 */

#ifndef OAIAmqp_rule_response_H
#define OAIAmqp_rule_response_H
...
class OAIAmqp_rule_response : public OAIObject {
public:
    OAIAmqp_rule_response();
    OAIAmqp_rule_response(QString json);
    ~OAIAmqp_rule_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmqp_rule_response)

#endif // OAIAmqp_rule_response_H
