...
/*
 * OAIAzure_function_rule_response.h
 *
 * 
 */

#ifndef OAIAzure_function_rule_response_H
#define OAIAzure_function_rule_response_H
...
class OAIAzure_function_rule_post_target;

class OAIAzure_function_rule_response : public OAIObject {
public:
    OAIAzure_function_rule_response();
    OAIAzure_function_rule_response(QString json);
    ~OAIAzure_function_rule_response() override;
    ...
    OAIAzure_function_rule_post_target getTarget() const;
    void setTarget(const OAIAzure_function_rule_post_target &target);
...
private:
    ...
    OAIAzure_function_rule_post_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzure_function_rule_response)

#endif // OAIAzure_function_rule_response_H
