...
/*
 * OAIAws_kinesis_rule_response.h
 *
 * 
 */

#ifndef OAIAws_kinesis_rule_response_H
#define OAIAws_kinesis_rule_response_H
...
class OAIAws_kinesis_rule_response_target;

class OAIAws_kinesis_rule_response : public OAIObject {
public:
    OAIAws_kinesis_rule_response();
    OAIAws_kinesis_rule_response(QString json);
    ~OAIAws_kinesis_rule_response() override;
    ...
    OAIAws_kinesis_rule_response_target getTarget() const;
    void setTarget(const OAIAws_kinesis_rule_response_target &target);
...
private:
    ...
    OAIAws_kinesis_rule_response_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_kinesis_rule_response)

#endif // OAIAws_kinesis_rule_response_H
