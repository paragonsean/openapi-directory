...
bool OAINamespace_post::isExposeTimeserial() const {
    return m_expose_timeserial;
}
void OAINamespace_post::setExposeTimeserial(const bool &expose_timeserial) {
    m_expose_timeserial = expose_timeserial;
    m_expose_timeserial_isSet = true;
}

bool OAINamespace_post::is_expose_timeserial_Set() const{
    return m_expose_timeserial_isSet;
}

bool OAINamespace_post::is_expose_timeserial_Valid() const{
