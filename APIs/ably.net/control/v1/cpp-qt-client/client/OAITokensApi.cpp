...
void OAITokensApi::meGet() {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITokensApi::meGetCallback);
...
void OAITokensApi::meGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIMe output(QString(worker->response));
    worker->deleteLater();
