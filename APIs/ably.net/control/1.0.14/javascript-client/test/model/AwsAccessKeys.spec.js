...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsAccessKeys();
  });
  ...
  describe('AwsAccessKeys', function() {
    it('should create an instance of AwsAccessKeys', function() {
      // uncomment below and update the code to test AwsAccessKeys
      //var instance = new ControlApiV1.AwsAccessKeys();
      //expect(instance).to.be.a(ControlApiV1.AwsAccessKeys);
    });
