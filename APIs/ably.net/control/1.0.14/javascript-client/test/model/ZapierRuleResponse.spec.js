...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.ZapierRuleResponse();
  });
  ...
  describe('ZapierRuleResponse', function() {
    it('should create an instance of ZapierRuleResponse', function() {
      // uncomment below and update the code to test ZapierRuleResponse
      //var instance = new ControlApiV1.ZapierRuleResponse();
      //expect(instance).to.be.a(ControlApiV1.ZapierRuleResponse);
    });
