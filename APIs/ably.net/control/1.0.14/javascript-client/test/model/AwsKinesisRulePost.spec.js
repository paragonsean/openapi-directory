...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsKinesisRulePost();
  });
  ...
  describe('AwsKinesisRulePost', function() {
    it('should create an instance of AwsKinesisRulePost', function() {
      // uncomment below and update the code to test AwsKinesisRulePost
      //var instance = new ControlApiV1.AwsKinesisRulePost();
      //expect(instance).to.be.a(ControlApiV1.AwsKinesisRulePost);
    });
