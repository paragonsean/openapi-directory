...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.HttpRulePost();
  });
  ...
  describe('HttpRulePost', function() {
    it('should create an instance of HttpRulePost', function() {
      // uncomment below and update the code to test HttpRulePost
      //var instance = new ControlApiV1.HttpRulePost();
      //expect(instance).to.be.a(ControlApiV1.HttpRulePost);
    });
