...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.CloudflareWorkerRulePatchTarget();
  });
  ...
  describe('CloudflareWorkerRulePatchTarget', function() {
    it('should create an instance of CloudflareWorkerRulePatchTarget', function() {
      ...
      //var instance = new ControlApiV1.CloudflareWorkerRulePatchTarget();
      //expect(instance).to.be.a(ControlApiV1.CloudflareWorkerRulePatchTarget);
    });
