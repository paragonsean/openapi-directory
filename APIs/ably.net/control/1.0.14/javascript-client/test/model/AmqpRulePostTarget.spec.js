...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AmqpRulePostTarget();
  });
  ...
  describe('AmqpRulePostTarget', function() {
    it('should create an instance of AmqpRulePostTarget', function() {
      // uncomment below and update the code to test AmqpRulePostTarget
      //var instance = new ControlApiV1.AmqpRulePostTarget();
      //expect(instance).to.be.a(ControlApiV1.AmqpRulePostTarget);
    });
