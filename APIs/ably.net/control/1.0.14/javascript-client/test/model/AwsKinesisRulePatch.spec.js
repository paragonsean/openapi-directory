...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsKinesisRulePatch();
  });
  ...
  describe('AwsKinesisRulePatch', function() {
    it('should create an instance of AwsKinesisRulePatch', function() {
      // uncomment below and update the code to test AwsKinesisRulePatch
      //var instance = new ControlApiV1.AwsKinesisRulePatch();
      //expect(instance).to.be.a(ControlApiV1.AwsKinesisRulePatch);
    });
