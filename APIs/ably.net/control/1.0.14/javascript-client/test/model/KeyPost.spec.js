...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.KeyPost();
  });
  ...
  describe('KeyPost', function() {
    it('should create an instance of KeyPost', function() {
      // uncomment below and update the code to test KeyPost
      //var instance = new ControlApiV1.KeyPost();
      //expect(instance).to.be.a(ControlApiV1.KeyPost);
    });
