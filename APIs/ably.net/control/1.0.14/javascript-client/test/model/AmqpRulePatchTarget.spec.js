...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AmqpRulePatchTarget();
  });
  ...
  describe('AmqpRulePatchTarget', function() {
    it('should create an instance of AmqpRulePatchTarget', function() {
      ...
      //var instance = new ControlApiV1.AmqpRulePatchTarget();
      //expect(instance).to.be.a(ControlApiV1.AmqpRulePatchTarget);
    });
