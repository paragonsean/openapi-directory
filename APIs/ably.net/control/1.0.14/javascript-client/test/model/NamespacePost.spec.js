...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.NamespacePost();
  });
  ...
  describe('NamespacePost', function() {
    it('should create an instance of NamespacePost', function() {
      // uncomment below and update the code to test NamespacePost
      //var instance = new ControlApiV1.NamespacePost();
      //expect(instance).to.be.a(ControlApiV1.NamespacePost);
    });
