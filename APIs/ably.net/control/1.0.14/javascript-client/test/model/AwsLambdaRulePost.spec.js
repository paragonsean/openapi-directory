...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsLambdaRulePost();
  });
  ...
  describe('AwsLambdaRulePost', function() {
    it('should create an instance of AwsLambdaRulePost', function() {
      // uncomment below and update the code to test AwsLambdaRulePost
      //var instance = new ControlApiV1.AwsLambdaRulePost();
      //expect(instance).to.be.a(ControlApiV1.AwsLambdaRulePost);
    });
