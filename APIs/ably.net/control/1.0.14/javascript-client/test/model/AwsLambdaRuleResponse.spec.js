...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsLambdaRuleResponse();
  });
  ...
  describe('AwsLambdaRuleResponse', function() {
    it('should create an instance of AwsLambdaRuleResponse', function() {
      // uncomment below and update the code to test AwsLambdaRuleResponse
      //var instance = new ControlApiV1.AwsLambdaRuleResponse();
      //expect(instance).to.be.a(ControlApiV1.AwsLambdaRuleResponse);
    });
