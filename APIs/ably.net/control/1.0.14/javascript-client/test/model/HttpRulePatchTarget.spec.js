...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.HttpRulePatchTarget();
  });
  ...
  describe('HttpRulePatchTarget', function() {
    it('should create an instance of HttpRulePatchTarget', function() {
      ...
      //var instance = new ControlApiV1.HttpRulePatchTarget();
      //expect(instance).to.be.a(ControlApiV1.HttpRulePatchTarget);
    });
