...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AzureFunctionRuleResponse();
  });
  ...
  describe('AzureFunctionRuleResponse', function() {
    it('should create an instance of AzureFunctionRuleResponse', function() {
      // uncomment below and update the code to test AzureFunctionRuleResponse
      //var instance = new ControlApiV1.AzureFunctionRuleResponse();
      //expect(instance).to.be.a(ControlApiV1.AzureFunctionRuleResponse);
    });
