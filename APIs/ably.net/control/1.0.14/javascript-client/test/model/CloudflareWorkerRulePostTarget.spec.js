...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.CloudflareWorkerRulePostTarget();
  });
  ...
  describe('CloudflareWorkerRulePostTarget', function() {
    it('should create an instance of CloudflareWorkerRulePostTarget', function() {
      ...
      //var instance = new ControlApiV1.CloudflareWorkerRulePostTarget();
      //expect(instance).to.be.a(ControlApiV1.CloudflareWorkerRulePostTarget);
    });
