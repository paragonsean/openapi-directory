...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsLambdaRulePatchTarget();
  });
  ...
  describe('AwsLambdaRulePatchTarget', function() {
    it('should create an instance of AwsLambdaRulePatchTarget', function() {
      ...
      //var instance = new ControlApiV1.AwsLambdaRulePatchTarget();
      //expect(instance).to.be.a(ControlApiV1.AwsLambdaRulePatchTarget);
    });
