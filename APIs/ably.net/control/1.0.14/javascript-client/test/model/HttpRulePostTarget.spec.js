...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.HttpRulePostTarget();
  });
  ...
  describe('HttpRulePostTarget', function() {
    it('should create an instance of HttpRulePostTarget', function() {
      // uncomment below and update the code to test HttpRulePostTarget
      //var instance = new ControlApiV1.HttpRulePostTarget();
      //expect(instance).to.be.a(ControlApiV1.HttpRulePostTarget);
    });
