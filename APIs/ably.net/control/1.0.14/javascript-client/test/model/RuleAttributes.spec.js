...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.RuleAttributes();
  });
  ...
  describe('RuleAttributes', function() {
    it('should create an instance of RuleAttributes', function() {
      // uncomment below and update the code to test RuleAttributes
      //var instance = new ControlApiV1.RuleAttributes();
      //expect(instance).to.be.a(ControlApiV1.RuleAttributes);
    });
