...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.RulePatch();
  });
  ...
  describe('RulePatch', function() {
    it('should create an instance of RulePatch', function() {
      // uncomment below and update the code to test RulePatch
      //var instance = new ControlApiV1.RulePatch();
      //expect(instance).to.be.a(ControlApiV1.RulePatch);
    });
