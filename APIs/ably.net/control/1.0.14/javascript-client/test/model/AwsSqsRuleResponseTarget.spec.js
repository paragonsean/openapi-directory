...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsSqsRuleResponseTarget();
  });
  ...
  describe('AwsSqsRuleResponseTarget', function() {
    it('should create an instance of AwsSqsRuleResponseTarget', function() {
      // uncomment below and update the code to test AwsSqsRuleResponseTarget
      //var instance = new ControlApiV1.AwsSqsRuleResponseTarget();
      //expect(instance).to.be.a(ControlApiV1.AwsSqsRuleResponseTarget);
    });
