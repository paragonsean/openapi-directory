...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsSqsRuleResponse();
  });
  ...
  describe('AwsSqsRuleResponse', function() {
    it('should create an instance of AwsSqsRuleResponse', function() {
      // uncomment below and update the code to test AwsSqsRuleResponse
      //var instance = new ControlApiV1.AwsSqsRuleResponse();
      //expect(instance).to.be.a(ControlApiV1.AwsSqsRuleResponse);
    });
