...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsSqsRulePost();
  });
  ...
  describe('AwsSqsRulePost', function() {
    it('should create an instance of AwsSqsRulePost', function() {
      // uncomment below and update the code to test AwsSqsRulePost
      //var instance = new ControlApiV1.AwsSqsRulePost();
      //expect(instance).to.be.a(ControlApiV1.AwsSqsRulePost);
    });
