...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsSqsRulePostTarget();
  });
  ...
  describe('AwsSqsRulePostTarget', function() {
    it('should create an instance of AwsSqsRulePostTarget', function() {
      // uncomment below and update the code to test AwsSqsRulePostTarget
      //var instance = new ControlApiV1.AwsSqsRulePostTarget();
      //expect(instance).to.be.a(ControlApiV1.AwsSqsRulePostTarget);
    });
