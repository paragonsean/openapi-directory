...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.RuleResponse();
  });
  ...
  describe('RuleResponse', function() {
    it('should create an instance of RuleResponse', function() {
      // uncomment below and update the code to test RuleResponse
      //var instance = new ControlApiV1.RuleResponse();
      //expect(instance).to.be.a(ControlApiV1.RuleResponse);
    });
