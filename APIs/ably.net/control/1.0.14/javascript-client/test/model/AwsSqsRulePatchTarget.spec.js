...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsSqsRulePatchTarget();
  });
  ...
  describe('AwsSqsRulePatchTarget', function() {
    it('should create an instance of AwsSqsRulePatchTarget', function() {
      ...
      //var instance = new ControlApiV1.AwsSqsRulePatchTarget();
      //expect(instance).to.be.a(ControlApiV1.AwsSqsRulePatchTarget);
    });
