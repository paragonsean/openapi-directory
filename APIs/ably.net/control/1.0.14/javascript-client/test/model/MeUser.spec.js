...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.MeUser();
  });
  ...
  describe('MeUser', function() {
    it('should create an instance of MeUser', function() {
      // uncomment below and update the code to test MeUser
      //var instance = new ControlApiV1.MeUser();
      //expect(instance).to.be.a(ControlApiV1.MeUser);
    });
