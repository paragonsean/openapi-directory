...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AmqpRuleResponse();
  });
  ...
  describe('AmqpRuleResponse', function() {
    it('should create an instance of AmqpRuleResponse', function() {
      // uncomment below and update the code to test AmqpRuleResponse
      //var instance = new ControlApiV1.AmqpRuleResponse();
      //expect(instance).to.be.a(ControlApiV1.AmqpRuleResponse);
    });
