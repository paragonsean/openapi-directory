...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.HttpRuleResponse();
  });
  ...
  describe('HttpRuleResponse', function() {
    it('should create an instance of HttpRuleResponse', function() {
      // uncomment below and update the code to test HttpRuleResponse
      //var instance = new ControlApiV1.HttpRuleResponse();
      //expect(instance).to.be.a(ControlApiV1.HttpRuleResponse);
    });
