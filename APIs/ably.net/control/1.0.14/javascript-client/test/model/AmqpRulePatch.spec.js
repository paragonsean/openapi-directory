...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AmqpRulePatch();
  });
  ...
  describe('AmqpRulePatch', function() {
    it('should create an instance of AmqpRulePatch', function() {
      // uncomment below and update the code to test AmqpRulePatch
      //var instance = new ControlApiV1.AmqpRulePatch();
      //expect(instance).to.be.a(ControlApiV1.AmqpRulePatch);
    });
