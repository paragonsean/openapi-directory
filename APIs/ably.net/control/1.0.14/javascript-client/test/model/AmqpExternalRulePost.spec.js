...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AmqpExternalRulePost();
  });
  ...
  describe('AmqpExternalRulePost', function() {
    it('should create an instance of AmqpExternalRulePost', function() {
      // uncomment below and update the code to test AmqpExternalRulePost
      //var instance = new ControlApiV1.AmqpExternalRulePost();
      //expect(instance).to.be.a(ControlApiV1.AmqpExternalRulePost);
    });
