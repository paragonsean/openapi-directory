...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsLambdaRuleResponseTarget();
  });
  ...
  describe('AwsLambdaRuleResponseTarget', function() {
    it('should create an instance of AwsLambdaRuleResponseTarget', function() {
      ...
      //var instance = new ControlApiV1.AwsLambdaRuleResponseTarget();
      //expect(instance).to.be.a(ControlApiV1.AwsLambdaRuleResponseTarget);
    });
