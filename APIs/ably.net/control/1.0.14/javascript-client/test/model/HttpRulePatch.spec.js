...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.HttpRulePatch();
  });
  ...
  describe('HttpRulePatch', function() {
    it('should create an instance of HttpRulePatch', function() {
      // uncomment below and update the code to test HttpRulePatch
      //var instance = new ControlApiV1.HttpRulePatch();
      //expect(instance).to.be.a(ControlApiV1.HttpRulePatch);
    });
