...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.MeToken();
  });
  ...
  describe('MeToken', function() {
    it('should create an instance of MeToken', function() {
      // uncomment below and update the code to test MeToken
      //var instance = new ControlApiV1.MeToken();
      //expect(instance).to.be.a(ControlApiV1.MeToken);
    });
