...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.MeAccount();
  });
  ...
  describe('MeAccount', function() {
    it('should create an instance of MeAccount', function() {
      // uncomment below and update the code to test MeAccount
      //var instance = new ControlApiV1.MeAccount();
      //expect(instance).to.be.a(ControlApiV1.MeAccount);
    });
