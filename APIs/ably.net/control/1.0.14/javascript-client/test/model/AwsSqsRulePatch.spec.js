...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.AwsSqsRulePatch();
  });
  ...
  describe('AwsSqsRulePatch', function() {
    it('should create an instance of AwsSqsRulePatch', function() {
      // uncomment below and update the code to test AwsSqsRulePatch
      //var instance = new ControlApiV1.AwsSqsRulePatch();
      //expect(instance).to.be.a(ControlApiV1.AwsSqsRulePatch);
    });
