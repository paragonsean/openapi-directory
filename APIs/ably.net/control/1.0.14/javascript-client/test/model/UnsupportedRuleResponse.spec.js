...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ControlApiV1.UnsupportedRuleResponse();
  });
  ...
  describe('UnsupportedRuleResponse', function() {
    it('should create an instance of UnsupportedRuleResponse', function() {
      // uncomment below and update the code to test UnsupportedRuleResponse
      //var instance = new ControlApiV1.UnsupportedRuleResponse();
      //expect(instance).to.be.a(ControlApiV1.UnsupportedRuleResponse);
    });
