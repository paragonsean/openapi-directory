...
class AwsLambdaRulePatch {
     ...
     * @param requestMode {module:model/AwsLambdaRulePatch.RequestModeEnum} Single request mode sends each event separately to the endpoint specified by the rule. You can read more about single request mode events in the <a href=\"https://ably.com/documentation/general/events#batching\">Ably documentation</a>.
     * @param ruleType {module:model/AwsLambdaRulePatch.RuleTypeEnum} The type of rule. In this case AWS Lambda. See the <a href=\"https://ably.com/integrations\">Ably documentation</a> for further information.
    ...
    constructor(requestMode, ruleType, source, target) { 
        ...
        AwsLambdaRulePatch.initialize(this, requestMode, ruleType, source, target);
    }
...
AwsLambdaRulePatch.RequiredProperties = ["requestMode", "ruleType", "source", "target"];
 ...
 * @member {module:model/AwsLambdaRulePatch.RequestModeEnum} requestMode
 */
 ...
 * @member {module:model/AwsLambdaRulePatch.StatusEnum} status
 */
 ...
 * @readonly
 */
AwsLambdaRulePatch['RequestModeEnum'] = {
