...
import HttpRuleResponseTarget from './HttpRuleResponseTarget';
...
class HttpRuleResponse {
     ...
     * @param requestMode {module:model/HttpRuleResponse.RequestModeEnum} This is Single Request mode or Batch Request mode. Single Request mode sends each event separately to the endpoint specified by the rule. Batch Request mode rolls up multiple events into the same request. You can read more about the difference between single and batched events in the Ably <a href=\"https://ably.com/documentation/general/events#batching\">documentation</a>.
     * @param ruleType {module:model/HttpRuleResponse.RuleTypeEnum} The type of rule. See the <a href=\"https://ably.com/integrations\">documentation</a> for further information.
     * @param source {module:model/RuleSource} 
     * @param target {module:model/HttpRuleResponseTarget} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('target')) {
                obj['target'] = HttpRuleResponseTarget.constructFromObject(data['target']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['target']) { // data not null
          HttpRuleResponseTarget.validateJSON(data['target']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/HttpRuleResponse.RequestModeEnum} requestMode
 */
 ...
 * @member {module:model/HttpRuleResponse.StatusEnum} status
 */
HttpRuleResponse.prototype['status'] = undefined;

/**
 * @member {module:model/HttpRuleResponseTarget} target
 */
 ...
 * @readonly
 */
HttpRuleResponse['RequestModeEnum'] = {
