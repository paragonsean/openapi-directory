...
class AmqpRuleResponse {
     ...
     * @param requestMode {module:model/AmqpRuleResponse.RequestModeEnum} Single request mode sends each event separately to the endpoint specified by the rule. You can read more about single request mode events in the <a href=\"https://ably.com/documentation/general/events#batching\">Ably documentation</a>.
     * @param ruleType {module:model/AmqpRuleResponse.RuleTypeEnum} The type of rule. In this case AMQP. See the <a href=\"https://ably.com/integrations\">documentation</a> for further information.
 ...
 * @member {module:model/AmqpRuleResponse.RequestModeEnum} requestMode
 */
 ...
 * @member {module:model/AmqpRuleResponse.StatusEnum} status
 */
 ...
 * @readonly
 */
AmqpRuleResponse['RequestModeEnum'] = {
