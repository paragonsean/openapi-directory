...
class IftttRuleResponse {
     ...
     * @param requestMode {module:model/IftttRuleResponse.RequestModeEnum} Single request mode sends each event separately to the endpoint specified by the rule. You can read more about single request mode events in the <a href=\"https://ably.com/documentation/general/events#batching\">Ably documentation</a>.
     * @param ruleType {module:model/IftttRuleResponse.RuleTypeEnum} The type of rule. In this case IFTTT. See the <a href=\"https://ably.com/integrations\">documentation</a> for further information.
 ...
 * @member {module:model/IftttRuleResponse.RequestModeEnum} requestMode
 */
 ...
 * @member {module:model/IftttRuleResponse.StatusEnum} status
 */
 ...
 * @readonly
 */
IftttRuleResponse['RequestModeEnum'] = {
