...
class ZapierRuleResponse {
     ...
     * @param requestMode {module:model/ZapierRuleResponse.RequestModeEnum} This is Single Request mode or Batch Request mode. Single Request mode sends each event separately to the endpoint specified by the rule. Batch Request mode rolls up multiple events into the same request. You can read more about the difference between single and batched events in the Ably <a href=\"https://ably.com/documentation/general/events#batching\">documentation</a>.
     * @param ruleType {module:model/ZapierRuleResponse.RuleTypeEnum} The type of rule. In this case Zapier. See the <a href=\"https://ably.com/integrations\">documentation</a> for further information.
 ...
 * @member {module:model/ZapierRuleResponse.RequestModeEnum} requestMode
 */
 ...
 * @member {module:model/ZapierRuleResponse.StatusEnum} status
 */
 ...
 * @readonly
 */
ZapierRuleResponse['RequestModeEnum'] = {
