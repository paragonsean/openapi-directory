...
/**
 * The HttpRuleResponseTarget model module.
 * @module model/HttpRuleResponseTarget
 * @version 1.0.14
 */
class HttpRuleResponseTarget {
    /**
     * Constructs a new <code>HttpRuleResponseTarget</code>.
     * @alias module:model/HttpRuleResponseTarget
     * @param format {module:model/HttpRuleResponseTarget.FormatEnum} JSON provides a simpler text-based encoding, whereas MsgPack provides a more efficient binary encoding.
     * @param url {String} 
     */
    constructor(format, url) { 
        
        HttpRuleResponseTarget.initialize(this, format, url);
    }
    ...
    /**
     * Constructs a <code>HttpRuleResponseTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HttpRuleResponseTarget} obj Optional instance to populate.
     * @return {module:model/HttpRuleResponseTarget} The populated <code>HttpRuleResponseTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HttpRuleResponseTarget();
    ...
    /**
     * Validates the JSON data with respect to <code>HttpRuleResponseTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HttpRuleResponseTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HttpRuleResponseTarget.RequiredProperties) {
...
HttpRuleResponseTarget.RequiredProperties = ["format", "url"];

/**
 * Messages delivered through Reactor are wrapped in an Ably envelope by default that contains metadata about the message and its payload. The form of the envelope depends on whether it is part of a Webhook/Function or a Queue/Firehose rule. For everything besides Webhooks, you can ensure you only get the raw payload by unchecking \"Enveloped\" when setting up the rule.
 * @member {Boolean} enveloped
 */
HttpRuleResponseTarget.prototype['enveloped'] = undefined;

/**
 * JSON provides a simpler text-based encoding, whereas MsgPack provides a more efficient binary encoding.
 * @member {module:model/HttpRuleResponseTarget.FormatEnum} format
 */
HttpRuleResponseTarget.prototype['format'] = undefined;
 ...
 */
HttpRuleResponseTarget.prototype['headers'] = undefined;
 ...
 */
HttpRuleResponseTarget.prototype['signingKeyId'] = undefined;

/**
 * @member {String} url
 */
HttpRuleResponseTarget.prototype['url'] = undefined;
 ...
 * @readonly
 */
HttpRuleResponseTarget['FormatEnum'] = {
...
export default HttpRuleResponseTarget;
