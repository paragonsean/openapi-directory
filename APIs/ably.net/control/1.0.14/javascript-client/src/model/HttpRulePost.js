...
/**
 * The HttpRulePost model module.
 * @module model/HttpRulePost
 * @version 1.0.14
 */
class HttpRulePost {
    /**
     * Constructs a new <code>HttpRulePost</code>.
     * @alias module:model/HttpRulePost
     * @param requestMode {module:model/HttpRulePost.RequestModeEnum} This is Single Request mode or Batch Request mode. Single Request mode sends each event separately to the endpoint specified by the rule. Batch Request mode rolls up multiple events into the same request. You can read more about the difference between single and batched events in the Ably <a href=\"https://ably.com/documentation/general/events#batching\">documentation</a>.
     * @param ruleType {module:model/HttpRulePost.RuleTypeEnum} The type of rule. See the <a href=\"https://ably.com/integrations\">documentation</a> for further information.
    ...
    constructor(requestMode, ruleType, source, target) { 
        ...
        HttpRulePost.initialize(this, requestMode, ruleType, source, target);
    }
    ...
    /**
     * Constructs a <code>HttpRulePost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HttpRulePost} obj Optional instance to populate.
     * @return {module:model/HttpRulePost} The populated <code>HttpRulePost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HttpRulePost();
    ...
    /**
     * Validates the JSON data with respect to <code>HttpRulePost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HttpRulePost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HttpRulePost.RequiredProperties) {
...
HttpRulePost.RequiredProperties = ["requestMode", "ruleType", "source", "target"];
 ...
 * @member {module:model/HttpRulePost.RequestModeEnum} requestMode
 */
HttpRulePost.prototype['requestMode'] = undefined;

/**
 * The type of rule. See the <a href=\"https://ably.com/integrations\">documentation</a> for further information.
 * @member {module:model/HttpRulePost.RuleTypeEnum} ruleType
 */
HttpRulePost.prototype['ruleType'] = undefined;

/**
 * @member {module:model/RuleSource} source
 */
HttpRulePost.prototype['source'] = undefined;

/**
 * The status of the rule. Rules can be enabled or disabled.
 * @member {module:model/HttpRulePost.StatusEnum} status
 */
HttpRulePost.prototype['status'] = undefined;

/**
 * @member {module:model/HttpRulePostTarget} target
 */
HttpRulePost.prototype['target'] = undefined;
