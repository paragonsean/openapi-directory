...
class AwsLambdaRulePost {
     ...
     * @param requestMode {module:model/AwsLambdaRulePost.RequestModeEnum} Single request mode sends each event separately to the endpoint specified by the rule. You can read more about single request mode events in the <a href=\"https://ably.com/documentation/general/events#batching\">Ably documentation</a>.
     * @param ruleType {module:model/AwsLambdaRulePost.RuleTypeEnum} The type of rule. In this case AWS Lambda. See the <a href=\"https://ably.com/integrations\">documentation</a> for further information.
 ...
 * @member {module:model/AwsLambdaRulePost.RequestModeEnum} requestMode
 */
 ...
 * @member {module:model/AwsLambdaRulePost.StatusEnum} status
 */
 ...
 * @readonly
 */
AwsLambdaRulePost['RequestModeEnum'] = {
