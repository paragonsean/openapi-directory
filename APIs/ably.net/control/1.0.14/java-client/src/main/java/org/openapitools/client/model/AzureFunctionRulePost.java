...
public class AzureFunctionRulePost {
  ...
  public AzureFunctionRulePost() {
  }

  public AzureFunctionRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public AzureFunctionRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public AzureFunctionRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AzureFunctionRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AzureFunctionRulePost target(AzureFunctionRulePostTarget target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AzureFunctionRulePost azureFunctionRulePost = (AzureFunctionRulePost) o;
    return Objects.equals(this.requestMode, azureFunctionRulePost.requestMode) &&
        Objects.equals(this.ruleType, azureFunctionRulePost.ruleType) &&
        Objects.equals(this.source, azureFunctionRulePost.source) &&
        Objects.equals(this.status, azureFunctionRulePost.status) &&
        Objects.equals(this.target, azureFunctionRulePost.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class AzureFunctionRulePost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AzureFunctionRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AzureFunctionRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AzureFunctionRulePost is not found in the empty JSON string", AzureFunctionRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AzureFunctionRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AzureFunctionRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AzureFunctionRulePost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AzureFunctionRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AzureFunctionRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AzureFunctionRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AzureFunctionRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<AzureFunctionRulePost>() {
           @Override
           public void write(JsonWriter out, AzureFunctionRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AzureFunctionRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AzureFunctionRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AzureFunctionRulePost
   * @throws IOException if the JSON string is invalid with respect to AzureFunctionRulePost
   */
  public static AzureFunctionRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AzureFunctionRulePost.class);
  }

  /**
   * Convert an instance of AzureFunctionRulePost to an JSON string
   *
   * @return JSON string
   */
