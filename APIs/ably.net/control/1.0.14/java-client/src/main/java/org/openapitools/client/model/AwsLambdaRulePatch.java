...
public class AwsLambdaRulePatch {
  ...
  public AwsLambdaRulePatch requestMode(RequestModeEnum requestMode) {
  ...
  public AwsLambdaRulePatch source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AwsLambdaRulePatch status(StatusEnum status) {
    this.status = status;
    return this;
  }
