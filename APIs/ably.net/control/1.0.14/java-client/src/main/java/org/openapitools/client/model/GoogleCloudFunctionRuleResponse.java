...
public class GoogleCloudFunctionRuleResponse {
  ...
  public GoogleCloudFunctionRuleResponse() {
  }

  public GoogleCloudFunctionRuleResponse links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public GoogleCloudFunctionRuleResponse appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public GoogleCloudFunctionRuleResponse created(BigDecimal created) {
  ...
  public GoogleCloudFunctionRuleResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GoogleCloudFunctionRuleResponse modified(BigDecimal modified) {
  ...
  public GoogleCloudFunctionRuleResponse requestMode(RequestModeEnum requestMode) {
  ...
  public GoogleCloudFunctionRuleResponse ruleType(RuleTypeEnum ruleType) {
  ...
  public GoogleCloudFunctionRuleResponse source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public GoogleCloudFunctionRuleResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public GoogleCloudFunctionRuleResponse target(GoogleCloudFunctionRulePostTarget target) {
    this.target = target;
    return this;
  }
  ...
  public GoogleCloudFunctionRuleResponse version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudFunctionRuleResponse googleCloudFunctionRuleResponse = (GoogleCloudFunctionRuleResponse) o;
    return Objects.equals(this.links, googleCloudFunctionRuleResponse.links) &&
        Objects.equals(this.appId, googleCloudFunctionRuleResponse.appId) &&
        Objects.equals(this.created, googleCloudFunctionRuleResponse.created) &&
        Objects.equals(this.id, googleCloudFunctionRuleResponse.id) &&
        Objects.equals(this.modified, googleCloudFunctionRuleResponse.modified) &&
        Objects.equals(this.requestMode, googleCloudFunctionRuleResponse.requestMode) &&
        Objects.equals(this.ruleType, googleCloudFunctionRuleResponse.ruleType) &&
        Objects.equals(this.source, googleCloudFunctionRuleResponse.source) &&
        Objects.equals(this.status, googleCloudFunctionRuleResponse.status) &&
        Objects.equals(this.target, googleCloudFunctionRuleResponse.target) &&
        Objects.equals(this.version, googleCloudFunctionRuleResponse.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudFunctionRuleResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudFunctionRuleResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudFunctionRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudFunctionRuleResponse is not found in the empty JSON string", GoogleCloudFunctionRuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudFunctionRuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudFunctionRuleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GoogleCloudFunctionRuleResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudFunctionRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudFunctionRuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudFunctionRuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudFunctionRuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudFunctionRuleResponse>() {
           @Override
           public void write(JsonWriter out, GoogleCloudFunctionRuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudFunctionRuleResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudFunctionRuleResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudFunctionRuleResponse
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudFunctionRuleResponse
   */
  public static GoogleCloudFunctionRuleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudFunctionRuleResponse.class);
  }

  /**
   * Convert an instance of GoogleCloudFunctionRuleResponse to an JSON string
   *
   * @return JSON string
   */
