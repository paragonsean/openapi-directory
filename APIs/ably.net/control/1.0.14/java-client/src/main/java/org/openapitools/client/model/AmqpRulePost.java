...
public class AmqpRulePost {
  ...
  public AmqpRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public AmqpRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public AmqpRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AmqpRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AmqpRulePost target(AmqpRulePostTarget target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AmqpRulePost amqpRulePost = (AmqpRulePost) o;
    return Objects.equals(this.requestMode, amqpRulePost.requestMode) &&
        Objects.equals(this.ruleType, amqpRulePost.ruleType) &&
        Objects.equals(this.source, amqpRulePost.source) &&
        Objects.equals(this.status, amqpRulePost.status) &&
        Objects.equals(this.target, amqpRulePost.target);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmqpRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmqpRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmqpRulePost is not found in the empty JSON string", AmqpRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AmqpRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AmqpRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmqpRulePost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmqpRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmqpRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmqpRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmqpRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<AmqpRulePost>() {
           @Override
           public void write(JsonWriter out, AmqpRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AmqpRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AmqpRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AmqpRulePost
   * @throws IOException if the JSON string is invalid with respect to AmqpRulePost
   */
  public static AmqpRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmqpRulePost.class);
  }

  /**
   * Convert an instance of AmqpRulePost to an JSON string
   *
   * @return JSON string
   */
