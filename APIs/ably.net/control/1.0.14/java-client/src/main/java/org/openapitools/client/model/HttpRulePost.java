...
public class HttpRulePost {
  ...
  private HttpRulePostTarget target;

  public HttpRulePost() {
  }

  public HttpRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public HttpRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public HttpRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public HttpRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public HttpRulePost target(HttpRulePostTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public HttpRulePostTarget getTarget() {
    return target;
  }

  public void setTarget(HttpRulePostTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    HttpRulePost httpRulePost = (HttpRulePost) o;
    return Objects.equals(this.requestMode, httpRulePost.requestMode) &&
        Objects.equals(this.ruleType, httpRulePost.ruleType) &&
        Objects.equals(this.source, httpRulePost.source) &&
        Objects.equals(this.status, httpRulePost.status) &&
        Objects.equals(this.target, httpRulePost.target);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HttpRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HttpRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HttpRulePost is not found in the empty JSON string", HttpRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HttpRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HttpRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HttpRulePost.openapiRequiredFields) {
      ...
      HttpRulePostTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HttpRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HttpRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HttpRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HttpRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<HttpRulePost>() {
           @Override
           public void write(JsonWriter out, HttpRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HttpRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HttpRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HttpRulePost
   * @throws IOException if the JSON string is invalid with respect to HttpRulePost
   */
  public static HttpRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HttpRulePost.class);
  }

  /**
   * Convert an instance of HttpRulePost to an JSON string
   *
   * @return JSON string
   */
