...
public class HttpRuleResponse {
  ...
  private HttpRuleResponseTarget target;
  ...
  public HttpRuleResponse requestMode(RequestModeEnum requestMode) {
  ...
  public HttpRuleResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public HttpRuleResponse target(HttpRuleResponseTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public HttpRuleResponseTarget getTarget() {
    return target;
  }

  public void setTarget(HttpRuleResponseTarget target) {
    this.target = target;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      HttpRuleResponseTarget.validateJsonElement(jsonObj.get("target"));
