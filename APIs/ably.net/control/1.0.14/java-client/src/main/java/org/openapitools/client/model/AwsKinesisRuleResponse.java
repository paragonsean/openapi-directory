...
public class AwsKinesisRuleResponse {
  ...
  private AwsKinesisRuleResponseTarget target;

  public static final String SERIALIZED_NAME_VERSION = "version";
  @SerializedName(SERIALIZED_NAME_VERSION)
  private String version;

  public AwsKinesisRuleResponse() {
  }

  public AwsKinesisRuleResponse links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public AwsKinesisRuleResponse appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public AwsKinesisRuleResponse created(BigDecimal created) {
  ...
  public AwsKinesisRuleResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AwsKinesisRuleResponse modified(BigDecimal modified) {
  ...
  public AwsKinesisRuleResponse requestMode(RequestModeEnum requestMode) {
  ...
  public AwsKinesisRuleResponse ruleType(RuleTypeEnum ruleType) {
  ...
  public AwsKinesisRuleResponse source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AwsKinesisRuleResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AwsKinesisRuleResponse target(AwsKinesisRuleResponseTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AwsKinesisRuleResponseTarget getTarget() {
    return target;
  }

  public void setTarget(AwsKinesisRuleResponseTarget target) {
    this.target = target;
  }


  public AwsKinesisRuleResponse version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    AwsKinesisRuleResponse awsKinesisRuleResponse = (AwsKinesisRuleResponse) o;
    return Objects.equals(this.links, awsKinesisRuleResponse.links) &&
        Objects.equals(this.appId, awsKinesisRuleResponse.appId) &&
        Objects.equals(this.created, awsKinesisRuleResponse.created) &&
        Objects.equals(this.id, awsKinesisRuleResponse.id) &&
        Objects.equals(this.modified, awsKinesisRuleResponse.modified) &&
        Objects.equals(this.requestMode, awsKinesisRuleResponse.requestMode) &&
        Objects.equals(this.ruleType, awsKinesisRuleResponse.ruleType) &&
        Objects.equals(this.source, awsKinesisRuleResponse.source) &&
        Objects.equals(this.status, awsKinesisRuleResponse.status) &&
        Objects.equals(this.target, awsKinesisRuleResponse.target) &&
        Objects.equals(this.version, awsKinesisRuleResponse.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsKinesisRuleResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsKinesisRuleResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsKinesisRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsKinesisRuleResponse is not found in the empty JSON string", AwsKinesisRuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsKinesisRuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsKinesisRuleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AwsKinesisRuleResponse.openapiRequiredFields) {
      ...
      AwsKinesisRuleResponseTarget.validateJsonElement(jsonObj.get("target"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsKinesisRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsKinesisRuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsKinesisRuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsKinesisRuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsKinesisRuleResponse>() {
           @Override
           public void write(JsonWriter out, AwsKinesisRuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsKinesisRuleResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsKinesisRuleResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsKinesisRuleResponse
   * @throws IOException if the JSON string is invalid with respect to AwsKinesisRuleResponse
   */
  public static AwsKinesisRuleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsKinesisRuleResponse.class);
  }

  /**
   * Convert an instance of AwsKinesisRuleResponse to an JSON string
   *
   * @return JSON string
   */
