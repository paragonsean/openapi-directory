...
public class ApiClient {
    ...
    private String basePath = "https://control.ably.net/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.14/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://control.ably.net/v1
