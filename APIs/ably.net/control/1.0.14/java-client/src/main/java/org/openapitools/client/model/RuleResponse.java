...
public class RuleResponse extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<RuleResponse>() {
                ...
                public void write(JsonWriter out, RuleResponse value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: AmqpExternalRuleResponse, AmqpRuleResponse, AwsKinesisRuleResponse, AwsLambdaRuleResponse, AwsSqsRuleResponse, AzureFunctionRuleResponse, CloudflareWorkerRuleResponse, GoogleCloudFunctionRuleResponse, HttpRuleResponse, IftttRuleResponse, ZapierRuleResponse");
                }
     ...
     * AmqpExternalRuleResponse, AmqpRuleResponse, AwsKinesisRuleResponse, AwsLambdaRuleResponse, AwsSqsRuleResponse, AzureFunctionRuleResponse, CloudflareWorkerRuleResponse, GoogleCloudFunctionRuleResponse, HttpRuleResponse, IftttRuleResponse, ZapierRuleResponse
     *
     ...
     * AmqpExternalRuleResponse, AmqpRuleResponse, AwsKinesisRuleResponse, AwsLambdaRuleResponse, AwsSqsRuleResponse, AzureFunctionRuleResponse, CloudflareWorkerRuleResponse, GoogleCloudFunctionRuleResponse, HttpRuleResponse, IftttRuleResponse, ZapierRuleResponse
     *
     * @return The actual instance (AmqpExternalRuleResponse, AmqpRuleResponse, AwsKinesisRuleResponse, AwsLambdaRuleResponse, AwsSqsRuleResponse, AzureFunctionRuleResponse, CloudflareWorkerRuleResponse, GoogleCloudFunctionRuleResponse, HttpRuleResponse, IftttRuleResponse, ZapierRuleResponse)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for RuleResponse with oneOf schemas: AmqpExternalRuleResponse, AmqpRuleResponse, AwsKinesisRuleResponse, AwsLambdaRuleResponse, AwsSqsRuleResponse, AzureFunctionRuleResponse, CloudflareWorkerRuleResponse, GoogleCloudFunctionRuleResponse, HttpRuleResponse, IftttRuleResponse, ZapierRuleResponse. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
