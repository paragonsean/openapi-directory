...
public class AwsKinesisRulePatch {
  ...
  public AwsKinesisRulePatch requestMode(RequestModeEnum requestMode) {
  ...
  public AwsKinesisRulePatch source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AwsKinesisRulePatch status(StatusEnum status) {
    this.status = status;
    return this;
  }
