...
public class AwsLambdaRulePost {
  ...
  private AwsLambdaRulePatchTarget target;

  public AwsLambdaRulePost() {
  }

  public AwsLambdaRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public AwsLambdaRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public AwsLambdaRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AwsLambdaRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AwsLambdaRulePost target(AwsLambdaRulePatchTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AwsLambdaRulePatchTarget getTarget() {
    return target;
  }

  public void setTarget(AwsLambdaRulePatchTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    AwsLambdaRulePost awsLambdaRulePost = (AwsLambdaRulePost) o;
    return Objects.equals(this.requestMode, awsLambdaRulePost.requestMode) &&
        Objects.equals(this.ruleType, awsLambdaRulePost.ruleType) &&
        Objects.equals(this.source, awsLambdaRulePost.source) &&
        Objects.equals(this.status, awsLambdaRulePost.status) &&
        Objects.equals(this.target, awsLambdaRulePost.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsLambdaRulePost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsLambdaRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsLambdaRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsLambdaRulePost is not found in the empty JSON string", AwsLambdaRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsLambdaRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsLambdaRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AwsLambdaRulePost.openapiRequiredFields) {
      ...
      AwsLambdaRulePatchTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsLambdaRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsLambdaRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsLambdaRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsLambdaRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsLambdaRulePost>() {
           @Override
           public void write(JsonWriter out, AwsLambdaRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsLambdaRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsLambdaRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsLambdaRulePost
   * @throws IOException if the JSON string is invalid with respect to AwsLambdaRulePost
   */
  public static AwsLambdaRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsLambdaRulePost.class);
  }

  /**
   * Convert an instance of AwsLambdaRulePost to an JSON string
   *
   * @return JSON string
   */
