...
import org.openapitools.client.model.AwsSqsRulePostTarget;
...
public class AwsSqsRulePost {
  ...
  private AwsSqsRulePostTarget target;

  public AwsSqsRulePost() {
  }

  public AwsSqsRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public AwsSqsRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public AwsSqsRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AwsSqsRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AwsSqsRulePost target(AwsSqsRulePostTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AwsSqsRulePostTarget getTarget() {
    return target;
  }

  public void setTarget(AwsSqsRulePostTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    AwsSqsRulePost awsSqsRulePost = (AwsSqsRulePost) o;
    return Objects.equals(this.requestMode, awsSqsRulePost.requestMode) &&
        Objects.equals(this.ruleType, awsSqsRulePost.ruleType) &&
        Objects.equals(this.source, awsSqsRulePost.source) &&
        Objects.equals(this.status, awsSqsRulePost.status) &&
        Objects.equals(this.target, awsSqsRulePost.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsSqsRulePost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsSqsRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsSqsRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsSqsRulePost is not found in the empty JSON string", AwsSqsRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsSqsRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsSqsRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AwsSqsRulePost.openapiRequiredFields) {
      ...
      AwsSqsRulePostTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsSqsRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsSqsRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsSqsRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsSqsRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsSqsRulePost>() {
           @Override
           public void write(JsonWriter out, AwsSqsRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsSqsRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsSqsRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsSqsRulePost
   * @throws IOException if the JSON string is invalid with respect to AwsSqsRulePost
   */
  public static AwsSqsRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsSqsRulePost.class);
  }

  /**
   * Convert an instance of AwsSqsRulePost to an JSON string
   *
   * @return JSON string
   */
