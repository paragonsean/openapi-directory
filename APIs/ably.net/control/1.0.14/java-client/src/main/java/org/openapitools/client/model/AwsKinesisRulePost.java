...
import org.openapitools.client.model.AwsKinesisRulePostTarget;
...
public class AwsKinesisRulePost {
  ...
  private AwsKinesisRulePostTarget target;

  public AwsKinesisRulePost() {
  }

  public AwsKinesisRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public AwsKinesisRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public AwsKinesisRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AwsKinesisRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AwsKinesisRulePost target(AwsKinesisRulePostTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AwsKinesisRulePostTarget getTarget() {
    return target;
  }

  public void setTarget(AwsKinesisRulePostTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    AwsKinesisRulePost awsKinesisRulePost = (AwsKinesisRulePost) o;
    return Objects.equals(this.requestMode, awsKinesisRulePost.requestMode) &&
        Objects.equals(this.ruleType, awsKinesisRulePost.ruleType) &&
        Objects.equals(this.source, awsKinesisRulePost.source) &&
        Objects.equals(this.status, awsKinesisRulePost.status) &&
        Objects.equals(this.target, awsKinesisRulePost.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsKinesisRulePost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsKinesisRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsKinesisRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsKinesisRulePost is not found in the empty JSON string", AwsKinesisRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsKinesisRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsKinesisRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AwsKinesisRulePost.openapiRequiredFields) {
      ...
      AwsKinesisRulePostTarget.validateJsonElement(jsonObj.get("target"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsKinesisRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsKinesisRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsKinesisRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsKinesisRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsKinesisRulePost>() {
           @Override
           public void write(JsonWriter out, AwsKinesisRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsKinesisRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsKinesisRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsKinesisRulePost
   * @throws IOException if the JSON string is invalid with respect to AwsKinesisRulePost
   */
  public static AwsKinesisRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsKinesisRulePost.class);
  }

  /**
   * Convert an instance of AwsKinesisRulePost to an JSON string
   *
   * @return JSON string
   */
