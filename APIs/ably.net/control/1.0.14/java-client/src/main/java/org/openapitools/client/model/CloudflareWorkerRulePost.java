...
public class CloudflareWorkerRulePost {
  ...
  public CloudflareWorkerRulePost() {
  }

  public CloudflareWorkerRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public CloudflareWorkerRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public CloudflareWorkerRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public CloudflareWorkerRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public CloudflareWorkerRulePost target(CloudflareWorkerRulePostTarget target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloudflareWorkerRulePost cloudflareWorkerRulePost = (CloudflareWorkerRulePost) o;
    return Objects.equals(this.requestMode, cloudflareWorkerRulePost.requestMode) &&
        Objects.equals(this.ruleType, cloudflareWorkerRulePost.ruleType) &&
        Objects.equals(this.source, cloudflareWorkerRulePost.source) &&
        Objects.equals(this.status, cloudflareWorkerRulePost.status) &&
        Objects.equals(this.target, cloudflareWorkerRulePost.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudflareWorkerRulePost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudflareWorkerRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudflareWorkerRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudflareWorkerRulePost is not found in the empty JSON string", CloudflareWorkerRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudflareWorkerRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudflareWorkerRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudflareWorkerRulePost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudflareWorkerRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudflareWorkerRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudflareWorkerRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudflareWorkerRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudflareWorkerRulePost>() {
           @Override
           public void write(JsonWriter out, CloudflareWorkerRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudflareWorkerRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudflareWorkerRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudflareWorkerRulePost
   * @throws IOException if the JSON string is invalid with respect to CloudflareWorkerRulePost
   */
  public static CloudflareWorkerRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudflareWorkerRulePost.class);
  }

  /**
   * Convert an instance of CloudflareWorkerRulePost to an JSON string
   *
   * @return JSON string
   */
