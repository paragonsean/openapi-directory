...
public class CloudflareWorkerRuleResponse {
  ...
  public CloudflareWorkerRuleResponse() {
  }

  public CloudflareWorkerRuleResponse links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public CloudflareWorkerRuleResponse appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public CloudflareWorkerRuleResponse created(BigDecimal created) {
  ...
  public CloudflareWorkerRuleResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CloudflareWorkerRuleResponse modified(BigDecimal modified) {
  ...
  public CloudflareWorkerRuleResponse requestMode(RequestModeEnum requestMode) {
  ...
  public CloudflareWorkerRuleResponse ruleType(RuleTypeEnum ruleType) {
  ...
  public CloudflareWorkerRuleResponse source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public CloudflareWorkerRuleResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public CloudflareWorkerRuleResponse target(CloudflareWorkerRulePostTarget target) {
    this.target = target;
    return this;
  }
  ...
  public CloudflareWorkerRuleResponse version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    CloudflareWorkerRuleResponse cloudflareWorkerRuleResponse = (CloudflareWorkerRuleResponse) o;
    return Objects.equals(this.links, cloudflareWorkerRuleResponse.links) &&
        Objects.equals(this.appId, cloudflareWorkerRuleResponse.appId) &&
        Objects.equals(this.created, cloudflareWorkerRuleResponse.created) &&
        Objects.equals(this.id, cloudflareWorkerRuleResponse.id) &&
        Objects.equals(this.modified, cloudflareWorkerRuleResponse.modified) &&
        Objects.equals(this.requestMode, cloudflareWorkerRuleResponse.requestMode) &&
        Objects.equals(this.ruleType, cloudflareWorkerRuleResponse.ruleType) &&
        Objects.equals(this.source, cloudflareWorkerRuleResponse.source) &&
        Objects.equals(this.status, cloudflareWorkerRuleResponse.status) &&
        Objects.equals(this.target, cloudflareWorkerRuleResponse.target) &&
        Objects.equals(this.version, cloudflareWorkerRuleResponse.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudflareWorkerRuleResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudflareWorkerRuleResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudflareWorkerRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudflareWorkerRuleResponse is not found in the empty JSON string", CloudflareWorkerRuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudflareWorkerRuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudflareWorkerRuleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CloudflareWorkerRuleResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudflareWorkerRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudflareWorkerRuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudflareWorkerRuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudflareWorkerRuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudflareWorkerRuleResponse>() {
           @Override
           public void write(JsonWriter out, CloudflareWorkerRuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudflareWorkerRuleResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudflareWorkerRuleResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudflareWorkerRuleResponse
   * @throws IOException if the JSON string is invalid with respect to CloudflareWorkerRuleResponse
   */
  public static CloudflareWorkerRuleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudflareWorkerRuleResponse.class);
  }

  /**
   * Convert an instance of CloudflareWorkerRuleResponse to an JSON string
   *
   * @return JSON string
   */
