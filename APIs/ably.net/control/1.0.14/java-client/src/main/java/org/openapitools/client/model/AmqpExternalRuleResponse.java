...
public class AmqpExternalRuleResponse {
  ...
  public AmqpExternalRuleResponse() {
  }

  public AmqpExternalRuleResponse links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public AmqpExternalRuleResponse appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public AmqpExternalRuleResponse created(BigDecimal created) {
  ...
  public AmqpExternalRuleResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AmqpExternalRuleResponse modified(BigDecimal modified) {
  ...
  public AmqpExternalRuleResponse requestMode(RequestModeEnum requestMode) {
  ...
  public AmqpExternalRuleResponse ruleType(RuleTypeEnum ruleType) {
  ...
  public AmqpExternalRuleResponse source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AmqpExternalRuleResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AmqpExternalRuleResponse target(AmqpExternalRulePostTarget target) {
    this.target = target;
    return this;
  }
  ...
  public AmqpExternalRuleResponse version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    AmqpExternalRuleResponse amqpExternalRuleResponse = (AmqpExternalRuleResponse) o;
    return Objects.equals(this.links, amqpExternalRuleResponse.links) &&
        Objects.equals(this.appId, amqpExternalRuleResponse.appId) &&
        Objects.equals(this.created, amqpExternalRuleResponse.created) &&
        Objects.equals(this.id, amqpExternalRuleResponse.id) &&
        Objects.equals(this.modified, amqpExternalRuleResponse.modified) &&
        Objects.equals(this.requestMode, amqpExternalRuleResponse.requestMode) &&
        Objects.equals(this.ruleType, amqpExternalRuleResponse.ruleType) &&
        Objects.equals(this.source, amqpExternalRuleResponse.source) &&
        Objects.equals(this.status, amqpExternalRuleResponse.status) &&
        Objects.equals(this.target, amqpExternalRuleResponse.target) &&
        Objects.equals(this.version, amqpExternalRuleResponse.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class AmqpExternalRuleResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AmqpExternalRuleResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AmqpExternalRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmqpExternalRuleResponse is not found in the empty JSON string", AmqpExternalRuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AmqpExternalRuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AmqpExternalRuleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmqpExternalRuleResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmqpExternalRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmqpExternalRuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmqpExternalRuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmqpExternalRuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AmqpExternalRuleResponse>() {
           @Override
           public void write(JsonWriter out, AmqpExternalRuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AmqpExternalRuleResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AmqpExternalRuleResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AmqpExternalRuleResponse
   * @throws IOException if the JSON string is invalid with respect to AmqpExternalRuleResponse
   */
  public static AmqpExternalRuleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmqpExternalRuleResponse.class);
  }

  /**
   * Convert an instance of AmqpExternalRuleResponse to an JSON string
   *
   * @return JSON string
   */
