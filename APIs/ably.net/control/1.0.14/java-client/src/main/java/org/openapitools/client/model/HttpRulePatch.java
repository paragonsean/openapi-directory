...
import org.openapitools.client.model.HttpRulePatchTarget;
...
public class HttpRulePatch {
  ...
  private HttpRulePatchTarget target;

  public HttpRulePatch() {
  }

  public HttpRulePatch requestMode(RequestModeEnum requestMode) {
  ...
  public HttpRulePatch ruleType(RuleTypeEnum ruleType) {
  ...
  public HttpRulePatch source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public HttpRulePatch status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public HttpRulePatch target(HttpRulePatchTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public HttpRulePatchTarget getTarget() {
    return target;
  }

  public void setTarget(HttpRulePatchTarget target) {
    this.target = target;
  }
  ...
  public boolean equals(Object o) {
    ...
    HttpRulePatch httpRulePatch = (HttpRulePatch) o;
    return Objects.equals(this.requestMode, httpRulePatch.requestMode) &&
        Objects.equals(this.ruleType, httpRulePatch.ruleType) &&
        Objects.equals(this.source, httpRulePatch.source) &&
        Objects.equals(this.status, httpRulePatch.status) &&
        Objects.equals(this.target, httpRulePatch.target);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HttpRulePatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HttpRulePatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HttpRulePatch is not found in the empty JSON string", HttpRulePatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HttpRulePatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HttpRulePatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        HttpRulePatchTarget.validateJsonElement(jsonObj.get("target"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HttpRulePatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HttpRulePatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HttpRulePatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HttpRulePatch.class));

       return (TypeAdapter<T>) new TypeAdapter<HttpRulePatch>() {
           @Override
           public void write(JsonWriter out, HttpRulePatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HttpRulePatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HttpRulePatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HttpRulePatch
   * @throws IOException if the JSON string is invalid with respect to HttpRulePatch
   */
  public static HttpRulePatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HttpRulePatch.class);
  }

  /**
   * Convert an instance of HttpRulePatch to an JSON string
   *
   * @return JSON string
   */
