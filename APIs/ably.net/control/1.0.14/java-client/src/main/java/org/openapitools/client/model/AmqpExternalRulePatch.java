...
public class AmqpExternalRulePatch {
  ...
  public AmqpExternalRulePatch requestMode(RequestModeEnum requestMode) {
  ...
  public AmqpExternalRulePatch source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public AmqpExternalRulePatch status(StatusEnum status) {
    this.status = status;
    return this;
  }
