...
public class GoogleCloudFunctionRulePatch {
  ...
  public GoogleCloudFunctionRulePatch requestMode(RequestModeEnum requestMode) {
  ...
  public GoogleCloudFunctionRulePatch source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public GoogleCloudFunctionRulePatch status(StatusEnum status) {
    this.status = status;
    return this;
  }
