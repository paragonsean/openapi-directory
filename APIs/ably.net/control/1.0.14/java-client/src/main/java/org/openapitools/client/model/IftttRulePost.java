...
public class IftttRulePost {
  ...
  public IftttRulePost() {
  }

  public IftttRulePost requestMode(RequestModeEnum requestMode) {
  ...
  public IftttRulePost ruleType(RuleTypeEnum ruleType) {
  ...
  public IftttRulePost source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public IftttRulePost status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public IftttRulePost target(IftttRulePostTarget target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IftttRulePost iftttRulePost = (IftttRulePost) o;
    return Objects.equals(this.requestMode, iftttRulePost.requestMode) &&
        Objects.equals(this.ruleType, iftttRulePost.ruleType) &&
        Objects.equals(this.source, iftttRulePost.source) &&
        Objects.equals(this.status, iftttRulePost.status) &&
        Objects.equals(this.target, iftttRulePost.target);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IftttRulePost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IftttRulePost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IftttRulePost is not found in the empty JSON string", IftttRulePost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IftttRulePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IftttRulePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IftttRulePost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IftttRulePost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IftttRulePost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IftttRulePost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IftttRulePost.class));

       return (TypeAdapter<T>) new TypeAdapter<IftttRulePost>() {
           @Override
           public void write(JsonWriter out, IftttRulePost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IftttRulePost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IftttRulePost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IftttRulePost
   * @throws IOException if the JSON string is invalid with respect to IftttRulePost
   */
  public static IftttRulePost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IftttRulePost.class);
  }

  /**
   * Convert an instance of IftttRulePost to an JSON string
   *
   * @return JSON string
   */
