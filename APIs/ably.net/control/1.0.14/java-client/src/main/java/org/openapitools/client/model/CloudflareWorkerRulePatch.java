...
public class CloudflareWorkerRulePatch {
  ...
  public CloudflareWorkerRulePatch() {
  }

  public CloudflareWorkerRulePatch requestMode(RequestModeEnum requestMode) {
  ...
  public CloudflareWorkerRulePatch ruleType(RuleTypeEnum ruleType) {
  ...
  public CloudflareWorkerRulePatch source(RuleSource source) {
    this.source = source;
    return this;
  }
  ...
  public CloudflareWorkerRulePatch status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public CloudflareWorkerRulePatch target(CloudflareWorkerRulePatchTarget target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CloudflareWorkerRulePatch cloudflareWorkerRulePatch = (CloudflareWorkerRulePatch) o;
    return Objects.equals(this.requestMode, cloudflareWorkerRulePatch.requestMode) &&
        Objects.equals(this.ruleType, cloudflareWorkerRulePatch.ruleType) &&
        Objects.equals(this.source, cloudflareWorkerRulePatch.source) &&
        Objects.equals(this.status, cloudflareWorkerRulePatch.status) &&
        Objects.equals(this.target, cloudflareWorkerRulePatch.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class CloudflareWorkerRulePatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudflareWorkerRulePatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudflareWorkerRulePatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CloudflareWorkerRulePatch is not found in the empty JSON string", CloudflareWorkerRulePatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudflareWorkerRulePatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CloudflareWorkerRulePatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CloudflareWorkerRulePatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CloudflareWorkerRulePatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CloudflareWorkerRulePatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CloudflareWorkerRulePatch.class));

       return (TypeAdapter<T>) new TypeAdapter<CloudflareWorkerRulePatch>() {
           @Override
           public void write(JsonWriter out, CloudflareWorkerRulePatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CloudflareWorkerRulePatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CloudflareWorkerRulePatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CloudflareWorkerRulePatch
   * @throws IOException if the JSON string is invalid with respect to CloudflareWorkerRulePatch
   */
  public static CloudflareWorkerRulePatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CloudflareWorkerRulePatch.class);
  }

  /**
   * Convert an instance of CloudflareWorkerRulePatch to an JSON string
   *
   * @return JSON string
   */
