...
|**format** | [**FormatEnum**](#FormatEnum) | JSON provides a simpler text-based encoding, whereas MsgPack provides a more efficient binary encoding. |  |
...
|**url** | **String** | The URL of the endpoint that is invoked when events occur on Ably. |  |
