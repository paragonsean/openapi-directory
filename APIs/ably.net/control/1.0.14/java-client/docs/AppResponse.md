...
|**status** | [**StatusEnum**](#StatusEnum) | The application status. Disabled applications will not accept new connections and will return an error to all clients. |  [optional] |
