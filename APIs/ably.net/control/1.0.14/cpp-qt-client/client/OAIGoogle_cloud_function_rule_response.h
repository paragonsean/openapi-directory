...
/*
 * OAIGoogle_cloud_function_rule_response.h
 *
 * 
 */

#ifndef OAIGoogle_cloud_function_rule_response_H
#define OAIGoogle_cloud_function_rule_response_H
...
class OAIGoogle_cloud_function_rule_response : public OAIObject {
public:
    OAIGoogle_cloud_function_rule_response();
    OAIGoogle_cloud_function_rule_response(QString json);
    ~OAIGoogle_cloud_function_rule_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogle_cloud_function_rule_response)

#endif // OAIGoogle_cloud_function_rule_response_H
