...
/*
 * OAIAmqp_external_rule_patch.h
 *
 * 
 */

#ifndef OAIAmqp_external_rule_patch_H
#define OAIAmqp_external_rule_patch_H
...
class OAIAmqp_external_rule_patch : public OAIObject {
public:
    OAIAmqp_external_rule_patch();
    OAIAmqp_external_rule_patch(QString json);
    ~OAIAmqp_external_rule_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmqp_external_rule_patch)

#endif // OAIAmqp_external_rule_patch_H
