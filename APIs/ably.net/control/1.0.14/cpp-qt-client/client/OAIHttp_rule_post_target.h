...
/*
 * OAIHttp_rule_post_target.h
 *
 * 
 */

#ifndef OAIHttp_rule_post_target_H
#define OAIHttp_rule_post_target_H
...
class OAIHttp_rule_post_target : public OAIObject {
public:
    OAIHttp_rule_post_target();
    OAIHttp_rule_post_target(QString json);
    ~OAIHttp_rule_post_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttp_rule_post_target)

#endif // OAIHttp_rule_post_target_H
