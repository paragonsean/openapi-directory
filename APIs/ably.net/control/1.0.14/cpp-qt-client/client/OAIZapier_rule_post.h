...
/*
 * OAIZapier_rule_post.h
 *
 * 
 */

#ifndef OAIZapier_rule_post_H
#define OAIZapier_rule_post_H
...
class OAIZapier_rule_post : public OAIObject {
public:
    OAIZapier_rule_post();
    OAIZapier_rule_post(QString json);
    ~OAIZapier_rule_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIZapier_rule_post)

#endif // OAIZapier_rule_post_H
