...
QList<QString> OAIKey_patch::getCapabilities() const {
    return m_capabilities;
}
void OAIKey_patch::setCapabilities(const QList<QString> &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIKey_patch::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIKey_patch::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

QString OAIKey_patch::getChannels() const {
    return m_channels;
}
void OAIKey_patch::setChannels(const QString &channels) {
    m_channels = channels;
    m_channels_isSet = true;
}

bool OAIKey_patch::is_channels_Set() const{
    return m_channels_isSet;
}

bool OAIKey_patch::is_channels_Valid() const{
