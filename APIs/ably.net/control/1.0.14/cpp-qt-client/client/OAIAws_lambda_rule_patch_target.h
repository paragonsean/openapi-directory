...
/*
 * OAIAws_lambda_rule_patch_target.h
 *
 * 
 */

#ifndef OAIAws_lambda_rule_patch_target_H
#define OAIAws_lambda_rule_patch_target_H
...
class OAIAws_lambda_rule_patch_target : public OAIObject {
public:
    OAIAws_lambda_rule_patch_target();
    OAIAws_lambda_rule_patch_target(QString json);
    ~OAIAws_lambda_rule_patch_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_lambda_rule_patch_target)

#endif // OAIAws_lambda_rule_patch_target_H
