...
/*
 * OAIZapier_rule_response.h
 *
 * 
 */

#ifndef OAIZapier_rule_response_H
#define OAIZapier_rule_response_H
...
class OAIZapier_rule_response : public OAIObject {
public:
    OAIZapier_rule_response();
    OAIZapier_rule_response(QString json);
    ~OAIZapier_rule_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIZapier_rule_response)

#endif // OAIZapier_rule_response_H
