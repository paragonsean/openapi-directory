...
/*
 * OAIUnsupported_rule_response.h
 *
 * 
 */

#ifndef OAIUnsupported_rule_response_H
#define OAIUnsupported_rule_response_H
...
class OAIUnsupported_rule_response : public OAIObject {
public:
    OAIUnsupported_rule_response();
    OAIUnsupported_rule_response(QString json);
    ~OAIUnsupported_rule_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsupported_rule_response)

#endif // OAIUnsupported_rule_response_H
