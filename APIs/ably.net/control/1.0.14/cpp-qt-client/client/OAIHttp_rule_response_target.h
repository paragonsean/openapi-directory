...
/*
 * OAIHttp_rule_response_target.h
 *
 * 
 */

#ifndef OAIHttp_rule_response_target_H
#define OAIHttp_rule_response_target_H
...
class OAIHttp_rule_response_target : public OAIObject {
public:
    OAIHttp_rule_response_target();
    OAIHttp_rule_response_target(QString json);
    ~OAIHttp_rule_response_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttp_rule_response_target)

#endif // OAIHttp_rule_response_target_H
