...
/*
 * OAIAws_kinesis_rule_patch.h
 *
 * 
 */

#ifndef OAIAws_kinesis_rule_patch_H
#define OAIAws_kinesis_rule_patch_H
...
class OAIAws_kinesis_rule_patch_target;

class OAIAws_kinesis_rule_patch : public OAIObject {
public:
    OAIAws_kinesis_rule_patch();
    OAIAws_kinesis_rule_patch(QString json);
    ~OAIAws_kinesis_rule_patch() override;
    ...
    OAIAws_kinesis_rule_patch_target getTarget() const;
    void setTarget(const OAIAws_kinesis_rule_patch_target &target);
...
private:
    ...
    OAIAws_kinesis_rule_patch_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_kinesis_rule_patch)

#endif // OAIAws_kinesis_rule_patch_H
