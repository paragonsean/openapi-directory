...
/*
 * OAIAws_sqs_rule_post.h
 *
 * 
 */

#ifndef OAIAws_sqs_rule_post_H
#define OAIAws_sqs_rule_post_H
...
class OAIAws_sqs_rule_post_target;

class OAIAws_sqs_rule_post : public OAIObject {
public:
    OAIAws_sqs_rule_post();
    OAIAws_sqs_rule_post(QString json);
    ~OAIAws_sqs_rule_post() override;
    ...
    OAIAws_sqs_rule_post_target getTarget() const;
    void setTarget(const OAIAws_sqs_rule_post_target &target);
...
private:
    ...
    OAIAws_sqs_rule_post_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_sqs_rule_post)

#endif // OAIAws_sqs_rule_post_H
