...
/*
 * OAIAzure_function_rule_post_target.h
 *
 * 
 */

#ifndef OAIAzure_function_rule_post_target_H
#define OAIAzure_function_rule_post_target_H
...
class OAIAzure_function_rule_post_target : public OAIObject {
public:
    OAIAzure_function_rule_post_target();
    OAIAzure_function_rule_post_target(QString json);
    ~OAIAzure_function_rule_post_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzure_function_rule_post_target)

#endif // OAIAzure_function_rule_post_target_H
