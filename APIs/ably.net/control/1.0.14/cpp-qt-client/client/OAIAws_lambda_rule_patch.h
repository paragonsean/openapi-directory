...
/*
 * OAIAws_lambda_rule_patch.h
 *
 * 
 */

#ifndef OAIAws_lambda_rule_patch_H
#define OAIAws_lambda_rule_patch_H
...
class OAIAws_lambda_rule_patch_target;

class OAIAws_lambda_rule_patch : public OAIObject {
public:
    OAIAws_lambda_rule_patch();
    OAIAws_lambda_rule_patch(QString json);
    ~OAIAws_lambda_rule_patch() override;
    ...
    OAIAws_lambda_rule_patch_target getTarget() const;
    void setTarget(const OAIAws_lambda_rule_patch_target &target);
...
private:
    ...
    OAIAws_lambda_rule_patch_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_lambda_rule_patch)

#endif // OAIAws_lambda_rule_patch_H
