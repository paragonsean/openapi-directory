...
/*
 * OAIAzure_function_rule_post.h
 *
 * 
 */

#ifndef OAIAzure_function_rule_post_H
#define OAIAzure_function_rule_post_H
...
class OAIAzure_function_rule_post : public OAIObject {
public:
    OAIAzure_function_rule_post();
    OAIAzure_function_rule_post(QString json);
    ~OAIAzure_function_rule_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzure_function_rule_post)

#endif // OAIAzure_function_rule_post_H
