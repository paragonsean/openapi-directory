...
/*
 * OAIAws_sqs_rule_response_target.h
 *
 * 
 */

#ifndef OAIAws_sqs_rule_response_target_H
#define OAIAws_sqs_rule_response_target_H
...
class OAIAws_sqs_rule_response_target : public OAIObject {
public:
    OAIAws_sqs_rule_response_target();
    OAIAws_sqs_rule_response_target(QString json);
    ~OAIAws_sqs_rule_response_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_sqs_rule_response_target)

#endif // OAIAws_sqs_rule_response_target_H
