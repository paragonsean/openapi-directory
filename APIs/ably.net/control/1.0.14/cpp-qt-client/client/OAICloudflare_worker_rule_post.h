...
/*
 * OAICloudflare_worker_rule_post.h
 *
 * 
 */

#ifndef OAICloudflare_worker_rule_post_H
#define OAICloudflare_worker_rule_post_H
...
class OAICloudflare_worker_rule_post : public OAIObject {
public:
    OAICloudflare_worker_rule_post();
    OAICloudflare_worker_rule_post(QString json);
    ~OAICloudflare_worker_rule_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudflare_worker_rule_post)

#endif // OAICloudflare_worker_rule_post_H
