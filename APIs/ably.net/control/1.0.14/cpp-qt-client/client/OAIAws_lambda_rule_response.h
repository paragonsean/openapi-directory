...
/*
 * OAIAws_lambda_rule_response.h
 *
 * 
 */

#ifndef OAIAws_lambda_rule_response_H
#define OAIAws_lambda_rule_response_H
...
class OAIAws_lambda_rule_response_target;

class OAIAws_lambda_rule_response : public OAIObject {
public:
    OAIAws_lambda_rule_response();
    OAIAws_lambda_rule_response(QString json);
    ~OAIAws_lambda_rule_response() override;
    ...
    OAIAws_lambda_rule_response_target getTarget() const;
    void setTarget(const OAIAws_lambda_rule_response_target &target);
...
private:
    ...
    OAIAws_lambda_rule_response_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAws_lambda_rule_response)

#endif // OAIAws_lambda_rule_response_H
