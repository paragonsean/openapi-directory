...
class OAIHttp_rule_response_target;
...
public:
    ...
    OAIHttp_rule_response_target getTarget() const;
    void setTarget(const OAIHttp_rule_response_target &target);
...
private:
    ...
    OAIHttp_rule_response_target m_target;
    bool m_target_isSet;
