...
/*
 * OAIIfttt_rule_post.h
 *
 * 
 */

#ifndef OAIIfttt_rule_post_H
#define OAIIfttt_rule_post_H
...
class OAIIfttt_rule_post : public OAIObject {
public:
    OAIIfttt_rule_post();
    OAIIfttt_rule_post(QString json);
    ~OAIIfttt_rule_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIfttt_rule_post)

#endif // OAIIfttt_rule_post_H
