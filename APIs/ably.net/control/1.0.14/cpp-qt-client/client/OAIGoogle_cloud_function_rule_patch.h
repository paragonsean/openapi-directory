...
/*
 * OAIGoogle_cloud_function_rule_patch.h
 *
 * 
 */

#ifndef OAIGoogle_cloud_function_rule_patch_H
#define OAIGoogle_cloud_function_rule_patch_H
...
class OAIGoogle_cloud_function_rule_patch_target;

class OAIGoogle_cloud_function_rule_patch : public OAIObject {
public:
    OAIGoogle_cloud_function_rule_patch();
    OAIGoogle_cloud_function_rule_patch(QString json);
    ~OAIGoogle_cloud_function_rule_patch() override;
    ...
    OAIGoogle_cloud_function_rule_patch_target getTarget() const;
    void setTarget(const OAIGoogle_cloud_function_rule_patch_target &target);
...
private:
    ...
    OAIGoogle_cloud_function_rule_patch_target m_target;
    bool m_target_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogle_cloud_function_rule_patch)

#endif // OAIGoogle_cloud_function_rule_patch_H
