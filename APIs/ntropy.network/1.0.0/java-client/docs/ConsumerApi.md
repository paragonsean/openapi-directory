...
<a id="getABatchOfConsumerTransactionClassificationResults_0"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetABatchOfConsumerTransactionClassificationResults200Response result = apiInstance.getABatchOfConsumerTransactionClassificationResults_0(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ConsumerApi#getABatchOfConsumerTransactionClassificationResults_0");
