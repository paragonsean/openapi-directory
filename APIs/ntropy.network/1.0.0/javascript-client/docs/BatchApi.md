# NtropyTransactionApiV1.BatchApi
...
let apiInstance = new NtropyTransactionApiV1.BatchApi();
let id = "247ee045-3d04-4b3c-872b-a9160b810f33"; // String | (Required) Batch id.
apiInstance.getABatchOfConsumerTransactionClassificationResults_1(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
