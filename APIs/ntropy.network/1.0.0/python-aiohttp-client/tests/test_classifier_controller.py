...
async def test_get_a_batch_of_business_transaction_classification_results(client):
...
async def test_get_a_batch_of_consumer_transaction_classification_results(client):
