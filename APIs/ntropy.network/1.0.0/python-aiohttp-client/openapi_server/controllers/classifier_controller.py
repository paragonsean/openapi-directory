...
async def get_a_batch_of_business_transaction_classification_results(request: web.Request, id) -> web.Response:
...
async def get_a_batch_of_consumer_transaction_classification_results(request: web.Request, id) -> web.Response:
