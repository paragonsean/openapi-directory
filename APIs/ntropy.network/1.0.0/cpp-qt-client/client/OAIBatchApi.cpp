...
void OAIBatchApi::getABatchOfConsumerTransactionClassificationResults(const QString &id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBatchApi::getABatchOfConsumerTransactionClassificationResultsCallback);
...
void OAIBatchApi::getABatchOfConsumerTransactionClassificationResultsCallback(OAIHttpRequestWorker *worker) {
