...
public class WebhookObject {
  ...
  public WebhookObject id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookObject type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookObject webhookObject = (WebhookObject) o;
    return Objects.equals(this.id, webhookObject.id) &&
        Objects.equals(this.type, webhookObject.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookObject is not found in the empty JSON string", WebhookObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<WebhookObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookObject.class));
