...
public class ApiClient {
    ...
    private String basePath = "https://www.daniweb.com/connect/api/v4";
    ...
    public ApiClient() {
        ...
        authentications.put("explicit_flow", new OAuth());
        authentications.put("implicit_flow", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://www.daniweb.com/connect/oauth/access_token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.daniweb.com/connect/api/v4
