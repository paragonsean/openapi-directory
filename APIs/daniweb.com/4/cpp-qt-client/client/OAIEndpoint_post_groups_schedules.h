...
/*
 * OAIEndpoint_post_groups_schedules.h
 *
 * 
 */

#ifndef OAIEndpoint_post_groups_schedules_H
#define OAIEndpoint_post_groups_schedules_H
...
class OAIEndpoint_post_groups_schedules : public OAIObject {
public:
    OAIEndpoint_post_groups_schedules();
    OAIEndpoint_post_groups_schedules(QString json);
    ~OAIEndpoint_post_groups_schedules() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpoint_post_groups_schedules)

#endif // OAIEndpoint_post_groups_schedules_H
