...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DaniWebConnectApi.EndpointGetAutocompletesData();
  });
  ...
  describe('EndpointGetAutocompletesData', function() {
    it('should create an instance of EndpointGetAutocompletesData', function() {
      // uncomment below and update the code to test EndpointGetAutocompletesData
      //var instance = new DaniWebConnectApi.EndpointGetAutocompletesData();
      //expect(instance).to.be.a(DaniWebConnectApi.EndpointGetAutocompletesData);
    });
