...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DaniWebConnectApi.MeSettings();
  });
  ...
  describe('MeSettings', function() {
    it('should create an instance of MeSettings', function() {
      // uncomment below and update the code to test MeSettings
      //var instance = new DaniWebConnectApi.MeSettings();
      //expect(instance).to.be.a(DaniWebConnectApi.MeSettings);
    });
