...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DaniWebConnectApi.PositionOrganization();
  });
  ...
  describe('PositionOrganization', function() {
    it('should create an instance of PositionOrganization', function() {
      // uncomment below and update the code to test PositionOrganization
      //var instance = new DaniWebConnectApi.PositionOrganization();
      //expect(instance).to.be.a(DaniWebConnectApi.PositionOrganization);
    });
