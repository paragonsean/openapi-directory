...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://www.daniweb.com/connect/api/v4') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://www.daniweb.com/connect/api/v4
         */
        ...
        this.authentications = {
            'explicit_flow': {type: 'oauth2'},
            'implicit_flow': {type: 'oauth2'}
        }
