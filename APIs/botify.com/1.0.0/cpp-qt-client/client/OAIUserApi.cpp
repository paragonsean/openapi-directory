...
void OAIUserApi::getUserProjects(const QString &username, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &size) {
    QString fullPath = QString(_serverConfigs["getUserProjects"][_serverIndices.value("getUserProjects")].URL()+"/projects/{username}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserApi::getUserProjectsCallback);
...
void OAIUserApi::getUserProjectsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetUserProjects_200_response output(QString(worker->response));
    worker->deleteLater();
