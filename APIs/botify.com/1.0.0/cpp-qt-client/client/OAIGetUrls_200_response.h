...
/*
 * OAIGetUrls_200_response.h
 *
 * 
 */

#ifndef OAIGetUrls_200_response_H
#define OAIGetUrls_200_response_H
...
class OAIGetUrls_200_response : public OAIObject {
public:
    OAIGetUrls_200_response();
    OAIGetUrls_200_response(QString json);
    ~OAIGetUrls_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUrls_200_response)

#endif // OAIGetUrls_200_response_H
