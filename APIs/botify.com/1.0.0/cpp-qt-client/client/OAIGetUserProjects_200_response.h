...
/*
 * OAIGetUserProjects_200_response.h
 *
 * 
 */

#ifndef OAIGetUserProjects_200_response_H
#define OAIGetUserProjects_200_response_H
...
class OAIGetUserProjects_200_response : public OAIObject {
public:
    OAIGetUserProjects_200_response();
    OAIGetUserProjects_200_response(QString json);
    ~OAIGetUserProjects_200_response() override;
    ...
    QList<OAIProject> getResults() const;
    void setResults(const QList<OAIProject> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserProjects_200_response)

#endif // OAIGetUserProjects_200_response_H
