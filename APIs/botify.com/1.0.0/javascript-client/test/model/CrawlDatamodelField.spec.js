...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BotifyApi.CrawlDatamodelField();
  });
  ...
  describe('CrawlDatamodelField', function() {
    it('should create an instance of CrawlDatamodelField', function() {
      // uncomment below and update the code to test CrawlDatamodelField
      //var instance = new BotifyApi.CrawlDatamodelField();
      //expect(instance).to.be.a(BotifyApi.CrawlDatamodelField);
    });
