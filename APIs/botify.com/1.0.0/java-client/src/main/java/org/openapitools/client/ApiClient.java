...
public class ApiClient {
    ...
    private String basePath = "https://api.botify.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("DjangoRestToken", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.botify.com/v1
