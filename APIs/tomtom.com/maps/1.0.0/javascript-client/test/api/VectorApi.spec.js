...
(function(root, factory) {
  ...
  describe('VectorApi', function() {
    describe('mapVersionNumberTileLayerStyleZoomXYPbfGet', function() {
      it('should call mapVersionNumberTileLayerStyleZoomXYPbfGet successfully', function(done) {
        //uncomment below and update the code to test mapVersionNumberTileLayerStyleZoomXYPbfGet
        //instance.mapVersionNumberTileLayerStyleZoomXYPbfGet(function(error) {
