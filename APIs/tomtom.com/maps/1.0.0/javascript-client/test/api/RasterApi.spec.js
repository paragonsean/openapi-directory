...
(function(root, factory) {
  ...
  describe('RasterApi', function() {
    describe('mapVersionNumberStaticimageGet', function() {
      it('should call mapVersionNumberStaticimageGet successfully', function(done) {
        //uncomment below and update the code to test mapVersionNumberStaticimageGet
        //instance.mapVersionNumberStaticimageGet(function(error) {
    ...
    describe('mapVersionNumberTileLayerStyleZoomXYFormatGet', function() {
      it('should call mapVersionNumberTileLayerStyleZoomXYFormatGet successfully', function(done) {
        //uncomment below and update the code to test mapVersionNumberTileLayerStyleZoomXYFormatGet
        //instance.mapVersionNumberTileLayerStyleZoomXYFormatGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
