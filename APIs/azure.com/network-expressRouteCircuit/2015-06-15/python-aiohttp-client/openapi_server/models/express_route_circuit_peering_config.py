...
class ExpressRouteCircuitPeeringConfig(Model):
    ...
    def __init__(self, advertised_public_prefixes: List[str]=None, advertised_public_prefixes_state: str=None, customer_asn: int=None, routing_registry_name: str=None):
