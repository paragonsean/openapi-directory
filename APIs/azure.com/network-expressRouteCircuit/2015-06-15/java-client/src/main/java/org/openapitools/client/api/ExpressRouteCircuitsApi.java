...
public class ExpressRouteCircuitsApi {
     ...
     */
    public okhttp3.Call expressRouteCircuitsListArpTableCall(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/arpTable"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "circuitName" + "}", localVarApiClient.escapeString(circuitName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call expressRouteCircuitsListArpTableValidateBeforeCall(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return expressRouteCircuitsListArpTableCall(resourceGroupName, circuitName, apiVersion, subscriptionId, _callback);
     ...
     */
    public ExpressRouteCircuitsArpTableListResult expressRouteCircuitsListArpTable(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<ExpressRouteCircuitsArpTableListResult> localVarResp = expressRouteCircuitsListArpTableWithHttpInfo(resourceGroupName, circuitName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExpressRouteCircuitsArpTableListResult> expressRouteCircuitsListArpTableWithHttpInfo(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = expressRouteCircuitsListArpTableValidateBeforeCall(resourceGroupName, circuitName, apiVersion, subscriptionId, null);
     ...
     */
    public okhttp3.Call expressRouteCircuitsListArpTableAsync(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, final ApiCallback<ExpressRouteCircuitsArpTableListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = expressRouteCircuitsListArpTableValidateBeforeCall(resourceGroupName, circuitName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<ExpressRouteCircuitsArpTableListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call expressRouteCircuitsListRoutesTableCall(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/routesTable"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "circuitName" + "}", localVarApiClient.escapeString(circuitName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call expressRouteCircuitsListRoutesTableValidateBeforeCall(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return expressRouteCircuitsListRoutesTableCall(resourceGroupName, circuitName, apiVersion, subscriptionId, _callback);
     ...
     */
    public ExpressRouteCircuitsRoutesTableListResult expressRouteCircuitsListRoutesTable(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<ExpressRouteCircuitsRoutesTableListResult> localVarResp = expressRouteCircuitsListRoutesTableWithHttpInfo(resourceGroupName, circuitName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExpressRouteCircuitsRoutesTableListResult> expressRouteCircuitsListRoutesTableWithHttpInfo(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = expressRouteCircuitsListRoutesTableValidateBeforeCall(resourceGroupName, circuitName, apiVersion, subscriptionId, null);
     ...
     */
    public okhttp3.Call expressRouteCircuitsListRoutesTableAsync(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, final ApiCallback<ExpressRouteCircuitsRoutesTableListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = expressRouteCircuitsListRoutesTableValidateBeforeCall(resourceGroupName, circuitName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<ExpressRouteCircuitsRoutesTableListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
