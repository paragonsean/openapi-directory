...
public class ExpressRouteCircuitPeeringPropertiesFormat {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(azureASN, microsoftPeeringConfig, peerASN, peeringType, primaryAzurePort, primaryPeerAddressPrefix, provisioningState, secondaryAzurePort, secondaryPeerAddressPrefix, sharedKey, state, stats, vlanId);
  }
