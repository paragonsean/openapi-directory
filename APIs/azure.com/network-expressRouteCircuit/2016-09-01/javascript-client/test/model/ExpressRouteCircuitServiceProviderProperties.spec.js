...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.ExpressRouteCircuitServiceProviderProperties();
  });
  ...
  describe('ExpressRouteCircuitServiceProviderProperties', function() {
    it('should create an instance of ExpressRouteCircuitServiceProviderProperties', function() {
      ...
      //var instance = new NetworkManagementClient.ExpressRouteCircuitServiceProviderProperties();
      //expect(instance).to.be.a(NetworkManagementClient.ExpressRouteCircuitServiceProviderProperties);
    });
