...
public class ExpressRouteCircuitPropertiesFormat {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowClassicOperations, authorizations, circuitProvisioningState, gatewayManagerEtag, peerings, provisioningState, serviceKey, serviceProviderNotes, serviceProviderProperties, serviceProviderProvisioningState);
  }
