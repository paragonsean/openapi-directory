...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.ExpressRouteCircuitArpTable();
  });
  ...
  describe('ExpressRouteCircuitArpTable', function() {
    it('should create an instance of ExpressRouteCircuitArpTable', function() {
      // uncomment below and update the code to test ExpressRouteCircuitArpTable
      //var instance = new NetworkManagementClient.ExpressRouteCircuitArpTable();
      //expect(instance).to.be.a(NetworkManagementClient.ExpressRouteCircuitArpTable);
    });
