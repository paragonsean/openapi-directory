...
async def express_route_circuits_update_tags(request: web.Request, resource_group_name, circuit_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = ExpressRouteCircuitsUpdateTagsRequest.from_dict(parameters)
    return web.Response(status=200)
