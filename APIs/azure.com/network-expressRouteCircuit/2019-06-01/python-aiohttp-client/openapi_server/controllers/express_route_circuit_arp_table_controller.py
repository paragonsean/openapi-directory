...
async def express_route_circuits_list_arp_table(request: web.Request, resource_group_name, circuit_name, peering_name, device_path, api_version, subscription_id) -> web.Response:
