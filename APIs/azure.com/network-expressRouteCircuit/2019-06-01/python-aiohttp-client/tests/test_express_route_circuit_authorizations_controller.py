...
async def test_express_route_circuit_authorizations_create_or_update(client):
    ...
    """
    authorization_parameters = {"name":"name","etag":"etag","type":"type","properties":{"authorizationUseStatus":"Available","authorizationKey":"authorizationKey","provisioningState":"provisioningState"}}
