...
async def test_express_route_circuit_connections_create_or_update(client):
    ...
    """
    express_route_circuit_connection_parameters = {"name":"name","etag":"etag","type":"type","properties":{"authorizationKey":"authorizationKey","expressRouteCircuitPeering":{"id":"id"},"addressPrefix":"addressPrefix","peerExpressRouteCircuitPeering":{"id":"id"},"provisioningState":"provisioningState","circuitConnectionStatus":"Connected"}}
