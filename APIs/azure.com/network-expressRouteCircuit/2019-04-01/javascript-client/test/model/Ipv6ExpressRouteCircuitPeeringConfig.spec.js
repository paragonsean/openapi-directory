...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.Ipv6ExpressRouteCircuitPeeringConfig();
  });
  ...
  describe('Ipv6ExpressRouteCircuitPeeringConfig', function() {
    it('should create an instance of Ipv6ExpressRouteCircuitPeeringConfig', function() {
      // uncomment below and update the code to test Ipv6ExpressRouteCircuitPeeringConfig
      //var instance = new NetworkManagementClient.Ipv6ExpressRouteCircuitPeeringConfig();
      //expect(instance).to.be.a(NetworkManagementClient.Ipv6ExpressRouteCircuitPeeringConfig);
    });
