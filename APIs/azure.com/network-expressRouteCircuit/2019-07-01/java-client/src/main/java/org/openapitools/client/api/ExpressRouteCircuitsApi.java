...
public class ExpressRouteCircuitsApi {
    ...
    /**
     * Build call for expressRouteCircuitsUpdateTags
     * @param resourceGroupName The name of the resource group. (required)
     * @param circuitName The name of the circuit. (required)
     * @param apiVersion Client API version. (required)
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     ...
     */
    public okhttp3.Call expressRouteCircuitsUpdateTagsCall(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, ExpressRouteCircuitsUpdateTagsRequest parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call expressRouteCircuitsUpdateTagsValidateBeforeCall(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, ExpressRouteCircuitsUpdateTagsRequest parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling expressRouteCircuitsUpdateTags(Async)");
        }

        // verify the required parameter 'circuitName' is set
        if (circuitName == null) {
            throw new ApiException("Missing the required parameter 'circuitName' when calling expressRouteCircuitsUpdateTags(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling expressRouteCircuitsUpdateTags(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling expressRouteCircuitsUpdateTags(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling expressRouteCircuitsUpdateTags(Async)");
        }

        return expressRouteCircuitsUpdateTagsCall(resourceGroupName, circuitName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public ExpressRouteCircuit expressRouteCircuitsUpdateTags(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, ExpressRouteCircuitsUpdateTagsRequest parameters) throws ApiException {
        ApiResponse<ExpressRouteCircuit> localVarResp = expressRouteCircuitsUpdateTagsWithHttpInfo(resourceGroupName, circuitName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ExpressRouteCircuit> expressRouteCircuitsUpdateTagsWithHttpInfo(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, ExpressRouteCircuitsUpdateTagsRequest parameters) throws ApiException {
        okhttp3.Call localVarCall = expressRouteCircuitsUpdateTagsValidateBeforeCall(resourceGroupName, circuitName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<ExpressRouteCircuit>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call expressRouteCircuitsUpdateTagsAsync(String resourceGroupName, String circuitName, String apiVersion, String subscriptionId, ExpressRouteCircuitsUpdateTagsRequest parameters, final ApiCallback<ExpressRouteCircuit> _callback) throws ApiException {

        okhttp3.Call localVarCall = expressRouteCircuitsUpdateTagsValidateBeforeCall(resourceGroupName, circuitName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<ExpressRouteCircuit>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
