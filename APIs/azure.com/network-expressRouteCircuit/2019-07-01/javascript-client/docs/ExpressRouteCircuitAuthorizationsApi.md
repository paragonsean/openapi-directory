...
let authorizationParameters = new NetworkManagementClient.ExpressRouteCircuitAuthorization(); // ExpressRouteCircuitAuthorization | Parameters supplied to the create or update express route circuit authorization operation.
