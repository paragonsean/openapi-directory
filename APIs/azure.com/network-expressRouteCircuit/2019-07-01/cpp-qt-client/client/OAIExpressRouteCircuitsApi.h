...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAIExpressRouteCircuits_UpdateTags_request [required]
    */
    virtual void expressRouteCircuitsUpdateTags(const QString &resource_group_name, const QString &circuit_name, const QString &api_version, const QString &subscription_id, const OAIExpressRouteCircuits_UpdateTags_request &parameters);
...
private:
    ...
    void expressRouteCircuitsUpdateTagsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void expressRouteCircuitsUpdateTagsSignal(OAIExpressRouteCircuit summary);
    ...
    void expressRouteCircuitsUpdateTagsSignalFull(OAIHttpRequestWorker *worker, OAIExpressRouteCircuit summary);
    ...
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsUpdateTagsSignalError() instead")
    void expressRouteCircuitsUpdateTagsSignalE(OAIExpressRouteCircuit summary, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsUpdateTagsSignalError(OAIExpressRouteCircuit summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsUpdateTagsSignalErrorFull() instead")
    void expressRouteCircuitsUpdateTagsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsUpdateTagsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
