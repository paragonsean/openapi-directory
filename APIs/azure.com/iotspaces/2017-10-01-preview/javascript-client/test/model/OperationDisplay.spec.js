...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoTSpacesClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new IoTSpacesClient.OperationDisplay();
      //expect(instance).to.be.a(IoTSpacesClient.OperationDisplay);
    });
