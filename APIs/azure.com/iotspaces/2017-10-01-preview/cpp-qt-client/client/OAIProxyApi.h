...
public:
    ...
    */
    virtual void ioTSpacesCheckNameAvailability(const QString &api_version, const QString &subscription_id, const OAIOperationInputs &operation_inputs);
...
private:
    ...
    void ioTSpacesCheckNameAvailabilityCallback(OAIHttpRequestWorker *worker);
    void operationsListCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void ioTSpacesCheckNameAvailabilitySignal(OAIIoTSpacesNameAvailabilityInfo summary);
    void operationsListSignal(OAIOperationListResult summary);


    void ioTSpacesCheckNameAvailabilitySignalFull(OAIHttpRequestWorker *worker, OAIIoTSpacesNameAvailabilityInfo summary);
    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIOperationListResult summary);

    Q_DECL_DEPRECATED_X("Use ioTSpacesCheckNameAvailabilitySignalError() instead")
    void ioTSpacesCheckNameAvailabilitySignalE(OAIIoTSpacesNameAvailabilityInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void ioTSpacesCheckNameAvailabilitySignalError(OAIIoTSpacesNameAvailabilityInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use ioTSpacesCheckNameAvailabilitySignalErrorFull() instead")
    void ioTSpacesCheckNameAvailabilitySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void ioTSpacesCheckNameAvailabilitySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
