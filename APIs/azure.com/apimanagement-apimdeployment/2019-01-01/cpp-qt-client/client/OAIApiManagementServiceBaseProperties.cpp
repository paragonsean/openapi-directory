...
bool OAIApiManagementServiceBaseProperties::isEnableClientCertificate() const {
    return m_enable_client_certificate;
}
void OAIApiManagementServiceBaseProperties::setEnableClientCertificate(const bool &enable_client_certificate) {
    m_enable_client_certificate = enable_client_certificate;
    m_enable_client_certificate_isSet = true;
}

bool OAIApiManagementServiceBaseProperties::is_enable_client_certificate_Set() const{
    return m_enable_client_certificate_isSet;
}

bool OAIApiManagementServiceBaseProperties::is_enable_client_certificate_Valid() const{
