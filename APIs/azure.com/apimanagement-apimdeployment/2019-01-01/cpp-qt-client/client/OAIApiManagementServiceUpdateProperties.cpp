...
bool OAIApiManagementServiceUpdateProperties::isEnableClientCertificate() const {
    return m_enable_client_certificate;
}
void OAIApiManagementServiceUpdateProperties::setEnableClientCertificate(const bool &enable_client_certificate) {
    m_enable_client_certificate = enable_client_certificate;
    m_enable_client_certificate_isSet = true;
}

bool OAIApiManagementServiceUpdateProperties::is_enable_client_certificate_Set() const{
    return m_enable_client_certificate_isSet;
}

bool OAIApiManagementServiceUpdateProperties::is_enable_client_certificate_Valid() const{
...
QList<QString> OAIApiManagementServiceUpdateProperties::getPrivateIpAddresses() const {
    return m_private_ip_addresses;
}
void OAIApiManagementServiceUpdateProperties::setPrivateIpAddresses(const QList<QString> &private_ip_addresses) {
    m_private_ip_addresses = private_ip_addresses;
    m_private_ip_addresses_isSet = true;
}

bool OAIApiManagementServiceUpdateProperties::is_private_ip_addresses_Set() const{
    return m_private_ip_addresses_isSet;
}

bool OAIApiManagementServiceUpdateProperties::is_private_ip_addresses_Valid() const{
...
QList<QString> OAIApiManagementServiceUpdateProperties::getPublicIpAddresses() const {
    return m_public_ip_addresses;
}
void OAIApiManagementServiceUpdateProperties::setPublicIpAddresses(const QList<QString> &public_ip_addresses) {
    m_public_ip_addresses = public_ip_addresses;
    m_public_ip_addresses_isSet = true;
}

bool OAIApiManagementServiceUpdateProperties::is_public_ip_addresses_Set() const{
    return m_public_ip_addresses_isSet;
}

bool OAIApiManagementServiceUpdateProperties::is_public_ip_addresses_Valid() const{
