...
class ApiManagementServiceBaseProperties(Model):
    ...
    def __init__(self, additional_locations: List[AdditionalLocation]=None, certificates: List[CertificateConfiguration]=None, created_at_utc: datetime=None, custom_properties: Dict[str, str]=None, enable_client_certificate: bool=False, gateway_regional_url: str=None, gateway_url: str=None, hostname_configurations: List[HostnameConfiguration]=None, management_api_url: str=None, notification_sender_email: str=None, portal_url: str=None, private_ip_addresses: List[str]=None, provisioning_state: str=None, public_ip_addresses: List[str]=None, scm_url: str=None, target_provisioning_state: str=None, virtual_network_configuration: VirtualNetworkConfiguration=None, virtual_network_type: str='None'):
