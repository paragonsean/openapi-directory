 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T10:45:39.059470-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class ApiManagementServiceUpdateProperties {
  ...
  public static final String SERIALIZED_NAME_ENABLE_CLIENT_CERTIFICATE = "enableClientCertificate";
  @SerializedName(SERIALIZED_NAME_ENABLE_CLIENT_CERTIFICATE)
  private Boolean enableClientCertificate = false;
  ...
  public ApiManagementServiceUpdateProperties publisherEmail(String publisherEmail) {
  ...
  public ApiManagementServiceUpdateProperties publisherName(String publisherName) {
  ...
  public ApiManagementServiceUpdateProperties additionalLocations(List<AdditionalLocation> additionalLocations) {
    this.additionalLocations = additionalLocations;
    return this;
  }

  public ApiManagementServiceUpdateProperties addAdditionalLocationsItem(AdditionalLocation additionalLocationsItem) {
  ...
  public ApiManagementServiceUpdateProperties certificates(List<CertificateConfiguration> certificates) {
    this.certificates = certificates;
    return this;
  }

  public ApiManagementServiceUpdateProperties addCertificatesItem(CertificateConfiguration certificatesItem) {
  ...
  public ApiManagementServiceUpdateProperties customProperties(Map<String, String> customProperties) {
    this.customProperties = customProperties;
    return this;
  }

  public ApiManagementServiceUpdateProperties putCustomPropertiesItem(String key, String customPropertiesItem) {
  ...
  public ApiManagementServiceUpdateProperties enableClientCertificate(Boolean enableClientCertificate) {
  ...
  public void setEnableClientCertificate(Boolean enableClientCertificate) {
    this.enableClientCertificate = enableClientCertificate;
  }
  ...
  public ApiManagementServiceUpdateProperties hostnameConfigurations(List<HostnameConfiguration> hostnameConfigurations) {
    this.hostnameConfigurations = hostnameConfigurations;
    return this;
  }

  public ApiManagementServiceUpdateProperties addHostnameConfigurationsItem(HostnameConfiguration hostnameConfigurationsItem) {
  ...
  public ApiManagementServiceUpdateProperties notificationSenderEmail(String notificationSenderEmail) {
  ...
  public ApiManagementServiceUpdateProperties virtualNetworkConfiguration(VirtualNetworkConfiguration virtualNetworkConfiguration) {
  ...
  public ApiManagementServiceUpdateProperties virtualNetworkType(VirtualNetworkTypeEnum virtualNetworkType) {
  ...
  public boolean equals(Object o) {
    ...
    ApiManagementServiceUpdateProperties apiManagementServiceUpdateProperties = (ApiManagementServiceUpdateProperties) o;
    return Objects.equals(this.publisherEmail, apiManagementServiceUpdateProperties.publisherEmail) &&
        Objects.equals(this.publisherName, apiManagementServiceUpdateProperties.publisherName) &&
        Objects.equals(this.additionalLocations, apiManagementServiceUpdateProperties.additionalLocations) &&
        Objects.equals(this.certificates, apiManagementServiceUpdateProperties.certificates) &&
        Objects.equals(this.createdAtUtc, apiManagementServiceUpdateProperties.createdAtUtc) &&
        Objects.equals(this.customProperties, apiManagementServiceUpdateProperties.customProperties) &&
        Objects.equals(this.enableClientCertificate, apiManagementServiceUpdateProperties.enableClientCertificate) &&
        Objects.equals(this.gatewayRegionalUrl, apiManagementServiceUpdateProperties.gatewayRegionalUrl) &&
        Objects.equals(this.gatewayUrl, apiManagementServiceUpdateProperties.gatewayUrl) &&
        Objects.equals(this.hostnameConfigurations, apiManagementServiceUpdateProperties.hostnameConfigurations) &&
        Objects.equals(this.managementApiUrl, apiManagementServiceUpdateProperties.managementApiUrl) &&
        Objects.equals(this.notificationSenderEmail, apiManagementServiceUpdateProperties.notificationSenderEmail) &&
        Objects.equals(this.portalUrl, apiManagementServiceUpdateProperties.portalUrl) &&
        Objects.equals(this.privateIPAddresses, apiManagementServiceUpdateProperties.privateIPAddresses) &&
        Objects.equals(this.provisioningState, apiManagementServiceUpdateProperties.provisioningState) &&
        Objects.equals(this.publicIPAddresses, apiManagementServiceUpdateProperties.publicIPAddresses) &&
        Objects.equals(this.scmUrl, apiManagementServiceUpdateProperties.scmUrl) &&
        Objects.equals(this.targetProvisioningState, apiManagementServiceUpdateProperties.targetProvisioningState) &&
        Objects.equals(this.virtualNetworkConfiguration, apiManagementServiceUpdateProperties.virtualNetworkConfiguration) &&
        Objects.equals(this.virtualNetworkType, apiManagementServiceUpdateProperties.virtualNetworkType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherEmail, publisherName, additionalLocations, certificates, createdAtUtc, customProperties, enableClientCertificate, gatewayRegionalUrl, gatewayUrl, hostnameConfigurations, managementApiUrl, notificationSenderEmail, portalUrl, privateIPAddresses, provisioningState, publicIPAddresses, scmUrl, targetProvisioningState, virtualNetworkConfiguration, virtualNetworkType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiManagementServiceUpdateProperties {\n");
    ...
    sb.append("    enableClientCertificate: ").append(toIndentedString(enableClientCertificate)).append("\n");
  ...
  static {
    ...
    openapiFields.add("enableClientCertificate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiManagementServiceUpdateProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiManagementServiceUpdateProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiManagementServiceUpdateProperties is not found in the empty JSON string", ApiManagementServiceUpdateProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiManagementServiceUpdateProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiManagementServiceUpdateProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("publisherEmail") != null && !jsonObj.get("publisherEmail").isJsonNull()) && !jsonObj.get("publisherEmail").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiManagementServiceUpdateProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiManagementServiceUpdateProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiManagementServiceUpdateProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiManagementServiceUpdateProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiManagementServiceUpdateProperties>() {
           @Override
           public void write(JsonWriter out, ApiManagementServiceUpdateProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiManagementServiceUpdateProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiManagementServiceUpdateProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiManagementServiceUpdateProperties
   * @throws IOException if the JSON string is invalid with respect to ApiManagementServiceUpdateProperties
   */
  public static ApiManagementServiceUpdateProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiManagementServiceUpdateProperties.class);
  }

  /**
   * Convert an instance of ApiManagementServiceUpdateProperties to an JSON string
   *
   * @return JSON string
   */
