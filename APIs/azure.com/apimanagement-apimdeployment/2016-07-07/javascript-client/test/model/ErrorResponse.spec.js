...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new ApiManagementClient.ErrorResponse();
      //expect(instance).to.be.a(ApiManagementClient.ErrorResponse);
    });
