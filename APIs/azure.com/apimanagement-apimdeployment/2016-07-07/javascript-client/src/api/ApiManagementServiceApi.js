...
export default class ApiManagementServiceApi {
    ...
    */
    ...
    apiManagementServicesGetSsoToken(resourceGroupName, serviceName, apiVersion, subscriptionId, callback) {
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/getssotoken', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/ApiManagementServiceBaseParameters} parameters Parameters supplied to the CreateOrUpdate API Management service operation.
