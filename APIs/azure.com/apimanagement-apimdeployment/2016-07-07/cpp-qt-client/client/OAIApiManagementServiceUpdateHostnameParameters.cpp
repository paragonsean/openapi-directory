...
QList<OAIHostnameConfiguration> OAIApiManagementServiceUpdateHostnameParameters::getUpdate() const {
    return m_update;
}
void OAIApiManagementServiceUpdateHostnameParameters::setUpdate(const QList<OAIHostnameConfiguration> &update) {
    m_update = update;
    m_update_isSet = true;
}
