...
async def api_management_services_apply_network_configuration_updates(request: web.Request, resource_group_name, service_name, api_version, subscription_id) -> web.Response:
