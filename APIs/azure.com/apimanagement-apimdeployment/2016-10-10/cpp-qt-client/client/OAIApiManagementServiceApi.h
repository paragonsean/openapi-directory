...
public:
    ...
    */
    virtual void apiManagementServicesApplyNetworkConfigurationUpdates(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id);
    ...
    */
    virtual void apiManagementServicesUpdate(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const OAIApiManagementServiceUpdateParameters &parameters);
...
private:
    ...
    void apiManagementServicesApplyNetworkConfigurationUpdatesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void apiManagementServicesApplyNetworkConfigurationUpdatesSignal(OAIApiManagementServiceResource summary);
    ...
    void apiManagementServicesApplyNetworkConfigurationUpdatesSignalFull(OAIHttpRequestWorker *worker, OAIApiManagementServiceResource summary);
    ...
    Q_DECL_DEPRECATED_X("Use apiManagementServicesApplyNetworkConfigurationUpdatesSignalError() instead")
    void apiManagementServicesApplyNetworkConfigurationUpdatesSignalE(OAIApiManagementServiceResource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiManagementServicesApplyNetworkConfigurationUpdatesSignalError(OAIApiManagementServiceResource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apiManagementServicesApplyNetworkConfigurationUpdatesSignalErrorFull() instead")
    void apiManagementServicesApplyNetworkConfigurationUpdatesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiManagementServicesApplyNetworkConfigurationUpdatesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
