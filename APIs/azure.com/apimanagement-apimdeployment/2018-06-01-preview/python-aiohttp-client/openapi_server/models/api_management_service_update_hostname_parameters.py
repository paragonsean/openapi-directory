...
class ApiManagementServiceUpdateHostnameParameters(Model):
    ...
    def __init__(self, delete: List[str]=None, update: List[HostnameConfigurationOld]=None):
        ...
        self.openapi_types = {
            'delete': List[str],
            'update': List[HostnameConfigurationOld]
        }
    ...
    def update(self):
        ...
        :rtype: List[HostnameConfigurationOld]
        """
        return self._update
    ...
    def update(self, update):
        ...
        :param update: The update of this ApiManagementServiceUpdateHostnameParameters.
        :type update: List[HostnameConfigurationOld]
        """
