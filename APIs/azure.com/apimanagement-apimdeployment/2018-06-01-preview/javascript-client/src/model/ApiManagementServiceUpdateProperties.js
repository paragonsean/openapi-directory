...
/**
 * The ApiManagementServiceUpdateProperties model module.
 * @module model/ApiManagementServiceUpdateProperties
 * @version 2018-06-01-preview
 */
class ApiManagementServiceUpdateProperties {
    /**
     * Constructs a new <code>ApiManagementServiceUpdateProperties</code>.
     * Properties of an API Management service resource description.
     * @alias module:model/ApiManagementServiceUpdateProperties
     * @implements module:model/ApiManagementServiceBaseProperties
     */
    constructor() { 
        ApiManagementServiceBaseProperties.initialize(this);
        ApiManagementServiceUpdateProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiManagementServiceUpdateProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiManagementServiceUpdateProperties} obj Optional instance to populate.
     * @return {module:model/ApiManagementServiceUpdateProperties} The populated <code>ApiManagementServiceUpdateProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiManagementServiceUpdateProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiManagementServiceUpdateProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiManagementServiceUpdateProperties</code>.
     */
 ...
 */
ApiManagementServiceUpdateProperties.prototype['publisherEmail'] = undefined;

/**
 * Publisher name.
 * @member {String} publisherName
 */
ApiManagementServiceUpdateProperties.prototype['publisherName'] = undefined;

/**
 * Additional datacenter locations of the API Management service.
 * @member {Array.<module:model/AdditionalLocation>} additionalLocations
 */
ApiManagementServiceUpdateProperties.prototype['additionalLocations'] = undefined;

/**
 * List of Certificates that need to be installed in the API Management service. Max supported certificates that can be installed is 10.
 * @member {Array.<module:model/CertificateConfiguration>} certificates
 */
ApiManagementServiceUpdateProperties.prototype['certificates'] = undefined;

/**
 * Creation UTC date of the API Management service.The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard.
 * @member {Date} createdAtUtc
 */
ApiManagementServiceUpdateProperties.prototype['createdAtUtc'] = undefined;

/**
 * Custom properties of the API Management service. Setting `Microsoft.WindowsAzure.ApiManagement.Gateway.Security.Ciphers.TripleDes168` will disable the cipher TLS_RSA_WITH_3DES_EDE_CBC_SHA for all TLS(1.0, 1.1 and 1.2). Setting `Microsoft.WindowsAzure.ApiManagement.Gateway.Security.Protocols.Tls11` can be used to disable just TLS 1.1 and setting `Microsoft.WindowsAzure.ApiManagement.Gateway.Security.Protocols.Tls10` can be used to disable TLS 1.0 on an API Management service.
 * @member {Object.<String, String>} customProperties
 */
ApiManagementServiceUpdateProperties.prototype['customProperties'] = undefined;

/**
 * Gateway URL of the API Management service in the Default Region.
 * @member {String} gatewayRegionalUrl
 */
ApiManagementServiceUpdateProperties.prototype['gatewayRegionalUrl'] = undefined;

/**
 * Gateway URL of the API Management service.
 * @member {String} gatewayUrl
 */
ApiManagementServiceUpdateProperties.prototype['gatewayUrl'] = undefined;

/**
 * Custom hostname configuration of the API Management service.
 * @member {Array.<module:model/HostnameConfiguration>} hostnameConfigurations
 */
ApiManagementServiceUpdateProperties.prototype['hostnameConfigurations'] = undefined;

/**
 * Management API endpoint URL of the API Management service.
 * @member {String} managementApiUrl
 */
ApiManagementServiceUpdateProperties.prototype['managementApiUrl'] = undefined;

/**
 * Email address from which the notification will be sent.
 * @member {String} notificationSenderEmail
 */
ApiManagementServiceUpdateProperties.prototype['notificationSenderEmail'] = undefined;

/**
 * Publisher portal endpoint Url of the API Management service.
 * @member {String} portalUrl
 */
ApiManagementServiceUpdateProperties.prototype['portalUrl'] = undefined;
 ...
 */
ApiManagementServiceUpdateProperties.prototype['privateIPAddresses'] = undefined;

/**
 * The current provisioning state of the API Management service which can be one of the following: Created/Activating/Succeeded/Updating/Failed/Stopped/Terminating/TerminationFailed/Deleted.
 * @member {String} provisioningState
 */
ApiManagementServiceUpdateProperties.prototype['provisioningState'] = undefined;
 ...
 */
ApiManagementServiceUpdateProperties.prototype['publicIPAddresses'] = undefined;

/**
 * SCM endpoint URL of the API Management service.
 * @member {String} scmUrl
 */
ApiManagementServiceUpdateProperties.prototype['scmUrl'] = undefined;

/**
 * The provisioning state of the API Management service, which is targeted by the long running operation started on the service.
 * @member {String} targetProvisioningState
 */
ApiManagementServiceUpdateProperties.prototype['targetProvisioningState'] = undefined;

/**
 * @member {module:model/VirtualNetworkConfiguration} virtualNetworkConfiguration
 */
ApiManagementServiceUpdateProperties.prototype['virtualNetworkConfiguration'] = undefined;

/**
 * The type of VPN in which API Management service needs to be configured in. None (Default Value) means the API Management service is not part of any Virtual Network, External means the API Management deployment is set up inside a Virtual Network having an Internet Facing Endpoint, and Internal means that API Management deployment is setup inside a Virtual Network having an Intranet Facing Endpoint only.
 * @member {module:model/ApiManagementServiceUpdateProperties.VirtualNetworkTypeEnum} virtualNetworkType
 * @default 'None'
 */
ApiManagementServiceUpdateProperties.prototype['virtualNetworkType'] = 'None';
 ...
 * @readonly
 */
ApiManagementServiceUpdateProperties['VirtualNetworkTypeEnum'] = {
...
export default ApiManagementServiceUpdateProperties;
