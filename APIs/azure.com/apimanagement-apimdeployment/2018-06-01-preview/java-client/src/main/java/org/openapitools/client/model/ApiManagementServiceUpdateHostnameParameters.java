...
public class ApiManagementServiceUpdateHostnameParameters {
  ...
  private List<HostnameConfigurationOld> update = new ArrayList<>();
  ...
  public ApiManagementServiceUpdateHostnameParameters update(List<HostnameConfigurationOld> update) {
    this.update = update;
    return this;
  }

  public ApiManagementServiceUpdateHostnameParameters addUpdateItem(HostnameConfigurationOld updateItem) {
    if (this.update == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<HostnameConfigurationOld> getUpdate() {
    return update;
  }

  public void setUpdate(List<HostnameConfigurationOld> update) {
    this.update = update;
  }
      ...
      if (jsonObj.get("update") != null && !jsonObj.get("update").isJsonNull()) {
        ...
        if (jsonArrayupdate != null) {
          ...
          for (int i = 0; i < jsonArrayupdate.size(); i++) {
            HostnameConfigurationOld.validateJsonElement(jsonArrayupdate.get(i));
          };
        }
      }
  }
