...
class AdditionalLocation(Model):
    ...
    def __init__(self, disable_gateway: bool=False, gateway_regional_url: str=None, location: str=None, private_ip_addresses: List[str]=None, public_ip_addresses: List[str]=None, sku: ApiManagementServiceSkuProperties=None, virtual_network_configuration: VirtualNetworkConfiguration=None):
        """AdditionalLocation - a model defined in OpenAPI

        :param disable_gateway: The disable_gateway of this AdditionalLocation.
    ...
    def disable_gateway(self):
        """Gets the disable_gateway of this AdditionalLocation.

        Property only valid for an Api Management service deployed in multiple locations. This can be used to disable the gateway in this additional location.

        :return: The disable_gateway of this AdditionalLocation.
        :rtype: bool
        """
    ...
    def disable_gateway(self, disable_gateway):
        """Sets the disable_gateway of this AdditionalLocation.
