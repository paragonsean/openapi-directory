...
async def test_api_management_service_create_or_update(client):
    ...
    """
    parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"046b6c7f-0b8a-43b9-b35d-6489e6daee91","principalId":"046b6c7f-0b8a-43b9-b35d-6489e6daee91","type":"SystemAssigned"},"etag":"etag","location":"location","sku":{"name":"Developer","capacity":0},"properties":{"publisherName":"publisherName","publisherEmail":"publisherEmail"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_api_management_service_update(client):
    ...
    """
    parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"046b6c7f-0b8a-43b9-b35d-6489e6daee91","principalId":"046b6c7f-0b8a-43b9-b35d-6489e6daee91","type":"SystemAssigned"},"etag":"etag","sku":{"name":"Developer","capacity":0},"properties":{"publisherName":"publisherName","publisherEmail":"publisherEmail"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
