...
------------ | ------------- | ------------- | -------------
**disableGateway** | **Boolean** | Property only valid for an Api Management service deployed in multiple locations. This can be used to disable the gateway in this additional location. | [optional] [default to false]
