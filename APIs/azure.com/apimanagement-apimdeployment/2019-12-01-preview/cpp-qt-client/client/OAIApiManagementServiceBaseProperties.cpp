...
OAIApiVersionConstraint OAIApiManagementServiceBaseProperties::getApiVersionConstraint() const {
    return m_api_version_constraint;
}
void OAIApiManagementServiceBaseProperties::setApiVersionConstraint(const OAIApiVersionConstraint &api_version_constraint) {
    m_api_version_constraint = api_version_constraint;
    m_api_version_constraint_isSet = true;
}

bool OAIApiManagementServiceBaseProperties::is_api_version_constraint_Set() const{
    return m_api_version_constraint_isSet;
}

bool OAIApiManagementServiceBaseProperties::is_api_version_constraint_Valid() const{
...
QString OAIApiManagementServiceBaseProperties::getDeveloperPortalUrl() const {
    return m_developer_portal_url;
}
void OAIApiManagementServiceBaseProperties::setDeveloperPortalUrl(const QString &developer_portal_url) {
    m_developer_portal_url = developer_portal_url;
    m_developer_portal_url_isSet = true;
}

bool OAIApiManagementServiceBaseProperties::is_developer_portal_url_Set() const{
    return m_developer_portal_url_isSet;
}

bool OAIApiManagementServiceBaseProperties::is_developer_portal_url_Valid() const{
    return m_developer_portal_url_isValid;
}

bool OAIApiManagementServiceBaseProperties::isDisableGateway() const {
    return m_disable_gateway;
}
void OAIApiManagementServiceBaseProperties::setDisableGateway(const bool &disable_gateway) {
    m_disable_gateway = disable_gateway;
    m_disable_gateway_isSet = true;
}

bool OAIApiManagementServiceBaseProperties::is_disable_gateway_Set() const{
    return m_disable_gateway_isSet;
}

bool OAIApiManagementServiceBaseProperties::is_disable_gateway_Valid() const{
