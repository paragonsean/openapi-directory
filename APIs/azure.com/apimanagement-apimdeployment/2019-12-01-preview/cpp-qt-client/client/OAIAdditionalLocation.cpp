...
bool OAIAdditionalLocation::isDisableGateway() const {
    return m_disable_gateway;
}
void OAIAdditionalLocation::setDisableGateway(const bool &disable_gateway) {
    m_disable_gateway = disable_gateway;
    m_disable_gateway_isSet = true;
}

bool OAIAdditionalLocation::is_disable_gateway_Set() const{
    return m_disable_gateway_isSet;
}

bool OAIAdditionalLocation::is_disable_gateway_Valid() const{
