...
class ApiManagementServiceBaseProperties(Model):
    ...
    def __init__(self, additional_locations: List[AdditionalLocation]=None, certificates: List[CertificateConfiguration]=None, created_at_utc: datetime=None, custom_properties: Dict[str, str]=None, gateway_regional_url: str=None, gateway_url: str=None, hostname_configurations: List[HostnameConfiguration]=None, management_api_url: str=None, notification_sender_email: str=None, portal_url: str=None, provisioning_state: str=None, scm_url: str=None, static_ips: List[str]=None, target_provisioning_state: str=None, virtual_network_configuration: VirtualNetworkConfiguration=None, virtual_network_type: str='None'):
        ...
        :param static_ips: The static_ips of this ApiManagementServiceBaseProperties.
    ...
    @property
    def static_ips(self):
        """Gets the static_ips of this ApiManagementServiceBaseProperties.

        Static IP addresses of the API Management service virtual machines. Available only for Standard and Premium SKU.

        :return: The static_ips of this ApiManagementServiceBaseProperties.
        :rtype: List[str]
        """
    ...
    def static_ips(self, static_ips):
        """Sets the static_ips of this ApiManagementServiceBaseProperties.
