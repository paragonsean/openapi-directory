...
QList<QString> OAIApiManagementServiceBaseProperties::getStaticIps() const {
    return m_static_ips;
}
void OAIApiManagementServiceBaseProperties::setStaticIps(const QList<QString> &static_ips) {
    m_static_ips = static_ips;
    m_static_ips_isSet = true;
}

bool OAIApiManagementServiceBaseProperties::is_static_ips_Set() const{
    return m_static_ips_isSet;
}

bool OAIApiManagementServiceBaseProperties::is_static_ips_Valid() const{
