...
export default class ApiManagementServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiManagementServiceUpdateHostname operation.
     * @callback module:api/ApiManagementServiceApi~apiManagementServiceUpdateHostnameCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiManagementServiceResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ApiManagementServiceApi~apiManagementServiceUpdateHostnameCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiManagementServiceResource}
     */
    apiManagementServiceUpdateHostname(resourceGroupName, serviceName, apiVersion, subscriptionId, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling apiManagementServiceUpdateHostname");
      }
      // verify the required parameter 'serviceName' is set
      if (serviceName === undefined || serviceName === null) {
        throw new Error("Missing the required parameter 'serviceName' when calling apiManagementServiceUpdateHostname");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling apiManagementServiceUpdateHostname");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling apiManagementServiceUpdateHostname");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling apiManagementServiceUpdateHostname");
      }
    ...
    /**
     * Callback function to receive the result of the apiManagementServiceUploadCertificate operation.
     * @callback module:api/ApiManagementServiceApi~apiManagementServiceUploadCertificateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ApiManagementServiceApi~apiManagementServiceUploadCertificateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CertificateInformation}
     */
    apiManagementServiceUploadCertificate(resourceGroupName, serviceName, apiVersion, subscriptionId, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling apiManagementServiceUploadCertificate");
      }
      // verify the required parameter 'serviceName' is set
      if (serviceName === undefined || serviceName === null) {
        throw new Error("Missing the required parameter 'serviceName' when calling apiManagementServiceUploadCertificate");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling apiManagementServiceUploadCertificate");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling apiManagementServiceUploadCertificate");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling apiManagementServiceUploadCertificate");
      }
