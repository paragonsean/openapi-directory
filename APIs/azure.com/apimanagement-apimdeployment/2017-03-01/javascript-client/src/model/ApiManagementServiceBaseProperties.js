...
/**
 * The ApiManagementServiceBaseProperties model module.
 * @module model/ApiManagementServiceBaseProperties
 * @version 2017-03-01
 */
class ApiManagementServiceBaseProperties {
    /**
     * Constructs a new <code>ApiManagementServiceBaseProperties</code>.
     * Base Properties of an API Management service resource description.
     * @alias module:model/ApiManagementServiceBaseProperties
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ApiManagementServiceBaseProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiManagementServiceBaseProperties} obj Optional instance to populate.
     * @return {module:model/ApiManagementServiceBaseProperties} The populated <code>ApiManagementServiceBaseProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiManagementServiceBaseProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiManagementServiceBaseProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiManagementServiceBaseProperties</code>.
     */
 ...
 */
ApiManagementServiceBaseProperties.prototype['staticIps'] = undefined;
 ...
 * @readonly
 */
ApiManagementServiceBaseProperties['VirtualNetworkTypeEnum'] = {
...
export default ApiManagementServiceBaseProperties;
