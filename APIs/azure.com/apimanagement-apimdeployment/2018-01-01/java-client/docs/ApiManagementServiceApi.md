...
<a id="apiManagementServiceUpdateHostname"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApiManagementServiceResource result = apiInstance.apiManagementServiceUpdateHostname(resourceGroupName, serviceName, apiVersion, subscriptionId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiManagementServiceApi#apiManagementServiceUpdateHostname");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="apiManagementServiceUploadCertificate"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CertificateInformation result = apiInstance.apiManagementServiceUploadCertificate(resourceGroupName, serviceName, apiVersion, subscriptionId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApiManagementServiceApi#apiManagementServiceUploadCertificate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
