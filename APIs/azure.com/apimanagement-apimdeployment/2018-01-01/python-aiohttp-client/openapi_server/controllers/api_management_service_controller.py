...
async def api_management_service_update_hostname(request: web.Request, resource_group_name, service_name, api_version, subscription_id, parameters) -> web.Response:
...
async def api_management_service_upload_certificate(request: web.Request, resource_group_name, service_name, api_version, subscription_id, parameters) -> web.Response:
