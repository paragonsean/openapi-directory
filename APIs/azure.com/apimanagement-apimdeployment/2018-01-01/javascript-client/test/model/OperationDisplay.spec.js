...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ApiManagementClient.OperationDisplay();
      //expect(instance).to.be.a(ApiManagementClient.OperationDisplay);
    });
