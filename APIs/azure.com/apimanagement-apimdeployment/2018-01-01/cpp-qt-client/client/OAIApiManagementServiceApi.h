...
public:
    ...
    */
    virtual void apiManagementServiceUpdateHostname(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const OAIApiManagementServiceUpdateHostnameParameters &parameters);
    ...
    */
    virtual void apiManagementServiceUploadCertificate(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const OAIApiManagementServiceUploadCertificateParameters &parameters);
...
private:
    ...
    void apiManagementServiceUpdateHostnameCallback(OAIHttpRequestWorker *worker);
    void apiManagementServiceUploadCertificateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void apiManagementServiceUpdateHostnameSignal(OAIApiManagementServiceResource summary);
    void apiManagementServiceUploadCertificateSignal(OAICertificateInformation summary);
    ...
    void apiManagementServiceUpdateHostnameSignalFull(OAIHttpRequestWorker *worker, OAIApiManagementServiceResource summary);
    void apiManagementServiceUploadCertificateSignalFull(OAIHttpRequestWorker *worker, OAICertificateInformation summary);
    ...
    Q_DECL_DEPRECATED_X("Use apiManagementServiceUpdateHostnameSignalError() instead")
    void apiManagementServiceUpdateHostnameSignalE(OAIApiManagementServiceResource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiManagementServiceUpdateHostnameSignalError(OAIApiManagementServiceResource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiManagementServiceUploadCertificateSignalError() instead")
    void apiManagementServiceUploadCertificateSignalE(OAICertificateInformation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiManagementServiceUploadCertificateSignalError(OAICertificateInformation summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apiManagementServiceUpdateHostnameSignalErrorFull() instead")
    void apiManagementServiceUpdateHostnameSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiManagementServiceUpdateHostnameSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiManagementServiceUploadCertificateSignalErrorFull() instead")
    void apiManagementServiceUploadCertificateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiManagementServiceUploadCertificateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
