...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MixedReality.SpatialAnchorsAccountsGetKeys200Response();
  });
  ...
  describe('SpatialAnchorsAccountsGetKeys200Response', function() {
    it('should create an instance of SpatialAnchorsAccountsGetKeys200Response', function() {
      // uncomment below and update the code to test SpatialAnchorsAccountsGetKeys200Response
      //var instance = new MixedReality.SpatialAnchorsAccountsGetKeys200Response();
      //expect(instance).to.be.a(MixedReality.SpatialAnchorsAccountsGetKeys200Response);
    });
