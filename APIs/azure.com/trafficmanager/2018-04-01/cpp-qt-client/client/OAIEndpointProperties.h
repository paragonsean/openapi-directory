...
class OAIEndpointProperties_subnets_inner;
...
public:
    ...
    QList<OAIEndpointProperties_subnets_inner> getSubnets() const;
    void setSubnets(const QList<OAIEndpointProperties_subnets_inner> &subnets);
...
private:
    ...
    QList<OAIEndpointProperties_subnets_inner> m_subnets;
