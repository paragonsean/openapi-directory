...
QList<OAIEndpointProperties_subnets_inner> OAIEndpointProperties::getSubnets() const {
    return m_subnets;
}
void OAIEndpointProperties::setSubnets(const QList<OAIEndpointProperties_subnets_inner> &subnets) {
    m_subnets = subnets;
    m_subnets_isSet = true;
}

bool OAIEndpointProperties::is_subnets_Set() const{
    return m_subnets_isSet;
}

bool OAIEndpointProperties::is_subnets_Valid() const{
