...
import org.openapitools.client.model.EndpointPropertiesSubnetsInner;
...
public class EndpointProperties {
  ...
  private List<EndpointPropertiesSubnetsInner> subnets = new ArrayList<>();
  ...
  public EndpointProperties subnets(List<EndpointPropertiesSubnetsInner> subnets) {
    this.subnets = subnets;
    return this;
  }

  public EndpointProperties addSubnetsItem(EndpointPropertiesSubnetsInner subnetsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<EndpointPropertiesSubnetsInner> getSubnets() {
    return subnets;
  }

  public void setSubnets(List<EndpointPropertiesSubnetsInner> subnets) {
    this.subnets = subnets;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customHeaders, endpointProperties.customHeaders) &&
        ...
        Objects.equals(this.subnets, endpointProperties.subnets) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customHeaders, endpointLocation, endpointMonitorStatus, endpointStatus, geoMapping, minChildEndpoints, priority, subnets, target, targetResourceId, weight);
  }
      ...
      if (jsonObj.get("subnets") != null && !jsonObj.get("subnets").isJsonNull()) {
        ...
        if (jsonArraysubnets != null) {
          ...
          for (int i = 0; i < jsonArraysubnets.size(); i++) {
            EndpointPropertiesSubnetsInner.validateJsonElement(jsonArraysubnets.get(i));
          };
        }
      }
