...
async def test_endpoints_create_or_update(client):
    ...
    """
    parameters = {"properties":{"targetResourceId":"targetResourceId","endpointLocation":"endpointLocation","endpointStatus":"Enabled","minChildEndpoints":6,"weight":5,"subnets":[{"last":"last","scope":5,"first":"first"},{"last":"last","scope":5,"first":"first"}],"priority":1,"customHeaders":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"geoMapping":["geoMapping","geoMapping"],"endpointMonitorStatus":"CheckingEndpoint","target":"target"}}
