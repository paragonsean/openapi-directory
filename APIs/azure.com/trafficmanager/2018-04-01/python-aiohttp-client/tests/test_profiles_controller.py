...
async def test_profiles_create_or_update(client):
    ...
    """
    parameters = {"properties":{"maxReturn":2,"endpoints":[{"properties":{"targetResourceId":"targetResourceId","endpointLocation":"endpointLocation","endpointStatus":"Enabled","minChildEndpoints":6,"weight":5,"subnets":[{"last":"last","scope":5,"first":"first"},{"last":"last","scope":5,"first":"first"}],"priority":1,"customHeaders":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"geoMapping":["geoMapping","geoMapping"],"endpointMonitorStatus":"CheckingEndpoint","target":"target"}},{"properties":{"targetResourceId":"targetResourceId","endpointLocation":"endpointLocation","endpointStatus":"Enabled","minChildEndpoints":6,"weight":5,"subnets":[{"last":"last","scope":5,"first":"first"},{"last":"last","scope":5,"first":"first"}],"priority":1,"customHeaders":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"geoMapping":["geoMapping","geoMapping"],"endpointMonitorStatus":"CheckingEndpoint","target":"target"}}],"trafficViewEnrollmentStatus":"Enabled","dnsConfig":{"relativeName":"relativeName","fqdn":"fqdn","ttl":0},"monitorConfig":{"profileMonitorStatus":"CheckingEndpoints","path":"path","protocol":"HTTP","expectedStatusCodeRanges":[{"min":9,"max":7},{"min":9,"max":7}],"port":2,"toleratedNumberOfFailures":7,"intervalInSeconds":3,"customHeaders":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"timeoutInSeconds":4},"profileStatus":"Enabled","trafficRoutingMethod":"Performance"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
