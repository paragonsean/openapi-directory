...
------------ | ------------- | ------------- | -------------
**customHeaders** | [**[EndpointPropertiesCustomHeadersInner]**](EndpointPropertiesCustomHeadersInner.md) | List of custom headers. | [optional] 
...
**subnets** | [**[EndpointPropertiesSubnetsInner]**](EndpointPropertiesSubnetsInner.md) | The list of subnets, IP addresses, and/or address ranges mapped to this endpoint when using the &#39;Subnet&#39; traffic routing method. An empty list will match all ranges not covered by other endpoints. | [optional] 
