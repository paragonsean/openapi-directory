...
class ProfileProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('maxReturn')) {
                obj['maxReturn'] = ApiClient.convertToType(data['maxReturn'], 'Number');
            }
 ...
 * @member {Number} maxReturn
 */
ProfileProperties.prototype['maxReturn'] = undefined;
