...
import EndpointPropertiesSubnetsInner from './EndpointPropertiesSubnetsInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('subnets')) {
                obj['subnets'] = ApiClient.convertToType(data['subnets'], [EndpointPropertiesSubnetsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['subnets']) { // data not null
            ...
            for (const item of data['subnets']) {
                EndpointPropertiesSubnetsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/EndpointPropertiesSubnetsInner>} subnets
 */
EndpointProperties.prototype['subnets'] = undefined;
