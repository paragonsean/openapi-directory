...
void OAIEndpointProperties::initializeModel() {
    ...
    m_geo_mapping_isSet = false;
    m_geo_mapping_isValid = false;
...
void OAIEndpointProperties::fromJsonObject(QJsonObject json) {
    ...
    m_geo_mapping_isValid = ::OpenAPI::fromJsonValue(m_geo_mapping, json[QString("geoMapping")]);
    m_geo_mapping_isSet = !json[QString("geoMapping")].isNull() && m_geo_mapping_isValid;
...
QJsonObject OAIEndpointProperties::asJsonObject() const {
    ...
    if (m_geo_mapping.size() > 0) {
        obj.insert(QString("geoMapping"), ::OpenAPI::toJsonValue(m_geo_mapping));
    }
...
QList<QString> OAIEndpointProperties::getGeoMapping() const {
    return m_geo_mapping;
}
void OAIEndpointProperties::setGeoMapping(const QList<QString> &geo_mapping) {
    m_geo_mapping = geo_mapping;
    m_geo_mapping_isSet = true;
}

bool OAIEndpointProperties::is_geo_mapping_Set() const{
    return m_geo_mapping_isSet;
}

bool OAIEndpointProperties::is_geo_mapping_Valid() const{
    return m_geo_mapping_isValid;
}
