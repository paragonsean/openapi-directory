...
class MonitorConfig(Model):
    ...
    def __init__(self, interval_in_seconds: int=None, path: str=None, port: int=None, profile_monitor_status: str=None, protocol: str=None, timeout_in_seconds: int=None, tolerated_number_of_failures: int=None):
