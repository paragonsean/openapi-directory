...
class EndpointProperties(Model):
    ...
    def __init__(self, custom_headers: List[EndpointPropertiesCustomHeadersInner]=None, endpoint_location: str=None, endpoint_monitor_status: str=None, endpoint_status: str=None, geo_mapping: List[str]=None, min_child_endpoints: int=None, priority: int=None, target: str=None, target_resource_id: str=None, weight: int=None):
