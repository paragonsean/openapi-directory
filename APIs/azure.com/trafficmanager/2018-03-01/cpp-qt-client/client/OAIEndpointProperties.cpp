...
QList<OAIEndpointProperties_customHeaders_inner> OAIEndpointProperties::getCustomHeaders() const {
    return m_custom_headers;
}
void OAIEndpointProperties::setCustomHeaders(const QList<OAIEndpointProperties_customHeaders_inner> &custom_headers) {
    m_custom_headers = custom_headers;
    m_custom_headers_isSet = true;
}

bool OAIEndpointProperties::is_custom_headers_Set() const{
    return m_custom_headers_isSet;
}

bool OAIEndpointProperties::is_custom_headers_Valid() const{
