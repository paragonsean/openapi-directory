...
class ProfileProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('trafficViewEnrollmentStatus')) {
                obj['trafficViewEnrollmentStatus'] = ApiClient.convertToType(data['trafficViewEnrollmentStatus'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['trafficViewEnrollmentStatus'] && !(typeof data['trafficViewEnrollmentStatus'] === 'string' || data['trafficViewEnrollmentStatus'] instanceof String)) {
            throw new Error("Expected the field `trafficViewEnrollmentStatus` to be a primitive type in the JSON string but got " + data['trafficViewEnrollmentStatus']);
        }
 ...
 * @member {module:model/ProfileProperties.ProfileStatusEnum} profileStatus
 */
ProfileProperties.prototype['profileStatus'] = undefined;

/**
 * The traffic routing method of the Traffic Manager profile.
 * @member {module:model/ProfileProperties.TrafficRoutingMethodEnum} trafficRoutingMethod
 */
ProfileProperties.prototype['trafficRoutingMethod'] = undefined;

/**
 * Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
 * @member {module:model/ProfileProperties.TrafficViewEnrollmentStatusEnum} trafficViewEnrollmentStatus
 */
ProfileProperties.prototype['trafficViewEnrollmentStatus'] = undefined;
 ...
 * @readonly
 */
ProfileProperties['ProfileStatusEnum'] = {
...
/**
 * Allowed values for the <code>trafficRoutingMethod</code> property.
 * @enum {String}
 * @readonly
 */
ProfileProperties['TrafficRoutingMethodEnum'] = {
...
/**
 * Allowed values for the <code>trafficViewEnrollmentStatus</code> property.
 * @enum {String}
 * @readonly
 */
ProfileProperties['TrafficViewEnrollmentStatusEnum'] = {
