...
async def test_profiles_create_or_update(client):
    ...
    """
    parameters = {"properties":{"endpoints":[{"name":"name","id":"id","type":"type","properties":{"targetResourceId":"targetResourceId","endpointLocation":"endpointLocation","endpointStatus":"endpointStatus","minChildEndpoints":6,"weight":5,"priority":1,"geoMapping":["geoMapping","geoMapping"],"endpointMonitorStatus":"endpointMonitorStatus","target":"target"}},{"name":"name","id":"id","type":"type","properties":{"targetResourceId":"targetResourceId","endpointLocation":"endpointLocation","endpointStatus":"endpointStatus","minChildEndpoints":6,"weight":5,"priority":1,"geoMapping":["geoMapping","geoMapping"],"endpointMonitorStatus":"endpointMonitorStatus","target":"target"}}],"dnsConfig":{"relativeName":"relativeName","fqdn":"fqdn","ttl":0},"monitorConfig":{"profileMonitorStatus":"profileMonitorStatus","path":"path","protocol":"protocol","port":5},"profileStatus":"profileStatus","trafficRoutingMethod":"trafficRoutingMethod"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
