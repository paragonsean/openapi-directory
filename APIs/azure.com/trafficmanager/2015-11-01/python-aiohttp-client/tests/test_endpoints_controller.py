...
async def test_endpoints_create_or_update(client):
    ...
    """
    parameters = {"name":"name","id":"id","type":"type","properties":{"targetResourceId":"targetResourceId","endpointLocation":"endpointLocation","endpointStatus":"endpointStatus","minChildEndpoints":6,"weight":5,"priority":1,"endpointMonitorStatus":"endpointMonitorStatus","target":"target"}}
