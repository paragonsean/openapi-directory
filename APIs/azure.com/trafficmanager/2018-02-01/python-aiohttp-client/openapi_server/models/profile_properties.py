...
class ProfileProperties(Model):
    ...
    def __init__(self, dns_config: DnsConfig=None, endpoints: List[Endpoint]=None, monitor_config: MonitorConfig=None, profile_status: str=None, traffic_routing_method: str=None, traffic_view_enrollment_status: str=None):
