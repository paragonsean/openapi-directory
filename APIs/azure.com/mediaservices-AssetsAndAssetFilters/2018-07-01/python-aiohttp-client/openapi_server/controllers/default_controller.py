...
async def asset_filters_create_or_update(request: web.Request, subscription_id, resource_group_name, account_name, asset_name, filter_name, api_version, parameters) -> web.Response:
    ...
    """
    parameters = AssetFilter.from_dict(parameters)
    return web.Response(status=200)


async def asset_filters_delete(request: web.Request, subscription_id, resource_group_name, account_name, asset_name, filter_name, api_version) -> web.Response:
...
async def asset_filters_get(request: web.Request, subscription_id, resource_group_name, account_name, asset_name, filter_name, api_version) -> web.Response:
    """Get an Asset Filter.
...
async def asset_filters_list(request: web.Request, subscription_id, resource_group_name, account_name, asset_name, api_version) -> web.Response:
    """List Asset Filters
...
async def asset_filters_update(request: web.Request, subscription_id, resource_group_name, account_name, asset_name, filter_name, api_version, parameters) -> web.Response:
...
async def assets_list_streaming_locators(request: web.Request, subscription_id, resource_group_name, account_name, asset_name, api_version) -> web.Response:
