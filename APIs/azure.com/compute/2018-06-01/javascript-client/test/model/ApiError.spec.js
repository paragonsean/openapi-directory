...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.ApiError();
  });
  ...
  describe('ApiError', function() {
    it('should create an instance of ApiError', function() {
      ...
      //var instance = new ComputeManagementClient.ApiError();
      //expect(instance).to.be.a(ComputeManagementClient.ApiError);
    });
