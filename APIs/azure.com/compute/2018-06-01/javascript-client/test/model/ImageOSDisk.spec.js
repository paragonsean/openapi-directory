...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.ImageOSDisk();
  });
  ...
  describe('ImageOSDisk', function() {
    it('should create an instance of ImageOSDisk', function() {
      // uncomment below and update the code to test ImageOSDisk
      //var instance = new ComputeManagementClient.ImageOSDisk();
      //expect(instance).to.be.a(ComputeManagementClient.ImageOSDisk);
    });
