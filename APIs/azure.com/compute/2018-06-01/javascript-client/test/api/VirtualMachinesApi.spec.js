...
(function(root, factory) {
  ...
  describe('VirtualMachinesApi', function() {
    ...
    describe('virtualMachinesReimage', function() {
      it('should call virtualMachinesReimage successfully', function(done) {
        //uncomment below and update the code to test virtualMachinesReimage
        //instance.virtualMachinesReimage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
