...
public class VirtualMachineProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalCapabilities, availabilitySet, diagnosticsProfile, hardwareProfile, instanceView, licenseType, networkProfile, osProfile, provisioningState, proximityPlacementGroup, storageProfile, vmId);
  }
