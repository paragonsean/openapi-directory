...
public class SshPublicKey {
  ...
  public SshPublicKey keyData(String keyData) {
  ...
  public SshPublicKey path(String path) {
    this.path = path;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyData, sshPublicKey.keyData) &&
        Objects.equals(this.path, sshPublicKey.path);
  }
