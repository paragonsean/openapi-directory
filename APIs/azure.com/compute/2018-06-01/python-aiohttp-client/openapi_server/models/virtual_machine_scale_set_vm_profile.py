...
class VirtualMachineScaleSetVMProfile(Model):
    ...
    def __init__(self, additional_capabilities: AdditionalCapabilities=None, diagnostics_profile: DiagnosticsProfile=None, eviction_policy: str=None, extension_profile: VirtualMachineScaleSetExtensionProfile=None, license_type: str=None, network_profile: VirtualMachineScaleSetNetworkProfile=None, os_profile: VirtualMachineScaleSetOSProfile=None, priority: str=None, storage_profile: VirtualMachineScaleSetStorageProfile=None):
        """VirtualMachineScaleSetVMProfile - a model defined in OpenAPI

        :param additional_capabilities: The additional_capabilities of this VirtualMachineScaleSetVMProfile.
    ...
    def additional_capabilities(self):
        """Gets the additional_capabilities of this VirtualMachineScaleSetVMProfile.


        :return: The additional_capabilities of this VirtualMachineScaleSetVMProfile.
    ...
    def additional_capabilities(self, additional_capabilities):
        """Sets the additional_capabilities of this VirtualMachineScaleSetVMProfile.
