...
async def virtual_machines_reimage(request: web.Request, resource_group_name, vm_name, api_version, subscription_id, parameters=None) -> web.Response:
    ...
    """
    parameters = VirtualMachineReimageParameters.from_dict(parameters)
    return web.Response(status=200)
