...
OAIAdditionalCapabilities OAIVirtualMachineScaleSetVMProfile::getAdditionalCapabilities() const {
    return m_additional_capabilities;
}
void OAIVirtualMachineScaleSetVMProfile::setAdditionalCapabilities(const OAIAdditionalCapabilities &additional_capabilities) {
    m_additional_capabilities = additional_capabilities;
    m_additional_capabilities_isSet = true;
}

bool OAIVirtualMachineScaleSetVMProfile::is_additional_capabilities_Set() const{
    return m_additional_capabilities_isSet;
}

bool OAIVirtualMachineScaleSetVMProfile::is_additional_capabilities_Valid() const{
