...
void OAIStorageAccountType::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("StandardSSD_LRS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStorageAccountType::STANDARDSSD_LRS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UltraSSD_LRS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStorageAccountType::ULTRASSD_LRS;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIStorageAccountType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIStorageAccountType::PREMIUM_LRS:
            val = "Premium_LRS";
            break;
        case eOAIStorageAccountType::STANDARDSSD_LRS:
            val = "StandardSSD_LRS";
            break;
        case eOAIStorageAccountType::ULTRASSD_LRS:
            val = "UltraSSD_LRS";
            break;
        default:
            break;
