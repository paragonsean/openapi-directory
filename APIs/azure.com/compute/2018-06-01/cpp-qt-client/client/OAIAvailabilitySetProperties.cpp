...
OAISubResource OAIAvailabilitySetProperties::getProximityPlacementGroup() const {
    return m_proximity_placement_group;
}
void OAIAvailabilitySetProperties::setProximityPlacementGroup(const OAISubResource &proximity_placement_group) {
    m_proximity_placement_group = proximity_placement_group;
    m_proximity_placement_group_isSet = true;
}

bool OAIAvailabilitySetProperties::is_proximity_placement_group_Set() const{
    return m_proximity_placement_group_isSet;
}

bool OAIAvailabilitySetProperties::is_proximity_placement_group_Valid() const{
