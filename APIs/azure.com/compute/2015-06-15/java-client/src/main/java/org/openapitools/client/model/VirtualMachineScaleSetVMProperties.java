...
public class VirtualMachineScaleSetVMProperties {
  ...
  public VirtualMachineScaleSetVMProperties provisioningState(String provisioningState) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availabilitySet, diagnosticsProfile, hardwareProfile, instanceView, latestModelApplied, licenseType, networkProfile, osProfile, provisioningState, storageProfile);
  }
