...
public class VirtualMachineProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availabilitySet, diagnosticsProfile, hardwareProfile, instanceView, licenseType, networkProfile, osProfile, provisioningState, storageProfile);
  }
