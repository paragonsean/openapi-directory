...
class DataDisk {
     ...
     */
    constructor(createOption, lun, name, vhd) { 
        
        DataDisk.initialize(this, createOption, lun, name, vhd);
    }
     ...
     */
    static initialize(obj, createOption, lun, name, vhd) { 
...
DataDisk.RequiredProperties = ["createOption", "lun", "name", "vhd"];
