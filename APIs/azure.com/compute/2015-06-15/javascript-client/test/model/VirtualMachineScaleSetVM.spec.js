...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.VirtualMachineScaleSetVM();
  });
  ...
  describe('VirtualMachineScaleSetVM', function() {
    it('should create an instance of VirtualMachineScaleSetVM', function() {
      // uncomment below and update the code to test VirtualMachineScaleSetVM
      //var instance = new ComputeManagementClient.VirtualMachineScaleSetVM();
      //expect(instance).to.be.a(ComputeManagementClient.VirtualMachineScaleSetVM);
    });
