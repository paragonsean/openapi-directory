...
class VirtualMachineScaleSetProperties(Model):
    ...
    def __init__(self, over_provision: bool=None, provisioning_state: str=None, upgrade_policy: UpgradePolicy=None, virtual_machine_profile: VirtualMachineScaleSetVMProfile=None):
