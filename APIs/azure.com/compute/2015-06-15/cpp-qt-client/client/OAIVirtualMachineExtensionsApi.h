...
Q_SIGNALS:
    ...
    void virtualMachineExtensionsDeleteSignal(OAIOperationStatusResponse summary);
    ...
    void virtualMachineExtensionsDeleteSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void virtualMachineExtensionsDeleteSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachineExtensionsDeleteSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
