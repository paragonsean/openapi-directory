...
public class NetworkProfile {
  ...
  private List<NetworkInterfaceReference> networkInterfaces = new ArrayList<>();

  public NetworkProfile() {
  }

  public NetworkProfile networkInterfaces(List<NetworkInterfaceReference> networkInterfaces) {
    this.networkInterfaces = networkInterfaces;
    return this;
  }

  public NetworkProfile addNetworkInterfacesItem(NetworkInterfaceReference networkInterfacesItem) {
      ...
      if (jsonObj.get("networkInterfaces") != null && !jsonObj.get("networkInterfaces").isJsonNull()) {
        ...
        if (jsonArraynetworkInterfaces != null) {
          ...
          for (int i = 0; i < jsonArraynetworkInterfaces.size(); i++) {
            NetworkInterfaceReference.validateJsonElement(jsonArraynetworkInterfaces.get(i));
          };
        }
      }
  }
