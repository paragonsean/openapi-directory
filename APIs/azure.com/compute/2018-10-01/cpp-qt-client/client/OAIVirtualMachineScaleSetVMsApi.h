...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  vm_scale_set_vm_reimage_input OAIVirtualMachineScaleSetVMReimageParameters [optional]
    */
    virtual void virtualMachineScaleSetVMsReimage(const QString &resource_group_name, const QString &vm_scale_set_name, const QString &instance_id, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<OAIVirtualMachineScaleSetVMReimageParameters> &vm_scale_set_vm_reimage_input = ::OpenAPI::OptionalParam<OAIVirtualMachineScaleSetVMReimageParameters>());
