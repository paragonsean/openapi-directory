...
QList<OAISubResource> OAIVirtualMachineScaleSetUpdateIPConfigurationProperties::getApplicationSecurityGroups() const {
    return m_application_security_groups;
}
void OAIVirtualMachineScaleSetUpdateIPConfigurationProperties::setApplicationSecurityGroups(const QList<OAISubResource> &application_security_groups) {
    m_application_security_groups = application_security_groups;
    m_application_security_groups_isSet = true;
}

bool OAIVirtualMachineScaleSetUpdateIPConfigurationProperties::is_application_security_groups_Set() const{
    return m_application_security_groups_isSet;
}

bool OAIVirtualMachineScaleSetUpdateIPConfigurationProperties::is_application_security_groups_Valid() const{
