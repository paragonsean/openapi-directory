...
async def virtual_machine_scale_set_vms_perform_maintenance(request: web.Request, resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id) -> web.Response:
...
async def virtual_machine_scale_set_vms_redeploy(request: web.Request, resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id) -> web.Response:
...
async def virtual_machine_scale_set_vms_reimage(request: web.Request, resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, vm_scale_set_vm_reimage_input=None) -> web.Response:
    ...
    :type vm_scale_set_vm_reimage_input: dict | bytes

    """
    vm_scale_set_vm_reimage_input = VirtualMachineScaleSetVMReimageParameters.from_dict(vm_scale_set_vm_reimage_input)
    return web.Response(status=200)
...
async def virtual_machine_scale_set_vms_update(request: web.Request, resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = VirtualMachineScaleSetVM.from_dict(parameters)
    return web.Response(status=200)
