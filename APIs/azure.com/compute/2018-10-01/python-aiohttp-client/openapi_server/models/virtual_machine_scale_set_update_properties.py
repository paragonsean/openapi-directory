...
class VirtualMachineScaleSetUpdateProperties(Model):
    ...
    def __init__(self, automatic_repairs_policy: AutomaticRepairsPolicy=None, do_not_run_extensions_on_overprovisioned_vms: bool=None, overprovision: bool=None, proximity_placement_group: SubResource=None, single_placement_group: bool=None, upgrade_policy: UpgradePolicy=None, virtual_machine_profile: VirtualMachineScaleSetUpdateVMProfile=None):
