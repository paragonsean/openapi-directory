...
class VirtualMachineScaleSetDataDisk(Model):
    ...
    def __init__(self, caching: Caching=None, create_option: CreateOption=None, disk_size_gb: int=None, lun: int=None, managed_disk: VirtualMachineScaleSetManagedDiskParameters=None, name: str=None, write_accelerator_enabled: bool=None):
