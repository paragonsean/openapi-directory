...
class VirtualMachineScaleSetVMInstanceView(Model):
    ...
    def __init__(self, boot_diagnostics: BootDiagnosticsInstanceView=None, disks: List[DiskInstanceView]=None, extensions: List[VirtualMachineExtensionInstanceView]=None, maintenance_redeploy_status: MaintenanceRedeployStatus=None, placement_group_id: str=None, platform_fault_domain: int=None, platform_update_domain: int=None, rdp_thumb_print: str=None, statuses: List[InstanceViewStatus]=None, vm_agent: VirtualMachineAgentInstanceView=None, vm_health: VirtualMachineHealthStatus=None):
        ...
        :param maintenance_redeploy_status: The maintenance_redeploy_status of this VirtualMachineScaleSetVMInstanceView.
    ...
    def maintenance_redeploy_status(self):
        """Gets the maintenance_redeploy_status of this VirtualMachineScaleSetVMInstanceView.


        :return: The maintenance_redeploy_status of this VirtualMachineScaleSetVMInstanceView.
    ...
    def maintenance_redeploy_status(self, maintenance_redeploy_status):
        """Sets the maintenance_redeploy_status of this VirtualMachineScaleSetVMInstanceView.
