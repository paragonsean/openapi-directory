...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.VirtualMachineScaleSet();
  });
  ...
  describe('VirtualMachineScaleSet', function() {
    it('should create an instance of VirtualMachineScaleSet', function() {
      // uncomment below and update the code to test VirtualMachineScaleSet
      //var instance = new ComputeManagementClient.VirtualMachineScaleSet();
      //expect(instance).to.be.a(ComputeManagementClient.VirtualMachineScaleSet);
    });
