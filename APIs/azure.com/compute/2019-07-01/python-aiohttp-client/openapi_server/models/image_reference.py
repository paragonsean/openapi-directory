...
class ImageReference(Model):
    ...
    def __init__(self, exact_version: str=None, offer: str=None, publisher: str=None, sku: str=None, version: str=None, id: str=None):
        """ImageReference - a model defined in OpenAPI

        :param exact_version: The exact_version of this ImageReference.
    ...
    def exact_version(self):
        """Gets the exact_version of this ImageReference.

        Specifies in decimal numbers, the version of platform image or marketplace image used to create the virtual machine. This readonly field differs from 'version', only if the value specified in 'version' field is 'latest'.

        :return: The exact_version of this ImageReference.
        :rtype: str
        """
        return self._exact_version

    @exact_version.setter
    def exact_version(self, exact_version):
        """Sets the exact_version of this ImageReference.
