...
from openapi_server.models.eviction_policy import EvictionPolicy
...
class VirtualMachineProperties(Model):
    ...
    def __init__(self, additional_capabilities: AdditionalCapabilities=None, availability_set: SubResource=None, billing_profile: BillingProfile=None, diagnostics_profile: DiagnosticsProfile=None, eviction_policy: EvictionPolicy=None, hardware_profile: HardwareProfile=None, host: SubResource=None, instance_view: VirtualMachineInstanceView=None, license_type: str=None, network_profile: NetworkProfile=None, os_profile: OSProfile=None, priority: Priority=None, provisioning_state: str=None, proximity_placement_group: SubResource=None, storage_profile: StorageProfile=None, virtual_machine_scale_set: SubResource=None, vm_id: str=None):
