...
class ImageDataDisk(Model):
    ...
    def __init__(self, lun: int=None, blob_uri: str=None, caching: str=None, disk_encryption_set: DiskEncryptionSetParameters=None, disk_size_gb: int=None, managed_disk: SubResource=None, snapshot: SubResource=None, storage_account_type: StorageAccountType=None):
        ...
        :param disk_encryption_set: The disk_encryption_set of this ImageDataDisk.
    ...
    def disk_encryption_set(self):
        """Gets the disk_encryption_set of this ImageDataDisk.


        :return: The disk_encryption_set of this ImageDataDisk.
    ...
    def disk_encryption_set(self, disk_encryption_set):
        """Sets the disk_encryption_set of this ImageDataDisk.
