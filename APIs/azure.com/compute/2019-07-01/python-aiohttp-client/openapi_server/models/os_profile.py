...
class OSProfile(Model):
    ...
    def __init__(self, admin_password: str=None, admin_username: str=None, allow_extension_operations: bool=None, computer_name: str=None, custom_data: str=None, linux_configuration: LinuxConfiguration=None, require_guest_provision_signal: bool=None, secrets: List[VaultSecretGroup]=None, windows_configuration: WindowsConfiguration=None):
        ...
        :param require_guest_provision_signal: The require_guest_provision_signal of this OSProfile.
        ...
        self._require_guest_provision_signal = require_guest_provision_signal
    ...
    @property
    def require_guest_provision_signal(self):
        """Gets the require_guest_provision_signal of this OSProfile.

        Specifies whether the guest provision signal is required to infer provision success of the virtual machine.

        :return: The require_guest_provision_signal of this OSProfile.
        :rtype: bool
        """
        return self._require_guest_provision_signal

    @require_guest_provision_signal.setter
    def require_guest_provision_signal(self, require_guest_provision_signal):
        """Sets the require_guest_provision_signal of this OSProfile.
