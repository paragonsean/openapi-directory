...
class VirtualMachineImageProperties(Model):
    ...
    def __init__(self, automatic_os_upgrade_properties: AutomaticOSUpgradeProperties=None, data_disk_images: List[DataDiskImage]=None, hyper_v_generation: HyperVGenerationType=None, os_disk_image: OSDiskImage=None, plan: PurchasePlan=None):
        ...
        :param hyper_v_generation: The hyper_v_generation of this VirtualMachineImageProperties.
    ...
    def hyper_v_generation(self):
        """Gets the hyper_v_generation of this VirtualMachineImageProperties.


        :return: The hyper_v_generation of this VirtualMachineImageProperties.
    ...
    def hyper_v_generation(self, hyper_v_generation):
        """Sets the hyper_v_generation of this VirtualMachineImageProperties.
