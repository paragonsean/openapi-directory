...
class VirtualMachineScaleSetProperties(Model):
    ...
    def __init__(self, additional_capabilities: AdditionalCapabilities=None, automatic_repairs_policy: AutomaticRepairsPolicy=None, do_not_run_extensions_on_overprovisioned_vms: bool=None, overprovision: bool=None, platform_fault_domain_count: int=None, provisioning_state: str=None, proximity_placement_group: SubResource=None, scale_in_policy: ScaleInPolicy=None, single_placement_group: bool=None, unique_id: str=None, upgrade_policy: UpgradePolicy=None, virtual_machine_profile: VirtualMachineScaleSetVMProfile=None, zone_balance: bool=None):
