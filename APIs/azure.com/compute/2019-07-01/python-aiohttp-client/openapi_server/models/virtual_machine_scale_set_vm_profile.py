...
class VirtualMachineScaleSetVMProfile(Model):
    ...
    def __init__(self, billing_profile: BillingProfile=None, diagnostics_profile: DiagnosticsProfile=None, eviction_policy: EvictionPolicy=None, extension_profile: VirtualMachineScaleSetExtensionProfile=None, license_type: str=None, network_profile: VirtualMachineScaleSetNetworkProfile=None, os_profile: VirtualMachineScaleSetOSProfile=None, priority: Priority=None, scheduled_events_profile: ScheduledEventsProfile=None, storage_profile: VirtualMachineScaleSetStorageProfile=None):
