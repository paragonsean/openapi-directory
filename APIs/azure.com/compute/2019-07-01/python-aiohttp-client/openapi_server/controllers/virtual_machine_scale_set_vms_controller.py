...
async def virtual_machine_scale_set_vms_get(request: web.Request, resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, expand=None) -> web.Response:
...
async def virtual_machine_scale_set_vms_power_off(request: web.Request, resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id, skip_shutdown=None) -> web.Response:
