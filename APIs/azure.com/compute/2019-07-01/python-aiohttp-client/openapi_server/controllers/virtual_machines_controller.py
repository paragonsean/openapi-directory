...
async def virtual_machines_list_all(request: web.Request, api_version, subscription_id, status_only=None) -> web.Response:
...
async def virtual_machines_reapply(request: web.Request, resource_group_name, vm_name, api_version, subscription_id) -> web.Response:
