...
async def proximity_placement_groups_get(request: web.Request, resource_group_name, proximity_placement_group_name, api_version, subscription_id, include_colocation_status=None) -> web.Response:
