...
async def availability_sets_update(request: web.Request, resource_group_name, availability_set_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = AvailabilitySetUpdate.from_dict(parameters)
    return web.Response(status=200)
