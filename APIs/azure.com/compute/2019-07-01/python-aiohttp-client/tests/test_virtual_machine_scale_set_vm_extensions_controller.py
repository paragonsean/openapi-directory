...
async def test_virtual_machine_scale_set_vm_extensions_create_or_update(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/{vm_scale_set_name}/virtualMachines/{instance_id}/extensions/{vm_extension_name}'.format(resource_group_name='resource_group_name_example', vm_scale_set_name='vm_scale_set_name_example', instance_id='instance_id_example', vm_extension_name='vm_extension_name_example', subscription_id='subscription_id_example'),
        headers=headers,
...
async def test_virtual_machine_scale_set_vm_extensions_delete(client):
...
async def test_virtual_machine_scale_set_vm_extensions_get(client):
...
async def test_virtual_machine_scale_set_vm_extensions_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Compute/virtualMachineScaleSets/{vm_scale_set_name}/virtualMachines/{instance_id}/extensions'.format(resource_group_name='resource_group_name_example', vm_scale_set_name='vm_scale_set_name_example', instance_id='instance_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_virtual_machine_scale_set_vm_extensions_update(client):
