...
OAIInstanceViewStatus OAIBootDiagnosticsInstanceView::getStatus() const {
    return m_status;
}
void OAIBootDiagnosticsInstanceView::setStatus(const OAIInstanceViewStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBootDiagnosticsInstanceView::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBootDiagnosticsInstanceView::is_status_Valid() const{
