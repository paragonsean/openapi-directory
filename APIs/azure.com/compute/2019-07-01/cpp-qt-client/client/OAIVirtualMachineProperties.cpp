...
OAIEvictionPolicy OAIVirtualMachineProperties::getEvictionPolicy() const {
    return m_eviction_policy;
}
void OAIVirtualMachineProperties::setEvictionPolicy(const OAIEvictionPolicy &eviction_policy) {
...
OAIPriority OAIVirtualMachineProperties::getPriority() const {
    return m_priority;
}
void OAIVirtualMachineProperties::setPriority(const OAIPriority &priority) {
    m_priority = priority;
