...
#ifndef OAIImageDisk_H
#define OAIImageDisk_H
...
class OAIImageDisk : public OAIObject {
public:
    OAIImageDisk();
    OAIImageDisk(QString json);
    ~OAIImageDisk() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageDisk)

#endif // OAIImageDisk_H
