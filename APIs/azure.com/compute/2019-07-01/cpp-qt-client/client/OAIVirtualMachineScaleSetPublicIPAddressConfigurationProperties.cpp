...
QString OAIVirtualMachineScaleSetPublicIPAddressConfigurationProperties::getPublicIpAddressVersion() const {
    return m_public_ip_address_version;
}
void OAIVirtualMachineScaleSetPublicIPAddressConfigurationProperties::setPublicIpAddressVersion(const QString &public_ip_address_version) {
    m_public_ip_address_version = public_ip_address_version;
    m_public_ip_address_version_isSet = true;
}

bool OAIVirtualMachineScaleSetPublicIPAddressConfigurationProperties::is_public_ip_address_version_Set() const{
    return m_public_ip_address_version_isSet;
}

bool OAIVirtualMachineScaleSetPublicIPAddressConfigurationProperties::is_public_ip_address_version_Valid() const{
