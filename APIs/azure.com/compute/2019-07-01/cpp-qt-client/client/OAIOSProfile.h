...
public:
    ...
    bool isRequireGuestProvisionSignal() const;
    void setRequireGuestProvisionSignal(const bool &require_guest_provision_signal);
    bool is_require_guest_provision_signal_Set() const;
    bool is_require_guest_provision_signal_Valid() const;
...
private:
    ...
    bool m_require_guest_provision_signal;
    bool m_require_guest_provision_signal_isSet;
    bool m_require_guest_provision_signal_isValid;
