...
OAIDiskEncryptionSetParameters OAIImageOSDisk::getDiskEncryptionSet() const {
    return m_disk_encryption_set;
}
void OAIImageOSDisk::setDiskEncryptionSet(const OAIDiskEncryptionSetParameters &disk_encryption_set) {
    m_disk_encryption_set = disk_encryption_set;
    m_disk_encryption_set_isSet = true;
}

bool OAIImageOSDisk::is_disk_encryption_set_Set() const{
    return m_disk_encryption_set_isSet;
}

bool OAIImageOSDisk::is_disk_encryption_set_Valid() const{
