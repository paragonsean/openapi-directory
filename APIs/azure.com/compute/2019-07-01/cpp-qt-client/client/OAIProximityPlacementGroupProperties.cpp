...
QList<OAISubResourceWithColocationStatus> OAIProximityPlacementGroupProperties::getAvailabilitySets() const {
    return m_availability_sets;
}
void OAIProximityPlacementGroupProperties::setAvailabilitySets(const QList<OAISubResourceWithColocationStatus> &availability_sets) {
...
OAIInstanceViewStatus OAIProximityPlacementGroupProperties::getColocationStatus() const {
    return m_colocation_status;
}
void OAIProximityPlacementGroupProperties::setColocationStatus(const OAIInstanceViewStatus &colocation_status) {
    m_colocation_status = colocation_status;
    m_colocation_status_isSet = true;
}

bool OAIProximityPlacementGroupProperties::is_colocation_status_Set() const{
    return m_colocation_status_isSet;
}

bool OAIProximityPlacementGroupProperties::is_colocation_status_Valid() const{
...
QList<OAISubResourceWithColocationStatus> OAIProximityPlacementGroupProperties::getVirtualMachineScaleSets() const {
    return m_virtual_machine_scale_sets;
}
void OAIProximityPlacementGroupProperties::setVirtualMachineScaleSets(const QList<OAISubResourceWithColocationStatus> &virtual_machine_scale_sets) {
...
QList<OAISubResourceWithColocationStatus> OAIProximityPlacementGroupProperties::getVirtualMachines() const {
    return m_virtual_machines;
}
void OAIProximityPlacementGroupProperties::setVirtualMachines(const QList<OAISubResourceWithColocationStatus> &virtual_machines) {
