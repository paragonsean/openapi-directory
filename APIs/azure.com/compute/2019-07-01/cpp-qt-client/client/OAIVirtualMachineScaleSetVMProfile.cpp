...
OAIEvictionPolicy OAIVirtualMachineScaleSetVMProfile::getEvictionPolicy() const {
    return m_eviction_policy;
}
void OAIVirtualMachineScaleSetVMProfile::setEvictionPolicy(const OAIEvictionPolicy &eviction_policy) {
...
OAIPriority OAIVirtualMachineScaleSetVMProfile::getPriority() const {
    return m_priority;
}
void OAIVirtualMachineScaleSetVMProfile::setPriority(const OAIPriority &priority) {
    m_priority = priority;
