...
public:
    ...
    * @param[in]  parameters OAIVMScaleSetConvertToSinglePlacementGroupInput [required]
    */
    virtual void virtualMachineScaleSetsConvertToSinglePlacementGroup(const QString &resource_group_name, const QString &vm_scale_set_name, const QString &subscription_id, const OAIVMScaleSetConvertToSinglePlacementGroupInput &parameters);
    ...
    * @param[in]  vm_instance_ids OAIVirtualMachineScaleSetVMInstanceIDs [optional]
    */
    virtual void virtualMachineScaleSetsPowerOff(const QString &resource_group_name, const QString &vm_scale_set_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<bool> &skip_shutdown = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<OAIVirtualMachineScaleSetVMInstanceIDs> &vm_instance_ids = ::OpenAPI::OptionalParam<OAIVirtualMachineScaleSetVMInstanceIDs>());
...
private:
    ...
    void virtualMachineScaleSetsConvertToSinglePlacementGroupCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void virtualMachineScaleSetsConvertToSinglePlacementGroupSignal();
    ...
    void virtualMachineScaleSetsConvertToSinglePlacementGroupSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use virtualMachineScaleSetsConvertToSinglePlacementGroupSignalError() instead")
    void virtualMachineScaleSetsConvertToSinglePlacementGroupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachineScaleSetsConvertToSinglePlacementGroupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use virtualMachineScaleSetsConvertToSinglePlacementGroupSignalErrorFull() instead")
    void virtualMachineScaleSetsConvertToSinglePlacementGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachineScaleSetsConvertToSinglePlacementGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
