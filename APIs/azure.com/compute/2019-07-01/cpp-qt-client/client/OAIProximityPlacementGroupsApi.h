...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  include_colocation_status QString [optional]
    */
    virtual void proximityPlacementGroupsGet(const QString &resource_group_name, const QString &proximity_placement_group_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &include_colocation_status = ::OpenAPI::OptionalParam<QString>());
