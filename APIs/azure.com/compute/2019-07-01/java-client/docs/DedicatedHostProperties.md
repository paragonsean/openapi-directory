...
|**licenseType** | **DedicatedHostLicenseType** |  |  [optional] |
|**platformFaultDomain** | **Integer** | Fault domain of the dedicated host within a dedicated host group. |  [optional] |
|**provisioningState** | **String** | The provisioning state, which only appears in the response. |  [optional] [readonly] |
|**provisioningTime** | **OffsetDateTime** | The date when the host was first provisioned. |  [optional] [readonly] |
|**virtualMachines** | [**List&lt;SubResourceReadOnly&gt;**](SubResourceReadOnly.md) | A list of references to all virtual machines in the Dedicated Host. |  [optional] [readonly] |
