...
public class ProximityPlacementGroupsApi {
     ...
     * @param apiVersion Client Api Version. (required)
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param includeColocationStatus includeColocationStatus&#x3D;true enables fetching the colocation status of all the resources in the proximity placement group. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call proximityPlacementGroupsGetCall(String resourceGroupName, String proximityPlacementGroupName, String apiVersion, String subscriptionId, String includeColocationStatus, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (includeColocationStatus != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("includeColocationStatus", includeColocationStatus));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call proximityPlacementGroupsGetValidateBeforeCall(String resourceGroupName, String proximityPlacementGroupName, String apiVersion, String subscriptionId, String includeColocationStatus, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return proximityPlacementGroupsGetCall(resourceGroupName, proximityPlacementGroupName, apiVersion, subscriptionId, includeColocationStatus, _callback);
     ...
     */
    public ProximityPlacementGroup proximityPlacementGroupsGet(String resourceGroupName, String proximityPlacementGroupName, String apiVersion, String subscriptionId, String includeColocationStatus) throws ApiException {
        ApiResponse<ProximityPlacementGroup> localVarResp = proximityPlacementGroupsGetWithHttpInfo(resourceGroupName, proximityPlacementGroupName, apiVersion, subscriptionId, includeColocationStatus);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProximityPlacementGroup> proximityPlacementGroupsGetWithHttpInfo(String resourceGroupName, String proximityPlacementGroupName, String apiVersion, String subscriptionId, String includeColocationStatus) throws ApiException {
        okhttp3.Call localVarCall = proximityPlacementGroupsGetValidateBeforeCall(resourceGroupName, proximityPlacementGroupName, apiVersion, subscriptionId, includeColocationStatus, null);
        Type localVarReturnType = new TypeToken<ProximityPlacementGroup>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call proximityPlacementGroupsGetAsync(String resourceGroupName, String proximityPlacementGroupName, String apiVersion, String subscriptionId, String includeColocationStatus, final ApiCallback<ProximityPlacementGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = proximityPlacementGroupsGetValidateBeforeCall(resourceGroupName, proximityPlacementGroupName, apiVersion, subscriptionId, includeColocationStatus, _callback);
        Type localVarReturnType = new TypeToken<ProximityPlacementGroup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
