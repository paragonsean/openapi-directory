...
public class ProximityPlacementGroupProperties {
  ...
  private List<SubResourceWithColocationStatus> availabilitySets = new ArrayList<>();

  public static final String SERIALIZED_NAME_COLOCATION_STATUS = "colocationStatus";
  @SerializedName(SERIALIZED_NAME_COLOCATION_STATUS)
  ...
  private List<SubResourceWithColocationStatus> virtualMachineScaleSets = new ArrayList<>();
  ...
  private List<SubResourceWithColocationStatus> virtualMachines = new ArrayList<>();
  ...
  public ProximityPlacementGroupProperties colocationStatus(InstanceViewStatus colocationStatus) {
    this.colocationStatus = colocationStatus;
    return this;
  }

  /**
   * Get colocationStatus
  ...
  public void setColocationStatus(InstanceViewStatus colocationStatus) {
    this.colocationStatus = colocationStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availabilitySets, proximityPlacementGroupProperties.availabilitySets) &&
        Objects.equals(this.colocationStatus, proximityPlacementGroupProperties.colocationStatus) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availabilitySets, colocationStatus, proximityPlacementGroupType, virtualMachineScaleSets, virtualMachines);
  }
  ...
  public String toString() {
    ...
    sb.append("    colocationStatus: ").append(toIndentedString(colocationStatus)).append("\n");
  ...
  static {
    ...
    openapiFields.add("colocationStatus");
      ...
      if (jsonObj.get("availabilitySets") != null && !jsonObj.get("availabilitySets").isJsonNull()) {
        ...
        if (jsonArrayavailabilitySets != null) {
          ...
          for (int i = 0; i < jsonArrayavailabilitySets.size(); i++) {
            SubResourceWithColocationStatus.validateJsonElement(jsonArrayavailabilitySets.get(i));
          };
        }
      }
      // validate the optional field `colocationStatus`
      if (jsonObj.get("colocationStatus") != null && !jsonObj.get("colocationStatus").isJsonNull()) {
        InstanceViewStatus.validateJsonElement(jsonObj.get("colocationStatus"));
      }
      ...
      if (jsonObj.get("virtualMachineScaleSets") != null && !jsonObj.get("virtualMachineScaleSets").isJsonNull()) {
        ...
        if (jsonArrayvirtualMachineScaleSets != null) {
          ...
          for (int i = 0; i < jsonArrayvirtualMachineScaleSets.size(); i++) {
            SubResourceWithColocationStatus.validateJsonElement(jsonArrayvirtualMachineScaleSets.get(i));
          };
        }
      }
      if (jsonObj.get("virtualMachines") != null && !jsonObj.get("virtualMachines").isJsonNull()) {
        ...
        if (jsonArrayvirtualMachines != null) {
          ...
          for (int i = 0; i < jsonArrayvirtualMachines.size(); i++) {
            SubResourceWithColocationStatus.validateJsonElement(jsonArrayvirtualMachines.get(i));
          };
        }
      }
  }
