...
import org.openapitools.client.model.VirtualMachineScaleSetVMNetworkProfileConfiguration;
import org.openapitools.client.model.VirtualMachineScaleSetVMProtectionPolicy;
...
public class VirtualMachineScaleSetVMProperties {
  ...
  public static final String SERIALIZED_NAME_MODEL_DEFINITION_APPLIED = "modelDefinitionApplied";
  @SerializedName(SERIALIZED_NAME_MODEL_DEFINITION_APPLIED)
  ...
  public static final String SERIALIZED_NAME_NETWORK_PROFILE_CONFIGURATION = "networkProfileConfiguration";
  @SerializedName(SERIALIZED_NAME_NETWORK_PROFILE_CONFIGURATION)
  ...
  public VirtualMachineScaleSetVMProperties networkProfileConfiguration(VirtualMachineScaleSetVMNetworkProfileConfiguration networkProfileConfiguration) {
    this.networkProfileConfiguration = networkProfileConfiguration;
    return this;
  }

  /**
   * Get networkProfileConfiguration
   * @return networkProfileConfiguration
   */
  @javax.annotation.Nullable
  ...
  public void setNetworkProfileConfiguration(VirtualMachineScaleSetVMNetworkProfileConfiguration networkProfileConfiguration) {
    this.networkProfileConfiguration = networkProfileConfiguration;
  }
  ...
  public VirtualMachineScaleSetVMProperties protectionPolicy(VirtualMachineScaleSetVMProtectionPolicy protectionPolicy) {
  ...
  public void setProtectionPolicy(VirtualMachineScaleSetVMProtectionPolicy protectionPolicy) {
    this.protectionPolicy = protectionPolicy;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalCapabilities, virtualMachineScaleSetVMProperties.additionalCapabilities) &&
        ...
        Objects.equals(this.modelDefinitionApplied, virtualMachineScaleSetVMProperties.modelDefinitionApplied) &&
        Objects.equals(this.networkProfile, virtualMachineScaleSetVMProperties.networkProfile) &&
        Objects.equals(this.networkProfileConfiguration, virtualMachineScaleSetVMProperties.networkProfileConfiguration) &&
        Objects.equals(this.osProfile, virtualMachineScaleSetVMProperties.osProfile) &&
        Objects.equals(this.protectionPolicy, virtualMachineScaleSetVMProperties.protectionPolicy) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalCapabilities, availabilitySet, diagnosticsProfile, hardwareProfile, instanceView, latestModelApplied, licenseType, modelDefinitionApplied, networkProfile, networkProfileConfiguration, osProfile, protectionPolicy, provisioningState, storageProfile, vmId);
  }
  ...
  public String toString() {
    ...
    sb.append("    modelDefinitionApplied: ").append(toIndentedString(modelDefinitionApplied)).append("\n");
    sb.append("    networkProfile: ").append(toIndentedString(networkProfile)).append("\n");
    sb.append("    networkProfileConfiguration: ").append(toIndentedString(networkProfileConfiguration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("modelDefinitionApplied");
    openapiFields.add("networkProfile");
    openapiFields.add("networkProfileConfiguration");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("modelDefinitionApplied") != null && !jsonObj.get("modelDefinitionApplied").isJsonNull()) && !jsonObj.get("modelDefinitionApplied").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `modelDefinitionApplied` to be a primitive type in the JSON string but got `%s`", jsonObj.get("modelDefinitionApplied").toString()));
      }
      ...
      // validate the optional field `networkProfileConfiguration`
      if (jsonObj.get("networkProfileConfiguration") != null && !jsonObj.get("networkProfileConfiguration").isJsonNull()) {
        VirtualMachineScaleSetVMNetworkProfileConfiguration.validateJsonElement(jsonObj.get("networkProfileConfiguration"));
      }
      ...
      if (jsonObj.get("protectionPolicy") != null && !jsonObj.get("protectionPolicy").isJsonNull()) {
        VirtualMachineScaleSetVMProtectionPolicy.validateJsonElement(jsonObj.get("protectionPolicy"));
      }
