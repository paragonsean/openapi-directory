...
public class ImageDisk {
  ...
  public ImageDisk blobUri(String blobUri) {
  ...
  public ImageDisk caching(CachingEnum caching) {
  ...
  public ImageDisk diskEncryptionSet(DiskEncryptionSetParameters diskEncryptionSet) {
  ...
  public ImageDisk diskSizeGB(Integer diskSizeGB) {
  ...
  public ImageDisk managedDisk(SubResource managedDisk) {
  ...
  public ImageDisk snapshot(SubResource snapshot) {
  ...
  public ImageDisk storageAccountType(StorageAccountType storageAccountType) {
  ...
  public boolean equals(Object o) {
    ...
    ImageDisk imageDisk = (ImageDisk) o;
    return Objects.equals(this.blobUri, imageDisk.blobUri) &&
        Objects.equals(this.caching, imageDisk.caching) &&
        Objects.equals(this.diskEncryptionSet, imageDisk.diskEncryptionSet) &&
        Objects.equals(this.diskSizeGB, imageDisk.diskSizeGB) &&
        Objects.equals(this.managedDisk, imageDisk.managedDisk) &&
        Objects.equals(this.snapshot, imageDisk.snapshot) &&
        Objects.equals(this.storageAccountType, imageDisk.storageAccountType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blobUri, caching, diskEncryptionSet, diskSizeGB, managedDisk, snapshot, storageAccountType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImageDisk {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImageDisk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImageDisk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageDisk is not found in the empty JSON string", ImageDisk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImageDisk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImageDisk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageDisk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageDisk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageDisk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageDisk.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageDisk>() {
           @Override
           public void write(JsonWriter out, ImageDisk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImageDisk read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImageDisk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImageDisk
   * @throws IOException if the JSON string is invalid with respect to ImageDisk
   */
  public static ImageDisk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageDisk.class);
  }

  /**
   * Convert an instance of ImageDisk to an JSON string
   *
   * @return JSON string
   */
