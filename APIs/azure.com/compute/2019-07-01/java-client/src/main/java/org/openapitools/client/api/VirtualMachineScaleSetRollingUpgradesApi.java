...
public class VirtualMachineScaleSetRollingUpgradesApi {
     ...
     */
    public void virtualMachineScaleSetRollingUpgradesCancel(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId) throws ApiException {
        virtualMachineScaleSetRollingUpgradesCancelWithHttpInfo(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId);
    }
     ...
     */
    public ApiResponse<Void> virtualMachineScaleSetRollingUpgradesCancelWithHttpInfo(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId) throws ApiException {
     ...
     */
    public okhttp3.Call virtualMachineScaleSetRollingUpgradesCancelAsync(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, final ApiCallback<Void> _callback) throws ApiException {
    ...
    /**
     * Build call for virtualMachineScaleSetRollingUpgradesStartExtensionUpgrade
     * @param resourceGroupName The name of the resource group. (required)
     * @param vmScaleSetName The name of the VM scale set. (required)
     * @param apiVersion Client Api Version. (required)
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     ...
     */
    public okhttp3.Call virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeCall(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/extensionRollingUpgrade"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "vmScaleSetName" + "}", localVarApiClient.escapeString(vmScaleSetName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeValidateBeforeCall(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling virtualMachineScaleSetRollingUpgradesStartExtensionUpgrade(Async)");
        }

        // verify the required parameter 'vmScaleSetName' is set
        if (vmScaleSetName == null) {
            throw new ApiException("Missing the required parameter 'vmScaleSetName' when calling virtualMachineScaleSetRollingUpgradesStartExtensionUpgrade(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling virtualMachineScaleSetRollingUpgradesStartExtensionUpgrade(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling virtualMachineScaleSetRollingUpgradesStartExtensionUpgrade(Async)");
        }

        return virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeCall(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, _callback);
     ...
     */
    public void virtualMachineScaleSetRollingUpgradesStartExtensionUpgrade(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId) throws ApiException {
        virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeWithHttpInfo(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId);
    }
     ...
     */
    public ApiResponse<Void> virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeWithHttpInfo(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeValidateBeforeCall(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeAsync(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualMachineScaleSetRollingUpgradesStartExtensionUpgradeValidateBeforeCall(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public void virtualMachineScaleSetRollingUpgradesStartOSUpgrade(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId) throws ApiException {
        virtualMachineScaleSetRollingUpgradesStartOSUpgradeWithHttpInfo(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId);
    }
     ...
     */
    public ApiResponse<Void> virtualMachineScaleSetRollingUpgradesStartOSUpgradeWithHttpInfo(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId) throws ApiException {
     ...
     */
    public okhttp3.Call virtualMachineScaleSetRollingUpgradesStartOSUpgradeAsync(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, final ApiCallback<Void> _callback) throws ApiException {
