...
let vmScaleSetName = "vmScaleSetName_example"; // String | The name of the virtual machine scale set to create or update.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let parameters = new ComputeManagementClient.VMScaleSetConvertToSinglePlacementGroupInput(); // VMScaleSetConvertToSinglePlacementGroupInput | The input object for ConvertToSinglePlacementGroup API.
apiInstance.virtualMachineScaleSetsConvertToSinglePlacementGroup(resourceGroupName, vmScaleSetName, subscriptionId, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
