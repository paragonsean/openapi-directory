...
(function(root, factory) {
  ...
  describe('VirtualMachinesApi', function() {
    ...
    describe('virtualMachinesReapply', function() {
      it('should call virtualMachinesReapply successfully', function(done) {
        //uncomment below and update the code to test virtualMachinesReapply
        //instance.virtualMachinesReapply(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
