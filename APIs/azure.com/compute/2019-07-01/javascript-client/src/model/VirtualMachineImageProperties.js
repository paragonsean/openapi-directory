...
class VirtualMachineImageProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('automaticOSUpgradeProperties')) {
                obj['automaticOSUpgradeProperties'] = AutomaticOSUpgradeProperties.constructFromObject(data['automaticOSUpgradeProperties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['automaticOSUpgradeProperties']) { // data not null
          AutomaticOSUpgradeProperties.validateJSON(data['automaticOSUpgradeProperties']);
        }
...
/**
 * @member {module:model/AutomaticOSUpgradeProperties} automaticOSUpgradeProperties
 */
VirtualMachineImageProperties.prototype['automaticOSUpgradeProperties'] = undefined;
 ...
 */
VirtualMachineImageProperties.prototype['hyperVGeneration'] = undefined;
