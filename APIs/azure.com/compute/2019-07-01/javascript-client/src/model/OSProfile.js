...
class OSProfile {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('requireGuestProvisionSignal')) {
                obj['requireGuestProvisionSignal'] = ApiClient.convertToType(data['requireGuestProvisionSignal'], 'Boolean');
            }
 ...
 * @member {Boolean} requireGuestProvisionSignal
 */
OSProfile.prototype['requireGuestProvisionSignal'] = undefined;
