...
class ImageReference {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('exactVersion')) {
                obj['exactVersion'] = ApiClient.convertToType(data['exactVersion'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['exactVersion'] && !(typeof data['exactVersion'] === 'string' || data['exactVersion'] instanceof String)) {
            throw new Error("Expected the field `exactVersion` to be a primitive type in the JSON string but got " + data['exactVersion']);
        }
        // ensure the json data is a string
 ...
 * @member {String} exactVersion
 */
ImageReference.prototype['exactVersion'] = undefined;
