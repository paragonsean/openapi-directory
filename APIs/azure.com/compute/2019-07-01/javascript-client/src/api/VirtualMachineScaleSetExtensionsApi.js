...
export default class VirtualMachineScaleSetExtensionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the virtualMachineScaleSetExtensionsUpdate operation.
     * @callback module:api/VirtualMachineScaleSetExtensionsApi~virtualMachineScaleSetExtensionsUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VirtualMachineScaleSetExtension} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client Api Version.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/VirtualMachineScaleSetExtensionUpdate} extensionParameters Parameters supplied to the Update VM scale set Extension operation.
     * @param {module:api/VirtualMachineScaleSetExtensionsApi~virtualMachineScaleSetExtensionsUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VirtualMachineScaleSetExtension}
     */
    virtualMachineScaleSetExtensionsUpdate(resourceGroupName, vmScaleSetName, vmssExtensionName, apiVersion, subscriptionId, extensionParameters, callback) {
      let postBody = extensionParameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling virtualMachineScaleSetExtensionsUpdate");
      }
      // verify the required parameter 'vmScaleSetName' is set
      if (vmScaleSetName === undefined || vmScaleSetName === null) {
        throw new Error("Missing the required parameter 'vmScaleSetName' when calling virtualMachineScaleSetExtensionsUpdate");
      }
      // verify the required parameter 'vmssExtensionName' is set
      if (vmssExtensionName === undefined || vmssExtensionName === null) {
        throw new Error("Missing the required parameter 'vmssExtensionName' when calling virtualMachineScaleSetExtensionsUpdate");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling virtualMachineScaleSetExtensionsUpdate");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling virtualMachineScaleSetExtensionsUpdate");
      }
      // verify the required parameter 'extensionParameters' is set
      if (extensionParameters === undefined || extensionParameters === null) {
        throw new Error("Missing the required parameter 'extensionParameters' when calling virtualMachineScaleSetExtensionsUpdate");
      }
      ...
      let returnType = VirtualMachineScaleSetExtension;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/extensions/{vmssExtensionName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
