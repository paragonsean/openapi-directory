...
class VirtualMachineScaleSetNetworkConfigurationProperties(Model):
    ...
    def __init__(self, dns_settings: VirtualMachineScaleSetNetworkConfigurationDnsSettings=None, enable_accelerated_networking: bool=None, ip_configurations: List[VirtualMachineScaleSetIPConfiguration]=None, network_security_group: SubResource=None, primary: bool=None):
