...
class VirtualMachineScaleSetVMProfile(Model):
    ...
    def __init__(self, diagnostics_profile: DiagnosticsProfile=None, extension_profile: VirtualMachineScaleSetExtensionProfile=None, license_type: str=None, network_profile: VirtualMachineScaleSetNetworkProfile=None, os_profile: VirtualMachineScaleSetOSProfile=None, storage_profile: VirtualMachineScaleSetStorageProfile=None):
