...
class VirtualMachineScaleSetProperties(Model):
    ...
    def __init__(self, overprovision: bool=None, provisioning_state: str=None, single_placement_group: bool=None, unique_id: str=None, upgrade_policy: UpgradePolicy=None, virtual_machine_profile: VirtualMachineScaleSetVMProfile=None):
