...
async def virtual_machine_scale_set_vms_reimage_all(request: web.Request, resource_group_name, vm_scale_set_name, instance_id, api_version, subscription_id) -> web.Response:
