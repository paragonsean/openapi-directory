...
async def test_virtual_machine_scale_sets_create_or_update(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"sku":{"tier":"tier","name":"name","capacity":1},"zones":["zones","zones"],"plan":{"product":"product","name":"name","promotionCode":"promotionCode","publisher":"publisher"},"properties":{"upgradePolicy":{"automaticOSUpgrade":True,"mode":"Automatic","rollingUpgradePolicy":{"maxUnhealthyInstancePercent":62,"pauseTimeBetweenBatches":"pauseTimeBetweenBatches","maxBatchInstancePercent":12,"maxUnhealthyUpgradedInstancePercent":14}},"overprovision":True,"provisioningState":"provisioningState","singlePlacementGroup":True,"virtualMachineProfile":{"licenseType":"licenseType","extensionProfile":{"extensions":[{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisioningState":"provisioningState","type":"type","forceUpdateTag":"forceUpdateTag","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}},{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisioningState":"provisioningState","type":"type","forceUpdateTag":"forceUpdateTag","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}}]},"storageProfile":{"dataDisks":[{"lun":2,"managedDisk":{"storageAccountType":"Standard_LRS"},"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":5},{"lun":2,"managedDisk":{"storageAccountType":"Standard_LRS"},"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":5}],"imageReference":{"offer":"offer","publisher":"publisher","sku":"sku","version":"version"},"osDisk":{"image":{"uri":"uri"},"vhdContainers":["vhdContainers","vhdContainers"],"managedDisk":{"storageAccountType":"Standard_LRS"},"name":"name","osType":"Windows"}},"diagnosticsProfile":{"bootDiagnostics":{"storageUri":"storageUri","enabled":True}},"networkProfile":{"healthProbe":{"id":"id"},"networkInterfaceConfigurations":[{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":5}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":5}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}}],"dnsSettings":{"dnsServers":["dnsServers","dnsServers"]},"enableAcceleratedNetworking":True,"networkSecurityGroup":{"id":"id"},"primary":True}},{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":5}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":5}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}}],"dnsSettings":{"dnsServers":["dnsServers","dnsServers"]},"enableAcceleratedNetworking":True,"networkSecurityGroup":{"id":"id"},"primary":True}}]},"osProfile":{"adminUsername":"adminUsername","linuxConfiguration":{"disablePasswordAuthentication":True,"ssh":{"publicKeys":[{"path":"path","keyData":"keyData"},{"path":"path","keyData":"keyData"}]}},"customData":"customData","computerNamePrefix":"computerNamePrefix","windowsConfiguration":{"additionalUnattendContent":[{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"},{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"}],"provisionVMAgent":True,"timeZone":"timeZone","winRM":{"listeners":[{"protocol":"Http","certificateUrl":"certificateUrl"},{"protocol":"Http","certificateUrl":"certificateUrl"}]},"enableAutomaticUpdates":True},"secrets":[{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}},{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}}],"adminPassword":"adminPassword"}},"uniqueId":"uniqueId"}}
...
async def test_virtual_machine_scale_sets_update(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"sku":{"tier":"tier","name":"name","capacity":1},"plan":{"product":"product","name":"name","promotionCode":"promotionCode","publisher":"publisher"},"properties":{"upgradePolicy":{"automaticOSUpgrade":True,"mode":"Automatic","rollingUpgradePolicy":{"maxUnhealthyInstancePercent":62,"pauseTimeBetweenBatches":"pauseTimeBetweenBatches","maxBatchInstancePercent":12,"maxUnhealthyUpgradedInstancePercent":14}},"overprovision":True,"singlePlacementGroup":True,"virtualMachineProfile":{"licenseType":"licenseType","extensionProfile":{"extensions":[{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisioningState":"provisioningState","type":"type","forceUpdateTag":"forceUpdateTag","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}},{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisioningState":"provisioningState","type":"type","forceUpdateTag":"forceUpdateTag","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}}]},"storageProfile":{"dataDisks":[{"lun":2,"managedDisk":{"storageAccountType":"Standard_LRS"},"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":5},{"lun":2,"managedDisk":{"storageAccountType":"Standard_LRS"},"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":5}],"imageReference":{"offer":"offer","publisher":"publisher","sku":"sku","version":"version"},"osDisk":{"image":{"uri":"uri"},"vhdContainers":["vhdContainers","vhdContainers"],"managedDisk":{"storageAccountType":"Standard_LRS"},"caching":"None"}},"diagnosticsProfile":{"bootDiagnostics":{"storageUri":"storageUri","enabled":True}},"networkProfile":{"networkInterfaceConfigurations":[{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}}],"dnsSettings":{"dnsServers":["dnsServers","dnsServers"]},"enableAcceleratedNetworking":True,"networkSecurityGroup":{"id":"id"},"primary":True}},{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}}],"dnsSettings":{"dnsServers":["dnsServers","dnsServers"]},"enableAcceleratedNetworking":True,"networkSecurityGroup":{"id":"id"},"primary":True}}]},"osProfile":{"linuxConfiguration":{"disablePasswordAuthentication":True,"ssh":{"publicKeys":[{"path":"path","keyData":"keyData"},{"path":"path","keyData":"keyData"}]}},"customData":"customData","windowsConfiguration":{"additionalUnattendContent":[{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"},{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"}],"provisionVMAgent":True,"timeZone":"timeZone","winRM":{"listeners":[{"protocol":"Http","certificateUrl":"certificateUrl"},{"protocol":"Http","certificateUrl":"certificateUrl"}]},"enableAutomaticUpdates":True},"secrets":[{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}},{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}}]}}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
