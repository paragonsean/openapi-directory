...
export default class VirtualMachineScaleSetVMsApi {
    ...
    */
     ...
     */
    virtualMachineScaleSetVMsGet(resourceGroupName, vmScaleSetName, instanceId, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
     ...
     * data is of type: {@link module:model/OperationStatusResponse}
     */
    virtualMachineScaleSetVMsPowerOff(resourceGroupName, vmScaleSetName, instanceId, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
     ...
     * data is of type: {@link module:model/OperationStatusResponse}
     */
    virtualMachineScaleSetVMsReimage(resourceGroupName, vmScaleSetName, instanceId, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
