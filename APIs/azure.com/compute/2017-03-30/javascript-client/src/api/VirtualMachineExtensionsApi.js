...
export default class VirtualMachineExtensionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the virtualMachinesGetExtensions operation.
     * @callback module:api/VirtualMachineExtensionsApi~virtualMachinesGetExtensionsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [expand] The expand expression to apply on the operation.
     * @param {module:api/VirtualMachineExtensionsApi~virtualMachinesGetExtensionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VirtualMachineExtensionsListResult}
     */
    virtualMachinesGetExtensions(resourceGroupName, vmName, apiVersion, subscriptionId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling virtualMachinesGetExtensions");
      }
      // verify the required parameter 'vmName' is set
      if (vmName === undefined || vmName === null) {
        throw new Error("Missing the required parameter 'vmName' when calling virtualMachinesGetExtensions");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling virtualMachinesGetExtensions");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling virtualMachinesGetExtensions");
      }
