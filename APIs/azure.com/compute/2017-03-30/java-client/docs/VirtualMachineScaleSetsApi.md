...
> OperationStatusResponse virtualMachineScaleSetsReimage(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs)
...
public class Example {
  public static void main(String[] args) {
    ...
    VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs = new VirtualMachineScaleSetVMInstanceIDs(); // VirtualMachineScaleSetVMInstanceIDs | A list of virtual machine instance IDs from the VM scale set.
    try {
      OperationStatusResponse result = apiInstance.virtualMachineScaleSetsReimage(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs);
      System.out.println(result);
    } catch (ApiException e) {
...
> OperationStatusResponse virtualMachineScaleSetsReimageAll(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs)
...
public class Example {
  public static void main(String[] args) {
    ...
    VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs = new VirtualMachineScaleSetVMInstanceIDs(); // VirtualMachineScaleSetVMInstanceIDs | A list of virtual machine instance IDs from the VM scale set.
    try {
      OperationStatusResponse result = apiInstance.virtualMachineScaleSetsReimageAll(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs);
      System.out.println(result);
    } catch (ApiException e) {
