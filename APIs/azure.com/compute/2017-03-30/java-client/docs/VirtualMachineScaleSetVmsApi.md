...
> OperationStatusResponse virtualMachineScaleSetVMsReimageAll(resourceGroupName, vmScaleSetName, instanceId, apiVersion, subscriptionId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      OperationStatusResponse result = apiInstance.virtualMachineScaleSetVMsReimageAll(resourceGroupName, vmScaleSetName, instanceId, apiVersion, subscriptionId);
      System.out.println(result);
    } catch (ApiException e) {
