...
public class VirtualMachineScaleSetVMInstanceView {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bootDiagnostics, disks, extensions, placementGroupId, platformFaultDomain, platformUpdateDomain, rdpThumbPrint, statuses, vmAgent, vmHealth);
  }
