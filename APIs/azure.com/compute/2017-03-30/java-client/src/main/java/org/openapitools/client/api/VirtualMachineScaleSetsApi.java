...
public class VirtualMachineScaleSetsApi {
     ...
     */
    public okhttp3.Call virtualMachineScaleSetsReimageCall(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualMachineScaleSetsReimageValidateBeforeCall(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return virtualMachineScaleSetsReimageCall(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs, _callback);
     ...
     */
    public OperationStatusResponse virtualMachineScaleSetsReimage(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) throws ApiException {
        ApiResponse<OperationStatusResponse> localVarResp = virtualMachineScaleSetsReimageWithHttpInfo(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OperationStatusResponse> virtualMachineScaleSetsReimageWithHttpInfo(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) throws ApiException {
        okhttp3.Call localVarCall = virtualMachineScaleSetsReimageValidateBeforeCall(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs, null);
        Type localVarReturnType = new TypeToken<OperationStatusResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call virtualMachineScaleSetsReimageAsync(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs, final ApiCallback<OperationStatusResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualMachineScaleSetsReimageValidateBeforeCall(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs, _callback);
        Type localVarReturnType = new TypeToken<OperationStatusResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public OperationStatusResponse virtualMachineScaleSetsReimageAll(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) throws ApiException {
        ApiResponse<OperationStatusResponse> localVarResp = virtualMachineScaleSetsReimageAllWithHttpInfo(resourceGroupName, vmScaleSetName, apiVersion, subscriptionId, vmInstanceIDs);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OperationStatusResponse> virtualMachineScaleSetsReimageAllWithHttpInfo(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) throws ApiException {
     ...
     */
    public okhttp3.Call virtualMachineScaleSetsReimageAllAsync(String resourceGroupName, String vmScaleSetName, String apiVersion, String subscriptionId, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs, final ApiCallback<OperationStatusResponse> _callback) throws ApiException {
