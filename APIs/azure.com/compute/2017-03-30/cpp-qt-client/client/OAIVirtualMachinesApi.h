...
Q_SIGNALS:
    ...
    void virtualMachinesPerformMaintenanceSignal(OAIOperationStatusResponse summary);
    ...
    void virtualMachinesPerformMaintenanceSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void virtualMachinesPerformMaintenanceSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachinesPerformMaintenanceSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
