...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.VirtualMachineInstanceView();
  });
  ...
  describe('VirtualMachineInstanceView', function() {
    it('should create an instance of VirtualMachineInstanceView', function() {
      // uncomment below and update the code to test VirtualMachineInstanceView
      //var instance = new ComputeManagementClient.VirtualMachineInstanceView();
      //expect(instance).to.be.a(ComputeManagementClient.VirtualMachineInstanceView);
    });
