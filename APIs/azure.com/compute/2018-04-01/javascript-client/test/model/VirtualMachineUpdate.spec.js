...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.VirtualMachineUpdate();
  });
  ...
  describe('VirtualMachineUpdate', function() {
    it('should create an instance of VirtualMachineUpdate', function() {
      // uncomment below and update the code to test VirtualMachineUpdate
      //var instance = new ComputeManagementClient.VirtualMachineUpdate();
      //expect(instance).to.be.a(ComputeManagementClient.VirtualMachineUpdate);
    });
