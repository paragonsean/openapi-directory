...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new ComputeManagementClient.Resource();
      //expect(instance).to.be.a(ComputeManagementClient.Resource);
    });
