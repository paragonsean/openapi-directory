# ComputeManagementClient.VirtualMachineExtensionUpdateProperties
...
**forceUpdateTag** | **String** | How the extension handler should be forced to update even if the extension configuration has not changed. | [optional] 
