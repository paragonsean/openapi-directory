    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('availabilitySets')) {
                obj['availabilitySets'] = ApiClient.convertToType(data['availabilitySets'], [SubResource]);
            }
            ...
            if (data.hasOwnProperty('virtualMachineScaleSets')) {
                obj['virtualMachineScaleSets'] = ApiClient.convertToType(data['virtualMachineScaleSets'], [SubResource]);
            }
 ...
 * @member {Array.<module:model/SubResource>} availabilitySets
 */
 ...
 * @member {Array.<module:model/SubResource>} virtualMachineScaleSets
 */
