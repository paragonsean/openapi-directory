...
/**
 * The ThrottledRequestsInput model module.
 * @module model/ThrottledRequestsInput
 * @version 2018-04-01
 */
class ThrottledRequestsInput {
    /**
     * Constructs a new <code>ThrottledRequestsInput</code>.
     * Api request input for LogAnalytics getThrottledRequests Api.
     * @alias module:model/ThrottledRequestsInput
    ...
    constructor(blobContainerSasUri, fromTime, toTime) { 
        ...
        ThrottledRequestsInput.initialize(this, blobContainerSasUri, fromTime, toTime);
    }
    ...
    /**
     * Constructs a <code>ThrottledRequestsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ThrottledRequestsInput} obj Optional instance to populate.
     * @return {module:model/ThrottledRequestsInput} The populated <code>ThrottledRequestsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ThrottledRequestsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ThrottledRequestsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ThrottledRequestsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ThrottledRequestsInput.RequiredProperties) {
...
ThrottledRequestsInput.RequiredProperties = ["blobContainerSasUri", "fromTime", "toTime"];

/**
 * SAS Uri of the logging blob container to which LogAnalytics Api writes output logs to.
 * @member {String} blobContainerSasUri
 */
ThrottledRequestsInput.prototype['blobContainerSasUri'] = undefined;

/**
 * From time of the query
 * @member {Date} fromTime
 */
ThrottledRequestsInput.prototype['fromTime'] = undefined;

/**
 * Group query result by Operation Name.
 * @member {Boolean} groupByOperationName
 */
ThrottledRequestsInput.prototype['groupByOperationName'] = undefined;

/**
 * Group query result by Resource Name.
 * @member {Boolean} groupByResourceName
 */
ThrottledRequestsInput.prototype['groupByResourceName'] = undefined;

/**
 * Group query result by Throttle Policy applied.
 * @member {Boolean} groupByThrottlePolicy
 */
ThrottledRequestsInput.prototype['groupByThrottlePolicy'] = undefined;

/**
 * To time of the query
 * @member {Date} toTime
 */
ThrottledRequestsInput.prototype['toTime'] = undefined;
...
export default ThrottledRequestsInput;
