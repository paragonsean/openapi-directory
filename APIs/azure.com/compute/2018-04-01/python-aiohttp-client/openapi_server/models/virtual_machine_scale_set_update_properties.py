...
class VirtualMachineScaleSetUpdateProperties(Model):
    ...
    def __init__(self, overprovision: bool=None, proximity_placement_group: SubResource=None, single_placement_group: bool=None, upgrade_policy: UpgradePolicy=None, virtual_machine_profile: VirtualMachineScaleSetUpdateVMProfile=None):
