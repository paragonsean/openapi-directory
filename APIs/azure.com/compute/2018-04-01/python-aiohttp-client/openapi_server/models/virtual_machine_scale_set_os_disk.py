...
class VirtualMachineScaleSetOSDisk(Model):
    ...
    def __init__(self, caching: Caching=None, create_option: CreateOption=None, disk_size_gb: int=None, image: VirtualHardDisk=None, managed_disk: VirtualMachineScaleSetManagedDiskParameters=None, name: str=None, os_type: str=None, vhd_containers: List[str]=None, write_accelerator_enabled: bool=None):
