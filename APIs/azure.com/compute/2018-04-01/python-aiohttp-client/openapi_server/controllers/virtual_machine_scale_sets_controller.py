...
async def virtual_machine_scale_sets_reimage(request: web.Request, resource_group_name, vm_scale_set_name, api_version, subscription_id, vm_instance_ids=None) -> web.Response:
