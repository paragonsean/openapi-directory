...
async def test_virtual_machines_update(client):
    ...
    """
    parameters = {"identity":{"identityIds":["identityIds","identityIds"],"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"zones":["zones","zones"],"plan":{"product":"product","name":"name","promotionCode":"promotionCode","publisher":"publisher"},"properties":{"availabilitySet":{"id":"id"},"licenseType":"licenseType","instanceView":{"extensions":[{"name":"name","statuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"substatuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"type":"type","typeHandlerVersion":"typeHandlerVersion"},{"name":"name","statuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"substatuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"type":"type","typeHandlerVersion":"typeHandlerVersion"}],"disks":[{"name":"name","statuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"encryptionSettings":[{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}},{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}]},{"name":"name","statuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"encryptionSettings":[{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}},{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}]}],"osVersion":"osVersion","computerName":"computerName","statuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"bootDiagnostics":{"consoleScreenshotBlobUri":"consoleScreenshotBlobUri","serialConsoleLogBlobUri":"serialConsoleLogBlobUri","status":{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}},"maintenanceRedeployStatus":{"isCustomerInitiatedMaintenanceAllowed":True,"maintenanceWindowEndTime":"2000-01-23T04:56:07.000+00:00","maintenanceWindowStartTime":"2000-01-23T04:56:07.000+00:00","lastOperationMessage":"lastOperationMessage","preMaintenanceWindowStartTime":"2000-01-23T04:56:07.000+00:00","preMaintenanceWindowEndTime":"2000-01-23T04:56:07.000+00:00","lastOperationResultCode":"None"},"osName":"osName","platformUpdateDomain":6,"vmAgent":{"vmAgentVersion":"vmAgentVersion","statuses":[{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"},{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}],"extensionHandlers":[{"type":"type","typeHandlerVersion":"typeHandlerVersion","status":{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}},{"type":"type","typeHandlerVersion":"typeHandlerVersion","status":{"code":"code","level":"Info","displayStatus":"displayStatus","time":"2000-01-23T04:56:07.000+00:00","message":"message"}}]},"platformFaultDomain":0,"rdpThumbPrint":"rdpThumbPrint"},"hardwareProfile":{"vmSize":"Basic_A0"},"vmId":"vmId","storageProfile":{"dataDisks":[{"image":{"uri":"uri"},"vhd":{"uri":"uri"},"lun":5,"managedDisk":{"storageAccountType":"Standard_LRS"},"writeAcceleratorEnabled":True,"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":1},{"image":{"uri":"uri"},"vhd":{"uri":"uri"},"lun":5,"managedDisk":{"storageAccountType":"Standard_LRS"},"writeAcceleratorEnabled":True,"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":1}],"imageReference":{"offer":"offer","publisher":"publisher","sku":"sku","version":"version"},"osDisk":{"image":{"uri":"uri"},"vhd":{"uri":"uri"},"managedDisk":{"storageAccountType":"Standard_LRS"},"writeAcceleratorEnabled":True,"name":"name","osType":"Windows","diskSizeGB":5,"encryptionSettings":{"diskEncryptionKey":{"secretUrl":"secretUrl","sourceVault":{"id":"id"}},"enabled":True,"keyEncryptionKey":{"sourceVault":{"id":"id"},"keyUrl":"keyUrl"}}}},"diagnosticsProfile":{"bootDiagnostics":{"storageUri":"storageUri","enabled":True}},"networkProfile":{"networkInterfaces":[{"properties":{"primary":True}},{"properties":{"primary":True}}]},"proximityPlacementGroup":{"id":"id"},"provisioningState":"provisioningState","osProfile":{"adminUsername":"adminUsername","computerName":"computerName","linuxConfiguration":{"disablePasswordAuthentication":True,"ssh":{"publicKeys":[{"path":"path","keyData":"keyData"},{"path":"path","keyData":"keyData"}]}},"customData":"customData","windowsConfiguration":{"additionalUnattendContent":[{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"},{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"}],"provisionVMAgent":True,"timeZone":"timeZone","winRM":{"listeners":[{"protocol":"Http","certificateUrl":"certificateUrl"},{"protocol":"Http","certificateUrl":"certificateUrl"}]},"enableAutomaticUpdates":True},"secrets":[{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}},{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}}],"adminPassword":"adminPassword"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
