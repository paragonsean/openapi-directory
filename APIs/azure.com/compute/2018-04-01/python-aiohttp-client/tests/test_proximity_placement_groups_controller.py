...
async def test_proximity_placement_groups_create_or_update(client):
    ...
    """
    parameters = {"properties":{"proximityPlacementGroupType":"Standard","virtualMachineScaleSets":[{"id":"id"},{"id":"id"}],"availabilitySets":[{"id":"id"},{"id":"id"}],"virtualMachines":[{"id":"id"},{"id":"id"}]}}
