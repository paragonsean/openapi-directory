...
OAIThrottledRequestsInput::OAIThrottledRequestsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThrottledRequestsInput::OAIThrottledRequestsInput() {
    this->initializeModel();
}

OAIThrottledRequestsInput::~OAIThrottledRequestsInput() {}

void OAIThrottledRequestsInput::initializeModel() {
...
void OAIThrottledRequestsInput::fromJson(QString jsonString) {
...
void OAIThrottledRequestsInput::fromJsonObject(QJsonObject json) {
...
QString OAIThrottledRequestsInput::asJson() const {
...
QJsonObject OAIThrottledRequestsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIThrottledRequestsInput::getBlobContainerSasUri() const {
    return m_blob_container_sas_uri;
}
void OAIThrottledRequestsInput::setBlobContainerSasUri(const QString &blob_container_sas_uri) {
    m_blob_container_sas_uri = blob_container_sas_uri;
    m_blob_container_sas_uri_isSet = true;
}

bool OAIThrottledRequestsInput::is_blob_container_sas_uri_Set() const{
    return m_blob_container_sas_uri_isSet;
}

bool OAIThrottledRequestsInput::is_blob_container_sas_uri_Valid() const{
    return m_blob_container_sas_uri_isValid;
}

QDateTime OAIThrottledRequestsInput::getFromTime() const {
    return m_from_time;
}
void OAIThrottledRequestsInput::setFromTime(const QDateTime &from_time) {
    m_from_time = from_time;
    m_from_time_isSet = true;
}

bool OAIThrottledRequestsInput::is_from_time_Set() const{
    return m_from_time_isSet;
}

bool OAIThrottledRequestsInput::is_from_time_Valid() const{
    return m_from_time_isValid;
}

bool OAIThrottledRequestsInput::isGroupByOperationName() const {
    return m_group_by_operation_name;
}
void OAIThrottledRequestsInput::setGroupByOperationName(const bool &group_by_operation_name) {
    m_group_by_operation_name = group_by_operation_name;
    m_group_by_operation_name_isSet = true;
}

bool OAIThrottledRequestsInput::is_group_by_operation_name_Set() const{
    return m_group_by_operation_name_isSet;
}

bool OAIThrottledRequestsInput::is_group_by_operation_name_Valid() const{
    return m_group_by_operation_name_isValid;
}

bool OAIThrottledRequestsInput::isGroupByResourceName() const {
    return m_group_by_resource_name;
}
void OAIThrottledRequestsInput::setGroupByResourceName(const bool &group_by_resource_name) {
    m_group_by_resource_name = group_by_resource_name;
    m_group_by_resource_name_isSet = true;
}

bool OAIThrottledRequestsInput::is_group_by_resource_name_Set() const{
    return m_group_by_resource_name_isSet;
}

bool OAIThrottledRequestsInput::is_group_by_resource_name_Valid() const{
    return m_group_by_resource_name_isValid;
}

bool OAIThrottledRequestsInput::isGroupByThrottlePolicy() const {
    return m_group_by_throttle_policy;
}
void OAIThrottledRequestsInput::setGroupByThrottlePolicy(const bool &group_by_throttle_policy) {
    m_group_by_throttle_policy = group_by_throttle_policy;
    m_group_by_throttle_policy_isSet = true;
}

bool OAIThrottledRequestsInput::is_group_by_throttle_policy_Set() const{
    return m_group_by_throttle_policy_isSet;
}

bool OAIThrottledRequestsInput::is_group_by_throttle_policy_Valid() const{
    return m_group_by_throttle_policy_isValid;
}

QDateTime OAIThrottledRequestsInput::getToTime() const {
    return m_to_time;
}
void OAIThrottledRequestsInput::setToTime(const QDateTime &to_time) {
    m_to_time = to_time;
    m_to_time_isSet = true;
}

bool OAIThrottledRequestsInput::is_to_time_Set() const{
    return m_to_time_isSet;
}

bool OAIThrottledRequestsInput::is_to_time_Valid() const{
    return m_to_time_isValid;
}

bool OAIThrottledRequestsInput::isSet() const {
...
bool OAIThrottledRequestsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_blob_container_sas_uri_isValid && m_from_time_isValid && m_to_time_isValid && true;
}
