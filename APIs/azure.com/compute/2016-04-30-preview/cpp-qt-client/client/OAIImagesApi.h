...
Q_SIGNALS:
    ...
    void imagesDeleteSignal(OAIOperationStatusResponse summary);
    ...
    void imagesDeleteSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void imagesDeleteSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void imagesDeleteSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
