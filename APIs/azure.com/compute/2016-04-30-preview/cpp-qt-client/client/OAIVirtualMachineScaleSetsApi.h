...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void virtualMachineScaleSetsReimageAll(const QString &resource_group_name, const QString &vm_scale_set_name, const QString &api_version, const QString &subscription_id);
...
Q_SIGNALS:
    ...
    void virtualMachineScaleSetsReimageAllSignal(OAIOperationStatusResponse summary);
    ...
    void virtualMachineScaleSetsReimageAllSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void virtualMachineScaleSetsReimageAllSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachineScaleSetsReimageAllSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
