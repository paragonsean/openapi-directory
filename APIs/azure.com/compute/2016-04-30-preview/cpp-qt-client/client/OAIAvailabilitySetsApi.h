...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void availabilitySetsListBySubscription(const QString &api_version, const QString &subscription_id);
...
Q_SIGNALS:
    ...
    void availabilitySetsDeleteSignal(OAIOperationStatusResponse summary);
    ...
    void availabilitySetsDeleteSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void availabilitySetsDeleteSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void availabilitySetsDeleteSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
