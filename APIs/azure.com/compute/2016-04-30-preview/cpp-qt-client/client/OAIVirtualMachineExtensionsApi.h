...
public:
    ...
    * @param[in]  expand QString [optional]
    */
    virtual void virtualMachinesGetExtensions(const QString &resource_group_name, const QString &vm_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void virtualMachinesGetExtensionsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void virtualMachinesGetExtensionsSignal(OAIVirtualMachineExtensionsListResult summary);
    ...
    void virtualMachinesGetExtensionsSignalFull(OAIHttpRequestWorker *worker, OAIVirtualMachineExtensionsListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use virtualMachinesGetExtensionsSignalError() instead")
    void virtualMachinesGetExtensionsSignalE(OAIVirtualMachineExtensionsListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachinesGetExtensionsSignalError(OAIVirtualMachineExtensionsListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use virtualMachinesGetExtensionsSignalErrorFull() instead")
    void virtualMachinesGetExtensionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachinesGetExtensionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
