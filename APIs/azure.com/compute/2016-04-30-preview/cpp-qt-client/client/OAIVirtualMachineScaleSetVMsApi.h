...
Q_SIGNALS:
    ...
    void virtualMachineScaleSetVMsReimageAllSignal(OAIOperationStatusResponse summary);
    ...
    void virtualMachineScaleSetVMsReimageAllSignalFull(OAIHttpRequestWorker *worker, OAIOperationStatusResponse summary);
    ...
    void virtualMachineScaleSetVMsReimageAllSignalE(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualMachineScaleSetVMsReimageAllSignalError(OAIOperationStatusResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
