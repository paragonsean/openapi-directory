...
**type** | **String** | The type of identity used for the virtual machine. Currently, the only supported type is &#39;SystemAssigned&#39;, which implicitly creates an identity. | [optional] 
