...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.PurchasePlan();
  });
  ...
  describe('PurchasePlan', function() {
    it('should create an instance of PurchasePlan', function() {
      // uncomment below and update the code to test PurchasePlan
      //var instance = new ComputeManagementClient.PurchasePlan();
      //expect(instance).to.be.a(ComputeManagementClient.PurchasePlan);
    });
