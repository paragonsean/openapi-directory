...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementClient.NetworkProfile();
  });
  ...
  describe('NetworkProfile', function() {
    it('should create an instance of NetworkProfile', function() {
      ...
      //var instance = new ComputeManagementClient.NetworkProfile();
      //expect(instance).to.be.a(ComputeManagementClient.NetworkProfile);
    });
