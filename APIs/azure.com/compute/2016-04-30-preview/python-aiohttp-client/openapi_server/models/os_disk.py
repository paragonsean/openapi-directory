...
class OSDisk(Model):
    ...
    def __init__(self, caching: Caching=None, create_option: CreateOption=None, disk_size_gb: int=None, encryption_settings: DiskEncryptionSettings=None, image: VirtualHardDisk=None, managed_disk: ManagedDiskParameters=None, name: str=None, os_type: str=None, vhd: VirtualHardDisk=None):
