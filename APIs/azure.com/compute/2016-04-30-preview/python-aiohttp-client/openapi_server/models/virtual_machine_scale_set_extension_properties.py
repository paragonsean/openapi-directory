...
class VirtualMachineScaleSetExtensionProperties(Model):
    ...
    def __init__(self, auto_upgrade_minor_version: bool=None, protected_settings: object=None, provisioning_state: str=None, publisher: str=None, settings: object=None, type: str=None, type_handler_version: str=None):
