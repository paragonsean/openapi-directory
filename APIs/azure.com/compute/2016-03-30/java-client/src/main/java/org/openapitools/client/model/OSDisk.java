...
public class OSDisk {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(caching, createOption, diskSizeGB, encryptionSettings, image, name, osType, vhd);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `vhd`
