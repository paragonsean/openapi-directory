...
async def test_virtual_machine_scale_sets_create_or_update(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"sku":{"tier":"tier","name":"name","capacity":0},"properties":{"upgradePolicy":{"mode":"Automatic"},"overProvision":True,"provisioningState":"provisioningState","virtualMachineProfile":{"extensionProfile":{"extensions":[{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisioningState":"provisioningState","type":"type","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}},{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisioningState":"provisioningState","type":"type","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}}]},"storageProfile":{"imageReference":{"offer":"offer","publisher":"publisher","sku":"sku","version":"version"},"osDisk":{"image":{"uri":"uri"},"vhdContainers":["vhdContainers","vhdContainers"],"name":"name","osType":"Windows","caching":"None","createOption":"FromImage"}},"networkProfile":{"networkInterfaceConfigurations":[{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}]}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}]}}],"primary":True}},{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}]}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}]}}],"primary":True}}]},"osProfile":{"adminUsername":"adminUsername","linuxConfiguration":{"disablePasswordAuthentication":True,"ssh":{"publicKeys":[{"path":"path","keyData":"keyData"},{"path":"path","keyData":"keyData"}]}},"customData":"customData","computerNamePrefix":"computerNamePrefix","windowsConfiguration":{"additionalUnattendContent":[{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"},{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"}],"provisionVMAgent":True,"timeZone":"timeZone","winRM":{"listeners":[{"protocol":"Http","certificateUrl":"certificateUrl"},{"protocol":"Http","certificateUrl":"certificateUrl"}]},"enableAutomaticUpdates":True},"secrets":[{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}},{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}}],"adminPassword":"adminPassword"}}}}
