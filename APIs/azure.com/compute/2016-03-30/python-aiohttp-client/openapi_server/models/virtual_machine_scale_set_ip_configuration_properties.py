...
class VirtualMachineScaleSetIPConfigurationProperties(Model):
    ...
    def __init__(self, application_gateway_backend_address_pools: List[SubResource]=None, load_balancer_backend_address_pools: List[SubResource]=None, load_balancer_inbound_nat_pools: List[SubResource]=None, subnet: ApiEntityReference=None):
