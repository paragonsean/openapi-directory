...
class DataDisk(Model):
    ...
    def __init__(self, caching: Caching=None, create_option: CreateOption=None, disk_size_gb: int=None, image: VirtualHardDisk=None, lun: int=None, name: str=None, vhd: VirtualHardDisk=None):
