...
class OSProfile(Model):
    ...
    def __init__(self, admin_password: str=None, admin_username: str=None, computer_name: str=None, custom_data: str=None, linux_configuration: LinuxConfiguration=None, secrets: List[VaultSecretGroup]=None, windows_configuration: WindowsConfiguration=None):
