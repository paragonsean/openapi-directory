...
class VirtualMachineScaleSetOSDisk {
     ...
     */
    constructor(createOption, name) { 
        
        VirtualMachineScaleSetOSDisk.initialize(this, createOption, name);
    }
     ...
     */
    static initialize(obj, createOption, name) { 
...
VirtualMachineScaleSetOSDisk.RequiredProperties = ["createOption", "name"];
