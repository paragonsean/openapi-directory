...
class ImageStorageProfile {
    ...
    constructor() { 
        ...
        ImageStorageProfile.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('zoneResilient')) {
                obj['zoneResilient'] = ApiClient.convertToType(data['zoneResilient'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} zoneResilient
 */
ImageStorageProfile.prototype['zoneResilient'] = undefined;
