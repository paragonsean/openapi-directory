...
class DataDisk {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('toBeDetached')) {
                obj['toBeDetached'] = ApiClient.convertToType(data['toBeDetached'], 'Boolean');
            }
 ...
 * @member {Boolean} toBeDetached
 */
DataDisk.prototype['toBeDetached'] = undefined;
