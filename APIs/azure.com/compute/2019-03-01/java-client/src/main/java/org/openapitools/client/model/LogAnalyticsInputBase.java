...
public class LogAnalyticsInputBase {
  ...
  public LogAnalyticsInputBase blobContainerSasUri(String blobContainerSasUri) {
  ...
  public LogAnalyticsInputBase fromTime(OffsetDateTime fromTime) {
  ...
  public LogAnalyticsInputBase groupByOperationName(Boolean groupByOperationName) {
  ...
  public LogAnalyticsInputBase groupByResourceName(Boolean groupByResourceName) {
  ...
  public LogAnalyticsInputBase groupByThrottlePolicy(Boolean groupByThrottlePolicy) {
  ...
  public LogAnalyticsInputBase toTime(OffsetDateTime toTime) {
    this.toTime = toTime;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LogAnalyticsInputBase logAnalyticsInputBase = (LogAnalyticsInputBase) o;
    return Objects.equals(this.blobContainerSasUri, logAnalyticsInputBase.blobContainerSasUri) &&
        Objects.equals(this.fromTime, logAnalyticsInputBase.fromTime) &&
        Objects.equals(this.groupByOperationName, logAnalyticsInputBase.groupByOperationName) &&
        Objects.equals(this.groupByResourceName, logAnalyticsInputBase.groupByResourceName) &&
        Objects.equals(this.groupByThrottlePolicy, logAnalyticsInputBase.groupByThrottlePolicy) &&
        Objects.equals(this.toTime, logAnalyticsInputBase.toTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogAnalyticsInputBase {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogAnalyticsInputBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogAnalyticsInputBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogAnalyticsInputBase is not found in the empty JSON string", LogAnalyticsInputBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogAnalyticsInputBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogAnalyticsInputBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LogAnalyticsInputBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogAnalyticsInputBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogAnalyticsInputBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogAnalyticsInputBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogAnalyticsInputBase.class));

       return (TypeAdapter<T>) new TypeAdapter<LogAnalyticsInputBase>() {
           @Override
           public void write(JsonWriter out, LogAnalyticsInputBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogAnalyticsInputBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogAnalyticsInputBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogAnalyticsInputBase
   * @throws IOException if the JSON string is invalid with respect to LogAnalyticsInputBase
   */
  public static LogAnalyticsInputBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogAnalyticsInputBase.class);
  }

  /**
   * Convert an instance of LogAnalyticsInputBase to an JSON string
   *
   * @return JSON string
   */
