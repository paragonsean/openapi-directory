...
class DataDisk(Model):
    ...
    def __init__(self, caching: Caching=None, create_option: CreateOption=None, disk_size_gb: int=None, image: VirtualHardDisk=None, lun: int=None, managed_disk: ManagedDiskParameters=None, name: str=None, to_be_detached: bool=None, vhd: VirtualHardDisk=None, write_accelerator_enabled: bool=None):
