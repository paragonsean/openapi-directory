...
class ImageDataDisk(Model):
    ...
    def __init__(self, blob_uri: str=None, caching: str=None, disk_size_gb: int=None, lun: int=None, managed_disk: SubResource=None, snapshot: SubResource=None, storage_account_type: StorageAccountType=None):
        ...
        :param storage_account_type: The storage_account_type of this ImageDataDisk.
        """
        self.openapi_types = {
            'blob_uri': str,
            'caching': str,
    ...
    def storage_account_type(self):
        """Gets the storage_account_type of this ImageDataDisk.


        :return: The storage_account_type of this ImageDataDisk.
    ...
    def storage_account_type(self, storage_account_type):
        """Sets the storage_account_type of this ImageDataDisk.
