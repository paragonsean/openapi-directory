...
class VirtualMachineScaleSetUpdateProperties(Model):
    ...
    def __init__(self, additional_capabilities: AdditionalCapabilities=None, overprovision: bool=None, scale_in_policy: ScaleInPolicy=None, single_placement_group: bool=None, upgrade_policy: UpgradePolicy=None, virtual_machine_profile: VirtualMachineScaleSetUpdateVMProfile=None):
