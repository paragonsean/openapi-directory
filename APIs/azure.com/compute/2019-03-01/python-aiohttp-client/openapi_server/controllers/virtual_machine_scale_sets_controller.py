...
async def virtual_machine_scale_sets_convert_to_single_placement_group(request: web.Request, resource_group_name, vm_scale_set_name, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = VMScaleSetConvertToSinglePlacementGroupInput.from_dict(parameters)
...
async def virtual_machine_scale_sets_power_off(request: web.Request, resource_group_name, vm_scale_set_name, api_version, subscription_id, skip_shutdown=None, vm_instance_ids=None) -> web.Response:
    ...
    :param subscription_id: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    :type subscription_id: str
    :param skip_shutdown: The parameter to request non-graceful VM shutdown. True value for this flag indicates non-graceful shutdown whereas false indicates otherwise. Default value for this flag is false if not specified
