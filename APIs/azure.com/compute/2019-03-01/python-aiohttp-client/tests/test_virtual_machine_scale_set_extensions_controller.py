...
async def test_virtual_machine_scale_set_extensions_create_or_update(client):
    ...
    """
    extension_parameters = {"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisionAfterExtensions":["provisionAfterExtensions","provisionAfterExtensions"],"provisioningState":"provisioningState","type":"type","forceUpdateTag":"forceUpdateTag","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}}
