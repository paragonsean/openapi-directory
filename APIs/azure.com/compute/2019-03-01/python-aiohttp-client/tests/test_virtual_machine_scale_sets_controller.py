...
async def test_virtual_machine_scale_sets_update(client):
    ...
    """
    parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"sku":{"tier":"tier","name":"name","capacity":1},"plan":{"product":"product","name":"name","promotionCode":"promotionCode","publisher":"publisher"},"properties":{"upgradePolicy":{"automaticOSUpgradePolicy":{"disableAutomaticRollback":True,"enableAutomaticOSUpgrade":True},"mode":"Automatic","rollingUpgradePolicy":{"maxUnhealthyInstancePercent":18,"pauseTimeBetweenBatches":"pauseTimeBetweenBatches","maxBatchInstancePercent":62,"maxUnhealthyUpgradedInstancePercent":59}},"overprovision":True,"scaleInPolicy":{"rules":["Default","Default"]},"singlePlacementGroup":True,"virtualMachineProfile":{"licenseType":"licenseType","extensionProfile":{"extensions":[{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisionAfterExtensions":["provisionAfterExtensions","provisionAfterExtensions"],"provisioningState":"provisioningState","type":"type","forceUpdateTag":"forceUpdateTag","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}},{"name":"name","properties":{"settings":"{}","autoUpgradeMinorVersion":True,"publisher":"publisher","provisionAfterExtensions":["provisionAfterExtensions","provisionAfterExtensions"],"provisioningState":"provisioningState","type":"type","forceUpdateTag":"forceUpdateTag","protectedSettings":"{}","typeHandlerVersion":"typeHandlerVersion"}}]},"billingProfile":{"maxPrice":0.8008281904610115},"storageProfile":{"dataDisks":[{"lun":7,"managedDisk":{"storageAccountType":"Standard_LRS"},"writeAcceleratorEnabled":True,"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":2},{"lun":7,"managedDisk":{"storageAccountType":"Standard_LRS"},"writeAcceleratorEnabled":True,"name":"name","caching":"None","createOption":"FromImage","diskSizeGB":2}],"imageReference":{"offer":"offer","publisher":"publisher","sku":"sku","version":"version"},"osDisk":{"image":{"uri":"uri"},"vhdContainers":["vhdContainers","vhdContainers"],"managedDisk":{"storageAccountType":"Standard_LRS"},"writeAcceleratorEnabled":True,"caching":"None","diskSizeGB":6}},"diagnosticsProfile":{"bootDiagnostics":{"storageUri":"storageUri","enabled":True}},"networkProfile":{"networkInterfaceConfigurations":[{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"applicationSecurityGroups":[{"id":"id"},{"id":"id"}],"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"applicationSecurityGroups":[{"id":"id"},{"id":"id"}],"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}}],"dnsSettings":{"dnsServers":["dnsServers","dnsServers"]},"enableAcceleratedNetworking":True,"enableIPForwarding":True,"networkSecurityGroup":{"id":"id"},"primary":True}},{"name":"name","properties":{"ipConfigurations":[{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"applicationSecurityGroups":[{"id":"id"},{"id":"id"}],"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}},{"name":"name","properties":{"applicationGatewayBackendAddressPools":[{"id":"id"},{"id":"id"}],"loadBalancerInboundNatPools":[{"id":"id"},{"id":"id"}],"subnet":{"id":"id"},"publicIPAddressConfiguration":{"name":"name","properties":{"dnsSettings":{"domainNameLabel":"domainNameLabel"},"idleTimeoutInMinutes":0}},"applicationSecurityGroups":[{"id":"id"},{"id":"id"}],"privateIPAddressVersion":"IPv4","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"primary":True}}],"dnsSettings":{"dnsServers":["dnsServers","dnsServers"]},"enableAcceleratedNetworking":True,"enableIPForwarding":True,"networkSecurityGroup":{"id":"id"},"primary":True}}]},"scheduledEventsProfile":{"terminateNotificationProfile":{"notBeforeTimeout":"notBeforeTimeout","enable":True}},"osProfile":{"linuxConfiguration":{"disablePasswordAuthentication":True,"provisionVMAgent":True,"ssh":{"publicKeys":[{"path":"path","keyData":"keyData"},{"path":"path","keyData":"keyData"}]}},"customData":"customData","windowsConfiguration":{"additionalUnattendContent":[{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"},{"passName":"OobeSystem","componentName":"Microsoft-Windows-Shell-Setup","content":"content","settingName":"AutoLogon"}],"provisionVMAgent":True,"timeZone":"timeZone","winRM":{"listeners":[{"protocol":"Http","certificateUrl":"certificateUrl"},{"protocol":"Http","certificateUrl":"certificateUrl"}]},"enableAutomaticUpdates":True},"secrets":[{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}},{"vaultCertificates":[{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"},{"certificateUrl":"certificateUrl","certificateStore":"certificateStore"}],"sourceVault":{"id":"id"}}]}},"additionalCapabilities":{"ultraSSDEnabled":True}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
