...
public:
    ...
    bool isAllowExtensionOperations() const;
    void setAllowExtensionOperations(const bool &allow_extension_operations);
    bool is_allow_extension_operations_Set() const;
    bool is_allow_extension_operations_Valid() const;
...
private:
    ...
    bool m_allow_extension_operations;
    bool m_allow_extension_operations_isSet;
    bool m_allow_extension_operations_isValid;
