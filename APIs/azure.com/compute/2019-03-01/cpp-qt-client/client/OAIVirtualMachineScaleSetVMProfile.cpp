...
OAIBillingProfile OAIVirtualMachineScaleSetVMProfile::getBillingProfile() const {
    return m_billing_profile;
}
void OAIVirtualMachineScaleSetVMProfile::setBillingProfile(const OAIBillingProfile &billing_profile) {
    m_billing_profile = billing_profile;
    m_billing_profile_isSet = true;
}

bool OAIVirtualMachineScaleSetVMProfile::is_billing_profile_Set() const{
    return m_billing_profile_isSet;
}

bool OAIVirtualMachineScaleSetVMProfile::is_billing_profile_Valid() const{
...
OAIScheduledEventsProfile OAIVirtualMachineScaleSetVMProfile::getScheduledEventsProfile() const {
    return m_scheduled_events_profile;
}
void OAIVirtualMachineScaleSetVMProfile::setScheduledEventsProfile(const OAIScheduledEventsProfile &scheduled_events_profile) {
    m_scheduled_events_profile = scheduled_events_profile;
    m_scheduled_events_profile_isSet = true;
}

bool OAIVirtualMachineScaleSetVMProfile::is_scheduled_events_profile_Set() const{
    return m_scheduled_events_profile_isSet;
}

bool OAIVirtualMachineScaleSetVMProfile::is_scheduled_events_profile_Valid() const{
