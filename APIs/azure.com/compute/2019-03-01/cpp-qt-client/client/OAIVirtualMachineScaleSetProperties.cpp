...
OAIAdditionalCapabilities OAIVirtualMachineScaleSetProperties::getAdditionalCapabilities() const {
    return m_additional_capabilities;
}
void OAIVirtualMachineScaleSetProperties::setAdditionalCapabilities(const OAIAdditionalCapabilities &additional_capabilities) {
    m_additional_capabilities = additional_capabilities;
    m_additional_capabilities_isSet = true;
}

bool OAIVirtualMachineScaleSetProperties::is_additional_capabilities_Set() const{
    return m_additional_capabilities_isSet;
}

bool OAIVirtualMachineScaleSetProperties::is_additional_capabilities_Valid() const{
...
OAIScaleInPolicy OAIVirtualMachineScaleSetProperties::getScaleInPolicy() const {
    return m_scale_in_policy;
}
void OAIVirtualMachineScaleSetProperties::setScaleInPolicy(const OAIScaleInPolicy &scale_in_policy) {
    m_scale_in_policy = scale_in_policy;
    m_scale_in_policy_isSet = true;
}

bool OAIVirtualMachineScaleSetProperties::is_scale_in_policy_Set() const{
    return m_scale_in_policy_isSet;
}

bool OAIVirtualMachineScaleSetProperties::is_scale_in_policy_Valid() const{
