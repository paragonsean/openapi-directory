...
void OAIVirtualMachineImageProperties::initializeModel() {
    ...
    m_automatic_os_upgrade_properties_isSet = false;
    m_automatic_os_upgrade_properties_isValid = false;
...
void OAIVirtualMachineImageProperties::fromJsonObject(QJsonObject json) {
    ...
    m_automatic_os_upgrade_properties_isValid = ::OpenAPI::fromJsonValue(m_automatic_os_upgrade_properties, json[QString("automaticOSUpgradeProperties")]);
    m_automatic_os_upgrade_properties_isSet = !json[QString("automaticOSUpgradeProperties")].isNull() && m_automatic_os_upgrade_properties_isValid;
...
QJsonObject OAIVirtualMachineImageProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_automatic_os_upgrade_properties.isSet()) {
        obj.insert(QString("automaticOSUpgradeProperties"), ::OpenAPI::toJsonValue(m_automatic_os_upgrade_properties));
    }
...
OAIAutomaticOSUpgradeProperties OAIVirtualMachineImageProperties::getAutomaticOsUpgradeProperties() const {
    return m_automatic_os_upgrade_properties;
}
void OAIVirtualMachineImageProperties::setAutomaticOsUpgradeProperties(const OAIAutomaticOSUpgradeProperties &automatic_os_upgrade_properties) {
    m_automatic_os_upgrade_properties = automatic_os_upgrade_properties;
    m_automatic_os_upgrade_properties_isSet = true;
}

bool OAIVirtualMachineImageProperties::is_automatic_os_upgrade_properties_Set() const{
    return m_automatic_os_upgrade_properties_isSet;
}

bool OAIVirtualMachineImageProperties::is_automatic_os_upgrade_properties_Valid() const{
    return m_automatic_os_upgrade_properties_isValid;
}
...
OAIHyperVGenerationType OAIVirtualMachineImageProperties::getHyperVGeneration() const {
    return m_hyper_v_generation;
}
void OAIVirtualMachineImageProperties::setHyperVGeneration(const OAIHyperVGenerationType &hyper_v_generation) {
    m_hyper_v_generation = hyper_v_generation;
    m_hyper_v_generation_isSet = true;
}

bool OAIVirtualMachineImageProperties::is_hyper_v_generation_Set() const{
    return m_hyper_v_generation_isSet;
}

bool OAIVirtualMachineImageProperties::is_hyper_v_generation_Valid() const{
