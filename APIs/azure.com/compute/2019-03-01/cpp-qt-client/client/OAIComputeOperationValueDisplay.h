...
/*
 * OAIComputeOperationValueDisplay.h
 *
 * Describes the properties of a Compute Operation Value Display.
 */

#ifndef OAIComputeOperationValueDisplay_H
#define OAIComputeOperationValueDisplay_H
...
class OAIComputeOperationValueDisplay : public OAIObject {
public:
    OAIComputeOperationValueDisplay();
    OAIComputeOperationValueDisplay(QString json);
    ~OAIComputeOperationValueDisplay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputeOperationValueDisplay)

#endif // OAIComputeOperationValueDisplay_H
