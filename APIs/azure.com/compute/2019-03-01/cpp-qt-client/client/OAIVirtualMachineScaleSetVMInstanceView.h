...
class OAIVirtualMachineHealthStatus;
...
public:
    ...
    OAIVirtualMachineHealthStatus getVmHealth() const;
    void setVmHealth(const OAIVirtualMachineHealthStatus &vm_health);
    bool is_vm_health_Set() const;
    bool is_vm_health_Valid() const;
...
private:
    ...
    OAIVirtualMachineHealthStatus m_vm_health;
    bool m_vm_health_isSet;
    bool m_vm_health_isValid;
};
