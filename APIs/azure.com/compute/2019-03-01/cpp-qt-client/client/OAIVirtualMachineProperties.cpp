...
void OAIVirtualMachineProperties::initializeModel() {
    ...
    m_billing_profile_isSet = false;
    m_billing_profile_isValid = false;
    ...
    m_virtual_machine_scale_set_isSet = false;
    m_virtual_machine_scale_set_isValid = false;
...
void OAIVirtualMachineProperties::fromJsonObject(QJsonObject json) {
    ...
    m_billing_profile_isValid = ::OpenAPI::fromJsonValue(m_billing_profile, json[QString("billingProfile")]);
    m_billing_profile_isSet = !json[QString("billingProfile")].isNull() && m_billing_profile_isValid;
    ...
    m_virtual_machine_scale_set_isValid = ::OpenAPI::fromJsonValue(m_virtual_machine_scale_set, json[QString("virtualMachineScaleSet")]);
    m_virtual_machine_scale_set_isSet = !json[QString("virtualMachineScaleSet")].isNull() && m_virtual_machine_scale_set_isValid;
...
QJsonObject OAIVirtualMachineProperties::asJsonObject() const {
    ...
    if (m_billing_profile.isSet()) {
        obj.insert(QString("billingProfile"), ::OpenAPI::toJsonValue(m_billing_profile));
    }
    ...
    if (m_virtual_machine_scale_set.isSet()) {
        obj.insert(QString("virtualMachineScaleSet"), ::OpenAPI::toJsonValue(m_virtual_machine_scale_set));
    }
    if (m_vm_id_isSet) {
...
OAIAdditionalCapabilities OAIVirtualMachineProperties::getAdditionalCapabilities() const {
    return m_additional_capabilities;
}
void OAIVirtualMachineProperties::setAdditionalCapabilities(const OAIAdditionalCapabilities &additional_capabilities) {
    m_additional_capabilities = additional_capabilities;
    m_additional_capabilities_isSet = true;
}

bool OAIVirtualMachineProperties::is_additional_capabilities_Set() const{
    return m_additional_capabilities_isSet;
}

bool OAIVirtualMachineProperties::is_additional_capabilities_Valid() const{
...
OAIBillingProfile OAIVirtualMachineProperties::getBillingProfile() const {
    return m_billing_profile;
}
void OAIVirtualMachineProperties::setBillingProfile(const OAIBillingProfile &billing_profile) {
    m_billing_profile = billing_profile;
    m_billing_profile_isSet = true;
}

bool OAIVirtualMachineProperties::is_billing_profile_Set() const{
    return m_billing_profile_isSet;
}

bool OAIVirtualMachineProperties::is_billing_profile_Valid() const{
    return m_billing_profile_isValid;
}
...
QString OAIVirtualMachineProperties::getEvictionPolicy() const {
    return m_eviction_policy;
}
void OAIVirtualMachineProperties::setEvictionPolicy(const QString &eviction_policy) {
    m_eviction_policy = eviction_policy;
    m_eviction_policy_isSet = true;
}

bool OAIVirtualMachineProperties::is_eviction_policy_Set() const{
    return m_eviction_policy_isSet;
}

bool OAIVirtualMachineProperties::is_eviction_policy_Valid() const{
...
OAISubResource OAIVirtualMachineProperties::getHost() const {
    return m_host;
}
void OAIVirtualMachineProperties::setHost(const OAISubResource &host) {
    m_host = host;
    m_host_isSet = true;
}

bool OAIVirtualMachineProperties::is_host_Set() const{
    return m_host_isSet;
}

bool OAIVirtualMachineProperties::is_host_Valid() const{
...
QString OAIVirtualMachineProperties::getPriority() const {
    return m_priority;
}
void OAIVirtualMachineProperties::setPriority(const QString &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIVirtualMachineProperties::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIVirtualMachineProperties::is_priority_Valid() const{
...
OAISubResource OAIVirtualMachineProperties::getVirtualMachineScaleSet() const {
    return m_virtual_machine_scale_set;
}
void OAIVirtualMachineProperties::setVirtualMachineScaleSet(const OAISubResource &virtual_machine_scale_set) {
    m_virtual_machine_scale_set = virtual_machine_scale_set;
    m_virtual_machine_scale_set_isSet = true;
}

bool OAIVirtualMachineProperties::is_virtual_machine_scale_set_Set() const{
    return m_virtual_machine_scale_set_isSet;
}

bool OAIVirtualMachineProperties::is_virtual_machine_scale_set_Valid() const{
    return m_virtual_machine_scale_set_isValid;
}
