...
void OAIVirtualMachineScaleSetUpdateVMProfile::initializeModel() {
    ...
    m_scheduled_events_profile_isSet = false;
    m_scheduled_events_profile_isValid = false;
...
void OAIVirtualMachineScaleSetUpdateVMProfile::fromJsonObject(QJsonObject json) {
    ...
    m_scheduled_events_profile_isValid = ::OpenAPI::fromJsonValue(m_scheduled_events_profile, json[QString("scheduledEventsProfile")]);
    m_scheduled_events_profile_isSet = !json[QString("scheduledEventsProfile")].isNull() && m_scheduled_events_profile_isValid;
...
QJsonObject OAIVirtualMachineScaleSetUpdateVMProfile::asJsonObject() const {
    ...
    if (m_scheduled_events_profile.isSet()) {
        obj.insert(QString("scheduledEventsProfile"), ::OpenAPI::toJsonValue(m_scheduled_events_profile));
    }
...
OAIBillingProfile OAIVirtualMachineScaleSetUpdateVMProfile::getBillingProfile() const {
    return m_billing_profile;
}
void OAIVirtualMachineScaleSetUpdateVMProfile::setBillingProfile(const OAIBillingProfile &billing_profile) {
    m_billing_profile = billing_profile;
    m_billing_profile_isSet = true;
}

bool OAIVirtualMachineScaleSetUpdateVMProfile::is_billing_profile_Set() const{
    return m_billing_profile_isSet;
}

bool OAIVirtualMachineScaleSetUpdateVMProfile::is_billing_profile_Valid() const{
...
OAIScheduledEventsProfile OAIVirtualMachineScaleSetUpdateVMProfile::getScheduledEventsProfile() const {
    return m_scheduled_events_profile;
}
void OAIVirtualMachineScaleSetUpdateVMProfile::setScheduledEventsProfile(const OAIScheduledEventsProfile &scheduled_events_profile) {
    m_scheduled_events_profile = scheduled_events_profile;
    m_scheduled_events_profile_isSet = true;
}

bool OAIVirtualMachineScaleSetUpdateVMProfile::is_scheduled_events_profile_Set() const{
    return m_scheduled_events_profile_isSet;
}

bool OAIVirtualMachineScaleSetUpdateVMProfile::is_scheduled_events_profile_Valid() const{
    return m_scheduled_events_profile_isValid;
}
