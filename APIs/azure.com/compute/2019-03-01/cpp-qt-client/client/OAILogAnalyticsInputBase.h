...
/*
 * OAILogAnalyticsInputBase.h
 *
 * Api input base class for LogAnalytics Api.
 */

#ifndef OAILogAnalyticsInputBase_H
#define OAILogAnalyticsInputBase_H
...
class OAILogAnalyticsInputBase : public OAIObject {
public:
    OAILogAnalyticsInputBase();
    OAILogAnalyticsInputBase(QString json);
    ~OAILogAnalyticsInputBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogAnalyticsInputBase)

#endif // OAILogAnalyticsInputBase_H
