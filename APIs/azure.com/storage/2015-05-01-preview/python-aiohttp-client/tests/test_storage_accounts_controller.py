...
async def test_storage_accounts_check_name_availability(client):
    ...
    """
    account_name = {"name":"name","type":"type"}
...
async def test_storage_accounts_create(client):
    ...
    """
    parameters = {"properties":{"accountType":"Standard_LRS"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_storage_accounts_update(client):
    ...
    """
    parameters = {"properties":{"accountType":"Standard_LRS","customDomain":{"useSubDomainName":True,"name":"name"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
