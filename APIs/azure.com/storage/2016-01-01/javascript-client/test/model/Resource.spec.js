...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new StorageManagementClient.Resource();
      //expect(instance).to.be.a(StorageManagementClient.Resource);
    });
