...
export default class ManagementPoliciesApi {
    ...
    */
     ...
     * @param {module:model/ManagementPolicy} properties The ManagementPolicy set to a storage account.
     ...
     */
    managementPoliciesCreateOrUpdate(resourceGroupName, accountName, apiVersion, subscriptionId, managementPolicyName, properties, callback) {
      ...
      if (properties === undefined || properties === null) {
        throw new Error("Missing the required parameter 'properties' when calling managementPoliciesCreateOrUpdate");
      }
