...
class AccountSasParameters {
     ...
     */
    constructor(signedExpiry, signedPermission, signedResourceTypes, signedServices) { 
        
        AccountSasParameters.initialize(this, signedExpiry, signedPermission, signedResourceTypes, signedServices);
    }
     ...
     */
    static initialize(obj, signedExpiry, signedPermission, signedResourceTypes, signedServices) { 
...
AccountSasParameters.RequiredProperties = ["signedExpiry", "signedPermission", "signedResourceTypes", "signedServices"];
