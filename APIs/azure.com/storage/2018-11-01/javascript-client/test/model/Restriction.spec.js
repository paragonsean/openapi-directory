...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.Restriction();
  });
  ...
  describe('Restriction', function() {
    it('should create an instance of Restriction', function() {
      ...
      //var instance = new StorageManagementClient.Restriction();
      //expect(instance).to.be.a(StorageManagementClient.Restriction);
    });
