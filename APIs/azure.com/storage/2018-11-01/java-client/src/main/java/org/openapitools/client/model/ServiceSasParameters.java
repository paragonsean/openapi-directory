...
public class ServiceSasParameters {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("signedResource") != null && !jsonObj.get("signedResource").isJsonNull()) && !jsonObj.get("signedResource").isJsonPrimitive()) {
      ...
      // validate the optional field `signedResource`
      if (jsonObj.get("signedResource") != null && !jsonObj.get("signedResource").isJsonNull()) {
