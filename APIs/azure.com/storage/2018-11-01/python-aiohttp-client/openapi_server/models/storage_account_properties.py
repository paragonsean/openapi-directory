...
class StorageAccountProperties(Model):
    ...
    def __init__(self, access_tier: str=None, azure_files_aad_integration: bool=None, creation_time: datetime=None, custom_domain: CustomDomain=None, encryption: Encryption=None, failover_in_progress: bool=None, geo_replication_stats: GeoReplicationStats=None, is_hns_enabled: bool=None, last_geo_failover_time: datetime=None, network_acls: NetworkRuleSet=None, primary_endpoints: Endpoints=None, primary_location: str=None, provisioning_state: str=None, secondary_endpoints: Endpoints=None, secondary_location: str=None, status_of_primary: str=None, status_of_secondary: str=None, supports_https_traffic_only: bool=None):
        ...
        self.openapi_types = {
            'access_tier': str,
            'azure_files_aad_integration': bool,
        ...
        self.attribute_map = {
            ...
            'azure_files_aad_integration': 'azureFilesAadIntegration',
        ...
        self._azure_files_aad_integration = azure_files_aad_integration
    ...
    @property
    def azure_files_aad_integration(self):
        """Gets the azure_files_aad_integration of this StorageAccountProperties.

        Enables Azure Files AAD Integration for SMB if sets to true.

        :return: The azure_files_aad_integration of this StorageAccountProperties.
        :rtype: bool
        """
        return self._azure_files_aad_integration

    @azure_files_aad_integration.setter
    def azure_files_aad_integration(self, azure_files_aad_integration):
        """Sets the azure_files_aad_integration of this StorageAccountProperties.

        Enables Azure Files AAD Integration for SMB if sets to true.

        :param azure_files_aad_integration: The azure_files_aad_integration of this StorageAccountProperties.
        :type azure_files_aad_integration: bool
        """
