...
async def test_storage_accounts_update(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"kind":"Storage","sku":{"capabilities":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"tier":"Standard","kind":"Storage","name":"Standard_LRS","restrictions":[{"values":["values","values"],"reasonCode":"QuotaId","type":"type"},{"values":["values","values"],"reasonCode":"QuotaId","type":"type"}],"locations":["locations","locations"],"resourceType":"resourceType"},"properties":{"encryption":{"keySource":"Microsoft.Storage","keyvaultproperties":{"keyvaulturi":"keyvaulturi","keyname":"keyname","keyversion":"keyversion"},"services":{"blob":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"file":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"queue":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"table":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True}}},"accessTier":"Hot","supportsHttpsTrafficOnly":True,"azureFilesAadIntegration":True,"networkAcls":{"bypass":"AzureServices","defaultAction":"Allow","ipRules":[{"action":"Allow","value":"value"},{"action":"Allow","value":"value"}],"virtualNetworkRules":[{"action":"Allow","id":"id","state":"provisioning"},{"action":"Allow","id":"id","state":"provisioning"}]},"customDomain":{"useSubDomainName":True,"name":"name"}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
