...
async def test_management_policies_create_or_update(client):
    ...
    """
    properties = {"properties":{"lastModifiedTime":"2000-01-23T04:56:07.000+00:00","policy":{"rules":[{"name":"name","definition":{"filters":{"blobTypes":["blobTypes","blobTypes"],"prefixMatch":["prefixMatch","prefixMatch"]},"actions":{"baseBlob":{"tierToArchive":{"daysAfterModificationGreaterThan":0},"delete":{"daysAfterModificationGreaterThan":0},"tierToCool":{"daysAfterModificationGreaterThan":0}},"snapshot":{"delete":{"daysAfterCreationGreaterThan":0}}}},"type":"Lifecycle","enabled":True},{"name":"name","definition":{"filters":{"blobTypes":["blobTypes","blobTypes"],"prefixMatch":["prefixMatch","prefixMatch"]},"actions":{"baseBlob":{"tierToArchive":{"daysAfterModificationGreaterThan":0},"delete":{"daysAfterModificationGreaterThan":0},"tierToCool":{"daysAfterModificationGreaterThan":0}},"snapshot":{"delete":{"daysAfterCreationGreaterThan":0}}}},"type":"Lifecycle","enabled":True}]}}}
