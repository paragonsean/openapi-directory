...
void OAIStorageAccountPropertiesCreateParameters::initializeModel() {
    ...
    m_azure_files_aad_integration_isSet = false;
    m_azure_files_aad_integration_isValid = false;
...
void OAIStorageAccountPropertiesCreateParameters::fromJsonObject(QJsonObject json) {
    ...
    m_azure_files_aad_integration_isValid = ::OpenAPI::fromJsonValue(m_azure_files_aad_integration, json[QString("azureFilesAadIntegration")]);
    m_azure_files_aad_integration_isSet = !json[QString("azureFilesAadIntegration")].isNull() && m_azure_files_aad_integration_isValid;
...
QJsonObject OAIStorageAccountPropertiesCreateParameters::asJsonObject() const {
    ...
    if (m_azure_files_aad_integration_isSet) {
        obj.insert(QString("azureFilesAadIntegration"), ::OpenAPI::toJsonValue(m_azure_files_aad_integration));
    }
...
bool OAIStorageAccountPropertiesCreateParameters::isAzureFilesAadIntegration() const {
    return m_azure_files_aad_integration;
}
void OAIStorageAccountPropertiesCreateParameters::setAzureFilesAadIntegration(const bool &azure_files_aad_integration) {
    m_azure_files_aad_integration = azure_files_aad_integration;
    m_azure_files_aad_integration_isSet = true;
}

bool OAIStorageAccountPropertiesCreateParameters::is_azure_files_aad_integration_Set() const{
    return m_azure_files_aad_integration_isSet;
}

bool OAIStorageAccountPropertiesCreateParameters::is_azure_files_aad_integration_Valid() const{
    return m_azure_files_aad_integration_isValid;
}
...
bool OAIStorageAccountPropertiesCreateParameters::isIsHnsEnabled() const {
    return m_is_hns_enabled;
}
void OAIStorageAccountPropertiesCreateParameters::setIsHnsEnabled(const bool &is_hns_enabled) {
    m_is_hns_enabled = is_hns_enabled;
    m_is_hns_enabled_isSet = true;
}

bool OAIStorageAccountPropertiesCreateParameters::is_is_hns_enabled_Set() const{
    return m_is_hns_enabled_isSet;
}

bool OAIStorageAccountPropertiesCreateParameters::is_is_hns_enabled_Valid() const{
    return m_is_hns_enabled_isValid;
}

OAINetworkRuleSet OAIStorageAccountPropertiesCreateParameters::getNetworkAcls() const {
    return m_network_acls;
}
void OAIStorageAccountPropertiesCreateParameters::setNetworkAcls(const OAINetworkRuleSet &network_acls) {
    m_network_acls = network_acls;
    m_network_acls_isSet = true;
}

bool OAIStorageAccountPropertiesCreateParameters::is_network_acls_Set() const{
    return m_network_acls_isSet;
}

bool OAIStorageAccountPropertiesCreateParameters::is_network_acls_Valid() const{
