...
bool OAIStorageAccountProperties::isAzureFilesAadIntegration() const {
    return m_azure_files_aad_integration;
}
void OAIStorageAccountProperties::setAzureFilesAadIntegration(const bool &azure_files_aad_integration) {
    m_azure_files_aad_integration = azure_files_aad_integration;
    m_azure_files_aad_integration_isSet = true;
}

bool OAIStorageAccountProperties::is_azure_files_aad_integration_Set() const{
    return m_azure_files_aad_integration_isSet;
}

bool OAIStorageAccountProperties::is_azure_files_aad_integration_Valid() const{
