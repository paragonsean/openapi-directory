...
public:
    ...
    */
    virtual void usagesList(const QString &api_version, const QString &subscription_id);
...
Q_SIGNALS:
    ...
    void usagesListSignal(OAIUsageListResult summary);


    void usagesListSignalFull(OAIHttpRequestWorker *worker, OAIUsageListResult summary);

    Q_DECL_DEPRECATED_X("Use usagesListSignalError() instead")
    void usagesListSignalE(OAIUsageListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void usagesListSignalError(OAIUsageListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
