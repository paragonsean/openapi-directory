...
|------------- | ------------- | -------------|
| [**usagesList**](UsageApi.md#usagesList) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Storage/usages |  |


<a id="usagesList"></a>
# **usagesList**
> UsageListResult usagesList(apiVersion, subscriptionId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageListResult result = apiInstance.usagesList(apiVersion, subscriptionId);
