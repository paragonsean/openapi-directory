...
async def storage_accounts_create_or_update_management_policies(request: web.Request, resource_group_name, account_name, api_version, subscription_id, management_policy_name, properties) -> web.Response:
...
async def storage_accounts_delete_management_policies(request: web.Request, resource_group_name, account_name, api_version, subscription_id, management_policy_name) -> web.Response:
...
async def storage_accounts_get_management_policies(request: web.Request, resource_group_name, account_name, api_version, subscription_id, management_policy_name) -> web.Response:
