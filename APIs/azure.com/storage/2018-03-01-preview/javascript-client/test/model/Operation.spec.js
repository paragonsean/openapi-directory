...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new StorageManagementClient.Operation();
      //expect(instance).to.be.a(StorageManagementClient.Operation);
    });
