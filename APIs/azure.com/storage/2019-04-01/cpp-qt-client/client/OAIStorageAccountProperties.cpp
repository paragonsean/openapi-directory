...
void OAIStorageAccountProperties::initializeModel() {
    ...
    m_azure_files_identity_based_authentication_isSet = false;
    m_azure_files_identity_based_authentication_isValid = false;
    ...
    m_failover_in_progress_isSet = false;
    m_failover_in_progress_isValid = false;

    m_geo_replication_stats_isSet = false;
    m_geo_replication_stats_isValid = false;

    m_is_hns_enabled_isSet = false;
    m_is_hns_enabled_isValid = false;

    m_large_file_shares_state_isSet = false;
    m_large_file_shares_state_isValid = false;
...
void OAIStorageAccountProperties::fromJsonObject(QJsonObject json) {
    ...
    m_azure_files_identity_based_authentication_isValid = ::OpenAPI::fromJsonValue(m_azure_files_identity_based_authentication, json[QString("azureFilesIdentityBasedAuthentication")]);
    m_azure_files_identity_based_authentication_isSet = !json[QString("azureFilesIdentityBasedAuthentication")].isNull() && m_azure_files_identity_based_authentication_isValid;
    ...
    m_failover_in_progress_isValid = ::OpenAPI::fromJsonValue(m_failover_in_progress, json[QString("failoverInProgress")]);
    m_failover_in_progress_isSet = !json[QString("failoverInProgress")].isNull() && m_failover_in_progress_isValid;

    m_geo_replication_stats_isValid = ::OpenAPI::fromJsonValue(m_geo_replication_stats, json[QString("geoReplicationStats")]);
    m_geo_replication_stats_isSet = !json[QString("geoReplicationStats")].isNull() && m_geo_replication_stats_isValid;
    ...
    m_large_file_shares_state_isValid = ::OpenAPI::fromJsonValue(m_large_file_shares_state, json[QString("largeFileSharesState")]);
    m_large_file_shares_state_isSet = !json[QString("largeFileSharesState")].isNull() && m_large_file_shares_state_isValid;
...
QJsonObject OAIStorageAccountProperties::asJsonObject() const {
    ...
    if (m_azure_files_identity_based_authentication.isSet()) {
        obj.insert(QString("azureFilesIdentityBasedAuthentication"), ::OpenAPI::toJsonValue(m_azure_files_identity_based_authentication));
    }
    ...
    if (m_failover_in_progress_isSet) {
        obj.insert(QString("failoverInProgress"), ::OpenAPI::toJsonValue(m_failover_in_progress));
    }
    if (m_geo_replication_stats.isSet()) {
        obj.insert(QString("geoReplicationStats"), ::OpenAPI::toJsonValue(m_geo_replication_stats));
    }
    if (m_is_hns_enabled_isSet) {
        obj.insert(QString("isHnsEnabled"), ::OpenAPI::toJsonValue(m_is_hns_enabled));
    }
    if (m_large_file_shares_state_isSet) {
        obj.insert(QString("largeFileSharesState"), ::OpenAPI::toJsonValue(m_large_file_shares_state));
    }
...
OAIAzureFilesIdentityBasedAuthentication OAIStorageAccountProperties::getAzureFilesIdentityBasedAuthentication() const {
    return m_azure_files_identity_based_authentication;
}
void OAIStorageAccountProperties::setAzureFilesIdentityBasedAuthentication(const OAIAzureFilesIdentityBasedAuthentication &azure_files_identity_based_authentication) {
    m_azure_files_identity_based_authentication = azure_files_identity_based_authentication;
    m_azure_files_identity_based_authentication_isSet = true;
}

bool OAIStorageAccountProperties::is_azure_files_identity_based_authentication_Set() const{
    return m_azure_files_identity_based_authentication_isSet;
}

bool OAIStorageAccountProperties::is_azure_files_identity_based_authentication_Valid() const{
    return m_azure_files_identity_based_authentication_isValid;
}
...
bool OAIStorageAccountProperties::isFailoverInProgress() const {
    return m_failover_in_progress;
}
void OAIStorageAccountProperties::setFailoverInProgress(const bool &failover_in_progress) {
    m_failover_in_progress = failover_in_progress;
    m_failover_in_progress_isSet = true;
}

bool OAIStorageAccountProperties::is_failover_in_progress_Set() const{
    return m_failover_in_progress_isSet;
}

bool OAIStorageAccountProperties::is_failover_in_progress_Valid() const{
    return m_failover_in_progress_isValid;
}

OAIGeoReplicationStats OAIStorageAccountProperties::getGeoReplicationStats() const {
    return m_geo_replication_stats;
}
void OAIStorageAccountProperties::setGeoReplicationStats(const OAIGeoReplicationStats &geo_replication_stats) {
    m_geo_replication_stats = geo_replication_stats;
    m_geo_replication_stats_isSet = true;
}

bool OAIStorageAccountProperties::is_geo_replication_stats_Set() const{
    return m_geo_replication_stats_isSet;
}

bool OAIStorageAccountProperties::is_geo_replication_stats_Valid() const{
    return m_geo_replication_stats_isValid;
}
...
QString OAIStorageAccountProperties::getLargeFileSharesState() const {
    return m_large_file_shares_state;
}
void OAIStorageAccountProperties::setLargeFileSharesState(const QString &large_file_shares_state) {
    m_large_file_shares_state = large_file_shares_state;
    m_large_file_shares_state_isSet = true;
}

bool OAIStorageAccountProperties::is_large_file_shares_state_Set() const{
    return m_large_file_shares_state_isSet;
}

bool OAIStorageAccountProperties::is_large_file_shares_state_Valid() const{
    return m_large_file_shares_state_isValid;
}
