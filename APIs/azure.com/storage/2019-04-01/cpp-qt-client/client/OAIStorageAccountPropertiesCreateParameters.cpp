...
OAIAzureFilesIdentityBasedAuthentication OAIStorageAccountPropertiesCreateParameters::getAzureFilesIdentityBasedAuthentication() const {
    return m_azure_files_identity_based_authentication;
}
void OAIStorageAccountPropertiesCreateParameters::setAzureFilesIdentityBasedAuthentication(const OAIAzureFilesIdentityBasedAuthentication &azure_files_identity_based_authentication) {
...
bool OAIStorageAccountPropertiesCreateParameters::is_azure_files_identity_based_authentication_Set() const{
    return m_azure_files_identity_based_authentication_isSet;
}

bool OAIStorageAccountPropertiesCreateParameters::is_azure_files_identity_based_authentication_Valid() const{
...
QString OAIStorageAccountPropertiesCreateParameters::getLargeFileSharesState() const {
    return m_large_file_shares_state;
}
void OAIStorageAccountPropertiesCreateParameters::setLargeFileSharesState(const QString &large_file_shares_state) {
    m_large_file_shares_state = large_file_shares_state;
    m_large_file_shares_state_isSet = true;
}

bool OAIStorageAccountPropertiesCreateParameters::is_large_file_shares_state_Set() const{
    return m_large_file_shares_state_isSet;
}

bool OAIStorageAccountPropertiesCreateParameters::is_large_file_shares_state_Valid() const{
