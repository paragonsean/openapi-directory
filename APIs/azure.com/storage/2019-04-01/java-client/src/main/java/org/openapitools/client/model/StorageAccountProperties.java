...
public class StorageAccountProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessTier, azureFilesIdentityBasedAuthentication, creationTime, customDomain, encryption, failoverInProgress, geoReplicationStats, isHnsEnabled, largeFileSharesState, lastGeoFailoverTime, networkAcls, primaryEndpoints, primaryLocation, provisioningState, secondaryEndpoints, secondaryLocation, statusOfPrimary, statusOfSecondary, supportsHttpsTrafficOnly);
  }
