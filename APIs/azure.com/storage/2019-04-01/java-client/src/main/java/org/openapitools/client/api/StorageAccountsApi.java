...
public class StorageAccountsApi {
     ...
     * @param apiVersion The API version to use for this operation. (required)
     * @param subscriptionId The ID of the target subscription. (required)
     * @param $expand Specifies type of the key to be listed. Possible value is kerb. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call storageAccountsListKeysCall(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, String $expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call storageAccountsListKeysValidateBeforeCall(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, String $expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return storageAccountsListKeysCall(resourceGroupName, accountName, apiVersion, subscriptionId, $expand, _callback);
     ...
     */
    public StorageAccountListKeysResult storageAccountsListKeys(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, String $expand) throws ApiException {
        ApiResponse<StorageAccountListKeysResult> localVarResp = storageAccountsListKeysWithHttpInfo(resourceGroupName, accountName, apiVersion, subscriptionId, $expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StorageAccountListKeysResult> storageAccountsListKeysWithHttpInfo(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, String $expand) throws ApiException {
        okhttp3.Call localVarCall = storageAccountsListKeysValidateBeforeCall(resourceGroupName, accountName, apiVersion, subscriptionId, $expand, null);
     ...
     */
    public okhttp3.Call storageAccountsListKeysAsync(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, String $expand, final ApiCallback<StorageAccountListKeysResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = storageAccountsListKeysValidateBeforeCall(resourceGroupName, accountName, apiVersion, subscriptionId, $expand, _callback);
        Type localVarReturnType = new TypeToken<StorageAccountListKeysResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param apiVersion The API version to use for this operation. (required)
     * @param subscriptionId The ID of the target subscription. (required)
     * @param regenerateKey Specifies name of the key which should be regenerated -- key1, key2, kerb1, kerb2. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
