...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new StorageManagementClient.OperationDisplay();
      //expect(instance).to.be.a(StorageManagementClient.OperationDisplay);
    });
