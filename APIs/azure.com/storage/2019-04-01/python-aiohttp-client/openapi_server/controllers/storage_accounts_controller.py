...
async def storage_accounts_get_properties(request: web.Request, resource_group_name, account_name, api_version, subscription_id, expand=None) -> web.Response:
    ...
    :param subscription_id: The ID of the target subscription.
    :type subscription_id: str
    :param expand: May be used to expand the properties within account&#39;s properties. By default, data is not included when fetching properties. Currently we only support geoReplicationStats.
    :type expand: str
