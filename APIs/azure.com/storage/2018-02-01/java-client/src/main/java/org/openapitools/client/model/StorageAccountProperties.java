...
public class StorageAccountProperties {
  ...
  private Boolean isHnsEnabled = false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessTier, creationTime, customDomain, encryption, isHnsEnabled, lastGeoFailoverTime, networkAcls, primaryEndpoints, primaryLocation, provisioningState, secondaryEndpoints, secondaryLocation, statusOfPrimary, statusOfSecondary, supportsHttpsTrafficOnly);
  }
