...
public:
    ...
    bool isAzureFilesAadIntegration() const;
    void setAzureFilesAadIntegration(const bool &azure_files_aad_integration);
    bool is_azure_files_aad_integration_Set() const;
    bool is_azure_files_aad_integration_Valid() const;
...
private:
    ...
    bool m_azure_files_aad_integration;
    bool m_azure_files_aad_integration_isSet;
    bool m_azure_files_aad_integration_isValid;
