...
class StorageAccountPropertiesUpdateParameters(Model):
    ...
    def __init__(self, access_tier: str=None, azure_files_aad_integration: bool=None, custom_domain: CustomDomain=None, encryption: Encryption=None, network_acls: NetworkRuleSet=None, supports_https_traffic_only: bool=None):
        ...
        :param azure_files_aad_integration: The azure_files_aad_integration of this StorageAccountPropertiesUpdateParameters.
    ...
    def azure_files_aad_integration(self):
        """Gets the azure_files_aad_integration of this StorageAccountPropertiesUpdateParameters.

        Enables Azure Files AAD Integration for SMB if sets to true.

        :return: The azure_files_aad_integration of this StorageAccountPropertiesUpdateParameters.
        :rtype: bool
        """
    ...
    def azure_files_aad_integration(self, azure_files_aad_integration):
        """Sets the azure_files_aad_integration of this StorageAccountPropertiesUpdateParameters.
