...
|**signedResource** | [**SignedResourceEnum**](#SignedResourceEnum) | The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s). |  |
