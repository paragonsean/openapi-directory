...
async def test_storage_accounts_create(client):
    ...
    """
    parameters = {"kind":"Storage","location":"location","sku":{"tier":"Standard","name":"Standard_LRS"},"properties":{"encryption":{"keySource":"Microsoft.Storage","services":{"blob":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"file":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"queue":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"table":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True}}},"accessTier":"Hot","supportsHttpsTrafficOnly":False,"customDomain":{"useSubDomainName":True,"name":"name"}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_storage_accounts_update(client):
    ...
    """
    parameters = {"sku":{"tier":"Standard","name":"Standard_LRS"},"properties":{"encryption":{"keySource":"Microsoft.Storage","services":{"blob":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"file":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"queue":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True},"table":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","enabled":True}}},"accessTier":"Hot","supportsHttpsTrafficOnly":False,"customDomain":{"useSubDomainName":True,"name":"name"}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
