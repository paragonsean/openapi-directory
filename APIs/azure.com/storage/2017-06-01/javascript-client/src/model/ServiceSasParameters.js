...
class ServiceSasParameters {
     ...
     * @param signedResource {module:model/ServiceSasParameters.SignedResourceEnum} The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s).
     */
    constructor(canonicalizedResource, signedResource) { 
        
        ServiceSasParameters.initialize(this, canonicalizedResource, signedResource);
    }
     ...
     */
    static initialize(obj, canonicalizedResource, signedResource) { 
        obj['canonicalizedResource'] = canonicalizedResource;
        obj['signedResource'] = signedResource;
    }
...
ServiceSasParameters.RequiredProperties = ["canonicalizedResource", "signedResource"];
