...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagement.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new StorageManagement.OperationDisplay();
      //expect(instance).to.be.a(StorageManagement.OperationDisplay);
    });
