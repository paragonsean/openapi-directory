...
class StorageAccountProperties(Model):
    ...
    def __init__(self, access_tier: str=None, creation_time: datetime=None, custom_domain: CustomDomain=None, encryption: Encryption=None, last_geo_failover_time: datetime=None, network_acls: NetworkRuleSet=None, primary_endpoints: Endpoints=None, primary_location: str=None, provisioning_state: str=None, secondary_endpoints: Endpoints=None, secondary_location: str=None, status_of_primary: str=None, status_of_secondary: str=None, supports_https_traffic_only: bool=False):
