...
public class StorageAccountProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessTier, creationTime, customDomain, encryption, lastGeoFailoverTime, primaryEndpoints, primaryLocation, provisioningState, secondaryEndpoints, secondaryLocation, statusOfPrimary, statusOfSecondary);
  }
