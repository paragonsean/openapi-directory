...
class StorageAccountCreateParameters {
     ...
     */
    constructor(kind, location, sku) { 
        
        StorageAccountCreateParameters.initialize(this, kind, location, sku);
    }
     ...
     */
    static initialize(obj, kind, location, sku) { 
        obj['kind'] = kind;
...
StorageAccountCreateParameters.RequiredProperties = ["kind", "location", "sku"];
