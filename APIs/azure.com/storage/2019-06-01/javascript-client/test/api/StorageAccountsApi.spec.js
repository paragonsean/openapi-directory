...
(function(root, factory) {
  ...
  describe('StorageAccountsApi', function() {
    ...
    describe('storageAccountsRestoreBlobRanges', function() {
      it('should call storageAccountsRestoreBlobRanges successfully', function(done) {
        //uncomment below and update the code to test storageAccountsRestoreBlobRanges
        //instance.storageAccountsRestoreBlobRanges(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
