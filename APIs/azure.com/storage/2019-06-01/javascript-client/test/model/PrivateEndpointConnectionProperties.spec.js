...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.PrivateEndpointConnectionProperties();
  });
  ...
  describe('PrivateEndpointConnectionProperties', function() {
    it('should create an instance of PrivateEndpointConnectionProperties', function() {
      ...
      //var instance = new StorageManagementClient.PrivateEndpointConnectionProperties();
      //expect(instance).to.be.a(StorageManagementClient.PrivateEndpointConnectionProperties);
    });
