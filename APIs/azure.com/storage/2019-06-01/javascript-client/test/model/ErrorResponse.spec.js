...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new StorageManagementClient.ErrorResponse();
      //expect(instance).to.be.a(StorageManagementClient.ErrorResponse);
    });
