...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.SkuInformation();
  });
  ...
  describe('SkuInformation', function() {
    it('should create an instance of SkuInformation', function() {
      ...
      //var instance = new StorageManagementClient.SkuInformation();
      //expect(instance).to.be.a(StorageManagementClient.SkuInformation);
    });
