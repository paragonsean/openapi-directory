...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.Identity();
  });
  ...
  describe('Identity', function() {
    it('should create an instance of Identity', function() {
      ...
      //var instance = new StorageManagementClient.Identity();
      //expect(instance).to.be.a(StorageManagementClient.Identity);
    });
