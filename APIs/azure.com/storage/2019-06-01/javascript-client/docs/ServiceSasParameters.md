# StorageManagementClient.ServiceSasParameters
...
**signedResource** | **String** | The signed services accessible with the service SAS. Possible values include: Blob (b), Container (c), File (f), Share (s). | [optional] 
