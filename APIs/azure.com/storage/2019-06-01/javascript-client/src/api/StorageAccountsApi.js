...
export default class StorageAccountsApi {
    ...
    */
     ...
     * @param {String} apiVersion The API version to use for this operation.
     * @param {String} subscriptionId The ID of the target subscription.
     * @param {module:model/StorageAccountRegenerateKeyParameters} regenerateKey Specifies name of the key which should be regenerated -- key1, key2, kerb1, kerb2.
     ...
     * @param {String} apiVersion The API version to use for this operation.
     * @param {String} subscriptionId The ID of the target subscription.
     * @param {module:model/BlobRestoreParameters} parameters The parameters to provide for restore blob ranges.
     ...
     */
    storageAccountsRestoreBlobRanges(resourceGroupName, accountName, apiVersion, subscriptionId, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
      ...
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling storageAccountsRestoreBlobRanges");
      }
