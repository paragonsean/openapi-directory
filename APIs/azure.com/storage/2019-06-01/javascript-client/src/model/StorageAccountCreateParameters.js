...
import StorageAccountCreateParametersSku from './StorageAccountCreateParametersSku';
...
class StorageAccountCreateParameters {
     ...
     * @param sku {module:model/StorageAccountCreateParametersSku} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sku')) {
                obj['sku'] = StorageAccountCreateParametersSku.constructFromObject(data['sku']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['sku']) { // data not null
          StorageAccountCreateParametersSku.validateJSON(data['sku']);
        }
...
/**
 * @member {module:model/StorageAccountCreateParametersSku} sku
 */
