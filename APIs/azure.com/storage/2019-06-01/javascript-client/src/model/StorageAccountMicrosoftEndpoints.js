...
/**
 * The StorageAccountMicrosoftEndpoints model module.
 * @module model/StorageAccountMicrosoftEndpoints
 * @version 2019-06-01
 */
class StorageAccountMicrosoftEndpoints {
    /**
     * Constructs a new <code>StorageAccountMicrosoftEndpoints</code>.
     * The URIs that are used to perform a retrieval of a public blob, queue, table, web or dfs object via a microsoft routing endpoint.
     * @alias module:model/StorageAccountMicrosoftEndpoints
     */
    constructor() { 
        
        StorageAccountMicrosoftEndpoints.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StorageAccountMicrosoftEndpoints</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StorageAccountMicrosoftEndpoints} obj Optional instance to populate.
     * @return {module:model/StorageAccountMicrosoftEndpoints} The populated <code>StorageAccountMicrosoftEndpoints</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StorageAccountMicrosoftEndpoints();
    ...
    /**
     * Validates the JSON data with respect to <code>StorageAccountMicrosoftEndpoints</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StorageAccountMicrosoftEndpoints</code>.
     */
 ...
 * @member {String} blob
 */
StorageAccountMicrosoftEndpoints.prototype['blob'] = undefined;

/**
 * Gets the dfs endpoint.
 * @member {String} dfs
 */
StorageAccountMicrosoftEndpoints.prototype['dfs'] = undefined;

/**
 * Gets the file endpoint.
 * @member {String} file
 */
StorageAccountMicrosoftEndpoints.prototype['file'] = undefined;

/**
 * Gets the queue endpoint.
 * @member {String} queue
 */
StorageAccountMicrosoftEndpoints.prototype['queue'] = undefined;

/**
 * Gets the table endpoint.
 * @member {String} table
 */
StorageAccountMicrosoftEndpoints.prototype['table'] = undefined;

/**
 * Gets the web endpoint.
 * @member {String} web
 */
StorageAccountMicrosoftEndpoints.prototype['web'] = undefined;
...
export default StorageAccountMicrosoftEndpoints;
