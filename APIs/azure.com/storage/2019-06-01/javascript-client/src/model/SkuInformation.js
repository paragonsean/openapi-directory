...
class SkuInformation {
     ...
     * @param name {module:model/SkuInformation.NameEnum} The SKU name. Required for account creation; optional for update. Note that in older versions, SKU name was called accountType.
     */
    constructor(name) { 
 ...
 * @member {module:model/SkuInformation.NameEnum} name
 */
 ...
 * @member {module:model/SkuInformation.TierEnum} tier
 */
