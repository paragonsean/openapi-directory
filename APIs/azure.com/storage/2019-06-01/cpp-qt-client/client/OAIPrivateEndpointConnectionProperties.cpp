...
OAIPrivateEndpoint OAIPrivateEndpointConnectionProperties::getPrivateEndpoint() const {
    return m_private_endpoint;
}
void OAIPrivateEndpointConnectionProperties::setPrivateEndpoint(const OAIPrivateEndpoint &private_endpoint) {
...
OAIPrivateEndpointConnectionProvisioningState OAIPrivateEndpointConnectionProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIPrivateEndpointConnectionProperties::setProvisioningState(const OAIPrivateEndpointConnectionProvisioningState &provisioning_state) {
...
bool OAIPrivateEndpointConnectionProperties::isValid() const {
    ...
    return m_private_link_service_connection_state_isValid && true;
}
