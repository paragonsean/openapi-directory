...
public:
    ...
    OAIBlobRestoreStatus getBlobRestoreStatus() const;
    void setBlobRestoreStatus(const OAIBlobRestoreStatus &blob_restore_status);
    bool is_blob_restore_status_Set() const;
    bool is_blob_restore_status_Valid() const;
...
private:
    ...
    OAIBlobRestoreStatus m_blob_restore_status;
    bool m_blob_restore_status_isSet;
    bool m_blob_restore_status_isValid;
