...
public:
    ...
    OAIRoutingPreference getRoutingPreference() const;
    void setRoutingPreference(const OAIRoutingPreference &routing_preference);
    bool is_routing_preference_Set() const;
    bool is_routing_preference_Valid() const;
...
private:
    ...
    OAIRoutingPreference m_routing_preference;
    bool m_routing_preference_isSet;
    bool m_routing_preference_isValid;
