...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAIBlobRestoreParameters [required]
    */
    virtual void storageAccountsRestoreBlobRanges(const QString &resource_group_name, const QString &account_name, const QString &api_version, const QString &subscription_id, const OAIBlobRestoreParameters &parameters);
...
private:
    ...
    void storageAccountsRestoreBlobRangesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void storageAccountsRestoreBlobRangesSignal(OAIBlobRestoreStatus summary);
    ...
    void storageAccountsRestoreBlobRangesSignalFull(OAIHttpRequestWorker *worker, OAIBlobRestoreStatus summary);
    ...
    Q_DECL_DEPRECATED_X("Use storageAccountsRestoreBlobRangesSignalError() instead")
    void storageAccountsRestoreBlobRangesSignalE(OAIBlobRestoreStatus summary, QNetworkReply::NetworkError error_type, QString error_str);
    void storageAccountsRestoreBlobRangesSignalError(OAIBlobRestoreStatus summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use storageAccountsRestoreBlobRangesSignalErrorFull() instead")
    void storageAccountsRestoreBlobRangesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void storageAccountsRestoreBlobRangesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
