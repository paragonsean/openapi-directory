...
void OAIStorageAccountProperties::initializeModel() {
    ...
    m_blob_restore_status_isSet = false;
    m_blob_restore_status_isValid = false;
...
void OAIStorageAccountProperties::fromJsonObject(QJsonObject json) {
    ...
    m_blob_restore_status_isValid = ::OpenAPI::fromJsonValue(m_blob_restore_status, json[QString("blobRestoreStatus")]);
    m_blob_restore_status_isSet = !json[QString("blobRestoreStatus")].isNull() && m_blob_restore_status_isValid;
...
QJsonObject OAIStorageAccountProperties::asJsonObject() const {
    ...
    if (m_blob_restore_status.isSet()) {
        obj.insert(QString("blobRestoreStatus"), ::OpenAPI::toJsonValue(m_blob_restore_status));
    }
...
OAIBlobRestoreStatus OAIStorageAccountProperties::getBlobRestoreStatus() const {
    return m_blob_restore_status;
}
void OAIStorageAccountProperties::setBlobRestoreStatus(const OAIBlobRestoreStatus &blob_restore_status) {
    m_blob_restore_status = blob_restore_status;
    m_blob_restore_status_isSet = true;
}

bool OAIStorageAccountProperties::is_blob_restore_status_Set() const{
    return m_blob_restore_status_isSet;
}

bool OAIStorageAccountProperties::is_blob_restore_status_Valid() const{
    return m_blob_restore_status_isValid;
}
...
QList<OAIPrivateEndpointConnection> OAIStorageAccountProperties::getPrivateEndpointConnections() const {
    return m_private_endpoint_connections;
}
void OAIStorageAccountProperties::setPrivateEndpointConnections(const QList<OAIPrivateEndpointConnection> &private_endpoint_connections) {
    m_private_endpoint_connections = private_endpoint_connections;
    m_private_endpoint_connections_isSet = true;
}

bool OAIStorageAccountProperties::is_private_endpoint_connections_Set() const{
    return m_private_endpoint_connections_isSet;
}

bool OAIStorageAccountProperties::is_private_endpoint_connections_Valid() const{
...
OAIRoutingPreference OAIStorageAccountProperties::getRoutingPreference() const {
    return m_routing_preference;
}
void OAIStorageAccountProperties::setRoutingPreference(const OAIRoutingPreference &routing_preference) {
    m_routing_preference = routing_preference;
    m_routing_preference_isSet = true;
}

bool OAIStorageAccountProperties::is_routing_preference_Set() const{
    return m_routing_preference_isSet;
}

bool OAIStorageAccountProperties::is_routing_preference_Valid() const{
