...
OAIRoutingPreference OAIStorageAccountPropertiesCreateParameters::getRoutingPreference() const {
    return m_routing_preference;
}
void OAIStorageAccountPropertiesCreateParameters::setRoutingPreference(const OAIRoutingPreference &routing_preference) {
    m_routing_preference = routing_preference;
    m_routing_preference_isSet = true;
}

bool OAIStorageAccountPropertiesCreateParameters::is_routing_preference_Set() const{
    return m_routing_preference_isSet;
}

bool OAIStorageAccountPropertiesCreateParameters::is_routing_preference_Valid() const{
