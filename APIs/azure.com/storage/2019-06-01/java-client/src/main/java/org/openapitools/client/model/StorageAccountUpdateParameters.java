...
import org.openapitools.client.model.StorageAccountCreateParametersSku;
...
public class StorageAccountUpdateParameters {
  ...
  private StorageAccountCreateParametersSku sku;
  ...
  public StorageAccountUpdateParameters sku(StorageAccountCreateParametersSku sku) {
    this.sku = sku;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public StorageAccountCreateParametersSku getSku() {
    return sku;
  }

  public void setSku(StorageAccountCreateParametersSku sku) {
    this.sku = sku;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("sku") != null && !jsonObj.get("sku").isJsonNull()) {
        StorageAccountCreateParametersSku.validateJsonElement(jsonObj.get("sku"));
      }
  }
