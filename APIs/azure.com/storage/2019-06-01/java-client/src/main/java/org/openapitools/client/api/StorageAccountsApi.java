...
public class StorageAccountsApi {
     ...
     * @param apiVersion The API version to use for this operation. (required)
     * @param subscriptionId The ID of the target subscription. (required)
     * @param $expand May be used to expand the properties within account&#39;s properties. By default, data is not included when fetching properties. Currently we only support geoReplicationStats and blobRestoreStatus. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Build call for storageAccountsRestoreBlobRanges
     * @param resourceGroupName The name of the resource group within the user&#39;s subscription. The name is case insensitive. (required)
     * @param accountName The name of the storage account within the specified resource group. Storage account names must be between 3 and 24 characters in length and use numbers and lower-case letters only. (required)
     * @param apiVersion The API version to use for this operation. (required)
     * @param subscriptionId The ID of the target subscription. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK -- returned when blob ranges are restored completely with the same properties specified in the request body. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Accepted -- Blob restore request accepted; operation will complete asynchronously. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call storageAccountsRestoreBlobRangesCall(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, BlobRestoreParameters parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/restoreBlobRanges"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "accountName" + "}", localVarApiClient.escapeString(accountName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call storageAccountsRestoreBlobRangesValidateBeforeCall(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, BlobRestoreParameters parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling storageAccountsRestoreBlobRanges(Async)");
        }

        // verify the required parameter 'accountName' is set
        if (accountName == null) {
            throw new ApiException("Missing the required parameter 'accountName' when calling storageAccountsRestoreBlobRanges(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling storageAccountsRestoreBlobRanges(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling storageAccountsRestoreBlobRanges(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling storageAccountsRestoreBlobRanges(Async)");
        }

        return storageAccountsRestoreBlobRangesCall(resourceGroupName, accountName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public BlobRestoreStatus storageAccountsRestoreBlobRanges(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, BlobRestoreParameters parameters) throws ApiException {
        ApiResponse<BlobRestoreStatus> localVarResp = storageAccountsRestoreBlobRangesWithHttpInfo(resourceGroupName, accountName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     * @param subscriptionId The ID of the target subscription. (required)
     * @param parameters The parameters to provide for restore blob ranges. (required)
     * @return ApiResponse&lt;BlobRestoreStatus&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BlobRestoreStatus> storageAccountsRestoreBlobRangesWithHttpInfo(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, BlobRestoreParameters parameters) throws ApiException {
        okhttp3.Call localVarCall = storageAccountsRestoreBlobRangesValidateBeforeCall(resourceGroupName, accountName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<BlobRestoreStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call storageAccountsRestoreBlobRangesAsync(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, BlobRestoreParameters parameters, final ApiCallback<BlobRestoreStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = storageAccountsRestoreBlobRangesValidateBeforeCall(resourceGroupName, accountName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<BlobRestoreStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
