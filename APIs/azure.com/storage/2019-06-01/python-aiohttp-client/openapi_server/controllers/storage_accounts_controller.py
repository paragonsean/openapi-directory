...
async def storage_accounts_failover(request: web.Request, resource_group_name, account_name, api_version, subscription_id) -> web.Response:
...
async def storage_accounts_get_properties(request: web.Request, resource_group_name, account_name, api_version, subscription_id, expand=None) -> web.Response:
...
async def storage_accounts_list_account_sas(request: web.Request, resource_group_name, account_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = AccountSasParameters.from_dict(parameters)
    return web.Response(status=200)
...
async def storage_accounts_list_keys(request: web.Request, resource_group_name, account_name, api_version, subscription_id, expand=None) -> web.Response:
...
async def storage_accounts_list_service_sas(request: web.Request, resource_group_name, account_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = ServiceSasParameters.from_dict(parameters)
    return web.Response(status=200)
...
async def storage_accounts_regenerate_key(request: web.Request, resource_group_name, account_name, api_version, subscription_id, regenerate_key) -> web.Response:
    ...
    :param subscription_id: The ID of the target subscription.
    :type subscription_id: str
    :param regenerate_key: Specifies name of the key which should be regenerated -- key1, key2, kerb1, kerb2.
...
async def storage_accounts_restore_blob_ranges(request: web.Request, resource_group_name, account_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = BlobRestoreParameters.from_dict(parameters)
    return web.Response(status=200)


async def storage_accounts_revoke_user_delegation_keys(request: web.Request, resource_group_name, account_name, api_version, subscription_id) -> web.Response:
