...
class EncryptionService(Model):
    ...
    def __init__(self, enabled: bool=None, key_type: str=None, last_enabled_time: datetime=None):
        """EncryptionService - a model defined in OpenAPI

        :param enabled: The enabled of this EncryptionService.
        :param key_type: The key_type of this EncryptionService.
    ...
    @property
    def key_type(self):
        """Gets the key_type of this EncryptionService.

        Encryption key type to be used for the encryption service. 'Account' key type implies that an account-scoped encryption key will be used. 'Service' key type implies that a default service key is used.

        :return: The key_type of this EncryptionService.
        :rtype: str
        """
    ...
    def key_type(self, key_type):
        """Sets the key_type of this EncryptionService.
        ...
        :type key_type: str
        """
        allowed_values = ["Service", "Account"]  # noqa: E501
