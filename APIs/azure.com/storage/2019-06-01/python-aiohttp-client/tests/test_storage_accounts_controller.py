...
async def test_storage_accounts_create(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"kind":"Storage","location":"location","sku":{"tier":"Standard","name":"Standard_LRS"},"properties":{"routingPreference":{"publishInternetEndpoints":True,"routingChoice":"MicrosoftRouting","publishMicrosoftEndpoints":True},"encryption":{"keySource":"Microsoft.Storage","keyvaultproperties":{"keyvaulturi":"keyvaulturi","keyname":"keyname","keyversion":"keyversion"},"services":{"blob":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True},"file":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True},"queue":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True},"table":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True}}},"accessTier":"Hot","isHnsEnabled":True,"largeFileSharesState":"Disabled","supportsHttpsTrafficOnly":True,"azureFilesIdentityBasedAuthentication":{"activeDirectoryProperties":{"domainName":"domainName","forestName":"forestName","domainGuid":"domainGuid","netBiosDomainName":"netBiosDomainName","azureStorageSid":"azureStorageSid","domainSid":"domainSid"},"directoryServiceOptions":"None"},"networkAcls":{"bypass":"AzureServices","defaultAction":"Allow","ipRules":[{"action":"Allow","value":"value"},{"action":"Allow","value":"value"}],"virtualNetworkRules":[{"action":"Allow","id":"id","state":"provisioning"},{"action":"Allow","id":"id","state":"provisioning"}]},"customDomain":{"useSubDomainName":True,"name":"name"}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_storage_accounts_failover(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Storage/storageAccounts/{account_name}/failover'.format(resource_group_name='resource_group_name_example', account_name='account_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_storage_accounts_restore_blob_ranges(client):
    """Test case for storage_accounts_restore_blob_ranges

    
    """
    parameters = {"timeToRestore":"2000-01-23T04:56:07.000+00:00","blobRanges":[{"startRange":"startRange","endRange":"endRange"},{"startRange":"startRange","endRange":"endRange"}]}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Storage/storageAccounts/{account_name}/restoreBlobRanges'.format(resource_group_name='resource_group_name_example', account_name='account_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
...
async def test_storage_accounts_revoke_user_delegation_keys(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Storage/storageAccounts/{account_name}/revokeUserDelegationKeys'.format(resource_group_name='resource_group_name_example', account_name='account_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_storage_accounts_update(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"kind":"Storage","sku":{"tier":"Standard","name":"Standard_LRS"},"properties":{"routingPreference":{"publishInternetEndpoints":True,"routingChoice":"MicrosoftRouting","publishMicrosoftEndpoints":True},"encryption":{"keySource":"Microsoft.Storage","keyvaultproperties":{"keyvaulturi":"keyvaulturi","keyname":"keyname","keyversion":"keyversion"},"services":{"blob":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True},"file":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True},"queue":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True},"table":{"lastEnabledTime":"2000-01-23T04:56:07.000+00:00","keyType":"Service","enabled":True}}},"accessTier":"Hot","largeFileSharesState":"Disabled","supportsHttpsTrafficOnly":True,"azureFilesIdentityBasedAuthentication":{"activeDirectoryProperties":{"domainName":"domainName","forestName":"forestName","domainGuid":"domainGuid","netBiosDomainName":"netBiosDomainName","azureStorageSid":"azureStorageSid","domainSid":"domainSid"},"directoryServiceOptions":"None"},"networkAcls":{"bypass":"AzureServices","defaultAction":"Allow","ipRules":[{"action":"Allow","value":"value"},{"action":"Allow","value":"value"}],"virtualNetworkRules":[{"action":"Allow","id":"id","state":"provisioning"},{"action":"Allow","id":"id","state":"provisioning"}]},"customDomain":{"useSubDomainName":True,"name":"name"}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
