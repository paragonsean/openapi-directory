...
class Usage {
     ...
     * @param currentValue {Number} The current count of the allocated resources in the subscription.
     * @param limit {Number} The maximum count of the resources that can be allocated in the subscription.
     * @param name {module:model/UsageName} 
     * @param unit {module:model/Usage.UnitEnum} The unit of measurement.
     */
