...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void storageAccountsGetProperties(const QString &resource_group_name, const QString &account_name, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void storageAccountsListKeys(const QString &resource_group_name, const QString &account_name, const QString &api_version, const QString &subscription_id);
...
Q_SIGNALS:
    ...
    void storageAccountsListKeysSignal(OAIStorageAccountKeys summary);
    void storageAccountsRegenerateKeySignal(OAIStorageAccountKeys summary);
    ...
    void storageAccountsListKeysSignalFull(OAIHttpRequestWorker *worker, OAIStorageAccountKeys summary);
    void storageAccountsRegenerateKeySignalFull(OAIHttpRequestWorker *worker, OAIStorageAccountKeys summary);
    ...
    void storageAccountsListKeysSignalE(OAIStorageAccountKeys summary, QNetworkReply::NetworkError error_type, QString error_str);
    void storageAccountsListKeysSignalError(OAIStorageAccountKeys summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use storageAccountsRegenerateKeySignalError() instead")
    void storageAccountsRegenerateKeySignalE(OAIStorageAccountKeys summary, QNetworkReply::NetworkError error_type, QString error_str);
    void storageAccountsRegenerateKeySignalError(OAIStorageAccountKeys summary, QNetworkReply::NetworkError error_type, const QString &error_str);
