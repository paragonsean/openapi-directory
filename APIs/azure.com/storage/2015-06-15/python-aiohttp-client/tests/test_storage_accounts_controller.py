...
async def test_storage_accounts_create(client):
    ...
    """
    parameters = {"location":"location","properties":{"accountType":"Standard_LRS"},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_storage_accounts_update(client):
    ...
    """
    parameters = {"properties":{"accountType":"Standard_LRS","customDomain":{"useSubDomainName":True,"name":"name"}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
