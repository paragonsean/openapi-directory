...
class ContactProfile(Model):
    ...
    def __init__(self, additional_email_addresses: List[str]=None, country: str=None, first_name: str=None, last_name: str=None, phone_number: str=None, preferred_contact_method: str=None, preferred_support_language: str=None, preferred_time_zone: str=None, primary_email_address: str=None):
        """ContactProfile - a model defined in OpenAPI

        :param additional_email_addresses: The additional_email_addresses of this ContactProfile.
        :param country: The country of this ContactProfile.
        :param first_name: The first_name of this ContactProfile.
        :param last_name: The last_name of this ContactProfile.
        :param phone_number: The phone_number of this ContactProfile.
        :param preferred_contact_method: The preferred_contact_method of this ContactProfile.
        :param preferred_support_language: The preferred_support_language of this ContactProfile.
        :param preferred_time_zone: The preferred_time_zone of this ContactProfile.
        :param primary_email_address: The primary_email_address of this ContactProfile.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ContactProfile':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ContactProfile of this ContactProfile.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def additional_email_addresses(self):
        """Gets the additional_email_addresses of this ContactProfile.

        Additional email addresses listed will be copied on any correspondence about the support ticket.

        :return: The additional_email_addresses of this ContactProfile.
        :rtype: List[str]
        """
    ...
    def additional_email_addresses(self, additional_email_addresses):
        """Sets the additional_email_addresses of this ContactProfile.
    ...
    @property
    def country(self):
        """Gets the country of this ContactProfile.

        Country of the user. This is the ISO 3166-1 alpha-3 code.

        :return: The country of this ContactProfile.
        :rtype: str
        """
    ...
    def country(self, country):
        """Sets the country of this ContactProfile.
    ...
    @property
    def first_name(self):
        """Gets the first_name of this ContactProfile.

        First name.

        :return: The first_name of this ContactProfile.
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """Sets the first_name of this ContactProfile.
    ...
    @property
    def last_name(self):
        """Gets the last_name of this ContactProfile.

        Last name.

        :return: The last_name of this ContactProfile.
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """Sets the last_name of this ContactProfile.
    ...
    def phone_number(self):
        """Gets the phone_number of this ContactProfile.

        Phone number. This is required if preferred contact method is phone.

        :return: The phone_number of this ContactProfile.
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this ContactProfile.
    ...
    def preferred_contact_method(self):
        """Gets the preferred_contact_method of this ContactProfile.

        Preferred contact method.

        :return: The preferred_contact_method of this ContactProfile.
        :rtype: str
        """
    ...
    def preferred_contact_method(self, preferred_contact_method):
        """Sets the preferred_contact_method of this ContactProfile.
    ...
    def preferred_support_language(self):
        """Gets the preferred_support_language of this ContactProfile.
        ...
        :return: The preferred_support_language of this ContactProfile.
        :rtype: str
        """
    ...
    def preferred_support_language(self, preferred_support_language):
        """Sets the preferred_support_language of this ContactProfile.
        ...
        """
        if preferred_support_language is None:
            raise ValueError("Invalid value for `preferred_support_language`, must not be `None`")

        self._preferred_support_language = preferred_support_language

    @property
    def preferred_time_zone(self):
        """Gets the preferred_time_zone of this ContactProfile.
        ...
        :return: The preferred_time_zone of this ContactProfile.
        :rtype: str
        """
    ...
    def preferred_time_zone(self, preferred_time_zone):
        """Sets the preferred_time_zone of this ContactProfile.
        ...
        if preferred_time_zone is None:
            raise ValueError("Invalid value for `preferred_time_zone`, must not be `None`")

        self._preferred_time_zone = preferred_time_zone

    @property
    def primary_email_address(self):
        """Gets the primary_email_address of this ContactProfile.

        Primary email address.

        :return: The primary_email_address of this ContactProfile.
        :rtype: str
        """
    ...
    def primary_email_address(self, primary_email_address):
        """Sets the primary_email_address of this ContactProfile.
        ...
        """
        if primary_email_address is None:
            raise ValueError("Invalid value for `primary_email_address`, must not be `None`")
