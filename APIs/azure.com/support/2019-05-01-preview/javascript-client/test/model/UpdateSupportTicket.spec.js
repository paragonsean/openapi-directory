...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftSupport.UpdateSupportTicket();
  });
  ...
  describe('UpdateSupportTicket', function() {
    it('should create an instance of UpdateSupportTicket', function() {
      // uncomment below and update the code to test UpdateSupportTicket
      //var instance = new MicrosoftSupport.UpdateSupportTicket();
      //expect(instance).to.be.a(MicrosoftSupport.UpdateSupportTicket);
    });
