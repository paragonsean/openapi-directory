...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftSupport.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MicrosoftSupport.OperationDisplay();
      //expect(instance).to.be.a(MicrosoftSupport.OperationDisplay);
    });
