# MicrosoftSupport.ContactProfile

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**additionalEmailAddresses** | **[String]** | Additional email addresses listed will be copied on any correspondence about the support ticket. | [optional] 
