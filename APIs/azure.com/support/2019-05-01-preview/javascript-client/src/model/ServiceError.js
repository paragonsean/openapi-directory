    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('details')) {
                obj['details'] = ApiClient.convertToType(data['details'], [ServiceErrorDetail]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['details']) { // data not null
            ...
            for (const item of data['details']) {
                ServiceErrorDetail.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/ServiceErrorDetail>} details
 */
ServiceError.prototype['details'] = undefined;
 ...
 */
ServiceError.prototype['target'] = undefined;
