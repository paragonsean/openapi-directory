...
|------------ | ------------- | ------------- | -------------|
|**additionalEmailAddresses** | **List&lt;String&gt;** | Email addresses listed will be copied on any correspondence about the support ticket |  [optional] |
...
|**preferredContactMethod** | [**PreferredContactMethodEnum**](#PreferredContactMethodEnum) | Preferred contact method |  [optional] |
