...
|------------ | ------------- | ------------- | -------------|
|**additionalEmailAddresses** | **List&lt;String&gt;** | Additional email addresses listed will be copied on any correspondence about the support ticket. |  [optional] |
...
|**preferredContactMethod** | [**PreferredContactMethodEnum**](#PreferredContactMethodEnum) | Preferred contact method. |  |
