...
|**createdDate** | **OffsetDateTime** | Time in UTC (ISO 8601 format) when support ticket was created. |  [optional] [readonly] |
...
|**modifiedDate** | **OffsetDateTime** | Time in UTC (ISO 8601 format) when support ticket was last modified. |  [optional] [readonly] |
...
|**problemStartTime** | **OffsetDateTime** | Time in UTC (ISO 8601 format) when the problem started. |  [optional] |
...
|**severity** | [**SeverityEnum**](#SeverityEnum) | A value that indicates the urgency of the case, which in turn determines the response time according to the service level agreement of the technical support plan you have with Azure. |  |
