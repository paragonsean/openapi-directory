...
public class ServiceError {
  ...
  private List<ServiceErrorDetail> details = new ArrayList<>();
  ...
  public ServiceError(
     List<ServiceErrorDetail> details
  ) {
    this();
   ...
   */
  @javax.annotation.Nullable
  public List<ServiceErrorDetail> getDetails() {
    return details;
  }
  ...
  public ServiceError target(String target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, serviceError.code) &&
        ...
        Objects.equals(this.target, serviceError.target);
  }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            ServiceErrorDetail.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
