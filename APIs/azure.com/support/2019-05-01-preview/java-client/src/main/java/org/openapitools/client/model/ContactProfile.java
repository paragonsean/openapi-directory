...
public class ContactProfile {
  ...
  public ContactProfile additionalEmailAddresses(List<String> additionalEmailAddresses) {
    this.additionalEmailAddresses = additionalEmailAddresses;
    return this;
  }

  public ContactProfile addAdditionalEmailAddressesItem(String additionalEmailAddressesItem) {
  ...
  public ContactProfile country(String country) {
  ...
  public ContactProfile firstName(String firstName) {
  ...
  public ContactProfile lastName(String lastName) {
  ...
  public ContactProfile phoneNumber(String phoneNumber) {
  ...
  public ContactProfile preferredContactMethod(PreferredContactMethodEnum preferredContactMethod) {
  ...
  public ContactProfile preferredSupportLanguage(String preferredSupportLanguage) {
  ...
  public ContactProfile preferredTimeZone(String preferredTimeZone) {
  ...
  public ContactProfile primaryEmailAddress(String primaryEmailAddress) {
  ...
  public boolean equals(Object o) {
    ...
    ContactProfile contactProfile = (ContactProfile) o;
    return Objects.equals(this.additionalEmailAddresses, contactProfile.additionalEmailAddresses) &&
        Objects.equals(this.country, contactProfile.country) &&
        Objects.equals(this.firstName, contactProfile.firstName) &&
        Objects.equals(this.lastName, contactProfile.lastName) &&
        Objects.equals(this.phoneNumber, contactProfile.phoneNumber) &&
        Objects.equals(this.preferredContactMethod, contactProfile.preferredContactMethod) &&
        Objects.equals(this.preferredSupportLanguage, contactProfile.preferredSupportLanguage) &&
        Objects.equals(this.preferredTimeZone, contactProfile.preferredTimeZone) &&
        Objects.equals(this.primaryEmailAddress, contactProfile.primaryEmailAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactProfile {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("preferredContactMethod");
    openapiRequiredFields.add("preferredSupportLanguage");
    openapiRequiredFields.add("preferredTimeZone");
    openapiRequiredFields.add("primaryEmailAddress");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactProfile is not found in the empty JSON string", ContactProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ContactProfile.openapiRequiredFields) {
      ...
      if (!jsonObj.get("preferredContactMethod").isJsonPrimitive()) {
      ...
      // validate the required field `preferredContactMethod`
      PreferredContactMethodEnum.validateJsonElement(jsonObj.get("preferredContactMethod"));
      if (!jsonObj.get("preferredSupportLanguage").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("preferredTimeZone").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("primaryEmailAddress").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactProfile>() {
           @Override
           public void write(JsonWriter out, ContactProfile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactProfile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactProfile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactProfile
   * @throws IOException if the JSON string is invalid with respect to ContactProfile
   */
  public static ContactProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactProfile.class);
  }

  /**
   * Convert an instance of ContactProfile to an JSON string
   *
   * @return JSON string
   */
