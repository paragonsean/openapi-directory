...
public class OperationsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Successfully retrieved list of operations. </td><td>  -  </td></tr>
    ...
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.Support/operations";
     ...
     */
    public OperationsListResult operationsList(String apiVersion) throws ApiException {
        ApiResponse<OperationsListResult> localVarResp = operationsListWithHttpInfo(apiVersion);
     ...
     * This lists all the available Microsoft Support REST API operations.
     * @param apiVersion Api version (required)
     * @return ApiResponse&lt;OperationsListResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<OperationsListResult> operationsListWithHttpInfo(String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = operationsListValidateBeforeCall(apiVersion, null);
        Type localVarReturnType = new TypeToken<OperationsListResult>(){}.getType();
     ...
     */
    public okhttp3.Call operationsListAsync(String apiVersion, final ApiCallback<OperationsListResult> _callback) throws ApiException {
