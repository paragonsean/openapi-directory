...
QString OAIDeploymentOperationProperties::getDuration() const {
    return m_duration;
}
void OAIDeploymentOperationProperties::setDuration(const QString &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIDeploymentOperationProperties::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIDeploymentOperationProperties::is_duration_Valid() const{
