...
OAIDebugSetting OAIDeploymentPropertiesExtended::getDebugSetting() const {
    return m_debug_setting;
}
void OAIDeploymentPropertiesExtended::setDebugSetting(const OAIDebugSetting &debug_setting) {
    m_debug_setting = debug_setting;
    m_debug_setting_isSet = true;
}

bool OAIDeploymentPropertiesExtended::is_debug_setting_Set() const{
    return m_debug_setting_isSet;
}

bool OAIDeploymentPropertiesExtended::is_debug_setting_Valid() const{
...
QString OAIDeploymentPropertiesExtended::getDuration() const {
    return m_duration;
}
void OAIDeploymentPropertiesExtended::setDuration(const QString &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIDeploymentPropertiesExtended::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIDeploymentPropertiesExtended::is_duration_Valid() const{
...
OAIOnErrorDeploymentExtended OAIDeploymentPropertiesExtended::getOnErrorDeployment() const {
    return m_on_error_deployment;
}
void OAIDeploymentPropertiesExtended::setOnErrorDeployment(const OAIOnErrorDeploymentExtended &on_error_deployment) {
    m_on_error_deployment = on_error_deployment;
    m_on_error_deployment_isSet = true;
}

bool OAIDeploymentPropertiesExtended::is_on_error_deployment_Set() const{
    return m_on_error_deployment_isSet;
}

bool OAIDeploymentPropertiesExtended::is_on_error_deployment_Valid() const{
