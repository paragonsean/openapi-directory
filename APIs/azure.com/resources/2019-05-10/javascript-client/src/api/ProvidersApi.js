...
export default class ProvidersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the providersGetAtTenantScope operation.
     * @callback module:api/ProvidersApi~providersGetAtTenantScopeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Provider} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [expand] The $expand query parameter. For example, to include property aliases in response, use $expand=resourceTypes/aliases.
     * @param {module:api/ProvidersApi~providersGetAtTenantScopeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Provider}
     */
    providersGetAtTenantScope(resourceProviderNamespace, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'resourceProviderNamespace' is set
      if (resourceProviderNamespace === undefined || resourceProviderNamespace === null) {
        throw new Error("Missing the required parameter 'resourceProviderNamespace' when calling providersGetAtTenantScope");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling providersGetAtTenantScope");
      }
      ...
      let returnType = Provider;
      return this.apiClient.callApi(
        '/providers/{resourceProviderNamespace}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the providersListAtTenantScope operation.
     * @callback module:api/ProvidersApi~providersListAtTenantScopeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProviderListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [expand] The properties to include in the results. For example, use &$expand=metadata in the query string to retrieve resource provider metadata. To include property aliases in response, use $expand=resourceTypes/aliases.
     * @param {module:api/ProvidersApi~providersListAtTenantScopeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProviderListResult}
     */
    providersListAtTenantScope(apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling providersListAtTenantScope");
      }
