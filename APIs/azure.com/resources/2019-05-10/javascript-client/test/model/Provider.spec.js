...
(function(root, factory) {
  ...
  describe('Provider', function() {
    ...
    it('should have the property registrationPolicy (base name: "registrationPolicy")', function() {
      // uncomment below and update the code to test the property registrationPolicy
      //var instance = new ResourceManagementClient.Provider();
      //expect(instance).to.be();
    });
