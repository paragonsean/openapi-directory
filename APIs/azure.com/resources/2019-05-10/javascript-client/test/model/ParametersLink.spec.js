...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.ParametersLink();
  });
  ...
  describe('ParametersLink', function() {
    it('should create an instance of ParametersLink', function() {
      ...
      //var instance = new ResourceManagementClient.ParametersLink();
      //expect(instance).to.be.a(ResourceManagementClient.ParametersLink);
    });
