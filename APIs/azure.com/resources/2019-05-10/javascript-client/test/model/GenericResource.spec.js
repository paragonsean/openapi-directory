...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.GenericResource();
  });
  ...
  describe('GenericResource', function() {
    it('should create an instance of GenericResource', function() {
      // uncomment below and update the code to test GenericResource
      //var instance = new ResourceManagementClient.GenericResource();
      //expect(instance).to.be.a(ResourceManagementClient.GenericResource);
    });
