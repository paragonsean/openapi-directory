...
async def providers_get_at_tenant_scope(request: web.Request, resource_provider_namespace, api_version, expand=None) -> web.Response:
...
async def providers_list_at_tenant_scope(request: web.Request, api_version, top=None, expand=None) -> web.Response:
