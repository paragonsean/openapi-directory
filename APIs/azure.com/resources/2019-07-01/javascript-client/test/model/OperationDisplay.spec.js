...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ResourceManagementClient.OperationDisplay();
      //expect(instance).to.be.a(ResourceManagementClient.OperationDisplay);
    });
