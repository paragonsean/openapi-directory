...
let operationId = "operationId_example"; // String | The ID of the operation to get.
let apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
apiInstance.deploymentOperationsGetAtScope(scope, deploymentName, operationId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let operationId = "operationId_example"; // String | The ID of the operation to get.
let apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
apiInstance.deploymentOperationsGetAtTenantScope(deploymentName, operationId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeploymentOperationsListResult deploymentOperationsListAtScope(scope, deploymentName, apiVersion, opts)
...
apiInstance.deploymentOperationsListAtScope(scope, deploymentName, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeploymentOperationsListResult deploymentOperationsListAtTenantScope(deploymentName, apiVersion, opts)
...
apiInstance.deploymentOperationsListAtTenantScope(deploymentName, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
