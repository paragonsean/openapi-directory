...
void OAIProvider::initializeModel() {
    ...
    m_registration_policy_isSet = false;
    m_registration_policy_isValid = false;
...
void OAIProvider::fromJsonObject(QJsonObject json) {
    ...
    m_registration_policy_isValid = ::OpenAPI::fromJsonValue(m_registration_policy, json[QString("registrationPolicy")]);
    m_registration_policy_isSet = !json[QString("registrationPolicy")].isNull() && m_registration_policy_isValid;
...
QJsonObject OAIProvider::asJsonObject() const {
    ...
    if (m_registration_policy_isSet) {
        obj.insert(QString("registrationPolicy"), ::OpenAPI::toJsonValue(m_registration_policy));
    }
...
QString OAIProvider::getRegistrationPolicy() const {
    return m_registration_policy;
}
void OAIProvider::setRegistrationPolicy(const QString &registration_policy) {
    m_registration_policy = registration_policy;
    m_registration_policy_isSet = true;
}

bool OAIProvider::is_registration_policy_Set() const{
    return m_registration_policy_isSet;
}

bool OAIProvider::is_registration_policy_Valid() const{
    return m_registration_policy_isValid;
}
