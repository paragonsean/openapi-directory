...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void deploymentOperationsGetAtScope(const QString &scope, const QString &deployment_name, const QString &operation_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void deploymentOperationsGetAtTenantScope(const QString &deployment_name, const QString &operation_id, const QString &api_version);
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void deploymentOperationsListAtScope(const QString &scope, const QString &deployment_name, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void deploymentOperationsListAtTenantScope(const QString &deployment_name, const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void deploymentOperationsGetAtScopeCallback(OAIHttpRequestWorker *worker);
    void deploymentOperationsGetAtSubscriptionScopeCallback(OAIHttpRequestWorker *worker);
    void deploymentOperationsGetAtTenantScopeCallback(OAIHttpRequestWorker *worker);
    ...
    void deploymentOperationsListAtScopeCallback(OAIHttpRequestWorker *worker);
    void deploymentOperationsListAtSubscriptionScopeCallback(OAIHttpRequestWorker *worker);
    void deploymentOperationsListAtTenantScopeCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void deploymentOperationsGetAtScopeSignal(OAIDeploymentOperation summary);
    void deploymentOperationsGetAtSubscriptionScopeSignal(OAIDeploymentOperation summary);
    void deploymentOperationsGetAtTenantScopeSignal(OAIDeploymentOperation summary);
    ...
    void deploymentOperationsListAtScopeSignal(OAIDeploymentOperationsListResult summary);
    void deploymentOperationsListAtSubscriptionScopeSignal(OAIDeploymentOperationsListResult summary);
    void deploymentOperationsListAtTenantScopeSignal(OAIDeploymentOperationsListResult summary);
    ...
    void deploymentOperationsGetAtScopeSignalFull(OAIHttpRequestWorker *worker, OAIDeploymentOperation summary);
    void deploymentOperationsGetAtSubscriptionScopeSignalFull(OAIHttpRequestWorker *worker, OAIDeploymentOperation summary);
    void deploymentOperationsGetAtTenantScopeSignalFull(OAIHttpRequestWorker *worker, OAIDeploymentOperation summary);
    ...
    void deploymentOperationsListAtScopeSignalFull(OAIHttpRequestWorker *worker, OAIDeploymentOperationsListResult summary);
    ...
    void deploymentOperationsListAtTenantScopeSignalFull(OAIHttpRequestWorker *worker, OAIDeploymentOperationsListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsGetAtScopeSignalError() instead")
    void deploymentOperationsGetAtScopeSignalE(OAIDeploymentOperation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsGetAtScopeSignalError(OAIDeploymentOperation summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsGetAtTenantScopeSignalError() instead")
    void deploymentOperationsGetAtTenantScopeSignalE(OAIDeploymentOperation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsGetAtTenantScopeSignalError(OAIDeploymentOperation summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsListAtScopeSignalError() instead")
    void deploymentOperationsListAtScopeSignalE(OAIDeploymentOperationsListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsListAtScopeSignalError(OAIDeploymentOperationsListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsListAtTenantScopeSignalError() instead")
    void deploymentOperationsListAtTenantScopeSignalE(OAIDeploymentOperationsListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsListAtTenantScopeSignalError(OAIDeploymentOperationsListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsGetAtScopeSignalErrorFull() instead")
    void deploymentOperationsGetAtScopeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsGetAtScopeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsGetAtTenantScopeSignalErrorFull() instead")
    void deploymentOperationsGetAtTenantScopeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsGetAtTenantScopeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsListAtScopeSignalErrorFull() instead")
    void deploymentOperationsListAtScopeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsListAtScopeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deploymentOperationsListAtTenantScopeSignalErrorFull() instead")
    void deploymentOperationsListAtTenantScopeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deploymentOperationsListAtTenantScopeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
