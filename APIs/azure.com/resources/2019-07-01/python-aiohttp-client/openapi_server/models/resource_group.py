...
class ResourceGroup(Model):
    ...
    def __init__(self, id: str=None, location: str=None, managed_by: str=None, name: str=None, properties: ResourceGroupProperties=None, tags: Dict[str, str]=None, type: str=None):
        ...
        :param type: The type of this ResourceGroup.
        """
        self.openapi_types = {
            'id': str,
            'location': str,
    ...
    @property
    def type(self):
        """Gets the type of this ResourceGroup.

        The type of the resource group.

        :return: The type of this ResourceGroup.
        :rtype: str
        """
        return self._type
