...
> ResourceGroupExportResult resourceGroupsExportTemplate(subscriptionId, resourceGroupName, apiVersion, parameters)
...
apiInstance.resourceGroupsExportTemplate(subscriptionId, resourceGroupName, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
