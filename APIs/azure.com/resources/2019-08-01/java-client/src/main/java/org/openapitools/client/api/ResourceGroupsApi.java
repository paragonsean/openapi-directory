...
public class ResourceGroupsApi {
     ...
     */
    public okhttp3.Call resourceGroupsExportTemplateCall(String subscriptionId, String resourceGroupName, String apiVersion, ExportTemplateRequest parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resourceGroupsExportTemplateValidateBeforeCall(String subscriptionId, String resourceGroupName, String apiVersion, ExportTemplateRequest parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        return resourceGroupsExportTemplateCall(subscriptionId, resourceGroupName, apiVersion, parameters, _callback);
     ...
     */
    public ResourceGroupExportResult resourceGroupsExportTemplate(String subscriptionId, String resourceGroupName, String apiVersion, ExportTemplateRequest parameters) throws ApiException {
        ApiResponse<ResourceGroupExportResult> localVarResp = resourceGroupsExportTemplateWithHttpInfo(subscriptionId, resourceGroupName, apiVersion, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceGroupExportResult> resourceGroupsExportTemplateWithHttpInfo(String subscriptionId, String resourceGroupName, String apiVersion, ExportTemplateRequest parameters) throws ApiException {
        okhttp3.Call localVarCall = resourceGroupsExportTemplateValidateBeforeCall(subscriptionId, resourceGroupName, apiVersion, parameters, null);
     ...
     */
    public okhttp3.Call resourceGroupsExportTemplateAsync(String subscriptionId, String resourceGroupName, String apiVersion, ExportTemplateRequest parameters, final ApiCallback<ResourceGroupExportResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = resourceGroupsExportTemplateValidateBeforeCall(subscriptionId, resourceGroupName, apiVersion, parameters, _callback);
        Type localVarReturnType = new TypeToken<ResourceGroupExportResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
