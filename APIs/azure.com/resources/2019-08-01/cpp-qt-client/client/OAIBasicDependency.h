...
/*
 * OAIBasicDependency.h
 *
 * Deployment dependency information.
 */

#ifndef OAIBasicDependency_H
#define OAIBasicDependency_H
...
class OAIBasicDependency : public OAIObject {
public:
    OAIBasicDependency();
    OAIBasicDependency(QString json);
    ~OAIBasicDependency() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBasicDependency)

#endif // OAIBasicDependency_H
