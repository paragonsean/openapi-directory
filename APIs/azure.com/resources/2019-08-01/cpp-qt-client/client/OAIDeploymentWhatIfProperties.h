...
/*
 * OAIDeploymentWhatIfProperties.h
 *
 * Deployment What-if properties.
 */

#ifndef OAIDeploymentWhatIfProperties_H
#define OAIDeploymentWhatIfProperties_H
...
namespace OpenAPI {
class OAIDeploymentWhatIfSettings;
class OAIDebugSetting;
class OAIOnErrorDeployment;
class OAIParametersLink;
class OAITemplateLink;

class OAIDeploymentWhatIfProperties : public OAIObject {
public:
    OAIDeploymentWhatIfProperties();
    OAIDeploymentWhatIfProperties(QString json);
    ~OAIDeploymentWhatIfProperties() override;
    ...
    OAIDeploymentWhatIfSettings getWhatIfSettings() const;
    void setWhatIfSettings(const OAIDeploymentWhatIfSettings &what_if_settings);
    bool is_what_if_settings_Set() const;
    bool is_what_if_settings_Valid() const;
...
private:
    ...
    OAIDeploymentWhatIfSettings m_what_if_settings;
    bool m_what_if_settings_isSet;
    bool m_what_if_settings_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentWhatIfProperties)

#endif // OAIDeploymentWhatIfProperties_H
