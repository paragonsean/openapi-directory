...
class Provider {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('registrationPolicy')) {
                obj['registrationPolicy'] = ApiClient.convertToType(data['registrationPolicy'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['registrationPolicy'] && !(typeof data['registrationPolicy'] === 'string' || data['registrationPolicy'] instanceof String)) {
            throw new Error("Expected the field `registrationPolicy` to be a primitive type in the JSON string but got " + data['registrationPolicy']);
        }
        // ensure the json data is a string
 ...
 * @member {String} registrationPolicy
 */
Provider.prototype['registrationPolicy'] = undefined;
