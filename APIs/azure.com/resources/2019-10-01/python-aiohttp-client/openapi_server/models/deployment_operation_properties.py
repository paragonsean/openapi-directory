...
class DeploymentOperationProperties(Model):
    ...
    def __init__(self, duration: str=None, provisioning_state: str=None, request: HttpMessage=None, response: HttpMessage=None, service_request_id: str=None, status_code: str=None, status_message: object=None, target_resource: TargetResource=None, timestamp: datetime=None):
        """DeploymentOperationProperties - a model defined in OpenAPI

        :param duration: The duration of this DeploymentOperationProperties.
    ...
    @property
    def duration(self):
        """Gets the duration of this DeploymentOperationProperties.

        The duration of the operation.

        :return: The duration of this DeploymentOperationProperties.
        :rtype: str
        """
    ...
    def duration(self, duration):
        """Sets the duration of this DeploymentOperationProperties.
