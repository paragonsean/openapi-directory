...
import IdentityUserAssignedIdentitiesValue from './IdentityUserAssignedIdentitiesValue';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('userAssignedIdentities')) {
                obj['userAssignedIdentities'] = ApiClient.convertToType(data['userAssignedIdentities'], {'String': IdentityUserAssignedIdentitiesValue});
            }
        }
        return obj;
    }
 ...
 * @member {Object.<String, module:model/IdentityUserAssignedIdentitiesValue>} userAssignedIdentities
 */
Identity.prototype['userAssignedIdentities'] = undefined;
