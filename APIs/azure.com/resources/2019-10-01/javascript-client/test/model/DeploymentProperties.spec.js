...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.DeploymentProperties();
  });
  ...
  describe('DeploymentProperties', function() {
    it('should create an instance of DeploymentProperties', function() {
      // uncomment below and update the code to test DeploymentProperties
      //var instance = new ResourceManagementClient.DeploymentProperties();
      //expect(instance).to.be.a(ResourceManagementClient.DeploymentProperties);
    });
