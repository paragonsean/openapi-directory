...
public:
    ...
    */
    virtual void resourceGroupsExportTemplate(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const OAIExportTemplateRequest &parameters);
