...
namespace OpenAPI {
class OAIIdentity_userAssignedIdentities_value;
...
public:
    ...
    QMap<QString, OAIIdentity_userAssignedIdentities_value> getUserAssignedIdentities() const;
    void setUserAssignedIdentities(const QMap<QString, OAIIdentity_userAssignedIdentities_value> &user_assigned_identities);
...
private:
    ...
    QMap<QString, OAIIdentity_userAssignedIdentities_value> m_user_assigned_identities;
