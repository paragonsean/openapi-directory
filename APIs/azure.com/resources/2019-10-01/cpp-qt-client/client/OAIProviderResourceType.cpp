...
QString OAIProviderResourceType::getCapabilities() const {
    return m_capabilities;
}
void OAIProviderResourceType::setCapabilities(const QString &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIProviderResourceType::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIProviderResourceType::is_capabilities_Valid() const{
