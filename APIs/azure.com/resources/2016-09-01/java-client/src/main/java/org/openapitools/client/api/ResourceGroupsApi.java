...
public class ResourceGroupsApi {
     ...
     * @param resourceGroupName The name of the resource group to create or update. (required)
     * @param apiVersion The API version to use for this operation. (required)
     * @param subscriptionId The ID of the target subscription. (required)
    ...
    /**
     * Build call for resourceGroupsListResources
     ...
     */
    public okhttp3.Call resourceGroupsListResourcesCall(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, String $expand, Integer $top, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resourceGroupsListResourcesValidateBeforeCall(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, String $expand, Integer $top, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling resourceGroupsListResources(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling resourceGroupsListResources(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling resourceGroupsListResources(Async)");
        }

        return resourceGroupsListResourcesCall(resourceGroupName, apiVersion, subscriptionId, $filter, $expand, $top, _callback);
     ...
     */
    public ResourceListResult resourceGroupsListResources(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, String $expand, Integer $top) throws ApiException {
        ApiResponse<ResourceListResult> localVarResp = resourceGroupsListResourcesWithHttpInfo(resourceGroupName, apiVersion, subscriptionId, $filter, $expand, $top);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListResult> resourceGroupsListResourcesWithHttpInfo(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, String $expand, Integer $top) throws ApiException {
        okhttp3.Call localVarCall = resourceGroupsListResourcesValidateBeforeCall(resourceGroupName, apiVersion, subscriptionId, $filter, $expand, $top, null);
     ...
     */
    public okhttp3.Call resourceGroupsListResourcesAsync(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, String $expand, Integer $top, final ApiCallback<ResourceListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = resourceGroupsListResourcesValidateBeforeCall(resourceGroupName, apiVersion, subscriptionId, $filter, $expand, $top, _callback);
        Type localVarReturnType = new TypeToken<ResourceListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for resourceGroupsPatch
     ...
     */
    public okhttp3.Call resourceGroupsPatchCall(String resourceGroupName, String apiVersion, String subscriptionId, ResourceGroup parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resourceGroupsPatchValidateBeforeCall(String resourceGroupName, String apiVersion, String subscriptionId, ResourceGroup parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling resourceGroupsPatch(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling resourceGroupsPatch(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling resourceGroupsPatch(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling resourceGroupsPatch(Async)");
        }

        return resourceGroupsPatchCall(resourceGroupName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public ResourceGroup resourceGroupsPatch(String resourceGroupName, String apiVersion, String subscriptionId, ResourceGroup parameters) throws ApiException {
        ApiResponse<ResourceGroup> localVarResp = resourceGroupsPatchWithHttpInfo(resourceGroupName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceGroup> resourceGroupsPatchWithHttpInfo(String resourceGroupName, String apiVersion, String subscriptionId, ResourceGroup parameters) throws ApiException {
        okhttp3.Call localVarCall = resourceGroupsPatchValidateBeforeCall(resourceGroupName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<ResourceGroup>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call resourceGroupsPatchAsync(String resourceGroupName, String apiVersion, String subscriptionId, ResourceGroup parameters, final ApiCallback<ResourceGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = resourceGroupsPatchValidateBeforeCall(resourceGroupName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<ResourceGroup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
