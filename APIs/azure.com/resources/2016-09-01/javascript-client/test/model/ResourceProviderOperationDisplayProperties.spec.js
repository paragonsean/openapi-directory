...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.ResourceProviderOperationDisplayProperties();
  });
  ...
  describe('ResourceProviderOperationDisplayProperties', function() {
    it('should create an instance of ResourceProviderOperationDisplayProperties', function() {
      // uncomment below and update the code to test ResourceProviderOperationDisplayProperties
      //var instance = new ResourceManagementClient.ResourceProviderOperationDisplayProperties();
      //expect(instance).to.be.a(ResourceManagementClient.ResourceProviderOperationDisplayProperties);
    });
