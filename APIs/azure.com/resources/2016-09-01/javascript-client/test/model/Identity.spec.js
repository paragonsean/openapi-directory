...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.Identity();
  });
  ...
  describe('Identity', function() {
    it('should create an instance of Identity', function() {
      ...
      //var instance = new ResourceManagementClient.Identity();
      //expect(instance).to.be.a(ResourceManagementClient.Identity);
    });
