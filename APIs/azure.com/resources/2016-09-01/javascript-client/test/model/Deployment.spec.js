...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.Deployment();
  });
  ...
  describe('Deployment', function() {
    it('should create an instance of Deployment', function() {
      ...
      //var instance = new ResourceManagementClient.Deployment();
      //expect(instance).to.be.a(ResourceManagementClient.Deployment);
    });
