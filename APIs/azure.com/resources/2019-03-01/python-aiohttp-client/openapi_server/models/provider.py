...
class Provider(Model):
    ...
    def __init__(self, id: str=None, namespace: str=None, registration_policy: str=None, registration_state: str=None, resource_types: List[ProviderResourceType]=None):
        """Provider - a model defined in OpenAPI

        :param id: The id of this Provider.
        :param namespace: The namespace of this Provider.
        :param registration_policy: The registration_policy of this Provider.
    ...
    def registration_policy(self):
        """Gets the registration_policy of this Provider.

        The registration policy of the resource provider.

        :return: The registration_policy of this Provider.
        :rtype: str
        """
        return self._registration_policy

    @registration_policy.setter
    def registration_policy(self, registration_policy):
        """Sets the registration_policy of this Provider.

        The registration policy of the resource provider.

        :param registration_policy: The registration_policy of this Provider.
        :type registration_policy: str
        """
