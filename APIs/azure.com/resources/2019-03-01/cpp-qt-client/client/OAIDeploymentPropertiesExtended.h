...
class OAIDependency;
class OAIOnErrorDeploymentExtended;
...
public:
    ...
    OAIOnErrorDeploymentExtended getOnErrorDeployment() const;
    void setOnErrorDeployment(const OAIOnErrorDeploymentExtended &on_error_deployment);
...
private:
    ...
    OAIOnErrorDeploymentExtended m_on_error_deployment;
