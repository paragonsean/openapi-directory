...
public:
    ...
    QString getRegistrationPolicy() const;
    void setRegistrationPolicy(const QString &registration_policy);
    bool is_registration_policy_Set() const;
    bool is_registration_policy_Valid() const;
...
private:
    ...
    QString m_registration_policy;
    bool m_registration_policy_isSet;
    bool m_registration_policy_isValid;
