# ResourceManagementClient.ResourceGroup
...
**name** | **String** | The name of the resource group. | [optional] [readonly] 
**properties** | [**ResourceGroupProperties**](ResourceGroupProperties.md) |  | [optional] 
**tags** | **{String: String}** | The tags attached to the resource group. | [optional] 
**type** | **String** | The type of the resource group. | [optional] [readonly] 
