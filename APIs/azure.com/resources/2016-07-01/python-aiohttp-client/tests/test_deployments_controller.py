...
async def test_deployments_create_or_update(client):
    ...
    """
    parameters = {"properties":{"mode":"Incremental","parametersLink":{"contentVersion":"contentVersion","uri":"uri"},"template":"{}","templateLink":{"contentVersion":"contentVersion","uri":"uri"},"parameters":"{}","debugSetting":{"detailLevel":"detailLevel"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
