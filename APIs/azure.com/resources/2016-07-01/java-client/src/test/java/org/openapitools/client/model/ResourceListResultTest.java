...
/**
 * Model tests for ResourceListResult
 */
public class ResourceListResultTest {
    private final ResourceListResult model = new ResourceListResult();
