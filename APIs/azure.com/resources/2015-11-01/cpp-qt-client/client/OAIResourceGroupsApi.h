...
public:
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void resourceGroupsListResources(const QString &resource_group_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  parameters OAIResourceGroup [required]
    */
    virtual void resourceGroupsPatch(const QString &resource_group_name, const QString &api_version, const QString &subscription_id, const OAIResourceGroup &parameters);
...
private:
    ...
    void resourceGroupsListResourcesCallback(OAIHttpRequestWorker *worker);
    void resourceGroupsPatchCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void resourceGroupsListResourcesSignal(OAIResourceListResult summary);
    void resourceGroupsPatchSignal(OAIResourceGroup summary);
    ...
    void resourceGroupsListResourcesSignalFull(OAIHttpRequestWorker *worker, OAIResourceListResult summary);
    void resourceGroupsPatchSignalFull(OAIHttpRequestWorker *worker, OAIResourceGroup summary);
    ...
    Q_DECL_DEPRECATED_X("Use resourceGroupsListResourcesSignalError() instead")
    void resourceGroupsListResourcesSignalE(OAIResourceListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resourceGroupsListResourcesSignalError(OAIResourceListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use resourceGroupsPatchSignalError() instead")
    void resourceGroupsPatchSignalE(OAIResourceGroup summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resourceGroupsPatchSignalError(OAIResourceGroup summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use resourceGroupsListResourcesSignalErrorFull() instead")
    void resourceGroupsListResourcesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resourceGroupsListResourcesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use resourceGroupsPatchSignalErrorFull() instead")
    void resourceGroupsPatchSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resourceGroupsPatchSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
