...
public:
    ...
    * @param[in]  policy_assignment_name QString [required]
    */
    virtual void policyAssignmentsDelete(const QString &scope, const QString &policy_assignment_name);
    ...
    * @param[in]  filter QString [optional]
    */
    virtual void policyAssignmentsListForScope(const QString &scope, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void policyAssignmentsListForScopeCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void policyAssignmentsListForScopeSignal(OAIPolicyAssignmentListResult summary);
    ...
    void policyAssignmentsListForScopeSignalFull(OAIHttpRequestWorker *worker, OAIPolicyAssignmentListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use policyAssignmentsListForScopeSignalError() instead")
    void policyAssignmentsListForScopeSignalE(OAIPolicyAssignmentListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void policyAssignmentsListForScopeSignalError(OAIPolicyAssignmentListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use policyAssignmentsListForScopeSignalErrorFull() instead")
    void policyAssignmentsListForScopeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void policyAssignmentsListForScopeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
