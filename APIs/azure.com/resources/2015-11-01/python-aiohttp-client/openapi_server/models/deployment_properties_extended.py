...
class DeploymentPropertiesExtended(Model):
    ...
    def __init__(self, correlation_id: str=None, dependencies: List[Dependency]=None, mode: str=None, outputs: object=None, parameters: object=None, parameters_link: ParametersLink=None, providers: List[Provider]=None, provisioning_state: str=None, template: object=None, template_link: TemplateLink=None, timestamp: datetime=None):
