...
async def providers_get(request: web.Request, resource_provider_namespace, api_version, subscription_id) -> web.Response:
    """providers_get
...
async def providers_list(request: web.Request, api_version, subscription_id, top=None) -> web.Response:
    """providers_list
