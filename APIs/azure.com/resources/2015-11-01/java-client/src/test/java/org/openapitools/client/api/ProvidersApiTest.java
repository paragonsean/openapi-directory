...
public class ProvidersApiTest {
    ...
    public void providersGetTest() throws ApiException {
        ...
        Provider response = api.providersGet(resourceProviderNamespace, apiVersion, subscriptionId);
    ...
    public void providersListTest() throws ApiException {
        ...
        String subscriptionId = null;
        Integer $top = null;
        ProviderListResult response = api.providersList(apiVersion, subscriptionId, $top);
        // TODO: test validations
    }
