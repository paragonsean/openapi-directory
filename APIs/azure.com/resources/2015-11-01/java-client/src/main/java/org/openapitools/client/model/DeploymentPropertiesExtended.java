...
public class DeploymentPropertiesExtended {
  ...
  public DeploymentPropertiesExtended correlationId(String correlationId) {
  ...
  public DeploymentPropertiesExtended provisioningState(String provisioningState) {
  ...
  public DeploymentPropertiesExtended timestamp(OffsetDateTime timestamp) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(correlationId, dependencies, mode, outputs, parameters, parametersLink, providers, provisioningState, template, templateLink, timestamp);
  }
