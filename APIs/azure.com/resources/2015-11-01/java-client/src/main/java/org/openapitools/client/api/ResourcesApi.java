...
public class ResourcesApi {
     ...
     */
    public okhttp3.Call resourcesListCall(String apiVersion, String subscriptionId, String $filter, Integer $top, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resourcesListValidateBeforeCall(String apiVersion, String subscriptionId, String $filter, Integer $top, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
        ...
        return resourcesListCall(apiVersion, subscriptionId, $filter, $top, _callback);
     ...
     */
    public ResourceListResult resourcesList(String apiVersion, String subscriptionId, String $filter, Integer $top) throws ApiException {
        ApiResponse<ResourceListResult> localVarResp = resourcesListWithHttpInfo(apiVersion, subscriptionId, $filter, $top);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListResult> resourcesListWithHttpInfo(String apiVersion, String subscriptionId, String $filter, Integer $top) throws ApiException {
        okhttp3.Call localVarCall = resourcesListValidateBeforeCall(apiVersion, subscriptionId, $filter, $top, null);
     ...
     */
    public okhttp3.Call resourcesListAsync(String apiVersion, String subscriptionId, String $filter, Integer $top, final ApiCallback<ResourceListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = resourcesListValidateBeforeCall(apiVersion, subscriptionId, $filter, $top, _callback);
        Type localVarReturnType = new TypeToken<ResourceListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
