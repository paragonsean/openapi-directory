...
public class ResourceGroupsApi {
     ...
     */
    public okhttp3.Call resourceGroupsListResourcesCall(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, Integer $top, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resourceGroupsListResourcesValidateBeforeCall(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, Integer $top, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return resourceGroupsListResourcesCall(resourceGroupName, apiVersion, subscriptionId, $filter, $top, _callback);
     ...
     */
    public ResourceListResult resourceGroupsListResources(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, Integer $top) throws ApiException {
        ApiResponse<ResourceListResult> localVarResp = resourceGroupsListResourcesWithHttpInfo(resourceGroupName, apiVersion, subscriptionId, $filter, $top);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListResult> resourceGroupsListResourcesWithHttpInfo(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, Integer $top) throws ApiException {
        okhttp3.Call localVarCall = resourceGroupsListResourcesValidateBeforeCall(resourceGroupName, apiVersion, subscriptionId, $filter, $top, null);
     ...
     */
    public okhttp3.Call resourceGroupsListResourcesAsync(String resourceGroupName, String apiVersion, String subscriptionId, String $filter, Integer $top, final ApiCallback<ResourceListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = resourceGroupsListResourcesValidateBeforeCall(resourceGroupName, apiVersion, subscriptionId, $filter, $top, _callback);
        Type localVarReturnType = new TypeToken<ResourceListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
