...
> ResourceListResult resourceGroupsListResources(resourceGroupName, apiVersion, subscriptionId, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | Query parameters. If null is passed returns all resource groups.
    try {
      ResourceListResult result = apiInstance.resourceGroupsListResources(resourceGroupName, apiVersion, subscriptionId, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
