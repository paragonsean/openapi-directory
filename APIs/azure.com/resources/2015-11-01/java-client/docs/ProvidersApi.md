...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Provider result = apiInstance.providersGet(resourceProviderNamespace, apiVersion, subscriptionId);
...
# **providersList**
> ProviderListResult providersList(apiVersion, subscriptionId, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProviderListResult result = apiInstance.providersList(apiVersion, subscriptionId, $top);
      System.out.println(result);
    } catch (ApiException e) {
