...
# **resourcesList**
> ResourceListResult resourcesList(apiVersion, subscriptionId, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResourceListResult result = apiInstance.resourcesList(apiVersion, subscriptionId, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
