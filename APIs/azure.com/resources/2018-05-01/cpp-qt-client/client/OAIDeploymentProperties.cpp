...
OAIOnErrorDeployment OAIDeploymentProperties::getOnErrorDeployment() const {
    return m_on_error_deployment;
}
void OAIDeploymentProperties::setOnErrorDeployment(const OAIOnErrorDeployment &on_error_deployment) {
    m_on_error_deployment = on_error_deployment;
    m_on_error_deployment_isSet = true;
}

bool OAIDeploymentProperties::is_on_error_deployment_Set() const{
    return m_on_error_deployment_isSet;
}

bool OAIDeploymentProperties::is_on_error_deployment_Valid() const{
