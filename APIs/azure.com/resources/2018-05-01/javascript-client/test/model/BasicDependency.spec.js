...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.BasicDependency();
  });
  ...
  describe('BasicDependency', function() {
    it('should create an instance of BasicDependency', function() {
      // uncomment below and update the code to test BasicDependency
      //var instance = new ResourceManagementClient.BasicDependency();
      //expect(instance).to.be.a(ResourceManagementClient.BasicDependency);
    });
