...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ResourceManagementClient.Operation();
      //expect(instance).to.be.a(ResourceManagementClient.Operation);
    });
