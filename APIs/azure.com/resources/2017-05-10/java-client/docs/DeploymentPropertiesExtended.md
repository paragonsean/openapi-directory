...
|------------ | ------------- | ------------- | -------------|
|**correlationId** | **String** | The correlation ID of the deployment. |  [optional] [readonly] |
...
|**mode** | [**ModeEnum**](#ModeEnum) | The deployment mode. Possible values are Incremental and Complete. |  [optional] |
...
|**timestamp** | **OffsetDateTime** | The timestamp of the template deployment. |  [optional] [readonly] |
