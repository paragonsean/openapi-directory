...
public class DeploymentPropertiesExtended {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(correlationId, debugSetting, dependencies, mode, outputs, parameters, parametersLink, providers, provisioningState, template, templateLink, timestamp);
  }
