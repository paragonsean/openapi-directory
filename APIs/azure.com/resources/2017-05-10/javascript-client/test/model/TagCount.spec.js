...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.TagCount();
  });
  ...
  describe('TagCount', function() {
    it('should create an instance of TagCount', function() {
      // uncomment below and update the code to test TagCount
      //var instance = new ResourceManagementClient.TagCount();
      //expect(instance).to.be.a(ResourceManagementClient.TagCount);
    });
