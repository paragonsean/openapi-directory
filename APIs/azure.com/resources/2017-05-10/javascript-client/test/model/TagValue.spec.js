...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.TagValue();
  });
  ...
  describe('TagValue', function() {
    it('should create an instance of TagValue', function() {
      // uncomment below and update the code to test TagValue
      //var instance = new ResourceManagementClient.TagValue();
      //expect(instance).to.be.a(ResourceManagementClient.TagValue);
    });
