...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ResourceManagementClient.Dependency();
  });
  ...
  describe('Dependency', function() {
    it('should create an instance of Dependency', function() {
      // uncomment below and update the code to test Dependency
      //var instance = new ResourceManagementClient.Dependency();
      //expect(instance).to.be.a(ResourceManagementClient.Dependency);
    });
