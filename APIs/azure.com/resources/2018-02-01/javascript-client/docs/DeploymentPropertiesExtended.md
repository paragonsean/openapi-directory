...
**mode** | **String** | The deployment mode. Possible values are Incremental and Complete. | [optional] 
**onErrorDeployment** | [**OnErrorDeploymentExtended**](OnErrorDeploymentExtended.md) |  | [optional] 
...
**timestamp** | **Date** | The timestamp of the template deployment. | [optional] [readonly] 
