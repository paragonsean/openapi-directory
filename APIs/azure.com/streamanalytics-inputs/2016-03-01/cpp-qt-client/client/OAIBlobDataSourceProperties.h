...
/*
 * OAIBlobDataSourceProperties.h
 *
 * The properties that are associated with a blob data source.
 */

#ifndef OAIBlobDataSourceProperties_H
#define OAIBlobDataSourceProperties_H
...
class OAIBlobDataSourceProperties : public OAIObject {
public:
    OAIBlobDataSourceProperties();
    OAIBlobDataSourceProperties(QString json);
    ~OAIBlobDataSourceProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlobDataSourceProperties)

#endif // OAIBlobDataSourceProperties_H
