...
|------------ | ------------- | ------------- | -------------|
|**sourcePartitionCount** | **Integer** | The partition count of the blob input data source. Range 1 - 256. |  [optional] |
...
|**storageAccounts** | [**List&lt;StorageAccount&gt;**](StorageAccount.md) | A list of one or more Azure Storage accounts. Required on PUT (CreateOrReplace) requests. |  [optional] |
