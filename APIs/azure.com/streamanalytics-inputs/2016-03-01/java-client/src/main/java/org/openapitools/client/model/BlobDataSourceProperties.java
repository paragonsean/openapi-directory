...
public class BlobDataSourceProperties {
  ...
  public BlobDataSourceProperties container(String container) {
  ...
  public BlobDataSourceProperties dateFormat(String dateFormat) {
  ...
  public BlobDataSourceProperties pathPattern(String pathPattern) {
  ...
  public BlobDataSourceProperties storageAccounts(List<StorageAccount> storageAccounts) {
    this.storageAccounts = storageAccounts;
    return this;
  }

  public BlobDataSourceProperties addStorageAccountsItem(StorageAccount storageAccountsItem) {
  ...
  public BlobDataSourceProperties timeFormat(String timeFormat) {
  ...
  public boolean equals(Object o) {
    ...
    BlobDataSourceProperties blobDataSourceProperties = (BlobDataSourceProperties) o;
    return Objects.equals(this.container, blobDataSourceProperties.container) &&
        Objects.equals(this.dateFormat, blobDataSourceProperties.dateFormat) &&
        Objects.equals(this.pathPattern, blobDataSourceProperties.pathPattern) &&
        Objects.equals(this.storageAccounts, blobDataSourceProperties.storageAccounts) &&
        Objects.equals(this.timeFormat, blobDataSourceProperties.timeFormat);
  }
  ...
  public String toString() {
    ...
    sb.append("class BlobDataSourceProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BlobDataSourceProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlobDataSourceProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlobDataSourceProperties is not found in the empty JSON string", BlobDataSourceProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlobDataSourceProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlobDataSourceProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlobDataSourceProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlobDataSourceProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlobDataSourceProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlobDataSourceProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<BlobDataSourceProperties>() {
           @Override
           public void write(JsonWriter out, BlobDataSourceProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlobDataSourceProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BlobDataSourceProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BlobDataSourceProperties
   * @throws IOException if the JSON string is invalid with respect to BlobDataSourceProperties
   */
  public static BlobDataSourceProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlobDataSourceProperties.class);
  }

  /**
   * Convert an instance of BlobDataSourceProperties to an JSON string
   *
   * @return JSON string
   */
