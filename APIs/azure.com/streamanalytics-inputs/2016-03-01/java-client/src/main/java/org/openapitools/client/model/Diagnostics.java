...
import org.openapitools.client.model.DiagnosticCondition;
...
public class Diagnostics {
  ...
  private List<DiagnosticCondition> conditions = new ArrayList<>();
  ...
  public List<DiagnosticCondition> getConditions() {
    return conditions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conditions, diagnostics.conditions);
  }
      ...
      if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonNull()) {
        ...
        if (jsonArrayconditions != null) {
          ...
          for (int i = 0; i < jsonArrayconditions.size(); i++) {
            DiagnosticCondition.validateJsonElement(jsonArrayconditions.get(i));
          };
        }
      }
  }
