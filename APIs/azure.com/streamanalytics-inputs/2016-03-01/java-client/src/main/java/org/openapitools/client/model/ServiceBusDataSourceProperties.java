...
public class ServiceBusDataSourceProperties {
  ...
  public ServiceBusDataSourceProperties serviceBusNamespace(String serviceBusNamespace) {
  ...
  public ServiceBusDataSourceProperties sharedAccessPolicyKey(String sharedAccessPolicyKey) {
  ...
  public ServiceBusDataSourceProperties sharedAccessPolicyName(String sharedAccessPolicyName) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceBusDataSourceProperties serviceBusDataSourceProperties = (ServiceBusDataSourceProperties) o;
    return Objects.equals(this.serviceBusNamespace, serviceBusDataSourceProperties.serviceBusNamespace) &&
        Objects.equals(this.sharedAccessPolicyKey, serviceBusDataSourceProperties.sharedAccessPolicyKey) &&
        Objects.equals(this.sharedAccessPolicyName, serviceBusDataSourceProperties.sharedAccessPolicyName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceBusNamespace, sharedAccessPolicyKey, sharedAccessPolicyName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServiceBusDataSourceProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceBusDataSourceProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceBusDataSourceProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceBusDataSourceProperties is not found in the empty JSON string", ServiceBusDataSourceProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceBusDataSourceProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceBusDataSourceProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceBusDataSourceProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceBusDataSourceProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceBusDataSourceProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceBusDataSourceProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceBusDataSourceProperties>() {
           @Override
           public void write(JsonWriter out, ServiceBusDataSourceProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceBusDataSourceProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceBusDataSourceProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceBusDataSourceProperties
   * @throws IOException if the JSON string is invalid with respect to ServiceBusDataSourceProperties
   */
  public static ServiceBusDataSourceProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceBusDataSourceProperties.class);
  }

  /**
   * Convert an instance of ServiceBusDataSourceProperties to an JSON string
   *
   * @return JSON string
   */
