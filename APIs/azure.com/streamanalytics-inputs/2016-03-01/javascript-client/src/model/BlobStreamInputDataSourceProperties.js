...
/**
 * The BlobStreamInputDataSourceProperties model module.
 * @module model/BlobStreamInputDataSourceProperties
 * @version 2016-03-01
 */
class BlobStreamInputDataSourceProperties {
    /**
     * Constructs a new <code>BlobStreamInputDataSourceProperties</code>.
     * The properties that are associated with a blob input containing stream data.
     * @alias module:model/BlobStreamInputDataSourceProperties
     * @implements module:model/BlobDataSourceProperties
     */
    constructor() { 
        BlobDataSourceProperties.initialize(this);
        BlobStreamInputDataSourceProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BlobStreamInputDataSourceProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlobStreamInputDataSourceProperties} obj Optional instance to populate.
     * @return {module:model/BlobStreamInputDataSourceProperties} The populated <code>BlobStreamInputDataSourceProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlobStreamInputDataSourceProperties();
            BlobDataSourceProperties.constructFromObject(data, obj);

            if (data.hasOwnProperty('sourcePartitionCount')) {
                obj['sourcePartitionCount'] = ApiClient.convertToType(data['sourcePartitionCount'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BlobStreamInputDataSourceProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlobStreamInputDataSourceProperties</code>.
     */
 ...
 * @member {Number} sourcePartitionCount
 */
BlobStreamInputDataSourceProperties.prototype['sourcePartitionCount'] = undefined;

/**
 * The name of a container within the associated Storage account. This container contains either the blob(s) to be read from or written to. Required on PUT (CreateOrReplace) requests.
 * @member {String} container
 */
BlobStreamInputDataSourceProperties.prototype['container'] = undefined;

/**
 * The date format. Wherever {date} appears in pathPattern, the value of this property is used as the date format instead.
 * @member {String} dateFormat
 */
BlobStreamInputDataSourceProperties.prototype['dateFormat'] = undefined;

/**
 * The blob path pattern. Not a regular expression. It represents a pattern against which blob names will be matched to determine whether or not they should be included as input or output to the job. See https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-input or https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-output for a more detailed explanation and example.
 * @member {String} pathPattern
 */
BlobStreamInputDataSourceProperties.prototype['pathPattern'] = undefined;

/**
 * A list of one or more Azure Storage accounts. Required on PUT (CreateOrReplace) requests.
 * @member {Array.<module:model/StorageAccount>} storageAccounts
 */
BlobStreamInputDataSourceProperties.prototype['storageAccounts'] = undefined;

/**
 * The time format. Wherever {time} appears in pathPattern, the value of this property is used as the time format instead.
 * @member {String} timeFormat
 */
BlobStreamInputDataSourceProperties.prototype['timeFormat'] = undefined;
...
export default BlobStreamInputDataSourceProperties;
