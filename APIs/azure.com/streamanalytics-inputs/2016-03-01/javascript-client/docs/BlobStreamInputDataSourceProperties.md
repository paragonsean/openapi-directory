# StreamAnalyticsManagementClient.BlobStreamInputDataSourceProperties

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**sourcePartitionCount** | **Number** | The partition count of the blob input data source. Range 1 - 256. | [optional] 
