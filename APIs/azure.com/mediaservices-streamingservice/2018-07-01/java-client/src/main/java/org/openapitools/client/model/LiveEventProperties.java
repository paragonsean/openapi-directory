...
public class LiveEventProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, crossSiteAccessPolicies, description, encoding, input, lastModified, preview, provisioningState, resourceState, streamOptions, vanityUrl);
  }
