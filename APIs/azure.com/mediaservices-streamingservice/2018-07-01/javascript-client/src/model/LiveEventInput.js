...
import LiveEventInputAccessControl from './LiveEventInputAccessControl';
...
class LiveEventInput {
     ...
     * @param streamingProtocol {module:model/LiveEventInput.StreamingProtocolEnum} The streaming protocol for the Live Event.  This is specified at creation time and cannot be updated.
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('accessControl')) {
                obj['accessControl'] = LiveEventInputAccessControl.constructFromObject(data['accessControl']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['accessControl']) { // data not null
          LiveEventInputAccessControl.validateJSON(data['accessControl']);
        }
...
/**
 * @member {module:model/LiveEventInputAccessControl} accessControl
 */
LiveEventInput.prototype['accessControl'] = undefined;
