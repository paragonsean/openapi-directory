...
async def test_live_events_create(client):
    ...
    Create Live Event
    """
    parameters = {"properties":{"preview":{"accessControl":{"ip":{"allow":[{"address":"address","name":"name","subnetPrefixLength":6},{"address":"address","name":"name","subnetPrefixLength":6}]}},"endpoints":[{"protocol":"protocol","url":"url"},{"protocol":"protocol","url":"url"}],"streamingPolicyName":"streamingPolicyName","previewLocator":"previewLocator"},"input":{"endpoints":[{"protocol":"protocol","url":"url"},{"protocol":"protocol","url":"url"}],"streamingProtocol":"FragmentedMP4","accessToken":"accessToken","keyFrameIntervalDuration":"keyFrameIntervalDuration"},"created":"2000-01-23T04:56:07.000+00:00","vanityUrl":True,"streamOptions":["Default","Default"],"description":"description","resourceState":"Stopped","lastModified":"2000-01-23T04:56:07.000+00:00","provisioningState":"provisioningState","encoding":{"presetName":"presetName","encodingType":"None"},"crossSiteAccessPolicies":{"crossDomainPolicy":"crossDomainPolicy","clientAccessPolicy":"clientAccessPolicy"}}}
