...
public class Hls {
  public static final String SERIALIZED_NAME_FRAGMENTS_PER_TS_SEGMENT = "fragmentsPerTsSegment";
  @SerializedName(SERIALIZED_NAME_FRAGMENTS_PER_TS_SEGMENT)
  private Integer fragmentsPerTsSegment;

  public Hls() {
  }

  public Hls fragmentsPerTsSegment(Integer fragmentsPerTsSegment) {
   ...
   * @return fragmentsPerTsSegment
   */
  @javax.annotation.Nullable
  public Integer getFragmentsPerTsSegment() {
    return fragmentsPerTsSegment;
  }

  public void setFragmentsPerTsSegment(Integer fragmentsPerTsSegment) {
    this.fragmentsPerTsSegment = fragmentsPerTsSegment;
  }
  ...
  public boolean equals(Object o) {
    ...
    Hls hls = (Hls) o;
    return Objects.equals(this.fragmentsPerTsSegment, hls.fragmentsPerTsSegment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fragmentsPerTsSegment);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hls {\n");
    sb.append("    fragmentsPerTsSegment: ").append(toIndentedString(fragmentsPerTsSegment)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("fragmentsPerTsSegment");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hls
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hls.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hls.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hls` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
