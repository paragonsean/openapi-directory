...
import LiveEventTranscription from './LiveEventTranscription';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('transcriptions')) {
                obj['transcriptions'] = ApiClient.convertToType(data['transcriptions'], [LiveEventTranscription]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['transcriptions']) { // data not null
            ...
            for (const item of data['transcriptions']) {
                LiveEventTranscription.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/LiveEventTranscription>} transcriptions
 */
LiveEventProperties.prototype['transcriptions'] = undefined;
