...
class OAILiveEventTranscription;
...
public:
    ...
    QList<OAILiveEventTranscription> getTranscriptions() const;
    void setTranscriptions(const QList<OAILiveEventTranscription> &transcriptions);
...
private:
    ...
    QList<OAILiveEventTranscription> m_transcriptions;
