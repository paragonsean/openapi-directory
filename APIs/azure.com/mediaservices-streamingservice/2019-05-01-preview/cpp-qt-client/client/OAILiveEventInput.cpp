...
OAILiveEventInputAccessControl OAILiveEventInput::getAccessControl() const {
    return m_access_control;
}
void OAILiveEventInput::setAccessControl(const OAILiveEventInputAccessControl &access_control) {
    m_access_control = access_control;
    m_access_control_isSet = true;
}

bool OAILiveEventInput::is_access_control_Set() const{
    return m_access_control_isSet;
}

bool OAILiveEventInput::is_access_control_Valid() const{
