...
public class Drive {
  ...
  public Drive properties(DriveModel properties) {
  ...
  public DriveModel getProperties() {
    return properties;
  }

  public void setProperties(DriveModel properties) {
    this.properties = properties;
  }
  ...
  public Drive location(String location) {
  ...
  public Drive tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public Drive putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    Drive drive = (Drive) o;
    return Objects.equals(this.properties, drive.properties) &&
        Objects.equals(this.id, drive.id) &&
        Objects.equals(this.location, drive.location) &&
        Objects.equals(this.name, drive.name) &&
        Objects.equals(this.tags, drive.tags) &&
        Objects.equals(this.type, drive.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        DriveModel.validateJsonElement(jsonObj.get("properties"));
      }
