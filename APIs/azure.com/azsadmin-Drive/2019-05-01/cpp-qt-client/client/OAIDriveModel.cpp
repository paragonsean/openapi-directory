...
void OAIDriveModel::initializeModel() {
    ...
    m_is_indication_enabled_isSet = false;
    m_is_indication_enabled_isValid = false;
    ...
    m_storage_pool_isSet = false;
    m_storage_pool_isValid = false;
...
void OAIDriveModel::fromJsonObject(QJsonObject json) {
    ...
    m_is_indication_enabled_isValid = ::OpenAPI::fromJsonValue(m_is_indication_enabled, json[QString("isIndicationEnabled")]);
    m_is_indication_enabled_isSet = !json[QString("isIndicationEnabled")].isNull() && m_is_indication_enabled_isValid;
    ...
    m_storage_pool_isValid = ::OpenAPI::fromJsonValue(m_storage_pool, json[QString("storagePool")]);
    m_storage_pool_isSet = !json[QString("storagePool")].isNull() && m_storage_pool_isValid;
...
QJsonObject OAIDriveModel::asJsonObject() const {
    ...
    if (m_is_indication_enabled_isSet) {
        obj.insert(QString("isIndicationEnabled"), ::OpenAPI::toJsonValue(m_is_indication_enabled));
    }
    ...
    if (m_storage_pool_isSet) {
        obj.insert(QString("storagePool"), ::OpenAPI::toJsonValue(m_storage_pool));
    }
    if (m_usage_isSet) {
...
QString OAIDriveModel::getFirmwareVersion() const {
    return m_firmware_version;
}
void OAIDriveModel::setFirmwareVersion(const QString &firmware_version) {
    m_firmware_version = firmware_version;
    m_firmware_version_isSet = true;
}

bool OAIDriveModel::is_firmware_version_Set() const{
    return m_firmware_version_isSet;
}

bool OAIDriveModel::is_firmware_version_Valid() const{
...
bool OAIDriveModel::isIsIndicationEnabled() const {
    return m_is_indication_enabled;
}
void OAIDriveModel::setIsIndicationEnabled(const bool &is_indication_enabled) {
    m_is_indication_enabled = is_indication_enabled;
    m_is_indication_enabled_isSet = true;
}

bool OAIDriveModel::is_is_indication_enabled_Set() const{
    return m_is_indication_enabled_isSet;
}

bool OAIDriveModel::is_is_indication_enabled_Valid() const{
    return m_is_indication_enabled_isValid;
}

QString OAIDriveModel::getManufacturer() const {
    return m_manufacturer;
}
void OAIDriveModel::setManufacturer(const QString &manufacturer) {
    m_manufacturer = manufacturer;
    m_manufacturer_isSet = true;
}

bool OAIDriveModel::is_manufacturer_Set() const{
    return m_manufacturer_isSet;
}

bool OAIDriveModel::is_manufacturer_Valid() const{
...
QString OAIDriveModel::getStoragePool() const {
    return m_storage_pool;
}
void OAIDriveModel::setStoragePool(const QString &storage_pool) {
    m_storage_pool = storage_pool;
    m_storage_pool_isSet = true;
}

bool OAIDriveModel::is_storage_pool_Set() const{
    return m_storage_pool_isSet;
}

bool OAIDriveModel::is_storage_pool_Valid() const{
    return m_storage_pool_isValid;
}
