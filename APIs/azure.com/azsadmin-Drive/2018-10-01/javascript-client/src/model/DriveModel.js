...
class DriveModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('canPool')) {
                obj['canPool'] = ApiClient.convertToType(data['canPool'], 'Boolean');
            }
            if (data.hasOwnProperty('cannotPoolReason')) {
                obj['cannotPoolReason'] = ApiClient.convertToType(data['cannotPoolReason'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['cannotPoolReason'] && !(typeof data['cannotPoolReason'] === 'string' || data['cannotPoolReason'] instanceof String)) {
            throw new Error("Expected the field `cannotPoolReason` to be a primitive type in the JSON string but got " + data['cannotPoolReason']);
        }
        // ensure the json data is a string
 ...
 * @member {Boolean} canPool
 */
DriveModel.prototype['canPool'] = undefined;

/**
 * Specify the reasons why the drive cannot be added to the pool.
 * @member {String} cannotPoolReason
 */
DriveModel.prototype['cannotPoolReason'] = undefined;
