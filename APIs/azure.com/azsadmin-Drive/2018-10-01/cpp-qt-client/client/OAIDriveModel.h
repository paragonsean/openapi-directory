...
public:
    ...
    bool isCanPool() const;
    void setCanPool(const bool &can_pool);
    bool is_can_pool_Set() const;
    bool is_can_pool_Valid() const;

    QString getCannotPoolReason() const;
    void setCannotPoolReason(const QString &cannot_pool_reason);
    bool is_cannot_pool_reason_Set() const;
    bool is_cannot_pool_reason_Valid() const;
...
private:
    ...
    bool m_can_pool;
    bool m_can_pool_isSet;
    bool m_can_pool_isValid;

    QString m_cannot_pool_reason;
    bool m_cannot_pool_reason_isSet;
    bool m_cannot_pool_reason_isValid;
