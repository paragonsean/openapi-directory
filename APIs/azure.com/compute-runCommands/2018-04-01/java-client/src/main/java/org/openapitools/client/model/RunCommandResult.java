 ...
 * RunCommandResult
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T10:54:42.231249-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class RunCommandResult {
  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private List<InstanceViewStatus> value = new ArrayList<>();

  public RunCommandResult() {
  }

  public RunCommandResult value(List<InstanceViewStatus> value) {
    this.value = value;
    return this;
  }

  public RunCommandResult addValueItem(InstanceViewStatus valueItem) {
    if (this.value == null) {
  ...
  public void setValue(List<InstanceViewStatus> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, runCommandResult.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            InstanceViewStatus.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
