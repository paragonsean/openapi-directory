...
class ControllerProperties {
     ...
     * @param hostSuffix {String} DNS suffix for public endpoints running in the Azure Dev Spaces Controller.
     ...
     */
    constructor(hostSuffix, targetContainerHostCredentialsBase64, targetContainerHostResourceId) { 
        
        ControllerProperties.initialize(this, hostSuffix, targetContainerHostCredentialsBase64, targetContainerHostResourceId);
    }
     ...
     */
    static initialize(obj, hostSuffix, targetContainerHostCredentialsBase64, targetContainerHostResourceId) { 
        obj['hostSuffix'] = hostSuffix;
...
ControllerProperties.RequiredProperties = ["hostSuffix", "targetContainerHostCredentialsBase64", "targetContainerHostResourceId"];
