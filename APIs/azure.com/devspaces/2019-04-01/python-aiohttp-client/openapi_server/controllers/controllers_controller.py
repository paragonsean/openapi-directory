...
async def controllers_list_connection_details(request: web.Request, api_version, subscription_id, resource_group_name, name, list_connection_details_parameters) -> web.Response:
    ...
    :param name: Name of the resource.
    :type name: str
    :param list_connection_details_parameters: Parameters for listing connection details of Azure Dev Spaces Controller.
    :type list_connection_details_parameters: dict | bytes

    """
    list_connection_details_parameters = ListConnectionDetailsParameters.from_dict(list_connection_details_parameters)
    return web.Response(status=200)
