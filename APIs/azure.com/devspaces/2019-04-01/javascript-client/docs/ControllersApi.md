...
let resourceGroupName = "resourceGroupName_example"; // String | Resource group to which the resource belongs.
let name = "name_example"; // String | Name of the resource.
let listConnectionDetailsParameters = new DevSpacesManagement.ListConnectionDetailsParameters(); // ListConnectionDetailsParameters | Parameters for listing connection details of Azure Dev Spaces Controller.
apiInstance.controllersListConnectionDetails(apiVersion, subscriptionId, resourceGroupName, name, listConnectionDetailsParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
