...
import ListConnectionDetailsParameters from '../model/ListConnectionDetailsParameters';
...
export default class ControllersApi {
    ...
    */
     ...
     * @param {String} resourceGroupName Resource group to which the resource belongs.
     * @param {String} name Name of the resource.
     * @param {module:model/ListConnectionDetailsParameters} listConnectionDetailsParameters Parameters for listing connection details of Azure Dev Spaces Controller.
     ...
     */
    controllersListConnectionDetails(apiVersion, subscriptionId, resourceGroupName, name, listConnectionDetailsParameters, callback) {
      let postBody = listConnectionDetailsParameters;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
      ...
      if (listConnectionDetailsParameters === undefined || listConnectionDetailsParameters === null) {
        throw new Error("Missing the required parameter 'listConnectionDetailsParameters' when calling controllersListConnectionDetails");
      }
