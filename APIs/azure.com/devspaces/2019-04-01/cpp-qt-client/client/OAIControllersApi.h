...
public:
    ...
    * @param[in]  resource_group_name QString [required]
    * @param[in]  name QString [required]
    * @param[in]  list_connection_details_parameters OAIListConnectionDetailsParameters [required]
    */
    virtual void controllersListConnectionDetails(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &name, const OAIListConnectionDetailsParameters &list_connection_details_parameters);
