...
public class ControllersApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 0 </td><td> Error response describing the reason for operation failure. 404 - NotFound(Azure Dev Spaces Controller doesn&#39;t exist.), 400 - BadRequest(One or more creation parameters are invalid.) </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 0 </td><td> Error response describing the reason for operation failure. 409 - Conflict(Azure Dev Spaces Controller is already getting deleted.) </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public okhttp3.Call controllersListConnectionDetailsCall(String apiVersion, String subscriptionId, String resourceGroupName, String name, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call controllersListConnectionDetailsValidateBeforeCall(String apiVersion, String subscriptionId, String resourceGroupName, String name, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
        ...
        return controllersListConnectionDetailsCall(apiVersion, subscriptionId, resourceGroupName, name, _callback);
     ...
     */
    public ControllerConnectionDetailsList controllersListConnectionDetails(String apiVersion, String subscriptionId, String resourceGroupName, String name) throws ApiException {
        ApiResponse<ControllerConnectionDetailsList> localVarResp = controllersListConnectionDetailsWithHttpInfo(apiVersion, subscriptionId, resourceGroupName, name);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ControllerConnectionDetailsList> controllersListConnectionDetailsWithHttpInfo(String apiVersion, String subscriptionId, String resourceGroupName, String name) throws ApiException {
        okhttp3.Call localVarCall = controllersListConnectionDetailsValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, name, null);
     ...
     */
    public okhttp3.Call controllersListConnectionDetailsAsync(String apiVersion, String subscriptionId, String resourceGroupName, String name, final ApiCallback<ControllerConnectionDetailsList> _callback) throws ApiException {

        okhttp3.Call localVarCall = controllersListConnectionDetailsValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, name, _callback);
        Type localVarReturnType = new TypeToken<ControllerConnectionDetailsList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
