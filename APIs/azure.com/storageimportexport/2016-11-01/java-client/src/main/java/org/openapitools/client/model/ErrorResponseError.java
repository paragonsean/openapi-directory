...
public class ErrorResponseError {
  ...
  private List<ErrorResponseErrorDetailsInner> details = new ArrayList<>();
  ...
  public ErrorResponseError details(List<ErrorResponseErrorDetailsInner> details) {
    this.details = details;
    return this;
  }

  public ErrorResponseError addDetailsItem(ErrorResponseErrorDetailsInner detailsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ErrorResponseErrorDetailsInner> getDetails() {
    return details;
  }

  public void setDetails(List<ErrorResponseErrorDetailsInner> details) {
    this.details = details;
  }


  public ErrorResponseError innererror(Object innererror) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, errorResponseError.code) &&
        ...
        Objects.equals(this.innererror, errorResponseError.innererror) &&
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            ErrorResponseErrorDetailsInner.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
