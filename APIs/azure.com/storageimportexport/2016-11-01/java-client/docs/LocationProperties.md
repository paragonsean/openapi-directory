...
|------------ | ------------- | ------------- | -------------|
|**alternateLocations** | **List&lt;String&gt;** | A list of location IDs that should be used to ship shipping drives to for jobs created against the current location. If the current location is active, it will be part of the list. If it is temporarily closed due to maintenance, this list may contain other locations.  |  [optional] |
...
|**supportedCarriers** | **List&lt;String&gt;** | A list of carriers that are supported at this location.  |  [optional] |
