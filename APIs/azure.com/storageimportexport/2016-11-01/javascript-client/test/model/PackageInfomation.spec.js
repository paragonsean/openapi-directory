...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageImportExport.PackageInfomation();
  });
  ...
  describe('PackageInfomation', function() {
    it('should create an instance of PackageInfomation', function() {
      // uncomment below and update the code to test PackageInfomation
      //var instance = new StorageImportExport.PackageInfomation();
      //expect(instance).to.be.a(StorageImportExport.PackageInfomation);
    });
    ...
    it('should have the property driveCount (base name: "driveCount")', function() {
      // uncomment below and update the code to test the property driveCount
      //var instance = new StorageImportExport.PackageInfomation();
      //expect(instance).to.be();
    });
