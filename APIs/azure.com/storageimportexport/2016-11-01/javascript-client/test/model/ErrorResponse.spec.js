...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageImportExport.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new StorageImportExport.ErrorResponse();
      //expect(instance).to.be.a(StorageImportExport.ErrorResponse);
    });
