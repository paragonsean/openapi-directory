...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageImportExport.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new StorageImportExport.OperationDisplay();
      //expect(instance).to.be.a(StorageImportExport.OperationDisplay);
    });
