# StorageImportExport.JobDetails
...
**driveList** | [**[DriveStatus]**](DriveStatus.md) | List of up to ten drives that comprise the job. The drive list is a required element for an import job; it is not specified for export jobs. | [optional] 
...
**percentComplete** | **Number** | Overall percentage completed for the job. | [optional] 
