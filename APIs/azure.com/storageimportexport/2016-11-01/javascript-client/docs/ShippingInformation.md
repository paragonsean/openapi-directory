# StorageImportExport.ShippingInformation
...
**phone** | **String** | Phone number of the recipient of the returned drives. | [optional] 
...
**streetAddress2** | **String** | The second line of the street address to use when returning the drives.  | [optional] 
