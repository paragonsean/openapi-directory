...
> [String] applicationGatewaysListAvailableRequestHeaders(opts)
...
apiInstance.applicationGatewaysListAvailableRequestHeaders(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [String] applicationGatewaysListAvailableResponseHeaders(opts)
...
apiInstance.applicationGatewaysListAvailableResponseHeaders(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [String] applicationGatewaysListAvailableServerVariables(opts)
...
apiInstance.applicationGatewaysListAvailableServerVariables(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> applicationGatewaysStart(resourceGroupName, applicationGatewayName, opts)
...
apiInstance.applicationGatewaysStart(resourceGroupName, applicationGatewayName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
