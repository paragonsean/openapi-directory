...
QString OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_virtualNetworkTaps_inner_properties_destinationLoadBalancerFrontEndIPConfiguration_properties::getPrivateIpAllocationMethod() const {
    return m_private_ip_allocation_method;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_virtualNetworkTaps_inner_properties_destinationLoadBalancerFrontEndIPConfiguration_properties::setPrivateIpAllocationMethod(const QString &private_ip_allocation_method) {
