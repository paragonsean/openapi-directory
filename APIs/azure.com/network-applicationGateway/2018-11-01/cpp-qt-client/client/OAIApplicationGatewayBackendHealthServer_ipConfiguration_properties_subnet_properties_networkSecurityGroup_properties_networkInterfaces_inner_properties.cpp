...
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::initializeModel() {
    ...
    m_hosted_workloads_isSet = false;
    m_hosted_workloads_isValid = false;

    m_interface_endpoint_isSet = false;
    m_interface_endpoint_isValid = false;
    ...
    m_tap_configurations_isSet = false;
    m_tap_configurations_isValid = false;
...
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::fromJsonObject(QJsonObject json) {
    ...
    m_hosted_workloads_isValid = ::OpenAPI::fromJsonValue(m_hosted_workloads, json[QString("hostedWorkloads")]);
    m_hosted_workloads_isSet = !json[QString("hostedWorkloads")].isNull() && m_hosted_workloads_isValid;

    m_interface_endpoint_isValid = ::OpenAPI::fromJsonValue(m_interface_endpoint, json[QString("interfaceEndpoint")]);
    m_interface_endpoint_isSet = !json[QString("interfaceEndpoint")].isNull() && m_interface_endpoint_isValid;
    ...
    m_tap_configurations_isValid = ::OpenAPI::fromJsonValue(m_tap_configurations, json[QString("tapConfigurations")]);
    m_tap_configurations_isSet = !json[QString("tapConfigurations")].isNull() && m_tap_configurations_isValid;
...
QJsonObject OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::asJsonObject() const {
    ...
    if (m_hosted_workloads.size() > 0) {
        obj.insert(QString("hostedWorkloads"), ::OpenAPI::toJsonValue(m_hosted_workloads));
    }
    if (m_interface_endpoint.isSet()) {
        obj.insert(QString("interfaceEndpoint"), ::OpenAPI::toJsonValue(m_interface_endpoint));
    }
    ...
    if (m_tap_configurations.size() > 0) {
        obj.insert(QString("tapConfigurations"), ::OpenAPI::toJsonValue(m_tap_configurations));
    }
...
QList<QString> OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::getHostedWorkloads() const {
    return m_hosted_workloads;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::setHostedWorkloads(const QList<QString> &hosted_workloads) {
    m_hosted_workloads = hosted_workloads;
    m_hosted_workloads_isSet = true;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_hosted_workloads_Set() const{
    return m_hosted_workloads_isSet;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_hosted_workloads_Valid() const{
    return m_hosted_workloads_isValid;
}

OAIItems OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::getInterfaceEndpoint() const {
    return m_interface_endpoint;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::setInterfaceEndpoint(const OAIItems &interface_endpoint) {
    m_interface_endpoint = interface_endpoint;
    m_interface_endpoint_isSet = true;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_interface_endpoint_Set() const{
    return m_interface_endpoint_isSet;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_interface_endpoint_Valid() const{
    return m_interface_endpoint_isValid;
}

QList<OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties_ipConfigurations_inner> OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::getIpConfigurations() const {
...
QList<OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties_tapConfigurations_inner> OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::getTapConfigurations() const {
    return m_tap_configurations;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::setTapConfigurations(const QList<OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties_tapConfigurations_inner> &tap_configurations) {
    m_tap_configurations = tap_configurations;
    m_tap_configurations_isSet = true;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_tap_configurations_Set() const{
    return m_tap_configurations_isSet;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_tap_configurations_Valid() const{
    return m_tap_configurations_isValid;
}
