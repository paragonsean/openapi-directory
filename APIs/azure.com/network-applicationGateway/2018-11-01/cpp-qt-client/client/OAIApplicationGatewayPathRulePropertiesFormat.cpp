...
OAI0 OAIApplicationGatewayPathRulePropertiesFormat::getRewriteRuleSet() const {
    return m_rewrite_rule_set;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setRewriteRuleSet(const OAI0 &rewrite_rule_set) {
