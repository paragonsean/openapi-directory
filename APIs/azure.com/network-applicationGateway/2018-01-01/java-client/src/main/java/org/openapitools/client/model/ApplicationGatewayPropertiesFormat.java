...
public class ApplicationGatewayPropertiesFormat {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationCertificates, backendAddressPools, backendHttpSettingsCollection, enableHttp2, frontendIPConfigurations, frontendPorts, gatewayIPConfigurations, httpListeners, operationalState, probes, provisioningState, redirectConfigurations, requestRoutingRules, resourceGuid, sku, sslCertificates, sslPolicy, urlPathMaps, webApplicationFirewallConfiguration);
  }
