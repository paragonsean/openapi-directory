...
class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInnerProperties(Model):
    ...
    def __init__(self, application_gateway_backend_address_pools: List[Items]=None, application_security_groups: List[Items]=None, load_balancer_backend_address_pools: List[Items]=None, load_balancer_inbound_nat_rules: List[Items]=None, primary: bool=None, private_ip_address: str=None, private_ip_address_version: str=None, private_ip_allocation_method: str=None, provisioning_state: str=None, public_ip_address: PublicIPAddress=None, subnet: Subnet=None):
        ...
        :param application_security_groups: The application_security_groups of this ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInnerProperties.
        ...
        self.openapi_types = {
            ...
            'application_security_groups': List[Items],
    ...
    def application_security_groups(self):
        """Gets the application_security_groups of this ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInnerProperties.

        Application security groups in which the IP configuration is included.

        :return: The application_security_groups of this ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInnerProperties.
        :rtype: List[Items]
        """
    ...
    def application_security_groups(self, application_security_groups):
        """Sets the application_security_groups of this ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInnerProperties.

        Application security groups in which the IP configuration is included.

        :param application_security_groups: The application_security_groups of this ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInnerProperties.
        :type application_security_groups: List[Items]
        """
