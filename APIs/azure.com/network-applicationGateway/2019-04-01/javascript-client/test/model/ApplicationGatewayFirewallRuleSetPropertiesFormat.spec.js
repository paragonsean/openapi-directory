...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.ApplicationGatewayFirewallRuleSetPropertiesFormat();
  });
  ...
  describe('ApplicationGatewayFirewallRuleSetPropertiesFormat', function() {
    it('should create an instance of ApplicationGatewayFirewallRuleSetPropertiesFormat', function() {
      // uncomment below and update the code to test ApplicationGatewayFirewallRuleSetPropertiesFormat
      //var instance = new NetworkManagementClient.ApplicationGatewayFirewallRuleSetPropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.ApplicationGatewayFirewallRuleSetPropertiesFormat);
    });
