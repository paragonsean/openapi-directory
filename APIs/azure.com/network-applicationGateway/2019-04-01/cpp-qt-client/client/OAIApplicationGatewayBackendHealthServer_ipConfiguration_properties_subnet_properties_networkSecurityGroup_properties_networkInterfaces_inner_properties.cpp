...
OAIItems OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::getPrivateEndpoint() const {
    return m_private_endpoint;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::setPrivateEndpoint(const OAIItems &private_endpoint) {
    m_private_endpoint = private_endpoint;
    m_private_endpoint_isSet = true;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_private_endpoint_Set() const{
    return m_private_endpoint_isSet;
}

bool OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_subnet_properties_networkSecurityGroup_properties_networkInterfaces_inner_properties::is_private_endpoint_Valid() const{
