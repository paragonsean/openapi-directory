...
OAIPrivateIPAddressVersion OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_publicIPAddress_properties::getPublicIpAddressVersion() const {
    return m_public_ip_address_version;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_publicIPAddress_properties::setPublicIpAddressVersion(const OAIPrivateIPAddressVersion &public_ip_address_version) {
...
OAIPrivateIPAllocationMethod OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_publicIPAddress_properties::getPublicIpAllocationMethod() const {
    return m_public_ip_allocation_method;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_publicIPAddress_properties::setPublicIpAllocationMethod(const OAIPrivateIPAllocationMethod &public_ip_allocation_method) {
