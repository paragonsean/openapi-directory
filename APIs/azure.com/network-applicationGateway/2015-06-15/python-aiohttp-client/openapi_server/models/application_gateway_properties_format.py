...
class ApplicationGatewayPropertiesFormat(Model):
    ...
    def __init__(self, backend_address_pools: List[object]=None, backend_http_settings_collection: List[object]=None, frontend_ip_configurations: List[object]=None, frontend_ports: List[object]=None, gateway_ip_configurations: List[object]=None, http_listeners: List[ApplicationGatewayHttpListener]=None, operational_state: str=None, probes: List[object]=None, provisioning_state: str=None, request_routing_rules: List[object]=None, resource_guid: str=None, sku: ApplicationGatewaySku=None, ssl_certificates: List[object]=None, url_path_maps: List[object]=None):
