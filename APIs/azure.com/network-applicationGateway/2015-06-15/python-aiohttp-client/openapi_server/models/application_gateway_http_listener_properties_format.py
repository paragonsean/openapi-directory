...
class ApplicationGatewayHttpListenerPropertiesFormat(Model):
    ...
    def __init__(self, frontend_ip_configuration: Model0=None, frontend_port: Model0=None, host_name: str=None, protocol: str=None, provisioning_state: str=None, require_server_name_indication: bool=None, ssl_certificate: Model0=None):
        ...
        self.openapi_types = {
            ...
            'frontend_port': Model0,
            'host_name': str,
            'protocol': str,
            'provisioning_state': str,
            'require_server_name_indication': bool,
            'ssl_certificate': Model0
        }
