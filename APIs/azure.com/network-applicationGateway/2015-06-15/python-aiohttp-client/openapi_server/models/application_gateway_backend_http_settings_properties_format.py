...
class ApplicationGatewayBackendHttpSettingsPropertiesFormat(Model):
    ...
    def __init__(self, cookie_based_affinity: str=None, port: int=None, probe: Model0=None, protocol: str=None, provisioning_state: str=None, request_timeout: int=None):
