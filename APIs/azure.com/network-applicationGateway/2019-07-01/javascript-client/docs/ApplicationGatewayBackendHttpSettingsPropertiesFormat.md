...
**authenticationCertificates** | [**[ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet]**](ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.md) | Array of references to application gateway authentication certificates. | [optional] 
...
**trustedRootCertificates** | [**[ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet]**](ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.md) | Array of references to application gateway trusted root certificates. | [optional] 
