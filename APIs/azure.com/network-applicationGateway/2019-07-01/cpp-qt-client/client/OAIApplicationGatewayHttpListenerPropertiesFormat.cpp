...
QList<OAIApplicationGatewayCustomError> OAIApplicationGatewayHttpListenerPropertiesFormat::getCustomErrorConfigurations() const {
    return m_custom_error_configurations;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setCustomErrorConfigurations(const QList<OAIApplicationGatewayCustomError> &custom_error_configurations) {
    m_custom_error_configurations = custom_error_configurations;
    m_custom_error_configurations_isSet = true;
}

bool OAIApplicationGatewayHttpListenerPropertiesFormat::is_custom_error_configurations_Set() const{
    return m_custom_error_configurations_isSet;
}

bool OAIApplicationGatewayHttpListenerPropertiesFormat::is_custom_error_configurations_Valid() const{
    return m_custom_error_configurations_isValid;
}

OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayHttpListenerPropertiesFormat::getFrontendIpConfiguration() const {
    return m_frontend_ip_configuration;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setFrontendIpConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &frontend_ip_configuration) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayHttpListenerPropertiesFormat::getFrontendPort() const {
    return m_frontend_port;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setFrontendPort(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &frontend_port) {
...
OAIApplicationGatewayProtocol OAIApplicationGatewayHttpListenerPropertiesFormat::getProtocol() const {
    return m_protocol;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setProtocol(const OAIApplicationGatewayProtocol &protocol) {
    m_protocol = protocol;
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayHttpListenerPropertiesFormat::getSslCertificate() const {
    return m_ssl_certificate;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setSslCertificate(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &ssl_certificate) {
