...
OAI0 OAIApplicationGatewayPathRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendAddressPool(const OAI0 &backend_address_pool) {
...
OAI0 OAIApplicationGatewayPathRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendHttpSettings(const OAI0 &backend_http_settings) {
...
OAI0 OAIApplicationGatewayPathRulePropertiesFormat::getRedirectConfiguration() const {
    return m_redirect_configuration;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setRedirectConfiguration(const OAI0 &redirect_configuration) {
