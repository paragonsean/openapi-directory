...
OAI0 OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setPublicIpAddress(const OAI0 &public_ip_address) {
...
OAI0 OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setSubnet(const OAI0 &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
