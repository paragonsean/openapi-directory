...
OAIProvisioningState OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_virtualNetworkTaps_inner_properties_destinationLoadBalancerFrontEndIPConfiguration_properties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_virtualNetworkTaps_inner_properties_destinationLoadBalancerFrontEndIPConfiguration_properties::setProvisioningState(const OAIProvisioningState &provisioning_state) {
