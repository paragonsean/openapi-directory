...
qint32 OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getPriority() const {
    return m_priority;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIApplicationGatewayRequestRoutingRulePropertiesFormat::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIApplicationGatewayRequestRoutingRulePropertiesFormat::is_priority_Valid() const{
