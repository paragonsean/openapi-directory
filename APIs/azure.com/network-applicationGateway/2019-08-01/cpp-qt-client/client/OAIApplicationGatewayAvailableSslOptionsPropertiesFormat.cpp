...
QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> OAIApplicationGatewayAvailableSslOptionsPropertiesFormat::getPredefinedPolicies() const {
    return m_predefined_policies;
}
void OAIApplicationGatewayAvailableSslOptionsPropertiesFormat::setPredefinedPolicies(const QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> &predefined_policies) {
