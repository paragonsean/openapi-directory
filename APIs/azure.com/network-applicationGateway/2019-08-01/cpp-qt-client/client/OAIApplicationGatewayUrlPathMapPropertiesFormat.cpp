...
void OAIApplicationGatewayUrlPathMapPropertiesFormat::initializeModel() {
    ...
    m_default_rewrite_rule_set_isSet = false;
    m_default_rewrite_rule_set_isValid = false;
...
void OAIApplicationGatewayUrlPathMapPropertiesFormat::fromJsonObject(QJsonObject json) {
    ...
    m_default_rewrite_rule_set_isValid = ::OpenAPI::fromJsonValue(m_default_rewrite_rule_set, json[QString("defaultRewriteRuleSet")]);
    m_default_rewrite_rule_set_isSet = !json[QString("defaultRewriteRuleSet")].isNull() && m_default_rewrite_rule_set_isValid;
...
QJsonObject OAIApplicationGatewayUrlPathMapPropertiesFormat::asJsonObject() const {
    ...
    if (m_default_rewrite_rule_set.isSet()) {
        obj.insert(QString("defaultRewriteRuleSet"), ::OpenAPI::toJsonValue(m_default_rewrite_rule_set));
    }
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendAddressPool() const {
    return m_default_backend_address_pool;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendAddressPool(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &default_backend_address_pool) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendHttpSettings() const {
    return m_default_backend_http_settings;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendHttpSettings(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &default_backend_http_settings) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultRedirectConfiguration() const {
    return m_default_redirect_configuration;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultRedirectConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &default_redirect_configuration) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultRewriteRuleSet() const {
    return m_default_rewrite_rule_set;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultRewriteRuleSet(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &default_rewrite_rule_set) {
    m_default_rewrite_rule_set = default_rewrite_rule_set;
    m_default_rewrite_rule_set_isSet = true;
}

bool OAIApplicationGatewayUrlPathMapPropertiesFormat::is_default_rewrite_rule_set_Set() const{
    return m_default_rewrite_rule_set_isSet;
}

bool OAIApplicationGatewayUrlPathMapPropertiesFormat::is_default_rewrite_rule_set_Valid() const{
    return m_default_rewrite_rule_set_isValid;
}

QList<OAIObject> OAIApplicationGatewayUrlPathMapPropertiesFormat::getPathRules() const {
    return m_path_rules;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setPathRules(const QList<OAIObject> &path_rules) {
