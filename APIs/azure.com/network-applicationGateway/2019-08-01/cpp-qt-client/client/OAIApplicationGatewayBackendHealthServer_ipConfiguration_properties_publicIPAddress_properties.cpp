...
OAIProvisioningState OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_publicIPAddress_properties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIApplicationGatewayBackendHealthServer_ipConfiguration_properties_publicIPAddress_properties::setProvisioningState(const OAIProvisioningState &provisioning_state) {
