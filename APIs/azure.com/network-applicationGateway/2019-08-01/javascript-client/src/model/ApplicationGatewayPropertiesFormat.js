...
class ApplicationGatewayPropertiesFormat {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('firewallPolicy')) {
                obj['firewallPolicy'] = ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.constructFromObject(data['firewallPolicy']);
            }
            ...
            if (data.hasOwnProperty('rewriteRuleSets')) {
                obj['rewriteRuleSets'] = ApiClient.convertToType(data['rewriteRuleSets'], [Object]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['firewallPolicy']) { // data not null
          ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.validateJSON(data['firewallPolicy']);
        }
        ...
        if (data['rewriteRuleSets']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['rewriteRuleSets'])) {
                throw new Error("Expected the field `rewriteRuleSets` to be an array in the JSON data but got " + data['rewriteRuleSets']);
            }
            // validate the optional field `rewriteRuleSets` (array)
            for (const item of data['rewriteRuleSets']) {
                Object.validateJSON(item);
            };
        }
...
/**
 * @member {module:model/ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet} firewallPolicy
 */
ApplicationGatewayPropertiesFormat.prototype['firewallPolicy'] = undefined;
 ...
 * @member {module:model/ApplicationGatewayPropertiesFormat.ProvisioningStateEnum} provisioningState
 */
 ...
 * @member {Array.<Object>} rewriteRuleSets
 */
ApplicationGatewayPropertiesFormat.prototype['rewriteRuleSets'] = undefined;
 ...
 * @readonly
 */
ApplicationGatewayPropertiesFormat['ProvisioningStateEnum'] = {
