...
------------ | ------------- | ------------- | -------------
**backendIPConfiguration** | [**DestinationNetworkInterfaceIPConfiguration**](DestinationNetworkInterfaceIPConfiguration.md) |  | [optional] 
...
**protocol** | **String** | The transport protocol for the endpoint. | [optional] 
