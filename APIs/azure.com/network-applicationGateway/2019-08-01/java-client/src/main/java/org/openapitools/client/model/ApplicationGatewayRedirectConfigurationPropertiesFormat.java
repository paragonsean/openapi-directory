...
public class ApplicationGatewayRedirectConfigurationPropertiesFormat {
  ...
  private List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> pathRules = new ArrayList<>();
  ...
  private List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> requestRoutingRules = new ArrayList<>();

  public static final String SERIALIZED_NAME_TARGET_LISTENER = "targetListener";
  @SerializedName(SERIALIZED_NAME_TARGET_LISTENER)
  private ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet targetListener;
  ...
  private List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> urlPathMaps = new ArrayList<>();
  ...
  public ApplicationGatewayRedirectConfigurationPropertiesFormat pathRules(List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> pathRules) {
    this.pathRules = pathRules;
    return this;
  }

  public ApplicationGatewayRedirectConfigurationPropertiesFormat addPathRulesItem(ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet pathRulesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> getPathRules() {
    return pathRules;
  }

  public void setPathRules(List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> pathRules) {
    this.pathRules = pathRules;
  }
  ...
  public ApplicationGatewayRedirectConfigurationPropertiesFormat requestRoutingRules(List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> requestRoutingRules) {
    this.requestRoutingRules = requestRoutingRules;
    return this;
  }

  public ApplicationGatewayRedirectConfigurationPropertiesFormat addRequestRoutingRulesItem(ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet requestRoutingRulesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> getRequestRoutingRules() {
    return requestRoutingRules;
  }

  public void setRequestRoutingRules(List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> requestRoutingRules) {
    this.requestRoutingRules = requestRoutingRules;
  }


  public ApplicationGatewayRedirectConfigurationPropertiesFormat targetListener(ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet targetListener) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet getTargetListener() {
    return targetListener;
  }

  public void setTargetListener(ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet targetListener) {
    this.targetListener = targetListener;
  }
  ...
  public ApplicationGatewayRedirectConfigurationPropertiesFormat urlPathMaps(List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> urlPathMaps) {
    this.urlPathMaps = urlPathMaps;
    return this;
  }

  public ApplicationGatewayRedirectConfigurationPropertiesFormat addUrlPathMapsItem(ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet urlPathMapsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> getUrlPathMaps() {
    return urlPathMaps;
  }

  public void setUrlPathMaps(List<ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet> urlPathMaps) {
    this.urlPathMaps = urlPathMaps;
  }
      ...
      if (jsonObj.get("pathRules") != null && !jsonObj.get("pathRules").isJsonNull()) {
        ...
        if (jsonArraypathRules != null) {
          ...
          for (int i = 0; i < jsonArraypathRules.size(); i++) {
            ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.validateJsonElement(jsonArraypathRules.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("requestRoutingRules") != null && !jsonObj.get("requestRoutingRules").isJsonNull()) {
        ...
        if (jsonArrayrequestRoutingRules != null) {
          ...
          for (int i = 0; i < jsonArrayrequestRoutingRules.size(); i++) {
            ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.validateJsonElement(jsonArrayrequestRoutingRules.get(i));
          };
        }
      }
      // validate the optional field `targetListener`
      if (jsonObj.get("targetListener") != null && !jsonObj.get("targetListener").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.validateJsonElement(jsonObj.get("targetListener"));
      }
      ...
      if (jsonObj.get("urlPathMaps") != null && !jsonObj.get("urlPathMaps").isJsonNull()) {
        ...
        if (jsonArrayurlPathMaps != null) {
          ...
          for (int i = 0; i < jsonArrayurlPathMaps.size(); i++) {
            ApplicationGatewayPathRulePropertiesFormatRewriteRuleSet.validateJsonElement(jsonArrayurlPathMaps.get(i));
          };
        }
      }
  }
