...
public class ApplicationGatewayBackendHealthServer {
  ...
  public static final String SERIALIZED_NAME_HEALTH_PROBE_LOG = "healthProbeLog";
  @SerializedName(SERIALIZED_NAME_HEALTH_PROBE_LOG)
  ...
  public ApplicationGatewayBackendHealthServer healthProbeLog(String healthProbeLog) {
  ...
  public void setHealthProbeLog(String healthProbeLog) {
    this.healthProbeLog = healthProbeLog;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, applicationGatewayBackendHealthServer.address) &&
        ...
        Objects.equals(this.healthProbeLog, applicationGatewayBackendHealthServer.healthProbeLog) &&
        Objects.equals(this.ipConfiguration, applicationGatewayBackendHealthServer.ipConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, health, healthProbeLog, ipConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("    healthProbeLog: ").append(toIndentedString(healthProbeLog)).append("\n");
  ...
  static {
    ...
    openapiFields.add("healthProbeLog");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("healthProbeLog") != null && !jsonObj.get("healthProbeLog").isJsonNull()) && !jsonObj.get("healthProbeLog").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `healthProbeLog` to be a primitive type in the JSON string but got `%s`", jsonObj.get("healthProbeLog").toString()));
      }
