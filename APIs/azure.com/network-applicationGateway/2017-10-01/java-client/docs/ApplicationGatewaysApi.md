...
> ApplicationGateway applicationGatewaysUpdateTags(resourceGroupName, applicationGatewayName, apiVersion, subscriptionId, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApplicationGateway result = apiInstance.applicationGatewaysUpdateTags(resourceGroupName, applicationGatewayName, apiVersion, subscriptionId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
