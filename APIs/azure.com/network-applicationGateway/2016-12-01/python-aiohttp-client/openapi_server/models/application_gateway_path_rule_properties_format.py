...
class ApplicationGatewayPathRulePropertiesFormat(Model):
    ...
    def __init__(self, backend_address_pool: ApplicationGatewayHttpListenerPropertiesFormatFrontendPort=None, backend_http_settings: ApplicationGatewayHttpListenerPropertiesFormatFrontendPort=None, paths: List[str]=None, provisioning_state: str=None):
