...
public class ApplicationGatewayHttpListenerPropertiesFormat {
  ...
  private ApplicationGatewayHttpListenerPropertiesFormatFrontendPort frontendIPConfiguration;

  public static final String SERIALIZED_NAME_FRONTEND_PORT = "frontendPort";
  @SerializedName(SERIALIZED_NAME_FRONTEND_PORT)
  private ApplicationGatewayHttpListenerPropertiesFormatFrontendPort frontendPort;
  ...
  private ApplicationGatewayHttpListenerPropertiesFormatFrontendPort sslCertificate;

  public ApplicationGatewayHttpListenerPropertiesFormat() {
  }

  public ApplicationGatewayHttpListenerPropertiesFormat frontendIPConfiguration(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort frontendIPConfiguration) {
  ...
  public ApplicationGatewayHttpListenerPropertiesFormatFrontendPort getFrontendIPConfiguration() {
    return frontendIPConfiguration;
  }

  public void setFrontendIPConfiguration(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort frontendIPConfiguration) {
    this.frontendIPConfiguration = frontendIPConfiguration;
  }


  public ApplicationGatewayHttpListenerPropertiesFormat frontendPort(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort frontendPort) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayHttpListenerPropertiesFormatFrontendPort getFrontendPort() {
    return frontendPort;
  }

  public void setFrontendPort(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort frontendPort) {
    this.frontendPort = frontendPort;
  }
  ...
  public ApplicationGatewayHttpListenerPropertiesFormat sslCertificate(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort sslCertificate) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayHttpListenerPropertiesFormatFrontendPort getSslCertificate() {
    return sslCertificate;
  }

  public void setSslCertificate(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort sslCertificate) {
    this.sslCertificate = sslCertificate;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("frontendIPConfiguration") != null && !jsonObj.get("frontendIPConfiguration").isJsonNull()) {
        ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.validateJsonElement(jsonObj.get("frontendIPConfiguration"));
      }
      // validate the optional field `frontendPort`
      if (jsonObj.get("frontendPort") != null && !jsonObj.get("frontendPort").isJsonNull()) {
        ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.validateJsonElement(jsonObj.get("frontendPort"));
      }
      ...
      if (jsonObj.get("sslCertificate") != null && !jsonObj.get("sslCertificate").isJsonNull()) {
        ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.validateJsonElement(jsonObj.get("sslCertificate"));
      }
  }
