...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setPublicIpAddress(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &public_ip_address) {
...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setSubnet(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
