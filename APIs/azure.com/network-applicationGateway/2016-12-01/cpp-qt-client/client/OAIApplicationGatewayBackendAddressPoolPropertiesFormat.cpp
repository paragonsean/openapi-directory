...
QList<OAIApplicationGatewayBackendAddressPoolPropertiesFormat_backendIPConfigurations_inner> OAIApplicationGatewayBackendAddressPoolPropertiesFormat::getBackendIpConfigurations() const {
    return m_backend_ip_configurations;
}
void OAIApplicationGatewayBackendAddressPoolPropertiesFormat::setBackendIpConfigurations(const QList<OAIApplicationGatewayBackendAddressPoolPropertiesFormat_backendIPConfigurations_inner> &backend_ip_configurations) {
