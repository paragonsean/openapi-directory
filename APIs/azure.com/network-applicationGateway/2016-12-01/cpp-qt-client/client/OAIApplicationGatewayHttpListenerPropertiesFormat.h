...
public:
    ...
    OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort getFrontendIpConfiguration() const;
    void setFrontendIpConfiguration(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &frontend_ip_configuration);
    bool is_frontend_ip_configuration_Set() const;
    bool is_frontend_ip_configuration_Valid() const;

    OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort getFrontendPort() const;
    void setFrontendPort(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &frontend_port);
    ...
    OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort getSslCertificate() const;
    void setSslCertificate(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &ssl_certificate);
...
private:
    ...
    OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort m_frontend_ip_configuration;
    bool m_frontend_ip_configuration_isSet;
    bool m_frontend_ip_configuration_isValid;

    OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort m_frontend_port;
    ...
    OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort m_ssl_certificate;
