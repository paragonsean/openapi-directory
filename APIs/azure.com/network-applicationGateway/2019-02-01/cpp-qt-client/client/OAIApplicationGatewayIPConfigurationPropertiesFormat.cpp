...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayIPConfigurationPropertiesFormat::setSubnet(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
