...
public:
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet getFrontendIpConfiguration() const;
    void setFrontendIpConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &frontend_ip_configuration);
    bool is_frontend_ip_configuration_Set() const;
    bool is_frontend_ip_configuration_Valid() const;

    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet getFrontendPort() const;
    void setFrontendPort(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &frontend_port);
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet getSslCertificate() const;
    void setSslCertificate(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &ssl_certificate);
...
private:
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet m_frontend_ip_configuration;
    bool m_frontend_ip_configuration_isSet;
    bool m_frontend_ip_configuration_isValid;

    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet m_frontend_port;
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet m_ssl_certificate;
