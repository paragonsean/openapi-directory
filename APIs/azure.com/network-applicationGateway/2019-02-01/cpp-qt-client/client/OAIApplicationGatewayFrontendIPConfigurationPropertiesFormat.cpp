...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setPublicIpAddress(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &public_ip_address) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setSubnet(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
