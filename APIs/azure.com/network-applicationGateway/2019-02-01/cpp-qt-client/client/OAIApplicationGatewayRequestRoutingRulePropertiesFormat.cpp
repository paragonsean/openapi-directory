...
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::initializeModel() {
    ...
    m_rewrite_rule_set_isSet = false;
    m_rewrite_rule_set_isValid = false;
...
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::fromJsonObject(QJsonObject json) {
    ...
    m_rewrite_rule_set_isValid = ::OpenAPI::fromJsonValue(m_rewrite_rule_set, json[QString("rewriteRuleSet")]);
    m_rewrite_rule_set_isSet = !json[QString("rewriteRuleSet")].isNull() && m_rewrite_rule_set_isValid;
...
QJsonObject OAIApplicationGatewayRequestRoutingRulePropertiesFormat::asJsonObject() const {
    ...
    if (m_rewrite_rule_set.isSet()) {
        obj.insert(QString("rewriteRuleSet"), ::OpenAPI::toJsonValue(m_rewrite_rule_set));
    }
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendAddressPool(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &backend_address_pool) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendHttpSettings(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &backend_http_settings) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getHttpListener() const {
    return m_http_listener;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setHttpListener(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &http_listener) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getRedirectConfiguration() const {
    return m_redirect_configuration;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setRedirectConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &redirect_configuration) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getRewriteRuleSet() const {
    return m_rewrite_rule_set;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setRewriteRuleSet(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &rewrite_rule_set) {
    m_rewrite_rule_set = rewrite_rule_set;
    m_rewrite_rule_set_isSet = true;
}

bool OAIApplicationGatewayRequestRoutingRulePropertiesFormat::is_rewrite_rule_set_Set() const{
    return m_rewrite_rule_set_isSet;
}

bool OAIApplicationGatewayRequestRoutingRulePropertiesFormat::is_rewrite_rule_set_Valid() const{
    return m_rewrite_rule_set_isValid;
}
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getUrlPathMap() const {
    return m_url_path_map;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setUrlPathMap(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &url_path_map) {
