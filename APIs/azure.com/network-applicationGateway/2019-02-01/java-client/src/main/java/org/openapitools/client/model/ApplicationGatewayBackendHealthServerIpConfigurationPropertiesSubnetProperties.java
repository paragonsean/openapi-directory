...
import org.openapitools.client.model.ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesInterfaceEndpointsInner;
...
public class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties {
  ...
  public static final String SERIALIZED_NAME_INTERFACE_ENDPOINTS = "interfaceEndpoints";
  @SerializedName(SERIALIZED_NAME_INTERFACE_ENDPOINTS)
  private List<ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesInterfaceEndpointsInner> interfaceEndpoints = new ArrayList<>();
  ...
  public ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties(
     List<ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesInterfaceEndpointsInner> interfaceEndpoints, 
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesInterfaceEndpointsInner> getInterfaceEndpoints() {
    return interfaceEndpoints;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressPrefix, applicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties.addressPrefix) &&
        ...
        Objects.equals(this.interfaceEndpoints, applicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties.interfaceEndpoints) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressPrefix, addressPrefixes, delegations, interfaceEndpoints, ipConfigurationProfiles, ipConfigurations, natGateway, networkSecurityGroup, provisioningState, purpose, resourceNavigationLinks, routeTable, serviceAssociationLinks, serviceEndpointPolicies, serviceEndpoints);
  }
  ...
  public String toString() {
    ...
    sb.append("    interfaceEndpoints: ").append(toIndentedString(interfaceEndpoints)).append("\n");
  ...
  static {
    ...
    openapiFields.add("interfaceEndpoints");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("interfaceEndpoints") != null && !jsonObj.get("interfaceEndpoints").isJsonNull()) {
        JsonArray jsonArrayinterfaceEndpoints = jsonObj.getAsJsonArray("interfaceEndpoints");
        if (jsonArrayinterfaceEndpoints != null) {
          // ensure the json data is an array
          if (!jsonObj.get("interfaceEndpoints").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `interfaceEndpoints` to be an array in the JSON string but got `%s`", jsonObj.get("interfaceEndpoints").toString()));
          }

          // validate the optional field `interfaceEndpoints` (array)
          for (int i = 0; i < jsonArrayinterfaceEndpoints.size(); i++) {
            ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetPropertiesInterfaceEndpointsInner.validateJsonElement(jsonArrayinterfaceEndpoints.get(i));
          };
        }
      }
