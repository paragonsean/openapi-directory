...
public class ApplicationGatewaysApi {
     ...
     */
    public okhttp3.Call applicationGatewaysBackendHealthCall(String resourceGroupName, String applicationGatewayName,  UNKNOWN_PARAMETER_NAME,  UNKNOWN_PARAMETER_NAME2, String $expand, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call applicationGatewaysBackendHealthValidateBeforeCall(String resourceGroupName, String applicationGatewayName,  UNKNOWN_PARAMETER_NAME,  UNKNOWN_PARAMETER_NAME2, String $expand, final ApiCallback _callback) throws ApiException {
        ...
        return applicationGatewaysBackendHealthCall(resourceGroupName, applicationGatewayName, UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, $expand, _callback);
     ...
     */
    public ApplicationGatewayBackendHealth applicationGatewaysBackendHealth(String resourceGroupName, String applicationGatewayName,  UNKNOWN_PARAMETER_NAME,  UNKNOWN_PARAMETER_NAME2, String $expand) throws ApiException {
        ApiResponse<ApplicationGatewayBackendHealth> localVarResp = applicationGatewaysBackendHealthWithHttpInfo(resourceGroupName, applicationGatewayName, UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, $expand);
     ...
     */
    public ApiResponse<ApplicationGatewayBackendHealth> applicationGatewaysBackendHealthWithHttpInfo(String resourceGroupName, String applicationGatewayName,  UNKNOWN_PARAMETER_NAME,  UNKNOWN_PARAMETER_NAME2, String $expand) throws ApiException {
        okhttp3.Call localVarCall = applicationGatewaysBackendHealthValidateBeforeCall(resourceGroupName, applicationGatewayName, UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, $expand, null);
     ...
     */
    public okhttp3.Call applicationGatewaysBackendHealthAsync(String resourceGroupName, String applicationGatewayName,  UNKNOWN_PARAMETER_NAME,  UNKNOWN_PARAMETER_NAME2, String $expand, final ApiCallback<ApplicationGatewayBackendHealth> _callback) throws ApiException {

        okhttp3.Call localVarCall = applicationGatewaysBackendHealthValidateBeforeCall(resourceGroupName, applicationGatewayName, UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, $expand, _callback);
        Type localVarReturnType = new TypeToken<ApplicationGatewayBackendHealth>(){}.getType();
