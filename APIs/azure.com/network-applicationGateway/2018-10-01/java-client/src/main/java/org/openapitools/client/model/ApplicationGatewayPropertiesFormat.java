...
public class ApplicationGatewayPropertiesFormat {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationCertificates, autoscaleConfiguration, backendAddressPools, backendHttpSettingsCollection, customErrorConfigurations, enableFips, enableHttp2, frontendIPConfigurations, frontendPorts, gatewayIPConfigurations, httpListeners, operationalState, probes, provisioningState, redirectConfigurations, requestRoutingRules, resourceGuid, rewriteRuleSets, sku, sslCertificates, sslPolicy, trustedRootCertificates, urlPathMaps, webApplicationFirewallConfiguration);
  }
