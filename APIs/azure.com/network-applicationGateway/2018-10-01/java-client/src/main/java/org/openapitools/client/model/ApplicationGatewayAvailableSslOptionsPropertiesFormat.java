...
public class ApplicationGatewayAvailableSslOptionsPropertiesFormat {
  ...
  private List<Model0> predefinedPolicies = new ArrayList<>();
  ...
  public ApplicationGatewayAvailableSslOptionsPropertiesFormat predefinedPolicies(List<Model0> predefinedPolicies) {
    this.predefinedPolicies = predefinedPolicies;
    return this;
  }

  public ApplicationGatewayAvailableSslOptionsPropertiesFormat addPredefinedPoliciesItem(Model0 predefinedPoliciesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Model0> getPredefinedPolicies() {
    return predefinedPolicies;
  }

  public void setPredefinedPolicies(List<Model0> predefinedPolicies) {
    this.predefinedPolicies = predefinedPolicies;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("predefinedPolicies") != null && !jsonObj.get("predefinedPolicies").isJsonNull() && !jsonObj.get("predefinedPolicies").isJsonArray()) {
