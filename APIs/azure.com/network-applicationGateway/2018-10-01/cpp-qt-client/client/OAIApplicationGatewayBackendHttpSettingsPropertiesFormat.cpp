...
QList<OAI0> OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getTrustedRootCertificates() const {
    return m_trusted_root_certificates;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setTrustedRootCertificates(const QList<OAI0> &trusted_root_certificates) {
