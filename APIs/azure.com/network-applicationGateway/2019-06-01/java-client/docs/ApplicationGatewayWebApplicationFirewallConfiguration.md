...
|**fileUploadLimitInMb** | **Integer** | Maximum file upload size in Mb for WAF. |  [optional] |
...
|**maxRequestBodySizeInKb** | **Integer** | Maximum request body size in Kb for WAF. |  [optional] |
