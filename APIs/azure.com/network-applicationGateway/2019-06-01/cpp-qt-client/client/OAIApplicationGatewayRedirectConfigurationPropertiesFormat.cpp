...
QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getPathRules() const {
    return m_path_rules;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setPathRules(const QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> &path_rules) {
...
QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getRequestRoutingRules() const {
    return m_request_routing_rules;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setRequestRoutingRules(const QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> &request_routing_rules) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getTargetListener() const {
    return m_target_listener;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setTargetListener(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &target_listener) {
...
QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getUrlPathMaps() const {
    return m_url_path_maps;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setUrlPathMaps(const QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> &url_path_maps) {
