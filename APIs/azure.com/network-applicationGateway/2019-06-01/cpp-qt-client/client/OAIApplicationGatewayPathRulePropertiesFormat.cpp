...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayPathRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendAddressPool(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &backend_address_pool) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayPathRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendHttpSettings(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &backend_http_settings) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayPathRulePropertiesFormat::getRedirectConfiguration() const {
    return m_redirect_configuration;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setRedirectConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &redirect_configuration) {
...
OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet OAIApplicationGatewayPathRulePropertiesFormat::getRewriteRuleSet() const {
    return m_rewrite_rule_set;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setRewriteRuleSet(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &rewrite_rule_set) {
    m_rewrite_rule_set = rewrite_rule_set;
    m_rewrite_rule_set_isSet = true;
}

bool OAIApplicationGatewayPathRulePropertiesFormat::is_rewrite_rule_set_Set() const{
    return m_rewrite_rule_set_isSet;
}

bool OAIApplicationGatewayPathRulePropertiesFormat::is_rewrite_rule_set_Valid() const{
