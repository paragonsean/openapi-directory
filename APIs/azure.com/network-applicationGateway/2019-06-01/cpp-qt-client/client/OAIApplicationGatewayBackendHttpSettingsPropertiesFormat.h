...
public:
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> getAuthenticationCertificates() const;
    void setAuthenticationCertificates(const QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> &authentication_certificates);
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet getProbe() const;
    void setProbe(const OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet &probe);
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> getTrustedRootCertificates() const;
    void setTrustedRootCertificates(const QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> &trusted_root_certificates);
...
private:
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> m_authentication_certificates;
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet m_probe;
    bool m_probe_isSet;
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_rewriteRuleSet> m_trusted_root_certificates;
