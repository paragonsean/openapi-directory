...
public class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerProperties {
  ...
  private List<ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner> backendIPConfigurations = new ArrayList<>();
  ...
  public ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerProperties backendIPConfigurations(List<ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner> backendIPConfigurations) {
    this.backendIPConfigurations = backendIPConfigurations;
    return this;
  }

  public ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerProperties addBackendIPConfigurationsItem(ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner backendIPConfigurationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner> getBackendIPConfigurations() {
    return backendIPConfigurations;
  }

  public void setBackendIPConfigurations(List<ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner> backendIPConfigurations) {
    this.backendIPConfigurations = backendIPConfigurations;
  }
      ...
      if (jsonObj.get("backendIPConfigurations") != null && !jsonObj.get("backendIPConfigurations").isJsonNull()) {
        ...
        if (jsonArraybackendIPConfigurations != null) {
          ...
          for (int i = 0; i < jsonArraybackendIPConfigurations.size(); i++) {
            ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendIPConfigurationsInner.validateJsonElement(jsonArraybackendIPConfigurations.get(i));
          };
        }
      }
