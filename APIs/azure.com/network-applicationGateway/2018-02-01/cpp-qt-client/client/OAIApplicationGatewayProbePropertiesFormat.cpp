...
QString OAIApplicationGatewayProbePropertiesFormat::getProtocol() const {
    return m_protocol;
}
void OAIApplicationGatewayProbePropertiesFormat::setProtocol(const QString &protocol) {
    m_protocol = protocol;
