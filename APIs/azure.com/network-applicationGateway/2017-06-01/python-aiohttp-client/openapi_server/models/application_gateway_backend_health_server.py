...
class ApplicationGatewayBackendHealthServer(Model):
    ...
    def __init__(self, address: str=None, health: str=None, ip_configuration: ApplicationGatewayBackendHealthServerIpConfiguration=None):
        ...
        self.openapi_types = {
            'address': str,
            'health': str,
            'ip_configuration': ApplicationGatewayBackendHealthServerIpConfiguration
        }
    ...
    def ip_configuration(self):
        ...
        :rtype: ApplicationGatewayBackendHealthServerIpConfiguration
        """
    ...
    def ip_configuration(self, ip_configuration):
        ...
        :param ip_configuration: The ip_configuration of this ApplicationGatewayBackendHealthServer.
        :type ip_configuration: ApplicationGatewayBackendHealthServerIpConfiguration
        """
