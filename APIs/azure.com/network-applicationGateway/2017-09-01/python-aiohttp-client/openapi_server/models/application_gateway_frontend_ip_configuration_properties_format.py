...
class ApplicationGatewayFrontendIPConfigurationPropertiesFormat(Model):
    ...
    def __init__(self, private_ip_address: str=None, private_ip_allocation_method: str=None, provisioning_state: str=None, public_ip_address: Model0=None, subnet: Model0=None):
