...
async def application_gateways_update_tags(request: web.Request, resource_group_name, application_gateway_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = ApplicationGatewaysUpdateTagsRequest.from_dict(parameters)
    return web.Response(status=200)
