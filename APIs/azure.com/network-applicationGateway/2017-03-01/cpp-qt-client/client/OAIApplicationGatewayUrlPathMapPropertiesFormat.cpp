...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendAddressPool() const {
    return m_default_backend_address_pool;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendAddressPool(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &default_backend_address_pool) {
...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendHttpSettings() const {
    return m_default_backend_http_settings;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendHttpSettings(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &default_backend_http_settings) {
