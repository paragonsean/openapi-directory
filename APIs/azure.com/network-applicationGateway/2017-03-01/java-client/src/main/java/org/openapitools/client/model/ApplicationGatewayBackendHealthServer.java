...
public class ApplicationGatewayBackendHealthServer {
  ...
  private ApplicationGatewayHttpListenerPropertiesFormatFrontendPort ipConfiguration;
  ...
  public ApplicationGatewayBackendHealthServer ipConfiguration(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort ipConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayHttpListenerPropertiesFormatFrontendPort getIpConfiguration() {
    return ipConfiguration;
  }

  public void setIpConfiguration(ApplicationGatewayHttpListenerPropertiesFormatFrontendPort ipConfiguration) {
    this.ipConfiguration = ipConfiguration;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("ipConfiguration") != null && !jsonObj.get("ipConfiguration").isJsonNull()) {
        ApplicationGatewayHttpListenerPropertiesFormatFrontendPort.validateJsonElement(jsonObj.get("ipConfiguration"));
      }
  }
