...
class ApplicationGatewayPathRulePropertiesFormat(Model):
    ...
    def __init__(self, backend_address_pool: Model0=None, backend_http_settings: Model0=None, paths: List[str]=None, provisioning_state: str=None, redirect_configuration: Model0=None):
        ...
        :param redirect_configuration: The redirect_configuration of this ApplicationGatewayPathRulePropertiesFormat.
        """
        self.openapi_types = {
        ...
        self._redirect_configuration = redirect_configuration
    ...
    @property
    def redirect_configuration(self):
        """Gets the redirect_configuration of this ApplicationGatewayPathRulePropertiesFormat.


        :return: The redirect_configuration of this ApplicationGatewayPathRulePropertiesFormat.
        :rtype: Model0
        """
        return self._redirect_configuration

    @redirect_configuration.setter
    def redirect_configuration(self, redirect_configuration):
        """Sets the redirect_configuration of this ApplicationGatewayPathRulePropertiesFormat.


        :param redirect_configuration: The redirect_configuration of this ApplicationGatewayPathRulePropertiesFormat.
        :type redirect_configuration: Model0
        """
