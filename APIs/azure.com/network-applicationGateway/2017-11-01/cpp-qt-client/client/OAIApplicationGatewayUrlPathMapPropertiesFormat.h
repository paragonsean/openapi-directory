...
public:
    ...
    OAI0 getDefaultBackendAddressPool() const;
    void setDefaultBackendAddressPool(const OAI0 &default_backend_address_pool);
    bool is_default_backend_address_pool_Set() const;
    bool is_default_backend_address_pool_Valid() const;

    OAI0 getDefaultBackendHttpSettings() const;
    void setDefaultBackendHttpSettings(const OAI0 &default_backend_http_settings);
    bool is_default_backend_http_settings_Set() const;
    bool is_default_backend_http_settings_Valid() const;

    OAI0 getDefaultRedirectConfiguration() const;
    void setDefaultRedirectConfiguration(const OAI0 &default_redirect_configuration);
