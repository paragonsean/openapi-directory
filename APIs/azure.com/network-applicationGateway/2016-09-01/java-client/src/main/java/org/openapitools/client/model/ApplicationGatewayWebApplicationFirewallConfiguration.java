...
public class ApplicationGatewayWebApplicationFirewallConfiguration {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, applicationGatewayWebApplicationFirewallConfiguration.enabled) &&
        Objects.equals(this.firewallMode, applicationGatewayWebApplicationFirewallConfiguration.firewallMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, firewallMode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("firewallMode") != null && !jsonObj.get("firewallMode").isJsonNull()) && !jsonObj.get("firewallMode").isJsonPrimitive()) {
      ...
      // validate the optional field `firewallMode`
      if (jsonObj.get("firewallMode") != null && !jsonObj.get("firewallMode").isJsonNull()) {
