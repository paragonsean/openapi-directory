...
public class ApplicationGatewayPropertiesFormat {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationCertificates, backendAddressPools, backendHttpSettingsCollection, frontendIPConfigurations, frontendPorts, gatewayIPConfigurations, httpListeners, operationalState, probes, provisioningState, requestRoutingRules, resourceGuid, sku, sslCertificates, sslPolicy, urlPathMaps, webApplicationFirewallConfiguration);
  }
