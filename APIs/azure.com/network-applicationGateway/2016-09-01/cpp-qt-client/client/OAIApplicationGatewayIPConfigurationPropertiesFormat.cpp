...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayIPConfigurationPropertiesFormat::setSubnet(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
