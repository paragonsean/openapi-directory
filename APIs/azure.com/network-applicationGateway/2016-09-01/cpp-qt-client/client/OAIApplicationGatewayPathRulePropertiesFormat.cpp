...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayPathRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendAddressPool(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &backend_address_pool) {
...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayPathRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendHttpSettings(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &backend_http_settings) {
