...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayHttpListenerPropertiesFormat::getFrontendIpConfiguration() const {
    return m_frontend_ip_configuration;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setFrontendIpConfiguration(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &frontend_ip_configuration) {
...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayHttpListenerPropertiesFormat::getFrontendPort() const {
    return m_frontend_port;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setFrontendPort(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &frontend_port) {
...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayHttpListenerPropertiesFormat::getSslCertificate() const {
    return m_ssl_certificate;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setSslCertificate(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &ssl_certificate) {
