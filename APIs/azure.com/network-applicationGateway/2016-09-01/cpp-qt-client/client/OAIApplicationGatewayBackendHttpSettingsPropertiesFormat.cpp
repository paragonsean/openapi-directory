...
QList<OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort> OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getAuthenticationCertificates() const {
    return m_authentication_certificates;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setAuthenticationCertificates(const QList<OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort> &authentication_certificates) {
...
OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getProbe() const {
    return m_probe;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setProbe(const OAIApplicationGatewayHttpListenerPropertiesFormat_frontendPort &probe) {
    m_probe = probe;
    m_probe_isSet = true;
}
