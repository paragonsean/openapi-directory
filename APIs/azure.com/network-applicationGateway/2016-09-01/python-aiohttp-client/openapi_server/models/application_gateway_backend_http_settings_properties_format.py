...
class ApplicationGatewayBackendHttpSettingsPropertiesFormat(Model):
    ...
    def __init__(self, authentication_certificates: List[ApplicationGatewayHttpListenerPropertiesFormatFrontendPort]=None, cookie_based_affinity: str=None, port: int=None, probe: ApplicationGatewayHttpListenerPropertiesFormatFrontendPort=None, protocol: str=None, provisioning_state: str=None, request_timeout: int=None):
