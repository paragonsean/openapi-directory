...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.ApplicationGatewayHttpListenerPropertiesFormat();
  });
  ...
  describe('ApplicationGatewayHttpListenerPropertiesFormat', function() {
    it('should create an instance of ApplicationGatewayHttpListenerPropertiesFormat', function() {
      ...
      //var instance = new NetworkManagementClient.ApplicationGatewayHttpListenerPropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.ApplicationGatewayHttpListenerPropertiesFormat);
    });
    ...
    it('should have the property requireServerNameIndication (base name: "requireServerNameIndication")', function() {
      // uncomment below and update the code to test the property requireServerNameIndication
      //var instance = new NetworkManagementClient.ApplicationGatewayHttpListenerPropertiesFormat();
      //expect(instance).to.be();
    });
