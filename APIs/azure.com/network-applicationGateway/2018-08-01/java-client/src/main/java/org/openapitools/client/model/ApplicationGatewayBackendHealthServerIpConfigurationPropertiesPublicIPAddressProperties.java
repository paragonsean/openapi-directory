...
public class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesPublicIPAddressProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dnsSettings, idleTimeoutInMinutes, ipAddress, ipConfiguration, ipTags, provisioningState, publicIPAddressVersion, publicIPAllocationMethod, publicIPPrefix, resourceGuid);
  }
