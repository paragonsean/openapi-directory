...
public class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressPrefix, addressPrefixes, delegations, interfaceEndpoints, ipConfigurationProfiles, ipConfigurations, networkSecurityGroup, provisioningState, purpose, resourceNavigationLinks, routeTable, serviceAssociationLinks, serviceEndpointPolicies, serviceEndpoints);
  }
