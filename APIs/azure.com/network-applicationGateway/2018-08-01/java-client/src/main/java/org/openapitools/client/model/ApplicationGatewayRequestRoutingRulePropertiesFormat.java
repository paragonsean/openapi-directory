...
public class ApplicationGatewayRequestRoutingRulePropertiesFormat {
  ...
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration backendAddressPool;
  ...
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration backendHttpSettings;

  public static final String SERIALIZED_NAME_HTTP_LISTENER = "httpListener";
  @SerializedName(SERIALIZED_NAME_HTTP_LISTENER)
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration httpListener;
  ...
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration redirectConfiguration;
  ...
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration urlPathMap;

  public ApplicationGatewayRequestRoutingRulePropertiesFormat() {
  }

  public ApplicationGatewayRequestRoutingRulePropertiesFormat backendAddressPool(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration backendAddressPool) {
  ...
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getBackendAddressPool() {
    return backendAddressPool;
  }

  public void setBackendAddressPool(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration backendAddressPool) {
    this.backendAddressPool = backendAddressPool;
  }


  public ApplicationGatewayRequestRoutingRulePropertiesFormat backendHttpSettings(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration backendHttpSettings) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getBackendHttpSettings() {
    return backendHttpSettings;
  }

  public void setBackendHttpSettings(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration backendHttpSettings) {
    this.backendHttpSettings = backendHttpSettings;
  }


  public ApplicationGatewayRequestRoutingRulePropertiesFormat httpListener(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration httpListener) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getHttpListener() {
    return httpListener;
  }

  public void setHttpListener(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration httpListener) {
    this.httpListener = httpListener;
  }
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat redirectConfiguration(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration redirectConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getRedirectConfiguration() {
    return redirectConfiguration;
  }

  public void setRedirectConfiguration(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration redirectConfiguration) {
    this.redirectConfiguration = redirectConfiguration;
  }
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat urlPathMap(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration urlPathMap) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getUrlPathMap() {
    return urlPathMap;
  }

  public void setUrlPathMap(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration urlPathMap) {
    this.urlPathMap = urlPathMap;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backendAddressPool, applicationGatewayRequestRoutingRulePropertiesFormat.backendAddressPool) &&
        ...
        Objects.equals(this.redirectConfiguration, applicationGatewayRequestRoutingRulePropertiesFormat.redirectConfiguration) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backendAddressPool, backendHttpSettings, httpListener, provisioningState, redirectConfiguration, ruleType, urlPathMap);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("backendAddressPool") != null && !jsonObj.get("backendAddressPool").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("backendAddressPool"));
      }
      ...
      if (jsonObj.get("backendHttpSettings") != null && !jsonObj.get("backendHttpSettings").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("backendHttpSettings"));
      }
      // validate the optional field `httpListener`
      if (jsonObj.get("httpListener") != null && !jsonObj.get("httpListener").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("httpListener"));
      }
      ...
      if (jsonObj.get("redirectConfiguration") != null && !jsonObj.get("redirectConfiguration").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("redirectConfiguration"));
      }
      ...
      if (jsonObj.get("urlPathMap") != null && !jsonObj.get("urlPathMap").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("urlPathMap"));
      }
  }
