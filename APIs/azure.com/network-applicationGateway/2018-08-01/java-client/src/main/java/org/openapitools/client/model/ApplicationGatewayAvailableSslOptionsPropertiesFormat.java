...
public class ApplicationGatewayAvailableSslOptionsPropertiesFormat {
  ...
  private List<ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration> predefinedPolicies = new ArrayList<>();
  ...
  public ApplicationGatewayAvailableSslOptionsPropertiesFormat predefinedPolicies(List<ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration> predefinedPolicies) {
    this.predefinedPolicies = predefinedPolicies;
    return this;
  }

  public ApplicationGatewayAvailableSslOptionsPropertiesFormat addPredefinedPoliciesItem(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration predefinedPoliciesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration> getPredefinedPolicies() {
    return predefinedPolicies;
  }

  public void setPredefinedPolicies(List<ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration> predefinedPolicies) {
    this.predefinedPolicies = predefinedPolicies;
  }
      ...
      if (jsonObj.get("predefinedPolicies") != null && !jsonObj.get("predefinedPolicies").isJsonNull()) {
        ...
        if (jsonArraypredefinedPolicies != null) {
          ...
          for (int i = 0; i < jsonArraypredefinedPolicies.size(); i++) {
            ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonArraypredefinedPolicies.get(i));
          };
        }
      }
  }
