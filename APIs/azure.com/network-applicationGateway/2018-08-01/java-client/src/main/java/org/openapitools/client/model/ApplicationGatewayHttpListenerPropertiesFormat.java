...
public class ApplicationGatewayHttpListenerPropertiesFormat {
  ...
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration frontendIPConfiguration;

  public static final String SERIALIZED_NAME_FRONTEND_PORT = "frontendPort";
  @SerializedName(SERIALIZED_NAME_FRONTEND_PORT)
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration frontendPort;
  ...
  private ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration sslCertificate;
  ...
  public ApplicationGatewayHttpListenerPropertiesFormat frontendIPConfiguration(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration frontendIPConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getFrontendIPConfiguration() {
    return frontendIPConfiguration;
  }

  public void setFrontendIPConfiguration(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration frontendIPConfiguration) {
    this.frontendIPConfiguration = frontendIPConfiguration;
  }


  public ApplicationGatewayHttpListenerPropertiesFormat frontendPort(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration frontendPort) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getFrontendPort() {
    return frontendPort;
  }

  public void setFrontendPort(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration frontendPort) {
    this.frontendPort = frontendPort;
  }
  ...
  public ApplicationGatewayHttpListenerPropertiesFormat sslCertificate(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration sslCertificate) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration getSslCertificate() {
    return sslCertificate;
  }

  public void setSslCertificate(ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration sslCertificate) {
    this.sslCertificate = sslCertificate;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("frontendIPConfiguration") != null && !jsonObj.get("frontendIPConfiguration").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("frontendIPConfiguration"));
      }
      // validate the optional field `frontendPort`
      if (jsonObj.get("frontendPort") != null && !jsonObj.get("frontendPort").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("frontendPort"));
      }
      ...
      if (jsonObj.get("sslCertificate") != null && !jsonObj.get("sslCertificate").isJsonNull()) {
        ApplicationGatewayPathRulePropertiesFormatRedirectConfiguration.validateJsonElement(jsonObj.get("sslCertificate"));
      }
  }
