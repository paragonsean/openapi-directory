...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayHttpListenerPropertiesFormat::getFrontendIpConfiguration() const {
    return m_frontend_ip_configuration;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setFrontendIpConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &frontend_ip_configuration) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayHttpListenerPropertiesFormat::getFrontendPort() const {
    return m_frontend_port;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setFrontendPort(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &frontend_port) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayHttpListenerPropertiesFormat::getSslCertificate() const {
    return m_ssl_certificate;
}
void OAIApplicationGatewayHttpListenerPropertiesFormat::setSslCertificate(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &ssl_certificate) {
