...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendAddressPool(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &backend_address_pool) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendHttpSettings(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &backend_http_settings) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getHttpListener() const {
    return m_http_listener;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setHttpListener(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &http_listener) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getRedirectConfiguration() const {
    return m_redirect_configuration;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setRedirectConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &redirect_configuration) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getUrlPathMap() const {
    return m_url_path_map;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setUrlPathMap(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &url_path_map) {
