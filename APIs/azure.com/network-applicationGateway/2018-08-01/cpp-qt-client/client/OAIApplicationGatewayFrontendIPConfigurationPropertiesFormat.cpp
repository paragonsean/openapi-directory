...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setPublicIpAddress(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &public_ip_address) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayFrontendIPConfigurationPropertiesFormat::setSubnet(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
