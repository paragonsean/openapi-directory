...
QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> OAIApplicationGatewayAvailableSslOptionsPropertiesFormat::getPredefinedPolicies() const {
    return m_predefined_policies;
}
void OAIApplicationGatewayAvailableSslOptionsPropertiesFormat::setPredefinedPolicies(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &predefined_policies) {
