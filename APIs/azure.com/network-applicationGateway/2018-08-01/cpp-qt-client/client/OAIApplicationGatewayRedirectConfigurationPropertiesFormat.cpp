...
QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getPathRules() const {
    return m_path_rules;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setPathRules(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &path_rules) {
...
QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getRequestRoutingRules() const {
    return m_request_routing_rules;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setRequestRoutingRules(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &request_routing_rules) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getTargetListener() const {
    return m_target_listener;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setTargetListener(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &target_listener) {
...
QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> OAIApplicationGatewayRedirectConfigurationPropertiesFormat::getUrlPathMaps() const {
    return m_url_path_maps;
}
void OAIApplicationGatewayRedirectConfigurationPropertiesFormat::setUrlPathMaps(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &url_path_maps) {
