...
void OAIApplicationGatewayTrustedRootCertificatePropertiesFormat::initializeModel() {
    ...
    m_keyvault_secret_id_isSet = false;
    m_keyvault_secret_id_isValid = false;
...
void OAIApplicationGatewayTrustedRootCertificatePropertiesFormat::fromJsonObject(QJsonObject json) {
    ...
    m_keyvault_secret_id_isValid = ::OpenAPI::fromJsonValue(m_keyvault_secret_id, json[QString("keyvaultSecretId")]);
    m_keyvault_secret_id_isSet = !json[QString("keyvaultSecretId")].isNull() && m_keyvault_secret_id_isValid;
...
QJsonObject OAIApplicationGatewayTrustedRootCertificatePropertiesFormat::asJsonObject() const {
    ...
    if (m_keyvault_secret_id_isSet) {
        obj.insert(QString("keyvaultSecretId"), ::OpenAPI::toJsonValue(m_keyvault_secret_id));
    }
...
QString OAIApplicationGatewayTrustedRootCertificatePropertiesFormat::getKeyvaultSecretId() const {
    return m_keyvault_secret_id;
}
void OAIApplicationGatewayTrustedRootCertificatePropertiesFormat::setKeyvaultSecretId(const QString &keyvault_secret_id) {
    m_keyvault_secret_id = keyvault_secret_id;
    m_keyvault_secret_id_isSet = true;
}

bool OAIApplicationGatewayTrustedRootCertificatePropertiesFormat::is_keyvault_secret_id_Set() const{
    return m_keyvault_secret_id_isSet;
}

bool OAIApplicationGatewayTrustedRootCertificatePropertiesFormat::is_keyvault_secret_id_Valid() const{
    return m_keyvault_secret_id_isValid;
}
