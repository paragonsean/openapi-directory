...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayIPConfigurationPropertiesFormat::setSubnet(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
