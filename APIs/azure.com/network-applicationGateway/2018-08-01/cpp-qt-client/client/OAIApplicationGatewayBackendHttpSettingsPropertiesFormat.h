...
public:
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> getAuthenticationCertificates() const;
    void setAuthenticationCertificates(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &authentication_certificates);
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration getProbe() const;
    void setProbe(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &probe);
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> getTrustedRootCertificates() const;
    void setTrustedRootCertificates(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &trusted_root_certificates);
...
private:
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> m_authentication_certificates;
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration m_probe;
    bool m_probe_isSet;
    ...
    QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> m_trusted_root_certificates;
