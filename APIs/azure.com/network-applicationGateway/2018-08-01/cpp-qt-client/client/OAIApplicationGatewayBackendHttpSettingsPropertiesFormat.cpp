...
QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getAuthenticationCertificates() const {
    return m_authentication_certificates;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setAuthenticationCertificates(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &authentication_certificates) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getProbe() const {
    return m_probe;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setProbe(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &probe) {
    m_probe = probe;
    m_probe_isSet = true;
}
...
QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getTrustedRootCertificates() const {
    return m_trusted_root_certificates;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setTrustedRootCertificates(const QList<OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration> &trusted_root_certificates) {
