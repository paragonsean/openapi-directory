...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendAddressPool() const {
    return m_default_backend_address_pool;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendAddressPool(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &default_backend_address_pool) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendHttpSettings() const {
    return m_default_backend_http_settings;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendHttpSettings(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &default_backend_http_settings) {
...
OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultRedirectConfiguration() const {
    return m_default_redirect_configuration;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultRedirectConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &default_redirect_configuration) {
