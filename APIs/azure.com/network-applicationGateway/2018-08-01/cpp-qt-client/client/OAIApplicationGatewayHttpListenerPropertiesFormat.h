...
public:
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration getFrontendIpConfiguration() const;
    void setFrontendIpConfiguration(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &frontend_ip_configuration);
    bool is_frontend_ip_configuration_Set() const;
    bool is_frontend_ip_configuration_Valid() const;

    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration getFrontendPort() const;
    void setFrontendPort(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &frontend_port);
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration getSslCertificate() const;
    void setSslCertificate(const OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration &ssl_certificate);
...
private:
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration m_frontend_ip_configuration;
    bool m_frontend_ip_configuration_isSet;
    bool m_frontend_ip_configuration_isValid;

    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration m_frontend_port;
    ...
    OAIApplicationGatewayPathRulePropertiesFormat_redirectConfiguration m_ssl_certificate;
