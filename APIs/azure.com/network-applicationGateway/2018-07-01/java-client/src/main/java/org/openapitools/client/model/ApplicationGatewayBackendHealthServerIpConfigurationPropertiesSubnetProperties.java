...
public class ApplicationGatewayBackendHealthServerIpConfigurationPropertiesSubnetProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressPrefix, ipConfigurations, networkSecurityGroup, provisioningState, resourceNavigationLinks, routeTable, serviceEndpointPolicies, serviceEndpoints);
  }
