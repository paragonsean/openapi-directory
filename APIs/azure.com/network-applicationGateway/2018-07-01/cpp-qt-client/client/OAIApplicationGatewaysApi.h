...
public:
    ...
    */
    virtual void applicationGatewaysBackendHealth(const QString &resource_group_name, const QString &application_gateway_name, const ::OpenAPI::OptionalParam<> &UNKNOWN_PARAMETER_NAME = ::OpenAPI::OptionalParam<>(), const ::OpenAPI::OptionalParam<> &UNKNOWN_PARAMETER_NAME2 = ::OpenAPI::OptionalParam<>(), const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>());
