...
QList<OAI0> OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getAuthenticationCertificates() const {
    return m_authentication_certificates;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setAuthenticationCertificates(const QList<OAI0> &authentication_certificates) {
...
OAI0 OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getProbe() const {
    return m_probe;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setProbe(const OAI0 &probe) {
    m_probe = probe;
    m_probe_isSet = true;
}
