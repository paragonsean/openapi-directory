...
public class ApplicationGatewayBackendHttpSettingsPropertiesFormat {
  ...
  private List<Model0> trustedRootCertificates = new ArrayList<>();
  ...
  public ApplicationGatewayBackendHttpSettingsPropertiesFormat trustedRootCertificates(List<Model0> trustedRootCertificates) {
    this.trustedRootCertificates = trustedRootCertificates;
    return this;
  }

  public ApplicationGatewayBackendHttpSettingsPropertiesFormat addTrustedRootCertificatesItem(Model0 trustedRootCertificatesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Model0> getTrustedRootCertificates() {
    return trustedRootCertificates;
  }

  public void setTrustedRootCertificates(List<Model0> trustedRootCertificates) {
    this.trustedRootCertificates = trustedRootCertificates;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("trustedRootCertificates") != null && !jsonObj.get("trustedRootCertificates").isJsonNull() && !jsonObj.get("trustedRootCertificates").isJsonArray()) {
