...
public class ApplicationGatewayRequestRoutingRulePropertiesFormat {
  ...
  private Model0 httpListener = null;
  ...
  private Model0 rewriteRuleSet = null;
  ...
  private Model0 urlPathMap = null;

  public ApplicationGatewayRequestRoutingRulePropertiesFormat() {
  }

  public ApplicationGatewayRequestRoutingRulePropertiesFormat backendAddressPool(Model0 backendAddressPool) {
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat backendHttpSettings(Model0 backendHttpSettings) {
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat httpListener(Model0 httpListener) {
   ...
   */
  @javax.annotation.Nullable
  public Model0 getHttpListener() {
    return httpListener;
  }

  public void setHttpListener(Model0 httpListener) {
    this.httpListener = httpListener;
  }
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat redirectConfiguration(Model0 redirectConfiguration) {
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat rewriteRuleSet(Model0 rewriteRuleSet) {
   ...
   */
  @javax.annotation.Nullable
  public Model0 getRewriteRuleSet() {
    return rewriteRuleSet;
  }

  public void setRewriteRuleSet(Model0 rewriteRuleSet) {
    this.rewriteRuleSet = rewriteRuleSet;
  }
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat urlPathMap(Model0 urlPathMap) {
   ...
   */
  @javax.annotation.Nullable
  public Model0 getUrlPathMap() {
    return urlPathMap;
  }

  public void setUrlPathMap(Model0 urlPathMap) {
    this.urlPathMap = urlPathMap;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backendAddressPool, backendHttpSettings, httpListener, provisioningState, redirectConfiguration, rewriteRuleSet, ruleType, urlPathMap);
  }
