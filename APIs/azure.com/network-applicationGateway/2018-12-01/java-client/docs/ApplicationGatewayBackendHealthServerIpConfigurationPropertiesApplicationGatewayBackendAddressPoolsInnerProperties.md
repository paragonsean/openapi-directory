...
|------------ | ------------- | ------------- | -------------|
|**backendAddresses** | [**List&lt;ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendAddressesInner&gt;**](ApplicationGatewayBackendHealthServerIpConfigurationPropertiesApplicationGatewayBackendAddressPoolsInnerPropertiesBackendAddressesInner.md) | Backend addresses |  [optional] |
|**backendIPConfigurations** | **List&lt;DestinationNetworkInterfaceIPConfiguration&gt;** | Collection of references to IPs defined in network interfaces. |  [optional] |
