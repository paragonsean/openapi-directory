...
OAI0 OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getRewriteRuleSet() const {
    return m_rewrite_rule_set;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setRewriteRuleSet(const OAI0 &rewrite_rule_set) {
