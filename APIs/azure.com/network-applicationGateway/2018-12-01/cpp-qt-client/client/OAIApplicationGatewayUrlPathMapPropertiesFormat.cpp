...
OAI0 OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultRewriteRuleSet() const {
    return m_default_rewrite_rule_set;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultRewriteRuleSet(const OAI0 &default_rewrite_rule_set) {
