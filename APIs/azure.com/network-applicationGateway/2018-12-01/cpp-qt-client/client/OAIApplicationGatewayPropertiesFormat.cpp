...
OAI0 OAIApplicationGatewayPropertiesFormat::getFirewallPolicy() const {
    return m_firewall_policy;
}
void OAIApplicationGatewayPropertiesFormat::setFirewallPolicy(const OAI0 &firewall_policy) {
