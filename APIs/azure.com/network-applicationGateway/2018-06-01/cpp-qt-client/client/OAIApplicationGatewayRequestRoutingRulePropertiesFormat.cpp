...
OAI0 OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendAddressPool(const OAI0 &backend_address_pool) {
...
OAI0 OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendHttpSettings(const OAI0 &backend_http_settings) {
...
OAI0 OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getHttpListener() const {
    return m_http_listener;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setHttpListener(const OAI0 &http_listener) {
...
OAI0 OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getRedirectConfiguration() const {
    return m_redirect_configuration;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setRedirectConfiguration(const OAI0 &redirect_configuration) {
    m_redirect_configuration = redirect_configuration;
    m_redirect_configuration_isSet = true;
}

bool OAIApplicationGatewayRequestRoutingRulePropertiesFormat::is_redirect_configuration_Set() const{
    return m_redirect_configuration_isSet;
}

bool OAIApplicationGatewayRequestRoutingRulePropertiesFormat::is_redirect_configuration_Valid() const{
...
OAI0 OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getUrlPathMap() const {
    return m_url_path_map;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setUrlPathMap(const OAI0 &url_path_map) {
