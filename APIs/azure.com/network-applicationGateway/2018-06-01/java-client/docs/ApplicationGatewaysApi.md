...
> ApplicationGatewayBackendHealth applicationGatewaysBackendHealth(resourceGroupName, applicationGatewayName, UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, $expand)
