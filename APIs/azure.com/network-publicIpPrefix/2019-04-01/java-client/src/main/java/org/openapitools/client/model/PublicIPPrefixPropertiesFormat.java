...
public class PublicIPPrefixPropertiesFormat {
  ...
  private List<PublicIPPrefixPropertiesFormatIpTagsInner> ipTags = new ArrayList<>();
  ...
  public PublicIPPrefixPropertiesFormat ipTags(List<PublicIPPrefixPropertiesFormatIpTagsInner> ipTags) {
    this.ipTags = ipTags;
    return this;
  }

  public PublicIPPrefixPropertiesFormat addIpTagsItem(PublicIPPrefixPropertiesFormatIpTagsInner ipTagsItem) {
    if (this.ipTags == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<PublicIPPrefixPropertiesFormatIpTagsInner> getIpTags() {
    return ipTags;
  }

  public void setIpTags(List<PublicIPPrefixPropertiesFormatIpTagsInner> ipTags) {
    this.ipTags = ipTags;
  }
      ...
      if (jsonObj.get("ipTags") != null && !jsonObj.get("ipTags").isJsonNull()) {
        ...
        if (jsonArrayipTags != null) {
          ...
          for (int i = 0; i < jsonArrayipTags.size(); i++) {
            PublicIPPrefixPropertiesFormatIpTagsInner.validateJsonElement(jsonArrayipTags.get(i));
          };
        }
      }
