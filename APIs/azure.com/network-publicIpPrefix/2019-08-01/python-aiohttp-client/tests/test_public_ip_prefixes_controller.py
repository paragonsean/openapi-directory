...
async def test_public_ip_prefixes_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","sku":{"name":"Standard"},"zones":["zones","zones"],"properties":{"prefixLength":0,"publicIPAddressVersion":"IPv4","loadBalancerFrontendIpConfiguration":{"id":"id"},"resourceGuid":"resourceGuid","ipPrefix":"ipPrefix","publicIPAddresses":[{"id":"id"},{"id":"id"}],"provisioningState":"Succeeded","ipTags":[{"ipTagType":"ipTagType","tag":"tag"},{"ipTagType":"ipTagType","tag":"tag"}]}}
