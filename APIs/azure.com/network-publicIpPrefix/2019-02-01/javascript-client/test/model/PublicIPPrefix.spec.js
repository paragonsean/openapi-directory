...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.PublicIPPrefix();
  });
  ...
  describe('PublicIPPrefix', function() {
    it('should create an instance of PublicIPPrefix', function() {
      // uncomment below and update the code to test PublicIPPrefix
      //var instance = new NetworkManagementClient.PublicIPPrefix();
      //expect(instance).to.be.a(NetworkManagementClient.PublicIPPrefix);
    });
