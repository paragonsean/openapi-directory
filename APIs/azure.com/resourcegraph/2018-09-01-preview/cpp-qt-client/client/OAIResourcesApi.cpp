...
void OAIResourcesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("resources", defaultConf);
    _serverIndices.insert("resources", 0);
}
...
void OAIResourcesApi::resources(const QString &api_version, const OAIQueryRequest &query) {
    QString fullPath = QString(_serverConfigs["resources"][_serverIndices.value("resources")].URL()+"/providers/Microsoft.ResourceGraph/resources");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIResourcesApi::resourcesCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIResourcesApi::resourcesCallback);
...
void OAIResourcesApi::resourcesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT resourcesSignal(output);
        Q_EMIT resourcesSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT resourcesSignalE(output, error_type, error_str);
        Q_EMIT resourcesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT resourcesSignalError(output, error_type, error_str);
        Q_EMIT resourcesSignalErrorFull(worker, error_type, error_str);
    }
}
