...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureResourceGraph.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureResourceGraph.OperationDisplay();
      //expect(instance).to.be.a(AzureResourceGraph.OperationDisplay);
    });
