...
|**lastModified** | **OffsetDateTime** | The last time a modifying operation was performed on the given key-value. |  [optional] [readonly] |
...
|**tags** | **Map&lt;String, String&gt;** | A dictionary of tags that can help identify what a key-value may be applicable for. |  [optional] [readonly] |
