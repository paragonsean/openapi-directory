...
public class PrivateEndpointConnectionListResult {
  ...
  public PrivateEndpointConnectionListResult nextLink(String nextLink) {
  ...
  public PrivateEndpointConnectionListResult value(List<PrivateEndpointConnection> value) {
    this.value = value;
    return this;
  }

  public PrivateEndpointConnectionListResult addValueItem(PrivateEndpointConnection valueItem) {
    if (this.value == null) {
  ...
  public void setValue(List<PrivateEndpointConnection> value) {
    this.value = value;
  }
