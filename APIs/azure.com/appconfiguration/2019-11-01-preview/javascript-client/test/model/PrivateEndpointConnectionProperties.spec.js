...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppConfigurationManagementClient.PrivateEndpointConnectionProperties();
  });
  ...
  describe('PrivateEndpointConnectionProperties', function() {
    it('should create an instance of PrivateEndpointConnectionProperties', function() {
      ...
      //var instance = new AppConfigurationManagementClient.PrivateEndpointConnectionProperties();
      //expect(instance).to.be.a(AppConfigurationManagementClient.PrivateEndpointConnectionProperties);
    });
