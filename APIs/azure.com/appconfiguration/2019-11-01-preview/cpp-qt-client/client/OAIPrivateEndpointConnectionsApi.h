...
public:
    ...
    * @param[in]  private_endpoint_connection OAIPrivateEndpointConnection [required]
    */
    virtual void privateEndpointConnectionsCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &config_store_name, const QString &api_version, const QString &private_endpoint_connection_name, const OAIPrivateEndpointConnection &private_endpoint_connection);
    ...
    * @param[in]  private_endpoint_connection_name QString [required]
    */
    virtual void privateEndpointConnectionsDelete(const QString &subscription_id, const QString &resource_group_name, const QString &config_store_name, const QString &api_version, const QString &private_endpoint_connection_name);
    ...
    * @param[in]  private_endpoint_connection_name QString [required]
    */
    virtual void privateEndpointConnectionsGet(const QString &subscription_id, const QString &resource_group_name, const QString &config_store_name, const QString &api_version, const QString &private_endpoint_connection_name);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void privateEndpointConnectionsListByConfigurationStore(const QString &subscription_id, const QString &resource_group_name, const QString &config_store_name, const QString &api_version);
...
private:
    ...
    void privateEndpointConnectionsListByConfigurationStoreCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void privateEndpointConnectionsListByConfigurationStoreSignal(OAIPrivateEndpointConnectionListResult summary);
    ...
    void privateEndpointConnectionsListByConfigurationStoreSignalFull(OAIHttpRequestWorker *worker, OAIPrivateEndpointConnectionListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use privateEndpointConnectionsListByConfigurationStoreSignalError() instead")
    void privateEndpointConnectionsListByConfigurationStoreSignalE(OAIPrivateEndpointConnectionListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void privateEndpointConnectionsListByConfigurationStoreSignalError(OAIPrivateEndpointConnectionListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use privateEndpointConnectionsListByConfigurationStoreSignalErrorFull() instead")
    void privateEndpointConnectionsListByConfigurationStoreSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void privateEndpointConnectionsListByConfigurationStoreSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
