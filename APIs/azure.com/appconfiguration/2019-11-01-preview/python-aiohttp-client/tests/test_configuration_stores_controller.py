...
async def test_configuration_stores_create(client):
    ...
    """
    config_store_creation_parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"tenantId","principalId":"principalId","type":"None"},"sku":{"name":"name"},"properties":{"endpoint":"endpoint","encryption":{"keyVaultProperties":{"keyIdentifier":"keyIdentifier","identityClientId":"identityClientId"}},"provisioningState":"Creating","creationDate":"2000-01-23T04:56:07.000+00:00"}}
...
async def test_configuration_stores_update(client):
    ...
    """
    config_store_update_parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"tenantId","principalId":"principalId","type":"None"},"sku":{"name":"name"},"properties":{"encryption":{"keyVaultProperties":{"keyIdentifier":"keyIdentifier","identityClientId":"identityClientId"}}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
