...
import OperationDefinitionDisplay from './OperationDefinitionDisplay';
...
class OperationDefinition {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('display')) {
                obj['display'] = OperationDefinitionDisplay.constructFromObject(data['display']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['display']) { // data not null
          OperationDefinitionDisplay.validateJSON(data['display']);
        }
...
/**
 * @member {module:model/OperationDefinitionDisplay} display
 */
