...
/*
 * OAIOperationDefinitionDisplay.h
 *
 * The display information for a configuration store operation.
 */

#ifndef OAIOperationDefinitionDisplay_H
#define OAIOperationDefinitionDisplay_H
...
class OAIOperationDefinitionDisplay : public OAIObject {
public:
    OAIOperationDefinitionDisplay();
    OAIOperationDefinitionDisplay(QString json);
    ~OAIOperationDefinitionDisplay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOperationDefinitionDisplay)

#endif // OAIOperationDefinitionDisplay_H
