...
QMap<QString, OAIUserIdentity> OAIResourceIdentity::getUserAssignedIdentities() const {
    return m_user_assigned_identities;
}
void OAIResourceIdentity::setUserAssignedIdentities(const QMap<QString, OAIUserIdentity> &user_assigned_identities) {
    m_user_assigned_identities = user_assigned_identities;
    m_user_assigned_identities_isSet = true;
}

bool OAIResourceIdentity::is_user_assigned_identities_Set() const{
    return m_user_assigned_identities_isSet;
}

bool OAIResourceIdentity::is_user_assigned_identities_Valid() const{
