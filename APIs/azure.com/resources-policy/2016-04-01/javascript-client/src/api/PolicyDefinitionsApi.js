...
export default class PolicyDefinitionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the policyDefinitionsList operation.
     * @callback module:api/PolicyDefinitionsApi~policyDefinitionsListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PolicyDefinitionListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PolicyDefinitionsApi~policyDefinitionsListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PolicyDefinitionListResult}
     */
    policyDefinitionsList(apiVersion, subscriptionId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling policyDefinitionsList");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling policyDefinitionsList");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json', 'text/json'];
      let returnType = PolicyDefinitionListResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policydefinitions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
