...
**files** | [**[FileDTO]**](FileDTO.md) | List of files from which to Extract Q-A. | [optional] 
**language** | **String** | Language of the knowledgebase. | [optional] 
**name** | **String** | Friendly name for the knowledgebase. | 
**qnaList** | [**[QnADTO]**](QnADTO.md) | List of Q-A (QnADTO) to be added to the knowledgebase. Q-A Ids are assigned by the service and should be omitted. | [optional] 
**urls** | **[String]** | List of URLs to be used for extracting Q-A. | [optional] 
