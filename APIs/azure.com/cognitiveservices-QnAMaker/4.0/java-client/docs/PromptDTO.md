...
|------------ | ------------- | ------------- | -------------|
|**displayOrder** | **Integer** | Index of the prompt - used in ordering of the prompts |  [optional] |
...
|**qnaId** | **Integer** | Qna id corresponding to the prompt - if QnaId is present, QnADTO object is ignored. |  [optional] |
