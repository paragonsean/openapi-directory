...
|------------- | ------------- | -------------|
| [**notificationHubsCheckNotificationHubAvailability**](NotificationHubsApi.md#notificationHubsCheckNotificationHubAvailability) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/checkNotificationHubAvailability |  |
...
| [**notificationHubsDebugSend**](NotificationHubsApi.md#notificationHubsDebugSend) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs/{notificationHubName}/debugsend |  |
...
| [**notificationHubsPatch**](NotificationHubsApi.md#notificationHubsPatch) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/notificationHubs/{notificationHubName} |  |
...
<a id="notificationHubsCheckNotificationHubAvailability"></a>
# **notificationHubsCheckNotificationHubAvailability**
> CheckAvailabilityResult notificationHubsCheckNotificationHubAvailability(resourceGroupName, namespaceName, apiVersion, subscriptionId, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CheckAvailabilityResult result = apiInstance.notificationHubsCheckNotificationHubAvailability(resourceGroupName, namespaceName, apiVersion, subscriptionId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NotificationHubsApi#notificationHubsCheckNotificationHubAvailability");
...
|-------------|-------------|------------------|
| **200** | Checks if the NotificationHub name is a valid available name |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | NotificationHub is Created/Updated |  -  |
| **201** | NotificationHub is Created/Updated |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | NotificationHub AuthorizationRule is Created/Updated |  -  |

<a id="notificationHubsDebugSend"></a>
# **notificationHubsDebugSend**
> DebugSendResponse notificationHubsDebugSend(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    String subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    Object parameters = null; // Object | Debug send parameters
    try {
      DebugSendResponse result = apiInstance.notificationHubsDebugSend(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NotificationHubsApi#notificationHubsDebugSend");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **apiVersion** | **String**| Client Api Version. | |
| **subscriptionId** | **String**| Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | |
| **parameters** | **Object**| Debug send parameters | [optional] |

### Return type

[**DebugSendResponse**](DebugSendResponse.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | NotificationHub AuthorizationRule is deleted |  -  |
| **204** | NotificationHub AuthorizationRule is already deleted |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Get NotificationHub AuthorizationRule |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      PnsCredentialsResource result = apiInstance.notificationHubsGetPnsCredentials(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId);
      System.out.println(result);
    } catch (ApiException e) {
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Gets all the NotificationHub PNS credentials |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Get all NotificationHubs within a Namespace |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Get all NotificationHub AuthorizationRules |  -  |
...
<a id="notificationHubsPatch"></a>
# **notificationHubsPatch**
> NotificationHubResource notificationHubsPatch(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    String subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    NotificationHubPatchParameters parameters = new NotificationHubPatchParameters(); // NotificationHubPatchParameters | Parameters supplied to patch a NotificationHub Resource.
    try {
      NotificationHubResource result = apiInstance.notificationHubsPatch(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NotificationHubsApi#notificationHubsPatch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **apiVersion** | **String**| Client Api Version. | |
| **subscriptionId** | **String**| Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | |
| **parameters** | [**NotificationHubPatchParameters**](NotificationHubPatchParameters.md)| Parameters supplied to patch a NotificationHub Resource. | [optional] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | NotificationHub is patched |  -  |

<a id="notificationHubsRegenerateKeys"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    String subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    PolicykeyResource parameters = new PolicykeyResource(); // PolicykeyResource | Parameters supplied to regenerate the NotificationHub Authorization Rule Key.
    try {
      ResourceListKeys result = apiInstance.notificationHubsRegenerateKeys(resourceGroupName, namespaceName, notificationHubName, authorizationRuleName, apiVersion, subscriptionId, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NotificationHubsApi#notificationHubsRegenerateKeys");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
