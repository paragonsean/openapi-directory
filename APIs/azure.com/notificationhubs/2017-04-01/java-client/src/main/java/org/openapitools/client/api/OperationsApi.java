...
public class OperationsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 0 </td><td> NotificationHubs error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.NotificationHubs/operations";
