...
apiInstance.notificationHubsCheckNotificationHubAvailability(resourceGroupName, namespaceName, apiVersion, subscriptionId, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> DebugSendResponse notificationHubsDebugSend(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, opts)
...
let subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let opts = {
  'parameters': {key: null} // Object | Debug send parameters
};
apiInstance.notificationHubsDebugSend(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NotificationHubResource notificationHubsPatch(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, opts)
...
let subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let opts = {
  'parameters': new NotificationHubsManagementClient.NotificationHubPatchParameters() // NotificationHubPatchParameters | Parameters supplied to patch a NotificationHub Resource.
};
apiInstance.notificationHubsPatch(resourceGroupName, namespaceName, notificationHubName, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
