...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationHubsManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new NotificationHubsManagementClient.OperationDisplay();
      //expect(instance).to.be.a(NotificationHubsManagementClient.OperationDisplay);
    });
