...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationHubsManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new NotificationHubsManagementClient.Operation();
      //expect(instance).to.be.a(NotificationHubsManagementClient.Operation);
    });
