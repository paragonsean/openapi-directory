...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationHubsManagementClient.Sku();
  });
  ...
  describe('Sku', function() {
    it('should create an instance of Sku', function() {
      ...
      //var instance = new NotificationHubsManagementClient.Sku();
      //expect(instance).to.be.a(NotificationHubsManagementClient.Sku);
    });
