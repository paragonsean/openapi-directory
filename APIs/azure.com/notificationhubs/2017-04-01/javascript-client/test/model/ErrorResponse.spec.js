...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NotificationHubsManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new NotificationHubsManagementClient.ErrorResponse();
      //expect(instance).to.be.a(NotificationHubsManagementClient.ErrorResponse);
    });
