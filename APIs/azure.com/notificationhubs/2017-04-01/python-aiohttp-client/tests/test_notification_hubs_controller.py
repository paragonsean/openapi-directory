...
async def test_notification_hubs_check_notification_hub_availability(client):
...
async def test_notification_hubs_create_or_update(client):
    ...
    """
    parameters = {"properties":{"baiduCredential":{"properties":{"baiduApiKey":"baiduApiKey","baiduSecretKey":"baiduSecretKey","baiduEndPoint":"baiduEndPoint"}},"mpnsCredential":{"properties":{"mpnsCertificate":"mpnsCertificate","thumbprint":"thumbprint","certificateKey":"certificateKey"}},"apnsCredential":{"properties":{"endpoint":"endpoint","appName":"appName","appId":"appId","thumbprint":"thumbprint","keyId":"keyId","certificateKey":"certificateKey","apnsCertificate":"apnsCertificate","token":"token"}},"authorizationRules":[{"claimType":"claimType","modifiedTime":"modifiedTime","secondaryKey":"secondaryKey","rights":["Manage","Manage"],"keyName":"keyName","createdTime":"createdTime","claimValue":"claimValue","primaryKey":"primaryKey","revision":0},{"claimType":"claimType","modifiedTime":"modifiedTime","secondaryKey":"secondaryKey","rights":["Manage","Manage"],"keyName":"keyName","createdTime":"createdTime","claimValue":"claimValue","primaryKey":"primaryKey","revision":0}],"gcmCredential":{"properties":{"googleApiKey":"googleApiKey","gcmEndpoint":"gcmEndpoint"}},"name":"name","registrationTtl":"registrationTtl","wnsCredential":{"properties":{"secretKey":"secretKey","packageSid":"packageSid","windowsLiveEndpoint":"windowsLiveEndpoint"}},"admCredential":{"properties":{"clientId":"clientId","authTokenUrl":"authTokenUrl","clientSecret":"clientSecret"}}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_notification_hubs_create_or_update_authorization_rule(client):
    ...
    """
    parameters = {"properties":{"claimType":"claimType","modifiedTime":"modifiedTime","secondaryKey":"secondaryKey","rights":["Manage","Manage"],"keyName":"keyName","createdTime":"createdTime","claimValue":"claimValue","primaryKey":"primaryKey","revision":0}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_notification_hubs_debug_send(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/{namespace_name}/notificationHubs/{notification_hub_name}/debugsend'.format(resource_group_name='resource_group_name_example', namespace_name='namespace_name_example', notification_hub_name='notification_hub_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
...
async def test_notification_hubs_patch(client):
...
async def test_notification_hubs_regenerate_keys(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/{namespace_name}/notificationHubs/{notification_hub_name}/AuthorizationRules/{authorization_rule_name}/regenerateKeys'.format(resource_group_name='resource_group_name_example', namespace_name='namespace_name_example', notification_hub_name='notification_hub_name_example', authorization_rule_name='authorization_rule_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
