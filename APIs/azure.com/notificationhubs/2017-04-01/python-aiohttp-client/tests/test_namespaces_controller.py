...
async def test_namespaces_create_or_update(client):
    ...
    """
    parameters = {"properties":{"critical":True,"serviceBusEndpoint":"serviceBusEndpoint","dataCenter":"dataCenter","provisioningState":"provisioningState","enabled":True,"namespaceType":"Messaging","createdAt":"2000-01-23T04:56:07.000+00:00","metricId":"metricId","name":"name","region":"region","subscriptionId":"subscriptionId","scaleUnit":"scaleUnit","status":"status","updatedAt":"2000-01-23T04:56:07.000+00:00"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
