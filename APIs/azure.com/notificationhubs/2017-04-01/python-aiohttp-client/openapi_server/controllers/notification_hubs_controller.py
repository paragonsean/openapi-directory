...
async def notification_hubs_check_notification_hub_availability(request: web.Request, resource_group_name, namespace_name, api_version, subscription_id, parameters) -> web.Response:
    """notification_hubs_check_notification_hub_availability
...
async def notification_hubs_debug_send(request: web.Request, resource_group_name, namespace_name, notification_hub_name, api_version, subscription_id, parameters=None) -> web.Response:
    """notification_hubs_debug_send
...
async def notification_hubs_patch(request: web.Request, resource_group_name, namespace_name, notification_hub_name, api_version, subscription_id, parameters=None) -> web.Response:
    """notification_hubs_patch
    ...
    """
    parameters = NotificationHubPatchParameters.from_dict(parameters)
    return web.Response(status=200)


async def notification_hubs_regenerate_keys(request: web.Request, resource_group_name, namespace_name, notification_hub_name, authorization_rule_name, api_version, subscription_id, parameters) -> web.Response:
    """notification_hubs_regenerate_keys
