...
Q_SIGNALS:
    ...
    void namespacesListKeysSignal(OAISharedAccessAuthorizationRuleListResult summary);
    ...
    void namespacesListKeysSignalFull(OAIHttpRequestWorker *worker, OAISharedAccessAuthorizationRuleListResult summary);
    ...
    void namespacesListKeysSignalE(OAISharedAccessAuthorizationRuleListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void namespacesListKeysSignalError(OAISharedAccessAuthorizationRuleListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
