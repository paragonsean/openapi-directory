...
export default class NamespacesApi {
    ...
    */
    ...
    namespacesGetAuthorizationRule(resourceGroupName, namespaceName, authorizationRuleName, apiVersion, subscriptionId, callback) {
      ...
      let returnType = SharedAccessAuthorizationRuleResource;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/AuthorizationRules/{authorizationRuleName}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the namespacesGetLongRunningOperationStatus operation.
     * @callback module:api/NamespacesApi~namespacesGetLongRunningOperationStatusCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} operationStatusLink Location value returned by the Begin operation.
     * @param {module:api/NamespacesApi~namespacesGetLongRunningOperationStatusCallback} callback The callback function, accepting three arguments: error, data, response
     */
    namespacesGetLongRunningOperationStatus(operationStatusLink, callback) {
      let postBody = null;
      // verify the required parameter 'operationStatusLink' is set
      if (operationStatusLink === undefined || operationStatusLink === null) {
        throw new Error("Missing the required parameter 'operationStatusLink' when calling namespacesGetLongRunningOperationStatus");
      }
    ...
    namespacesListAuthorizationRules(resourceGroupName, namespaceName, apiVersion, subscriptionId, callback) {
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NotificationHubs/namespaces/{namespaceName}/AuthorizationRules', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
