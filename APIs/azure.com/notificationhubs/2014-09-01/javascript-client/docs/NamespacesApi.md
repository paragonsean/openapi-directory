...
let apiInstance = new NotificationHubsManagementClient.NamespacesApi();
let operationStatusLink = "operationStatusLink_example"; // String | Location value returned by the Begin operation.
apiInstance.namespacesGetLongRunningOperationStatus(operationStatusLink, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
