...
(function(root, factory) {
  ...
  describe('NamespacesApi', function() {
    ...
    describe('namespacesGetLongRunningOperationStatus', function() {
      it('should call namespacesGetLongRunningOperationStatus successfully', function(done) {
        //uncomment below and update the code to test namespacesGetLongRunningOperationStatus
        //instance.namespacesGetLongRunningOperationStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
