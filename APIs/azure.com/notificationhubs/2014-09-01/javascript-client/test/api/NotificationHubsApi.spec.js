...
(function(root, factory) {
  ...
  describe('NotificationHubsApi', function() {
    describe('notificationHubsCheckAvailability', function() {
      it('should call notificationHubsCheckAvailability successfully', function(done) {
        //uncomment below and update the code to test notificationHubsCheckAvailability
        //instance.notificationHubsCheckAvailability(function(error) {
