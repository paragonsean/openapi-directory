...
|**namespaceType** | [**NamespaceTypeEnum**](#NamespaceTypeEnum) | Gets or sets the namespace type. |  [optional] |
|**provisioningState** | **String** | Gets or sets provisioning state of the Namespace. |  [optional] |
