...
class SharedAccessAuthorizationRuleProperties(Model):
    ...
    def __init__(self, claim_type: str=None, claim_value: str=None, created_time: datetime=None, key_name: str=None, modified_time: datetime=None, primary_key: str=None, revision: int=None, rights: List[str]=None, secondary_key: str=None):
