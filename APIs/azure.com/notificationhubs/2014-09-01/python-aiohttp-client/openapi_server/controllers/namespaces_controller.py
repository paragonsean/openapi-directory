...
async def namespaces_get_long_running_operation_status(request: web.Request, operation_status_link) -> web.Response:
    ...
    :param operation_status_link: Location value returned by the Begin operation.
    :type operation_status_link: str
