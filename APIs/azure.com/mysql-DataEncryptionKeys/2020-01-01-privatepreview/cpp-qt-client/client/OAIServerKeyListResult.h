...
/*
 * OAIServerKeyListResult.h
 *
 * A list of MySQL Server keys.
 */

#ifndef OAIServerKeyListResult_H
#define OAIServerKeyListResult_H
...
class OAIServerKeyListResult : public OAIObject {
public:
    OAIServerKeyListResult();
    OAIServerKeyListResult(QString json);
    ~OAIServerKeyListResult() override;
    ...
    QList<OAIServerKey> getValue() const;
    void setValue(const QList<OAIServerKey> &value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerKeyListResult)

#endif // OAIServerKeyListResult_H
