...
/**
 * The BlobServiceWritableSettings model module.
 * @module model/BlobServiceWritableSettings
 * @version 2015-12-01-preview
 */
class BlobServiceWritableSettings {
    /**
     * Constructs a new <code>BlobServiceWritableSettings</code>.
     * Settings of BLOB service.
     * @alias module:model/BlobServiceWritableSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>BlobServiceWritableSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlobServiceWritableSettings} obj Optional instance to populate.
     * @return {module:model/BlobServiceWritableSettings} The populated <code>BlobServiceWritableSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlobServiceWritableSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>BlobServiceWritableSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlobServiceWritableSettings</code>.
     */
 ...
 */
BlobServiceWritableSettings.prototype['blobSvcContainerGcInterval'] = undefined;

/**
 * The interval ,in seconds, of shallow garbage collection.
 * @member {Number} blobSvcShallowGcInterval
 */
BlobServiceWritableSettings.prototype['blobSvcShallowGcInterval'] = undefined;

/**
 * The minimal container occupancy percent for stream mapping.
 * @member {Number} blobSvcStreamMapMinContainerOccupancyPercent
 */
BlobServiceWritableSettings.prototype['blobSvcStreamMapMinContainerOccupancyPercent'] = undefined;
...
export default BlobServiceWritableSettings;
