...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.BlobServiceSettings();
  });
  ...
  describe('BlobServiceSettings', function() {
    it('should create an instance of BlobServiceSettings', function() {
      // uncomment below and update the code to test BlobServiceSettings
      //var instance = new StorageManagementClient.BlobServiceSettings();
      //expect(instance).to.be.a(StorageManagementClient.BlobServiceSettings);
    });
