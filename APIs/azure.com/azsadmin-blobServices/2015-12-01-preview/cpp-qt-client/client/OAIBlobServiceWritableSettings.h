...
/*
 * OAIBlobServiceWritableSettings.h
 *
 * Settings of BLOB service.
 */

#ifndef OAIBlobServiceWritableSettings_H
#define OAIBlobServiceWritableSettings_H
...
class OAIBlobServiceWritableSettings : public OAIObject {
public:
    OAIBlobServiceWritableSettings();
    OAIBlobServiceWritableSettings(QString json);
    ~OAIBlobServiceWritableSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlobServiceWritableSettings)

#endif // OAIBlobServiceWritableSettings_H
