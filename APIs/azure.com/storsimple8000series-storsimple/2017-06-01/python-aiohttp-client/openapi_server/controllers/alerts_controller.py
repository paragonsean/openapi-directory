...
async def alerts_clear(request: web.Request, subscription_id, resource_group_name, manager_name, api_version, parameters) -> web.Response:
    """alerts_clear
    ...
    """
    parameters = ClearAlertRequest.from_dict(parameters)
...
async def alerts_send_test_email(request: web.Request, device_name, subscription_id, resource_group_name, manager_name, api_version, parameters) -> web.Response:
    ...
    """
    parameters = SendTestAlertEmailRequest.from_dict(parameters)
    return web.Response(status=200)
