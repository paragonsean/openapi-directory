...
class Device(Model):
    ...
    def __init__(self, properties: DeviceProperties=None, id: str=None, kind: str=None, name: str=None, type: str=None):
    ...
    @property
    def kind(self):
        """Gets the kind of this Device.

        The Kind of the object. Currently only Series8000 is supported

        :return: The kind of this Device.
        :rtype: str
        """
        return self._kind
