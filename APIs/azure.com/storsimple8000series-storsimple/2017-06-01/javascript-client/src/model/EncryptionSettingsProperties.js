...
class EncryptionSettingsProperties {
     ...
     * @param encryptionStatus {module:model/EncryptionSettingsProperties.EncryptionStatusEnum} The encryption status to indicates if encryption is enabled or not.
     * @param keyRolloverStatus {module:model/EncryptionSettingsProperties.KeyRolloverStatusEnum} The key rollover status to indicates if key rollover is required or not. If secret's encryption has been upgraded, then it requires key rollover.
     */
