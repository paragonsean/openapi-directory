...
import EncryptionSettingsProperties from './EncryptionSettingsProperties';
...
class EncryptionSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = EncryptionSettingsProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of EncryptionSettings.RequiredProperties) {
        ...
        if (data['properties']) { // data not null
          EncryptionSettingsProperties.validateJSON(data['properties']);
        }
...
EncryptionSettings.RequiredProperties = ["properties"];

/**
 * @member {module:model/EncryptionSettingsProperties} properties
 */
EncryptionSettings.prototype['properties'] = undefined;

/**
 * The path ID that uniquely identifies the object.
 * @member {String} id
 */
EncryptionSettings.prototype['id'] = undefined;

/**
 * The Kind of the object. Currently only Series8000 is supported
 * @member {module:model/EncryptionSettings.KindEnum} kind
 */
EncryptionSettings.prototype['kind'] = undefined;

/**
 * The name of the object.
 * @member {String} name
 */
EncryptionSettings.prototype['name'] = undefined;

/**
 * The hierarchical type of the object.
 * @member {String} type
 */
EncryptionSettings.prototype['type'] = undefined;
