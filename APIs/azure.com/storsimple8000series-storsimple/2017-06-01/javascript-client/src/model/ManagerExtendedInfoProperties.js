...
class ManagerExtendedInfoProperties {
     ...
     * @param algorithm {String} Represents the encryption algorithm used to encrypt the keys. None - if Key is saved in plain text format. Algorithm name - if key is encrypted
