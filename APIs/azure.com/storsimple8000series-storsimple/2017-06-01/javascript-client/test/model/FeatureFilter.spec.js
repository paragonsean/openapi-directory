...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.FeatureFilter();
  });
  ...
  describe('FeatureFilter', function() {
    it('should create an instance of FeatureFilter', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.FeatureFilter();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.FeatureFilter);
    });
