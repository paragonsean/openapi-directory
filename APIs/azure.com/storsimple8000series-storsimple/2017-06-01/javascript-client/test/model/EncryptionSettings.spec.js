...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.EncryptionSettings();
  });
  ...
  describe('EncryptionSettings', function() {
    it('should create an instance of EncryptionSettings', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.EncryptionSettings();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.EncryptionSettings);
    });
