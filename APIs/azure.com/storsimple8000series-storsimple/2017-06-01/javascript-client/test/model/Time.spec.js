...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.Time();
  });
  ...
  describe('Time', function() {
    it('should create an instance of Time', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.Time();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.Time);
    });
