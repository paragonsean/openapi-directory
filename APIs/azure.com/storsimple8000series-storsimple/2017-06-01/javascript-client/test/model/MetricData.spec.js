...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.MetricData();
  });
  ...
  describe('MetricData', function() {
    it('should create an instance of MetricData', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.MetricData();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.MetricData);
    });
