...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.AlertFilter();
  });
  ...
  describe('AlertFilter', function() {
    it('should create an instance of AlertFilter', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.AlertFilter();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.AlertFilter);
    });
