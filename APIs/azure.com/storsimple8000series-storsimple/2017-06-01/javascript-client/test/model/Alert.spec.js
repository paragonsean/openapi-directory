...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.Alert();
  });
  ...
  describe('Alert', function() {
    it('should create an instance of Alert', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.Alert();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.Alert);
    });
