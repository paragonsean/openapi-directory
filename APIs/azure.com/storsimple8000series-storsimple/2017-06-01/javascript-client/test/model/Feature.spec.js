...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.Feature();
  });
  ...
  describe('Feature', function() {
    it('should create an instance of Feature', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.Feature();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.Feature);
    });
