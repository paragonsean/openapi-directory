...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.VmImage();
  });
  ...
  describe('VmImage', function() {
    it('should create an instance of VmImage', function() {
      // uncomment below and update the code to test VmImage
      //var instance = new StorSimple8000SeriesManagementClient.VmImage();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.VmImage);
    });
