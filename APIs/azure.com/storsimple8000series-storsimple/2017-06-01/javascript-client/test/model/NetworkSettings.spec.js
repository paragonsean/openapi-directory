...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.NetworkSettings();
  });
  ...
  describe('NetworkSettings', function() {
    it('should create an instance of NetworkSettings', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.NetworkSettings();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.NetworkSettings);
    });
