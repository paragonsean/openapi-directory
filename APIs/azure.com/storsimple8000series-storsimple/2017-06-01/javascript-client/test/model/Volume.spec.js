...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.Volume();
  });
  ...
  describe('Volume', function() {
    it('should create an instance of Volume', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.Volume();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.Volume);
    });
