...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimple8000SeriesManagementClient.Backup();
  });
  ...
  describe('Backup', function() {
    it('should create an instance of Backup', function() {
      ...
      //var instance = new StorSimple8000SeriesManagementClient.Backup();
      //expect(instance).to.be.a(StorSimple8000SeriesManagementClient.Backup);
    });
