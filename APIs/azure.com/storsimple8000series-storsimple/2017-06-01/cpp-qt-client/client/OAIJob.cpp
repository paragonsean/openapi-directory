...
OAIJobErrorDetails OAIJob::getError() const {
    return m_error;
}
void OAIJob::setError(const OAIJobErrorDetails &error) {
    m_error = error;
    m_error_isSet = true;
}
...
qint32 OAIJob::getPercentComplete() const {
    return m_percent_complete;
}
void OAIJob::setPercentComplete(const qint32 &percent_complete) {
    m_percent_complete = percent_complete;
    m_percent_complete_isSet = true;
}

bool OAIJob::is_percent_complete_Set() const{
    return m_percent_complete_isSet;
}

bool OAIJob::is_percent_complete_Valid() const{
...
bool OAIJob::isValid() const {
    ...
    return m_percent_complete_isValid && m_status_isValid && true;
}
