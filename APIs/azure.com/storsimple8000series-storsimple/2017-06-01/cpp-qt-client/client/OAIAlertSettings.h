...
namespace OpenAPI {
class OAIAlertNotificationProperties;
...
public:
    ...
    OAIAlertNotificationProperties getProperties() const;
    void setProperties(const OAIAlertNotificationProperties &properties);
...
private:
    ...
    OAIAlertNotificationProperties m_properties;
