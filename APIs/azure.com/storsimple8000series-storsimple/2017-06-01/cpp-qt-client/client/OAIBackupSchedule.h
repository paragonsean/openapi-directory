...
namespace OpenAPI {
class OAIBackupScheduleProperties;
...
public:
    ...
    OAIBackupScheduleProperties getProperties() const;
    void setProperties(const OAIBackupScheduleProperties &properties);
...
private:
    ...
    OAIBackupScheduleProperties m_properties;
