...
OAIBackupProperties OAIBackup::getProperties() const {
    return m_properties;
}
void OAIBackup::setProperties(const OAIBackupProperties &properties) {
...
QString OAIBackup::getKind() const {
    return m_kind;
}
void OAIBackup::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIBackup::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIBackup::is_kind_Valid() const{
