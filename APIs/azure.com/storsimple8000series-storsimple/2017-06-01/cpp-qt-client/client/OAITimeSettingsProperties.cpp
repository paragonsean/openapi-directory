...
QJsonObject OAITimeSettingsProperties::asJsonObject() const {
    ...
    if (m_secondary_time_server.size() > 0) {
...
QList<QString> OAITimeSettingsProperties::getSecondaryTimeServer() const {
    return m_secondary_time_server;
}
void OAITimeSettingsProperties::setSecondaryTimeServer(const QList<QString> &secondary_time_server) {
...
bool OAITimeSettingsProperties::isValid() const {
    ...
    return m_time_zone_isValid && true;
}
