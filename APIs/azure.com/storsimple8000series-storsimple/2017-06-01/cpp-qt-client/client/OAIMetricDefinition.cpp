...
QString OAIMetricDefinition::getCategory() const {
    return m_category;
}
void OAIMetricDefinition::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIMetricDefinition::is_category_Set() const{
    return m_category_isSet;
}

bool OAIMetricDefinition::is_category_Valid() const{
