...
Q_SIGNALS:
    ...
    void operationsListSignal(OAIAvailableProviderOperationList summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIAvailableProviderOperationList summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(OAIAvailableProviderOperationList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(OAIAvailableProviderOperationList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
