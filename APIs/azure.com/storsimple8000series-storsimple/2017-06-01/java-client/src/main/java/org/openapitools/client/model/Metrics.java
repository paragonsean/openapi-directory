...
public class Metrics {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("primaryAggregation") != null && !jsonObj.get("primaryAggregation").isJsonNull()) && !jsonObj.get("primaryAggregation").isJsonPrimitive()) {
      ...
      // validate the optional field `primaryAggregation`
      if (jsonObj.get("primaryAggregation") != null && !jsonObj.get("primaryAggregation").isJsonNull()) {
