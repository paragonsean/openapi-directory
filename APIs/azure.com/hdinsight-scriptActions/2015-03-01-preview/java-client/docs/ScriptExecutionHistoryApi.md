...
| [**scriptExecutionHistoryList**](ScriptExecutionHistoryApi.md#scriptExecutionHistoryList) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HDInsight/clusters/{clusterName}/scriptExecutionHistory |  |
...
<a id="scriptExecutionHistoryList"></a>
# **scriptExecutionHistoryList**
> ScriptActionExecutionHistoryList scriptExecutionHistoryList(subscriptionId, resourceGroupName, clusterName, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The HDInsight client API Version.
    try {
      ScriptActionExecutionHistoryList result = apiInstance.scriptExecutionHistoryList(subscriptionId, resourceGroupName, clusterName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ScriptExecutionHistoryApi#scriptExecutionHistoryList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
