...
<a id="scriptActionsListPersistedScripts"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The HDInsight client API Version.
    try {
      ScriptActionsList result = apiInstance.scriptActionsListPersistedScripts(subscriptionId, resourceGroupName, clusterName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ScriptActionsApi#scriptActionsListPersistedScripts");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
