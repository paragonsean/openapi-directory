...
import TdeCertificateProperties from './model/TdeCertificateProperties';
import ManagedInstanceTdeCertificatesApi from './api/ManagedInstanceTdeCertificatesApi';
...
export {
    ...
    /**
     * The TdeCertificate model constructor.
     * @property {module:model/TdeCertificate}
     */
    TdeCertificate,

    /**
     * The TdeCertificateProperties model constructor.
     * @property {module:model/TdeCertificateProperties}
     */
    TdeCertificateProperties,

    /**
    * The ManagedInstanceTdeCertificatesApi service constructor.
    * @property {module:api/ManagedInstanceTdeCertificatesApi}
    */
