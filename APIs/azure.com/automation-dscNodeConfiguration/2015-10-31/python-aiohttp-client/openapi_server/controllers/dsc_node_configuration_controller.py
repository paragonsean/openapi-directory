...
async def dsc_node_configuration_create_or_update(request: web.Request, resource_group_name, automation_account_name, node_configuration_name, subscription_id, api_version, parameters) -> web.Response:
    ...
    :param node_configuration_name: The create or update parameters for configuration.
...
async def dsc_node_configuration_delete(request: web.Request, resource_group_name, automation_account_name, node_configuration_name, subscription_id, api_version) -> web.Response:
...
async def dsc_node_configuration_get(request: web.Request, resource_group_name, automation_account_name, node_configuration_name, subscription_id, api_version) -> web.Response:
...
async def dsc_node_configuration_list_by_automation_account(request: web.Request, resource_group_name, automation_account_name, subscription_id, api_version, filter=None) -> web.Response:
