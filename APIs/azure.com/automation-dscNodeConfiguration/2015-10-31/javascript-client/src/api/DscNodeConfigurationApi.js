...
export default class DscNodeConfigurationApi {
    ...
    */
     ...
     * @param {String} nodeConfigurationName The create or update parameters for configuration.
     ...
     */
    dscNodeConfigurationDelete(resourceGroupName, automationAccountName, nodeConfigurationName, subscriptionId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
     ...
     * data is of type: {@link module:model/DscNodeConfiguration}
     */
    dscNodeConfigurationGet(resourceGroupName, automationAccountName, nodeConfigurationName, subscriptionId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
