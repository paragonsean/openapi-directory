...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.DscNodeConfiguration();
  });
  ...
  describe('DscNodeConfiguration', function() {
    it('should create an instance of DscNodeConfiguration', function() {
      // uncomment below and update the code to test DscNodeConfiguration
      //var instance = new AutomationManagement.DscNodeConfiguration();
      //expect(instance).to.be.a(AutomationManagement.DscNodeConfiguration);
    });
