...
OAIAdminKeyResult::OAIAdminKeyResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminKeyResult::OAIAdminKeyResult() {
    this->initializeModel();
}

OAIAdminKeyResult::~OAIAdminKeyResult() {}

void OAIAdminKeyResult::initializeModel() {
...
void OAIAdminKeyResult::fromJson(QString jsonString) {
...
void OAIAdminKeyResult::fromJsonObject(QJsonObject json) {
...
QString OAIAdminKeyResult::asJson() const {
...
QJsonObject OAIAdminKeyResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminKeyResult::getPrimaryKey() const {
    return m_primary_key;
}
void OAIAdminKeyResult::setPrimaryKey(const QString &primary_key) {
    m_primary_key = primary_key;
    m_primary_key_isSet = true;
}

bool OAIAdminKeyResult::is_primary_key_Set() const{
    return m_primary_key_isSet;
}

bool OAIAdminKeyResult::is_primary_key_Valid() const{
    return m_primary_key_isValid;
}

QString OAIAdminKeyResult::getSecondaryKey() const {
    return m_secondary_key;
}
void OAIAdminKeyResult::setSecondaryKey(const QString &secondary_key) {
    m_secondary_key = secondary_key;
    m_secondary_key_isSet = true;
}

bool OAIAdminKeyResult::is_secondary_key_Set() const{
    return m_secondary_key_isSet;
}

bool OAIAdminKeyResult::is_secondary_key_Valid() const{
    return m_secondary_key_isValid;
}

bool OAIAdminKeyResult::isSet() const {
...
bool OAIAdminKeyResult::isValid() const {
