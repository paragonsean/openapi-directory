...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmosDb.UniqueKey();
  });
  ...
  describe('UniqueKey', function() {
    it('should create an instance of UniqueKey', function() {
      // uncomment below and update the code to test UniqueKey
      //var instance = new CosmosDb.UniqueKey();
      //expect(instance).to.be.a(CosmosDb.UniqueKey);
    });
