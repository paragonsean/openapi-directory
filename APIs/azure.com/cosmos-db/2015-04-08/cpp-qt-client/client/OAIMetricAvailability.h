...
/*
 * OAIMetricAvailability.h
 *
 * The availability of the metric.
 */

#ifndef OAIMetricAvailability_H
#define OAIMetricAvailability_H
...
class OAIMetricAvailability : public OAIObject {
public:
    OAIMetricAvailability();
    OAIMetricAvailability(QString json);
    ~OAIMetricAvailability() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricAvailability)

#endif // OAIMetricAvailability_H
