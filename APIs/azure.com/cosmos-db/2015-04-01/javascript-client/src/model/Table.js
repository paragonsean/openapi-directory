...
class Table {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = TableProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          TableProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/TableProperties} properties
 */
Table.prototype['properties'] = undefined;
 ...
 */
Table.prototype['tags'] = undefined;
