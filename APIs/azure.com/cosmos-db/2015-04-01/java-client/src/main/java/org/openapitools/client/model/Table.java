...
import org.openapitools.client.model.TableProperties;
...
public class Table {
  ...
  public Table tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public Table putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    Table table = (Table) o;
    return Objects.equals(this.properties, table.properties) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        TableProperties.validateJsonElement(jsonObj.get("properties"));
      }
