...
/*
 * OAIDatabaseAccountGetProperties.h
 *
 * Properties for the database account.
 */

#ifndef OAIDatabaseAccountGetProperties_H
#define OAIDatabaseAccountGetProperties_H
...
class OAIDatabaseAccountGetProperties : public OAIObject {
public:
    OAIDatabaseAccountGetProperties();
    OAIDatabaseAccountGetProperties(QString json);
    ~OAIDatabaseAccountGetProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseAccountGetProperties)

#endif // OAIDatabaseAccountGetProperties_H
