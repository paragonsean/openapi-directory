...
/*
 * OAIDatabaseAccountUpdateProperties.h
 *
 * Properties to update Azure Cosmos DB database accounts.
 */

#ifndef OAIDatabaseAccountUpdateProperties_H
#define OAIDatabaseAccountUpdateProperties_H
...
class OAIDatabaseAccountUpdateProperties : public OAIObject {
public:
    OAIDatabaseAccountUpdateProperties();
    OAIDatabaseAccountUpdateProperties(QString json);
    ~OAIDatabaseAccountUpdateProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseAccountUpdateProperties)

#endif // OAIDatabaseAccountUpdateProperties_H
