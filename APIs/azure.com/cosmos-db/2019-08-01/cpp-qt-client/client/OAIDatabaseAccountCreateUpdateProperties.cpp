...
bool OAIDatabaseAccountCreateUpdateProperties::isDisableKeyBasedMetadataWriteAccess() const {
    return m_disable_key_based_metadata_write_access;
}
void OAIDatabaseAccountCreateUpdateProperties::setDisableKeyBasedMetadataWriteAccess(const bool &disable_key_based_metadata_write_access) {
...
bool OAIDatabaseAccountCreateUpdateProperties::is_disable_key_based_metadata_write_access_Set() const{
    return m_disable_key_based_metadata_write_access_isSet;
}

bool OAIDatabaseAccountCreateUpdateProperties::is_disable_key_based_metadata_write_access_Valid() const{
