...
/*
 * OAISqlContainerGetProperties_resource.h
 *
 * 
 */

#ifndef OAISqlContainerGetProperties_resource_H
#define OAISqlContainerGetProperties_resource_H
...
class OAISqlContainerGetProperties_resource : public OAIObject {
public:
    OAISqlContainerGetProperties_resource();
    OAISqlContainerGetProperties_resource(QString json);
    ~OAISqlContainerGetProperties_resource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISqlContainerGetProperties_resource)

#endif // OAISqlContainerGetProperties_resource_H
