...
public class GremlinGraphGetPropertiesResource {
  ...
  public GremlinGraphGetPropertiesResource conflictResolutionPolicy(ConflictResolutionPolicy conflictResolutionPolicy) {
  ...
  public GremlinGraphGetPropertiesResource defaultTtl(Integer defaultTtl) {
  ...
  public GremlinGraphGetPropertiesResource id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GremlinGraphGetPropertiesResource indexingPolicy(IndexingPolicy indexingPolicy) {
  ...
  public GremlinGraphGetPropertiesResource partitionKey(ContainerPartitionKey partitionKey) {
  ...
  public GremlinGraphGetPropertiesResource uniqueKeyPolicy(UniqueKeyPolicy uniqueKeyPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    GremlinGraphGetPropertiesResource gremlinGraphGetPropertiesResource = (GremlinGraphGetPropertiesResource) o;
    return Objects.equals(this.conflictResolutionPolicy, gremlinGraphGetPropertiesResource.conflictResolutionPolicy) &&
        Objects.equals(this.defaultTtl, gremlinGraphGetPropertiesResource.defaultTtl) &&
        Objects.equals(this.id, gremlinGraphGetPropertiesResource.id) &&
        Objects.equals(this.indexingPolicy, gremlinGraphGetPropertiesResource.indexingPolicy) &&
        Objects.equals(this.partitionKey, gremlinGraphGetPropertiesResource.partitionKey) &&
        Objects.equals(this.uniqueKeyPolicy, gremlinGraphGetPropertiesResource.uniqueKeyPolicy) &&
        Objects.equals(this.etag, gremlinGraphGetPropertiesResource.etag) &&
        Objects.equals(this.rid, gremlinGraphGetPropertiesResource.rid) &&
        Objects.equals(this.ts, gremlinGraphGetPropertiesResource.ts);
  }
  ...
  public String toString() {
    ...
    sb.append("class GremlinGraphGetPropertiesResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GremlinGraphGetPropertiesResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GremlinGraphGetPropertiesResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GremlinGraphGetPropertiesResource is not found in the empty JSON string", GremlinGraphGetPropertiesResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GremlinGraphGetPropertiesResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GremlinGraphGetPropertiesResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GremlinGraphGetPropertiesResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GremlinGraphGetPropertiesResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GremlinGraphGetPropertiesResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GremlinGraphGetPropertiesResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GremlinGraphGetPropertiesResource.class));

       return (TypeAdapter<T>) new TypeAdapter<GremlinGraphGetPropertiesResource>() {
           @Override
           public void write(JsonWriter out, GremlinGraphGetPropertiesResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GremlinGraphGetPropertiesResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GremlinGraphGetPropertiesResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GremlinGraphGetPropertiesResource
   * @throws IOException if the JSON string is invalid with respect to GremlinGraphGetPropertiesResource
   */
  public static GremlinGraphGetPropertiesResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GremlinGraphGetPropertiesResource.class);
  }

  /**
   * Convert an instance of GremlinGraphGetPropertiesResource to an JSON string
   *
   * @return JSON string
   */
