...
public class DatabaseAccountUpdateProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capabilities, connectorOffer, consistencyPolicy, disableKeyBasedMetadataWriteAccess, enableAutomaticFailover, enableCassandraConnector, enableMultipleWriteLocations, ipRangeFilter, isVirtualNetworkFilterEnabled, locations, virtualNetworkRules);
  }
