# CosmosDb.DatabaseAccountCreateUpdateProperties
...
**databaseAccountOfferType** | [**DatabaseAccountOfferType**](DatabaseAccountOfferType.md) |  | 
...
**locations** | [**[Location]**](Location.md) | An array that contains the georeplication locations enabled for the Cosmos DB account. | 
