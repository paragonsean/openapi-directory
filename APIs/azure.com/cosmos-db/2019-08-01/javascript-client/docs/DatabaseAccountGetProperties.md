# CosmosDb.DatabaseAccountGetProperties
...
**databaseAccountOfferType** | [**DatabaseAccountOfferType**](DatabaseAccountOfferType.md) |  | [optional] 
...
**failoverPolicies** | [**[FailoverPolicy]**](FailoverPolicy.md) | An array that contains the regions ordered by their failover priorities. | [optional] [readonly] 
...
**locations** | [**[Location]**](Location.md) | An array that contains all of the locations enabled for the Cosmos DB account. | [optional] [readonly] 
...
**readLocations** | [**[Location]**](Location.md) | An array that contains of the read locations enabled for the Cosmos DB account. | [optional] [readonly] 
...
**writeLocations** | [**[Location]**](Location.md) | An array that contains the write location for the Cosmos DB account. | [optional] [readonly] 
