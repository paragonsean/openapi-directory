# CosmosDb.ThroughputSettingsGetPropertiesResource

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**minimumThroughput** | **String** | The minimum throughput of the resource | [optional] [readonly] 
**offerReplacePending** | **String** | The throughput replace is pending | [optional] [readonly] 
**throughput** | **Number** | Value of the Cosmos DB resource throughput | 
