...
/*
 * OAISqlContainerProperties.h
 *
 * The properties of an Azure Cosmos DB container
 */

#ifndef OAISqlContainerProperties_H
#define OAISqlContainerProperties_H
...
class OAISqlContainerProperties : public OAIObject {
public:
    OAISqlContainerProperties();
    OAISqlContainerProperties(QString json);
    ~OAISqlContainerProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISqlContainerProperties)

#endif // OAISqlContainerProperties_H
