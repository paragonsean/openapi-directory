...
public class GremlinGraphProperties {
  ...
  public GremlinGraphProperties conflictResolutionPolicy(ConflictResolutionPolicy conflictResolutionPolicy) {
  ...
  public GremlinGraphProperties defaultTtl(Integer defaultTtl) {
  ...
  public GremlinGraphProperties id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GremlinGraphProperties indexingPolicy(IndexingPolicy indexingPolicy) {
  ...
  public GremlinGraphProperties partitionKey(ContainerPartitionKey partitionKey) {
  ...
  public GremlinGraphProperties uniqueKeyPolicy(UniqueKeyPolicy uniqueKeyPolicy) {
  ...
  public GremlinGraphProperties etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public GremlinGraphProperties rid(String rid) {
    this.rid = rid;
    return this;
  }
  ...
  public GremlinGraphProperties ts(Object ts) {
    this.ts = ts;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GremlinGraphProperties gremlinGraphProperties = (GremlinGraphProperties) o;
    return Objects.equals(this.conflictResolutionPolicy, gremlinGraphProperties.conflictResolutionPolicy) &&
        Objects.equals(this.defaultTtl, gremlinGraphProperties.defaultTtl) &&
        Objects.equals(this.id, gremlinGraphProperties.id) &&
        Objects.equals(this.indexingPolicy, gremlinGraphProperties.indexingPolicy) &&
        Objects.equals(this.partitionKey, gremlinGraphProperties.partitionKey) &&
        Objects.equals(this.uniqueKeyPolicy, gremlinGraphProperties.uniqueKeyPolicy) &&
        Objects.equals(this.etag, gremlinGraphProperties.etag) &&
        Objects.equals(this.rid, gremlinGraphProperties.rid) &&
        Objects.equals(this.ts, gremlinGraphProperties.ts);
  }
  ...
  public String toString() {
    ...
    sb.append("class GremlinGraphProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GremlinGraphProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GremlinGraphProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GremlinGraphProperties is not found in the empty JSON string", GremlinGraphProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GremlinGraphProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GremlinGraphProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GremlinGraphProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GremlinGraphProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GremlinGraphProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GremlinGraphProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GremlinGraphProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<GremlinGraphProperties>() {
           @Override
           public void write(JsonWriter out, GremlinGraphProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GremlinGraphProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GremlinGraphProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GremlinGraphProperties
   * @throws IOException if the JSON string is invalid with respect to GremlinGraphProperties
   */
  public static GremlinGraphProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GremlinGraphProperties.class);
  }

  /**
   * Convert an instance of GremlinGraphProperties to an JSON string
   *
   * @return JSON string
   */
