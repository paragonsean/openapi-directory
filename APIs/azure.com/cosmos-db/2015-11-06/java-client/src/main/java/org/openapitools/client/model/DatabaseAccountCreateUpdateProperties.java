...
public class DatabaseAccountCreateUpdateProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capabilities, connectorOffer, consistencyPolicy, databaseAccountOfferType, enableAutomaticFailover, enableCassandraConnector, enableMultipleWriteLocations, ipRangeFilter, isVirtualNetworkFilterEnabled, locations, virtualNetworkRules);
  }
