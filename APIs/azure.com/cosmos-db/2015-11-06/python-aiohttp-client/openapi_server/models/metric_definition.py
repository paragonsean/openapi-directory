...
class MetricDefinition(Model):
    ...
    def __init__(self, metric_availabilities: List[MetricAvailability]=None, name: MetricName=None, primary_aggregation_type: str=None, resource_uri: str=None, unit: UnitType=None):
