...
OAITableProperties OAITable::getProperties() const {
    return m_properties;
}
void OAITable::setProperties(const OAITableProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAITable::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAITable::is_properties_Valid() const{
...
QMap<QString, QString> OAITable::getTags() const {
    return m_tags;
}
void OAITable::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITable::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITable::is_tags_Valid() const{
