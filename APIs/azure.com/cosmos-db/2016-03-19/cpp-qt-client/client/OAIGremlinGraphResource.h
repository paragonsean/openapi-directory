...
/*
 * OAIGremlinGraphResource.h
 *
 * Cosmos DB Gremlin graph resource object
 */

#ifndef OAIGremlinGraphResource_H
#define OAIGremlinGraphResource_H
...
class OAIGremlinGraphResource : public OAIObject {
public:
    OAIGremlinGraphResource();
    OAIGremlinGraphResource(QString json);
    ~OAIGremlinGraphResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGremlinGraphResource)

#endif // OAIGremlinGraphResource_H
