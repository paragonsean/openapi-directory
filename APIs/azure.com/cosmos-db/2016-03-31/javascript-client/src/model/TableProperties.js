...
class TableProperties {
     ...
     */
    constructor(id) { 
        TableResource.initialize(this, id);
        TableProperties.initialize(this, id);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TableProperties.RequiredProperties) {
...
TableProperties.RequiredProperties = ["id"];

/**
 * Name of the Cosmos DB table
 * @member {String} id
 */
TableProperties.prototype['id'] = undefined;
