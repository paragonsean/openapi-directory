...
/*
 * OAIGremlinGraphProperties.h
 *
 * The properties of an Azure Cosmos DB Gremlin graph
 */

#ifndef OAIGremlinGraphProperties_H
#define OAIGremlinGraphProperties_H
...
class OAIGremlinGraphProperties : public OAIObject {
public:
    OAIGremlinGraphProperties();
    OAIGremlinGraphProperties(QString json);
    ~OAIGremlinGraphProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGremlinGraphProperties)

#endif // OAIGremlinGraphProperties_H
