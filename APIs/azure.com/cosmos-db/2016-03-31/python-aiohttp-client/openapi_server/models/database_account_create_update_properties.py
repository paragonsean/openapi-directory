...
class DatabaseAccountCreateUpdateProperties(Model):
    ...
    def __init__(self, capabilities: List[Capability]=None, connector_offer: ConnectorOffer=None, consistency_policy: ConsistencyPolicy=None, database_account_offer_type: DatabaseAccountOfferType=None, enable_automatic_failover: bool=None, enable_cassandra_connector: bool=None, enable_multiple_write_locations: bool=None, ip_range_filter: str=None, is_virtual_network_filter_enabled: bool=None, locations: List[Location]=None, virtual_network_rules: List[VirtualNetworkRule]=None):
