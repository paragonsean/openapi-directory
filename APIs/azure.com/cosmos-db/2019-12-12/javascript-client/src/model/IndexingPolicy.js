...
import SpatialSpec from './SpatialSpec';
...
class IndexingPolicy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('compositeIndexes')) {
                obj['compositeIndexes'] = ApiClient.convertToType(data['compositeIndexes'], [Array]);
            }
            ...
            if (data.hasOwnProperty('spatialIndexes')) {
                obj['spatialIndexes'] = ApiClient.convertToType(data['spatialIndexes'], [SpatialSpec]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['compositeIndexes'])) {
            throw new Error("Expected the field `compositeIndexes` to be an array in the JSON data but got " + data['compositeIndexes']);
        }
        ...
        if (data['spatialIndexes']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['spatialIndexes'])) {
                throw new Error("Expected the field `spatialIndexes` to be an array in the JSON data but got " + data['spatialIndexes']);
            }
            // validate the optional field `spatialIndexes` (array)
            for (const item of data['spatialIndexes']) {
                SpatialSpec.validateJSON(item);
            };
        }
 ...
 * @member {Array.<Array.<module:model/CompositePath>>} compositeIndexes
 */
IndexingPolicy.prototype['compositeIndexes'] = undefined;
 ...
 * @member {Array.<module:model/SpatialSpec>} spatialIndexes
 */
IndexingPolicy.prototype['spatialIndexes'] = undefined;
