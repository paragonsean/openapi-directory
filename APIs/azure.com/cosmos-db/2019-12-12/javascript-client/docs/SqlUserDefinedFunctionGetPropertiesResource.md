# CosmosDb.SqlUserDefinedFunctionGetPropertiesResource

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**body** | **String** | Body of the User Defined Function | [optional] 
**id** | **String** | Name of the Cosmos DB SQL userDefinedFunction | 
