...
QString OAIDatabaseAccountGetProperties::getKeyVaultKeyUri() const {
    return m_key_vault_key_uri;
}
void OAIDatabaseAccountGetProperties::setKeyVaultKeyUri(const QString &key_vault_key_uri) {
    m_key_vault_key_uri = key_vault_key_uri;
    m_key_vault_key_uri_isSet = true;
}

bool OAIDatabaseAccountGetProperties::is_key_vault_key_uri_Set() const{
    return m_key_vault_key_uri_isSet;
}

bool OAIDatabaseAccountGetProperties::is_key_vault_key_uri_Valid() const{
