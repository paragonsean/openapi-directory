...
void OAIDatabaseAccountCreateUpdateProperties::initializeModel() {
    ...
    m_key_vault_key_uri_isSet = false;
    m_key_vault_key_uri_isValid = false;
...
void OAIDatabaseAccountCreateUpdateProperties::fromJsonObject(QJsonObject json) {
    ...
    m_key_vault_key_uri_isValid = ::OpenAPI::fromJsonValue(m_key_vault_key_uri, json[QString("keyVaultKeyUri")]);
    m_key_vault_key_uri_isSet = !json[QString("keyVaultKeyUri")].isNull() && m_key_vault_key_uri_isValid;
...
QJsonObject OAIDatabaseAccountCreateUpdateProperties::asJsonObject() const {
    ...
    if (m_key_vault_key_uri_isSet) {
        obj.insert(QString("keyVaultKeyUri"), ::OpenAPI::toJsonValue(m_key_vault_key_uri));
    }
...
QString OAIDatabaseAccountCreateUpdateProperties::getKeyVaultKeyUri() const {
    return m_key_vault_key_uri;
}
void OAIDatabaseAccountCreateUpdateProperties::setKeyVaultKeyUri(const QString &key_vault_key_uri) {
    m_key_vault_key_uri = key_vault_key_uri;
    m_key_vault_key_uri_isSet = true;
}

bool OAIDatabaseAccountCreateUpdateProperties::is_key_vault_key_uri_Set() const{
    return m_key_vault_key_uri_isSet;
}

bool OAIDatabaseAccountCreateUpdateProperties::is_key_vault_key_uri_Valid() const{
    return m_key_vault_key_uri_isValid;
}
