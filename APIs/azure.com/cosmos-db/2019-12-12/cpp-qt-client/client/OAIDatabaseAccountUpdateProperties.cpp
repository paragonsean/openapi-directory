...
QString OAIDatabaseAccountUpdateProperties::getKeyVaultKeyUri() const {
    return m_key_vault_key_uri;
}
void OAIDatabaseAccountUpdateProperties::setKeyVaultKeyUri(const QString &key_vault_key_uri) {
    m_key_vault_key_uri = key_vault_key_uri;
    m_key_vault_key_uri_isSet = true;
}

bool OAIDatabaseAccountUpdateProperties::is_key_vault_key_uri_Set() const{
    return m_key_vault_key_uri_isSet;
}

bool OAIDatabaseAccountUpdateProperties::is_key_vault_key_uri_Valid() const{
