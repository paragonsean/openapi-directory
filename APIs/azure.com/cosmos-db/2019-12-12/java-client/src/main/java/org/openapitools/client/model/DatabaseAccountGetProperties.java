...
public class DatabaseAccountGetProperties {
  ...
  public static final String SERIALIZED_NAME_KEY_VAULT_KEY_URI = "keyVaultKeyUri";
  @SerializedName(SERIALIZED_NAME_KEY_VAULT_KEY_URI)
  ...
  public DatabaseAccountGetProperties capabilities(List<Capability> capabilities) {
    this.capabilities = capabilities;
    return this;
  }

  public DatabaseAccountGetProperties addCapabilitiesItem(Capability capabilitiesItem) {
  ...
  public DatabaseAccountGetProperties connectorOffer(ConnectorOffer connectorOffer) {
  ...
  public DatabaseAccountGetProperties consistencyPolicy(ConsistencyPolicy consistencyPolicy) {
  ...
  public DatabaseAccountGetProperties databaseAccountOfferType(DatabaseAccountOfferType databaseAccountOfferType) {
  ...
  public DatabaseAccountGetProperties disableKeyBasedMetadataWriteAccess(Boolean disableKeyBasedMetadataWriteAccess) {
  ...
  public DatabaseAccountGetProperties enableAutomaticFailover(Boolean enableAutomaticFailover) {
  ...
  public DatabaseAccountGetProperties enableCassandraConnector(Boolean enableCassandraConnector) {
  ...
  public DatabaseAccountGetProperties enableMultipleWriteLocations(Boolean enableMultipleWriteLocations) {
  ...
  public DatabaseAccountGetProperties ipRangeFilter(String ipRangeFilter) {
  ...
  public DatabaseAccountGetProperties isVirtualNetworkFilterEnabled(Boolean isVirtualNetworkFilterEnabled) {
  ...
  public DatabaseAccountGetProperties keyVaultKeyUri(String keyVaultKeyUri) {
   ...
   */
  @javax.annotation.Nullable
  public String getKeyVaultKeyUri() {
    return keyVaultKeyUri;
  }

  public void setKeyVaultKeyUri(String keyVaultKeyUri) {
    this.keyVaultKeyUri = keyVaultKeyUri;
  }
  ...
  public DatabaseAccountGetProperties provisioningState(String provisioningState) {
  ...
  public DatabaseAccountGetProperties virtualNetworkRules(List<VirtualNetworkRule> virtualNetworkRules) {
    this.virtualNetworkRules = virtualNetworkRules;
    return this;
  }

  public DatabaseAccountGetProperties addVirtualNetworkRulesItem(VirtualNetworkRule virtualNetworkRulesItem) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseAccountGetProperties databaseAccountGetProperties = (DatabaseAccountGetProperties) o;
    return Objects.equals(this.capabilities, databaseAccountGetProperties.capabilities) &&
        Objects.equals(this.connectorOffer, databaseAccountGetProperties.connectorOffer) &&
        Objects.equals(this.consistencyPolicy, databaseAccountGetProperties.consistencyPolicy) &&
        Objects.equals(this.databaseAccountOfferType, databaseAccountGetProperties.databaseAccountOfferType) &&
        Objects.equals(this.disableKeyBasedMetadataWriteAccess, databaseAccountGetProperties.disableKeyBasedMetadataWriteAccess) &&
        Objects.equals(this.documentEndpoint, databaseAccountGetProperties.documentEndpoint) &&
        Objects.equals(this.enableAutomaticFailover, databaseAccountGetProperties.enableAutomaticFailover) &&
        Objects.equals(this.enableCassandraConnector, databaseAccountGetProperties.enableCassandraConnector) &&
        Objects.equals(this.enableMultipleWriteLocations, databaseAccountGetProperties.enableMultipleWriteLocations) &&
        Objects.equals(this.failoverPolicies, databaseAccountGetProperties.failoverPolicies) &&
        Objects.equals(this.ipRangeFilter, databaseAccountGetProperties.ipRangeFilter) &&
        Objects.equals(this.isVirtualNetworkFilterEnabled, databaseAccountGetProperties.isVirtualNetworkFilterEnabled) &&
        Objects.equals(this.keyVaultKeyUri, databaseAccountGetProperties.keyVaultKeyUri) &&
        Objects.equals(this.locations, databaseAccountGetProperties.locations) &&
        Objects.equals(this.provisioningState, databaseAccountGetProperties.provisioningState) &&
        Objects.equals(this.readLocations, databaseAccountGetProperties.readLocations) &&
        Objects.equals(this.virtualNetworkRules, databaseAccountGetProperties.virtualNetworkRules) &&
        Objects.equals(this.writeLocations, databaseAccountGetProperties.writeLocations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(capabilities, connectorOffer, consistencyPolicy, databaseAccountOfferType, disableKeyBasedMetadataWriteAccess, documentEndpoint, enableAutomaticFailover, enableCassandraConnector, enableMultipleWriteLocations, failoverPolicies, ipRangeFilter, isVirtualNetworkFilterEnabled, keyVaultKeyUri, locations, provisioningState, readLocations, virtualNetworkRules, writeLocations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseAccountGetProperties {\n");
    ...
    sb.append("    keyVaultKeyUri: ").append(toIndentedString(keyVaultKeyUri)).append("\n");
  ...
  static {
    ...
    openapiFields.add("keyVaultKeyUri");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseAccountGetProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseAccountGetProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseAccountGetProperties is not found in the empty JSON string", DatabaseAccountGetProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseAccountGetProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseAccountGetProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("keyVaultKeyUri") != null && !jsonObj.get("keyVaultKeyUri").isJsonNull()) && !jsonObj.get("keyVaultKeyUri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `keyVaultKeyUri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("keyVaultKeyUri").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseAccountGetProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseAccountGetProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseAccountGetProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseAccountGetProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseAccountGetProperties>() {
           @Override
           public void write(JsonWriter out, DatabaseAccountGetProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseAccountGetProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseAccountGetProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseAccountGetProperties
   * @throws IOException if the JSON string is invalid with respect to DatabaseAccountGetProperties
   */
  public static DatabaseAccountGetProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseAccountGetProperties.class);
  }

  /**
   * Convert an instance of DatabaseAccountGetProperties to an JSON string
   *
   * @return JSON string
   */
