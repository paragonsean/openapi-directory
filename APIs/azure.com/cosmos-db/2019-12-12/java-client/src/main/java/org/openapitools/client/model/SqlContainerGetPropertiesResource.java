...
public class SqlContainerGetPropertiesResource {
  ...
  public SqlContainerGetPropertiesResource conflictResolutionPolicy(ConflictResolutionPolicy conflictResolutionPolicy) {
  ...
  public SqlContainerGetPropertiesResource defaultTtl(Integer defaultTtl) {
  ...
  public SqlContainerGetPropertiesResource id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SqlContainerGetPropertiesResource indexingPolicy(IndexingPolicy indexingPolicy) {
  ...
  public SqlContainerGetPropertiesResource partitionKey(ContainerPartitionKey partitionKey) {
  ...
  public SqlContainerGetPropertiesResource uniqueKeyPolicy(UniqueKeyPolicy uniqueKeyPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    SqlContainerGetPropertiesResource sqlContainerGetPropertiesResource = (SqlContainerGetPropertiesResource) o;
    return Objects.equals(this.conflictResolutionPolicy, sqlContainerGetPropertiesResource.conflictResolutionPolicy) &&
        Objects.equals(this.defaultTtl, sqlContainerGetPropertiesResource.defaultTtl) &&
        Objects.equals(this.id, sqlContainerGetPropertiesResource.id) &&
        Objects.equals(this.indexingPolicy, sqlContainerGetPropertiesResource.indexingPolicy) &&
        Objects.equals(this.partitionKey, sqlContainerGetPropertiesResource.partitionKey) &&
        Objects.equals(this.uniqueKeyPolicy, sqlContainerGetPropertiesResource.uniqueKeyPolicy) &&
        Objects.equals(this.etag, sqlContainerGetPropertiesResource.etag) &&
        Objects.equals(this.rid, sqlContainerGetPropertiesResource.rid) &&
        Objects.equals(this.ts, sqlContainerGetPropertiesResource.ts);
  }
  ...
  public String toString() {
    ...
    sb.append("class SqlContainerGetPropertiesResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SqlContainerGetPropertiesResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SqlContainerGetPropertiesResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SqlContainerGetPropertiesResource is not found in the empty JSON string", SqlContainerGetPropertiesResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SqlContainerGetPropertiesResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SqlContainerGetPropertiesResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SqlContainerGetPropertiesResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SqlContainerGetPropertiesResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SqlContainerGetPropertiesResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SqlContainerGetPropertiesResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SqlContainerGetPropertiesResource.class));

       return (TypeAdapter<T>) new TypeAdapter<SqlContainerGetPropertiesResource>() {
           @Override
           public void write(JsonWriter out, SqlContainerGetPropertiesResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SqlContainerGetPropertiesResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SqlContainerGetPropertiesResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SqlContainerGetPropertiesResource
   * @throws IOException if the JSON string is invalid with respect to SqlContainerGetPropertiesResource
   */
  public static SqlContainerGetPropertiesResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SqlContainerGetPropertiesResource.class);
  }

  /**
   * Convert an instance of SqlContainerGetPropertiesResource to an JSON string
   *
   * @return JSON string
   */
