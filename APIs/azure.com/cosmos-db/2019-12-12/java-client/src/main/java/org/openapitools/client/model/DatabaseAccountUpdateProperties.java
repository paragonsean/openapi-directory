...
public class DatabaseAccountUpdateProperties {
  ...
  public DatabaseAccountUpdateProperties capabilities(List<Capability> capabilities) {
    this.capabilities = capabilities;
    return this;
  }

  public DatabaseAccountUpdateProperties addCapabilitiesItem(Capability capabilitiesItem) {
  ...
  public DatabaseAccountUpdateProperties connectorOffer(ConnectorOffer connectorOffer) {
  ...
  public DatabaseAccountUpdateProperties consistencyPolicy(ConsistencyPolicy consistencyPolicy) {
  ...
  public DatabaseAccountUpdateProperties disableKeyBasedMetadataWriteAccess(Boolean disableKeyBasedMetadataWriteAccess) {
  ...
  public DatabaseAccountUpdateProperties enableAutomaticFailover(Boolean enableAutomaticFailover) {
  ...
  public DatabaseAccountUpdateProperties enableCassandraConnector(Boolean enableCassandraConnector) {
  ...
  public DatabaseAccountUpdateProperties enableMultipleWriteLocations(Boolean enableMultipleWriteLocations) {
  ...
  public DatabaseAccountUpdateProperties ipRangeFilter(String ipRangeFilter) {
  ...
  public DatabaseAccountUpdateProperties isVirtualNetworkFilterEnabled(Boolean isVirtualNetworkFilterEnabled) {
  ...
  public DatabaseAccountUpdateProperties keyVaultKeyUri(String keyVaultKeyUri) {
  ...
  public DatabaseAccountUpdateProperties locations(List<Location> locations) {
    this.locations = locations;
    return this;
  }

  public DatabaseAccountUpdateProperties addLocationsItem(Location locationsItem) {
  ...
  public DatabaseAccountUpdateProperties virtualNetworkRules(List<VirtualNetworkRule> virtualNetworkRules) {
    this.virtualNetworkRules = virtualNetworkRules;
    return this;
  }

  public DatabaseAccountUpdateProperties addVirtualNetworkRulesItem(VirtualNetworkRule virtualNetworkRulesItem) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseAccountUpdateProperties databaseAccountUpdateProperties = (DatabaseAccountUpdateProperties) o;
    return Objects.equals(this.capabilities, databaseAccountUpdateProperties.capabilities) &&
        Objects.equals(this.connectorOffer, databaseAccountUpdateProperties.connectorOffer) &&
        Objects.equals(this.consistencyPolicy, databaseAccountUpdateProperties.consistencyPolicy) &&
        Objects.equals(this.disableKeyBasedMetadataWriteAccess, databaseAccountUpdateProperties.disableKeyBasedMetadataWriteAccess) &&
        Objects.equals(this.enableAutomaticFailover, databaseAccountUpdateProperties.enableAutomaticFailover) &&
        Objects.equals(this.enableCassandraConnector, databaseAccountUpdateProperties.enableCassandraConnector) &&
        Objects.equals(this.enableMultipleWriteLocations, databaseAccountUpdateProperties.enableMultipleWriteLocations) &&
        Objects.equals(this.ipRangeFilter, databaseAccountUpdateProperties.ipRangeFilter) &&
        Objects.equals(this.isVirtualNetworkFilterEnabled, databaseAccountUpdateProperties.isVirtualNetworkFilterEnabled) &&
        Objects.equals(this.keyVaultKeyUri, databaseAccountUpdateProperties.keyVaultKeyUri) &&
        Objects.equals(this.locations, databaseAccountUpdateProperties.locations) &&
        Objects.equals(this.virtualNetworkRules, databaseAccountUpdateProperties.virtualNetworkRules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(capabilities, connectorOffer, consistencyPolicy, disableKeyBasedMetadataWriteAccess, enableAutomaticFailover, enableCassandraConnector, enableMultipleWriteLocations, ipRangeFilter, isVirtualNetworkFilterEnabled, keyVaultKeyUri, locations, virtualNetworkRules);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseAccountUpdateProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseAccountUpdateProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseAccountUpdateProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseAccountUpdateProperties is not found in the empty JSON string", DatabaseAccountUpdateProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseAccountUpdateProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseAccountUpdateProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseAccountUpdateProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseAccountUpdateProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseAccountUpdateProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseAccountUpdateProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseAccountUpdateProperties>() {
           @Override
           public void write(JsonWriter out, DatabaseAccountUpdateProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseAccountUpdateProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseAccountUpdateProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseAccountUpdateProperties
   * @throws IOException if the JSON string is invalid with respect to DatabaseAccountUpdateProperties
   */
  public static DatabaseAccountUpdateProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseAccountUpdateProperties.class);
  }

  /**
   * Convert an instance of DatabaseAccountUpdateProperties to an JSON string
   *
   * @return JSON string
   */
