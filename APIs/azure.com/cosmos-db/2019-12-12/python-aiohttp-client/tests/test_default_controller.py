...
async def test_database_accounts_create_or_update(client):
    ...
    """
    create_update_parameters = {"kind":"GlobalDocumentDB","properties":{"ipRangeFilter":"ipRangeFilter","capabilities":[{"name":"name"},{"name":"name"}],"connectorOffer":"Small","virtualNetworkRules":[{"id":"id","ignoreMissingVNetServiceEndpoint":True},{"id":"id","ignoreMissingVNetServiceEndpoint":True}],"disableKeyBasedMetadataWriteAccess":True,"enableAutomaticFailover":True,"enableCassandraConnector":True,"enableMultipleWriteLocations":True,"consistencyPolicy":{"maxStalenessPrefix":1294386359,"defaultConsistencyLevel":"Eventual","maxIntervalInSeconds":6923},"databaseAccountOfferType":"Standard","locations":[{"failoverPriority":0,"locationName":"locationName","documentEndpoint":"documentEndpoint","id":"id","provisioningState":"provisioningState","isZoneRedundant":True},{"failoverPriority":0,"locationName":"locationName","documentEndpoint":"documentEndpoint","id":"id","provisioningState":"provisioningState","isZoneRedundant":True}],"isVirtualNetworkFilterEnabled":True,"keyVaultKeyUri":"keyVaultKeyUri"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
