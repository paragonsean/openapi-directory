...
class DatabaseAccountCreateUpdateProperties(Model):
    ...
    def __init__(self, capabilities: List[Capability]=None, connector_offer: ConnectorOffer=None, consistency_policy: ConsistencyPolicy=None, database_account_offer_type: DatabaseAccountOfferType=None, disable_key_based_metadata_write_access: bool=None, enable_automatic_failover: bool=None, enable_cassandra_connector: bool=None, enable_multiple_write_locations: bool=None, ip_range_filter: str=None, is_virtual_network_filter_enabled: bool=None, key_vault_key_uri: str=None, locations: List[Location]=None, virtual_network_rules: List[VirtualNetworkRule]=None):
        ...
        :param key_vault_key_uri: The key_vault_key_uri of this DatabaseAccountCreateUpdateProperties.
    ...
    def key_vault_key_uri(self):
        """Gets the key_vault_key_uri of this DatabaseAccountCreateUpdateProperties.

        The URI of the key vault

        :return: The key_vault_key_uri of this DatabaseAccountCreateUpdateProperties.
        :rtype: str
        """
    ...
    def key_vault_key_uri(self, key_vault_key_uri):
        """Sets the key_vault_key_uri of this DatabaseAccountCreateUpdateProperties.
