...
<a id="storageOperationResultsGet"></a>
...
import org.openapitools.client.api.StorageOperationResultsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    StorageOperationResultsApi apiInstance = new StorageOperationResultsApi(defaultClient);
    ...
    try {
      StorageOperationResult result = apiInstance.storageOperationResultsGet(subscriptionId, resourceGroupName, location, operation, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageOperationResultsApi#storageOperationResultsGet");
...
<a id="storageOperationResultsList"></a>
# **storageOperationResultsList**
> StorageOperationResultList storageOperationResultsList(subscriptionId, resourceGroupName, location, apiVersion, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      StorageOperationResultList result = apiInstance.storageOperationResultsList(subscriptionId, resourceGroupName, location, apiVersion, $filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StorageOperationResultsApi#storageOperationResultsList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
