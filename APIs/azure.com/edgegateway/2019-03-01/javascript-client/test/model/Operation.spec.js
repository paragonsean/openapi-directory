...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.Operation();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.Operation);
    });
