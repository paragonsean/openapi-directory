...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionDefinitionsClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new SubscriptionDefinitionsClient.OperationDisplay();
      //expect(instance).to.be.a(SubscriptionDefinitionsClient.OperationDisplay);
    });
