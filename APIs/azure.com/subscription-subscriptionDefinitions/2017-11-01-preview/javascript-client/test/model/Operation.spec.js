...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionDefinitionsClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new SubscriptionDefinitionsClient.Operation();
      //expect(instance).to.be.a(SubscriptionDefinitionsClient.Operation);
    });
