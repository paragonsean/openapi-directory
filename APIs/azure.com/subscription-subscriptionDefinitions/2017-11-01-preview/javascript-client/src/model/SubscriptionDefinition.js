...
import SubscriptionDefinitionProperties from './SubscriptionDefinitionProperties';
...
class SubscriptionDefinition {
    ...
    constructor() { 
        ...
        SubscriptionDefinition.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = SubscriptionDefinitionProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          SubscriptionDefinitionProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/SubscriptionDefinitionProperties} properties
 */
SubscriptionDefinition.prototype['properties'] = undefined;

/**
 * The type of the resource.
 * @member {String} type
 */
SubscriptionDefinition.prototype['type'] = undefined;
