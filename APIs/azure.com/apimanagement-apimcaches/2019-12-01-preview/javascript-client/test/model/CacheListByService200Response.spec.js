...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.CacheListByService200Response();
  });
  ...
  describe('CacheListByService200Response', function() {
    it('should create an instance of CacheListByService200Response', function() {
      // uncomment below and update the code to test CacheListByService200Response
      //var instance = new ApiManagementClient.CacheListByService200Response();
      //expect(instance).to.be.a(ApiManagementClient.CacheListByService200Response);
    });
