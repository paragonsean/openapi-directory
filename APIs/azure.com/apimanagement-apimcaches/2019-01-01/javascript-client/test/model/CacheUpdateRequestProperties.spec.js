...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.CacheUpdateRequestProperties();
  });
  ...
  describe('CacheUpdateRequestProperties', function() {
    it('should create an instance of CacheUpdateRequestProperties', function() {
      // uncomment below and update the code to test CacheUpdateRequestProperties
      //var instance = new ApiManagementClient.CacheUpdateRequestProperties();
      //expect(instance).to.be.a(ApiManagementClient.CacheUpdateRequestProperties);
    });
