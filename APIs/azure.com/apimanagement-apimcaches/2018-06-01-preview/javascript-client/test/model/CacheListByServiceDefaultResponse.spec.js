...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.CacheListByServiceDefaultResponse();
  });
  ...
  describe('CacheListByServiceDefaultResponse', function() {
    it('should create an instance of CacheListByServiceDefaultResponse', function() {
      // uncomment below and update the code to test CacheListByServiceDefaultResponse
      //var instance = new ApiManagementClient.CacheListByServiceDefaultResponse();
      //expect(instance).to.be.a(ApiManagementClient.CacheListByServiceDefaultResponse);
    });
