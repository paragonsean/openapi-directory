...
public class VirtualNetworkRulesApi {
     ...
     */
    public okhttp3.Call virtualNetworkRulesCreateOrUpdateCall(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, VirtualNetworkRule parameters, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/virtualNetworkRules/{virtualNetworkRuleName}"
    ...
    private okhttp3.Call virtualNetworkRulesCreateOrUpdateValidateBeforeCall(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, VirtualNetworkRule parameters, final ApiCallback _callback) throws ApiException {
        ...
        return virtualNetworkRulesCreateOrUpdateCall(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion, parameters, _callback);
     ...
     */
    public VirtualNetworkRule virtualNetworkRulesCreateOrUpdate(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, VirtualNetworkRule parameters) throws ApiException {
        ApiResponse<VirtualNetworkRule> localVarResp = virtualNetworkRulesCreateOrUpdateWithHttpInfo(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion, parameters);
     ...
     */
    public ApiResponse<VirtualNetworkRule> virtualNetworkRulesCreateOrUpdateWithHttpInfo(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, VirtualNetworkRule parameters) throws ApiException {
        okhttp3.Call localVarCall = virtualNetworkRulesCreateOrUpdateValidateBeforeCall(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion, parameters, null);
     ...
     */
    public okhttp3.Call virtualNetworkRulesCreateOrUpdateAsync(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, VirtualNetworkRule parameters, final ApiCallback<VirtualNetworkRule> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualNetworkRulesCreateOrUpdateValidateBeforeCall(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion, parameters, _callback);
        Type localVarReturnType = new TypeToken<VirtualNetworkRule>(){}.getType();
     ...
     */
    public okhttp3.Call virtualNetworkRulesGetCall(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualNetworkRulesGetValidateBeforeCall(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return virtualNetworkRulesGetCall(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion, _callback);
     ...
     */
    public VirtualNetworkRule virtualNetworkRulesGet(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<VirtualNetworkRule> localVarResp = virtualNetworkRulesGetWithHttpInfo(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VirtualNetworkRule> virtualNetworkRulesGetWithHttpInfo(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = virtualNetworkRulesGetValidateBeforeCall(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion, null);
        Type localVarReturnType = new TypeToken<VirtualNetworkRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call virtualNetworkRulesGetAsync(String resourceGroupName, String serverName, String virtualNetworkRuleName, String subscriptionId, String apiVersion, final ApiCallback<VirtualNetworkRule> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualNetworkRulesGetValidateBeforeCall(resourceGroupName, serverName, virtualNetworkRuleName, subscriptionId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<VirtualNetworkRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call virtualNetworkRulesListByServerCall(String resourceGroupName, String serverName, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/virtualNetworkRules"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "serverName" + "}", localVarApiClient.escapeString(serverName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
