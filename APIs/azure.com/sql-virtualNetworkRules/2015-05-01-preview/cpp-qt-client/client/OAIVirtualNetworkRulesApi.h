...
public:
    ...
    */
    virtual void virtualNetworkRulesCreateOrUpdate(const QString &resource_group_name, const QString &server_name, const QString &virtual_network_rule_name, const QString &subscription_id, const QString &api_version, const OAIVirtualNetworkRule &parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void virtualNetworkRulesGet(const QString &resource_group_name, const QString &server_name, const QString &virtual_network_rule_name, const QString &subscription_id, const QString &api_version);
