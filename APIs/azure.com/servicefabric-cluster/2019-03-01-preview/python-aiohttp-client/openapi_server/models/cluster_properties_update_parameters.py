...
class ClusterPropertiesUpdateParameters(Model):
    ...
    def __init__(self, add_on_features: List[AddOnFeatures]=None, certificate: CertificateDescription=None, certificate_common_names: ServerCertificateCommonNames=None, client_certificate_common_names: List[ClientCertificateCommonName]=None, client_certificate_thumbprints: List[ClientCertificateThumbprint]=None, cluster_code_version: str=None, event_store_service_enabled: bool=None, fabric_settings: List[SettingsSectionDescription]=None, node_types: List[NodeTypeDescription]=None, reliability_level: ReliabilityLevel=None, reverse_proxy_certificate: CertificateDescription=None, upgrade_description: ClusterUpgradePolicy=None, upgrade_mode: UpgradeMode=None):
        ...
        :param certificate_common_names: The certificate_common_names of this ClusterPropertiesUpdateParameters.
        ...
        :param event_store_service_enabled: The event_store_service_enabled of this ClusterPropertiesUpdateParameters.
        ...
        self._event_store_service_enabled = event_store_service_enabled
    ...
    def certificate_common_names(self):
        """Gets the certificate_common_names of this ClusterPropertiesUpdateParameters.


        :return: The certificate_common_names of this ClusterPropertiesUpdateParameters.
    ...
    def certificate_common_names(self, certificate_common_names):
        """Sets the certificate_common_names of this ClusterPropertiesUpdateParameters.
    ...
    @property
    def event_store_service_enabled(self):
        """Gets the event_store_service_enabled of this ClusterPropertiesUpdateParameters.

        Indicates if the event store service is enabled.

        :return: The event_store_service_enabled of this ClusterPropertiesUpdateParameters.
        :rtype: bool
        """
        return self._event_store_service_enabled

    @event_store_service_enabled.setter
    def event_store_service_enabled(self, event_store_service_enabled):
        """Sets the event_store_service_enabled of this ClusterPropertiesUpdateParameters.
