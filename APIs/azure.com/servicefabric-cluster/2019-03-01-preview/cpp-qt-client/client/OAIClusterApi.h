...
public:
    ...
    */
    virtual void clustersCreate(const QString &resource_group_name, const QString &cluster_name, const QString &api_version, const QString &subscription_id, const OAICluster &parameters);
