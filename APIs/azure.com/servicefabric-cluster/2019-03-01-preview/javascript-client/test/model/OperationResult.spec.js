...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricManagementClient.OperationResult();
  });
  ...
  describe('OperationResult', function() {
    it('should create an instance of OperationResult', function() {
      ...
      //var instance = new ServiceFabricManagementClient.OperationResult();
      //expect(instance).to.be.a(ServiceFabricManagementClient.OperationResult);
    });
