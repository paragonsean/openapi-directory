...
public class ClusterPropertiesUpdateParameters {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addOnFeatures, certificate, certificateCommonNames, clientCertificateCommonNames, clientCertificateThumbprints, clusterCodeVersion, fabricSettings, nodeTypes, reliabilityLevel, reverseProxyCertificate, upgradeDescription, upgradeMode);
  }
