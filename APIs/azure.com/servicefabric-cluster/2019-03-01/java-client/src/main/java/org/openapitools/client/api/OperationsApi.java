...
public class OperationsApi {
     ...
     * @param apiVersion The version of the Service Fabric resource provider API (required)
    ...
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.ServiceFabric/operations";
    ...
    /**
     * Lists all of the available Service Fabric resource provider API operations. (asynchronously)
     * Get the list of available Service Fabric resource provider API operations.
     * @param apiVersion The version of the Service Fabric resource provider API (required)
