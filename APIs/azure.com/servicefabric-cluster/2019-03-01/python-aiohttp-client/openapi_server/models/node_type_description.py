...
class NodeTypeDescription(Model):
    ...
    def __init__(self, application_ports: EndpointRangeDescription=None, capacities: Dict[str, str]=None, client_connection_endpoint_port: int=None, durability_level: DurabilityLevel=None, ephemeral_ports: EndpointRangeDescription=None, http_gateway_endpoint_port: int=None, is_primary: bool=None, name: str=None, placement_properties: Dict[str, str]=None, reverse_proxy_endpoint_port: int=None, vm_instance_count: int=None):
    ...
    def durability_level(self, durability_level):
        ...
        :param durability_level: The durability_level of this NodeTypeDescription.
        :type durability_level: DurabilityLevel
        """
