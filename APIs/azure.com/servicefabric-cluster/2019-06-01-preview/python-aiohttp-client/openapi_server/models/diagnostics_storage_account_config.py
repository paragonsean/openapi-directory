...
class DiagnosticsStorageAccountConfig(Model):
    ...
    def __init__(self, blob_endpoint: str=None, protected_account_key_name: str=None, protected_account_key_name2: str=None, queue_endpoint: str=None, storage_account_name: str=None, table_endpoint: str=None):
        ...
        :param protected_account_key_name2: The protected_account_key_name2 of this DiagnosticsStorageAccountConfig.
        ...
        self._protected_account_key_name2 = protected_account_key_name2
    ...
    @property
    def protected_account_key_name2(self):
        """Gets the protected_account_key_name2 of this DiagnosticsStorageAccountConfig.

        The secondary protected diagnostics storage key name.

        :return: The protected_account_key_name2 of this DiagnosticsStorageAccountConfig.
        :rtype: str
        """
        return self._protected_account_key_name2

    @protected_account_key_name2.setter
    def protected_account_key_name2(self, protected_account_key_name2):
        """Sets the protected_account_key_name2 of this DiagnosticsStorageAccountConfig.
