...
class ClusterProperties(Model):
    ...
    def __init__(self, add_on_features: List[AddOnFeatures]=None, available_cluster_versions: List[ClusterVersionDetails]=None, azure_active_directory: AzureActiveDirectory=None, certificate: CertificateDescription=None, certificate_common_names: ServerCertificateCommonNames=None, client_certificate_common_names: List[ClientCertificateCommonName]=None, client_certificate_thumbprints: List[ClientCertificateThumbprint]=None, cluster_code_version: str=None, cluster_endpoint: str=None, cluster_id: str=None, cluster_state: ClusterState=None, diagnostics_storage_account_config: DiagnosticsStorageAccountConfig=None, event_store_service_enabled: bool=None, fabric_settings: List[SettingsSectionDescription]=None, management_endpoint: str=None, node_types: List[NodeTypeDescription]=None, provisioning_state: str=None, reliability_level: ReliabilityLevel=None, reverse_proxy_certificate: CertificateDescription=None, reverse_proxy_certificate_common_names: ServerCertificateCommonNames=None, upgrade_description: ClusterUpgradePolicy=None, upgrade_mode: UpgradeMode=None, vm_image: str=None):
        ...
        :param event_store_service_enabled: The event_store_service_enabled of this ClusterProperties.
    ...
    def event_store_service_enabled(self):
        """Gets the event_store_service_enabled of this ClusterProperties.

        Indicates if the event store service is enabled.

        :return: The event_store_service_enabled of this ClusterProperties.
        :rtype: bool
        """
    ...
    def event_store_service_enabled(self, event_store_service_enabled):
        """Sets the event_store_service_enabled of this ClusterProperties.
