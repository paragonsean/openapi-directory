...
void OAIClusterProperties::initializeModel() {
    ...
    m_event_store_service_enabled_isSet = false;
    m_event_store_service_enabled_isValid = false;
...
void OAIClusterProperties::fromJsonObject(QJsonObject json) {
    ...
    m_event_store_service_enabled_isValid = ::OpenAPI::fromJsonValue(m_event_store_service_enabled, json[QString("eventStoreServiceEnabled")]);
    m_event_store_service_enabled_isSet = !json[QString("eventStoreServiceEnabled")].isNull() && m_event_store_service_enabled_isValid;
...
QJsonObject OAIClusterProperties::asJsonObject() const {
    ...
    if (m_event_store_service_enabled_isSet) {
        obj.insert(QString("eventStoreServiceEnabled"), ::OpenAPI::toJsonValue(m_event_store_service_enabled));
    }
...
bool OAIClusterProperties::isEventStoreServiceEnabled() const {
    return m_event_store_service_enabled;
}
void OAIClusterProperties::setEventStoreServiceEnabled(const bool &event_store_service_enabled) {
    m_event_store_service_enabled = event_store_service_enabled;
    m_event_store_service_enabled_isSet = true;
}

bool OAIClusterProperties::is_event_store_service_enabled_Set() const{
    return m_event_store_service_enabled_isSet;
}

bool OAIClusterProperties::is_event_store_service_enabled_Valid() const{
    return m_event_store_service_enabled_isValid;
}
