...
void OAIClusterUpgradeDeltaHealthPolicy::initializeModel() {
    ...
    m_application_delta_health_policies_isSet = false;
    m_application_delta_health_policies_isValid = false;
...
void OAIClusterUpgradeDeltaHealthPolicy::fromJsonObject(QJsonObject json) {
    ...
    m_application_delta_health_policies_isValid = ::OpenAPI::fromJsonValue(m_application_delta_health_policies, json[QString("applicationDeltaHealthPolicies")]);
    m_application_delta_health_policies_isSet = !json[QString("applicationDeltaHealthPolicies")].isNull() && m_application_delta_health_policies_isValid;
...
QJsonObject OAIClusterUpgradeDeltaHealthPolicy::asJsonObject() const {
    QJsonObject obj;
    if (m_application_delta_health_policies.size() > 0) {
        obj.insert(QString("applicationDeltaHealthPolicies"), ::OpenAPI::toJsonValue(m_application_delta_health_policies));
    }
...
QMap<QString, OAIApplicationDeltaHealthPolicy> OAIClusterUpgradeDeltaHealthPolicy::getApplicationDeltaHealthPolicies() const {
    return m_application_delta_health_policies;
}
void OAIClusterUpgradeDeltaHealthPolicy::setApplicationDeltaHealthPolicies(const QMap<QString, OAIApplicationDeltaHealthPolicy> &application_delta_health_policies) {
    m_application_delta_health_policies = application_delta_health_policies;
    m_application_delta_health_policies_isSet = true;
}

bool OAIClusterUpgradeDeltaHealthPolicy::is_application_delta_health_policies_Set() const{
    return m_application_delta_health_policies_isSet;
}

bool OAIClusterUpgradeDeltaHealthPolicy::is_application_delta_health_policies_Valid() const{
    return m_application_delta_health_policies_isValid;
}
