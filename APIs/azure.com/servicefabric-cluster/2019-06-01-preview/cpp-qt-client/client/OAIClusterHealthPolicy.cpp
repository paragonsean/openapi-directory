...
QJsonObject OAIClusterHealthPolicy::asJsonObject() const {
    QJsonObject obj;
    if (m_application_health_policies.size() > 0) {
...
QMap<QString, OAIApplicationHealthPolicy> OAIClusterHealthPolicy::getApplicationHealthPolicies() const {
    return m_application_health_policies;
}
void OAIClusterHealthPolicy::setApplicationHealthPolicies(const QMap<QString, OAIApplicationHealthPolicy> &application_health_policies) {
    m_application_health_policies = application_health_policies;
    m_application_health_policies_isSet = true;
}

bool OAIClusterHealthPolicy::is_application_health_policies_Set() const{
    return m_application_health_policies_isSet;
}

bool OAIClusterHealthPolicy::is_application_health_policies_Valid() const{
