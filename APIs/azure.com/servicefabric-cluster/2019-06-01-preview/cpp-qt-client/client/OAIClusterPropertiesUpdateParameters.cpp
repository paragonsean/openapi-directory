...
OAIServerCertificateCommonNames OAIClusterPropertiesUpdateParameters::getCertificateCommonNames() const {
    return m_certificate_common_names;
}
void OAIClusterPropertiesUpdateParameters::setCertificateCommonNames(const OAIServerCertificateCommonNames &certificate_common_names) {
    m_certificate_common_names = certificate_common_names;
    m_certificate_common_names_isSet = true;
}

bool OAIClusterPropertiesUpdateParameters::is_certificate_common_names_Set() const{
    return m_certificate_common_names_isSet;
}

bool OAIClusterPropertiesUpdateParameters::is_certificate_common_names_Valid() const{
...
bool OAIClusterPropertiesUpdateParameters::isEventStoreServiceEnabled() const {
    return m_event_store_service_enabled;
}
void OAIClusterPropertiesUpdateParameters::setEventStoreServiceEnabled(const bool &event_store_service_enabled) {
    m_event_store_service_enabled = event_store_service_enabled;
    m_event_store_service_enabled_isSet = true;
}

bool OAIClusterPropertiesUpdateParameters::is_event_store_service_enabled_Set() const{
    return m_event_store_service_enabled_isSet;
}

bool OAIClusterPropertiesUpdateParameters::is_event_store_service_enabled_Valid() const{
...
OAIReliabilityLevel OAIClusterPropertiesUpdateParameters::getReliabilityLevel() const {
    return m_reliability_level;
}
void OAIClusterPropertiesUpdateParameters::setReliabilityLevel(const OAIReliabilityLevel &reliability_level) {
...
OAIUpgradeMode OAIClusterPropertiesUpdateParameters::getUpgradeMode() const {
    return m_upgrade_mode;
}
void OAIClusterPropertiesUpdateParameters::setUpgradeMode(const OAIUpgradeMode &upgrade_mode) {
