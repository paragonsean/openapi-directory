...
void OAIDiagnosticsStorageAccountConfig::initializeModel() {
    ...
    m_protected_account_key_name2_isSet = false;
    m_protected_account_key_name2_isValid = false;
...
void OAIDiagnosticsStorageAccountConfig::fromJsonObject(QJsonObject json) {
    ...
    m_protected_account_key_name2_isValid = ::OpenAPI::fromJsonValue(m_protected_account_key_name2, json[QString("protectedAccountKeyName2")]);
    m_protected_account_key_name2_isSet = !json[QString("protectedAccountKeyName2")].isNull() && m_protected_account_key_name2_isValid;
...
QJsonObject OAIDiagnosticsStorageAccountConfig::asJsonObject() const {
    ...
    if (m_protected_account_key_name2_isSet) {
        obj.insert(QString("protectedAccountKeyName2"), ::OpenAPI::toJsonValue(m_protected_account_key_name2));
    }
...
QString OAIDiagnosticsStorageAccountConfig::getProtectedAccountKeyName2() const {
    return m_protected_account_key_name2;
}
void OAIDiagnosticsStorageAccountConfig::setProtectedAccountKeyName2(const QString &protected_account_key_name2) {
    m_protected_account_key_name2 = protected_account_key_name2;
    m_protected_account_key_name2_isSet = true;
}

bool OAIDiagnosticsStorageAccountConfig::is_protected_account_key_name2_Set() const{
    return m_protected_account_key_name2_isSet;
}

bool OAIDiagnosticsStorageAccountConfig::is_protected_account_key_name2_Valid() const{
    return m_protected_account_key_name2_isValid;
}
