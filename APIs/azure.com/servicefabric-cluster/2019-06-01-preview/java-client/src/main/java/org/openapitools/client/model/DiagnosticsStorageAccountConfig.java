...
public class DiagnosticsStorageAccountConfig {
  ...
  public static final String SERIALIZED_NAME_PROTECTED_ACCOUNT_KEY_NAME2 = "protectedAccountKeyName2";
  @SerializedName(SERIALIZED_NAME_PROTECTED_ACCOUNT_KEY_NAME2)
  ...
  public DiagnosticsStorageAccountConfig protectedAccountKeyName2(String protectedAccountKeyName2) {
   ...
   * @return protectedAccountKeyName2
   */
  @javax.annotation.Nullable
  public String getProtectedAccountKeyName2() {
    return protectedAccountKeyName2;
  }

  public void setProtectedAccountKeyName2(String protectedAccountKeyName2) {
    this.protectedAccountKeyName2 = protectedAccountKeyName2;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blobEndpoint, diagnosticsStorageAccountConfig.blobEndpoint) &&
        ...
        Objects.equals(this.protectedAccountKeyName2, diagnosticsStorageAccountConfig.protectedAccountKeyName2) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(blobEndpoint, protectedAccountKeyName, protectedAccountKeyName2, queueEndpoint, storageAccountName, tableEndpoint);
  }
  ...
  public String toString() {
    ...
    sb.append("    protectedAccountKeyName2: ").append(toIndentedString(protectedAccountKeyName2)).append("\n");
  ...
  static {
    ...
    openapiFields.add("protectedAccountKeyName2");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("protectedAccountKeyName2") != null && !jsonObj.get("protectedAccountKeyName2").isJsonNull()) && !jsonObj.get("protectedAccountKeyName2").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `protectedAccountKeyName2` to be a primitive type in the JSON string but got `%s`", jsonObj.get("protectedAccountKeyName2").toString()));
      }
