...
public class ApplicationHealthPolicy {
  ...
  public static final String SERIALIZED_NAME_SERVICE_TYPE_HEALTH_POLICIES = "serviceTypeHealthPolicies";
  @SerializedName(SERIALIZED_NAME_SERVICE_TYPE_HEALTH_POLICIES)
  private Map<String, ServiceTypeHealthPolicy> serviceTypeHealthPolicies = new HashMap<>();
  ...
  public ApplicationHealthPolicy serviceTypeHealthPolicies(Map<String, ServiceTypeHealthPolicy> serviceTypeHealthPolicies) {
    this.serviceTypeHealthPolicies = serviceTypeHealthPolicies;
    return this;
  }

  public ApplicationHealthPolicy putServiceTypeHealthPoliciesItem(String key, ServiceTypeHealthPolicy serviceTypeHealthPoliciesItem) {
    if (this.serviceTypeHealthPolicies == null) {
      this.serviceTypeHealthPolicies = new HashMap<>();
    }
    this.serviceTypeHealthPolicies.put(key, serviceTypeHealthPoliciesItem);
    return this;
  }
   ...
   * @return serviceTypeHealthPolicies
   */
  @javax.annotation.Nullable
  public Map<String, ServiceTypeHealthPolicy> getServiceTypeHealthPolicies() {
    return serviceTypeHealthPolicies;
  }

  public void setServiceTypeHealthPolicies(Map<String, ServiceTypeHealthPolicy> serviceTypeHealthPolicies) {
    this.serviceTypeHealthPolicies = serviceTypeHealthPolicies;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultServiceTypeHealthPolicy, applicationHealthPolicy.defaultServiceTypeHealthPolicy) &&
        Objects.equals(this.serviceTypeHealthPolicies, applicationHealthPolicy.serviceTypeHealthPolicies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultServiceTypeHealthPolicy, serviceTypeHealthPolicies);
  }
  ...
  public String toString() {
    ...
    sb.append("    serviceTypeHealthPolicies: ").append(toIndentedString(serviceTypeHealthPolicies)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("serviceTypeHealthPolicies");
