...
class DiagnosticsStorageAccountConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('protectedAccountKeyName2')) {
                obj['protectedAccountKeyName2'] = ApiClient.convertToType(data['protectedAccountKeyName2'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['protectedAccountKeyName2'] && !(typeof data['protectedAccountKeyName2'] === 'string' || data['protectedAccountKeyName2'] instanceof String)) {
            throw new Error("Expected the field `protectedAccountKeyName2` to be a primitive type in the JSON string but got " + data['protectedAccountKeyName2']);
        }
        // ensure the json data is a string
 ...
 * @member {String} protectedAccountKeyName2
 */
DiagnosticsStorageAccountConfig.prototype['protectedAccountKeyName2'] = undefined;
