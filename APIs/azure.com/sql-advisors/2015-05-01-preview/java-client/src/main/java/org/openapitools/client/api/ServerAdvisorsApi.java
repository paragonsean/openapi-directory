...
public class ServerAdvisorsApi {
     ...
     */
    public List<Advisor> serverAdvisorsListByServer(String resourceGroupName, String serverName, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<List<Advisor>> localVarResp = serverAdvisorsListByServerWithHttpInfo(resourceGroupName, serverName, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Advisor>> serverAdvisorsListByServerWithHttpInfo(String resourceGroupName, String serverName, String subscriptionId, String apiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call serverAdvisorsListByServerAsync(String resourceGroupName, String serverName, String subscriptionId, String apiVersion, final ApiCallback<List<Advisor>> _callback) throws ApiException {
