...
async def database_advisors_update(request: web.Request, resource_group_name, server_name, database_name, advisor_name, subscription_id, api_version, parameters) -> web.Response:
