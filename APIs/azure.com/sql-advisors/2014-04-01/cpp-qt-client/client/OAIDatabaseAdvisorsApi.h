...
public:
    ...
    */
    virtual void databaseAdvisorsCreateOrUpdate(const QString &resource_group_name, const QString &server_name, const QString &database_name, const QString &advisor_name, const QString &subscription_id, const QString &api_version, const OAIAdvisor &parameters);
...
private:
    ...
    void databaseAdvisorsCreateOrUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void databaseAdvisorsCreateOrUpdateSignal(OAIAdvisor summary);
    void databaseAdvisorsGetSignal(OAIAdvisor summary);
    void databaseAdvisorsListByDatabaseSignal(OAIAdvisorListResult summary);


    void databaseAdvisorsCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIAdvisor summary);
    void databaseAdvisorsGetSignalFull(OAIHttpRequestWorker *worker, OAIAdvisor summary);
    void databaseAdvisorsListByDatabaseSignalFull(OAIHttpRequestWorker *worker, OAIAdvisorListResult summary);

    Q_DECL_DEPRECATED_X("Use databaseAdvisorsCreateOrUpdateSignalError() instead")
    void databaseAdvisorsCreateOrUpdateSignalE(OAIAdvisor summary, QNetworkReply::NetworkError error_type, QString error_str);
    void databaseAdvisorsCreateOrUpdateSignalError(OAIAdvisor summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void databaseAdvisorsListByDatabaseSignalE(OAIAdvisorListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void databaseAdvisorsListByDatabaseSignalError(OAIAdvisorListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use databaseAdvisorsCreateOrUpdateSignalErrorFull() instead")
    void databaseAdvisorsCreateOrUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void databaseAdvisorsCreateOrUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
