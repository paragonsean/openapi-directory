...
public:
    ...
    */
    virtual void serverAdvisorsCreateOrUpdate(const QString &resource_group_name, const QString &server_name, const QString &advisor_name, const QString &subscription_id, const QString &api_version, const OAIAdvisor &parameters);
...
private:
    ...
    void serverAdvisorsCreateOrUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void serverAdvisorsCreateOrUpdateSignal(OAIAdvisor summary);
    void serverAdvisorsGetSignal(OAIAdvisor summary);
    void serverAdvisorsListByServerSignal(OAIAdvisorListResult summary);
    void serverAdvisorsUpdateSignal(OAIAdvisor summary);


    void serverAdvisorsCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIAdvisor summary);
    void serverAdvisorsGetSignalFull(OAIHttpRequestWorker *worker, OAIAdvisor summary);
    void serverAdvisorsListByServerSignalFull(OAIHttpRequestWorker *worker, OAIAdvisorListResult summary);
    void serverAdvisorsUpdateSignalFull(OAIHttpRequestWorker *worker, OAIAdvisor summary);

    Q_DECL_DEPRECATED_X("Use serverAdvisorsCreateOrUpdateSignalError() instead")
    void serverAdvisorsCreateOrUpdateSignalE(OAIAdvisor summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serverAdvisorsCreateOrUpdateSignalError(OAIAdvisor summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void serverAdvisorsListByServerSignalE(OAIAdvisorListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serverAdvisorsListByServerSignalError(OAIAdvisorListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use serverAdvisorsCreateOrUpdateSignalErrorFull() instead")
    void serverAdvisorsCreateOrUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serverAdvisorsCreateOrUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
