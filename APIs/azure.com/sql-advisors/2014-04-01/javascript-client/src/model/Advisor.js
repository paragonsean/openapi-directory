...
import AdvisorProperties from './AdvisorProperties';
...
class Advisor {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = AdvisorProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          AdvisorProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} kind
 */
Advisor.prototype['kind'] = undefined;

/**
 * Resource location.
 * @member {String} location
 */
Advisor.prototype['location'] = undefined;

/**
 * @member {module:model/AdvisorProperties} properties
 */
