...
|------------- | ------------- | -------------|
| [**serverAdvisorsCreateOrUpdate**](ServerAdvisorsApi.md#serverAdvisorsCreateOrUpdate) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/advisors/{advisorName} |  |
...
<a id="serverAdvisorsCreateOrUpdate"></a>
# **serverAdvisorsCreateOrUpdate**
> Advisor serverAdvisorsCreateOrUpdate(resourceGroupName, serverName, advisorName, subscriptionId, apiVersion, parameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Advisor result = apiInstance.serverAdvisorsCreateOrUpdate(resourceGroupName, serverName, advisorName, subscriptionId, apiVersion, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServerAdvisorsApi#serverAdvisorsCreateOrUpdate");
...
| **0** | *** Error Responses: ***   * 404 SubscriptionDoesNotHaveServer - The requested server was not found   * 404 AdvisorNotFound - The requested advisor was not found.   * 405 NotSupported - This functionality is not supported.   * 409 Conflict - Request could not be processed because of conflict in the request.   * 503 ServiceTemporarilyUnavailable - Feature temporarily unavailable. |  -  |

<a id="serverAdvisorsListByServer"></a>
# **serverAdvisorsListByServer**
> AdvisorListResult serverAdvisorsListByServer(resourceGroupName, serverName, subscriptionId, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version to use for the request.
    try {
      AdvisorListResult result = apiInstance.serverAdvisorsListByServer(resourceGroupName, serverName, subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
| **0** | *** Error Responses: ***   * 404 SubscriptionDoesNotHaveServer - The requested server was not found   * 404 AdvisorNotFound - The requested advisor was not found.   * 503 ServiceTemporarilyUnavailable - Feature temporarily unavailable. |  -  |
