...
async def server_advisors_create_or_update(request: web.Request, resource_group_name, server_name, advisor_name, subscription_id, api_version, parameters) -> web.Response:
    """server_advisors_create_or_update
