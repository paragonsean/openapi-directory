...
/*
 * OAIDatabaseBlobAuditingPolicyProperties.h
 *
 * Properties of a database blob auditing policy.
 */

#ifndef OAIDatabaseBlobAuditingPolicyProperties_H
#define OAIDatabaseBlobAuditingPolicyProperties_H
...
class OAIDatabaseBlobAuditingPolicyProperties : public OAIObject {
public:
    OAIDatabaseBlobAuditingPolicyProperties();
    OAIDatabaseBlobAuditingPolicyProperties(QString json);
    ~OAIDatabaseBlobAuditingPolicyProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseBlobAuditingPolicyProperties)

#endif // OAIDatabaseBlobAuditingPolicyProperties_H
