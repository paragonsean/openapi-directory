...
OAIObject OAICertificate::getProperties() const {
    return m_properties;
}
void OAICertificate::setProperties(const OAIObject &properties) {
...
QString OAICertificate::getKind() const {
    return m_kind;
}
void OAICertificate::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAICertificate::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAICertificate::is_kind_Valid() const{
    return m_kind_isValid;
}

QString OAICertificate::getLocation() const {
    return m_location;
}
void OAICertificate::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICertificate::is_location_Set() const{
    return m_location_isSet;
}

bool OAICertificate::is_location_Valid() const{
...
QMap<QString, QString> OAICertificate::getTags() const {
    return m_tags;
}
void OAICertificate::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICertificate::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICertificate::is_tags_Valid() const{
