...
public class DeviceServicesApi {
     ...
     */
    public okhttp3.Call servicesCreateOrUpdateCall(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call servicesCreateOrUpdateValidateBeforeCall(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch, final ApiCallback _callback) throws ApiException {
     ...
     */
    public DeviceService servicesCreateOrUpdate(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch) throws ApiException {
     ...
     */
    public ApiResponse<DeviceService> servicesCreateOrUpdateWithHttpInfo(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch) throws ApiException {
     ...
     */
    public okhttp3.Call servicesCreateOrUpdateAsync(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch, final ApiCallback<DeviceService> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call servicesUpdateCall(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call servicesUpdateValidateBeforeCall(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
     ...
     */
    public DeviceService servicesUpdate(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch) throws ApiException {
     ...
     */
    public ApiResponse<DeviceService> servicesUpdateWithHttpInfo(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch) throws ApiException {
     ...
     */
    public okhttp3.Call servicesUpdateAsync(String apiVersion, String subscriptionId, String resourceGroupName, String deviceName, DeviceService deviceService, String ifMatch, final ApiCallback<DeviceService> _callback) throws ApiException {
