...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.Certificate();
  });
  ...
  describe('Certificate', function() {
    it('should create an instance of Certificate', function() {
      ...
      //var instance = new AutomationManagement.Certificate();
      //expect(instance).to.be.a(AutomationManagement.Certificate);
    });
