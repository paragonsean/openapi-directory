...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.CertificateApi();
  });
  ...
  describe('CertificateApi', function() {
    ...
    describe('certificateListByAutomationAccount', function() {
      it('should call certificateListByAutomationAccount successfully', function(done) {
        //uncomment below and update the code to test certificateListByAutomationAccount
        //instance.certificateListByAutomationAccount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
