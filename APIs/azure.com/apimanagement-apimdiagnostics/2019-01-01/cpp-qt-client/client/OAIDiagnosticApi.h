...
#ifndef OAI_OAIDiagnosticApi_H
#define OAI_OAIDiagnosticApi_H
...
#include "OAIDiagnostic_Get_200_response.h"
#include "OAIDiagnostic_ListByService_200_response.h"
...
class OAIDiagnosticApi : public QObject {
    Q_OBJECT

public:
    OAIDiagnosticApi(const int timeOut = 0);
    ~OAIDiagnosticApi();
    ...
    * @param[in]  parameters OAIDiagnostic_Get_200_response [required]
    * @param[in]  if_match QString [optional]
    */
    virtual void diagnosticCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &diagnostic_id, const QString &api_version, const QString &subscription_id, const OAIDiagnostic_Get_200_response &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  parameters OAIDiagnostic_Get_200_response [required]
    */
    virtual void diagnosticUpdate(const QString &resource_group_name, const QString &service_name, const QString &diagnostic_id, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAIDiagnostic_Get_200_response &parameters);
...
Q_SIGNALS:
    ...
    void diagnosticCreateOrUpdateSignal(OAIDiagnostic_Get_200_response summary);
    void diagnosticDeleteSignal();
    void diagnosticGetSignal(OAIDiagnostic_Get_200_response summary);
    void diagnosticGetEntityTagSignal();
    void diagnosticListByServiceSignal(OAIDiagnostic_ListByService_200_response summary);
    void diagnosticUpdateSignal();


    void diagnosticCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIDiagnostic_Get_200_response summary);
    void diagnosticDeleteSignalFull(OAIHttpRequestWorker *worker);
    void diagnosticGetSignalFull(OAIHttpRequestWorker *worker, OAIDiagnostic_Get_200_response summary);
    void diagnosticGetEntityTagSignalFull(OAIHttpRequestWorker *worker);
    void diagnosticListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIDiagnostic_ListByService_200_response summary);
    ...
    void diagnosticCreateOrUpdateSignalE(OAIDiagnostic_Get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticCreateOrUpdateSignalError(OAIDiagnostic_Get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void diagnosticGetSignalE(OAIDiagnostic_Get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticGetSignalError(OAIDiagnostic_Get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void diagnosticListByServiceSignalE(OAIDiagnostic_ListByService_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticListByServiceSignalError(OAIDiagnostic_ListByService_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
