# ApiManagementClient.DiagnosticsApi
...
> DiagnosticContract diagnosticCreateOrUpdate(resourceGroupName, serviceName, diagnosticId, apiVersion, subscriptionId, parameters, opts)
...
let apiInstance = new ApiManagementClient.DiagnosticsApi();
...
let parameters = new ApiManagementClient.DiagnosticContract(); // DiagnosticContract | Create parameters.
let opts = {
...
> DiagnosticCollection diagnosticListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let parameters = new ApiManagementClient.DiagnosticContract(); // DiagnosticContract | Diagnostic Update parameters.
