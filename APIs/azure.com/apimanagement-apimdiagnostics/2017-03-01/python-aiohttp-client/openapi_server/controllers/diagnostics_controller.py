...
async def diagnostic_create_or_update(request: web.Request, resource_group_name, service_name, diagnostic_id, api_version, subscription_id, parameters, if_match=None) -> web.Response:
    ...
    """
    parameters = DiagnosticContract.from_dict(parameters)
...
async def diagnostic_head(request: web.Request, resource_group_name, service_name, diagnostic_id, api_version, subscription_id) -> web.Response:
    """diagnostic_head
