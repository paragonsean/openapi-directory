...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void diagnosticHead(const QString &resource_group_name, const QString &service_name, const QString &diagnostic_id, const QString &api_version, const QString &subscription_id);
...
private:
    ...
    void diagnosticHeadCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void diagnosticHeadSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use diagnosticHeadSignalError() instead")
    void diagnosticHeadSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticHeadSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use diagnosticHeadSignalErrorFull() instead")
    void diagnosticHeadSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void diagnosticHeadSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
