...
OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling OAIDiagnosticLogger_ListByService_200_response_value_inner_properties::getSampling() const {
    return m_sampling;
}
void OAIDiagnosticLogger_ListByService_200_response_value_inner_properties::setSampling(const OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling &sampling) {
    m_sampling = sampling;
    m_sampling_isSet = true;
}

bool OAIDiagnosticLogger_ListByService_200_response_value_inner_properties::is_sampling_Set() const{
    return m_sampling_isSet;
}

bool OAIDiagnosticLogger_ListByService_200_response_value_inner_properties::is_sampling_Valid() const{
