...
/*
 * OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties.h
 *
 * Sampling settings for an ApplicationInsights logger.
 */

#ifndef OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties_H
#define OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties_H
...
class OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties : public OAIObject {
public:
    OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties();
    OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties(QString json);
    ~OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties)

#endif // OAIDiagnosticLogger_ListByService_200_response_value_inner_properties_sampling_properties_H
