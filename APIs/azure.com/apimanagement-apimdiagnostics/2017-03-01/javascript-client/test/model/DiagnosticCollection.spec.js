...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.DiagnosticCollection();
  });
  ...
  describe('DiagnosticCollection', function() {
    it('should create an instance of DiagnosticCollection', function() {
      // uncomment below and update the code to test DiagnosticCollection
      //var instance = new ApiManagementClient.DiagnosticCollection();
      //expect(instance).to.be.a(ApiManagementClient.DiagnosticCollection);
    });
