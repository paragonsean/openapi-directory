...
public class Email {
  ...
  public Email detected(String detected) {
  ...
  public Email index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public Email subType(String subType) {
  ...
  public boolean equals(Object o) {
    ...
    Email email = (Email) o;
    return Objects.equals(this.detected, email.detected) &&
        Objects.equals(this.index, email.index) &&
        Objects.equals(this.subType, email.subType) &&
        Objects.equals(this.text, email.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(detected, index, subType, text);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("Detected") != null && !jsonObj.get("Detected").isJsonNull()) && !jsonObj.get("Detected").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `Detected` to be a primitive type in the JSON string but got `%s`", jsonObj.get("Detected").toString()));
      }
