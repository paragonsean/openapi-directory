...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentModeratorClient.IPA();
  });
  ...
  describe('IPA', function() {
    it('should create an instance of IPA', function() {
      // uncomment below and update the code to test IPA
      //var instance = new ContentModeratorClient.IPA();
      //expect(instance).to.be.a(ContentModeratorClient.IPA);
    });
