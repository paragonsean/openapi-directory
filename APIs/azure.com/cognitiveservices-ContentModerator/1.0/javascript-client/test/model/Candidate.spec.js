...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentModeratorClient.Candidate();
  });
  ...
  describe('Candidate', function() {
    it('should create an instance of Candidate', function() {
      ...
      //var instance = new ContentModeratorClient.Candidate();
      //expect(instance).to.be.a(ContentModeratorClient.Candidate);
    });
