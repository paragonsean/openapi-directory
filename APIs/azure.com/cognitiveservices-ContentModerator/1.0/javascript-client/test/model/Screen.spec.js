...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentModeratorClient.Screen();
  });
  ...
  describe('Screen', function() {
    it('should create an instance of Screen', function() {
      ...
      //var instance = new ContentModeratorClient.Screen();
      //expect(instance).to.be.a(ContentModeratorClient.Screen);
    });

    it('should have the property autoCorrectedText (base name: "AutoCorrectedText")', function() {
      // uncomment below and update the code to test the property autoCorrectedText
      //var instance = new ContentModeratorClient.Screen();
    ...
    it('should have the property misrepresentation (base name: "Misrepresentation")', function() {
      // uncomment below and update the code to test the property misrepresentation
      //var instance = new ContentModeratorClient.Screen();
      //expect(instance).to.be();
    });

    it('should have the property normalizedText (base name: "NormalizedText")', function() {
