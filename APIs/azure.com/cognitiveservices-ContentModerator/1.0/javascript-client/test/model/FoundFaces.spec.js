...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentModeratorClient.FoundFaces();
  });
  ...
  describe('FoundFaces', function() {
    it('should create an instance of FoundFaces', function() {
      // uncomment below and update the code to test FoundFaces
      //var instance = new ContentModeratorClient.FoundFaces();
      //expect(instance).to.be.a(ContentModeratorClient.FoundFaces);
    });
