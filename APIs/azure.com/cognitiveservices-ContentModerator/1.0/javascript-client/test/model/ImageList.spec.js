...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentModeratorClient.ImageList();
  });
  ...
  describe('ImageList', function() {
    it('should create an instance of ImageList', function() {
      ...
      //var instance = new ContentModeratorClient.ImageList();
      //expect(instance).to.be.a(ContentModeratorClient.ImageList);
    });
