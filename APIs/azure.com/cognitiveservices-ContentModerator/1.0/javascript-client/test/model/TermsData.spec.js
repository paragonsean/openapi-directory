...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentModeratorClient.TermsData();
  });
  ...
  describe('TermsData', function() {
    it('should create an instance of TermsData', function() {
      // uncomment below and update the code to test TermsData
      //var instance = new ContentModeratorClient.TermsData();
      //expect(instance).to.be.a(ContentModeratorClient.TermsData);
    });
