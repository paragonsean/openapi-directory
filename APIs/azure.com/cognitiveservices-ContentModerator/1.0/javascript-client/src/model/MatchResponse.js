    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('IsMatch')) {
                obj['IsMatch'] = ApiClient.convertToType(data['IsMatch'], 'Boolean');
            }
 ...
 */
MatchResponse.prototype['CacheID'] = undefined;

/**
 * Indicates if there is a match.
 * @member {Boolean} IsMatch
 */
MatchResponse.prototype['IsMatch'] = undefined;

/**
 * The match details.
 * @member {Array.<module:model/Match>} Matches
 */
MatchResponse.prototype['Matches'] = undefined;

/**
 * @member {module:model/Status} Status
 */
MatchResponse.prototype['Status'] = undefined;

/**
 * The tracking id.
 * @member {String} TrackingId
 */
MatchResponse.prototype['TrackingId'] = undefined;
