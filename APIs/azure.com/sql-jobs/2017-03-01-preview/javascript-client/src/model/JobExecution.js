...
import JobExecutionProperties from './JobExecutionProperties';
...
class JobExecution {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = JobExecutionProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          JobExecutionProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/JobExecutionProperties} properties
 */
JobExecution.prototype['properties'] = undefined;
 ...
 * @member {String} type
 */
JobExecution.prototype['type'] = undefined;
