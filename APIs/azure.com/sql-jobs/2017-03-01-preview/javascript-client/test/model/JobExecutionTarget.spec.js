...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.JobExecutionTarget();
  });
  ...
  describe('JobExecutionTarget', function() {
    it('should create an instance of JobExecutionTarget', function() {
      // uncomment below and update the code to test JobExecutionTarget
      //var instance = new SqlManagementClient.JobExecutionTarget();
      //expect(instance).to.be.a(SqlManagementClient.JobExecutionTarget);
    });
