...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.JobExecution();
  });
  ...
  describe('JobExecution', function() {
    it('should create an instance of JobExecution', function() {
      ...
      //var instance = new SqlManagementClient.JobExecution();
      //expect(instance).to.be.a(SqlManagementClient.JobExecution);
    });
