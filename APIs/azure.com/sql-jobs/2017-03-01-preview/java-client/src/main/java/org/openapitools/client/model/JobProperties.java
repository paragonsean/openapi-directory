...
public class JobProperties {
  ...
  public JobProperties schedule(JobSchedule schedule) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, jobProperties.description) &&
        Objects.equals(this.schedule, jobProperties.schedule) &&
        Objects.equals(this.version, jobProperties.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schedule, version);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("schedule") != null && !jsonObj.get("schedule").isJsonNull()) {
        JobSchedule.validateJsonElement(jsonObj.get("schedule"));
      }
  }
