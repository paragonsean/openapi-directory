...
async def job_step_executions_get(request: web.Request, resource_group_name, server_name, job_agent_name, job_name, job_execution_id, step_name, subscription_id, api_version) -> web.Response:
...
async def job_step_executions_list_by_job_execution(request: web.Request, resource_group_name, server_name, job_agent_name, job_name, job_execution_id, subscription_id, api_version, create_time_min=None, create_time_max=None, end_time_min=None, end_time_max=None, is_active=None, skip=None, top=None) -> web.Response:
