# NetworkAdminManagementClient.VirtualNetworksApi
...
> VirtualNetworksList virtualNetworksList(subscriptionId, apiVersion, opts)
...
let apiInstance = new NetworkAdminManagementClient.VirtualNetworksApi();
...
apiInstance.virtualNetworksList(subscriptionId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
