...
async def policy_set_evaluate_policies(request: web.Request, subscription_id, resource_group_name, lab_name, name, api_version, evaluate_policies_request) -> web.Response:
