...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.VMCostProperties();
  });
  ...
  describe('VMCostProperties', function() {
    it('should create an instance of VMCostProperties', function() {
      // uncomment below and update the code to test VMCostProperties
      //var instance = new DevTestLabsClient.VMCostProperties();
      //expect(instance).to.be.a(DevTestLabsClient.VMCostProperties);
    });
