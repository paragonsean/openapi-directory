...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.WeekDetails();
  });
  ...
  describe('WeekDetails', function() {
    it('should create an instance of WeekDetails', function() {
      // uncomment below and update the code to test WeekDetails
      //var instance = new DevTestLabsClient.WeekDetails();
      //expect(instance).to.be.a(DevTestLabsClient.WeekDetails);
    });
