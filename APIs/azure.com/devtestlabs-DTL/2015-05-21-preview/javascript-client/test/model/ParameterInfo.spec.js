...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.ParameterInfo();
  });
  ...
  describe('ParameterInfo', function() {
    it('should create an instance of ParameterInfo', function() {
      // uncomment below and update the code to test ParameterInfo
      //var instance = new DevTestLabsClient.ParameterInfo();
      //expect(instance).to.be.a(DevTestLabsClient.ParameterInfo);
    });
