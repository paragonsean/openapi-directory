...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.FormulaProperties();
  });
  ...
  describe('FormulaProperties', function() {
    it('should create an instance of FormulaProperties', function() {
      // uncomment below and update the code to test FormulaProperties
      //var instance = new DevTestLabsClient.FormulaProperties();
      //expect(instance).to.be.a(DevTestLabsClient.FormulaProperties);
    });
