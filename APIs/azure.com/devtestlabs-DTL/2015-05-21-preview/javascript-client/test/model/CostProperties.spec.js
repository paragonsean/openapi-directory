...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.CostProperties();
  });
  ...
  describe('CostProperties', function() {
    it('should create an instance of CostProperties', function() {
      // uncomment below and update the code to test CostProperties
      //var instance = new DevTestLabsClient.CostProperties();
      //expect(instance).to.be.a(DevTestLabsClient.CostProperties);
    });
