...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.HourDetails();
  });
  ...
  describe('HourDetails', function() {
    it('should create an instance of HourDetails', function() {
      // uncomment below and update the code to test HourDetails
      //var instance = new DevTestLabsClient.HourDetails();
      //expect(instance).to.be.a(DevTestLabsClient.HourDetails);
    });
