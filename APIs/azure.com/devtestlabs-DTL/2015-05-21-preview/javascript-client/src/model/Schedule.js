...
class Schedule {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ScheduleProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ScheduleProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 */
Schedule.prototype['location'] = undefined;
...
/**
 * @member {module:model/ScheduleProperties} properties
 */
Schedule.prototype['properties'] = undefined;

/**
 * The tags of the resource.
 * @member {Object.<String, String>} tags
 */
Schedule.prototype['tags'] = undefined;

/**
 * The type of the resource.
 * @member {String} type
 */
Schedule.prototype['type'] = undefined;
