...
<a id="labsImportVirtualMachine"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String name = "name_example"; // String | The name of the lab.
    String apiVersion = "2018-09-15"; // String | Client API version.
    ImportLabVirtualMachineRequest importLabVirtualMachineRequest = new ImportLabVirtualMachineRequest(); // ImportLabVirtualMachineRequest | This represents the payload required to import a virtual machine from a different lab into the current one
    try {
      apiInstance.labsImportVirtualMachine(subscriptionId, resourceGroupName, name, apiVersion, importLabVirtualMachineRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling LabsApi#labsImportVirtualMachine");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> LabList labsListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      LabList result = apiInstance.labsListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
...
> LabList labsListBySubscription(subscriptionId, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    String $orderby = "$orderby_example"; // String | The ordering expression for the results, using OData notation. Example: '$orderby=name desc'
    try {
      LabList result = apiInstance.labsListBySubscription(subscriptionId, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "2018-09-15"; // String | Client API version.
    try {
      LabVhdList result = apiInstance.labsListVhds(subscriptionId, resourceGroupName, name, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
