...
<a id="usersList"></a>
# **usersList**
> UserList usersList(subscriptionId, resourceGroupName, labName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserList result = apiInstance.usersList(subscriptionId, resourceGroupName, labName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
