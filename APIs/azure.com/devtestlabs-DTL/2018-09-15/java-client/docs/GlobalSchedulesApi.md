...
> ScheduleList globalSchedulesListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ScheduleList result = apiInstance.globalSchedulesListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
...
> ScheduleList globalSchedulesListBySubscription(subscriptionId, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    String $orderby = "$orderby_example"; // String | The ordering expression for the results, using OData notation. Example: '$orderby=name desc'
    try {
      ScheduleList result = apiInstance.globalSchedulesListBySubscription(subscriptionId, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
