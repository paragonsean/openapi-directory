...
# **armTemplatesList**
> ArmTemplateList armTemplatesList(subscriptionId, resourceGroupName, labName, artifactSourceName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ArmTemplateList result = apiInstance.armTemplatesList(subscriptionId, resourceGroupName, labName, artifactSourceName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
