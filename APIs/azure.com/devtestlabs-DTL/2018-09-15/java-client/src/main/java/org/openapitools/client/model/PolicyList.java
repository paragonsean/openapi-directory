...
public class PolicyList {
  ...
  private List<Policy> value = new ArrayList<>();

  public PolicyList() {
  }

  public PolicyList nextLink(String nextLink) {
  ...
  public PolicyList value(List<Policy> value) {
    this.value = value;
    return this;
  }

  public PolicyList addValueItem(Policy valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<Policy> getValue() {
    return value;
  }

  public void setValue(List<Policy> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextLink, policyList.nextLink) &&
        Objects.equals(this.value, policyList.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            Policy.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
