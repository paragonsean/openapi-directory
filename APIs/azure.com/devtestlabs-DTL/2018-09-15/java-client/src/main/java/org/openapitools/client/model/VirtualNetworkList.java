...
public class VirtualNetworkList {
  ...
  public VirtualNetworkList nextLink(String nextLink) {
  ...
  public VirtualNetworkList value(List<VirtualNetwork> value) {
    this.value = value;
    return this;
  }

  public VirtualNetworkList addValueItem(VirtualNetwork valueItem) {
    if (this.value == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextLink, virtualNetworkList.nextLink) &&
        Objects.equals(this.value, virtualNetworkList.value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VirtualNetworkList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VirtualNetworkList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
