...
public class VirtualNetwork {
  ...
  public VirtualNetwork properties(VirtualNetworkProperties properties) {
  ...
  public VirtualNetworkProperties getProperties() {
    return properties;
  }

  public void setProperties(VirtualNetworkProperties properties) {
    this.properties = properties;
  }
  ...
  public VirtualNetwork location(String location) {
  ...
  public VirtualNetwork tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public VirtualNetwork putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.properties, virtualNetwork.properties) &&
        Objects.equals(this.id, virtualNetwork.id) &&
        Objects.equals(this.location, virtualNetwork.location) &&
        Objects.equals(this.name, virtualNetwork.name) &&
        Objects.equals(this.tags, virtualNetwork.tags) &&
        Objects.equals(this.type, virtualNetwork.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VirtualNetwork.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VirtualNetwork` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        VirtualNetworkProperties.validateJsonElement(jsonObj.get("properties"));
      }
