...
public class ShutdownNotificationContent {
  ...
  public static final String SERIALIZED_NAME_MINUTES_UNTIL_SHUTDOWN = "minutesUntilShutdown";
  @SerializedName(SERIALIZED_NAME_MINUTES_UNTIL_SHUTDOWN)
  ...
  public static final String SERIALIZED_NAME_VM_URL = "vmUrl";
  @SerializedName(SERIALIZED_NAME_VM_URL)
  ...
  public ShutdownNotificationContent minutesUntilShutdown(String minutesUntilShutdown) {
   ...
   */
  @javax.annotation.Nullable
  public String getMinutesUntilShutdown() {
    return minutesUntilShutdown;
  }

  public void setMinutesUntilShutdown(String minutesUntilShutdown) {
    this.minutesUntilShutdown = minutesUntilShutdown;
  }
  ...
  public ShutdownNotificationContent vmUrl(String vmUrl) {
    this.vmUrl = vmUrl;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.delayUrl120, shutdownNotificationContent.delayUrl120) &&
        ...
        Objects.equals(this.minutesUntilShutdown, shutdownNotificationContent.minutesUntilShutdown) &&
        ...
        Objects.equals(this.vmUrl, shutdownNotificationContent.vmUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delayUrl120, delayUrl60, eventType, guid, labName, minutesUntilShutdown, owner, resourceGroupName, skipUrl, subscriptionId, text, vmName, vmUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("    minutesUntilShutdown: ").append(toIndentedString(minutesUntilShutdown)).append("\n");
    ...
    sb.append("    vmUrl: ").append(toIndentedString(vmUrl)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("minutesUntilShutdown");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("minutesUntilShutdown") != null && !jsonObj.get("minutesUntilShutdown").isJsonNull()) && !jsonObj.get("minutesUntilShutdown").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `minutesUntilShutdown` to be a primitive type in the JSON string but got `%s`", jsonObj.get("minutesUntilShutdown").toString()));
      }
      ...
      if ((jsonObj.get("vmUrl") != null && !jsonObj.get("vmUrl").isJsonNull()) && !jsonObj.get("vmUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `vmUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("vmUrl").toString()));
      }
  }
