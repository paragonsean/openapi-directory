...
import org.openapitools.client.model.BulkCreationParametersFragment;
...
public class LabVirtualMachineCreationParameterPropertiesFragment {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment() {
  }

  public LabVirtualMachineCreationParameterPropertiesFragment allowClaim(Boolean allowClaim) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment artifactDeploymentStatus(ArtifactDeploymentStatusPropertiesFragment artifactDeploymentStatus) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment artifacts(List<ArtifactInstallPropertiesFragment> artifacts) {
    this.artifacts = artifacts;
    return this;
  }

  public LabVirtualMachineCreationParameterPropertiesFragment addArtifactsItem(ArtifactInstallPropertiesFragment artifactsItem) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment bulkCreationParameters(BulkCreationParametersFragment bulkCreationParameters) {
   ...
   */
  @javax.annotation.Nullable
  public BulkCreationParametersFragment getBulkCreationParameters() {
    return bulkCreationParameters;
  }

  public void setBulkCreationParameters(BulkCreationParametersFragment bulkCreationParameters) {
    this.bulkCreationParameters = bulkCreationParameters;
  }


  public LabVirtualMachineCreationParameterPropertiesFragment computeId(String computeId) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment createdByUser(String createdByUser) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment createdByUserId(String createdByUserId) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment createdDate(OffsetDateTime createdDate) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment customImageId(String customImageId) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment dataDiskParameters(List<DataDiskPropertiesFragment> dataDiskParameters) {
    this.dataDiskParameters = dataDiskParameters;
    return this;
  }

  public LabVirtualMachineCreationParameterPropertiesFragment addDataDiskParametersItem(DataDiskPropertiesFragment dataDiskParametersItem) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment disallowPublicIpAddress(Boolean disallowPublicIpAddress) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment environmentId(String environmentId) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment expirationDate(OffsetDateTime expirationDate) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment fqdn(String fqdn) {
    this.fqdn = fqdn;
    return this;
  }
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment galleryImageReference(GalleryImageReferenceFragment galleryImageReference) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment isAuthenticationWithSshKey(Boolean isAuthenticationWithSshKey) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment labSubnetName(String labSubnetName) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment labVirtualNetworkId(String labVirtualNetworkId) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment lastKnownPowerState(String lastKnownPowerState) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment networkInterface(NetworkInterfacePropertiesFragment networkInterface) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment osType(String osType) {
    this.osType = osType;
    return this;
  }
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment ownerObjectId(String ownerObjectId) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment ownerUserPrincipalName(String ownerUserPrincipalName) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment password(String password) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment planId(String planId) {
    this.planId = planId;
    return this;
  }
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment scheduleParameters(List<ScheduleCreationParameterFragment> scheduleParameters) {
    this.scheduleParameters = scheduleParameters;
    return this;
  }

  public LabVirtualMachineCreationParameterPropertiesFragment addScheduleParametersItem(ScheduleCreationParameterFragment scheduleParametersItem) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment size(String size) {
    this.size = size;
    return this;
  }
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment sshKey(String sshKey) {
    this.sshKey = sshKey;
    return this;
  }
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment storageType(String storageType) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment userName(String userName) {
  ...
  public LabVirtualMachineCreationParameterPropertiesFragment virtualMachineCreationSource(VirtualMachineCreationSourceEnum virtualMachineCreationSource) {
  ...
  public boolean equals(Object o) {
    ...
    LabVirtualMachineCreationParameterPropertiesFragment labVirtualMachineCreationParameterPropertiesFragment = (LabVirtualMachineCreationParameterPropertiesFragment) o;
    return Objects.equals(this.allowClaim, labVirtualMachineCreationParameterPropertiesFragment.allowClaim) &&
        Objects.equals(this.artifactDeploymentStatus, labVirtualMachineCreationParameterPropertiesFragment.artifactDeploymentStatus) &&
        Objects.equals(this.artifacts, labVirtualMachineCreationParameterPropertiesFragment.artifacts) &&
        Objects.equals(this.bulkCreationParameters, labVirtualMachineCreationParameterPropertiesFragment.bulkCreationParameters) &&
        Objects.equals(this.computeId, labVirtualMachineCreationParameterPropertiesFragment.computeId) &&
        Objects.equals(this.createdByUser, labVirtualMachineCreationParameterPropertiesFragment.createdByUser) &&
        Objects.equals(this.createdByUserId, labVirtualMachineCreationParameterPropertiesFragment.createdByUserId) &&
        Objects.equals(this.createdDate, labVirtualMachineCreationParameterPropertiesFragment.createdDate) &&
        Objects.equals(this.customImageId, labVirtualMachineCreationParameterPropertiesFragment.customImageId) &&
        Objects.equals(this.dataDiskParameters, labVirtualMachineCreationParameterPropertiesFragment.dataDiskParameters) &&
        Objects.equals(this.disallowPublicIpAddress, labVirtualMachineCreationParameterPropertiesFragment.disallowPublicIpAddress) &&
        Objects.equals(this.environmentId, labVirtualMachineCreationParameterPropertiesFragment.environmentId) &&
        Objects.equals(this.expirationDate, labVirtualMachineCreationParameterPropertiesFragment.expirationDate) &&
        Objects.equals(this.fqdn, labVirtualMachineCreationParameterPropertiesFragment.fqdn) &&
        Objects.equals(this.galleryImageReference, labVirtualMachineCreationParameterPropertiesFragment.galleryImageReference) &&
        Objects.equals(this.isAuthenticationWithSshKey, labVirtualMachineCreationParameterPropertiesFragment.isAuthenticationWithSshKey) &&
        Objects.equals(this.labSubnetName, labVirtualMachineCreationParameterPropertiesFragment.labSubnetName) &&
        Objects.equals(this.labVirtualNetworkId, labVirtualMachineCreationParameterPropertiesFragment.labVirtualNetworkId) &&
        Objects.equals(this.lastKnownPowerState, labVirtualMachineCreationParameterPropertiesFragment.lastKnownPowerState) &&
        Objects.equals(this.networkInterface, labVirtualMachineCreationParameterPropertiesFragment.networkInterface) &&
        Objects.equals(this.notes, labVirtualMachineCreationParameterPropertiesFragment.notes) &&
        Objects.equals(this.osType, labVirtualMachineCreationParameterPropertiesFragment.osType) &&
        Objects.equals(this.ownerObjectId, labVirtualMachineCreationParameterPropertiesFragment.ownerObjectId) &&
        Objects.equals(this.ownerUserPrincipalName, labVirtualMachineCreationParameterPropertiesFragment.ownerUserPrincipalName) &&
        Objects.equals(this.password, labVirtualMachineCreationParameterPropertiesFragment.password) &&
        Objects.equals(this.planId, labVirtualMachineCreationParameterPropertiesFragment.planId) &&
        Objects.equals(this.scheduleParameters, labVirtualMachineCreationParameterPropertiesFragment.scheduleParameters) &&
        Objects.equals(this.size, labVirtualMachineCreationParameterPropertiesFragment.size) &&
        Objects.equals(this.sshKey, labVirtualMachineCreationParameterPropertiesFragment.sshKey) &&
        Objects.equals(this.storageType, labVirtualMachineCreationParameterPropertiesFragment.storageType) &&
        Objects.equals(this.userName, labVirtualMachineCreationParameterPropertiesFragment.userName) &&
        Objects.equals(this.virtualMachineCreationSource, labVirtualMachineCreationParameterPropertiesFragment.virtualMachineCreationSource);
  }
  ...
  public String toString() {
    ...
    sb.append("class LabVirtualMachineCreationParameterPropertiesFragment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LabVirtualMachineCreationParameterPropertiesFragment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LabVirtualMachineCreationParameterPropertiesFragment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LabVirtualMachineCreationParameterPropertiesFragment is not found in the empty JSON string", LabVirtualMachineCreationParameterPropertiesFragment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LabVirtualMachineCreationParameterPropertiesFragment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LabVirtualMachineCreationParameterPropertiesFragment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bulkCreationParameters") != null && !jsonObj.get("bulkCreationParameters").isJsonNull()) {
        BulkCreationParametersFragment.validateJsonElement(jsonObj.get("bulkCreationParameters"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LabVirtualMachineCreationParameterPropertiesFragment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LabVirtualMachineCreationParameterPropertiesFragment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LabVirtualMachineCreationParameterPropertiesFragment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LabVirtualMachineCreationParameterPropertiesFragment.class));

       return (TypeAdapter<T>) new TypeAdapter<LabVirtualMachineCreationParameterPropertiesFragment>() {
           @Override
           public void write(JsonWriter out, LabVirtualMachineCreationParameterPropertiesFragment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LabVirtualMachineCreationParameterPropertiesFragment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LabVirtualMachineCreationParameterPropertiesFragment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LabVirtualMachineCreationParameterPropertiesFragment
   * @throws IOException if the JSON string is invalid with respect to LabVirtualMachineCreationParameterPropertiesFragment
   */
  public static LabVirtualMachineCreationParameterPropertiesFragment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LabVirtualMachineCreationParameterPropertiesFragment.class);
  }

  /**
   * Convert an instance of LabVirtualMachineCreationParameterPropertiesFragment to an JSON string
   *
   * @return JSON string
   */
