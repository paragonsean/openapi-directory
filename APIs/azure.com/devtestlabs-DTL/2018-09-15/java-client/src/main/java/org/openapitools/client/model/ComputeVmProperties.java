...
public class ComputeVmProperties {
  ...
  private List<ComputeDataDisk> dataDisks = new ArrayList<>();
  ...
  private List<ComputeVmInstanceViewStatus> statuses = new ArrayList<>();
  ...
  public ComputeVmProperties dataDiskIds(List<String> dataDiskIds) {
    this.dataDiskIds = dataDiskIds;
    return this;
  }

  public ComputeVmProperties addDataDiskIdsItem(String dataDiskIdsItem) {
  ...
  public ComputeVmProperties dataDisks(List<ComputeDataDisk> dataDisks) {
    this.dataDisks = dataDisks;
    return this;
  }

  public ComputeVmProperties addDataDisksItem(ComputeDataDisk dataDisksItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ComputeDataDisk> getDataDisks() {
    return dataDisks;
  }

  public void setDataDisks(List<ComputeDataDisk> dataDisks) {
    this.dataDisks = dataDisks;
  }


  public ComputeVmProperties networkInterfaceId(String networkInterfaceId) {
  ...
  public ComputeVmProperties osDiskId(String osDiskId) {
  ...
  public ComputeVmProperties osType(String osType) {
    this.osType = osType;
    return this;
  }
  ...
  public ComputeVmProperties statuses(List<ComputeVmInstanceViewStatus> statuses) {
    this.statuses = statuses;
    return this;
  }

  public ComputeVmProperties addStatusesItem(ComputeVmInstanceViewStatus statusesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ComputeVmInstanceViewStatus> getStatuses() {
    return statuses;
  }

  public void setStatuses(List<ComputeVmInstanceViewStatus> statuses) {
    this.statuses = statuses;
  }


  public ComputeVmProperties vmSize(String vmSize) {
    this.vmSize = vmSize;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ComputeVmProperties computeVmProperties = (ComputeVmProperties) o;
    return Objects.equals(this.dataDiskIds, computeVmProperties.dataDiskIds) &&
        Objects.equals(this.dataDisks, computeVmProperties.dataDisks) &&
        Objects.equals(this.networkInterfaceId, computeVmProperties.networkInterfaceId) &&
        Objects.equals(this.osDiskId, computeVmProperties.osDiskId) &&
        Objects.equals(this.osType, computeVmProperties.osType) &&
        Objects.equals(this.statuses, computeVmProperties.statuses) &&
        Objects.equals(this.vmSize, computeVmProperties.vmSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComputeVmProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComputeVmProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComputeVmProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComputeVmProperties is not found in the empty JSON string", ComputeVmProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComputeVmProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComputeVmProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dataDisks") != null && !jsonObj.get("dataDisks").isJsonNull()) {
        ...
        if (jsonArraydataDisks != null) {
          ...
          for (int i = 0; i < jsonArraydataDisks.size(); i++) {
            ComputeDataDisk.validateJsonElement(jsonArraydataDisks.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("statuses") != null && !jsonObj.get("statuses").isJsonNull()) {
        ...
        if (jsonArraystatuses != null) {
          ...
          for (int i = 0; i < jsonArraystatuses.size(); i++) {
            ComputeVmInstanceViewStatus.validateJsonElement(jsonArraystatuses.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComputeVmProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComputeVmProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComputeVmProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComputeVmProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ComputeVmProperties>() {
           @Override
           public void write(JsonWriter out, ComputeVmProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComputeVmProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComputeVmProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComputeVmProperties
   * @throws IOException if the JSON string is invalid with respect to ComputeVmProperties
   */
  public static ComputeVmProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComputeVmProperties.class);
  }

  /**
   * Convert an instance of ComputeVmProperties to an JSON string
   *
   * @return JSON string
   */
