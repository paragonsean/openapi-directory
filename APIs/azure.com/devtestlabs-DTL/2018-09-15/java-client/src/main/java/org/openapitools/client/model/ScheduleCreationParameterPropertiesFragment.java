...
public class ScheduleCreationParameterPropertiesFragment {
  ...
  public ScheduleCreationParameterPropertiesFragment() {
  }

  public ScheduleCreationParameterPropertiesFragment dailyRecurrence(DayDetailsFragment dailyRecurrence) {
  ...
  public ScheduleCreationParameterPropertiesFragment hourlyRecurrence(HourDetailsFragment hourlyRecurrence) {
  ...
  public ScheduleCreationParameterPropertiesFragment notificationSettings(NotificationSettingsFragment notificationSettings) {
  ...
  public ScheduleCreationParameterPropertiesFragment status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ScheduleCreationParameterPropertiesFragment targetResourceId(String targetResourceId) {
  ...
  public ScheduleCreationParameterPropertiesFragment taskType(String taskType) {
  ...
  public ScheduleCreationParameterPropertiesFragment timeZoneId(String timeZoneId) {
  ...
  public ScheduleCreationParameterPropertiesFragment weeklyRecurrence(WeekDetailsFragment weeklyRecurrence) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleCreationParameterPropertiesFragment scheduleCreationParameterPropertiesFragment = (ScheduleCreationParameterPropertiesFragment) o;
    return Objects.equals(this.dailyRecurrence, scheduleCreationParameterPropertiesFragment.dailyRecurrence) &&
        Objects.equals(this.hourlyRecurrence, scheduleCreationParameterPropertiesFragment.hourlyRecurrence) &&
        Objects.equals(this.notificationSettings, scheduleCreationParameterPropertiesFragment.notificationSettings) &&
        Objects.equals(this.status, scheduleCreationParameterPropertiesFragment.status) &&
        Objects.equals(this.targetResourceId, scheduleCreationParameterPropertiesFragment.targetResourceId) &&
        Objects.equals(this.taskType, scheduleCreationParameterPropertiesFragment.taskType) &&
        Objects.equals(this.timeZoneId, scheduleCreationParameterPropertiesFragment.timeZoneId) &&
        Objects.equals(this.weeklyRecurrence, scheduleCreationParameterPropertiesFragment.weeklyRecurrence);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleCreationParameterPropertiesFragment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleCreationParameterPropertiesFragment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleCreationParameterPropertiesFragment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleCreationParameterPropertiesFragment is not found in the empty JSON string", ScheduleCreationParameterPropertiesFragment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleCreationParameterPropertiesFragment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleCreationParameterPropertiesFragment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleCreationParameterPropertiesFragment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleCreationParameterPropertiesFragment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleCreationParameterPropertiesFragment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleCreationParameterPropertiesFragment.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleCreationParameterPropertiesFragment>() {
           @Override
           public void write(JsonWriter out, ScheduleCreationParameterPropertiesFragment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleCreationParameterPropertiesFragment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleCreationParameterPropertiesFragment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleCreationParameterPropertiesFragment
   * @throws IOException if the JSON string is invalid with respect to ScheduleCreationParameterPropertiesFragment
   */
  public static ScheduleCreationParameterPropertiesFragment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleCreationParameterPropertiesFragment.class);
  }

  /**
   * Convert an instance of ScheduleCreationParameterPropertiesFragment to an JSON string
   *
   * @return JSON string
   */
