...
class ShutdownNotificationContent(Model):
    ...
    def __init__(self, delay_url120: str=None, delay_url60: str=None, event_type: str=None, guid: str=None, lab_name: str=None, minutes_until_shutdown: str=None, owner: str=None, resource_group_name: str=None, skip_url: str=None, subscription_id: str=None, text: str=None, vm_name: str=None, vm_url: str=None):
        ...
        :param minutes_until_shutdown: The minutes_until_shutdown of this ShutdownNotificationContent.
        ...
        :param vm_url: The vm_url of this ShutdownNotificationContent.
        """
        self.openapi_types = {
            'delay_url120': str,
            'delay_url60': str,
        ...
        self.attribute_map = {
            ...
            'guid': 'guid',
            'lab_name': 'labName',
            'minutes_until_shutdown': 'minutesUntilShutdown',
            'owner': 'owner',
        ...
        self._minutes_until_shutdown = minutes_until_shutdown
        self._owner = owner
    ...
    @property
    def minutes_until_shutdown(self):
        """Gets the minutes_until_shutdown of this ShutdownNotificationContent.

        Minutes remaining until shutdown

        :return: The minutes_until_shutdown of this ShutdownNotificationContent.
        :rtype: str
        """
        return self._minutes_until_shutdown

    @minutes_until_shutdown.setter
    def minutes_until_shutdown(self, minutes_until_shutdown):
        """Sets the minutes_until_shutdown of this ShutdownNotificationContent.
    ...
    @property
    def vm_url(self):
        """Gets the vm_url of this ShutdownNotificationContent.

        The URL of the virtual machine.

        :return: The vm_url of this ShutdownNotificationContent.
        :rtype: str
        """
        return self._vm_url

    @vm_url.setter
    def vm_url(self, vm_url):
        """Sets the vm_url of this ShutdownNotificationContent.
