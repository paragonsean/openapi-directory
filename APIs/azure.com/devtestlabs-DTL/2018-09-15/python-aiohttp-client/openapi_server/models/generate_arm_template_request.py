...
class GenerateArmTemplateRequest(Model):
    ...
    def __init__(self, file_upload_options: str=None, location: str=None, parameters: List[ParameterInfo]=None, virtual_machine_name: str=None):
        """GenerateArmTemplateRequest - a model defined in OpenAPI

        :param file_upload_options: The file_upload_options of this GenerateArmTemplateRequest.
        ...
        self._file_upload_options = file_upload_options
    ...
    @property
    def file_upload_options(self):
        """Gets the file_upload_options of this GenerateArmTemplateRequest.

        Options for uploading the files for the artifact. UploadFilesAndGenerateSasTokens is the default value.

        :return: The file_upload_options of this GenerateArmTemplateRequest.
        :rtype: str
        """
        return self._file_upload_options

    @file_upload_options.setter
    def file_upload_options(self, file_upload_options):
        """Sets the file_upload_options of this GenerateArmTemplateRequest.

        Options for uploading the files for the artifact. UploadFilesAndGenerateSasTokens is the default value.

        :param file_upload_options: The file_upload_options of this GenerateArmTemplateRequest.
        :type file_upload_options: str
        """
        allowed_values = ["UploadFilesAndGenerateSasTokens", "None"]  # noqa: E501
        if file_upload_options not in allowed_values:
            raise ValueError(
                "Invalid value for `file_upload_options` ({0}), must be one of {1}"
                .format(file_upload_options, allowed_values)
            )
