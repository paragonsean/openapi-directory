...
async def disks_update(request: web.Request, subscription_id, resource_group_name, lab_name, user_name, name, api_version, disk) -> web.Response:
    """disks_update
    ...
    """
    disk = DiskFragment.from_dict(disk)
    return web.Response(status=200)
