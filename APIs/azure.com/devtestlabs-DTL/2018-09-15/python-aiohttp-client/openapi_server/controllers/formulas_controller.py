...
async def formulas_update(request: web.Request, subscription_id, resource_group_name, lab_name, name, api_version, formula) -> web.Response:
    """formulas_update
    ...
    """
    formula = FormulaFragment.from_dict(formula)
    return web.Response(status=200)
