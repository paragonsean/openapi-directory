...
async def environments_update(request: web.Request, subscription_id, resource_group_name, lab_name, user_name, name, api_version, dtl_environment) -> web.Response:
    """environments_update
    ...
    """
    dtl_environment = DtlEnvironmentFragment.from_dict(dtl_environment)
    return web.Response(status=200)
