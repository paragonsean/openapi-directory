...
async def test_notification_channels_create_or_update(client):
    ...
    """
    notification_channel = {"properties":{"notificationLocale":"notificationLocale","createdDate":"2000-01-23T04:56:07.000+00:00","webHookUrl":"webHookUrl","description":"description","emailRecipient":"emailRecipient","provisioningState":"provisioningState","events":[{"eventName":"AutoShutdown"},{"eventName":"AutoShutdown"}],"uniqueIdentifier":"uniqueIdentifier"}}
...
async def test_notification_channels_update(client):
    ...
    """
    notification_channel = {"properties":{"notificationLocale":"notificationLocale","webHookUrl":"webHookUrl","description":"description","emailRecipient":"emailRecipient","events":[{"eventName":"AutoShutdown"},{"eventName":"AutoShutdown"}]}}
    params = [('api-version', '2018-09-15')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
