...
async def test_users_update(client):
    ...
    """
    user = {"properties":{"secretStore":{"keyVaultUri":"keyVaultUri","keyVaultId":"keyVaultId"},"identity":{"appId":"appId","tenantId":"tenantId","principalId":"principalId","principalName":"principalName","objectId":"objectId"}}}
    params = [('api-version', '2018-09-15')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
