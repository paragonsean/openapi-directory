...
async def test_artifact_sources_update(client):
    ...
    """
    artifact_source = {"properties":{"folderPath":"folderPath","securityToken":"securityToken","sourceType":"VsoGit","displayName":"displayName","armTemplateFolderPath":"armTemplateFolderPath","branchRef":"branchRef","uri":"uri","status":"Enabled"}}
    params = [('api-version', '2018-09-15')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
