...
async def test_policies_update(client):
    ...
    """
    policy = {"properties":{"factData":"factData","evaluatorType":"AllowedValuesPolicy","description":"description","threshold":"threshold","factName":"UserOwnedLabVmCount","status":"Enabled"}}
    params = [('api-version', '2018-09-15')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
