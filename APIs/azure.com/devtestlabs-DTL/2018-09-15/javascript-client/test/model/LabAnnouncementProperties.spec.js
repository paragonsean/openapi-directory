...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.LabAnnouncementProperties();
  });
  ...
  describe('LabAnnouncementProperties', function() {
    it('should create an instance of LabAnnouncementProperties', function() {
      // uncomment below and update the code to test LabAnnouncementProperties
      //var instance = new DevTestLabsClient.LabAnnouncementProperties();
      //expect(instance).to.be.a(DevTestLabsClient.LabAnnouncementProperties);
    });
