...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.PolicyList();
  });
  ...
  describe('PolicyList', function() {
    it('should create an instance of PolicyList', function() {
      // uncomment below and update the code to test PolicyList
      //var instance = new DevTestLabsClient.PolicyList();
      //expect(instance).to.be.a(DevTestLabsClient.PolicyList);
    });
