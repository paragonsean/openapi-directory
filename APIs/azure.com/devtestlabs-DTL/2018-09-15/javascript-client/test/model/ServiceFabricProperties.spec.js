...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.ServiceFabricProperties();
  });
  ...
  describe('ServiceFabricProperties', function() {
    it('should create an instance of ServiceFabricProperties', function() {
      // uncomment below and update the code to test ServiceFabricProperties
      //var instance = new DevTestLabsClient.ServiceFabricProperties();
      //expect(instance).to.be.a(DevTestLabsClient.ServiceFabricProperties);
    });
