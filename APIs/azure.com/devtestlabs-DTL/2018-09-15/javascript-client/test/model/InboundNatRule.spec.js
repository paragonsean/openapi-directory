...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.InboundNatRule();
  });
  ...
  describe('InboundNatRule', function() {
    it('should create an instance of InboundNatRule', function() {
      // uncomment below and update the code to test InboundNatRule
      //var instance = new DevTestLabsClient.InboundNatRule();
      //expect(instance).to.be.a(DevTestLabsClient.InboundNatRule);
    });
