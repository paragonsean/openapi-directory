...
(function(root, factory) {
  ...
  describe('LabsApi', function() {
    ...
    describe('labsImportVirtualMachine', function() {
      it('should call labsImportVirtualMachine successfully', function(done) {
        //uncomment below and update the code to test labsImportVirtualMachine
        //instance.labsImportVirtualMachine(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
