...
[**customImagesUpdate**](CustomImagesApi.md#customImagesUpdate) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/customimages/{name} | 
...
> CustomImageList customImagesList(subscriptionId, resourceGroupName, labName, apiVersion, opts)
...
[**CustomImageList**](CustomImageList.md)
...
> CustomImage customImagesUpdate(subscriptionId, resourceGroupName, labName, name, apiVersion, customImage)
...
let name = "name_example"; // String | The name of the custom image.
let apiVersion = "'2018-09-15'"; // String | Client API version.
let customImage = new DevTestLabsClient.CustomImageFragment(); // CustomImageFragment | A custom image.
apiInstance.customImagesUpdate(subscriptionId, resourceGroupName, labName, name, apiVersion, customImage, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **name** | **String**| The name of the custom image. | 
 **apiVersion** | **String**| Client API version. | [default to &#39;2018-09-15&#39;]
 **customImage** | [**CustomImageFragment**](CustomImageFragment.md)| A custom image. | 
