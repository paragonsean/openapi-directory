...
void OAIShutdownNotificationContent::initializeModel() {
    ...
    m_minutes_until_shutdown_isSet = false;
    m_minutes_until_shutdown_isValid = false;
    ...
    m_vm_url_isSet = false;
    m_vm_url_isValid = false;
}
...
void OAIShutdownNotificationContent::fromJsonObject(QJsonObject json) {
    ...
    m_minutes_until_shutdown_isValid = ::OpenAPI::fromJsonValue(m_minutes_until_shutdown, json[QString("minutesUntilShutdown")]);
    m_minutes_until_shutdown_isSet = !json[QString("minutesUntilShutdown")].isNull() && m_minutes_until_shutdown_isValid;
    ...
    m_vm_url_isValid = ::OpenAPI::fromJsonValue(m_vm_url, json[QString("vmUrl")]);
    m_vm_url_isSet = !json[QString("vmUrl")].isNull() && m_vm_url_isValid;
}
...
QJsonObject OAIShutdownNotificationContent::asJsonObject() const {
    ...
    if (m_minutes_until_shutdown_isSet) {
        obj.insert(QString("minutesUntilShutdown"), ::OpenAPI::toJsonValue(m_minutes_until_shutdown));
    }
    if (m_owner_isSet) {
    ...
    if (m_vm_url_isSet) {
        obj.insert(QString("vmUrl"), ::OpenAPI::toJsonValue(m_vm_url));
    }
    return obj;
}
...
QString OAIShutdownNotificationContent::getMinutesUntilShutdown() const {
    return m_minutes_until_shutdown;
}
void OAIShutdownNotificationContent::setMinutesUntilShutdown(const QString &minutes_until_shutdown) {
    m_minutes_until_shutdown = minutes_until_shutdown;
    m_minutes_until_shutdown_isSet = true;
}

bool OAIShutdownNotificationContent::is_minutes_until_shutdown_Set() const{
    return m_minutes_until_shutdown_isSet;
}

bool OAIShutdownNotificationContent::is_minutes_until_shutdown_Valid() const{
    return m_minutes_until_shutdown_isValid;
}
...
QString OAIShutdownNotificationContent::getVmUrl() const {
    return m_vm_url;
}
void OAIShutdownNotificationContent::setVmUrl(const QString &vm_url) {
    m_vm_url = vm_url;
    m_vm_url_isSet = true;
}

bool OAIShutdownNotificationContent::is_vm_url_Set() const{
    return m_vm_url_isSet;
}

bool OAIShutdownNotificationContent::is_vm_url_Valid() const{
    return m_vm_url_isValid;
}
