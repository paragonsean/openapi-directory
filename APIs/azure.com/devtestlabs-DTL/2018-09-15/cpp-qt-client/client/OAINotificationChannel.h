...
namespace OpenAPI {
class OAINotificationChannelProperties;
...
public:
    ...
    OAINotificationChannelProperties getProperties() const;
    void setProperties(const OAINotificationChannelProperties &properties);
...
private:
    ...
    OAINotificationChannelProperties m_properties;
