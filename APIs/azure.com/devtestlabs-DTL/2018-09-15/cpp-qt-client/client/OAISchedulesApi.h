...
Q_SIGNALS:
    ...
    void schedulesListSignal(OAIScheduleList summary);
    void schedulesListApplicableSignal(OAIScheduleList summary);
    ...
    void schedulesListSignalFull(OAIHttpRequestWorker *worker, OAIScheduleList summary);
    void schedulesListApplicableSignalFull(OAIHttpRequestWorker *worker, OAIScheduleList summary);
    ...
    void schedulesListSignalE(OAIScheduleList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void schedulesListSignalError(OAIScheduleList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use schedulesListApplicableSignalError() instead")
    void schedulesListApplicableSignalE(OAIScheduleList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void schedulesListApplicableSignalError(OAIScheduleList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
