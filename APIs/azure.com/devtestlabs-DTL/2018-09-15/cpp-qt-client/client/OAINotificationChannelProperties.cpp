...
QString OAINotificationChannelProperties::getEmailRecipient() const {
    return m_email_recipient;
}
void OAINotificationChannelProperties::setEmailRecipient(const QString &email_recipient) {
    m_email_recipient = email_recipient;
    m_email_recipient_isSet = true;
}

bool OAINotificationChannelProperties::is_email_recipient_Set() const{
    return m_email_recipient_isSet;
}

bool OAINotificationChannelProperties::is_email_recipient_Valid() const{
...
QString OAINotificationChannelProperties::getNotificationLocale() const {
    return m_notification_locale;
}
void OAINotificationChannelProperties::setNotificationLocale(const QString &notification_locale) {
    m_notification_locale = notification_locale;
    m_notification_locale_isSet = true;
}

bool OAINotificationChannelProperties::is_notification_locale_Set() const{
    return m_notification_locale_isSet;
}

bool OAINotificationChannelProperties::is_notification_locale_Valid() const{
