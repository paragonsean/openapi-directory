...
QString OAIUserIdentity::getAppId() const {
    return m_app_id;
}
void OAIUserIdentity::setAppId(const QString &app_id) {
    m_app_id = app_id;
    m_app_id_isSet = true;
}

bool OAIUserIdentity::is_app_id_Set() const{
    return m_app_id_isSet;
}

bool OAIUserIdentity::is_app_id_Valid() const{
    return m_app_id_isValid;
}

QString OAIUserIdentity::getObjectId() const {
    return m_object_id;
}
void OAIUserIdentity::setObjectId(const QString &object_id) {
    m_object_id = object_id;
    m_object_id_isSet = true;
}

bool OAIUserIdentity::is_object_id_Set() const{
    return m_object_id_isSet;
}

bool OAIUserIdentity::is_object_id_Valid() const{
...
QString OAIUserIdentity::getPrincipalName() const {
    return m_principal_name;
}
void OAIUserIdentity::setPrincipalName(const QString &principal_name) {
    m_principal_name = principal_name;
    m_principal_name_isSet = true;
}

bool OAIUserIdentity::is_principal_name_Set() const{
    return m_principal_name_isSet;
}

bool OAIUserIdentity::is_principal_name_Valid() const{
    return m_principal_name_isValid;
}

QString OAIUserIdentity::getTenantId() const {
    return m_tenant_id;
}
void OAIUserIdentity::setTenantId(const QString &tenant_id) {
    m_tenant_id = tenant_id;
    m_tenant_id_isSet = true;
}

bool OAIUserIdentity::is_tenant_id_Set() const{
    return m_tenant_id_isSet;
}

bool OAIUserIdentity::is_tenant_id_Valid() const{
