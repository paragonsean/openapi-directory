...
#include "OAISecret.h"
#include "OAISecretFragment.h"
#include "OAISecretList.h"
#include <QString>
...
public:
    ...
    * @param[in]  name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  secret OAISecretFragment [required]
    */
    virtual void secretsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &user_name, const QString &name, const QString &api_version, const OAISecretFragment &secret);
...
Q_SIGNALS:
    ...
    void secretsListSignal(OAISecretList summary);
    ...
    void secretsListSignalFull(OAIHttpRequestWorker *worker, OAISecretList summary);
    ...
    void secretsListSignalE(OAISecretList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void secretsListSignalError(OAISecretList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
