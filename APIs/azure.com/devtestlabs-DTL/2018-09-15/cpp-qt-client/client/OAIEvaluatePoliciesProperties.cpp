...
void OAIEvaluatePoliciesProperties::initializeModel() {
    ...
    m_user_object_id_isSet = false;
    m_user_object_id_isValid = false;
...
void OAIEvaluatePoliciesProperties::fromJsonObject(QJsonObject json) {
    ...
    m_user_object_id_isValid = ::OpenAPI::fromJsonValue(m_user_object_id, json[QString("userObjectId")]);
    m_user_object_id_isSet = !json[QString("userObjectId")].isNull() && m_user_object_id_isValid;
...
QJsonObject OAIEvaluatePoliciesProperties::asJsonObject() const {
    ...
    if (m_user_object_id_isSet) {
        obj.insert(QString("userObjectId"), ::OpenAPI::toJsonValue(m_user_object_id));
    }
...
QString OAIEvaluatePoliciesProperties::getUserObjectId() const {
    return m_user_object_id;
}
void OAIEvaluatePoliciesProperties::setUserObjectId(const QString &user_object_id) {
    m_user_object_id = user_object_id;
    m_user_object_id_isSet = true;
}

bool OAIEvaluatePoliciesProperties::is_user_object_id_Set() const{
    return m_user_object_id_isSet;
}

bool OAIEvaluatePoliciesProperties::is_user_object_id_Valid() const{
    return m_user_object_id_isValid;
}
