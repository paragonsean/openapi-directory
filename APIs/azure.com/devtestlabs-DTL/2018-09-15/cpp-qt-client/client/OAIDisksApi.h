...
public:
    ...
    * @param[in]  attach_disk_properties OAIAttachDiskProperties [required]
    */
    virtual void disksAttach(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &user_name, const QString &name, const QString &api_version, const OAIAttachDiskProperties &attach_disk_properties);
    ...
    */
    virtual void disksCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &user_name, const QString &name, const QString &api_version, const OAIDisk &disk);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void disksDelete(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &user_name, const QString &name, const QString &api_version);
    ...
    * @param[in]  name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  detach_disk_properties OAIDetachDiskProperties [required]
    */
    virtual void disksDetach(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &user_name, const QString &name, const QString &api_version, const OAIDetachDiskProperties &detach_disk_properties);
    ...
    */
    virtual void disksGet(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &user_name, const QString &name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  disk OAIDiskFragment [required]
    */
    virtual void disksUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &user_name, const QString &name, const QString &api_version, const OAIDiskFragment &disk);
...
Q_SIGNALS:
    ...
    void disksDetachSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use disksAttachSignalError() instead")
    void disksAttachSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void disksAttachSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use disksDetachSignalError() instead")
    void disksDetachSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void disksDetachSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use disksAttachSignalErrorFull() instead")
    void disksAttachSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void disksAttachSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use disksDetachSignalErrorFull() instead")
    void disksDetachSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void disksDetachSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
