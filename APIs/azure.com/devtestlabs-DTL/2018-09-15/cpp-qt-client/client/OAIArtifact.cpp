...
OAIArtifactProperties OAIArtifact::getProperties() const {
    return m_properties;
}
void OAIArtifact::setProperties(const OAIArtifactProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIArtifact::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIArtifact::is_properties_Valid() const{
...
QString OAIArtifact::getLocation() const {
    return m_location;
}
void OAIArtifact::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIArtifact::is_location_Set() const{
    return m_location_isSet;
}

bool OAIArtifact::is_location_Valid() const{
...
QMap<QString, QString> OAIArtifact::getTags() const {
    return m_tags;
}
void OAIArtifact::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIArtifact::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIArtifact::is_tags_Valid() const{
