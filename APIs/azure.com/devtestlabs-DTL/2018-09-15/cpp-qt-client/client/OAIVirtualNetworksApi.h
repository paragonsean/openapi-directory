...
#include "OAIVirtualNetworkList.h"
#include <QString>
...
Q_SIGNALS:
    ...
    void virtualNetworksListSignal(OAIVirtualNetworkList summary);
    ...
    void virtualNetworksListSignalFull(OAIHttpRequestWorker *worker, OAIVirtualNetworkList summary);
    ...
    void virtualNetworksListSignalE(OAIVirtualNetworkList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualNetworksListSignalError(OAIVirtualNetworkList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
