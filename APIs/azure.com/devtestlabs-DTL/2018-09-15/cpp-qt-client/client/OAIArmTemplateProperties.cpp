...
bool OAIArmTemplateProperties::isEnabled() const {
    return m_enabled;
}
void OAIArmTemplateProperties::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIArmTemplateProperties::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIArmTemplateProperties::is_enabled_Valid() const{
