...
void OAIUsersApi::usersCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &name, const QString &api_version, const OAIUser &user) {
    QString fullPath = QString(_serverConfigs["usersCreateOrUpdate"][_serverIndices.value("usersCreateOrUpdate")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{name}");
...
void OAIUsersApi::usersDelete(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["usersDelete"][_serverIndices.value("usersDelete")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{name}");
...
void OAIUsersApi::usersGet(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &expand) {
    QString fullPath = QString(_serverConfigs["usersGet"][_serverIndices.value("usersGet")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{name}");
...
void OAIUsersApi::usersList(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &expand, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &top, const ::OpenAPI::OptionalParam<QString> &orderby) {
    QString fullPath = QString(_serverConfigs["usersList"][_serverIndices.value("usersList")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users");
...
void OAIUsersApi::usersUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &lab_name, const QString &name, const QString &api_version, const OAIUserFragment &user) {
    QString fullPath = QString(_serverConfigs["usersUpdate"][_serverIndices.value("usersUpdate")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{name}");
