...
OAIDataDiskPropertiesFragment::OAIDataDiskPropertiesFragment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataDiskPropertiesFragment::OAIDataDiskPropertiesFragment() {
    this->initializeModel();
}

OAIDataDiskPropertiesFragment::~OAIDataDiskPropertiesFragment() {}

void OAIDataDiskPropertiesFragment::initializeModel() {
...
void OAIDataDiskPropertiesFragment::fromJson(QString jsonString) {
...
void OAIDataDiskPropertiesFragment::fromJsonObject(QJsonObject json) {
...
QString OAIDataDiskPropertiesFragment::asJson() const {
...
QJsonObject OAIDataDiskPropertiesFragment::asJsonObject() const {
    QJsonObject obj;
...
OAIAttachNewDataDiskOptionsFragment OAIDataDiskPropertiesFragment::getAttachNewDataDiskOptions() const {
    return m_attach_new_data_disk_options;
}
void OAIDataDiskPropertiesFragment::setAttachNewDataDiskOptions(const OAIAttachNewDataDiskOptionsFragment &attach_new_data_disk_options) {
    m_attach_new_data_disk_options = attach_new_data_disk_options;
    m_attach_new_data_disk_options_isSet = true;
}

bool OAIDataDiskPropertiesFragment::is_attach_new_data_disk_options_Set() const{
    return m_attach_new_data_disk_options_isSet;
}

bool OAIDataDiskPropertiesFragment::is_attach_new_data_disk_options_Valid() const{
    return m_attach_new_data_disk_options_isValid;
}

QString OAIDataDiskPropertiesFragment::getExistingLabDiskId() const {
    return m_existing_lab_disk_id;
}
void OAIDataDiskPropertiesFragment::setExistingLabDiskId(const QString &existing_lab_disk_id) {
    m_existing_lab_disk_id = existing_lab_disk_id;
    m_existing_lab_disk_id_isSet = true;
}

bool OAIDataDiskPropertiesFragment::is_existing_lab_disk_id_Set() const{
    return m_existing_lab_disk_id_isSet;
}

bool OAIDataDiskPropertiesFragment::is_existing_lab_disk_id_Valid() const{
    return m_existing_lab_disk_id_isValid;
}

QString OAIDataDiskPropertiesFragment::getHostCaching() const {
    return m_host_caching;
}
void OAIDataDiskPropertiesFragment::setHostCaching(const QString &host_caching) {
    m_host_caching = host_caching;
    m_host_caching_isSet = true;
}

bool OAIDataDiskPropertiesFragment::is_host_caching_Set() const{
    return m_host_caching_isSet;
}

bool OAIDataDiskPropertiesFragment::is_host_caching_Valid() const{
    return m_host_caching_isValid;
}

bool OAIDataDiskPropertiesFragment::isSet() const {
...
bool OAIDataDiskPropertiesFragment::isValid() const {
