...
> ResponseWithContinuationSchedule globalSchedulesListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, opts)
...
> ResponseWithContinuationSchedule globalSchedulesListBySubscription(subscriptionId, apiVersion, opts)
