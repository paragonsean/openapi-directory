...
let name = "name_example"; // String | The name of the notificationChannel.
 ...
 **name** | **String**| The name of the notificationChannel. | 
...
> ResponseWithContinuationNotificationChannel notificationChannelsList(subscriptionId, resourceGroupName, labName, apiVersion, opts)
