...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.LabVirtualMachinePropertiesFragment();
  });
  ...
  describe('LabVirtualMachinePropertiesFragment', function() {
    it('should create an instance of LabVirtualMachinePropertiesFragment', function() {
      // uncomment below and update the code to test LabVirtualMachinePropertiesFragment
      //var instance = new DevTestLabsClient.LabVirtualMachinePropertiesFragment();
      //expect(instance).to.be.a(DevTestLabsClient.LabVirtualMachinePropertiesFragment);
    });
