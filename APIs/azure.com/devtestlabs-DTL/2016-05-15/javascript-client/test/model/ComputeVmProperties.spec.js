...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.ComputeVmProperties();
  });
  ...
  describe('ComputeVmProperties', function() {
    it('should create an instance of ComputeVmProperties', function() {
      // uncomment below and update the code to test ComputeVmProperties
      //var instance = new DevTestLabsClient.ComputeVmProperties();
      //expect(instance).to.be.a(DevTestLabsClient.ComputeVmProperties);
    });
