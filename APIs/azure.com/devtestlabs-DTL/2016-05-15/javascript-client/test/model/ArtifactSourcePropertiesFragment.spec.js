...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.ArtifactSourcePropertiesFragment();
  });
  ...
  describe('ArtifactSourcePropertiesFragment', function() {
    it('should create an instance of ArtifactSourcePropertiesFragment', function() {
      // uncomment below and update the code to test ArtifactSourcePropertiesFragment
      //var instance = new DevTestLabsClient.ArtifactSourcePropertiesFragment();
      //expect(instance).to.be.a(DevTestLabsClient.ArtifactSourcePropertiesFragment);
    });
