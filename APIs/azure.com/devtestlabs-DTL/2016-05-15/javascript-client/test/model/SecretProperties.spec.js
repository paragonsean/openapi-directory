...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.SecretProperties();
  });
  ...
  describe('SecretProperties', function() {
    it('should create an instance of SecretProperties', function() {
      ...
      //var instance = new DevTestLabsClient.SecretProperties();
      //expect(instance).to.be.a(DevTestLabsClient.SecretProperties);
    });
