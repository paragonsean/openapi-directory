...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.UserPropertiesFragment();
  });
  ...
  describe('UserPropertiesFragment', function() {
    it('should create an instance of UserPropertiesFragment', function() {
      ...
      //var instance = new DevTestLabsClient.UserPropertiesFragment();
      //expect(instance).to.be.a(DevTestLabsClient.UserPropertiesFragment);
    });
