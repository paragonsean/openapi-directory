...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.NotificationSettings();
  });
  ...
  describe('NotificationSettings', function() {
    it('should create an instance of NotificationSettings', function() {
      ...
      //var instance = new DevTestLabsClient.NotificationSettings();
      //expect(instance).to.be.a(DevTestLabsClient.NotificationSettings);
    });
