...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.InboundNatRuleFragment();
  });
  ...
  describe('InboundNatRuleFragment', function() {
    it('should create an instance of InboundNatRuleFragment', function() {
      // uncomment below and update the code to test InboundNatRuleFragment
      //var instance = new DevTestLabsClient.InboundNatRuleFragment();
      //expect(instance).to.be.a(DevTestLabsClient.InboundNatRuleFragment);
    });
