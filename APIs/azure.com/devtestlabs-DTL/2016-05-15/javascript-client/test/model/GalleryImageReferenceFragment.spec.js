...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.GalleryImageReferenceFragment();
  });
  ...
  describe('GalleryImageReferenceFragment', function() {
    it('should create an instance of GalleryImageReferenceFragment', function() {
      ...
      //var instance = new DevTestLabsClient.GalleryImageReferenceFragment();
      //expect(instance).to.be.a(DevTestLabsClient.GalleryImageReferenceFragment);
    });
