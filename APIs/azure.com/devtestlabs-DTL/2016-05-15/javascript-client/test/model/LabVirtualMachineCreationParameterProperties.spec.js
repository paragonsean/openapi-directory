...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.LabVirtualMachineCreationParameterProperties();
  });
  ...
  describe('LabVirtualMachineCreationParameterProperties', function() {
    it('should create an instance of LabVirtualMachineCreationParameterProperties', function() {
      // uncomment below and update the code to test LabVirtualMachineCreationParameterProperties
      //var instance = new DevTestLabsClient.LabVirtualMachineCreationParameterProperties();
      //expect(instance).to.be.a(DevTestLabsClient.LabVirtualMachineCreationParameterProperties);
    });
