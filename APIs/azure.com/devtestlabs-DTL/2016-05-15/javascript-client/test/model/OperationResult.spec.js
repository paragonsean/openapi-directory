...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DevTestLabsClient.OperationResult();
  });
  ...
  describe('OperationResult', function() {
    it('should create an instance of OperationResult', function() {
      ...
      //var instance = new DevTestLabsClient.OperationResult();
      //expect(instance).to.be.a(DevTestLabsClient.OperationResult);
    });
