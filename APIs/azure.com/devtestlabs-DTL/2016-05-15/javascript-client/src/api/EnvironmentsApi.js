...
export default class EnvironmentsApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ResponseWithContinuationDtlEnvironment} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ResponseWithContinuationDtlEnvironment}
     */
    environmentsList(subscriptionId, resourceGroupName, labName, userName, apiVersion, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ResponseWithContinuationDtlEnvironment;
      return this.apiClient.callApi(
