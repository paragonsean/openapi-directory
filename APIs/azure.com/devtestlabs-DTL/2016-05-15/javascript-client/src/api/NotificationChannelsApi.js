...
export default class NotificationChannelsApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ResponseWithContinuationNotificationChannel} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ResponseWithContinuationNotificationChannel}
     */
    notificationChannelsList(subscriptionId, resourceGroupName, labName, apiVersion, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ResponseWithContinuationNotificationChannel;
      return this.apiClient.callApi(
