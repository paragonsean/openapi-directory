...
class Formula {
     ...
     * @param {module:model/Formula} obj Optional instance to populate.
     * @return {module:model/Formula} The populated <code>Formula</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = FormulaProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          FormulaProperties.validateJSON(data['properties']);
        }
...
Formula.RequiredProperties = ["properties"];

/**
 * @member {module:model/FormulaProperties} properties
 */
Formula.prototype['properties'] = undefined;

/**
 * The identifier of the resource.
 * @member {String} id
 */
Formula.prototype['id'] = undefined;

/**
 * The location of the resource.
 * @member {String} location
 */
Formula.prototype['location'] = undefined;

/**
 * The name of the resource.
 * @member {String} name
 */
Formula.prototype['name'] = undefined;

/**
 * The tags of the resource.
 * @member {Object.<String, String>} tags
 */
Formula.prototype['tags'] = undefined;

/**
 * The type of the resource.
 * @member {String} type
 */
Formula.prototype['type'] = undefined;
