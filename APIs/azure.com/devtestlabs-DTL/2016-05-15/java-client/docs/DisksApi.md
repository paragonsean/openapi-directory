...
<a id="disksList"></a>
# **disksList**
> ResponseWithContinuationDisk disksList(subscriptionId, resourceGroupName, labName, userName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResponseWithContinuationDisk result = apiInstance.disksList(subscriptionId, resourceGroupName, labName, userName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
