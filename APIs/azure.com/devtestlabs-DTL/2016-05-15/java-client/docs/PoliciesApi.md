...
<a id="policiesList"></a>
# **policiesList**
> ResponseWithContinuationPolicy policiesList(subscriptionId, resourceGroupName, labName, policySetName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResponseWithContinuationPolicy result = apiInstance.policiesList(subscriptionId, resourceGroupName, labName, policySetName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
