...
# **virtualNetworksList**
> ResponseWithContinuationVirtualNetwork virtualNetworksList(subscriptionId, resourceGroupName, labName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResponseWithContinuationVirtualNetwork result = apiInstance.virtualNetworksList(subscriptionId, resourceGroupName, labName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
