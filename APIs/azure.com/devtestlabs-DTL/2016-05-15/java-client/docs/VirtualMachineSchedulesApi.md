...
> ResponseWithContinuationSchedule virtualMachineSchedulesList(subscriptionId, resourceGroupName, labName, virtualMachineName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResponseWithContinuationSchedule result = apiInstance.virtualMachineSchedulesList(subscriptionId, resourceGroupName, labName, virtualMachineName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
