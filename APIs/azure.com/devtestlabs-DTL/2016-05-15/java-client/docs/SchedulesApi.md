...
# **schedulesList**
> ResponseWithContinuationSchedule schedulesList(subscriptionId, resourceGroupName, labName, apiVersion, $expand, $filter, $top, $orderby)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResponseWithContinuationSchedule result = apiInstance.schedulesList(subscriptionId, resourceGroupName, labName, apiVersion, $expand, $filter, $top, $orderby);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "2016-05-15"; // String | Client API version.
    try {
      ResponseWithContinuationSchedule result = apiInstance.schedulesListApplicable(subscriptionId, resourceGroupName, labName, name, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
