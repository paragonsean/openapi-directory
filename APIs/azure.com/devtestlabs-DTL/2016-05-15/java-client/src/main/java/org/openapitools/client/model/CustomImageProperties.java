...
public class CustomImageProperties {
  ...
  public CustomImageProperties uniqueIdentifier(String uniqueIdentifier) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(author, creationDate, description, managedImageId, provisioningState, uniqueIdentifier, vhd, vm);
  }
