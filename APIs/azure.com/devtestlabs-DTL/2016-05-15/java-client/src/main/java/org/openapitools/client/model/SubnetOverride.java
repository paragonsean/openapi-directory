...
public class SubnetOverride {
  ...
  public SubnetOverride labSubnetName(String labSubnetName) {
  ...
  public SubnetOverride resourceId(String resourceId) {
  ...
  public SubnetOverride sharedPublicIpAddressConfiguration(SubnetSharedPublicIpAddressConfiguration sharedPublicIpAddressConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public SubnetSharedPublicIpAddressConfiguration getSharedPublicIpAddressConfiguration() {
    return sharedPublicIpAddressConfiguration;
  }

  public void setSharedPublicIpAddressConfiguration(SubnetSharedPublicIpAddressConfiguration sharedPublicIpAddressConfiguration) {
    this.sharedPublicIpAddressConfiguration = sharedPublicIpAddressConfiguration;
  }


  public SubnetOverride useInVmCreationPermission(UseInVmCreationPermissionEnum useInVmCreationPermission) {
  ...
  public SubnetOverride usePublicIpAddressPermission(UsePublicIpAddressPermissionEnum usePublicIpAddressPermission) {
  ...
  public SubnetOverride virtualNetworkPoolName(String virtualNetworkPoolName) {
  ...
  public boolean equals(Object o) {
    ...
    SubnetOverride subnetOverride = (SubnetOverride) o;
    return Objects.equals(this.labSubnetName, subnetOverride.labSubnetName) &&
        Objects.equals(this.resourceId, subnetOverride.resourceId) &&
        Objects.equals(this.sharedPublicIpAddressConfiguration, subnetOverride.sharedPublicIpAddressConfiguration) &&
        Objects.equals(this.useInVmCreationPermission, subnetOverride.useInVmCreationPermission) &&
        Objects.equals(this.usePublicIpAddressPermission, subnetOverride.usePublicIpAddressPermission) &&
        Objects.equals(this.virtualNetworkPoolName, subnetOverride.virtualNetworkPoolName);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubnetOverride {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubnetOverride
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubnetOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubnetOverride is not found in the empty JSON string", SubnetOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubnetOverride.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubnetOverride` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("sharedPublicIpAddressConfiguration") != null && !jsonObj.get("sharedPublicIpAddressConfiguration").isJsonNull()) {
        SubnetSharedPublicIpAddressConfiguration.validateJsonElement(jsonObj.get("sharedPublicIpAddressConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubnetOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubnetOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubnetOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubnetOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<SubnetOverride>() {
           @Override
           public void write(JsonWriter out, SubnetOverride value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubnetOverride read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubnetOverride given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubnetOverride
   * @throws IOException if the JSON string is invalid with respect to SubnetOverride
   */
  public static SubnetOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubnetOverride.class);
  }

  /**
   * Convert an instance of SubnetOverride to an JSON string
   *
   * @return JSON string
   */
