...
import org.openapitools.client.model.ResponseWithContinuationDisk;
...
public class DisksApi {
     ...
     */
    public ResponseWithContinuationDisk disksList(String subscriptionId, String resourceGroupName, String labName, String userName, String apiVersion, String $expand, String $filter, Integer $top, String $orderby) throws ApiException {
        ApiResponse<ResponseWithContinuationDisk> localVarResp = disksListWithHttpInfo(subscriptionId, resourceGroupName, labName, userName, apiVersion, $expand, $filter, $top, $orderby);
        return localVarResp.getData();
    }
     ...
     * @param $top The maximum number of resources to return from the operation. (optional)
     * @param $orderby The ordering expression for the results, using OData notation. (optional)
     * @return ApiResponse&lt;ResponseWithContinuationDisk&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ResponseWithContinuationDisk> disksListWithHttpInfo(String subscriptionId, String resourceGroupName, String labName, String userName, String apiVersion, String $expand, String $filter, Integer $top, String $orderby) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ResponseWithContinuationDisk>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call disksListAsync(String subscriptionId, String resourceGroupName, String labName, String userName, String apiVersion, String $expand, String $filter, Integer $top, String $orderby, final ApiCallback<ResponseWithContinuationDisk> _callback) throws ApiException {
