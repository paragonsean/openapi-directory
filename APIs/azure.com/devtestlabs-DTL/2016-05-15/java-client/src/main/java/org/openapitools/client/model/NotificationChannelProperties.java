...
public class NotificationChannelProperties {
  ...
  public NotificationChannelProperties provisioningState(String provisioningState) {
  ...
  public NotificationChannelProperties uniqueIdentifier(String uniqueIdentifier) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdDate, description, events, provisioningState, uniqueIdentifier, webHookUrl);
  }
