...
public class NotificationChannelsApiTest {
    ...
    public void notificationChannelsListTest() throws ApiException {
        ...
        Integer $top = null;
        String $orderby = null;
        ResponseWithContinuationNotificationChannel response = api.notificationChannelsList(subscriptionId, resourceGroupName, labName, apiVersion, $expand, $filter, $top, $orderby);
        // TODO: test validations
    }
