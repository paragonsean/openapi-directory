...
async def test_custom_images_create_or_update(client):
    ...
    """
    custom_image = {"properties":{"vhd":{"imageName":"imageName","osType":"Windows","sysPrep":True},"author":"author","managedImageId":"managedImageId","vm":{"windowsOsInfo":{"windowsOsState":"NonSysprepped"},"linuxOsInfo":{"linuxOsState":"NonDeprovisioned"},"sourceVmId":"sourceVmId"},"description":"description","provisioningState":"provisioningState","creationDate":"2000-01-23T04:56:07.000+00:00","uniqueIdentifier":"uniqueIdentifier"}}
