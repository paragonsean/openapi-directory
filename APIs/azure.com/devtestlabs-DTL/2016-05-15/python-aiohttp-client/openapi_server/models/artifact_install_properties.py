...
class ArtifactInstallProperties(Model):
    ...
    def __init__(self, artifact_id: str=None, deployment_status_message: str=None, install_time: datetime=None, parameters: List[ArtifactParameterProperties]=None, status: str=None, vm_extension_status_message: str=None):
