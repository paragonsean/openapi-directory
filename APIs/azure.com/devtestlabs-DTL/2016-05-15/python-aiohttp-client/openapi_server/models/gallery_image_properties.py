...
class GalleryImageProperties(Model):
    ...
    def __init__(self, author: str=None, created_date: datetime=None, description: str=None, enabled: bool=None, icon: str=None, image_reference: GalleryImageReference=None):
