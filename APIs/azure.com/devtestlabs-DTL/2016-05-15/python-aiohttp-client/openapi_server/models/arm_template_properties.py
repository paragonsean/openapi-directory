...
class ArmTemplateProperties(Model):
    ...
    def __init__(self, contents: object=None, created_date: datetime=None, description: str=None, display_name: str=None, icon: str=None, parameters_value_files_info: List[ParametersValueFileInfo]=None, publisher: str=None):
