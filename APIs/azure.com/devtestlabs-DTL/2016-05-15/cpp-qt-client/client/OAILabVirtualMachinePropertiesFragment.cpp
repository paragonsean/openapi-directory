...
OAIApplicableScheduleFragment OAILabVirtualMachinePropertiesFragment::getApplicableSchedule() const {
    return m_applicable_schedule;
}
void OAILabVirtualMachinePropertiesFragment::setApplicableSchedule(const OAIApplicableScheduleFragment &applicable_schedule) {
    m_applicable_schedule = applicable_schedule;
    m_applicable_schedule_isSet = true;
}

bool OAILabVirtualMachinePropertiesFragment::is_applicable_schedule_Set() const{
    return m_applicable_schedule_isSet;
}

bool OAILabVirtualMachinePropertiesFragment::is_applicable_schedule_Valid() const{
...
OAIComputeVmPropertiesFragment OAILabVirtualMachinePropertiesFragment::getComputeVm() const {
    return m_compute_vm;
}
void OAILabVirtualMachinePropertiesFragment::setComputeVm(const OAIComputeVmPropertiesFragment &compute_vm) {
    m_compute_vm = compute_vm;
    m_compute_vm_isSet = true;
}

bool OAILabVirtualMachinePropertiesFragment::is_compute_vm_Set() const{
    return m_compute_vm_isSet;
}

bool OAILabVirtualMachinePropertiesFragment::is_compute_vm_Valid() const{
...
QString OAILabVirtualMachinePropertiesFragment::getProvisioningState() const {
    return m_provisioning_state;
}
void OAILabVirtualMachinePropertiesFragment::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAILabVirtualMachinePropertiesFragment::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAILabVirtualMachinePropertiesFragment::is_provisioning_state_Valid() const{
...
QString OAILabVirtualMachinePropertiesFragment::getUniqueIdentifier() const {
    return m_unique_identifier;
}
void OAILabVirtualMachinePropertiesFragment::setUniqueIdentifier(const QString &unique_identifier) {
    m_unique_identifier = unique_identifier;
    m_unique_identifier_isSet = true;
}

bool OAILabVirtualMachinePropertiesFragment::is_unique_identifier_Set() const{
    return m_unique_identifier_isSet;
}

bool OAILabVirtualMachinePropertiesFragment::is_unique_identifier_Valid() const{
