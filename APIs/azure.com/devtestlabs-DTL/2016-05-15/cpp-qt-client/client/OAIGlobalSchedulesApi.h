...
Q_SIGNALS:
    ...
    void globalSchedulesListByResourceGroupSignal(OAIResponseWithContinuation_Schedule summary);
    void globalSchedulesListBySubscriptionSignal(OAIResponseWithContinuation_Schedule summary);
    ...
    void globalSchedulesListByResourceGroupSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_Schedule summary);
    void globalSchedulesListBySubscriptionSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_Schedule summary);
    ...
    void globalSchedulesListByResourceGroupSignalE(OAIResponseWithContinuation_Schedule summary, QNetworkReply::NetworkError error_type, QString error_str);
    void globalSchedulesListByResourceGroupSignalError(OAIResponseWithContinuation_Schedule summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use globalSchedulesListBySubscriptionSignalError() instead")
    void globalSchedulesListBySubscriptionSignalE(OAIResponseWithContinuation_Schedule summary, QNetworkReply::NetworkError error_type, QString error_str);
    void globalSchedulesListBySubscriptionSignalError(OAIResponseWithContinuation_Schedule summary, QNetworkReply::NetworkError error_type, const QString &error_str);
