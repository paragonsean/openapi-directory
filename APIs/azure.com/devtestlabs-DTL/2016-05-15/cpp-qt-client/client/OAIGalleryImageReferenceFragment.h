...
/*
 * OAIGalleryImageReferenceFragment.h
 *
 * The reference information for an Azure Marketplace image.
 */

#ifndef OAIGalleryImageReferenceFragment_H
#define OAIGalleryImageReferenceFragment_H
...
class OAIGalleryImageReferenceFragment : public OAIObject {
public:
    OAIGalleryImageReferenceFragment();
    OAIGalleryImageReferenceFragment(QString json);
    ~OAIGalleryImageReferenceFragment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGalleryImageReferenceFragment)

#endif // OAIGalleryImageReferenceFragment_H
