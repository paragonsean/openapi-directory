...
Q_SIGNALS:
    ...
    void artifactSourcesListSignal(OAIResponseWithContinuation_ArtifactSource summary);
    ...
    void artifactSourcesListSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_ArtifactSource summary);
    ...
    void artifactSourcesListSignalE(OAIResponseWithContinuation_ArtifactSource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void artifactSourcesListSignalError(OAIResponseWithContinuation_ArtifactSource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
