...
OAISchedulePropertiesFragment::OAISchedulePropertiesFragment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISchedulePropertiesFragment::OAISchedulePropertiesFragment() {
    this->initializeModel();
}

OAISchedulePropertiesFragment::~OAISchedulePropertiesFragment() {}

void OAISchedulePropertiesFragment::initializeModel() {
...
void OAISchedulePropertiesFragment::fromJson(QString jsonString) {
...
void OAISchedulePropertiesFragment::fromJsonObject(QJsonObject json) {
...
QString OAISchedulePropertiesFragment::asJson() const {
...
QJsonObject OAISchedulePropertiesFragment::asJsonObject() const {
    QJsonObject obj;
...
OAIDayDetailsFragment OAISchedulePropertiesFragment::getDailyRecurrence() const {
    return m_daily_recurrence;
}
void OAISchedulePropertiesFragment::setDailyRecurrence(const OAIDayDetailsFragment &daily_recurrence) {
    m_daily_recurrence = daily_recurrence;
    m_daily_recurrence_isSet = true;
}

bool OAISchedulePropertiesFragment::is_daily_recurrence_Set() const{
    return m_daily_recurrence_isSet;
}

bool OAISchedulePropertiesFragment::is_daily_recurrence_Valid() const{
    return m_daily_recurrence_isValid;
}

OAIHourDetailsFragment OAISchedulePropertiesFragment::getHourlyRecurrence() const {
    return m_hourly_recurrence;
}
void OAISchedulePropertiesFragment::setHourlyRecurrence(const OAIHourDetailsFragment &hourly_recurrence) {
    m_hourly_recurrence = hourly_recurrence;
    m_hourly_recurrence_isSet = true;
}

bool OAISchedulePropertiesFragment::is_hourly_recurrence_Set() const{
    return m_hourly_recurrence_isSet;
}

bool OAISchedulePropertiesFragment::is_hourly_recurrence_Valid() const{
    return m_hourly_recurrence_isValid;
}

OAINotificationSettingsFragment OAISchedulePropertiesFragment::getNotificationSettings() const {
    return m_notification_settings;
}
void OAISchedulePropertiesFragment::setNotificationSettings(const OAINotificationSettingsFragment &notification_settings) {
    m_notification_settings = notification_settings;
    m_notification_settings_isSet = true;
}

bool OAISchedulePropertiesFragment::is_notification_settings_Set() const{
    return m_notification_settings_isSet;
}

bool OAISchedulePropertiesFragment::is_notification_settings_Valid() const{
    return m_notification_settings_isValid;
}

QString OAISchedulePropertiesFragment::getProvisioningState() const {
    return m_provisioning_state;
}
void OAISchedulePropertiesFragment::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAISchedulePropertiesFragment::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAISchedulePropertiesFragment::is_provisioning_state_Valid() const{
    return m_provisioning_state_isValid;
}

QString OAISchedulePropertiesFragment::getStatus() const {
    return m_status;
}
void OAISchedulePropertiesFragment::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISchedulePropertiesFragment::is_status_Set() const{
    return m_status_isSet;
}

bool OAISchedulePropertiesFragment::is_status_Valid() const{
    return m_status_isValid;
}

QString OAISchedulePropertiesFragment::getTargetResourceId() const {
    return m_target_resource_id;
}
void OAISchedulePropertiesFragment::setTargetResourceId(const QString &target_resource_id) {
    m_target_resource_id = target_resource_id;
    m_target_resource_id_isSet = true;
}

bool OAISchedulePropertiesFragment::is_target_resource_id_Set() const{
    return m_target_resource_id_isSet;
}

bool OAISchedulePropertiesFragment::is_target_resource_id_Valid() const{
    return m_target_resource_id_isValid;
}

QString OAISchedulePropertiesFragment::getTaskType() const {
    return m_task_type;
}
void OAISchedulePropertiesFragment::setTaskType(const QString &task_type) {
    m_task_type = task_type;
    m_task_type_isSet = true;
}

bool OAISchedulePropertiesFragment::is_task_type_Set() const{
    return m_task_type_isSet;
}

bool OAISchedulePropertiesFragment::is_task_type_Valid() const{
    return m_task_type_isValid;
}

QString OAISchedulePropertiesFragment::getTimeZoneId() const {
    return m_time_zone_id;
}
void OAISchedulePropertiesFragment::setTimeZoneId(const QString &time_zone_id) {
    m_time_zone_id = time_zone_id;
    m_time_zone_id_isSet = true;
}

bool OAISchedulePropertiesFragment::is_time_zone_id_Set() const{
    return m_time_zone_id_isSet;
}

bool OAISchedulePropertiesFragment::is_time_zone_id_Valid() const{
    return m_time_zone_id_isValid;
}

QString OAISchedulePropertiesFragment::getUniqueIdentifier() const {
    return m_unique_identifier;
}
void OAISchedulePropertiesFragment::setUniqueIdentifier(const QString &unique_identifier) {
    m_unique_identifier = unique_identifier;
    m_unique_identifier_isSet = true;
}

bool OAISchedulePropertiesFragment::is_unique_identifier_Set() const{
    return m_unique_identifier_isSet;
}

bool OAISchedulePropertiesFragment::is_unique_identifier_Valid() const{
    return m_unique_identifier_isValid;
}

OAIWeekDetailsFragment OAISchedulePropertiesFragment::getWeeklyRecurrence() const {
    return m_weekly_recurrence;
}
void OAISchedulePropertiesFragment::setWeeklyRecurrence(const OAIWeekDetailsFragment &weekly_recurrence) {
    m_weekly_recurrence = weekly_recurrence;
    m_weekly_recurrence_isSet = true;
}

bool OAISchedulePropertiesFragment::is_weekly_recurrence_Set() const{
    return m_weekly_recurrence_isSet;
}

bool OAISchedulePropertiesFragment::is_weekly_recurrence_Valid() const{
    return m_weekly_recurrence_isValid;
}

bool OAISchedulePropertiesFragment::isSet() const {
...
bool OAISchedulePropertiesFragment::isValid() const {
