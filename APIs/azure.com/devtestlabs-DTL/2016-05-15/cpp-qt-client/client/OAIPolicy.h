...
public:
    ...
    OAIPolicyProperties getProperties() const;
    void setProperties(const OAIPolicyProperties &properties);
...
private:
    ...
    OAIPolicyProperties m_properties;
