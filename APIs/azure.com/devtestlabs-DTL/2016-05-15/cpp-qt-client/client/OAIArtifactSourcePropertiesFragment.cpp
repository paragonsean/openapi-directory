...
QString OAIArtifactSourcePropertiesFragment::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIArtifactSourcePropertiesFragment::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAIArtifactSourcePropertiesFragment::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAIArtifactSourcePropertiesFragment::is_provisioning_state_Valid() const{
...
QString OAIArtifactSourcePropertiesFragment::getUniqueIdentifier() const {
    return m_unique_identifier;
}
void OAIArtifactSourcePropertiesFragment::setUniqueIdentifier(const QString &unique_identifier) {
    m_unique_identifier = unique_identifier;
    m_unique_identifier_isSet = true;
}

bool OAIArtifactSourcePropertiesFragment::is_unique_identifier_Set() const{
    return m_unique_identifier_isSet;
}

bool OAIArtifactSourcePropertiesFragment::is_unique_identifier_Valid() const{
