...
Q_SIGNALS:
    ...
    void environmentsListSignal(OAIResponseWithContinuation_DtlEnvironment summary);
    ...
    void environmentsListSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_DtlEnvironment summary);
    ...
    void environmentsListSignalE(OAIResponseWithContinuation_DtlEnvironment summary, QNetworkReply::NetworkError error_type, QString error_str);
    void environmentsListSignalError(OAIResponseWithContinuation_DtlEnvironment summary, QNetworkReply::NetworkError error_type, const QString &error_str);
