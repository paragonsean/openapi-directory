...
Q_SIGNALS:
    ...
    void labsListByResourceGroupSignal(OAIResponseWithContinuation_Lab summary);
    void labsListBySubscriptionSignal(OAIResponseWithContinuation_Lab summary);
    void labsListVhdsSignal(OAIResponseWithContinuation_LabVhd summary);
    ...
    void labsListByResourceGroupSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_Lab summary);
    void labsListBySubscriptionSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_Lab summary);
    void labsListVhdsSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_LabVhd summary);
    ...
    void labsListByResourceGroupSignalE(OAIResponseWithContinuation_Lab summary, QNetworkReply::NetworkError error_type, QString error_str);
    void labsListByResourceGroupSignalError(OAIResponseWithContinuation_Lab summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use labsListBySubscriptionSignalError() instead")
    void labsListBySubscriptionSignalE(OAIResponseWithContinuation_Lab summary, QNetworkReply::NetworkError error_type, QString error_str);
    void labsListBySubscriptionSignalError(OAIResponseWithContinuation_Lab summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use labsListVhdsSignalError() instead")
    void labsListVhdsSignalE(OAIResponseWithContinuation_LabVhd summary, QNetworkReply::NetworkError error_type, QString error_str);
    void labsListVhdsSignalError(OAIResponseWithContinuation_LabVhd summary, QNetworkReply::NetworkError error_type, const QString &error_str);
