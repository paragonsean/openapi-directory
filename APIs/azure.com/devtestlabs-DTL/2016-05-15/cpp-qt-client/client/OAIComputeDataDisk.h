...
/*
 * OAIComputeDataDisk.h
 *
 * A data disks attached to a virtual machine.
 */

#ifndef OAIComputeDataDisk_H
#define OAIComputeDataDisk_H
...
class OAIComputeDataDisk : public OAIObject {
public:
    OAIComputeDataDisk();
    OAIComputeDataDisk(QString json);
    ~OAIComputeDataDisk() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputeDataDisk)

#endif // OAIComputeDataDisk_H
