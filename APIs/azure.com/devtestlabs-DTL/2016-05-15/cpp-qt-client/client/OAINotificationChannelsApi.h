...
Q_SIGNALS:
    ...
    void notificationChannelsListSignal(OAIResponseWithContinuation_NotificationChannel summary);
    ...
    void notificationChannelsListSignalFull(OAIHttpRequestWorker *worker, OAIResponseWithContinuation_NotificationChannel summary);
    ...
    void notificationChannelsListSignalE(OAIResponseWithContinuation_NotificationChannel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void notificationChannelsListSignalError(OAIResponseWithContinuation_NotificationChannel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
