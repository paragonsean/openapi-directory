...
public:
    ...
    OAIArtifactProperties getProperties() const;
    void setProperties(const OAIArtifactProperties &properties);
...
private:
    ...
    OAIArtifactProperties m_properties;
