...
#ifndef OAIInboundNatRule_H
#define OAIInboundNatRule_H
...
class OAIInboundNatRule : public OAIObject {
public:
    OAIInboundNatRule();
    OAIInboundNatRule(QString json);
    ~OAIInboundNatRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInboundNatRule)

#endif // OAIInboundNatRule_H
