...
/*
 * OAINetworkInterfacePropertiesFragment.h
 *
 * Properties of a network interface.
 */

#ifndef OAINetworkInterfacePropertiesFragment_H
#define OAINetworkInterfacePropertiesFragment_H
...
namespace OpenAPI {
class OAISharedPublicIpAddressConfigurationFragment;

class OAINetworkInterfacePropertiesFragment : public OAIObject {
public:
    OAINetworkInterfacePropertiesFragment();
    OAINetworkInterfacePropertiesFragment(QString json);
    ~OAINetworkInterfacePropertiesFragment() override;
    ...
    OAISharedPublicIpAddressConfigurationFragment getSharedPublicIpAddressConfiguration() const;
    void setSharedPublicIpAddressConfiguration(const OAISharedPublicIpAddressConfigurationFragment &shared_public_ip_address_configuration);
...
private:
    ...
    OAISharedPublicIpAddressConfigurationFragment m_shared_public_ip_address_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkInterfacePropertiesFragment)

#endif // OAINetworkInterfacePropertiesFragment_H
