...
QString OAICustomImagePropertiesCustom::getOsType() const {
    return m_os_type;
}
void OAICustomImagePropertiesCustom::setOsType(const QString &os_type) {
    m_os_type = os_type;
    m_os_type_isSet = true;
}

bool OAICustomImagePropertiesCustom::is_os_type_Set() const{
    return m_os_type_isSet;
}

bool OAICustomImagePropertiesCustom::is_os_type_Valid() const{
