...
async def tag_assign_to_api(request: web.Request, resource_group_name, service_name, api_id, tag_id, api_version, subscription_id, if_match=None) -> web.Response:
    """tag_assign_to_api
...
async def tag_detach_from_api(request: web.Request, resource_group_name, service_name, api_id, tag_id, if_match, api_version, subscription_id) -> web.Response:
    """tag_detach_from_api
