...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OperationListByTags200ResponseValueInnerProperties();
  });
  ...
  describe('OperationListByTags200ResponseValueInnerProperties', function() {
    it('should create an instance of OperationListByTags200ResponseValueInnerProperties', function() {
      // uncomment below and update the code to test OperationListByTags200ResponseValueInnerProperties
      //var instance = new ApiManagementClient.OperationListByTags200ResponseValueInnerProperties();
      //expect(instance).to.be.a(ApiManagementClient.OperationListByTags200ResponseValueInnerProperties);
    });
