...
public class TagCollection {
  ...
  private List<OperationListByTags200ResponseValueInnerPropertiesTag> value = new ArrayList<>();
  ...
  public TagCollection value(List<OperationListByTags200ResponseValueInnerPropertiesTag> value) {
    this.value = value;
    return this;
  }

  public TagCollection addValueItem(OperationListByTags200ResponseValueInnerPropertiesTag valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<OperationListByTags200ResponseValueInnerPropertiesTag> getValue() {
    return value;
  }

  public void setValue(List<OperationListByTags200ResponseValueInnerPropertiesTag> value) {
    this.value = value;
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            OperationListByTags200ResponseValueInnerPropertiesTag.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
