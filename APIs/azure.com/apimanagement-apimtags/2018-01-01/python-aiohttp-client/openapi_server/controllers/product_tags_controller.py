...
async def tag_assign_to_product(request: web.Request, resource_group_name, service_name, product_id, tag_id, api_version, subscription_id, if_match=None) -> web.Response:
...
async def tag_detach_from_product(request: web.Request, resource_group_name, service_name, product_id, tag_id, if_match, api_version, subscription_id) -> web.Response:
