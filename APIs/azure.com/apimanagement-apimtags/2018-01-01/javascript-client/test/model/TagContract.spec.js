...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.TagContract();
  });
  ...
  describe('TagContract', function() {
    it('should create an instance of TagContract', function() {
      // uncomment below and update the code to test TagContract
      //var instance = new ApiManagementClient.TagContract();
      //expect(instance).to.be.a(ApiManagementClient.TagContract);
    });
