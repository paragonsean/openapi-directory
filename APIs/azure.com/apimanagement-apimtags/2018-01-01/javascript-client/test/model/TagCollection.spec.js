...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.TagCollection();
  });
  ...
  describe('TagCollection', function() {
    it('should create an instance of TagCollection', function() {
      ...
      //var instance = new ApiManagementClient.TagCollection();
      //expect(instance).to.be.a(ApiManagementClient.TagCollection);
    });
