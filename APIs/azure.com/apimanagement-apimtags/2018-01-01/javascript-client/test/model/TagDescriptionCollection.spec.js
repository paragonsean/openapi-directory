...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.TagDescriptionCollection();
  });
  ...
  describe('TagDescriptionCollection', function() {
    it('should create an instance of TagDescriptionCollection', function() {
      // uncomment below and update the code to test TagDescriptionCollection
      //var instance = new ApiManagementClient.TagDescriptionCollection();
      //expect(instance).to.be.a(ApiManagementClient.TagDescriptionCollection);
    });
