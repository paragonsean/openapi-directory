...
/*
 * OAIOperation_ListByTags_200_response_value_inner_operation.h
 *
 * Operation Entity contract Properties.
 */

#ifndef OAIOperation_ListByTags_200_response_value_inner_operation_H
#define OAIOperation_ListByTags_200_response_value_inner_operation_H
...
class OAIOperation_ListByTags_200_response_value_inner_operation : public OAIObject {
public:
    OAIOperation_ListByTags_200_response_value_inner_operation();
    OAIOperation_ListByTags_200_response_value_inner_operation(QString json);
    ~OAIOperation_ListByTags_200_response_value_inner_operation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOperation_ListByTags_200_response_value_inner_operation)

#endif // OAIOperation_ListByTags_200_response_value_inner_operation_H
