...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.ScopeMapProperties();
  });
  ...
  describe('ScopeMapProperties', function() {
    it('should create an instance of ScopeMapProperties', function() {
      // uncomment below and update the code to test ScopeMapProperties
      //var instance = new ContainerRegistryManagementClient.ScopeMapProperties();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.ScopeMapProperties);
    });
