...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.Token();
  });
  ...
  describe('Token', function() {
    it('should create an instance of Token', function() {
      ...
      //var instance = new ContainerRegistryManagementClient.Token();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.Token);
    });
