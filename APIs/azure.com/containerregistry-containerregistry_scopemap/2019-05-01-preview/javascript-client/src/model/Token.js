...
class Token {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = TokenProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          TokenProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/TokenProperties} properties
 */
Token.prototype['properties'] = undefined;
