...
export default class ScopeMapsApi {
    ...
    */
     ...
     * @param {module:model/ScopeMap} scopeMapCreateParameters The parameters for creating a scope map.
     ...
     */
    scopeMapsCreate(apiVersion, subscriptionId, resourceGroupName, registryName, scopeMapName, scopeMapCreateParameters, callback) {
      let postBody = scopeMapCreateParameters;
      ...
      if (scopeMapCreateParameters === undefined || scopeMapCreateParameters === null) {
        throw new Error("Missing the required parameter 'scopeMapCreateParameters' when calling scopeMapsCreate");
      }
