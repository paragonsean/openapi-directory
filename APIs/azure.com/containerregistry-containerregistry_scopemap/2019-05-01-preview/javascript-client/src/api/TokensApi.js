...
export default class TokensApi {
    ...
    */
     ...
     * @param {module:model/Token} tokenCreateParameters The parameters for creating a token.
     ...
     */
    tokensCreate(apiVersion, subscriptionId, resourceGroupName, registryName, tokenName, tokenCreateParameters, callback) {
      let postBody = tokenCreateParameters;
      ...
      if (tokenCreateParameters === undefined || tokenCreateParameters === null) {
        throw new Error("Missing the required parameter 'tokenCreateParameters' when calling tokensCreate");
      }
