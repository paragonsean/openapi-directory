...
import ManagedBackupShortTermRetentionPolicyProperties from './model/ManagedBackupShortTermRetentionPolicyProperties';
import ProxyResource from './model/ProxyResource';
import Resource from './model/Resource';
import ManagedBackupShortTermRetentionPoliciesApi from './api/ManagedBackupShortTermRetentionPoliciesApi';
...
export {
    ...
    /**
     * The ManagedBackupShortTermRetentionPolicy model constructor.
     * @property {module:model/ManagedBackupShortTermRetentionPolicy}
     */
    ManagedBackupShortTermRetentionPolicy,

    /**
     * The ManagedBackupShortTermRetentionPolicyListResult model constructor.
     * @property {module:model/ManagedBackupShortTermRetentionPolicyListResult}
     */
    ManagedBackupShortTermRetentionPolicyListResult,

    /**
     * The ManagedBackupShortTermRetentionPolicyProperties model constructor.
     * @property {module:model/ManagedBackupShortTermRetentionPolicyProperties}
     */
    ...
    /**
    * The ManagedBackupShortTermRetentionPoliciesApi service constructor.
    * @property {module:api/ManagedBackupShortTermRetentionPoliciesApi}
    */
