...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MixedReality.OperationPage();
  });
  ...
  describe('OperationPage', function() {
    it('should create an instance of OperationPage', function() {
      // uncomment below and update the code to test OperationPage
      //var instance = new MixedReality.OperationPage();
      //expect(instance).to.be.a(MixedReality.OperationPage);
    });
