...
/*
 * OAIIotBaseModuleSettings.h
 *
 * 
 */

#ifndef OAIIotBaseModuleSettings_H
#define OAIIotBaseModuleSettings_H
...
class OAIIotBaseModuleSettings : public OAIObject {
public:
    OAIIotBaseModuleSettings();
    OAIIotBaseModuleSettings(QString json);
    ~OAIIotBaseModuleSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIotBaseModuleSettings)

#endif // OAIIotBaseModuleSettings_H
