...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMachineLearningModelManagementService.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new AzureMachineLearningModelManagementService.ErrorDetails();
      //expect(instance).to.be.a(AzureMachineLearningModelManagementService.ErrorDetails);
    });
