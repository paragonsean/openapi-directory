...
class OAIServiceResponseBase : public OAIObject {
public:
    OAIServiceResponseBase();
    OAIServiceResponseBase(QString json);
    ~OAIServiceResponseBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceResponseBase)

#endif // OAIServiceResponseBase_H
