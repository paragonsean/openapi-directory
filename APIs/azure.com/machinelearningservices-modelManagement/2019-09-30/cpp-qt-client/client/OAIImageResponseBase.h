...
/*
 * OAIImageResponseBase.h
 *
 * 
 */

#ifndef OAIImageResponseBase_H
#define OAIImageResponseBase_H
...
class OAIImageResponseBase : public OAIObject {
public:
    OAIImageResponseBase();
    OAIImageResponseBase(QString json);
    ~OAIImageResponseBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageResponseBase)

#endif // OAIImageResponseBase_H
