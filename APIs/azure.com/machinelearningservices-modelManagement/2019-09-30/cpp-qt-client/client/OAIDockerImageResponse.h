...
/*
 * OAIDockerImageResponse.h
 *
 * 
 */

#ifndef OAIDockerImageResponse_H
#define OAIDockerImageResponse_H
...
class OAITargetRuntime;

class OAIDockerImageResponse : public OAIObject {
public:
    OAIDockerImageResponse();
    OAIDockerImageResponse(QString json);
    ~OAIDockerImageResponse() override;
    ...
    QString getDockerFileUri() const;
    void setDockerFileUri(const QString &docker_file_uri);
    bool is_docker_file_uri_Set() const;
    bool is_docker_file_uri_Valid() const;
    ...
    QString getGeneratedDockerFileUri() const;
    void setGeneratedDockerFileUri(const QString &generated_docker_file_uri);
    bool is_generated_docker_file_uri_Set() const;
    bool is_generated_docker_file_uri_Valid() const;

    OAITargetRuntime getTargetRuntime() const;
    void setTargetRuntime(const OAITargetRuntime &target_runtime);
    bool is_target_runtime_Set() const;
    bool is_target_runtime_Valid() const;
...
private:
    ...
    QString m_docker_file_uri;
    bool m_docker_file_uri_isSet;
    bool m_docker_file_uri_isValid;

    QString m_driver_program;
    bool m_driver_program_isSet;
    bool m_driver_program_isValid;

    QString m_generated_docker_file_uri;
    bool m_generated_docker_file_uri_isSet;
    bool m_generated_docker_file_uri_isValid;

    OAITargetRuntime m_target_runtime;
    bool m_target_runtime_isSet;
    bool m_target_runtime_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDockerImageResponse)

#endif // OAIDockerImageResponse_H
