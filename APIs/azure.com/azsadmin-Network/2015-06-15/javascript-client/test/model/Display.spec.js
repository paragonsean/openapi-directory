...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkAdminManagementClient.Display();
  });
  ...
  describe('Display', function() {
    it('should create an instance of Display', function() {
      ...
      //var instance = new NetworkAdminManagementClient.Display();
      //expect(instance).to.be.a(NetworkAdminManagementClient.Display);
    });
