...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkAdminManagementClient.LocationsList();
  });
  ...
  describe('LocationsList', function() {
    it('should create an instance of LocationsList', function() {
      // uncomment below and update the code to test LocationsList
      //var instance = new NetworkAdminManagementClient.LocationsList();
      //expect(instance).to.be.a(NetworkAdminManagementClient.LocationsList);
    });
