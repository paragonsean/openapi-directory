...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkAdminManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new NetworkAdminManagementClient.Operation();
      //expect(instance).to.be.a(NetworkAdminManagementClient.Operation);
    });
