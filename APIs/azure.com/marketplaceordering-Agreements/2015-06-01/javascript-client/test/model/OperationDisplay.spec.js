...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceOrderingAgreements.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MarketplaceOrderingAgreements.OperationDisplay();
      //expect(instance).to.be.a(MarketplaceOrderingAgreements.OperationDisplay);
    });
