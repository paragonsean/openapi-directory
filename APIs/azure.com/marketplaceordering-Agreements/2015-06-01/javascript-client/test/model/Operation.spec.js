...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceOrderingAgreements.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new MarketplaceOrderingAgreements.Operation();
      //expect(instance).to.be.a(MarketplaceOrderingAgreements.Operation);
    });
