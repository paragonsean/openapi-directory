...
import org.openapitools.client.model.ExpressRouteLinkMacSecConfig;
...
public class ExpressRouteLinkPropertiesFormat {
  ...
  public static final String SERIALIZED_NAME_MAC_SEC_CONFIG = "macSecConfig";
  @SerializedName(SERIALIZED_NAME_MAC_SEC_CONFIG)
  ...
  public ExpressRouteLinkPropertiesFormat macSecConfig(ExpressRouteLinkMacSecConfig macSecConfig) {
  ...
  public void setMacSecConfig(ExpressRouteLinkMacSecConfig macSecConfig) {
    this.macSecConfig = macSecConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adminState, expressRouteLinkPropertiesFormat.adminState) &&
        ...
        Objects.equals(this.macSecConfig, expressRouteLinkPropertiesFormat.macSecConfig) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adminState, connectorType, interfaceName, macSecConfig, patchPanelId, provisioningState, rackId, routerName);
  }
  ...
  public String toString() {
    ...
    sb.append("    macSecConfig: ").append(toIndentedString(macSecConfig)).append("\n");
  ...
  static {
    ...
    openapiFields.add("macSecConfig");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `macSecConfig`
      if (jsonObj.get("macSecConfig") != null && !jsonObj.get("macSecConfig").isJsonNull()) {
        ExpressRouteLinkMacSecConfig.validateJsonElement(jsonObj.get("macSecConfig"));
      }
