...
async def test_express_route_ports_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","properties":{"allocationDate":"allocationDate","bandwidthInGbps":0,"encapsulation":"Dot1Q","resourceGuid":"resourceGuid","provisionedBandwidthInGbps":6.027456183070403,"etherType":"etherType","links":[{"name":"name","etag":"etag","properties":{"connectorType":"LC","routerName":"routerName","adminState":"Enabled","patchPanelId":"patchPanelId","interfaceName":"interfaceName","provisioningState":"provisioningState","rackId":"rackId"}},{"name":"name","etag":"etag","properties":{"connectorType":"LC","routerName":"routerName","adminState":"Enabled","patchPanelId":"patchPanelId","interfaceName":"interfaceName","provisioningState":"provisioningState","rackId":"rackId"}}],"provisioningState":"provisioningState","circuits":[{"id":"id"},{"id":"id"}],"mtu":"mtu","peeringLocation":"peeringLocation"}}
