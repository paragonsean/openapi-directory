...
class ExpressRouteLinkPropertiesFormat(Model):
    ...
    def __init__(self, admin_state: str=None, connector_type: str=None, interface_name: str=None, mac_sec_config: ExpressRouteLinkMacSecConfig=None, patch_panel_id: str=None, provisioning_state: str=None, rack_id: str=None, router_name: str=None):
        ...
        :param mac_sec_config: The mac_sec_config of this ExpressRouteLinkPropertiesFormat.
        ...
        self._mac_sec_config = mac_sec_config
    ...
    @property
    def mac_sec_config(self):
        """Gets the mac_sec_config of this ExpressRouteLinkPropertiesFormat.


        :return: The mac_sec_config of this ExpressRouteLinkPropertiesFormat.
        :rtype: ExpressRouteLinkMacSecConfig
        """
        return self._mac_sec_config

    @mac_sec_config.setter
    def mac_sec_config(self, mac_sec_config):
        """Sets the mac_sec_config of this ExpressRouteLinkPropertiesFormat.


        :param mac_sec_config: The mac_sec_config of this ExpressRouteLinkPropertiesFormat.
        :type mac_sec_config: ExpressRouteLinkMacSecConfig
        """
