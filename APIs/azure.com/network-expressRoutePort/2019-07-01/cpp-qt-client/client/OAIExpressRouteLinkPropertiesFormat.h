...
namespace OpenAPI {
class OAIExpressRouteLinkMacSecConfig;
...
public:
    ...
    OAIExpressRouteLinkMacSecConfig getMacSecConfig() const;
    void setMacSecConfig(const OAIExpressRouteLinkMacSecConfig &mac_sec_config);
    bool is_mac_sec_config_Set() const;
    bool is_mac_sec_config_Valid() const;
...
private:
    ...
    OAIExpressRouteLinkMacSecConfig m_mac_sec_config;
    bool m_mac_sec_config_isSet;
    bool m_mac_sec_config_isValid;
