...
/*
 * OAIContainers_ListDestinationShares_200_response_inner_properties.h
 *
 * Storage share properties.
 */

#ifndef OAIContainers_ListDestinationShares_200_response_inner_properties_H
#define OAIContainers_ListDestinationShares_200_response_inner_properties_H
...
class OAIContainers_ListDestinationShares_200_response_inner_properties : public OAIObject {
public:
    OAIContainers_ListDestinationShares_200_response_inner_properties();
    OAIContainers_ListDestinationShares_200_response_inner_properties(QString json);
    ~OAIContainers_ListDestinationShares_200_response_inner_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainers_ListDestinationShares_200_response_inner_properties)

#endif // OAIContainers_ListDestinationShares_200_response_inner_properties_H
