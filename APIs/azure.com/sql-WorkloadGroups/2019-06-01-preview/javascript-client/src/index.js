...
import WorkloadGroupProperties from './model/WorkloadGroupProperties';
import WorkloadGroupsApi from './api/WorkloadGroupsApi';
...
export {
    ...
    /**
     * The WorkloadGroup model constructor.
     * @property {module:model/WorkloadGroup}
     */
    WorkloadGroup,

    /**
     * The WorkloadGroupListResult model constructor.
     * @property {module:model/WorkloadGroupListResult}
     */
    WorkloadGroupListResult,

    /**
     * The WorkloadGroupProperties model constructor.
     * @property {module:model/WorkloadGroupProperties}
     */
    WorkloadGroupProperties,

    /**
    * The WorkloadGroupsApi service constructor.
    * @property {module:api/WorkloadGroupsApi}
    */
    WorkloadGroupsApi
};
