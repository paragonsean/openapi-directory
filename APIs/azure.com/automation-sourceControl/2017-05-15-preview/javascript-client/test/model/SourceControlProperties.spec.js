...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.SourceControlProperties();
  });
  ...
  describe('SourceControlProperties', function() {
    it('should create an instance of SourceControlProperties', function() {
      // uncomment below and update the code to test SourceControlProperties
      //var instance = new AutomationManagement.SourceControlProperties();
      //expect(instance).to.be.a(AutomationManagement.SourceControlProperties);
    });
