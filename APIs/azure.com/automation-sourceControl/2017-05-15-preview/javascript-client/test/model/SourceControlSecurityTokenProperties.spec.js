...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.SourceControlSecurityTokenProperties();
  });
  ...
  describe('SourceControlSecurityTokenProperties', function() {
    it('should create an instance of SourceControlSecurityTokenProperties', function() {
      // uncomment below and update the code to test SourceControlSecurityTokenProperties
      //var instance = new AutomationManagement.SourceControlSecurityTokenProperties();
      //expect(instance).to.be.a(AutomationManagement.SourceControlSecurityTokenProperties);
    });
