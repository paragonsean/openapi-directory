...
void OAIBackupInfo::initializeModel() {
    ...
    m_is_cloud_recovery_ready_isSet = false;
    m_is_cloud_recovery_ready_isValid = false;
...
void OAIBackupInfo::fromJsonObject(QJsonObject json) {
    ...
    m_is_cloud_recovery_ready_isValid = ::OpenAPI::fromJsonValue(m_is_cloud_recovery_ready, json[QString("isCloudRecoveryReady")]);
    m_is_cloud_recovery_ready_isSet = !json[QString("isCloudRecoveryReady")].isNull() && m_is_cloud_recovery_ready_isValid;
...
QJsonObject OAIBackupInfo::asJsonObject() const {
    ...
    if (m_is_cloud_recovery_ready_isSet) {
        obj.insert(QString("isCloudRecoveryReady"), ::OpenAPI::toJsonValue(m_is_cloud_recovery_ready));
    }
...
QString OAIBackupInfo::getEncryptionCertThumbprint() const {
    return m_encryption_cert_thumbprint;
}
void OAIBackupInfo::setEncryptionCertThumbprint(const QString &encryption_cert_thumbprint) {
    m_encryption_cert_thumbprint = encryption_cert_thumbprint;
    m_encryption_cert_thumbprint_isSet = true;
}

bool OAIBackupInfo::is_encryption_cert_thumbprint_Set() const{
    return m_encryption_cert_thumbprint_isSet;
}

bool OAIBackupInfo::is_encryption_cert_thumbprint_Valid() const{
    return m_encryption_cert_thumbprint_isValid;
}

bool OAIBackupInfo::isIsCloudRecoveryReady() const {
    return m_is_cloud_recovery_ready;
}
void OAIBackupInfo::setIsCloudRecoveryReady(const bool &is_cloud_recovery_ready) {
    m_is_cloud_recovery_ready = is_cloud_recovery_ready;
    m_is_cloud_recovery_ready_isSet = true;
}

bool OAIBackupInfo::is_is_cloud_recovery_ready_Set() const{
    return m_is_cloud_recovery_ready_isSet;
}

bool OAIBackupInfo::is_is_cloud_recovery_ready_Valid() const{
    return m_is_cloud_recovery_ready_isValid;
}
