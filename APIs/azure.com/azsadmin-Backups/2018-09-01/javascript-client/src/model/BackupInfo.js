...
class BackupInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isCloudRecoveryReady')) {
                obj['isCloudRecoveryReady'] = ApiClient.convertToType(data['isCloudRecoveryReady'], 'Boolean');
            }
 ...
 */
BackupInfo.prototype['encryptionCertThumbprint'] = undefined;

/**
 * True if the backup can be used for cloud recovery scenario.
 * @member {Boolean} isCloudRecoveryReady
 */
BackupInfo.prototype['isCloudRecoveryReady'] = undefined;
