...
export default class BackupsApi {
    ...
    */
     ...
     * @param {String} backup Name of the backup.
     * @param {String} apiVersion Client API version.
     * @param {module:model/RestoreOptions} restoreOptions Restore options.
     ...
     */
    backupsRestore(subscriptionId, location, resourceGroupName, backup, apiVersion, restoreOptions, callback) {
      let postBody = restoreOptions;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
      ...
      if (restoreOptions === undefined || restoreOptions === null) {
        throw new Error("Missing the required parameter 'restoreOptions' when calling backupsRestore");
      }
