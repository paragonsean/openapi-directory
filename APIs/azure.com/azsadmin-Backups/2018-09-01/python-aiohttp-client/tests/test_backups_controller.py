...
async def test_backups_restore(client):
    ...
    """
    restore_options = {"decryptionCertBase64":"decryptionCertBase64","decryptionCertPassword":"decryptionCertPassword","roleName":"roleName"}
    params = [('api-version', '2018-09-01')]
    headers = { 
