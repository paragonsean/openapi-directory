...
public class FrontDoorProperties {
  ...
  public static final String SERIALIZED_NAME_FRONTDOOR_ID = "frontdoorId";
  @SerializedName(SERIALIZED_NAME_FRONTDOOR_ID)
  ...
  public static final String SERIALIZED_NAME_RULES_ENGINES = "rulesEngines";
  @SerializedName(SERIALIZED_NAME_RULES_ENGINES)
  private List<RulesEngine> rulesEngines = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cname, frontDoorProperties.cname) &&
        Objects.equals(this.frontdoorId, frontDoorProperties.frontdoorId) &&
        ...
        Objects.equals(this.rulesEngines, frontDoorProperties.rulesEngines) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cname, frontdoorId, provisioningState, resourceState, rulesEngines, backendPools, backendPoolsSettings, enabledState, friendlyName, frontendEndpoints, healthProbeSettings, loadBalancingSettings, routingRules);
  }
  ...
  public String toString() {
    ...
    sb.append("    frontdoorId: ").append(toIndentedString(frontdoorId)).append("\n");
    sb.append("    provisioningState: ").append(toIndentedString(provisioningState)).append("\n");
    sb.append("    resourceState: ").append(toIndentedString(resourceState)).append("\n");
    sb.append("    rulesEngines: ").append(toIndentedString(rulesEngines)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("frontdoorId") != null && !jsonObj.get("frontdoorId").isJsonNull()) && !jsonObj.get("frontdoorId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `frontdoorId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("frontdoorId").toString()));
      }
      ...
      if (jsonObj.get("rulesEngines") != null && !jsonObj.get("rulesEngines").isJsonNull()) {
        JsonArray jsonArrayrulesEngines = jsonObj.getAsJsonArray("rulesEngines");
        if (jsonArrayrulesEngines != null) {
          // ensure the json data is an array
          if (!jsonObj.get("rulesEngines").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `rulesEngines` to be an array in the JSON string but got `%s`", jsonObj.get("rulesEngines").toString()));
          }

          // validate the optional field `rulesEngines` (array)
          for (int i = 0; i < jsonArrayrulesEngines.size(); i++) {
            RulesEngine.validateJsonElement(jsonArrayrulesEngines.get(i));
          };
        }
      }
