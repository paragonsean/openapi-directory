...
void OAIBackend::initializeModel() {
    ...
    m_private_link_id_isSet = false;
    m_private_link_id_isValid = false;
...
void OAIBackend::fromJsonObject(QJsonObject json) {
    ...
    m_private_link_id_isValid = ::OpenAPI::fromJsonValue(m_private_link_id, json[QString("privateLinkId")]);
    m_private_link_id_isSet = !json[QString("privateLinkId")].isNull() && m_private_link_id_isValid;
...
QJsonObject OAIBackend::asJsonObject() const {
    ...
    if (m_private_link_id_isSet) {
        obj.insert(QString("privateLinkId"), ::OpenAPI::toJsonValue(m_private_link_id));
    }
    if (m_weight_isSet) {
...
QString OAIBackend::getLocation() const {
    return m_location;
}
void OAIBackend::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIBackend::is_location_Set() const{
    return m_location_isSet;
}

bool OAIBackend::is_location_Valid() const{
...
QString OAIBackend::getPrivateLinkId() const {
    return m_private_link_id;
}
void OAIBackend::setPrivateLinkId(const QString &private_link_id) {
    m_private_link_id = private_link_id;
    m_private_link_id_isSet = true;
}

bool OAIBackend::is_private_link_id_Set() const{
    return m_private_link_id_isSet;
}

bool OAIBackend::is_private_link_id_Valid() const{
    return m_private_link_id_isValid;
}
