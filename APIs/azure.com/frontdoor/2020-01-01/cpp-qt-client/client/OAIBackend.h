...
public:
    ...
    QString getPrivateLinkId() const;
    void setPrivateLinkId(const QString &private_link_id);
    bool is_private_link_id_Set() const;
    bool is_private_link_id_Valid() const;
...
private:
    ...
    QString m_private_link_id;
    bool m_private_link_id_isSet;
    bool m_private_link_id_isValid;
