...
public:
    ...
    QString getFrontdoorId() const;
    void setFrontdoorId(const QString &frontdoor_id);
    bool is_frontdoor_id_Set() const;
    bool is_frontdoor_id_Valid() const;
    ...
    QList<OAIRulesEngine> getRulesEngines() const;
    void setRulesEngines(const QList<OAIRulesEngine> &rules_engines);
    bool is_rules_engines_Set() const;
    bool is_rules_engines_Valid() const;
...
private:
    ...
    QString m_frontdoor_id;
    bool m_frontdoor_id_isSet;
    bool m_frontdoor_id_isValid;
    ...
    QList<OAIRulesEngine> m_rules_engines;
    bool m_rules_engines_isSet;
    bool m_rules_engines_isValid;
