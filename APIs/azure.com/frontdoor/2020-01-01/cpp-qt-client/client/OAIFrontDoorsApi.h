...
#include "OAIRulesEngineListResult.h"
...
public:
    ...
    * @param[in]  resource_group_name QString [required]
    * @param[in]  front_door_name QString [required]
    * @param[in]  rules_engine_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  rules_engine_parameters OAIRulesEngine [required]
    */
    virtual void rulesEnginesCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &front_door_name, const QString &rules_engine_name, const QString &api_version, const OAIRulesEngine &rules_engine_parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void rulesEnginesDelete(const QString &subscription_id, const QString &resource_group_name, const QString &front_door_name, const QString &rules_engine_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void rulesEnginesGet(const QString &subscription_id, const QString &resource_group_name, const QString &front_door_name, const QString &rules_engine_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void rulesEnginesListByFrontDoor(const QString &subscription_id, const QString &resource_group_name, const QString &front_door_name, const QString &api_version);
...
private:
    ...
    void rulesEnginesCreateOrUpdateCallback(OAIHttpRequestWorker *worker);
    void rulesEnginesDeleteCallback(OAIHttpRequestWorker *worker);
    void rulesEnginesGetCallback(OAIHttpRequestWorker *worker);
    void rulesEnginesListByFrontDoorCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void rulesEnginesCreateOrUpdateSignal(OAIRulesEngine summary);
    void rulesEnginesDeleteSignal();
    void rulesEnginesGetSignal(OAIRulesEngine summary);
    void rulesEnginesListByFrontDoorSignal(OAIRulesEngineListResult summary);
    ...
    void rulesEnginesCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIRulesEngine summary);
    void rulesEnginesDeleteSignalFull(OAIHttpRequestWorker *worker);
    void rulesEnginesGetSignalFull(OAIHttpRequestWorker *worker, OAIRulesEngine summary);
    void rulesEnginesListByFrontDoorSignalFull(OAIHttpRequestWorker *worker, OAIRulesEngineListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use rulesEnginesCreateOrUpdateSignalError() instead")
    void rulesEnginesCreateOrUpdateSignalE(OAIRulesEngine summary, QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesCreateOrUpdateSignalError(OAIRulesEngine summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rulesEnginesDeleteSignalError() instead")
    void rulesEnginesDeleteSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesDeleteSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rulesEnginesGetSignalError() instead")
    void rulesEnginesGetSignalE(OAIRulesEngine summary, QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesGetSignalError(OAIRulesEngine summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rulesEnginesListByFrontDoorSignalError() instead")
    void rulesEnginesListByFrontDoorSignalE(OAIRulesEngineListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesListByFrontDoorSignalError(OAIRulesEngineListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use rulesEnginesCreateOrUpdateSignalErrorFull() instead")
    void rulesEnginesCreateOrUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesCreateOrUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rulesEnginesDeleteSignalErrorFull() instead")
    void rulesEnginesDeleteSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesDeleteSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rulesEnginesGetSignalErrorFull() instead")
    void rulesEnginesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use rulesEnginesListByFrontDoorSignalErrorFull() instead")
    void rulesEnginesListByFrontDoorSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void rulesEnginesListByFrontDoorSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
