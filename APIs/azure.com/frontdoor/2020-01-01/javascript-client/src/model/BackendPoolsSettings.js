...
class BackendPoolsSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sendRecvTimeoutSeconds')) {
                obj['sendRecvTimeoutSeconds'] = ApiClient.convertToType(data['sendRecvTimeoutSeconds'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} sendRecvTimeoutSeconds
 */
BackendPoolsSettings.prototype['sendRecvTimeoutSeconds'] = undefined;
