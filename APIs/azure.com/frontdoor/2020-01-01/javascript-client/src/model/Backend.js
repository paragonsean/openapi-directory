...
class Backend {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('privateLinkId')) {
                obj['privateLinkId'] = ApiClient.convertToType(data['privateLinkId'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['privateLinkId'] && !(typeof data['privateLinkId'] === 'string' || data['privateLinkId'] instanceof String)) {
            throw new Error("Expected the field `privateLinkId` to be a primitive type in the JSON string but got " + data['privateLinkId']);
        }
 ...
 */
Backend.prototype['location'] = undefined;
 ...
 * @member {String} privateLinkId
 */
Backend.prototype['privateLinkId'] = undefined;
