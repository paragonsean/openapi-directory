...
import RulesEngine from '../model/RulesEngine';
import RulesEngineListResult from '../model/RulesEngineListResult';
...
export default class FrontDoorsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the rulesEnginesCreateOrUpdate operation.
     * @callback module:api/FrontDoorsApi~rulesEnginesCreateOrUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RulesEngine} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} resourceGroupName Name of the Resource group within the Azure subscription.
     * @param {String} frontDoorName Name of the Front Door which is globally unique.
     * @param {String} rulesEngineName Name of the Rules Engine which is unique within the Front Door.
     * @param {String} apiVersion Client API version.
     * @param {module:model/RulesEngine} rulesEngineParameters Rules Engine Configuration properties needed to create a new Rules Engine Configuration.
     * @param {module:api/FrontDoorsApi~rulesEnginesCreateOrUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RulesEngine}
     */
    rulesEnginesCreateOrUpdate(subscriptionId, resourceGroupName, frontDoorName, rulesEngineName, apiVersion, rulesEngineParameters, callback) {
      let postBody = rulesEngineParameters;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling rulesEnginesCreateOrUpdate");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling rulesEnginesCreateOrUpdate");
      }
      // verify the required parameter 'frontDoorName' is set
      if (frontDoorName === undefined || frontDoorName === null) {
        throw new Error("Missing the required parameter 'frontDoorName' when calling rulesEnginesCreateOrUpdate");
      }
      // verify the required parameter 'rulesEngineName' is set
      if (rulesEngineName === undefined || rulesEngineName === null) {
        throw new Error("Missing the required parameter 'rulesEngineName' when calling rulesEnginesCreateOrUpdate");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling rulesEnginesCreateOrUpdate");
      }
      // verify the required parameter 'rulesEngineParameters' is set
      if (rulesEngineParameters === undefined || rulesEngineParameters === null) {
        throw new Error("Missing the required parameter 'rulesEngineParameters' when calling rulesEnginesCreateOrUpdate");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = RulesEngine;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoors/{frontDoorName}/rulesEngines/{rulesEngineName}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the rulesEnginesDelete operation.
     * @callback module:api/FrontDoorsApi~rulesEnginesDeleteCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} rulesEngineName Name of the Rules Engine which is unique within the Front Door.
     * @param {String} apiVersion Client API version.
     * @param {module:api/FrontDoorsApi~rulesEnginesDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    rulesEnginesDelete(subscriptionId, resourceGroupName, frontDoorName, rulesEngineName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling rulesEnginesDelete");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling rulesEnginesDelete");
      }
      // verify the required parameter 'frontDoorName' is set
      if (frontDoorName === undefined || frontDoorName === null) {
        throw new Error("Missing the required parameter 'frontDoorName' when calling rulesEnginesDelete");
      }
      // verify the required parameter 'rulesEngineName' is set
      if (rulesEngineName === undefined || rulesEngineName === null) {
        throw new Error("Missing the required parameter 'rulesEngineName' when calling rulesEnginesDelete");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling rulesEnginesDelete");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoors/{frontDoorName}/rulesEngines/{rulesEngineName}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the rulesEnginesGet operation.
     * @callback module:api/FrontDoorsApi~rulesEnginesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RulesEngine} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} rulesEngineName Name of the Rules Engine which is unique within the Front Door.
     * @param {String} apiVersion Client API version.
     * @param {module:api/FrontDoorsApi~rulesEnginesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RulesEngine}
     */
    rulesEnginesGet(subscriptionId, resourceGroupName, frontDoorName, rulesEngineName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling rulesEnginesGet");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling rulesEnginesGet");
      }
      // verify the required parameter 'frontDoorName' is set
      if (frontDoorName === undefined || frontDoorName === null) {
        throw new Error("Missing the required parameter 'frontDoorName' when calling rulesEnginesGet");
      }
      // verify the required parameter 'rulesEngineName' is set
      if (rulesEngineName === undefined || rulesEngineName === null) {
        throw new Error("Missing the required parameter 'rulesEngineName' when calling rulesEnginesGet");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling rulesEnginesGet");
      }
      ...
      let returnType = RulesEngine;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoors/{frontDoorName}/rulesEngines/{rulesEngineName}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the rulesEnginesListByFrontDoor operation.
     * @callback module:api/FrontDoorsApi~rulesEnginesListByFrontDoorCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RulesEngineListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} frontDoorName Name of the Front Door which is globally unique.
     * @param {String} apiVersion Client API version.
     * @param {module:api/FrontDoorsApi~rulesEnginesListByFrontDoorCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RulesEngineListResult}
     */
    rulesEnginesListByFrontDoor(subscriptionId, resourceGroupName, frontDoorName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling rulesEnginesListByFrontDoor");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling rulesEnginesListByFrontDoor");
      }
      // verify the required parameter 'frontDoorName' is set
      if (frontDoorName === undefined || frontDoorName === null) {
        throw new Error("Missing the required parameter 'frontDoorName' when calling rulesEnginesListByFrontDoor");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling rulesEnginesListByFrontDoor");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = RulesEngineListResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/frontDoors/{frontDoorName}/rulesEngines', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
