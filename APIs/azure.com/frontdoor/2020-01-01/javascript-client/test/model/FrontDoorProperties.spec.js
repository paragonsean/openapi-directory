...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrontDoorManagementClient.FrontDoorProperties();
  });
  ...
  describe('FrontDoorProperties', function() {
    it('should create an instance of FrontDoorProperties', function() {
      // uncomment below and update the code to test FrontDoorProperties
      //var instance = new FrontDoorManagementClient.FrontDoorProperties();
      //expect(instance).to.be.a(FrontDoorManagementClient.FrontDoorProperties);
    });
    ...
    it('should have the property frontdoorId (base name: "frontdoorId")', function() {
      // uncomment below and update the code to test the property frontdoorId
      //var instance = new FrontDoorManagementClient.FrontDoorProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property rulesEngines (base name: "rulesEngines")', function() {
      // uncomment below and update the code to test the property rulesEngines
      //var instance = new FrontDoorManagementClient.FrontDoorProperties();
      //expect(instance).to.be();
    });
