...
async def test_front_doors_create_or_update(client):
    ...
    """
    front_door_parameters = {"properties":{"cname":"cname","resourceState":"Creating","rulesEngines":[{"name":"name","id":"id","type":"type","properties":{}},{"name":"name","id":"id","type":"type","properties":{}}],"frontdoorId":"frontdoorId","provisioningState":"provisioningState"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_frontend_endpoints_enable_https(client):
    ...
    """
    custom_https_configuration = {"frontDoorCertificateSourceParameters":{"certificateType":"Dedicated"},"minimumTlsVersion":"1.0","keyVaultCertificateSourceParameters":{"secretName":"secretName","secretVersion":"secretVersion","vault":{"id":"id"}},"protocolType":"ServerNameIndication","certificateSource":"AzureKeyVault"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_rules_engines_create_or_update(client):
    """Test case for rules_engines_create_or_update

    
    """
    rules_engine_parameters = {"name":"name","id":"id","type":"type","properties":{}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/frontDoors/{front_door_name}/rulesEngines/{rules_engine_name}'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', front_door_name='front_door_name_example', rules_engine_name='rules_engine_name_example'),
        headers=headers,
...
async def test_rules_engines_delete(client):
...
async def test_rules_engines_get(client):
...
async def test_rules_engines_list_by_front_door(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/frontDoors/{front_door_name}/rulesEngines'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', front_door_name='front_door_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
