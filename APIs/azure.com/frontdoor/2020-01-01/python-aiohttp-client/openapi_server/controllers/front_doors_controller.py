...
from openapi_server.models.rules_engine_list_result import RulesEngineListResult
...
async def rules_engines_create_or_update(request: web.Request, subscription_id, resource_group_name, front_door_name, rules_engine_name, api_version, rules_engine_parameters) -> web.Response:
    """rules_engines_create_or_update
    ...
    :param api_version: Client API version.
    :type api_version: str
    :param rules_engine_parameters: Rules Engine Configuration properties needed to create a new Rules Engine Configuration.
    :type rules_engine_parameters: dict | bytes

    """
    rules_engine_parameters = RulesEngine.from_dict(rules_engine_parameters)
    return web.Response(status=200)


async def rules_engines_delete(request: web.Request, subscription_id, resource_group_name, front_door_name, rules_engine_name, api_version) -> web.Response:
    """rules_engines_delete
...
async def rules_engines_get(request: web.Request, subscription_id, resource_group_name, front_door_name, rules_engine_name, api_version) -> web.Response:
    """rules_engines_get
...
async def rules_engines_list_by_front_door(request: web.Request, subscription_id, resource_group_name, front_door_name, api_version) -> web.Response:
    """rules_engines_list_by_front_door
