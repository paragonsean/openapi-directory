...
class Backend(Model):
    ...
    def __init__(self, address: str=None, backend_host_header: str=None, enabled_state: str=None, http_port: int=None, https_port: int=None, location: str=None, priority: int=None, private_link_id: str=None, weight: int=None):
        ...
        :param location: The location of this Backend.
        :param priority: The priority of this Backend.
        :param private_link_id: The private_link_id of this Backend.
    ...
    def location(self, location):
        """Sets the location of this Backend.
    ...
    def private_link_id(self):
        """Gets the private_link_id of this Backend.
        ...
        :return: The private_link_id of this Backend.
        :rtype: str
        """
    ...
    def private_link_id(self, private_link_id):
        """Sets the private_link_id of this Backend.
