...
class RoutingRuleProperties(Model):
    ...
    def __init__(self, resource_state: ResourceState=None, accepted_protocols: List[str]=None, enabled_state: str=None, frontend_endpoints: List[BackendPoolUpdateParametersHealthProbeSettings]=None, patterns_to_match: List[str]=None, route_configuration: RouteConfiguration=None, rules_engine: BackendPoolUpdateParametersHealthProbeSettings=None):
        ...
        :param rules_engine: The rules_engine of this RoutingRuleProperties.
        """
        self.openapi_types = {
            ...
            'rules_engine': BackendPoolUpdateParametersHealthProbeSettings
        }
    ...
    def rules_engine(self):
        """Gets the rules_engine of this RoutingRuleProperties.


        :return: The rules_engine of this RoutingRuleProperties.
        :rtype: BackendPoolUpdateParametersHealthProbeSettings
        """
        return self._rules_engine

    @rules_engine.setter
    def rules_engine(self, rules_engine):
        """Sets the rules_engine of this RoutingRuleProperties.


        :param rules_engine: The rules_engine of this RoutingRuleProperties.
        :type rules_engine: BackendPoolUpdateParametersHealthProbeSettings
        """
