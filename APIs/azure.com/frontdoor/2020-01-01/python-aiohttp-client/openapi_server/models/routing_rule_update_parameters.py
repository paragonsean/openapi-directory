...
class RoutingRuleUpdateParameters(Model):
    ...
    def __init__(self, accepted_protocols: List[str]=None, enabled_state: str=None, frontend_endpoints: List[BackendPoolUpdateParametersHealthProbeSettings]=None, patterns_to_match: List[str]=None, route_configuration: RouteConfiguration=None, rules_engine: BackendPoolUpdateParametersHealthProbeSettings=None):
        ...
        :param rules_engine: The rules_engine of this RoutingRuleUpdateParameters.
        """
        self.openapi_types = {
    ...
    def rules_engine(self):
        """Gets the rules_engine of this RoutingRuleUpdateParameters.


        :return: The rules_engine of this RoutingRuleUpdateParameters.
    ...
    def rules_engine(self, rules_engine):
        """Sets the rules_engine of this RoutingRuleUpdateParameters.
