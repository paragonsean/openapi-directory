...
public class FrontDoorProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cname, provisioningState, resourceState, backendPools, enabledState, friendlyName, frontendEndpoints, healthProbeSettings, loadBalancingSettings, routingRules);
  }
