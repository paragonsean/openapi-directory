...
public class RoutingRuleProperties {
  ...
  private BackendPoolUpdateParametersHealthProbeSettings backendPool;
  ...
  public RoutingRuleProperties backendPool(BackendPoolUpdateParametersHealthProbeSettings backendPool) {
   ...
   */
  @javax.annotation.Nullable
  public BackendPoolUpdateParametersHealthProbeSettings getBackendPool() {
    return backendPool;
  }

  public void setBackendPool(BackendPoolUpdateParametersHealthProbeSettings backendPool) {
    this.backendPool = backendPool;
  }


  public RoutingRuleProperties cacheConfiguration(CacheConfiguration cacheConfiguration) {
  ...
  public RoutingRuleProperties customForwardingPath(String customForwardingPath) {
  ...
  public RoutingRuleProperties forwardingProtocol(ForwardingProtocolEnum forwardingProtocol) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceState, routingRuleProperties.resourceState) &&
        ...
        Objects.equals(this.backendPool, routingRuleProperties.backendPool) &&
        Objects.equals(this.cacheConfiguration, routingRuleProperties.cacheConfiguration) &&
        Objects.equals(this.customForwardingPath, routingRuleProperties.customForwardingPath) &&
        Objects.equals(this.enabledState, routingRuleProperties.enabledState) &&
        Objects.equals(this.forwardingProtocol, routingRuleProperties.forwardingProtocol) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(resourceState, acceptedProtocols, backendPool, cacheConfiguration, customForwardingPath, enabledState, forwardingProtocol, frontendEndpoints, patternsToMatch);
  }
  ...
  static {
    ...
    openapiFields.add("backendPool");
    openapiFields.add("cacheConfiguration");
    openapiFields.add("customForwardingPath");
    openapiFields.add("enabledState");
    openapiFields.add("forwardingProtocol");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("backendPool") != null && !jsonObj.get("backendPool").isJsonNull()) {
        BackendPoolUpdateParametersHealthProbeSettings.validateJsonElement(jsonObj.get("backendPool"));
      }
      // validate the optional field `cacheConfiguration`
      if (jsonObj.get("cacheConfiguration") != null && !jsonObj.get("cacheConfiguration").isJsonNull()) {
        CacheConfiguration.validateJsonElement(jsonObj.get("cacheConfiguration"));
      }
      if ((jsonObj.get("customForwardingPath") != null && !jsonObj.get("customForwardingPath").isJsonNull()) && !jsonObj.get("customForwardingPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `customForwardingPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("customForwardingPath").toString()));
      }
      ...
      if ((jsonObj.get("forwardingProtocol") != null && !jsonObj.get("forwardingProtocol").isJsonNull()) && !jsonObj.get("forwardingProtocol").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `forwardingProtocol` to be a primitive type in the JSON string but got `%s`", jsonObj.get("forwardingProtocol").toString()));
      }
      // validate the optional field `forwardingProtocol`
      if (jsonObj.get("forwardingProtocol") != null && !jsonObj.get("forwardingProtocol").isJsonNull()) {
        ForwardingProtocolEnum.validateJsonElement(jsonObj.get("forwardingProtocol"));
      }
