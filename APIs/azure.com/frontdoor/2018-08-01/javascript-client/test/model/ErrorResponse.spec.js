...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrontDoorManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new FrontDoorManagementClient.ErrorResponse();
      //expect(instance).to.be.a(FrontDoorManagementClient.ErrorResponse);
    });
