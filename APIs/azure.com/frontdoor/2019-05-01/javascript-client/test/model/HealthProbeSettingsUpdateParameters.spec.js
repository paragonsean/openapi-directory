...
(function(root, factory) {
  ...
  describe('HealthProbeSettingsUpdateParameters', function() {
    ...
    it('should have the property healthProbeMethod (base name: "healthProbeMethod")', function() {
      // uncomment below and update the code to test the property healthProbeMethod
      //var instance = new FrontDoorManagementClient.HealthProbeSettingsUpdateParameters();
      //expect(instance).to.be();
    });
