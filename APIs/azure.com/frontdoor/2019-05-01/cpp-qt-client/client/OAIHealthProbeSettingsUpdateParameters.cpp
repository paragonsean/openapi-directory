...
void OAIHealthProbeSettingsUpdateParameters::initializeModel() {
    ...
    m_health_probe_method_isSet = false;
    m_health_probe_method_isValid = false;
...
void OAIHealthProbeSettingsUpdateParameters::fromJsonObject(QJsonObject json) {
    ...
    m_health_probe_method_isValid = ::OpenAPI::fromJsonValue(m_health_probe_method, json[QString("healthProbeMethod")]);
    m_health_probe_method_isSet = !json[QString("healthProbeMethod")].isNull() && m_health_probe_method_isValid;
...
QJsonObject OAIHealthProbeSettingsUpdateParameters::asJsonObject() const {
    ...
    if (m_health_probe_method_isSet) {
        obj.insert(QString("healthProbeMethod"), ::OpenAPI::toJsonValue(m_health_probe_method));
    }
...
QString OAIHealthProbeSettingsUpdateParameters::getEnabledState() const {
    return m_enabled_state;
}
void OAIHealthProbeSettingsUpdateParameters::setEnabledState(const QString &enabled_state) {
    m_enabled_state = enabled_state;
    m_enabled_state_isSet = true;
}

bool OAIHealthProbeSettingsUpdateParameters::is_enabled_state_Set() const{
    return m_enabled_state_isSet;
}

bool OAIHealthProbeSettingsUpdateParameters::is_enabled_state_Valid() const{
    return m_enabled_state_isValid;
}

QString OAIHealthProbeSettingsUpdateParameters::getHealthProbeMethod() const {
    return m_health_probe_method;
}
void OAIHealthProbeSettingsUpdateParameters::setHealthProbeMethod(const QString &health_probe_method) {
    m_health_probe_method = health_probe_method;
    m_health_probe_method_isSet = true;
}

bool OAIHealthProbeSettingsUpdateParameters::is_health_probe_method_Set() const{
    return m_health_probe_method_isSet;
}

bool OAIHealthProbeSettingsUpdateParameters::is_health_probe_method_Valid() const{
    return m_health_probe_method_isValid;
}
