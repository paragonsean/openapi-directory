...
OAIBackendPoolProperties::OAIBackendPoolProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackendPoolProperties::OAIBackendPoolProperties() {
    this->initializeModel();
}

OAIBackendPoolProperties::~OAIBackendPoolProperties() {}

void OAIBackendPoolProperties::initializeModel() {
...
void OAIBackendPoolProperties::fromJson(QString jsonString) {
...
void OAIBackendPoolProperties::fromJsonObject(QJsonObject json) {
...
QString OAIBackendPoolProperties::asJson() const {
...
QJsonObject OAIBackendPoolProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIResourceState OAIBackendPoolProperties::getResourceState() const {
    return m_resource_state;
}
void OAIBackendPoolProperties::setResourceState(const OAIResourceState &resource_state) {
    m_resource_state = resource_state;
    m_resource_state_isSet = true;
}

bool OAIBackendPoolProperties::is_resource_state_Set() const{
    return m_resource_state_isSet;
}

bool OAIBackendPoolProperties::is_resource_state_Valid() const{
    return m_resource_state_isValid;
}

QList<OAIBackend> OAIBackendPoolProperties::getBackends() const {
    return m_backends;
}
void OAIBackendPoolProperties::setBackends(const QList<OAIBackend> &backends) {
    m_backends = backends;
    m_backends_isSet = true;
}

bool OAIBackendPoolProperties::is_backends_Set() const{
    return m_backends_isSet;
}

bool OAIBackendPoolProperties::is_backends_Valid() const{
    return m_backends_isValid;
}

OAIBackendPoolUpdateParameters_healthProbeSettings OAIBackendPoolProperties::getHealthProbeSettings() const {
    return m_health_probe_settings;
}
void OAIBackendPoolProperties::setHealthProbeSettings(const OAIBackendPoolUpdateParameters_healthProbeSettings &health_probe_settings) {
    m_health_probe_settings = health_probe_settings;
    m_health_probe_settings_isSet = true;
}

bool OAIBackendPoolProperties::is_health_probe_settings_Set() const{
    return m_health_probe_settings_isSet;
}

bool OAIBackendPoolProperties::is_health_probe_settings_Valid() const{
    return m_health_probe_settings_isValid;
}

OAIBackendPoolUpdateParameters_healthProbeSettings OAIBackendPoolProperties::getLoadBalancingSettings() const {
    return m_load_balancing_settings;
}
void OAIBackendPoolProperties::setLoadBalancingSettings(const OAIBackendPoolUpdateParameters_healthProbeSettings &load_balancing_settings) {
    m_load_balancing_settings = load_balancing_settings;
    m_load_balancing_settings_isSet = true;
}

bool OAIBackendPoolProperties::is_load_balancing_settings_Set() const{
    return m_load_balancing_settings_isSet;
}

bool OAIBackendPoolProperties::is_load_balancing_settings_Valid() const{
    return m_load_balancing_settings_isValid;
}

bool OAIBackendPoolProperties::isSet() const {
...
bool OAIBackendPoolProperties::isValid() const {
