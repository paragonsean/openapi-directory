...
class FrontDoorProperties(Model):
    ...
    def __init__(self, cname: str=None, provisioning_state: str=None, resource_state: ResourceState=None, backend_pools: List[BackendPool]=None, backend_pools_settings: BackendPoolsSettings=None, enabled_state: str=None, friendly_name: str=None, frontend_endpoints: List[FrontendEndpoint]=None, health_probe_settings: List[HealthProbeSettingsModel]=None, load_balancing_settings: List[LoadBalancingSettingsModel]=None, routing_rules: List[RoutingRule]=None):
