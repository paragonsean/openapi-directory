...
class CustomHttpsConfiguration(Model):
    ...
    def __init__(self, certificate_source: str=None, front_door_certificate_source_parameters: FrontDoorCertificateSourceParameters=None, key_vault_certificate_source_parameters: KeyVaultCertificateSourceParameters=None, protocol_type: str=None):
