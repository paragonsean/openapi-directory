...
public class FrontDoorUpdateParameters {
  ...
  public FrontDoorUpdateParameters backendPools(List<BackendPool> backendPools) {
    this.backendPools = backendPools;
    return this;
  }

  public FrontDoorUpdateParameters addBackendPoolsItem(BackendPool backendPoolsItem) {
  ...
  public FrontDoorUpdateParameters backendPoolsSettings(BackendPoolsSettings backendPoolsSettings) {
  ...
  public FrontDoorUpdateParameters enabledState(EnabledStateEnum enabledState) {
  ...
  public FrontDoorUpdateParameters friendlyName(String friendlyName) {
  ...
  public FrontDoorUpdateParameters frontendEndpoints(List<FrontendEndpoint> frontendEndpoints) {
    this.frontendEndpoints = frontendEndpoints;
    return this;
  }

  public FrontDoorUpdateParameters addFrontendEndpointsItem(FrontendEndpoint frontendEndpointsItem) {
  ...
  public FrontDoorUpdateParameters healthProbeSettings(List<HealthProbeSettingsModel> healthProbeSettings) {
    this.healthProbeSettings = healthProbeSettings;
    return this;
  }

  public FrontDoorUpdateParameters addHealthProbeSettingsItem(HealthProbeSettingsModel healthProbeSettingsItem) {
  ...
  public FrontDoorUpdateParameters loadBalancingSettings(List<LoadBalancingSettingsModel> loadBalancingSettings) {
    this.loadBalancingSettings = loadBalancingSettings;
    return this;
  }

  public FrontDoorUpdateParameters addLoadBalancingSettingsItem(LoadBalancingSettingsModel loadBalancingSettingsItem) {
  ...
  public FrontDoorUpdateParameters routingRules(List<RoutingRule> routingRules) {
    this.routingRules = routingRules;
    return this;
  }

  public FrontDoorUpdateParameters addRoutingRulesItem(RoutingRule routingRulesItem) {
  ...
  public boolean equals(Object o) {
    ...
    FrontDoorUpdateParameters frontDoorUpdateParameters = (FrontDoorUpdateParameters) o;
    return Objects.equals(this.backendPools, frontDoorUpdateParameters.backendPools) &&
        Objects.equals(this.backendPoolsSettings, frontDoorUpdateParameters.backendPoolsSettings) &&
        Objects.equals(this.enabledState, frontDoorUpdateParameters.enabledState) &&
        Objects.equals(this.friendlyName, frontDoorUpdateParameters.friendlyName) &&
        Objects.equals(this.frontendEndpoints, frontDoorUpdateParameters.frontendEndpoints) &&
        Objects.equals(this.healthProbeSettings, frontDoorUpdateParameters.healthProbeSettings) &&
        Objects.equals(this.loadBalancingSettings, frontDoorUpdateParameters.loadBalancingSettings) &&
        Objects.equals(this.routingRules, frontDoorUpdateParameters.routingRules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backendPools, backendPoolsSettings, enabledState, friendlyName, frontendEndpoints, healthProbeSettings, loadBalancingSettings, routingRules);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FrontDoorUpdateParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FrontDoorUpdateParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FrontDoorUpdateParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FrontDoorUpdateParameters is not found in the empty JSON string", FrontDoorUpdateParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FrontDoorUpdateParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FrontDoorUpdateParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FrontDoorUpdateParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FrontDoorUpdateParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FrontDoorUpdateParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FrontDoorUpdateParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<FrontDoorUpdateParameters>() {
           @Override
           public void write(JsonWriter out, FrontDoorUpdateParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FrontDoorUpdateParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FrontDoorUpdateParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FrontDoorUpdateParameters
   * @throws IOException if the JSON string is invalid with respect to FrontDoorUpdateParameters
   */
  public static FrontDoorUpdateParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FrontDoorUpdateParameters.class);
  }

  /**
   * Convert an instance of FrontDoorUpdateParameters to an JSON string
   *
   * @return JSON string
   */
