...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FrontDoorManagementClient.BackendPoolUpdateParameters();
  });
  ...
  describe('BackendPoolUpdateParameters', function() {
    it('should create an instance of BackendPoolUpdateParameters', function() {
      // uncomment below and update the code to test BackendPoolUpdateParameters
      //var instance = new FrontDoorManagementClient.BackendPoolUpdateParameters();
      //expect(instance).to.be.a(FrontDoorManagementClient.BackendPoolUpdateParameters);
    });
