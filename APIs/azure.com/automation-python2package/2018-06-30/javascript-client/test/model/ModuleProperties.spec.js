...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.ModuleProperties();
  });
  ...
  describe('ModuleProperties', function() {
    it('should create an instance of ModuleProperties', function() {
      // uncomment below and update the code to test ModuleProperties
      //var instance = new AutomationManagement.ModuleProperties();
      //expect(instance).to.be.a(AutomationManagement.ModuleProperties);
    });

    it('should have the property activityCount (base name: "activityCount")', function() {
    ...
    it('should have the property isComposite (base name: "isComposite")', function() {
      // uncomment below and update the code to test the property isComposite
      //var instance = new AutomationManagement.ModuleProperties();
      //expect(instance).to.be();
    });
