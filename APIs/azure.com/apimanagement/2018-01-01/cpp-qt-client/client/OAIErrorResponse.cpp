...
OAIPolicy_GetEntityTag_default_response_error OAIErrorResponse::getError() const {
    return m_error;
}
void OAIErrorResponse::setError(const OAIPolicy_GetEntityTag_default_response_error &error) {
    m_error = error;
    m_error_isSet = true;
}
