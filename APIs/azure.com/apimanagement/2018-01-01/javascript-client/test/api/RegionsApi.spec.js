...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.RegionsApi();
  });
  ...
  describe('RegionsApi', function() {
    describe('regionsListByService', function() {
      it('should call regionsListByService successfully', function(done) {
        //uncomment below and update the code to test regionsListByService
        //instance.regionsListByService(function(error) {
