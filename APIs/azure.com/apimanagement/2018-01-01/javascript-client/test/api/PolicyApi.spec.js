...
(function(root, factory) {
  ...
  describe('PolicyApi', function() {
    ...
    describe('policyGetEntityTag', function() {
      it('should call policyGetEntityTag successfully', function(done) {
        //uncomment below and update the code to test policyGetEntityTag
        //instance.policyGetEntityTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
