...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.PolicySnippetContract();
  });
  ...
  describe('PolicySnippetContract', function() {
    it('should create an instance of PolicySnippetContract', function() {
      // uncomment below and update the code to test PolicySnippetContract
      //var instance = new ApiManagementClient.PolicySnippetContract();
      //expect(instance).to.be.a(ApiManagementClient.PolicySnippetContract);
    });
