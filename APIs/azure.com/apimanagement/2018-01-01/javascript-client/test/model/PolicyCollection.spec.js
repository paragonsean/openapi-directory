...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.PolicyCollection();
  });
  ...
  describe('PolicyCollection', function() {
    it('should create an instance of PolicyCollection', function() {
      ...
      //var instance = new ApiManagementClient.PolicyCollection();
      //expect(instance).to.be.a(ApiManagementClient.PolicyCollection);
    });
