...
public class ErrorResponse {
  ...
  private PolicyGetEntityTagDefaultResponseError error;

  public ErrorResponse() {
  }

  public ErrorResponse error(PolicyGetEntityTagDefaultResponseError error) {
    this.error = error;
    return this;
  }
  ...
  public PolicyGetEntityTagDefaultResponseError getError() {
    return error;
  }

  public void setError(PolicyGetEntityTagDefaultResponseError error) {
    this.error = error;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        PolicyGetEntityTagDefaultResponseError.validateJsonElement(jsonObj.get("error"));
      }
  }
