...
public:
    ...
    QList<OAIErrorFieldContract> getDetails() const;
    void setDetails(const QList<OAIErrorFieldContract> &details);
...
private:
    ...
    QList<OAIErrorFieldContract> m_details;
