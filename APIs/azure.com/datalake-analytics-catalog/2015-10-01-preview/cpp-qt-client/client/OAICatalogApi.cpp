...
void OAICatalogApi::catalogCreateSecretCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT catalogCreateSecretSignal(output);
        Q_EMIT catalogCreateSecretSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT catalogCreateSecretSignalE(output, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT catalogCreateSecretSignalError(output, error_type, error_str);
...
void OAICatalogApi::catalogListAssemblies(const QString &database_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &top, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<QString> &expand, const ::OpenAPI::OptionalParam<QString> &select, const ::OpenAPI::OptionalParam<QString> &orderby, const ::OpenAPI::OptionalParam<bool> &count) {
...
void OAICatalogApi::catalogUpdateSecretCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT catalogUpdateSecretSignal(output);
        Q_EMIT catalogUpdateSecretSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT catalogUpdateSecretSignalE(output, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT catalogUpdateSecretSignalError(output, error_type, error_str);
