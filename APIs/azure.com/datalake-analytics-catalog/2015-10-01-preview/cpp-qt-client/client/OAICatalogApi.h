...
public:
    ...
    */
    virtual void catalogCreateSecret(const QString &database_name, const QString &secret_name, const QString &api_version, const OAIDataLakeAnalyticsCatalogSecretCreateOrUpdateParameters &parameters);

    /**
    * @param[in]  database_name QString [required]
    * @param[in]  api_version QString [required]
    */
    virtual void catalogDeleteAllSecrets(const QString &database_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void catalogDeleteSecret(const QString &database_name, const QString &secret_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void catalogGetSecret(const QString &database_name, const QString &secret_name, const QString &api_version);
    ...
    */
    virtual void catalogListAssemblies(const QString &database_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &select = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &orderby = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &count = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  parameters OAIDataLakeAnalyticsCatalogSecretCreateOrUpdateParameters [required]
    */
    virtual void catalogUpdateSecret(const QString &database_name, const QString &secret_name, const QString &api_version, const OAIDataLakeAnalyticsCatalogSecretCreateOrUpdateParameters &parameters);
...
Q_SIGNALS:
    ...
    void catalogCreateSecretSignal(OAIUSqlSecret summary);
    ...
    void catalogUpdateSecretSignal(OAIUSqlSecret summary);


    void catalogCreateSecretSignalFull(OAIHttpRequestWorker *worker, OAIUSqlSecret summary);
    ...
    void catalogUpdateSecretSignalFull(OAIHttpRequestWorker *worker, OAIUSqlSecret summary);

    Q_DECL_DEPRECATED_X("Use catalogCreateSecretSignalError() instead")
    void catalogCreateSecretSignalE(OAIUSqlSecret summary, QNetworkReply::NetworkError error_type, QString error_str);
    void catalogCreateSecretSignalError(OAIUSqlSecret summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void catalogUpdateSecretSignalE(OAIUSqlSecret summary, QNetworkReply::NetworkError error_type, QString error_str);
    void catalogUpdateSecretSignalError(OAIUSqlSecret summary, QNetworkReply::NetworkError error_type, const QString &error_str);
