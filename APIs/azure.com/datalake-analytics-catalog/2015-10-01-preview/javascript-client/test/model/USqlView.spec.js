...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataLakeAnalyticsCatalogManagementClient.USqlView();
  });
  ...
  describe('USqlView', function() {
    it('should create an instance of USqlView', function() {
      // uncomment below and update the code to test USqlView
      //var instance = new DataLakeAnalyticsCatalogManagementClient.USqlView();
      //expect(instance).to.be.a(DataLakeAnalyticsCatalogManagementClient.USqlView);
    });
