...
|**definition** | **String** | the definition of the table valued function. |  [optional] |
|**schemaName** | **String** | the name of the schema associated with this database. |  [optional] |
|**tvfName** | **String** | the name of the table valued function. |  [optional] |
