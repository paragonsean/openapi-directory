...
#ifndef OAIUSqlType_H
#define OAIUSqlType_H
...
class OAIUSqlType : public OAIObject {
public:
    OAIUSqlType();
    OAIUSqlType(QString json);
    ~OAIUSqlType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUSqlType)
