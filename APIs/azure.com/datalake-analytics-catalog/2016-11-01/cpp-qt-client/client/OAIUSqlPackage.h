...
#ifndef OAIUSqlPackage_H
#define OAIUSqlPackage_H
...
class OAIUSqlPackage : public OAIObject {
public:
    OAIUSqlPackage();
    OAIUSqlPackage(QString json);
    ~OAIUSqlPackage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUSqlPackage)

#endif // OAIUSqlPackage_H
