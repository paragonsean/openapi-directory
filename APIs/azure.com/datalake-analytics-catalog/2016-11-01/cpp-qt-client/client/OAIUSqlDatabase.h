...
#ifndef OAIUSqlDatabase_H
#define OAIUSqlDatabase_H
...
class OAIUSqlDatabase : public OAIObject {
public:
    OAIUSqlDatabase();
    OAIUSqlDatabase(QString json);
    ~OAIUSqlDatabase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUSqlDatabase)

#endif // OAIUSqlDatabase_H
