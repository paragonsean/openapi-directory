...
async def test_catalog_create_credential(client):
    """Test case for catalog_create_credential

    
    """
    parameters = {"password":"password","uri":"uri","userId":"userId"}
...
async def test_catalog_delete_credential(client):
...
async def test_catalog_get_package(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/schemas/{schema_name}/packages/{package_name}'.format(database_name='database_name_example', schema_name='schema_name_example', package_name='package_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_acls(client):
...
async def test_catalog_list_acls_by_database(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/acl'.format(database_name='database_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_packages(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/schemas/{schema_name}/packages'.format(database_name='database_name_example', schema_name='schema_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_table_fragments(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/schemas/{schema_name}/tables/{table_name}/tablefragments'.format(database_name='database_name_example', schema_name='schema_name_example', table_name='table_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_table_statistics_by_database(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/statistics'.format(database_name='database_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_table_statistics_by_database_and_schema(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/schemas/{schema_name}/statistics'.format(database_name='database_name_example', schema_name='schema_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_table_valued_functions_by_database(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/tablevaluedfunctions'.format(database_name='database_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_tables_by_database(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/tables'.format(database_name='database_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_list_views_by_database(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/views'.format(database_name='database_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_preview_table(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/schemas/{schema_name}/tables/{table_name}/previewrows'.format(database_name='database_name_example', schema_name='schema_name_example', table_name='table_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_preview_table_partition(client):
    ...
    response = await client.request(
        method='GET',
        path='/catalog/usql/databases/{database_name}/schemas/{schema_name}/tables/{table_name}/partitions/{partition_name}/previewrows'.format(database_name='database_name_example', schema_name='schema_name_example', table_name='table_name_example', partition_name='partition_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_catalog_update_credential(client):
    """Test case for catalog_update_credential

    
    """
    parameters = {"password":"password","newPassword":"newPassword","uri":"uri","userId":"userId"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Content-Type': 'application/json',
    }
