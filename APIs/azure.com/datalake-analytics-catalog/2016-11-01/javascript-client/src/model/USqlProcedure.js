...
/**
 * The USqlProcedure model module.
 * @module model/USqlProcedure
 * @version 2016-11-01
 */
class USqlProcedure {
    /**
     * Constructs a new <code>USqlProcedure</code>.
     * A Data Lake Analytics catalog U-SQL procedure item.
     * @alias module:model/USqlProcedure
     * @implements module:model/CatalogItem
     */
    constructor() { 
        CatalogItem.initialize(this);
        USqlProcedure.initialize(this);
    }
    ...
    /**
     * Constructs a <code>USqlProcedure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/USqlProcedure} obj Optional instance to populate.
     * @return {module:model/USqlProcedure} The populated <code>USqlProcedure</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new USqlProcedure();
            ...
            if (data.hasOwnProperty('procName')) {
                obj['procName'] = ApiClient.convertToType(data['procName'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>USqlProcedure</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>USqlProcedure</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['procName'] && !(typeof data['procName'] === 'string' || data['procName'] instanceof String)) {
            throw new Error("Expected the field `procName` to be a primitive type in the JSON string but got " + data['procName']);
        }
        // ensure the json data is a string
 ...
 */
USqlProcedure.prototype['databaseName'] = undefined;

/**
 * the defined query of the procedure.
 * @member {String} definition
 */
USqlProcedure.prototype['definition'] = undefined;

/**
 * the name of the procedure.
 * @member {String} procName
 */
USqlProcedure.prototype['procName'] = undefined;

/**
 * the name of the schema associated with this procedure and database.
 * @member {String} schemaName
 */
USqlProcedure.prototype['schemaName'] = undefined;

/**
 * the name of the Data Lake Analytics account.
 * @member {String} computeAccountName
 */
USqlProcedure.prototype['computeAccountName'] = undefined;

/**
 * the version of the catalog item.
 * @member {String} version
 */
USqlProcedure.prototype['version'] = undefined;
