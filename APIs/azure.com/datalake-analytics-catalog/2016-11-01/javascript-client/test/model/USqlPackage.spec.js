...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataLakeAnalyticsCatalogManagementClient.USqlPackage();
  });
  ...
  describe('USqlPackage', function() {
    it('should create an instance of USqlPackage', function() {
      // uncomment below and update the code to test USqlPackage
      //var instance = new DataLakeAnalyticsCatalogManagementClient.USqlPackage();
      //expect(instance).to.be.a(DataLakeAnalyticsCatalogManagementClient.USqlPackage);
    });
