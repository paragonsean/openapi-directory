...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataLakeAnalyticsCatalogManagementClient.ExternalTable();
  });
  ...
  describe('ExternalTable', function() {
    it('should create an instance of ExternalTable', function() {
      // uncomment below and update the code to test ExternalTable
      //var instance = new DataLakeAnalyticsCatalogManagementClient.ExternalTable();
      //expect(instance).to.be.a(DataLakeAnalyticsCatalogManagementClient.ExternalTable);
    });
