...
QString OAIDashboard::getLocation() const {
    return m_location;
}
void OAIDashboard::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDashboard::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDashboard::is_location_Valid() const{
...
OAIDashboardProperties OAIDashboard::getProperties() const {
    return m_properties;
}
void OAIDashboard::setProperties(const OAIDashboardProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIDashboard::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIDashboard::is_properties_Valid() const{
    return m_properties_isValid;
}

QMap<QString, QString> OAIDashboard::getTags() const {
    return m_tags;
}
void OAIDashboard::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDashboard::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDashboard::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIDashboard::getType() const {
    return m_type;
}
void OAIDashboard::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDashboard::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDashboard::is_type_Valid() const{
