...
import RestorePointProperties from './model/RestorePointProperties';
import RestorePointsApi from './api/RestorePointsApi';
...
export {
    ...
    /**
     * The CreateDatabaseRestorePointDefinition model constructor.
     * @property {module:model/CreateDatabaseRestorePointDefinition}
     */
    ...
    /**
     * The RestorePointListResult model constructor.
     * @property {module:model/RestorePointListResult}
     */
    RestorePointListResult,

    /**
     * The RestorePointProperties model constructor.
     * @property {module:model/RestorePointProperties}
     */
    RestorePointProperties,

    /**
    * The RestorePointsApi service constructor.
    * @property {module:api/RestorePointsApi}
    */
    RestorePointsApi
};
