...
QString OAIRestorePointProperties::getRestorePointLabel() const {
    return m_restore_point_label;
}
void OAIRestorePointProperties::setRestorePointLabel(const QString &restore_point_label) {
    m_restore_point_label = restore_point_label;
    m_restore_point_label_isSet = true;
}

bool OAIRestorePointProperties::is_restore_point_label_Set() const{
    return m_restore_point_label_isSet;
}

bool OAIRestorePointProperties::is_restore_point_label_Valid() const{
