...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAIApplicationSecurityGroups_UpdateTags_request [required]
    */
    virtual void applicationSecurityGroupsUpdateTags(const QString &resource_group_name, const QString &application_security_group_name, const QString &api_version, const QString &subscription_id, const OAIApplicationSecurityGroups_UpdateTags_request &parameters);
...
private:
    ...
    void applicationSecurityGroupsUpdateTagsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void applicationSecurityGroupsUpdateTagsSignal(OAIApplicationSecurityGroup summary);
    ...
    void applicationSecurityGroupsUpdateTagsSignalFull(OAIHttpRequestWorker *worker, OAIApplicationSecurityGroup summary);
    ...
    Q_DECL_DEPRECATED_X("Use applicationSecurityGroupsUpdateTagsSignalError() instead")
    void applicationSecurityGroupsUpdateTagsSignalE(OAIApplicationSecurityGroup summary, QNetworkReply::NetworkError error_type, QString error_str);
    void applicationSecurityGroupsUpdateTagsSignalError(OAIApplicationSecurityGroup summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use applicationSecurityGroupsUpdateTagsSignalErrorFull() instead")
    void applicationSecurityGroupsUpdateTagsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void applicationSecurityGroupsUpdateTagsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
