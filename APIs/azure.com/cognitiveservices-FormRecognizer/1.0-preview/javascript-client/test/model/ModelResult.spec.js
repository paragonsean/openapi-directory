...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FormRecognizerClient.ModelResult();
  });
  ...
  describe('ModelResult', function() {
    it('should create an instance of ModelResult', function() {
      // uncomment below and update the code to test ModelResult
      //var instance = new FormRecognizerClient.ModelResult();
      //expect(instance).to.be.a(FormRecognizerClient.ModelResult);
    });
