...
class ErrorResponse {
     ...
     * @param error {module:model/ErrorInformation} 
     */
    constructor(error) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = ErrorInformation.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['error']) { // data not null
          ErrorInformation.validateJSON(data['error']);
        }
...
/**
 * @member {module:model/ErrorInformation} error
 */
