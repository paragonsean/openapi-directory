...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FormRecognizerClient.ModelInfo();
  });
  ...
  describe('ModelInfo', function() {
    it('should create an instance of ModelInfo', function() {
      // uncomment below and update the code to test ModelInfo
      //var instance = new FormRecognizerClient.ModelInfo();
      //expect(instance).to.be.a(FormRecognizerClient.ModelInfo);
    });
