...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FormRecognizerClient.TextLine();
  });
  ...
  describe('TextLine', function() {
    it('should create an instance of TextLine', function() {
      // uncomment below and update the code to test TextLine
      //var instance = new FormRecognizerClient.TextLine();
      //expect(instance).to.be.a(FormRecognizerClient.TextLine);
    });
