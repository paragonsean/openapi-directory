...
class TrainSourceFilter(Model):
    ...
    def __init__(self, include_sub_folders: bool=False, prefix: str=None):
    ...
    def prefix(self, prefix):
        ...
        :type prefix: str
        """
        if prefix is not None and len(prefix) > 1024:
            raise ValueError("Invalid value for `prefix`, length must be less than or equal to `1024`")
