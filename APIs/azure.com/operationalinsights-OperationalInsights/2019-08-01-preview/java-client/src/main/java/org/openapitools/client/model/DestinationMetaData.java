...
public class DestinationMetaData {
  ...
  public DestinationMetaData eventHubName(String eventHubName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventHubName, destinationMetaData.eventHubName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventHubName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DestinationMetaData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DestinationMetaData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DestinationMetaData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DestinationMetaData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
