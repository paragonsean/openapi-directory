...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureLogAnalytics.WorkspacePurgeBody();
  });
  ...
  describe('WorkspacePurgeBody', function() {
    it('should create an instance of WorkspacePurgeBody', function() {
      // uncomment below and update the code to test WorkspacePurgeBody
      //var instance = new AzureLogAnalytics.WorkspacePurgeBody();
      //expect(instance).to.be.a(AzureLogAnalytics.WorkspacePurgeBody);
    });
