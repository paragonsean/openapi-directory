...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureLogAnalytics.WorkspacePurgeBodyFilters();
  });
  ...
  describe('WorkspacePurgeBodyFilters', function() {
    it('should create an instance of WorkspacePurgeBodyFilters', function() {
      // uncomment below and update the code to test WorkspacePurgeBodyFilters
      //var instance = new AzureLogAnalytics.WorkspacePurgeBodyFilters();
      //expect(instance).to.be.a(AzureLogAnalytics.WorkspacePurgeBodyFilters);
    });
