...
QMap<QString, QString> OAIProxyResource::getTags() const {
    return m_tags;
}
void OAIProxyResource::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIProxyResource::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIProxyResource::is_tags_Valid() const{
