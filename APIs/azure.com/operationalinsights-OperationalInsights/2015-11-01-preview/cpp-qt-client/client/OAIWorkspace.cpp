...
QString OAIWorkspace::getETag() const {
    return m_e_tag;
}
void OAIWorkspace::setETag(const QString &e_tag) {
    m_e_tag = e_tag;
    m_e_tag_isSet = true;
}

bool OAIWorkspace::is_e_tag_Set() const{
    return m_e_tag_isSet;
}

bool OAIWorkspace::is_e_tag_Valid() const{
