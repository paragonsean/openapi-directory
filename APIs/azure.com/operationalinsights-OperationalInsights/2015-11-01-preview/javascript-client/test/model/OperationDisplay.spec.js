...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureLogAnalytics.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureLogAnalytics.OperationDisplay();
      //expect(instance).to.be.a(AzureLogAnalytics.OperationDisplay);
    });
