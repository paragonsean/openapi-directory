...
<a id="baselinesList_0"></a>
# **baselinesList_0**
> MetricBaselinesResponse baselinesList_0(resourceUri, apiVersion, metricnames, metricnamespace, timespan, interval, aggregation, sensitivities, $filter, resultType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      MetricBaselinesResponse result = apiInstance.baselinesList_0(resourceUri, apiVersion, metricnames, metricnamespace, timespan, interval, aggregation, sensitivities, $filter, resultType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MetricApi#baselinesList_0");
