...
export default class BaselineApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the baselinesList operation.
     * @callback module:api/BaselineApi~baselinesListCallback
     ...
     * @param {module:api/BaselineApi~baselinesListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MetricBaselinesResponse}
     */
    baselinesList(resourceUri, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'resourceUri' is set
      if (resourceUri === undefined || resourceUri === null) {
        throw new Error("Missing the required parameter 'resourceUri' when calling baselinesList");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling baselinesList");
      }
