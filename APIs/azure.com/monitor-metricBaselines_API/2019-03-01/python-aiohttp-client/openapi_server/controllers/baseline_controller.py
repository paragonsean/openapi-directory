...
async def baselines_list(request: web.Request, resource_uri, api_version, metricnames=None, metricnamespace=None, timespan=None, interval=None, aggregation=None, sensitivities=None, filter=None, result_type=None) -> web.Response:
    """baselines_list
