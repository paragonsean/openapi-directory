...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizationManagementClient.RoleAssignmentFilter();
  });
  ...
  describe('RoleAssignmentFilter', function() {
    it('should create an instance of RoleAssignmentFilter', function() {
      // uncomment below and update the code to test RoleAssignmentFilter
      //var instance = new AuthorizationManagementClient.RoleAssignmentFilter();
      //expect(instance).to.be.a(AuthorizationManagementClient.RoleAssignmentFilter);
    });
