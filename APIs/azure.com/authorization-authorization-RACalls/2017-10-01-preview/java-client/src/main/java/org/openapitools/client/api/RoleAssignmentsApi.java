...
public class RoleAssignmentsApi {
     ...
     * @param roleAssignmentId The ID of the role assignment to create. (required)
     * @param apiVersion The API version to use for this operation. (required)
     * @param parameters Parameters for the role assignment. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call roleAssignmentsCreateByIdCall(String roleAssignmentId, String apiVersion, RoleAssignmentCreateParameters parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/{roleAssignmentId}"
            .replace("{" + "roleAssignmentId" + "}", localVarApiClient.escapeString(roleAssignmentId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call roleAssignmentsCreateByIdValidateBeforeCall(String roleAssignmentId, String apiVersion, RoleAssignmentCreateParameters parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'roleAssignmentId' is set
        if (roleAssignmentId == null) {
            throw new ApiException("Missing the required parameter 'roleAssignmentId' when calling roleAssignmentsCreateById(Async)");
        }
        ...
        return roleAssignmentsCreateByIdCall(roleAssignmentId, apiVersion, parameters, _callback);
     ...
     */
    public RoleAssignment roleAssignmentsCreateById(String roleAssignmentId, String apiVersion, RoleAssignmentCreateParameters parameters) throws ApiException {
        ApiResponse<RoleAssignment> localVarResp = roleAssignmentsCreateByIdWithHttpInfo(roleAssignmentId, apiVersion, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RoleAssignment> roleAssignmentsCreateByIdWithHttpInfo(String roleAssignmentId, String apiVersion, RoleAssignmentCreateParameters parameters) throws ApiException {
        okhttp3.Call localVarCall = roleAssignmentsCreateByIdValidateBeforeCall(roleAssignmentId, apiVersion, parameters, null);
        Type localVarReturnType = new TypeToken<RoleAssignment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call roleAssignmentsCreateByIdAsync(String roleAssignmentId, String apiVersion, RoleAssignmentCreateParameters parameters, final ApiCallback<RoleAssignment> _callback) throws ApiException {

        okhttp3.Call localVarCall = roleAssignmentsCreateByIdValidateBeforeCall(roleAssignmentId, apiVersion, parameters, _callback);
        Type localVarReturnType = new TypeToken<RoleAssignment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param roleAssignmentId The ID of the role assignment to delete. (required)
     * @param apiVersion The API version to use for this operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call roleAssignmentsDeleteByIdCall(String roleAssignmentId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call roleAssignmentsDeleteByIdValidateBeforeCall(String roleAssignmentId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'roleAssignmentId' is set
        if (roleAssignmentId == null) {
            throw new ApiException("Missing the required parameter 'roleAssignmentId' when calling roleAssignmentsDeleteById(Async)");
        }
        ...
        return roleAssignmentsDeleteByIdCall(roleAssignmentId, apiVersion, _callback);
     ...
     */
    public RoleAssignment roleAssignmentsDeleteById(String roleAssignmentId, String apiVersion) throws ApiException {
        ApiResponse<RoleAssignment> localVarResp = roleAssignmentsDeleteByIdWithHttpInfo(roleAssignmentId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RoleAssignment> roleAssignmentsDeleteByIdWithHttpInfo(String roleAssignmentId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = roleAssignmentsDeleteByIdValidateBeforeCall(roleAssignmentId, apiVersion, null);
        Type localVarReturnType = new TypeToken<RoleAssignment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call roleAssignmentsDeleteByIdAsync(String roleAssignmentId, String apiVersion, final ApiCallback<RoleAssignment> _callback) throws ApiException {

        okhttp3.Call localVarCall = roleAssignmentsDeleteByIdValidateBeforeCall(roleAssignmentId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<RoleAssignment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param roleAssignmentId The ID of the role assignment to get. (required)
     * @param apiVersion The API version to use for this operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call roleAssignmentsGetByIdCall(String roleAssignmentId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call roleAssignmentsGetByIdValidateBeforeCall(String roleAssignmentId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'roleAssignmentId' is set
        if (roleAssignmentId == null) {
            throw new ApiException("Missing the required parameter 'roleAssignmentId' when calling roleAssignmentsGetById(Async)");
        }
        ...
        return roleAssignmentsGetByIdCall(roleAssignmentId, apiVersion, _callback);
     ...
     */
    public RoleAssignment roleAssignmentsGetById(String roleAssignmentId, String apiVersion) throws ApiException {
        ApiResponse<RoleAssignment> localVarResp = roleAssignmentsGetByIdWithHttpInfo(roleAssignmentId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RoleAssignment> roleAssignmentsGetByIdWithHttpInfo(String roleAssignmentId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = roleAssignmentsGetByIdValidateBeforeCall(roleAssignmentId, apiVersion, null);
        Type localVarReturnType = new TypeToken<RoleAssignment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call roleAssignmentsGetByIdAsync(String roleAssignmentId, String apiVersion, final ApiCallback<RoleAssignment> _callback) throws ApiException {

        okhttp3.Call localVarCall = roleAssignmentsGetByIdValidateBeforeCall(roleAssignmentId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<RoleAssignment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
