...
async def role_assignments_create_by_id(request: web.Request, role_assignment_id, api_version, parameters) -> web.Response:
...
async def role_assignments_delete_by_id(request: web.Request, role_assignment_id, api_version) -> web.Response:
...
async def role_assignments_get_by_id(request: web.Request, role_assignment_id, api_version) -> web.Response:
