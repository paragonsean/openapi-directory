...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstanceMetadataClient.Ipv4Properties();
  });
  ...
  describe('Ipv4Properties', function() {
    it('should create an instance of Ipv4Properties', function() {
      // uncomment below and update the code to test Ipv4Properties
      //var instance = new InstanceMetadataClient.Ipv4Properties();
      //expect(instance).to.be.a(InstanceMetadataClient.Ipv4Properties);
    });
