...
public:
    ...
    QList<OAITagsProperties> getTagsList() const;
    void setTagsList(const QList<OAITagsProperties> &tags_list);
...
private:
    ...
    QList<OAITagsProperties> m_tags_list;
