...
OAIStorageProfile OAICompute::getStorageProfile() const {
    return m_storage_profile;
}
void OAICompute::setStorageProfile(const OAIStorageProfile &storage_profile) {
    m_storage_profile = storage_profile;
    m_storage_profile_isSet = true;
}

bool OAICompute::is_storage_profile_Set() const{
    return m_storage_profile_isSet;
}

bool OAICompute::is_storage_profile_Valid() const{
...
QList<OAITagsProperties> OAICompute::getTagsList() const {
    return m_tags_list;
}
void OAICompute::setTagsList(const QList<OAITagsProperties> &tags_list) {
    m_tags_list = tags_list;
    m_tags_list_isSet = true;
}

bool OAICompute::is_tags_list_Set() const{
    return m_tags_list_isSet;
}

bool OAICompute::is_tags_list_Valid() const{
