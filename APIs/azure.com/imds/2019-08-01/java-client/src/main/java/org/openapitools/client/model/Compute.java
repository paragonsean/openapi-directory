...
import org.openapitools.client.model.TagsProperties;
...
public class Compute {
  ...
  private List<TagsProperties> tagsList = new ArrayList<>();
  ...
  public Compute storageProfile(StorageProfile storageProfile) {
  ...
  public Compute tagsList(List<TagsProperties> tagsList) {
    this.tagsList = tagsList;
    return this;
  }

  public Compute addTagsListItem(TagsProperties tagsListItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<TagsProperties> getTagsList() {
    return tagsList;
  }

  public void setTagsList(List<TagsProperties> tagsList) {
    this.tagsList = tagsList;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.azEnvironment, compute.azEnvironment) &&
        ...
        Objects.equals(this.storageProfile, compute.storageProfile) &&
        Objects.equals(this.subscriptionId, compute.subscriptionId) &&
        Objects.equals(this.tags, compute.tags) &&
        Objects.equals(this.tagsList, compute.tagsList) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(azEnvironment, location, name, offer, osType, placementGroupId, plan, platformFaultDomain, platformUpdateDomain, provider, publicKeys, publisher, resourceGroupName, resourceId, sku, storageProfile, subscriptionId, tags, tagsList, version, vmId, vmScaleSetName, vmSize, zone);
  }
      ...
      if (jsonObj.get("tagsList") != null && !jsonObj.get("tagsList").isJsonNull()) {
        ...
        if (jsonArraytagsList != null) {
          ...
          for (int i = 0; i < jsonArraytagsList.size(); i++) {
            TagsProperties.validateJsonElement(jsonArraytagsList.get(i));
          };
        }
      }
