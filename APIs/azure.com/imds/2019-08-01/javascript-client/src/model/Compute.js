...
import TagsProperties from './TagsProperties';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tagsList')) {
                obj['tagsList'] = ApiClient.convertToType(data['tagsList'], [TagsProperties]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['tagsList']) { // data not null
            ...
            for (const item of data['tagsList']) {
                TagsProperties.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/TagsProperties>} tagsList
 */
Compute.prototype['tagsList'] = undefined;
