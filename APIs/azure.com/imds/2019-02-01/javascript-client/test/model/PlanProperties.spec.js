...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstanceMetadataClient.PlanProperties();
  });
  ...
  describe('PlanProperties', function() {
    it('should create an instance of PlanProperties', function() {
      ...
      //var instance = new InstanceMetadataClient.PlanProperties();
      //expect(instance).to.be.a(InstanceMetadataClient.PlanProperties);
    });
