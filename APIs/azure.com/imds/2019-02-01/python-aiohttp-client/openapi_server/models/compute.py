...
class Compute(Model):
    ...
    def custom_data(self):
        """Gets the custom_data of this Compute.

        This is the base64 encoded custom data for the running VM.

        :return: The custom_data of this Compute.
        :rtype: str
        """
    ...
    def custom_data(self, custom_data):
        """Sets the custom_data of this Compute.
