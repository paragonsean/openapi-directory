...
QString OAIPlanProperties::getProduct() const {
    return m_product;
}
void OAIPlanProperties::setProduct(const QString &product) {
    m_product = product;
    m_product_isSet = true;
}

bool OAIPlanProperties::is_product_Set() const{
    return m_product_isSet;
}

bool OAIPlanProperties::is_product_Valid() const{
    return m_product_isValid;
}

QString OAIPlanProperties::getPublisher() const {
    return m_publisher;
}
void OAIPlanProperties::setPublisher(const QString &publisher) {
    m_publisher = publisher;
    m_publisher_isSet = true;
}

bool OAIPlanProperties::is_publisher_Set() const{
    return m_publisher_isSet;
}

bool OAIPlanProperties::is_publisher_Valid() const{
