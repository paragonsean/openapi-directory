...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstanceMetadataClient.ManagedDisk();
  });
  ...
  describe('ManagedDisk', function() {
    it('should create an instance of ManagedDisk', function() {
      // uncomment below and update the code to test ManagedDisk
      //var instance = new InstanceMetadataClient.ManagedDisk();
      //expect(instance).to.be.a(InstanceMetadataClient.ManagedDisk);
    });
