...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstanceMetadataClient.EncryptionSettings();
  });
  ...
  describe('EncryptionSettings', function() {
    it('should create an instance of EncryptionSettings', function() {
      ...
      //var instance = new InstanceMetadataClient.EncryptionSettings();
      //expect(instance).to.be.a(InstanceMetadataClient.EncryptionSettings);
    });
