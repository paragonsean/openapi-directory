...
class Compute(Model):
    ...
    def __init__(self, az_environment: str=None, location: str=None, name: str=None, offer: str=None, os_type: str=None, placement_group_id: str=None, plan: PlanProperties=None, platform_fault_domain: str=None, platform_update_domain: str=None, provider: str=None, public_keys: List[PublicKeysProperties]=None, publisher: str=None, resource_group_name: str=None, resource_id: str=None, sku: str=None, storage_profile: StorageProfile=None, subscription_id: str=None, tags: str=None, tags_list: List[TagsProperties]=None, version: str=None, vm_id: str=None, vm_scale_set_name: str=None, vm_size: str=None, zone: str=None):
        ...
        :param tags_list: The tags_list of this Compute.
    ...
    @property
    def tags_list(self):
        """Gets the tags_list of this Compute.

        This is the list of tags for your VM formatted as a JSON array for easier programmatic parsing.

        :return: The tags_list of this Compute.
        :rtype: List[TagsProperties]
        """
        return self._tags_list

    @tags_list.setter
    def tags_list(self, tags_list):
        """Sets the tags_list of this Compute.

        This is the list of tags for your VM formatted as a JSON array for easier programmatic parsing.

        :param tags_list: The tags_list of this Compute.
        :type tags_list: List[TagsProperties]
        """
