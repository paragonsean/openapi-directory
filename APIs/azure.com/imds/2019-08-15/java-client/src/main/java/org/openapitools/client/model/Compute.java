...
public class Compute {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(azEnvironment, location, name, offer, osType, placementGroupId, plan, platformFaultDomain, platformUpdateDomain, provider, publicKeys, publisher, resourceGroupName, resourceId, sku, storageProfile, subscriptionId, tags, version, vmId, vmScaleSetName, vmSize, zone);
  }
