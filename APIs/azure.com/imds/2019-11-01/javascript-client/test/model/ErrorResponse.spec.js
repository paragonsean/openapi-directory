...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstanceMetadataClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new InstanceMetadataClient.ErrorResponse();
      //expect(instance).to.be.a(InstanceMetadataClient.ErrorResponse);
    });
