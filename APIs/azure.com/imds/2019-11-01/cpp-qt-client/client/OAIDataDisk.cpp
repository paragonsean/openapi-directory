...
QString OAIDataDisk::getCaching() const {
    return m_caching;
}
void OAIDataDisk::setCaching(const QString &caching) {
    m_caching = caching;
...
QString OAIDataDisk::getCreateOption() const {
    return m_create_option;
}
void OAIDataDisk::setCreateOption(const QString &create_option) {
...
QString OAIDataDisk::getDiskSizeGb() const {
    return m_disk_size_gb;
}
void OAIDataDisk::setDiskSizeGb(const QString &disk_size_gb) {
...
OAIDiskImage OAIDataDisk::getImage() const {
    return m_image;
}
void OAIDataDisk::setImage(const OAIDiskImage &image) {
    m_image = image;
    m_image_isSet = true;
}
...
QString OAIDataDisk::getLun() const {
    return m_lun;
}
void OAIDataDisk::setLun(const QString &lun) {
    m_lun = lun;
    m_lun_isSet = true;
}
...
OAIManagedDisk OAIDataDisk::getManagedDisk() const {
    return m_managed_disk;
}
void OAIDataDisk::setManagedDisk(const OAIManagedDisk &managed_disk) {
...
QString OAIDataDisk::getWriteAcceleratorEnabled() const {
    return m_write_accelerator_enabled;
}
void OAIDataDisk::setWriteAcceleratorEnabled(const QString &write_accelerator_enabled) {
