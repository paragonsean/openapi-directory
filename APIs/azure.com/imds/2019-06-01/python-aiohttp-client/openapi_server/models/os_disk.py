...
class OsDisk(Model):
    ...
    def __init__(self, caching: str=None, create_option: str=None, disk_size_gb: str=None, encryption_settings: EncryptionSettings=None, image: DiskImage=None, managed_disk: ManagedDisk=None, name: str=None, os_type: str=None, vhd: VirtualHardDisk=None, write_accelerator_enabled: str=None):
