# SqlManagementClient.DatabaseSchemasApi
...
let apiInstance = new SqlManagementClient.DatabaseSchemasApi();
...
apiInstance.databaseSchemasGet(resourceGroupName, serverName, databaseName, schemaName, subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> DatabaseSchemaListResult databaseSchemasListByDatabase(resourceGroupName, serverName, databaseName, subscriptionId, apiVersion, opts)
...
apiInstance.databaseSchemasListByDatabase(resourceGroupName, serverName, databaseName, subscriptionId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
