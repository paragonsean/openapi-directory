...
class DatabaseSchema {
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseSchema</code>.
     */
 ...
 * @member {String} id
 */
DatabaseSchema.prototype['id'] = undefined;

/**
 * Resource name.
 * @member {String} name
 */
DatabaseSchema.prototype['name'] = undefined;

/**
 * Resource type.
 * @member {String} type
 */
DatabaseSchema.prototype['type'] = undefined;
