...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("logProfilesUpdate", defaultConf);
    _serverIndices.insert("logProfilesUpdate", 0);
}
...
void OAIDefaultApi::logProfilesUpdate(const QString &subscription_id, const QString &log_profile_name, const QString &api_version, const OAILogProfileResourcePatch &log_profiles_resource) {
    QString fullPath = QString(_serverConfigs["logProfilesUpdate"][_serverIndices.value("logProfilesUpdate")].URL()+"/subscriptions/{subscriptionId}/providers/microsoft.insights/logprofiles/{logProfileName}");
...

    {
        ...
        QByteArray output = log_profiles_resource.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::logProfilesUpdateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::logProfilesUpdateCallback);
...
void OAIDefaultApi::logProfilesUpdateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT logProfilesUpdateSignal(output);
        Q_EMIT logProfilesUpdateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT logProfilesUpdateSignalE(output, error_type, error_str);
        Q_EMIT logProfilesUpdateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT logProfilesUpdateSignalError(output, error_type, error_str);
        Q_EMIT logProfilesUpdateSignalErrorFull(worker, error_type, error_str);
    }
}
