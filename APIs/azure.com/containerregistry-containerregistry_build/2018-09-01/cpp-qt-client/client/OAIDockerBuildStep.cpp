...
QList<OAIArgument> OAIDockerBuildStep::getArguments() const {
    return m_arguments;
}
void OAIDockerBuildStep::setArguments(const QList<OAIArgument> &arguments) {
    m_arguments = arguments;
    m_arguments_isSet = true;
}

bool OAIDockerBuildStep::is_arguments_Set() const{
    return m_arguments_isSet;
}

bool OAIDockerBuildStep::is_arguments_Valid() const{
...
QString OAIDockerBuildStep::getTarget() const {
    return m_target;
}
void OAIDockerBuildStep::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIDockerBuildStep::is_target_Set() const{
    return m_target_isSet;
}

bool OAIDockerBuildStep::is_target_Valid() const{
...
QString OAIDockerBuildStep::getContextAccessToken() const {
    return m_context_access_token;
}
void OAIDockerBuildStep::setContextAccessToken(const QString &context_access_token) {
    m_context_access_token = context_access_token;
    m_context_access_token_isSet = true;
}

bool OAIDockerBuildStep::is_context_access_token_Set() const{
    return m_context_access_token_isSet;
}

bool OAIDockerBuildStep::is_context_access_token_Valid() const{
...
bool OAIDockerBuildStep::isValid() const {
    ...
    return m_docker_file_path_isValid && true;
}
