...
public:
    ...
    * @param[in]  registry_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  run_request OAIRunRequest [required]
    */
    virtual void registriesScheduleRun(const QString &subscription_id, const QString &resource_group_name, const QString &registry_name, const QString &api_version, const OAIRunRequest &run_request);
...
private:
    ...
    void registriesScheduleRunCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void registriesGetBuildSourceUploadUrlSignal(OAISourceUploadDefinition summary);
    void registriesScheduleRunSignal(OAIRun summary);


    void registriesGetBuildSourceUploadUrlSignalFull(OAIHttpRequestWorker *worker, OAISourceUploadDefinition summary);
    void registriesScheduleRunSignalFull(OAIHttpRequestWorker *worker, OAIRun summary);
    ...
    Q_DECL_DEPRECATED_X("Use registriesScheduleRunSignalError() instead")
    void registriesScheduleRunSignalE(OAIRun summary, QNetworkReply::NetworkError error_type, QString error_str);
    void registriesScheduleRunSignalError(OAIRun summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use registriesScheduleRunSignalErrorFull() instead")
    void registriesScheduleRunSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void registriesScheduleRunSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
