...
class SourceTrigger {
     ...
     */
    constructor(name, sourceRepository, sourceTriggerEvents) { 
        
        SourceTrigger.initialize(this, name, sourceRepository, sourceTriggerEvents);
    }
     ...
     */
    static initialize(obj, name, sourceRepository, sourceTriggerEvents) { 
        obj['name'] = name;
...
SourceTrigger.RequiredProperties = ["name", "sourceRepository", "sourceTriggerEvents"];
