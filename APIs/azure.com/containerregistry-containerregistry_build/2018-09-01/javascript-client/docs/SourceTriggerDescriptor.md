# ContainerRegistryManagementClient.SourceTriggerDescriptor
...
**eventType** | **String** | The event type of the trigger. | [optional] 
**id** | **String** | The unique ID of the trigger. | [optional] 
**providerType** | **String** | The source control provider type. | [optional] 
**pullRequestId** | **String** | The unique ID that identifies pull request. | [optional] 
