...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.Task();
  });
  ...
  describe('Task', function() {
    it('should create an instance of Task', function() {
      ...
      //var instance = new ContainerRegistryManagementClient.Task();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.Task);
    });
