...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.DockerBuildStep();
  });
  ...
  describe('DockerBuildStep', function() {
    it('should create an instance of DockerBuildStep', function() {
      // uncomment below and update the code to test DockerBuildStep
      //var instance = new ContainerRegistryManagementClient.DockerBuildStep();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.DockerBuildStep);
    });
