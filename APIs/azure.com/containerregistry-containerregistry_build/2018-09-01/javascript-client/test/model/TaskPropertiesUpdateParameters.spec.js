...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.TaskPropertiesUpdateParameters();
  });
  ...
  describe('TaskPropertiesUpdateParameters', function() {
    it('should create an instance of TaskPropertiesUpdateParameters', function() {
      // uncomment below and update the code to test TaskPropertiesUpdateParameters
      //var instance = new ContainerRegistryManagementClient.TaskPropertiesUpdateParameters();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.TaskPropertiesUpdateParameters);
    });
