...
public class RunRequest {
  ...
  public RunRequest isArchiveEnabled(Boolean isArchiveEnabled) {
  ...
  public RunRequest type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isArchiveEnabled, runRequest.isArchiveEnabled) &&
        Objects.equals(this.type, runRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isArchiveEnabled, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      switch (discriminatorValue) {
        case "DockerBuildRequest":
          DockerBuildRequest.validateJsonElement(jsonElement);
          break;
        case "EncodedTaskRunRequest":
          EncodedTaskRunRequest.validateJsonElement(jsonElement);
          break;
        case "FileTaskRunRequest":
          FileTaskRunRequest.validateJsonElement(jsonElement);
          break;
        case "TaskRunRequest":
          TaskRunRequest.validateJsonElement(jsonElement);
          break;
        default:
