...
public class Example {
  public static void main(String[] args) {
    ...
    String registryName = "registryName_example"; // String | The name of the container registry.
    String apiVersion = "apiVersion_example"; // String | The client API version.
    RunRequest runRequest = new RunRequest(); // RunRequest | The parameters of a run that needs to scheduled.
    try {
      Run result = apiInstance.registriesScheduleRun(subscriptionId, resourceGroupName, registryName, apiVersion, runRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RegistriesApi#registriesScheduleRun");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
