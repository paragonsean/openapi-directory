...
async def test_tasks_create(client):
    ...
    """
    task_create_parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"properties":{"agentConfiguration":{"cpu":0},"credentials":{"customRegistries":{"key":{"password":{"type":"Opaque","value":"value"},"identity":"identity","userName":{"type":"Opaque","value":"value"}}},"sourceRegistry":{"loginMode":"None"}},"step":{"baseImageDependencies":[{"registry":"registry","digest":"digest","tag":"tag","repository":"repository","type":"BuildTime"},{"registry":"registry","digest":"digest","tag":"tag","repository":"repository","type":"BuildTime"}],"contextPath":"contextPath","type":"Docker","contextAccessToken":"contextAccessToken"},"provisioningState":"Creating","trigger":{"timerTriggers":[{"schedule":"schedule","name":"name","status":"Enabled"},{"schedule":"schedule","name":"name","status":"Enabled"}],"sourceTriggers":[{"sourceRepository":{"sourceControlAuthProperties":{"expiresIn":6,"scope":"scope","tokenType":"PAT","refreshToken":"refreshToken","token":"token"},"sourceControlType":"Github","branch":"branch","repositoryUrl":"repositoryUrl"},"sourceTriggerEvents":["commit","commit"],"name":"name","status":"Enabled"},{"sourceRepository":{"sourceControlAuthProperties":{"expiresIn":6,"scope":"scope","tokenType":"PAT","refreshToken":"refreshToken","token":"token"},"sourceControlType":"Github","branch":"branch","repositoryUrl":"repositoryUrl"},"sourceTriggerEvents":["commit","commit"],"name":"name","status":"Enabled"}],"baseImageTrigger":{"updateTriggerEndpoint":"updateTriggerEndpoint","baseImageTriggerType":"All","name":"name","updateTriggerPayloadType":"Default","status":"Enabled"}},"creationDate":"2000-01-23T04:56:07.000+00:00","platform":{"os":"Windows","variant":"v6","architecture":"amd64"},"timeout":2582,"status":"Disabled"}}
...
async def test_tasks_update(client):
    ...
    """
    task_update_parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"properties":{"agentConfiguration":{"cpu":0},"credentials":{"customRegistries":{"key":{"password":{"type":"Opaque","value":"value"},"identity":"identity","userName":{"type":"Opaque","value":"value"}}},"sourceRegistry":{"loginMode":"None"}},"step":{"contextPath":"contextPath","type":"Docker","contextAccessToken":"contextAccessToken"},"trigger":{"timerTriggers":[{"schedule":"schedule","name":"name","status":"Enabled"},{"schedule":"schedule","name":"name","status":"Enabled"}],"sourceTriggers":[{"sourceRepository":{"sourceControlAuthProperties":{"expiresIn":6,"scope":"scope","tokenType":"PAT","refreshToken":"refreshToken","token":"token"},"sourceControlType":"Github","branch":"branch","repositoryUrl":"repositoryUrl"},"sourceTriggerEvents":["commit","commit"],"name":"name","status":"Enabled"},{"sourceRepository":{"sourceControlAuthProperties":{"expiresIn":6,"scope":"scope","tokenType":"PAT","refreshToken":"refreshToken","token":"token"},"sourceControlType":"Github","branch":"branch","repositoryUrl":"repositoryUrl"},"sourceTriggerEvents":["commit","commit"],"name":"name","status":"Enabled"}],"baseImageTrigger":{"updateTriggerEndpoint":"updateTriggerEndpoint","baseImageTriggerType":"All","name":"name","updateTriggerPayloadType":"Default","status":"Enabled"}},"platform":{"os":"Windows","variant":"v6","architecture":"amd64"},"timeout":0,"status":"Disabled"},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
