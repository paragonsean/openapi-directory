...
export default class TasksApi {
    ...
    */
     ...
     * @param {module:model/Task} taskCreateParameters The parameters for creating a task.
     ...
     */
    tasksCreate(subscriptionId, resourceGroupName, registryName, apiVersion, taskName, taskCreateParameters, callback) {
      let postBody = taskCreateParameters;
      ...
      if (taskCreateParameters === undefined || taskCreateParameters === null) {
        throw new Error("Missing the required parameter 'taskCreateParameters' when calling tasksCreate");
      }
