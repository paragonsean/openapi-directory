...
export default class TaskRunsApi {
    ...
    */
     ...
     * @param {String} apiVersion The client API version.
     * @param {String} taskRunName The task run name.
     * @param {module:model/TaskRunUpdateParameters} updateParameters The parameters for updating a task run.
     ...
     * data is of type: {@link module:model/TaskRun}
     */
    taskRunsUpdate(subscriptionId, resourceGroupName, registryName, apiVersion, taskRunName, updateParameters, callback) {
      ...
      if (updateParameters === undefined || updateParameters === null) {
        throw new Error("Missing the required parameter 'updateParameters' when calling taskRunsUpdate");
      }
