...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.AuthInfoUpdateParameters();
  });
  ...
  describe('AuthInfoUpdateParameters', function() {
    it('should create an instance of AuthInfoUpdateParameters', function() {
      // uncomment below and update the code to test AuthInfoUpdateParameters
      //var instance = new ContainerRegistryManagementClient.AuthInfoUpdateParameters();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.AuthInfoUpdateParameters);
    });
