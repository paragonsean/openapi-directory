...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.Run();
  });
  ...
  describe('Run', function() {
    it('should create an instance of Run', function() {
      ...
      //var instance = new ContainerRegistryManagementClient.Run();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.Run);
    });
