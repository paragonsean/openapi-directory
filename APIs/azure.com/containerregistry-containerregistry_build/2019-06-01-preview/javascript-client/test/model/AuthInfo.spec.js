...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.AuthInfo();
  });
  ...
  describe('AuthInfo', function() {
    it('should create an instance of AuthInfo', function() {
      // uncomment below and update the code to test AuthInfo
      //var instance = new ContainerRegistryManagementClient.AuthInfo();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.AuthInfo);
    });
