...
void OAIRunProperties::initializeModel() {
    ...
    m_timer_trigger_isSet = false;
    m_timer_trigger_isValid = false;
...
void OAIRunProperties::fromJsonObject(QJsonObject json) {
    ...
    m_timer_trigger_isValid = ::OpenAPI::fromJsonValue(m_timer_trigger, json[QString("timerTrigger")]);
    m_timer_trigger_isSet = !json[QString("timerTrigger")].isNull() && m_timer_trigger_isValid;
...
QJsonObject OAIRunProperties::asJsonObject() const {
    ...
    if (m_timer_trigger.isSet()) {
        obj.insert(QString("timerTrigger"), ::OpenAPI::toJsonValue(m_timer_trigger));
    }
...
OAITimerTriggerDescriptor OAIRunProperties::getTimerTrigger() const {
    return m_timer_trigger;
}
void OAIRunProperties::setTimerTrigger(const OAITimerTriggerDescriptor &timer_trigger) {
    m_timer_trigger = timer_trigger;
    m_timer_trigger_isSet = true;
}

bool OAIRunProperties::is_timer_trigger_Set() const{
    return m_timer_trigger_isSet;
}

bool OAIRunProperties::is_timer_trigger_Valid() const{
    return m_timer_trigger_isValid;
}

QString OAIRunProperties::getUpdateTriggerToken() const {
    return m_update_trigger_token;
}
void OAIRunProperties::setUpdateTriggerToken(const QString &update_trigger_token) {
    m_update_trigger_token = update_trigger_token;
    m_update_trigger_token_isSet = true;
}

bool OAIRunProperties::is_update_trigger_token_Set() const{
    return m_update_trigger_token_isSet;
}

bool OAIRunProperties::is_update_trigger_token_Valid() const{
