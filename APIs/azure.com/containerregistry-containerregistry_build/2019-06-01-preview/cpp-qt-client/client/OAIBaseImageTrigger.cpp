...
QString OAIBaseImageTrigger::getUpdateTriggerEndpoint() const {
    return m_update_trigger_endpoint;
}
void OAIBaseImageTrigger::setUpdateTriggerEndpoint(const QString &update_trigger_endpoint) {
    m_update_trigger_endpoint = update_trigger_endpoint;
    m_update_trigger_endpoint_isSet = true;
}

bool OAIBaseImageTrigger::is_update_trigger_endpoint_Set() const{
    return m_update_trigger_endpoint_isSet;
}

bool OAIBaseImageTrigger::is_update_trigger_endpoint_Valid() const{
    return m_update_trigger_endpoint_isValid;
}

QString OAIBaseImageTrigger::getUpdateTriggerPayloadType() const {
    return m_update_trigger_payload_type;
}
void OAIBaseImageTrigger::setUpdateTriggerPayloadType(const QString &update_trigger_payload_type) {
    m_update_trigger_payload_type = update_trigger_payload_type;
    m_update_trigger_payload_type_isSet = true;
}

bool OAIBaseImageTrigger::is_update_trigger_payload_type_Set() const{
    return m_update_trigger_payload_type_isSet;
}

bool OAIBaseImageTrigger::is_update_trigger_payload_type_Valid() const{
