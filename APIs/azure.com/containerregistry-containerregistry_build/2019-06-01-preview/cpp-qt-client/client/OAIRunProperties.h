...
class OAITimerTriggerDescriptor;
...
public:
    ...
    OAITimerTriggerDescriptor getTimerTrigger() const;
    void setTimerTrigger(const OAITimerTriggerDescriptor &timer_trigger);
    bool is_timer_trigger_Set() const;
    bool is_timer_trigger_Valid() const;
...
private:
    ...
    OAITimerTriggerDescriptor m_timer_trigger;
    bool m_timer_trigger_isSet;
    bool m_timer_trigger_isValid;
