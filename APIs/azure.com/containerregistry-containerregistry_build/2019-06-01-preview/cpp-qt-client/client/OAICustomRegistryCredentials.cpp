...
QString OAICustomRegistryCredentials::getIdentity() const {
    return m_identity;
}
void OAICustomRegistryCredentials::setIdentity(const QString &identity) {
    m_identity = identity;
    m_identity_isSet = true;
}

bool OAICustomRegistryCredentials::is_identity_Set() const{
    return m_identity_isSet;
}

bool OAICustomRegistryCredentials::is_identity_Valid() const{
