...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.TaskProperties();
  });
  ...
  describe('TaskProperties', function() {
    it('should create an instance of TaskProperties', function() {
      ...
      //var instance = new ContainerRegistryManagementClient.TaskProperties();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.TaskProperties);
    });
