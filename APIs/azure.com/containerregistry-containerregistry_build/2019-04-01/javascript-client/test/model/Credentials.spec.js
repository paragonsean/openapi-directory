...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.Credentials();
  });
  ...
  describe('Credentials', function() {
    it('should create an instance of Credentials', function() {
      ...
      //var instance = new ContainerRegistryManagementClient.Credentials();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.Credentials);
    });
    ...
    it('should have the property sourceRegistry (base name: "sourceRegistry")', function() {
      // uncomment below and update the code to test the property sourceRegistry
      //var instance = new ContainerRegistryManagementClient.Credentials();
      //expect(instance).to.be();
    });
