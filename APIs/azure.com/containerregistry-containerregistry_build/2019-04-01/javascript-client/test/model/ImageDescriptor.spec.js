...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.ImageDescriptor();
  });
  ...
  describe('ImageDescriptor', function() {
    it('should create an instance of ImageDescriptor', function() {
      // uncomment below and update the code to test ImageDescriptor
      //var instance = new ContainerRegistryManagementClient.ImageDescriptor();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.ImageDescriptor);
    });
