...
/**
 * Model tests for BuildArgumentList
 */
public class BuildArgumentListTest {
    private final BuildArgumentList model = new BuildArgumentList();
