...
public class Build {
  ...
  public Build properties(BuildProperties properties) {
  ...
  public boolean equals(Object o) {
    ...
    Build build = (Build) o;
    return Objects.equals(this.properties, build.properties) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        BuildProperties.validateJsonElement(jsonObj.get("properties"));
      }
