...
OAIGitCommitTrigger::OAIGitCommitTrigger(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGitCommitTrigger::OAIGitCommitTrigger() {
    this->initializeModel();
}

OAIGitCommitTrigger::~OAIGitCommitTrigger() {}

void OAIGitCommitTrigger::initializeModel() {
...
void OAIGitCommitTrigger::fromJson(QString jsonString) {
...
void OAIGitCommitTrigger::fromJsonObject(QJsonObject json) {
...
QString OAIGitCommitTrigger::asJson() const {
...
QJsonObject OAIGitCommitTrigger::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGitCommitTrigger::getBranchName() const {
    return m_branch_name;
}
void OAIGitCommitTrigger::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIGitCommitTrigger::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIGitCommitTrigger::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAIGitCommitTrigger::getCommitId() const {
    return m_commit_id;
}
void OAIGitCommitTrigger::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIGitCommitTrigger::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIGitCommitTrigger::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIGitCommitTrigger::getId() const {
    return m_id;
}
void OAIGitCommitTrigger::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGitCommitTrigger::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGitCommitTrigger::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGitCommitTrigger::getProviderType() const {
    return m_provider_type;
}
void OAIGitCommitTrigger::setProviderType(const QString &provider_type) {
    m_provider_type = provider_type;
    m_provider_type_isSet = true;
}

bool OAIGitCommitTrigger::is_provider_type_Set() const{
    return m_provider_type_isSet;
}

bool OAIGitCommitTrigger::is_provider_type_Valid() const{
    return m_provider_type_isValid;
}

QString OAIGitCommitTrigger::getRepositoryUrl() const {
    return m_repository_url;
}
void OAIGitCommitTrigger::setRepositoryUrl(const QString &repository_url) {
    m_repository_url = repository_url;
    m_repository_url_isSet = true;
}

bool OAIGitCommitTrigger::is_repository_url_Set() const{
    return m_repository_url_isSet;
}

bool OAIGitCommitTrigger::is_repository_url_Valid() const{
    return m_repository_url_isValid;
}

bool OAIGitCommitTrigger::isSet() const {
...
bool OAIGitCommitTrigger::isValid() const {
