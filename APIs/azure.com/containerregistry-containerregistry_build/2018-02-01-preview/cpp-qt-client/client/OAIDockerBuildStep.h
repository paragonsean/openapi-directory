...
/*
 * OAIDockerBuildStep.h
 *
 * The Docker build step.
 */

#ifndef OAIDockerBuildStep_H
#define OAIDockerBuildStep_H
...
class OAIDockerBuildStep : public OAIObject {
public:
    OAIDockerBuildStep();
    OAIDockerBuildStep(QString json);
    ~OAIDockerBuildStep() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDockerBuildStep)

#endif // OAIDockerBuildStep_H
