...
/*
 * OAISourceControlAuthInfo.h
 *
 * The authorization properties for accessing the source code repository.
 */

#ifndef OAISourceControlAuthInfo_H
#define OAISourceControlAuthInfo_H
...
class OAISourceControlAuthInfo : public OAIObject {
public:
    OAISourceControlAuthInfo();
    OAISourceControlAuthInfo(QString json);
    ~OAISourceControlAuthInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceControlAuthInfo)

#endif // OAISourceControlAuthInfo_H
