...
/*
 * OAIQuickBuildRequest.h
 *
 * The queue build request parameters for a quick build.
 */

#ifndef OAIQuickBuildRequest_H
#define OAIQuickBuildRequest_H
...
class OAIQuickBuildRequest : public OAIObject {
public:
    OAIQuickBuildRequest();
    OAIQuickBuildRequest(QString json);
    ~OAIQuickBuildRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuickBuildRequest)

#endif // OAIQuickBuildRequest_H
