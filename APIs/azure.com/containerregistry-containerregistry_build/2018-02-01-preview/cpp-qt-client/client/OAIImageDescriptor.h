...
/*
 * OAIImageDescriptor.h
 *
 * Properties for a registry image.
 */

#ifndef OAIImageDescriptor_H
#define OAIImageDescriptor_H
...
class OAIImageDescriptor : public OAIObject {
public:
    OAIImageDescriptor();
    OAIImageDescriptor(QString json);
    ~OAIImageDescriptor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageDescriptor)

#endif // OAIImageDescriptor_H
