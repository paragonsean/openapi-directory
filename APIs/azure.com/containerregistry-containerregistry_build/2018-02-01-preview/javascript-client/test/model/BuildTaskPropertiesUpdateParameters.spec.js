...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.BuildTaskPropertiesUpdateParameters();
  });
  ...
  describe('BuildTaskPropertiesUpdateParameters', function() {
    it('should create an instance of BuildTaskPropertiesUpdateParameters', function() {
      // uncomment below and update the code to test BuildTaskPropertiesUpdateParameters
      //var instance = new ContainerRegistryManagementClient.BuildTaskPropertiesUpdateParameters();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.BuildTaskPropertiesUpdateParameters);
    });
