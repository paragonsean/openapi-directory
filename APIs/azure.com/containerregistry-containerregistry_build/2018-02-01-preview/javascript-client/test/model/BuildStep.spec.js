...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.BuildStep();
  });
  ...
  describe('BuildStep', function() {
    it('should create an instance of BuildStep', function() {
      ...
      //var instance = new ContainerRegistryManagementClient.BuildStep();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.BuildStep);
    });
