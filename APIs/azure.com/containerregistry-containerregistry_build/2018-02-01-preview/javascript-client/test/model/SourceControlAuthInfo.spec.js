...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.SourceControlAuthInfo();
  });
  ...
  describe('SourceControlAuthInfo', function() {
    it('should create an instance of SourceControlAuthInfo', function() {
      // uncomment below and update the code to test SourceControlAuthInfo
      //var instance = new ContainerRegistryManagementClient.SourceControlAuthInfo();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.SourceControlAuthInfo);
    });
