...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerRegistryManagementClient.BuildTaskProperties();
  });
  ...
  describe('BuildTaskProperties', function() {
    it('should create an instance of BuildTaskProperties', function() {
      // uncomment below and update the code to test BuildTaskProperties
      //var instance = new ContainerRegistryManagementClient.BuildTaskProperties();
      //expect(instance).to.be.a(ContainerRegistryManagementClient.BuildTaskProperties);
    });
