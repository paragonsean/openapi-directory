...
(function(root, factory) {
  ...
  describe('RegistriesApi', function() {
    ...
    describe('registriesQueueBuild', function() {
      it('should call registriesQueueBuild successfully', function(done) {
        //uncomment below and update the code to test registriesQueueBuild
        //instance.registriesQueueBuild(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
