...
class Build {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = BuildProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          BuildProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/BuildProperties} properties
 */
Build.prototype['properties'] = undefined;
