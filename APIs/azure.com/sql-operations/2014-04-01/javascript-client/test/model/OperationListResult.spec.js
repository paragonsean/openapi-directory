...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabase.OperationListResult();
  });
  ...
  describe('OperationListResult', function() {
    it('should create an instance of OperationListResult', function() {
      ...
      //var instance = new AzureSqlDatabase.OperationListResult();
      //expect(instance).to.be.a(AzureSqlDatabase.OperationListResult);
    });
