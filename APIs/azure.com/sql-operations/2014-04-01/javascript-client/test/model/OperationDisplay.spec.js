...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabase.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureSqlDatabase.OperationDisplay();
      //expect(instance).to.be.a(AzureSqlDatabase.OperationDisplay);
    });
