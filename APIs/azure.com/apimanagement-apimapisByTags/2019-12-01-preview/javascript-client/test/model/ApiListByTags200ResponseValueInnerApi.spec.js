...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ApiListByTags200ResponseValueInnerApi();
  });
  ...
  describe('ApiListByTags200ResponseValueInnerApi', function() {
    it('should create an instance of ApiListByTags200ResponseValueInnerApi', function() {
      // uncomment below and update the code to test ApiListByTags200ResponseValueInnerApi
      //var instance = new ApiManagementClient.ApiListByTags200ResponseValueInnerApi();
      //expect(instance).to.be.a(ApiManagementClient.ApiListByTags200ResponseValueInnerApi);
    });
