...
|**atOdataId** | **String** | OData entity ID; always set to null since policy event records do not have an entity ID. |  [optional] |
...
|**timestamp** | **OffsetDateTime** | Timestamp for the policy event record. |  [optional] |
