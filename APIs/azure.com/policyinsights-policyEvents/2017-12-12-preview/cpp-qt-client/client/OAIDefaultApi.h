...
private:
    ...
    void policyEventsListQueryResultsForPolicyDefinitionCallback(OAIHttpRequestWorker *worker);
    void policyEventsListQueryResultsForPolicySetDefinitionCallback(OAIHttpRequestWorker *worker);
    ...
    void policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentCallback(OAIHttpRequestWorker *worker);
    void policyEventsListQueryResultsForSubscriptionCallback(OAIHttpRequestWorker *worker);
    void policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void policyEventsListQueryResultsForPolicyDefinitionSignal(OAIPolicyEventsQueryResults summary);
    void policyEventsListQueryResultsForPolicySetDefinitionSignal(OAIPolicyEventsQueryResults summary);
    ...
    void policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignal(OAIPolicyEventsQueryResults summary);
    void policyEventsListQueryResultsForSubscriptionSignal(OAIPolicyEventsQueryResults summary);
    void policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignal(OAIPolicyEventsQueryResults summary);
    ...
    void policyEventsListQueryResultsForPolicyDefinitionSignalFull(OAIHttpRequestWorker *worker, OAIPolicyEventsQueryResults summary);
    void policyEventsListQueryResultsForPolicySetDefinitionSignalFull(OAIHttpRequestWorker *worker, OAIPolicyEventsQueryResults summary);
    ...
    void policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignalFull(OAIHttpRequestWorker *worker, OAIPolicyEventsQueryResults summary);
    ...
    void policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignalFull(OAIHttpRequestWorker *worker, OAIPolicyEventsQueryResults summary);
    ...
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForPolicyDefinitionSignalError() instead")
    void policyEventsListQueryResultsForPolicyDefinitionSignalE(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForPolicyDefinitionSignalError(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForPolicySetDefinitionSignalError() instead")
    void policyEventsListQueryResultsForPolicySetDefinitionSignalE(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForPolicySetDefinitionSignalError(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignalError() instead")
    void policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignalE(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignalError(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignalError() instead")
    void policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignalE(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignalError(OAIPolicyEventsQueryResults summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForPolicyDefinitionSignalErrorFull() instead")
    void policyEventsListQueryResultsForPolicyDefinitionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForPolicyDefinitionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForPolicySetDefinitionSignalErrorFull() instead")
    void policyEventsListQueryResultsForPolicySetDefinitionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForPolicySetDefinitionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignalErrorFull() instead")
    void policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForResourceGroupLevelPolicyAssignmentSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignalErrorFull() instead")
    void policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void policyEventsListQueryResultsForSubscriptionLevelPolicyAssignmentSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
