...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolicyEventsClient.PolicyEvent();
  });
  ...
  describe('PolicyEvent', function() {
    it('should create an instance of PolicyEvent', function() {
      // uncomment below and update the code to test PolicyEvent
      //var instance = new PolicyEventsClient.PolicyEvent();
      //expect(instance).to.be.a(PolicyEventsClient.PolicyEvent);
    });
    ...
    it('should have the property principalOid (base name: "principalOid")', function() {
      // uncomment below and update the code to test the property principalOid
      //var instance = new PolicyEventsClient.PolicyEvent();
      //expect(instance).to.be();
    });
