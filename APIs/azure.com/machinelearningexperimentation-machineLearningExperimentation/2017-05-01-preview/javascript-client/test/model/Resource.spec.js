...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlTeamAccountManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new MlTeamAccountManagementClient.Resource();
      //expect(instance).to.be.a(MlTeamAccountManagementClient.Resource);
    });
