...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlTeamAccountManagementClient.Project();
  });
  ...
  describe('Project', function() {
    it('should create an instance of Project', function() {
      ...
      //var instance = new MlTeamAccountManagementClient.Project();
      //expect(instance).to.be.a(MlTeamAccountManagementClient.Project);
    });
