...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlTeamAccountManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new MlTeamAccountManagementClient.Operation();
      //expect(instance).to.be.a(MlTeamAccountManagementClient.Operation);
    });
