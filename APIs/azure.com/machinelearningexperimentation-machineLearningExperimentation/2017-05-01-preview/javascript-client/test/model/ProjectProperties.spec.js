...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlTeamAccountManagementClient.ProjectProperties();
  });
  ...
  describe('ProjectProperties', function() {
    it('should create an instance of ProjectProperties', function() {
      ...
      //var instance = new MlTeamAccountManagementClient.ProjectProperties();
      //expect(instance).to.be.a(MlTeamAccountManagementClient.ProjectProperties);
    });
