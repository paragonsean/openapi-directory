...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlTeamAccountManagementClient.Workspace();
  });
  ...
  describe('Workspace', function() {
    it('should create an instance of Workspace', function() {
      ...
      //var instance = new MlTeamAccountManagementClient.Workspace();
      //expect(instance).to.be.a(MlTeamAccountManagementClient.Workspace);
    });
