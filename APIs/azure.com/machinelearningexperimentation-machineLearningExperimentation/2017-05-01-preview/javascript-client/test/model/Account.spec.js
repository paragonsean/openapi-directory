...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlTeamAccountManagementClient.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new MlTeamAccountManagementClient.Account();
      //expect(instance).to.be.a(MlTeamAccountManagementClient.Account);
    });
