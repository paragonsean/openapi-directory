...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MlTeamAccountManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new MlTeamAccountManagementClient.ErrorResponse();
      //expect(instance).to.be.a(MlTeamAccountManagementClient.ErrorResponse);
    });
