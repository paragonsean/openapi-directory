...
#include "OAIAccountListResult.h"
...
public:
    ...
    * @param[in]  parameters OAIAccount [required]
    */
    virtual void accountsCreateOrUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const OAIAccount &parameters);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void accountsList(const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  resource_group_name QString [required]
    * @param[in]  account_name QString [required]
    * @param[in]  parameters OAIAccountUpdateParameters [required]
    */
    virtual void accountsUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const OAIAccountUpdateParameters &parameters);
...
Q_SIGNALS:
    ...
    void accountsCreateOrUpdateSignal(OAIAccount summary);
    void accountsDeleteSignal();
    void accountsGetSignal(OAIAccount summary);
    void accountsListSignal(OAIAccountListResult summary);
    void accountsListByResourceGroupSignal(OAIAccountListResult summary);
    void accountsUpdateSignal(OAIAccount summary);


    void accountsCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIAccount summary);
    ...
    void accountsListSignalFull(OAIHttpRequestWorker *worker, OAIAccountListResult summary);
    void accountsListByResourceGroupSignalFull(OAIHttpRequestWorker *worker, OAIAccountListResult summary);
    ...
    void accountsCreateOrUpdateSignalE(OAIAccount summary, QNetworkReply::NetworkError error_type, QString error_str);
    void accountsCreateOrUpdateSignalError(OAIAccount summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void accountsListSignalE(OAIAccountListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void accountsListSignalError(OAIAccountListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use accountsListByResourceGroupSignalError() instead")
    void accountsListByResourceGroupSignalE(OAIAccountListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void accountsListByResourceGroupSignalError(OAIAccountListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
