...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("projectsListByWorkspace", defaultConf);
    _serverIndices.insert("projectsListByWorkspace", 0);
...
void OAIProjectsApi::projectsCreateOrUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name, const QString &project_name, const OAIProject &parameters) {
    QString fullPath = QString(_serverConfigs["projectsCreateOrUpdate"][_serverIndices.value("projectsCreateOrUpdate")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningExperimentation/accounts/{accountName}/workspaces/{workspaceName}/projects/{projectName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::projectsCreateOrUpdateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::projectsCreateOrUpdateCallback);
...
void OAIProjectsApi::projectsCreateOrUpdateCallback(OAIHttpRequestWorker *worker) {
...
void OAIProjectsApi::projectsDelete(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name, const QString &project_name) {
    QString fullPath = QString(_serverConfigs["projectsDelete"][_serverIndices.value("projectsDelete")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningExperimentation/accounts/{accountName}/workspaces/{workspaceName}/projects/{projectName}");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::projectsDeleteCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::projectsGet(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name, const QString &project_name) {
    QString fullPath = QString(_serverConfigs["projectsGet"][_serverIndices.value("projectsGet")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningExperimentation/accounts/{accountName}/workspaces/{workspaceName}/projects/{projectName}");
...
void OAIProjectsApi::projectsListByWorkspace(const QString &api_version, const QString &subscription_id, const QString &account_name, const QString &workspace_name, const QString &resource_group_name) {
    QString fullPath = QString(_serverConfigs["projectsListByWorkspace"][_serverIndices.value("projectsListByWorkspace")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningExperimentation/accounts/{accountName}/workspaces{workspaceName}/projects");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::projectsListByWorkspaceCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::projectsListByWorkspaceCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::projectsListByWorkspaceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectListResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT projectsListByWorkspaceSignal(output);
        Q_EMIT projectsListByWorkspaceSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT projectsListByWorkspaceSignalE(output, error_type, error_str);
        Q_EMIT projectsListByWorkspaceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT projectsListByWorkspaceSignalError(output, error_type, error_str);
        Q_EMIT projectsListByWorkspaceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::projectsUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name, const QString &project_name, const OAIProjectUpdateParameters &parameters) {
    QString fullPath = QString(_serverConfigs["projectsUpdate"][_serverIndices.value("projectsUpdate")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningExperimentation/accounts/{accountName}/workspaces/{workspaceName}/projects/{projectName}");
