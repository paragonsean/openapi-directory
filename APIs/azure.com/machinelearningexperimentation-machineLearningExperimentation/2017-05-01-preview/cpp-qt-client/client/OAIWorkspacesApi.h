...
public:
    ...
    */
    virtual void workspacesCreateOrUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name, const OAIWorkspace &parameters);
    ...
    * @param[in]  workspace_name QString [required]
    */
    virtual void workspacesDelete(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name);
    ...
    * @param[in]  workspace_name QString [required]
    */
    virtual void workspacesGet(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name);
    ...
    * @param[in]  resource_group_name QString [required]
    */
    virtual void workspacesListByAccounts(const QString &api_version, const QString &subscription_id, const QString &account_name, const QString &resource_group_name);
    ...
    */
    virtual void workspacesUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &workspace_name, const OAIWorkspaceUpdateParameters &parameters);
...
private:
    ...
    void workspacesListByAccountsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void workspacesListByAccountsSignal(OAIWorkspaceListResult summary);
    ...
    void workspacesListByAccountsSignalFull(OAIHttpRequestWorker *worker, OAIWorkspaceListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use workspacesListByAccountsSignalError() instead")
    void workspacesListByAccountsSignalE(OAIWorkspaceListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void workspacesListByAccountsSignalError(OAIWorkspaceListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use workspacesListByAccountsSignalErrorFull() instead")
    void workspacesListByAccountsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workspacesListByAccountsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
