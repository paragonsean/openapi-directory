...
/*
 * OAIAccountListResult.h
 *
 * The result of a request to list machine learning team accounts.
 */

#ifndef OAIAccountListResult_H
#define OAIAccountListResult_H
...
class OAIAccountListResult : public OAIObject {
public:
    OAIAccountListResult();
    OAIAccountListResult(QString json);
    ~OAIAccountListResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountListResult)

#endif // OAIAccountListResult_H
