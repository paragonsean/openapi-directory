...
- API version: 2017-11-01-preview
  - Build date: 2024-10-12T10:37:17.112777-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*BaselineApi* | [**metricBaselineCalculateBaseline**](docs/BaselineApi.md#metricBaselineCalculateBaseline) | **POST** /{resourceUri}/providers/microsoft.insights/calculatebaseline | 


## Documentation for Models

 - [Baseline](docs/Baseline.md)
 - [CalculateBaselineResponse](docs/CalculateBaselineResponse.md)
 - [ErrorResponse](docs/ErrorResponse.md)
 - [TimeSeriesInformation](docs/TimeSeriesInformation.md)
