...
bool OAIAzureFunctionReceiver::isUseCommonAlertSchema() const {
    return m_use_common_alert_schema;
}
void OAIAzureFunctionReceiver::setUseCommonAlertSchema(const bool &use_common_alert_schema) {
    m_use_common_alert_schema = use_common_alert_schema;
    m_use_common_alert_schema_isSet = true;
}

bool OAIAzureFunctionReceiver::is_use_common_alert_schema_Set() const{
    return m_use_common_alert_schema_isSet;
}

bool OAIAzureFunctionReceiver::is_use_common_alert_schema_Valid() const{
...
bool OAIAzureFunctionReceiver::isValid() const {
    ...
    return m_function_app_resource_id_isValid && m_function_name_isValid && m_http_trigger_url_isValid && m_name_isValid && m_use_common_alert_schema_isValid && true;
}
