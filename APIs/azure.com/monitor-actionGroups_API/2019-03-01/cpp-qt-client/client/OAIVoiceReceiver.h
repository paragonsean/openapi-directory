...
#ifndef OAIVoiceReceiver_H
#define OAIVoiceReceiver_H
...
class OAIVoiceReceiver : public OAIObject {
public:
    OAIVoiceReceiver();
    OAIVoiceReceiver(QString json);
    ~OAIVoiceReceiver() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoiceReceiver)

#endif // OAIVoiceReceiver_H
