...
bool OAIAutomationRunbookReceiver::isUseCommonAlertSchema() const {
    return m_use_common_alert_schema;
}
void OAIAutomationRunbookReceiver::setUseCommonAlertSchema(const bool &use_common_alert_schema) {
    m_use_common_alert_schema = use_common_alert_schema;
    m_use_common_alert_schema_isSet = true;
}

bool OAIAutomationRunbookReceiver::is_use_common_alert_schema_Set() const{
    return m_use_common_alert_schema_isSet;
}

bool OAIAutomationRunbookReceiver::is_use_common_alert_schema_Valid() const{
...
bool OAIAutomationRunbookReceiver::isValid() const {
    ...
    return m_automation_account_id_isValid && m_is_global_runbook_isValid && m_runbook_name_isValid && m_use_common_alert_schema_isValid && m_webhook_resource_id_isValid && true;
}
