...
async def test_action_groups_create_or_update(client):
    ...
    """
    action_group = {"properties":{"logicAppReceivers":[{"resourceId":"resourceId","useCommonAlertSchema":True,"name":"name","callbackUrl":"callbackUrl"},{"resourceId":"resourceId","useCommonAlertSchema":True,"name":"name","callbackUrl":"callbackUrl"}],"armRoleReceivers":[{"useCommonAlertSchema":True,"roleId":"roleId","name":"name"},{"useCommonAlertSchema":True,"roleId":"roleId","name":"name"}],"smsReceivers":[{"phoneNumber":"phoneNumber","countryCode":"countryCode","name":"name"},{"phoneNumber":"phoneNumber","countryCode":"countryCode","name":"name"}],"voiceReceivers":[{"phoneNumber":"phoneNumber","countryCode":"countryCode","name":"name"},{"phoneNumber":"phoneNumber","countryCode":"countryCode","name":"name"}],"groupShortName":"groupShortName","azureFunctionReceivers":[{"httpTriggerUrl":"httpTriggerUrl","useCommonAlertSchema":True,"functionName":"functionName","name":"name","functionAppResourceId":"functionAppResourceId"},{"httpTriggerUrl":"httpTriggerUrl","useCommonAlertSchema":True,"functionName":"functionName","name":"name","functionAppResourceId":"functionAppResourceId"}],"webhookReceivers":[{"useCommonAlertSchema":True,"serviceUri":"serviceUri","name":"name"},{"useCommonAlertSchema":True,"serviceUri":"serviceUri","name":"name"}],"emailReceivers":[{"emailAddress":"emailAddress","useCommonAlertSchema":True,"name":"name","status":"NotSpecified"},{"emailAddress":"emailAddress","useCommonAlertSchema":True,"name":"name","status":"NotSpecified"}],"enabled":True,"itsmReceivers":[{"name":"name","connectionId":"connectionId","region":"region","ticketConfiguration":"ticketConfiguration","workspaceId":"workspaceId"},{"name":"name","connectionId":"connectionId","region":"region","ticketConfiguration":"ticketConfiguration","workspaceId":"workspaceId"}],"automationRunbookReceivers":[{"useCommonAlertSchema":True,"serviceUri":"serviceUri","webhookResourceId":"webhookResourceId","runbookName":"runbookName","name":"name","automationAccountId":"automationAccountId","isGlobalRunbook":True},{"useCommonAlertSchema":True,"serviceUri":"serviceUri","webhookResourceId":"webhookResourceId","runbookName":"runbookName","name":"name","automationAccountId":"automationAccountId","isGlobalRunbook":True}],"azureAppPushReceivers":[{"emailAddress":"emailAddress","name":"name"},{"emailAddress":"emailAddress","name":"name"}]}}
