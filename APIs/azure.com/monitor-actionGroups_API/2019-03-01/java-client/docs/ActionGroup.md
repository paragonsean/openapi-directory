...
|------------ | ------------- | ------------- | -------------|
|**armRoleReceivers** | [**List&lt;ArmRoleReceiver&gt;**](ArmRoleReceiver.md) | The list of ARM role receivers that are part of this action group. Roles are Azure RBAC roles and only built-in roles are supported. |  [optional] |
