...
class AzureFunctionReceiver {
     ...
     */
    constructor(functionAppResourceId, functionName, httpTriggerUrl, name, useCommonAlertSchema) { 
        
        AzureFunctionReceiver.initialize(this, functionAppResourceId, functionName, httpTriggerUrl, name, useCommonAlertSchema);
    }
     ...
     */
    static initialize(obj, functionAppResourceId, functionName, httpTriggerUrl, name, useCommonAlertSchema) { 
...
AzureFunctionReceiver.RequiredProperties = ["functionAppResourceId", "functionName", "httpTriggerUrl", "name", "useCommonAlertSchema"];
 ...
 */
AzureFunctionReceiver.prototype['useCommonAlertSchema'] = undefined;
