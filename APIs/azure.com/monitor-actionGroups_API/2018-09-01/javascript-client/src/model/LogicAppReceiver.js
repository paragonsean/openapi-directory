...
class LogicAppReceiver {
     ...
     */
    constructor(callbackUrl, name, resourceId) { 
        
        LogicAppReceiver.initialize(this, callbackUrl, name, resourceId);
    }
     ...
     */
    static initialize(obj, callbackUrl, name, resourceId) { 
...
LogicAppReceiver.RequiredProperties = ["callbackUrl", "name", "resourceId"];
