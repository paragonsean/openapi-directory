...
void OAIActionGroup::initializeModel() {
    ...
    m_arm_role_receivers_isSet = false;
    m_arm_role_receivers_isValid = false;
    ...
    m_azure_function_receivers_isSet = false;
    m_azure_function_receivers_isValid = false;
    ...
    m_logic_app_receivers_isSet = false;
    m_logic_app_receivers_isValid = false;

    m_sms_receivers_isSet = false;
    m_sms_receivers_isValid = false;

    m_voice_receivers_isSet = false;
    m_voice_receivers_isValid = false;
...
void OAIActionGroup::fromJsonObject(QJsonObject json) {
    ...
    m_arm_role_receivers_isValid = ::OpenAPI::fromJsonValue(m_arm_role_receivers, json[QString("armRoleReceivers")]);
    m_arm_role_receivers_isSet = !json[QString("armRoleReceivers")].isNull() && m_arm_role_receivers_isValid;
    ...
    m_azure_function_receivers_isValid = ::OpenAPI::fromJsonValue(m_azure_function_receivers, json[QString("azureFunctionReceivers")]);
    m_azure_function_receivers_isSet = !json[QString("azureFunctionReceivers")].isNull() && m_azure_function_receivers_isValid;
    ...
    m_logic_app_receivers_isValid = ::OpenAPI::fromJsonValue(m_logic_app_receivers, json[QString("logicAppReceivers")]);
    m_logic_app_receivers_isSet = !json[QString("logicAppReceivers")].isNull() && m_logic_app_receivers_isValid;
    ...
    m_voice_receivers_isValid = ::OpenAPI::fromJsonValue(m_voice_receivers, json[QString("voiceReceivers")]);
    m_voice_receivers_isSet = !json[QString("voiceReceivers")].isNull() && m_voice_receivers_isValid;
...
QJsonObject OAIActionGroup::asJsonObject() const {
    QJsonObject obj;
    if (m_arm_role_receivers.size() > 0) {
        obj.insert(QString("armRoleReceivers"), ::OpenAPI::toJsonValue(m_arm_role_receivers));
    }
    ...
    if (m_azure_function_receivers.size() > 0) {
        obj.insert(QString("azureFunctionReceivers"), ::OpenAPI::toJsonValue(m_azure_function_receivers));
    }
    ...
    if (m_logic_app_receivers.size() > 0) {
        obj.insert(QString("logicAppReceivers"), ::OpenAPI::toJsonValue(m_logic_app_receivers));
    }
    if (m_sms_receivers.size() > 0) {
        obj.insert(QString("smsReceivers"), ::OpenAPI::toJsonValue(m_sms_receivers));
    }
    if (m_voice_receivers.size() > 0) {
        obj.insert(QString("voiceReceivers"), ::OpenAPI::toJsonValue(m_voice_receivers));
    }
...
QList<OAIArmRoleReceiver> OAIActionGroup::getArmRoleReceivers() const {
    return m_arm_role_receivers;
}
void OAIActionGroup::setArmRoleReceivers(const QList<OAIArmRoleReceiver> &arm_role_receivers) {
    m_arm_role_receivers = arm_role_receivers;
    m_arm_role_receivers_isSet = true;
}

bool OAIActionGroup::is_arm_role_receivers_Set() const{
    return m_arm_role_receivers_isSet;
}

bool OAIActionGroup::is_arm_role_receivers_Valid() const{
    return m_arm_role_receivers_isValid;
}
...
QList<OAIAzureFunctionReceiver> OAIActionGroup::getAzureFunctionReceivers() const {
    return m_azure_function_receivers;
}
void OAIActionGroup::setAzureFunctionReceivers(const QList<OAIAzureFunctionReceiver> &azure_function_receivers) {
    m_azure_function_receivers = azure_function_receivers;
    m_azure_function_receivers_isSet = true;
}

bool OAIActionGroup::is_azure_function_receivers_Set() const{
    return m_azure_function_receivers_isSet;
}

bool OAIActionGroup::is_azure_function_receivers_Valid() const{
    return m_azure_function_receivers_isValid;
}
...
QList<OAILogicAppReceiver> OAIActionGroup::getLogicAppReceivers() const {
    return m_logic_app_receivers;
}
void OAIActionGroup::setLogicAppReceivers(const QList<OAILogicAppReceiver> &logic_app_receivers) {
    m_logic_app_receivers = logic_app_receivers;
    m_logic_app_receivers_isSet = true;
}

bool OAIActionGroup::is_logic_app_receivers_Set() const{
    return m_logic_app_receivers_isSet;
}

bool OAIActionGroup::is_logic_app_receivers_Valid() const{
    return m_logic_app_receivers_isValid;
}
...
QList<OAIVoiceReceiver> OAIActionGroup::getVoiceReceivers() const {
    return m_voice_receivers;
}
void OAIActionGroup::setVoiceReceivers(const QList<OAIVoiceReceiver> &voice_receivers) {
    m_voice_receivers = voice_receivers;
    m_voice_receivers_isSet = true;
}

bool OAIActionGroup::is_voice_receivers_Set() const{
    return m_voice_receivers_isSet;
}

bool OAIActionGroup::is_voice_receivers_Valid() const{
    return m_voice_receivers_isValid;
}
