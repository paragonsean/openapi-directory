...
class AutomationRunbookReceiver(Model):
    ...
    def __init__(self, automation_account_id: str=None, is_global_runbook: bool=None, name: str=None, runbook_name: str=None, service_uri: str=None, webhook_resource_id: str=None):
