...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabricAdminClient.NetworkOperationResultModel();
  });
  ...
  describe('NetworkOperationResultModel', function() {
    it('should create an instance of NetworkOperationResultModel', function() {
      // uncomment below and update the code to test NetworkOperationResultModel
      //var instance = new FabricAdminClient.NetworkOperationResultModel();
      //expect(instance).to.be.a(FabricAdminClient.NetworkOperationResultModel);
    });
