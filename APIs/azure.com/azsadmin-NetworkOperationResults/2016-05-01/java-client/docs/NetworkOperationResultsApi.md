...
<a id="networkOperationResultsGet"></a>
...
<a id="networkOperationResultsList"></a>
# **networkOperationResultsList**
> NetworkOperationResultList networkOperationResultsList(subscriptionId, resourceGroupName, location, apiVersion, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      NetworkOperationResultList result = apiInstance.networkOperationResultsList(subscriptionId, resourceGroupName, location, apiVersion, $filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NetworkOperationResultsApi#networkOperationResultsList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
