...
public:
    ...
    * @param[in]  resource_group_name QString [required]
    */
    virtual void workspacesListByResourceGroup(const QString &api_version, const QString &subscription_id, const QString &resource_group_name);
    ...
    * @param[in]  resource_group_name QString [required]
    */
    virtual void workspacesListWorkspaceKeys(const QString &api_version, const QString &subscription_id, const QString &workspace_name, const QString &resource_group_name);
    ...
    * @param[in]  resource_group_name QString [required]
    */
    virtual void workspacesResyncStorageKeys(const QString &api_version, const QString &subscription_id, const QString &workspace_name, const QString &resource_group_name);
...
private:
    ...
    void workspacesListWorkspaceKeysCallback(OAIHttpRequestWorker *worker);
    void workspacesResyncStorageKeysCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void workspacesListWorkspaceKeysSignal(OAIWorkspaceKeysResponse summary);
    void workspacesResyncStorageKeysSignal();
    ...
    void workspacesListWorkspaceKeysSignalFull(OAIHttpRequestWorker *worker, OAIWorkspaceKeysResponse summary);
    void workspacesResyncStorageKeysSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use workspacesListWorkspaceKeysSignalError() instead")
    void workspacesListWorkspaceKeysSignalE(OAIWorkspaceKeysResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void workspacesListWorkspaceKeysSignalError(OAIWorkspaceKeysResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use workspacesResyncStorageKeysSignalError() instead")
    void workspacesResyncStorageKeysSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void workspacesResyncStorageKeysSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use workspacesListWorkspaceKeysSignalErrorFull() instead")
    void workspacesListWorkspaceKeysSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workspacesListWorkspaceKeysSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use workspacesResyncStorageKeysSignalErrorFull() instead")
    void workspacesResyncStorageKeysSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workspacesResyncStorageKeysSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
