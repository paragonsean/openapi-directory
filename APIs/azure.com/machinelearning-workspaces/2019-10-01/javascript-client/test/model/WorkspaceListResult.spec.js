...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningWorkspacesManagementClient.WorkspaceListResult();
  });
  ...
  describe('WorkspaceListResult', function() {
    it('should create an instance of WorkspaceListResult', function() {
      ...
      //var instance = new MachineLearningWorkspacesManagementClient.WorkspaceListResult();
      //expect(instance).to.be.a(MachineLearningWorkspacesManagementClient.WorkspaceListResult);
    });
