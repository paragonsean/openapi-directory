...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningWorkspacesManagementClient.Sku();
  });
  ...
  describe('Sku', function() {
    it('should create an instance of Sku', function() {
      ...
      //var instance = new MachineLearningWorkspacesManagementClient.Sku();
      //expect(instance).to.be.a(MachineLearningWorkspacesManagementClient.Sku);
    });
