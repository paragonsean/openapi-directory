...
class WorkspacePropertiesUpdateParameters(Model):
    ...
    def __init__(self, key_vault_identifier_id: str=None, sku: Sku=None, workspace_state: str=None):
        ...
        :param sku: The sku of this WorkspacePropertiesUpdateParameters.
    ...
    @property
    def sku(self):
        """Gets the sku of this WorkspacePropertiesUpdateParameters.


        :return: The sku of this WorkspacePropertiesUpdateParameters.
        :rtype: Sku
        """
        return self._sku
    ...
    @sku.setter
    def sku(self, sku):
        """Sets the sku of this WorkspacePropertiesUpdateParameters.
