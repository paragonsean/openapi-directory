...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningWorkspacesManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new MachineLearningWorkspacesManagementClient.ErrorResponse();
      //expect(instance).to.be.a(MachineLearningWorkspacesManagementClient.ErrorResponse);
    });
