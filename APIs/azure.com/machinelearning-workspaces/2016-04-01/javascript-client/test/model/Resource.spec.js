...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningWorkspacesManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new MachineLearningWorkspacesManagementClient.Resource();
      //expect(instance).to.be.a(MachineLearningWorkspacesManagementClient.Resource);
    });
