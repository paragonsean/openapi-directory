...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningWorkspacesManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MachineLearningWorkspacesManagementClient.OperationDisplay();
      //expect(instance).to.be.a(MachineLearningWorkspacesManagementClient.OperationDisplay);
    });
