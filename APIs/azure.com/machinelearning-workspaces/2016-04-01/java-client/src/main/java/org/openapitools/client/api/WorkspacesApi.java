...
public class WorkspacesApi {
     ...
     * @param resourceGroupName The name of the resource group to which the machine learning workspace belongs. (required)
     * @param workspaceName The name of the machine learning workspace. (required)
    ...
    public okhttp3.Call workspacesCreateOrUpdateCall(String apiVersion, String subscriptionId, String resourceGroupName, String workspaceName, Workspace parameters, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces/{workspaceName}"
    ...
    public okhttp3.Call workspacesListCall(String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/providers/Microsoft.MachineLearning/workspaces"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
     ...
     */
    public okhttp3.Call workspacesListByResourceGroupCall(String apiVersion, String subscriptionId, String resourceGroupName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workspacesListByResourceGroupValidateBeforeCall(String apiVersion, String subscriptionId, String resourceGroupName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
        ...
        return workspacesListByResourceGroupCall(apiVersion, subscriptionId, resourceGroupName, _callback);
     ...
     */
    public WorkspaceListResult workspacesListByResourceGroup(String apiVersion, String subscriptionId, String resourceGroupName) throws ApiException {
        ApiResponse<WorkspaceListResult> localVarResp = workspacesListByResourceGroupWithHttpInfo(apiVersion, subscriptionId, resourceGroupName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkspaceListResult> workspacesListByResourceGroupWithHttpInfo(String apiVersion, String subscriptionId, String resourceGroupName) throws ApiException {
        okhttp3.Call localVarCall = workspacesListByResourceGroupValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, null);
        Type localVarReturnType = new TypeToken<WorkspaceListResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call workspacesListByResourceGroupAsync(String apiVersion, String subscriptionId, String resourceGroupName, final ApiCallback<WorkspaceListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = workspacesListByResourceGroupValidateBeforeCall(apiVersion, subscriptionId, resourceGroupName, _callback);
        Type localVarReturnType = new TypeToken<WorkspaceListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for workspacesListWorkspaceKeys
     * @param apiVersion The client API version. (required)
     * @param subscriptionId The Microsoft Azure subscription ID. (required)
     * @param workspaceName The name of the machine learning workspace. (required)
     * @param resourceGroupName The name of the resource group to which the machine learning workspace belongs. (required)
     ...
     */
    public okhttp3.Call workspacesListWorkspaceKeysCall(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces/{workspaceName}/listWorkspaceKeys"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "workspaceName" + "}", localVarApiClient.escapeString(workspaceName.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workspacesListWorkspaceKeysValidateBeforeCall(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling workspacesListWorkspaceKeys(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling workspacesListWorkspaceKeys(Async)");
        }

        // verify the required parameter 'workspaceName' is set
        if (workspaceName == null) {
            throw new ApiException("Missing the required parameter 'workspaceName' when calling workspacesListWorkspaceKeys(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling workspacesListWorkspaceKeys(Async)");
        }

        return workspacesListWorkspaceKeysCall(apiVersion, subscriptionId, workspaceName, resourceGroupName, _callback);
     ...
     */
    public WorkspaceKeysResponse workspacesListWorkspaceKeys(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName) throws ApiException {
        ApiResponse<WorkspaceKeysResponse> localVarResp = workspacesListWorkspaceKeysWithHttpInfo(apiVersion, subscriptionId, workspaceName, resourceGroupName);
        return localVarResp.getData();
    }
     ...
     * @param workspaceName The name of the machine learning workspace. (required)
     * @param resourceGroupName The name of the resource group to which the machine learning workspace belongs. (required)
     * @return ApiResponse&lt;WorkspaceKeysResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WorkspaceKeysResponse> workspacesListWorkspaceKeysWithHttpInfo(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName) throws ApiException {
        okhttp3.Call localVarCall = workspacesListWorkspaceKeysValidateBeforeCall(apiVersion, subscriptionId, workspaceName, resourceGroupName, null);
        Type localVarReturnType = new TypeToken<WorkspaceKeysResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call workspacesListWorkspaceKeysAsync(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName, final ApiCallback<WorkspaceKeysResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = workspacesListWorkspaceKeysValidateBeforeCall(apiVersion, subscriptionId, workspaceName, resourceGroupName, _callback);
        Type localVarReturnType = new TypeToken<WorkspaceKeysResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for workspacesResyncStorageKeys
     * @param apiVersion The client API version. (required)
     * @param subscriptionId The Microsoft Azure subscription ID. (required)
     * @param workspaceName The name of the machine learning workspace. (required)
     * @param resourceGroupName The name of the resource group to which the machine learning workspace belongs. (required)
     ...
     */
    public okhttp3.Call workspacesResyncStorageKeysCall(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/workspaces/{workspaceName}/resyncStorageKeys"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "workspaceName" + "}", localVarApiClient.escapeString(workspaceName.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workspacesResyncStorageKeysValidateBeforeCall(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling workspacesResyncStorageKeys(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling workspacesResyncStorageKeys(Async)");
        }

        // verify the required parameter 'workspaceName' is set
        if (workspaceName == null) {
            throw new ApiException("Missing the required parameter 'workspaceName' when calling workspacesResyncStorageKeys(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling workspacesResyncStorageKeys(Async)");
        }

        return workspacesResyncStorageKeysCall(apiVersion, subscriptionId, workspaceName, resourceGroupName, _callback);
     ...
     */
    public void workspacesResyncStorageKeys(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName) throws ApiException {
        workspacesResyncStorageKeysWithHttpInfo(apiVersion, subscriptionId, workspaceName, resourceGroupName);
    }
     ...
     */
    public ApiResponse<Void> workspacesResyncStorageKeysWithHttpInfo(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName) throws ApiException {
        okhttp3.Call localVarCall = workspacesResyncStorageKeysValidateBeforeCall(apiVersion, subscriptionId, workspaceName, resourceGroupName, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call workspacesResyncStorageKeysAsync(String apiVersion, String subscriptionId, String workspaceName, String resourceGroupName, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = workspacesResyncStorageKeysValidateBeforeCall(apiVersion, subscriptionId, workspaceName, resourceGroupName, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
