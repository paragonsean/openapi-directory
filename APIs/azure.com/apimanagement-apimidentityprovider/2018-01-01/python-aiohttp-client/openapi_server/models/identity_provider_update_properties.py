...
class IdentityProviderUpdateProperties(Model):
    ...
    def __init__(self, client_id: str=None, client_secret: str=None, allowed_tenants: List[str]=None, password_reset_policy_name: str=None, profile_editing_policy_name: str=None, signin_policy_name: str=None, signup_policy_name: str=None, type: str=None):
        """IdentityProviderUpdateProperties - a model defined in OpenAPI

        :param client_id: The client_id of this IdentityProviderUpdateProperties.
        :param client_secret: The client_secret of this IdentityProviderUpdateProperties.
        :param allowed_tenants: The allowed_tenants of this IdentityProviderUpdateProperties.
        :param password_reset_policy_name: The password_reset_policy_name of this IdentityProviderUpdateProperties.
        :param profile_editing_policy_name: The profile_editing_policy_name of this IdentityProviderUpdateProperties.
        :param signin_policy_name: The signin_policy_name of this IdentityProviderUpdateProperties.
        :param signup_policy_name: The signup_policy_name of this IdentityProviderUpdateProperties.
        :param type: The type of this IdentityProviderUpdateProperties.
        """
        self.openapi_types = {
            'client_id': str,
            'client_secret': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'IdentityProviderUpdateProperties':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The IdentityProviderUpdateProperties of this IdentityProviderUpdateProperties.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def client_id(self):
        """Gets the client_id of this IdentityProviderUpdateProperties.

        Client Id of the Application in the external Identity Provider. It is App ID for Facebook login, Client ID for Google login, App ID for Microsoft.

        :return: The client_id of this IdentityProviderUpdateProperties.
        :rtype: str
        """
    ...
    def client_id(self, client_id):
        """Sets the client_id of this IdentityProviderUpdateProperties.
    ...
    def client_secret(self):
        """Gets the client_secret of this IdentityProviderUpdateProperties.
        ...
        :return: The client_secret of this IdentityProviderUpdateProperties.
        :rtype: str
        """
    ...
    def client_secret(self, client_secret):
        """Sets the client_secret of this IdentityProviderUpdateProperties.
    ...
    def allowed_tenants(self):
        """Gets the allowed_tenants of this IdentityProviderUpdateProperties.

        List of Allowed Tenants when configuring Azure Active Directory login.

        :return: The allowed_tenants of this IdentityProviderUpdateProperties.
        :rtype: List[str]
        """
    ...
    def allowed_tenants(self, allowed_tenants):
        """Sets the allowed_tenants of this IdentityProviderUpdateProperties.
    ...
    def password_reset_policy_name(self):
        """Gets the password_reset_policy_name of this IdentityProviderUpdateProperties.

        Password Reset Policy Name. Only applies to AAD B2C Identity Provider.

        :return: The password_reset_policy_name of this IdentityProviderUpdateProperties.
        :rtype: str
        """
    ...
    def password_reset_policy_name(self, password_reset_policy_name):
        """Sets the password_reset_policy_name of this IdentityProviderUpdateProperties.
    ...
    def profile_editing_policy_name(self):
        """Gets the profile_editing_policy_name of this IdentityProviderUpdateProperties.

        Profile Editing Policy Name. Only applies to AAD B2C Identity Provider.

        :return: The profile_editing_policy_name of this IdentityProviderUpdateProperties.
        :rtype: str
        """
    ...
    def profile_editing_policy_name(self, profile_editing_policy_name):
        """Sets the profile_editing_policy_name of this IdentityProviderUpdateProperties.
    ...
    def signin_policy_name(self):
        """Gets the signin_policy_name of this IdentityProviderUpdateProperties.

        Signin Policy Name. Only applies to AAD B2C Identity Provider.

        :return: The signin_policy_name of this IdentityProviderUpdateProperties.
        :rtype: str
        """
    ...
    def signin_policy_name(self, signin_policy_name):
        """Sets the signin_policy_name of this IdentityProviderUpdateProperties.
    ...
    def signup_policy_name(self):
        """Gets the signup_policy_name of this IdentityProviderUpdateProperties.

        Signup Policy Name. Only applies to AAD B2C Identity Provider.

        :return: The signup_policy_name of this IdentityProviderUpdateProperties.
        :rtype: str
        """
    ...
    def signup_policy_name(self, signup_policy_name):
        """Sets the signup_policy_name of this IdentityProviderUpdateProperties.
    ...
    @property
    def type(self):
        """Gets the type of this IdentityProviderUpdateProperties.

        Identity Provider Type identifier.

        :return: The type of this IdentityProviderUpdateProperties.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this IdentityProviderUpdateProperties.
