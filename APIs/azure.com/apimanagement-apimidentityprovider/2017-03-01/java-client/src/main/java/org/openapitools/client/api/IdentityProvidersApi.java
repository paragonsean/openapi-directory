...
public class IdentityProvidersApi {
     ...
     * @param ifMatch The entity state (Etag) version of the identity provider configuration to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. (required)
