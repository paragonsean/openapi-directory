...
public class IdentityProviderApi {
     ...
     */
    public okhttp3.Call identityProviderCreateOrUpdateCall(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, IdentityProviderContract parameters, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call identityProviderCreateOrUpdateValidateBeforeCall(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, IdentityProviderContract parameters, final ApiCallback _callback) throws ApiException {
        ...
        return identityProviderCreateOrUpdateCall(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public IdentityProviderContract identityProviderCreateOrUpdate(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, IdentityProviderContract parameters) throws ApiException {
        ApiResponse<IdentityProviderContract> localVarResp = identityProviderCreateOrUpdateWithHttpInfo(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId, parameters);
     ...
     */
    public ApiResponse<IdentityProviderContract> identityProviderCreateOrUpdateWithHttpInfo(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, IdentityProviderContract parameters) throws ApiException {
        okhttp3.Call localVarCall = identityProviderCreateOrUpdateValidateBeforeCall(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId, parameters, null);
     ...
     */
    public okhttp3.Call identityProviderCreateOrUpdateAsync(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, IdentityProviderContract parameters, final ApiCallback<IdentityProviderContract> _callback) throws ApiException {

        okhttp3.Call localVarCall = identityProviderCreateOrUpdateValidateBeforeCall(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<IdentityProviderContract>(){}.getType();
     ...
     * @param serviceName The name of the API Management service. (required)
     * @param identityProviderName Identity Provider Type identifier. (required)
     * @param ifMatch The entity state (Etag) version of the backend to delete. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation. (required)
     * @param apiVersion Version of the API to be used with the client request. (required)
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
