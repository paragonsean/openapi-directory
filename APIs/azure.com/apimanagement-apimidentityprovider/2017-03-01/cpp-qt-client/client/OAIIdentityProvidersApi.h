...
public:
    ...
    * @param[in]  parameters OAIIdentityProviderUpdateParameters [required]
    */
    virtual void identityProviderUpdate(const QString &resource_group_name, const QString &service_name, const QString &identity_provider_name, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAIIdentityProviderUpdateParameters &parameters);
