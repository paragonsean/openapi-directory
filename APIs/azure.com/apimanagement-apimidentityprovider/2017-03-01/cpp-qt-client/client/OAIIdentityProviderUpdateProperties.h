...
/*
 * OAIIdentityProviderUpdateProperties.h
 *
 * Parameters supplied to the Update Identity Provider operation.
 */

#ifndef OAIIdentityProviderUpdateProperties_H
#define OAIIdentityProviderUpdateProperties_H
...
class OAIIdentityProviderUpdateProperties : public OAIObject {
public:
    OAIIdentityProviderUpdateProperties();
    OAIIdentityProviderUpdateProperties(QString json);
    ~OAIIdentityProviderUpdateProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityProviderUpdateProperties)

#endif // OAIIdentityProviderUpdateProperties_H
