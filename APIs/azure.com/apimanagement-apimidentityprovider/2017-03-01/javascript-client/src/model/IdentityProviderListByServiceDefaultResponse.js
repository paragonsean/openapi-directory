...
import IdentityProviderListByServiceDefaultResponseDetailsInner from './IdentityProviderListByServiceDefaultResponseDetailsInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('details')) {
                obj['details'] = ApiClient.convertToType(data['details'], [IdentityProviderListByServiceDefaultResponseDetailsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['details']) { // data not null
            ...
            for (const item of data['details']) {
                IdentityProviderListByServiceDefaultResponseDetailsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {String} code
 */
IdentityProviderListByServiceDefaultResponse.prototype['code'] = undefined;

/**
 * The list of invalid fields send in request, in case of validation error.
 * @member {Array.<module:model/IdentityProviderListByServiceDefaultResponseDetailsInner>} details
 */
IdentityProviderListByServiceDefaultResponse.prototype['details'] = undefined;

/**
 * Human-readable representation of the error.
 * @member {String} message
 */
IdentityProviderListByServiceDefaultResponse.prototype['message'] = undefined;
