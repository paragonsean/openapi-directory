...
/**
 * The IdentityProviderUpdateProperties model module.
 * @module model/IdentityProviderUpdateProperties
 * @version 2017-03-01
 */
class IdentityProviderUpdateProperties {
    /**
     * Constructs a new <code>IdentityProviderUpdateProperties</code>.
     * Parameters supplied to the Update Identity Provider operation.
     * @alias module:model/IdentityProviderUpdateProperties
     * @implements module:model/IdentityProviderBaseParameters
     */
    constructor() { 
        IdentityProviderBaseParameters.initialize(this);
        IdentityProviderUpdateProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IdentityProviderUpdateProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentityProviderUpdateProperties} obj Optional instance to populate.
     * @return {module:model/IdentityProviderUpdateProperties} The populated <code>IdentityProviderUpdateProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentityProviderUpdateProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>IdentityProviderUpdateProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentityProviderUpdateProperties</code>.
     */
 ...
 */
IdentityProviderUpdateProperties.prototype['clientId'] = undefined;
 ...
 */
IdentityProviderUpdateProperties.prototype['clientSecret'] = undefined;

/**
 * List of Allowed Tenants when configuring Azure Active Directory login.
 * @member {Array.<String>} allowedTenants
 */
IdentityProviderUpdateProperties.prototype['allowedTenants'] = undefined;

/**
 * Password Reset Policy Name. Only applies to AAD B2C Identity Provider.
 * @member {String} passwordResetPolicyName
 */
IdentityProviderUpdateProperties.prototype['passwordResetPolicyName'] = undefined;

/**
 * Profile Editing Policy Name. Only applies to AAD B2C Identity Provider.
 * @member {String} profileEditingPolicyName
 */
IdentityProviderUpdateProperties.prototype['profileEditingPolicyName'] = undefined;

/**
 * Signin Policy Name. Only applies to AAD B2C Identity Provider.
 * @member {String} signinPolicyName
 */
IdentityProviderUpdateProperties.prototype['signinPolicyName'] = undefined;

/**
 * Signup Policy Name. Only applies to AAD B2C Identity Provider.
 * @member {String} signupPolicyName
 */
IdentityProviderUpdateProperties.prototype['signupPolicyName'] = undefined;

/**
 * Identity Provider Type identifier.
 * @member {module:model/IdentityProviderUpdateProperties.TypeEnum} type
 */
IdentityProviderUpdateProperties.prototype['type'] = undefined;
 ...
 * @readonly
 */
IdentityProviderUpdateProperties['TypeEnum'] = {
...
export default IdentityProviderUpdateProperties;
