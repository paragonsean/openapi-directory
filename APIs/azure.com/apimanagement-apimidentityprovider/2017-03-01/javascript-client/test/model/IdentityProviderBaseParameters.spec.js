...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.IdentityProviderBaseParameters();
  });
  ...
  describe('IdentityProviderBaseParameters', function() {
    it('should create an instance of IdentityProviderBaseParameters', function() {
      // uncomment below and update the code to test IdentityProviderBaseParameters
      //var instance = new ApiManagementClient.IdentityProviderBaseParameters();
      //expect(instance).to.be.a(ApiManagementClient.IdentityProviderBaseParameters);
    });
