...
async def identity_provider_create_or_update(request: web.Request, resource_group_name, service_name, identity_provider_name, api_version, subscription_id, parameters) -> web.Response:
...
async def identity_provider_delete(request: web.Request, resource_group_name, service_name, identity_provider_name, if_match, api_version, subscription_id) -> web.Response:
    ...
    :param identity_provider_name: Identity Provider Type identifier.
    :type identity_provider_name: str
    :param if_match: The entity state (Etag) version of the backend to delete. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation.
    :type if_match: str
    :param api_version: Version of the API to be used with the client request.
    :type api_version: str
    :param subscription_id: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
