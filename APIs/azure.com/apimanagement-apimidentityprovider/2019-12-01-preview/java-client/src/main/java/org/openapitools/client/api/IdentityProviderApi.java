...
public class IdentityProviderApi {
    ...
    /**
     * Build call for identityProviderListSecrets
     * @param resourceGroupName The name of the resource group. (required)
     * @param serviceName The name of the API Management service. (required)
     * @param identityProviderName Identity Provider Type identifier. (required)
     * @param apiVersion Version of the API to be used with the client request. (required)
     ...
     */
    public okhttp3.Call identityProviderListSecretsCall(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/identityProviders/{identityProviderName}/listSecrets"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "serviceName" + "}", localVarApiClient.escapeString(serviceName.toString()))
            .replace("{" + "identityProviderName" + "}", localVarApiClient.escapeString(identityProviderName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call identityProviderListSecretsValidateBeforeCall(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling identityProviderListSecrets(Async)");
        }

        // verify the required parameter 'serviceName' is set
        if (serviceName == null) {
            throw new ApiException("Missing the required parameter 'serviceName' when calling identityProviderListSecrets(Async)");
        }

        // verify the required parameter 'identityProviderName' is set
        if (identityProviderName == null) {
            throw new ApiException("Missing the required parameter 'identityProviderName' when calling identityProviderListSecrets(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling identityProviderListSecrets(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling identityProviderListSecrets(Async)");
        }

        return identityProviderListSecretsCall(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId, _callback);
     ...
     */
    public IdentityProviderListSecrets200Response identityProviderListSecrets(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<IdentityProviderListSecrets200Response> localVarResp = identityProviderListSecretsWithHttpInfo(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion Version of the API to be used with the client request. (required)
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @return ApiResponse&lt;IdentityProviderListSecrets200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<IdentityProviderListSecrets200Response> identityProviderListSecretsWithHttpInfo(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = identityProviderListSecretsValidateBeforeCall(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<IdentityProviderListSecrets200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call identityProviderListSecretsAsync(String resourceGroupName, String serviceName, String identityProviderName, String apiVersion, String subscriptionId, final ApiCallback<IdentityProviderListSecrets200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = identityProviderListSecretsValidateBeforeCall(resourceGroupName, serviceName, identityProviderName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<IdentityProviderListSecrets200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
