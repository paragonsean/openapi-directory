...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftNetApp.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MicrosoftNetApp.OperationDisplay();
      //expect(instance).to.be.a(MicrosoftNetApp.OperationDisplay);
    });
