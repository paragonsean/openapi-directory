...
QDateTime OAISnapshotProperties::getCreationDate() const {
    return m_creation_date;
}
void OAISnapshotProperties::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAISnapshotProperties::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAISnapshotProperties::is_creation_date_Valid() const{
