...
void OAIExportPolicyRule::fromJsonObject(QJsonObject json) {
    ...
    m_nfsv4_isValid = ::OpenAPI::fromJsonValue(m_nfsv4, json[QString("nfsv4")]);
    m_nfsv4_isSet = !json[QString("nfsv4")].isNull() && m_nfsv4_isValid;
...
QJsonObject OAIExportPolicyRule::asJsonObject() const {
    ...
    if (m_nfsv4_isSet) {
        obj.insert(QString("nfsv4"), ::OpenAPI::toJsonValue(m_nfsv4));
    }
...
bool OAIExportPolicyRule::isNfsv4() const {
    return m_nfsv4;
}
void OAIExportPolicyRule::setNfsv4(const bool &nfsv4) {
    m_nfsv4 = nfsv4;
    m_nfsv4_isSet = true;
}

bool OAIExportPolicyRule::is_nfsv4_Set() const{
    return m_nfsv4_isSet;
}

bool OAIExportPolicyRule::is_nfsv4_Valid() const{
    return m_nfsv4_isValid;
}
