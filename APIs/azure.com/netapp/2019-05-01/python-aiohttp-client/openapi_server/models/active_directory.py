...
class ActiveDirectory(Model):
    ...
    def __init__(self, active_directory_id: str=None, dns: str=None, domain: str=None, organizational_unit: str=None, password: str=None, smb_server_name: str=None, status: str=None, username: str=None):
