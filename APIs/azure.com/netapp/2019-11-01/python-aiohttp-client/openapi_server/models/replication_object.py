...
class ReplicationObject(Model):
    ...
    def __init__(self, endpoint_type: str=None, remote_volume_region: str=None, remote_volume_resource_id: str=None, replication_id: str=None, replication_schedule: str=None):
        """ReplicationObject - a model defined in OpenAPI

        :param endpoint_type: The endpoint_type of this ReplicationObject.
        :param remote_volume_region: The remote_volume_region of this ReplicationObject.
        ...
        self._remote_volume_region = remote_volume_region
    ...
    @property
    def remote_volume_region(self):
        """Gets the remote_volume_region of this ReplicationObject.

        The remote region for the other end of the Volume Replication.

        :return: The remote_volume_region of this ReplicationObject.
        :rtype: str
        """
        return self._remote_volume_region

    @remote_volume_region.setter
    def remote_volume_region(self, remote_volume_region):
        """Sets the remote_volume_region of this ReplicationObject.
    ...
    def replication_schedule(self, replication_schedule):
        ...
        """
        allowed_values = ["_10minutely", "hourly", "daily", "weekly", "monthly"]  # noqa: E501
        if replication_schedule not in allowed_values:
            raise ValueError(
                "Invalid value for `replication_schedule` ({0}), must be one of {1}"
                .format(replication_schedule, allowed_values)
            )
