...
public:
    ...
    * @param[in]  body OAISnapshot [required]
    */
    virtual void snapshotsCreate(const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &pool_name, const QString &volume_name, const QString &snapshot_name, const QString &api_version, const OAISnapshot &body);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void snapshotsDelete(const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &pool_name, const QString &volume_name, const QString &snapshot_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void snapshotsGet(const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &pool_name, const QString &volume_name, const QString &snapshot_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void snapshotsList(const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &pool_name, const QString &volume_name, const QString &api_version);
    ...
    */
    virtual void snapshotsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &pool_name, const QString &volume_name, const QString &snapshot_name, const QString &api_version, const OAIObject &body);
...
private:
    ...
    void snapshotsCreateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void snapshotsCreateSignal(OAISnapshot summary);
    void snapshotsDeleteSignal();
    void snapshotsGetSignal(OAISnapshot summary);
    void snapshotsListSignal(OAISnapshotsList summary);
    void snapshotsUpdateSignal(OAISnapshot summary);


    void snapshotsCreateSignalFull(OAIHttpRequestWorker *worker, OAISnapshot summary);
    ...
    void snapshotsListSignalFull(OAIHttpRequestWorker *worker, OAISnapshotsList summary);
    void snapshotsUpdateSignalFull(OAIHttpRequestWorker *worker, OAISnapshot summary);

    Q_DECL_DEPRECATED_X("Use snapshotsCreateSignalError() instead")
    void snapshotsCreateSignalE(OAISnapshot summary, QNetworkReply::NetworkError error_type, QString error_str);
    void snapshotsCreateSignalError(OAISnapshot summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void snapshotsListSignalE(OAISnapshotsList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void snapshotsListSignalError(OAISnapshotsList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use snapshotsCreateSignalErrorFull() instead")
    void snapshotsCreateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void snapshotsCreateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
