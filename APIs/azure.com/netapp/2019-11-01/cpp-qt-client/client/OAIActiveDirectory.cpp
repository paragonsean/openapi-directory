...
QString OAIActiveDirectory::getSite() const {
    return m_site;
}
void OAIActiveDirectory::setSite(const QString &site) {
    m_site = site;
    m_site_isSet = true;
}

bool OAIActiveDirectory::is_site_Set() const{
    return m_site_isSet;
}

bool OAIActiveDirectory::is_site_Valid() const{
