...
void OAIVolumeProperties::initializeModel() {
    ...
    m_data_protection_isSet = false;
    m_data_protection_isValid = false;
    ...
    m_is_restoring_isSet = false;
    m_is_restoring_isValid = false;
...
void OAIVolumeProperties::fromJsonObject(QJsonObject json) {
    ...
    m_data_protection_isValid = ::OpenAPI::fromJsonValue(m_data_protection, json[QString("dataProtection")]);
    m_data_protection_isSet = !json[QString("dataProtection")].isNull() && m_data_protection_isValid;
    ...
    m_is_restoring_isValid = ::OpenAPI::fromJsonValue(m_is_restoring, json[QString("isRestoring")]);
    m_is_restoring_isSet = !json[QString("isRestoring")].isNull() && m_is_restoring_isValid;
...
QJsonObject OAIVolumeProperties::asJsonObject() const {
    ...
    if (m_data_protection.isSet()) {
        obj.insert(QString("dataProtection"), ::OpenAPI::toJsonValue(m_data_protection));
    }
    ...
    if (m_is_restoring_isSet) {
        obj.insert(QString("isRestoring"), ::OpenAPI::toJsonValue(m_is_restoring));
    }
...
OAIDataProtection OAIVolumeProperties::getDataProtection() const {
    return m_data_protection;
}
void OAIVolumeProperties::setDataProtection(const OAIDataProtection &data_protection) {
    m_data_protection = data_protection;
    m_data_protection_isSet = true;
}

bool OAIVolumeProperties::is_data_protection_Set() const{
    return m_data_protection_isSet;
}

bool OAIVolumeProperties::is_data_protection_Valid() const{
    return m_data_protection_isValid;
}
...
bool OAIVolumeProperties::isIsRestoring() const {
    return m_is_restoring;
}
void OAIVolumeProperties::setIsRestoring(const bool &is_restoring) {
    m_is_restoring = is_restoring;
    m_is_restoring_isSet = true;
}

bool OAIVolumeProperties::is_is_restoring_Set() const{
    return m_is_restoring_isSet;
}

bool OAIVolumeProperties::is_is_restoring_Valid() const{
    return m_is_restoring_isValid;
}
