...
public:
    ...
    OAISnapshotProperties getProperties() const;
    void setProperties(const OAISnapshotProperties &properties);
...
private:
    ...
    OAISnapshotProperties m_properties;
