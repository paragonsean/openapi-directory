...
class Operation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = OperationProperties.constructFromObject(data['properties']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          OperationProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/OperationProperties} properties
 */
