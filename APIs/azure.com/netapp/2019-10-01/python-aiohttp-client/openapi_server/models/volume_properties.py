...
class VolumeProperties(Model):
    ...
    def __init__(self, baremetal_tenant_id: str=None, creation_token: str=None, data_protection: DataProtection=None, export_policy: ExportPolicy=None, file_system_id: str=None, is_restoring: bool=None, mount_targets: List[MountTargetList]=None, protocol_types: List[str]=None, provisioning_state: str=None, service_level: str='Premium', snapshot_id: str=None, subnet_id: str=None, usage_threshold: int=107374182400, volume_type: str=None):
