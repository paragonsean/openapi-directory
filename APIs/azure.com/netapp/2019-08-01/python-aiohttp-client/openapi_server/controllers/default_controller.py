...
async def net_app_resource_check_file_path_availability(request: web.Request, subscription_id, location, api_version, body) -> web.Response:
...
async def net_app_resource_check_name_availability(request: web.Request, subscription_id, location, api_version, body) -> web.Response:
