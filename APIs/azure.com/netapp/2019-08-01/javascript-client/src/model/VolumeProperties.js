...
import MountTargetList from './MountTargetList';
...
class VolumeProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mountTargets')) {
                obj['mountTargets'] = ApiClient.convertToType(data['mountTargets'], [MountTargetList]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['mountTargets']) { // data not null
            ...
            if (!Array.isArray(data['mountTargets'])) {
                throw new Error("Expected the field `mountTargets` to be an array in the JSON data but got " + data['mountTargets']);
            }
            // validate the optional field `mountTargets` (array)
            for (const item of data['mountTargets']) {
                MountTargetList.validateJSON(item);
            };
        }
        // ensure the json data is an array
 ...
 * @member {Array.<module:model/MountTargetList>} mountTargets
 */
