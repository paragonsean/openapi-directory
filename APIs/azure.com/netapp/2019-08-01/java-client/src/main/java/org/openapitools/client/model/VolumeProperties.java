...
public class VolumeProperties {
  ...
  private List<MountTargetList> mountTargets = new ArrayList<>();
  ...
  public VolumeProperties mountTargets(List<MountTargetList> mountTargets) {
    this.mountTargets = mountTargets;
    return this;
  }

  public VolumeProperties addMountTargetsItem(MountTargetList mountTargetsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<MountTargetList> getMountTargets() {
    return mountTargets;
  }

  public void setMountTargets(List<MountTargetList> mountTargets) {
    this.mountTargets = mountTargets;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baremetalTenantId, creationToken, dataProtection, exportPolicy, fileSystemId, mountTargets, protocolTypes, provisioningState, serviceLevel, snapshotId, subnetId, usageThreshold, volumeType);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("mountTargets") != null && !jsonObj.get("mountTargets").isJsonNull()) {
        JsonArray jsonArraymountTargets = jsonObj.getAsJsonArray("mountTargets");
        if (jsonArraymountTargets != null) {
          // ensure the json data is an array
          if (!jsonObj.get("mountTargets").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `mountTargets` to be an array in the JSON string but got `%s`", jsonObj.get("mountTargets").toString()));
          }

          // validate the optional field `mountTargets` (array)
          for (int i = 0; i < jsonArraymountTargets.size(); i++) {
            MountTargetList.validateJsonElement(jsonArraymountTargets.get(i));
          };
        }
      }
