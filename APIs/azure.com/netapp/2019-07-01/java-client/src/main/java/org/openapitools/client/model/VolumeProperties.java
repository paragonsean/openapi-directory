...
public class VolumeProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baremetalTenantId, creationToken, exportPolicy, fileSystemId, mountTargets, protocolTypes, provisioningState, serviceLevel, snapshotId, subnetId, usageThreshold);
  }
