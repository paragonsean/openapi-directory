...
public:
    ...
    * @param[in]  snapshot_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  body OAISnapshotPatch [required]
    */
    virtual void snapshotsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &account_name, const QString &pool_name, const QString &volume_name, const QString &snapshot_name, const QString &api_version, const OAISnapshotPatch &body);
