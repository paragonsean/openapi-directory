...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftNetApp.MetricSpecification();
  });
  ...
  describe('MetricSpecification', function() {
    it('should create an instance of MetricSpecification', function() {
      // uncomment below and update the code to test MetricSpecification
      //var instance = new MicrosoftNetApp.MetricSpecification();
      //expect(instance).to.be.a(MicrosoftNetApp.MetricSpecification);
    });
