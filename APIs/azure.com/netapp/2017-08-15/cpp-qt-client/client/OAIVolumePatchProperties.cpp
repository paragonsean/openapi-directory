...
OAIVolumePatchProperties_exportPolicy OAIVolumePatchProperties::getExportPolicy() const {
    return m_export_policy;
}
void OAIVolumePatchProperties::setExportPolicy(const OAIVolumePatchProperties_exportPolicy &export_policy) {
