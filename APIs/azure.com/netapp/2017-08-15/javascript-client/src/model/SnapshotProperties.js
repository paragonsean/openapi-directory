...
class SnapshotProperties {
     ...
     * @param fileSystemId {String} UUID v4 used to identify the FileSystem
     */
    constructor(fileSystemId) { 
        
        SnapshotProperties.initialize(this, fileSystemId);
    }
...
SnapshotProperties.RequiredProperties = ["fileSystemId"];
