...
import VolumePatchPropertiesExportPolicy from './VolumePatchPropertiesExportPolicy';
...
class VolumePatchProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('exportPolicy')) {
                obj['exportPolicy'] = VolumePatchPropertiesExportPolicy.constructFromObject(data['exportPolicy']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['exportPolicy']) { // data not null
          VolumePatchPropertiesExportPolicy.validateJSON(data['exportPolicy']);
        }
...
/**
 * @member {module:model/VolumePatchPropertiesExportPolicy} exportPolicy
 */
