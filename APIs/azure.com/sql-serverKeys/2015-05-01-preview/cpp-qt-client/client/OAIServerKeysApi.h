...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void serverKeysListByServer(const QString &resource_group_name, const QString &server_name, const QString &subscription_id, const QString &api_version);
...
private:
    ...
    void serverKeysListByServerCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void serverKeysListByServerSignal(OAIServerKeyListResult summary);
    ...
    void serverKeysListByServerSignalFull(OAIHttpRequestWorker *worker, OAIServerKeyListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use serverKeysListByServerSignalError() instead")
    void serverKeysListByServerSignalE(OAIServerKeyListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serverKeysListByServerSignalError(OAIServerKeyListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use serverKeysListByServerSignalErrorFull() instead")
    void serverKeysListByServerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serverKeysListByServerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
