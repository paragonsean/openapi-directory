...
QString OAIServerKey::getLocation() const {
    return m_location;
}
void OAIServerKey::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIServerKey::is_location_Set() const{
    return m_location_isSet;
}

bool OAIServerKey::is_location_Valid() const{
