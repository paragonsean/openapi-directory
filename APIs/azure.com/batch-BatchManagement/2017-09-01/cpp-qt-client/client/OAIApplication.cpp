...
bool OAIApplication::isAllowUpdates() const {
    return m_allow_updates;
}
void OAIApplication::setAllowUpdates(const bool &allow_updates) {
    m_allow_updates = allow_updates;
    m_allow_updates_isSet = true;
}

bool OAIApplication::is_allow_updates_Set() const{
    return m_allow_updates_isSet;
}

bool OAIApplication::is_allow_updates_Valid() const{
    return m_allow_updates_isValid;
}

QString OAIApplication::getDefaultVersion() const {
    return m_default_version;
}
void OAIApplication::setDefaultVersion(const QString &default_version) {
    m_default_version = default_version;
    m_default_version_isSet = true;
}

bool OAIApplication::is_default_version_Set() const{
    return m_default_version_isSet;
}

bool OAIApplication::is_default_version_Valid() const{
...
QList<OAIApplicationPackage> OAIApplication::getPackages() const {
    return m_packages;
}
void OAIApplication::setPackages(const QList<OAIApplicationPackage> &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAIApplication::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAIApplication::is_packages_Valid() const{
