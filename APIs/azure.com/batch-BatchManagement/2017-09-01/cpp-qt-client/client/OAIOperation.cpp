...
OAIThe_object_that_describes_the_operation_ OAIOperation::getDisplay() const {
    return m_display;
}
void OAIOperation::setDisplay(const OAIThe_object_that_describes_the_operation_ &display) {
    m_display = display;
...
OAIObject OAIOperation::getProperties() const {
    return m_properties;
}
void OAIOperation::setProperties(const OAIObject &properties) {
