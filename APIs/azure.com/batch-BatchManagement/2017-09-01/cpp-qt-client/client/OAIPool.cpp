...
OAIPoolProperties OAIPool::getProperties() const {
    return m_properties;
}
void OAIPool::setProperties(const OAIPoolProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIPool::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIPool::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIPool::getEtag() const {
    return m_etag;
}
void OAIPool::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIPool::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIPool::is_etag_Valid() const{
    return m_etag_isValid;
}

QString OAIPool::getId() const {
    return m_id;
}
void OAIPool::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPool::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPool::is_id_Valid() const{
    return m_id_isValid;
}
