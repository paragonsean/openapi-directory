...
|------------ | ------------- | ------------- | -------------|
|**dataDisks** | [**List&lt;DataDisk&gt;**](DataDisk.md) | This property must be specified if the compute nodes in the pool need to have empty data disks attached to them. |  [optional] |
