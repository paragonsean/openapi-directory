...
public class CertificateReference {
  ...
  public CertificateReference id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, certificateReference.id) &&
        Objects.equals(this.storeLocation, certificateReference.storeLocation) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, storeLocation, storeName, visibility);
  }
