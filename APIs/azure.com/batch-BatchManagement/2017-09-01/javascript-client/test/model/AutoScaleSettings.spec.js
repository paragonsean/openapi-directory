...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BatchManagement.AutoScaleSettings();
  });
  ...
  describe('AutoScaleSettings', function() {
    it('should create an instance of AutoScaleSettings', function() {
      // uncomment below and update the code to test AutoScaleSettings
      //var instance = new BatchManagement.AutoScaleSettings();
      //expect(instance).to.be.a(BatchManagement.AutoScaleSettings);
    });
