...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BatchManagement.NetworkConfiguration();
  });
  ...
  describe('NetworkConfiguration', function() {
    it('should create an instance of NetworkConfiguration', function() {
      ...
      //var instance = new BatchManagement.NetworkConfiguration();
      //expect(instance).to.be.a(BatchManagement.NetworkConfiguration);
    });
