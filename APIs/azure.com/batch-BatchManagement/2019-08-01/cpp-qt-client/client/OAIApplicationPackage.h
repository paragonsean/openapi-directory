...
namespace OpenAPI {
class OAIApplicationPackageProperties;
...
public:
    ...
    OAIApplicationPackageProperties getProperties() const;
    void setProperties(const OAIApplicationPackageProperties &properties);
...
private:
    ...
    OAIApplicationPackageProperties m_properties;
