...
public:
    ...
    void setNodeAgentSkuId(const QString &node_agent_sku_id);
    bool is_node_agent_sku_id_Set() const;
    bool is_node_agent_sku_id_Valid() const;
...
private:
    ...
    QString m_node_agent_sku_id;
    bool m_node_agent_sku_id_isSet;
    bool m_node_agent_sku_id_isValid;
