...
QString OAITaskContainerSettings::getWorkingDirectory() const {
    return m_working_directory;
}
void OAITaskContainerSettings::setWorkingDirectory(const QString &working_directory) {
    m_working_directory = working_directory;
    m_working_directory_isSet = true;
}

bool OAITaskContainerSettings::is_working_directory_Set() const{
    return m_working_directory_isSet;
}

bool OAITaskContainerSettings::is_working_directory_Valid() const{
