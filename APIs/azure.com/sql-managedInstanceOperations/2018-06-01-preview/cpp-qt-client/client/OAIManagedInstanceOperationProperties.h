...
/*
 * OAIManagedInstanceOperationProperties.h
 *
 * The properties of a managed instance operation.
 */

#ifndef OAIManagedInstanceOperationProperties_H
#define OAIManagedInstanceOperationProperties_H
...
class OAIManagedInstanceOperationProperties : public OAIObject {
public:
    OAIManagedInstanceOperationProperties();
    OAIManagedInstanceOperationProperties(QString json);
    ~OAIManagedInstanceOperationProperties() override;
    ...
    QString getManagedInstanceName() const;
    void setManagedInstanceName(const QString &managed_instance_name);
    bool is_managed_instance_name_Set() const;
    bool is_managed_instance_name_Valid() const;
...
private:
    ...
    QString m_managed_instance_name;
    bool m_managed_instance_name_isSet;
    bool m_managed_instance_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIManagedInstanceOperationProperties)

#endif // OAIManagedInstanceOperationProperties_H
