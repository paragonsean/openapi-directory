# SqlManagementClient.ManagedInstanceOperationProperties
...
**managedInstanceName** | **String** | The name of the managed instance the operation is being performed on. | [optional] [readonly] 
