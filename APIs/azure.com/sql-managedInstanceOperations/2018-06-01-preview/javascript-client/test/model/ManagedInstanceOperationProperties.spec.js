...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.ManagedInstanceOperationProperties();
  });
  ...
  describe('ManagedInstanceOperationProperties', function() {
    it('should create an instance of ManagedInstanceOperationProperties', function() {
      // uncomment below and update the code to test ManagedInstanceOperationProperties
      //var instance = new SqlManagementClient.ManagedInstanceOperationProperties();
      //expect(instance).to.be.a(SqlManagementClient.ManagedInstanceOperationProperties);
    });
    ...
    it('should have the property managedInstanceName (base name: "managedInstanceName")', function() {
      // uncomment below and update the code to test the property managedInstanceName
      //var instance = new SqlManagementClient.ManagedInstanceOperationProperties();
      //expect(instance).to.be();
    });
