...
qint64 OAIResourceSkuCapacity::getRDefault() const {
    return m_r_default;
}
void OAIResourceSkuCapacity::setRDefault(const qint64 &r_default) {
...
qint64 OAIResourceSkuCapacity::getMaximum() const {
    return m_maximum;
}
void OAIResourceSkuCapacity::setMaximum(const qint64 &maximum) {
    m_maximum = maximum;
...
qint64 OAIResourceSkuCapacity::getMinimum() const {
    return m_minimum;
}
void OAIResourceSkuCapacity::setMinimum(const qint64 &minimum) {
    m_minimum = minimum;
