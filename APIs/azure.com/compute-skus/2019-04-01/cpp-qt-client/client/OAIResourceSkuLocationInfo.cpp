...
void OAIResourceSkuLocationInfo::initializeModel() {
    ...
    m_zone_details_isSet = false;
    m_zone_details_isValid = false;
...
void OAIResourceSkuLocationInfo::fromJsonObject(QJsonObject json) {
    ...
    m_zone_details_isValid = ::OpenAPI::fromJsonValue(m_zone_details, json[QString("zoneDetails")]);
    m_zone_details_isSet = !json[QString("zoneDetails")].isNull() && m_zone_details_isValid;
...
QJsonObject OAIResourceSkuLocationInfo::asJsonObject() const {
    ...
    if (m_zone_details.size() > 0) {
        obj.insert(QString("zoneDetails"), ::OpenAPI::toJsonValue(m_zone_details));
    }
    if (m_zones.size() > 0) {
...
QList<OAIResourceSkuZoneDetails> OAIResourceSkuLocationInfo::getZoneDetails() const {
    return m_zone_details;
}
void OAIResourceSkuLocationInfo::setZoneDetails(const QList<OAIResourceSkuZoneDetails> &zone_details) {
    m_zone_details = zone_details;
    m_zone_details_isSet = true;
}

bool OAIResourceSkuLocationInfo::is_zone_details_Set() const{
    return m_zone_details_isSet;
}

bool OAIResourceSkuLocationInfo::is_zone_details_Valid() const{
    return m_zone_details_isValid;
}
