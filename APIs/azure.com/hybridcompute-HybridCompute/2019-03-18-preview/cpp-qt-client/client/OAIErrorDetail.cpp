...
QList<OAIErrorDetail> OAIErrorDetail::getDetails() const {
    return m_details;
}
void OAIErrorDetail::setDetails(const QList<OAIErrorDetail> &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIErrorDetail::is_details_Set() const{
    return m_details_isSet;
}

bool OAIErrorDetail::is_details_Valid() const{
