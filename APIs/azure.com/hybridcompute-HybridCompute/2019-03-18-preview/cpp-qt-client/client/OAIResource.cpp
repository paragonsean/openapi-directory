...
OAIIdentity OAIResource::getIdentity() const {
    return m_identity;
}
void OAIResource::setIdentity(const OAIIdentity &identity) {
    m_identity = identity;
    m_identity_isSet = true;
}

bool OAIResource::is_identity_Set() const{
    return m_identity_isSet;
}

bool OAIResource::is_identity_Valid() const{
