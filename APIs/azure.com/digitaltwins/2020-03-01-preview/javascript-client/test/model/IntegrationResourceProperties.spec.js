...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDigitalTwinsManagementClient.IntegrationResourceProperties();
  });
  ...
  describe('IntegrationResourceProperties', function() {
    it('should create an instance of IntegrationResourceProperties', function() {
      // uncomment below and update the code to test IntegrationResourceProperties
      //var instance = new AzureDigitalTwinsManagementClient.IntegrationResourceProperties();
      //expect(instance).to.be.a(AzureDigitalTwinsManagementClient.IntegrationResourceProperties);
    });
