...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDigitalTwinsManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new AzureDigitalTwinsManagementClient.Operation();
      //expect(instance).to.be.a(AzureDigitalTwinsManagementClient.Operation);
    });
