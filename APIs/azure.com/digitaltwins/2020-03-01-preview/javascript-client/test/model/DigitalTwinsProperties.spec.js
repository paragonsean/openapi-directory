...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDigitalTwinsManagementClient.DigitalTwinsProperties();
  });
  ...
  describe('DigitalTwinsProperties', function() {
    it('should create an instance of DigitalTwinsProperties', function() {
      // uncomment below and update the code to test DigitalTwinsProperties
      //var instance = new AzureDigitalTwinsManagementClient.DigitalTwinsProperties();
      //expect(instance).to.be.a(AzureDigitalTwinsManagementClient.DigitalTwinsProperties);
    });
