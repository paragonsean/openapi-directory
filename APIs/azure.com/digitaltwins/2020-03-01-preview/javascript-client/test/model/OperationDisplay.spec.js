...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDigitalTwinsManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureDigitalTwinsManagementClient.OperationDisplay();
      //expect(instance).to.be.a(AzureDigitalTwinsManagementClient.OperationDisplay);
    });
