...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MixedReality.RemoteRenderingAccountsGetKeys200Response();
  });
  ...
  describe('RemoteRenderingAccountsGetKeys200Response', function() {
    it('should create an instance of RemoteRenderingAccountsGetKeys200Response', function() {
      // uncomment below and update the code to test RemoteRenderingAccountsGetKeys200Response
      //var instance = new MixedReality.RemoteRenderingAccountsGetKeys200Response();
      //expect(instance).to.be.a(MixedReality.RemoteRenderingAccountsGetKeys200Response);
    });
