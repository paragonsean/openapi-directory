...
export default class GETApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the dpsCertificatesList operation.
     * @callback module:api/GETApi~dpsCertificatesListCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apiVersion The version of the API.
     * @param {module:api/GETApi~dpsCertificatesListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CertificateListDescription}
     */
    dpsCertificatesList(subscriptionId, resourceGroupName, provisioningServiceName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling dpsCertificatesList");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling dpsCertificatesList");
      }
      // verify the required parameter 'provisioningServiceName' is set
      if (provisioningServiceName === undefined || provisioningServiceName === null) {
        throw new Error("Missing the required parameter 'provisioningServiceName' when calling dpsCertificatesList");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling dpsCertificatesList");
      }
