...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void dpsCertificatesList(const QString &subscription_id, const QString &resource_group_name, const QString &provisioning_service_name, const QString &api_version);
...
private:
    ...
    void dpsCertificatesListCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void dpsCertificatesListSignal(OAICertificateListDescription summary);
    ...
    void dpsCertificatesListSignalFull(OAIHttpRequestWorker *worker, OAICertificateListDescription summary);
    ...
    Q_DECL_DEPRECATED_X("Use dpsCertificatesListSignalError() instead")
    void dpsCertificatesListSignalE(OAICertificateListDescription summary, QNetworkReply::NetworkError error_type, QString error_str);
    void dpsCertificatesListSignalError(OAICertificateListDescription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use dpsCertificatesListSignalErrorFull() instead")
    void dpsCertificatesListSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void dpsCertificatesListSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
