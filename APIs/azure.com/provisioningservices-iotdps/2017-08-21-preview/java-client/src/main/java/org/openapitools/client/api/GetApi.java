...
public class GetApi {
    ...
    /**
     * Build call for dpsCertificatesList
     * @param subscriptionId The subscription identifier. (required)
     ...
     */
    public okhttp3.Call dpsCertificatesListCall(String subscriptionId, String resourceGroupName, String provisioningServiceName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dpsCertificatesListValidateBeforeCall(String subscriptionId, String resourceGroupName, String provisioningServiceName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling dpsCertificatesList(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling dpsCertificatesList(Async)");
        }

        // verify the required parameter 'provisioningServiceName' is set
        if (provisioningServiceName == null) {
            throw new ApiException("Missing the required parameter 'provisioningServiceName' when calling dpsCertificatesList(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling dpsCertificatesList(Async)");
        }

        return dpsCertificatesListCall(subscriptionId, resourceGroupName, provisioningServiceName, apiVersion, _callback);
     ...
     */
    public CertificateListDescription dpsCertificatesList(String subscriptionId, String resourceGroupName, String provisioningServiceName, String apiVersion) throws ApiException {
        ApiResponse<CertificateListDescription> localVarResp = dpsCertificatesListWithHttpInfo(subscriptionId, resourceGroupName, provisioningServiceName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CertificateListDescription> dpsCertificatesListWithHttpInfo(String subscriptionId, String resourceGroupName, String provisioningServiceName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = dpsCertificatesListValidateBeforeCall(subscriptionId, resourceGroupName, provisioningServiceName, apiVersion, null);
     ...
     */
    public okhttp3.Call dpsCertificatesListAsync(String subscriptionId, String resourceGroupName, String provisioningServiceName, String apiVersion, final ApiCallback<CertificateListDescription> _callback) throws ApiException {

        okhttp3.Call localVarCall = dpsCertificatesListValidateBeforeCall(subscriptionId, resourceGroupName, provisioningServiceName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<CertificateListDescription>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
