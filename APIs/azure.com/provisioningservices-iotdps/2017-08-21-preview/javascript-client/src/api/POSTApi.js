...
export default class POSTApi {
    ...
    */
     ...
     * @param {String} apiVersion The version of the API.
     * @param {module:model/VerificationCodeRequest} request 
     * @param {Object} opts Optional parameters
     * @param {String} [certificateName2] Common Name for the certificate.
     * @param {Blob} [certificateRawBytes] Raw data of certificate.
     * @param {Boolean} [certificateIsVerified] Indicates if the certificate has been verified by owner of the private key.
    ...
    /**
     * Callback function to receive the result of the iotDpsResourceCheckNameAvailability operation.
     * @callback module:api/POSTApi~iotDpsResourceCheckNameAvailabilityCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/POSTApi~iotDpsResourceCheckNameAvailabilityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NameAvailabilityInfo}
     */
    iotDpsResourceCheckNameAvailability(subscriptionId, apiVersion, _arguments, callback) {
      let postBody = _arguments;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling iotDpsResourceCheckNameAvailability");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling iotDpsResourceCheckNameAvailability");
      }
      // verify the required parameter '_arguments' is set
      if (_arguments === undefined || _arguments === null) {
        throw new Error("Missing the required parameter '_arguments' when calling iotDpsResourceCheckNameAvailability");
      }
    ...
    /**
     * Callback function to receive the result of the iotDpsResourceGetKeysForKeyName operation.
     * @callback module:api/POSTApi~iotDpsResourceGetKeysForKeyNameCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apiVersion The version of the API.
     * @param {module:api/POSTApi~iotDpsResourceGetKeysForKeyNameCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SharedAccessSignatureAuthorizationRuleAccessRightsDescription}
     */
    iotDpsResourceGetKeysForKeyName(provisioningServiceName, keyName, subscriptionId, resourceGroupName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'provisioningServiceName' is set
      if (provisioningServiceName === undefined || provisioningServiceName === null) {
        throw new Error("Missing the required parameter 'provisioningServiceName' when calling iotDpsResourceGetKeysForKeyName");
      }
      // verify the required parameter 'keyName' is set
      if (keyName === undefined || keyName === null) {
        throw new Error("Missing the required parameter 'keyName' when calling iotDpsResourceGetKeysForKeyName");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling iotDpsResourceGetKeysForKeyName");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling iotDpsResourceGetKeysForKeyName");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling iotDpsResourceGetKeysForKeyName");
      }
