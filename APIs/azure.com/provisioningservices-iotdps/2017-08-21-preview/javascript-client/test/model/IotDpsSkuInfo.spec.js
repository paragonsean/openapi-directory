...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IotDpsClient.IotDpsSkuInfo();
  });
  ...
  describe('IotDpsSkuInfo', function() {
    it('should create an instance of IotDpsSkuInfo', function() {
      // uncomment below and update the code to test IotDpsSkuInfo
      //var instance = new IotDpsClient.IotDpsSkuInfo();
      //expect(instance).to.be.a(IotDpsClient.IotDpsSkuInfo);
    });
