...
public class Example {
  public static void main(String[] args) {
    ...
    String name = "name_example"; // String | The name of the diagnostic setting.
    try {
      apiInstance.diagnosticSettingsDelete(resourceUri, apiVersion, name);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String name = "name_example"; // String | The name of the diagnostic setting.
    try {
      DiagnosticSettingsResource result = apiInstance.diagnosticSettingsGet(resourceUri, apiVersion, name);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    try {
      DiagnosticSettingsResourceCollection result = apiInstance.diagnosticSettingsList(resourceUri, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
