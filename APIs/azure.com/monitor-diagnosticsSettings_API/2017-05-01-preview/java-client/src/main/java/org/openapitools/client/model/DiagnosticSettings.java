...
public class DiagnosticSettings {
  ...
  public static final String SERIALIZED_NAME_LOG_ANALYTICS_DESTINATION_TYPE = "logAnalyticsDestinationType";
  @SerializedName(SERIALIZED_NAME_LOG_ANALYTICS_DESTINATION_TYPE)
  ...
  public DiagnosticSettings logAnalyticsDestinationType(String logAnalyticsDestinationType) {
   ...
   * @return logAnalyticsDestinationType
   */
  @javax.annotation.Nullable
  public String getLogAnalyticsDestinationType() {
    return logAnalyticsDestinationType;
  }

  public void setLogAnalyticsDestinationType(String logAnalyticsDestinationType) {
    this.logAnalyticsDestinationType = logAnalyticsDestinationType;
  }
  ...
  public DiagnosticSettings metrics(List<MetricSettings> metrics) {
    this.metrics = metrics;
    return this;
  }

  public DiagnosticSettings addMetricsItem(MetricSettings metricsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventHubAuthorizationRuleId, diagnosticSettings.eventHubAuthorizationRuleId) &&
        ...
        Objects.equals(this.logAnalyticsDestinationType, diagnosticSettings.logAnalyticsDestinationType) &&
        Objects.equals(this.logs, diagnosticSettings.logs) &&
        Objects.equals(this.metrics, diagnosticSettings.metrics) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventHubAuthorizationRuleId, eventHubName, logAnalyticsDestinationType, logs, metrics, serviceBusRuleId, storageAccountId, workspaceId);
  }
  ...
  public String toString() {
    ...
    sb.append("    logAnalyticsDestinationType: ").append(toIndentedString(logAnalyticsDestinationType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("logAnalyticsDestinationType");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("logAnalyticsDestinationType") != null && !jsonObj.get("logAnalyticsDestinationType").isJsonNull()) && !jsonObj.get("logAnalyticsDestinationType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `logAnalyticsDestinationType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logAnalyticsDestinationType").toString()));
      }
