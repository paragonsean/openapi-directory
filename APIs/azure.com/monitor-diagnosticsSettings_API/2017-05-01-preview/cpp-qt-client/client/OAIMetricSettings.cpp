...
QString OAIMetricSettings::getCategory() const {
    return m_category;
}
void OAIMetricSettings::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIMetricSettings::is_category_Set() const{
    return m_category_isSet;
}

bool OAIMetricSettings::is_category_Valid() const{
