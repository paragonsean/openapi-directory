...
class Connection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ConnectionProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ConnectionProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ConnectionProperties} properties
 */
