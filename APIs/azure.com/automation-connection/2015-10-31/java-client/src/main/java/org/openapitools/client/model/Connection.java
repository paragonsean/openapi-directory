...
import org.openapitools.client.model.ConnectionProperties;
...
public class Connection {
  ...
  public Connection properties(ConnectionProperties properties) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        ConnectionProperties.validateJsonElement(jsonObj.get("properties"));
      }
