...
OAIConnectionProperties OAIConnection::getProperties() const {
    return m_properties;
}
void OAIConnection::setProperties(const OAIConnectionProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIConnection::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIConnection::is_properties_Valid() const{
