...
public class NetworkStatusApiTest {
     ...
     */
    @Test
    public void networkStatusGetByServiceTest() throws ApiException {
        String subscriptionId = null;
        String resourceGroupName = null;
        String serviceName = null;
        String apiVersion = null;
        NetworkStatusContract response = api.networkStatusGetByService(subscriptionId, resourceGroupName, serviceName, apiVersion);
