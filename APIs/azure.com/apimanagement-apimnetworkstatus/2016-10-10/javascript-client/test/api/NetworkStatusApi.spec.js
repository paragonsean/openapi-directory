...
(function(root, factory) {
  ...
  describe('NetworkStatusApi', function() {
    describe('networkStatusGetByService', function() {
      it('should call networkStatusGetByService successfully', function(done) {
        //uncomment below and update the code to test networkStatusGetByService
        //instance.networkStatusGetByService(function(error) {
