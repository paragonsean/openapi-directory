...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ConnectivityStatusContract();
  });
  ...
  describe('ConnectivityStatusContract', function() {
    it('should create an instance of ConnectivityStatusContract', function() {
      // uncomment below and update the code to test ConnectivityStatusContract
      //var instance = new ApiManagementClient.ConnectivityStatusContract();
      //expect(instance).to.be.a(ApiManagementClient.ConnectivityStatusContract);
    });
    ...
    it('should have the property lastStatusChange (base name: "lastStatusChange")', function() {
