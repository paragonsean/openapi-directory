...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.NetworkStatusContractByLocation();
  });
  ...
  describe('NetworkStatusContractByLocation', function() {
    it('should create an instance of NetworkStatusContractByLocation', function() {
      // uncomment below and update the code to test NetworkStatusContractByLocation
      //var instance = new ApiManagementClient.NetworkStatusContractByLocation();
      //expect(instance).to.be.a(ApiManagementClient.NetworkStatusContractByLocation);
    });
    ...
    it('should have the property networkStatus (base name: "networkStatus")', function() {
      // uncomment below and update the code to test the property networkStatus
      //var instance = new ApiManagementClient.NetworkStatusContractByLocation();
      //expect(instance).to.be();
    });
