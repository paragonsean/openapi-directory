...
class NetworkStatusContract {
     ...
     * @param connectivityStatus {Array.<module:model/ConnectivityStatusContract>} Gets the list of Connectivity Status to the Resources on which the service depends upon.
