...
class RelationshipsLookup(Model):
    ...
    def __init__(self, existing_relationship_name: str=None, profile_name: str=None, profile_property_references: List[ParticipantProfilePropertyReference]=None, related_profile_name: str=None, related_profile_property_references: List[ParticipantProfilePropertyReference]=None):
