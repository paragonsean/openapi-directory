...
async def test_interactions_create_or_update(client):
    ...
    """
    parameters = {"properties":{"participantProfiles":[{"role":"role","profileTypeName":"profileTypeName","displayName":{"key":"displayName"},"description":{"key":"description"},"participantPropertyReferences":[{"targetPropertyName":"targetPropertyName","sourcePropertyName":"sourcePropertyName"},{"targetPropertyName":"targetPropertyName","sourcePropertyName":"sourcePropertyName"}],"participantName":"participantName"},{"role":"role","profileTypeName":"profileTypeName","displayName":{"key":"displayName"},"description":{"key":"description"},"participantPropertyReferences":[{"targetPropertyName":"targetPropertyName","sourcePropertyName":"sourcePropertyName"},{"targetPropertyName":"targetPropertyName","sourcePropertyName":"sourcePropertyName"}],"participantName":"participantName"}],"primaryParticipantProfilePropertyName":"primaryParticipantProfilePropertyName","dataSourcePrecedenceRules":[{"dataSource":{"name":"name","id":0,"dataSourceType":"Connector","dataSourceReferenceId":"dataSourceReferenceId","status":"None"},"precedence":6},{"dataSource":{"name":"name","id":0,"dataSourceType":"Connector","dataSourceReferenceId":"dataSourceReferenceId","status":"None"},"precedence":6}],"isActivity":True,"defaultDataSource":{"name":"name","id":0,"dataSourceType":"Connector","dataSourceReferenceId":"dataSourceReferenceId","status":"None"},"idPropertyNames":["idPropertyNames","idPropertyNames"]}}
