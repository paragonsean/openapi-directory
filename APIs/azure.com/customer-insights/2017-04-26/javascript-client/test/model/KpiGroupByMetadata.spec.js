...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerInsightsManagementClient.KpiGroupByMetadata();
  });
  ...
  describe('KpiGroupByMetadata', function() {
    it('should create an instance of KpiGroupByMetadata', function() {
      // uncomment below and update the code to test KpiGroupByMetadata
      //var instance = new CustomerInsightsManagementClient.KpiGroupByMetadata();
      //expect(instance).to.be.a(CustomerInsightsManagementClient.KpiGroupByMetadata);
    });
