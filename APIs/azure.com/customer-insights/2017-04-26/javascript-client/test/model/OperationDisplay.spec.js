...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerInsightsManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new CustomerInsightsManagementClient.OperationDisplay();
      //expect(instance).to.be.a(CustomerInsightsManagementClient.OperationDisplay);
    });
