...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerInsightsManagementClient.Role();
  });
  ...
  describe('Role', function() {
    it('should create an instance of Role', function() {
      ...
      //var instance = new CustomerInsightsManagementClient.Role();
      //expect(instance).to.be.a(CustomerInsightsManagementClient.Role);
    });
