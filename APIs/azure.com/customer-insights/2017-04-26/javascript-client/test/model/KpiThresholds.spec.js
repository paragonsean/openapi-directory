...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerInsightsManagementClient.KpiThresholds();
  });
  ...
  describe('KpiThresholds', function() {
    it('should create an instance of KpiThresholds', function() {
      // uncomment below and update the code to test KpiThresholds
      //var instance = new CustomerInsightsManagementClient.KpiThresholds();
      //expect(instance).to.be.a(CustomerInsightsManagementClient.KpiThresholds);
    });

    it('should have the property increasingKpi (base name: "increasingKpi")', function() {
      // uncomment below and update the code to test the property increasingKpi
      //var instance = new CustomerInsightsManagementClient.KpiThresholds();
