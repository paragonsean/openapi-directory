...
/*
 * OAIProfileTypeDefinition.h
 *
 * The profile type definition.
 */

#ifndef OAIProfileTypeDefinition_H
#define OAIProfileTypeDefinition_H
...
class OAIProfileTypeDefinition : public OAIObject {
public:
    OAIProfileTypeDefinition();
    OAIProfileTypeDefinition(QString json);
    ~OAIProfileTypeDefinition() override;
    ...
    QList<OAIStrongId> getStrongIds() const;
    void setStrongIds(const QList<OAIStrongId> &strong_ids);
    bool is_strong_ids_Set() const;
    bool is_strong_ids_Valid() const;
...
private:
    ...
    QList<OAIStrongId> m_strong_ids;
    bool m_strong_ids_isSet;
    bool m_strong_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfileTypeDefinition)

#endif // OAIProfileTypeDefinition_H
