...
QList<OAIParticipantProfilePropertyReference> OAIRelationshipLinkDefinition::getProfilePropertyReferences() const {
    return m_profile_property_references;
}
void OAIRelationshipLinkDefinition::setProfilePropertyReferences(const QList<OAIParticipantProfilePropertyReference> &profile_property_references) {
...
QList<OAIParticipantProfilePropertyReference> OAIRelationshipLinkDefinition::getRelatedProfilePropertyReferences() const {
    return m_related_profile_property_references;
}
void OAIRelationshipLinkDefinition::setRelatedProfilePropertyReferences(const QList<OAIParticipantProfilePropertyReference> &related_profile_property_references) {
