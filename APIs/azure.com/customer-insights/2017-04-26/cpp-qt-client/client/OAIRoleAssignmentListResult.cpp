...
QList<OAIRoleAssignmentResourceFormat> OAIRoleAssignmentListResult::getValue() const {
    return m_value;
}
void OAIRoleAssignmentListResult::setValue(const QList<OAIRoleAssignmentResourceFormat> &value) {
    m_value = value;
    m_value_isSet = true;
}
