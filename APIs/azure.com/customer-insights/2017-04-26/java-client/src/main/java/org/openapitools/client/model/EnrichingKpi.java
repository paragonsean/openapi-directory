...
public class EnrichingKpi {
  ...
  public EnrichingKpi aliases(List<KpiAlias> aliases) {
    this.aliases = aliases;
    return this;
  }

  public EnrichingKpi addAliasesItem(KpiAlias aliasesItem) {
  ...
  public EnrichingKpi calculationWindow(CalculationWindowEnum calculationWindow) {
  ...
  public EnrichingKpi calculationWindowFieldName(String calculationWindowFieldName) {
  ...
  public EnrichingKpi description(Map<String, String> description) {
    this.description = description;
    return this;
  }

  public EnrichingKpi putDescriptionItem(String key, String descriptionItem) {
  ...
  public EnrichingKpi displayName(Map<String, String> displayName) {
    this.displayName = displayName;
    return this;
  }

  public EnrichingKpi putDisplayNameItem(String key, String displayNameItem) {
  ...
  public EnrichingKpi entityType(EntityTypeEnum entityType) {
  ...
  public EnrichingKpi entityTypeName(String entityTypeName) {
  ...
  public EnrichingKpi expression(String expression) {
  ...
  public EnrichingKpi extracts(List<KpiExtract> extracts) {
    this.extracts = extracts;
    return this;
  }

  public EnrichingKpi addExtractsItem(KpiExtract extractsItem) {
  ...
  public EnrichingKpi filter(String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public EnrichingKpi function(FunctionEnum function) {
  ...
  public EnrichingKpi groupBy(List<String> groupBy) {
    this.groupBy = groupBy;
    return this;
  }

  public EnrichingKpi addGroupByItem(String groupByItem) {
  ...
  public EnrichingKpi provisioningState(ProvisioningState provisioningState) {
  ...
  public EnrichingKpi thresHolds(KpiThresholds thresHolds) {
  ...
  public EnrichingKpi unit(String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnrichingKpi enrichingKpi = (EnrichingKpi) o;
    return Objects.equals(this.aliases, enrichingKpi.aliases) &&
        Objects.equals(this.calculationWindow, enrichingKpi.calculationWindow) &&
        Objects.equals(this.calculationWindowFieldName, enrichingKpi.calculationWindowFieldName) &&
        Objects.equals(this.description, enrichingKpi.description) &&
        Objects.equals(this.displayName, enrichingKpi.displayName) &&
        Objects.equals(this.entityType, enrichingKpi.entityType) &&
        Objects.equals(this.entityTypeName, enrichingKpi.entityTypeName) &&
        Objects.equals(this.expression, enrichingKpi.expression) &&
        Objects.equals(this.extracts, enrichingKpi.extracts) &&
        Objects.equals(this.filter, enrichingKpi.filter) &&
        Objects.equals(this.function, enrichingKpi.function) &&
        Objects.equals(this.groupBy, enrichingKpi.groupBy) &&
        Objects.equals(this.groupByMetadata, enrichingKpi.groupByMetadata) &&
        Objects.equals(this.kpiName, enrichingKpi.kpiName) &&
        Objects.equals(this.participantProfilesMetadata, enrichingKpi.participantProfilesMetadata) &&
        Objects.equals(this.provisioningState, enrichingKpi.provisioningState) &&
        Objects.equals(this.tenantId, enrichingKpi.tenantId) &&
        Objects.equals(this.thresHolds, enrichingKpi.thresHolds) &&
        Objects.equals(this.unit, enrichingKpi.unit);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnrichingKpi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnrichingKpi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnrichingKpi is not found in the empty JSON string", EnrichingKpi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnrichingKpi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnrichingKpi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnrichingKpi.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnrichingKpi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnrichingKpi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnrichingKpi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnrichingKpi.class));

       return (TypeAdapter<T>) new TypeAdapter<EnrichingKpi>() {
           @Override
           public void write(JsonWriter out, EnrichingKpi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnrichingKpi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnrichingKpi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnrichingKpi
   * @throws IOException if the JSON string is invalid with respect to EnrichingKpi
   */
  public static EnrichingKpi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnrichingKpi.class);
  }

  /**
   * Convert an instance of EnrichingKpi to an JSON string
   *
   * @return JSON string
   */
