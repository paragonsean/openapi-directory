...
|**enumValidValues** | [**List&lt;ProfileEnumValidValuesFormat&gt;**](ProfileEnumValidValuesFormat.md) | Describes valid values for an enum property. |  [optional] |
...
|**maxLength** | **Integer** | Max length of string. Used only if type is string. |  [optional] |
