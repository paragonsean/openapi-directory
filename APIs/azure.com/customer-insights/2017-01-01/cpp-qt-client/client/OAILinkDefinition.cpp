...
void OAILinkDefinition::initializeModel() {
    ...
    m_source_interaction_type_isSet = false;
    m_source_interaction_type_isValid = false;

    m_target_profile_type_isSet = false;
    m_target_profile_type_isValid = false;
...
void OAILinkDefinition::fromJsonObject(QJsonObject json) {
    ...
    m_source_interaction_type_isValid = ::OpenAPI::fromJsonValue(m_source_interaction_type, json[QString("sourceInteractionType")]);
    m_source_interaction_type_isSet = !json[QString("sourceInteractionType")].isNull() && m_source_interaction_type_isValid;

    m_target_profile_type_isValid = ::OpenAPI::fromJsonValue(m_target_profile_type, json[QString("targetProfileType")]);
    m_target_profile_type_isSet = !json[QString("targetProfileType")].isNull() && m_target_profile_type_isValid;
...
QJsonObject OAILinkDefinition::asJsonObject() const {
    ...
    if (m_source_interaction_type_isSet) {
        obj.insert(QString("sourceInteractionType"), ::OpenAPI::toJsonValue(m_source_interaction_type));
    }
    if (m_target_profile_type_isSet) {
        obj.insert(QString("targetProfileType"), ::OpenAPI::toJsonValue(m_target_profile_type));
    }
...
QString OAILinkDefinition::getSourceInteractionType() const {
    return m_source_interaction_type;
}
void OAILinkDefinition::setSourceInteractionType(const QString &source_interaction_type) {
    m_source_interaction_type = source_interaction_type;
    m_source_interaction_type_isSet = true;
}

bool OAILinkDefinition::is_source_interaction_type_Set() const{
    return m_source_interaction_type_isSet;
}

bool OAILinkDefinition::is_source_interaction_type_Valid() const{
    return m_source_interaction_type_isValid;
}

QString OAILinkDefinition::getTargetProfileType() const {
    return m_target_profile_type;
}
void OAILinkDefinition::setTargetProfileType(const QString &target_profile_type) {
    m_target_profile_type = target_profile_type;
    m_target_profile_type_isSet = true;
}

bool OAILinkDefinition::is_target_profile_type_Set() const{
    return m_target_profile_type_isSet;
}

bool OAILinkDefinition::is_target_profile_type_Valid() const{
    return m_target_profile_type_isValid;
}
...
bool OAILinkDefinition::isValid() const {
    ...
    return m_participant_property_references_isValid && m_source_interaction_type_isValid && m_target_profile_type_isValid && true;
}
