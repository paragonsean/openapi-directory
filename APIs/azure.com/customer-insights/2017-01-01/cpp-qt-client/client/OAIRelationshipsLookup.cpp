...
QList<OAIParticipantPropertyReference> OAIRelationshipsLookup::getProfilePropertyReferences() const {
    return m_profile_property_references;
}
void OAIRelationshipsLookup::setProfilePropertyReferences(const QList<OAIParticipantPropertyReference> &profile_property_references) {
...
QList<OAIParticipantPropertyReference> OAIRelationshipsLookup::getRelatedProfilePropertyReferences() const {
    return m_related_profile_property_references;
}
void OAIRelationshipsLookup::setRelatedProfilePropertyReferences(const QList<OAIParticipantPropertyReference> &related_profile_property_references) {
