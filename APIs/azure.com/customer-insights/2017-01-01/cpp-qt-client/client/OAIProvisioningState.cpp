...
void OAIProvisioningState::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Provisioning", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProvisioningState::PROVISIONING;
        ...
        m_value = eOAIProvisioningState::EXPIRING;
        m_value_isSet = m_value_isValid = true;
    }
    ...
    else if ( jsonString.compare("HumanIntervention", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProvisioningState::HUMANINTERVENTION;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIProvisioningState::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIProvisioningState::PROVISIONING:
            val = "Provisioning";
            break;
        case eOAIProvisioningState::SUCCEEDED:
            val = "Succeeded";
            break;
        case eOAIProvisioningState::EXPIRING:
            val = "Expiring";
            break;
        case eOAIProvisioningState::DELETING:
            val = "Deleting";
            break;
        case eOAIProvisioningState::HUMANINTERVENTION:
            val = "HumanIntervention";
            break;
