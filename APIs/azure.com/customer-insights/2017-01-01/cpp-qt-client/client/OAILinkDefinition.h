...
public:
    ...
    QString getSourceInteractionType() const;
    void setSourceInteractionType(const QString &source_interaction_type);
    bool is_source_interaction_type_Set() const;
    bool is_source_interaction_type_Valid() const;

    QString getTargetProfileType() const;
    void setTargetProfileType(const QString &target_profile_type);
    bool is_target_profile_type_Set() const;
    bool is_target_profile_type_Valid() const;
...
private:
    ...
    QString m_source_interaction_type;
    bool m_source_interaction_type_isSet;
    bool m_source_interaction_type_isValid;

    QString m_target_profile_type;
    bool m_target_profile_type_isSet;
    bool m_target_profile_type_isValid;
