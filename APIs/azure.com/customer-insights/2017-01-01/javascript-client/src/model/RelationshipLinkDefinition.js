...
class RelationshipLinkDefinition {
     ...
     * @param profilePropertyReferences {Array.<module:model/ParticipantPropertyReference>} The property references for the Profile of the Relationship.
     * @param relatedProfilePropertyReferences {Array.<module:model/ParticipantPropertyReference>} The property references for the Related Profile of the Relationship.
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('profilePropertyReferences')) {
                obj['profilePropertyReferences'] = ApiClient.convertToType(data['profilePropertyReferences'], [ParticipantPropertyReference]);
            }
            ...
            if (data.hasOwnProperty('relatedProfilePropertyReferences')) {
                obj['relatedProfilePropertyReferences'] = ApiClient.convertToType(data['relatedProfilePropertyReferences'], [ParticipantPropertyReference]);
            }
 ...
 * @member {Array.<module:model/ParticipantPropertyReference>} profilePropertyReferences
 */
 ...
 * @member {Array.<module:model/ParticipantPropertyReference>} relatedProfilePropertyReferences
 */
