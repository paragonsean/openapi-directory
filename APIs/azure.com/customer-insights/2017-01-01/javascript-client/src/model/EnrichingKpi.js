...
/**
 * The EnrichingKpi model module.
 * @module model/EnrichingKpi
 * @version 2017-01-01
 */
class EnrichingKpi {
    /**
     * Constructs a new <code>EnrichingKpi</code>.
     * The enriching KPI definition.
     * @alias module:model/EnrichingKpi
     * @implements module:model/KpiDefinition
     * @param calculationWindow {module:model/EnrichingKpi.CalculationWindowEnum} The calculation window.
     * @param entityType {module:model/EnrichingKpi.EntityTypeEnum} The mapping entity type.
     * @param entityTypeName {String} The mapping entity name.
     * @param expression {String} The computation expression for the KPI.
     * @param _function {module:model/EnrichingKpi.FunctionEnum} The computation function for the KPI.
     */
    constructor(calculationWindow, entityType, entityTypeName, expression, _function) { 
        ...
        EnrichingKpi.initialize(this, calculationWindow, entityType, entityTypeName, expression, _function);
    }
    ...
    /**
     * Constructs a <code>EnrichingKpi</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnrichingKpi} obj Optional instance to populate.
     * @return {module:model/EnrichingKpi} The populated <code>EnrichingKpi</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnrichingKpi();
            KpiDefinition.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>EnrichingKpi</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnrichingKpi</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnrichingKpi.RequiredProperties) {
...
EnrichingKpi.RequiredProperties = ["calculationWindow", "entityType", "entityTypeName", "expression", "function"];

/**
 * The aliases.
 * @member {Array.<module:model/KpiAlias>} aliases
 */
EnrichingKpi.prototype['aliases'] = undefined;

/**
 * The calculation window.
 * @member {module:model/EnrichingKpi.CalculationWindowEnum} calculationWindow
 */
EnrichingKpi.prototype['calculationWindow'] = undefined;

/**
 * Name of calculation window field.
 * @member {String} calculationWindowFieldName
 */
EnrichingKpi.prototype['calculationWindowFieldName'] = undefined;

/**
 * Localized description for the KPI.
 * @member {Object.<String, String>} description
 */
EnrichingKpi.prototype['description'] = undefined;

/**
 * Localized display name for the KPI.
 * @member {Object.<String, String>} displayName
 */
EnrichingKpi.prototype['displayName'] = undefined;

/**
 * The mapping entity type.
 * @member {module:model/EnrichingKpi.EntityTypeEnum} entityType
 */
EnrichingKpi.prototype['entityType'] = undefined;

/**
 * The mapping entity name.
 * @member {String} entityTypeName
 */
EnrichingKpi.prototype['entityTypeName'] = undefined;

/**
 * The computation expression for the KPI.
 * @member {String} expression
 */
EnrichingKpi.prototype['expression'] = undefined;

/**
 * The KPI extracts.
 * @member {Array.<module:model/KpiExtract>} extracts
 */
EnrichingKpi.prototype['extracts'] = undefined;

/**
 * The filter expression for the KPI.
 * @member {String} filter
 */
EnrichingKpi.prototype['filter'] = undefined;

/**
 * The computation function for the KPI.
 * @member {module:model/EnrichingKpi.FunctionEnum} function
 */
EnrichingKpi.prototype['function'] = undefined;

/**
 * the group by properties for the KPI.
 * @member {Array.<String>} groupBy
 */
EnrichingKpi.prototype['groupBy'] = undefined;

/**
 * The KPI GroupByMetadata.
 * @member {Array.<module:model/KpiGroupByMetadata>} groupByMetadata
 */
EnrichingKpi.prototype['groupByMetadata'] = undefined;

/**
 * The KPI name.
 * @member {String} kpiName
 */
EnrichingKpi.prototype['kpiName'] = undefined;

/**
 * The participant profiles.
 * @member {Array.<module:model/KpiParticipantProfilesMetadata>} participantProfilesMetadata
 */
EnrichingKpi.prototype['participantProfilesMetadata'] = undefined;

/**
 * @member {module:model/ProvisioningState} provisioningState
 */
EnrichingKpi.prototype['provisioningState'] = undefined;

/**
 * The hub name.
 * @member {String} tenantId
 */
EnrichingKpi.prototype['tenantId'] = undefined;

/**
 * @member {module:model/KpiThresholds} thresHolds
 */
EnrichingKpi.prototype['thresHolds'] = undefined;

/**
 * The unit of measurement for the KPI.
 * @member {String} unit
 */
EnrichingKpi.prototype['unit'] = undefined;


// Implement KpiDefinition interface:
/**
 * The aliases.
 * @member {Array.<module:model/KpiAlias>} aliases
 */
 ...
 * @readonly
 */
EnrichingKpi['CalculationWindowEnum'] = {
