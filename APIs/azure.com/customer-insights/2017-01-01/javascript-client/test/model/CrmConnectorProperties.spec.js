...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerInsightsManagementClient.CrmConnectorProperties();
  });
  ...
  describe('CrmConnectorProperties', function() {
    it('should create an instance of CrmConnectorProperties', function() {
      // uncomment below and update the code to test CrmConnectorProperties
      //var instance = new CustomerInsightsManagementClient.CrmConnectorProperties();
      //expect(instance).to.be.a(CustomerInsightsManagementClient.CrmConnectorProperties);
    });
    ...
    it('should have the property organizationUrl (base name: "organizationUrl")', function() {
