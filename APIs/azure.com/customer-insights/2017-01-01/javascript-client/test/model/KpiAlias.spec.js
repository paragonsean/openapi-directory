...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerInsightsManagementClient.KpiAlias();
  });
  ...
  describe('KpiAlias', function() {
    it('should create an instance of KpiAlias', function() {
      // uncomment below and update the code to test KpiAlias
      //var instance = new CustomerInsightsManagementClient.KpiAlias();
      //expect(instance).to.be.a(CustomerInsightsManagementClient.KpiAlias);
    });
