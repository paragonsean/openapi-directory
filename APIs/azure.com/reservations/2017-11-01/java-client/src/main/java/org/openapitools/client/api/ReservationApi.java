...
public class ReservationApi {
     ...
     */
    public okhttp3.Call reservationGetCall(String reservationId, String reservationOrderId, String apiVersion, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call reservationGetValidateBeforeCall(String reservationId, String reservationOrderId, String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        return reservationGetCall(reservationId, reservationOrderId, apiVersion, _callback);
     ...
     */
    public ReservationResponse reservationGet(String reservationId, String reservationOrderId, String apiVersion) throws ApiException {
        ApiResponse<ReservationResponse> localVarResp = reservationGetWithHttpInfo(reservationId, reservationOrderId, apiVersion);
     ...
     */
    public ApiResponse<ReservationResponse> reservationGetWithHttpInfo(String reservationId, String reservationOrderId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = reservationGetValidateBeforeCall(reservationId, reservationOrderId, apiVersion, null);
     ...
     */
    public okhttp3.Call reservationGetAsync(String reservationId, String reservationOrderId, String apiVersion, final ApiCallback<ReservationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = reservationGetValidateBeforeCall(reservationId, reservationOrderId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<ReservationResponse>(){}.getType();
     ...
     */
    public okhttp3.Call reservationOrderGetCall(String reservationOrderId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reservationOrderGetValidateBeforeCall(String reservationOrderId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'reservationOrderId' is set
        if (reservationOrderId == null) {
        ...
        return reservationOrderGetCall(reservationOrderId, apiVersion, _callback);
     ...
     */
    public ReservationOrderResponse reservationOrderGet(String reservationOrderId, String apiVersion) throws ApiException {
        ApiResponse<ReservationOrderResponse> localVarResp = reservationOrderGetWithHttpInfo(reservationOrderId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ReservationOrderResponse> reservationOrderGetWithHttpInfo(String reservationOrderId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = reservationOrderGetValidateBeforeCall(reservationOrderId, apiVersion, null);
     ...
     */
    public okhttp3.Call reservationOrderGetAsync(String reservationOrderId, String apiVersion, final ApiCallback<ReservationOrderResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = reservationOrderGetValidateBeforeCall(reservationOrderId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<ReservationOrderResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
