...
OAIProvisioningState OAIReservationOrderProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIReservationOrderProperties::setProvisioningState(const OAIProvisioningState &provisioning_state) {
