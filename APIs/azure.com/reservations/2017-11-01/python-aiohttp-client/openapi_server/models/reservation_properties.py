...
class ReservationProperties(Model):
    ...
    def __init__(self, applied_scope_type: AppliedScopeType=None, applied_scopes: List[str]=None, display_name: str=None, effective_date_time: datetime=None, expiry_date: date=None, extended_status_info: ExtendedStatusInfo=None, last_updated_date_time: datetime=None, merge_properties: ReservationMergeProperties=None, provisioning_state: ProvisioningState=None, quantity: int=None, split_properties: ReservationSplitProperties=None):
