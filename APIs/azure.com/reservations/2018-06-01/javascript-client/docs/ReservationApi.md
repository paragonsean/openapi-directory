...
apiInstance.reservationGet(reservationId, reservationOrderId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let reservationOrderId = "reservationOrderId_example"; // String | Order Id of the reservation 
let apiVersion = "apiVersion_example"; // String | Supported version.
apiInstance.reservationOrderGet(reservationOrderId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
