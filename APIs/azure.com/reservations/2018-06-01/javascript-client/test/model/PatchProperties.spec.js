...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureReservation.PatchProperties();
  });
  ...
  describe('PatchProperties', function() {
    it('should create an instance of PatchProperties', function() {
      ...
      //var instance = new AzureReservation.PatchProperties();
      //expect(instance).to.be.a(AzureReservation.PatchProperties);
    });
