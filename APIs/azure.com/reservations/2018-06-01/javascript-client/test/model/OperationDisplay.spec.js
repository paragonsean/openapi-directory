...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureReservation.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureReservation.OperationDisplay();
      //expect(instance).to.be.a(AzureReservation.OperationDisplay);
    });
