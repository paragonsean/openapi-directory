...
# **reservationGet**
> ReservationResponse reservationGet(reservationId, reservationOrderId, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ReservationResponse result = apiInstance.reservationGet(reservationId, reservationOrderId, apiVersion);
...
# **reservationOrderGet**
> ReservationOrderResponse reservationOrderGet(reservationOrderId, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Supported version.
    try {
      ReservationOrderResponse result = apiInstance.reservationOrderGet(reservationOrderId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
