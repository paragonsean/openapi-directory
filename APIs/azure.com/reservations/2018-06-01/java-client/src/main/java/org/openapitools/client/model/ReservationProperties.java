...
public class ReservationProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appliedScopeType, appliedScopes, displayName, effectiveDateTime, expiryDate, extendedStatusInfo, instanceFlexibility, lastUpdatedDateTime, mergeProperties, provisioningState, quantity, reservedResourceType, skuDescription, splitProperties);
  }
