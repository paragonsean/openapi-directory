...
async def reservation_get(request: web.Request, reservation_id, reservation_order_id, api_version) -> web.Response:
...
async def reservation_order_get(request: web.Request, reservation_order_id, api_version) -> web.Response:
