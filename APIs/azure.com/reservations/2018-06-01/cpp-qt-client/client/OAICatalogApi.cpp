...
void OAICatalogApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getCatalog", defaultConf);
    _serverIndices.insert("getCatalog", 0);
}
...
void OAICatalogApi::getCatalog(const QString &api_version, const QString &subscription_id, const QString &reserved_resource_type, const ::OpenAPI::OptionalParam<QString> &location) {
    QString fullPath = QString(_serverConfigs["getCatalog"][_serverIndices.value("getCatalog")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Capacity/catalogs");
    ...
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "reservedResourceType", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("reservedResourceType")).append(querySuffix).append(QUrl::toPercentEncoding(reserved_resource_type));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICatalogApi::getCatalogCallback);
...
void OAICatalogApi::getCatalogCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getCatalogSignal(output);
        Q_EMIT getCatalogSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getCatalogSignalE(output, error_type, error_str);
        Q_EMIT getCatalogSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getCatalogSignalError(output, error_type, error_str);
        Q_EMIT getCatalogSignalErrorFull(worker, error_type, error_str);
    }
}
