...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureReservation.ReservationList();
  });
  ...
  describe('ReservationList', function() {
    it('should create an instance of ReservationList', function() {
      // uncomment below and update the code to test ReservationList
      //var instance = new AzureReservation.ReservationList();
      //expect(instance).to.be.a(AzureReservation.ReservationList);
    });
