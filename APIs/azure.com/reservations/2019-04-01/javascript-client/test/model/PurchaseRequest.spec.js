...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureReservation.PurchaseRequest();
  });
  ...
  describe('PurchaseRequest', function() {
    it('should create an instance of PurchaseRequest', function() {
      ...
      //var instance = new AzureReservation.PurchaseRequest();
      //expect(instance).to.be.a(AzureReservation.PurchaseRequest);
    });
