...
(function(root, factory) {
  ...
  describe('ReservationProperties', function() {
    ...
    it('should have the property billingPlan (base name: "billingPlan")', function() {
      // uncomment below and update the code to test the property billingPlan
      //var instance = new AzureReservation.ReservationProperties();
      //expect(instance).to.be();
    });

    it('should have the property billingScopeId (base name: "billingScopeId")', function() {
      // uncomment below and update the code to test the property billingScopeId
      //var instance = new AzureReservation.ReservationProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property renewDestination (base name: "renewDestination")', function() {
      // uncomment below and update the code to test the property renewDestination
      //var instance = new AzureReservation.ReservationProperties();
      //expect(instance).to.be();
    });

    it('should have the property renewProperties (base name: "renewProperties")', function() {
      // uncomment below and update the code to test the property renewProperties
      //var instance = new AzureReservation.ReservationProperties();
      //expect(instance).to.be();
    });

    it('should have the property renewSource (base name: "renewSource")', function() {
      // uncomment below and update the code to test the property renewSource
      //var instance = new AzureReservation.ReservationProperties();
      //expect(instance).to.be();
    });
