...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureReservation.SplitProperties();
  });
  ...
  describe('SplitProperties', function() {
    it('should create an instance of SplitProperties', function() {
      // uncomment below and update the code to test SplitProperties
      //var instance = new AzureReservation.SplitProperties();
      //expect(instance).to.be.a(AzureReservation.SplitProperties);
    });
