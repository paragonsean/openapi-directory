...
export default class ReservationApi {
    ...
    */
     ...
     * @param {String} [expand] Supported value of this query is renewProperties
     ...
     */
    reservationGet(reservationId, reservationOrderId, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} apiVersion Supported version for this document is 2019-04-01
     * @param {Object} opts Optional parameters
     * @param {String} [expand] May be used to expand the planInformation.
     ...
     */
    reservationOrderGet(reservationOrderId, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'reservationOrderId' is set
      if (reservationOrderId === undefined || reservationOrderId === null) {
