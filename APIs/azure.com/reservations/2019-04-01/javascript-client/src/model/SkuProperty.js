...
class SkuProperty {
    ...
    /**
     * Validates the JSON data with respect to <code>SkuProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SkuProperty</code>.
     */
 ...
 * @member {String} name
 */
SkuProperty.prototype['name'] = undefined;

/**
 * An invariant if the feature is measured by quantity.
 * @member {String} value
 */
SkuProperty.prototype['value'] = undefined;
