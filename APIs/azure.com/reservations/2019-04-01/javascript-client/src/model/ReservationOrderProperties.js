...
import ReservationOrderBillingPlanInformation from './ReservationOrderBillingPlanInformation';
...
class ReservationOrderProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('planInformation')) {
                obj['planInformation'] = ReservationOrderBillingPlanInformation.constructFromObject(data['planInformation']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['planInformation']) { // data not null
          ReservationOrderBillingPlanInformation.validateJSON(data['planInformation']);
        }
        // ensure the json data is a string
 ...
 */
ReservationOrderProperties.prototype['billingPlan'] = undefined;
...
/**
 * @member {module:model/ReservationOrderBillingPlanInformation} planInformation
 */
ReservationOrderProperties.prototype['planInformation'] = undefined;
