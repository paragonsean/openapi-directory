...
void OAIReservationProperties::initializeModel() {
    ...
    m_renew_destination_isSet = false;
    m_renew_destination_isValid = false;

    m_renew_properties_isSet = false;
    m_renew_properties_isValid = false;

    m_renew_source_isSet = false;
    m_renew_source_isValid = false;
...
void OAIReservationProperties::fromJsonObject(QJsonObject json) {
    ...
    m_renew_destination_isValid = ::OpenAPI::fromJsonValue(m_renew_destination, json[QString("renewDestination")]);
    m_renew_destination_isSet = !json[QString("renewDestination")].isNull() && m_renew_destination_isValid;

    m_renew_properties_isValid = ::OpenAPI::fromJsonValue(m_renew_properties, json[QString("renewProperties")]);
    m_renew_properties_isSet = !json[QString("renewProperties")].isNull() && m_renew_properties_isValid;

    m_renew_source_isValid = ::OpenAPI::fromJsonValue(m_renew_source, json[QString("renewSource")]);
    m_renew_source_isSet = !json[QString("renewSource")].isNull() && m_renew_source_isValid;
...
QJsonObject OAIReservationProperties::asJsonObject() const {
    ...
    if (m_renew_destination_isSet) {
        obj.insert(QString("renewDestination"), ::OpenAPI::toJsonValue(m_renew_destination));
    }
    if (m_renew_properties.isSet()) {
        obj.insert(QString("renewProperties"), ::OpenAPI::toJsonValue(m_renew_properties));
    }
    if (m_renew_source_isSet) {
        obj.insert(QString("renewSource"), ::OpenAPI::toJsonValue(m_renew_source));
    }
...
OAIReservationBillingPlan OAIReservationProperties::getBillingPlan() const {
    return m_billing_plan;
}
void OAIReservationProperties::setBillingPlan(const OAIReservationBillingPlan &billing_plan) {
    m_billing_plan = billing_plan;
    m_billing_plan_isSet = true;
}

bool OAIReservationProperties::is_billing_plan_Set() const{
    return m_billing_plan_isSet;
}

bool OAIReservationProperties::is_billing_plan_Valid() const{
    return m_billing_plan_isValid;
}

QString OAIReservationProperties::getBillingScopeId() const {
    return m_billing_scope_id;
}
void OAIReservationProperties::setBillingScopeId(const QString &billing_scope_id) {
    m_billing_scope_id = billing_scope_id;
    m_billing_scope_id_isSet = true;
}

bool OAIReservationProperties::is_billing_scope_id_Set() const{
    return m_billing_scope_id_isSet;
}

bool OAIReservationProperties::is_billing_scope_id_Valid() const{
...
OAIInstanceFlexibility OAIReservationProperties::getInstanceFlexibility() const {
    return m_instance_flexibility;
}
void OAIReservationProperties::setInstanceFlexibility(const OAIInstanceFlexibility &instance_flexibility) {
    m_instance_flexibility = instance_flexibility;
    m_instance_flexibility_isSet = true;
}

bool OAIReservationProperties::is_instance_flexibility_Set() const{
    return m_instance_flexibility_isSet;
}

bool OAIReservationProperties::is_instance_flexibility_Valid() const{
...
QString OAIReservationProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIReservationProperties::setProvisioningState(const QString &provisioning_state) {
...
bool OAIReservationProperties::isRenew() const {
    return m_renew;
}
void OAIReservationProperties::setRenew(const bool &renew) {
    m_renew = renew;
    m_renew_isSet = true;
}

bool OAIReservationProperties::is_renew_Set() const{
    return m_renew_isSet;
}

bool OAIReservationProperties::is_renew_Valid() const{
    return m_renew_isValid;
}

QString OAIReservationProperties::getRenewDestination() const {
    return m_renew_destination;
}
void OAIReservationProperties::setRenewDestination(const QString &renew_destination) {
    m_renew_destination = renew_destination;
    m_renew_destination_isSet = true;
}

bool OAIReservationProperties::is_renew_destination_Set() const{
    return m_renew_destination_isSet;
}

bool OAIReservationProperties::is_renew_destination_Valid() const{
    return m_renew_destination_isValid;
}

OAIRenewPropertiesResponse OAIReservationProperties::getRenewProperties() const {
    return m_renew_properties;
}
void OAIReservationProperties::setRenewProperties(const OAIRenewPropertiesResponse &renew_properties) {
    m_renew_properties = renew_properties;
    m_renew_properties_isSet = true;
}

bool OAIReservationProperties::is_renew_properties_Set() const{
    return m_renew_properties_isSet;
}

bool OAIReservationProperties::is_renew_properties_Valid() const{
    return m_renew_properties_isValid;
}

QString OAIReservationProperties::getRenewSource() const {
    return m_renew_source;
}
void OAIReservationProperties::setRenewSource(const QString &renew_source) {
    m_renew_source = renew_source;
    m_renew_source_isSet = true;
}

bool OAIReservationProperties::is_renew_source_Set() const{
    return m_renew_source_isSet;
}

bool OAIReservationProperties::is_renew_source_Valid() const{
    return m_renew_source_isValid;
}

OAIReservedResourceType OAIReservationProperties::getReservedResourceType() const {
    return m_reserved_resource_type;
}
void OAIReservationProperties::setReservedResourceType(const OAIReservedResourceType &reserved_resource_type) {
    m_reserved_resource_type = reserved_resource_type;
    m_reserved_resource_type_isSet = true;
}

bool OAIReservationProperties::is_reserved_resource_type_Set() const{
    return m_reserved_resource_type_isSet;
}

bool OAIReservationProperties::is_reserved_resource_type_Valid() const{
    return m_reserved_resource_type_isValid;
}

QString OAIReservationProperties::getSkuDescription() const {
    return m_sku_description;
}
void OAIReservationProperties::setSkuDescription(const QString &sku_description) {
    m_sku_description = sku_description;
    m_sku_description_isSet = true;
}

bool OAIReservationProperties::is_sku_description_Set() const{
    return m_sku_description_isSet;
}

bool OAIReservationProperties::is_sku_description_Valid() const{
...
OAIReservationTerm OAIReservationProperties::getTerm() const {
    return m_term;
}
void OAIReservationProperties::setTerm(const OAIReservationTerm &term) {
    m_term = term;
    m_term_isSet = true;
}

bool OAIReservationProperties::is_term_Set() const{
    return m_term_isSet;
}

bool OAIReservationProperties::is_term_Valid() const{
