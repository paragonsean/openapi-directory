...
void OAIErrorResponseCode::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("PatchValuesSameAsExisting", Qt::CaseInsensitive) == 0) {
        m_value = eOAIErrorResponseCode::PATCHVALUESSAMEASEXISTING;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIErrorResponseCode::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIErrorResponseCode::APPLIEDSCOPESNOTASSOCIATEDWITHCOMMERCEACCOUNT:
            ...
            break;
        case eOAIErrorResponseCode::PATCHVALUESSAMEASEXISTING:
            val = "PatchValuesSameAsExisting";
            break;
