...
namespace OpenAPI {
class OAIReservationOrderBillingPlanInformation;
...
public:
    ...
    OAIReservationOrderBillingPlanInformation getPlanInformation() const;
    void setPlanInformation(const OAIReservationOrderBillingPlanInformation &plan_information);
    bool is_plan_information_Set() const;
    bool is_plan_information_Valid() const;
...
private:
    ...
    OAIReservationOrderBillingPlanInformation m_plan_information;
    bool m_plan_information_isSet;
    bool m_plan_information_isValid;
