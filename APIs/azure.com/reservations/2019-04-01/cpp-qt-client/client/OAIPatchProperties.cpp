...
bool OAIPatchProperties::isRenew() const {
    return m_renew;
}
void OAIPatchProperties::setRenew(const bool &renew) {
    m_renew = renew;
    m_renew_isSet = true;
}

bool OAIPatchProperties::is_renew_Set() const{
    return m_renew_isSet;
}

bool OAIPatchProperties::is_renew_Valid() const{
    return m_renew_isValid;
}

OAIPatchProperties_renewProperties OAIPatchProperties::getRenewProperties() const {
    return m_renew_properties;
}
void OAIPatchProperties::setRenewProperties(const OAIPatchProperties_renewProperties &renew_properties) {
    m_renew_properties = renew_properties;
    m_renew_properties_isSet = true;
}

bool OAIPatchProperties::is_renew_properties_Set() const{
    return m_renew_properties_isSet;
}

bool OAIPatchProperties::is_renew_properties_Valid() const{
