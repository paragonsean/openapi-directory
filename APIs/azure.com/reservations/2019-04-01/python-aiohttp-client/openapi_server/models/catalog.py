...
class Catalog(Model):
    ...
    def __init__(self, billing_plans: Dict[str, List[ReservationBillingPlan]]=None, locations: List[str]=None, name: str=None, resource_type: str=None, restrictions: List[SkuRestriction]=None, sku_properties: List[SkuProperty]=None, terms: List[ReservationTerm]=None):
        """Catalog - a model defined in OpenAPI

        :param billing_plans: The billing_plans of this Catalog.
        ...
        """
        self.openapi_types = {
            'billing_plans': Dict[str, List[ReservationBillingPlan]],
            'locations': List[str],
            'name': str,
            'resource_type': str,
    ...
    def billing_plans(self):
        """Gets the billing_plans of this Catalog.

        The billing plan options available for this SKU.

        :return: The billing_plans of this Catalog.
        :rtype: Dict[str, List[ReservationBillingPlan]]
        """
        return self._billing_plans

    @billing_plans.setter
    def billing_plans(self, billing_plans):
        """Sets the billing_plans of this Catalog.

        The billing plan options available for this SKU.

        :param billing_plans: The billing_plans of this Catalog.
        :type billing_plans: Dict[str, List[ReservationBillingPlan]]
        """
