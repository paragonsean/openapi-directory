...
class ContainerServiceNetworkProfile(Model):
    ...
    def __init__(self, dns_service_ip: str='10.0.0.10', docker_bridge_cidr: str='172.17.0.1/16', network_plugin: str='kubenet', network_policy: str=None, pod_cidr: str='10.244.0.0/16', service_cidr: str='10.0.0.0/16'):
    ...
    def network_policy(self, network_policy):
        ...
        """
        allowed_values = ["calico"]  # noqa: E501
