...
import ManagedClusterAPIServerAccessProfile from './ManagedClusterAPIServerAccessProfile';
...
class ManagedClusterProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('apiServerAccessProfile')) {
                obj['apiServerAccessProfile'] = ManagedClusterAPIServerAccessProfile.constructFromObject(data['apiServerAccessProfile']);
            }
            ...
            if (data.hasOwnProperty('identityProfile')) {
                obj['identityProfile'] = ApiClient.convertToType(data['identityProfile'], Object);
            }
            ...
            if (data.hasOwnProperty('privateFQDN')) {
                obj['privateFQDN'] = ApiClient.convertToType(data['privateFQDN'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['apiServerAccessProfile']) { // data not null
          ManagedClusterAPIServerAccessProfile.validateJSON(data['apiServerAccessProfile']);
        }
        ...
        // ensure the json data is a string
        if (data['privateFQDN'] && !(typeof data['privateFQDN'] === 'string' || data['privateFQDN'] instanceof String)) {
            throw new Error("Expected the field `privateFQDN` to be a primitive type in the JSON string but got " + data['privateFQDN']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ManagedClusterAPIServerAccessProfile} apiServerAccessProfile
 */
ManagedClusterProperties.prototype['apiServerAccessProfile'] = undefined;

/**
 * ResourceId of the disk encryption set to use for enabling encryption at rest.
 * @member {String} diskEncryptionSetID
 */
ManagedClusterProperties.prototype['diskEncryptionSetID'] = undefined;
 ...
 * @member {Object} identityProfile
 */
ManagedClusterProperties.prototype['identityProfile'] = undefined;
 ...
 * @member {String} privateFQDN
 */
ManagedClusterProperties.prototype['privateFQDN'] = undefined;
