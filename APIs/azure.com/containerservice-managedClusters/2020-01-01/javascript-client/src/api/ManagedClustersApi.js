...
export default class ManagedClustersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the managedClustersListClusterMonitoringUserCredentials operation.
     * @callback module:api/ManagedClustersApi~managedClustersListClusterMonitoringUserCredentialsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CredentialResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} resourceGroupName The name of the resource group.
     * @param {String} resourceName The name of the managed cluster resource.
     * @param {module:api/ManagedClustersApi~managedClustersListClusterMonitoringUserCredentialsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CredentialResults}
     */
    managedClustersListClusterMonitoringUserCredentials(apiVersion, subscriptionId, resourceGroupName, resourceName, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling managedClustersListClusterMonitoringUserCredentials");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling managedClustersListClusterMonitoringUserCredentials");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling managedClustersListClusterMonitoringUserCredentials");
      }
      // verify the required parameter 'resourceName' is set
      if (resourceName === undefined || resourceName === null) {
        throw new Error("Missing the required parameter 'resourceName' when calling managedClustersListClusterMonitoringUserCredentials");
      }
      ...
      let returnType = CredentialResults;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/listClusterMonitoringUserCredential', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the managedClustersRotateClusterCertificates operation.
     * @callback module:api/ManagedClustersApi~managedClustersRotateClusterCertificatesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} resourceGroupName The name of the resource group.
     * @param {String} resourceName The name of the managed cluster resource.
     * @param {module:api/ManagedClustersApi~managedClustersRotateClusterCertificatesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    managedClustersRotateClusterCertificates(apiVersion, subscriptionId, resourceGroupName, resourceName, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling managedClustersRotateClusterCertificates");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling managedClustersRotateClusterCertificates");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling managedClustersRotateClusterCertificates");
      }
      // verify the required parameter 'resourceName' is set
      if (resourceName === undefined || resourceName === null) {
        throw new Error("Missing the required parameter 'resourceName' when calling managedClustersRotateClusterCertificates");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/rotateClusterCertificates', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
