...
void OAIContainerServiceNetworkProfile::initializeModel() {
    ...
    m_outbound_type_isSet = false;
    m_outbound_type_isValid = false;
...
void OAIContainerServiceNetworkProfile::fromJsonObject(QJsonObject json) {
    ...
    m_outbound_type_isValid = ::OpenAPI::fromJsonValue(m_outbound_type, json[QString("outboundType")]);
    m_outbound_type_isSet = !json[QString("outboundType")].isNull() && m_outbound_type_isValid;
...
QJsonObject OAIContainerServiceNetworkProfile::asJsonObject() const {
    ...
    if (m_outbound_type_isSet) {
        obj.insert(QString("outboundType"), ::OpenAPI::toJsonValue(m_outbound_type));
    }
    if (m_pod_cidr_isSet) {
...
QString OAIContainerServiceNetworkProfile::getOutboundType() const {
    return m_outbound_type;
}
void OAIContainerServiceNetworkProfile::setOutboundType(const QString &outbound_type) {
    m_outbound_type = outbound_type;
    m_outbound_type_isSet = true;
}

bool OAIContainerServiceNetworkProfile::is_outbound_type_Set() const{
    return m_outbound_type_isSet;
}

bool OAIContainerServiceNetworkProfile::is_outbound_type_Valid() const{
    return m_outbound_type_isValid;
}
