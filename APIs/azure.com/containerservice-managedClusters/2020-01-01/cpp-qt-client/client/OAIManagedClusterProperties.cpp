...
void OAIManagedClusterProperties::initializeModel() {
    ...
    m_identity_profile_isSet = false;
    m_identity_profile_isValid = false;
...
void OAIManagedClusterProperties::fromJsonObject(QJsonObject json) {
    ...
    m_identity_profile_isValid = ::OpenAPI::fromJsonValue(m_identity_profile, json[QString("identityProfile")]);
    m_identity_profile_isSet = !json[QString("identityProfile")].isNull() && m_identity_profile_isValid;
...
QJsonObject OAIManagedClusterProperties::asJsonObject() const {
    ...
    if (m_identity_profile_isSet) {
        obj.insert(QString("identityProfile"), ::OpenAPI::toJsonValue(m_identity_profile));
    }
...
QString OAIManagedClusterProperties::getDiskEncryptionSetId() const {
    return m_disk_encryption_set_id;
}
void OAIManagedClusterProperties::setDiskEncryptionSetId(const QString &disk_encryption_set_id) {
    m_disk_encryption_set_id = disk_encryption_set_id;
    m_disk_encryption_set_id_isSet = true;
}

bool OAIManagedClusterProperties::is_disk_encryption_set_id_Set() const{
    return m_disk_encryption_set_id_isSet;
}

bool OAIManagedClusterProperties::is_disk_encryption_set_id_Valid() const{
...
OAIObject OAIManagedClusterProperties::getIdentityProfile() const {
    return m_identity_profile;
}
void OAIManagedClusterProperties::setIdentityProfile(const OAIObject &identity_profile) {
    m_identity_profile = identity_profile;
    m_identity_profile_isSet = true;
}

bool OAIManagedClusterProperties::is_identity_profile_Set() const{
    return m_identity_profile_isSet;
}

bool OAIManagedClusterProperties::is_identity_profile_Valid() const{
    return m_identity_profile_isValid;
}
