...
QMap<QString, QString> OAIManagedClusterAgentPoolProfileProperties::getNodeLabels() const {
    return m_node_labels;
}
void OAIManagedClusterAgentPoolProfileProperties::setNodeLabels(const QMap<QString, QString> &node_labels) {
    m_node_labels = node_labels;
    m_node_labels_isSet = true;
}

bool OAIManagedClusterAgentPoolProfileProperties::is_node_labels_Set() const{
    return m_node_labels_isSet;
}

bool OAIManagedClusterAgentPoolProfileProperties::is_node_labels_Valid() const{
...
QMap<QString, QString> OAIManagedClusterAgentPoolProfileProperties::getTags() const {
    return m_tags;
}
void OAIManagedClusterAgentPoolProfileProperties::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIManagedClusterAgentPoolProfileProperties::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIManagedClusterAgentPoolProfileProperties::is_tags_Valid() const{
