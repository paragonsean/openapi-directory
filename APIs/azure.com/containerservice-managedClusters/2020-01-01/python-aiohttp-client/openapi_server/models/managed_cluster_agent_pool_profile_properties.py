...
class ManagedClusterAgentPoolProfileProperties(Model):
    ...
    def __init__(self, availability_zones: List[str]=None, count: int=1, enable_auto_scaling: bool=None, enable_node_public_ip: bool=None, max_count: int=None, max_pods: int=None, min_count: int=None, node_labels: Dict[str, str]=None, node_taints: List[str]=None, orchestrator_version: str=None, os_disk_size_gb: int=None, os_type: OSType=OSType.LINUX, provisioning_state: str=None, scale_set_eviction_policy: ScaleSetEvictionPolicy=ScaleSetEvictionPolicy.DELETE, scale_set_priority: ScaleSetPriority=ScaleSetPriority.REGULAR, tags: Dict[str, str]=None, type: AgentPoolType=None, vm_size: ContainerServiceVMSize=None, vnet_subnet_id: str=None):
        ...
        :param node_labels: The node_labels of this ManagedClusterAgentPoolProfileProperties.
        ...
        :param tags: The tags of this ManagedClusterAgentPoolProfileProperties.
    ...
    def node_labels(self):
        """Gets the node_labels of this ManagedClusterAgentPoolProfileProperties.

        Agent pool node labels to be persisted across all nodes in agent pool.

        :return: The node_labels of this ManagedClusterAgentPoolProfileProperties.
        :rtype: Dict[str, str]
        """
    ...
    def node_labels(self, node_labels):
        """Sets the node_labels of this ManagedClusterAgentPoolProfileProperties.
    ...
    @property
    def tags(self):
        """Gets the tags of this ManagedClusterAgentPoolProfileProperties.

        Agent pool tags to be persisted on the agent pool virtual machine scale set.

        :return: The tags of this ManagedClusterAgentPoolProfileProperties.
        :rtype: Dict[str, str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ManagedClusterAgentPoolProfileProperties.
