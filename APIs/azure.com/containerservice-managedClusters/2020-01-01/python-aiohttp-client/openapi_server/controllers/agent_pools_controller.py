...
async def agent_pools_get_available_agent_pool_versions(request: web.Request, api_version, subscription_id, resource_group_name, resource_name) -> web.Response:
...
async def agent_pools_get_upgrade_profile(request: web.Request, api_version, subscription_id, resource_group_name, resource_name, agent_pool_name) -> web.Response:
