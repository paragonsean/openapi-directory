...
async def managed_clusters_list_cluster_monitoring_user_credentials(request: web.Request, api_version, subscription_id, resource_group_name, resource_name) -> web.Response:
...
async def managed_clusters_rotate_cluster_certificates(request: web.Request, api_version, subscription_id, resource_group_name, resource_name) -> web.Response:
