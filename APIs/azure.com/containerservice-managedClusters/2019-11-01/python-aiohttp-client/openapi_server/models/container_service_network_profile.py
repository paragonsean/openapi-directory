...
class ContainerServiceNetworkProfile(Model):
    ...
    def __init__(self, dns_service_ip: str='10.0.0.10', docker_bridge_cidr: str='172.17.0.1/16', load_balancer_profile: ManagedClusterLoadBalancerProfile=None, load_balancer_sku: str=None, network_plugin: str='kubenet', network_policy: str=None, outbound_type: str='loadBalancer', pod_cidr: str='10.244.0.0/16', service_cidr: str='10.0.0.0/16'):
        ...
        :param outbound_type: The outbound_type of this ContainerServiceNetworkProfile.
        ...
        self._outbound_type = outbound_type
    ...
    def outbound_type(self):
        """Gets the outbound_type of this ContainerServiceNetworkProfile.

        The outbound (egress) routing method.

        :return: The outbound_type of this ContainerServiceNetworkProfile.
        :rtype: str
        """
        return self._outbound_type

    @outbound_type.setter
    def outbound_type(self, outbound_type):
        """Sets the outbound_type of this ContainerServiceNetworkProfile.

        The outbound (egress) routing method.

        :param outbound_type: The outbound_type of this ContainerServiceNetworkProfile.
        :type outbound_type: str
        """
        allowed_values = ["loadBalancer", "userDefinedRouting"]  # noqa: E501
        if outbound_type not in allowed_values:
            raise ValueError(
                "Invalid value for `outbound_type` ({0}), must be one of {1}"
                .format(outbound_type, allowed_values)
            )
