...
async def test_managed_clusters_create_or_update(client):
    ...
    """
    parameters = {"identity":{"tenantId":"tenantId","principalId":"principalId","type":"SystemAssigned"},"name":"name","location":"location","id":"id","type":"type","properties":{"agentPoolProfiles":[{"osDiskSizeGB":576,"count":8,"vnetSubnetID":"vnetSubnetID","availabilityZones":["availabilityZones","availabilityZones"],"enableAutoScaling":True,"orchestratorVersion":"orchestratorVersion","provisioningState":"provisioningState","type":"VirtualMachineScaleSets","maxCount":6,"tags":{"key":"tags"},"enableNodePublicIP":True,"scaleSetEvictionPolicy":"Delete","nodeTaints":["nodeTaints","nodeTaints"],"scaleSetPriority":"Regular","osType":"Linux","name":"name","minCount":5,"nodeLabels":{"key":"nodeLabels"},"vmSize":"Standard_A1","maxPods":1},{"osDiskSizeGB":576,"count":8,"vnetSubnetID":"vnetSubnetID","availabilityZones":["availabilityZones","availabilityZones"],"enableAutoScaling":True,"orchestratorVersion":"orchestratorVersion","provisioningState":"provisioningState","type":"VirtualMachineScaleSets","maxCount":6,"tags":{"key":"tags"},"enableNodePublicIP":True,"scaleSetEvictionPolicy":"Delete","nodeTaints":["nodeTaints","nodeTaints"],"scaleSetPriority":"Regular","osType":"Linux","name":"name","minCount":5,"nodeLabels":{"key":"nodeLabels"},"vmSize":"Standard_A1","maxPods":1}],"apiServerAccessProfile":{"enablePrivateCluster":True,"authorizedIPRanges":["authorizedIPRanges","authorizedIPRanges"]},"enableRBAC":True,"fqdn":"fqdn","privateFQDN":"privateFQDN","servicePrincipalProfile":{"clientId":"clientId","secret":"secret"},"provisioningState":"provisioningState","nodeResourceGroup":"nodeResourceGroup","windowsProfile":{"adminUsername":"adminUsername","adminPassword":"adminPassword"},"identityProfile":"{}","addonProfiles":"{}","dnsPrefix":"dnsPrefix","networkProfile":{"loadBalancerSku":"standard","networkPlugin":"kubenet","dockerBridgeCidr":"172.17.0.1/16","dnsServiceIP":"10.0.0.10","outboundType":"loadBalancer","networkPolicy":"calico","podCidr":"10.244.0.0/16","loadBalancerProfile":{"managedOutboundIPs":{"count":36},"allocatedOutboundPorts":45192,"outboundIPPrefixes":{"publicIPPrefixes":[{"id":"id"},{"id":"id"}]},"idleTimeoutInMinutes":111,"outboundIPs":{"publicIPs":[{"id":"id"},{"id":"id"}]},"effectiveOutboundIPs":[{"id":"id"},{"id":"id"}]},"serviceCidr":"10.0.0.0/16"},"aadProfile":{"serverAppSecret":"serverAppSecret","tenantID":"tenantID","serverAppID":"serverAppID","clientAppID":"clientAppID"},"enablePodSecurityPolicy":True,"maxAgentPools":2,"linuxProfile":{"adminUsername":"adminUsername","ssh":{"publicKeys":[{"keyData":"keyData"},{"keyData":"keyData"}]}},"kubernetesVersion":"kubernetesVersion"},"tags":{"key":"tags"}}
