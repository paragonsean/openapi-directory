...
QList<OAIAgentPoolUpgradeProfileProperties_upgrades_inner> OAIManagedClusterPoolUpgradeProfile::getUpgrades() const {
    return m_upgrades;
}
void OAIManagedClusterPoolUpgradeProfile::setUpgrades(const QList<OAIAgentPoolUpgradeProfileProperties_upgrades_inner> &upgrades) {
    m_upgrades = upgrades;
