...
**loadBalancerSku** | **String** | The load balancer sku for the managed cluster. | [optional] 
...
**outboundType** | **String** | The outbound (egress) routing method. | [optional] [default to &#39;loadBalancer&#39;]
...
## Enum: OutboundTypeEnum


* `loadBalancer` (value: `"loadBalancer"`)

* `userDefinedRouting` (value: `"userDefinedRouting"`)
