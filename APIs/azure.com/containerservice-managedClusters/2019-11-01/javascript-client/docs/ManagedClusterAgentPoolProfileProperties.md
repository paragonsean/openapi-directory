...
------------ | ------------- | ------------- | -------------
**availabilityZones** | **[String]** | Availability zones for nodes. Must use VirtualMachineScaleSets AgentPoolType. | [optional] 
...
**nodeLabels** | **{String: String}** | Agent pool node labels to be persisted across all nodes in agent pool. | [optional] 
...
**tags** | **{String: String}** | Agent pool tags to be persisted on the agent pool virtual machine scale set. | [optional] 
