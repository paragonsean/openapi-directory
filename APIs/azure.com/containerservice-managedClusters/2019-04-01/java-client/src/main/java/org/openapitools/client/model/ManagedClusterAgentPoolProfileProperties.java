...
public class ManagedClusterAgentPoolProfileProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availabilityZones, count, enableAutoScaling, maxCount, maxPods, minCount, orchestratorVersion, osDiskSizeGB, osType, provisioningState, type, vmSize, vnetSubnetID);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ManagedClusterAgentPoolProfileProperties.openapiRequiredFields) {
