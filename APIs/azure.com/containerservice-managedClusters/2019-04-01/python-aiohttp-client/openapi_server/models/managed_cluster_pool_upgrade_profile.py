...
from openapi_server.models.managed_cluster_pool_upgrade_profile_upgrades_inner import ManagedClusterPoolUpgradeProfileUpgradesInner
...
class ManagedClusterPoolUpgradeProfile(Model):
    ...
    def __init__(self, kubernetes_version: str=None, name: str=None, os_type: OSType=OSType.LINUX, upgrades: List[ManagedClusterPoolUpgradeProfileUpgradesInner]=None):
        ...
        self.openapi_types = {
            ...
            'name': str,
            'os_type': OSType,
            'upgrades': List[ManagedClusterPoolUpgradeProfileUpgradesInner]
        }
    ...
    def upgrades(self):
        ...
        :rtype: List[ManagedClusterPoolUpgradeProfileUpgradesInner]
        """
    ...
    def upgrades(self, upgrades):
        ...
        :param upgrades: The upgrades of this ManagedClusterPoolUpgradeProfile.
        :type upgrades: List[ManagedClusterPoolUpgradeProfileUpgradesInner]
        """
