...
class ManagedClusterProperties(Model):
    ...
    def __init__(self, aad_profile: ManagedClusterAADProfile=None, addon_profiles: object=None, agent_pool_profiles: List[ManagedClusterAgentPoolProfile]=None, api_server_authorized_ip_ranges: List[str]=None, dns_prefix: str=None, enable_pod_security_policy: bool=None, enable_rbac: bool=None, fqdn: str=None, kubernetes_version: str=None, linux_profile: ContainerServiceLinuxProfile=None, max_agent_pools: int=None, network_profile: ContainerServiceNetworkProfile=None, node_resource_group: str=None, provisioning_state: str=None, service_principal_profile: ManagedClusterServicePrincipalProfile=None, windows_profile: ManagedClusterWindowsProfile=None):
        ...
        :param api_server_authorized_ip_ranges: The api_server_authorized_ip_ranges of this ManagedClusterProperties.
        ...
        self._api_server_authorized_ip_ranges = api_server_authorized_ip_ranges
    ...
    @property
    def api_server_authorized_ip_ranges(self):
        """Gets the api_server_authorized_ip_ranges of this ManagedClusterProperties.

        (PREVIEW) Authorized IP Ranges to kubernetes API server.

        :return: The api_server_authorized_ip_ranges of this ManagedClusterProperties.
        :rtype: List[str]
        """
        return self._api_server_authorized_ip_ranges

    @api_server_authorized_ip_ranges.setter
    def api_server_authorized_ip_ranges(self, api_server_authorized_ip_ranges):
        """Sets the api_server_authorized_ip_ranges of this ManagedClusterProperties.
