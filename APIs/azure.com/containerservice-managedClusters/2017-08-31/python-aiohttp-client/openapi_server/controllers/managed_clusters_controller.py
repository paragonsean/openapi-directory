...
async def managed_clusters_get_access_profiles(request: web.Request, api_version, subscription_id, resource_group_name, resource_name, role_name) -> web.Response:
