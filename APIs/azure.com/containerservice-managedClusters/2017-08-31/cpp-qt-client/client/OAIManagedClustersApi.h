...
public:
    ...
    * @param[in]  role_name QString [required]
    */
    Q_DECL_DEPRECATED virtual void managedClustersGetAccessProfiles(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &resource_name, const QString &role_name);
...
private:
    ...
    void managedClustersGetAccessProfilesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void managedClustersGetAccessProfilesSignal(OAIManagedClusterAccessProfile summary);
    ...
    void managedClustersGetAccessProfilesSignalFull(OAIHttpRequestWorker *worker, OAIManagedClusterAccessProfile summary);
    ...
    Q_DECL_DEPRECATED_X("Use managedClustersGetAccessProfilesSignalError() instead")
    void managedClustersGetAccessProfilesSignalE(OAIManagedClusterAccessProfile summary, QNetworkReply::NetworkError error_type, QString error_str);
    void managedClustersGetAccessProfilesSignalError(OAIManagedClusterAccessProfile summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use managedClustersGetAccessProfilesSignalErrorFull() instead")
    void managedClustersGetAccessProfilesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void managedClustersGetAccessProfilesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
