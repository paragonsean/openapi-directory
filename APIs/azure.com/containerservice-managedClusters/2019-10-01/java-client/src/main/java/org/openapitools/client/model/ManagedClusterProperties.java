...
public class ManagedClusterProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aadProfile, addonProfiles, agentPoolProfiles, apiServerAccessProfile, dnsPrefix, enablePodSecurityPolicy, enableRBAC, fqdn, kubernetesVersion, linuxProfile, maxAgentPools, networkProfile, nodeResourceGroup, privateFQDN, provisioningState, servicePrincipalProfile, windowsProfile);
  }
