...
|------------ | ------------- | ------------- | -------------|
|**availabilityZones** | **List&lt;String&gt;** | (PREVIEW) Availability zones for nodes. Must use VirtualMachineScaleSets AgentPoolType. |  [optional] |
...
|**vmSize** | **ContainerServiceVMSize** |  |  [optional] |
