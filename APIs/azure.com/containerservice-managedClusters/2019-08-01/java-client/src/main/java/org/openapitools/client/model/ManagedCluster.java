...
public class ManagedCluster {
  ...
  public ManagedCluster location(String location) {
  ...
  public ManagedCluster tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public ManagedCluster putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public ManagedCluster identity(ManagedClusterIdentity identity) {
   ...
   */
  @javax.annotation.Nullable
  public ManagedClusterIdentity getIdentity() {
    return identity;
  }

  public void setIdentity(ManagedClusterIdentity identity) {
    this.identity = identity;
  }


  public ManagedCluster properties(ManagedClusterProperties properties) {
   ...
   */
  @javax.annotation.Nullable
  public ManagedClusterProperties getProperties() {
    return properties;
  }

  public void setProperties(ManagedClusterProperties properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, managedCluster.id) &&
        Objects.equals(this.location, managedCluster.location) &&
        Objects.equals(this.name, managedCluster.name) &&
        Objects.equals(this.tags, managedCluster.tags) &&
        Objects.equals(this.type, managedCluster.type) &&
        Objects.equals(this.identity, managedCluster.identity) &&
        Objects.equals(this.properties, managedCluster.properties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, location, name, tags, type, identity, properties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ManagedCluster.openapiRequiredFields) {
      ...
      if (jsonObj.get("identity") != null && !jsonObj.get("identity").isJsonNull()) {
        ManagedClusterIdentity.validateJsonElement(jsonObj.get("identity"));
      }
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        ManagedClusterProperties.validateJsonElement(jsonObj.get("properties"));
      }
  }
