...
**nodeTaints** | **[String]** | Taints added to new nodes during node pool create and scale. For example, key&#x3D;value:NoSchedule. | [optional] 
...
**scaleSetEvictionPolicy** | [**ScaleSetEvictionPolicy**](ScaleSetEvictionPolicy.md) |  | [optional] 
**scaleSetPriority** | [**ScaleSetPriority**](ScaleSetPriority.md) |  | [optional] 
**type** | [**AgentPoolType**](AgentPoolType.md) |  | [optional] 
**vmSize** | [**ContainerServiceVMSize**](ContainerServiceVMSize.md) |  | [optional] 
**vnetSubnetID** | **String** | VNet SubnetID specifies the VNet&#39;s subnet identifier. | [optional] 
**name** | **String** | Unique name of the agent pool profile in the context of the subscription and resource group. | [optional] 
