...
import ManagedClusterIdentity from './ManagedClusterIdentity';
import ManagedClusterProperties from './ManagedClusterProperties';
...
class ManagedCluster {
    ...
    constructor(location) { 
        ...
        ManagedCluster.initialize(this, location);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('identity')) {
                obj['identity'] = ManagedClusterIdentity.constructFromObject(data['identity']);
            }
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ManagedClusterProperties.constructFromObject(data['properties']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ManagedCluster.RequiredProperties) {
        ...
        if (data['identity']) { // data not null
          ManagedClusterIdentity.validateJSON(data['identity']);
        }
        // validate the optional field `properties`
        if (data['properties']) { // data not null
          ManagedClusterProperties.validateJSON(data['properties']);
        }
...
ManagedCluster.RequiredProperties = ["location"];

/**
 * Resource Id
 * @member {String} id
 */
ManagedCluster.prototype['id'] = undefined;

/**
 * Resource location
 * @member {String} location
 */
ManagedCluster.prototype['location'] = undefined;

/**
 * Resource name
 * @member {String} name
 */
ManagedCluster.prototype['name'] = undefined;

/**
 * Resource tags
 * @member {Object.<String, String>} tags
 */
ManagedCluster.prototype['tags'] = undefined;

/**
 * Resource type
 * @member {String} type
 */
ManagedCluster.prototype['type'] = undefined;

/**
 * @member {module:model/ManagedClusterIdentity} identity
 */
ManagedCluster.prototype['identity'] = undefined;

/**
 * @member {module:model/ManagedClusterProperties} properties
 */
ManagedCluster.prototype['properties'] = undefined;
