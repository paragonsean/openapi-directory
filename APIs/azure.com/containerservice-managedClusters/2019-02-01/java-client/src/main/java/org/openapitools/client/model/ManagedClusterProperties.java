...
public class ManagedClusterProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aadProfile, addonProfiles, agentPoolProfiles, apiServerAuthorizedIPRanges, dnsPrefix, enablePodSecurityPolicy, enableRBAC, fqdn, kubernetesVersion, linuxProfile, networkProfile, nodeResourceGroup, provisioningState, servicePrincipalProfile);
  }
