...
export default class AgentPoolsApi {
    ...
    */
     ...
     */
    agentPoolsCreateOrUpdate(apiVersion, subscriptionId, resourceGroupName, managedClusterName, agentPoolName, parameters, callback) {
      ...
      if (managedClusterName === undefined || managedClusterName === null) {
        throw new Error("Missing the required parameter 'managedClusterName' when calling agentPoolsCreateOrUpdate");
      }
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{managedClusterName}/agentPools/{agentPoolName}', 'PUT',
     ...
     */
    agentPoolsDelete(apiVersion, subscriptionId, resourceGroupName, managedClusterName, agentPoolName, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
      ...
      // verify the required parameter 'managedClusterName' is set
      if (managedClusterName === undefined || managedClusterName === null) {
        throw new Error("Missing the required parameter 'managedClusterName' when calling agentPoolsDelete");
      }
      // verify the required parameter 'agentPoolName' is set
      if (agentPoolName === undefined || agentPoolName === null) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{managedClusterName}/agentPools/{agentPoolName}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/AgentPool}
     */
    agentPoolsGet(apiVersion, subscriptionId, resourceGroupName, managedClusterName, agentPoolName, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
      ...
      // verify the required parameter 'managedClusterName' is set
      if (managedClusterName === undefined || managedClusterName === null) {
        throw new Error("Missing the required parameter 'managedClusterName' when calling agentPoolsGet");
      }
      // verify the required parameter 'agentPoolName' is set
      if (agentPoolName === undefined || agentPoolName === null) {
      ...
      let returnType = AgentPool;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{managedClusterName}/agentPools/{agentPoolName}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    agentPoolsList(apiVersion, subscriptionId, resourceGroupName, managedClusterName, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
      ...
      // verify the required parameter 'managedClusterName' is set
      if (managedClusterName === undefined || managedClusterName === null) {
        throw new Error("Missing the required parameter 'managedClusterName' when calling agentPoolsList");
      }
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{managedClusterName}/agentPools', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
