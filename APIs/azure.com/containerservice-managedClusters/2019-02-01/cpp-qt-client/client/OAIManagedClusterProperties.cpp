...
void OAIManagedClusterProperties::initializeModel() {
    ...
    m_api_server_authorized_ip_ranges_isSet = false;
    m_api_server_authorized_ip_ranges_isValid = false;
...
void OAIManagedClusterProperties::fromJsonObject(QJsonObject json) {
    ...
    m_api_server_authorized_ip_ranges_isValid = ::OpenAPI::fromJsonValue(m_api_server_authorized_ip_ranges, json[QString("apiServerAuthorizedIPRanges")]);
    m_api_server_authorized_ip_ranges_isSet = !json[QString("apiServerAuthorizedIPRanges")].isNull() && m_api_server_authorized_ip_ranges_isValid;
...
QJsonObject OAIManagedClusterProperties::asJsonObject() const {
    ...
    if (m_api_server_authorized_ip_ranges.size() > 0) {
        obj.insert(QString("apiServerAuthorizedIPRanges"), ::OpenAPI::toJsonValue(m_api_server_authorized_ip_ranges));
    }
...
QList<QString> OAIManagedClusterProperties::getApiServerAuthorizedIpRanges() const {
    return m_api_server_authorized_ip_ranges;
}
void OAIManagedClusterProperties::setApiServerAuthorizedIpRanges(const QList<QString> &api_server_authorized_ip_ranges) {
    m_api_server_authorized_ip_ranges = api_server_authorized_ip_ranges;
    m_api_server_authorized_ip_ranges_isSet = true;
}

bool OAIManagedClusterProperties::is_api_server_authorized_ip_ranges_Set() const{
    return m_api_server_authorized_ip_ranges_isSet;
}

bool OAIManagedClusterProperties::is_api_server_authorized_ip_ranges_Valid() const{
    return m_api_server_authorized_ip_ranges_isValid;
}
