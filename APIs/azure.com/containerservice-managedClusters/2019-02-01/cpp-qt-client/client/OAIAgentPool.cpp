...
QString OAIAgentPool::getId() const {
    return m_id;
}
void OAIAgentPool::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAgentPool::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAgentPool::is_id_Valid() const{
    return m_id_isValid;
}
...
QString OAIAgentPool::getType() const {
    return m_type;
}
void OAIAgentPool::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAgentPool::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAgentPool::is_type_Valid() const{
    return m_type_isValid;
}

OAIManagedClusterAgentPoolProfileProperties OAIAgentPool::getProperties() const {
    return m_properties;
}
void OAIAgentPool::setProperties(const OAIManagedClusterAgentPoolProfileProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIAgentPool::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIAgentPool::is_properties_Valid() const{
