...
async def test_managed_clusters_create_or_update(client):
    ...
    """
    parameters = {"name":"name","location":"location","id":"id","type":"type","properties":{"agentPoolProfiles":[{"osDiskSizeGB":576,"count":8,"vnetSubnetID":"vnetSubnetID","availabilityZones":["availabilityZones","availabilityZones"],"enableAutoScaling":True,"orchestratorVersion":"orchestratorVersion","provisioningState":"provisioningState","type":"VirtualMachineScaleSets","maxCount":6,"osType":"Linux","name":"name","minCount":5,"vmSize":"Standard_A1","maxPods":1},{"osDiskSizeGB":576,"count":8,"vnetSubnetID":"vnetSubnetID","availabilityZones":["availabilityZones","availabilityZones"],"enableAutoScaling":True,"orchestratorVersion":"orchestratorVersion","provisioningState":"provisioningState","type":"VirtualMachineScaleSets","maxCount":6,"osType":"Linux","name":"name","minCount":5,"vmSize":"Standard_A1","maxPods":1}],"enableRBAC":True,"apiServerAuthorizedIPRanges":["apiServerAuthorizedIPRanges","apiServerAuthorizedIPRanges"],"fqdn":"fqdn","servicePrincipalProfile":{"clientId":"clientId","secret":"secret"},"provisioningState":"provisioningState","nodeResourceGroup":"nodeResourceGroup","addonProfiles":"{}","dnsPrefix":"dnsPrefix","networkProfile":{"networkPlugin":"kubenet","dockerBridgeCidr":"172.17.0.1/16","dnsServiceIP":"10.0.0.10","networkPolicy":"calico","podCidr":"10.244.0.0/16","serviceCidr":"10.0.0.0/16"},"aadProfile":{"serverAppSecret":"serverAppSecret","tenantID":"tenantID","serverAppID":"serverAppID","clientAppID":"clientAppID"},"enablePodSecurityPolicy":True,"linuxProfile":{"adminUsername":"adminUsername","ssh":{"publicKeys":[{"keyData":"keyData"},{"keyData":"keyData"}]}},"kubernetesVersion":"kubernetesVersion"},"tags":{"key":"tags"}}
