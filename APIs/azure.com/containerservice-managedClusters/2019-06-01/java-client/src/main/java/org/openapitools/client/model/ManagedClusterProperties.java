...
public class ManagedClusterProperties {
  ...
  public static final String SERIALIZED_NAME_API_SERVER_AUTHORIZED_I_P_RANGES = "apiServerAuthorizedIPRanges";
  @SerializedName(SERIALIZED_NAME_API_SERVER_AUTHORIZED_I_P_RANGES)
  private List<String> apiServerAuthorizedIPRanges = new ArrayList<>();
  ...
  public ManagedClusterProperties apiServerAuthorizedIPRanges(List<String> apiServerAuthorizedIPRanges) {
    this.apiServerAuthorizedIPRanges = apiServerAuthorizedIPRanges;
    return this;
  }

  public ManagedClusterProperties addApiServerAuthorizedIPRangesItem(String apiServerAuthorizedIPRangesItem) {
    if (this.apiServerAuthorizedIPRanges == null) {
      this.apiServerAuthorizedIPRanges = new ArrayList<>();
    }
    this.apiServerAuthorizedIPRanges.add(apiServerAuthorizedIPRangesItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<String> getApiServerAuthorizedIPRanges() {
    return apiServerAuthorizedIPRanges;
  }

  public void setApiServerAuthorizedIPRanges(List<String> apiServerAuthorizedIPRanges) {
    this.apiServerAuthorizedIPRanges = apiServerAuthorizedIPRanges;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aadProfile, managedClusterProperties.aadProfile) &&
        ...
        Objects.equals(this.apiServerAuthorizedIPRanges, managedClusterProperties.apiServerAuthorizedIPRanges) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aadProfile, addonProfiles, agentPoolProfiles, apiServerAuthorizedIPRanges, dnsPrefix, enablePodSecurityPolicy, enableRBAC, fqdn, kubernetesVersion, linuxProfile, maxAgentPools, networkProfile, nodeResourceGroup, provisioningState, servicePrincipalProfile, windowsProfile);
  }
  ...
  public String toString() {
    ...
    sb.append("    apiServerAuthorizedIPRanges: ").append(toIndentedString(apiServerAuthorizedIPRanges)).append("\n");
  ...
  static {
    ...
    openapiFields.add("apiServerAuthorizedIPRanges");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("apiServerAuthorizedIPRanges") != null && !jsonObj.get("apiServerAuthorizedIPRanges").isJsonNull() && !jsonObj.get("apiServerAuthorizedIPRanges").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `apiServerAuthorizedIPRanges` to be an array in the JSON string but got `%s`", jsonObj.get("apiServerAuthorizedIPRanges").toString()));
      }
