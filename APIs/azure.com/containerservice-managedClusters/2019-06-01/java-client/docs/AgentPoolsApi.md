...
public class Example {
  public static void main(String[] args) {
    ...
    String agentPoolName = "agentPoolName_example"; // String | The name of the agent pool.
    try {
      apiInstance.agentPoolsDelete(apiVersion, subscriptionId, resourceGroupName, resourceName, agentPoolName);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String agentPoolName = "agentPoolName_example"; // String | The name of the agent pool.
    try {
      AgentPool result = apiInstance.agentPoolsGet(apiVersion, subscriptionId, resourceGroupName, resourceName, agentPoolName);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="agentPoolsGetAvailableAgentPoolVersions"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceName = "resourceName_example"; // String | The name of the managed cluster resource.
    try {
      AgentPoolAvailableVersions result = apiInstance.agentPoolsGetAvailableAgentPoolVersions(apiVersion, subscriptionId, resourceGroupName, resourceName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AgentPoolsApi#agentPoolsGetAvailableAgentPoolVersions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="agentPoolsGetUpgradeProfile"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String agentPoolName = "agentPoolName_example"; // String | The name of the agent pool.
    try {
      AgentPoolUpgradeProfile result = apiInstance.agentPoolsGetUpgradeProfile(apiVersion, subscriptionId, resourceGroupName, resourceName, agentPoolName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AgentPoolsApi#agentPoolsGetUpgradeProfile");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceName = "resourceName_example"; // String | The name of the managed cluster resource.
    try {
      AgentPoolListResult result = apiInstance.agentPoolsList(apiVersion, subscriptionId, resourceGroupName, resourceName);
      System.out.println(result);
    } catch (ApiException e) {
