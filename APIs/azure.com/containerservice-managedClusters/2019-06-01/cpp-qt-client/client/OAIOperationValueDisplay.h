...
/*
 * OAIOperationValueDisplay.h
 *
 * Describes the properties of a Compute Operation Value Display.
 */

#ifndef OAIOperationValueDisplay_H
#define OAIOperationValueDisplay_H
...
class OAIOperationValueDisplay : public OAIObject {
public:
    OAIOperationValueDisplay();
    OAIOperationValueDisplay(QString json);
    ~OAIOperationValueDisplay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOperationValueDisplay)

#endif // OAIOperationValueDisplay_H
