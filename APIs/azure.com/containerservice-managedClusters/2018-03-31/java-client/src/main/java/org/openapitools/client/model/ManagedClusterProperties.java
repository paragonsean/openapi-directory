...
public class ManagedClusterProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aadProfile, addonProfiles, agentPoolProfiles, dnsPrefix, enableRBAC, fqdn, kubernetesVersion, linuxProfile, networkProfile, nodeResourceGroup, provisioningState, servicePrincipalProfile);
  }
