...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GalleryManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new GalleryManagementClient.Resource();
      //expect(instance).to.be.a(GalleryManagementClient.Resource);
    });
