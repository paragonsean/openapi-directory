...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GalleryManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new GalleryManagementClient.Operation();
      //expect(instance).to.be.a(GalleryManagementClient.Operation);
    });
