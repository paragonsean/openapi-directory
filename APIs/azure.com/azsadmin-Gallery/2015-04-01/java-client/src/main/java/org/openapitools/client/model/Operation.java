...
import org.openapitools.client.model.OperationDisplayDefinition;
...
public class Operation {
  ...
  public Operation display(OperationDisplayDefinition display) {
  ...
  public OperationDisplayDefinition getDisplay() {
    return display;
  }

  public void setDisplay(OperationDisplayDefinition display) {
    this.display = display;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("display") != null && !jsonObj.get("display").isJsonNull()) {
        OperationDisplayDefinition.validateJsonElement(jsonObj.get("display"));
      }
