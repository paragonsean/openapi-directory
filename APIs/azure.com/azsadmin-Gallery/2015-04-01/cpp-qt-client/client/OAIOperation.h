...
#include "OAIOperationDisplayDefinition.h"
#include <QString>
...
namespace OpenAPI {
class OAIOperationDisplayDefinition;
...
public:
    ...
    OAIOperationDisplayDefinition getDisplay() const;
    void setDisplay(const OAIOperationDisplayDefinition &display);
...
private:
    ...
    OAIOperationDisplayDefinition m_display;
