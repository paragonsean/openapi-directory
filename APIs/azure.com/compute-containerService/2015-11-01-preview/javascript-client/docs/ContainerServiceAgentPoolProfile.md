...
------------ | ------------- | ------------- | -------------
**count** | **Number** | No. of agents (VMs) that will host docker containers | [optional] 
**dnsPrefix** | **String** | DNS prefix to be used to create FQDN for this agent pool | 
**fqdn** | **String** | FQDN for the agent pool | [optional] [readonly] 
**name** | **String** | Unique name of the agent pool profile within the context of the subscription and resource group | 
**vmSize** | **String** | Size of agent VMs | [optional] 
