...
class ContainerServiceAgentPoolProfile {
     ...
     * @param dnsPrefix {String} DNS prefix to be used to create FQDN for this agent pool
     * @param name {String} Unique name of the agent pool profile within the context of the subscription and resource group
     */
    constructor(dnsPrefix, name) { 
        
        ContainerServiceAgentPoolProfile.initialize(this, dnsPrefix, name);
    }
     ...
     */
    static initialize(obj, dnsPrefix, name) { 
...
ContainerServiceAgentPoolProfile.RequiredProperties = ["dnsPrefix", "name"];

/**
 * No. of agents (VMs) that will host docker containers
 * @member {Number} count
 */
ContainerServiceAgentPoolProfile.prototype['count'] = undefined;
