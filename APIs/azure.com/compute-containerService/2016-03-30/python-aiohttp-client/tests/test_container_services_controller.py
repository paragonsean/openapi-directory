...
async def test_container_services_create_or_update(client):
    ...
    """
    parameters = {"properties":{"agentPoolProfiles":[{"fqdn":"fqdn","count":8,"name":"name","dnsPrefix":"dnsPrefix","vmSize":"Standard_A0"},{"fqdn":"fqdn","count":8,"name":"name","dnsPrefix":"dnsPrefix","vmSize":"Standard_A0"}],"orchestratorProfile":{"orchestratorType":"Swarm"},"windowsProfile":{"adminUsername":"adminUsername","adminPassword":"adminPassword"},"diagnosticsProfile":{"vmDiagnostics":{"storageUri":"storageUri","enabled":True}},"provisioningState":"provisioningState","linuxProfile":{"adminUsername":"adminUsername","ssh":{"publicKeys":[{"keyData":"keyData"},{"keyData":"keyData"}]}},"masterProfile":{"fqdn":"fqdn","count":6,"dnsPrefix":"dnsPrefix"}}}
