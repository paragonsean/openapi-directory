...
- API version: 2016-09-30
  - Build date: 2024-10-12T11:06:20.088325-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2016-09-30"
  }
```
...
* `target/openapi-java-client-2016-09-30.jar`
* `target/lib/*.jar`
