...
class ContainerServiceOrchestratorProfile {
     ...
     * @param orchestratorType {module:model/ContainerServiceOrchestratorProfile.OrchestratorTypeEnum} The orchestrator to use to manage container service cluster resources. Valid values are Swarm, DCOS, and Custom.
     */
