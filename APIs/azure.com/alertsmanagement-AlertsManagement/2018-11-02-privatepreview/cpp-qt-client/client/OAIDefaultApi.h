...
public:
    ...
    */
    virtual void actionRulesCreateUpdate(const QString &subscription_id, const QString &resource_group, const QString &action_rule_name, const OAIActionRule &action_rule);
    ...
    * @param[in]  action_rule_name QString [required]
    */
    virtual void actionRulesDelete(const QString &subscription_id, const QString &resource_group, const QString &action_rule_name);
    ...
    */
    virtual void actionRulesGetAllResourceGroup(const QString &subscription_id, const QString &resource_group, const ::OpenAPI::OptionalParam<QString> &target_resource_group = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &target_resource_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &target_resource = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &severity = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &monitor_service = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  monitor_service QString [optional]
    */
    virtual void actionRulesGetAllSubscription(const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &target_resource_group = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &target_resource_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &target_resource = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &severity = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &monitor_service = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  action_rule_name QString [required]
    */
    virtual void actionRulesGetByName(const QString &subscription_id, const QString &resource_group, const QString &action_rule_name);
    ...
    */
    virtual void actionRulesPatch(const QString &subscription_id, const QString &resource_group, const QString &action_rule_name, const OAIPatchObject &action_rule_patch);
...
private:
    ...
    void actionRulesGetAllResourceGroupCallback(OAIHttpRequestWorker *worker);
    void actionRulesGetAllSubscriptionCallback(OAIHttpRequestWorker *worker);
    void actionRulesGetByNameCallback(OAIHttpRequestWorker *worker);
    void actionRulesPatchCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void actionRulesDeleteSignal();
    void actionRulesGetAllResourceGroupSignal(OAIActionRulesList summary);
    void actionRulesGetAllSubscriptionSignal(OAIActionRulesList summary);
    void actionRulesGetByNameSignal(OAIActionRule summary);
    void actionRulesPatchSignal();
    ...
    void actionRulesDeleteSignalFull(OAIHttpRequestWorker *worker);
    void actionRulesGetAllResourceGroupSignalFull(OAIHttpRequestWorker *worker, OAIActionRulesList summary);
    void actionRulesGetAllSubscriptionSignalFull(OAIHttpRequestWorker *worker, OAIActionRulesList summary);
    void actionRulesGetByNameSignalFull(OAIHttpRequestWorker *worker, OAIActionRule summary);
    void actionRulesPatchSignalFull(OAIHttpRequestWorker *worker);
    ...
    void actionRulesDeleteSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void actionRulesDeleteSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actionRulesGetAllResourceGroupSignalError() instead")
    void actionRulesGetAllResourceGroupSignalE(OAIActionRulesList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actionRulesGetAllResourceGroupSignalError(OAIActionRulesList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actionRulesGetAllSubscriptionSignalError() instead")
    void actionRulesGetAllSubscriptionSignalE(OAIActionRulesList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actionRulesGetAllSubscriptionSignalError(OAIActionRulesList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actionRulesPatchSignalError() instead")
    void actionRulesPatchSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void actionRulesPatchSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actionRulesGetAllResourceGroupSignalErrorFull() instead")
    void actionRulesGetAllResourceGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actionRulesGetAllResourceGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actionRulesGetAllSubscriptionSignalErrorFull() instead")
    void actionRulesGetAllSubscriptionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actionRulesGetAllSubscriptionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actionRulesPatchSignalErrorFull() instead")
    void actionRulesPatchSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actionRulesPatchSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
