...
QString OAIAlertProperties::getAlertState() const {
    return m_alert_state;
}
void OAIAlertProperties::setAlertState(const QString &alert_state) {
    m_alert_state = alert_state;
    m_alert_state_isSet = true;
}

bool OAIAlertProperties::is_alert_state_Set() const{
    return m_alert_state_isSet;
}

bool OAIAlertProperties::is_alert_state_Valid() const{
    return m_alert_state_isValid;
}

QDateTime OAIAlertProperties::getLastModifiedDateTime() const {
    return m_last_modified_date_time;
}
void OAIAlertProperties::setLastModifiedDateTime(const QDateTime &last_modified_date_time) {
    m_last_modified_date_time = last_modified_date_time;
    m_last_modified_date_time_isSet = true;
}

bool OAIAlertProperties::is_last_modified_date_time_Set() const{
    return m_last_modified_date_time_isSet;
}

bool OAIAlertProperties::is_last_modified_date_time_Valid() const{
    return m_last_modified_date_time_isValid;
}

QString OAIAlertProperties::getLastModifiedUserName() const {
    return m_last_modified_user_name;
}
void OAIAlertProperties::setLastModifiedUserName(const QString &last_modified_user_name) {
    m_last_modified_user_name = last_modified_user_name;
    m_last_modified_user_name_isSet = true;
}

bool OAIAlertProperties::is_last_modified_user_name_Set() const{
    return m_last_modified_user_name_isSet;
}

bool OAIAlertProperties::is_last_modified_user_name_Valid() const{
    return m_last_modified_user_name_isValid;
}

QString OAIAlertProperties::getMonitorCondition() const {
    return m_monitor_condition;
}
void OAIAlertProperties::setMonitorCondition(const QString &monitor_condition) {
    m_monitor_condition = monitor_condition;
    m_monitor_condition_isSet = true;
}

bool OAIAlertProperties::is_monitor_condition_Set() const{
    return m_monitor_condition_isSet;
}

bool OAIAlertProperties::is_monitor_condition_Valid() const{
    return m_monitor_condition_isValid;
}

QString OAIAlertProperties::getMonitorService() const {
    return m_monitor_service;
}
void OAIAlertProperties::setMonitorService(const QString &monitor_service) {
    m_monitor_service = monitor_service;
    m_monitor_service_isSet = true;
}

bool OAIAlertProperties::is_monitor_service_Set() const{
    return m_monitor_service_isSet;
}

bool OAIAlertProperties::is_monitor_service_Valid() const{
    return m_monitor_service_isValid;
}

OAIObject OAIAlertProperties::getPayload() const {
    return m_payload;
}
void OAIAlertProperties::setPayload(const OAIObject &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIAlertProperties::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIAlertProperties::is_payload_Valid() const{
...
QString OAIAlertProperties::getSignalType() const {
    return m_signal_type;
}
void OAIAlertProperties::setSignalType(const QString &signal_type) {
    m_signal_type = signal_type;
    m_signal_type_isSet = true;
}

bool OAIAlertProperties::is_signal_type_Set() const{
    return m_signal_type_isSet;
}

bool OAIAlertProperties::is_signal_type_Valid() const{
    return m_signal_type_isValid;
}

QString OAIAlertProperties::getSmartGroupId() const {
    return m_smart_group_id;
}
void OAIAlertProperties::setSmartGroupId(const QString &smart_group_id) {
    m_smart_group_id = smart_group_id;
    m_smart_group_id_isSet = true;
}

bool OAIAlertProperties::is_smart_group_id_Set() const{
    return m_smart_group_id_isSet;
}

bool OAIAlertProperties::is_smart_group_id_Valid() const{
    return m_smart_group_id_isValid;
}

QString OAIAlertProperties::getSmartGroupingReason() const {
    return m_smart_grouping_reason;
}
void OAIAlertProperties::setSmartGroupingReason(const QString &smart_grouping_reason) {
    m_smart_grouping_reason = smart_grouping_reason;
    m_smart_grouping_reason_isSet = true;
}

bool OAIAlertProperties::is_smart_grouping_reason_Set() const{
    return m_smart_grouping_reason_isSet;
}

bool OAIAlertProperties::is_smart_grouping_reason_Valid() const{
    return m_smart_grouping_reason_isValid;
}

QString OAIAlertProperties::getSourceCreatedId() const {
    return m_source_created_id;
}
void OAIAlertProperties::setSourceCreatedId(const QString &source_created_id) {
    m_source_created_id = source_created_id;
    m_source_created_id_isSet = true;
}

bool OAIAlertProperties::is_source_created_id_Set() const{
    return m_source_created_id_isSet;
}

bool OAIAlertProperties::is_source_created_id_Valid() const{
    return m_source_created_id_isValid;
}

QDateTime OAIAlertProperties::getStartDateTime() const {
    return m_start_date_time;
}
void OAIAlertProperties::setStartDateTime(const QDateTime &start_date_time) {
    m_start_date_time = start_date_time;
    m_start_date_time_isSet = true;
}

bool OAIAlertProperties::is_start_date_time_Set() const{
    return m_start_date_time_isSet;
}

bool OAIAlertProperties::is_start_date_time_Valid() const{
    return m_start_date_time_isValid;
}

QString OAIAlertProperties::getTargetResource() const {
    return m_target_resource;
}
void OAIAlertProperties::setTargetResource(const QString &target_resource) {
    m_target_resource = target_resource;
    m_target_resource_isSet = true;
}

bool OAIAlertProperties::is_target_resource_Set() const{
    return m_target_resource_isSet;
}

bool OAIAlertProperties::is_target_resource_Valid() const{
    return m_target_resource_isValid;
}

QString OAIAlertProperties::getTargetResourceGroup() const {
    return m_target_resource_group;
}
void OAIAlertProperties::setTargetResourceGroup(const QString &target_resource_group) {
    m_target_resource_group = target_resource_group;
    m_target_resource_group_isSet = true;
}

bool OAIAlertProperties::is_target_resource_group_Set() const{
    return m_target_resource_group_isSet;
}

bool OAIAlertProperties::is_target_resource_group_Valid() const{
    return m_target_resource_group_isValid;
}

QString OAIAlertProperties::getTargetResourceName() const {
    return m_target_resource_name;
}
void OAIAlertProperties::setTargetResourceName(const QString &target_resource_name) {
    m_target_resource_name = target_resource_name;
    m_target_resource_name_isSet = true;
}

bool OAIAlertProperties::is_target_resource_name_Set() const{
    return m_target_resource_name_isSet;
}

bool OAIAlertProperties::is_target_resource_name_Valid() const{
    return m_target_resource_name_isValid;
}

QString OAIAlertProperties::getTargetResourceType() const {
    return m_target_resource_type;
}
void OAIAlertProperties::setTargetResourceType(const QString &target_resource_type) {
    m_target_resource_type = target_resource_type;
    m_target_resource_type_isSet = true;
}

bool OAIAlertProperties::is_target_resource_type_Set() const{
    return m_target_resource_type_isSet;
}

bool OAIAlertProperties::is_target_resource_type_Valid() const{
