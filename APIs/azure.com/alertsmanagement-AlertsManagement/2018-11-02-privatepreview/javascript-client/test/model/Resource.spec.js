...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new AzureAlertsManagementServiceResourceProvider.Resource();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.Resource);
    });
