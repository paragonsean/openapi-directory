...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new AzureAlertsManagementServiceResourceProvider.ErrorResponse();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.ErrorResponse);
    });
