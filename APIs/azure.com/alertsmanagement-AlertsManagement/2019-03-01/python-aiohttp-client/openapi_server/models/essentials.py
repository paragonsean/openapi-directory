...
class Essentials(Model):
    ...
    def monitor_service(self, monitor_service):
        ...
        """
        allowed_values = ["Application Insights", "ActivityLog Administrative", "ActivityLog Security", "ActivityLog Recommendation", "ActivityLog Policy", "ActivityLog Autoscale", "Log Analytics", "Nagios", "Platform", "SCOM", "ServiceHealth", "SmartDetector", "VM Insights", "Zabbix", "Resource Health"]  # noqa: E501
