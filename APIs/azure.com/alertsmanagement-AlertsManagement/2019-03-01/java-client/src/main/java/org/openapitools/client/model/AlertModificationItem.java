...
public class AlertModificationItem {
  ...
  public AlertModificationItem comments(String comments) {
  ...
  public AlertModificationItem description(String description) {
  ...
  public AlertModificationItem modificationEvent(ModificationEventEnum modificationEvent) {
  ...
  public AlertModificationItem modifiedAt(String modifiedAt) {
  ...
  public AlertModificationItem modifiedBy(String modifiedBy) {
  ...
  public AlertModificationItem newValue(String newValue) {
  ...
  public AlertModificationItem oldValue(String oldValue) {
  ...
  public boolean equals(Object o) {
    ...
    AlertModificationItem alertModificationItem = (AlertModificationItem) o;
    return Objects.equals(this.comments, alertModificationItem.comments) &&
        Objects.equals(this.description, alertModificationItem.description) &&
        Objects.equals(this.modificationEvent, alertModificationItem.modificationEvent) &&
        Objects.equals(this.modifiedAt, alertModificationItem.modifiedAt) &&
        Objects.equals(this.modifiedBy, alertModificationItem.modifiedBy) &&
        Objects.equals(this.newValue, alertModificationItem.newValue) &&
        Objects.equals(this.oldValue, alertModificationItem.oldValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlertModificationItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlertModificationItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlertModificationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertModificationItem is not found in the empty JSON string", AlertModificationItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertModificationItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlertModificationItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertModificationItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertModificationItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertModificationItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertModificationItem.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertModificationItem>() {
           @Override
           public void write(JsonWriter out, AlertModificationItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlertModificationItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlertModificationItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlertModificationItem
   * @throws IOException if the JSON string is invalid with respect to AlertModificationItem
   */
  public static AlertModificationItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertModificationItem.class);
  }

  /**
   * Convert an instance of AlertModificationItem to an JSON string
   *
   * @return JSON string
   */
