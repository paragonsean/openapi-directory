...
async def action_rules_create_update(request: web.Request, subscription_id, resource_group_name, action_rule_name, api_version, action_rule) -> web.Response:
...
async def action_rules_delete(request: web.Request, subscription_id, resource_group_name, action_rule_name, api_version) -> web.Response:
    """Delete action rule
...
async def action_rules_get_by_name(request: web.Request, subscription_id, resource_group_name, action_rule_name, api_version) -> web.Response:
...
async def action_rules_list_by_resource_group(request: web.Request, subscription_id, resource_group_name, api_version, target_resource_group=None, target_resource_type=None, target_resource=None, severity=None, monitor_service=None, impacted_scope=None, description=None, alert_rule_id=None, action_group=None, name=None) -> web.Response:
    ...
    :param impacted_scope: filter by impacted/target scope (provide comma separated list for multiple scopes). The value should be an well constructed ARM id of the scope.
...
async def action_rules_list_by_subscription(request: web.Request, subscription_id, api_version, target_resource_group=None, target_resource_type=None, target_resource=None, severity=None, monitor_service=None, impacted_scope=None, description=None, alert_rule_id=None, action_group=None, name=None) -> web.Response:
...
async def action_rules_update(request: web.Request, subscription_id, resource_group_name, action_rule_name, api_version, action_rule_patch) -> web.Response:
    """Patch action rule
...
async def alerts_get_summary(request: web.Request, subscription_id, groupby, api_version, include_smart_groups_count=None, target_resource=None, target_resource_type=None, target_resource_group=None, monitor_service=None, monitor_condition=None, severity=None, alert_state=None, alert_rule=None, time_range=None, custom_time_range=None) -> web.Response:
    """alerts_get_summary
    ...
    :param subscription_id: The ID of the target subscription.
    :type subscription_id: str
    :param groupby: This parameter allows the result set to be grouped by input fields (Maximum 2 comma separated fields supported). For example, groupby&#x3D;severity or groupby&#x3D;severity,alertstate.
    :type groupby: str
    :param api_version: client API version
    :type api_version: str
...
async def alerts_meta_data(request: web.Request, api_version, identifier) -> web.Response:
    """alerts_meta_data
