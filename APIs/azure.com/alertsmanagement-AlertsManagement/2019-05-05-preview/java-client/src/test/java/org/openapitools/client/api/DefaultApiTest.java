...
public class DefaultApiTest {
    ...
    public void actionRulesCreateUpdateTest() throws ApiException {
        ...
        ActionRule response = api.actionRulesCreateUpdate(subscriptionId, resourceGroupName, actionRuleName, apiVersion, actionRule);
    ...
    public void actionRulesDeleteTest() throws ApiException {
        ...
        String actionRuleName = null;
        String apiVersion = null;
        Boolean response = api.actionRulesDelete(subscriptionId, resourceGroupName, actionRuleName, apiVersion);
        // TODO: test validations
    }
    ...
    public void actionRulesGetByNameTest() throws ApiException {
        ...
        String actionRuleName = null;
        String apiVersion = null;
        ActionRule response = api.actionRulesGetByName(subscriptionId, resourceGroupName, actionRuleName, apiVersion);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void actionRulesListByResourceGroupTest() throws ApiException {
        String subscriptionId = null;
        String resourceGroupName = null;
        String apiVersion = null;
        ...
        String impactedScope = null;
        String description = null;
        String alertRuleId = null;
        String actionGroup = null;
        String name = null;
        ActionRulesList response = api.actionRulesListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, targetResourceGroup, targetResourceType, targetResource, severity, monitorService, impactedScope, description, alertRuleId, actionGroup, name);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void actionRulesListBySubscriptionTest() throws ApiException {
        String subscriptionId = null;
        String apiVersion = null;
        String targetResourceGroup = null;
        String targetResourceType = null;
        ...
        String actionGroup = null;
        String name = null;
        ActionRulesList response = api.actionRulesListBySubscription(subscriptionId, apiVersion, targetResourceGroup, targetResourceType, targetResource, severity, monitorService, impactedScope, description, alertRuleId, actionGroup, name);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void actionRulesUpdateTest() throws ApiException {
        String subscriptionId = null;
        String resourceGroupName = null;
        String actionRuleName = null;
        String apiVersion = null;
        PatchObject actionRulePatch = null;
        ActionRule response = api.actionRulesUpdate(subscriptionId, resourceGroupName, actionRuleName, apiVersion, actionRulePatch);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void alertsMetaDataTest() throws ApiException {
        String apiVersion = null;
        String identifier = null;
        AlertsMetaData response = api.alertsMetaData(apiVersion, identifier);
        // TODO: test validations
    }
