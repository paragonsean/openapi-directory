...
public class Conditions {
  public static final String SERIALIZED_NAME_ALERT_CONTEXT = "alertContext";
  @SerializedName(SERIALIZED_NAME_ALERT_CONTEXT)
  private Condition alertContext;
  ...
  public Conditions alertContext(Condition alertContext) {
  ...
  public Condition getAlertContext() {
    return alertContext;
  }

  public void setAlertContext(Condition alertContext) {
    this.alertContext = alertContext;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alertContext, conditions.alertContext) &&
        Objects.equals(this.alertRuleId, conditions.alertRuleId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alertContext, alertRuleId, description, monitorCondition, monitorService, severity, targetResourceType);
  }
  ...
  public String toString() {
    ...
    sb.append("    alertContext: ").append(toIndentedString(alertContext)).append("\n");
  ...
  static {
    ...
    openapiFields.add("alertContext");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("alertContext") != null && !jsonObj.get("alertContext").isJsonNull()) {
        Condition.validateJsonElement(jsonObj.get("alertContext"));
      }
