...
|**monitorCondition** | [**MonitorConditionEnum**](#MonitorConditionEnum) | Condition of the rule at the monitor service. It represents whether the underlying conditions have crossed the defined alert rule thresholds. |  [optional] [readonly] |
