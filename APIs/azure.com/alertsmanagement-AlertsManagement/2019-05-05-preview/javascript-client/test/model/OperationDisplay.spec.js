...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureAlertsManagementServiceResourceProvider.OperationDisplay();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.OperationDisplay);
    });
