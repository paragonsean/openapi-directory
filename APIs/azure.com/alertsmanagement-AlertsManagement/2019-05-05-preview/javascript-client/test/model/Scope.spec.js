...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.Scope();
  });
  ...
  describe('Scope', function() {
    it('should create an instance of Scope', function() {
      ...
      //var instance = new AzureAlertsManagementServiceResourceProvider.Scope();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.Scope);
    });
