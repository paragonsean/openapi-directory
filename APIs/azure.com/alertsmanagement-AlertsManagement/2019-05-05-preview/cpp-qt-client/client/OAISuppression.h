...
#ifndef OAISuppression_H
#define OAISuppression_H
...
class OAISuppression : public OAIObject {
public:
    OAISuppression();
    OAISuppression(QString json);
    ~OAISuppression() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuppression)

#endif // OAISuppression_H
