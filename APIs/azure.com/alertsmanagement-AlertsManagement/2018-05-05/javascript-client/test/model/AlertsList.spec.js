...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.AlertsList();
  });
  ...
  describe('AlertsList', function() {
    it('should create an instance of AlertsList', function() {
      // uncomment below and update the code to test AlertsList
      //var instance = new AzureAlertsManagementServiceResourceProvider.AlertsList();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.AlertsList);
    });
