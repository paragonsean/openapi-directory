...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.Alert();
  });
  ...
  describe('Alert', function() {
    it('should create an instance of Alert', function() {
      ...
      //var instance = new AzureAlertsManagementServiceResourceProvider.Alert();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.Alert);
    });
