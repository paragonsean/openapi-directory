...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAlertsManagementServiceResourceProvider.OperationsList();
  });
  ...
  describe('OperationsList', function() {
    it('should create an instance of OperationsList', function() {
      ...
      //var instance = new AzureAlertsManagementServiceResourceProvider.OperationsList();
      //expect(instance).to.be.a(AzureAlertsManagementServiceResourceProvider.OperationsList);
    });
