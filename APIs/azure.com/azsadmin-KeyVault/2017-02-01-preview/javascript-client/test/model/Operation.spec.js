...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new KeyVaultManagementClient.Operation();
      //expect(instance).to.be.a(KeyVaultManagementClient.Operation);
    });
