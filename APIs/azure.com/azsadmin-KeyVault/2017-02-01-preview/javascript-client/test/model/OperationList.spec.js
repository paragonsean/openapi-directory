...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultManagementClient.OperationList();
  });
  ...
  describe('OperationList', function() {
    it('should create an instance of OperationList', function() {
      ...
      //var instance = new KeyVaultManagementClient.OperationList();
      //expect(instance).to.be.a(KeyVaultManagementClient.OperationList);
    });
