...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultManagementClient.Display();
  });
  ...
  describe('Display', function() {
    it('should create an instance of Display', function() {
      ...
      //var instance = new KeyVaultManagementClient.Display();
      //expect(instance).to.be.a(KeyVaultManagementClient.Display);
    });
