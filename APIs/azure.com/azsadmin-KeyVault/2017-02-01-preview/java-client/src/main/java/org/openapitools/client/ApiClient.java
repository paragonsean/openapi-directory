...
public class ApiClient {
    ...
    private String basePath = "https://management.local.azurestack.external";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-02-01-preview/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://management.local.azurestack.external
