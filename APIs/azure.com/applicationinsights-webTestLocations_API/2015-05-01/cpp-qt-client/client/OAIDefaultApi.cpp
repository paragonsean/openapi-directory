...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("webTestLocationsList", defaultConf);
    _serverIndices.insert("webTestLocationsList", 0);
}
...
void OAIDefaultApi::webTestLocationsList(const QString &resource_group_name, const QString &api_version, const QString &subscription_id, const QString &resource_name) {
    QString fullPath = QString(_serverConfigs["webTestLocationsList"][_serverIndices.value("webTestLocationsList")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/components/{resourceName}/syntheticmonitorlocations");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::webTestLocationsListCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::webTestLocationsListCallback);
...
void OAIDefaultApi::webTestLocationsListCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIApplicationInsightsWebTestLocationsListResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT webTestLocationsListSignal(output);
        Q_EMIT webTestLocationsListSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT webTestLocationsListSignalE(output, error_type, error_str);
        Q_EMIT webTestLocationsListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT webTestLocationsListSignalError(output, error_type, error_str);
        Q_EMIT webTestLocationsListSignalErrorFull(worker, error_type, error_str);
    }
}
