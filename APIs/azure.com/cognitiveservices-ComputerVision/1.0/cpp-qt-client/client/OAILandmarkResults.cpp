...
QList<OAILandmarkResults_landmarks_inner> OAILandmarkResults::getLandmarks() const {
    return m_landmarks;
}
void OAILandmarkResults::setLandmarks(const QList<OAILandmarkResults_landmarks_inner> &landmarks) {
