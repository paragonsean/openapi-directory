...
public class ApiClient {
    ...
    private String basePath = "https://azure.local/vision/v1.0";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://azure.local/vision/v1.0",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://azure.local/vision/v1.0
