...
class ImageAnalysis(Model):
    ...
    def __init__(self, adult: AdultInfo=None, categories: List[Category]=None, color: ColorInfo=None, description: ImageDescriptionDetails=None, faces: List[FaceDescription]=None, image_type: ImageType=None, metadata: ImageMetadata=None, request_id: str=None, tags: List[ImageTag]=None):
