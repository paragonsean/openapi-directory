...
export default class DomainsApi {
    ...
    */
     ...
     * @param {module:model/DomainAvailabilityCheckResult} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/DomainAvailabilityCheckResult}
     */
    domainsCheckAvailability(subscriptionId, apiVersion, identifier, callback) {
      ...
      let returnType = DomainAvailabilityCheckResult;
