...
Q_SIGNALS:
    ...
    void domainsCheckAvailabilitySignal(OAIDomainAvailabilityCheckResult summary);
    ...
    void domainsCheckAvailabilitySignalFull(OAIHttpRequestWorker *worker, OAIDomainAvailabilityCheckResult summary);
    ...
    void domainsCheckAvailabilitySignalE(OAIDomainAvailabilityCheckResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void domainsCheckAvailabilitySignalError(OAIDomainAvailabilityCheckResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
