...
import OpenShiftManagedClusterMonitorProfile from './OpenShiftManagedClusterMonitorProfile';
...
class OpenShiftManagedClusterProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('monitorProfile')) {
                obj['monitorProfile'] = OpenShiftManagedClusterMonitorProfile.constructFromObject(data['monitorProfile']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `monitorProfile`
        if (data['monitorProfile']) { // data not null
          OpenShiftManagedClusterMonitorProfile.validateJSON(data['monitorProfile']);
        }
 ...
 */
OpenShiftManagedClusterProperties.prototype['clusterVersion'] = undefined;
...
/**
 * @member {module:model/OpenShiftManagedClusterMonitorProfile} monitorProfile
 */
OpenShiftManagedClusterProperties.prototype['monitorProfile'] = undefined;
