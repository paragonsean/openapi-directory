...
void OAIOpenShiftManagedClusterProperties::initializeModel() {
    ...
    m_monitor_profile_isSet = false;
    m_monitor_profile_isValid = false;
...
void OAIOpenShiftManagedClusterProperties::fromJsonObject(QJsonObject json) {
    ...
    m_monitor_profile_isValid = ::OpenAPI::fromJsonValue(m_monitor_profile, json[QString("monitorProfile")]);
    m_monitor_profile_isSet = !json[QString("monitorProfile")].isNull() && m_monitor_profile_isValid;
...
QJsonObject OAIOpenShiftManagedClusterProperties::asJsonObject() const {
    ...
    if (m_monitor_profile.isSet()) {
        obj.insert(QString("monitorProfile"), ::OpenAPI::toJsonValue(m_monitor_profile));
    }
...
OAIOpenShiftManagedClusterMonitorProfile OAIOpenShiftManagedClusterProperties::getMonitorProfile() const {
    return m_monitor_profile;
}
void OAIOpenShiftManagedClusterProperties::setMonitorProfile(const OAIOpenShiftManagedClusterMonitorProfile &monitor_profile) {
    m_monitor_profile = monitor_profile;
    m_monitor_profile_isSet = true;
}

bool OAIOpenShiftManagedClusterProperties::is_monitor_profile_Set() const{
    return m_monitor_profile_isSet;
}

bool OAIOpenShiftManagedClusterProperties::is_monitor_profile_Valid() const{
    return m_monitor_profile_isValid;
}
