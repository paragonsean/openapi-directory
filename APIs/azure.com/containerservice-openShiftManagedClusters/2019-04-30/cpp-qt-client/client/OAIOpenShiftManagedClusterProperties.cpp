...
QString OAIOpenShiftManagedClusterProperties::getClusterVersion() const {
    return m_cluster_version;
}
void OAIOpenShiftManagedClusterProperties::setClusterVersion(const QString &cluster_version) {
    m_cluster_version = cluster_version;
    m_cluster_version_isSet = true;
}

bool OAIOpenShiftManagedClusterProperties::is_cluster_version_Set() const{
    return m_cluster_version_isSet;
}

bool OAIOpenShiftManagedClusterProperties::is_cluster_version_Valid() const{
