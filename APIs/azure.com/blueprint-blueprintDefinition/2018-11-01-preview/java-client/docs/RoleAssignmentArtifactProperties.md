...
|------------ | ------------- | ------------- | -------------|
|**principalIds** | **Object** | Array of user or group identities in Azure Active Directory. The roleDefinition will apply to each identity. |  |
|**resourceGroup** | **String** | RoleAssignment will be scope to this resourceGroup. If empty, it scopes to the subscription. |  [optional] |
