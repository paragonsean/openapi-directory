...
class ResourceGroupDefinition(Model):
    ...
    def __init__(self, depends_on: List[str]=None, location: str=None, metadata: ParameterDefinitionMetadata=None, name: str=None, tags: Dict[str, str]=None):
        ...
        :param tags: The tags of this ResourceGroupDefinition.
        """
        self.openapi_types = {
            'depends_on': List[str],
            'location': str,
    ...
    @property
    def tags(self):
        """Gets the tags of this ResourceGroupDefinition.

        A dictionary of resource group tag values.

        :return: The tags of this ResourceGroupDefinition.
        :rtype: Dict[str, str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ResourceGroupDefinition.
