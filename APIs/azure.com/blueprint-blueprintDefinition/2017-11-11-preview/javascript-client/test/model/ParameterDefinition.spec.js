...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlueprintClient.ParameterDefinition();
  });
  ...
  describe('ParameterDefinition', function() {
    it('should create an instance of ParameterDefinition', function() {
      // uncomment below and update the code to test ParameterDefinition
      //var instance = new BlueprintClient.ParameterDefinition();
      //expect(instance).to.be.a(BlueprintClient.ParameterDefinition);
    });
