...
class TemplateArtifactProperties(Model):
    ...
    def __init__(self, parameters: Dict[str, ParameterValueBase]=None, resource_group: str=None, template: object=None, description: str=None, display_name: str=None, depends_on: List[str]=None):
