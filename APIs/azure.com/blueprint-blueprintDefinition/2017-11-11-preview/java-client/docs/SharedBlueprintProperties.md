...
|------------ | ------------- | ------------- | -------------|
|**parameters** | [**Map&lt;String, ParameterDefinition&gt;**](ParameterDefinition.md) | A dictionary hold parameter name and it&#39;s metadata. |  [optional] |
...
|**targetScope** | [**TargetScopeEnum**](#TargetScopeEnum) | The scope where this Blueprint can be applied. |  [optional] |
