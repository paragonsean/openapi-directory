...
/*
 * OAISharedBlueprintProperties.h
 *
 * Shared Schema for both blueprintProperties and publishedBlueprintProperties.
 */

#ifndef OAISharedBlueprintProperties_H
#define OAISharedBlueprintProperties_H
...
class OAISharedBlueprintProperties : public OAIObject {
public:
    OAISharedBlueprintProperties();
    OAISharedBlueprintProperties(QString json);
    ~OAISharedBlueprintProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISharedBlueprintProperties)

#endif // OAISharedBlueprintProperties_H
