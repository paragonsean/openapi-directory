...
QMap<QString, OAIParameterValueBase> OAITemplateArtifactProperties::getParameters() const {
    return m_parameters;
}
void OAITemplateArtifactProperties::setParameters(const QMap<QString, OAIParameterValueBase> &parameters) {
