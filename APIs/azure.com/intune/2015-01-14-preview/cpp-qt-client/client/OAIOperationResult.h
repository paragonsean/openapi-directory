...
namespace OpenAPI {
class OAIOperationResultProperties;
...
public:
    ...
    OAIOperationResultProperties getProperties() const;
    void setProperties(const OAIOperationResultProperties &properties);
...
private:
    ...
    OAIOperationResultProperties m_properties;
