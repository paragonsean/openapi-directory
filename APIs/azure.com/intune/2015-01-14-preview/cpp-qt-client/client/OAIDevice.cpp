...
QString OAIDevice::getLocation() const {
    return m_location;
}
void OAIDevice::setLocation(const QString &location) {
    m_location = location;
...
QMap<QString, QString> OAIDevice::getTags() const {
    return m_tags;
}
void OAIDevice::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
