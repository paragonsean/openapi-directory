...
public:
    ...
    OAILocationProperties getProperties() const;
    void setProperties(const OAILocationProperties &properties);
...
private:
    ...
    OAILocationProperties m_properties;
