...
public class Location {
  ...
  public Location tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public Location putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        LocationProperties.validateJsonElement(jsonObj.get("properties"));
      }
