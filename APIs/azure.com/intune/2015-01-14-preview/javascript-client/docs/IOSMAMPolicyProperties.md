# IntuneResourceManagementClient.IOSMAMPolicyProperties

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**fileEncryptionLevel** | **String** |  | [optional] [default to &#39;deviceLocked&#39;]
**touchId** | **String** |  | [optional] [default to &#39;enable&#39;]
...
* `deviceLocked` (value: `"deviceLocked"`)

* `deviceLockedExceptFilesOpen` (value: `"deviceLockedExceptFilesOpen"`)

* `afterDeviceRestart` (value: `"afterDeviceRestart"`)

* `useDeviceSettings` (value: `"useDeviceSettings"`)
