...
public class MAMPolicyProperties {
  ...
  public MAMPolicyProperties accessRecheckOfflineTimeout(String accessRecheckOfflineTimeout) {
  ...
  public MAMPolicyProperties accessRecheckOnlineTimeout(String accessRecheckOnlineTimeout) {
  ...
  public MAMPolicyProperties appSharingFromLevel(AppSharingFromLevelEnum appSharingFromLevel) {
  ...
  public MAMPolicyProperties appSharingToLevel(AppSharingToLevelEnum appSharingToLevel) {
  ...
  public MAMPolicyProperties authentication(AuthenticationEnum authentication) {
  ...
  public MAMPolicyProperties clipboardSharingLevel(ClipboardSharingLevelEnum clipboardSharingLevel) {
  ...
  public MAMPolicyProperties dataBackup(DataBackupEnum dataBackup) {
  ...
  public MAMPolicyProperties description(String description) {
  ...
  public MAMPolicyProperties deviceCompliance(DeviceComplianceEnum deviceCompliance) {
  ...
  public MAMPolicyProperties fileSharingSaveAs(FileSharingSaveAsEnum fileSharingSaveAs) {
  ...
  public MAMPolicyProperties friendlyName(String friendlyName) {
  ...
  public MAMPolicyProperties managedBrowser(ManagedBrowserEnum managedBrowser) {
  ...
  public MAMPolicyProperties offlineWipeTimeout(String offlineWipeTimeout) {
  ...
  public MAMPolicyProperties pin(PinEnum pin) {
    this.pin = pin;
    return this;
  }
  ...
  public MAMPolicyProperties pinNumRetry(Integer pinNumRetry) {
  ...
  public boolean equals(Object o) {
    ...
    MAMPolicyProperties maMPolicyProperties = (MAMPolicyProperties) o;
    return Objects.equals(this.accessRecheckOfflineTimeout, maMPolicyProperties.accessRecheckOfflineTimeout) &&
        Objects.equals(this.accessRecheckOnlineTimeout, maMPolicyProperties.accessRecheckOnlineTimeout) &&
        Objects.equals(this.appSharingFromLevel, maMPolicyProperties.appSharingFromLevel) &&
        Objects.equals(this.appSharingToLevel, maMPolicyProperties.appSharingToLevel) &&
        Objects.equals(this.authentication, maMPolicyProperties.authentication) &&
        Objects.equals(this.clipboardSharingLevel, maMPolicyProperties.clipboardSharingLevel) &&
        Objects.equals(this.dataBackup, maMPolicyProperties.dataBackup) &&
        Objects.equals(this.description, maMPolicyProperties.description) &&
        Objects.equals(this.deviceCompliance, maMPolicyProperties.deviceCompliance) &&
        Objects.equals(this.fileSharingSaveAs, maMPolicyProperties.fileSharingSaveAs) &&
        Objects.equals(this.friendlyName, maMPolicyProperties.friendlyName) &&
        Objects.equals(this.groupStatus, maMPolicyProperties.groupStatus) &&
        Objects.equals(this.lastModifiedTime, maMPolicyProperties.lastModifiedTime) &&
        Objects.equals(this.managedBrowser, maMPolicyProperties.managedBrowser) &&
        Objects.equals(this.numOfApps, maMPolicyProperties.numOfApps) &&
        Objects.equals(this.offlineWipeTimeout, maMPolicyProperties.offlineWipeTimeout) &&
        Objects.equals(this.pin, maMPolicyProperties.pin) &&
        Objects.equals(this.pinNumRetry, maMPolicyProperties.pinNumRetry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessRecheckOfflineTimeout, accessRecheckOnlineTimeout, appSharingFromLevel, appSharingToLevel, authentication, clipboardSharingLevel, dataBackup, description, deviceCompliance, fileSharingSaveAs, friendlyName, groupStatus, lastModifiedTime, managedBrowser, numOfApps, offlineWipeTimeout, pin, pinNumRetry);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MAMPolicyProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MAMPolicyProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MAMPolicyProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MAMPolicyProperties is not found in the empty JSON string", MAMPolicyProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MAMPolicyProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MAMPolicyProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MAMPolicyProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MAMPolicyProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MAMPolicyProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MAMPolicyProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MAMPolicyProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<MAMPolicyProperties>() {
           @Override
           public void write(JsonWriter out, MAMPolicyProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MAMPolicyProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MAMPolicyProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MAMPolicyProperties
   * @throws IOException if the JSON string is invalid with respect to MAMPolicyProperties
   */
  public static MAMPolicyProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MAMPolicyProperties.class);
  }

  /**
   * Convert an instance of MAMPolicyProperties to an JSON string
   *
   * @return JSON string
   */
