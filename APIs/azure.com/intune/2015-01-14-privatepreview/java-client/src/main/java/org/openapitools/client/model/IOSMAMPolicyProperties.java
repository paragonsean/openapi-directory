...
public class IOSMAMPolicyProperties {
  /**
   * Gets or Sets fileEncryptionLevel
   */
  @JsonAdapter(FileEncryptionLevelEnum.Adapter.class)
  public enum FileEncryptionLevelEnum {
    ...
    FileEncryptionLevelEnum(String value) {
      this.value = value;
    }
    ...
    public static FileEncryptionLevelEnum fromValue(String value) {
      for (FileEncryptionLevelEnum b : FileEncryptionLevelEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<FileEncryptionLevelEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final FileEncryptionLevelEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public FileEncryptionLevelEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return FileEncryptionLevelEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      FileEncryptionLevelEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_FILE_ENCRYPTION_LEVEL = "fileEncryptionLevel";
  @SerializedName(SERIALIZED_NAME_FILE_ENCRYPTION_LEVEL)
  private FileEncryptionLevelEnum fileEncryptionLevel = FileEncryptionLevelEnum.DEVICE_LOCKED;

  /**
   * Gets or Sets touchId
   */
  @JsonAdapter(TouchIdEnum.Adapter.class)
  public enum TouchIdEnum {
    ENABLE("enable"),
    ...
    public static TouchIdEnum fromValue(String value) {
      for (TouchIdEnum b : TouchIdEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<TouchIdEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final TouchIdEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public TouchIdEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return TouchIdEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      TouchIdEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_TOUCH_ID = "touchId";
  @SerializedName(SERIALIZED_NAME_TOUCH_ID)
  private TouchIdEnum touchId = TouchIdEnum.ENABLE;
  ...
  public IOSMAMPolicyProperties fileEncryptionLevel(FileEncryptionLevelEnum fileEncryptionLevel) {
    this.fileEncryptionLevel = fileEncryptionLevel;
    return this;
  }

  /**
   * Get fileEncryptionLevel
   * @return fileEncryptionLevel
   */
  @javax.annotation.Nullable
  public FileEncryptionLevelEnum getFileEncryptionLevel() {
    return fileEncryptionLevel;
  }

  public void setFileEncryptionLevel(FileEncryptionLevelEnum fileEncryptionLevel) {
    this.fileEncryptionLevel = fileEncryptionLevel;
  }


  public IOSMAMPolicyProperties touchId(TouchIdEnum touchId) {
   ...
   */
  @javax.annotation.Nullable
  public TouchIdEnum getTouchId() {
    return touchId;
  }

  public void setTouchId(TouchIdEnum touchId) {
    this.touchId = touchId;
  }


  public IOSMAMPolicyProperties accessRecheckOfflineTimeout(String accessRecheckOfflineTimeout) {
  ...
  public IOSMAMPolicyProperties accessRecheckOnlineTimeout(String accessRecheckOnlineTimeout) {
  ...
  public IOSMAMPolicyProperties appSharingFromLevel(AppSharingFromLevelEnum appSharingFromLevel) {
  ...
  public IOSMAMPolicyProperties appSharingToLevel(AppSharingToLevelEnum appSharingToLevel) {
  ...
  public IOSMAMPolicyProperties authentication(AuthenticationEnum authentication) {
  ...
  public IOSMAMPolicyProperties clipboardSharingLevel(ClipboardSharingLevelEnum clipboardSharingLevel) {
  ...
  public IOSMAMPolicyProperties dataBackup(DataBackupEnum dataBackup) {
  ...
  public IOSMAMPolicyProperties description(String description) {
  ...
  public IOSMAMPolicyProperties deviceCompliance(DeviceComplianceEnum deviceCompliance) {
  ...
  public IOSMAMPolicyProperties fileSharingSaveAs(FileSharingSaveAsEnum fileSharingSaveAs) {
  ...
  public IOSMAMPolicyProperties friendlyName(String friendlyName) {
  ...
  public IOSMAMPolicyProperties managedBrowser(ManagedBrowserEnum managedBrowser) {
  ...
  public IOSMAMPolicyProperties offlineWipeTimeout(String offlineWipeTimeout) {
  ...
  public IOSMAMPolicyProperties pin(PinEnum pin) {
    this.pin = pin;
    return this;
  }
  ...
  public IOSMAMPolicyProperties pinNumRetry(Integer pinNumRetry) {
  ...
  public boolean equals(Object o) {
    ...
    IOSMAMPolicyProperties iOSMAMPolicyProperties = (IOSMAMPolicyProperties) o;
    return Objects.equals(this.fileEncryptionLevel, iOSMAMPolicyProperties.fileEncryptionLevel) &&
        Objects.equals(this.touchId, iOSMAMPolicyProperties.touchId) &&
        Objects.equals(this.accessRecheckOfflineTimeout, iOSMAMPolicyProperties.accessRecheckOfflineTimeout) &&
        Objects.equals(this.accessRecheckOnlineTimeout, iOSMAMPolicyProperties.accessRecheckOnlineTimeout) &&
        Objects.equals(this.appSharingFromLevel, iOSMAMPolicyProperties.appSharingFromLevel) &&
        Objects.equals(this.appSharingToLevel, iOSMAMPolicyProperties.appSharingToLevel) &&
        Objects.equals(this.authentication, iOSMAMPolicyProperties.authentication) &&
        Objects.equals(this.clipboardSharingLevel, iOSMAMPolicyProperties.clipboardSharingLevel) &&
        Objects.equals(this.dataBackup, iOSMAMPolicyProperties.dataBackup) &&
        Objects.equals(this.description, iOSMAMPolicyProperties.description) &&
        Objects.equals(this.deviceCompliance, iOSMAMPolicyProperties.deviceCompliance) &&
        Objects.equals(this.fileSharingSaveAs, iOSMAMPolicyProperties.fileSharingSaveAs) &&
        Objects.equals(this.friendlyName, iOSMAMPolicyProperties.friendlyName) &&
        Objects.equals(this.groupStatus, iOSMAMPolicyProperties.groupStatus) &&
        Objects.equals(this.lastModifiedTime, iOSMAMPolicyProperties.lastModifiedTime) &&
        Objects.equals(this.managedBrowser, iOSMAMPolicyProperties.managedBrowser) &&
        Objects.equals(this.numOfApps, iOSMAMPolicyProperties.numOfApps) &&
        Objects.equals(this.offlineWipeTimeout, iOSMAMPolicyProperties.offlineWipeTimeout) &&
        Objects.equals(this.pin, iOSMAMPolicyProperties.pin) &&
        Objects.equals(this.pinNumRetry, iOSMAMPolicyProperties.pinNumRetry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileEncryptionLevel, touchId, accessRecheckOfflineTimeout, accessRecheckOnlineTimeout, appSharingFromLevel, appSharingToLevel, authentication, clipboardSharingLevel, dataBackup, description, deviceCompliance, fileSharingSaveAs, friendlyName, groupStatus, lastModifiedTime, managedBrowser, numOfApps, offlineWipeTimeout, pin, pinNumRetry);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IOSMAMPolicyProperties {\n");
    sb.append("    fileEncryptionLevel: ").append(toIndentedString(fileEncryptionLevel)).append("\n");
    sb.append("    touchId: ").append(toIndentedString(touchId)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IOSMAMPolicyProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IOSMAMPolicyProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IOSMAMPolicyProperties is not found in the empty JSON string", IOSMAMPolicyProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IOSMAMPolicyProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IOSMAMPolicyProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IOSMAMPolicyProperties.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("fileEncryptionLevel") != null && !jsonObj.get("fileEncryptionLevel").isJsonNull()) && !jsonObj.get("fileEncryptionLevel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fileEncryptionLevel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fileEncryptionLevel").toString()));
      }
      // validate the optional field `fileEncryptionLevel`
      if (jsonObj.get("fileEncryptionLevel") != null && !jsonObj.get("fileEncryptionLevel").isJsonNull()) {
        FileEncryptionLevelEnum.validateJsonElement(jsonObj.get("fileEncryptionLevel"));
      }
      if ((jsonObj.get("touchId") != null && !jsonObj.get("touchId").isJsonNull()) && !jsonObj.get("touchId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `touchId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("touchId").toString()));
      }
      // validate the optional field `touchId`
      if (jsonObj.get("touchId") != null && !jsonObj.get("touchId").isJsonNull()) {
        TouchIdEnum.validateJsonElement(jsonObj.get("touchId"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IOSMAMPolicyProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IOSMAMPolicyProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IOSMAMPolicyProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IOSMAMPolicyProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<IOSMAMPolicyProperties>() {
           @Override
           public void write(JsonWriter out, IOSMAMPolicyProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IOSMAMPolicyProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IOSMAMPolicyProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IOSMAMPolicyProperties
   * @throws IOException if the JSON string is invalid with respect to IOSMAMPolicyProperties
   */
  public static IOSMAMPolicyProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IOSMAMPolicyProperties.class);
  }

  /**
   * Convert an instance of IOSMAMPolicyProperties to an JSON string
   *
   * @return JSON string
   */
