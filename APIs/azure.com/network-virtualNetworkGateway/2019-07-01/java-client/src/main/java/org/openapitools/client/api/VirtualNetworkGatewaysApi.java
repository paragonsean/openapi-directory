...
import org.openapitools.client.model.VpnClientConnectionHealthDetailListResult;
...
public class VirtualNetworkGatewaysApi {
    ...
    /**
     * Build call for virtualNetworkGatewaysGetVpnclientConnectionHealth
     * @param resourceGroupName The name of the resource group. (required)
     * @param virtualNetworkGatewayName The name of the virtual network gateway. (required)
     * @param apiVersion Client API version. (required)
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> List of VPN client connection health details. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Accepted and the operation will complete asynchronously. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call virtualNetworkGatewaysGetVpnclientConnectionHealthCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/getVpnClientConnectionHealth"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "virtualNetworkGatewayName" + "}", localVarApiClient.escapeString(virtualNetworkGatewayName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualNetworkGatewaysGetVpnclientConnectionHealthValidateBeforeCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth(Async)");
        }

        // verify the required parameter 'virtualNetworkGatewayName' is set
        if (virtualNetworkGatewayName == null) {
            throw new ApiException("Missing the required parameter 'virtualNetworkGatewayName' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth(Async)");
        }

        return virtualNetworkGatewaysGetVpnclientConnectionHealthCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, _callback);
     ...
     */
    public VpnClientConnectionHealthDetailListResult virtualNetworkGatewaysGetVpnclientConnectionHealth(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<VpnClientConnectionHealthDetailListResult> localVarResp = virtualNetworkGatewaysGetVpnclientConnectionHealthWithHttpInfo(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion Client API version. (required)
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @return ApiResponse&lt;VpnClientConnectionHealthDetailListResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VpnClientConnectionHealthDetailListResult> virtualNetworkGatewaysGetVpnclientConnectionHealthWithHttpInfo(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = virtualNetworkGatewaysGetVpnclientConnectionHealthValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<VpnClientConnectionHealthDetailListResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call virtualNetworkGatewaysGetVpnclientConnectionHealthAsync(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, final ApiCallback<VpnClientConnectionHealthDetailListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualNetworkGatewaysGetVpnclientConnectionHealthValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<VpnClientConnectionHealthDetailListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for virtualNetworkGatewaysResetVpnClientSharedKey
     * @param resourceGroupName The name of the resource group. (required)
     * @param virtualNetworkGatewayName The name of the virtual network gateway. (required)
     * @param apiVersion Client API version. (required)
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Request successful. The operation reset the vpn client shared key of the virtual network gateway. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Accepted and the operation will complete asynchronously. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call virtualNetworkGatewaysResetVpnClientSharedKeyCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/resetvpnclientsharedkey"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "virtualNetworkGatewayName" + "}", localVarApiClient.escapeString(virtualNetworkGatewayName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualNetworkGatewaysResetVpnClientSharedKeyValidateBeforeCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling virtualNetworkGatewaysResetVpnClientSharedKey(Async)");
        }

        // verify the required parameter 'virtualNetworkGatewayName' is set
        if (virtualNetworkGatewayName == null) {
            throw new ApiException("Missing the required parameter 'virtualNetworkGatewayName' when calling virtualNetworkGatewaysResetVpnClientSharedKey(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling virtualNetworkGatewaysResetVpnClientSharedKey(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling virtualNetworkGatewaysResetVpnClientSharedKey(Async)");
        }

        return virtualNetworkGatewaysResetVpnClientSharedKeyCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, _callback);
     ...
     */
    public void virtualNetworkGatewaysResetVpnClientSharedKey(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId) throws ApiException {
        virtualNetworkGatewaysResetVpnClientSharedKeyWithHttpInfo(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId);
    }
     ...
     */
    public ApiResponse<Void> virtualNetworkGatewaysResetVpnClientSharedKeyWithHttpInfo(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = virtualNetworkGatewaysResetVpnClientSharedKeyValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call virtualNetworkGatewaysResetVpnClientSharedKeyAsync(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualNetworkGatewaysResetVpnClientSharedKeyValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    /**
     * Build call for virtualNetworkGatewaysStartPacketCapture
     * @param resourceGroupName The name of the resource group. (required)
     * @param virtualNetworkGatewayName The name of the virtual network gateway. (required)
     * @param apiVersion Client API version. (required)
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param parameters Virtual network gateway packet capture parameters supplied to start packet capture on gateway. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Request successful. The operation packet capture started on virtual network gateway. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Accepted and the operation will complete asynchronously. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call virtualNetworkGatewaysStartPacketCaptureCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStartParameters parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/startPacketCapture"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "virtualNetworkGatewayName" + "}", localVarApiClient.escapeString(virtualNetworkGatewayName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualNetworkGatewaysStartPacketCaptureValidateBeforeCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStartParameters parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling virtualNetworkGatewaysStartPacketCapture(Async)");
        }

        // verify the required parameter 'virtualNetworkGatewayName' is set
        if (virtualNetworkGatewayName == null) {
            throw new ApiException("Missing the required parameter 'virtualNetworkGatewayName' when calling virtualNetworkGatewaysStartPacketCapture(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling virtualNetworkGatewaysStartPacketCapture(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling virtualNetworkGatewaysStartPacketCapture(Async)");
        }

        return virtualNetworkGatewaysStartPacketCaptureCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public String virtualNetworkGatewaysStartPacketCapture(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStartParameters parameters) throws ApiException {
        ApiResponse<String> localVarResp = virtualNetworkGatewaysStartPacketCaptureWithHttpInfo(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> virtualNetworkGatewaysStartPacketCaptureWithHttpInfo(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStartParameters parameters) throws ApiException {
        okhttp3.Call localVarCall = virtualNetworkGatewaysStartPacketCaptureValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call virtualNetworkGatewaysStartPacketCaptureAsync(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStartParameters parameters, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualNetworkGatewaysStartPacketCaptureValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for virtualNetworkGatewaysStopPacketCapture
     * @param resourceGroupName The name of the resource group. (required)
     * @param virtualNetworkGatewayName The name of the virtual network gateway. (required)
     * @param apiVersion Client API version. (required)
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param parameters Virtual network gateway packet capture parameters supplied to stop packet capture on gateway. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Request successful. The operation packet capture stopped on virtual network gateway. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Accepted and the operation will complete asynchronously. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call virtualNetworkGatewaysStopPacketCaptureCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStopParameters parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/stopPacketCapture"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "virtualNetworkGatewayName" + "}", localVarApiClient.escapeString(virtualNetworkGatewayName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualNetworkGatewaysStopPacketCaptureValidateBeforeCall(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStopParameters parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling virtualNetworkGatewaysStopPacketCapture(Async)");
        }

        // verify the required parameter 'virtualNetworkGatewayName' is set
        if (virtualNetworkGatewayName == null) {
            throw new ApiException("Missing the required parameter 'virtualNetworkGatewayName' when calling virtualNetworkGatewaysStopPacketCapture(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling virtualNetworkGatewaysStopPacketCapture(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling virtualNetworkGatewaysStopPacketCapture(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling virtualNetworkGatewaysStopPacketCapture(Async)");
        }

        return virtualNetworkGatewaysStopPacketCaptureCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public String virtualNetworkGatewaysStopPacketCapture(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStopParameters parameters) throws ApiException {
        ApiResponse<String> localVarResp = virtualNetworkGatewaysStopPacketCaptureWithHttpInfo(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> virtualNetworkGatewaysStopPacketCaptureWithHttpInfo(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStopParameters parameters) throws ApiException {
        okhttp3.Call localVarCall = virtualNetworkGatewaysStopPacketCaptureValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call virtualNetworkGatewaysStopPacketCaptureAsync(String resourceGroupName, String virtualNetworkGatewayName, String apiVersion, String subscriptionId, VpnPacketCaptureStopParameters parameters, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualNetworkGatewaysStopPacketCaptureValidateBeforeCall(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
