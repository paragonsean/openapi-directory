...
public class VirtualNetworkGatewayPropertiesFormat {
   ...
   */
  @JsonAdapter(VpnGatewayGenerationEnum.Adapter.class)
  public enum VpnGatewayGenerationEnum {
    NONE("None"),
    ...
    VpnGatewayGenerationEnum(String value) {
      this.value = value;
    }
    ...
    public static VpnGatewayGenerationEnum fromValue(String value) {
      for (VpnGatewayGenerationEnum b : VpnGatewayGenerationEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<VpnGatewayGenerationEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final VpnGatewayGenerationEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public VpnGatewayGenerationEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return VpnGatewayGenerationEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      VpnGatewayGenerationEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_VPN_GATEWAY_GENERATION = "vpnGatewayGeneration";
  @SerializedName(SERIALIZED_NAME_VPN_GATEWAY_GENERATION)
  private VpnGatewayGenerationEnum vpnGatewayGeneration;
  ...
  public VirtualNetworkGatewayPropertiesFormat vpnGatewayGeneration(VpnGatewayGenerationEnum vpnGatewayGeneration) {
   ...
   */
  @javax.annotation.Nullable
  public VpnGatewayGenerationEnum getVpnGatewayGeneration() {
    return vpnGatewayGeneration;
  }

  public void setVpnGatewayGeneration(VpnGatewayGenerationEnum vpnGatewayGeneration) {
    this.vpnGatewayGeneration = vpnGatewayGeneration;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activeActive, virtualNetworkGatewayPropertiesFormat.activeActive) &&
        ...
        Objects.equals(this.vpnGatewayGeneration, virtualNetworkGatewayPropertiesFormat.vpnGatewayGeneration) &&
        Objects.equals(this.vpnType, virtualNetworkGatewayPropertiesFormat.vpnType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activeActive, bgpSettings, customRoutes, enableBgp, gatewayDefaultSite, gatewayType, ipConfigurations, provisioningState, resourceGuid, sku, vpnClientConfiguration, vpnGatewayGeneration, vpnType);
  }
  ...
  public String toString() {
    ...
    sb.append("    vpnGatewayGeneration: ").append(toIndentedString(vpnGatewayGeneration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("vpnGatewayGeneration");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("vpnGatewayGeneration") != null && !jsonObj.get("vpnGatewayGeneration").isJsonNull()) && !jsonObj.get("vpnGatewayGeneration").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `vpnGatewayGeneration` to be a primitive type in the JSON string but got `%s`", jsonObj.get("vpnGatewayGeneration").toString()));
      }
      // validate the optional field `vpnGatewayGeneration`
      if (jsonObj.get("vpnGatewayGeneration") != null && !jsonObj.get("vpnGatewayGeneration").isJsonNull()) {
        VpnGatewayGenerationEnum.validateJsonElement(jsonObj.get("vpnGatewayGeneration"));
      }
