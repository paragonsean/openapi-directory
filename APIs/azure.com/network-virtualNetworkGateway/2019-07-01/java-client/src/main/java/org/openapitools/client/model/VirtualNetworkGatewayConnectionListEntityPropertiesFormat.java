...
public class VirtualNetworkGatewayConnectionListEntityPropertiesFormat {
  ...
  public static final String SERIALIZED_NAME_TRAFFIC_SELECTOR_POLICIES = "trafficSelectorPolicies";
  @SerializedName(SERIALIZED_NAME_TRAFFIC_SELECTOR_POLICIES)
  private List<TrafficSelectorPolicy> trafficSelectorPolicies = new ArrayList<>();
  ...
  public VirtualNetworkGatewayConnectionListEntityPropertiesFormat connectionStatus(VirtualNetworkGatewayConnectionStatus connectionStatus) {
  ...
  public VirtualNetworkGatewayConnectionListEntityPropertiesFormat connectionType(VirtualNetworkGatewayConnectionType connectionType) {
  ...
  public void setConnectionType(VirtualNetworkGatewayConnectionType connectionType) {
    this.connectionType = connectionType;
  }
  ...
  public VirtualNetworkGatewayConnectionListEntityPropertiesFormat trafficSelectorPolicies(List<TrafficSelectorPolicy> trafficSelectorPolicies) {
    this.trafficSelectorPolicies = trafficSelectorPolicies;
    return this;
  }

  public VirtualNetworkGatewayConnectionListEntityPropertiesFormat addTrafficSelectorPoliciesItem(TrafficSelectorPolicy trafficSelectorPoliciesItem) {
    if (this.trafficSelectorPolicies == null) {
      this.trafficSelectorPolicies = new ArrayList<>();
    }
    this.trafficSelectorPolicies.add(trafficSelectorPoliciesItem);
    return this;
  }
  ...
  public void setTrafficSelectorPolicies(List<TrafficSelectorPolicy> trafficSelectorPolicies) {
    this.trafficSelectorPolicies = trafficSelectorPolicies;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationKey, virtualNetworkGatewayConnectionListEntityPropertiesFormat.authorizationKey) &&
        ...
        Objects.equals(this.trafficSelectorPolicies, virtualNetworkGatewayConnectionListEntityPropertiesFormat.trafficSelectorPolicies) &&
  ...
  public String toString() {
    ...
    sb.append("    trafficSelectorPolicies: ").append(toIndentedString(trafficSelectorPolicies)).append("\n");
  ...
  static {
    ...
    openapiFields.add("trafficSelectorPolicies");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      VirtualNetworkGatewayConnectionType.validateJsonElement(jsonObj.get("connectionType"));
      ...
      if (jsonObj.get("trafficSelectorPolicies") != null && !jsonObj.get("trafficSelectorPolicies").isJsonNull()) {
        JsonArray jsonArraytrafficSelectorPolicies = jsonObj.getAsJsonArray("trafficSelectorPolicies");
        if (jsonArraytrafficSelectorPolicies != null) {
          // ensure the json data is an array
          if (!jsonObj.get("trafficSelectorPolicies").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `trafficSelectorPolicies` to be an array in the JSON string but got `%s`", jsonObj.get("trafficSelectorPolicies").toString()));
          }

          // validate the optional field `trafficSelectorPolicies` (array)
          for (int i = 0; i < jsonArraytrafficSelectorPolicies.size(); i++) {
            TrafficSelectorPolicy.validateJsonElement(jsonArraytrafficSelectorPolicies.get(i));
          };
        }
      }
