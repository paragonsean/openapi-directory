...
class OAITrafficSelectorPolicy;
...
public:
    ...
    QList<OAITrafficSelectorPolicy> getTrafficSelectorPolicies() const;
    void setTrafficSelectorPolicies(const QList<OAITrafficSelectorPolicy> &traffic_selector_policies);
    bool is_traffic_selector_policies_Set() const;
    bool is_traffic_selector_policies_Valid() const;
...
private:
    ...
    QList<OAITrafficSelectorPolicy> m_traffic_selector_policies;
    bool m_traffic_selector_policies_isSet;
    bool m_traffic_selector_policies_isValid;
