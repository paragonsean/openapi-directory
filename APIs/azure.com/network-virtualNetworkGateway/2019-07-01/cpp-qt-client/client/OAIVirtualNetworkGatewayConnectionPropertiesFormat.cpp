...
QList<OAITrafficSelectorPolicy> OAIVirtualNetworkGatewayConnectionPropertiesFormat::getTrafficSelectorPolicies() const {
    return m_traffic_selector_policies;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setTrafficSelectorPolicies(const QList<OAITrafficSelectorPolicy> &traffic_selector_policies) {
    m_traffic_selector_policies = traffic_selector_policies;
    m_traffic_selector_policies_isSet = true;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_traffic_selector_policies_Set() const{
    return m_traffic_selector_policies_isSet;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_traffic_selector_policies_Valid() const{
