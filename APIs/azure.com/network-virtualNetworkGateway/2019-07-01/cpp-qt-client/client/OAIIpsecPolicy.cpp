...
OAIDhGroup OAIIpsecPolicy::getDhGroup() const {
    return m_dh_group;
}
void OAIIpsecPolicy::setDhGroup(const OAIDhGroup &dh_group) {
    m_dh_group = dh_group;
...
OAIIkeEncryption OAIIpsecPolicy::getIkeEncryption() const {
    return m_ike_encryption;
}
void OAIIpsecPolicy::setIkeEncryption(const OAIIkeEncryption &ike_encryption) {
...
OAIIkeIntegrity OAIIpsecPolicy::getIkeIntegrity() const {
    return m_ike_integrity;
}
void OAIIpsecPolicy::setIkeIntegrity(const OAIIkeIntegrity &ike_integrity) {
...
OAIIpsecEncryption OAIIpsecPolicy::getIpsecEncryption() const {
    return m_ipsec_encryption;
}
void OAIIpsecPolicy::setIpsecEncryption(const OAIIpsecEncryption &ipsec_encryption) {
...
OAIIpsecIntegrity OAIIpsecPolicy::getIpsecIntegrity() const {
    return m_ipsec_integrity;
}
void OAIIpsecPolicy::setIpsecIntegrity(const OAIIpsecIntegrity &ipsec_integrity) {
...
OAIPfsGroup OAIIpsecPolicy::getPfsGroup() const {
    return m_pfs_group;
}
void OAIIpsecPolicy::setPfsGroup(const OAIPfsGroup &pfs_group) {
