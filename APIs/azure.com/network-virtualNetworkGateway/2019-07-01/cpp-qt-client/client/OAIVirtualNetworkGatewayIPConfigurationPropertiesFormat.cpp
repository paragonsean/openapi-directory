...
OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat_peer OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::setPublicIpAddress(const OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat_peer &public_ip_address) {
...
OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat_peer OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::setSubnet(const OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat_peer &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
