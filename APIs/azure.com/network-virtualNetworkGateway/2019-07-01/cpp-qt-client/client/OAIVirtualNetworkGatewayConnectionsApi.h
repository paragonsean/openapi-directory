...
public:
    ...
    */
    virtual void virtualNetworkGatewayConnectionsStopPacketCapture(const QString &resource_group_name, const QString &virtual_network_gateway_connection_name, const QString &api_version, const QString &subscription_id, const OAIVpnPacketCaptureStopParameters &parameters);
...
private:
    ...
    void virtualNetworkGatewayConnectionsStartPacketCaptureCallback(OAIHttpRequestWorker *worker);
    void virtualNetworkGatewayConnectionsStopPacketCaptureCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void virtualNetworkGatewayConnectionsStartPacketCaptureSignal(QString summary);
    void virtualNetworkGatewayConnectionsStopPacketCaptureSignal(QString summary);
    ...
    void virtualNetworkGatewayConnectionsStartPacketCaptureSignalFull(OAIHttpRequestWorker *worker, QString summary);
    void virtualNetworkGatewayConnectionsStopPacketCaptureSignalFull(OAIHttpRequestWorker *worker, QString summary);
    ...
    Q_DECL_DEPRECATED_X("Use virtualNetworkGatewayConnectionsStartPacketCaptureSignalError() instead")
    void virtualNetworkGatewayConnectionsStartPacketCaptureSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualNetworkGatewayConnectionsStartPacketCaptureSignalError(QString summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use virtualNetworkGatewayConnectionsStopPacketCaptureSignalError() instead")
    void virtualNetworkGatewayConnectionsStopPacketCaptureSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualNetworkGatewayConnectionsStopPacketCaptureSignalError(QString summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use virtualNetworkGatewayConnectionsStartPacketCaptureSignalErrorFull() instead")
    void virtualNetworkGatewayConnectionsStartPacketCaptureSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualNetworkGatewayConnectionsStartPacketCaptureSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use virtualNetworkGatewayConnectionsStopPacketCaptureSignalErrorFull() instead")
    void virtualNetworkGatewayConnectionsStopPacketCaptureSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualNetworkGatewayConnectionsStopPacketCaptureSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
