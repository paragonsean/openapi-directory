...
void OAIVirtualNetworkGatewayPropertiesFormat::initializeModel() {
    ...
    m_vpn_gateway_generation_isSet = false;
    m_vpn_gateway_generation_isValid = false;
...
void OAIVirtualNetworkGatewayPropertiesFormat::fromJsonObject(QJsonObject json) {
    ...
    m_vpn_gateway_generation_isValid = ::OpenAPI::fromJsonValue(m_vpn_gateway_generation, json[QString("vpnGatewayGeneration")]);
    m_vpn_gateway_generation_isSet = !json[QString("vpnGatewayGeneration")].isNull() && m_vpn_gateway_generation_isValid;
...
QJsonObject OAIVirtualNetworkGatewayPropertiesFormat::asJsonObject() const {
    ...
    if (m_vpn_gateway_generation_isSet) {
        obj.insert(QString("vpnGatewayGeneration"), ::OpenAPI::toJsonValue(m_vpn_gateway_generation));
    }
    if (m_vpn_type_isSet) {
...
OAILocalNetworkGatewayPropertiesFormat_localNetworkAddressSpace OAIVirtualNetworkGatewayPropertiesFormat::getCustomRoutes() const {
    return m_custom_routes;
}
void OAIVirtualNetworkGatewayPropertiesFormat::setCustomRoutes(const OAILocalNetworkGatewayPropertiesFormat_localNetworkAddressSpace &custom_routes) {
    m_custom_routes = custom_routes;
    m_custom_routes_isSet = true;
}

bool OAIVirtualNetworkGatewayPropertiesFormat::is_custom_routes_Set() const{
    return m_custom_routes_isSet;
}

bool OAIVirtualNetworkGatewayPropertiesFormat::is_custom_routes_Valid() const{
...
QString OAIVirtualNetworkGatewayPropertiesFormat::getVpnGatewayGeneration() const {
    return m_vpn_gateway_generation;
}
void OAIVirtualNetworkGatewayPropertiesFormat::setVpnGatewayGeneration(const QString &vpn_gateway_generation) {
    m_vpn_gateway_generation = vpn_gateway_generation;
    m_vpn_gateway_generation_isSet = true;
}

bool OAIVirtualNetworkGatewayPropertiesFormat::is_vpn_gateway_generation_Set() const{
    return m_vpn_gateway_generation_isSet;
}

bool OAIVirtualNetworkGatewayPropertiesFormat::is_vpn_gateway_generation_Valid() const{
    return m_vpn_gateway_generation_isValid;
}
