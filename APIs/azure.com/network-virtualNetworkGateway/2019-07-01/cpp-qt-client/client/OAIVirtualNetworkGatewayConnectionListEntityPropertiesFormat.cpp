...
void OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::initializeModel() {
    ...
    m_traffic_selector_policies_isSet = false;
    m_traffic_selector_policies_isValid = false;
...
void OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::fromJsonObject(QJsonObject json) {
    ...
    m_traffic_selector_policies_isValid = ::OpenAPI::fromJsonValue(m_traffic_selector_policies, json[QString("trafficSelectorPolicies")]);
    m_traffic_selector_policies_isSet = !json[QString("trafficSelectorPolicies")].isNull() && m_traffic_selector_policies_isValid;
...
QJsonObject OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::asJsonObject() const {
    ...
    if (m_traffic_selector_policies.size() > 0) {
        obj.insert(QString("trafficSelectorPolicies"), ::OpenAPI::toJsonValue(m_traffic_selector_policies));
    }
...
OAIVirtualNetworkGatewayConnectionStatus OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::getConnectionStatus() const {
    return m_connection_status;
}
void OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::setConnectionStatus(const OAIVirtualNetworkGatewayConnectionStatus &connection_status) {
...
OAIVirtualNetworkGatewayConnectionType OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::getConnectionType() const {
    return m_connection_type;
}
void OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::setConnectionType(const OAIVirtualNetworkGatewayConnectionType &connection_type) {
...
QList<OAITrafficSelectorPolicy> OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::getTrafficSelectorPolicies() const {
    return m_traffic_selector_policies;
}
void OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::setTrafficSelectorPolicies(const QList<OAITrafficSelectorPolicy> &traffic_selector_policies) {
    m_traffic_selector_policies = traffic_selector_policies;
    m_traffic_selector_policies_isSet = true;
}

bool OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::is_traffic_selector_policies_Set() const{
    return m_traffic_selector_policies_isSet;
}

bool OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat::is_traffic_selector_policies_Valid() const{
    return m_traffic_selector_policies_isValid;
}
