...
async def virtual_network_gateways_start_packet_capture(request: web.Request, resource_group_name, virtual_network_gateway_name, api_version, subscription_id, parameters=None) -> web.Response:
...
async def virtual_network_gateways_stop_packet_capture(request: web.Request, resource_group_name, virtual_network_gateway_name, api_version, subscription_id, parameters) -> web.Response:
