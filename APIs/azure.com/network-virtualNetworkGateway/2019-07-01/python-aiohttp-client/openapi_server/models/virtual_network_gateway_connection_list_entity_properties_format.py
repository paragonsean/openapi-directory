...
class VirtualNetworkGatewayConnectionListEntityPropertiesFormat(Model):
    ...
    def __init__(self, authorization_key: str=None, connection_protocol: ConnectionProtocol=None, connection_status: VirtualNetworkGatewayConnectionStatus=None, connection_type: VirtualNetworkGatewayConnectionType=None, egress_bytes_transferred: int=None, enable_bgp: bool=None, express_route_gateway_bypass: bool=None, ingress_bytes_transferred: int=None, ipsec_policies: List[IpsecPolicy]=None, local_network_gateway2: VirtualNetworkConnectionGatewayReference=None, peer: VirtualNetworkGatewayConnectionListEntityPropertiesFormatPeer=None, provisioning_state: str=None, resource_guid: str=None, routing_weight: int=None, shared_key: str=None, traffic_selector_policies: List[TrafficSelectorPolicy]=None, tunnel_connection_status: List[TunnelConnectionHealth]=None, use_policy_based_traffic_selectors: bool=None, virtual_network_gateway1: VirtualNetworkConnectionGatewayReference=None, virtual_network_gateway2: VirtualNetworkConnectionGatewayReference=None):
        ...
        :param traffic_selector_policies: The traffic_selector_policies of this VirtualNetworkGatewayConnectionListEntityPropertiesFormat.
    ...
    def traffic_selector_policies(self):
        """Gets the traffic_selector_policies of this VirtualNetworkGatewayConnectionListEntityPropertiesFormat.

        The Traffic Selector Policies to be considered by this connection.

        :return: The traffic_selector_policies of this VirtualNetworkGatewayConnectionListEntityPropertiesFormat.
    ...
    def traffic_selector_policies(self, traffic_selector_policies):
        """Sets the traffic_selector_policies of this VirtualNetworkGatewayConnectionListEntityPropertiesFormat.
