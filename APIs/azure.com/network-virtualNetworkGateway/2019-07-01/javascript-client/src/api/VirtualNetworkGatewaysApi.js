...
import VirtualNetworkGatewayConnectionsStartPacketCaptureDefaultResponse from '../model/VirtualNetworkGatewayConnectionsStartPacketCaptureDefaultResponse';
...
import VpnClientConnectionHealthDetailListResult from '../model/VpnClientConnectionHealthDetailListResult';
...
import VpnPacketCaptureStartParameters from '../model/VpnPacketCaptureStartParameters';
import VpnPacketCaptureStopParameters from '../model/VpnPacketCaptureStopParameters';
...
export default class VirtualNetworkGatewaysApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the virtualNetworkGatewaysGetVpnclientConnectionHealth operation.
     * @callback module:api/VirtualNetworkGatewaysApi~virtualNetworkGatewaysGetVpnclientConnectionHealthCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VpnClientConnectionHealthDetailListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client API version.
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/VirtualNetworkGatewaysApi~virtualNetworkGatewaysGetVpnclientConnectionHealthCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VpnClientConnectionHealthDetailListResult}
     */
    virtualNetworkGatewaysGetVpnclientConnectionHealth(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth");
      }
      // verify the required parameter 'virtualNetworkGatewayName' is set
      if (virtualNetworkGatewayName === undefined || virtualNetworkGatewayName === null) {
        throw new Error("Missing the required parameter 'virtualNetworkGatewayName' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling virtualNetworkGatewaysGetVpnclientConnectionHealth");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = VpnClientConnectionHealthDetailListResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/getVpnClientConnectionHealth', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the virtualNetworkGatewaysStartPacketCapture operation.
     * @callback module:api/VirtualNetworkGatewaysApi~virtualNetworkGatewaysStartPacketCaptureCallback
     * @param {String} error Error message, if any.
     * @param {String} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {Object} opts Optional parameters
     * @param {module:model/VpnPacketCaptureStartParameters} [parameters] Virtual network gateway packet capture parameters supplied to start packet capture on gateway.
     * @param {module:api/VirtualNetworkGatewaysApi~virtualNetworkGatewaysStartPacketCaptureCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    virtualNetworkGatewaysStartPacketCapture(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, opts, callback) {
      opts = opts || {};
      let postBody = opts['parameters'];
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling virtualNetworkGatewaysStartPacketCapture");
      }
      // verify the required parameter 'virtualNetworkGatewayName' is set
      if (virtualNetworkGatewayName === undefined || virtualNetworkGatewayName === null) {
        throw new Error("Missing the required parameter 'virtualNetworkGatewayName' when calling virtualNetworkGatewaysStartPacketCapture");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling virtualNetworkGatewaysStartPacketCapture");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling virtualNetworkGatewaysStartPacketCapture");
      }
      ...
      let returnType = 'String';
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/startPacketCapture', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the virtualNetworkGatewaysStopPacketCapture operation.
     * @callback module:api/VirtualNetworkGatewaysApi~virtualNetworkGatewaysStopPacketCaptureCallback
     * @param {String} error Error message, if any.
     * @param {String} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client API version.
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/VpnPacketCaptureStopParameters} parameters Virtual network gateway packet capture parameters supplied to stop packet capture on gateway.
     * @param {module:api/VirtualNetworkGatewaysApi~virtualNetworkGatewaysStopPacketCaptureCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    virtualNetworkGatewaysStopPacketCapture(resourceGroupName, virtualNetworkGatewayName, apiVersion, subscriptionId, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling virtualNetworkGatewaysStopPacketCapture");
      }
      // verify the required parameter 'virtualNetworkGatewayName' is set
      if (virtualNetworkGatewayName === undefined || virtualNetworkGatewayName === null) {
        throw new Error("Missing the required parameter 'virtualNetworkGatewayName' when calling virtualNetworkGatewaysStopPacketCapture");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling virtualNetworkGatewaysStopPacketCapture");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling virtualNetworkGatewaysStopPacketCapture");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling virtualNetworkGatewaysStopPacketCapture");
      }
      ...
      let returnType = 'String';
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{virtualNetworkGatewayName}/stopPacketCapture', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
