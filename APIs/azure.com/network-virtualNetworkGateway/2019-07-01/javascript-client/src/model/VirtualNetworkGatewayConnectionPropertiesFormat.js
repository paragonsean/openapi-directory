...
class VirtualNetworkGatewayConnectionPropertiesFormat {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('trafficSelectorPolicies')) {
                obj['trafficSelectorPolicies'] = ApiClient.convertToType(data['trafficSelectorPolicies'], [TrafficSelectorPolicy]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['trafficSelectorPolicies']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['trafficSelectorPolicies'])) {
                throw new Error("Expected the field `trafficSelectorPolicies` to be an array in the JSON data but got " + data['trafficSelectorPolicies']);
            }
            // validate the optional field `trafficSelectorPolicies` (array)
            for (const item of data['trafficSelectorPolicies']) {
                TrafficSelectorPolicy.validateJSON(item);
            };
        }
 ...
 * @member {module:model/VirtualNetworkGatewayConnectionPropertiesFormat.ProvisioningStateEnum} provisioningState
 */
 ...
 * @member {Array.<module:model/TrafficSelectorPolicy>} trafficSelectorPolicies
 */
VirtualNetworkGatewayConnectionPropertiesFormat.prototype['trafficSelectorPolicies'] = undefined;
 ...
 * @readonly
 */
VirtualNetworkGatewayConnectionPropertiesFormat['ProvisioningStateEnum'] = {
