...
(function(root, factory) {
  ...
  describe('VirtualNetworkGatewayConnectionsApi', function() {
    ...
    describe('virtualNetworkGatewayConnectionsStartPacketCapture', function() {
      it('should call virtualNetworkGatewayConnectionsStartPacketCapture successfully', function(done) {
        //uncomment below and update the code to test virtualNetworkGatewayConnectionsStartPacketCapture
        //instance.virtualNetworkGatewayConnectionsStartPacketCapture(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('virtualNetworkGatewayConnectionsStopPacketCapture', function() {
      it('should call virtualNetworkGatewayConnectionsStopPacketCapture successfully', function(done) {
        //uncomment below and update the code to test virtualNetworkGatewayConnectionsStopPacketCapture
        //instance.virtualNetworkGatewayConnectionsStopPacketCapture(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
