...
(function(root, factory) {
  ...
  describe('VirtualNetworkGatewaysApi', function() {
    ...
    describe('virtualNetworkGatewaysGetVpnclientConnectionHealth', function() {
      it('should call virtualNetworkGatewaysGetVpnclientConnectionHealth successfully', function(done) {
        //uncomment below and update the code to test virtualNetworkGatewaysGetVpnclientConnectionHealth
        //instance.virtualNetworkGatewaysGetVpnclientConnectionHealth(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('virtualNetworkGatewaysStartPacketCapture', function() {
      it('should call virtualNetworkGatewaysStartPacketCapture successfully', function(done) {
        //uncomment below and update the code to test virtualNetworkGatewaysStartPacketCapture
        //instance.virtualNetworkGatewaysStartPacketCapture(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('virtualNetworkGatewaysStopPacketCapture', function() {
      it('should call virtualNetworkGatewaysStopPacketCapture successfully', function(done) {
        //uncomment below and update the code to test virtualNetworkGatewaysStopPacketCapture
        //instance.virtualNetworkGatewaysStopPacketCapture(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
