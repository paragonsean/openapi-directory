...
(function(root, factory) {
  ...
  describe('VirtualNetworkGatewayPropertiesFormat', function() {
    ...
    it('should have the property activeActive (base name: "activeActive")', function() {
      // uncomment below and update the code to test the property activeActive
      //var instance = new NetworkManagementClient.VirtualNetworkGatewayPropertiesFormat();
    ...
    it('should have the property vpnGatewayGeneration (base name: "vpnGatewayGeneration")', function() {
      // uncomment below and update the code to test the property vpnGatewayGeneration
      //var instance = new NetworkManagementClient.VirtualNetworkGatewayPropertiesFormat();
      //expect(instance).to.be();
    });
