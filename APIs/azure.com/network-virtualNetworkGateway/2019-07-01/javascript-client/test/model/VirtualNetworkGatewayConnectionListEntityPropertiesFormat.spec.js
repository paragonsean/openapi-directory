...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.VirtualNetworkGatewayConnectionListEntityPropertiesFormat();
  });
  ...
  describe('VirtualNetworkGatewayConnectionListEntityPropertiesFormat', function() {
    it('should create an instance of VirtualNetworkGatewayConnectionListEntityPropertiesFormat', function() {
      // uncomment below and update the code to test VirtualNetworkGatewayConnectionListEntityPropertiesFormat
      //var instance = new NetworkManagementClient.VirtualNetworkGatewayConnectionListEntityPropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.VirtualNetworkGatewayConnectionListEntityPropertiesFormat);
    });
    ...
    it('should have the property trafficSelectorPolicies (base name: "trafficSelectorPolicies")', function() {
      // uncomment below and update the code to test the property trafficSelectorPolicies
      //var instance = new NetworkManagementClient.VirtualNetworkGatewayConnectionListEntityPropertiesFormat();
      //expect(instance).to.be();
    });
