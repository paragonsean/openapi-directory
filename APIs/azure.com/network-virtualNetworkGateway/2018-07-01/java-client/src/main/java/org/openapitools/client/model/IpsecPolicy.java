...
public class IpsecPolicy {
  ...
  public IpsecPolicy dhGroup(DhGroupEnum dhGroup) {
  ...
  public IpsecPolicy ikeEncryption(IkeEncryptionEnum ikeEncryption) {
  ...
  public IpsecPolicy ikeIntegrity(IkeIntegrityEnum ikeIntegrity) {
  ...
  public IpsecPolicy ipsecEncryption(IpsecEncryptionEnum ipsecEncryption) {
  ...
  public IpsecPolicy ipsecIntegrity(IpsecIntegrityEnum ipsecIntegrity) {
  ...
  public IpsecPolicy pfsGroup(PfsGroupEnum pfsGroup) {
