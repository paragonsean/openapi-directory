...
public:
    ...
    OAIVirtualNetworkGatewayConnectionPropertiesFormat_peer getPeer() const;
    void setPeer(const OAIVirtualNetworkGatewayConnectionPropertiesFormat_peer &peer);
...
private:
    ...
    OAIVirtualNetworkGatewayConnectionPropertiesFormat_peer m_peer;
    bool m_peer_isSet;
    bool m_peer_isValid;
