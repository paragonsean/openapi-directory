...
public:
    ...
    * @param[in]  parameters OAIVirtualNetworkGateway [required]
    */
    virtual void virtualNetworkGatewaysReset(const QString &resource_group_name, const QString &virtual_network_gateway_name, const QString &api_version, const QString &subscription_id, const OAIVirtualNetworkGateway &parameters);
