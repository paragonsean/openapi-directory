...
Q_SIGNALS:
    ...
    void virtualNetworkGatewayConnectionsGetSharedKeySignal(OAIConnectionSharedKeyResult summary);
    ...
    void virtualNetworkGatewayConnectionsGetSharedKeySignalFull(OAIHttpRequestWorker *worker, OAIConnectionSharedKeyResult summary);
    ...
    void virtualNetworkGatewayConnectionsGetSharedKeySignalE(OAIConnectionSharedKeyResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void virtualNetworkGatewayConnectionsGetSharedKeySignalError(OAIConnectionSharedKeyResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
