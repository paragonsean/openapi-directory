...
QString OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::getPrivateIpAddress() const {
    return m_private_ip_address;
}
void OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::setPrivateIpAddress(const QString &private_ip_address) {
    m_private_ip_address = private_ip_address;
    m_private_ip_address_isSet = true;
}

bool OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::is_private_ip_address_Set() const{
    return m_private_ip_address_isSet;
}

bool OAIVirtualNetworkGatewayIPConfigurationPropertiesFormat::is_private_ip_address_Valid() const{
