...
OAIVirtualNetworkGatewayConnectionPropertiesFormat_peer OAIVirtualNetworkGatewayPropertiesFormat::getGatewayDefaultSite() const {
    return m_gateway_default_site;
}
void OAIVirtualNetworkGatewayPropertiesFormat::setGatewayDefaultSite(const OAIVirtualNetworkGatewayConnectionPropertiesFormat_peer &gateway_default_site) {
