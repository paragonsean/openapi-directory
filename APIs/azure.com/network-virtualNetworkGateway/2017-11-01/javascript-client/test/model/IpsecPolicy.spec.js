...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.IpsecPolicy();
  });
  ...
  describe('IpsecPolicy', function() {
    it('should create an instance of IpsecPolicy', function() {
      // uncomment below and update the code to test IpsecPolicy
      //var instance = new NetworkManagementClient.IpsecPolicy();
      //expect(instance).to.be.a(NetworkManagementClient.IpsecPolicy);
    });
