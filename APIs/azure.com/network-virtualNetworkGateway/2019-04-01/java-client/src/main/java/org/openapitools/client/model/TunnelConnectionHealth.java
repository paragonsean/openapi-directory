...
public class TunnelConnectionHealth {
  ...
  public TunnelConnectionHealth connectionStatus(VirtualNetworkGatewayConnectionStatus connectionStatus) {
  ...
  public void setConnectionStatus(VirtualNetworkGatewayConnectionStatus connectionStatus) {
    this.connectionStatus = connectionStatus;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("connectionStatus") != null && !jsonObj.get("connectionStatus").isJsonNull()) {
        VirtualNetworkGatewayConnectionStatus.validateJsonElement(jsonObj.get("connectionStatus"));
      }
