...
public class VpnClientIPsecParameters {
  ...
  public VpnClientIPsecParameters dhGroup(DhGroup dhGroup) {
  ...
  public VpnClientIPsecParameters ikeEncryption(IkeEncryption ikeEncryption) {
  ...
  public VpnClientIPsecParameters ikeIntegrity(IkeIntegrity ikeIntegrity) {
  ...
  public VpnClientIPsecParameters ipsecEncryption(IpsecEncryption ipsecEncryption) {
  ...
  public VpnClientIPsecParameters ipsecIntegrity(IpsecIntegrity ipsecIntegrity) {
  ...
  public VpnClientIPsecParameters pfsGroup(PfsGroup pfsGroup) {
