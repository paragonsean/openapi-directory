...
class TunnelConnectionHealth(Model):
    ...
    def __init__(self, connection_status: VirtualNetworkGatewayConnectionStatus=None, egress_bytes_transferred: int=None, ingress_bytes_transferred: int=None, last_connection_established_utc_time: str=None, tunnel: str=None):
