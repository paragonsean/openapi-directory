...
OAIConnectionProtocol OAIVirtualNetworkGatewayConnectionPropertiesFormat::getConnectionProtocol() const {
    return m_connection_protocol;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setConnectionProtocol(const OAIConnectionProtocol &connection_protocol) {
    m_connection_protocol = connection_protocol;
    m_connection_protocol_isSet = true;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_connection_protocol_Set() const{
    return m_connection_protocol_isSet;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_connection_protocol_Valid() const{
    return m_connection_protocol_isValid;
}

OAIVirtualNetworkGatewayConnectionStatus OAIVirtualNetworkGatewayConnectionPropertiesFormat::getConnectionStatus() const {
    return m_connection_status;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setConnectionStatus(const OAIVirtualNetworkGatewayConnectionStatus &connection_status) {
...
OAIVirtualNetworkGatewayConnectionType OAIVirtualNetworkGatewayConnectionPropertiesFormat::getConnectionType() const {
    return m_connection_type;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setConnectionType(const OAIVirtualNetworkGatewayConnectionType &connection_type) {
...
bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::isExpressRouteGatewayBypass() const {
    return m_express_route_gateway_bypass;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setExpressRouteGatewayBypass(const bool &express_route_gateway_bypass) {
    m_express_route_gateway_bypass = express_route_gateway_bypass;
    m_express_route_gateway_bypass_isSet = true;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_express_route_gateway_bypass_Set() const{
    return m_express_route_gateway_bypass_isSet;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_express_route_gateway_bypass_Valid() const{
...
QList<OAIIpsecPolicy> OAIVirtualNetworkGatewayConnectionPropertiesFormat::getIpsecPolicies() const {
    return m_ipsec_policies;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setIpsecPolicies(const QList<OAIIpsecPolicy> &ipsec_policies) {
    m_ipsec_policies = ipsec_policies;
    m_ipsec_policies_isSet = true;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_ipsec_policies_Set() const{
    return m_ipsec_policies_isSet;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_ipsec_policies_Valid() const{
...
OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat_peer OAIVirtualNetworkGatewayConnectionPropertiesFormat::getPeer() const {
    return m_peer;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setPeer(const OAIVirtualNetworkGatewayConnectionListEntityPropertiesFormat_peer &peer) {
    m_peer = peer;
    m_peer_isSet = true;
}
...
QList<OAITunnelConnectionHealth> OAIVirtualNetworkGatewayConnectionPropertiesFormat::getTunnelConnectionStatus() const {
    return m_tunnel_connection_status;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setTunnelConnectionStatus(const QList<OAITunnelConnectionHealth> &tunnel_connection_status) {
    m_tunnel_connection_status = tunnel_connection_status;
    m_tunnel_connection_status_isSet = true;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_tunnel_connection_status_Set() const{
    return m_tunnel_connection_status_isSet;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_tunnel_connection_status_Valid() const{
    return m_tunnel_connection_status_isValid;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::isUsePolicyBasedTrafficSelectors() const {
    return m_use_policy_based_traffic_selectors;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setUsePolicyBasedTrafficSelectors(const bool &use_policy_based_traffic_selectors) {
    m_use_policy_based_traffic_selectors = use_policy_based_traffic_selectors;
    m_use_policy_based_traffic_selectors_isSet = true;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_use_policy_based_traffic_selectors_Set() const{
    return m_use_policy_based_traffic_selectors_isSet;
}

bool OAIVirtualNetworkGatewayConnectionPropertiesFormat::is_use_policy_based_traffic_selectors_Valid() const{
