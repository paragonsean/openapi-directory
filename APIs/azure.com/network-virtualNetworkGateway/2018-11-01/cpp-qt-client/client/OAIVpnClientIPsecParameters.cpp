...
QString OAIVpnClientIPsecParameters::getDhGroup() const {
    return m_dh_group;
}
void OAIVpnClientIPsecParameters::setDhGroup(const QString &dh_group) {
    m_dh_group = dh_group;
...
QString OAIVpnClientIPsecParameters::getIkeEncryption() const {
    return m_ike_encryption;
}
void OAIVpnClientIPsecParameters::setIkeEncryption(const QString &ike_encryption) {
...
QString OAIVpnClientIPsecParameters::getIkeIntegrity() const {
    return m_ike_integrity;
}
void OAIVpnClientIPsecParameters::setIkeIntegrity(const QString &ike_integrity) {
...
QString OAIVpnClientIPsecParameters::getIpsecEncryption() const {
    return m_ipsec_encryption;
}
void OAIVpnClientIPsecParameters::setIpsecEncryption(const QString &ipsec_encryption) {
...
QString OAIVpnClientIPsecParameters::getIpsecIntegrity() const {
    return m_ipsec_integrity;
}
void OAIVpnClientIPsecParameters::setIpsecIntegrity(const QString &ipsec_integrity) {
...
QString OAIVpnClientIPsecParameters::getPfsGroup() const {
    return m_pfs_group;
}
void OAIVpnClientIPsecParameters::setPfsGroup(const QString &pfs_group) {
