...
class VirtualNetworkGatewayConnectionPropertiesFormat {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('peer')) {
                obj['peer'] = VirtualNetworkGatewayConnectionPropertiesFormatPeer.constructFromObject(data['peer']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['peer']) { // data not null
          VirtualNetworkGatewayConnectionPropertiesFormatPeer.validateJSON(data['peer']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/VirtualNetworkGatewayConnectionPropertiesFormatPeer} peer
 */
