...
public class VirtualNetworkGatewayConnectionPropertiesFormat {
  ...
  private VirtualNetworkGatewayConnectionPropertiesFormatPeer peer;
  ...
  public VirtualNetworkGatewayConnectionPropertiesFormat peer(VirtualNetworkGatewayConnectionPropertiesFormatPeer peer) {
    this.peer = peer;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public VirtualNetworkGatewayConnectionPropertiesFormatPeer getPeer() {
    return peer;
  }

  public void setPeer(VirtualNetworkGatewayConnectionPropertiesFormatPeer peer) {
    this.peer = peer;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("peer") != null && !jsonObj.get("peer").isJsonNull()) {
        VirtualNetworkGatewayConnectionPropertiesFormatPeer.validateJsonElement(jsonObj.get("peer"));
      }
