...
public class VpnClientParameters {
  ...
  static {
    ...
    openapiRequiredFields.add("processorArchitecture");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : VpnClientParameters.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("processorArchitecture").isJsonPrimitive()) {
      ...
      // validate the required field `processorArchitecture`
