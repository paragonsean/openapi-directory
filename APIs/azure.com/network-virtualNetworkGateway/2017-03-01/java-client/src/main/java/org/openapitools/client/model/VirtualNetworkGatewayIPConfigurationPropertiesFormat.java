...
import org.openapitools.client.model.VirtualNetworkGatewayConnectionPropertiesFormatPeer;
...
public class VirtualNetworkGatewayIPConfigurationPropertiesFormat {
  ...
  private VirtualNetworkGatewayConnectionPropertiesFormatPeer publicIPAddress;

  public static final String SERIALIZED_NAME_SUBNET = "subnet";
  @SerializedName(SERIALIZED_NAME_SUBNET)
  private VirtualNetworkGatewayConnectionPropertiesFormatPeer subnet;
  ...
  public VirtualNetworkGatewayIPConfigurationPropertiesFormat publicIPAddress(VirtualNetworkGatewayConnectionPropertiesFormatPeer publicIPAddress) {
   ...
   */
  @javax.annotation.Nullable
  public VirtualNetworkGatewayConnectionPropertiesFormatPeer getPublicIPAddress() {
    return publicIPAddress;
  }

  public void setPublicIPAddress(VirtualNetworkGatewayConnectionPropertiesFormatPeer publicIPAddress) {
    this.publicIPAddress = publicIPAddress;
  }


  public VirtualNetworkGatewayIPConfigurationPropertiesFormat subnet(VirtualNetworkGatewayConnectionPropertiesFormatPeer subnet) {
    this.subnet = subnet;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public VirtualNetworkGatewayConnectionPropertiesFormatPeer getSubnet() {
    return subnet;
  }

  public void setSubnet(VirtualNetworkGatewayConnectionPropertiesFormatPeer subnet) {
    this.subnet = subnet;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("publicIPAddress") != null && !jsonObj.get("publicIPAddress").isJsonNull()) {
        VirtualNetworkGatewayConnectionPropertiesFormatPeer.validateJsonElement(jsonObj.get("publicIPAddress"));
      }
      // validate the optional field `subnet`
      if (jsonObj.get("subnet") != null && !jsonObj.get("subnet").isJsonNull()) {
        VirtualNetworkGatewayConnectionPropertiesFormatPeer.validateJsonElement(jsonObj.get("subnet"));
      }
  }
