...
class VirtualNetworkGatewayConnectionPropertiesFormat(Model):
    ...
    def __init__(self, authorization_key: str=None, connection_status: str=None, connection_type: str=None, egress_bytes_transferred: int=None, enable_bgp: bool=None, ingress_bytes_transferred: int=None, ipsec_policies: List[IpsecPolicy]=None, local_network_gateway2: LocalNetworkGateway=None, peer: VirtualNetworkGatewayConnectionPropertiesFormatPeer=None, provisioning_state: str=None, resource_guid: str=None, routing_weight: int=None, shared_key: str=None, tunnel_connection_status: List[TunnelConnectionHealth]=None, use_policy_based_traffic_selectors: bool=None, virtual_network_gateway1: VirtualNetworkGateway=None, virtual_network_gateway2: VirtualNetworkGateway=None):
        ...
        self.openapi_types = {
            ...
            'peer': VirtualNetworkGatewayConnectionPropertiesFormatPeer,
    ...
    def peer(self):
        ...
        :rtype: VirtualNetworkGatewayConnectionPropertiesFormatPeer
        """
        return self._peer
    ...
    def peer(self, peer):
        ...
        :param peer: The peer of this VirtualNetworkGatewayConnectionPropertiesFormat.
        :type peer: VirtualNetworkGatewayConnectionPropertiesFormatPeer
        """
