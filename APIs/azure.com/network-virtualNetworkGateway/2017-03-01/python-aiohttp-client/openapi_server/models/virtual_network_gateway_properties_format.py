...
class VirtualNetworkGatewayPropertiesFormat(Model):
    ...
    def __init__(self, active_active: bool=None, bgp_settings: BgpSettings=None, enable_bgp: bool=None, gateway_default_site: VirtualNetworkGatewayConnectionPropertiesFormatPeer=None, gateway_type: str=None, ip_configurations: List[VirtualNetworkGatewayIPConfiguration]=None, provisioning_state: str=None, resource_guid: str=None, sku: VirtualNetworkGatewaySku=None, vpn_client_configuration: VpnClientConfiguration=None, vpn_type: str=None):
        ...
        self.openapi_types = {
            ...
            'enable_bgp': bool,
            'gateway_default_site': VirtualNetworkGatewayConnectionPropertiesFormatPeer,
            'gateway_type': str,
    ...
    def gateway_default_site(self, gateway_default_site):
        ...
        :param gateway_default_site: The gateway_default_site of this VirtualNetworkGatewayPropertiesFormat.
        :type gateway_default_site: VirtualNetworkGatewayConnectionPropertiesFormatPeer
        """
