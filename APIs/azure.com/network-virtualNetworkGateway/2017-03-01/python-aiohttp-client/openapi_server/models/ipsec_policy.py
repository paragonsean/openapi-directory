...
class IpsecPolicy(Model):
    ...
    def ike_encryption(self, ike_encryption):
        ...
        """
        allowed_values = ["DES", "DES3", "AES128", "AES192", "AES256"]  # noqa: E501
    ...
    def ike_integrity(self, ike_integrity):
        ...
        """
        allowed_values = ["MD5", "SHA1", "SHA256", "SHA384"]  # noqa: E501
    ...
    def pfs_group(self, pfs_group):
        ...
        :type pfs_group: str
        """
        allowed_values = ["None", "PFS1", "PFS2", "PFS2048", "ECP256", "ECP384", "PFS24"]  # noqa: E501
