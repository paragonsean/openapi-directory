...
OAIVirtualNetworkGatewayConnectionPropertiesFormat_peer OAIVirtualNetworkGatewayConnectionPropertiesFormat::getPeer() const {
    return m_peer;
}
void OAIVirtualNetworkGatewayConnectionPropertiesFormat::setPeer(const OAIVirtualNetworkGatewayConnectionPropertiesFormat_peer &peer) {
    m_peer = peer;
    m_peer_isSet = true;
}
