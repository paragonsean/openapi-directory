...
public class VpnClientConfiguration {
  public static final String SERIALIZED_NAME_AAD_AUDIENCE = "aadAudience";
  @SerializedName(SERIALIZED_NAME_AAD_AUDIENCE)
  private String aadAudience;

  public static final String SERIALIZED_NAME_AAD_ISSUER = "aadIssuer";
  @SerializedName(SERIALIZED_NAME_AAD_ISSUER)
  private String aadIssuer;

  public static final String SERIALIZED_NAME_AAD_TENANT = "aadTenant";
  @SerializedName(SERIALIZED_NAME_AAD_TENANT)
  ...
  public VpnClientConfiguration aadAudience(String aadAudience) {
  ...
  public void setAadAudience(String aadAudience) {
    this.aadAudience = aadAudience;
  }


  public VpnClientConfiguration aadIssuer(String aadIssuer) {
  ...
  public void setAadIssuer(String aadIssuer) {
    this.aadIssuer = aadIssuer;
  }


  public VpnClientConfiguration aadTenant(String aadTenant) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aadAudience, vpnClientConfiguration.aadAudience) &&
        Objects.equals(this.aadIssuer, vpnClientConfiguration.aadIssuer) &&
        Objects.equals(this.aadTenant, vpnClientConfiguration.aadTenant) &&
        Objects.equals(this.radiusServerAddress, vpnClientConfiguration.radiusServerAddress) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aadAudience, aadIssuer, aadTenant, radiusServerAddress, radiusServerSecret, vpnClientAddressPool, vpnClientIpsecPolicies, vpnClientProtocols, vpnClientRevokedCertificates, vpnClientRootCertificates);
  }
  ...
  public String toString() {
    ...
    sb.append("    aadAudience: ").append(toIndentedString(aadAudience)).append("\n");
    sb.append("    aadIssuer: ").append(toIndentedString(aadIssuer)).append("\n");
    sb.append("    aadTenant: ").append(toIndentedString(aadTenant)).append("\n");
  ...
  static {
    ...
    openapiFields.add("aadAudience");
    openapiFields.add("aadIssuer");
    openapiFields.add("aadTenant");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("aadAudience") != null && !jsonObj.get("aadAudience").isJsonNull()) && !jsonObj.get("aadAudience").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `aadAudience` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aadAudience").toString()));
      }
      if ((jsonObj.get("aadIssuer") != null && !jsonObj.get("aadIssuer").isJsonNull()) && !jsonObj.get("aadIssuer").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `aadIssuer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aadIssuer").toString()));
      }
      if ((jsonObj.get("aadTenant") != null && !jsonObj.get("aadTenant").isJsonNull()) && !jsonObj.get("aadTenant").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `aadTenant` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aadTenant").toString()));
      }
