...
async def virtual_network_gateways_get_vpnclient_connection_health(request: web.Request, resource_group_name, virtual_network_gateway_name, api_version, subscription_id) -> web.Response:
