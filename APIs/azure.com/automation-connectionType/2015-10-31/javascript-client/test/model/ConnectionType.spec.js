...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.ConnectionType();
  });
  ...
  describe('ConnectionType', function() {
    it('should create an instance of ConnectionType', function() {
      ...
      //var instance = new AutomationManagement.ConnectionType();
      //expect(instance).to.be.a(AutomationManagement.ConnectionType);
    });
