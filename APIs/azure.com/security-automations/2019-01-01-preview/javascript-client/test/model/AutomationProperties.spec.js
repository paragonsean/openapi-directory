...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SecurityCenter.AutomationProperties();
  });
  ...
  describe('AutomationProperties', function() {
    it('should create an instance of AutomationProperties', function() {
      // uncomment below and update the code to test AutomationProperties
      //var instance = new SecurityCenter.AutomationProperties();
      //expect(instance).to.be.a(SecurityCenter.AutomationProperties);
    });
