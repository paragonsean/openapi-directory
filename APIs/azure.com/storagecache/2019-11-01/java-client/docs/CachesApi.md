...
<a id="cachesCreateOrUpdate"></a>
# **cachesCreateOrUpdate**
> Cache cachesCreateOrUpdate(resourceGroupName, apiVersion, subscriptionId, cacheName, cache)
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    String cacheName = "cacheName_example"; // String | Name of Cache.
    Cache cache = new Cache(); // Cache | Object containing the user-selectable properties of the Cache. If read-only properties are included, they must match the existing values of those properties.
    try {
