...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageCacheMgmtClient.ApiOperationDisplay();
  });
  ...
  describe('ApiOperationDisplay', function() {
    it('should create an instance of ApiOperationDisplay', function() {
      // uncomment below and update the code to test ApiOperationDisplay
      //var instance = new StorageCacheMgmtClient.ApiOperationDisplay();
      //expect(instance).to.be.a(StorageCacheMgmtClient.ApiOperationDisplay);
    });
