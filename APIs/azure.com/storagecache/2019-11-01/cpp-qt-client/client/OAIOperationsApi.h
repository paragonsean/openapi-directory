...
Q_SIGNALS:
    ...
    void operationsListSignal(OAIApiOperationListResult summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIApiOperationListResult summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(OAIApiOperationListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(OAIApiOperationListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
