...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageCacheMgmtClient.CacheHealth();
  });
  ...
  describe('CacheHealth', function() {
    it('should create an instance of CacheHealth', function() {
      // uncomment below and update the code to test CacheHealth
      //var instance = new StorageCacheMgmtClient.CacheHealth();
      //expect(instance).to.be.a(StorageCacheMgmtClient.CacheHealth);
    });
