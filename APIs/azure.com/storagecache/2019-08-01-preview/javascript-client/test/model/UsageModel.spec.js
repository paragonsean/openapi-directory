...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageCacheMgmtClient.UsageModel();
  });
  ...
  describe('UsageModel', function() {
    it('should create an instance of UsageModel', function() {
      // uncomment below and update the code to test UsageModel
      //var instance = new StorageCacheMgmtClient.UsageModel();
      //expect(instance).to.be.a(StorageCacheMgmtClient.UsageModel);
    });
