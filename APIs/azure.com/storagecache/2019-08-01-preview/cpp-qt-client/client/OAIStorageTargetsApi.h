...
public:
    ...
    */
    virtual void storageTargetsCreate(const QString &resource_group_name, const QString &api_version, const QString &subscription_id, const QString &cache_name, const QString &storage_target_name, const ::OpenAPI::OptionalParam<OAIStorageTarget> &storagetarget = ::OpenAPI::OptionalParam<OAIStorageTarget>());
    ...
    * @param[in]  storagetarget OAIStorageTarget [optional]
    */
    virtual void storageTargetsUpdate(const QString &resource_group_name, const QString &api_version, const QString &subscription_id, const QString &cache_name, const QString &storage_target_name, const ::OpenAPI::OptionalParam<OAIStorageTarget> &storagetarget = ::OpenAPI::OptionalParam<OAIStorageTarget>());
...
private:
    ...
    void storageTargetsCreateCallback(OAIHttpRequestWorker *worker);
    ...
    void storageTargetsUpdateCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void storageTargetsCreateSignal(OAIStorageTarget summary);
    ...
    void storageTargetsUpdateSignal(OAIStorageTarget summary);


    void storageTargetsCreateSignalFull(OAIHttpRequestWorker *worker, OAIStorageTarget summary);
    ...
    void storageTargetsUpdateSignalFull(OAIHttpRequestWorker *worker, OAIStorageTarget summary);

    Q_DECL_DEPRECATED_X("Use storageTargetsCreateSignalError() instead")
    void storageTargetsCreateSignalE(OAIStorageTarget summary, QNetworkReply::NetworkError error_type, QString error_str);
    void storageTargetsCreateSignalError(OAIStorageTarget summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use storageTargetsUpdateSignalError() instead")
    void storageTargetsUpdateSignalE(OAIStorageTarget summary, QNetworkReply::NetworkError error_type, QString error_str);
    void storageTargetsUpdateSignalError(OAIStorageTarget summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use storageTargetsCreateSignalErrorFull() instead")
    void storageTargetsCreateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void storageTargetsCreateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use storageTargetsUpdateSignalErrorFull() instead")
    void storageTargetsUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void storageTargetsUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
