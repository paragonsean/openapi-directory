...
public:
    ...
    */
    virtual void cachesCreate(const QString &resource_group_name, const QString &api_version, const QString &subscription_id, const QString &cache_name, const ::OpenAPI::OptionalParam<OAICache> &cache = ::OpenAPI::OptionalParam<OAICache>());
...
private:
    ...
    void cachesCreateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void cachesCreateSignal(OAICache summary);
    ...
    void cachesCreateSignalFull(OAIHttpRequestWorker *worker, OAICache summary);
    ...
    Q_DECL_DEPRECATED_X("Use cachesCreateSignalError() instead")
    void cachesCreateSignalE(OAICache summary, QNetworkReply::NetworkError error_type, QString error_str);
    void cachesCreateSignalError(OAICache summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use cachesCreateSignalErrorFull() instead")
    void cachesCreateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void cachesCreateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
