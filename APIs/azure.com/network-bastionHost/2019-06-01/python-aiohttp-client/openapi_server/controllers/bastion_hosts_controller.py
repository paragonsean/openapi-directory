...
async def bastion_hosts_update_tags(request: web.Request, subscription_id, resource_group_name, bastion_host_name, api_version, bastion_host_parameters) -> web.Response:
    ...
    :type bastion_host_parameters: dict | bytes

    """
    bastion_host_parameters = BastionHostsUpdateTagsRequest.from_dict(bastion_host_parameters)
    return web.Response(status=200)
