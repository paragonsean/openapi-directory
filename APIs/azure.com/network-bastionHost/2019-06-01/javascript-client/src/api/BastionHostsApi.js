...
export default class BastionHostsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the bastionHostsUpdateTags operation.
     * @callback module:api/BastionHostsApi~bastionHostsUpdateTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BastionHost} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {String} resourceGroupName The resource group name of the BastionHost.
     * @param {String} bastionHostName The name of the bastionHost.
     * @param {String} apiVersion Client API version.
     * @param {module:model/BastionHostsUpdateTagsRequest} bastionHostParameters Parameters supplied to update a bastion host tags.
     * @param {module:api/BastionHostsApi~bastionHostsUpdateTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BastionHost}
     */
    bastionHostsUpdateTags(subscriptionId, resourceGroupName, bastionHostName, apiVersion, bastionHostParameters, callback) {
      let postBody = bastionHostParameters;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling bastionHostsUpdateTags");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling bastionHostsUpdateTags");
      }
      // verify the required parameter 'bastionHostName' is set
      if (bastionHostName === undefined || bastionHostName === null) {
        throw new Error("Missing the required parameter 'bastionHostName' when calling bastionHostsUpdateTags");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling bastionHostsUpdateTags");
      }
      // verify the required parameter 'bastionHostParameters' is set
      if (bastionHostParameters === undefined || bastionHostParameters === null) {
        throw new Error("Missing the required parameter 'bastionHostParameters' when calling bastionHostsUpdateTags");
      }
      ...
      let returnType = BastionHost;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
