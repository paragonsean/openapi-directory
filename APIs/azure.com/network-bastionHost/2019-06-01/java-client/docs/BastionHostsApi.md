...
public class Example {
  public static void main(String[] args) {
    ...
    BastionHostsApi apiInstance = new BastionHostsApi(defaultClient);
    String subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    String resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the BastionHost.
    String bastionHostName = "bastionHostName_example"; // String | The name of the bastionHost.
    String apiVersion = "apiVersion_example"; // String | Client API version.
    BastionHostsUpdateTagsRequest bastionHostParameters = new BastionHostsUpdateTagsRequest(); // BastionHostsUpdateTagsRequest | Parameters supplied to update a bastion host tags.
    try {
      BastionHost result = apiInstance.bastionHostsUpdateTags(subscriptionId, resourceGroupName, bastionHostName, apiVersion, bastionHostParameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BastionHostsApi#bastionHostsUpdateTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Request successful. Returns the details of the updated bastion host. |  -  |
| **201** | Request received successfully. Returns the details of the updated bastion host. |  -  |
| **0** | Error. |  -  |
