...
public class BastionHostsApi {
    ...
    /**
     * Build call for bastionHostsUpdateTags
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The resource group name of the BastionHost. (required)
     * @param bastionHostName The name of the bastionHost. (required)
     * @param apiVersion Client API version. (required)
     * @param bastionHostParameters Parameters supplied to update a bastion host tags. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Request successful. Returns the details of the updated bastion host. </td><td>  -  </td></tr>
        <tr><td> 201 </td><td> Request received successfully. Returns the details of the updated bastion host. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call bastionHostsUpdateTagsCall(String subscriptionId, String resourceGroupName, String bastionHostName, String apiVersion, BastionHostsUpdateTagsRequest bastionHostParameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bastionHostParameters;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bastionHostsUpdateTagsValidateBeforeCall(String subscriptionId, String resourceGroupName, String bastionHostName, String apiVersion, BastionHostsUpdateTagsRequest bastionHostParameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling bastionHostsUpdateTags(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling bastionHostsUpdateTags(Async)");
        }

        // verify the required parameter 'bastionHostName' is set
        if (bastionHostName == null) {
            throw new ApiException("Missing the required parameter 'bastionHostName' when calling bastionHostsUpdateTags(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling bastionHostsUpdateTags(Async)");
        }

        // verify the required parameter 'bastionHostParameters' is set
        if (bastionHostParameters == null) {
            throw new ApiException("Missing the required parameter 'bastionHostParameters' when calling bastionHostsUpdateTags(Async)");
        }

        return bastionHostsUpdateTagsCall(subscriptionId, resourceGroupName, bastionHostName, apiVersion, bastionHostParameters, _callback);
     ...
     */
    public BastionHost bastionHostsUpdateTags(String subscriptionId, String resourceGroupName, String bastionHostName, String apiVersion, BastionHostsUpdateTagsRequest bastionHostParameters) throws ApiException {
        ApiResponse<BastionHost> localVarResp = bastionHostsUpdateTagsWithHttpInfo(subscriptionId, resourceGroupName, bastionHostName, apiVersion, bastionHostParameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BastionHost> bastionHostsUpdateTagsWithHttpInfo(String subscriptionId, String resourceGroupName, String bastionHostName, String apiVersion, BastionHostsUpdateTagsRequest bastionHostParameters) throws ApiException {
        okhttp3.Call localVarCall = bastionHostsUpdateTagsValidateBeforeCall(subscriptionId, resourceGroupName, bastionHostName, apiVersion, bastionHostParameters, null);
        Type localVarReturnType = new TypeToken<BastionHost>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call bastionHostsUpdateTagsAsync(String subscriptionId, String resourceGroupName, String bastionHostName, String apiVersion, BastionHostsUpdateTagsRequest bastionHostParameters, final ApiCallback<BastionHost> _callback) throws ApiException {

        okhttp3.Call localVarCall = bastionHostsUpdateTagsValidateBeforeCall(subscriptionId, resourceGroupName, bastionHostName, apiVersion, bastionHostParameters, _callback);
        Type localVarReturnType = new TypeToken<BastionHost>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
