...
#include "OAIBastionHosts_UpdateTags_default_response.h"
...
public:
    ...
    * @param[in]  bastion_host_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  bastion_host_parameters OAIBastionHosts_UpdateTags_request [required]
    */
    virtual void bastionHostsUpdateTags(const QString &subscription_id, const QString &resource_group_name, const QString &bastion_host_name, const QString &api_version, const OAIBastionHosts_UpdateTags_request &bastion_host_parameters);
...
private:
    ...
    void bastionHostsUpdateTagsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void bastionHostsUpdateTagsSignal(OAIBastionHost summary);
    ...
    void bastionHostsUpdateTagsSignalFull(OAIHttpRequestWorker *worker, OAIBastionHost summary);
    ...
    Q_DECL_DEPRECATED_X("Use bastionHostsUpdateTagsSignalError() instead")
    void bastionHostsUpdateTagsSignalE(OAIBastionHost summary, QNetworkReply::NetworkError error_type, QString error_str);
    void bastionHostsUpdateTagsSignalError(OAIBastionHost summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use bastionHostsUpdateTagsSignalErrorFull() instead")
    void bastionHostsUpdateTagsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void bastionHostsUpdateTagsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
