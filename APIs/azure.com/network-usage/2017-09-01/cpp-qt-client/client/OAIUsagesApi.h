...
Q_SIGNALS:
    ...
    void usagesListSignal(OAIUsagesListResult summary);


    void usagesListSignalFull(OAIHttpRequestWorker *worker, OAIUsagesListResult summary);

    Q_DECL_DEPRECATED_X("Use usagesListSignalError() instead")
    void usagesListSignalE(OAIUsagesListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void usagesListSignalError(OAIUsagesListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
