...
class Usage {
     ...
     * @param currentValue {Number} The current value of the usage.
     * @param limit {Number} The limit of usage.
     * @param name {module:model/UsageName} 
     * @param unit {module:model/Usage.UnitEnum} An enum describing the unit of measurement.
     */
