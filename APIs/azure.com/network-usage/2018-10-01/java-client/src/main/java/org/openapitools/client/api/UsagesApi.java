...
public class UsagesApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Request successful. The operation returns a list of Usage resources. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call usagesListCall(String location, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/usages"
     ...
     */
    public UsagesListResult usagesList(String location, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<UsagesListResult> localVarResp = usagesListWithHttpInfo(location, apiVersion, subscriptionId);
     ...
     */
    public ApiResponse<UsagesListResult> usagesListWithHttpInfo(String location, String apiVersion, String subscriptionId) throws ApiException {
     ...
     */
    public okhttp3.Call usagesListAsync(String location, String apiVersion, String subscriptionId, final ApiCallback<UsagesListResult> _callback) throws ApiException {
