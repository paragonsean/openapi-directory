...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmosDb.PrivateEndpointConnectionProperties();
  });
  ...
  describe('PrivateEndpointConnectionProperties', function() {
    it('should create an instance of PrivateEndpointConnectionProperties', function() {
      ...
      //var instance = new CosmosDb.PrivateEndpointConnectionProperties();
      //expect(instance).to.be.a(CosmosDb.PrivateEndpointConnectionProperties);
    });
