...
- API version: 2018-06-17-preview
  - Build date: 2024-10-12T10:34:03.982268-04:00[America/New_York]
...
<dependency>
  ...
  <version>2018-06-17-preview</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2018-06-17-preview"
  }
```
...
* `target/openapi-java-client-2018-06-17-preview.jar`
* `target/lib/*.jar`
