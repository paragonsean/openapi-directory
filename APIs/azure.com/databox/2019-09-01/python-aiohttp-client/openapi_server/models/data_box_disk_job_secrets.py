...
class DataBoxDiskJobSecrets(Model):
    ...
    def __init__(self, disk_secrets: List[DiskSecret]=None, is_passkey_user_defined: bool=None, pass_key: str=None, dc_access_security_code: DcAccessSecurityCode=None, job_secrets_type: str=None):
        ...
        :param dc_access_security_code: The dc_access_security_code of this DataBoxDiskJobSecrets.
    ...
    def dc_access_security_code(self):
        """Gets the dc_access_security_code of this DataBoxDiskJobSecrets.


        :return: The dc_access_security_code of this DataBoxDiskJobSecrets.
    ...
    def dc_access_security_code(self, dc_access_security_code):
        """Sets the dc_access_security_code of this DataBoxDiskJobSecrets.
