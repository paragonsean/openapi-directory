...
async def test_jobs_create(client):
    ...
    """
    job_resource = {"name":"name","id":"id","type":"type","properties":{"isDeletable":True,"deliveryInfo":{"scheduledDateTime":"2000-01-23T04:56:07.000+00:00"},"cancellationReason":"cancellationReason","isCancellable":True,"deliveryType":"NonScheduled","details":{"preferences":{"transportPreferences":{"preferredShipmentType":"CustomerManaged"},"preferredDataCenterRegion":["preferredDataCenterRegion","preferredDataCenterRegion"]},"destinationAccountDetails":[{"accountId":"accountId","dataDestinationType":"StorageAccount","sharePassword":"sharePassword"},{"accountId":"accountId","dataDestinationType":"StorageAccount","sharePassword":"sharePassword"}],"contactDetails":{"emailList":["emailList","emailList"],"phone":"phone","contactName":"contactName","phoneExtension":"phoneExtension","mobile":"mobile","notificationPreference":[{"stageName":"DevicePrepared","sendNotification":True},{"stageName":"DevicePrepared","sendNotification":True}]},"returnPackage":{"carrierName":"carrierName","trackingUrl":"trackingUrl","trackingId":"trackingId"},"chainOfCustodySasKey":"chainOfCustodySasKey","deliveryPackage":{"carrierName":"carrierName","trackingUrl":"trackingUrl","trackingId":"trackingId"},"jobDetailsType":"DataBox","reverseShipmentLabelSasKey":"reverseShipmentLabelSasKey","expectedDataSizeInTerabytes":6,"shippingAddress":{"country":"country","stateOrProvince":"stateOrProvince","city":"city","zipExtendedCode":"zipExtendedCode","addressType":"None","companyName":"companyName","postalCode":"postalCode","streetAddress1":"streetAddress1","streetAddress2":"streetAddress2","streetAddress3":"streetAddress3"},"copyLogDetails":[{"copyLogDetailsType":"DataBox"},{"copyLogDetailsType":"DataBox"}],"errorDetails":[{"recommendedAction":"recommendedAction","errorMessage":"errorMessage","errorCode":0,"exceptionMessage":"exceptionMessage"},{"recommendedAction":"recommendedAction","errorMessage":"errorMessage","errorCode":0,"exceptionMessage":"exceptionMessage"}],"jobStages":[{"stageStatus":"None","stageName":"DeviceOrdered","displayName":"displayName","stageTime":"2000-01-23T04:56:07.000+00:00","jobStageDetails":"{}","errorDetails":[{"recommendedAction":"recommendedAction","errorMessage":"errorMessage","errorCode":0,"exceptionMessage":"exceptionMessage"},{"recommendedAction":"recommendedAction","errorMessage":"errorMessage","errorCode":0,"exceptionMessage":"exceptionMessage"}]},{"stageStatus":"None","stageName":"DeviceOrdered","displayName":"displayName","stageTime":"2000-01-23T04:56:07.000+00:00","jobStageDetails":"{}","errorDetails":[{"recommendedAction":"recommendedAction","errorMessage":"errorMessage","errorCode":0,"exceptionMessage":"exceptionMessage"},{"recommendedAction":"recommendedAction","errorMessage":"errorMessage","errorCode":0,"exceptionMessage":"exceptionMessage"}]}]},"isCancellableWithoutFee":True,"isShippingAddressEditable":True,"startTime":"2000-01-23T04:56:07.000+00:00","error":{"code":"code","message":"message"},"status":"DeviceOrdered"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_jobs_update(client):
    ...
    """
    job_resource_update_parameter = {"properties":{"destinationAccountDetails":[{"accountId":"accountId","dataDestinationType":"StorageAccount","sharePassword":"sharePassword"},{"accountId":"accountId","dataDestinationType":"StorageAccount","sharePassword":"sharePassword"}],"details":{"shippingAddress":{"country":"country","stateOrProvince":"stateOrProvince","city":"city","zipExtendedCode":"zipExtendedCode","addressType":"None","companyName":"companyName","postalCode":"postalCode","streetAddress1":"streetAddress1","streetAddress2":"streetAddress2","streetAddress3":"streetAddress3"},"contactDetails":{"emailList":["emailList","emailList"],"phone":"phone","contactName":"contactName","phoneExtension":"phoneExtension","mobile":"mobile","notificationPreference":[{"stageName":"DevicePrepared","sendNotification":True},{"stageName":"DevicePrepared","sendNotification":True}]}}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
