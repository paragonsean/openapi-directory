...
void OAIJobDetails::setExpectedDataSizeInTerabytes(const qint32 &expected_data_size_in_terabytes) {
    m_expected_data_size_in_terabytes = expected_data_size_in_terabytes;
    m_expected_data_size_in_terabytes_isSet = true;
}

bool OAIJobDetails::is_expected_data_size_in_terabytes_Set() const{
    return m_expected_data_size_in_terabytes_isSet;
}

bool OAIJobDetails::is_expected_data_size_in_terabytes_Valid() const{
