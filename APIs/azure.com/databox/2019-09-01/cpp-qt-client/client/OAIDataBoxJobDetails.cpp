...
QString OAIDataBoxJobDetails::getDevicePassword() const {
    return m_device_password;
}
void OAIDataBoxJobDetails::setDevicePassword(const QString &device_password) {
    m_device_password = device_password;
    m_device_password_isSet = true;
}

bool OAIDataBoxJobDetails::is_device_password_Set() const{
    return m_device_password_isSet;
}

bool OAIDataBoxJobDetails::is_device_password_Valid() const{
...
void OAIDataBoxJobDetails::setExpectedDataSizeInTerabytes(const qint32 &expected_data_size_in_terabytes) {
    m_expected_data_size_in_terabytes = expected_data_size_in_terabytes;
    m_expected_data_size_in_terabytes_isSet = true;
}

bool OAIDataBoxJobDetails::is_expected_data_size_in_terabytes_Set() const{
    return m_expected_data_size_in_terabytes_isSet;
}

bool OAIDataBoxJobDetails::is_expected_data_size_in_terabytes_Valid() const{
