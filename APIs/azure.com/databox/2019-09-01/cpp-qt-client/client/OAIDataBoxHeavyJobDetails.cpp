...
#include "OAIDataBoxHeavyJobDetails.h"
...
OAIDataBoxHeavyJobDetails::OAIDataBoxHeavyJobDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataBoxHeavyJobDetails::OAIDataBoxHeavyJobDetails() {
    this->initializeModel();
}

OAIDataBoxHeavyJobDetails::~OAIDataBoxHeavyJobDetails() {}

void OAIDataBoxHeavyJobDetails::initializeModel() {
...
void OAIDataBoxHeavyJobDetails::fromJson(QString jsonString) {
...
void OAIDataBoxHeavyJobDetails::fromJsonObject(QJsonObject json) {
...
QString OAIDataBoxHeavyJobDetails::asJson() const {
...
QJsonObject OAIDataBoxHeavyJobDetails::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICopyProgress> OAIDataBoxHeavyJobDetails::getCopyProgress() const {
    return m_copy_progress;
}
void OAIDataBoxHeavyJobDetails::setCopyProgress(const QList<OAICopyProgress> &copy_progress) {
    m_copy_progress = copy_progress;
    m_copy_progress_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_copy_progress_Set() const{
    return m_copy_progress_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_copy_progress_Valid() const{
    return m_copy_progress_isValid;
}

QString OAIDataBoxHeavyJobDetails::getDevicePassword() const {
    return m_device_password;
}
void OAIDataBoxHeavyJobDetails::setDevicePassword(const QString &device_password) {
    m_device_password = device_password;
    m_device_password_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_device_password_Set() const{
    return m_device_password_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_device_password_Valid() const{
    return m_device_password_isValid;
}

QString OAIDataBoxHeavyJobDetails::getChainOfCustodySasKey() const {
    return m_chain_of_custody_sas_key;
}
void OAIDataBoxHeavyJobDetails::setChainOfCustodySasKey(const QString &chain_of_custody_sas_key) {
    m_chain_of_custody_sas_key = chain_of_custody_sas_key;
    m_chain_of_custody_sas_key_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_chain_of_custody_sas_key_Set() const{
    return m_chain_of_custody_sas_key_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_chain_of_custody_sas_key_Valid() const{
    return m_chain_of_custody_sas_key_isValid;
}

OAIContactDetails OAIDataBoxHeavyJobDetails::getContactDetails() const {
    return m_contact_details;
}
void OAIDataBoxHeavyJobDetails::setContactDetails(const OAIContactDetails &contact_details) {
    m_contact_details = contact_details;
    m_contact_details_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_contact_details_Set() const{
    return m_contact_details_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_contact_details_Valid() const{
    return m_contact_details_isValid;
}

QList<OAICopyLogDetails> OAIDataBoxHeavyJobDetails::getCopyLogDetails() const {
    return m_copy_log_details;
}
void OAIDataBoxHeavyJobDetails::setCopyLogDetails(const QList<OAICopyLogDetails> &copy_log_details) {
    m_copy_log_details = copy_log_details;
    m_copy_log_details_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_copy_log_details_Set() const{
    return m_copy_log_details_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_copy_log_details_Valid() const{
    return m_copy_log_details_isValid;
}

OAIPackageShippingDetails OAIDataBoxHeavyJobDetails::getDeliveryPackage() const {
    return m_delivery_package;
}
void OAIDataBoxHeavyJobDetails::setDeliveryPackage(const OAIPackageShippingDetails &delivery_package) {
    m_delivery_package = delivery_package;
    m_delivery_package_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_delivery_package_Set() const{
    return m_delivery_package_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_delivery_package_Valid() const{
    return m_delivery_package_isValid;
}

QList<OAIDestinationAccountDetails> OAIDataBoxHeavyJobDetails::getDestinationAccountDetails() const {
    return m_destination_account_details;
}
void OAIDataBoxHeavyJobDetails::setDestinationAccountDetails(const QList<OAIDestinationAccountDetails> &destination_account_details) {
    m_destination_account_details = destination_account_details;
    m_destination_account_details_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_destination_account_details_Set() const{
    return m_destination_account_details_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_destination_account_details_Valid() const{
    return m_destination_account_details_isValid;
}

QList<OAIJobErrorDetails> OAIDataBoxHeavyJobDetails::getErrorDetails() const {
    return m_error_details;
}
void OAIDataBoxHeavyJobDetails::setErrorDetails(const QList<OAIJobErrorDetails> &error_details) {
    m_error_details = error_details;
    m_error_details_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_error_details_Set() const{
    return m_error_details_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_error_details_Valid() const{
    return m_error_details_isValid;
}

qint32 OAIDataBoxHeavyJobDetails::getExpectedDataSizeInTerabytes() const {
    return m_expected_data_size_in_terabytes;
}
void OAIDataBoxHeavyJobDetails::setExpectedDataSizeInTerabytes(const qint32 &expected_data_size_in_terabytes) {
    m_expected_data_size_in_terabytes = expected_data_size_in_terabytes;
    m_expected_data_size_in_terabytes_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_expected_data_size_in_terabytes_Set() const{
    return m_expected_data_size_in_terabytes_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_expected_data_size_in_terabytes_Valid() const{
    return m_expected_data_size_in_terabytes_isValid;
}

QString OAIDataBoxHeavyJobDetails::getJobDetailsType() const {
    return m_job_details_type;
}
void OAIDataBoxHeavyJobDetails::setJobDetailsType(const QString &job_details_type) {
    m_job_details_type = job_details_type;
    m_job_details_type_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_job_details_type_Set() const{
    return m_job_details_type_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_job_details_type_Valid() const{
    return m_job_details_type_isValid;
}

QList<OAIJobStages> OAIDataBoxHeavyJobDetails::getJobStages() const {
    return m_job_stages;
}
void OAIDataBoxHeavyJobDetails::setJobStages(const QList<OAIJobStages> &job_stages) {
    m_job_stages = job_stages;
    m_job_stages_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_job_stages_Set() const{
    return m_job_stages_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_job_stages_Valid() const{
    return m_job_stages_isValid;
}

OAIPreferences OAIDataBoxHeavyJobDetails::getPreferences() const {
    return m_preferences;
}
void OAIDataBoxHeavyJobDetails::setPreferences(const OAIPreferences &preferences) {
    m_preferences = preferences;
    m_preferences_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_preferences_Set() const{
    return m_preferences_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_preferences_Valid() const{
    return m_preferences_isValid;
}

OAIPackageShippingDetails OAIDataBoxHeavyJobDetails::getReturnPackage() const {
    return m_return_package;
}
void OAIDataBoxHeavyJobDetails::setReturnPackage(const OAIPackageShippingDetails &return_package) {
    m_return_package = return_package;
    m_return_package_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_return_package_Set() const{
    return m_return_package_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_return_package_Valid() const{
    return m_return_package_isValid;
}

QString OAIDataBoxHeavyJobDetails::getReverseShipmentLabelSasKey() const {
    return m_reverse_shipment_label_sas_key;
}
void OAIDataBoxHeavyJobDetails::setReverseShipmentLabelSasKey(const QString &reverse_shipment_label_sas_key) {
    m_reverse_shipment_label_sas_key = reverse_shipment_label_sas_key;
    m_reverse_shipment_label_sas_key_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_reverse_shipment_label_sas_key_Set() const{
    return m_reverse_shipment_label_sas_key_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_reverse_shipment_label_sas_key_Valid() const{
    return m_reverse_shipment_label_sas_key_isValid;
}

OAIShippingAddress OAIDataBoxHeavyJobDetails::getShippingAddress() const {
    return m_shipping_address;
}
void OAIDataBoxHeavyJobDetails::setShippingAddress(const OAIShippingAddress &shipping_address) {
    m_shipping_address = shipping_address;
    m_shipping_address_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_shipping_address_Set() const{
    return m_shipping_address_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_shipping_address_Valid() const{
    return m_shipping_address_isValid;
}

bool OAIDataBoxHeavyJobDetails::isSet() const {
...
bool OAIDataBoxHeavyJobDetails::isValid() const {
