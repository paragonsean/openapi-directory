...
void OAIJobProperties::initializeModel() {
    ...
    m_is_cancellable_without_fee_isSet = false;
    m_is_cancellable_without_fee_isValid = false;
...
void OAIJobProperties::fromJsonObject(QJsonObject json) {
    ...
    m_is_cancellable_without_fee_isValid = ::OpenAPI::fromJsonValue(m_is_cancellable_without_fee, json[QString("isCancellableWithoutFee")]);
    m_is_cancellable_without_fee_isSet = !json[QString("isCancellableWithoutFee")].isNull() && m_is_cancellable_without_fee_isValid;
...
QJsonObject OAIJobProperties::asJsonObject() const {
    ...
    if (m_is_cancellable_without_fee_isSet) {
        obj.insert(QString("isCancellableWithoutFee"), ::OpenAPI::toJsonValue(m_is_cancellable_without_fee));
    }
...
OAIJobDeliveryInfo OAIJobProperties::getDeliveryInfo() const {
    return m_delivery_info;
}
void OAIJobProperties::setDeliveryInfo(const OAIJobDeliveryInfo &delivery_info) {
    m_delivery_info = delivery_info;
    m_delivery_info_isSet = true;
}

bool OAIJobProperties::is_delivery_info_Set() const{
    return m_delivery_info_isSet;
}

bool OAIJobProperties::is_delivery_info_Valid() const{
    return m_delivery_info_isValid;
}

QString OAIJobProperties::getDeliveryType() const {
    return m_delivery_type;
}
void OAIJobProperties::setDeliveryType(const QString &delivery_type) {
    m_delivery_type = delivery_type;
    m_delivery_type_isSet = true;
}

bool OAIJobProperties::is_delivery_type_Set() const{
    return m_delivery_type_isSet;
}

bool OAIJobProperties::is_delivery_type_Valid() const{
...
bool OAIJobProperties::isIsCancellableWithoutFee() const {
    return m_is_cancellable_without_fee;
}
void OAIJobProperties::setIsCancellableWithoutFee(const bool &is_cancellable_without_fee) {
    m_is_cancellable_without_fee = is_cancellable_without_fee;
    m_is_cancellable_without_fee_isSet = true;
}

bool OAIJobProperties::is_is_cancellable_without_fee_Set() const{
    return m_is_cancellable_without_fee_isSet;
}

bool OAIJobProperties::is_is_cancellable_without_fee_Valid() const{
    return m_is_cancellable_without_fee_isValid;
}
