...
* `HardwareError` (value: `"HardwareError"`)

* `DeviceFormatted` (value: `"DeviceFormatted"`)

* `DeviceMetadataModified` (value: `"DeviceMetadataModified"`)

* `StorageAccountNotAccessible` (value: `"StorageAccountNotAccessible"`)

* `UnsupportedData` (value: `"UnsupportedData"`)
