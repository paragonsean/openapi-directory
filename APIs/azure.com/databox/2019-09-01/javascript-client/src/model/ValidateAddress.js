...
class ValidateAddress {
     ...
     * @param validationType {module:model/ValidateAddress.ValidationTypeEnum} Identifies the type of validation request.
     */
    constructor(validationType) { 
        ValidationInputRequest.initialize(this, validationType);
        ValidateAddress.initialize(this, validationType);
    }
...
ValidateAddress.RequiredProperties = ["deviceType", "shippingAddress", "validationType"];
 ...
 */
ValidateAddress.prototype['transportPreferences'] = undefined;
