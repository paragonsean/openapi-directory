...
/**
 * The DataBoxJobDetails model module.
 * @module model/DataBoxJobDetails
 * @version 2019-09-01
 */
class DataBoxJobDetails {
    /**
     * Constructs a new <code>DataBoxJobDetails</code>.
     * Databox Job Details
     * @alias module:model/DataBoxJobDetails
     ...
     * @param jobDetailsType {module:model/DataBoxJobDetails.JobDetailsTypeEnum} Indicates the type of job details.
    ...
    constructor(contactDetails, destinationAccountDetails, jobDetailsType, shippingAddress) { 
        ...
        DataBoxJobDetails.initialize(this, contactDetails, destinationAccountDetails, jobDetailsType, shippingAddress);
    }
    ...
    /**
     * Constructs a <code>DataBoxJobDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataBoxJobDetails} obj Optional instance to populate.
     * @return {module:model/DataBoxJobDetails} The populated <code>DataBoxJobDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataBoxJobDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>DataBoxJobDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataBoxJobDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DataBoxJobDetails.RequiredProperties) {
...
DataBoxJobDetails.RequiredProperties = ["contactDetails", "destinationAccountDetails", "jobDetailsType", "shippingAddress"];

/**
 * Copy progress per storage account.
 * @member {Array.<module:model/CopyProgress>} copyProgress
 */
DataBoxJobDetails.prototype['copyProgress'] = undefined;

/**
 * Set Device password for unlocking Databox
 * @member {String} devicePassword
 */
DataBoxJobDetails.prototype['devicePassword'] = undefined;
...
export default DataBoxJobDetails;
