...
public class SkuCapacity {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.maximum, skuCapacity.maximum) &&
        Objects.equals(this.usable, skuCapacity.usable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maximum, usable);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("usable") != null && !jsonObj.get("usable").isJsonNull()) && !jsonObj.get("usable").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `usable` to be a primitive type in the JSON string but got `%s`", jsonObj.get("usable").toString()));
      }
  }
