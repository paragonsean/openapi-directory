...
public class DataBoxHeavySecret {
  ...
  public boolean equals(Object o) {
    ...
    DataBoxHeavySecret dataBoxHeavySecret = (DataBoxHeavySecret) o;
    return Objects.equals(this.accountCredentialDetails, dataBoxHeavySecret.accountCredentialDetails) &&
        Objects.equals(this.devicePassword, dataBoxHeavySecret.devicePassword) &&
        Objects.equals(this.deviceSerialNumber, dataBoxHeavySecret.deviceSerialNumber) &&
        Objects.equals(this.encodedValidationCertPubKey, dataBoxHeavySecret.encodedValidationCertPubKey) &&
        Objects.equals(this.networkConfigurations, dataBoxHeavySecret.networkConfigurations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataBoxHeavySecret {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataBoxHeavySecret
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataBoxHeavySecret.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataBoxHeavySecret is not found in the empty JSON string", DataBoxHeavySecret.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataBoxHeavySecret.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataBoxHeavySecret` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataBoxHeavySecret.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataBoxHeavySecret' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataBoxHeavySecret> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataBoxHeavySecret.class));

       return (TypeAdapter<T>) new TypeAdapter<DataBoxHeavySecret>() {
           @Override
           public void write(JsonWriter out, DataBoxHeavySecret value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataBoxHeavySecret read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataBoxHeavySecret given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataBoxHeavySecret
   * @throws IOException if the JSON string is invalid with respect to DataBoxHeavySecret
   */
  public static DataBoxHeavySecret fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataBoxHeavySecret.class);
  }

  /**
   * Convert an instance of DataBoxHeavySecret to an JSON string
   *
   * @return JSON string
   */
