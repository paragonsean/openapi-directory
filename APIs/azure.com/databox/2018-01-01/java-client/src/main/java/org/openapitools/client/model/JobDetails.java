...
public class JobDetails {
  ...
  public static final String SERIALIZED_NAME_EXPECTED_DATA_SIZE_IN_TERA_BYTES = "expectedDataSizeInTeraBytes";
  @SerializedName(SERIALIZED_NAME_EXPECTED_DATA_SIZE_IN_TERA_BYTES)
