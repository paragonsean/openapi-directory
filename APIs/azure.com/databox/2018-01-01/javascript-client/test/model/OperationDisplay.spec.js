...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new DataBoxManagementClient.OperationDisplay();
      //expect(instance).to.be.a(DataBoxManagementClient.OperationDisplay);
    });
