...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new DataBoxManagementClient.Operation();
      //expect(instance).to.be.a(DataBoxManagementClient.Operation);
    });
