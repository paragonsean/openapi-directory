...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxManagementClient.ValidateAddress();
  });
  ...
  describe('ValidateAddress', function() {
    it('should create an instance of ValidateAddress', function() {
      // uncomment below and update the code to test ValidateAddress
      //var instance = new DataBoxManagementClient.ValidateAddress();
      //expect(instance).to.be.a(DataBoxManagementClient.ValidateAddress);
    });
