...
void OAIDataBoxHeavyJobDetails::setExpectedDataSizeInTeraBytes(const qint32 &expected_data_size_in_tera_bytes) {
    m_expected_data_size_in_tera_bytes = expected_data_size_in_tera_bytes;
    m_expected_data_size_in_tera_bytes_isSet = true;
}

bool OAIDataBoxHeavyJobDetails::is_expected_data_size_in_tera_bytes_Set() const{
    return m_expected_data_size_in_tera_bytes_isSet;
}

bool OAIDataBoxHeavyJobDetails::is_expected_data_size_in_tera_bytes_Valid() const{
