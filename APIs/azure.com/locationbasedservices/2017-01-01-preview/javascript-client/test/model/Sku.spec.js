...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureLocationBasedServicesResourceProvider.Sku();
  });
  ...
  describe('Sku', function() {
    it('should create an instance of Sku', function() {
      ...
      //var instance = new AzureLocationBasedServicesResourceProvider.Sku();
      //expect(instance).to.be.a(AzureLocationBasedServicesResourceProvider.Sku);
    });
