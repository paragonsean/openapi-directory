...
public:
    ...
    OAIPublicKeyProperties getProperties() const;
    void setProperties(const OAIPublicKeyProperties &properties);
...
private:
    ...
    OAIPublicKeyProperties m_properties;
