...
#include "OAIAvailableProviderOperations.h"
#include <QString>
...
Q_SIGNALS:
    ...
    void operationsListSignal(OAIAvailableProviderOperations summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIAvailableProviderOperations summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(OAIAvailableProviderOperations summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(OAIAvailableProviderOperations summary, QNetworkReply::NetworkError error_type, const QString &error_str);
