# HybridDataManagementClient.Resource
...
**tags** | **{String: String}** | The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource  (across resource groups). | [optional] 
