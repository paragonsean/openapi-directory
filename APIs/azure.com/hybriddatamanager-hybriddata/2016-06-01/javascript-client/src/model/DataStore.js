...
class DataStore {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = DataStoreProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of DataStore.RequiredProperties) {
        ...
        if (data['properties']) { // data not null
          DataStoreProperties.validateJSON(data['properties']);
        }
...
DataStore.RequiredProperties = ["properties"];

/**
 * @member {module:model/DataStoreProperties} properties
 */
DataStore.prototype['properties'] = undefined;

/**
 * Id of the object.
 * @member {String} id
 */
DataStore.prototype['id'] = undefined;

/**
 * Name of the object.
 * @member {String} name
 */
DataStore.prototype['name'] = undefined;
