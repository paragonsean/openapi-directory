...
import PublicKeyProperties from './PublicKeyProperties';
...
class PublicKey {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = PublicKeyProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          PublicKeyProperties.validateJSON(data['properties']);
        }
...
PublicKey.RequiredProperties = ["properties"];

/**
 * @member {module:model/PublicKeyProperties} properties
 */
PublicKey.prototype['properties'] = undefined;
