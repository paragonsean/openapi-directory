...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HybridDataManagementClient.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new HybridDataManagementClient.ErrorDetails();
      //expect(instance).to.be.a(HybridDataManagementClient.ErrorDetails);
    });
