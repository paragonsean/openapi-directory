...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HybridDataManagementClient.AvailableProviderOperationDisplay();
  });
  ...
  describe('AvailableProviderOperationDisplay', function() {
    it('should create an instance of AvailableProviderOperationDisplay', function() {
      ...
      //var instance = new HybridDataManagementClient.AvailableProviderOperationDisplay();
      //expect(instance).to.be.a(HybridDataManagementClient.AvailableProviderOperationDisplay);
    });
