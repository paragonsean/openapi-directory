...
public class JobFilter {
  ...
  public JobFilter status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startTime, jobFilter.startTime) &&
        Objects.equals(this.status, jobFilter.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startTime, status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : JobFilter.openapiRequiredFields) {
