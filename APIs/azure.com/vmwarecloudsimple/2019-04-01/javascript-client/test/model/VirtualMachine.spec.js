...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VMwareCloudSimple.VirtualMachine();
  });
  ...
  describe('VirtualMachine', function() {
    it('should create an instance of VirtualMachine', function() {
      ...
      //var instance = new VMwareCloudSimple.VirtualMachine();
      //expect(instance).to.be.a(VMwareCloudSimple.VirtualMachine);
    });
