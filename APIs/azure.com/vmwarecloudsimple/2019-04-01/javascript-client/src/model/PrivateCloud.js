...
import PrivateCloudProperties from './PrivateCloudProperties';
...
class PrivateCloud {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = PrivateCloudProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          PrivateCloudProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} id
 */
PrivateCloud.prototype['id'] = undefined;

/**
 * Location where private cloud created, e.g \"westus\"
 * @member {String} location
 */
PrivateCloud.prototype['location'] = undefined;
...
/**
 * @member {module:model/PrivateCloudProperties} properties
 */
PrivateCloud.prototype['properties'] = undefined;
...
PrivateCloud['TypeEnum'] = {
    ...
    /**
     * value: "Microsoft.VMwareCloudSimple/privateClouds"
     * @const
     */
    "Microsoft.VMwareCloudSimple/privateClouds": "Microsoft.VMwareCloudSimple/privateClouds"
};
