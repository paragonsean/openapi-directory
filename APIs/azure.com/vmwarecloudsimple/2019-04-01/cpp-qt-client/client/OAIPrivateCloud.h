...
namespace OpenAPI {
class OAIPrivateCloudProperties;
...
public:
    ...
    OAIPrivateCloudProperties getProperties() const;
    void setProperties(const OAIPrivateCloudProperties &properties);
...
private:
    ...
    OAIPrivateCloudProperties m_properties;
