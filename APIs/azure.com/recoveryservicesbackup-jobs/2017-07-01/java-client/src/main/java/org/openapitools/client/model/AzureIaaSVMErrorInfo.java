...
public class AzureIaaSVMErrorInfo {
  ...
  public AzureIaaSVMErrorInfo errorCode(Integer errorCode) {
  ...
  public AzureIaaSVMErrorInfo errorString(String errorString) {
  ...
  public AzureIaaSVMErrorInfo errorTitle(String errorTitle) {
  ...
  public AzureIaaSVMErrorInfo recommendations(List<String> recommendations) {
    this.recommendations = recommendations;
    return this;
  }

  public AzureIaaSVMErrorInfo addRecommendationsItem(String recommendationsItem) {
