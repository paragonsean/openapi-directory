...
QString OAIActionType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIActionType::ALLOW:
            val = "Allow";
            break;
        case eOAIActionType::BLOCK:
            val = "Block";
            break;
        case eOAIActionType::LOG:
            val = "Log";
            break;
        case eOAIActionType::REDIRECT:
            val = "Redirect";
            break;
        default:
            break;
