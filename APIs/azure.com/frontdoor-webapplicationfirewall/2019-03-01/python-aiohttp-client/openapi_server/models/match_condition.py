...
class MatchCondition(Model):
    ...
    def __init__(self, match_value: List[str]=None, match_variable: str=None, negate_condition: bool=None, operator: str=None, selector: str=None, transforms: List[TransformType]=None):
        ...
        :param transforms: The transforms of this MatchCondition.
        """
        self.openapi_types = {
    ...
    def match_variable(self, match_variable):
        ...
        """
        allowed_values = ["RemoteAddr", "RequestMethod", "QueryString", "PostArgs", "RequestUri", "RequestHeader", "RequestBody", "Cookies", "SocketAddr"]  # noqa: E501
    ...
    def operator(self, operator):
        ...
        :type operator: str
        """
        allowed_values = ["Any", "IPMatch", "GeoMatch", "Equal", "Contains", "LessThan", "GreaterThan", "LessThanOrEqual", "GreaterThanOrEqual", "BeginsWith", "EndsWith", "RegEx"]  # noqa: E501
    ...
    @property
    def transforms(self):
        """Gets the transforms of this MatchCondition.

        List of transforms.

        :return: The transforms of this MatchCondition.
    ...
    def transforms(self, transforms):
        """Sets the transforms of this MatchCondition.

        List of transforms.

        :param transforms: The transforms of this MatchCondition.
        :type transforms: List[TransformType]
        """
