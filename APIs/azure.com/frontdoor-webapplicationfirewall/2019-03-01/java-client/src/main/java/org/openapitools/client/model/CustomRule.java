...
public class CustomRule {
  ...
  public CustomRule action(ActionType action) {
    this.action = action;
    return this;
  }
  ...
  public CustomRule enabledState(EnabledStateEnum enabledState) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, customRule.action) &&
        Objects.equals(this.enabledState, customRule.enabledState) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, enabledState, matchConditions, name, priority, rateLimitDurationInMinutes, rateLimitThreshold, ruleType);
  }
