...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionCreateParameters();
  });
  ...
  describe('SubscriptionCreateParameters', function() {
    it('should create an instance of SubscriptionCreateParameters', function() {
      // uncomment below and update the code to test SubscriptionCreateParameters
      //var instance = new ApiManagementClient.SubscriptionCreateParameters();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionCreateParameters);
    });
