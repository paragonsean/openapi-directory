...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionContractProperties();
  });
  ...
  describe('SubscriptionContractProperties', function() {
    it('should create an instance of SubscriptionContractProperties', function() {
      // uncomment below and update the code to test SubscriptionContractProperties
      //var instance = new ApiManagementClient.SubscriptionContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionContractProperties);
    });
