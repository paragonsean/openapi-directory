...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionUpdateParameterProperties();
  });
  ...
  describe('SubscriptionUpdateParameterProperties', function() {
    it('should create an instance of SubscriptionUpdateParameterProperties', function() {
      // uncomment below and update the code to test SubscriptionUpdateParameterProperties
      //var instance = new ApiManagementClient.SubscriptionUpdateParameterProperties();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionUpdateParameterProperties);
    });
