...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionCreateParameterProperties();
  });
  ...
  describe('SubscriptionCreateParameterProperties', function() {
    it('should create an instance of SubscriptionCreateParameterProperties', function() {
      // uncomment below and update the code to test SubscriptionCreateParameterProperties
      //var instance = new ApiManagementClient.SubscriptionCreateParameterProperties();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionCreateParameterProperties);
    });
