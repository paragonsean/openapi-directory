...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionCollection();
  });
  ...
  describe('SubscriptionCollection', function() {
    it('should create an instance of SubscriptionCollection', function() {
      // uncomment below and update the code to test SubscriptionCollection
      //var instance = new ApiManagementClient.SubscriptionCollection();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionCollection);
    });
