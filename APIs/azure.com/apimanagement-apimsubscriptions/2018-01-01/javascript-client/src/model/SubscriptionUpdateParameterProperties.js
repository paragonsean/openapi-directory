...
/**
 * The SubscriptionUpdateParameterProperties model module.
 * @module model/SubscriptionUpdateParameterProperties
 * @version 2018-01-01
 */
class SubscriptionUpdateParameterProperties {
    /**
     * Constructs a new <code>SubscriptionUpdateParameterProperties</code>.
     * Parameters supplied to the Update subscription operation.
     * @alias module:model/SubscriptionUpdateParameterProperties
     */
    constructor() { 
        
        SubscriptionUpdateParameterProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubscriptionUpdateParameterProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubscriptionUpdateParameterProperties} obj Optional instance to populate.
     * @return {module:model/SubscriptionUpdateParameterProperties} The populated <code>SubscriptionUpdateParameterProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubscriptionUpdateParameterProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>SubscriptionUpdateParameterProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscriptionUpdateParameterProperties</code>.
     */
 ...
 */
SubscriptionUpdateParameterProperties.prototype['displayName'] = undefined;

/**
 * Subscription expiration date. The setting is for audit purposes only and the subscription is not automatically expired. The subscription lifecycle can be managed by using the `state` property. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard.
 * @member {Date} expirationDate
 */
SubscriptionUpdateParameterProperties.prototype['expirationDate'] = undefined;

/**
 * Primary subscription key.
 * @member {String} primaryKey
 */
SubscriptionUpdateParameterProperties.prototype['primaryKey'] = undefined;

/**
 * Product identifier path: /products/{productId}
 * @member {String} productId
 */
SubscriptionUpdateParameterProperties.prototype['productId'] = undefined;

/**
 * Secondary subscription key.
 * @member {String} secondaryKey
 */
SubscriptionUpdateParameterProperties.prototype['secondaryKey'] = undefined;

/**
 * Subscription state. Possible states are * active – the subscription is active, * suspended – the subscription is blocked, and the subscriber cannot call any APIs of the product, * submitted – the subscription request has been made by the developer, but has not yet been approved or rejected, * rejected – the subscription request has been denied by an administrator, * cancelled – the subscription has been cancelled by the developer or administrator, * expired – the subscription reached its expiration date and was deactivated.
 * @member {module:model/SubscriptionUpdateParameterProperties.StateEnum} state
 */
SubscriptionUpdateParameterProperties.prototype['state'] = undefined;

/**
 * Comments describing subscription state change by the administrator.
 * @member {String} stateComment
 */
SubscriptionUpdateParameterProperties.prototype['stateComment'] = undefined;

/**
 * User identifier path: /users/{uid}
 * @member {String} userId
 */
SubscriptionUpdateParameterProperties.prototype['userId'] = undefined;
 ...
 * @readonly
 */
SubscriptionUpdateParameterProperties['StateEnum'] = {
...
export default SubscriptionUpdateParameterProperties;
