...
async def test_subscription_create_or_update(client):
    ...
    """
    parameters = {"properties":{"productId":"productId","secondaryKey":"secondaryKey","displayName":"displayName","state":"suspended","userId":"userId","primaryKey":"primaryKey"}}
    params = [('notify', True),
...
async def test_subscription_update(client):
    ...
    """
    parameters = {"properties":{"productId":"productId","secondaryKey":"secondaryKey","displayName":"displayName","stateComment":"stateComment","state":"suspended","userId":"userId","expirationDate":"2000-01-23T04:56:07.000+00:00","primaryKey":"primaryKey"}}
    params = [('notify', True),
                    ('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
