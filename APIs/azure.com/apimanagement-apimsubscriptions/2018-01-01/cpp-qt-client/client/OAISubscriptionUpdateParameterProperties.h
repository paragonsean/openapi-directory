...
/*
 * OAISubscriptionUpdateParameterProperties.h
 *
 * Parameters supplied to the Update subscription operation.
 */

#ifndef OAISubscriptionUpdateParameterProperties_H
#define OAISubscriptionUpdateParameterProperties_H
...
class OAISubscriptionUpdateParameterProperties : public OAIObject {
public:
    OAISubscriptionUpdateParameterProperties();
    OAISubscriptionUpdateParameterProperties(QString json);
    ~OAISubscriptionUpdateParameterProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscriptionUpdateParameterProperties)

#endif // OAISubscriptionUpdateParameterProperties_H
