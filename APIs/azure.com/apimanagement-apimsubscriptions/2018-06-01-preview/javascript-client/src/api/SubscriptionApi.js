...
export default class SubscriptionApi {
    ...
    */
     ...
     * @callback module:api/SubscriptionApi~subscriptionCreateOrUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SubscriptionGet200Response} data The data returned by the service call.
     ...
     * @param {module:model/SubscriptionCreateOrUpdateRequest} parameters Create parameters.
     ...
     * @param {module:api/SubscriptionApi~subscriptionCreateOrUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SubscriptionGet200Response}
     */
    subscriptionCreateOrUpdate(resourceGroupName, serviceName, sid, apiVersion, subscriptionId, parameters, opts, callback) {
      ...
      let returnType = SubscriptionGet200Response;
     ...
     * @callback module:api/SubscriptionApi~subscriptionDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/SubscriptionApi~subscriptionDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/SubscriptionApi~subscriptionGetEntityTagCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/SubscriptionApi~subscriptionGetEntityTagCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/SubscriptionApi~subscriptionListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SubscriptionList200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SubscriptionApi~subscriptionListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SubscriptionList200Response}
     */
    subscriptionList(resourceGroupName, serviceName, apiVersion, subscriptionId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SubscriptionList200Response;
      return this.apiClient.callApi(
     ...
     * @callback module:api/SubscriptionApi~subscriptionUpdateCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/SubscriptionUpdateRequest} parameters Update parameters.
     * @param {Object} opts Optional parameters
     * @param {Boolean} [notify] Notify change in Subscription State.   - If false, do not send any email notification for change of state of subscription   - If true, send email notification of change of state of subscription 
     * @param {module:api/SubscriptionApi~subscriptionUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     */
