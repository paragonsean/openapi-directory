...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionListDefaultResponseError();
  });
  ...
  describe('SubscriptionListDefaultResponseError', function() {
    it('should create an instance of SubscriptionListDefaultResponseError', function() {
      // uncomment below and update the code to test SubscriptionListDefaultResponseError
      //var instance = new ApiManagementClient.SubscriptionListDefaultResponseError();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionListDefaultResponseError);
    });
