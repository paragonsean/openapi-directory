...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionGet200Response();
  });
  ...
  describe('SubscriptionGet200Response', function() {
    it('should create an instance of SubscriptionGet200Response', function() {
      // uncomment below and update the code to test SubscriptionGet200Response
      //var instance = new ApiManagementClient.SubscriptionGet200Response();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionGet200Response);
    });
