...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionCreateOrUpdateRequestProperties();
  });
  ...
  describe('SubscriptionCreateOrUpdateRequestProperties', function() {
    it('should create an instance of SubscriptionCreateOrUpdateRequestProperties', function() {
      // uncomment below and update the code to test SubscriptionCreateOrUpdateRequestProperties
      //var instance = new ApiManagementClient.SubscriptionCreateOrUpdateRequestProperties();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionCreateOrUpdateRequestProperties);
    });
