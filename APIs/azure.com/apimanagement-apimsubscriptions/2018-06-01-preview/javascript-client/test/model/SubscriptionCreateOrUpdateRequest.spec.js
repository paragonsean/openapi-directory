...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionCreateOrUpdateRequest();
  });
  ...
  describe('SubscriptionCreateOrUpdateRequest', function() {
    it('should create an instance of SubscriptionCreateOrUpdateRequest', function() {
      // uncomment below and update the code to test SubscriptionCreateOrUpdateRequest
      //var instance = new ApiManagementClient.SubscriptionCreateOrUpdateRequest();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionCreateOrUpdateRequest);
    });
