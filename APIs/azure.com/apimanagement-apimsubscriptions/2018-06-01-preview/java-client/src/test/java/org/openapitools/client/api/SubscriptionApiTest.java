...
public class SubscriptionApiTest {
    ...
    public void subscriptionCreateOrUpdateTest() throws ApiException {
        ...
        Boolean notify = null;
        String ifMatch = null;
        SubscriptionGet200Response response = api.subscriptionCreateOrUpdate(resourceGroupName, serviceName, sid, apiVersion, subscriptionId, parameters, notify, ifMatch);
