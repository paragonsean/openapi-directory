...
> SubscriptionGet200Response subscriptionCreateOrUpdate(resourceGroupName, serviceName, sid, apiVersion, subscriptionId, parameters, notify, ifMatch)
...
# **subscriptionUpdate**
> subscriptionUpdate(resourceGroupName, serviceName, sid, ifMatch, apiVersion, subscriptionId, parameters, notify)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean notify = true; // Boolean | Notify change in Subscription State.   - If false, do not send any email notification for change of state of subscription   - If true, send email notification of change of state of subscription 
    try {
      apiInstance.subscriptionUpdate(resourceGroupName, serviceName, sid, ifMatch, apiVersion, subscriptionId, parameters, notify);
    } catch (ApiException e) {
