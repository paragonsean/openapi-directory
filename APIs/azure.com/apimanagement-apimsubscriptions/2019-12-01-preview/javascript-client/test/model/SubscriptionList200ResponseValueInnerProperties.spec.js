...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionList200ResponseValueInnerProperties();
  });
  ...
  describe('SubscriptionList200ResponseValueInnerProperties', function() {
    it('should create an instance of SubscriptionList200ResponseValueInnerProperties', function() {
      // uncomment below and update the code to test SubscriptionList200ResponseValueInnerProperties
      //var instance = new ApiManagementClient.SubscriptionList200ResponseValueInnerProperties();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionList200ResponseValueInnerProperties);
    });
