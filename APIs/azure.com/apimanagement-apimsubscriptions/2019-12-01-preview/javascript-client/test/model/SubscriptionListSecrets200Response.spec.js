...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionListSecrets200Response();
  });
  ...
  describe('SubscriptionListSecrets200Response', function() {
    it('should create an instance of SubscriptionListSecrets200Response', function() {
      // uncomment below and update the code to test SubscriptionListSecrets200Response
      //var instance = new ApiManagementClient.SubscriptionListSecrets200Response();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionListSecrets200Response);
    });
