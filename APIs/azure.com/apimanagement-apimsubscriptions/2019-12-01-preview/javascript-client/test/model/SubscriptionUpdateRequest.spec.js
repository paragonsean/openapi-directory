...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionUpdateRequest();
  });
  ...
  describe('SubscriptionUpdateRequest', function() {
    it('should create an instance of SubscriptionUpdateRequest', function() {
      // uncomment below and update the code to test SubscriptionUpdateRequest
      //var instance = new ApiManagementClient.SubscriptionUpdateRequest();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionUpdateRequest);
    });
