# ApiManagementClient.SubscriptionList200ResponseValueInnerProperties
...
**primaryKey** | **String** | Subscription primary key. This property will not be filled on &#39;GET&#39; operations! Use &#39;/listSecrets&#39; POST request to get the value. | [optional] 
**scope** | **String** | Scope like /products/{productId} or /apis or /apis/{apiId}. | 
**secondaryKey** | **String** | Subscription secondary key. This property will not be filled on &#39;GET&#39; operations! Use &#39;/listSecrets&#39; POST request to get the value. | [optional] 
