...
import org.openapitools.client.model.SubscriptionListSecrets200Response;
...
public class SubscriptionApi {
     ...
     */
    public okhttp3.Call subscriptionCreateOrUpdateCall(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, SubscriptionCreateOrUpdateRequest parameters, Boolean notify, String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call subscriptionCreateOrUpdateValidateBeforeCall(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, SubscriptionCreateOrUpdateRequest parameters, Boolean notify, String ifMatch, final ApiCallback _callback) throws ApiException {
     ...
     */
    public SubscriptionGet200Response subscriptionCreateOrUpdate(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, SubscriptionCreateOrUpdateRequest parameters, Boolean notify, String ifMatch) throws ApiException {
        ApiResponse<SubscriptionGet200Response> localVarResp = subscriptionCreateOrUpdateWithHttpInfo(resourceGroupName, serviceName, sid, apiVersion, subscriptionId, parameters, notify, ifMatch);
     ...
     */
    public ApiResponse<SubscriptionGet200Response> subscriptionCreateOrUpdateWithHttpInfo(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, SubscriptionCreateOrUpdateRequest parameters, Boolean notify, String ifMatch) throws ApiException {
     ...
     */
    public okhttp3.Call subscriptionCreateOrUpdateAsync(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, SubscriptionCreateOrUpdateRequest parameters, Boolean notify, String ifMatch, final ApiCallback<SubscriptionGet200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for subscriptionListSecrets
     * @param resourceGroupName The name of the resource group. (required)
     * @param serviceName The name of the API Management service. (required)
     * @param sid Subscription entity Identifier. The entity represents the association between a user and a product in API Management. (required)
     * @param apiVersion Version of the API to be used with the client request. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The response body contains subscription keys. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call subscriptionListSecretsCall(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/subscriptions/{sid}/listSecrets"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "serviceName" + "}", localVarApiClient.escapeString(serviceName.toString()))
            .replace("{" + "sid" + "}", localVarApiClient.escapeString(sid.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call subscriptionListSecretsValidateBeforeCall(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling subscriptionListSecrets(Async)");
        }

        // verify the required parameter 'serviceName' is set
        if (serviceName == null) {
            throw new ApiException("Missing the required parameter 'serviceName' when calling subscriptionListSecrets(Async)");
        }

        // verify the required parameter 'sid' is set
        if (sid == null) {
            throw new ApiException("Missing the required parameter 'sid' when calling subscriptionListSecrets(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling subscriptionListSecrets(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling subscriptionListSecrets(Async)");
        }

        return subscriptionListSecretsCall(resourceGroupName, serviceName, sid, apiVersion, subscriptionId, _callback);
     ...
     */
    public SubscriptionListSecrets200Response subscriptionListSecrets(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<SubscriptionListSecrets200Response> localVarResp = subscriptionListSecretsWithHttpInfo(resourceGroupName, serviceName, sid, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion Version of the API to be used with the client request. (required)
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @return ApiResponse&lt;SubscriptionListSecrets200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SubscriptionListSecrets200Response> subscriptionListSecretsWithHttpInfo(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = subscriptionListSecretsValidateBeforeCall(resourceGroupName, serviceName, sid, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<SubscriptionListSecrets200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call subscriptionListSecretsAsync(String resourceGroupName, String serviceName, String sid, String apiVersion, String subscriptionId, final ApiCallback<SubscriptionListSecrets200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = subscriptionListSecretsValidateBeforeCall(resourceGroupName, serviceName, sid, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<SubscriptionListSecrets200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call subscriptionUpdateCall(String resourceGroupName, String serviceName, String sid, String ifMatch, String apiVersion, String subscriptionId, SubscriptionUpdateRequest parameters, Boolean notify, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call subscriptionUpdateValidateBeforeCall(String resourceGroupName, String serviceName, String sid, String ifMatch, String apiVersion, String subscriptionId, SubscriptionUpdateRequest parameters, Boolean notify, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
     ...
     */
    public void subscriptionUpdate(String resourceGroupName, String serviceName, String sid, String ifMatch, String apiVersion, String subscriptionId, SubscriptionUpdateRequest parameters, Boolean notify) throws ApiException {
     ...
     */
    public ApiResponse<Void> subscriptionUpdateWithHttpInfo(String resourceGroupName, String serviceName, String sid, String ifMatch, String apiVersion, String subscriptionId, SubscriptionUpdateRequest parameters, Boolean notify) throws ApiException {
     ...
     */
    public okhttp3.Call subscriptionUpdateAsync(String resourceGroupName, String serviceName, String sid, String ifMatch, String apiVersion, String subscriptionId, SubscriptionUpdateRequest parameters, Boolean notify, final ApiCallback<Void> _callback) throws ApiException {
