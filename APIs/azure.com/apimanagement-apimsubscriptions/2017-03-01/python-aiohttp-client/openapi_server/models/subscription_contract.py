...
class SubscriptionContract(Model):
    ...
    def __init__(self, id: str=None, created_date: datetime=None, end_date: datetime=None, expiration_date: datetime=None, name: str=None, notification_date: datetime=None, primary_key: str=None, product_id: str=None, secondary_key: str=None, start_date: datetime=None, state: str=None, state_comment: str=None, user_id: str=None):
