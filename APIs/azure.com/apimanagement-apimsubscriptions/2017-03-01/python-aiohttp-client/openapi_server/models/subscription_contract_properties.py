...
class SubscriptionContractProperties(Model):
    ...
    def __init__(self, created_date: datetime=None, end_date: datetime=None, expiration_date: datetime=None, name: str=None, notification_date: datetime=None, primary_key: str=None, product_id: str=None, secondary_key: str=None, start_date: datetime=None, state: str=None, state_comment: str=None, user_id: str=None):
        ...
        :param name: The name of this SubscriptionContractProperties.
    ...
    @property
    def name(self):
        """Gets the name of this SubscriptionContractProperties.

        The name of the subscription, or null if the subscription has no name.

        :return: The name of this SubscriptionContractProperties.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SubscriptionContractProperties.
