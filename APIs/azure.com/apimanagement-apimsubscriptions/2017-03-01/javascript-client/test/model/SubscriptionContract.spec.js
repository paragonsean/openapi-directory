...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionContract();
  });
  ...
  describe('SubscriptionContract', function() {
    it('should create an instance of SubscriptionContract', function() {
      // uncomment below and update the code to test SubscriptionContract
      //var instance = new ApiManagementClient.SubscriptionContract();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionContract);
    });
