...
/**
 * The SubscriptionUpdateRequestProperties model module.
 * @module model/SubscriptionUpdateRequestProperties
 * @version 2019-01-01
 */
class SubscriptionUpdateRequestProperties {
    /**
     * Constructs a new <code>SubscriptionUpdateRequestProperties</code>.
     * Parameters supplied to the Update subscription operation.
     * @alias module:model/SubscriptionUpdateRequestProperties
     */
    constructor() { 
        
        SubscriptionUpdateRequestProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubscriptionUpdateRequestProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubscriptionUpdateRequestProperties} obj Optional instance to populate.
     * @return {module:model/SubscriptionUpdateRequestProperties} The populated <code>SubscriptionUpdateRequestProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubscriptionUpdateRequestProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>SubscriptionUpdateRequestProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscriptionUpdateRequestProperties</code>.
     */
 ...
 */
SubscriptionUpdateRequestProperties.prototype['allowTracing'] = undefined;

/**
 * Subscription name.
 * @member {String} displayName
 */
SubscriptionUpdateRequestProperties.prototype['displayName'] = undefined;

/**
 * Subscription expiration date. The setting is for audit purposes only and the subscription is not automatically expired. The subscription lifecycle can be managed by using the `state` property. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard.
 * @member {Date} expirationDate
 */
SubscriptionUpdateRequestProperties.prototype['expirationDate'] = undefined;

/**
 * User identifier path: /users/{userId}
 * @member {String} ownerId
 */
SubscriptionUpdateRequestProperties.prototype['ownerId'] = undefined;

/**
 * Primary subscription key.
 * @member {String} primaryKey
 */
SubscriptionUpdateRequestProperties.prototype['primaryKey'] = undefined;

/**
 * Scope like /products/{productId} or /apis or /apis/{apiId}
 * @member {String} scope
 */
SubscriptionUpdateRequestProperties.prototype['scope'] = undefined;

/**
 * Secondary subscription key.
 * @member {String} secondaryKey
 */
SubscriptionUpdateRequestProperties.prototype['secondaryKey'] = undefined;

/**
 * Subscription state. Possible states are * active – the subscription is active, * suspended – the subscription is blocked, and the subscriber cannot call any APIs of the product, * submitted – the subscription request has been made by the developer, but has not yet been approved or rejected, * rejected – the subscription request has been denied by an administrator, * cancelled – the subscription has been cancelled by the developer or administrator, * expired – the subscription reached its expiration date and was deactivated.
 * @member {module:model/SubscriptionUpdateRequestProperties.StateEnum} state
 */
SubscriptionUpdateRequestProperties.prototype['state'] = undefined;

/**
 * Comments describing subscription state change by the administrator.
 * @member {String} stateComment
 */
SubscriptionUpdateRequestProperties.prototype['stateComment'] = undefined;
 ...
 * @readonly
 */
SubscriptionUpdateRequestProperties['StateEnum'] = {
...
export default SubscriptionUpdateRequestProperties;
