...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionList200Response();
  });
  ...
  describe('SubscriptionList200Response', function() {
    it('should create an instance of SubscriptionList200Response', function() {
      // uncomment below and update the code to test SubscriptionList200Response
      //var instance = new ApiManagementClient.SubscriptionList200Response();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionList200Response);
    });
