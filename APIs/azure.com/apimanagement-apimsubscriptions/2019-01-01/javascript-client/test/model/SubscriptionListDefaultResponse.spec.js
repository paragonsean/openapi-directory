...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionListDefaultResponse();
  });
  ...
  describe('SubscriptionListDefaultResponse', function() {
    it('should create an instance of SubscriptionListDefaultResponse', function() {
      // uncomment below and update the code to test SubscriptionListDefaultResponse
      //var instance = new ApiManagementClient.SubscriptionListDefaultResponse();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionListDefaultResponse);
    });
