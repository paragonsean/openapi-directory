...
async def subscription_create_or_update(request: web.Request, resource_group_name, service_name, sid, api_version, subscription_id, parameters, notify=None, if_match=None, app_type=None) -> web.Response:
...
async def subscription_update(request: web.Request, resource_group_name, service_name, sid, if_match, api_version, subscription_id, parameters, notify=None, app_type=None) -> web.Response:
    """subscription_update
