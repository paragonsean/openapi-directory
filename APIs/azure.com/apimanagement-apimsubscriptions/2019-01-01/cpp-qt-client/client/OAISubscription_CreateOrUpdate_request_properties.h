...
/*
 * OAISubscription_CreateOrUpdate_request_properties.h
 *
 * Parameters supplied to the Create subscription operation.
 */

#ifndef OAISubscription_CreateOrUpdate_request_properties_H
#define OAISubscription_CreateOrUpdate_request_properties_H
...
class OAISubscription_CreateOrUpdate_request_properties : public OAIObject {
public:
    OAISubscription_CreateOrUpdate_request_properties();
    OAISubscription_CreateOrUpdate_request_properties(QString json);
    ~OAISubscription_CreateOrUpdate_request_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscription_CreateOrUpdate_request_properties)

#endif // OAISubscription_CreateOrUpdate_request_properties_H
