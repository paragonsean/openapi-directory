...
public class SubscriptionContract {
  ...
  public SubscriptionContract endDate(OffsetDateTime endDate) {
  ...
  public SubscriptionContract expirationDate(OffsetDateTime expirationDate) {
  ...
  public SubscriptionContract name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SubscriptionContract notificationDate(OffsetDateTime notificationDate) {
  ...
  public SubscriptionContract primaryKey(String primaryKey) {
  ...
  public SubscriptionContract productId(String productId) {
  ...
  public SubscriptionContract secondaryKey(String secondaryKey) {
  ...
  public SubscriptionContract startDate(OffsetDateTime startDate) {
  ...
  public SubscriptionContract state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public SubscriptionContract stateComment(String stateComment) {
  ...
  public SubscriptionContract userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdDate, subscriptionContract.createdDate) &&
        Objects.equals(this.endDate, subscriptionContract.endDate) &&
        Objects.equals(this.expirationDate, subscriptionContract.expirationDate) &&
        Objects.equals(this.id, subscriptionContract.id) &&
        Objects.equals(this.name, subscriptionContract.name) &&
        Objects.equals(this.notificationDate, subscriptionContract.notificationDate) &&
        Objects.equals(this.primaryKey, subscriptionContract.primaryKey) &&
        Objects.equals(this.productId, subscriptionContract.productId) &&
        Objects.equals(this.secondaryKey, subscriptionContract.secondaryKey) &&
        Objects.equals(this.startDate, subscriptionContract.startDate) &&
        Objects.equals(this.state, subscriptionContract.state) &&
        Objects.equals(this.stateComment, subscriptionContract.stateComment) &&
        Objects.equals(this.userId, subscriptionContract.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionContract {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubscriptionContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionContract is not found in the empty JSON string", SubscriptionContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscriptionContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionContract.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionContract>() {
           @Override
           public void write(JsonWriter out, SubscriptionContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscriptionContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubscriptionContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubscriptionContract
   * @throws IOException if the JSON string is invalid with respect to SubscriptionContract
   */
  public static SubscriptionContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionContract.class);
  }

  /**
   * Convert an instance of SubscriptionContract to an JSON string
   *
   * @return JSON string
   */
