...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.SubscriptionsListDefaultResponse();
  });
  ...
  describe('SubscriptionsListDefaultResponse', function() {
    it('should create an instance of SubscriptionsListDefaultResponse', function() {
      // uncomment below and update the code to test SubscriptionsListDefaultResponse
      //var instance = new ApiManagementClient.SubscriptionsListDefaultResponse();
      //expect(instance).to.be.a(ApiManagementClient.SubscriptionsListDefaultResponse);
    });
