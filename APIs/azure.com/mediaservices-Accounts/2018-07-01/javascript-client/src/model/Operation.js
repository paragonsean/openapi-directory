...
class Operation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = MetricProperties.constructFromObject(data['properties']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          MetricProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/MetricProperties} properties
 */
