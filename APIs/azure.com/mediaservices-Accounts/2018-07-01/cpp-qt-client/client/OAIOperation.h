...
public:
    ...
    OAIMetricProperties getProperties() const;
    void setProperties(const OAIMetricProperties &properties);
...
private:
    ...
    OAIMetricProperties m_properties;
