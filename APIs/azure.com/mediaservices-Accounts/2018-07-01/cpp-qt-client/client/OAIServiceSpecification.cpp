...
QList<OAIMetric> OAIServiceSpecification::getMetricSpecifications() const {
    return m_metric_specifications;
}
void OAIServiceSpecification::setMetricSpecifications(const QList<OAIMetric> &metric_specifications) {
