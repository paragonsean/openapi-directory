...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMediaServices.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureMediaServices.OperationDisplay();
      //expect(instance).to.be.a(AzureMediaServices.OperationDisplay);
    });
