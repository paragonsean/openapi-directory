...
async def recommendations_get_generate_recommendations_status(request: web.Request, subscription_id, operation_id, api_version) -> web.Response:
    """recommendations_get_generate_recommendations_status
