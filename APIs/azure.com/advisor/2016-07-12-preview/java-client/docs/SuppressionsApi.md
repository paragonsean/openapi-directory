...
# **suppressionsList**
> List&lt;SuppressionContract&gt; suppressionsList(subscriptionId, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The version of the API to be used with the client request.
    try {
      List<SuppressionContract> result = apiInstance.suppressionsList(subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
