...
QMap<QString, QString> OAIRecommendationProperties::getExtendedProperties() const {
    return m_extended_properties;
}
void OAIRecommendationProperties::setExtendedProperties(const QMap<QString, QString> &extended_properties) {
    m_extended_properties = extended_properties;
    m_extended_properties_isSet = true;
}

bool OAIRecommendationProperties::is_extended_properties_Set() const{
    return m_extended_properties_isSet;
}

bool OAIRecommendationProperties::is_extended_properties_Valid() const{
...
QList<QString> OAIRecommendationProperties::getSuppressionIds() const {
    return m_suppression_ids;
}
void OAIRecommendationProperties::setSuppressionIds(const QList<QString> &suppression_ids) {
    m_suppression_ids = suppression_ids;
    m_suppression_ids_isSet = true;
}

bool OAIRecommendationProperties::is_suppression_ids_Set() const{
    return m_suppression_ids_isSet;
}

bool OAIRecommendationProperties::is_suppression_ids_Valid() const{
