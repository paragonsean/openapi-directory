...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("recommendationMetadataGet", defaultConf);
    _serverIndices.insert("recommendationMetadataGet", 0);
    _serverConfigs.insert("recommendationMetadataList", defaultConf);
    _serverIndices.insert("recommendationMetadataList", 0);
}
...
void OAIMetadataApi::recommendationMetadataGet(const QString &name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["recommendationMetadataGet"][_serverIndices.value("recommendationMetadataGet")].URL()+"/providers/Microsoft.Advisor/metadata/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::recommendationMetadataGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::recommendationMetadataGetCallback);
...
void OAIMetadataApi::recommendationMetadataGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT recommendationMetadataGetSignal(output);
        Q_EMIT recommendationMetadataGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT recommendationMetadataGetSignalE(output, error_type, error_str);
        Q_EMIT recommendationMetadataGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT recommendationMetadataGetSignalError(output, error_type, error_str);
        Q_EMIT recommendationMetadataGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMetadataApi::recommendationMetadataList(const QString &api_version) {
    QString fullPath = QString(_serverConfigs["recommendationMetadataList"][_serverIndices.value("recommendationMetadataList")].URL()+"/providers/Microsoft.Advisor/metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::recommendationMetadataListCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::recommendationMetadataListCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::recommendationMetadataListCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT recommendationMetadataListSignal(output);
        Q_EMIT recommendationMetadataListSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT recommendationMetadataListSignalE(output, error_type, error_str);
        Q_EMIT recommendationMetadataListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT recommendationMetadataListSignalError(output, error_type, error_str);
        Q_EMIT recommendationMetadataListSignalErrorFull(worker, error_type, error_str);
    }
}
