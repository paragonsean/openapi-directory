...
export default class SuppressionsApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/SuppressionContractListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/SuppressionContractListResult}
     */
    suppressionsList(subscriptionId, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SuppressionContractListResult;
      return this.apiClient.callApi(
