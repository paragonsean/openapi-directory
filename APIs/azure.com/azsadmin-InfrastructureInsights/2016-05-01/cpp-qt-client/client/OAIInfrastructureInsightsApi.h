...
#ifndef OAI_OAIInfrastructureInsightsApi_H
#define OAI_OAIInfrastructureInsightsApi_H
...
class OAIInfrastructureInsightsApi : public QObject {
    Q_OBJECT

public:
    OAIInfrastructureInsightsApi(const int timeOut = 0);
    ~OAIInfrastructureInsightsApi();
