...
public class InfrastructureInsightsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public InfrastructureInsightsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public InfrastructureInsightsApi(ApiClient apiClient) {
    ...
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.InfrastructureInsights.Admin/operations";
