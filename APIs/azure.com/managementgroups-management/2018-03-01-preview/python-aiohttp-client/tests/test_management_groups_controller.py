...
async def test_management_groups_create_or_update(client):
    ...
    """
    create_management_group_request = {"name":"name","id":"id","type":"type","properties":{"children":[{"children":[null,null],"displayName":"displayName","roles":["roles","roles"],"name":"name","id":"id","type":"/providers/Microsoft.Management/managementGroups"},{"children":[null,null],"displayName":"displayName","roles":["roles","roles"],"name":"name","id":"id","type":"/providers/Microsoft.Management/managementGroups"}],"displayName":"displayName","roles":["roles","roles"],"tenantId":"tenantId","details":{"parent":{"displayName":"displayName","name":"name","id":"id"},"updatedTime":"2000-01-23T04:56:07.000+00:00","updatedBy":"updatedBy","version":0.8008281904610115}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
