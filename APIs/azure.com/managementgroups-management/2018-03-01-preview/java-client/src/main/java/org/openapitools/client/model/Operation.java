...
import org.openapitools.client.model.OperationDisplayProperties;
...
public class Operation {
  ...
  public Operation display(OperationDisplayProperties display) {
  ...
  public OperationDisplayProperties getDisplay() {
    return display;
  }

  public void setDisplay(OperationDisplayProperties display) {
    this.display = display;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("display") != null && !jsonObj.get("display").isJsonNull()) {
        OperationDisplayProperties.validateJsonElement(jsonObj.get("display"));
      }
