...
QString OAIManagementGroupChildInfo::getId() const {
    return m_id;
}
void OAIManagementGroupChildInfo::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIManagementGroupChildInfo::is_id_Set() const{
    return m_id_isSet;
}

bool OAIManagementGroupChildInfo::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIManagementGroupChildInfo::getName() const {
    return m_name;
}
void OAIManagementGroupChildInfo::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIManagementGroupChildInfo::is_name_Set() const{
    return m_name_isSet;
}

bool OAIManagementGroupChildInfo::is_name_Valid() const{
    return m_name_isValid;
}

QList<QString> OAIManagementGroupChildInfo::getRoles() const {
    return m_roles;
}
void OAIManagementGroupChildInfo::setRoles(const QList<QString> &roles) {
    m_roles = roles;
    m_roles_isSet = true;
}

bool OAIManagementGroupChildInfo::is_roles_Set() const{
    return m_roles_isSet;
}

bool OAIManagementGroupChildInfo::is_roles_Valid() const{
    return m_roles_isValid;
}

OAIManagementGroupChildType OAIManagementGroupChildInfo::getType() const {
    return m_type;
}
void OAIManagementGroupChildInfo::setType(const OAIManagementGroupChildType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIManagementGroupChildInfo::is_type_Set() const{
    return m_type_isSet;
}

bool OAIManagementGroupChildInfo::is_type_Valid() const{
