...
public class Example {
  public static void main(String[] args) {
    ...
    String cacheControl = "no-cache"; // String | Indicates that the request shouldn't utilize any caches.
    try {
      OperationResults result = apiInstance.managementGroupsDelete(groupId, apiVersion, cacheControl);
      System.out.println(result);
    } catch (ApiException e) {
...
# **managementGroupsGet**
> ManagementGroup managementGroupsGet(groupId, apiVersion, $expand, $recurse, $filter, cacheControl)
...
public class Example {
  public static void main(String[] args) {
    ...
    String groupId = "groupId_example"; // String | Management Group ID.
    String apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request. The current version is 2018-01-01-preview.
    String $expand = "children"; // String | The $expand=children query string parameter allows clients to request inclusion of children in the response payload.  $expand=path includes the path from the root group to the current group.
    Boolean $recurse = true; // Boolean | The $recurse=true query string parameter allows clients to request inclusion of entire hierarchy in the response payload. Note that  $expand=children must be passed up if $recurse is set to true.
    String $filter = "$filter_example"; // String | A filter which allows the exclusion of subscriptions from results (i.e. '$filter=children.childType ne Subscription')
    String cacheControl = "no-cache"; // String | Indicates that the request shouldn't utilize any caches.
    try {
      ManagementGroup result = apiInstance.managementGroupsGet(groupId, apiVersion, $expand, $recurse, $filter, cacheControl);
      System.out.println(result);
    } catch (ApiException e) {
...
| **groupId** | **String**| Management Group ID. | |
| **apiVersion** | **String**| Version of the API to be used with the client request. The current version is 2018-01-01-preview. | |
| **$expand** | **String**| The $expand&#x3D;children query string parameter allows clients to request inclusion of children in the response payload.  $expand&#x3D;path includes the path from the root group to the current group. | [optional] [enum: children, path] |
...
> ManagementGroup managementGroupsUpdate(groupId, apiVersion, patchGroupRequest, cacheControl)
...
public class Example {
  public static void main(String[] args) {
    ...
    String groupId = "groupId_example"; // String | Management Group ID.
    String apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request. The current version is 2018-01-01-preview.
    PatchManagementGroupRequest patchGroupRequest = new PatchManagementGroupRequest(); // PatchManagementGroupRequest | Management group patch parameters.
    String cacheControl = "no-cache"; // String | Indicates that the request shouldn't utilize any caches.
    try {
      ManagementGroup result = apiInstance.managementGroupsUpdate(groupId, apiVersion, patchGroupRequest, cacheControl);
      System.out.println(result);
    } catch (ApiException e) {
