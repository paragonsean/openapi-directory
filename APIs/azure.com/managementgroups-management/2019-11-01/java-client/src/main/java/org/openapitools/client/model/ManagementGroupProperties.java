...
public class ManagementGroupProperties {
  ...
  public ManagementGroupProperties path(List<ManagementGroupPathElement> path) {
    this.path = path;
    return this;
  }

  public ManagementGroupProperties addPathItem(ManagementGroupPathElement pathItem) {
    if (this.path == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ManagementGroupPathElement> getPath() {
    return path;
  }

  public void setPath(List<ManagementGroupPathElement> path) {
    this.path = path;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.children, managementGroupProperties.children) &&
        ...
        Objects.equals(this.path, managementGroupProperties.path) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(children, details, displayName, path, roles, tenantId);
  }
      ...
      if (jsonObj.get("path") != null && !jsonObj.get("path").isJsonNull()) {
        ...
        if (jsonArraypath != null) {
          ...
          for (int i = 0; i < jsonArraypath.size(); i++) {
            ManagementGroupPathElement.validateJsonElement(jsonArraypath.get(i));
          };
        }
      }
