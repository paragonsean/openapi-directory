...
export default class ManagementGroupsApi {
    ...
    */
     ...
     * @param {String} apiVersion Version of the API to be used with the client request. The current version is 2018-01-01-preview.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [expand] The $expand=children query string parameter allows clients to request inclusion of children in the response payload.  $expand=path includes the path from the root group to the current group.
