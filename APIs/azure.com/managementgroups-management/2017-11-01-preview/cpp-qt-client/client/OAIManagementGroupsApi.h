...
public:
    ...
    * @param[in]  cache_control QString [optional]
    */
    virtual void managementGroupsGet(const QString &group_id, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &recurse = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &cache_control = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  cache_control QString [optional]
    */
    virtual void managementGroupsUpdate(const QString &group_id, const QString &api_version, const OAICreateManagementGroupRequest &create_management_group_request, const ::OpenAPI::OptionalParam<QString> &cache_control = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void managementGroupsDeleteSignal();
    ...
    void managementGroupsDeleteSignalFull(OAIHttpRequestWorker *worker);
    ...
    void managementGroupsDeleteSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void managementGroupsDeleteSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
