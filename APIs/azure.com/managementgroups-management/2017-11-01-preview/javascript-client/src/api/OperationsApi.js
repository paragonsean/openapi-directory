...
export default class OperationsApi {
    ...
    */
     ...
     * @param {String} apiVersion Version of the API to be used with the client request. The current version is 2017-11-01-preview.
    ...
    operationsList(apiVersion, callback) {
      ...
      return this.apiClient.callApi(
        '/providers/Microsoft.Management/operations', 'GET',
