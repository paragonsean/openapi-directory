...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementGroups.EntitiesApi();
  });
  ...
  describe('EntitiesApi', function() {
    describe('entitiesList', function() {
      it('should call entitiesList successfully', function(done) {
        //uncomment below and update the code to test entitiesList
        //instance.entitiesList(function(error) {
