...
------------ | ------------- | ------------- | -------------
**children** | [**[ManagementGroupChildInfo]**](ManagementGroupChildInfo.md) | The list of children. | [optional] 
...
**roles** | **[String]** | The role definitions associated with the management group. | [optional] 
