...
async def management_groups_get(request: web.Request, group_id, api_version, expand=None, recurse=None, filter=None, cache_control=None) -> web.Response:
...
async def management_groups_update(request: web.Request, group_id, api_version, patch_group_request, cache_control=None) -> web.Response:
    ...
    :type patch_group_request: dict | bytes
    :param cache_control: Indicates that the request shouldn&#39;t utilize any caches.
    :type cache_control: str

    """
    patch_group_request = PatchManagementGroupRequest.from_dict(patch_group_request)
    return web.Response(status=200)
