...
|**reason** | [**ReasonEnum**](#ReasonEnum) | Required if nameAvailable &#x3D;&#x3D; false. Invalid indicates the name provided does not match the resource provider&#39;s naming requirements (incorrect length, unsupported characters, etc.) AlreadyExists indicates that the name is already in use and is therefore unavailable. |  [optional] [readonly] |
