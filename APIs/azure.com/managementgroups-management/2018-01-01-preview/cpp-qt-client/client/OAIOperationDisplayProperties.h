...
/*
 * OAIOperationDisplayProperties.h
 *
 * The object that represents the operation.
 */

#ifndef OAIOperationDisplayProperties_H
#define OAIOperationDisplayProperties_H
...
class OAIOperationDisplayProperties : public OAIObject {
public:
    OAIOperationDisplayProperties();
    OAIOperationDisplayProperties(QString json);
    ~OAIOperationDisplayProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOperationDisplayProperties)

#endif // OAIOperationDisplayProperties_H
