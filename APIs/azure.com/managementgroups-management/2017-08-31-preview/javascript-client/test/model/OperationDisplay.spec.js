...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementGroups.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ManagementGroups.OperationDisplay();
      //expect(instance).to.be.a(ManagementGroups.OperationDisplay);
    });
