...
export default class QuotasApi {
    ...
    */
     ...
     * @param {module:model/QuotasGet200Response} data The data returned by the service call.
     ...
     * @param {module:model/QuotasGet200Response} newQuota New quota to create.
     ...
     * data is of type: {@link module:model/QuotasGet200Response}
     */
    quotasCreateOrUpdate(subscriptionId, location, quotaName, apiVersion, newQuota, callback) {
      ...
      let returnType = QuotasGet200Response;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/QuotasList200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/QuotasList200Response}
     */
    quotasList(subscriptionId, location, apiVersion, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = QuotasList200Response;
      return this.apiClient.callApi(
