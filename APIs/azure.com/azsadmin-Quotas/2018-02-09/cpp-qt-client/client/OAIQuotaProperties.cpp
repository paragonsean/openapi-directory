...
qint32 OAIQuotaProperties::getMaxAllocationPremiumManagedDisksAndSnapshots() const {
    return m_max_allocation_premium_managed_disks_and_snapshots;
}
void OAIQuotaProperties::setMaxAllocationPremiumManagedDisksAndSnapshots(const qint32 &max_allocation_premium_managed_disks_and_snapshots) {
...
bool OAIQuotaProperties::is_max_allocation_premium_managed_disks_and_snapshots_Set() const{
    return m_max_allocation_premium_managed_disks_and_snapshots_isSet;
}

bool OAIQuotaProperties::is_max_allocation_premium_managed_disks_and_snapshots_Valid() const{
    return m_max_allocation_premium_managed_disks_and_snapshots_isValid;
}

qint32 OAIQuotaProperties::getMaxAllocationStandardManagedDisksAndSnapshots() const {
    return m_max_allocation_standard_managed_disks_and_snapshots;
}
void OAIQuotaProperties::setMaxAllocationStandardManagedDisksAndSnapshots(const qint32 &max_allocation_standard_managed_disks_and_snapshots) {
...
bool OAIQuotaProperties::is_max_allocation_standard_managed_disks_and_snapshots_Set() const{
    return m_max_allocation_standard_managed_disks_and_snapshots_isSet;
}

bool OAIQuotaProperties::is_max_allocation_standard_managed_disks_and_snapshots_Valid() const{
