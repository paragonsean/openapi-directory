...
class QuotaProperties(Model):
    ...
    def __init__(self, availability_set_count: int=None, cores_limit: int=None, max_allocation_premium_managed_disks_and_snapshots: int=None, max_allocation_standard_managed_disks_and_snapshots: int=None, virtual_machine_count: int=None, vm_scale_set_count: int=None):
        ...
        :param max_allocation_premium_managed_disks_and_snapshots: The max_allocation_premium_managed_disks_and_snapshots of this QuotaProperties.
        :param max_allocation_standard_managed_disks_and_snapshots: The max_allocation_standard_managed_disks_and_snapshots of this QuotaProperties.
    ...
    def max_allocation_premium_managed_disks_and_snapshots(self):
        """Gets the max_allocation_premium_managed_disks_and_snapshots of this QuotaProperties.

        Maximum number of managed disks and snapshots of type premium allowed.

        :return: The max_allocation_premium_managed_disks_and_snapshots of this QuotaProperties.
        :rtype: int
        """
    ...
    def max_allocation_premium_managed_disks_and_snapshots(self, max_allocation_premium_managed_disks_and_snapshots):
        """Sets the max_allocation_premium_managed_disks_and_snapshots of this QuotaProperties.
    ...
    def max_allocation_standard_managed_disks_and_snapshots(self):
        """Gets the max_allocation_standard_managed_disks_and_snapshots of this QuotaProperties.

        Maximum number of managed disks and snapshots of type standard allowed.

        :return: The max_allocation_standard_managed_disks_and_snapshots of this QuotaProperties.
        :rtype: int
        """
    ...
    def max_allocation_standard_managed_disks_and_snapshots(self, max_allocation_standard_managed_disks_and_snapshots):
        """Sets the max_allocation_standard_managed_disks_and_snapshots of this QuotaProperties.
