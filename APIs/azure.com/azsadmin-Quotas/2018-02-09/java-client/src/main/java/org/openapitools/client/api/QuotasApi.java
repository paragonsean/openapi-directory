...
public class QuotasApi {
     ...
     */
    public okhttp3.Call quotasCreateOrUpdateCall(String subscriptionId, String location, String quotaName, String apiVersion, QuotasGet200Response newQuota, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call quotasCreateOrUpdateValidateBeforeCall(String subscriptionId, String location, String quotaName, String apiVersion, QuotasGet200Response newQuota, final ApiCallback _callback) throws ApiException {
     ...
     */
    public QuotasGet200Response quotasCreateOrUpdate(String subscriptionId, String location, String quotaName, String apiVersion, QuotasGet200Response newQuota) throws ApiException {
        ApiResponse<QuotasGet200Response> localVarResp = quotasCreateOrUpdateWithHttpInfo(subscriptionId, location, quotaName, apiVersion, newQuota);
     ...
     * @param apiVersion Client API Version. (required)
     * @param newQuota New quota to create. (required)
     * @return ApiResponse&lt;QuotasGet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<QuotasGet200Response> quotasCreateOrUpdateWithHttpInfo(String subscriptionId, String location, String quotaName, String apiVersion, QuotasGet200Response newQuota) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<QuotasGet200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Creates or Updates a Compute Quota. (asynchronously)
     * Creates or Updates a Compute Quota with the provided quota parameters.
     * @param subscriptionId Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param location Location of the resource. (required)
     * @param quotaName Name of the quota. (required)
     ...
     */
    public okhttp3.Call quotasCreateOrUpdateAsync(String subscriptionId, String location, String quotaName, String apiVersion, QuotasGet200Response newQuota, final ApiCallback<QuotasGet200Response> _callback) throws ApiException {
    ...
    /**
     * Deletes specified Compute quota (asynchronously)
     * Delete an existing Compute quota.
     * @param subscriptionId Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param location Location of the resource. (required)
     * @param quotaName Name of the quota. (required)
     ...
     */
    public QuotasGet200Response quotasGet(String subscriptionId, String location, String quotaName, String apiVersion) throws ApiException {
        ApiResponse<QuotasGet200Response> localVarResp = quotasGetWithHttpInfo(subscriptionId, location, quotaName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<QuotasGet200Response> quotasGetWithHttpInfo(String subscriptionId, String location, String quotaName, String apiVersion) throws ApiException {
    ...
    /**
     * Returns the requested Compute quota. (asynchronously)
     * Get an existing Compute Quota.
     * @param subscriptionId Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param location Location of the resource. (required)
     * @param quotaName Name of the quota. (required)
     ...
     */
    public okhttp3.Call quotasGetAsync(String subscriptionId, String location, String quotaName, String apiVersion, final ApiCallback<QuotasGet200Response> _callback) throws ApiException {
     ...
     */
    public QuotasList200Response quotasList(String subscriptionId, String location, String apiVersion) throws ApiException {
        ApiResponse<QuotasList200Response> localVarResp = quotasListWithHttpInfo(subscriptionId, location, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param location Location of the resource. (required)
     * @param apiVersion Client API Version. (required)
     * @return ApiResponse&lt;QuotasList200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<QuotasList200Response> quotasListWithHttpInfo(String subscriptionId, String location, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = quotasListValidateBeforeCall(subscriptionId, location, apiVersion, null);
        Type localVarReturnType = new TypeToken<QuotasList200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Lists all Compute quotas. (asynchronously)
     * Get a list of existing Compute quotas.
     * @param subscriptionId Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param location Location of the resource. (required)
     * @param apiVersion Client API Version. (required)
     ...
     */
    public okhttp3.Call quotasListAsync(String subscriptionId, String location, String apiVersion, final ApiCallback<QuotasList200Response> _callback) throws ApiException {
