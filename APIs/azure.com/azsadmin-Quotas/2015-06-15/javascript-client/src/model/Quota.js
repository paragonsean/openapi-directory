...
class Quota {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = QuotaProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          QuotaProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/QuotaProperties} properties
 */
 ...
 */
Quota.prototype['tags'] = undefined;
