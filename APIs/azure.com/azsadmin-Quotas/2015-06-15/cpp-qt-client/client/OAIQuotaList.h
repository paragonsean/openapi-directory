...
#ifndef OAIQuotaList_H
#define OAIQuotaList_H
...
class OAIQuotaList : public OAIObject {
public:
    OAIQuotaList();
    OAIQuotaList(QString json);
    ~OAIQuotaList() override;
    ...
    QList<OAIQuota> getValue() const;
    void setValue(const QList<OAIQuota> &value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuotaList)

#endif // OAIQuotaList_H
