...
- API version: 2017-02-01-preview
  - Build date: 2024-10-12T11:08:22.789215-04:00[America/New_York]
...
<dependency>
  ...
  <version>2017-02-01-preview</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2017-02-01-preview"
  }
```
...
* `target/openapi-java-client-2017-02-01-preview.jar`
* `target/lib/*.jar`
...
------------ | ------------- | ------------- | -------------
*KeyVaultApi* | [**quotasList**](docs/KeyVaultApi.md#quotasList) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.KeyVault.Admin/locations/{location}/quotas | 
