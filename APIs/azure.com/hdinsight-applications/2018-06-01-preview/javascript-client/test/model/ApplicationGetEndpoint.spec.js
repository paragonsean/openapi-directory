...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.ApplicationGetEndpoint();
  });
  ...
  describe('ApplicationGetEndpoint', function() {
    it('should create an instance of ApplicationGetEndpoint', function() {
      // uncomment below and update the code to test ApplicationGetEndpoint
      //var instance = new HdInsightManagementClient.ApplicationGetEndpoint();
      //expect(instance).to.be.a(HdInsightManagementClient.ApplicationGetEndpoint);
    });
