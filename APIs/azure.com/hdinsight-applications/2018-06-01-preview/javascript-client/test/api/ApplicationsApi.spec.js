...
(function(root, factory) {
  ...
  describe('ApplicationsApi', function() {
    ...
    describe('applicationsListByCluster', function() {
      it('should call applicationsListByCluster successfully', function(done) {
        //uncomment below and update the code to test applicationsListByCluster
        //instance.applicationsListByCluster(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
