...
import DataMaskingPolicyProperties from './DataMaskingPolicyProperties';
...
class DataMaskingPolicy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = DataMaskingPolicyProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          DataMaskingPolicyProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} kind
 */
DataMaskingPolicy.prototype['kind'] = undefined;

/**
 * The location of the data masking policy.
 * @member {String} location
 */
DataMaskingPolicy.prototype['location'] = undefined;

/**
 * @member {module:model/DataMaskingPolicyProperties} properties
 */
DataMaskingPolicy.prototype['properties'] = undefined;

/**
 * Resource ID.
 * @member {String} id
 */
DataMaskingPolicy.prototype['id'] = undefined;

/**
 * Resource name.
 * @member {String} name
 */
DataMaskingPolicy.prototype['name'] = undefined;

/**
 * Resource type.
 * @member {String} type
 */
DataMaskingPolicy.prototype['type'] = undefined;
