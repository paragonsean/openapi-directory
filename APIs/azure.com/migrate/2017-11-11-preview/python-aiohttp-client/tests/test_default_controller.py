...
async def test_assessments_create(client):
    ...
    """
    assessment = {"name":"name","eTag":"eTag","id":"id","type":"type","properties":{"createdTimestamp":"2000-01-23T04:56:07.000+00:00","scalingFactor":2.3021358869347655,"pricesTimestamp":"2000-01-23T04:56:07.000+00:00","updatedTimestamp":"2000-01-23T04:56:07.000+00:00","azureStorageRedundancy":"Unknown","discountPercentage":0.8008281904610115,"azurePricingTier":"Standard","percentile":"Percentile50","azureOfferCode":"Unknown","stage":"InProgress","numberOfMachines":5,"azureLocation":"Unknown","currency":"Unknown","monthlyBandwidthCost":6.027456183070403,"azureHybridUseBenefit":"Unknown","monthlyComputeCost":1.4658129805029452,"monthlyStorageCost":5.962133916683182,"status":"Created","timeRange":"Day"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_projects_create(client):
    ...
    """
    project = {"name":"name","eTag":"eTag","location":"location","id":"id","type":"type","properties":{"numberOfAssessments":0,"numberOfMachines":1,"createdTimestamp":"2000-01-23T04:56:07.000+00:00","discoveryStatus":"Unknown","numberOfGroups":6,"provisioningState":"Accepted","customerWorkspaceId":"customerWorkspaceId","updatedTimestamp":"2000-01-23T04:56:07.000+00:00"},"tags":"{}"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
