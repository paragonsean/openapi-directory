...
class AssessmentProperties(Model):
    ...
    def __init__(self, azure_hybrid_use_benefit: str=None, azure_location: str=None, azure_offer_code: str=None, azure_pricing_tier: str=None, azure_storage_redundancy: str=None, created_timestamp: datetime=None, currency: str=None, discount_percentage: float=None, monthly_bandwidth_cost: float=None, monthly_compute_cost: float=None, monthly_storage_cost: float=None, number_of_machines: int=None, percentile: str=None, prices_timestamp: datetime=None, scaling_factor: float=None, stage: str=None, status: str=None, time_range: str=None, updated_timestamp: datetime=None):
    ...
    def azure_offer_code(self, azure_offer_code):
        ...
        """
        allowed_values = ["Unknown", "MSAZR0003P", "MSAZR0044P", "MSAZR0059P", "MSAZR0060P", "MSAZR0062P", "MSAZR0063P", "MSAZR0064P", "MSAZR0029P", "MSAZR0022P", "MSAZR0023P", "MSAZR0148P", "MSAZR0025P", "MSAZR0036P", "MSAZR0120P", "MSAZR0121P", "MSAZR0122P", "MSAZR0123P", "MSAZR0124P", "MSAZR0125P", "MSAZR0126P", "MSAZR0127P", "MSAZR0128P", "MSAZR0129P", "MSAZR0130P", "MSAZR0111P", "MSAZR0144P", "MSAZR0149P"]  # noqa: E501
    ...
    def currency(self, currency):
        ...
        :type currency: str
        """
        allowed_values = ["Unknown", "USD", "DKK", "CAD", "IDR", "JPY", "KRW", "NZD", "NOK", "RUB", "SAR", "ZAR", "SEK", "TRY", "GBP", "MXN", "MYR", "INR", "HKD", "BRL", "TWD", "EUR", "CHF", "ARS", "AUD"]  # noqa: E501
