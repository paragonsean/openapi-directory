...
class ProjectProperties(Model):
    ...
    def __init__(self, created_timestamp: datetime=None, customer_workspace_id: str=None, discovery_status: str=None, number_of_assessments: int=None, number_of_groups: int=None, number_of_machines: int=None, provisioning_state: str=None, updated_timestamp: datetime=None):
