...
void OAIGroup::setETag(const QString &e_tag) {
    m_e_tag = e_tag;
    m_e_tag_isSet = true;
}

bool OAIGroup::is_e_tag_Set() const{
    return m_e_tag_isSet;
}

bool OAIGroup::is_e_tag_Valid() const{
...
OAIGroupProperties OAIGroup::getProperties() const {
    return m_properties;
}
void OAIGroup::setProperties(const OAIGroupProperties &properties) {
