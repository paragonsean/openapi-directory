...
public class AssessmentProperties {
   ...
   */
  @JsonAdapter(AzureDiskTypeEnum.Adapter.class)
  public enum AzureDiskTypeEnum {
    UNKNOWN("Unknown"),
    ...
    AzureDiskTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static AzureDiskTypeEnum fromValue(String value) {
      for (AzureDiskTypeEnum b : AzureDiskTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<AzureDiskTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AzureDiskTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AzureDiskTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AzureDiskTypeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      AzureDiskTypeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_AZURE_DISK_TYPE = "azureDiskType";
  @SerializedName(SERIALIZED_NAME_AZURE_DISK_TYPE)
  private AzureDiskTypeEnum azureDiskType;
   ...
   * Azure VM family.
   */
  @JsonAdapter(AzureVmFamiliesEnum.Adapter.class)
  public enum AzureVmFamiliesEnum {
    UNKNOWN("Unknown"),
    ...
    AzureVmFamiliesEnum(String value) {
      this.value = value;
    }
    ...
    public static AzureVmFamiliesEnum fromValue(String value) {
      for (AzureVmFamiliesEnum b : AzureVmFamiliesEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<AzureVmFamiliesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AzureVmFamiliesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AzureVmFamiliesEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AzureVmFamiliesEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      AzureVmFamiliesEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_AZURE_VM_FAMILIES = "azureVmFamilies";
  @SerializedName(SERIALIZED_NAME_AZURE_VM_FAMILIES)
  private List<AzureVmFamiliesEnum> azureVmFamilies = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_EA_SUBSCRIPTION_ID = "eaSubscriptionId";
  @SerializedName(SERIALIZED_NAME_EA_SUBSCRIPTION_ID)
  ...
  public static final String SERIALIZED_NAME_PERF_DATA_END_TIME = "perfDataEndTime";
  @SerializedName(SERIALIZED_NAME_PERF_DATA_END_TIME)
  private OffsetDateTime perfDataEndTime;

  public static final String SERIALIZED_NAME_PERF_DATA_START_TIME = "perfDataStartTime";
  @SerializedName(SERIALIZED_NAME_PERF_DATA_START_TIME)
   ...
   */
  @JsonAdapter(ReservedInstanceEnum.Adapter.class)
  public enum ReservedInstanceEnum {
    NONE("None"),
    ...
    ReservedInstanceEnum(String value) {
      this.value = value;
    }
    ...
    public static ReservedInstanceEnum fromValue(String value) {
      for (ReservedInstanceEnum b : ReservedInstanceEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ReservedInstanceEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ReservedInstanceEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ReservedInstanceEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ReservedInstanceEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ReservedInstanceEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_RESERVED_INSTANCE = "reservedInstance";
  @SerializedName(SERIALIZED_NAME_RESERVED_INSTANCE)
  private ReservedInstanceEnum reservedInstance;
  ...
  public static final String SERIALIZED_NAME_VM_UPTIME = "vmUptime";
  @SerializedName(SERIALIZED_NAME_VM_UPTIME)
  ...
  public AssessmentProperties(
     ...
     OffsetDateTime perfDataEndTime, 
     OffsetDateTime perfDataStartTime, 
  ...
  public AssessmentProperties azureDiskType(AzureDiskTypeEnum azureDiskType) {
  ...
  public AzureDiskTypeEnum getAzureDiskType() {
    return azureDiskType;
  }

  public void setAzureDiskType(AzureDiskTypeEnum azureDiskType) {
    this.azureDiskType = azureDiskType;
  }
  ...
  public AssessmentProperties azureVmFamilies(List<AzureVmFamiliesEnum> azureVmFamilies) {
    this.azureVmFamilies = azureVmFamilies;
    return this;
  }

  public AssessmentProperties addAzureVmFamiliesItem(AzureVmFamiliesEnum azureVmFamiliesItem) {
    if (this.azureVmFamilies == null) {
      this.azureVmFamilies = new ArrayList<>();
    }
    this.azureVmFamilies.add(azureVmFamiliesItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public List<AzureVmFamiliesEnum> getAzureVmFamilies() {
    return azureVmFamilies;
  }

  public void setAzureVmFamilies(List<AzureVmFamiliesEnum> azureVmFamilies) {
    this.azureVmFamilies = azureVmFamilies;
  }
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getPerfDataEndTime() {
    return perfDataEndTime;
  }
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getPerfDataStartTime() {
    return perfDataStartTime;
  }
  ...
  public AssessmentProperties reservedInstance(ReservedInstanceEnum reservedInstance) {
   ...
   */
  @javax.annotation.Nonnull
  public ReservedInstanceEnum getReservedInstance() {
    return reservedInstance;
  }

  public void setReservedInstance(ReservedInstanceEnum reservedInstance) {
    this.reservedInstance = reservedInstance;
  }
  ...
  public AssessmentProperties vmUptime(VmUptime vmUptime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.azureDiskType, assessmentProperties.azureDiskType) &&
        Objects.equals(this.azureHybridUseBenefit, assessmentProperties.azureHybridUseBenefit) &&
        ...
        Objects.equals(this.azureVmFamilies, assessmentProperties.azureVmFamilies) &&
        ...
        Objects.equals(this.eaSubscriptionId, assessmentProperties.eaSubscriptionId) &&
        ...
        Objects.equals(this.monthlyPremiumStorageCost, assessmentProperties.monthlyPremiumStorageCost) &&
        Objects.equals(this.monthlyStandardSSDStorageCost, assessmentProperties.monthlyStandardSSDStorageCost) &&
        ...
        Objects.equals(this.perfDataEndTime, assessmentProperties.perfDataEndTime) &&
        Objects.equals(this.perfDataStartTime, assessmentProperties.perfDataStartTime) &&
        Objects.equals(this.pricesTimestamp, assessmentProperties.pricesTimestamp) &&
        Objects.equals(this.reservedInstance, assessmentProperties.reservedInstance) &&
        ...
        Objects.equals(this.vmUptime, assessmentProperties.vmUptime);
  }
  ...
  public String toString() {
    ...
    sb.append("    azureDiskType: ").append(toIndentedString(azureDiskType)).append("\n");
    ...
    sb.append("    azureVmFamilies: ").append(toIndentedString(azureVmFamilies)).append("\n");
    ...
    sb.append("    eaSubscriptionId: ").append(toIndentedString(eaSubscriptionId)).append("\n");
    ...
    sb.append("    perfDataEndTime: ").append(toIndentedString(perfDataEndTime)).append("\n");
    sb.append("    perfDataStartTime: ").append(toIndentedString(perfDataStartTime)).append("\n");
    sb.append("    pricesTimestamp: ").append(toIndentedString(pricesTimestamp)).append("\n");
    sb.append("    reservedInstance: ").append(toIndentedString(reservedInstance)).append("\n");
    ...
    sb.append("    vmUptime: ").append(toIndentedString(vmUptime)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("azureDiskType");
    ...
    openapiFields.add("azureVmFamilies");
    ...
    openapiFields.add("eaSubscriptionId");
    ...
    openapiFields.add("perfDataEndTime");
    openapiFields.add("perfDataStartTime");
    openapiFields.add("pricesTimestamp");
    openapiFields.add("reservedInstance");
    ...
    openapiFields.add("vmUptime");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("azureDiskType");
    ...
    openapiRequiredFields.add("vmUptime");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("azureDiskType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `azureDiskType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("azureDiskType").toString()));
      }
      // validate the required field `azureDiskType`
      AzureDiskTypeEnum.validateJsonElement(jsonObj.get("azureDiskType"));
      ...
      if (jsonObj.get("azureVmFamilies") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("azureVmFamilies").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `azureVmFamilies` to be an array in the JSON string but got `%s`", jsonObj.get("azureVmFamilies").toString()));
      }
      ...
      if ((jsonObj.get("eaSubscriptionId") != null && !jsonObj.get("eaSubscriptionId").isJsonNull()) && !jsonObj.get("eaSubscriptionId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `eaSubscriptionId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eaSubscriptionId").toString()));
      }
      ...
      if (!jsonObj.get("reservedInstance").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reservedInstance` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reservedInstance").toString()));
      }
      // validate the required field `reservedInstance`
      ReservedInstanceEnum.validateJsonElement(jsonObj.get("reservedInstance"));
      ...
      // validate the required field `vmUptime`
      VmUptime.validateJsonElement(jsonObj.get("vmUptime"));
  }
