...
class NetworkAdapter(Model):
    ...
    def __init__(self, display_name: str=None, ip_addresses: List[str]=None, mac_address: str=None):
        """NetworkAdapter - a model defined in OpenAPI

        :param display_name: The display_name of this NetworkAdapter.
    ...
    def display_name(self):
        """Gets the display_name of this NetworkAdapter.

        User friendly name of the network adapter.

        :return: The display_name of this NetworkAdapter.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this NetworkAdapter.
