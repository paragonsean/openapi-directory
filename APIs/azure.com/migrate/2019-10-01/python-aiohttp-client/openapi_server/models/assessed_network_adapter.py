...
class AssessedNetworkAdapter(Model):
    ...
    def __init__(self, display_name: str=None, ip_addresses: List[str]=None, mac_address: str=None, megabytes_per_second_received: float=None, megabytes_per_second_transmitted: float=None, monthly_bandwidth_costs: float=None, net_gigabytes_transmitted_per_month: float=None, suitability: str=None, suitability_detail: str=None, suitability_explanation: str=None):
        """AssessedNetworkAdapter - a model defined in OpenAPI

        :param display_name: The display_name of this AssessedNetworkAdapter.
        ...
        :param suitability_detail: The suitability_detail of this AssessedNetworkAdapter.
    ...
    def display_name(self):
        """Gets the display_name of this AssessedNetworkAdapter.

        User friendly name of the assessed network adapter.

        :return: The display_name of this AssessedNetworkAdapter.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this AssessedNetworkAdapter.
    ...
    def suitability_detail(self):
        """Gets the suitability_detail of this AssessedNetworkAdapter.

        If network adapter is not suitable for cloud, this explains the reasons.

        :return: The suitability_detail of this AssessedNetworkAdapter.
        :rtype: str
        """
    ...
    def suitability_detail(self, suitability_detail):
        """Sets the suitability_detail of this AssessedNetworkAdapter.
        ...
        """
        allowed_values = ["None", "MegabytesOfDataTransmittedMissing", "MegabytesOfDataTransmittedOutOfRange"]  # noqa: E501
    ...
    def suitability_explanation(self, suitability_explanation):
        ...
        """
        allowed_values = ["Unknown", "NotApplicable", "InternalErrorOccurred"]  # noqa: E501
