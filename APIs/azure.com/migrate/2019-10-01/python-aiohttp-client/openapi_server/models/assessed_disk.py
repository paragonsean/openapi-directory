...
class AssessedDisk(Model):
    ...
    def __init__(self, display_name: str=None, gigabytes_for_recommended_disk_size: int=None, gigabytes_provisioned: float=None, megabytes_per_second_of_read: float=None, megabytes_per_second_of_write: float=None, monthly_storage_cost: float=None, name: str=None, number_of_read_operations_per_second: float=None, number_of_write_operations_per_second: float=None, recommended_disk_size: str=None, recommended_disk_type: str=None, suitability: str=None, suitability_detail: str=None, suitability_explanation: str=None):
        """AssessedDisk - a model defined in OpenAPI

        :param display_name: The display_name of this AssessedDisk.
        ...
        :param suitability_detail: The suitability_detail of this AssessedDisk.
    ...
    def display_name(self):
        """Gets the display_name of this AssessedDisk.

        User friendly name of the assessed disk.

        :return: The display_name of this AssessedDisk.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this AssessedDisk.
    ...
    def suitability_detail(self):
        """Gets the suitability_detail of this AssessedDisk.
        ...
        :return: The suitability_detail of this AssessedDisk.
        :rtype: str
        """
    ...
    def suitability_detail(self, suitability_detail):
        """Sets the suitability_detail of this AssessedDisk.
    ...
    def suitability_explanation(self, suitability_explanation):
        ...
        """
        allowed_values = ["Unknown", "NotApplicable", "DiskSizeGreaterThanSupported", "NoSuitableDiskSizeForIops", "NoSuitableDiskSizeForThroughput", "NoDiskSizeFoundInSelectedLocation", "NoDiskSizeFoundForSelectedRedundancy", "InternalErrorOccurredForDiskEvaluation", "NoEaPriceFoundForDiskSize"]  # noqa: E501
