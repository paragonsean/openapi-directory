...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMigrateV2.GroupBodyProperties();
  });
  ...
  describe('GroupBodyProperties', function() {
    it('should create an instance of GroupBodyProperties', function() {
      // uncomment below and update the code to test GroupBodyProperties
      //var instance = new AzureMigrateV2.GroupBodyProperties();
      //expect(instance).to.be.a(AzureMigrateV2.GroupBodyProperties);
    });
