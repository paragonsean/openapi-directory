...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMigrateV2.DownloadUrl();
  });
  ...
  describe('DownloadUrl', function() {
    it('should create an instance of DownloadUrl', function() {
      ...
      //var instance = new AzureMigrateV2.DownloadUrl();
      //expect(instance).to.be.a(AzureMigrateV2.DownloadUrl);
    });

    it('should have the property assessmentReportUrl (base name: "assessmentReportUrl")', function() {
      // uncomment below and update the code to test the property assessmentReportUrl
      //var instance = new AzureMigrateV2.DownloadUrl();
