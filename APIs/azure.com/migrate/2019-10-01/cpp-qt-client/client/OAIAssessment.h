...
public:
    ...
    OAIAssessmentProperties getProperties() const;
    void setProperties(const OAIAssessmentProperties &properties);
...
private:
    ...
    OAIAssessmentProperties m_properties;
