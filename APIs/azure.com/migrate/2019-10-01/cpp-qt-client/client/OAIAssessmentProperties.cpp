...
void OAIAssessmentProperties::initializeModel() {
    ...
    m_azure_disk_type_isSet = false;
    m_azure_disk_type_isValid = false;
    ...
    m_azure_vm_families_isSet = false;
    m_azure_vm_families_isValid = false;
    ...
    m_ea_subscription_id_isSet = false;
    m_ea_subscription_id_isValid = false;
    ...
    m_perf_data_end_time_isSet = false;
    m_perf_data_end_time_isValid = false;

    m_perf_data_start_time_isSet = false;
    m_perf_data_start_time_isValid = false;

    m_prices_timestamp_isSet = false;
    m_prices_timestamp_isValid = false;

    m_reserved_instance_isSet = false;
    m_reserved_instance_isValid = false;
    ...
    m_vm_uptime_isSet = false;
    m_vm_uptime_isValid = false;
}
...
void OAIAssessmentProperties::fromJsonObject(QJsonObject json) {
    ...
    m_azure_disk_type_isValid = ::OpenAPI::fromJsonValue(m_azure_disk_type, json[QString("azureDiskType")]);
    m_azure_disk_type_isSet = !json[QString("azureDiskType")].isNull() && m_azure_disk_type_isValid;
    ...
    m_azure_vm_families_isValid = ::OpenAPI::fromJsonValue(m_azure_vm_families, json[QString("azureVmFamilies")]);
    m_azure_vm_families_isSet = !json[QString("azureVmFamilies")].isNull() && m_azure_vm_families_isValid;
    ...
    m_ea_subscription_id_isValid = ::OpenAPI::fromJsonValue(m_ea_subscription_id, json[QString("eaSubscriptionId")]);
    m_ea_subscription_id_isSet = !json[QString("eaSubscriptionId")].isNull() && m_ea_subscription_id_isValid;
    ...
    m_perf_data_end_time_isValid = ::OpenAPI::fromJsonValue(m_perf_data_end_time, json[QString("perfDataEndTime")]);
    m_perf_data_end_time_isSet = !json[QString("perfDataEndTime")].isNull() && m_perf_data_end_time_isValid;

    m_perf_data_start_time_isValid = ::OpenAPI::fromJsonValue(m_perf_data_start_time, json[QString("perfDataStartTime")]);
    m_perf_data_start_time_isSet = !json[QString("perfDataStartTime")].isNull() && m_perf_data_start_time_isValid;
    ...
    m_reserved_instance_isValid = ::OpenAPI::fromJsonValue(m_reserved_instance, json[QString("reservedInstance")]);
    m_reserved_instance_isSet = !json[QString("reservedInstance")].isNull() && m_reserved_instance_isValid;
    ...
    m_vm_uptime_isValid = ::OpenAPI::fromJsonValue(m_vm_uptime, json[QString("vmUptime")]);
    m_vm_uptime_isSet = !json[QString("vmUptime")].isNull() && m_vm_uptime_isValid;
}
...
QJsonObject OAIAssessmentProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_azure_disk_type_isSet) {
        obj.insert(QString("azureDiskType"), ::OpenAPI::toJsonValue(m_azure_disk_type));
    }
    ...
    if (m_azure_vm_families.size() > 0) {
        obj.insert(QString("azureVmFamilies"), ::OpenAPI::toJsonValue(m_azure_vm_families));
    }
    ...
    if (m_ea_subscription_id_isSet) {
        obj.insert(QString("eaSubscriptionId"), ::OpenAPI::toJsonValue(m_ea_subscription_id));
    }
    ...
    if (m_perf_data_end_time_isSet) {
        obj.insert(QString("perfDataEndTime"), ::OpenAPI::toJsonValue(m_perf_data_end_time));
    }
    if (m_perf_data_start_time_isSet) {
        obj.insert(QString("perfDataStartTime"), ::OpenAPI::toJsonValue(m_perf_data_start_time));
    }
    if (m_prices_timestamp_isSet) {
        obj.insert(QString("pricesTimestamp"), ::OpenAPI::toJsonValue(m_prices_timestamp));
    }
    if (m_reserved_instance_isSet) {
        obj.insert(QString("reservedInstance"), ::OpenAPI::toJsonValue(m_reserved_instance));
    }
    ...
    if (m_vm_uptime.isSet()) {
        obj.insert(QString("vmUptime"), ::OpenAPI::toJsonValue(m_vm_uptime));
    }
    return obj;
}

QString OAIAssessmentProperties::getAzureDiskType() const {
    return m_azure_disk_type;
}
void OAIAssessmentProperties::setAzureDiskType(const QString &azure_disk_type) {
    m_azure_disk_type = azure_disk_type;
    m_azure_disk_type_isSet = true;
}

bool OAIAssessmentProperties::is_azure_disk_type_Set() const{
    return m_azure_disk_type_isSet;
}

bool OAIAssessmentProperties::is_azure_disk_type_Valid() const{
    return m_azure_disk_type_isValid;
}
...
QList<QString> OAIAssessmentProperties::getAzureVmFamilies() const {
    return m_azure_vm_families;
}
void OAIAssessmentProperties::setAzureVmFamilies(const QList<QString> &azure_vm_families) {
    m_azure_vm_families = azure_vm_families;
    m_azure_vm_families_isSet = true;
}

bool OAIAssessmentProperties::is_azure_vm_families_Set() const{
    return m_azure_vm_families_isSet;
}

bool OAIAssessmentProperties::is_azure_vm_families_Valid() const{
    return m_azure_vm_families_isValid;
}
...
QString OAIAssessmentProperties::getEaSubscriptionId() const {
    return m_ea_subscription_id;
}
void OAIAssessmentProperties::setEaSubscriptionId(const QString &ea_subscription_id) {
    m_ea_subscription_id = ea_subscription_id;
    m_ea_subscription_id_isSet = true;
}

bool OAIAssessmentProperties::is_ea_subscription_id_Set() const{
    return m_ea_subscription_id_isSet;
}

bool OAIAssessmentProperties::is_ea_subscription_id_Valid() const{
    return m_ea_subscription_id_isValid;
}
...
double OAIAssessmentProperties::getMonthlyPremiumStorageCost() const {
    return m_monthly_premium_storage_cost;
}
void OAIAssessmentProperties::setMonthlyPremiumStorageCost(const double &monthly_premium_storage_cost) {
    m_monthly_premium_storage_cost = monthly_premium_storage_cost;
    m_monthly_premium_storage_cost_isSet = true;
}

bool OAIAssessmentProperties::is_monthly_premium_storage_cost_Set() const{
    return m_monthly_premium_storage_cost_isSet;
}

bool OAIAssessmentProperties::is_monthly_premium_storage_cost_Valid() const{
    return m_monthly_premium_storage_cost_isValid;
}

double OAIAssessmentProperties::getMonthlyStandardSsdStorageCost() const {
    return m_monthly_standard_ssd_storage_cost;
}
void OAIAssessmentProperties::setMonthlyStandardSsdStorageCost(const double &monthly_standard_ssd_storage_cost) {
    m_monthly_standard_ssd_storage_cost = monthly_standard_ssd_storage_cost;
    m_monthly_standard_ssd_storage_cost_isSet = true;
}

bool OAIAssessmentProperties::is_monthly_standard_ssd_storage_cost_Set() const{
    return m_monthly_standard_ssd_storage_cost_isSet;
}

bool OAIAssessmentProperties::is_monthly_standard_ssd_storage_cost_Valid() const{
...
QDateTime OAIAssessmentProperties::getPerfDataEndTime() const {
    return m_perf_data_end_time;
}
void OAIAssessmentProperties::setPerfDataEndTime(const QDateTime &perf_data_end_time) {
    m_perf_data_end_time = perf_data_end_time;
    m_perf_data_end_time_isSet = true;
}

bool OAIAssessmentProperties::is_perf_data_end_time_Set() const{
    return m_perf_data_end_time_isSet;
}

bool OAIAssessmentProperties::is_perf_data_end_time_Valid() const{
    return m_perf_data_end_time_isValid;
}

QDateTime OAIAssessmentProperties::getPerfDataStartTime() const {
    return m_perf_data_start_time;
}
void OAIAssessmentProperties::setPerfDataStartTime(const QDateTime &perf_data_start_time) {
    m_perf_data_start_time = perf_data_start_time;
    m_perf_data_start_time_isSet = true;
}

bool OAIAssessmentProperties::is_perf_data_start_time_Set() const{
    return m_perf_data_start_time_isSet;
}

bool OAIAssessmentProperties::is_perf_data_start_time_Valid() const{
    return m_perf_data_start_time_isValid;
}
...
QString OAIAssessmentProperties::getReservedInstance() const {
    return m_reserved_instance;
}
void OAIAssessmentProperties::setReservedInstance(const QString &reserved_instance) {
    m_reserved_instance = reserved_instance;
    m_reserved_instance_isSet = true;
}

bool OAIAssessmentProperties::is_reserved_instance_Set() const{
    return m_reserved_instance_isSet;
}

bool OAIAssessmentProperties::is_reserved_instance_Valid() const{
    return m_reserved_instance_isValid;
}
...
OAIVmUptime OAIAssessmentProperties::getVmUptime() const {
    return m_vm_uptime;
}
void OAIAssessmentProperties::setVmUptime(const OAIVmUptime &vm_uptime) {
    m_vm_uptime = vm_uptime;
    m_vm_uptime_isSet = true;
}

bool OAIAssessmentProperties::is_vm_uptime_Set() const{
    return m_vm_uptime_isSet;
}

bool OAIAssessmentProperties::is_vm_uptime_Valid() const{
    return m_vm_uptime_isValid;
}
...
bool OAIAssessmentProperties::isValid() const {
    ...
    return m_azure_disk_type_isValid && m_azure_hybrid_use_benefit_isValid && m_azure_location_isValid && m_azure_offer_code_isValid && m_azure_pricing_tier_isValid && m_azure_storage_redundancy_isValid && m_azure_vm_families_isValid && m_currency_isValid && m_discount_percentage_isValid && m_percentile_isValid && m_reserved_instance_isValid && m_scaling_factor_isValid && m_sizing_criterion_isValid && m_stage_isValid && m_time_range_isValid && m_vm_uptime_isValid && true;
}
