...
void OAIProject::setETag(const QString &e_tag) {
    m_e_tag = e_tag;
    m_e_tag_isSet = true;
}

bool OAIProject::is_e_tag_Set() const{
    return m_e_tag_isSet;
}

bool OAIProject::is_e_tag_Valid() const{
...
QString OAIProject::getLocation() const {
    return m_location;
}
void OAIProject::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIProject::is_location_Set() const{
    return m_location_isSet;
}

bool OAIProject::is_location_Valid() const{
...
OAIProjectProperties OAIProject::getProperties() const {
    return m_properties;
}
void OAIProject::setProperties(const OAIProjectProperties &properties) {
...
OAIObject OAIProject::getTags() const {
    return m_tags;
}
void OAIProject::setTags(const OAIObject &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
