...
QString OAIAssessedDisk::getDisplayName() const {
    return m_display_name;
}
void OAIAssessedDisk::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIAssessedDisk::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIAssessedDisk::is_display_name_Valid() const{
...
QString OAIAssessedDisk::getSuitabilityDetail() const {
    return m_suitability_detail;
}
void OAIAssessedDisk::setSuitabilityDetail(const QString &suitability_detail) {
    m_suitability_detail = suitability_detail;
    m_suitability_detail_isSet = true;
}

bool OAIAssessedDisk::is_suitability_detail_Set() const{
    return m_suitability_detail_isSet;
}

bool OAIAssessedDisk::is_suitability_detail_Valid() const{
