...
|**percentageCoresUtilizationDataPointsExpected** | **Integer** | Expected data points for percentage of cores utilization. |  [optional] [readonly] |
|**percentageCoresUtilizationDataPointsReceived** | **Integer** | Received data points for percentage of cores utilization. |  [optional] [readonly] |
...
|**percentageMemoryUtilizationDataPointsExpected** | **Integer** | Expected data points for percentage of memory utilization. |  [optional] [readonly] |
|**percentageMemoryUtilizationDataPointsReceived** | **Integer** | Received data points for percentage of memory utilization. |  [optional] [readonly] |
