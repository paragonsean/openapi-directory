...
public class ProjectProperties {
   ...
   */
  @JsonAdapter(DiscoveryStatusEnum.Adapter.class)
  public enum DiscoveryStatusEnum {
    ...
    DiscoveryStatusEnum(String value) {
      this.value = value;
    }
    ...
    public static DiscoveryStatusEnum fromValue(String value) {
      for (DiscoveryStatusEnum b : DiscoveryStatusEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<DiscoveryStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DiscoveryStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DiscoveryStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return DiscoveryStatusEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      DiscoveryStatusEnum.fromValue(value);
    }
  }
  ...
  private DiscoveryStatusEnum discoveryStatus;
  ...
  public static final String SERIALIZED_NAME_LAST_DISCOVERY_SESSION_ID = "lastDiscoverySessionId";
  @SerializedName(SERIALIZED_NAME_LAST_DISCOVERY_SESSION_ID)
  private String lastDiscoverySessionId;

  public static final String SERIALIZED_NAME_LAST_DISCOVERY_TIMESTAMP = "lastDiscoveryTimestamp";
  @SerializedName(SERIALIZED_NAME_LAST_DISCOVERY_TIMESTAMP)
  private OffsetDateTime lastDiscoveryTimestamp;
  ...
  public ProjectProperties(
     ...
     OffsetDateTime lastDiscoveryTimestamp, 
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getLastDiscoveryTimestamp() {
    return lastDiscoveryTimestamp;
  }
  ...
  public ProjectProperties provisioningState(ProvisioningStateEnum provisioningState) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdTimestamp, projectProperties.createdTimestamp) &&
        ...
        Objects.equals(this.discoveryStatus, projectProperties.discoveryStatus) &&
        Objects.equals(this.lastAssessmentTimestamp, projectProperties.lastAssessmentTimestamp) &&
        Objects.equals(this.lastDiscoverySessionId, projectProperties.lastDiscoverySessionId) &&
        Objects.equals(this.lastDiscoveryTimestamp, projectProperties.lastDiscoveryTimestamp) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdTimestamp, customerWorkspaceId, customerWorkspaceLocation, discoveryStatus, lastAssessmentTimestamp, lastDiscoverySessionId, lastDiscoveryTimestamp, numberOfAssessments, numberOfGroups, numberOfMachines, provisioningState, updatedTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastDiscoverySessionId: ").append(toIndentedString(lastDiscoverySessionId)).append("\n");
    sb.append("    lastDiscoveryTimestamp: ").append(toIndentedString(lastDiscoveryTimestamp)).append("\n");
  ...
  static {
    ...
    openapiFields.add("lastDiscoverySessionId");
    openapiFields.add("lastDiscoveryTimestamp");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("discoveryStatus") != null && !jsonObj.get("discoveryStatus").isJsonNull()) {
        DiscoveryStatusEnum.validateJsonElement(jsonObj.get("discoveryStatus"));
      }
      if ((jsonObj.get("lastDiscoverySessionId") != null && !jsonObj.get("lastDiscoverySessionId").isJsonNull()) && !jsonObj.get("lastDiscoverySessionId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `lastDiscoverySessionId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lastDiscoverySessionId").toString()));
      }
