...
class AssessedDisk {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('megabytesPerSecondOfReadDataPointsExpected')) {
                obj['megabytesPerSecondOfReadDataPointsExpected'] = ApiClient.convertToType(data['megabytesPerSecondOfReadDataPointsExpected'], 'Number');
            }
            ...
            if (data.hasOwnProperty('megabytesPerSecondOfWriteDataPointsExpected')) {
                obj['megabytesPerSecondOfWriteDataPointsExpected'] = ApiClient.convertToType(data['megabytesPerSecondOfWriteDataPointsExpected'], 'Number');
            }
            if (data.hasOwnProperty('megabytesPerSecondOfWriteDataPointsReceived')) {
                obj['megabytesPerSecondOfWriteDataPointsReceived'] = ApiClient.convertToType(data['megabytesPerSecondOfWriteDataPointsReceived'], 'Number');
            }
            ...
            if (data.hasOwnProperty('numberOfReadOperationsPerSecondDataPointsExpected')) {
                obj['numberOfReadOperationsPerSecondDataPointsExpected'] = ApiClient.convertToType(data['numberOfReadOperationsPerSecondDataPointsExpected'], 'Number');
            }
            if (data.hasOwnProperty('numberOfReadOperationsPerSecondDataPointsReceived')) {
                obj['numberOfReadOperationsPerSecondDataPointsReceived'] = ApiClient.convertToType(data['numberOfReadOperationsPerSecondDataPointsReceived'], 'Number');
            }
            ...
            if (data.hasOwnProperty('numberOfWriteOperationsPerSecondDataPointsExpected')) {
                obj['numberOfWriteOperationsPerSecondDataPointsExpected'] = ApiClient.convertToType(data['numberOfWriteOperationsPerSecondDataPointsExpected'], 'Number');
            }
            if (data.hasOwnProperty('numberOfWriteOperationsPerSecondDataPointsReceived')) {
                obj['numberOfWriteOperationsPerSecondDataPointsReceived'] = ApiClient.convertToType(data['numberOfWriteOperationsPerSecondDataPointsReceived'], 'Number');
            }
 ...
 * @member {Number} megabytesPerSecondOfReadDataPointsExpected
 */
AssessedDisk.prototype['megabytesPerSecondOfReadDataPointsExpected'] = undefined;

/**
 * Received data points for MegaBytes per second of read.
 * @member {Number} megabytesPerSecondOfReadDataPointsReceived
 */
AssessedDisk.prototype['megabytesPerSecondOfReadDataPointsReceived'] = undefined;
 ...
 * @member {Number} megabytesPerSecondOfWriteDataPointsExpected
 */
AssessedDisk.prototype['megabytesPerSecondOfWriteDataPointsExpected'] = undefined;

/**
 * Received data points for MegaBytes per second of write.
 * @member {Number} megabytesPerSecondOfWriteDataPointsReceived
 */
AssessedDisk.prototype['megabytesPerSecondOfWriteDataPointsReceived'] = undefined;
 ...
 */
AssessedDisk.prototype['numberOfReadOperationsPerSecondDataPointsExpected'] = undefined;
 ...
 */
AssessedDisk.prototype['numberOfReadOperationsPerSecondDataPointsReceived'] = undefined;
 ...
 */
AssessedDisk.prototype['numberOfWriteOperationsPerSecondDataPointsExpected'] = undefined;
 ...
 */
AssessedDisk.prototype['numberOfWriteOperationsPerSecondDataPointsReceived'] = undefined;
