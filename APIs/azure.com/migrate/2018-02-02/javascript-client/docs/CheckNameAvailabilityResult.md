# AzureMigrate.CheckNameAvailabilityResult
...
**reason** | **String** | Gets the reason that a project name could not be used. The Reason element is only returned if NameAvailable is false. | [optional] [readonly] 
