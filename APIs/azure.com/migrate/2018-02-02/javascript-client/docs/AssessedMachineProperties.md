...
**percentageCoresUtilizationDataPointsExpected** | **Number** | Expected data points for percentage of cores utilization. | [optional] [readonly] 
**percentageCoresUtilizationDataPointsReceived** | **Number** | Received data points for percentage of cores utilization. | [optional] [readonly] 
...
**percentageMemoryUtilizationDataPointsExpected** | **Number** | Expected data points for percentage of memory utilization. | [optional] [readonly] 
**percentageMemoryUtilizationDataPointsReceived** | **Number** | Received data points for percentage of memory utilization. | [optional] [readonly] 
