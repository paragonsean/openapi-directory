...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMigrate.VmFamily();
  });
  ...
  describe('VmFamily', function() {
    it('should create an instance of VmFamily', function() {
      // uncomment below and update the code to test VmFamily
      //var instance = new AzureMigrate.VmFamily();
      //expect(instance).to.be.a(AzureMigrate.VmFamily);
    });
