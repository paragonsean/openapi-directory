...
class AssessedDisk(Model):
    ...
    def __init__(self, gigabytes_consumed: float=None, gigabytes_for_recommended_disk_size: int=None, gigabytes_provisioned: float=None, megabytes_per_second_of_read: float=None, megabytes_per_second_of_read_data_points_expected: int=None, megabytes_per_second_of_read_data_points_received: int=None, megabytes_per_second_of_write: float=None, megabytes_per_second_of_write_data_points_expected: int=None, megabytes_per_second_of_write_data_points_received: int=None, monthly_storage_cost: float=None, name: str=None, number_of_read_operations_per_second: float=None, number_of_read_operations_per_second_data_points_expected: int=None, number_of_read_operations_per_second_data_points_received: int=None, number_of_write_operations_per_second: float=None, number_of_write_operations_per_second_data_points_expected: int=None, number_of_write_operations_per_second_data_points_received: int=None, recommended_disk_size: str=None, recommended_disk_type: str=None, suitability: str=None, suitability_explanation: str=None):
        ...
        :param megabytes_per_second_of_read_data_points_expected: The megabytes_per_second_of_read_data_points_expected of this AssessedDisk.
        :param megabytes_per_second_of_read_data_points_received: The megabytes_per_second_of_read_data_points_received of this AssessedDisk.
        :param megabytes_per_second_of_write: The megabytes_per_second_of_write of this AssessedDisk.
        :param megabytes_per_second_of_write_data_points_expected: The megabytes_per_second_of_write_data_points_expected of this AssessedDisk.
        :param megabytes_per_second_of_write_data_points_received: The megabytes_per_second_of_write_data_points_received of this AssessedDisk.
        ...
        :param number_of_read_operations_per_second_data_points_expected: The number_of_read_operations_per_second_data_points_expected of this AssessedDisk.
        :param number_of_read_operations_per_second_data_points_received: The number_of_read_operations_per_second_data_points_received of this AssessedDisk.
        :param number_of_write_operations_per_second: The number_of_write_operations_per_second of this AssessedDisk.
        :param number_of_write_operations_per_second_data_points_expected: The number_of_write_operations_per_second_data_points_expected of this AssessedDisk.
        :param number_of_write_operations_per_second_data_points_received: The number_of_write_operations_per_second_data_points_received of this AssessedDisk.
        ...
        self.openapi_types = {
            ...
            'megabytes_per_second_of_read_data_points_expected': int,
            'megabytes_per_second_of_read_data_points_received': int,
            'megabytes_per_second_of_write': float,
            'megabytes_per_second_of_write_data_points_expected': int,
            'megabytes_per_second_of_write_data_points_received': int,
            'monthly_storage_cost': float,
            'name': str,
            'number_of_read_operations_per_second': float,
            'number_of_read_operations_per_second_data_points_expected': int,
            'number_of_read_operations_per_second_data_points_received': int,
            'number_of_write_operations_per_second': float,
            'number_of_write_operations_per_second_data_points_expected': int,
            'number_of_write_operations_per_second_data_points_received': int,
        ...
        self.attribute_map = {
            ...
            'megabytes_per_second_of_read_data_points_expected': 'megabytesPerSecondOfReadDataPointsExpected',
            ...
            'megabytes_per_second_of_write_data_points_expected': 'megabytesPerSecondOfWriteDataPointsExpected',
            'megabytes_per_second_of_write_data_points_received': 'megabytesPerSecondOfWriteDataPointsReceived',
            'monthly_storage_cost': 'monthlyStorageCost',
            'name': 'name',
            'number_of_read_operations_per_second': 'numberOfReadOperationsPerSecond',
            'number_of_read_operations_per_second_data_points_expected': 'numberOfReadOperationsPerSecondDataPointsExpected',
            'number_of_read_operations_per_second_data_points_received': 'numberOfReadOperationsPerSecondDataPointsReceived',
            'number_of_write_operations_per_second': 'numberOfWriteOperationsPerSecond',
            'number_of_write_operations_per_second_data_points_expected': 'numberOfWriteOperationsPerSecondDataPointsExpected',
            'number_of_write_operations_per_second_data_points_received': 'numberOfWriteOperationsPerSecondDataPointsReceived',
        ...
        self._megabytes_per_second_of_read_data_points_expected = megabytes_per_second_of_read_data_points_expected
        ...
        self._megabytes_per_second_of_write_data_points_expected = megabytes_per_second_of_write_data_points_expected
        self._megabytes_per_second_of_write_data_points_received = megabytes_per_second_of_write_data_points_received
        ...
        self._number_of_read_operations_per_second_data_points_expected = number_of_read_operations_per_second_data_points_expected
        self._number_of_read_operations_per_second_data_points_received = number_of_read_operations_per_second_data_points_received
        self._number_of_write_operations_per_second = number_of_write_operations_per_second
        self._number_of_write_operations_per_second_data_points_expected = number_of_write_operations_per_second_data_points_expected
        self._number_of_write_operations_per_second_data_points_received = number_of_write_operations_per_second_data_points_received
    ...
    @property
    def megabytes_per_second_of_read_data_points_expected(self):
        """Gets the megabytes_per_second_of_read_data_points_expected of this AssessedDisk.

        Expected data points for MegaBytes per second of read.

        :return: The megabytes_per_second_of_read_data_points_expected of this AssessedDisk.
        :rtype: int
        """
        return self._megabytes_per_second_of_read_data_points_expected

    @megabytes_per_second_of_read_data_points_expected.setter
    def megabytes_per_second_of_read_data_points_expected(self, megabytes_per_second_of_read_data_points_expected):
        """Sets the megabytes_per_second_of_read_data_points_expected of this AssessedDisk.

        Expected data points for MegaBytes per second of read.

        :param megabytes_per_second_of_read_data_points_expected: The megabytes_per_second_of_read_data_points_expected of this AssessedDisk.
        :type megabytes_per_second_of_read_data_points_expected: int
        """
    ...
    def megabytes_per_second_of_read_data_points_received(self):
        """Gets the megabytes_per_second_of_read_data_points_received of this AssessedDisk.

        Received data points for MegaBytes per second of read.

        :return: The megabytes_per_second_of_read_data_points_received of this AssessedDisk.
        :rtype: int
        """
    ...
    def megabytes_per_second_of_read_data_points_received(self, megabytes_per_second_of_read_data_points_received):
        """Sets the megabytes_per_second_of_read_data_points_received of this AssessedDisk.
    ...
    @property
    def megabytes_per_second_of_write_data_points_expected(self):
        """Gets the megabytes_per_second_of_write_data_points_expected of this AssessedDisk.

        Expected data points for MegaBytes per second of write.

        :return: The megabytes_per_second_of_write_data_points_expected of this AssessedDisk.
        :rtype: int
        """
        return self._megabytes_per_second_of_write_data_points_expected

    @megabytes_per_second_of_write_data_points_expected.setter
    def megabytes_per_second_of_write_data_points_expected(self, megabytes_per_second_of_write_data_points_expected):
        """Sets the megabytes_per_second_of_write_data_points_expected of this AssessedDisk.

        Expected data points for MegaBytes per second of write.

        :param megabytes_per_second_of_write_data_points_expected: The megabytes_per_second_of_write_data_points_expected of this AssessedDisk.
        :type megabytes_per_second_of_write_data_points_expected: int
        """

        self._megabytes_per_second_of_write_data_points_expected = megabytes_per_second_of_write_data_points_expected

    @property
    def megabytes_per_second_of_write_data_points_received(self):
        """Gets the megabytes_per_second_of_write_data_points_received of this AssessedDisk.

        Received data points for MegaBytes per second of write.

        :return: The megabytes_per_second_of_write_data_points_received of this AssessedDisk.
        :rtype: int
        """
        return self._megabytes_per_second_of_write_data_points_received

    @megabytes_per_second_of_write_data_points_received.setter
    def megabytes_per_second_of_write_data_points_received(self, megabytes_per_second_of_write_data_points_received):
        """Sets the megabytes_per_second_of_write_data_points_received of this AssessedDisk.

        Received data points for MegaBytes per second of write.

        :param megabytes_per_second_of_write_data_points_received: The megabytes_per_second_of_write_data_points_received of this AssessedDisk.
        :type megabytes_per_second_of_write_data_points_received: int
        """
    ...
    @property
    def number_of_read_operations_per_second_data_points_expected(self):
        """Gets the number_of_read_operations_per_second_data_points_expected of this AssessedDisk.

        Expected number of data points for read operations per second.

        :return: The number_of_read_operations_per_second_data_points_expected of this AssessedDisk.
        :rtype: int
        """
        return self._number_of_read_operations_per_second_data_points_expected

    @number_of_read_operations_per_second_data_points_expected.setter
    def number_of_read_operations_per_second_data_points_expected(self, number_of_read_operations_per_second_data_points_expected):
        """Sets the number_of_read_operations_per_second_data_points_expected of this AssessedDisk.

        Expected number of data points for read operations per second.

        :param number_of_read_operations_per_second_data_points_expected: The number_of_read_operations_per_second_data_points_expected of this AssessedDisk.
        :type number_of_read_operations_per_second_data_points_expected: int
        """

        self._number_of_read_operations_per_second_data_points_expected = number_of_read_operations_per_second_data_points_expected

    @property
    def number_of_read_operations_per_second_data_points_received(self):
        """Gets the number_of_read_operations_per_second_data_points_received of this AssessedDisk.

        Received number of data points for read operations per second.

        :return: The number_of_read_operations_per_second_data_points_received of this AssessedDisk.
        :rtype: int
        """
        return self._number_of_read_operations_per_second_data_points_received

    @number_of_read_operations_per_second_data_points_received.setter
    def number_of_read_operations_per_second_data_points_received(self, number_of_read_operations_per_second_data_points_received):
        """Sets the number_of_read_operations_per_second_data_points_received of this AssessedDisk.

        Received number of data points for read operations per second.

        :param number_of_read_operations_per_second_data_points_received: The number_of_read_operations_per_second_data_points_received of this AssessedDisk.
        :type number_of_read_operations_per_second_data_points_received: int
        """
    ...
    @property
    def number_of_write_operations_per_second_data_points_expected(self):
        """Gets the number_of_write_operations_per_second_data_points_expected of this AssessedDisk.

        Expected number of data points for write operations per second.

        :return: The number_of_write_operations_per_second_data_points_expected of this AssessedDisk.
        :rtype: int
        """
        return self._number_of_write_operations_per_second_data_points_expected

    @number_of_write_operations_per_second_data_points_expected.setter
    def number_of_write_operations_per_second_data_points_expected(self, number_of_write_operations_per_second_data_points_expected):
        """Sets the number_of_write_operations_per_second_data_points_expected of this AssessedDisk.

        Expected number of data points for write operations per second.

        :param number_of_write_operations_per_second_data_points_expected: The number_of_write_operations_per_second_data_points_expected of this AssessedDisk.
        :type number_of_write_operations_per_second_data_points_expected: int
        """

        self._number_of_write_operations_per_second_data_points_expected = number_of_write_operations_per_second_data_points_expected

    @property
    def number_of_write_operations_per_second_data_points_received(self):
        """Gets the number_of_write_operations_per_second_data_points_received of this AssessedDisk.

        Received number of data points for write operations per second.

        :return: The number_of_write_operations_per_second_data_points_received of this AssessedDisk.
        :rtype: int
        """
        return self._number_of_write_operations_per_second_data_points_received

    @number_of_write_operations_per_second_data_points_received.setter
    def number_of_write_operations_per_second_data_points_received(self, number_of_write_operations_per_second_data_points_received):
        """Sets the number_of_write_operations_per_second_data_points_received of this AssessedDisk.

        Received number of data points for write operations per second.

        :param number_of_write_operations_per_second_data_points_received: The number_of_write_operations_per_second_data_points_received of this AssessedDisk.
        :type number_of_write_operations_per_second_data_points_received: int
        """
