...
class AssessedMachineProperties(Model):
    ...
    def __init__(self, boot_type: str=None, created_timestamp: datetime=None, datacenter_container: str=None, datacenter_machine_id: str=None, datacenter_management_server: str=None, datacenter_management_server_id: str=None, description: str=None, discovered_timestamp: datetime=None, disks: Dict[str, AssessedDisk]=None, display_name: str=None, groups: List[str]=None, megabytes_of_memory: float=None, megabytes_of_memory_for_recommended_size: float=None, monthly_bandwidth_cost: float=None, monthly_compute_cost_for_recommended_size: float=None, monthly_storage_cost: float=None, network_adapters: Dict[str, AssessedNetworkAdapter]=None, number_of_cores: int=None, number_of_cores_for_recommended_size: int=None, operating_system: str=None, percentage_cores_utilization: float=None, percentage_cores_utilization_data_points_expected: int=None, percentage_cores_utilization_data_points_received: int=None, percentage_memory_utilization: float=None, percentage_memory_utilization_data_points_expected: int=None, percentage_memory_utilization_data_points_received: int=None, recommended_size: str=None, suitability: str=None, suitability_explanation: str=None, updated_timestamp: datetime=None):
        ...
        :param percentage_cores_utilization_data_points_expected: The percentage_cores_utilization_data_points_expected of this AssessedMachineProperties.
        :param percentage_cores_utilization_data_points_received: The percentage_cores_utilization_data_points_received of this AssessedMachineProperties.
        :param percentage_memory_utilization: The percentage_memory_utilization of this AssessedMachineProperties.
        :param percentage_memory_utilization_data_points_expected: The percentage_memory_utilization_data_points_expected of this AssessedMachineProperties.
        :param percentage_memory_utilization_data_points_received: The percentage_memory_utilization_data_points_received of this AssessedMachineProperties.
        ...
        self.openapi_types = {
            ...
            'percentage_cores_utilization_data_points_expected': int,
            'percentage_cores_utilization_data_points_received': int,
            'percentage_memory_utilization': float,
            'percentage_memory_utilization_data_points_expected': int,
            'percentage_memory_utilization_data_points_received': int,
        ...
        self.attribute_map = {
            ...
            'percentage_cores_utilization_data_points_expected': 'percentageCoresUtilizationDataPointsExpected',
            'percentage_cores_utilization_data_points_received': 'percentageCoresUtilizationDataPointsReceived',
            'percentage_memory_utilization': 'percentageMemoryUtilization',
            'percentage_memory_utilization_data_points_expected': 'percentageMemoryUtilizationDataPointsExpected',
            'percentage_memory_utilization_data_points_received': 'percentageMemoryUtilizationDataPointsReceived',
        ...
        self._percentage_cores_utilization_data_points_expected = percentage_cores_utilization_data_points_expected
        self._percentage_cores_utilization_data_points_received = percentage_cores_utilization_data_points_received
        self._percentage_memory_utilization = percentage_memory_utilization
        self._percentage_memory_utilization_data_points_expected = percentage_memory_utilization_data_points_expected
        self._percentage_memory_utilization_data_points_received = percentage_memory_utilization_data_points_received
    ...
    @property
    def percentage_cores_utilization_data_points_expected(self):
        """Gets the percentage_cores_utilization_data_points_expected of this AssessedMachineProperties.

        Expected data points for percentage of cores utilization.

        :return: The percentage_cores_utilization_data_points_expected of this AssessedMachineProperties.
        :rtype: int
        """
        return self._percentage_cores_utilization_data_points_expected

    @percentage_cores_utilization_data_points_expected.setter
    def percentage_cores_utilization_data_points_expected(self, percentage_cores_utilization_data_points_expected):
        """Sets the percentage_cores_utilization_data_points_expected of this AssessedMachineProperties.

        Expected data points for percentage of cores utilization.

        :param percentage_cores_utilization_data_points_expected: The percentage_cores_utilization_data_points_expected of this AssessedMachineProperties.
        :type percentage_cores_utilization_data_points_expected: int
        """

        self._percentage_cores_utilization_data_points_expected = percentage_cores_utilization_data_points_expected

    @property
    def percentage_cores_utilization_data_points_received(self):
        """Gets the percentage_cores_utilization_data_points_received of this AssessedMachineProperties.

        Received data points for percentage of cores utilization.

        :return: The percentage_cores_utilization_data_points_received of this AssessedMachineProperties.
        :rtype: int
        """
        return self._percentage_cores_utilization_data_points_received

    @percentage_cores_utilization_data_points_received.setter
    def percentage_cores_utilization_data_points_received(self, percentage_cores_utilization_data_points_received):
        """Sets the percentage_cores_utilization_data_points_received of this AssessedMachineProperties.

        Received data points for percentage of cores utilization.

        :param percentage_cores_utilization_data_points_received: The percentage_cores_utilization_data_points_received of this AssessedMachineProperties.
        :type percentage_cores_utilization_data_points_received: int
        """
    ...
    @property
    def percentage_memory_utilization_data_points_expected(self):
        """Gets the percentage_memory_utilization_data_points_expected of this AssessedMachineProperties.

        Expected data points for percentage of memory utilization.

        :return: The percentage_memory_utilization_data_points_expected of this AssessedMachineProperties.
        :rtype: int
        """
        return self._percentage_memory_utilization_data_points_expected

    @percentage_memory_utilization_data_points_expected.setter
    def percentage_memory_utilization_data_points_expected(self, percentage_memory_utilization_data_points_expected):
        """Sets the percentage_memory_utilization_data_points_expected of this AssessedMachineProperties.

        Expected data points for percentage of memory utilization.

        :param percentage_memory_utilization_data_points_expected: The percentage_memory_utilization_data_points_expected of this AssessedMachineProperties.
        :type percentage_memory_utilization_data_points_expected: int
        """

        self._percentage_memory_utilization_data_points_expected = percentage_memory_utilization_data_points_expected

    @property
    def percentage_memory_utilization_data_points_received(self):
        """Gets the percentage_memory_utilization_data_points_received of this AssessedMachineProperties.

        Received data points for percentage of memory utilization.

        :return: The percentage_memory_utilization_data_points_received of this AssessedMachineProperties.
        :rtype: int
        """
        return self._percentage_memory_utilization_data_points_received

    @percentage_memory_utilization_data_points_received.setter
    def percentage_memory_utilization_data_points_received(self, percentage_memory_utilization_data_points_received):
        """Sets the percentage_memory_utilization_data_points_received of this AssessedMachineProperties.

        Received data points for percentage of memory utilization.

        :param percentage_memory_utilization_data_points_received: The percentage_memory_utilization_data_points_received of this AssessedMachineProperties.
        :type percentage_memory_utilization_data_points_received: int
        """
