...
async def assessment_options_get(request: web.Request, subscription_id, location_name, api_version, accept_language=None) -> web.Response:
...
async def location_check_name_availability(request: web.Request, location_name, api_version, subscription_id, parameters) -> web.Response:
...
async def projects_list_by_resource_group(request: web.Request, subscription_id, resource_group_name, api_version, accept_language=None) -> web.Response:
    """Get all projects.
