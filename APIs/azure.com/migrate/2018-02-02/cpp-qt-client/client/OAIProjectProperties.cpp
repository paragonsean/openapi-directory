...
void OAIProjectProperties::initializeModel() {
    ...
    m_last_discovery_session_id_isSet = false;
    m_last_discovery_session_id_isValid = false;

    m_last_discovery_timestamp_isSet = false;
    m_last_discovery_timestamp_isValid = false;
...
void OAIProjectProperties::fromJsonObject(QJsonObject json) {
    ...
    m_last_discovery_session_id_isValid = ::OpenAPI::fromJsonValue(m_last_discovery_session_id, json[QString("lastDiscoverySessionId")]);
    m_last_discovery_session_id_isSet = !json[QString("lastDiscoverySessionId")].isNull() && m_last_discovery_session_id_isValid;

    m_last_discovery_timestamp_isValid = ::OpenAPI::fromJsonValue(m_last_discovery_timestamp, json[QString("lastDiscoveryTimestamp")]);
    m_last_discovery_timestamp_isSet = !json[QString("lastDiscoveryTimestamp")].isNull() && m_last_discovery_timestamp_isValid;
...
QJsonObject OAIProjectProperties::asJsonObject() const {
    ...
    if (m_last_discovery_session_id_isSet) {
        obj.insert(QString("lastDiscoverySessionId"), ::OpenAPI::toJsonValue(m_last_discovery_session_id));
    }
    if (m_last_discovery_timestamp_isSet) {
        obj.insert(QString("lastDiscoveryTimestamp"), ::OpenAPI::toJsonValue(m_last_discovery_timestamp));
    }
...
QString OAIProjectProperties::getLastDiscoverySessionId() const {
    return m_last_discovery_session_id;
}
void OAIProjectProperties::setLastDiscoverySessionId(const QString &last_discovery_session_id) {
    m_last_discovery_session_id = last_discovery_session_id;
    m_last_discovery_session_id_isSet = true;
}

bool OAIProjectProperties::is_last_discovery_session_id_Set() const{
    return m_last_discovery_session_id_isSet;
}

bool OAIProjectProperties::is_last_discovery_session_id_Valid() const{
    return m_last_discovery_session_id_isValid;
}

QDateTime OAIProjectProperties::getLastDiscoveryTimestamp() const {
    return m_last_discovery_timestamp;
}
void OAIProjectProperties::setLastDiscoveryTimestamp(const QDateTime &last_discovery_timestamp) {
    m_last_discovery_timestamp = last_discovery_timestamp;
    m_last_discovery_timestamp_isSet = true;
}

bool OAIProjectProperties::is_last_discovery_timestamp_Set() const{
    return m_last_discovery_timestamp_isSet;
}

bool OAIProjectProperties::is_last_discovery_timestamp_Valid() const{
    return m_last_discovery_timestamp_isValid;
}
