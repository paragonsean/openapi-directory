...
public:
    ...
    OAIProjectProperties getProperties() const;
    void setProperties(const OAIProjectProperties &properties);
...
private:
    ...
    OAIProjectProperties m_properties;
