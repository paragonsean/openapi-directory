...
void OAIAssessmentProperties::initializeModel() {
    ...
    m_sizing_criterion_isSet = false;
    m_sizing_criterion_isValid = false;
...
void OAIAssessmentProperties::fromJsonObject(QJsonObject json) {
    ...
    m_sizing_criterion_isValid = ::OpenAPI::fromJsonValue(m_sizing_criterion, json[QString("sizingCriterion")]);
    m_sizing_criterion_isSet = !json[QString("sizingCriterion")].isNull() && m_sizing_criterion_isValid;
...
QJsonObject OAIAssessmentProperties::asJsonObject() const {
    ...
    if (m_sizing_criterion_isSet) {
        obj.insert(QString("sizingCriterion"), ::OpenAPI::toJsonValue(m_sizing_criterion));
    }
    if (m_stage_isSet) {
...
double OAIAssessmentProperties::getConfidenceRatingInPercentage() const {
    return m_confidence_rating_in_percentage;
}
void OAIAssessmentProperties::setConfidenceRatingInPercentage(const double &confidence_rating_in_percentage) {
    m_confidence_rating_in_percentage = confidence_rating_in_percentage;
    m_confidence_rating_in_percentage_isSet = true;
}

bool OAIAssessmentProperties::is_confidence_rating_in_percentage_Set() const{
    return m_confidence_rating_in_percentage_isSet;
}

bool OAIAssessmentProperties::is_confidence_rating_in_percentage_Valid() const{
...
QString OAIAssessmentProperties::getSizingCriterion() const {
    return m_sizing_criterion;
}
void OAIAssessmentProperties::setSizingCriterion(const QString &sizing_criterion) {
    m_sizing_criterion = sizing_criterion;
    m_sizing_criterion_isSet = true;
}

bool OAIAssessmentProperties::is_sizing_criterion_Set() const{
    return m_sizing_criterion_isSet;
}

bool OAIAssessmentProperties::is_sizing_criterion_Valid() const{
    return m_sizing_criterion_isValid;
}
...
bool OAIAssessmentProperties::isValid() const {
    ...
    return m_azure_hybrid_use_benefit_isValid && m_azure_location_isValid && m_azure_offer_code_isValid && m_azure_pricing_tier_isValid && m_azure_storage_redundancy_isValid && m_currency_isValid && m_discount_percentage_isValid && m_percentile_isValid && m_scaling_factor_isValid && m_sizing_criterion_isValid && m_stage_isValid && m_time_range_isValid && true;
}
