...
public:
    ...
    qint32 getPercentageCoresUtilizationDataPointsExpected() const;
    void setPercentageCoresUtilizationDataPointsExpected(const qint32 &percentage_cores_utilization_data_points_expected);
    bool is_percentage_cores_utilization_data_points_expected_Set() const;
    bool is_percentage_cores_utilization_data_points_expected_Valid() const;

    qint32 getPercentageCoresUtilizationDataPointsReceived() const;
    void setPercentageCoresUtilizationDataPointsReceived(const qint32 &percentage_cores_utilization_data_points_received);
    bool is_percentage_cores_utilization_data_points_received_Set() const;
    bool is_percentage_cores_utilization_data_points_received_Valid() const;
    ...
    qint32 getPercentageMemoryUtilizationDataPointsExpected() const;
    void setPercentageMemoryUtilizationDataPointsExpected(const qint32 &percentage_memory_utilization_data_points_expected);
    bool is_percentage_memory_utilization_data_points_expected_Set() const;
    bool is_percentage_memory_utilization_data_points_expected_Valid() const;

    qint32 getPercentageMemoryUtilizationDataPointsReceived() const;
    void setPercentageMemoryUtilizationDataPointsReceived(const qint32 &percentage_memory_utilization_data_points_received);
    bool is_percentage_memory_utilization_data_points_received_Set() const;
    bool is_percentage_memory_utilization_data_points_received_Valid() const;
...
private:
    ...
    qint32 m_percentage_cores_utilization_data_points_expected;
    bool m_percentage_cores_utilization_data_points_expected_isSet;
    bool m_percentage_cores_utilization_data_points_expected_isValid;

    qint32 m_percentage_cores_utilization_data_points_received;
    bool m_percentage_cores_utilization_data_points_received_isSet;
    bool m_percentage_cores_utilization_data_points_received_isValid;
    ...
    qint32 m_percentage_memory_utilization_data_points_expected;
    bool m_percentage_memory_utilization_data_points_expected_isSet;
    bool m_percentage_memory_utilization_data_points_expected_isValid;

    qint32 m_percentage_memory_utilization_data_points_received;
    bool m_percentage_memory_utilization_data_points_received_isSet;
    bool m_percentage_memory_utilization_data_points_received_isValid;
