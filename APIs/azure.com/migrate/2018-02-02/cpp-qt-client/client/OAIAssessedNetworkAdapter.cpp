...
void OAIAssessedNetworkAdapter::initializeModel() {
    ...
    m_megabytes_per_second_received_data_points_expected_isSet = false;
    m_megabytes_per_second_received_data_points_expected_isValid = false;

    m_megabytes_per_second_transmitted_isSet = false;
    m_megabytes_per_second_transmitted_isValid = false;

    m_megabytes_per_second_transmitted_data_points_expected_isSet = false;
    m_megabytes_per_second_transmitted_data_points_expected_isValid = false;

    m_megabytes_per_second_transmitted_data_points_received_isSet = false;
    m_megabytes_per_second_transmitted_data_points_received_isValid = false;
...
void OAIAssessedNetworkAdapter::fromJsonObject(QJsonObject json) {
    ...
    m_megabytes_per_second_received_data_points_expected_isValid = ::OpenAPI::fromJsonValue(m_megabytes_per_second_received_data_points_expected, json[QString("megabytesPerSecondReceivedDataPointsExpected")]);
    m_megabytes_per_second_received_data_points_expected_isSet = !json[QString("megabytesPerSecondReceivedDataPointsExpected")].isNull() && m_megabytes_per_second_received_data_points_expected_isValid;
    ...
    m_megabytes_per_second_transmitted_data_points_expected_isValid = ::OpenAPI::fromJsonValue(m_megabytes_per_second_transmitted_data_points_expected, json[QString("megabytesPerSecondTransmittedDataPointsExpected")]);
    m_megabytes_per_second_transmitted_data_points_expected_isSet = !json[QString("megabytesPerSecondTransmittedDataPointsExpected")].isNull() && m_megabytes_per_second_transmitted_data_points_expected_isValid;

    m_megabytes_per_second_transmitted_data_points_received_isValid = ::OpenAPI::fromJsonValue(m_megabytes_per_second_transmitted_data_points_received, json[QString("megabytesPerSecondTransmittedDataPointsReceived")]);
    m_megabytes_per_second_transmitted_data_points_received_isSet = !json[QString("megabytesPerSecondTransmittedDataPointsReceived")].isNull() && m_megabytes_per_second_transmitted_data_points_received_isValid;
...
QJsonObject OAIAssessedNetworkAdapter::asJsonObject() const {
    ...
    if (m_megabytes_per_second_received_data_points_expected_isSet) {
        obj.insert(QString("megabytesPerSecondReceivedDataPointsExpected"), ::OpenAPI::toJsonValue(m_megabytes_per_second_received_data_points_expected));
    }
    ...
    if (m_megabytes_per_second_transmitted_data_points_expected_isSet) {
        obj.insert(QString("megabytesPerSecondTransmittedDataPointsExpected"), ::OpenAPI::toJsonValue(m_megabytes_per_second_transmitted_data_points_expected));
    }
    if (m_megabytes_per_second_transmitted_data_points_received_isSet) {
        obj.insert(QString("megabytesPerSecondTransmittedDataPointsReceived"), ::OpenAPI::toJsonValue(m_megabytes_per_second_transmitted_data_points_received));
    }
...
qint32 OAIAssessedNetworkAdapter::getMegabytesPerSecondOfReadDataPointsReceived() const {
    return m_megabytes_per_second_of_read_data_points_received;
}
void OAIAssessedNetworkAdapter::setMegabytesPerSecondOfReadDataPointsReceived(const qint32 &megabytes_per_second_of_read_data_points_received) {
...
bool OAIAssessedNetworkAdapter::is_megabytes_per_second_of_read_data_points_received_Set() const{
    return m_megabytes_per_second_of_read_data_points_received_isSet;
}

bool OAIAssessedNetworkAdapter::is_megabytes_per_second_of_read_data_points_received_Valid() const{
...
qint32 OAIAssessedNetworkAdapter::getMegabytesPerSecondReceivedDataPointsExpected() const {
    return m_megabytes_per_second_received_data_points_expected;
}
void OAIAssessedNetworkAdapter::setMegabytesPerSecondReceivedDataPointsExpected(const qint32 &megabytes_per_second_received_data_points_expected) {
    m_megabytes_per_second_received_data_points_expected = megabytes_per_second_received_data_points_expected;
    m_megabytes_per_second_received_data_points_expected_isSet = true;
}

bool OAIAssessedNetworkAdapter::is_megabytes_per_second_received_data_points_expected_Set() const{
    return m_megabytes_per_second_received_data_points_expected_isSet;
}

bool OAIAssessedNetworkAdapter::is_megabytes_per_second_received_data_points_expected_Valid() const{
    return m_megabytes_per_second_received_data_points_expected_isValid;
}
...
qint32 OAIAssessedNetworkAdapter::getMegabytesPerSecondTransmittedDataPointsExpected() const {
    return m_megabytes_per_second_transmitted_data_points_expected;
}
void OAIAssessedNetworkAdapter::setMegabytesPerSecondTransmittedDataPointsExpected(const qint32 &megabytes_per_second_transmitted_data_points_expected) {
    m_megabytes_per_second_transmitted_data_points_expected = megabytes_per_second_transmitted_data_points_expected;
    m_megabytes_per_second_transmitted_data_points_expected_isSet = true;
}

bool OAIAssessedNetworkAdapter::is_megabytes_per_second_transmitted_data_points_expected_Set() const{
    return m_megabytes_per_second_transmitted_data_points_expected_isSet;
}

bool OAIAssessedNetworkAdapter::is_megabytes_per_second_transmitted_data_points_expected_Valid() const{
    return m_megabytes_per_second_transmitted_data_points_expected_isValid;
}

qint32 OAIAssessedNetworkAdapter::getMegabytesPerSecondTransmittedDataPointsReceived() const {
    return m_megabytes_per_second_transmitted_data_points_received;
}
void OAIAssessedNetworkAdapter::setMegabytesPerSecondTransmittedDataPointsReceived(const qint32 &megabytes_per_second_transmitted_data_points_received) {
    m_megabytes_per_second_transmitted_data_points_received = megabytes_per_second_transmitted_data_points_received;
    m_megabytes_per_second_transmitted_data_points_received_isSet = true;
}

bool OAIAssessedNetworkAdapter::is_megabytes_per_second_transmitted_data_points_received_Set() const{
    return m_megabytes_per_second_transmitted_data_points_received_isSet;
}

bool OAIAssessedNetworkAdapter::is_megabytes_per_second_transmitted_data_points_received_Valid() const{
    return m_megabytes_per_second_transmitted_data_points_received_isValid;
}
