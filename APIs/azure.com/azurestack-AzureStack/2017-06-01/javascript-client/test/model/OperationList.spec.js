...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.OperationList();
  });
  ...
  describe('OperationList', function() {
    it('should create an instance of OperationList', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.OperationList();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.OperationList);
    });
