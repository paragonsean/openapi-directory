...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.Operation();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.Operation);
    });
