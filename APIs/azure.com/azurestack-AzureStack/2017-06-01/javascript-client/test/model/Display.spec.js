...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.Display();
  });
  ...
  describe('Display', function() {
    it('should create an instance of Display', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.Display();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.Display);
    });
