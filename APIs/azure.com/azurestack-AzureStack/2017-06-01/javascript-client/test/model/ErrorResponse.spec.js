...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.ErrorResponse();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.ErrorResponse);
    });
