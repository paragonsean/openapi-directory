...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.ErrorDetails();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.ErrorDetails);
    });
