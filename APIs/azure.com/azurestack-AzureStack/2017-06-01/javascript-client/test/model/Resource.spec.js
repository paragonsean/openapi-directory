...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.Resource();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.Resource);
    });
