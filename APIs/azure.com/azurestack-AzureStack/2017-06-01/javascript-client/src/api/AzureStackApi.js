...
/**
* AzureStack service.
* @module api/AzureStackApi
* @version 2017-06-01
*/
export default class AzureStackApi {

    /**
    * Constructs a new AzureStackApi. 
    * @alias module:api/AzureStackApi
    * @class
    ...
    */
     ...
     * @callback module:api/AzureStackApi~operationsListCallback
     ...
     * @param {module:api/AzureStackApi~operationsListCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    operationsList(apiVersion, callback) {
      ...
      return this.apiClient.callApi(
        '/providers/Microsoft.AzureStack/operations', 'GET',
