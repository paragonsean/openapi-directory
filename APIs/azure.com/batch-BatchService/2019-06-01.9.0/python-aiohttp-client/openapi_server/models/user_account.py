...
class UserAccount(Model):
    ...
    def __init__(self, elevation_level: ElevationLevel=None, linux_user_configuration: LinuxUserConfiguration=None, name: str=None, password: str=None, windows_user_configuration: WindowsUserConfiguration=None):
        ...
        :param windows_user_configuration: The windows_user_configuration of this UserAccount.
        """
        self.openapi_types = {
        ...
        self._windows_user_configuration = windows_user_configuration
    ...
    def windows_user_configuration(self):
        """Gets the windows_user_configuration of this UserAccount.


        :return: The windows_user_configuration of this UserAccount.
        :rtype: WindowsUserConfiguration
        """
        return self._windows_user_configuration

    @windows_user_configuration.setter
    def windows_user_configuration(self, windows_user_configuration):
        """Sets the windows_user_configuration of this UserAccount.


        :param windows_user_configuration: The windows_user_configuration of this UserAccount.
        :type windows_user_configuration: WindowsUserConfiguration
        """
