...
class InboundEndpoint(Model):
    ...
    def __init__(self, backend_port: int=None, frontend_port: int=None, name: str=None, protocol: InboundEndpointProtocol=None, public_fqdn: str=None, public_ip_address: str=None):
