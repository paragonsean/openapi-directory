...
class JobSpecification(Model):
    ...
    def __init__(self, common_environment_settings: List[EnvironmentSetting]=None, constraints: JobConstraints=None, display_name: str=None, job_manager_task: JobManagerTask=None, job_preparation_task: JobPreparationTask=None, job_release_task: JobReleaseTask=None, metadata: List[MetadataItem]=None, network_configuration: JobNetworkConfiguration=None, on_all_tasks_complete: OnAllTasksComplete=None, on_task_failure: OnTaskFailure=None, pool_info: PoolInformation=None, priority: int=None, uses_task_dependencies: bool=None):
        ...
        :param network_configuration: The network_configuration of this JobSpecification.
    ...
    def network_configuration(self):
        """Gets the network_configuration of this JobSpecification.


        :return: The network_configuration of this JobSpecification.
    ...
    def network_configuration(self, network_configuration):
        """Sets the network_configuration of this JobSpecification.
