...
class NodeAgentInformation {
     ...
     * @param lastUpdateTime {Date} This is the most recent time that the Compute Node agent was updated to a new version.
     * @param version {String} This version number can be checked against the Compute Node agent release notes located at https://github.com/Azure/Batch/blob/master/changelogs/nodeagent/CHANGELOG.md.
     */
