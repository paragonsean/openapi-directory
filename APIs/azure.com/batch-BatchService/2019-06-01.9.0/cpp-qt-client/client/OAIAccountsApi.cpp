...
void OAIAccountsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("accountListSupportedImages", defaultConf);
    _serverIndices.insert("accountListSupportedImages", 0);
}
...
void OAIAccountsApi::accountListPoolNodeCounts(const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &maxresults, const ::OpenAPI::OptionalParam<qint32> &timeout, const ::OpenAPI::OptionalParam<QString> &client_request_id, const ::OpenAPI::OptionalParam<bool> &return_client_request_id, const ::OpenAPI::OptionalParam<QString> &ocp_date) {
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::accountListPoolNodeCountsCallback);
...
void OAIAccountsApi::accountListSupportedImages(const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &maxresults, const ::OpenAPI::OptionalParam<qint32> &timeout, const ::OpenAPI::OptionalParam<QString> &client_request_id, const ::OpenAPI::OptionalParam<bool> &return_client_request_id, const ::OpenAPI::OptionalParam<QString> &ocp_date) {
    QString fullPath = QString(_serverConfigs["accountListSupportedImages"][_serverIndices.value("accountListSupportedImages")].URL()+"/supportedimages");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::accountListSupportedImagesCallback);
    connect(this, &OAIAccountsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::accountListSupportedImagesCallback);
    connect(this, &OAIAccountsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAccountsApi::accountListSupportedImagesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIAccountListSupportedImagesResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountListSupportedImagesSignal(output);
        Q_EMIT accountListSupportedImagesSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountListSupportedImagesSignalE(output, error_type, error_str);
        Q_EMIT accountListSupportedImagesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountListSupportedImagesSignalError(output, error_type, error_str);
        Q_EMIT accountListSupportedImagesSignalErrorFull(worker, error_type, error_str);
    }
}
