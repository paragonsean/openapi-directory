...
QList<OAINameValuePair> OAIAutoScaleRunError::getValues() const {
    return m_values;
}
void OAIAutoScaleRunError::setValues(const QList<OAINameValuePair> &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIAutoScaleRunError::is_values_Set() const{
    return m_values_isSet;
}

bool OAIAutoScaleRunError::is_values_Valid() const{
