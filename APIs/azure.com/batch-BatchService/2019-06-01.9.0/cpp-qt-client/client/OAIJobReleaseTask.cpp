...
OAITaskContainerSettings OAIJobReleaseTask::getContainerSettings() const {
    return m_container_settings;
}
void OAIJobReleaseTask::setContainerSettings(const OAITaskContainerSettings &container_settings) {
    m_container_settings = container_settings;
    m_container_settings_isSet = true;
}

bool OAIJobReleaseTask::is_container_settings_Set() const{
    return m_container_settings_isSet;
}

bool OAIJobReleaseTask::is_container_settings_Valid() const{
...
OAIUserIdentity OAIJobReleaseTask::getUserIdentity() const {
    return m_user_identity;
}
void OAIJobReleaseTask::setUserIdentity(const OAIUserIdentity &user_identity) {
    m_user_identity = user_identity;
    m_user_identity_isSet = true;
}

bool OAIJobReleaseTask::is_user_identity_Set() const{
    return m_user_identity_isSet;
}

bool OAIJobReleaseTask::is_user_identity_Valid() const{
