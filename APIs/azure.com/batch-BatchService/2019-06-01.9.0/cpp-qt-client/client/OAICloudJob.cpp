...
OAIJobNetworkConfiguration OAICloudJob::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAICloudJob::setNetworkConfiguration(const OAIJobNetworkConfiguration &network_configuration) {
    m_network_configuration = network_configuration;
    m_network_configuration_isSet = true;
}

bool OAICloudJob::is_network_configuration_Set() const{
    return m_network_configuration_isSet;
}

bool OAICloudJob::is_network_configuration_Valid() const{
