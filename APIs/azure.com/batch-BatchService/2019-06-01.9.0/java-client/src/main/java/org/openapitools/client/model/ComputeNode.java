...
public class ComputeNode {
  ...
  public static final String SERIALIZED_NAME_NODE_AGENT_INFO = "nodeAgentInfo";
  @SerializedName(SERIALIZED_NAME_NODE_AGENT_INFO)
  ...
  public ComputeNode nodeAgentInfo(NodeAgentInformation nodeAgentInfo) {
  ...
  public void setNodeAgentInfo(NodeAgentInformation nodeAgentInfo) {
    this.nodeAgentInfo = nodeAgentInfo;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.affinityId, computeNode.affinityId) &&
        ...
        Objects.equals(this.nodeAgentInfo, computeNode.nodeAgentInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(affinityId, allocationTime, certificateReferences, endpointConfiguration, errors, id, ipAddress, isDedicated, lastBootTime, nodeAgentInfo, recentTasks, runningTasksCount, schedulingState, startTask, startTaskInfo, state, stateTransitionTime, totalTasksRun, totalTasksSucceeded, url, vmSize);
  }
  ...
  public String toString() {
    ...
    sb.append("    nodeAgentInfo: ").append(toIndentedString(nodeAgentInfo)).append("\n");
  ...
  static {
    ...
    openapiFields.add("nodeAgentInfo");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("nodeAgentInfo") != null && !jsonObj.get("nodeAgentInfo").isJsonNull()) {
        NodeAgentInformation.validateJsonElement(jsonObj.get("nodeAgentInfo"));
      }
