...
public class JobSpecification {
  ...
  public JobSpecification networkConfiguration(JobNetworkConfiguration networkConfiguration) {
  ...
  public void setNetworkConfiguration(JobNetworkConfiguration networkConfiguration) {
    this.networkConfiguration = networkConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commonEnvironmentSettings, jobSpecification.commonEnvironmentSettings) &&
        ...
        Objects.equals(this.networkConfiguration, jobSpecification.networkConfiguration) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commonEnvironmentSettings, constraints, displayName, jobManagerTask, jobPreparationTask, jobReleaseTask, metadata, networkConfiguration, onAllTasksComplete, onTaskFailure, poolInfo, priority, usesTaskDependencies);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("networkConfiguration") != null && !jsonObj.get("networkConfiguration").isJsonNull()) {
        JobNetworkConfiguration.validateJsonElement(jsonObj.get("networkConfiguration"));
      }
