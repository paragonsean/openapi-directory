...
|**allocationTime** | **OffsetDateTime** | This is the time when the node was initially allocated and doesn&#39;t change once set. It is not updated when the node is service healed or preempted. |  [optional] |
