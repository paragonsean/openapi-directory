...
async def compute_node_upload_batch_service_logs(request: web.Request, pool_id, node_id, api_version, upload_batch_service_logs_configuration, timeout=None, client_request_id=None, return_client_request_id=None, ocp_date=None) -> web.Response:
    ...
    :param pool_id: The ID of the pool that contains the compute node.
    :type pool_id: str
    :param node_id: The ID of the compute node from which you want to upload the Azure Batch service log files.
    :type node_id: str
    :param api_version: Client API Version.
    :type api_version: str
    :param upload_batch_service_logs_configuration: The Azure Batch service log files upload configuration.
    :type upload_batch_service_logs_configuration: dict | bytes
    :param timeout: The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds.
    :type timeout: int
    :param client_request_id: The caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.
    :type client_request_id: str
    ...
    """
    upload_batch_service_logs_configuration = UploadBatchServiceLogsConfiguration.from_dict(upload_batch_service_logs_configuration)
    return web.Response(status=200)
