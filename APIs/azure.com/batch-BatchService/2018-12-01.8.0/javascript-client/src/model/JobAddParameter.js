...
import JobNetworkConfiguration from './JobNetworkConfiguration';
...
class JobAddParameter {
     ...
     * @param id {String} The ID can contain any combination of alphanumeric characters including hyphens and underscores, and cannot contain more than 64 characters. The ID is case-preserving and case-insensitive (that is, you may not have two IDs within an account that differ only by case).
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('networkConfiguration')) {
                obj['networkConfiguration'] = JobNetworkConfiguration.constructFromObject(data['networkConfiguration']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['networkConfiguration']) { // data not null
          JobNetworkConfiguration.validateJSON(data['networkConfiguration']);
        }
...
/**
 * @member {module:model/JobNetworkConfiguration} networkConfiguration
 */
JobAddParameter.prototype['networkConfiguration'] = undefined;
