...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BatchService.JobScheduleStatistics();
  });
  ...
  describe('JobScheduleStatistics', function() {
    it('should create an instance of JobScheduleStatistics', function() {
      // uncomment below and update the code to test JobScheduleStatistics
      //var instance = new BatchService.JobScheduleStatistics();
      //expect(instance).to.be.a(BatchService.JobScheduleStatistics);
    });
