...
OAIOnAllTasksComplete OAIJobUpdateParameter::getOnAllTasksComplete() const {
    return m_on_all_tasks_complete;
}
void OAIJobUpdateParameter::setOnAllTasksComplete(const OAIOnAllTasksComplete &on_all_tasks_complete) {
    m_on_all_tasks_complete = on_all_tasks_complete;
    m_on_all_tasks_complete_isSet = true;
}

bool OAIJobUpdateParameter::is_on_all_tasks_complete_Set() const{
    return m_on_all_tasks_complete_isSet;
}

bool OAIJobUpdateParameter::is_on_all_tasks_complete_Valid() const{
