...
OAIJobScheduleState OAICloudJobSchedule::getPreviousState() const {
    return m_previous_state;
}
void OAICloudJobSchedule::setPreviousState(const OAIJobScheduleState &previous_state) {
...
OAIJobScheduleState OAICloudJobSchedule::getState() const {
    return m_state;
}
void OAICloudJobSchedule::setState(const OAIJobScheduleState &state) {
    m_state = state;
    m_state_isSet = true;
}
