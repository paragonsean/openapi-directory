...
QList<OAIMountConfiguration> OAICloudPool::getMountConfiguration() const {
    return m_mount_configuration;
}
void OAICloudPool::setMountConfiguration(const QList<OAIMountConfiguration> &mount_configuration) {
    m_mount_configuration = mount_configuration;
    m_mount_configuration_isSet = true;
}

bool OAICloudPool::is_mount_configuration_Set() const{
    return m_mount_configuration_isSet;
}

bool OAICloudPool::is_mount_configuration_Valid() const{
