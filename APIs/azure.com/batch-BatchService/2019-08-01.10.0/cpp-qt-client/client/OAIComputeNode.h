...
class OAIComputeNodeEndpointConfiguration;
class OAIComputeNodeError;
class OAINodeAgentInformation;
...
public:
    ...
    OAIComputeNodeEndpointConfiguration getEndpointConfiguration() const;
    void setEndpointConfiguration(const OAIComputeNodeEndpointConfiguration &endpoint_configuration);
    ...
    OAINodeAgentInformation getNodeAgentInfo() const;
    void setNodeAgentInfo(const OAINodeAgentInformation &node_agent_info);
    bool is_node_agent_info_Set() const;
    bool is_node_agent_info_Valid() const;
...
private:
    ...
    OAIComputeNodeEndpointConfiguration m_endpoint_configuration;
    ...
    OAINodeAgentInformation m_node_agent_info;
    bool m_node_agent_info_isSet;
    bool m_node_agent_info_isValid;
