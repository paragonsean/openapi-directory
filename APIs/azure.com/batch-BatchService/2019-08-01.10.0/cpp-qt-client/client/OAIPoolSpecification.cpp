...
QList<OAIMountConfiguration> OAIPoolSpecification::getMountConfiguration() const {
    return m_mount_configuration;
}
void OAIPoolSpecification::setMountConfiguration(const QList<OAIMountConfiguration> &mount_configuration) {
    m_mount_configuration = mount_configuration;
    m_mount_configuration_isSet = true;
}

bool OAIPoolSpecification::is_mount_configuration_Set() const{
    return m_mount_configuration_isSet;
}

bool OAIPoolSpecification::is_mount_configuration_Valid() const{
