...
QList<OAIMountConfiguration> OAIPoolAddParameter::getMountConfiguration() const {
    return m_mount_configuration;
}
void OAIPoolAddParameter::setMountConfiguration(const QList<OAIMountConfiguration> &mount_configuration) {
    m_mount_configuration = mount_configuration;
    m_mount_configuration_isSet = true;
}

bool OAIPoolAddParameter::is_mount_configuration_Set() const{
    return m_mount_configuration_isSet;
}

bool OAIPoolAddParameter::is_mount_configuration_Valid() const{
