...
/*
 * OAIJobScheduleStatistics.h
 *
 * 
 */

#ifndef OAIJobScheduleStatistics_H
#define OAIJobScheduleStatistics_H
...
class OAIJobScheduleStatistics : public OAIObject {
public:
    OAIJobScheduleStatistics();
    OAIJobScheduleStatistics(QString json);
    ~OAIJobScheduleStatistics() override;
    ...
    qint64 getNumFailedTasks() const;
    void setNumFailedTasks(const qint64 &num_failed_tasks);
    bool is_num_failed_tasks_Set() const;
    bool is_num_failed_tasks_Valid() const;

    qint64 getNumSucceededTasks() const;
    void setNumSucceededTasks(const qint64 &num_succeeded_tasks);
    bool is_num_succeeded_tasks_Set() const;
    bool is_num_succeeded_tasks_Valid() const;

    qint64 getNumTaskRetries() const;
    void setNumTaskRetries(const qint64 &num_task_retries);
    bool is_num_task_retries_Set() const;
    bool is_num_task_retries_Valid() const;
...
private:
    ...
    qint64 m_num_failed_tasks;
    bool m_num_failed_tasks_isSet;
    bool m_num_failed_tasks_isValid;

    qint64 m_num_succeeded_tasks;
    bool m_num_succeeded_tasks_isSet;
    bool m_num_succeeded_tasks_isValid;

    qint64 m_num_task_retries;
    bool m_num_task_retries_isSet;
    bool m_num_task_retries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobScheduleStatistics)

#endif // OAIJobScheduleStatistics_H
