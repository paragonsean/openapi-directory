...
QList<QString> OAINetworkConfiguration::getPublicIps() const {
    return m_public_ips;
}
void OAINetworkConfiguration::setPublicIps(const QList<QString> &public_ips) {
    m_public_ips = public_ips;
    m_public_ips_isSet = true;
}

bool OAINetworkConfiguration::is_public_ips_Set() const{
    return m_public_ips_isSet;
}

bool OAINetworkConfiguration::is_public_ips_Valid() const{
