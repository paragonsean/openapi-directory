...
class NetworkConfiguration(Model):
    ...
    def __init__(self, dynamic_v_net_assignment_scope: str=None, endpoint_configuration: PoolEndpointConfiguration=None, public_ips: List[str]=None, subnet_id: str=None):
        ...
        :param public_ips: The public_ips of this NetworkConfiguration.
    ...
    @property
    def public_ips(self):
        """Gets the public_ips of this NetworkConfiguration.
        ...
        :return: The public_ips of this NetworkConfiguration.
        :rtype: List[str]
        """
    ...
    def public_ips(self, public_ips):
        """Sets the public_ips of this NetworkConfiguration.
