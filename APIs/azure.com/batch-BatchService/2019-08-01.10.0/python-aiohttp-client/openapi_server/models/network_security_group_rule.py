...
class NetworkSecurityGroupRule(Model):
    ...
    def __init__(self, access: str=None, priority: int=None, source_address_prefix: str=None, source_port_ranges: List[str]=None):
        ...
        :param source_port_ranges: The source_port_ranges of this NetworkSecurityGroupRule.
        """
        self.openapi_types = {
            'access': str,
            'priority': int,
    ...
    def source_port_ranges(self):
        """Gets the source_port_ranges of this NetworkSecurityGroupRule.
        ...
        :return: The source_port_ranges of this NetworkSecurityGroupRule.
        :rtype: List[str]
        """
    ...
    def source_port_ranges(self, source_port_ranges):
        """Sets the source_port_ranges of this NetworkSecurityGroupRule.
