...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BatchService.UserIdentity();
  });
  ...
  describe('UserIdentity', function() {
    it('should create an instance of UserIdentity', function() {
      ...
      //var instance = new BatchService.UserIdentity();
      //expect(instance).to.be.a(BatchService.UserIdentity);
    });

    it('should have the property autoUser (base name: "autoUser")', function() {
      // uncomment below and update the code to test the property autoUser
      //var instance = new BatchService.UserIdentity();
