...
import MountConfiguration from './MountConfiguration';
...
class PoolSpecification {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mountConfiguration')) {
                obj['mountConfiguration'] = ApiClient.convertToType(data['mountConfiguration'], [MountConfiguration]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['mountConfiguration']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['mountConfiguration'])) {
                throw new Error("Expected the field `mountConfiguration` to be an array in the JSON data but got " + data['mountConfiguration']);
            }
            // validate the optional field `mountConfiguration` (array)
            for (const item of data['mountConfiguration']) {
                MountConfiguration.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/MountConfiguration>} mountConfiguration
 */
PoolSpecification.prototype['mountConfiguration'] = undefined;
