...
public class PoolAddParameter {
  ...
  public static final String SERIALIZED_NAME_MOUNT_CONFIGURATION = "mountConfiguration";
  @SerializedName(SERIALIZED_NAME_MOUNT_CONFIGURATION)
  private List<MountConfiguration> mountConfiguration = new ArrayList<>();
  ...
  public PoolAddParameter mountConfiguration(List<MountConfiguration> mountConfiguration) {
    this.mountConfiguration = mountConfiguration;
    return this;
  }

  public PoolAddParameter addMountConfigurationItem(MountConfiguration mountConfigurationItem) {
    if (this.mountConfiguration == null) {
      this.mountConfiguration = new ArrayList<>();
    }
    this.mountConfiguration.add(mountConfigurationItem);
    return this;
  }
  ...
  public void setMountConfiguration(List<MountConfiguration> mountConfiguration) {
    this.mountConfiguration = mountConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationLicenses, poolAddParameter.applicationLicenses) &&
        ...
        Objects.equals(this.mountConfiguration, poolAddParameter.mountConfiguration) &&
  ...
  public String toString() {
    ...
    sb.append("    mountConfiguration: ").append(toIndentedString(mountConfiguration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("mountConfiguration");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("mountConfiguration") != null && !jsonObj.get("mountConfiguration").isJsonNull()) {
        JsonArray jsonArraymountConfiguration = jsonObj.getAsJsonArray("mountConfiguration");
        if (jsonArraymountConfiguration != null) {
          // ensure the json data is an array
          if (!jsonObj.get("mountConfiguration").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `mountConfiguration` to be an array in the JSON string but got `%s`", jsonObj.get("mountConfiguration").toString()));
          }

          // validate the optional field `mountConfiguration` (array)
          for (int i = 0; i < jsonArraymountConfiguration.size(); i++) {
            MountConfiguration.validateJsonElement(jsonArraymountConfiguration.get(i));
          };
        }
      }
