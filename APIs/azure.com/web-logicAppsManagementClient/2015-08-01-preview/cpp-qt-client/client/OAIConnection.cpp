...
OAIObject OAIConnection::getProperties() const {
    return m_properties;
}
void OAIConnection::setProperties(const OAIObject &properties) {
...
QString OAIConnection::getKind() const {
    return m_kind;
}
void OAIConnection::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIConnection::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIConnection::is_kind_Valid() const{
    return m_kind_isValid;
}

QString OAIConnection::getLocation() const {
    return m_location;
}
void OAIConnection::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIConnection::is_location_Set() const{
    return m_location_isSet;
}

bool OAIConnection::is_location_Valid() const{
...
QMap<QString, QString> OAIConnection::getTags() const {
    return m_tags;
}
void OAIConnection::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIConnection::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIConnection::is_tags_Valid() const{
