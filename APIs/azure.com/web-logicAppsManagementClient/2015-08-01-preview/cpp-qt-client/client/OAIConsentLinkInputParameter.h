...
/*
 * OAIConsentLinkInputParameter.h
 *
 * 
 */

#ifndef OAIConsentLinkInputParameter_H
#define OAIConsentLinkInputParameter_H
...
class OAIConsentLinkInputParameter : public OAIObject {
public:
    OAIConsentLinkInputParameter();
    OAIConsentLinkInputParameter(QString json);
    ~OAIConsentLinkInputParameter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsentLinkInputParameter)

#endif // OAIConsentLinkInputParameter_H
