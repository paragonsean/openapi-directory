...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataLakeStoreAccountManagementClient.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new DataLakeStoreAccountManagementClient.ErrorDetails();
      //expect(instance).to.be.a(DataLakeStoreAccountManagementClient.ErrorDetails);
    });
