...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataLakeStoreAccountManagementClient.FirewallRule();
  });
  ...
  describe('FirewallRule', function() {
    it('should create an instance of FirewallRule', function() {
      ...
      //var instance = new DataLakeStoreAccountManagementClient.FirewallRule();
      //expect(instance).to.be.a(DataLakeStoreAccountManagementClient.FirewallRule);
    });
