...
/*
 * OAIEncryptionIdentity.h
 *
 * 
 */

#ifndef OAIEncryptionIdentity_H
#define OAIEncryptionIdentity_H
...
class OAIEncryptionIdentity : public OAIObject {
public:
    OAIEncryptionIdentity();
    OAIEncryptionIdentity(QString json);
    ~OAIEncryptionIdentity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncryptionIdentity)

#endif // OAIEncryptionIdentity_H
