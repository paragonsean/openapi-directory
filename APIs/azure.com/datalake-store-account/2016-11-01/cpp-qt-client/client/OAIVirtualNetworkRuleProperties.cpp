...
QString OAIVirtualNetworkRuleProperties::getSubnetId() const {
    return m_subnet_id;
}
void OAIVirtualNetworkRuleProperties::setSubnetId(const QString &subnet_id) {
    m_subnet_id = subnet_id;
    m_subnet_id_isSet = true;
}

bool OAIVirtualNetworkRuleProperties::is_subnet_id_Set() const{
    return m_subnet_id_isSet;
}

bool OAIVirtualNetworkRuleProperties::is_subnet_id_Valid() const{
