...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataLakeStoreAccountManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new DataLakeStoreAccountManagementClient.OperationDisplay();
      //expect(instance).to.be.a(DataLakeStoreAccountManagementClient.OperationDisplay);
    });
