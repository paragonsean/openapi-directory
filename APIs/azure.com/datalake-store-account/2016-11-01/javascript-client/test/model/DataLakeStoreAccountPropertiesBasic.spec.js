...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataLakeStoreAccountManagementClient.DataLakeStoreAccountPropertiesBasic();
  });
  ...
  describe('DataLakeStoreAccountPropertiesBasic', function() {
    it('should create an instance of DataLakeStoreAccountPropertiesBasic', function() {
      // uncomment below and update the code to test DataLakeStoreAccountPropertiesBasic
      //var instance = new DataLakeStoreAccountManagementClient.DataLakeStoreAccountPropertiesBasic();
      //expect(instance).to.be.a(DataLakeStoreAccountManagementClient.DataLakeStoreAccountPropertiesBasic);
    });
