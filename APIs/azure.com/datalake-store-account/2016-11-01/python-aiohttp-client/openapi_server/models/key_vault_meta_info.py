...
class KeyVaultMetaInfo(Model):
    ...
    def encryption_key_name(self, encryption_key_name):
        ...
        if encryption_key_name is None:
            raise ValueError("Invalid value for `encryption_key_name`, must not be `None`")
    ...
    def encryption_key_version(self, encryption_key_version):
        ...
        if encryption_key_version is None:
            raise ValueError("Invalid value for `encryption_key_version`, must not be `None`")
    ...
    def key_vault_resource_id(self, key_vault_resource_id):
        ...
        if key_vault_resource_id is None:
            raise ValueError("Invalid value for `key_vault_resource_id`, must not be `None`")
