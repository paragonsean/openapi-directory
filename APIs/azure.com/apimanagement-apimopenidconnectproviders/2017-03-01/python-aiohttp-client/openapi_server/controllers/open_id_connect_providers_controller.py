...
async def open_id_connect_provider_create_or_update(request: web.Request, resource_group_name, service_name, opid, api_version, subscription_id, parameters) -> web.Response:
