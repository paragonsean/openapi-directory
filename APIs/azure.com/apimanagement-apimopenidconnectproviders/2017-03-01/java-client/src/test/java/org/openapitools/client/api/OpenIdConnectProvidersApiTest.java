...
public class OpenIdConnectProvidersApiTest {
    ...
    public void openIdConnectProviderCreateOrUpdateTest() throws ApiException {
        ...
        OpenidConnectProviderContract response = api.openIdConnectProviderCreateOrUpdate(resourceGroupName, serviceName, opid, apiVersion, subscriptionId, parameters);
