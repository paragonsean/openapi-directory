...
[**openIdConnectProviderListSecrets**](OpenidConnectProviderApi.md#openIdConnectProviderListSecrets) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/openidConnectProviders/{opid}/listSecrets | 
...
> OpenIdConnectProviderListSecrets200Response openIdConnectProviderListSecrets(resourceGroupName, serviceName, opid, apiVersion, subscriptionId)
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
apiInstance.openIdConnectProviderListSecrets(resourceGroupName, serviceName, opid, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
