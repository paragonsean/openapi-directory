...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OpenIdConnectProviderListSecrets200Response();
  });
  ...
  describe('OpenIdConnectProviderListSecrets200Response', function() {
    it('should create an instance of OpenIdConnectProviderListSecrets200Response', function() {
      // uncomment below and update the code to test OpenIdConnectProviderListSecrets200Response
      //var instance = new ApiManagementClient.OpenIdConnectProviderListSecrets200Response();
      //expect(instance).to.be.a(ApiManagementClient.OpenIdConnectProviderListSecrets200Response);
    });
