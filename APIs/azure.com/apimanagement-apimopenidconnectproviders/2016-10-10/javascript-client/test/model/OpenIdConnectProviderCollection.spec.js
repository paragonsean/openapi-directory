...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OpenIdConnectProviderCollection();
  });
  ...
  describe('OpenIdConnectProviderCollection', function() {
    it('should create an instance of OpenIdConnectProviderCollection', function() {
      // uncomment below and update the code to test OpenIdConnectProviderCollection
      //var instance = new ApiManagementClient.OpenIdConnectProviderCollection();
      //expect(instance).to.be.a(ApiManagementClient.OpenIdConnectProviderCollection);
    });
