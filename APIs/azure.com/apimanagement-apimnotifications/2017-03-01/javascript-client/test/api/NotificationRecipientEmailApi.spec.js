...
(function(root, factory) {
  ...
  describe('NotificationRecipientEmailApi', function() {
    ...
    describe('notificationRecipientEmailGet', function() {
      it('should call notificationRecipientEmailGet successfully', function(done) {
        //uncomment below and update the code to test notificationRecipientEmailGet
        //instance.notificationRecipientEmailGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
