...
(function(root, factory) {
  ...
  describe('NotificationRecipientUserApi', function() {
    ...
    describe('notificationRecipientUserGet', function() {
      it('should call notificationRecipientUserGet successfully', function(done) {
        //uncomment below and update the code to test notificationRecipientUserGet
        //instance.notificationRecipientUserGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
