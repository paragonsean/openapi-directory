...
export default class NotificationRecipientEmailApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the notificationRecipientEmailGet operation.
     * @callback module:api/NotificationRecipientEmailApi~notificationRecipientEmailGetCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/NotificationRecipientEmailApi~notificationRecipientEmailGetCallback} callback The callback function, accepting three arguments: error, data, response
     */
    notificationRecipientEmailGet(resourceGroupName, serviceName, notificationName, email, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling notificationRecipientEmailGet");
      }
      // verify the required parameter 'serviceName' is set
      if (serviceName === undefined || serviceName === null) {
        throw new Error("Missing the required parameter 'serviceName' when calling notificationRecipientEmailGet");
      }
      // verify the required parameter 'notificationName' is set
      if (notificationName === undefined || notificationName === null) {
        throw new Error("Missing the required parameter 'notificationName' when calling notificationRecipientEmailGet");
      }
      // verify the required parameter 'email' is set
      if (email === undefined || email === null) {
        throw new Error("Missing the required parameter 'email' when calling notificationRecipientEmailGet");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling notificationRecipientEmailGet");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling notificationRecipientEmailGet");
      }
