...
> NotificationContract notificationCreateOrUpdate(resourceGroupName, serviceName, notificationName, apiVersion, subscriptionId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      NotificationContract result = apiInstance.notificationCreateOrUpdate(resourceGroupName, serviceName, notificationName, apiVersion, subscriptionId);
