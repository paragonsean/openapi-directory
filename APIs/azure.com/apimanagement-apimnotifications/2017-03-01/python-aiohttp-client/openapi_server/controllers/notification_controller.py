...
async def notification_create_or_update(request: web.Request, resource_group_name, service_name, notification_name, api_version, subscription_id) -> web.Response:
