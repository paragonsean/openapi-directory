...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.NotificationCollection();
  });
  ...
  describe('NotificationCollection', function() {
    it('should create an instance of NotificationCollection', function() {
      // uncomment below and update the code to test NotificationCollection
      //var instance = new ApiManagementClient.NotificationCollection();
      //expect(instance).to.be.a(ApiManagementClient.NotificationCollection);
    });
