...
export default class NotificationRecipientUserApi {
    ...
    */
     ...
     */
    notificationRecipientUserCheckEntityExists(resourceGroupName, serviceName, notificationName, uid, apiVersion, subscriptionId, callback) {
      let postBody = null;
      ...
      if (uid === undefined || uid === null) {
        throw new Error("Missing the required parameter 'uid' when calling notificationRecipientUserCheckEntityExists");
      }
