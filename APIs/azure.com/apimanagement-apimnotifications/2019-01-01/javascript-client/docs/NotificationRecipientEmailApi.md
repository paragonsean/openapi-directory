...
------------- | ------------- | -------------
[**notificationRecipientEmailCheckEntityExists**](NotificationRecipientEmailApi.md#notificationRecipientEmailCheckEntityExists) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/notifications/{notificationName}/recipientEmails/{email} | 
...
> notificationRecipientEmailCheckEntityExists(resourceGroupName, serviceName, notificationName, email, apiVersion, subscriptionId)
...
apiInstance.notificationRecipientEmailCheckEntityExists(resourceGroupName, serviceName, notificationName, email, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> NotificationRecipientEmailCreateOrUpdate200Response notificationRecipientEmailCreateOrUpdate(resourceGroupName, serviceName, notificationName, email, apiVersion, subscriptionId)
...
[**NotificationRecipientEmailCreateOrUpdate200Response**](NotificationRecipientEmailCreateOrUpdate200Response.md)
...
> NotificationRecipientEmailListByNotification200Response notificationRecipientEmailListByNotification(resourceGroupName, serviceName, notificationName, apiVersion, subscriptionId)
...
[**NotificationRecipientEmailListByNotification200Response**](NotificationRecipientEmailListByNotification200Response.md)
