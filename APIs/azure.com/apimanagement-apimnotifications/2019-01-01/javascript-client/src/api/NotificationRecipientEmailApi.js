...
export default class NotificationRecipientEmailApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/NotificationRecipientEmailCreateOrUpdate200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/NotificationRecipientEmailCreateOrUpdate200Response}
     */
    notificationRecipientEmailCreateOrUpdate(resourceGroupName, serviceName, notificationName, email, apiVersion, subscriptionId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = NotificationRecipientEmailCreateOrUpdate200Response;
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/NotificationRecipientEmailListByNotification200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/NotificationRecipientEmailListByNotification200Response}
     */
    notificationRecipientEmailListByNotification(resourceGroupName, serviceName, notificationName, apiVersion, subscriptionId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = NotificationRecipientEmailListByNotification200Response;
      return this.apiClient.callApi(
