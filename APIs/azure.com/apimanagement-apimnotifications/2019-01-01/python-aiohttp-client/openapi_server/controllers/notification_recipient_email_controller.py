...
async def notification_recipient_email_check_entity_exists(request: web.Request, resource_group_name, service_name, notification_name, email, api_version, subscription_id) -> web.Response:
