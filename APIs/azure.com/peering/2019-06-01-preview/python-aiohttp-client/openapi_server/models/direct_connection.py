...
class DirectConnection(Model):
    ...
    def __init__(self, bandwidth_in_mbps: int=None, bgp_session: BgpSession=None, connection_identifier: str=None, connection_state: str=None, peering_db_facility_id: int=None, provisioned_bandwidth_in_mbps: int=None):
