...
let checkServiceProviderAvailabilityInput = new PeeringManagementClient.CheckServiceProviderAvailabilityInput(); // CheckServiceProviderAvailabilityInput | The CheckServiceProviderAvailabilityInput.
