...
async def test_peering_services_create_or_update(client):
    ...
    """
    peering_service = {"location":"location","properties":{"provisioningState":"Succeeded","peeringServiceLocation":"peeringServiceLocation","peeringServiceProvider":"peeringServiceProvider"},"tags":{"key":"tags"}}
