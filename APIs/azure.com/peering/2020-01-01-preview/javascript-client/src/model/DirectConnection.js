...
class DirectConnection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sessionAddressProvider')) {
                obj['sessionAddressProvider'] = ApiClient.convertToType(data['sessionAddressProvider'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['sessionAddressProvider'] && !(typeof data['sessionAddressProvider'] === 'string' || data['sessionAddressProvider'] instanceof String)) {
            throw new Error("Expected the field `sessionAddressProvider` to be a primitive type in the JSON string but got " + data['sessionAddressProvider']);
        }
 ...
 */
DirectConnection.prototype['connectionIdentifier'] = undefined;
 ...
 */
DirectConnection.prototype['errorMessage'] = undefined;
 ...
 * @member {module:model/DirectConnection.SessionAddressProviderEnum} sessionAddressProvider
 */
DirectConnection.prototype['sessionAddressProvider'] = undefined;

/**
 * The flag that indicates whether or not the connection is used for peering service.
 * @member {Boolean} useForPeeringService
 */
DirectConnection.prototype['useForPeeringService'] = undefined;
...
/**
 * Allowed values for the <code>sessionAddressProvider</code> property.
 * @enum {String}
 * @readonly
 */
DirectConnection['SessionAddressProviderEnum'] = {
