...
> PeeringServiceLocationListResult peeringServiceLocationsList(subscriptionId, apiVersion, country)
...
public class Example {
  public static void main(String[] args) {
    ...
    String country = "country_example"; // String | The country of interest, in which the locations are to be present.
    try {
      PeeringServiceLocationListResult result = apiInstance.peeringServiceLocationsList(subscriptionId, apiVersion, country);
