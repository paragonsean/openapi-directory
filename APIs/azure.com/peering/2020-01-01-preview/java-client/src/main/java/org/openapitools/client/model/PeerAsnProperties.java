...
public class PeerAsnProperties {
  ...
  public static final String SERIALIZED_NAME_PEER_CONTACT_DETAIL = "peerContactDetail";
  @SerializedName(SERIALIZED_NAME_PEER_CONTACT_DETAIL)
  private List<ContactDetail> peerContactDetail = new ArrayList<>();
  ...
  public PeerAsnProperties peerContactDetail(List<ContactDetail> peerContactDetail) {
    this.peerContactDetail = peerContactDetail;
    return this;
  }

  public PeerAsnProperties addPeerContactDetailItem(ContactDetail peerContactDetailItem) {
    if (this.peerContactDetail == null) {
      this.peerContactDetail = new ArrayList<>();
    }
    this.peerContactDetail.add(peerContactDetailItem);
    return this;
  }

  /**
   * The contact details of the peer.
   * @return peerContactDetail
   */
  @javax.annotation.Nullable
  public List<ContactDetail> getPeerContactDetail() {
    return peerContactDetail;
  }

  public void setPeerContactDetail(List<ContactDetail> peerContactDetail) {
    this.peerContactDetail = peerContactDetail;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorMessage, peerAsnProperties.errorMessage) &&
        Objects.equals(this.peerAsn, peerAsnProperties.peerAsn) &&
        Objects.equals(this.peerContactDetail, peerAsnProperties.peerContactDetail) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errorMessage, peerAsn, peerContactDetail, peerName, validationState);
  }
  ...
  public String toString() {
    ...
    sb.append("    peerContactDetail: ").append(toIndentedString(peerContactDetail)).append("\n");
  ...
  static {
    ...
    openapiFields.add("peerContactDetail");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("peerContactDetail") != null && !jsonObj.get("peerContactDetail").isJsonNull()) {
        JsonArray jsonArraypeerContactDetail = jsonObj.getAsJsonArray("peerContactDetail");
        if (jsonArraypeerContactDetail != null) {
          // ensure the json data is an array
          if (!jsonObj.get("peerContactDetail").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `peerContactDetail` to be an array in the JSON string but got `%s`", jsonObj.get("peerContactDetail").toString()));
          }

          // validate the optional field `peerContactDetail` (array)
          for (int i = 0; i < jsonArraypeerContactDetail.size(); i++) {
            ContactDetail.validateJsonElement(jsonArraypeerContactDetail.get(i));
          };
        }
      }
