...
QString OAIPeeringServicePrefixProperties::getPeeringServicePrefixKey() const {
    return m_peering_service_prefix_key;
}
void OAIPeeringServicePrefixProperties::setPeeringServicePrefixKey(const QString &peering_service_prefix_key) {
    m_peering_service_prefix_key = peering_service_prefix_key;
    m_peering_service_prefix_key_isSet = true;
}

bool OAIPeeringServicePrefixProperties::is_peering_service_prefix_key_Set() const{
    return m_peering_service_prefix_key_isSet;
}

bool OAIPeeringServicePrefixProperties::is_peering_service_prefix_key_Valid() const{
