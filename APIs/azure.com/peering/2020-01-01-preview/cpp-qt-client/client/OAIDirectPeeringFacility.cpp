...
QString OAIDirectPeeringFacility::getDirectPeeringType() const {
    return m_direct_peering_type;
}
void OAIDirectPeeringFacility::setDirectPeeringType(const QString &direct_peering_type) {
    m_direct_peering_type = direct_peering_type;
    m_direct_peering_type_isSet = true;
}

bool OAIDirectPeeringFacility::is_direct_peering_type_Set() const{
    return m_direct_peering_type_isSet;
}

bool OAIDirectPeeringFacility::is_direct_peering_type_Valid() const{
