...
void OAIPeerAsnProperties::initializeModel() {
    ...
    m_peer_contact_detail_isSet = false;
    m_peer_contact_detail_isValid = false;
...
void OAIPeerAsnProperties::fromJsonObject(QJsonObject json) {
    ...
    m_peer_contact_detail_isValid = ::OpenAPI::fromJsonValue(m_peer_contact_detail, json[QString("peerContactDetail")]);
    m_peer_contact_detail_isSet = !json[QString("peerContactDetail")].isNull() && m_peer_contact_detail_isValid;
...
QJsonObject OAIPeerAsnProperties::asJsonObject() const {
    ...
    if (m_peer_contact_detail.size() > 0) {
        obj.insert(QString("peerContactDetail"), ::OpenAPI::toJsonValue(m_peer_contact_detail));
    }
...
QList<OAIContactDetail> OAIPeerAsnProperties::getPeerContactDetail() const {
    return m_peer_contact_detail;
}
void OAIPeerAsnProperties::setPeerContactDetail(const QList<OAIContactDetail> &peer_contact_detail) {
    m_peer_contact_detail = peer_contact_detail;
    m_peer_contact_detail_isSet = true;
}

bool OAIPeerAsnProperties::is_peer_contact_detail_Set() const{
    return m_peer_contact_detail_isSet;
}

bool OAIPeerAsnProperties::is_peer_contact_detail_Valid() const{
    return m_peer_contact_detail_isValid;
}
