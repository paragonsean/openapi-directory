...
class PeeringServicePrefixProperties(Model):
    ...
    def __init__(self, error_message: str=None, events: List[PeeringServicePrefixEvent]=None, learned_type: str=None, peering_service_prefix_key: str=None, prefix: str=None, prefix_validation_state: str=None, provisioning_state: str=None):
        ...
        :param peering_service_prefix_key: The peering_service_prefix_key of this PeeringServicePrefixProperties.
    ...
    def peering_service_prefix_key(self):
        """Gets the peering_service_prefix_key of this PeeringServicePrefixProperties.

        The peering service prefix key

        :return: The peering_service_prefix_key of this PeeringServicePrefixProperties.
        :rtype: str
        """
    ...
    def peering_service_prefix_key(self, peering_service_prefix_key):
        """Sets the peering_service_prefix_key of this PeeringServicePrefixProperties.
