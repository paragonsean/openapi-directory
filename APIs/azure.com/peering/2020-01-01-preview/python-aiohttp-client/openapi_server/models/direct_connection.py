...
class DirectConnection(Model):
    ...
    def __init__(self, bandwidth_in_mbps: int=None, bgp_session: BgpSession=None, connection_identifier: str=None, connection_state: str=None, error_message: str=None, peering_db_facility_id: int=None, provisioned_bandwidth_in_mbps: int=None, session_address_provider: str=None, use_for_peering_service: bool=None):
        ...
        :param error_message: The error_message of this DirectConnection.
    ...
    def error_message(self):
        """Gets the error_message of this DirectConnection.

        The error message related to the connection state, if any.

        :return: The error_message of this DirectConnection.
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        """Sets the error_message of this DirectConnection.
