...
QString OAIDirectConnection::getErrorMessage() const {
    return m_error_message;
}
void OAIDirectConnection::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIDirectConnection::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIDirectConnection::is_error_message_Valid() const{
