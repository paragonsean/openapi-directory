...
QString OAIPeerAsnProperties::getErrorMessage() const {
    return m_error_message;
}
void OAIPeerAsnProperties::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIPeerAsnProperties::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIPeerAsnProperties::is_error_message_Valid() const{
