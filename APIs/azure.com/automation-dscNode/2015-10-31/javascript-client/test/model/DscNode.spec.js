...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.DscNode();
  });
  ...
  describe('DscNode', function() {
    it('should create an instance of DscNode', function() {
      // uncomment below and update the code to test DscNode
      //var instance = new AutomationManagement.DscNode();
      //expect(instance).to.be.a(AutomationManagement.DscNode);
    });
