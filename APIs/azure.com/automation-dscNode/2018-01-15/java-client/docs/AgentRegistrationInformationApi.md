...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AgentRegistration result = apiInstance.agentRegistrationInformationGet(subscriptionId, resourceGroupName, automationAccountName, apiVersion);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AgentRegistration result = apiInstance.agentRegistrationInformationRegenerateKey(subscriptionId, resourceGroupName, automationAccountName, apiVersion, parameters);
      System.out.println(result);
    } catch (ApiException e) {
