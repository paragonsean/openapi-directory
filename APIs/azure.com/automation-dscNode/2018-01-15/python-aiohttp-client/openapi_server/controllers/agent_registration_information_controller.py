...
async def agent_registration_information_get(request: web.Request, subscription_id, resource_group_name, automation_account_name, api_version) -> web.Response:
...
async def agent_registration_information_regenerate_key(request: web.Request, subscription_id, resource_group_name, automation_account_name, api_version, parameters) -> web.Response:
