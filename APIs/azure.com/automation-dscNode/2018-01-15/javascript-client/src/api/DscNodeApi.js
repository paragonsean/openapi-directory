...
export default class DscNodeApi {
    ...
    */
     ...
     * @param {String} subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {String} apiVersion Client Api Version.
     * @param {module:model/DscNodeUpdateParameters} dscNodeUpdateParameters Parameters supplied to the update dsc node.
     ...
     * data is of type: {@link module:model/DscNode}
     */
    dscNodeUpdate(resourceGroupName, automationAccountName, nodeId, subscriptionId, apiVersion, dscNodeUpdateParameters, callback) {
      let postBody = dscNodeUpdateParameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
      ...
      if (dscNodeUpdateParameters === undefined || dscNodeUpdateParameters === null) {
        throw new Error("Missing the required parameter 'dscNodeUpdateParameters' when calling dscNodeUpdate");
      }
