...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MonitorManagementClient.AlertRule();
  });
  ...
  describe('AlertRule', function() {
    it('should create an instance of AlertRule', function() {
      ...
      //var instance = new MonitorManagementClient.AlertRule();
      //expect(instance).to.be.a(MonitorManagementClient.AlertRule);
    });
