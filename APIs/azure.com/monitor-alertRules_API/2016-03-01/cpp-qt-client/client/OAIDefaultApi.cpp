...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("alertRulesUpdate", defaultConf);
    _serverIndices.insert("alertRulesUpdate", 0);
}
...
void OAIDefaultApi::alertRulesUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &rule_name, const QString &api_version, const OAIAlertRuleResourcePatch &alert_rules_resource) {
    QString fullPath = QString(_serverConfigs["alertRulesUpdate"][_serverIndices.value("alertRulesUpdate")].URL()+"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/microsoft.insights/alertrules/{ruleName}");
...

    {
        ...
        QByteArray output = alert_rules_resource.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::alertRulesUpdateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::alertRulesUpdateCallback);
...
void OAIDefaultApi::alertRulesUpdateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT alertRulesUpdateSignal(output);
        Q_EMIT alertRulesUpdateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT alertRulesUpdateSignalE(output, error_type, error_str);
        Q_EMIT alertRulesUpdateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT alertRulesUpdateSignalError(output, error_type, error_str);
        Q_EMIT alertRulesUpdateSignalErrorFull(worker, error_type, error_str);
    }
}
