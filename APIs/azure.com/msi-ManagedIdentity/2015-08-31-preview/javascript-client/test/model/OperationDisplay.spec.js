...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedServiceIdentityClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ManagedServiceIdentityClient.OperationDisplay();
      //expect(instance).to.be.a(ManagedServiceIdentityClient.OperationDisplay);
    });
