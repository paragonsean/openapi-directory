...
QString OAIIdentity::getLocation() const {
    return m_location;
}
void OAIIdentity::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIIdentity::is_location_Set() const{
    return m_location_isSet;
}

bool OAIIdentity::is_location_Valid() const{
...
OAIIdentityProperties OAIIdentity::getProperties() const {
    return m_properties;
}
void OAIIdentity::setProperties(const OAIIdentityProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIIdentity::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIIdentity::is_properties_Valid() const{
    return m_properties_isValid;
}

QMap<QString, QString> OAIIdentity::getTags() const {
    return m_tags;
}
void OAIIdentity::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIIdentity::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIIdentity::is_tags_Valid() const{
