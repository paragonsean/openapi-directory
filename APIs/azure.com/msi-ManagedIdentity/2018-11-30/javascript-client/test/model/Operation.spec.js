...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedServiceIdentityClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ManagedServiceIdentityClient.Operation();
      //expect(instance).to.be.a(ManagedServiceIdentityClient.Operation);
    });
