...
void OAISecurityAssessmentMetadataProperties::initializeModel() {
    ...
    m_partner_data_isSet = false;
    m_partner_data_isValid = false;
...
void OAISecurityAssessmentMetadataProperties::fromJsonObject(QJsonObject json) {
    ...
    m_partner_data_isValid = ::OpenAPI::fromJsonValue(m_partner_data, json[QString("partnerData")]);
    m_partner_data_isSet = !json[QString("partnerData")].isNull() && m_partner_data_isValid;
...
QJsonObject OAISecurityAssessmentMetadataProperties::asJsonObject() const {
    ...
    if (m_partner_data.isSet()) {
        obj.insert(QString("partnerData"), ::OpenAPI::toJsonValue(m_partner_data));
    }
...
OAISecurityAssessmentMetadataPartnerData OAISecurityAssessmentMetadataProperties::getPartnerData() const {
    return m_partner_data;
}
void OAISecurityAssessmentMetadataProperties::setPartnerData(const OAISecurityAssessmentMetadataPartnerData &partner_data) {
    m_partner_data = partner_data;
    m_partner_data_isSet = true;
}

bool OAISecurityAssessmentMetadataProperties::is_partner_data_Set() const{
    return m_partner_data_isSet;
}

bool OAISecurityAssessmentMetadataProperties::is_partner_data_Valid() const{
    return m_partner_data_isValid;
}
