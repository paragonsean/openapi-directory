...
class SecurityAssessmentMetadataProperties(Model):
    ...
    def __init__(self, assessment_type: str=None, category: List[str]=None, description: str=None, display_name: str=None, implementation_effort: str=None, partner_data: SecurityAssessmentMetadataPartnerData=None, policy_definition_id: str=None, preview: bool=None, remediation_description: str=None, severity: str=None, threats: List[str]=None, user_impact: str=None):
        ...
        :param partner_data: The partner_data of this SecurityAssessmentMetadataProperties.
    ...
    def assessment_type(self, assessment_type):
        ...
        """
        allowed_values = ["BuiltIn", "CustomPolicy", "CustomerManaged", "VerifiedPartner"]  # noqa: E501
    ...
    def partner_data(self):
        """Gets the partner_data of this SecurityAssessmentMetadataProperties.


        :return: The partner_data of this SecurityAssessmentMetadataProperties.
        :rtype: SecurityAssessmentMetadataPartnerData
        """
        return self._partner_data

    @partner_data.setter
    def partner_data(self, partner_data):
        """Sets the partner_data of this SecurityAssessmentMetadataProperties.


        :param partner_data: The partner_data of this SecurityAssessmentMetadataProperties.
        :type partner_data: SecurityAssessmentMetadataPartnerData
        """
