...
import SecurityAssessmentMetadataPartnerData from './SecurityAssessmentMetadataPartnerData';
...
class SecurityAssessmentMetadataProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('partnerData')) {
                obj['partnerData'] = SecurityAssessmentMetadataPartnerData.constructFromObject(data['partnerData']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['partnerData']) { // data not null
          SecurityAssessmentMetadataPartnerData.validateJSON(data['partnerData']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/SecurityAssessmentMetadataPartnerData} partnerData
 */
SecurityAssessmentMetadataProperties.prototype['partnerData'] = undefined;
