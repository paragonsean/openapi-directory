...
async def test_assessments_metadata_subscription_create(client):
    ...
    """
    assessment_metadata = {"properties":{"preview":True,"severity":"Low","userImpact":"Low","policyDefinitionId":"policyDefinitionId","assessmentType":"BuiltIn","implementationEffort":"Low","displayName":"displayName","description":"description","threats":["accountBreach","accountBreach"],"remediationDescription":"remediationDescription","category":["Compute","Compute"]}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
