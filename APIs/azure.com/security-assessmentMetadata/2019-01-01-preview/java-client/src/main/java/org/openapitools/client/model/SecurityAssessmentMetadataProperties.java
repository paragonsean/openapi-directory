...
public class SecurityAssessmentMetadataProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assessmentType, category, description, displayName, implementationEffort, policyDefinitionId, preview, remediationDescription, severity, threats, userImpact);
  }
