...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.WorkflowAccessKeyProperties();
  });
  ...
  describe('WorkflowAccessKeyProperties', function() {
    it('should create an instance of WorkflowAccessKeyProperties', function() {
      // uncomment below and update the code to test WorkflowAccessKeyProperties
      //var instance = new LogicManagementClient.WorkflowAccessKeyProperties();
      //expect(instance).to.be.a(LogicManagementClient.WorkflowAccessKeyProperties);
    });
