...
(function(root, factory) {
  ...
  describe('WorkflowsApi', function() {
    ...
    describe('workflowsRun', function() {
      it('should call workflowsRun successfully', function(done) {
        //uncomment below and update the code to test workflowsRun
        //instance.workflowsRun(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
