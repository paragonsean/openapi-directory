...
QString OAIX12EnvelopeOverride::getResponsibleAgencyCode() const {
    return m_responsible_agency_code;
}
void OAIX12EnvelopeOverride::setResponsibleAgencyCode(const QString &responsible_agency_code) {
...
bool OAIX12EnvelopeOverride::isValid() const {
    ...
    return m_date_format_isValid && m_header_version_isValid && m_message_id_isValid && m_protocol_version_isValid && m_receiver_application_id_isValid && m_responsible_agency_code_isValid && m_sender_application_id_isValid && m_target_namespace_isValid && m_time_format_isValid && true;
}
