...
bool OAIAS2MdnSettings::isValid() const {
    ...
    return m_mic_hashing_algorithm_isValid && m_need_mdn_isValid && m_send_inbound_mdn_to_message_box_isValid && m_send_mdn_asynchronously_isValid && m_sign_mdn_isValid && m_sign_outbound_mdn_if_optional_isValid && true;
}
