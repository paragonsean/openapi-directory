...
public:
    ...
    * @param[in]  integration_account_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  parameters OAIGetCallbackUrlParameters [required]
    */
    virtual void integrationAccountsGetCallbackUrl(const QString &subscription_id, const QString &resource_group_name, const QString &integration_account_name, const QString &api_version, const OAIGetCallbackUrlParameters &parameters);
    ...
    * @param[in]  integration_account_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  list_key_vault_keys OAIListKeyVaultKeysDefinition [required]
    */
    virtual void integrationAccountsListKeyVaultKeys(const QString &subscription_id, const QString &resource_group_name, const QString &integration_account_name, const QString &api_version, const OAIListKeyVaultKeysDefinition &list_key_vault_keys);
    ...
    * @param[in]  integration_account_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  log_tracking_events OAITrackingEventsDefinition [required]
    */
    virtual void integrationAccountsLogTrackingEvents(const QString &subscription_id, const QString &resource_group_name, const QString &integration_account_name, const QString &api_version, const OAITrackingEventsDefinition &log_tracking_events);
    ...
    * @param[in]  integration_account_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  regenerate_access_key OAIRegenerateActionParameter [required]
    */
    virtual void integrationAccountsRegenerateAccessKey(const QString &subscription_id, const QString &resource_group_name, const QString &integration_account_name, const QString &api_version, const OAIRegenerateActionParameter &regenerate_access_key);
...
private:
    ...
    void integrationAccountsGetCallbackUrlCallback(OAIHttpRequestWorker *worker);
    ...
    void integrationAccountsListKeyVaultKeysCallback(OAIHttpRequestWorker *worker);
    void integrationAccountsLogTrackingEventsCallback(OAIHttpRequestWorker *worker);
    void integrationAccountsRegenerateAccessKeyCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void integrationAccountsGetCallbackUrlSignal(OAICallbackUrl summary);
    ...
    void integrationAccountsListKeyVaultKeysSignal(OAIKeyVaultKeyCollection summary);
    void integrationAccountsLogTrackingEventsSignal();
    void integrationAccountsRegenerateAccessKeySignal(OAIIntegrationAccount summary);
    ...
    void integrationAccountsGetCallbackUrlSignalFull(OAIHttpRequestWorker *worker, OAICallbackUrl summary);
    ...
    void integrationAccountsListKeyVaultKeysSignalFull(OAIHttpRequestWorker *worker, OAIKeyVaultKeyCollection summary);
    void integrationAccountsLogTrackingEventsSignalFull(OAIHttpRequestWorker *worker);
    void integrationAccountsRegenerateAccessKeySignalFull(OAIHttpRequestWorker *worker, OAIIntegrationAccount summary);
    ...
    Q_DECL_DEPRECATED_X("Use integrationAccountsGetCallbackUrlSignalError() instead")
    void integrationAccountsGetCallbackUrlSignalE(OAICallbackUrl summary, QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsGetCallbackUrlSignalError(OAICallbackUrl summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use integrationAccountsListKeyVaultKeysSignalError() instead")
    void integrationAccountsListKeyVaultKeysSignalE(OAIKeyVaultKeyCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsListKeyVaultKeysSignalError(OAIKeyVaultKeyCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use integrationAccountsLogTrackingEventsSignalError() instead")
    void integrationAccountsLogTrackingEventsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsLogTrackingEventsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use integrationAccountsRegenerateAccessKeySignalError() instead")
    void integrationAccountsRegenerateAccessKeySignalE(OAIIntegrationAccount summary, QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsRegenerateAccessKeySignalError(OAIIntegrationAccount summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use integrationAccountsGetCallbackUrlSignalErrorFull() instead")
    void integrationAccountsGetCallbackUrlSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsGetCallbackUrlSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use integrationAccountsListKeyVaultKeysSignalErrorFull() instead")
    void integrationAccountsListKeyVaultKeysSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsListKeyVaultKeysSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use integrationAccountsLogTrackingEventsSignalErrorFull() instead")
    void integrationAccountsLogTrackingEventsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsLogTrackingEventsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use integrationAccountsRegenerateAccessKeySignalErrorFull() instead")
    void integrationAccountsRegenerateAccessKeySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void integrationAccountsRegenerateAccessKeySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
