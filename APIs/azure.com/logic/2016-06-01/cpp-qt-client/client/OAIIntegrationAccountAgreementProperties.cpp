...
bool OAIIntegrationAccountAgreementProperties::isValid() const {
    ...
    return m_agreement_type_isValid && m_content_isValid && m_guest_identity_isValid && m_guest_partner_isValid && m_host_identity_isValid && m_host_partner_isValid && true;
}
