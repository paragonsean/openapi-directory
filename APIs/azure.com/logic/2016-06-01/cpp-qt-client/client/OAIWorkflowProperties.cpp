...
OAIResourceReference OAIWorkflowProperties::getIntegrationAccount() const {
    return m_integration_account;
}
void OAIWorkflowProperties::setIntegrationAccount(const OAIResourceReference &integration_account) {
    m_integration_account = integration_account;
    m_integration_account_isSet = true;
}

bool OAIWorkflowProperties::is_integration_account_Set() const{
    return m_integration_account_isSet;
}

bool OAIWorkflowProperties::is_integration_account_Valid() const{
