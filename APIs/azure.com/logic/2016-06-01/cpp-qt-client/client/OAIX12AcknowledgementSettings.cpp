...
bool OAIX12AcknowledgementSettings::isValid() const {
    ...
    return m_acknowledgement_control_number_lower_bound_isValid && m_acknowledgement_control_number_upper_bound_isValid && m_batch_functional_acknowledgements_isValid && m_batch_implementation_acknowledgements_isValid && m_batch_technical_acknowledgements_isValid && m_need_functional_acknowledgement_isValid && m_need_implementation_acknowledgement_isValid && m_need_loop_for_valid_messages_isValid && m_need_technical_acknowledgement_isValid && m_rollover_acknowledgement_control_number_isValid && m_send_synchronous_acknowledgement_isValid && true;
}
