...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void workflowRunActionScopedRepetitionsGet(const QString &subscription_id, const QString &resource_group_name, const QString &workflow_name, const QString &run_name, const QString &action_name, const QString &repetition_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void workflowRunActionScopedRepetitionsList(const QString &subscription_id, const QString &resource_group_name, const QString &workflow_name, const QString &run_name, const QString &action_name, const QString &api_version);
...
private:
    ...
    void workflowRunActionScopedRepetitionsGetCallback(OAIHttpRequestWorker *worker);
    void workflowRunActionScopedRepetitionsListCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void workflowRunActionScopedRepetitionsGetSignal(OAIWorkflowRunActionRepetitionDefinition summary);
    void workflowRunActionScopedRepetitionsListSignal(OAIWorkflowRunActionRepetitionDefinitionCollection summary);
    ...
    void workflowRunActionScopedRepetitionsGetSignalFull(OAIHttpRequestWorker *worker, OAIWorkflowRunActionRepetitionDefinition summary);
    void workflowRunActionScopedRepetitionsListSignalFull(OAIHttpRequestWorker *worker, OAIWorkflowRunActionRepetitionDefinitionCollection summary);
    ...
    Q_DECL_DEPRECATED_X("Use workflowRunActionScopedRepetitionsGetSignalError() instead")
    void workflowRunActionScopedRepetitionsGetSignalE(OAIWorkflowRunActionRepetitionDefinition summary, QNetworkReply::NetworkError error_type, QString error_str);
    void workflowRunActionScopedRepetitionsGetSignalError(OAIWorkflowRunActionRepetitionDefinition summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use workflowRunActionScopedRepetitionsListSignalError() instead")
    void workflowRunActionScopedRepetitionsListSignalE(OAIWorkflowRunActionRepetitionDefinitionCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void workflowRunActionScopedRepetitionsListSignalError(OAIWorkflowRunActionRepetitionDefinitionCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use workflowRunActionScopedRepetitionsGetSignalErrorFull() instead")
    void workflowRunActionScopedRepetitionsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workflowRunActionScopedRepetitionsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use workflowRunActionScopedRepetitionsListSignalErrorFull() instead")
    void workflowRunActionScopedRepetitionsListSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workflowRunActionScopedRepetitionsListSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
