...
bool OAIEdifactDelimiterOverride::isValid() const {
    ...
    return m_component_separator_isValid && m_data_element_separator_isValid && m_decimal_point_indicator_isValid && m_release_indicator_isValid && m_repetition_separator_isValid && m_segment_terminator_isValid && m_segment_terminator_suffix_isValid && true;
}
