...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.AccessKeyRegenerateActionDefinition.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.IntegrationAccountRosettaNetProcessConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.IntegrationAccountRosettaNetProcessConfigurationListResult.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.IntegrationAccountRosettaNetProcessConfigurationProperties.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.RosettaNetPipAcknowledgmentOfReceiptSettings.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.RosettaNetPipActivityBehavior.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.RosettaNetPipActivitySettings.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.RosettaNetPipBusinessDocument.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new org.openapitools.client.model.RosettaNetPipRoleSettings.CustomTypeAdapterFactory());
