...
public class KeyVaultReference {
  ...
  public KeyVaultReference name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, keyVaultReference.name) &&
        Objects.equals(this.id, keyVaultReference.id) &&
        Objects.equals(this.type, keyVaultReference.type);
  }
