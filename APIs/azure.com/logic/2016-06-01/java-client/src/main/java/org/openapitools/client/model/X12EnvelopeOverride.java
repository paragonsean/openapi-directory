...
public class X12EnvelopeOverride {
  ...
  public X12EnvelopeOverride responsibleAgencyCode(String responsibleAgencyCode) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : X12EnvelopeOverride.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `dateFormat`
      ...
      if (!jsonObj.get("headerVersion").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("protocolVersion").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("responsibleAgencyCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `responsibleAgencyCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("responsibleAgencyCode").toString()));
      }
      ...
      if (!jsonObj.get("targetNamespace").isJsonPrimitive()) {
