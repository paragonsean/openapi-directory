...
public class WorkflowRunProperties {
  ...
  public static final String SERIALIZED_NAME_WAIT_END_TIME = "waitEndTime";
  @SerializedName(SERIALIZED_NAME_WAIT_END_TIME)
  ...
  public WorkflowRunProperties correlation(Correlation correlation) {
  ...
  public WorkflowRunProperties response(WorkflowRunTrigger response) {
   ...
   */
  @javax.annotation.Nullable
  public WorkflowRunTrigger getResponse() {
    return response;
  }

  public void setResponse(WorkflowRunTrigger response) {
    this.response = response;
  }
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getWaitEndTime() {
    return waitEndTime;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, workflowRunProperties.code) &&
        Objects.equals(this.correlation, workflowRunProperties.correlation) &&
        ...
        Objects.equals(this.response, workflowRunProperties.response) &&
        ...
        Objects.equals(this.waitEndTime, workflowRunProperties.waitEndTime) &&
        Objects.equals(this.workflow, workflowRunProperties.workflow);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, correlation, correlationId, endTime, error, outputs, response, startTime, status, trigger, waitEndTime, workflow);
  }
  ...
  public String toString() {
    ...
    sb.append("    waitEndTime: ").append(toIndentedString(waitEndTime)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        WorkflowRunTrigger.validateJsonElement(jsonObj.get("response"));
      }
