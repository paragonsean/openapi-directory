...
public class WorkflowsApi {
     ...
     */
    public okhttp3.Call workflowsValidateCall(String subscriptionId, String resourceGroupName, String location, String workflowName, String apiVersion, Workflow workflow, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workflowsValidateValidateBeforeCall(String subscriptionId, String resourceGroupName, String location, String workflowName, String apiVersion, Workflow workflow, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        if (location == null) {
            throw new ApiException("Missing the required parameter 'location' when calling workflowsValidate(Async)");
        }
        ...
        return workflowsValidateCall(subscriptionId, resourceGroupName, location, workflowName, apiVersion, workflow, _callback);
     ...
     */
    public void workflowsValidate(String subscriptionId, String resourceGroupName, String location, String workflowName, String apiVersion, Workflow workflow) throws ApiException {
        workflowsValidateWithHttpInfo(subscriptionId, resourceGroupName, location, workflowName, apiVersion, workflow);
    }
     ...
     */
    public ApiResponse<Void> workflowsValidateWithHttpInfo(String subscriptionId, String resourceGroupName, String location, String workflowName, String apiVersion, Workflow workflow) throws ApiException {
        okhttp3.Call localVarCall = workflowsValidateValidateBeforeCall(subscriptionId, resourceGroupName, location, workflowName, apiVersion, workflow, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call workflowsValidateAsync(String subscriptionId, String resourceGroupName, String location, String workflowName, String apiVersion, Workflow workflow, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = workflowsValidateValidateBeforeCall(subscriptionId, resourceGroupName, location, workflowName, apiVersion, workflow, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for workflowsValidateWorkflow
     * @param subscriptionId The subscription id. (required)
     * @param resourceGroupName The resource group name. (required)
     * @param workflowName The workflow name. (required)
     * @param apiVersion The API version. (required)
     ...
     */
    public okhttp3.Call workflowsValidateWorkflowCall(String subscriptionId, String resourceGroupName, String workflowName, String apiVersion, Workflow validate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workflowsValidateWorkflowValidateBeforeCall(String subscriptionId, String resourceGroupName, String workflowName, String apiVersion, Workflow validate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling workflowsValidateWorkflow(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling workflowsValidateWorkflow(Async)");
        }

        // verify the required parameter 'workflowName' is set
        if (workflowName == null) {
            throw new ApiException("Missing the required parameter 'workflowName' when calling workflowsValidateWorkflow(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling workflowsValidateWorkflow(Async)");
        }

        // verify the required parameter 'validate' is set
        if (validate == null) {
            throw new ApiException("Missing the required parameter 'validate' when calling workflowsValidateWorkflow(Async)");
        }

        return workflowsValidateWorkflowCall(subscriptionId, resourceGroupName, workflowName, apiVersion, validate, _callback);
     ...
     */
    public void workflowsValidateWorkflow(String subscriptionId, String resourceGroupName, String workflowName, String apiVersion, Workflow validate) throws ApiException {
        workflowsValidateWorkflowWithHttpInfo(subscriptionId, resourceGroupName, workflowName, apiVersion, validate);
    }
     ...
     */
    public ApiResponse<Void> workflowsValidateWorkflowWithHttpInfo(String subscriptionId, String resourceGroupName, String workflowName, String apiVersion, Workflow validate) throws ApiException {
        okhttp3.Call localVarCall = workflowsValidateWorkflowValidateBeforeCall(subscriptionId, resourceGroupName, workflowName, apiVersion, validate, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call workflowsValidateWorkflowAsync(String subscriptionId, String resourceGroupName, String workflowName, String apiVersion, Workflow validate, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = workflowsValidateWorkflowValidateBeforeCall(subscriptionId, resourceGroupName, workflowName, apiVersion, validate, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
