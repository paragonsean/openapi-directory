...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IntegrationAccountSession result = apiInstance.sessionsCreateOrUpdate(subscriptionId, resourceGroupName, integrationAccountName, sessionName, apiVersion, session);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntegrationAccountSessionsApi#sessionsCreateOrUpdate");
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version.
    try {
      apiInstance.sessionsDelete(subscriptionId, resourceGroupName, integrationAccountName, sessionName, apiVersion);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntegrationAccountSessionsApi#sessionsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version.
    try {
      IntegrationAccountSession result = apiInstance.sessionsGet(subscriptionId, resourceGroupName, integrationAccountName, sessionName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntegrationAccountSessionsApi#sessionsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="sessionsListByIntegrationAccounts"></a>
# **sessionsListByIntegrationAccounts**
> IntegrationAccountSessionListResult sessionsListByIntegrationAccounts(subscriptionId, resourceGroupName, integrationAccountName, apiVersion, $top, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IntegrationAccountSessionListResult result = apiInstance.sessionsListByIntegrationAccounts(subscriptionId, resourceGroupName, integrationAccountName, apiVersion, $top, $filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntegrationAccountSessionsApi#sessionsListByIntegrationAccounts");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
