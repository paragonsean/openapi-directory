...
class AS2ValidationSettings(Model):
    ...
    def __init__(self, check_certificate_revocation_list_on_receive: bool=None, check_certificate_revocation_list_on_send: bool=None, check_duplicate_message: bool=None, compress_message: bool=None, encrypt_message: bool=None, encryption_algorithm: EncryptionAlgorithm=None, interchange_duplicates_validity_days: int=None, override_message_properties: bool=None, sign_message: bool=None, signing_algorithm: SigningAlgorithm=None):
        ...
        :param signing_algorithm: The signing_algorithm of this AS2ValidationSettings.
        """
        self.openapi_types = {
    ...
    def check_certificate_revocation_list_on_receive(self, check_certificate_revocation_list_on_receive):
        ...
        if check_certificate_revocation_list_on_receive is None:
            raise ValueError("Invalid value for `check_certificate_revocation_list_on_receive`, must not be `None`")
    ...
    def check_certificate_revocation_list_on_send(self, check_certificate_revocation_list_on_send):
        ...
        if check_certificate_revocation_list_on_send is None:
            raise ValueError("Invalid value for `check_certificate_revocation_list_on_send`, must not be `None`")
    ...
    def check_duplicate_message(self, check_duplicate_message):
        ...
        if check_duplicate_message is None:
            raise ValueError("Invalid value for `check_duplicate_message`, must not be `None`")
    ...
    def compress_message(self, compress_message):
        ...
        if compress_message is None:
            raise ValueError("Invalid value for `compress_message`, must not be `None`")
    ...
    def encrypt_message(self, encrypt_message):
        ...
        if encrypt_message is None:
            raise ValueError("Invalid value for `encrypt_message`, must not be `None`")
    ...
    def encryption_algorithm(self, encryption_algorithm):
        ...
        if encryption_algorithm is None:
            raise ValueError("Invalid value for `encryption_algorithm`, must not be `None`")
    ...
    def interchange_duplicates_validity_days(self, interchange_duplicates_validity_days):
        ...
        if interchange_duplicates_validity_days is None:
            raise ValueError("Invalid value for `interchange_duplicates_validity_days`, must not be `None`")
    ...
    def override_message_properties(self, override_message_properties):
        ...
        if override_message_properties is None:
            raise ValueError("Invalid value for `override_message_properties`, must not be `None`")
    ...
    def sign_message(self, sign_message):
        ...
        if sign_message is None:
            raise ValueError("Invalid value for `sign_message`, must not be `None`")

        self._sign_message = sign_message

    @property
    def signing_algorithm(self):
        """Gets the signing_algorithm of this AS2ValidationSettings.


        :return: The signing_algorithm of this AS2ValidationSettings.
    ...
    def signing_algorithm(self, signing_algorithm):
        """Sets the signing_algorithm of this AS2ValidationSettings.
