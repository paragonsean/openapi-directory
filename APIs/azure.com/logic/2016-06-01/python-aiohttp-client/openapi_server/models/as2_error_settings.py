...
class AS2ErrorSettings(Model):
    ...
    def resend_if_mdn_not_received(self, resend_if_mdn_not_received):
        ...
        if resend_if_mdn_not_received is None:
            raise ValueError("Invalid value for `resend_if_mdn_not_received`, must not be `None`")
    ...
    def suspend_duplicate_message(self, suspend_duplicate_message):
        ...
        if suspend_duplicate_message is None:
            raise ValueError("Invalid value for `suspend_duplicate_message`, must not be `None`")
