...
class X12EnvelopeOverride(Model):
    ...
    def header_version(self, header_version):
        ...
        if header_version is None:
            raise ValueError("Invalid value for `header_version`, must not be `None`")
    ...
    def responsible_agency_code(self, responsible_agency_code):
        ...
        if responsible_agency_code is None:
            raise ValueError("Invalid value for `responsible_agency_code`, must not be `None`")
    ...
    def target_namespace(self, target_namespace):
        ...
        if target_namespace is None:
            raise ValueError("Invalid value for `target_namespace`, must not be `None`")
