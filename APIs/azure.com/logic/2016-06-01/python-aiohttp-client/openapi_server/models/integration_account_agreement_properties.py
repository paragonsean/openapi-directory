...
class IntegrationAccountAgreementProperties(Model):
    ...
    def guest_identity(self, guest_identity):
        ...
        if guest_identity is None:
            raise ValueError("Invalid value for `guest_identity`, must not be `None`")
    ...
    def guest_partner(self, guest_partner):
        ...
        if guest_partner is None:
            raise ValueError("Invalid value for `guest_partner`, must not be `None`")
    ...
    def host_identity(self, host_identity):
        ...
        if host_identity is None:
            raise ValueError("Invalid value for `host_identity`, must not be `None`")
    ...
    def host_partner(self, host_partner):
        ...
        if host_partner is None:
            raise ValueError("Invalid value for `host_partner`, must not be `None`")
