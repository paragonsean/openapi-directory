...
class EdifactEnvelopeSettings(Model):
    ...
    def apply_delimiter_string_advice(self, apply_delimiter_string_advice):
        ...
        if apply_delimiter_string_advice is None:
            raise ValueError("Invalid value for `apply_delimiter_string_advice`, must not be `None`")
    ...
    def create_grouping_segments(self, create_grouping_segments):
        ...
        if create_grouping_segments is None:
            raise ValueError("Invalid value for `create_grouping_segments`, must not be `None`")
    ...
    def enable_default_group_headers(self, enable_default_group_headers):
        ...
        if enable_default_group_headers is None:
            raise ValueError("Invalid value for `enable_default_group_headers`, must not be `None`")
    ...
    def group_control_number_lower_bound(self, group_control_number_lower_bound):
        ...
        if group_control_number_lower_bound is None:
            raise ValueError("Invalid value for `group_control_number_lower_bound`, must not be `None`")
    ...
    def group_control_number_upper_bound(self, group_control_number_upper_bound):
        ...
        if group_control_number_upper_bound is None:
            raise ValueError("Invalid value for `group_control_number_upper_bound`, must not be `None`")
    ...
    def interchange_control_number_lower_bound(self, interchange_control_number_lower_bound):
        ...
        if interchange_control_number_lower_bound is None:
            raise ValueError("Invalid value for `interchange_control_number_lower_bound`, must not be `None`")
    ...
    def interchange_control_number_upper_bound(self, interchange_control_number_upper_bound):
        ...
        if interchange_control_number_upper_bound is None:
            raise ValueError("Invalid value for `interchange_control_number_upper_bound`, must not be `None`")
    ...
    def is_test_interchange(self, is_test_interchange):
        ...
        if is_test_interchange is None:
            raise ValueError("Invalid value for `is_test_interchange`, must not be `None`")
    ...
    def overwrite_existing_transaction_set_control_number(self, overwrite_existing_transaction_set_control_number):
        ...
        if overwrite_existing_transaction_set_control_number is None:
            raise ValueError("Invalid value for `overwrite_existing_transaction_set_control_number`, must not be `None`")
    ...
    def rollover_group_control_number(self, rollover_group_control_number):
        ...
        if rollover_group_control_number is None:
            raise ValueError("Invalid value for `rollover_group_control_number`, must not be `None`")
    ...
    def rollover_interchange_control_number(self, rollover_interchange_control_number):
        ...
        if rollover_interchange_control_number is None:
            raise ValueError("Invalid value for `rollover_interchange_control_number`, must not be `None`")
    ...
    def rollover_transaction_set_control_number(self, rollover_transaction_set_control_number):
        ...
        if rollover_transaction_set_control_number is None:
            raise ValueError("Invalid value for `rollover_transaction_set_control_number`, must not be `None`")
    ...
    def transaction_set_control_number_lower_bound(self, transaction_set_control_number_lower_bound):
        ...
        if transaction_set_control_number_lower_bound is None:
            raise ValueError("Invalid value for `transaction_set_control_number_lower_bound`, must not be `None`")
    ...
    def transaction_set_control_number_upper_bound(self, transaction_set_control_number_upper_bound):
        ...
        if transaction_set_control_number_upper_bound is None:
            raise ValueError("Invalid value for `transaction_set_control_number_upper_bound`, must not be `None`")
