...
class X12EnvelopeSettings(Model):
    ...
    def control_standards_id(self, control_standards_id):
        ...
        if control_standards_id is None:
            raise ValueError("Invalid value for `control_standards_id`, must not be `None`")
    ...
    def control_version_number(self, control_version_number):
        ...
        if control_version_number is None:
            raise ValueError("Invalid value for `control_version_number`, must not be `None`")
    ...
    def group_header_agency_code(self, group_header_agency_code):
        ...
        if group_header_agency_code is None:
            raise ValueError("Invalid value for `group_header_agency_code`, must not be `None`")
    ...
    def group_header_date_format(self, group_header_date_format):
        ...
        if group_header_date_format is None:
            raise ValueError("Invalid value for `group_header_date_format`, must not be `None`")
    ...
    def group_header_time_format(self, group_header_time_format):
        ...
        if group_header_time_format is None:
            raise ValueError("Invalid value for `group_header_time_format`, must not be `None`")
    ...
    def group_header_version(self, group_header_version):
        ...
        if group_header_version is None:
            raise ValueError("Invalid value for `group_header_version`, must not be `None`")
    ...
    def receiver_application_id(self, receiver_application_id):
        ...
        if receiver_application_id is None:
            raise ValueError("Invalid value for `receiver_application_id`, must not be `None`")
    ...
    def sender_application_id(self, sender_application_id):
        ...
        if sender_application_id is None:
            raise ValueError("Invalid value for `sender_application_id`, must not be `None`")
    ...
    def usage_indicator(self, usage_indicator):
        ...
        if usage_indicator is None:
            raise ValueError("Invalid value for `usage_indicator`, must not be `None`")
    ...
    def use_control_standards_id_as_repetition_character(self, use_control_standards_id_as_repetition_character):
        ...
        if use_control_standards_id_as_repetition_character is None:
            raise ValueError("Invalid value for `use_control_standards_id_as_repetition_character`, must not be `None`")
