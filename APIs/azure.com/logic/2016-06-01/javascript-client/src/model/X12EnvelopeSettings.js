...
class X12EnvelopeSettings {
     ...
     * @param controlStandardsId {Number} The controls standards id.
     * @param controlVersionNumber {String} The control version number.
     ...
     * @param groupHeaderAgencyCode {String} The group header agency code.
     * @param groupHeaderDateFormat {module:model/X12DateFormat} 
     * @param groupHeaderTimeFormat {module:model/X12TimeFormat} 
     * @param groupHeaderVersion {String} The group header version.
     ...
     */
    static initialize(obj, controlStandardsId, controlVersionNumber, enableDefaultGroupHeaders, groupControlNumberLowerBound, groupControlNumberUpperBound, groupHeaderAgencyCode, groupHeaderDateFormat, groupHeaderTimeFormat, groupHeaderVersion, interchangeControlNumberLowerBound, interchangeControlNumberUpperBound, overwriteExistingTransactionSetControlNumber, receiverApplicationId, rolloverGroupControlNumber, rolloverInterchangeControlNumber, rolloverTransactionSetControlNumber, senderApplicationId, transactionSetControlNumberLowerBound, transactionSetControlNumberUpperBound, usageIndicator, useControlStandardsIdAsRepetitionCharacter) { 
        obj['controlStandardsId'] = controlStandardsId;
        obj['controlVersionNumber'] = controlVersionNumber;
        ...
        obj['groupHeaderAgencyCode'] = groupHeaderAgencyCode;
        obj['groupHeaderDateFormat'] = groupHeaderDateFormat;
        obj['groupHeaderTimeFormat'] = groupHeaderTimeFormat;
        obj['groupHeaderVersion'] = groupHeaderVersion;
        ...
        obj['usageIndicator'] = usageIndicator;
        obj['useControlStandardsIdAsRepetitionCharacter'] = useControlStandardsIdAsRepetitionCharacter;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of X12EnvelopeSettings.RequiredProperties) {
...
X12EnvelopeSettings.RequiredProperties = ["controlStandardsId", "controlVersionNumber", "enableDefaultGroupHeaders", "groupControlNumberLowerBound", "groupControlNumberUpperBound", "groupHeaderAgencyCode", "groupHeaderDateFormat", "groupHeaderTimeFormat", "groupHeaderVersion", "interchangeControlNumberLowerBound", "interchangeControlNumberUpperBound", "overwriteExistingTransactionSetControlNumber", "receiverApplicationId", "rolloverGroupControlNumber", "rolloverInterchangeControlNumber", "rolloverTransactionSetControlNumber", "senderApplicationId", "transactionSetControlNumberLowerBound", "transactionSetControlNumberUpperBound", "usageIndicator", "useControlStandardsIdAsRepetitionCharacter"];
