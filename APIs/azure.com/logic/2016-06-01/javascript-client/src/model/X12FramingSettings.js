...
class X12FramingSettings {
     ...
     * @param characterSet {module:model/X12CharacterSet} 
     * @param componentSeparator {Number} The component separator.
     * @param dataElementSeparator {Number} The data element separator.
     * @param replaceCharacter {Number} The replacement character.
     * @param replaceSeparatorsInPayload {Boolean} The value indicating whether to replace separators in payload.
     * @param segmentTerminator {Number} The segment terminator.
     * @param segmentTerminatorSuffix {module:model/SegmentTerminatorSuffix} 
     */
    constructor(characterSet, componentSeparator, dataElementSeparator, replaceCharacter, replaceSeparatorsInPayload, segmentTerminator, segmentTerminatorSuffix) { 
        
        X12FramingSettings.initialize(this, characterSet, componentSeparator, dataElementSeparator, replaceCharacter, replaceSeparatorsInPayload, segmentTerminator, segmentTerminatorSuffix);
    }
     ...
     */
    static initialize(obj, characterSet, componentSeparator, dataElementSeparator, replaceCharacter, replaceSeparatorsInPayload, segmentTerminator, segmentTerminatorSuffix) { 
        obj['characterSet'] = characterSet;
        obj['componentSeparator'] = componentSeparator;
        obj['dataElementSeparator'] = dataElementSeparator;
        obj['replaceCharacter'] = replaceCharacter;
        obj['replaceSeparatorsInPayload'] = replaceSeparatorsInPayload;
    ...
    static validateJSON(data) {
        ...
        for (const property of X12FramingSettings.RequiredProperties) {
...
X12FramingSettings.RequiredProperties = ["characterSet", "componentSeparator", "dataElementSeparator", "replaceCharacter", "replaceSeparatorsInPayload", "segmentTerminator", "segmentTerminatorSuffix"];
