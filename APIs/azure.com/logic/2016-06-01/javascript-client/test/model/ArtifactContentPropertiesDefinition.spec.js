...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.ArtifactContentPropertiesDefinition();
  });
  ...
  describe('ArtifactContentPropertiesDefinition', function() {
    it('should create an instance of ArtifactContentPropertiesDefinition', function() {
      // uncomment below and update the code to test ArtifactContentPropertiesDefinition
      //var instance = new LogicManagementClient.ArtifactContentPropertiesDefinition();
      //expect(instance).to.be.a(LogicManagementClient.ArtifactContentPropertiesDefinition);
    });
