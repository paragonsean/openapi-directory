...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new LogicManagementClient.ErrorResponse();
      //expect(instance).to.be.a(LogicManagementClient.ErrorResponse);
    });
