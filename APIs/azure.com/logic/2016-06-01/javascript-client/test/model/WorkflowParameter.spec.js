...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.WorkflowParameter();
  });
  ...
  describe('WorkflowParameter', function() {
    it('should create an instance of WorkflowParameter', function() {
      ...
      //var instance = new LogicManagementClient.WorkflowParameter();
      //expect(instance).to.be.a(LogicManagementClient.WorkflowParameter);
    });
