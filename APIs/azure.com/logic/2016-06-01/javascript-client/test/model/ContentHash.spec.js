...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.ContentHash();
  });
  ...
  describe('ContentHash', function() {
    it('should create an instance of ContentHash', function() {
      ...
      //var instance = new LogicManagementClient.ContentHash();
      //expect(instance).to.be.a(LogicManagementClient.ContentHash);
    });
