...
**encryptionAlgorithm** | [**EncryptionAlgorithm**](EncryptionAlgorithm.md) |  | 
**interchangeDuplicatesValidityDays** | **Number** | The number of days to look back for duplicate interchange. | 
...
**signingAlgorithm** | [**SigningAlgorithm**](SigningAlgorithm.md) |  | [optional] 
