# LogicManagementClient.WorkflowTriggerHistoryProperties
...
**endTime** | **Date** | Gets the end time. | [optional] [readonly] 
...
**startTime** | **Date** | Gets the start time. | [optional] [readonly] 
