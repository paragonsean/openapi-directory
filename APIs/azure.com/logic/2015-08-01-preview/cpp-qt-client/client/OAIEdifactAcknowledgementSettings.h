...
/*
 * OAIEdifactAcknowledgementSettings.h
 *
 * 
 */

#ifndef OAIEdifactAcknowledgementSettings_H
#define OAIEdifactAcknowledgementSettings_H
...
class OAIEdifactAcknowledgementSettings : public OAIObject {
public:
    OAIEdifactAcknowledgementSettings();
    OAIEdifactAcknowledgementSettings(QString json);
    ~OAIEdifactAcknowledgementSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEdifactAcknowledgementSettings)

#endif // OAIEdifactAcknowledgementSettings_H
