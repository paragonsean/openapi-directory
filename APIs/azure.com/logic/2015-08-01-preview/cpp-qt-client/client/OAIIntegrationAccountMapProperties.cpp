...
OAIIntegrationAccountContentLink OAIIntegrationAccountMapProperties::getContentLink() const {
    return m_content_link;
}
void OAIIntegrationAccountMapProperties::setContentLink(const OAIIntegrationAccountContentLink &content_link) {
