...
|**encryptionAlgorithm** | **EncryptionAlgorithm** |  |  [optional] |
|**interchangeDuplicatesValidityDays** | **Integer** | The number of days to look back for duplicate interchange. |  [optional] |
