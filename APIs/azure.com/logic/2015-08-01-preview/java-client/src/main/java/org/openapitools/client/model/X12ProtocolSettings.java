...
public class X12ProtocolSettings {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("acknowledgementSettings") != null && !jsonObj.get("acknowledgementSettings").isJsonNull()) {
      ...
      if (jsonObj.get("envelopeSettings") != null && !jsonObj.get("envelopeSettings").isJsonNull()) {
        X12EnvelopeSettings.validateJsonElement(jsonObj.get("envelopeSettings"));
      }
      // validate the optional field `framingSettings`
      if (jsonObj.get("framingSettings") != null && !jsonObj.get("framingSettings").isJsonNull()) {
        X12FramingSettings.validateJsonElement(jsonObj.get("framingSettings"));
      }
      // validate the optional field `messageFilter`
      if (jsonObj.get("messageFilter") != null && !jsonObj.get("messageFilter").isJsonNull()) {
      ...
      if (jsonObj.get("schemaReferences") != null && !jsonObj.get("schemaReferences").isJsonNull()) {
        JsonArray jsonArrayschemaReferences = jsonObj.getAsJsonArray("schemaReferences");
        if (jsonArrayschemaReferences != null) {
          // ensure the json data is an array
      ...
      if (jsonObj.get("validationSettings") != null && !jsonObj.get("validationSettings").isJsonNull()) {
