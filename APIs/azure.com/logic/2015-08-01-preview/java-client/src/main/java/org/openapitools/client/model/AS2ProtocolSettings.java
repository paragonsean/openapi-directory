...
public class AS2ProtocolSettings {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("acknowledgementConnectionSettings") != null && !jsonObj.get("acknowledgementConnectionSettings").isJsonNull()) {
      ...
      if (jsonObj.get("errorSettings") != null && !jsonObj.get("errorSettings").isJsonNull()) {
        AS2ErrorSettings.validateJsonElement(jsonObj.get("errorSettings"));
      }
      // validate the optional field `mdnSettings`
      if (jsonObj.get("mdnSettings") != null && !jsonObj.get("mdnSettings").isJsonNull()) {
        AS2MdnSettings.validateJsonElement(jsonObj.get("mdnSettings"));
      }
      // validate the optional field `messageConnectionSettings`
      if (jsonObj.get("messageConnectionSettings") != null && !jsonObj.get("messageConnectionSettings").isJsonNull()) {
