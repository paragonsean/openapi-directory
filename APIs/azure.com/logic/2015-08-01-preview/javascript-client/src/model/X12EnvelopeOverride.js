...
class X12EnvelopeOverride {
    ...
    constructor() { 
        ...
        X12EnvelopeOverride.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('responsibleAgencyCode')) {
                obj['responsibleAgencyCode'] = ApiClient.convertToType(data['responsibleAgencyCode'], 'Number');
            }
 ...
 * @member {Number} responsibleAgencyCode
 */
