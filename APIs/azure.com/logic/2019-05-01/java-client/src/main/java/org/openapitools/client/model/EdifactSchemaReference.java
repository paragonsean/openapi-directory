...
public class EdifactSchemaReference {
  ...
  static {
    ...
    openapiRequiredFields.add("messageRelease");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : EdifactSchemaReference.openapiRequiredFields) {
      ...
      if (!jsonObj.get("messageRelease").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("messageVersion").isJsonPrimitive()) {
