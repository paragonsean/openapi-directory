...
public class IntegrationAccountAgreementProperties {
  ...
  static {
    ...
    openapiRequiredFields.add("guestIdentity");
    openapiRequiredFields.add("guestPartner");
    openapiRequiredFields.add("hostIdentity");
    openapiRequiredFields.add("hostPartner");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : IntegrationAccountAgreementProperties.openapiRequiredFields) {
      ...
      // validate the required field `guestIdentity`
      BusinessIdentity.validateJsonElement(jsonObj.get("guestIdentity"));
      if (!jsonObj.get("guestPartner").isJsonPrimitive()) {
      ...
      // validate the required field `hostIdentity`
      BusinessIdentity.validateJsonElement(jsonObj.get("hostIdentity"));
      if (!jsonObj.get("hostPartner").isJsonPrimitive()) {
