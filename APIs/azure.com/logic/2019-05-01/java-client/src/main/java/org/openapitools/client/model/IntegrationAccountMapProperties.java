...
public class IntegrationAccountMapProperties {
  ...
  public IntegrationAccountMapProperties contentLink(ContentLink contentLink) {
  ...
  public IntegrationAccountMapProperties parametersSchema(IntegrationAccountMapPropertiesParametersSchema parametersSchema) {
   ...
   */
  @javax.annotation.Nullable
  public IntegrationAccountMapPropertiesParametersSchema getParametersSchema() {
    return parametersSchema;
  }

  public void setParametersSchema(IntegrationAccountMapPropertiesParametersSchema parametersSchema) {
    this.parametersSchema = parametersSchema;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.changedTime, integrationAccountMapProperties.changedTime) &&
        ...
        Objects.equals(this.parametersSchema, integrationAccountMapProperties.parametersSchema);
  }

  @Override
  public int hashCode() {
    return Objects.hash(changedTime, content, contentLink, contentType, createdTime, mapType, metadata, parametersSchema);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : IntegrationAccountMapProperties.openapiRequiredFields) {
      ...
      if (jsonObj.get("parametersSchema") != null && !jsonObj.get("parametersSchema").isJsonNull()) {
        IntegrationAccountMapPropertiesParametersSchema.validateJsonElement(jsonObj.get("parametersSchema"));
      }
  }
