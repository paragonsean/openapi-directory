...
public class WorkflowRunActionsApi {
    ...
    /**
     * Build call for workflowRunActionScopeRepetitionsGet
     * @param subscriptionId The subscription id. (required)
     * @param resourceGroupName The resource group name. (required)
     * @param workflowName The workflow name. (required)
     * @param runName The workflow run name. (required)
     ...
     */
    public okhttp3.Call workflowRunActionScopeRepetitionsGetCall(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String repetitionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workflowRunActionScopeRepetitionsGetValidateBeforeCall(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String repetitionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling workflowRunActionScopeRepetitionsGet(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling workflowRunActionScopeRepetitionsGet(Async)");
        }

        // verify the required parameter 'workflowName' is set
        if (workflowName == null) {
            throw new ApiException("Missing the required parameter 'workflowName' when calling workflowRunActionScopeRepetitionsGet(Async)");
        }

        // verify the required parameter 'runName' is set
        if (runName == null) {
            throw new ApiException("Missing the required parameter 'runName' when calling workflowRunActionScopeRepetitionsGet(Async)");
        }

        // verify the required parameter 'actionName' is set
        if (actionName == null) {
            throw new ApiException("Missing the required parameter 'actionName' when calling workflowRunActionScopeRepetitionsGet(Async)");
        }

        // verify the required parameter 'repetitionName' is set
        if (repetitionName == null) {
            throw new ApiException("Missing the required parameter 'repetitionName' when calling workflowRunActionScopeRepetitionsGet(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling workflowRunActionScopeRepetitionsGet(Async)");
        }

        return workflowRunActionScopeRepetitionsGetCall(subscriptionId, resourceGroupName, workflowName, runName, actionName, repetitionName, apiVersion, _callback);
     ...
     */
    public WorkflowRunActionRepetitionDefinition workflowRunActionScopeRepetitionsGet(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String repetitionName, String apiVersion) throws ApiException {
        ApiResponse<WorkflowRunActionRepetitionDefinition> localVarResp = workflowRunActionScopeRepetitionsGetWithHttpInfo(subscriptionId, resourceGroupName, workflowName, runName, actionName, repetitionName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowRunActionRepetitionDefinition> workflowRunActionScopeRepetitionsGetWithHttpInfo(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String repetitionName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = workflowRunActionScopeRepetitionsGetValidateBeforeCall(subscriptionId, resourceGroupName, workflowName, runName, actionName, repetitionName, apiVersion, null);
        Type localVarReturnType = new TypeToken<WorkflowRunActionRepetitionDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call workflowRunActionScopeRepetitionsGetAsync(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String repetitionName, String apiVersion, final ApiCallback<WorkflowRunActionRepetitionDefinition> _callback) throws ApiException {

        okhttp3.Call localVarCall = workflowRunActionScopeRepetitionsGetValidateBeforeCall(subscriptionId, resourceGroupName, workflowName, runName, actionName, repetitionName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<WorkflowRunActionRepetitionDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for workflowRunActionScopeRepetitionsList
     * @param subscriptionId The subscription id. (required)
     * @param resourceGroupName The resource group name. (required)
     * @param workflowName The workflow name. (required)
     * @param runName The workflow run name. (required)
     ...
     */
    public okhttp3.Call workflowRunActionScopeRepetitionsListCall(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workflowRunActionScopeRepetitionsListValidateBeforeCall(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling workflowRunActionScopeRepetitionsList(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling workflowRunActionScopeRepetitionsList(Async)");
        }

        // verify the required parameter 'workflowName' is set
        if (workflowName == null) {
            throw new ApiException("Missing the required parameter 'workflowName' when calling workflowRunActionScopeRepetitionsList(Async)");
        }

        // verify the required parameter 'runName' is set
        if (runName == null) {
            throw new ApiException("Missing the required parameter 'runName' when calling workflowRunActionScopeRepetitionsList(Async)");
        }

        // verify the required parameter 'actionName' is set
        if (actionName == null) {
            throw new ApiException("Missing the required parameter 'actionName' when calling workflowRunActionScopeRepetitionsList(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling workflowRunActionScopeRepetitionsList(Async)");
        }

        return workflowRunActionScopeRepetitionsListCall(subscriptionId, resourceGroupName, workflowName, runName, actionName, apiVersion, _callback);
     ...
     */
    public WorkflowRunActionRepetitionDefinitionCollection workflowRunActionScopeRepetitionsList(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String apiVersion) throws ApiException {
        ApiResponse<WorkflowRunActionRepetitionDefinitionCollection> localVarResp = workflowRunActionScopeRepetitionsListWithHttpInfo(subscriptionId, resourceGroupName, workflowName, runName, actionName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowRunActionRepetitionDefinitionCollection> workflowRunActionScopeRepetitionsListWithHttpInfo(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = workflowRunActionScopeRepetitionsListValidateBeforeCall(subscriptionId, resourceGroupName, workflowName, runName, actionName, apiVersion, null);
        Type localVarReturnType = new TypeToken<WorkflowRunActionRepetitionDefinitionCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call workflowRunActionScopeRepetitionsListAsync(String subscriptionId, String resourceGroupName, String workflowName, String runName, String actionName, String apiVersion, final ApiCallback<WorkflowRunActionRepetitionDefinitionCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = workflowRunActionScopeRepetitionsListValidateBeforeCall(subscriptionId, resourceGroupName, workflowName, runName, actionName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<WorkflowRunActionRepetitionDefinitionCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
