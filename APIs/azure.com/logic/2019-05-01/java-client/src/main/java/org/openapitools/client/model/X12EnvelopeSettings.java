...
public class X12EnvelopeSettings {
  ...
  static {
    ...
    openapiRequiredFields.add("controlStandardsId");
    openapiRequiredFields.add("controlVersionNumber");
    ...
    openapiRequiredFields.add("groupHeaderAgencyCode");
    openapiRequiredFields.add("groupHeaderDateFormat");
    openapiRequiredFields.add("groupHeaderTimeFormat");
    openapiRequiredFields.add("groupHeaderVersion");
    ...
    openapiRequiredFields.add("receiverApplicationId");
    ...
    openapiRequiredFields.add("senderApplicationId");
    ...
    openapiRequiredFields.add("usageIndicator");
    openapiRequiredFields.add("useControlStandardsIdAsRepetitionCharacter");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : X12EnvelopeSettings.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("controlVersionNumber").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("groupHeaderAgencyCode").isJsonPrimitive()) {
      ...
      // validate the required field `groupHeaderDateFormat`
      X12DateFormat.validateJsonElement(jsonObj.get("groupHeaderDateFormat"));
      // validate the required field `groupHeaderTimeFormat`
      X12TimeFormat.validateJsonElement(jsonObj.get("groupHeaderTimeFormat"));
      if (!jsonObj.get("groupHeaderVersion").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("receiverApplicationId").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("senderApplicationId").isJsonPrimitive()) {
      ...
      // validate the required field `usageIndicator`
