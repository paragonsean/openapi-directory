...
let workflowName = "workflowName_example"; // String | The workflow name.
let apiVersion = "apiVersion_example"; // String | The API version.
apiInstance.workflowsValidateByLocation(subscriptionId, resourceGroupName, location, workflowName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.workflowsValidateByResourceGroup(subscriptionId, resourceGroupName, workflowName, apiVersion, validate, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
