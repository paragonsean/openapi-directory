...
class AS2AcknowledgementConnectionSettings {
     ...
     * @param ignoreCertificateNameMismatch {Boolean} Indicates whether to ignore mismatch in certificate name.
     * @param keepHttpConnectionAlive {Boolean} Indicates whether to keep the connection alive.
     * @param supportHttpStatusCodeContinue {Boolean} Indicates whether to support HTTP status code 'CONTINUE'.
     * @param unfoldHttpHeaders {Boolean} Indicates whether to unfold the HTTP headers.
     */
