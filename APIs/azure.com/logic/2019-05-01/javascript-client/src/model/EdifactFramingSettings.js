...
class EdifactFramingSettings {
     ...
     * @param characterSet {module:model/EdifactCharacterSet} 
     ...
     */
    constructor(characterSet, componentSeparator, dataElementSeparator, decimalPointIndicator, protocolVersion, releaseIndicator, repetitionSeparator, segmentTerminator, segmentTerminatorSuffix) { 
        
        EdifactFramingSettings.initialize(this, characterSet, componentSeparator, dataElementSeparator, decimalPointIndicator, protocolVersion, releaseIndicator, repetitionSeparator, segmentTerminator, segmentTerminatorSuffix);
    }
     ...
     */
    static initialize(obj, characterSet, componentSeparator, dataElementSeparator, decimalPointIndicator, protocolVersion, releaseIndicator, repetitionSeparator, segmentTerminator, segmentTerminatorSuffix) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of EdifactFramingSettings.RequiredProperties) {
...
EdifactFramingSettings.RequiredProperties = ["characterSet", "componentSeparator", "dataElementSeparator", "decimalPointIndicator", "protocolVersion", "releaseIndicator", "repetitionSeparator", "segmentTerminator", "segmentTerminatorSuffix"];
