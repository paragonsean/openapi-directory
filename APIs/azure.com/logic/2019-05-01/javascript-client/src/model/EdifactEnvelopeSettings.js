...
class EdifactEnvelopeSettings {
     ...
     * @param applyDelimiterStringAdvice {Boolean} The value indicating whether to apply delimiter string advice.
     * @param createGroupingSegments {Boolean} The value indicating whether to create grouping segments.
     * @param enableDefaultGroupHeaders {Boolean} The value indicating whether to enable default group headers.
     * @param groupControlNumberLowerBound {Number} The group control number lower bound.
     * @param groupControlNumberUpperBound {Number} The group control number upper bound.
     * @param interchangeControlNumberLowerBound {Number} The interchange control number lower bound.
     * @param interchangeControlNumberUpperBound {Number} The interchange control number upper bound.
     * @param isTestInterchange {Boolean} The value indicating whether the message is a test interchange.
     * @param overwriteExistingTransactionSetControlNumber {Boolean} The value indicating whether to overwrite existing transaction set control number.
     * @param rolloverGroupControlNumber {Boolean} The value indicating whether to rollover group control number.
     * @param rolloverInterchangeControlNumber {Boolean} The value indicating whether to rollover interchange control number.
     * @param rolloverTransactionSetControlNumber {Boolean} The value indicating whether to rollover transaction set control number.
     * @param transactionSetControlNumberLowerBound {Number} The transaction set control number lower bound.
     * @param transactionSetControlNumberUpperBound {Number} The transaction set control number upper bound.
     */
    constructor(applyDelimiterStringAdvice, createGroupingSegments, enableDefaultGroupHeaders, groupControlNumberLowerBound, groupControlNumberUpperBound, interchangeControlNumberLowerBound, interchangeControlNumberUpperBound, isTestInterchange, overwriteExistingTransactionSetControlNumber, rolloverGroupControlNumber, rolloverInterchangeControlNumber, rolloverTransactionSetControlNumber, transactionSetControlNumberLowerBound, transactionSetControlNumberUpperBound) { 
        
        EdifactEnvelopeSettings.initialize(this, applyDelimiterStringAdvice, createGroupingSegments, enableDefaultGroupHeaders, groupControlNumberLowerBound, groupControlNumberUpperBound, interchangeControlNumberLowerBound, interchangeControlNumberUpperBound, isTestInterchange, overwriteExistingTransactionSetControlNumber, rolloverGroupControlNumber, rolloverInterchangeControlNumber, rolloverTransactionSetControlNumber, transactionSetControlNumberLowerBound, transactionSetControlNumberUpperBound);
    }
     ...
     */
    static initialize(obj, applyDelimiterStringAdvice, createGroupingSegments, enableDefaultGroupHeaders, groupControlNumberLowerBound, groupControlNumberUpperBound, interchangeControlNumberLowerBound, interchangeControlNumberUpperBound, isTestInterchange, overwriteExistingTransactionSetControlNumber, rolloverGroupControlNumber, rolloverInterchangeControlNumber, rolloverTransactionSetControlNumber, transactionSetControlNumberLowerBound, transactionSetControlNumberUpperBound) { 
        obj['applyDelimiterStringAdvice'] = applyDelimiterStringAdvice;
        obj['createGroupingSegments'] = createGroupingSegments;
        obj['enableDefaultGroupHeaders'] = enableDefaultGroupHeaders;
        obj['groupControlNumberLowerBound'] = groupControlNumberLowerBound;
        obj['groupControlNumberUpperBound'] = groupControlNumberUpperBound;
        obj['interchangeControlNumberLowerBound'] = interchangeControlNumberLowerBound;
        obj['interchangeControlNumberUpperBound'] = interchangeControlNumberUpperBound;
        obj['isTestInterchange'] = isTestInterchange;
        obj['overwriteExistingTransactionSetControlNumber'] = overwriteExistingTransactionSetControlNumber;
        obj['rolloverGroupControlNumber'] = rolloverGroupControlNumber;
        obj['rolloverInterchangeControlNumber'] = rolloverInterchangeControlNumber;
        obj['rolloverTransactionSetControlNumber'] = rolloverTransactionSetControlNumber;
        obj['transactionSetControlNumberLowerBound'] = transactionSetControlNumberLowerBound;
        obj['transactionSetControlNumberUpperBound'] = transactionSetControlNumberUpperBound;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of EdifactEnvelopeSettings.RequiredProperties) {
...
EdifactEnvelopeSettings.RequiredProperties = ["applyDelimiterStringAdvice", "createGroupingSegments", "enableDefaultGroupHeaders", "groupControlNumberLowerBound", "groupControlNumberUpperBound", "interchangeControlNumberLowerBound", "interchangeControlNumberUpperBound", "isTestInterchange", "overwriteExistingTransactionSetControlNumber", "rolloverGroupControlNumber", "rolloverInterchangeControlNumber", "rolloverTransactionSetControlNumber", "transactionSetControlNumberLowerBound", "transactionSetControlNumberUpperBound"];
