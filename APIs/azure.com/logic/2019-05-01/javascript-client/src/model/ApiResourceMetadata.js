...
import ApiDeploymentParameterMetadataSet from './ApiDeploymentParameterMetadataSet';
...
class ApiResourceMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('deploymentParameters')) {
                obj['deploymentParameters'] = ApiDeploymentParameterMetadataSet.constructFromObject(data['deploymentParameters']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['deploymentParameters']) { // data not null
          ApiDeploymentParameterMetadataSet.validateJSON(data['deploymentParameters']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ApiDeploymentParameterMetadataSet} deploymentParameters
 */
ApiResourceMetadata.prototype['deploymentParameters'] = undefined;
 ...
 */
ApiResourceMetadata.prototype['provisioningState'] = undefined;
