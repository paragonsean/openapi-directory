...
export default class WorkflowRunActionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the workflowRunActionScopeRepetitionsGet operation.
     * @callback module:api/WorkflowRunActionsApi~workflowRunActionScopeRepetitionsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/WorkflowRunActionRepetitionDefinition} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repetitionName The workflow repetition.
     * @param {String} apiVersion The API version.
     * @param {module:api/WorkflowRunActionsApi~workflowRunActionScopeRepetitionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WorkflowRunActionRepetitionDefinition}
     */
    workflowRunActionScopeRepetitionsGet(subscriptionId, resourceGroupName, workflowName, runName, actionName, repetitionName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling workflowRunActionScopeRepetitionsGet");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling workflowRunActionScopeRepetitionsGet");
      }
      // verify the required parameter 'workflowName' is set
      if (workflowName === undefined || workflowName === null) {
        throw new Error("Missing the required parameter 'workflowName' when calling workflowRunActionScopeRepetitionsGet");
      }
      // verify the required parameter 'runName' is set
      if (runName === undefined || runName === null) {
        throw new Error("Missing the required parameter 'runName' when calling workflowRunActionScopeRepetitionsGet");
      }
      // verify the required parameter 'actionName' is set
      if (actionName === undefined || actionName === null) {
        throw new Error("Missing the required parameter 'actionName' when calling workflowRunActionScopeRepetitionsGet");
      }
      // verify the required parameter 'repetitionName' is set
      if (repetitionName === undefined || repetitionName === null) {
        throw new Error("Missing the required parameter 'repetitionName' when calling workflowRunActionScopeRepetitionsGet");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling workflowRunActionScopeRepetitionsGet");
      }
    ...
    /**
     * Callback function to receive the result of the workflowRunActionScopeRepetitionsList operation.
     * @callback module:api/WorkflowRunActionsApi~workflowRunActionScopeRepetitionsListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/WorkflowRunActionRepetitionDefinitionCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} actionName The workflow action name.
     * @param {String} apiVersion The API version.
     * @param {module:api/WorkflowRunActionsApi~workflowRunActionScopeRepetitionsListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WorkflowRunActionRepetitionDefinitionCollection}
     */
    workflowRunActionScopeRepetitionsList(subscriptionId, resourceGroupName, workflowName, runName, actionName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling workflowRunActionScopeRepetitionsList");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling workflowRunActionScopeRepetitionsList");
      }
      // verify the required parameter 'workflowName' is set
      if (workflowName === undefined || workflowName === null) {
        throw new Error("Missing the required parameter 'workflowName' when calling workflowRunActionScopeRepetitionsList");
      }
      // verify the required parameter 'runName' is set
      if (runName === undefined || runName === null) {
        throw new Error("Missing the required parameter 'runName' when calling workflowRunActionScopeRepetitionsList");
      }
      // verify the required parameter 'actionName' is set
      if (actionName === undefined || actionName === null) {
        throw new Error("Missing the required parameter 'actionName' when calling workflowRunActionScopeRepetitionsList");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling workflowRunActionScopeRepetitionsList");
      }
