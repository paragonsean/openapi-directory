...
export default class IntegrationAccountAgreementsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the integrationAccountAgreementsListContentCallbackUrl operation.
     * @callback module:api/IntegrationAccountAgreementsApi~integrationAccountAgreementsListContentCallbackUrlCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/IntegrationAccountAgreementsApi~integrationAccountAgreementsListContentCallbackUrlCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WorkflowTriggerCallbackUrl}
     */
    integrationAccountAgreementsListContentCallbackUrl(subscriptionId, resourceGroupName, integrationAccountName, agreementName, apiVersion, listContentCallbackUrl, callback) {
      let postBody = listContentCallbackUrl;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling integrationAccountAgreementsListContentCallbackUrl");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling integrationAccountAgreementsListContentCallbackUrl");
      }
      // verify the required parameter 'integrationAccountName' is set
      if (integrationAccountName === undefined || integrationAccountName === null) {
        throw new Error("Missing the required parameter 'integrationAccountName' when calling integrationAccountAgreementsListContentCallbackUrl");
      }
      // verify the required parameter 'agreementName' is set
      if (agreementName === undefined || agreementName === null) {
        throw new Error("Missing the required parameter 'agreementName' when calling integrationAccountAgreementsListContentCallbackUrl");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling integrationAccountAgreementsListContentCallbackUrl");
      }
      ...
      if (listContentCallbackUrl === undefined || listContentCallbackUrl === null) {
        throw new Error("Missing the required parameter 'listContentCallbackUrl' when calling integrationAccountAgreementsListContentCallbackUrl");
      }
