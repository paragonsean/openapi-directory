...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.WorkflowRun();
  });
  ...
  describe('WorkflowRun', function() {
    it('should create an instance of WorkflowRun', function() {
      ...
      //var instance = new LogicManagementClient.WorkflowRun();
      //expect(instance).to.be.a(LogicManagementClient.WorkflowRun);
    });
