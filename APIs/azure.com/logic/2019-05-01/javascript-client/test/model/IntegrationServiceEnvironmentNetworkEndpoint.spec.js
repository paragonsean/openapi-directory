...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.IntegrationServiceEnvironmentNetworkEndpoint();
  });
  ...
  describe('IntegrationServiceEnvironmentNetworkEndpoint', function() {
    it('should create an instance of IntegrationServiceEnvironmentNetworkEndpoint', function() {
      // uncomment below and update the code to test IntegrationServiceEnvironmentNetworkEndpoint
      //var instance = new LogicManagementClient.IntegrationServiceEnvironmentNetworkEndpoint();
      //expect(instance).to.be.a(LogicManagementClient.IntegrationServiceEnvironmentNetworkEndpoint);
    });
