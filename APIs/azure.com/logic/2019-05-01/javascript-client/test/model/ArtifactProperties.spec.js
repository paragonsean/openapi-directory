...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.ArtifactProperties();
  });
  ...
  describe('ArtifactProperties', function() {
    it('should create an instance of ArtifactProperties', function() {
      // uncomment below and update the code to test ArtifactProperties
      //var instance = new LogicManagementClient.ArtifactProperties();
      //expect(instance).to.be.a(LogicManagementClient.ArtifactProperties);
    });
