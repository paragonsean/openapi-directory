...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogicManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new LogicManagementClient.OperationDisplay();
      //expect(instance).to.be.a(LogicManagementClient.OperationDisplay);
    });
