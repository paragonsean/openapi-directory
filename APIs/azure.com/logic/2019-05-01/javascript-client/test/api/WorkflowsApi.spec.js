...
(function(root, factory) {
  ...
  describe('WorkflowsApi', function() {
    ...
    describe('workflowsValidateByLocation', function() {
      it('should call workflowsValidateByLocation successfully', function(done) {
        //uncomment below and update the code to test workflowsValidateByLocation
        //instance.workflowsValidateByLocation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('workflowsValidateByResourceGroup', function() {
      it('should call workflowsValidateByResourceGroup successfully', function(done) {
        //uncomment below and update the code to test workflowsValidateByResourceGroup
        //instance.workflowsValidateByResourceGroup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
