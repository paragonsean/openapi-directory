...
OAIApiTier OAIApiResourceProperties::getCategory() const {
    return m_category;
}
void OAIApiResourceProperties::setCategory(const OAIApiTier &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIApiResourceProperties::is_category_Set() const{
    return m_category_isSet;
}

bool OAIApiResourceProperties::is_category_Valid() const{
    return m_category_isValid;
}

QMap<QString, OAIObject> OAIApiResourceProperties::getConnectionParameters() const {
    return m_connection_parameters;
}
void OAIApiResourceProperties::setConnectionParameters(const QMap<QString, OAIObject> &connection_parameters) {
...
OAIResourceReference OAIApiResourceProperties::getIntegrationServiceEnvironment() const {
    return m_integration_service_environment;
}
void OAIApiResourceProperties::setIntegrationServiceEnvironment(const OAIResourceReference &integration_service_environment) {
    m_integration_service_environment = integration_service_environment;
    m_integration_service_environment_isSet = true;
}

bool OAIApiResourceProperties::is_integration_service_environment_Set() const{
    return m_integration_service_environment_isSet;
}

bool OAIApiResourceProperties::is_integration_service_environment_Valid() const{
...
OAIWorkflowProvisioningState OAIApiResourceProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIApiResourceProperties::setProvisioningState(const OAIWorkflowProvisioningState &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAIApiResourceProperties::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAIApiResourceProperties::is_provisioning_state_Valid() const{
