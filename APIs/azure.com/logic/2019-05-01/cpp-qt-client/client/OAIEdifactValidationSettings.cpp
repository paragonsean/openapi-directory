...
bool OAIEdifactValidationSettings::isValid() const {
    ...
    return m_allow_leading_and_trailing_spaces_and_zeroes_isValid && m_check_duplicate_group_control_number_isValid && m_check_duplicate_interchange_control_number_isValid && m_check_duplicate_transaction_set_control_number_isValid && m_interchange_control_number_validity_days_isValid && m_trailing_separator_policy_isValid && m_trim_leading_and_trailing_spaces_and_zeroes_isValid && m_validate_character_set_isValid && m_validate_edi_types_isValid && m_validate_xsd_types_isValid && true;
}
