...
/*
 * OAIEdifactValidationSettings.h
 *
 * The Edifact agreement validation settings.
 */

#ifndef OAIEdifactValidationSettings_H
#define OAIEdifactValidationSettings_H
...
class OAIEdifactValidationSettings : public OAIObject {
public:
    OAIEdifactValidationSettings();
    OAIEdifactValidationSettings(QString json);
    ~OAIEdifactValidationSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEdifactValidationSettings)

#endif // OAIEdifactValidationSettings_H
