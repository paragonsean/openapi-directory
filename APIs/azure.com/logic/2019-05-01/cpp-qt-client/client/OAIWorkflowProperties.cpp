...
OAIFlowEndpointsConfiguration OAIWorkflowProperties::getEndpointsConfiguration() const {
    return m_endpoints_configuration;
}
void OAIWorkflowProperties::setEndpointsConfiguration(const OAIFlowEndpointsConfiguration &endpoints_configuration) {
    m_endpoints_configuration = endpoints_configuration;
    m_endpoints_configuration_isSet = true;
}

bool OAIWorkflowProperties::is_endpoints_configuration_Set() const{
    return m_endpoints_configuration_isSet;
}

bool OAIWorkflowProperties::is_endpoints_configuration_Valid() const{
...
OAIResourceReference OAIWorkflowProperties::getIntegrationServiceEnvironment() const {
    return m_integration_service_environment;
}
void OAIWorkflowProperties::setIntegrationServiceEnvironment(const OAIResourceReference &integration_service_environment) {
    m_integration_service_environment = integration_service_environment;
    m_integration_service_environment_isSet = true;
}

bool OAIWorkflowProperties::is_integration_service_environment_Set() const{
    return m_integration_service_environment_isSet;
}

bool OAIWorkflowProperties::is_integration_service_environment_Valid() const{
