...
void OAIWorkflowRunProperties::initializeModel() {
    ...
    m_wait_end_time_isSet = false;
    m_wait_end_time_isValid = false;
...
void OAIWorkflowRunProperties::fromJsonObject(QJsonObject json) {
    ...
    m_wait_end_time_isValid = ::OpenAPI::fromJsonValue(m_wait_end_time, json[QString("waitEndTime")]);
    m_wait_end_time_isSet = !json[QString("waitEndTime")].isNull() && m_wait_end_time_isValid;
...
QJsonObject OAIWorkflowRunProperties::asJsonObject() const {
    ...
    if (m_wait_end_time_isSet) {
        obj.insert(QString("waitEndTime"), ::OpenAPI::toJsonValue(m_wait_end_time));
    }
    if (m_workflow.isSet()) {
...
OAICorrelation OAIWorkflowRunProperties::getCorrelation() const {
    return m_correlation;
}
void OAIWorkflowRunProperties::setCorrelation(const OAICorrelation &correlation) {
    m_correlation = correlation;
    m_correlation_isSet = true;
}

bool OAIWorkflowRunProperties::is_correlation_Set() const{
    return m_correlation_isSet;
}

bool OAIWorkflowRunProperties::is_correlation_Valid() const{
...
OAIWorkflowRunTrigger OAIWorkflowRunProperties::getResponse() const {
    return m_response;
}
void OAIWorkflowRunProperties::setResponse(const OAIWorkflowRunTrigger &response) {
    m_response = response;
    m_response_isSet = true;
}

bool OAIWorkflowRunProperties::is_response_Set() const{
    return m_response_isSet;
}

bool OAIWorkflowRunProperties::is_response_Valid() const{
...
QDateTime OAIWorkflowRunProperties::getWaitEndTime() const {
    return m_wait_end_time;
}
void OAIWorkflowRunProperties::setWaitEndTime(const QDateTime &wait_end_time) {
    m_wait_end_time = wait_end_time;
    m_wait_end_time_isSet = true;
}

bool OAIWorkflowRunProperties::is_wait_end_time_Set() const{
    return m_wait_end_time_isSet;
}

bool OAIWorkflowRunProperties::is_wait_end_time_Valid() const{
    return m_wait_end_time_isValid;
}
