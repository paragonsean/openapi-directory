...
public:
    ...
    */
    virtual void integrationAccountsListCallbackUrl(const QString &subscription_id, const QString &resource_group_name, const QString &integration_account_name, const QString &api_version, const OAIGetCallbackUrlParameters &parameters);
