...
namespace OpenAPI {
class OAIApiOperationPropertiesDefinition;
...
public:
    ...
    OAIApiOperationPropertiesDefinition getProperties() const;
    void setProperties(const OAIApiOperationPropertiesDefinition &properties);
...
private:
    ...
    OAIApiOperationPropertiesDefinition m_properties;
