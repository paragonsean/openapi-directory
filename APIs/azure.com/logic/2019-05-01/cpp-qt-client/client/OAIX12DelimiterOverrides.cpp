...
bool OAIX12DelimiterOverrides::isValid() const {
    ...
    return m_component_separator_isValid && m_data_element_separator_isValid && m_replace_character_isValid && m_replace_separators_in_payload_isValid && m_segment_terminator_isValid && m_segment_terminator_suffix_isValid && true;
}
