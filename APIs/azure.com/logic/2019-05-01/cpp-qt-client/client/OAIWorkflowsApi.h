...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void workflowsValidateByLocation(const QString &subscription_id, const QString &resource_group_name, const QString &location, const QString &workflow_name, const QString &api_version);
    ...
    */
    virtual void workflowsValidateByResourceGroup(const QString &subscription_id, const QString &resource_group_name, const QString &workflow_name, const QString &api_version, const OAIWorkflow &validate);
...
private:
    ...
    void workflowsValidateByLocationCallback(OAIHttpRequestWorker *worker);
    void workflowsValidateByResourceGroupCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void workflowsValidateByLocationSignal();
    void workflowsValidateByResourceGroupSignal();
    ...
    void workflowsValidateByLocationSignalFull(OAIHttpRequestWorker *worker);
    void workflowsValidateByResourceGroupSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use workflowsValidateByLocationSignalError() instead")
    void workflowsValidateByLocationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void workflowsValidateByLocationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use workflowsValidateByResourceGroupSignalError() instead")
    void workflowsValidateByResourceGroupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void workflowsValidateByResourceGroupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use workflowsValidateByLocationSignalErrorFull() instead")
    void workflowsValidateByLocationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workflowsValidateByLocationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use workflowsValidateByResourceGroupSignalErrorFull() instead")
    void workflowsValidateByResourceGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workflowsValidateByResourceGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
