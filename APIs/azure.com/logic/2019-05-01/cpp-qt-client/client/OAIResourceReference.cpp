...
QString OAIResourceReference::getName() const {
    return m_name;
}
void OAIResourceReference::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIResourceReference::is_name_Set() const{
    return m_name_isSet;
}

bool OAIResourceReference::is_name_Valid() const{
