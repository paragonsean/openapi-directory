...
bool OAIEdifactValidationOverride::isValid() const {
    ...
    return m_allow_leading_and_trailing_spaces_and_zeroes_isValid && m_enforce_character_set_isValid && m_message_id_isValid && m_trailing_separator_policy_isValid && m_trim_leading_and_trailing_spaces_and_zeroes_isValid && m_validate_edi_types_isValid && m_validate_xsd_types_isValid && true;
}
