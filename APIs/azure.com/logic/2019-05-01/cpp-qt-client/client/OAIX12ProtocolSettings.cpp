...
bool OAIX12ProtocolSettings::isValid() const {
    ...
    return m_acknowledgement_settings_isValid && m_envelope_settings_isValid && m_framing_settings_isValid && m_message_filter_isValid && m_processing_settings_isValid && m_schema_references_isValid && m_security_settings_isValid && m_validation_settings_isValid && true;
}
