...
bool OAIEdifactProcessingSettings::isValid() const {
    ...
    return m_create_empty_xml_tags_for_trailing_separators_isValid && m_mask_security_info_isValid && m_preserve_interchange_isValid && m_suspend_interchange_on_error_isValid && m_use_dot_as_decimal_separator_isValid && true;
}
