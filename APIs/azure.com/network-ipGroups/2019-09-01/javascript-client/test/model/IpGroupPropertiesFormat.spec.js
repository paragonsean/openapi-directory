...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.IpGroupPropertiesFormat();
  });
  ...
  describe('IpGroupPropertiesFormat', function() {
    it('should create an instance of IpGroupPropertiesFormat', function() {
      // uncomment below and update the code to test IpGroupPropertiesFormat
      //var instance = new NetworkManagementClient.IpGroupPropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.IpGroupPropertiesFormat);
    });
