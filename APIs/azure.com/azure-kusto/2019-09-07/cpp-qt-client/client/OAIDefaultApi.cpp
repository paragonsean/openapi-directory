...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("clustersListSkus", defaultConf);
    _serverIndices.insert("clustersListSkus", 0);
}
...
void OAIDefaultApi::clustersListSkus(const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["clustersListSkus"][_serverIndices.value("clustersListSkus")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Kusto/skus");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::clustersListSkusCallback);
...
void OAIDefaultApi::clustersListSkusCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISkuDescriptionList output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT clustersListSkusSignal(output);
        Q_EMIT clustersListSkusSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT clustersListSkusSignalE(output, error_type, error_str);
        Q_EMIT clustersListSkusSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT clustersListSkusSignalError(output, error_type, error_str);
        Q_EMIT clustersListSkusSignalErrorFull(worker, error_type, error_str);
    }
}
