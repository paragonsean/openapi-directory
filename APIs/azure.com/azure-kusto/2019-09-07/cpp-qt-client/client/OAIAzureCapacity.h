...
#ifndef OAIAzureCapacity_H
#define OAIAzureCapacity_H
...
class OAIAzureCapacity : public OAIObject {
public:
    OAIAzureCapacity();
    OAIAzureCapacity(QString json);
    ~OAIAzureCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureCapacity)

#endif // OAIAzureCapacity_H
