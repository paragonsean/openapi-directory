...
public:
    ...
    OAIClusterProperties getProperties() const;
    void setProperties(const OAIClusterProperties &properties);
...
private:
    ...
    OAIClusterProperties m_properties;
