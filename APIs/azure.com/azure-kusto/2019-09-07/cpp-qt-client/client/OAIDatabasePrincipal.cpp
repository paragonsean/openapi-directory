...
QString OAIDatabasePrincipal::getTenantName() const {
    return m_tenant_name;
}
void OAIDatabasePrincipal::setTenantName(const QString &tenant_name) {
    m_tenant_name = tenant_name;
    m_tenant_name_isSet = true;
}

bool OAIDatabasePrincipal::is_tenant_name_Set() const{
    return m_tenant_name_isSet;
}

bool OAIDatabasePrincipal::is_tenant_name_Valid() const{
