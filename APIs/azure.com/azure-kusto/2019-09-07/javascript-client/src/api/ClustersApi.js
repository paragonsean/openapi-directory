...
export default class ClustersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the clustersDetachFollowerDatabases operation.
     * @callback module:api/ClustersApi~clustersDetachFollowerDatabasesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {String} apiVersion Client API Version.
     * @param {module:model/FollowerDatabaseDefinition} followerDatabaseToRemove The follower databases properties to remove.
     * @param {module:api/ClustersApi~clustersDetachFollowerDatabasesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    clustersDetachFollowerDatabases(resourceGroupName, clusterName, subscriptionId, apiVersion, followerDatabaseToRemove, callback) {
      let postBody = followerDatabaseToRemove;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling clustersDetachFollowerDatabases");
      }
      // verify the required parameter 'clusterName' is set
      if (clusterName === undefined || clusterName === null) {
        throw new Error("Missing the required parameter 'clusterName' when calling clustersDetachFollowerDatabases");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling clustersDetachFollowerDatabases");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling clustersDetachFollowerDatabases");
      }
      // verify the required parameter 'followerDatabaseToRemove' is set
      if (followerDatabaseToRemove === undefined || followerDatabaseToRemove === null) {
        throw new Error("Missing the required parameter 'followerDatabaseToRemove' when calling clustersDetachFollowerDatabases");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/detachFollowerDatabases', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the clustersListFollowerDatabases operation.
     * @callback module:api/ClustersApi~clustersListFollowerDatabasesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FollowerDatabaseListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {String} apiVersion Client API Version.
     * @param {module:api/ClustersApi~clustersListFollowerDatabasesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FollowerDatabaseListResult}
     */
    clustersListFollowerDatabases(resourceGroupName, clusterName, subscriptionId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling clustersListFollowerDatabases");
      }
      // verify the required parameter 'clusterName' is set
      if (clusterName === undefined || clusterName === null) {
        throw new Error("Missing the required parameter 'clusterName' when calling clustersListFollowerDatabases");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling clustersListFollowerDatabases");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling clustersListFollowerDatabases");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FollowerDatabaseListResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/listFollowerDatabases', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
