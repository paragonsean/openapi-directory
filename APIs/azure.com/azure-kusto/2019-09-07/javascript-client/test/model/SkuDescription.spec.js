...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KustoManagementClient.SkuDescription();
  });
  ...
  describe('SkuDescription', function() {
    it('should create an instance of SkuDescription', function() {
      ...
      //var instance = new KustoManagementClient.SkuDescription();
      //expect(instance).to.be.a(KustoManagementClient.SkuDescription);
    });
