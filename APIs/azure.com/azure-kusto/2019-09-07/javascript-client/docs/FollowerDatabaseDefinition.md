# KustoManagementClient.FollowerDatabaseDefinition
...
**databaseName** | **String** | The database name owned by this cluster that was followed. * in case following all databases. | [optional] [readonly] 
