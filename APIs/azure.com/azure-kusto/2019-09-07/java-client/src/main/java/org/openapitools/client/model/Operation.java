...
import org.openapitools.client.model.TheObjectThatDescribesTheOperation;
...
public class Operation {
  ...
  private TheObjectThatDescribesTheOperation display;
  ...
  public Operation display(TheObjectThatDescribesTheOperation display) {
  ...
  public TheObjectThatDescribesTheOperation getDisplay() {
    return display;
  }

  public void setDisplay(TheObjectThatDescribesTheOperation display) {
    this.display = display;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("display") != null && !jsonObj.get("display").isJsonNull()) {
        TheObjectThatDescribesTheOperation.validateJsonElement(jsonObj.get("display"));
      }
