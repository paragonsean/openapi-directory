...
public class DatabasesApi {
     ...
     */
    public okhttp3.Call databasesCheckNameAvailabilityCall(String resourceGroupName, String clusterName, String apiVersion, String subscriptionId, CheckNameRequest resourceName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = resourceName;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call databasesCheckNameAvailabilityValidateBeforeCall(String resourceGroupName, String clusterName, String apiVersion, String subscriptionId, CheckNameRequest resourceName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        if (resourceName == null) {
            throw new ApiException("Missing the required parameter 'resourceName' when calling databasesCheckNameAvailability(Async)");
        }

        return databasesCheckNameAvailabilityCall(resourceGroupName, clusterName, apiVersion, subscriptionId, resourceName, _callback);
     ...
     */
    public CheckNameResult databasesCheckNameAvailability(String resourceGroupName, String clusterName, String apiVersion, String subscriptionId, CheckNameRequest resourceName) throws ApiException {
        ApiResponse<CheckNameResult> localVarResp = databasesCheckNameAvailabilityWithHttpInfo(resourceGroupName, clusterName, apiVersion, subscriptionId, resourceName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CheckNameResult> databasesCheckNameAvailabilityWithHttpInfo(String resourceGroupName, String clusterName, String apiVersion, String subscriptionId, CheckNameRequest resourceName) throws ApiException {
        okhttp3.Call localVarCall = databasesCheckNameAvailabilityValidateBeforeCall(resourceGroupName, clusterName, apiVersion, subscriptionId, resourceName, null);
     ...
     */
    public okhttp3.Call databasesCheckNameAvailabilityAsync(String resourceGroupName, String clusterName, String apiVersion, String subscriptionId, CheckNameRequest resourceName, final ApiCallback<CheckNameResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = databasesCheckNameAvailabilityValidateBeforeCall(resourceGroupName, clusterName, apiVersion, subscriptionId, resourceName, _callback);
        Type localVarReturnType = new TypeToken<CheckNameResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call databasesUpdateCall(String resourceGroupName, String clusterName, String databaseName, String subscriptionId, String apiVersion, Database parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call databasesUpdateValidateBeforeCall(String resourceGroupName, String clusterName, String databaseName, String subscriptionId, String apiVersion, Database parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
     ...
     */
    public Database databasesUpdate(String resourceGroupName, String clusterName, String databaseName, String subscriptionId, String apiVersion, Database parameters) throws ApiException {
     ...
     */
    public ApiResponse<Database> databasesUpdateWithHttpInfo(String resourceGroupName, String clusterName, String databaseName, String subscriptionId, String apiVersion, Database parameters) throws ApiException {
     ...
     */
    public okhttp3.Call databasesUpdateAsync(String resourceGroupName, String clusterName, String databaseName, String subscriptionId, String apiVersion, Database parameters, final ApiCallback<Database> _callback) throws ApiException {
