...
<a id="clustersDetachFollowerDatabases"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    String apiVersion = "apiVersion_example"; // String | Client API Version.
    FollowerDatabaseDefinition followerDatabaseToRemove = new FollowerDatabaseDefinition(); // FollowerDatabaseDefinition | The follower databases properties to remove.
    try {
      apiInstance.clustersDetachFollowerDatabases(resourceGroupName, clusterName, subscriptionId, apiVersion, followerDatabaseToRemove);
    } catch (ApiException e) {
      System.err.println("Exception when calling ClustersApi#clustersDetachFollowerDatabases");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="clustersListFollowerDatabases"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client API Version.
    try {
      FollowerDatabaseListResult result = apiInstance.clustersListFollowerDatabases(resourceGroupName, clusterName, subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ClustersApi#clustersListFollowerDatabases");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
