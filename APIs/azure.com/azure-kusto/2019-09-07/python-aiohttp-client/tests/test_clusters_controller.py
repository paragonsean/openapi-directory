...
from openapi_server.models.follower_database_list_result import FollowerDatabaseListResult
...
async def test_clusters_create_or_update(client):
    ...
    """
    parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"tenantId","principalId":"principalId","type":"None"},"sku":{"tier":"Basic","name":"Standard_DS13_v2+1TB_PS","capacity":5},"zones":["zones","zones"],"properties":{"dataIngestionUri":"dataIngestionUri","trustedExternalTenants":[{"value":"value"},{"value":"value"}],"keyVaultProperties":{"keyVaultUri":"keyVaultUri","keyVersion":"keyVersion","keyName":"keyName"},"optimizedAutoscale":{"isEnabled":True,"maximum":0,"minimum":6,"version":1},"enableStreamingIngest":False,"enableDiskEncryption":True,"virtualNetworkConfiguration":{"subnetId":"subnetId","enginePublicIpId":"enginePublicIpId","dataManagementPublicIpId":"dataManagementPublicIpId"},"provisioningState":"Running","state":"Creating","uri":"uri"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_clusters_detach_follower_databases(client):
    """Test case for clusters_detach_follower_databases

    
    """
    follower_database_to_remove = {"databaseName":"databaseName","attachedDatabaseConfigurationName":"attachedDatabaseConfigurationName","clusterResourceId":"clusterResourceId"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Kusto/clusters/{cluster_name}/detachFollowerDatabases'.format(resource_group_name='resource_group_name_example', cluster_name='cluster_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=follower_database_to_remove,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_clusters_list_follower_databases(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Kusto/clusters/{cluster_name}/listFollowerDatabases'.format(resource_group_name='resource_group_name_example', cluster_name='cluster_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_clusters_update(client):
    ...
    """
    parameters = {"identity":{"userAssignedIdentities":{"key":{"clientId":"clientId","principalId":"principalId"}},"tenantId":"tenantId","principalId":"principalId","type":"None"},"location":"location","sku":{"tier":"Basic","name":"Standard_DS13_v2+1TB_PS","capacity":5},"properties":{"dataIngestionUri":"dataIngestionUri","trustedExternalTenants":[{"value":"value"},{"value":"value"}],"keyVaultProperties":{"keyVaultUri":"keyVaultUri","keyVersion":"keyVersion","keyName":"keyName"},"optimizedAutoscale":{"isEnabled":True,"maximum":0,"minimum":6,"version":1},"enableStreamingIngest":False,"enableDiskEncryption":True,"virtualNetworkConfiguration":{"subnetId":"subnetId","enginePublicIpId":"enginePublicIpId","dataManagementPublicIpId":"dataManagementPublicIpId"},"provisioningState":"Running","state":"Creating","uri":"uri"},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
