...
class Identity(Model):
    ...
    def __init__(self, principal_id: str=None, tenant_id: str=None, type: str=None, user_assigned_identities: Dict[str, IdentityUserAssignedIdentitiesValue]=None):
        ...
        :param user_assigned_identities: The user_assigned_identities of this Identity.
        """
        self.openapi_types = {
            'principal_id': str,
            'tenant_id': str,
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["None", "SystemAssigned"]  # noqa: E501
    ...
    def user_assigned_identities(self):
        """Gets the user_assigned_identities of this Identity.

        The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.

        :return: The user_assigned_identities of this Identity.
        :rtype: Dict[str, IdentityUserAssignedIdentitiesValue]
        """
        return self._user_assigned_identities

    @user_assigned_identities.setter
    def user_assigned_identities(self, user_assigned_identities):
        """Sets the user_assigned_identities of this Identity.

        The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.

        :param user_assigned_identities: The user_assigned_identities of this Identity.
        :type user_assigned_identities: Dict[str, IdentityUserAssignedIdentitiesValue]
        """
