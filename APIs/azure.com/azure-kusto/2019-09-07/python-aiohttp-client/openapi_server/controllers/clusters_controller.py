...
async def clusters_detach_follower_databases(request: web.Request, resource_group_name, cluster_name, subscription_id, api_version, follower_database_to_remove) -> web.Response:
    ...
    :type follower_database_to_remove: dict | bytes

    """
    follower_database_to_remove = FollowerDatabaseDefinition.from_dict(follower_database_to_remove)
    return web.Response(status=200)
...
async def clusters_list_follower_databases(request: web.Request, resource_group_name, cluster_name, subscription_id, api_version) -> web.Response:
