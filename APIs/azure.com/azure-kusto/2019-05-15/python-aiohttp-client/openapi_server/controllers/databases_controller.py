...
async def databases_check_name_availability(request: web.Request, resource_group_name, cluster_name, api_version, subscription_id, database_name) -> web.Response:
    ...
    :type database_name: dict | bytes

    """
    database_name = DatabaseCheckNameRequest.from_dict(database_name)
    return web.Response(status=200)
