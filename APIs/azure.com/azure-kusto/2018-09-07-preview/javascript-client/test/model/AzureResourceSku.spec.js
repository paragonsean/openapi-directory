...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KustoManagementClient.AzureResourceSku();
  });
  ...
  describe('AzureResourceSku', function() {
    it('should create an instance of AzureResourceSku', function() {
      // uncomment below and update the code to test AzureResourceSku
      //var instance = new KustoManagementClient.AzureResourceSku();
      //expect(instance).to.be.a(KustoManagementClient.AzureResourceSku);
    });
