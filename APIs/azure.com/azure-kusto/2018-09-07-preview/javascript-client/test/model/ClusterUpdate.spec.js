...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KustoManagementClient.ClusterUpdate();
  });
  ...
  describe('ClusterUpdate', function() {
    it('should create an instance of ClusterUpdate', function() {
      ...
      //var instance = new KustoManagementClient.ClusterUpdate();
      //expect(instance).to.be.a(KustoManagementClient.ClusterUpdate);
    });
