...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KustoManagementClient.DatabaseUpdate();
  });
  ...
  describe('DatabaseUpdate', function() {
    it('should create an instance of DatabaseUpdate', function() {
      ...
      //var instance = new KustoManagementClient.DatabaseUpdate();
      //expect(instance).to.be.a(KustoManagementClient.DatabaseUpdate);
    });
