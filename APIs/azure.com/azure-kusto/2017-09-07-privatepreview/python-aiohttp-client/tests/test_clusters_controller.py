...
async def test_clusters_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","sku":{"tier":"Standard","name":"KC8","capacity":0},"properties":{"dataIngestionUri":"dataIngestionUri","trustedExternalTenants":[{"value":"value"},{"value":"value"}],"provisioningState":"Running","state":"Creating","uri":"uri"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_clusters_update(client):
    ...
    """
    parameters = {"etag":"etag","location":"location","sku":{"tier":"Standard","name":"KC8","capacity":0},"properties":{"dataIngestionUri":"dataIngestionUri","trustedExternalTenants":[{"value":"value"},{"value":"value"}],"provisioningState":"Running","state":"Creating","uri":"uri"},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
