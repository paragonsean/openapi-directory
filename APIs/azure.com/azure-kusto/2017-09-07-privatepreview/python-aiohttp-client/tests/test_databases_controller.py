...
async def test_databases_add_principals(client):
    ...
    """
    database_principals_to_add = {"value":[{"fqn":"fqn","role":"Admin","appId":"appId","name":"name","type":"App","email":"email"},{"fqn":"fqn","role":"Admin","appId":"appId","name":"name","type":"App","email":"email"}]}
...
async def test_databases_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","properties":{"softDeletePeriodInDays":6,"provisioningState":"Running","hotCachePeriodInDays":0,"statistics":{"size":1.4658129805029452}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_databases_remove_principals(client):
    ...
    """
    database_principals_to_remove = {"value":[{"fqn":"fqn","role":"Admin","appId":"appId","name":"name","type":"App","email":"email"},{"fqn":"fqn","role":"Admin","appId":"appId","name":"name","type":"App","email":"email"}]}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_databases_update(client):
    ...
    """
    parameters = {"etag":"etag","location":"location","properties":{"softDeletePeriodInDays":6,"provisioningState":"Running","hotCachePeriodInDays":0,"statistics":{"size":1.4658129805029452}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
