...
public:
    ...
    */
    virtual void eventSubscriptionsCreate(const QString &scope, const QString &event_subscription_name, const QString &api_version, const OAIEventSubscription &event_subscription_info);
...
private:
    ...
    void eventSubscriptionsCreateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void eventSubscriptionsCreateSignal(OAIEventSubscription summary);
    ...
    void eventSubscriptionsCreateSignalFull(OAIHttpRequestWorker *worker, OAIEventSubscription summary);
    ...
    Q_DECL_DEPRECATED_X("Use eventSubscriptionsCreateSignalError() instead")
    void eventSubscriptionsCreateSignalE(OAIEventSubscription summary, QNetworkReply::NetworkError error_type, QString error_str);
    void eventSubscriptionsCreateSignalError(OAIEventSubscription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use eventSubscriptionsCreateSignalErrorFull() instead")
    void eventSubscriptionsCreateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void eventSubscriptionsCreateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
