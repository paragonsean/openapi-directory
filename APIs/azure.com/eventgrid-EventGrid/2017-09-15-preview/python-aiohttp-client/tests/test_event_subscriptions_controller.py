...
async def test_event_subscriptions_create(client):
    ...
    """
    event_subscription_info = {"properties":{"filter":{"includedEventTypes":["includedEventTypes","includedEventTypes"],"subjectEndsWith":"subjectEndsWith","subjectBeginsWith":"subjectBeginsWith","isSubjectCaseSensitive":False},"destination":{"endpointType":"WebHook"},"topic":"topic","provisioningState":"Creating","labels":["labels","labels"]}}
...
async def test_event_subscriptions_update(client):
    ...
    """
    event_subscription_update_parameters = {"filter":{"includedEventTypes":["includedEventTypes","includedEventTypes"],"subjectEndsWith":"subjectEndsWith","subjectBeginsWith":"subjectBeginsWith","isSubjectCaseSensitive":False},"destination":{"endpointType":"WebHook"},"labels":["labels","labels"]}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
