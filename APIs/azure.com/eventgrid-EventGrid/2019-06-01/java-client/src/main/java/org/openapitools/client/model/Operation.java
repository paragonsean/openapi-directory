...
import org.openapitools.client.model.OperationInfo;
...
public class Operation {
  ...
  public Operation display(OperationInfo display) {
  ...
  public OperationInfo getDisplay() {
    return display;
  }

  public void setDisplay(OperationInfo display) {
    this.display = display;
  }
  ...
  public Operation properties(Object properties) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("display") != null && !jsonObj.get("display").isJsonNull()) {
        OperationInfo.validateJsonElement(jsonObj.get("display"));
      }
