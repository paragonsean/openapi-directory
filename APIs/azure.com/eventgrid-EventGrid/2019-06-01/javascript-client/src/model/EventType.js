...
import EventTypeProperties from './EventTypeProperties';
...
class EventType {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = EventTypeProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          EventTypeProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/EventTypeProperties} properties
 */
EventType.prototype['properties'] = undefined;
 ...
 * @member {String} type
 */
EventType.prototype['type'] = undefined;
