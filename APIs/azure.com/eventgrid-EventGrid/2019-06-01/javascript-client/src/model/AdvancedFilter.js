...
class AdvancedFilter {
     ...
     * @param operatorType {module:model/AdvancedFilter.OperatorTypeEnum} The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
     */
