...
async def topics_list_by_resource_group(request: web.Request, subscription_id, resource_group_name, api_version, filter=None, top=None) -> web.Response:
...
async def topics_list_by_subscription(request: web.Request, subscription_id, api_version, filter=None, top=None) -> web.Response:
