...
class TopicTypeProperties(Model):
    ...
    def __init__(self, description: str=None, display_name: str=None, provider: str=None, provisioning_state: str=None, resource_region_type: str=None, supported_locations: List[str]=None):
