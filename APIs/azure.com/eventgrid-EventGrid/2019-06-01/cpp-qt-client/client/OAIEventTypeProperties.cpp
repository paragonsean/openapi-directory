...
void OAIEventTypeProperties::initializeModel() {
    ...
    m_is_in_default_set_isSet = false;
    m_is_in_default_set_isValid = false;
...
void OAIEventTypeProperties::fromJsonObject(QJsonObject json) {
    ...
    m_is_in_default_set_isValid = ::OpenAPI::fromJsonValue(m_is_in_default_set, json[QString("isInDefaultSet")]);
    m_is_in_default_set_isSet = !json[QString("isInDefaultSet")].isNull() && m_is_in_default_set_isValid;
...
QJsonObject OAIEventTypeProperties::asJsonObject() const {
    ...
    if (m_is_in_default_set_isSet) {
        obj.insert(QString("isInDefaultSet"), ::OpenAPI::toJsonValue(m_is_in_default_set));
    }
...
bool OAIEventTypeProperties::isIsInDefaultSet() const {
    return m_is_in_default_set;
}
void OAIEventTypeProperties::setIsInDefaultSet(const bool &is_in_default_set) {
    m_is_in_default_set = is_in_default_set;
    m_is_in_default_set_isSet = true;
}

bool OAIEventTypeProperties::is_is_in_default_set_Set() const{
    return m_is_in_default_set_isSet;
}

bool OAIEventTypeProperties::is_is_in_default_set_Valid() const{
    return m_is_in_default_set_isValid;
}
