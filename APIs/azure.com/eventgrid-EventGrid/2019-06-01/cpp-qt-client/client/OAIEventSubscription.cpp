...
OAIEventSubscriptionProperties OAIEventSubscription::getProperties() const {
    return m_properties;
}
void OAIEventSubscription::setProperties(const OAIEventSubscriptionProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIEventSubscription::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIEventSubscription::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIEventSubscription::getId() const {
    return m_id;
}
void OAIEventSubscription::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventSubscription::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventSubscription::is_id_Valid() const{
    return m_id_isValid;
}
...
QString OAIEventSubscription::getType() const {
    return m_type;
}
void OAIEventSubscription::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEventSubscription::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEventSubscription::is_type_Valid() const{
