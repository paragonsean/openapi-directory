...
async def test_event_subscriptions_create_or_update(client):
    ...
    """
    event_subscription_info = {"properties":{"filter":{"includedEventTypes":["includedEventTypes","includedEventTypes"],"subjectEndsWith":"subjectEndsWith","subjectBeginsWith":"subjectBeginsWith","isSubjectCaseSensitive":False},"deadLetterDestination":{"endpointType":"StorageBlob"},"retryPolicy":{"maxDeliveryAttempts":6,"eventTimeToLiveInMinutes":0},"destination":{"endpointType":"WebHook"},"topic":"topic","provisioningState":"Creating","labels":["labels","labels"]}}
...
async def test_event_subscriptions_update(client):
    ...
    """
    event_subscription_update_parameters = {"filter":{"includedEventTypes":["includedEventTypes","includedEventTypes"],"subjectEndsWith":"subjectEndsWith","subjectBeginsWith":"subjectBeginsWith","isSubjectCaseSensitive":False},"deadLetterDestination":{"endpointType":"StorageBlob"},"retryPolicy":{"maxDeliveryAttempts":6,"eventTimeToLiveInMinutes":0},"destination":{"endpointType":"WebHook"},"labels":["labels","labels"]}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
