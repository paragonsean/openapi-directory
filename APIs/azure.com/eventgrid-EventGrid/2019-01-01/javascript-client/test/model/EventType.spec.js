...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventGridManagementClient.EventType();
  });
  ...
  describe('EventType', function() {
    it('should create an instance of EventType', function() {
      ...
      //var instance = new EventGridManagementClient.EventType();
      //expect(instance).to.be.a(EventGridManagementClient.EventType);
    });
