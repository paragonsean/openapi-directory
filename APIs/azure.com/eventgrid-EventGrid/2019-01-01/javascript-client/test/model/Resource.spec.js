...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventGridManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new EventGridManagementClient.Resource();
      //expect(instance).to.be.a(EventGridManagementClient.Resource);
    });
