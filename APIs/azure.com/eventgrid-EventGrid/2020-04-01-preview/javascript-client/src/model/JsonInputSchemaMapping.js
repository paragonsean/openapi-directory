...
class JsonInputSchemaMapping {
     ...
     * @param inputSchemaMappingType {module:model/JsonInputSchemaMapping.InputSchemaMappingTypeEnum} Type of the custom mapping
     */
    constructor(inputSchemaMappingType) { 
        InputSchemaMapping.initialize(this, inputSchemaMappingType);
        JsonInputSchemaMapping.initialize(this, inputSchemaMappingType);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of JsonInputSchemaMapping.RequiredProperties) {
...
JsonInputSchemaMapping.RequiredProperties = ["inputSchemaMappingType"];
