...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventGridManagementClient.Domain();
  });
  ...
  describe('Domain', function() {
    it('should create an instance of Domain', function() {
      ...
      //var instance = new EventGridManagementClient.Domain();
      //expect(instance).to.be.a(EventGridManagementClient.Domain);
    });
