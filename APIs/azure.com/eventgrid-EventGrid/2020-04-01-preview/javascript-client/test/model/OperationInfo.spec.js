...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventGridManagementClient.OperationInfo();
  });
  ...
  describe('OperationInfo', function() {
    it('should create an instance of OperationInfo', function() {
      ...
      //var instance = new EventGridManagementClient.OperationInfo();
      //expect(instance).to.be.a(EventGridManagementClient.OperationInfo);
    });
