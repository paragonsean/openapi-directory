...
class TopicTypeProperties(Model):
    ...
    def __init__(self, description: str=None, display_name: str=None, provider: str=None, provisioning_state: str=None, resource_region_type: str=None, source_resource_format: str=None, supported_locations: List[str]=None):
        ...
        :param source_resource_format: The source_resource_format of this TopicTypeProperties.
        :param supported_locations: The supported_locations of this TopicTypeProperties.
        """
        self.openapi_types = {
            'description': str,
            'display_name': str,
        ...
        self.attribute_map = {
            ...
            'source_resource_format': 'sourceResourceFormat',
        ...
        self._source_resource_format = source_resource_format
    ...
    @property
    def source_resource_format(self):
        """Gets the source_resource_format of this TopicTypeProperties.

        Source resource format.

        :return: The source_resource_format of this TopicTypeProperties.
        :rtype: str
        """
        return self._source_resource_format

    @source_resource_format.setter
    def source_resource_format(self, source_resource_format):
        """Sets the source_resource_format of this TopicTypeProperties.
    ...
    def supported_locations(self):
        """Gets the supported_locations of this TopicTypeProperties.

        List of locations supported by this topic type.

        :return: The supported_locations of this TopicTypeProperties.
        :rtype: List[str]
        """
    ...
    def supported_locations(self, supported_locations):
        """Sets the supported_locations of this TopicTypeProperties.
