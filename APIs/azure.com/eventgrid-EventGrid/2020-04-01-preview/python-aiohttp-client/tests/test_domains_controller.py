...
async def test_domains_create_or_update(client):
    ...
    """
    domain_info = {"properties":{"endpoint":"endpoint","inputSchema":"EventGridSchema","inputSchemaMapping":{"inputSchemaMappingType":"Json"},"metricResourceId":"metricResourceId","inboundIpRules":[{"ipMask":"ipMask","action":"Allow"},{"ipMask":"ipMask","action":"Allow"}],"provisioningState":"Creating","allowTrafficFromAllIPs":True}}
...
async def test_domains_update(client):
    ...
    Update a domain.
    """
    domain_update_parameters = {"inboundIpRules":[{"ipMask":"ipMask","action":"Allow"},{"ipMask":"ipMask","action":"Allow"}],"allowTrafficFromAllIPs":True,"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
