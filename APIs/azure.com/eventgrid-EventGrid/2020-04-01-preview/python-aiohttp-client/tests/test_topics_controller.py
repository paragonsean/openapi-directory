...
async def test_topics_create_or_update(client):
    ...
    Create a topic.
    """
    topic_info = {"properties":{"endpoint":"endpoint","inputSchema":"EventGridSchema","inputSchemaMapping":{"inputSchemaMappingType":"Json"},"metricResourceId":"metricResourceId","inboundIpRules":[{"ipMask":"ipMask","action":"Allow"},{"ipMask":"ipMask","action":"Allow"}],"provisioningState":"Creating","allowTrafficFromAllIPs":True}}
...
async def test_topics_update(client):
    ...
    Update a topic.
    """
    topic_update_parameters = {"inboundIpRules":[{"ipMask":"ipMask","action":"Allow"},{"ipMask":"ipMask","action":"Allow"}],"allowTrafficFromAllIPs":True,"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
