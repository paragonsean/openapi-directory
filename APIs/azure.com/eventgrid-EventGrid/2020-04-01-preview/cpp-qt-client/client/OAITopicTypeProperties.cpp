...
void OAITopicTypeProperties::initializeModel() {
    ...
    m_source_resource_format_isSet = false;
    m_source_resource_format_isValid = false;
...
void OAITopicTypeProperties::fromJsonObject(QJsonObject json) {
    ...
    m_source_resource_format_isValid = ::OpenAPI::fromJsonValue(m_source_resource_format, json[QString("sourceResourceFormat")]);
    m_source_resource_format_isSet = !json[QString("sourceResourceFormat")].isNull() && m_source_resource_format_isValid;
...
QJsonObject OAITopicTypeProperties::asJsonObject() const {
    ...
    if (m_source_resource_format_isSet) {
        obj.insert(QString("sourceResourceFormat"), ::OpenAPI::toJsonValue(m_source_resource_format));
    }
...
QString OAITopicTypeProperties::getSourceResourceFormat() const {
    return m_source_resource_format;
}
void OAITopicTypeProperties::setSourceResourceFormat(const QString &source_resource_format) {
    m_source_resource_format = source_resource_format;
    m_source_resource_format_isSet = true;
}

bool OAITopicTypeProperties::is_source_resource_format_Set() const{
    return m_source_resource_format_isSet;
}

bool OAITopicTypeProperties::is_source_resource_format_Valid() const{
    return m_source_resource_format_isValid;
}
