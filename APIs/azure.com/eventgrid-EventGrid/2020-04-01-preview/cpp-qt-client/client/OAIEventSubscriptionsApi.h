...
public:
    ...
    */
    virtual void eventSubscriptionsListByDomainTopic(const QString &subscription_id, const QString &resource_group_name, const QString &domain_name, const QString &topic_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void eventSubscriptionsListGlobalByResourceGroup(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void eventSubscriptionsListGlobalBySubscription(const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void eventSubscriptionsListGlobalBySubscriptionForTopicType(const QString &subscription_id, const QString &topic_type_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void eventSubscriptionsListRegionalBySubscription(const QString &subscription_id, const QString &location, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  top qint32 [optional]
    */
    virtual void eventSubscriptionsListRegionalBySubscriptionForTopicType(const QString &subscription_id, const QString &location, const QString &topic_type_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void eventSubscriptionsListByDomainTopicCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void eventSubscriptionsListByDomainTopicSignal(OAIEventSubscriptionsListResult summary);
    ...
    void eventSubscriptionsListByDomainTopicSignalFull(OAIHttpRequestWorker *worker, OAIEventSubscriptionsListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use eventSubscriptionsListByDomainTopicSignalError() instead")
    void eventSubscriptionsListByDomainTopicSignalE(OAIEventSubscriptionsListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void eventSubscriptionsListByDomainTopicSignalError(OAIEventSubscriptionsListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use eventSubscriptionsListByDomainTopicSignalErrorFull() instead")
    void eventSubscriptionsListByDomainTopicSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void eventSubscriptionsListByDomainTopicSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
