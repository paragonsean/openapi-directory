...
OAIEventTypeProperties OAIEventType::getProperties() const {
    return m_properties;
}
void OAIEventType::setProperties(const OAIEventTypeProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIEventType::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIEventType::is_properties_Valid() const{
...
QString OAIEventType::getType() const {
    return m_type;
}
void OAIEventType::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEventType::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEventType::is_type_Valid() const{
