...
public class TopicTypeProperties {
  ...
  public static final String SERIALIZED_NAME_SOURCE_RESOURCE_FORMAT = "sourceResourceFormat";
  @SerializedName(SERIALIZED_NAME_SOURCE_RESOURCE_FORMAT)
  ...
  public TopicTypeProperties sourceResourceFormat(String sourceResourceFormat) {
   ...
   * @return sourceResourceFormat
   */
  @javax.annotation.Nullable
  public String getSourceResourceFormat() {
    return sourceResourceFormat;
  }

  public void setSourceResourceFormat(String sourceResourceFormat) {
    this.sourceResourceFormat = sourceResourceFormat;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, topicTypeProperties.description) &&
        ...
        Objects.equals(this.sourceResourceFormat, topicTypeProperties.sourceResourceFormat) &&
        Objects.equals(this.supportedLocations, topicTypeProperties.supportedLocations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, displayName, provider, provisioningState, resourceRegionType, sourceResourceFormat, supportedLocations);
  }
  ...
  public String toString() {
    ...
    sb.append("    sourceResourceFormat: ").append(toIndentedString(sourceResourceFormat)).append("\n");
  ...
  static {
    ...
    openapiFields.add("sourceResourceFormat");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("sourceResourceFormat") != null && !jsonObj.get("sourceResourceFormat").isJsonNull()) && !jsonObj.get("sourceResourceFormat").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sourceResourceFormat` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sourceResourceFormat").toString()));
      }
