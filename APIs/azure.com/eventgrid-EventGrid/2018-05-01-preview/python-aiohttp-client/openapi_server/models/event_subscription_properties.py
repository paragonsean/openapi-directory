...
class EventSubscriptionProperties(Model):
    ...
    def __init__(self, dead_letter_destination: DeadLetterDestination=None, destination: EventSubscriptionDestination=None, event_delivery_schema: str='InputEventSchema', filter: EventSubscriptionFilter=None, labels: List[str]=None, provisioning_state: str=None, retry_policy: RetryPolicy=None, topic: str=None):
