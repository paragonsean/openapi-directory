...
QString OAIEventSubscriptionProperties::getEventDeliverySchema() const {
    return m_event_delivery_schema;
}
void OAIEventSubscriptionProperties::setEventDeliverySchema(const QString &event_delivery_schema) {
    m_event_delivery_schema = event_delivery_schema;
    m_event_delivery_schema_isSet = true;
}

bool OAIEventSubscriptionProperties::is_event_delivery_schema_Set() const{
    return m_event_delivery_schema_isSet;
}

bool OAIEventSubscriptionProperties::is_event_delivery_schema_Valid() const{
