...
public class EventSubscriptionProperties {
  ...
  private EventDeliverySchemaEnum eventDeliverySchema = EventDeliverySchemaEnum.INPUT_EVENT_SCHEMA;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deadLetterDestination, destination, eventDeliverySchema, filter, labels, provisioningState, retryPolicy, topic);
  }
