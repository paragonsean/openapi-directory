...
void OAIEventsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("publishEvents", defaultConf);
    _serverIndices.insert("publishEvents", 0);
}
...
void OAIEventsApi::publishEvents(const QString &api_version, const QList<OAIEventGridEvent> &events) {
    QString fullPath = QString(_serverConfigs["publishEvents"][_serverIndices.value("publishEvents")].URL()+"/api/events");
    ...
    {
        QJsonDocument doc(::OpenAPI::toJsonValue(events).toArray());
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::publishEventsCallback);
...
void OAIEventsApi::publishEventsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT publishEventsSignal();
        Q_EMIT publishEventsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT publishEventsSignalE(error_type, error_str);
        Q_EMIT publishEventsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT publishEventsSignalError(error_type, error_str);
        Q_EMIT publishEventsSignalErrorFull(worker, error_type, error_str);
    }
}
