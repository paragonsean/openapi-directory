...
public:
    ...
    * @param[in]  label QString [optional]
    */
    virtual void eventSubscriptionsListGlobalBySubscriptionForTopicType(const QString &subscription_id, const QString &topic_type_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>());
