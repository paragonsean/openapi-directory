...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventGridManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new EventGridManagementClient.Operation();
      //expect(instance).to.be.a(EventGridManagementClient.Operation);
    });
