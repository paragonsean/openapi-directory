...
------------ | ------------- | ------------- | -------------
**advancedFilters** | [**[AdvancedFilter]**](AdvancedFilter.md) | An array of advanced filters that are used for filtering event subscriptions. | [optional] 
**includedEventTypes** | **[String]** | A list of applicable event types that need to be part of the event subscription. If it is desired to subscribe to all default event types, set the IncludedEventTypes to null. | [optional] 
