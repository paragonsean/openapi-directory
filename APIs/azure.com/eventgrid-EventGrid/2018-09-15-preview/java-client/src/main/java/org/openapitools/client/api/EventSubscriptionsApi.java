...
public class EventSubscriptionsApi {
     ...
     */
    public okhttp3.Call eventSubscriptionsListByDomainTopicCall(String subscriptionId, String resourceGroupName, String domainName, String topicName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call eventSubscriptionsListByDomainTopicValidateBeforeCall(String subscriptionId, String resourceGroupName, String domainName, String topicName, String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        return eventSubscriptionsListByDomainTopicCall(subscriptionId, resourceGroupName, domainName, topicName, apiVersion, _callback);
     ...
     */
    public EventSubscriptionsListResult eventSubscriptionsListByDomainTopic(String subscriptionId, String resourceGroupName, String domainName, String topicName, String apiVersion) throws ApiException {
        ApiResponse<EventSubscriptionsListResult> localVarResp = eventSubscriptionsListByDomainTopicWithHttpInfo(subscriptionId, resourceGroupName, domainName, topicName, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EventSubscriptionsListResult> eventSubscriptionsListByDomainTopicWithHttpInfo(String subscriptionId, String resourceGroupName, String domainName, String topicName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = eventSubscriptionsListByDomainTopicValidateBeforeCall(subscriptionId, resourceGroupName, domainName, topicName, apiVersion, null);
     ...
     */
    public okhttp3.Call eventSubscriptionsListByDomainTopicAsync(String subscriptionId, String resourceGroupName, String domainName, String topicName, String apiVersion, final ApiCallback<EventSubscriptionsListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = eventSubscriptionsListByDomainTopicValidateBeforeCall(subscriptionId, resourceGroupName, domainName, topicName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<EventSubscriptionsListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
