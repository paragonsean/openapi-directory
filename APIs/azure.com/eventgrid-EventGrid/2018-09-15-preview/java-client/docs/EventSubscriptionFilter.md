...
|------------ | ------------- | ------------- | -------------|
|**advancedFilters** | [**List&lt;AdvancedFilter&gt;**](AdvancedFilter.md) | A list of advanced filters. |  [optional] |
|**includedEventTypes** | **List&lt;String&gt;** | A list of applicable event types that need to be part of the event subscription.   If it is desired to subscribe to all event types, the string \&quot;all\&quot; needs to be specified as an element in this list. |  [optional] |
