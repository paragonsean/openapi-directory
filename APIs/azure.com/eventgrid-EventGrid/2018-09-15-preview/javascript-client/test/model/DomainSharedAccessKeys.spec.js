...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventGridManagementClient.DomainSharedAccessKeys();
  });
  ...
  describe('DomainSharedAccessKeys', function() {
    it('should create an instance of DomainSharedAccessKeys', function() {
      // uncomment below and update the code to test DomainSharedAccessKeys
      //var instance = new EventGridManagementClient.DomainSharedAccessKeys();
      //expect(instance).to.be.a(EventGridManagementClient.DomainSharedAccessKeys);
    });
