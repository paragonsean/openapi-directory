...
class EventSubscriptionUpdateParameters(Model):
    ...
    def __init__(self, dead_letter_destination: DeadLetterDestination=None, destination: EventSubscriptionDestination=None, event_delivery_schema: str=None, expiration_time_utc: datetime=None, filter: EventSubscriptionFilter=None, labels: List[str]=None, retry_policy: RetryPolicy=None):
    ...
    def event_delivery_schema(self, event_delivery_schema):
        ...
        """
        allowed_values = ["EventGridSchema", "CloudEventV01Schema", "CustomInputSchema"]  # noqa: E501
