...
async def event_subscriptions_list_by_domain_topic(request: web.Request, subscription_id, resource_group_name, domain_name, topic_name, api_version) -> web.Response:
