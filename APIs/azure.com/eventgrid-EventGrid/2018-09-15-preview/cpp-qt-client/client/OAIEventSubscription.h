...
namespace OpenAPI {
class OAIEventSubscriptionProperties;
...
public:
    ...
    OAIEventSubscriptionProperties getProperties() const;
    void setProperties(const OAIEventSubscriptionProperties &properties);
...
private:
    ...
    OAIEventSubscriptionProperties m_properties;
