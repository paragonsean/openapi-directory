...
public:
    ...
    OAIDomainProperties getProperties() const;
    void setProperties(const OAIDomainProperties &properties);
...
private:
    ...
    OAIDomainProperties m_properties;
