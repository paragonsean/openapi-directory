...
async def test_domains_create_or_update(client):
    ...
    """
    domain_info = {"properties":{"endpoint":"endpoint","inputSchema":"EventGridSchema","inputSchemaMapping":{"inputSchemaMappingType":"Json"},"metricResourceId":"metricResourceId","provisioningState":"Creating"}}
