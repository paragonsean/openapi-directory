...
async def test_topics_create_or_update(client):
    ...
    Create a topic
    """
    topic_info = {"properties":{"endpoint":"endpoint","inputSchema":"EventGridSchema","inputSchemaMapping":{"inputSchemaMappingType":"Json"},"metricResourceId":"metricResourceId","provisioningState":"Creating"}}
