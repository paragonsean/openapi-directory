...
Q_SIGNALS:
    ...
    void operationsListSignal(OAIOperationsListResult summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIOperationsListResult summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(OAIOperationsListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(OAIOperationsListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
