...
OAITopicProperties OAITopic::getProperties() const {
    return m_properties;
}
void OAITopic::setProperties(const OAITopicProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAITopic::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAITopic::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAITopic::getLocation() const {
    return m_location;
}
void OAITopic::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAITopic::is_location_Set() const{
    return m_location_isSet;
}

bool OAITopic::is_location_Valid() const{
    return m_location_isValid;
}

QMap<QString, QString> OAITopic::getTags() const {
    return m_tags;
}
void OAITopic::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITopic::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITopic::is_tags_Valid() const{
