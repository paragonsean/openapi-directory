...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EventGridManagementClient.JsonInputSchemaMappingProperties();
  });
  ...
  describe('JsonInputSchemaMappingProperties', function() {
    it('should create an instance of JsonInputSchemaMappingProperties', function() {
      // uncomment below and update the code to test JsonInputSchemaMappingProperties
      //var instance = new EventGridManagementClient.JsonInputSchemaMappingProperties();
      //expect(instance).to.be.a(EventGridManagementClient.JsonInputSchemaMappingProperties);
    });
