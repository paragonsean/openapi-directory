...
> EventSubscriptionsListResult eventSubscriptionsListByDomainTopic(subscriptionId, resourceGroupName, domainName, topicName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListByDomainTopic(subscriptionId, resourceGroupName, domainName, topicName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> EventSubscriptionsListResult eventSubscriptionsListByResource(subscriptionId, resourceGroupName, providerNamespace, resourceTypeName, resourceName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListByResource(subscriptionId, resourceGroupName, providerNamespace, resourceTypeName, resourceName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> EventSubscriptionsListResult eventSubscriptionsListGlobalByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListGlobalByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> EventSubscriptionsListResult eventSubscriptionsListGlobalByResourceGroupForTopicType(subscriptionId, resourceGroupName, topicTypeName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListGlobalByResourceGroupForTopicType(subscriptionId, resourceGroupName, topicTypeName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> EventSubscriptionsListResult eventSubscriptionsListGlobalBySubscription(subscriptionId, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListGlobalBySubscription(subscriptionId, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> EventSubscriptionsListResult eventSubscriptionsListGlobalBySubscriptionForTopicType(subscriptionId, topicTypeName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListGlobalBySubscriptionForTopicType(subscriptionId, topicTypeName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> EventSubscriptionsListResult eventSubscriptionsListRegionalByResourceGroup(subscriptionId, resourceGroupName, location, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListRegionalByResourceGroup(subscriptionId, resourceGroupName, location, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
# **eventSubscriptionsListRegionalByResourceGroupForTopicType**
> EventSubscriptionsListResult eventSubscriptionsListRegionalByResourceGroupForTopicType(subscriptionId, resourceGroupName, location, topicTypeName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListRegionalByResourceGroupForTopicType(subscriptionId, resourceGroupName, location, topicTypeName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> EventSubscriptionsListResult eventSubscriptionsListRegionalBySubscription(subscriptionId, location, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListRegionalBySubscription(subscriptionId, location, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
# **eventSubscriptionsListRegionalBySubscriptionForTopicType**
> EventSubscriptionsListResult eventSubscriptionsListRegionalBySubscriptionForTopicType(subscriptionId, location, topicTypeName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      EventSubscriptionsListResult result = apiInstance.eventSubscriptionsListRegionalBySubscriptionForTopicType(subscriptionId, location, topicTypeName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
