...
> TopicsListResult topicsListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TopicsListResult result = apiInstance.topicsListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
...
> TopicsListResult topicsListBySubscription(subscriptionId, apiVersion, $filter, $top)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer $top = 56; // Integer | The number of results to return per page for the list operation. Valid range for top parameter is 1 to 100. If not specified, the default number of results to be returned is 20 items per page.
    try {
      TopicsListResult result = apiInstance.topicsListBySubscription(subscriptionId, apiVersion, $filter, $top);
      System.out.println(result);
    } catch (ApiException e) {
