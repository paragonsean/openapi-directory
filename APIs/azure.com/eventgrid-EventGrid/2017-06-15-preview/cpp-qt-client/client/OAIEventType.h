...
public:
    ...
    OAIEventTypeProperties getProperties() const;
    void setProperties(const OAIEventTypeProperties &properties);
...
private:
    ...
    OAIEventTypeProperties m_properties;
