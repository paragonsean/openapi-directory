...
public class EventSubscriptionsApiTest {
     ...
     */
    @Test
    public void eventSubscriptionsCreateTest() throws ApiException {
        String scope = null;
        String eventSubscriptionName = null;
        String apiVersion = null;
        EventSubscription eventSubscriptionInfo = null;
        EventSubscription response = api.eventSubscriptionsCreate(scope, eventSubscriptionName, apiVersion, eventSubscriptionInfo);
