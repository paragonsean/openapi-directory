...
(function(root, factory) {
  ...
  describe('EventSubscriptionsApi', function() {
    describe('eventSubscriptionsCreate', function() {
      it('should call eventSubscriptionsCreate successfully', function(done) {
        //uncomment below and update the code to test eventSubscriptionsCreate
        //instance.eventSubscriptionsCreate(function(error) {
