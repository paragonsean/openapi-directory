...
export default class EventSubscriptionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the eventSubscriptionsCreate operation.
     * @callback module:api/EventSubscriptionsApi~eventSubscriptionsCreateCallback
     ...
     * @param {String} scope The scope of the resource to which the event subscription needs to be created. The scope can be a subscription, or a resource group, or a top level resource belonging to a resource provider namespace, or an EventGrid topic. For example, use '/subscriptions/{subscriptionId}/' for a subscription, '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for a resource group, and '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}' for a resource, and '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/topics/{topicName}' for an EventGrid topic.
     * @param {String} eventSubscriptionName Name of the event subscription to be created. Event subscription names must be between 3 and 64 characters in length and use alphanumeric letters only.
     ...
     * @param {module:api/EventSubscriptionsApi~eventSubscriptionsCreateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EventSubscription}
     */
    eventSubscriptionsCreate(scope, eventSubscriptionName, apiVersion, eventSubscriptionInfo, callback) {
      let postBody = eventSubscriptionInfo;
      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling eventSubscriptionsCreate");
      }
      // verify the required parameter 'eventSubscriptionName' is set
      if (eventSubscriptionName === undefined || eventSubscriptionName === null) {
        throw new Error("Missing the required parameter 'eventSubscriptionName' when calling eventSubscriptionsCreate");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling eventSubscriptionsCreate");
      }
      // verify the required parameter 'eventSubscriptionInfo' is set
      if (eventSubscriptionInfo === undefined || eventSubscriptionInfo === null) {
        throw new Error("Missing the required parameter 'eventSubscriptionInfo' when calling eventSubscriptionsCreate");
      }
     ...
     * @param {String} eventSubscriptionName Name of the event subscription to be created
     * @param {String} apiVersion Version of the API to be used with the client request.
