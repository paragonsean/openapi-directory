...
public:
    ...
    */
    virtual void elasticPoolsCreateOrUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &server_name, const QString &elastic_pool_name, const OAIElasticPool &parameters);
    ...
    * @param[in]  elastic_pool_name QString [required]
    */
    virtual void elasticPoolsDelete(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &server_name, const QString &elastic_pool_name);
    ...
    * @param[in]  elastic_pool_name QString [required]
    */
    virtual void elasticPoolsGet(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &server_name, const QString &elastic_pool_name);
    ...
    * @param[in]  server_name QString [required]
    */
    virtual void elasticPoolsListByServer(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &server_name);
    ...
    */
    virtual void elasticPoolsUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &server_name, const QString &elastic_pool_name, const OAIElasticPoolUpdate &parameters);
