...
OAIElasticPoolProperties OAIElasticPoolUpdate::getProperties() const {
    return m_properties;
}
void OAIElasticPoolUpdate::setProperties(const OAIElasticPoolProperties &properties) {
...
QString OAIElasticPoolUpdate::getId() const {
    return m_id;
}
void OAIElasticPoolUpdate::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIElasticPoolUpdate::is_id_Set() const{
    return m_id_isSet;
}

bool OAIElasticPoolUpdate::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIElasticPoolUpdate::getName() const {
    return m_name;
}
void OAIElasticPoolUpdate::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIElasticPoolUpdate::is_name_Set() const{
    return m_name_isSet;
}

bool OAIElasticPoolUpdate::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIElasticPoolUpdate::getType() const {
    return m_type;
}
void OAIElasticPoolUpdate::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIElasticPoolUpdate::is_type_Set() const{
    return m_type_isSet;
}

bool OAIElasticPoolUpdate::is_type_Valid() const{
