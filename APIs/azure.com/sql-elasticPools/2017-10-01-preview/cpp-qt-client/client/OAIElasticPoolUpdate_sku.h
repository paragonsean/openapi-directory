...
/*
 * OAIElasticPoolUpdate_sku.h
 *
 * An ARM Resource SKU.
 */

#ifndef OAIElasticPoolUpdate_sku_H
#define OAIElasticPoolUpdate_sku_H
...
class OAIElasticPoolUpdate_sku : public OAIObject {
public:
    OAIElasticPoolUpdate_sku();
    OAIElasticPoolUpdate_sku(QString json);
    ~OAIElasticPoolUpdate_sku() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElasticPoolUpdate_sku)

#endif // OAIElasticPoolUpdate_sku_H
