...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.ElasticPoolUpdateSku();
  });
  ...
  describe('ElasticPoolUpdateSku', function() {
    it('should create an instance of ElasticPoolUpdateSku', function() {
      // uncomment below and update the code to test ElasticPoolUpdateSku
      //var instance = new SqlManagementClient.ElasticPoolUpdateSku();
      //expect(instance).to.be.a(SqlManagementClient.ElasticPoolUpdateSku);
    });
