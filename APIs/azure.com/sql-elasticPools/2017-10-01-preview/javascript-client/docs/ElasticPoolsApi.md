...
let parameters = new SqlManagementClient.ElasticPool(); // ElasticPool | The elastic pool parameters.
apiInstance.elasticPoolsCreateOrUpdate(resourceGroupName, serverName, elasticPoolName, subscriptionId, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let subscriptionId = "subscriptionId_example"; // String | The subscription ID that identifies an Azure subscription.
let apiVersion = "apiVersion_example"; // String | The API version to use for the request.
apiInstance.elasticPoolsDelete(resourceGroupName, serverName, elasticPoolName, subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let subscriptionId = "subscriptionId_example"; // String | The subscription ID that identifies an Azure subscription.
let apiVersion = "apiVersion_example"; // String | The API version to use for the request.
apiInstance.elasticPoolsGet(resourceGroupName, serverName, elasticPoolName, subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ElasticPoolListResult elasticPoolsListByServer(resourceGroupName, serverName, subscriptionId, apiVersion, opts)
...
apiInstance.elasticPoolsListByServer(resourceGroupName, serverName, subscriptionId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription ID that identifies an Azure subscription.
let apiVersion = "apiVersion_example"; // String | The API version to use for the request.
let parameters = new SqlManagementClient.ElasticPoolUpdate(); // ElasticPoolUpdate | The elastic pool update parameters.
apiInstance.elasticPoolsUpdate(resourceGroupName, serverName, elasticPoolName, subscriptionId, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
