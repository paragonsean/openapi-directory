...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FabricAdminClient.ComputeOperationResultModel();
  });
  ...
  describe('ComputeOperationResultModel', function() {
    it('should create an instance of ComputeOperationResultModel', function() {
      // uncomment below and update the code to test ComputeOperationResultModel
      //var instance = new FabricAdminClient.ComputeOperationResultModel();
      //expect(instance).to.be.a(FabricAdminClient.ComputeOperationResultModel);
    });
