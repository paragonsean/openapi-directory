...
> PolicySnippetListByService200Response policySnippetListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
...
apiInstance.policySnippetListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
