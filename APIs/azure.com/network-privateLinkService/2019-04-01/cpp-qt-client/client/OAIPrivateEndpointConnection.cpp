...
QString OAIPrivateEndpointConnection::getEtag() const {
    return m_etag;
}
void OAIPrivateEndpointConnection::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIPrivateEndpointConnection::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIPrivateEndpointConnection::is_etag_Valid() const{
