...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.PrivateEndpointConnectionProperties();
  });
  ...
  describe('PrivateEndpointConnectionProperties', function() {
    it('should create an instance of PrivateEndpointConnectionProperties', function() {
      ...
      //var instance = new NetworkManagementClient.PrivateEndpointConnectionProperties();
      //expect(instance).to.be.a(NetworkManagementClient.PrivateEndpointConnectionProperties);
    });
