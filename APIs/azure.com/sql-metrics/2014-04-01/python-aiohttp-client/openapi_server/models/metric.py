...
class Metric(Model):
    ...
    def __init__(self, end_time: datetime=None, metric_values: List[MetricValue]=None, name: MetricName=None, start_time: datetime=None, time_grain: str=None, unit: str=None):
