...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabase.MetricAvailability();
  });
  ...
  describe('MetricAvailability', function() {
    it('should create an instance of MetricAvailability', function() {
      ...
      //var instance = new AzureSqlDatabase.MetricAvailability();
      //expect(instance).to.be.a(AzureSqlDatabase.MetricAvailability);
    });
