...
QString OAILocation::getSubscriptionId() const {
    return m_subscription_id;
}
void OAILocation::setSubscriptionId(const QString &subscription_id) {
    m_subscription_id = subscription_id;
    m_subscription_id_isSet = true;
}

bool OAILocation::is_subscription_id_Set() const{
    return m_subscription_id_isSet;
}

bool OAILocation::is_subscription_id_Valid() const{
