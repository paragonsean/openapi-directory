...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionClient.SubscriptionOperation();
  });
  ...
  describe('SubscriptionOperation', function() {
    it('should create an instance of SubscriptionOperation', function() {
      // uncomment below and update the code to test SubscriptionOperation
      //var instance = new SubscriptionClient.SubscriptionOperation();
      //expect(instance).to.be.a(SubscriptionClient.SubscriptionOperation);
    });
