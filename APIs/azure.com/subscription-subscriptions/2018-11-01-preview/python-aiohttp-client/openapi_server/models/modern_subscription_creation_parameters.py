...
class ModernSubscriptionCreationParameters(Model):
    ...
    def __init__(self, additional_parameters: Dict[str, object]=None, billing_profile_id: str=None, cost_center: str=None, display_name: str=None, management_group_id: str=None, owner: AdPrincipal=None, sku_id: str=None):
        """ModernSubscriptionCreationParameters - a model defined in OpenAPI

        :param additional_parameters: The additional_parameters of this ModernSubscriptionCreationParameters.
        :param billing_profile_id: The billing_profile_id of this ModernSubscriptionCreationParameters.
    ...
    def additional_parameters(self):
        """Gets the additional_parameters of this ModernSubscriptionCreationParameters.

        Additional, untyped parameters to support custom subscription creation scenarios.

        :return: The additional_parameters of this ModernSubscriptionCreationParameters.
    ...
    def additional_parameters(self, additional_parameters):
        """Sets the additional_parameters of this ModernSubscriptionCreationParameters.
    ...
    def billing_profile_id(self):
        """Gets the billing_profile_id of this ModernSubscriptionCreationParameters.

        The ARM ID of the billing profile for which you want to create the subscription.

        :return: The billing_profile_id of this ModernSubscriptionCreationParameters.
        :rtype: str
        """
    ...
    def billing_profile_id(self, billing_profile_id):
        """Sets the billing_profile_id of this ModernSubscriptionCreationParameters.
        ...
        if billing_profile_id is None:
            raise ValueError("Invalid value for `billing_profile_id`, must not be `None`")
