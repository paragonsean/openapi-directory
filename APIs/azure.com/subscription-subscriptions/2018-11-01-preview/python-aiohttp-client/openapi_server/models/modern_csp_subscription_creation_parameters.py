...
class ModernCspSubscriptionCreationParameters(Model):
    ...
    def __init__(self, display_name: str=None, reseller_id: str=None, service_provider_id: str=None, sku_id: str=None):
        ...
        :param service_provider_id: The service_provider_id of this ModernCspSubscriptionCreationParameters.
    ...
    def service_provider_id(self):
        """Gets the service_provider_id of this ModernCspSubscriptionCreationParameters.

        Service provider ID, basically MPN Id.

        :return: The service_provider_id of this ModernCspSubscriptionCreationParameters.
        :rtype: str
        """
    ...
    def service_provider_id(self, service_provider_id):
        """Sets the service_provider_id of this ModernCspSubscriptionCreationParameters.
