...
QMap<QString, OAIObject> OAIModernSubscriptionCreationParameters::getAdditionalParameters() const {
    return m_additional_parameters;
}
void OAIModernSubscriptionCreationParameters::setAdditionalParameters(const QMap<QString, OAIObject> &additional_parameters) {
    m_additional_parameters = additional_parameters;
    m_additional_parameters_isSet = true;
}

bool OAIModernSubscriptionCreationParameters::is_additional_parameters_Set() const{
    return m_additional_parameters_isSet;
}

bool OAIModernSubscriptionCreationParameters::is_additional_parameters_Valid() const{
    return m_additional_parameters_isValid;
}

QString OAIModernSubscriptionCreationParameters::getBillingProfileId() const {
    return m_billing_profile_id;
}
void OAIModernSubscriptionCreationParameters::setBillingProfileId(const QString &billing_profile_id) {
    m_billing_profile_id = billing_profile_id;
    m_billing_profile_id_isSet = true;
}

bool OAIModernSubscriptionCreationParameters::is_billing_profile_id_Set() const{
    return m_billing_profile_id_isSet;
}

bool OAIModernSubscriptionCreationParameters::is_billing_profile_id_Valid() const{
...
bool OAIModernSubscriptionCreationParameters::isValid() const {
    ...
    return m_billing_profile_id_isValid && m_display_name_isValid && m_sku_id_isValid && true;
}
