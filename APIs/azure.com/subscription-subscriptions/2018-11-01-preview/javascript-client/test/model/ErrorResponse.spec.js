...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new SubscriptionClient.ErrorResponse();
      //expect(instance).to.be.a(SubscriptionClient.ErrorResponse);
    });
