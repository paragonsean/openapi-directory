...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new SubscriptionClient.OperationDisplay();
      //expect(instance).to.be.a(SubscriptionClient.OperationDisplay);
    });
