...
async def operations_list(request: web.Request, api_version) -> web.Response:
    ...
    :param api_version: Version of the API to be used with the client request. Current version is 2020-01-01
...
async def subscription_cancel(request: web.Request, subscription_id, api_version) -> web.Response:
    """subscription_cancel
...
async def subscription_create_csp_subscription(request: web.Request, billing_account_name, customer_name, api_version, body) -> web.Response:
...
async def subscription_create_subscription(request: web.Request, billing_account_name, billing_profile_name, invoice_section_name, api_version, body) -> web.Response:
...
async def subscription_create_subscription_in_enrollment_account(request: web.Request, enrollment_account_name, api_version, body) -> web.Response:
...
async def subscription_enable(request: web.Request, subscription_id, api_version) -> web.Response:
    """subscription_enable
...
async def subscription_rename(request: web.Request, subscription_id, api_version, body) -> web.Response:
    """subscription_rename
