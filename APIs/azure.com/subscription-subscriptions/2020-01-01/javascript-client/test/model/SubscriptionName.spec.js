...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionClient.SubscriptionName();
  });
  ...
  describe('SubscriptionName', function() {
    it('should create an instance of SubscriptionName', function() {
      // uncomment below and update the code to test SubscriptionName
      //var instance = new SubscriptionClient.SubscriptionName();
      //expect(instance).to.be.a(SubscriptionClient.SubscriptionName);
    });
