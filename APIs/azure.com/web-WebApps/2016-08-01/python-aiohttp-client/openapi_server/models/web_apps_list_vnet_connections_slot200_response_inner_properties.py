...
class WebAppsListVnetConnectionsSlot200ResponseInnerProperties(Model):
    ...
    def __init__(self, cert_blob: str=None, cert_thumbprint: str=None, dns_servers: str=None, resync_required: bool=None, routes: List[WebAppsListVnetConnectionsSlot200ResponseInnerPropertiesRoutesInner]=None, vnet_resource_id: str=None):
