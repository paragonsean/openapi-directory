...
[**webAppsDiscoverRestore**](WebAppsApi.md#webAppsDiscoverRestore) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/backups/discover | Discovers an existing app backup that can be restored from a blob in Azure storage.
[**webAppsDiscoverRestoreSlot**](WebAppsApi.md#webAppsDiscoverRestoreSlot) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/backups/discover | Discovers an existing app backup that can be restored from a blob in Azure storage.
...
[**webAppsGetWebSiteContainerLogsZip**](WebAppsApi.md#webAppsGetWebSiteContainerLogsZip) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/containerlogs/zip/download | Gets the ZIP archived docker log files for the given site
[**webAppsGetWebSiteContainerLogsZipSlot**](WebAppsApi.md#webAppsGetWebSiteContainerLogsZipSlot) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/containerlogs/zip/download | Gets the ZIP archived docker log files for the given site
...
[**webAppsListSiteExtensions**](WebAppsApi.md#webAppsListSiteExtensions) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/siteextensions | Get list of site extensions for a web site, or a deployment slot.
[**webAppsListSiteExtensionsSlot**](WebAppsApi.md#webAppsListSiteExtensionsSlot) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/siteextensions | Get list of site extensions for a web site, or a deployment slot.
...
[**webAppsRecover**](WebAppsApi.md#webAppsRecover) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/recover | Recovers a web app to a previous snapshot.
...
[**webAppsRecoverSlot**](WebAppsApi.md#webAppsRecoverSlot) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/recover | Recovers a web app to a previous snapshot.
...
[**webAppsStartWebSiteNetworkTrace**](WebAppsApi.md#webAppsStartWebSiteNetworkTrace) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/networkTrace/start | Start capturing network packets for the site.
[**webAppsStartWebSiteNetworkTraceSlot**](WebAppsApi.md#webAppsStartWebSiteNetworkTraceSlot) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/networkTrace/start | Start capturing network packets for the site.
...
[**webAppsSyncFunctionTriggers**](WebAppsApi.md#webAppsSyncFunctionTriggers) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/syncfunctiontriggers | Syncs function trigger metadata to the scale controller
[**webAppsSyncFunctionTriggersSlot**](WebAppsApi.md#webAppsSyncFunctionTriggersSlot) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/slots/{slot}/syncfunctiontriggers | Syncs function trigger metadata to the scale controller
...
> WebAppsGet200Response webAppsCreateOrUpdateSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, siteEnvelope, opts)
...
let siteEnvelope = new WebAppsApiClient.WebAppsGet200Response(); // WebAppsGet200Response | A JSON representation of the app properties. See example.
let opts = {
  'skipDnsRegistration': true, // Boolean | If true web app hostname is not registered with DNS on creation. This parameter is  only used for app creation.
  'skipCustomDomainVerification': true, // Boolean | If true, custom (non *.azurewebsites.net) domains associated with web app are not verified.
  'forceDnsRegistration': true, // Boolean | If true, web app hostname is force registered with DNS.
  'ttlInSeconds': "ttlInSeconds_example" // String | Time to live in seconds for web app's default domain name.
};
apiInstance.webAppsCreateOrUpdateSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, siteEnvelope, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **apiVersion** | **String**| API Version | 
 **siteEnvelope** | [**WebAppsGet200Response**](WebAppsGet200Response.md)| A JSON representation of the app properties. See example. | 
 **skipDnsRegistration** | **Boolean**| If true web app hostname is not registered with DNS on creation. This parameter is  only used for app creation. | [optional] 
 **skipCustomDomainVerification** | **Boolean**| If true, custom (non *.azurewebsites.net) domains associated with web app are not verified. | [optional] 
 **forceDnsRegistration** | **Boolean**| If true, web app hostname is force registered with DNS. | [optional] 
...
let opts = {
  ...
  'skipDnsRegistration': true // Boolean | If true, DNS registration is skipped.
};
 ...
 **skipDnsRegistration** | **Boolean**| If true, DNS registration is skipped. | [optional] 
...
> RestoreRequest webAppsDiscoverRestore(resourceGroupName, name, subscriptionId, apiVersion, request)
...
apiInstance.webAppsDiscoverRestore(resourceGroupName, name, subscriptionId, apiVersion, request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RestoreRequest webAppsDiscoverRestoreSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, request)
...
let apiVersion = "apiVersion_example"; // String | API Version
let request = new WebAppsApiClient.RestoreRequest(); // RestoreRequest | A RestoreRequest object that includes Azure storage URL and blog name for discovery of backup.
apiInstance.webAppsDiscoverRestoreSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File webAppsGetWebSiteContainerLogsZip(resourceGroupName, name, subscriptionId, apiVersion)
...
let subscriptionId = "subscriptionId_example"; // String | Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).
let apiVersion = "apiVersion_example"; // String | API Version
apiInstance.webAppsGetWebSiteContainerLogsZip(resourceGroupName, name, subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File webAppsGetWebSiteContainerLogsZipSlot(resourceGroupName, name, slot, subscriptionId, apiVersion)
...
let subscriptionId = "subscriptionId_example"; // String | Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).
let apiVersion = "apiVersion_example"; // String | API Version
apiInstance.webAppsGetWebSiteContainerLogsZipSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> webAppsRecover(resourceGroupName, name, subscriptionId, apiVersion, recoveryEntity)
...
let subscriptionId = "subscriptionId_example"; // String | Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).
let apiVersion = "apiVersion_example"; // String | API Version
let recoveryEntity = new WebAppsApiClient.WebAppsRecoverRequest(); // WebAppsRecoverRequest | Snapshot data used for web app recovery. Snapshot information can be obtained by calling GetDeletedSites or GetSiteSnapshots API.
apiInstance.webAppsRecover(resourceGroupName, name, subscriptionId, apiVersion, recoveryEntity, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **subscriptionId** | **String**| Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). | 
 **apiVersion** | **String**| API Version | 
 **recoveryEntity** | [**WebAppsRecoverRequest**](WebAppsRecoverRequest.md)| Snapshot data used for web app recovery. Snapshot information can be obtained by calling GetDeletedSites or GetSiteSnapshots API. | 
...
> webAppsRecoverSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, recoveryEntity)
...
let apiVersion = "apiVersion_example"; // String | API Version
let recoveryEntity = new WebAppsApiClient.WebAppsRecoverRequest(); // WebAppsRecoverRequest | Snapshot data used for web app recovery. Snapshot information can be obtained by calling GetDeletedSites or GetSiteSnapshots API.
apiInstance.webAppsRecoverSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, recoveryEntity, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> RestoreResponse webAppsRestore(resourceGroupName, name, backupId, subscriptionId, apiVersion, request)
...
> RestoreResponse webAppsRestoreSlot(resourceGroupName, name, backupId, slot, subscriptionId, apiVersion, request)
...
> String webAppsStopWebSiteNetworkTrace(resourceGroupName, name, subscriptionId, apiVersion)
...
> String webAppsStopWebSiteNetworkTraceSlot(resourceGroupName, name, slot, subscriptionId, apiVersion)
...
> WebAppsGet200Response webAppsUpdateSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, siteEnvelope, opts)
...
apiInstance.webAppsUpdateSlot(resourceGroupName, name, slot, subscriptionId, apiVersion, siteEnvelope, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
