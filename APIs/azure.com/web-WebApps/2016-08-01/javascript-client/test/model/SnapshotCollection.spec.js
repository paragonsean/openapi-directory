...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebAppsApiClient.SnapshotCollection();
  });
  ...
  describe('SnapshotCollection', function() {
    it('should create an instance of SnapshotCollection', function() {
      // uncomment below and update the code to test SnapshotCollection
      //var instance = new WebAppsApiClient.SnapshotCollection();
      //expect(instance).to.be.a(WebAppsApiClient.SnapshotCollection);
    });
