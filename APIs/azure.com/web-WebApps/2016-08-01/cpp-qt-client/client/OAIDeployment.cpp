...
OAIObject OAIDeployment::getProperties() const {
    return m_properties;
}
void OAIDeployment::setProperties(const OAIObject &properties) {
...
QString OAIDeployment::getKind() const {
    return m_kind;
}
void OAIDeployment::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIDeployment::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIDeployment::is_kind_Valid() const{
