...
qint32 OAIPerfMonSample::getCoreCount() const {
    return m_core_count;
}
void OAIPerfMonSample::setCoreCount(const qint32 &core_count) {
    m_core_count = core_count;
    m_core_count_isSet = true;
}

bool OAIPerfMonSample::is_core_count_Set() const{
    return m_core_count_isSet;
}

bool OAIPerfMonSample::is_core_count_Valid() const{
