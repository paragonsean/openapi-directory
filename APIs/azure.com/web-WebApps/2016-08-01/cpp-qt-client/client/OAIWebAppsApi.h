...
#include "OAIWebApps_Recover_request.h"
...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  site_envelope OAIWebApps_Get_200_response [required]
    * @param[in]  skip_dns_registration bool [optional]
    * @param[in]  skip_custom_domain_verification bool [optional]
    * @param[in]  force_dns_registration bool [optional]
    * @param[in]  ttl_in_seconds QString [optional]
    */
    virtual void webAppsCreateOrUpdateSlot(const QString &resource_group_name, const QString &name, const QString &slot, const QString &subscription_id, const QString &api_version, const OAIWebApps_Get_200_response &site_envelope, const ::OpenAPI::OptionalParam<bool> &skip_dns_registration = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &skip_custom_domain_verification = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &force_dns_registration = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ttl_in_seconds = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  skip_dns_registration bool [optional]
    */
    virtual void webAppsDeleteSlot(const QString &resource_group_name, const QString &name, const QString &slot, const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<bool> &delete_metrics = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &delete_empty_server_farm = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &skip_dns_registration = ::OpenAPI::OptionalParam<bool>());
    ...
    */
    virtual void webAppsDiscoverRestore(const QString &resource_group_name, const QString &name, const QString &subscription_id, const QString &api_version, const OAIRestoreRequest &request);
    ...
    * @param[in]  request OAIRestoreRequest [required]
    */
    virtual void webAppsDiscoverRestoreSlot(const QString &resource_group_name, const QString &name, const QString &slot, const QString &subscription_id, const QString &api_version, const OAIRestoreRequest &request);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void webAppsGetWebSiteContainerLogsZip(const QString &resource_group_name, const QString &name, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void webAppsGetWebSiteContainerLogsZipSlot(const QString &resource_group_name, const QString &name, const QString &slot, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  subscription_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  recovery_entity OAIWebApps_Recover_request [required]
    */
    virtual void webAppsRecover(const QString &resource_group_name, const QString &name, const QString &subscription_id, const QString &api_version, const OAIWebApps_Recover_request &recovery_entity);
    ...
    * @param[in]  recovery_entity OAIWebApps_Recover_request [required]
    */
    virtual void webAppsRecoverSlot(const QString &resource_group_name, const QString &name, const QString &slot, const QString &subscription_id, const QString &api_version, const OAIWebApps_Recover_request &recovery_entity);
    ...
    * @param[in]  ttl_in_seconds QString [optional]
    */
    virtual void webAppsUpdateSlot(const QString &resource_group_name, const QString &name, const QString &slot, const QString &subscription_id, const QString &api_version, const OAISitePatchResource &site_envelope, const ::OpenAPI::OptionalParam<bool> &skip_dns_registration = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &skip_custom_domain_verification = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &force_dns_registration = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &ttl_in_seconds = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void webAppsDiscoverRestoreCallback(OAIHttpRequestWorker *worker);
    void webAppsDiscoverRestoreSlotCallback(OAIHttpRequestWorker *worker);
    ...
    void webAppsGetWebSiteContainerLogsZipCallback(OAIHttpRequestWorker *worker);
    void webAppsGetWebSiteContainerLogsZipSlotCallback(OAIHttpRequestWorker *worker);
    ...
    void webAppsRecoverCallback(OAIHttpRequestWorker *worker);
    ...
    void webAppsRecoverSlotCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void webAppsDiscoverRestoreSignal(OAIRestoreRequest summary);
    void webAppsDiscoverRestoreSlotSignal(OAIRestoreRequest summary);
    ...
    void webAppsGetWebSiteContainerLogsZipSignal(OAIHttpFileElement summary);
    void webAppsGetWebSiteContainerLogsZipSlotSignal(OAIHttpFileElement summary);
    ...
    void webAppsRestoreSignal(OAIRestoreResponse summary);
    void webAppsRestoreSlotSignal(OAIRestoreResponse summary);
    ...
    void webAppsStopWebSiteNetworkTraceSignal(QString summary);
    void webAppsStopWebSiteNetworkTraceSlotSignal(QString summary);
    ...
    void webAppsDiscoverRestoreSignalFull(OAIHttpRequestWorker *worker, OAIRestoreRequest summary);
    void webAppsDiscoverRestoreSlotSignalFull(OAIHttpRequestWorker *worker, OAIRestoreRequest summary);
    ...
    void webAppsGetWebSiteContainerLogsZipSignalFull(OAIHttpRequestWorker *worker, OAIHttpFileElement summary);
    void webAppsGetWebSiteContainerLogsZipSlotSignalFull(OAIHttpRequestWorker *worker, OAIHttpFileElement summary);
    ...
    void webAppsRecoverSignalFull(OAIHttpRequestWorker *worker);
    ...
    void webAppsRecoverSlotSignalFull(OAIHttpRequestWorker *worker);
    ...
    void webAppsRestoreSignalFull(OAIHttpRequestWorker *worker, OAIRestoreResponse summary);
    void webAppsRestoreSlotSignalFull(OAIHttpRequestWorker *worker, OAIRestoreResponse summary);
    ...
    void webAppsStopWebSiteNetworkTraceSignalFull(OAIHttpRequestWorker *worker, QString summary);
    void webAppsStopWebSiteNetworkTraceSlotSignalFull(OAIHttpRequestWorker *worker, QString summary);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsDiscoverRestoreSignalError() instead")
    void webAppsDiscoverRestoreSignalE(OAIRestoreRequest summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsDiscoverRestoreSignalError(OAIRestoreRequest summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webAppsDiscoverRestoreSlotSignalError() instead")
    void webAppsDiscoverRestoreSlotSignalE(OAIRestoreRequest summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsDiscoverRestoreSlotSignalError(OAIRestoreRequest summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsGetWebSiteContainerLogsZipSignalError() instead")
    void webAppsGetWebSiteContainerLogsZipSignalE(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsGetWebSiteContainerLogsZipSignalError(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webAppsGetWebSiteContainerLogsZipSlotSignalError() instead")
    void webAppsGetWebSiteContainerLogsZipSlotSignalE(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsGetWebSiteContainerLogsZipSlotSignalError(OAIHttpFileElement summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsRecoverSignalError() instead")
    void webAppsRecoverSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsRecoverSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsRecoverSlotSignalError() instead")
    void webAppsRecoverSlotSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsRecoverSlotSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void webAppsRestoreSignalE(OAIRestoreResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsRestoreSignalError(OAIRestoreResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webAppsRestoreSlotSignalError() instead")
    void webAppsRestoreSlotSignalE(OAIRestoreResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsRestoreSlotSignalError(OAIRestoreResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void webAppsStopWebSiteNetworkTraceSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsStopWebSiteNetworkTraceSignalError(QString summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webAppsStopWebSiteNetworkTraceSlotSignalError() instead")
    void webAppsStopWebSiteNetworkTraceSlotSignalE(QString summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsStopWebSiteNetworkTraceSlotSignalError(QString summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsDiscoverRestoreSignalErrorFull() instead")
    void webAppsDiscoverRestoreSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsDiscoverRestoreSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webAppsDiscoverRestoreSlotSignalErrorFull() instead")
    void webAppsDiscoverRestoreSlotSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsDiscoverRestoreSlotSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsGetWebSiteContainerLogsZipSignalErrorFull() instead")
    void webAppsGetWebSiteContainerLogsZipSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsGetWebSiteContainerLogsZipSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webAppsGetWebSiteContainerLogsZipSlotSignalErrorFull() instead")
    void webAppsGetWebSiteContainerLogsZipSlotSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsGetWebSiteContainerLogsZipSlotSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsRecoverSignalErrorFull() instead")
    void webAppsRecoverSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsRecoverSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webAppsRecoverSlotSignalErrorFull() instead")
    void webAppsRecoverSlotSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webAppsRecoverSlotSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
