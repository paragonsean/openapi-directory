...
OAIWebApps_List_200_response_value_inner_properties_snapshotInfo OAIWebApps_List_200_response_value_inner_properties::getSnapshotInfo() const {
    return m_snapshot_info;
}
void OAIWebApps_List_200_response_value_inner_properties::setSnapshotInfo(const OAIWebApps_List_200_response_value_inner_properties_snapshotInfo &snapshot_info) {
    m_snapshot_info = snapshot_info;
    m_snapshot_info_isSet = true;
}

bool OAIWebApps_List_200_response_value_inner_properties::is_snapshot_info_Set() const{
    return m_snapshot_info_isSet;
}

bool OAIWebApps_List_200_response_value_inner_properties::is_snapshot_info_Valid() const{
