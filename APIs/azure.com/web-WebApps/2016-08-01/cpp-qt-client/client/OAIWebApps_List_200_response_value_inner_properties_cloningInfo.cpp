...
bool OAIWebApps_List_200_response_value_inner_properties_cloningInfo::isIgnoreQuotas() const {
    return m_ignore_quotas;
}
void OAIWebApps_List_200_response_value_inner_properties_cloningInfo::setIgnoreQuotas(const bool &ignore_quotas) {
    m_ignore_quotas = ignore_quotas;
    m_ignore_quotas_isSet = true;
}

bool OAIWebApps_List_200_response_value_inner_properties_cloningInfo::is_ignore_quotas_Set() const{
    return m_ignore_quotas_isSet;
}

bool OAIWebApps_List_200_response_value_inner_properties_cloningInfo::is_ignore_quotas_Valid() const{
