...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebAppsApiClient.WebAppsList200ResponseValueInnerPropertiesSiteConfig();
  });
  ...
  describe('WebAppsList200ResponseValueInnerPropertiesSiteConfig', function() {
    it('should create an instance of WebAppsList200ResponseValueInnerPropertiesSiteConfig', function() {
      // uncomment below and update the code to test WebAppsList200ResponseValueInnerPropertiesSiteConfig
      //var instance = new WebAppsApiClient.WebAppsList200ResponseValueInnerPropertiesSiteConfig();
      //expect(instance).to.be.a(WebAppsApiClient.WebAppsList200ResponseValueInnerPropertiesSiteConfig);
    });
