...
/**
 * The WebAppsList200ResponseValueInnerPropertiesCloningInfo model module.
 * @module model/WebAppsList200ResponseValueInnerPropertiesCloningInfo
 * @version 2018-02-01
 */
class WebAppsList200ResponseValueInnerPropertiesCloningInfo {
    /**
     * Constructs a new <code>WebAppsList200ResponseValueInnerPropertiesCloningInfo</code>.
     * Information needed for cloning operation.
     * @alias module:model/WebAppsList200ResponseValueInnerPropertiesCloningInfo
    ...
    constructor(sourceWebAppId) { 
        ...
        WebAppsList200ResponseValueInnerPropertiesCloningInfo.initialize(this, sourceWebAppId);
    }
    ...
    /**
     * Constructs a <code>WebAppsList200ResponseValueInnerPropertiesCloningInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebAppsList200ResponseValueInnerPropertiesCloningInfo} obj Optional instance to populate.
     * @return {module:model/WebAppsList200ResponseValueInnerPropertiesCloningInfo} The populated <code>WebAppsList200ResponseValueInnerPropertiesCloningInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebAppsList200ResponseValueInnerPropertiesCloningInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>WebAppsList200ResponseValueInnerPropertiesCloningInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebAppsList200ResponseValueInnerPropertiesCloningInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebAppsList200ResponseValueInnerPropertiesCloningInfo.RequiredProperties) {
...
WebAppsList200ResponseValueInnerPropertiesCloningInfo.RequiredProperties = ["sourceWebAppId"];
 ...
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['appSettingsOverrides'] = undefined;

/**
 * <code>true</code> to clone custom hostnames from source app; otherwise, <code>false</code>.
 * @member {Boolean} cloneCustomHostNames
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['cloneCustomHostNames'] = undefined;

/**
 * <code>true</code> to clone source control from source app; otherwise, <code>false</code>.
 * @member {Boolean} cloneSourceControl
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['cloneSourceControl'] = undefined;

/**
 * <code>true</code> to configure load balancing for source and destination app.
 * @member {Boolean} configureLoadBalancing
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['configureLoadBalancing'] = undefined;

/**
 * Correlation ID of cloning operation. This ID ties multiple cloning operations together to use the same snapshot.
 * @member {String} correlationId
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['correlationId'] = undefined;

/**
 * App Service Environment.
 * @member {String} hostingEnvironment
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['hostingEnvironment'] = undefined;

/**
 * <code>true</code> to overwrite destination app; otherwise, <code>false</code>.
 * @member {Boolean} overwrite
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['overwrite'] = undefined;

/**
 * ARM resource ID of the source app. App resource ID is of the form  /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName} for production slots and  /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName} for other slots.
 * @member {String} sourceWebAppId
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['sourceWebAppId'] = undefined;

/**
 * Location of source app ex: West US or North Europe
 * @member {String} sourceWebAppLocation
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['sourceWebAppLocation'] = undefined;
 ...
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['trafficManagerProfileId'] = undefined;

/**
 * Name of Traffic Manager profile to create. This is only needed if Traffic Manager profile does not already exist.
 * @member {String} trafficManagerProfileName
 */
WebAppsList200ResponseValueInnerPropertiesCloningInfo.prototype['trafficManagerProfileName'] = undefined;
...
export default WebAppsList200ResponseValueInnerPropertiesCloningInfo;
