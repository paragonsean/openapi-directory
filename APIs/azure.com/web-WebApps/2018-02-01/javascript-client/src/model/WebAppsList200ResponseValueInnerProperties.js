...
import WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner from './WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner';
...
class WebAppsList200ResponseValueInnerProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('geoDistributions')) {
                obj['geoDistributions'] = ApiClient.convertToType(data['geoDistributions'], [WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['geoDistributions']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['geoDistributions'])) {
                throw new Error("Expected the field `geoDistributions` to be an array in the JSON data but got " + data['geoDistributions']);
            }
            // validate the optional field `geoDistributions` (array)
            for (const item of data['geoDistributions']) {
                WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner.validateJSON(item);
            };
        }
 ...
 */
WebAppsList200ResponseValueInnerProperties.prototype['clientCertExclusionPaths'] = undefined;
 ...
 * @member {Array.<module:model/WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner>} geoDistributions
 */
WebAppsList200ResponseValueInnerProperties.prototype['geoDistributions'] = undefined;
 ...
 * @default false
 */
WebAppsList200ResponseValueInnerProperties.prototype['hyperV'] = false;

/**
 * Specifies an operation id if this site has a pending operation.
 * @member {String} inProgressOperationId
 */
WebAppsList200ResponseValueInnerProperties.prototype['inProgressOperationId'] = undefined;
 ...
 * @default false
 */
WebAppsList200ResponseValueInnerProperties.prototype['isXenon'] = false;
 ...
 * @member {module:model/WebAppsList200ResponseValueInnerProperties.RedundancyModeEnum} redundancyMode
 */
WebAppsList200ResponseValueInnerProperties.prototype['redundancyMode'] = undefined;
 ...
 * @readonly
 */
WebAppsList200ResponseValueInnerProperties['RedundancyModeEnum'] = {
