...
QList<OAIWebApps_List_200_response_value_inner_properties_geoDistributions_inner> OAIWebApps_List_200_response_value_inner_properties::getGeoDistributions() const {
    return m_geo_distributions;
}
void OAIWebApps_List_200_response_value_inner_properties::setGeoDistributions(const QList<OAIWebApps_List_200_response_value_inner_properties_geoDistributions_inner> &geo_distributions) {
    m_geo_distributions = geo_distributions;
    m_geo_distributions_isSet = true;
}

bool OAIWebApps_List_200_response_value_inner_properties::is_geo_distributions_Set() const{
    return m_geo_distributions_isSet;
}

bool OAIWebApps_List_200_response_value_inner_properties::is_geo_distributions_Valid() const{
