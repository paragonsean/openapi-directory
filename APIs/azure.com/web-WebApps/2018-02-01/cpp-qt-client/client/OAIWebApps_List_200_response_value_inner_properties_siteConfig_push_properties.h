...
/*
 * OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties.h
 *
 * PushSettings resource specific properties
 */

#ifndef OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties_H
#define OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties_H
...
class OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties : public OAIObject {
public:
    OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties();
    OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties(QString json);
    ~OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties)

#endif // OAIWebApps_List_200_response_value_inner_properties_siteConfig_push_properties_H
