...
class BackupSchedule(Model):
    ...
    def __init__(self, frequency_interval: int=7, frequency_unit: str='Day', keep_at_least_one_backup: bool=True, last_execution_time: datetime=None, retention_period_in_days: int=30, start_time: datetime=None):
    ...
    def frequency_interval(self, frequency_interval):
        ...
        if frequency_interval is None:
            raise ValueError("Invalid value for `frequency_interval`, must not be `None`")
    ...
    def keep_at_least_one_backup(self, keep_at_least_one_backup):
        ...
        if keep_at_least_one_backup is None:
            raise ValueError("Invalid value for `keep_at_least_one_backup`, must not be `None`")
    ...
    def retention_period_in_days(self, retention_period_in_days):
        ...
        if retention_period_in_days is None:
            raise ValueError("Invalid value for `retention_period_in_days`, must not be `None`")
