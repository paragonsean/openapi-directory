...
OAIWebApps_List_200_response_value_inner_properties_siteConfig_apiManagementConfig OAIWebApps_List_200_response_value_inner_properties_siteConfig::getApiManagementConfig() const {
    return m_api_management_config;
}
void OAIWebApps_List_200_response_value_inner_properties_siteConfig::setApiManagementConfig(const OAIWebApps_List_200_response_value_inner_properties_siteConfig_apiManagementConfig &api_management_config) {
    m_api_management_config = api_management_config;
    m_api_management_config_isSet = true;
}

bool OAIWebApps_List_200_response_value_inner_properties_siteConfig::is_api_management_config_Set() const{
    return m_api_management_config_isSet;
}

bool OAIWebApps_List_200_response_value_inner_properties_siteConfig::is_api_management_config_Valid() const{
...
QString OAIWebApps_List_200_response_value_inner_properties_siteConfig::getHealthCheckPath() const {
    return m_health_check_path;
}
void OAIWebApps_List_200_response_value_inner_properties_siteConfig::setHealthCheckPath(const QString &health_check_path) {
    m_health_check_path = health_check_path;
    m_health_check_path_isSet = true;
}

bool OAIWebApps_List_200_response_value_inner_properties_siteConfig::is_health_check_path_Set() const{
    return m_health_check_path_isSet;
}

bool OAIWebApps_List_200_response_value_inner_properties_siteConfig::is_health_check_path_Valid() const{
...
qint32 OAIWebApps_List_200_response_value_inner_properties_siteConfig::getPreWarmedInstanceCount() const {
    return m_pre_warmed_instance_count;
}
void OAIWebApps_List_200_response_value_inner_properties_siteConfig::setPreWarmedInstanceCount(const qint32 &pre_warmed_instance_count) {
    m_pre_warmed_instance_count = pre_warmed_instance_count;
    m_pre_warmed_instance_count_isSet = true;
}

bool OAIWebApps_List_200_response_value_inner_properties_siteConfig::is_pre_warmed_instance_count_Set() const{
    return m_pre_warmed_instance_count_isSet;
}

bool OAIWebApps_List_200_response_value_inner_properties_siteConfig::is_pre_warmed_instance_count_Valid() const{
