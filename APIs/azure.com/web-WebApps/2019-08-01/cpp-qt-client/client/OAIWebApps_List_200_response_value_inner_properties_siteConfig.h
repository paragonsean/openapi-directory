...
class OAIWebApps_List_200_response_value_inner_properties_siteConfig_apiManagementConfig;
...
public:
    ...
    OAIWebApps_List_200_response_value_inner_properties_siteConfig_apiManagementConfig getApiManagementConfig() const;
    void setApiManagementConfig(const OAIWebApps_List_200_response_value_inner_properties_siteConfig_apiManagementConfig &api_management_config);
...
private:
    ...
    OAIWebApps_List_200_response_value_inner_properties_siteConfig_apiManagementConfig m_api_management_config;
