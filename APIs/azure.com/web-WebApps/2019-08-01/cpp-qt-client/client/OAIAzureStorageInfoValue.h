...
/*
 * OAIAzureStorageInfoValue.h
 *
 * Azure Files or Blob Storage access information value for dictionary storage.
 */

#ifndef OAIAzureStorageInfoValue_H
#define OAIAzureStorageInfoValue_H
...
class OAIAzureStorageInfoValue : public OAIObject {
public:
    OAIAzureStorageInfoValue();
    OAIAzureStorageInfoValue(QString json);
    ~OAIAzureStorageInfoValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureStorageInfoValue)

#endif // OAIAzureStorageInfoValue_H
