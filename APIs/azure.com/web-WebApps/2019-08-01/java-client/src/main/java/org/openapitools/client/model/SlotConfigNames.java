...
public class SlotConfigNames {
  ...
  public static final String SERIALIZED_NAME_AZURE_STORAGE_CONFIG_NAMES = "azureStorageConfigNames";
  @SerializedName(SERIALIZED_NAME_AZURE_STORAGE_CONFIG_NAMES)
  private List<String> azureStorageConfigNames = new ArrayList<>();
  ...
  public SlotConfigNames azureStorageConfigNames(List<String> azureStorageConfigNames) {
    this.azureStorageConfigNames = azureStorageConfigNames;
    return this;
  }

  public SlotConfigNames addAzureStorageConfigNamesItem(String azureStorageConfigNamesItem) {
    if (this.azureStorageConfigNames == null) {
      this.azureStorageConfigNames = new ArrayList<>();
    }
    this.azureStorageConfigNames.add(azureStorageConfigNamesItem);
    return this;
  }

  /**
   * List of external Azure storage account identifiers.
   * @return azureStorageConfigNames
   */
  @javax.annotation.Nullable
  ...
  public void setAzureStorageConfigNames(List<String> azureStorageConfigNames) {
    this.azureStorageConfigNames = azureStorageConfigNames;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appSettingNames, slotConfigNames.appSettingNames) &&
        Objects.equals(this.azureStorageConfigNames, slotConfigNames.azureStorageConfigNames) &&
        Objects.equals(this.connectionStringNames, slotConfigNames.connectionStringNames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appSettingNames, azureStorageConfigNames, connectionStringNames);
  }
  ...
  public String toString() {
    ...
    sb.append("    azureStorageConfigNames: ").append(toIndentedString(azureStorageConfigNames)).append("\n");
  ...
  static {
    ...
    openapiFields.add("azureStorageConfigNames");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("azureStorageConfigNames") != null && !jsonObj.get("azureStorageConfigNames").isJsonNull() && !jsonObj.get("azureStorageConfigNames").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `azureStorageConfigNames` to be an array in the JSON string but got `%s`", jsonObj.get("azureStorageConfigNames").toString()));
      }
      // ensure the optional json data is an array if present
