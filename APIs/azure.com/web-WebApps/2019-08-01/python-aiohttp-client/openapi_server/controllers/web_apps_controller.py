...
async def web_apps_copy_production_slot(request: web.Request, resource_group_name, name, subscription_id, api_version, copy_slot_entity) -> web.Response:
    ...
    :param api_version: API Version
    :type api_version: str
    :param copy_slot_entity: JSON object that contains the target slot name and site config properties to override the source slot config. See example.
    :type copy_slot_entity: dict | bytes

    """
    copy_slot_entity = CsmCopySlotEntity.from_dict(copy_slot_entity)
    return web.Response(status=200)


async def web_apps_copy_slot_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, copy_slot_entity) -> web.Response:
    """Copies a deployment slot to another deployment slot of an app.
...
async def web_apps_create_or_update_function_secret(request: web.Request, resource_group_name, name, function_name, key_name, subscription_id, api_version, key) -> web.Response:
    ...
    """
    key = KeyInfo.from_dict(key)
    return web.Response(status=200)


async def web_apps_create_or_update_function_secret_slot(request: web.Request, resource_group_name, name, function_name, key_name, slot, subscription_id, api_version, key) -> web.Response:
    """Add or update a function secret.
...
async def web_apps_create_or_update_host_secret(request: web.Request, resource_group_name, name, key_type, key_name, subscription_id, api_version, key) -> web.Response:
...
async def web_apps_create_or_update_host_secret_slot(request: web.Request, resource_group_name, name, key_type, key_name, slot, subscription_id, api_version, key) -> web.Response:
    """Add or update a host level secret.
...
async def web_apps_create_or_update_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, site_envelope) -> web.Response:
    """Creates a new web, mobile, or API app in an existing resource group, or updates an existing app.
...
async def web_apps_create_or_update_swift_virtual_network_connection(request: web.Request, resource_group_name, name, subscription_id, api_version, connection_envelope) -> web.Response:
    ...
    """
    connection_envelope = SwiftVirtualNetwork.from_dict(connection_envelope)
    return web.Response(status=200)


async def web_apps_create_or_update_swift_virtual_network_connection_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, connection_envelope) -> web.Response:
    """Integrates this Web App with a Virtual Network. This requires that 1) \&quot;swiftSupported\&quot; is true when doing a GET against this resource, and 2) that the target Subnet has already been delegated, and is not  in use by another App Service Plan other than the one this App is in.
...
async def web_apps_delete_function_secret(request: web.Request, resource_group_name, name, function_name, key_name, subscription_id, api_version) -> web.Response:
...
async def web_apps_delete_function_secret_slot(request: web.Request, resource_group_name, name, function_name, key_name, slot, subscription_id, api_version) -> web.Response:
    """Delete a function secret.
...
async def web_apps_delete_host_secret(request: web.Request, resource_group_name, name, key_type, key_name, subscription_id, api_version) -> web.Response:
...
async def web_apps_delete_host_secret_slot(request: web.Request, resource_group_name, name, key_type, key_name, slot, subscription_id, api_version) -> web.Response:
    """Delete a host level secret.
...
async def web_apps_delete_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, delete_metrics=None, delete_empty_server_farm=None) -> web.Response:
    """Deletes a web, mobile, or API app, or one of the deployment slots.
...
async def web_apps_delete_swift_virtual_network(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_delete_swift_virtual_network_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Deletes a Swift Virtual Network connection from an app (or deployment slot).
...
async def web_apps_discover_backup(request: web.Request, resource_group_name, name, subscription_id, api_version, request) -> web.Response:
...
async def web_apps_discover_backup_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, request) -> web.Response:
    """Discovers an existing app backup that can be restored from a blob in Azure storage. Use this to get information about the databases stored in a backup.
...
async def web_apps_get_app_setting_key_vault_reference(request: web.Request, resource_group_name, name, app_setting_key, subscription_id, api_version) -> web.Response:
...
async def web_apps_get_app_settings_key_vault_references(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_get_container_logs_zip(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_get_container_logs_zip_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Gets the ZIP archived docker log files for the given site
...
async def web_apps_get_instance_info(request: web.Request, resource_group_name, name, instance_id, subscription_id, api_version) -> web.Response:
...
async def web_apps_get_instance_info_slot(request: web.Request, resource_group_name, name, instance_id, slot, subscription_id, api_version) -> web.Response:
    """Gets all scale-out instances of an app.
...
async def web_apps_get_network_trace_operation(request: web.Request, resource_group_name, name, operation_id, subscription_id, api_version) -> web.Response:
...
async def web_apps_get_network_trace_operation_slot(request: web.Request, resource_group_name, name, operation_id, slot, subscription_id, api_version) -> web.Response:
    """Gets a named operation for a network trace capturing (or deployment slot, if specified).
...
async def web_apps_get_network_trace_operation_slot_v2(request: web.Request, resource_group_name, name, operation_id, slot, subscription_id, api_version) -> web.Response:
    """Gets a named operation for a network trace capturing (or deployment slot, if specified).
...
async def web_apps_get_network_trace_operation_v2(request: web.Request, resource_group_name, name, operation_id, subscription_id, api_version) -> web.Response:
    """Gets a named operation for a network trace capturing (or deployment slot, if specified).
...
async def web_apps_get_network_traces(request: web.Request, resource_group_name, name, operation_id, subscription_id, api_version) -> web.Response:
    """Gets a named operation for a network trace capturing (or deployment slot, if specified).
...
async def web_apps_get_network_traces_slot(request: web.Request, resource_group_name, name, operation_id, slot, subscription_id, api_version) -> web.Response:
    """Gets a named operation for a network trace capturing (or deployment slot, if specified).
...
async def web_apps_get_network_traces_slot_v2(request: web.Request, resource_group_name, name, operation_id, slot, subscription_id, api_version) -> web.Response:
    """Gets a named operation for a network trace capturing (or deployment slot, if specified).
...
async def web_apps_get_network_traces_v2(request: web.Request, resource_group_name, name, operation_id, subscription_id, api_version) -> web.Response:
    """Gets a named operation for a network trace capturing (or deployment slot, if specified).
...
async def web_apps_get_private_access(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_get_private_access_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Gets data around private site access enablement and authorized Virtual Networks that can access the site.
...
async def web_apps_get_swift_virtual_network_connection(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_get_swift_virtual_network_connection_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Gets a Swift Virtual Network connection.
...
async def web_apps_list_azure_storage_accounts(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_list_azure_storage_accounts_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Gets the Azure storage account configurations of an app.
...
async def web_apps_list_function_keys(request: web.Request, resource_group_name, name, function_name, subscription_id, api_version) -> web.Response:
...
async def web_apps_list_function_keys_slot(request: web.Request, resource_group_name, name, function_name, slot, subscription_id, api_version) -> web.Response:
    """Get function keys for a function in a web site, or a deployment slot.
...
async def web_apps_list_host_keys(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_list_host_keys_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Get host secrets for a function app.
...
async def web_apps_list_site_backups(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
    """Gets existing backups of an app.
...
async def web_apps_list_site_backups_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Gets existing backups of an app.
...
async def web_apps_list_snapshots_from_dr_secondary(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_list_snapshots_from_dr_secondary_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Returns all Snapshots to the user from DRSecondary endpoint.
...
async def web_apps_list_sync_status(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
    """This is to allow calling via powershell and ARM template.
...
async def web_apps_list_sync_status_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """This is to allow calling via powershell and ARM template.
...
async def web_apps_put_private_access_vnet(request: web.Request, resource_group_name, name, subscription_id, api_version, access) -> web.Response:
    ...
    :type access: dict | bytes

    """
    access = PrivateAccess.from_dict(access)
    return web.Response(status=200)


async def web_apps_put_private_access_vnet_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, access) -> web.Response:
    """Sets data around private site access enablement and authorized Virtual Networks that can access the site.
...
async def web_apps_restore_from_backup_blob(request: web.Request, resource_group_name, name, subscription_id, api_version, request) -> web.Response:
...
async def web_apps_restore_from_backup_blob_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, request) -> web.Response:
    """Restores an app from a backup blob in Azure Storage.
...
async def web_apps_restore_from_deleted_app(request: web.Request, resource_group_name, name, subscription_id, api_version, restore_request) -> web.Response:
    ...
    :type restore_request: dict | bytes

    """
    restore_request = DeletedAppRestoreRequest.from_dict(restore_request)
    return web.Response(status=200)


async def web_apps_restore_from_deleted_app_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, restore_request) -> web.Response:
    """Restores a deleted web app to this web app.
...
async def web_apps_restore_snapshot(request: web.Request, resource_group_name, name, subscription_id, api_version, restore_request) -> web.Response:
    ...
    :param api_version: API Version
    :type api_version: str
    :param restore_request: Snapshot restore settings. Snapshot information can be obtained by calling GetDeletedSites or GetSiteSnapshots API.
    :type restore_request: dict | bytes

    """
    restore_request = SnapshotRestoreRequest.from_dict(restore_request)
    return web.Response(status=200)


async def web_apps_restore_snapshot_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, restore_request) -> web.Response:
    """Restores a web app from a snapshot.
...
async def web_apps_start_network_trace(request: web.Request, resource_group_name, name, subscription_id, api_version, duration_in_seconds=None, max_frame_length=None, sas_url=None) -> web.Response:
...
async def web_apps_start_network_trace_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, duration_in_seconds=None, max_frame_length=None, sas_url=None) -> web.Response:
    """Start capturing network packets for the site.
...
async def web_apps_start_web_site_network_trace_operation(request: web.Request, resource_group_name, name, subscription_id, api_version, duration_in_seconds=None, max_frame_length=None, sas_url=None) -> web.Response:
    """Start capturing network packets for the site.
...
async def web_apps_start_web_site_network_trace_operation_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, duration_in_seconds=None, max_frame_length=None, sas_url=None) -> web.Response:
    """Start capturing network packets for the site.
...
async def web_apps_stop_network_trace(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
...
async def web_apps_stop_network_trace_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Stop ongoing capturing network packets for the site.
...
async def web_apps_sync_functions(request: web.Request, resource_group_name, name, subscription_id, api_version) -> web.Response:
    """Syncs function trigger metadata to the management database
...
async def web_apps_sync_functions_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version) -> web.Response:
    """Syncs function trigger metadata to the management database
...
async def web_apps_update_azure_storage_accounts(request: web.Request, resource_group_name, name, subscription_id, api_version, azure_storage_accounts) -> web.Response:
    ...
    :type azure_storage_accounts: dict | bytes

    """
    azure_storage_accounts = AzureStoragePropertyDictionaryResource.from_dict(azure_storage_accounts)
    return web.Response(status=200)


async def web_apps_update_azure_storage_accounts_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, azure_storage_accounts) -> web.Response:
    """Updates the Azure storage account configurations of an app.
...
async def web_apps_update_premier_add_on(request: web.Request, resource_group_name, name, premier_add_on_name, subscription_id, api_version, premier_add_on) -> web.Response:
    """Updates a named add-on of an app.
    ...
    """
    premier_add_on = PremierAddOnPatchResource.from_dict(premier_add_on)
    return web.Response(status=200)


async def web_apps_update_premier_add_on_slot(request: web.Request, resource_group_name, name, premier_add_on_name, slot, subscription_id, api_version, premier_add_on) -> web.Response:
    """Updates a named add-on of an app.
...
async def web_apps_update_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, site_envelope) -> web.Response:
    """Creates a new web, mobile, or API app in an existing resource group, or updates an existing app.
...
async def web_apps_update_swift_virtual_network_connection(request: web.Request, resource_group_name, name, subscription_id, api_version, connection_envelope) -> web.Response:
    """Integrates this Web App with a Virtual Network. This requires that 1) \&quot;swiftSupported\&quot; is true when doing a GET against this resource, and 2) that the target Subnet has already been delegated, and is not  in use by another App Service Plan other than the one this App is in.
...
async def web_apps_update_swift_virtual_network_connection_slot(request: web.Request, resource_group_name, name, slot, subscription_id, api_version, connection_envelope) -> web.Response:
    """Integrates this Web App with a Virtual Network. This requires that 1) \&quot;swiftSupported\&quot; is true when doing a GET against this resource, and 2) that the target Subnet has already been delegated, and is not  in use by another App Service Plan other than the one this App is in.
