...
from openapi_server.models.azure_storage_property_dictionary_resource import AzureStoragePropertyDictionaryResource
...
from openapi_server.models.csm_copy_slot_entity import CsmCopySlotEntity
...
from openapi_server.models.deleted_app_restore_request import DeletedAppRestoreRequest
...
from openapi_server.models.host_keys import HostKeys
...
from openapi_server.models.key_info import KeyInfo
from openapi_server.models.key_vault_reference_collection import KeyVaultReferenceCollection
from openapi_server.models.key_vault_reference_resource import KeyVaultReferenceResource
...
from openapi_server.models.network_trace import NetworkTrace
...
from openapi_server.models.premier_add_on_patch_resource import PremierAddOnPatchResource
from openapi_server.models.private_access import PrivateAccess
...
from openapi_server.models.snapshot_restore_request import SnapshotRestoreRequest
...
from openapi_server.models.swift_virtual_network import SwiftVirtualNetwork
...
from openapi_server.models.web_apps_list_default_response import WebAppsListDefaultResponse
...
from openapi_server.models.web_site_instance_status import WebSiteInstanceStatus
...
async def test_web_apps_copy_production_slot(client):
    """Test case for web_apps_copy_production_slot

    Copies a deployment slot to another deployment slot of an app.
    """
    copy_slot_entity = {"siteConfig":{"pythonVersion":"pythonVersion","cors":{"supportCredentials":True,"allowedOrigins":["allowedOrigins","allowedOrigins"]},"scmIpSecurityRestrictionsUseMain":True,"tracingOptions":"tracingOptions","detailedErrorLoggingEnabled":True,"use32BitWorkerProcess":True,"xManagedServiceIdentityId":6,"apiDefinition":{"url":"url"},"vnetName":"vnetName","localMySqlEnabled":False,"linuxFxVersion":"linuxFxVersion","preWarmedInstanceCount":9,"remoteDebuggingEnabled":True,"virtualApplications":[{"virtualPath":"virtualPath","physicalPath":"physicalPath","virtualDirectories":[{"virtualPath":"virtualPath","physicalPath":"physicalPath"},{"virtualPath":"virtualPath","physicalPath":"physicalPath"}],"preloadEnabled":True},{"virtualPath":"virtualPath","physicalPath":"physicalPath","virtualDirectories":[{"virtualPath":"virtualPath","physicalPath":"physicalPath"},{"virtualPath":"virtualPath","physicalPath":"physicalPath"}],"preloadEnabled":True}],"requestTracingEnabled":True,"netFrameworkVersion":"v4.6","javaContainerVersion":"javaContainerVersion","appCommandLine":"appCommandLine","machineKey":{"decryptionKey":"decryptionKey","validationKey":"validationKey","decryption":"decryption","validation":"validation"},"autoHealRules":{"triggers":{"statusCodes":[{"win32Status":2,"count":7,"timeInterval":"timeInterval","subStatus":3,"status":9},{"win32Status":2,"count":7,"timeInterval":"timeInterval","subStatus":3,"status":9}],"privateBytesInKB":5,"requests":{"count":5,"timeInterval":"timeInterval"},"slowRequests":{"timeTaken":"timeTaken","count":2,"timeInterval":"timeInterval"}},"actions":{"actionType":"Recycle","customAction":{"exe":"exe","parameters":"parameters"},"minProcessExecutionTime":"minProcessExecutionTime"}},"nodeVersion":"nodeVersion","apiManagementConfig":{"id":"id"},"loadBalancing":"WeightedRoundRobin","publishingUsername":"publishingUsername","push":{"properties":{"dynamicTagsJson":"dynamicTagsJson","tagWhitelistJson":"tagWhitelistJson","isPushEnabled":True,"tagsRequiringAuth":"tagsRequiringAuth"}},"autoSwapSlotName":"autoSwapSlotName","documentRoot":"documentRoot","healthCheckPath":"healthCheckPath","scmIpSecurityRestrictions":[{"subnetTrafficTag":7,"vnetTrafficTag":1,"ipAddress":"ipAddress","name":"name","action":"action","description":"description","tag":"Default","priority":6,"subnetMask":"subnetMask","vnetSubnetResourceId":"vnetSubnetResourceId"},{"subnetTrafficTag":7,"vnetTrafficTag":1,"ipAddress":"ipAddress","name":"name","action":"action","description":"description","tag":"Default","priority":6,"subnetMask":"subnetMask","vnetSubnetResourceId":"vnetSubnetResourceId"}],"javaContainer":"javaContainer","numberOfWorkers":8,"http20Enabled":True,"remoteDebuggingVersion":"remoteDebuggingVersion","defaultDocuments":["defaultDocuments","defaultDocuments"],"javaVersion":"javaVersion","experiments":{"rampUpRules":[{"changeStep":7.386281948385884,"minReroutePercentage":1.0246457001441578,"maxReroutePercentage":1.2315135367772556,"actionHostName":"actionHostName","name":"name","changeIntervalInMinutes":4,"reroutePercentage":1.4894159098541704,"changeDecisionCallbackUrl":"changeDecisionCallbackUrl"},{"changeStep":7.386281948385884,"minReroutePercentage":1.0246457001441578,"maxReroutePercentage":1.2315135367772556,"actionHostName":"actionHostName","name":"name","changeIntervalInMinutes":4,"reroutePercentage":1.4894159098541704,"changeDecisionCallbackUrl":"changeDecisionCallbackUrl"}]},"ftpsState":"AllAllowed","logsDirectorySizeLimit":9,"webSocketsEnabled":True,"alwaysOn":True,"limits":{"maxMemoryInMb":5,"maxPercentageCpu":9.965781217890562,"maxDiskSizeInMb":4},"phpVersion":"phpVersion","connectionStrings":[{"connectionString":"connectionString","name":"name","type":"MySql"},{"connectionString":"connectionString","name":"name","type":"MySql"}],"managedServiceIdentityId":6,"httpLoggingEnabled":True,"autoHealEnabled":True,"windowsFxVersion":"windowsFxVersion","managedPipelineMode":"Integrated","appSettings":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"handlerMappings":[{"extension":"extension","scriptProcessor":"scriptProcessor","arguments":"arguments"},{"extension":"extension","scriptProcessor":"scriptProcessor","arguments":"arguments"}],"requestTracingExpirationTime":"2000-01-23T04:56:07.000+00:00","ipSecurityRestrictions":[{"subnetTrafficTag":7,"vnetTrafficTag":1,"ipAddress":"ipAddress","name":"name","action":"action","description":"description","tag":"Default","priority":6,"subnetMask":"subnetMask","vnetSubnetResourceId":"vnetSubnetResourceId"},{"subnetTrafficTag":7,"vnetTrafficTag":1,"ipAddress":"ipAddress","name":"name","action":"action","description":"description","tag":"Default","priority":6,"subnetMask":"subnetMask","vnetSubnetResourceId":"vnetSubnetResourceId"}],"scmType":"None","minTlsVersion":"1.0"},"targetSlot":"targetSlot"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slotcopy'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=copy_slot_entity,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_copy_slot_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/slotcopy'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=copy_slot_entity,
        params=params,
        )
...
async def test_web_apps_create_or_update_function_secret(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/functions/{function_name}/keys/{key_name}'.format(resource_group_name='resource_group_name_example', name='name_example', function_name='function_name_example', key_name='key_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=key,
        params=params,
        )
...
async def test_web_apps_create_or_update_function_secret_slot(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/functions/{function_name}/keys/{key_name}'.format(resource_group_name='resource_group_name_example', name='name_example', function_name='function_name_example', key_name='key_name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=key,
        params=params,
        )
...
async def test_web_apps_create_or_update_host_secret(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/host/default/{key_type}/{key_name}'.format(resource_group_name='resource_group_name_example', name='name_example', key_type='key_type_example', key_name='key_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=key,
        params=params,
        )
...
async def test_web_apps_create_or_update_host_secret_slot(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/host/default/{key_type}/{key_name}'.format(resource_group_name='resource_group_name_example', name='name_example', key_type='key_type_example', key_name='key_name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=key,
        params=params,
        )
...
async def test_web_apps_create_or_update_swift_virtual_network_connection(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/networkConfig/virtualNetwork'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=connection_envelope,
        params=params,
        )
...
async def test_web_apps_create_or_update_swift_virtual_network_connection_slot(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/networkConfig/virtualNetwork'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=connection_envelope,
        params=params,
        )
...
async def test_web_apps_delete_function_secret(client):
...
async def test_web_apps_delete_function_secret_slot(client):
...
async def test_web_apps_delete_host_secret(client):
...
async def test_web_apps_delete_host_secret_slot(client):
...
async def test_web_apps_delete_swift_virtual_network(client):
...
async def test_web_apps_delete_swift_virtual_network_slot(client):
...
async def test_web_apps_discover_backup(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/discoverbackup'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=request,
        params=params,
        )
...
async def test_web_apps_discover_backup_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/discoverbackup'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=request,
        params=params,
        )
...
async def test_web_apps_get_app_setting_key_vault_reference(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/config/configreferences/appsettings/{app_setting_key}'.format(resource_group_name='resource_group_name_example', name='name_example', app_setting_key='app_setting_key_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_app_settings_key_vault_references(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/config/configreferences/appsettings'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_container_logs_zip(client):
...
async def test_web_apps_get_container_logs_zip_slot(client):
...
async def test_web_apps_get_instance_info(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/instances/{instance_id}'.format(resource_group_name='resource_group_name_example', name='name_example', instance_id='instance_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_instance_info_slot(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/instances/{instance_id}'.format(resource_group_name='resource_group_name_example', name='name_example', instance_id='instance_id_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_network_trace_operation(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/networkTrace/operationresults/{operation_id}'.format(resource_group_name='resource_group_name_example', name='name_example', operation_id='operation_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_network_trace_operation_slot(client):
...
async def test_web_apps_get_network_trace_operation_slot_v2(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/networkTraces/current/operationresults/{operation_id}'.format(resource_group_name='resource_group_name_example', name='name_example', operation_id='operation_id_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_network_trace_operation_v2(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/networkTraces/current/operationresults/{operation_id}'.format(resource_group_name='resource_group_name_example', name='name_example', operation_id='operation_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_network_traces(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/networkTrace/{operation_id}'.format(resource_group_name='resource_group_name_example', name='name_example', operation_id='operation_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_network_traces_slot(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/networkTrace/{operation_id}'.format(resource_group_name='resource_group_name_example', name='name_example', operation_id='operation_id_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_network_traces_slot_v2(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/networkTraces/{operation_id}'.format(resource_group_name='resource_group_name_example', name='name_example', operation_id='operation_id_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_network_traces_v2(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/networkTraces/{operation_id}'.format(resource_group_name='resource_group_name_example', name='name_example', operation_id='operation_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_private_access(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/privateAccess/virtualNetworks'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_private_access_slot(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/privateAccess/virtualNetworks'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_get_swift_virtual_network_connection(client):
...
async def test_web_apps_get_swift_virtual_network_connection_slot(client):
...
async def test_web_apps_list_azure_storage_accounts(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/config/azurestorageaccounts/list'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_azure_storage_accounts_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/azurestorageaccounts/list'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_function_keys(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/functions/{function_name}/listkeys'.format(resource_group_name='resource_group_name_example', name='name_example', function_name='function_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_function_keys_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/functions/{function_name}/listkeys'.format(resource_group_name='resource_group_name_example', name='name_example', function_name='function_name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_host_keys(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/host/default/listkeys'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_host_keys_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/host/default/listkeys'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_publishing_profile_xml_with_secrets(client):
    ...
    """
    publishing_profile_options = {"includeDisasterRecoveryEndpoints":True,"format":"FileZilla3"}
    params = [('api-version', 'api_version_example')]
    headers = { 
...
async def test_web_apps_list_site_backups(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/listbackups'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_site_backups_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/listbackups'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_snapshots_from_dr_secondary(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/snapshotsdr'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_snapshots_from_dr_secondary_slot(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/snapshotsdr'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_sync_status(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/host/default/listsyncstatus'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_list_sync_status_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/host/default/listsyncstatus'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_put_private_access_vnet(client):
...
async def test_web_apps_put_private_access_vnet_slot(client):
...
async def test_web_apps_restore_from_backup_blob(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/restoreFromBackupBlob'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=request,
        params=params,
        )
...
async def test_web_apps_restore_from_backup_blob_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/restoreFromBackupBlob'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=request,
        params=params,
        )
...
async def test_web_apps_restore_from_deleted_app(client):
    """Test case for web_apps_restore_from_deleted_app

    Restores a deleted web app to this web app.
    """
    restore_request = {"properties":"{}"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/restoreFromDeletedApp'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
...
async def test_web_apps_restore_from_deleted_app_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/restoreFromDeletedApp'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=restore_request,
        params=params,
        )
...
async def test_web_apps_restore_snapshot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/restoreSnapshot'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=restore_request,
        params=params,
        )
...
async def test_web_apps_restore_snapshot_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/restoreSnapshot'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=restore_request,
        params=params,
        )
...
async def test_web_apps_start_network_trace(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/startNetworkTrace'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_start_network_trace_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/startNetworkTrace'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_start_web_site_network_trace_operation(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/networkTrace/startOperation'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_start_web_site_network_trace_operation_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/networkTrace/startOperation'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_stop_network_trace(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/stopNetworkTrace'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_stop_network_trace_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/stopNetworkTrace'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_sync_functions(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/host/default/sync'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_sync_functions_slot(client):
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/host/default/sync'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_update(client):
    ...
    Creates a new web, mobile, or API app in an existing resource group, or updates an existing app.
    """
    site_envelope = {"identity":"{}","properties":"{}"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_web_apps_update_azure_storage_accounts(client):
    """Test case for web_apps_update_azure_storage_accounts

    Updates the Azure storage account configurations of an app.
    """
    azure_storage_accounts = {"properties":{"key":{"mountPath":"mountPath","accessKey":"accessKey","accountName":"accountName","shareName":"shareName","state":"Ok","type":"AzureFiles"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/config/azurestorageaccounts'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=azure_storage_accounts,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_web_apps_update_azure_storage_accounts_slot(client):
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{name}/slots/{slot}/config/azurestorageaccounts'.format(resource_group_name='resource_group_name_example', name='name_example', slot='slot_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=azure_storage_accounts,
        params=params,
        )
...
async def test_web_apps_update_premier_add_on(client):
...
async def test_web_apps_update_premier_add_on_slot(client):
...
async def test_web_apps_update_slot_configuration_names(client):
    ...
    """
    slot_config_names = {"properties":{"connectionStringNames":["connectionStringNames","connectionStringNames"],"appSettingNames":["appSettingNames","appSettingNames"],"azureStorageConfigNames":["azureStorageConfigNames","azureStorageConfigNames"]}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_web_apps_update_swift_virtual_network_connection(client):
...
async def test_web_apps_update_swift_virtual_network_connection_slot(client):
