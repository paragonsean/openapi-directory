...
(function(root, factory) {
  ...
  describe('WebAppsList200ResponseValueInnerProperties', function() {
    ...
    it('should have the property clientCertExclusionPaths (base name: "clientCertExclusionPaths")', function() {
      // uncomment below and update the code to test the property clientCertExclusionPaths
      //var instance = new WebAppsApiClient.WebAppsList200ResponseValueInnerProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property inProgressOperationId (base name: "inProgressOperationId")', function() {
      // uncomment below and update the code to test the property inProgressOperationId
      //var instance = new WebAppsApiClient.WebAppsList200ResponseValueInnerProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property redundancyMode (base name: "redundancyMode")', function() {
      // uncomment below and update the code to test the property redundancyMode
      //var instance = new WebAppsApiClient.WebAppsList200ResponseValueInnerProperties();
      //expect(instance).to.be();
    });
