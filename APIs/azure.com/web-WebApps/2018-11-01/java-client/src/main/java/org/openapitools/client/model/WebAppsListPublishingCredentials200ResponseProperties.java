...
public class WebAppsListPublishingCredentials200ResponseProperties {
  ...
  public WebAppsListPublishingCredentials200ResponseProperties() {
  }

  public WebAppsListPublishingCredentials200ResponseProperties publishingPassword(String publishingPassword) {
  ...
  public WebAppsListPublishingCredentials200ResponseProperties publishingPasswordHash(String publishingPasswordHash) {
  ...
  public WebAppsListPublishingCredentials200ResponseProperties publishingPasswordHashSalt(String publishingPasswordHashSalt) {
  ...
  public WebAppsListPublishingCredentials200ResponseProperties publishingUserName(String publishingUserName) {
  ...
  public WebAppsListPublishingCredentials200ResponseProperties scmUri(String scmUri) {
    this.scmUri = scmUri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebAppsListPublishingCredentials200ResponseProperties webAppsListPublishingCredentials200ResponseProperties = (WebAppsListPublishingCredentials200ResponseProperties) o;
    return Objects.equals(this.publishingPassword, webAppsListPublishingCredentials200ResponseProperties.publishingPassword) &&
        Objects.equals(this.publishingPasswordHash, webAppsListPublishingCredentials200ResponseProperties.publishingPasswordHash) &&
        Objects.equals(this.publishingPasswordHashSalt, webAppsListPublishingCredentials200ResponseProperties.publishingPasswordHashSalt) &&
        Objects.equals(this.publishingUserName, webAppsListPublishingCredentials200ResponseProperties.publishingUserName) &&
        Objects.equals(this.scmUri, webAppsListPublishingCredentials200ResponseProperties.scmUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebAppsListPublishingCredentials200ResponseProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebAppsListPublishingCredentials200ResponseProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAppsListPublishingCredentials200ResponseProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAppsListPublishingCredentials200ResponseProperties is not found in the empty JSON string", WebAppsListPublishingCredentials200ResponseProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAppsListPublishingCredentials200ResponseProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAppsListPublishingCredentials200ResponseProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebAppsListPublishingCredentials200ResponseProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAppsListPublishingCredentials200ResponseProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAppsListPublishingCredentials200ResponseProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAppsListPublishingCredentials200ResponseProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAppsListPublishingCredentials200ResponseProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAppsListPublishingCredentials200ResponseProperties>() {
           @Override
           public void write(JsonWriter out, WebAppsListPublishingCredentials200ResponseProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAppsListPublishingCredentials200ResponseProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebAppsListPublishingCredentials200ResponseProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebAppsListPublishingCredentials200ResponseProperties
   * @throws IOException if the JSON string is invalid with respect to WebAppsListPublishingCredentials200ResponseProperties
   */
  public static WebAppsListPublishingCredentials200ResponseProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAppsListPublishingCredentials200ResponseProperties.class);
  }

  /**
   * Convert an instance of WebAppsListPublishingCredentials200ResponseProperties to an JSON string
   *
   * @return JSON string
   */
