...
import org.openapitools.client.model.WebAppsList200ResponseValueInnerPropertiesCloningInfo;
import org.openapitools.client.model.WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner;
import org.openapitools.client.model.WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner;
import org.openapitools.client.model.WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile;
import org.openapitools.client.model.WebAppsList200ResponseValueInnerPropertiesSiteConfig;
import org.openapitools.client.model.WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus;
...
public class WebAppsList200ResponseValueInnerProperties {
  /**
  ...
  private WebAppsList200ResponseValueInnerPropertiesCloningInfo cloningInfo;
  ...
  public static final String SERIALIZED_NAME_GEO_DISTRIBUTIONS = "geoDistributions";
  @SerializedName(SERIALIZED_NAME_GEO_DISTRIBUTIONS)
  private List<WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner> geoDistributions = new ArrayList<>();
  ...
  private List<WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner> hostNameSslStates = new ArrayList<>();
  ...
  private WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile hostingEnvironmentProfile;
  ...
  private WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus slotSwapStatus;
  ...
  public WebAppsList200ResponseValueInnerProperties() {
  }
  ...
  public WebAppsList200ResponseValueInnerProperties clientAffinityEnabled(Boolean clientAffinityEnabled) {
  ...
  public WebAppsList200ResponseValueInnerProperties clientCertEnabled(Boolean clientCertEnabled) {
  ...
  public WebAppsList200ResponseValueInnerProperties clientCertExclusionPaths(String clientCertExclusionPaths) {
  ...
  public WebAppsList200ResponseValueInnerProperties cloningInfo(WebAppsList200ResponseValueInnerPropertiesCloningInfo cloningInfo) {
   ...
   */
  @javax.annotation.Nullable
  public WebAppsList200ResponseValueInnerPropertiesCloningInfo getCloningInfo() {
    return cloningInfo;
  }

  public void setCloningInfo(WebAppsList200ResponseValueInnerPropertiesCloningInfo cloningInfo) {
    this.cloningInfo = cloningInfo;
  }


  public WebAppsList200ResponseValueInnerProperties containerSize(Integer containerSize) {
  ...
  public WebAppsList200ResponseValueInnerProperties dailyMemoryTimeQuota(Integer dailyMemoryTimeQuota) {
  ...
  public WebAppsList200ResponseValueInnerProperties enabled(Boolean enabled) {
  ...
  public WebAppsList200ResponseValueInnerProperties geoDistributions(List<WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner> geoDistributions) {
    this.geoDistributions = geoDistributions;
    return this;
  }

  public WebAppsList200ResponseValueInnerProperties addGeoDistributionsItem(WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner geoDistributionsItem) {
    if (this.geoDistributions == null) {
      this.geoDistributions = new ArrayList<>();
    }
    this.geoDistributions.add(geoDistributionsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner> getGeoDistributions() {
    return geoDistributions;
  }

  public void setGeoDistributions(List<WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner> geoDistributions) {
    this.geoDistributions = geoDistributions;
  }


  public WebAppsList200ResponseValueInnerProperties hostNameSslStates(List<WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner> hostNameSslStates) {
    this.hostNameSslStates = hostNameSslStates;
    return this;
  }

  public WebAppsList200ResponseValueInnerProperties addHostNameSslStatesItem(WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner hostNameSslStatesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner> getHostNameSslStates() {
    return hostNameSslStates;
  }

  public void setHostNameSslStates(List<WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner> hostNameSslStates) {
    this.hostNameSslStates = hostNameSslStates;
  }
  ...
  public WebAppsList200ResponseValueInnerProperties hostNamesDisabled(Boolean hostNamesDisabled) {
  ...
  public WebAppsList200ResponseValueInnerProperties hostingEnvironmentProfile(WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile hostingEnvironmentProfile) {
   ...
   */
  @javax.annotation.Nullable
  public WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile getHostingEnvironmentProfile() {
    return hostingEnvironmentProfile;
  }

  public void setHostingEnvironmentProfile(WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile hostingEnvironmentProfile) {
    this.hostingEnvironmentProfile = hostingEnvironmentProfile;
  }


  public WebAppsList200ResponseValueInnerProperties httpsOnly(Boolean httpsOnly) {
  ...
  public WebAppsList200ResponseValueInnerProperties hyperV(Boolean hyperV) {
    this.hyperV = hyperV;
    return this;
  }
  ...
  public WebAppsList200ResponseValueInnerProperties isXenon(Boolean isXenon) {
  ...
  public WebAppsList200ResponseValueInnerProperties redundancyMode(RedundancyModeEnum redundancyMode) {
  ...
  public WebAppsList200ResponseValueInnerProperties reserved(Boolean reserved) {
  ...
  public WebAppsList200ResponseValueInnerProperties scmSiteAlsoStopped(Boolean scmSiteAlsoStopped) {
  ...
  public WebAppsList200ResponseValueInnerProperties serverFarmId(String serverFarmId) {
  ...
  public WebAppsList200ResponseValueInnerProperties siteConfig(WebAppsList200ResponseValueInnerPropertiesSiteConfig siteConfig) {
  ...
  public WebAppsList200ResponseValueInnerProperties slotSwapStatus(WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus slotSwapStatus) {
   ...
   */
  @javax.annotation.Nullable
  public WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus getSlotSwapStatus() {
    return slotSwapStatus;
  }

  public void setSlotSwapStatus(WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus slotSwapStatus) {
    this.slotSwapStatus = slotSwapStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebAppsList200ResponseValueInnerProperties webAppsList200ResponseValueInnerProperties = (WebAppsList200ResponseValueInnerProperties) o;
    return Objects.equals(this.availabilityState, webAppsList200ResponseValueInnerProperties.availabilityState) &&
        Objects.equals(this.clientAffinityEnabled, webAppsList200ResponseValueInnerProperties.clientAffinityEnabled) &&
        Objects.equals(this.clientCertEnabled, webAppsList200ResponseValueInnerProperties.clientCertEnabled) &&
        Objects.equals(this.clientCertExclusionPaths, webAppsList200ResponseValueInnerProperties.clientCertExclusionPaths) &&
        Objects.equals(this.cloningInfo, webAppsList200ResponseValueInnerProperties.cloningInfo) &&
        Objects.equals(this.containerSize, webAppsList200ResponseValueInnerProperties.containerSize) &&
        Objects.equals(this.dailyMemoryTimeQuota, webAppsList200ResponseValueInnerProperties.dailyMemoryTimeQuota) &&
        Objects.equals(this.defaultHostName, webAppsList200ResponseValueInnerProperties.defaultHostName) &&
        Objects.equals(this.enabled, webAppsList200ResponseValueInnerProperties.enabled) &&
        Objects.equals(this.enabledHostNames, webAppsList200ResponseValueInnerProperties.enabledHostNames) &&
        Objects.equals(this.geoDistributions, webAppsList200ResponseValueInnerProperties.geoDistributions) &&
        Objects.equals(this.hostNameSslStates, webAppsList200ResponseValueInnerProperties.hostNameSslStates) &&
        Objects.equals(this.hostNames, webAppsList200ResponseValueInnerProperties.hostNames) &&
        Objects.equals(this.hostNamesDisabled, webAppsList200ResponseValueInnerProperties.hostNamesDisabled) &&
        Objects.equals(this.hostingEnvironmentProfile, webAppsList200ResponseValueInnerProperties.hostingEnvironmentProfile) &&
        Objects.equals(this.httpsOnly, webAppsList200ResponseValueInnerProperties.httpsOnly) &&
        Objects.equals(this.hyperV, webAppsList200ResponseValueInnerProperties.hyperV) &&
        Objects.equals(this.inProgressOperationId, webAppsList200ResponseValueInnerProperties.inProgressOperationId) &&
        Objects.equals(this.isDefaultContainer, webAppsList200ResponseValueInnerProperties.isDefaultContainer) &&
        Objects.equals(this.isXenon, webAppsList200ResponseValueInnerProperties.isXenon) &&
        Objects.equals(this.lastModifiedTimeUtc, webAppsList200ResponseValueInnerProperties.lastModifiedTimeUtc) &&
        Objects.equals(this.maxNumberOfWorkers, webAppsList200ResponseValueInnerProperties.maxNumberOfWorkers) &&
        Objects.equals(this.outboundIpAddresses, webAppsList200ResponseValueInnerProperties.outboundIpAddresses) &&
        Objects.equals(this.possibleOutboundIpAddresses, webAppsList200ResponseValueInnerProperties.possibleOutboundIpAddresses) &&
        Objects.equals(this.redundancyMode, webAppsList200ResponseValueInnerProperties.redundancyMode) &&
        Objects.equals(this.repositorySiteName, webAppsList200ResponseValueInnerProperties.repositorySiteName) &&
        Objects.equals(this.reserved, webAppsList200ResponseValueInnerProperties.reserved) &&
        Objects.equals(this.resourceGroup, webAppsList200ResponseValueInnerProperties.resourceGroup) &&
        Objects.equals(this.scmSiteAlsoStopped, webAppsList200ResponseValueInnerProperties.scmSiteAlsoStopped) &&
        Objects.equals(this.serverFarmId, webAppsList200ResponseValueInnerProperties.serverFarmId) &&
        Objects.equals(this.siteConfig, webAppsList200ResponseValueInnerProperties.siteConfig) &&
        Objects.equals(this.slotSwapStatus, webAppsList200ResponseValueInnerProperties.slotSwapStatus) &&
        Objects.equals(this.state, webAppsList200ResponseValueInnerProperties.state) &&
        Objects.equals(this.suspendedTill, webAppsList200ResponseValueInnerProperties.suspendedTill) &&
        Objects.equals(this.targetSwapSlot, webAppsList200ResponseValueInnerProperties.targetSwapSlot) &&
        Objects.equals(this.trafficManagerHostNames, webAppsList200ResponseValueInnerProperties.trafficManagerHostNames) &&
        Objects.equals(this.usageState, webAppsList200ResponseValueInnerProperties.usageState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(availabilityState, clientAffinityEnabled, clientCertEnabled, clientCertExclusionPaths, cloningInfo, containerSize, dailyMemoryTimeQuota, defaultHostName, enabled, enabledHostNames, geoDistributions, hostNameSslStates, hostNames, hostNamesDisabled, hostingEnvironmentProfile, httpsOnly, hyperV, inProgressOperationId, isDefaultContainer, isXenon, lastModifiedTimeUtc, maxNumberOfWorkers, outboundIpAddresses, possibleOutboundIpAddresses, redundancyMode, repositorySiteName, reserved, resourceGroup, scmSiteAlsoStopped, serverFarmId, siteConfig, slotSwapStatus, state, suspendedTill, targetSwapSlot, trafficManagerHostNames, usageState);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebAppsList200ResponseValueInnerProperties {\n");
    ...
    sb.append("    geoDistributions: ").append(toIndentedString(geoDistributions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("geoDistributions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebAppsList200ResponseValueInnerProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebAppsList200ResponseValueInnerProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebAppsList200ResponseValueInnerProperties is not found in the empty JSON string", WebAppsList200ResponseValueInnerProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebAppsList200ResponseValueInnerProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebAppsList200ResponseValueInnerProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("cloningInfo") != null && !jsonObj.get("cloningInfo").isJsonNull()) {
        WebAppsList200ResponseValueInnerPropertiesCloningInfo.validateJsonElement(jsonObj.get("cloningInfo"));
      }
      ...
      if (jsonObj.get("geoDistributions") != null && !jsonObj.get("geoDistributions").isJsonNull()) {
        JsonArray jsonArraygeoDistributions = jsonObj.getAsJsonArray("geoDistributions");
        if (jsonArraygeoDistributions != null) {
          // ensure the json data is an array
          if (!jsonObj.get("geoDistributions").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `geoDistributions` to be an array in the JSON string but got `%s`", jsonObj.get("geoDistributions").toString()));
          }

          // validate the optional field `geoDistributions` (array)
          for (int i = 0; i < jsonArraygeoDistributions.size(); i++) {
            WebAppsList200ResponseValueInnerPropertiesGeoDistributionsInner.validateJsonElement(jsonArraygeoDistributions.get(i));
          };
        }
      }
      if (jsonObj.get("hostNameSslStates") != null && !jsonObj.get("hostNameSslStates").isJsonNull()) {
        ...
        if (jsonArrayhostNameSslStates != null) {
          ...
          for (int i = 0; i < jsonArrayhostNameSslStates.size(); i++) {
            WebAppsList200ResponseValueInnerPropertiesHostNameSslStatesInner.validateJsonElement(jsonArrayhostNameSslStates.get(i));
          };
        }
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("hostingEnvironmentProfile") != null && !jsonObj.get("hostingEnvironmentProfile").isJsonNull()) {
        WebAppsList200ResponseValueInnerPropertiesHostingEnvironmentProfile.validateJsonElement(jsonObj.get("hostingEnvironmentProfile"));
      }
      ...
      if (jsonObj.get("slotSwapStatus") != null && !jsonObj.get("slotSwapStatus").isJsonNull()) {
        WebAppsList200ResponseValueInnerPropertiesSlotSwapStatus.validateJsonElement(jsonObj.get("slotSwapStatus"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebAppsList200ResponseValueInnerProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebAppsList200ResponseValueInnerProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebAppsList200ResponseValueInnerProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebAppsList200ResponseValueInnerProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<WebAppsList200ResponseValueInnerProperties>() {
           @Override
           public void write(JsonWriter out, WebAppsList200ResponseValueInnerProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebAppsList200ResponseValueInnerProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebAppsList200ResponseValueInnerProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebAppsList200ResponseValueInnerProperties
   * @throws IOException if the JSON string is invalid with respect to WebAppsList200ResponseValueInnerProperties
   */
  public static WebAppsList200ResponseValueInnerProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebAppsList200ResponseValueInnerProperties.class);
  }

  /**
   * Convert an instance of WebAppsList200ResponseValueInnerProperties to an JSON string
   *
   * @return JSON string
   */
