...
/*
 * OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner.h
 *
 * Routing rules for ramp up testing. This rule allows to redirect static traffic % to a slot or to gradually change routing % based on performance.
 */

#ifndef OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
#define OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
...
class OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner : public OAIObject {
public:
    OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner();
    OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner(QString json);
    ~OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner)

#endif // OAIWebApps_List_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
