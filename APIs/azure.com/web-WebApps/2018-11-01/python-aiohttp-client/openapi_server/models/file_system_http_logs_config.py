...
class FileSystemHttpLogsConfig(Model):
    ...
    def retention_in_mb(self, retention_in_mb):
        ...
        """
        if retention_in_mb is not None and retention_in_mb > 100:
            raise ValueError("Invalid value for `retention_in_mb`, must be a value less than or equal to `100`")
        if retention_in_mb is not None and retention_in_mb < 25:
            raise ValueError("Invalid value for `retention_in_mb`, must be a value greater than or equal to `25`")
