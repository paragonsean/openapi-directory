...
public:
    ...
    OAITimeseriesProperties getProperties() const;
    void setProperties(const OAITimeseriesProperties &properties);
...
private:
    ...
    OAITimeseriesProperties m_properties;
