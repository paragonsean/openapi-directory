...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkExperiments.TimeseriesDataPoint();
  });
  ...
  describe('TimeseriesDataPoint', function() {
    it('should create an instance of TimeseriesDataPoint', function() {
      ...
      //var instance = new NetworkExperiments.TimeseriesDataPoint();
      //expect(instance).to.be.a(NetworkExperiments.TimeseriesDataPoint);
    });
