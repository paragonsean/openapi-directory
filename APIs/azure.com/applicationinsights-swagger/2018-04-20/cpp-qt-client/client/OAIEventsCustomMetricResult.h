...
/*
 * OAIEventsCustomMetricResult.h
 *
 * A custom metric result
 */

#ifndef OAIEventsCustomMetricResult_H
#define OAIEventsCustomMetricResult_H
...
class OAIEventsCustomMetricInfo;

class OAIEventsCustomMetricResult : public OAIObject {
public:
    OAIEventsCustomMetricResult();
    OAIEventsCustomMetricResult(QString json);
    ~OAIEventsCustomMetricResult() override;
    ...
    OAIEventsCustomMetricInfo getCustomMetric() const;
    void setCustomMetric(const OAIEventsCustomMetricInfo &custom_metric);
...
private:
    ...
    OAIEventsCustomMetricInfo m_custom_metric;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsCustomMetricResult)

#endif // OAIEventsCustomMetricResult_H
