...
/*
 * OAIEventsBrowserTimingResult.h
 *
 * A browser timing result
 */

#ifndef OAIEventsBrowserTimingResult_H
#define OAIEventsBrowserTimingResult_H
...
class OAIEventsBrowserTimingInfo;
class OAIEventsClientPerformanceInfo;

class OAIEventsBrowserTimingResult : public OAIObject {
public:
    OAIEventsBrowserTimingResult();
    OAIEventsBrowserTimingResult(QString json);
    ~OAIEventsBrowserTimingResult() override;
    ...
    OAIEventsBrowserTimingInfo getBrowserTiming() const;
    void setBrowserTiming(const OAIEventsBrowserTimingInfo &browser_timing);
    bool is_browser_timing_Set() const;
    bool is_browser_timing_Valid() const;

    OAIEventsClientPerformanceInfo getClientPerformance() const;
    void setClientPerformance(const OAIEventsClientPerformanceInfo &client_performance);
    bool is_client_performance_Set() const;
    bool is_client_performance_Valid() const;
...
private:
    ...
    OAIEventsBrowserTimingInfo m_browser_timing;
    bool m_browser_timing_isSet;
    bool m_browser_timing_isValid;

    OAIEventsClientPerformanceInfo m_client_performance;
    bool m_client_performance_isSet;
    bool m_client_performance_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEventsBrowserTimingResult)

#endif // OAIEventsBrowserTimingResult_H
