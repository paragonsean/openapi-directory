...
/*
 * OAIEventsPageViewResult.h
 *
 * A page view result
 */

#ifndef OAIEventsPageViewResult_H
#define OAIEventsPageViewResult_H
...
class OAIEventsPageViewInfo;

class OAIEventsPageViewResult : public OAIObject {
public:
    OAIEventsPageViewResult();
    OAIEventsPageViewResult(QString json);
    ~OAIEventsPageViewResult() override;
    ...
    OAIEventsPageViewInfo getPageView() const;
    void setPageView(const OAIEventsPageViewInfo &page_view);
    bool is_page_view_Set() const;
    bool is_page_view_Valid() const;
...
private:
    ...
    OAIEventsPageViewInfo m_page_view;
    bool m_page_view_isSet;
    bool m_page_view_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEventsPageViewResult)

#endif // OAIEventsPageViewResult_H
