...
/*
 * OAIEventsCustomEventResult.h
 *
 * A custom event result
 */

#ifndef OAIEventsCustomEventResult_H
#define OAIEventsCustomEventResult_H
...
class OAIEventsCustomEventInfo;

class OAIEventsCustomEventResult : public OAIObject {
public:
    OAIEventsCustomEventResult();
    OAIEventsCustomEventResult(QString json);
    ~OAIEventsCustomEventResult() override;
    ...
    OAIEventsCustomEventInfo getCustomEvent() const;
    void setCustomEvent(const OAIEventsCustomEventInfo &custom_event);
...
private:
    ...
    OAIEventsCustomEventInfo m_custom_event;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsCustomEventResult)

#endif // OAIEventsCustomEventResult_H
