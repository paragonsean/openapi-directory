...
/*
 * OAIEventsTraceResult.h
 *
 * A trace result
 */

#ifndef OAIEventsTraceResult_H
#define OAIEventsTraceResult_H
...
class OAIEventsTraceInfo;

class OAIEventsTraceResult : public OAIObject {
public:
    OAIEventsTraceResult();
    OAIEventsTraceResult(QString json);
    ~OAIEventsTraceResult() override;
    ...
    OAIEventsTraceInfo getTrace() const;
    void setTrace(const OAIEventsTraceInfo &trace);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsTraceResult)

#endif // OAIEventsTraceResult_H
