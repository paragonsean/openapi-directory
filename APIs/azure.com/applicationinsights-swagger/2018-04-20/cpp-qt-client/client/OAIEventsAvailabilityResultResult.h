...
/*
 * OAIEventsAvailabilityResultResult.h
 *
 * An availability result result
 */

#ifndef OAIEventsAvailabilityResultResult_H
#define OAIEventsAvailabilityResultResult_H
...
class OAIEventsAvailabilityResultInfo;

class OAIEventsAvailabilityResultResult : public OAIObject {
public:
    OAIEventsAvailabilityResultResult();
    OAIEventsAvailabilityResultResult(QString json);
    ~OAIEventsAvailabilityResultResult() override;
    ...
    OAIEventsAvailabilityResultInfo getAvailabilityResult() const;
    void setAvailabilityResult(const OAIEventsAvailabilityResultInfo &availability_result);
    bool is_availability_result_Set() const;
    bool is_availability_result_Valid() const;
...
private:
    ...
    OAIEventsAvailabilityResultInfo m_availability_result;
    bool m_availability_result_isSet;
    bool m_availability_result_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEventsAvailabilityResultResult)

#endif // OAIEventsAvailabilityResultResult_H
