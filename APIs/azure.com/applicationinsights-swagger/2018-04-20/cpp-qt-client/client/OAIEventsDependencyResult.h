...
/*
 * OAIEventsDependencyResult.h
 *
 * A dependency result
 */

#ifndef OAIEventsDependencyResult_H
#define OAIEventsDependencyResult_H
...
class OAIEventsDependencyInfo;

class OAIEventsDependencyResult : public OAIObject {
public:
    OAIEventsDependencyResult();
    OAIEventsDependencyResult(QString json);
    ~OAIEventsDependencyResult() override;
    ...
    OAIEventsDependencyInfo getDependency() const;
    void setDependency(const OAIEventsDependencyInfo &dependency);
...
private:
    ...
    OAIEventsDependencyInfo m_dependency;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsDependencyResult)

#endif // OAIEventsDependencyResult_H
