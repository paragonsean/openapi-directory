...
/*
 * OAIEventsResultData.h
 *
 * Events query result data.
 */

#ifndef OAIEventsResultData_H
#define OAIEventsResultData_H
...
class OAIEventsResultData : public OAIObject {
public:
    OAIEventsResultData();
    OAIEventsResultData(QString json);
    ~OAIEventsResultData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsResultData)

#endif // OAIEventsResultData_H
