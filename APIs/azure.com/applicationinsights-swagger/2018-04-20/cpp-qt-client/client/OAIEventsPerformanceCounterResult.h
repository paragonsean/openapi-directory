...
/*
 * OAIEventsPerformanceCounterResult.h
 *
 * A performance counter result
 */

#ifndef OAIEventsPerformanceCounterResult_H
#define OAIEventsPerformanceCounterResult_H
...
class OAIEventsPerformanceCounterInfo;

class OAIEventsPerformanceCounterResult : public OAIObject {
public:
    OAIEventsPerformanceCounterResult();
    OAIEventsPerformanceCounterResult(QString json);
    ~OAIEventsPerformanceCounterResult() override;
    ...
    OAIEventsPerformanceCounterInfo getPerformanceCounter() const;
    void setPerformanceCounter(const OAIEventsPerformanceCounterInfo &performance_counter);
    bool is_performance_counter_Set() const;
    bool is_performance_counter_Valid() const;
...
private:
    ...
    OAIEventsPerformanceCounterInfo m_performance_counter;
    bool m_performance_counter_isSet;
    bool m_performance_counter_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEventsPerformanceCounterResult)

#endif // OAIEventsPerformanceCounterResult_H
