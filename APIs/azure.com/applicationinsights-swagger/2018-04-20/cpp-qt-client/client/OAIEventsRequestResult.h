...
/*
 * OAIEventsRequestResult.h
 *
 * A request result
 */

#ifndef OAIEventsRequestResult_H
#define OAIEventsRequestResult_H
...
class OAIEventsRequestInfo;

class OAIEventsRequestResult : public OAIObject {
public:
    OAIEventsRequestResult();
    OAIEventsRequestResult(QString json);
    ~OAIEventsRequestResult() override;
    ...
    OAIEventsRequestInfo getRequest() const;
    void setRequest(const OAIEventsRequestInfo &request);
...
private:
    ...
    OAIEventsRequestInfo m_request;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsRequestResult)

#endif // OAIEventsRequestResult_H
