...
import EventsPageViewInfo from './EventsPageViewInfo';
...
/**
 * The EventsPageViewResult model module.
 * @module model/EventsPageViewResult
 * @version 2018-04-20
 */
class EventsPageViewResult {
    /**
     * Constructs a new <code>EventsPageViewResult</code>.
     * A page view result
     * @alias module:model/EventsPageViewResult
     * @extends module:model/EventsResultData
     * @implements module:model/EventsResultData
     */
    constructor() { 
        EventsResultData.initialize(this);
        EventsPageViewResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventsPageViewResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsPageViewResult} obj Optional instance to populate.
     * @return {module:model/EventsPageViewResult} The populated <code>EventsPageViewResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsPageViewResult();
            EventsResultData.constructFromObject(data, obj);
            EventsResultData.constructFromObject(data, obj);

            if (data.hasOwnProperty('pageView')) {
                obj['pageView'] = EventsPageViewInfo.constructFromObject(data['pageView']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsPageViewResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsPageViewResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pageView`
        if (data['pageView']) { // data not null
          EventsPageViewInfo.validateJSON(data['pageView']);
        }
...
/**
 * @member {module:model/EventsPageViewInfo} pageView
 */
EventsPageViewResult.prototype['pageView'] = undefined;
...
export default EventsPageViewResult;
