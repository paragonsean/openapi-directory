...
import EventsCustomEventInfo from './EventsCustomEventInfo';
...
/**
 * The EventsCustomEventResult model module.
 * @module model/EventsCustomEventResult
 * @version 2018-04-20
 */
class EventsCustomEventResult {
    /**
     * Constructs a new <code>EventsCustomEventResult</code>.
     * A custom event result
     * @alias module:model/EventsCustomEventResult
     * @extends module:model/EventsResultData
     * @implements module:model/EventsResultData
     */
    constructor() { 
        EventsResultData.initialize(this);
        EventsCustomEventResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventsCustomEventResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsCustomEventResult} obj Optional instance to populate.
     * @return {module:model/EventsCustomEventResult} The populated <code>EventsCustomEventResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsCustomEventResult();
            EventsResultData.constructFromObject(data, obj);
            EventsResultData.constructFromObject(data, obj);

            if (data.hasOwnProperty('customEvent')) {
                obj['customEvent'] = EventsCustomEventInfo.constructFromObject(data['customEvent']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsCustomEventResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsCustomEventResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `customEvent`
        if (data['customEvent']) { // data not null
          EventsCustomEventInfo.validateJSON(data['customEvent']);
        }
...
/**
 * @member {module:model/EventsCustomEventInfo} customEvent
 */
EventsCustomEventResult.prototype['customEvent'] = undefined;
...
export default EventsCustomEventResult;
