...
import EventsRequestInfo from './EventsRequestInfo';
...
/**
 * The EventsRequestResult model module.
 * @module model/EventsRequestResult
 * @version 2018-04-20
 */
class EventsRequestResult {
    /**
     * Constructs a new <code>EventsRequestResult</code>.
     * A request result
     * @alias module:model/EventsRequestResult
     * @extends module:model/EventsResultData
     * @implements module:model/EventsResultData
     */
    constructor() { 
        EventsResultData.initialize(this);
        EventsRequestResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventsRequestResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsRequestResult} obj Optional instance to populate.
     * @return {module:model/EventsRequestResult} The populated <code>EventsRequestResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsRequestResult();
            EventsResultData.constructFromObject(data, obj);
            EventsResultData.constructFromObject(data, obj);

            if (data.hasOwnProperty('request')) {
                obj['request'] = EventsRequestInfo.constructFromObject(data['request']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsRequestResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsRequestResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `request`
        if (data['request']) { // data not null
          EventsRequestInfo.validateJSON(data['request']);
        }
...
/**
 * @member {module:model/EventsRequestInfo} request
 */
EventsRequestResult.prototype['request'] = undefined;
...
export default EventsRequestResult;
