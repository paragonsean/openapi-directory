...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsDataPlane.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new ApplicationInsightsDataPlane.ErrorResponse();
      //expect(instance).to.be.a(ApplicationInsightsDataPlane.ErrorResponse);
    });
