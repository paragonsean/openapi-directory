...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsDataPlane.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new ApplicationInsightsDataPlane.ErrorDetail();
      //expect(instance).to.be.a(ApplicationInsightsDataPlane.ErrorDetail);
    });
