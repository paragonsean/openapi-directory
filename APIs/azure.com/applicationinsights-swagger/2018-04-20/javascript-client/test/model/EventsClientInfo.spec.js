...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsDataPlane.EventsClientInfo();
  });
  ...
  describe('EventsClientInfo', function() {
    it('should create an instance of EventsClientInfo', function() {
      // uncomment below and update the code to test EventsClientInfo
      //var instance = new ApplicationInsightsDataPlane.EventsClientInfo();
      //expect(instance).to.be.a(ApplicationInsightsDataPlane.EventsClientInfo);
    });
