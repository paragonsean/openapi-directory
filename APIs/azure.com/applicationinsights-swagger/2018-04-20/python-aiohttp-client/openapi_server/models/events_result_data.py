...
class EventsResultData(Model):
    ...
    def __init__(self, ai: EventsAiInfo=None, application: EventsApplicationInfo=None, client: EventsClientInfo=None, cloud: EventsCloudInfo=None, count: int=None, custom_dimensions: EventsResultDataCustomDimensions=None, custom_measurements: EventsResultDataCustomMeasurements=None, id: str=None, operation: EventsOperationInfo=None, session: EventsSessionInfo=None, timestamp: datetime=None, type: EventType=None, user: EventsUserInfo=None):
        """EventsResultData - a model defined in OpenAPI

        :param ai: The ai of this EventsResultData.
        :param application: The application of this EventsResultData.
        :param client: The client of this EventsResultData.
        :param cloud: The cloud of this EventsResultData.
        :param count: The count of this EventsResultData.
        :param custom_dimensions: The custom_dimensions of this EventsResultData.
        :param custom_measurements: The custom_measurements of this EventsResultData.
        :param id: The id of this EventsResultData.
        :param operation: The operation of this EventsResultData.
        :param session: The session of this EventsResultData.
        :param timestamp: The timestamp of this EventsResultData.
        :param type: The type of this EventsResultData.
        :param user: The user of this EventsResultData.
        """
        self.openapi_types = {
            'ai': EventsAiInfo,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EventsResultData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The eventsResultData of this EventsResultData.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def ai(self):
        """Gets the ai of this EventsResultData.


        :return: The ai of this EventsResultData.
        :rtype: EventsAiInfo
        """
        return self._ai
    ...
    def application(self):
        """Gets the application of this EventsResultData.


        :return: The application of this EventsResultData.
    ...
    @property
    def client(self):
        """Gets the client of this EventsResultData.


        :return: The client of this EventsResultData.
    ...
    @property
    def cloud(self):
        """Gets the cloud of this EventsResultData.


        :return: The cloud of this EventsResultData.
    ...
    @property
    def count(self):
        """Gets the count of this EventsResultData.

        Count of the event

        :return: The count of this EventsResultData.
        :rtype: int
        """
        return self._count
    ...
    def custom_dimensions(self):
        """Gets the custom_dimensions of this EventsResultData.


        :return: The custom_dimensions of this EventsResultData.
    ...
    def custom_measurements(self):
        """Gets the custom_measurements of this EventsResultData.


        :return: The custom_measurements of this EventsResultData.
    ...
    @property
    def id(self):
        """Gets the id of this EventsResultData.

        The unique ID for this event.

        :return: The id of this EventsResultData.
        :rtype: str
        """
        return self._id
    ...
    @property
    def operation(self):
        """Gets the operation of this EventsResultData.


        :return: The operation of this EventsResultData.
    ...
    @property
    def session(self):
        """Gets the session of this EventsResultData.


        :return: The session of this EventsResultData.
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this EventsResultData.

        Timestamp of the event

        :return: The timestamp of this EventsResultData.
        :rtype: datetime
        """
    ...
    @property
    def type(self):
        """Gets the type of this EventsResultData.


        :return: The type of this EventsResultData.
        :rtype: EventType
        """
        return self._type
    ...
    @property
    def user(self):
        """Gets the user of this EventsResultData.


        :return: The user of this EventsResultData.
