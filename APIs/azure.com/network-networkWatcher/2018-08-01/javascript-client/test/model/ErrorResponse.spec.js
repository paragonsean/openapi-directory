...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new NetworkManagementClient.ErrorResponse();
      //expect(instance).to.be.a(NetworkManagementClient.ErrorResponse);
    });
