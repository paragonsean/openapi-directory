...
public class SecurityRuleAssociationsEffectiveSecurityRulesInner {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, destinationAddressPrefix, destinationPortRange, direction, expandedDestinationAddressPrefix, expandedSourceAddressPrefix, name, priority, protocol, sourceAddressPrefix, sourcePortRange);
  }
