...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.FlowLogProperties();
  });
  ...
  describe('FlowLogProperties', function() {
    it('should create an instance of FlowLogProperties', function() {
      // uncomment below and update the code to test FlowLogProperties
      //var instance = new NetworkManagementClient.FlowLogProperties();
      //expect(instance).to.be.a(NetworkManagementClient.FlowLogProperties);
    });
