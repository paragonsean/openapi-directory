...
|-------------|-------------|------------------|
| **200** | Successful request for query flow log and traffic analytics status. |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Successful request for setting flow log and traffic analytics (if opted) configuration. |  -  |
| **202** | Accepted and the operation will complete asynchronously. |  -  |
