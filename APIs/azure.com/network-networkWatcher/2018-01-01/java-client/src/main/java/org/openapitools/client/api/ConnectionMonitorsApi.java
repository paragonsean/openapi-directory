...
public class ConnectionMonitorsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Update successful. The operation returns the resulting connection monitor resource. </td><td>  -  </td></tr>
        <tr><td> 201 </td><td> Create successful. The operation returns the resulting connection monitor resource. </td><td>  -  </td></tr>
     </table>
     */
