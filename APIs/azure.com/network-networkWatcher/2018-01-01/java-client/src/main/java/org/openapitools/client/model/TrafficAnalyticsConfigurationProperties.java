...
public class TrafficAnalyticsConfigurationProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enabled, workspaceId, workspaceRegion, workspaceResourceId);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("workspaceRegion");
    openapiRequiredFields.add("workspaceResourceId");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("workspaceRegion").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("workspaceResourceId").isJsonPrimitive()) {
