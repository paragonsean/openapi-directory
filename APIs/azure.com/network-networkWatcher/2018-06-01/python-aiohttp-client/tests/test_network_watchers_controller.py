...
async def test_network_watchers_get_network_configuration_diagnostic(client):
    ...
    """
    parameters = {"targetResourceId":"targetResourceId","queries":[{"destinationPort":"destinationPort","protocol":"protocol","destination":"destination","source":"source","direction":"Inbound"},{"destinationPort":"destinationPort","protocol":"protocol","destination":"destination","source":"source","direction":"Inbound"}]}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
