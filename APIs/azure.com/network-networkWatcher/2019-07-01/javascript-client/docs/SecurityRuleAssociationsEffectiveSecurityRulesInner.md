...
------------ | ------------- | ------------- | -------------
**access** | **String** | Whether network traffic is allowed or denied. | [optional] 
...
**direction** | **String** | The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic. | [optional] 
...
**protocol** | **String** | The network protocol this rule applies to. | [optional] 
