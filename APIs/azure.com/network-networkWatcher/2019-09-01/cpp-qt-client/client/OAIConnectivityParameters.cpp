...
QString OAIConnectivityParameters::getPreferredIpVersion() const {
    return m_preferred_ip_version;
}
void OAIConnectivityParameters::setPreferredIpVersion(const QString &preferred_ip_version) {
    m_preferred_ip_version = preferred_ip_version;
    m_preferred_ip_version_isSet = true;
}

bool OAIConnectivityParameters::is_preferred_ip_version_Set() const{
    return m_preferred_ip_version_isSet;
}

bool OAIConnectivityParameters::is_preferred_ip_version_Valid() const{
