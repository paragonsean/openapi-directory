...
OAIDirection OAINetworkConfigurationDiagnosticProfile::getDirection() const {
    return m_direction;
}
void OAINetworkConfigurationDiagnosticProfile::setDirection(const OAIDirection &direction) {
