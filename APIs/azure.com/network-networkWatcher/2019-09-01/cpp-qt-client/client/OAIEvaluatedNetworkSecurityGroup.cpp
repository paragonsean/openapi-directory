...
void OAIEvaluatedNetworkSecurityGroup::fromJsonObject(QJsonObject json) {
    ...
    m_applied_to_isValid = ::OpenAPI::fromJsonValue(m_applied_to, json[QString("appliedTo")]);
    m_applied_to_isSet = !json[QString("appliedTo")].isNull() && m_applied_to_isValid;
...
QJsonObject OAIEvaluatedNetworkSecurityGroup::asJsonObject() const {
    QJsonObject obj;
    if (m_applied_to_isSet) {
        obj.insert(QString("appliedTo"), ::OpenAPI::toJsonValue(m_applied_to));
    }
...
QString OAIEvaluatedNetworkSecurityGroup::getAppliedTo() const {
    return m_applied_to;
}
void OAIEvaluatedNetworkSecurityGroup::setAppliedTo(const QString &applied_to) {
    m_applied_to = applied_to;
    m_applied_to_isSet = true;
}

bool OAIEvaluatedNetworkSecurityGroup::is_applied_to_Set() const{
    return m_applied_to_isSet;
}

bool OAIEvaluatedNetworkSecurityGroup::is_applied_to_Valid() const{
