...
class ConnectionStateSnapshot(Model):
    ...
    def __init__(self, avg_latency_in_ms: int=None, connection_state: str=None, end_time: datetime=None, evaluation_state: str=None, hops: List[ConnectivityHop]=None, max_latency_in_ms: int=None, min_latency_in_ms: int=None, probes_failed: int=None, probes_sent: int=None, start_time: datetime=None):
