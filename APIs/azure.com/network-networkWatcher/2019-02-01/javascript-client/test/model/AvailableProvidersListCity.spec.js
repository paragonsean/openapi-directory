...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.AvailableProvidersListCity();
  });
  ...
  describe('AvailableProvidersListCity', function() {
    it('should create an instance of AvailableProvidersListCity', function() {
      // uncomment below and update the code to test AvailableProvidersListCity
      //var instance = new NetworkManagementClient.AvailableProvidersListCity();
      //expect(instance).to.be.a(NetworkManagementClient.AvailableProvidersListCity);
    });
