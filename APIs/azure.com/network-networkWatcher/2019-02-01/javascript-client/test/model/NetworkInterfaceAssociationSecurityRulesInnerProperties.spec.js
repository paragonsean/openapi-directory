...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.NetworkInterfaceAssociationSecurityRulesInnerProperties();
  });
  ...
  describe('NetworkInterfaceAssociationSecurityRulesInnerProperties', function() {
    it('should create an instance of NetworkInterfaceAssociationSecurityRulesInnerProperties', function() {
      // uncomment below and update the code to test NetworkInterfaceAssociationSecurityRulesInnerProperties
      //var instance = new NetworkManagementClient.NetworkInterfaceAssociationSecurityRulesInnerProperties();
      //expect(instance).to.be.a(NetworkManagementClient.NetworkInterfaceAssociationSecurityRulesInnerProperties);
    });
    ...
    it('should have the property destinationApplicationSecurityGroups (base name: "destinationApplicationSecurityGroups")', function() {
      // uncomment below and update the code to test the property destinationApplicationSecurityGroups
      //var instance = new NetworkManagementClient.NetworkInterfaceAssociationSecurityRulesInnerProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceApplicationSecurityGroups (base name: "sourceApplicationSecurityGroups")', function() {
      // uncomment below and update the code to test the property sourceApplicationSecurityGroups
      //var instance = new NetworkManagementClient.NetworkInterfaceAssociationSecurityRulesInnerProperties();
      //expect(instance).to.be();
    });
