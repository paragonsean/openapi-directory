...
/*
 * OAIPacketCaptureResultProperties.h
 *
 * Describes the properties of a packet capture session.
 */

#ifndef OAIPacketCaptureResultProperties_H
#define OAIPacketCaptureResultProperties_H
...
class OAIPacketCaptureResultProperties : public OAIObject {
public:
    OAIPacketCaptureResultProperties();
    OAIPacketCaptureResultProperties(QString json);
    ~OAIPacketCaptureResultProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPacketCaptureResultProperties)

#endif // OAIPacketCaptureResultProperties_H
