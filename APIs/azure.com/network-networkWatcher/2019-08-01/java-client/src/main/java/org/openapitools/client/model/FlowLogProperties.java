...
public class FlowLogProperties {
  ...
  public FlowLogProperties format(FlowLogFormatParameters format) {
    this.format = format;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, flowLogProperties.enabled) &&
        Objects.equals(this.format, flowLogProperties.format) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enabled, format, retentionPolicy, storageId);
  }
