...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.AvailableProvidersListCountry();
  });
  ...
  describe('AvailableProvidersListCountry', function() {
    it('should create an instance of AvailableProvidersListCountry', function() {
      // uncomment below and update the code to test AvailableProvidersListCountry
      //var instance = new NetworkManagementClient.AvailableProvidersListCountry();
      //expect(instance).to.be.a(NetworkManagementClient.AvailableProvidersListCountry);
    });
