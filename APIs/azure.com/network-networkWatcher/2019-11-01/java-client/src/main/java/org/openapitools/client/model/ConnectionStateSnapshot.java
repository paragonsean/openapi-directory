...
import org.openapitools.client.model.ConnectionStateSnapshotHopsInner;
...
public class ConnectionStateSnapshot {
  ...
  private List<ConnectionStateSnapshotHopsInner> hops = new ArrayList<>();
  ...
  public ConnectionStateSnapshot(
     List<ConnectionStateSnapshotHopsInner> hops
  ) {
    this();
    this.hops = hops;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<ConnectionStateSnapshotHopsInner> getHops() {
    return hops;
  }
      ...
      if (jsonObj.get("hops") != null && !jsonObj.get("hops").isJsonNull()) {
        ...
        if (jsonArrayhops != null) {
          ...
          for (int i = 0; i < jsonArrayhops.size(); i++) {
            ConnectionStateSnapshotHopsInner.validateJsonElement(jsonArrayhops.get(i));
          };
        }
      }
  }
