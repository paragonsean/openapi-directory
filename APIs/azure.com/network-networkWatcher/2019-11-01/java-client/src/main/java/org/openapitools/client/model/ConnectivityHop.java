...
import org.openapitools.client.model.ConnectionStateSnapshotHopsInnerIssuesInner;
...
public class ConnectivityHop {
  ...
  private List<ConnectionStateSnapshotHopsInnerIssuesInner> issues = new ArrayList<>();
  ...
  public ConnectivityHop(
     String address, 
     String id, 
     List<ConnectionStateSnapshotHopsInnerIssuesInner> issues, 
   ...
   */
  @javax.annotation.Nullable
  public List<ConnectionStateSnapshotHopsInnerIssuesInner> getIssues() {
    return issues;
  }
      ...
      if (jsonObj.get("issues") != null && !jsonObj.get("issues").isJsonNull()) {
        ...
        if (jsonArrayissues != null) {
          ...
          for (int i = 0; i < jsonArrayissues.size(); i++) {
            ConnectionStateSnapshotHopsInnerIssuesInner.validateJsonElement(jsonArrayissues.get(i));
          };
        }
      }
