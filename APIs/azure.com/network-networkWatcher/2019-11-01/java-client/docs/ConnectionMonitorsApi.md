...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client API version.
    String subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    NetworkWatchersUpdateTagsRequest parameters = new NetworkWatchersUpdateTagsRequest(); // NetworkWatchersUpdateTagsRequest | Parameters supplied to update connection monitor tags.
    try {
...
| **apiVersion** | **String**| Client API version. | |
| **subscriptionId** | **String**| The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | |
| **parameters** | [**NetworkWatchersUpdateTagsRequest**](NetworkWatchersUpdateTagsRequest.md)| Parameters supplied to update connection monitor tags. | |
