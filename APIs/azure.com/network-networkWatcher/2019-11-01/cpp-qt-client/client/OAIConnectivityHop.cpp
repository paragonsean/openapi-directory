...
QList<OAIConnectionStateSnapshot_hops_inner_issues_inner> OAIConnectivityHop::getIssues() const {
    return m_issues;
}
void OAIConnectivityHop::setIssues(const QList<OAIConnectionStateSnapshot_hops_inner_issues_inner> &issues) {
    m_issues = issues;
    m_issues_isSet = true;
}
