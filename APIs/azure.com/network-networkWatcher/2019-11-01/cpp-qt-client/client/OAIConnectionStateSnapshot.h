...
namespace OpenAPI {
class OAIConnectionStateSnapshot_hops_inner;
...
public:
    ...
    QList<OAIConnectionStateSnapshot_hops_inner> getHops() const;
    void setHops(const QList<OAIConnectionStateSnapshot_hops_inner> &hops);
...
private:
    ...
    QList<OAIConnectionStateSnapshot_hops_inner> m_hops;
    bool m_hops_isSet;
    bool m_hops_isValid;
