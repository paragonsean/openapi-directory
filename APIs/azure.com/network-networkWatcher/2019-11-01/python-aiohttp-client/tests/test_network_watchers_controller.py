...
async def test_network_watchers_check_connectivity(client):
    ...
    """
    parameters = {"protocolConfiguration":{"HTTPConfiguration":{"headers":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"method":"Get","validStatusCodes":[6,6]}},"protocol":"Tcp","destination":{"resourceId":"resourceId","address":"address","port":0},"source":{"resourceId":"resourceId","port":1},"preferredIPVersion":"IPv4"}
