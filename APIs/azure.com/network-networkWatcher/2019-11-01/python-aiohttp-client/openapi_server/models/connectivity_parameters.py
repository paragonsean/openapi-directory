...
class ConnectivityParameters(Model):
    ...
    def __init__(self, destination: ConnectivityDestination=None, preferred_ip_version: str=None, protocol: str=None, protocol_configuration: ProtocolConfiguration=None, source: ConnectivitySource=None):
        """ConnectivityParameters - a model defined in OpenAPI

        :param destination: The destination of this ConnectivityParameters.
        :param preferred_ip_version: The preferred_ip_version of this ConnectivityParameters.
    ...
    def preferred_ip_version(self):
        """Gets the preferred_ip_version of this ConnectivityParameters.

        IP address version.

        :return: The preferred_ip_version of this ConnectivityParameters.
        :rtype: str
        """
    ...
    def preferred_ip_version(self, preferred_ip_version):
        """Sets the preferred_ip_version of this ConnectivityParameters.
