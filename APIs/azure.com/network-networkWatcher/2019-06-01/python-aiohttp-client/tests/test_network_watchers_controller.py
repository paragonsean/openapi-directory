...
async def test_network_watchers_set_flow_log_configuration(client):
    ...
    """
    parameters = {"targetResourceId":"targetResourceId","flowAnalyticsConfiguration":{"networkWatcherFlowAnalyticsConfiguration":{"trafficAnalyticsInterval":0,"workspaceResourceId":"workspaceResourceId","workspaceRegion":"workspaceRegion","enabled":True,"workspaceId":"workspaceId"}},"properties":{"format":{"type":"JSON","version":6},"retentionPolicy":{"days":1,"enabled":False},"enabled":True,"storageId":"storageId"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
