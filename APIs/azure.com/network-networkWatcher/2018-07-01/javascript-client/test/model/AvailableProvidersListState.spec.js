...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.AvailableProvidersListState();
  });
  ...
  describe('AvailableProvidersListState', function() {
    it('should create an instance of AvailableProvidersListState', function() {
      // uncomment below and update the code to test AvailableProvidersListState
      //var instance = new NetworkManagementClient.AvailableProvidersListState();
      //expect(instance).to.be.a(NetworkManagementClient.AvailableProvidersListState);
    });
