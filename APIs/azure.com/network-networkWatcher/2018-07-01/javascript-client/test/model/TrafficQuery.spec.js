...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.TrafficQuery();
  });
  ...
  describe('TrafficQuery', function() {
    it('should create an instance of TrafficQuery', function() {
      // uncomment below and update the code to test TrafficQuery
      //var instance = new NetworkManagementClient.TrafficQuery();
      //expect(instance).to.be.a(NetworkManagementClient.TrafficQuery);
    });
