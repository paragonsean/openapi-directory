...
class EvaluatedNetworkSecurityGroup(Model):
    ...
    def __init__(self, matched_rule: MatchedRule=None, network_security_group_id: str=None, rules_evaluation_result: List[NetworkSecurityRulesEvaluationResult]=None):
