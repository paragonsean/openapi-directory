...
class VerificationIPFlowParameters(Model):
    ...
    def __init__(self, direction: str=None, local_ip_address: str=None, local_port: str=None, protocol: str=None, remote_ip_address: str=None, remote_port: str=None, target_nic_resource_id: str=None, target_resource_id: str=None):
