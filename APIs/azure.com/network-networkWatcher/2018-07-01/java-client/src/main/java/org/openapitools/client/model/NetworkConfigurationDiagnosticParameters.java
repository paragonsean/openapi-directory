...
public class NetworkConfigurationDiagnosticParameters {
  ...
  private List<TrafficQuery> queries = new ArrayList<>();
  ...
  public NetworkConfigurationDiagnosticParameters queries(List<TrafficQuery> queries) {
    this.queries = queries;
    return this;
  }

  public NetworkConfigurationDiagnosticParameters addQueriesItem(TrafficQuery queriesItem) {
  ...
  public List<TrafficQuery> getQueries() {
    return queries;
  }

  public void setQueries(List<TrafficQuery> queries) {
    this.queries = queries;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.queries, networkConfigurationDiagnosticParameters.queries) &&
        Objects.equals(this.targetResourceId, networkConfigurationDiagnosticParameters.targetResourceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(queries, targetResourceId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayqueries.size(); i++) {
        TrafficQuery.validateJsonElement(jsonArrayqueries.get(i));
      };
