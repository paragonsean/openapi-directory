...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.PacketCaptureResultProperties();
  });
  ...
  describe('PacketCaptureResultProperties', function() {
    it('should create an instance of PacketCaptureResultProperties', function() {
      // uncomment below and update the code to test PacketCaptureResultProperties
      //var instance = new NetworkManagementClient.PacketCaptureResultProperties();
      //expect(instance).to.be.a(NetworkManagementClient.PacketCaptureResultProperties);
    });
