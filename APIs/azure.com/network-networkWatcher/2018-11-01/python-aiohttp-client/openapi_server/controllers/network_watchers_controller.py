...
async def network_watchers_get_network_configuration_diagnostic(request: web.Request, resource_group_name, network_watcher_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = NetworkConfigurationDiagnosticParameters.from_dict(parameters)
    return web.Response(status=200)
