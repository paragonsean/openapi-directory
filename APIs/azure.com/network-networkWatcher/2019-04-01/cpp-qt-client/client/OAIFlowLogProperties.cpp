...
OAIFlowLogFormatParameters OAIFlowLogProperties::getFormat() const {
    return m_format;
}
void OAIFlowLogProperties::setFormat(const OAIFlowLogFormatParameters &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIFlowLogProperties::is_format_Set() const{
    return m_format_isSet;
}

bool OAIFlowLogProperties::is_format_Valid() const{
