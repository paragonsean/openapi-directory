...
class ConnectivityHop(Model):
    ...
    def __init__(self, address: str=None, id: str=None, issues: List[ConnectivityIssue]=None, next_hop_ids: List[str]=None, resource_id: str=None, type: str=None):
    ...
    def issues(self, issues):
        ...
        :param issues: The issues of this ConnectivityHop.
        :type issues: List[ConnectivityIssue]
        """
