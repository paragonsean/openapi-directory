...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.CloudError();
  });
  ...
  describe('CloudError', function() {
    it('should create an instance of CloudError', function() {
      ...
      //var instance = new MariaDbManagementClient.CloudError();
      //expect(instance).to.be.a(MariaDbManagementClient.CloudError);
    });
