...
#ifndef OAIServerKey_H
#define OAIServerKey_H
...
namespace OpenAPI {
class OAIServerKeyProperties;

class OAIServerKey : public OAIObject {
public:
    OAIServerKey();
    OAIServerKey(QString json);
    ~OAIServerKey() override;
    ...
    OAIServerKeyProperties getProperties() const;
    void setProperties(const OAIServerKeyProperties &properties);
...
private:
    ...
    OAIServerKeyProperties m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerKey)

#endif // OAIServerKey_H
