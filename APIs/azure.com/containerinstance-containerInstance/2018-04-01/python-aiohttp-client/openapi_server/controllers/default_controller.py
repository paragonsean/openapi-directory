...
async def start_container_launch_exec(request: web.Request, subscription_id, api_version, resource_group_name, container_group_name, container_name, container_exec_request) -> web.Response:
