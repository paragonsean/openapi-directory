...
public class ContainerPropertiesInstanceView {
  ...
  public ContainerPropertiesInstanceView events(List<ContainerEvent> events) {
    this.events = events;
    return this;
  }

  public ContainerPropertiesInstanceView addEventsItem(ContainerEvent eventsItem) {
    if (this.events == null) {
  ...
  public ContainerPropertiesInstanceView restartCount(Integer restartCount) {
