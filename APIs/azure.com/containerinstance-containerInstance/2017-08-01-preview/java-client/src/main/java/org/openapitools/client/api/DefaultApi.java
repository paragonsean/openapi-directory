...
public class DefaultApi {
     ...
     * @param resourceGroupName The name of the resource group to contain the container group to be created or updated. (required)
     * @param containerGroupName The name of the container group to be created or updated. (required)
     ...
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client API version (required)
     * @param resourceGroupName The name of the resource group that contains the container group. (required)
     * @param containerGroupName The name of the container group to be deleted. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client API version (required)
     * @param resourceGroupName The name of the resource group that contains the container instance. (required)
     * @param containerName The name of the container instance. (required)
     * @param containerGroupName The name of the container group the container instance belongs to. (required)
     ...
     */
    public okhttp3.Call containerLogsListCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerName, String containerGroupName, Integer tail, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call containerLogsListValidateBeforeCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerName, String containerGroupName, Integer tail, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        return containerLogsListCall(subscriptionId, apiVersion, resourceGroupName, containerName, containerGroupName, tail, _callback);
     ...
     */
    public Logs containerLogsList(String subscriptionId, String apiVersion, String resourceGroupName, String containerName, String containerGroupName, Integer tail) throws ApiException {
        ApiResponse<Logs> localVarResp = containerLogsListWithHttpInfo(subscriptionId, apiVersion, resourceGroupName, containerName, containerGroupName, tail);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Logs> containerLogsListWithHttpInfo(String subscriptionId, String apiVersion, String resourceGroupName, String containerName, String containerGroupName, Integer tail) throws ApiException {
        okhttp3.Call localVarCall = containerLogsListValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerName, containerGroupName, tail, null);
     ...
     */
    public okhttp3.Call containerLogsListAsync(String subscriptionId, String apiVersion, String resourceGroupName, String containerName, String containerGroupName, Integer tail, final ApiCallback<Logs> _callback) throws ApiException {

        okhttp3.Call localVarCall = containerLogsListValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerName, containerGroupName, tail, _callback);
        Type localVarReturnType = new TypeToken<Logs>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
