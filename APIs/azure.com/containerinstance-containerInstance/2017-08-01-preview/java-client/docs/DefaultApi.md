...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    String apiVersion = "apiVersion_example"; // String | Client API version
    String resourceGroupName = "resourceGroupName_example"; // String | The name of the resource group that contains the container group.
    String containerGroupName = "containerGroupName_example"; // String | The name of the container group to be deleted.
    try {
...
# **containerLogsList**
> Logs containerLogsList(subscriptionId, apiVersion, resourceGroupName, containerName, containerGroupName, tail)
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    String apiVersion = "apiVersion_example"; // String | Client API version
    String resourceGroupName = "resourceGroupName_example"; // String | The name of the resource group that contains the container instance.
    String containerName = "containerName_example"; // String | The name of the container instance.
    String containerGroupName = "containerGroupName_example"; // String | The name of the container group the container instance belongs to.
    ...
    try {
      Logs result = apiInstance.containerLogsList(subscriptionId, apiVersion, resourceGroupName, containerName, containerGroupName, tail);
      System.out.println(result);
    } catch (ApiException e) {
