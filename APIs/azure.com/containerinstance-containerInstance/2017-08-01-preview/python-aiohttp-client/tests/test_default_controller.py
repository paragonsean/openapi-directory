...
async def test_container_groups_create_or_update(client):
    ...
    """
    container_group = {"name":"name","location":"location","id":"id","type":"type","properties":{"imageRegistryCredentials":[{"server":"server","password":"password","username":"username"},{"server":"server","password":"password","username":"username"}],"ipAddress":{"ip":"ip","ports":[{"protocol":"TCP","port":3},{"protocol":"TCP","port":3}],"type":"Public"},"osType":"Windows","volumes":[{"azureFile":{"storageAccountName":"storageAccountName","readOnly":True,"storageAccountKey":"storageAccountKey","shareName":"shareName"},"name":"name"},{"azureFile":{"storageAccountName":"storageAccountName","readOnly":True,"storageAccountKey":"storageAccountKey","shareName":"shareName"},"name":"name"}],"containers":[{"name":"name","properties":{"image":"image","instanceView":{"restartCount":1,"currentState":{"detailStatus":"detailStatus","finishTime":"2000-01-23T04:56:07.000+00:00","exitCode":0,"startTime":"2000-01-23T04:56:07.000+00:00","state":"state"},"events":[{"firstTimestamp":"2000-01-23T04:56:07.000+00:00","lastTimestamp":"2000-01-23T04:56:07.000+00:00","count":6,"message":"message","type":"type"},{"firstTimestamp":"2000-01-23T04:56:07.000+00:00","lastTimestamp":"2000-01-23T04:56:07.000+00:00","count":6,"message":"message","type":"type"}],"previousState":{"detailStatus":"detailStatus","finishTime":"2000-01-23T04:56:07.000+00:00","exitCode":0,"startTime":"2000-01-23T04:56:07.000+00:00","state":"state"}},"environmentVariables":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"resources":{"requests":{"cpu":7.061401241503109,"memoryInGB":9.301444243932576},"limits":{"cpu":5.637376656633329,"memoryInGB":2.3021358869347655}},"ports":[{"port":5},{"port":5}],"command":["command","command"],"volumeMounts":[{"mountPath":"mountPath","name":"name","readOnly":True},{"mountPath":"mountPath","name":"name","readOnly":True}]}},{"name":"name","properties":{"image":"image","instanceView":{"restartCount":1,"currentState":{"detailStatus":"detailStatus","finishTime":"2000-01-23T04:56:07.000+00:00","exitCode":0,"startTime":"2000-01-23T04:56:07.000+00:00","state":"state"},"events":[{"firstTimestamp":"2000-01-23T04:56:07.000+00:00","lastTimestamp":"2000-01-23T04:56:07.000+00:00","count":6,"message":"message","type":"type"},{"firstTimestamp":"2000-01-23T04:56:07.000+00:00","lastTimestamp":"2000-01-23T04:56:07.000+00:00","count":6,"message":"message","type":"type"}],"previousState":{"detailStatus":"detailStatus","finishTime":"2000-01-23T04:56:07.000+00:00","exitCode":0,"startTime":"2000-01-23T04:56:07.000+00:00","state":"state"}},"environmentVariables":[{"name":"name","value":"value"},{"name":"name","value":"value"}],"resources":{"requests":{"cpu":7.061401241503109,"memoryInGB":9.301444243932576},"limits":{"cpu":5.637376656633329,"memoryInGB":2.3021358869347655}},"ports":[{"port":5},{"port":5}],"command":["command","command"],"volumeMounts":[{"mountPath":"mountPath","name":"name","readOnly":True},{"mountPath":"mountPath","name":"name","readOnly":True}]}}],"provisioningState":"provisioningState","state":"state","restartPolicy":"always"},"tags":{"key":"tags"}}
...
async def test_container_logs_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ContainerInstance/containerGroups/{container_group_name}/containers/{container_name}/logs'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', container_name='container_name_example', container_group_name='container_group_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
