...
async def container_groups_create_or_update(request: web.Request, subscription_id, api_version, resource_group_name, container_group_name, container_group) -> web.Response:
    ...
    :param resource_group_name: The name of the resource group to contain the container group to be created or updated.
    :type resource_group_name: str
    :param container_group_name: The name of the container group to be created or updated.
...
async def container_groups_delete(request: web.Request, subscription_id, api_version, resource_group_name, container_group_name) -> web.Response:
    ...
    :param api_version: Client API version
    :type api_version: str
    :param resource_group_name: The name of the resource group that contains the container group.
    :type resource_group_name: str
    :param container_group_name: The name of the container group to be deleted.
    :type container_group_name: str
...
async def container_logs_list(request: web.Request, subscription_id, api_version, resource_group_name, container_name, container_group_name, tail=None) -> web.Response:
    ...
    :param api_version: Client API version
    :type api_version: str
    :param resource_group_name: The name of the resource group that contains the container instance.
    :type resource_group_name: str
    :param container_name: The name of the container instance.
    :type container_name: str
    :param container_group_name: The name of the container group the container instance belongs to.
    :type container_group_name: str
