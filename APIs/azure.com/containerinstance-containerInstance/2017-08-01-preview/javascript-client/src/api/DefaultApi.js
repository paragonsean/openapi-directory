...
export default class DefaultApi {
    ...
    */
     ...
     * @param {String} resourceGroupName The name of the resource group to contain the container group to be created or updated.
     * @param {String} containerGroupName The name of the container group to be created or updated.
     ...
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {String} apiVersion Client API version
     * @param {String} resourceGroupName The name of the resource group that contains the container group.
     * @param {String} containerGroupName The name of the container group to be deleted.
     ...
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {String} apiVersion Client API version
     * @param {String} resourceGroupName The name of the resource group that contains the container instance.
     * @param {String} containerName The name of the container instance.
     * @param {String} containerGroupName The name of the container group the container instance belongs to.
     ...
     */
    containerLogsList(subscriptionId, apiVersion, resourceGroupName, containerName, containerGroupName, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
