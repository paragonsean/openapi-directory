...
public:
    ...
    */
    virtual void containerLogsList(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &container_name, const QString &container_group_name, const ::OpenAPI::OptionalParam<qint32> &tail = ::OpenAPI::OptionalParam<qint32>());
