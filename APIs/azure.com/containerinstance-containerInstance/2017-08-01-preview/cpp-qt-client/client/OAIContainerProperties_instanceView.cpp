...
QList<OAIContainerEvent> OAIContainerProperties_instanceView::getEvents() const {
    return m_events;
}
void OAIContainerProperties_instanceView::setEvents(const QList<OAIContainerEvent> &events) {
    m_events = events;
    m_events_isSet = true;
}
