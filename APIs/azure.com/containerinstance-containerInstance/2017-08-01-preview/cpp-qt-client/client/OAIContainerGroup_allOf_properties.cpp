...
QString OAIContainerGroup_allOf_properties::getState() const {
    return m_state;
}
void OAIContainerGroup_allOf_properties::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIContainerGroup_allOf_properties::is_state_Set() const{
    return m_state_isSet;
}

bool OAIContainerGroup_allOf_properties::is_state_Valid() const{
