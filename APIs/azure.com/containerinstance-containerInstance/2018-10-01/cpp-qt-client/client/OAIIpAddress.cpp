...
QString OAIIpAddress::getDnsNameLabel() const {
    return m_dns_name_label;
}
void OAIIpAddress::setDnsNameLabel(const QString &dns_name_label) {
    m_dns_name_label = dns_name_label;
    m_dns_name_label_isSet = true;
}

bool OAIIpAddress::is_dns_name_label_Set() const{
    return m_dns_name_label_isSet;
}

bool OAIIpAddress::is_dns_name_label_Valid() const{
