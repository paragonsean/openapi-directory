...
OAIContainerGroupDiagnostics OAIContainerGroup_allOf_properties::getDiagnostics() const {
    return m_diagnostics;
}
void OAIContainerGroup_allOf_properties::setDiagnostics(const OAIContainerGroupDiagnostics &diagnostics) {
    m_diagnostics = diagnostics;
    m_diagnostics_isSet = true;
}

bool OAIContainerGroup_allOf_properties::is_diagnostics_Set() const{
    return m_diagnostics_isSet;
}

bool OAIContainerGroup_allOf_properties::is_diagnostics_Valid() const{
    return m_diagnostics_isValid;
}

OAIDnsConfiguration OAIContainerGroup_allOf_properties::getDnsConfig() const {
    return m_dns_config;
}
void OAIContainerGroup_allOf_properties::setDnsConfig(const OAIDnsConfiguration &dns_config) {
    m_dns_config = dns_config;
    m_dns_config_isSet = true;
}

bool OAIContainerGroup_allOf_properties::is_dns_config_Set() const{
    return m_dns_config_isSet;
}

bool OAIContainerGroup_allOf_properties::is_dns_config_Valid() const{
...
OAIContainerGroupNetworkProfile OAIContainerGroup_allOf_properties::getNetworkProfile() const {
    return m_network_profile;
}
void OAIContainerGroup_allOf_properties::setNetworkProfile(const OAIContainerGroupNetworkProfile &network_profile) {
    m_network_profile = network_profile;
    m_network_profile_isSet = true;
}

bool OAIContainerGroup_allOf_properties::is_network_profile_Set() const{
    return m_network_profile_isSet;
}

bool OAIContainerGroup_allOf_properties::is_network_profile_Valid() const{
