...
import ContainerGroupDiagnostics from './ContainerGroupDiagnostics';
import ContainerGroupNetworkProfile from './ContainerGroupNetworkProfile';
...
class ContainerGroupAllOfProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('diagnostics')) {
                obj['diagnostics'] = ContainerGroupDiagnostics.constructFromObject(data['diagnostics']);
            }
            if (data.hasOwnProperty('dnsConfig')) {
                obj['dnsConfig'] = DnsConfiguration.constructFromObject(data['dnsConfig']);
            }
            ...
            if (data.hasOwnProperty('networkProfile')) {
                obj['networkProfile'] = ContainerGroupNetworkProfile.constructFromObject(data['networkProfile']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['diagnostics']) { // data not null
          ContainerGroupDiagnostics.validateJSON(data['diagnostics']);
        }
        // validate the optional field `dnsConfig`
        if (data['dnsConfig']) { // data not null
          DnsConfiguration.validateJSON(data['dnsConfig']);
        }
        ...
        if (data['networkProfile']) { // data not null
          ContainerGroupNetworkProfile.validateJSON(data['networkProfile']);
        }
...
/**
 * @member {module:model/ContainerGroupDiagnostics} diagnostics
 */
ContainerGroupAllOfProperties.prototype['diagnostics'] = undefined;

/**
 * @member {module:model/DnsConfiguration} dnsConfig
 */
ContainerGroupAllOfProperties.prototype['dnsConfig'] = undefined;
...
/**
 * @member {module:model/ContainerGroupNetworkProfile} networkProfile
 */
ContainerGroupAllOfProperties.prototype['networkProfile'] = undefined;
