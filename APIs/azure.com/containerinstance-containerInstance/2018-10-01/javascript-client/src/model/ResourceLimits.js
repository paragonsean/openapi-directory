...
class ResourceLimits {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('gpu')) {
                obj['gpu'] = GpuResource.constructFromObject(data['gpu']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['gpu']) { // data not null
          GpuResource.validateJSON(data['gpu']);
        }
...
/**
 * @member {module:model/GpuResource} gpu
 */
ResourceLimits.prototype['gpu'] = undefined;
