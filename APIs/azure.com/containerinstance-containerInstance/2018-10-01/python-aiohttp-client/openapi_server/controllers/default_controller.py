...
async def container_groups_start(request: web.Request, subscription_id, api_version, resource_group_name, container_group_name) -> web.Response:
...
async def list_cached_images(request: web.Request, subscription_id, location, api_version) -> web.Response:
...
async def list_capabilities(request: web.Request, subscription_id, location, api_version) -> web.Response:
...
async def service_association_link_delete(request: web.Request, subscription_id, api_version, resource_group_name, virtual_network_name, subnet_name) -> web.Response:
