...
from openapi_server.models.dns_configuration import DnsConfiguration
...
class ContainerGroupAllOfProperties(Model):
    ...
    def __init__(self, containers: List[Container]=None, diagnostics: ContainerGroupDiagnostics=None, dns_config: DnsConfiguration=None, image_registry_credentials: List[ImageRegistryCredential]=None, instance_view: ContainerGroupAllOfPropertiesInstanceView=None, ip_address: IpAddress=None, network_profile: ContainerGroupNetworkProfile=None, os_type: str=None, provisioning_state: str=None, restart_policy: str=None, volumes: List[Volume]=None):
        ...
        :param dns_config: The dns_config of this ContainerGroupAllOfProperties.
    ...
    @property
    def dns_config(self):
        """Gets the dns_config of this ContainerGroupAllOfProperties.


        :return: The dns_config of this ContainerGroupAllOfProperties.
        :rtype: DnsConfiguration
        """
        return self._dns_config

    @dns_config.setter
    def dns_config(self, dns_config):
        """Sets the dns_config of this ContainerGroupAllOfProperties.


        :param dns_config: The dns_config of this ContainerGroupAllOfProperties.
        :type dns_config: DnsConfiguration
        """
