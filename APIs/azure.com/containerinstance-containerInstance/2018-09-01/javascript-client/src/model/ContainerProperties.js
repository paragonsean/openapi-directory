...
class ContainerProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('livenessProbe')) {
                obj['livenessProbe'] = ContainerProbe.constructFromObject(data['livenessProbe']);
            }
            if (data.hasOwnProperty('ports')) {
                obj['ports'] = ApiClient.convertToType(data['ports'], [ContainerPort]);
            }
            if (data.hasOwnProperty('readinessProbe')) {
                obj['readinessProbe'] = ContainerProbe.constructFromObject(data['readinessProbe']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['livenessProbe']) { // data not null
          ContainerProbe.validateJSON(data['livenessProbe']);
        }
        ...
        if (data['readinessProbe']) { // data not null
          ContainerProbe.validateJSON(data['readinessProbe']);
        }
...
/**
 * @member {module:model/ContainerProbe} livenessProbe
 */
ContainerProperties.prototype['livenessProbe'] = undefined;
...
/**
 * @member {module:model/ContainerProbe} readinessProbe
 */
ContainerProperties.prototype['readinessProbe'] = undefined;
