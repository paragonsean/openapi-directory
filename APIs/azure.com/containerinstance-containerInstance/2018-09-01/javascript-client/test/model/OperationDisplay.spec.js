...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerInstanceManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ContainerInstanceManagementClient.OperationDisplay();
      //expect(instance).to.be.a(ContainerInstanceManagementClient.OperationDisplay);
    });
