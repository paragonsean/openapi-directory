...
public:
    ...
    OAIContainerProbe getLivenessProbe() const;
    void setLivenessProbe(const OAIContainerProbe &liveness_probe);
    ...
    OAIContainerProbe getReadinessProbe() const;
    void setReadinessProbe(const OAIContainerProbe &readiness_probe);
...
private:
    ...
    OAIContainerProbe m_liveness_probe;
    ...
    OAIContainerProbe m_readiness_probe;
