...
public class DefaultApi {
    ...
    /**
     * Build call for containerExecuteCommand
     ...
     */
    public okhttp3.Call containerExecuteCommandCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, ContainerExecRequest containerExecRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call containerExecuteCommandValidateBeforeCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, ContainerExecRequest containerExecRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling containerExecuteCommand(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling containerExecuteCommand(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling containerExecuteCommand(Async)");
        }

        // verify the required parameter 'containerGroupName' is set
        if (containerGroupName == null) {
            throw new ApiException("Missing the required parameter 'containerGroupName' when calling containerExecuteCommand(Async)");
        }

        // verify the required parameter 'containerName' is set
        if (containerName == null) {
            throw new ApiException("Missing the required parameter 'containerName' when calling containerExecuteCommand(Async)");
        }

        // verify the required parameter 'containerExecRequest' is set
        if (containerExecRequest == null) {
            throw new ApiException("Missing the required parameter 'containerExecRequest' when calling containerExecuteCommand(Async)");
        }

        return containerExecuteCommandCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, containerExecRequest, _callback);
     ...
     */
    public ContainerExecResponse containerExecuteCommand(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, ContainerExecRequest containerExecRequest) throws ApiException {
        ApiResponse<ContainerExecResponse> localVarResp = containerExecuteCommandWithHttpInfo(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, containerExecRequest);
     ...
     */
    public ApiResponse<ContainerExecResponse> containerExecuteCommandWithHttpInfo(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, ContainerExecRequest containerExecRequest) throws ApiException {
        okhttp3.Call localVarCall = containerExecuteCommandValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, containerExecRequest, null);
        Type localVarReturnType = new TypeToken<ContainerExecResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Executes a command in a specific container instance. (asynchronously)
     * Executes a command for a specific container instance in a specified resource group and container group.
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client API version (required)
     * @param resourceGroupName The name of the resource group. (required)
     ...
     */
    public okhttp3.Call containerExecuteCommandAsync(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, ContainerExecRequest containerExecRequest, final ApiCallback<ContainerExecResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = containerExecuteCommandValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, containerExecRequest, _callback);
        Type localVarReturnType = new TypeToken<ContainerExecResponse>(){}.getType();
    ...
    /**
     * Build call for containerGroupsRestart
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client API version (required)
     * @param resourceGroupName The name of the resource group. (required)
     * @param containerGroupName The name of the container group. (required)
     ...
     */
    public okhttp3.Call containerGroupsRestartCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerInstance/containerGroups/{containerGroupName}/restart"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "containerGroupName" + "}", localVarApiClient.escapeString(containerGroupName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call containerGroupsRestartValidateBeforeCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling containerGroupsRestart(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling containerGroupsRestart(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling containerGroupsRestart(Async)");
        }

        // verify the required parameter 'containerGroupName' is set
        if (containerGroupName == null) {
            throw new ApiException("Missing the required parameter 'containerGroupName' when calling containerGroupsRestart(Async)");
        }

        return containerGroupsRestartCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, _callback);
     ...
     */
    public void containerGroupsRestart(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName) throws ApiException {
        containerGroupsRestartWithHttpInfo(subscriptionId, apiVersion, resourceGroupName, containerGroupName);
    }
     ...
     */
    public ApiResponse<Void> containerGroupsRestartWithHttpInfo(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName) throws ApiException {
        okhttp3.Call localVarCall = containerGroupsRestartValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Restarts all containers in a container group. (asynchronously)
     * Restarts all containers in a container group in place. If container image has updates, new image will be downloaded.
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client API version (required)
     * @param resourceGroupName The name of the resource group. (required)
     ...
     */
    public okhttp3.Call containerGroupsRestartAsync(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = containerGroupsRestartValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for containerGroupsStop
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client API version (required)
     * @param resourceGroupName The name of the resource group. (required)
     * @param containerGroupName The name of the container group. (required)
     ...
     */
    public okhttp3.Call containerGroupsStopCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerInstance/containerGroups/{containerGroupName}/stop"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "containerGroupName" + "}", localVarApiClient.escapeString(containerGroupName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call containerGroupsStopValidateBeforeCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling containerGroupsStop(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling containerGroupsStop(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling containerGroupsStop(Async)");
        }

        // verify the required parameter 'containerGroupName' is set
        if (containerGroupName == null) {
            throw new ApiException("Missing the required parameter 'containerGroupName' when calling containerGroupsStop(Async)");
        }

        return containerGroupsStopCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, _callback);
     ...
     */
    public void containerGroupsStop(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName) throws ApiException {
        containerGroupsStopWithHttpInfo(subscriptionId, apiVersion, resourceGroupName, containerGroupName);
    }
     ...
     */
    public ApiResponse<Void> containerGroupsStopWithHttpInfo(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName) throws ApiException {
        okhttp3.Call localVarCall = containerGroupsStopValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call containerGroupsStopAsync(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = containerGroupsStopValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    /**
     * Build call for containerListLogs
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client API version (required)
     * @param resourceGroupName The name of the resource group. (required)
     * @param containerGroupName The name of the container group. (required)
     ...
     */
    public okhttp3.Call containerListLogsCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, Integer tail, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call containerListLogsValidateBeforeCall(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, Integer tail, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling containerListLogs(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling containerListLogs(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling containerListLogs(Async)");
        }

        // verify the required parameter 'containerGroupName' is set
        if (containerGroupName == null) {
            throw new ApiException("Missing the required parameter 'containerGroupName' when calling containerListLogs(Async)");
        }

        // verify the required parameter 'containerName' is set
        if (containerName == null) {
            throw new ApiException("Missing the required parameter 'containerName' when calling containerListLogs(Async)");
        }

        return containerListLogsCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, tail, _callback);
     ...
     */
    public Logs containerListLogs(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, Integer tail) throws ApiException {
        ApiResponse<Logs> localVarResp = containerListLogsWithHttpInfo(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, tail);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Logs> containerListLogsWithHttpInfo(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, Integer tail) throws ApiException {
        okhttp3.Call localVarCall = containerListLogsValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, tail, null);
     ...
     */
    public okhttp3.Call containerListLogsAsync(String subscriptionId, String apiVersion, String resourceGroupName, String containerGroupName, String containerName, Integer tail, final ApiCallback<Logs> _callback) throws ApiException {

        okhttp3.Call localVarCall = containerListLogsValidateBeforeCall(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, tail, _callback);
        Type localVarReturnType = new TypeToken<Logs>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
