...
import org.openapitools.client.model.ContainerProbe;
...
public class ContainerProperties {
  ...
  public ContainerProperties livenessProbe(ContainerProbe livenessProbe) {
  ...
  public ContainerProperties readinessProbe(ContainerProbe readinessProbe) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.command, containerProperties.command) &&
        ...
        Objects.equals(this.livenessProbe, containerProperties.livenessProbe) &&
        Objects.equals(this.ports, containerProperties.ports) &&
        Objects.equals(this.readinessProbe, containerProperties.readinessProbe) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(command, environmentVariables, image, instanceView, livenessProbe, ports, readinessProbe, resources, volumeMounts);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("livenessProbe") != null && !jsonObj.get("livenessProbe").isJsonNull()) {
        ContainerProbe.validateJsonElement(jsonObj.get("livenessProbe"));
      }
      ...
      if (jsonObj.get("readinessProbe") != null && !jsonObj.get("readinessProbe").isJsonNull()) {
        ContainerProbe.validateJsonElement(jsonObj.get("readinessProbe"));
      }
