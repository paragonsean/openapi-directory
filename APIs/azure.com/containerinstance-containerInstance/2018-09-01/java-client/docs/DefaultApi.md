...
<a id="containerExecuteCommand"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String containerGroupName = "containerGroupName_example"; // String | The name of the container group.
    try {
      apiInstance.containerGroupsRestart(subscriptionId, apiVersion, resourceGroupName, containerGroupName);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#containerGroupsRestart");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String containerGroupName = "containerGroupName_example"; // String | The name of the container group.
    try {
      apiInstance.containerGroupsStop(subscriptionId, apiVersion, resourceGroupName, containerGroupName);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#containerGroupsStop");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="containerListLogs"></a>
# **containerListLogs**
> Logs containerListLogs(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, tail)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Logs result = apiInstance.containerListLogs(subscriptionId, apiVersion, resourceGroupName, containerGroupName, containerName, tail);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#containerListLogs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
