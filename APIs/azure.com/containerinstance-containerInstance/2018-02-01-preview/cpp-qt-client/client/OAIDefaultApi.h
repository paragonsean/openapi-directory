...
public:
    ...
    */
    virtual void startContainerLaunchExec(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &container_group_name, const QString &container_name, const OAIContainerExecRequest &container_exec_request);
...
private:
    ...
    void startContainerLaunchExecCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void startContainerLaunchExecSignal(OAIContainerExecResponse summary);
    ...
    void startContainerLaunchExecSignalFull(OAIHttpRequestWorker *worker, OAIContainerExecResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use startContainerLaunchExecSignalError() instead")
    void startContainerLaunchExecSignalE(OAIContainerExecResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void startContainerLaunchExecSignalError(OAIContainerExecResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use startContainerLaunchExecSignalErrorFull() instead")
    void startContainerLaunchExecSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void startContainerLaunchExecSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
