...
public class ContainerPort {
  ...
  public ContainerPort port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public ContainerPort protocol(ProtocolEnum protocol) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.port, containerPort.port) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ContainerPort.openapiRequiredFields) {
