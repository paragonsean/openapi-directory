...
public class Volume {
  ...
  public Volume gitRepo(GitRepoVolume gitRepo) {
   ...
   */
  @javax.annotation.Nullable
  public GitRepoVolume getGitRepo() {
    return gitRepo;
  }

  public void setGitRepo(GitRepoVolume gitRepo) {
    this.gitRepo = gitRepo;
  }
  ...
  public Volume secret(Map<String, String> secret) {
    this.secret = secret;
    return this;
  }

  public Volume putSecretItem(String key, String secretItem) {
    if (this.secret == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.azureFile, volume.azureFile) &&
        ...
        Objects.equals(this.gitRepo, volume.gitRepo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(azureFile, emptyDir, gitRepo, name, secret);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("gitRepo") != null && !jsonObj.get("gitRepo").isJsonNull()) {
        GitRepoVolume.validateJsonElement(jsonObj.get("gitRepo"));
      }
