...
class ContainerGroupAllOfProperties(Model):
    ...
    def __init__(self, containers: List[Container]=None, image_registry_credentials: List[ImageRegistryCredential]=None, instance_view: ContainerGroupAllOfPropertiesInstanceView=None, ip_address: IpAddress=None, os_type: str=None, provisioning_state: str=None, restart_policy: str=None, volumes: List[Volume]=None):
