...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo();
  });
  ...
  describe('AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo', function() {
    it('should create an instance of AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo', function() {
      // uncomment below and update the code to test AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo
      //var instance = new AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo();
      //expect(instance).to.be.a(AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo);
    });
    ...
    it('should have the property ignoreQuotas (base name: "ignoreQuotas")', function() {
      // uncomment below and update the code to test the property ignoreQuotas
      //var instance = new AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo();
      //expect(instance).to.be();
    });
