...
public class AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo() {
  }

  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo appSettingsOverrides(Map<String, String> appSettingsOverrides) {
    this.appSettingsOverrides = appSettingsOverrides;
    return this;
  }

  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo putAppSettingsOverridesItem(String key, String appSettingsOverridesItem) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo cloneCustomHostNames(Boolean cloneCustomHostNames) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo cloneSourceControl(Boolean cloneSourceControl) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo configureLoadBalancing(Boolean configureLoadBalancing) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo correlationId(UUID correlationId) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo hostingEnvironment(String hostingEnvironment) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo ignoreQuotas(Boolean ignoreQuotas) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo overwrite(Boolean overwrite) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo sourceWebAppId(String sourceWebAppId) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo trafficManagerProfileId(String trafficManagerProfileId) {
  ...
  public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo trafficManagerProfileName(String trafficManagerProfileName) {
  ...
  public boolean equals(Object o) {
    ...
    AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo = (AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo) o;
    return Objects.equals(this.appSettingsOverrides, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.appSettingsOverrides) &&
        Objects.equals(this.cloneCustomHostNames, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.cloneCustomHostNames) &&
        Objects.equals(this.cloneSourceControl, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.cloneSourceControl) &&
        Objects.equals(this.configureLoadBalancing, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.configureLoadBalancing) &&
        Objects.equals(this.correlationId, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.correlationId) &&
        Objects.equals(this.hostingEnvironment, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.hostingEnvironment) &&
        Objects.equals(this.ignoreQuotas, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.ignoreQuotas) &&
        Objects.equals(this.overwrite, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.overwrite) &&
        Objects.equals(this.sourceWebAppId, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.sourceWebAppId) &&
        Objects.equals(this.trafficManagerProfileId, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.trafficManagerProfileId) &&
        Objects.equals(this.trafficManagerProfileName, appServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.trafficManagerProfileName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo is not found in the empty JSON string", AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo>() {
           @Override
           public void write(JsonWriter out, AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo
   * @throws IOException if the JSON string is invalid with respect to AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo
   */
  public static AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.class);
  }

  /**
   * Convert an instance of AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo to an JSON string
   *
   * @return JSON string
   */
