...
public class AppServicePlansApi {
     ...
     */
    public AppServicePlansListHybridConnectionKeys200Response appServicePlansListHybridConnectionKeys(String resourceGroupName, String name, String namespaceName, String relayName, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServicePlansListHybridConnectionKeys200Response> localVarResp = appServicePlansListHybridConnectionKeysWithHttpInfo(resourceGroupName, name, namespaceName, relayName, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     * @return ApiResponse&lt;AppServicePlansListHybridConnectionKeys200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppServicePlansListHybridConnectionKeys200Response> appServicePlansListHybridConnectionKeysWithHttpInfo(String resourceGroupName, String name, String namespaceName, String relayName, String subscriptionId, String apiVersion) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<AppServicePlansListHybridConnectionKeys200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call appServicePlansListHybridConnectionKeysAsync(String resourceGroupName, String name, String namespaceName, String relayName, String subscriptionId, String apiVersion, final ApiCallback<AppServicePlansListHybridConnectionKeys200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for appServicePlansListMetricDefintions
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service plan. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     ...
     */
    public okhttp3.Call appServicePlansListMetricDefintionsCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServicePlansListMetricDefintionsValidateBeforeCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServicePlansListMetricDefintions(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServicePlansListMetricDefintions(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServicePlansListMetricDefintions(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServicePlansListMetricDefintions(Async)");
        }

        return appServicePlansListMetricDefintionsCall(resourceGroupName, name, subscriptionId, apiVersion, _callback);
     ...
     */
    public AppServicePlansListMetricDefintions200Response appServicePlansListMetricDefintions(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServicePlansListMetricDefintions200Response> localVarResp = appServicePlansListMetricDefintionsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     * @return ApiResponse&lt;AppServicePlansListMetricDefintions200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppServicePlansListMetricDefintions200Response> appServicePlansListMetricDefintionsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = appServicePlansListMetricDefintionsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, null);
        Type localVarReturnType = new TypeToken<AppServicePlansListMetricDefintions200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get metrics that can be queried for an App Service plan, and their definitions. (asynchronously)
     * Get metrics that can be queried for an App Service plan, and their definitions.
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service plan. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     ...
     */
    public okhttp3.Call appServicePlansListMetricDefintionsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback<AppServicePlansListMetricDefintions200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServicePlansListMetricDefintionsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<AppServicePlansListMetricDefintions200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for appServicePlansListMetrics
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service plan. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     * @param details Specify &lt;code&gt;true&lt;/code&gt; to include instance details. The default is &lt;code&gt;false&lt;/code&gt;. (optional)
     ...
     */
    public okhttp3.Call appServicePlansListMetricsCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServicePlansListMetricsValidateBeforeCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServicePlansListMetrics(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServicePlansListMetrics(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServicePlansListMetrics(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServicePlansListMetrics(Async)");
        }

        return appServicePlansListMetricsCall(resourceGroupName, name, subscriptionId, apiVersion, details, $filter, _callback);
     ...
     */
    public AppServicePlansListMetrics200Response appServicePlansListMetrics(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        ApiResponse<AppServicePlansListMetrics200Response> localVarResp = appServicePlansListMetricsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion, details, $filter);
        return localVarResp.getData();
    }
     ...
     * @param details Specify &lt;code&gt;true&lt;/code&gt; to include instance details. The default is &lt;code&gt;false&lt;/code&gt;. (optional)
     * @param $filter Return only usages/metrics specified in the filter. Filter conforms to odata syntax. Example: $filter&#x3D;(name.value eq &#39;Metric1&#39; or name.value eq &#39;Metric2&#39;) and startTime eq &#39;2014-01-01T00:00:00Z&#39; and endTime eq &#39;2014-12-31T23:59:59Z&#39; and timeGrain eq duration&#39;[Hour|Minute|Day]&#39;. (optional)
     * @return ApiResponse&lt;AppServicePlansListMetrics200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppServicePlansListMetrics200Response> appServicePlansListMetricsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        okhttp3.Call localVarCall = appServicePlansListMetricsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, details, $filter, null);
        Type localVarReturnType = new TypeToken<AppServicePlansListMetrics200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get metrics for an App Service plan. (asynchronously)
     * Get metrics for an App Service plan.
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service plan. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     ...
     */
    public okhttp3.Call appServicePlansListMetricsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback<AppServicePlansListMetrics200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServicePlansListMetricsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, details, $filter, _callback);
        Type localVarReturnType = new TypeToken<AppServicePlansListMetrics200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
