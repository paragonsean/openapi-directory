...
public class ResourceCollection {
  ...
  public ResourceCollection value(List<String> value) {
    this.value = value;
    return this;
  }

  public ResourceCollection addValueItem(String valueItem) {
    if (this.value == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextLink, resourceCollection.nextLink) &&
        Objects.equals(this.value, resourceCollection.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceCollection.openapiRequiredFields) {
