...
/*
 * OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner.h
 *
 * Routing rules for ramp up testing. This rule allows to redirect static traffic % to a slot or to gradually change routing % based on performance.
 */

#ifndef OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
#define OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
...
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner : public OAIObject {
public:
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner();
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner(QString json);
    ~OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner)

#endif // OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
