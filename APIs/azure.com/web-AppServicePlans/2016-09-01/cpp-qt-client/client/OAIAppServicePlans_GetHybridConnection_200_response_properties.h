...
/*
 * OAIAppServicePlans_GetHybridConnection_200_response_properties.h
 *
 * HybridConnection resource specific properties
 */

#ifndef OAIAppServicePlans_GetHybridConnection_200_response_properties_H
#define OAIAppServicePlans_GetHybridConnection_200_response_properties_H
...
class OAIAppServicePlans_GetHybridConnection_200_response_properties : public OAIObject {
public:
    OAIAppServicePlans_GetHybridConnection_200_response_properties();
    OAIAppServicePlans_GetHybridConnection_200_response_properties(QString json);
    ~OAIAppServicePlans_GetHybridConnection_200_response_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServicePlans_GetHybridConnection_200_response_properties)

#endif // OAIAppServicePlans_GetHybridConnection_200_response_properties_H
