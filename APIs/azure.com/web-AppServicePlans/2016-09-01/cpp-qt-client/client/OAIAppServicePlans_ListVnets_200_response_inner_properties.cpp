...
QByteArray OAIAppServicePlans_ListVnets_200_response_inner_properties::getCertBlob() const {
    return m_cert_blob;
}
void OAIAppServicePlans_ListVnets_200_response_inner_properties::setCertBlob(const QByteArray &cert_blob) {
