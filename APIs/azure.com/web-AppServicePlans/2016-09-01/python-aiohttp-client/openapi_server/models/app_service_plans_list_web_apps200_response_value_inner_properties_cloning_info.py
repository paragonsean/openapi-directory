...
class AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo(Model):
    ...
    def __init__(self, app_settings_overrides: Dict[str, str]=None, clone_custom_host_names: bool=None, clone_source_control: bool=None, configure_load_balancing: bool=None, correlation_id: str=None, hosting_environment: str=None, ignore_quotas: bool=None, overwrite: bool=None, source_web_app_id: str=None, traffic_manager_profile_id: str=None, traffic_manager_profile_name: str=None):
        ...
        :param ignore_quotas: The ignore_quotas of this AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.
    ...
    def ignore_quotas(self):
        """Gets the ignore_quotas of this AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.

        <code>true</code> if quotas should be ignored; otherwise, <code>false</code>.

        :return: The ignore_quotas of this AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.
        :rtype: bool
        """
    ...
    def ignore_quotas(self, ignore_quotas):
        """Sets the ignore_quotas of this AppServicePlansListWebApps200ResponseValueInnerPropertiesCloningInfo.
