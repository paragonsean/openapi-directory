...
public class AppServicePlansGetHybridConnection200ResponseProperties {
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties() {
  }

  public AppServicePlansGetHybridConnection200ResponseProperties hostname(String hostname) {
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties relayArmUri(String relayArmUri) {
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties relayName(String relayName) {
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties sendKeyName(String sendKeyName) {
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties sendKeyValue(String sendKeyValue) {
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties serviceBusNamespace(String serviceBusNamespace) {
  ...
  public AppServicePlansGetHybridConnection200ResponseProperties serviceBusSuffix(String serviceBusSuffix) {
  ...
  public boolean equals(Object o) {
    ...
    AppServicePlansGetHybridConnection200ResponseProperties appServicePlansGetHybridConnection200ResponseProperties = (AppServicePlansGetHybridConnection200ResponseProperties) o;
    return Objects.equals(this.hostname, appServicePlansGetHybridConnection200ResponseProperties.hostname) &&
        Objects.equals(this.port, appServicePlansGetHybridConnection200ResponseProperties.port) &&
        Objects.equals(this.relayArmUri, appServicePlansGetHybridConnection200ResponseProperties.relayArmUri) &&
        Objects.equals(this.relayName, appServicePlansGetHybridConnection200ResponseProperties.relayName) &&
        Objects.equals(this.sendKeyName, appServicePlansGetHybridConnection200ResponseProperties.sendKeyName) &&
        Objects.equals(this.sendKeyValue, appServicePlansGetHybridConnection200ResponseProperties.sendKeyValue) &&
        Objects.equals(this.serviceBusNamespace, appServicePlansGetHybridConnection200ResponseProperties.serviceBusNamespace) &&
        Objects.equals(this.serviceBusSuffix, appServicePlansGetHybridConnection200ResponseProperties.serviceBusSuffix);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppServicePlansGetHybridConnection200ResponseProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppServicePlansGetHybridConnection200ResponseProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppServicePlansGetHybridConnection200ResponseProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppServicePlansGetHybridConnection200ResponseProperties is not found in the empty JSON string", AppServicePlansGetHybridConnection200ResponseProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppServicePlansGetHybridConnection200ResponseProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppServicePlansGetHybridConnection200ResponseProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppServicePlansGetHybridConnection200ResponseProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppServicePlansGetHybridConnection200ResponseProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppServicePlansGetHybridConnection200ResponseProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppServicePlansGetHybridConnection200ResponseProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<AppServicePlansGetHybridConnection200ResponseProperties>() {
           @Override
           public void write(JsonWriter out, AppServicePlansGetHybridConnection200ResponseProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppServicePlansGetHybridConnection200ResponseProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppServicePlansGetHybridConnection200ResponseProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppServicePlansGetHybridConnection200ResponseProperties
   * @throws IOException if the JSON string is invalid with respect to AppServicePlansGetHybridConnection200ResponseProperties
   */
  public static AppServicePlansGetHybridConnection200ResponseProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppServicePlansGetHybridConnection200ResponseProperties.class);
  }

  /**
   * Convert an instance of AppServicePlansGetHybridConnection200ResponseProperties to an JSON string
   *
   * @return JSON string
   */
