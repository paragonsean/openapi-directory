...
QString OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_cloningInfo::getSourceWebAppLocation() const {
    return m_source_web_app_location;
}
void OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_cloningInfo::setSourceWebAppLocation(const QString &source_web_app_location) {
    m_source_web_app_location = source_web_app_location;
    m_source_web_app_location_isSet = true;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_cloningInfo::is_source_web_app_location_Set() const{
    return m_source_web_app_location_isSet;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_cloningInfo::is_source_web_app_location_Valid() const{
