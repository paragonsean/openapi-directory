...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerProperties();
  });
  ...
  describe('AppServicePlansListWebApps200ResponseValueInnerProperties', function() {
    it('should create an instance of AppServicePlansListWebApps200ResponseValueInnerProperties', function() {
      // uncomment below and update the code to test AppServicePlansListWebApps200ResponseValueInnerProperties
      //var instance = new AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerProperties();
      //expect(instance).to.be.a(AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerProperties);
    });
    ...
    it('should have the property geoDistributions (base name: "geoDistributions")', function() {
      // uncomment below and update the code to test the property geoDistributions
      //var instance = new AppServicePlansApiClient.AppServicePlansListWebApps200ResponseValueInnerProperties();
      //expect(instance).to.be();
    });
