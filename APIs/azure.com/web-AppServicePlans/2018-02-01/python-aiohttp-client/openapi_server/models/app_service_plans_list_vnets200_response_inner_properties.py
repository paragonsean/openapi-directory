...
class AppServicePlansListVnets200ResponseInnerProperties(Model):
    ...
    def __init__(self, cert_blob: str=None, cert_thumbprint: str=None, dns_servers: str=None, is_swift: bool=None, resync_required: bool=None, routes: List[AppServicePlansListVnets200ResponseInnerPropertiesRoutesInner]=None, vnet_resource_id: str=None):
        ...
        :param is_swift: The is_swift of this AppServicePlansListVnets200ResponseInnerProperties.
    ...
    @property
    def is_swift(self):
        """Gets the is_swift of this AppServicePlansListVnets200ResponseInnerProperties.

        Flag that is used to denote if this is VNET injection

        :return: The is_swift of this AppServicePlansListVnets200ResponseInnerProperties.
        :rtype: bool
        """
    ...
    def is_swift(self, is_swift):
        """Sets the is_swift of this AppServicePlansListVnets200ResponseInnerProperties.
