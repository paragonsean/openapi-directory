...
import HybridConnectionKey from '../model/HybridConnectionKey';
...
export default class AppServicePlansApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/HybridConnectionKey} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/HybridConnectionKey}
     */
    appServicePlansListHybridConnectionKeys(resourceGroupName, name, namespaceName, relayName, subscriptionId, apiVersion, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = HybridConnectionKey;
      return this.apiClient.callApi(
