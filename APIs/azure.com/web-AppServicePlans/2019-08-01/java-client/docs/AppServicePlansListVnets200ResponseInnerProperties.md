...
|------------ | ------------- | ------------- | -------------|
|**certBlob** | **String** | A certificate file (.cer) blob containing the public key of the private key used to authenticate a  Point-To-Site VPN connection. |  [optional] |
...
|**isSwift** | **Boolean** | Flag that is used to denote if this is VNET injection |  [optional] |
