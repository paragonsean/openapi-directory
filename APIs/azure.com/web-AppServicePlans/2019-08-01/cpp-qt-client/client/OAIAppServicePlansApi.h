...
Q_SIGNALS:
    ...
    void appServicePlansListHybridConnectionKeysSignal(OAIHybridConnectionKey summary);
    ...
    void appServicePlansListHybridConnectionKeysSignalFull(OAIHttpRequestWorker *worker, OAIHybridConnectionKey summary);
    ...
    void appServicePlansListHybridConnectionKeysSignalE(OAIHybridConnectionKey summary, QNetworkReply::NetworkError error_type, QString error_str);
    void appServicePlansListHybridConnectionKeysSignalError(OAIHybridConnectionKey summary, QNetworkReply::NetworkError error_type, const QString &error_str);
