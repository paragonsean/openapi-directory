...
QString OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::getClientCertExclusionPaths() const {
    return m_client_cert_exclusion_paths;
}
void OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::setClientCertExclusionPaths(const QString &client_cert_exclusion_paths) {
    m_client_cert_exclusion_paths = client_cert_exclusion_paths;
    m_client_cert_exclusion_paths_isSet = true;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_client_cert_exclusion_paths_Set() const{
    return m_client_cert_exclusion_paths_isSet;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_client_cert_exclusion_paths_Valid() const{
...
bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::isHyperV() const {
    return m_hyper_v;
}
void OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::setHyperV(const bool &hyper_v) {
    m_hyper_v = hyper_v;
    m_hyper_v_isSet = true;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_hyper_v_Set() const{
    return m_hyper_v_isSet;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_hyper_v_Valid() const{
    return m_hyper_v_isValid;
}

QString OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::getInProgressOperationId() const {
    return m_in_progress_operation_id;
}
void OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::setInProgressOperationId(const QString &in_progress_operation_id) {
    m_in_progress_operation_id = in_progress_operation_id;
    m_in_progress_operation_id_isSet = true;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_in_progress_operation_id_Set() const{
    return m_in_progress_operation_id_isSet;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_in_progress_operation_id_Valid() const{
...
bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::isIsXenon() const {
    return m_is_xenon;
}
void OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::setIsXenon(const bool &is_xenon) {
    m_is_xenon = is_xenon;
    m_is_xenon_isSet = true;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_is_xenon_Set() const{
    return m_is_xenon_isSet;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_is_xenon_Valid() const{
...
QString OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::getRedundancyMode() const {
    return m_redundancy_mode;
}
void OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::setRedundancyMode(const QString &redundancy_mode) {
    m_redundancy_mode = redundancy_mode;
    m_redundancy_mode_isSet = true;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_redundancy_mode_Set() const{
    return m_redundancy_mode_isSet;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties::is_redundancy_mode_Valid() const{
