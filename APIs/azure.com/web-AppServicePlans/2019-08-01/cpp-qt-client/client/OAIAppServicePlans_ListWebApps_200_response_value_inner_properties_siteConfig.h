...
/*
 * OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig.h
 *
 * Configuration of an App Service app.
 */

#ifndef OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_H
#define OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_H
...
namespace OpenAPI {
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiDefinition;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiManagementConfig;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_appSettings_inner;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_autoHealRules;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_connectionStrings_inner;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_handlerMappings_inner;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_limits;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_machineKey;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_push;
class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_virtualApplications_inner;

class OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig : public OAIObject {
public:
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig();
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig(QString json);
    ~OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig() override;
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiDefinition getApiDefinition() const;
    void setApiDefinition(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiDefinition &api_definition);
    bool is_api_definition_Set() const;
    bool is_api_definition_Valid() const;

    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiManagementConfig getApiManagementConfig() const;
    void setApiManagementConfig(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiManagementConfig &api_management_config);
    bool is_api_management_config_Set() const;
    bool is_api_management_config_Valid() const;
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_appSettings_inner> getAppSettings() const;
    void setAppSettings(const QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_appSettings_inner> &app_settings);
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_autoHealRules getAutoHealRules() const;
    void setAutoHealRules(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_autoHealRules &auto_heal_rules);
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_connectionStrings_inner> getConnectionStrings() const;
    void setConnectionStrings(const QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_connectionStrings_inner> &connection_strings);
    bool is_connection_strings_Set() const;
    bool is_connection_strings_Valid() const;

    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors getCors() const;
    void setCors(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors &cors);
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments getExperiments() const;
    void setExperiments(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments &experiments);
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_handlerMappings_inner> getHandlerMappings() const;
    void setHandlerMappings(const QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_handlerMappings_inner> &handler_mappings);
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> getIpSecurityRestrictions() const;
    void setIpSecurityRestrictions(const QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> &ip_security_restrictions);
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_limits getLimits() const;
    void setLimits(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_limits &limits);
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_machineKey getMachineKey() const;
    void setMachineKey(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_machineKey &machine_key);
    ...
    qint32 getPreWarmedInstanceCount() const;
    void setPreWarmedInstanceCount(const qint32 &pre_warmed_instance_count);
    bool is_pre_warmed_instance_count_Set() const;
    bool is_pre_warmed_instance_count_Valid() const;
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_push getPush() const;
    void setPush(const OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_push &push);
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> getScmIpSecurityRestrictions() const;
    void setScmIpSecurityRestrictions(const QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> &scm_ip_security_restrictions);
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_virtualApplications_inner> getVirtualApplications() const;
    void setVirtualApplications(const QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_virtualApplications_inner> &virtual_applications);
...
private:
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiDefinition m_api_definition;
    bool m_api_definition_isSet;
    bool m_api_definition_isValid;

    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_apiManagementConfig m_api_management_config;
    bool m_api_management_config_isSet;
    bool m_api_management_config_isValid;

    QString m_app_command_line;
    bool m_app_command_line_isSet;
    bool m_app_command_line_isValid;

    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_appSettings_inner> m_app_settings;
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_autoHealRules m_auto_heal_rules;
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_connectionStrings_inner> m_connection_strings;
    bool m_connection_strings_isSet;
    bool m_connection_strings_isValid;

    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors m_cors;
    bool m_cors_isSet;
    bool m_cors_isValid;
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_experiments m_experiments;
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_handlerMappings_inner> m_handler_mappings;
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> m_ip_security_restrictions;
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_limits m_limits;
    bool m_limits_isSet;
    ...
    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_machineKey m_machine_key;
    ...
    qint32 m_pre_warmed_instance_count;
    bool m_pre_warmed_instance_count_isSet;
    bool m_pre_warmed_instance_count_isValid;

    QString m_publishing_username;
    bool m_publishing_username_isSet;
    bool m_publishing_username_isValid;

    OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_push m_push;
    bool m_push_isSet;
    bool m_push_isValid;
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> m_scm_ip_security_restrictions;
    ...
    QList<OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_virtualApplications_inner> m_virtual_applications;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig)

#endif // OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_H
