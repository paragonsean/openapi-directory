...
bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors::isSupportCredentials() const {
    return m_support_credentials;
}
void OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors::setSupportCredentials(const bool &support_credentials) {
    m_support_credentials = support_credentials;
    m_support_credentials_isSet = true;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors::is_support_credentials_Set() const{
    return m_support_credentials_isSet;
}

bool OAIAppServicePlans_ListWebApps_200_response_value_inner_properties_siteConfig_cors::is_support_credentials_Valid() const{
