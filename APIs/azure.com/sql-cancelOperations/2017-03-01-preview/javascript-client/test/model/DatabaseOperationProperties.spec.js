...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.DatabaseOperationProperties();
  });
  ...
  describe('DatabaseOperationProperties', function() {
    it('should create an instance of DatabaseOperationProperties', function() {
      // uncomment below and update the code to test DatabaseOperationProperties
      //var instance = new SqlManagementClient.DatabaseOperationProperties();
      //expect(instance).to.be.a(SqlManagementClient.DatabaseOperationProperties);
    });
