...
export default class DefaultApi {
    ...
    */
     ...
     */
    workbooksCreateOrUpdate(subscriptionId, resourceGroupName, resourceName, apiVersion, workbookProperties, callback) {
     ...
     */
    workbooksListByResourceGroup(subscriptionId, resourceGroupName, category, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
     ...
     * data is of type: {@link module:model/Workbook}
     */
    workbooksUpdate(subscriptionId, resourceGroupName, resourceName, apiVersion, workbookProperties, callback) {
      let postBody = workbookProperties;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
      ...
      // verify the required parameter 'workbookProperties' is set
      if (workbookProperties === undefined || workbookProperties === null) {
        throw new Error("Missing the required parameter 'workbookProperties' when calling workbooksUpdate");
      }
