...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new ApplicationInsightsManagementClient.Resource();
      //expect(instance).to.be.a(ApplicationInsightsManagementClient.Resource);
    });
