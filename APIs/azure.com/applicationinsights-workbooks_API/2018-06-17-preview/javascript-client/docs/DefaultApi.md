...
> Workbook workbooksCreateOrUpdate(subscriptionId, resourceGroupName, resourceName, sourceId, apiVersion, workbookProperties)
...
let sourceId = "sourceId_example"; // String | Azure Resource Id that will fetch all related workbooks.
...
apiInstance.workbooksCreateOrUpdate(subscriptionId, resourceGroupName, resourceName, sourceId, apiVersion, workbookProperties, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> WorkbooksListResult workbooksListByResourceGroup(subscriptionId, resourceGroupName, category, sourceId, apiVersion, opts)
...
apiInstance.workbooksListByResourceGroup(subscriptionId, resourceGroupName, category, sourceId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Workbook workbooksUpdate(subscriptionId, resourceGroupName, resourceName, sourceId, apiVersion, opts)
...
let apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
let opts = {
  'workbookUpdateParameters': new ApplicationInsightsManagementClient.WorkbookUpdateParameters() // WorkbookUpdateParameters | Properties that need to be specified to create a new workbook.
};
apiInstance.workbooksUpdate(subscriptionId, resourceGroupName, resourceName, sourceId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **sourceId** | **String**| Azure Resource Id that will fetch all related workbooks. | 
 **apiVersion** | **String**| The API version to use for this operation. | 
 **workbookUpdateParameters** | [**WorkbookUpdateParameters**](WorkbookUpdateParameters.md)| Properties that need to be specified to create a new workbook. | [optional] 
