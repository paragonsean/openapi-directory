...
public:
    ...
    */
    virtual void workbooksCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &resource_name, const QString &source_id, const QString &api_version, const OAIWorkbook &workbook_properties);
    ...
    */
    virtual void workbooksListByResourceGroup(const QString &subscription_id, const QString &resource_group_name, const QString &category, const QString &source_id, const QString &api_version, const ::OpenAPI::OptionalParam<QList<QString>> &tags = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<bool> &can_fetch_content = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  source_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  workbook_update_parameters OAIWorkbookUpdateParameters [optional]
    */
    virtual void workbooksUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &resource_name, const QString &source_id, const QString &api_version, const ::OpenAPI::OptionalParam<OAIWorkbookUpdateParameters> &workbook_update_parameters = ::OpenAPI::OptionalParam<OAIWorkbookUpdateParameters>());
