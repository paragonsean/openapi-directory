...
QString OAIWorkbookProperties::getDisplayName() const {
    return m_display_name;
}
void OAIWorkbookProperties::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIWorkbookProperties::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIWorkbookProperties::is_display_name_Valid() const{
...
bool OAIWorkbookProperties::isValid() const {
    ...
    return m_category_isValid && m_display_name_isValid && m_serialized_data_isValid && m_user_id_isValid && true;
}
