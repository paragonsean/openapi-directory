...
> WorkbooksListResult workbooksListByResourceGroup(subscriptionId, resourceGroupName, category, sourceId, apiVersion, tags, canFetchContent)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      WorkbooksListResult result = apiInstance.workbooksListByResourceGroup(subscriptionId, resourceGroupName, category, sourceId, apiVersion, tags, canFetchContent);
      System.out.println(result);
    } catch (ApiException e) {
...
# **workbooksUpdate**
> Workbook workbooksUpdate(subscriptionId, resourceGroupName, resourceName, sourceId, apiVersion, workbookUpdateParameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    String sourceId = "sourceId_example"; // String | Azure Resource Id that will fetch all related workbooks.
    String apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
    WorkbookUpdateParameters workbookUpdateParameters = new WorkbookUpdateParameters(); // WorkbookUpdateParameters | Properties that need to be specified to create a new workbook.
    try {
      Workbook result = apiInstance.workbooksUpdate(subscriptionId, resourceGroupName, resourceName, sourceId, apiVersion, workbookUpdateParameters);
      System.out.println(result);
    } catch (ApiException e) {
