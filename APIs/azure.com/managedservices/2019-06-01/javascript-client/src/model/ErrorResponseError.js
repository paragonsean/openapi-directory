...
class ErrorResponseError {
     ...
     * @param message {String} Error message indicating why the operation failed.
     */
    constructor(code, message) { 
        
        ErrorResponseError.initialize(this, code, message);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ErrorResponseError.RequiredProperties) {
...
ErrorResponseError.RequiredProperties = ["code", "message"];
