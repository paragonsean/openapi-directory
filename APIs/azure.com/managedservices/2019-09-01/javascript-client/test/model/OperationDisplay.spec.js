...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedServicesClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ManagedServicesClient.OperationDisplay();
      //expect(instance).to.be.a(ManagedServicesClient.OperationDisplay);
    });
