...
OAIFunctionProperties OAIFunction::getProperties() const {
    return m_properties;
}
void OAIFunction::setProperties(const OAIFunctionProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIFunction::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIFunction::is_properties_Valid() const{
...
QString OAIFunction::getType() const {
    return m_type;
}
void OAIFunction::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}
