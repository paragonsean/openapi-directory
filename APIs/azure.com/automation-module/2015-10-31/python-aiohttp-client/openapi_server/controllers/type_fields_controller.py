...
async def fields_list_by_type(request: web.Request, resource_group_name, automation_account_name, module_name, type_name, subscription_id, api_version) -> web.Response:
    """fields_list_by_type
