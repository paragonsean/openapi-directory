...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ApplicationInsightsManagementClient.OperationDisplay();
      //expect(instance).to.be.a(ApplicationInsightsManagementClient.OperationDisplay);
    });
