...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new ApplicationInsightsManagementClient.ErrorResponse();
      //expect(instance).to.be.a(ApplicationInsightsManagementClient.ErrorResponse);
    });
