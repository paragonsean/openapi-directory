...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationInsightsManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ApplicationInsightsManagementClient.Operation();
      //expect(instance).to.be.a(ApplicationInsightsManagementClient.Operation);
    });
