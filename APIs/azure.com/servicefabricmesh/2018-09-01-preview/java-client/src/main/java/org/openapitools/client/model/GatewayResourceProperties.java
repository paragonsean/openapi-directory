...
public class GatewayResourceProperties {
  ...
  public GatewayResourceProperties description(String description) {
  ...
  public GatewayResourceProperties destinationNetwork(NetworkRef destinationNetwork) {
  ...
  public GatewayResourceProperties http(List<HttpConfig> http) {
    this.http = http;
    return this;
  }

  public GatewayResourceProperties addHttpItem(HttpConfig httpItem) {
    if (this.http == null) {
  ...
  public GatewayResourceProperties sourceNetwork(NetworkRef sourceNetwork) {
  ...
  public GatewayResourceProperties status(ResourceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GatewayResourceProperties tcp(List<TcpConfig> tcp) {
    this.tcp = tcp;
    return this;
  }

  public GatewayResourceProperties addTcpItem(TcpConfig tcpItem) {
    if (this.tcp == null) {
  ...
  public boolean equals(Object o) {
    ...
    GatewayResourceProperties gatewayResourceProperties = (GatewayResourceProperties) o;
    return Objects.equals(this.provisioningState, gatewayResourceProperties.provisioningState) &&
        Objects.equals(this.description, gatewayResourceProperties.description) &&
        Objects.equals(this.destinationNetwork, gatewayResourceProperties.destinationNetwork) &&
        Objects.equals(this.http, gatewayResourceProperties.http) &&
        Objects.equals(this.ipAddress, gatewayResourceProperties.ipAddress) &&
        Objects.equals(this.sourceNetwork, gatewayResourceProperties.sourceNetwork) &&
        Objects.equals(this.status, gatewayResourceProperties.status) &&
        Objects.equals(this.statusDetails, gatewayResourceProperties.statusDetails) &&
        Objects.equals(this.tcp, gatewayResourceProperties.tcp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(provisioningState, description, destinationNetwork, http, ipAddress, sourceNetwork, status, statusDetails, tcp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GatewayResourceProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayResourceProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayResourceProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GatewayResourceProperties is not found in the empty JSON string", GatewayResourceProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayResourceProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GatewayResourceProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayResourceProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayResourceProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayResourceProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayResourceProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayResourceProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayResourceProperties>() {
           @Override
           public void write(JsonWriter out, GatewayResourceProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayResourceProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayResourceProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayResourceProperties
   * @throws IOException if the JSON string is invalid with respect to GatewayResourceProperties
   */
  public static GatewayResourceProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayResourceProperties.class);
  }

  /**
   * Convert an instance of GatewayResourceProperties to an JSON string
   *
   * @return JSON string
   */
