...
import org.openapitools.client.model.ErrorErrorModel;
...
public class ErrorModel {
  ...
  private ErrorErrorModel error;

  public ErrorModel() {
  }

  public ErrorModel error(ErrorErrorModel error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorErrorModel getError() {
    return error;
  }

  public void setError(ErrorErrorModel error) {
    this.error = error;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      ErrorErrorModel.validateJsonElement(jsonObj.get("error"));
  }
