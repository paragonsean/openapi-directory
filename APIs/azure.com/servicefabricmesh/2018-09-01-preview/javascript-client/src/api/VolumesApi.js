...
export default class VolumesApi {
    ...
    */
     ...
     */
    volumeCreate(subscriptionId, apiVersion, resourceGroupName, volumeResourceName, volumeResourceDescription, callback) {
      ...
      if (volumeResourceName === undefined || volumeResourceName === null) {
        throw new Error("Missing the required parameter 'volumeResourceName' when calling volumeCreate");
      }
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/volumes/{volumeResourceName}', 'PUT',
     ...
     */
    volumeDelete(subscriptionId, apiVersion, resourceGroupName, volumeResourceName, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
      ...
      // verify the required parameter 'volumeResourceName' is set
      if (volumeResourceName === undefined || volumeResourceName === null) {
        throw new Error("Missing the required parameter 'volumeResourceName' when calling volumeDelete");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/volumes/{volumeResourceName}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/VolumeResourceDescription}
     */
    volumeGet(subscriptionId, apiVersion, resourceGroupName, volumeResourceName, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
      ...
      // verify the required parameter 'volumeResourceName' is set
      if (volumeResourceName === undefined || volumeResourceName === null) {
        throw new Error("Missing the required parameter 'volumeResourceName' when calling volumeGet");
      }
      ...
      let returnType = VolumeResourceDescription;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/volumes/{volumeResourceName}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
