...
class ServiceResourceProperties(Model):
    ...
    def __init__(self, provisioning_state: str=None, code_packages: List[ContainerCodePackageProperties]=None, diagnostics: DiagnosticsRef=None, network_refs: List[NetworkRef]=None, os_type: OperatingSystemType=None, auto_scaling_policies: List[AutoScalingPolicy]=None, description: str=None, health_state: HealthState=None, replica_count: int=None, status: ResourceStatus=None, status_details: str=None, unhealthy_evaluation: str=None):
