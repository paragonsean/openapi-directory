...
class ServiceProperties(Model):
    ...
    def __init__(self, auto_scaling_policies: List[AutoScalingPolicy]=None, description: str=None, health_state: HealthState=None, replica_count: int=None, status: ResourceStatus=None, status_details: str=None, unhealthy_evaluation: str=None):
