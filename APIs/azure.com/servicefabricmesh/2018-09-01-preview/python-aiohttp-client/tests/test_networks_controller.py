...
async def test_network_create(client):
    ...
    """
    network_resource_description = {"properties":{"description":"description","statusDetails":"statusDetails","status":"Unknown"}}
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ServiceFabricMesh/networks/{network_resource_name}'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', network_resource_name='network_resource_name_example'),
        headers=headers,
