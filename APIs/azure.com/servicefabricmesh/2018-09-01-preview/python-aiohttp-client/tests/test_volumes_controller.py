...
async def test_volume_create(client):
    ...
    """
    volume_resource_description = {"properties":{"azureFileParameters":{"accountName":"accountName","shareName":"shareName","accountKey":"accountKey"},"provider":"SFAzureFile","description":"description","statusDetails":"statusDetails","provisioningState":"provisioningState","status":"Unknown"}}
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ServiceFabricMesh/volumes/{volume_resource_name}'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', volume_resource_name='volume_resource_name_example'),
        headers=headers,
