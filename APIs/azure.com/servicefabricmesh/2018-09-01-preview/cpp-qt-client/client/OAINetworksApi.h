...
public:
    ...
    */
    virtual void networkCreate(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &network_resource_name, const OAINetworkResourceDescription &network_resource_description);
    ...
    * @param[in]  network_resource_name QString [required]
    */
    virtual void networkDelete(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &network_resource_name);
    ...
    * @param[in]  network_resource_name QString [required]
    */
    virtual void networkGet(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &network_resource_name);
