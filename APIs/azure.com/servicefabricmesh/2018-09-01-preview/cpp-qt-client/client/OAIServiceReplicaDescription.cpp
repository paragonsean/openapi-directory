...
OAIOperatingSystemType OAIServiceReplicaDescription::getOsType() const {
    return m_os_type;
}
void OAIServiceReplicaDescription::setOsType(const OAIOperatingSystemType &os_type) {
    m_os_type = os_type;
...
bool OAIServiceReplicaDescription::isValid() const {
    ...
    return m_replica_name_isValid && m_code_packages_isValid && m_os_type_isValid && true;
}
