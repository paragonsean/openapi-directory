...
/*
 * OAIGatewayProperties.h
 *
 * Describes properties of a gateway resource.
 */

#ifndef OAIGatewayProperties_H
#define OAIGatewayProperties_H
...
class OAIGatewayProperties : public OAIObject {
public:
    OAIGatewayProperties();
    OAIGatewayProperties(QString json);
    ~OAIGatewayProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGatewayProperties)

#endif // OAIGatewayProperties_H
