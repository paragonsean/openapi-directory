...
OAIVolumeProvider OAIVolumeResourceProperties::getProvider() const {
    return m_provider;
}
void OAIVolumeResourceProperties::setProvider(const OAIVolumeProvider &provider) {
    m_provider = provider;
...
OAIResourceStatus OAIVolumeResourceProperties::getStatus() const {
    return m_status;
}
void OAIVolumeResourceProperties::setStatus(const OAIResourceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVolumeResourceProperties::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVolumeResourceProperties::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIVolumeResourceProperties::getStatusDetails() const {
    return m_status_details;
}
void OAIVolumeResourceProperties::setStatusDetails(const QString &status_details) {
    m_status_details = status_details;
    m_status_details_isSet = true;
}

bool OAIVolumeResourceProperties::is_status_details_Set() const{
    return m_status_details_isSet;
}

bool OAIVolumeResourceProperties::is_status_details_Valid() const{
