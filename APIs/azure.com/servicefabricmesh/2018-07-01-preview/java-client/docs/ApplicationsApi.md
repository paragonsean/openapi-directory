...
|------------- | ------------- | -------------|
| [**applicationCreate**](ApplicationsApi.md#applicationCreate) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationName} | Creates or updates an application resource. |
| [**applicationDelete**](ApplicationsApi.md#applicationDelete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationName} | Deletes the application resource. |
| [**applicationGet**](ApplicationsApi.md#applicationGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationName} | Gets the application resource. |
...
# **applicationCreate**
> ApplicationResourceDescription applicationCreate(subscriptionId, apiVersion, resourceGroupName, applicationName, applicationResourceDescription)
...
# **applicationDelete**
> applicationDelete(subscriptionId, apiVersion, resourceGroupName, applicationName)
...
public class Example {
  public static void main(String[] args) {
    ...
    String applicationName = "applicationName_example"; // String | The identity of the application.
    try {
      apiInstance.applicationDelete(subscriptionId, apiVersion, resourceGroupName, applicationName);
    } catch (ApiException e) {
...
# **applicationGet**
> ApplicationResourceDescription applicationGet(subscriptionId, apiVersion, resourceGroupName, applicationName)
...
public class Example {
  public static void main(String[] args) {
    ...
    String applicationName = "applicationName_example"; // String | The identity of the application.
    try {
      ApplicationResourceDescription result = apiInstance.applicationGet(subscriptionId, apiVersion, resourceGroupName, applicationName);
      System.out.println(result);
    } catch (ApiException e) {
