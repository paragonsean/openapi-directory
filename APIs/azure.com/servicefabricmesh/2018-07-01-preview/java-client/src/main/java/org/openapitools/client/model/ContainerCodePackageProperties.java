...
public class ContainerCodePackageProperties {
  ...
  private List<ContainerVolume> volumeRefs = new ArrayList<>();
  ...
  public ContainerCodePackageProperties volumeRefs(List<ContainerVolume> volumeRefs) {
    this.volumeRefs = volumeRefs;
    return this;
  }

  public ContainerCodePackageProperties addVolumeRefsItem(ContainerVolume volumeRefsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ContainerVolume> getVolumeRefs() {
    return volumeRefs;
  }

  public void setVolumeRefs(List<ContainerVolume> volumeRefs) {
    this.volumeRefs = volumeRefs;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commands, diagnostics, endpoints, entrypoint, environmentVariables, image, imageRegistryCredential, instanceView, labels, name, resources, settings, volumeRefs);
  }
      ...
      if (jsonObj.get("volumeRefs") != null && !jsonObj.get("volumeRefs").isJsonNull()) {
        ...
        if (jsonArrayvolumeRefs != null) {
          ...
          for (int i = 0; i < jsonArrayvolumeRefs.size(); i++) {
            ContainerVolume.validateJsonElement(jsonArrayvolumeRefs.get(i));
          };
        }
      }
  }
