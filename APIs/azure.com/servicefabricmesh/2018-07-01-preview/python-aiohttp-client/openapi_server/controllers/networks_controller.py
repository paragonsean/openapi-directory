...
async def network_create(request: web.Request, subscription_id, api_version, resource_group_name, network_name, network_resource_description) -> web.Response:
...
async def network_delete(request: web.Request, subscription_id, api_version, resource_group_name, network_name) -> web.Response:
...
async def network_get(request: web.Request, subscription_id, api_version, resource_group_name, network_name) -> web.Response:
