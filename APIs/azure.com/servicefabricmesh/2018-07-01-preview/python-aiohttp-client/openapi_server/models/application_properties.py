...
class ApplicationProperties(Model):
    ...
    def __init__(self, debug_params: str=None, description: str=None, diagnostics: DiagnosticsDescription=None, health_state: HealthState=None, service_names: List[str]=None, services: List[ServiceResourceDescription]=None, status: str=None, status_details: str=None, unhealthy_evaluation: str=None):
