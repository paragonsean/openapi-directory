...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeaBreezeManagementClient.Layer4IngressConfig();
  });
  ...
  describe('Layer4IngressConfig', function() {
    it('should create an instance of Layer4IngressConfig', function() {
      // uncomment below and update the code to test Layer4IngressConfig
      //var instance = new SeaBreezeManagementClient.Layer4IngressConfig();
      //expect(instance).to.be.a(SeaBreezeManagementClient.Layer4IngressConfig);
    });
