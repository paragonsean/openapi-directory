...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeaBreezeManagementClient.OperationResult();
  });
  ...
  describe('OperationResult', function() {
    it('should create an instance of OperationResult', function() {
      ...
      //var instance = new SeaBreezeManagementClient.OperationResult();
      //expect(instance).to.be.a(SeaBreezeManagementClient.OperationResult);
    });
