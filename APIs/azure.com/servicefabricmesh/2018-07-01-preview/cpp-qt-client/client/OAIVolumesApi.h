...
public:
    ...
    */
    virtual void volumeCreate(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &volume_name, const OAIVolumeResourceDescription &volume_resource_description);
    ...
    * @param[in]  volume_name QString [required]
    */
    virtual void volumeDelete(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &volume_name);
    ...
    * @param[in]  volume_name QString [required]
    */
    virtual void volumeGet(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &volume_name);
