...
QString OAIServiceResourceProperties::getOsType() const {
    return m_os_type;
}
void OAIServiceResourceProperties::setOsType(const QString &os_type) {
    m_os_type = os_type;
...
QString OAIServiceResourceProperties::getStatus() const {
    return m_status;
}
void OAIServiceResourceProperties::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}
