...
/*
 * OAIContainerVolume.h
 *
 * Describes how a volume is attached to a container.
 */

#ifndef OAIContainerVolume_H
#define OAIContainerVolume_H
...
class OAIContainerVolume : public OAIObject {
public:
    OAIContainerVolume();
    OAIContainerVolume(QString json);
    ~OAIContainerVolume() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainerVolume)

#endif // OAIContainerVolume_H
