...
public:
    ...
    */
    virtual void applicationCreate(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &application_name, const OAIApplicationResourceDescription &application_resource_description);
    ...
    * @param[in]  application_name QString [required]
    */
    virtual void applicationDelete(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &application_name);
    ...
    * @param[in]  application_name QString [required]
    */
    virtual void applicationGet(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &application_name);
