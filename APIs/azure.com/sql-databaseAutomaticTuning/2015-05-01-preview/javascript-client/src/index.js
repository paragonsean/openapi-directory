...
import AutomaticTuningOptions from './model/AutomaticTuningOptions';
import DatabaseAutomaticTuning from './model/DatabaseAutomaticTuning';
import DatabaseAutomaticTuningProperties from './model/DatabaseAutomaticTuningProperties';
import DatabaseAutomaticTuningApi from './api/DatabaseAutomaticTuningApi';
...
export {
    ...
    /**
     * The AutomaticTuningOptions model constructor.
     * @property {module:model/AutomaticTuningOptions}
     */
    AutomaticTuningOptions,

    /**
     * The DatabaseAutomaticTuning model constructor.
     * @property {module:model/DatabaseAutomaticTuning}
     */
    DatabaseAutomaticTuning,

    /**
     * The DatabaseAutomaticTuningProperties model constructor.
     * @property {module:model/DatabaseAutomaticTuningProperties}
     */
    DatabaseAutomaticTuningProperties,

    /**
    * The DatabaseAutomaticTuningApi service constructor.
    * @property {module:api/DatabaseAutomaticTuningApi}
    */
