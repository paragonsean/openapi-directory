...
Q_SIGNALS:
    ...
    void operationsListSignal(QList<OAIOperation> summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, QList<OAIOperation> summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(QList<OAIOperation> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(QList<OAIOperation> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
