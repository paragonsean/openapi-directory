...
OAIServiceSpecification OAIProperties::getServiceSpecification() const {
    return m_service_specification;
}
void OAIProperties::setServiceSpecification(const OAIServiceSpecification &service_specification) {
    m_service_specification = service_specification;
    m_service_specification_isSet = true;
}

bool OAIProperties::is_service_specification_Set() const{
    return m_service_specification_isSet;
}

bool OAIProperties::is_service_specification_Valid() const{
