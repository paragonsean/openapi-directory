...
public class OperationsApi {
    ...
    public okhttp3.Call operationsListCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.DynamicsTelemetry/operations";
     ...
     */
    public List<Operation> operationsList() throws ApiException {
        ApiResponse<List<Operation>> localVarResp = operationsListWithHttpInfo();
     ...
     */
    public ApiResponse<List<Operation>> operationsListWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call operationsListAsync(final ApiCallback<List<Operation>> _callback) throws ApiException {
