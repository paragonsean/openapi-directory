...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new NetworkManagementClient.OperationDisplay();
      //expect(instance).to.be.a(NetworkManagementClient.OperationDisplay);
    });
