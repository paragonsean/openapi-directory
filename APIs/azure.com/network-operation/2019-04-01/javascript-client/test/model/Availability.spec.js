...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.Availability();
  });
  ...
  describe('Availability', function() {
    it('should create an instance of Availability', function() {
      ...
      //var instance = new NetworkManagementClient.Availability();
      //expect(instance).to.be.a(NetworkManagementClient.Availability);
    });
