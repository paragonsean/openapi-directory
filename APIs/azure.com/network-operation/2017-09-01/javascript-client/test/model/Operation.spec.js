...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new NetworkManagementClient.Operation();
      //expect(instance).to.be.a(NetworkManagementClient.Operation);
    });
