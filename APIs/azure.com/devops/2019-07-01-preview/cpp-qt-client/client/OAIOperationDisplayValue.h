...
/*
 * OAIOperationDisplayValue.h
 *
 * Display information of an operation.
 */

#ifndef OAIOperationDisplayValue_H
#define OAIOperationDisplayValue_H
...
class OAIOperationDisplayValue : public OAIObject {
public:
    OAIOperationDisplayValue();
    OAIOperationDisplayValue(QString json);
    ~OAIOperationDisplayValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOperationDisplayValue)

#endif // OAIOperationDisplayValue_H
