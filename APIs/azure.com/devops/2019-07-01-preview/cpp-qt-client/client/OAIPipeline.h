...
public:
    ...
    OAIPipelineProperties getProperties() const;
    void setProperties(const OAIPipelineProperties &properties);
...
private:
    ...
    OAIPipelineProperties m_properties;
