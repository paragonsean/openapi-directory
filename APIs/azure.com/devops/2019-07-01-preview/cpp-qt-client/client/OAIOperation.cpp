...
OAIOperationDisplayValue OAIOperation::getDisplay() const {
    return m_display;
}
void OAIOperation::setDisplay(const OAIOperationDisplayValue &display) {
    m_display = display;
...
QString OAIOperation::getIsDataAction() const {
    return m_is_data_action;
}
void OAIOperation::setIsDataAction(const QString &is_data_action) {
    m_is_data_action = is_data_action;
    m_is_data_action_isSet = true;
}

bool OAIOperation::is_is_data_action_Set() const{
    return m_is_data_action_isSet;
}

bool OAIOperation::is_is_data_action_Valid() const{
