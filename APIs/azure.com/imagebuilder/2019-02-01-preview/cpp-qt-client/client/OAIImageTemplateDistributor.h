...
/*
 * OAIImageTemplateDistributor.h
 *
 * Generic distribution object
 */

#ifndef OAIImageTemplateDistributor_H
#define OAIImageTemplateDistributor_H
...
class OAIImageTemplateDistributor : public OAIObject {
public:
    OAIImageTemplateDistributor();
    OAIImageTemplateDistributor(QString json);
    ~OAIImageTemplateDistributor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageTemplateDistributor)

#endif // OAIImageTemplateDistributor_H
