...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VirtualMachineImageTemplate.ApiError();
  });
  ...
  describe('ApiError', function() {
    it('should create an instance of ApiError', function() {
      ...
      //var instance = new VirtualMachineImageTemplate.ApiError();
      //expect(instance).to.be.a(VirtualMachineImageTemplate.ApiError);
    });
