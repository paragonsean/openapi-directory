...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VirtualMachineImageTemplate.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new VirtualMachineImageTemplate.Operation();
      //expect(instance).to.be.a(VirtualMachineImageTemplate.Operation);
    });
