...
public class ApiError {
  ...
  private List<ApiErrorBase> details = new ArrayList<>();
  ...
  public ApiError details(List<ApiErrorBase> details) {
    this.details = details;
    return this;
  }

  public ApiError addDetailsItem(ApiErrorBase detailsItem) {
  ...
  public ApiError innerError(InnerError innerError) {
  ...
  public ApiError target(String target) {
    this.target = target;
    return this;
  }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            ApiErrorBase.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
