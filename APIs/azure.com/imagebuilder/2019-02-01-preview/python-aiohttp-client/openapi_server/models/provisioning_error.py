...
class ProvisioningError(Model):
    ...
    def provisioning_error_code(self, provisioning_error_code):
        ...
        """
        allowed_values = ["BadSourceType", "BadPIRSource", "BadISOSource", "BadManagedImageSource", "BadCustomizerType", "UnsupportedCustomizerType", "NoCustomizerScript", "BadDistributeType", "BadSharedImageDistribute", "ServerError", "Other"]  # noqa: E501
