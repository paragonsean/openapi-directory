...
/*
 * OAIImageTemplateVhdDistributor.h
 *
 * Distribute via VHD in a storage account.
 */

#ifndef OAIImageTemplateVhdDistributor_H
#define OAIImageTemplateVhdDistributor_H
...
class OAIImageTemplateVhdDistributor : public OAIObject {
public:
    OAIImageTemplateVhdDistributor();
    OAIImageTemplateVhdDistributor(QString json);
    ~OAIImageTemplateVhdDistributor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageTemplateVhdDistributor)

#endif // OAIImageTemplateVhdDistributor_H
