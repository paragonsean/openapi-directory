...
class ImageTemplateShellCustomizer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptUri')) {
                obj['scriptUri'] = ApiClient.convertToType(data['scriptUri'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['scriptUri'] && !(typeof data['scriptUri'] === 'string' || data['scriptUri'] instanceof String)) {
            throw new Error("Expected the field `scriptUri` to be a primitive type in the JSON string but got " + data['scriptUri']);
        }
        // ensure the json data is a string
 ...
 */
ImageTemplateShellCustomizer.prototype['inline'] = undefined;

/**
 * URI of the shell script to be run for customizing. It can be a github link, SAS URI for Azure Storage, etc
 * @member {String} scriptUri
 */
ImageTemplateShellCustomizer.prototype['scriptUri'] = undefined;

/**
 * SHA256 checksum of the shell script provided in the scriptUri field
 * @member {String} sha256Checksum
 */
ImageTemplateShellCustomizer.prototype['sha256Checksum'] = undefined;
