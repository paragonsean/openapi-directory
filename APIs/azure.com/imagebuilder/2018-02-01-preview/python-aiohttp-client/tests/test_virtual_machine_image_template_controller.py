...
async def test_virtual_machine_image_template_create_or_update(client):
    """Test case for virtual_machine_image_template_create_or_update

    
    """
    parameters = {"properties":{"provisioningError":{"provisioningErrorCode":"BadSourceType","message":"message"},"lastRunStatus":{"runSubState":"queued","startTime":"2000-01-23T04:56:07.000+00:00","endTime":"2000-01-23T04:56:07.000+00:00","message":"message","runState":"ready"},"distribute":[{"artifactTags":{"key":"artifactTags"},"runOutputName":"runOutputName","type":"type"},{"artifactTags":{"key":"artifactTags"},"runOutputName":"runOutputName","type":"type"}],"provisioningState":"Creating","source":{"type":"type"},"customize":[{"name":"name","type":"type"},{"name":"name","type":"type"}]}}
...
async def test_virtual_machine_image_template_delete(client):
...
async def test_virtual_machine_image_template_get(client):
...
async def test_virtual_machine_image_template_get_run_output(client):
...
async def test_virtual_machine_image_template_list(client):
...
async def test_virtual_machine_image_template_list_by_resource_group(client):
...
async def test_virtual_machine_image_template_list_run_outputs(client):
...
async def test_virtual_machine_image_template_run(client):
...
async def test_virtual_machine_image_template_update(client):
