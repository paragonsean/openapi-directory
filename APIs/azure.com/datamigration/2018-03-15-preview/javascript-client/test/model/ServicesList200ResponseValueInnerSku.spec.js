...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDataMigrationServiceResourceProvider.ServicesList200ResponseValueInnerSku();
  });
  ...
  describe('ServicesList200ResponseValueInnerSku', function() {
    it('should create an instance of ServicesList200ResponseValueInnerSku', function() {
      // uncomment below and update the code to test ServicesList200ResponseValueInnerSku
      //var instance = new AzureDataMigrationServiceResourceProvider.ServicesList200ResponseValueInnerSku();
      //expect(instance).to.be.a(AzureDataMigrationServiceResourceProvider.ServicesList200ResponseValueInnerSku);
    });
