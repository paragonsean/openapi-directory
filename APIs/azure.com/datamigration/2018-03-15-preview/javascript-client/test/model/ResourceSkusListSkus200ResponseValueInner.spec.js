...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDataMigrationServiceResourceProvider.ResourceSkusListSkus200ResponseValueInner();
  });
  ...
  describe('ResourceSkusListSkus200ResponseValueInner', function() {
    it('should create an instance of ResourceSkusListSkus200ResponseValueInner', function() {
      // uncomment below and update the code to test ResourceSkusListSkus200ResponseValueInner
      //var instance = new AzureDataMigrationServiceResourceProvider.ResourceSkusListSkus200ResponseValueInner();
      //expect(instance).to.be.a(AzureDataMigrationServiceResourceProvider.ResourceSkusListSkus200ResponseValueInner);
    });
