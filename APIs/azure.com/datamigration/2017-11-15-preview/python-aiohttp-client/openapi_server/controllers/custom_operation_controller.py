...
async def services_check_children_name_availability(request: web.Request, subscription_id, group_name, api_version, service_name, parameters) -> web.Response:
...
async def services_check_status_0(request: web.Request, subscription_id, group_name, service_name, api_version) -> web.Response:
...
async def services_start_0(request: web.Request, subscription_id, group_name, service_name, api_version) -> web.Response:
    """Start service
...
async def services_stop_0(request: web.Request, subscription_id, group_name, service_name, api_version) -> web.Response:
    """Stop service
...
async def tasks_cancel_0(request: web.Request, subscription_id, group_name, service_name, project_name, task_name, api_version) -> web.Response:
    """Cancel a task
