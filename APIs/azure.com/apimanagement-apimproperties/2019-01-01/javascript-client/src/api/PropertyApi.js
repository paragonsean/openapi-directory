...
export default class PropertyApi {
    ...
    */
     ...
     * @param {module:model/PropertyGet200Response} data The data returned by the service call.
     ...
     * @param {module:model/PropertyGet200Response} parameters Create parameters.
     ...
     * data is of type: {@link module:model/PropertyGet200Response}
     */
    propertyCreateOrUpdate(resourceGroupName, serviceName, propId, apiVersion, subscriptionId, parameters, opts, callback) {
      ...
      let returnType = PropertyGet200Response;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PropertyListByService200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {Object} opts Optional parameters
     * @param {String} [filter] |   Field     |     Usage     |     Supported operators     |     Supported functions     |</br>|-------------|-------------|-------------|-------------|</br>| tags | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith, any, all | </br>| displayName | filter | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith | </br>
     ...
     * data is of type: {@link module:model/PropertyListByService200Response}
     */
    propertyListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PropertyListByService200Response;
      return this.apiClient.callApi(
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/PropertyUpdateRequest} parameters Update parameters.
