...
public:
    ...
    */
    virtual void propertyCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &prop_id, const QString &api_version, const QString &subscription_id, const OAIPropertyContract &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void propertyListByServiceSignal(OAIPropertyCollection summary);
    ...
    void propertyListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIPropertyCollection summary);
    ...
    void propertyListByServiceSignalE(OAIPropertyCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void propertyListByServiceSignalError(OAIPropertyCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
