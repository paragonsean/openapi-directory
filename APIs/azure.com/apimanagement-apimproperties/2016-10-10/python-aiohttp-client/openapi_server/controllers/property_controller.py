...
async def properties_list_by_service(request: web.Request, resource_group_name, service_name, api_version, subscription_id, filter=None, top=None, skip=None) -> web.Response:
...
async def property_create_or_update(request: web.Request, resource_group_name, service_name, prop_id, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = PropertyCreateParameters.from_dict(parameters)
    return web.Response(status=200)
