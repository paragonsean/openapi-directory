...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.PropertyCollection();
  });
  ...
  describe('PropertyCollection', function() {
    it('should create an instance of PropertyCollection', function() {
      // uncomment below and update the code to test PropertyCollection
      //var instance = new ApiManagementClient.PropertyCollection();
      //expect(instance).to.be.a(ApiManagementClient.PropertyCollection);
    });
