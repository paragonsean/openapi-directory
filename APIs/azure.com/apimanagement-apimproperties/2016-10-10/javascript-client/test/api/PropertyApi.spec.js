...
(function(root, factory) {
  ...
  describe('PropertyApi', function() {
    describe('propertiesListByService', function() {
      it('should call propertiesListByService successfully', function(done) {
        //uncomment below and update the code to test propertiesListByService
        //instance.propertiesListByService(function(error) {
