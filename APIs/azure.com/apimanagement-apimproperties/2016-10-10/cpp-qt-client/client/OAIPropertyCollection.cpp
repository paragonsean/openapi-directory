...
qint64 OAIPropertyCollection::getCount() const {
    return m_count;
}
void OAIPropertyCollection::setCount(const qint64 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIPropertyCollection::is_count_Set() const{
    return m_count_isSet;
}

bool OAIPropertyCollection::is_count_Valid() const{
