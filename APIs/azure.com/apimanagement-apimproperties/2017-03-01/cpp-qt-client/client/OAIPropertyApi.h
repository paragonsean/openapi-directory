...
public:
    ...
    * @param[in]  parameters OAIPropertyContract [required]
    */
    virtual void propertyCreateOrUpdate(const QString &prop_id, const QString &api_version, const OAIPropertyContract &parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void propertyDelete(const QString &prop_id, const QString &if_match, const QString &api_version);

    /**
    * @param[in]  prop_id QString [required]
    * @param[in]  api_version QString [required]
    */
    virtual void propertyGet(const QString &prop_id, const QString &api_version);
    ...
    */
    virtual void propertyList(const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &skip = ::OpenAPI::OptionalParam<qint32>());
    ...
    */
    virtual void propertyUpdate(const QString &prop_id, const QString &if_match, const QString &api_version, const OAIPropertyUpdateParameters &parameters);
...
private:
    ...
    void propertyListCallback(OAIHttpRequestWorker *worker);
    void propertyUpdateCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void propertyCreateOrUpdateSignal(OAIPropertyContract summary);
    void propertyDeleteSignal();
    void propertyGetSignal(OAIPropertyContract summary);
    void propertyListSignal(OAIPropertyCollection summary);
    void propertyUpdateSignal();


    void propertyCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIPropertyContract summary);
    ...
    void propertyListSignalFull(OAIHttpRequestWorker *worker, OAIPropertyCollection summary);
    ...
    void propertyCreateOrUpdateSignalE(OAIPropertyContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void propertyCreateOrUpdateSignalError(OAIPropertyContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use propertyListSignalError() instead")
    void propertyListSignalE(OAIPropertyCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void propertyListSignalError(OAIPropertyCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use propertyListSignalErrorFull() instead")
    void propertyListSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void propertyListSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
