...
export default class PropertyApi {
    ...
    */
     ...
     */
    propertyCreateOrUpdate(propId, apiVersion, parameters, callback) {
     ...
     */
    propertyDelete(propId, ifMatch, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'propId' is set
      if (propId === undefined || propId === null) {
     ...
     * data is of type: {@link module:model/PropertyContract}
     */
    propertyGet(propId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'propId' is set
      if (propId === undefined || propId === null) {
    ...
    /**
     * Callback function to receive the result of the propertyList operation.
     * @callback module:api/PropertyApi~propertyListCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PropertyApi~propertyListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PropertyCollection}
     */
    propertyList(apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling propertyList");
      }
     ...
     */
    propertyUpdate(propId, ifMatch, apiVersion, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'propId' is set
      if (propId === undefined || propId === null) {
