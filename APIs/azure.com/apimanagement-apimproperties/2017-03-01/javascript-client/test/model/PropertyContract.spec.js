...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.PropertyContract();
  });
  ...
  describe('PropertyContract', function() {
    it('should create an instance of PropertyContract', function() {
      // uncomment below and update the code to test PropertyContract
      //var instance = new ApiManagementClient.PropertyContract();
      //expect(instance).to.be.a(ApiManagementClient.PropertyContract);
    });
