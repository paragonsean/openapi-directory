...
public:
    ...
    */
    virtual void privateEndpointConnectionsCreateOrUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &scope_name, const QString &private_endpoint_connection_name, const OAIPrivateEndpointConnection &parameters);
    ...
    * @param[in]  private_endpoint_connection_name QString [required]
    */
    virtual void privateEndpointConnectionsDelete(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &scope_name, const QString &private_endpoint_connection_name);
    ...
    * @param[in]  private_endpoint_connection_name QString [required]
    */
    virtual void privateEndpointConnectionsGet(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &scope_name, const QString &private_endpoint_connection_name);
    ...
    * @param[in]  scope_name QString [required]
    */
    virtual void privateEndpointConnectionsListByPrivateLinkScope(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &scope_name);
...
private:
    ...
    void privateEndpointConnectionsListByPrivateLinkScopeCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void privateEndpointConnectionsListByPrivateLinkScopeSignal(OAIPrivateEndpointConnectionListResult summary);
    ...
    void privateEndpointConnectionsListByPrivateLinkScopeSignalFull(OAIHttpRequestWorker *worker, OAIPrivateEndpointConnectionListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use privateEndpointConnectionsListByPrivateLinkScopeSignalError() instead")
    void privateEndpointConnectionsListByPrivateLinkScopeSignalE(OAIPrivateEndpointConnectionListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void privateEndpointConnectionsListByPrivateLinkScopeSignalError(OAIPrivateEndpointConnectionListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use privateEndpointConnectionsListByPrivateLinkScopeSignalErrorFull() instead")
    void privateEndpointConnectionsListByPrivateLinkScopeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void privateEndpointConnectionsListByPrivateLinkScopeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
