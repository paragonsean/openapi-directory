...
QMap<QString, QString> OAIPrivateEndpointConnection::getTags() const {
    return m_tags;
}
void OAIPrivateEndpointConnection::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPrivateEndpointConnection::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPrivateEndpointConnection::is_tags_Valid() const{
