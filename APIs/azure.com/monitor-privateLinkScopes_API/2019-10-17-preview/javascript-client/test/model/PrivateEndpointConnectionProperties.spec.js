...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMonitorPrivateLinkScopes.PrivateEndpointConnectionProperties();
  });
  ...
  describe('PrivateEndpointConnectionProperties', function() {
    it('should create an instance of PrivateEndpointConnectionProperties', function() {
      ...
      //var instance = new AzureMonitorPrivateLinkScopes.PrivateEndpointConnectionProperties();
      //expect(instance).to.be.a(AzureMonitorPrivateLinkScopes.PrivateEndpointConnectionProperties);
    });
