...
public class RegisteredServerProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentVersion, clusterId, clusterName, discoveryEndpointUri, friendlyName, lastHeartBeat, lastOperationName, lastWorkflowId, managementEndpointUri, provisioningState, resourceLocation, serverCertificate, serverId, serverManagementtErrorCode, serverOSVersion, serverRole, serviceLocation, storageSyncServiceUid);
  }
