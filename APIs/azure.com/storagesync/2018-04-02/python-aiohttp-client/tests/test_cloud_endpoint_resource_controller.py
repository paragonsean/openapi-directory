...
async def test_cloud_endpoints_create(client):
    ...
    """
    parameters = {"location":"location","properties":{"storageAccountTenantId":"storageAccountTenantId","storageAccountShareName":"storageAccountShareName","storageAccountResourceId":"storageAccountResourceId"},"tags":{"key":"tags"}}
