...
async def test_registered_servers_create(client):
    ...
    """
    parameters = {"properties":{"lastHeartBeat":"lastHeartBeat","serverRole":"serverRole","serverCertificate":"serverCertificate","clusterName":"clusterName","agentVersion":"agentVersion","serverOSVersion":"serverOSVersion","clusterId":"clusterId","serverId":"serverId","friendlyName":"friendlyName"}}
...
async def test_registered_servers_trigger_rollover(client):
    """Test case for registered_servers_trigger_rollover
