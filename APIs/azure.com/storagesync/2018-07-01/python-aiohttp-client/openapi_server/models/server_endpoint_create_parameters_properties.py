...
class ServerEndpointCreateParametersProperties(Model):
    ...
    def __init__(self, cloud_tiering: FeatureStatus=None, friendly_name: str=None, server_local_path: str=None, server_resource_id: str=None, tier_files_older_than_days: int=None, volume_free_space_percent: int=None):
