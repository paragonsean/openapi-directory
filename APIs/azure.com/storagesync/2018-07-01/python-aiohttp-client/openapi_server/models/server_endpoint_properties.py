...
class ServerEndpointProperties(Model):
    ...
    def __init__(self, cloud_tiering: FeatureStatus=None, friendly_name: str=None, last_operation_name: str=None, last_workflow_id: str=None, provisioning_state: str=None, server_local_path: str=None, server_resource_id: str=None, sync_status: object=None, tier_files_older_than_days: int=None, volume_free_space_percent: int=None):
