...
public:
    ...
    qint32 getServerManagementtErrorCode() const;
    void setServerManagementtErrorCode(const qint32 &server_managementt_error_code);
    bool is_server_managementt_error_code_Set() const;
    bool is_server_managementt_error_code_Valid() const;
...
private:
    ...
    qint32 m_server_managementt_error_code;
    bool m_server_managementt_error_code_isSet;
    bool m_server_managementt_error_code_isValid;
