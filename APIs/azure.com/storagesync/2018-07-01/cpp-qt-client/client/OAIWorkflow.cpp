...
OAIWorkflowProperties OAIWorkflow::getProperties() const {
    return m_properties;
}
void OAIWorkflow::setProperties(const OAIWorkflowProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIWorkflow::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIWorkflow::is_properties_Valid() const{
...
QString OAIWorkflow::getType() const {
    return m_type;
}
void OAIWorkflow::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIWorkflow::is_type_Set() const{
    return m_type_isSet;
}

bool OAIWorkflow::is_type_Valid() const{
