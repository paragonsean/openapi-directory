...
public class ServerEndpointProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cloudTiering, friendlyName, lastOperationName, lastWorkflowId, provisioningState, serverLocalPath, serverResourceId, syncStatus, tierFilesOlderThanDays, volumeFreeSpacePercent);
  }
