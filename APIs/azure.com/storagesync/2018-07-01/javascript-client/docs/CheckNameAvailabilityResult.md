# MicrosoftStorageSync.CheckNameAvailabilityResult
...
**reason** | **String** | Gets the reason that a Storage Sync Service name could not be used. The Reason element is only returned if NameAvailable is false. | [optional] [readonly] 
