...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftStorageSync.ServerEndpointHealth();
  });
  ...
  describe('ServerEndpointHealth', function() {
    it('should create an instance of ServerEndpointHealth', function() {
      // uncomment below and update the code to test ServerEndpointHealth
      //var instance = new MicrosoftStorageSync.ServerEndpointHealth();
      //expect(instance).to.be.a(MicrosoftStorageSync.ServerEndpointHealth);
    });
