...
* @module api/ResourceProviderApi
* @version 2018-10-01
*/
export default class ResourceProviderApi {

    /**
    * Constructs a new ResourceProviderApi. 
    * @alias module:api/ResourceProviderApi
    * @class
    ...
    */
     ...
     * @callback module:api/ResourceProviderApi~operationsListCallback
     ...
     * @param {module:api/ResourceProviderApi~operationsListCallback} callback The callback function, accepting three arguments: error, data, response
