...
public class ServerEndpointProperties {
  ...
  public ServerEndpointProperties syncStatus(ServerEndpointHealth syncStatus) {
   ...
   */
  @javax.annotation.Nullable
  public ServerEndpointHealth getSyncStatus() {
    return syncStatus;
  }

  public void setSyncStatus(ServerEndpointHealth syncStatus) {
    this.syncStatus = syncStatus;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("syncStatus") != null && !jsonObj.get("syncStatus").isJsonNull()) {
        ServerEndpointHealth.validateJsonElement(jsonObj.get("syncStatus"));
      }
  }
