...
async def test_cloud_endpoints_create(client):
    ...
    """
    parameters = {"properties":{"storageAccountTenantId":"storageAccountTenantId","storageAccountShareName":"storageAccountShareName","storageAccountResourceId":"storageAccountResourceId"}}
