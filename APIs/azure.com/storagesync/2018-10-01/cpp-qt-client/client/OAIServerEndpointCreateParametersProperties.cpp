...
OAIFeatureStatus OAIServerEndpointCreateParametersProperties::getOfflineDataTransfer() const {
    return m_offline_data_transfer;
}
void OAIServerEndpointCreateParametersProperties::setOfflineDataTransfer(const OAIFeatureStatus &offline_data_transfer) {
    m_offline_data_transfer = offline_data_transfer;
    m_offline_data_transfer_isSet = true;
}

bool OAIServerEndpointCreateParametersProperties::is_offline_data_transfer_Set() const{
    return m_offline_data_transfer_isSet;
}

bool OAIServerEndpointCreateParametersProperties::is_offline_data_transfer_Valid() const{
    return m_offline_data_transfer_isValid;
}

QString OAIServerEndpointCreateParametersProperties::getOfflineDataTransferShareName() const {
    return m_offline_data_transfer_share_name;
}
void OAIServerEndpointCreateParametersProperties::setOfflineDataTransferShareName(const QString &offline_data_transfer_share_name) {
    m_offline_data_transfer_share_name = offline_data_transfer_share_name;
    m_offline_data_transfer_share_name_isSet = true;
}

bool OAIServerEndpointCreateParametersProperties::is_offline_data_transfer_share_name_Set() const{
    return m_offline_data_transfer_share_name_isSet;
}

bool OAIServerEndpointCreateParametersProperties::is_offline_data_transfer_share_name_Valid() const{
