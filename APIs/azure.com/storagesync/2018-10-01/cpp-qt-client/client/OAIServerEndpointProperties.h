...
public:
    ...
    OAIServerEndpointHealth getSyncStatus() const;
    void setSyncStatus(const OAIServerEndpointHealth &sync_status);
...
private:
    ...
    OAIServerEndpointHealth m_sync_status;
