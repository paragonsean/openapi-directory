...
/*
 * OAIServerEndpointSyncActivityStatus.h
 *
 * Sync Session status object.
 */

#ifndef OAIServerEndpointSyncActivityStatus_H
#define OAIServerEndpointSyncActivityStatus_H
...
class OAIServerEndpointSyncActivityStatus : public OAIObject {
public:
    OAIServerEndpointSyncActivityStatus();
    OAIServerEndpointSyncActivityStatus(QString json);
    ~OAIServerEndpointSyncActivityStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerEndpointSyncActivityStatus)

#endif // OAIServerEndpointSyncActivityStatus_H
