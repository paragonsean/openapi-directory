...
namespace OpenAPI {
class OAIServerEndpointSyncActivityStatus;
class OAIServerEndpointSyncSessionStatus;
...
public:
    ...
    OAIServerEndpointSyncHealthState getCombinedHealth() const;
    void setCombinedHealth(const OAIServerEndpointSyncHealthState &combined_health);
    bool is_combined_health_Set() const;
    bool is_combined_health_Valid() const;

    OAIServerEndpointSyncActivityStatus getDownloadActivity() const;
    void setDownloadActivity(const OAIServerEndpointSyncActivityStatus &download_activity);
    bool is_download_activity_Set() const;
    bool is_download_activity_Valid() const;

    OAIServerEndpointSyncHealthState getDownloadHealth() const;
    void setDownloadHealth(const OAIServerEndpointSyncHealthState &download_health);
    bool is_download_health_Set() const;
    bool is_download_health_Valid() const;

    OAIServerEndpointSyncSessionStatus getDownloadStatus() const;
    void setDownloadStatus(const OAIServerEndpointSyncSessionStatus &download_status);
    ...
    OAIServerEndpointOfflineDataTransferState getOfflineDataTransferStatus() const;
    void setOfflineDataTransferStatus(const OAIServerEndpointOfflineDataTransferState &offline_data_transfer_status);
    bool is_offline_data_transfer_status_Set() const;
    bool is_offline_data_transfer_status_Valid() const;

    OAIServerEndpointSyncActivityState getSyncActivity() const;
    void setSyncActivity(const OAIServerEndpointSyncActivityState &sync_activity);
    ...
    OAIServerEndpointSyncActivityStatus getUploadActivity() const;
    void setUploadActivity(const OAIServerEndpointSyncActivityStatus &upload_activity);
    bool is_upload_activity_Set() const;
    bool is_upload_activity_Valid() const;

    OAIServerEndpointSyncHealthState getUploadHealth() const;
    void setUploadHealth(const OAIServerEndpointSyncHealthState &upload_health);
    bool is_upload_health_Set() const;
    bool is_upload_health_Valid() const;

    OAIServerEndpointSyncSessionStatus getUploadStatus() const;
    void setUploadStatus(const OAIServerEndpointSyncSessionStatus &upload_status);
...
private:
    ...
    OAIServerEndpointSyncHealthState m_combined_health;
    bool m_combined_health_isSet;
    bool m_combined_health_isValid;

    OAIServerEndpointSyncActivityStatus m_download_activity;
    bool m_download_activity_isSet;
    bool m_download_activity_isValid;

    OAIServerEndpointSyncHealthState m_download_health;
    bool m_download_health_isSet;
    bool m_download_health_isValid;

    OAIServerEndpointSyncSessionStatus m_download_status;
    ...
    OAIServerEndpointOfflineDataTransferState m_offline_data_transfer_status;
    bool m_offline_data_transfer_status_isSet;
    bool m_offline_data_transfer_status_isValid;

    OAIServerEndpointSyncActivityState m_sync_activity;
    ...
    OAIServerEndpointSyncActivityStatus m_upload_activity;
    bool m_upload_activity_isSet;
    bool m_upload_activity_isValid;

    OAIServerEndpointSyncHealthState m_upload_health;
    bool m_upload_health_isSet;
    bool m_upload_health_isValid;

    OAIServerEndpointSyncSessionStatus m_upload_status;
