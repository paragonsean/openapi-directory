...
QString OAICloudEndpointCreateParametersProperties::getAzureFileShareName() const {
    return m_azure_file_share_name;
}
void OAICloudEndpointCreateParametersProperties::setAzureFileShareName(const QString &azure_file_share_name) {
    m_azure_file_share_name = azure_file_share_name;
    m_azure_file_share_name_isSet = true;
}

bool OAICloudEndpointCreateParametersProperties::is_azure_file_share_name_Set() const{
    return m_azure_file_share_name_isSet;
}

bool OAICloudEndpointCreateParametersProperties::is_azure_file_share_name_Valid() const{
    return m_azure_file_share_name_isValid;
}

QString OAICloudEndpointCreateParametersProperties::getFriendlyName() const {
    return m_friendly_name;
}
void OAICloudEndpointCreateParametersProperties::setFriendlyName(const QString &friendly_name) {
    m_friendly_name = friendly_name;
    m_friendly_name_isSet = true;
}

bool OAICloudEndpointCreateParametersProperties::is_friendly_name_Set() const{
    return m_friendly_name_isSet;
}

bool OAICloudEndpointCreateParametersProperties::is_friendly_name_Valid() const{
