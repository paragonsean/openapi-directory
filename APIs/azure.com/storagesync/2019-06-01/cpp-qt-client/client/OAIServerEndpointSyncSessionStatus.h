...
/*
 * OAIServerEndpointSyncSessionStatus.h
 *
 * Sync Session status object.
 */

#ifndef OAIServerEndpointSyncSessionStatus_H
#define OAIServerEndpointSyncSessionStatus_H

#include <QJsonObject>

#include "OAIServerEndpointFilesNotSyncingError.h"
#include <QDateTime>
#include <QList>
...
namespace OpenAPI {
class OAIServerEndpointFilesNotSyncingError;

class OAIServerEndpointSyncSessionStatus : public OAIObject {
public:
    OAIServerEndpointSyncSessionStatus();
    OAIServerEndpointSyncSessionStatus(QString json);
    ~OAIServerEndpointSyncSessionStatus() override;
    ...
    QList<OAIServerEndpointFilesNotSyncingError> getFilesNotSyncingErrors() const;
    void setFilesNotSyncingErrors(const QList<OAIServerEndpointFilesNotSyncingError> &files_not_syncing_errors);
...
private:
    ...
    QList<OAIServerEndpointFilesNotSyncingError> m_files_not_syncing_errors;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerEndpointSyncSessionStatus)

#endif // OAIServerEndpointSyncSessionStatus_H
