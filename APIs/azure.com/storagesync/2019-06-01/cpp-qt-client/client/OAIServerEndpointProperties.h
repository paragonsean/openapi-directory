...
namespace OpenAPI {
class OAIServerEndpointCloudTieringStatus;
class OAIServerEndpointRecallStatus;
...
public:
    ...
    OAIServerEndpointCloudTieringStatus getCloudTieringStatus() const;
    void setCloudTieringStatus(const OAIServerEndpointCloudTieringStatus &cloud_tiering_status);
    bool is_cloud_tiering_status_Set() const;
    bool is_cloud_tiering_status_Valid() const;
    ...
    OAIServerEndpointRecallStatus getRecallStatus() const;
    void setRecallStatus(const OAIServerEndpointRecallStatus &recall_status);
    bool is_recall_status_Set() const;
    bool is_recall_status_Valid() const;
...
private:
    ...
    OAIServerEndpointCloudTieringStatus m_cloud_tiering_status;
    bool m_cloud_tiering_status_isSet;
    bool m_cloud_tiering_status_isValid;
    ...
    OAIServerEndpointRecallStatus m_recall_status;
    bool m_recall_status_isSet;
    bool m_recall_status_isValid;
