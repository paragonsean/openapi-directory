...
void OAIServerEndpointProperties::initializeModel() {
    ...
    m_cloud_tiering_status_isSet = false;
    m_cloud_tiering_status_isValid = false;
    ...
    m_recall_status_isSet = false;
    m_recall_status_isValid = false;
...
void OAIServerEndpointProperties::fromJsonObject(QJsonObject json) {
    ...
    m_cloud_tiering_status_isValid = ::OpenAPI::fromJsonValue(m_cloud_tiering_status, json[QString("cloudTieringStatus")]);
    m_cloud_tiering_status_isSet = !json[QString("cloudTieringStatus")].isNull() && m_cloud_tiering_status_isValid;
    ...
    m_recall_status_isValid = ::OpenAPI::fromJsonValue(m_recall_status, json[QString("recallStatus")]);
    m_recall_status_isSet = !json[QString("recallStatus")].isNull() && m_recall_status_isValid;
...
QJsonObject OAIServerEndpointProperties::asJsonObject() const {
    ...
    if (m_cloud_tiering_status.isSet()) {
        obj.insert(QString("cloudTieringStatus"), ::OpenAPI::toJsonValue(m_cloud_tiering_status));
    }
    ...
    if (m_recall_status.isSet()) {
        obj.insert(QString("recallStatus"), ::OpenAPI::toJsonValue(m_recall_status));
    }
...
OAIServerEndpointCloudTieringStatus OAIServerEndpointProperties::getCloudTieringStatus() const {
    return m_cloud_tiering_status;
}
void OAIServerEndpointProperties::setCloudTieringStatus(const OAIServerEndpointCloudTieringStatus &cloud_tiering_status) {
    m_cloud_tiering_status = cloud_tiering_status;
    m_cloud_tiering_status_isSet = true;
}

bool OAIServerEndpointProperties::is_cloud_tiering_status_Set() const{
    return m_cloud_tiering_status_isSet;
}

bool OAIServerEndpointProperties::is_cloud_tiering_status_Valid() const{
    return m_cloud_tiering_status_isValid;
}
...
OAIServerEndpointRecallStatus OAIServerEndpointProperties::getRecallStatus() const {
    return m_recall_status;
}
void OAIServerEndpointProperties::setRecallStatus(const OAIServerEndpointRecallStatus &recall_status) {
    m_recall_status = recall_status;
    m_recall_status_isSet = true;
}

bool OAIServerEndpointProperties::is_recall_status_Set() const{
    return m_recall_status_isSet;
}

bool OAIServerEndpointProperties::is_recall_status_Valid() const{
    return m_recall_status_isValid;
}
