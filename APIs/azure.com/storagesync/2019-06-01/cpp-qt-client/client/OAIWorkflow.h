...
public:
    ...
    OAIWorkflowProperties getProperties() const;
    void setProperties(const OAIWorkflowProperties &properties);
...
private:
    ...
    OAIWorkflowProperties m_properties;
