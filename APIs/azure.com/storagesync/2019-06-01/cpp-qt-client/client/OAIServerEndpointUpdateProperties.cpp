...
OAIFeatureStatus OAIServerEndpointUpdateProperties::getOfflineDataTransfer() const {
    return m_offline_data_transfer;
}
void OAIServerEndpointUpdateProperties::setOfflineDataTransfer(const OAIFeatureStatus &offline_data_transfer) {
    m_offline_data_transfer = offline_data_transfer;
    m_offline_data_transfer_isSet = true;
}

bool OAIServerEndpointUpdateProperties::is_offline_data_transfer_Set() const{
    return m_offline_data_transfer_isSet;
}

bool OAIServerEndpointUpdateProperties::is_offline_data_transfer_Valid() const{
    return m_offline_data_transfer_isValid;
}

QString OAIServerEndpointUpdateProperties::getOfflineDataTransferShareName() const {
    return m_offline_data_transfer_share_name;
}
void OAIServerEndpointUpdateProperties::setOfflineDataTransferShareName(const QString &offline_data_transfer_share_name) {
    m_offline_data_transfer_share_name = offline_data_transfer_share_name;
    m_offline_data_transfer_share_name_isSet = true;
}

bool OAIServerEndpointUpdateProperties::is_offline_data_transfer_share_name_Set() const{
    return m_offline_data_transfer_share_name_isSet;
}

bool OAIServerEndpointUpdateProperties::is_offline_data_transfer_share_name_Valid() const{
