...
async def cloud_endpoints_trigger_change_detection_0(request: web.Request, subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, cloud_endpoint_name, parameters) -> web.Response:
...
async def registered_servers_trigger_rollover_0(request: web.Request, subscription_id, resource_group_name, api_version, storage_sync_service_name, server_id, parameters) -> web.Response:
