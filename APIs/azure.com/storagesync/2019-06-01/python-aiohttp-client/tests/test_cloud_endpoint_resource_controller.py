...
async def test_cloud_endpoints_create(client):
    ...
    """
    parameters = {"properties":{"storageAccountTenantId":"storageAccountTenantId","azureFileShareName":"azureFileShareName","storageAccountResourceId":"storageAccountResourceId","friendlyName":"friendlyName"}}
...
async def test_cloud_endpoints_trigger_change_detection(client):
