...
[**cloudEndpointsTriggerChangeDetection_0**](ActionsApi.md#cloudEndpointsTriggerChangeDetection_0) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/cloudEndpoints/{cloudEndpointName}/triggerChangeDetection | 
...
## cloudEndpointsTriggerChangeDetection_0

> cloudEndpointsTriggerChangeDetection_0(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters)
...
apiInstance.cloudEndpointsTriggerChangeDetection_0(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
