...
[**registeredServersTriggerRollover**](RegisteredServerResourceApi.md#registeredServersTriggerRollover) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}/triggerRollover | 
...
let parameters = new MicrosoftStorageSync.RegisteredServerCreateParameters(); // RegisteredServerCreateParameters | Body of Registered Server object.
...
> registeredServersTriggerRollover(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, serverId, parameters)
...
apiInstance.registeredServersTriggerRollover(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, serverId, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
