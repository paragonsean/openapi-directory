...
void OAIRegisteredServerProperties::initializeModel() {
    ...
    m_server_management_error_code_isSet = false;
    m_server_management_error_code_isValid = false;
...
void OAIRegisteredServerProperties::fromJsonObject(QJsonObject json) {
    ...
    m_server_management_error_code_isValid = ::OpenAPI::fromJsonValue(m_server_management_error_code, json[QString("serverManagementErrorCode")]);
    m_server_management_error_code_isSet = !json[QString("serverManagementErrorCode")].isNull() && m_server_management_error_code_isValid;
...
QJsonObject OAIRegisteredServerProperties::asJsonObject() const {
    ...
    if (m_monitoring_configuration_isSet) {
    ...
    if (m_server_management_error_code_isSet) {
        obj.insert(QString("serverManagementErrorCode"), ::OpenAPI::toJsonValue(m_server_management_error_code));
    }
...
QString OAIRegisteredServerProperties::getMonitoringConfiguration() const {
    return m_monitoring_configuration;
}
void OAIRegisteredServerProperties::setMonitoringConfiguration(const QString &monitoring_configuration) {
    m_monitoring_configuration = monitoring_configuration;
    m_monitoring_configuration_isSet = true;
}

bool OAIRegisteredServerProperties::is_monitoring_configuration_Set() const{
    return m_monitoring_configuration_isSet;
}

bool OAIRegisteredServerProperties::is_monitoring_configuration_Valid() const{
...
qint32 OAIRegisteredServerProperties::getServerManagementErrorCode() const {
    return m_server_management_error_code;
}
void OAIRegisteredServerProperties::setServerManagementErrorCode(const qint32 &server_management_error_code) {
    m_server_management_error_code = server_management_error_code;
    m_server_management_error_code_isSet = true;
}

bool OAIRegisteredServerProperties::is_server_management_error_code_Set() const{
    return m_server_management_error_code_isSet;
}

bool OAIRegisteredServerProperties::is_server_management_error_code_Valid() const{
    return m_server_management_error_code_isValid;
}
