...
OAIServerEndpointSyncStatus OAIServerEndpointProperties::getSyncStatus() const {
    return m_sync_status;
}
void OAIServerEndpointProperties::setSyncStatus(const OAIServerEndpointSyncStatus &sync_status) {
