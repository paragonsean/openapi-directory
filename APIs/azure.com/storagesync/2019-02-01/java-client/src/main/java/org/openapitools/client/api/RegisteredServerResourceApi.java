...
public class RegisteredServerResourceApi {
    ...
    /**
     * Build call for registeredServersTriggerRollover
     * @param subscriptionId The ID of the target subscription. (required)
     * @param resourceGroupName The name of the resource group. The name is case insensitive. (required)
     * @param apiVersion The API version to use for this operation. (required)
     * @param storageSyncServiceName Name of Storage Sync Service resource. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Trigger Rollover success status </td><td>  * x-ms-request-id - request id. <br>  * x-ms-correlation-request-id - correlation request id. <br>  </td></tr>
        <tr><td> 202 </td><td> Asynchronous Operation Status Location </td><td>  * x-ms-request-id - request id. <br>  * x-ms-correlation-request-id - correlation request id. <br>  * Location - Operation Status Location URI <br>  </td></tr>
        <tr><td> 0 </td><td> Error message indicating why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call registeredServersTriggerRolloverCall(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String serverId, TriggerRolloverRequest parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/registeredServers/{serverId}/triggerRollover"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "storageSyncServiceName" + "}", localVarApiClient.escapeString(storageSyncServiceName.toString()))
            .replace("{" + "serverId" + "}", localVarApiClient.escapeString(serverId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call registeredServersTriggerRolloverValidateBeforeCall(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String serverId, TriggerRolloverRequest parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling registeredServersTriggerRollover(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling registeredServersTriggerRollover(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling registeredServersTriggerRollover(Async)");
        }

        // verify the required parameter 'storageSyncServiceName' is set
        if (storageSyncServiceName == null) {
            throw new ApiException("Missing the required parameter 'storageSyncServiceName' when calling registeredServersTriggerRollover(Async)");
        }

        // verify the required parameter 'serverId' is set
        if (serverId == null) {
            throw new ApiException("Missing the required parameter 'serverId' when calling registeredServersTriggerRollover(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling registeredServersTriggerRollover(Async)");
        }

        return registeredServersTriggerRolloverCall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, serverId, parameters, _callback);
     ...
     */
    public void registeredServersTriggerRollover(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String serverId, TriggerRolloverRequest parameters) throws ApiException {
        registeredServersTriggerRolloverWithHttpInfo(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, serverId, parameters);
    }
     ...
     */
    public ApiResponse<Void> registeredServersTriggerRolloverWithHttpInfo(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String serverId, TriggerRolloverRequest parameters) throws ApiException {
        okhttp3.Call localVarCall = registeredServersTriggerRolloverValidateBeforeCall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, serverId, parameters, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call registeredServersTriggerRolloverAsync(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String serverId, TriggerRolloverRequest parameters, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = registeredServersTriggerRolloverValidateBeforeCall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, serverId, parameters, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
