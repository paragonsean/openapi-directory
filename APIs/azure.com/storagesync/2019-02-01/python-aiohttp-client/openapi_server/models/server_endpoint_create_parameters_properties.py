...
class ServerEndpointCreateParametersProperties(Model):
    ...
    def __init__(self, cloud_tiering: FeatureStatus=None, friendly_name: str=None, offline_data_transfer: FeatureStatus=None, offline_data_transfer_share_name: str=None, server_local_path: str=None, server_resource_id: str=None, tier_files_older_than_days: int=None, volume_free_space_percent: int=None):
        ...
        :param offline_data_transfer: The offline_data_transfer of this ServerEndpointCreateParametersProperties.
        :param offline_data_transfer_share_name: The offline_data_transfer_share_name of this ServerEndpointCreateParametersProperties.
        ...
        :param tier_files_older_than_days: The tier_files_older_than_days of this ServerEndpointCreateParametersProperties.
    ...
    def offline_data_transfer(self):
        """Gets the offline_data_transfer of this ServerEndpointCreateParametersProperties.


        :return: The offline_data_transfer of this ServerEndpointCreateParametersProperties.
        :rtype: FeatureStatus
        """
    ...
    def offline_data_transfer(self, offline_data_transfer):
        """Sets the offline_data_transfer of this ServerEndpointCreateParametersProperties.
    ...
    def offline_data_transfer_share_name(self):
        """Gets the offline_data_transfer_share_name of this ServerEndpointCreateParametersProperties.

        Offline data transfer share name

        :return: The offline_data_transfer_share_name of this ServerEndpointCreateParametersProperties.
        :rtype: str
        """
    ...
    def offline_data_transfer_share_name(self, offline_data_transfer_share_name):
        """Sets the offline_data_transfer_share_name of this ServerEndpointCreateParametersProperties.
    ...
    def tier_files_older_than_days(self):
        """Gets the tier_files_older_than_days of this ServerEndpointCreateParametersProperties.

        Tier files older than days.

        :return: The tier_files_older_than_days of this ServerEndpointCreateParametersProperties.
        :rtype: int
        """
    ...
    def tier_files_older_than_days(self, tier_files_older_than_days):
        """Sets the tier_files_older_than_days of this ServerEndpointCreateParametersProperties.
