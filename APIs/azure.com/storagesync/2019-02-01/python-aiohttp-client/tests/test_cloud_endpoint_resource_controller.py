...
async def test_cloud_endpoints_create(client):
    ...
    """
    parameters = {"properties":{"storageAccountTenantId":"storageAccountTenantId","azureFileShareName":"azureFileShareName","storageAccountResourceId":"storageAccountResourceId"}}
...
async def test_cloud_endpoints_restoreheartbeat(client):
