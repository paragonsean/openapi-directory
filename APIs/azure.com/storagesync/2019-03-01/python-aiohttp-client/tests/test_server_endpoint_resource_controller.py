...
async def test_server_endpoints_create(client):
    ...
    """
    parameters = {"properties":{"offlineDataTransferShareName":"offlineDataTransferShareName","cloudTiering":"on","tierFilesOlderThanDays":171976544,"volumeFreeSpacePercent":60,"serverResourceId":"serverResourceId","serverLocalPath":"serverLocalPath","friendlyName":"friendlyName"}}
...
async def test_server_endpoints_update(client):
    ...
    """
    parameters = {"properties":{"offlineDataTransferShareName":"offlineDataTransferShareName","cloudTiering":"on","tierFilesOlderThanDays":171976544,"volumeFreeSpacePercent":60}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
