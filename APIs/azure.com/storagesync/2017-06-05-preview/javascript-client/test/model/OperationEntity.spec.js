...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftStorageSync.OperationEntity();
  });
  ...
  describe('OperationEntity', function() {
    it('should create an instance of OperationEntity', function() {
      ...
      //var instance = new MicrosoftStorageSync.OperationEntity();
      //expect(instance).to.be.a(MicrosoftStorageSync.OperationEntity);
    });
