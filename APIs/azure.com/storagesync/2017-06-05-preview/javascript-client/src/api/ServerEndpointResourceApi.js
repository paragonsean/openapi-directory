...
export default class ServerEndpointResourceApi {
    ...
    */
     ...
     * @param {module:model/ServerEndpoint} parameters Body of Server Endpoint object.
    ...
    /**
     * Callback function to receive the result of the serverEndpointsRecall operation.
     * @callback module:api/ServerEndpointResourceApi~serverEndpointsRecallCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} syncGroupName Name of Sync Group resource.
     * @param {String} serverEndpointName Name of Server Endpoint object.
     * @param {module:api/ServerEndpointResourceApi~serverEndpointsRecallCallback} callback The callback function, accepting three arguments: error, data, response
     */
    serverEndpointsRecall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, serverEndpointName, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling serverEndpointsRecall");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling serverEndpointsRecall");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling serverEndpointsRecall");
      }
      // verify the required parameter 'storageSyncServiceName' is set
      if (storageSyncServiceName === undefined || storageSyncServiceName === null) {
        throw new Error("Missing the required parameter 'storageSyncServiceName' when calling serverEndpointsRecall");
      }
      // verify the required parameter 'syncGroupName' is set
      if (syncGroupName === undefined || syncGroupName === null) {
        throw new Error("Missing the required parameter 'syncGroupName' when calling serverEndpointsRecall");
      }
      // verify the required parameter 'serverEndpointName' is set
      if (serverEndpointName === undefined || serverEndpointName === null) {
        throw new Error("Missing the required parameter 'serverEndpointName' when calling serverEndpointsRecall");
      }
     ...
     * @param {module:model/ServerEndpoint} [parameters] Any of the properties applicable in PUT request.
