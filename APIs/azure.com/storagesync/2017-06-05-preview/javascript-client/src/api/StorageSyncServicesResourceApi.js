...
export default class StorageSyncServicesResourceApi {
    ...
    */
     ...
     * @param {module:model/StorageSyncService} parameters Storage Sync Service resource name.
     ...
     * @param {module:model/StorageSyncService} [parameters] Storage Sync Service resource.
