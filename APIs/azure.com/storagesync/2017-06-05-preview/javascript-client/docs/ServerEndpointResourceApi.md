...
[**serverEndpointsRecall**](ServerEndpointResourceApi.md#serverEndpointsRecall) | **POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/serverEndpoints/{serverEndpointName}/recallAction | 
...
let parameters = new MicrosoftStorageSync.ServerEndpoint(); // ServerEndpoint | Body of Server Endpoint object.
...
> serverEndpointsRecall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, serverEndpointName)
...
let syncGroupName = "syncGroupName_example"; // String | Name of Sync Group resource.
let serverEndpointName = "serverEndpointName_example"; // String | Name of Server Endpoint object.
apiInstance.serverEndpointsRecall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, serverEndpointName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let serverEndpointName = "serverEndpointName_example"; // String | Name of Server Endpoint object.
let opts = {
  'parameters': new MicrosoftStorageSync.ServerEndpoint() // ServerEndpoint | Any of the properties applicable in PUT request.
};
