...
public:
    ...
    * @param[in]  parameters OAIStorageSyncService [required]
    */
    virtual void storageSyncServicesCreate(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &storage_sync_service_name, const OAIStorageSyncService &parameters);
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  storage_sync_service_name QString [required]
    * @param[in]  parameters OAIStorageSyncService [optional]
    */
    virtual void storageSyncServicesUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &storage_sync_service_name, const ::OpenAPI::OptionalParam<OAIStorageSyncService> &parameters = ::OpenAPI::OptionalParam<OAIStorageSyncService>());
