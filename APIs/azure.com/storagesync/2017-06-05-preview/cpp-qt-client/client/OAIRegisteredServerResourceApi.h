...
public:
    ...
    * @param[in]  parameters OAIRegisteredServer [required]
    */
    virtual void registeredServersCreate(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &storage_sync_service_name, const QString &server_id, const OAIRegisteredServer &parameters);
