...
/*
 * OAIOperationDisplayResource.h
 *
 * Operation Display Resource object.
 */

#ifndef OAIOperationDisplayResource_H
#define OAIOperationDisplayResource_H
...
class OAIOperationDisplayResource : public OAIObject {
public:
    OAIOperationDisplayResource();
    OAIOperationDisplayResource(QString json);
    ~OAIOperationDisplayResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOperationDisplayResource)

#endif // OAIOperationDisplayResource_H
