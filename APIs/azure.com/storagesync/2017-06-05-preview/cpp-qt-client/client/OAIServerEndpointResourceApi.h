...
public:
    ...
    * @param[in]  parameters OAIServerEndpoint [required]
    */
    virtual void serverEndpointsCreate(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &storage_sync_service_name, const QString &sync_group_name, const QString &server_endpoint_name, const OAIServerEndpoint &parameters);
    ...
    * @param[in]  server_endpoint_name QString [required]
    */
    virtual void serverEndpointsRecall(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &storage_sync_service_name, const QString &sync_group_name, const QString &server_endpoint_name);
    ...
    * @param[in]  sync_group_name QString [required]
    * @param[in]  server_endpoint_name QString [required]
    * @param[in]  parameters OAIServerEndpoint [optional]
    */
    virtual void serverEndpointsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &api_version, const QString &storage_sync_service_name, const QString &sync_group_name, const QString &server_endpoint_name, const ::OpenAPI::OptionalParam<OAIServerEndpoint> &parameters = ::OpenAPI::OptionalParam<OAIServerEndpoint>());
...
private:
    ...
    void serverEndpointsRecallCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void serverEndpointsRecallSignal();
    ...
    void serverEndpointsRecallSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use serverEndpointsRecallSignalError() instead")
    void serverEndpointsRecallSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void serverEndpointsRecallSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use serverEndpointsRecallSignalErrorFull() instead")
    void serverEndpointsRecallSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serverEndpointsRecallSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
