...
async def cloud_endpoints_restore_heatbeat_0(request: web.Request, subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, cloud_endpoint_name) -> web.Response:
...
async def server_endpoints_recall_0(request: web.Request, subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, server_endpoint_name) -> web.Response:
