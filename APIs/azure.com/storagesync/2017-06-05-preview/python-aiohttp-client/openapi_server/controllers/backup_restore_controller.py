...
async def cloud_endpoints_restore_heatbeat_1(request: web.Request, subscription_id, resource_group_name, api_version, storage_sync_service_name, sync_group_name, cloud_endpoint_name) -> web.Response:
