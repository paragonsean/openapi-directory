...
public class BackupRestoreApi {
    ...
    /**
     * Build call for cloudEndpointsRestoreHeatbeat_1
     * @param subscriptionId Gets subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The name of the resource group within the user&#39;s subscription. The name is case insensitive. (required)
     * @param apiVersion Client Api Version. (required)
     * @param storageSyncServiceName Name of Storage Sync Service resource. (required)
     ...
     */
    public okhttp3.Call cloudEndpointsRestoreHeatbeat_1Call(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String syncGroupName, String cloudEndpointName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cloudEndpointsRestoreHeatbeat_1ValidateBeforeCall(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String syncGroupName, String cloudEndpointName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling cloudEndpointsRestoreHeatbeat_1(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling cloudEndpointsRestoreHeatbeat_1(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling cloudEndpointsRestoreHeatbeat_1(Async)");
        }

        // verify the required parameter 'storageSyncServiceName' is set
        if (storageSyncServiceName == null) {
            throw new ApiException("Missing the required parameter 'storageSyncServiceName' when calling cloudEndpointsRestoreHeatbeat_1(Async)");
        }

        // verify the required parameter 'syncGroupName' is set
        if (syncGroupName == null) {
            throw new ApiException("Missing the required parameter 'syncGroupName' when calling cloudEndpointsRestoreHeatbeat_1(Async)");
        }

        // verify the required parameter 'cloudEndpointName' is set
        if (cloudEndpointName == null) {
            throw new ApiException("Missing the required parameter 'cloudEndpointName' when calling cloudEndpointsRestoreHeatbeat_1(Async)");
        }

        return cloudEndpointsRestoreHeatbeat_1Call(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, cloudEndpointName, _callback);
     ...
     */
    public void cloudEndpointsRestoreHeatbeat_1(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String syncGroupName, String cloudEndpointName) throws ApiException {
        cloudEndpointsRestoreHeatbeat_1WithHttpInfo(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, cloudEndpointName);
    }
     ...
     */
    public ApiResponse<Void> cloudEndpointsRestoreHeatbeat_1WithHttpInfo(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String syncGroupName, String cloudEndpointName) throws ApiException {
        okhttp3.Call localVarCall = cloudEndpointsRestoreHeatbeat_1ValidateBeforeCall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, cloudEndpointName, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call cloudEndpointsRestoreHeatbeat_1Async(String subscriptionId, String resourceGroupName, String apiVersion, String storageSyncServiceName, String syncGroupName, String cloudEndpointName, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = cloudEndpointsRestoreHeatbeat_1ValidateBeforeCall(subscriptionId, resourceGroupName, apiVersion, storageSyncServiceName, syncGroupName, cloudEndpointName, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
