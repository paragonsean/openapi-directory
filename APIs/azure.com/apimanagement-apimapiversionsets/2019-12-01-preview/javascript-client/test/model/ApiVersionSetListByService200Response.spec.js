...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ApiVersionSetListByService200Response();
  });
  ...
  describe('ApiVersionSetListByService200Response', function() {
    it('should create an instance of ApiVersionSetListByService200Response', function() {
      // uncomment below and update the code to test ApiVersionSetListByService200Response
      //var instance = new ApiManagementClient.ApiVersionSetListByService200Response();
      //expect(instance).to.be.a(ApiManagementClient.ApiVersionSetListByService200Response);
    });
