...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ApiVersionSetUpdateRequestProperties();
  });
  ...
  describe('ApiVersionSetUpdateRequestProperties', function() {
    it('should create an instance of ApiVersionSetUpdateRequestProperties', function() {
      // uncomment below and update the code to test ApiVersionSetUpdateRequestProperties
      //var instance = new ApiManagementClient.ApiVersionSetUpdateRequestProperties();
      //expect(instance).to.be.a(ApiManagementClient.ApiVersionSetUpdateRequestProperties);
    });
