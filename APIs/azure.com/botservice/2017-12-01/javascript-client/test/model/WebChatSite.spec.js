...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureBotService.WebChatSite();
  });
  ...
  describe('WebChatSite', function() {
    it('should create an instance of WebChatSite', function() {
      // uncomment below and update the code to test WebChatSite
      //var instance = new AzureBotService.WebChatSite();
      //expect(instance).to.be.a(AzureBotService.WebChatSite);
    });

    it('should have the property enablePreview (base name: "enablePreview")', function() {
      // uncomment below and update the code to test the property enablePreview
      //var instance = new AzureBotService.WebChatSite();
