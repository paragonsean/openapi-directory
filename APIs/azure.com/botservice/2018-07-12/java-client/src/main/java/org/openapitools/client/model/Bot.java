...
import org.openapitools.client.model.BotProperties;
...
public class Bot {
  ...
  public Bot properties(BotProperties properties) {
  ...
  public Bot location(String location) {
  ...
  public Bot tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public Bot putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    Bot bot = (Bot) o;
    return Objects.equals(this.properties, bot.properties) &&
        Objects.equals(this.etag, bot.etag) &&
        Objects.equals(this.id, bot.id) &&
        Objects.equals(this.kind, bot.kind) &&
        Objects.equals(this.location, bot.location) &&
        Objects.equals(this.name, bot.name) &&
        Objects.equals(this.sku, bot.sku) &&
        Objects.equals(this.tags, bot.tags) &&
        Objects.equals(this.type, bot.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Bot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Bot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        BotProperties.validateJsonElement(jsonObj.get("properties"));
      }
