...
import EnterpriseChannelNode from './model/EnterpriseChannelNode';
import EnterpriseChannelProperties from './model/EnterpriseChannelProperties';
...
import EnterpriseChannelApi from './api/EnterpriseChannelApi';
...
export {
    ...
    /**
     * The EnterpriseChannel model constructor.
     * @property {module:model/EnterpriseChannel}
     */
    EnterpriseChannel,

    /**
     * The EnterpriseChannelCheckNameAvailabilityRequest model constructor.
     * @property {module:model/EnterpriseChannelCheckNameAvailabilityRequest}
     */
    EnterpriseChannelCheckNameAvailabilityRequest,

    /**
     * The EnterpriseChannelCheckNameAvailabilityResponse model constructor.
     * @property {module:model/EnterpriseChannelCheckNameAvailabilityResponse}
     */
    EnterpriseChannelCheckNameAvailabilityResponse,

    /**
     * The EnterpriseChannelNode model constructor.
     * @property {module:model/EnterpriseChannelNode}
     */
    EnterpriseChannelNode,

    /**
     * The EnterpriseChannelProperties model constructor.
     * @property {module:model/EnterpriseChannelProperties}
     */
    EnterpriseChannelProperties,

    /**
     * The EnterpriseChannelResponseList model constructor.
     * @property {module:model/EnterpriseChannelResponseList}
     */
    ...
    */
    ...
    /**
    * The EnterpriseChannelApi service constructor.
    * @property {module:api/EnterpriseChannelApi}
    */
