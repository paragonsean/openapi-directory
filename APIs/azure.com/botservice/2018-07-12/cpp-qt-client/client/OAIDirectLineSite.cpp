...
void OAIDirectLineSite::initializeModel() {
    ...
    m_is_secure_site_enabled_isSet = false;
    m_is_secure_site_enabled_isValid = false;
    ...
    m_trusted_origins_isSet = false;
    m_trusted_origins_isValid = false;
}
...
void OAIDirectLineSite::fromJsonObject(QJsonObject json) {
    ...
    m_is_secure_site_enabled_isValid = ::OpenAPI::fromJsonValue(m_is_secure_site_enabled, json[QString("isSecureSiteEnabled")]);
    m_is_secure_site_enabled_isSet = !json[QString("isSecureSiteEnabled")].isNull() && m_is_secure_site_enabled_isValid;
    ...
    m_trusted_origins_isValid = ::OpenAPI::fromJsonValue(m_trusted_origins, json[QString("trustedOrigins")]);
    m_trusted_origins_isSet = !json[QString("trustedOrigins")].isNull() && m_trusted_origins_isValid;
}
...
QJsonObject OAIDirectLineSite::asJsonObject() const {
    ...
    if (m_is_secure_site_enabled_isSet) {
        obj.insert(QString("isSecureSiteEnabled"), ::OpenAPI::toJsonValue(m_is_secure_site_enabled));
    }
    ...
    if (m_trusted_origins.size() > 0) {
        obj.insert(QString("trustedOrigins"), ::OpenAPI::toJsonValue(m_trusted_origins));
    }
    return obj;
}
...
bool OAIDirectLineSite::isIsSecureSiteEnabled() const {
    return m_is_secure_site_enabled;
}
void OAIDirectLineSite::setIsSecureSiteEnabled(const bool &is_secure_site_enabled) {
    m_is_secure_site_enabled = is_secure_site_enabled;
    m_is_secure_site_enabled_isSet = true;
}

bool OAIDirectLineSite::is_is_secure_site_enabled_Set() const{
    return m_is_secure_site_enabled_isSet;
}

bool OAIDirectLineSite::is_is_secure_site_enabled_Valid() const{
    return m_is_secure_site_enabled_isValid;
}
...
QList<QString> OAIDirectLineSite::getTrustedOrigins() const {
    return m_trusted_origins;
}
void OAIDirectLineSite::setTrustedOrigins(const QList<QString> &trusted_origins) {
    m_trusted_origins = trusted_origins;
    m_trusted_origins_isSet = true;
}

bool OAIDirectLineSite::is_trusted_origins_Set() const{
    return m_trusted_origins_isSet;
}

bool OAIDirectLineSite::is_trusted_origins_Valid() const{
    return m_trusted_origins_isValid;
}
