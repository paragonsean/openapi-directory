...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("autoscaleSettingsUpdate", defaultConf);
    _serverIndices.insert("autoscaleSettingsUpdate", 0);
}
...
void OAIDefaultApi::autoscaleSettingsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &autoscale_setting_name, const QString &api_version, const OAIAutoscaleSettingResourcePatch &autoscale_setting_resource) {
    QString fullPath = QString(_serverConfigs["autoscaleSettingsUpdate"][_serverIndices.value("autoscaleSettingsUpdate")].URL()+"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/microsoft.insights/autoscalesettings/{autoscaleSettingName}");
...

    {
        ...
        QByteArray output = autoscale_setting_resource.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::autoscaleSettingsUpdateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::autoscaleSettingsUpdateCallback);
...
void OAIDefaultApi::autoscaleSettingsUpdateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT autoscaleSettingsUpdateSignal(output);
        Q_EMIT autoscaleSettingsUpdateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT autoscaleSettingsUpdateSignalE(output, error_type, error_str);
        Q_EMIT autoscaleSettingsUpdateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT autoscaleSettingsUpdateSignalError(output, error_type, error_str);
        Q_EMIT autoscaleSettingsUpdateSignalErrorFull(worker, error_type, error_str);
    }
}
