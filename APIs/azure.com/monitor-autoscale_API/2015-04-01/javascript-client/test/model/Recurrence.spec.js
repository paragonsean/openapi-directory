...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MonitorManagementClient.Recurrence();
  });
  ...
  describe('Recurrence', function() {
    it('should create an instance of Recurrence', function() {
      ...
      //var instance = new MonitorManagementClient.Recurrence();
      //expect(instance).to.be.a(MonitorManagementClient.Recurrence);
    });
