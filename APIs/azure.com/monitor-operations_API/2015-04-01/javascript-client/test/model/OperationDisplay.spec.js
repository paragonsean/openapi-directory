...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MonitorManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new MonitorManagementClient.OperationDisplay();
      //expect(instance).to.be.a(MonitorManagementClient.OperationDisplay);
    });
