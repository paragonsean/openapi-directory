...
import EncryptionProtectorProperties from './model/EncryptionProtectorProperties';
import EncryptionProtectorsApi from './api/EncryptionProtectorsApi';
...
export {
    ...
    /**
     * The EncryptionProtector model constructor.
     * @property {module:model/EncryptionProtector}
     */
    EncryptionProtector,

    /**
     * The EncryptionProtectorListResult model constructor.
     * @property {module:model/EncryptionProtectorListResult}
     */
    EncryptionProtectorListResult,

    /**
     * The EncryptionProtectorProperties model constructor.
     * @property {module:model/EncryptionProtectorProperties}
     */
    EncryptionProtectorProperties,

    /**
    * The EncryptionProtectorsApi service constructor.
    * @property {module:api/EncryptionProtectorsApi}
    */
