...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("entireDetect", defaultConf);
    _serverIndices.insert("entireDetect", 0);
    _serverConfigs.insert("lastDetect", defaultConf);
    _serverIndices.insert("lastDetect", 0);
}
...
void OAIDefaultApi::entireDetect(const OAIRequest &body) {
    QString fullPath = QString(_serverConfigs["entireDetect"][_serverIndices.value("entireDetect")].URL()+"/timeseries/entire/detect");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::entireDetectCallback);
...
void OAIDefaultApi::entireDetectCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIEntireDetectResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT entireDetectSignal(output);
        Q_EMIT entireDetectSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT entireDetectSignalE(output, error_type, error_str);
        Q_EMIT entireDetectSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT entireDetectSignalError(output, error_type, error_str);
        Q_EMIT entireDetectSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::lastDetect(const OAIRequest &body) {
    QString fullPath = QString(_serverConfigs["lastDetect"][_serverIndices.value("lastDetect")].URL()+"/timeseries/last/detect");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::lastDetectCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::lastDetectCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAILastDetectResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT lastDetectSignal(output);
        Q_EMIT lastDetectSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT lastDetectSignalE(output, error_type, error_str);
        Q_EMIT lastDetectSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT lastDetectSignalError(output, error_type, error_str);
        Q_EMIT lastDetectSignalErrorFull(worker, error_type, error_str);
    }
}
