...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::entireDetectSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::entireDetectSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIRequest body = create(); // OAIRequest | Time series points and period if needed. Advanced model parameters can also be set in the request.
      apiInstance.entireDetect(body);
