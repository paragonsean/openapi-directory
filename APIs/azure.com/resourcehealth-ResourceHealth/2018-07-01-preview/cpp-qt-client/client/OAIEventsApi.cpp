...
void OAIEventsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("eventsListBySingleResource", defaultConf);
    _serverIndices.insert("eventsListBySingleResource", 0);
    _serverConfigs.insert("eventsListBySubscriptionId", defaultConf);
    _serverIndices.insert("eventsListBySubscriptionId", 0);
}
...
void OAIEventsApi::eventsListBySingleResource(const QString &resource_uri, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["eventsListBySingleResource"][_serverIndices.value("eventsListBySingleResource")].URL()+"/{resourceUri}/providers/Microsoft.ResourceHealth/events");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::eventsListBySingleResourceCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::eventsListBySingleResourceCallback);
...
void OAIEventsApi::eventsListBySingleResourceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT eventsListBySingleResourceSignal(output);
        Q_EMIT eventsListBySingleResourceSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT eventsListBySingleResourceSignalE(output, error_type, error_str);
        Q_EMIT eventsListBySingleResourceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT eventsListBySingleResourceSignalError(output, error_type, error_str);
        Q_EMIT eventsListBySingleResourceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEventsApi::eventsListBySubscriptionId(const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["eventsListBySubscriptionId"][_serverIndices.value("eventsListBySubscriptionId")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/events");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::eventsListBySubscriptionIdCallback);
    connect(this, &OAIEventsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::eventsListBySubscriptionIdCallback);
    connect(this, &OAIEventsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEventsApi::eventsListBySubscriptionIdCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT eventsListBySubscriptionIdSignal(output);
        Q_EMIT eventsListBySubscriptionIdSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT eventsListBySubscriptionIdSignalE(output, error_type, error_str);
        Q_EMIT eventsListBySubscriptionIdSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT eventsListBySubscriptionIdSignalError(output, error_type, error_str);
        Q_EMIT eventsListBySubscriptionIdSignalErrorFull(worker, error_type, error_str);
    }
}
