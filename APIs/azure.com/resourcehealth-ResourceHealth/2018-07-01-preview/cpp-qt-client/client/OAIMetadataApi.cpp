...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("metadataGet", defaultConf);
    _serverIndices.insert("metadataGet", 0);
    _serverConfigs.insert("metadataList", defaultConf);
    _serverIndices.insert("metadataList", 0);
}
...
void OAIMetadataApi::metadataGet(const QString &name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["metadataGet"][_serverIndices.value("metadataGet")].URL()+"/providers/Microsoft.ResourceHealth/metadata/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::metadataGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::metadataGetCallback);
...
void OAIMetadataApi::metadataGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIMetadataEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT metadataGetSignal(output);
        Q_EMIT metadataGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT metadataGetSignalE(output, error_type, error_str);
        Q_EMIT metadataGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT metadataGetSignalError(output, error_type, error_str);
        Q_EMIT metadataGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMetadataApi::metadataList(const QString &api_version) {
    QString fullPath = QString(_serverConfigs["metadataList"][_serverIndices.value("metadataList")].URL()+"/providers/Microsoft.ResourceHealth/metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::metadataListCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::metadataListCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::metadataListCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIMetadataEntityListResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT metadataListSignal(output);
        Q_EMIT metadataListSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT metadataListSignalE(output, error_type, error_str);
        Q_EMIT metadataListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT metadataListSignalError(output, error_type, error_str);
        Q_EMIT metadataListSignalErrorFull(worker, error_type, error_str);
    }
}
