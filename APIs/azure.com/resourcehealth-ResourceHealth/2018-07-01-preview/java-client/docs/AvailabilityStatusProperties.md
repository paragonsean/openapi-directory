...
|------------ | ------------- | ------------- | -------------|
|**availabilityState** | [**AvailabilityStateEnum**](#AvailabilityStateEnum) | Availability status of the resource. When it is null, this availabilityStatus object represents an availability impacting event |  [optional] |
