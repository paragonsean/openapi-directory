...
public class Faq {
  ...
  public Faq localeCode(String localeCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.answer, faq.answer) &&
        Objects.equals(this.localeCode, faq.localeCode) &&
        Objects.equals(this.question, faq.question);
  }

  @Override
  public int hashCode() {
    return Objects.hash(answer, localeCode, question);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Faq
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Faq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Faq is not found in the empty JSON string", Faq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Faq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Faq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Faq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Faq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Faq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Faq.class));

       return (TypeAdapter<T>) new TypeAdapter<Faq>() {
           @Override
           public void write(JsonWriter out, Faq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Faq read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Faq given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Faq
   * @throws IOException if the JSON string is invalid with respect to Faq
   */
  public static Faq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Faq.class);
  }

  /**
   * Convert an instance of Faq to an JSON string
   *
   * @return JSON string
   */
