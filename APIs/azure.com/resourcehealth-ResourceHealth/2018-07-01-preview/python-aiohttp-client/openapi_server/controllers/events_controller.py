...
async def events_list_by_single_resource(request: web.Request, resource_uri, api_version, filter=None) -> web.Response:
...
async def events_list_by_subscription_id(request: web.Request, api_version, subscription_id, filter=None) -> web.Response:
