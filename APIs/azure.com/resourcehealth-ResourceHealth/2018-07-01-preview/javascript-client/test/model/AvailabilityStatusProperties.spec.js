...
(function(root, factory) {
  ...
  describe('AvailabilityStatusProperties', function() {
    ...
    it('should have the property healthEventCategory (base name: "healthEventCategory")', function() {
      // uncomment below and update the code to test the property healthEventCategory
      //var instance = new MicrosoftResourceHealth.AvailabilityStatusProperties();
      //expect(instance).to.be();
    });

    it('should have the property healthEventCause (base name: "healthEventCause")', function() {
      // uncomment below and update the code to test the property healthEventCause
      //var instance = new MicrosoftResourceHealth.AvailabilityStatusProperties();
      //expect(instance).to.be();
    });

    it('should have the property healthEventId (base name: "healthEventId")', function() {
      // uncomment below and update the code to test the property healthEventId
      //var instance = new MicrosoftResourceHealth.AvailabilityStatusProperties();
      //expect(instance).to.be();
    });

    it('should have the property healthEventType (base name: "healthEventType")', function() {
      // uncomment below and update the code to test the property healthEventType
      //var instance = new MicrosoftResourceHealth.AvailabilityStatusProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property recentlyResolved (base name: "recentlyResolved")', function() {
      // uncomment below and update the code to test the property recentlyResolved
      //var instance = new MicrosoftResourceHealth.AvailabilityStatusProperties();
      //expect(instance).to.be();
    });
