...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrosoftResourceHealth.StatusBanner();
  });
  ...
  describe('StatusBanner', function() {
    it('should create an instance of StatusBanner', function() {
      // uncomment below and update the code to test StatusBanner
      //var instance = new MicrosoftResourceHealth.StatusBanner();
      //expect(instance).to.be.a(MicrosoftResourceHealth.StatusBanner);
    });
