...
<a id="metricsList"></a>
# **metricsList**
> Response metricsList(resourceUri, apiVersion, timespan, interval, metricnames, aggregation, top, orderby, $filter, resultType, metricnamespace)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer top = 56; // Integer | The maximum number of records to retrieve. Valid only if $filter is specified. Defaults to 10.
    ...
    try {
      Response result = apiInstance.metricsList(resourceUri, apiVersion, timespan, interval, metricnames, aggregation, top, orderby, $filter, resultType, metricnamespace);
...
| **top** | **Integer**| The maximum number of records to retrieve. Valid only if $filter is specified. Defaults to 10. | [optional] |
