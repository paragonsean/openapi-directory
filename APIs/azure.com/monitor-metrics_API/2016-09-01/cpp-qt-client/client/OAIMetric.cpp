...
QList<OAIMetricValue> OAIMetric::getData() const {
    return m_data;
}
void OAIMetric::setData(const QList<OAIMetricValue> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMetric::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMetric::is_data_Valid() const{
...
bool OAIMetric::isValid() const {
    ...
    return m_data_isValid && m_name_isValid && m_unit_isValid && true;
}
