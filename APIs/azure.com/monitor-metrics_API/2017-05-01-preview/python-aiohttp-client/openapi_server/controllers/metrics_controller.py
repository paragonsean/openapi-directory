...
async def metrics_list(request: web.Request, resource_uri, api_version, timespan=None, interval=None, metric=None, aggregation=None, top=None, orderby=None, filter=None, result_type=None) -> web.Response:
    """metrics_list
