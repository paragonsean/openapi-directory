...
/**
 * The ServerBlobAuditingPolicyProperties model module.
 * @module model/ServerBlobAuditingPolicyProperties
 * @version 2017-03-01-preview
 */
class ServerBlobAuditingPolicyProperties {
    /**
     * Constructs a new <code>ServerBlobAuditingPolicyProperties</code>.
     * Properties of a server blob auditing policy.
     * @alias module:model/ServerBlobAuditingPolicyProperties
     * @param state {module:model/ServerBlobAuditingPolicyProperties.StateEnum} Specifies the state of the policy. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    constructor(state) { 
        
        ServerBlobAuditingPolicyProperties.initialize(this, state);
    }
    ...
    /**
     * Constructs a <code>ServerBlobAuditingPolicyProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerBlobAuditingPolicyProperties} obj Optional instance to populate.
     * @return {module:model/ServerBlobAuditingPolicyProperties} The populated <code>ServerBlobAuditingPolicyProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerBlobAuditingPolicyProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ServerBlobAuditingPolicyProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerBlobAuditingPolicyProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServerBlobAuditingPolicyProperties.RequiredProperties) {
...
ServerBlobAuditingPolicyProperties.RequiredProperties = ["state"];
 ...
 */
ServerBlobAuditingPolicyProperties.prototype['auditActionsAndGroups'] = undefined;
 ...
 */
ServerBlobAuditingPolicyProperties.prototype['isAzureMonitorTargetEnabled'] = undefined;

/**
 * Specifies whether storageAccountAccessKey value is the storage's secondary key.
 * @member {Boolean} isStorageSecondaryKeyInUse
 */
ServerBlobAuditingPolicyProperties.prototype['isStorageSecondaryKeyInUse'] = undefined;
 ...
 */
ServerBlobAuditingPolicyProperties.prototype['queueDelayMs'] = undefined;

/**
 * Specifies the number of days to keep in the audit logs in the storage account.
 * @member {Number} retentionDays
 */
ServerBlobAuditingPolicyProperties.prototype['retentionDays'] = undefined;

/**
 * Specifies the state of the policy. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
 * @member {module:model/ServerBlobAuditingPolicyProperties.StateEnum} state
 */
ServerBlobAuditingPolicyProperties.prototype['state'] = undefined;
 ...
 */
ServerBlobAuditingPolicyProperties.prototype['storageAccountAccessKey'] = undefined;

/**
 * Specifies the blob storage subscription Id.
 * @member {String} storageAccountSubscriptionId
 */
ServerBlobAuditingPolicyProperties.prototype['storageAccountSubscriptionId'] = undefined;

/**
 * Specifies the blob storage endpoint (e.g. https://MyAccount.blob.core.windows.net). If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled is required.
 * @member {String} storageEndpoint
 */
ServerBlobAuditingPolicyProperties.prototype['storageEndpoint'] = undefined;
 ...
 * @readonly
 */
ServerBlobAuditingPolicyProperties['StateEnum'] = {
...
export default ServerBlobAuditingPolicyProperties;
