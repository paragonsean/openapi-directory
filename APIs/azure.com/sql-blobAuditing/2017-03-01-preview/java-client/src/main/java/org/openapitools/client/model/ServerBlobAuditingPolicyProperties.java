...
public class ServerBlobAuditingPolicyProperties {
  ...
  public ServerBlobAuditingPolicyProperties auditActionsAndGroups(List<String> auditActionsAndGroups) {
    this.auditActionsAndGroups = auditActionsAndGroups;
    return this;
  }

  public ServerBlobAuditingPolicyProperties addAuditActionsAndGroupsItem(String auditActionsAndGroupsItem) {
  ...
  public ServerBlobAuditingPolicyProperties isAzureMonitorTargetEnabled(Boolean isAzureMonitorTargetEnabled) {
  ...
  public ServerBlobAuditingPolicyProperties isStorageSecondaryKeyInUse(Boolean isStorageSecondaryKeyInUse) {
  ...
  public ServerBlobAuditingPolicyProperties queueDelayMs(Integer queueDelayMs) {
  ...
  public ServerBlobAuditingPolicyProperties retentionDays(Integer retentionDays) {
  ...
  public ServerBlobAuditingPolicyProperties state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public ServerBlobAuditingPolicyProperties storageAccountAccessKey(String storageAccountAccessKey) {
  ...
  public ServerBlobAuditingPolicyProperties storageAccountSubscriptionId(UUID storageAccountSubscriptionId) {
  ...
  public ServerBlobAuditingPolicyProperties storageEndpoint(String storageEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    ServerBlobAuditingPolicyProperties serverBlobAuditingPolicyProperties = (ServerBlobAuditingPolicyProperties) o;
    return Objects.equals(this.auditActionsAndGroups, serverBlobAuditingPolicyProperties.auditActionsAndGroups) &&
        Objects.equals(this.isAzureMonitorTargetEnabled, serverBlobAuditingPolicyProperties.isAzureMonitorTargetEnabled) &&
        Objects.equals(this.isStorageSecondaryKeyInUse, serverBlobAuditingPolicyProperties.isStorageSecondaryKeyInUse) &&
        Objects.equals(this.queueDelayMs, serverBlobAuditingPolicyProperties.queueDelayMs) &&
        Objects.equals(this.retentionDays, serverBlobAuditingPolicyProperties.retentionDays) &&
        Objects.equals(this.state, serverBlobAuditingPolicyProperties.state) &&
        Objects.equals(this.storageAccountAccessKey, serverBlobAuditingPolicyProperties.storageAccountAccessKey) &&
        Objects.equals(this.storageAccountSubscriptionId, serverBlobAuditingPolicyProperties.storageAccountSubscriptionId) &&
        Objects.equals(this.storageEndpoint, serverBlobAuditingPolicyProperties.storageEndpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(auditActionsAndGroups, isAzureMonitorTargetEnabled, isStorageSecondaryKeyInUse, queueDelayMs, retentionDays, state, storageAccountAccessKey, storageAccountSubscriptionId, storageEndpoint);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerBlobAuditingPolicyProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerBlobAuditingPolicyProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerBlobAuditingPolicyProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerBlobAuditingPolicyProperties is not found in the empty JSON string", ServerBlobAuditingPolicyProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerBlobAuditingPolicyProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerBlobAuditingPolicyProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerBlobAuditingPolicyProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerBlobAuditingPolicyProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerBlobAuditingPolicyProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerBlobAuditingPolicyProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerBlobAuditingPolicyProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerBlobAuditingPolicyProperties>() {
           @Override
           public void write(JsonWriter out, ServerBlobAuditingPolicyProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerBlobAuditingPolicyProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerBlobAuditingPolicyProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerBlobAuditingPolicyProperties
   * @throws IOException if the JSON string is invalid with respect to ServerBlobAuditingPolicyProperties
   */
  public static ServerBlobAuditingPolicyProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerBlobAuditingPolicyProperties.class);
  }

  /**
   * Convert an instance of ServerBlobAuditingPolicyProperties to an JSON string
   *
   * @return JSON string
   */
