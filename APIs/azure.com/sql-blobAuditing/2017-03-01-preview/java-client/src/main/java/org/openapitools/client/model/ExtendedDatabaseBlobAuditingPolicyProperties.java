...
public class ExtendedDatabaseBlobAuditingPolicyProperties {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties auditActionsAndGroups(List<String> auditActionsAndGroups) {
    this.auditActionsAndGroups = auditActionsAndGroups;
    return this;
  }

  public ExtendedDatabaseBlobAuditingPolicyProperties addAuditActionsAndGroupsItem(String auditActionsAndGroupsItem) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties isAzureMonitorTargetEnabled(Boolean isAzureMonitorTargetEnabled) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties isStorageSecondaryKeyInUse(Boolean isStorageSecondaryKeyInUse) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties predicateExpression(String predicateExpression) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties queueDelayMs(Integer queueDelayMs) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties retentionDays(Integer retentionDays) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties storageAccountAccessKey(String storageAccountAccessKey) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties storageAccountSubscriptionId(UUID storageAccountSubscriptionId) {
  ...
  public ExtendedDatabaseBlobAuditingPolicyProperties storageEndpoint(String storageEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    ExtendedDatabaseBlobAuditingPolicyProperties extendedDatabaseBlobAuditingPolicyProperties = (ExtendedDatabaseBlobAuditingPolicyProperties) o;
    return Objects.equals(this.auditActionsAndGroups, extendedDatabaseBlobAuditingPolicyProperties.auditActionsAndGroups) &&
        Objects.equals(this.isAzureMonitorTargetEnabled, extendedDatabaseBlobAuditingPolicyProperties.isAzureMonitorTargetEnabled) &&
        Objects.equals(this.isStorageSecondaryKeyInUse, extendedDatabaseBlobAuditingPolicyProperties.isStorageSecondaryKeyInUse) &&
        Objects.equals(this.predicateExpression, extendedDatabaseBlobAuditingPolicyProperties.predicateExpression) &&
        Objects.equals(this.queueDelayMs, extendedDatabaseBlobAuditingPolicyProperties.queueDelayMs) &&
        Objects.equals(this.retentionDays, extendedDatabaseBlobAuditingPolicyProperties.retentionDays) &&
        Objects.equals(this.state, extendedDatabaseBlobAuditingPolicyProperties.state) &&
        Objects.equals(this.storageAccountAccessKey, extendedDatabaseBlobAuditingPolicyProperties.storageAccountAccessKey) &&
        Objects.equals(this.storageAccountSubscriptionId, extendedDatabaseBlobAuditingPolicyProperties.storageAccountSubscriptionId) &&
        Objects.equals(this.storageEndpoint, extendedDatabaseBlobAuditingPolicyProperties.storageEndpoint);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtendedDatabaseBlobAuditingPolicyProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExtendedDatabaseBlobAuditingPolicyProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtendedDatabaseBlobAuditingPolicyProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExtendedDatabaseBlobAuditingPolicyProperties is not found in the empty JSON string", ExtendedDatabaseBlobAuditingPolicyProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtendedDatabaseBlobAuditingPolicyProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExtendedDatabaseBlobAuditingPolicyProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExtendedDatabaseBlobAuditingPolicyProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtendedDatabaseBlobAuditingPolicyProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtendedDatabaseBlobAuditingPolicyProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtendedDatabaseBlobAuditingPolicyProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtendedDatabaseBlobAuditingPolicyProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtendedDatabaseBlobAuditingPolicyProperties>() {
           @Override
           public void write(JsonWriter out, ExtendedDatabaseBlobAuditingPolicyProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExtendedDatabaseBlobAuditingPolicyProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExtendedDatabaseBlobAuditingPolicyProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtendedDatabaseBlobAuditingPolicyProperties
   * @throws IOException if the JSON string is invalid with respect to ExtendedDatabaseBlobAuditingPolicyProperties
   */
  public static ExtendedDatabaseBlobAuditingPolicyProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtendedDatabaseBlobAuditingPolicyProperties.class);
  }

  /**
   * Convert an instance of ExtendedDatabaseBlobAuditingPolicyProperties to an JSON string
   *
   * @return JSON string
   */
