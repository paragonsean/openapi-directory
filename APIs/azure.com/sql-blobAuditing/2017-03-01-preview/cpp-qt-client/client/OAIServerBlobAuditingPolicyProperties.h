...
/*
 * OAIServerBlobAuditingPolicyProperties.h
 *
 * Properties of a server blob auditing policy.
 */

#ifndef OAIServerBlobAuditingPolicyProperties_H
#define OAIServerBlobAuditingPolicyProperties_H
...
class OAIServerBlobAuditingPolicyProperties : public OAIObject {
public:
    OAIServerBlobAuditingPolicyProperties();
    OAIServerBlobAuditingPolicyProperties(QString json);
    ~OAIServerBlobAuditingPolicyProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerBlobAuditingPolicyProperties)

#endif // OAIServerBlobAuditingPolicyProperties_H
