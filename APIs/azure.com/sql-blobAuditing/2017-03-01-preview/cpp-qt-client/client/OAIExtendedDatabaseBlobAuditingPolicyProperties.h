...
/*
 * OAIExtendedDatabaseBlobAuditingPolicyProperties.h
 *
 * Properties of an extended database blob auditing policy.
 */

#ifndef OAIExtendedDatabaseBlobAuditingPolicyProperties_H
#define OAIExtendedDatabaseBlobAuditingPolicyProperties_H
...
class OAIExtendedDatabaseBlobAuditingPolicyProperties : public OAIObject {
public:
    OAIExtendedDatabaseBlobAuditingPolicyProperties();
    OAIExtendedDatabaseBlobAuditingPolicyProperties(QString json);
    ~OAIExtendedDatabaseBlobAuditingPolicyProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtendedDatabaseBlobAuditingPolicyProperties)

#endif // OAIExtendedDatabaseBlobAuditingPolicyProperties_H
