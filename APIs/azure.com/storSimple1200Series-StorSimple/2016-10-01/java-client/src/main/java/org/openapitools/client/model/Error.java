...
public class Error {
  ...
  public Error message(Message message) {
  ...
  public Error values(List<Item> values) {
    this.values = values;
    return this;
  }

  public Error addValuesItem(Item valuesItem) {
    if (this.values == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorCode, error.errorCode) &&
        ...
        Objects.equals(this.values, error.values);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errorCode, message, values);
  }
      ...
      if (jsonObj.get("values") != null && !jsonObj.get("values").isJsonNull()) {
        ...
        if (jsonArrayvalues != null) {
          ...
          for (int i = 0; i < jsonArrayvalues.size(); i++) {
            Item.validateJsonElement(jsonArrayvalues.get(i));
          };
        }
      }
  }
