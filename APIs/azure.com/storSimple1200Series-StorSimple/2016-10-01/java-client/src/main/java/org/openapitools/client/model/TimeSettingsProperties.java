...
public class TimeSettingsProperties {
  ...
  public TimeSettingsProperties secondaryTimeServer(String secondaryTimeServer) {
  ...
  public void setSecondaryTimeServer(String secondaryTimeServer) {
    this.secondaryTimeServer = secondaryTimeServer;
  }
  ...
  static {
    ...
    openapiRequiredFields.add("primaryTimeServer");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("primaryTimeServer").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("secondaryTimeServer") != null && !jsonObj.get("secondaryTimeServer").isJsonNull()) && !jsonObj.get("secondaryTimeServer").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `secondaryTimeServer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("secondaryTimeServer").toString()));
      }
