...
namespace OpenAPI {
class OAIAlertSettingsProperties;
...
public:
    ...
    OAIAlertSettingsProperties getProperties() const;
    void setProperties(const OAIAlertSettingsProperties &properties);
...
private:
    ...
    OAIAlertSettingsProperties m_properties;
