...
public:
    ...
    * @param[in]  storage_account OAIStorageAccountCredential [required]
    */
    virtual void storageAccountCredentialsCreateOrUpdate(const QString &credential_name, const QString &subscription_id, const QString &resource_group_name, const QString &manager_name, const QString &api_version, const OAIStorageAccountCredential &storage_account);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void storageAccountCredentialsDelete(const QString &credential_name, const QString &subscription_id, const QString &resource_group_name, const QString &manager_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void storageAccountCredentialsGet(const QString &credential_name, const QString &subscription_id, const QString &resource_group_name, const QString &manager_name, const QString &api_version);
