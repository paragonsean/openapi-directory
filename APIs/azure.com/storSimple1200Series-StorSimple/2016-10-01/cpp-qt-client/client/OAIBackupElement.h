...
namespace OpenAPI {
class OAIBackupElementProperties;
...
public:
    ...
    OAIBackupElementProperties getProperties() const;
    void setProperties(const OAIBackupElementProperties &properties);
...
private:
    ...
    OAIBackupElementProperties m_properties;
