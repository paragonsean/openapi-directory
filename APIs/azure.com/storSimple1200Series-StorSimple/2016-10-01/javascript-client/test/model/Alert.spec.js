...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.Alert();
  });
  ...
  describe('Alert', function() {
    it('should create an instance of Alert', function() {
      ...
      //var instance = new StorSimpleManagementClient.Alert();
      //expect(instance).to.be.a(StorSimpleManagementClient.Alert);
    });
