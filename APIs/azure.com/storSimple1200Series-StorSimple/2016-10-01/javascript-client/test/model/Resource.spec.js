...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new StorSimpleManagementClient.Resource();
      //expect(instance).to.be.a(StorSimpleManagementClient.Resource);
    });
