...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.Device();
  });
  ...
  describe('Device', function() {
    it('should create an instance of Device', function() {
      ...
      //var instance = new StorSimpleManagementClient.Device();
      //expect(instance).to.be.a(StorSimpleManagementClient.Device);
    });
