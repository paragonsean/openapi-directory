...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.ManagerProperties();
  });
  ...
  describe('ManagerProperties', function() {
    it('should create an instance of ManagerProperties', function() {
      ...
      //var instance = new StorSimpleManagementClient.ManagerProperties();
      //expect(instance).to.be.a(StorSimpleManagementClient.ManagerProperties);
    });
