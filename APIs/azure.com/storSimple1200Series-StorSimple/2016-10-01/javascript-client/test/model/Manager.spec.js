...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.Manager();
  });
  ...
  describe('Manager', function() {
    it('should create an instance of Manager', function() {
      ...
      //var instance = new StorSimpleManagementClient.Manager();
      //expect(instance).to.be.a(StorSimpleManagementClient.Manager);
    });
