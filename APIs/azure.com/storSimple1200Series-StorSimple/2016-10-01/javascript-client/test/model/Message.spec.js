...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instance = new StorSimpleManagementClient.Message();
      //expect(instance).to.be.a(StorSimpleManagementClient.Message);
    });
