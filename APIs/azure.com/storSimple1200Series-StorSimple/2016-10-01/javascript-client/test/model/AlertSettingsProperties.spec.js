...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.AlertSettingsProperties();
  });
  ...
  describe('AlertSettingsProperties', function() {
    it('should create an instance of AlertSettingsProperties', function() {
      // uncomment below and update the code to test AlertSettingsProperties
      //var instance = new StorSimpleManagementClient.AlertSettingsProperties();
      //expect(instance).to.be.a(StorSimpleManagementClient.AlertSettingsProperties);
    });
