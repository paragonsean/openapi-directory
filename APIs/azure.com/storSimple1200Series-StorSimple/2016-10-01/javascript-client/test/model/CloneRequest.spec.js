...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.CloneRequest();
  });
  ...
  describe('CloneRequest', function() {
    it('should create an instance of CloneRequest', function() {
      ...
      //var instance = new StorSimpleManagementClient.CloneRequest();
      //expect(instance).to.be.a(StorSimpleManagementClient.CloneRequest);
    });
