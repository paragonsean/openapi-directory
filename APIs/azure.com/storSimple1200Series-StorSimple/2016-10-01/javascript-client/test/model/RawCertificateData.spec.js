...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.RawCertificateData();
  });
  ...
  describe('RawCertificateData', function() {
    it('should create an instance of RawCertificateData', function() {
      ...
      //var instance = new StorSimpleManagementClient.RawCertificateData();
      //expect(instance).to.be.a(StorSimpleManagementClient.RawCertificateData);
    });
