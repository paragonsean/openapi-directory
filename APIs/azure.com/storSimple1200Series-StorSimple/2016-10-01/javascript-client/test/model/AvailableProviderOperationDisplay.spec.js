...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorSimpleManagementClient.AvailableProviderOperationDisplay();
  });
  ...
  describe('AvailableProviderOperationDisplay', function() {
    it('should create an instance of AvailableProviderOperationDisplay', function() {
      ...
      //var instance = new StorSimpleManagementClient.AvailableProviderOperationDisplay();
      //expect(instance).to.be.a(StorSimpleManagementClient.AvailableProviderOperationDisplay);
    });
