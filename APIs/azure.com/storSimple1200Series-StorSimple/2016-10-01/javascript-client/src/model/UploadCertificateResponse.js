...
import ResourceCertificateAndAADDetails from './ResourceCertificateAndAADDetails';
...
class UploadCertificateResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ResourceCertificateAndAADDetails.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ResourceCertificateAndAADDetails.validateJSON(data['properties']);
        }
...
UploadCertificateResponse.RequiredProperties = ["properties"];

/**
 * @member {module:model/ResourceCertificateAndAADDetails} properties
 */
UploadCertificateResponse.prototype['properties'] = undefined;

/**
 * The identifier.
 * @member {String} id
 */
UploadCertificateResponse.prototype['id'] = undefined;

/**
 * The name.
 * @member {String} name
 */
UploadCertificateResponse.prototype['name'] = undefined;

/**
 * The type.
 * @member {String} type
 */
UploadCertificateResponse.prototype['type'] = undefined;
