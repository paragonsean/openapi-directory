...
class StorageAccountCredentialList {
     ...
     * @param value {Array.<module:model/StorageAccountCredential>} The value.
     */
    constructor(value) { 
        
        StorageAccountCredentialList.initialize(this, value);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of StorageAccountCredentialList.RequiredProperties) {
...
StorageAccountCredentialList.RequiredProperties = ["value"];
