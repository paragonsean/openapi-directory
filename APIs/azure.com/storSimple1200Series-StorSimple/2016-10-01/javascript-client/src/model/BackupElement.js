...
import BackupElementProperties from './BackupElementProperties';
...
class BackupElement {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = BackupElementProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          BackupElementProperties.validateJSON(data['properties']);
        }
...
BackupElement.RequiredProperties = ["properties"];

/**
 * @member {module:model/BackupElementProperties} properties
 */
BackupElement.prototype['properties'] = undefined;

/**
 * The identifier.
 * @member {String} id
 */
BackupElement.prototype['id'] = undefined;

/**
 * The name.
 * @member {String} name
 */
BackupElement.prototype['name'] = undefined;

/**
 * The type.
 * @member {String} type
 */
BackupElement.prototype['type'] = undefined;
