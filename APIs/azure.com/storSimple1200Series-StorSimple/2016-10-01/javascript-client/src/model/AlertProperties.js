...
class AlertProperties {
     ...
     * @param alertType {String} Type of the alert
     * @param appearedAtSourceTime {Date} UTC time at which the alert appeared on the source
     * @param appearedAtTime {Date} UTC time at which the alert appeared
     * @param scope {module:model/AlertProperties.ScopeEnum} Device or Resource alert
     * @param severity {module:model/AlertProperties.SeverityEnum} Severity of the alert
     * @param source {module:model/AlertSource} 
     * @param status {module:model/AlertProperties.StatusEnum} Current status of the alert
