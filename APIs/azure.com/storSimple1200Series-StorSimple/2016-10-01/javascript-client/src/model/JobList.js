...
class JobList {
     ...
     * @param value {Array.<module:model/Job>} The value.
     */
    constructor(value) { 
        
        JobList.initialize(this, value);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of JobList.RequiredProperties) {
...
JobList.RequiredProperties = ["value"];
