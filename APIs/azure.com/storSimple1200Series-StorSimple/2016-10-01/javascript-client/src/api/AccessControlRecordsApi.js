...
export default class AccessControlRecordsApi {
    ...
    */
     ...
     * @param {module:model/AccessControlRecord} accessControlRecord The access control record to be added or updated.
     ...
     */
    accessControlRecordsCreateOrUpdate(accessControlRecordName, subscriptionId, resourceGroupName, managerName, apiVersion, accessControlRecord, callback) {
      let postBody = accessControlRecord;
      ...
      if (accessControlRecord === undefined || accessControlRecord === null) {
        throw new Error("Missing the required parameter 'accessControlRecord' when calling accessControlRecordsCreateOrUpdate");
      }
