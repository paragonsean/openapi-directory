...
async def access_control_records_create_or_update(request: web.Request, access_control_record_name, subscription_id, resource_group_name, manager_name, api_version, access_control_record) -> web.Response:
    ...
    :param access_control_record: The access control record to be added or updated.
    :type access_control_record: dict | bytes

    """
    access_control_record = AccessControlRecord.from_dict(access_control_record)
