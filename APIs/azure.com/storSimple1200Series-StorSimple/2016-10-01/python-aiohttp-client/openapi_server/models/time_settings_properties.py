...
class TimeSettingsProperties(Model):
    ...
    def __init__(self, primary_time_server: str=None, secondary_time_server: str=None, time_zone: str=None):
    ...
    def primary_time_server(self, primary_time_server):
        ...
        """
        if primary_time_server is None:
            raise ValueError("Invalid value for `primary_time_server`, must not be `None`")
    ...
    def secondary_time_server(self, secondary_time_server):
        ...
        :param secondary_time_server: The secondary_time_server of this TimeSettingsProperties.
        :type secondary_time_server: str
        """
