...
async def test_storage_account_credentials_create_or_update(client):
    ...
    """
    storage_account = {"properties":{"enableSSL":"Enabled","endPoint":"endPoint","accessKey":{"encryptionCertificateThumbprint":"encryptionCertificateThumbprint","encryptionAlgorithm":"None","value":"value"},"cloudType":"Azure","location":"location","login":"login"}}
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.StorSimple/managers/{manager_name}/storageAccountCredentials/{credential_name}'.format(credential_name='credential_name_example', subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', manager_name='manager_name_example'),
        headers=headers,
