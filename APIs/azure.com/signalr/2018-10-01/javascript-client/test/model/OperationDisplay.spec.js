...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignalRManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new SignalRManagementClient.OperationDisplay();
      //expect(instance).to.be.a(SignalRManagementClient.OperationDisplay);
    });
