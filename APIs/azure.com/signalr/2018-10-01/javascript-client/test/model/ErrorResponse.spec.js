...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignalRManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new SignalRManagementClient.ErrorResponse();
      //expect(instance).to.be.a(SignalRManagementClient.ErrorResponse);
    });
