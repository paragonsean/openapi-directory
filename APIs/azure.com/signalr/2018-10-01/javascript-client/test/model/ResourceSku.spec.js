...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignalRManagementClient.ResourceSku();
  });
  ...
  describe('ResourceSku', function() {
    it('should create an instance of ResourceSku', function() {
      ...
      //var instance = new SignalRManagementClient.ResourceSku();
      //expect(instance).to.be.a(SignalRManagementClient.ResourceSku);
    });
