...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignalRManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new SignalRManagementClient.Operation();
      //expect(instance).to.be.a(SignalRManagementClient.Operation);
    });
