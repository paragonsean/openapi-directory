...
public class MetricSpecification {
  ...
  public MetricSpecification fillGapWithZero(String fillGapWithZero) {
   ...
   */
  @javax.annotation.Nullable
  public String getFillGapWithZero() {
    return fillGapWithZero;
  }

  public void setFillGapWithZero(String fillGapWithZero) {
    this.fillGapWithZero = fillGapWithZero;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aggregationType, category, dimensions, displayDescription, displayName, fillGapWithZero, name, unit);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("fillGapWithZero") != null && !jsonObj.get("fillGapWithZero").isJsonNull()) && !jsonObj.get("fillGapWithZero").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fillGapWithZero` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fillGapWithZero").toString()));
      }
