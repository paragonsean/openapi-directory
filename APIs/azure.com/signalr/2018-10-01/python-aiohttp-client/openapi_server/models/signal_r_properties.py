...
class SignalRProperties(Model):
    ...
    def __init__(self, external_ip: str=None, host_name: str=None, provisioning_state: str=None, public_port: int=None, server_port: int=None, version: str=None, cors: SignalRCorsSettings=None, features: List[SignalRFeature]=None, host_name_prefix: str=None):
        ...
        :param cors: The cors of this SignalRProperties.
        :param features: The features of this SignalRProperties.
    ...
    @property
    def cors(self):
        """Gets the cors of this SignalRProperties.


        :return: The cors of this SignalRProperties.
    ...
    @cors.setter
    def cors(self, cors):
        """Sets the cors of this SignalRProperties.
    ...
    @property
    def features(self):
        """Gets the features of this SignalRProperties.
        ...
        :return: The features of this SignalRProperties.
    ...
    def features(self, features):
        """Sets the features of this SignalRProperties.
