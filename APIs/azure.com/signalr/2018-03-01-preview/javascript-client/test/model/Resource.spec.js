...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignalRManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new SignalRManagementClient.Resource();
      //expect(instance).to.be.a(SignalRManagementClient.Resource);
    });
