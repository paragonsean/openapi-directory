...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignalRManagementClient.OperationList();
  });
  ...
  describe('OperationList', function() {
    it('should create an instance of OperationList', function() {
      ...
      //var instance = new SignalRManagementClient.OperationList();
      //expect(instance).to.be.a(SignalRManagementClient.OperationList);
    });
