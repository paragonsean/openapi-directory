...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignalRManagementClient.SignalRUsage();
  });
  ...
  describe('SignalRUsage', function() {
    it('should create an instance of SignalRUsage', function() {
      // uncomment below and update the code to test SignalRUsage
      //var instance = new SignalRManagementClient.SignalRUsage();
      //expect(instance).to.be.a(SignalRManagementClient.SignalRUsage);
    });
