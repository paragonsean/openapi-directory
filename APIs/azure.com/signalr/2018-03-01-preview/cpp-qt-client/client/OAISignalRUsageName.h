...
/*
 * OAISignalRUsageName.h
 *
 * Localizable String object containing the name and a localized value.
 */

#ifndef OAISignalRUsageName_H
#define OAISignalRUsageName_H
...
class OAISignalRUsageName : public OAIObject {
public:
    OAISignalRUsageName();
    OAISignalRUsageName(QString json);
    ~OAISignalRUsageName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignalRUsageName)

#endif // OAISignalRUsageName_H
