...
public class SignalRKeys {
  ...
  public SignalRKeys primaryConnectionString(String primaryConnectionString) {
  ...
  public SignalRKeys primaryKey(String primaryKey) {
  ...
  public SignalRKeys secondaryConnectionString(String secondaryConnectionString) {
  ...
  public SignalRKeys secondaryKey(String secondaryKey) {
  ...
  public boolean equals(Object o) {
    ...
    SignalRKeys signalRKeys = (SignalRKeys) o;
    return Objects.equals(this.primaryConnectionString, signalRKeys.primaryConnectionString) &&
        Objects.equals(this.primaryKey, signalRKeys.primaryKey) &&
        Objects.equals(this.secondaryConnectionString, signalRKeys.secondaryConnectionString) &&
        Objects.equals(this.secondaryKey, signalRKeys.secondaryKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primaryConnectionString, primaryKey, secondaryConnectionString, secondaryKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SignalRKeys {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SignalRKeys
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignalRKeys.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignalRKeys is not found in the empty JSON string", SignalRKeys.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignalRKeys.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SignalRKeys` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignalRKeys.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignalRKeys' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignalRKeys> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignalRKeys.class));

       return (TypeAdapter<T>) new TypeAdapter<SignalRKeys>() {
           @Override
           public void write(JsonWriter out, SignalRKeys value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SignalRKeys read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SignalRKeys given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SignalRKeys
   * @throws IOException if the JSON string is invalid with respect to SignalRKeys
   */
  public static SignalRKeys fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignalRKeys.class);
  }

  /**
   * Convert an instance of SignalRKeys to an JSON string
   *
   * @return JSON string
   */
