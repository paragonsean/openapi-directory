...
public class SignalRApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success. The response describe the corresponding SignalR service. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Success. The response describes a SignalR service which is not up-to-date. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Accepted. The response indicates the exiting SignalR service is now updating  and contains a Location header to query the operation result.. </td><td>  -  </td></tr>
     </table>
     */
