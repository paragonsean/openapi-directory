...
async def iot_dps_resource_check_name_availability(request: web.Request, subscription_id, api_version, arguments) -> web.Response:
...
async def iot_dps_resource_get_keys_for_key_name(request: web.Request, provisioning_service_name, key_name, subscription_id, resource_group_name, api_version) -> web.Response:
