...
let apiVersion = "apiVersion_example"; // String | The version of the API.
let request = new IotDpsClient.VerificationCodeRequest(); // VerificationCodeRequest | The name of the certificate
let opts = {
  'certificateName2': "certificateName_example", // String | Common Name for the certificate.
  'certificateRawBytes': null, // Blob | Raw data of certificate.
  'certificateIsVerified': true, // Boolean | Indicates if the certificate has been verified by owner of the private key.
...
> NameAvailabilityInfo iotDpsResourceCheckProvisioningServiceNameAvailability(subscriptionId, apiVersion, _arguments)
...
apiInstance.iotDpsResourceCheckProvisioningServiceNameAvailability(subscriptionId, apiVersion, _arguments, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiVersion = "apiVersion_example"; // String | The version of the API.
apiInstance.iotDpsResourceListKeysForKeyName(provisioningServiceName, keyName, subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
