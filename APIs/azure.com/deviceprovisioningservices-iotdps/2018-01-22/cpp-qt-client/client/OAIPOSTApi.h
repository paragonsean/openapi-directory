...
public:
    ...
    */
    virtual void iotDpsResourceCheckProvisioningServiceNameAvailability(const QString &subscription_id, const QString &api_version, const OAIOperationInputs &arguments);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void iotDpsResourceListKeysForKeyName(const QString &provisioning_service_name, const QString &key_name, const QString &subscription_id, const QString &resource_group_name, const QString &api_version);
...
private:
    ...
    void iotDpsResourceCheckProvisioningServiceNameAvailabilityCallback(OAIHttpRequestWorker *worker);
    void iotDpsResourceListKeysCallback(OAIHttpRequestWorker *worker);
    void iotDpsResourceListKeysForKeyNameCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void iotDpsResourceCheckProvisioningServiceNameAvailabilitySignal(OAINameAvailabilityInfo summary);
    void iotDpsResourceListKeysSignal(OAISharedAccessSignatureAuthorizationRuleListResult summary);
    void iotDpsResourceListKeysForKeyNameSignal(OAISharedAccessSignatureAuthorizationRule_AccessRightsDescription summary);
    ...
    void iotDpsResourceCheckProvisioningServiceNameAvailabilitySignalFull(OAIHttpRequestWorker *worker, OAINameAvailabilityInfo summary);
    ...
    void iotDpsResourceListKeysForKeyNameSignalFull(OAIHttpRequestWorker *worker, OAISharedAccessSignatureAuthorizationRule_AccessRightsDescription summary);
    ...
    Q_DECL_DEPRECATED_X("Use iotDpsResourceCheckProvisioningServiceNameAvailabilitySignalError() instead")
    void iotDpsResourceCheckProvisioningServiceNameAvailabilitySignalE(OAINameAvailabilityInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void iotDpsResourceCheckProvisioningServiceNameAvailabilitySignalError(OAINameAvailabilityInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use iotDpsResourceListKeysForKeyNameSignalError() instead")
    void iotDpsResourceListKeysForKeyNameSignalE(OAISharedAccessSignatureAuthorizationRule_AccessRightsDescription summary, QNetworkReply::NetworkError error_type, QString error_str);
    void iotDpsResourceListKeysForKeyNameSignalError(OAISharedAccessSignatureAuthorizationRule_AccessRightsDescription summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use iotDpsResourceCheckProvisioningServiceNameAvailabilitySignalErrorFull() instead")
    void iotDpsResourceCheckProvisioningServiceNameAvailabilitySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void iotDpsResourceCheckProvisioningServiceNameAvailabilitySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use iotDpsResourceListKeysForKeyNameSignalErrorFull() instead")
    void iotDpsResourceListKeysForKeyNameSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void iotDpsResourceListKeysForKeyNameSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
