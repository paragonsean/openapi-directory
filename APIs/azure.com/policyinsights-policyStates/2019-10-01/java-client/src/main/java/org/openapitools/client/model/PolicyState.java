...
public class PolicyState {
  ...
  public static final String SERIALIZED_NAME_POLICY_DEFINITION_GROUP_NAMES = "policyDefinitionGroupNames";
  @SerializedName(SERIALIZED_NAME_POLICY_DEFINITION_GROUP_NAMES)
  private List<String> policyDefinitionGroupNames = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_POLICY_EVALUATION_DETAILS = "policyEvaluationDetails";
  @SerializedName(SERIALIZED_NAME_POLICY_EVALUATION_DETAILS)
  ...
  public PolicyState atOdataContext(String atOdataContext) {
  ...
  public PolicyState atOdataId(String atOdataId) {
  ...
  public PolicyState complianceState(String complianceState) {
  ...
  public PolicyState effectiveParameters(String effectiveParameters) {
  ...
  public PolicyState isCompliant(Boolean isCompliant) {
  ...
  public PolicyState managementGroupIds(String managementGroupIds) {
  ...
  public PolicyState policyAssignmentId(String policyAssignmentId) {
  ...
  public PolicyState policyAssignmentName(String policyAssignmentName) {
  ...
  public PolicyState policyAssignmentOwner(String policyAssignmentOwner) {
  ...
  public PolicyState policyAssignmentParameters(String policyAssignmentParameters) {
  ...
  public PolicyState policyAssignmentScope(String policyAssignmentScope) {
  ...
  public PolicyState policyDefinitionAction(String policyDefinitionAction) {
  ...
  public PolicyState policyDefinitionCategory(String policyDefinitionCategory) {
  ...
  public PolicyState policyDefinitionGroupNames(List<String> policyDefinitionGroupNames) {
    this.policyDefinitionGroupNames = policyDefinitionGroupNames;
    return this;
  }

  public PolicyState addPolicyDefinitionGroupNamesItem(String policyDefinitionGroupNamesItem) {
    if (this.policyDefinitionGroupNames == null) {
      this.policyDefinitionGroupNames = new ArrayList<>();
    }
    this.policyDefinitionGroupNames.add(policyDefinitionGroupNamesItem);
    return this;
  }

  /**
   * Policy definition group names.
   * @return policyDefinitionGroupNames
   */
  @javax.annotation.Nullable
  public List<String> getPolicyDefinitionGroupNames() {
    return policyDefinitionGroupNames;
  }

  public void setPolicyDefinitionGroupNames(List<String> policyDefinitionGroupNames) {
    this.policyDefinitionGroupNames = policyDefinitionGroupNames;
  }


  public PolicyState policyDefinitionId(String policyDefinitionId) {
  ...
  public PolicyState policyDefinitionName(String policyDefinitionName) {
  ...
  public PolicyState policyDefinitionReferenceId(String policyDefinitionReferenceId) {
  ...
  public PolicyState policyEvaluationDetails(PolicyEvaluationDetails policyEvaluationDetails) {
    this.policyEvaluationDetails = policyEvaluationDetails;
    return this;
  }

  /**
   * Get policyEvaluationDetails
   * @return policyEvaluationDetails
   */
  @javax.annotation.Nullable
  public PolicyEvaluationDetails getPolicyEvaluationDetails() {
    return policyEvaluationDetails;
  }

  public void setPolicyEvaluationDetails(PolicyEvaluationDetails policyEvaluationDetails) {
    this.policyEvaluationDetails = policyEvaluationDetails;
  }


  public PolicyState policySetDefinitionCategory(String policySetDefinitionCategory) {
  ...
  public PolicyState policySetDefinitionId(String policySetDefinitionId) {
  ...
  public PolicyState policySetDefinitionName(String policySetDefinitionName) {
  ...
  public PolicyState policySetDefinitionOwner(String policySetDefinitionOwner) {
  ...
  public PolicyState policySetDefinitionParameters(String policySetDefinitionParameters) {
  ...
  public PolicyState resourceGroup(String resourceGroup) {
  ...
  public PolicyState resourceId(String resourceId) {
  ...
  public PolicyState resourceLocation(String resourceLocation) {
  ...
  public PolicyState resourceTags(String resourceTags) {
  ...
  public PolicyState resourceType(String resourceType) {
  ...
  public PolicyState subscriptionId(String subscriptionId) {
  ...
  public PolicyState timestamp(OffsetDateTime timestamp) {
   ...
   * @return the PolicyState instance itself
   */
  public PolicyState putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atOdataContext, policyState.atOdataContext) &&
        Objects.equals(this.atOdataId, policyState.atOdataId) &&
        Objects.equals(this.complianceState, policyState.complianceState) &&
        Objects.equals(this.effectiveParameters, policyState.effectiveParameters) &&
        Objects.equals(this.isCompliant, policyState.isCompliant) &&
        Objects.equals(this.managementGroupIds, policyState.managementGroupIds) &&
        ...
        Objects.equals(this.policyAssignmentOwner, policyState.policyAssignmentOwner) &&
        Objects.equals(this.policyAssignmentParameters, policyState.policyAssignmentParameters) &&
        Objects.equals(this.policyAssignmentScope, policyState.policyAssignmentScope) &&
        Objects.equals(this.policyDefinitionAction, policyState.policyDefinitionAction) &&
        Objects.equals(this.policyDefinitionCategory, policyState.policyDefinitionCategory) &&
        Objects.equals(this.policyDefinitionGroupNames, policyState.policyDefinitionGroupNames) &&
        Objects.equals(this.policyDefinitionId, policyState.policyDefinitionId) &&
        Objects.equals(this.policyDefinitionName, policyState.policyDefinitionName) &&
        Objects.equals(this.policyDefinitionReferenceId, policyState.policyDefinitionReferenceId) &&
        Objects.equals(this.policyEvaluationDetails, policyState.policyEvaluationDetails) &&
        Objects.equals(this.policySetDefinitionCategory, policyState.policySetDefinitionCategory) &&
        Objects.equals(this.policySetDefinitionId, policyState.policySetDefinitionId) &&
        Objects.equals(this.policySetDefinitionName, policyState.policySetDefinitionName) &&
        Objects.equals(this.policySetDefinitionOwner, policyState.policySetDefinitionOwner) &&
        Objects.equals(this.policySetDefinitionParameters, policyState.policySetDefinitionParameters) &&
        Objects.equals(this.resourceGroup, policyState.resourceGroup) &&
        Objects.equals(this.resourceId, policyState.resourceId) &&
        Objects.equals(this.resourceLocation, policyState.resourceLocation) &&
        Objects.equals(this.resourceTags, policyState.resourceTags) &&
        Objects.equals(this.resourceType, policyState.resourceType) &&
        Objects.equals(this.subscriptionId, policyState.subscriptionId) &&
        Objects.equals(this.timestamp, policyState.timestamp)&&
        Objects.equals(this.additionalProperties, policyState.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atOdataContext, atOdataId, complianceState, effectiveParameters, isCompliant, managementGroupIds, policyAssignmentId, policyAssignmentName, policyAssignmentOwner, policyAssignmentParameters, policyAssignmentScope, policyDefinitionAction, policyDefinitionCategory, policyDefinitionGroupNames, policyDefinitionId, policyDefinitionName, policyDefinitionReferenceId, policyEvaluationDetails, policySetDefinitionCategory, policySetDefinitionId, policySetDefinitionName, policySetDefinitionOwner, policySetDefinitionParameters, resourceGroup, resourceId, resourceLocation, resourceTags, resourceType, subscriptionId, timestamp, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    policyDefinitionGroupNames: ").append(toIndentedString(policyDefinitionGroupNames)).append("\n");
    ...
    sb.append("    policyEvaluationDetails: ").append(toIndentedString(policyEvaluationDetails)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyState is not found in the empty JSON string", PolicyState.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("policyDefinitionGroupNames") != null && !jsonObj.get("policyDefinitionGroupNames").isJsonNull() && !jsonObj.get("policyDefinitionGroupNames").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `policyDefinitionGroupNames` to be an array in the JSON string but got `%s`", jsonObj.get("policyDefinitionGroupNames").toString()));
      }
      ...
      // validate the optional field `policyEvaluationDetails`
      if (jsonObj.get("policyEvaluationDetails") != null && !jsonObj.get("policyEvaluationDetails").isJsonNull()) {
        PolicyEvaluationDetails.validateJsonElement(jsonObj.get("policyEvaluationDetails"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyState.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyState>() {
           @Override
           public void write(JsonWriter out, PolicyState value) throws IOException {
           ...
           @Override
           public PolicyState read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PolicyState instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PolicyState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyState
   * @throws IOException if the JSON string is invalid with respect to PolicyState
   */
  public static PolicyState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyState.class);
  }

  /**
   * Convert an instance of PolicyState to an JSON string
   *
   * @return JSON string
   */
