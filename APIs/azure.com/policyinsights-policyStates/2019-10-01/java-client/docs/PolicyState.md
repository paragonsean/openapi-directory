...
|**isCompliant** | **Boolean** | Flag which states whether the resource is compliant against the policy assignment it was evaluated against. This property is deprecated; please use ComplianceState instead. |  [optional] |
...
|**policyDefinitionGroupNames** | **List&lt;String&gt;** | Policy definition group names. |  [optional] |
