...
(function(root, factory) {
  ...
  describe('PolicyState', function() {
    ...
    it('should have the property policyDefinitionGroupNames (base name: "policyDefinitionGroupNames")', function() {
      // uncomment below and update the code to test the property policyDefinitionGroupNames
      //var instance = new PolicyStatesClient.PolicyState();
      //expect(instance).to.be();
    });
    ...
    it('should have the property policyEvaluationDetails (base name: "policyEvaluationDetails")', function() {
      // uncomment below and update the code to test the property policyEvaluationDetails
      //var instance = new PolicyStatesClient.PolicyState();
      //expect(instance).to.be();
    });
