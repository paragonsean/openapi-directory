...
let resourceGroupName = "resourceGroupName_example"; // String | Resource group name.
let apiVersion = "apiVersion_example"; // String | Client Api Version.
apiInstance.policyStatesTriggerResourceGroupEvaluation(subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let subscriptionId = "subscriptionId_example"; // String | Microsoft Azure subscription ID.
let apiVersion = "apiVersion_example"; // String | Client Api Version.
apiInstance.policyStatesTriggerSubscriptionEvaluation(subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
