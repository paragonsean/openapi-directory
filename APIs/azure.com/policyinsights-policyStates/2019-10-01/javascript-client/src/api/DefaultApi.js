...
export default class DefaultApi {
    ...
    */
     ...
     * @param {String} [filter] OData filter expression.
     * @param {String} [apply] OData apply expression for aggregations.
     * @param {String} [expand] The $expand query parameter. For example, to expand policyEvaluationDetails, use $expand=policyEvaluationDetails
    ...
    /**
     * Callback function to receive the result of the policyStatesTriggerResourceGroupEvaluation operation.
     * @callback module:api/DefaultApi~policyStatesTriggerResourceGroupEvaluationCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} resourceGroupName Resource group name.
     * @param {String} apiVersion Client Api Version.
     * @param {module:api/DefaultApi~policyStatesTriggerResourceGroupEvaluationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    policyStatesTriggerResourceGroupEvaluation(subscriptionId, resourceGroupName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling policyStatesTriggerResourceGroupEvaluation");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling policyStatesTriggerResourceGroupEvaluation");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling policyStatesTriggerResourceGroupEvaluation");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the policyStatesTriggerSubscriptionEvaluation operation.
     * @callback module:api/DefaultApi~policyStatesTriggerSubscriptionEvaluationCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId Microsoft Azure subscription ID.
     * @param {String} apiVersion Client Api Version.
     * @param {module:api/DefaultApi~policyStatesTriggerSubscriptionEvaluationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    policyStatesTriggerSubscriptionEvaluation(subscriptionId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling policyStatesTriggerSubscriptionEvaluation");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling policyStatesTriggerSubscriptionEvaluation");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/policyStates/latest/triggerEvaluation', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
