...
import PolicyGroupSummary from './PolicyGroupSummary';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('policyGroups')) {
                obj['policyGroups'] = ApiClient.convertToType(data['policyGroups'], [PolicyGroupSummary]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['policyGroups']) { // data not null
            ...
            for (const item of data['policyGroups']) {
                PolicyGroupSummary.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/PolicyGroupSummary>} policyGroups
 */
PolicyAssignmentSummary.prototype['policyGroups'] = undefined;
