...
class PolicyState {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('policyEvaluationDetails')) {
                obj['policyEvaluationDetails'] = PolicyEvaluationDetails.constructFromObject(data['policyEvaluationDetails']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['policyEvaluationDetails']) { // data not null
          PolicyEvaluationDetails.validateJSON(data['policyEvaluationDetails']);
        }
        // ensure the json data is a string
 ...
 */
PolicyState.prototype['complianceState'] = undefined;
 ...
 */
PolicyState.prototype['policyDefinitionGroupNames'] = undefined;
...
/**
 * @member {module:model/PolicyEvaluationDetails} policyEvaluationDetails
 */
PolicyState.prototype['policyEvaluationDetails'] = undefined;
