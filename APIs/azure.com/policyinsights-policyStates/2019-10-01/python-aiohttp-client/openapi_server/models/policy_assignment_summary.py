...
from openapi_server.models.policy_group_summary import PolicyGroupSummary
...
class PolicyAssignmentSummary(Model):
    ...
    def __init__(self, policy_assignment_id: str=None, policy_definitions: List[PolicyDefinitionSummary]=None, policy_groups: List[PolicyGroupSummary]=None, policy_set_definition_id: str=None, results: SummaryResults=None):
        ...
        :param policy_groups: The policy_groups of this PolicyAssignmentSummary.
    ...
    def policy_groups(self):
        """Gets the policy_groups of this PolicyAssignmentSummary.

        Policy definition group summary.

        :return: The policy_groups of this PolicyAssignmentSummary.
        :rtype: List[PolicyGroupSummary]
        """
        return self._policy_groups

    @policy_groups.setter
    def policy_groups(self, policy_groups):
        """Sets the policy_groups of this PolicyAssignmentSummary.

        Policy definition group summary.

        :param policy_groups: The policy_groups of this PolicyAssignmentSummary.
        :type policy_groups: List[PolicyGroupSummary]
        """
