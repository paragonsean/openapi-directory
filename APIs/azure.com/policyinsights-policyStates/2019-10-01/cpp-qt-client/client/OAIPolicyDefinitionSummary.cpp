...
QList<QString> OAIPolicyDefinitionSummary::getPolicyDefinitionGroupNames() const {
    return m_policy_definition_group_names;
}
void OAIPolicyDefinitionSummary::setPolicyDefinitionGroupNames(const QList<QString> &policy_definition_group_names) {
    m_policy_definition_group_names = policy_definition_group_names;
    m_policy_definition_group_names_isSet = true;
}

bool OAIPolicyDefinitionSummary::is_policy_definition_group_names_Set() const{
    return m_policy_definition_group_names_isSet;
}

bool OAIPolicyDefinitionSummary::is_policy_definition_group_names_Valid() const{
