...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void policyStatesTriggerResourceGroupEvaluation(const QString &subscription_id, const QString &resource_group_name, const QString &api_version);

    /**
    * @param[in]  subscription_id QString [required]
    * @param[in]  api_version QString [required]
    */
    virtual void policyStatesTriggerSubscriptionEvaluation(const QString &subscription_id, const QString &api_version);
...
private:
    ...
    void policyStatesTriggerResourceGroupEvaluationCallback(OAIHttpRequestWorker *worker);
    void policyStatesTriggerSubscriptionEvaluationCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void policyStatesTriggerResourceGroupEvaluationSignal();
    void policyStatesTriggerSubscriptionEvaluationSignal();
    ...
    void policyStatesTriggerResourceGroupEvaluationSignalFull(OAIHttpRequestWorker *worker);
    void policyStatesTriggerSubscriptionEvaluationSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use policyStatesTriggerResourceGroupEvaluationSignalError() instead")
    void policyStatesTriggerResourceGroupEvaluationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void policyStatesTriggerResourceGroupEvaluationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use policyStatesTriggerSubscriptionEvaluationSignalError() instead")
    void policyStatesTriggerSubscriptionEvaluationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void policyStatesTriggerSubscriptionEvaluationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use policyStatesTriggerResourceGroupEvaluationSignalErrorFull() instead")
    void policyStatesTriggerResourceGroupEvaluationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void policyStatesTriggerResourceGroupEvaluationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use policyStatesTriggerSubscriptionEvaluationSignalErrorFull() instead")
    void policyStatesTriggerSubscriptionEvaluationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void policyStatesTriggerSubscriptionEvaluationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
