...
void OAIPolicyAssignmentSummary::initializeModel() {
    ...
    m_policy_groups_isSet = false;
    m_policy_groups_isValid = false;
...
void OAIPolicyAssignmentSummary::fromJsonObject(QJsonObject json) {
    ...
    m_policy_groups_isValid = ::OpenAPI::fromJsonValue(m_policy_groups, json[QString("policyGroups")]);
    m_policy_groups_isSet = !json[QString("policyGroups")].isNull() && m_policy_groups_isValid;
...
QJsonObject OAIPolicyAssignmentSummary::asJsonObject() const {
    ...
    if (m_policy_groups.size() > 0) {
        obj.insert(QString("policyGroups"), ::OpenAPI::toJsonValue(m_policy_groups));
    }
...
QList<OAIPolicyGroupSummary> OAIPolicyAssignmentSummary::getPolicyGroups() const {
    return m_policy_groups;
}
void OAIPolicyAssignmentSummary::setPolicyGroups(const QList<OAIPolicyGroupSummary> &policy_groups) {
    m_policy_groups = policy_groups;
    m_policy_groups_isSet = true;
}

bool OAIPolicyAssignmentSummary::is_policy_groups_Set() const{
    return m_policy_groups_isSet;
}

bool OAIPolicyAssignmentSummary::is_policy_groups_Valid() const{
    return m_policy_groups_isValid;
}
