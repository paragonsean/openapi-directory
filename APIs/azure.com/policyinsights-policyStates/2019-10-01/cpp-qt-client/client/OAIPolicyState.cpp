...
void OAIPolicyState::initializeModel() {
    ...
    m_policy_definition_group_names_isSet = false;
    m_policy_definition_group_names_isValid = false;
    ...
    m_policy_evaluation_details_isSet = false;
    m_policy_evaluation_details_isValid = false;
...
void OAIPolicyState::fromJsonObject(QJsonObject json) {
    ...
    m_policy_definition_group_names_isValid = ::OpenAPI::fromJsonValue(m_policy_definition_group_names, json[QString("policyDefinitionGroupNames")]);
    m_policy_definition_group_names_isSet = !json[QString("policyDefinitionGroupNames")].isNull() && m_policy_definition_group_names_isValid;
    ...
    m_policy_evaluation_details_isValid = ::OpenAPI::fromJsonValue(m_policy_evaluation_details, json[QString("policyEvaluationDetails")]);
    m_policy_evaluation_details_isSet = !json[QString("policyEvaluationDetails")].isNull() && m_policy_evaluation_details_isValid;
...
QJsonObject OAIPolicyState::asJsonObject() const {
    ...
    if (m_policy_definition_group_names.size() > 0) {
        obj.insert(QString("policyDefinitionGroupNames"), ::OpenAPI::toJsonValue(m_policy_definition_group_names));
    }
    ...
    if (m_policy_evaluation_details.isSet()) {
        obj.insert(QString("policyEvaluationDetails"), ::OpenAPI::toJsonValue(m_policy_evaluation_details));
    }
...
QString OAIPolicyState::getComplianceState() const {
    return m_compliance_state;
}
void OAIPolicyState::setComplianceState(const QString &compliance_state) {
    m_compliance_state = compliance_state;
    m_compliance_state_isSet = true;
}

bool OAIPolicyState::is_compliance_state_Set() const{
    return m_compliance_state_isSet;
}

bool OAIPolicyState::is_compliance_state_Valid() const{
...
QList<QString> OAIPolicyState::getPolicyDefinitionGroupNames() const {
    return m_policy_definition_group_names;
}
void OAIPolicyState::setPolicyDefinitionGroupNames(const QList<QString> &policy_definition_group_names) {
    m_policy_definition_group_names = policy_definition_group_names;
    m_policy_definition_group_names_isSet = true;
}

bool OAIPolicyState::is_policy_definition_group_names_Set() const{
    return m_policy_definition_group_names_isSet;
}

bool OAIPolicyState::is_policy_definition_group_names_Valid() const{
    return m_policy_definition_group_names_isValid;
}
...
OAIPolicyEvaluationDetails OAIPolicyState::getPolicyEvaluationDetails() const {
    return m_policy_evaluation_details;
}
void OAIPolicyState::setPolicyEvaluationDetails(const OAIPolicyEvaluationDetails &policy_evaluation_details) {
    m_policy_evaluation_details = policy_evaluation_details;
    m_policy_evaluation_details_isSet = true;
}

bool OAIPolicyState::is_policy_evaluation_details_Set() const{
    return m_policy_evaluation_details_isSet;
}

bool OAIPolicyState::is_policy_evaluation_details_Valid() const{
    return m_policy_evaluation_details_isValid;
}
