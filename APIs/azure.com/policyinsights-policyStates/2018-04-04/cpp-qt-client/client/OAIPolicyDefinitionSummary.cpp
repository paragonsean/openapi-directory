...
QString OAIPolicyDefinitionSummary::getPolicyDefinitionReferenceId() const {
    return m_policy_definition_reference_id;
}
void OAIPolicyDefinitionSummary::setPolicyDefinitionReferenceId(const QString &policy_definition_reference_id) {
    m_policy_definition_reference_id = policy_definition_reference_id;
    m_policy_definition_reference_id_isSet = true;
}

bool OAIPolicyDefinitionSummary::is_policy_definition_reference_id_Set() const{
    return m_policy_definition_reference_id_isSet;
}

bool OAIPolicyDefinitionSummary::is_policy_definition_reference_id_Valid() const{
