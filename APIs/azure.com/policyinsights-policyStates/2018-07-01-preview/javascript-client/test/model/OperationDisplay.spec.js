...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolicyStatesClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new PolicyStatesClient.OperationDisplay();
      //expect(instance).to.be.a(PolicyStatesClient.OperationDisplay);
    });
