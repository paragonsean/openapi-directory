...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolicyStatesClient.SummarizeResults();
  });
  ...
  describe('SummarizeResults', function() {
    it('should create an instance of SummarizeResults', function() {
      // uncomment below and update the code to test SummarizeResults
      //var instance = new PolicyStatesClient.SummarizeResults();
      //expect(instance).to.be.a(PolicyStatesClient.SummarizeResults);
    });
