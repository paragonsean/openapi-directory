...
|------------ | ------------- | ------------- | -------------|
|**atOdataContext** | **String** | OData context string; used by OData clients to resolve type information based on metadata. |  [optional] |
|**atOdataId** | **String** | OData entity ID; always set to null since policy state records do not have an entity ID. |  [optional] |
...
|**timestamp** | **OffsetDateTime** | Timestamp for the policy state record. |  [optional] |
