...
public class JobErrorAction {
  ...
  public JobErrorAction queueMessage(StorageQueueMessage queueMessage) {
  ...
  public JobErrorAction request(HttpRequest request) {
  ...
  public JobErrorAction retryPolicy(RetryPolicy retryPolicy) {
  ...
  public JobErrorAction serviceBusQueueMessage(ServiceBusQueueMessage serviceBusQueueMessage) {
  ...
  public JobErrorAction serviceBusTopicMessage(ServiceBusTopicMessage serviceBusTopicMessage) {
  ...
  public JobErrorAction type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JobErrorAction jobErrorAction = (JobErrorAction) o;
    return Objects.equals(this.queueMessage, jobErrorAction.queueMessage) &&
        Objects.equals(this.request, jobErrorAction.request) &&
        Objects.equals(this.retryPolicy, jobErrorAction.retryPolicy) &&
        Objects.equals(this.serviceBusQueueMessage, jobErrorAction.serviceBusQueueMessage) &&
        Objects.equals(this.serviceBusTopicMessage, jobErrorAction.serviceBusTopicMessage) &&
        Objects.equals(this.type, jobErrorAction.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(queueMessage, request, retryPolicy, serviceBusQueueMessage, serviceBusTopicMessage, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JobErrorAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobErrorAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobErrorAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobErrorAction is not found in the empty JSON string", JobErrorAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobErrorAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobErrorAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobErrorAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobErrorAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobErrorAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobErrorAction.class));

       return (TypeAdapter<T>) new TypeAdapter<JobErrorAction>() {
           @Override
           public void write(JsonWriter out, JobErrorAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobErrorAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobErrorAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobErrorAction
   * @throws IOException if the JSON string is invalid with respect to JobErrorAction
   */
  public static JobErrorAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobErrorAction.class);
  }

  /**
   * Convert an instance of JobErrorAction to an JSON string
   *
   * @return JSON string
   */
