...
public class ServiceBusTopicMessage {
  public static final String SERIALIZED_NAME_TOPIC_PATH = "topicPath";
  @SerializedName(SERIALIZED_NAME_TOPIC_PATH)
  ...
  public ServiceBusTopicMessage topicPath(String topicPath) {
  ...
  public ServiceBusTopicMessage authentication(ServiceBusAuthentication authentication) {
  ...
  public ServiceBusTopicMessage brokeredMessageProperties(ServiceBusBrokeredMessageProperties brokeredMessageProperties) {
  ...
  public ServiceBusTopicMessage customMessageProperties(Map<String, String> customMessageProperties) {
    this.customMessageProperties = customMessageProperties;
    return this;
  }

  public ServiceBusTopicMessage putCustomMessagePropertiesItem(String key, String customMessagePropertiesItem) {
  ...
  public ServiceBusTopicMessage message(String message) {
  ...
  public ServiceBusTopicMessage namespace(String namespace) {
  ...
  public ServiceBusTopicMessage transportType(TransportTypeEnum transportType) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceBusTopicMessage serviceBusTopicMessage = (ServiceBusTopicMessage) o;
    return Objects.equals(this.topicPath, serviceBusTopicMessage.topicPath) &&
        Objects.equals(this.authentication, serviceBusTopicMessage.authentication) &&
        Objects.equals(this.brokeredMessageProperties, serviceBusTopicMessage.brokeredMessageProperties) &&
        Objects.equals(this.customMessageProperties, serviceBusTopicMessage.customMessageProperties) &&
        Objects.equals(this.message, serviceBusTopicMessage.message) &&
        Objects.equals(this.namespace, serviceBusTopicMessage.namespace) &&
        Objects.equals(this.transportType, serviceBusTopicMessage.transportType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(topicPath, authentication, brokeredMessageProperties, customMessageProperties, message, namespace, transportType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServiceBusTopicMessage {\n");
    sb.append("    topicPath: ").append(toIndentedString(topicPath)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceBusTopicMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceBusTopicMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceBusTopicMessage is not found in the empty JSON string", ServiceBusTopicMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceBusTopicMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceBusTopicMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("topicPath") != null && !jsonObj.get("topicPath").isJsonNull()) && !jsonObj.get("topicPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `topicPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("topicPath").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceBusTopicMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceBusTopicMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceBusTopicMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceBusTopicMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceBusTopicMessage>() {
           @Override
           public void write(JsonWriter out, ServiceBusTopicMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceBusTopicMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceBusTopicMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceBusTopicMessage
   * @throws IOException if the JSON string is invalid with respect to ServiceBusTopicMessage
   */
  public static ServiceBusTopicMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceBusTopicMessage.class);
  }

  /**
   * Convert an instance of ServiceBusTopicMessage to an JSON string
   *
   * @return JSON string
   */
