...
| **202** | The delete operation for the job collection has been accepted and will complete asynchronously. |  -  |
...
| **202** | Accepted and the disable job collection operation will complete asynchronously. |  -  |
...
| **202** | Accepted and the enable job collection operation will complete asynchronously. |  -  |
