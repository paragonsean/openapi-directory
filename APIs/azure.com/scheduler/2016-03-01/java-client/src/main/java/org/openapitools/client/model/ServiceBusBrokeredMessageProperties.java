...
public class ServiceBusBrokeredMessageProperties {
  ...
  public ServiceBusBrokeredMessageProperties timeToLive(String timeToLive) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("timeToLive") != null && !jsonObj.get("timeToLive").isJsonNull()) && !jsonObj.get("timeToLive").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `timeToLive` to be a primitive type in the JSON string but got `%s`", jsonObj.get("timeToLive").toString()));
      }
