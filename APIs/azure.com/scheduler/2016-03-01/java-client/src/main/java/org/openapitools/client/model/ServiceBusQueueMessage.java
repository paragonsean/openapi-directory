...
public class ServiceBusQueueMessage {
  ...
  public ServiceBusQueueMessage queueName(String queueName) {
  ...
  public ServiceBusQueueMessage authentication(ServiceBusAuthentication authentication) {
  ...
  public ServiceBusQueueMessage brokeredMessageProperties(ServiceBusBrokeredMessageProperties brokeredMessageProperties) {
  ...
  public ServiceBusQueueMessage customMessageProperties(Map<String, String> customMessageProperties) {
    this.customMessageProperties = customMessageProperties;
    return this;
  }

  public ServiceBusQueueMessage putCustomMessagePropertiesItem(String key, String customMessagePropertiesItem) {
  ...
  public ServiceBusQueueMessage message(String message) {
  ...
  public ServiceBusQueueMessage namespace(String namespace) {
  ...
  public ServiceBusQueueMessage transportType(TransportTypeEnum transportType) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceBusQueueMessage serviceBusQueueMessage = (ServiceBusQueueMessage) o;
    return Objects.equals(this.queueName, serviceBusQueueMessage.queueName) &&
        Objects.equals(this.authentication, serviceBusQueueMessage.authentication) &&
        Objects.equals(this.brokeredMessageProperties, serviceBusQueueMessage.brokeredMessageProperties) &&
        Objects.equals(this.customMessageProperties, serviceBusQueueMessage.customMessageProperties) &&
        Objects.equals(this.message, serviceBusQueueMessage.message) &&
        Objects.equals(this.namespace, serviceBusQueueMessage.namespace) &&
        Objects.equals(this.transportType, serviceBusQueueMessage.transportType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(queueName, authentication, brokeredMessageProperties, customMessageProperties, message, namespace, transportType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServiceBusQueueMessage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceBusQueueMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceBusQueueMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceBusQueueMessage is not found in the empty JSON string", ServiceBusQueueMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceBusQueueMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceBusQueueMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceBusQueueMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceBusQueueMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceBusQueueMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceBusQueueMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceBusQueueMessage>() {
           @Override
           public void write(JsonWriter out, ServiceBusQueueMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceBusQueueMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceBusQueueMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceBusQueueMessage
   * @throws IOException if the JSON string is invalid with respect to ServiceBusQueueMessage
   */
  public static ServiceBusQueueMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceBusQueueMessage.class);
  }

  /**
   * Convert an instance of ServiceBusQueueMessage to an JSON string
   *
   * @return JSON string
   */
