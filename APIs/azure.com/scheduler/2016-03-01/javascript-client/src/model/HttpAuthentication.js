...
class HttpAuthentication {
     ...
     * @param type {module:model/HttpAuthentication.TypeEnum} Gets or sets the HTTP authentication type.
     */
    constructor(type) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of HttpAuthentication.RequiredProperties) {
...
HttpAuthentication.RequiredProperties = ["type"];
