...
OAIJobRecurrenceSchedule::OAIJobRecurrenceSchedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobRecurrenceSchedule::OAIJobRecurrenceSchedule() {
    this->initializeModel();
}

OAIJobRecurrenceSchedule::~OAIJobRecurrenceSchedule() {}

void OAIJobRecurrenceSchedule::initializeModel() {
...
void OAIJobRecurrenceSchedule::fromJson(QString jsonString) {
...
void OAIJobRecurrenceSchedule::fromJsonObject(QJsonObject json) {
...
QString OAIJobRecurrenceSchedule::asJson() const {
...
QJsonObject OAIJobRecurrenceSchedule::asJsonObject() const {
    QJsonObject obj;
    if (m_hours.size() > 0) {
...
QList<qint32> OAIJobRecurrenceSchedule::getHours() const {
    return m_hours;
}
void OAIJobRecurrenceSchedule::setHours(const QList<qint32> &hours) {
    m_hours = hours;
    m_hours_isSet = true;
}

bool OAIJobRecurrenceSchedule::is_hours_Set() const{
    return m_hours_isSet;
}

bool OAIJobRecurrenceSchedule::is_hours_Valid() const{
    return m_hours_isValid;
}

QList<qint32> OAIJobRecurrenceSchedule::getMinutes() const {
    return m_minutes;
}
void OAIJobRecurrenceSchedule::setMinutes(const QList<qint32> &minutes) {
    m_minutes = minutes;
    m_minutes_isSet = true;
}

bool OAIJobRecurrenceSchedule::is_minutes_Set() const{
    return m_minutes_isSet;
}

bool OAIJobRecurrenceSchedule::is_minutes_Valid() const{
    return m_minutes_isValid;
}

QList<qint32> OAIJobRecurrenceSchedule::getMonthDays() const {
    return m_month_days;
}
void OAIJobRecurrenceSchedule::setMonthDays(const QList<qint32> &month_days) {
    m_month_days = month_days;
    m_month_days_isSet = true;
}

bool OAIJobRecurrenceSchedule::is_month_days_Set() const{
    return m_month_days_isSet;
}

bool OAIJobRecurrenceSchedule::is_month_days_Valid() const{
    return m_month_days_isValid;
}

QList<OAIJobRecurrenceScheduleMonthlyOccurrence> OAIJobRecurrenceSchedule::getMonthlyOccurrences() const {
    return m_monthly_occurrences;
}
void OAIJobRecurrenceSchedule::setMonthlyOccurrences(const QList<OAIJobRecurrenceScheduleMonthlyOccurrence> &monthly_occurrences) {
    m_monthly_occurrences = monthly_occurrences;
    m_monthly_occurrences_isSet = true;
}

bool OAIJobRecurrenceSchedule::is_monthly_occurrences_Set() const{
    return m_monthly_occurrences_isSet;
}

bool OAIJobRecurrenceSchedule::is_monthly_occurrences_Valid() const{
    return m_monthly_occurrences_isValid;
}

QList<QString> OAIJobRecurrenceSchedule::getWeekDays() const {
    return m_week_days;
}
void OAIJobRecurrenceSchedule::setWeekDays(const QList<QString> &week_days) {
    m_week_days = week_days;
    m_week_days_isSet = true;
}

bool OAIJobRecurrenceSchedule::is_week_days_Set() const{
    return m_week_days_isSet;
}

bool OAIJobRecurrenceSchedule::is_week_days_Valid() const{
    return m_week_days_isValid;
}

bool OAIJobRecurrenceSchedule::isSet() const {
...
bool OAIJobRecurrenceSchedule::isValid() const {
