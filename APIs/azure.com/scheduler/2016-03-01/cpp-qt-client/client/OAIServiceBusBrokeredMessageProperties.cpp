...
QString OAIServiceBusBrokeredMessageProperties::getTimeToLive() const {
    return m_time_to_live;
}
void OAIServiceBusBrokeredMessageProperties::setTimeToLive(const QString &time_to_live) {
