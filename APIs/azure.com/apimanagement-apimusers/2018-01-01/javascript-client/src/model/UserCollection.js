    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = ApiClient.convertToType(data['value'], [UserContract]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['value']) { // data not null
            ...
            for (const item of data['value']) {
                UserContract.validateJSON(item);
            };
        }
 ...
 */
UserCollection.prototype['nextLink'] = undefined;

/**
 * Page values.
 * @member {Array.<module:model/UserContract>} value
 */
UserCollection.prototype['value'] = undefined;
