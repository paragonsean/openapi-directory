...
(function(root, factory) {
  ...
  describe('UsersApi', function() {
    ...
    describe('userGetIdentity', function() {
      it('should call userGetIdentity successfully', function(done) {
        //uncomment below and update the code to test userGetIdentity
        //instance.userGetIdentity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
