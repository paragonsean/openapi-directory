...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.UserContractProperties();
  });
  ...
  describe('UserContractProperties', function() {
    it('should create an instance of UserContractProperties', function() {
      // uncomment below and update the code to test UserContractProperties
      //var instance = new ApiManagementClient.UserContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.UserContractProperties);
    });
