...
/*
 * OAIUserUpdateParametersProperties.h
 *
 * Parameters supplied to the Update User operation.
 */

#ifndef OAIUserUpdateParametersProperties_H
#define OAIUserUpdateParametersProperties_H
...
class OAIUserUpdateParametersProperties : public OAIObject {
public:
    OAIUserUpdateParametersProperties();
    OAIUserUpdateParametersProperties(QString json);
    ~OAIUserUpdateParametersProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserUpdateParametersProperties)

#endif // OAIUserUpdateParametersProperties_H
