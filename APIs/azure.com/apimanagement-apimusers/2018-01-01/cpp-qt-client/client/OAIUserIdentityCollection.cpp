...
qint64 OAIUserIdentityCollection::getCount() const {
    return m_count;
}
void OAIUserIdentityCollection::setCount(const qint64 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIUserIdentityCollection::is_count_Set() const{
    return m_count_isSet;
}

bool OAIUserIdentityCollection::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIUserIdentityCollection::getNextLink() const {
    return m_next_link;
}
void OAIUserIdentityCollection::setNextLink(const QString &next_link) {
    m_next_link = next_link;
    m_next_link_isSet = true;
}

bool OAIUserIdentityCollection::is_next_link_Set() const{
    return m_next_link_isSet;
}

bool OAIUserIdentityCollection::is_next_link_Valid() const{
