...
async def user_group_list(request: web.Request, resource_group_name, service_name, uid, api_version, subscription_id, filter=None, top=None, skip=None) -> web.Response:
    """user_group_list
