...
bool OAIUserSubscription_List_200_response_value_inner_properties::isAllowTracing() const {
    return m_allow_tracing;
}
void OAIUserSubscription_List_200_response_value_inner_properties::setAllowTracing(const bool &allow_tracing) {
    m_allow_tracing = allow_tracing;
    m_allow_tracing_isSet = true;
}

bool OAIUserSubscription_List_200_response_value_inner_properties::is_allow_tracing_Set() const{
    return m_allow_tracing_isSet;
}

bool OAIUserSubscription_List_200_response_value_inner_properties::is_allow_tracing_Valid() const{
...
QString OAIUserSubscription_List_200_response_value_inner_properties::getOwnerId() const {
    return m_owner_id;
}
void OAIUserSubscription_List_200_response_value_inner_properties::setOwnerId(const QString &owner_id) {
    m_owner_id = owner_id;
    m_owner_id_isSet = true;
}

bool OAIUserSubscription_List_200_response_value_inner_properties::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAIUserSubscription_List_200_response_value_inner_properties::is_owner_id_Valid() const{
...
QString OAIUserSubscription_List_200_response_value_inner_properties::getScope() const {
    return m_scope;
}
void OAIUserSubscription_List_200_response_value_inner_properties::setScope(const QString &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAIUserSubscription_List_200_response_value_inner_properties::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAIUserSubscription_List_200_response_value_inner_properties::is_scope_Valid() const{
