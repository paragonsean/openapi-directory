...
# **userCreateOrUpdate**
> UserGet200Response userCreateOrUpdate(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, parameters, notify, ifMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean notify = true; // Boolean | Send an Email notification to the User.
    ...
    try {
      UserGet200Response result = apiInstance.userCreateOrUpdate(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, parameters, notify, ifMatch);
...
<a id="userDelete"></a>
# **userDelete**
> userDelete(resourceGroupName, serviceName, userId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions, notify, appType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.userDelete(resourceGroupName, serviceName, userId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions, notify, appType);
    } catch (ApiException e) {
