...
|------------- | ------------- | -------------|
| [**userGroupList**](UserGroupApi.md#userGroupList) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/groups |  |


<a id="userGroupList"></a>
# **userGroupList**
> UserGroupList200Response userGroupList(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, $filter, $top, $skip)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserGroupList200Response result = apiInstance.userGroupList(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, $filter, $top, $skip);
