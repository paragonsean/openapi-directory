...
async def user_create_or_update(request: web.Request, resource_group_name, service_name, user_id, api_version, subscription_id, parameters, notify=None, if_match=None) -> web.Response:
...
async def user_delete(request: web.Request, resource_group_name, service_name, user_id, if_match, api_version, subscription_id, delete_subscriptions=None, notify=None, app_type=None) -> web.Response:
    """user_delete
