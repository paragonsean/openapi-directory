...
class UserSubscriptionList200ResponseValueInnerProperties {
    ...
    constructor(primaryKey, scope, secondaryKey, state) { 
        ...
        UserSubscriptionList200ResponseValueInnerProperties.initialize(this, primaryKey, scope, secondaryKey, state);
    }
...
UserSubscriptionList200ResponseValueInnerProperties.RequiredProperties = ["primaryKey", "scope", "secondaryKey", "state"];
