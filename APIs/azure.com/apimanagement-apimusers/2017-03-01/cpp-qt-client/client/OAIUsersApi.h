...
public:
    ...
    */
    virtual void userCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &uid, const QString &api_version, const QString &subscription_id, const OAIUserCreateParameters &parameters);
    ...
    */
    virtual void userDelete(const QString &resource_group_name, const QString &service_name, const QString &uid, const QString &if_match, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<bool> &delete_subscriptions = ::OpenAPI::OptionalParam<bool>());
