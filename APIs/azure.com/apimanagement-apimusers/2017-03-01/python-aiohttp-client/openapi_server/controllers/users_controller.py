...
async def user_create_or_update(request: web.Request, resource_group_name, service_name, uid, api_version, subscription_id, parameters) -> web.Response:
...
async def user_delete(request: web.Request, resource_group_name, service_name, uid, if_match, api_version, subscription_id, delete_subscriptions=None) -> web.Response:
    """user_delete
    ...
    :param uid: User identifier. Must be unique in the current API Management service instance.
    :type uid: str
    :param if_match: The entity state (Etag) version of the user to delete. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation.
    :type if_match: str
    :param api_version: Version of the API to be used with the client request.
    :type api_version: str
    :param subscription_id: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
...
async def user_update(request: web.Request, resource_group_name, service_name, uid, if_match, api_version, subscription_id, parameters) -> web.Response:
    ...
    :param uid: User identifier. Must be unique in the current API Management service instance.
    :type uid: str
    :param if_match: The entity state (Etag) version of the user to update. A value of \&quot;*\&quot; can be used for If-Match to unconditionally apply the operation.
    :type if_match: str
    :param api_version: Version of the API to be used with the client request.
    :type api_version: str
    :param subscription_id: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
