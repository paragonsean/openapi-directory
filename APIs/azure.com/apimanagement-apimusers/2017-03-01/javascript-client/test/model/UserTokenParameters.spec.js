...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.UserTokenParameters();
  });
  ...
  describe('UserTokenParameters', function() {
    it('should create an instance of UserTokenParameters', function() {
      // uncomment below and update the code to test UserTokenParameters
      //var instance = new ApiManagementClient.UserTokenParameters();
      //expect(instance).to.be.a(ApiManagementClient.UserTokenParameters);
    });
