# ApiManagementClient.UserSubscriptionsApi
...
> UserSubscriptionList200Response userSubscriptionList(resourceGroupName, serviceName, uid, apiVersion, subscriptionId, opts)
...
let apiInstance = new ApiManagementClient.UserSubscriptionsApi();
...
apiInstance.userSubscriptionList(resourceGroupName, serviceName, uid, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
