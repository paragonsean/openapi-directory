...
class UserSubscriptionList200ResponseValueInnerProperties {
    ...
    constructor(primaryKey, productId, secondaryKey, state, userId) { 
        ...
        UserSubscriptionList200ResponseValueInnerProperties.initialize(this, primaryKey, productId, secondaryKey, state, userId);
    }
...
UserSubscriptionList200ResponseValueInnerProperties.RequiredProperties = ["primaryKey", "productId", "secondaryKey", "state", "userId"];
 ...
 */
UserSubscriptionList200ResponseValueInnerProperties.prototype['productId'] = undefined;
 ...
 */
UserSubscriptionList200ResponseValueInnerProperties.prototype['userId'] = undefined;
