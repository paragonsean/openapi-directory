...
async def user_subscriptions_list_by_users(request: web.Request, resource_group_name, service_name, uid, api_version, subscription_id, filter=None, top=None, skip=None) -> web.Response:
