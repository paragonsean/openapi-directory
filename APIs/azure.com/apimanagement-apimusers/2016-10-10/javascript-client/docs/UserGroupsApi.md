...
------------- | ------------- | -------------
[**userGroupsListByUsers**](UserGroupsApi.md#userGroupsListByUsers) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{uid}/groups | 



## userGroupsListByUsers

> UserGroupsListByUsers200Response userGroupsListByUsers(resourceGroupName, serviceName, uid, apiVersion, subscriptionId, opts)
...
apiInstance.userGroupsListByUsers(resourceGroupName, serviceName, uid, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**UserGroupsListByUsers200Response**](UserGroupsListByUsers200Response.md)
