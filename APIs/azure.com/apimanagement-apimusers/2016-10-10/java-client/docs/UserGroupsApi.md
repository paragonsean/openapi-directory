...
<a id="userGroupsListByUsers"></a>
# **userGroupsListByUsers**
> UserGroupsListByUsers200Response userGroupsListByUsers(resourceGroupName, serviceName, uid, apiVersion, subscriptionId, $filter, $top, $skip)
