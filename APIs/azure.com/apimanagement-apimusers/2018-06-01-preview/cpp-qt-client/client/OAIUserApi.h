...
public:
    ...
    */
    virtual void userCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &user_id, const QString &api_version, const QString &subscription_id, const OAIUser_CreateOrUpdate_request &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
