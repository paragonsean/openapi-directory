...
QDateTime OAIUser_GetSharedAccessToken_request::getExpiry() const {
    return m_expiry;
}
void OAIUser_GetSharedAccessToken_request::setExpiry(const QDateTime &expiry) {
    m_expiry = expiry;
    m_expiry_isSet = true;
}

bool OAIUser_GetSharedAccessToken_request::is_expiry_Set() const{
    return m_expiry_isSet;
}

bool OAIUser_GetSharedAccessToken_request::is_expiry_Valid() const{
    return m_expiry_isValid;
}

QString OAIUser_GetSharedAccessToken_request::getKeyType() const {
    return m_key_type;
}
void OAIUser_GetSharedAccessToken_request::setKeyType(const QString &key_type) {
    m_key_type = key_type;
    m_key_type_isSet = true;
}

bool OAIUser_GetSharedAccessToken_request::is_key_type_Set() const{
    return m_key_type_isSet;
}

bool OAIUser_GetSharedAccessToken_request::is_key_type_Valid() const{
