...
public class UserApi {
     ...
     */
    public okhttp3.Call userCreateOrUpdateCall(String resourceGroupName, String serviceName, String userId, String apiVersion, String subscriptionId, UserCreateOrUpdateRequest parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call userCreateOrUpdateValidateBeforeCall(String resourceGroupName, String serviceName, String userId, String apiVersion, String subscriptionId, UserCreateOrUpdateRequest parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
        ...
        return userCreateOrUpdateCall(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, parameters, ifMatch, _callback);
     ...
     */
    public UserGet200Response userCreateOrUpdate(String resourceGroupName, String serviceName, String userId, String apiVersion, String subscriptionId, UserCreateOrUpdateRequest parameters, String ifMatch) throws ApiException {
        ApiResponse<UserGet200Response> localVarResp = userCreateOrUpdateWithHttpInfo(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, parameters, ifMatch);
     ...
     */
    public ApiResponse<UserGet200Response> userCreateOrUpdateWithHttpInfo(String resourceGroupName, String serviceName, String userId, String apiVersion, String subscriptionId, UserCreateOrUpdateRequest parameters, String ifMatch) throws ApiException {
        okhttp3.Call localVarCall = userCreateOrUpdateValidateBeforeCall(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, parameters, ifMatch, null);
     ...
     */
    public okhttp3.Call userCreateOrUpdateAsync(String resourceGroupName, String serviceName, String userId, String apiVersion, String subscriptionId, UserCreateOrUpdateRequest parameters, String ifMatch, final ApiCallback<UserGet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = userCreateOrUpdateValidateBeforeCall(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, parameters, ifMatch, _callback);
        Type localVarReturnType = new TypeToken<UserGet200Response>(){}.getType();
     ...
     */
    public okhttp3.Call userDeleteCall(String resourceGroupName, String serviceName, String userId, String ifMatch, String apiVersion, String subscriptionId, Boolean deleteSubscriptions, Boolean notify, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call userDeleteValidateBeforeCall(String resourceGroupName, String serviceName, String userId, String ifMatch, String apiVersion, String subscriptionId, Boolean deleteSubscriptions, Boolean notify, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return userDeleteCall(resourceGroupName, serviceName, userId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions, notify, _callback);
     ...
     */
    public void userDelete(String resourceGroupName, String serviceName, String userId, String ifMatch, String apiVersion, String subscriptionId, Boolean deleteSubscriptions, Boolean notify) throws ApiException {
        userDeleteWithHttpInfo(resourceGroupName, serviceName, userId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions, notify);
    }
     ...
     */
    public ApiResponse<Void> userDeleteWithHttpInfo(String resourceGroupName, String serviceName, String userId, String ifMatch, String apiVersion, String subscriptionId, Boolean deleteSubscriptions, Boolean notify) throws ApiException {
        okhttp3.Call localVarCall = userDeleteValidateBeforeCall(resourceGroupName, serviceName, userId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions, notify, null);
     ...
     */
    public okhttp3.Call userDeleteAsync(String resourceGroupName, String serviceName, String userId, String ifMatch, String apiVersion, String subscriptionId, Boolean deleteSubscriptions, Boolean notify, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = userDeleteValidateBeforeCall(resourceGroupName, serviceName, userId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions, notify, _callback);
