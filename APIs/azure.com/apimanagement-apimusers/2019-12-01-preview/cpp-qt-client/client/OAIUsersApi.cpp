...
void OAIUsersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("userGenerateSsoUrl", defaultConf);
    _serverIndices.insert("userGenerateSsoUrl", 0);
}
...
void OAIUsersApi::userGenerateSsoUrl(const QString &resource_group_name, const QString &service_name, const QString &user_id, const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["userGenerateSsoUrl"][_serverIndices.value("userGenerateSsoUrl")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{userId}/generateSsoUrl");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::userGenerateSsoUrlCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::userGenerateSsoUrlCallback);
...
void OAIUsersApi::userGenerateSsoUrlCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIUser_GenerateSsoUrl_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT userGenerateSsoUrlSignal(output);
        Q_EMIT userGenerateSsoUrlSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT userGenerateSsoUrlSignalE(output, error_type, error_str);
        Q_EMIT userGenerateSsoUrlSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT userGenerateSsoUrlSignalError(output, error_type, error_str);
        Q_EMIT userGenerateSsoUrlSignalErrorFull(worker, error_type, error_str);
    }
}
