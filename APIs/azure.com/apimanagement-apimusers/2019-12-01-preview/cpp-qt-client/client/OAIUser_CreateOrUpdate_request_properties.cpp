...
QString OAIUser_CreateOrUpdate_request_properties::getAppType() const {
    return m_app_type;
}
void OAIUser_CreateOrUpdate_request_properties::setAppType(const QString &app_type) {
    m_app_type = app_type;
    m_app_type_isSet = true;
}

bool OAIUser_CreateOrUpdate_request_properties::is_app_type_Set() const{
    return m_app_type_isSet;
}

bool OAIUser_CreateOrUpdate_request_properties::is_app_type_Valid() const{
