# ApiManagementClient.UserIdentityApi
...
let apiInstance = new ApiManagementClient.UserIdentityApi();
...
apiInstance.userIdentitiesList(resourceGroupName, serviceName, userId, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
