...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("availableEndpointServicesList", defaultConf);
    _serverIndices.insert("availableEndpointServicesList", 0);
}
...
void OAIDefaultApi::availableEndpointServicesList(const QString &location, const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["availableEndpointServicesList"][_serverIndices.value("availableEndpointServicesList")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/virtualNetworkAvailableEndpointServices");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::availableEndpointServicesListCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::availableEndpointServicesListCallback);
...
void OAIDefaultApi::availableEndpointServicesListCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIEndpointServicesListResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT availableEndpointServicesListSignal(output);
        Q_EMIT availableEndpointServicesListSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT availableEndpointServicesListSignalE(output, error_type, error_str);
        Q_EMIT availableEndpointServicesListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT availableEndpointServicesListSignalError(output, error_type, error_str);
        Q_EMIT availableEndpointServicesListSignalErrorFull(worker, error_type, error_str);
    }
}
