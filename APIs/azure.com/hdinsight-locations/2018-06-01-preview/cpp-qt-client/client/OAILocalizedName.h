...
#ifndef OAILocalizedName_H
#define OAILocalizedName_H
...
class OAILocalizedName : public OAIObject {
public:
    OAILocalizedName();
    OAILocalizedName(QString json);
    ~OAILocalizedName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocalizedName)

#endif // OAILocalizedName_H
