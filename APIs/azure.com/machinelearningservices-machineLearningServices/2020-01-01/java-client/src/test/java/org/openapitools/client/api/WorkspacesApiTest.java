...
public class WorkspacesApiTest {
     ...
     */
    @Test
    public void workspaceFeaturesListTest() throws ApiException {
        String apiVersion = null;
        String subscriptionId = null;
        String resourceGroupName = null;
        String workspaceName = null;
        ListAmlUserFeatureResult response = api.workspaceFeaturesList(apiVersion, subscriptionId, resourceGroupName, workspaceName);
