...
public class AmlComputeAllOfProperties {
   ...
   */
  @JsonAdapter(RemoteLoginPortPublicAccessEnum.Adapter.class)
  public enum RemoteLoginPortPublicAccessEnum {
    ENABLED("Enabled"),
    ...
    RemoteLoginPortPublicAccessEnum(String value) {
      this.value = value;
    }
    ...
    public static RemoteLoginPortPublicAccessEnum fromValue(String value) {
      for (RemoteLoginPortPublicAccessEnum b : RemoteLoginPortPublicAccessEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<RemoteLoginPortPublicAccessEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RemoteLoginPortPublicAccessEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RemoteLoginPortPublicAccessEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RemoteLoginPortPublicAccessEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      RemoteLoginPortPublicAccessEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_REMOTE_LOGIN_PORT_PUBLIC_ACCESS = "remoteLoginPortPublicAccess";
  @SerializedName(SERIALIZED_NAME_REMOTE_LOGIN_PORT_PUBLIC_ACCESS)
  private RemoteLoginPortPublicAccessEnum remoteLoginPortPublicAccess = RemoteLoginPortPublicAccessEnum.NOT_SPECIFIED;
  ...
  public AmlComputeAllOfProperties remoteLoginPortPublicAccess(RemoteLoginPortPublicAccessEnum remoteLoginPortPublicAccess) {
   ...
   */
  @javax.annotation.Nullable
  public RemoteLoginPortPublicAccessEnum getRemoteLoginPortPublicAccess() {
    return remoteLoginPortPublicAccess;
  }

  public void setRemoteLoginPortPublicAccess(RemoteLoginPortPublicAccessEnum remoteLoginPortPublicAccess) {
    this.remoteLoginPortPublicAccess = remoteLoginPortPublicAccess;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allocationState, amlComputeAllOfProperties.allocationState) &&
        ...
        Objects.equals(this.remoteLoginPortPublicAccess, amlComputeAllOfProperties.remoteLoginPortPublicAccess) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allocationState, allocationStateTransitionTime, currentNodeCount, errors, nodeStateCounts, remoteLoginPortPublicAccess, scaleSettings, subnet, targetNodeCount, userAccountCredentials, vmPriority, vmSize);
  }
  ...
  public String toString() {
    ...
    sb.append("    remoteLoginPortPublicAccess: ").append(toIndentedString(remoteLoginPortPublicAccess)).append("\n");
  ...
  static {
    ...
    openapiFields.add("remoteLoginPortPublicAccess");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("remoteLoginPortPublicAccess") != null && !jsonObj.get("remoteLoginPortPublicAccess").isJsonNull()) && !jsonObj.get("remoteLoginPortPublicAccess").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `remoteLoginPortPublicAccess` to be a primitive type in the JSON string but got `%s`", jsonObj.get("remoteLoginPortPublicAccess").toString()));
      }
      // validate the optional field `remoteLoginPortPublicAccess`
      if (jsonObj.get("remoteLoginPortPublicAccess") != null && !jsonObj.get("remoteLoginPortPublicAccess").isJsonNull()) {
        RemoteLoginPortPublicAccessEnum.validateJsonElement(jsonObj.get("remoteLoginPortPublicAccess"));
      }
