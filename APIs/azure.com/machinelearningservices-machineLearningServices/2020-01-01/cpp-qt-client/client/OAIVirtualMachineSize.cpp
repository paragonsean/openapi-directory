...
qint32 OAIVirtualMachineSize::getGpus() const {
    return m_gpus;
}
void OAIVirtualMachineSize::setGpus(const qint32 &gpus) {
    m_gpus = gpus;
    m_gpus_isSet = true;
}

bool OAIVirtualMachineSize::is_gpus_Set() const{
    return m_gpus_isSet;
}

bool OAIVirtualMachineSize::is_gpus_Valid() const{
