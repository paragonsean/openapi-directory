...
public:
    ...
    */
    virtual void usagesList(const QString &api_version, const QString &subscription_id, const QString &location);
...
Q_SIGNALS:
    ...
    void usagesListSignal(OAIListUsagesResult summary);


    void usagesListSignalFull(OAIHttpRequestWorker *worker, OAIListUsagesResult summary);

    Q_DECL_DEPRECATED_X("Use usagesListSignalError() instead")
    void usagesListSignalE(OAIListUsagesResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void usagesListSignalError(OAIListUsagesResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
