...
apiInstance.machineLearningComputeDelete(subscriptionId, resourceGroupName, workspaceName, computeName, apiVersion, underlyingResourceAction, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.machineLearningComputeUpdate(subscriptionId, resourceGroupName, workspaceName, computeName, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
