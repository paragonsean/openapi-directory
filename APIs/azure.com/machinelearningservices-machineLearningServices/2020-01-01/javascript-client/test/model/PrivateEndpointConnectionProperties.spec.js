...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMachineLearningWorkspaces.PrivateEndpointConnectionProperties();
  });
  ...
  describe('PrivateEndpointConnectionProperties', function() {
    it('should create an instance of PrivateEndpointConnectionProperties', function() {
      ...
      //var instance = new AzureMachineLearningWorkspaces.PrivateEndpointConnectionProperties();
      //expect(instance).to.be.a(AzureMachineLearningWorkspaces.PrivateEndpointConnectionProperties);
    });
