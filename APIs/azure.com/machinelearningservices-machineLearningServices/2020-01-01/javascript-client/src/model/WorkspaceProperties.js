...
class WorkspaceProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hbiWorkspace')) {
                obj['hbiWorkspace'] = ApiClient.convertToType(data['hbiWorkspace'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('serviceProvisionedResourceGroup')) {
                obj['serviceProvisionedResourceGroup'] = ApiClient.convertToType(data['serviceProvisionedResourceGroup'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['serviceProvisionedResourceGroup'] && !(typeof data['serviceProvisionedResourceGroup'] === 'string' || data['serviceProvisionedResourceGroup'] instanceof String)) {
            throw new Error("Expected the field `serviceProvisionedResourceGroup` to be a primitive type in the JSON string but got " + data['serviceProvisionedResourceGroup']);
        }
        // ensure the json data is a string
 ...
 */
WorkspaceProperties.prototype['encryption'] = undefined;
 ...
 * @member {Boolean} hbiWorkspace
 * @default false
 */
WorkspaceProperties.prototype['hbiWorkspace'] = false;
 ...
 * @member {String} serviceProvisionedResourceGroup
 */
WorkspaceProperties.prototype['serviceProvisionedResourceGroup'] = undefined;
