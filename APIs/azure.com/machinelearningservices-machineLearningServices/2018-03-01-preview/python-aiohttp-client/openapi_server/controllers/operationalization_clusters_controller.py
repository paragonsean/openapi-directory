...
async def machine_learning_compute_delete(request: web.Request, subscription_id, resource_group_name, workspace_name, compute_name, api_version) -> web.Response:
...
async def machine_learning_compute_system_update(request: web.Request, subscription_id, resource_group_name, workspace_name, compute_name, api_version) -> web.Response:
