...
class WorkspaceProperties(Model):
    ...
    def __init__(self, application_insights: str=None, batchai_workspace: str=None, container_registry: str=None, creation_time: datetime=None, description: str=None, discovery_url: str=None, friendly_name: str=None, key_vault: str=None, provisioning_state: str=None, storage_account: str=None, workspace_id: str=None):
        ...
        :param batchai_workspace: The batchai_workspace of this WorkspaceProperties.
        ...
        self._batchai_workspace = batchai_workspace
    ...
    @property
    def batchai_workspace(self):
        """Gets the batchai_workspace of this WorkspaceProperties.
        ...
        :return: The batchai_workspace of this WorkspaceProperties.
        :rtype: str
        """
        return self._batchai_workspace

    @batchai_workspace.setter
    def batchai_workspace(self, batchai_workspace):
        """Sets the batchai_workspace of this WorkspaceProperties.
