...
OAIBatchAI::OAIBatchAI(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchAI::OAIBatchAI() {
    this->initializeModel();
}

OAIBatchAI::~OAIBatchAI() {}

void OAIBatchAI::initializeModel() {
...
void OAIBatchAI::fromJson(QString jsonString) {
...
void OAIBatchAI::fromJsonObject(QJsonObject json) {
...
QString OAIBatchAI::asJson() const {
...
QJsonObject OAIBatchAI::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchAI::getComputeLocation() const {
    return m_compute_location;
}
void OAIBatchAI::setComputeLocation(const QString &compute_location) {
    m_compute_location = compute_location;
    m_compute_location_isSet = true;
}

bool OAIBatchAI::is_compute_location_Set() const{
    return m_compute_location_isSet;
}

bool OAIBatchAI::is_compute_location_Valid() const{
    return m_compute_location_isValid;
}

OAIComputeType OAIBatchAI::getComputeType() const {
    return m_compute_type;
}
void OAIBatchAI::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIBatchAI::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIBatchAI::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QDateTime OAIBatchAI::getCreatedOn() const {
    return m_created_on;
}
void OAIBatchAI::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIBatchAI::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIBatchAI::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QString OAIBatchAI::getDescription() const {
    return m_description;
}
void OAIBatchAI::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIBatchAI::is_description_Set() const{
    return m_description_isSet;
}

bool OAIBatchAI::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIBatchAI::getModifiedOn() const {
    return m_modified_on;
}
void OAIBatchAI::setModifiedOn(const QDateTime &modified_on) {
    m_modified_on = modified_on;
    m_modified_on_isSet = true;
}

bool OAIBatchAI::is_modified_on_Set() const{
    return m_modified_on_isSet;
}

bool OAIBatchAI::is_modified_on_Valid() const{
    return m_modified_on_isValid;
}

QList<OAIMachineLearningServiceError> OAIBatchAI::getProvisioningErrors() const {
    return m_provisioning_errors;
}
void OAIBatchAI::setProvisioningErrors(const QList<OAIMachineLearningServiceError> &provisioning_errors) {
    m_provisioning_errors = provisioning_errors;
    m_provisioning_errors_isSet = true;
}

bool OAIBatchAI::is_provisioning_errors_Set() const{
    return m_provisioning_errors_isSet;
}

bool OAIBatchAI::is_provisioning_errors_Valid() const{
    return m_provisioning_errors_isValid;
}

QString OAIBatchAI::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIBatchAI::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAIBatchAI::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAIBatchAI::is_provisioning_state_Valid() const{
    return m_provisioning_state_isValid;
}

QString OAIBatchAI::getResourceId() const {
    return m_resource_id;
}
void OAIBatchAI::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIBatchAI::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIBatchAI::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIBatchAI_allOf_properties OAIBatchAI::getProperties() const {
    return m_properties;
}
void OAIBatchAI::setProperties(const OAIBatchAI_allOf_properties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIBatchAI::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIBatchAI::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIBatchAI::isSet() const {
