...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void machineLearningComputeDelete(const QString &subscription_id, const QString &resource_group_name, const QString &workspace_name, const QString &compute_name, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void machineLearningComputeSystemUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &workspace_name, const QString &compute_name, const QString &api_version);
...
private:
    ...
    void machineLearningComputeSystemUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void machineLearningComputeSystemUpdateSignal();
    ...
    void machineLearningComputeSystemUpdateSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use machineLearningComputeSystemUpdateSignalError() instead")
    void machineLearningComputeSystemUpdateSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void machineLearningComputeSystemUpdateSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use machineLearningComputeSystemUpdateSignalErrorFull() instead")
    void machineLearningComputeSystemUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void machineLearningComputeSystemUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
