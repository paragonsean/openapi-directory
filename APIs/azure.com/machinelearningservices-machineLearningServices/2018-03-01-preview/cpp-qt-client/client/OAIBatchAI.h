...
class OAIBatchAI_allOf_properties;

class OAIBatchAI : public OAIObject {
public:
    OAIBatchAI();
    OAIBatchAI(QString json);
    ~OAIBatchAI() override;
    ...
    OAIBatchAI_allOf_properties getProperties() const;
    void setProperties(const OAIBatchAI_allOf_properties &properties);
...
private:
    ...
    OAIBatchAI_allOf_properties m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchAI)
