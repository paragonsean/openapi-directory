...
public:
    ...
    QString getBatchaiWorkspace() const;
    void setBatchaiWorkspace(const QString &batchai_workspace);
    bool is_batchai_workspace_Set() const;
    bool is_batchai_workspace_Valid() const;
...
private:
    ...
    QString m_batchai_workspace;
    bool m_batchai_workspace_isSet;
    bool m_batchai_workspace_isValid;
