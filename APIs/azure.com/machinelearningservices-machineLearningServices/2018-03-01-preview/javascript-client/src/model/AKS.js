...
import AKSAllOfProperties from './AKSAllOfProperties';
import Compute from './Compute';
import ComputeType from './ComputeType';
import MachineLearningServiceError from './MachineLearningServiceError';

/**
 * The AKS model module.
 * @module model/AKS
 * @version 2018-03-01-preview
 */
class AKS {
    /**
     * Constructs a new <code>AKS</code>.
     * A Machine Learning compute based on AKS.
     * @alias module:model/AKS
    ...
    constructor(computeType) { 
        ...
        AKS.initialize(this, computeType);
    }
    ...
    /**
     * Constructs a <code>AKS</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AKS} obj Optional instance to populate.
     * @return {module:model/AKS} The populated <code>AKS</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = AKSAllOfProperties.constructFromObject(data['properties']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AKS</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AKS</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AKS.RequiredProperties) {
        ...
        if (data['properties']) { // data not null
          AKSAllOfProperties.validateJSON(data['properties']);
        }
...
AKS.RequiredProperties = ["computeType"];

/**
 * @member {module:model/AKSAllOfProperties} properties
 */
AKS.prototype['properties'] = undefined;
