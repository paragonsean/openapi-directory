...
class WorkspaceProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('batchaiWorkspace')) {
                obj['batchaiWorkspace'] = ApiClient.convertToType(data['batchaiWorkspace'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['batchaiWorkspace'] && !(typeof data['batchaiWorkspace'] === 'string' || data['batchaiWorkspace'] instanceof String)) {
            throw new Error("Expected the field `batchaiWorkspace` to be a primitive type in the JSON string but got " + data['batchaiWorkspace']);
        }
        // ensure the json data is a string
 ...
 * @member {String} batchaiWorkspace
 */
WorkspaceProperties.prototype['batchaiWorkspace'] = undefined;
