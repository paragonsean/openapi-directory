...
export default class MachineLearningComputesApi {
    ...
    */
     ...
     */
    machineLearningComputeDelete_0(subscriptionId, resourceGroupName, workspaceName, computeName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
    ...
    /**
     * Callback function to receive the result of the machineLearningComputeSystemUpdate_0 operation.
     * @callback module:api/MachineLearningComputesApi~machineLearningComputeSystemUpdate_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} computeName Name of the Azure Machine Learning compute.
     * @param {String} apiVersion Version of Azure Machine Learning resource provider API.
     * @param {module:api/MachineLearningComputesApi~machineLearningComputeSystemUpdate_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    machineLearningComputeSystemUpdate_0(subscriptionId, resourceGroupName, workspaceName, computeName, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling machineLearningComputeSystemUpdate_0");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling machineLearningComputeSystemUpdate_0");
      }
      // verify the required parameter 'workspaceName' is set
      if (workspaceName === undefined || workspaceName === null) {
        throw new Error("Missing the required parameter 'workspaceName' when calling machineLearningComputeSystemUpdate_0");
      }
      // verify the required parameter 'computeName' is set
      if (computeName === undefined || computeName === null) {
        throw new Error("Missing the required parameter 'computeName' when calling machineLearningComputeSystemUpdate_0");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling machineLearningComputeSystemUpdate_0");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/computes/{computeName}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
