...
public class AKSAllOfProperties {
  ...
  public AKSAllOfProperties systemServices(List<SystemService> systemServices) {
    this.systemServices = systemServices;
    return this;
  }

  public AKSAllOfProperties addSystemServicesItem(SystemService systemServicesItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentCount, agentVMSize, clusterFqdn, sslConfiguration, systemServices);
  }
