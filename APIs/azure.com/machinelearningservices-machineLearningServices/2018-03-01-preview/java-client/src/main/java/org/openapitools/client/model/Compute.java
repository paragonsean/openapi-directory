...
public class Compute {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(computeLocation, computeType, createdOn, description, modifiedOn, provisioningErrors, provisioningState, resourceId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      switch (discriminatorValue) {
        case "AKS":
          ...
          break;
        case "BatchAI":
          BatchAI.validateJsonElement(jsonElement);
          break;
        case "DataFactory":
