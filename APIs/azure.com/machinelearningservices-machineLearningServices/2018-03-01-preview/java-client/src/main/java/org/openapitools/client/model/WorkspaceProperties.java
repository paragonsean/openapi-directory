...
public class WorkspaceProperties {
  ...
  public static final String SERIALIZED_NAME_BATCHAI_WORKSPACE = "batchaiWorkspace";
  @SerializedName(SERIALIZED_NAME_BATCHAI_WORKSPACE)
  private String batchaiWorkspace;
  ...
  public WorkspaceProperties batchaiWorkspace(String batchaiWorkspace) {
    this.batchaiWorkspace = batchaiWorkspace;
    return this;
  }
   ...
   * @return batchaiWorkspace
   */
  @javax.annotation.Nullable
  public String getBatchaiWorkspace() {
    return batchaiWorkspace;
  }

  public void setBatchaiWorkspace(String batchaiWorkspace) {
    this.batchaiWorkspace = batchaiWorkspace;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationInsights, workspaceProperties.applicationInsights) &&
        Objects.equals(this.batchaiWorkspace, workspaceProperties.batchaiWorkspace) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationInsights, batchaiWorkspace, containerRegistry, creationTime, description, discoveryUrl, friendlyName, keyVault, provisioningState, storageAccount, workspaceId);
  }
  ...
  public String toString() {
    ...
    sb.append("    batchaiWorkspace: ").append(toIndentedString(batchaiWorkspace)).append("\n");
  ...
  static {
    ...
    openapiFields.add("batchaiWorkspace");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("batchaiWorkspace") != null && !jsonObj.get("batchaiWorkspace").isJsonNull()) && !jsonObj.get("batchaiWorkspace").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `batchaiWorkspace` to be a primitive type in the JSON string but got `%s`", jsonObj.get("batchaiWorkspace").toString()));
      }
