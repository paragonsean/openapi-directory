...
#ifndef OAIDataFactory_H
#define OAIDataFactory_H
...
class OAIDataFactory : public OAIObject {
public:
    OAIDataFactory();
    OAIDataFactory(QString json);
    ~OAIDataFactory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataFactory)

#endif // OAIDataFactory_H
