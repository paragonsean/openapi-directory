...
public:
    ...
    OAIWorkspaceProperties getProperties() const;
    void setProperties(const OAIWorkspaceProperties &properties);
...
private:
    ...
    OAIWorkspaceProperties m_properties;
