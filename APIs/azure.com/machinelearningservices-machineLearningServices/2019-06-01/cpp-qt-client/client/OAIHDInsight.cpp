...
OAIHDInsight::OAIHDInsight(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHDInsight::OAIHDInsight() {
    this->initializeModel();
}

OAIHDInsight::~OAIHDInsight() {}

void OAIHDInsight::initializeModel() {
...
void OAIHDInsight::fromJson(QString jsonString) {
...
void OAIHDInsight::fromJsonObject(QJsonObject json) {
...
QString OAIHDInsight::asJson() const {
...
QJsonObject OAIHDInsight::asJsonObject() const {
    QJsonObject obj;
...
QString OAIHDInsight::getComputeLocation() const {
    return m_compute_location;
}
void OAIHDInsight::setComputeLocation(const QString &compute_location) {
    m_compute_location = compute_location;
    m_compute_location_isSet = true;
}

bool OAIHDInsight::is_compute_location_Set() const{
    return m_compute_location_isSet;
}

bool OAIHDInsight::is_compute_location_Valid() const{
    return m_compute_location_isValid;
}

OAIComputeType OAIHDInsight::getComputeType() const {
    return m_compute_type;
}
void OAIHDInsight::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIHDInsight::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIHDInsight::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QDateTime OAIHDInsight::getCreatedOn() const {
    return m_created_on;
}
void OAIHDInsight::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIHDInsight::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIHDInsight::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QString OAIHDInsight::getDescription() const {
    return m_description;
}
void OAIHDInsight::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIHDInsight::is_description_Set() const{
    return m_description_isSet;
}

bool OAIHDInsight::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIHDInsight::isIsAttachedCompute() const {
    return m_is_attached_compute;
}
void OAIHDInsight::setIsAttachedCompute(const bool &is_attached_compute) {
    m_is_attached_compute = is_attached_compute;
    m_is_attached_compute_isSet = true;
}

bool OAIHDInsight::is_is_attached_compute_Set() const{
    return m_is_attached_compute_isSet;
}

bool OAIHDInsight::is_is_attached_compute_Valid() const{
    return m_is_attached_compute_isValid;
}

QDateTime OAIHDInsight::getModifiedOn() const {
    return m_modified_on;
}
void OAIHDInsight::setModifiedOn(const QDateTime &modified_on) {
    m_modified_on = modified_on;
    m_modified_on_isSet = true;
}

bool OAIHDInsight::is_modified_on_Set() const{
    return m_modified_on_isSet;
}

bool OAIHDInsight::is_modified_on_Valid() const{
    return m_modified_on_isValid;
}

QList<OAIMachineLearningServiceError> OAIHDInsight::getProvisioningErrors() const {
    return m_provisioning_errors;
}
void OAIHDInsight::setProvisioningErrors(const QList<OAIMachineLearningServiceError> &provisioning_errors) {
    m_provisioning_errors = provisioning_errors;
    m_provisioning_errors_isSet = true;
}

bool OAIHDInsight::is_provisioning_errors_Set() const{
    return m_provisioning_errors_isSet;
}

bool OAIHDInsight::is_provisioning_errors_Valid() const{
    return m_provisioning_errors_isValid;
}

QString OAIHDInsight::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIHDInsight::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAIHDInsight::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAIHDInsight::is_provisioning_state_Valid() const{
    return m_provisioning_state_isValid;
}

QString OAIHDInsight::getResourceId() const {
    return m_resource_id;
}
void OAIHDInsight::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIHDInsight::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIHDInsight::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIHDInsight_allOf_properties OAIHDInsight::getProperties() const {
    return m_properties;
}
void OAIHDInsight::setProperties(const OAIHDInsight_allOf_properties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIHDInsight::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIHDInsight::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIHDInsight::isSet() const {
...
bool OAIHDInsight::isValid() const {
