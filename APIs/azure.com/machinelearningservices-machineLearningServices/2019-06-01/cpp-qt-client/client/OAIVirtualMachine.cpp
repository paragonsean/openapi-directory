...
QString OAIVirtualMachine::getComputeLocation() const {
    return m_compute_location;
}
void OAIVirtualMachine::setComputeLocation(const QString &compute_location) {
    m_compute_location = compute_location;
    m_compute_location_isSet = true;
}

bool OAIVirtualMachine::is_compute_location_Set() const{
    return m_compute_location_isSet;
}

bool OAIVirtualMachine::is_compute_location_Valid() const{
    return m_compute_location_isValid;
}

OAIComputeType OAIVirtualMachine::getComputeType() const {
    return m_compute_type;
}
void OAIVirtualMachine::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIVirtualMachine::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIVirtualMachine::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QDateTime OAIVirtualMachine::getCreatedOn() const {
    return m_created_on;
}
void OAIVirtualMachine::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIVirtualMachine::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIVirtualMachine::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QString OAIVirtualMachine::getDescription() const {
    return m_description;
}
void OAIVirtualMachine::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIVirtualMachine::is_description_Set() const{
    return m_description_isSet;
}

bool OAIVirtualMachine::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIVirtualMachine::isIsAttachedCompute() const {
    return m_is_attached_compute;
}
void OAIVirtualMachine::setIsAttachedCompute(const bool &is_attached_compute) {
    m_is_attached_compute = is_attached_compute;
    m_is_attached_compute_isSet = true;
}

bool OAIVirtualMachine::is_is_attached_compute_Set() const{
    return m_is_attached_compute_isSet;
}

bool OAIVirtualMachine::is_is_attached_compute_Valid() const{
    return m_is_attached_compute_isValid;
}

QDateTime OAIVirtualMachine::getModifiedOn() const {
    return m_modified_on;
}
void OAIVirtualMachine::setModifiedOn(const QDateTime &modified_on) {
    m_modified_on = modified_on;
    m_modified_on_isSet = true;
}

bool OAIVirtualMachine::is_modified_on_Set() const{
    return m_modified_on_isSet;
}

bool OAIVirtualMachine::is_modified_on_Valid() const{
    return m_modified_on_isValid;
}

QList<OAIMachineLearningServiceError> OAIVirtualMachine::getProvisioningErrors() const {
    return m_provisioning_errors;
}
void OAIVirtualMachine::setProvisioningErrors(const QList<OAIMachineLearningServiceError> &provisioning_errors) {
    m_provisioning_errors = provisioning_errors;
    m_provisioning_errors_isSet = true;
}

bool OAIVirtualMachine::is_provisioning_errors_Set() const{
    return m_provisioning_errors_isSet;
}

bool OAIVirtualMachine::is_provisioning_errors_Valid() const{
    return m_provisioning_errors_isValid;
}

QString OAIVirtualMachine::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIVirtualMachine::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAIVirtualMachine::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAIVirtualMachine::is_provisioning_state_Valid() const{
    return m_provisioning_state_isValid;
}

QString OAIVirtualMachine::getResourceId() const {
    return m_resource_id;
}
void OAIVirtualMachine::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIVirtualMachine::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIVirtualMachine::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIVirtualMachine_allOf_properties OAIVirtualMachine::getProperties() const {
    return m_properties;
}
void OAIVirtualMachine::setProperties(const OAIVirtualMachine_allOf_properties &properties) {
