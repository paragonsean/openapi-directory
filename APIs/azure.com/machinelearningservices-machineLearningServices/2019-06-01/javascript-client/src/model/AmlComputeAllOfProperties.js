...
class AmlComputeAllOfProperties {
    ...
    static initialize(obj) { 
        obj['remoteLoginPortPublicAccess'] = 'NotSpecified';
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('remoteLoginPortPublicAccess')) {
                obj['remoteLoginPortPublicAccess'] = ApiClient.convertToType(data['remoteLoginPortPublicAccess'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['remoteLoginPortPublicAccess'] && !(typeof data['remoteLoginPortPublicAccess'] === 'string' || data['remoteLoginPortPublicAccess'] instanceof String)) {
            throw new Error("Expected the field `remoteLoginPortPublicAccess` to be a primitive type in the JSON string but got " + data['remoteLoginPortPublicAccess']);
        }
 ...
 * @member {module:model/AmlComputeAllOfProperties.RemoteLoginPortPublicAccessEnum} remoteLoginPortPublicAccess
 * @default 'NotSpecified'
 */
AmlComputeAllOfProperties.prototype['remoteLoginPortPublicAccess'] = 'NotSpecified';
...
/**
 * Allowed values for the <code>remoteLoginPortPublicAccess</code> property.
 * @enum {String}
 * @readonly
 */
AmlComputeAllOfProperties['RemoteLoginPortPublicAccessEnum'] = {
