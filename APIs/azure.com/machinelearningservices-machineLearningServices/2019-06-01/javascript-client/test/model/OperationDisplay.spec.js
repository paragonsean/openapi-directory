...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMachineLearningWorkspaces.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureMachineLearningWorkspaces.OperationDisplay();
      //expect(instance).to.be.a(AzureMachineLearningWorkspaces.OperationDisplay);
    });
