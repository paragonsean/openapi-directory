...
async def machine_learning_compute_delete_0(request: web.Request, subscription_id, resource_group_name, workspace_name, compute_name, api_version, underlying_resource_action) -> web.Response:
...
async def machine_learning_compute_list_nodes(request: web.Request, subscription_id, resource_group_name, workspace_name, compute_name, api_version) -> web.Response:
...
async def machine_learning_compute_update_0(request: web.Request, subscription_id, resource_group_name, workspace_name, compute_name, api_version, parameters) -> web.Response:
