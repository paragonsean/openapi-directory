...
<a id="usagesList"></a>
# **usagesList**
> ListUsagesResult usagesList(apiVersion, subscriptionId, location, expandChildren)
...
public class Example {
  public static void main(String[] args) {
    ...
    String expandChildren = "expandChildren_example"; // String | Specifies if detailed usages of child resources are required.
    try {
      ListUsagesResult result = apiInstance.usagesList(apiVersion, subscriptionId, location, expandChildren);
