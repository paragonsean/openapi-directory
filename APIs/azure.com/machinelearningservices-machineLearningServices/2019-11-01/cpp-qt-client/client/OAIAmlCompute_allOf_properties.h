...
public:
    ...
    QString getRemoteLoginPortPublicAccess() const;
    void setRemoteLoginPortPublicAccess(const QString &remote_login_port_public_access);
    bool is_remote_login_port_public_access_Set() const;
    bool is_remote_login_port_public_access_Valid() const;
...
private:
    ...
    QString m_remote_login_port_public_access;
    bool m_remote_login_port_public_access_isSet;
    bool m_remote_login_port_public_access_isValid;
