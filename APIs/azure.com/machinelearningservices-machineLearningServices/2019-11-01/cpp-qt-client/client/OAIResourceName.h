...
#ifndef OAIResourceName_H
#define OAIResourceName_H
...
class OAIResourceName : public OAIObject {
public:
    OAIResourceName();
    OAIResourceName(QString json);
    ~OAIResourceName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceName)

#endif // OAIResourceName_H
