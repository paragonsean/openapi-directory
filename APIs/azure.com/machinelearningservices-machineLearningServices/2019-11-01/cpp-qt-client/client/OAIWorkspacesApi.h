...
public:
    ...
    */
    virtual void workspaceFeaturesList(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &workspace_name);
...
private:
    ...
    void workspaceFeaturesListCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void workspaceFeaturesListSignal(OAIListAmlUserFeatureResult summary);
    ...
    void workspaceFeaturesListSignalFull(OAIHttpRequestWorker *worker, OAIListAmlUserFeatureResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use workspaceFeaturesListSignalError() instead")
    void workspaceFeaturesListSignalE(OAIListAmlUserFeatureResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void workspaceFeaturesListSignalError(OAIListAmlUserFeatureResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use workspaceFeaturesListSignalErrorFull() instead")
    void workspaceFeaturesListSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void workspaceFeaturesListSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
