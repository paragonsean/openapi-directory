...
class VirtualMachineSize(Model):
    ...
    def __init__(self, family: str=None, gpus: int=None, low_priority_capable: bool=None, max_resource_volume_mb: int=None, memory_gb: float=None, name: str=None, os_vhd_size_mb: int=None, premium_io: bool=None, v_cpus: int=None):
        """VirtualMachineSize - a model defined in OpenAPI

        :param family: The family of this VirtualMachineSize.
        :param gpus: The gpus of this VirtualMachineSize.
    ...
    @property
    def gpus(self):
        """Gets the gpus of this VirtualMachineSize.

        The number of gPUs supported by the virtual machine size.

        :return: The gpus of this VirtualMachineSize.
        :rtype: int
        """
        return self._gpus
    ...
    @gpus.setter
    def gpus(self, gpus):
        """Sets the gpus of this VirtualMachineSize.
