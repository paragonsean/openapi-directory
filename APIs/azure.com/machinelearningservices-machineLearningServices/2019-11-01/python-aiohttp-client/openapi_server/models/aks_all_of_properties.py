...
class AKSAllOfProperties(Model):
    ...
    def __init__(self, agent_count: int=None, agent_vm_size: str=None, aks_networking_configuration: AksNetworkingConfiguration=None, cluster_fqdn: str=None, ssl_configuration: SslConfiguration=None, system_services: List[SystemService]=None):
        ...
        :param aks_networking_configuration: The aks_networking_configuration of this AKSAllOfProperties.
        ...
        self._aks_networking_configuration = aks_networking_configuration
    ...
    @property
    def aks_networking_configuration(self):
        """Gets the aks_networking_configuration of this AKSAllOfProperties.


        :return: The aks_networking_configuration of this AKSAllOfProperties.
        :rtype: AksNetworkingConfiguration
        """
        return self._aks_networking_configuration

    @aks_networking_configuration.setter
    def aks_networking_configuration(self, aks_networking_configuration):
        """Sets the aks_networking_configuration of this AKSAllOfProperties.


        :param aks_networking_configuration: The aks_networking_configuration of this AKSAllOfProperties.
        :type aks_networking_configuration: AksNetworkingConfiguration
        """
