...
export default class WorkspacesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the workspaceFeaturesList operation.
     * @callback module:api/WorkspacesApi~workspaceFeaturesListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListAmlUserFeatureResult} data The data returned by the service call.
     ...
     * @param {module:api/WorkspacesApi~workspaceFeaturesListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListAmlUserFeatureResult}
     */
    workspaceFeaturesList(apiVersion, subscriptionId, resourceGroupName, workspaceName, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling workspaceFeaturesList");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling workspaceFeaturesList");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling workspaceFeaturesList");
      }
      // verify the required parameter 'workspaceName' is set
      if (workspaceName === undefined || workspaceName === null) {
        throw new Error("Missing the required parameter 'workspaceName' when calling workspaceFeaturesList");
      }
      ...
      let returnType = ListAmlUserFeatureResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/features', 'GET',
