...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMachineLearningWorkspaces.WorkspaceSku();
  });
  ...
  describe('WorkspaceSku', function() {
    it('should create an instance of WorkspaceSku', function() {
      // uncomment below and update the code to test WorkspaceSku
      //var instance = new AzureMachineLearningWorkspaces.WorkspaceSku();
      //expect(instance).to.be.a(AzureMachineLearningWorkspaces.WorkspaceSku);
    });
