...
#ifndef OAIHDInsight_H
#define OAIHDInsight_H
...
class OAIHDInsight_allOf_properties;

class OAIHDInsight : public OAIObject {
public:
    OAIHDInsight();
    OAIHDInsight(QString json);
    ~OAIHDInsight() override;
    ...
    OAIHDInsight_allOf_properties getProperties() const;
    void setProperties(const OAIHDInsight_allOf_properties &properties);
...
private:
    ...
    OAIHDInsight_allOf_properties m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHDInsight)

#endif // OAIHDInsight_H
