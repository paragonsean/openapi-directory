...
OAIDatabricks::OAIDatabricks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabricks::OAIDatabricks() {
    this->initializeModel();
}

OAIDatabricks::~OAIDatabricks() {}

void OAIDatabricks::initializeModel() {
...
void OAIDatabricks::fromJson(QString jsonString) {
...
void OAIDatabricks::fromJsonObject(QJsonObject json) {
...
QString OAIDatabricks::asJson() const {
...
QJsonObject OAIDatabricks::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDatabricks::getComputeLocation() const {
    return m_compute_location;
}
void OAIDatabricks::setComputeLocation(const QString &compute_location) {
    m_compute_location = compute_location;
    m_compute_location_isSet = true;
}

bool OAIDatabricks::is_compute_location_Set() const{
    return m_compute_location_isSet;
}

bool OAIDatabricks::is_compute_location_Valid() const{
    return m_compute_location_isValid;
}

OAIComputeType OAIDatabricks::getComputeType() const {
    return m_compute_type;
}
void OAIDatabricks::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIDatabricks::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIDatabricks::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QDateTime OAIDatabricks::getCreatedOn() const {
    return m_created_on;
}
void OAIDatabricks::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIDatabricks::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIDatabricks::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QString OAIDatabricks::getDescription() const {
    return m_description;
}
void OAIDatabricks::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDatabricks::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDatabricks::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIDatabricks::isIsAttachedCompute() const {
    return m_is_attached_compute;
}
void OAIDatabricks::setIsAttachedCompute(const bool &is_attached_compute) {
    m_is_attached_compute = is_attached_compute;
    m_is_attached_compute_isSet = true;
}

bool OAIDatabricks::is_is_attached_compute_Set() const{
    return m_is_attached_compute_isSet;
}

bool OAIDatabricks::is_is_attached_compute_Valid() const{
    return m_is_attached_compute_isValid;
}

QDateTime OAIDatabricks::getModifiedOn() const {
    return m_modified_on;
}
void OAIDatabricks::setModifiedOn(const QDateTime &modified_on) {
    m_modified_on = modified_on;
    m_modified_on_isSet = true;
}

bool OAIDatabricks::is_modified_on_Set() const{
    return m_modified_on_isSet;
}

bool OAIDatabricks::is_modified_on_Valid() const{
    return m_modified_on_isValid;
}

QList<OAIMachineLearningServiceError> OAIDatabricks::getProvisioningErrors() const {
    return m_provisioning_errors;
}
void OAIDatabricks::setProvisioningErrors(const QList<OAIMachineLearningServiceError> &provisioning_errors) {
    m_provisioning_errors = provisioning_errors;
    m_provisioning_errors_isSet = true;
}

bool OAIDatabricks::is_provisioning_errors_Set() const{
    return m_provisioning_errors_isSet;
}

bool OAIDatabricks::is_provisioning_errors_Valid() const{
    return m_provisioning_errors_isValid;
}

QString OAIDatabricks::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIDatabricks::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAIDatabricks::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAIDatabricks::is_provisioning_state_Valid() const{
    return m_provisioning_state_isValid;
}

QString OAIDatabricks::getResourceId() const {
    return m_resource_id;
}
void OAIDatabricks::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIDatabricks::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIDatabricks::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIDatabricks_allOf_properties OAIDatabricks::getProperties() const {
    return m_properties;
}
void OAIDatabricks::setProperties(const OAIDatabricks_allOf_properties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIDatabricks::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIDatabricks::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIDatabricks::isSet() const {
...
bool OAIDatabricks::isValid() const {
