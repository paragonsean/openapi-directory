...
void OAIAKS::fromJson(QString jsonString) {
...
void OAIAKS::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAKS::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAKS::getComputeLocation() const {
    return m_compute_location;
}
void OAIAKS::setComputeLocation(const QString &compute_location) {
    m_compute_location = compute_location;
    m_compute_location_isSet = true;
}

bool OAIAKS::is_compute_location_Set() const{
    return m_compute_location_isSet;
}

bool OAIAKS::is_compute_location_Valid() const{
    return m_compute_location_isValid;
}

OAIComputeType OAIAKS::getComputeType() const {
    return m_compute_type;
}
void OAIAKS::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIAKS::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIAKS::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

QDateTime OAIAKS::getCreatedOn() const {
    return m_created_on;
}
void OAIAKS::setCreatedOn(const QDateTime &created_on) {
    m_created_on = created_on;
    m_created_on_isSet = true;
}

bool OAIAKS::is_created_on_Set() const{
    return m_created_on_isSet;
}

bool OAIAKS::is_created_on_Valid() const{
    return m_created_on_isValid;
}

QString OAIAKS::getDescription() const {
    return m_description;
}
void OAIAKS::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIAKS::is_description_Set() const{
    return m_description_isSet;
}

bool OAIAKS::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIAKS::isIsAttachedCompute() const {
    return m_is_attached_compute;
}
void OAIAKS::setIsAttachedCompute(const bool &is_attached_compute) {
    m_is_attached_compute = is_attached_compute;
    m_is_attached_compute_isSet = true;
}

bool OAIAKS::is_is_attached_compute_Set() const{
    return m_is_attached_compute_isSet;
}

bool OAIAKS::is_is_attached_compute_Valid() const{
    return m_is_attached_compute_isValid;
}

QDateTime OAIAKS::getModifiedOn() const {
    return m_modified_on;
}
void OAIAKS::setModifiedOn(const QDateTime &modified_on) {
    m_modified_on = modified_on;
    m_modified_on_isSet = true;
}

bool OAIAKS::is_modified_on_Set() const{
    return m_modified_on_isSet;
}

bool OAIAKS::is_modified_on_Valid() const{
    return m_modified_on_isValid;
}

QList<OAIMachineLearningServiceError> OAIAKS::getProvisioningErrors() const {
    return m_provisioning_errors;
}
void OAIAKS::setProvisioningErrors(const QList<OAIMachineLearningServiceError> &provisioning_errors) {
    m_provisioning_errors = provisioning_errors;
    m_provisioning_errors_isSet = true;
}

bool OAIAKS::is_provisioning_errors_Set() const{
    return m_provisioning_errors_isSet;
}

bool OAIAKS::is_provisioning_errors_Valid() const{
    return m_provisioning_errors_isValid;
}

QString OAIAKS::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIAKS::setProvisioningState(const QString &provisioning_state) {
    m_provisioning_state = provisioning_state;
    m_provisioning_state_isSet = true;
}

bool OAIAKS::is_provisioning_state_Set() const{
    return m_provisioning_state_isSet;
}

bool OAIAKS::is_provisioning_state_Valid() const{
    return m_provisioning_state_isValid;
}

QString OAIAKS::getResourceId() const {
    return m_resource_id;
}
void OAIAKS::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIAKS::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIAKS::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIAKS_allOf_properties OAIAKS::getProperties() const {
    return m_properties;
}
void OAIAKS::setProperties(const OAIAKS_allOf_properties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIAKS::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIAKS::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIAKS::isSet() const {
