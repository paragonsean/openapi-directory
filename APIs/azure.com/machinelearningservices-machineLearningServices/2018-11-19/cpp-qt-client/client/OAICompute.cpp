...
bool OAICompute::isIsAttachedCompute() const {
    return m_is_attached_compute;
}
void OAICompute::setIsAttachedCompute(const bool &is_attached_compute) {
    m_is_attached_compute = is_attached_compute;
    m_is_attached_compute_isSet = true;
}

bool OAICompute::is_is_attached_compute_Set() const{
    return m_is_attached_compute_isSet;
}

bool OAICompute::is_is_attached_compute_Valid() const{
