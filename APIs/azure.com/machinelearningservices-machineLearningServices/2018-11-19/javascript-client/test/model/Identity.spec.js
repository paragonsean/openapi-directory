...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMachineLearningWorkspaces.Identity();
  });
  ...
  describe('Identity', function() {
    it('should create an instance of Identity', function() {
      ...
      //var instance = new AzureMachineLearningWorkspaces.Identity();
      //expect(instance).to.be.a(AzureMachineLearningWorkspaces.Identity);
    });
