...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMachineLearningWorkspaces.Usage();
  });
  ...
  describe('Usage', function() {
    it('should create an instance of Usage', function() {
      ...
      //var instance = new AzureMachineLearningWorkspaces.Usage();
      //expect(instance).to.be.a(AzureMachineLearningWorkspaces.Usage);
    });
