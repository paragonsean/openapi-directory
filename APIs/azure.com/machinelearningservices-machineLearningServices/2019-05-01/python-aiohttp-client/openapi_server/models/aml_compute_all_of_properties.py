...
class AmlComputeAllOfProperties(Model):
    ...
    def __init__(self, allocation_state: str=None, allocation_state_transition_time: datetime=None, current_node_count: int=None, errors: List[MachineLearningServiceError]=None, node_state_counts: NodeStateCounts=None, scale_settings: ScaleSettings=None, subnet: ResourceId=None, target_node_count: int=None, user_account_credentials: UserAccountCredentials=None, vm_priority: str=None, vm_size: str=None):
