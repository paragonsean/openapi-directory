...
class OAIVirtualMachine_allOf_properties;
...
public:
    ...
    OAIVirtualMachine_allOf_properties getProperties() const;
    void setProperties(const OAIVirtualMachine_allOf_properties &properties);
...
private:
    ...
    OAIVirtualMachine_allOf_properties m_properties;
