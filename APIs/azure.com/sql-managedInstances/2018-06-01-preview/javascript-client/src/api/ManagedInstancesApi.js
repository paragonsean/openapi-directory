...
export default class ManagedInstancesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the managedInstancesListByInstancePool operation.
     * @callback module:api/ManagedInstancesApi~managedInstancesListByInstancePoolCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ManagedInstanceListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The subscription ID that identifies an Azure subscription.
     * @param {String} apiVersion The API version to use for the request.
     * @param {module:api/ManagedInstancesApi~managedInstancesListByInstancePoolCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ManagedInstanceListResult}
     */
    managedInstancesListByInstancePool(resourceGroupName, instancePoolName, subscriptionId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling managedInstancesListByInstancePool");
      }
      // verify the required parameter 'instancePoolName' is set
      if (instancePoolName === undefined || instancePoolName === null) {
        throw new Error("Missing the required parameter 'instancePoolName' when calling managedInstancesListByInstancePool");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling managedInstancesListByInstancePool");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling managedInstancesListByInstancePool");
      }
      ...
      let returnType = ManagedInstanceListResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/instancePools/{instancePoolName}/managedInstances', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
