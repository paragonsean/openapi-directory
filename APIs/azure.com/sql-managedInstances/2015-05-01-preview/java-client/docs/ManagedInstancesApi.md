...
<a id="managedInstancesCreateOrUpdate"></a>
...
import org.openapitools.client.api.ManagedInstancesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ManagedInstancesApi apiInstance = new ManagedInstancesApi(defaultClient);
    ...
    ManagedInstance parameters = new ManagedInstance(); // ManagedInstance | The requested managed instance resource state.
    try {
      ManagedInstance result = apiInstance.managedInstancesCreateOrUpdate(resourceGroupName, managedInstanceName, subscriptionId, apiVersion, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ManagedInstancesApi#managedInstancesCreateOrUpdate");
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version to use for the request.
    try {
      apiInstance.managedInstancesDelete(resourceGroupName, managedInstanceName, subscriptionId, apiVersion);
    } catch (ApiException e) {
      System.err.println("Exception when calling ManagedInstancesApi#managedInstancesDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version to use for the request.
    try {
      ManagedInstance result = apiInstance.managedInstancesGet(resourceGroupName, managedInstanceName, subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ManagedInstancesApi#managedInstancesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version to use for the request.
    try {
      ManagedInstanceListResult result = apiInstance.managedInstancesList(subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ManagedInstancesApi#managedInstancesList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="managedInstancesListByResourceGroup"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version to use for the request.
    try {
      ManagedInstanceListResult result = apiInstance.managedInstancesListByResourceGroup(resourceGroupName, subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ManagedInstancesApi#managedInstancesListByResourceGroup");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | The subscription ID that identifies an Azure subscription.
    String apiVersion = "apiVersion_example"; // String | The API version to use for the request.
    ManagedInstanceUpdate parameters = new ManagedInstanceUpdate(); // ManagedInstanceUpdate | The requested managed instance resource state.
    try {
      ManagedInstance result = apiInstance.managedInstancesUpdate(resourceGroupName, managedInstanceName, subscriptionId, apiVersion, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ManagedInstancesApi#managedInstancesUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
