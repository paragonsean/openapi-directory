...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.ManagedInstanceUpdateSku();
  });
  ...
  describe('ManagedInstanceUpdateSku', function() {
    it('should create an instance of ManagedInstanceUpdateSku', function() {
      // uncomment below and update the code to test ManagedInstanceUpdateSku
      //var instance = new SqlManagementClient.ManagedInstanceUpdateSku();
      //expect(instance).to.be.a(SqlManagementClient.ManagedInstanceUpdateSku);
    });
