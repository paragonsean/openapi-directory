...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.PrivateLinkResourceListResult();
  });
  ...
  describe('PrivateLinkResourceListResult', function() {
    it('should create an instance of PrivateLinkResourceListResult', function() {
      ...
      //var instance = new MariaDbManagementClient.PrivateLinkResourceListResult();
      //expect(instance).to.be.a(MariaDbManagementClient.PrivateLinkResourceListResult);
    });
