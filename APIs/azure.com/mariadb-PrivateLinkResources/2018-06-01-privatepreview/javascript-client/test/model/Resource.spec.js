...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new MariaDbManagementClient.Resource();
      //expect(instance).to.be.a(MariaDbManagementClient.Resource);
    });
