...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.ProxyResource();
  });
  ...
  describe('ProxyResource', function() {
    it('should create an instance of ProxyResource', function() {
      ...
      //var instance = new MariaDbManagementClient.ProxyResource();
      //expect(instance).to.be.a(MariaDbManagementClient.ProxyResource);
    });
