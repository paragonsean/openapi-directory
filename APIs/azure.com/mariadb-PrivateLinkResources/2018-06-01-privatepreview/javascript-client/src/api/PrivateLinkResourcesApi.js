    ...
    */
    ...
    privateLinkResourcesGet(resourceGroupName, serverName, groupName, subscriptionId, apiVersion, callback) {
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/privateLinkResources/{groupName}', 'GET',
    ...
    privateLinkResourcesListByServer(resourceGroupName, serverName, subscriptionId, apiVersion, callback) {
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/privateLinkResources', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
