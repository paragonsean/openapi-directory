...
import ManagedInstanceKeyProperties from './model/ManagedInstanceKeyProperties';
import ManagedInstanceKeysApi from './api/ManagedInstanceKeysApi';
...
export {
    ...
    /**
     * The ManagedInstanceKey model constructor.
     * @property {module:model/ManagedInstanceKey}
     */
    ManagedInstanceKey,

    /**
     * The ManagedInstanceKeyListResult model constructor.
     * @property {module:model/ManagedInstanceKeyListResult}
     */
    ManagedInstanceKeyListResult,

    /**
     * The ManagedInstanceKeyProperties model constructor.
     * @property {module:model/ManagedInstanceKeyProperties}
     */
    ManagedInstanceKeyProperties,

    /**
    * The ManagedInstanceKeysApi service constructor.
    * @property {module:api/ManagedInstanceKeysApi}
    */
