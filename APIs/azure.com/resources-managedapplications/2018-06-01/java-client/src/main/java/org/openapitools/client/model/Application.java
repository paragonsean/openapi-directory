...
public class Application {
  ...
  public Application identity(Identity identity) {
  ...
  public Application managedBy(String managedBy) {
  ...
  public Application sku(Sku sku) {
    this.sku = sku;
    return this;
  }
