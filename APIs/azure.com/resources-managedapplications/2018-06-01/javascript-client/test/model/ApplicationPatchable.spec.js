...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationClient.ApplicationPatchable();
  });
  ...
  describe('ApplicationPatchable', function() {
    it('should create an instance of ApplicationPatchable', function() {
      // uncomment below and update the code to test ApplicationPatchable
      //var instance = new ApplicationClient.ApplicationPatchable();
      //expect(instance).to.be.a(ApplicationClient.ApplicationPatchable);
    });
