...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationClient.ApplicationDefinition();
  });
  ...
  describe('ApplicationDefinition', function() {
    it('should create an instance of ApplicationDefinition', function() {
      // uncomment below and update the code to test ApplicationDefinition
      //var instance = new ApplicationClient.ApplicationDefinition();
      //expect(instance).to.be.a(ApplicationClient.ApplicationDefinition);
    });
