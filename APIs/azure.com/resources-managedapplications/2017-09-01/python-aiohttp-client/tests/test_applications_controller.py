...
async def test_applications_create_or_update(client):
    ...
    """
    parameters = {"kind":"kind","plan":{"product":"product","name":"name","promotionCode":"promotionCode","publisher":"publisher","version":"version"},"properties":{"outputs":"{}","uiDefinitionUri":"uiDefinitionUri","managedResourceGroupId":"managedResourceGroupId","provisioningState":"Accepted","applicationDefinitionId":"applicationDefinitionId","parameters":"{}"}}
