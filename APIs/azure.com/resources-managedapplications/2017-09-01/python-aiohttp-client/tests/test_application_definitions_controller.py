...
async def test_application_definitions_create_or_update_by_id(client):
    ...
    response = await client.request(
        method='PUT',
        path='/{application_definition_id}'.format(application_definition_id='application_definition_id_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
...
async def test_application_definitions_delete_by_id(client):
...
async def test_application_definitions_get_by_id(client):
