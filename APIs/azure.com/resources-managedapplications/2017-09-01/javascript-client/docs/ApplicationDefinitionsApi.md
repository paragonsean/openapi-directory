...
[**applicationDefinitionsCreateOrUpdateById**](ApplicationDefinitionsApi.md#applicationDefinitionsCreateOrUpdateById) | **PUT** /{applicationDefinitionId} | 
...
[**applicationDefinitionsDeleteById**](ApplicationDefinitionsApi.md#applicationDefinitionsDeleteById) | **DELETE** /{applicationDefinitionId} | 
...
[**applicationDefinitionsGetById**](ApplicationDefinitionsApi.md#applicationDefinitionsGetById) | **GET** /{applicationDefinitionId} | 
...
## applicationDefinitionsCreateOrUpdateById

> ApplicationDefinition applicationDefinitionsCreateOrUpdateById(applicationDefinitionId, apiVersion, parameters)
...
let apiInstance = new ApplicationClient.ApplicationDefinitionsApi();
let applicationDefinitionId = "applicationDefinitionId_example"; // String | The fully qualified ID of the managed application definition, including the managed application name and the managed application definition resource type. Use the format, /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applicationDefinitions/{applicationDefinition-name}
let apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
let parameters = new ApplicationClient.ApplicationDefinition(); // ApplicationDefinition | Parameters supplied to the create or update a managed application definition.
apiInstance.applicationDefinitionsCreateOrUpdateById(applicationDefinitionId, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **apiVersion** | **String**| The API version to use for this operation. | 
 **parameters** | [**ApplicationDefinition**](ApplicationDefinition.md)| Parameters supplied to the create or update a managed application definition. | 
...
## applicationDefinitionsDeleteById

> applicationDefinitionsDeleteById(applicationDefinitionId, apiVersion)
...
let applicationDefinitionId = "applicationDefinitionId_example"; // String | The fully qualified ID of the managed application definition, including the managed application name and the managed application definition resource type. Use the format, /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applicationDefinitions/{applicationDefinition-name}
let apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
apiInstance.applicationDefinitionsDeleteById(applicationDefinitionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
## applicationDefinitionsGetById

> ApplicationDefinition applicationDefinitionsGetById(applicationDefinitionId, apiVersion)
...
let applicationDefinitionId = "applicationDefinitionId_example"; // String | The fully qualified ID of the managed application definition, including the managed application name and the managed application definition resource type. Use the format, /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applicationDefinitions/{applicationDefinition-name}
let apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
apiInstance.applicationDefinitionsGetById(applicationDefinitionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
