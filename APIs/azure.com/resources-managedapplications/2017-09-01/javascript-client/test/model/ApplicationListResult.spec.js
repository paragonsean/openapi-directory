...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationClient.ApplicationListResult();
  });
  ...
  describe('ApplicationListResult', function() {
    it('should create an instance of ApplicationListResult', function() {
      ...
      //var instance = new ApplicationClient.ApplicationListResult();
      //expect(instance).to.be.a(ApplicationClient.ApplicationListResult);
    });
