...
<a id="applicationDefinitionsCreateOrUpdateById"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicationDefinitionsApi apiInstance = new ApplicationDefinitionsApi(defaultClient);
    String applicationDefinitionId = "applicationDefinitionId_example"; // String | The fully qualified ID of the managed application definition, including the managed application name and the managed application definition resource type. Use the format, /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applicationDefinitions/{applicationDefinition-name}
    String apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
    ApplicationDefinition parameters = new ApplicationDefinition(); // ApplicationDefinition | Parameters supplied to the create or update a managed application definition.
    try {
      ApplicationDefinition result = apiInstance.applicationDefinitionsCreateOrUpdateById(applicationDefinitionId, apiVersion, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicationDefinitionsApi#applicationDefinitionsCreateOrUpdateById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="applicationDefinitionsDeleteById"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
    try {
      apiInstance.applicationDefinitionsDeleteById(applicationDefinitionId, apiVersion);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicationDefinitionsApi#applicationDefinitionsDeleteById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="applicationDefinitionsGetById"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | The API version to use for this operation.
    try {
      ApplicationDefinition result = apiInstance.applicationDefinitionsGetById(applicationDefinitionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicationDefinitionsApi#applicationDefinitionsGetById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
