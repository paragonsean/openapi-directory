...
QList<OAIApplicationArtifact> OAIApplicationDefinitionProperties::getArtifacts() const {
    return m_artifacts;
}
void OAIApplicationDefinitionProperties::setArtifacts(const QList<OAIApplicationArtifact> &artifacts) {
...
QList<OAIApplicationProviderAuthorization> OAIApplicationDefinitionProperties::getAuthorizations() const {
    return m_authorizations;
}
void OAIApplicationDefinitionProperties::setAuthorizations(const QList<OAIApplicationProviderAuthorization> &authorizations) {
...
QString OAIApplicationDefinitionProperties::getIsEnabled() const {
    return m_is_enabled;
}
void OAIApplicationDefinitionProperties::setIsEnabled(const QString &is_enabled) {
...
bool OAIApplicationDefinitionProperties::isValid() const {
    ...
    return m_authorizations_isValid && m_lock_level_isValid && true;
}
