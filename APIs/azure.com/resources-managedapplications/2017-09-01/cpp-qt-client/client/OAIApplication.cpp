...
OAIPlan OAIApplication::getPlan() const {
    return m_plan;
}
void OAIApplication::setPlan(const OAIPlan &plan) {
    m_plan = plan;
    m_plan_isSet = true;
}

bool OAIApplication::is_plan_Set() const{
    return m_plan_isSet;
}

bool OAIApplication::is_plan_Valid() const{
...
OAIIdentity OAIApplication::getIdentity() const {
    return m_identity;
}
void OAIApplication::setIdentity(const OAIIdentity &identity) {
    m_identity = identity;
    m_identity_isSet = true;
}

bool OAIApplication::is_identity_Set() const{
    return m_identity_isSet;
}

bool OAIApplication::is_identity_Valid() const{
    return m_identity_isValid;
}

QString OAIApplication::getManagedBy() const {
    return m_managed_by;
}
void OAIApplication::setManagedBy(const QString &managed_by) {
    m_managed_by = managed_by;
    m_managed_by_isSet = true;
}

bool OAIApplication::is_managed_by_Set() const{
    return m_managed_by_isSet;
}

bool OAIApplication::is_managed_by_Valid() const{
    return m_managed_by_isValid;
}

OAISku OAIApplication::getSku() const {
    return m_sku;
}
void OAIApplication::setSku(const OAISku &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIApplication::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIApplication::is_sku_Valid() const{
...
QString OAIApplication::getLocation() const {
    return m_location;
}
void OAIApplication::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIApplication::is_location_Set() const{
    return m_location_isSet;
}

bool OAIApplication::is_location_Valid() const{
