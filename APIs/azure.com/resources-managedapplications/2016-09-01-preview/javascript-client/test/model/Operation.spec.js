...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedApplicationClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ManagedApplicationClient.Operation();
      //expect(instance).to.be.a(ManagedApplicationClient.Operation);
    });
