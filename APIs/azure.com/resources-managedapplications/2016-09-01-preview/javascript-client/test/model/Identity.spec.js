...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedApplicationClient.Identity();
  });
  ...
  describe('Identity', function() {
    it('should create an instance of Identity', function() {
      ...
      //var instance = new ManagedApplicationClient.Identity();
      //expect(instance).to.be.a(ManagedApplicationClient.Identity);
    });
