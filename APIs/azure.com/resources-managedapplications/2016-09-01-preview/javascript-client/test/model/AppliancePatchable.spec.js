...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedApplicationClient.AppliancePatchable();
  });
  ...
  describe('AppliancePatchable', function() {
    it('should create an instance of AppliancePatchable', function() {
      // uncomment below and update the code to test AppliancePatchable
      //var instance = new ManagedApplicationClient.AppliancePatchable();
      //expect(instance).to.be.a(ManagedApplicationClient.AppliancePatchable);
    });
