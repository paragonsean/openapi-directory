...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedApplicationClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ManagedApplicationClient.OperationDisplay();
      //expect(instance).to.be.a(ManagedApplicationClient.OperationDisplay);
    });
