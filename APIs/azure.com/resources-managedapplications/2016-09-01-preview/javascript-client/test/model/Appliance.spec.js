...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedApplicationClient.Appliance();
  });
  ...
  describe('Appliance', function() {
    it('should create an instance of Appliance', function() {
      // uncomment below and update the code to test Appliance
      //var instance = new ManagedApplicationClient.Appliance();
      //expect(instance).to.be.a(ManagedApplicationClient.Appliance);
    });
