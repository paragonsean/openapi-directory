...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedApplicationClient.ApplianceProperties();
  });
  ...
  describe('ApplianceProperties', function() {
    it('should create an instance of ApplianceProperties', function() {
      // uncomment below and update the code to test ApplianceProperties
      //var instance = new ManagedApplicationClient.ApplianceProperties();
      //expect(instance).to.be.a(ManagedApplicationClient.ApplianceProperties);
    });
