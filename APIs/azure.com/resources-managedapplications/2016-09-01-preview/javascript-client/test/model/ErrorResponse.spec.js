...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedApplicationClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new ManagedApplicationClient.ErrorResponse();
      //expect(instance).to.be.a(ManagedApplicationClient.ErrorResponse);
    });
