...
#ifndef OAIAppliance_H
#define OAIAppliance_H
...
namespace OpenAPI {
class OAIPlan;
class OAIApplianceProperties;
class OAIIdentity;
class OAISku;

class OAIAppliance : public OAIObject {
public:
    OAIAppliance();
    OAIAppliance(QString json);
    ~OAIAppliance() override;
    ...
    OAIApplianceProperties getProperties() const;
    void setProperties(const OAIApplianceProperties &properties);
...
private:
    ...
    OAIApplianceProperties m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppliance)

#endif // OAIAppliance_H
