...
/*
 * OAIApplianceDefinition.h
 *
 * Information about appliance definition.
 */

#ifndef OAIApplianceDefinition_H
#define OAIApplianceDefinition_H
...
namespace OpenAPI {
class OAIApplianceDefinitionProperties;
class OAIIdentity;
class OAISku;

class OAIApplianceDefinition : public OAIObject {
public:
    OAIApplianceDefinition();
    OAIApplianceDefinition(QString json);
    ~OAIApplianceDefinition() override;
    ...
    OAIApplianceDefinitionProperties getProperties() const;
    void setProperties(const OAIApplianceDefinitionProperties &properties);
...
private:
    ...
    OAIApplianceDefinitionProperties m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplianceDefinition)

#endif // OAIApplianceDefinition_H
