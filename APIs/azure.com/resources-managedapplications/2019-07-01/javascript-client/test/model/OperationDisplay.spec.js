...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ApplicationClient.OperationDisplay();
      //expect(instance).to.be.a(ApplicationClient.OperationDisplay);
    });
