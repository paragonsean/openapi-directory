...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationClient.JitAuthorizationPolicies();
  });
  ...
  describe('JitAuthorizationPolicies', function() {
    it('should create an instance of JitAuthorizationPolicies', function() {
      // uncomment below and update the code to test JitAuthorizationPolicies
      //var instance = new ApplicationClient.JitAuthorizationPolicies();
      //expect(instance).to.be.a(ApplicationClient.JitAuthorizationPolicies);
    });
