...
public class OperationsApi {
    ...
    public okhttp3.Call listOperationsCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.Solutions/operations";
     ...
     */
    public OperationListResult listOperations(String apiVersion) throws ApiException {
        ApiResponse<OperationListResult> localVarResp = listOperationsWithHttpInfo(apiVersion);
     ...
     */
    public ApiResponse<OperationListResult> listOperationsWithHttpInfo(String apiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call listOperationsAsync(String apiVersion, final ApiCallback<OperationListResult> _callback) throws ApiException {
