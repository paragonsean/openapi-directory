...
class Credential {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = CredentialProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          CredentialProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/CredentialProperties} properties
 */
Credential.prototype['properties'] = undefined;
