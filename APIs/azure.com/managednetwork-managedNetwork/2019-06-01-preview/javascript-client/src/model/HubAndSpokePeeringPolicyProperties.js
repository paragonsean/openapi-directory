...
/**
 * The HubAndSpokePeeringPolicyProperties model module.
 * @module model/HubAndSpokePeeringPolicyProperties
 * @version 2019-06-01-preview
 */
class HubAndSpokePeeringPolicyProperties {
    /**
     * Constructs a new <code>HubAndSpokePeeringPolicyProperties</code>.
     * Properties of a Hub and Spoke Peering Policy
     * @alias module:model/HubAndSpokePeeringPolicyProperties
     * @implements module:model/ManagedNetworkPeeringPolicyProperties
     * @param type {module:model/HubAndSpokePeeringPolicyProperties.TypeEnum} Gets or sets the connectivity type of a network structure policy
     */
    constructor(type) { 
        ManagedNetworkPeeringPolicyProperties.initialize(this);
        HubAndSpokePeeringPolicyProperties.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>HubAndSpokePeeringPolicyProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HubAndSpokePeeringPolicyProperties} obj Optional instance to populate.
     * @return {module:model/HubAndSpokePeeringPolicyProperties} The populated <code>HubAndSpokePeeringPolicyProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HubAndSpokePeeringPolicyProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>HubAndSpokePeeringPolicyProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HubAndSpokePeeringPolicyProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HubAndSpokePeeringPolicyProperties.RequiredProperties) {
...
HubAndSpokePeeringPolicyProperties.RequiredProperties = ["type"];

/**
 * @member {module:model/ResourceId} hub
 */
HubAndSpokePeeringPolicyProperties.prototype['hub'] = undefined;

/**
 * Gets or sets the spokes group IDs
 * @member {Array.<module:model/ResourceId>} spokes
 */
HubAndSpokePeeringPolicyProperties.prototype['spokes'] = undefined;

/**
 * Gets or sets the mesh group IDs
 * @member {Array.<module:model/ResourceId>} mesh
 */
HubAndSpokePeeringPolicyProperties.prototype['mesh'] = undefined;

/**
 * Gets or sets the connectivity type of a network structure policy
 * @member {module:model/HubAndSpokePeeringPolicyProperties.TypeEnum} type
 */
HubAndSpokePeeringPolicyProperties.prototype['type'] = undefined;

/**
 * A unique read-only string that changes whenever the resource is updated.
 * @member {String} etag
 */
HubAndSpokePeeringPolicyProperties.prototype['etag'] = undefined;

/**
 * Provisioning state of the ManagedNetwork resource.
 * @member {module:model/HubAndSpokePeeringPolicyProperties.ProvisioningStateEnum} provisioningState
 */
HubAndSpokePeeringPolicyProperties.prototype['provisioningState'] = undefined;
 ...
 * @readonly
 */
HubAndSpokePeeringPolicyProperties['TypeEnum'] = {
 ...
 * @readonly
 */
HubAndSpokePeeringPolicyProperties['ProvisioningStateEnum'] = {
...
export default HubAndSpokePeeringPolicyProperties;
