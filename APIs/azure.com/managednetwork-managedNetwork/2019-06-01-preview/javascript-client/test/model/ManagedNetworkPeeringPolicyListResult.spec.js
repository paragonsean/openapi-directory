...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetworkPeeringPolicyListResult();
  });
  ...
  describe('ManagedNetworkPeeringPolicyListResult', function() {
    it('should create an instance of ManagedNetworkPeeringPolicyListResult', function() {
      // uncomment below and update the code to test ManagedNetworkPeeringPolicyListResult
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkPeeringPolicyListResult();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetworkPeeringPolicyListResult);
    });
