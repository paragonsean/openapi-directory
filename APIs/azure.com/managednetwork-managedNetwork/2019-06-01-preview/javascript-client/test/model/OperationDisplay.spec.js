...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ManagedNetworkManagementClient.OperationDisplay();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.OperationDisplay);
    });
