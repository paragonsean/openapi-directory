...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetworkListResult();
  });
  ...
  describe('ManagedNetworkListResult', function() {
    it('should create an instance of ManagedNetworkListResult', function() {
      // uncomment below and update the code to test ManagedNetworkListResult
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkListResult();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetworkListResult);
    });
