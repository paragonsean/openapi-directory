...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ConnectivityCollection();
  });
  ...
  describe('ConnectivityCollection', function() {
    it('should create an instance of ConnectivityCollection', function() {
      // uncomment below and update the code to test ConnectivityCollection
      //var instance = new ManagedNetworkManagementClient.ConnectivityCollection();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ConnectivityCollection);
    });
