...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetwork();
  });
  ...
  describe('ManagedNetwork', function() {
    it('should create an instance of ManagedNetwork', function() {
      // uncomment below and update the code to test ManagedNetwork
      //var instance = new ManagedNetworkManagementClient.ManagedNetwork();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetwork);
    });
