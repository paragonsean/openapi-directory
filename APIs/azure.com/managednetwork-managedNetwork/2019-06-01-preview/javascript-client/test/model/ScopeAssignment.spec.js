...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ScopeAssignment();
  });
  ...
  describe('ScopeAssignment', function() {
    it('should create an instance of ScopeAssignment', function() {
      // uncomment below and update the code to test ScopeAssignment
      //var instance = new ManagedNetworkManagementClient.ScopeAssignment();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ScopeAssignment);
    });
