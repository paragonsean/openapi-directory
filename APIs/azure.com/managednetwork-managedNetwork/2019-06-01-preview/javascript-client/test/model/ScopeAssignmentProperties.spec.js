...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ScopeAssignmentProperties();
  });
  ...
  describe('ScopeAssignmentProperties', function() {
    it('should create an instance of ScopeAssignmentProperties', function() {
      // uncomment below and update the code to test ScopeAssignmentProperties
      //var instance = new ManagedNetworkManagementClient.ScopeAssignmentProperties();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ScopeAssignmentProperties);
    });

    it('should have the property assignedManagedNetwork (base name: "assignedManagedNetwork")', function() {
      // uncomment below and update the code to test the property assignedManagedNetwork
      //var instance = new ManagedNetworkManagementClient.ScopeAssignmentProperties();
