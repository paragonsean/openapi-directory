...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetworkPeeringPolicyProperties();
  });
  ...
  describe('ManagedNetworkPeeringPolicyProperties', function() {
    it('should create an instance of ManagedNetworkPeeringPolicyProperties', function() {
      // uncomment below and update the code to test ManagedNetworkPeeringPolicyProperties
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkPeeringPolicyProperties();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetworkPeeringPolicyProperties);
    });
