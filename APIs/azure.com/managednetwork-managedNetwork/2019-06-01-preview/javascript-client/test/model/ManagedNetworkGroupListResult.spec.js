...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetworkGroupListResult();
  });
  ...
  describe('ManagedNetworkGroupListResult', function() {
    it('should create an instance of ManagedNetworkGroupListResult', function() {
      // uncomment below and update the code to test ManagedNetworkGroupListResult
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkGroupListResult();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetworkGroupListResult);
    });
