...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ScopeAssignmentListResult();
  });
  ...
  describe('ScopeAssignmentListResult', function() {
    it('should create an instance of ScopeAssignmentListResult', function() {
      // uncomment below and update the code to test ScopeAssignmentListResult
      //var instance = new ManagedNetworkManagementClient.ScopeAssignmentListResult();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ScopeAssignmentListResult);
    });
