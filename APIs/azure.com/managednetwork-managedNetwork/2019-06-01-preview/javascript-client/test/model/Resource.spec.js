...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new ManagedNetworkManagementClient.Resource();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.Resource);
    });
