...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetworkUpdate();
  });
  ...
  describe('ManagedNetworkUpdate', function() {
    it('should create an instance of ManagedNetworkUpdate', function() {
      // uncomment below and update the code to test ManagedNetworkUpdate
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkUpdate();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetworkUpdate);
    });
