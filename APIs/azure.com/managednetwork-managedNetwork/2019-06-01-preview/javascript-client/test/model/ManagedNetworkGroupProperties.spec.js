...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetworkGroupProperties();
  });
  ...
  describe('ManagedNetworkGroupProperties', function() {
    it('should create an instance of ManagedNetworkGroupProperties', function() {
      // uncomment below and update the code to test ManagedNetworkGroupProperties
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkGroupProperties();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetworkGroupProperties);
    });

    it('should have the property managementGroups (base name: "managementGroups")', function() {
      // uncomment below and update the code to test the property managementGroups
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkGroupProperties();
