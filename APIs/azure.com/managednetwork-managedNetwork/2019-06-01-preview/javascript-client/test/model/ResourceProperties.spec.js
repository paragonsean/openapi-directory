...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ResourceProperties();
  });
  ...
  describe('ResourceProperties', function() {
    it('should create an instance of ResourceProperties', function() {
      ...
      //var instance = new ManagedNetworkManagementClient.ResourceProperties();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ResourceProperties);
    });
