...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ManagedNetworkManagementClient.Operation();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.Operation);
    });
