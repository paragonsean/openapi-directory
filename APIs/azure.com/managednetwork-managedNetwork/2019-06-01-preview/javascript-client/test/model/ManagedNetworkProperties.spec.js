...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.ManagedNetworkProperties();
  });
  ...
  describe('ManagedNetworkProperties', function() {
    it('should create an instance of ManagedNetworkProperties', function() {
      // uncomment below and update the code to test ManagedNetworkProperties
      //var instance = new ManagedNetworkManagementClient.ManagedNetworkProperties();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.ManagedNetworkProperties);
    });
