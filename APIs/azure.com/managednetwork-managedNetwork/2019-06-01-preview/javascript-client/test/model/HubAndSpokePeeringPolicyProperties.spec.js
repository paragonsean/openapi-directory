...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.HubAndSpokePeeringPolicyProperties();
  });
  ...
  describe('HubAndSpokePeeringPolicyProperties', function() {
    it('should create an instance of HubAndSpokePeeringPolicyProperties', function() {
      // uncomment below and update the code to test HubAndSpokePeeringPolicyProperties
      //var instance = new ManagedNetworkManagementClient.HubAndSpokePeeringPolicyProperties();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.HubAndSpokePeeringPolicyProperties);
    });
