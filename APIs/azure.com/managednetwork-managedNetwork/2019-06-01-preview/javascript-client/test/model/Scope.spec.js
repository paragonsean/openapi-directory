...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedNetworkManagementClient.Scope();
  });
  ...
  describe('Scope', function() {
    it('should create an instance of Scope', function() {
      ...
      //var instance = new ManagedNetworkManagementClient.Scope();
      //expect(instance).to.be.a(ManagedNetworkManagementClient.Scope);
    });
