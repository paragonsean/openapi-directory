...
/*
 * OAIHubAndSpokePeeringPolicyProperties.h
 *
 * Properties of a Hub and Spoke Peering Policy
 */

#ifndef OAIHubAndSpokePeeringPolicyProperties_H
#define OAIHubAndSpokePeeringPolicyProperties_H
...
class OAIHubAndSpokePeeringPolicyProperties : public OAIObject {
public:
    OAIHubAndSpokePeeringPolicyProperties();
    OAIHubAndSpokePeeringPolicyProperties(QString json);
    ~OAIHubAndSpokePeeringPolicyProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHubAndSpokePeeringPolicyProperties)

#endif // OAIHubAndSpokePeeringPolicyProperties_H
