...
/*
 * OAIManagedNetworkUpdate.h
 *
 * Update Tags of Managed Network
 */

#ifndef OAIManagedNetworkUpdate_H
#define OAIManagedNetworkUpdate_H
...
class OAIManagedNetworkUpdate : public OAIObject {
public:
    OAIManagedNetworkUpdate();
    OAIManagedNetworkUpdate(QString json);
    ~OAIManagedNetworkUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIManagedNetworkUpdate)

#endif // OAIManagedNetworkUpdate_H
