...
/*
 * OAIScopeAssignmentListResult.h
 *
 * Result of the request to list ScopeAssignment. It contains a list of groups and a URL link to get the next set of results.
 */

#ifndef OAIScopeAssignmentListResult_H
#define OAIScopeAssignmentListResult_H

#include <QJsonObject>

#include "OAIScopeAssignment.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIScopeAssignment;

class OAIScopeAssignmentListResult : public OAIObject {
public:
    OAIScopeAssignmentListResult();
    OAIScopeAssignmentListResult(QString json);
    ~OAIScopeAssignmentListResult() override;
    ...
    QList<OAIScopeAssignment> getValue() const;
    void setValue(const QList<OAIScopeAssignment> &value);
...
private:
    ...
    QList<OAIScopeAssignment> m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScopeAssignmentListResult)

#endif // OAIScopeAssignmentListResult_H
