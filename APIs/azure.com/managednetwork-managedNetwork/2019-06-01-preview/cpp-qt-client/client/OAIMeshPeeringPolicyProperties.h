...
/*
 * OAIMeshPeeringPolicyProperties.h
 *
 * Properties of a Mesh Peering Policy
 */

#ifndef OAIMeshPeeringPolicyProperties_H
#define OAIMeshPeeringPolicyProperties_H
...
class OAIMeshPeeringPolicyProperties : public OAIObject {
public:
    OAIMeshPeeringPolicyProperties();
    OAIMeshPeeringPolicyProperties(QString json);
    ~OAIMeshPeeringPolicyProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMeshPeeringPolicyProperties)

#endif // OAIMeshPeeringPolicyProperties_H
