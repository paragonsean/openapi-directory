...
public class PlanList {
  ...
  private List<Plan> value = new ArrayList<>();

  public PlanList() {
  }

  public PlanList nextLink(String nextLink) {
  ...
  public PlanList value(List<Plan> value) {
    this.value = value;
    return this;
  }

  public PlanList addValueItem(Plan valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<Plan> getValue() {
    return value;
  }

  public void setValue(List<Plan> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextLink, planList.nextLink) &&
        Objects.equals(this.value, planList.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            Plan.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
