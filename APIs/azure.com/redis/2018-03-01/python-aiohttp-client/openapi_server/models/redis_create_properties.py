...
class RedisCreateProperties(Model):
    ...
    def __init__(self, sku: Sku=None, static_ip: str=None, subnet_id: str=None, enable_non_ssl_port: bool=None, minimum_tls_version: str=None, redis_configuration: Dict[str, str]=None, shard_count: int=None, tenant_settings: Dict[str, str]=None):
