...
QString OAIRedisCreateProperties::getMinimumTlsVersion() const {
    return m_minimum_tls_version;
}
void OAIRedisCreateProperties::setMinimumTlsVersion(const QString &minimum_tls_version) {
    m_minimum_tls_version = minimum_tls_version;
    m_minimum_tls_version_isSet = true;
}

bool OAIRedisCreateProperties::is_minimum_tls_version_Set() const{
    return m_minimum_tls_version_isSet;
}

bool OAIRedisCreateProperties::is_minimum_tls_version_Valid() const{
