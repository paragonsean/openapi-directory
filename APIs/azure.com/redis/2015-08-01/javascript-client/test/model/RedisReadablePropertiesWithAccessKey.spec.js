...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedisManagementClient.RedisReadablePropertiesWithAccessKey();
  });
  ...
  describe('RedisReadablePropertiesWithAccessKey', function() {
    it('should create an instance of RedisReadablePropertiesWithAccessKey', function() {
      // uncomment below and update the code to test RedisReadablePropertiesWithAccessKey
      //var instance = new RedisManagementClient.RedisReadablePropertiesWithAccessKey();
      //expect(instance).to.be.a(RedisManagementClient.RedisReadablePropertiesWithAccessKey);
    });
