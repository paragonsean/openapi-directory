...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedisManagementClient.RedisListKeysResult();
  });
  ...
  describe('RedisListKeysResult', function() {
    it('should create an instance of RedisListKeysResult', function() {
      // uncomment below and update the code to test RedisListKeysResult
      //var instance = new RedisManagementClient.RedisListKeysResult();
      //expect(instance).to.be.a(RedisManagementClient.RedisListKeysResult);
    });
