...
class Sku {
     ...
     * @param capacity {Number} What size of Redis cache to deploy. Valid values: for C family (0, 1, 2, 3, 4, 5, 6), for P family (1, 2, 3, 4).
     * @param family {module:model/Sku.FamilyEnum} Which family to use. Valid values: (C, P).
     * @param name {module:model/Sku.NameEnum} What type of Redis cache to deploy. Valid values: (Basic, Standard, Premium).
     */
