...
/**
 * The RedisReadableProperties model module.
 * @module model/RedisReadableProperties
 * @version 2015-08-01
 */
class RedisReadableProperties {
    /**
     * Constructs a new <code>RedisReadableProperties</code>.
     * Parameters describing a Redis instance
     * @alias module:model/RedisReadableProperties
    ...
    /**
     * Constructs a <code>RedisReadableProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedisReadableProperties} obj Optional instance to populate.
     * @return {module:model/RedisReadableProperties} The populated <code>RedisReadableProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedisReadableProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>RedisReadableProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedisReadableProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RedisReadableProperties.RequiredProperties) {
...
RedisReadableProperties.RequiredProperties = ["sku"];

/**
 * Redis host name.
 * @member {String} hostName
 */
RedisReadableProperties.prototype['hostName'] = undefined;

/**
 * Redis non-SSL port.
 * @member {Number} port
 */
RedisReadableProperties.prototype['port'] = undefined;

/**
 * Redis instance provisioning status.
 * @member {String} provisioningState
 */
RedisReadableProperties.prototype['provisioningState'] = undefined;

/**
 * Redis SSL port.
 * @member {Number} sslPort
 */
RedisReadableProperties.prototype['sslPort'] = undefined;
...
export default RedisReadableProperties;
