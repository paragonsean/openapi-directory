...
/*
 * OAIRedisReadablePropertiesWithAccessKey.h
 *
 * Properties generated only in response to CreateOrUpdate Redis operation.
 */

#ifndef OAIRedisReadablePropertiesWithAccessKey_H
#define OAIRedisReadablePropertiesWithAccessKey_H
...
class OAIRedisReadablePropertiesWithAccessKey : public OAIObject {
public:
    OAIRedisReadablePropertiesWithAccessKey();
    OAIRedisReadablePropertiesWithAccessKey(QString json);
    ~OAIRedisReadablePropertiesWithAccessKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedisReadablePropertiesWithAccessKey)

#endif // OAIRedisReadablePropertiesWithAccessKey_H
