...
/*
 * OAIRedisListKeysResult.h
 *
 * The response of Redis list keys operation.
 */

#ifndef OAIRedisListKeysResult_H
#define OAIRedisListKeysResult_H
...
class OAIRedisListKeysResult : public OAIObject {
public:
    OAIRedisListKeysResult();
    OAIRedisListKeysResult(QString json);
    ~OAIRedisListKeysResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedisListKeysResult)

#endif // OAIRedisListKeysResult_H
