...
public:
    ...
    */
    virtual void firewallRulesCreateOrUpdate(const QString &resource_group_name, const QString &cache_name, const QString &rule_name, const QString &api_version, const QString &subscription_id, const OAIRedisFirewallRule &parameters);
