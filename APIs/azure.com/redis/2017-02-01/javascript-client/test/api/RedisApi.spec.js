...
(function(root, factory) {
  ...
  describe('RedisApi', function() {
    ...
    describe('redisLinkedServerCreate', function() {
      it('should call redisLinkedServerCreate successfully', function(done) {
        //uncomment below and update the code to test redisLinkedServerCreate
        //instance.redisLinkedServerCreate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('redisLinkedServerDelete', function() {
      it('should call redisLinkedServerDelete successfully', function(done) {
        //uncomment below and update the code to test redisLinkedServerDelete
        //instance.redisLinkedServerDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('redisLinkedServerGet', function() {
      it('should call redisLinkedServerGet successfully', function(done) {
        //uncomment below and update the code to test redisLinkedServerGet
        //instance.redisLinkedServerGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('redisLinkedServerList', function() {
      it('should call redisLinkedServerList successfully', function(done) {
        //uncomment below and update the code to test redisLinkedServerList
        //instance.redisLinkedServerList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
