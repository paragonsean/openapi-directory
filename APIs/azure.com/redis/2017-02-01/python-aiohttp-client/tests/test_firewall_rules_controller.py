...
async def test_firewall_rules_create_or_update_0(client):
    """Test case for firewall_rules_create_or_update_0
...
async def test_firewall_rules_delete_0(client):
    """Test case for firewall_rules_delete_0
...
async def test_firewall_rules_get_0(client):
    """Test case for firewall_rules_get_0
...
async def test_firewall_rules_list_by_redis_resource_0(client):
    """Test case for firewall_rules_list_by_redis_resource_0
