...
async def firewall_rules_create_or_update_0(request: web.Request, resource_group_name, cache_name, rule_name, api_version, subscription_id, parameters) -> web.Response:
...
async def firewall_rules_delete_0(request: web.Request, resource_group_name, cache_name, rule_name, api_version, subscription_id) -> web.Response:
...
async def firewall_rules_get_0(request: web.Request, resource_group_name, cache_name, rule_name, api_version, subscription_id) -> web.Response:
...
async def firewall_rules_list_by_redis_resource_0(request: web.Request, api_version, subscription_id, resource_group_name, cache_name) -> web.Response:
