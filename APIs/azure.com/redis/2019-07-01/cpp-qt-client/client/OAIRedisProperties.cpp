...
QList<OAIRedisInstanceDetails> OAIRedisProperties::getInstances() const {
    return m_instances;
}
void OAIRedisProperties::setInstances(const QList<OAIRedisInstanceDetails> &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAIRedisProperties::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAIRedisProperties::is_instances_Valid() const{
...
qint32 OAIRedisProperties::getReplicasPerMaster() const {
    return m_replicas_per_master;
}
void OAIRedisProperties::setReplicasPerMaster(const qint32 &replicas_per_master) {
    m_replicas_per_master = replicas_per_master;
    m_replicas_per_master_isSet = true;
}

bool OAIRedisProperties::is_replicas_per_master_Set() const{
    return m_replicas_per_master_isSet;
}

bool OAIRedisProperties::is_replicas_per_master_Valid() const{
