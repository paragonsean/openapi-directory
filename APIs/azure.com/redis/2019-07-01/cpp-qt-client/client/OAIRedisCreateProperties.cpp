...
qint32 OAIRedisCreateProperties::getReplicasPerMaster() const {
    return m_replicas_per_master;
}
void OAIRedisCreateProperties::setReplicasPerMaster(const qint32 &replicas_per_master) {
    m_replicas_per_master = replicas_per_master;
    m_replicas_per_master_isSet = true;
}

bool OAIRedisCreateProperties::is_replicas_per_master_Set() const{
    return m_replicas_per_master_isSet;
}

bool OAIRedisCreateProperties::is_replicas_per_master_Valid() const{
