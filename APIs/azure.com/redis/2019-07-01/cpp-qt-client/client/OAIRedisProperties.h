...
public:
    ...
    QList<OAIRedisInstanceDetails> getInstances() const;
    void setInstances(const QList<OAIRedisInstanceDetails> &instances);
...
private:
    ...
    QList<OAIRedisInstanceDetails> m_instances;
