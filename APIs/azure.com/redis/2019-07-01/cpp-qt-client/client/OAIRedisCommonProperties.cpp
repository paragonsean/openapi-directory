...
QString OAIRedisCommonProperties::getMinimumTlsVersion() const {
    return m_minimum_tls_version;
}
void OAIRedisCommonProperties::setMinimumTlsVersion(const QString &minimum_tls_version) {
    m_minimum_tls_version = minimum_tls_version;
    m_minimum_tls_version_isSet = true;
}

bool OAIRedisCommonProperties::is_minimum_tls_version_Set() const{
    return m_minimum_tls_version_isSet;
}

bool OAIRedisCommonProperties::is_minimum_tls_version_Valid() const{
...
qint32 OAIRedisCommonProperties::getReplicasPerMaster() const {
    return m_replicas_per_master;
}
void OAIRedisCommonProperties::setReplicasPerMaster(const qint32 &replicas_per_master) {
    m_replicas_per_master = replicas_per_master;
    m_replicas_per_master_isSet = true;
}

bool OAIRedisCommonProperties::is_replicas_per_master_Set() const{
    return m_replicas_per_master_isSet;
}

bool OAIRedisCommonProperties::is_replicas_per_master_Valid() const{
