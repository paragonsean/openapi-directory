...
import RedisInstanceDetails from './RedisInstanceDetails';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('instances')) {
                obj['instances'] = ApiClient.convertToType(data['instances'], [RedisInstanceDetails]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['instances']) { // data not null
            ...
            for (const item of data['instances']) {
                RedisInstanceDetails.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/RedisInstanceDetails>} instances
 */
RedisProperties.prototype['instances'] = undefined;
 ...
 */
RedisProperties.prototype['replicasPerMaster'] = undefined;
