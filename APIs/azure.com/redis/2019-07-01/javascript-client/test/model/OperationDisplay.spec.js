...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedisManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new RedisManagementClient.OperationDisplay();
      //expect(instance).to.be.a(RedisManagementClient.OperationDisplay);
    });
