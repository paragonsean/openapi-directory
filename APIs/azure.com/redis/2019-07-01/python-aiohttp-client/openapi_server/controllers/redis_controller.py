...
async def firewall_rules_create_or_update(request: web.Request, resource_group_name, cache_name, rule_name, api_version, subscription_id, parameters) -> web.Response:
    ...
    """
    parameters = RedisFirewallRuleCreateParameters.from_dict(parameters)
...
async def linked_server_create(request: web.Request, resource_group_name, name, linked_server_name, api_version, subscription_id, parameters) -> web.Response:
...
async def linked_server_delete(request: web.Request, resource_group_name, name, linked_server_name, api_version, subscription_id) -> web.Response:
...
async def linked_server_get(request: web.Request, resource_group_name, name, linked_server_name, api_version, subscription_id) -> web.Response:
    """linked_server_get
...
async def linked_server_list(request: web.Request, resource_group_name, name, api_version, subscription_id) -> web.Response:
    """linked_server_list
...
async def patch_schedules_create_or_update(request: web.Request, resource_group_name, name, default, api_version, subscription_id, parameters) -> web.Response:
...
async def patch_schedules_delete(request: web.Request, resource_group_name, name, default, api_version, subscription_id) -> web.Response:
...
async def patch_schedules_get(request: web.Request, resource_group_name, name, default, api_version, subscription_id) -> web.Response:
    """patch_schedules_get
...
async def patch_schedules_list_by_redis_resource(request: web.Request, api_version, subscription_id, resource_group_name, cache_name) -> web.Response:
...
async def redis_check_name_availability(request: web.Request, api_version, subscription_id, parameters) -> web.Response:
...
async def redis_list_upgrade_notifications(request: web.Request, resource_group_name, name, api_version, subscription_id, history) -> web.Response:
