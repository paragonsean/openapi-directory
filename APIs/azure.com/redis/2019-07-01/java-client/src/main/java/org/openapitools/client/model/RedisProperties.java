...
public class RedisProperties {
  ...
  private List<RedisInstanceDetails> instances = new ArrayList<>();
  ...
  public RedisProperties replicasPerMaster(Integer replicasPerMaster) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKeys, redisProperties.accessKeys) &&
        ...
        Objects.equals(this.instances, redisProperties.instances) &&
        ...
        Objects.equals(this.replicasPerMaster, redisProperties.replicasPerMaster) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessKeys, hostName, instances, linkedServers, port, provisioningState, redisVersion, sslPort, sku, staticIP, subnetId, enableNonSslPort, minimumTlsVersion, redisConfiguration, replicasPerMaster, shardCount, tenantSettings);
  }
      ...
      if (jsonObj.get("instances") != null && !jsonObj.get("instances").isJsonNull()) {
        ...
        if (jsonArrayinstances != null) {
          ...
          for (int i = 0; i < jsonArrayinstances.size(); i++) {
            RedisInstanceDetails.validateJsonElement(jsonArrayinstances.get(i));
          };
        }
      }
