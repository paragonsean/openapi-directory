...
async def test_firewall_rules_list(client):
...
async def test_patch_schedules_create_or_update(client):
    ...
    """
    parameters = {"name":"name","location":"location","id":"id","type":"type","properties":{"scheduleEntries":[{"maintenanceWindow":"maintenanceWindow","dayOfWeek":"Monday","startHourUtc":0},{"maintenanceWindow":"maintenanceWindow","dayOfWeek":"Monday","startHourUtc":0}]}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Cache/Redis/{name}/patchSchedules/default'.format(resource_group_name='resource_group_name_example', name='name_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
...
async def test_redis_create(client):
    ...
    """
    parameters = {"properties":{"sku":{"name":"Basic","family":"C","capacity":6}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_redis_firewall_rule_create_or_update(client):
...
async def test_redis_firewall_rule_delete(client):
...
async def test_redis_firewall_rule_get(client):
...
async def test_redis_update(client):
    ...
    """
    parameters = {"properties":{"sku":{"name":"Basic","family":"C","capacity":6}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
