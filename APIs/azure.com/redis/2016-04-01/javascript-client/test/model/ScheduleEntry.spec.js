...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedisManagementClient.ScheduleEntry();
  });
  ...
  describe('ScheduleEntry', function() {
    it('should create an instance of ScheduleEntry', function() {
      ...
      //var instance = new RedisManagementClient.ScheduleEntry();
      //expect(instance).to.be.a(RedisManagementClient.ScheduleEntry);
    });
    ...
    it('should have the property startHourUtc (base name: "startHourUtc")', function() {
      // uncomment below and update the code to test the property startHourUtc
      //var instance = new RedisManagementClient.ScheduleEntry();
      //expect(instance).to.be();
    });
