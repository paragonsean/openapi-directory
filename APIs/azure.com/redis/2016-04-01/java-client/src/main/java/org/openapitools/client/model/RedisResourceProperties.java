...
public class RedisResourceProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessKeys, hostName, port, provisioningState, redisVersion, sku, sslPort, enableNonSslPort, redisConfiguration, shardCount, staticIP, subnetId, tenantSettings);
  }
