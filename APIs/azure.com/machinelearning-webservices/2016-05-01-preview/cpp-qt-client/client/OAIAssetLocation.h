...
#ifndef OAIAssetLocation_H
#define OAIAssetLocation_H
...
class OAIAssetLocation : public OAIObject {
public:
    OAIAssetLocation();
    OAIAssetLocation(QString json);
    ~OAIAssetLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetLocation)

#endif // OAIAssetLocation_H
