...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMlWebServicesManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new AzureMlWebServicesManagementClient.Resource();
      //expect(instance).to.be.a(AzureMlWebServicesManagementClient.Resource);
    });
