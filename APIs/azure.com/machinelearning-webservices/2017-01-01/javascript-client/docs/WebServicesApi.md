...
let resourceGroupName = "resourceGroupName_example"; // String | Name of the resource group in which the web service is located.
let webServiceName = "webServiceName_example"; // String | The name of the web service.
let region = "region_example"; // String | The region for which encrypted credential parameters are created.
let apiVersion = "apiVersion_example"; // String | The version of the Microsoft.MachineLearning resource provider API to use.
let subscriptionId = "subscriptionId_example"; // String | The Azure subscription ID.
apiInstance.webServicesCreateRegionalProperties(resourceGroupName, webServiceName, region, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> WebService webServicesGet(resourceGroupName, webServiceName, apiVersion, subscriptionId, opts)
...
let subscriptionId = "subscriptionId_example"; // String | The Azure subscription ID.
let opts = {
  'region': "region_example" // String | The region for which encrypted credential parameters are valid.
};
apiInstance.webServicesGet(resourceGroupName, webServiceName, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PaginatedWebServicesList webServicesListBySubscriptionId(apiVersion, subscriptionId, opts)
...
apiInstance.webServicesListBySubscriptionId(apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiVersion = "apiVersion_example"; // String | The version of the Microsoft.MachineLearning resource provider API to use.
let subscriptionId = "subscriptionId_example"; // String | The Azure subscription ID.
let patchPayload = new AzureMlWebServicesManagementClient.PatchedWebService(); // PatchedWebService | The payload to use to patch the web service.
