...
class WebServiceProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('parameters')) {
                obj['parameters'] = ApiClient.convertToType(data['parameters'], {'String': WebServiceParameter});
            }
            if (data.hasOwnProperty('payloadsInBlobStorage')) {
                obj['payloadsInBlobStorage'] = ApiClient.convertToType(data['payloadsInBlobStorage'], 'Boolean');
            }
            if (data.hasOwnProperty('payloadsLocation')) {
                obj['payloadsLocation'] = BlobLocation.constructFromObject(data['payloadsLocation']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `payloadsLocation`
        if (data['payloadsLocation']) { // data not null
          BlobLocation.validateJSON(data['payloadsLocation']);
        }
        // ensure the json data is a string
