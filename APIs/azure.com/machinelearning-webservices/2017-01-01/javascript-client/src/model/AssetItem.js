...
class AssetItem {
     ...
     * @param locationInfo {module:model/BlobLocation} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('locationInfo')) {
                obj['locationInfo'] = BlobLocation.constructFromObject(data['locationInfo']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['locationInfo']) { // data not null
          BlobLocation.validateJSON(data['locationInfo']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/BlobLocation} locationInfo
 */
