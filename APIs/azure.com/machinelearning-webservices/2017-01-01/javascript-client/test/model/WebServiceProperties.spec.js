...
(function(root, factory) {
  ...
  describe('WebServiceProperties', function() {
    ...
    it('should have the property payloadsInBlobStorage (base name: "payloadsInBlobStorage")', function() {
      // uncomment below and update the code to test the property payloadsInBlobStorage
      //var instance = new AzureMlWebServicesManagementClient.WebServiceProperties();
      //expect(instance).to.be();
    });

    it('should have the property payloadsLocation (base name: "payloadsLocation")', function() {
      // uncomment below and update the code to test the property payloadsLocation
      //var instance = new AzureMlWebServicesManagementClient.WebServiceProperties();
      //expect(instance).to.be();
    });
