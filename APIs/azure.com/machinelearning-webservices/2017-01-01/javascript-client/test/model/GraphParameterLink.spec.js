...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMlWebServicesManagementClient.GraphParameterLink();
  });
  ...
  describe('GraphParameterLink', function() {
    it('should create an instance of GraphParameterLink', function() {
      // uncomment below and update the code to test GraphParameterLink
      //var instance = new AzureMlWebServicesManagementClient.GraphParameterLink();
      //expect(instance).to.be.a(AzureMlWebServicesManagementClient.GraphParameterLink);
    });
