...
class AssetItem(Model):
    ...
    def __init__(self, id: str=None, input_ports: Dict[str, InputPort]=None, location_info: BlobLocation=None, metadata: Dict[str, str]=None, name: str=None, output_ports: Dict[str, OutputPort]=None, parameters: List[ModuleAssetParameter]=None, type: str=None):
    ...
    def location_info(self, location_info):
        ...
        :param location_info: The location_info of this AssetItem.
        :type location_info: BlobLocation
        """
