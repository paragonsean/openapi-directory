...
from openapi_server.models.blob_location import BlobLocation
...
from openapi_server.models.web_service_parameter import WebServiceParameter
...
class WebServicePropertiesForGraph(Model):
    ...
    def __init__(self, package: GraphPackage=None, assets: Dict[str, AssetItem]=None, commitment_plan: CommitmentPlan=None, created_on: datetime=None, description: str=None, diagnostics: DiagnosticsConfiguration=None, example_request: ExampleRequest=None, expose_sample_data: bool=None, input: ServiceInputOutputSpecification=None, keys: WebServiceKeys=None, machine_learning_workspace: MachineLearningWorkspace=None, modified_on: datetime=None, output: ServiceInputOutputSpecification=None, package_type: str=None, parameters: Dict[str, WebServiceParameter]=None, payloads_in_blob_storage: bool=None, payloads_location: BlobLocation=None, provisioning_state: str=None, read_only: bool=None, realtime_configuration: RealtimeConfiguration=None, storage_account: StorageAccount=None, swagger_location: str=None, title: str=None):
        ...
        :param payloads_in_blob_storage: The payloads_in_blob_storage of this WebServicePropertiesForGraph.
        :param payloads_location: The payloads_location of this WebServicePropertiesForGraph.
        ...
        self.openapi_types = {
            ...
            'package_type': str,
            'parameters': Dict[str, WebServiceParameter],
        ...
        self._payloads_in_blob_storage = payloads_in_blob_storage
        self._payloads_location = payloads_location
    ...
    def parameters(self):
        ...
        :rtype: Dict[str, WebServiceParameter]
        """
    ...
    def parameters(self, parameters):
        ...
        :param parameters: The parameters of this WebServicePropertiesForGraph.
        :type parameters: Dict[str, WebServiceParameter]
        """

        self._parameters = parameters

    @property
    def payloads_in_blob_storage(self):
        """Gets the payloads_in_blob_storage of this WebServicePropertiesForGraph.
        ...
        :return: The payloads_in_blob_storage of this WebServicePropertiesForGraph.
        :rtype: bool
        """
        return self._payloads_in_blob_storage

    @payloads_in_blob_storage.setter
    def payloads_in_blob_storage(self, payloads_in_blob_storage):
        """Sets the payloads_in_blob_storage of this WebServicePropertiesForGraph.

        When set to true, indicates that the payload size is larger than 3 MB. Otherwise false. If the payload size exceed 3 MB, the payload is stored in a blob and the PayloadsLocation parameter contains the URI of the blob. Otherwise, this will be set to false and Assets, Input, Output, Package, Parameters, ExampleRequest are inline. The Payload sizes is determined by adding the size of the Assets, Input, Output, Package, Parameters, and the ExampleRequest.

        :param payloads_in_blob_storage: The payloads_in_blob_storage of this WebServicePropertiesForGraph.
        :type payloads_in_blob_storage: bool
        """

        self._payloads_in_blob_storage = payloads_in_blob_storage

    @property
    def payloads_location(self):
        """Gets the payloads_location of this WebServicePropertiesForGraph.


        :return: The payloads_location of this WebServicePropertiesForGraph.
        :rtype: BlobLocation
        """
        return self._payloads_location

    @payloads_location.setter
    def payloads_location(self, payloads_location):
        """Sets the payloads_location of this WebServicePropertiesForGraph.


        :param payloads_location: The payloads_location of this WebServicePropertiesForGraph.
        :type payloads_location: BlobLocation
        """
