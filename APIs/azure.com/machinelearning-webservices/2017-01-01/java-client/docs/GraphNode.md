...
|**parameters** | [**Map&lt;String, WebServiceParameter&gt;**](WebServiceParameter.md) | If applicable, parameters of the node. Global graph parameters map into these, with values set at runtime. |  [optional] |
