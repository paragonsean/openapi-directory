...
public class WebServicesApi {
    ...
    /**
     * Build call for webServicesCreateRegionalProperties
     * @param resourceGroupName Name of the resource group in which the web service is located. (required)
     * @param webServiceName The name of the web service. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK. Internal use only. Used for SDK return values. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> Accepted.  The response includes the Azure-AsyncOperation header. To get the progress of the operation, call the GET operation on the URL in the Azure-AsyncOperation header field. For more information about Asynchronous Operations, see https://docs.microsoft.com/en-us/azure/azure-resource-manager/resource-manager-async-operations. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call webServicesCreateRegionalPropertiesCall(String resourceGroupName, String webServiceName, String region, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/webServices/{webServiceName}/CreateRegionalBlob"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "webServiceName" + "}", localVarApiClient.escapeString(webServiceName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call webServicesCreateRegionalPropertiesValidateBeforeCall(String resourceGroupName, String webServiceName, String region, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling webServicesCreateRegionalProperties(Async)");
        }

        // verify the required parameter 'webServiceName' is set
        if (webServiceName == null) {
            throw new ApiException("Missing the required parameter 'webServiceName' when calling webServicesCreateRegionalProperties(Async)");
        }

        // verify the required parameter 'region' is set
        if (region == null) {
            throw new ApiException("Missing the required parameter 'region' when calling webServicesCreateRegionalProperties(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling webServicesCreateRegionalProperties(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling webServicesCreateRegionalProperties(Async)");
        }

        return webServicesCreateRegionalPropertiesCall(resourceGroupName, webServiceName, region, apiVersion, subscriptionId, _callback);
     ...
     */
    public AsyncOperationStatus webServicesCreateRegionalProperties(String resourceGroupName, String webServiceName, String region, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<AsyncOperationStatus> localVarResp = webServicesCreateRegionalPropertiesWithHttpInfo(resourceGroupName, webServiceName, region, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncOperationStatus> webServicesCreateRegionalPropertiesWithHttpInfo(String resourceGroupName, String webServiceName, String region, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = webServicesCreateRegionalPropertiesValidateBeforeCall(resourceGroupName, webServiceName, region, apiVersion, subscriptionId, null);
     ...
     */
    public okhttp3.Call webServicesCreateRegionalPropertiesAsync(String resourceGroupName, String webServiceName, String region, String apiVersion, String subscriptionId, final ApiCallback<AsyncOperationStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = webServicesCreateRegionalPropertiesValidateBeforeCall(resourceGroupName, webServiceName, region, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<AsyncOperationStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param apiVersion The version of the Microsoft.MachineLearning resource provider API to use. (required)
     * @param subscriptionId The Azure subscription ID. (required)
     * @param region The region for which encrypted credential parameters are valid. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call webServicesGetCall(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, String region, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call webServicesGetValidateBeforeCall(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, String region, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return webServicesGetCall(resourceGroupName, webServiceName, apiVersion, subscriptionId, region, _callback);
     ...
     */
    public WebService webServicesGet(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, String region) throws ApiException {
        ApiResponse<WebService> localVarResp = webServicesGetWithHttpInfo(resourceGroupName, webServiceName, apiVersion, subscriptionId, region);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WebService> webServicesGetWithHttpInfo(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, String region) throws ApiException {
        okhttp3.Call localVarCall = webServicesGetValidateBeforeCall(resourceGroupName, webServiceName, apiVersion, subscriptionId, region, null);
        Type localVarReturnType = new TypeToken<WebService>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call webServicesGetAsync(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, String region, final ApiCallback<WebService> _callback) throws ApiException {

        okhttp3.Call localVarCall = webServicesGetValidateBeforeCall(resourceGroupName, webServiceName, apiVersion, subscriptionId, region, _callback);
        Type localVarReturnType = new TypeToken<WebService>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for webServicesListBySubscriptionId
     * @param apiVersion The version of the Microsoft.MachineLearning resource provider API to use. (required)
     * @param subscriptionId The Azure subscription ID. (required)
     * @param $skiptoken Continuation token for pagination. (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call webServicesListBySubscriptionIdCall(String apiVersion, String subscriptionId, String $skiptoken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call webServicesListBySubscriptionIdValidateBeforeCall(String apiVersion, String subscriptionId, String $skiptoken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling webServicesListBySubscriptionId(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling webServicesListBySubscriptionId(Async)");
        }

        return webServicesListBySubscriptionIdCall(apiVersion, subscriptionId, $skiptoken, _callback);
     ...
     */
    public PaginatedWebServicesList webServicesListBySubscriptionId(String apiVersion, String subscriptionId, String $skiptoken) throws ApiException {
        ApiResponse<PaginatedWebServicesList> localVarResp = webServicesListBySubscriptionIdWithHttpInfo(apiVersion, subscriptionId, $skiptoken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PaginatedWebServicesList> webServicesListBySubscriptionIdWithHttpInfo(String apiVersion, String subscriptionId, String $skiptoken) throws ApiException {
        okhttp3.Call localVarCall = webServicesListBySubscriptionIdValidateBeforeCall(apiVersion, subscriptionId, $skiptoken, null);
        Type localVarReturnType = new TypeToken<PaginatedWebServicesList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call webServicesListBySubscriptionIdAsync(String apiVersion, String subscriptionId, String $skiptoken, final ApiCallback<PaginatedWebServicesList> _callback) throws ApiException {

        okhttp3.Call localVarCall = webServicesListBySubscriptionIdValidateBeforeCall(apiVersion, subscriptionId, $skiptoken, _callback);
        Type localVarReturnType = new TypeToken<PaginatedWebServicesList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call webServicesPatchCall(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, PatchedWebService patchPayload, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call webServicesPatchValidateBeforeCall(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, PatchedWebService patchPayload, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
     ...
     */
    public WebService webServicesPatch(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, PatchedWebService patchPayload) throws ApiException {
     ...
     */
    public ApiResponse<WebService> webServicesPatchWithHttpInfo(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, PatchedWebService patchPayload) throws ApiException {
     ...
     */
    public okhttp3.Call webServicesPatchAsync(String resourceGroupName, String webServiceName, String apiVersion, String subscriptionId, PatchedWebService patchPayload, final ApiCallback<WebService> _callback) throws ApiException {
