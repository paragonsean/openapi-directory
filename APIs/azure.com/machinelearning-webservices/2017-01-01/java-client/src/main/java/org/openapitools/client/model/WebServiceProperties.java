...
public class WebServiceProperties {
  ...
  private Map<String, WebServiceParameter> parameters = new HashMap<>();

  public static final String SERIALIZED_NAME_PAYLOADS_IN_BLOB_STORAGE = "payloadsInBlobStorage";
  @SerializedName(SERIALIZED_NAME_PAYLOADS_IN_BLOB_STORAGE)
  private Boolean payloadsInBlobStorage;

  public static final String SERIALIZED_NAME_PAYLOADS_LOCATION = "payloadsLocation";
  @SerializedName(SERIALIZED_NAME_PAYLOADS_LOCATION)
  ...
  public WebServiceProperties parameters(Map<String, WebServiceParameter> parameters) {
    this.parameters = parameters;
    return this;
  }

  public WebServiceProperties putParametersItem(String key, WebServiceParameter parametersItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, WebServiceParameter> getParameters() {
    return parameters;
  }

  public void setParameters(Map<String, WebServiceParameter> parameters) {
    this.parameters = parameters;
  }


  public WebServiceProperties payloadsInBlobStorage(Boolean payloadsInBlobStorage) {
   ...
   * @return payloadsInBlobStorage
   */
  @javax.annotation.Nullable
  public Boolean getPayloadsInBlobStorage() {
    return payloadsInBlobStorage;
  }

  public void setPayloadsInBlobStorage(Boolean payloadsInBlobStorage) {
    this.payloadsInBlobStorage = payloadsInBlobStorage;
  }


  public WebServiceProperties payloadsLocation(BlobLocation payloadsLocation) {
    this.payloadsLocation = payloadsLocation;
    return this;
  }

  /**
   * Get payloadsLocation
   * @return payloadsLocation
   */
  @javax.annotation.Nullable
  public BlobLocation getPayloadsLocation() {
    return payloadsLocation;
  }

  public void setPayloadsLocation(BlobLocation payloadsLocation) {
    this.payloadsLocation = payloadsLocation;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assets, webServiceProperties.assets) &&
        ...
        Objects.equals(this.payloadsInBlobStorage, webServiceProperties.payloadsInBlobStorage) &&
        Objects.equals(this.payloadsLocation, webServiceProperties.payloadsLocation) &&
  ...
  public String toString() {
    ...
    sb.append("    payloadsInBlobStorage: ").append(toIndentedString(payloadsInBlobStorage)).append("\n");
    sb.append("    payloadsLocation: ").append(toIndentedString(payloadsLocation)).append("\n");
