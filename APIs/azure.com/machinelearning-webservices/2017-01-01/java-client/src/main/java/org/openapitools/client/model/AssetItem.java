...
public class AssetItem {
  ...
  public AssetItem locationInfo(BlobLocation locationInfo) {
  ...
  public BlobLocation getLocationInfo() {
    return locationInfo;
  }

  public void setLocationInfo(BlobLocation locationInfo) {
    this.locationInfo = locationInfo;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      BlobLocation.validateJsonElement(jsonObj.get("locationInfo"));
