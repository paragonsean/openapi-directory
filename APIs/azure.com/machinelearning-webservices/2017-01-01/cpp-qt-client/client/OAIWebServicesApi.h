...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void webServicesCreateRegionalProperties(const QString &resource_group_name, const QString &web_service_name, const QString &region, const QString &api_version, const QString &subscription_id);
    ...
    */
    virtual void webServicesGet(const QString &resource_group_name, const QString &web_service_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &region = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  skiptoken QString [optional]
    */
    virtual void webServicesListBySubscriptionId(const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &skiptoken = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  patch_payload OAIPatchedWebService [required]
    */
    virtual void webServicesPatch(const QString &resource_group_name, const QString &web_service_name, const QString &api_version, const QString &subscription_id, const OAIPatchedWebService &patch_payload);
...
private:
    ...
    void webServicesCreateRegionalPropertiesCallback(OAIHttpRequestWorker *worker);
    ...
    void webServicesListBySubscriptionIdCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void webServicesCreateRegionalPropertiesSignal(OAIAsyncOperationStatus summary);
    ...
    void webServicesListBySubscriptionIdSignal(OAIPaginatedWebServicesList summary);
    ...
    void webServicesCreateRegionalPropertiesSignalFull(OAIHttpRequestWorker *worker, OAIAsyncOperationStatus summary);
    ...
    void webServicesListBySubscriptionIdSignalFull(OAIHttpRequestWorker *worker, OAIPaginatedWebServicesList summary);
    ...
    Q_DECL_DEPRECATED_X("Use webServicesCreateRegionalPropertiesSignalError() instead")
    void webServicesCreateRegionalPropertiesSignalE(OAIAsyncOperationStatus summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webServicesCreateRegionalPropertiesSignalError(OAIAsyncOperationStatus summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webServicesListBySubscriptionIdSignalError() instead")
    void webServicesListBySubscriptionIdSignalE(OAIPaginatedWebServicesList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webServicesListBySubscriptionIdSignalError(OAIPaginatedWebServicesList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webServicesCreateRegionalPropertiesSignalErrorFull() instead")
    void webServicesCreateRegionalPropertiesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webServicesCreateRegionalPropertiesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use webServicesListBySubscriptionIdSignalErrorFull() instead")
    void webServicesListBySubscriptionIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webServicesListBySubscriptionIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
