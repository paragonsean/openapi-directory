...
QMap<QString, OAIWebServiceParameter> OAIWebServicePropertiesForGraph::getParameters() const {
    return m_parameters;
}
void OAIWebServicePropertiesForGraph::setParameters(const QMap<QString, OAIWebServiceParameter> &parameters) {
...
bool OAIWebServicePropertiesForGraph::isPayloadsInBlobStorage() const {
    return m_payloads_in_blob_storage;
}
void OAIWebServicePropertiesForGraph::setPayloadsInBlobStorage(const bool &payloads_in_blob_storage) {
    m_payloads_in_blob_storage = payloads_in_blob_storage;
    m_payloads_in_blob_storage_isSet = true;
}

bool OAIWebServicePropertiesForGraph::is_payloads_in_blob_storage_Set() const{
    return m_payloads_in_blob_storage_isSet;
}

bool OAIWebServicePropertiesForGraph::is_payloads_in_blob_storage_Valid() const{
    return m_payloads_in_blob_storage_isValid;
}

OAIBlobLocation OAIWebServicePropertiesForGraph::getPayloadsLocation() const {
    return m_payloads_location;
}
void OAIWebServicePropertiesForGraph::setPayloadsLocation(const OAIBlobLocation &payloads_location) {
    m_payloads_location = payloads_location;
    m_payloads_location_isSet = true;
}

bool OAIWebServicePropertiesForGraph::is_payloads_location_Set() const{
    return m_payloads_location_isSet;
}

bool OAIWebServicePropertiesForGraph::is_payloads_location_Valid() const{
