...
Q_SIGNALS:
    ...
    void operationsListSignal(OAIOperationEntityListResult summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIOperationEntityListResult summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(OAIOperationEntityListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(OAIOperationEntityListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
