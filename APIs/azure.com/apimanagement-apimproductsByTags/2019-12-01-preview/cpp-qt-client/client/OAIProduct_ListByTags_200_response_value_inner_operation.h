...
/*
 * OAIProduct_ListByTags_200_response_value_inner_operation.h
 *
 * Operation Entity contract Properties.
 */

#ifndef OAIProduct_ListByTags_200_response_value_inner_operation_H
#define OAIProduct_ListByTags_200_response_value_inner_operation_H
...
class OAIProduct_ListByTags_200_response_value_inner_operation : public OAIObject {
public:
    OAIProduct_ListByTags_200_response_value_inner_operation();
    OAIProduct_ListByTags_200_response_value_inner_operation(QString json);
    ~OAIProduct_ListByTags_200_response_value_inner_operation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProduct_ListByTags_200_response_value_inner_operation)

#endif // OAIProduct_ListByTags_200_response_value_inner_operation_H
