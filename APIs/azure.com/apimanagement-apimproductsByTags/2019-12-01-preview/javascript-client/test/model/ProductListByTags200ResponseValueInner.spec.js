...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ProductListByTags200ResponseValueInner();
  });
  ...
  describe('ProductListByTags200ResponseValueInner', function() {
    it('should create an instance of ProductListByTags200ResponseValueInner', function() {
      // uncomment below and update the code to test ProductListByTags200ResponseValueInner
      //var instance = new ApiManagementClient.ProductListByTags200ResponseValueInner();
      //expect(instance).to.be.a(ApiManagementClient.ProductListByTags200ResponseValueInner);
    });
