...
public:
    ...
    * @param[in]  parameters OAIRoleAssignmentCreateParameters [required]
    */
    virtual void roleAssignmentsCreateById(const QString &role_id, const QString &api_version, const OAIRoleAssignmentCreateParameters &parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void roleAssignmentsDeleteById(const QString &role_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void roleAssignmentsGetById(const QString &role_id, const QString &api_version);
