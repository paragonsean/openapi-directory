...
export default class RoleAssignmentsApi {
    ...
    */
     ...
     * data is of type: {@link module:model/RoleAssignment}
     */
    roleAssignmentsCreateById(roleId, apiVersion, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'roleId' is set
      if (roleId === undefined || roleId === null) {
        throw new Error("Missing the required parameter 'roleId' when calling roleAssignmentsCreateById");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
     ...
     * data is of type: {@link module:model/RoleAssignment}
     */
    roleAssignmentsDeleteById(roleId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'roleId' is set
      if (roleId === undefined || roleId === null) {
        throw new Error("Missing the required parameter 'roleId' when calling roleAssignmentsDeleteById");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
     ...
     * data is of type: {@link module:model/RoleAssignment}
     */
    roleAssignmentsGetById(roleId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'roleId' is set
      if (roleId === undefined || roleId === null) {
        throw new Error("Missing the required parameter 'roleId' when calling roleAssignmentsGetById");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
