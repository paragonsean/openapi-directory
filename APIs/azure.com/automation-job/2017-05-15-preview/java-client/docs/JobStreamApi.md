...
<a id="jobStreamGet"></a>
# **jobStreamGet**
> JobStream jobStreamGet(subscriptionId, resourceGroupName, automationAccountName, jobName, jobStreamId, apiVersion, clientRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      JobStream result = apiInstance.jobStreamGet(subscriptionId, resourceGroupName, automationAccountName, jobName, jobStreamId, apiVersion, clientRequestId);
...
# **jobStreamListByJob**
> JobStreamListResult jobStreamListByJob(resourceGroupName, automationAccountName, jobName, subscriptionId, apiVersion, $filter, clientRequestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String clientRequestId = "clientRequestId_example"; // String | Identifies this specific client request.
    try {
      JobStreamListResult result = apiInstance.jobStreamListByJob(resourceGroupName, automationAccountName, jobName, subscriptionId, apiVersion, $filter, clientRequestId);
      System.out.println(result);
    } catch (ApiException e) {
