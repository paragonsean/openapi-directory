...
public class JobProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationTime, endTime, exception, jobId, lastModifiedTime, lastStatusModifiedTime, parameters, provisioningState, runOn, runbook, startTime, startedBy, status, statusDetails);
  }
