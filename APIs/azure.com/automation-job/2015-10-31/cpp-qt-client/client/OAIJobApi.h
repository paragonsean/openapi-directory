...
public:
    ...
    */
    virtual void jobCreate(const QString &resource_group_name, const QString &automation_account_name, const QString &job_id, const QString &subscription_id, const QString &api_version, const OAIJobCreateParameters &parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void jobGet(const QString &resource_group_name, const QString &automation_account_name, const QString &job_id, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void jobGetOutput(const QString &resource_group_name, const QString &automation_account_name, const QString &job_id, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void jobGetRunbookContent(const QString &resource_group_name, const QString &automation_account_name, const QString &job_id, const QString &subscription_id, const QString &api_version);
    ...
    */
    virtual void jobListByAutomationAccount(const QString &resource_group_name, const QString &automation_account_name, const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void jobResume(const QString &resource_group_name, const QString &automation_account_name, const QString &job_id, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void jobStop(const QString &resource_group_name, const QString &automation_account_name, const QString &job_id, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void jobSuspend(const QString &resource_group_name, const QString &automation_account_name, const QString &job_id, const QString &subscription_id, const QString &api_version);
...
Q_SIGNALS:
    ...
    void jobListByAutomationAccountSignal(OAIJobListResult summary);
    ...
    void jobListByAutomationAccountSignalFull(OAIHttpRequestWorker *worker, OAIJobListResult summary);
    ...
    void jobListByAutomationAccountSignalE(OAIJobListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void jobListByAutomationAccountSignalError(OAIJobListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
