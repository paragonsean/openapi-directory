...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("serviceTagsList", defaultConf);
    _serverIndices.insert("serviceTagsList", 0);
}
...
void OAIDefaultApi::serviceTagsList(const QString &location, const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["serviceTagsList"][_serverIndices.value("serviceTagsList")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/serviceTags");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::serviceTagsListCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::serviceTagsListCallback);
...
void OAIDefaultApi::serviceTagsListCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIServiceTagsListResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT serviceTagsListSignal(output);
        Q_EMIT serviceTagsListSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT serviceTagsListSignalE(output, error_type, error_str);
        Q_EMIT serviceTagsListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT serviceTagsListSignalError(output, error_type, error_str);
        Q_EMIT serviceTagsListSignalErrorFull(worker, error_type, error_str);
    }
}
