...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.ServiceTagInformationPropertiesFormat();
  });
  ...
  describe('ServiceTagInformationPropertiesFormat', function() {
    it('should create an instance of ServiceTagInformationPropertiesFormat', function() {
      // uncomment below and update the code to test ServiceTagInformationPropertiesFormat
      //var instance = new NetworkManagementClient.ServiceTagInformationPropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.ServiceTagInformationPropertiesFormat);
    });
