...
export default class OperationsApi {
    ...
    */
     ...
     * @param {module:model/ClientDiscoveryResponse} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/ClientDiscoveryResponse}
     */
    operationsList(apiVersion, callback) {
      ...
      let returnType = ClientDiscoveryResponse;
