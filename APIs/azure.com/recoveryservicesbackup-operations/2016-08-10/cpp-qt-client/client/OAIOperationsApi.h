...
Q_SIGNALS:
    ...
    void operationsListSignal(OAIClientDiscoveryResponse summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIClientDiscoveryResponse summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(OAIClientDiscoveryResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(OAIClientDiscoveryResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
