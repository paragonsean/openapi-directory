...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAnalysisServices.ResourceSku();
  });
  ...
  describe('ResourceSku', function() {
    it('should create an instance of ResourceSku', function() {
      ...
      //var instance = new AzureAnalysisServices.ResourceSku();
      //expect(instance).to.be.a(AzureAnalysisServices.ResourceSku);
    });
