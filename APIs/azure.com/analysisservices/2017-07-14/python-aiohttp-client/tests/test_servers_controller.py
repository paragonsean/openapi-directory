...
async def test_servers_update(client):
    ...
    """
    server_update_parameters = {"sku":{"tier":"Development","name":"name"},"properties":{"gatewayDetails":{"dmtsClusterUri":"dmtsClusterUri","gatewayResourceId":"gatewayResourceId","gatewayObjectId":"gatewayObjectId"},"backupBlobContainerUri":"backupBlobContainerUri","asAdministrators":{"members":["members","members"]}},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
