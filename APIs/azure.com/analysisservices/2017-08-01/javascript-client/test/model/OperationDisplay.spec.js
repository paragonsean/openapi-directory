...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAnalysisServices.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new AzureAnalysisServices.OperationDisplay();
      //expect(instance).to.be.a(AzureAnalysisServices.OperationDisplay);
    });
