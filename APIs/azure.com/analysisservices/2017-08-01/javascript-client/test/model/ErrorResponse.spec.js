...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureAnalysisServices.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new AzureAnalysisServices.ErrorResponse();
      //expect(instance).to.be.a(AzureAnalysisServices.ErrorResponse);
    });
