...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("serversListSkusForNew", defaultConf);
    _serverIndices.insert("serversListSkusForNew", 0);
}
...
void OAIDefaultApi::serversListSkusForNew(const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["serversListSkusForNew"][_serverIndices.value("serversListSkusForNew")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.AnalysisServices/skus");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::serversListSkusForNewCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::serversListSkusForNewCallback);
...
void OAIDefaultApi::serversListSkusForNewCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISkuEnumerationForNewResourceResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT serversListSkusForNewSignal(output);
        Q_EMIT serversListSkusForNewSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT serversListSkusForNewSignalE(output, error_type, error_str);
        Q_EMIT serversListSkusForNewSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT serversListSkusForNewSignalError(output, error_type, error_str);
        Q_EMIT serversListSkusForNewSignalErrorFull(worker, error_type, error_str);
    }
}
