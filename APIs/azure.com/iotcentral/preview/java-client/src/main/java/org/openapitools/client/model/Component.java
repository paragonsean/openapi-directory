...
public class Component {
  ...
  private ModelInterface schema;

  public Component() {
  }

  public Component atContext(Object atContext) {
  ...
  public Component atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public Component atType(List<String> atType) {
    this.atType = atType;
    return this;
  }

  public Component addAtTypeItem(String atTypeItem) {
    if (this.atType == null) {
  ...
  public Component displayName(String displayName) {
  ...
  public Component schema(ModelInterface schema) {
    this.schema = schema;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ModelInterface getSchema() {
    return schema;
  }

  public void setSchema(ModelInterface schema) {
    this.schema = schema;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atContext, component.atContext) &&
        Objects.equals(this.atId, component.atId) &&
        Objects.equals(this.atType, component.atType) &&
        Objects.equals(this.comment, component.comment) &&
        Objects.equals(this.description, component.description) &&
        Objects.equals(this.displayName, component.displayName) &&
        Objects.equals(this.name, component.name) &&
        Objects.equals(this.schema, component.schema);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, comment, description, displayName, name, schema);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("schema") != null && !jsonObj.get("schema").isJsonNull()) {
        ModelInterface.validateJsonElement(jsonObj.get("schema"));
      }
  }
