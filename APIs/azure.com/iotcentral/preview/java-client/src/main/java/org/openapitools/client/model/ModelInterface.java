...
public class ModelInterface {
  ...
  private List<Capability> contents = new ArrayList<>();

  public ModelInterface() {
  }

  public ModelInterface atContext(Object atContext) {
  ...
  public ModelInterface atId(String atId) {
    this.atId = atId;
    return this;
  }
  ...
  public ModelInterface atType(List<String> atType) {
    this.atType = atType;
    return this;
  }

  public ModelInterface addAtTypeItem(String atTypeItem) {
    if (this.atType == null) {
  ...
  public ModelInterface comment(String comment) {
  ...
  public ModelInterface displayName(String displayName) {
  ...
  public ModelInterface contents(List<Capability> contents) {
    this.contents = contents;
    return this;
  }

  public ModelInterface addContentsItem(Capability contentsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Capability> getContents() {
    return contents;
  }

  public void setContents(List<Capability> contents) {
    this.contents = contents;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atContext, _interface.atContext) &&
        Objects.equals(this.atId, _interface.atId) &&
        Objects.equals(this.atType, _interface.atType) &&
        Objects.equals(this.comment, _interface.comment) &&
        Objects.equals(this.description, _interface.description) &&
        Objects.equals(this.displayName, _interface.displayName) &&
        Objects.equals(this.contents, _interface.contents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, comment, description, displayName, contents);
  }
      ...
      if (jsonObj.get("contents") != null && !jsonObj.get("contents").isJsonNull()) {
        ...
        if (jsonArraycontents != null) {
          ...
          for (int i = 0; i < jsonArraycontents.size(); i++) {
            Capability.validateJsonElement(jsonArraycontents.get(i));
          };
        }
      }
  }
