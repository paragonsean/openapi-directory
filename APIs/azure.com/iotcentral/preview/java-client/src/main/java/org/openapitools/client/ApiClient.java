...
public class ApiClient {
    ...
    private String basePath = "https://azure.local/api/preview";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://azure.local/api/preview",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/preview/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://azure.local/api/preview
