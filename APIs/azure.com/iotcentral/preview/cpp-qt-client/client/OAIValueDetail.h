...
#ifndef OAIValueDetail_H
#define OAIValueDetail_H
...
class OAIValueDetail : public OAIObject {
public:
    OAIValueDetail();
    OAIValueDetail(QString json);
    ~OAIValueDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValueDetail)

#endif // OAIValueDetail_H
