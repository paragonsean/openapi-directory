...
OAIObject OAIEntity::getContext() const {
    return m_context;
}
void OAIEntity::setContext(const OAIObject &context) {
    m_context = context;
    m_context_isSet = true;
}

bool OAIEntity::is_context_Set() const{
    return m_context_isSet;
}

bool OAIEntity::is_context_Valid() const{
...
QList<QString> OAIEntity::getType() const {
    return m_type;
}
void OAIEntity::setType(const QList<QString> &type) {
    m_type = type;
    m_type_isSet = true;
}
...
QString OAIEntity::getComment() const {
    return m_comment;
}
void OAIEntity::setComment(const QString &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIEntity::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIEntity::is_comment_Valid() const{
...
QString OAIEntity::getDisplayName() const {
    return m_display_name;
}
void OAIEntity::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIEntity::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIEntity::is_display_name_Valid() const{
