...
/*
 * OAIServiceBusQueueEndpoint.h
 *
 * 
 */

#ifndef OAIServiceBusQueueEndpoint_H
#define OAIServiceBusQueueEndpoint_H
...
class OAIServiceBusQueueEndpoint : public OAIObject {
public:
    OAIServiceBusQueueEndpoint();
    OAIServiceBusQueueEndpoint(QString json);
    ~OAIServiceBusQueueEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceBusQueueEndpoint)

#endif // OAIServiceBusQueueEndpoint_H
