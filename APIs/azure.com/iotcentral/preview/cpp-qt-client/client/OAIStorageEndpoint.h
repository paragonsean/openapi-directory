...
/*
 * OAIStorageEndpoint.h
 *
 * 
 */

#ifndef OAIStorageEndpoint_H
#define OAIStorageEndpoint_H
...
class OAIStorageEndpoint : public OAIObject {
public:
    OAIStorageEndpoint();
    OAIStorageEndpoint(QString json);
    ~OAIStorageEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStorageEndpoint)

#endif // OAIStorageEndpoint_H
