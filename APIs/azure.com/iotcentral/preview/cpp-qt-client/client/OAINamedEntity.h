...
#ifndef OAINamedEntity_H
#define OAINamedEntity_H
...
class OAINamedEntity : public OAIObject {
public:
    OAINamedEntity();
    OAINamedEntity(QString json);
    ~OAINamedEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINamedEntity)

#endif // OAINamedEntity_H
