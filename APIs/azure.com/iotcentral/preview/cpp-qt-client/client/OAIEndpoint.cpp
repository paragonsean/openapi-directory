...
QString OAIEndpoint::getConnectionString() const {
    return m_connection_string;
}
void OAIEndpoint::setConnectionString(const QString &connection_string) {
    m_connection_string = connection_string;
    m_connection_string_isSet = true;
}

bool OAIEndpoint::is_connection_string_Set() const{
    return m_connection_string_isSet;
}

bool OAIEndpoint::is_connection_string_Valid() const{
