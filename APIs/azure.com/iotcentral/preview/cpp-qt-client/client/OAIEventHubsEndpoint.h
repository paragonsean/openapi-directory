...
/*
 * OAIEventHubsEndpoint.h
 *
 * 
 */

#ifndef OAIEventHubsEndpoint_H
#define OAIEventHubsEndpoint_H
...
class OAIEventHubsEndpoint : public OAIObject {
public:
    OAIEventHubsEndpoint();
    OAIEventHubsEndpoint(QString json);
    ~OAIEventHubsEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventHubsEndpoint)

#endif // OAIEventHubsEndpoint_H
