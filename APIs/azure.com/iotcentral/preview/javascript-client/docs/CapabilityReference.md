# AzureIoTCentral.CapabilityReference
...
**component** | **String** | The name of the component being referenced. | [optional] 
**reference** | **String** | The name of the capability being referenced. | [optional] 
