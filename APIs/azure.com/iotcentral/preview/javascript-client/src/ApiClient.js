...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://azure.local/api/preview') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://azure.local/api/preview
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/preview/Javascript'
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://azure.local/api/preview",
