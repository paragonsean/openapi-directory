...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureIoTCentral.DeviceCollection();
  });
  ...
  describe('DeviceCollection', function() {
    it('should create an instance of DeviceCollection', function() {
      // uncomment below and update the code to test DeviceCollection
      //var instance = new AzureIoTCentral.DeviceCollection();
      //expect(instance).to.be.a(AzureIoTCentral.DeviceCollection);
    });
