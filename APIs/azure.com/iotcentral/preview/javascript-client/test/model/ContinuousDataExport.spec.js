...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureIoTCentral.ContinuousDataExport();
  });
  ...
  describe('ContinuousDataExport', function() {
    it('should create an instance of ContinuousDataExport', function() {
      // uncomment below and update the code to test ContinuousDataExport
      //var instance = new AzureIoTCentral.ContinuousDataExport();
      //expect(instance).to.be.a(AzureIoTCentral.ContinuousDataExport);
    });
