...
export default class AppsApi {
    ...
    */
     ...
     * @param {module:model/AppAvailabilityInfo} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/AppAvailabilityInfo}
     */
    appsCheckNameAvailability(apiVersion, subscriptionId, operationInputs, callback) {
      ...
      let returnType = AppAvailabilityInfo;
    ...
    /**
     * Callback function to receive the result of the appsCheckSubdomainAvailability operation.
     * @callback module:api/AppsApi~appsCheckSubdomainAvailabilityCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AppAvailabilityInfo} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion The version of the API.
     * @param {String} subscriptionId The subscription identifier.
     * @param {module:model/OperationInputs} operationInputs Set the name parameter in the OperationInputs structure to the subdomain of the IoT Central application to check.
     * @param {module:api/AppsApi~appsCheckSubdomainAvailabilityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AppAvailabilityInfo}
     */
    appsCheckSubdomainAvailability(apiVersion, subscriptionId, operationInputs, callback) {
      let postBody = operationInputs;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling appsCheckSubdomainAvailability");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling appsCheckSubdomainAvailability");
      }
      // verify the required parameter 'operationInputs' is set
      if (operationInputs === undefined || operationInputs === null) {
        throw new Error("Missing the required parameter 'operationInputs' when calling appsCheckSubdomainAvailability");
      }
      ...
      let returnType = AppAvailabilityInfo;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/checkSubdomainAvailability', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the appsListTemplates operation.
     * @callback module:api/AppsApi~appsListTemplatesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AppTemplatesResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion The version of the API.
     * @param {String} subscriptionId The subscription identifier.
     * @param {module:api/AppsApi~appsListTemplatesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AppTemplatesResult}
     */
    appsListTemplates(apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling appsListTemplates");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling appsListTemplates");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AppTemplatesResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/appTemplates', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
