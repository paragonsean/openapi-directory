...
async def apps_check_subdomain_availability(request: web.Request, api_version, subscription_id, operation_inputs) -> web.Response:
    """apps_check_subdomain_availability
    ...
    :param subscription_id: The subscription identifier.
    :type subscription_id: str
    :param operation_inputs: Set the name parameter in the OperationInputs structure to the subdomain of the IoT Central application to check.
    :type operation_inputs: dict | bytes
...
async def apps_list_templates(request: web.Request, api_version, subscription_id) -> web.Response:
    """apps_list_templates
