...
from openapi_server.models.app_availability_info import AppAvailabilityInfo
from openapi_server.models.app_list_result import AppListResult
from openapi_server.models.app_patch import AppPatch
from openapi_server.models.app_templates_result import AppTemplatesResult
...
async def test_apps_check_name_availability(client):
    ...
    """
    operation_inputs = {"name":"name","type":"IoTApps"}
...
async def test_apps_check_subdomain_availability(client):
    """Test case for apps_check_subdomain_availability
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/providers/Microsoft.IoTCentral/checkSubdomainAvailability'.format(subscription_id='subscription_id_example'),
        headers=headers,
        json=operation_inputs,
        params=params,
        )
...
async def test_apps_list_templates(client):
    """Test case for apps_list_templates
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/providers/Microsoft.IoTCentral/appTemplates'.format(subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
