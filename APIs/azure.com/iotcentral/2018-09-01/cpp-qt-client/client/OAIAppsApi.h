...
public:
    ...
    * @param[in]  operation_inputs OAIOperationInputs [required]
    */
    virtual void appsCheckSubdomainAvailability(const QString &api_version, const QString &subscription_id, const OAIOperationInputs &operation_inputs);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void appsListTemplates(const QString &api_version, const QString &subscription_id);
...
private:
    ...
    void appsCheckSubdomainAvailabilityCallback(OAIHttpRequestWorker *worker);
    ...
    void appsListTemplatesCallback(OAIHttpRequestWorker *worker);
    void appsUpdateCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void appsCheckNameAvailabilitySignal(OAIAppAvailabilityInfo summary);
    void appsCheckSubdomainAvailabilitySignal(OAIAppAvailabilityInfo summary);
    ...
    void appsListTemplatesSignal(OAIAppTemplatesResult summary);
    void appsUpdateSignal(OAIApp summary);


    void appsCheckNameAvailabilitySignalFull(OAIHttpRequestWorker *worker, OAIAppAvailabilityInfo summary);
    void appsCheckSubdomainAvailabilitySignalFull(OAIHttpRequestWorker *worker, OAIAppAvailabilityInfo summary);
    ...
    void appsListTemplatesSignalFull(OAIHttpRequestWorker *worker, OAIAppTemplatesResult summary);
    ...
    void appsCheckNameAvailabilitySignalE(OAIAppAvailabilityInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void appsCheckNameAvailabilitySignalError(OAIAppAvailabilityInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use appsCheckSubdomainAvailabilitySignalError() instead")
    void appsCheckSubdomainAvailabilitySignalE(OAIAppAvailabilityInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void appsCheckSubdomainAvailabilitySignalError(OAIAppAvailabilityInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use appsListTemplatesSignalError() instead")
    void appsListTemplatesSignalE(OAIAppTemplatesResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void appsListTemplatesSignalError(OAIAppTemplatesResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use appsCheckSubdomainAvailabilitySignalErrorFull() instead")
    void appsCheckSubdomainAvailabilitySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void appsCheckSubdomainAvailabilitySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use appsListTemplatesSignalErrorFull() instead")
    void appsListTemplatesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void appsListTemplatesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
