...
public class AppsApi {
     ...
     */
    public AppAvailabilityInfo appsCheckNameAvailability(String apiVersion, String subscriptionId, OperationInputs operationInputs) throws ApiException {
        ApiResponse<AppAvailabilityInfo> localVarResp = appsCheckNameAvailabilityWithHttpInfo(apiVersion, subscriptionId, operationInputs);
     ...
     * @param subscriptionId The subscription identifier. (required)
     * @param operationInputs Set the name parameter in the OperationInputs structure to the name of the IoT Central application to check. (required)
     * @return ApiResponse&lt;AppAvailabilityInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppAvailabilityInfo> appsCheckNameAvailabilityWithHttpInfo(String apiVersion, String subscriptionId, OperationInputs operationInputs) throws ApiException {
        okhttp3.Call localVarCall = appsCheckNameAvailabilityValidateBeforeCall(apiVersion, subscriptionId, operationInputs, null);
        Type localVarReturnType = new TypeToken<AppAvailabilityInfo>(){}.getType();
     ...
     */
    public okhttp3.Call appsCheckNameAvailabilityAsync(String apiVersion, String subscriptionId, OperationInputs operationInputs, final ApiCallback<AppAvailabilityInfo> _callback) throws ApiException {
    ...
    /**
     * Build call for appsCheckSubdomainAvailability
     * @param apiVersion The version of the API. (required)
     * @param subscriptionId The subscription identifier. (required)
     * @param operationInputs Set the name parameter in the OperationInputs structure to the subdomain of the IoT Central application to check. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> This is a synchronous operation. The body contains a JSON-serialized response that specifies whether the IoT Central application subdomain is available. If the subdomain is not available, the body contains the reason. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> DefaultErrorResponse </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call appsCheckSubdomainAvailabilityCall(String apiVersion, String subscriptionId, OperationInputs operationInputs, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/checkSubdomainAvailability"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsCheckSubdomainAvailabilityValidateBeforeCall(String apiVersion, String subscriptionId, OperationInputs operationInputs, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appsCheckSubdomainAvailability(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appsCheckSubdomainAvailability(Async)");
        }

        // verify the required parameter 'operationInputs' is set
        if (operationInputs == null) {
            throw new ApiException("Missing the required parameter 'operationInputs' when calling appsCheckSubdomainAvailability(Async)");
        }

        return appsCheckSubdomainAvailabilityCall(apiVersion, subscriptionId, operationInputs, _callback);
     ...
     */
    public AppAvailabilityInfo appsCheckSubdomainAvailability(String apiVersion, String subscriptionId, OperationInputs operationInputs) throws ApiException {
        ApiResponse<AppAvailabilityInfo> localVarResp = appsCheckSubdomainAvailabilityWithHttpInfo(apiVersion, subscriptionId, operationInputs);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppAvailabilityInfo> appsCheckSubdomainAvailabilityWithHttpInfo(String apiVersion, String subscriptionId, OperationInputs operationInputs) throws ApiException {
        okhttp3.Call localVarCall = appsCheckSubdomainAvailabilityValidateBeforeCall(apiVersion, subscriptionId, operationInputs, null);
        Type localVarReturnType = new TypeToken<AppAvailabilityInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call appsCheckSubdomainAvailabilityAsync(String apiVersion, String subscriptionId, OperationInputs operationInputs, final ApiCallback<AppAvailabilityInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsCheckSubdomainAvailabilityValidateBeforeCall(apiVersion, subscriptionId, operationInputs, _callback);
        Type localVarReturnType = new TypeToken<AppAvailabilityInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for appsListTemplates
     * @param apiVersion The version of the API. (required)
     * @param subscriptionId The subscription identifier. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The body contains all the IoT Central application templates. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> DefaultErrorResponse </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call appsListTemplatesCall(String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/providers/Microsoft.IoTCentral/appTemplates"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListTemplatesValidateBeforeCall(String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appsListTemplates(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appsListTemplates(Async)");
        }

        return appsListTemplatesCall(apiVersion, subscriptionId, _callback);
     ...
     */
    public AppTemplatesResult appsListTemplates(String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<AppTemplatesResult> localVarResp = appsListTemplatesWithHttpInfo(apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion The version of the API. (required)
     * @param subscriptionId The subscription identifier. (required)
     * @return ApiResponse&lt;AppTemplatesResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppTemplatesResult> appsListTemplatesWithHttpInfo(String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = appsListTemplatesValidateBeforeCall(apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<AppTemplatesResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call appsListTemplatesAsync(String apiVersion, String subscriptionId, final ApiCallback<AppTemplatesResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListTemplatesValidateBeforeCall(apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<AppTemplatesResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
