...
#ifndef OAIAppListResult_H
#define OAIAppListResult_H
...
class OAIAppListResult : public OAIObject {
public:
    OAIAppListResult();
    OAIAppListResult(QString json);
    ~OAIAppListResult() override;
    ...
    QList<OAIApp> getValue() const;
    void setValue(const QList<OAIApp> &value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppListResult)

#endif // OAIAppListResult_H
