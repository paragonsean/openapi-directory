...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IotCentralClient.OperationListResult();
  });
  ...
  describe('OperationListResult', function() {
    it('should create an instance of OperationListResult', function() {
      ...
      //var instance = new IotCentralClient.OperationListResult();
      //expect(instance).to.be.a(IotCentralClient.OperationListResult);
    });
