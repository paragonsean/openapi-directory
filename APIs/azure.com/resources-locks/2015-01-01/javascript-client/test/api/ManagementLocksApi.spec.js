...
(function(root, factory) {
  ...
  describe('ManagementLocksApi', function() {
    ...
    describe('managementLocksGet', function() {
      it('should call managementLocksGet successfully', function(done) {
        //uncomment below and update the code to test managementLocksGet
        //instance.managementLocksGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
