...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementLockClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ManagementLockClient.OperationDisplay();
      //expect(instance).to.be.a(ManagementLockClient.OperationDisplay);
    });
