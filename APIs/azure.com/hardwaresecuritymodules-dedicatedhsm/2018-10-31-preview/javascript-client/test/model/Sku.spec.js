...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDedicatedHsmResourceProvider.Sku();
  });
  ...
  describe('Sku', function() {
    it('should create an instance of Sku', function() {
      ...
      //var instance = new AzureDedicatedHsmResourceProvider.Sku();
      //expect(instance).to.be.a(AzureDedicatedHsmResourceProvider.Sku);
    });
