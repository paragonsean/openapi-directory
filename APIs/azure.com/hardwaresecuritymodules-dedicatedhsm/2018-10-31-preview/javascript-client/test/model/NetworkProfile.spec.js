...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDedicatedHsmResourceProvider.NetworkProfile();
  });
  ...
  describe('NetworkProfile', function() {
    it('should create an instance of NetworkProfile', function() {
      ...
      //var instance = new AzureDedicatedHsmResourceProvider.NetworkProfile();
      //expect(instance).to.be.a(AzureDedicatedHsmResourceProvider.NetworkProfile);
    });
