...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDedicatedHsmResourceProvider.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new AzureDedicatedHsmResourceProvider.Error();
      //expect(instance).to.be.a(AzureDedicatedHsmResourceProvider.Error);
    });
