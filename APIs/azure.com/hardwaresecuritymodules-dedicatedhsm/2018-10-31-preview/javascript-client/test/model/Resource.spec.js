...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureDedicatedHsmResourceProvider.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new AzureDedicatedHsmResourceProvider.Resource();
      //expect(instance).to.be.a(AzureDedicatedHsmResourceProvider.Resource);
    });
