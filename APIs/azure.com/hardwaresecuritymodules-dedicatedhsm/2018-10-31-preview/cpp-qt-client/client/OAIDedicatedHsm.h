...
#ifndef OAIDedicatedHsm_H
#define OAIDedicatedHsm_H
...
namespace OpenAPI {
class OAIDedicatedHsmProperties;
class OAISku;

class OAIDedicatedHsm : public OAIObject {
public:
    OAIDedicatedHsm();
    OAIDedicatedHsm(QString json);
    ~OAIDedicatedHsm() override;
    ...
    OAIDedicatedHsmProperties getProperties() const;
    void setProperties(const OAIDedicatedHsmProperties &properties);
...
private:
    ...
    OAIDedicatedHsmProperties m_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDedicatedHsm)

#endif // OAIDedicatedHsm_H
