...
QList<QString> OAIResource::getZones() const {
    return m_zones;
}
void OAIResource::setZones(const QList<QString> &zones) {
    m_zones = zones;
    m_zones_isSet = true;
}

bool OAIResource::is_zones_Set() const{
    return m_zones_isSet;
}

bool OAIResource::is_zones_Valid() const{
