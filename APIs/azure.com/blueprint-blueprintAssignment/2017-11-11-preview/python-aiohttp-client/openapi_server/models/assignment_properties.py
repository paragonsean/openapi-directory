...
class AssignmentProperties(Model):
    ...
    def __init__(self, blueprint_id: str=None, locks: AssignmentLockSettings=None, parameters: Dict[str, ParameterValueBase]=None, provisioning_state: str=None, resource_groups: Dict[str, ResourceGroupValue]=None, status: AssignmentStatus=None, description: str=None, display_name: str=None):
