...
class ManagedServiceIdentity(Model):
    ...
    def __init__(self, principal_id: str=None, tenant_id: str=None, type: str=None, user_assigned_identities: Dict[str, UserAssignedIdentity]=None):
        """ManagedServiceIdentity - a model defined in OpenAPI

        :param principal_id: The principal_id of this ManagedServiceIdentity.
        :param tenant_id: The tenant_id of this ManagedServiceIdentity.
    ...
    def principal_id(self):
        """Gets the principal_id of this ManagedServiceIdentity.

        Azure Active Directory principal ID associated with this Identity.

        :return: The principal_id of this ManagedServiceIdentity.
        :rtype: str
        """
    ...
    def principal_id(self, principal_id):
        """Sets the principal_id of this ManagedServiceIdentity.
    ...
    @property
    def tenant_id(self):
        """Gets the tenant_id of this ManagedServiceIdentity.

        ID of the Azure Active Directory.

        :return: The tenant_id of this ManagedServiceIdentity.
        :rtype: str
        """
    ...
    def tenant_id(self, tenant_id):
        """Sets the tenant_id of this ManagedServiceIdentity.
