...
public class AssignmentProperties {
  ...
  public AssignmentProperties parameters(Map<String, ParameterValue> parameters) {
    this.parameters = parameters;
    return this;
  }

  public AssignmentProperties putParametersItem(String key, ParameterValue parametersItem) {
