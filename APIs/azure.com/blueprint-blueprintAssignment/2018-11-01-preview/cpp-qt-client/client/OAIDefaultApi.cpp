...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("assignmentsWhoIsBlueprint", defaultConf);
    _serverIndices.insert("assignmentsWhoIsBlueprint", 0);
}
...
void OAIDefaultApi::assignmentsWhoIsBlueprint(const QString &api_version, const QString &scope, const QString &assignment_name) {
    QString fullPath = QString(_serverConfigs["assignmentsWhoIsBlueprint"][_serverIndices.value("assignmentsWhoIsBlueprint")].URL()+"/{scope}/providers/Microsoft.Blueprint/blueprintAssignments/{assignmentName}/WhoIsBlueprint");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::assignmentsWhoIsBlueprintCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::assignmentsWhoIsBlueprintCallback);
...
void OAIDefaultApi::assignmentsWhoIsBlueprintCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIWhoIsBlueprintContract output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT assignmentsWhoIsBlueprintSignal(output);
        Q_EMIT assignmentsWhoIsBlueprintSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT assignmentsWhoIsBlueprintSignalE(output, error_type, error_str);
        Q_EMIT assignmentsWhoIsBlueprintSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT assignmentsWhoIsBlueprintSignalError(output, error_type, error_str);
        Q_EMIT assignmentsWhoIsBlueprintSignalErrorFull(worker, error_type, error_str);
    }
}
