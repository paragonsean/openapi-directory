...
QList<QList<QString>> OAITable::getRows() const {
    return m_rows;
}
void OAITable::setRows(const QList<QList<QString>> &rows) {
    m_rows = rows;
    m_rows_isSet = true;
}
...
bool OAITable::isValid() const {
    ...
    return m_columns_isValid && m_name_isValid && m_rows_isValid && true;
}
