...
public:
    ...
    */
    virtual void queryExecute(const QString &subscription_id, const QString &resource_group_name, const QString &workspace_name, const QString &api_version, const OAIQueryBody &body);
    ...
    */
    virtual void queryGet(const QString &subscription_id, const QString &resource_group_name, const QString &workspace_name, const QString &query, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &timespan = ::OpenAPI::OptionalParam<QString>());
