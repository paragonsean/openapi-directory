...
void OAIDefaultApi::queryExecute(const QString &subscription_id, const QString &resource_group_name, const QString &workspace_name, const QString &api_version, const OAIQueryBody &body) {
    QString fullPath = QString(_serverConfigs["queryExecute"][_serverIndices.value("queryExecute")].URL()+"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/query");
...
void OAIDefaultApi::queryGet(const QString &subscription_id, const QString &resource_group_name, const QString &workspace_name, const QString &query, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &timespan) {
    QString fullPath = QString(_serverConfigs["queryGet"][_serverIndices.value("queryGet")].URL()+"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/query");
