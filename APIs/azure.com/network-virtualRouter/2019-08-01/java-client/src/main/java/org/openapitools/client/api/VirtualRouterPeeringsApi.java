...
public class VirtualRouterPeeringsApi {
    ...
    /**
     * Build call for virtualRouterPeeringsUpdate
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The resource group name of the Virtual Router Peering. (required)
     * @param virtualRouterName The name of the Virtual Router. (required)
     * @param apiVersion Client API version. (required)
     * @param peeringName The name of the Virtual Router Peering being updated. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Request successful. Returns the details of the Virtual Router Peering updated. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call virtualRouterPeeringsUpdateCall(String subscriptionId, String resourceGroupName, String virtualRouterName, String apiVersion, String peeringName, VirtualRouterPeering parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call virtualRouterPeeringsUpdateValidateBeforeCall(String subscriptionId, String resourceGroupName, String virtualRouterName, String apiVersion, String peeringName, VirtualRouterPeering parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling virtualRouterPeeringsUpdate(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling virtualRouterPeeringsUpdate(Async)");
        }

        // verify the required parameter 'virtualRouterName' is set
        if (virtualRouterName == null) {
            throw new ApiException("Missing the required parameter 'virtualRouterName' when calling virtualRouterPeeringsUpdate(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling virtualRouterPeeringsUpdate(Async)");
        }

        // verify the required parameter 'peeringName' is set
        if (peeringName == null) {
            throw new ApiException("Missing the required parameter 'peeringName' when calling virtualRouterPeeringsUpdate(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling virtualRouterPeeringsUpdate(Async)");
        }

        return virtualRouterPeeringsUpdateCall(subscriptionId, resourceGroupName, virtualRouterName, apiVersion, peeringName, parameters, _callback);
     ...
     */
    public VirtualRouterPeering virtualRouterPeeringsUpdate(String subscriptionId, String resourceGroupName, String virtualRouterName, String apiVersion, String peeringName, VirtualRouterPeering parameters) throws ApiException {
        ApiResponse<VirtualRouterPeering> localVarResp = virtualRouterPeeringsUpdateWithHttpInfo(subscriptionId, resourceGroupName, virtualRouterName, apiVersion, peeringName, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VirtualRouterPeering> virtualRouterPeeringsUpdateWithHttpInfo(String subscriptionId, String resourceGroupName, String virtualRouterName, String apiVersion, String peeringName, VirtualRouterPeering parameters) throws ApiException {
        okhttp3.Call localVarCall = virtualRouterPeeringsUpdateValidateBeforeCall(subscriptionId, resourceGroupName, virtualRouterName, apiVersion, peeringName, parameters, null);
        Type localVarReturnType = new TypeToken<VirtualRouterPeering>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call virtualRouterPeeringsUpdateAsync(String subscriptionId, String resourceGroupName, String virtualRouterName, String apiVersion, String peeringName, VirtualRouterPeering parameters, final ApiCallback<VirtualRouterPeering> _callback) throws ApiException {

        okhttp3.Call localVarCall = virtualRouterPeeringsUpdateValidateBeforeCall(subscriptionId, resourceGroupName, virtualRouterName, apiVersion, peeringName, parameters, _callback);
        Type localVarReturnType = new TypeToken<VirtualRouterPeering>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
