...
async def test_virtual_routers_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","properties":{"hostedGateway":{"id":"id"},"virtualRouterAsn":343953088,"virtualRouterIps":["virtualRouterIps","virtualRouterIps"],"peerings":[{"id":"id"},{"id":"id"}],"provisioningState":"Succeeded","hostedSubnet":{"id":"id"}}}
