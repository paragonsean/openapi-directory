...
let apiInstance = new NetworkManagementClient.VirtualRouterPeeringsApi();
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the Virtual Router Peering.
let virtualRouterName = "virtualRouterName_example"; // String | The name of the Virtual Router.
let apiVersion = "apiVersion_example"; // String | Client API version.
let peeringName = "peeringName_example"; // String | The name of the Virtual Router Peering being updated.
let parameters = new NetworkManagementClient.VirtualRouterPeering(); // VirtualRouterPeering | Parameters supplied to update Virtual Router Peering operation.
apiInstance.virtualRouterPeeringsUpdate(subscriptionId, resourceGroupName, virtualRouterName, apiVersion, peeringName, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
