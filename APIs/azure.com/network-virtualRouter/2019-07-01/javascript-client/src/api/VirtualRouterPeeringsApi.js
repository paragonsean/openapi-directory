...
export default class VirtualRouterPeeringsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the virtualRouterPeeringsUpdate operation.
     * @callback module:api/VirtualRouterPeeringsApi~virtualRouterPeeringsUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VirtualRouterPeering} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {String} resourceGroupName The resource group name of the Virtual Router Peering.
     * @param {String} virtualRouterName The name of the Virtual Router.
     * @param {String} apiVersion Client API version.
     * @param {String} peeringName The name of the Virtual Router Peering being updated.
     * @param {module:model/VirtualRouterPeering} parameters Parameters supplied to update Virtual Router Peering operation.
     * @param {module:api/VirtualRouterPeeringsApi~virtualRouterPeeringsUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VirtualRouterPeering}
     */
    virtualRouterPeeringsUpdate(subscriptionId, resourceGroupName, virtualRouterName, apiVersion, peeringName, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling virtualRouterPeeringsUpdate");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling virtualRouterPeeringsUpdate");
      }
      // verify the required parameter 'virtualRouterName' is set
      if (virtualRouterName === undefined || virtualRouterName === null) {
        throw new Error("Missing the required parameter 'virtualRouterName' when calling virtualRouterPeeringsUpdate");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling virtualRouterPeeringsUpdate");
      }
      // verify the required parameter 'peeringName' is set
      if (peeringName === undefined || peeringName === null) {
        throw new Error("Missing the required parameter 'peeringName' when calling virtualRouterPeeringsUpdate");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling virtualRouterPeeringsUpdate");
      }
      ...
      let returnType = VirtualRouterPeering;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualRouters/{virtualRouterName}/peerings/{peeringName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
