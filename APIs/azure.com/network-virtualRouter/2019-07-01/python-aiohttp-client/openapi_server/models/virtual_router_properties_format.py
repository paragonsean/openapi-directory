...
class VirtualRouterPropertiesFormat(Model):
    ...
    def virtual_router_asn(self, virtual_router_asn):
        ...
        if virtual_router_asn is not None and virtual_router_asn < 1:
            raise ValueError("Invalid value for `virtual_router_asn`, must be a value greater than or equal to `1`")
