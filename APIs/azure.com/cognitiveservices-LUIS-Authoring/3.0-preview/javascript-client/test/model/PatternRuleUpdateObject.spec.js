...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.PatternRuleUpdateObject();
  });
  ...
  describe('PatternRuleUpdateObject', function() {
    it('should create an instance of PatternRuleUpdateObject', function() {
      // uncomment below and update the code to test PatternRuleUpdateObject
      //var instance = new LuisAuthoringClient.PatternRuleUpdateObject();
      //expect(instance).to.be.a(LuisAuthoringClient.PatternRuleUpdateObject);
    });
