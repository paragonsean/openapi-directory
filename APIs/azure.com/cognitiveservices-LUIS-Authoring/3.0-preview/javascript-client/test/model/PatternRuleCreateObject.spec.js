...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.PatternRuleCreateObject();
  });
  ...
  describe('PatternRuleCreateObject', function() {
    it('should create an instance of PatternRuleCreateObject', function() {
      // uncomment below and update the code to test PatternRuleCreateObject
      //var instance = new LuisAuthoringClient.PatternRuleCreateObject();
      //expect(instance).to.be.a(LuisAuthoringClient.PatternRuleCreateObject);
    });
