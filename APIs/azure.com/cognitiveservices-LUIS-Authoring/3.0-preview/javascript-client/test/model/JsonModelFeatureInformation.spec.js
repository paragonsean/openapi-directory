...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.JsonModelFeatureInformation();
  });
  ...
  describe('JsonModelFeatureInformation', function() {
    it('should create an instance of JsonModelFeatureInformation', function() {
      // uncomment below and update the code to test JsonModelFeatureInformation
      //var instance = new LuisAuthoringClient.JsonModelFeatureInformation();
      //expect(instance).to.be.a(LuisAuthoringClient.JsonModelFeatureInformation);
    });
