...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.PatternRuleInfo();
  });
  ...
  describe('PatternRuleInfo', function() {
    it('should create an instance of PatternRuleInfo', function() {
      // uncomment below and update the code to test PatternRuleInfo
      //var instance = new LuisAuthoringClient.PatternRuleInfo();
      //expect(instance).to.be.a(LuisAuthoringClient.PatternRuleInfo);
    });
