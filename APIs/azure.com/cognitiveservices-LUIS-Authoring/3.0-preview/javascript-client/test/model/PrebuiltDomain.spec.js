...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.PrebuiltDomain();
  });
  ...
  describe('PrebuiltDomain', function() {
    it('should create an instance of PrebuiltDomain', function() {
      // uncomment below and update the code to test PrebuiltDomain
      //var instance = new LuisAuthoringClient.PrebuiltDomain();
      //expect(instance).to.be.a(LuisAuthoringClient.PrebuiltDomain);
    });
