...
async def test_apps_import(client):
    ...
    """
    luis_app = {"utterances":[{"entities":[{"role":"role","entity":"entity","startPos":6,"endPos":0},{"role":"role","entity":"entity","startPos":6,"endPos":0}],"text":"text","intent":"intent"},{"entities":[{"role":"role","entity":"entity","startPos":6,"endPos":0},{"role":"role","entity":"entity","startPos":6,"endPos":0}],"text":"text","intent":"intent"}],"intents":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}}],"phraselists":[{"mode":True,"name":"name","words":"words","enabledForAllModels":True,"activated":True},{"mode":True,"name":"name","words":"words","enabledForAllModels":True,"activated":True}],"prebuiltEntities":[{"roles":["roles","roles"],"name":"name"},{"roles":["roles","roles"],"name":"name"}],"patterns":[{"pattern":"pattern","intent":"intent"},{"pattern":"pattern","intent":"intent"}],"composites":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}}],"versionId":"versionId","closedLists":[{"roles":["roles","roles"],"name":"name","subLists":[{"canonicalForm":"canonicalForm","list":["list","list"]},{"canonicalForm":"canonicalForm","list":["list","list"]}]},{"roles":["roles","roles"],"name":"name","subLists":[{"canonicalForm":"canonicalForm","list":["list","list"]},{"canonicalForm":"canonicalForm","list":["list","list"]}]}],"entities":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}}],"culture":"culture","regex_entities":[{"roles":["roles","roles"],"name":"name","regexPattern":"regexPattern"},{"roles":["roles","roles"],"name":"name","regexPattern":"regexPattern"}],"patternAnyEntities":[{"explicitList":["explicitList","explicitList"],"roles":["roles","roles"],"name":"name"},{"explicitList":["explicitList","explicitList"],"roles":["roles","roles"],"name":"name"}],"name":"name","hierarchicals":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"features":[{"modelName":"modelName","featureName":"featureName"},{"modelName":"modelName","featureName":"featureName"}],"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"roles":["roles","roles"],"name":"name","inherits":{"domain_name":"domain_name","model_name":"model_name"}}],"regex_features":[{"name":"name","pattern":"pattern","activated":True},{"name":"name","pattern":"pattern","activated":True}],"desc":"desc"}
...
async def test_features_add_entity_feature(client):
    """Test case for features_add_entity_feature

    
    """
    feature_relation_create_object = {"modelName":"modelName","featureName":"featureName"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
    ...
    response = await client.request(
        method='POST',
        path='/apps/{app_id}/versions/{version_id}/entities/{entity_id}/features'.format(app_id='app_id_example', version_id='version_id_example', entity_id='entity_id_example'),
        headers=headers,
        json=feature_relation_create_object,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_features_add_intent_feature(client):
    ...
    response = await client.request(
        method='POST',
        path='/apps/{app_id}/versions/{version_id}/intents/{intent_id}/features'.format(app_id='app_id_example', version_id='version_id_example', intent_id='intent_id_example'),
        headers=headers,
        json=feature_relation_create_object,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_features_add_phrase_list(client):
    ...
    """
    phraselist_create_object = {"name":"name","isExchangeable":True,"phrases":"phrases","enabledForAllModels":True}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
...
async def test_features_update_phrase_list(client):
    ...
    """
    phraselist_update_object = {"name":"name","isExchangeable":True,"isActive":True,"phrases":"phrases","enabledForAllModels":True}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
...
async def test_model_add_entity(client):
    ...
    """
    entity_model_create_object = {"children":[{"children":[null,null],"name":"name","instanceOf":"instanceOf"},{"children":[null,null],"name":"name","instanceOf":"instanceOf"}],"name":"name"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
    ...
    response = await client.request(
        ...
        headers=headers,
        json=entity_model_create_object,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_model_add_entity_child(client):
    """Test case for model_add_entity_child

    
    """
    child_entity_model_create_object = {"children":[null,null],"name":"name","instanceOf":"instanceOf"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
    ...
    response = await client.request(
        method='POST',
        path='/apps/{app_id}/versions/{version_id}/entities/{entity_id}/children'.format(app_id='app_id_example', version_id='version_id_example', entity_id='entity_id_example'),
        headers=headers,
        json=child_entity_model_create_object,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_model_delete_entity_feature(client):
    """Test case for model_delete_entity_feature

    
    """
    feature_relation_delete_object = openapi_server.ModelFeatureInformation()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
    ...
    response = await client.request(
        ...
        path='/apps/{app_id}/versions/{version_id}/entities/{entity_id}/features'.format(app_id='app_id_example', version_id='version_id_example', entity_id='entity_id_example'),
        headers=headers,
        json=feature_relation_delete_object,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
@pytest.mark.skip("*/* not supported by Connexion. Use application/json instead. See https://github.com/zalando/connexion/pull/760")
async def test_model_delete_intent_feature(client):
...
async def test_model_get_entity_features(client):
...
async def test_model_get_intent_features(client):
...
async def test_model_replace_entity_features(client):
    """Test case for model_replace_entity_features

    
    """
    feature_relations_update_object = {"modelName":"modelName","featureName":"featureName"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
    ...
    response = await client.request(
        ...
        path='/apps/{app_id}/versions/{version_id}/entities/{entity_id}/features'.format(app_id='app_id_example', version_id='version_id_example', entity_id='entity_id_example'),
        headers=headers,
        json=feature_relations_update_object,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_model_replace_intent_features(client):
...
async def test_model_update_entity_child(client):
    """Test case for model_update_entity_child

    
    """
    entity_model_update_object = {"name":"name","instanceOf":"instanceOf"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'apiKeyHeader': 'special-key',
    ...
    response = await client.request(
        ...
        path='/apps/{app_id}/versions/{version_id}/entities/{entity_id}'.format(app_id='app_id_example', version_id='version_id_example', entity_id='entity_id_example'),
        headers=headers,
        json=entity_model_update_object,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
