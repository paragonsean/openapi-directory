...
class PhraselistUpdateObject(Model):
    ...
    def __init__(self, enabled_for_all_models: bool=True, is_active: bool=True, is_exchangeable: bool=True, name: str=None, phrases: str=None):
        """PhraselistUpdateObject - a model defined in OpenAPI

        :param enabled_for_all_models: The enabled_for_all_models of this PhraselistUpdateObject.
    ...
    def enabled_for_all_models(self):
        """Gets the enabled_for_all_models of this PhraselistUpdateObject.

        Indicates if the Phraselist is enabled for all models in the application.

        :return: The enabled_for_all_models of this PhraselistUpdateObject.
        :rtype: bool
        """
    ...
    def enabled_for_all_models(self, enabled_for_all_models):
        """Sets the enabled_for_all_models of this PhraselistUpdateObject.
