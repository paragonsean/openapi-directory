...
void OAIReadableType::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("Child Entity Extractor", Qt::CaseInsensitive) == 0) {
        m_value = eOAIReadableType::CHILD_ENTITY_EXTRACTOR;
        m_value_isSet = m_value_isValid = true;
    }
...
QString OAIReadableType::asJson() const {
    ...
    switch (m_value){
        case eOAIReadableType::ENTITY_EXTRACTOR:
            ...
            break;
        case eOAIReadableType::CHILD_ENTITY_EXTRACTOR:
            val = "Child Entity Extractor";
            break;
