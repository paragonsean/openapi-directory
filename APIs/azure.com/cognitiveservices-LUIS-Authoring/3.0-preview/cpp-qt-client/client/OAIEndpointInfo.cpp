...
QString OAIEndpointInfo::getAssignedEndpointKey() const {
    return m_assigned_endpoint_key;
}
void OAIEndpointInfo::setAssignedEndpointKey(const QString &assigned_endpoint_key) {
    m_assigned_endpoint_key = assigned_endpoint_key;
    m_assigned_endpoint_key_isSet = true;
}

bool OAIEndpointInfo::is_assigned_endpoint_key_Set() const{
    return m_assigned_endpoint_key_isSet;
}

bool OAIEndpointInfo::is_assigned_endpoint_key_Valid() const{
    return m_assigned_endpoint_key_isValid;
}

QString OAIEndpointInfo::getEndpointRegion() const {
    return m_endpoint_region;
}
void OAIEndpointInfo::setEndpointRegion(const QString &endpoint_region) {
    m_endpoint_region = endpoint_region;
    m_endpoint_region_isSet = true;
}

bool OAIEndpointInfo::is_endpoint_region_Set() const{
    return m_endpoint_region_isSet;
}

bool OAIEndpointInfo::is_endpoint_region_Valid() const{
    return m_endpoint_region_isValid;
}

QString OAIEndpointInfo::getEndpointUrl() const {
    return m_endpoint_url;
}
void OAIEndpointInfo::setEndpointUrl(const QString &endpoint_url) {
    m_endpoint_url = endpoint_url;
    m_endpoint_url_isSet = true;
}

bool OAIEndpointInfo::is_endpoint_url_Set() const{
    return m_endpoint_url_isSet;
}

bool OAIEndpointInfo::is_endpoint_url_Valid() const{
    return m_endpoint_url_isValid;
}

QString OAIEndpointInfo::getFailedRegions() const {
    return m_failed_regions;
}
void OAIEndpointInfo::setFailedRegions(const QString &failed_regions) {
    m_failed_regions = failed_regions;
    m_failed_regions_isSet = true;
}

bool OAIEndpointInfo::is_failed_regions_Set() const{
    return m_failed_regions_isSet;
}

bool OAIEndpointInfo::is_failed_regions_Valid() const{
    return m_failed_regions_isValid;
}

bool OAIEndpointInfo::isIsStaging() const {
    return m_is_staging;
}
void OAIEndpointInfo::setIsStaging(const bool &is_staging) {
    m_is_staging = is_staging;
    m_is_staging_isSet = true;
}

bool OAIEndpointInfo::is_is_staging_Set() const{
    return m_is_staging_isSet;
}

bool OAIEndpointInfo::is_is_staging_Valid() const{
    return m_is_staging_isValid;
}

QString OAIEndpointInfo::getPublishedDateTime() const {
    return m_published_date_time;
}
void OAIEndpointInfo::setPublishedDateTime(const QString &published_date_time) {
    m_published_date_time = published_date_time;
    m_published_date_time_isSet = true;
}

bool OAIEndpointInfo::is_published_date_time_Set() const{
    return m_published_date_time_isSet;
}

bool OAIEndpointInfo::is_published_date_time_Valid() const{
    return m_published_date_time_isValid;
}

QString OAIEndpointInfo::getRegion() const {
    return m_region;
}
void OAIEndpointInfo::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIEndpointInfo::is_region_Set() const{
    return m_region_isSet;
}

bool OAIEndpointInfo::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIEndpointInfo::getVersionId() const {
    return m_version_id;
}
void OAIEndpointInfo::setVersionId(const QString &version_id) {
    m_version_id = version_id;
    m_version_id_isSet = true;
}

bool OAIEndpointInfo::is_version_id_Set() const{
    return m_version_id_isSet;
}

bool OAIEndpointInfo::is_version_id_Valid() const{
