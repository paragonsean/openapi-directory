...
/*
 * OAIJsonModelFeatureInformation.h
 *
 * An object containing the model feature information either the model name or feature name.
 */

#ifndef OAIJsonModelFeatureInformation_H
#define OAIJsonModelFeatureInformation_H
...
class OAIJsonModelFeatureInformation : public OAIObject {
public:
    OAIJsonModelFeatureInformation();
    OAIJsonModelFeatureInformation(QString json);
    ~OAIJsonModelFeatureInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJsonModelFeatureInformation)

#endif // OAIJsonModelFeatureInformation_H
