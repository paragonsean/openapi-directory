...
bool OAIJSONModelFeature::isEnabledForAllModels() const {
    return m_enabled_for_all_models;
}
void OAIJSONModelFeature::setEnabledForAllModels(const bool &enabled_for_all_models) {
    m_enabled_for_all_models = enabled_for_all_models;
    m_enabled_for_all_models_isSet = true;
}

bool OAIJSONModelFeature::is_enabled_for_all_models_Set() const{
    return m_enabled_for_all_models_isSet;
}

bool OAIJSONModelFeature::is_enabled_for_all_models_Valid() const{
