...
<a id="featuresAddEntityFeature"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ModelFeatureInformation featureRelationCreateObject = new ModelFeatureInformation(); // ModelFeatureInformation | A Feature relation information object.
    try {
      OperationStatus result = apiInstance.featuresAddEntityFeature(appId, versionId, entityId, featureRelationCreateObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#featuresAddEntityFeature");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="featuresAddIntentFeature"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ModelFeatureInformation featureRelationCreateObject = new ModelFeatureInformation(); // ModelFeatureInformation | A Feature relation information object.
    try {
      OperationStatus result = apiInstance.featuresAddIntentFeature(appId, versionId, intentId, featureRelationCreateObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#featuresAddIntentFeature");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **modelAddEntity**
> UUID modelAddEntity(appId, versionId, entityModelCreateObject)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID appId = UUID.randomUUID(); // UUID | The application ID.
    String versionId = "versionId_example"; // String | The version ID.
    EntityModelCreateObject entityModelCreateObject = new EntityModelCreateObject(); // EntityModelCreateObject | A model object containing the name of the new entity extractor and its children.
    try {
      UUID result = apiInstance.modelAddEntity(appId, versionId, entityModelCreateObject);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="modelAddEntityChild"></a>
# **modelAddEntityChild**
> UUID modelAddEntityChild(appId, versionId, entityId, childEntityModelCreateObject)
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionId = "versionId_example"; // String | The version ID.
    UUID entityId = UUID.randomUUID(); // UUID | The entity extractor ID.
    ChildEntityModelCreateObject childEntityModelCreateObject = new ChildEntityModelCreateObject(); // ChildEntityModelCreateObject | A model object containing the name of the new child model and its children.
    try {
      UUID result = apiInstance.modelAddEntityChild(appId, versionId, entityId, childEntityModelCreateObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelAddEntityChild");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID appId = UUID.randomUUID(); // UUID | The application ID.
    String versionId = "versionId_example"; // String | The version ID.
    UUID entityId = UUID.randomUUID(); // UUID | The entity extractor or the child entity extractor ID.
    try {
...
| **appId** | **UUID**| The application ID. | |
| **versionId** | **String**| The version ID. | |
| **entityId** | **UUID**| The entity extractor or the child entity extractor ID. | |
...
<a id="modelDeleteEntityFeature"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionId = "versionId_example"; // String | The version ID.
    UUID entityId = UUID.randomUUID(); // UUID | The entity extractor ID.
    ModelFeatureInformation featureRelationDeleteObject = new ModelFeatureInformation(); // ModelFeatureInformation | A feature information object containing the feature relation to delete.
    try {
      OperationStatus result = apiInstance.modelDeleteEntityFeature(appId, versionId, entityId, featureRelationDeleteObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelDeleteEntityFeature");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="modelDeleteIntentFeature"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ModelFeatureInformation featureRelationDeleteObject = new ModelFeatureInformation(); // ModelFeatureInformation | A feature information object containing the feature relation to delete.
    try {
      OperationStatus result = apiInstance.modelDeleteIntentFeature(appId, versionId, intentId, featureRelationDeleteObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelDeleteIntentFeature");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID entityId = UUID.randomUUID(); // UUID | The entity extractor ID.
    try {
      NDepthEntityExtractor result = apiInstance.modelGetEntity(appId, versionId, entityId);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="modelGetEntityFeatures"></a>
# **modelGetEntityFeatures**
> List&lt;ModelFeatureInformation&gt; modelGetEntityFeatures(appId, versionId, entityId)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID entityId = UUID.randomUUID(); // UUID | The entity extractor ID.
    try {
      List<ModelFeatureInformation> result = apiInstance.modelGetEntityFeatures(appId, versionId, entityId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelGetEntityFeatures");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="modelGetIntentFeatures"></a>
# **modelGetIntentFeatures**
> List&lt;ModelFeatureInformation&gt; modelGetIntentFeatures(appId, versionId, intentId)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID intentId = UUID.randomUUID(); // UUID | The intent classifier ID.
    try {
      List<ModelFeatureInformation> result = apiInstance.modelGetIntentFeatures(appId, versionId, intentId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelGetIntentFeatures");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **modelListEntities**
> List&lt;NDepthEntityExtractor&gt; modelListEntities(appId, versionId, skip, take)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer take = 100; // Integer | The number of entries to return. Maximum page size is 500. Default is 100.
    try {
      List<NDepthEntityExtractor> result = apiInstance.modelListEntities(appId, versionId, skip, take);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="modelReplaceEntityFeatures"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionId = "versionId_example"; // String | The version ID.
    UUID entityId = UUID.randomUUID(); // UUID | The entity extractor ID.
    List<ModelFeatureInformation> featureRelationsUpdateObject = Arrays.asList(); // List<ModelFeatureInformation> | A list of feature information objects containing the new feature relations.
    try {
      OperationStatus result = apiInstance.modelReplaceEntityFeatures(appId, versionId, entityId, featureRelationsUpdateObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelReplaceEntityFeatures");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **versionId** | **String**| The version ID. | |
| **entityId** | **UUID**| The entity extractor ID. | |
| **featureRelationsUpdateObject** | [**List&lt;ModelFeatureInformation&gt;**](ModelFeatureInformation.md)| A list of feature information objects containing the new feature relations. | |
...
<a id="modelReplaceIntentFeatures"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    List<ModelFeatureInformation> featureRelationsUpdateObject = Arrays.asList(); // List<ModelFeatureInformation> | A list of feature information objects containing the new feature relations.
    try {
      OperationStatus result = apiInstance.modelReplaceIntentFeatures(appId, versionId, intentId, featureRelationsUpdateObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelReplaceIntentFeatures");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionId = "versionId_example"; // String | The version ID.
    UUID entityId = UUID.randomUUID(); // UUID | The entity extractor or the child entity extractor ID.
    EntityModelUpdateObject entityModelUpdateObject = new EntityModelUpdateObject(); // EntityModelUpdateObject | A model object containing the name new entity extractor or the name and instance of model of a child entity extractor 
    try {
      OperationStatus result = apiInstance.modelUpdateEntityChild(appId, versionId, entityId, entityModelUpdateObject);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#modelUpdateEntityChild");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String versionId = "versionId_example"; // String | The version ID.
    UUID hEntityId = UUID.randomUUID(); // UUID | The hierarchical entity extractor ID.
    ModelUpdateObject modelUpdateObject = new ModelUpdateObject(); // ModelUpdateObject | Model containing names of the hierarchical entity.
    try {
      OperationStatus result = apiInstance.modelUpdateHierarchicalEntity(appId, versionId, hEntityId, modelUpdateObject);
      System.out.println(result);
    } catch (ApiException e) {
