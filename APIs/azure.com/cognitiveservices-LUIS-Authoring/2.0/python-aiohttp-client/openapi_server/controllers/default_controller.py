...
async def features_create_pattern_feature(request: web.Request, app_id, version_id, pattern_create_object) -> web.Response:
    ...
    :param version_id: The version ID.
    :type version_id: str
    :param pattern_create_object: The Name and Pattern of the feature.
    :type pattern_create_object: dict | bytes

    """
    pattern_create_object = PatternCreateObject.from_dict(pattern_create_object)
    return web.Response(status=200)


async def features_delete_pattern_feature(request: web.Request, app_id, version_id, pattern_id) -> web.Response:
...
async def features_get_pattern_feature_info(request: web.Request, app_id, version_id, pattern_id) -> web.Response:
...
async def features_list_application_version_pattern_features(request: web.Request, app_id, version_id, skip=None, take=None) -> web.Response:
...
async def features_update_pattern_feature(request: web.Request, app_id, version_id, pattern_id, pattern_update_object) -> web.Response:
    ...
    :param pattern_id: The pattern feature ID.
    :type pattern_id: int
    :param pattern_update_object: The new values for: - Just a boolean called IsActive, in which case the status of the feature will be changed. - Name, Pattern and a boolean called IsActive to update the feature.
    :type pattern_update_object: dict | bytes

    """
    pattern_update_object = PatternUpdateObject.from_dict(pattern_update_object)
    return web.Response(status=200)
...
async def model_add_composite_entity(request: web.Request, app_id, version_id, composite_model_create_object) -> web.Response:
    ...
    :param version_id: The version ID.
    :type version_id: str
    :param composite_model_create_object: A model containing the name and children of the new entity extractor.
    :type composite_model_create_object: dict | bytes

    """
    composite_model_create_object = CompositeEntityModel.from_dict(composite_model_create_object)
    return web.Response(status=200)
...
async def model_add_entity(request: web.Request, app_id, version_id, model_create_object) -> web.Response:
    """model_add_entity
    ...
    :param version_id: The version ID.
    :type version_id: str
    :param model_create_object: A model object containing the name for the new simple entity extractor.
    :type model_create_object: dict | bytes

    """
    model_create_object = ModelCreateObject.from_dict(model_create_object)
    return web.Response(status=200)
...
async def model_add_hierarchical_entity(request: web.Request, app_id, version_id, hierarchical_model_create_object) -> web.Response:
    ...
    :param version_id: The version ID.
    :type version_id: str
    :param hierarchical_model_create_object: A model containing the name and children of the new entity extractor.
    :type hierarchical_model_create_object: dict | bytes

    """
    hierarchical_model_create_object = HierarchicalEntityModel.from_dict(hierarchical_model_create_object)
    return web.Response(status=200)


async def model_add_hierarchical_entity_child(request: web.Request, app_id, version_id, h_entity_id, hierarchical_child_model_create_object) -> web.Response:
    ...
    :type h_entity_id: str
    :param hierarchical_child_model_create_object: A model object containing the name of the new hierarchical child model.
    :type hierarchical_child_model_create_object: dict | bytes

    """
    hierarchical_child_model_create_object = ModelAddCompositeEntityChildRequest.from_dict(hierarchical_child_model_create_object)
    return web.Response(status=200)
...
async def model_update_entity(request: web.Request, app_id, version_id, entity_id, model_update_object) -> web.Response:
    """model_update_entity
    ...
    :type entity_id: str
    :type entity_id: str
    :param model_update_object: A model object containing the new entity extractor name.
...
async def model_update_hierarchical_entity(request: web.Request, app_id, version_id, h_entity_id, hierarchical_model_update_object) -> web.Response:
    ...
    :type h_entity_id: str
    :type h_entity_id: str
    :param hierarchical_model_update_object: Model containing names of the children of the hierarchical entity.
    :type hierarchical_model_update_object: dict | bytes

    """
    hierarchical_model_update_object = HierarchicalEntityModel.from_dict(hierarchical_model_update_object)
    return web.Response(status=200)
