...
class LuisApp(Model):
    ...
    def __init__(self, closed_lists: List[ClosedList]=None, composites: List[HierarchicalModel]=None, culture: str=None, desc: str=None, entities: List[HierarchicalModel]=None, intents: List[HierarchicalModel]=None, model_features: List[JSONModelFeature]=None, name: str=None, pattern_any_entities: List[PatternAny]=None, patterns: List[PatternRule]=None, prebuilt_entities: List[PrebuiltEntity]=None, regex_entities: List[RegexEntity]=None, regex_features: List[JSONRegexFeature]=None, utterances: List[JSONUtterance]=None, version_id: str=None):
        ...
        :param model_features: The model_features of this LuisApp.
        ...
        self.openapi_types = {
            ...
            'model_features': List[JSONModelFeature],
            'name': str,
    ...
    def model_features(self):
        """Gets the model_features of this LuisApp.

        List of model features.

        :return: The model_features of this LuisApp.
    ...
    def model_features(self, model_features):
        """Sets the model_features of this LuisApp.

        List of model features.

        :param model_features: The model_features of this LuisApp.
        :type model_features: List[JSONModelFeature]
        """
