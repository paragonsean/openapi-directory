...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.PrebuiltDomainObject();
  });
  ...
  describe('PrebuiltDomainObject', function() {
    it('should create an instance of PrebuiltDomainObject', function() {
      // uncomment below and update the code to test PrebuiltDomainObject
      //var instance = new LuisAuthoringClient.PrebuiltDomainObject();
      //expect(instance).to.be.a(LuisAuthoringClient.PrebuiltDomainObject);
    });
