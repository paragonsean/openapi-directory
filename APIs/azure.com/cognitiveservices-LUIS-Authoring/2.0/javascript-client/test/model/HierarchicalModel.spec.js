...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.HierarchicalModel();
  });
  ...
  describe('HierarchicalModel', function() {
    it('should create an instance of HierarchicalModel', function() {
      // uncomment below and update the code to test HierarchicalModel
      //var instance = new LuisAuthoringClient.HierarchicalModel();
      //expect(instance).to.be.a(LuisAuthoringClient.HierarchicalModel);
    });
