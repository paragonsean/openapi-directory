...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.JSONUtterance();
  });
  ...
  describe('JSONUtterance', function() {
    it('should create an instance of JSONUtterance', function() {
      // uncomment below and update the code to test JSONUtterance
      //var instance = new LuisAuthoringClient.JSONUtterance();
      //expect(instance).to.be.a(LuisAuthoringClient.JSONUtterance);
    });
