...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.JSONRegexFeature();
  });
  ...
  describe('JSONRegexFeature', function() {
    it('should create an instance of JSONRegexFeature', function() {
      // uncomment below and update the code to test JSONRegexFeature
      //var instance = new LuisAuthoringClient.JSONRegexFeature();
      //expect(instance).to.be.a(LuisAuthoringClient.JSONRegexFeature);
    });
