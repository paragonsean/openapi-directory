...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LuisAuthoringClient.PatternRule();
  });
  ...
  describe('PatternRule', function() {
    it('should create an instance of PatternRule', function() {
      // uncomment below and update the code to test PatternRule
      //var instance = new LuisAuthoringClient.PatternRule();
      //expect(instance).to.be.a(LuisAuthoringClient.PatternRule);
    });
