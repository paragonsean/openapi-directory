...
/**
 * The EntitiesSuggestionExample model module.
 * @module model/EntitiesSuggestionExample
 * @version 2.0
 */
class EntitiesSuggestionExample {
    /**
     * Constructs a new <code>EntitiesSuggestionExample</code>.
     * Predicted/suggested entity.
     * @alias module:model/EntitiesSuggestionExample
     */
    constructor() { 
        
        EntitiesSuggestionExample.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EntitiesSuggestionExample</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntitiesSuggestionExample} obj Optional instance to populate.
     * @return {module:model/EntitiesSuggestionExample} The populated <code>EntitiesSuggestionExample</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntitiesSuggestionExample();
    ...
    /**
     * Validates the JSON data with respect to <code>EntitiesSuggestionExample</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntitiesSuggestionExample</code>.
     */
 ...
 */
EntitiesSuggestionExample.prototype['entityPredictions'] = undefined;

/**
 * Predicted/suggested intents.
 * @member {Array.<module:model/IntentPrediction>} intentPredictions
 */
EntitiesSuggestionExample.prototype['intentPredictions'] = undefined;

/**
 * The utterance. For example, \"What's the weather like in seattle?\"
 * @member {String} text
 */
EntitiesSuggestionExample.prototype['text'] = undefined;

/**
 * The utterance tokenized.
 * @member {Array.<String>} tokenizedText
 */
EntitiesSuggestionExample.prototype['tokenizedText'] = undefined;
...
export default EntitiesSuggestionExample;
