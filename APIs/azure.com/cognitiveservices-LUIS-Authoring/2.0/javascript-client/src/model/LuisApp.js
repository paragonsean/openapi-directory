...
class LuisApp {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('model_features')) {
                obj['model_features'] = ApiClient.convertToType(data['model_features'], [JSONModelFeature]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['model_features']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['model_features'])) {
                throw new Error("Expected the field `model_features` to be an array in the JSON data but got " + data['model_features']);
            }
            // validate the optional field `model_features` (array)
            for (const item of data['model_features']) {
 ...
 * @member {Array.<module:model/JSONModelFeature>} model_features
 */
LuisApp.prototype['model_features'] = undefined;
