...
> Number featuresCreatePatternFeature(appId, versionId, patternCreateObject)
...
let appId = "appId_example"; // String | The application ID.
let versionId = "versionId_example"; // String | The version ID.
let patternCreateObject = new LuisAuthoringClient.PatternCreateObject(); // PatternCreateObject | The Name and Pattern of the feature.
apiInstance.featuresCreatePatternFeature(appId, versionId, patternCreateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let appId = "appId_example"; // String | The application ID.
let versionId = "versionId_example"; // String | The version ID.
let patternId = 56; // Number | The pattern feature ID.
apiInstance.featuresDeletePatternFeature(appId, versionId, patternId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **appId** | **String**| The application ID. | 
 **versionId** | **String**| The version ID. | 
 **patternId** | **Number**| The pattern feature ID. | 
...
let versionId = "versionId_example"; // String | The version ID.
let patternId = 56; // Number | The pattern feature ID.
apiInstance.featuresGetPatternFeatureInfo(appId, versionId, patternId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [PatternFeatureInfo] featuresListApplicationVersionPatternFeatures(appId, versionId, opts)
...
apiInstance.featuresListApplicationVersionPatternFeatures(appId, versionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let versionId = "versionId_example"; // String | The version ID.
let patternId = 56; // Number | The pattern feature ID.
let patternUpdateObject = new LuisAuthoringClient.PatternUpdateObject(); // PatternUpdateObject | The new values for: - Just a boolean called IsActive, in which case the status of the feature will be changed. - Name, Pattern and a boolean called IsActive to update the feature.
apiInstance.featuresUpdatePatternFeature(appId, versionId, patternId, patternUpdateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> String modelAddCompositeEntity(appId, versionId, compositeModelCreateObject)
...
let appId = "appId_example"; // String | The application ID.
let versionId = "versionId_example"; // String | The version ID.
let compositeModelCreateObject = new LuisAuthoringClient.CompositeEntityModel(); // CompositeEntityModel | A model containing the name and children of the new entity extractor.
apiInstance.modelAddCompositeEntity(appId, versionId, compositeModelCreateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> String modelAddEntity(appId, versionId, modelCreateObject)
...
let appId = "appId_example"; // String | The application ID.
let versionId = "versionId_example"; // String | The version ID.
let modelCreateObject = new LuisAuthoringClient.ModelCreateObject(); // ModelCreateObject | A model object containing the name for the new simple entity extractor.
apiInstance.modelAddEntity(appId, versionId, modelCreateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> String modelAddHierarchicalEntity(appId, versionId, hierarchicalModelCreateObject)
...
let appId = "appId_example"; // String | The application ID.
let versionId = "versionId_example"; // String | The version ID.
let hierarchicalModelCreateObject = new LuisAuthoringClient.HierarchicalEntityModel(); // HierarchicalEntityModel | A model containing the name and children of the new entity extractor.
apiInstance.modelAddHierarchicalEntity(appId, versionId, hierarchicalModelCreateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> String modelAddHierarchicalEntityChild(appId, versionId, hEntityId, hierarchicalChildModelCreateObject)
...
let hierarchicalChildModelCreateObject = new LuisAuthoringClient.ModelAddCompositeEntityChildRequest(); // ModelAddCompositeEntityChildRequest | A model object containing the name of the new hierarchical child model.
apiInstance.modelAddHierarchicalEntityChild(appId, versionId, hEntityId, hierarchicalChildModelCreateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [EntityExtractor] modelListEntities(appId, versionId, opts)
...
let versionId = "versionId_example"; // String | The version ID.
let entityId = "entityId_example"; // String | The entity extractor ID.
let modelUpdateObject = new LuisAuthoringClient.ModelUpdateObject(); // ModelUpdateObject | A model object containing the new entity extractor name.
apiInstance.modelUpdateEntity(appId, versionId, entityId, modelUpdateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let versionId = "versionId_example"; // String | The version ID.
let hEntityId = "hEntityId_example"; // String | The hierarchical entity extractor ID.
let hierarchicalModelUpdateObject = new LuisAuthoringClient.HierarchicalEntityModel(); // HierarchicalEntityModel | Model containing names of the children of the hierarchical entity.
apiInstance.modelUpdateHierarchicalEntity(appId, versionId, hEntityId, hierarchicalModelUpdateObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
