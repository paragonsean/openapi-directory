...
#ifndef OAIPatternRule_H
#define OAIPatternRule_H
...
class OAIPatternRule : public OAIObject {
public:
    OAIPatternRule();
    OAIPatternRule(QString json);
    ~OAIPatternRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPatternRule)

#endif // OAIPatternRule_H
