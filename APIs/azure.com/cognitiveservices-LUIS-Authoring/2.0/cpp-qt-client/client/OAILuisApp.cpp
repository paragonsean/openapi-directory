...
void OAILuisApp::initializeModel() {
    ...
    m_model_features_isSet = false;
    m_model_features_isValid = false;
...
void OAILuisApp::fromJsonObject(QJsonObject json) {
    ...
    m_model_features_isValid = ::OpenAPI::fromJsonValue(m_model_features, json[QString("model_features")]);
    m_model_features_isSet = !json[QString("model_features")].isNull() && m_model_features_isValid;
...
QJsonObject OAILuisApp::asJsonObject() const {
    ...
    if (m_model_features.size() > 0) {
        obj.insert(QString("model_features"), ::OpenAPI::toJsonValue(m_model_features));
    }
    if (m_name_isSet) {
...
QList<OAIJSONModelFeature> OAILuisApp::getModelFeatures() const {
    return m_model_features;
}
void OAILuisApp::setModelFeatures(const QList<OAIJSONModelFeature> &model_features) {
    m_model_features = model_features;
    m_model_features_isSet = true;
}

bool OAILuisApp::is_model_features_Set() const{
    return m_model_features_isSet;
}

bool OAILuisApp::is_model_features_Valid() const{
    return m_model_features_isValid;
}
