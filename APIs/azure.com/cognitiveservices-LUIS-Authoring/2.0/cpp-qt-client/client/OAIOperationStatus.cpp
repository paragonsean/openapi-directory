...
QString OAIOperationStatus::getCode() const {
    return m_code;
}
void OAIOperationStatus::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIOperationStatus::is_code_Set() const{
    return m_code_isSet;
}

bool OAIOperationStatus::is_code_Valid() const{
