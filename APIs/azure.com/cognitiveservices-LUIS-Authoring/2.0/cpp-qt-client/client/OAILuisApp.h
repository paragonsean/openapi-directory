...
public:
    ...
    QList<OAIJSONModelFeature> getModelFeatures() const;
    void setModelFeatures(const QList<OAIJSONModelFeature> &model_features);
    bool is_model_features_Set() const;
    bool is_model_features_Valid() const;
...
private:
    ...
    QList<OAIJSONModelFeature> m_model_features;
    bool m_model_features_isSet;
    bool m_model_features_isValid;
