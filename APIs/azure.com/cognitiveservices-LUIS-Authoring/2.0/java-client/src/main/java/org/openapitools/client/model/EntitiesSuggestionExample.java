...
public class EntitiesSuggestionExample {
  ...
  public EntitiesSuggestionExample entityPredictions(List<EntityPrediction> entityPredictions) {
    this.entityPredictions = entityPredictions;
    return this;
  }

  public EntitiesSuggestionExample addEntityPredictionsItem(EntityPrediction entityPredictionsItem) {
  ...
  public EntitiesSuggestionExample intentPredictions(List<IntentPrediction> intentPredictions) {
    this.intentPredictions = intentPredictions;
    return this;
  }

  public EntitiesSuggestionExample addIntentPredictionsItem(IntentPrediction intentPredictionsItem) {
  ...
  public EntitiesSuggestionExample text(String text) {
    this.text = text;
    return this;
  }
  ...
  public EntitiesSuggestionExample tokenizedText(List<String> tokenizedText) {
    this.tokenizedText = tokenizedText;
    return this;
  }

  public EntitiesSuggestionExample addTokenizedTextItem(String tokenizedTextItem) {
  ...
  public boolean equals(Object o) {
    ...
    EntitiesSuggestionExample entitiesSuggestionExample = (EntitiesSuggestionExample) o;
    return Objects.equals(this.entityPredictions, entitiesSuggestionExample.entityPredictions) &&
        Objects.equals(this.intentPredictions, entitiesSuggestionExample.intentPredictions) &&
        Objects.equals(this.text, entitiesSuggestionExample.text) &&
        Objects.equals(this.tokenizedText, entitiesSuggestionExample.tokenizedText);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntitiesSuggestionExample {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntitiesSuggestionExample
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntitiesSuggestionExample.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntitiesSuggestionExample is not found in the empty JSON string", EntitiesSuggestionExample.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntitiesSuggestionExample.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntitiesSuggestionExample` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntitiesSuggestionExample.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntitiesSuggestionExample' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntitiesSuggestionExample> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntitiesSuggestionExample.class));

       return (TypeAdapter<T>) new TypeAdapter<EntitiesSuggestionExample>() {
           @Override
           public void write(JsonWriter out, EntitiesSuggestionExample value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntitiesSuggestionExample read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntitiesSuggestionExample given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntitiesSuggestionExample
   * @throws IOException if the JSON string is invalid with respect to EntitiesSuggestionExample
   */
  public static EntitiesSuggestionExample fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntitiesSuggestionExample.class);
  }

  /**
   * Convert an instance of EntitiesSuggestionExample to an JSON string
   *
   * @return JSON string
   */
