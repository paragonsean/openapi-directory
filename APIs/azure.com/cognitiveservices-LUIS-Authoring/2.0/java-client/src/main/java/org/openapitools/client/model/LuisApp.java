...
public class LuisApp {
  ...
  public static final String SERIALIZED_NAME_MODEL_FEATURES = "model_features";
  @SerializedName(SERIALIZED_NAME_MODEL_FEATURES)
  private List<JSONModelFeature> modelFeatures = new ArrayList<>();
  ...
  public LuisApp modelFeatures(List<JSONModelFeature> modelFeatures) {
    this.modelFeatures = modelFeatures;
    return this;
  }

  public LuisApp addModelFeaturesItem(JSONModelFeature modelFeaturesItem) {
    if (this.modelFeatures == null) {
      this.modelFeatures = new ArrayList<>();
    }
    this.modelFeatures.add(modelFeaturesItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<JSONModelFeature> getModelFeatures() {
    return modelFeatures;
  }

  public void setModelFeatures(List<JSONModelFeature> modelFeatures) {
    this.modelFeatures = modelFeatures;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.closedLists, luisApp.closedLists) &&
        ...
        Objects.equals(this.modelFeatures, luisApp.modelFeatures) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(closedLists, composites, culture, desc, entities, intents, modelFeatures, name, patternAnyEntities, patterns, prebuiltEntities, regexEntities, regexFeatures, utterances, versionId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    modelFeatures: ").append(toIndentedString(modelFeatures)).append("\n");
  ...
  static {
    ...
    openapiFields.add("model_features");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("model_features") != null && !jsonObj.get("model_features").isJsonNull()) {
        JsonArray jsonArraymodelFeatures = jsonObj.getAsJsonArray("model_features");
        if (jsonArraymodelFeatures != null) {
          // ensure the json data is an array
          if (!jsonObj.get("model_features").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `model_features` to be an array in the JSON string but got `%s`", jsonObj.get("model_features").toString()));
          }

          // validate the optional field `model_features` (array)
          for (int i = 0; i < jsonArraymodelFeatures.size(); i++) {
            JSONModelFeature.validateJsonElement(jsonArraymodelFeatures.get(i));
          };
        }
      }
