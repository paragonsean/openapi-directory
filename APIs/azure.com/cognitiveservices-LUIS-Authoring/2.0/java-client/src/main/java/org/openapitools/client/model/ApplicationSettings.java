...
public class ApplicationSettings {
  ...
  public ApplicationSettings id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ApplicationSettings _public(Boolean _public) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, applicationSettings.id) &&
        Objects.equals(this._public, applicationSettings._public);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ApplicationSettings.openapiRequiredFields) {
