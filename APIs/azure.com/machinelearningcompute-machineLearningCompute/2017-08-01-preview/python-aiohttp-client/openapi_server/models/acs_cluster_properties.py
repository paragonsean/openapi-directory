...
class AcsClusterProperties(Model):
    ...
    def __init__(self, agent_count: int=None, agent_vm_size: str='D3_v2', cluster_fqdn: str=None, master_count: int=None, orchestrator_properties: KubernetesClusterProperties=None, orchestrator_type: str=None, system_services: List[SystemService]=None):
        ...
        :param master_count: The master_count of this AcsClusterProperties.
    ...
    def master_count(self):
        """Gets the master_count of this AcsClusterProperties.

        The number of master nodes in the container service.

        :return: The master_count of this AcsClusterProperties.
        :rtype: int
        """
    ...
    def master_count(self, master_count):
        """Sets the master_count of this AcsClusterProperties.
        ...
        """
        if master_count is not None and master_count > 5:
            raise ValueError("Invalid value for `master_count`, must be a value less than or equal to `5`")
        if master_count is not None and master_count < 1:
            raise ValueError("Invalid value for `master_count`, must be a value greater than or equal to `1`")
    ...
    def orchestrator_type(self, orchestrator_type):
        ...
        """
        allowed_values = ["Kubernetes", "None"]  # noqa: E501
