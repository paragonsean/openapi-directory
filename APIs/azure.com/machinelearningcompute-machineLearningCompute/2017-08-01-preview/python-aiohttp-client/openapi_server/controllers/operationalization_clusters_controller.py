...
async def operationalization_clusters_check_system_services_updates_available(request: web.Request, api_version, subscription_id, resource_group_name, cluster_name) -> web.Response:
...
async def operationalization_clusters_delete(request: web.Request, api_version, subscription_id, resource_group_name, cluster_name, delete_all=None) -> web.Response:
...
async def operationalization_clusters_update_system_services(request: web.Request, api_version, subscription_id, resource_group_name, cluster_name) -> web.Response:
