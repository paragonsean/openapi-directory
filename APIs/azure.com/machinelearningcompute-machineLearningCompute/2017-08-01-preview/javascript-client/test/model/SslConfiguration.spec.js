...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningComputeManagementClient.SslConfiguration();
  });
  ...
  describe('SslConfiguration', function() {
    it('should create an instance of SslConfiguration', function() {
      // uncomment below and update the code to test SslConfiguration
      //var instance = new MachineLearningComputeManagementClient.SslConfiguration();
      //expect(instance).to.be.a(MachineLearningComputeManagementClient.SslConfiguration);
    });
