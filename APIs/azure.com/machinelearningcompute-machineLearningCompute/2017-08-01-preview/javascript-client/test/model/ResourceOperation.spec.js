...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningComputeManagementClient.ResourceOperation();
  });
  ...
  describe('ResourceOperation', function() {
    it('should create an instance of ResourceOperation', function() {
      ...
      //var instance = new MachineLearningComputeManagementClient.ResourceOperation();
      //expect(instance).to.be.a(MachineLearningComputeManagementClient.ResourceOperation);
    });
