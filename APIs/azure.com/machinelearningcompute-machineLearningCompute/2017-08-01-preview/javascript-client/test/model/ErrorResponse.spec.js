...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningComputeManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new MachineLearningComputeManagementClient.ErrorResponse();
      //expect(instance).to.be.a(MachineLearningComputeManagementClient.ErrorResponse);
    });
