...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MachineLearningComputeManagementClient.AppInsightsCredentials();
  });
  ...
  describe('AppInsightsCredentials', function() {
    it('should create an instance of AppInsightsCredentials', function() {
      ...
      //var instance = new MachineLearningComputeManagementClient.AppInsightsCredentials();
      //expect(instance).to.be.a(MachineLearningComputeManagementClient.AppInsightsCredentials);
    });
