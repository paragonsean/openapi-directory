...
class AcsClusterProperties {
    ...
    constructor(orchestratorType) { 
        ...
        AcsClusterProperties.initialize(this, orchestratorType);
    }
    ...
    static initialize(obj, orchestratorType) { 
        obj['agentVmSize'] = 'Standard_D3_v2';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('masterCount')) {
                obj['masterCount'] = ApiClient.convertToType(data['masterCount'], 'Number');
            }
...
AcsClusterProperties.RequiredProperties = ["orchestratorType"];
 ...
 */
AcsClusterProperties.prototype['agentVmSize'] = 'Standard_D3_v2';
 ...
 * @member {Number} masterCount
 */
AcsClusterProperties.prototype['masterCount'] = undefined;
