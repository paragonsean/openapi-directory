# MachineLearningComputeManagementClient.AcsClusterProperties
...
**agentVmSize** | **String** | The Azure VM size of the agent VM nodes. This cannot be changed once the cluster is created. This list is non exhaustive; refer to https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes for the possible VM sizes. | [optional] [default to &#39;Standard_D3_v2&#39;]
**clusterFqdn** | **String** | The FQDN of the cluster.  | [optional] [readonly] 
**masterCount** | **Number** | The number of master nodes in the container service. | [optional] 
**orchestratorProperties** | [**KubernetesClusterProperties**](KubernetesClusterProperties.md) |  | [optional] 
**orchestratorType** | **String** | Type of orchestrator. It cannot be changed once the cluster is created. | 
**systemServices** | [**[SystemService]**](SystemService.md) | The system services deployed to the cluster | [optional] 
