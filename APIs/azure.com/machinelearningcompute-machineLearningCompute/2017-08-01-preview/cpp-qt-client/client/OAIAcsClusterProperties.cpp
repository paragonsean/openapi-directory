...
void OAIAcsClusterProperties::initializeModel() {
    ...
    m_master_count_isSet = false;
    m_master_count_isValid = false;
...
void OAIAcsClusterProperties::fromJsonObject(QJsonObject json) {
    ...
    m_master_count_isValid = ::OpenAPI::fromJsonValue(m_master_count, json[QString("masterCount")]);
    m_master_count_isSet = !json[QString("masterCount")].isNull() && m_master_count_isValid;
...
QJsonObject OAIAcsClusterProperties::asJsonObject() const {
    ...
    if (m_master_count_isSet) {
        obj.insert(QString("masterCount"), ::OpenAPI::toJsonValue(m_master_count));
    }
...
qint32 OAIAcsClusterProperties::getMasterCount() const {
    return m_master_count;
}
void OAIAcsClusterProperties::setMasterCount(const qint32 &master_count) {
    m_master_count = master_count;
    m_master_count_isSet = true;
}

bool OAIAcsClusterProperties::is_master_count_Set() const{
    return m_master_count_isSet;
}

bool OAIAcsClusterProperties::is_master_count_Valid() const{
    return m_master_count_isValid;
}
...
QList<OAISystemService> OAIAcsClusterProperties::getSystemServices() const {
    return m_system_services;
}
void OAIAcsClusterProperties::setSystemServices(const QList<OAISystemService> &system_services) {
