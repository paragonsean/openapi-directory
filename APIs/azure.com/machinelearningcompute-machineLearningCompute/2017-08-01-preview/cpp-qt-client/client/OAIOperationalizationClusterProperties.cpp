...
OAIAppInsightsProperties OAIOperationalizationClusterProperties::getAppInsights() const {
    return m_app_insights;
}
void OAIOperationalizationClusterProperties::setAppInsights(const OAIAppInsightsProperties &app_insights) {
...
QList<OAIErrorResponseWrapper> OAIOperationalizationClusterProperties::getProvisioningErrors() const {
    return m_provisioning_errors;
}
void OAIOperationalizationClusterProperties::setProvisioningErrors(const QList<OAIErrorResponseWrapper> &provisioning_errors) {
    m_provisioning_errors = provisioning_errors;
    m_provisioning_errors_isSet = true;
}

bool OAIOperationalizationClusterProperties::is_provisioning_errors_Set() const{
    return m_provisioning_errors_isSet;
}

bool OAIOperationalizationClusterProperties::is_provisioning_errors_Valid() const{
...
bool OAIOperationalizationClusterProperties::isValid() const {
    ...
    return m_cluster_type_isValid && true;
}
