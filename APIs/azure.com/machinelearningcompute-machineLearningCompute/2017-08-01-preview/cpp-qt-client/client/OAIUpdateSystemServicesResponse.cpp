...
OAIUpdateSystemServicesResponse::OAIUpdateSystemServicesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSystemServicesResponse::OAIUpdateSystemServicesResponse() {
    this->initializeModel();
}

OAIUpdateSystemServicesResponse::~OAIUpdateSystemServicesResponse() {}

void OAIUpdateSystemServicesResponse::initializeModel() {
...
void OAIUpdateSystemServicesResponse::fromJson(QString jsonString) {
...
void OAIUpdateSystemServicesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSystemServicesResponse::asJson() const {
...
QJsonObject OAIUpdateSystemServicesResponse::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIUpdateSystemServicesResponse::getUpdateCompletedOn() const {
    return m_update_completed_on;
}
void OAIUpdateSystemServicesResponse::setUpdateCompletedOn(const QDateTime &update_completed_on) {
    m_update_completed_on = update_completed_on;
    m_update_completed_on_isSet = true;
}

bool OAIUpdateSystemServicesResponse::is_update_completed_on_Set() const{
    return m_update_completed_on_isSet;
}

bool OAIUpdateSystemServicesResponse::is_update_completed_on_Valid() const{
    return m_update_completed_on_isValid;
}

QDateTime OAIUpdateSystemServicesResponse::getUpdateStartedOn() const {
    return m_update_started_on;
}
void OAIUpdateSystemServicesResponse::setUpdateStartedOn(const QDateTime &update_started_on) {
    m_update_started_on = update_started_on;
    m_update_started_on_isSet = true;
}

bool OAIUpdateSystemServicesResponse::is_update_started_on_Set() const{
    return m_update_started_on_isSet;
}

bool OAIUpdateSystemServicesResponse::is_update_started_on_Valid() const{
    return m_update_started_on_isValid;
}

QString OAIUpdateSystemServicesResponse::getUpdateStatus() const {
    return m_update_status;
}
void OAIUpdateSystemServicesResponse::setUpdateStatus(const QString &update_status) {
    m_update_status = update_status;
    m_update_status_isSet = true;
}

bool OAIUpdateSystemServicesResponse::is_update_status_Set() const{
    return m_update_status_isSet;
}

bool OAIUpdateSystemServicesResponse::is_update_status_Valid() const{
    return m_update_status_isValid;
}

bool OAIUpdateSystemServicesResponse::isSet() const {
...
bool OAIUpdateSystemServicesResponse::isValid() const {
