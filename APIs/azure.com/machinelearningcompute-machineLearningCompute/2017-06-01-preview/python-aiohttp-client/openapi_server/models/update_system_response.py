...
class UpdateSystemResponse(Model):
    ...
    def __init__(self, update_completed_on: datetime=None, update_started_on: datetime=None, update_status: str=None):
        """UpdateSystemResponse - a model defined in OpenAPI

        :param update_completed_on: The update_completed_on of this UpdateSystemResponse.
        :param update_started_on: The update_started_on of this UpdateSystemResponse.
        :param update_status: The update_status of this UpdateSystemResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSystemResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSystemResponse of this UpdateSystemResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def update_completed_on(self):
        """Gets the update_completed_on of this UpdateSystemResponse.

        Read Only: The date and time when the last system services update completed.

        :return: The update_completed_on of this UpdateSystemResponse.
        :rtype: datetime
        """
    ...
    def update_completed_on(self, update_completed_on):
        """Sets the update_completed_on of this UpdateSystemResponse.
    ...
    def update_started_on(self):
        """Gets the update_started_on of this UpdateSystemResponse.

        Read Only: The date and time when the last system services update was started.

        :return: The update_started_on of this UpdateSystemResponse.
        :rtype: datetime
        """
    ...
    def update_started_on(self, update_started_on):
        """Sets the update_started_on of this UpdateSystemResponse.
    ...
    def update_status(self):
        """Gets the update_status of this UpdateSystemResponse.

        Update status

        :return: The update_status of this UpdateSystemResponse.
        :rtype: str
        """
    ...
    def update_status(self, update_status):
        """Sets the update_status of this UpdateSystemResponse.
