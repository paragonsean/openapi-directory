...
class CheckUpdateResponse(Model):
    ...
    def __init__(self, updates_available: str=None):
        """CheckUpdateResponse - a model defined in OpenAPI

        :param updates_available: The updates_available of this CheckUpdateResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CheckUpdateResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CheckUpdateResponse of this CheckUpdateResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def updates_available(self):
        """Gets the updates_available of this CheckUpdateResponse.

        Yes if updates are available for the system services, No if not.

        :return: The updates_available of this CheckUpdateResponse.
        :rtype: str
        """
    ...
    def updates_available(self, updates_available):
        """Sets the updates_available of this CheckUpdateResponse.
