...
class OperationalizationClusterProperties(Model):
    ...
    def __init__(self, app_insights: AppInsightsCredentials=None, cluster_type: str=None, container_registry: ContainerRegistryProperties=None, container_service: AcsClusterProperties=None, created_on: datetime=None, description: str=None, global_service_configuration: GlobalServiceConfiguration=None, modified_on: datetime=None, provisioning_state: str=None, storage_account: StorageAccountProperties=None):
    ...
    def container_service(self, container_service):
        ...
        if container_service is None:
            raise ValueError("Invalid value for `container_service`, must not be `None`")
