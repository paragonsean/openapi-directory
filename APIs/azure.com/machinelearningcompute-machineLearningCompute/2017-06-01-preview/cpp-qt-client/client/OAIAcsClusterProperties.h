...
public:
    ...
    QList<OAISystemServices> getSystemServices() const;
    void setSystemServices(const QList<OAISystemServices> &system_services);
...
private:
    ...
    QList<OAISystemServices> m_system_services;
