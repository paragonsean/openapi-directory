...
|**percentComplete** | **BigDecimal** | Async operation progress. |  [optional] |
|**provisioningState** | [**ProvisioningStateEnum**](#ProvisioningStateEnum) | Read Only: The provisioning state of the cluster. Valid values are Unknown, Provisioning, Succeeded, and Failed. |  [optional] [readonly] |
