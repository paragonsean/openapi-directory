...
public class OperationalizationClusterProperties {
  ...
  public OperationalizationClusterProperties appInsights(AppInsightsCredentials appInsights) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appInsights, clusterType, containerRegistry, containerService, createdOn, description, globalServiceConfiguration, modifiedOn, provisioningState, storageAccount);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("containerService");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `containerService`
