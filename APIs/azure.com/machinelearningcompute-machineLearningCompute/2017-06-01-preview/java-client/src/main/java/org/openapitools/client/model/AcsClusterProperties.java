...
import org.openapitools.client.model.SystemServices;
...
public class AcsClusterProperties {
  ...
  private AgentVmSizeEnum agentVmSize = AgentVmSizeEnum.D2_V2;
  ...
  private List<SystemServices> systemServices = new ArrayList<>();
  ...
  public AcsClusterProperties systemServices(List<SystemServices> systemServices) {
    this.systemServices = systemServices;
    return this;
  }

  public AcsClusterProperties addSystemServicesItem(SystemServices systemServicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SystemServices> getSystemServices() {
    return systemServices;
  }

  public void setSystemServices(List<SystemServices> systemServices) {
    this.systemServices = systemServices;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentCount, agentVmSize, clusterFqdn, orchestratorProperties, orchestratorType, systemServices);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("orchestratorProperties");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `orchestratorProperties`
      ...
      if (jsonObj.get("systemServices") != null && !jsonObj.get("systemServices").isJsonNull() && !jsonObj.get("systemServices").isJsonArray()) {
