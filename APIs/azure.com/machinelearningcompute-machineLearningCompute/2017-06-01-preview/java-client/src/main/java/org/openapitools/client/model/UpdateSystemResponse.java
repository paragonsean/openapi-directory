...
public class UpdateSystemResponse {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSystemResponse updateSystemResponse = (UpdateSystemResponse) o;
    return Objects.equals(this.updateCompletedOn, updateSystemResponse.updateCompletedOn) &&
        Objects.equals(this.updateStartedOn, updateSystemResponse.updateStartedOn) &&
        Objects.equals(this.updateStatus, updateSystemResponse.updateStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSystemResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSystemResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSystemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSystemResponse is not found in the empty JSON string", UpdateSystemResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSystemResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSystemResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSystemResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSystemResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSystemResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSystemResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSystemResponse>() {
           @Override
           public void write(JsonWriter out, UpdateSystemResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSystemResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSystemResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSystemResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateSystemResponse
   */
  public static UpdateSystemResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSystemResponse.class);
  }

  /**
   * Convert an instance of UpdateSystemResponse to an JSON string
   *
   * @return JSON string
   */
