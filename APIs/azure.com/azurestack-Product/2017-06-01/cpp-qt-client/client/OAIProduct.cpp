...
OAIProductNestedProperties OAIProduct::getProperties() const {
    return m_properties;
}
void OAIProduct::setProperties(const OAIProductNestedProperties &properties) {
...
QString OAIProduct::getEtag() const {
    return m_etag;
}
void OAIProduct::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIProduct::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIProduct::is_etag_Valid() const{
