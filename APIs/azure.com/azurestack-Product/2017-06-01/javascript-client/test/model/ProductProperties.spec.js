...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.ProductProperties();
  });
  ...
  describe('ProductProperties', function() {
    it('should create an instance of ProductProperties', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.ProductProperties();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.ProductProperties);
    });
