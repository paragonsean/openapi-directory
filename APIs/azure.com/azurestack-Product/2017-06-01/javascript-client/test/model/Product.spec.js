...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureStackAzureBridgeClient.Product();
  });
  ...
  describe('Product', function() {
    it('should create an instance of Product', function() {
      ...
      //var instance = new AzureStackAzureBridgeClient.Product();
      //expect(instance).to.be.a(AzureStackAzureBridgeClient.Product);
    });
