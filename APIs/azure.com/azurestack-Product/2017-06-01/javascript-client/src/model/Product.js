...
import ProductNestedProperties from './ProductNestedProperties';
...
class Product {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ProductNestedProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ProductNestedProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ProductNestedProperties} properties
 */
 ...
 * @member {String} etag
 */
Product.prototype['etag'] = undefined;
