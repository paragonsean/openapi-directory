...
public class IconUris {
  ...
  public IconUris hero(String hero) {
    this.hero = hero;
    return this;
  }
  ...
  public IconUris large(String large) {
    this.large = large;
    return this;
  }
  ...
  public IconUris medium(String medium) {
    this.medium = medium;
    return this;
  }
  ...
  public IconUris small(String small) {
    this.small = small;
    return this;
  }
  ...
  public IconUris wide(String wide) {
    this.wide = wide;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IconUris iconUris = (IconUris) o;
    return Objects.equals(this.hero, iconUris.hero) &&
        Objects.equals(this.large, iconUris.large) &&
        Objects.equals(this.medium, iconUris.medium) &&
        Objects.equals(this.small, iconUris.small) &&
        Objects.equals(this.wide, iconUris.wide);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IconUris
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IconUris.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IconUris is not found in the empty JSON string", IconUris.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IconUris.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IconUris` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IconUris.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IconUris' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IconUris> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IconUris.class));

       return (TypeAdapter<T>) new TypeAdapter<IconUris>() {
           @Override
           public void write(JsonWriter out, IconUris value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IconUris read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IconUris given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IconUris
   * @throws IOException if the JSON string is invalid with respect to IconUris
   */
  public static IconUris fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IconUris.class);
  }

  /**
   * Convert an instance of IconUris to an JSON string
   *
   * @return JSON string
   */
