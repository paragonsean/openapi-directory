...
class Compatibility(Model):
    ...
    def __init__(self, description: str=None, is_compatible: bool=None, issues: List[CompatibilityIssue]=None, message: str=None):
    ...
    def issues(self, issues):
        ...
        :param issues: The issues of this Compatibility.
        :type issues: List[CompatibilityIssue]
        """
