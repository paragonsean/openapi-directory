...
> TriggerList triggersListByDataBoxEdgeDevice(deviceName, subscriptionId, resourceGroupName, apiVersion, $expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceGroupName = "resourceGroupName_example"; // String | The resource group name.
    String apiVersion = "apiVersion_example"; // String | The API version.
    String $expand = "$expand_example"; // String | Specify $filter='CustomContextTag eq <tag>' to filter on custom context tag property
    try {
      TriggerList result = apiInstance.triggersListByDataBoxEdgeDevice(deviceName, subscriptionId, resourceGroupName, apiVersion, $expand);
      System.out.println(result);
    } catch (ApiException e) {
