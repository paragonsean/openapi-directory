...
|**lastCompletedRefreshJobTimeInUTC** | **OffsetDateTime** | Indicates the completed time for the last refresh job on this particular share, if any.This could be a failed job or a successful job. |  [optional] |
