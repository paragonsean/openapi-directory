...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.MountPointMap();
  });
  ...
  describe('MountPointMap', function() {
    it('should create an instance of MountPointMap', function() {
      // uncomment below and update the code to test MountPointMap
      //var instance = new DataBoxEdgeManagementClient.MountPointMap();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.MountPointMap);
    });
