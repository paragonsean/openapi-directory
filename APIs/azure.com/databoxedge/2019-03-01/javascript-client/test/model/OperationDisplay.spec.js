...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.OperationDisplay();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.OperationDisplay);
    });
