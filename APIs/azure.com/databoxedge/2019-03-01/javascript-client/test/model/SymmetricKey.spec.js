...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.SymmetricKey();
  });
  ...
  describe('SymmetricKey', function() {
    it('should create an instance of SymmetricKey', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.SymmetricKey();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.SymmetricKey);
    });
