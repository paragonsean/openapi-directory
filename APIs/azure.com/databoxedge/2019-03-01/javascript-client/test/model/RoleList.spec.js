...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.RoleList();
  });
  ...
  describe('RoleList', function() {
    it('should create an instance of RoleList', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.RoleList();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.RoleList);
    });
