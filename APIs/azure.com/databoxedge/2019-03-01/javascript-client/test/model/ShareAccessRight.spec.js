...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.ShareAccessRight();
  });
  ...
  describe('ShareAccessRight', function() {
    it('should create an instance of ShareAccessRight', function() {
      // uncomment below and update the code to test ShareAccessRight
      //var instance = new DataBoxEdgeManagementClient.ShareAccessRight();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.ShareAccessRight);
    });
