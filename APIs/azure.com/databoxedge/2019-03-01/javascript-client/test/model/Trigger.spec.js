...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.Trigger();
  });
  ...
  describe('Trigger', function() {
    it('should create an instance of Trigger', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.Trigger();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.Trigger);
    });
