...
------------- | ------------- | -------------
[**operationsStatusGet**](OperationsStatusApi.md#operationsStatusGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/operationsStatus/{name} | Gets the details of a specified job on a data box edge/gateway device.
