...
import BandwidthScheduleProperties from './BandwidthScheduleProperties';
...
class BandwidthSchedule {
    ...
    constructor() { 
        ...
        BandwidthSchedule.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = BandwidthScheduleProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          BandwidthScheduleProperties.validateJSON(data['properties']);
        }
...
BandwidthSchedule.RequiredProperties = ["properties"];

/**
 * @member {module:model/BandwidthScheduleProperties} properties
 */
BandwidthSchedule.prototype['properties'] = undefined;

/**
 * The path ID that uniquely identifies the object.
 * @member {String} id
 */
BandwidthSchedule.prototype['id'] = undefined;

/**
 * The object name.
 * @member {String} name
 */
BandwidthSchedule.prototype['name'] = undefined;

/**
 * The hierarchical type of the object.
 * @member {String} type
 */
BandwidthSchedule.prototype['type'] = undefined;
