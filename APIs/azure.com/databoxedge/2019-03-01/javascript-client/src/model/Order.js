...
class Order {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = OrderProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          OrderProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/OrderProperties} properties
 */
