...
/*
 * OAIFileTriggerProperties.h
 *
 * File trigger properties.
 */

#ifndef OAIFileTriggerProperties_H
#define OAIFileTriggerProperties_H
...
class OAIFileSourceInfo;

class OAIFileTriggerProperties : public OAIObject {
public:
    OAIFileTriggerProperties();
    OAIFileTriggerProperties(QString json);
    ~OAIFileTriggerProperties() override;
    ...
    OAIFileSourceInfo getSourceInfo() const;
    void setSourceInfo(const OAIFileSourceInfo &source_info);
...
private:
    ...
    OAIFileSourceInfo m_source_info;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileTriggerProperties)

#endif // OAIFileTriggerProperties_H
