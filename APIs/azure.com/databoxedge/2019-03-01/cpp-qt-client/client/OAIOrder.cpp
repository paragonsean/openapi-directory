...
OAIOrderProperties OAIOrder::getProperties() const {
    return m_properties;
}
void OAIOrder::setProperties(const OAIOrderProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIOrder::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIOrder::is_properties_Valid() const{
