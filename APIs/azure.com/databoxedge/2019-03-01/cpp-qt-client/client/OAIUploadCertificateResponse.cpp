...
bool OAIUploadCertificateResponse::isValid() const {
    ...
    return m_aad_authority_isValid && m_aad_tenant_id_isValid && m_azure_management_endpoint_audience_isValid && m_resource_id_isValid && m_service_principal_client_id_isValid && m_service_principal_object_id_isValid && true;
}
