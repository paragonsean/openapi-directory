...
class UploadCertificateResponse(Model):
    ...
    def __init__(self, aad_authority: str=None, aad_tenant_id: str=None, auth_type: str=None, azure_management_endpoint_audience: str=None, resource_id: str=None, service_principal_client_id: str=None, service_principal_object_id: str=None):
