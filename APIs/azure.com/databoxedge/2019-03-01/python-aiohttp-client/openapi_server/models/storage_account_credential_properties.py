...
class StorageAccountCredentialProperties(Model):
    ...
    def __init__(self, account_key: AsymmetricEncryptedSecret=None, account_type: str=None, alias: str=None, blob_domain_name: str=None, connection_string: str=None, ssl_status: str=None, user_name: str=None):
