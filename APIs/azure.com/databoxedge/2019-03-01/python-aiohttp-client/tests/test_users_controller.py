...
async def test_users_create_or_update(client):
    ...
    """
    user = {"properties":{"encryptedPassword":{"encryptionAlgorithm":"None","encryptionCertThumbprint":"encryptionCertThumbprint","value":"value"},"shareAccessRights":[{"accessType":"Change","shareId":"shareId"},{"accessType":"Change","shareId":"shareId"}]}}
