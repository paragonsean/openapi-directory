...
class IoTDeviceInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ioTHostHubId')) {
                obj['ioTHostHubId'] = ApiClient.convertToType(data['ioTHostHubId'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ioTHostHubId'] && !(typeof data['ioTHostHubId'] === 'string' || data['ioTHostHubId'] instanceof String)) {
            throw new Error("Expected the field `ioTHostHubId` to be a primitive type in the JSON string but got " + data['ioTHostHubId']);
        }
 ...
 * @member {String} ioTHostHubId
 */
IoTDeviceInfo.prototype['ioTHostHubId'] = undefined;
