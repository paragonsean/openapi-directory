...
class JobProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('refreshedEntityId')) {
                obj['refreshedEntityId'] = ApiClient.convertToType(data['refreshedEntityId'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['refreshedEntityId'] && !(typeof data['refreshedEntityId'] === 'string' || data['refreshedEntityId'] instanceof String)) {
            throw new Error("Expected the field `refreshedEntityId` to be a primitive type in the JSON string but got " + data['refreshedEntityId']);
        }
 ...
 * @member {String} refreshedEntityId
 */
JobProperties.prototype['refreshedEntityId'] = undefined;
