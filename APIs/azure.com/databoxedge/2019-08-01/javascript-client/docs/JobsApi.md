# DataBoxEdgeManagementClient.JobsApi
...
let apiInstance = new DataBoxEdgeManagementClient.JobsApi();
...
apiInstance.jobsGet(deviceName, name, subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
