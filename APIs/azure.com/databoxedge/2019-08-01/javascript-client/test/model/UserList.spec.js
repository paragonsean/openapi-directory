...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.UserList();
  });
  ...
  describe('UserList', function() {
    it('should create an instance of UserList', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.UserList();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.UserList);
    });
