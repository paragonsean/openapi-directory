...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.SkuRestrictionInfo();
  });
  ...
  describe('SkuRestrictionInfo', function() {
    it('should create an instance of SkuRestrictionInfo', function() {
      // uncomment below and update the code to test SkuRestrictionInfo
      //var instance = new DataBoxEdgeManagementClient.SkuRestrictionInfo();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.SkuRestrictionInfo);
    });
