...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.ContainerList();
  });
  ...
  describe('ContainerList', function() {
    it('should create an instance of ContainerList', function() {
      // uncomment below and update the code to test ContainerList
      //var instance = new DataBoxEdgeManagementClient.ContainerList();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.ContainerList);
    });
