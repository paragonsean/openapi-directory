...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.Alert();
  });
  ...
  describe('Alert', function() {
    it('should create an instance of Alert', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.Alert();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.Alert);
    });
