...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.Role();
  });
  ...
  describe('Role', function() {
    it('should create an instance of Role', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.Role();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.Role);
    });
