...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.SkuLocationInfo();
  });
  ...
  describe('SkuLocationInfo', function() {
    it('should create an instance of SkuLocationInfo', function() {
      // uncomment below and update the code to test SkuLocationInfo
      //var instance = new DataBoxEdgeManagementClient.SkuLocationInfo();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.SkuLocationInfo);
    });
