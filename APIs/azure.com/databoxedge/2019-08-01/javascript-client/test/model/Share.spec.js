...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.Share();
  });
  ...
  describe('Share', function() {
    it('should create an instance of Share', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.Share();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.Share);
    });
