...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.Node();
  });
  ...
  describe('Node', function() {
    it('should create an instance of Node', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.Node();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.Node);
    });
