...
class DataBoxEdgeDeviceProperties(Model):
    ...
    def __init__(self, configured_role_types: List[str]=None, culture: str=None, data_box_edge_device_status: str=None, description: str=None, device_hcs_version: str=None, device_local_capacity: int=None, device_model: str=None, device_software_version: str=None, device_type: str=None, friendly_name: str=None, model_description: str=None, node_count: int=None, serial_number: str=None, time_zone: str=None):
        ...
        :param node_count: The node_count of this DataBoxEdgeDeviceProperties.
    ...
    def data_box_edge_device_status(self, data_box_edge_device_status):
        ...
        """
        allowed_values = ["ReadyToSetup", "Online", "Offline", "NeedsAttention", "Disconnected", "PartiallyDisconnected", "Maintenance"]  # noqa: E501
    ...
    @property
    def node_count(self):
        """Gets the node_count of this DataBoxEdgeDeviceProperties.

        The number of nodes in the cluster.

        :return: The node_count of this DataBoxEdgeDeviceProperties.
        :rtype: int
        """
    ...
    def node_count(self, node_count):
        """Sets the node_count of this DataBoxEdgeDeviceProperties.
