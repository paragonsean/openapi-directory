...
async def test_storage_account_credentials_create_or_update(client):
    ...
    """
    storage_account_credential = {"properties":{"connectionString":"connectionString","storageAccountId":"storageAccountId","sslStatus":"Enabled","accountType":"GeneralPurposeStorage","blobDomainName":"blobDomainName","alias":"alias","userName":"userName","accountKey":{"encryptionAlgorithm":"None","encryptionCertThumbprint":"encryptionCertThumbprint","value":"value"}}}
