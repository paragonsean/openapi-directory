...
void OAINodesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("nodesListByDataBoxEdgeDevice", defaultConf);
    _serverIndices.insert("nodesListByDataBoxEdgeDevice", 0);
}
...
void OAINodesApi::nodesListByDataBoxEdgeDevice(const QString &device_name, const QString &subscription_id, const QString &resource_group_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["nodesListByDataBoxEdgeDevice"][_serverIndices.value("nodesListByDataBoxEdgeDevice")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/nodes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINodesApi::nodesListByDataBoxEdgeDeviceCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINodesApi::nodesListByDataBoxEdgeDeviceCallback);
...
void OAINodesApi::nodesListByDataBoxEdgeDeviceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT nodesListByDataBoxEdgeDeviceSignal(output);
        Q_EMIT nodesListByDataBoxEdgeDeviceSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT nodesListByDataBoxEdgeDeviceSignalE(output, error_type, error_str);
        Q_EMIT nodesListByDataBoxEdgeDeviceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT nodesListByDataBoxEdgeDeviceSignalError(output, error_type, error_str);
        Q_EMIT nodesListByDataBoxEdgeDeviceSignalErrorFull(worker, error_type, error_str);
    }
}
