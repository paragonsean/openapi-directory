...
void OAIJobProperties::initializeModel() {
    ...
    m_refreshed_entity_id_isSet = false;
    m_refreshed_entity_id_isValid = false;
...
void OAIJobProperties::fromJsonObject(QJsonObject json) {
    ...
    m_refreshed_entity_id_isValid = ::OpenAPI::fromJsonValue(m_refreshed_entity_id, json[QString("refreshedEntityId")]);
    m_refreshed_entity_id_isSet = !json[QString("refreshedEntityId")].isNull() && m_refreshed_entity_id_isValid;
...
QJsonObject OAIJobProperties::asJsonObject() const {
    ...
    if (m_refreshed_entity_id_isSet) {
        obj.insert(QString("refreshedEntityId"), ::OpenAPI::toJsonValue(m_refreshed_entity_id));
    }
...
QString OAIJobProperties::getRefreshedEntityId() const {
    return m_refreshed_entity_id;
}
void OAIJobProperties::setRefreshedEntityId(const QString &refreshed_entity_id) {
    m_refreshed_entity_id = refreshed_entity_id;
    m_refreshed_entity_id_isSet = true;
}

bool OAIJobProperties::is_refreshed_entity_id_Set() const{
    return m_refreshed_entity_id_isSet;
}

bool OAIJobProperties::is_refreshed_entity_id_Valid() const{
    return m_refreshed_entity_id_isValid;
}
