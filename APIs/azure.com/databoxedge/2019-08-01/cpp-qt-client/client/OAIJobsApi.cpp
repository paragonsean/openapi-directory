...
void OAIJobsApi::jobsGet(const QString &device_name, const QString &name, const QString &subscription_id, const QString &resource_group_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["jobsGet"][_serverIndices.value("jobsGet")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/jobs/{name}");
