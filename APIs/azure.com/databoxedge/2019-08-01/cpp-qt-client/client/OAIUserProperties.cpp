...
QString OAIUserProperties::getUserType() const {
    return m_user_type;
}
void OAIUserProperties::setUserType(const QString &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAIUserProperties::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAIUserProperties::is_user_type_Valid() const{
...
bool OAIUserProperties::isValid() const {
    ...
    return m_user_type_isValid && true;
}
