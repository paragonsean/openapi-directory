...
QString OAIContainer::getType() const {
    return m_type;
}
void OAIContainer::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIContainer::is_type_Set() const{
    return m_type_isSet;
}

bool OAIContainer::is_type_Valid() const{
