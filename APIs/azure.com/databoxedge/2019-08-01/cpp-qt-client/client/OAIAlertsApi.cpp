...
void OAIAlertsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("alertsGet", defaultConf);
    _serverIndices.insert("alertsGet", 0);
    _serverConfigs.insert("alertsListByDataBoxEdgeDevice", defaultConf);
    _serverIndices.insert("alertsListByDataBoxEdgeDevice", 0);
}
...
void OAIAlertsApi::alertsGet(const QString &device_name, const QString &name, const QString &subscription_id, const QString &resource_group_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["alertsGet"][_serverIndices.value("alertsGet")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/alerts/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::alertsGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::alertsGetCallback);
...
void OAIAlertsApi::alertsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT alertsGetSignal(output);
        Q_EMIT alertsGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT alertsGetSignalE(output, error_type, error_str);
        Q_EMIT alertsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT alertsGetSignalError(output, error_type, error_str);
        Q_EMIT alertsGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAlertsApi::alertsListByDataBoxEdgeDevice(const QString &device_name, const QString &subscription_id, const QString &resource_group_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["alertsListByDataBoxEdgeDevice"][_serverIndices.value("alertsListByDataBoxEdgeDevice")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/alerts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::alertsListByDataBoxEdgeDeviceCallback);
    connect(this, &OAIAlertsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::alertsListByDataBoxEdgeDeviceCallback);
    connect(this, &OAIAlertsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAlertsApi::alertsListByDataBoxEdgeDeviceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT alertsListByDataBoxEdgeDeviceSignal(output);
        Q_EMIT alertsListByDataBoxEdgeDeviceSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT alertsListByDataBoxEdgeDeviceSignalE(output, error_type, error_str);
        Q_EMIT alertsListByDataBoxEdgeDeviceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT alertsListByDataBoxEdgeDeviceSignalError(output, error_type, error_str);
        Q_EMIT alertsListByDataBoxEdgeDeviceSignalErrorFull(worker, error_type, error_str);
    }
}
