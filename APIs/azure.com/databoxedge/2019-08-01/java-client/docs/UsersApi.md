...
> UserList usersListByDataBoxEdgeDevice(deviceName, subscriptionId, resourceGroupName, apiVersion, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceGroupName = "resourceGroupName_example"; // String | The resource group name.
    String apiVersion = "apiVersion_example"; // String | The API version.
    String $filter = "$filter_example"; // String | Specify $filter='UserType eq <type>' to filter on user type property
    try {
      UserList result = apiInstance.usersListByDataBoxEdgeDevice(deviceName, subscriptionId, resourceGroupName, apiVersion, $filter);
      System.out.println(result);
    } catch (ApiException e) {
