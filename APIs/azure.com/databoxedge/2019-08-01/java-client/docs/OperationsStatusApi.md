...
import org.openapitools.client.api.OperationsStatusApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    OperationsStatusApi apiInstance = new OperationsStatusApi(defaultClient);
    ...
    try {
      Job result = apiInstance.operationsStatusGet(deviceName, name, subscriptionId, resourceGroupName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OperationsStatusApi#operationsStatusGet");
