...
|**folder** | **String** | If only subfolders need to be refreshed, then the subfolder path inside the share or container. (The path is empty if there are no subfolders.) |  [optional] |
...
|**refreshedEntityId** | **String** | ARM ID of the entity that was refreshed. |  [optional] [readonly] |
