...
public class JobProperties {
  ...
  public static final String SERIALIZED_NAME_REFRESHED_ENTITY_ID = "refreshedEntityId";
  @SerializedName(SERIALIZED_NAME_REFRESHED_ENTITY_ID)
   ...
   * @return refreshedEntityId
   */
  @javax.annotation.Nullable
  public String getRefreshedEntityId() {
    return refreshedEntityId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentStage, jobProperties.currentStage) &&
        ...
        Objects.equals(this.refreshedEntityId, jobProperties.refreshedEntityId) &&
        Objects.equals(this.totalRefreshErrors, jobProperties.totalRefreshErrors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentStage, downloadProgress, errorManifestFile, folder, installProgress, jobType, refreshedEntityId, totalRefreshErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("    refreshedEntityId: ").append(toIndentedString(refreshedEntityId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("refreshedEntityId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("refreshedEntityId") != null && !jsonObj.get("refreshedEntityId").isJsonNull()) && !jsonObj.get("refreshedEntityId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `refreshedEntityId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("refreshedEntityId").toString()));
      }
  }
