...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.OperationsList();
  });
  ...
  describe('OperationsList', function() {
    it('should create an instance of OperationsList', function() {
      // uncomment below and update the code to test OperationsList
      //var instance = new DataBoxEdgeManagementClient.OperationsList();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.OperationsList);
    });
