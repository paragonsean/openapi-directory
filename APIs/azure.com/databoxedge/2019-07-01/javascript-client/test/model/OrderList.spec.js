...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.OrderList();
  });
  ...
  describe('OrderList', function() {
    it('should create an instance of OrderList', function() {
      ...
      //var instance = new DataBoxEdgeManagementClient.OrderList();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.OrderList);
    });
