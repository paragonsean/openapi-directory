...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataBoxEdgeManagementClient.AlertErrorDetails();
  });
  ...
  describe('AlertErrorDetails', function() {
    it('should create an instance of AlertErrorDetails', function() {
      // uncomment below and update the code to test AlertErrorDetails
      //var instance = new DataBoxEdgeManagementClient.AlertErrorDetails();
      //expect(instance).to.be.a(DataBoxEdgeManagementClient.AlertErrorDetails);
    });
