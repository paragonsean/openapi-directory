...
let apiVersion = "apiVersion_example"; // String | The API version.
let opts = {
  'expand': "expand_example" // String | Specify $filter='CustomContextTag eq <tag>' to filter on custom context tag property
};
 ...
 **resourceGroupName** | **String**| The resource group name. | 
 **apiVersion** | **String**| The API version. | 
 **expand** | **String**| Specify $filter&#x3D;&#39;CustomContextTag eq &lt;tag&gt;&#39; to filter on custom context tag property | [optional] 
