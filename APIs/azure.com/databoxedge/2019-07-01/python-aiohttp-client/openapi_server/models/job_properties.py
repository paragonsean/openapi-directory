...
class JobProperties(Model):
    ...
    def __init__(self, current_stage: str=None, download_progress: UpdateDownloadProgress=None, error_manifest_file: str=None, folder: str=None, install_progress: UpdateInstallProgress=None, job_type: str=None, share_id: str=None, total_refresh_errors: int=None):
        ...
        :param share_id: The share_id of this JobProperties.
    ...
    def job_type(self, job_type):
        ...
        :type job_type: str
        """
        allowed_values = ["Invalid", "ScanForUpdates", "DownloadUpdates", "InstallUpdates", "RefreshShare"]  # noqa: E501
    ...
    @property
    def share_id(self):
        """Gets the share_id of this JobProperties.

        ARM ID of the share that was refreshed.

        :return: The share_id of this JobProperties.
        :rtype: str
        """
    ...
    def share_id(self, share_id):
        """Sets the share_id of this JobProperties.
