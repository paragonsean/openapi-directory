...
public class RoleList {
  ...
  private List<Role> value = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextLink, roleList.nextLink) &&
        Objects.equals(this.value, roleList.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            Role.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
