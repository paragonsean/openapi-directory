...
public class Node {
  ...
  public Node properties(NodeProperties properties) {
  ...
  public boolean equals(Object o) {
    ...
    Node node = (Node) o;
    return Objects.equals(this.properties, node.properties) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        NodeProperties.validateJsonElement(jsonObj.get("properties"));
      }
