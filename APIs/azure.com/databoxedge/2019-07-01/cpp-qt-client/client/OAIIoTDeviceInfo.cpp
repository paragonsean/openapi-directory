...
void OAIIoTDeviceInfo::initializeModel() {
    ...
    m_io_t_host_hub_id_isSet = false;
    m_io_t_host_hub_id_isValid = false;
}
...
void OAIIoTDeviceInfo::fromJsonObject(QJsonObject json) {
    ...
    m_io_t_host_hub_id_isValid = ::OpenAPI::fromJsonValue(m_io_t_host_hub_id, json[QString("ioTHostHubId")]);
    m_io_t_host_hub_id_isSet = !json[QString("ioTHostHubId")].isNull() && m_io_t_host_hub_id_isValid;
}
...
QJsonObject OAIIoTDeviceInfo::asJsonObject() const {
    ...
    if (m_io_t_host_hub_id_isSet) {
        obj.insert(QString("ioTHostHubId"), ::OpenAPI::toJsonValue(m_io_t_host_hub_id));
    }
    return obj;
}
...
QString OAIIoTDeviceInfo::getIoTHostHubId() const {
    return m_io_t_host_hub_id;
}
void OAIIoTDeviceInfo::setIoTHostHubId(const QString &io_t_host_hub_id) {
    m_io_t_host_hub_id = io_t_host_hub_id;
    m_io_t_host_hub_id_isSet = true;
}

bool OAIIoTDeviceInfo::is_io_t_host_hub_id_Set() const{
    return m_io_t_host_hub_id_isSet;
}

bool OAIIoTDeviceInfo::is_io_t_host_hub_id_Valid() const{
    return m_io_t_host_hub_id_isValid;
}
