...
public:
    ...
    */
    virtual void jobsGet(const QString &device_name, const QString &name, const QString &subscription_id, const QString &resource_group_name, const QString &api_version);
