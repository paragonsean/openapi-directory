...
qint32 OAIDataBoxEdgeDeviceProperties::getNodeCount() const {
    return m_node_count;
}
void OAIDataBoxEdgeDeviceProperties::setNodeCount(const qint32 &node_count) {
    m_node_count = node_count;
    m_node_count_isSet = true;
}

bool OAIDataBoxEdgeDeviceProperties::is_node_count_Set() const{
    return m_node_count_isSet;
}

bool OAIDataBoxEdgeDeviceProperties::is_node_count_Valid() const{
