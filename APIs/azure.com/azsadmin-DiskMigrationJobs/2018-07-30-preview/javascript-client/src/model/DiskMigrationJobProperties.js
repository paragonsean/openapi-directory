...
/**
 * The DiskMigrationJobProperties model module.
 * @module model/DiskMigrationJobProperties
 * @version 2018-07-30-preview
 */
class DiskMigrationJobProperties {
    /**
     * Constructs a new <code>DiskMigrationJobProperties</code>.
     * Disk migration job properties.
     * @alias module:model/DiskMigrationJobProperties
     */
    constructor() { 
        
        DiskMigrationJobProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DiskMigrationJobProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DiskMigrationJobProperties} obj Optional instance to populate.
     * @return {module:model/DiskMigrationJobProperties} The populated <code>DiskMigrationJobProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DiskMigrationJobProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>DiskMigrationJobProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DiskMigrationJobProperties</code>.
     */
 ...
 */
DiskMigrationJobProperties.prototype['creationTime'] = undefined;

/**
 * The job end time.
 * @member {Date} endTime
 */
DiskMigrationJobProperties.prototype['endTime'] = undefined;

/**
 * The disk migration id.
 * @member {String} migrationId
 */
DiskMigrationJobProperties.prototype['migrationId'] = undefined;

/**
 * The job start time.
 * @member {Date} startTime
 */
DiskMigrationJobProperties.prototype['startTime'] = undefined;

/**
 * Migration job status.
 * @member {module:model/DiskMigrationJobProperties.StatusEnum} status
 */
DiskMigrationJobProperties.prototype['status'] = undefined;
 ...
 */
DiskMigrationJobProperties.prototype['subtasks'] = undefined;

/**
 * The target share of migration job.
 * @member {String} targetShare
 */
DiskMigrationJobProperties.prototype['targetShare'] = undefined;
 ...
 * @readonly
 */
DiskMigrationJobProperties['StatusEnum'] = {
...
export default DiskMigrationJobProperties;
