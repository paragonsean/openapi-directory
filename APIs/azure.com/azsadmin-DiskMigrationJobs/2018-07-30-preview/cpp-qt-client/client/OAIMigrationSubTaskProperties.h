...
/*
 * OAIMigrationSubTaskProperties.h
 *
 * Disk migration child task properties.
 */

#ifndef OAIMigrationSubTaskProperties_H
#define OAIMigrationSubTaskProperties_H
...
class OAIMigrationSubTaskProperties : public OAIObject {
public:
    OAIMigrationSubTaskProperties();
    OAIMigrationSubTaskProperties(QString json);
    ~OAIMigrationSubTaskProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMigrationSubTaskProperties)

#endif // OAIMigrationSubTaskProperties_H
