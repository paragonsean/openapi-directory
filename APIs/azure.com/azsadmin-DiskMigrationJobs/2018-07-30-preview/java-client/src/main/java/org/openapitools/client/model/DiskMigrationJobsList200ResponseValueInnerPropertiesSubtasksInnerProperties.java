...
public class DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties {
  ...
  public DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties() {
  }
  ...
  public DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties migrationSubtaskStatus(MigrationSubtaskStatusEnum migrationSubtaskStatus) {
  ...
  public DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties targetDiskStateForMigration(TargetDiskStateForMigrationEnum targetDiskStateForMigration) {
  ...
  public boolean equals(Object o) {
    ...
    DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties = (DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties) o;
    return Objects.equals(this.diskId, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.diskId) &&
        Objects.equals(this.endTime, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.endTime) &&
        Objects.equals(this.migrationSubtaskStatus, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.migrationSubtaskStatus) &&
        Objects.equals(this.reason, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.reason) &&
        Objects.equals(this.sourceShare, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.sourceShare) &&
        Objects.equals(this.startTime, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.startTime) &&
        Objects.equals(this.targetDiskStateForMigration, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.targetDiskStateForMigration) &&
        Objects.equals(this.targetShare, diskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.targetShare);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties is not found in the empty JSON string", DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties>() {
           @Override
           public void write(JsonWriter out, DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties
   * @throws IOException if the JSON string is invalid with respect to DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties
   */
  public static DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties.class);
  }

  /**
   * Convert an instance of DiskMigrationJobsList200ResponseValueInnerPropertiesSubtasksInnerProperties to an JSON string
   *
   * @return JSON string
   */
