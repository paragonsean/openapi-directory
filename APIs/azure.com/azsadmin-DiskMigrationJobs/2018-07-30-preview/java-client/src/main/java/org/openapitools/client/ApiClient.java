...
public class ApiClient {
    ...
    private String basePath = "https://adminmanagement.local.azurestack.external";
    ...
    public ApiClient() {
        ...
        authentications.put("azure_auth", new OAuth());
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-07-30-preview/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://adminmanagement.local.azurestack.external
