...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("policyMetadataGetResource", defaultConf);
    _serverIndices.insert("policyMetadataGetResource", 0);
    _serverConfigs.insert("policyMetadataList", defaultConf);
    _serverIndices.insert("policyMetadataList", 0);
}
...
void OAIDefaultApi::policyMetadataGetResource(const QString &resource_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["policyMetadataGetResource"][_serverIndices.value("policyMetadataGetResource")].URL()+"/providers/Microsoft.PolicyInsights/policyMetadata/{resourceName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::policyMetadataGetResourceCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::policyMetadataGetResourceCallback);
...
void OAIDefaultApi::policyMetadataGetResourceCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPolicyMetadata output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT policyMetadataGetResourceSignal(output);
        Q_EMIT policyMetadataGetResourceSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT policyMetadataGetResourceSignalE(output, error_type, error_str);
        Q_EMIT policyMetadataGetResourceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT policyMetadataGetResourceSignalError(output, error_type, error_str);
        Q_EMIT policyMetadataGetResourceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::policyMetadataList(const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &top) {
    QString fullPath = QString(_serverConfigs["policyMetadataList"][_serverIndices.value("policyMetadataList")].URL()+"/providers/Microsoft.PolicyInsights/policyMetadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::policyMetadataListCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::policyMetadataListCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::policyMetadataListCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIPolicyMetadataCollection output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT policyMetadataListSignal(output);
        Q_EMIT policyMetadataListSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT policyMetadataListSignalE(output, error_type, error_str);
        Q_EMIT policyMetadataListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT policyMetadataListSignalError(output, error_type, error_str);
        Q_EMIT policyMetadataListSignalErrorFull(worker, error_type, error_str);
    }
}
