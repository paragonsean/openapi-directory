# ApiManagementClient.PolicyDescriptionApi
...
> PolicyDescriptionListByService200Response policyDescriptionListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
...
let apiInstance = new ApiManagementClient.PolicyDescriptionApi();
...
apiInstance.policyDescriptionListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
