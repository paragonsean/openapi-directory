...
export default class ProductGroupsApi {
    ...
    */
     ...
     * @callback module:api/ProductGroupsApi~productGroupCheckEntityExistsCallback
     ...
     * @param {module:api/ProductGroupsApi~productGroupCheckEntityExistsCallback} callback The callback function, accepting three arguments: error, data, response
     */
