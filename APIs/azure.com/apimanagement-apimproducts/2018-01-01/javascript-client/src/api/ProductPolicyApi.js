...
export default class ProductPolicyApi {
    ...
    */
     ...
     * data is of type: {@link module:model/ProductPolicyGet200Response}
     */
    productPolicyGet(resourceGroupName, serviceName, apiVersion, subscriptionId, productId, policyId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
     ...
     */
    productPolicyGetEntityTag(resourceGroupName, serviceName, apiVersion, subscriptionId, productId, policyId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
     ...
     */
    productPolicyListByProduct(resourceGroupName, serviceName, apiVersion, subscriptionId, productId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
