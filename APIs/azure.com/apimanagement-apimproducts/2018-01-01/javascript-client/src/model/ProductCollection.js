...
class ProductCollection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = ApiClient.convertToType(data['value'], [ProductContract]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProductCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCollection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['value']) { // data not null
            ...
            for (const item of data['value']) {
                ProductContract.validateJSON(item);
            };
        }
 ...
 */
ProductCollection.prototype['nextLink'] = undefined;

/**
 * Page values.
 * @member {Array.<module:model/ProductContract>} value
 */
ProductCollection.prototype['value'] = undefined;
