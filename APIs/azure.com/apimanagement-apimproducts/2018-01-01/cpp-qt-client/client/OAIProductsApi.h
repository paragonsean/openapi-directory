...
public:
    ...
    */
    virtual void productCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &product_id, const QString &api_version, const QString &subscription_id, const OAIProductContract &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void productUpdate(const QString &resource_group_name, const QString &service_name, const QString &product_id, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAIProductUpdateParameters &parameters);
...
Q_SIGNALS:
    ...
    void productListByServiceSignal(OAIProductCollection summary);
    ...
    void productListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIProductCollection summary);
    ...
    void productListByServiceSignalE(OAIProductCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void productListByServiceSignalError(OAIProductCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
