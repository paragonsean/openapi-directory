...
public:
    ...
    * @param[in]  policy_id QString [required]
    */
    virtual void productPolicyGet(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &product_id, const QString &policy_id);
    ...
    * @param[in]  policy_id QString [required]
    */
    virtual void productPolicyGetEntityTag(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &product_id, const QString &policy_id);
    ...
    * @param[in]  product_id QString [required]
    */
    virtual void productPolicyListByProduct(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const QString &product_id);
