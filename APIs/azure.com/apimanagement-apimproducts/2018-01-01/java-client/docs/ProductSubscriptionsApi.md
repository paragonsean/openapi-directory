...
> ProductSubscriptionsList200Response productSubscriptionsList(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, $filter, $top, $skip)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProductSubscriptionsList200Response result = apiInstance.productSubscriptionsList(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, $filter, $top, $skip);
