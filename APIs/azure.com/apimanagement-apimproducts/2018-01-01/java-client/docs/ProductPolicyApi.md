...
public class Example {
  public static void main(String[] args) {
    ...
    String policyId = "policy"; // String | The identifier of the Policy.
    try {
      ProductPolicyGet200Response result = apiInstance.productPolicyGet(resourceGroupName, serviceName, apiVersion, subscriptionId, productId, policyId);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String policyId = "policy"; // String | The identifier of the Policy.
    try {
      apiInstance.productPolicyGetEntityTag(resourceGroupName, serviceName, apiVersion, subscriptionId, productId, policyId);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String productId = "productId_example"; // String | Product identifier. Must be unique in the current API Management service instance.
    try {
      ProductPolicyListByProduct200Response result = apiInstance.productPolicyListByProduct(resourceGroupName, serviceName, apiVersion, subscriptionId, productId);
      System.out.println(result);
    } catch (ApiException e) {
