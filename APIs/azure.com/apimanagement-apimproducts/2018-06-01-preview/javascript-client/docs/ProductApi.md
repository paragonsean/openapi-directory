...
> ProductGet200Response productCreateOrUpdate(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, parameters, opts)
...
let apiInstance = new ApiManagementClient.ProductApi();
...
let parameters = new ApiManagementClient.ProductGet200Response(); // ProductGet200Response | Create or update parameters.
let opts = {
...
> ProductListByService200Response productListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
...
let opts = {
  ...
  'tags': "tags_example" // String | Products which are part of a specific tag.
};
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let parameters = new ApiManagementClient.ProductUpdateRequest(); // ProductUpdateRequest | Update parameters.
