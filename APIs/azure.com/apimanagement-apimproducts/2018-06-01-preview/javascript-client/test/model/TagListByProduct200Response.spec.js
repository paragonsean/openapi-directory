...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.TagListByProduct200Response();
  });
  ...
  describe('TagListByProduct200Response', function() {
    it('should create an instance of TagListByProduct200Response', function() {
      // uncomment below and update the code to test TagListByProduct200Response
      //var instance = new ApiManagementClient.TagListByProduct200Response();
      //expect(instance).to.be.a(ApiManagementClient.TagListByProduct200Response);
    });
