...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ProductCollection();
  });
  ...
  describe('ProductCollection', function() {
    it('should create an instance of ProductCollection', function() {
      ...
      //var instance = new ApiManagementClient.ProductCollection();
      //expect(instance).to.be.a(ApiManagementClient.ProductCollection);
    });
