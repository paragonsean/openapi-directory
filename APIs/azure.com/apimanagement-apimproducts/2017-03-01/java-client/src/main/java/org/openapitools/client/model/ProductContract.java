...
public class ProductContract {
  ...
  public ProductContract id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productContract.id) &&
        Objects.equals(this.name, productContract.name) &&
        Objects.equals(this.approvalRequired, productContract.approvalRequired) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, approvalRequired, description, state, subscriptionRequired, subscriptionsLimit, terms);
  }
