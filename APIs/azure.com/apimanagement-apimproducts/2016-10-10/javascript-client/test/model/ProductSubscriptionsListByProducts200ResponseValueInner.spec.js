...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ProductSubscriptionsListByProducts200ResponseValueInner();
  });
  ...
  describe('ProductSubscriptionsListByProducts200ResponseValueInner', function() {
    it('should create an instance of ProductSubscriptionsListByProducts200ResponseValueInner', function() {
      // uncomment below and update the code to test ProductSubscriptionsListByProducts200ResponseValueInner
      //var instance = new ApiManagementClient.ProductSubscriptionsListByProducts200ResponseValueInner();
      //expect(instance).to.be.a(ApiManagementClient.ProductSubscriptionsListByProducts200ResponseValueInner);
    });
