...
> ProductSubscriptionsListByProducts200Response productSubscriptionsListByProducts(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, opts)
...
apiInstance.productSubscriptionsListByProducts(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
