...
apiInstance.productGroupsCreate(resourceGroupName, serviceName, productId, groupId, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
apiInstance.productGroupsDelete(resourceGroupName, serviceName, productId, groupId, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> ProductGroupsListByProducts200Response productGroupsListByProducts(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, opts)
...
apiInstance.productGroupsListByProducts(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
