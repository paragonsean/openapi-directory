...
async def products_create_or_update(request: web.Request, resource_group_name, service_name, product_id, api_version, subscription_id, parameters) -> web.Response:
...
async def products_delete(request: web.Request, resource_group_name, service_name, product_id, if_match, api_version, subscription_id, delete_subscriptions=None) -> web.Response:
    """products_delete
...
async def products_get(request: web.Request, resource_group_name, service_name, product_id, api_version, subscription_id) -> web.Response:
    """products_get
...
async def products_list_by_service(request: web.Request, resource_group_name, service_name, api_version, subscription_id, filter=None, top=None, skip=None, expand_groups=None) -> web.Response:
...
async def products_update(request: web.Request, resource_group_name, service_name, product_id, if_match, api_version, subscription_id, parameters) -> web.Response:
    """products_update
