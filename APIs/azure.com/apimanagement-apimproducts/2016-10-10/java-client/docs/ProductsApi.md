...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.productsCreateOrUpdate(resourceGroupName, serviceName, productId, apiVersion, subscriptionId, parameters);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductsApi#productsCreateOrUpdate");
...
# **productsDelete**
> productsDelete(resourceGroupName, serviceName, productId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.productsDelete(resourceGroupName, serviceName, productId, ifMatch, apiVersion, subscriptionId, deleteSubscriptions);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    try {
      ProductContract result = apiInstance.productsGet(resourceGroupName, serviceName, productId, apiVersion, subscriptionId);
...
<a id="productsListByService"></a>
# **productsListByService**
> ProductCollection productsListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip, expandGroups)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProductCollection result = apiInstance.productsListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, $filter, $top, $skip, expandGroups);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductsApi#productsListByService");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.productsUpdate(resourceGroupName, serviceName, productId, ifMatch, apiVersion, subscriptionId, parameters);
    } catch (ApiException e) {
