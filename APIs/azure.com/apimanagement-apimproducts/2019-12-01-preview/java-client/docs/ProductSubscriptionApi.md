...
import org.openapitools.client.api.ProductSubscriptionApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProductSubscriptionApi apiInstance = new ProductSubscriptionApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling ProductSubscriptionApi#productSubscriptionsList");
