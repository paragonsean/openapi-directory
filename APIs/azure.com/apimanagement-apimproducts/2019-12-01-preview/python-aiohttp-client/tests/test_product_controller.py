...
async def test_product_create_or_update(client):
    ...
    """
    parameters = openapi_server.ProductGet200Response()
...
async def test_product_get_entity_tag(client):
...
async def test_product_list_by_service(client):
...
async def test_product_update(client):
    ...
    """
    parameters = openapi_server.ProductUpdateRequest()
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
