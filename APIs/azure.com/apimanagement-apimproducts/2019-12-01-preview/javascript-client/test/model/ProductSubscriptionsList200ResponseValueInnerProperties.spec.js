...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.ProductSubscriptionsList200ResponseValueInnerProperties();
  });
  ...
  describe('ProductSubscriptionsList200ResponseValueInnerProperties', function() {
    it('should create an instance of ProductSubscriptionsList200ResponseValueInnerProperties', function() {
      // uncomment below and update the code to test ProductSubscriptionsList200ResponseValueInnerProperties
      //var instance = new ApiManagementClient.ProductSubscriptionsList200ResponseValueInnerProperties();
      //expect(instance).to.be.a(ApiManagementClient.ProductSubscriptionsList200ResponseValueInnerProperties);
    });
