...
class SiteLimits(Model):
    ...
    def __init__(self, max_disk_size_in_mb: int=None, max_memory_in_mb: int=None, max_percentage_cpu: float=None):
        """SiteLimits - a model defined in OpenAPI

        :param max_disk_size_in_mb: The max_disk_size_in_mb of this SiteLimits.
        :param max_memory_in_mb: The max_memory_in_mb of this SiteLimits.
        :param max_percentage_cpu: The max_percentage_cpu of this SiteLimits.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SiteLimits':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SiteLimits of this SiteLimits.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_disk_size_in_mb(self):
        """Gets the max_disk_size_in_mb of this SiteLimits.

        Maximum allowed disk size usage in MB

        :return: The max_disk_size_in_mb of this SiteLimits.
        :rtype: int
        """
    ...
    def max_disk_size_in_mb(self, max_disk_size_in_mb):
        """Sets the max_disk_size_in_mb of this SiteLimits.
    ...
    def max_memory_in_mb(self):
        """Gets the max_memory_in_mb of this SiteLimits.

        Maximum allowed memory usage in MB

        :return: The max_memory_in_mb of this SiteLimits.
        :rtype: int
        """
    ...
    def max_memory_in_mb(self, max_memory_in_mb):
        """Sets the max_memory_in_mb of this SiteLimits.
    ...
    def max_percentage_cpu(self):
        """Gets the max_percentage_cpu of this SiteLimits.

        Maximum allowed CPU usage percentage

        :return: The max_percentage_cpu of this SiteLimits.
        :rtype: float
        """
    ...
    def max_percentage_cpu(self, max_percentage_cpu):
        """Sets the max_percentage_cpu of this SiteLimits.
