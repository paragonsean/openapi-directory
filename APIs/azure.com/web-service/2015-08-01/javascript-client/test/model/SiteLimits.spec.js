...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.SiteLimits();
  });
  ...
  describe('SiteLimits', function() {
    it('should create an instance of SiteLimits', function() {
      // uncomment below and update the code to test SiteLimits
      //var instance = new WebSiteManagementClient.SiteLimits();
      //expect(instance).to.be.a(WebSiteManagementClient.SiteLimits);
    });
