...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.GeoRegionCollection();
  });
  ...
  describe('GeoRegionCollection', function() {
    it('should create an instance of GeoRegionCollection', function() {
      ...
      //var instance = new WebSiteManagementClient.GeoRegionCollection();
      //expect(instance).to.be.a(WebSiteManagementClient.GeoRegionCollection);
    });
