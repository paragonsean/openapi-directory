...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new WebSiteManagementClient.Resource();
      //expect(instance).to.be.a(WebSiteManagementClient.Resource);
    });
