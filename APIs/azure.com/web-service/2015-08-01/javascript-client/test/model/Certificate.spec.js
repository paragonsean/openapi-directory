...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.Certificate();
  });
  ...
  describe('Certificate', function() {
    it('should create an instance of Certificate', function() {
      ...
      //var instance = new WebSiteManagementClient.Certificate();
      //expect(instance).to.be.a(WebSiteManagementClient.Certificate);
    });
