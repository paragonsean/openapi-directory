...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.SkuDescription();
  });
  ...
  describe('SkuDescription', function() {
    it('should create an instance of SkuDescription', function() {
      ...
      //var instance = new WebSiteManagementClient.SkuDescription();
      //expect(instance).to.be.a(WebSiteManagementClient.SkuDescription);
    });
