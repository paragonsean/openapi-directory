...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.Deployment();
  });
  ...
  describe('Deployment', function() {
    it('should create an instance of Deployment', function() {
      ...
      //var instance = new WebSiteManagementClient.Deployment();
      //expect(instance).to.be.a(WebSiteManagementClient.Deployment);
    });
