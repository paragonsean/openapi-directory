...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.AutoHealRules();
  });
  ...
  describe('AutoHealRules', function() {
    it('should create an instance of AutoHealRules', function() {
      // uncomment below and update the code to test AutoHealRules
      //var instance = new WebSiteManagementClient.AutoHealRules();
      //expect(instance).to.be.a(WebSiteManagementClient.AutoHealRules);
    });
