...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.ResourceMetricValue();
  });
  ...
  describe('ResourceMetricValue', function() {
    it('should create an instance of ResourceMetricValue', function() {
      // uncomment below and update the code to test ResourceMetricValue
      //var instance = new WebSiteManagementClient.ResourceMetricValue();
      //expect(instance).to.be.a(WebSiteManagementClient.ResourceMetricValue);
    });
