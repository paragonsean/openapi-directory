...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSiteManagementClient.CsmMoveResourceEnvelope();
  });
  ...
  describe('CsmMoveResourceEnvelope', function() {
    it('should create an instance of CsmMoveResourceEnvelope', function() {
      ...
      //var instance = new WebSiteManagementClient.CsmMoveResourceEnvelope();
      //expect(instance).to.be.a(WebSiteManagementClient.CsmMoveResourceEnvelope);
    });
