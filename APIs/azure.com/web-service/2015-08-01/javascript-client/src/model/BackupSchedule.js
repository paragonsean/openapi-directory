...
class BackupSchedule {
     ...
     * @param frequencyUnit {module:model/BackupSchedule.FrequencyUnitEnum} How often should be the backup executed (e.g. for weekly backup, this should be set to Day and FrequencyInterval should be set to 7)
     */
    constructor(frequencyUnit) { 
        
        BackupSchedule.initialize(this, frequencyUnit);
    }
     ...
     */
    static initialize(obj, frequencyUnit) { 
...
BackupSchedule.RequiredProperties = ["frequencyUnit"];
 ...
 */
BackupSchedule.prototype['frequencyInterval'] = undefined;
 ...
 */
BackupSchedule.prototype['frequencyUnit'] = undefined;

/**
 * True if the retention policy should always keep at least one backup in the storage account, regardless how old it is; false otherwise.
 * @member {Boolean} keepAtLeastOneBackup
 */
BackupSchedule.prototype['keepAtLeastOneBackup'] = undefined;
 ...
 */
BackupSchedule.prototype['retentionPeriodInDays'] = undefined;
