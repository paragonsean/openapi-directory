...
import AutoHealRules from './AutoHealRules';
import ConnStringInfo from './ConnStringInfo';
import CorsSettings from './CorsSettings';
import Experiments from './Experiments';
import HandlerMapping from './HandlerMapping';
import IpSecurityRestriction from './IpSecurityRestriction';
import NameValuePair from './NameValuePair';
import Resource from './Resource';
import SiteLimits from './SiteLimits';
import VirtualApplication from './VirtualApplication';
...
class SiteConfig {
    ...
    constructor(location) { 
        ...
        SiteConfig.initialize(this, location);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of SiteConfig.RequiredProperties) {
...
SiteConfig.RequiredProperties = ["location"];

/**
 * @member {Object} properties
 */
SiteConfig.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
SiteConfig.prototype['id'] = undefined;

/**
 * Kind of resource
 * @member {String} kind
 */
SiteConfig.prototype['kind'] = undefined;

/**
 * Resource Location
 * @member {String} location
 */
SiteConfig.prototype['location'] = undefined;

/**
 * Resource Name
 * @member {String} name
 */
SiteConfig.prototype['name'] = undefined;

/**
 * Resource tags
 * @member {Object.<String, String>} tags
 */
SiteConfig.prototype['tags'] = undefined;

/**
 * Resource type
 * @member {String} type
 */
SiteConfig.prototype['type'] = undefined;
