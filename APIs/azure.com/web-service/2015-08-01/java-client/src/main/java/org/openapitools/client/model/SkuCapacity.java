...
public class SkuCapacity {
  ...
  public SkuCapacity _default(Integer _default) {
  ...
  public SkuCapacity maximum(Integer maximum) {
  ...
  public SkuCapacity minimum(Integer minimum) {
  ...
  public SkuCapacity scaleType(String scaleType) {
