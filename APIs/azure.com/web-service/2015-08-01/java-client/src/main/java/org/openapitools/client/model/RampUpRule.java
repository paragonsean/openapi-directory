...
public class RampUpRule {
  ...
  public RampUpRule actionHostName(String actionHostName) {
  ...
  public RampUpRule changeDecisionCallbackUrl(String changeDecisionCallbackUrl) {
  ...
  public RampUpRule changeIntervalInMinutes(Integer changeIntervalInMinutes) {
  ...
  public RampUpRule changeStep(Double changeStep) {
  ...
  public RampUpRule maxReroutePercentage(Double maxReroutePercentage) {
  ...
  public RampUpRule minReroutePercentage(Double minReroutePercentage) {
  ...
  public RampUpRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RampUpRule reroutePercentage(Double reroutePercentage) {
  ...
  public boolean equals(Object o) {
    ...
    RampUpRule rampUpRule = (RampUpRule) o;
    return Objects.equals(this.actionHostName, rampUpRule.actionHostName) &&
        Objects.equals(this.changeDecisionCallbackUrl, rampUpRule.changeDecisionCallbackUrl) &&
        Objects.equals(this.changeIntervalInMinutes, rampUpRule.changeIntervalInMinutes) &&
        Objects.equals(this.changeStep, rampUpRule.changeStep) &&
        Objects.equals(this.maxReroutePercentage, rampUpRule.maxReroutePercentage) &&
        Objects.equals(this.minReroutePercentage, rampUpRule.minReroutePercentage) &&
        Objects.equals(this.name, rampUpRule.name) &&
        Objects.equals(this.reroutePercentage, rampUpRule.reroutePercentage);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RampUpRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RampUpRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RampUpRule is not found in the empty JSON string", RampUpRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RampUpRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RampUpRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RampUpRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RampUpRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RampUpRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RampUpRule.class));

       return (TypeAdapter<T>) new TypeAdapter<RampUpRule>() {
           @Override
           public void write(JsonWriter out, RampUpRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RampUpRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RampUpRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RampUpRule
   * @throws IOException if the JSON string is invalid with respect to RampUpRule
   */
  public static RampUpRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RampUpRule.class);
  }

  /**
   * Convert an instance of RampUpRule to an JSON string
   *
   * @return JSON string
   */
