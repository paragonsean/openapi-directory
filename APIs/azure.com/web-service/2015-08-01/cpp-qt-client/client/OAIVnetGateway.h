...
#ifndef OAIVnetGateway_H
#define OAIVnetGateway_H
...
class OAIVnetGateway : public OAIObject {
public:
    OAIVnetGateway();
    OAIVnetGateway(QString json);
    ~OAIVnetGateway() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVnetGateway)

#endif // OAIVnetGateway_H
