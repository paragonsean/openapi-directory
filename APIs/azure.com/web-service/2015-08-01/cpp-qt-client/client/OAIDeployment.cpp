...
QMap<QString, QString> OAIDeployment::getTags() const {
    return m_tags;
}
void OAIDeployment::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDeployment::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDeployment::is_tags_Valid() const{
