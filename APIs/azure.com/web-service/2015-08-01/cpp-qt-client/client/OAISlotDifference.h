...
#ifndef OAISlotDifference_H
#define OAISlotDifference_H
...
class OAISlotDifference : public OAIObject {
public:
    OAISlotDifference();
    OAISlotDifference(QString json);
    ~OAISlotDifference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlotDifference)

#endif // OAISlotDifference_H
