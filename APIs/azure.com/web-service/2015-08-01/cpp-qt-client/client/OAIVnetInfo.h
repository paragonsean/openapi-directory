...
#ifndef OAIVnetInfo_H
#define OAIVnetInfo_H
...
class OAIVnetInfo : public OAIObject {
public:
    OAIVnetInfo();
    OAIVnetInfo(QString json);
    ~OAIVnetInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVnetInfo)
