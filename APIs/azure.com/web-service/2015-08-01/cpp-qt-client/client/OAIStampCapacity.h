...
#ifndef OAIStampCapacity_H
#define OAIStampCapacity_H
...
class OAIStampCapacity : public OAIObject {
public:
    OAIStampCapacity();
    OAIStampCapacity(QString json);
    ~OAIStampCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStampCapacity)

#endif // OAIStampCapacity_H
