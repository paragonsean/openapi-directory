...
#ifndef OAICloningInfo_H
#define OAICloningInfo_H
...
class OAICloningInfo : public OAIObject {
public:
    OAICloningInfo();
    OAICloningInfo(QString json);
    ~OAICloningInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloningInfo)

#endif // OAICloningInfo_H
