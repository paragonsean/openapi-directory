...
/*
 * OAIVirtualApplication.h
 *
 * 
 */

#ifndef OAIVirtualApplication_H
#define OAIVirtualApplication_H
...
namespace OpenAPI {
class OAIVirtualDirectory;

class OAIVirtualApplication : public OAIObject {
public:
    OAIVirtualApplication();
    OAIVirtualApplication(QString json);
    ~OAIVirtualApplication() override;
    ...
    QList<OAIVirtualDirectory> getVirtualDirectories() const;
    void setVirtualDirectories(const QList<OAIVirtualDirectory> &virtual_directories);
...
private:
    ...
    QList<OAIVirtualDirectory> m_virtual_directories;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualApplication)

#endif // OAIVirtualApplication_H
