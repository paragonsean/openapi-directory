...
OAICloningInfo::OAICloningInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICloningInfo::OAICloningInfo() {
    this->initializeModel();
}

OAICloningInfo::~OAICloningInfo() {}

void OAICloningInfo::initializeModel() {
...
void OAICloningInfo::fromJson(QString jsonString) {
...
void OAICloningInfo::fromJsonObject(QJsonObject json) {
...
QString OAICloningInfo::asJson() const {
...
QJsonObject OAICloningInfo::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, QString> OAICloningInfo::getAppSettingsOverrides() const {
    return m_app_settings_overrides;
}
void OAICloningInfo::setAppSettingsOverrides(const QMap<QString, QString> &app_settings_overrides) {
    m_app_settings_overrides = app_settings_overrides;
    m_app_settings_overrides_isSet = true;
}

bool OAICloningInfo::is_app_settings_overrides_Set() const{
    return m_app_settings_overrides_isSet;
}

bool OAICloningInfo::is_app_settings_overrides_Valid() const{
    return m_app_settings_overrides_isValid;
}

bool OAICloningInfo::isCloneCustomHostNames() const {
    return m_clone_custom_host_names;
}
void OAICloningInfo::setCloneCustomHostNames(const bool &clone_custom_host_names) {
    m_clone_custom_host_names = clone_custom_host_names;
    m_clone_custom_host_names_isSet = true;
}

bool OAICloningInfo::is_clone_custom_host_names_Set() const{
    return m_clone_custom_host_names_isSet;
}

bool OAICloningInfo::is_clone_custom_host_names_Valid() const{
    return m_clone_custom_host_names_isValid;
}

bool OAICloningInfo::isCloneSourceControl() const {
    return m_clone_source_control;
}
void OAICloningInfo::setCloneSourceControl(const bool &clone_source_control) {
    m_clone_source_control = clone_source_control;
    m_clone_source_control_isSet = true;
}

bool OAICloningInfo::is_clone_source_control_Set() const{
    return m_clone_source_control_isSet;
}

bool OAICloningInfo::is_clone_source_control_Valid() const{
    return m_clone_source_control_isValid;
}

bool OAICloningInfo::isConfigureLoadBalancing() const {
    return m_configure_load_balancing;
}
void OAICloningInfo::setConfigureLoadBalancing(const bool &configure_load_balancing) {
    m_configure_load_balancing = configure_load_balancing;
    m_configure_load_balancing_isSet = true;
}

bool OAICloningInfo::is_configure_load_balancing_Set() const{
    return m_configure_load_balancing_isSet;
}

bool OAICloningInfo::is_configure_load_balancing_Valid() const{
    return m_configure_load_balancing_isValid;
}

QString OAICloningInfo::getCorrelationId() const {
    return m_correlation_id;
}
void OAICloningInfo::setCorrelationId(const QString &correlation_id) {
    m_correlation_id = correlation_id;
    m_correlation_id_isSet = true;
}

bool OAICloningInfo::is_correlation_id_Set() const{
    return m_correlation_id_isSet;
}

bool OAICloningInfo::is_correlation_id_Valid() const{
    return m_correlation_id_isValid;
}

QString OAICloningInfo::getHostingEnvironment() const {
    return m_hosting_environment;
}
void OAICloningInfo::setHostingEnvironment(const QString &hosting_environment) {
    m_hosting_environment = hosting_environment;
    m_hosting_environment_isSet = true;
}

bool OAICloningInfo::is_hosting_environment_Set() const{
    return m_hosting_environment_isSet;
}

bool OAICloningInfo::is_hosting_environment_Valid() const{
    return m_hosting_environment_isValid;
}

bool OAICloningInfo::isOverwrite() const {
    return m_overwrite;
}
void OAICloningInfo::setOverwrite(const bool &overwrite) {
    m_overwrite = overwrite;
    m_overwrite_isSet = true;
}

bool OAICloningInfo::is_overwrite_Set() const{
    return m_overwrite_isSet;
}

bool OAICloningInfo::is_overwrite_Valid() const{
    return m_overwrite_isValid;
}

QString OAICloningInfo::getSourceWebAppId() const {
    return m_source_web_app_id;
}
void OAICloningInfo::setSourceWebAppId(const QString &source_web_app_id) {
    m_source_web_app_id = source_web_app_id;
    m_source_web_app_id_isSet = true;
}

bool OAICloningInfo::is_source_web_app_id_Set() const{
    return m_source_web_app_id_isSet;
}

bool OAICloningInfo::is_source_web_app_id_Valid() const{
    return m_source_web_app_id_isValid;
}

QString OAICloningInfo::getTrafficManagerProfileId() const {
    return m_traffic_manager_profile_id;
}
void OAICloningInfo::setTrafficManagerProfileId(const QString &traffic_manager_profile_id) {
    m_traffic_manager_profile_id = traffic_manager_profile_id;
    m_traffic_manager_profile_id_isSet = true;
}

bool OAICloningInfo::is_traffic_manager_profile_id_Set() const{
    return m_traffic_manager_profile_id_isSet;
}

bool OAICloningInfo::is_traffic_manager_profile_id_Valid() const{
    return m_traffic_manager_profile_id_isValid;
}

QString OAICloningInfo::getTrafficManagerProfileName() const {
    return m_traffic_manager_profile_name;
}
void OAICloningInfo::setTrafficManagerProfileName(const QString &traffic_manager_profile_name) {
    m_traffic_manager_profile_name = traffic_manager_profile_name;
    m_traffic_manager_profile_name_isSet = true;
}

bool OAICloningInfo::is_traffic_manager_profile_name_Set() const{
    return m_traffic_manager_profile_name_isSet;
}

bool OAICloningInfo::is_traffic_manager_profile_name_Valid() const{
    return m_traffic_manager_profile_name_isValid;
}

bool OAICloningInfo::isSet() const {
...
bool OAICloningInfo::isValid() const {
