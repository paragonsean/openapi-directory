...
#ifndef OAIConnStringInfo_H
#define OAIConnStringInfo_H
...
class OAIConnStringInfo : public OAIObject {
public:
    OAIConnStringInfo();
    OAIConnStringInfo(QString json);
    ~OAIConnStringInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnStringInfo)

#endif // OAIConnStringInfo_H
