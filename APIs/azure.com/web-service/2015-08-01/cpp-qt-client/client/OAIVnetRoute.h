...
#ifndef OAIVnetRoute_H
#define OAIVnetRoute_H
...
class OAIVnetRoute : public OAIObject {
public:
    OAIVnetRoute();
    OAIVnetRoute(QString json);
    ~OAIVnetRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVnetRoute)

#endif // OAIVnetRoute_H
