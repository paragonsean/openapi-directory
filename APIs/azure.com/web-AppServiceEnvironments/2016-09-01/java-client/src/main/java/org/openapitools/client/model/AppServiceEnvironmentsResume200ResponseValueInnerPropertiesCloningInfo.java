...
public class AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo() {
  }

  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo appSettingsOverrides(Map<String, String> appSettingsOverrides) {
    this.appSettingsOverrides = appSettingsOverrides;
    return this;
  }

  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo putAppSettingsOverridesItem(String key, String appSettingsOverridesItem) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo cloneCustomHostNames(Boolean cloneCustomHostNames) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo cloneSourceControl(Boolean cloneSourceControl) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo configureLoadBalancing(Boolean configureLoadBalancing) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo correlationId(UUID correlationId) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo hostingEnvironment(String hostingEnvironment) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo ignoreQuotas(Boolean ignoreQuotas) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo overwrite(Boolean overwrite) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo sourceWebAppId(String sourceWebAppId) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo trafficManagerProfileId(String trafficManagerProfileId) {
  ...
  public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo trafficManagerProfileName(String trafficManagerProfileName) {
  ...
  public boolean equals(Object o) {
    ...
    AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo = (AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo) o;
    return Objects.equals(this.appSettingsOverrides, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.appSettingsOverrides) &&
        Objects.equals(this.cloneCustomHostNames, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.cloneCustomHostNames) &&
        Objects.equals(this.cloneSourceControl, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.cloneSourceControl) &&
        Objects.equals(this.configureLoadBalancing, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.configureLoadBalancing) &&
        Objects.equals(this.correlationId, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.correlationId) &&
        Objects.equals(this.hostingEnvironment, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.hostingEnvironment) &&
        Objects.equals(this.ignoreQuotas, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.ignoreQuotas) &&
        Objects.equals(this.overwrite, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.overwrite) &&
        Objects.equals(this.sourceWebAppId, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.sourceWebAppId) &&
        Objects.equals(this.trafficManagerProfileId, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.trafficManagerProfileId) &&
        Objects.equals(this.trafficManagerProfileName, appServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.trafficManagerProfileName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo is not found in the empty JSON string", AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo>() {
           @Override
           public void write(JsonWriter out, AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo
   * @throws IOException if the JSON string is invalid with respect to AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo
   */
  public static AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo.class);
  }

  /**
   * Convert an instance of AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo to an JSON string
   *
   * @return JSON string
   */
