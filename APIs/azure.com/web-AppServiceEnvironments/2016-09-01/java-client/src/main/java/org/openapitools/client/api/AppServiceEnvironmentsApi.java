...
public class AppServiceEnvironmentsApi {
    ...
    /**
     * Build call for appServiceEnvironmentsListMetricDefinitions
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMetricDefinitionsCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServiceEnvironmentsListMetricDefinitionsValidateBeforeCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServiceEnvironmentsListMetricDefinitions(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServiceEnvironmentsListMetricDefinitions(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServiceEnvironmentsListMetricDefinitions(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServiceEnvironmentsListMetricDefinitions(Async)");
        }

        return appServiceEnvironmentsListMetricDefinitionsCall(resourceGroupName, name, subscriptionId, apiVersion, _callback);
     ...
     */
    public MetricDefinition appServiceEnvironmentsListMetricDefinitions(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<MetricDefinition> localVarResp = appServiceEnvironmentsListMetricDefinitionsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MetricDefinition> appServiceEnvironmentsListMetricDefinitionsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = appServiceEnvironmentsListMetricDefinitionsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, null);
        Type localVarReturnType = new TypeToken<MetricDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get global metric definitions of an App Service Environment. (asynchronously)
     * Get global metric definitions of an App Service Environment.
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMetricDefinitionsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback<MetricDefinition> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServiceEnvironmentsListMetricDefinitionsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<MetricDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for appServiceEnvironmentsListMetrics
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMetricsCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServiceEnvironmentsListMetricsValidateBeforeCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServiceEnvironmentsListMetrics(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServiceEnvironmentsListMetrics(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServiceEnvironmentsListMetrics(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServiceEnvironmentsListMetrics(Async)");
        }

        return appServiceEnvironmentsListMetricsCall(resourceGroupName, name, subscriptionId, apiVersion, details, $filter, _callback);
     ...
     */
    public AppServiceEnvironmentsListMetrics200Response appServiceEnvironmentsListMetrics(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMetrics200Response> localVarResp = appServiceEnvironmentsListMetricsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion, details, $filter);
        return localVarResp.getData();
    }
     ...
     * @param details Specify &lt;code&gt;true&lt;/code&gt; to include instance details. The default is &lt;code&gt;false&lt;/code&gt;. (optional)
     * @param $filter Return only usages/metrics specified in the filter. Filter conforms to odata syntax. Example: $filter&#x3D;(name.value eq &#39;Metric1&#39; or name.value eq &#39;Metric2&#39;) and startTime eq &#39;2014-01-01T00:00:00Z&#39; and endTime eq &#39;2014-12-31T23:59:59Z&#39; and timeGrain eq duration&#39;[Hour|Minute|Day]&#39;. (optional)
     * @return ApiResponse&lt;AppServiceEnvironmentsListMetrics200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMetrics200Response> appServiceEnvironmentsListMetricsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        okhttp3.Call localVarCall = appServiceEnvironmentsListMetricsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, details, $filter, null);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get global metrics of an App Service Environment. (asynchronously)
     * Get global metrics of an App Service Environment.
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMetricsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback<AppServiceEnvironmentsListMetrics200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServiceEnvironmentsListMetricsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, details, $filter, _callback);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response appServiceEnvironmentsListMultiRoleMetricDefinitions(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> localVarResp = appServiceEnvironmentsListMultiRoleMetricDefinitionsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     * @return ApiResponse&lt;AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> appServiceEnvironmentsListMultiRoleMetricDefinitionsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMultiRoleMetricDefinitionsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for appServiceEnvironmentsListMultiRoleMetrics
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     * @param startTime Beginning time of the metrics query. (optional)
     * @param endTime End time of the metrics query. (optional)
     * @param timeGrain Time granularity of the metrics query. (optional)
     * @param details Specify &lt;code&gt;true&lt;/code&gt; to include instance details. The default is &lt;code&gt;false&lt;/code&gt;. (optional)
     * @param $filter Return only usages/metrics specified in the filter. Filter conforms to odata syntax. Example: $filter&#x3D;(name.value eq &#39;Metric1&#39; or name.value eq &#39;Metric2&#39;) and startTime eq &#39;2014-01-01T00:00:00Z&#39; and endTime eq &#39;2014-12-31T23:59:59Z&#39; and timeGrain eq duration&#39;[Hour|Minute|Day]&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMultiRoleMetricsCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, String startTime, String endTime, String timeGrain, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServiceEnvironmentsListMultiRoleMetricsValidateBeforeCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, String startTime, String endTime, String timeGrain, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServiceEnvironmentsListMultiRoleMetrics(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServiceEnvironmentsListMultiRoleMetrics(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServiceEnvironmentsListMultiRoleMetrics(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServiceEnvironmentsListMultiRoleMetrics(Async)");
        }

        return appServiceEnvironmentsListMultiRoleMetricsCall(resourceGroupName, name, subscriptionId, apiVersion, startTime, endTime, timeGrain, details, $filter, _callback);
     ...
     */
    public AppServiceEnvironmentsListMetrics200Response appServiceEnvironmentsListMultiRoleMetrics(String resourceGroupName, String name, String subscriptionId, String apiVersion, String startTime, String endTime, String timeGrain, Boolean details, String $filter) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMetrics200Response> localVarResp = appServiceEnvironmentsListMultiRoleMetricsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion, startTime, endTime, timeGrain, details, $filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMetrics200Response> appServiceEnvironmentsListMultiRoleMetricsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion, String startTime, String endTime, String timeGrain, Boolean details, String $filter) throws ApiException {
        okhttp3.Call localVarCall = appServiceEnvironmentsListMultiRoleMetricsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, startTime, endTime, timeGrain, details, $filter, null);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get metrics for a multi-role pool of an App Service Environment. (asynchronously)
     * Get metrics for a multi-role pool of an App Service Environment.
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMultiRoleMetricsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, String startTime, String endTime, String timeGrain, Boolean details, String $filter, final ApiCallback<AppServiceEnvironmentsListMetrics200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServiceEnvironmentsListMultiRoleMetricsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, startTime, endTime, timeGrain, details, $filter, _callback);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response appServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> localVarResp = appServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitionsWithHttpInfo(resourceGroupName, name, instance, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> appServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitionsWithHttpInfo(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitionsAsync(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion, final ApiCallback<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for appServiceEnvironmentsListMultiRolePoolInstanceMetrics
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param instance Name of the instance in the multi-role pool. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMultiRolePoolInstanceMetricsCall(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion, Boolean details, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServiceEnvironmentsListMultiRolePoolInstanceMetricsValidateBeforeCall(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion, Boolean details, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServiceEnvironmentsListMultiRolePoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServiceEnvironmentsListMultiRolePoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'instance' is set
        if (instance == null) {
            throw new ApiException("Missing the required parameter 'instance' when calling appServiceEnvironmentsListMultiRolePoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServiceEnvironmentsListMultiRolePoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServiceEnvironmentsListMultiRolePoolInstanceMetrics(Async)");
        }

        return appServiceEnvironmentsListMultiRolePoolInstanceMetricsCall(resourceGroupName, name, instance, subscriptionId, apiVersion, details, _callback);
     ...
     */
    public AppServiceEnvironmentsListMetrics200Response appServiceEnvironmentsListMultiRolePoolInstanceMetrics(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion, Boolean details) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMetrics200Response> localVarResp = appServiceEnvironmentsListMultiRolePoolInstanceMetricsWithHttpInfo(resourceGroupName, name, instance, subscriptionId, apiVersion, details);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMetrics200Response> appServiceEnvironmentsListMultiRolePoolInstanceMetricsWithHttpInfo(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion, Boolean details) throws ApiException {
        okhttp3.Call localVarCall = appServiceEnvironmentsListMultiRolePoolInstanceMetricsValidateBeforeCall(resourceGroupName, name, instance, subscriptionId, apiVersion, details, null);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get metrics for a specific instance of a multi-role pool of an App Service Environment. (asynchronously)
     * Get metrics for a specific instance of a multi-role pool of an App Service Environment.
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param instance Name of the instance in the multi-role pool. (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListMultiRolePoolInstanceMetricsAsync(String resourceGroupName, String name, String instance, String subscriptionId, String apiVersion, Boolean details, final ApiCallback<AppServiceEnvironmentsListMetrics200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServiceEnvironmentsListMultiRolePoolInstanceMetricsValidateBeforeCall(resourceGroupName, name, instance, subscriptionId, apiVersion, details, _callback);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for appServiceEnvironmentsListVips
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param subscriptionId Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000). (required)
     * @param apiVersion API Version (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListVipsCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServiceEnvironmentsListVipsValidateBeforeCall(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServiceEnvironmentsListVips(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServiceEnvironmentsListVips(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServiceEnvironmentsListVips(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServiceEnvironmentsListVips(Async)");
        }

        return appServiceEnvironmentsListVipsCall(resourceGroupName, name, subscriptionId, apiVersion, _callback);
     ...
     */
    public AddressResponse appServiceEnvironmentsListVips(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AddressResponse> localVarResp = appServiceEnvironmentsListVipsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AddressResponse> appServiceEnvironmentsListVipsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = appServiceEnvironmentsListVipsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, null);
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListVipsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback<AddressResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServiceEnvironmentsListVipsValidateBeforeCall(resourceGroupName, name, subscriptionId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<AddressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param apiVersion API Version (required)
     * @param propertiesToInclude Comma separated list of app properties to include. (optional)
     * @return AppServiceEnvironmentsResume200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public AppServiceEnvironmentsResume200Response appServiceEnvironmentsListWebApps(String resourceGroupName, String name, String subscriptionId, String apiVersion, String propertiesToInclude) throws ApiException {
        ApiResponse<AppServiceEnvironmentsResume200Response> localVarResp = appServiceEnvironmentsListWebAppsWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion, propertiesToInclude);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion API Version (required)
     * @param propertiesToInclude Comma separated list of app properties to include. (optional)
     * @return ApiResponse&lt;AppServiceEnvironmentsResume200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AppServiceEnvironmentsResume200Response> appServiceEnvironmentsListWebAppsWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion, String propertiesToInclude) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsResume200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListWebAppsAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, String propertiesToInclude, final ApiCallback<AppServiceEnvironmentsResume200Response> _callback) throws ApiException {
     ...
     */
    public AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response appServiceEnvironmentsListWebWorkerMetricDefinitions(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> localVarResp = appServiceEnvironmentsListWebWorkerMetricDefinitionsWithHttpInfo(resourceGroupName, name, workerPoolName, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> appServiceEnvironmentsListWebWorkerMetricDefinitionsWithHttpInfo(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListWebWorkerMetricDefinitionsAsync(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion, final ApiCallback<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for appServiceEnvironmentsListWebWorkerMetrics
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListWebWorkerMetricsCall(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServiceEnvironmentsListWebWorkerMetricsValidateBeforeCall(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServiceEnvironmentsListWebWorkerMetrics(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServiceEnvironmentsListWebWorkerMetrics(Async)");
        }

        // verify the required parameter 'workerPoolName' is set
        if (workerPoolName == null) {
            throw new ApiException("Missing the required parameter 'workerPoolName' when calling appServiceEnvironmentsListWebWorkerMetrics(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServiceEnvironmentsListWebWorkerMetrics(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServiceEnvironmentsListWebWorkerMetrics(Async)");
        }

        return appServiceEnvironmentsListWebWorkerMetricsCall(resourceGroupName, name, workerPoolName, subscriptionId, apiVersion, details, $filter, _callback);
     ...
     */
    public AppServiceEnvironmentsListMetrics200Response appServiceEnvironmentsListWebWorkerMetrics(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMetrics200Response> localVarResp = appServiceEnvironmentsListWebWorkerMetricsWithHttpInfo(resourceGroupName, name, workerPoolName, subscriptionId, apiVersion, details, $filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMetrics200Response> appServiceEnvironmentsListWebWorkerMetricsWithHttpInfo(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        okhttp3.Call localVarCall = appServiceEnvironmentsListWebWorkerMetricsValidateBeforeCall(resourceGroupName, name, workerPoolName, subscriptionId, apiVersion, details, $filter, null);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get metrics for a worker pool of a AppServiceEnvironment (App Service Environment). (asynchronously)
     * Get metrics for a worker pool of a AppServiceEnvironment (App Service Environment).
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param workerPoolName Name of worker pool (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListWebWorkerMetricsAsync(String resourceGroupName, String name, String workerPoolName, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback<AppServiceEnvironmentsListMetrics200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServiceEnvironmentsListWebWorkerMetricsValidateBeforeCall(resourceGroupName, name, workerPoolName, subscriptionId, apiVersion, details, $filter, _callback);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response appServiceEnvironmentsListWorkerPoolInstanceMetricDefinitions(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> localVarResp = appServiceEnvironmentsListWorkerPoolInstanceMetricDefinitionsWithHttpInfo(resourceGroupName, name, workerPoolName, instance, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> appServiceEnvironmentsListWorkerPoolInstanceMetricDefinitionsWithHttpInfo(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListWorkerPoolInstanceMetricDefinitionsAsync(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion, final ApiCallback<AppServiceEnvironmentsListMultiRolePoolInstanceMetricDefinitions200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for appServiceEnvironmentsListWorkerPoolInstanceMetrics
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param workerPoolName Name of the worker pool. (required)
     * @param instance Name of the instance in the worker pool. (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListWorkerPoolInstanceMetricsCall(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appServiceEnvironmentsListWorkerPoolInstanceMetricsValidateBeforeCall(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling appServiceEnvironmentsListWorkerPoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling appServiceEnvironmentsListWorkerPoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'workerPoolName' is set
        if (workerPoolName == null) {
            throw new ApiException("Missing the required parameter 'workerPoolName' when calling appServiceEnvironmentsListWorkerPoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'instance' is set
        if (instance == null) {
            throw new ApiException("Missing the required parameter 'instance' when calling appServiceEnvironmentsListWorkerPoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling appServiceEnvironmentsListWorkerPoolInstanceMetrics(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling appServiceEnvironmentsListWorkerPoolInstanceMetrics(Async)");
        }

        return appServiceEnvironmentsListWorkerPoolInstanceMetricsCall(resourceGroupName, name, workerPoolName, instance, subscriptionId, apiVersion, details, $filter, _callback);
     ...
     */
    public AppServiceEnvironmentsListMetrics200Response appServiceEnvironmentsListWorkerPoolInstanceMetrics(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        ApiResponse<AppServiceEnvironmentsListMetrics200Response> localVarResp = appServiceEnvironmentsListWorkerPoolInstanceMetricsWithHttpInfo(resourceGroupName, name, workerPoolName, instance, subscriptionId, apiVersion, details, $filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsListMetrics200Response> appServiceEnvironmentsListWorkerPoolInstanceMetricsWithHttpInfo(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion, Boolean details, String $filter) throws ApiException {
        okhttp3.Call localVarCall = appServiceEnvironmentsListWorkerPoolInstanceMetricsValidateBeforeCall(resourceGroupName, name, workerPoolName, instance, subscriptionId, apiVersion, details, $filter, null);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get metrics for a specific instance of a worker pool of an App Service Environment. (asynchronously)
     * Get metrics for a specific instance of a worker pool of an App Service Environment.
     * @param resourceGroupName Name of the resource group to which the resource belongs. (required)
     * @param name Name of the App Service Environment. (required)
     * @param workerPoolName Name of the worker pool. (required)
     ...
     */
    public okhttp3.Call appServiceEnvironmentsListWorkerPoolInstanceMetricsAsync(String resourceGroupName, String name, String workerPoolName, String instance, String subscriptionId, String apiVersion, Boolean details, String $filter, final ApiCallback<AppServiceEnvironmentsListMetrics200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = appServiceEnvironmentsListWorkerPoolInstanceMetricsValidateBeforeCall(resourceGroupName, name, workerPoolName, instance, subscriptionId, apiVersion, details, $filter, _callback);
        Type localVarReturnType = new TypeToken<AppServiceEnvironmentsListMetrics200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public AppServiceEnvironmentsResume200Response appServiceEnvironmentsResume(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServiceEnvironmentsResume200Response> localVarResp = appServiceEnvironmentsResumeWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsResume200Response> appServiceEnvironmentsResumeWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call appServiceEnvironmentsResumeAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback<AppServiceEnvironmentsResume200Response> _callback) throws ApiException {
     ...
     */
    public AppServiceEnvironmentsResume200Response appServiceEnvironmentsSuspend(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<AppServiceEnvironmentsResume200Response> localVarResp = appServiceEnvironmentsSuspendWithHttpInfo(resourceGroupName, name, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AppServiceEnvironmentsResume200Response> appServiceEnvironmentsSuspendWithHttpInfo(String resourceGroupName, String name, String subscriptionId, String apiVersion) throws ApiException {
     ...
     */
    public okhttp3.Call appServiceEnvironmentsSuspendAsync(String resourceGroupName, String name, String subscriptionId, String apiVersion, final ApiCallback<AppServiceEnvironmentsResume200Response> _callback) throws ApiException {
