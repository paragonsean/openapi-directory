...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo();
  });
  ...
  describe('AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo', function() {
    it('should create an instance of AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo', function() {
      // uncomment below and update the code to test AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo
      //var instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo();
      //expect(instance).to.be.a(AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerPropertiesCloningInfo);
    });
