...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerProperties();
  });
  ...
  describe('AppServiceEnvironmentsResume200ResponseValueInnerProperties', function() {
    it('should create an instance of AppServiceEnvironmentsResume200ResponseValueInnerProperties', function() {
      // uncomment below and update the code to test AppServiceEnvironmentsResume200ResponseValueInnerProperties
      //var instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerProperties();
      //expect(instance).to.be.a(AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerProperties);
    });
