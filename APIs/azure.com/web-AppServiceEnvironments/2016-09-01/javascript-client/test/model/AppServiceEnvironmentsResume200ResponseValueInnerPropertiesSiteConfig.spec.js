...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig();
  });
  ...
  describe('AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig', function() {
    it('should create an instance of AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig', function() {
      // uncomment below and update the code to test AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig
      //var instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig();
      //expect(instance).to.be.a(AppServiceEnvironmentsApiClient.AppServiceEnvironmentsResume200ResponseValueInnerPropertiesSiteConfig);
    });
