...
QString OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::getAdminSiteName() const {
    return m_admin_site_name;
}
void OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::setAdminSiteName(const QString &admin_site_name) {
    m_admin_site_name = admin_site_name;
    m_admin_site_name_isSet = true;
}

bool OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::is_admin_site_name_Set() const{
    return m_admin_site_name_isSet;
}

bool OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::is_admin_site_name_Valid() const{
...
OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_hostingEnvironmentProfile OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::getHostingEnvironmentProfile() const {
    return m_hosting_environment_profile;
}
void OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::setHostingEnvironmentProfile(const OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_hostingEnvironmentProfile &hosting_environment_profile) {
...
QString OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::getName() const {
    return m_name;
}
void OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAppServiceEnvironments_ListAppServicePlans_200_response_value_inner_properties::is_name_Valid() const{
