...
/*
 * OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo.h
 *
 * Information needed for cloning operation.
 */

#ifndef OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo_H
#define OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo_H
...
class OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo : public OAIObject {
public:
    OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo();
    OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo(QString json);
    ~OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo)

#endif // OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_cloningInfo_H
