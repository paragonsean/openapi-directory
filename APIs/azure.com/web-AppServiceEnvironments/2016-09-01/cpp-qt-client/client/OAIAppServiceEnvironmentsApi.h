...
#include "OAIAppServiceEnvironments_Resume_200_response.h"
...
Q_SIGNALS:
    ...
    void appServiceEnvironmentsListWebAppsSignal(OAIAppServiceEnvironments_Resume_200_response summary);
    ...
    void appServiceEnvironmentsResumeSignal(OAIAppServiceEnvironments_Resume_200_response summary);
    void appServiceEnvironmentsSuspendSignal(OAIAppServiceEnvironments_Resume_200_response summary);
    ...
    void appServiceEnvironmentsListWebAppsSignalFull(OAIHttpRequestWorker *worker, OAIAppServiceEnvironments_Resume_200_response summary);
    ...
    void appServiceEnvironmentsResumeSignalFull(OAIHttpRequestWorker *worker, OAIAppServiceEnvironments_Resume_200_response summary);
    void appServiceEnvironmentsSuspendSignalFull(OAIHttpRequestWorker *worker, OAIAppServiceEnvironments_Resume_200_response summary);
    ...
    void appServiceEnvironmentsListWebAppsSignalE(OAIAppServiceEnvironments_Resume_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void appServiceEnvironmentsListWebAppsSignalError(OAIAppServiceEnvironments_Resume_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void appServiceEnvironmentsResumeSignalE(OAIAppServiceEnvironments_Resume_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void appServiceEnvironmentsResumeSignalError(OAIAppServiceEnvironments_Resume_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use appServiceEnvironmentsSuspendSignalError() instead")
    void appServiceEnvironmentsSuspendSignalE(OAIAppServiceEnvironments_Resume_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void appServiceEnvironmentsSuspendSignalError(OAIAppServiceEnvironments_Resume_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
