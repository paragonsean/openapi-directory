...
/*
 * OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner.h
 *
 * Routing rules for ramp up testing. This rule allows to redirect static traffic % to a slot or to gradually change routing % based on performance.
 */

#ifndef OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
#define OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
...
class OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner : public OAIObject {
public:
    OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner();
    OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner(QString json);
    ~OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner)

#endif // OAIAppServiceEnvironments_Resume_200_response_value_inner_properties_siteConfig_experiments_rampUpRules_inner_H
