...
/*
 * OAIAddressResponse_vipMappings_inner.h
 *
 * Virtual IP mapping.
 */

#ifndef OAIAddressResponse_vipMappings_inner_H
#define OAIAddressResponse_vipMappings_inner_H
...
class OAIAddressResponse_vipMappings_inner : public OAIObject {
public:
    OAIAddressResponse_vipMappings_inner();
    OAIAddressResponse_vipMappings_inner(QString json);
    ~OAIAddressResponse_vipMappings_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressResponse_vipMappings_inner)

#endif // OAIAddressResponse_vipMappings_inner_H
