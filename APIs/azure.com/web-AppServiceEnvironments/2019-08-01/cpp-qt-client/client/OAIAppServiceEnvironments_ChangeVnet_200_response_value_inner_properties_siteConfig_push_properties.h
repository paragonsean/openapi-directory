...
/*
 * OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties.h
 *
 * PushSettings resource specific properties
 */

#ifndef OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties_H
#define OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties_H
...
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties : public OAIObject {
public:
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties();
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties(QString json);
    ~OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties)

#endif // OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push_properties_H
