...
bool OAIEndpointDetail::isIsAccessible() const {
    return m_is_accessible;
}
void OAIEndpointDetail::setIsAccessible(const bool &is_accessible) {
    m_is_accessible = is_accessible;
    m_is_accessible_isSet = true;
}

bool OAIEndpointDetail::is_is_accessible_Set() const{
    return m_is_accessible_isSet;
}

bool OAIEndpointDetail::is_is_accessible_Valid() const{
