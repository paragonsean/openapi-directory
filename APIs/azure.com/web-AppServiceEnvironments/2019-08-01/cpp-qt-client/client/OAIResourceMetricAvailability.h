...
/*
 * OAIResourceMetricAvailability.h
 *
 * Metrics availability and retention.
 */

#ifndef OAIResourceMetricAvailability_H
#define OAIResourceMetricAvailability_H
...
class OAIResourceMetricAvailability : public OAIObject {
public:
    OAIResourceMetricAvailability();
    OAIResourceMetricAvailability(QString json);
    ~OAIResourceMetricAvailability() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceMetricAvailability)

#endif // OAIResourceMetricAvailability_H
