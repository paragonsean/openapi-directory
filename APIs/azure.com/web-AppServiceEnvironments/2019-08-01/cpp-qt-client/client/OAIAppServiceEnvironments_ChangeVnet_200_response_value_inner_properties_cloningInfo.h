...
/*
 * OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo.h
 *
 * Information needed for cloning operation.
 */

#ifndef OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo_H
#define OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo_H
...
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo : public OAIObject {
public:
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo();
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo(QString json);
    ~OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo() override;
    ...
    QString getSourceWebAppLocation() const;
    void setSourceWebAppLocation(const QString &source_web_app_location);
    bool is_source_web_app_location_Set() const;
    bool is_source_web_app_location_Valid() const;
...
private:
    ...
    QString m_source_web_app_location;
    bool m_source_web_app_location_isSet;
    bool m_source_web_app_location_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo)

#endif // OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_cloningInfo_H
