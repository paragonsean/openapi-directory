...
class EndpointDetail(Model):
    ...
    def __init__(self, ip_address: str=None, is_accessible: bool=None, latency: float=None, port: int=None):
        """EndpointDetail - a model defined in OpenAPI

        :param ip_address: The ip_address of this EndpointDetail.
        :param is_accessible: The is_accessible of this EndpointDetail.
    ...
    def is_accessible(self):
        """Gets the is_accessible of this EndpointDetail.

        Whether it is possible to create a TCP connection from the App Service Environment to this IpAddress at this Port.

        :return: The is_accessible of this EndpointDetail.
        :rtype: bool
        """
    ...
    def is_accessible(self, is_accessible):
        """Sets the is_accessible of this EndpointDetail.
