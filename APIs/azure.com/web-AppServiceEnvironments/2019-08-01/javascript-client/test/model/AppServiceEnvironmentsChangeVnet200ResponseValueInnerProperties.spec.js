...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerProperties();
  });
  ...
  describe('AppServiceEnvironmentsChangeVnet200ResponseValueInnerProperties', function() {
    it('should create an instance of AppServiceEnvironmentsChangeVnet200ResponseValueInnerProperties', function() {
      // uncomment below and update the code to test AppServiceEnvironmentsChangeVnet200ResponseValueInnerProperties
      //var instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerProperties();
      //expect(instance).to.be.a(AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerProperties);
    });
