...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo();
  });
  ...
  describe('AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo', function() {
    it('should create an instance of AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo', function() {
      // uncomment below and update the code to test AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo
      //var instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo();
      //expect(instance).to.be.a(AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo);
    });
