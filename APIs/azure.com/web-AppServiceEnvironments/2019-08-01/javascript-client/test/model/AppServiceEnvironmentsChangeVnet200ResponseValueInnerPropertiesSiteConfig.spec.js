...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig();
  });
  ...
  describe('AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig', function() {
    it('should create an instance of AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig', function() {
      // uncomment below and update the code to test AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig
      //var instance = new AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig();
      //expect(instance).to.be.a(AppServiceEnvironmentsApiClient.AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesSiteConfig);
    });
