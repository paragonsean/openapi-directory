...
/**
 * The AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo model module.
 * @module model/AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo
 * @version 2018-02-01
 */
class AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo {
    /**
     * Constructs a new <code>AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo</code>.
     * Information needed for cloning operation.
     * @alias module:model/AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo
    ...
    constructor(sourceWebAppId) { 
        ...
        AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.initialize(this, sourceWebAppId);
    }
    ...
    /**
     * Constructs a <code>AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo} obj Optional instance to populate.
     * @return {module:model/AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo} The populated <code>AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.RequiredProperties) {
...
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.RequiredProperties = ["sourceWebAppId"];
 ...
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['appSettingsOverrides'] = undefined;

/**
 * <code>true</code> to clone custom hostnames from source app; otherwise, <code>false</code>.
 * @member {Boolean} cloneCustomHostNames
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['cloneCustomHostNames'] = undefined;

/**
 * <code>true</code> to clone source control from source app; otherwise, <code>false</code>.
 * @member {Boolean} cloneSourceControl
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['cloneSourceControl'] = undefined;

/**
 * <code>true</code> to configure load balancing for source and destination app.
 * @member {Boolean} configureLoadBalancing
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['configureLoadBalancing'] = undefined;

/**
 * Correlation ID of cloning operation. This ID ties multiple cloning operations together to use the same snapshot.
 * @member {String} correlationId
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['correlationId'] = undefined;

/**
 * App Service Environment.
 * @member {String} hostingEnvironment
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['hostingEnvironment'] = undefined;

/**
 * <code>true</code> to overwrite destination app; otherwise, <code>false</code>.
 * @member {Boolean} overwrite
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['overwrite'] = undefined;

/**
 * ARM resource ID of the source app. App resource ID is of the form  /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName} for production slots and  /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName} for other slots.
 * @member {String} sourceWebAppId
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['sourceWebAppId'] = undefined;

/**
 * Location of source app ex: West US or North Europe
 * @member {String} sourceWebAppLocation
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['sourceWebAppLocation'] = undefined;
 ...
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['trafficManagerProfileId'] = undefined;

/**
 * Name of Traffic Manager profile to create. This is only needed if Traffic Manager profile does not already exist.
 * @member {String} trafficManagerProfileName
 */
AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo.prototype['trafficManagerProfileName'] = undefined;
...
export default AppServiceEnvironmentsChangeVnet200ResponseValueInnerPropertiesCloningInfo;
