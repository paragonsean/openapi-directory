...
/*
 * OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig.h
 *
 * Configuration of an App Service app.
 */

#ifndef OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_H
#define OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_H

#include <QJsonObject>

#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_apiDefinition.h"
...
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_connectionStrings_inner.h"
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_cors.h"
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_experiments.h"
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_handlerMappings_inner.h"
...
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_limits.h"
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_machineKey.h"
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push.h"
#include "OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_virtualApplications_inner.h"
#include <QDateTime>
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_apiDefinition;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_appSettings_inner;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_autoHealRules;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_azureStorageAccounts_value;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_connectionStrings_inner;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_cors;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_experiments;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_handlerMappings_inner;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_limits;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_machineKey;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push;
class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_virtualApplications_inner;

class OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig : public OAIObject {
public:
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig();
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig(QString json);
    ~OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig() override;
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_apiDefinition getApiDefinition() const;
    void setApiDefinition(const OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_apiDefinition &api_definition);
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_appSettings_inner> getAppSettings() const;
    void setAppSettings(const QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_appSettings_inner> &app_settings);
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_autoHealRules getAutoHealRules() const;
    void setAutoHealRules(const OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_autoHealRules &auto_heal_rules);
    ...
    QMap<QString, OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_azureStorageAccounts_value> getAzureStorageAccounts() const;
    void setAzureStorageAccounts(const QMap<QString, OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_azureStorageAccounts_value> &azure_storage_accounts);
    bool is_azure_storage_accounts_Set() const;
    bool is_azure_storage_accounts_Valid() const;

    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_connectionStrings_inner> getConnectionStrings() const;
    void setConnectionStrings(const QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_connectionStrings_inner> &connection_strings);
    bool is_connection_strings_Set() const;
    bool is_connection_strings_Valid() const;

    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_cors getCors() const;
    void setCors(const OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_cors &cors);
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_experiments getExperiments() const;
    void setExperiments(const OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_experiments &experiments);
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_handlerMappings_inner> getHandlerMappings() const;
    void setHandlerMappings(const QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_handlerMappings_inner> &handler_mappings);
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> getIpSecurityRestrictions() const;
    void setIpSecurityRestrictions(const QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> &ip_security_restrictions);
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_limits getLimits() const;
    void setLimits(const OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_limits &limits);
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_machineKey getMachineKey() const;
    void setMachineKey(const OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_machineKey &machine_key);
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push getPush() const;
    void setPush(const OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push &push);
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> getScmIpSecurityRestrictions() const;
    void setScmIpSecurityRestrictions(const QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> &scm_ip_security_restrictions);
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_virtualApplications_inner> getVirtualApplications() const;
    void setVirtualApplications(const QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_virtualApplications_inner> &virtual_applications);
...
private:
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_apiDefinition m_api_definition;
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_appSettings_inner> m_app_settings;
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_autoHealRules m_auto_heal_rules;
    ...
    QMap<QString, OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_azureStorageAccounts_value> m_azure_storage_accounts;
    bool m_azure_storage_accounts_isSet;
    bool m_azure_storage_accounts_isValid;

    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_connectionStrings_inner> m_connection_strings;
    bool m_connection_strings_isSet;
    bool m_connection_strings_isValid;

    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_cors m_cors;
    bool m_cors_isSet;
    bool m_cors_isValid;
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_experiments m_experiments;
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_handlerMappings_inner> m_handler_mappings;
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> m_ip_security_restrictions;
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_limits m_limits;
    bool m_limits_isSet;
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_machineKey m_machine_key;
    ...
    OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_push m_push;
    bool m_push_isSet;
    bool m_push_isValid;
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_ipSecurityRestrictions_inner> m_scm_ip_security_restrictions;
    ...
    QList<OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_virtualApplications_inner> m_virtual_applications;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig)

#endif // OAIAppServiceEnvironments_ChangeVnet_200_response_value_inner_properties_siteConfig_H
