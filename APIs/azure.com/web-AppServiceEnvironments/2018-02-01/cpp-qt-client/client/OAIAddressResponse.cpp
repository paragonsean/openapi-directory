...
QList<OAIAddressResponse_vipMappings_inner> OAIAddressResponse::getVipMappings() const {
    return m_vip_mappings;
}
void OAIAddressResponse::setVipMappings(const QList<OAIAddressResponse_vipMappings_inner> &vip_mappings) {
