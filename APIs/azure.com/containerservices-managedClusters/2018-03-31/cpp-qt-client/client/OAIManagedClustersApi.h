...
Q_SIGNALS:
    ...
    void managedClustersResetAADProfileSignal(OAIManagedCluster summary);
    void managedClustersResetServicePrincipalProfileSignal(OAIManagedCluster summary);
    ...
    void managedClustersResetAADProfileSignalFull(OAIHttpRequestWorker *worker, OAIManagedCluster summary);
    void managedClustersResetServicePrincipalProfileSignalFull(OAIHttpRequestWorker *worker, OAIManagedCluster summary);
    ...
    void managedClustersResetAADProfileSignalE(OAIManagedCluster summary, QNetworkReply::NetworkError error_type, QString error_str);
    void managedClustersResetAADProfileSignalError(OAIManagedCluster summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use managedClustersResetServicePrincipalProfileSignalError() instead")
    void managedClustersResetServicePrincipalProfileSignalE(OAIManagedCluster summary, QNetworkReply::NetworkError error_type, QString error_str);
    void managedClustersResetServicePrincipalProfileSignalError(OAIManagedCluster summary, QNetworkReply::NetworkError error_type, const QString &error_str);
