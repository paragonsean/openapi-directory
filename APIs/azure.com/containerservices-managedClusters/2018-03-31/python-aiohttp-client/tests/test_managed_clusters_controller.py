...
async def test_managed_clusters_create_or_update(client):
    ...
    """
    parameters = {"name":"name","location":"location","id":"id","type":"type","properties":{"agentPoolProfiles":[{"osDiskSizeGB":149,"storageProfile":"StorageAccount","count":8,"name":"name","osType":"Linux","vnetSubnetID":"vnetSubnetID","vmSize":"Standard_A1","maxPods":6},{"osDiskSizeGB":149,"storageProfile":"StorageAccount","count":8,"name":"name","osType":"Linux","vnetSubnetID":"vnetSubnetID","vmSize":"Standard_A1","maxPods":6}],"enableRBAC":True,"fqdn":"fqdn","addonProfiles":"{}","servicePrincipalProfile":{"clientId":"clientId","secret":"secret"},"dnsPrefix":"dnsPrefix","networkProfile":{"networkPlugin":"kubenet","dockerBridgeCidr":"172.17.0.1/16","dnsServiceIP":"10.0.0.10","networkPolicy":"calico","podCidr":"10.244.0.0/16","serviceCidr":"10.0.0.0/16"},"aadProfile":{"serverAppSecret":"serverAppSecret","tenantID":"tenantID","serverAppID":"serverAppID","clientAppID":"clientAppID"},"provisioningState":"provisioningState","linuxProfile":{"adminUsername":"adminUsername","ssh":{"publicKeys":[{"keyData":"keyData"},{"keyData":"keyData"}]}},"nodeResourceGroup":"nodeResourceGroup","kubernetesVersion":"kubernetesVersion"},"tags":{"key":"tags"}}
