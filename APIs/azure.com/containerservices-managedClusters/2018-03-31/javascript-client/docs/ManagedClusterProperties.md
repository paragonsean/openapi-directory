...
**agentPoolProfiles** | [**[ManagedClusterAgentPoolProfile]**](ManagedClusterAgentPoolProfile.md) | Properties of the agent pool. Currently only one agent pool can exist. | [optional] 
