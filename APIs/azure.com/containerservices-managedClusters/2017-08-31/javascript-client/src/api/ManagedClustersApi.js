...
export default class ManagedClustersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the managedClustersGetAccessProfiles operation.
     * @callback module:api/ManagedClustersApi~managedClustersGetAccessProfilesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ManagedClusterAccessProfile} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} resourceName The name of the managed cluster resource.
     * @param {String} roleName The name of the role for managed cluster accessProfile resource.
     * @param {module:api/ManagedClustersApi~managedClustersGetAccessProfilesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ManagedClusterAccessProfile}
     */
    managedClustersGetAccessProfiles(apiVersion, subscriptionId, resourceGroupName, resourceName, roleName, callback) {
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling managedClustersGetAccessProfiles");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling managedClustersGetAccessProfiles");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling managedClustersGetAccessProfiles");
      }
      // verify the required parameter 'resourceName' is set
      if (resourceName === undefined || resourceName === null) {
        throw new Error("Missing the required parameter 'resourceName' when calling managedClustersGetAccessProfiles");
      }
      // verify the required parameter 'roleName' is set
      if (roleName === undefined || roleName === null) {
        throw new Error("Missing the required parameter 'roleName' when calling managedClustersGetAccessProfiles");
      }
      ...
      let returnType = ManagedClusterAccessProfile;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/accessProfiles/{roleName}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
