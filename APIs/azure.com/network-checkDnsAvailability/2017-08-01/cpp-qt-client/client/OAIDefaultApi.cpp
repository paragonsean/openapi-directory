...
void OAIDefaultApi::checkDnsNameAvailability(const QString &location, const QString &domain_name_label, const QString &api_version, const QString &subscription_id) {
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("domainNameLabel")).append(querySuffix).append(QUrl::toPercentEncoding(domain_name_label));
    }
