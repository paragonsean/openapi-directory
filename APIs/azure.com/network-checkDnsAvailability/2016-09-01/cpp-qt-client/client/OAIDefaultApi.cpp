...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("checkDnsNameAvailability", defaultConf);
    _serverIndices.insert("checkDnsNameAvailability", 0);
}
...
void OAIDefaultApi::checkDnsNameAvailability(const QString &location, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &domain_name_label) {
    QString fullPath = QString(_serverConfigs["checkDnsNameAvailability"][_serverIndices.value("checkDnsNameAvailability")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/CheckDnsNameAvailability");
    ...
    if (domain_name_label.hasValue())
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "domainNameLabel", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("domainNameLabel")).append(querySuffix).append(QUrl::toPercentEncoding(domain_name_label.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::checkDnsNameAvailabilityCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::checkDnsNameAvailabilityCallback);
...
void OAIDefaultApi::checkDnsNameAvailabilityCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIDnsNameAvailabilityResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT checkDnsNameAvailabilitySignal(output);
        Q_EMIT checkDnsNameAvailabilitySignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT checkDnsNameAvailabilitySignalE(output, error_type, error_str);
        Q_EMIT checkDnsNameAvailabilitySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT checkDnsNameAvailabilitySignalError(output, error_type, error_str);
        Q_EMIT checkDnsNameAvailabilitySignalErrorFull(worker, error_type, error_str);
    }
}
