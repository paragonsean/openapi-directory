...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionClient.SubscriptionList();
  });
  ...
  describe('SubscriptionList', function() {
    it('should create an instance of SubscriptionList', function() {
      ...
      //var instance = new SubscriptionClient.SubscriptionList();
      //expect(instance).to.be.a(SubscriptionClient.SubscriptionList);
    });
