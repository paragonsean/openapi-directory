...
/*
 * OAITableServiceProperties.h
 *
 * Table service properties.
 */

#ifndef OAITableServiceProperties_H
#define OAITableServiceProperties_H
...
class OAITableServiceProperties : public OAIObject {
public:
    OAITableServiceProperties();
    OAITableServiceProperties(QString json);
    ~OAITableServiceProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableServiceProperties)

#endif // OAITableServiceProperties_H
