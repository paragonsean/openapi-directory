...
import org.openapitools.client.api.JobScheduleApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    JobScheduleApi apiInstance = new JobScheduleApi(defaultClient);
    ...
    UUID jobScheduleId = UUID.randomUUID(); // UUID | The job schedule name.
    String subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    JobScheduleCreateParameters parameters = new JobScheduleCreateParameters(); // JobScheduleCreateParameters | The parameters supplied to the create job schedule operation.
    try {
      JobSchedule result = apiInstance.jobScheduleCreate(resourceGroupName, automationAccountName, jobScheduleId, subscriptionId, apiVersion, parameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling JobScheduleApi#jobScheduleCreate");
...
| **jobScheduleId** | **UUID**| The job schedule name. | |
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    try {
      apiInstance.jobScheduleDelete(resourceGroupName, automationAccountName, jobScheduleId, subscriptionId, apiVersion);
    } catch (ApiException e) {
      System.err.println("Exception when calling JobScheduleApi#jobScheduleDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client Api Version.
    try {
      JobSchedule result = apiInstance.jobScheduleGet(resourceGroupName, automationAccountName, jobScheduleId, subscriptionId, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling JobScheduleApi#jobScheduleGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="jobScheduleListByAutomationAccount"></a>
# **jobScheduleListByAutomationAccount**
> JobScheduleListResult jobScheduleListByAutomationAccount(resourceGroupName, automationAccountName, subscriptionId, apiVersion, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      JobScheduleListResult result = apiInstance.jobScheduleListByAutomationAccount(resourceGroupName, automationAccountName, subscriptionId, apiVersion, $filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling JobScheduleApi#jobScheduleListByAutomationAccount");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
