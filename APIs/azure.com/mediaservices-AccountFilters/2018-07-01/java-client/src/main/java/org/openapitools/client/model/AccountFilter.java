...
public class AccountFilter {
  ...
  public AccountFilter properties(MediaFilterProperties properties) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.properties, accountFilter.properties) &&
        Objects.equals(this.id, accountFilter.id) &&
        Objects.equals(this.name, accountFilter.name) &&
        Objects.equals(this.type, accountFilter.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
