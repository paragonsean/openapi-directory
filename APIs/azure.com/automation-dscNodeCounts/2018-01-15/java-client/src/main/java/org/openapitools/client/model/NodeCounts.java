...
public class NodeCounts {
  ...
  private List<NodeCount> value = new ArrayList<>();

  public NodeCounts() {
  }

  public NodeCounts totalCount(Integer totalCount) {
  ...
  public NodeCounts value(List<NodeCount> value) {
    this.value = value;
    return this;
  }

  public NodeCounts addValueItem(NodeCount valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<NodeCount> getValue() {
    return value;
  }

  public void setValue(List<NodeCount> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCount, nodeCounts.totalCount) &&
        Objects.equals(this.value, nodeCounts.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            NodeCount.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
