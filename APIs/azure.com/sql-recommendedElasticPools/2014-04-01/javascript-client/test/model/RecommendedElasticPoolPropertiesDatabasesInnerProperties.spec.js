...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabase.RecommendedElasticPoolPropertiesDatabasesInnerProperties();
  });
  ...
  describe('RecommendedElasticPoolPropertiesDatabasesInnerProperties', function() {
    it('should create an instance of RecommendedElasticPoolPropertiesDatabasesInnerProperties', function() {
      // uncomment below and update the code to test RecommendedElasticPoolPropertiesDatabasesInnerProperties
      //var instance = new AzureSqlDatabase.RecommendedElasticPoolPropertiesDatabasesInnerProperties();
      //expect(instance).to.be.a(AzureSqlDatabase.RecommendedElasticPoolPropertiesDatabasesInnerProperties);
    });
