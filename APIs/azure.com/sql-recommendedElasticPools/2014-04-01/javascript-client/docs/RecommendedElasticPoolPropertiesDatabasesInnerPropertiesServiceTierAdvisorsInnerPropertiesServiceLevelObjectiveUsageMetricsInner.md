# AzureSqlDatabase.RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInnerPropertiesServiceLevelObjectiveUsageMetricsInner

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**inRangeTimeRatio** | **Number** | Gets or sets inRangeTimeRatio for SLO usage metric. | [optional] [readonly] 
**serviceLevelObjective** | **String** | The serviceLevelObjective for SLO usage metric. | [optional] [readonly] 
**serviceLevelObjectiveId** | **String** | The serviceLevelObjectiveId for SLO usage metric. | [optional] [readonly] 
