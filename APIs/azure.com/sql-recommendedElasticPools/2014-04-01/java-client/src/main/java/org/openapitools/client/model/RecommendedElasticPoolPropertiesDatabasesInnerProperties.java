...
import org.openapitools.client.model.RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInner;
import org.openapitools.client.model.RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner;
import org.openapitools.client.model.RecommendedElasticPoolPropertiesDatabasesInnerPropertiesTransparentDataEncryptionInner;
...
public class RecommendedElasticPoolPropertiesDatabasesInnerProperties {
  ...
  private List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInner> recommendedIndex = new ArrayList<>();
  ...
  private List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner> serviceTierAdvisors = new ArrayList<>();
  ...
  private List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesTransparentDataEncryptionInner> transparentDataEncryption = new ArrayList<>();
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties() {
  }
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties(
     ...
     List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInner> recommendedIndex, 
     ServiceLevelObjectiveEnum serviceLevelObjective, 
     List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner> serviceTierAdvisors, 
     String status, 
     List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesTransparentDataEncryptionInner> transparentDataEncryption
  ) {
    this();
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties collation(String collation) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties createMode(CreateModeEnum createMode) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties edition(EditionEnum edition) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties elasticPoolName(String elasticPoolName) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties maxSizeBytes(String maxSizeBytes) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties readScale(ReadScaleEnum readScale) {
   ...
   */
  @javax.annotation.Nullable
  public List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInner> getRecommendedIndex() {
    return recommendedIndex;
  }



  public RecommendedElasticPoolPropertiesDatabasesInnerProperties recoveryServicesRecoveryPointResourceId(String recoveryServicesRecoveryPointResourceId) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties requestedServiceObjectiveId(UUID requestedServiceObjectiveId) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties requestedServiceObjectiveName(RequestedServiceObjectiveNameEnum requestedServiceObjectiveName) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties restorePointInTime(OffsetDateTime restorePointInTime) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties sampleName(SampleNameEnum sampleName) {
   ...
   */
  @javax.annotation.Nullable
  public List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner> getServiceTierAdvisors() {
    return serviceTierAdvisors;
  }



  public RecommendedElasticPoolPropertiesDatabasesInnerProperties sourceDatabaseDeletionDate(OffsetDateTime sourceDatabaseDeletionDate) {
  ...
  public RecommendedElasticPoolPropertiesDatabasesInnerProperties sourceDatabaseId(String sourceDatabaseId) {
   ...
   */
  @javax.annotation.Nullable
  public List<RecommendedElasticPoolPropertiesDatabasesInnerPropertiesTransparentDataEncryptionInner> getTransparentDataEncryption() {
    return transparentDataEncryption;
  }



  public RecommendedElasticPoolPropertiesDatabasesInnerProperties zoneRedundant(Boolean zoneRedundant) {
  ...
  public boolean equals(Object o) {
    ...
    RecommendedElasticPoolPropertiesDatabasesInnerProperties recommendedElasticPoolPropertiesDatabasesInnerProperties = (RecommendedElasticPoolPropertiesDatabasesInnerProperties) o;
    return Objects.equals(this.collation, recommendedElasticPoolPropertiesDatabasesInnerProperties.collation) &&
        Objects.equals(this.containmentState, recommendedElasticPoolPropertiesDatabasesInnerProperties.containmentState) &&
        Objects.equals(this.createMode, recommendedElasticPoolPropertiesDatabasesInnerProperties.createMode) &&
        Objects.equals(this.creationDate, recommendedElasticPoolPropertiesDatabasesInnerProperties.creationDate) &&
        Objects.equals(this.currentServiceObjectiveId, recommendedElasticPoolPropertiesDatabasesInnerProperties.currentServiceObjectiveId) &&
        Objects.equals(this.databaseId, recommendedElasticPoolPropertiesDatabasesInnerProperties.databaseId) &&
        Objects.equals(this.defaultSecondaryLocation, recommendedElasticPoolPropertiesDatabasesInnerProperties.defaultSecondaryLocation) &&
        Objects.equals(this.earliestRestoreDate, recommendedElasticPoolPropertiesDatabasesInnerProperties.earliestRestoreDate) &&
        Objects.equals(this.edition, recommendedElasticPoolPropertiesDatabasesInnerProperties.edition) &&
        Objects.equals(this.elasticPoolName, recommendedElasticPoolPropertiesDatabasesInnerProperties.elasticPoolName) &&
        Objects.equals(this.failoverGroupId, recommendedElasticPoolPropertiesDatabasesInnerProperties.failoverGroupId) &&
        Objects.equals(this.maxSizeBytes, recommendedElasticPoolPropertiesDatabasesInnerProperties.maxSizeBytes) &&
        Objects.equals(this.readScale, recommendedElasticPoolPropertiesDatabasesInnerProperties.readScale) &&
        Objects.equals(this.recommendedIndex, recommendedElasticPoolPropertiesDatabasesInnerProperties.recommendedIndex) &&
        Objects.equals(this.recoveryServicesRecoveryPointResourceId, recommendedElasticPoolPropertiesDatabasesInnerProperties.recoveryServicesRecoveryPointResourceId) &&
        Objects.equals(this.requestedServiceObjectiveId, recommendedElasticPoolPropertiesDatabasesInnerProperties.requestedServiceObjectiveId) &&
        Objects.equals(this.requestedServiceObjectiveName, recommendedElasticPoolPropertiesDatabasesInnerProperties.requestedServiceObjectiveName) &&
        Objects.equals(this.restorePointInTime, recommendedElasticPoolPropertiesDatabasesInnerProperties.restorePointInTime) &&
        Objects.equals(this.sampleName, recommendedElasticPoolPropertiesDatabasesInnerProperties.sampleName) &&
        Objects.equals(this.serviceLevelObjective, recommendedElasticPoolPropertiesDatabasesInnerProperties.serviceLevelObjective) &&
        Objects.equals(this.serviceTierAdvisors, recommendedElasticPoolPropertiesDatabasesInnerProperties.serviceTierAdvisors) &&
        Objects.equals(this.sourceDatabaseDeletionDate, recommendedElasticPoolPropertiesDatabasesInnerProperties.sourceDatabaseDeletionDate) &&
        Objects.equals(this.sourceDatabaseId, recommendedElasticPoolPropertiesDatabasesInnerProperties.sourceDatabaseId) &&
        Objects.equals(this.status, recommendedElasticPoolPropertiesDatabasesInnerProperties.status) &&
        Objects.equals(this.transparentDataEncryption, recommendedElasticPoolPropertiesDatabasesInnerProperties.transparentDataEncryption) &&
        Objects.equals(this.zoneRedundant, recommendedElasticPoolPropertiesDatabasesInnerProperties.zoneRedundant);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecommendedElasticPoolPropertiesDatabasesInnerProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecommendedElasticPoolPropertiesDatabasesInnerProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecommendedElasticPoolPropertiesDatabasesInnerProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecommendedElasticPoolPropertiesDatabasesInnerProperties is not found in the empty JSON string", RecommendedElasticPoolPropertiesDatabasesInnerProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecommendedElasticPoolPropertiesDatabasesInnerProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecommendedElasticPoolPropertiesDatabasesInnerProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("recommendedIndex") != null && !jsonObj.get("recommendedIndex").isJsonNull()) {
        ...
        if (jsonArrayrecommendedIndex != null) {
          ...
          for (int i = 0; i < jsonArrayrecommendedIndex.size(); i++) {
            RecommendedElasticPoolPropertiesDatabasesInnerPropertiesRecommendedIndexInner.validateJsonElement(jsonArrayrecommendedIndex.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("serviceTierAdvisors") != null && !jsonObj.get("serviceTierAdvisors").isJsonNull()) {
        ...
        if (jsonArrayserviceTierAdvisors != null) {
          ...
          for (int i = 0; i < jsonArrayserviceTierAdvisors.size(); i++) {
            RecommendedElasticPoolPropertiesDatabasesInnerPropertiesServiceTierAdvisorsInner.validateJsonElement(jsonArrayserviceTierAdvisors.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("transparentDataEncryption") != null && !jsonObj.get("transparentDataEncryption").isJsonNull()) {
        ...
        if (jsonArraytransparentDataEncryption != null) {
          ...
          for (int i = 0; i < jsonArraytransparentDataEncryption.size(); i++) {
            RecommendedElasticPoolPropertiesDatabasesInnerPropertiesTransparentDataEncryptionInner.validateJsonElement(jsonArraytransparentDataEncryption.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecommendedElasticPoolPropertiesDatabasesInnerProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecommendedElasticPoolPropertiesDatabasesInnerProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecommendedElasticPoolPropertiesDatabasesInnerProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecommendedElasticPoolPropertiesDatabasesInnerProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<RecommendedElasticPoolPropertiesDatabasesInnerProperties>() {
           @Override
           public void write(JsonWriter out, RecommendedElasticPoolPropertiesDatabasesInnerProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecommendedElasticPoolPropertiesDatabasesInnerProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecommendedElasticPoolPropertiesDatabasesInnerProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecommendedElasticPoolPropertiesDatabasesInnerProperties
   * @throws IOException if the JSON string is invalid with respect to RecommendedElasticPoolPropertiesDatabasesInnerProperties
   */
  public static RecommendedElasticPoolPropertiesDatabasesInnerProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecommendedElasticPoolPropertiesDatabasesInnerProperties.class);
  }

  /**
   * Convert an instance of RecommendedElasticPoolPropertiesDatabasesInnerProperties to an JSON string
   *
   * @return JSON string
   */
