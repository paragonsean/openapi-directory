...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMlCommitmentPlansManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new AzureMlCommitmentPlansManagementClient.Resource();
      //expect(instance).to.be.a(AzureMlCommitmentPlansManagementClient.Resource);
    });
