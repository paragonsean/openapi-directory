...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMlCommitmentPlansManagementClient.ResourceSku();
  });
  ...
  describe('ResourceSku', function() {
    it('should create an instance of ResourceSku', function() {
      ...
      //var instance = new AzureMlCommitmentPlansManagementClient.ResourceSku();
      //expect(instance).to.be.a(AzureMlCommitmentPlansManagementClient.ResourceSku);
    });
