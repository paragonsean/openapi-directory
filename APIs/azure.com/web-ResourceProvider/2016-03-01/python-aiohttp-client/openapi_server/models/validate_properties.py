...
class ValidateProperties(Model):
    ...
    def __init__(self, capacity: int=None, hosting_environment: str=None, is_spot: bool=None, need_linux_workers: bool=None, server_farm_id: str=None, sku_name: str=None):
