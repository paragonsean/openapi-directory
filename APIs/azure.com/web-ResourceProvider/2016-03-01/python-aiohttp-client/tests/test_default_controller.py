...
async def test_billing_meters_list(client):
...
async def test_validate(client):
    ...
    """
    validate_request = {"name":"name","location":"location","type":"ServerFarm","properties":{"serverFarmId":"serverFarmId","skuName":"skuName","isSpot":True,"needLinuxWorkers":True,"capacity":1,"hostingEnvironment":"hostingEnvironment"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
