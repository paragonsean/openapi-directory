...
------------- | ------------- | -------------
[**billingMetersList**](DefaultApi.md#billingMetersList) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Web/billingMeters | Gets a list of meters for a given location.
...
> BillingMeterCollection billingMetersList(subscriptionId, apiVersion, opts)
...
apiInstance.billingMetersList(subscriptionId, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
