...
public:
    ...
    */
    virtual void billingMetersList(const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &billing_location = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void listGeoRegions(const QString &subscription_id, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &sku = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &linux_workers_enabled = ::OpenAPI::OptionalParam<bool>());
...
private:
    ...
    void billingMetersListCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void billingMetersListSignal(OAIBillingMeterCollection summary);
    ...
    void billingMetersListSignalFull(OAIHttpRequestWorker *worker, OAIBillingMeterCollection summary);
    ...
    Q_DECL_DEPRECATED_X("Use billingMetersListSignalError() instead")
    void billingMetersListSignalE(OAIBillingMeterCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void billingMetersListSignalError(OAIBillingMeterCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use billingMetersListSignalErrorFull() instead")
    void billingMetersListSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void billingMetersListSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
