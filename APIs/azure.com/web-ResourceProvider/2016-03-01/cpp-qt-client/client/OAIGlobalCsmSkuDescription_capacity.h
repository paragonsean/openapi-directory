...
/*
 * OAIGlobalCsmSkuDescription_capacity.h
 *
 * Description of the App Service plan scale options.
 */

#ifndef OAIGlobalCsmSkuDescription_capacity_H
#define OAIGlobalCsmSkuDescription_capacity_H
...
class OAIGlobalCsmSkuDescription_capacity : public OAIObject {
public:
    OAIGlobalCsmSkuDescription_capacity();
    OAIGlobalCsmSkuDescription_capacity(QString json);
    ~OAIGlobalCsmSkuDescription_capacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlobalCsmSkuDescription_capacity)

#endif // OAIGlobalCsmSkuDescription_capacity_H
