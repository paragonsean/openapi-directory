...
let subscriptionId = "subscriptionId_example"; // String | Your Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).
let apiVersion = "apiVersion_example"; // String | API Version
let validateContainerSettingsRequest = new ApiClient.ValidateContainerSettingsRequest(); // ValidateContainerSettingsRequest | 
apiInstance.validateContainerSettings(resourceGroupName, subscriptionId, apiVersion, validateContainerSettingsRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
