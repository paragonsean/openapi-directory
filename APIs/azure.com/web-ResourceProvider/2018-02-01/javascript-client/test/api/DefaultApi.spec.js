...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    ...
    describe('validateContainerSettings', function() {
      it('should call validateContainerSettings successfully', function(done) {
        //uncomment below and update the code to test validateContainerSettings
        //instance.validateContainerSettings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
