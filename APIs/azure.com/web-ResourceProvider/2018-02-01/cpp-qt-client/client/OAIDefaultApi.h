...
public:
    ...
    * @param[in]  subscription_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  validate_container_settings_request OAIValidateContainerSettingsRequest [required]
    */
    virtual void validateContainerSettings(const QString &resource_group_name, const QString &subscription_id, const QString &api_version, const OAIValidateContainerSettingsRequest &validate_container_settings_request);
...
private:
    ...
    void validateContainerSettingsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void validateContainerSettingsSignal(OAIObject summary);
    ...
    void validateContainerSettingsSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    ...
    Q_DECL_DEPRECATED_X("Use validateContainerSettingsSignalError() instead")
    void validateContainerSettingsSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void validateContainerSettingsSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use validateContainerSettingsSignalErrorFull() instead")
    void validateContainerSettingsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void validateContainerSettingsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
