...
#ifndef OAIBillingMeter_H
#define OAIBillingMeter_H
...
class OAIBillingMeter : public OAIObject {
public:
    OAIBillingMeter();
    OAIBillingMeter(QString json);
    ~OAIBillingMeter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBillingMeter)

#endif // OAIBillingMeter_H
