...
public:
    ...
    bool isHasLinuxWorkers() const;
    void setHasLinuxWorkers(const bool &has_linux_workers);
    bool is_has_linux_workers_Set() const;
    bool is_has_linux_workers_Valid() const;
    ...
    QString getSslCertKeyVaultId() const;
    void setSslCertKeyVaultId(const QString &ssl_cert_key_vault_id);
    bool is_ssl_cert_key_vault_id_Set() const;
    bool is_ssl_cert_key_vault_id_Valid() const;

    QString getSslCertKeyVaultSecretName() const;
    void setSslCertKeyVaultSecretName(const QString &ssl_cert_key_vault_secret_name);
    bool is_ssl_cert_key_vault_secret_name_Set() const;
    bool is_ssl_cert_key_vault_secret_name_Valid() const;
...
private:
    ...
    bool m_has_linux_workers;
    bool m_has_linux_workers_isSet;
    bool m_has_linux_workers_isValid;
    ...
    QString m_ssl_cert_key_vault_id;
    bool m_ssl_cert_key_vault_id_isSet;
    bool m_ssl_cert_key_vault_id_isValid;

    QString m_ssl_cert_key_vault_secret_name;
    bool m_ssl_cert_key_vault_secret_name_isSet;
    bool m_ssl_cert_key_vault_secret_name_isValid;
