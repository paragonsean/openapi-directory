...
/*
 * OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner.h
 *
 * Stamp capacity information.
 */

#ifndef OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner_H
#define OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner_H
...
class OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner : public OAIObject {
public:
    OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner();
    OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner(QString json);
    ~OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner)

#endif // OAIDeploymentLocations_hostingEnvironments_inner_environmentCapacities_inner_H
