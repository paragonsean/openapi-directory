...
class GetPublishingUser200ResponseProperties(Model):
    ...
    def __init__(self, publishing_password: str=None, publishing_password_hash: str=None, publishing_password_hash_salt: str=None, publishing_user_name: str=None, scm_uri: str=None):
        ...
        :param scm_uri: The scm_uri of this GetPublishingUser200ResponseProperties.
        """
        self.openapi_types = {
    ...
    @property
    def scm_uri(self):
        """Gets the scm_uri of this GetPublishingUser200ResponseProperties.

        Url of SCM site.

        :return: The scm_uri of this GetPublishingUser200ResponseProperties.
        :rtype: str
        """
    ...
    def scm_uri(self, scm_uri):
        """Sets the scm_uri of this GetPublishingUser200ResponseProperties.
