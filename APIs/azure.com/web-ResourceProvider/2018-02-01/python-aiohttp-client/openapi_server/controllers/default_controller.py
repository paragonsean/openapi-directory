...
async def list_billing_meters(request: web.Request, subscription_id, api_version, billing_location=None, os_type=None) -> web.Response:
...
async def list_geo_regions(request: web.Request, subscription_id, api_version, sku=None, linux_workers_enabled=None, xenon_workers_enabled=None, linux_dynamic_workers_enabled=None) -> web.Response:
...
async def validate_container_settings(request: web.Request, resource_group_name, subscription_id, api_version, validate_container_settings_request) -> web.Response:
    ...
    :type validate_container_settings_request: dict | bytes

    """
    validate_container_settings_request = ValidateContainerSettingsRequest.from_dict(validate_container_settings_request)
    return web.Response(status=200)
