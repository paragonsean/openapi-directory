...
public class DeploymentLocationsHostingEnvironmentsInner {
  ...
  public static final String SERIALIZED_NAME_HAS_LINUX_WORKERS = "hasLinuxWorkers";
  @SerializedName(SERIALIZED_NAME_HAS_LINUX_WORKERS)
  ...
  public static final String SERIALIZED_NAME_SSL_CERT_KEY_VAULT_ID = "sslCertKeyVaultId";
  @SerializedName(SERIALIZED_NAME_SSL_CERT_KEY_VAULT_ID)
  private String sslCertKeyVaultId;

  public static final String SERIALIZED_NAME_SSL_CERT_KEY_VAULT_SECRET_NAME = "sslCertKeyVaultSecretName";
  @SerializedName(SERIALIZED_NAME_SSL_CERT_KEY_VAULT_SECRET_NAME)
  ...
  public DeploymentLocationsHostingEnvironmentsInner hasLinuxWorkers(Boolean hasLinuxWorkers) {
  ...
  public void setHasLinuxWorkers(Boolean hasLinuxWorkers) {
    this.hasLinuxWorkers = hasLinuxWorkers;
  }
  ...
  public DeploymentLocationsHostingEnvironmentsInner sslCertKeyVaultId(String sslCertKeyVaultId) {
   ...
   * @return sslCertKeyVaultId
   */
  @javax.annotation.Nullable
  public String getSslCertKeyVaultId() {
    return sslCertKeyVaultId;
  }

  public void setSslCertKeyVaultId(String sslCertKeyVaultId) {
    this.sslCertKeyVaultId = sslCertKeyVaultId;
  }


  public DeploymentLocationsHostingEnvironmentsInner sslCertKeyVaultSecretName(String sslCertKeyVaultSecretName) {
   ...
   * @return sslCertKeyVaultSecretName
   */
  @javax.annotation.Nullable
  public String getSslCertKeyVaultSecretName() {
    return sslCertKeyVaultSecretName;
  }

  public void setSslCertKeyVaultSecretName(String sslCertKeyVaultSecretName) {
    this.sslCertKeyVaultSecretName = sslCertKeyVaultSecretName;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowedMultiSizes, deploymentLocationsHostingEnvironmentsInner.allowedMultiSizes) &&
        ...
        Objects.equals(this.hasLinuxWorkers, deploymentLocationsHostingEnvironmentsInner.hasLinuxWorkers) &&
        ...
        Objects.equals(this.sslCertKeyVaultId, deploymentLocationsHostingEnvironmentsInner.sslCertKeyVaultId) &&
        Objects.equals(this.sslCertKeyVaultSecretName, deploymentLocationsHostingEnvironmentsInner.sslCertKeyVaultSecretName) &&
  ...
  public String toString() {
    ...
    sb.append("    hasLinuxWorkers: ").append(toIndentedString(hasLinuxWorkers)).append("\n");
    ...
    sb.append("    sslCertKeyVaultId: ").append(toIndentedString(sslCertKeyVaultId)).append("\n");
    sb.append("    sslCertKeyVaultSecretName: ").append(toIndentedString(sslCertKeyVaultSecretName)).append("\n");
  ...
  static {
    ...
    openapiFields.add("hasLinuxWorkers");
    ...
    openapiFields.add("sslCertKeyVaultId");
    openapiFields.add("sslCertKeyVaultSecretName");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("sslCertKeyVaultId") != null && !jsonObj.get("sslCertKeyVaultId").isJsonNull()) && !jsonObj.get("sslCertKeyVaultId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sslCertKeyVaultId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sslCertKeyVaultId").toString()));
      }
      if ((jsonObj.get("sslCertKeyVaultSecretName") != null && !jsonObj.get("sslCertKeyVaultSecretName").isJsonNull()) && !jsonObj.get("sslCertKeyVaultSecretName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sslCertKeyVaultSecretName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sslCertKeyVaultSecretName").toString()));
      }
