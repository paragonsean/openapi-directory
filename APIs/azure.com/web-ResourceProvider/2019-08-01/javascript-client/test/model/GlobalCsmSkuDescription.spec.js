...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.GlobalCsmSkuDescription();
  });
  ...
  describe('GlobalCsmSkuDescription', function() {
    it('should create an instance of GlobalCsmSkuDescription', function() {
      // uncomment below and update the code to test GlobalCsmSkuDescription
      //var instance = new ApiClient.GlobalCsmSkuDescription();
      //expect(instance).to.be.a(ApiClient.GlobalCsmSkuDescription);
    });
