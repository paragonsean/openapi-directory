...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiClient.SkuInfos();
  });
  ...
  describe('SkuInfos', function() {
    it('should create an instance of SkuInfos', function() {
      // uncomment below and update the code to test SkuInfos
      //var instance = new ApiClient.SkuInfos();
      //expect(instance).to.be.a(ApiClient.SkuInfos);
    });
