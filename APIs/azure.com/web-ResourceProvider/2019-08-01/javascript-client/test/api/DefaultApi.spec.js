...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    ...
    describe('listBillingMeters', function() {
      it('should call listBillingMeters successfully', function(done) {
        //uncomment below and update the code to test listBillingMeters
        //instance.listBillingMeters(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
