...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComputeManagementConvenienceClient.DeploymentPropertiesExtended();
  });
  ...
  describe('DeploymentPropertiesExtended', function() {
    it('should create an instance of DeploymentPropertiesExtended', function() {
      ...
      //var instance = new ComputeManagementConvenienceClient.DeploymentPropertiesExtended();
      //expect(instance).to.be.a(ComputeManagementConvenienceClient.DeploymentPropertiesExtended);
    });
