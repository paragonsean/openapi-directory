# SharedImageGalleryServiceClient.GalleryArtifactPublishingProfileBase
...
**storageAccountType** | **String** | Specifies the storage account type to be used to store the image. This property is not updatable. | [optional] 
...
* `LRS` (value: `"Standard_LRS"`)

* `ZRS` (value: `"Standard_ZRS"`)
