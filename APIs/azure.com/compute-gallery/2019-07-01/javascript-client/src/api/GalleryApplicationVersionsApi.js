...
export default class GalleryApplicationVersionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the galleryApplicationVersionsUpdate operation.
     * @callback module:api/GalleryApplicationVersionsApi~galleryApplicationVersionsUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GalleryApplicationVersion} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client Api Version.
     * @param {module:model/GalleryApplicationVersionUpdate} galleryApplicationVersion Parameters supplied to the update gallery Application Version operation.
     * @param {module:api/GalleryApplicationVersionsApi~galleryApplicationVersionsUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GalleryApplicationVersion}
     */
    galleryApplicationVersionsUpdate(subscriptionId, resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, apiVersion, galleryApplicationVersion, callback) {
      let postBody = galleryApplicationVersion;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling galleryApplicationVersionsUpdate");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling galleryApplicationVersionsUpdate");
      }
      // verify the required parameter 'galleryName' is set
      if (galleryName === undefined || galleryName === null) {
        throw new Error("Missing the required parameter 'galleryName' when calling galleryApplicationVersionsUpdate");
      }
      // verify the required parameter 'galleryApplicationName' is set
      if (galleryApplicationName === undefined || galleryApplicationName === null) {
        throw new Error("Missing the required parameter 'galleryApplicationName' when calling galleryApplicationVersionsUpdate");
      }
      // verify the required parameter 'galleryApplicationVersionName' is set
      if (galleryApplicationVersionName === undefined || galleryApplicationVersionName === null) {
        throw new Error("Missing the required parameter 'galleryApplicationVersionName' when calling galleryApplicationVersionsUpdate");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling galleryApplicationVersionsUpdate");
      }
      // verify the required parameter 'galleryApplicationVersion' is set
      if (galleryApplicationVersion === undefined || galleryApplicationVersion === null) {
        throw new Error("Missing the required parameter 'galleryApplicationVersion' when calling galleryApplicationVersionsUpdate");
      }
      ...
      let returnType = GalleryApplicationVersion;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{galleryApplicationName}/versions/{galleryApplicationVersionName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
