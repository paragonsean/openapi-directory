...
export default class GalleryApplicationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the galleryApplicationsUpdate operation.
     * @callback module:api/GalleryApplicationsApi~galleryApplicationsUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GalleryApplication} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client Api Version.
     * @param {module:model/GalleryApplicationUpdate} galleryApplication Parameters supplied to the update gallery Application operation.
     * @param {module:api/GalleryApplicationsApi~galleryApplicationsUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GalleryApplication}
     */
    galleryApplicationsUpdate(subscriptionId, resourceGroupName, galleryName, galleryApplicationName, apiVersion, galleryApplication, callback) {
      let postBody = galleryApplication;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling galleryApplicationsUpdate");
      }
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling galleryApplicationsUpdate");
      }
      // verify the required parameter 'galleryName' is set
      if (galleryName === undefined || galleryName === null) {
        throw new Error("Missing the required parameter 'galleryName' when calling galleryApplicationsUpdate");
      }
      // verify the required parameter 'galleryApplicationName' is set
      if (galleryApplicationName === undefined || galleryApplicationName === null) {
        throw new Error("Missing the required parameter 'galleryApplicationName' when calling galleryApplicationsUpdate");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling galleryApplicationsUpdate");
      }
      // verify the required parameter 'galleryApplication' is set
      if (galleryApplication === undefined || galleryApplication === null) {
        throw new Error("Missing the required parameter 'galleryApplication' when calling galleryApplicationsUpdate");
      }
      ...
      let returnType = GalleryApplication;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{galleryApplicationName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
