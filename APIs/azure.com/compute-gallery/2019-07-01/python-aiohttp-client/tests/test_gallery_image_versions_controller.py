...
async def test_gallery_image_versions_create_or_update(client):
    ...
    """
    gallery_image_version = {"properties":{"publishingProfile":{"replicaCount":0,"publishedDate":"2000-01-23T04:56:07.000+00:00","storageAccountType":"Standard_LRS","endOfLifeDate":"2000-01-23T04:56:07.000+00:00","excludeFromLatest":True,"targetRegions":[{"name":"name","regionalReplicaCount":6,"storageAccountType":"Standard_LRS"},{"name":"name","regionalReplicaCount":6,"storageAccountType":"Standard_LRS"}]},"storageProfile":{"osDiskImage":{"hostCaching":"None","sizeInGB":5,"source":{"id":"id"}},"source":{"id":"id"},"dataDiskImages":[{"lun":1},{"lun":1}]},"replicationStatus":{"summary":[{"progress":0,"details":"details","state":"Unknown","region":"region"},{"progress":0,"details":"details","state":"Unknown","region":"region"}],"aggregatedState":"Unknown"},"provisioningState":"Creating"}}
...
async def test_gallery_image_versions_update(client):
    """Test case for gallery_image_versions_update
