...
from openapi_server.models.gallery_application_version_update import GalleryApplicationVersionUpdate
...
async def test_gallery_application_versions_update(client):
    """Test case for gallery_application_versions_update
