...
async def gallery_images_update(request: web.Request, subscription_id, resource_group_name, gallery_name, gallery_image_name, api_version, gallery_image) -> web.Response:
    ...
    :param resource_group_name: The name of the resource group.
    :type resource_group_name: str
    :param gallery_name: The name of the Shared Image Gallery in which the Image Definition is to be updated.
    :type gallery_name: str
    :param gallery_image_name: The name of the gallery Image Definition to be updated. The allowed characters are alphabets and numbers with dots, dashes, and periods allowed in the middle. The maximum length is 80 characters.
    :type gallery_image_name: str
    :param api_version: Client Api Version.
    :type api_version: str
    ...
    """
    gallery_image = GalleryImageUpdate.from_dict(gallery_image)
    return web.Response(status=200)
