...
from openapi_server.models.gallery_application_update import GalleryApplicationUpdate
...
async def gallery_applications_update(request: web.Request, subscription_id, resource_group_name, gallery_name, gallery_application_name, api_version, gallery_application) -> web.Response:
    """gallery_applications_update
    ...
    :param resource_group_name: The name of the resource group.
    :type resource_group_name: str
    :param gallery_name: The name of the Shared Application Gallery in which the Application Definition is to be updated.
    :type gallery_name: str
    :param gallery_application_name: The name of the gallery Application Definition to be updated. The allowed characters are alphabets and numbers with dots, dashes, and periods allowed in the middle. The maximum length is 80 characters.
    :type gallery_application_name: str
    :param api_version: Client Api Version.
    :type api_version: str
    ...
    """
    gallery_application = GalleryApplicationUpdate.from_dict(gallery_application)
    return web.Response(status=200)
