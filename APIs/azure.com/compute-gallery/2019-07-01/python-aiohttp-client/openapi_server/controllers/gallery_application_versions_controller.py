...
async def gallery_application_versions_update(request: web.Request, subscription_id, resource_group_name, gallery_name, gallery_application_name, gallery_application_version_name, api_version, gallery_application_version) -> web.Response:
    ...
    :param gallery_name: The name of the Shared Application Gallery in which the Application Definition resides.
    :type gallery_name: str
    :param gallery_application_name: The name of the gallery Application Definition in which the Application Version is to be updated.
    :type gallery_application_name: str
    :param gallery_application_version_name: The name of the gallery Application Version to be updated. Needs to follow semantic version name pattern: The allowed characters are digit and period. Digits must be within the range of a 32-bit integer. Format: &lt;MajorVersion&gt;.&lt;MinorVersion&gt;.&lt;Patch&gt;
    :type gallery_application_version_name: str
    :param api_version: Client Api Version.
    :type api_version: str
    :param gallery_application_version: Parameters supplied to the update gallery Application Version operation.
    :type gallery_application_version: dict | bytes

    """
    gallery_application_version = GalleryApplicationVersionUpdate.from_dict(gallery_application_version)
    return web.Response(status=200)
