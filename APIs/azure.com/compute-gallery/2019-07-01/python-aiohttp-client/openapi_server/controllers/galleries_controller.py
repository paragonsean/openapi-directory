...
async def galleries_update(request: web.Request, subscription_id, resource_group_name, gallery_name, api_version, gallery) -> web.Response:
    """galleries_update
    ...
    """
    gallery = GalleryUpdate.from_dict(gallery)
    return web.Response(status=200)
