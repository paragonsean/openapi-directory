...
class GalleryDataDiskImage(Model):
    ...
    def __init__(self, lun: int=None, host_caching: str=None, size_in_gb: int=None, source: GalleryArtifactVersionSource=None):
        ...
        :param source: The source of this GalleryDataDiskImage.
        """
        self.openapi_types = {
            'lun': int,
            'host_caching': str,
    ...
    @property
    def source(self):
        """Gets the source of this GalleryDataDiskImage.


        :return: The source of this GalleryDataDiskImage.
    ...
    def source(self, source):
        """Sets the source of this GalleryDataDiskImage.
