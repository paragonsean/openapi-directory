...
class GalleryImageProperties(Model):
    ...
    def __init__(self, description: str=None, disallowed: Disallowed=None, end_of_life_date: datetime=None, eula: str=None, hyper_v_generation: str=None, identifier: GalleryImageIdentifier=None, os_state: str=None, os_type: str=None, privacy_statement_uri: str=None, provisioning_state: str=None, purchase_plan: ImagePurchasePlan=None, recommended: RecommendedMachineConfiguration=None, release_note_uri: str=None):
        ...
        :param hyper_v_generation: The hyper_v_generation of this GalleryImageProperties.
    ...
    def hyper_v_generation(self):
        """Gets the hyper_v_generation of this GalleryImageProperties.

        The hypervisor generation of the Virtual Machine. Applicable to OS disks only.

        :return: The hyper_v_generation of this GalleryImageProperties.
        :rtype: str
        """
    ...
    def hyper_v_generation(self, hyper_v_generation):
        """Sets the hyper_v_generation of this GalleryImageProperties.
