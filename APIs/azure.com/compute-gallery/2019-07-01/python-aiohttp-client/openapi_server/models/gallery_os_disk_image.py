...
class GalleryOSDiskImage(Model):
    ...
    def __init__(self, host_caching: str=None, size_in_gb: int=None, source: GalleryArtifactVersionSource=None):
        ...
        :param source: The source of this GalleryOSDiskImage.
        """
        self.openapi_types = {
            'host_caching': str,
            'size_in_gb': int,
    ...
    @property
    def source(self):
        """Gets the source of this GalleryOSDiskImage.


        :return: The source of this GalleryOSDiskImage.
    ...
    def source(self, source):
        """Sets the source of this GalleryOSDiskImage.
