...
public class GalleryImageVersionsApi {
    ...
    /**
     * Build call for galleryImageVersionsUpdate
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The name of the resource group. (required)
     * @param galleryName The name of the Shared Image Gallery in which the Image Definition resides. (required)
     * @param galleryImageName The name of the gallery Image Definition in which the Image Version is to be updated. (required)
     * @param galleryImageVersionName The name of the gallery Image Version to be updated. Needs to follow semantic version name pattern: The allowed characters are digit and period. Digits must be within the range of a 32-bit integer. Format: &lt;MajorVersion&gt;.&lt;MinorVersion&gt;.&lt;Patch&gt; (required)
     * @param apiVersion Client Api Version. (required)
     * @param galleryImageVersion Parameters supplied to the update gallery Image Version operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call galleryImageVersionsUpdateCall(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String galleryImageVersionName, String apiVersion, GalleryImageVersionUpdate galleryImageVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call galleryImageVersionsUpdateValidateBeforeCall(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String galleryImageVersionName, String apiVersion, GalleryImageVersionUpdate galleryImageVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling galleryImageVersionsUpdate(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling galleryImageVersionsUpdate(Async)");
        }

        // verify the required parameter 'galleryName' is set
        if (galleryName == null) {
            throw new ApiException("Missing the required parameter 'galleryName' when calling galleryImageVersionsUpdate(Async)");
        }

        // verify the required parameter 'galleryImageName' is set
        if (galleryImageName == null) {
            throw new ApiException("Missing the required parameter 'galleryImageName' when calling galleryImageVersionsUpdate(Async)");
        }

        // verify the required parameter 'galleryImageVersionName' is set
        if (galleryImageVersionName == null) {
            throw new ApiException("Missing the required parameter 'galleryImageVersionName' when calling galleryImageVersionsUpdate(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling galleryImageVersionsUpdate(Async)");
        }

        // verify the required parameter 'galleryImageVersion' is set
        if (galleryImageVersion == null) {
            throw new ApiException("Missing the required parameter 'galleryImageVersion' when calling galleryImageVersionsUpdate(Async)");
        }

        return galleryImageVersionsUpdateCall(subscriptionId, resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, apiVersion, galleryImageVersion, _callback);
     ...
     */
    public GalleryImageVersion galleryImageVersionsUpdate(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String galleryImageVersionName, String apiVersion, GalleryImageVersionUpdate galleryImageVersion) throws ApiException {
        ApiResponse<GalleryImageVersion> localVarResp = galleryImageVersionsUpdateWithHttpInfo(subscriptionId, resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, apiVersion, galleryImageVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GalleryImageVersion> galleryImageVersionsUpdateWithHttpInfo(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String galleryImageVersionName, String apiVersion, GalleryImageVersionUpdate galleryImageVersion) throws ApiException {
        okhttp3.Call localVarCall = galleryImageVersionsUpdateValidateBeforeCall(subscriptionId, resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, apiVersion, galleryImageVersion, null);
        Type localVarReturnType = new TypeToken<GalleryImageVersion>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call galleryImageVersionsUpdateAsync(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String galleryImageVersionName, String apiVersion, GalleryImageVersionUpdate galleryImageVersion, final ApiCallback<GalleryImageVersion> _callback) throws ApiException {

        okhttp3.Call localVarCall = galleryImageVersionsUpdateValidateBeforeCall(subscriptionId, resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, apiVersion, galleryImageVersion, _callback);
        Type localVarReturnType = new TypeToken<GalleryImageVersion>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
