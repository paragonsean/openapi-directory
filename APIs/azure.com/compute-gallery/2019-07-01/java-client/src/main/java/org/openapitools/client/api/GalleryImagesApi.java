...
public class GalleryImagesApi {
     ...
     * @param subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The name of the resource group. (required)
     * @param galleryName The name of the Shared Image Gallery in which the Image Definition is to be updated. (required)
     * @param galleryImageName The name of the gallery Image Definition to be updated. The allowed characters are alphabets and numbers with dots, dashes, and periods allowed in the middle. The maximum length is 80 characters. (required)
     * @param apiVersion Client Api Version. (required)
     * @param galleryImage Parameters supplied to the update gallery image operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call galleryImagesUpdateCall(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String apiVersion, GalleryImageUpdate galleryImage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call galleryImagesUpdateValidateBeforeCall(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String apiVersion, GalleryImageUpdate galleryImage, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
        ...
        // verify the required parameter 'galleryName' is set
        if (galleryName == null) {
            throw new ApiException("Missing the required parameter 'galleryName' when calling galleryImagesUpdate(Async)");
        }
        ...
        return galleryImagesUpdateCall(subscriptionId, resourceGroupName, galleryName, galleryImageName, apiVersion, galleryImage, _callback);
     ...
     */
    public GalleryImage galleryImagesUpdate(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String apiVersion, GalleryImageUpdate galleryImage) throws ApiException {
        ApiResponse<GalleryImage> localVarResp = galleryImagesUpdateWithHttpInfo(subscriptionId, resourceGroupName, galleryName, galleryImageName, apiVersion, galleryImage);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GalleryImage> galleryImagesUpdateWithHttpInfo(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String apiVersion, GalleryImageUpdate galleryImage) throws ApiException {
        okhttp3.Call localVarCall = galleryImagesUpdateValidateBeforeCall(subscriptionId, resourceGroupName, galleryName, galleryImageName, apiVersion, galleryImage, null);
        Type localVarReturnType = new TypeToken<GalleryImage>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call galleryImagesUpdateAsync(String subscriptionId, String resourceGroupName, String galleryName, String galleryImageName, String apiVersion, GalleryImageUpdate galleryImage, final ApiCallback<GalleryImage> _callback) throws ApiException {

        okhttp3.Call localVarCall = galleryImagesUpdateValidateBeforeCall(subscriptionId, resourceGroupName, galleryName, galleryImageName, apiVersion, galleryImage, _callback);
        Type localVarReturnType = new TypeToken<GalleryImage>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
