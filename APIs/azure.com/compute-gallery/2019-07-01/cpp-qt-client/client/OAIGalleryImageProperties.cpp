...
QString OAIGalleryImageProperties::getHyperVGeneration() const {
    return m_hyper_v_generation;
}
void OAIGalleryImageProperties::setHyperVGeneration(const QString &hyper_v_generation) {
    m_hyper_v_generation = hyper_v_generation;
    m_hyper_v_generation_isSet = true;
}

bool OAIGalleryImageProperties::is_hyper_v_generation_Set() const{
    return m_hyper_v_generation_isSet;
}

bool OAIGalleryImageProperties::is_hyper_v_generation_Valid() const{
