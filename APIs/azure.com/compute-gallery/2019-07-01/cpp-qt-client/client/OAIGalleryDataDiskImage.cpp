...
OAIGalleryArtifactVersionSource OAIGalleryDataDiskImage::getSource() const {
    return m_source;
}
void OAIGalleryDataDiskImage::setSource(const OAIGalleryArtifactVersionSource &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIGalleryDataDiskImage::is_source_Set() const{
    return m_source_isSet;
}

bool OAIGalleryDataDiskImage::is_source_Valid() const{
