...
public:
    ...
    * @param[in]  gallery_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  gallery OAIGalleryUpdate [required]
    */
    virtual void galleriesUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &gallery_name, const QString &api_version, const OAIGalleryUpdate &gallery);
...
private:
    ...
    void galleriesUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void galleriesUpdateSignal(OAIGallery summary);
    ...
    void galleriesUpdateSignalFull(OAIHttpRequestWorker *worker, OAIGallery summary);
    ...
    Q_DECL_DEPRECATED_X("Use galleriesUpdateSignalError() instead")
    void galleriesUpdateSignalE(OAIGallery summary, QNetworkReply::NetworkError error_type, QString error_str);
    void galleriesUpdateSignalError(OAIGallery summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use galleriesUpdateSignalErrorFull() instead")
    void galleriesUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void galleriesUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
