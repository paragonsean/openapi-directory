...
public:
    ...
    * @param[in]  gallery_application_version_name QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  gallery_application_version OAIGalleryApplicationVersionUpdate [required]
    */
    virtual void galleryApplicationVersionsUpdate(const QString &subscription_id, const QString &resource_group_name, const QString &gallery_name, const QString &gallery_application_name, const QString &gallery_application_version_name, const QString &api_version, const OAIGalleryApplicationVersionUpdate &gallery_application_version);
...
private:
    ...
    void galleryApplicationVersionsUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void galleryApplicationVersionsUpdateSignal(OAIGalleryApplicationVersion summary);
    ...
    void galleryApplicationVersionsUpdateSignalFull(OAIHttpRequestWorker *worker, OAIGalleryApplicationVersion summary);
    ...
    Q_DECL_DEPRECATED_X("Use galleryApplicationVersionsUpdateSignalError() instead")
    void galleryApplicationVersionsUpdateSignalE(OAIGalleryApplicationVersion summary, QNetworkReply::NetworkError error_type, QString error_str);
    void galleryApplicationVersionsUpdateSignalError(OAIGalleryApplicationVersion summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use galleryApplicationVersionsUpdateSignalErrorFull() instead")
    void galleryApplicationVersionsUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void galleryApplicationVersionsUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
