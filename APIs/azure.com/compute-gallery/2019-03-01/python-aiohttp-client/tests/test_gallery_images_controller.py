...
async def test_gallery_images_create_or_update(client):
    ...
    """
    gallery_image = {"properties":{"identifier":{"offer":"offer","publisher":"publisher","sku":"sku"},"osState":"Generalized","osType":"Windows","purchasePlan":{"product":"product","name":"name","publisher":"publisher"},"releaseNoteUri":"releaseNoteUri","description":"description","eula":"eula","provisioningState":"Creating","disallowed":{"diskTypes":["diskTypes","diskTypes"]},"endOfLifeDate":"2000-01-23T04:56:07.000+00:00","privacyStatementUri":"privacyStatementUri","recommended":{"memory":{"min":6,"max":0},"vCPUs":{"min":6,"max":0}}}}
