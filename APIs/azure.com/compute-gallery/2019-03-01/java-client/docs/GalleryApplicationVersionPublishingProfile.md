...
|------------ | ------------- | ------------- | -------------|
|**contentType** | **String** | Optional. May be used to help process this file. The type of file contained in the source, e.g. zip, json, etc. |  [optional] |
|**enableHealthCheck** | **Boolean** | Optional. Whether or not this application reports health. |  [optional] |
