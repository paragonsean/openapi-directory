...
public class GalleryImageVersionPublishingProfile {
  ...
  public GalleryImageVersionPublishingProfile source(GalleryArtifactSource source) {
    this.source = source;
    return this;
  }
  ...
  public GalleryImageVersionPublishingProfile endOfLifeDate(OffsetDateTime endOfLifeDate) {
  ...
  public GalleryImageVersionPublishingProfile excludeFromLatest(Boolean excludeFromLatest) {
  ...
  public GalleryImageVersionPublishingProfile replicaCount(Integer replicaCount) {
  ...
  public GalleryImageVersionPublishingProfile storageAccountType(StorageAccountTypeEnum storageAccountType) {
  ...
  public GalleryImageVersionPublishingProfile targetRegions(List<TargetRegion> targetRegions) {
    this.targetRegions = targetRegions;
    return this;
  }

  public GalleryImageVersionPublishingProfile addTargetRegionsItem(TargetRegion targetRegionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GalleryImageVersionPublishingProfile galleryImageVersionPublishingProfile = (GalleryImageVersionPublishingProfile) o;
    return Objects.equals(this.source, galleryImageVersionPublishingProfile.source) &&
        Objects.equals(this.endOfLifeDate, galleryImageVersionPublishingProfile.endOfLifeDate) &&
        Objects.equals(this.excludeFromLatest, galleryImageVersionPublishingProfile.excludeFromLatest) &&
        Objects.equals(this.publishedDate, galleryImageVersionPublishingProfile.publishedDate) &&
        Objects.equals(this.replicaCount, galleryImageVersionPublishingProfile.replicaCount) &&
        Objects.equals(this.storageAccountType, galleryImageVersionPublishingProfile.storageAccountType) &&
        Objects.equals(this.targetRegions, galleryImageVersionPublishingProfile.targetRegions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(source, endOfLifeDate, excludeFromLatest, publishedDate, replicaCount, storageAccountType, targetRegions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GalleryImageVersionPublishingProfile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GalleryImageVersionPublishingProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GalleryImageVersionPublishingProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GalleryImageVersionPublishingProfile is not found in the empty JSON string", GalleryImageVersionPublishingProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GalleryImageVersionPublishingProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GalleryImageVersionPublishingProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GalleryImageVersionPublishingProfile.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GalleryImageVersionPublishingProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GalleryImageVersionPublishingProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GalleryImageVersionPublishingProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GalleryImageVersionPublishingProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<GalleryImageVersionPublishingProfile>() {
           @Override
           public void write(JsonWriter out, GalleryImageVersionPublishingProfile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GalleryImageVersionPublishingProfile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GalleryImageVersionPublishingProfile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GalleryImageVersionPublishingProfile
   * @throws IOException if the JSON string is invalid with respect to GalleryImageVersionPublishingProfile
   */
  public static GalleryImageVersionPublishingProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GalleryImageVersionPublishingProfile.class);
  }

  /**
   * Convert an instance of GalleryImageVersionPublishingProfile to an JSON string
   *
   * @return JSON string
   */
