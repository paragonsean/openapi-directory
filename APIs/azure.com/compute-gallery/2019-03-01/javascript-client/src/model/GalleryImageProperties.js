...
class GalleryImageProperties {
     ...
     * @param osState {module:model/GalleryImageProperties.OsStateEnum} This property allows the user to specify whether the virtual machines created under this image are 'Generalized' or 'Specialized'.
