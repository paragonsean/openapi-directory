...
public class AzureBridgeApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AzureBridgeApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AzureBridgeApi(ApiClient apiClient) {
    ...
    public okhttp3.Call operationsListCall(String apiVersion, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/providers/Microsoft.AzureBridge.Admin/operations";
