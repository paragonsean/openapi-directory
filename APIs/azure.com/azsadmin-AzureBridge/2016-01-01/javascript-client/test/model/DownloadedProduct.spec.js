...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureBridgeAdminClient.DownloadedProduct();
  });
  ...
  describe('DownloadedProduct', function() {
    it('should create an instance of DownloadedProduct', function() {
      // uncomment below and update the code to test DownloadedProduct
      //var instance = new AzureBridgeAdminClient.DownloadedProduct();
      //expect(instance).to.be.a(AzureBridgeAdminClient.DownloadedProduct);
    });
