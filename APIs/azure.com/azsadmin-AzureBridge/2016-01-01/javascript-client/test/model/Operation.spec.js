...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureBridgeAdminClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new AzureBridgeAdminClient.Operation();
      //expect(instance).to.be.a(AzureBridgeAdminClient.Operation);
    });
