...
/**
 * The DownloadedProductAllOfIconUris model module.
 * @module model/DownloadedProductAllOfIconUris
 * @version 2016-01-01
 */
class DownloadedProductAllOfIconUris {
    /**
     * Constructs a new <code>DownloadedProductAllOfIconUris</code>.
     * Icons for the gallery items.
     * @alias module:model/DownloadedProductAllOfIconUris
     */
    constructor() { 
        
        DownloadedProductAllOfIconUris.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DownloadedProductAllOfIconUris</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DownloadedProductAllOfIconUris} obj Optional instance to populate.
     * @return {module:model/DownloadedProductAllOfIconUris} The populated <code>DownloadedProductAllOfIconUris</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DownloadedProductAllOfIconUris();
    ...
    /**
     * Validates the JSON data with respect to <code>DownloadedProductAllOfIconUris</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DownloadedProductAllOfIconUris</code>.
     */
 ...
 * @member {String} hero
 */
DownloadedProductAllOfIconUris.prototype['hero'] = undefined;

/**
 * The large (115x115) icon relative path.
 * @member {String} large
 */
DownloadedProductAllOfIconUris.prototype['large'] = undefined;

/**
 * The medium (90x90) icon relative path.
 * @member {String} medium
 */
DownloadedProductAllOfIconUris.prototype['medium'] = undefined;

/**
 * The small (40x40) icon relative path.
 * @member {String} small
 */
DownloadedProductAllOfIconUris.prototype['small'] = undefined;

/**
 * The wide (255x115) icon relative path.
 * @member {String} wide
 */
DownloadedProductAllOfIconUris.prototype['wide'] = undefined;
...
export default DownloadedProductAllOfIconUris;
