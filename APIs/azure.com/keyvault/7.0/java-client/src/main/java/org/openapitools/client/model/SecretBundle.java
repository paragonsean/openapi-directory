...
public class SecretBundle {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, secretBundle.attributes) &&
        ...
        Objects.equals(this.value, secretBundle.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, contentType, id, kid, managed, tags, value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecretBundle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecretBundle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecretBundle is not found in the empty JSON string", SecretBundle.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecretBundle.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecretBundle` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SecretBundle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SecretBundle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SecretBundle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SecretBundle.class));

       return (TypeAdapter<T>) new TypeAdapter<SecretBundle>() {
           @Override
           public void write(JsonWriter out, SecretBundle value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SecretBundle read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SecretBundle given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SecretBundle
   * @throws IOException if the JSON string is invalid with respect to SecretBundle
   */
  public static SecretBundle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SecretBundle.class);
  }

  /**
   * Convert an instance of SecretBundle to an JSON string
   *
   * @return JSON string
   */
