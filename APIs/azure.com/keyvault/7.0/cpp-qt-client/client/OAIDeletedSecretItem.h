...
/*
 * OAIDeletedSecretItem.h
 *
 * The deleted secret item containing metadata about the deleted secret.
 */

#ifndef OAIDeletedSecretItem_H
#define OAIDeletedSecretItem_H
...
class OAIDeletedSecretItem : public OAIObject {
public:
    OAIDeletedSecretItem();
    OAIDeletedSecretItem(QString json);
    ~OAIDeletedSecretItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletedSecretItem)

#endif // OAIDeletedSecretItem_H
