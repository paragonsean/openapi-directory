...
#ifndef OAISecretBundle_H
#define OAISecretBundle_H
...
class OAISecretBundle : public OAIObject {
public:
    OAISecretBundle();
    OAISecretBundle(QString json);
    ~OAISecretBundle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecretBundle)

#endif // OAISecretBundle_H
