...
#ifndef OAISecretItem_H
#define OAISecretItem_H
...
class OAISecretItem : public OAIObject {
public:
    OAISecretItem();
    OAISecretItem(QString json);
    ~OAISecretItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecretItem)

#endif // OAISecretItem_H
