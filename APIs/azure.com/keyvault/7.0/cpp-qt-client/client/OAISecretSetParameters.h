...
/*
 * OAISecretSetParameters.h
 *
 * The secret set parameters.
 */

#ifndef OAISecretSetParameters_H
#define OAISecretSetParameters_H
...
class OAISecretSetParameters : public OAIObject {
public:
    OAISecretSetParameters();
    OAISecretSetParameters(QString json);
    ~OAISecretSetParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecretSetParameters)

#endif // OAISecretSetParameters_H
