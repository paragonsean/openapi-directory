...
let apiInstance = new KeyVaultClient.KeysApi();
let keyName = "keyName_example"; // String | The name of the key.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.backupKey(keyName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new KeyVaultClient.KeysApi();
let keyName = "keyName_example"; // String | The name for the new key. The system will generate the version name for the new key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyCreateParameters(); // KeyCreateParameters | The parameters to create a key.
apiInstance.createKey(keyName, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new KeyVaultClient.KeysApi();
let keyName = "keyName_example"; // String | The name of the key.
let keyVersion = "keyVersion_example"; // String | The version of the key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyOperationsParameters(); // KeyOperationsParameters | The parameters for the decryption operation.
apiInstance.decrypt(keyName, keyVersion, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new KeyVaultClient.KeysApi();
let keyName = "keyName_example"; // String | The name of the key to delete.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.deleteKey(keyName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let keyVersion = "keyVersion_example"; // String | The version of the key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyOperationsParameters(); // KeyOperationsParameters | The parameters for the encryption operation.
apiInstance.encrypt(keyName, keyVersion, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new KeyVaultClient.KeysApi();
let keyName = "keyName_example"; // String | The name of the key to get.
let keyVersion = "keyVersion_example"; // String | Adding the version parameter retrieves a specific version of a key.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.getKey(keyName, keyVersion, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> KeyListResult getKeyVersions(keyName, apiVersion, opts)
...
apiInstance.getKeyVersions(keyName, apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new KeyVaultClient.KeysApi();
let keyName = "keyName_example"; // String | Name for the imported key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyImportParameters(); // KeyImportParameters | The parameters to import a key.
apiInstance.importKey(keyName, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new KeyVaultClient.KeysApi();
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyRestoreParameters(); // KeyRestoreParameters | The parameters to restore the key.
apiInstance.restoreKey(apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let keyVersion = "keyVersion_example"; // String | The version of the key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeySignParameters(); // KeySignParameters | The parameters for the signing operation.
apiInstance.sign(keyName, keyVersion, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let keyVersion = "keyVersion_example"; // String | The version of the key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyOperationsParameters(); // KeyOperationsParameters | The parameters for the key operation.
apiInstance.unwrapKey(keyName, keyVersion, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new KeyVaultClient.KeysApi();
let keyName = "keyName_example"; // String | The name of key to update.
let keyVersion = "keyVersion_example"; // String | The version of the key to update.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyUpdateParameters(); // KeyUpdateParameters | The parameters of the key to update.
apiInstance.updateKey(keyName, keyVersion, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let keyVersion = "keyVersion_example"; // String | The version of the key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyVerifyParameters(); // KeyVerifyParameters | The parameters for verify operations.
apiInstance.verify(keyName, keyVersion, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let keyVersion = "keyVersion_example"; // String | The version of the key.
let apiVersion = "apiVersion_example"; // String | Client API version.
let parameters = new KeyVaultClient.KeyOperationsParameters(); // KeyOperationsParameters | The parameters for wrap operation.
apiInstance.wrapKey(keyName, keyVersion, apiVersion, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
