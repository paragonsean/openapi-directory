...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultClient.KeyVerifyParameters();
  });
  ...
  describe('KeyVerifyParameters', function() {
    it('should create an instance of KeyVerifyParameters', function() {
      // uncomment below and update the code to test KeyVerifyParameters
      //var instance = new KeyVaultClient.KeyVerifyParameters();
      //expect(instance).to.be.a(KeyVaultClient.KeyVerifyParameters);
    });
