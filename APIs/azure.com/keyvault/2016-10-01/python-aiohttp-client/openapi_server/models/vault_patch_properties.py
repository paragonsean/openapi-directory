...
class VaultPatchProperties(Model):
    ...
    def __init__(self, access_policies: List[AccessPolicyEntry]=None, create_mode: str=None, enable_purge_protection: bool=None, enable_soft_delete: bool=None, enabled_for_deployment: bool=None, enabled_for_disk_encryption: bool=None, enabled_for_template_deployment: bool=None, sku: Sku=None, tenant_id: str=None):
