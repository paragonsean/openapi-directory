...
public class VaultPatchProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessPolicies, createMode, enablePurgeProtection, enableSoftDelete, enabledForDeployment, enabledForDiskEncryption, enabledForTemplateDeployment, sku, tenantId);
  }
