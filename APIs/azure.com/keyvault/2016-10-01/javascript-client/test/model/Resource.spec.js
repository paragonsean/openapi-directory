...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new KeyVaultManagementClient.Resource();
      //expect(instance).to.be.a(KeyVaultManagementClient.Resource);
    });
