...
OAINetworkRuleSet OAIVaultPatchProperties::getNetworkAcls() const {
    return m_network_acls;
}
void OAIVaultPatchProperties::setNetworkAcls(const OAINetworkRuleSet &network_acls) {
    m_network_acls = network_acls;
    m_network_acls_isSet = true;
}

bool OAIVaultPatchProperties::is_network_acls_Set() const{
    return m_network_acls_isSet;
}

bool OAIVaultPatchProperties::is_network_acls_Valid() const{
