...
class NetworkRuleSet(Model):
    ...
    def __init__(self, bypass: str=None, default_action: str=None, ip_rules: List[IPRule]=None, virtual_network_rules: List[VirtualNetworkRule]=None):
    ...
    def bypass(self, bypass):
        ...
        :type bypass: str
        """
        allowed_values = ["AzureServices", "None"]  # noqa: E501
