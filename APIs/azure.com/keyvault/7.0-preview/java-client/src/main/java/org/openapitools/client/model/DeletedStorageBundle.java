...
public class DeletedStorageBundle {
  ...
  public DeletedStorageBundle recoveryId(String recoveryId) {
  ...
  public DeletedStorageBundle attributes(StorageAccountAttributes attributes) {
  ...
  public boolean equals(Object o) {
    ...
    DeletedStorageBundle deletedStorageBundle = (DeletedStorageBundle) o;
    return Objects.equals(this.deletedDate, deletedStorageBundle.deletedDate) &&
        Objects.equals(this.recoveryId, deletedStorageBundle.recoveryId) &&
        Objects.equals(this.scheduledPurgeDate, deletedStorageBundle.scheduledPurgeDate) &&
        Objects.equals(this.activeKeyName, deletedStorageBundle.activeKeyName) &&
        Objects.equals(this.attributes, deletedStorageBundle.attributes) &&
        Objects.equals(this.autoRegenerateKey, deletedStorageBundle.autoRegenerateKey) &&
        Objects.equals(this.id, deletedStorageBundle.id) &&
        Objects.equals(this.regenerationPeriod, deletedStorageBundle.regenerationPeriod) &&
        Objects.equals(this.resourceId, deletedStorageBundle.resourceId) &&
        Objects.equals(this.tags, deletedStorageBundle.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deletedDate, recoveryId, scheduledPurgeDate, activeKeyName, attributes, autoRegenerateKey, id, regenerationPeriod, resourceId, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletedStorageBundle {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletedStorageBundle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletedStorageBundle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletedStorageBundle is not found in the empty JSON string", DeletedStorageBundle.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletedStorageBundle.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletedStorageBundle` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletedStorageBundle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletedStorageBundle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletedStorageBundle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletedStorageBundle.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletedStorageBundle>() {
           @Override
           public void write(JsonWriter out, DeletedStorageBundle value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletedStorageBundle read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletedStorageBundle given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletedStorageBundle
   * @throws IOException if the JSON string is invalid with respect to DeletedStorageBundle
   */
  public static DeletedStorageBundle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletedStorageBundle.class);
  }

  /**
   * Convert an instance of DeletedStorageBundle to an JSON string
   *
   * @return JSON string
   */
