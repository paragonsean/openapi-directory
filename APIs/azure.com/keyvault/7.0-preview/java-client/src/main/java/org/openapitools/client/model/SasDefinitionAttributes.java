...
public class SasDefinitionAttributes {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, sasDefinitionAttributes.created) &&
        Objects.equals(this.enabled, sasDefinitionAttributes.enabled) &&
        Objects.equals(this.recoveryLevel, sasDefinitionAttributes.recoveryLevel) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SasDefinitionAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SasDefinitionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SasDefinitionAttributes is not found in the empty JSON string", SasDefinitionAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SasDefinitionAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SasDefinitionAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SasDefinitionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SasDefinitionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SasDefinitionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SasDefinitionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<SasDefinitionAttributes>() {
           @Override
           public void write(JsonWriter out, SasDefinitionAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SasDefinitionAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SasDefinitionAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SasDefinitionAttributes
   * @throws IOException if the JSON string is invalid with respect to SasDefinitionAttributes
   */
  public static SasDefinitionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SasDefinitionAttributes.class);
  }

  /**
   * Convert an instance of SasDefinitionAttributes to an JSON string
   *
   * @return JSON string
   */
