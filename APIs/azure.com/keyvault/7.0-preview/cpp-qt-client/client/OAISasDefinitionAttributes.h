...
/*
 * OAISasDefinitionAttributes.h
 *
 * The SAS definition management attributes.
 */

#ifndef OAISasDefinitionAttributes_H
#define OAISasDefinitionAttributes_H
...
class OAISasDefinitionAttributes : public OAIObject {
public:
    OAISasDefinitionAttributes();
    OAISasDefinitionAttributes(QString json);
    ~OAISasDefinitionAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISasDefinitionAttributes)

#endif // OAISasDefinitionAttributes_H
