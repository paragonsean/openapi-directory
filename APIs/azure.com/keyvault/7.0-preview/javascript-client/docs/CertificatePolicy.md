# KeyVaultClient.CertificatePolicy
...
**lifetimeActions** | [**[LifetimeAction]**](LifetimeAction.md) | Actions that will be performed by Key Vault over the lifetime of a certificate. | [optional] 
