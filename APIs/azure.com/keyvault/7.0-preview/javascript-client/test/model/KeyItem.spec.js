...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultClient.KeyItem();
  });
  ...
  describe('KeyItem', function() {
    it('should create an instance of KeyItem', function() {
      // uncomment below and update the code to test KeyItem
      //var instance = new KeyVaultClient.KeyItem();
      //expect(instance).to.be.a(KeyVaultClient.KeyItem);
    });
