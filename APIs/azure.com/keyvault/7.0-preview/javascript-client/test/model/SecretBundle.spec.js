...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultClient.SecretBundle();
  });
  ...
  describe('SecretBundle', function() {
    it('should create an instance of SecretBundle', function() {
      // uncomment below and update the code to test SecretBundle
      //var instance = new KeyVaultClient.SecretBundle();
      //expect(instance).to.be.a(KeyVaultClient.SecretBundle);
    });
