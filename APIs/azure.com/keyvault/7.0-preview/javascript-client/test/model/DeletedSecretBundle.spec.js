...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultClient.DeletedSecretBundle();
  });
  ...
  describe('DeletedSecretBundle', function() {
    it('should create an instance of DeletedSecretBundle', function() {
      // uncomment below and update the code to test DeletedSecretBundle
      //var instance = new KeyVaultClient.DeletedSecretBundle();
      //expect(instance).to.be.a(KeyVaultClient.DeletedSecretBundle);
    });
