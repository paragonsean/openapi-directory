...
/**
 * The SecretBundle model module.
 * @module model/SecretBundle
 * @version 7.0-preview
 */
class SecretBundle {
    /**
     * Constructs a new <code>SecretBundle</code>.
     * A secret consisting of a value, id and its attributes.
     * @alias module:model/SecretBundle
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SecretBundle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SecretBundle} obj Optional instance to populate.
     * @return {module:model/SecretBundle} The populated <code>SecretBundle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SecretBundle();
    ...
    /**
     * Validates the JSON data with respect to <code>SecretBundle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SecretBundle</code>.
     */
