...
/**
 * The SasDefinitionBundle model module.
 * @module model/SasDefinitionBundle
 * @version 7.0-preview
 */
class SasDefinitionBundle {
    /**
     * Constructs a new <code>SasDefinitionBundle</code>.
     * A SAS definition bundle consists of key vault SAS definition details plus its attributes.
     * @alias module:model/SasDefinitionBundle
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SasDefinitionBundle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SasDefinitionBundle} obj Optional instance to populate.
     * @return {module:model/SasDefinitionBundle} The populated <code>SasDefinitionBundle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SasDefinitionBundle();
    ...
    /**
     * Validates the JSON data with respect to <code>SasDefinitionBundle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SasDefinitionBundle</code>.
     */
 ...
 * @readonly
 */
SasDefinitionBundle['SasTypeEnum'] = {
...
export default SasDefinitionBundle;
