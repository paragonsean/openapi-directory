...
class OAIPrivateEndpointConnectionItem;
class OAISku;
...
public:
    ...
    QList<OAIPrivateEndpointConnectionItem> getPrivateEndpointConnections() const;
    void setPrivateEndpointConnections(const QList<OAIPrivateEndpointConnectionItem> &private_endpoint_connections);
...
private:
    ...
    QList<OAIPrivateEndpointConnectionItem> m_private_endpoint_connections;
