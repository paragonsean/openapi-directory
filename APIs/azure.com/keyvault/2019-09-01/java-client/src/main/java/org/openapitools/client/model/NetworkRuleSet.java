...
public class NetworkRuleSet {
  ...
  private DefaultActionEnum defaultAction;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("defaultAction") != null && !jsonObj.get("defaultAction").isJsonNull()) && !jsonObj.get("defaultAction").isJsonPrimitive()) {
