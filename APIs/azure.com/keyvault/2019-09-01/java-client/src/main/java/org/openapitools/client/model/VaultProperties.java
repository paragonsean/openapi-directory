...
public class VaultProperties {
  ...
  private List<PrivateEndpointConnectionItem> privateEndpointConnections = new ArrayList<>();
   ...
   */
  @javax.annotation.Nullable
  public List<PrivateEndpointConnectionItem> getPrivateEndpointConnections() {
    return privateEndpointConnections;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessPolicies, vaultProperties.accessPolicies) &&
        ...
        Objects.equals(this.privateEndpointConnections, vaultProperties.privateEndpointConnections) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessPolicies, createMode, enablePurgeProtection, enableSoftDelete, enabledForDeployment, enabledForDiskEncryption, enabledForTemplateDeployment, networkAcls, privateEndpointConnections, sku, tenantId, vaultUri);
  }
      ...
      if (jsonObj.get("privateEndpointConnections") != null && !jsonObj.get("privateEndpointConnections").isJsonNull()) {
        ...
        if (jsonArrayprivateEndpointConnections != null) {
          ...
          for (int i = 0; i < jsonArrayprivateEndpointConnections.size(); i++) {
            PrivateEndpointConnectionItem.validateJsonElement(jsonArrayprivateEndpointConnections.get(i));
          };
        }
      }
