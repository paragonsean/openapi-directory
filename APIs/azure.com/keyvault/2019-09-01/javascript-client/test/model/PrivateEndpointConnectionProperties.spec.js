...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultManagementClient.PrivateEndpointConnectionProperties();
  });
  ...
  describe('PrivateEndpointConnectionProperties', function() {
    it('should create an instance of PrivateEndpointConnectionProperties', function() {
      ...
      //var instance = new KeyVaultManagementClient.PrivateEndpointConnectionProperties();
      //expect(instance).to.be.a(KeyVaultManagementClient.PrivateEndpointConnectionProperties);
    });
