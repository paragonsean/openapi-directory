    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('privateEndpointConnections')) {
                obj['privateEndpointConnections'] = ApiClient.convertToType(data['privateEndpointConnections'], [PrivateEndpointConnectionItem]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['privateEndpointConnections']) { // data not null
            ...
            for (const item of data['privateEndpointConnections']) {
                PrivateEndpointConnectionItem.validateJSON(item);
            };
        }
 ...
 */
VaultProperties.prototype['networkAcls'] = undefined;

/**
 * List of private endpoint connections associated with the key vault.
 * @member {Array.<module:model/PrivateEndpointConnectionItem>} privateEndpointConnections
 */
VaultProperties.prototype['privateEndpointConnections'] = undefined;
