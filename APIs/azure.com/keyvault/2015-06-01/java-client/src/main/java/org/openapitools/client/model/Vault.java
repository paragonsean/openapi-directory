...
public class Vault {
  ...
  public Vault properties(VaultProperties properties) {
  ...
  public Vault location(String location) {
  ...
  public Vault tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public Vault putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    Vault vault = (Vault) o;
    return Objects.equals(this.properties, vault.properties) &&
        Objects.equals(this.id, vault.id) &&
        Objects.equals(this.location, vault.location) &&
