# AdHybridHealthService.AddsServiceMember
...
**addsRoles** | **[String]** | The list of ADDS roles. | [optional] 
**createdDate** | **Date** | The date time , in UTC, when the server was onboarded to Azure Active Directory Connect Health. | [optional] 
**dcTypes** | **[String]** | The list of domain controller types. | [optional] 
**dimensions** | [**[Item]**](Item.md) | The server specific configuration related dimensions. | [optional] 
...
**installedQfes** | [**[Hotfix]**](Hotfix.md) | The list of installed QFEs for the server. | [optional] 
...
**monitoringConfigurationsComputed** | [**[Item]**](Item.md) | The monitoring configuration of the server which determines what activities are monitored by Azure Active Directory Connect Health. | [optional] 
**monitoringConfigurationsCustomized** | [**[Item]**](Item.md) | The customized monitoring configuration of the server which determines what activities are monitored by Azure Active Directory Connect Health. | [optional] 
...
**properties** | [**[Item]**](Item.md) | Server specific properties. | [optional] 
**recommendedQfes** | [**[Hotfix]**](Hotfix.md) | The list of recommended hotfixes for the server. | [optional] 
