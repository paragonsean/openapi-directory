...
export default class OperationsApi {
    ...
    */
     ...
     * @param {module:model/OperationListResponse} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/OperationListResponse}
     */
    operationsList(apiVersion, callback) {
      ...
      let returnType = OperationListResponse;
      return this.apiClient.callApi(
        '/providers/Microsoft.ADHybridHealthService/operations', 'GET',
