...
class Connectors {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Connectors();

            if (data.hasOwnProperty('value')) {
                obj['value'] = ApiClient.convertToType(data['value'], [Connector]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Connectors</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Connectors</code>.
     */
 ...
 * @member {Array.<module:model/Connector>} value
 */
Connectors.prototype['value'] = undefined;
