...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.MetricMetadataList();
  });
  ...
  describe('MetricMetadataList', function() {
    it('should create an instance of MetricMetadataList', function() {
      // uncomment below and update the code to test MetricMetadataList
      //var instance = new AdHybridHealthService.MetricMetadataList();
      //expect(instance).to.be.a(AdHybridHealthService.MetricMetadataList);
    });
