...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.AddsServiceMembers();
  });
  ...
  describe('AddsServiceMembers', function() {
    it('should create an instance of AddsServiceMembers', function() {
      // uncomment below and update the code to test AddsServiceMembers
      //var instance = new AdHybridHealthService.AddsServiceMembers();
      //expect(instance).to.be.a(AdHybridHealthService.AddsServiceMembers);
    });
