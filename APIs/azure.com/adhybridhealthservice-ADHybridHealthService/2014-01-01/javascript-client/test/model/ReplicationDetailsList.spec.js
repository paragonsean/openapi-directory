...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.ReplicationDetailsList();
  });
  ...
  describe('ReplicationDetailsList', function() {
    it('should create an instance of ReplicationDetailsList', function() {
      // uncomment below and update the code to test ReplicationDetailsList
      //var instance = new AdHybridHealthService.ReplicationDetailsList();
      //expect(instance).to.be.a(AdHybridHealthService.ReplicationDetailsList);
    });
