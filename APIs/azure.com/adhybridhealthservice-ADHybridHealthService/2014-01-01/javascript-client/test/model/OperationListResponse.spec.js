...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.OperationListResponse();
  });
  ...
  describe('OperationListResponse', function() {
    it('should create an instance of OperationListResponse', function() {
      ...
      //var instance = new AdHybridHealthService.OperationListResponse();
      //expect(instance).to.be.a(AdHybridHealthService.OperationListResponse);
    });
