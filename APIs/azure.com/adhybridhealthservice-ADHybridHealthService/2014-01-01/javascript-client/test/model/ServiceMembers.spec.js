...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.ServiceMembers();
  });
  ...
  describe('ServiceMembers', function() {
    it('should create an instance of ServiceMembers', function() {
      // uncomment below and update the code to test ServiceMembers
      //var instance = new AdHybridHealthService.ServiceMembers();
      //expect(instance).to.be.a(AdHybridHealthService.ServiceMembers);
    });
