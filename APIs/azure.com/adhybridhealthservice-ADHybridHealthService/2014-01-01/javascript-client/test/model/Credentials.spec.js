...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.Credentials();
  });
  ...
  describe('Credentials', function() {
    it('should create an instance of Credentials', function() {
      ...
      //var instance = new AdHybridHealthService.Credentials();
      //expect(instance).to.be.a(AdHybridHealthService.Credentials);
    });
