...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.Dimensions();
  });
  ...
  describe('Dimensions', function() {
    it('should create an instance of Dimensions', function() {
      ...
      //var instance = new AdHybridHealthService.Dimensions();
      //expect(instance).to.be.a(AdHybridHealthService.Dimensions);
    });
