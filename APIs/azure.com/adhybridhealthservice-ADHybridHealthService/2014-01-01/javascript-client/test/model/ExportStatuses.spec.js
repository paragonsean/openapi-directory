...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdHybridHealthService.ExportStatuses();
  });
  ...
  describe('ExportStatuses', function() {
    it('should create an instance of ExportStatuses', function() {
      // uncomment below and update the code to test ExportStatuses
      //var instance = new AdHybridHealthService.ExportStatuses();
      //expect(instance).to.be.a(AdHybridHealthService.ExportStatuses);
    });
