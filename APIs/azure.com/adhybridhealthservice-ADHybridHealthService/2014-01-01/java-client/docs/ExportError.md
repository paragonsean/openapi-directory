...
|**lastDirSyncTime** | **OffsetDateTime** | The date and time of last sync run. |  [optional] |
...
|**timeFirstOccured** | **OffsetDateTime** | The date and time when the export error first occurred. |  [optional] |
|**timeOccured** | **OffsetDateTime** | The date and time of occurrence. |  [optional] |
