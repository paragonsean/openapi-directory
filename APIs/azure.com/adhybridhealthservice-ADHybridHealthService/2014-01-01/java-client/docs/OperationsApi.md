...
|------------- | ------------- | -------------|
| [**operationsList**](OperationsApi.md#operationsList) | **GET** /providers/Microsoft.ADHybridHealthService/operations |  |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OperationListResponse result = apiInstance.operationsList(apiVersion);
