...
|**createdDate** | **OffsetDateTime** | The date and time, in UTC, when the service was onboarded to Azure Active Directory Connect Health. |  [optional] |
|**customNotificationEmails** | **List&lt;String&gt;** | The list of additional emails that are configured to receive notifications about the service. |  [optional] |
...
|**lastDisabled** | **OffsetDateTime** | The date and time, in UTC, when the service was last disabled. |  [optional] |
...
|**notificationEmails** | **List&lt;String&gt;** | The list of emails to whom service notifications will be sent. |  [optional] |
