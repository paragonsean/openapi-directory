...
public class Services {
  ...
  private List<ServiceProperties> value = new ArrayList<>();

  public Services() {
  }

  public Services continuationToken(String continuationToken) {
  ...
  public Services nextLink(String nextLink) {
  ...
  public Services totalCount(Integer totalCount) {
  ...
  public Services value(List<ServiceProperties> value) {
    this.value = value;
    return this;
  }

  public Services addValueItem(ServiceProperties valueItem) {
    if (this.value == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ServiceProperties> getValue() {
    return value;
  }

  public void setValue(List<ServiceProperties> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.continuationToken, services.continuationToken) &&
        Objects.equals(this.nextLink, services.nextLink) &&
        Objects.equals(this.totalCount, services.totalCount) &&
        Objects.equals(this.value, services.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            ServiceProperties.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
