...
void OAIAlertsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("serviceMembersListAlerts", defaultConf);
    _serverIndices.insert("serviceMembersListAlerts", 0);
    _serverConfigs.insert("servicesListAlerts", defaultConf);
    _serverIndices.insert("servicesListAlerts", 0);
}
...
void OAIAlertsApi::serviceMembersListAlerts(const QString &service_member_id, const QString &service_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &state, const ::OpenAPI::OptionalParam<QDateTime> &from, const ::OpenAPI::OptionalParam<QDateTime> &to) {
    QString fullPath = QString(_serverConfigs["serviceMembersListAlerts"][_serverIndices.value("serviceMembersListAlerts")].URL()+"/providers/Microsoft.ADHybridHealthService/services/{serviceName}/servicemembers/{serviceMemberId}/alerts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::serviceMembersListAlertsCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::serviceMembersListAlertsCallback);
...
void OAIAlertsApi::serviceMembersListAlertsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT serviceMembersListAlertsSignal(output);
        Q_EMIT serviceMembersListAlertsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT serviceMembersListAlertsSignalE(output, error_type, error_str);
        Q_EMIT serviceMembersListAlertsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT serviceMembersListAlertsSignalError(output, error_type, error_str);
        Q_EMIT serviceMembersListAlertsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAlertsApi::servicesListAlerts(const QString &service_name, const QString &api_version, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &state, const ::OpenAPI::OptionalParam<QDateTime> &from, const ::OpenAPI::OptionalParam<QDateTime> &to) {
    QString fullPath = QString(_serverConfigs["servicesListAlerts"][_serverIndices.value("servicesListAlerts")].URL()+"/providers/Microsoft.ADHybridHealthService/services/{serviceName}/alerts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::servicesListAlertsCallback);
    connect(this, &OAIAlertsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAlertsApi::servicesListAlertsCallback);
    connect(this, &OAIAlertsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAlertsApi::servicesListAlertsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT servicesListAlertsSignal(output);
        Q_EMIT servicesListAlertsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_implicitFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("user_impersonation");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT servicesListAlertsSignalE(output, error_type, error_str);
        Q_EMIT servicesListAlertsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT servicesListAlertsSignalError(output, error_type, error_str);
        Q_EMIT servicesListAlertsSignalErrorFull(worker, error_type, error_str);
    }
}
