...
/*
 * OAIAddsServiceMembers.h
 *
 * The list of  ADDS service members.
 */

#ifndef OAIAddsServiceMembers_H
#define OAIAddsServiceMembers_H
...
namespace OpenAPI {
class OAIAddsServiceMember;

class OAIAddsServiceMembers : public OAIObject {
public:
    OAIAddsServiceMembers();
    OAIAddsServiceMembers(QString json);
    ~OAIAddsServiceMembers() override;
    ...
    QList<OAIAddsServiceMember> getValue() const;
    void setValue(const QList<OAIAddsServiceMember> &value);
...
private:
    ...
    QList<OAIAddsServiceMember> m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddsServiceMembers)

#endif // OAIAddsServiceMembers_H
