...
QString OAIMetrics::getContinuationToken() const {
    return m_continuation_token;
}
void OAIMetrics::setContinuationToken(const QString &continuation_token) {
    m_continuation_token = continuation_token;
    m_continuation_token_isSet = true;
}

bool OAIMetrics::is_continuation_token_Set() const{
    return m_continuation_token_isSet;
}

bool OAIMetrics::is_continuation_token_Valid() const{
    return m_continuation_token_isValid;
}

QString OAIMetrics::getNextLink() const {
    return m_next_link;
}
void OAIMetrics::setNextLink(const QString &next_link) {
    m_next_link = next_link;
    m_next_link_isSet = true;
}

bool OAIMetrics::is_next_link_Set() const{
    return m_next_link_isSet;
}

bool OAIMetrics::is_next_link_Valid() const{
    return m_next_link_isValid;
}

qint32 OAIMetrics::getTotalCount() const {
    return m_total_count;
}
void OAIMetrics::setTotalCount(const qint32 &total_count) {
    m_total_count = total_count;
    m_total_count_isSet = true;
}

bool OAIMetrics::is_total_count_Set() const{
    return m_total_count_isSet;
}

bool OAIMetrics::is_total_count_Valid() const{
    return m_total_count_isValid;
}

QList<OAIItem> OAIMetrics::getValue() const {
    return m_value;
}
void OAIMetrics::setValue(const QList<OAIItem> &value) {
    m_value = value;
    m_value_isSet = true;
}
