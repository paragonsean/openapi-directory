...
#ifndef OAIServiceMembers_H
#define OAIServiceMembers_H
...
namespace OpenAPI {
class OAIServiceMember;

class OAIServiceMembers : public OAIObject {
public:
    OAIServiceMembers();
    OAIServiceMembers(QString json);
    ~OAIServiceMembers() override;
    ...
    QList<OAIServiceMember> getValue() const;
    void setValue(const QList<OAIServiceMember> &value);
...
private:
    ...
    QList<OAIServiceMember> m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceMembers)

#endif // OAIServiceMembers_H
