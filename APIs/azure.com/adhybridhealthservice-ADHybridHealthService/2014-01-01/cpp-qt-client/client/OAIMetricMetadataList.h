...
/*
 * OAIMetricMetadataList.h
 *
 * The list of metric metadata.
 */

#ifndef OAIMetricMetadataList_H
#define OAIMetricMetadataList_H
...
class OAIMetricMetadataList : public OAIObject {
public:
    OAIMetricMetadataList();
    OAIMetricMetadataList(QString json);
    ~OAIMetricMetadataList() override;
    ...
    QList<OAIMetricMetadata> getValue() const;
    void setValue(const QList<OAIMetricMetadata> &value);
...
private:
    ...
    QList<OAIMetricMetadata> m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricMetadataList)

#endif // OAIMetricMetadataList_H
