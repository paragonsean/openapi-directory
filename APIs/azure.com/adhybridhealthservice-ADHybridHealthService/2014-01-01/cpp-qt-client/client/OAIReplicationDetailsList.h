...
/*
 * OAIReplicationDetailsList.h
 *
 * The list of replication details.
 */

#ifndef OAIReplicationDetailsList_H
#define OAIReplicationDetailsList_H
...
namespace OpenAPI {
class OAIReplicationSummary;

class OAIReplicationDetailsList : public OAIObject {
public:
    OAIReplicationDetailsList();
    OAIReplicationDetailsList(QString json);
    ~OAIReplicationDetailsList() override;
    ...
    QList<OAIReplicationSummary> getValue() const;
    void setValue(const QList<OAIReplicationSummary> &value);
...
private:
    ...
    QList<OAIReplicationSummary> m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicationDetailsList)

#endif // OAIReplicationDetailsList_H
