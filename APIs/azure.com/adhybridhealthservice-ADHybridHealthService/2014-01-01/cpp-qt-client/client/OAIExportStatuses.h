...
#ifndef OAIExportStatuses_H
#define OAIExportStatuses_H
...
namespace OpenAPI {
class OAIExportStatus;

class OAIExportStatuses : public OAIObject {
public:
    OAIExportStatuses();
    OAIExportStatuses(QString json);
    ~OAIExportStatuses() override;
    ...
    QList<OAIExportStatus> getValue() const;
    void setValue(const QList<OAIExportStatus> &value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportStatuses)

#endif // OAIExportStatuses_H
