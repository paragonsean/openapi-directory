...
async def storage_systems_get(request: web.Request, subscription_id, resource_group_name, location, storage_sub_system, api_version) -> web.Response:
    """storage_systems_get
...
async def storage_systems_list(request: web.Request, subscription_id, resource_group_name, location, api_version, filter=None) -> web.Response:
