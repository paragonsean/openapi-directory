...
public class AuthorizationServerUpdateContractProperties {
  ...
  public AuthorizationServerUpdateContractProperties authorizationEndpoint(String authorizationEndpoint) {
  ...
  public AuthorizationServerUpdateContractProperties clientId(String clientId) {
  ...
  public AuthorizationServerUpdateContractProperties clientRegistrationEndpoint(String clientRegistrationEndpoint) {
  ...
  public AuthorizationServerUpdateContractProperties displayName(String displayName) {
  ...
  public AuthorizationServerUpdateContractProperties grantTypes(List<GrantTypesEnum> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public AuthorizationServerUpdateContractProperties addGrantTypesItem(GrantTypesEnum grantTypesItem) {
  ...
  public AuthorizationServerUpdateContractProperties authorizationMethods(List<AuthorizationMethodsEnum> authorizationMethods) {
    this.authorizationMethods = authorizationMethods;
    return this;
  }

  public AuthorizationServerUpdateContractProperties addAuthorizationMethodsItem(AuthorizationMethodsEnum authorizationMethodsItem) {
  ...
  public AuthorizationServerUpdateContractProperties bearerTokenSendingMethods(List<BearerTokenSendingMethodsEnum> bearerTokenSendingMethods) {
    this.bearerTokenSendingMethods = bearerTokenSendingMethods;
    return this;
  }

  public AuthorizationServerUpdateContractProperties addBearerTokenSendingMethodsItem(BearerTokenSendingMethodsEnum bearerTokenSendingMethodsItem) {
  ...
  public AuthorizationServerUpdateContractProperties clientAuthenticationMethod(List<ClientAuthenticationMethodEnum> clientAuthenticationMethod) {
    this.clientAuthenticationMethod = clientAuthenticationMethod;
    return this;
  }

  public AuthorizationServerUpdateContractProperties addClientAuthenticationMethodItem(ClientAuthenticationMethodEnum clientAuthenticationMethodItem) {
  ...
  public AuthorizationServerUpdateContractProperties clientSecret(String clientSecret) {
  ...
  public AuthorizationServerUpdateContractProperties defaultScope(String defaultScope) {
  ...
  public AuthorizationServerUpdateContractProperties description(String description) {
  ...
  public AuthorizationServerUpdateContractProperties resourceOwnerPassword(String resourceOwnerPassword) {
  ...
  public AuthorizationServerUpdateContractProperties resourceOwnerUsername(String resourceOwnerUsername) {
  ...
  public AuthorizationServerUpdateContractProperties supportState(Boolean supportState) {
  ...
  public AuthorizationServerUpdateContractProperties tokenBodyParameters(List<TokenBodyParameterContract> tokenBodyParameters) {
    this.tokenBodyParameters = tokenBodyParameters;
    return this;
  }

  public AuthorizationServerUpdateContractProperties addTokenBodyParametersItem(TokenBodyParameterContract tokenBodyParametersItem) {
  ...
  public AuthorizationServerUpdateContractProperties tokenEndpoint(String tokenEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    AuthorizationServerUpdateContractProperties authorizationServerUpdateContractProperties = (AuthorizationServerUpdateContractProperties) o;
    return Objects.equals(this.authorizationEndpoint, authorizationServerUpdateContractProperties.authorizationEndpoint) &&
        Objects.equals(this.clientId, authorizationServerUpdateContractProperties.clientId) &&
        Objects.equals(this.clientRegistrationEndpoint, authorizationServerUpdateContractProperties.clientRegistrationEndpoint) &&
        Objects.equals(this.displayName, authorizationServerUpdateContractProperties.displayName) &&
        Objects.equals(this.grantTypes, authorizationServerUpdateContractProperties.grantTypes) &&
        Objects.equals(this.authorizationMethods, authorizationServerUpdateContractProperties.authorizationMethods) &&
        Objects.equals(this.bearerTokenSendingMethods, authorizationServerUpdateContractProperties.bearerTokenSendingMethods) &&
        Objects.equals(this.clientAuthenticationMethod, authorizationServerUpdateContractProperties.clientAuthenticationMethod) &&
        Objects.equals(this.clientSecret, authorizationServerUpdateContractProperties.clientSecret) &&
        Objects.equals(this.defaultScope, authorizationServerUpdateContractProperties.defaultScope) &&
        Objects.equals(this.description, authorizationServerUpdateContractProperties.description) &&
        Objects.equals(this.resourceOwnerPassword, authorizationServerUpdateContractProperties.resourceOwnerPassword) &&
        Objects.equals(this.resourceOwnerUsername, authorizationServerUpdateContractProperties.resourceOwnerUsername) &&
        Objects.equals(this.supportState, authorizationServerUpdateContractProperties.supportState) &&
        Objects.equals(this.tokenBodyParameters, authorizationServerUpdateContractProperties.tokenBodyParameters) &&
        Objects.equals(this.tokenEndpoint, authorizationServerUpdateContractProperties.tokenEndpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationEndpoint, clientId, clientRegistrationEndpoint, displayName, grantTypes, authorizationMethods, bearerTokenSendingMethods, clientAuthenticationMethod, clientSecret, defaultScope, description, resourceOwnerPassword, resourceOwnerUsername, supportState, tokenBodyParameters, tokenEndpoint);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthorizationServerUpdateContractProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthorizationServerUpdateContractProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthorizationServerUpdateContractProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizationServerUpdateContractProperties is not found in the empty JSON string", AuthorizationServerUpdateContractProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthorizationServerUpdateContractProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthorizationServerUpdateContractProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizationServerUpdateContractProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizationServerUpdateContractProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizationServerUpdateContractProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizationServerUpdateContractProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizationServerUpdateContractProperties>() {
           @Override
           public void write(JsonWriter out, AuthorizationServerUpdateContractProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthorizationServerUpdateContractProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthorizationServerUpdateContractProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthorizationServerUpdateContractProperties
   * @throws IOException if the JSON string is invalid with respect to AuthorizationServerUpdateContractProperties
   */
  public static AuthorizationServerUpdateContractProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizationServerUpdateContractProperties.class);
  }

  /**
   * Convert an instance of AuthorizationServerUpdateContractProperties to an JSON string
   *
   * @return JSON string
   */
