...
public class AuthorizationServerContractBaseProperties {
  ...
  public AuthorizationServerContractBaseProperties authorizationMethods(List<AuthorizationMethodsEnum> authorizationMethods) {
    this.authorizationMethods = authorizationMethods;
    return this;
  }

  public AuthorizationServerContractBaseProperties addAuthorizationMethodsItem(AuthorizationMethodsEnum authorizationMethodsItem) {
  ...
  public AuthorizationServerContractBaseProperties bearerTokenSendingMethods(List<BearerTokenSendingMethodsEnum> bearerTokenSendingMethods) {
    this.bearerTokenSendingMethods = bearerTokenSendingMethods;
    return this;
  }

  public AuthorizationServerContractBaseProperties addBearerTokenSendingMethodsItem(BearerTokenSendingMethodsEnum bearerTokenSendingMethodsItem) {
  ...
  public AuthorizationServerContractBaseProperties clientAuthenticationMethod(List<ClientAuthenticationMethodEnum> clientAuthenticationMethod) {
    this.clientAuthenticationMethod = clientAuthenticationMethod;
    return this;
  }

  public AuthorizationServerContractBaseProperties addClientAuthenticationMethodItem(ClientAuthenticationMethodEnum clientAuthenticationMethodItem) {
  ...
  public AuthorizationServerContractBaseProperties clientSecret(String clientSecret) {
  ...
  public AuthorizationServerContractBaseProperties defaultScope(String defaultScope) {
  ...
  public AuthorizationServerContractBaseProperties description(String description) {
  ...
  public AuthorizationServerContractBaseProperties resourceOwnerPassword(String resourceOwnerPassword) {
  ...
  public AuthorizationServerContractBaseProperties resourceOwnerUsername(String resourceOwnerUsername) {
  ...
  public AuthorizationServerContractBaseProperties supportState(Boolean supportState) {
  ...
  public AuthorizationServerContractBaseProperties tokenBodyParameters(List<TokenBodyParameterContract> tokenBodyParameters) {
    this.tokenBodyParameters = tokenBodyParameters;
    return this;
  }

  public AuthorizationServerContractBaseProperties addTokenBodyParametersItem(TokenBodyParameterContract tokenBodyParametersItem) {
  ...
  public AuthorizationServerContractBaseProperties tokenEndpoint(String tokenEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    AuthorizationServerContractBaseProperties authorizationServerContractBaseProperties = (AuthorizationServerContractBaseProperties) o;
    return Objects.equals(this.authorizationMethods, authorizationServerContractBaseProperties.authorizationMethods) &&
        Objects.equals(this.bearerTokenSendingMethods, authorizationServerContractBaseProperties.bearerTokenSendingMethods) &&
        Objects.equals(this.clientAuthenticationMethod, authorizationServerContractBaseProperties.clientAuthenticationMethod) &&
        Objects.equals(this.clientSecret, authorizationServerContractBaseProperties.clientSecret) &&
        Objects.equals(this.defaultScope, authorizationServerContractBaseProperties.defaultScope) &&
        Objects.equals(this.description, authorizationServerContractBaseProperties.description) &&
        Objects.equals(this.resourceOwnerPassword, authorizationServerContractBaseProperties.resourceOwnerPassword) &&
        Objects.equals(this.resourceOwnerUsername, authorizationServerContractBaseProperties.resourceOwnerUsername) &&
        Objects.equals(this.supportState, authorizationServerContractBaseProperties.supportState) &&
        Objects.equals(this.tokenBodyParameters, authorizationServerContractBaseProperties.tokenBodyParameters) &&
        Objects.equals(this.tokenEndpoint, authorizationServerContractBaseProperties.tokenEndpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationMethods, bearerTokenSendingMethods, clientAuthenticationMethod, clientSecret, defaultScope, description, resourceOwnerPassword, resourceOwnerUsername, supportState, tokenBodyParameters, tokenEndpoint);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthorizationServerContractBaseProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthorizationServerContractBaseProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthorizationServerContractBaseProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizationServerContractBaseProperties is not found in the empty JSON string", AuthorizationServerContractBaseProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthorizationServerContractBaseProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthorizationServerContractBaseProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizationServerContractBaseProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizationServerContractBaseProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizationServerContractBaseProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizationServerContractBaseProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizationServerContractBaseProperties>() {
           @Override
           public void write(JsonWriter out, AuthorizationServerContractBaseProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthorizationServerContractBaseProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthorizationServerContractBaseProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthorizationServerContractBaseProperties
   * @throws IOException if the JSON string is invalid with respect to AuthorizationServerContractBaseProperties
   */
  public static AuthorizationServerContractBaseProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizationServerContractBaseProperties.class);
  }

  /**
   * Convert an instance of AuthorizationServerContractBaseProperties to an JSON string
   *
   * @return JSON string
   */
