...
/**
 * The AuthorizationServerContractProperties model module.
 * @module model/AuthorizationServerContractProperties
 * @version 2017-03-01
 */
class AuthorizationServerContractProperties {
    /**
     * Constructs a new <code>AuthorizationServerContractProperties</code>.
     * External OAuth authorization server settings Properties.
     * @alias module:model/AuthorizationServerContractProperties
    ...
    constructor() { 
        ...
        AuthorizationServerContractProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AuthorizationServerContractProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthorizationServerContractProperties} obj Optional instance to populate.
     * @return {module:model/AuthorizationServerContractProperties} The populated <code>AuthorizationServerContractProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthorizationServerContractProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthorizationServerContractProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthorizationServerContractProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthorizationServerContractProperties.RequiredProperties) {
...
AuthorizationServerContractProperties.RequiredProperties = ["authorizationEndpoint", "clientId", "clientRegistrationEndpoint", "displayName", "grantTypes"];

/**
 * OAuth authorization endpoint. See http://tools.ietf.org/html/rfc6749#section-3.2.
 * @member {String} authorizationEndpoint
 */
AuthorizationServerContractProperties.prototype['authorizationEndpoint'] = undefined;

/**
 * Client or app id registered with this authorization server.
 * @member {String} clientId
 */
AuthorizationServerContractProperties.prototype['clientId'] = undefined;

/**
 * Optional reference to a page where client or app registration for this authorization server is performed. Contains absolute URL to entity being referenced.
 * @member {String} clientRegistrationEndpoint
 */
AuthorizationServerContractProperties.prototype['clientRegistrationEndpoint'] = undefined;

/**
 * User-friendly authorization server name.
 * @member {String} displayName
 */
AuthorizationServerContractProperties.prototype['displayName'] = undefined;

/**
 * Form of an authorization grant, which the client uses to request the access token.
 * @member {Array.<module:model/AuthorizationServerContractProperties.GrantTypesEnum>} grantTypes
 */
AuthorizationServerContractProperties.prototype['grantTypes'] = undefined;

/**
 * HTTP verbs supported by the authorization endpoint. GET must be always present. POST is optional.
 * @member {Array.<module:model/AuthorizationServerContractProperties.AuthorizationMethodsEnum>} authorizationMethods
 */
AuthorizationServerContractProperties.prototype['authorizationMethods'] = undefined;

/**
 * Specifies the mechanism by which access token is passed to the API. 
 * @member {Array.<module:model/AuthorizationServerContractProperties.BearerTokenSendingMethodsEnum>} bearerTokenSendingMethods
 */
AuthorizationServerContractProperties.prototype['bearerTokenSendingMethods'] = undefined;

/**
 * Method of authentication supported by the token endpoint of this authorization server. Possible values are Basic and/or Body. When Body is specified, client credentials and other parameters are passed within the request body in the application/x-www-form-urlencoded format.
 * @member {Array.<module:model/AuthorizationServerContractProperties.ClientAuthenticationMethodEnum>} clientAuthenticationMethod
 */
AuthorizationServerContractProperties.prototype['clientAuthenticationMethod'] = undefined;

/**
 * Client or app secret registered with this authorization server.
 * @member {String} clientSecret
 */
AuthorizationServerContractProperties.prototype['clientSecret'] = undefined;

/**
 * Access token scope that is going to be requested by default. Can be overridden at the API level. Should be provided in the form of a string containing space-delimited values.
 * @member {String} defaultScope
 */
AuthorizationServerContractProperties.prototype['defaultScope'] = undefined;

/**
 * Description of the authorization server. Can contain HTML formatting tags.
 * @member {String} description
 */
AuthorizationServerContractProperties.prototype['description'] = undefined;

/**
 * Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner password.
 * @member {String} resourceOwnerPassword
 */
AuthorizationServerContractProperties.prototype['resourceOwnerPassword'] = undefined;

/**
 * Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner username.
 * @member {String} resourceOwnerUsername
 */
AuthorizationServerContractProperties.prototype['resourceOwnerUsername'] = undefined;

/**
 * If true, authorization server will include state parameter from the authorization request to its response. Client may use state parameter to raise protocol security.
 * @member {Boolean} supportState
 */
AuthorizationServerContractProperties.prototype['supportState'] = undefined;

/**
 * Additional parameters required by the token endpoint of this authorization server represented as an array of JSON objects with name and value string properties, i.e. {\"name\" : \"name value\", \"value\": \"a value\"}.
 * @member {Array.<module:model/TokenBodyParameterContract>} tokenBodyParameters
 */
AuthorizationServerContractProperties.prototype['tokenBodyParameters'] = undefined;

/**
 * OAuth token endpoint. Contains absolute URI to entity being referenced.
 * @member {String} tokenEndpoint
 */
AuthorizationServerContractProperties.prototype['tokenEndpoint'] = undefined;
 ...
 * @readonly
 */
AuthorizationServerContractProperties['GrantTypesEnum'] = {
 ...
 * @readonly
 */
AuthorizationServerContractProperties['AuthorizationMethodsEnum'] = {
 ...
 * @readonly
 */
AuthorizationServerContractProperties['BearerTokenSendingMethodsEnum'] = {
 ...
 * @readonly
 */
AuthorizationServerContractProperties['ClientAuthenticationMethodEnum'] = {
...
export default AuthorizationServerContractProperties;
