...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.AuthorizationServerUpdateContractProperties();
  });
  ...
  describe('AuthorizationServerUpdateContractProperties', function() {
    it('should create an instance of AuthorizationServerUpdateContractProperties', function() {
      // uncomment below and update the code to test AuthorizationServerUpdateContractProperties
      //var instance = new ApiManagementClient.AuthorizationServerUpdateContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.AuthorizationServerUpdateContractProperties);
    });
