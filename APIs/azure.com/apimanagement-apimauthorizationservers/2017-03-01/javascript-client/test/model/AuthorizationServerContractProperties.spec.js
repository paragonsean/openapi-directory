...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.AuthorizationServerContractProperties();
  });
  ...
  describe('AuthorizationServerContractProperties', function() {
    it('should create an instance of AuthorizationServerContractProperties', function() {
      // uncomment below and update the code to test AuthorizationServerContractProperties
      //var instance = new ApiManagementClient.AuthorizationServerContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.AuthorizationServerContractProperties);
    });
