...
> AuthorizationServerContract authorizationServerCreateOrUpdate(resourceGroupName, serviceName, authsid, apiVersion, subscriptionId, parameters, opts)
...
let parameters = new ApiManagementClient.AuthorizationServerContract(); // AuthorizationServerContract | Create or update parameters.
let opts = {
...
> AuthorizationServerCollection authorizationServerListByService(resourceGroupName, serviceName, apiVersion, subscriptionId, opts)
...
let apiVersion = "apiVersion_example"; // String | Version of the API to be used with the client request.
let subscriptionId = "subscriptionId_example"; // String | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let parameters = new ApiManagementClient.AuthorizationServerUpdateContract(); // AuthorizationServerUpdateContract | OAuth2 Server settings Update parameters.
