...
public class AuthorizationServerContractProperties {
  ...
  public AuthorizationServerContractProperties authorizationEndpoint(String authorizationEndpoint) {
  ...
  public AuthorizationServerContractProperties clientId(String clientId) {
  ...
  public AuthorizationServerContractProperties clientRegistrationEndpoint(String clientRegistrationEndpoint) {
  ...
  public AuthorizationServerContractProperties displayName(String displayName) {
  ...
  public AuthorizationServerContractProperties grantTypes(List<GrantTypesEnum> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public AuthorizationServerContractProperties addGrantTypesItem(GrantTypesEnum grantTypesItem) {
  ...
  public AuthorizationServerContractProperties authorizationMethods(List<AuthorizationMethodsEnum> authorizationMethods) {
    this.authorizationMethods = authorizationMethods;
    return this;
  }

  public AuthorizationServerContractProperties addAuthorizationMethodsItem(AuthorizationMethodsEnum authorizationMethodsItem) {
  ...
  public AuthorizationServerContractProperties bearerTokenSendingMethods(List<BearerTokenSendingMethodsEnum> bearerTokenSendingMethods) {
    this.bearerTokenSendingMethods = bearerTokenSendingMethods;
    return this;
  }

  public AuthorizationServerContractProperties addBearerTokenSendingMethodsItem(BearerTokenSendingMethodsEnum bearerTokenSendingMethodsItem) {
  ...
  public AuthorizationServerContractProperties clientAuthenticationMethod(List<ClientAuthenticationMethodEnum> clientAuthenticationMethod) {
    this.clientAuthenticationMethod = clientAuthenticationMethod;
    return this;
  }

  public AuthorizationServerContractProperties addClientAuthenticationMethodItem(ClientAuthenticationMethodEnum clientAuthenticationMethodItem) {
  ...
  public AuthorizationServerContractProperties clientSecret(String clientSecret) {
  ...
  public AuthorizationServerContractProperties defaultScope(String defaultScope) {
  ...
  public AuthorizationServerContractProperties description(String description) {
  ...
  public AuthorizationServerContractProperties resourceOwnerPassword(String resourceOwnerPassword) {
  ...
  public AuthorizationServerContractProperties resourceOwnerUsername(String resourceOwnerUsername) {
  ...
  public AuthorizationServerContractProperties supportState(Boolean supportState) {
  ...
  public AuthorizationServerContractProperties tokenBodyParameters(List<TokenBodyParameterContract> tokenBodyParameters) {
    this.tokenBodyParameters = tokenBodyParameters;
    return this;
  }

  public AuthorizationServerContractProperties addTokenBodyParametersItem(TokenBodyParameterContract tokenBodyParametersItem) {
  ...
  public AuthorizationServerContractProperties tokenEndpoint(String tokenEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    AuthorizationServerContractProperties authorizationServerContractProperties = (AuthorizationServerContractProperties) o;
    return Objects.equals(this.authorizationEndpoint, authorizationServerContractProperties.authorizationEndpoint) &&
        Objects.equals(this.clientId, authorizationServerContractProperties.clientId) &&
        Objects.equals(this.clientRegistrationEndpoint, authorizationServerContractProperties.clientRegistrationEndpoint) &&
        Objects.equals(this.displayName, authorizationServerContractProperties.displayName) &&
        Objects.equals(this.grantTypes, authorizationServerContractProperties.grantTypes) &&
        Objects.equals(this.authorizationMethods, authorizationServerContractProperties.authorizationMethods) &&
        Objects.equals(this.bearerTokenSendingMethods, authorizationServerContractProperties.bearerTokenSendingMethods) &&
        Objects.equals(this.clientAuthenticationMethod, authorizationServerContractProperties.clientAuthenticationMethod) &&
        Objects.equals(this.clientSecret, authorizationServerContractProperties.clientSecret) &&
        Objects.equals(this.defaultScope, authorizationServerContractProperties.defaultScope) &&
        Objects.equals(this.description, authorizationServerContractProperties.description) &&
        Objects.equals(this.resourceOwnerPassword, authorizationServerContractProperties.resourceOwnerPassword) &&
        Objects.equals(this.resourceOwnerUsername, authorizationServerContractProperties.resourceOwnerUsername) &&
        Objects.equals(this.supportState, authorizationServerContractProperties.supportState) &&
        Objects.equals(this.tokenBodyParameters, authorizationServerContractProperties.tokenBodyParameters) &&
        Objects.equals(this.tokenEndpoint, authorizationServerContractProperties.tokenEndpoint);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthorizationServerContractProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthorizationServerContractProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthorizationServerContractProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizationServerContractProperties is not found in the empty JSON string", AuthorizationServerContractProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthorizationServerContractProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthorizationServerContractProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthorizationServerContractProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizationServerContractProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizationServerContractProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizationServerContractProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizationServerContractProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizationServerContractProperties>() {
           @Override
           public void write(JsonWriter out, AuthorizationServerContractProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthorizationServerContractProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthorizationServerContractProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthorizationServerContractProperties
   * @throws IOException if the JSON string is invalid with respect to AuthorizationServerContractProperties
   */
  public static AuthorizationServerContractProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizationServerContractProperties.class);
  }

  /**
   * Convert an instance of AuthorizationServerContractProperties to an JSON string
   *
   * @return JSON string
   */
