...
> AuthorizationServerContract authorizationServerCreateOrUpdate(resourceGroupName, serviceName, authsid, apiVersion, subscriptionId, parameters, ifMatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AuthorizationServerContract result = apiInstance.authorizationServerCreateOrUpdate(resourceGroupName, serviceName, authsid, apiVersion, subscriptionId, parameters, ifMatch);
