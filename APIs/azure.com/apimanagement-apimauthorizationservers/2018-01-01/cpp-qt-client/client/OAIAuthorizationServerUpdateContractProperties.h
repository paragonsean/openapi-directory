...
/*
 * OAIAuthorizationServerUpdateContractProperties.h
 *
 * External OAuth authorization server Update settings contract.
 */

#ifndef OAIAuthorizationServerUpdateContractProperties_H
#define OAIAuthorizationServerUpdateContractProperties_H
...
class OAIAuthorizationServerUpdateContractProperties : public OAIObject {
public:
    OAIAuthorizationServerUpdateContractProperties();
    OAIAuthorizationServerUpdateContractProperties(QString json);
    ~OAIAuthorizationServerUpdateContractProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthorizationServerUpdateContractProperties)

#endif // OAIAuthorizationServerUpdateContractProperties_H
