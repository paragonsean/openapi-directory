...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.AuthorizationServerUpdateRequestProperties();
  });
  ...
  describe('AuthorizationServerUpdateRequestProperties', function() {
    it('should create an instance of AuthorizationServerUpdateRequestProperties', function() {
      // uncomment below and update the code to test AuthorizationServerUpdateRequestProperties
      //var instance = new ApiManagementClient.AuthorizationServerUpdateRequestProperties();
      //expect(instance).to.be.a(ApiManagementClient.AuthorizationServerUpdateRequestProperties);
    });
