...
#ifndef OAI_OAIAuthorizationServerApi_H
#define OAI_OAIAuthorizationServerApi_H
...
#include "OAIAuthorizationServer_Get_200_response.h"
...
class OAIAuthorizationServerApi : public QObject {
    Q_OBJECT

public:
    OAIAuthorizationServerApi(const int timeOut = 0);
    ~OAIAuthorizationServerApi();
    ...
    * @param[in]  parameters OAIAuthorizationServer_Get_200_response [required]
    * @param[in]  if_match QString [optional]
    */
    virtual void authorizationServerCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &authsid, const QString &api_version, const QString &subscription_id, const OAIAuthorizationServer_Get_200_response &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void authorizationServerListSecrets(const QString &resource_group_name, const QString &service_name, const QString &authsid, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAIAuthorizationServer_Update_request [required]
    */
    virtual void authorizationServerUpdate(const QString &resource_group_name, const QString &service_name, const QString &authsid, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAIAuthorizationServer_Update_request &parameters);
...
private:
    ...
    void authorizationServerListSecretsCallback(OAIHttpRequestWorker *worker);
    void authorizationServerUpdateCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void authorizationServerCreateOrUpdateSignal(OAIAuthorizationServer_Get_200_response summary);
    void authorizationServerDeleteSignal();
    void authorizationServerGetSignal(OAIAuthorizationServer_Get_200_response summary);
    void authorizationServerGetEntityTagSignal();
    void authorizationServerListByServiceSignal(OAIAuthorizationServer_ListByService_200_response summary);
    void authorizationServerListSecretsSignal(OAIAuthorizationServer_ListSecrets_200_response summary);
    void authorizationServerUpdateSignal();


    void authorizationServerCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIAuthorizationServer_Get_200_response summary);
    void authorizationServerDeleteSignalFull(OAIHttpRequestWorker *worker);
    void authorizationServerGetSignalFull(OAIHttpRequestWorker *worker, OAIAuthorizationServer_Get_200_response summary);
    void authorizationServerGetEntityTagSignalFull(OAIHttpRequestWorker *worker);
    void authorizationServerListByServiceSignalFull(OAIHttpRequestWorker *worker, OAIAuthorizationServer_ListByService_200_response summary);
    void authorizationServerListSecretsSignalFull(OAIHttpRequestWorker *worker, OAIAuthorizationServer_ListSecrets_200_response summary);
    ...
    void authorizationServerCreateOrUpdateSignalE(OAIAuthorizationServer_Get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void authorizationServerCreateOrUpdateSignalError(OAIAuthorizationServer_Get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void authorizationServerGetSignalE(OAIAuthorizationServer_Get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void authorizationServerGetSignalError(OAIAuthorizationServer_Get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void authorizationServerListByServiceSignalE(OAIAuthorizationServer_ListByService_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void authorizationServerListByServiceSignalError(OAIAuthorizationServer_ListByService_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use authorizationServerListSecretsSignalError() instead")
    void authorizationServerListSecretsSignalE(OAIAuthorizationServer_ListSecrets_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void authorizationServerListSecretsSignalError(OAIAuthorizationServer_ListSecrets_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use authorizationServerListSecretsSignalErrorFull() instead")
    void authorizationServerListSecretsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void authorizationServerListSecretsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
