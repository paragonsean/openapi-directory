...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.AuthorizationServerApi();
  });
  ...
  describe('AuthorizationServerApi', function() {
    ...
    describe('authorizationServerListSecrets', function() {
      it('should call authorizationServerListSecrets successfully', function(done) {
        //uncomment below and update the code to test authorizationServerListSecrets
        //instance.authorizationServerListSecrets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
