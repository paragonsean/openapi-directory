...
public class OAuth2AuthorizationServerUpdateContract {
  ...
  public OAuth2AuthorizationServerUpdateContract() {
  }

  public OAuth2AuthorizationServerUpdateContract authorizationEndpoint(String authorizationEndpoint) {
  ...
  public OAuth2AuthorizationServerUpdateContract authorizationMethods(List<AuthorizationMethodsEnum> authorizationMethods) {
    this.authorizationMethods = authorizationMethods;
    return this;
  }

  public OAuth2AuthorizationServerUpdateContract addAuthorizationMethodsItem(AuthorizationMethodsEnum authorizationMethodsItem) {
  ...
  public OAuth2AuthorizationServerUpdateContract bearerTokenSendingMethods(List<BearerTokenSendingMethodsEnum> bearerTokenSendingMethods) {
    this.bearerTokenSendingMethods = bearerTokenSendingMethods;
    return this;
  }

  public OAuth2AuthorizationServerUpdateContract addBearerTokenSendingMethodsItem(BearerTokenSendingMethodsEnum bearerTokenSendingMethodsItem) {
  ...
  public OAuth2AuthorizationServerUpdateContract clientAuthenticationMethod(List<ClientAuthenticationMethodEnum> clientAuthenticationMethod) {
    this.clientAuthenticationMethod = clientAuthenticationMethod;
    return this;
  }

  public OAuth2AuthorizationServerUpdateContract addClientAuthenticationMethodItem(ClientAuthenticationMethodEnum clientAuthenticationMethodItem) {
  ...
  public OAuth2AuthorizationServerUpdateContract clientId(String clientId) {
  ...
  public OAuth2AuthorizationServerUpdateContract clientRegistrationEndpoint(String clientRegistrationEndpoint) {
  ...
  public OAuth2AuthorizationServerUpdateContract clientSecret(String clientSecret) {
  ...
  public OAuth2AuthorizationServerUpdateContract defaultScope(String defaultScope) {
  ...
  public OAuth2AuthorizationServerUpdateContract description(String description) {
  ...
  public OAuth2AuthorizationServerUpdateContract grantTypes(List<GrantTypesEnum> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public OAuth2AuthorizationServerUpdateContract addGrantTypesItem(GrantTypesEnum grantTypesItem) {
  ...
  public OAuth2AuthorizationServerUpdateContract name(String name) {
    this.name = name;
    return this;
  }
  ...
  public OAuth2AuthorizationServerUpdateContract resourceOwnerPassword(String resourceOwnerPassword) {
  ...
  public OAuth2AuthorizationServerUpdateContract resourceOwnerUsername(String resourceOwnerUsername) {
  ...
  public OAuth2AuthorizationServerUpdateContract supportState(Boolean supportState) {
  ...
  public OAuth2AuthorizationServerUpdateContract tokenBodyParameters(List<TokenBodyParameterContract> tokenBodyParameters) {
    this.tokenBodyParameters = tokenBodyParameters;
    return this;
  }

  public OAuth2AuthorizationServerUpdateContract addTokenBodyParametersItem(TokenBodyParameterContract tokenBodyParametersItem) {
  ...
  public OAuth2AuthorizationServerUpdateContract tokenEndpoint(String tokenEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    OAuth2AuthorizationServerUpdateContract oauth2AuthorizationServerUpdateContract = (OAuth2AuthorizationServerUpdateContract) o;
    return Objects.equals(this.authorizationEndpoint, oauth2AuthorizationServerUpdateContract.authorizationEndpoint) &&
        Objects.equals(this.authorizationMethods, oauth2AuthorizationServerUpdateContract.authorizationMethods) &&
        Objects.equals(this.bearerTokenSendingMethods, oauth2AuthorizationServerUpdateContract.bearerTokenSendingMethods) &&
        Objects.equals(this.clientAuthenticationMethod, oauth2AuthorizationServerUpdateContract.clientAuthenticationMethod) &&
        Objects.equals(this.clientId, oauth2AuthorizationServerUpdateContract.clientId) &&
        Objects.equals(this.clientRegistrationEndpoint, oauth2AuthorizationServerUpdateContract.clientRegistrationEndpoint) &&
        Objects.equals(this.clientSecret, oauth2AuthorizationServerUpdateContract.clientSecret) &&
        Objects.equals(this.defaultScope, oauth2AuthorizationServerUpdateContract.defaultScope) &&
        Objects.equals(this.description, oauth2AuthorizationServerUpdateContract.description) &&
        Objects.equals(this.grantTypes, oauth2AuthorizationServerUpdateContract.grantTypes) &&
        Objects.equals(this.name, oauth2AuthorizationServerUpdateContract.name) &&
        Objects.equals(this.resourceOwnerPassword, oauth2AuthorizationServerUpdateContract.resourceOwnerPassword) &&
        Objects.equals(this.resourceOwnerUsername, oauth2AuthorizationServerUpdateContract.resourceOwnerUsername) &&
        Objects.equals(this.supportState, oauth2AuthorizationServerUpdateContract.supportState) &&
        Objects.equals(this.tokenBodyParameters, oauth2AuthorizationServerUpdateContract.tokenBodyParameters) &&
        Objects.equals(this.tokenEndpoint, oauth2AuthorizationServerUpdateContract.tokenEndpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationEndpoint, authorizationMethods, bearerTokenSendingMethods, clientAuthenticationMethod, clientId, clientRegistrationEndpoint, clientSecret, defaultScope, description, grantTypes, name, resourceOwnerPassword, resourceOwnerUsername, supportState, tokenBodyParameters, tokenEndpoint);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OAuth2AuthorizationServerUpdateContract {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OAuth2AuthorizationServerUpdateContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OAuth2AuthorizationServerUpdateContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OAuth2AuthorizationServerUpdateContract is not found in the empty JSON string", OAuth2AuthorizationServerUpdateContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OAuth2AuthorizationServerUpdateContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OAuth2AuthorizationServerUpdateContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("clientRegistrationEndpoint") != null && !jsonObj.get("clientRegistrationEndpoint").isJsonNull()) && !jsonObj.get("clientRegistrationEndpoint").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OAuth2AuthorizationServerUpdateContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OAuth2AuthorizationServerUpdateContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OAuth2AuthorizationServerUpdateContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OAuth2AuthorizationServerUpdateContract.class));

       return (TypeAdapter<T>) new TypeAdapter<OAuth2AuthorizationServerUpdateContract>() {
           @Override
           public void write(JsonWriter out, OAuth2AuthorizationServerUpdateContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OAuth2AuthorizationServerUpdateContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OAuth2AuthorizationServerUpdateContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OAuth2AuthorizationServerUpdateContract
   * @throws IOException if the JSON string is invalid with respect to OAuth2AuthorizationServerUpdateContract
   */
  public static OAuth2AuthorizationServerUpdateContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OAuth2AuthorizationServerUpdateContract.class);
  }

  /**
   * Convert an instance of OAuth2AuthorizationServerUpdateContract to an JSON string
   *
   * @return JSON string
   */
