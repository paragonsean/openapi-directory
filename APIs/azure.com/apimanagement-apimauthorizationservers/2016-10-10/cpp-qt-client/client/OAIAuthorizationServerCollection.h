...
namespace OpenAPI {
class OAIOAuth2AuthorizationServerContract;
...
public:
    ...
    QList<OAIOAuth2AuthorizationServerContract> getValue() const;
    void setValue(const QList<OAIOAuth2AuthorizationServerContract> &value);
...
private:
    ...
    QList<OAIOAuth2AuthorizationServerContract> m_value;
    bool m_value_isSet;
