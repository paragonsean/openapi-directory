...
QList<OAIOAuth2AuthorizationServerContract> OAIAuthorizationServerCollection::getValue() const {
    return m_value;
}
void OAIAuthorizationServerCollection::setValue(const QList<OAIOAuth2AuthorizationServerContract> &value) {
    m_value = value;
    m_value_isSet = true;
}
