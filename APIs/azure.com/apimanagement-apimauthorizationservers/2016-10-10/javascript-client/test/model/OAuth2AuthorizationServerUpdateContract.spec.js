...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.OAuth2AuthorizationServerUpdateContract();
  });
  ...
  describe('OAuth2AuthorizationServerUpdateContract', function() {
    it('should create an instance of OAuth2AuthorizationServerUpdateContract', function() {
      // uncomment below and update the code to test OAuth2AuthorizationServerUpdateContract
      //var instance = new ApiManagementClient.OAuth2AuthorizationServerUpdateContract();
      //expect(instance).to.be.a(ApiManagementClient.OAuth2AuthorizationServerUpdateContract);
    });
