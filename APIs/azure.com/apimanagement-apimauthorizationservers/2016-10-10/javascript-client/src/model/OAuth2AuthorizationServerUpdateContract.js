...
/**
 * The OAuth2AuthorizationServerUpdateContract model module.
 * @module model/OAuth2AuthorizationServerUpdateContract
 * @version 2016-10-10
 */
class OAuth2AuthorizationServerUpdateContract {
    /**
     * Constructs a new <code>OAuth2AuthorizationServerUpdateContract</code>.
     * External OAuth authorization server Update settings contract.
     * @alias module:model/OAuth2AuthorizationServerUpdateContract
     */
    constructor() { 
        
        OAuth2AuthorizationServerUpdateContract.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OAuth2AuthorizationServerUpdateContract</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OAuth2AuthorizationServerUpdateContract} obj Optional instance to populate.
     * @return {module:model/OAuth2AuthorizationServerUpdateContract} The populated <code>OAuth2AuthorizationServerUpdateContract</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OAuth2AuthorizationServerUpdateContract();
    ...
    /**
     * Validates the JSON data with respect to <code>OAuth2AuthorizationServerUpdateContract</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OAuth2AuthorizationServerUpdateContract</code>.
     */
 ...
 */
OAuth2AuthorizationServerUpdateContract.prototype['authorizationEndpoint'] = undefined;

/**
 * HTTP verbs supported by the authorization endpoint. GET must be always present. POST is optional.
 * @member {Array.<module:model/OAuth2AuthorizationServerUpdateContract.AuthorizationMethodsEnum>} authorizationMethods
 */
OAuth2AuthorizationServerUpdateContract.prototype['authorizationMethods'] = undefined;

/**
 * Specifies the mechanism by which access token is passed to the API. 
 * @member {Array.<module:model/OAuth2AuthorizationServerUpdateContract.BearerTokenSendingMethodsEnum>} bearerTokenSendingMethods
 */
OAuth2AuthorizationServerUpdateContract.prototype['bearerTokenSendingMethods'] = undefined;

/**
 * Method of authentication supported by the token endpoint of this authorization server. Possible values are Basic and/or Body. When Body is specified, client credentials and other parameters are passed within the request body in the application/x-www-form-urlencoded format.
 * @member {Array.<module:model/OAuth2AuthorizationServerUpdateContract.ClientAuthenticationMethodEnum>} clientAuthenticationMethod
 */
OAuth2AuthorizationServerUpdateContract.prototype['clientAuthenticationMethod'] = undefined;

/**
 * Client or app id registered with this authorization server.
 * @member {String} clientId
 */
OAuth2AuthorizationServerUpdateContract.prototype['clientId'] = undefined;

/**
 * Optional reference to a page where client or app registration for this authorization server is performed. Contains absolute URL to entity being referenced.
 * @member {String} clientRegistrationEndpoint
 */
OAuth2AuthorizationServerUpdateContract.prototype['clientRegistrationEndpoint'] = undefined;

/**
 * Client or app secret registered with this authorization server.
 * @member {String} clientSecret
 */
OAuth2AuthorizationServerUpdateContract.prototype['clientSecret'] = undefined;

/**
 * Access token scope that is going to be requested by default. Can be overridden at the API level. Should be provided in the form of a string containing space-delimited values.
 * @member {String} defaultScope
 */
OAuth2AuthorizationServerUpdateContract.prototype['defaultScope'] = undefined;

/**
 * Description of the authorization server. Can contain HTML formatting tags.
 * @member {String} description
 */
OAuth2AuthorizationServerUpdateContract.prototype['description'] = undefined;

/**
 * Form of an authorization grant, which the client uses to request the access token.
 * @member {Array.<module:model/OAuth2AuthorizationServerUpdateContract.GrantTypesEnum>} grantTypes
 */
OAuth2AuthorizationServerUpdateContract.prototype['grantTypes'] = undefined;

/**
 * User-friendly authorization server name.
 * @member {String} name
 */
OAuth2AuthorizationServerUpdateContract.prototype['name'] = undefined;

/**
 * Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner password.
 * @member {String} resourceOwnerPassword
 */
OAuth2AuthorizationServerUpdateContract.prototype['resourceOwnerPassword'] = undefined;

/**
 * Can be optionally specified when resource owner password grant type is supported by this authorization server. Default resource owner username.
 * @member {String} resourceOwnerUsername
 */
OAuth2AuthorizationServerUpdateContract.prototype['resourceOwnerUsername'] = undefined;

/**
 * If true, authorization server will include state parameter from the authorization request to its response. Client may use state parameter to raise protocol security.
 * @member {Boolean} supportState
 */
OAuth2AuthorizationServerUpdateContract.prototype['supportState'] = undefined;

/**
 * Additional parameters required by the token endpoint of this authorization server represented as an array of JSON objects with name and value string properties, i.e. {\"name\" : \"name value\", \"value\": \"a value\"}.
 * @member {Array.<module:model/TokenBodyParameterContract>} tokenBodyParameters
 */
OAuth2AuthorizationServerUpdateContract.prototype['tokenBodyParameters'] = undefined;

/**
 * OAuth token endpoint. Contains absolute URI to entity being referenced.
 * @member {String} tokenEndpoint
 */
OAuth2AuthorizationServerUpdateContract.prototype['tokenEndpoint'] = undefined;
 ...
 * @readonly
 */
OAuth2AuthorizationServerUpdateContract['AuthorizationMethodsEnum'] = {
 ...
 * @readonly
 */
OAuth2AuthorizationServerUpdateContract['BearerTokenSendingMethodsEnum'] = {
 ...
 * @readonly
 */
OAuth2AuthorizationServerUpdateContract['ClientAuthenticationMethodEnum'] = {
 ...
 * @readonly
 */
OAuth2AuthorizationServerUpdateContract['GrantTypesEnum'] = {
...
export default OAuth2AuthorizationServerUpdateContract;
