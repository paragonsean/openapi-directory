...
/*
 * OAIAuthorizationServer_Update_request_properties.h
 *
 * External OAuth authorization server Update settings contract.
 */

#ifndef OAIAuthorizationServer_Update_request_properties_H
#define OAIAuthorizationServer_Update_request_properties_H
...
class OAIAuthorizationServer_Update_request_properties : public OAIObject {
public:
    OAIAuthorizationServer_Update_request_properties();
    OAIAuthorizationServer_Update_request_properties(QString json);
    ~OAIAuthorizationServer_Update_request_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthorizationServer_Update_request_properties)

#endif // OAIAuthorizationServer_Update_request_properties_H
