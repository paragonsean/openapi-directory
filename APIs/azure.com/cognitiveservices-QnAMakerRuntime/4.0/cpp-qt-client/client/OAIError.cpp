...
QList<OAIError> OAIError::getDetails() const {
    return m_details;
}
void OAIError::setDetails(const QList<OAIError> &details) {
    m_details = details;
...
OAIInnerErrorModel OAIError::getInnerError() const {
    return m_inner_error;
}
void OAIError::setInnerError(const OAIInnerErrorModel &inner_error) {
