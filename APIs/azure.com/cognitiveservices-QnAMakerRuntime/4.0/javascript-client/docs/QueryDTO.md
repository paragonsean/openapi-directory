# QnAMakerRuntimeClient.QueryDTO
...
**scoreThreshold** | **Number** | Threshold for answers returned based on score. | [optional] 
**strictFilters** | [**[MetadataDTO]**](MetadataDTO.md) | Find only answers that contain these metadata. | [optional] 
**top** | **Number** | Max number of answers to be returned for the question. | [optional] 
