...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new PowerBiEmbeddedManagementClient.ErrorDetail();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.ErrorDetail);
    });
