...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.CheckNameResponse();
  });
  ...
  describe('CheckNameResponse', function() {
    it('should create an instance of CheckNameResponse', function() {
      // uncomment below and update the code to test CheckNameResponse
      //var instance = new PowerBiEmbeddedManagementClient.CheckNameResponse();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.CheckNameResponse);
    });
