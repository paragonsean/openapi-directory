...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new PowerBiEmbeddedManagementClient.Operation();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.Operation);
    });
