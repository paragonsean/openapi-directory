...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.MigrateWorkspaceCollectionRequest();
  });
  ...
  describe('MigrateWorkspaceCollectionRequest', function() {
    it('should create an instance of MigrateWorkspaceCollectionRequest', function() {
      // uncomment below and update the code to test MigrateWorkspaceCollectionRequest
      //var instance = new PowerBiEmbeddedManagementClient.MigrateWorkspaceCollectionRequest();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.MigrateWorkspaceCollectionRequest);
    });
