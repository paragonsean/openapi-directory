...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.Workspace();
  });
  ...
  describe('Workspace', function() {
    it('should create an instance of Workspace', function() {
      ...
      //var instance = new PowerBiEmbeddedManagementClient.Workspace();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.Workspace);
    });
