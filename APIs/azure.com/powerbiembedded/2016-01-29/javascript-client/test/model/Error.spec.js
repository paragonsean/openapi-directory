...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new PowerBiEmbeddedManagementClient.Error();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.Error);
    });
