...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.AzureSku();
  });
  ...
  describe('AzureSku', function() {
    it('should create an instance of AzureSku', function() {
      ...
      //var instance = new PowerBiEmbeddedManagementClient.AzureSku();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.AzureSku);
    });
