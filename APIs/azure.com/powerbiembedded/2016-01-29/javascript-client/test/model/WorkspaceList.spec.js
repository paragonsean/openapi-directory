...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.WorkspaceList();
  });
  ...
  describe('WorkspaceList', function() {
    it('should create an instance of WorkspaceList', function() {
      ...
      //var instance = new PowerBiEmbeddedManagementClient.WorkspaceList();
      //expect(instance).to.be.a(PowerBiEmbeddedManagementClient.WorkspaceList);
    });
