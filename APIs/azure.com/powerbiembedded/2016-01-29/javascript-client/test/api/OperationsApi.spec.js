...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiEmbeddedManagementClient.OperationsApi();
  });
  ...
  describe('OperationsApi', function() {
    describe('getAvailableOperations', function() {
      it('should call getAvailableOperations successfully', function(done) {
        //uncomment below and update the code to test getAvailableOperations
        //instance.getAvailableOperations(function(error) {
