...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.BatchInput();
  });
  ...
  describe('BatchInput', function() {
    it('should create an instance of BatchInput', function() {
      // uncomment below and update the code to test BatchInput
      //var instance = new TextAnalyticsClient.BatchInput();
      //expect(instance).to.be.a(TextAnalyticsClient.BatchInput);
    });
