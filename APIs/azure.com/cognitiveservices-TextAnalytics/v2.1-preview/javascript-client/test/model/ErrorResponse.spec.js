...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new TextAnalyticsClient.ErrorResponse();
      //expect(instance).to.be.a(TextAnalyticsClient.ErrorResponse);
    });
