...
export default class EntitiesApi {
    ...
    */
     ...
     * @param {module:model/EntitiesBatchResultV2dot1} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/EntitiesBatchResultV2dot1}
     */
    entities(input, callback) {
      ...
      let returnType = EntitiesBatchResultV2dot1;
