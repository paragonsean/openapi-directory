...
/*
 * OAIEntityRecordV2dot1.h
 *
 * 
 */

#ifndef OAIEntityRecordV2dot1_H
#define OAIEntityRecordV2dot1_H
...
namespace OpenAPI {
class OAIMatchRecordV2dot1;

class OAIEntityRecordV2dot1 : public OAIObject {
public:
    OAIEntityRecordV2dot1();
    OAIEntityRecordV2dot1(QString json);
    ~OAIEntityRecordV2dot1() override;
    ...
    QList<OAIMatchRecordV2dot1> getMatches() const;
    void setMatches(const QList<OAIMatchRecordV2dot1> &matches);
...
private:
    ...
    QList<OAIMatchRecordV2dot1> m_matches;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityRecordV2dot1)

#endif // OAIEntityRecordV2dot1_H
