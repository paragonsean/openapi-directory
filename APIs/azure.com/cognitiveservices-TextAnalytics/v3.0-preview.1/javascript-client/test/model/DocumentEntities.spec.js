...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.DocumentEntities();
  });
  ...
  describe('DocumentEntities', function() {
    it('should create an instance of DocumentEntities', function() {
      // uncomment below and update the code to test DocumentEntities
      //var instance = new TextAnalyticsClient.DocumentEntities();
      //expect(instance).to.be.a(TextAnalyticsClient.DocumentEntities);
    });
