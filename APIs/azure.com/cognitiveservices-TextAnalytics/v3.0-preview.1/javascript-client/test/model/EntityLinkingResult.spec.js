...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.EntityLinkingResult();
  });
  ...
  describe('EntityLinkingResult', function() {
    it('should create an instance of EntityLinkingResult', function() {
      // uncomment below and update the code to test EntityLinkingResult
      //var instance = new TextAnalyticsClient.EntityLinkingResult();
      //expect(instance).to.be.a(TextAnalyticsClient.EntityLinkingResult);
    });
