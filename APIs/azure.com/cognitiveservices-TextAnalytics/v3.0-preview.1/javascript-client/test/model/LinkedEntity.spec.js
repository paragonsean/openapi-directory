...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.LinkedEntity();
  });
  ...
  describe('LinkedEntity', function() {
    it('should create an instance of LinkedEntity', function() {
      ...
      //var instance = new TextAnalyticsClient.LinkedEntity();
      //expect(instance).to.be.a(TextAnalyticsClient.LinkedEntity);
    });
