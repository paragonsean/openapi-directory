...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.DocumentLanguage();
  });
  ...
  describe('DocumentLanguage', function() {
    it('should create an instance of DocumentLanguage', function() {
      ...
      //var instance = new TextAnalyticsClient.DocumentLanguage();
      //expect(instance).to.be.a(TextAnalyticsClient.DocumentLanguage);
    });
