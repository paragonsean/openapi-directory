...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.LanguageResult();
  });
  ...
  describe('LanguageResult', function() {
    it('should create an instance of LanguageResult', function() {
      // uncomment below and update the code to test LanguageResult
      //var instance = new TextAnalyticsClient.LanguageResult();
      //expect(instance).to.be.a(TextAnalyticsClient.LanguageResult);
    });
