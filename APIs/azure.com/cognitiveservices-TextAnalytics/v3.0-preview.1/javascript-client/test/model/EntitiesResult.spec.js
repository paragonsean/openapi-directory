...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.EntitiesResult();
  });
  ...
  describe('EntitiesResult', function() {
    it('should create an instance of EntitiesResult', function() {
      // uncomment below and update the code to test EntitiesResult
      //var instance = new TextAnalyticsClient.EntitiesResult();
      //expect(instance).to.be.a(TextAnalyticsClient.EntitiesResult);
    });
