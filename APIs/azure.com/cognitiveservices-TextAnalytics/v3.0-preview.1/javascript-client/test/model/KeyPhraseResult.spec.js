...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.KeyPhraseResult();
  });
  ...
  describe('KeyPhraseResult', function() {
    it('should create an instance of KeyPhraseResult', function() {
      // uncomment below and update the code to test KeyPhraseResult
      //var instance = new TextAnalyticsClient.KeyPhraseResult();
      //expect(instance).to.be.a(TextAnalyticsClient.KeyPhraseResult);
    });
