...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.DocumentKeyPhrases();
  });
  ...
  describe('DocumentKeyPhrases', function() {
    it('should create an instance of DocumentKeyPhrases', function() {
      // uncomment below and update the code to test DocumentKeyPhrases
      //var instance = new TextAnalyticsClient.DocumentKeyPhrases();
      //expect(instance).to.be.a(TextAnalyticsClient.DocumentKeyPhrases);
    });
