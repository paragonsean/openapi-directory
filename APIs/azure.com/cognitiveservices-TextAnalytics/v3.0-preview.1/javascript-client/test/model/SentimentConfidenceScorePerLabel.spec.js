...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.SentimentConfidenceScorePerLabel();
  });
  ...
  describe('SentimentConfidenceScorePerLabel', function() {
    it('should create an instance of SentimentConfidenceScorePerLabel', function() {
      // uncomment below and update the code to test SentimentConfidenceScorePerLabel
      //var instance = new TextAnalyticsClient.SentimentConfidenceScorePerLabel();
      //expect(instance).to.be.a(TextAnalyticsClient.SentimentConfidenceScorePerLabel);
    });
