...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.DocumentLinkedEntities();
  });
  ...
  describe('DocumentLinkedEntities', function() {
    it('should create an instance of DocumentLinkedEntities', function() {
      // uncomment below and update the code to test DocumentLinkedEntities
      //var instance = new TextAnalyticsClient.DocumentLinkedEntities();
      //expect(instance).to.be.a(TextAnalyticsClient.DocumentLinkedEntities);
    });
