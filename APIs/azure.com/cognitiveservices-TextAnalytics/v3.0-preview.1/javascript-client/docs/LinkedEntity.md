# TextAnalyticsClient.LinkedEntity
...
**id** | **String** | Unique identifier of the recognized entity from the data source. | [optional] 
**language** | **String** | Language used in the data source. | 
**matches** | [**[Match]**](Match.md) | List of instances this entity appears in the text. | 
