...
OAIKeyPhraseResult::OAIKeyPhraseResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyPhraseResult::OAIKeyPhraseResult() {
    this->initializeModel();
}

OAIKeyPhraseResult::~OAIKeyPhraseResult() {}

void OAIKeyPhraseResult::initializeModel() {
...
void OAIKeyPhraseResult::fromJson(QString jsonString) {
...
void OAIKeyPhraseResult::fromJsonObject(QJsonObject json) {
...
QString OAIKeyPhraseResult::asJson() const {
...
QJsonObject OAIKeyPhraseResult::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIDocumentKeyPhrases> OAIKeyPhraseResult::getDocuments() const {
    return m_documents;
}
void OAIKeyPhraseResult::setDocuments(const QList<OAIDocumentKeyPhrases> &documents) {
    m_documents = documents;
    m_documents_isSet = true;
}

bool OAIKeyPhraseResult::is_documents_Set() const{
    return m_documents_isSet;
}

bool OAIKeyPhraseResult::is_documents_Valid() const{
    return m_documents_isValid;
}

QList<OAIDocumentError> OAIKeyPhraseResult::getErrors() const {
    return m_errors;
}
void OAIKeyPhraseResult::setErrors(const QList<OAIDocumentError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIKeyPhraseResult::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIKeyPhraseResult::is_errors_Valid() const{
    return m_errors_isValid;
}

QString OAIKeyPhraseResult::getModelVersion() const {
    return m_model_version;
}
void OAIKeyPhraseResult::setModelVersion(const QString &model_version) {
    m_model_version = model_version;
    m_model_version_isSet = true;
}

bool OAIKeyPhraseResult::is_model_version_Set() const{
    return m_model_version_isSet;
}

bool OAIKeyPhraseResult::is_model_version_Valid() const{
    return m_model_version_isValid;
}

OAIRequestStatistics OAIKeyPhraseResult::getStatistics() const {
    return m_statistics;
}
void OAIKeyPhraseResult::setStatistics(const OAIRequestStatistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAIKeyPhraseResult::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAIKeyPhraseResult::is_statistics_Valid() const{
    return m_statistics_isValid;
}

bool OAIKeyPhraseResult::isSet() const {
...
bool OAIKeyPhraseResult::isValid() const {
