...
/*
 * OAIDocumentEntities.h
 *
 * 
 */

#ifndef OAIDocumentEntities_H
#define OAIDocumentEntities_H
...
class OAIDocumentEntities : public OAIObject {
public:
    OAIDocumentEntities();
    OAIDocumentEntities(QString json);
    ~OAIDocumentEntities() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentEntities)

#endif // OAIDocumentEntities_H
