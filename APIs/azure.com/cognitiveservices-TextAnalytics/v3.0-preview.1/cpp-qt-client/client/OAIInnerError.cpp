...
QString OAIInnerError::getCode() const {
    return m_code;
}
void OAIInnerError::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIInnerError::is_code_Set() const{
    return m_code_isSet;
}

bool OAIInnerError::is_code_Valid() const{
    return m_code_isValid;
}

QMap<QString, QString> OAIInnerError::getDetails() const {
    return m_details;
}
void OAIInnerError::setDetails(const QMap<QString, QString> &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIInnerError::is_details_Set() const{
    return m_details_isSet;
}

bool OAIInnerError::is_details_Valid() const{
    return m_details_isValid;
}

OAIInnerError OAIInnerError::getInnerError() const {
    return m_inner_error;
}
void OAIInnerError::setInnerError(const OAIInnerError &inner_error) {
    m_inner_error = inner_error;
    m_inner_error_isSet = true;
}

bool OAIInnerError::is_inner_error_Set() const{
    return m_inner_error_isSet;
}

bool OAIInnerError::is_inner_error_Valid() const{
    return m_inner_error_isValid;
}

QString OAIInnerError::getMessage() const {
    return m_message;
}
void OAIInnerError::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIInnerError::is_message_Set() const{
    return m_message_isSet;
}

bool OAIInnerError::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIInnerError::getTarget() const {
    return m_target;
}
void OAIInnerError::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIInnerError::is_target_Set() const{
    return m_target_isSet;
}

bool OAIInnerError::is_target_Valid() const{
