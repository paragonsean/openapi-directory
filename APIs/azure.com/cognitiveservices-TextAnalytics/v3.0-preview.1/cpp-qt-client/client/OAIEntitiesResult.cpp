...
OAIEntitiesResult::OAIEntitiesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntitiesResult::OAIEntitiesResult() {
    this->initializeModel();
}

OAIEntitiesResult::~OAIEntitiesResult() {}

void OAIEntitiesResult::initializeModel() {
...
void OAIEntitiesResult::fromJson(QString jsonString) {
...
void OAIEntitiesResult::fromJsonObject(QJsonObject json) {
...
QString OAIEntitiesResult::asJson() const {
...
QJsonObject OAIEntitiesResult::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIDocumentEntities> OAIEntitiesResult::getDocuments() const {
    return m_documents;
}
void OAIEntitiesResult::setDocuments(const QList<OAIDocumentEntities> &documents) {
    m_documents = documents;
    m_documents_isSet = true;
}

bool OAIEntitiesResult::is_documents_Set() const{
    return m_documents_isSet;
}

bool OAIEntitiesResult::is_documents_Valid() const{
    return m_documents_isValid;
}

QList<OAIDocumentError> OAIEntitiesResult::getErrors() const {
    return m_errors;
}
void OAIEntitiesResult::setErrors(const QList<OAIDocumentError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIEntitiesResult::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIEntitiesResult::is_errors_Valid() const{
    return m_errors_isValid;
}

QString OAIEntitiesResult::getModelVersion() const {
    return m_model_version;
}
void OAIEntitiesResult::setModelVersion(const QString &model_version) {
    m_model_version = model_version;
    m_model_version_isSet = true;
}

bool OAIEntitiesResult::is_model_version_Set() const{
    return m_model_version_isSet;
}

bool OAIEntitiesResult::is_model_version_Valid() const{
    return m_model_version_isValid;
}

OAIRequestStatistics OAIEntitiesResult::getStatistics() const {
    return m_statistics;
}
void OAIEntitiesResult::setStatistics(const OAIRequestStatistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAIEntitiesResult::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAIEntitiesResult::is_statistics_Valid() const{
    return m_statistics_isValid;
}

bool OAIEntitiesResult::isSet() const {
...
bool OAIEntitiesResult::isValid() const {
