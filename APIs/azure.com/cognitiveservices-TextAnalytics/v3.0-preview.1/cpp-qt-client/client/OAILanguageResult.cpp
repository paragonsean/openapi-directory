...
OAILanguageResult::OAILanguageResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILanguageResult::OAILanguageResult() {
    this->initializeModel();
}

OAILanguageResult::~OAILanguageResult() {}

void OAILanguageResult::initializeModel() {
...
void OAILanguageResult::fromJson(QString jsonString) {
...
void OAILanguageResult::fromJsonObject(QJsonObject json) {
...
QString OAILanguageResult::asJson() const {
...
QJsonObject OAILanguageResult::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIDocumentLanguage> OAILanguageResult::getDocuments() const {
    return m_documents;
}
void OAILanguageResult::setDocuments(const QList<OAIDocumentLanguage> &documents) {
    m_documents = documents;
    m_documents_isSet = true;
}

bool OAILanguageResult::is_documents_Set() const{
    return m_documents_isSet;
}

bool OAILanguageResult::is_documents_Valid() const{
    return m_documents_isValid;
}

QList<OAIDocumentError> OAILanguageResult::getErrors() const {
    return m_errors;
}
void OAILanguageResult::setErrors(const QList<OAIDocumentError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAILanguageResult::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAILanguageResult::is_errors_Valid() const{
    return m_errors_isValid;
}

QString OAILanguageResult::getModelVersion() const {
    return m_model_version;
}
void OAILanguageResult::setModelVersion(const QString &model_version) {
    m_model_version = model_version;
    m_model_version_isSet = true;
}

bool OAILanguageResult::is_model_version_Set() const{
    return m_model_version_isSet;
}

bool OAILanguageResult::is_model_version_Valid() const{
    return m_model_version_isValid;
}

OAIRequestStatistics OAILanguageResult::getStatistics() const {
    return m_statistics;
}
void OAILanguageResult::setStatistics(const OAIRequestStatistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAILanguageResult::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAILanguageResult::is_statistics_Valid() const{
    return m_statistics_isValid;
}

bool OAILanguageResult::isSet() const {
...
bool OAILanguageResult::isValid() const {
