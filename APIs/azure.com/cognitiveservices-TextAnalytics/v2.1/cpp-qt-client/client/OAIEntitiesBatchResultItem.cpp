...
OAIDocumentStatistics OAIEntitiesBatchResultItem::getStatistics() const {
    return m_statistics;
}
void OAIEntitiesBatchResultItem::setStatistics(const OAIDocumentStatistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAIEntitiesBatchResultItem::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAIEntitiesBatchResultItem::is_statistics_Valid() const{
