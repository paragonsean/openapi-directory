...
OAIRequestStatistics OAIEntitiesBatchResult::getStatistics() const {
    return m_statistics;
}
void OAIEntitiesBatchResult::setStatistics(const OAIRequestStatistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAIEntitiesBatchResult::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAIEntitiesBatchResult::is_statistics_Valid() const{
