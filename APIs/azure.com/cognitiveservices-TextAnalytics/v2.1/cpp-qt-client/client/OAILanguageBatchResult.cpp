...
OAIRequestStatistics OAILanguageBatchResult::getStatistics() const {
    return m_statistics;
}
void OAILanguageBatchResult::setStatistics(const OAIRequestStatistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAILanguageBatchResult::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAILanguageBatchResult::is_statistics_Valid() const{
