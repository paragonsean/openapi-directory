...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.EntitiesBatchResultItem();
  });
  ...
  describe('EntitiesBatchResultItem', function() {
    it('should create an instance of EntitiesBatchResultItem', function() {
      // uncomment below and update the code to test EntitiesBatchResultItem
      //var instance = new TextAnalyticsClient.EntitiesBatchResultItem();
      //expect(instance).to.be.a(TextAnalyticsClient.EntitiesBatchResultItem);
    });
