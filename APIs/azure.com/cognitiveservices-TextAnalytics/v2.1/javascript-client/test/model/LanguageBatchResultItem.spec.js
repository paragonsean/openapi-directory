...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.LanguageBatchResultItem();
  });
  ...
  describe('LanguageBatchResultItem', function() {
    it('should create an instance of LanguageBatchResultItem', function() {
      // uncomment below and update the code to test LanguageBatchResultItem
      //var instance = new TextAnalyticsClient.LanguageBatchResultItem();
      //expect(instance).to.be.a(TextAnalyticsClient.LanguageBatchResultItem);
    });
