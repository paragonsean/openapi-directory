...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextAnalyticsClient.EntitiesBatchResult();
  });
  ...
  describe('EntitiesBatchResult', function() {
    it('should create an instance of EntitiesBatchResult', function() {
      // uncomment below and update the code to test EntitiesBatchResult
      //var instance = new TextAnalyticsClient.EntitiesBatchResult();
      //expect(instance).to.be.a(TextAnalyticsClient.EntitiesBatchResult);
    });
