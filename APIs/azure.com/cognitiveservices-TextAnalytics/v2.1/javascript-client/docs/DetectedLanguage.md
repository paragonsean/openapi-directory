# TextAnalyticsClient.DetectedLanguage
...
**score** | **Number** | A confidence score between 0 and 1. Scores close to 1 indicate 100% certainty that the identified language is true. | [optional] 
