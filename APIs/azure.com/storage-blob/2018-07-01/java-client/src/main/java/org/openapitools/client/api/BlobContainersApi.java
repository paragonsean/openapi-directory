...
public class BlobContainersApi {
     ...
     */
    public okhttp3.Call blobContainersListCall(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call blobContainersListValidateBeforeCall(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return blobContainersListCall(resourceGroupName, accountName, apiVersion, subscriptionId, _callback);
     ...
     */
    public ListContainerItems blobContainersList(String resourceGroupName, String accountName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<ListContainerItems> localVarResp = blobContainersListWithHttpInfo(resourceGroupName, accountName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListContainerItems> blobContainersListWithHttpInfo(String resourceGroupName, String accountName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = blobContainersListValidateBeforeCall(resourceGroupName, accountName, apiVersion, subscriptionId, null);
     ...
     */
    public okhttp3.Call blobContainersListAsync(String resourceGroupName, String accountName, String apiVersion, String subscriptionId, final ApiCallback<ListContainerItems> _callback) throws ApiException {

        okhttp3.Call localVarCall = blobContainersListValidateBeforeCall(resourceGroupName, accountName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<ListContainerItems>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
