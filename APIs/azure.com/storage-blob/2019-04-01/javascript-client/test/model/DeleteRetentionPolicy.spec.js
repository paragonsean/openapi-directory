...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorageManagementClient.DeleteRetentionPolicy();
  });
  ...
  describe('DeleteRetentionPolicy', function() {
    it('should create an instance of DeleteRetentionPolicy', function() {
      // uncomment below and update the code to test DeleteRetentionPolicy
      //var instance = new StorageManagementClient.DeleteRetentionPolicy();
      //expect(instance).to.be.a(StorageManagementClient.DeleteRetentionPolicy);
    });
