...
# **blobContainersList**
> ListContainerItems blobContainersList(resourceGroupName, accountName, apiVersion, subscriptionId, $skipToken, $maxpagesize, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListContainerItems result = apiInstance.blobContainersList(resourceGroupName, accountName, apiVersion, subscriptionId, $skipToken, $maxpagesize, $filter);
      System.out.println(result);
    } catch (ApiException e) {
