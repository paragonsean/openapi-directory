...
async def blob_containers_list(request: web.Request, resource_group_name, account_name, api_version, subscription_id, maxpagesize=None, filter=None) -> web.Response:
