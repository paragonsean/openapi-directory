...
export default class BlobContainersApi {
    ...
    */
     ...
     * @param {module:model/ImmutabilityPolicy} [parameters] The ImmutabilityPolicy Properties that will be created or updated to a blob container.
     ...
     * @param {String} ifMatch The entity state (ETag) version of the immutability policy to update. A value of \"*\" can be used to apply the operation only if the immutability policy already exists. If omitted, this operation will always be applied.
     * @param {Object} opts Optional parameters
     * @param {module:model/ImmutabilityPolicy} [parameters] The ImmutabilityPolicy Properties that will be extended for a blob container.
     ...
     * @param {String} subscriptionId The ID of the target subscription.
     * @param {Object} opts Optional parameters
     * @param {module:model/LeaseContainerRequest} [parameters] Lease Container request body.
