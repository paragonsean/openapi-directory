...
> ListContainerItems blobContainersList(resourceGroupName, accountName, apiVersion, subscriptionId, opts)
...
apiInstance.blobContainersList(resourceGroupName, accountName, apiVersion, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
