...
#ifndef OAI_OAISoftwarePlanOperationsApi_H
#define OAI_OAISoftwarePlanOperationsApi_H
...
class OAISoftwarePlanOperationsApi : public QObject {
    Q_OBJECT

public:
    OAISoftwarePlanOperationsApi(const int timeOut = 0);
    ~OAISoftwarePlanOperationsApi();
    ...
    */
    virtual void operationsList(const QString &scope, const QString &api_version);
