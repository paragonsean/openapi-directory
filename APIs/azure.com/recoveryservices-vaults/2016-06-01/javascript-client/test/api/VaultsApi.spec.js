...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesClient.VaultsApi();
  });
  ...
  describe('VaultsApi', function() {
    ...
    describe('vaultsListBySubscriptionId', function() {
      it('should call vaultsListBySubscriptionId successfully', function(done) {
        //uncomment below and update the code to test vaultsListBySubscriptionId
        //instance.vaultsListBySubscriptionId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
