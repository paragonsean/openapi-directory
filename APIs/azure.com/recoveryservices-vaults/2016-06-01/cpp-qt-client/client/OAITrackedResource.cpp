...
QString OAITrackedResource::getETag() const {
    return m_e_tag;
}
void OAITrackedResource::setETag(const QString &e_tag) {
    m_e_tag = e_tag;
    m_e_tag_isSet = true;
}

bool OAITrackedResource::is_e_tag_Set() const{
    return m_e_tag_isSet;
}

bool OAITrackedResource::is_e_tag_Valid() const{
