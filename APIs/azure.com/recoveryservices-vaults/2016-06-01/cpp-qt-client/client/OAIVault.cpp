...
OAIVaultProperties OAIVault::getProperties() const {
    return m_properties;
}
void OAIVault::setProperties(const OAIVaultProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIVault::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIVault::is_properties_Valid() const{
    return m_properties_isValid;
}

OAISku OAIVault::getSku() const {
    return m_sku;
}
void OAIVault::setSku(const OAISku &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIVault::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIVault::is_sku_Valid() const{
    return m_sku_isValid;
}

QString OAIVault::getLocation() const {
    return m_location;
}
void OAIVault::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIVault::is_location_Set() const{
    return m_location_isSet;
}

bool OAIVault::is_location_Valid() const{
    return m_location_isValid;
}

QMap<QString, QString> OAIVault::getTags() const {
    return m_tags;
}
void OAIVault::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIVault::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIVault::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIVault::getETag() const {
    return m_e_tag;
}
void OAIVault::setETag(const QString &e_tag) {
    m_e_tag = e_tag;
    m_e_tag_isSet = true;
}

bool OAIVault::is_e_tag_Set() const{
    return m_e_tag_isSet;
}

bool OAIVault::is_e_tag_Valid() const{
