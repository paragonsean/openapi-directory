...
public:
    ...
    * @param[in]  vault OAIVault [required]
    */
    virtual void vaultsCreateOrUpdate(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &vault_name, const OAIVault &vault);
    ...
    * @param[in]  vault_name QString [required]
    */
    virtual void vaultsDelete(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &vault_name);
    ...
    * @param[in]  vault_name QString [required]
    */
    virtual void vaultsGet(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &vault_name);
    ...
    * @param[in]  resource_group_name QString [required]
    */
    virtual void vaultsListByResourceGroup(const QString &subscription_id, const QString &api_version, const QString &resource_group_name);

    /**
    * @param[in]  subscription_id QString [required]
    * @param[in]  api_version QString [required]
    */
    virtual void vaultsListBySubscriptionId(const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  resource_group_name QString [required]
    * @param[in]  vault_name QString [required]
    * @param[in]  vault OAIPatchVault [required]
    */
    virtual void vaultsUpdate(const QString &subscription_id, const QString &api_version, const QString &resource_group_name, const QString &vault_name, const OAIPatchVault &vault);
...
private:
    ...
    void vaultsListBySubscriptionIdCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void vaultsListByResourceGroupSignal(OAIVaultList summary);
    void vaultsListBySubscriptionIdSignal(OAIVaultList summary);
    ...
    void vaultsListByResourceGroupSignalFull(OAIHttpRequestWorker *worker, OAIVaultList summary);
    void vaultsListBySubscriptionIdSignalFull(OAIHttpRequestWorker *worker, OAIVaultList summary);
    ...
    void vaultsListByResourceGroupSignalE(OAIVaultList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void vaultsListByResourceGroupSignalError(OAIVaultList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use vaultsListBySubscriptionIdSignalError() instead")
    void vaultsListBySubscriptionIdSignalE(OAIVaultList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void vaultsListBySubscriptionIdSignalError(OAIVaultList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use vaultsListBySubscriptionIdSignalErrorFull() instead")
    void vaultsListBySubscriptionIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void vaultsListBySubscriptionIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
