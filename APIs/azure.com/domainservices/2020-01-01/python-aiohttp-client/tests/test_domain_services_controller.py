...
async def test_domain_services_create_or_update(client):
    ...
    """
    domain_service = {"properties":{"filteredSync":"Enabled","ldapsSettings":{"certificateNotAfter":"2000-01-23T04:56:07.000+00:00","pfxCertificatePassword":"pfxCertificatePassword","certificateThumbprint":"certificateThumbprint","publicCertificate":"publicCertificate","ldaps":"Enabled","pfxCertificate":"pfxCertificate","externalAccess":"Enabled"},"syncOwner":"syncOwner","domainSecuritySettings":{"tlsV1":"Enabled","ntlmV1":"Enabled","syncNtlmPasswords":"Enabled"},"replicaSets":[{"subnetId":"subnetId","vnetSiteId":"vnetSiteId","externalAccessIpAddress":"externalAccessIpAddress","domainControllerIpAddress":["domainControllerIpAddress","domainControllerIpAddress"],"healthAlerts":[{"severity":"severity","issue":"issue","lastDetected":"2000-01-23T04:56:07.000+00:00","name":"name","raised":"2000-01-23T04:56:07.000+00:00","id":"id","resolutionUri":"resolutionUri"},{"severity":"severity","issue":"issue","lastDetected":"2000-01-23T04:56:07.000+00:00","name":"name","raised":"2000-01-23T04:56:07.000+00:00","id":"id","resolutionUri":"resolutionUri"}],"serviceStatus":"serviceStatus","healthLastEvaluated":"2000-01-23T04:56:07.000+00:00","replicaSetId":"replicaSetId","healthMonitors":[{"name":"name","details":"details","id":"id"},{"name":"name","details":"details","id":"id"}],"location":"location"},{"subnetId":"subnetId","vnetSiteId":"vnetSiteId","externalAccessIpAddress":"externalAccessIpAddress","domainControllerIpAddress":["domainControllerIpAddress","domainControllerIpAddress"],"healthAlerts":[{"severity":"severity","issue":"issue","lastDetected":"2000-01-23T04:56:07.000+00:00","name":"name","raised":"2000-01-23T04:56:07.000+00:00","id":"id","resolutionUri":"resolutionUri"},{"severity":"severity","issue":"issue","lastDetected":"2000-01-23T04:56:07.000+00:00","name":"name","raised":"2000-01-23T04:56:07.000+00:00","id":"id","resolutionUri":"resolutionUri"}],"serviceStatus":"serviceStatus","healthLastEvaluated":"2000-01-23T04:56:07.000+00:00","replicaSetId":"replicaSetId","healthMonitors":[{"name":"name","details":"details","id":"id"},{"name":"name","details":"details","id":"id"}],"location":"location"}],"deploymentId":"deploymentId","domainName":"domainName","tenantId":"tenantId","provisioningState":"provisioningState","version":0,"notificationSettings":{"notifyDcAdmins":"Enabled","additionalRecipients":["additionalRecipients","additionalRecipients"],"notifyGlobalAdmins":"Enabled"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
