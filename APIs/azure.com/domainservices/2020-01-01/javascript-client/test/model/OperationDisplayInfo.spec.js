...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DomainServicesResourceProvider.OperationDisplayInfo();
  });
  ...
  describe('OperationDisplayInfo', function() {
    it('should create an instance of OperationDisplayInfo', function() {
      ...
      //var instance = new DomainServicesResourceProvider.OperationDisplayInfo();
      //expect(instance).to.be.a(DomainServicesResourceProvider.OperationDisplayInfo);
    });
