...
QString OAILdapsSettings::getExternalAccessIpAddress() const {
    return m_external_access_ip_address;
}
void OAILdapsSettings::setExternalAccessIpAddress(const QString &external_access_ip_address) {
    m_external_access_ip_address = external_access_ip_address;
    m_external_access_ip_address_isSet = true;
}

bool OAILdapsSettings::is_external_access_ip_address_Set() const{
    return m_external_access_ip_address_isSet;
}

bool OAILdapsSettings::is_external_access_ip_address_Valid() const{
