...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DomainServicesResourceProvider.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new DomainServicesResourceProvider.Resource();
      //expect(instance).to.be.a(DomainServicesResourceProvider.Resource);
    });
