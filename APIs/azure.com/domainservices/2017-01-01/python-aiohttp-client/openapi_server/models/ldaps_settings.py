...
class LdapsSettings(Model):
    ...
    def __init__(self, certificate_not_after: datetime=None, certificate_thumbprint: str=None, external_access: str=None, external_access_ip_address: str=None, ldaps: str=None, pfx_certificate: str=None, pfx_certificate_password: str=None, public_certificate: str=None):
        ...
        :param external_access_ip_address: The external_access_ip_address of this LdapsSettings.
    ...
    def external_access_ip_address(self):
        """Gets the external_access_ip_address of this LdapsSettings.

        External access ip address.

        :return: The external_access_ip_address of this LdapsSettings.
        :rtype: str
        """
    ...
    def external_access_ip_address(self, external_access_ip_address):
        """Sets the external_access_ip_address of this LdapsSettings.
