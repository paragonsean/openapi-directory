...
void OAIProductsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("productsDownload", defaultConf);
    _serverIndices.insert("productsDownload", 0);
...
void OAIProductsApi::productsDownload(const QString &subscription_id, const QString &resource_group, const QString &activation_name, const QString &product_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["productsDownload"][_serverIndices.value("productsDownload")].URL()+"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.AzureBridge.Admin/activations/{activationName}/products/{productName}/download");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::productsDownloadCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::productsDownloadCallback);
...
void OAIProductsApi::productsDownloadCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProducts_Download_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT productsDownloadSignal(output);
        Q_EMIT productsDownloadSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT productsDownloadSignalE(output, error_type, error_str);
        Q_EMIT productsDownloadSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT productsDownloadSignalError(output, error_type, error_str);
        Q_EMIT productsDownloadSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProductsApi::productsGet(const QString &subscription_id, const QString &resource_group, const QString &activation_name, const QString &product_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["productsGet"][_serverIndices.value("productsGet")].URL()+"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.AzureBridge.Admin/activations/{activationName}/products/{productName}");
...
void OAIProductsApi::productsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProductResource output(QString(worker->response));
    worker->deleteLater();
...
void OAIProductsApi::productsList(const QString &subscription_id, const QString &resource_group, const QString &activation_name, const QString &api_version) {
    QString fullPath = QString(_serverConfigs["productsList"][_serverIndices.value("productsList")].URL()+"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.AzureBridge.Admin/activations/{activationName}/products");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::productsListCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::productsListCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProductsApi::productsListCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProductResourcesPage output(QString(worker->response));
    worker->deleteLater();
