...
class ProductResource {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = Product.constructFromObject(data['properties']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ProductResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductResource</code>.
     */
    static validateJSON(data) {
        // validate the optional field `properties`
        if (data['properties']) { // data not null
          Product.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/Product} properties
 */
ProductResource.prototype['properties'] = undefined;
 ...
 */
ProductResource.prototype['location'] = undefined;
 ...
 */
ProductResource.prototype['tags'] = undefined;

/**
 * Type of resource.
 * @member {String} type
 */
ProductResource.prototype['type'] = undefined;
