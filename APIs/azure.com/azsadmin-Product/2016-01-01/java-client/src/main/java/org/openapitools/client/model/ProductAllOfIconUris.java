...
public class ProductAllOfIconUris {
  ...
  public ProductAllOfIconUris() {
  }

  public ProductAllOfIconUris hero(String hero) {
    this.hero = hero;
    return this;
  }
  ...
  public ProductAllOfIconUris large(String large) {
    this.large = large;
    return this;
  }
  ...
  public ProductAllOfIconUris medium(String medium) {
    this.medium = medium;
    return this;
  }
  ...
  public ProductAllOfIconUris small(String small) {
    this.small = small;
    return this;
  }
  ...
  public ProductAllOfIconUris wide(String wide) {
    this.wide = wide;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProductAllOfIconUris productAllOfIconUris = (ProductAllOfIconUris) o;
    return Objects.equals(this.hero, productAllOfIconUris.hero) &&
        Objects.equals(this.large, productAllOfIconUris.large) &&
        Objects.equals(this.medium, productAllOfIconUris.medium) &&
        Objects.equals(this.small, productAllOfIconUris.small) &&
        Objects.equals(this.wide, productAllOfIconUris.wide);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductAllOfIconUris {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProductAllOfIconUris
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductAllOfIconUris.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductAllOfIconUris is not found in the empty JSON string", ProductAllOfIconUris.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductAllOfIconUris.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductAllOfIconUris` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductAllOfIconUris.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductAllOfIconUris' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductAllOfIconUris> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductAllOfIconUris.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductAllOfIconUris>() {
           @Override
           public void write(JsonWriter out, ProductAllOfIconUris value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductAllOfIconUris read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProductAllOfIconUris given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProductAllOfIconUris
   * @throws IOException if the JSON string is invalid with respect to ProductAllOfIconUris
   */
  public static ProductAllOfIconUris fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductAllOfIconUris.class);
  }

  /**
   * Convert an instance of ProductAllOfIconUris to an JSON string
   *
   * @return JSON string
   */
