...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.BackendReconnectRequest();
  });
  ...
  describe('BackendReconnectRequest', function() {
    it('should create an instance of BackendReconnectRequest', function() {
      // uncomment below and update the code to test BackendReconnectRequest
      //var instance = new ApiManagementClient.BackendReconnectRequest();
      //expect(instance).to.be.a(ApiManagementClient.BackendReconnectRequest);
    });
