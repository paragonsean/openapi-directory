...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.BackendListByService200Response();
  });
  ...
  describe('BackendListByService200Response', function() {
    it('should create an instance of BackendListByService200Response', function() {
      // uncomment below and update the code to test BackendListByService200Response
      //var instance = new ApiManagementClient.BackendListByService200Response();
      //expect(instance).to.be.a(ApiManagementClient.BackendListByService200Response);
    });
