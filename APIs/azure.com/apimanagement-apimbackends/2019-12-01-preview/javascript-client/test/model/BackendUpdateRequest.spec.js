...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.BackendUpdateRequest();
  });
  ...
  describe('BackendUpdateRequest', function() {
    it('should create an instance of BackendUpdateRequest', function() {
      // uncomment below and update the code to test BackendUpdateRequest
      //var instance = new ApiManagementClient.BackendUpdateRequest();
      //expect(instance).to.be.a(ApiManagementClient.BackendUpdateRequest);
    });
