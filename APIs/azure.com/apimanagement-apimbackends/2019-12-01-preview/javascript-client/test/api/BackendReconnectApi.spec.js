...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.BackendReconnectApi();
  });
  ...
  describe('BackendReconnectApi', function() {
    describe('backendReconnect', function() {
      it('should call backendReconnect successfully', function(done) {
        //uncomment below and update the code to test backendReconnect
        //instance.backendReconnect(function(error) {
