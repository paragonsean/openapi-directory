...
let aPIKeyProperties = new ApplicationInsightsManagementClient.APIKeyRequest(); // APIKeyRequest | Properties that need to be specified to create an API key of a Application Insights component.
apiInstance.aPIKeysCreate(resourceGroupName, apiVersion, subscriptionId, resourceName, aPIKeyProperties, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let subscriptionId = "subscriptionId_example"; // String | The ID of the target subscription.
let resourceName = "resourceName_example"; // String | The name of the Application Insights component resource.
let keyId = "keyId_example"; // String | The API Key ID. This is unique within a Application Insights component.
apiInstance.aPIKeysDelete(resourceGroupName, apiVersion, subscriptionId, resourceName, keyId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let resourceName = "resourceName_example"; // String | The name of the Application Insights component resource.
let keyId = "keyId_example"; // String | The API Key ID. This is unique within a Application Insights component.
apiInstance.aPIKeysGet(resourceGroupName, apiVersion, subscriptionId, resourceName, keyId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The ID of the target subscription.
let resourceName = "resourceName_example"; // String | The name of the Application Insights component resource.
apiInstance.aPIKeysList(resourceGroupName, apiVersion, subscriptionId, resourceName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
