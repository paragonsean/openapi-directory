...
public class Operation {
  ...
  public Operation display(OperationProperties display) {
  ...
  public OperationProperties getDisplay() {
    return display;
  }

  public void setDisplay(OperationProperties display) {
    this.display = display;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("display") != null && !jsonObj.get("display").isJsonNull()) {
        OperationProperties.validateJsonElement(jsonObj.get("display"));
      }
