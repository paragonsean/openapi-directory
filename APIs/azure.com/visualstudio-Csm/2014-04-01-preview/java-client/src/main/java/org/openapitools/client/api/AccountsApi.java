...
public class AccountsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The operation succeeded. The Visual Studio Team Services account resource was updated. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The Visual Studio Team Services account does not exist. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call accountsUpdateCall(String resourceGroupName, String subscriptionId, String apiVersion, String resourceName, AccountTagRequest body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountsUpdateValidateBeforeCall(String resourceGroupName, String subscriptionId, String apiVersion, String resourceName, AccountTagRequest body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        // verify the required parameter 'resourceName' is set
        if (resourceName == null) {
            throw new ApiException("Missing the required parameter 'resourceName' when calling accountsUpdate(Async)");
        }
        ...
        return accountsUpdateCall(resourceGroupName, subscriptionId, apiVersion, resourceName, body, _callback);
     ...
     */
    public AccountResource accountsUpdate(String resourceGroupName, String subscriptionId, String apiVersion, String resourceName, AccountTagRequest body) throws ApiException {
        ApiResponse<AccountResource> localVarResp = accountsUpdateWithHttpInfo(resourceGroupName, subscriptionId, apiVersion, resourceName, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AccountResource> accountsUpdateWithHttpInfo(String resourceGroupName, String subscriptionId, String apiVersion, String resourceName, AccountTagRequest body) throws ApiException {
        okhttp3.Call localVarCall = accountsUpdateValidateBeforeCall(resourceGroupName, subscriptionId, apiVersion, resourceName, body, null);
        Type localVarReturnType = new TypeToken<AccountResource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Accounts_Update (asynchronously)
     * Updates tags for Visual Studio Team Services account resource.
     * @param resourceGroupName Name of the resource group within the Azure subscription. (required)
     * @param subscriptionId The Azure subscription identifier. (required)
     * @param apiVersion API Version (required)
     ...
     */
    public okhttp3.Call accountsUpdateAsync(String resourceGroupName, String subscriptionId, String apiVersion, String resourceName, AccountTagRequest body, final ApiCallback<AccountResource> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountsUpdateValidateBeforeCall(resourceGroupName, subscriptionId, apiVersion, resourceName, body, _callback);
        Type localVarReturnType = new TypeToken<AccountResource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
