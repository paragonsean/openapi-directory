...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | API Version
    String resourceName = "resourceName_example"; // String | Name of the resource.
    AccountTagRequest body = new AccountTagRequest(); // AccountTagRequest | The request data.
    try {
      AccountResource result = apiInstance.accountsUpdate(resourceGroupName, subscriptionId, apiVersion, resourceName, body);
      System.out.println(result);
    } catch (ApiException e) {
