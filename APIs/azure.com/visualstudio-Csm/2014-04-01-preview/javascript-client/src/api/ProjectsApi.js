...
export default class ProjectsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the projectsGetJobStatus operation.
     * @callback module:api/ProjectsApi~projectsGetJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProjectResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} rootResourceName Name of the Team Services account.
     * @param {String} resourceName Name of the Team Services project.
     * @param {String} subContainerName This parameter should be set to the resourceName.
     * @param {String} operation The operation type. The only supported value is 'put'.
     * @param {Object} opts Optional parameters
     * @param {String} [jobId] The job identifier.
     * @param {module:api/ProjectsApi~projectsGetJobStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectResource}
     */
    projectsGetJobStatus(resourceGroupName, subscriptionId, apiVersion, rootResourceName, resourceName, subContainerName, operation, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling projectsGetJobStatus");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling projectsGetJobStatus");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling projectsGetJobStatus");
      }
      // verify the required parameter 'rootResourceName' is set
      if (rootResourceName === undefined || rootResourceName === null) {
        throw new Error("Missing the required parameter 'rootResourceName' when calling projectsGetJobStatus");
      }
      // verify the required parameter 'resourceName' is set
      if (resourceName === undefined || resourceName === null) {
        throw new Error("Missing the required parameter 'resourceName' when calling projectsGetJobStatus");
      }
      // verify the required parameter 'subContainerName' is set
      if (subContainerName === undefined || subContainerName === null) {
        throw new Error("Missing the required parameter 'subContainerName' when calling projectsGetJobStatus");
      }
      // verify the required parameter 'operation' is set
      if (operation === undefined || operation === null) {
        throw new Error("Missing the required parameter 'operation' when calling projectsGetJobStatus");
      }
     ...
     * @callback module:api/ProjectsApi~projectsListByResourceGroupCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apiVersion API Version
     * @param {String} rootResourceName Name of the Team Services account.
     * @param {module:api/ProjectsApi~projectsListByResourceGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProjectResourceListResult}
     */
    projectsListByResourceGroup(resourceGroupName, subscriptionId, apiVersion, rootResourceName, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
      ...
      // verify the required parameter 'rootResourceName' is set
      if (rootResourceName === undefined || rootResourceName === null) {
        throw new Error("Missing the required parameter 'rootResourceName' when calling projectsListByResourceGroup");
      }
