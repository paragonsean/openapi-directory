...
apiInstance.projectListByAccountResource(resourceGroupName, subscriptionId, apiVersion, rootResourceName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let rootResourceName = "rootResourceName_example"; // String | Name of the Team Services account.
let resourceName = "resourceName_example"; // String | Name of the Team Services project.
let body = new VisualStudioResourceProviderClient.ProjectResourceUpdateParameters(); // ProjectResourceUpdateParameters | The request data.
