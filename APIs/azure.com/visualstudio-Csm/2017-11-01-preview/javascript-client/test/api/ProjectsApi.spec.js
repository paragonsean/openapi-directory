...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    describe('projectListByAccountResource', function() {
      it('should call projectListByAccountResource successfully', function(done) {
        //uncomment below and update the code to test projectListByAccountResource
        //instance.projectListByAccountResource(function(error) {
