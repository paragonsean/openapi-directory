...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualStudioResourceProviderClient.Authorization();
  });
  ...
  describe('Authorization', function() {
    it('should create an instance of Authorization', function() {
      ...
      //var instance = new VisualStudioResourceProviderClient.Authorization();
      //expect(instance).to.be.a(VisualStudioResourceProviderClient.Authorization);
    });
