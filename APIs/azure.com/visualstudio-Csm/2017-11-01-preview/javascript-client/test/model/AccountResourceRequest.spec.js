...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualStudioResourceProviderClient.AccountResourceRequest();
  });
  ...
  describe('AccountResourceRequest', function() {
    it('should create an instance of AccountResourceRequest', function() {
      // uncomment below and update the code to test AccountResourceRequest
      //var instance = new VisualStudioResourceProviderClient.AccountResourceRequest();
      //expect(instance).to.be.a(VisualStudioResourceProviderClient.AccountResourceRequest);
    });
