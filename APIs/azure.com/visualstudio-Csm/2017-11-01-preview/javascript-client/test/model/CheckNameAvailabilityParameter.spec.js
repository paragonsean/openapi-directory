...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisualStudioResourceProviderClient.CheckNameAvailabilityParameter();
  });
  ...
  describe('CheckNameAvailabilityParameter', function() {
    it('should create an instance of CheckNameAvailabilityParameter', function() {
      // uncomment below and update the code to test CheckNameAvailabilityParameter
      //var instance = new VisualStudioResourceProviderClient.CheckNameAvailabilityParameter();
      //expect(instance).to.be.a(VisualStudioResourceProviderClient.CheckNameAvailabilityParameter);
    });
