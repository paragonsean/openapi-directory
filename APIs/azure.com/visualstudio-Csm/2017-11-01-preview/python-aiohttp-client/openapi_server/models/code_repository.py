...
class CodeRepository(Model):
    ...
    def __init__(self, authorization_reference: str=None, default_branch: str=None, id: str=None, properties: Dict[str, str]=None, repository_type: str=None):
        """CodeRepository - a model defined in OpenAPI

        :param authorization_reference: The authorization_reference of this CodeRepository.
    ...
    def authorization_reference(self):
        """Gets the authorization_reference of this CodeRepository.
        ...
        :return: The authorization_reference of this CodeRepository.
        :rtype: str
        """
    ...
    def authorization_reference(self, authorization_reference):
        """Sets the authorization_reference of this CodeRepository.
