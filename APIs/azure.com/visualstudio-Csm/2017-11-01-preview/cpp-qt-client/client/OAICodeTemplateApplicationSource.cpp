...
#include "OAICodeTemplateApplicationSource.h"
...
OAICodeTemplateApplicationSource::OAICodeTemplateApplicationSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICodeTemplateApplicationSource::OAICodeTemplateApplicationSource() {
    this->initializeModel();
}

OAICodeTemplateApplicationSource::~OAICodeTemplateApplicationSource() {}

void OAICodeTemplateApplicationSource::initializeModel() {
...
void OAICodeTemplateApplicationSource::fromJson(QString jsonString) {
...
void OAICodeTemplateApplicationSource::fromJsonObject(QJsonObject json) {
...
QString OAICodeTemplateApplicationSource::asJson() const {
...
QJsonObject OAICodeTemplateApplicationSource::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, QString> OAICodeTemplateApplicationSource::getApplicationConfiguration() const {
    return m_application_configuration;
}
void OAICodeTemplateApplicationSource::setApplicationConfiguration(const QMap<QString, QString> &application_configuration) {
    m_application_configuration = application_configuration;
    m_application_configuration_isSet = true;
}

bool OAICodeTemplateApplicationSource::is_application_configuration_Set() const{
    return m_application_configuration_isSet;
}

bool OAICodeTemplateApplicationSource::is_application_configuration_Valid() const{
    return m_application_configuration_isValid;
}

QString OAICodeTemplateApplicationSource::getApplicationType() const {
    return m_application_type;
}
void OAICodeTemplateApplicationSource::setApplicationType(const QString &application_type) {
    m_application_type = application_type;
    m_application_type_isSet = true;
}

bool OAICodeTemplateApplicationSource::is_application_type_Set() const{
    return m_application_type_isSet;
}

bool OAICodeTemplateApplicationSource::is_application_type_Valid() const{
    return m_application_type_isValid;
}

QString OAICodeTemplateApplicationSource::getSourceType() const {
    return m_source_type;
}
void OAICodeTemplateApplicationSource::setSourceType(const QString &source_type) {
    m_source_type = source_type;
    m_source_type_isSet = true;
}

bool OAICodeTemplateApplicationSource::is_source_type_Set() const{
    return m_source_type_isSet;
}

bool OAICodeTemplateApplicationSource::is_source_type_Valid() const{
    return m_source_type_isValid;
}

bool OAICodeTemplateApplicationSource::isSet() const {
...
bool OAICodeTemplateApplicationSource::isValid() const {
