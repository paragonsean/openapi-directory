...
/*
 * OAICodeTemplateApplicationSource.h
 *
 * Defines the source application template.
 */

#ifndef OAICodeTemplateApplicationSource_H
#define OAICodeTemplateApplicationSource_H
...
class OAICodeTemplateApplicationSource : public OAIObject {
public:
    OAICodeTemplateApplicationSource();
    OAICodeTemplateApplicationSource(QString json);
    ~OAICodeTemplateApplicationSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeTemplateApplicationSource)

#endif // OAICodeTemplateApplicationSource_H
