...
public:
    ...
    */
    Q_DECL_DEPRECATED virtual void projectListByAccountResource(const QString &resource_group_name, const QString &subscription_id, const QString &api_version, const QString &root_resource_name);
    ...
    * @param[in]  root_resource_name QString [required]
    * @param[in]  resource_name QString [required]
    * @param[in]  body OAIProjectResourceUpdateParameters [required]
    */
    Q_DECL_DEPRECATED virtual void projectsUpdate(const QString &resource_group_name, const QString &subscription_id, const QString &api_version, const QString &root_resource_name, const QString &resource_name, const OAIProjectResourceUpdateParameters &body);
...
private:
    ...
    void projectListByAccountResourceCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void projectListByAccountResourceSignal(OAIProjectResourceListResult summary);
    ...
    void projectListByAccountResourceSignalFull(OAIHttpRequestWorker *worker, OAIProjectResourceListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use projectListByAccountResourceSignalError() instead")
    void projectListByAccountResourceSignalE(OAIProjectResourceListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void projectListByAccountResourceSignalError(OAIProjectResourceListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use projectListByAccountResourceSignalErrorFull() instead")
    void projectListByAccountResourceSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void projectListByAccountResourceSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
