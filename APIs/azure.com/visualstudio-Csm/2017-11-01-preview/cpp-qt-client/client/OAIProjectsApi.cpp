...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("projectListByAccountResource", defaultConf);
    _serverIndices.insert("projectListByAccountResource", 0);
...
void OAIProjectsApi::projectListByAccountResource(const QString &resource_group_name, const QString &subscription_id, const QString &api_version, const QString &root_resource_name) {
    QString fullPath = QString(_serverConfigs["projectListByAccountResource"][_serverIndices.value("projectListByAccountResource")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.visualstudio/account/{rootResourceName}/project");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::projectListByAccountResourceCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::projectListByAccountResourceCallback);
...
void OAIProjectsApi::projectListByAccountResourceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT projectListByAccountResourceSignal(output);
        Q_EMIT projectListByAccountResourceSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT projectListByAccountResourceSignalE(output, error_type, error_str);
        Q_EMIT projectListByAccountResourceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT projectListByAccountResourceSignalError(output, error_type, error_str);
        Q_EMIT projectListByAccountResourceSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIProjectsApi::projectsUpdate(const QString &resource_group_name, const QString &subscription_id, const QString &api_version, const QString &root_resource_name, const QString &resource_name, const OAIProjectResourceUpdateParameters &body) {
