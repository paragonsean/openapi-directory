...
public class ProjectsApi {
    ...
    /**
     * Build call for projectListByAccountResource
     ...
     */
    @Deprecated
    public okhttp3.Call projectListByAccountResourceCall(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call projectListByAccountResourceValidateBeforeCall(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling projectListByAccountResource(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling projectListByAccountResource(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling projectListByAccountResource(Async)");
        }

        // verify the required parameter 'rootResourceName' is set
        if (rootResourceName == null) {
            throw new ApiException("Missing the required parameter 'rootResourceName' when calling projectListByAccountResource(Async)");
        }

        return projectListByAccountResourceCall(resourceGroupName, subscriptionId, apiVersion, rootResourceName, _callback);
     ...
     */
    @Deprecated
    public ProjectResourceListResult projectListByAccountResource(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName) throws ApiException {
        ApiResponse<ProjectResourceListResult> localVarResp = projectListByAccountResourceWithHttpInfo(resourceGroupName, subscriptionId, apiVersion, rootResourceName);
     ...
     */
    @Deprecated
    public ApiResponse<ProjectResourceListResult> projectListByAccountResourceWithHttpInfo(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName) throws ApiException {
        okhttp3.Call localVarCall = projectListByAccountResourceValidateBeforeCall(resourceGroupName, subscriptionId, apiVersion, rootResourceName, null);
        Type localVarReturnType = new TypeToken<ProjectResourceListResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Projects_ListByAccountResource (asynchronously)
     * Gets all Visual Studio Team Services project resources created in the specified Team Services account.
     * @param resourceGroupName Name of the resource group within the Azure subscription. (required)
     * @param subscriptionId The Azure subscription identifier. (required)
     * @param apiVersion API Version (required)
     ...
     */
    @Deprecated
    public okhttp3.Call projectListByAccountResourceAsync(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, final ApiCallback<ProjectResourceListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = projectListByAccountResourceValidateBeforeCall(resourceGroupName, subscriptionId, apiVersion, rootResourceName, _callback);
        Type localVarReturnType = new TypeToken<ProjectResourceListResult>(){}.getType();
     ...
     */
    @Deprecated
    public okhttp3.Call projectsUpdateCall(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, String resourceName, ProjectResourceUpdateParameters body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call projectsUpdateValidateBeforeCall(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, String resourceName, ProjectResourceUpdateParameters body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
     ...
     */
    @Deprecated
    public ProjectResource projectsUpdate(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, String resourceName, ProjectResourceUpdateParameters body) throws ApiException {
     ...
     */
    @Deprecated
    public ApiResponse<ProjectResource> projectsUpdateWithHttpInfo(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, String resourceName, ProjectResourceUpdateParameters body) throws ApiException {
     ...
     */
    @Deprecated
    public okhttp3.Call projectsUpdateAsync(String resourceGroupName, String subscriptionId, String apiVersion, String rootResourceName, String resourceName, ProjectResourceUpdateParameters body, final ApiCallback<ProjectResource> _callback) throws ApiException {
