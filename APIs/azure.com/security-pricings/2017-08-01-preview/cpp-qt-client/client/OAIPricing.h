...
public:
    ...
    OAIPricingProperties getProperties() const;
    void setProperties(const OAIPricingProperties &properties);
...
private:
    ...
    OAIPricingProperties m_properties;
