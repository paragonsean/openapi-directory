...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultManagementClient.SecretAttributes();
  });
  ...
  describe('SecretAttributes', function() {
    it('should create an instance of SecretAttributes', function() {
      // uncomment below and update the code to test SecretAttributes
      //var instance = new KeyVaultManagementClient.SecretAttributes();
      //expect(instance).to.be.a(KeyVaultManagementClient.SecretAttributes);
    });
