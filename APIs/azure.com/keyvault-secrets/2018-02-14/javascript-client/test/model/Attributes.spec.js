...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeyVaultManagementClient.Attributes();
  });
  ...
  describe('Attributes', function() {
    it('should create an instance of Attributes', function() {
      ...
      //var instance = new KeyVaultManagementClient.Attributes();
      //expect(instance).to.be.a(KeyVaultManagementClient.Attributes);
    });
