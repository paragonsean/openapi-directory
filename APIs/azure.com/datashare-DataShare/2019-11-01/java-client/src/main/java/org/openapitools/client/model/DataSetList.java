...
public class DataSetList {
  ...
  private List<DataSet> value = new ArrayList<>();

  public DataSetList() {
  }

  public DataSetList nextLink(String nextLink) {
  ...
  public DataSetList value(List<DataSet> value) {
    this.value = value;
    return this;
  }

  public DataSetList addValueItem(DataSet valueItem) {
    if (this.value == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextLink, dataSetList.nextLink) &&
        Objects.equals(this.value, dataSetList.value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayvalue.size(); i++) {
        DataSet.validateJsonElement(jsonArrayvalue.get(i));
      };
  }
