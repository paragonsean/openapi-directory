...
class Invitation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = InvitationProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          InvitationProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/InvitationProperties} properties
 */
Invitation.prototype['properties'] = undefined;
 ...
 * @member {String} type
 */
Invitation.prototype['type'] = undefined;
