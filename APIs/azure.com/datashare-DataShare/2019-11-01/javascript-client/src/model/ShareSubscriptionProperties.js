...
class ShareSubscriptionProperties {
     ...
     * @param sourceShareLocation {String} Source share location.
     */
    constructor(invitationId, sourceShareLocation) { 
        
        ShareSubscriptionProperties.initialize(this, invitationId, sourceShareLocation);
    }
     ...
     */
    static initialize(obj, invitationId, sourceShareLocation) { 
        obj['invitationId'] = invitationId;
        obj['sourceShareLocation'] = sourceShareLocation;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sourceShareLocation')) {
                obj['sourceShareLocation'] = ApiClient.convertToType(data['sourceShareLocation'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['sourceShareLocation'] && !(typeof data['sourceShareLocation'] === 'string' || data['sourceShareLocation'] instanceof String)) {
            throw new Error("Expected the field `sourceShareLocation` to be a primitive type in the JSON string but got " + data['sourceShareLocation']);
        }
        // ensure the json data is a string
...
ShareSubscriptionProperties.RequiredProperties = ["invitationId", "sourceShareLocation"];
 ...
 * @member {String} sourceShareLocation
 */
ShareSubscriptionProperties.prototype['sourceShareLocation'] = undefined;
