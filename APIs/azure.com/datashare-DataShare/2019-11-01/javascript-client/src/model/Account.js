...
class Account {
     ...
     * @implements module:model/DefaultDto
     */
    constructor() { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Account();
            DefaultDto.constructFromObject(data, obj);
...
Account.RequiredProperties = ["identity"];

/**
 * @member {module:model/Identity} identity
 */
Account.prototype['identity'] = undefined;
...
// Implement DefaultDto interface:
/**
 * The resource id of the azure resource
 * @member {String} id
 */
