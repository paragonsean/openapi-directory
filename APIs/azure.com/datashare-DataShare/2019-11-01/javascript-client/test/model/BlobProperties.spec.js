...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.BlobProperties();
  });
  ...
  describe('BlobProperties', function() {
    it('should create an instance of BlobProperties', function() {
      // uncomment below and update the code to test BlobProperties
      //var instance = new DataShareManagementClient.BlobProperties();
      //expect(instance).to.be.a(DataShareManagementClient.BlobProperties);
    });
