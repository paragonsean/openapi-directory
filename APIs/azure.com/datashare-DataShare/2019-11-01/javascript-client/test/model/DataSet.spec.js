...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.DataSet();
  });
  ...
  describe('DataSet', function() {
    it('should create an instance of DataSet', function() {
      ...
      //var instance = new DataShareManagementClient.DataSet();
      //expect(instance).to.be.a(DataShareManagementClient.DataSet);
    });
