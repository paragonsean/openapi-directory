...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.BlobFolderMappingProperties();
  });
  ...
  describe('BlobFolderMappingProperties', function() {
    it('should create an instance of BlobFolderMappingProperties', function() {
      // uncomment below and update the code to test BlobFolderMappingProperties
      //var instance = new DataShareManagementClient.BlobFolderMappingProperties();
      //expect(instance).to.be.a(DataShareManagementClient.BlobFolderMappingProperties);
    });
