...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.ADLSGen1FolderProperties();
  });
  ...
  describe('ADLSGen1FolderProperties', function() {
    it('should create an instance of ADLSGen1FolderProperties', function() {
      // uncomment below and update the code to test ADLSGen1FolderProperties
      //var instance = new DataShareManagementClient.ADLSGen1FolderProperties();
      //expect(instance).to.be.a(DataShareManagementClient.ADLSGen1FolderProperties);
    });
