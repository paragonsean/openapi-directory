...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new DataShareManagementClient.Account();
      //expect(instance).to.be.a(DataShareManagementClient.Account);
    });
