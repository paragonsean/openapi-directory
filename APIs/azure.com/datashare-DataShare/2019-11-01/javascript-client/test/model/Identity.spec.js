...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.Identity();
  });
  ...
  describe('Identity', function() {
    it('should create an instance of Identity', function() {
      ...
      //var instance = new DataShareManagementClient.Identity();
      //expect(instance).to.be.a(DataShareManagementClient.Identity);
    });
