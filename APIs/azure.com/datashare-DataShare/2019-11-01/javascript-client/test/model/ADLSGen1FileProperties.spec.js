...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.ADLSGen1FileProperties();
  });
  ...
  describe('ADLSGen1FileProperties', function() {
    it('should create an instance of ADLSGen1FileProperties', function() {
      // uncomment below and update the code to test ADLSGen1FileProperties
      //var instance = new DataShareManagementClient.ADLSGen1FileProperties();
      //expect(instance).to.be.a(DataShareManagementClient.ADLSGen1FileProperties);
    });
