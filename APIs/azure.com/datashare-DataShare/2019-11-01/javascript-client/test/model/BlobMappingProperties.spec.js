...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.BlobMappingProperties();
  });
  ...
  describe('BlobMappingProperties', function() {
    it('should create an instance of BlobMappingProperties', function() {
      // uncomment below and update the code to test BlobMappingProperties
      //var instance = new DataShareManagementClient.BlobMappingProperties();
      //expect(instance).to.be.a(DataShareManagementClient.BlobMappingProperties);
    });
