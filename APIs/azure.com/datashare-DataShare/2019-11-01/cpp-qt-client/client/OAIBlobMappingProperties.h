...
/*
 * OAIBlobMappingProperties.h
 *
 * Azure storage Blob data set mapping property bag.
 */

#ifndef OAIBlobMappingProperties_H
#define OAIBlobMappingProperties_H
...
class OAIBlobMappingProperties : public OAIObject {
public:
    OAIBlobMappingProperties();
    OAIBlobMappingProperties(QString json);
    ~OAIBlobMappingProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlobMappingProperties)

#endif // OAIBlobMappingProperties_H
