...
/*
 * OAIBlobFolderProperties.h
 *
 * Properties of the blob folder data set.
 */

#ifndef OAIBlobFolderProperties_H
#define OAIBlobFolderProperties_H
...
class OAIBlobFolderProperties : public OAIObject {
public:
    OAIBlobFolderProperties();
    OAIBlobFolderProperties(QString json);
    ~OAIBlobFolderProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlobFolderProperties)

#endif // OAIBlobFolderProperties_H
