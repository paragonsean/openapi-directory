...
void OAIShareSubscriptionProperties::initializeModel() {
    ...
    m_source_share_location_isSet = false;
    m_source_share_location_isValid = false;
...
void OAIShareSubscriptionProperties::fromJsonObject(QJsonObject json) {
    ...
    m_source_share_location_isValid = ::OpenAPI::fromJsonValue(m_source_share_location, json[QString("sourceShareLocation")]);
    m_source_share_location_isSet = !json[QString("sourceShareLocation")].isNull() && m_source_share_location_isValid;
...
QJsonObject OAIShareSubscriptionProperties::asJsonObject() const {
    ...
    if (m_source_share_location_isSet) {
        obj.insert(QString("sourceShareLocation"), ::OpenAPI::toJsonValue(m_source_share_location));
    }
...
QString OAIShareSubscriptionProperties::getSourceShareLocation() const {
    return m_source_share_location;
}
void OAIShareSubscriptionProperties::setSourceShareLocation(const QString &source_share_location) {
    m_source_share_location = source_share_location;
    m_source_share_location_isSet = true;
}

bool OAIShareSubscriptionProperties::is_source_share_location_Set() const{
    return m_source_share_location_isSet;
}

bool OAIShareSubscriptionProperties::is_source_share_location_Valid() const{
    return m_source_share_location_isValid;
}
...
bool OAIShareSubscriptionProperties::isValid() const {
    ...
    return m_invitation_id_isValid && m_source_share_location_isValid && true;
}
