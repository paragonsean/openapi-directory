...
/*
 * OAIOperationModelProperties.h
 *
 * Properties on operations
 */

#ifndef OAIOperationModelProperties_H
#define OAIOperationModelProperties_H
...
class OAIOperationModelProperties : public OAIObject {
public:
    OAIOperationModelProperties();
    OAIOperationModelProperties(QString json);
    ~OAIOperationModelProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOperationModelProperties)

#endif // OAIOperationModelProperties_H
