...
/*
 * OAIBlobFolderMappingProperties.h
 *
 * Azure storage Blob folder data set mapping property bag.
 */

#ifndef OAIBlobFolderMappingProperties_H
#define OAIBlobFolderMappingProperties_H
...
class OAIBlobFolderMappingProperties : public OAIObject {
public:
    OAIBlobFolderMappingProperties();
    OAIBlobFolderMappingProperties(QString json);
    ~OAIBlobFolderMappingProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlobFolderMappingProperties)

#endif // OAIBlobFolderMappingProperties_H
