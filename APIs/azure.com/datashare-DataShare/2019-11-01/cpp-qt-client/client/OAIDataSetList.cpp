...
QString OAIDataSetList::getNextLink() const {
    return m_next_link;
}
void OAIDataSetList::setNextLink(const QString &next_link) {
    m_next_link = next_link;
    m_next_link_isSet = true;
}

bool OAIDataSetList::is_next_link_Set() const{
    return m_next_link_isSet;
}

bool OAIDataSetList::is_next_link_Valid() const{
    return m_next_link_isValid;
}

QList<OAIDataSet> OAIDataSetList::getValue() const {
    return m_value;
}
void OAIDataSetList::setValue(const QList<OAIDataSet> &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIDataSetList::is_value_Set() const{
    return m_value_isSet;
}

bool OAIDataSetList::is_value_Valid() const{
