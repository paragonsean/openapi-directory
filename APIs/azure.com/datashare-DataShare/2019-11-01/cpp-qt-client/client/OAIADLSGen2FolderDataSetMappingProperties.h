...
/*
 * OAIADLSGen2FolderDataSetMappingProperties.h
 *
 * ADLS Gen 2 folder data set mapping property bag.
 */

#ifndef OAIADLSGen2FolderDataSetMappingProperties_H
#define OAIADLSGen2FolderDataSetMappingProperties_H
...
class OAIADLSGen2FolderDataSetMappingProperties : public OAIObject {
public:
    OAIADLSGen2FolderDataSetMappingProperties();
    OAIADLSGen2FolderDataSetMappingProperties(QString json);
    ~OAIADLSGen2FolderDataSetMappingProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIADLSGen2FolderDataSetMappingProperties)

#endif // OAIADLSGen2FolderDataSetMappingProperties_H
