...
/*
 * OAISqlDWTableDataSetMappingProperties.h
 *
 * Properties of the SQL DW table data set mapping.
 */

#ifndef OAISqlDWTableDataSetMappingProperties_H
#define OAISqlDWTableDataSetMappingProperties_H
...
class OAISqlDWTableDataSetMappingProperties : public OAIObject {
public:
    OAISqlDWTableDataSetMappingProperties();
    OAISqlDWTableDataSetMappingProperties(QString json);
    ~OAISqlDWTableDataSetMappingProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISqlDWTableDataSetMappingProperties)

#endif // OAISqlDWTableDataSetMappingProperties_H
