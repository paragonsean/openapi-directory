...
/*
 * OAIBlobContainerProperties.h
 *
 * Properties of the BLOB container data set.
 */

#ifndef OAIBlobContainerProperties_H
#define OAIBlobContainerProperties_H
...
class OAIBlobContainerProperties : public OAIObject {
public:
    OAIBlobContainerProperties();
    OAIBlobContainerProperties(QString json);
    ~OAIBlobContainerProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlobContainerProperties)

#endif // OAIBlobContainerProperties_H
