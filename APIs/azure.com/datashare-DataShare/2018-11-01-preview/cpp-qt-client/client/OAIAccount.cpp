...
OAIIdentity OAIAccount::getIdentity() const {
    return m_identity;
}
void OAIAccount::setIdentity(const OAIIdentity &identity) {
    m_identity = identity;
    m_identity_isSet = true;
}

bool OAIAccount::is_identity_Set() const{
    return m_identity_isSet;
}

bool OAIAccount::is_identity_Valid() const{
