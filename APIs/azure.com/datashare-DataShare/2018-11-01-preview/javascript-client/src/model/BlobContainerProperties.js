...
/**
 * The BlobContainerProperties model module.
 * @module model/BlobContainerProperties
 * @version 2018-11-01-preview
 */
class BlobContainerProperties {
    /**
     * Constructs a new <code>BlobContainerProperties</code>.
     * Properties of the BLOB container data set.
     * @alias module:model/BlobContainerProperties
     ...
     */
    constructor(containerName, resourceGroup, storageAccountName, subscriptionId) { 
        
        BlobContainerProperties.initialize(this, containerName, resourceGroup, storageAccountName, subscriptionId);
    }
     ...
     */
    static initialize(obj, containerName, resourceGroup, storageAccountName, subscriptionId) { 
    ...
    /**
     * Constructs a <code>BlobContainerProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlobContainerProperties} obj Optional instance to populate.
     * @return {module:model/BlobContainerProperties} The populated <code>BlobContainerProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlobContainerProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>BlobContainerProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlobContainerProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BlobContainerProperties.RequiredProperties) {
...
BlobContainerProperties.RequiredProperties = ["containerName", "resourceGroup", "storageAccountName", "subscriptionId"];

/**
 * BLOB Container name.
 * @member {String} containerName
 */
BlobContainerProperties.prototype['containerName'] = undefined;

/**
 * Unique id for identifying a data set resource
 * @member {String} dataSetId
 */
BlobContainerProperties.prototype['dataSetId'] = undefined;

/**
 * Resource group of storage account
 * @member {String} resourceGroup
 */
BlobContainerProperties.prototype['resourceGroup'] = undefined;

/**
 * Storage account name of the source data set
 * @member {String} storageAccountName
 */
BlobContainerProperties.prototype['storageAccountName'] = undefined;

/**
 * Subscription id of storage account
 * @member {String} subscriptionId
 */
BlobContainerProperties.prototype['subscriptionId'] = undefined;
...
export default BlobContainerProperties;
