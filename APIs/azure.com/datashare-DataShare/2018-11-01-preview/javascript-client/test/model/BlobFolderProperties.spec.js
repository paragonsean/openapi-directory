...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.BlobFolderProperties();
  });
  ...
  describe('BlobFolderProperties', function() {
    it('should create an instance of BlobFolderProperties', function() {
      // uncomment below and update the code to test BlobFolderProperties
      //var instance = new DataShareManagementClient.BlobFolderProperties();
      //expect(instance).to.be.a(DataShareManagementClient.BlobFolderProperties);
    });
