...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.AccountList();
  });
  ...
  describe('AccountList', function() {
    it('should create an instance of AccountList', function() {
      ...
      //var instance = new DataShareManagementClient.AccountList();
      //expect(instance).to.be.a(DataShareManagementClient.AccountList);
    });
