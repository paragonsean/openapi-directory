...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.OperationList();
  });
  ...
  describe('OperationList', function() {
    it('should create an instance of OperationList', function() {
      ...
      //var instance = new DataShareManagementClient.OperationList();
      //expect(instance).to.be.a(DataShareManagementClient.OperationList);
    });
