...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.SqlDBTableProperties();
  });
  ...
  describe('SqlDBTableProperties', function() {
    it('should create an instance of SqlDBTableProperties', function() {
      // uncomment below and update the code to test SqlDBTableProperties
      //var instance = new DataShareManagementClient.SqlDBTableProperties();
      //expect(instance).to.be.a(DataShareManagementClient.SqlDBTableProperties);
    });
