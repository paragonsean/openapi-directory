...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataShareManagementClient.AccountProperties();
  });
  ...
  describe('AccountProperties', function() {
    it('should create an instance of AccountProperties', function() {
      ...
      //var instance = new DataShareManagementClient.AccountProperties();
      //expect(instance).to.be.a(DataShareManagementClient.AccountProperties);
    });
