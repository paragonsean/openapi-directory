...
class Variable {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = VariableProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          VariableProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/VariableProperties} properties
 */
Variable.prototype['properties'] = undefined;
