...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.VariableProperties();
  });
  ...
  describe('VariableProperties', function() {
    it('should create an instance of VariableProperties', function() {
      ...
      //var instance = new AutomationManagement.VariableProperties();
      //expect(instance).to.be.a(AutomationManagement.VariableProperties);
    });
