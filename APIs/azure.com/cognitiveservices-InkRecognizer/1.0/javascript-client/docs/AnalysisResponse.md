# InkRecognizerClient.AnalysisResponse
...
**recognitionUnits** | [**[RecognitionUnitInner]**](RecognitionUnitInner.md) | The list of recognition units based on the analysis of the ink strokes. | 
