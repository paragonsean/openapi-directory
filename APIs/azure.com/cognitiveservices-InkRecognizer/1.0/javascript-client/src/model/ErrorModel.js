...
import ErrorModelDetailsInner from './ErrorModelDetailsInner';
...
class ErrorModel {
     ...
     * @param code {String} This represents the error code
     * @param message {String} This represents the error message
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('details')) {
                obj['details'] = ApiClient.convertToType(data['details'], [ErrorModelDetailsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['details']) { // data not null
            ...
            for (const item of data['details']) {
                ErrorModelDetailsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/ErrorModelDetailsInner>} details
 */
 ...
 */
ErrorModel.prototype['target'] = undefined;
