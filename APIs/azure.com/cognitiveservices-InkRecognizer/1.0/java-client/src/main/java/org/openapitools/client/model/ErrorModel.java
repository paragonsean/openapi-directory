...
public class ErrorModel {
  ...
  private List<ErrorModelDetailsInner> details = new ArrayList<>();
  ...
  public ErrorModel details(List<ErrorModelDetailsInner> details) {
    this.details = details;
    return this;
  }

  public ErrorModel addDetailsItem(ErrorModelDetailsInner detailsItem) {
  ...
  public List<ErrorModelDetailsInner> getDetails() {
    return details;
  }

  public void setDetails(List<ErrorModelDetailsInner> details) {
    this.details = details;
  }
  ...
  public ErrorModel target(String target) {
    this.target = target;
    return this;
  }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            ErrorModelDetailsInner.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
