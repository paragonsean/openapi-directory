...
import org.openapitools.client.api.VaultUsagesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    VaultUsagesApi apiInstance = new VaultUsagesApi(defaultClient);
    ...
    try {
      VaultUsageList result = apiInstance.usagesListByVaults(subscriptionId, apiVersion, resourceGroupName, vaultName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VaultUsagesApi#usagesListByVaults");
