...
#ifndef OAINameInfo_H
#define OAINameInfo_H
...
class OAINameInfo : public OAIObject {
public:
    OAINameInfo();
    OAINameInfo(QString json);
    ~OAINameInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINameInfo)
