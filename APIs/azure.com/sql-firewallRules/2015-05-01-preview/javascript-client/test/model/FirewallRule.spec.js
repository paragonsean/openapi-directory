...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.FirewallRule();
  });
  ...
  describe('FirewallRule', function() {
    it('should create an instance of FirewallRule', function() {
      ...
      //var instance = new SqlManagementClient.FirewallRule();
      //expect(instance).to.be.a(SqlManagementClient.FirewallRule);
    });
