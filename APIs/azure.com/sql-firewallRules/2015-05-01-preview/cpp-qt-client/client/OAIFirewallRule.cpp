...
OAIServerFirewallRuleProperties OAIFirewallRule::getProperties() const {
    return m_properties;
}
void OAIFirewallRule::setProperties(const OAIServerFirewallRuleProperties &properties) {
