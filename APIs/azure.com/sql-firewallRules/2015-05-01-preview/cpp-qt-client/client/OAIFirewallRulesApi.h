...
public:
    ...
    */
    virtual void firewallRulesCreateOrUpdate(const QString &resource_group_name, const QString &server_name, const QString &firewall_rule_name, const QString &subscription_id, const QString &api_version, const OAIFirewallRule &parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void firewallRulesDelete(const QString &resource_group_name, const QString &server_name, const QString &firewall_rule_name, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void firewallRulesGet(const QString &resource_group_name, const QString &server_name, const QString &firewall_rule_name, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void firewallRulesListByServer(const QString &resource_group_name, const QString &server_name, const QString &subscription_id, const QString &api_version);
    ...
    * @param[in]  subscription_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  parameters OAIFirewallRuleList [required]
    */
    virtual void firewallRulesReplace(const QString &resource_group_name, const QString &server_name, const QString &subscription_id, const QString &api_version, const OAIFirewallRuleList &parameters);
...
private:
    ...
    void firewallRulesReplaceCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void firewallRulesReplaceSignal(OAIFirewallRule summary);
    ...
    void firewallRulesReplaceSignalFull(OAIHttpRequestWorker *worker, OAIFirewallRule summary);
    ...
    Q_DECL_DEPRECATED_X("Use firewallRulesReplaceSignalError() instead")
    void firewallRulesReplaceSignalE(OAIFirewallRule summary, QNetworkReply::NetworkError error_type, QString error_str);
    void firewallRulesReplaceSignalError(OAIFirewallRule summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use firewallRulesReplaceSignalErrorFull() instead")
    void firewallRulesReplaceSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void firewallRulesReplaceSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
