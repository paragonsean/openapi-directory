...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureSqlDatabaseServerFirewallRules.FirewallRuleProperties();
  });
  ...
  describe('FirewallRuleProperties', function() {
    it('should create an instance of FirewallRuleProperties', function() {
      ...
      //var instance = new AzureSqlDatabaseServerFirewallRules.FirewallRuleProperties();
      //expect(instance).to.be.a(AzureSqlDatabaseServerFirewallRules.FirewallRuleProperties);
    });
