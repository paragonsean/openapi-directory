...
QString OAIFirewallRule::getKind() const {
    return m_kind;
}
void OAIFirewallRule::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIFirewallRule::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIFirewallRule::is_kind_Valid() const{
    return m_kind_isValid;
}

QString OAIFirewallRule::getLocation() const {
    return m_location;
}
void OAIFirewallRule::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIFirewallRule::is_location_Set() const{
    return m_location_isSet;
}

bool OAIFirewallRule::is_location_Valid() const{
