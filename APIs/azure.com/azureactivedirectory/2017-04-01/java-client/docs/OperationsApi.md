...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OperationsDiscoveryCollection result = apiInstance.operationsList(apiVersion);
...
|-------------|-------------|------------------|
| **200** | Successful request to get list of AadIam operations. |  -  |
| **0** | Error, failed to get list of AadIam operations. |  -  |
