...
public class Example {
  public static void main(String[] args) {
    ...
    VirtualHubsUpdateTagsRequest virtualHubParameters = new VirtualHubsUpdateTagsRequest(); // VirtualHubsUpdateTagsRequest | Parameters supplied to update VirtualHub tags.
    try {
...
| **virtualHubParameters** | [**VirtualHubsUpdateTagsRequest**](VirtualHubsUpdateTagsRequest.md)| Parameters supplied to update VirtualHub tags. | |
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client API version.
    VirtualHubsUpdateTagsRequest waNParameters = new VirtualHubsUpdateTagsRequest(); // VirtualHubsUpdateTagsRequest | Parameters supplied to Update VirtualWAN tags.
    try {
...
| **apiVersion** | **String**| Client API version. | |
| **waNParameters** | [**VirtualHubsUpdateTagsRequest**](VirtualHubsUpdateTagsRequest.md)| Parameters supplied to Update VirtualWAN tags. | |
