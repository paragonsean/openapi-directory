...
public class VpnConnectionProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionBandwidth, connectionStatus, egressBytesTransferred, enableBgp, ingressBytesTransferred, ipsecPolicies, provisioningState, remoteVpnSite, routingWeight, sharedKey);
  }
