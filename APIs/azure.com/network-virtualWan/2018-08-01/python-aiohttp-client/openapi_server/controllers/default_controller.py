...
async def p2s_vpn_gateways_create_or_update(request: web.Request, subscription_id, resource_group_name, gateway_name, api_version, p2_s_vpn_gateway_parameters) -> web.Response:
    ...
    :param api_version: Client API version.
    :type api_version: str
    :param p2_s_vpn_gateway_parameters: Parameters supplied to create or Update a virtual wan p2s vpn gateway.
    :type p2_s_vpn_gateway_parameters: dict | bytes

    """
    p2_s_vpn_gateway_parameters = P2SVpnGateway.from_dict(p2_s_vpn_gateway_parameters)
    return web.Response(status=200)


async def p2s_vpn_gateways_delete(request: web.Request, subscription_id, resource_group_name, gateway_name, api_version) -> web.Response:
...
async def p2s_vpn_gateways_get(request: web.Request, subscription_id, resource_group_name, gateway_name, api_version) -> web.Response:
...
async def p2s_vpn_gateways_list(request: web.Request, subscription_id, api_version) -> web.Response:
...
async def p2s_vpn_gateways_list_by_resource_group(request: web.Request, subscription_id, resource_group_name, api_version) -> web.Response:
...
async def p2s_vpn_server_configurations_create_or_update(request: web.Request, subscription_id, resource_group_name, virtual_wan_name, p2_s_vpn_server_configuration_name, api_version, p2_s_vpn_server_configuration_parameters) -> web.Response:
    ...
    :param api_version: Client API version.
    :type api_version: str
    :param p2_s_vpn_server_configuration_parameters: Parameters supplied to create or Update a P2SVpnServerConfiguration.
    :type p2_s_vpn_server_configuration_parameters: dict | bytes

    """
    p2_s_vpn_server_configuration_parameters = P2SVpnServerConfiguration.from_dict(p2_s_vpn_server_configuration_parameters)
    return web.Response(status=200)


async def p2s_vpn_server_configurations_delete(request: web.Request, subscription_id, resource_group_name, virtual_wan_name, p2_s_vpn_server_configuration_name, api_version) -> web.Response:
...
async def p2s_vpn_server_configurations_get(request: web.Request, subscription_id, resource_group_name, virtual_wan_name, p2_s_vpn_server_configuration_name, api_version) -> web.Response:
...
async def p2s_vpn_server_configurations_list_by_virtual_wan(request: web.Request, subscription_id, resource_group_name, virtual_wan_name, api_version) -> web.Response:
...
async def supported_security_providers(request: web.Request, subscription_id, resource_group_name, virtual_wan_name, api_version) -> web.Response:
    ...
    :type resource_group_name: str
    :param virtual_wan_name: The name of the VirtualWAN for which supported security providers are needed.
    :type virtual_wan_name: str
    :param api_version: Client API version.
    :type api_version: str
