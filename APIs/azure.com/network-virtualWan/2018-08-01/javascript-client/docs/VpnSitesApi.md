...
let vpnSiteParameters = new VirtualWanasAServiceManagementClient.P2sVpnGatewaysUpdateTagsRequest(); // P2sVpnGatewaysUpdateTagsRequest | Parameters supplied to update VpnSite tags.
