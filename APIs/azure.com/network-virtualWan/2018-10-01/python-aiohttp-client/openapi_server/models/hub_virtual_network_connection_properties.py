...
class HubVirtualNetworkConnectionProperties(Model):
    ...
    def __init__(self, allow_hub_to_remote_vnet_transit: bool=None, allow_remote_vnet_to_use_hub_vnet_gateways: bool=None, enable_internet_security: bool=None, provisioning_state: ProvisioningState=None, remote_virtual_network: HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork=None):
