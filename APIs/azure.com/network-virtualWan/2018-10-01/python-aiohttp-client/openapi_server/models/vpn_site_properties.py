...
class VpnSiteProperties(Model):
    ...
    def __init__(self, address_space: P2SVpnGatewayPropertiesVpnClientAddressPool=None, bgp_properties: VpnGatewayPropertiesBgpSettings=None, device_properties: DeviceProperties=None, ip_address: str=None, is_security_site: bool=None, provisioning_state: ProvisioningState=None, site_key: str=None, virtual_wan: HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork=None):
        ...
        """
        self.openapi_types = {
            'address_space': P2SVpnGatewayPropertiesVpnClientAddressPool,
    ...
    def address_space(self, address_space):
        ...
        :param address_space: The address_space of this VpnSiteProperties.
        :type address_space: P2SVpnGatewayPropertiesVpnClientAddressPool
        """
