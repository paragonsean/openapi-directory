...
public class VpnSiteProperties {
  ...
  private P2SVpnGatewayPropertiesCustomRoutes addressSpace;
  ...
  public static final String SERIALIZED_NAME_VPN_SITE_LINKS = "vpnSiteLinks";
  @SerializedName(SERIALIZED_NAME_VPN_SITE_LINKS)
  private List<VpnSiteLink> vpnSiteLinks = new ArrayList<>();
  ...
  public VpnSiteProperties addressSpace(P2SVpnGatewayPropertiesCustomRoutes addressSpace) {
  ...
  public P2SVpnGatewayPropertiesCustomRoutes getAddressSpace() {
    return addressSpace;
  }

  public void setAddressSpace(P2SVpnGatewayPropertiesCustomRoutes addressSpace) {
    this.addressSpace = addressSpace;
  }
  ...
  public VpnSiteProperties vpnSiteLinks(List<VpnSiteLink> vpnSiteLinks) {
    this.vpnSiteLinks = vpnSiteLinks;
    return this;
  }

  public VpnSiteProperties addVpnSiteLinksItem(VpnSiteLink vpnSiteLinksItem) {
    if (this.vpnSiteLinks == null) {
      this.vpnSiteLinks = new ArrayList<>();
    }
    this.vpnSiteLinks.add(vpnSiteLinksItem);
    return this;
  }
  ...
  public void setVpnSiteLinks(List<VpnSiteLink> vpnSiteLinks) {
    this.vpnSiteLinks = vpnSiteLinks;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressSpace, vpnSiteProperties.addressSpace) &&
        ...
        Objects.equals(this.vpnSiteLinks, vpnSiteProperties.vpnSiteLinks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressSpace, bgpProperties, deviceProperties, ipAddress, isSecuritySite, provisioningState, siteKey, virtualWan, vpnSiteLinks);
  }
  ...
  public String toString() {
    ...
    sb.append("    vpnSiteLinks: ").append(toIndentedString(vpnSiteLinks)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("vpnSiteLinks");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("addressSpace") != null && !jsonObj.get("addressSpace").isJsonNull()) {
        P2SVpnGatewayPropertiesCustomRoutes.validateJsonElement(jsonObj.get("addressSpace"));
      }
      ...
      if (jsonObj.get("vpnSiteLinks") != null && !jsonObj.get("vpnSiteLinks").isJsonNull()) {
        JsonArray jsonArrayvpnSiteLinks = jsonObj.getAsJsonArray("vpnSiteLinks");
        if (jsonArrayvpnSiteLinks != null) {
          // ensure the json data is an array
          if (!jsonObj.get("vpnSiteLinks").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `vpnSiteLinks` to be an array in the JSON string but got `%s`", jsonObj.get("vpnSiteLinks").toString()));
          }

          // validate the optional field `vpnSiteLinks` (array)
          for (int i = 0; i < jsonArrayvpnSiteLinks.size(); i++) {
            VpnSiteLink.validateJsonElement(jsonArrayvpnSiteLinks.get(i));
          };
        }
      }
  }
