...
public class VpnSiteLinkConnectionProperties {
  ...
  public static final String SERIALIZED_NAME_VPN_SITE_LINK = "vpnSiteLink";
  @SerializedName(SERIALIZED_NAME_VPN_SITE_LINK)
  private HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork vpnSiteLink;
  ...
  public VpnSiteLinkConnectionProperties connectionBandwidth(Integer connectionBandwidth) {
  ...
  public VpnSiteLinkConnectionProperties connectionStatus(VpnConnectionStatus connectionStatus) {
  ...
  public VpnSiteLinkConnectionProperties enableBgp(Boolean enableBgp) {
  ...
  public VpnSiteLinkConnectionProperties enableRateLimiting(Boolean enableRateLimiting) {
  ...
  public VpnSiteLinkConnectionProperties ipsecPolicies(List<P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner> ipsecPolicies) {
    this.ipsecPolicies = ipsecPolicies;
    return this;
  }

  public VpnSiteLinkConnectionProperties addIpsecPoliciesItem(P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner ipsecPoliciesItem) {
  ...
  public VpnSiteLinkConnectionProperties routingWeight(Integer routingWeight) {
  ...
  public VpnSiteLinkConnectionProperties sharedKey(String sharedKey) {
  ...
  public VpnSiteLinkConnectionProperties useLocalAzureIpAddress(Boolean useLocalAzureIpAddress) {
  ...
  public VpnSiteLinkConnectionProperties usePolicyBasedTrafficSelectors(Boolean usePolicyBasedTrafficSelectors) {
  ...
  public VpnSiteLinkConnectionProperties vpnConnectionProtocolType(VpnConnectionProtocolTypeEnum vpnConnectionProtocolType) {
  ...
  public VpnSiteLinkConnectionProperties vpnSiteLink(HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork vpnSiteLink) {
   ...
   */
  @javax.annotation.Nullable
  public HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork getVpnSiteLink() {
    return vpnSiteLink;
  }

  public void setVpnSiteLink(HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork vpnSiteLink) {
    this.vpnSiteLink = vpnSiteLink;
  }
  ...
  public boolean equals(Object o) {
    ...
    VpnSiteLinkConnectionProperties vpnSiteLinkConnectionProperties = (VpnSiteLinkConnectionProperties) o;
    return Objects.equals(this.connectionBandwidth, vpnSiteLinkConnectionProperties.connectionBandwidth) &&
        Objects.equals(this.connectionStatus, vpnSiteLinkConnectionProperties.connectionStatus) &&
        Objects.equals(this.egressBytesTransferred, vpnSiteLinkConnectionProperties.egressBytesTransferred) &&
        Objects.equals(this.enableBgp, vpnSiteLinkConnectionProperties.enableBgp) &&
        Objects.equals(this.enableRateLimiting, vpnSiteLinkConnectionProperties.enableRateLimiting) &&
        Objects.equals(this.ingressBytesTransferred, vpnSiteLinkConnectionProperties.ingressBytesTransferred) &&
        Objects.equals(this.ipsecPolicies, vpnSiteLinkConnectionProperties.ipsecPolicies) &&
        Objects.equals(this.provisioningState, vpnSiteLinkConnectionProperties.provisioningState) &&
        Objects.equals(this.routingWeight, vpnSiteLinkConnectionProperties.routingWeight) &&
        Objects.equals(this.sharedKey, vpnSiteLinkConnectionProperties.sharedKey) &&
        Objects.equals(this.useLocalAzureIpAddress, vpnSiteLinkConnectionProperties.useLocalAzureIpAddress) &&
        Objects.equals(this.usePolicyBasedTrafficSelectors, vpnSiteLinkConnectionProperties.usePolicyBasedTrafficSelectors) &&
        Objects.equals(this.vpnConnectionProtocolType, vpnSiteLinkConnectionProperties.vpnConnectionProtocolType) &&
        Objects.equals(this.vpnSiteLink, vpnSiteLinkConnectionProperties.vpnSiteLink);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectionBandwidth, connectionStatus, egressBytesTransferred, enableBgp, enableRateLimiting, ingressBytesTransferred, ipsecPolicies, provisioningState, routingWeight, sharedKey, useLocalAzureIpAddress, usePolicyBasedTrafficSelectors, vpnConnectionProtocolType, vpnSiteLink);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VpnSiteLinkConnectionProperties {\n");
    ...
    sb.append("    vpnSiteLink: ").append(toIndentedString(vpnSiteLink)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VpnSiteLinkConnectionProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VpnSiteLinkConnectionProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpnSiteLinkConnectionProperties is not found in the empty JSON string", VpnSiteLinkConnectionProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VpnSiteLinkConnectionProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VpnSiteLinkConnectionProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("vpnSiteLink") != null && !jsonObj.get("vpnSiteLink").isJsonNull()) {
        HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork.validateJsonElement(jsonObj.get("vpnSiteLink"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpnSiteLinkConnectionProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpnSiteLinkConnectionProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpnSiteLinkConnectionProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpnSiteLinkConnectionProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<VpnSiteLinkConnectionProperties>() {
           @Override
           public void write(JsonWriter out, VpnSiteLinkConnectionProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VpnSiteLinkConnectionProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VpnSiteLinkConnectionProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VpnSiteLinkConnectionProperties
   * @throws IOException if the JSON string is invalid with respect to VpnSiteLinkConnectionProperties
   */
  public static VpnSiteLinkConnectionProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpnSiteLinkConnectionProperties.class);
  }

  /**
   * Convert an instance of VpnSiteLinkConnectionProperties to an JSON string
   *
   * @return JSON string
   */
