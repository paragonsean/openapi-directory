...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      VpnGateway result = apiInstance.vpnGatewaysReset(resourceGroupName, gatewayName, apiVersion, subscriptionId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VpnGatewaysApi#vpnGatewaysReset");
