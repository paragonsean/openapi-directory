...
void OAIVpnSiteProperties::initializeModel() {
    ...
    m_vpn_site_links_isSet = false;
    m_vpn_site_links_isValid = false;
}
...
void OAIVpnSiteProperties::fromJsonObject(QJsonObject json) {
    ...
    m_vpn_site_links_isValid = ::OpenAPI::fromJsonValue(m_vpn_site_links, json[QString("vpnSiteLinks")]);
    m_vpn_site_links_isSet = !json[QString("vpnSiteLinks")].isNull() && m_vpn_site_links_isValid;
}
...
QJsonObject OAIVpnSiteProperties::asJsonObject() const {
    ...
    if (m_vpn_site_links.size() > 0) {
        obj.insert(QString("vpnSiteLinks"), ::OpenAPI::toJsonValue(m_vpn_site_links));
    }
    return obj;
}
...
QList<OAIVpnSiteLink> OAIVpnSiteProperties::getVpnSiteLinks() const {
    return m_vpn_site_links;
}
void OAIVpnSiteProperties::setVpnSiteLinks(const QList<OAIVpnSiteLink> &vpn_site_links) {
    m_vpn_site_links = vpn_site_links;
    m_vpn_site_links_isSet = true;
}

bool OAIVpnSiteProperties::is_vpn_site_links_Set() const{
    return m_vpn_site_links_isSet;
}

bool OAIVpnSiteProperties::is_vpn_site_links_Valid() const{
    return m_vpn_site_links_isValid;
}
