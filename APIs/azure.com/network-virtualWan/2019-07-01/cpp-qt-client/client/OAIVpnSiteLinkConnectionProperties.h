...
/*
 * OAIVpnSiteLinkConnectionProperties.h
 *
 * Parameters for VpnConnection.
 */

#ifndef OAIVpnSiteLinkConnectionProperties_H
#define OAIVpnSiteLinkConnectionProperties_H
...
class OAIVpnSiteLinkConnectionProperties : public OAIObject {
public:
    OAIVpnSiteLinkConnectionProperties();
    OAIVpnSiteLinkConnectionProperties(QString json);
    ~OAIVpnSiteLinkConnectionProperties() override;
    ...
    OAIHubVirtualNetworkConnectionProperties_remoteVirtualNetwork getVpnSiteLink() const;
    void setVpnSiteLink(const OAIHubVirtualNetworkConnectionProperties_remoteVirtualNetwork &vpn_site_link);
    bool is_vpn_site_link_Set() const;
    bool is_vpn_site_link_Valid() const;
...
private:
    ...
    OAIHubVirtualNetworkConnectionProperties_remoteVirtualNetwork m_vpn_site_link;
    bool m_vpn_site_link_isSet;
    bool m_vpn_site_link_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVpnSiteLinkConnectionProperties)

#endif // OAIVpnSiteLinkConnectionProperties_H
