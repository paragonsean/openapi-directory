...
async def vpn_link_connections_list_by_vpn_connection(request: web.Request, subscription_id, resource_group_name, gateway_name, connection_name, api_version) -> web.Response:
...
async def vpn_site_link_connections_get(request: web.Request, subscription_id, resource_group_name, gateway_name, connection_name, link_connection_name, api_version) -> web.Response:
...
async def vpn_site_links_get(request: web.Request, subscription_id, resource_group_name, vpn_site_name, vpn_site_link_name, api_version) -> web.Response:
    """vpn_site_links_get
...
async def vpn_site_links_list_by_vpn_site(request: web.Request, subscription_id, resource_group_name, vpn_site_name, api_version) -> web.Response:
