...
class VpnSiteProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vpnSiteLinks')) {
                obj['vpnSiteLinks'] = ApiClient.convertToType(data['vpnSiteLinks'], [VpnSiteLink]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['vpnSiteLinks']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['vpnSiteLinks'])) {
                throw new Error("Expected the field `vpnSiteLinks` to be an array in the JSON data but got " + data['vpnSiteLinks']);
            }
            // validate the optional field `vpnSiteLinks` (array)
            for (const item of data['vpnSiteLinks']) {
 ...
 * @member {Array.<module:model/VpnSiteLink>} vpnSiteLinks
 */
VpnSiteProperties.prototype['vpnSiteLinks'] = undefined;
