...
void OAIP2SVpnGatewayProperties::initializeModel() {
    ...
    m_custom_routes_isSet = false;
    m_custom_routes_isValid = false;
...
void OAIP2SVpnGatewayProperties::fromJsonObject(QJsonObject json) {
    ...
    m_custom_routes_isValid = ::OpenAPI::fromJsonValue(m_custom_routes, json[QString("customRoutes")]);
    m_custom_routes_isSet = !json[QString("customRoutes")].isNull() && m_custom_routes_isValid;
...
QJsonObject OAIP2SVpnGatewayProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_custom_routes.isSet()) {
        obj.insert(QString("customRoutes"), ::OpenAPI::toJsonValue(m_custom_routes));
    }
...
OAIP2SVpnGatewayProperties_customRoutes OAIP2SVpnGatewayProperties::getCustomRoutes() const {
    return m_custom_routes;
}
void OAIP2SVpnGatewayProperties::setCustomRoutes(const OAIP2SVpnGatewayProperties_customRoutes &custom_routes) {
    m_custom_routes = custom_routes;
    m_custom_routes_isSet = true;
}

bool OAIP2SVpnGatewayProperties::is_custom_routes_Set() const{
    return m_custom_routes_isSet;
}

bool OAIP2SVpnGatewayProperties::is_custom_routes_Valid() const{
    return m_custom_routes_isValid;
}
...
QString OAIP2SVpnGatewayProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIP2SVpnGatewayProperties::setProvisioningState(const QString &provisioning_state) {
...
OAIP2SVpnGatewayProperties_customRoutes OAIP2SVpnGatewayProperties::getVpnClientAddressPool() const {
    return m_vpn_client_address_pool;
}
void OAIP2SVpnGatewayProperties::setVpnClientAddressPool(const OAIP2SVpnGatewayProperties_customRoutes &vpn_client_address_pool) {
