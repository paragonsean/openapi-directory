...
QList<QString> OAIGetVpnSitesConfigurationRequest::getVpnSites() const {
    return m_vpn_sites;
}
void OAIGetVpnSitesConfigurationRequest::setVpnSites(const QList<QString> &vpn_sites) {
...
bool OAIGetVpnSitesConfigurationRequest::isValid() const {
    ...
    return m_output_blob_sas_url_isValid && true;
}
