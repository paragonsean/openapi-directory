...
class VpnGatewayProperties(Model):
    ...
    def __init__(self, bgp_settings: VpnGatewayPropertiesBgpSettings=None, connections: List[VpnConnection]=None, provisioning_state: str=None, virtual_hub: HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork=None, vpn_gateway_scale_unit: int=None):
