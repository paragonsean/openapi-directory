...
public class Example {
  public static void main(String[] args) {
    ...
    VirtualHubsUpdateTagsRequest vpnSiteParameters = new VirtualHubsUpdateTagsRequest(); // VirtualHubsUpdateTagsRequest | Parameters supplied to update VpnSite tags.
    try {
