...
public class VpnSiteProperties {
  ...
  private VpnSitePropertiesAddressSpace addressSpace;
  ...
  public static final String SERIALIZED_NAME_VIRTUAL_W_A_N = "virtualWAN";
  @SerializedName(SERIALIZED_NAME_VIRTUAL_W_A_N)
  private GetVpnSitesConfigurationRequestVpnSitesInner virtualWAN;

  public VpnSiteProperties() {
  }

  public VpnSiteProperties addressSpace(VpnSitePropertiesAddressSpace addressSpace) {
  ...
  public VpnSitePropertiesAddressSpace getAddressSpace() {
    return addressSpace;
  }

  public void setAddressSpace(VpnSitePropertiesAddressSpace addressSpace) {
    this.addressSpace = addressSpace;
  }
  ...
  public VpnSiteProperties virtualWAN(GetVpnSitesConfigurationRequestVpnSitesInner virtualWAN) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressSpace, bgpProperties, deviceProperties, ipAddress, provisioningState, siteKey, virtualWAN);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("addressSpace") != null && !jsonObj.get("addressSpace").isJsonNull()) {
        VpnSitePropertiesAddressSpace.validateJsonElement(jsonObj.get("addressSpace"));
      }
