...
public:
    ...
    qint32 getConnectionBandwidthInMbps() const;
    void setConnectionBandwidthInMbps(const qint32 &connection_bandwidth_in_mbps);
    bool is_connection_bandwidth_in_mbps_Set() const;
    bool is_connection_bandwidth_in_mbps_Valid() const;
...
private:
    ...
    qint32 m_connection_bandwidth_in_mbps;
    bool m_connection_bandwidth_in_mbps_isSet;
    bool m_connection_bandwidth_in_mbps_isValid;
