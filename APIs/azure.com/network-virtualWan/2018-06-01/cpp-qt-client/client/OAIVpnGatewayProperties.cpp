...
OAIPolicies OAIVpnGatewayProperties::getPolicies() const {
    return m_policies;
}
void OAIVpnGatewayProperties::setPolicies(const OAIPolicies &policies) {
    m_policies = policies;
    m_policies_isSet = true;
}

bool OAIVpnGatewayProperties::is_policies_Set() const{
    return m_policies_isSet;
}

bool OAIVpnGatewayProperties::is_policies_Valid() const{
    return m_policies_isValid;
}

OAIProvisioningState OAIVpnGatewayProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIVpnGatewayProperties::setProvisioningState(const OAIProvisioningState &provisioning_state) {
...
OAIGetVpnSitesConfigurationRequest_vpnSites_inner OAIVpnGatewayProperties::getVirtualHub() const {
    return m_virtual_hub;
}
void OAIVpnGatewayProperties::setVirtualHub(const OAIGetVpnSitesConfigurationRequest_vpnSites_inner &virtual_hub) {
