...
let virtualHubParameters = new VirtualWanasAServiceManagementClient.VirtualHubsUpdateTagsRequest(); // VirtualHubsUpdateTagsRequest | Parameters supplied to update VirtualHub tags.
...
let apiVersion = "apiVersion_example"; // String | Client API version.
let wANParameters = new VirtualWanasAServiceManagementClient.VirtualHubsUpdateTagsRequest(); // VirtualHubsUpdateTagsRequest | Parameters supplied to Update VirtualWAN tags.
