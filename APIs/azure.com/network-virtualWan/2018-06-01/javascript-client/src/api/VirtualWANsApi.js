...
export default class VirtualWANsApi {
    ...
    */
     ...
     * @param {module:model/VirtualHubsUpdateTagsRequest} virtualHubParameters Parameters supplied to update VirtualHub tags.
     ...
     * @param {String} apiVersion Client API version.
     * @param {module:model/VirtualHubsUpdateTagsRequest} wANParameters Parameters supplied to Update VirtualWAN tags.
