...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VirtualWanasAServiceManagementClient.VpnConnectionProperties();
  });
  ...
  describe('VpnConnectionProperties', function() {
    it('should create an instance of VpnConnectionProperties', function() {
      // uncomment below and update the code to test VpnConnectionProperties
      //var instance = new VirtualWanasAServiceManagementClient.VpnConnectionProperties();
      //expect(instance).to.be.a(VirtualWanasAServiceManagementClient.VpnConnectionProperties);
    });
    ...
    it('should have the property remoteVpnSite (base name: "remoteVpnSite")', function() {
      // uncomment below and update the code to test the property remoteVpnSite
      //var instance = new VirtualWanasAServiceManagementClient.VpnConnectionProperties();
      //expect(instance).to.be();
    });
