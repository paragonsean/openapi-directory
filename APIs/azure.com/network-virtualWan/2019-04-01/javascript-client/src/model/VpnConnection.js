...
class VpnConnection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = VpnConnectionProperties.constructFromObject(data['properties']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VpnConnection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VpnConnection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          VpnConnectionProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
VpnConnection.prototype['etag'] = undefined;

/**
 * The name of the resource that is unique within a resource group. This name can be used to access the resource.
 * @member {String} name
 */
VpnConnection.prototype['name'] = undefined;

/**
 * @member {module:model/VpnConnectionProperties} properties
 */
VpnConnection.prototype['properties'] = undefined;

/**
 * Resource ID.
 * @member {String} id
 */
VpnConnection.prototype['id'] = undefined;
