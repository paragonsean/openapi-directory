...
export default class P2SVpnGatewaysApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the p2sVpnGatewaysGetP2sVpnConnectionHealth operation.
     * @callback module:api/P2SVpnGatewaysApi~p2sVpnGatewaysGetP2sVpnConnectionHealthCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apiVersion Client API version.
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/P2SVpnGatewaysApi~p2sVpnGatewaysGetP2sVpnConnectionHealthCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/P2SVpnGateway}
     */
    p2sVpnGatewaysGetP2sVpnConnectionHealth(resourceGroupName, gatewayName, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling p2sVpnGatewaysGetP2sVpnConnectionHealth");
      }
      // verify the required parameter 'gatewayName' is set
      if (gatewayName === undefined || gatewayName === null) {
        throw new Error("Missing the required parameter 'gatewayName' when calling p2sVpnGatewaysGetP2sVpnConnectionHealth");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling p2sVpnGatewaysGetP2sVpnConnectionHealth");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling p2sVpnGatewaysGetP2sVpnConnectionHealth");
      }
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/p2svpnGateways/{gatewayName}/getP2sVpnConnectionHealth', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
