...
bool OAIHubVirtualNetworkConnectionProperties::isEnableInternetSecurity() const {
    return m_enable_internet_security;
}
void OAIHubVirtualNetworkConnectionProperties::setEnableInternetSecurity(const bool &enable_internet_security) {
    m_enable_internet_security = enable_internet_security;
    m_enable_internet_security_isSet = true;
}

bool OAIHubVirtualNetworkConnectionProperties::is_enable_internet_security_Set() const{
    return m_enable_internet_security_isSet;
}

bool OAIHubVirtualNetworkConnectionProperties::is_enable_internet_security_Valid() const{
    return m_enable_internet_security_isValid;
}

QString OAIHubVirtualNetworkConnectionProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIHubVirtualNetworkConnectionProperties::setProvisioningState(const QString &provisioning_state) {
...
OAIHubVirtualNetworkConnectionProperties_remoteVirtualNetwork OAIHubVirtualNetworkConnectionProperties::getRemoteVirtualNetwork() const {
    return m_remote_virtual_network;
}
void OAIHubVirtualNetworkConnectionProperties::setRemoteVirtualNetwork(const OAIHubVirtualNetworkConnectionProperties_remoteVirtualNetwork &remote_virtual_network) {
