...
OAIP2SVpnGatewayProperties_customRoutes OAIVpnSiteProperties::getAddressSpace() const {
    return m_address_space;
}
void OAIVpnSiteProperties::setAddressSpace(const OAIP2SVpnGatewayProperties_customRoutes &address_space) {
...
QString OAIVpnSiteProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIVpnSiteProperties::setProvisioningState(const QString &provisioning_state) {
