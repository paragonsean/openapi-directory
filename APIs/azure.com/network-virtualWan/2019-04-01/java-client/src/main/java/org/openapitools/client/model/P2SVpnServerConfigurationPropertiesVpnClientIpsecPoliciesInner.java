...
public class P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner {
  /**
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner() {
  }

  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner dhGroup(DhGroupEnum dhGroup) {
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner ikeEncryption(IkeEncryptionEnum ikeEncryption) {
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner ikeIntegrity(IkeIntegrityEnum ikeIntegrity) {
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner ipsecEncryption(IpsecEncryptionEnum ipsecEncryption) {
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner ipsecIntegrity(IpsecIntegrityEnum ipsecIntegrity) {
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner pfsGroup(PfsGroupEnum pfsGroup) {
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner saDataSizeKilobytes(Integer saDataSizeKilobytes) {
  ...
  public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner saLifeTimeSeconds(Integer saLifeTimeSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner = (P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner) o;
    return Objects.equals(this.dhGroup, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.dhGroup) &&
        Objects.equals(this.ikeEncryption, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.ikeEncryption) &&
        Objects.equals(this.ikeIntegrity, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.ikeIntegrity) &&
        Objects.equals(this.ipsecEncryption, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.ipsecEncryption) &&
        Objects.equals(this.ipsecIntegrity, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.ipsecIntegrity) &&
        Objects.equals(this.pfsGroup, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.pfsGroup) &&
        Objects.equals(this.saDataSizeKilobytes, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.saDataSizeKilobytes) &&
        Objects.equals(this.saLifeTimeSeconds, p2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.saLifeTimeSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner is not found in the empty JSON string", P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner>() {
           @Override
           public void write(JsonWriter out, P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner
   * @throws IOException if the JSON string is invalid with respect to P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner
   */
  public static P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner.class);
  }

  /**
   * Convert an instance of P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner to an JSON string
   *
   * @return JSON string
   */
