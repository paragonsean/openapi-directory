...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VirtualWanasAServiceManagementClient.P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner();
  });
  ...
  describe('P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner', function() {
    it('should create an instance of P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner', function() {
      // uncomment below and update the code to test P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner
      //var instance = new VirtualWanasAServiceManagementClient.P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner();
      //expect(instance).to.be.a(VirtualWanasAServiceManagementClient.P2SVpnServerConfigurationPropertiesVpnClientIpsecPoliciesInner);
    });
