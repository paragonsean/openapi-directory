# VirtualWanasAServiceManagementClient.DefaultApi
...
let apiInstance = new VirtualWanasAServiceManagementClient.DefaultApi();
...
let connectionName = "connectionName_example"; // String | The name of the vpn connection.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.hubVirtualNetworkConnectionsGet(subscriptionId, resourceGroupName, virtualHubName, connectionName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let virtualHubName = "virtualHubName_example"; // String | The name of the VirtualHub.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.hubVirtualNetworkConnectionsList(subscriptionId, resourceGroupName, virtualHubName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiVersion = "apiVersion_example"; // String | Client API version.
let p2SVpnGatewayParameters = new VirtualWanasAServiceManagementClient.P2SVpnGateway(); // P2SVpnGateway | Parameters supplied to create or Update a virtual wan p2s vpn gateway.
apiInstance.p2sVpnGatewaysCreateOrUpdate(subscriptionId, resourceGroupName, gatewayName, apiVersion, p2SVpnGatewayParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let gatewayName = "gatewayName_example"; // String | The name of the gateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.p2sVpnGatewaysDelete(subscriptionId, resourceGroupName, gatewayName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let gatewayName = "gatewayName_example"; // String | The name of the gateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.p2sVpnGatewaysGet(subscriptionId, resourceGroupName, gatewayName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.p2sVpnGatewaysList(subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the P2SVpnGateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.p2sVpnGatewaysListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let virtualWanName = "virtualWanName_example"; // String | The name of the VirtualWan.
let p2SVpnServerConfigurationName = "p2SVpnServerConfigurationName_example"; // String | The name of the P2SVpnServerConfiguration.
let apiVersion = "apiVersion_example"; // String | Client API version.
let p2SVpnServerConfigurationParameters = new VirtualWanasAServiceManagementClient.P2SVpnServerConfiguration(); // P2SVpnServerConfiguration | Parameters supplied to create or Update a P2SVpnServerConfiguration.
apiInstance.p2sVpnServerConfigurationsCreateOrUpdate(subscriptionId, resourceGroupName, virtualWanName, p2SVpnServerConfigurationName, apiVersion, p2SVpnServerConfigurationParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new VirtualWanasAServiceManagementClient.DefaultApi();
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the P2SVpnServerConfiguration.
let virtualWanName = "virtualWanName_example"; // String | The name of the VirtualWan.
let p2SVpnServerConfigurationName = "p2SVpnServerConfigurationName_example"; // String | The name of the P2SVpnServerConfiguration.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.p2sVpnServerConfigurationsDelete(subscriptionId, resourceGroupName, virtualWanName, p2SVpnServerConfigurationName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let p2SVpnServerConfigurationName = "p2SVpnServerConfigurationName_example"; // String | The name of the P2SVpnServerConfiguration.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.p2sVpnServerConfigurationsGet(subscriptionId, resourceGroupName, virtualWanName, p2SVpnServerConfigurationName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let virtualWanName = "virtualWanName_example"; // String | The name of the VirtualWan.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.p2sVpnServerConfigurationsListByVirtualWan(subscriptionId, resourceGroupName, virtualWanName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let virtualWANName = "virtualWANName_example"; // String | The name of the VirtualWAN for which supported security providers are needed.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.supportedSecurityProviders(subscriptionId, resourceGroupName, virtualWANName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let virtualHubName = "virtualHubName_example"; // String | The name of the VirtualHub.
let apiVersion = "apiVersion_example"; // String | Client API version.
let virtualHubParameters = new VirtualWanasAServiceManagementClient.VirtualHub(); // VirtualHub | Parameters supplied to create or update VirtualHub.
apiInstance.virtualHubsCreateOrUpdate(subscriptionId, resourceGroupName, virtualHubName, apiVersion, virtualHubParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let virtualHubName = "virtualHubName_example"; // String | The name of the VirtualHub.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.virtualHubsDelete(subscriptionId, resourceGroupName, virtualHubName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let virtualHubName = "virtualHubName_example"; // String | The name of the VirtualHub.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.virtualHubsGet(subscriptionId, resourceGroupName, virtualHubName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.virtualHubsList(subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VirtualHub.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.virtualHubsListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VirtualWan.
let virtualWANName = "virtualWANName_example"; // String | The name of the VirtualWAN being created or updated.
let apiVersion = "apiVersion_example"; // String | Client API version.
let wANParameters = new VirtualWanasAServiceManagementClient.VirtualWAN(); // VirtualWAN | Parameters supplied to create or update VirtualWAN.
apiInstance.virtualWansCreateOrUpdate(subscriptionId, resourceGroupName, virtualWANName, apiVersion, wANParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VirtualWan.
let virtualWANName = "virtualWANName_example"; // String | The name of the VirtualWAN being deleted.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.virtualWansDelete(subscriptionId, resourceGroupName, virtualWANName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new VirtualWanasAServiceManagementClient.DefaultApi();
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VirtualWan.
let virtualWANName = "virtualWANName_example"; // String | The name of the VirtualWAN being retrieved.
let apiVersion = "apiVersion_example"; // String | Client API version.
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
apiInstance.virtualWansGet(resourceGroupName, virtualWANName, apiVersion, subscriptionId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.virtualWansList(subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VirtualWan.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.virtualWansListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let gatewayName = "gatewayName_example"; // String | The name of the gateway.
let connectionName = "connectionName_example"; // String | The name of the connection.
let apiVersion = "apiVersion_example"; // String | Client API version.
let vpnConnectionParameters = new VirtualWanasAServiceManagementClient.VpnConnection(); // VpnConnection | Parameters supplied to create or Update a VPN Connection.
apiInstance.vpnConnectionsCreateOrUpdate(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion, vpnConnectionParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let connectionName = "connectionName_example"; // String | The name of the connection.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnConnectionsDelete(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let connectionName = "connectionName_example"; // String | The name of the vpn connection.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnConnectionsGet(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let gatewayName = "gatewayName_example"; // String | The name of the gateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnConnectionsListByVpnGateway(subscriptionId, resourceGroupName, gatewayName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let gatewayName = "gatewayName_example"; // String | The name of the gateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
let vpnGatewayParameters = new VirtualWanasAServiceManagementClient.VpnGateway(); // VpnGateway | Parameters supplied to create or Update a virtual wan vpn gateway.
apiInstance.vpnGatewaysCreateOrUpdate(subscriptionId, resourceGroupName, gatewayName, apiVersion, vpnGatewayParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let gatewayName = "gatewayName_example"; // String | The name of the gateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnGatewaysDelete(subscriptionId, resourceGroupName, gatewayName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let gatewayName = "gatewayName_example"; // String | The name of the gateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnGatewaysGet(subscriptionId, resourceGroupName, gatewayName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnGatewaysList(subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VpnGateway.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnGatewaysListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name.
let virtualWANName = "virtualWANName_example"; // String | The name of the VirtualWAN for which configuration of all vpn-sites is needed.
let apiVersion = "apiVersion_example"; // String | Client API version.
let request = new VirtualWanasAServiceManagementClient.GetVpnSitesConfigurationRequest(); // GetVpnSitesConfigurationRequest | Parameters supplied to download vpn-sites configuration.
apiInstance.vpnSitesConfigurationDownload(subscriptionId, resourceGroupName, virtualWANName, apiVersion, request, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let vpnSiteName = "vpnSiteName_example"; // String | The name of the VpnSite being created or updated.
let apiVersion = "apiVersion_example"; // String | Client API version.
let vpnSiteParameters = new VirtualWanasAServiceManagementClient.VpnSite(); // VpnSite | Parameters supplied to create or update VpnSite.
apiInstance.vpnSitesCreateOrUpdate(subscriptionId, resourceGroupName, vpnSiteName, apiVersion, vpnSiteParameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VpnSite.
let vpnSiteName = "vpnSiteName_example"; // String | The name of the VpnSite being deleted.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnSitesDelete(subscriptionId, resourceGroupName, vpnSiteName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VpnSite.
let vpnSiteName = "vpnSiteName_example"; // String | The name of the VpnSite being retrieved.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnSitesGet(subscriptionId, resourceGroupName, vpnSiteName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let subscriptionId = "subscriptionId_example"; // String | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnSitesList(subscriptionId, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let resourceGroupName = "resourceGroupName_example"; // String | The resource group name of the VpnSite.
let apiVersion = "apiVersion_example"; // String | Client API version.
apiInstance.vpnSitesListByResourceGroup(subscriptionId, resourceGroupName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
