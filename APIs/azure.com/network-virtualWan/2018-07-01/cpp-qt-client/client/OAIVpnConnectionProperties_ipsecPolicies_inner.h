...
/*
 * OAIVpnConnectionProperties_ipsecPolicies_inner.h
 *
 * An IPSec Policy configuration for a virtual network gateway connection
 */

#ifndef OAIVpnConnectionProperties_ipsecPolicies_inner_H
#define OAIVpnConnectionProperties_ipsecPolicies_inner_H
...
class OAIVpnConnectionProperties_ipsecPolicies_inner : public OAIObject {
public:
    OAIVpnConnectionProperties_ipsecPolicies_inner();
    OAIVpnConnectionProperties_ipsecPolicies_inner(QString json);
    ~OAIVpnConnectionProperties_ipsecPolicies_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpnConnectionProperties_ipsecPolicies_inner)

#endif // OAIVpnConnectionProperties_ipsecPolicies_inner_H
