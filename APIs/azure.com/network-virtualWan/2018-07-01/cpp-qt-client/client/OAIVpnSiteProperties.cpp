...
OAIVpnSiteProperties_addressSpace OAIVpnSiteProperties::getAddressSpace() const {
    return m_address_space;
}
void OAIVpnSiteProperties::setAddressSpace(const OAIVpnSiteProperties_addressSpace &address_space) {
...
OAIGetVpnSitesConfigurationRequest_vpnSites_inner OAIVpnSiteProperties::getVirtualWan() const {
    return m_virtual_wan;
}
void OAIVpnSiteProperties::setVirtualWan(const OAIGetVpnSitesConfigurationRequest_vpnSites_inner &virtual_wan) {
