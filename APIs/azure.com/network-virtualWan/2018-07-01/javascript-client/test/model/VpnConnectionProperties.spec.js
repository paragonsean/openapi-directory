...
(function(root, factory) {
  ...
  describe('VpnConnectionProperties', function() {
    ...
    it('should have the property connectionBandwidthInMbps (base name: "connectionBandwidthInMbps")', function() {
      // uncomment below and update the code to test the property connectionBandwidthInMbps
      //var instance = new VirtualWanasAServiceManagementClient.VpnConnectionProperties();
