...
class VpnConnectionProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('connectionBandwidthInMbps')) {
                obj['connectionBandwidthInMbps'] = ApiClient.convertToType(data['connectionBandwidthInMbps'], 'Number');
            }
 ...
 * @member {Number} connectionBandwidthInMbps
 */
VpnConnectionProperties.prototype['connectionBandwidthInMbps'] = undefined;
