...
| [**vpnLinkConnectionsListByVpnConnection**](DefaultApi.md#vpnLinkConnectionsListByVpnConnection) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections |  |
| [**vpnSiteLinkConnectionsGet**](DefaultApi.md#vpnSiteLinkConnectionsGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName} |  |
| [**vpnSiteLinksGet**](DefaultApi.md#vpnSiteLinksGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}/vpnSiteLinks/{vpnSiteLinkName} |  |
| [**vpnSiteLinksListByVpnSite**](DefaultApi.md#vpnSiteLinksListByVpnSite) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}/vpnSiteLinks |  |
...
<a id="vpnLinkConnectionsListByVpnConnection"></a>
# **vpnLinkConnectionsListByVpnConnection**
> ListVpnSiteLinkConnectionsResult vpnLinkConnectionsListByVpnConnection(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client API version.
    try {
      ListVpnSiteLinkConnectionsResult result = apiInstance.vpnLinkConnectionsListByVpnConnection(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#vpnLinkConnectionsListByVpnConnection");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="vpnSiteLinkConnectionsGet"></a>
# **vpnSiteLinkConnectionsGet**
> VpnSiteLinkConnection vpnSiteLinkConnectionsGet(subscriptionId, resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String gatewayName = "gatewayName_example"; // String | The name of the gateway.
    String connectionName = "connectionName_example"; // String | The name of the vpn connection.
    String linkConnectionName = "linkConnectionName_example"; // String | The name of the vpn connection.
    String apiVersion = "apiVersion_example"; // String | Client API version.
    try {
      VpnSiteLinkConnection result = apiInstance.vpnSiteLinkConnectionsGet(subscriptionId, resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#vpnSiteLinkConnectionsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="vpnSiteLinksGet"></a>
# **vpnSiteLinksGet**
> VpnSiteLink vpnSiteLinksGet(subscriptionId, resourceGroupName, vpnSiteName, vpnSiteLinkName, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String vpnSiteName = "vpnSiteName_example"; // String | The name of the VpnSite.
    String vpnSiteLinkName = "vpnSiteLinkName_example"; // String | The name of the VpnSiteLink being retrieved.
    String apiVersion = "apiVersion_example"; // String | Client API version.
    try {
      VpnSiteLink result = apiInstance.vpnSiteLinksGet(subscriptionId, resourceGroupName, vpnSiteName, vpnSiteLinkName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#vpnSiteLinksGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="vpnSiteLinksListByVpnSite"></a>
# **vpnSiteLinksListByVpnSite**
> ListVpnSiteLinksResult vpnSiteLinksListByVpnSite(subscriptionId, resourceGroupName, vpnSiteName, apiVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "apiVersion_example"; // String | Client API version.
    try {
      ListVpnSiteLinksResult result = apiInstance.vpnSiteLinksListByVpnSite(subscriptionId, resourceGroupName, vpnSiteName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#vpnSiteLinksListByVpnSite");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
