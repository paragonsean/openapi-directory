...
public class DefaultApi {
    ...
    /**
     * Build call for vpnLinkConnectionsListByVpnConnection
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The resource group name of the VpnGateway. (required)
     * @param gatewayName The name of the gateway. (required)
     * @param connectionName The name of the vpn connection. (required)
     ...
     */
    public okhttp3.Call vpnLinkConnectionsListByVpnConnectionCall(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "gatewayName" + "}", localVarApiClient.escapeString(gatewayName.toString()))
            .replace("{" + "connectionName" + "}", localVarApiClient.escapeString(connectionName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call vpnLinkConnectionsListByVpnConnectionValidateBeforeCall(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling vpnLinkConnectionsListByVpnConnection(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling vpnLinkConnectionsListByVpnConnection(Async)");
        }

        // verify the required parameter 'gatewayName' is set
        if (gatewayName == null) {
            throw new ApiException("Missing the required parameter 'gatewayName' when calling vpnLinkConnectionsListByVpnConnection(Async)");
        }

        // verify the required parameter 'connectionName' is set
        if (connectionName == null) {
            throw new ApiException("Missing the required parameter 'connectionName' when calling vpnLinkConnectionsListByVpnConnection(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling vpnLinkConnectionsListByVpnConnection(Async)");
        }

        return vpnLinkConnectionsListByVpnConnectionCall(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion, _callback);
     ...
     */
    public ListVpnSiteLinkConnectionsResult vpnLinkConnectionsListByVpnConnection(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String apiVersion) throws ApiException {
        ApiResponse<ListVpnSiteLinkConnectionsResult> localVarResp = vpnLinkConnectionsListByVpnConnectionWithHttpInfo(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param connectionName The name of the vpn connection. (required)
     * @param apiVersion Client API version. (required)
     * @return ApiResponse&lt;ListVpnSiteLinkConnectionsResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListVpnSiteLinkConnectionsResult> vpnLinkConnectionsListByVpnConnectionWithHttpInfo(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = vpnLinkConnectionsListByVpnConnectionValidateBeforeCall(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion, null);
        Type localVarReturnType = new TypeToken<ListVpnSiteLinkConnectionsResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call vpnLinkConnectionsListByVpnConnectionAsync(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String apiVersion, final ApiCallback<ListVpnSiteLinkConnectionsResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = vpnLinkConnectionsListByVpnConnectionValidateBeforeCall(subscriptionId, resourceGroupName, gatewayName, connectionName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<ListVpnSiteLinkConnectionsResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for vpnSiteLinkConnectionsGet
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The resource group name of the VpnGateway. (required)
     * @param gatewayName The name of the gateway. (required)
     * @param connectionName The name of the vpn connection. (required)
     * @param linkConnectionName The name of the vpn connection. (required)
     * @param apiVersion Client API version. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call vpnSiteLinkConnectionsGetCall(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String linkConnectionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "gatewayName" + "}", localVarApiClient.escapeString(gatewayName.toString()))
            .replace("{" + "connectionName" + "}", localVarApiClient.escapeString(connectionName.toString()))
            .replace("{" + "linkConnectionName" + "}", localVarApiClient.escapeString(linkConnectionName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call vpnSiteLinkConnectionsGetValidateBeforeCall(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String linkConnectionName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling vpnSiteLinkConnectionsGet(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling vpnSiteLinkConnectionsGet(Async)");
        }

        // verify the required parameter 'gatewayName' is set
        if (gatewayName == null) {
            throw new ApiException("Missing the required parameter 'gatewayName' when calling vpnSiteLinkConnectionsGet(Async)");
        }

        // verify the required parameter 'connectionName' is set
        if (connectionName == null) {
            throw new ApiException("Missing the required parameter 'connectionName' when calling vpnSiteLinkConnectionsGet(Async)");
        }

        // verify the required parameter 'linkConnectionName' is set
        if (linkConnectionName == null) {
            throw new ApiException("Missing the required parameter 'linkConnectionName' when calling vpnSiteLinkConnectionsGet(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling vpnSiteLinkConnectionsGet(Async)");
        }

        return vpnSiteLinkConnectionsGetCall(subscriptionId, resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, _callback);
     ...
     */
    public VpnSiteLinkConnection vpnSiteLinkConnectionsGet(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String linkConnectionName, String apiVersion) throws ApiException {
        ApiResponse<VpnSiteLinkConnection> localVarResp = vpnSiteLinkConnectionsGetWithHttpInfo(subscriptionId, resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param linkConnectionName The name of the vpn connection. (required)
     * @param apiVersion Client API version. (required)
     * @return ApiResponse&lt;VpnSiteLinkConnection&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VpnSiteLinkConnection> vpnSiteLinkConnectionsGetWithHttpInfo(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String linkConnectionName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = vpnSiteLinkConnectionsGetValidateBeforeCall(subscriptionId, resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, null);
        Type localVarReturnType = new TypeToken<VpnSiteLinkConnection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call vpnSiteLinkConnectionsGetAsync(String subscriptionId, String resourceGroupName, String gatewayName, String connectionName, String linkConnectionName, String apiVersion, final ApiCallback<VpnSiteLinkConnection> _callback) throws ApiException {

        okhttp3.Call localVarCall = vpnSiteLinkConnectionsGetValidateBeforeCall(subscriptionId, resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<VpnSiteLinkConnection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for vpnSiteLinksGet
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The resource group name of the VpnSite. (required)
     * @param vpnSiteName The name of the VpnSite. (required)
     * @param vpnSiteLinkName The name of the VpnSiteLink being retrieved. (required)
     * @param apiVersion Client API version. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Request successful. Returns the details of the VpnSiteLink retrieved. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call vpnSiteLinksGetCall(String subscriptionId, String resourceGroupName, String vpnSiteName, String vpnSiteLinkName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}/vpnSiteLinks/{vpnSiteLinkName}"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "vpnSiteName" + "}", localVarApiClient.escapeString(vpnSiteName.toString()))
            .replace("{" + "vpnSiteLinkName" + "}", localVarApiClient.escapeString(vpnSiteLinkName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call vpnSiteLinksGetValidateBeforeCall(String subscriptionId, String resourceGroupName, String vpnSiteName, String vpnSiteLinkName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling vpnSiteLinksGet(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling vpnSiteLinksGet(Async)");
        }

        // verify the required parameter 'vpnSiteName' is set
        if (vpnSiteName == null) {
            throw new ApiException("Missing the required parameter 'vpnSiteName' when calling vpnSiteLinksGet(Async)");
        }

        // verify the required parameter 'vpnSiteLinkName' is set
        if (vpnSiteLinkName == null) {
            throw new ApiException("Missing the required parameter 'vpnSiteLinkName' when calling vpnSiteLinksGet(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling vpnSiteLinksGet(Async)");
        }

        return vpnSiteLinksGetCall(subscriptionId, resourceGroupName, vpnSiteName, vpnSiteLinkName, apiVersion, _callback);
     ...
     */
    public VpnSiteLink vpnSiteLinksGet(String subscriptionId, String resourceGroupName, String vpnSiteName, String vpnSiteLinkName, String apiVersion) throws ApiException {
        ApiResponse<VpnSiteLink> localVarResp = vpnSiteLinksGetWithHttpInfo(subscriptionId, resourceGroupName, vpnSiteName, vpnSiteLinkName, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param vpnSiteLinkName The name of the VpnSiteLink being retrieved. (required)
     * @param apiVersion Client API version. (required)
     * @return ApiResponse&lt;VpnSiteLink&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VpnSiteLink> vpnSiteLinksGetWithHttpInfo(String subscriptionId, String resourceGroupName, String vpnSiteName, String vpnSiteLinkName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = vpnSiteLinksGetValidateBeforeCall(subscriptionId, resourceGroupName, vpnSiteName, vpnSiteLinkName, apiVersion, null);
        Type localVarReturnType = new TypeToken<VpnSiteLink>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call vpnSiteLinksGetAsync(String subscriptionId, String resourceGroupName, String vpnSiteName, String vpnSiteLinkName, String apiVersion, final ApiCallback<VpnSiteLink> _callback) throws ApiException {

        okhttp3.Call localVarCall = vpnSiteLinksGetValidateBeforeCall(subscriptionId, resourceGroupName, vpnSiteName, vpnSiteLinkName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<VpnSiteLink>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for vpnSiteLinksListByVpnSite
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param resourceGroupName The resource group name of the VpnSite. (required)
     * @param vpnSiteName The name of the VpnSite. (required)
     * @param apiVersion Client API version. (required)
     ...
     */
    public okhttp3.Call vpnSiteLinksListByVpnSiteCall(String subscriptionId, String resourceGroupName, String vpnSiteName, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnSites/{vpnSiteName}/vpnSiteLinks"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "vpnSiteName" + "}", localVarApiClient.escapeString(vpnSiteName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call vpnSiteLinksListByVpnSiteValidateBeforeCall(String subscriptionId, String resourceGroupName, String vpnSiteName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling vpnSiteLinksListByVpnSite(Async)");
        }

        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling vpnSiteLinksListByVpnSite(Async)");
        }

        // verify the required parameter 'vpnSiteName' is set
        if (vpnSiteName == null) {
            throw new ApiException("Missing the required parameter 'vpnSiteName' when calling vpnSiteLinksListByVpnSite(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling vpnSiteLinksListByVpnSite(Async)");
        }

        return vpnSiteLinksListByVpnSiteCall(subscriptionId, resourceGroupName, vpnSiteName, apiVersion, _callback);
     ...
     */
    public ListVpnSiteLinksResult vpnSiteLinksListByVpnSite(String subscriptionId, String resourceGroupName, String vpnSiteName, String apiVersion) throws ApiException {
        ApiResponse<ListVpnSiteLinksResult> localVarResp = vpnSiteLinksListByVpnSiteWithHttpInfo(subscriptionId, resourceGroupName, vpnSiteName, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param vpnSiteName The name of the VpnSite. (required)
     * @param apiVersion Client API version. (required)
     * @return ApiResponse&lt;ListVpnSiteLinksResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListVpnSiteLinksResult> vpnSiteLinksListByVpnSiteWithHttpInfo(String subscriptionId, String resourceGroupName, String vpnSiteName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = vpnSiteLinksListByVpnSiteValidateBeforeCall(subscriptionId, resourceGroupName, vpnSiteName, apiVersion, null);
        Type localVarReturnType = new TypeToken<ListVpnSiteLinksResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call vpnSiteLinksListByVpnSiteAsync(String subscriptionId, String resourceGroupName, String vpnSiteName, String apiVersion, final ApiCallback<ListVpnSiteLinksResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = vpnSiteLinksListByVpnSiteValidateBeforeCall(subscriptionId, resourceGroupName, vpnSiteName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<ListVpnSiteLinksResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
