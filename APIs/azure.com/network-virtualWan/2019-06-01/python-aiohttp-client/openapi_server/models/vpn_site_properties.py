...
class VpnSiteProperties(Model):
    ...
    def __init__(self, address_space: P2SVpnGatewayPropertiesCustomRoutes=None, bgp_properties: VpnGatewayPropertiesBgpSettings=None, device_properties: DeviceProperties=None, ip_address: str=None, is_security_site: bool=None, provisioning_state: str=None, site_key: str=None, virtual_wan: HubVirtualNetworkConnectionPropertiesRemoteVirtualNetwork=None, vpn_site_links: List[VpnSiteLink]=None):
        ...
        :param vpn_site_links: The vpn_site_links of this VpnSiteProperties.
        """
        self.openapi_types = {
        ...
        self._vpn_site_links = vpn_site_links
    ...
    def vpn_site_links(self):
        """Gets the vpn_site_links of this VpnSiteProperties.

        List of all vpn site links

        :return: The vpn_site_links of this VpnSiteProperties.
        :rtype: List[VpnSiteLink]
        """
        return self._vpn_site_links

    @vpn_site_links.setter
    def vpn_site_links(self, vpn_site_links):
        """Sets the vpn_site_links of this VpnSiteProperties.

        List of all vpn site links

        :param vpn_site_links: The vpn_site_links of this VpnSiteProperties.
        :type vpn_site_links: List[VpnSiteLink]
        """
