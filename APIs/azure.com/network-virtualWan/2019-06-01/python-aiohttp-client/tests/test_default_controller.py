...
from openapi_server.models.list_vpn_site_link_connections_result import ListVpnSiteLinkConnectionsResult
from openapi_server.models.list_vpn_site_links_result import ListVpnSiteLinksResult
...
from openapi_server.models.vpn_site_link import VpnSiteLink
...
async def test_vpn_connections_create_or_update(client):
    ...
    """
    vpn_connection_parameters = {"name":"name","etag":"etag","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":5,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":1,"enableInternetSecurity":True,"connectionStatus":"Unknown","remoteVpnSite":{"id":"id"},"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":5,"vpnLinkConnections":[{"name":"name","etag":"etag","type":"type","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":3,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":7,"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":9,"vpnSiteLink":{"id":"id"}}},{"name":"name","etag":"etag","type":"type","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":3,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":7,"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":9,"vpnSiteLink":{"id":"id"}}}]}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_vpn_gateways_create_or_update(client):
    ...
    """
    vpn_gateway_parameters = {"etag":"etag","properties":{"bgpSettings":{"bgpPeeringAddress":"bgpPeeringAddress","asn":0,"peerWeight":6},"vpnGatewayScaleUnit":4,"provisioningState":"Succeeded","connections":[{"name":"name","etag":"etag","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":5,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":1,"enableInternetSecurity":True,"connectionStatus":"Unknown","remoteVpnSite":{"id":"id"},"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":5,"vpnLinkConnections":[{"name":"name","etag":"etag","type":"type","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":3,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":7,"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":9,"vpnSiteLink":{"id":"id"}}},{"name":"name","etag":"etag","type":"type","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":3,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":7,"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":9,"vpnSiteLink":{"id":"id"}}}]}},{"name":"name","etag":"etag","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":5,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":1,"enableInternetSecurity":True,"connectionStatus":"Unknown","remoteVpnSite":{"id":"id"},"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":5,"vpnLinkConnections":[{"name":"name","etag":"etag","type":"type","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":3,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":7,"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":9,"vpnSiteLink":{"id":"id"}}},{"name":"name","etag":"etag","type":"type","properties":{"sharedKey":"sharedKey","vpnConnectionProtocolType":"IKEv2","ingressBytesTransferred":3,"enableRateLimiting":True,"useLocalAzureIpAddress":True,"routingWeight":2,"provisioningState":"Succeeded","ipsecPolicies":[{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"},{"ikeIntegrity":"MD5","ikeEncryption":"DES","ipsecIntegrity":"MD5","pfsGroup":"None","saDataSizeKilobytes":0,"saLifeTimeSeconds":6,"dhGroup":"None","ipsecEncryption":"None"}],"enableBgp":True,"connectionBandwidth":7,"usePolicyBasedTrafficSelectors":True,"egressBytesTransferred":9,"vpnSiteLink":{"id":"id"}}}]}}],"virtualHub":{"id":"id"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
async def test_vpn_link_connections_list_by_vpn_connection(client):
    """Test case for vpn_link_connections_list_by_vpn_connection
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/vpnGateways/{gateway_name}/vpnConnections/{connection_name}/vpnLinkConnections'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', gateway_name='gateway_name_example', connection_name='connection_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_vpn_site_link_connections_get(client):
    """Test case for vpn_site_link_connections_get
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/vpnGateways/{gateway_name}/vpnConnections/{connection_name}/vpnLinkConnections/{link_connection_name}'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', gateway_name='gateway_name_example', connection_name='connection_name_example', link_connection_name='link_connection_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_vpn_site_links_get(client):
    """Test case for vpn_site_links_get
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/vpnSites/{vpn_site_name}/vpnSiteLinks/{vpn_site_link_name}'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', vpn_site_name='vpn_site_name_example', vpn_site_link_name='vpn_site_link_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_vpn_site_links_list_by_vpn_site(client):
    """Test case for vpn_site_links_list_by_vpn_site
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/vpnSites/{vpn_site_name}/vpnSiteLinks'.format(subscription_id='subscription_id_example', resource_group_name='resource_group_name_example', vpn_site_name='vpn_site_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_vpn_sites_create_or_update(client):
    ...
    """
    vpn_site_parameters = {"etag":"etag","properties":{"bgpProperties":{"bgpPeeringAddress":"bgpPeeringAddress","asn":0,"peerWeight":6},"siteKey":"siteKey","addressSpace":{"addressPrefixes":["addressPrefixes","addressPrefixes"]},"deviceProperties":{"deviceVendor":"deviceVendor","deviceModel":"deviceModel","linkSpeedInMbps":0},"ipAddress":"ipAddress","vpnSiteLinks":[{"name":"name","etag":"etag","type":"type","properties":{"bgpProperties":{"bgpPeeringAddress":"bgpPeeringAddress","asn":6},"linkProperties":{"linkProviderName":"linkProviderName","linkSpeedInMbps":1},"ipAddress":"ipAddress","provisioningState":"Succeeded"}},{"name":"name","etag":"etag","type":"type","properties":{"bgpProperties":{"bgpPeeringAddress":"bgpPeeringAddress","asn":6},"linkProperties":{"linkProviderName":"linkProviderName","linkSpeedInMbps":1},"ipAddress":"ipAddress","provisioningState":"Succeeded"}}],"isSecuritySite":True,"provisioningState":"Succeeded","virtualWan":{"id":"id"}}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
