...
class VpnGateway {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = VpnGatewayProperties.constructFromObject(data['properties']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VpnGateway</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VpnGateway</code>.
     */
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          VpnGatewayProperties.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
VpnGateway.prototype['etag'] = undefined;

/**
 * @member {module:model/VpnGatewayProperties} properties
 */
VpnGateway.prototype['properties'] = undefined;

/**
 * Resource ID.
 * @member {String} id
 */
VpnGateway.prototype['id'] = undefined;

/**
 * Resource location.
 * @member {String} location
 */
VpnGateway.prototype['location'] = undefined;

/**
 * Resource name.
 * @member {String} name
 */
VpnGateway.prototype['name'] = undefined;
