...
public:
    ...
    OAIP2SVpnGatewayProperties_customRoutes getAddressSpace() const;
    void setAddressSpace(const OAIP2SVpnGatewayProperties_customRoutes &address_space);
    ...
    QList<OAIVpnSiteLink> getVpnSiteLinks() const;
    void setVpnSiteLinks(const QList<OAIVpnSiteLink> &vpn_site_links);
    bool is_vpn_site_links_Set() const;
    bool is_vpn_site_links_Valid() const;
...
private:
    ...
    OAIP2SVpnGatewayProperties_customRoutes m_address_space;
    ...
    QList<OAIVpnSiteLink> m_vpn_site_links;
    bool m_vpn_site_links_isSet;
    bool m_vpn_site_links_isValid;
};
