...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizationManagementClient.RoleAssignmentProperties();
  });
  ...
  describe('RoleAssignmentProperties', function() {
    it('should create an instance of RoleAssignmentProperties', function() {
      // uncomment below and update the code to test RoleAssignmentProperties
      //var instance = new AuthorizationManagementClient.RoleAssignmentProperties();
      //expect(instance).to.be.a(AuthorizationManagementClient.RoleAssignmentProperties);
    });
