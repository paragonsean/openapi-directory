...
QList<OAIConnectionStateSnapshot_hops_inner> OAIConnectionStateSnapshot::getHops() const {
    return m_hops;
}
void OAIConnectionStateSnapshot::setHops(const QList<OAIConnectionStateSnapshot_hops_inner> &hops) {
    m_hops = hops;
    m_hops_isSet = true;
}
