...
#include "OAIConnectionMonitors_UpdateTags_request.h"
#include <QString>
...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAIConnectionMonitors_UpdateTags_request [required]
    */
    virtual void connectionMonitorsUpdateTags(const QString &resource_group_name, const QString &network_watcher_name, const QString &connection_monitor_name, const QString &api_version, const QString &subscription_id, const OAIConnectionMonitors_UpdateTags_request &parameters);
