...
export default class ConnectionMonitorsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the connectionMonitorsUpdateTags operation.
     * @callback module:api/ConnectionMonitorsApi~connectionMonitorsUpdateTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConnectionMonitorResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client API version.
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/ConnectionMonitorsUpdateTagsRequest} parameters Parameters supplied to update connection monitor tags.
     * @param {module:api/ConnectionMonitorsApi~connectionMonitorsUpdateTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConnectionMonitorResult}
     */
    connectionMonitorsUpdateTags(resourceGroupName, networkWatcherName, connectionMonitorName, apiVersion, subscriptionId, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling connectionMonitorsUpdateTags");
      }
      // verify the required parameter 'networkWatcherName' is set
      if (networkWatcherName === undefined || networkWatcherName === null) {
        throw new Error("Missing the required parameter 'networkWatcherName' when calling connectionMonitorsUpdateTags");
      }
      // verify the required parameter 'connectionMonitorName' is set
      if (connectionMonitorName === undefined || connectionMonitorName === null) {
        throw new Error("Missing the required parameter 'connectionMonitorName' when calling connectionMonitorsUpdateTags");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling connectionMonitorsUpdateTags");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling connectionMonitorsUpdateTags");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling connectionMonitorsUpdateTags");
      }
      ...
      let returnType = ConnectionMonitorResult;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/connectionMonitors/{connectionMonitorName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
