...
import org.openapitools.client.model.ConnectionMonitorsUpdateTagsRequest;
...
public class ConnectionMonitorsApi {
    ...
    /**
     * Build call for connectionMonitorsUpdateTags
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Request successful. The operation returns updated connection monitor. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response describing why the operation failed. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call connectionMonitorsUpdateTagsCall(String resourceGroupName, String networkWatcherName, String connectionMonitorName, String apiVersion, String subscriptionId, ConnectionMonitorsUpdateTagsRequest parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call connectionMonitorsUpdateTagsValidateBeforeCall(String resourceGroupName, String networkWatcherName, String connectionMonitorName, String apiVersion, String subscriptionId, ConnectionMonitorsUpdateTagsRequest parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling connectionMonitorsUpdateTags(Async)");
        }

        // verify the required parameter 'networkWatcherName' is set
        if (networkWatcherName == null) {
            throw new ApiException("Missing the required parameter 'networkWatcherName' when calling connectionMonitorsUpdateTags(Async)");
        }

        // verify the required parameter 'connectionMonitorName' is set
        if (connectionMonitorName == null) {
            throw new ApiException("Missing the required parameter 'connectionMonitorName' when calling connectionMonitorsUpdateTags(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling connectionMonitorsUpdateTags(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling connectionMonitorsUpdateTags(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling connectionMonitorsUpdateTags(Async)");
        }

        return connectionMonitorsUpdateTagsCall(resourceGroupName, networkWatcherName, connectionMonitorName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public ConnectionMonitorResult connectionMonitorsUpdateTags(String resourceGroupName, String networkWatcherName, String connectionMonitorName, String apiVersion, String subscriptionId, ConnectionMonitorsUpdateTagsRequest parameters) throws ApiException {
        ApiResponse<ConnectionMonitorResult> localVarResp = connectionMonitorsUpdateTagsWithHttpInfo(resourceGroupName, networkWatcherName, connectionMonitorName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ConnectionMonitorResult> connectionMonitorsUpdateTagsWithHttpInfo(String resourceGroupName, String networkWatcherName, String connectionMonitorName, String apiVersion, String subscriptionId, ConnectionMonitorsUpdateTagsRequest parameters) throws ApiException {
        okhttp3.Call localVarCall = connectionMonitorsUpdateTagsValidateBeforeCall(resourceGroupName, networkWatcherName, connectionMonitorName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<ConnectionMonitorResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call connectionMonitorsUpdateTagsAsync(String resourceGroupName, String networkWatcherName, String connectionMonitorName, String apiVersion, String subscriptionId, ConnectionMonitorsUpdateTagsRequest parameters, final ApiCallback<ConnectionMonitorResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = connectionMonitorsUpdateTagsValidateBeforeCall(resourceGroupName, networkWatcherName, connectionMonitorName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<ConnectionMonitorResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
