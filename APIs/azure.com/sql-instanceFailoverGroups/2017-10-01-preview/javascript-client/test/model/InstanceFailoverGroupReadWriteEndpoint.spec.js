...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SqlManagementClient.InstanceFailoverGroupReadWriteEndpoint();
  });
  ...
  describe('InstanceFailoverGroupReadWriteEndpoint', function() {
    it('should create an instance of InstanceFailoverGroupReadWriteEndpoint', function() {
      // uncomment below and update the code to test InstanceFailoverGroupReadWriteEndpoint
      //var instance = new SqlManagementClient.InstanceFailoverGroupReadWriteEndpoint();
      //expect(instance).to.be.a(SqlManagementClient.InstanceFailoverGroupReadWriteEndpoint);
    });
