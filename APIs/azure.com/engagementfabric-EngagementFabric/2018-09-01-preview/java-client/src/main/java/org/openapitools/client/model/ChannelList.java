...
public class ChannelList {
  ...
  private List<Channel> value = new ArrayList<>();

  public ChannelList() {
  }

  public ChannelList value(List<Channel> value) {
    this.value = value;
    return this;
  }

  public ChannelList addValueItem(Channel valueItem) {
    if (this.value == null) {
  ...
  public List<Channel> getValue() {
    return value;
  }

  public void setValue(List<Channel> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, channelList.value);
  }
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ...
        if (jsonArrayvalue != null) {
          ...
          for (int i = 0; i < jsonArrayvalue.size(); i++) {
            Channel.validateJsonElement(jsonArrayvalue.get(i));
          };
        }
      }
  }
