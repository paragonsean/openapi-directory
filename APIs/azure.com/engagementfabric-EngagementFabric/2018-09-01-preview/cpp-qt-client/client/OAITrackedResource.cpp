...
OAISKU OAITrackedResource::getSku() const {
    return m_sku;
}
void OAITrackedResource::setSku(const OAISKU &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAITrackedResource::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAITrackedResource::is_sku_Valid() const{
