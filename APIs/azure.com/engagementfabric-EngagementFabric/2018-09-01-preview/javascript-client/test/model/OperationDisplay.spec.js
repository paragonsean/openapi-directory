...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EngagementFabric.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new EngagementFabric.OperationDisplay();
      //expect(instance).to.be.a(EngagementFabric.OperationDisplay);
    });
