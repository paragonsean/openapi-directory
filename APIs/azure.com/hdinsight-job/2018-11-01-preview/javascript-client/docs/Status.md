# HdInsightJobManagementClient.Status

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**cleanupProgress** | **Number** | The progress made on the cleanup. | [optional] 
**failureInfo** | **String** | The information about any failures that have occurred. | [optional] 
**finishTime** | **Number** | The time at which the job completed. It is an integer in milliseconds, as a Unix timestamp relative to 1/1/1970 00:00:00. | [optional] 
...
**mapProgress** | **Number** | The progress made on the maps. | [optional] 
**neededMem** | **Number** | The amount of memory needed for the job. | [optional] 
**numReservedSlots** | **Number** | The number of slots reserved. | [optional] 
**numUsedSlots** | **Number** | The number of slots used for the job. | [optional] 
**priority** | **String** | The priority of the job. | [optional] 
**queue** | **String** | The job queue name. | [optional] 
**reduceProgress** | **Number** | The progress made on the reduces. | [optional] 
**reservedMem** | **Number** | The amount of memory reserved for the job. | [optional] 
**retired** | **Boolean** | Whether or not the job has been retired.  | [optional] 
**runState** | **Number** | The current state of the job. | [optional] 
**schedulingInfo** | **String** | The information about the scheduling of the job. | [optional] 
**setupProgress** | **Number** | The progress made on the setup. | [optional] 
**startTime** | **Number** | The time at which the job started. It is an integer in milliseconds, as a Unix timestamp relative to 1/1/1970 00:00:00. | [optional] 
...
**usedMem** | **Number** | The amount of memory used by the job. | [optional] 
