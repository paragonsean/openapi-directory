...
void OAIIssueApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("issueGet", defaultConf);
    _serverIndices.insert("issueGet", 0);
...
void OAIIssueApi::issueGet(const QString &resource_group_name, const QString &service_name, const QString &issue_id, const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["issueGet"][_serverIndices.value("issueGet")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/issues/{issueId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIssueApi::issueGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIssueApi::issueGetCallback);
    connect(this, &OAIIssueApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIIssueApi::issueGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIIssue_Get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT issueGetSignal(output);
        Q_EMIT issueGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT issueGetSignalE(output, error_type, error_str);
        Q_EMIT issueGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT issueGetSignalError(output, error_type, error_str);
        Q_EMIT issueGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIssueApi::issueListByService(const QString &resource_group_name, const QString &service_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &top, const ::OpenAPI::OptionalParam<qint32> &skip) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIssueApi::issueListByServiceCallback);
    connect(this, &OAIIssueApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIssueApi::issueListByServiceCallback);
    connect(this, &OAIIssueApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIssueApi::issueListByServiceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
