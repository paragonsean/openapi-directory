# PostgreSqlManagementClient.ConfigurationsApi
...
let apiInstance = new PostgreSqlManagementClient.ConfigurationsApi();
...
let parameters = new PostgreSqlManagementClient.Configuration(); // Configuration | The required parameters for updating a server configuration.
