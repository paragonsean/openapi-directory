# PostgreSqlManagementClient.DatabasesApi
...
let apiInstance = new PostgreSqlManagementClient.DatabasesApi();
...
let parameters = new PostgreSqlManagementClient.Database(); // Database | The required parameters for creating or updating a database.
