...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new PostgreSqlManagementClient.Operation();
      //expect(instance).to.be.a(PostgreSqlManagementClient.Operation);
    });
