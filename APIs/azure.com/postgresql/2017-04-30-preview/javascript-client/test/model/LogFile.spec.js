...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.LogFile();
  });
  ...
  describe('LogFile', function() {
    it('should create an instance of LogFile', function() {
      // uncomment below and update the code to test LogFile
      //var instance = new PostgreSqlManagementClient.LogFile();
      //expect(instance).to.be.a(PostgreSqlManagementClient.LogFile);
    });
