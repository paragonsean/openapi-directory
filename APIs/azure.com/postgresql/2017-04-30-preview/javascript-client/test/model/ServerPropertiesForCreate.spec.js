...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.ServerPropertiesForCreate();
  });
  ...
  describe('ServerPropertiesForCreate', function() {
    it('should create an instance of ServerPropertiesForCreate', function() {
      ...
      //var instance = new PostgreSqlManagementClient.ServerPropertiesForCreate();
      //expect(instance).to.be.a(PostgreSqlManagementClient.ServerPropertiesForCreate);
    });
