...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.Database();
  });
  ...
  describe('Database', function() {
    it('should create an instance of Database', function() {
      ...
      //var instance = new PostgreSqlManagementClient.Database();
      //expect(instance).to.be.a(PostgreSqlManagementClient.Database);
    });
