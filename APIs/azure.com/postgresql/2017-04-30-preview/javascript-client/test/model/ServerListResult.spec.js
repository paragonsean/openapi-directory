...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.ServerListResult();
  });
  ...
  describe('ServerListResult', function() {
    it('should create an instance of ServerListResult', function() {
      // uncomment below and update the code to test ServerListResult
      //var instance = new PostgreSqlManagementClient.ServerListResult();
      //expect(instance).to.be.a(PostgreSqlManagementClient.ServerListResult);
    });
