...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.PerformanceTiersApi();
  });
  ...
  describe('PerformanceTiersApi', function() {
    describe('performanceTiersList', function() {
      it('should call performanceTiersList successfully', function(done) {
        //uncomment below and update the code to test performanceTiersList
        //instance.performanceTiersList(function(error) {
