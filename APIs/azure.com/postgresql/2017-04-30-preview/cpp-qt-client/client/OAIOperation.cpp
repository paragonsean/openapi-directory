...
OAIOperationDisplay OAIOperation::getDisplay() const {
    return m_display;
}
void OAIOperation::setDisplay(const OAIOperationDisplay &display) {
    m_display = display;
...
QMap<QString, OAIObject> OAIOperation::getProperties() const {
    return m_properties;
}
void OAIOperation::setProperties(const QMap<QString, OAIObject> &properties) {
