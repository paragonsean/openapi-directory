# PostgreSqlManagementClient.ServersApi

All URIs are relative to *https://management.azure.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**serversCreate**](ServersApi.md#serversCreate) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName} | 
[**serversDelete**](ServersApi.md#serversDelete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName} | 
[**serversGet**](ServersApi.md#serversGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName} | 
[**serversList**](ServersApi.md#serversList) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/servers | 
[**serversListByResourceGroup**](ServersApi.md#serversListByResourceGroup) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers | 
[**serversUpdate**](ServersApi.md#serversUpdate) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName} | 
...
let apiInstance = new PostgreSqlManagementClient.ServersApi();
let apiVersion = "apiVersion_example"; // String | The API version to use for the request.
let subscriptionId = "subscriptionId_example"; // String | The subscription ID that identifies an Azure subscription.
let resourceGroupName = "resourceGroupName_example"; // String | The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
let serverName = "serverName_example"; // String | The name of the server.
let parameters = new PostgreSqlManagementClient.ServerForCreate(); // ServerForCreate | The required parameters for creating or updating a server.
...
let resourceGroupName = "resourceGroupName_example"; // String | The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
let serverName = "serverName_example"; // String | The name of the server.
let parameters = new PostgreSqlManagementClient.ServerUpdateParameters(); // ServerUpdateParameters | The required parameters for updating a server.
