...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new PostgreSqlManagementClient.OperationDisplay();
      //expect(instance).to.be.a(PostgreSqlManagementClient.OperationDisplay);
    });
