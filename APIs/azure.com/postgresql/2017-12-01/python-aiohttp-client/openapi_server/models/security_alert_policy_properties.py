...
class SecurityAlertPolicyProperties(Model):
    ...
    def __init__(self, disabled_alerts: List[str]=None, email_account_admins: bool=None, email_addresses: List[str]=None, retention_days: int=None, state: str=None, storage_account_access_key: str=None, storage_endpoint: str=None):
