...
OAIStorageProfile OAIServerPropertiesForDefaultCreate::getStorageProfile() const {
    return m_storage_profile;
}
void OAIServerPropertiesForDefaultCreate::setStorageProfile(const OAIStorageProfile &storage_profile) {
    m_storage_profile = storage_profile;
    m_storage_profile_isSet = true;
}

bool OAIServerPropertiesForDefaultCreate::is_storage_profile_Set() const{
    return m_storage_profile_isSet;
}

bool OAIServerPropertiesForDefaultCreate::is_storage_profile_Valid() const{
