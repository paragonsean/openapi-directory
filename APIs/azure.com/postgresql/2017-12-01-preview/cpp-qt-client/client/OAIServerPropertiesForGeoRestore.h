...
/*
 * OAIServerPropertiesForGeoRestore.h
 *
 * The properties used to create a new server by restoring to a different region from a geo replicated backup.
 */

#ifndef OAIServerPropertiesForGeoRestore_H
#define OAIServerPropertiesForGeoRestore_H
...
class OAIServerPropertiesForGeoRestore : public OAIObject {
public:
    OAIServerPropertiesForGeoRestore();
    OAIServerPropertiesForGeoRestore(QString json);
    ~OAIServerPropertiesForGeoRestore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerPropertiesForGeoRestore)

#endif // OAIServerPropertiesForGeoRestore_H
