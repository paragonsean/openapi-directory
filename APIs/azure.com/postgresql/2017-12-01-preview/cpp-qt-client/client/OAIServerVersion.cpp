...
void OAIServerVersion::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("9.5", Qt::CaseInsensitive) == 0) {
        m_value = eOAIServerVersion::_9_5;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("9.6", Qt::CaseInsensitive) == 0) {
        m_value = eOAIServerVersion::_9_6;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("10", Qt::CaseInsensitive) == 0) {
        m_value = eOAIServerVersion::_10;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("10.0", Qt::CaseInsensitive) == 0) {
        m_value = eOAIServerVersion::_10_0;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("10.2", Qt::CaseInsensitive) == 0) {
        m_value = eOAIServerVersion::_10_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("11", Qt::CaseInsensitive) == 0) {
        m_value = eOAIServerVersion::_11;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIServerVersion::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIServerVersion::_9_5:
            val = "9.5";
            break;
        case eOAIServerVersion::_9_6:
            val = "9.6";
            break;
        case eOAIServerVersion::_10:
            val = "10";
            break;
        case eOAIServerVersion::_10_0:
            val = "10.0";
            break;
        case eOAIServerVersion::_10_2:
            val = "10.2";
            break;
        case eOAIServerVersion::_11:
            val = "11";
            break;
        default:
            break;
