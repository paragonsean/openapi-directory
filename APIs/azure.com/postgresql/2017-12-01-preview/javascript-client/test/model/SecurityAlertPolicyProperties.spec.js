...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.SecurityAlertPolicyProperties();
  });
  ...
  describe('SecurityAlertPolicyProperties', function() {
    it('should create an instance of SecurityAlertPolicyProperties', function() {
      ...
      //var instance = new PostgreSqlManagementClient.SecurityAlertPolicyProperties();
      //expect(instance).to.be.a(PostgreSqlManagementClient.SecurityAlertPolicyProperties);
    });
