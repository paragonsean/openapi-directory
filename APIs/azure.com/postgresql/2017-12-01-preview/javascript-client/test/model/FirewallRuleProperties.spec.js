...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.FirewallRuleProperties();
  });
  ...
  describe('FirewallRuleProperties', function() {
    it('should create an instance of FirewallRuleProperties', function() {
      ...
      //var instance = new PostgreSqlManagementClient.FirewallRuleProperties();
      //expect(instance).to.be.a(PostgreSqlManagementClient.FirewallRuleProperties);
    });
