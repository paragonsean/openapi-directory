...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.ResourceIdentity();
  });
  ...
  describe('ResourceIdentity', function() {
    it('should create an instance of ResourceIdentity', function() {
      ...
      //var instance = new PostgreSqlManagementClient.ResourceIdentity();
      //expect(instance).to.be.a(PostgreSqlManagementClient.ResourceIdentity);
    });
