# PostgreSqlManagementClient.VirtualNetworkRulesApi
...
let apiInstance = new PostgreSqlManagementClient.VirtualNetworkRulesApi();
...
let parameters = new PostgreSqlManagementClient.VirtualNetworkRule(); // VirtualNetworkRule | The requested virtual Network Rule Resource state.
