...
async def virtual_network_rules_create_or_update(request: web.Request, resource_group_name, server_name, subscription_id, api_version, virtual_network_rule_name, parameters) -> web.Response:
...
async def virtual_network_rules_get(request: web.Request, resource_group_name, server_name, subscription_id, api_version, virtual_network_rule_name) -> web.Response:
