...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostgreSqlManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new PostgreSqlManagementClient.Resource();
      //expect(instance).to.be.a(PostgreSqlManagementClient.Resource);
    });
