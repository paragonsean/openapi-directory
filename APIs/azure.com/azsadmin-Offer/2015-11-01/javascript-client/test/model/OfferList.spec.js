...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubscriptionClient.OfferList();
  });
  ...
  describe('OfferList', function() {
    it('should create an instance of OfferList', function() {
      // uncomment below and update the code to test OfferList
      //var instance = new SubscriptionClient.OfferList();
      //expect(instance).to.be.a(SubscriptionClient.OfferList);
    });
