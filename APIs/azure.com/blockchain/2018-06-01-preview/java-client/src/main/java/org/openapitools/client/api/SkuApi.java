...
public class SkuApi {
    ...
    public okhttp3.Call skusListCall(String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/providers/Microsoft.Blockchain/skus"
     ...
     */
    public ResourceTypeSkuCollection skusList(String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<ResourceTypeSkuCollection> localVarResp = skusListWithHttpInfo(apiVersion, subscriptionId);
     ...
     * @param apiVersion Client API Version. (required)
     * @param subscriptionId Gets the subscription Id which uniquely identifies the Microsoft Azure subscription. The subscription ID is part of the URI for every service call. (required)
     * @return ApiResponse&lt;ResourceTypeSkuCollection&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ResourceTypeSkuCollection> skusListWithHttpInfo(String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = skusListValidateBeforeCall(apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<ResourceTypeSkuCollection>(){}.getType();
     ...
     */
    public okhttp3.Call skusListAsync(String apiVersion, String subscriptionId, final ApiCallback<ResourceTypeSkuCollection> _callback) throws ApiException {
