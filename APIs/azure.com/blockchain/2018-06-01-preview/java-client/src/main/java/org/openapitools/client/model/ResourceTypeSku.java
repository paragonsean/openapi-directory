...
public class ResourceTypeSku {
  ...
  private List<SkuSetting> skus = new ArrayList<>();

  public ResourceTypeSku() {
  }

  public ResourceTypeSku resourceType(String resourceType) {
  ...
  public ResourceTypeSku skus(List<SkuSetting> skus) {
    this.skus = skus;
    return this;
  }

  public ResourceTypeSku addSkusItem(SkuSetting skusItem) {
    if (this.skus == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<SkuSetting> getSkus() {
    return skus;
  }

  public void setSkus(List<SkuSetting> skus) {
    this.skus = skus;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceType, resourceTypeSku.resourceType) &&
        Objects.equals(this.skus, resourceTypeSku.skus);
  }
      ...
      if (jsonObj.get("skus") != null && !jsonObj.get("skus").isJsonNull()) {
        ...
        if (jsonArrayskus != null) {
          ...
          for (int i = 0; i < jsonArrayskus.size(); i++) {
            SkuSetting.validateJsonElement(jsonArrayskus.get(i));
          };
        }
      }
  }
