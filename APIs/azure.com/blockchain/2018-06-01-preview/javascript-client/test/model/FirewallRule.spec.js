...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainManagementClient.FirewallRule();
  });
  ...
  describe('FirewallRule', function() {
    it('should create an instance of FirewallRule', function() {
      ...
      //var instance = new BlockchainManagementClient.FirewallRule();
      //expect(instance).to.be.a(BlockchainManagementClient.FirewallRule);
    });
