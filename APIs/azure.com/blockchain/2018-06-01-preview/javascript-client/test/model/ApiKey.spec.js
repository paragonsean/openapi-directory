...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainManagementClient.ApiKey();
  });
  ...
  describe('ApiKey', function() {
    it('should create an instance of ApiKey', function() {
      ...
      //var instance = new BlockchainManagementClient.ApiKey();
      //expect(instance).to.be.a(BlockchainManagementClient.ApiKey);
    });
