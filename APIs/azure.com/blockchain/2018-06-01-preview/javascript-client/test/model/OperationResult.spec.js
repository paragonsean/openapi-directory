...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainManagementClient.OperationResult();
  });
  ...
  describe('OperationResult', function() {
    it('should create an instance of OperationResult', function() {
      ...
      //var instance = new BlockchainManagementClient.OperationResult();
      //expect(instance).to.be.a(BlockchainManagementClient.OperationResult);
    });
