...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainManagementClient.TransactionNodeProperties();
  });
  ...
  describe('TransactionNodeProperties', function() {
    it('should create an instance of TransactionNodeProperties', function() {
      // uncomment below and update the code to test TransactionNodeProperties
      //var instance = new BlockchainManagementClient.TransactionNodeProperties();
      //expect(instance).to.be.a(BlockchainManagementClient.TransactionNodeProperties);
    });
