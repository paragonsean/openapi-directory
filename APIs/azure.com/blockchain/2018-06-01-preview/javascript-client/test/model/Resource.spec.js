...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new BlockchainManagementClient.Resource();
      //expect(instance).to.be.a(BlockchainManagementClient.Resource);
    });
