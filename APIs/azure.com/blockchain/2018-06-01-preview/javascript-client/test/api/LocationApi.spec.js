...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlockchainManagementClient.LocationApi();
  });
  ...
  describe('LocationApi', function() {
    ...
    describe('locationsListConsortiums', function() {
      it('should call locationsListConsortiums successfully', function(done) {
        //uncomment below and update the code to test locationsListConsortiums
        //instance.locationsListConsortiums(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
