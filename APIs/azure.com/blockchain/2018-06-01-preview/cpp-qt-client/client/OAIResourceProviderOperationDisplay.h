...
/*
 * OAIResourceProviderOperationDisplay.h
 *
 * Operation display payload which is exposed in the response of the resource provider.
 */

#ifndef OAIResourceProviderOperationDisplay_H
#define OAIResourceProviderOperationDisplay_H
...
class OAIResourceProviderOperationDisplay : public OAIObject {
public:
    OAIResourceProviderOperationDisplay();
    OAIResourceProviderOperationDisplay(QString json);
    ~OAIResourceProviderOperationDisplay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceProviderOperationDisplay)

#endif // OAIResourceProviderOperationDisplay_H
