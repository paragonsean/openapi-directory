...
Q_SIGNALS:
    ...
    void operationsListSignal(OAIResourceProviderOperationCollection summary);


    void operationsListSignalFull(OAIHttpRequestWorker *worker, OAIResourceProviderOperationCollection summary);

    Q_DECL_DEPRECATED_X("Use operationsListSignalError() instead")
    void operationsListSignalE(OAIResourceProviderOperationCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void operationsListSignalError(OAIResourceProviderOperationCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
