...
class AzureSqlContainer(Model):
    ...
    def __init__(self, backup_management_type: str=None, container_type: str=None, friendly_name: str=None, health_status: str=None, protectable_object_type: str=None, registration_status: str=None):
        """AzureSqlContainer - a model defined in OpenAPI

        :param backup_management_type: The backup_management_type of this AzureSqlContainer.
        :param container_type: The container_type of this AzureSqlContainer.
        :param friendly_name: The friendly_name of this AzureSqlContainer.
        :param health_status: The health_status of this AzureSqlContainer.
        :param protectable_object_type: The protectable_object_type of this AzureSqlContainer.
        :param registration_status: The registration_status of this AzureSqlContainer.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AzureSqlContainer':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AzureSqlContainer of this AzureSqlContainer.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def backup_management_type(self):
        """Gets the backup_management_type of this AzureSqlContainer.

        The backup management type for the container.

        :return: The backup_management_type of this AzureSqlContainer.
        :rtype: str
        """
    ...
    def backup_management_type(self, backup_management_type):
        """Sets the backup_management_type of this AzureSqlContainer.
    ...
    def container_type(self):
        """Gets the container_type of this AzureSqlContainer.
        ...
        :return: The container_type of this AzureSqlContainer.
        :rtype: str
        """
    ...
    def container_type(self, container_type):
        """Sets the container_type of this AzureSqlContainer.
    ...
    def friendly_name(self):
        """Gets the friendly_name of this AzureSqlContainer.

        Friendly name of the container.

        :return: The friendly_name of this AzureSqlContainer.
        :rtype: str
        """
    ...
    def friendly_name(self, friendly_name):
        """Sets the friendly_name of this AzureSqlContainer.
    ...
    def health_status(self):
        """Gets the health_status of this AzureSqlContainer.

        The status of the container's health.

        :return: The health_status of this AzureSqlContainer.
        :rtype: str
        """
    ...
    def health_status(self, health_status):
        """Sets the health_status of this AzureSqlContainer.
    ...
    def protectable_object_type(self):
        """Gets the protectable_object_type of this AzureSqlContainer.

        The protectable object type associated with the container.

        :return: The protectable_object_type of this AzureSqlContainer.
        :rtype: str
        """
    ...
    def protectable_object_type(self, protectable_object_type):
        """Sets the protectable_object_type of this AzureSqlContainer.
    ...
    def registration_status(self):
        """Gets the registration_status of this AzureSqlContainer.

        The container's registration status with the Recovery Services vault.

        :return: The registration_status of this AzureSqlContainer.
        :rtype: str
        """
    ...
    def registration_status(self, registration_status):
        """Sets the registration_status of this AzureSqlContainer.
