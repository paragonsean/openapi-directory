...
void OAIJobsApi::jobsList(const QString &api_version, const QString &vault_name, const QString &resource_group_name, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &skip_token) {
    QString fullPath = QString(_serverConfigs["jobsList"][_serverIndices.value("jobsList")].URL()+"/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupJobs");
