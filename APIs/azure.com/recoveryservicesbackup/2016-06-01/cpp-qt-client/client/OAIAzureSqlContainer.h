...
/*
 * OAIAzureSqlContainer.h
 *
 * Azure SQL workload-specific container.
 */

#ifndef OAIAzureSqlContainer_H
#define OAIAzureSqlContainer_H
...
class OAIAzureSqlContainer : public OAIObject {
public:
    OAIAzureSqlContainer();
    OAIAzureSqlContainer(QString json);
    ~OAIAzureSqlContainer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureSqlContainer)

#endif // OAIAzureSqlContainer_H
