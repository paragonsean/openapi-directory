...
QString OAIIaaSVMContainer::getProtectableObjectType() const {
    return m_protectable_object_type;
}
void OAIIaaSVMContainer::setProtectableObjectType(const QString &protectable_object_type) {
    m_protectable_object_type = protectable_object_type;
    m_protectable_object_type_isSet = true;
}

bool OAIIaaSVMContainer::is_protectable_object_type_Set() const{
    return m_protectable_object_type_isSet;
}

bool OAIIaaSVMContainer::is_protectable_object_type_Valid() const{
