...
QString OAIAzureIaaSClassicComputeVMContainer::getProtectableObjectType() const {
    return m_protectable_object_type;
}
void OAIAzureIaaSClassicComputeVMContainer::setProtectableObjectType(const QString &protectable_object_type) {
    m_protectable_object_type = protectable_object_type;
    m_protectable_object_type_isSet = true;
}

bool OAIAzureIaaSClassicComputeVMContainer::is_protectable_object_type_Set() const{
    return m_protectable_object_type_isSet;
}

bool OAIAzureIaaSClassicComputeVMContainer::is_protectable_object_type_Valid() const{
