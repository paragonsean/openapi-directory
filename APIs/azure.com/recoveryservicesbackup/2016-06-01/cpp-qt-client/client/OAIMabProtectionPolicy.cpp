...
#include "OAIMabProtectionPolicy.h"
...
OAIMabProtectionPolicy::OAIMabProtectionPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMabProtectionPolicy::OAIMabProtectionPolicy() {
    this->initializeModel();
}

OAIMabProtectionPolicy::~OAIMabProtectionPolicy() {}

void OAIMabProtectionPolicy::initializeModel() {
...
void OAIMabProtectionPolicy::fromJson(QString jsonString) {
...
void OAIMabProtectionPolicy::fromJsonObject(QJsonObject json) {
...
QString OAIMabProtectionPolicy::asJson() const {
...
QJsonObject OAIMabProtectionPolicy::asJsonObject() const {
    QJsonObject obj;
...
OAIRetentionPolicy OAIMabProtectionPolicy::getRetentionPolicy() const {
    return m_retention_policy;
}
void OAIMabProtectionPolicy::setRetentionPolicy(const OAIRetentionPolicy &retention_policy) {
    m_retention_policy = retention_policy;
    m_retention_policy_isSet = true;
}

bool OAIMabProtectionPolicy::is_retention_policy_Set() const{
    return m_retention_policy_isSet;
}

bool OAIMabProtectionPolicy::is_retention_policy_Valid() const{
    return m_retention_policy_isValid;
}

OAISchedulePolicy OAIMabProtectionPolicy::getSchedulePolicy() const {
    return m_schedule_policy;
}
void OAIMabProtectionPolicy::setSchedulePolicy(const OAISchedulePolicy &schedule_policy) {
    m_schedule_policy = schedule_policy;
    m_schedule_policy_isSet = true;
}

bool OAIMabProtectionPolicy::is_schedule_policy_Set() const{
    return m_schedule_policy_isSet;
}

bool OAIMabProtectionPolicy::is_schedule_policy_Valid() const{
    return m_schedule_policy_isValid;
}

QString OAIMabProtectionPolicy::getBackupManagementType() const {
    return m_backup_management_type;
}
void OAIMabProtectionPolicy::setBackupManagementType(const QString &backup_management_type) {
    m_backup_management_type = backup_management_type;
    m_backup_management_type_isSet = true;
}

bool OAIMabProtectionPolicy::is_backup_management_type_Set() const{
    return m_backup_management_type_isSet;
}

bool OAIMabProtectionPolicy::is_backup_management_type_Valid() const{
    return m_backup_management_type_isValid;
}

qint32 OAIMabProtectionPolicy::getProtectedItemsCount() const {
    return m_protected_items_count;
}
void OAIMabProtectionPolicy::setProtectedItemsCount(const qint32 &protected_items_count) {
    m_protected_items_count = protected_items_count;
    m_protected_items_count_isSet = true;
}

bool OAIMabProtectionPolicy::is_protected_items_count_Set() const{
    return m_protected_items_count_isSet;
}

bool OAIMabProtectionPolicy::is_protected_items_count_Valid() const{
    return m_protected_items_count_isValid;
}

bool OAIMabProtectionPolicy::isSet() const {
...
bool OAIMabProtectionPolicy::isValid() const {
