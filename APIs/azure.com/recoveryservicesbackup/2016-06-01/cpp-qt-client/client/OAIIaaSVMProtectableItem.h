...
class OAIIaaSVMProtectableItem : public OAIObject {
public:
    OAIIaaSVMProtectableItem();
    OAIIaaSVMProtectableItem(QString json);
    ~OAIIaaSVMProtectableItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIaaSVMProtectableItem)

#endif // OAIIaaSVMProtectableItem_H
