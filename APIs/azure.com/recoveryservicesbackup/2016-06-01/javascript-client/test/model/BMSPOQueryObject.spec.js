...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.BMSPOQueryObject();
  });
  ...
  describe('BMSPOQueryObject', function() {
    it('should create an instance of BMSPOQueryObject', function() {
      // uncomment below and update the code to test BMSPOQueryObject
      //var instance = new RecoveryServicesBackupClient.BMSPOQueryObject();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.BMSPOQueryObject);
    });
