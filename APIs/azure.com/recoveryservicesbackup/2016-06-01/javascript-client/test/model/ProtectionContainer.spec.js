...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecoveryServicesBackupClient.ProtectionContainer();
  });
  ...
  describe('ProtectionContainer', function() {
    it('should create an instance of ProtectionContainer', function() {
      ...
      //var instance = new RecoveryServicesBackupClient.ProtectionContainer();
      //expect(instance).to.be.a(RecoveryServicesBackupClient.ProtectionContainer);
    });
    ...
    it('should have the property protectableObjectType (base name: "protectableObjectType")', function() {
      // uncomment below and update the code to test the property protectableObjectType
      //var instance = new RecoveryServicesBackupClient.ProtectionContainer();
      //expect(instance).to.be();
    });
