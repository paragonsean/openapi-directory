...
/**
 * Identifies whether the backup copy represents an encrypted VM at the time of backup.
...
/**
 * The ID of Key Vault where the Bitlocker Encryption Key (BEK), or Secret, is stored.
