# RecoveryServicesBackupClient.OperationResultInfoBaseResource
...
**headers** | **{String: [String]}** | The HTTP headers associated with this operation. | [optional] 
**statusCode** | **String** | The HTTP status code of the operation. | [optional] 
