...
> BackupEngineBaseResourceList backupEnginesGet(apiVersion, vaultName, resourceGroupName, subscriptionId, opts)
...
apiInstance.backupEnginesGet(apiVersion, vaultName, resourceGroupName, subscriptionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
