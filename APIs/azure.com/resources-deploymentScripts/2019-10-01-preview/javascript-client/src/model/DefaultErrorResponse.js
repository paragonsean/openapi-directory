    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('details')) {
                obj['details'] = ApiClient.convertToType(data['details'], [DefaultErrorResponse]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['details']) { // data not null
            ...
            for (const item of data['details']) {
                DefaultErrorResponse.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {String} code
 */
DefaultErrorResponse.prototype['code'] = undefined;

/**
 * Detailed errors.
 * @member {Array.<module:model/DefaultErrorResponse>} details
 */
DefaultErrorResponse.prototype['details'] = undefined;

/**
 * A human-readable representation of the error.
 * @member {String} message
 */
DefaultErrorResponse.prototype['message'] = undefined;

/**
 * The target of the particular error.
 * @member {String} target
 */
DefaultErrorResponse.prototype['target'] = undefined;
