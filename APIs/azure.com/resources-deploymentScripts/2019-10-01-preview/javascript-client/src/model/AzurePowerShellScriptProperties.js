...
/**
 * The AzurePowerShellScriptProperties model module.
 * @module model/AzurePowerShellScriptProperties
 * @version 2019-10-01-preview
 */
class AzurePowerShellScriptProperties {
    /**
     * Constructs a new <code>AzurePowerShellScriptProperties</code>.
     * Properties of the Azure PowerShell script object.
     * @alias module:model/AzurePowerShellScriptProperties
    ...
    constructor(retentionInterval) { 
        ...
        AzurePowerShellScriptProperties.initialize(this, retentionInterval);
    }
    ...
    static initialize(obj, retentionInterval) { 
        obj['azPowerShellVersion'] = azPowerShellVersion;
        obj['retentionInterval'] = retentionInterval;
    }

    /**
     * Constructs a <code>AzurePowerShellScriptProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AzurePowerShellScriptProperties} obj Optional instance to populate.
     * @return {module:model/AzurePowerShellScriptProperties} The populated <code>AzurePowerShellScriptProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AzurePowerShellScriptProperties();
            DeploymentScriptPropertiesBase.constructFromObject(data, obj);
            ScriptConfigurationBase.constructFromObject(data, obj);

            if (data.hasOwnProperty('azPowerShellVersion')) {
                obj['azPowerShellVersion'] = ApiClient.convertToType(data['azPowerShellVersion'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AzurePowerShellScriptProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AzurePowerShellScriptProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AzurePowerShellScriptProperties.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['azPowerShellVersion'] && !(typeof data['azPowerShellVersion'] === 'string' || data['azPowerShellVersion'] instanceof String)) {
            throw new Error("Expected the field `azPowerShellVersion` to be a primitive type in the JSON string but got " + data['azPowerShellVersion']);
        }
        // ensure the json data is a string
...
AzurePowerShellScriptProperties.RequiredProperties = ["azPowerShellVersion", "retentionInterval"];

/**
 * Azure PowerShell module version to be used.
 * @member {String} azPowerShellVersion
 */
AzurePowerShellScriptProperties.prototype['azPowerShellVersion'] = undefined;

/**
 * The clean up preference when the script execution gets in a terminal state. Default setting is 'Always'.
 * @member {module:model/AzurePowerShellScriptProperties.CleanupPreferenceEnum} cleanupPreference
 */
AzurePowerShellScriptProperties.prototype['cleanupPreference'] = undefined;

/**
 * List of script outputs.
 * @member {Object.<String, Object>} outputs
 */
AzurePowerShellScriptProperties.prototype['outputs'] = undefined;

/**
 * State of the script execution. This only appears in the response.
 * @member {module:model/AzurePowerShellScriptProperties.ProvisioningStateEnum} provisioningState
 */
AzurePowerShellScriptProperties.prototype['provisioningState'] = undefined;

/**
 * @member {module:model/ScriptStatus} status
 */
AzurePowerShellScriptProperties.prototype['status'] = undefined;

/**
 * Command line arguments to pass to the script. Arguments are separated by spaces. ex: -Name blue* -Location 'West US 2' 
 * @member {String} arguments
 */
AzurePowerShellScriptProperties.prototype['arguments'] = undefined;

/**
 * The environment variables to pass over to the script.
 * @member {Array.<module:model/EnvironmentVariable>} environmentVariables
 */
AzurePowerShellScriptProperties.prototype['environmentVariables'] = undefined;

/**
 * Gets or sets how the deployment script should be forced to execute even if the script resource has not changed. Can be current time stamp or a GUID.
 * @member {String} forceUpdateTag
 */
AzurePowerShellScriptProperties.prototype['forceUpdateTag'] = undefined;

/**
 * Uri for the script. This is the entry point for the external script.
 * @member {String} primaryScriptUri
 */
AzurePowerShellScriptProperties.prototype['primaryScriptUri'] = undefined;
 ...
 */
AzurePowerShellScriptProperties.prototype['retentionInterval'] = undefined;

/**
 * Script body.
 * @member {String} scriptContent
 */
AzurePowerShellScriptProperties.prototype['scriptContent'] = undefined;

/**
 * Supporting files for the external script.
 * @member {Array.<String>} supportingScriptUris
 */
AzurePowerShellScriptProperties.prototype['supportingScriptUris'] = undefined;

/**
 * Maximum allowed script execution time specified in ISO 8601 format. Default value is PT1H
 * @member {String} timeout
 */
AzurePowerShellScriptProperties.prototype['timeout'] = undefined;
 ...
 * @readonly
 */
AzurePowerShellScriptProperties['CleanupPreferenceEnum'] = {
 ...
 * @readonly
 */
AzurePowerShellScriptProperties['ProvisioningStateEnum'] = {
...
export default AzurePowerShellScriptProperties;
