...
public class DefaultErrorResponse {
  ...
  private List<DefaultErrorResponse> details = new ArrayList<>();
  ...
  public DefaultErrorResponse code(String code) {
    this.code = code;
    return this;
  }
  ...
  public DefaultErrorResponse details(List<DefaultErrorResponse> details) {
    this.details = details;
    return this;
  }

  public DefaultErrorResponse addDetailsItem(DefaultErrorResponse detailsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<DefaultErrorResponse> getDetails() {
    return details;
  }

  public void setDetails(List<DefaultErrorResponse> details) {
    this.details = details;
  }


  public DefaultErrorResponse message(String message) {
  ...
  public DefaultErrorResponse target(String target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, defaultErrorResponse.code) &&
        Objects.equals(this.details, defaultErrorResponse.details) &&
        Objects.equals(this.message, defaultErrorResponse.message) &&
        Objects.equals(this.target, defaultErrorResponse.target);
  }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            DefaultErrorResponse.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
