...
/*
 * OAIAzureCliScriptProperties.h
 *
 * Properties of the Azure CLI script object.
 */

#ifndef OAIAzureCliScriptProperties_H
#define OAIAzureCliScriptProperties_H
...
class OAIAzureCliScriptProperties : public OAIObject {
public:
    OAIAzureCliScriptProperties();
    OAIAzureCliScriptProperties(QString json);
    ~OAIAzureCliScriptProperties() override;
    ...
    QString getAzCliVersion() const;
    void setAzCliVersion(const QString &az_cli_version);
    bool is_az_cli_version_Set() const;
    bool is_az_cli_version_Valid() const;
...
private:
    ...
    QString m_az_cli_version;
    bool m_az_cli_version_isSet;
    bool m_az_cli_version_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAzureCliScriptProperties)

#endif // OAIAzureCliScriptProperties_H
