...
export default class OperationsApi {
    ...
    */
     ...
     */
    operationsGet(subscriptionId, locationName, operationName, apiVersion, callback) {
      let postBody = null;
      ...
      if (operationName === undefined || operationName === null) {
        throw new Error("Missing the required parameter 'operationName' when calling operationsGet");
      }
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/providers/Microsoft.LabServices/locations/{locationName}/operations/{operationName}', 'GET',
