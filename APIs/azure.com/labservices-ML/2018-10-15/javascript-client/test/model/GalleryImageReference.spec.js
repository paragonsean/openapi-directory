...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedLabsClient.GalleryImageReference();
  });
  ...
  describe('GalleryImageReference', function() {
    it('should create an instance of GalleryImageReference', function() {
      ...
      //var instance = new ManagedLabsClient.GalleryImageReference();
      //expect(instance).to.be.a(ManagedLabsClient.GalleryImageReference);
    });
