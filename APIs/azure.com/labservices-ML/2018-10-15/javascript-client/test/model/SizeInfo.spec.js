...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedLabsClient.SizeInfo();
  });
  ...
  describe('SizeInfo', function() {
    it('should create an instance of SizeInfo', function() {
      // uncomment below and update the code to test SizeInfo
      //var instance = new ManagedLabsClient.SizeInfo();
      //expect(instance).to.be.a(ManagedLabsClient.SizeInfo);
    });
