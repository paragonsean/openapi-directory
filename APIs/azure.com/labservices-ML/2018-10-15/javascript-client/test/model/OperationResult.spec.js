...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedLabsClient.OperationResult();
  });
  ...
  describe('OperationResult', function() {
    it('should create an instance of OperationResult', function() {
      ...
      //var instance = new ManagedLabsClient.OperationResult();
      //expect(instance).to.be.a(ManagedLabsClient.OperationResult);
    });
