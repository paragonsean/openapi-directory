...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedLabsClient.LabsApi();
  });
  ...
  describe('LabsApi', function() {
    describe('labsAddUsers', function() {
      it('should call labsAddUsers successfully', function(done) {
        //uncomment below and update the code to test labsAddUsers
        //instance.labsAddUsers(function(error) {
    ...
    describe('labsList', function() {
      it('should call labsList successfully', function(done) {
        //uncomment below and update the code to test labsList
        //instance.labsList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('labsRegister', function() {
      it('should call labsRegister successfully', function(done) {
        //uncomment below and update the code to test labsRegister
        //instance.labsRegister(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
