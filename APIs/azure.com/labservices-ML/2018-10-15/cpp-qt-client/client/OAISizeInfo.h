...
#ifndef OAISizeInfo_H
#define OAISizeInfo_H
...
class OAISizeInfo : public OAIObject {
public:
    OAISizeInfo();
    OAISizeInfo(QString json);
    ~OAISizeInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISizeInfo)
