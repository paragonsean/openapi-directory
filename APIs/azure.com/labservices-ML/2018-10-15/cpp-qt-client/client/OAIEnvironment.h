...
namespace OpenAPI {
class OAIEnvironmentProperties;
...
public:
    ...
    OAIEnvironmentProperties getProperties() const;
    void setProperties(const OAIEnvironmentProperties &properties);
...
private:
    ...
    OAIEnvironmentProperties m_properties;
