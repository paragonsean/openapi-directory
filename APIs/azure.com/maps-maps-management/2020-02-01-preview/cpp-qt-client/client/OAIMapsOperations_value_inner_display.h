...
/*
 * OAIMapsOperations_value_inner_display.h
 *
 * The human-readable description of the operation.
 */

#ifndef OAIMapsOperations_value_inner_display_H
#define OAIMapsOperations_value_inner_display_H
...
class OAIMapsOperations_value_inner_display : public OAIObject {
public:
    OAIMapsOperations_value_inner_display();
    OAIMapsOperations_value_inner_display(QString json);
    ~OAIMapsOperations_value_inner_display() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapsOperations_value_inner_display)

#endif // OAIMapsOperations_value_inner_display_H
