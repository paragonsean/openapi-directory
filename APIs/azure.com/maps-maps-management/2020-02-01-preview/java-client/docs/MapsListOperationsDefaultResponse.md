...
|------------ | ------------- | ------------- | -------------|
|**additionalInfo** | [**List&lt;MapsListOperationsDefaultResponseAdditionalInfoInner&gt;**](MapsListOperationsDefaultResponseAdditionalInfoInner.md) | The error additional info. |  [optional] [readonly] |
