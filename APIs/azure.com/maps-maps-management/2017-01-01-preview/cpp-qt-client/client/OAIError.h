...
public:
    ...
    QList<OAIError_details_inner> getDetails() const;
    void setDetails(const QList<OAIError_details_inner> &details);
...
private:
    ...
    QList<OAIError_details_inner> m_details;
