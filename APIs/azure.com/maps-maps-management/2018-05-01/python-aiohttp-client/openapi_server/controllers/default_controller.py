...
async def accounts_move(request: web.Request, api_version, subscription_id, resource_group_name, move_request) -> web.Response:
    ...
    :param subscription_id: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    :type subscription_id: str
    :param resource_group_name: The name of the resource group that contains Maps Account to move.
    :type resource_group_name: str
    :param move_request: The details of the Maps Account move.
    :type move_request: dict | bytes

    """
    move_request = MapsAccountsMoveRequest.from_dict(move_request)
    return web.Response(status=200)
