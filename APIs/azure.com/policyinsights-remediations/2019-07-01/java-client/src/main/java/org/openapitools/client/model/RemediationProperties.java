...
public class RemediationProperties {
   ...
   */
  @JsonAdapter(ResourceDiscoveryModeEnum.Adapter.class)
  public enum ResourceDiscoveryModeEnum {
    ...
    ResourceDiscoveryModeEnum(String value) {
      this.value = value;
    }
    ...
    public static ResourceDiscoveryModeEnum fromValue(String value) {
      for (ResourceDiscoveryModeEnum b : ResourceDiscoveryModeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ResourceDiscoveryModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ResourceDiscoveryModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ResourceDiscoveryModeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ResourceDiscoveryModeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ResourceDiscoveryModeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_RESOURCE_DISCOVERY_MODE = "resourceDiscoveryMode";
  @SerializedName(SERIALIZED_NAME_RESOURCE_DISCOVERY_MODE)
  private ResourceDiscoveryModeEnum resourceDiscoveryMode;
  ...
  public RemediationProperties resourceDiscoveryMode(ResourceDiscoveryModeEnum resourceDiscoveryMode) {
   ...
   */
  @javax.annotation.Nullable
  public ResourceDiscoveryModeEnum getResourceDiscoveryMode() {
    return resourceDiscoveryMode;
  }

  public void setResourceDiscoveryMode(ResourceDiscoveryModeEnum resourceDiscoveryMode) {
    this.resourceDiscoveryMode = resourceDiscoveryMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdOn, remediationProperties.createdOn) &&
        ...
        Objects.equals(this.resourceDiscoveryMode, remediationProperties.resourceDiscoveryMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdOn, deploymentStatus, filters, lastUpdatedOn, policyAssignmentId, policyDefinitionReferenceId, provisioningState, resourceDiscoveryMode);
  }
  ...
  public String toString() {
    ...
    sb.append("    resourceDiscoveryMode: ").append(toIndentedString(resourceDiscoveryMode)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("resourceDiscoveryMode");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("resourceDiscoveryMode") != null && !jsonObj.get("resourceDiscoveryMode").isJsonNull()) && !jsonObj.get("resourceDiscoveryMode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `resourceDiscoveryMode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("resourceDiscoveryMode").toString()));
      }
      // validate the optional field `resourceDiscoveryMode`
      if (jsonObj.get("resourceDiscoveryMode") != null && !jsonObj.get("resourceDiscoveryMode").isJsonNull()) {
        ResourceDiscoveryModeEnum.validateJsonElement(jsonObj.get("resourceDiscoveryMode"));
      }
  }
