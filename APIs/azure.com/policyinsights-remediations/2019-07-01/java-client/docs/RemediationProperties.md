...
|**resourceDiscoveryMode** | [**ResourceDiscoveryModeEnum**](#ResourceDiscoveryModeEnum) | The way resources to remediate are discovered. Defaults to ExistingNonCompliant if not specified. |  [optional] |
