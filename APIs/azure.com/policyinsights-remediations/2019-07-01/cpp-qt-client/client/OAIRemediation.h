...
namespace OpenAPI {
class OAIRemediationProperties;
...
public:
    ...
    OAIRemediationProperties getProperties() const;
    void setProperties(const OAIRemediationProperties &properties);
...
private:
    ...
    OAIRemediationProperties m_properties;
