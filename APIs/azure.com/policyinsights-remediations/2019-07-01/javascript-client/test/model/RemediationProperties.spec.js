...
(function(root, factory) {
  ...
  describe('RemediationProperties', function() {
    ...
    it('should have the property resourceDiscoveryMode (base name: "resourceDiscoveryMode")', function() {
      // uncomment below and update the code to test the property resourceDiscoveryMode
      //var instance = new RemediationsClient.RemediationProperties();
      //expect(instance).to.be();
    });
