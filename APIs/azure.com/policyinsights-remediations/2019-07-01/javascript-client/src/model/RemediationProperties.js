...
class RemediationProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resourceDiscoveryMode')) {
                obj['resourceDiscoveryMode'] = ApiClient.convertToType(data['resourceDiscoveryMode'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['resourceDiscoveryMode'] && !(typeof data['resourceDiscoveryMode'] === 'string' || data['resourceDiscoveryMode'] instanceof String)) {
            throw new Error("Expected the field `resourceDiscoveryMode` to be a primitive type in the JSON string but got " + data['resourceDiscoveryMode']);
        }
 ...
 * @member {module:model/RemediationProperties.ResourceDiscoveryModeEnum} resourceDiscoveryMode
 */
RemediationProperties.prototype['resourceDiscoveryMode'] = undefined;
...
/**
 * Allowed values for the <code>resourceDiscoveryMode</code> property.
 * @enum {String}
 * @readonly
 */
RemediationProperties['ResourceDiscoveryModeEnum'] = {
