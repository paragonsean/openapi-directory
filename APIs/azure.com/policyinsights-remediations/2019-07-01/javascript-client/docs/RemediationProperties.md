# RemediationsClient.RemediationProperties

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**createdOn** | **Date** | The time at which the remediation was created. | [optional] [readonly] 
...
**lastUpdatedOn** | **Date** | The time at which the remediation was last updated. | [optional] [readonly] 
...
**resourceDiscoveryMode** | **String** | The way resources to remediate are discovered. Defaults to ExistingNonCompliant if not specified. | [optional] 



## Enum: ResourceDiscoveryModeEnum


* `ExistingNonCompliant` (value: `"ExistingNonCompliant"`)

* `ReEvaluateCompliance` (value: `"ReEvaluateCompliance"`)
