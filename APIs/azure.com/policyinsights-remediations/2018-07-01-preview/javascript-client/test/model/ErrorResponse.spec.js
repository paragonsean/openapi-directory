...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RemediationsClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new RemediationsClient.ErrorResponse();
      //expect(instance).to.be.a(RemediationsClient.ErrorResponse);
    });
