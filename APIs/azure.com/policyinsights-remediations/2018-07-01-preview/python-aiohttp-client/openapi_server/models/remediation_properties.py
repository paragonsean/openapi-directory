...
class RemediationProperties(Model):
    ...
    def __init__(self, created_on: datetime=None, deployment_status: RemediationDeploymentSummary=None, filters: RemediationFilters=None, last_updated_on: datetime=None, policy_assignment_id: str=None, policy_definition_reference_id: str=None, provisioning_state: str=None):
