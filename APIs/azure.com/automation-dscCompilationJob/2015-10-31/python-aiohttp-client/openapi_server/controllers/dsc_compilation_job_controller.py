...
async def dsc_compilation_job_create(request: web.Request, resource_group_name, automation_account_name, compilation_job_id, subscription_id, api_version, parameters) -> web.Response:
    ...
    :param compilation_job_id: The DSC configuration Id.
...
async def dsc_compilation_job_get(request: web.Request, resource_group_name, automation_account_name, compilation_job_id, subscription_id, api_version) -> web.Response:
