...
#include "OAIDscCompilationJobStream_ListByJob_200_response.h"
...
public:
    ...
    * @param[in]  compilation_job_id QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  api_version QString [required]
    * @param[in]  parameters OAIDscCompilationJobCreateParameters [required]
    */
    virtual void dscCompilationJobCreate(const QString &resource_group_name, const QString &automation_account_name, const QString &compilation_job_id, const QString &subscription_id, const QString &api_version, const OAIDscCompilationJobCreateParameters &parameters);
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void dscCompilationJobGet(const QString &resource_group_name, const QString &automation_account_name, const QString &compilation_job_id, const QString &subscription_id, const QString &api_version);
...
Q_SIGNALS:
    ...
    void dscCompilationJobGetStreamSignal(OAIDscCompilationJobStream_ListByJob_200_response_value_inner summary);
    void dscCompilationJobListByAutomationAccountSignal(OAIDscCompilationJobListResult summary);
    void dscCompilationJobStreamListByJobSignal(OAIDscCompilationJobStream_ListByJob_200_response summary);
    ...
    void dscCompilationJobGetStreamSignalFull(OAIHttpRequestWorker *worker, OAIDscCompilationJobStream_ListByJob_200_response_value_inner summary);
    ...
    void dscCompilationJobStreamListByJobSignalFull(OAIHttpRequestWorker *worker, OAIDscCompilationJobStream_ListByJob_200_response summary);
    ...
    void dscCompilationJobGetStreamSignalE(OAIDscCompilationJobStream_ListByJob_200_response_value_inner summary, QNetworkReply::NetworkError error_type, QString error_str);
    void dscCompilationJobGetStreamSignalError(OAIDscCompilationJobStream_ListByJob_200_response_value_inner summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void dscCompilationJobStreamListByJobSignalE(OAIDscCompilationJobStream_ListByJob_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void dscCompilationJobStreamListByJobSignalError(OAIDscCompilationJobStream_ListByJob_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
