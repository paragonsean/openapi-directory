...
public class DscCompilationJobApi {
     ...
     * @param compilationJobId The DSC configuration Id. (required)
     ...
     */
    public okhttp3.Call dscCompilationJobCreateCall(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, DscCompilationJobCreateParameters parameters, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/compilationjobs/{compilationJobId}"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "automationAccountName" + "}", localVarApiClient.escapeString(automationAccountName.toString()))
            .replace("{" + "compilationJobId" + "}", localVarApiClient.escapeString(compilationJobId.toString()))
    ...
    private okhttp3.Call dscCompilationJobCreateValidateBeforeCall(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, DscCompilationJobCreateParameters parameters, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'compilationJobId' is set
        if (compilationJobId == null) {
            throw new ApiException("Missing the required parameter 'compilationJobId' when calling dscCompilationJobCreate(Async)");
        }
        ...
        return dscCompilationJobCreateCall(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion, parameters, _callback);
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/dscconfigurationcompilejoboperations"> Documentation</a>
     */
    public DscCompilationJob dscCompilationJobCreate(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, DscCompilationJobCreateParameters parameters) throws ApiException {
        ApiResponse<DscCompilationJob> localVarResp = dscCompilationJobCreateWithHttpInfo(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion, parameters);
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/dscconfigurationcompilejoboperations"> Documentation</a>
     */
    public ApiResponse<DscCompilationJob> dscCompilationJobCreateWithHttpInfo(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, DscCompilationJobCreateParameters parameters) throws ApiException {
        okhttp3.Call localVarCall = dscCompilationJobCreateValidateBeforeCall(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion, parameters, null);
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/dscconfigurationcompilejoboperations"> Documentation</a>
     */
    public okhttp3.Call dscCompilationJobCreateAsync(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, DscCompilationJobCreateParameters parameters, final ApiCallback<DscCompilationJob> _callback) throws ApiException {

        okhttp3.Call localVarCall = dscCompilationJobCreateValidateBeforeCall(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion, parameters, _callback);
        Type localVarReturnType = new TypeToken<DscCompilationJob>(){}.getType();
     ...
     * @param resourceGroupName Name of an Azure Resource group. (required)
     * @param automationAccountName The name of the automation account. (required)
     * @param compilationJobId The Dsc configuration compilation job id. (required)
     * @param subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client Api Version. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call dscCompilationJobGetCall(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dscCompilationJobGetValidateBeforeCall(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        // verify the required parameter 'compilationJobId' is set
        if (compilationJobId == null) {
            throw new ApiException("Missing the required parameter 'compilationJobId' when calling dscCompilationJobGet(Async)");
        }
        ...
        return dscCompilationJobGetCall(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion, _callback);
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/dsccompilationjoboperations"> Documentation</a>
     */
    public DscCompilationJob dscCompilationJobGet(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<DscCompilationJob> localVarResp = dscCompilationJobGetWithHttpInfo(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/dsccompilationjoboperations"> Documentation</a>
     */
    public ApiResponse<DscCompilationJob> dscCompilationJobGetWithHttpInfo(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = dscCompilationJobGetValidateBeforeCall(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion, null);
        Type localVarReturnType = new TypeToken<DscCompilationJob>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/dsccompilationjoboperations"> Documentation</a>
     */
    public okhttp3.Call dscCompilationJobGetAsync(String resourceGroupName, String automationAccountName, UUID compilationJobId, String subscriptionId, String apiVersion, final ApiCallback<DscCompilationJob> _callback) throws ApiException {

        okhttp3.Call localVarCall = dscCompilationJobGetValidateBeforeCall(resourceGroupName, automationAccountName, compilationJobId, subscriptionId, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<DscCompilationJob>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/jobstreamoperations"> Documentation</a>
     */
    public DscCompilationJobStreamListByJob200ResponseValueInner dscCompilationJobGetStream(String resourceGroupName, String automationAccountName, UUID jobId, String jobStreamId, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<DscCompilationJobStreamListByJob200ResponseValueInner> localVarResp = dscCompilationJobGetStreamWithHttpInfo(resourceGroupName, automationAccountName, jobId, jobStreamId, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client Api Version. (required)
     * @return ApiResponse&lt;DscCompilationJobStreamListByJob200ResponseValueInner&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/jobstreamoperations"> Documentation</a>
     */
    public ApiResponse<DscCompilationJobStreamListByJob200ResponseValueInner> dscCompilationJobGetStreamWithHttpInfo(String resourceGroupName, String automationAccountName, UUID jobId, String jobStreamId, String subscriptionId, String apiVersion) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<DscCompilationJobStreamListByJob200ResponseValueInner>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/jobstreamoperations"> Documentation</a>
     */
    public okhttp3.Call dscCompilationJobGetStreamAsync(String resourceGroupName, String automationAccountName, UUID jobId, String jobStreamId, String subscriptionId, String apiVersion, final ApiCallback<DscCompilationJobStreamListByJob200ResponseValueInner> _callback) throws ApiException {
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/jobstreamoperations"> Documentation</a>
     */
    public DscCompilationJobStreamListByJob200Response dscCompilationJobStreamListByJob(String resourceGroupName, String automationAccountName, UUID jobId, String subscriptionId, String apiVersion) throws ApiException {
        ApiResponse<DscCompilationJobStreamListByJob200Response> localVarResp = dscCompilationJobStreamListByJobWithHttpInfo(resourceGroupName, automationAccountName, jobId, subscriptionId, apiVersion);
        return localVarResp.getData();
    }
     ...
     * @param subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @param apiVersion Client Api Version. (required)
     * @return ApiResponse&lt;DscCompilationJobStreamListByJob200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/jobstreamoperations"> Documentation</a>
     */
    public ApiResponse<DscCompilationJobStreamListByJob200Response> dscCompilationJobStreamListByJobWithHttpInfo(String resourceGroupName, String automationAccountName, UUID jobId, String subscriptionId, String apiVersion) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<DscCompilationJobStreamListByJob200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="http://aka.ms/azureautomationsdk/jobstreamoperations"> Documentation</a>
     */
    public okhttp3.Call dscCompilationJobStreamListByJobAsync(String resourceGroupName, String automationAccountName, UUID jobId, String subscriptionId, String apiVersion, final ApiCallback<DscCompilationJobStreamListByJob200Response> _callback) throws ApiException {
