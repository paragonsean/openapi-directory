...
async def test_loggers_create_or_update(client):
    """Test case for loggers_create_or_update

    
    """
    parameters = {"credentials":{"connectionString":"Endpoint=endpoint and key from Azure classic portal. This property in credentials is must.","name":"Event hub name. This is optional."},"isBuffered":True,"description":"description","type":"AzureEventHub"}
...
async def test_loggers_delete(client):
...
async def test_loggers_get(client):
...
async def test_loggers_list_by_service(client):
...
async def test_loggers_update(client):
    """Test case for loggers_update

    
    """
    parameters = {"credentials":{"key":"credentials"},"isBuffered":True,"description":"description","type":"AzureEventHub"}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
