...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerUpdateParameters();
  });
  ...
  describe('LoggerUpdateParameters', function() {
    it('should create an instance of LoggerUpdateParameters', function() {
      // uncomment below and update the code to test LoggerUpdateParameters
      //var instance = new ApiManagementClient.LoggerUpdateParameters();
      //expect(instance).to.be.a(ApiManagementClient.LoggerUpdateParameters);
    });
