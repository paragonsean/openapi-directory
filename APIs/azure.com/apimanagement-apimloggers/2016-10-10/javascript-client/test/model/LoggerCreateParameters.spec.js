...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerCreateParameters();
  });
  ...
  describe('LoggerCreateParameters', function() {
    it('should create an instance of LoggerCreateParameters', function() {
      // uncomment below and update the code to test LoggerCreateParameters
      //var instance = new ApiManagementClient.LoggerCreateParameters();
      //expect(instance).to.be.a(ApiManagementClient.LoggerCreateParameters);
    });
