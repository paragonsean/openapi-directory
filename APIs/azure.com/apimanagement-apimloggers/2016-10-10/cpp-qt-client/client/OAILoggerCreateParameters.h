...
/*
 * OAILoggerCreateParameters.h
 *
 * Parameters supplied to the Create Logger operation.
 */

#ifndef OAILoggerCreateParameters_H
#define OAILoggerCreateParameters_H
...
class OAILoggerCreateParameters : public OAIObject {
public:
    OAILoggerCreateParameters();
    OAILoggerCreateParameters(QString json);
    ~OAILoggerCreateParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggerCreateParameters)

#endif // OAILoggerCreateParameters_H
