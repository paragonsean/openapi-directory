...
#ifndef OAILoggerResponse_H
#define OAILoggerResponse_H
...
class OAILoggerResponse : public OAIObject {
public:
    OAILoggerResponse();
    OAILoggerResponse(QString json);
    ~OAILoggerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggerResponse)

#endif // OAILoggerResponse_H
