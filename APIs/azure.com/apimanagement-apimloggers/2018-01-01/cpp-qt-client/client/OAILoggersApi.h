...
public:
    ...
    * @param[in]  parameters OAILoggerContract [required]
    * @param[in]  if_match QString [optional]
    */
    virtual void loggerCreateOrUpdate(const QString &resource_group_name, const QString &service_name, const QString &loggerid, const QString &api_version, const QString &subscription_id, const OAILoggerContract &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void loggerDelete(const QString &resource_group_name, const QString &service_name, const QString &loggerid, const QString &if_match, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void loggerGet(const QString &resource_group_name, const QString &service_name, const QString &loggerid, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void loggerGetEntityTag(const QString &resource_group_name, const QString &service_name, const QString &loggerid, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAILoggerUpdateContract [required]
    */
    virtual void loggerUpdate(const QString &resource_group_name, const QString &service_name, const QString &loggerid, const QString &if_match, const QString &api_version, const QString &subscription_id, const OAILoggerUpdateContract &parameters);
...
Q_SIGNALS:
    ...
    void loggerCreateOrUpdateSignal(OAILoggerContract summary);
    void loggerDeleteSignal();
    void loggerGetSignal(OAILoggerContract summary);
    void loggerGetEntityTagSignal();
    void loggerListByServiceSignal(OAILoggerCollection summary);
    void loggerUpdateSignal();


    void loggerCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAILoggerContract summary);
    void loggerDeleteSignalFull(OAIHttpRequestWorker *worker);
    void loggerGetSignalFull(OAIHttpRequestWorker *worker, OAILoggerContract summary);
    void loggerGetEntityTagSignalFull(OAIHttpRequestWorker *worker);
    void loggerListByServiceSignalFull(OAIHttpRequestWorker *worker, OAILoggerCollection summary);
    void loggerUpdateSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use loggerCreateOrUpdateSignalError() instead")
    void loggerCreateOrUpdateSignalE(OAILoggerContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void loggerCreateOrUpdateSignalError(OAILoggerContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void loggerGetSignalE(OAILoggerContract summary, QNetworkReply::NetworkError error_type, QString error_str);
    void loggerGetSignalError(OAILoggerContract summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void loggerListByServiceSignalE(OAILoggerCollection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void loggerListByServiceSignalError(OAILoggerCollection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
