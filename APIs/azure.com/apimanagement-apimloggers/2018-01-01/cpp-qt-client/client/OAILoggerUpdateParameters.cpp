...
QString OAILoggerUpdateParameters::getLoggerType() const {
    return m_logger_type;
}
void OAILoggerUpdateParameters::setLoggerType(const QString &logger_type) {
    m_logger_type = logger_type;
    m_logger_type_isSet = true;
}

bool OAILoggerUpdateParameters::is_logger_type_Set() const{
    return m_logger_type_isSet;
}

bool OAILoggerUpdateParameters::is_logger_type_Valid() const{
