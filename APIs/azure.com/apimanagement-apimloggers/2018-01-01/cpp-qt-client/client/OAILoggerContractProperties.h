...
#ifndef OAILoggerContractProperties_H
#define OAILoggerContractProperties_H
...
class OAILoggerContractProperties : public OAIObject {
public:
    OAILoggerContractProperties();
    OAILoggerContractProperties(QString json);
    ~OAILoggerContractProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoggerContractProperties)

#endif // OAILoggerContractProperties_H
