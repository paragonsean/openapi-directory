...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerCollection();
  });
  ...
  describe('LoggerCollection', function() {
    it('should create an instance of LoggerCollection', function() {
      // uncomment below and update the code to test LoggerCollection
      //var instance = new ApiManagementClient.LoggerCollection();
      //expect(instance).to.be.a(ApiManagementClient.LoggerCollection);
    });
