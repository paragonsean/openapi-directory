...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerContractProperties();
  });
  ...
  describe('LoggerContractProperties', function() {
    it('should create an instance of LoggerContractProperties', function() {
      // uncomment below and update the code to test LoggerContractProperties
      //var instance = new ApiManagementClient.LoggerContractProperties();
      //expect(instance).to.be.a(ApiManagementClient.LoggerContractProperties);
    });
