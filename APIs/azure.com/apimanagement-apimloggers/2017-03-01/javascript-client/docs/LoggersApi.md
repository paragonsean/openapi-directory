...
> LoggerContract loggerCreateOrUpdate(resourceGroupName, serviceName, loggerid, apiVersion, subscriptionId, parameters)
...
apiInstance.loggerCreateOrUpdate(resourceGroupName, serviceName, loggerid, apiVersion, subscriptionId, parameters, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
