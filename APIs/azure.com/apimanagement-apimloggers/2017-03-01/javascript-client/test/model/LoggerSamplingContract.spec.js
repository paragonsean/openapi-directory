...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerSamplingContract();
  });
  ...
  describe('LoggerSamplingContract', function() {
    it('should create an instance of LoggerSamplingContract', function() {
      // uncomment below and update the code to test LoggerSamplingContract
      //var instance = new ApiManagementClient.LoggerSamplingContract();
      //expect(instance).to.be.a(ApiManagementClient.LoggerSamplingContract);
    });
