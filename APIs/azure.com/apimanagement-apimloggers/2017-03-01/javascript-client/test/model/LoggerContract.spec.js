...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerContract();
  });
  ...
  describe('LoggerContract', function() {
    it('should create an instance of LoggerContract', function() {
      // uncomment below and update the code to test LoggerContract
      //var instance = new ApiManagementClient.LoggerContract();
      //expect(instance).to.be.a(ApiManagementClient.LoggerContract);
    });
