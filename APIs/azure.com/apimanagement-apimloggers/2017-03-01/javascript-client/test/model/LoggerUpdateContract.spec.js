...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerUpdateContract();
  });
  ...
  describe('LoggerUpdateContract', function() {
    it('should create an instance of LoggerUpdateContract', function() {
      // uncomment below and update the code to test LoggerUpdateContract
      //var instance = new ApiManagementClient.LoggerUpdateContract();
      //expect(instance).to.be.a(ApiManagementClient.LoggerUpdateContract);
    });
