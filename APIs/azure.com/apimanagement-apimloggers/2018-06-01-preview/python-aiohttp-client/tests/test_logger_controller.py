...
async def test_logger_create_or_update(client):
    ...
    """
    parameters = openapi_server.LoggerGet200Response()
    ...
    response = await client.request(
        method='PUT',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ApiManagement/service/{service_name}/loggers/{logger_id}'.format(resource_group_name='resource_group_name_example', service_name='service_name_example', logger_id='logger_id_example', subscription_id='subscription_id_example'),
        headers=headers,
        json=parameters,
        params=params,
        )
...
async def test_logger_update(client):
    ...
    """
    parameters = openapi_server.LoggerUpdateRequest()
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
