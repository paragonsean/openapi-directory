...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerUpdateRequest();
  });
  ...
  describe('LoggerUpdateRequest', function() {
    it('should create an instance of LoggerUpdateRequest', function() {
      // uncomment below and update the code to test LoggerUpdateRequest
      //var instance = new ApiManagementClient.LoggerUpdateRequest();
      //expect(instance).to.be.a(ApiManagementClient.LoggerUpdateRequest);
    });
