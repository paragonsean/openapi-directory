...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.LoggerListByService200Response();
  });
  ...
  describe('LoggerListByService200Response', function() {
    it('should create an instance of LoggerListByService200Response', function() {
      // uncomment below and update the code to test LoggerListByService200Response
      //var instance = new ApiManagementClient.LoggerListByService200Response();
      //expect(instance).to.be.a(ApiManagementClient.LoggerListByService200Response);
    });
