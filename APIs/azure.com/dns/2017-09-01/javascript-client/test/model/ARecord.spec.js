...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnsManagementClient.ARecord();
  });
  ...
  describe('ARecord', function() {
    it('should create an instance of ARecord', function() {
      // uncomment below and update the code to test ARecord
      //var instance = new DnsManagementClient.ARecord();
      //expect(instance).to.be.a(DnsManagementClient.ARecord);
    });
