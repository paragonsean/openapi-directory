...
public:
    ...
    * @param[in]  if_match QString [optional]
    */
    virtual void recordSetsDelete(const QString &resource_group_name, const QString &zone_name, const QString &relative_record_set_name, const QString &record_type, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void recordSetsGet(const QString &resource_group_name, const QString &zone_name, const QString &relative_record_set_name, const QString &record_type, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  recordsetnamesuffix QString [optional]
    */
    virtual void recordSetsListByType(const QString &resource_group_name, const QString &zone_name, const QString &record_type, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<qint32> &top = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &recordsetnamesuffix = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void recordSetsListByDnsZoneCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void recordSetsListByDnsZoneSignal(OAIRecordSetListResult summary);
    ...
    void recordSetsListByDnsZoneSignalFull(OAIHttpRequestWorker *worker, OAIRecordSetListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use recordSetsListByDnsZoneSignalError() instead")
    void recordSetsListByDnsZoneSignalE(OAIRecordSetListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void recordSetsListByDnsZoneSignalError(OAIRecordSetListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use recordSetsListByDnsZoneSignalErrorFull() instead")
    void recordSetsListByDnsZoneSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void recordSetsListByDnsZoneSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
