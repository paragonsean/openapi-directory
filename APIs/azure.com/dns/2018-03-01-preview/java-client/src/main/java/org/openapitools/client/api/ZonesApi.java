...
import org.openapitools.client.model.ZoneUpdate;
...
public class ZonesApi {
     ...
     */
    public okhttp3.Call zonesUpdateCall(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, ZoneUpdate parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call zonesUpdateValidateBeforeCall(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, ZoneUpdate parameters, String ifMatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling zonesUpdate(Async)");
        }

        // verify the required parameter 'zoneName' is set
        if (zoneName == null) {
            throw new ApiException("Missing the required parameter 'zoneName' when calling zonesUpdate(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling zonesUpdate(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling zonesUpdate(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling zonesUpdate(Async)");
        }

        return zonesUpdateCall(resourceGroupName, zoneName, apiVersion, subscriptionId, parameters, ifMatch, _callback);
     ...
     */
    public Zone zonesUpdate(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, ZoneUpdate parameters, String ifMatch) throws ApiException {
        ApiResponse<Zone> localVarResp = zonesUpdateWithHttpInfo(resourceGroupName, zoneName, apiVersion, subscriptionId, parameters, ifMatch);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Zone> zonesUpdateWithHttpInfo(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, ZoneUpdate parameters, String ifMatch) throws ApiException {
        okhttp3.Call localVarCall = zonesUpdateValidateBeforeCall(resourceGroupName, zoneName, apiVersion, subscriptionId, parameters, ifMatch, null);
        Type localVarReturnType = new TypeToken<Zone>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call zonesUpdateAsync(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, ZoneUpdate parameters, String ifMatch, final ApiCallback<Zone> _callback) throws ApiException {

        okhttp3.Call localVarCall = zonesUpdateValidateBeforeCall(resourceGroupName, zoneName, apiVersion, subscriptionId, parameters, ifMatch, _callback);
        Type localVarReturnType = new TypeToken<Zone>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
