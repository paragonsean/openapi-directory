...
public class RecordSetsApi {
    ...
    /**
     * Build call for recordSetsListAllByDnsZone
     * @param resourceGroupName The name of the resource group. The name is case insensitive. (required)
     * @param zoneName The name of the DNS zone (without a terminating dot). (required)
     * @param apiVersion The API version to use for this operation. (required)
     * @param subscriptionId The ID of the target subscription. (required)
     ...
     */
    public okhttp3.Call recordSetsListAllByDnsZoneCall(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, Integer $top, String $recordsetnamesuffix, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/all"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "zoneName" + "}", localVarApiClient.escapeString(zoneName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call recordSetsListAllByDnsZoneValidateBeforeCall(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, Integer $top, String $recordsetnamesuffix, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling recordSetsListAllByDnsZone(Async)");
        }

        // verify the required parameter 'zoneName' is set
        if (zoneName == null) {
            throw new ApiException("Missing the required parameter 'zoneName' when calling recordSetsListAllByDnsZone(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling recordSetsListAllByDnsZone(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling recordSetsListAllByDnsZone(Async)");
        }

        return recordSetsListAllByDnsZoneCall(resourceGroupName, zoneName, apiVersion, subscriptionId, $top, $recordsetnamesuffix, _callback);
     ...
     */
    public RecordSetListResult recordSetsListAllByDnsZone(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, Integer $top, String $recordsetnamesuffix) throws ApiException {
        ApiResponse<RecordSetListResult> localVarResp = recordSetsListAllByDnsZoneWithHttpInfo(resourceGroupName, zoneName, apiVersion, subscriptionId, $top, $recordsetnamesuffix);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RecordSetListResult> recordSetsListAllByDnsZoneWithHttpInfo(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, Integer $top, String $recordsetnamesuffix) throws ApiException {
        okhttp3.Call localVarCall = recordSetsListAllByDnsZoneValidateBeforeCall(resourceGroupName, zoneName, apiVersion, subscriptionId, $top, $recordsetnamesuffix, null);
     ...
     */
    public okhttp3.Call recordSetsListAllByDnsZoneAsync(String resourceGroupName, String zoneName, String apiVersion, String subscriptionId, Integer $top, String $recordsetnamesuffix, final ApiCallback<RecordSetListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = recordSetsListAllByDnsZoneValidateBeforeCall(resourceGroupName, zoneName, apiVersion, subscriptionId, $top, $recordsetnamesuffix, _callback);
        Type localVarReturnType = new TypeToken<RecordSetListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
