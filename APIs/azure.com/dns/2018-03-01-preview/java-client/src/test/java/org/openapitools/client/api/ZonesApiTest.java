...
public class ZonesApiTest {
     ...
     */
    @Test
    public void zonesUpdateTest() throws ApiException {
        String resourceGroupName = null;
        String zoneName = null;
        String apiVersion = null;
        String subscriptionId = null;
        ZoneUpdate parameters = null;
        String ifMatch = null;
        Zone response = api.zonesUpdate(resourceGroupName, zoneName, apiVersion, subscriptionId, parameters, ifMatch);
        // TODO: test validations
    }
