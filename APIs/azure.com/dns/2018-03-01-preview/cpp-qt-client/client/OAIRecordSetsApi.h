...
private:
    ...
    void recordSetsListAllByDnsZoneCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void recordSetsListAllByDnsZoneSignal(OAIRecordSetListResult summary);
    ...
    void recordSetsListAllByDnsZoneSignalFull(OAIHttpRequestWorker *worker, OAIRecordSetListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use recordSetsListAllByDnsZoneSignalError() instead")
    void recordSetsListAllByDnsZoneSignalE(OAIRecordSetListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void recordSetsListAllByDnsZoneSignalError(OAIRecordSetListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use recordSetsListAllByDnsZoneSignalErrorFull() instead")
    void recordSetsListAllByDnsZoneSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void recordSetsListAllByDnsZoneSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
