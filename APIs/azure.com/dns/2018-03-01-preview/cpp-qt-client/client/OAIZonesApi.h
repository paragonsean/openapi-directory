...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  subscription_id QString [required]
    * @param[in]  parameters OAIZoneUpdate [required]
    * @param[in]  if_match QString [optional]
    */
    virtual void zonesUpdate(const QString &resource_group_name, const QString &zone_name, const QString &api_version, const QString &subscription_id, const OAIZoneUpdate &parameters, const ::OpenAPI::OptionalParam<QString> &if_match = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void zonesUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void zonesUpdateSignal(OAIZone summary);
    ...
    void zonesUpdateSignalFull(OAIHttpRequestWorker *worker, OAIZone summary);
    ...
    Q_DECL_DEPRECATED_X("Use zonesUpdateSignalError() instead")
    void zonesUpdateSignalE(OAIZone summary, QNetworkReply::NetworkError error_type, QString error_str);
    void zonesUpdateSignalError(OAIZone summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use zonesUpdateSignalErrorFull() instead")
    void zonesUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void zonesUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
