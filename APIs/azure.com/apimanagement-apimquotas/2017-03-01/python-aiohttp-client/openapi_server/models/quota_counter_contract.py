...
class QuotaCounterContract(Model):
    ...
    def __init__(self, value: QuotaCounterValueContractProperties=None, counter_key: str=None, period_end_time: datetime=None, period_key: str=None, period_start_time: datetime=None):
