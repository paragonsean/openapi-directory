...
#include "OAIQuotaByCounterKeys_List_default_response.h"
...
public:
    ...
    */
    virtual void quotaByPeriodKeysGet(const QString &quota_counter_key, const QString &quota_period_key, const QString &api_version);
    ...
    */
    virtual void quotaByPeriodKeysUpdate(const QString &quota_counter_key, const QString &quota_period_key, const QString &api_version, const OAIQuotaCounterValueContractProperties &parameters);
