...
async def test_quota_by_period_keys_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.ApiManagement/service/{service_name}/quotas/{quota_counter_key}/periods/{quota_period_key}'.format(resource_group_name='resource_group_name_example', service_name='service_name_example', quota_counter_key='quota_counter_key_example', quota_period_key='quota_period_key_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
