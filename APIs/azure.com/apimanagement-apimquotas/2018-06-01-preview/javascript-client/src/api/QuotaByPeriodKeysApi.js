...
export default class QuotaByPeriodKeysApi {
    ...
    */
     ...
     * @param {module:model/QuotaByCounterKeysListByService200ResponseValueInner} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/QuotaByCounterKeysListByService200ResponseValueInner}
     */
    quotaByPeriodKeysGet(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, apiVersion, subscriptionId, callback) {
      let postBody = null;
      ...
      let returnType = QuotaByCounterKeysListByService200ResponseValueInner;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/periods/{quotaPeriodKey}', 'GET',
     ...
     * @param {String} apiVersion Version of the API to be used with the client request.
     * @param {String} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/QuotaByCounterKeysListByService200ResponseValueInnerValue} parameters The value of the Quota counter to be applied on the specified period.
    ...
    quotaByPeriodKeysUpdate(resourceGroupName, serviceName, quotaCounterKey, quotaPeriodKey, apiVersion, subscriptionId, parameters, callback) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/quotas/{quotaCounterKey}/periods/{quotaPeriodKey}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
