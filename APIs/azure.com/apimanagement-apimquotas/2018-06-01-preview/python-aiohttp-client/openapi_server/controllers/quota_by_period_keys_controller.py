...
async def quota_by_period_keys_get(request: web.Request, resource_group_name, service_name, quota_counter_key, quota_period_key, api_version, subscription_id) -> web.Response:
