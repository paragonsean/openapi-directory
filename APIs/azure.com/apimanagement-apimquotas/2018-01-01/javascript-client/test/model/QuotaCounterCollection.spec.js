...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiManagementClient.QuotaCounterCollection();
  });
  ...
  describe('QuotaCounterCollection', function() {
    it('should create an instance of QuotaCounterCollection', function() {
      // uncomment below and update the code to test QuotaCounterCollection
      //var instance = new ApiManagementClient.QuotaCounterCollection();
      //expect(instance).to.be.a(ApiManagementClient.QuotaCounterCollection);
    });
