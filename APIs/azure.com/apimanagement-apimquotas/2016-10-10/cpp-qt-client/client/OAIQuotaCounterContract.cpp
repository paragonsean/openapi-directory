...
qint32 OAIQuotaCounterContract::getCallsCount() const {
    return m_calls_count;
}
void OAIQuotaCounterContract::setCallsCount(const qint32 &calls_count) {
    m_calls_count = calls_count;
    m_calls_count_isSet = true;
}

bool OAIQuotaCounterContract::is_calls_count_Set() const{
    return m_calls_count_isSet;
}

bool OAIQuotaCounterContract::is_calls_count_Valid() const{
    return m_calls_count_isValid;
}

double OAIQuotaCounterContract::getKbTransferred() const {
    return m_kb_transferred;
}
void OAIQuotaCounterContract::setKbTransferred(const double &kb_transferred) {
    m_kb_transferred = kb_transferred;
    m_kb_transferred_isSet = true;
}

bool OAIQuotaCounterContract::is_kb_transferred_Set() const{
    return m_kb_transferred_isSet;
}

bool OAIQuotaCounterContract::is_kb_transferred_Valid() const{
