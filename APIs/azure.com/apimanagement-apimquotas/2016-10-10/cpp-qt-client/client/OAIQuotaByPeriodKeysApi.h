...
public:
    ...
    */
    virtual void quotaByPeriodKeysUpdate(const QString &resource_group_name, const QString &service_name, const QString &quota_counter_key, const QString &quota_period_key, const QString &api_version, const QString &subscription_id, const OAIQuotaCounterValueContract &parameters);
