...
import QuotaCounterValueContract from './QuotaCounterValueContract';
...
class QuotaCounterContract {
     ...
     * @implements module:model/QuotaCounterValueContract
     */
    constructor() { 
        QuotaCounterValueContract.initialize(this);
        QuotaCounterContract.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            QuotaCounterValueContract.constructFromObject(data, obj);
 ...
 */
QuotaCounterContract.prototype['callsCount'] = undefined;

/**
 * Data Transferred in KiloBytes.
 * @member {Number} kbTransferred
 */
QuotaCounterContract.prototype['kbTransferred'] = undefined;


// Implement QuotaCounterValueContract interface:
/**
 * Number of times Counter was called.
 * @member {Number} callsCount
 */
