...
public:
    ...
    */
    virtual void quotaByPeriodKeysGet(const QString &resource_group_name, const QString &service_name, const QString &quota_counter_key, const QString &quota_period_key, const QString &api_version, const QString &subscription_id);
    ...
    */
    virtual void quotaByPeriodKeysUpdate(const QString &resource_group_name, const QString &service_name, const QString &quota_counter_key, const QString &quota_period_key, const QString &api_version, const QString &subscription_id, const OAIQuotaByCounterKeys_ListByService_200_response_value_inner_value &parameters);
...
Q_SIGNALS:
    ...
    void quotaByPeriodKeysGetSignal(OAIQuotaByCounterKeys_ListByService_200_response_value_inner summary);
    void quotaByPeriodKeysUpdateSignal();


    void quotaByPeriodKeysGetSignalFull(OAIHttpRequestWorker *worker, OAIQuotaByCounterKeys_ListByService_200_response_value_inner summary);
    ...
    void quotaByPeriodKeysGetSignalE(OAIQuotaByCounterKeys_ListByService_200_response_value_inner summary, QNetworkReply::NetworkError error_type, QString error_str);
    void quotaByPeriodKeysGetSignalError(OAIQuotaByCounterKeys_ListByService_200_response_value_inner summary, QNetworkReply::NetworkError error_type, const QString &error_str);
