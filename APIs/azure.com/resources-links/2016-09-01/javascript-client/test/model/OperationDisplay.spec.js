...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagementLinkClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ManagementLinkClient.OperationDisplay();
      //expect(instance).to.be.a(ManagementLinkClient.OperationDisplay);
    });
