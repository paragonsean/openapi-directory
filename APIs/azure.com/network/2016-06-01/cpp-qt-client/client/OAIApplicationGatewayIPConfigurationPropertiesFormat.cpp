...
OAISubResource OAIApplicationGatewayIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIApplicationGatewayIPConfigurationPropertiesFormat::setSubnet(const OAISubResource &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
