...
public:
    ...
    QList<OAISubResource> getAuthenticationCertificates() const;
    void setAuthenticationCertificates(const QList<OAISubResource> &authentication_certificates);
...
private:
    ...
    QList<OAISubResource> m_authentication_certificates;
