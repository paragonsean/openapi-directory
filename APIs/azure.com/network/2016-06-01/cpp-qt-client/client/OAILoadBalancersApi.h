...
public:
    ...
    */
    virtual void loadBalancersGet(const QString &resource_group_name, const QString &load_balancer_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>());
