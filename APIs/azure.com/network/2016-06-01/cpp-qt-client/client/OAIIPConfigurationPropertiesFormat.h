...
/*
 * OAIIPConfigurationPropertiesFormat.h
 *
 * Properties of IPConfiguration
 */

#ifndef OAIIPConfigurationPropertiesFormat_H
#define OAIIPConfigurationPropertiesFormat_H
...
class OAIIPConfigurationPropertiesFormat : public OAIObject {
public:
    OAIIPConfigurationPropertiesFormat();
    OAIIPConfigurationPropertiesFormat(QString json);
    ~OAIIPConfigurationPropertiesFormat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIPConfigurationPropertiesFormat)

#endif // OAIIPConfigurationPropertiesFormat_H
