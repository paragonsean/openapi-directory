...
namespace OpenAPI {
class OAILoadBalancerPropertiesFormat;
...
public:
    ...
    OAILoadBalancerPropertiesFormat getProperties() const;
    void setProperties(const OAILoadBalancerPropertiesFormat &properties);
...
private:
    ...
    OAILoadBalancerPropertiesFormat m_properties;
