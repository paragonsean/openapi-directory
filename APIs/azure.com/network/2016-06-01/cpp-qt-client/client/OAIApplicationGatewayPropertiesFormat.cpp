...
QList<OAIApplicationGatewayAuthenticationCertificate> OAIApplicationGatewayPropertiesFormat::getAuthenticationCertificates() const {
    return m_authentication_certificates;
}
void OAIApplicationGatewayPropertiesFormat::setAuthenticationCertificates(const QList<OAIApplicationGatewayAuthenticationCertificate> &authentication_certificates) {
...
QList<OAIApplicationGatewayProbe> OAIApplicationGatewayPropertiesFormat::getProbes() const {
    return m_probes;
}
void OAIApplicationGatewayPropertiesFormat::setProbes(const QList<OAIApplicationGatewayProbe> &probes) {
    m_probes = probes;
    m_probes_isSet = true;
}
...
QList<OAIApplicationGatewayUrlPathMap> OAIApplicationGatewayPropertiesFormat::getUrlPathMaps() const {
    return m_url_path_maps;
}
void OAIApplicationGatewayPropertiesFormat::setUrlPathMaps(const QList<OAIApplicationGatewayUrlPathMap> &url_path_maps) {
