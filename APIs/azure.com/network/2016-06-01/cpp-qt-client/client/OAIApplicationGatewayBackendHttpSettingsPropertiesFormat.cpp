...
QList<OAISubResource> OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::getAuthenticationCertificates() const {
    return m_authentication_certificates;
}
void OAIApplicationGatewayBackendHttpSettingsPropertiesFormat::setAuthenticationCertificates(const QList<OAISubResource> &authentication_certificates) {
