...
OAIPublicIPAddress OAIFrontendIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIFrontendIPConfigurationPropertiesFormat::setPublicIpAddress(const OAIPublicIPAddress &public_ip_address) {
...
OAISubnet OAIFrontendIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIFrontendIPConfigurationPropertiesFormat::setSubnet(const OAISubnet &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
