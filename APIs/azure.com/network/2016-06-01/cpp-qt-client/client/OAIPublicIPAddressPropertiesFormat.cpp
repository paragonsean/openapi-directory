...
OAIIPConfiguration OAIPublicIPAddressPropertiesFormat::getIpConfiguration() const {
    return m_ip_configuration;
}
void OAIPublicIPAddressPropertiesFormat::setIpConfiguration(const OAIIPConfiguration &ip_configuration) {
...
QString OAIPublicIPAddressPropertiesFormat::getPublicIpAddressVersion() const {
    return m_public_ip_address_version;
}
void OAIPublicIPAddressPropertiesFormat::setPublicIpAddressVersion(const QString &public_ip_address_version) {
    m_public_ip_address_version = public_ip_address_version;
    m_public_ip_address_version_isSet = true;
}

bool OAIPublicIPAddressPropertiesFormat::is_public_ip_address_version_Set() const{
    return m_public_ip_address_version_isSet;
}

bool OAIPublicIPAddressPropertiesFormat::is_public_ip_address_version_Valid() const{
