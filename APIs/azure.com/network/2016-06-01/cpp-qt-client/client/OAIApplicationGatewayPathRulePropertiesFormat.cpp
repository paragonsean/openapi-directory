...
OAISubResource OAIApplicationGatewayPathRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendAddressPool(const OAISubResource &backend_address_pool) {
...
OAISubResource OAIApplicationGatewayPathRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayPathRulePropertiesFormat::setBackendHttpSettings(const OAISubResource &backend_http_settings) {
