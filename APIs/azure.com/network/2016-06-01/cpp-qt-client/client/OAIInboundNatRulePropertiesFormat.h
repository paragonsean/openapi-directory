...
public:
    ...
    OAINetworkInterfaceIPConfiguration getBackendIpConfiguration() const;
    void setBackendIpConfiguration(const OAINetworkInterfaceIPConfiguration &backend_ip_configuration);
...
private:
    ...
    OAINetworkInterfaceIPConfiguration m_backend_ip_configuration;
