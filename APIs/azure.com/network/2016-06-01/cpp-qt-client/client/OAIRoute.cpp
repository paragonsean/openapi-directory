...
QString OAIRoute::getEtag() const {
    return m_etag;
}
void OAIRoute::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIRoute::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIRoute::is_etag_Valid() const{
...
OAIRoutePropertiesFormat OAIRoute::getProperties() const {
    return m_properties;
}
void OAIRoute::setProperties(const OAIRoutePropertiesFormat &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIRoute::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIRoute::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIRoute::getId() const {
    return m_id;
}
void OAIRoute::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
