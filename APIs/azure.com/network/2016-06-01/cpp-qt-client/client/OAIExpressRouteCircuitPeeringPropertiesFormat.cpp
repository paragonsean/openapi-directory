...
qint32 OAIExpressRouteCircuitPeeringPropertiesFormat::getPeerAsn() const {
    return m_peer_asn;
}
void OAIExpressRouteCircuitPeeringPropertiesFormat::setPeerAsn(const qint32 &peer_asn) {
    m_peer_asn = peer_asn;
...
QString OAIExpressRouteCircuitPeeringPropertiesFormat::getPeeringType() const {
    return m_peering_type;
}
void OAIExpressRouteCircuitPeeringPropertiesFormat::setPeeringType(const QString &peering_type) {
...
QString OAIExpressRouteCircuitPeeringPropertiesFormat::getState() const {
    return m_state;
}
void OAIExpressRouteCircuitPeeringPropertiesFormat::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}
