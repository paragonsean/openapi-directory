...
public:
    ...
    */
    virtual void networkSecurityGroupsGet(const QString &resource_group_name, const QString &network_security_group_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>());
