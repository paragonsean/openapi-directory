...
OAISubResource OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendAddressPool() const {
    return m_backend_address_pool;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendAddressPool(const OAISubResource &backend_address_pool) {
...
OAISubResource OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getBackendHttpSettings() const {
    return m_backend_http_settings;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setBackendHttpSettings(const OAISubResource &backend_http_settings) {
...
OAISubResource OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getHttpListener() const {
    return m_http_listener;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setHttpListener(const OAISubResource &http_listener) {
...
OAISubResource OAIApplicationGatewayRequestRoutingRulePropertiesFormat::getUrlPathMap() const {
    return m_url_path_map;
}
void OAIApplicationGatewayRequestRoutingRulePropertiesFormat::setUrlPathMap(const OAISubResource &url_path_map) {
