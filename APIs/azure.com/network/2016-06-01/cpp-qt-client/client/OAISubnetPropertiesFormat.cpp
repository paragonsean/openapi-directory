...
QList<OAIResourceNavigationLink> OAISubnetPropertiesFormat::getResourceNavigationLinks() const {
    return m_resource_navigation_links;
}
void OAISubnetPropertiesFormat::setResourceNavigationLinks(const QList<OAIResourceNavigationLink> &resource_navigation_links) {
    m_resource_navigation_links = resource_navigation_links;
    m_resource_navigation_links_isSet = true;
}

bool OAISubnetPropertiesFormat::is_resource_navigation_links_Set() const{
    return m_resource_navigation_links_isSet;
}

bool OAISubnetPropertiesFormat::is_resource_navigation_links_Valid() const{
