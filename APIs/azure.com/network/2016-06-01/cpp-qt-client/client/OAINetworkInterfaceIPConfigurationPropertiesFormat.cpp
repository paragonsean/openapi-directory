...
QList<OAIApplicationGatewayBackendAddressPool> OAINetworkInterfaceIPConfigurationPropertiesFormat::getApplicationGatewayBackendAddressPools() const {
    return m_application_gateway_backend_address_pools;
}
void OAINetworkInterfaceIPConfigurationPropertiesFormat::setApplicationGatewayBackendAddressPools(const QList<OAIApplicationGatewayBackendAddressPool> &application_gateway_backend_address_pools) {
...
bool OAINetworkInterfaceIPConfigurationPropertiesFormat::is_application_gateway_backend_address_pools_Set() const{
    return m_application_gateway_backend_address_pools_isSet;
}

bool OAINetworkInterfaceIPConfigurationPropertiesFormat::is_application_gateway_backend_address_pools_Valid() const{
    return m_application_gateway_backend_address_pools_isValid;
}

QList<OAIBackendAddressPool> OAINetworkInterfaceIPConfigurationPropertiesFormat::getLoadBalancerBackendAddressPools() const {
    return m_load_balancer_backend_address_pools;
}
void OAINetworkInterfaceIPConfigurationPropertiesFormat::setLoadBalancerBackendAddressPools(const QList<OAIBackendAddressPool> &load_balancer_backend_address_pools) {
...
QList<OAIInboundNatRule> OAINetworkInterfaceIPConfigurationPropertiesFormat::getLoadBalancerInboundNatRules() const {
    return m_load_balancer_inbound_nat_rules;
}
void OAINetworkInterfaceIPConfigurationPropertiesFormat::setLoadBalancerInboundNatRules(const QList<OAIInboundNatRule> &load_balancer_inbound_nat_rules) {
...
bool OAINetworkInterfaceIPConfigurationPropertiesFormat::isPrimary() const {
    return m_primary;
}
void OAINetworkInterfaceIPConfigurationPropertiesFormat::setPrimary(const bool &primary) {
    m_primary = primary;
    m_primary_isSet = true;
}

bool OAINetworkInterfaceIPConfigurationPropertiesFormat::is_primary_Set() const{
    return m_primary_isSet;
}

bool OAINetworkInterfaceIPConfigurationPropertiesFormat::is_primary_Valid() const{
...
QString OAINetworkInterfaceIPConfigurationPropertiesFormat::getPrivateIpAddressVersion() const {
    return m_private_ip_address_version;
}
void OAINetworkInterfaceIPConfigurationPropertiesFormat::setPrivateIpAddressVersion(const QString &private_ip_address_version) {
    m_private_ip_address_version = private_ip_address_version;
    m_private_ip_address_version_isSet = true;
}

bool OAINetworkInterfaceIPConfigurationPropertiesFormat::is_private_ip_address_version_Set() const{
    return m_private_ip_address_version_isSet;
}

bool OAINetworkInterfaceIPConfigurationPropertiesFormat::is_private_ip_address_version_Valid() const{
...
OAIPublicIPAddress OAINetworkInterfaceIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAINetworkInterfaceIPConfigurationPropertiesFormat::setPublicIpAddress(const OAIPublicIPAddress &public_ip_address) {
...
OAISubnet OAINetworkInterfaceIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAINetworkInterfaceIPConfigurationPropertiesFormat::setSubnet(const OAISubnet &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
