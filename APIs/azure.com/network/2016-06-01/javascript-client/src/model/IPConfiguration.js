...
class IPConfiguration {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = IPConfigurationPropertiesFormat.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          IPConfigurationPropertiesFormat.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
IPConfiguration.prototype['etag'] = undefined;

/**
 * Gets name of the resource that is unique within a resource group. This name can be used to access the resource
 * @member {String} name
 */
IPConfiguration.prototype['name'] = undefined;

/**
 * @member {module:model/IPConfigurationPropertiesFormat} properties
 */
IPConfiguration.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
IPConfiguration.prototype['id'] = undefined;
