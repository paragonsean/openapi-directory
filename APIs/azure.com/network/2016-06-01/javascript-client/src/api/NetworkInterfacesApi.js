...
export default class NetworkInterfacesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the networkInterfacesGetEffectiveRouteTable operation.
     * @callback module:api/NetworkInterfacesApi~networkInterfacesGetEffectiveRouteTableCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EffectiveRouteListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client Api Version.
     * @param {String} subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/NetworkInterfacesApi~networkInterfacesGetEffectiveRouteTableCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EffectiveRouteListResult}
     */
    networkInterfacesGetEffectiveRouteTable(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling networkInterfacesGetEffectiveRouteTable");
      }
      // verify the required parameter 'networkInterfaceName' is set
      if (networkInterfaceName === undefined || networkInterfaceName === null) {
        throw new Error("Missing the required parameter 'networkInterfaceName' when calling networkInterfacesGetEffectiveRouteTable");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling networkInterfacesGetEffectiveRouteTable");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling networkInterfacesGetEffectiveRouteTable");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json', 'text/json'];
      let returnType = EffectiveRouteListResult;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the networkInterfacesListEffectiveNetworkSecurityGroups operation.
     * @callback module:api/NetworkInterfacesApi~networkInterfacesListEffectiveNetworkSecurityGroupsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EffectiveNetworkSecurityGroupListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiVersion Client Api Version.
     * @param {String} subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:api/NetworkInterfacesApi~networkInterfacesListEffectiveNetworkSecurityGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EffectiveNetworkSecurityGroupListResult}
     */
    networkInterfacesListEffectiveNetworkSecurityGroups(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, callback) {
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling networkInterfacesListEffectiveNetworkSecurityGroups");
      }
      // verify the required parameter 'networkInterfaceName' is set
      if (networkInterfaceName === undefined || networkInterfaceName === null) {
        throw new Error("Missing the required parameter 'networkInterfaceName' when calling networkInterfacesListEffectiveNetworkSecurityGroups");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling networkInterfacesListEffectiveNetworkSecurityGroups");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling networkInterfacesListEffectiveNetworkSecurityGroups");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json', 'text/json'];
      let returnType = EffectiveNetworkSecurityGroupListResult;
      return this.apiClient.callApi(
