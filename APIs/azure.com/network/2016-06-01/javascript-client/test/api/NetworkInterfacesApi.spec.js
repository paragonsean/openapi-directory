...
(function(root, factory) {
  ...
  describe('NetworkInterfacesApi', function() {
    ...
    describe('networkInterfacesGetEffectiveRouteTable', function() {
      it('should call networkInterfacesGetEffectiveRouteTable successfully', function(done) {
        //uncomment below and update the code to test networkInterfacesGetEffectiveRouteTable
        //instance.networkInterfacesGetEffectiveRouteTable(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networkInterfacesListEffectiveNetworkSecurityGroups', function() {
      it('should call networkInterfacesListEffectiveNetworkSecurityGroups successfully', function(done) {
        //uncomment below and update the code to test networkInterfacesListEffectiveNetworkSecurityGroups
        //instance.networkInterfacesListEffectiveNetworkSecurityGroups(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
