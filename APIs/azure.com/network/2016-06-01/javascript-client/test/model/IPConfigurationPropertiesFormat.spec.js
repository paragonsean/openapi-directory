...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.IPConfigurationPropertiesFormat();
  });
  ...
  describe('IPConfigurationPropertiesFormat', function() {
    it('should create an instance of IPConfigurationPropertiesFormat', function() {
      // uncomment below and update the code to test IPConfigurationPropertiesFormat
      //var instance = new NetworkManagementClient.IPConfigurationPropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.IPConfigurationPropertiesFormat);
    });
