...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.EffectiveNetworkSecurityRule();
  });
  ...
  describe('EffectiveNetworkSecurityRule', function() {
    it('should create an instance of EffectiveNetworkSecurityRule', function() {
      // uncomment below and update the code to test EffectiveNetworkSecurityRule
      //var instance = new NetworkManagementClient.EffectiveNetworkSecurityRule();
      //expect(instance).to.be.a(NetworkManagementClient.EffectiveNetworkSecurityRule);
    });
