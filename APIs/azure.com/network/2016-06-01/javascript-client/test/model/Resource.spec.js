...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new NetworkManagementClient.Resource();
      //expect(instance).to.be.a(NetworkManagementClient.Resource);
    });
