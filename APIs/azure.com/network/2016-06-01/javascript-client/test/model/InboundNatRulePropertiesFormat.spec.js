...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.InboundNatRulePropertiesFormat();
  });
  ...
  describe('InboundNatRulePropertiesFormat', function() {
    it('should create an instance of InboundNatRulePropertiesFormat', function() {
      // uncomment below and update the code to test InboundNatRulePropertiesFormat
      //var instance = new NetworkManagementClient.InboundNatRulePropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.InboundNatRulePropertiesFormat);
    });
