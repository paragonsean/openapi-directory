...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.LoadBalancer();
  });
  ...
  describe('LoadBalancer', function() {
    it('should create an instance of LoadBalancer', function() {
      ...
      //var instance = new NetworkManagementClient.LoadBalancer();
      //expect(instance).to.be.a(NetworkManagementClient.LoadBalancer);
    });
