...
from openapi_server.models.effective_network_security_group_list_result import EffectiveNetworkSecurityGroupListResult
from openapi_server.models.effective_route_list_result import EffectiveRouteListResult
...
async def test_network_interfaces_get_effective_route_table(client):
    """Test case for network_interfaces_get_effective_route_table
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/networkInterfaces/{network_interface_name}/effectiveRouteTable'.format(resource_group_name='resource_group_name_example', network_interface_name='network_interface_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_network_interfaces_list_effective_network_security_groups(client):
    """Test case for network_interfaces_list_effective_network_security_groups
    ...
    response = await client.request(
        method='POST',
        path='/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/networkInterfaces/{network_interface_name}/effectiveNetworkSecurityGroups'.format(resource_group_name='resource_group_name_example', network_interface_name='network_interface_name_example', subscription_id='subscription_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
