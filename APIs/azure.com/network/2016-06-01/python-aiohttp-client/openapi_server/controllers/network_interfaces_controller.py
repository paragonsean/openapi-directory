...
async def network_interfaces_get_effective_route_table(request: web.Request, resource_group_name, network_interface_name, api_version, subscription_id) -> web.Response:
...
async def network_interfaces_list_effective_network_security_groups(request: web.Request, resource_group_name, network_interface_name, api_version, subscription_id) -> web.Response:
