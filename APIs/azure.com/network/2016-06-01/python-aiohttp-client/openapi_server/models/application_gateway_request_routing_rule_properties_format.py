...
class ApplicationGatewayRequestRoutingRulePropertiesFormat(Model):
    ...
    def __init__(self, backend_address_pool: SubResource=None, backend_http_settings: SubResource=None, http_listener: SubResource=None, provisioning_state: str=None, rule_type: str=None, url_path_map: SubResource=None):
