...
from openapi_server.models.resource_navigation_link import ResourceNavigationLink
...
class SubnetPropertiesFormat(Model):
    ...
    def __init__(self, address_prefix: str=None, ip_configurations: List[IPConfiguration]=None, network_security_group: NetworkSecurityGroup=None, provisioning_state: str=None, resource_navigation_links: List[ResourceNavigationLink]=None, route_table: RouteTable=None):
        ...
        :param resource_navigation_links: The resource_navigation_links of this SubnetPropertiesFormat.
    ...
    def resource_navigation_links(self):
        """Gets the resource_navigation_links of this SubnetPropertiesFormat.

        Gets array of references to the external resources using subnet

        :return: The resource_navigation_links of this SubnetPropertiesFormat.
        :rtype: List[ResourceNavigationLink]
        """
    ...
    def resource_navigation_links(self, resource_navigation_links):
        """Sets the resource_navigation_links of this SubnetPropertiesFormat.

        Gets array of references to the external resources using subnet

        :param resource_navigation_links: The resource_navigation_links of this SubnetPropertiesFormat.
        :type resource_navigation_links: List[ResourceNavigationLink]
        """
