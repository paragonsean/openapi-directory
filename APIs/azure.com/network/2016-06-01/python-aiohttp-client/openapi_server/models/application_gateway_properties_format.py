...
class ApplicationGatewayPropertiesFormat(Model):
    ...
    def __init__(self, authentication_certificates: List[ApplicationGatewayAuthenticationCertificate]=None, backend_address_pools: List[ApplicationGatewayBackendAddressPool]=None, backend_http_settings_collection: List[ApplicationGatewayBackendHttpSettings]=None, frontend_ip_configurations: List[ApplicationGatewayFrontendIPConfiguration]=None, frontend_ports: List[ApplicationGatewayFrontendPort]=None, gateway_ip_configurations: List[ApplicationGatewayIPConfiguration]=None, http_listeners: List[ApplicationGatewayHttpListener]=None, operational_state: str=None, probes: List[ApplicationGatewayProbe]=None, provisioning_state: str=None, request_routing_rules: List[ApplicationGatewayRequestRoutingRule]=None, resource_guid: str=None, sku: ApplicationGatewaySku=None, ssl_certificates: List[ApplicationGatewaySslCertificate]=None, ssl_policy: ApplicationGatewaySslPolicy=None, url_path_maps: List[ApplicationGatewayUrlPathMap]=None):
    ...
    def authentication_certificates(self):
        ...
        :rtype: List[ApplicationGatewayAuthenticationCertificate]
        """
    ...
    def authentication_certificates(self, authentication_certificates):
        ...
        :param authentication_certificates: The authentication_certificates of this ApplicationGatewayPropertiesFormat.
        :type authentication_certificates: List[ApplicationGatewayAuthenticationCertificate]
        """
