...
public class SubnetPropertiesFormat {
  ...
  private List<ResourceNavigationLink> resourceNavigationLinks = new ArrayList<>();
  ...
  public SubnetPropertiesFormat resourceNavigationLinks(List<ResourceNavigationLink> resourceNavigationLinks) {
    this.resourceNavigationLinks = resourceNavigationLinks;
    return this;
  }

  public SubnetPropertiesFormat addResourceNavigationLinksItem(ResourceNavigationLink resourceNavigationLinksItem) {
  ...
  public void setResourceNavigationLinks(List<ResourceNavigationLink> resourceNavigationLinks) {
    this.resourceNavigationLinks = resourceNavigationLinks;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressPrefix, subnetPropertiesFormat.addressPrefix) &&
        ...
        Objects.equals(this.resourceNavigationLinks, subnetPropertiesFormat.resourceNavigationLinks) &&
      ...
      if (jsonObj.get("resourceNavigationLinks") != null && !jsonObj.get("resourceNavigationLinks").isJsonNull()) {
        ...
        if (jsonArrayresourceNavigationLinks != null) {
          ...
          for (int i = 0; i < jsonArrayresourceNavigationLinks.size(); i++) {
            ResourceNavigationLink.validateJsonElement(jsonArrayresourceNavigationLinks.get(i));
          };
        }
      }
