...
import org.openapitools.client.model.ApplicationGatewayAuthenticationCertificate;
...
public class ApplicationGatewayPropertiesFormat {
  ...
  private List<ApplicationGatewayAuthenticationCertificate> authenticationCertificates = new ArrayList<>();
  ...
  public ApplicationGatewayPropertiesFormat authenticationCertificates(List<ApplicationGatewayAuthenticationCertificate> authenticationCertificates) {
    this.authenticationCertificates = authenticationCertificates;
    return this;
  }

  public ApplicationGatewayPropertiesFormat addAuthenticationCertificatesItem(ApplicationGatewayAuthenticationCertificate authenticationCertificatesItem) {
  ...
  public void setAuthenticationCertificates(List<ApplicationGatewayAuthenticationCertificate> authenticationCertificates) {
    this.authenticationCertificates = authenticationCertificates;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationCertificates, backendAddressPools, backendHttpSettingsCollection, frontendIPConfigurations, frontendPorts, gatewayIPConfigurations, httpListeners, operationalState, probes, provisioningState, requestRoutingRules, resourceGuid, sku, sslCertificates, sslPolicy, urlPathMaps);
  }
      ...
      if (jsonObj.get("authenticationCertificates") != null && !jsonObj.get("authenticationCertificates").isJsonNull()) {
        ...
        if (jsonArrayauthenticationCertificates != null) {
          ...
          for (int i = 0; i < jsonArrayauthenticationCertificates.size(); i++) {
            ApplicationGatewayAuthenticationCertificate.validateJsonElement(jsonArrayauthenticationCertificates.get(i));
          };
        }
      }
