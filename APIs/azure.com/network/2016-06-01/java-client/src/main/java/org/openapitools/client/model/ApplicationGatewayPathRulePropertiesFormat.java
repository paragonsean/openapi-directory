...
public class ApplicationGatewayPathRulePropertiesFormat {
  ...
  public ApplicationGatewayPathRulePropertiesFormat backendAddressPool(SubResource backendAddressPool) {
  ...
  public ApplicationGatewayPathRulePropertiesFormat backendHttpSettings(SubResource backendHttpSettings) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backendAddressPool, backendHttpSettings, paths, provisioningState);
  }
