...
import org.openapitools.client.model.RouteTablePropertiesFormat;
...
public class RouteTable {
  ...
  private RouteTablePropertiesFormat properties;
  ...
  public RouteTable etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public RouteTable properties(RouteTablePropertiesFormat properties) {
   ...
   */
  @javax.annotation.Nullable
  public RouteTablePropertiesFormat getProperties() {
    return properties;
  }

  public void setProperties(RouteTablePropertiesFormat properties) {
    this.properties = properties;
  }


  public RouteTable id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RouteTable location(String location) {
  ...
  public RouteTable tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public RouteTable putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.etag, routeTable.etag) &&
        Objects.equals(this.properties, routeTable.properties) &&
        Objects.equals(this.id, routeTable.id) &&
        Objects.equals(this.location, routeTable.location) &&
        Objects.equals(this.name, routeTable.name) &&
        Objects.equals(this.tags, routeTable.tags) &&
        Objects.equals(this.type, routeTable.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        RouteTablePropertiesFormat.validateJsonElement(jsonObj.get("properties"));
      }
