...
public class NetworkInterfacesApi {
    ...
    /**
     * Build call for networkInterfacesGetEffectiveRouteTable
     * @param resourceGroupName The name of the resource group. (required)
     * @param networkInterfaceName The name of the network interface. (required)
     * @param apiVersion Client Api Version. (required)
     * @param subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     ...
     */
    public okhttp3.Call networkInterfacesGetEffectiveRouteTableCall(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/effectiveRouteTable"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "networkInterfaceName" + "}", localVarApiClient.escapeString(networkInterfaceName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call networkInterfacesGetEffectiveRouteTableValidateBeforeCall(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling networkInterfacesGetEffectiveRouteTable(Async)");
        }

        // verify the required parameter 'networkInterfaceName' is set
        if (networkInterfaceName == null) {
            throw new ApiException("Missing the required parameter 'networkInterfaceName' when calling networkInterfacesGetEffectiveRouteTable(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling networkInterfacesGetEffectiveRouteTable(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling networkInterfacesGetEffectiveRouteTable(Async)");
        }

        return networkInterfacesGetEffectiveRouteTableCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, _callback);
     ...
     */
    public EffectiveRouteListResult networkInterfacesGetEffectiveRouteTable(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<EffectiveRouteListResult> localVarResp = networkInterfacesGetEffectiveRouteTableWithHttpInfo(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion Client Api Version. (required)
     * @param subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @return ApiResponse&lt;EffectiveRouteListResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<EffectiveRouteListResult> networkInterfacesGetEffectiveRouteTableWithHttpInfo(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = networkInterfacesGetEffectiveRouteTableValidateBeforeCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<EffectiveRouteListResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call networkInterfacesGetEffectiveRouteTableAsync(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback<EffectiveRouteListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = networkInterfacesGetEffectiveRouteTableValidateBeforeCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<EffectiveRouteListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for networkInterfacesListEffectiveNetworkSecurityGroups
     * @param resourceGroupName The name of the resource group. (required)
     * @param networkInterfaceName The name of the network interface. (required)
     * @param apiVersion Client Api Version. (required)
     * @param subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     ...
     */
    public okhttp3.Call networkInterfacesListEffectiveNetworkSecurityGroupsCall(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/effectiveNetworkSecurityGroups"
            .replace("{" + "resourceGroupName" + "}", localVarApiClient.escapeString(resourceGroupName.toString()))
            .replace("{" + "networkInterfaceName" + "}", localVarApiClient.escapeString(networkInterfaceName.toString()))
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call networkInterfacesListEffectiveNetworkSecurityGroupsValidateBeforeCall(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling networkInterfacesListEffectiveNetworkSecurityGroups(Async)");
        }

        // verify the required parameter 'networkInterfaceName' is set
        if (networkInterfaceName == null) {
            throw new ApiException("Missing the required parameter 'networkInterfaceName' when calling networkInterfacesListEffectiveNetworkSecurityGroups(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling networkInterfacesListEffectiveNetworkSecurityGroups(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling networkInterfacesListEffectiveNetworkSecurityGroups(Async)");
        }

        return networkInterfacesListEffectiveNetworkSecurityGroupsCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, _callback);
     ...
     */
    public EffectiveNetworkSecurityGroupListResult networkInterfacesListEffectiveNetworkSecurityGroups(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<EffectiveNetworkSecurityGroupListResult> localVarResp = networkInterfacesListEffectiveNetworkSecurityGroupsWithHttpInfo(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     * @param apiVersion Client Api Version. (required)
     * @param subscriptionId Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     * @return ApiResponse&lt;EffectiveNetworkSecurityGroupListResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<EffectiveNetworkSecurityGroupListResult> networkInterfacesListEffectiveNetworkSecurityGroupsWithHttpInfo(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = networkInterfacesListEffectiveNetworkSecurityGroupsValidateBeforeCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<EffectiveNetworkSecurityGroupListResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call networkInterfacesListEffectiveNetworkSecurityGroupsAsync(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback<EffectiveNetworkSecurityGroupListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = networkInterfacesListEffectiveNetworkSecurityGroupsValidateBeforeCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<EffectiveNetworkSecurityGroupListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
