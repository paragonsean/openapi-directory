...
public class EffectiveNetworkSecurityRule {
  ...
  public EffectiveNetworkSecurityRule access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public EffectiveNetworkSecurityRule destinationAddressPrefix(String destinationAddressPrefix) {
  ...
  public EffectiveNetworkSecurityRule destinationPortRange(String destinationPortRange) {
  ...
  public EffectiveNetworkSecurityRule direction(DirectionEnum direction) {
  ...
  public EffectiveNetworkSecurityRule expandedDestinationAddressPrefix(List<String> expandedDestinationAddressPrefix) {
    this.expandedDestinationAddressPrefix = expandedDestinationAddressPrefix;
    return this;
  }

  public EffectiveNetworkSecurityRule addExpandedDestinationAddressPrefixItem(String expandedDestinationAddressPrefixItem) {
  ...
  public EffectiveNetworkSecurityRule expandedSourceAddressPrefix(List<String> expandedSourceAddressPrefix) {
    this.expandedSourceAddressPrefix = expandedSourceAddressPrefix;
    return this;
  }

  public EffectiveNetworkSecurityRule addExpandedSourceAddressPrefixItem(String expandedSourceAddressPrefixItem) {
  ...
  public EffectiveNetworkSecurityRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EffectiveNetworkSecurityRule priority(Integer priority) {
  ...
  public EffectiveNetworkSecurityRule protocol(ProtocolEnum protocol) {
  ...
  public EffectiveNetworkSecurityRule sourceAddressPrefix(String sourceAddressPrefix) {
  ...
  public EffectiveNetworkSecurityRule sourcePortRange(String sourcePortRange) {
  ...
  public boolean equals(Object o) {
    ...
    EffectiveNetworkSecurityRule effectiveNetworkSecurityRule = (EffectiveNetworkSecurityRule) o;
    return Objects.equals(this.access, effectiveNetworkSecurityRule.access) &&
        Objects.equals(this.destinationAddressPrefix, effectiveNetworkSecurityRule.destinationAddressPrefix) &&
        Objects.equals(this.destinationPortRange, effectiveNetworkSecurityRule.destinationPortRange) &&
        Objects.equals(this.direction, effectiveNetworkSecurityRule.direction) &&
        Objects.equals(this.expandedDestinationAddressPrefix, effectiveNetworkSecurityRule.expandedDestinationAddressPrefix) &&
        Objects.equals(this.expandedSourceAddressPrefix, effectiveNetworkSecurityRule.expandedSourceAddressPrefix) &&
        Objects.equals(this.name, effectiveNetworkSecurityRule.name) &&
        Objects.equals(this.priority, effectiveNetworkSecurityRule.priority) &&
        Objects.equals(this.protocol, effectiveNetworkSecurityRule.protocol) &&
        Objects.equals(this.sourceAddressPrefix, effectiveNetworkSecurityRule.sourceAddressPrefix) &&
        Objects.equals(this.sourcePortRange, effectiveNetworkSecurityRule.sourcePortRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectiveNetworkSecurityRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectiveNetworkSecurityRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectiveNetworkSecurityRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EffectiveNetworkSecurityRule is not found in the empty JSON string", EffectiveNetworkSecurityRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EffectiveNetworkSecurityRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EffectiveNetworkSecurityRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectiveNetworkSecurityRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectiveNetworkSecurityRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectiveNetworkSecurityRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectiveNetworkSecurityRule.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectiveNetworkSecurityRule>() {
           @Override
           public void write(JsonWriter out, EffectiveNetworkSecurityRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EffectiveNetworkSecurityRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EffectiveNetworkSecurityRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectiveNetworkSecurityRule
   * @throws IOException if the JSON string is invalid with respect to EffectiveNetworkSecurityRule
   */
  public static EffectiveNetworkSecurityRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectiveNetworkSecurityRule.class);
  }

  /**
   * Convert an instance of EffectiveNetworkSecurityRule to an JSON string
   *
   * @return JSON string
   */
