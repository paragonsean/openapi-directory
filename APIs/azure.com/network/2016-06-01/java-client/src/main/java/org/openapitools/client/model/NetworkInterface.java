...
public class NetworkInterface {
  ...
  private NetworkInterfacePropertiesFormat properties;
  ...
  public NetworkInterface etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public NetworkInterface properties(NetworkInterfacePropertiesFormat properties) {
   ...
   */
  @javax.annotation.Nullable
  public NetworkInterfacePropertiesFormat getProperties() {
    return properties;
  }

  public void setProperties(NetworkInterfacePropertiesFormat properties) {
    this.properties = properties;
  }
  ...
  public NetworkInterface location(String location) {
  ...
  public NetworkInterface tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public NetworkInterface putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.etag, networkInterface.etag) &&
        Objects.equals(this.properties, networkInterface.properties) &&
        Objects.equals(this.id, networkInterface.id) &&
        Objects.equals(this.location, networkInterface.location) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        NetworkInterfacePropertiesFormat.validateJsonElement(jsonObj.get("properties"));
      }
