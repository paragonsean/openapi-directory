...
import org.openapitools.client.model.LoadBalancerPropertiesFormat;
...
public class LoadBalancer {
  ...
  public LoadBalancer etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public LoadBalancer properties(LoadBalancerPropertiesFormat properties) {
  ...
  public void setProperties(LoadBalancerPropertiesFormat properties) {
    this.properties = properties;
  }
  ...
  public LoadBalancer location(String location) {
  ...
  public LoadBalancer tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public LoadBalancer putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.etag, loadBalancer.etag) &&
        Objects.equals(this.properties, loadBalancer.properties) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        LoadBalancerPropertiesFormat.validateJsonElement(jsonObj.get("properties"));
      }
