...
public class ApplicationGatewayBackendHttpSettingsPropertiesFormat {
  ...
  private List<SubResource> authenticationCertificates = new ArrayList<>();
  ...
  public ApplicationGatewayBackendHttpSettingsPropertiesFormat authenticationCertificates(List<SubResource> authenticationCertificates) {
    this.authenticationCertificates = authenticationCertificates;
    return this;
  }

  public ApplicationGatewayBackendHttpSettingsPropertiesFormat addAuthenticationCertificatesItem(SubResource authenticationCertificatesItem) {
  ...
  public void setAuthenticationCertificates(List<SubResource> authenticationCertificates) {
    this.authenticationCertificates = authenticationCertificates;
  }
      ...
      if (jsonObj.get("authenticationCertificates") != null && !jsonObj.get("authenticationCertificates").isJsonNull()) {
        ...
        if (jsonArrayauthenticationCertificates != null) {
          ...
          for (int i = 0; i < jsonArrayauthenticationCertificates.size(); i++) {
            SubResource.validateJsonElement(jsonArrayauthenticationCertificates.get(i));
          };
        }
      }
