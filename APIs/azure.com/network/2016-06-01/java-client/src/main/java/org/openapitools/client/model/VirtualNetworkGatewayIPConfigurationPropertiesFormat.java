...
public class VirtualNetworkGatewayIPConfigurationPropertiesFormat {
  ...
  public VirtualNetworkGatewayIPConfigurationPropertiesFormat provisioningState(String provisioningState) {
  ...
  public VirtualNetworkGatewayIPConfigurationPropertiesFormat publicIPAddress(SubResource publicIPAddress) {
  ...
  public VirtualNetworkGatewayIPConfigurationPropertiesFormat subnet(SubResource subnet) {
    this.subnet = subnet;
    return this;
  }
