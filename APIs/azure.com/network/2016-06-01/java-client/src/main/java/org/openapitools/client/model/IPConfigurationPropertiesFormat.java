...
public class IPConfigurationPropertiesFormat {
  ...
  public IPConfigurationPropertiesFormat privateIPAddress(String privateIPAddress) {
  ...
  public IPConfigurationPropertiesFormat privateIPAllocationMethod(PrivateIPAllocationMethodEnum privateIPAllocationMethod) {
  ...
  public IPConfigurationPropertiesFormat provisioningState(String provisioningState) {
  ...
  public IPConfigurationPropertiesFormat publicIPAddress(PublicIPAddress publicIPAddress) {
  ...
  public IPConfigurationPropertiesFormat subnet(Subnet subnet) {
    this.subnet = subnet;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPConfigurationPropertiesFormat ipConfigurationPropertiesFormat = (IPConfigurationPropertiesFormat) o;
    return Objects.equals(this.privateIPAddress, ipConfigurationPropertiesFormat.privateIPAddress) &&
        Objects.equals(this.privateIPAllocationMethod, ipConfigurationPropertiesFormat.privateIPAllocationMethod) &&
        Objects.equals(this.provisioningState, ipConfigurationPropertiesFormat.provisioningState) &&
        Objects.equals(this.publicIPAddress, ipConfigurationPropertiesFormat.publicIPAddress) &&
        Objects.equals(this.subnet, ipConfigurationPropertiesFormat.subnet);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPConfigurationPropertiesFormat {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPConfigurationPropertiesFormat
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPConfigurationPropertiesFormat.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPConfigurationPropertiesFormat is not found in the empty JSON string", IPConfigurationPropertiesFormat.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPConfigurationPropertiesFormat.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPConfigurationPropertiesFormat` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPConfigurationPropertiesFormat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPConfigurationPropertiesFormat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPConfigurationPropertiesFormat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPConfigurationPropertiesFormat.class));

       return (TypeAdapter<T>) new TypeAdapter<IPConfigurationPropertiesFormat>() {
           @Override
           public void write(JsonWriter out, IPConfigurationPropertiesFormat value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPConfigurationPropertiesFormat read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPConfigurationPropertiesFormat given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPConfigurationPropertiesFormat
   * @throws IOException if the JSON string is invalid with respect to IPConfigurationPropertiesFormat
   */
  public static IPConfigurationPropertiesFormat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPConfigurationPropertiesFormat.class);
  }

  /**
   * Convert an instance of IPConfigurationPropertiesFormat to an JSON string
   *
   * @return JSON string
   */
