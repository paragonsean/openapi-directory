...
# **routeTablesGet**
> RouteTable routeTablesGet(resourceGroupName, routeTableName, apiVersion, subscriptionId, $expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      RouteTable result = apiInstance.routeTablesGet(resourceGroupName, routeTableName, apiVersion, subscriptionId, $expand);
      System.out.println(result);
    } catch (ApiException e) {
