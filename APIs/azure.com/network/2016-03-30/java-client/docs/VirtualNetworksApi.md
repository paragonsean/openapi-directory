...
# **virtualNetworksGet**
> VirtualNetwork virtualNetworksGet(resourceGroupName, virtualNetworkName, apiVersion, subscriptionId, $expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      VirtualNetwork result = apiInstance.virtualNetworksGet(resourceGroupName, virtualNetworkName, apiVersion, subscriptionId, $expand);
      System.out.println(result);
    } catch (ApiException e) {
