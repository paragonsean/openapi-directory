...
public class InboundNatRulePropertiesFormat {
  ...
  public InboundNatRulePropertiesFormat backendIPConfiguration(NetworkInterfaceIPConfiguration backendIPConfiguration) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("backendIPConfiguration") != null && !jsonObj.get("backendIPConfiguration").isJsonNull()) {
        NetworkInterfaceIPConfiguration.validateJsonElement(jsonObj.get("backendIPConfiguration"));
      }
