...
public class ApplicationGatewayBackendHttpSettingsPropertiesFormat {
  ...
  public ApplicationGatewayBackendHttpSettingsPropertiesFormat probe(SubResource probe) {
    this.probe = probe;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cookieBasedAffinity, port, probe, protocol, provisioningState, requestTimeout);
  }
