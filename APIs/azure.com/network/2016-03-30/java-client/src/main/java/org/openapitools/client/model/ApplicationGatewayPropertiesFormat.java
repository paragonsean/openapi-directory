...
public class ApplicationGatewayPropertiesFormat {
  ...
  private List<ApplicationGatewayProbe> probes = new ArrayList<>();
  ...
  private List<ApplicationGatewayUrlPathMap> urlPathMaps = new ArrayList<>();
  ...
  public ApplicationGatewayPropertiesFormat probes(List<ApplicationGatewayProbe> probes) {
    this.probes = probes;
    return this;
  }

  public ApplicationGatewayPropertiesFormat addProbesItem(ApplicationGatewayProbe probesItem) {
    if (this.probes == null) {
  ...
  public ApplicationGatewayPropertiesFormat urlPathMaps(List<ApplicationGatewayUrlPathMap> urlPathMaps) {
    this.urlPathMaps = urlPathMaps;
    return this;
  }

  public ApplicationGatewayPropertiesFormat addUrlPathMapsItem(ApplicationGatewayUrlPathMap urlPathMapsItem) {
      ...
      if (jsonObj.get("probes") != null && !jsonObj.get("probes").isJsonNull()) {
        ...
        if (jsonArrayprobes != null) {
          ...
          for (int i = 0; i < jsonArrayprobes.size(); i++) {
            ApplicationGatewayProbe.validateJsonElement(jsonArrayprobes.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("urlPathMaps") != null && !jsonObj.get("urlPathMaps").isJsonNull()) {
        ...
        if (jsonArrayurlPathMaps != null) {
          ...
          for (int i = 0; i < jsonArrayurlPathMaps.size(); i++) {
            ApplicationGatewayUrlPathMap.validateJsonElement(jsonArrayurlPathMaps.get(i));
          };
        }
      }
  }
