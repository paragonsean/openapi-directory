...
public class SecurityRulePropertiesFormat {
  ...
  public SecurityRulePropertiesFormat access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public SecurityRulePropertiesFormat description(String description) {
  ...
  public SecurityRulePropertiesFormat destinationAddressPrefix(String destinationAddressPrefix) {
  ...
  public SecurityRulePropertiesFormat destinationPortRange(String destinationPortRange) {
  ...
  public SecurityRulePropertiesFormat direction(DirectionEnum direction) {
  ...
  public SecurityRulePropertiesFormat priority(Integer priority) {
  ...
  public SecurityRulePropertiesFormat protocol(ProtocolEnum protocol) {
  ...
  public SecurityRulePropertiesFormat provisioningState(String provisioningState) {
  ...
  public SecurityRulePropertiesFormat sourceAddressPrefix(String sourceAddressPrefix) {
  ...
  public SecurityRulePropertiesFormat sourcePortRange(String sourcePortRange) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityRulePropertiesFormat securityRulePropertiesFormat = (SecurityRulePropertiesFormat) o;
    return Objects.equals(this.access, securityRulePropertiesFormat.access) &&
        Objects.equals(this.description, securityRulePropertiesFormat.description) &&
        Objects.equals(this.destinationAddressPrefix, securityRulePropertiesFormat.destinationAddressPrefix) &&
        Objects.equals(this.destinationPortRange, securityRulePropertiesFormat.destinationPortRange) &&
        Objects.equals(this.direction, securityRulePropertiesFormat.direction) &&
        Objects.equals(this.priority, securityRulePropertiesFormat.priority) &&
        Objects.equals(this.protocol, securityRulePropertiesFormat.protocol) &&
        Objects.equals(this.provisioningState, securityRulePropertiesFormat.provisioningState) &&
        Objects.equals(this.sourceAddressPrefix, securityRulePropertiesFormat.sourceAddressPrefix) &&
        Objects.equals(this.sourcePortRange, securityRulePropertiesFormat.sourcePortRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class SecurityRulePropertiesFormat {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecurityRulePropertiesFormat
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityRulePropertiesFormat.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecurityRulePropertiesFormat is not found in the empty JSON string", SecurityRulePropertiesFormat.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecurityRulePropertiesFormat.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecurityRulePropertiesFormat` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SecurityRulePropertiesFormat.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SecurityRulePropertiesFormat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SecurityRulePropertiesFormat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SecurityRulePropertiesFormat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SecurityRulePropertiesFormat.class));

       return (TypeAdapter<T>) new TypeAdapter<SecurityRulePropertiesFormat>() {
           @Override
           public void write(JsonWriter out, SecurityRulePropertiesFormat value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SecurityRulePropertiesFormat read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SecurityRulePropertiesFormat given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SecurityRulePropertiesFormat
   * @throws IOException if the JSON string is invalid with respect to SecurityRulePropertiesFormat
   */
  public static SecurityRulePropertiesFormat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SecurityRulePropertiesFormat.class);
  }

  /**
   * Convert an instance of SecurityRulePropertiesFormat to an JSON string
   *
   * @return JSON string
   */
