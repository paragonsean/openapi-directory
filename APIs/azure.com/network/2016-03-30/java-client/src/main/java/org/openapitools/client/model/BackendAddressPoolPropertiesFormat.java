...
public class BackendAddressPoolPropertiesFormat {
  ...
  public BackendAddressPoolPropertiesFormat backendIPConfigurations(List<NetworkInterfaceIPConfiguration> backendIPConfigurations) {
    this.backendIPConfigurations = backendIPConfigurations;
    return this;
  }

  public BackendAddressPoolPropertiesFormat addBackendIPConfigurationsItem(NetworkInterfaceIPConfiguration backendIPConfigurationsItem) {
