...
class ApplicationGatewayBackendAddressPoolPropertiesFormat(Model):
    ...
    def __init__(self, backend_addresses: List[ApplicationGatewayBackendAddress]=None, backend_ip_configurations: List[NetworkInterfaceIPConfiguration]=None, provisioning_state: str=None):
