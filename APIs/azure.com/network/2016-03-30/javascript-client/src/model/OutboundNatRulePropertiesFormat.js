...
class OutboundNatRulePropertiesFormat {
     ...
     */
    constructor(backendAddressPool) { 
        
        OutboundNatRulePropertiesFormat.initialize(this, backendAddressPool);
    }
     ...
     */
    static initialize(obj, backendAddressPool) { 
...
OutboundNatRulePropertiesFormat.RequiredProperties = ["backendAddressPool"];
