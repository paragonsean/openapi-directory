...
class InboundNatPoolPropertiesFormat {
     ...
     * @param protocol {module:model/InboundNatPoolPropertiesFormat.ProtocolEnum} Gets or sets the transport protocol for the external endpoint. Possible values are Udp or Tcp
     */
