...
class InboundNatPool {
    ...
    constructor() { 
        ...
        InboundNatPool.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = InboundNatPoolPropertiesFormat.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          InboundNatPoolPropertiesFormat.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
InboundNatPool.prototype['etag'] = undefined;
...
/**
 * @member {module:model/InboundNatPoolPropertiesFormat} properties
 */
InboundNatPool.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
InboundNatPool.prototype['id'] = undefined;
