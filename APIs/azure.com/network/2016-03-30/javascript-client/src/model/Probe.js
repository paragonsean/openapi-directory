...
class Probe {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ProbePropertiesFormat.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ProbePropertiesFormat.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
Probe.prototype['etag'] = undefined;

/**
 * Gets name of the resource that is unique within a resource group. This name can be used to access the resource
 * @member {String} name
 */
Probe.prototype['name'] = undefined;

/**
 * @member {module:model/ProbePropertiesFormat} properties
 */
Probe.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
Probe.prototype['id'] = undefined;
