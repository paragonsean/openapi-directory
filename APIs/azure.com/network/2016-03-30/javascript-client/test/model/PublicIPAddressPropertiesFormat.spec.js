...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.PublicIPAddressPropertiesFormat();
  });
  ...
  describe('PublicIPAddressPropertiesFormat', function() {
    it('should create an instance of PublicIPAddressPropertiesFormat', function() {
      // uncomment below and update the code to test PublicIPAddressPropertiesFormat
      //var instance = new NetworkManagementClient.PublicIPAddressPropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.PublicIPAddressPropertiesFormat);
    });
