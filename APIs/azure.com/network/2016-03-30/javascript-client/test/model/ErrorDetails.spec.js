...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new NetworkManagementClient.ErrorDetails();
      //expect(instance).to.be.a(NetworkManagementClient.ErrorDetails);
    });
