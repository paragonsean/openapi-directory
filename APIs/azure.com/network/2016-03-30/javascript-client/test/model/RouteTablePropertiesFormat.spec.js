...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.RouteTablePropertiesFormat();
  });
  ...
  describe('RouteTablePropertiesFormat', function() {
    it('should create an instance of RouteTablePropertiesFormat', function() {
      // uncomment below and update the code to test RouteTablePropertiesFormat
      //var instance = new NetworkManagementClient.RouteTablePropertiesFormat();
      //expect(instance).to.be.a(NetworkManagementClient.RouteTablePropertiesFormat);
    });
