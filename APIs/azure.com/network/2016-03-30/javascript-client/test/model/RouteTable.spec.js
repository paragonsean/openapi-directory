...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.RouteTable();
  });
  ...
  describe('RouteTable', function() {
    it('should create an instance of RouteTable', function() {
      ...
      //var instance = new NetworkManagementClient.RouteTable();
      //expect(instance).to.be.a(NetworkManagementClient.RouteTable);
    });
