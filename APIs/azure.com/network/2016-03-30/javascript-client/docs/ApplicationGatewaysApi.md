...
let parameters = new NetworkManagementClient.ApplicationGateway(); // ApplicationGateway | Parameters supplied to the create/delete ApplicationGateway operation
