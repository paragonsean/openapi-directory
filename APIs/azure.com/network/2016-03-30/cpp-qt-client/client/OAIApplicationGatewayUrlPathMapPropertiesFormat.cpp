...
OAISubResource OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendAddressPool() const {
    return m_default_backend_address_pool;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendAddressPool(const OAISubResource &default_backend_address_pool) {
...
OAISubResource OAIApplicationGatewayUrlPathMapPropertiesFormat::getDefaultBackendHttpSettings() const {
    return m_default_backend_http_settings;
}
void OAIApplicationGatewayUrlPathMapPropertiesFormat::setDefaultBackendHttpSettings(const OAISubResource &default_backend_http_settings) {
