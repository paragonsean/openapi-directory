...
namespace OpenAPI {
class OAIIPConfigurationPropertiesFormat;
...
public:
    ...
    OAIIPConfigurationPropertiesFormat getProperties() const;
    void setProperties(const OAIIPConfigurationPropertiesFormat &properties);
...
private:
    ...
    OAIIPConfigurationPropertiesFormat m_properties;
