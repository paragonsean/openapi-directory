...
OAIAddressSpace OAILocalNetworkGatewayPropertiesFormat::getLocalNetworkAddressSpace() const {
    return m_local_network_address_space;
}
void OAILocalNetworkGatewayPropertiesFormat::setLocalNetworkAddressSpace(const OAIAddressSpace &local_network_address_space) {
