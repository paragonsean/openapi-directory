...
namespace OpenAPI {
class OAISubnetPropertiesFormat;
...
public:
    ...
    OAISubnetPropertiesFormat getProperties() const;
    void setProperties(const OAISubnetPropertiesFormat &properties);
...
private:
    ...
    OAISubnetPropertiesFormat m_properties;
