...
public:
    ...
    */
    virtual void subnetsGet(const QString &resource_group_name, const QString &virtual_network_name, const QString &subnet_name, const QString &api_version, const QString &subscription_id, const ::OpenAPI::OptionalParam<QString> &expand = ::OpenAPI::OptionalParam<QString>());
