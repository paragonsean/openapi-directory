...
QString OAIInboundNatPool::getEtag() const {
    return m_etag;
}
void OAIInboundNatPool::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIInboundNatPool::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIInboundNatPool::is_etag_Valid() const{
...
OAIInboundNatPoolPropertiesFormat OAIInboundNatPool::getProperties() const {
    return m_properties;
}
void OAIInboundNatPool::setProperties(const OAIInboundNatPoolPropertiesFormat &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIInboundNatPool::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIInboundNatPool::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIInboundNatPool::getId() const {
    return m_id;
}
void OAIInboundNatPool::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInboundNatPool::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInboundNatPool::is_id_Valid() const{
    return m_id_isValid;
}
