...
QList<OAINetworkInterfaceIPConfiguration> OAIApplicationGatewayBackendAddressPoolPropertiesFormat::getBackendIpConfigurations() const {
    return m_backend_ip_configurations;
}
void OAIApplicationGatewayBackendAddressPoolPropertiesFormat::setBackendIpConfigurations(const QList<OAINetworkInterfaceIPConfiguration> &backend_ip_configurations) {
