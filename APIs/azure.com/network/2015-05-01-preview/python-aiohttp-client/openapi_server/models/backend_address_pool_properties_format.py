...
class BackendAddressPoolPropertiesFormat(Model):
    ...
    def __init__(self, backend_ip_configurations: List[SubResource]=None, load_balancing_rules: List[SubResource]=None, outbound_nat_rule: SubResource=None, provisioning_state: str=None):
        ...
        """
        self.openapi_types = {
            'backend_ip_configurations': List[SubResource],
    ...
    def backend_ip_configurations(self, backend_ip_configurations):
        ...
        :param backend_ip_configurations: The backend_ip_configurations of this BackendAddressPoolPropertiesFormat.
        :type backend_ip_configurations: List[SubResource]
        """
