...
class ApplicationGatewayBackendAddressPoolPropertiesFormat(Model):
    ...
    def __init__(self, backend_addresses: List[ApplicationGatewayBackendAddress]=None, backend_ip_configurations: List[SubResource]=None, provisioning_state: str=None):
