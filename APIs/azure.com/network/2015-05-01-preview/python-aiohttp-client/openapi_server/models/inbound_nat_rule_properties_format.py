...
class InboundNatRulePropertiesFormat(Model):
    ...
    def __init__(self, backend_ip_configuration: SubResource=None, backend_port: int=None, enable_floating_ip: bool=None, frontend_ip_configuration: SubResource=None, frontend_port: int=None, idle_timeout_in_minutes: int=None, protocol: str=None, provisioning_state: str=None):
        ...
        """
        self.openapi_types = {
            'backend_ip_configuration': SubResource,
            'backend_port': int,
    ...
    def backend_ip_configuration(self, backend_ip_configuration):
        ...
        :param backend_ip_configuration: The backend_ip_configuration of this InboundNatRulePropertiesFormat.
        :type backend_ip_configuration: SubResource
        """
