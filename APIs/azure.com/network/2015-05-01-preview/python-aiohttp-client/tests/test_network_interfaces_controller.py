...
async def test_network_interfaces_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","properties":{"ipConfigurations":[{"name":"name","etag":"etag","properties":{"subnet":{"id":"id"},"loadBalancerInboundNatRules":[{"id":"id"},{"id":"id"}],"privateIPAllocationMethod":"Static","privateIPAddress":"privateIPAddress","provisioningState":"provisioningState","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"publicIPAddress":{"id":"id"}}},{"name":"name","etag":"etag","properties":{"subnet":{"id":"id"},"loadBalancerInboundNatRules":[{"id":"id"},{"id":"id"}],"privateIPAllocationMethod":"Static","privateIPAddress":"privateIPAddress","provisioningState":"provisioningState","loadBalancerBackendAddressPools":[{"id":"id"},{"id":"id"}],"publicIPAddress":{"id":"id"}}}],"virtualMachine":{"id":"id"},"macAddress":"macAddress","dnsSettings":{"appliedDnsServers":["appliedDnsServers","appliedDnsServers"],"internalDnsNameLabel":"internalDnsNameLabel","internalFqdn":"internalFqdn","dnsServers":["dnsServers","dnsServers"]},"resourceGuid":"resourceGuid","provisioningState":"provisioningState","enableIPForwarding":True,"networkSecurityGroup":{"id":"id"},"primary":True}}
