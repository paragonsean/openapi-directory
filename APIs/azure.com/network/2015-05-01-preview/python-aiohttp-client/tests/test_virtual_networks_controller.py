...
async def test_virtual_networks_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","properties":{"resourceGuid":"resourceGuid","addressSpace":{"addressPrefixes":["addressPrefixes","addressPrefixes"]},"dhcpOptions":{"dnsServers":["dnsServers","dnsServers"]},"subnets":[{"name":"name","etag":"etag","properties":{"ipConfigurations":[{"id":"id"},{"id":"id"}],"routeTable":{"id":"id"},"addressPrefix":"addressPrefix","provisioningState":"provisioningState","networkSecurityGroup":{"id":"id"}}},{"name":"name","etag":"etag","properties":{"ipConfigurations":[{"id":"id"},{"id":"id"}],"routeTable":{"id":"id"},"addressPrefix":"addressPrefix","provisioningState":"provisioningState","networkSecurityGroup":{"id":"id"}}}],"provisioningState":"provisioningState"}}
