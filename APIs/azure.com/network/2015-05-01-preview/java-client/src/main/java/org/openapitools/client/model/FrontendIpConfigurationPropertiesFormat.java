...
public class FrontendIpConfigurationPropertiesFormat {
  ...
  public FrontendIpConfigurationPropertiesFormat publicIPAddress(SubResource publicIPAddress) {
  ...
  public FrontendIpConfigurationPropertiesFormat subnet(SubResource subnet) {
    this.subnet = subnet;
    return this;
  }
