...
public class SubnetsApi {
     ...
     */
    public okhttp3.Call subnetsGetCall(String resourceGroupName, String virtualNetworkName, String subnetName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call subnetsGetValidateBeforeCall(String resourceGroupName, String virtualNetworkName, String subnetName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return subnetsGetCall(resourceGroupName, virtualNetworkName, subnetName, apiVersion, subscriptionId, _callback);
     ...
     */
    public Subnet subnetsGet(String resourceGroupName, String virtualNetworkName, String subnetName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<Subnet> localVarResp = subnetsGetWithHttpInfo(resourceGroupName, virtualNetworkName, subnetName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Subnet> subnetsGetWithHttpInfo(String resourceGroupName, String virtualNetworkName, String subnetName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = subnetsGetValidateBeforeCall(resourceGroupName, virtualNetworkName, subnetName, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<Subnet>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call subnetsGetAsync(String resourceGroupName, String virtualNetworkName, String subnetName, String apiVersion, String subscriptionId, final ApiCallback<Subnet> _callback) throws ApiException {

        okhttp3.Call localVarCall = subnetsGetValidateBeforeCall(resourceGroupName, virtualNetworkName, subnetName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<Subnet>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
