...
public class InboundNatPool {
  ...
  private InboundNatPoolPropertiesFormat properties;
  ...
  public InboundNatPool etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public InboundNatPool properties(InboundNatPoolPropertiesFormat properties) {
   ...
   */
  @javax.annotation.Nullable
  public InboundNatPoolPropertiesFormat getProperties() {
    return properties;
  }

  public void setProperties(InboundNatPoolPropertiesFormat properties) {
    this.properties = properties;
  }


  public InboundNatPool id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.etag, inboundNatPool.etag) &&
        Objects.equals(this.name, inboundNatPool.name) &&
        Objects.equals(this.properties, inboundNatPool.properties) &&
        Objects.equals(this.id, inboundNatPool.id);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        InboundNatPoolPropertiesFormat.validateJsonElement(jsonObj.get("properties"));
      }
