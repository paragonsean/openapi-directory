...
public class RouteTablePropertiesFormat {
  ...
  private List<SubResource> subnets = new ArrayList<>();
  ...
  public RouteTablePropertiesFormat subnets(List<SubResource> subnets) {
    this.subnets = subnets;
    return this;
  }

  public RouteTablePropertiesFormat addSubnetsItem(SubResource subnetsItem) {
  ...
  public void setSubnets(List<SubResource> subnets) {
    this.subnets = subnets;
  }
      ...
      if (jsonObj.get("subnets") != null && !jsonObj.get("subnets").isJsonNull()) {
        ...
        if (jsonArraysubnets != null) {
          ...
          for (int i = 0; i < jsonArraysubnets.size(); i++) {
            SubResource.validateJsonElement(jsonArraysubnets.get(i));
          };
        }
      }
  }
