...
public class NetworkSecurityGroupPropertiesFormat {
  ...
  private List<SubResource> networkInterfaces = new ArrayList<>();
  ...
  public NetworkSecurityGroupPropertiesFormat networkInterfaces(List<SubResource> networkInterfaces) {
    this.networkInterfaces = networkInterfaces;
    return this;
  }

  public NetworkSecurityGroupPropertiesFormat addNetworkInterfacesItem(SubResource networkInterfacesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SubResource> getNetworkInterfaces() {
    return networkInterfaces;
  }

  public void setNetworkInterfaces(List<SubResource> networkInterfaces) {
    this.networkInterfaces = networkInterfaces;
  }
  ...
  public NetworkSecurityGroupPropertiesFormat subnets(List<SubResource> subnets) {
    this.subnets = subnets;
    return this;
  }

  public NetworkSecurityGroupPropertiesFormat addSubnetsItem(SubResource subnetsItem) {
      ...
      if (jsonObj.get("networkInterfaces") != null && !jsonObj.get("networkInterfaces").isJsonNull()) {
        ...
        if (jsonArraynetworkInterfaces != null) {
          ...
          for (int i = 0; i < jsonArraynetworkInterfaces.size(); i++) {
            SubResource.validateJsonElement(jsonArraynetworkInterfaces.get(i));
          };
        }
      }
