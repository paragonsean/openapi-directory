...
public class NetworkInterfacesApi {
     ...
     */
    public okhttp3.Call networkInterfacesGetCall(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call networkInterfacesGetValidateBeforeCall(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return networkInterfacesGetCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, _callback);
     ...
     */
    public NetworkInterface networkInterfacesGet(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<NetworkInterface> localVarResp = networkInterfacesGetWithHttpInfo(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NetworkInterface> networkInterfacesGetWithHttpInfo(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = networkInterfacesGetValidateBeforeCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<NetworkInterface>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call networkInterfacesGetAsync(String resourceGroupName, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback<NetworkInterface> _callback) throws ApiException {

        okhttp3.Call localVarCall = networkInterfacesGetValidateBeforeCall(resourceGroupName, networkInterfaceName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<NetworkInterface>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceCall(String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceValidateBeforeCall(String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
        ...
        return networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceCall(resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, apiVersion, subscriptionId, _callback);
     ...
     */
    public NetworkInterface networkInterfacesGetVirtualMachineScaleSetNetworkInterface(String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<NetworkInterface> localVarResp = networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceWithHttpInfo(resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, apiVersion, subscriptionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NetworkInterface> networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceWithHttpInfo(String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex, String networkInterfaceName, String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceValidateBeforeCall(resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<NetworkInterface>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceAsync(String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex, String networkInterfaceName, String apiVersion, String subscriptionId, final ApiCallback<NetworkInterface> _callback) throws ApiException {

        okhttp3.Call localVarCall = networkInterfacesGetVirtualMachineScaleSetNetworkInterfaceValidateBeforeCall(resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, apiVersion, subscriptionId, _callback);
        Type localVarReturnType = new TypeToken<NetworkInterface>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
