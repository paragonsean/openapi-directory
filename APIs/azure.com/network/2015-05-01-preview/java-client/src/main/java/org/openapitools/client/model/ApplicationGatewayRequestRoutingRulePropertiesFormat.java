...
public class ApplicationGatewayRequestRoutingRulePropertiesFormat {
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat backendAddressPool(SubResource backendAddressPool) {
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat backendHttpSettings(SubResource backendHttpSettings) {
  ...
  public ApplicationGatewayRequestRoutingRulePropertiesFormat httpListener(SubResource httpListener) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backendAddressPool, backendHttpSettings, httpListener, provisioningState, ruleType);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("backendHttpSettings") != null && !jsonObj.get("backendHttpSettings").isJsonNull()) {
        SubResource.validateJsonElement(jsonObj.get("backendHttpSettings"));
      }
      // validate the optional field `httpListener`
      if (jsonObj.get("httpListener") != null && !jsonObj.get("httpListener").isJsonNull()) {
        SubResource.validateJsonElement(jsonObj.get("httpListener"));
      }
