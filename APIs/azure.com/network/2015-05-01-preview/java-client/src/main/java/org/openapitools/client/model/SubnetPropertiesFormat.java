...
public class SubnetPropertiesFormat {
  ...
  private List<SubResource> ipConfigurations = new ArrayList<>();
  ...
  public SubnetPropertiesFormat ipConfigurations(List<SubResource> ipConfigurations) {
    this.ipConfigurations = ipConfigurations;
    return this;
  }

  public SubnetPropertiesFormat addIpConfigurationsItem(SubResource ipConfigurationsItem) {
  ...
  public List<SubResource> getIpConfigurations() {
    return ipConfigurations;
  }

  public void setIpConfigurations(List<SubResource> ipConfigurations) {
    this.ipConfigurations = ipConfigurations;
  }


  public SubnetPropertiesFormat networkSecurityGroup(SubResource networkSecurityGroup) {
  ...
  public SubnetPropertiesFormat routeTable(SubResource routeTable) {
   ...
   */
  @javax.annotation.Nullable
  public SubResource getRouteTable() {
    return routeTable;
  }

  public void setRouteTable(SubResource routeTable) {
    this.routeTable = routeTable;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : SubnetPropertiesFormat.openapiRequiredFields) {
      ...
      if (jsonObj.get("ipConfigurations") != null && !jsonObj.get("ipConfigurations").isJsonNull()) {
        ...
        if (jsonArrayipConfigurations != null) {
          ...
          for (int i = 0; i < jsonArrayipConfigurations.size(); i++) {
            SubResource.validateJsonElement(jsonArrayipConfigurations.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("routeTable") != null && !jsonObj.get("routeTable").isJsonNull()) {
        SubResource.validateJsonElement(jsonObj.get("routeTable"));
      }
  }
