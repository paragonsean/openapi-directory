...
QList<OAISubResource> OAIBackendAddressPoolPropertiesFormat::getBackendIpConfigurations() const {
    return m_backend_ip_configurations;
}
void OAIBackendAddressPoolPropertiesFormat::setBackendIpConfigurations(const QList<OAISubResource> &backend_ip_configurations) {
