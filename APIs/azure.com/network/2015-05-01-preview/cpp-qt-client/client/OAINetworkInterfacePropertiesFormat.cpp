...
OAISubResource OAINetworkInterfacePropertiesFormat::getNetworkSecurityGroup() const {
    return m_network_security_group;
}
void OAINetworkInterfacePropertiesFormat::setNetworkSecurityGroup(const OAISubResource &network_security_group) {
