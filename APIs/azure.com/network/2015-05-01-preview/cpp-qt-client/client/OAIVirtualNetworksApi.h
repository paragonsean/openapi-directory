...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void virtualNetworksGet(const QString &resource_group_name, const QString &virtual_network_name, const QString &api_version, const QString &subscription_id);
