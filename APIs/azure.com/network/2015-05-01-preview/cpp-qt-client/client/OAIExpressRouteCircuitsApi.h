...
#include "OAIExpressRouteCircuitsRoutesTableListResult.h"
...
public:
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void expressRouteCircuitsListArpTable(const QString &resource_group_name, const QString &circuit_name, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void expressRouteCircuitsListRoutesTable(const QString &resource_group_name, const QString &circuit_name, const QString &api_version, const QString &subscription_id);
    ...
    * @param[in]  subscription_id QString [required]
    */
    virtual void expressRouteCircuitsListStats(const QString &resource_group_name, const QString &circuit_name, const QString &api_version, const QString &subscription_id);
...
private:
    ...
    void expressRouteCircuitsListArpTableCallback(OAIHttpRequestWorker *worker);
    void expressRouteCircuitsListRoutesTableCallback(OAIHttpRequestWorker *worker);
    void expressRouteCircuitsListStatsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void expressRouteCircuitsListArpTableSignal(OAIExpressRouteCircuitsArpTableListResult summary);
    void expressRouteCircuitsListRoutesTableSignal(OAIExpressRouteCircuitsRoutesTableListResult summary);
    void expressRouteCircuitsListStatsSignal(OAIExpressRouteCircuitsStatsListResult summary);
    ...
    void expressRouteCircuitsListArpTableSignalFull(OAIHttpRequestWorker *worker, OAIExpressRouteCircuitsArpTableListResult summary);
    void expressRouteCircuitsListRoutesTableSignalFull(OAIHttpRequestWorker *worker, OAIExpressRouteCircuitsRoutesTableListResult summary);
    void expressRouteCircuitsListStatsSignalFull(OAIHttpRequestWorker *worker, OAIExpressRouteCircuitsStatsListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsListArpTableSignalError() instead")
    void expressRouteCircuitsListArpTableSignalE(OAIExpressRouteCircuitsArpTableListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsListArpTableSignalError(OAIExpressRouteCircuitsArpTableListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsListRoutesTableSignalError() instead")
    void expressRouteCircuitsListRoutesTableSignalE(OAIExpressRouteCircuitsRoutesTableListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsListRoutesTableSignalError(OAIExpressRouteCircuitsRoutesTableListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsListStatsSignalError() instead")
    void expressRouteCircuitsListStatsSignalE(OAIExpressRouteCircuitsStatsListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsListStatsSignalError(OAIExpressRouteCircuitsStatsListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsListArpTableSignalErrorFull() instead")
    void expressRouteCircuitsListArpTableSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsListArpTableSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsListRoutesTableSignalErrorFull() instead")
    void expressRouteCircuitsListRoutesTableSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsListRoutesTableSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use expressRouteCircuitsListStatsSignalErrorFull() instead")
    void expressRouteCircuitsListStatsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void expressRouteCircuitsListStatsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
