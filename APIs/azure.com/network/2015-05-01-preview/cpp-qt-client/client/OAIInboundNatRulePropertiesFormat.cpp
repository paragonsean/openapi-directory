...
OAISubResource OAIInboundNatRulePropertiesFormat::getBackendIpConfiguration() const {
    return m_backend_ip_configuration;
}
void OAIInboundNatRulePropertiesFormat::setBackendIpConfiguration(const OAISubResource &backend_ip_configuration) {
...
bool OAIInboundNatRulePropertiesFormat::isValid() const {
    ...
    return m_enable_floating_ip_isValid && m_frontend_port_isValid && m_protocol_isValid && true;
}
