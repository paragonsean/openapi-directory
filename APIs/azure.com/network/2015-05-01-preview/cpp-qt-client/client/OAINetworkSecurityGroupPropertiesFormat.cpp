...
QList<OAISubResource> OAINetworkSecurityGroupPropertiesFormat::getNetworkInterfaces() const {
    return m_network_interfaces;
}
void OAINetworkSecurityGroupPropertiesFormat::setNetworkInterfaces(const QList<OAISubResource> &network_interfaces) {
...
QList<OAISubResource> OAINetworkSecurityGroupPropertiesFormat::getSubnets() const {
    return m_subnets;
}
void OAINetworkSecurityGroupPropertiesFormat::setSubnets(const QList<OAISubResource> &subnets) {
    m_subnets = subnets;
