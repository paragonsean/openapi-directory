...
/*
 * OAINetworkInterfaceListResult.h
 *
 * Response for ListNetworkInterface Api service call
 */

#ifndef OAINetworkInterfaceListResult_H
#define OAINetworkInterfaceListResult_H
...
class OAINetworkInterfaceListResult : public OAIObject {
public:
    OAINetworkInterfaceListResult();
    OAINetworkInterfaceListResult(QString json);
    ~OAINetworkInterfaceListResult() override;
    ...
    QList<OAINetworkInterface> getValue() const;
    void setValue(const QList<OAINetworkInterface> &value);
...
private:
    ...
    QList<OAINetworkInterface> m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkInterfaceListResult)

#endif // OAINetworkInterfaceListResult_H
