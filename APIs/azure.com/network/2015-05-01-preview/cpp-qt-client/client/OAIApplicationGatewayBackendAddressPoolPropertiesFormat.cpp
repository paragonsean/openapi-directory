...
QList<OAISubResource> OAIApplicationGatewayBackendAddressPoolPropertiesFormat::getBackendIpConfigurations() const {
    return m_backend_ip_configurations;
}
void OAIApplicationGatewayBackendAddressPoolPropertiesFormat::setBackendIpConfigurations(const QList<OAISubResource> &backend_ip_configurations) {
