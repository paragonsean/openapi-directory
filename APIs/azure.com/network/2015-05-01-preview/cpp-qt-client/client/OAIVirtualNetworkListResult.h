...
/*
 * OAIVirtualNetworkListResult.h
 *
 * Response for ListVirtualNetworks Api service call
 */

#ifndef OAIVirtualNetworkListResult_H
#define OAIVirtualNetworkListResult_H
...
class OAIVirtualNetworkListResult : public OAIObject {
public:
    OAIVirtualNetworkListResult();
    OAIVirtualNetworkListResult(QString json);
    ~OAIVirtualNetworkListResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualNetworkListResult)

#endif // OAIVirtualNetworkListResult_H
