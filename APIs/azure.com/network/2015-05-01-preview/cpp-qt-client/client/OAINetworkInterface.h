...
namespace OpenAPI {
class OAINetworkInterfacePropertiesFormat;
...
public:
    ...
    OAINetworkInterfacePropertiesFormat getProperties() const;
    void setProperties(const OAINetworkInterfacePropertiesFormat &properties);
...
private:
    ...
    OAINetworkInterfacePropertiesFormat m_properties;
