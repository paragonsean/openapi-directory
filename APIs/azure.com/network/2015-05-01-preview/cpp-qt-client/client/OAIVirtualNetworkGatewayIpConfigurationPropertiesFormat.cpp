...
OAISubResource OAIVirtualNetworkGatewayIpConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIVirtualNetworkGatewayIpConfigurationPropertiesFormat::setPublicIpAddress(const OAISubResource &public_ip_address) {
...
OAISubResource OAIVirtualNetworkGatewayIpConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIVirtualNetworkGatewayIpConfigurationPropertiesFormat::setSubnet(const OAISubResource &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
