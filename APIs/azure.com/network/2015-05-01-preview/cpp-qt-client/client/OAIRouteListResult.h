...
/*
 * OAIRouteListResult.h
 *
 * Response for ListRoute Api service call
 */

#ifndef OAIRouteListResult_H
#define OAIRouteListResult_H
...
class OAIRouteListResult : public OAIObject {
public:
    OAIRouteListResult();
    OAIRouteListResult(QString json);
    ~OAIRouteListResult() override;
    ...
    QList<OAIRoute> getValue() const;
    void setValue(const QList<OAIRoute> &value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteListResult)

#endif // OAIRouteListResult_H
