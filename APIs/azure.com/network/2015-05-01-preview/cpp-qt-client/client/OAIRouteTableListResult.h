...
/*
 * OAIRouteTableListResult.h
 *
 * Response for ListRouteTable Api service call
 */

#ifndef OAIRouteTableListResult_H
#define OAIRouteTableListResult_H
...
class OAIRouteTableListResult : public OAIObject {
public:
    OAIRouteTableListResult();
    OAIRouteTableListResult(QString json);
    ~OAIRouteTableListResult() override;
    ...
    QList<OAIRouteTable> getValue() const;
    void setValue(const QList<OAIRouteTable> &value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteTableListResult)

#endif // OAIRouteTableListResult_H
