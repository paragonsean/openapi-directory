...
namespace OpenAPI {
class OAIProbePropertiesFormat;
...
public:
    ...
    OAIProbePropertiesFormat getProperties() const;
    void setProperties(const OAIProbePropertiesFormat &properties);
...
private:
    ...
    OAIProbePropertiesFormat m_properties;
