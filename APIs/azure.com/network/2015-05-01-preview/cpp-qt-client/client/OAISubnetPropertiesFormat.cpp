...
QList<OAISubResource> OAISubnetPropertiesFormat::getIpConfigurations() const {
    return m_ip_configurations;
}
void OAISubnetPropertiesFormat::setIpConfigurations(const QList<OAISubResource> &ip_configurations) {
...
OAISubResource OAISubnetPropertiesFormat::getNetworkSecurityGroup() const {
    return m_network_security_group;
}
void OAISubnetPropertiesFormat::setNetworkSecurityGroup(const OAISubResource &network_security_group) {
...
OAISubResource OAISubnetPropertiesFormat::getRouteTable() const {
    return m_route_table;
}
void OAISubnetPropertiesFormat::setRouteTable(const OAISubResource &route_table) {
