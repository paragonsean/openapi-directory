...
export default class ExpressRouteCircuitAuthorizationsApi {
    ...
    */
     ...
     * @param {module:model/ExpressRouteCircuitAuthorization} authorizationParameters Parameters supplied to the create/update ExpressRouteCircuitAuthorization operation
