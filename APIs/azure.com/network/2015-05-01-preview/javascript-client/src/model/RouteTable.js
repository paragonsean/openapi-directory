...
class RouteTable {
    ...
    constructor(location) { 
        ...
        RouteTable.initialize(this, location);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = RouteTablePropertiesFormat.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of RouteTable.RequiredProperties) {
        ...
        if (data['properties']) { // data not null
          RouteTablePropertiesFormat.validateJSON(data['properties']);
        }
        // ensure the json data is a string
...
RouteTable.RequiredProperties = ["location"];

/**
 * Gets a unique read-only string that changes whenever the resource is updated
 * @member {String} etag
 */
RouteTable.prototype['etag'] = undefined;

/**
 * @member {module:model/RouteTablePropertiesFormat} properties
 */
RouteTable.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
RouteTable.prototype['id'] = undefined;

/**
 * Resource location
 * @member {String} location
 */
RouteTable.prototype['location'] = undefined;
 ...
 * @member {String} type
 */
RouteTable.prototype['type'] = undefined;
