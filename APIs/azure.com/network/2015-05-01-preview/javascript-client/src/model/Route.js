...
class Route {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = RoutePropertiesFormat.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          RoutePropertiesFormat.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
Route.prototype['etag'] = undefined;
...
/**
 * @member {module:model/RoutePropertiesFormat} properties
 */
Route.prototype['properties'] = undefined;
