...
class InboundNatRule {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = InboundNatRulePropertiesFormat.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          InboundNatRulePropertiesFormat.validateJSON(data['properties']);
        }
        // ensure the json data is a string
 ...
 * @member {String} etag
 */
InboundNatRule.prototype['etag'] = undefined;

/**
 * Gets name of the resource that is unique within a resource group. This name can be used to access the resource
 * @member {String} name
 */
InboundNatRule.prototype['name'] = undefined;

/**
 * @member {module:model/InboundNatRulePropertiesFormat} properties
 */
InboundNatRule.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
InboundNatRule.prototype['id'] = undefined;
