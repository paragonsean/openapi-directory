...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.RouteTableListResult();
  });
  ...
  describe('RouteTableListResult', function() {
    it('should create an instance of RouteTableListResult', function() {
      // uncomment below and update the code to test RouteTableListResult
      //var instance = new NetworkResourceProviderClient.RouteTableListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.RouteTableListResult);
    });
