...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayBackendHttpSettingsPropertiesFormat();
  });
  ...
  describe('ApplicationGatewayBackendHttpSettingsPropertiesFormat', function() {
    it('should create an instance of ApplicationGatewayBackendHttpSettingsPropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayBackendHttpSettingsPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayBackendHttpSettingsPropertiesFormat);
    });
