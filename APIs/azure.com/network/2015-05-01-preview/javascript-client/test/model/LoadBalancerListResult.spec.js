...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.LoadBalancerListResult();
  });
  ...
  describe('LoadBalancerListResult', function() {
    it('should create an instance of LoadBalancerListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.LoadBalancerListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.LoadBalancerListResult);
    });
