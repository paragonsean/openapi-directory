...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.AuthorizationListResult();
  });
  ...
  describe('AuthorizationListResult', function() {
    it('should create an instance of AuthorizationListResult', function() {
      // uncomment below and update the code to test AuthorizationListResult
      //var instance = new NetworkResourceProviderClient.AuthorizationListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.AuthorizationListResult);
    });
