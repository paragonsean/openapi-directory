...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitSku();
  });
  ...
  describe('ExpressRouteCircuitSku', function() {
    it('should create an instance of ExpressRouteCircuitSku', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitSku();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitSku);
    });
