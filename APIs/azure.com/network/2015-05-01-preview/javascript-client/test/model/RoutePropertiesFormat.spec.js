...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.RoutePropertiesFormat();
  });
  ...
  describe('RoutePropertiesFormat', function() {
    it('should create an instance of RoutePropertiesFormat', function() {
      // uncomment below and update the code to test RoutePropertiesFormat
      //var instance = new NetworkResourceProviderClient.RoutePropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.RoutePropertiesFormat);
    });
