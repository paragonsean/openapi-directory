...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.FrontendIpConfiguration();
  });
  ...
  describe('FrontendIpConfiguration', function() {
    it('should create an instance of FrontendIpConfiguration', function() {
      // uncomment below and update the code to test FrontendIpConfiguration
      //var instance = new NetworkResourceProviderClient.FrontendIpConfiguration();
      //expect(instance).to.be.a(NetworkResourceProviderClient.FrontendIpConfiguration);
    });
