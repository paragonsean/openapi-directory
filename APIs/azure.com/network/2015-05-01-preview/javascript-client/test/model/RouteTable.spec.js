...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.RouteTable();
  });
  ...
  describe('RouteTable', function() {
    it('should create an instance of RouteTable', function() {
      ...
      //var instance = new NetworkResourceProviderClient.RouteTable();
      //expect(instance).to.be.a(NetworkResourceProviderClient.RouteTable);
    });
