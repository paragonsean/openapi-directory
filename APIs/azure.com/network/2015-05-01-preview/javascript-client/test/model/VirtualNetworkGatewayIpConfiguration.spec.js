...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkGatewayIpConfiguration();
  });
  ...
  describe('VirtualNetworkGatewayIpConfiguration', function() {
    it('should create an instance of VirtualNetworkGatewayIpConfiguration', function() {
      ...
      //var instance = new NetworkResourceProviderClient.VirtualNetworkGatewayIpConfiguration();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkGatewayIpConfiguration);
    });
