...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.Usage();
  });
  ...
  describe('Usage', function() {
    it('should create an instance of Usage', function() {
      ...
      //var instance = new NetworkResourceProviderClient.Usage();
      //expect(instance).to.be.a(NetworkResourceProviderClient.Usage);
    });
