...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitsArpTableListResult();
  });
  ...
  describe('ExpressRouteCircuitsArpTableListResult', function() {
    it('should create an instance of ExpressRouteCircuitsArpTableListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitsArpTableListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitsArpTableListResult);
    });
