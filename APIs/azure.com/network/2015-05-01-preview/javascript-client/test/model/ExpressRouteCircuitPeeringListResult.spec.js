...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitPeeringListResult();
  });
  ...
  describe('ExpressRouteCircuitPeeringListResult', function() {
    it('should create an instance of ExpressRouteCircuitPeeringListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitPeeringListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitPeeringListResult);
    });
