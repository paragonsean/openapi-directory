...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.RouteListResult();
  });
  ...
  describe('RouteListResult', function() {
    it('should create an instance of RouteListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.RouteListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.RouteListResult);
    });
