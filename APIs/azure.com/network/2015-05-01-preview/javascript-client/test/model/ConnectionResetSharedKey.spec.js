...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ConnectionResetSharedKey();
  });
  ...
  describe('ConnectionResetSharedKey', function() {
    it('should create an instance of ConnectionResetSharedKey', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ConnectionResetSharedKey();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ConnectionResetSharedKey);
    });
