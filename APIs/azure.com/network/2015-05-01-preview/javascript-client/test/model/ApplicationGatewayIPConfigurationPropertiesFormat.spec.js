...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayIPConfigurationPropertiesFormat();
  });
  ...
  describe('ApplicationGatewayIPConfigurationPropertiesFormat', function() {
    it('should create an instance of ApplicationGatewayIPConfigurationPropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayIPConfigurationPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayIPConfigurationPropertiesFormat);
    });
