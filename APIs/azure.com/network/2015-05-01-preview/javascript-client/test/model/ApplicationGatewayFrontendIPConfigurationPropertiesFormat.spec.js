...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayFrontendIPConfigurationPropertiesFormat();
  });
  ...
  describe('ApplicationGatewayFrontendIPConfigurationPropertiesFormat', function() {
    it('should create an instance of ApplicationGatewayFrontendIPConfigurationPropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayFrontendIPConfigurationPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayFrontendIPConfigurationPropertiesFormat);
    });
