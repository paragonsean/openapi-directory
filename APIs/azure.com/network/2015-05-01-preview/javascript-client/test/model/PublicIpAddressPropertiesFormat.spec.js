...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.PublicIpAddressPropertiesFormat();
  });
  ...
  describe('PublicIpAddressPropertiesFormat', function() {
    it('should create an instance of PublicIpAddressPropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.PublicIpAddressPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.PublicIpAddressPropertiesFormat);
    });
