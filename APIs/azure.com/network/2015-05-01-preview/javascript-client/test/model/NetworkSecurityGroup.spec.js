...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.NetworkSecurityGroup();
  });
  ...
  describe('NetworkSecurityGroup', function() {
    it('should create an instance of NetworkSecurityGroup', function() {
      // uncomment below and update the code to test NetworkSecurityGroup
      //var instance = new NetworkResourceProviderClient.NetworkSecurityGroup();
      //expect(instance).to.be.a(NetworkResourceProviderClient.NetworkSecurityGroup);
    });
