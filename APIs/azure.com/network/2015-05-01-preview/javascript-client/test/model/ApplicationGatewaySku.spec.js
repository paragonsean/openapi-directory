...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewaySku();
  });
  ...
  describe('ApplicationGatewaySku', function() {
    it('should create an instance of ApplicationGatewaySku', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewaySku();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewaySku);
    });
