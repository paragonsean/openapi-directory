...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.SubnetListResult();
  });
  ...
  describe('SubnetListResult', function() {
    it('should create an instance of SubnetListResult', function() {
      // uncomment below and update the code to test SubnetListResult
      //var instance = new NetworkResourceProviderClient.SubnetListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.SubnetListResult);
    });
