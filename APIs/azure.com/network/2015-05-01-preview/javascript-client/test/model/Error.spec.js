...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new NetworkResourceProviderClient.Error();
      //expect(instance).to.be.a(NetworkResourceProviderClient.Error);
    });
