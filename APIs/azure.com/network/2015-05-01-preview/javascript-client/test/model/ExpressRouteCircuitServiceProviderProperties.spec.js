...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitServiceProviderProperties();
  });
  ...
  describe('ExpressRouteCircuitServiceProviderProperties', function() {
    it('should create an instance of ExpressRouteCircuitServiceProviderProperties', function() {
      // uncomment below and update the code to test ExpressRouteCircuitServiceProviderProperties
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitServiceProviderProperties();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitServiceProviderProperties);
    });
