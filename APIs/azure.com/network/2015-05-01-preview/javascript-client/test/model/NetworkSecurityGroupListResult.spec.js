...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.NetworkSecurityGroupListResult();
  });
  ...
  describe('NetworkSecurityGroupListResult', function() {
    it('should create an instance of NetworkSecurityGroupListResult', function() {
      // uncomment below and update the code to test NetworkSecurityGroupListResult
      //var instance = new NetworkResourceProviderClient.NetworkSecurityGroupListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.NetworkSecurityGroupListResult);
    });
