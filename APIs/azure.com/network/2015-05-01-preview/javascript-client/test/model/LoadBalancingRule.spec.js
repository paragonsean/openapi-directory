...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.LoadBalancingRule();
  });
  ...
  describe('LoadBalancingRule', function() {
    it('should create an instance of LoadBalancingRule', function() {
      // uncomment below and update the code to test LoadBalancingRule
      //var instance = new NetworkResourceProviderClient.LoadBalancingRule();
      //expect(instance).to.be.a(NetworkResourceProviderClient.LoadBalancingRule);
    });
