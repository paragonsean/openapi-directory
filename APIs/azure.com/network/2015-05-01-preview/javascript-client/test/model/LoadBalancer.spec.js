...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.LoadBalancer();
  });
  ...
  describe('LoadBalancer', function() {
    it('should create an instance of LoadBalancer', function() {
      ...
      //var instance = new NetworkResourceProviderClient.LoadBalancer();
      //expect(instance).to.be.a(NetworkResourceProviderClient.LoadBalancer);
    });
