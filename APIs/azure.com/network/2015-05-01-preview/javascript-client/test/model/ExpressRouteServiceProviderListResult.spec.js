...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteServiceProviderListResult();
  });
  ...
  describe('ExpressRouteServiceProviderListResult', function() {
    it('should create an instance of ExpressRouteServiceProviderListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteServiceProviderListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteServiceProviderListResult);
    });
