...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.NetworkInterfaceIpConfiguration();
  });
  ...
  describe('NetworkInterfaceIpConfiguration', function() {
    it('should create an instance of NetworkInterfaceIpConfiguration', function() {
      ...
      //var instance = new NetworkResourceProviderClient.NetworkInterfaceIpConfiguration();
      //expect(instance).to.be.a(NetworkResourceProviderClient.NetworkInterfaceIpConfiguration);
    });
