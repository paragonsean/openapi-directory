...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.SecurityRuleListResult();
  });
  ...
  describe('SecurityRuleListResult', function() {
    it('should create an instance of SecurityRuleListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.SecurityRuleListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.SecurityRuleListResult);
    });
