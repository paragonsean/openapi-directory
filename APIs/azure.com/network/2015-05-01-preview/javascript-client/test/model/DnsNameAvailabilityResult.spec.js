...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.DnsNameAvailabilityResult();
  });
  ...
  describe('DnsNameAvailabilityResult', function() {
    it('should create an instance of DnsNameAvailabilityResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.DnsNameAvailabilityResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.DnsNameAvailabilityResult);
    });
