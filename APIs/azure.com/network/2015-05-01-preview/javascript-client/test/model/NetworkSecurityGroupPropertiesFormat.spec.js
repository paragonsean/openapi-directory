...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.NetworkSecurityGroupPropertiesFormat();
  });
  ...
  describe('NetworkSecurityGroupPropertiesFormat', function() {
    it('should create an instance of NetworkSecurityGroupPropertiesFormat', function() {
      // uncomment below and update the code to test NetworkSecurityGroupPropertiesFormat
      //var instance = new NetworkResourceProviderClient.NetworkSecurityGroupPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.NetworkSecurityGroupPropertiesFormat);
    });
