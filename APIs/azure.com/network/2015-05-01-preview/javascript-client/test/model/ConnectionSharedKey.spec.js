...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ConnectionSharedKey();
  });
  ...
  describe('ConnectionSharedKey', function() {
    it('should create an instance of ConnectionSharedKey', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ConnectionSharedKey();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ConnectionSharedKey);
    });
