...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkGatewayConnectionListResult();
  });
  ...
  describe('VirtualNetworkGatewayConnectionListResult', function() {
    it('should create an instance of VirtualNetworkGatewayConnectionListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.VirtualNetworkGatewayConnectionListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkGatewayConnectionListResult);
    });
