...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.PublicIpAddress();
  });
  ...
  describe('PublicIpAddress', function() {
    it('should create an instance of PublicIpAddress', function() {
      ...
      //var instance = new NetworkResourceProviderClient.PublicIpAddress();
      //expect(instance).to.be.a(NetworkResourceProviderClient.PublicIpAddress);
    });
