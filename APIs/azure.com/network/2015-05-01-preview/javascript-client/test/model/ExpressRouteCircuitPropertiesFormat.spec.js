...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitPropertiesFormat();
  });
  ...
  describe('ExpressRouteCircuitPropertiesFormat', function() {
    it('should create an instance of ExpressRouteCircuitPropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitPropertiesFormat);
    });
