...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitListResult();
  });
  ...
  describe('ExpressRouteCircuitListResult', function() {
    it('should create an instance of ExpressRouteCircuitListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitListResult);
    });
