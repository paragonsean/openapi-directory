...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkPropertiesFormat();
  });
  ...
  describe('VirtualNetworkPropertiesFormat', function() {
    it('should create an instance of VirtualNetworkPropertiesFormat', function() {
      // uncomment below and update the code to test VirtualNetworkPropertiesFormat
      //var instance = new NetworkResourceProviderClient.VirtualNetworkPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkPropertiesFormat);
    });
