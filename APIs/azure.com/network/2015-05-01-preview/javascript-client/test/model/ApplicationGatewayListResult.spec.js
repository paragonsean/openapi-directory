...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayListResult();
  });
  ...
  describe('ApplicationGatewayListResult', function() {
    it('should create an instance of ApplicationGatewayListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayListResult);
    });
