...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ErrorDetails();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ErrorDetails);
    });
