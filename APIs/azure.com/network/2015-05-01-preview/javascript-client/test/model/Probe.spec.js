...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.Probe();
  });
  ...
  describe('Probe', function() {
    it('should create an instance of Probe', function() {
      ...
      //var instance = new NetworkResourceProviderClient.Probe();
      //expect(instance).to.be.a(NetworkResourceProviderClient.Probe);
    });
