...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkGatewayConnectionPropertiesFormat();
  });
  ...
  describe('VirtualNetworkGatewayConnectionPropertiesFormat', function() {
    it('should create an instance of VirtualNetworkGatewayConnectionPropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.VirtualNetworkGatewayConnectionPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkGatewayConnectionPropertiesFormat);
    });
