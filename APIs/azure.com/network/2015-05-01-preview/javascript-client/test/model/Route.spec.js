...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.Route();
  });
  ...
  describe('Route', function() {
    it('should create an instance of Route', function() {
      ...
      //var instance = new NetworkResourceProviderClient.Route();
      //expect(instance).to.be.a(NetworkResourceProviderClient.Route);
    });
