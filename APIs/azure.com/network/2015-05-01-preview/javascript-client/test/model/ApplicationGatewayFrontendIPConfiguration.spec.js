...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayFrontendIPConfiguration();
  });
  ...
  describe('ApplicationGatewayFrontendIPConfiguration', function() {
    it('should create an instance of ApplicationGatewayFrontendIPConfiguration', function() {
      // uncomment below and update the code to test ApplicationGatewayFrontendIPConfiguration
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayFrontendIPConfiguration();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayFrontendIPConfiguration);
    });
