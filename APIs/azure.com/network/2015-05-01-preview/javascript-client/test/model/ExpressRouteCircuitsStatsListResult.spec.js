...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitsStatsListResult();
  });
  ...
  describe('ExpressRouteCircuitsStatsListResult', function() {
    it('should create an instance of ExpressRouteCircuitsStatsListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitsStatsListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitsStatsListResult);
    });
