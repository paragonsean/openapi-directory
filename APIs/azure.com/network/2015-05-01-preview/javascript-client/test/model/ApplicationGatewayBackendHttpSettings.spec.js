...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayBackendHttpSettings();
  });
  ...
  describe('ApplicationGatewayBackendHttpSettings', function() {
    it('should create an instance of ApplicationGatewayBackendHttpSettings', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayBackendHttpSettings();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayBackendHttpSettings);
    });
