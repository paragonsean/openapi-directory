...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkListResult();
  });
  ...
  describe('VirtualNetworkListResult', function() {
    it('should create an instance of VirtualNetworkListResult', function() {
      // uncomment below and update the code to test VirtualNetworkListResult
      //var instance = new NetworkResourceProviderClient.VirtualNetworkListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkListResult);
    });
