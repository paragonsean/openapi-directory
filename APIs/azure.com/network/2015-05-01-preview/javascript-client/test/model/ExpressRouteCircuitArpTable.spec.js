...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitArpTable();
  });
  ...
  describe('ExpressRouteCircuitArpTable', function() {
    it('should create an instance of ExpressRouteCircuitArpTable', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitArpTable();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitArpTable);
    });
