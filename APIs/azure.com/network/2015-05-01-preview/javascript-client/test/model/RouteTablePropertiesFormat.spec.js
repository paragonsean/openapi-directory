...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.RouteTablePropertiesFormat();
  });
  ...
  describe('RouteTablePropertiesFormat', function() {
    it('should create an instance of RouteTablePropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.RouteTablePropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.RouteTablePropertiesFormat);
    });
