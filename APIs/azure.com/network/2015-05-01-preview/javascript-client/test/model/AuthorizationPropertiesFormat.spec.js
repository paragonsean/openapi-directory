...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.AuthorizationPropertiesFormat();
  });
  ...
  describe('AuthorizationPropertiesFormat', function() {
    it('should create an instance of AuthorizationPropertiesFormat', function() {
      // uncomment below and update the code to test AuthorizationPropertiesFormat
      //var instance = new NetworkResourceProviderClient.AuthorizationPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.AuthorizationPropertiesFormat);
    });
    ...
    it('should have the property authorizationUseStatus (base name: "authorizationUseStatus")', function() {
      // uncomment below and update the code to test the property authorizationUseStatus
      //var instance = new NetworkResourceProviderClient.AuthorizationPropertiesFormat();
      //expect(instance).to.be();
    });
