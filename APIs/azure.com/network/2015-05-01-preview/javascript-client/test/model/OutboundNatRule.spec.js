...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.OutboundNatRule();
  });
  ...
  describe('OutboundNatRule', function() {
    it('should create an instance of OutboundNatRule', function() {
      ...
      //var instance = new NetworkResourceProviderClient.OutboundNatRule();
      //expect(instance).to.be.a(NetworkResourceProviderClient.OutboundNatRule);
    });
