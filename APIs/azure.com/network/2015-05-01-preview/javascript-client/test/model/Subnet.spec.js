...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.Subnet();
  });
  ...
  describe('Subnet', function() {
    it('should create an instance of Subnet', function() {
      ...
      //var instance = new NetworkResourceProviderClient.Subnet();
      //expect(instance).to.be.a(NetworkResourceProviderClient.Subnet);
    });
