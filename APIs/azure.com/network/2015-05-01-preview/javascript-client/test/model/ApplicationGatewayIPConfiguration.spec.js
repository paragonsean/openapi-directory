...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayIPConfiguration();
  });
  ...
  describe('ApplicationGatewayIPConfiguration', function() {
    it('should create an instance of ApplicationGatewayIPConfiguration', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayIPConfiguration();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayIPConfiguration);
    });
