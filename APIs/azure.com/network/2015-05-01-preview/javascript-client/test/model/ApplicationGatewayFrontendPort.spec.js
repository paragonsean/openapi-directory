...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayFrontendPort();
  });
  ...
  describe('ApplicationGatewayFrontendPort', function() {
    it('should create an instance of ApplicationGatewayFrontendPort', function() {
      // uncomment below and update the code to test ApplicationGatewayFrontendPort
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayFrontendPort();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayFrontendPort);
    });
