...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayBackendAddress();
  });
  ...
  describe('ApplicationGatewayBackendAddress', function() {
    it('should create an instance of ApplicationGatewayBackendAddress', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayBackendAddress();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayBackendAddress);
    });
