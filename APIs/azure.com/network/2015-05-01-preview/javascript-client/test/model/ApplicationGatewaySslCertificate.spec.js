...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewaySslCertificate();
  });
  ...
  describe('ApplicationGatewaySslCertificate', function() {
    it('should create an instance of ApplicationGatewaySslCertificate', function() {
      // uncomment below and update the code to test ApplicationGatewaySslCertificate
      //var instance = new NetworkResourceProviderClient.ApplicationGatewaySslCertificate();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewaySslCertificate);
    });
