...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayBackendAddressPool();
  });
  ...
  describe('ApplicationGatewayBackendAddressPool', function() {
    it('should create an instance of ApplicationGatewayBackendAddressPool', function() {
      // uncomment below and update the code to test ApplicationGatewayBackendAddressPool
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayBackendAddressPool();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayBackendAddressPool);
    });
