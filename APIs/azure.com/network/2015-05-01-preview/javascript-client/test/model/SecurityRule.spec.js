...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.SecurityRule();
  });
  ...
  describe('SecurityRule', function() {
    it('should create an instance of SecurityRule', function() {
      // uncomment below and update the code to test SecurityRule
      //var instance = new NetworkResourceProviderClient.SecurityRule();
      //expect(instance).to.be.a(NetworkResourceProviderClient.SecurityRule);
    });
