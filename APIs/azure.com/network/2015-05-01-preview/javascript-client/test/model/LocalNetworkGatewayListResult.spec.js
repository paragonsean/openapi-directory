...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.LocalNetworkGatewayListResult();
  });
  ...
  describe('LocalNetworkGatewayListResult', function() {
    it('should create an instance of LocalNetworkGatewayListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.LocalNetworkGatewayListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.LocalNetworkGatewayListResult);
    });
