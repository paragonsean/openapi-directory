...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkGatewayPropertiesFormat();
  });
  ...
  describe('VirtualNetworkGatewayPropertiesFormat', function() {
    it('should create an instance of VirtualNetworkGatewayPropertiesFormat', function() {
      ...
      //var instance = new NetworkResourceProviderClient.VirtualNetworkGatewayPropertiesFormat();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkGatewayPropertiesFormat);
    });
