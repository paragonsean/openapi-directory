...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitsRoutesTableListResult();
  });
  ...
  describe('ExpressRouteCircuitsRoutesTableListResult', function() {
    it('should create an instance of ExpressRouteCircuitsRoutesTableListResult', function() {
      // uncomment below and update the code to test ExpressRouteCircuitsRoutesTableListResult
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitsRoutesTableListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitsRoutesTableListResult);
    });
