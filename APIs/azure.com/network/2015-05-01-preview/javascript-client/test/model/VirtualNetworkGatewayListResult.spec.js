...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkGatewayListResult();
  });
  ...
  describe('VirtualNetworkGatewayListResult', function() {
    it('should create an instance of VirtualNetworkGatewayListResult', function() {
      // uncomment below and update the code to test VirtualNetworkGatewayListResult
      //var instance = new NetworkResourceProviderClient.VirtualNetworkGatewayListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkGatewayListResult);
    });
