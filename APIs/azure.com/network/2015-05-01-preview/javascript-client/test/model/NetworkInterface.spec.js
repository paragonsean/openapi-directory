...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.NetworkInterface();
  });
  ...
  describe('NetworkInterface', function() {
    it('should create an instance of NetworkInterface', function() {
      ...
      //var instance = new NetworkResourceProviderClient.NetworkInterface();
      //expect(instance).to.be.a(NetworkResourceProviderClient.NetworkInterface);
    });
