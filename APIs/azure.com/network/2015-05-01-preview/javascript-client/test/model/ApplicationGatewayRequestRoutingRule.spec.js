...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayRequestRoutingRule();
  });
  ...
  describe('ApplicationGatewayRequestRoutingRule', function() {
    it('should create an instance of ApplicationGatewayRequestRoutingRule', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayRequestRoutingRule();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayRequestRoutingRule);
    });
