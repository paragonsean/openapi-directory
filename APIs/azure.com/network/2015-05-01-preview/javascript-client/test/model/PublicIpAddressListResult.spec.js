...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.PublicIpAddressListResult();
  });
  ...
  describe('PublicIpAddressListResult', function() {
    it('should create an instance of PublicIpAddressListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.PublicIpAddressListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.PublicIpAddressListResult);
    });
