...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new NetworkResourceProviderClient.Resource();
      //expect(instance).to.be.a(NetworkResourceProviderClient.Resource);
    });
