...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ExpressRouteCircuitAuthorization();
  });
  ...
  describe('ExpressRouteCircuitAuthorization', function() {
    it('should create an instance of ExpressRouteCircuitAuthorization', function() {
      ...
      //var instance = new NetworkResourceProviderClient.ExpressRouteCircuitAuthorization();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ExpressRouteCircuitAuthorization);
    });
