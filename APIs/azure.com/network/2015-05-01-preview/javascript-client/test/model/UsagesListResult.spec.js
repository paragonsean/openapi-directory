...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.UsagesListResult();
  });
  ...
  describe('UsagesListResult', function() {
    it('should create an instance of UsagesListResult', function() {
      ...
      //var instance = new NetworkResourceProviderClient.UsagesListResult();
      //expect(instance).to.be.a(NetworkResourceProviderClient.UsagesListResult);
    });
