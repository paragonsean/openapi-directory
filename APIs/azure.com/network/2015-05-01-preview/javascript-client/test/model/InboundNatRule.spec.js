...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.InboundNatRule();
  });
  ...
  describe('InboundNatRule', function() {
    it('should create an instance of InboundNatRule', function() {
      ...
      //var instance = new NetworkResourceProviderClient.InboundNatRule();
      //expect(instance).to.be.a(NetworkResourceProviderClient.InboundNatRule);
    });
