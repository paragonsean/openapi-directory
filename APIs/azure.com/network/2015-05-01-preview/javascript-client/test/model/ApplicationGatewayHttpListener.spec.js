...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.ApplicationGatewayHttpListener();
  });
  ...
  describe('ApplicationGatewayHttpListener', function() {
    it('should create an instance of ApplicationGatewayHttpListener', function() {
      // uncomment below and update the code to test ApplicationGatewayHttpListener
      //var instance = new NetworkResourceProviderClient.ApplicationGatewayHttpListener();
      //expect(instance).to.be.a(NetworkResourceProviderClient.ApplicationGatewayHttpListener);
    });
