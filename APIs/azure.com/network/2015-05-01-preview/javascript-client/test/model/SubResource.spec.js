...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.SubResource();
  });
  ...
  describe('SubResource', function() {
    it('should create an instance of SubResource', function() {
      ...
      //var instance = new NetworkResourceProviderClient.SubResource();
      //expect(instance).to.be.a(NetworkResourceProviderClient.SubResource);
    });
