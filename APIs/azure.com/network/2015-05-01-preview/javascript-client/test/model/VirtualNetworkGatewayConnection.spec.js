...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkResourceProviderClient.VirtualNetworkGatewayConnection();
  });
  ...
  describe('VirtualNetworkGatewayConnection', function() {
    it('should create an instance of VirtualNetworkGatewayConnection', function() {
      // uncomment below and update the code to test VirtualNetworkGatewayConnection
      //var instance = new NetworkResourceProviderClient.VirtualNetworkGatewayConnection();
      //expect(instance).to.be.a(NetworkResourceProviderClient.VirtualNetworkGatewayConnection);
    });
