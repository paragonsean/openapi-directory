# NetworkResourceProviderClient.SecurityRulesApi
...
let apiInstance = new NetworkResourceProviderClient.SecurityRulesApi();
...
let securityRuleParameters = new NetworkResourceProviderClient.SecurityRule(); // SecurityRule | Parameters supplied to the create/update network security rule operation
