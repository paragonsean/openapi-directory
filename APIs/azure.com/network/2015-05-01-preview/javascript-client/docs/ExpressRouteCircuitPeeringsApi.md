# NetworkResourceProviderClient.ExpressRouteCircuitPeeringsApi
...
let apiInstance = new NetworkResourceProviderClient.ExpressRouteCircuitPeeringsApi();
...
let peeringParameters = new NetworkResourceProviderClient.ExpressRouteCircuitPeering(); // ExpressRouteCircuitPeering | Parameters supplied to the create/update ExpressRouteCircuit Peering operation
