# NetworkResourceProviderClient.RoutesApi
...
let apiInstance = new NetworkResourceProviderClient.RoutesApi();
...
let routeParameters = new NetworkResourceProviderClient.Route(); // Route | Parameters supplied to the create/update route operation
