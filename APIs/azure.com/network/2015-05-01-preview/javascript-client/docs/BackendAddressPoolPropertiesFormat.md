# NetworkResourceProviderClient.BackendAddressPoolPropertiesFormat

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**backendIPConfigurations** | [**[SubResource]**](SubResource.md) | Gets collection of references to IPs defined in NICs | [optional] 
