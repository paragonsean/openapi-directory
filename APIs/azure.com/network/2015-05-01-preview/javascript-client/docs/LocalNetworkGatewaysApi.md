# NetworkResourceProviderClient.LocalNetworkGatewaysApi
...
let apiInstance = new NetworkResourceProviderClient.LocalNetworkGatewaysApi();
...
let parameters = new NetworkResourceProviderClient.LocalNetworkGateway(); // LocalNetworkGateway | Parameters supplied to the Begin Create or update Local Network Gateway operation through Network resource provider.
