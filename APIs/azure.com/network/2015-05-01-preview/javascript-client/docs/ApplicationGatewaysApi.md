# NetworkResourceProviderClient.ApplicationGatewaysApi
...
let apiInstance = new NetworkResourceProviderClient.ApplicationGatewaysApi();
let resourceGroupName = "resourceGroupName_example"; // String | The name of the resource group.
let applicationGatewayName = "applicationGatewayName_example"; // String | The name of the ApplicationGateway.
let apiVersion = "apiVersion_example"; // String | Client Api Version.
let subscriptionId = "subscriptionId_example"; // String | Gets subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
let parameters = new NetworkResourceProviderClient.ApplicationGateway(); // ApplicationGateway | Parameters supplied to the create/delete ApplicationGateway operation
