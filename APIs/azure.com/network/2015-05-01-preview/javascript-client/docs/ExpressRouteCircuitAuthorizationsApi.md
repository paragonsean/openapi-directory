...
let apiInstance = new NetworkResourceProviderClient.ExpressRouteCircuitAuthorizationsApi();
...
let authorizationParameters = new NetworkResourceProviderClient.ExpressRouteCircuitAuthorization(); // ExpressRouteCircuitAuthorization | Parameters supplied to the create/update ExpressRouteCircuitAuthorization operation
