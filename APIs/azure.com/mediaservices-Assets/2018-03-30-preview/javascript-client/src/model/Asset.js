...
class Asset {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = AssetProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          AssetProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/AssetProperties} properties
 */
