...
public:
    ...
    * @param[in]  api_version QString [required]
    */
    virtual void roleDefinitionsGetById(const QString &role_definition_id, const QString &api_version);
...
private:
    ...
    void roleDefinitionsGetByIdCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void roleDefinitionsGetByIdSignal(OAIRoleDefinition summary);
    ...
    void roleDefinitionsGetByIdSignalFull(OAIHttpRequestWorker *worker, OAIRoleDefinition summary);
    ...
    Q_DECL_DEPRECATED_X("Use roleDefinitionsGetByIdSignalError() instead")
    void roleDefinitionsGetByIdSignalE(OAIRoleDefinition summary, QNetworkReply::NetworkError error_type, QString error_str);
    void roleDefinitionsGetByIdSignalError(OAIRoleDefinition summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use roleDefinitionsGetByIdSignalErrorFull() instead")
    void roleDefinitionsGetByIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void roleDefinitionsGetByIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
