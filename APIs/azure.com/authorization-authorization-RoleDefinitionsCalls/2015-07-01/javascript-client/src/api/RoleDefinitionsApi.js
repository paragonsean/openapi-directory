...
export default class RoleDefinitionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the roleDefinitionsGetById operation.
     * @callback module:api/RoleDefinitionsApi~roleDefinitionsGetByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RoleDefinition} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} roleDefinitionId The fully qualified role definition ID. Use the format, /subscriptions/{guid}/providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for subscription level role definitions, or /providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for tenant level role definitions.
     * @param {String} apiVersion The API version to use for this operation.
     * @param {module:api/RoleDefinitionsApi~roleDefinitionsGetByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RoleDefinition}
     */
    roleDefinitionsGetById(roleDefinitionId, apiVersion, callback) {
      let postBody = null;
      // verify the required parameter 'roleDefinitionId' is set
      if (roleDefinitionId === undefined || roleDefinitionId === null) {
        throw new Error("Missing the required parameter 'roleDefinitionId' when calling roleDefinitionsGetById");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling roleDefinitionsGetById");
      }
