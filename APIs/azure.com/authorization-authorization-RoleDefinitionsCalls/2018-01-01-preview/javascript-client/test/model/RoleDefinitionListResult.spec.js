...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizationManagementClient.RoleDefinitionListResult();
  });
  ...
  describe('RoleDefinitionListResult', function() {
    it('should create an instance of RoleDefinitionListResult', function() {
      // uncomment below and update the code to test RoleDefinitionListResult
      //var instance = new AuthorizationManagementClient.RoleDefinitionListResult();
      //expect(instance).to.be.a(AuthorizationManagementClient.RoleDefinitionListResult);
    });
