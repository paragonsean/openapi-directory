...
#include "OAIAzureFirewallNatRule.h"
...
OAIAzureFirewallNatRule::OAIAzureFirewallNatRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAzureFirewallNatRule::OAIAzureFirewallNatRule() {
    this->initializeModel();
}

OAIAzureFirewallNatRule::~OAIAzureFirewallNatRule() {}

void OAIAzureFirewallNatRule::initializeModel() {
...
void OAIAzureFirewallNatRule::fromJson(QString jsonString) {
...
void OAIAzureFirewallNatRule::fromJsonObject(QJsonObject json) {
...
QString OAIAzureFirewallNatRule::asJson() const {
...
QJsonObject OAIAzureFirewallNatRule::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAzureFirewallNatRule::getDescription() const {
    return m_description;
}
void OAIAzureFirewallNatRule::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIAzureFirewallNatRule::is_description_Set() const{
    return m_description_isSet;
}

bool OAIAzureFirewallNatRule::is_description_Valid() const{
    return m_description_isValid;
}

QList<QString> OAIAzureFirewallNatRule::getDestinationAddresses() const {
    return m_destination_addresses;
}
void OAIAzureFirewallNatRule::setDestinationAddresses(const QList<QString> &destination_addresses) {
    m_destination_addresses = destination_addresses;
    m_destination_addresses_isSet = true;
}

bool OAIAzureFirewallNatRule::is_destination_addresses_Set() const{
    return m_destination_addresses_isSet;
}

bool OAIAzureFirewallNatRule::is_destination_addresses_Valid() const{
    return m_destination_addresses_isValid;
}

QList<QString> OAIAzureFirewallNatRule::getDestinationPorts() const {
    return m_destination_ports;
}
void OAIAzureFirewallNatRule::setDestinationPorts(const QList<QString> &destination_ports) {
    m_destination_ports = destination_ports;
    m_destination_ports_isSet = true;
}

bool OAIAzureFirewallNatRule::is_destination_ports_Set() const{
    return m_destination_ports_isSet;
}

bool OAIAzureFirewallNatRule::is_destination_ports_Valid() const{
    return m_destination_ports_isValid;
}

QString OAIAzureFirewallNatRule::getName() const {
    return m_name;
}
void OAIAzureFirewallNatRule::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAzureFirewallNatRule::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAzureFirewallNatRule::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIAzureFirewallNetworkRuleProtocol> OAIAzureFirewallNatRule::getProtocols() const {
    return m_protocols;
}
void OAIAzureFirewallNatRule::setProtocols(const QList<OAIAzureFirewallNetworkRuleProtocol> &protocols) {
    m_protocols = protocols;
    m_protocols_isSet = true;
}

bool OAIAzureFirewallNatRule::is_protocols_Set() const{
    return m_protocols_isSet;
}

bool OAIAzureFirewallNatRule::is_protocols_Valid() const{
    return m_protocols_isValid;
}

QList<QString> OAIAzureFirewallNatRule::getSourceAddresses() const {
    return m_source_addresses;
}
void OAIAzureFirewallNatRule::setSourceAddresses(const QList<QString> &source_addresses) {
    m_source_addresses = source_addresses;
    m_source_addresses_isSet = true;
}

bool OAIAzureFirewallNatRule::is_source_addresses_Set() const{
    return m_source_addresses_isSet;
}

bool OAIAzureFirewallNatRule::is_source_addresses_Valid() const{
    return m_source_addresses_isValid;
}

QString OAIAzureFirewallNatRule::getTranslatedAddress() const {
    return m_translated_address;
}
void OAIAzureFirewallNatRule::setTranslatedAddress(const QString &translated_address) {
    m_translated_address = translated_address;
    m_translated_address_isSet = true;
}

bool OAIAzureFirewallNatRule::is_translated_address_Set() const{
    return m_translated_address_isSet;
}

bool OAIAzureFirewallNatRule::is_translated_address_Valid() const{
    return m_translated_address_isValid;
}

QString OAIAzureFirewallNatRule::getTranslatedPort() const {
    return m_translated_port;
}
void OAIAzureFirewallNatRule::setTranslatedPort(const QString &translated_port) {
    m_translated_port = translated_port;
    m_translated_port_isSet = true;
}

bool OAIAzureFirewallNatRule::is_translated_port_Set() const{
    return m_translated_port_isSet;
}

bool OAIAzureFirewallNatRule::is_translated_port_Valid() const{
    return m_translated_port_isValid;
}

bool OAIAzureFirewallNatRule::isSet() const {
...
bool OAIAzureFirewallNatRule::isValid() const {
