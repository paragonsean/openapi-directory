...
void OAIAzureFirewallApplicationRuleProtocolType::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("Mssql", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAzureFirewallApplicationRuleProtocolType::MSSQL;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAzureFirewallApplicationRuleProtocolType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIAzureFirewallApplicationRuleProtocolType::HTTPS:
            val = "Https";
            break;
        case eOAIAzureFirewallApplicationRuleProtocolType::MSSQL:
            val = "Mssql";
            break;
        default:
            break;
