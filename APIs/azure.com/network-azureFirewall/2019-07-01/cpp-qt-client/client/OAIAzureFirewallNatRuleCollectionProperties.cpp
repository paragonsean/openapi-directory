...
QString OAIAzureFirewallNatRuleCollectionProperties::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIAzureFirewallNatRuleCollectionProperties::setProvisioningState(const QString &provisioning_state) {
