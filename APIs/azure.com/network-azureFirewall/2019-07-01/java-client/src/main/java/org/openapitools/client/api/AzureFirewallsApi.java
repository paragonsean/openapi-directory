...
public class AzureFirewallsApi {
    ...
    /**
     * Build call for azureFirewallsUpdateTags
     * @param resourceGroupName The name of the resource group. (required)
     * @param azureFirewallName The name of the Azure Firewall. (required)
     * @param apiVersion Client API version. (required)
     * @param subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. (required)
     ...
     */
    public okhttp3.Call azureFirewallsUpdateTagsCall(String resourceGroupName, String azureFirewallName, String apiVersion, String subscriptionId, AzureFirewall parameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call azureFirewallsUpdateTagsValidateBeforeCall(String resourceGroupName, String azureFirewallName, String apiVersion, String subscriptionId, AzureFirewall parameters, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'resourceGroupName' is set
        if (resourceGroupName == null) {
            throw new ApiException("Missing the required parameter 'resourceGroupName' when calling azureFirewallsUpdateTags(Async)");
        }

        // verify the required parameter 'azureFirewallName' is set
        if (azureFirewallName == null) {
            throw new ApiException("Missing the required parameter 'azureFirewallName' when calling azureFirewallsUpdateTags(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling azureFirewallsUpdateTags(Async)");
        }

        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling azureFirewallsUpdateTags(Async)");
        }

        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling azureFirewallsUpdateTags(Async)");
        }

        return azureFirewallsUpdateTagsCall(resourceGroupName, azureFirewallName, apiVersion, subscriptionId, parameters, _callback);
     ...
     */
    public AzureFirewall azureFirewallsUpdateTags(String resourceGroupName, String azureFirewallName, String apiVersion, String subscriptionId, AzureFirewall parameters) throws ApiException {
        ApiResponse<AzureFirewall> localVarResp = azureFirewallsUpdateTagsWithHttpInfo(resourceGroupName, azureFirewallName, apiVersion, subscriptionId, parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AzureFirewall> azureFirewallsUpdateTagsWithHttpInfo(String resourceGroupName, String azureFirewallName, String apiVersion, String subscriptionId, AzureFirewall parameters) throws ApiException {
        okhttp3.Call localVarCall = azureFirewallsUpdateTagsValidateBeforeCall(resourceGroupName, azureFirewallName, apiVersion, subscriptionId, parameters, null);
        Type localVarReturnType = new TypeToken<AzureFirewall>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call azureFirewallsUpdateTagsAsync(String resourceGroupName, String azureFirewallName, String apiVersion, String subscriptionId, AzureFirewall parameters, final ApiCallback<AzureFirewall> _callback) throws ApiException {

        okhttp3.Call localVarCall = azureFirewallsUpdateTagsValidateBeforeCall(resourceGroupName, azureFirewallName, apiVersion, subscriptionId, parameters, _callback);
        Type localVarReturnType = new TypeToken<AzureFirewall>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
