...
export default class AzureFirewallsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the azureFirewallsUpdateTags operation.
     * @callback module:api/AzureFirewallsApi~azureFirewallsUpdateTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AzureFirewall} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subscriptionId The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
     * @param {module:model/AzureFirewall} parameters Parameters supplied to the create or update Azure Firewall operation.
     * @param {module:api/AzureFirewallsApi~azureFirewallsUpdateTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AzureFirewall}
     */
    azureFirewallsUpdateTags(resourceGroupName, azureFirewallName, apiVersion, subscriptionId, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling azureFirewallsUpdateTags");
      }
      // verify the required parameter 'azureFirewallName' is set
      if (azureFirewallName === undefined || azureFirewallName === null) {
        throw new Error("Missing the required parameter 'azureFirewallName' when calling azureFirewallsUpdateTags");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling azureFirewallsUpdateTags");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling azureFirewallsUpdateTags");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling azureFirewallsUpdateTags");
      }
      ...
      let returnType = AzureFirewall;
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/azureFirewalls/{azureFirewallName}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
