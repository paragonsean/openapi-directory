...
OAIProvisioningState OAIAzureFirewallNetworkRuleCollectionPropertiesFormat::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIAzureFirewallNetworkRuleCollectionPropertiesFormat::setProvisioningState(const OAIProvisioningState &provisioning_state) {
