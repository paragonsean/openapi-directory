...
void OAIAzureFirewallIPConfigurationPropertiesFormat::initializeModel() {
    ...
    m_internal_public_ip_address_isSet = false;
    m_internal_public_ip_address_isValid = false;
...
void OAIAzureFirewallIPConfigurationPropertiesFormat::fromJsonObject(QJsonObject json) {
    ...
    m_internal_public_ip_address_isValid = ::OpenAPI::fromJsonValue(m_internal_public_ip_address, json[QString("internalPublicIpAddress")]);
    m_internal_public_ip_address_isSet = !json[QString("internalPublicIpAddress")].isNull() && m_internal_public_ip_address_isValid;
...
QJsonObject OAIAzureFirewallIPConfigurationPropertiesFormat::asJsonObject() const {
    QJsonObject obj;
    if (m_internal_public_ip_address.isSet()) {
        obj.insert(QString("internalPublicIpAddress"), ::OpenAPI::toJsonValue(m_internal_public_ip_address));
    }
...
OAIAzureFirewallIPConfigurationPropertiesFormat_internalPublicIpAddress OAIAzureFirewallIPConfigurationPropertiesFormat::getInternalPublicIpAddress() const {
    return m_internal_public_ip_address;
}
void OAIAzureFirewallIPConfigurationPropertiesFormat::setInternalPublicIpAddress(const OAIAzureFirewallIPConfigurationPropertiesFormat_internalPublicIpAddress &internal_public_ip_address) {
    m_internal_public_ip_address = internal_public_ip_address;
    m_internal_public_ip_address_isSet = true;
}

bool OAIAzureFirewallIPConfigurationPropertiesFormat::is_internal_public_ip_address_Set() const{
    return m_internal_public_ip_address_isSet;
}

bool OAIAzureFirewallIPConfigurationPropertiesFormat::is_internal_public_ip_address_Valid() const{
    return m_internal_public_ip_address_isValid;
}
...
OAIProvisioningState OAIAzureFirewallIPConfigurationPropertiesFormat::getProvisioningState() const {
    return m_provisioning_state;
}
void OAIAzureFirewallIPConfigurationPropertiesFormat::setProvisioningState(const OAIProvisioningState &provisioning_state) {
...
OAIAzureFirewallIPConfigurationPropertiesFormat_internalPublicIpAddress OAIAzureFirewallIPConfigurationPropertiesFormat::getPublicIpAddress() const {
    return m_public_ip_address;
}
void OAIAzureFirewallIPConfigurationPropertiesFormat::setPublicIpAddress(const OAIAzureFirewallIPConfigurationPropertiesFormat_internalPublicIpAddress &public_ip_address) {
...
OAIAzureFirewallIPConfigurationPropertiesFormat_internalPublicIpAddress OAIAzureFirewallIPConfigurationPropertiesFormat::getSubnet() const {
    return m_subnet;
}
void OAIAzureFirewallIPConfigurationPropertiesFormat::setSubnet(const OAIAzureFirewallIPConfigurationPropertiesFormat_internalPublicIpAddress &subnet) {
    m_subnet = subnet;
    m_subnet_isSet = true;
}
