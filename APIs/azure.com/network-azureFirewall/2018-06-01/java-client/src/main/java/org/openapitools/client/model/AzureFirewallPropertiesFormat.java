...
public class AzureFirewallPropertiesFormat {
  ...
  public AzureFirewallPropertiesFormat provisioningState(ProvisioningState provisioningState) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationRuleCollections, ipConfigurations, networkRuleCollections, provisioningState);
  }
