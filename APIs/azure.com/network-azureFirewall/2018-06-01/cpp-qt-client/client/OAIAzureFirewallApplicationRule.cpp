...
void OAIAzureFirewallApplicationRule::initializeModel() {
    ...
    m_target_urls_isSet = false;
    m_target_urls_isValid = false;
}
...
void OAIAzureFirewallApplicationRule::fromJsonObject(QJsonObject json) {
    ...
    m_target_urls_isValid = ::OpenAPI::fromJsonValue(m_target_urls, json[QString("targetUrls")]);
    m_target_urls_isSet = !json[QString("targetUrls")].isNull() && m_target_urls_isValid;
}
...
QJsonObject OAIAzureFirewallApplicationRule::asJsonObject() const {
    ...
    if (m_target_urls.size() > 0) {
        obj.insert(QString("targetUrls"), ::OpenAPI::toJsonValue(m_target_urls));
    }
    return obj;
}
...
QList<QString> OAIAzureFirewallApplicationRule::getTargetUrls() const {
    return m_target_urls;
}
void OAIAzureFirewallApplicationRule::setTargetUrls(const QList<QString> &target_urls) {
    m_target_urls = target_urls;
    m_target_urls_isSet = true;
}

bool OAIAzureFirewallApplicationRule::is_target_urls_Set() const{
    return m_target_urls_isSet;
}

bool OAIAzureFirewallApplicationRule::is_target_urls_Valid() const{
    return m_target_urls_isValid;
}
