...
OAIAzureFirewallSku OAIAzureFirewallPropertiesFormat::getSku() const {
    return m_sku;
}
void OAIAzureFirewallPropertiesFormat::setSku(const OAIAzureFirewallSku &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIAzureFirewallPropertiesFormat::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIAzureFirewallPropertiesFormat::is_sku_Valid() const{
