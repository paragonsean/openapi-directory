...
import org.openapitools.client.model.AzureFirewallSku;
...
public class AzureFirewallPropertiesFormat {
  ...
  public AzureFirewallPropertiesFormat sku(AzureFirewallSku sku) {
    this.sku = sku;
    return this;
  }
  ...
  public void setSku(AzureFirewallSku sku) {
    this.sku = sku;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationRuleCollections, azureFirewallPropertiesFormat.applicationRuleCollections) &&
        ...
        Objects.equals(this.sku, azureFirewallPropertiesFormat.sku) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationRuleCollections, firewallPolicy, hubIpAddresses, ipConfigurations, natRuleCollections, networkRuleCollections, provisioningState, sku, threatIntelMode, virtualHub);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("sku") != null && !jsonObj.get("sku").isJsonNull()) {
        AzureFirewallSku.validateJsonElement(jsonObj.get("sku"));
      }
