...
public class VolumeModel {
  ...
  public VolumeModel action(String action) {
    this.action = action;
    return this;
  }
  ...
  public VolumeModel description(String description) {
  ...
  public VolumeModel healthStatus(String healthStatus) {
  ...
  public VolumeModel operationalStatus(String operationalStatus) {
  ...
  public VolumeModel remainingCapacityGB(Integer remainingCapacityGB) {
  ...
  public void setRemainingCapacityGB(Integer remainingCapacityGB) {
    this.remainingCapacityGB = remainingCapacityGB;
  }


  public VolumeModel repairStatus(String repairStatus) {
  ...
  public VolumeModel totalCapacityGB(Integer totalCapacityGB) {
