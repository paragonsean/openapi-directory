...
public class VolumesApiTest {
    ...
    public void volumesGetTest() throws ApiException {
        ...
        Volume response = api.volumesGet(subscriptionId, resourceGroupName, location, scaleUnit, storageSubSystem, volume, apiVersion);
    ...
    public void volumesListTest() throws ApiException {
        ...
        String apiVersion = null;
        String $filter = null;
        VolumeList response = api.volumesList(subscriptionId, resourceGroupName, location, scaleUnit, storageSubSystem, apiVersion, $filter);
        // TODO: test validations
    }
