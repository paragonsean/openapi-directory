...
|**remainingCapacityGB** | **Integer** | Remaining capacity in GB of the volume. |  [optional] [readonly] |
...
|**totalCapacityGB** | **Integer** | Total capacity in GB of the volume. |  [optional] [readonly] |
