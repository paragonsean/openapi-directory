...
- API version: 2016-05-01
  - Build date: 2024-10-12T10:19:37.928746-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Volume result = apiInstance.volumesGet(subscriptionId, resourceGroupName, location, storageSubSystem, storagePool, volume, apiVersion);
...
------------ | ------------- | ------------- | -------------
*VolumesApi* | [**volumesGet**](docs/VolumesApi.md#volumesGet) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems/{storageSubSystem}/storagePools/{storagePool}/volumes/{volume} | 
*VolumesApi* | [**volumesList**](docs/VolumesApi.md#volumesList) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems/{storageSubSystem}/storagePools/{storagePool}/volumes | 
