...
<a id="volumesList"></a>
# **volumesList**
> VolumeList volumesList(subscriptionId, resourceGroupName, location, storageSubSystem, storagePool, apiVersion, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      VolumeList result = apiInstance.volumesList(subscriptionId, resourceGroupName, location, storageSubSystem, storagePool, apiVersion, $filter);
      System.out.println(result);
    } catch (ApiException e) {
