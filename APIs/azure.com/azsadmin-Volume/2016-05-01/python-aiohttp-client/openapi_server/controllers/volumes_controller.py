...
async def volumes_get(request: web.Request, subscription_id, resource_group_name, location, storage_sub_system, storage_pool, volume, api_version) -> web.Response:
    """volumes_get
...
async def volumes_list(request: web.Request, subscription_id, resource_group_name, location, storage_sub_system, storage_pool, api_version, filter=None) -> web.Response:
    """volumes_list
