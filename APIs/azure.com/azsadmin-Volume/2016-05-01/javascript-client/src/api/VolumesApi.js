...
export default class VolumesApi {
    ...
    */
     ...
     */
    volumesGet(subscriptionId, resourceGroupName, location, storageSubSystem, storagePool, volume, apiVersion, callback) {
      let postBody = null;
      ...
      if (storagePool === undefined || storagePool === null) {
        throw new Error("Missing the required parameter 'storagePool' when calling volumesGet");
      }
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems/{storageSubSystem}/storagePools/{storagePool}/volumes/{volume}', 'GET',
     ...
     */
    volumesList(subscriptionId, resourceGroupName, location, storageSubSystem, storagePool, apiVersion, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
      ...
      // verify the required parameter 'storagePool' is set
      if (storagePool === undefined || storagePool === null) {
        throw new Error("Missing the required parameter 'storagePool' when calling volumesList");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
      ...
      return this.apiClient.callApi(
        '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/storageSubSystems/{storageSubSystem}/storagePools/{storagePool}/volumes', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
