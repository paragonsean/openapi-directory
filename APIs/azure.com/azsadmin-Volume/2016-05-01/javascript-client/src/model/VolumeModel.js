...
class VolumeModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('remainingSizeGB')) {
                obj['remainingSizeGB'] = ApiClient.convertToType(data['remainingSizeGB'], 'Number');
            }
 ...
 */
VolumeModel.prototype['fileSystem'] = undefined;

/**
 * Amount of free space in GB.
 * @member {Number} remainingSizeGB
 */
VolumeModel.prototype['remainingSizeGB'] = undefined;

/**
 * Total amount of space in GB.
 * @member {Number} sizeGB
 */
VolumeModel.prototype['sizeGB'] = undefined;
