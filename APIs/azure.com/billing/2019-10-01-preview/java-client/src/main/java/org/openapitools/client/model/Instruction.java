...
import org.openapitools.client.model.InstructionProperties;
...
public class Instruction {
  ...
  private InstructionProperties properties;
  ...
  public Instruction properties(InstructionProperties properties) {
  ...
  public void setProperties(InstructionProperties properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.properties, instruction.properties) &&
        Objects.equals(this.id, instruction.id) &&
        Objects.equals(this.name, instruction.name) &&
        Objects.equals(this.type, instruction.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Instruction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Instruction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Instruction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Instruction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        InstructionProperties.validateJsonElement(jsonObj.get("properties"));
      }
