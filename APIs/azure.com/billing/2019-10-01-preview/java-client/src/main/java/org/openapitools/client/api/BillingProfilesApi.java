...
public class BillingProfilesApi {
     ...
     * @param parameters Request parameters supplied to the Create BillingProfile operation. (required)
     ...
     */
    public okhttp3.Call billingProfilesCreateCall(String apiVersion, String billingAccountName, String billingProfileName, BillingProfileCreationRequest parameters, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call billingProfilesCreateValidateBeforeCall(String apiVersion, String billingAccountName, String billingProfileName, BillingProfileCreationRequest parameters, final ApiCallback _callback) throws ApiException {
        ...
        if (billingProfileName == null) {
            throw new ApiException("Missing the required parameter 'billingProfileName' when calling billingProfilesCreate(Async)");
        }
        ...
        return billingProfilesCreateCall(apiVersion, billingAccountName, billingProfileName, parameters, _callback);
     ...
     */
    public BillingProfile billingProfilesCreate(String apiVersion, String billingAccountName, String billingProfileName, BillingProfileCreationRequest parameters) throws ApiException {
        ApiResponse<BillingProfile> localVarResp = billingProfilesCreateWithHttpInfo(apiVersion, billingAccountName, billingProfileName, parameters);
     ...
     */
    public ApiResponse<BillingProfile> billingProfilesCreateWithHttpInfo(String apiVersion, String billingAccountName, String billingProfileName, BillingProfileCreationRequest parameters) throws ApiException {
        okhttp3.Call localVarCall = billingProfilesCreateValidateBeforeCall(apiVersion, billingAccountName, billingProfileName, parameters, null);
     ...
     */
    public okhttp3.Call billingProfilesCreateAsync(String apiVersion, String billingAccountName, String billingProfileName, BillingProfileCreationRequest parameters, final ApiCallback<BillingProfile> _callback) throws ApiException {

        okhttp3.Call localVarCall = billingProfilesCreateValidateBeforeCall(apiVersion, billingAccountName, billingProfileName, parameters, _callback);
        Type localVarReturnType = new TypeToken<BillingProfile>(){}.getType();
    ...
    /**
     * Build call for billingProfilesListByBillingAccount
     * @param apiVersion Version of the API to be used with the client request. The current version is 2019-10-01-preview. (required)
     * @param billingAccountName billing Account Id. (required)
     * @param $expand May be used to expand the invoiceSections. (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call billingProfilesListByBillingAccountCall(String apiVersion, String billingAccountName, String $expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call billingProfilesListByBillingAccountValidateBeforeCall(String apiVersion, String billingAccountName, String $expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling billingProfilesListByBillingAccount(Async)");
        }

        // verify the required parameter 'billingAccountName' is set
        if (billingAccountName == null) {
            throw new ApiException("Missing the required parameter 'billingAccountName' when calling billingProfilesListByBillingAccount(Async)");
        }

        return billingProfilesListByBillingAccountCall(apiVersion, billingAccountName, $expand, _callback);
     ...
     */
    public BillingProfileListResult billingProfilesListByBillingAccount(String apiVersion, String billingAccountName, String $expand) throws ApiException {
        ApiResponse<BillingProfileListResult> localVarResp = billingProfilesListByBillingAccountWithHttpInfo(apiVersion, billingAccountName, $expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BillingProfileListResult> billingProfilesListByBillingAccountWithHttpInfo(String apiVersion, String billingAccountName, String $expand) throws ApiException {
        okhttp3.Call localVarCall = billingProfilesListByBillingAccountValidateBeforeCall(apiVersion, billingAccountName, $expand, null);
     ...
     */
    public okhttp3.Call billingProfilesListByBillingAccountAsync(String apiVersion, String billingAccountName, String $expand, final ApiCallback<BillingProfileListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = billingProfilesListByBillingAccountValidateBeforeCall(apiVersion, billingAccountName, $expand, _callback);
        Type localVarReturnType = new TypeToken<BillingProfileListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param billingAccountName billing Account Id. (required)
     * @param billingProfileName Billing Profile Id. (required)
     * @param parameters Request parameters supplied to the update billing profile operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
