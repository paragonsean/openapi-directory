...
import org.openapitools.client.model.BillingSubscriptionProperties;
...
public class BillingSubscription {
  ...
  private BillingSubscriptionProperties properties;
  ...
  public BillingSubscription properties(BillingSubscriptionProperties properties) {
  ...
  public BillingSubscriptionProperties getProperties() {
    return properties;
  }

  public void setProperties(BillingSubscriptionProperties properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.properties, billingSubscription.properties) &&
        Objects.equals(this.id, billingSubscription.id) &&
        Objects.equals(this.name, billingSubscription.name) &&
        Objects.equals(this.type, billingSubscription.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BillingSubscription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillingSubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BillingSubscription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillingSubscription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        BillingSubscriptionProperties.validateJsonElement(jsonObj.get("properties"));
      }
