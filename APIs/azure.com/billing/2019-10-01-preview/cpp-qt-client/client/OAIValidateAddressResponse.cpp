...
QList<OAIAddressDetails> OAIValidateAddressResponse::getSuggestedAddresses() const {
    return m_suggested_addresses;
}
void OAIValidateAddressResponse::setSuggestedAddresses(const QList<OAIAddressDetails> &suggested_addresses) {
