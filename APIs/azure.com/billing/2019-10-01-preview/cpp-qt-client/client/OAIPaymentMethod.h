...
namespace OpenAPI {
class OAIPaymentMethodProperties;
...
public:
    ...
    OAIPaymentMethodProperties getProperties() const;
    void setProperties(const OAIPaymentMethodProperties &properties);
...
private:
    ...
    OAIPaymentMethodProperties m_properties;
