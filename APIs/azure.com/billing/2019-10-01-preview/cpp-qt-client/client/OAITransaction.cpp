...
OAITransactionProperties OAITransaction::getProperties() const {
    return m_properties;
}
void OAITransaction::setProperties(const OAITransactionProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAITransaction::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAITransaction::is_properties_Valid() const{
