...
#ifndef OAIAddressDetails_H
#define OAIAddressDetails_H
...
class OAIAddressDetails : public OAIObject {
public:
    OAIAddressDetails();
    OAIAddressDetails(QString json);
    ~OAIAddressDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressDetails)

#endif // OAIAddressDetails_H
