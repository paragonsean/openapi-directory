...
public:
    ...
    QString getPaymentMethodFamily() const;
    void setPaymentMethodFamily(const QString &payment_method_family);
    bool is_payment_method_family_Set() const;
    bool is_payment_method_family_Valid() const;
...
private:
    ...
    QString m_payment_method_family;
    bool m_payment_method_family_isSet;
    bool m_payment_method_family_isValid;
