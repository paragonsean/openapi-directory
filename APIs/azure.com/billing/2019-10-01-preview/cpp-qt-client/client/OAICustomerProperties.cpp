...
QList<OAIAzurePlan> OAICustomerProperties::getEnabledAzurePlans() const {
    return m_enabled_azure_plans;
}
void OAICustomerProperties::setEnabledAzurePlans(const QList<OAIAzurePlan> &enabled_azure_plans) {
    m_enabled_azure_plans = enabled_azure_plans;
    m_enabled_azure_plans_isSet = true;
}

bool OAICustomerProperties::is_enabled_azure_plans_Set() const{
    return m_enabled_azure_plans_isSet;
}

bool OAICustomerProperties::is_enabled_azure_plans_Valid() const{
