...
public:
    ...
    */
    virtual void billingSubscriptionsTransfer(const QString &billing_account_name, const QString &billing_profile_name, const QString &invoice_section_name, const QString &billing_subscription_name, const OAITransferBillingSubscriptionRequestProperties &parameters);
    ...
    * @param[in]  parameters OAITransferBillingSubscriptionRequestProperties [required]
    */
    virtual void billingSubscriptionsValidateTransfer(const QString &billing_account_name, const QString &billing_profile_name, const QString &invoice_section_name, const QString &billing_subscription_name, const OAITransferBillingSubscriptionRequestProperties &parameters);
    ...
    */
    virtual void productsValidateTransfer(const QString &billing_account_name, const QString &billing_profile_name, const QString &invoice_section_name, const QString &product_name, const OAITransferProductRequestProperties &parameters);
