...
OAICustomerProperties OAICustomer::getProperties() const {
    return m_properties;
}
void OAICustomer::setProperties(const OAICustomerProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAICustomer::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAICustomer::is_properties_Valid() const{
