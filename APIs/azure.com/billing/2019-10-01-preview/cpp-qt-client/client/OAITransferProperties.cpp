...
QString OAITransferProperties::getBillingProfileId() const {
    return m_billing_profile_id;
}
void OAITransferProperties::setBillingProfileId(const QString &billing_profile_id) {
    m_billing_profile_id = billing_profile_id;
    m_billing_profile_id_isSet = true;
}

bool OAITransferProperties::is_billing_profile_id_Set() const{
    return m_billing_profile_id_isSet;
}

bool OAITransferProperties::is_billing_profile_id_Valid() const{
...
QString OAITransferProperties::getInitiatorCustomerType() const {
    return m_initiator_customer_type;
}
void OAITransferProperties::setInitiatorCustomerType(const QString &initiator_customer_type) {
    m_initiator_customer_type = initiator_customer_type;
    m_initiator_customer_type_isSet = true;
}

bool OAITransferProperties::is_initiator_customer_type_Set() const{
    return m_initiator_customer_type_isSet;
}

bool OAITransferProperties::is_initiator_customer_type_Valid() const{
...
QString OAITransferProperties::getResellerId() const {
    return m_reseller_id;
}
void OAITransferProperties::setResellerId(const QString &reseller_id) {
    m_reseller_id = reseller_id;
    m_reseller_id_isSet = true;
}

bool OAITransferProperties::is_reseller_id_Set() const{
    return m_reseller_id_isSet;
}

bool OAITransferProperties::is_reseller_id_Valid() const{
    return m_reseller_id_isValid;
}

QString OAITransferProperties::getResellerName() const {
    return m_reseller_name;
}
void OAITransferProperties::setResellerName(const QString &reseller_name) {
    m_reseller_name = reseller_name;
    m_reseller_name_isSet = true;
}

bool OAITransferProperties::is_reseller_name_Set() const{
    return m_reseller_name_isSet;
}

bool OAITransferProperties::is_reseller_name_Valid() const{
