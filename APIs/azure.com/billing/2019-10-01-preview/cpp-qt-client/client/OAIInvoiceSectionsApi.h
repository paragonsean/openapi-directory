...
public:
    ...
    */
    virtual void invoiceSectionsCreate(const QString &api_version, const QString &billing_account_name, const QString &billing_profile_name, const QString &invoice_section_name, const OAIInvoiceSectionCreationRequest &parameters);
    ...
    * @param[in]  invoice_section_name QString [required]
    */
    virtual void invoiceSectionsElevateToBillingProfile(const QString &billing_account_name, const QString &billing_profile_name, const QString &invoice_section_name);
    ...
    * @param[in]  invoice_section_name QString [required]
    */
    virtual void invoiceSectionsGet(const QString &api_version, const QString &billing_account_name, const QString &billing_profile_name, const QString &invoice_section_name);
    ...
    * @param[in]  billing_profile_name QString [required]
    */
    virtual void invoiceSectionsListByBillingProfile(const QString &api_version, const QString &billing_account_name, const QString &billing_profile_name);
    ...
    */
    virtual void invoiceSectionsUpdate(const QString &api_version, const QString &billing_account_name, const QString &billing_profile_name, const QString &invoice_section_name, const OAIInvoiceSection &parameters);
...
private:
    ...
    void invoiceSectionsListByBillingProfileCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void invoiceSectionsListByBillingProfileSignal(OAIInvoiceSectionListResult summary);
    ...
    void invoiceSectionsListByBillingProfileSignalFull(OAIHttpRequestWorker *worker, OAIInvoiceSectionListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use invoiceSectionsListByBillingProfileSignalError() instead")
    void invoiceSectionsListByBillingProfileSignalE(OAIInvoiceSectionListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void invoiceSectionsListByBillingProfileSignalError(OAIInvoiceSectionListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use invoiceSectionsListByBillingProfileSignalErrorFull() instead")
    void invoiceSectionsListByBillingProfileSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void invoiceSectionsListByBillingProfileSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
