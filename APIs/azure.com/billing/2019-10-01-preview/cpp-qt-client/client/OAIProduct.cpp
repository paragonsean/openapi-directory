...
OAIProductProperties OAIProduct::getProperties() const {
    return m_properties;
}
void OAIProduct::setProperties(const OAIProductProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIProduct::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIProduct::is_properties_Valid() const{
