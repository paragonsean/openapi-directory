...
OAIAmount OAIInvoiceProperties::getAmountDue() const {
    return m_amount_due;
}
void OAIInvoiceProperties::setAmountDue(const OAIAmount &amount_due) {
    m_amount_due = amount_due;
    m_amount_due_isSet = true;
}

bool OAIInvoiceProperties::is_amount_due_Set() const{
    return m_amount_due_isSet;
}

bool OAIInvoiceProperties::is_amount_due_Valid() const{
    return m_amount_due_isValid;
}

OAIAmount OAIInvoiceProperties::getBilledAmount() const {
    return m_billed_amount;
}
void OAIInvoiceProperties::setBilledAmount(const OAIAmount &billed_amount) {
    m_billed_amount = billed_amount;
    m_billed_amount_isSet = true;
}

bool OAIInvoiceProperties::is_billed_amount_Set() const{
    return m_billed_amount_isSet;
}

bool OAIInvoiceProperties::is_billed_amount_Valid() const{
    return m_billed_amount_isValid;
}

QString OAIInvoiceProperties::getBillingProfileDisplayName() const {
    return m_billing_profile_display_name;
}
void OAIInvoiceProperties::setBillingProfileDisplayName(const QString &billing_profile_display_name) {
    m_billing_profile_display_name = billing_profile_display_name;
    m_billing_profile_display_name_isSet = true;
}

bool OAIInvoiceProperties::is_billing_profile_display_name_Set() const{
    return m_billing_profile_display_name_isSet;
}

bool OAIInvoiceProperties::is_billing_profile_display_name_Valid() const{
    return m_billing_profile_display_name_isValid;
}

QString OAIInvoiceProperties::getBillingProfileId() const {
    return m_billing_profile_id;
}
void OAIInvoiceProperties::setBillingProfileId(const QString &billing_profile_id) {
    m_billing_profile_id = billing_profile_id;
    m_billing_profile_id_isSet = true;
}

bool OAIInvoiceProperties::is_billing_profile_id_Set() const{
    return m_billing_profile_id_isSet;
}

bool OAIInvoiceProperties::is_billing_profile_id_Valid() const{
    return m_billing_profile_id_isValid;
}

QList<OAIDocument> OAIInvoiceProperties::getDocuments() const {
    return m_documents;
}
void OAIInvoiceProperties::setDocuments(const QList<OAIDocument> &documents) {
    m_documents = documents;
    m_documents_isSet = true;
}

bool OAIInvoiceProperties::is_documents_Set() const{
    return m_documents_isSet;
}

bool OAIInvoiceProperties::is_documents_Valid() const{
    return m_documents_isValid;
}

QDateTime OAIInvoiceProperties::getDueDate() const {
    return m_due_date;
}
void OAIInvoiceProperties::setDueDate(const QDateTime &due_date) {
    m_due_date = due_date;
    m_due_date_isSet = true;
}

bool OAIInvoiceProperties::is_due_date_Set() const{
    return m_due_date_isSet;
}

bool OAIInvoiceProperties::is_due_date_Valid() const{
    return m_due_date_isValid;
}

QDateTime OAIInvoiceProperties::getInvoiceDate() const {
    return m_invoice_date;
}
void OAIInvoiceProperties::setInvoiceDate(const QDateTime &invoice_date) {
    m_invoice_date = invoice_date;
    m_invoice_date_isSet = true;
}

bool OAIInvoiceProperties::is_invoice_date_Set() const{
    return m_invoice_date_isSet;
}

bool OAIInvoiceProperties::is_invoice_date_Valid() const{
    return m_invoice_date_isValid;
}

QDateTime OAIInvoiceProperties::getInvoicePeriodEndDate() const {
    return m_invoice_period_end_date;
}
void OAIInvoiceProperties::setInvoicePeriodEndDate(const QDateTime &invoice_period_end_date) {
...
QDateTime OAIInvoiceProperties::getInvoicePeriodStartDate() const {
    return m_invoice_period_start_date;
}
void OAIInvoiceProperties::setInvoicePeriodStartDate(const QDateTime &invoice_period_start_date) {
...
QString OAIInvoiceProperties::getInvoiceType() const {
    return m_invoice_type;
}
void OAIInvoiceProperties::setInvoiceType(const QString &invoice_type) {
    m_invoice_type = invoice_type;
    m_invoice_type_isSet = true;
}

bool OAIInvoiceProperties::is_invoice_type_Set() const{
    return m_invoice_type_isSet;
}

bool OAIInvoiceProperties::is_invoice_type_Valid() const{
    return m_invoice_type_isValid;
}

QList<OAIPaymentProperties> OAIInvoiceProperties::getPayments() const {
    return m_payments;
}
void OAIInvoiceProperties::setPayments(const QList<OAIPaymentProperties> &payments) {
    m_payments = payments;
    m_payments_isSet = true;
}

bool OAIInvoiceProperties::is_payments_Set() const{
    return m_payments_isSet;
}

bool OAIInvoiceProperties::is_payments_Valid() const{
    return m_payments_isValid;
}

QString OAIInvoiceProperties::getPurchaseOrderNumber() const {
    return m_purchase_order_number;
}
void OAIInvoiceProperties::setPurchaseOrderNumber(const QString &purchase_order_number) {
    m_purchase_order_number = purchase_order_number;
    m_purchase_order_number_isSet = true;
}

bool OAIInvoiceProperties::is_purchase_order_number_Set() const{
    return m_purchase_order_number_isSet;
}

bool OAIInvoiceProperties::is_purchase_order_number_Valid() const{
    return m_purchase_order_number_isValid;
}

QString OAIInvoiceProperties::getStatus() const {
    return m_status;
}
void OAIInvoiceProperties::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIInvoiceProperties::is_status_Set() const{
    return m_status_isSet;
}

bool OAIInvoiceProperties::is_status_Valid() const{
