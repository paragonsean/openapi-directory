...
export default class AddressApi {
    ...
    */
     ...
     * @param {module:model/AddressDetails} address 
     ...
     */
    addressValidate(apiVersion, address, callback) {
      ...
      if (address === undefined || address === null) {
        throw new Error("Missing the required parameter 'address' when calling addressValidate");
      }
