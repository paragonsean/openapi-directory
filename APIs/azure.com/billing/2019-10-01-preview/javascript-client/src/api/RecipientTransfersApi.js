...
export default class RecipientTransfersApi {
    ...
    */
     ...
     * @param {module:model/AcceptTransferRequest} parameters Parameters supplied to accept the transfer.
     ...
     */
    recipientTransfersAccept(transferName, parameters, callback) {
      ...
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling recipientTransfersAccept");
      }
    ...
    /**
     * Callback function to receive the result of the recipientTransfersValidate operation.
     * @callback module:api/RecipientTransfersApi~recipientTransfersValidateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ValidateTransferListResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} transferName Transfer Name.
     * @param {module:model/AcceptTransferRequest} parameters Parameters supplied to validate the transfer.
     * @param {module:api/RecipientTransfersApi~recipientTransfersValidateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ValidateTransferListResponse}
     */
    recipientTransfersValidate(transferName, parameters, callback) {
      let postBody = parameters;
      // verify the required parameter 'transferName' is set
      if (transferName === undefined || transferName === null) {
        throw new Error("Missing the required parameter 'transferName' when calling recipientTransfersValidate");
      }
      // verify the required parameter 'parameters' is set
      if (parameters === undefined || parameters === null) {
        throw new Error("Missing the required parameter 'parameters' when calling recipientTransfersValidate");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ValidateTransferListResponse;
      return this.apiClient.callApi(
