...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new BillingManagementClient.Operation();
      //expect(instance).to.be.a(BillingManagementClient.Operation);
    });
