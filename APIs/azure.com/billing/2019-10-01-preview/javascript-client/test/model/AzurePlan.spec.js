...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.AzurePlan();
  });
  ...
  describe('AzurePlan', function() {
    it('should create an instance of AzurePlan', function() {
      // uncomment below and update the code to test AzurePlan
      //var instance = new BillingManagementClient.AzurePlan();
      //expect(instance).to.be.a(BillingManagementClient.AzurePlan);
    });
