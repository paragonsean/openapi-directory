...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.AddressDetails();
  });
  ...
  describe('AddressDetails', function() {
    it('should create an instance of AddressDetails', function() {
      // uncomment below and update the code to test AddressDetails
      //var instance = new BillingManagementClient.AddressDetails();
      //expect(instance).to.be.a(BillingManagementClient.AddressDetails);
    });
