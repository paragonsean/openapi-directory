...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.Document();
  });
  ...
  describe('Document', function() {
    it('should create an instance of Document', function() {
      ...
      //var instance = new BillingManagementClient.Document();
      //expect(instance).to.be.a(BillingManagementClient.Document);
    });
