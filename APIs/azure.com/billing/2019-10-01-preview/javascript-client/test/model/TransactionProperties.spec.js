...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.TransactionProperties();
  });
  ...
  describe('TransactionProperties', function() {
    it('should create an instance of TransactionProperties', function() {
      // uncomment below and update the code to test TransactionProperties
      //var instance = new BillingManagementClient.TransactionProperties();
      //expect(instance).to.be.a(BillingManagementClient.TransactionProperties);
    });
