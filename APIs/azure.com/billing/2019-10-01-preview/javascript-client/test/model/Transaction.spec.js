...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.Transaction();
  });
  ...
  describe('Transaction', function() {
    it('should create an instance of Transaction', function() {
      ...
      //var instance = new BillingManagementClient.Transaction();
      //expect(instance).to.be.a(BillingManagementClient.Transaction);
    });
