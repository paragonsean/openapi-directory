...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.TransferProperties();
  });
  ...
  describe('TransferProperties', function() {
    it('should create an instance of TransferProperties', function() {
      // uncomment below and update the code to test TransferProperties
      //var instance = new BillingManagementClient.TransferProperties();
      //expect(instance).to.be.a(BillingManagementClient.TransferProperties);
    });
