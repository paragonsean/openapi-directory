...
async def invoices_get_by_id(request: web.Request, billing_account_name, billing_subscription_name, invoice_name, api_version) -> web.Response:
    """invoices_get_by_id
...
async def invoices_list_by_billing_account(request: web.Request, api_version, billing_account_name, period_start_date, period_end_date) -> web.Response:
...
async def invoices_list_by_billing_subscription(request: web.Request, billing_account_name, billing_subscription_name, period_start_date, period_end_date, api_version) -> web.Response:
