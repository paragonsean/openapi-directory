...
async def billing_profiles_create(request: web.Request, api_version, billing_account_name, billing_profile_name, parameters) -> web.Response:
    ...
    """
    parameters = BillingProfileCreationRequest.from_dict(parameters)
...
async def billing_profiles_list_by_billing_account(request: web.Request, api_version, billing_account_name, expand=None) -> web.Response:
    """billing_profiles_list_by_billing_account
