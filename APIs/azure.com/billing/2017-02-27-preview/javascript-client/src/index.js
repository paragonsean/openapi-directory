...
/**
* Billing client provides access to billing resources for Azure Web-Direct subscriptions. Other subscription types which were not purchased directly through the Azure web portal are not supported through this preview API..<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var BillingClient = require('index'); // See note below*.
* var xxxSvc = new BillingClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new BillingClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new BillingClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new BillingClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
