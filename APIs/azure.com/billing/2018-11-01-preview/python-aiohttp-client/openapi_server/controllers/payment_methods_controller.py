...
async def payment_methods_list_by_billing_account_name(request: web.Request, billing_account_name, api_version) -> web.Response:
...
async def payment_methods_list_by_billing_profile_name(request: web.Request, billing_account_name, billing_profile_name, api_version) -> web.Response:
