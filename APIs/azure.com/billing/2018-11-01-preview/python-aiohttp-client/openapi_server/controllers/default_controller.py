...
async def billing_subscriptions_transfer(request: web.Request, billing_account_name, invoice_section_name, billing_subscription_name, parameters) -> web.Response:
...
async def billing_subscriptions_validate_transfer(request: web.Request, billing_account_name, invoice_section_name, billing_subscription_name, parameters) -> web.Response:
...
async def products_validate_transfer(request: web.Request, billing_account_name, invoice_section_name, product_name, parameters) -> web.Response:
