...
> AgreementListResult agreementsListByBillingAccountName(apiVersion, billingAccountName, opts)
...
apiInstance.agreementsListByBillingAccountName(apiVersion, billingAccountName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
