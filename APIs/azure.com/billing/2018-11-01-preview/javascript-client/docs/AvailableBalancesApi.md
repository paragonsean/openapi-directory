# BillingManagementClient.AvailableBalancesApi
...
let apiInstance = new BillingManagementClient.AvailableBalancesApi();
...
apiInstance.availableBalancesGetByBillingProfile(billingAccountName, billingProfileName, apiVersion, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
