# BillingManagementClient.ValidateAddressApi
...
let apiInstance = new BillingManagementClient.ValidateAddressApi();
...
let address = new BillingManagementClient.Address(); // Address | 
apiInstance.addressesValidate(apiVersion, address, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
