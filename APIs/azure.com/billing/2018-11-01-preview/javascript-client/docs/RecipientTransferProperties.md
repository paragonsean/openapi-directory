# BillingManagementClient.RecipientTransferProperties

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**allowedProductType** | [**[EligibleProductType]**](EligibleProductType.md) | Type of subscriptions that can be transferred. | [optional] [readonly] 
