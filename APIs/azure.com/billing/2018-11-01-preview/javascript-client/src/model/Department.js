...
import DepartmentProperties from './DepartmentProperties';
...
class Department {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = DepartmentProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          DepartmentProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/DepartmentProperties} properties
 */
Department.prototype['properties'] = undefined;
 ...
 * @member {String} type
 */
Department.prototype['type'] = undefined;
