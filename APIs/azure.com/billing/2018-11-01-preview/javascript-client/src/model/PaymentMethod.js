...
import PaymentMethodProperties from './PaymentMethodProperties';
...
class PaymentMethod {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = PaymentMethodProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          PaymentMethodProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/PaymentMethodProperties} properties
 */
PaymentMethod.prototype['properties'] = undefined;
