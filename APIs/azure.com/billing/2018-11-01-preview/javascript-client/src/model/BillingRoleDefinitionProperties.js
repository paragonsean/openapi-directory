...
import BillingPermissionsListResult from './BillingPermissionsListResult';
...
class BillingRoleDefinitionProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('permissions')) {
                obj['permissions'] = BillingPermissionsListResult.constructFromObject(data['permissions']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['permissions']) { // data not null
          BillingPermissionsListResult.validateJSON(data['permissions']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/BillingPermissionsListResult} permissions
 */
