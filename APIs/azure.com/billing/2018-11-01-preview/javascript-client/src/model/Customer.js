...
class Customer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = CustomerProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          CustomerProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/CustomerProperties} properties
 */
