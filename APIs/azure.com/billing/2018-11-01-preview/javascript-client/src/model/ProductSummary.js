...
import ProductSummaryProperties from './ProductSummaryProperties';
...
class ProductSummary {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ProductSummaryProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ProductSummaryProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ProductSummaryProperties} properties
 */
ProductSummary.prototype['properties'] = undefined;

/**
 * Resource Id.
 * @member {String} id
 */
ProductSummary.prototype['id'] = undefined;

/**
 * Resource name.
 * @member {String} name
 */
ProductSummary.prototype['name'] = undefined;

/**
 * Resource type.
 * @member {String} type
 */
ProductSummary.prototype['type'] = undefined;
