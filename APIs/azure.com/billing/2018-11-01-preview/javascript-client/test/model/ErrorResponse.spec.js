...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new BillingManagementClient.ErrorResponse();
      //expect(instance).to.be.a(BillingManagementClient.ErrorResponse);
    });
