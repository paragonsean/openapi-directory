...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.Customer();
  });
  ...
  describe('Customer', function() {
    it('should create an instance of Customer', function() {
      ...
      //var instance = new BillingManagementClient.Customer();
      //expect(instance).to.be.a(BillingManagementClient.Customer);
    });
