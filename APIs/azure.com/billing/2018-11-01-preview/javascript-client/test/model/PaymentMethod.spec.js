...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.PaymentMethod();
  });
  ...
  describe('PaymentMethod', function() {
    it('should create an instance of PaymentMethod', function() {
      ...
      //var instance = new BillingManagementClient.PaymentMethod();
      //expect(instance).to.be.a(BillingManagementClient.PaymentMethod);
    });
