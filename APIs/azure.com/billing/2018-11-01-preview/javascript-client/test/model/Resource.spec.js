...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new BillingManagementClient.Resource();
      //expect(instance).to.be.a(BillingManagementClient.Resource);
    });
