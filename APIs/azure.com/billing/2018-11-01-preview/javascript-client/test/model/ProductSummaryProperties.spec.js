...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.ProductSummaryProperties();
  });
  ...
  describe('ProductSummaryProperties', function() {
    it('should create an instance of ProductSummaryProperties', function() {
      // uncomment below and update the code to test ProductSummaryProperties
      //var instance = new BillingManagementClient.ProductSummaryProperties();
      //expect(instance).to.be.a(BillingManagementClient.ProductSummaryProperties);
    });
