...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new BillingManagementClient.OperationDisplay();
      //expect(instance).to.be.a(BillingManagementClient.OperationDisplay);
    });
