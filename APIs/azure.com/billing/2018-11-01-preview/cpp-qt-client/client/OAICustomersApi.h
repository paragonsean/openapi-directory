...
public:
    ...
    */
    virtual void customersListByBillingAccountName(const QString &api_version, const QString &billing_account_name, const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &skiptoken = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void customersListByBillingAccountNameCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void customersGetSignal(OAICustomer summary);
    void customersListByBillingAccountNameSignal(OAICustomerListResult summary);


    void customersGetSignalFull(OAIHttpRequestWorker *worker, OAICustomer summary);
    void customersListByBillingAccountNameSignalFull(OAIHttpRequestWorker *worker, OAICustomerListResult summary);
    ...
    Q_DECL_DEPRECATED_X("Use customersListByBillingAccountNameSignalError() instead")
    void customersListByBillingAccountNameSignalE(OAICustomerListResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void customersListByBillingAccountNameSignalError(OAICustomerListResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use customersListByBillingAccountNameSignalErrorFull() instead")
    void customersListByBillingAccountNameSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void customersListByBillingAccountNameSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
