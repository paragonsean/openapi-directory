...
void OAIBillingAccountProperties::initializeModel() {
    ...
    m_has_read_access_isSet = false;
    m_has_read_access_isValid = false;
...
void OAIBillingAccountProperties::fromJsonObject(QJsonObject json) {
    ...
    m_has_read_access_isValid = ::OpenAPI::fromJsonValue(m_has_read_access, json[QString("hasReadAccess")]);
    m_has_read_access_isSet = !json[QString("hasReadAccess")].isNull() && m_has_read_access_isValid;
...
QJsonObject OAIBillingAccountProperties::asJsonObject() const {
    ...
    if (m_has_read_access_isSet) {
        obj.insert(QString("hasReadAccess"), ::OpenAPI::toJsonValue(m_has_read_access));
    }
...
bool OAIBillingAccountProperties::isHasReadAccess() const {
    return m_has_read_access;
}
void OAIBillingAccountProperties::setHasReadAccess(const bool &has_read_access) {
    m_has_read_access = has_read_access;
    m_has_read_access_isSet = true;
}

bool OAIBillingAccountProperties::is_has_read_access_Set() const{
    return m_has_read_access_isSet;
}

bool OAIBillingAccountProperties::is_has_read_access_Valid() const{
    return m_has_read_access_isValid;
}
