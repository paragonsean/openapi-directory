...
OAIPaymentMethodProperties OAIPaymentMethod::getProperties() const {
    return m_properties;
}
void OAIPaymentMethod::setProperties(const OAIPaymentMethodProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIPaymentMethod::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIPaymentMethod::is_properties_Valid() const{
