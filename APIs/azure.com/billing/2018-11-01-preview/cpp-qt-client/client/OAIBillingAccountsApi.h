...
#include "OAIBillingAccountUpdateProperties.h"
...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  billing_account_name QString [required]
    * @param[in]  parameters OAIBillingAccountUpdateProperties [required]
    */
    virtual void billingAccountsUpdate(const QString &api_version, const QString &billing_account_name, const OAIBillingAccountUpdateProperties &parameters);
