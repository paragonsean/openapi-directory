...
namespace OpenAPI {
class OAIProductSummaryProperties;
...
public:
    ...
    OAIProductSummaryProperties getProperties() const;
    void setProperties(const OAIProductSummaryProperties &properties);
...
private:
    ...
    OAIProductSummaryProperties m_properties;
