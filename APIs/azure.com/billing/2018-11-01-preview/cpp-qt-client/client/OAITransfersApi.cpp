...
void OAITransfersApi::transfersCancel(const QString &billing_account_name, const QString &invoice_section_name, const QString &transfer_name) {
    QString fullPath = QString(_serverConfigs["transfersCancel"][_serverIndices.value("transfersCancel")].URL()+"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoiceSections/{invoiceSectionName}/transfers/{transferName}");
...
void OAITransfersApi::transfersGet(const QString &billing_account_name, const QString &invoice_section_name, const QString &transfer_name) {
    QString fullPath = QString(_serverConfigs["transfersGet"][_serverIndices.value("transfersGet")].URL()+"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoiceSections/{invoiceSectionName}/transfers/{transferName}");
...
void OAITransfersApi::transfersInitiate(const QString &billing_account_name, const QString &invoice_section_name, const OAIInitiateTransferRequest &body) {
    QString fullPath = QString(_serverConfigs["transfersInitiate"][_serverIndices.value("transfersInitiate")].URL()+"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoiceSections/{invoiceSectionName}/initiateTransfer");
...
void OAITransfersApi::transfersList(const QString &billing_account_name, const QString &invoice_section_name) {
    QString fullPath = QString(_serverConfigs["transfersList"][_serverIndices.value("transfersList")].URL()+"/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoiceSections/{invoiceSectionName}/transfers");
