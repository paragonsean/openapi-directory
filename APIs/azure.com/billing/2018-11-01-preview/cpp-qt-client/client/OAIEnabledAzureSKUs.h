...
/*
 * OAIEnabledAzureSKUs.h
 *
 * Details about the enabled azure sku.
 */

#ifndef OAIEnabledAzureSKUs_H
#define OAIEnabledAzureSKUs_H
...
class OAIEnabledAzureSKUs : public OAIObject {
public:
    OAIEnabledAzureSKUs();
    OAIEnabledAzureSKUs(QString json);
    ~OAIEnabledAzureSKUs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnabledAzureSKUs)

#endif // OAIEnabledAzureSKUs_H
