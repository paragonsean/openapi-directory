...
public:
    ...
    */
    virtual void transfersCancel(const QString &billing_account_name, const QString &invoice_section_name, const QString &transfer_name);
    ...
    * @param[in]  transfer_name QString [required]
    */
    virtual void transfersGet(const QString &billing_account_name, const QString &invoice_section_name, const QString &transfer_name);

    /**
    * @param[in]  billing_account_name QString [required]
    * @param[in]  invoice_section_name QString [required]
    * @param[in]  body OAIInitiateTransferRequest [required]
    */
    virtual void transfersInitiate(const QString &billing_account_name, const QString &invoice_section_name, const OAIInitiateTransferRequest &body);

    /**
    * @param[in]  billing_account_name QString [required]
    * @param[in]  invoice_section_name QString [required]
    */
    virtual void transfersList(const QString &billing_account_name, const QString &invoice_section_name);
