...
QString OAIOperationStatus::getStatusDetail() const {
    return m_status_detail;
}
void OAIOperationStatus::setStatusDetail(const QString &status_detail) {
    m_status_detail = status_detail;
    m_status_detail_isSet = true;
}

bool OAIOperationStatus::is_status_detail_Set() const{
    return m_status_detail_isSet;
}

bool OAIOperationStatus::is_status_detail_Valid() const{
