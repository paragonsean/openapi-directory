...
<a id="policiesGetByBillingProfileName"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Policy result = apiInstance.policiesGetByBillingProfileName(billingAccountName, billingProfileName, apiVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PoliciesApi#policiesGetByBillingProfileName");
