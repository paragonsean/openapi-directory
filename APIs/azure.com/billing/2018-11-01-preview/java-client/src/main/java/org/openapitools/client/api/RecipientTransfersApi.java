...
public class RecipientTransfersApi {
     ...
     */
    public okhttp3.Call recipientTransfersAcceptCall(String transferName, AcceptTransferRequest body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call recipientTransfersAcceptValidateBeforeCall(String transferName, AcceptTransferRequest body, final ApiCallback _callback) throws ApiException {
        ...
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling recipientTransfersAccept(Async)");
        }

        return recipientTransfersAcceptCall(transferName, body, _callback);
     ...
     */
    public RecipientTransferDetails recipientTransfersAccept(String transferName, AcceptTransferRequest body) throws ApiException {
        ApiResponse<RecipientTransferDetails> localVarResp = recipientTransfersAcceptWithHttpInfo(transferName, body);
     ...
     */
    public ApiResponse<RecipientTransferDetails> recipientTransfersAcceptWithHttpInfo(String transferName, AcceptTransferRequest body) throws ApiException {
        okhttp3.Call localVarCall = recipientTransfersAcceptValidateBeforeCall(transferName, body, null);
     ...
     */
    public okhttp3.Call recipientTransfersAcceptAsync(String transferName, AcceptTransferRequest body, final ApiCallback<RecipientTransferDetails> _callback) throws ApiException {

        okhttp3.Call localVarCall = recipientTransfersAcceptValidateBeforeCall(transferName, body, _callback);
        Type localVarReturnType = new TypeToken<RecipientTransferDetails>(){}.getType();
