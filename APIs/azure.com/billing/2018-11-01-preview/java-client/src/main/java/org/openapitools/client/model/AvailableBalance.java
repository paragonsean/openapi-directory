...
import org.openapitools.client.model.AvailableBalanceProperties;
...
public class AvailableBalance {
  ...
  public AvailableBalance properties(AvailableBalanceProperties properties) {
  ...
  public AvailableBalanceProperties getProperties() {
    return properties;
  }

  public void setProperties(AvailableBalanceProperties properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.properties, availableBalance.properties) &&
        Objects.equals(this.id, availableBalance.id) &&
        Objects.equals(this.name, availableBalance.name) &&
        Objects.equals(this.type, availableBalance.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AvailableBalance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AvailableBalance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AvailableBalance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AvailableBalance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        AvailableBalanceProperties.validateJsonElement(jsonObj.get("properties"));
      }
