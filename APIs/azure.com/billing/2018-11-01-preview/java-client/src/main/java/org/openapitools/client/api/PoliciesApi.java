...
public class PoliciesApi {
    ...
    /**
     * Build call for policiesGetByBillingProfileName
     ...
     */
    public okhttp3.Call policiesGetByBillingProfileNameCall(String billingAccountName, String billingProfileName, String apiVersion, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call policiesGetByBillingProfileNameValidateBeforeCall(String billingAccountName, String billingProfileName, String apiVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'billingAccountName' is set
        if (billingAccountName == null) {
            throw new ApiException("Missing the required parameter 'billingAccountName' when calling policiesGetByBillingProfileName(Async)");
        }

        // verify the required parameter 'billingProfileName' is set
        if (billingProfileName == null) {
            throw new ApiException("Missing the required parameter 'billingProfileName' when calling policiesGetByBillingProfileName(Async)");
        }

        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling policiesGetByBillingProfileName(Async)");
        }

        return policiesGetByBillingProfileNameCall(billingAccountName, billingProfileName, apiVersion, _callback);
     ...
     * @see <a href="https://docs.microsoft.com/en-us/rest/api/consumption/"> Documentation</a>
     */
    public Policy policiesGetByBillingProfileName(String billingAccountName, String billingProfileName, String apiVersion) throws ApiException {
        ApiResponse<Policy> localVarResp = policiesGetByBillingProfileNameWithHttpInfo(billingAccountName, billingProfileName, apiVersion);
     ...
     * @see <a href="https://docs.microsoft.com/en-us/rest/api/consumption/"> Documentation</a>
     */
    public ApiResponse<Policy> policiesGetByBillingProfileNameWithHttpInfo(String billingAccountName, String billingProfileName, String apiVersion) throws ApiException {
        okhttp3.Call localVarCall = policiesGetByBillingProfileNameValidateBeforeCall(billingAccountName, billingProfileName, apiVersion, null);
     ...
     * @see <a href="https://docs.microsoft.com/en-us/rest/api/consumption/"> Documentation</a>
     */
    public okhttp3.Call policiesGetByBillingProfileNameAsync(String billingAccountName, String billingProfileName, String apiVersion, final ApiCallback<Policy> _callback) throws ApiException {

        okhttp3.Call localVarCall = policiesGetByBillingProfileNameValidateBeforeCall(billingAccountName, billingProfileName, apiVersion, _callback);
        Type localVarReturnType = new TypeToken<Policy>(){}.getType();
