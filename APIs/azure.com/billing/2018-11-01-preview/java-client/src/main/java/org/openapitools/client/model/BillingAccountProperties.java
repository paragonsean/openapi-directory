...
public class BillingAccountProperties {
  ...
  public static final String SERIALIZED_NAME_HAS_READ_ACCESS = "hasReadAccess";
  @SerializedName(SERIALIZED_NAME_HAS_READ_ACCESS)
  ...
  public BillingAccountProperties invoiceSections(List<InvoiceSection> invoiceSections) {
    this.invoiceSections = invoiceSections;
    return this;
  }

  public BillingAccountProperties addInvoiceSectionsItem(InvoiceSection invoiceSectionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountType, billingAccountProperties.accountType) &&
        ...
        Objects.equals(this.hasReadAccess, billingAccountProperties.hasReadAccess) &&
        Objects.equals(this.invoiceSections, billingAccountProperties.invoiceSections);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountType, address, billingProfiles, company, country, departments, displayName, enrollmentAccounts, enrollmentDetails, hasReadAccess, invoiceSections);
  }
  ...
  public String toString() {
    ...
    sb.append("    hasReadAccess: ").append(toIndentedString(hasReadAccess)).append("\n");
  ...
  static {
    ...
    openapiFields.add("hasReadAccess");
