...
import FailoverElasticPoolsApi from './api/FailoverElasticPoolsApi';
...
export {
    ...
    /**
    * The FailoverElasticPoolsApi service constructor.
    * @property {module:api/FailoverElasticPoolsApi}
    */
