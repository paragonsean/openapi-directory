...
void OAIAlertProperties::initializeModel() {
    ...
    m_correlation_key_isSet = false;
    m_correlation_key_isValid = false;
...
void OAIAlertProperties::fromJsonObject(QJsonObject json) {
    ...
    m_correlation_key_isValid = ::OpenAPI::fromJsonValue(m_correlation_key, json[QString("correlationKey")]);
    m_correlation_key_isSet = !json[QString("correlationKey")].isNull() && m_correlation_key_isValid;
...
QJsonObject OAIAlertProperties::asJsonObject() const {
    ...
    if (m_correlation_key_isSet) {
        obj.insert(QString("correlationKey"), ::OpenAPI::toJsonValue(m_correlation_key));
    }
...
QString OAIAlertProperties::getCorrelationKey() const {
    return m_correlation_key;
}
void OAIAlertProperties::setCorrelationKey(const QString &correlation_key) {
    m_correlation_key = correlation_key;
    m_correlation_key_isSet = true;
}

bool OAIAlertProperties::is_correlation_key_Set() const{
    return m_correlation_key_isSet;
}

bool OAIAlertProperties::is_correlation_key_Valid() const{
    return m_correlation_key_isValid;
}
