...
OAISqlRuleAction::OAISqlRuleAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISqlRuleAction::OAISqlRuleAction() {
    this->initializeModel();
}

OAISqlRuleAction::~OAISqlRuleAction() {}

void OAISqlRuleAction::initializeModel() {
...
void OAISqlRuleAction::fromJson(QString jsonString) {
...
void OAISqlRuleAction::fromJsonObject(QJsonObject json) {
...
QString OAISqlRuleAction::asJson() const {
...
QJsonObject OAISqlRuleAction::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAISqlRuleAction::getCompatibilityLevel() const {
    return m_compatibility_level;
}
void OAISqlRuleAction::setCompatibilityLevel(const qint32 &compatibility_level) {
    m_compatibility_level = compatibility_level;
    m_compatibility_level_isSet = true;
}

bool OAISqlRuleAction::is_compatibility_level_Set() const{
    return m_compatibility_level_isSet;
}

bool OAISqlRuleAction::is_compatibility_level_Valid() const{
    return m_compatibility_level_isValid;
}

bool OAISqlRuleAction::isRequiresPreprocessing() const {
    return m_requires_preprocessing;
}
void OAISqlRuleAction::setRequiresPreprocessing(const bool &requires_preprocessing) {
    m_requires_preprocessing = requires_preprocessing;
    m_requires_preprocessing_isSet = true;
}

bool OAISqlRuleAction::is_requires_preprocessing_Set() const{
    return m_requires_preprocessing_isSet;
}

bool OAISqlRuleAction::is_requires_preprocessing_Valid() const{
    return m_requires_preprocessing_isValid;
}

QString OAISqlRuleAction::getSqlExpression() const {
    return m_sql_expression;
}
void OAISqlRuleAction::setSqlExpression(const QString &sql_expression) {
    m_sql_expression = sql_expression;
    m_sql_expression_isSet = true;
}

bool OAISqlRuleAction::is_sql_expression_Set() const{
    return m_sql_expression_isSet;
}

bool OAISqlRuleAction::is_sql_expression_Valid() const{
    return m_sql_expression_isValid;
}

bool OAISqlRuleAction::isSet() const {
...
bool OAISqlRuleAction::isValid() const {
