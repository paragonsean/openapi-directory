...
OAIRuleproperties OAIRule::getProperties() const {
    return m_properties;
}
void OAIRule::setProperties(const OAIRuleproperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIRule::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIRule::is_properties_Valid() const{
