...
OAISBQueueProperties::OAISBQueueProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISBQueueProperties::OAISBQueueProperties() {
    this->initializeModel();
}

OAISBQueueProperties::~OAISBQueueProperties() {}

void OAISBQueueProperties::initializeModel() {
...
void OAISBQueueProperties::fromJson(QString jsonString) {
...
void OAISBQueueProperties::fromJsonObject(QJsonObject json) {
...
QString OAISBQueueProperties::asJson() const {
...
QJsonObject OAISBQueueProperties::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAISBQueueProperties::getAccessedAt() const {
    return m_accessed_at;
}
void OAISBQueueProperties::setAccessedAt(const QDateTime &accessed_at) {
    m_accessed_at = accessed_at;
    m_accessed_at_isSet = true;
}

bool OAISBQueueProperties::is_accessed_at_Set() const{
    return m_accessed_at_isSet;
}

bool OAISBQueueProperties::is_accessed_at_Valid() const{
    return m_accessed_at_isValid;
}

QString OAISBQueueProperties::getAutoDeleteOnIdle() const {
    return m_auto_delete_on_idle;
}
void OAISBQueueProperties::setAutoDeleteOnIdle(const QString &auto_delete_on_idle) {
    m_auto_delete_on_idle = auto_delete_on_idle;
    m_auto_delete_on_idle_isSet = true;
}

bool OAISBQueueProperties::is_auto_delete_on_idle_Set() const{
    return m_auto_delete_on_idle_isSet;
}

bool OAISBQueueProperties::is_auto_delete_on_idle_Valid() const{
    return m_auto_delete_on_idle_isValid;
}

OAIMessageCountDetails OAISBQueueProperties::getCountDetails() const {
    return m_count_details;
}
void OAISBQueueProperties::setCountDetails(const OAIMessageCountDetails &count_details) {
    m_count_details = count_details;
    m_count_details_isSet = true;
}

bool OAISBQueueProperties::is_count_details_Set() const{
    return m_count_details_isSet;
}

bool OAISBQueueProperties::is_count_details_Valid() const{
    return m_count_details_isValid;
}

QDateTime OAISBQueueProperties::getCreatedAt() const {
    return m_created_at;
}
void OAISBQueueProperties::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAISBQueueProperties::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAISBQueueProperties::is_created_at_Valid() const{
    return m_created_at_isValid;
}

bool OAISBQueueProperties::isDeadLetteringOnMessageExpiration() const {
    return m_dead_lettering_on_message_expiration;
}
void OAISBQueueProperties::setDeadLetteringOnMessageExpiration(const bool &dead_lettering_on_message_expiration) {
...
bool OAISBQueueProperties::is_dead_lettering_on_message_expiration_Set() const{
    return m_dead_lettering_on_message_expiration_isSet;
}

bool OAISBQueueProperties::is_dead_lettering_on_message_expiration_Valid() const{
    return m_dead_lettering_on_message_expiration_isValid;
}

QString OAISBQueueProperties::getDefaultMessageTimeToLive() const {
    return m_default_message_time_to_live;
}
void OAISBQueueProperties::setDefaultMessageTimeToLive(const QString &default_message_time_to_live) {
    m_default_message_time_to_live = default_message_time_to_live;
    m_default_message_time_to_live_isSet = true;
}

bool OAISBQueueProperties::is_default_message_time_to_live_Set() const{
    return m_default_message_time_to_live_isSet;
}

bool OAISBQueueProperties::is_default_message_time_to_live_Valid() const{
    return m_default_message_time_to_live_isValid;
}

QString OAISBQueueProperties::getDuplicateDetectionHistoryTimeWindow() const {
    return m_duplicate_detection_history_time_window;
}
void OAISBQueueProperties::setDuplicateDetectionHistoryTimeWindow(const QString &duplicate_detection_history_time_window) {
...
bool OAISBQueueProperties::is_duplicate_detection_history_time_window_Set() const{
    return m_duplicate_detection_history_time_window_isSet;
}

bool OAISBQueueProperties::is_duplicate_detection_history_time_window_Valid() const{
    return m_duplicate_detection_history_time_window_isValid;
}

bool OAISBQueueProperties::isEnableBatchedOperations() const {
    return m_enable_batched_operations;
}
void OAISBQueueProperties::setEnableBatchedOperations(const bool &enable_batched_operations) {
    m_enable_batched_operations = enable_batched_operations;
    m_enable_batched_operations_isSet = true;
}

bool OAISBQueueProperties::is_enable_batched_operations_Set() const{
    return m_enable_batched_operations_isSet;
}

bool OAISBQueueProperties::is_enable_batched_operations_Valid() const{
    return m_enable_batched_operations_isValid;
}

bool OAISBQueueProperties::isEnableExpress() const {
    return m_enable_express;
}
void OAISBQueueProperties::setEnableExpress(const bool &enable_express) {
    m_enable_express = enable_express;
    m_enable_express_isSet = true;
}

bool OAISBQueueProperties::is_enable_express_Set() const{
    return m_enable_express_isSet;
}

bool OAISBQueueProperties::is_enable_express_Valid() const{
    return m_enable_express_isValid;
}

bool OAISBQueueProperties::isEnablePartitioning() const {
    return m_enable_partitioning;
}
void OAISBQueueProperties::setEnablePartitioning(const bool &enable_partitioning) {
    m_enable_partitioning = enable_partitioning;
    m_enable_partitioning_isSet = true;
}

bool OAISBQueueProperties::is_enable_partitioning_Set() const{
    return m_enable_partitioning_isSet;
}

bool OAISBQueueProperties::is_enable_partitioning_Valid() const{
    return m_enable_partitioning_isValid;
}

QString OAISBQueueProperties::getForwardDeadLetteredMessagesTo() const {
    return m_forward_dead_lettered_messages_to;
}
void OAISBQueueProperties::setForwardDeadLetteredMessagesTo(const QString &forward_dead_lettered_messages_to) {
    m_forward_dead_lettered_messages_to = forward_dead_lettered_messages_to;
    m_forward_dead_lettered_messages_to_isSet = true;
}

bool OAISBQueueProperties::is_forward_dead_lettered_messages_to_Set() const{
    return m_forward_dead_lettered_messages_to_isSet;
}

bool OAISBQueueProperties::is_forward_dead_lettered_messages_to_Valid() const{
    return m_forward_dead_lettered_messages_to_isValid;
}

QString OAISBQueueProperties::getForwardTo() const {
    return m_forward_to;
}
void OAISBQueueProperties::setForwardTo(const QString &forward_to) {
    m_forward_to = forward_to;
    m_forward_to_isSet = true;
}

bool OAISBQueueProperties::is_forward_to_Set() const{
    return m_forward_to_isSet;
}

bool OAISBQueueProperties::is_forward_to_Valid() const{
    return m_forward_to_isValid;
}

QString OAISBQueueProperties::getLockDuration() const {
    return m_lock_duration;
}
void OAISBQueueProperties::setLockDuration(const QString &lock_duration) {
    m_lock_duration = lock_duration;
    m_lock_duration_isSet = true;
}

bool OAISBQueueProperties::is_lock_duration_Set() const{
    return m_lock_duration_isSet;
}

bool OAISBQueueProperties::is_lock_duration_Valid() const{
    return m_lock_duration_isValid;
}

qint32 OAISBQueueProperties::getMaxDeliveryCount() const {
    return m_max_delivery_count;
}
void OAISBQueueProperties::setMaxDeliveryCount(const qint32 &max_delivery_count) {
    m_max_delivery_count = max_delivery_count;
    m_max_delivery_count_isSet = true;
}

bool OAISBQueueProperties::is_max_delivery_count_Set() const{
    return m_max_delivery_count_isSet;
}

bool OAISBQueueProperties::is_max_delivery_count_Valid() const{
    return m_max_delivery_count_isValid;
}

qint32 OAISBQueueProperties::getMaxSizeInMegabytes() const {
    return m_max_size_in_megabytes;
}
void OAISBQueueProperties::setMaxSizeInMegabytes(const qint32 &max_size_in_megabytes) {
    m_max_size_in_megabytes = max_size_in_megabytes;
    m_max_size_in_megabytes_isSet = true;
}

bool OAISBQueueProperties::is_max_size_in_megabytes_Set() const{
    return m_max_size_in_megabytes_isSet;
}

bool OAISBQueueProperties::is_max_size_in_megabytes_Valid() const{
    return m_max_size_in_megabytes_isValid;
}

qint64 OAISBQueueProperties::getMessageCount() const {
    return m_message_count;
}
void OAISBQueueProperties::setMessageCount(const qint64 &message_count) {
    m_message_count = message_count;
    m_message_count_isSet = true;
}

bool OAISBQueueProperties::is_message_count_Set() const{
    return m_message_count_isSet;
}

bool OAISBQueueProperties::is_message_count_Valid() const{
    return m_message_count_isValid;
}

bool OAISBQueueProperties::isRequiresDuplicateDetection() const {
    return m_requires_duplicate_detection;
}
void OAISBQueueProperties::setRequiresDuplicateDetection(const bool &requires_duplicate_detection) {
    m_requires_duplicate_detection = requires_duplicate_detection;
    m_requires_duplicate_detection_isSet = true;
}

bool OAISBQueueProperties::is_requires_duplicate_detection_Set() const{
    return m_requires_duplicate_detection_isSet;
}

bool OAISBQueueProperties::is_requires_duplicate_detection_Valid() const{
    return m_requires_duplicate_detection_isValid;
}

bool OAISBQueueProperties::isRequiresSession() const {
    return m_requires_session;
}
void OAISBQueueProperties::setRequiresSession(const bool &requires_session) {
    m_requires_session = requires_session;
    m_requires_session_isSet = true;
}

bool OAISBQueueProperties::is_requires_session_Set() const{
    return m_requires_session_isSet;
}

bool OAISBQueueProperties::is_requires_session_Valid() const{
    return m_requires_session_isValid;
}

qint64 OAISBQueueProperties::getSizeInBytes() const {
    return m_size_in_bytes;
}
void OAISBQueueProperties::setSizeInBytes(const qint64 &size_in_bytes) {
    m_size_in_bytes = size_in_bytes;
    m_size_in_bytes_isSet = true;
}

bool OAISBQueueProperties::is_size_in_bytes_Set() const{
    return m_size_in_bytes_isSet;
}

bool OAISBQueueProperties::is_size_in_bytes_Valid() const{
    return m_size_in_bytes_isValid;
}

OAIEntityStatus OAISBQueueProperties::getStatus() const {
    return m_status;
}
void OAISBQueueProperties::setStatus(const OAIEntityStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISBQueueProperties::is_status_Set() const{
    return m_status_isSet;
}

bool OAISBQueueProperties::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAISBQueueProperties::getUpdatedAt() const {
    return m_updated_at;
}
void OAISBQueueProperties::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAISBQueueProperties::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAISBQueueProperties::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAISBQueueProperties::isSet() const {
...
bool OAISBQueueProperties::isValid() const {
