...
/*
 * OAISBQueueProperties.h
 *
 * The Queue Properties definition.
 */

#ifndef OAISBQueueProperties_H
#define OAISBQueueProperties_H
...
class OAISBQueueProperties : public OAIObject {
public:
    OAISBQueueProperties();
    OAISBQueueProperties(QString json);
    ~OAISBQueueProperties() override;
    ...
    QString getForwardDeadLetteredMessagesTo() const;
    void setForwardDeadLetteredMessagesTo(const QString &forward_dead_lettered_messages_to);
    bool is_forward_dead_lettered_messages_to_Set() const;
    bool is_forward_dead_lettered_messages_to_Valid() const;

    QString getForwardTo() const;
    void setForwardTo(const QString &forward_to);
    bool is_forward_to_Set() const;
    bool is_forward_to_Valid() const;
    ...
    qint32 getMaxSizeInMegabytes() const;
    void setMaxSizeInMegabytes(const qint32 &max_size_in_megabytes);
...
private:
    ...
    QString m_forward_dead_lettered_messages_to;
    bool m_forward_dead_lettered_messages_to_isSet;
    bool m_forward_dead_lettered_messages_to_isValid;

    QString m_forward_to;
    bool m_forward_to_isSet;
    bool m_forward_to_isValid;
    ...
    qint32 m_max_size_in_megabytes;
...
Q_DECLARE_METATYPE(OpenAPI::OAISBQueueProperties)

#endif // OAISBQueueProperties_H
