...
/*
 * OAISBTopicProperties.h
 *
 * The Topic Properties definition.
 */

#ifndef OAISBTopicProperties_H
#define OAISBTopicProperties_H
...
class OAISBTopicProperties : public OAIObject {
public:
    OAISBTopicProperties();
    OAISBTopicProperties(QString json);
    ~OAISBTopicProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISBTopicProperties)

#endif // OAISBTopicProperties_H
