# ServiceBusManagementClient.SBTopicProperties
...
**maxSizeInMegabytes** | **Number** | Maximum size of the topic in megabytes, which is the size of the memory allocated for the topic. Default is 1024. | [optional] 
