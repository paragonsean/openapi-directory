...
export default class TopicsApi {
    ...
    */
     ...
     * @param {module:model/SBTopic} data The data returned by the service call.
     ...
     * @param {module:model/SBTopic} parameters Parameters supplied to create a topic resource.
     ...
     * data is of type: {@link module:model/SBTopic}
     */
    ...
    /**
     * Callback function to receive the result of the topicsListByNamespace operation.
     * @callback module:api/TopicsApi~topicsListByNamespaceCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SBTopicListResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TopicsApi~topicsListByNamespaceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SBTopicListResult}
     */
    topicsListByNamespace(resourceGroupName, namespaceName, apiVersion, subscriptionId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'resourceGroupName' is set
      if (resourceGroupName === undefined || resourceGroupName === null) {
        throw new Error("Missing the required parameter 'resourceGroupName' when calling topicsListByNamespace");
      }
      // verify the required parameter 'namespaceName' is set
      if (namespaceName === undefined || namespaceName === null) {
        throw new Error("Missing the required parameter 'namespaceName' when calling topicsListByNamespace");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling topicsListByNamespace");
      }
      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling topicsListByNamespace");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = SBTopicListResult;
      return this.apiClient.callApi(
