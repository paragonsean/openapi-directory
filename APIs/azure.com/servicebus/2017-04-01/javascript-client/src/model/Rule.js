...
class Rule {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = Ruleproperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          Ruleproperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/Ruleproperties} properties
 */
Rule.prototype['properties'] = undefined;
