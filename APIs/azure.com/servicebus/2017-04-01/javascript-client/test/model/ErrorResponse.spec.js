...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new ServiceBusManagementClient.ErrorResponse();
      //expect(instance).to.be.a(ServiceBusManagementClient.ErrorResponse);
    });
