...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.Subnet();
  });
  ...
  describe('Subnet', function() {
    it('should create an instance of Subnet', function() {
      ...
      //var instance = new ServiceBusManagementClient.Subnet();
      //expect(instance).to.be.a(ServiceBusManagementClient.Subnet);
    });
