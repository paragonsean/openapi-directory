...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.SBSku();
  });
  ...
  describe('SBSku', function() {
    it('should create an instance of SBSku', function() {
      // uncomment below and update the code to test SBSku
      //var instance = new ServiceBusManagementClient.SBSku();
      //expect(instance).to.be.a(ServiceBusManagementClient.SBSku);
    });
