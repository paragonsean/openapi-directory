...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.SBQueueProperties();
  });
  ...
  describe('SBQueueProperties', function() {
    it('should create an instance of SBQueueProperties', function() {
      // uncomment below and update the code to test SBQueueProperties
      //var instance = new ServiceBusManagementClient.SBQueueProperties();
      //expect(instance).to.be.a(ServiceBusManagementClient.SBQueueProperties);
    });
