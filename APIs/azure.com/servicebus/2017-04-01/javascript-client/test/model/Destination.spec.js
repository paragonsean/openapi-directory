...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.Destination();
  });
  ...
  describe('Destination', function() {
    it('should create an instance of Destination', function() {
      ...
      //var instance = new ServiceBusManagementClient.Destination();
      //expect(instance).to.be.a(ServiceBusManagementClient.Destination);
    });
