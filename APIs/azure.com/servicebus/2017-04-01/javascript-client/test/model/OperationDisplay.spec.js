...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new ServiceBusManagementClient.OperationDisplay();
      //expect(instance).to.be.a(ServiceBusManagementClient.OperationDisplay);
    });
