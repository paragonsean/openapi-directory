...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.NamespacesApi();
  });
  ...
  describe('NamespacesApi', function() {
    ...
    describe('namespacesCreateOrUpdateNetworkRuleSet', function() {
      it('should call namespacesCreateOrUpdateNetworkRuleSet successfully', function(done) {
        //uncomment below and update the code to test namespacesCreateOrUpdateNetworkRuleSet
        //instance.namespacesCreateOrUpdateNetworkRuleSet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('namespacesGetNetworkRuleSet', function() {
      it('should call namespacesGetNetworkRuleSet successfully', function(done) {
        //uncomment below and update the code to test namespacesGetNetworkRuleSet
        //instance.namespacesGetNetworkRuleSet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('namespacesListNetworkRuleSets', function() {
      it('should call namespacesListNetworkRuleSets successfully', function(done) {
        //uncomment below and update the code to test namespacesListNetworkRuleSets
        //instance.namespacesListNetworkRuleSets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('namespacesMigrate', function() {
      it('should call namespacesMigrate successfully', function(done) {
        //uncomment below and update the code to test namespacesMigrate
        //instance.namespacesMigrate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
