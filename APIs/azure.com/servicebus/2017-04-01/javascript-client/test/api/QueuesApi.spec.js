...
(function(root, factory) {
  ...
  describe('QueuesApi', function() {
    ...
    describe('queuesListByNamespace', function() {
      it('should call queuesListByNamespace successfully', function(done) {
        //uncomment below and update the code to test queuesListByNamespace
        //instance.queuesListByNamespace(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
