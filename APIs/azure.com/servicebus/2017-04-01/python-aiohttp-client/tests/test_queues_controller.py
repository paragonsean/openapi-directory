...
async def test_queues_create_or_update(client):
    ...
    """
    parameters = {"properties":{"accessedAt":"2000-01-23T04:56:07.000+00:00","messageCount":9,"sizeInBytes":3,"lockDuration":"lockDuration","enablePartitioning":True,"requiresSession":True,"deadLetteringOnMessageExpiration":True,"forwardDeadLetteredMessagesTo":"forwardDeadLetteredMessagesTo","forwardTo":"forwardTo","maxDeliveryCount":2,"createdAt":"2000-01-23T04:56:07.000+00:00","autoDeleteOnIdle":"autoDeleteOnIdle","enableBatchedOperations":True,"enableExpress":True,"maxSizeInMegabytes":7,"countDetails":{"scheduledMessageCount":1,"transferMessageCount":5,"transferDeadLetterMessageCount":5,"deadLetterMessageCount":6,"activeMessageCount":0},"duplicateDetectionHistoryTimeWindow":"duplicateDetectionHistoryTimeWindow","requiresDuplicateDetection":True,"defaultMessageTimeToLive":"defaultMessageTimeToLive","status":"Active","updatedAt":"2000-01-23T04:56:07.000+00:00"}}
...
async def test_queues_list_by_namespace(client):
