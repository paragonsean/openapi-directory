...
class Action(Model):
    ...
    def __init__(self, compatibility_level: int=None, requires_preprocessing: bool=True, sql_expression: str=None):
        ...
        :param compatibility_level: The compatibility_level of this Action.
        :param requires_preprocessing: The requires_preprocessing of this Action.
        :param sql_expression: The sql_expression of this Action.
        """
        self.openapi_types = {
    ...
    def compatibility_level(self):
        """Gets the compatibility_level of this Action.

        This property is reserved for future use. An integer value showing the compatibility level, currently hard-coded to 20.

        :return: The compatibility_level of this Action.
        :rtype: int
        """
    ...
    def compatibility_level(self, compatibility_level):
        """Sets the compatibility_level of this Action.
    ...
    def requires_preprocessing(self):
        """Gets the requires_preprocessing of this Action.

        Value that indicates whether the rule action requires preprocessing.

        :return: The requires_preprocessing of this Action.
        :rtype: bool
        """
    ...
    def requires_preprocessing(self, requires_preprocessing):
        """Sets the requires_preprocessing of this Action.
    ...
    def sql_expression(self):
        """Gets the sql_expression of this Action.

        SQL expression. e.g. MyProperty='ABC'

        :return: The sql_expression of this Action.
        :rtype: str
        """
    ...
    def sql_expression(self, sql_expression):
        """Sets the sql_expression of this Action.
