...
class SubscriptionResource {
    ...
    constructor() { 
        ...
        SubscriptionResource.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SubscriptionResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscriptionResource</code>.
     */
 ...
 */
SubscriptionResource.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
SubscriptionResource.prototype['id'] = undefined;

/**
 * Resource location.
 * @member {String} location
 */
SubscriptionResource.prototype['location'] = undefined;

/**
 * Resource name
 * @member {String} name
 */
SubscriptionResource.prototype['name'] = undefined;

/**
 * Resource type
 * @member {String} type
 */
SubscriptionResource.prototype['type'] = undefined;
