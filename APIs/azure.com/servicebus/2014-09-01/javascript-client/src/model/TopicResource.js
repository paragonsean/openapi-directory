...
class TopicResource {
    ...
    /**
     * Validates the JSON data with respect to <code>TopicResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TopicResource</code>.
     */
 ...
 */
TopicResource.prototype['properties'] = undefined;

/**
 * Resource Id
 * @member {String} id
 */
TopicResource.prototype['id'] = undefined;

/**
 * Resource location.
 * @member {String} location
 */
TopicResource.prototype['location'] = undefined;

/**
 * Resource name
 * @member {String} name
 */
TopicResource.prototype['name'] = undefined;

/**
 * Resource type
 * @member {String} type
 */
TopicResource.prototype['type'] = undefined;
