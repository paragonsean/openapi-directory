...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.SharedAccessAuthorizationRuleProperties();
  });
  ...
  describe('SharedAccessAuthorizationRuleProperties', function() {
    it('should create an instance of SharedAccessAuthorizationRuleProperties', function() {
      ...
      //var instance = new ServiceBusManagementClient.SharedAccessAuthorizationRuleProperties();
      //expect(instance).to.be.a(ServiceBusManagementClient.SharedAccessAuthorizationRuleProperties);
    });
