...
Q_SIGNALS:
    ...
    void queuesGetAuthorizationRuleSignal(OAISharedAccessAuthorizationRuleGetResource summary);
    ...
    void queuesGetAuthorizationRuleSignalFull(OAIHttpRequestWorker *worker, OAISharedAccessAuthorizationRuleGetResource summary);
    ...
    void queuesGetAuthorizationRuleSignalE(OAISharedAccessAuthorizationRuleGetResource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void queuesGetAuthorizationRuleSignalError(OAISharedAccessAuthorizationRuleGetResource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
