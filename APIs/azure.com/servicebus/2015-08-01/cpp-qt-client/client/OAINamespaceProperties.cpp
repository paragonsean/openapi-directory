...
void OAINamespaceProperties::initializeModel() {
    ...
    m_create_acs_namespace_isSet = false;
    m_create_acs_namespace_isValid = false;
...
void OAINamespaceProperties::fromJsonObject(QJsonObject json) {
    ...
    m_create_acs_namespace_isValid = ::OpenAPI::fromJsonValue(m_create_acs_namespace, json[QString("createACSNamespace")]);
    m_create_acs_namespace_isSet = !json[QString("createACSNamespace")].isNull() && m_create_acs_namespace_isValid;
...
QJsonObject OAINamespaceProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_create_acs_namespace_isSet) {
        obj.insert(QString("createACSNamespace"), ::OpenAPI::toJsonValue(m_create_acs_namespace));
    }
...
bool OAINamespaceProperties::isCreateAcsNamespace() const {
    return m_create_acs_namespace;
}
void OAINamespaceProperties::setCreateAcsNamespace(const bool &create_acs_namespace) {
    m_create_acs_namespace = create_acs_namespace;
    m_create_acs_namespace_isSet = true;
}

bool OAINamespaceProperties::is_create_acs_namespace_Set() const{
    return m_create_acs_namespace_isSet;
}

bool OAINamespaceProperties::is_create_acs_namespace_Valid() const{
    return m_create_acs_namespace_isValid;
}
