...
public:
    ...
    */
    virtual void topicsRegenerateKeys(const QString &resource_group_name, const QString &namespace_name, const QString &topic_name, const QString &authorization_rule_name, const QString &api_version, const QString &subscription_id, const OAIRegenerateKeysParameters &parameters);
...
Q_SIGNALS:
    ...
    void topicsGetAuthorizationRuleSignal(OAISharedAccessAuthorizationRuleResource summary);
    ...
    void topicsListKeysSignal(OAIResourceListKeys summary);
    void topicsPostAuthorizationRuleSignal(OAISharedAccessAuthorizationRuleResource summary);
    void topicsRegenerateKeysSignal(OAIResourceListKeys summary);
    ...
    void topicsGetAuthorizationRuleSignalFull(OAIHttpRequestWorker *worker, OAISharedAccessAuthorizationRuleResource summary);
    ...
    void topicsListKeysSignalFull(OAIHttpRequestWorker *worker, OAIResourceListKeys summary);
    void topicsPostAuthorizationRuleSignalFull(OAIHttpRequestWorker *worker, OAISharedAccessAuthorizationRuleResource summary);
    void topicsRegenerateKeysSignalFull(OAIHttpRequestWorker *worker, OAIResourceListKeys summary);
    ...
    void topicsGetAuthorizationRuleSignalE(OAISharedAccessAuthorizationRuleResource summary, QNetworkReply::NetworkError error_type, QString error_str);
    void topicsGetAuthorizationRuleSignalError(OAISharedAccessAuthorizationRuleResource summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void topicsListKeysSignalE(OAIResourceListKeys summary, QNetworkReply::NetworkError error_type, QString error_str);
    void topicsListKeysSignalError(OAIResourceListKeys summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void topicsRegenerateKeysSignalE(OAIResourceListKeys summary, QNetworkReply::NetworkError error_type, QString error_str);
    void topicsRegenerateKeysSignalError(OAIResourceListKeys summary, QNetworkReply::NetworkError error_type, const QString &error_str);
