...
> SharedAccessAuthorizationRuleResource topicsGetAuthorizationRule(resourceGroupName, namespaceName, topicName, authorizationRuleName, apiVersion, subscriptionId)
...
> ResourceListKeys topicsListKeys(resourceGroupName, namespaceName, topicName, authorizationRuleName, apiVersion, subscriptionId)
...
> ResourceListKeys topicsRegenerateKeys(resourceGroupName, namespaceName, topicName, authorizationRuleName, apiVersion, subscriptionId, parameters)
