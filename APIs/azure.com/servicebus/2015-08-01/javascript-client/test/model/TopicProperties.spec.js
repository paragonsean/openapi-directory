...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.TopicProperties();
  });
  ...
  describe('TopicProperties', function() {
    it('should create an instance of TopicProperties', function() {
      ...
      //var instance = new ServiceBusManagementClient.TopicProperties();
      //expect(instance).to.be.a(ServiceBusManagementClient.TopicProperties);
    });
    ...
    it('should have the property filteringMessagesBeforePublishing (base name: "filteringMessagesBeforePublishing")', function() {
      // uncomment below and update the code to test the property filteringMessagesBeforePublishing
      //var instance = new ServiceBusManagementClient.TopicProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isExpress (base name: "isExpress")', function() {
      // uncomment below and update the code to test the property isExpress
      //var instance = new ServiceBusManagementClient.TopicProperties();
      //expect(instance).to.be();
    });
