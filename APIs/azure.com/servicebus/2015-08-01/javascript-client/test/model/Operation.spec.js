...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBusManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ServiceBusManagementClient.Operation();
      //expect(instance).to.be.a(ServiceBusManagementClient.Operation);
    });
