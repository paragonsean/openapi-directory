...
|**maxDeliveryCount** | **Integer** | The maximum delivery count. A message is automatically deadlettered after this number of deliveries. |  [optional] |
|**maxSizeInMegabytes** | **Long** | The maximum size of the queue in megabytes, which is the size of memory allocated for the queue. |  [optional] |
