...
import ManagedInstanceAdministratorProperties from './model/ManagedInstanceAdministratorProperties';
import ProxyResource from './model/ProxyResource';
import Resource from './model/Resource';
import ManagedInstanceAdministratorsApi from './api/ManagedInstanceAdministratorsApi';
...
export {
    ...
    /**
     * The ManagedInstanceAdministrator model constructor.
     * @property {module:model/ManagedInstanceAdministrator}
     */
    ManagedInstanceAdministrator,

    /**
     * The ManagedInstanceAdministratorListResult model constructor.
     * @property {module:model/ManagedInstanceAdministratorListResult}
     */
    ManagedInstanceAdministratorListResult,

    /**
     * The ManagedInstanceAdministratorProperties model constructor.
     * @property {module:model/ManagedInstanceAdministratorProperties}
     */
    ...
    /**
    * The ManagedInstanceAdministratorsApi service constructor.
    * @property {module:api/ManagedInstanceAdministratorsApi}
    */
