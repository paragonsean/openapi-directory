...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.QueryText();
  });
  ...
  describe('QueryText', function() {
    it('should create an instance of QueryText', function() {
      ...
      //var instance = new MariaDbManagementClient.QueryText();
      //expect(instance).to.be.a(MariaDbManagementClient.QueryText);
    });
