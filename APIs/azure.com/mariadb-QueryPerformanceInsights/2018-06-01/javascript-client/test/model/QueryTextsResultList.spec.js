...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.QueryTextsResultList();
  });
  ...
  describe('QueryTextsResultList', function() {
    it('should create an instance of QueryTextsResultList', function() {
      // uncomment below and update the code to test QueryTextsResultList
      //var instance = new MariaDbManagementClient.QueryTextsResultList();
      //expect(instance).to.be.a(MariaDbManagementClient.QueryTextsResultList);
    });
