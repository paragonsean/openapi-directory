...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.WaitStatistic();
  });
  ...
  describe('WaitStatistic', function() {
    it('should create an instance of WaitStatistic', function() {
      ...
      //var instance = new MariaDbManagementClient.WaitStatistic();
      //expect(instance).to.be.a(MariaDbManagementClient.WaitStatistic);
    });
