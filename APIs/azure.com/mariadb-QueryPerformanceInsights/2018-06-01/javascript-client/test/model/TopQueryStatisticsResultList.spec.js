...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.TopQueryStatisticsResultList();
  });
  ...
  describe('TopQueryStatisticsResultList', function() {
    it('should create an instance of TopQueryStatisticsResultList', function() {
      ...
      //var instance = new MariaDbManagementClient.TopQueryStatisticsResultList();
      //expect(instance).to.be.a(MariaDbManagementClient.TopQueryStatisticsResultList);
    });
