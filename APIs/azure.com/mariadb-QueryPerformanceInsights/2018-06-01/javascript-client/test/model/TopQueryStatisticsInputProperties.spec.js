...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.TopQueryStatisticsInputProperties();
  });
  ...
  describe('TopQueryStatisticsInputProperties', function() {
    it('should create an instance of TopQueryStatisticsInputProperties', function() {
      ...
      //var instance = new MariaDbManagementClient.TopQueryStatisticsInputProperties();
      //expect(instance).to.be.a(MariaDbManagementClient.TopQueryStatisticsInputProperties);
    });
