...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.QueryTextProperties();
  });
  ...
  describe('QueryTextProperties', function() {
    it('should create an instance of QueryTextProperties', function() {
      ...
      //var instance = new MariaDbManagementClient.QueryTextProperties();
      //expect(instance).to.be.a(MariaDbManagementClient.QueryTextProperties);
    });
