...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.QueryStatistic();
  });
  ...
  describe('QueryStatistic', function() {
    it('should create an instance of QueryStatistic', function() {
      ...
      //var instance = new MariaDbManagementClient.QueryStatistic();
      //expect(instance).to.be.a(MariaDbManagementClient.QueryStatistic);
    });
