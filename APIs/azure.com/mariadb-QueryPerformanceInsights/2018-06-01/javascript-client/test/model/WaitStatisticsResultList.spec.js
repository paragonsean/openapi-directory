...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.WaitStatisticsResultList();
  });
  ...
  describe('WaitStatisticsResultList', function() {
    it('should create an instance of WaitStatisticsResultList', function() {
      // uncomment below and update the code to test WaitStatisticsResultList
      //var instance = new MariaDbManagementClient.WaitStatisticsResultList();
      //expect(instance).to.be.a(MariaDbManagementClient.WaitStatisticsResultList);
    });
