...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MariaDbManagementClient.WaitStatisticsInputProperties();
  });
  ...
  describe('WaitStatisticsInputProperties', function() {
    it('should create an instance of WaitStatisticsInputProperties', function() {
      // uncomment below and update the code to test WaitStatisticsInputProperties
      //var instance = new MariaDbManagementClient.WaitStatisticsInputProperties();
      //expect(instance).to.be.a(MariaDbManagementClient.WaitStatisticsInputProperties);
    });
