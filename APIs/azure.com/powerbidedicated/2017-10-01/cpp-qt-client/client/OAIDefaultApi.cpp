...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("capacitiesListSkus", defaultConf);
    _serverIndices.insert("capacitiesListSkus", 0);
}
...
void OAIDefaultApi::capacitiesListSkus(const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["capacitiesListSkus"][_serverIndices.value("capacitiesListSkus")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.PowerBIDedicated/skus");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::capacitiesListSkusCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::capacitiesListSkusCallback);
...
void OAIDefaultApi::capacitiesListSkusCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT capacitiesListSkusSignal(output);
        Q_EMIT capacitiesListSkusSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT capacitiesListSkusSignalE(output, error_type, error_str);
        Q_EMIT capacitiesListSkusSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT capacitiesListSkusSignalError(output, error_type, error_str);
        Q_EMIT capacitiesListSkusSignalErrorFull(worker, error_type, error_str);
    }
}
