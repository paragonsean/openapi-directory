...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiDedicated.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new PowerBiDedicated.OperationDisplay();
      //expect(instance).to.be.a(PowerBiDedicated.OperationDisplay);
    });
