...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerBiDedicated.OperationListResult();
  });
  ...
  describe('OperationListResult', function() {
    it('should create an instance of OperationListResult', function() {
      ...
      //var instance = new PowerBiDedicated.OperationListResult();
      //expect(instance).to.be.a(PowerBiDedicated.OperationListResult);
    });
