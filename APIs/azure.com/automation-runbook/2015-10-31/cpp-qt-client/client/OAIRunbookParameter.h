...
/*
 * OAIRunbookParameter.h
 *
 * Definition of the runbook parameter type.
 */

#ifndef OAIRunbookParameter_H
#define OAIRunbookParameter_H
...
class OAIRunbookParameter : public OAIObject {
public:
    OAIRunbookParameter();
    OAIRunbookParameter(QString json);
    ~OAIRunbookParameter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRunbookParameter)

#endif // OAIRunbookParameter_H
