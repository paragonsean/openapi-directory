...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomationManagement.RunbookParameter();
  });
  ...
  describe('RunbookParameter', function() {
    it('should create an instance of RunbookParameter', function() {
      // uncomment below and update the code to test RunbookParameter
      //var instance = new AutomationManagement.RunbookParameter();
      //expect(instance).to.be.a(AutomationManagement.RunbookParameter);
    });
