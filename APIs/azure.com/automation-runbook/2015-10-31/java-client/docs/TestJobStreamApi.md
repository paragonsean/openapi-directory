...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TestJobStreamsListByTestJob200ResponseValueInner result = apiInstance.testJobStreamsGet(subscriptionId, resourceGroupName, automationAccountName, runbookName, jobStreamId, apiVersion);
...
> TestJobStreamsListByTestJob200Response testJobStreamsListByTestJob(subscriptionId, resourceGroupName, automationAccountName, runbookName, apiVersion, $filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TestJobStreamsListByTestJob200Response result = apiInstance.testJobStreamsListByTestJob(subscriptionId, resourceGroupName, automationAccountName, runbookName, apiVersion, $filter);
      System.out.println(result);
    } catch (ApiException e) {
