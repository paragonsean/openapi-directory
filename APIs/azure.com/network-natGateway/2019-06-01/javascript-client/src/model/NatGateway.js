...
class NatGateway {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = NatGatewayPropertiesFormat.constructFromObject(data['properties']);
            }
            if (data.hasOwnProperty('sku')) {
                obj['sku'] = NatGatewaySku.constructFromObject(data['sku']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>NatGateway</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NatGateway</code>.
     */
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          NatGatewayPropertiesFormat.validateJSON(data['properties']);
        }
        // validate the optional field `sku`
        if (data['sku']) { // data not null
          NatGatewaySku.validateJSON(data['sku']);
        }
 ...
 * @member {String} etag
 */
NatGateway.prototype['etag'] = undefined;

/**
 * @member {module:model/NatGatewayPropertiesFormat} properties
 */
NatGateway.prototype['properties'] = undefined;

/**
 * @member {module:model/NatGatewaySku} sku
 */
NatGateway.prototype['sku'] = undefined;

/**
 * A list of availability zones denoting the zone in which Nat Gateway should be deployed.
 * @member {Array.<String>} zones
 */
NatGateway.prototype['zones'] = undefined;

/**
 * Resource ID.
 * @member {String} id
 */
NatGateway.prototype['id'] = undefined;

/**
 * Resource location.
 * @member {String} location
 */
NatGateway.prototype['location'] = undefined;

/**
 * Resource name.
 * @member {String} name
 */
NatGateway.prototype['name'] = undefined;
 ...
 * @member {String} type
 */
NatGateway.prototype['type'] = undefined;
