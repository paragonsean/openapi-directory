...
async def test_nat_gateways_create_or_update(client):
    ...
    """
    parameters = {"etag":"etag","sku":{"name":"Standard"},"zones":["zones","zones"],"properties":{"publicIpPrefixes":[{"id":"id"},{"id":"id"}],"publicIpAddresses":[{"id":"id"},{"id":"id"}],"resourceGuid":"resourceGuid","idleTimeoutInMinutes":0,"subnets":[{"id":"id"},{"id":"id"}],"provisioningState":"provisioningState"}}
