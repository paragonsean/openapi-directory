...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementClient.NatGateway();
  });
  ...
  describe('NatGateway', function() {
    it('should create an instance of NatGateway', function() {
      ...
      //var instance = new NetworkManagementClient.NatGateway();
      //expect(instance).to.be.a(NetworkManagementClient.NatGateway);
    });
