...
export default class ManagementPoliciesApi {
    ...
    */
     ...
     * @param {module:model/StorageAccountManagementPolicies} data The data returned by the service call.
     ...
     * @param {module:model/ManagementPoliciesRulesSetParameter} properties The data policy rules to set to a storage account.
     ...
     * data is of type: {@link module:model/StorageAccountManagementPolicies}
     */
    managementPoliciesCreateOrUpdate(resourceGroupName, accountName, apiVersion, subscriptionId, managementPolicyName, properties, callback) {
      ...
      let returnType = StorageAccountManagementPolicies;
