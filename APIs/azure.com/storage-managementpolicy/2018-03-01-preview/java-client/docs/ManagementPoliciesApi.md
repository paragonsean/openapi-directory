...
public class Example {
  public static void main(String[] args) {
    ...
    String managementPolicyName = "default"; // String | The name of the Storage Account Management Policy. It should always be 'default'
    try {
      StorageAccountManagementPolicies result = apiInstance.managementPoliciesGet(resourceGroupName, accountName, apiVersion, subscriptionId, managementPolicyName);
      System.out.println(result);
    } catch (ApiException e) {
