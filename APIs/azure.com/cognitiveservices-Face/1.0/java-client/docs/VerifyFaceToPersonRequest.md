...
|------------ | ------------- | ------------- | -------------|
|**faceId** | **UUID** | FaceId of the face, comes from Face - Detect |  |
...
|**personId** | **UUID** | Specify a certain person in a person group or a large person group. personId is created in PersonGroup Person - Create or LargePersonGroup Person - Create. |  |
