...
/**
 * The LargePersonGroup model module.
 * @module model/LargePersonGroup
 * @version 1.0
 */
class LargePersonGroup {
    /**
     * Constructs a new <code>LargePersonGroup</code>.
     * Large person group object.
     * @alias module:model/LargePersonGroup
     * @implements module:model/MetaDataContract
     */
    constructor() { 
        MetaDataContract.initialize(this);
        LargePersonGroup.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['largePersonGroupId'] = largePersonGroupId;
    }

    /**
     * Constructs a <code>LargePersonGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LargePersonGroup} obj Optional instance to populate.
     * @return {module:model/LargePersonGroup} The populated <code>LargePersonGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LargePersonGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>LargePersonGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LargePersonGroup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LargePersonGroup.RequiredProperties) {
...
LargePersonGroup.RequiredProperties = ["largePersonGroupId"];

/**
 * LargePersonGroupId of the target large person groups
 * @member {String} largePersonGroupId
 */
LargePersonGroup.prototype['largePersonGroupId'] = undefined;

/**
 * @member {module:model/RecognitionModel} recognitionModel
 */
LargePersonGroup.prototype['recognitionModel'] = undefined;

/**
 * User defined name, maximum length is 128.
 * @member {String} name
 */
LargePersonGroup.prototype['name'] = undefined;

/**
 * User specified data. Length should not exceed 16KB.
 * @member {String} userData
 */
LargePersonGroup.prototype['userData'] = undefined;
...
export default LargePersonGroup;
