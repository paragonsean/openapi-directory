...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FaceClient.MetaDataContract();
  });
  ...
  describe('MetaDataContract', function() {
    it('should create an instance of MetaDataContract', function() {
      // uncomment below and update the code to test MetaDataContract
      //var instance = new FaceClient.MetaDataContract();
      //expect(instance).to.be.a(FaceClient.MetaDataContract);
    });
