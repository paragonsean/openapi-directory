...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FaceClient.IdentifyCandidate();
  });
  ...
  describe('IdentifyCandidate', function() {
    it('should create an instance of IdentifyCandidate', function() {
      // uncomment below and update the code to test IdentifyCandidate
      //var instance = new FaceClient.IdentifyCandidate();
      //expect(instance).to.be.a(FaceClient.IdentifyCandidate);
    });
