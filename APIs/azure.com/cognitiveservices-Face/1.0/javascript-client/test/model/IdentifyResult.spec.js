...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FaceClient.IdentifyResult();
  });
  ...
  describe('IdentifyResult', function() {
    it('should create an instance of IdentifyResult', function() {
      // uncomment below and update the code to test IdentifyResult
      //var instance = new FaceClient.IdentifyResult();
      //expect(instance).to.be.a(FaceClient.IdentifyResult);
    });
