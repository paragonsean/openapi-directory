...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FaceClient.Person();
  });
  ...
  describe('Person', function() {
    it('should create an instance of Person', function() {
      ...
      //var instance = new FaceClient.Person();
      //expect(instance).to.be.a(FaceClient.Person);
    });

    it('should have the property persistedFaceIds (base name: "persistedFaceIds")', function() {
      // uncomment below and update the code to test the property persistedFaceIds
      //var instance = new FaceClient.Person();
