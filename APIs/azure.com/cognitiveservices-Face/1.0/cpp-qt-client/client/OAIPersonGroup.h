...
#ifndef OAIPersonGroup_H
#define OAIPersonGroup_H
...
class OAIPersonGroup : public OAIObject {
public:
    OAIPersonGroup();
    OAIPersonGroup(QString json);
    ~OAIPersonGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonGroup)

#endif // OAIPersonGroup_H
