# ExecutionService.EnvironmentDefinition
...
**environmentVariables** | **{String: String}** | Definition of environment variables to be defined in the environment. | [optional] 
