...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExecutionService.RunDefinition();
  });
  ...
  describe('RunDefinition', function() {
    it('should create an instance of RunDefinition', function() {
      // uncomment below and update the code to test RunDefinition
      //var instance = new ExecutionService.RunDefinition();
      //expect(instance).to.be.a(ExecutionService.RunDefinition);
    });
    ...
    it('should have the property parentRunId (base name: "parentRunId")', function() {
      // uncomment below and update the code to test the property parentRunId
      //var instance = new ExecutionService.RunDefinition();
      //expect(instance).to.be();
    });
