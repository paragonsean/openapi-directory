...
|------------ | ------------- | ------------- | -------------|
|**_configuration** | [**RunConfiguration**](RunConfiguration.md) |  |  [optional] |
...
|**snapshotId** | **UUID** | Snapshots are user project folders that have been uploaded to the cloud for subsequent  execution. This field is required when executing against cloud-based compute targets  unless the run submission was against the API endpoint that takes a zipped project folder  inline with the request. |  [optional] |
