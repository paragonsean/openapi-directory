...
#ifndef OAIPythonSection_H
#define OAIPythonSection_H
...
class OAIPythonSection : public OAIObject {
public:
    OAIPythonSection();
    OAIPythonSection(QString json);
    ~OAIPythonSection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPythonSection)

#endif // OAIPythonSection_H
