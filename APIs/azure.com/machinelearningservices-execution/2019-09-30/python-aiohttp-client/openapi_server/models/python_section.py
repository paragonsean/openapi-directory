...
class PythonSection(Model):
    ...
    def __init__(self, base_conda_environment: str=None, conda_dependencies: object=None, interpreter_path: str=None, user_managed_dependencies: bool=None):
        """PythonSection - a model defined in OpenAPI

        :param base_conda_environment: The base_conda_environment of this PythonSection.
        :param conda_dependencies: The conda_dependencies of this PythonSection.
        :param interpreter_path: The interpreter_path of this PythonSection.
        :param user_managed_dependencies: The user_managed_dependencies of this PythonSection.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PythonSection':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PythonSection of this PythonSection.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def base_conda_environment(self):
        """Gets the base_conda_environment of this PythonSection.


        :return: The base_conda_environment of this PythonSection.
        :rtype: str
        """
    ...
    def base_conda_environment(self, base_conda_environment):
        """Sets the base_conda_environment of this PythonSection.
    ...
    def conda_dependencies(self):
        """Gets the conda_dependencies of this PythonSection.


        :return: The conda_dependencies of this PythonSection.
        :rtype: object
        """
    ...
    def conda_dependencies(self, conda_dependencies):
        """Sets the conda_dependencies of this PythonSection.
    ...
    def interpreter_path(self):
        """Gets the interpreter_path of this PythonSection.

        The python interpreter path. This is only used when user_managed_dependencies=True.

        :return: The interpreter_path of this PythonSection.
        :rtype: str
        """
    ...
    def interpreter_path(self, interpreter_path):
        """Sets the interpreter_path of this PythonSection.
    ...
    def user_managed_dependencies(self):
        """Gets the user_managed_dependencies of this PythonSection.

        True means that AzureML reuses an existing python environment; False means that AzureML will create a python environment based on the Conda dependencies specification.

        :return: The user_managed_dependencies of this PythonSection.
        :rtype: bool
        """
    ...
    def user_managed_dependencies(self, user_managed_dependencies):
        """Sets the user_managed_dependencies of this PythonSection.
