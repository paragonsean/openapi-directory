...
public class ExecutionApiTest {
     ...
     */
    @Test
    public void runsCancelRunWithUriTest() throws ApiException {
        UUID subscriptionId = null;
        String resourceGroupName = null;
        String workspaceName = null;
        String experimentName = null;
        String runId = null;
        StartRunResult response = api.runsCancelRunWithUri(subscriptionId, resourceGroupName, workspaceName, experimentName, runId);
     ...
     */
    @Test
    public void runsStartLocalRunTest() throws ApiException {
        UUID subscriptionId = null;
        String resourceGroupName = null;
        String workspaceName = null;
        String experimentName = null;
        ...
        String runId = null;
        File response = api.runsStartLocalRun(subscriptionId, resourceGroupName, workspaceName, experimentName, definition, runId);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void runsStartRunTest() throws ApiException {
        UUID subscriptionId = null;
        String resourceGroupName = null;
        String workspaceName = null;
        String experimentName = null;
        ...
        String runId = null;
        StartRunResult response = api.runsStartRun(subscriptionId, resourceGroupName, workspaceName, experimentName, runDefinitionFile, projectZipFile, runId);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void runsStartSnapshotRunTest() throws ApiException {
        UUID subscriptionId = null;
        String resourceGroupName = null;
        String workspaceName = null;
        String experimentName = null;
        RunDefinition definition = null;
        String runId = null;
        StartRunResult response = api.runsStartSnapshotRun(subscriptionId, resourceGroupName, workspaceName, experimentName, definition, runId);
        // TODO: test validations
    }
