...
void OAICollectionApi::servicesList(const QString &api_version, const QString &subscription_id) {
    QString fullPath = QString(_serverConfigs["servicesList"][_serverIndices.value("servicesList")].URL()+"/subscriptions/{subscriptionId}/providers/Microsoft.HealthcareApis/services");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionApi::servicesListCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionApi::servicesListCallback);
...
void OAICollectionApi::servicesListCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIServicesDescriptionListResult output(QString(worker->response));
    worker->deleteLater();
...
void OAICollectionApi::servicesListByResourceGroup(const QString &api_version, const QString &subscription_id, const QString &resource_group_name) {
    QString fullPath = QString(_serverConfigs["servicesListByResourceGroup"][_serverIndices.value("servicesListByResourceGroup")].URL()+"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/services");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionApi::servicesListByResourceGroupCallback);
    connect(this, &OAICollectionApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionApi::servicesListByResourceGroupCallback);
    connect(this, &OAICollectionApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICollectionApi::servicesListByResourceGroupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
