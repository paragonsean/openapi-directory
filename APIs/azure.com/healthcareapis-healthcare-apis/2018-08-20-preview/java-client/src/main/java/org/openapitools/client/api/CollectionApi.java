...
public class CollectionApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> This is a synchronous operation. The body contains a JSON-serialized array of the metadata from all the service instances in the subscription. </td><td>  -  </td></tr>
    ...
    public okhttp3.Call servicesListCall(String apiVersion, String subscriptionId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/subscriptions/{subscriptionId}/providers/Microsoft.HealthcareApis/services"
     ...
     */
    public ServicesDescriptionListResult servicesList(String apiVersion, String subscriptionId) throws ApiException {
        ApiResponse<ServicesDescriptionListResult> localVarResp = servicesListWithHttpInfo(apiVersion, subscriptionId);
     ...
     * @param apiVersion The version of the API. (required)
     * @param subscriptionId The subscription identifier. (required)
     * @return ApiResponse&lt;ServicesDescriptionListResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ServicesDescriptionListResult> servicesListWithHttpInfo(String apiVersion, String subscriptionId) throws ApiException {
        okhttp3.Call localVarCall = servicesListValidateBeforeCall(apiVersion, subscriptionId, null);
        Type localVarReturnType = new TypeToken<ServicesDescriptionListResult>(){}.getType();
     ...
     */
    public okhttp3.Call servicesListAsync(String apiVersion, String subscriptionId, final ApiCallback<ServicesDescriptionListResult> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> This is a synchronous operation. The body contains a JSON-serialized array of the metadata from all the service instances in the resource group. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> DefaultErrorResponse </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call servicesListByResourceGroupCall(String apiVersion, String subscriptionId, String resourceGroupName, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/services"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()))
     ...
     */
    public ServicesDescriptionListResult servicesListByResourceGroup(String apiVersion, String subscriptionId, String resourceGroupName) throws ApiException {
        ApiResponse<ServicesDescriptionListResult> localVarResp = servicesListByResourceGroupWithHttpInfo(apiVersion, subscriptionId, resourceGroupName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ServicesDescriptionListResult> servicesListByResourceGroupWithHttpInfo(String apiVersion, String subscriptionId, String resourceGroupName) throws ApiException {
     ...
     */
    public okhttp3.Call servicesListByResourceGroupAsync(String apiVersion, String subscriptionId, String resourceGroupName, final ApiCallback<ServicesDescriptionListResult> _callback) throws ApiException {
