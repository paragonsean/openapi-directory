...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthcareApisClient.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new HealthcareApisClient.ErrorDetails();
      //expect(instance).to.be.a(HealthcareApisClient.ErrorDetails);
    });
