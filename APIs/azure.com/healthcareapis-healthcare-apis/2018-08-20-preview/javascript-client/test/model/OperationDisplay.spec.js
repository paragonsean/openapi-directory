...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HealthcareApisClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new HealthcareApisClient.OperationDisplay();
      //expect(instance).to.be.a(HealthcareApisClient.OperationDisplay);
    });
