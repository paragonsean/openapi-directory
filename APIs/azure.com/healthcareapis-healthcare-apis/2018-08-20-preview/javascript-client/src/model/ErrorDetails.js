...
import ErrorDetailsInternal from './ErrorDetailsInternal';
...
class ErrorDetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = ErrorDetailsInternal.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['error']) { // data not null
          ErrorDetailsInternal.validateJSON(data['error']);
        }
...
/**
 * @member {module:model/ErrorDetailsInternal} error
 */
