...
public class ErrorDetails {
  ...
  public ErrorDetails error(ErrorDetailsInternal error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorDetailsInternal getError() {
    return error;
  }

  public void setError(ErrorDetailsInternal error) {
    this.error = error;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        ErrorDetailsInternal.validateJsonElement(jsonObj.get("error"));
      }
  }
