...
QList<QString> OAIStreamingLocatorProperties::getFilters() const {
    return m_filters;
}
void OAIStreamingLocatorProperties::setFilters(const QList<QString> &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIStreamingLocatorProperties::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIStreamingLocatorProperties::is_filters_Valid() const{
