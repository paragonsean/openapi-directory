...
void OAIEnvelopeEncryption::initializeModel() {
    ...
    m_custom_key_acquisition_url_template_isSet = false;
    m_custom_key_acquisition_url_template_isValid = false;
...
void OAIEnvelopeEncryption::fromJsonObject(QJsonObject json) {
    ...
    m_custom_key_acquisition_url_template_isValid = ::OpenAPI::fromJsonValue(m_custom_key_acquisition_url_template, json[QString("customKeyAcquisitionUrlTemplate")]);
    m_custom_key_acquisition_url_template_isSet = !json[QString("customKeyAcquisitionUrlTemplate")].isNull() && m_custom_key_acquisition_url_template_isValid;
...
QJsonObject OAIEnvelopeEncryption::asJsonObject() const {
    ...
    if (m_custom_key_acquisition_url_template_isSet) {
        obj.insert(QString("customKeyAcquisitionUrlTemplate"), ::OpenAPI::toJsonValue(m_custom_key_acquisition_url_template));
    }
...
QString OAIEnvelopeEncryption::getCustomKeyAcquisitionUrlTemplate() const {
    return m_custom_key_acquisition_url_template;
}
void OAIEnvelopeEncryption::setCustomKeyAcquisitionUrlTemplate(const QString &custom_key_acquisition_url_template) {
    m_custom_key_acquisition_url_template = custom_key_acquisition_url_template;
    m_custom_key_acquisition_url_template_isSet = true;
}

bool OAIEnvelopeEncryption::is_custom_key_acquisition_url_template_Set() const{
    return m_custom_key_acquisition_url_template_isSet;
}

bool OAIEnvelopeEncryption::is_custom_key_acquisition_url_template_Valid() const{
    return m_custom_key_acquisition_url_template_isValid;
}
