...
OAICommonEncryptionCenc::OAICommonEncryptionCenc(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommonEncryptionCenc::OAICommonEncryptionCenc() {
    this->initializeModel();
}

OAICommonEncryptionCenc::~OAICommonEncryptionCenc() {}

void OAICommonEncryptionCenc::initializeModel() {
...
void OAICommonEncryptionCenc::fromJson(QString jsonString) {
...
void OAICommonEncryptionCenc::fromJsonObject(QJsonObject json) {
...
QString OAICommonEncryptionCenc::asJson() const {
...
QJsonObject OAICommonEncryptionCenc::asJsonObject() const {
    QJsonObject obj;
...
QList<OAITrackSelection> OAICommonEncryptionCenc::getClearTracks() const {
    return m_clear_tracks;
}
void OAICommonEncryptionCenc::setClearTracks(const QList<OAITrackSelection> &clear_tracks) {
    m_clear_tracks = clear_tracks;
    m_clear_tracks_isSet = true;
}

bool OAICommonEncryptionCenc::is_clear_tracks_Set() const{
    return m_clear_tracks_isSet;
}

bool OAICommonEncryptionCenc::is_clear_tracks_Valid() const{
    return m_clear_tracks_isValid;
}

OAIStreamingPolicyContentKeys OAICommonEncryptionCenc::getContentKeys() const {
    return m_content_keys;
}
void OAICommonEncryptionCenc::setContentKeys(const OAIStreamingPolicyContentKeys &content_keys) {
    m_content_keys = content_keys;
    m_content_keys_isSet = true;
}

bool OAICommonEncryptionCenc::is_content_keys_Set() const{
    return m_content_keys_isSet;
}

bool OAICommonEncryptionCenc::is_content_keys_Valid() const{
    return m_content_keys_isValid;
}

OAICencDrmConfiguration OAICommonEncryptionCenc::getDrm() const {
    return m_drm;
}
void OAICommonEncryptionCenc::setDrm(const OAICencDrmConfiguration &drm) {
    m_drm = drm;
    m_drm_isSet = true;
}

bool OAICommonEncryptionCenc::is_drm_Set() const{
    return m_drm_isSet;
}

bool OAICommonEncryptionCenc::is_drm_Valid() const{
    return m_drm_isValid;
}

OAIEnabledProtocols OAICommonEncryptionCenc::getEnabledProtocols() const {
    return m_enabled_protocols;
}
void OAICommonEncryptionCenc::setEnabledProtocols(const OAIEnabledProtocols &enabled_protocols) {
    m_enabled_protocols = enabled_protocols;
    m_enabled_protocols_isSet = true;
}

bool OAICommonEncryptionCenc::is_enabled_protocols_Set() const{
    return m_enabled_protocols_isSet;
}

bool OAICommonEncryptionCenc::is_enabled_protocols_Valid() const{
    return m_enabled_protocols_isValid;
}

bool OAICommonEncryptionCenc::isSet() const {
...
bool OAICommonEncryptionCenc::isValid() const {
