...
public class CommonEncryptionCenc {
  ...
  public CommonEncryptionCenc clearTracks(List<TrackSelection> clearTracks) {
    this.clearTracks = clearTracks;
    return this;
  }

  public CommonEncryptionCenc addClearTracksItem(TrackSelection clearTracksItem) {
  ...
  public CommonEncryptionCenc contentKeys(StreamingPolicyContentKeys contentKeys) {
  ...
  public CommonEncryptionCenc drm(CencDrmConfiguration drm) {
    this.drm = drm;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CencDrmConfiguration getDrm() {
    return drm;
  }

  public void setDrm(CencDrmConfiguration drm) {
    this.drm = drm;
  }


  public CommonEncryptionCenc enabledProtocols(EnabledProtocols enabledProtocols) {
  ...
  public boolean equals(Object o) {
    ...
    CommonEncryptionCenc commonEncryptionCenc = (CommonEncryptionCenc) o;
    return Objects.equals(this.clearTracks, commonEncryptionCenc.clearTracks) &&
        Objects.equals(this.contentKeys, commonEncryptionCenc.contentKeys) &&
        Objects.equals(this.drm, commonEncryptionCenc.drm) &&
        Objects.equals(this.enabledProtocols, commonEncryptionCenc.enabledProtocols);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommonEncryptionCenc
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonEncryptionCenc.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonEncryptionCenc is not found in the empty JSON string", CommonEncryptionCenc.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonEncryptionCenc.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonEncryptionCenc` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("drm") != null && !jsonObj.get("drm").isJsonNull()) {
        CencDrmConfiguration.validateJsonElement(jsonObj.get("drm"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonEncryptionCenc.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonEncryptionCenc' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonEncryptionCenc> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonEncryptionCenc.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonEncryptionCenc>() {
           @Override
           public void write(JsonWriter out, CommonEncryptionCenc value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommonEncryptionCenc read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommonEncryptionCenc given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommonEncryptionCenc
   * @throws IOException if the JSON string is invalid with respect to CommonEncryptionCenc
   */
  public static CommonEncryptionCenc fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonEncryptionCenc.class);
  }

  /**
   * Convert an instance of CommonEncryptionCenc to an JSON string
   *
   * @return JSON string
   */
