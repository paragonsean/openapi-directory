...
public class StreamingLocatorContentKey {
  ...
  public StreamingLocatorContentKey label(String label) {
    this.label = label;
    return this;
  }
  ...
  public StreamingLocatorContentKey policyName(String policyName) {
  ...
  public StreamingLocatorContentKey tracks(List<TrackSelection> tracks) {
    this.tracks = tracks;
    return this;
  }

  public StreamingLocatorContentKey addTracksItem(TrackSelection tracksItem) {
    if (this.tracks == null) {
  ...
  public StreamingLocatorContentKey type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, streamingLocatorContentKey.id) &&
        Objects.equals(this.label, streamingLocatorContentKey.label) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, label, policyName, tracks, type, value);
  }
