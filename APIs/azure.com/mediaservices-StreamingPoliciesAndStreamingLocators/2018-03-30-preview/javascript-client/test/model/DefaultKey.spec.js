...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AzureMediaServices.DefaultKey();
  });
  ...
  describe('DefaultKey', function() {
    it('should create an instance of DefaultKey', function() {
      // uncomment below and update the code to test DefaultKey
      //var instance = new AzureMediaServices.DefaultKey();
      //expect(instance).to.be.a(AzureMediaServices.DefaultKey);
    });
