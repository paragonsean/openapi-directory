...
import StreamingLocatorUserDefinedContentKey from './StreamingLocatorUserDefinedContentKey';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('contentKeys')) {
                obj['contentKeys'] = ApiClient.convertToType(data['contentKeys'], [StreamingLocatorUserDefinedContentKey]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['contentKeys']) { // data not null
            ...
            for (const item of data['contentKeys']) {
                StreamingLocatorUserDefinedContentKey.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/StreamingLocatorUserDefinedContentKey>} contentKeys
 */
