...
class StreamingLocatorContentKey {
     ...
     * @param type {module:model/StreamingLocatorContentKey.TypeEnum} Encryption type of Content Key
     */
    constructor(id, type) { 
        
        StreamingLocatorContentKey.initialize(this, id, type);
    }
...
StreamingLocatorContentKey.RequiredProperties = ["id", "type"];
