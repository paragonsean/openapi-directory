...
class EnvelopeEncryption(Model):
    ...
    def __init__(self, clear_tracks: List[TrackSelection]=None, content_keys: StreamingPolicyContentKeys=None, custom_license_acquisition_url_template: str=None, enabled_protocols: EnabledProtocols=None):
        ...
        :param custom_license_acquisition_url_template: The custom_license_acquisition_url_template of this EnvelopeEncryption.
    ...
    def custom_license_acquisition_url_template(self):
        """Gets the custom_license_acquisition_url_template of this EnvelopeEncryption.

        LicenseAcquisitionUrlTemplate is used to point to user specified service to delivery content keys

        :return: The custom_license_acquisition_url_template of this EnvelopeEncryption.
        :rtype: str
        """
    ...
    def custom_license_acquisition_url_template(self, custom_license_acquisition_url_template):
        """Sets the custom_license_acquisition_url_template of this EnvelopeEncryption.
