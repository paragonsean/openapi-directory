...
class StreamingLocatorProperties(Model):
    ...
    def __init__(self, asset_name: str=None, content_keys: List[StreamingLocatorUserDefinedContentKey]=None, created: datetime=None, default_content_key_policy_name: str=None, end_time: datetime=None, start_time: datetime=None, streaming_locator_id: str=None, streaming_policy_name: str=None):
        ...
        self.openapi_types = {
            'asset_name': str,
            'content_keys': List[StreamingLocatorUserDefinedContentKey],
            'created': datetime,
    ...
    def content_keys(self):
        ...
        :rtype: List[StreamingLocatorUserDefinedContentKey]
        """
    ...
    def content_keys(self, content_keys):
        ...
        :param content_keys: The content_keys of this StreamingLocatorProperties.
        :type content_keys: List[StreamingLocatorUserDefinedContentKey]
        """
