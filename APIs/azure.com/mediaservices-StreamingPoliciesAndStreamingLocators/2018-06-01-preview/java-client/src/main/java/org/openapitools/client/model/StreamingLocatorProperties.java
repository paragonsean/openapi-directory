...
public class StreamingLocatorProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alternativeMediaId, assetName, contentKeys, created, defaultContentKeyPolicyName, endTime, startTime, streamingLocatorId, streamingPolicyName);
  }
