...
QString OAIStreamingLocatorProperties::getAlternativeMediaId() const {
    return m_alternative_media_id;
}
void OAIStreamingLocatorProperties::setAlternativeMediaId(const QString &alternative_media_id) {
    m_alternative_media_id = alternative_media_id;
    m_alternative_media_id_isSet = true;
}

bool OAIStreamingLocatorProperties::is_alternative_media_id_Set() const{
    return m_alternative_media_id_isSet;
}

bool OAIStreamingLocatorProperties::is_alternative_media_id_Valid() const{
...
QList<OAIStreamingLocatorContentKey> OAIStreamingLocatorProperties::getContentKeys() const {
    return m_content_keys;
}
void OAIStreamingLocatorProperties::setContentKeys(const QList<OAIStreamingLocatorContentKey> &content_keys) {
