...
public:
    ...
    * @param[in]  parameters OAICheckNameAvailabilityRequest [required]
    */
    virtual void serversCheckNameAvailability(const QString &api_version, const QString &subscription_id, const OAICheckNameAvailabilityRequest &parameters);
...
Q_SIGNALS:
    ...
    void serversCheckNameAvailabilitySignal(OAICheckNameAvailabilityResponse summary);


    void serversCheckNameAvailabilitySignalFull(OAIHttpRequestWorker *worker, OAICheckNameAvailabilityResponse summary);

    Q_DECL_DEPRECATED_X("Use serversCheckNameAvailabilitySignalError() instead")
    void serversCheckNameAvailabilitySignalE(OAICheckNameAvailabilityResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serversCheckNameAvailabilitySignalError(OAICheckNameAvailabilityResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
