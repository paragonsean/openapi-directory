...
bool OAICheckNameAvailabilityResponse::isAvailable() const {
    return m_available;
}
void OAICheckNameAvailabilityResponse::setAvailable(const bool &available) {
    m_available = available;
    m_available_isSet = true;
}

bool OAICheckNameAvailabilityResponse::is_available_Set() const{
    return m_available_isSet;
}

bool OAICheckNameAvailabilityResponse::is_available_Valid() const{
...
QString OAICheckNameAvailabilityResponse::getName() const {
    return m_name;
}
void OAICheckNameAvailabilityResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICheckNameAvailabilityResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAICheckNameAvailabilityResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICheckNameAvailabilityResponse::getReason() const {
    return m_reason;
}
void OAICheckNameAvailabilityResponse::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}
