...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerLockbox.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new CustomerLockbox.OperationDisplay();
      //expect(instance).to.be.a(CustomerLockbox.OperationDisplay);
    });
