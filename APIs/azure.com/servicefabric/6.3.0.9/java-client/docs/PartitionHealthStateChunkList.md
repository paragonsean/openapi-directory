...
|------------ | ------------- | ------------- | -------------|
|**items** | [**List&lt;PartitionHealthStateChunk&gt;**](PartitionHealthStateChunk.md) | The list of partition health state chunks that respect the input filters in the chunk query. |  [optional] |
