...
<a id="getServiceTypeInfoByName"></a>
# **getServiceTypeInfoByName**
> ServiceTypeInfo getServiceTypeInfoByName(apiVersion, applicationTypeName, applicationTypeVersion, serviceTypeName, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      ServiceTypeInfo result = apiInstance.getServiceTypeInfoByName(apiVersion, applicationTypeName, applicationTypeVersion, serviceTypeName, timeout);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServiceTypeApi#getServiceTypeInfoByName");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | A specific service type which supported by a provisioned application type. |  -  |
| **204** | A 204 response is returned if the specified service type is not found in the cluster. |  -  |
| **0** | The detailed error response. |  -  |
