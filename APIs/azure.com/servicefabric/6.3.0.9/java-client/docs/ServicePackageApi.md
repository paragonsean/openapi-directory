...
<a id="deployServicePackageToNode"></a>
# **deployServicePackageToNode**
> deployServicePackageToNode(apiVersion, nodeName, deployServicePackageToNodeDescription, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deployServicePackageToNode(apiVersion, nodeName, deployServicePackageToNodeDescription, timeout);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicePackageApi#deployServicePackageToNode");
...
> List&lt;DeployedServicePackageInfo&gt; getDeployedServicePackageInfoListByName(apiVersion, nodeName, applicationId, servicePackageName, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      List<DeployedServicePackageInfo> result = apiInstance.getDeployedServicePackageInfoListByName(apiVersion, nodeName, applicationId, servicePackageName, timeout);
      System.out.println(result);
    } catch (ApiException e) {
