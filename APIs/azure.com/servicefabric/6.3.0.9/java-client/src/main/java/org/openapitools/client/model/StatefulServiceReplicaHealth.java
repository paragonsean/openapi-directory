...
public class StatefulServiceReplicaHealth {
  ...
  public StatefulServiceReplicaHealth aggregatedHealthState(HealthState aggregatedHealthState) {
  ...
  public StatefulServiceReplicaHealth healthEvents(List<HealthEvent> healthEvents) {
    this.healthEvents = healthEvents;
    return this;
  }

  public StatefulServiceReplicaHealth addHealthEventsItem(HealthEvent healthEventsItem) {
  ...
  public StatefulServiceReplicaHealth healthStatistics(HealthStatistics healthStatistics) {
  ...
  public StatefulServiceReplicaHealth unhealthyEvaluations(List<HealthEvaluationWrapper> unhealthyEvaluations) {
    this.unhealthyEvaluations = unhealthyEvaluations;
    return this;
  }

  public StatefulServiceReplicaHealth addUnhealthyEvaluationsItem(HealthEvaluationWrapper unhealthyEvaluationsItem) {
  ...
  public StatefulServiceReplicaHealth partitionId(UUID partitionId) {
  ...
  public StatefulServiceReplicaHealth serviceKind(ServiceKind serviceKind) {
  ...
  public StatefulServiceReplicaHealth replicaId(String replicaId) {
  ...
  public boolean equals(Object o) {
    ...
    StatefulServiceReplicaHealth statefulServiceReplicaHealth = (StatefulServiceReplicaHealth) o;
    return Objects.equals(this.aggregatedHealthState, statefulServiceReplicaHealth.aggregatedHealthState) &&
        Objects.equals(this.healthEvents, statefulServiceReplicaHealth.healthEvents) &&
        Objects.equals(this.healthStatistics, statefulServiceReplicaHealth.healthStatistics) &&
        Objects.equals(this.unhealthyEvaluations, statefulServiceReplicaHealth.unhealthyEvaluations) &&
        Objects.equals(this.partitionId, statefulServiceReplicaHealth.partitionId) &&
        Objects.equals(this.serviceKind, statefulServiceReplicaHealth.serviceKind) &&
        Objects.equals(this.replicaId, statefulServiceReplicaHealth.replicaId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregatedHealthState, healthEvents, healthStatistics, unhealthyEvaluations, partitionId, serviceKind, replicaId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatefulServiceReplicaHealth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulServiceReplicaHealth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulServiceReplicaHealth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulServiceReplicaHealth is not found in the empty JSON string", StatefulServiceReplicaHealth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulServiceReplicaHealth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulServiceReplicaHealth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatefulServiceReplicaHealth.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulServiceReplicaHealth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulServiceReplicaHealth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulServiceReplicaHealth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulServiceReplicaHealth.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulServiceReplicaHealth>() {
           @Override
           public void write(JsonWriter out, StatefulServiceReplicaHealth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulServiceReplicaHealth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulServiceReplicaHealth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulServiceReplicaHealth
   * @throws IOException if the JSON string is invalid with respect to StatefulServiceReplicaHealth
   */
  public static StatefulServiceReplicaHealth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulServiceReplicaHealth.class);
  }

  /**
   * Convert an instance of StatefulServiceReplicaHealth to an JSON string
   *
   * @return JSON string
   */
