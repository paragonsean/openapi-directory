...
public class EntityHealth {
  ...
  public EntityHealth aggregatedHealthState(HealthState aggregatedHealthState) {
  ...
  public EntityHealth healthEvents(List<HealthEvent> healthEvents) {
    this.healthEvents = healthEvents;
    return this;
  }

  public EntityHealth addHealthEventsItem(HealthEvent healthEventsItem) {
  ...
  public EntityHealth healthStatistics(HealthStatistics healthStatistics) {
  ...
  public EntityHealth unhealthyEvaluations(List<HealthEvaluationWrapper> unhealthyEvaluations) {
    this.unhealthyEvaluations = unhealthyEvaluations;
    return this;
  }

  public EntityHealth addUnhealthyEvaluationsItem(HealthEvaluationWrapper unhealthyEvaluationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    EntityHealth entityHealth = (EntityHealth) o;
    return Objects.equals(this.aggregatedHealthState, entityHealth.aggregatedHealthState) &&
        Objects.equals(this.healthEvents, entityHealth.healthEvents) &&
        Objects.equals(this.healthStatistics, entityHealth.healthStatistics) &&
        Objects.equals(this.unhealthyEvaluations, entityHealth.unhealthyEvaluations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregatedHealthState, healthEvents, healthStatistics, unhealthyEvaluations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntityHealth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityHealth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityHealth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityHealth is not found in the empty JSON string", EntityHealth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntityHealth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityHealth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityHealth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityHealth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityHealth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityHealth.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityHealth>() {
           @Override
           public void write(JsonWriter out, EntityHealth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntityHealth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntityHealth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityHealth
   * @throws IOException if the JSON string is invalid with respect to EntityHealth
   */
  public static EntityHealth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityHealth.class);
  }

  /**
   * Convert an instance of EntityHealth to an JSON string
   *
   * @return JSON string
   */
