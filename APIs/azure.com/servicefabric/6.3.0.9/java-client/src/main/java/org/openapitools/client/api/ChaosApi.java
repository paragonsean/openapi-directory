...
public class ChaosApi {
     ...
     * @param startTimeUtc The Windows file time representing the start time of the time range for which a Chaos report is to be generated. Consult [DateTime.ToFileTimeUtc Method](https://msdn.microsoft.com/library/system.datetime.tofiletimeutc(v&#x3D;vs.110).aspx) for details. (optional)
     * @param endTimeUtc The Windows file time representing the end time of the time range for which a Chaos report is to be generated. Consult [DateTime.ToFileTimeUtc Method](https://msdn.microsoft.com/library/system.datetime.tofiletimeutc(v&#x3D;vs.110).aspx) for details. (optional)
     ...
     */
    public okhttp3.Call getChaosScheduleCall(String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getChaosScheduleValidateBeforeCall(String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getChaosSchedule(Async)");
        }

        return getChaosScheduleCall(apiVersion, timeout, _callback);
     ...
     */
    public ChaosScheduleDescription getChaosSchedule(String apiVersion, Long timeout) throws ApiException {
        ApiResponse<ChaosScheduleDescription> localVarResp = getChaosScheduleWithHttpInfo(apiVersion, timeout);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChaosScheduleDescription> getChaosScheduleWithHttpInfo(String apiVersion, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = getChaosScheduleValidateBeforeCall(apiVersion, timeout, null);
     ...
     */
    public okhttp3.Call getChaosScheduleAsync(String apiVersion, Long timeout, final ApiCallback<ChaosScheduleDescription> _callback) throws ApiException {

        okhttp3.Call localVarCall = getChaosScheduleValidateBeforeCall(apiVersion, timeout, _callback);
        Type localVarReturnType = new TypeToken<ChaosScheduleDescription>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call postChaosScheduleCall(String apiVersion, ChaosScheduleDescription chaosSchedule, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postChaosScheduleValidateBeforeCall(String apiVersion, ChaosScheduleDescription chaosSchedule, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
        ...
        return postChaosScheduleCall(apiVersion, chaosSchedule, timeout, _callback);
     ...
     */
    public void postChaosSchedule(String apiVersion, ChaosScheduleDescription chaosSchedule, Long timeout) throws ApiException {
        postChaosScheduleWithHttpInfo(apiVersion, chaosSchedule, timeout);
    }
     ...
     */
    public ApiResponse<Void> postChaosScheduleWithHttpInfo(String apiVersion, ChaosScheduleDescription chaosSchedule, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = postChaosScheduleValidateBeforeCall(apiVersion, chaosSchedule, timeout, null);
     ...
     */
    public okhttp3.Call postChaosScheduleAsync(String apiVersion, ChaosScheduleDescription chaosSchedule, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = postChaosScheduleValidateBeforeCall(apiVersion, chaosSchedule, timeout, _callback);
