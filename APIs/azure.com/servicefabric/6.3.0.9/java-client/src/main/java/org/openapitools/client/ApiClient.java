...
public class ApiClient {
    ...
    private String basePath = "http://azure.local:19080";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://azure.local:19080",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://azure.local:19080",
      "No description provided",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/6.3.0.9/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://azure.local:19080
