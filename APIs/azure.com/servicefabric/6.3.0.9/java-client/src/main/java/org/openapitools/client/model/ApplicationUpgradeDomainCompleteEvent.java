...
public class ApplicationUpgradeDomainCompleteEvent extends ApplicationEvent {
  ...
  public ApplicationUpgradeDomainCompleteEvent applicationTypeName(String applicationTypeName) {
  ...
  public ApplicationUpgradeDomainCompleteEvent applicationTypeVersion(String applicationTypeVersion) {
  ...
  public ApplicationUpgradeDomainCompleteEvent currentApplicationTypeVersion(String currentApplicationTypeVersion) {
  ...
  public ApplicationUpgradeDomainCompleteEvent upgradeDomainElapsedTimeInMs(Double upgradeDomainElapsedTimeInMs) {
  ...
  public ApplicationUpgradeDomainCompleteEvent upgradeDomains(String upgradeDomains) {
  ...
  public ApplicationUpgradeDomainCompleteEvent upgradeState(String upgradeState) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationUpgradeDomainCompleteEvent applicationUpgradeDomainCompleteEvent = (ApplicationUpgradeDomainCompleteEvent) o;
    return Objects.equals(this.applicationTypeName, applicationUpgradeDomainCompleteEvent.applicationTypeName) &&
        Objects.equals(this.applicationTypeVersion, applicationUpgradeDomainCompleteEvent.applicationTypeVersion) &&
        Objects.equals(this.currentApplicationTypeVersion, applicationUpgradeDomainCompleteEvent.currentApplicationTypeVersion) &&
        Objects.equals(this.upgradeDomainElapsedTimeInMs, applicationUpgradeDomainCompleteEvent.upgradeDomainElapsedTimeInMs) &&
        Objects.equals(this.upgradeDomains, applicationUpgradeDomainCompleteEvent.upgradeDomains) &&
        Objects.equals(this.upgradeState, applicationUpgradeDomainCompleteEvent.upgradeState) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationUpgradeDomainCompleteEvent {\n");
  ...
  static {
    ...
    openapiFields.add("UpgradeDomainElapsedTimeInMs");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationUpgradeDomainCompleteEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationUpgradeDomainCompleteEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationUpgradeDomainCompleteEvent is not found in the empty JSON string", ApplicationUpgradeDomainCompleteEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationUpgradeDomainCompleteEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationUpgradeDomainCompleteEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicationUpgradeDomainCompleteEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationUpgradeDomainCompleteEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationUpgradeDomainCompleteEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationUpgradeDomainCompleteEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationUpgradeDomainCompleteEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationUpgradeDomainCompleteEvent>() {
           @Override
           public void write(JsonWriter out, ApplicationUpgradeDomainCompleteEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationUpgradeDomainCompleteEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationUpgradeDomainCompleteEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationUpgradeDomainCompleteEvent
   * @throws IOException if the JSON string is invalid with respect to ApplicationUpgradeDomainCompleteEvent
   */
  public static ApplicationUpgradeDomainCompleteEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationUpgradeDomainCompleteEvent.class);
  }

  /**
   * Convert an instance of ApplicationUpgradeDomainCompleteEvent to an JSON string
   *
   * @return JSON string
   */
