...
public class ClusterEvent extends FabricEvent {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterEvent is not found in the empty JSON string", ClusterEvent.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of ClusterEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterEvent
   * @throws IOException if the JSON string is invalid with respect to ClusterEvent
   */
  public static ClusterEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterEvent.class);
  }

  /**
   * Convert an instance of ClusterEvent to an JSON string
   *
   * @return JSON string
   */
