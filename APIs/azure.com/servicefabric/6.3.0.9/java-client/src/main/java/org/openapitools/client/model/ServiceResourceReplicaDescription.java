...
public class ServiceResourceReplicaDescription {
  ...
  public ServiceResourceReplicaDescription codePackages(List<ContainerCodePackageProperties> codePackages) {
    this.codePackages = codePackages;
    return this;
  }

  public ServiceResourceReplicaDescription addCodePackagesItem(ContainerCodePackageProperties codePackagesItem) {
  ...
  public ServiceResourceReplicaDescription diagnostics(DiagnosticsRef diagnostics) {
  ...
  public ServiceResourceReplicaDescription networkRefs(List<NetworkRef> networkRefs) {
    this.networkRefs = networkRefs;
    return this;
  }

  public ServiceResourceReplicaDescription addNetworkRefsItem(NetworkRef networkRefsItem) {
  ...
  public ServiceResourceReplicaDescription osType(OsTypeEnum osType) {
    this.osType = osType;
    return this;
  }
  ...
  public ServiceResourceReplicaDescription replicaName(String replicaName) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceResourceReplicaDescription serviceResourceReplicaDescription = (ServiceResourceReplicaDescription) o;
    return Objects.equals(this.codePackages, serviceResourceReplicaDescription.codePackages) &&
        Objects.equals(this.diagnostics, serviceResourceReplicaDescription.diagnostics) &&
        Objects.equals(this.networkRefs, serviceResourceReplicaDescription.networkRefs) &&
        Objects.equals(this.osType, serviceResourceReplicaDescription.osType) &&
        Objects.equals(this.replicaName, serviceResourceReplicaDescription.replicaName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceResourceReplicaDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceResourceReplicaDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceResourceReplicaDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceResourceReplicaDescription is not found in the empty JSON string", ServiceResourceReplicaDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceResourceReplicaDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceResourceReplicaDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServiceResourceReplicaDescription.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceResourceReplicaDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceResourceReplicaDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceResourceReplicaDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceResourceReplicaDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceResourceReplicaDescription>() {
           @Override
           public void write(JsonWriter out, ServiceResourceReplicaDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceResourceReplicaDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceResourceReplicaDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceResourceReplicaDescription
   * @throws IOException if the JSON string is invalid with respect to ServiceResourceReplicaDescription
   */
  public static ServiceResourceReplicaDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceResourceReplicaDescription.class);
  }

  /**
   * Convert an instance of ServiceResourceReplicaDescription to an JSON string
   *
   * @return JSON string
   */
