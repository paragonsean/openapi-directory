...
class DeployedStatefulServiceReplicaDetailInfo(Model):
    ...
    def __init__(self, current_service_operation: ServiceOperationName=None, current_service_operation_start_time_utc: datetime=None, partition_id: str=None, reported_load: List[LoadMetricReportInfo]=None, service_kind: ServiceKind=None, service_name: str=None, current_replicator_operation: ReplicatorOperationName=None, deployed_service_replica_query_result: DeployedStatefulServiceReplicaInfo=None, read_status: PartitionAccessStatus=None, replica_id: str=None, replica_status: KeyValueStoreReplicaStatus=None, replicator_status: ReplicatorStatus=None, write_status: PartitionAccessStatus=None):
