...
class ProvisionApplicationTypeDescription(Model):
    ...
    def __init__(self, _async: bool=None, kind: ProvisionApplicationTypeKind=None, application_package_cleanup_policy: ApplicationPackageCleanupPolicy=None, application_type_build_path: str=None):
