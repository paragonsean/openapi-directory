...
class ApplicationCreatedEvent(Model):
    ...
    def __init__(self, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None, application_id: str=None, application_definition_kind: str=None, application_type_name: str=None, application_type_version: str=None):
