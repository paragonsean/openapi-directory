...
class HealthEvent(Model):
    ...
    def __init__(self, description: str=None, health_state: HealthState=None, _property: str=None, remove_when_expired: bool=None, sequence_number: str=None, source_id: str=None, time_to_live_in_milli_seconds: str=None, is_expired: bool=None, last_error_transition_at: datetime=None, last_modified_utc_timestamp: datetime=None, last_ok_transition_at: datetime=None, last_warning_transition_at: datetime=None, source_utc_timestamp: datetime=None):
