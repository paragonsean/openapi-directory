...
class DeployedStatelessServiceInstanceDetailInfo(Model):
    ...
    def __init__(self, current_service_operation: ServiceOperationName=None, current_service_operation_start_time_utc: datetime=None, partition_id: str=None, reported_load: List[LoadMetricReportInfo]=None, service_kind: ServiceKind=None, service_name: str=None, deployed_service_replica_query_result: DeployedStatelessServiceInstanceInfo=None, instance_id: str=None):
