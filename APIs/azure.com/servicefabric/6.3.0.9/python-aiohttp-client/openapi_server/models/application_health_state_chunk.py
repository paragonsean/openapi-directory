...
class ApplicationHealthStateChunk(Model):
    ...
    def __init__(self, health_state: HealthState=None, application_name: str=None, application_type_name: str=None, deployed_application_health_state_chunks: DeployedApplicationHealthStateChunkList=None, service_health_state_chunks: ServiceHealthStateChunkList=None):
