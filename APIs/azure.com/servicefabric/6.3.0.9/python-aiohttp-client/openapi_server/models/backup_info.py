...
class BackupInfo(Model):
    ...
    def __init__(self, application_name: str=None, backup_chain_id: str=None, backup_id: str=None, backup_location: str=None, backup_type: BackupType=None, creation_time_utc: datetime=None, epoch_of_last_backup_record: BackupEpoch=None, failure_error: FabricErrorError=None, lsn_of_last_backup_record: str=None, partition_information: PartitionInformation=None, service_name: str=None):
