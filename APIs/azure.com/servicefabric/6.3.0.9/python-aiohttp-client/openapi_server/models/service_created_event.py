...
class ServiceCreatedEvent(Model):
    ...
    def __init__(self, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None, service_id: str=None, application_name: str=None, application_type_name: str=None, is_stateful: bool=None, min_replica_set_size: int=None, partition_count: int=None, partition_id: str=None, service_instance: int=None, service_package_version: str=None, service_type_name: str=None, target_replica_set_size: int=None):
