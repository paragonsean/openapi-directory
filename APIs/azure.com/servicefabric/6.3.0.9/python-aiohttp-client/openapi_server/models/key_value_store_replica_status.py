...
class KeyValueStoreReplicaStatus(Model):
    ...
    def __init__(self, kind: ReplicaKind=None, copy_notification_current_key_filter: str=None, copy_notification_current_progress: str=None, database_logical_size_estimate: str=None, database_row_count_estimate: str=None, status_details: str=None):
