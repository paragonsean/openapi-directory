...
class ApplicationBackupConfigurationInfo(Model):
    ...
    def __init__(self, kind: BackupEntityKind=None, policy_inherited_from: BackupPolicyScope=None, policy_name: str=None, suspension_info: BackupSuspensionInfo=None, application_name: str=None):
