...
class BackupPolicyDescription(Model):
    ...
    def __init__(self, auto_restore_on_data_loss: bool=None, max_incremental_backups: int=None, name: str=None, schedule: BackupScheduleDescription=None, storage: BackupStorageDescription=None):
