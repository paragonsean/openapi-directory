...
class ExternalStoreProvisionApplicationTypeDescription(Model):
    ...
    def __init__(self, _async: bool=None, kind: ProvisionApplicationTypeKind=None, application_package_download_uri: str=None, application_type_name: str=None, application_type_version: str=None):
