...
class FabricErrorCodes(Model):
    ...
    def __init__(self):
        """FabricErrorCodes - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FabricErrorCodes':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FabricErrorCodes of this FabricErrorCodes.
        """
