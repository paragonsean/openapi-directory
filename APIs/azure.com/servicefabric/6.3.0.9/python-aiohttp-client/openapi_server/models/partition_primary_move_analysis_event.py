...
class PartitionPrimaryMoveAnalysisEvent(Model):
    ...
    def __init__(self, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None, partition_id: str=None, metadata: AnalysisEventMetadata=None, current_node: str=None, move_reason: str=None, previous_node: str=None, relevant_traces: str=None, when_move_completed: datetime=None):
