...
async def disable_application_backup(request: web.Request, application_id, api_version, timeout=None) -> web.Response:
...
async def disable_partition_backup(request: web.Request, partition_id, api_version, timeout=None) -> web.Response:
...
async def disable_service_backup(request: web.Request, service_id, api_version, timeout=None) -> web.Response:
