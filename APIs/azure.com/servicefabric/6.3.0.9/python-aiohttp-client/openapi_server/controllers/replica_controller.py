...
async def get_replica_info(request: web.Request, api_version, partition_id, replica_id, timeout=None) -> web.Response:
...
async def report_replica_health(request: web.Request, api_version, partition_id, replica_id, replica_health_report_service_kind, health_information, immediate=None, timeout=None) -> web.Response:
    ...
    :param replica_id: The identifier of the replica.
    :type replica_id: str
    :param replica_health_report_service_kind: The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values.
