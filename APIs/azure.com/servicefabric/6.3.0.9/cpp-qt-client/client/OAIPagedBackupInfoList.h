...
#ifndef OAIPagedBackupInfoList_H
#define OAIPagedBackupInfoList_H
...
class OAIPagedBackupInfoList : public OAIObject {
public:
    OAIPagedBackupInfoList();
    OAIPagedBackupInfoList(QString json);
    ~OAIPagedBackupInfoList() override;
    ...
    QList<OAIBackupInfo> getItems() const;
    void setItems(const QList<OAIBackupInfo> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagedBackupInfoList)

#endif // OAIPagedBackupInfoList_H
