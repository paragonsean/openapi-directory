...
/*
 * OAIServiceHealthReportCreatedEvent.h
 *
 * Service Health Report Created event.
 */

#ifndef OAIServiceHealthReportCreatedEvent_H
#define OAIServiceHealthReportCreatedEvent_H
...
class OAIServiceHealthReportCreatedEvent : public OAIObject {
public:
    OAIServiceHealthReportCreatedEvent();
    OAIServiceHealthReportCreatedEvent(QString json);
    ~OAIServiceHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceHealthReportCreatedEvent)

#endif // OAIServiceHealthReportCreatedEvent_H
