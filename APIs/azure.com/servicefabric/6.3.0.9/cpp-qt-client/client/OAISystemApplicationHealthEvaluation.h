...
/*
 * OAISystemApplicationHealthEvaluation.h
 *
...
#ifndef OAISystemApplicationHealthEvaluation_H
#define OAISystemApplicationHealthEvaluation_H
...
class OAISystemApplicationHealthEvaluation : public OAIObject {
public:
    OAISystemApplicationHealthEvaluation();
    OAISystemApplicationHealthEvaluation(QString json);
    ~OAISystemApplicationHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISystemApplicationHealthEvaluation)

#endif // OAISystemApplicationHealthEvaluation_H
