...
OAIEpoch OAIStatefulServicePartitionInfo::getCurrentConfigurationEpoch() const {
    return m_current_configuration_epoch;
}
void OAIStatefulServicePartitionInfo::setCurrentConfigurationEpoch(const OAIEpoch &current_configuration_epoch) {
    m_current_configuration_epoch = current_configuration_epoch;
    m_current_configuration_epoch_isSet = true;
}

bool OAIStatefulServicePartitionInfo::is_current_configuration_epoch_Set() const{
    return m_current_configuration_epoch_isSet;
}

bool OAIStatefulServicePartitionInfo::is_current_configuration_epoch_Valid() const{
