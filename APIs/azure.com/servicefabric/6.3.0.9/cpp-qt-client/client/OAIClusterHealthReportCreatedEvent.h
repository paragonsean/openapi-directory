...
/*
 * OAIClusterHealthReportCreatedEvent.h
 *
 * Cluster Health Report Created event.
 */

#ifndef OAIClusterHealthReportCreatedEvent_H
#define OAIClusterHealthReportCreatedEvent_H
...
class OAIClusterHealthReportCreatedEvent : public OAIObject {
public:
    OAIClusterHealthReportCreatedEvent();
    OAIClusterHealthReportCreatedEvent(QString json);
    ~OAIClusterHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterHealthReportCreatedEvent)

#endif // OAIClusterHealthReportCreatedEvent_H
