...
/*
 * OAIApplicationUpgradeRollbackCompleteEvent.h
 *
 * Application Upgrade Rollback Complete event.
 */

#ifndef OAIApplicationUpgradeRollbackCompleteEvent_H
#define OAIApplicationUpgradeRollbackCompleteEvent_H
...
class OAIApplicationUpgradeRollbackCompleteEvent : public OAIObject {
public:
    OAIApplicationUpgradeRollbackCompleteEvent();
    OAIApplicationUpgradeRollbackCompleteEvent(QString json);
    ~OAIApplicationUpgradeRollbackCompleteEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeRollbackCompleteEvent)

#endif // OAIApplicationUpgradeRollbackCompleteEvent_H
