...
/*
 * OAINodeOpenFailedEvent.h
 *
 * Node Open Failed event.
 */

#ifndef OAINodeOpenFailedEvent_H
#define OAINodeOpenFailedEvent_H
...
class OAINodeOpenFailedEvent : public OAIObject {
public:
    OAINodeOpenFailedEvent();
    OAINodeOpenFailedEvent(QString json);
    ~OAINodeOpenFailedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeOpenFailedEvent)

#endif // OAINodeOpenFailedEvent_H
