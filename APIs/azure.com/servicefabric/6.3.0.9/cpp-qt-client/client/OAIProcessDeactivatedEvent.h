...
/*
 * OAIProcessDeactivatedEvent.h
 *
 * Process Deactivated event.
 */

#ifndef OAIProcessDeactivatedEvent_H
#define OAIProcessDeactivatedEvent_H
...
class OAIProcessDeactivatedEvent : public OAIObject {
public:
    OAIProcessDeactivatedEvent();
    OAIProcessDeactivatedEvent(QString json);
    ~OAIProcessDeactivatedEvent() override;
    ...
    void setExeName(const QString &exe_name);
    bool is_exe_name_Set() const;
    bool is_exe_name_Valid() const;
    ...
    void setProcessId(const qint64 &process_id);
...
private:
    ...
    QString m_exe_name;
    bool m_exe_name_isSet;
    bool m_exe_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcessDeactivatedEvent)

#endif // OAIProcessDeactivatedEvent_H
