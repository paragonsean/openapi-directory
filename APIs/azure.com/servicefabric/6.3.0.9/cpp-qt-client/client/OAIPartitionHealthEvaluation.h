...
/*
 * OAIPartitionHealthEvaluation.h
 *
...
#ifndef OAIPartitionHealthEvaluation_H
#define OAIPartitionHealthEvaluation_H
...
class OAIPartitionHealthEvaluation : public OAIObject {
public:
    OAIPartitionHealthEvaluation();
    OAIPartitionHealthEvaluation(QString json);
    ~OAIPartitionHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionHealthEvaluation)

#endif // OAIPartitionHealthEvaluation_H
