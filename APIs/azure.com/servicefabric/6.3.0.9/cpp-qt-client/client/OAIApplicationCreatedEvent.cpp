...
bool OAIApplicationCreatedEvent::isValid() const {
    ...
    return m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && m_application_id_isValid && m_application_definition_kind_isValid && m_application_type_name_isValid && m_application_type_version_isValid && true;
}
