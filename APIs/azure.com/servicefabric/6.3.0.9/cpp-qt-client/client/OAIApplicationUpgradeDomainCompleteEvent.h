...
/*
 * OAIApplicationUpgradeDomainCompleteEvent.h
 *
 * Application Upgrade Domain Complete event.
 */

#ifndef OAIApplicationUpgradeDomainCompleteEvent_H
#define OAIApplicationUpgradeDomainCompleteEvent_H
...
class OAIApplicationUpgradeDomainCompleteEvent : public OAIObject {
public:
    OAIApplicationUpgradeDomainCompleteEvent();
    OAIApplicationUpgradeDomainCompleteEvent(QString json);
    ~OAIApplicationUpgradeDomainCompleteEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeDomainCompleteEvent)

#endif // OAIApplicationUpgradeDomainCompleteEvent_H
