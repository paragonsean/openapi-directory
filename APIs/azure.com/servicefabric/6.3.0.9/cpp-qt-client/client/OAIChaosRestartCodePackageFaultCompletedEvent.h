...
/*
 * OAIChaosRestartCodePackageFaultCompletedEvent.h
 *
 * Chaos Restart Code Package Fault Completed event.
 */

#ifndef OAIChaosRestartCodePackageFaultCompletedEvent_H
#define OAIChaosRestartCodePackageFaultCompletedEvent_H
...
class OAIChaosRestartCodePackageFaultCompletedEvent : public OAIObject {
public:
    OAIChaosRestartCodePackageFaultCompletedEvent();
    OAIChaosRestartCodePackageFaultCompletedEvent(QString json);
    ~OAIChaosRestartCodePackageFaultCompletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosRestartCodePackageFaultCompletedEvent)

#endif // OAIChaosRestartCodePackageFaultCompletedEvent_H
