...
/*
 * OAIApplicationEvent.h
 *
 * Represents the base for all Application Events.
 */

#ifndef OAIApplicationEvent_H
#define OAIApplicationEvent_H
...
class OAIApplicationEvent : public OAIObject {
public:
    OAIApplicationEvent();
    OAIApplicationEvent(QString json);
    ~OAIApplicationEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationEvent)

#endif // OAIApplicationEvent_H
