...
/*
 * OAIApplicationUpgradeRollbackStartEvent.h
 *
 * Application Upgrade Rollback Start event.
 */

#ifndef OAIApplicationUpgradeRollbackStartEvent_H
#define OAIApplicationUpgradeRollbackStartEvent_H
...
class OAIApplicationUpgradeRollbackStartEvent : public OAIObject {
public:
    OAIApplicationUpgradeRollbackStartEvent();
    OAIApplicationUpgradeRollbackStartEvent(QString json);
    ~OAIApplicationUpgradeRollbackStartEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeRollbackStartEvent)

#endif // OAIApplicationUpgradeRollbackStartEvent_H
