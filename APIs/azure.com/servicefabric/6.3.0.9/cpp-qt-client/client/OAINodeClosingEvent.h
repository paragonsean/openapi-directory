...
/*
 * OAINodeClosingEvent.h
 *
 * Node Closing event.
 */

#ifndef OAINodeClosingEvent_H
#define OAINodeClosingEvent_H
...
class OAINodeClosingEvent : public OAIObject {
public:
    OAINodeClosingEvent();
    OAINodeClosingEvent(QString json);
    ~OAINodeClosingEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeClosingEvent)

#endif // OAINodeClosingEvent_H
