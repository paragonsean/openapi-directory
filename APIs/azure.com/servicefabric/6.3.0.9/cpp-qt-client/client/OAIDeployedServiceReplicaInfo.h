...
/*
 * OAIDeployedServiceReplicaInfo.h
 *
 * Information about a Service Fabric service replica deployed on a node.
 */

#ifndef OAIDeployedServiceReplicaInfo_H
#define OAIDeployedServiceReplicaInfo_H
...
class OAIDeployedServiceReplicaInfo : public OAIObject {
public:
    OAIDeployedServiceReplicaInfo();
    OAIDeployedServiceReplicaInfo(QString json);
    ~OAIDeployedServiceReplicaInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedServiceReplicaInfo)

#endif // OAIDeployedServiceReplicaInfo_H
