...
/*
 * OAIDeployedApplicationHealthEvaluation.h
 *
...
#ifndef OAIDeployedApplicationHealthEvaluation_H
#define OAIDeployedApplicationHealthEvaluation_H
...
class OAIDeployedApplicationHealthEvaluation : public OAIObject {
public:
    OAIDeployedApplicationHealthEvaluation();
    OAIDeployedApplicationHealthEvaluation(QString json);
    ~OAIDeployedApplicationHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedApplicationHealthEvaluation)

#endif // OAIDeployedApplicationHealthEvaluation_H
