...
/*
 * OAIDeployedApplicationHealthReportCreatedEvent.h
 *
 * Deployed Application Health Report Created event.
 */

#ifndef OAIDeployedApplicationHealthReportCreatedEvent_H
#define OAIDeployedApplicationHealthReportCreatedEvent_H
...
class OAIDeployedApplicationHealthReportCreatedEvent : public OAIObject {
public:
    OAIDeployedApplicationHealthReportCreatedEvent();
    OAIDeployedApplicationHealthReportCreatedEvent(QString json);
    ~OAIDeployedApplicationHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedApplicationHealthReportCreatedEvent)

#endif // OAIDeployedApplicationHealthReportCreatedEvent_H
