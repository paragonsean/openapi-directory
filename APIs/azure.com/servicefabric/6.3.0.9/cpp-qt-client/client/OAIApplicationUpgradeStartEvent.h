...
/*
 * OAIApplicationUpgradeStartEvent.h
 *
 * Application Upgrade Start event.
 */

#ifndef OAIApplicationUpgradeStartEvent_H
#define OAIApplicationUpgradeStartEvent_H
...
class OAIApplicationUpgradeStartEvent : public OAIObject {
public:
    OAIApplicationUpgradeStartEvent();
    OAIApplicationUpgradeStartEvent(QString json);
    ~OAIApplicationUpgradeStartEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeStartEvent)

#endif // OAIApplicationUpgradeStartEvent_H
