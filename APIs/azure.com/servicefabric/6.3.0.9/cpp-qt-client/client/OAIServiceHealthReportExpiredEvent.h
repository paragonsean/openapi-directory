...
/*
 * OAIServiceHealthReportExpiredEvent.h
 *
 * Service Health Report Expired event.
 */

#ifndef OAIServiceHealthReportExpiredEvent_H
#define OAIServiceHealthReportExpiredEvent_H
...
class OAIServiceHealthReportExpiredEvent : public OAIObject {
public:
    OAIServiceHealthReportExpiredEvent();
    OAIServiceHealthReportExpiredEvent(QString json);
    ~OAIServiceHealthReportExpiredEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceHealthReportExpiredEvent)

#endif // OAIServiceHealthReportExpiredEvent_H
