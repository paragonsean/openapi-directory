...
OAIBackupEpoch OAIBackupProgressInfo::getEpochOfLastBackupRecord() const {
    return m_epoch_of_last_backup_record;
}
void OAIBackupProgressInfo::setEpochOfLastBackupRecord(const OAIBackupEpoch &epoch_of_last_backup_record) {
