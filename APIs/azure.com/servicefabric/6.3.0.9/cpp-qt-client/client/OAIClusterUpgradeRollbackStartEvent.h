...
/*
 * OAIClusterUpgradeRollbackStartEvent.h
 *
 * Cluster Upgrade Rollback Start event.
 */

#ifndef OAIClusterUpgradeRollbackStartEvent_H
#define OAIClusterUpgradeRollbackStartEvent_H
...
class OAIClusterUpgradeRollbackStartEvent : public OAIObject {
public:
    OAIClusterUpgradeRollbackStartEvent();
    OAIClusterUpgradeRollbackStartEvent(QString json);
    ~OAIClusterUpgradeRollbackStartEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterUpgradeRollbackStartEvent)

#endif // OAIClusterUpgradeRollbackStartEvent_H
