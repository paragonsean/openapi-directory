...
void OAIFileVersion::initializeModel() {
    ...
    m_epoch_configuration_number_isSet = false;
    m_epoch_configuration_number_isValid = false;
...
void OAIFileVersion::fromJsonObject(QJsonObject json) {
    ...
    m_epoch_configuration_number_isValid = ::OpenAPI::fromJsonValue(m_epoch_configuration_number, json[QString("EpochConfigurationNumber")]);
    m_epoch_configuration_number_isSet = !json[QString("EpochConfigurationNumber")].isNull() && m_epoch_configuration_number_isValid;
...
QJsonObject OAIFileVersion::asJsonObject() const {
    QJsonObject obj;
    if (m_epoch_configuration_number_isSet) {
        obj.insert(QString("EpochConfigurationNumber"), ::OpenAPI::toJsonValue(m_epoch_configuration_number));
    }
...
QString OAIFileVersion::getEpochConfigurationNumber() const {
    return m_epoch_configuration_number;
}
void OAIFileVersion::setEpochConfigurationNumber(const QString &epoch_configuration_number) {
    m_epoch_configuration_number = epoch_configuration_number;
    m_epoch_configuration_number_isSet = true;
}

bool OAIFileVersion::is_epoch_configuration_number_Set() const{
    return m_epoch_configuration_number_isSet;
}

bool OAIFileVersion::is_epoch_configuration_number_Valid() const{
    return m_epoch_configuration_number_isValid;
}
