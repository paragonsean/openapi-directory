...
OAIBackupEpoch OAIBackupInfo::getEpochOfLastBackupRecord() const {
    return m_epoch_of_last_backup_record;
}
void OAIBackupInfo::setEpochOfLastBackupRecord(const OAIBackupEpoch &epoch_of_last_backup_record) {
