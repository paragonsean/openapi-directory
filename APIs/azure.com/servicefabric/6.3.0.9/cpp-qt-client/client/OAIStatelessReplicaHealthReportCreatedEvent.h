...
/*
 * OAIStatelessReplicaHealthReportCreatedEvent.h
 *
 * Stateless Replica Health Report Created event.
 */

#ifndef OAIStatelessReplicaHealthReportCreatedEvent_H
#define OAIStatelessReplicaHealthReportCreatedEvent_H
...
class OAIStatelessReplicaHealthReportCreatedEvent : public OAIObject {
public:
    OAIStatelessReplicaHealthReportCreatedEvent();
    OAIStatelessReplicaHealthReportCreatedEvent(QString json);
    ~OAIStatelessReplicaHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessReplicaHealthReportCreatedEvent)

#endif // OAIStatelessReplicaHealthReportCreatedEvent_H
