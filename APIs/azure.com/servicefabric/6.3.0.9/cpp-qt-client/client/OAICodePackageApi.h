...
public:
    ...
    * @param[in]  previous bool [optional]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getContainerLogsDeployedOnNode(const QString &api_version, const QString &node_name, const QString &application_id, const QString &service_manifest_name, const QString &code_package_name, const ::OpenAPI::OptionalParam<QString> &tail = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &previous = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  service_manifest_name QString [required]
    * @param[in]  code_package_name QString [required]
    * @param[in]  code_package_instance_id QString [required]
    * @param[in]  container_api_request_body OAIContainerApiRequestBody [required]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void invokeContainerApi(const QString &api_version, const QString &node_name, const QString &application_id, const QString &service_manifest_name, const QString &code_package_name, const QString &code_package_instance_id, const OAIContainerApiRequestBody &container_api_request_body, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
private:
    ...
    void invokeContainerApiCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void invokeContainerApiSignal(OAIContainerApiResponse summary);
    ...
    void invokeContainerApiSignalFull(OAIHttpRequestWorker *worker, OAIContainerApiResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use invokeContainerApiSignalError() instead")
    void invokeContainerApiSignalE(OAIContainerApiResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void invokeContainerApiSignalError(OAIContainerApiResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use invokeContainerApiSignalErrorFull() instead")
    void invokeContainerApiSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void invokeContainerApiSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
