...
#ifndef OAIReplicasHealthEvaluation_H
#define OAIReplicasHealthEvaluation_H
...
class OAIReplicasHealthEvaluation : public OAIObject {
public:
    OAIReplicasHealthEvaluation();
    OAIReplicasHealthEvaluation(QString json);
    ~OAIReplicasHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicasHealthEvaluation)

#endif // OAIReplicasHealthEvaluation_H
