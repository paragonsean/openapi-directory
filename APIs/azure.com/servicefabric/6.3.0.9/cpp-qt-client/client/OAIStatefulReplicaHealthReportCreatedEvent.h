...
/*
 * OAIStatefulReplicaHealthReportCreatedEvent.h
 *
 * Stateful Replica Health Report Created event.
 */

#ifndef OAIStatefulReplicaHealthReportCreatedEvent_H
#define OAIStatefulReplicaHealthReportCreatedEvent_H
...
class OAIStatefulReplicaHealthReportCreatedEvent : public OAIObject {
public:
    OAIStatefulReplicaHealthReportCreatedEvent();
    OAIStatefulReplicaHealthReportCreatedEvent(QString json);
    ~OAIStatefulReplicaHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulReplicaHealthReportCreatedEvent)

#endif // OAIStatefulReplicaHealthReportCreatedEvent_H
