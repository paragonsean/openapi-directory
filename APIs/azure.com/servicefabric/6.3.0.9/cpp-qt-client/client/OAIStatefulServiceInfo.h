...
/*
 * OAIStatefulServiceInfo.h
 *
 * Information about a stateful Service Fabric service.
 */

#ifndef OAIStatefulServiceInfo_H
#define OAIStatefulServiceInfo_H
...
class OAIStatefulServiceInfo : public OAIObject {
public:
    OAIStatefulServiceInfo();
    OAIStatefulServiceInfo(QString json);
    ~OAIStatefulServiceInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulServiceInfo)

#endif // OAIStatefulServiceInfo_H
