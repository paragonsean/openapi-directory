...
#ifndef OAIFabricErrorCodes_H
#define OAIFabricErrorCodes_H
...
class OAIFabricErrorCodes : public OAIEnum {
public:
    OAIFabricErrorCodes();
    OAIFabricErrorCodes(QString json);
    ~OAIFabricErrorCodes() override;
    ...
    enum class eOAIFabricErrorCodes {
    ...
    OAIFabricErrorCodes::eOAIFabricErrorCodes getValue() const;
    void setValue(const OAIFabricErrorCodes::eOAIFabricErrorCodes& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFabricErrorCodes)

#endif // OAIFabricErrorCodes_H
