...
#include "OAINodeOpenFailedEvent.h"
...
OAINodeOpenFailedEvent::OAINodeOpenFailedEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeOpenFailedEvent::OAINodeOpenFailedEvent() {
    this->initializeModel();
}

OAINodeOpenFailedEvent::~OAINodeOpenFailedEvent() {}

void OAINodeOpenFailedEvent::initializeModel() {
...
void OAINodeOpenFailedEvent::fromJson(QString jsonString) {
...
void OAINodeOpenFailedEvent::fromJsonObject(QJsonObject json) {
...
QString OAINodeOpenFailedEvent::asJson() const {
...
QJsonObject OAINodeOpenFailedEvent::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeOpenFailedEvent::getEventInstanceId() const {
    return m_event_instance_id;
}
void OAINodeOpenFailedEvent::setEventInstanceId(const QString &event_instance_id) {
    m_event_instance_id = event_instance_id;
    m_event_instance_id_isSet = true;
}

bool OAINodeOpenFailedEvent::is_event_instance_id_Set() const{
    return m_event_instance_id_isSet;
}

bool OAINodeOpenFailedEvent::is_event_instance_id_Valid() const{
    return m_event_instance_id_isValid;
}

bool OAINodeOpenFailedEvent::isHasCorrelatedEvents() const {
    return m_has_correlated_events;
}
void OAINodeOpenFailedEvent::setHasCorrelatedEvents(const bool &has_correlated_events) {
    m_has_correlated_events = has_correlated_events;
    m_has_correlated_events_isSet = true;
}

bool OAINodeOpenFailedEvent::is_has_correlated_events_Set() const{
    return m_has_correlated_events_isSet;
}

bool OAINodeOpenFailedEvent::is_has_correlated_events_Valid() const{
    return m_has_correlated_events_isValid;
}

OAIFabricEventKind OAINodeOpenFailedEvent::getKind() const {
    return m_kind;
}
void OAINodeOpenFailedEvent::setKind(const OAIFabricEventKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAINodeOpenFailedEvent::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAINodeOpenFailedEvent::is_kind_Valid() const{
    return m_kind_isValid;
}

QDateTime OAINodeOpenFailedEvent::getTimeStamp() const {
    return m_time_stamp;
}
void OAINodeOpenFailedEvent::setTimeStamp(const QDateTime &time_stamp) {
    m_time_stamp = time_stamp;
    m_time_stamp_isSet = true;
}

bool OAINodeOpenFailedEvent::is_time_stamp_Set() const{
    return m_time_stamp_isSet;
}

bool OAINodeOpenFailedEvent::is_time_stamp_Valid() const{
    return m_time_stamp_isValid;
}

QString OAINodeOpenFailedEvent::getNodeName() const {
    return m_node_name;
}
void OAINodeOpenFailedEvent::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAINodeOpenFailedEvent::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAINodeOpenFailedEvent::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAINodeOpenFailedEvent::getError() const {
    return m_error;
}
void OAINodeOpenFailedEvent::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAINodeOpenFailedEvent::is_error_Set() const{
    return m_error_isSet;
}

bool OAINodeOpenFailedEvent::is_error_Valid() const{
    return m_error_isValid;
}

QString OAINodeOpenFailedEvent::getFaultDomain() const {
    return m_fault_domain;
}
void OAINodeOpenFailedEvent::setFaultDomain(const QString &fault_domain) {
    m_fault_domain = fault_domain;
    m_fault_domain_isSet = true;
}

bool OAINodeOpenFailedEvent::is_fault_domain_Set() const{
    return m_fault_domain_isSet;
}

bool OAINodeOpenFailedEvent::is_fault_domain_Valid() const{
    return m_fault_domain_isValid;
}

QString OAINodeOpenFailedEvent::getHostname() const {
    return m_hostname;
}
void OAINodeOpenFailedEvent::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAINodeOpenFailedEvent::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAINodeOpenFailedEvent::is_hostname_Valid() const{
    return m_hostname_isValid;
}

QString OAINodeOpenFailedEvent::getIpAddressOrFqdn() const {
    return m_ip_address_or_fqdn;
}
void OAINodeOpenFailedEvent::setIpAddressOrFqdn(const QString &ip_address_or_fqdn) {
    m_ip_address_or_fqdn = ip_address_or_fqdn;
    m_ip_address_or_fqdn_isSet = true;
}

bool OAINodeOpenFailedEvent::is_ip_address_or_fqdn_Set() const{
    return m_ip_address_or_fqdn_isSet;
}

bool OAINodeOpenFailedEvent::is_ip_address_or_fqdn_Valid() const{
    return m_ip_address_or_fqdn_isValid;
}

bool OAINodeOpenFailedEvent::isIsSeedNode() const {
    return m_is_seed_node;
}
void OAINodeOpenFailedEvent::setIsSeedNode(const bool &is_seed_node) {
    m_is_seed_node = is_seed_node;
    m_is_seed_node_isSet = true;
}

bool OAINodeOpenFailedEvent::is_is_seed_node_Set() const{
    return m_is_seed_node_isSet;
}

bool OAINodeOpenFailedEvent::is_is_seed_node_Valid() const{
    return m_is_seed_node_isValid;
}

QString OAINodeOpenFailedEvent::getNodeId() const {
    return m_node_id;
}
void OAINodeOpenFailedEvent::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAINodeOpenFailedEvent::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAINodeOpenFailedEvent::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint64 OAINodeOpenFailedEvent::getNodeInstance() const {
    return m_node_instance;
}
void OAINodeOpenFailedEvent::setNodeInstance(const qint64 &node_instance) {
    m_node_instance = node_instance;
    m_node_instance_isSet = true;
}

bool OAINodeOpenFailedEvent::is_node_instance_Set() const{
    return m_node_instance_isSet;
}

bool OAINodeOpenFailedEvent::is_node_instance_Valid() const{
    return m_node_instance_isValid;
}

QString OAINodeOpenFailedEvent::getNodeVersion() const {
    return m_node_version;
}
void OAINodeOpenFailedEvent::setNodeVersion(const QString &node_version) {
    m_node_version = node_version;
    m_node_version_isSet = true;
}

bool OAINodeOpenFailedEvent::is_node_version_Set() const{
    return m_node_version_isSet;
}

bool OAINodeOpenFailedEvent::is_node_version_Valid() const{
    return m_node_version_isValid;
}

QString OAINodeOpenFailedEvent::getUpgradeDomain() const {
    return m_upgrade_domain;
}
void OAINodeOpenFailedEvent::setUpgradeDomain(const QString &upgrade_domain) {
    m_upgrade_domain = upgrade_domain;
    m_upgrade_domain_isSet = true;
}

bool OAINodeOpenFailedEvent::is_upgrade_domain_Set() const{
    return m_upgrade_domain_isSet;
}

bool OAINodeOpenFailedEvent::is_upgrade_domain_Valid() const{
    return m_upgrade_domain_isValid;
}

bool OAINodeOpenFailedEvent::isSet() const {
...
bool OAINodeOpenFailedEvent::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && m_node_name_isValid && m_error_isValid && m_fault_domain_isValid && m_hostname_isValid && m_ip_address_or_fqdn_isValid && m_is_seed_node_isValid && m_node_id_isValid && m_node_instance_isValid && m_node_version_isValid && m_upgrade_domain_isValid && true;
}
