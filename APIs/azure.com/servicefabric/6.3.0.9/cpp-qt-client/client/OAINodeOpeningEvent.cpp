...
OAINodeOpeningEvent::OAINodeOpeningEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeOpeningEvent::OAINodeOpeningEvent() {
    this->initializeModel();
}

OAINodeOpeningEvent::~OAINodeOpeningEvent() {}

void OAINodeOpeningEvent::initializeModel() {
...
void OAINodeOpeningEvent::fromJson(QString jsonString) {
...
void OAINodeOpeningEvent::fromJsonObject(QJsonObject json) {
...
QString OAINodeOpeningEvent::asJson() const {
...
QJsonObject OAINodeOpeningEvent::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeOpeningEvent::getEventInstanceId() const {
    return m_event_instance_id;
}
void OAINodeOpeningEvent::setEventInstanceId(const QString &event_instance_id) {
    m_event_instance_id = event_instance_id;
    m_event_instance_id_isSet = true;
}

bool OAINodeOpeningEvent::is_event_instance_id_Set() const{
    return m_event_instance_id_isSet;
}

bool OAINodeOpeningEvent::is_event_instance_id_Valid() const{
    return m_event_instance_id_isValid;
}

bool OAINodeOpeningEvent::isHasCorrelatedEvents() const {
    return m_has_correlated_events;
}
void OAINodeOpeningEvent::setHasCorrelatedEvents(const bool &has_correlated_events) {
    m_has_correlated_events = has_correlated_events;
    m_has_correlated_events_isSet = true;
}

bool OAINodeOpeningEvent::is_has_correlated_events_Set() const{
    return m_has_correlated_events_isSet;
}

bool OAINodeOpeningEvent::is_has_correlated_events_Valid() const{
    return m_has_correlated_events_isValid;
}

OAIFabricEventKind OAINodeOpeningEvent::getKind() const {
    return m_kind;
}
void OAINodeOpeningEvent::setKind(const OAIFabricEventKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAINodeOpeningEvent::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAINodeOpeningEvent::is_kind_Valid() const{
    return m_kind_isValid;
}

QDateTime OAINodeOpeningEvent::getTimeStamp() const {
    return m_time_stamp;
}
void OAINodeOpeningEvent::setTimeStamp(const QDateTime &time_stamp) {
    m_time_stamp = time_stamp;
    m_time_stamp_isSet = true;
}

bool OAINodeOpeningEvent::is_time_stamp_Set() const{
    return m_time_stamp_isSet;
}

bool OAINodeOpeningEvent::is_time_stamp_Valid() const{
    return m_time_stamp_isValid;
}

QString OAINodeOpeningEvent::getNodeName() const {
    return m_node_name;
}
void OAINodeOpeningEvent::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAINodeOpeningEvent::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAINodeOpeningEvent::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAINodeOpeningEvent::getFaultDomain() const {
    return m_fault_domain;
}
void OAINodeOpeningEvent::setFaultDomain(const QString &fault_domain) {
    m_fault_domain = fault_domain;
    m_fault_domain_isSet = true;
}

bool OAINodeOpeningEvent::is_fault_domain_Set() const{
    return m_fault_domain_isSet;
}

bool OAINodeOpeningEvent::is_fault_domain_Valid() const{
    return m_fault_domain_isValid;
}

QString OAINodeOpeningEvent::getHostname() const {
    return m_hostname;
}
void OAINodeOpeningEvent::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAINodeOpeningEvent::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAINodeOpeningEvent::is_hostname_Valid() const{
    return m_hostname_isValid;
}

QString OAINodeOpeningEvent::getIpAddressOrFqdn() const {
    return m_ip_address_or_fqdn;
}
void OAINodeOpeningEvent::setIpAddressOrFqdn(const QString &ip_address_or_fqdn) {
    m_ip_address_or_fqdn = ip_address_or_fqdn;
    m_ip_address_or_fqdn_isSet = true;
}

bool OAINodeOpeningEvent::is_ip_address_or_fqdn_Set() const{
    return m_ip_address_or_fqdn_isSet;
}

bool OAINodeOpeningEvent::is_ip_address_or_fqdn_Valid() const{
    return m_ip_address_or_fqdn_isValid;
}

bool OAINodeOpeningEvent::isIsSeedNode() const {
    return m_is_seed_node;
}
void OAINodeOpeningEvent::setIsSeedNode(const bool &is_seed_node) {
    m_is_seed_node = is_seed_node;
    m_is_seed_node_isSet = true;
}

bool OAINodeOpeningEvent::is_is_seed_node_Set() const{
    return m_is_seed_node_isSet;
}

bool OAINodeOpeningEvent::is_is_seed_node_Valid() const{
    return m_is_seed_node_isValid;
}

QString OAINodeOpeningEvent::getNodeId() const {
    return m_node_id;
}
void OAINodeOpeningEvent::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAINodeOpeningEvent::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAINodeOpeningEvent::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint64 OAINodeOpeningEvent::getNodeInstance() const {
    return m_node_instance;
}
void OAINodeOpeningEvent::setNodeInstance(const qint64 &node_instance) {
    m_node_instance = node_instance;
    m_node_instance_isSet = true;
}

bool OAINodeOpeningEvent::is_node_instance_Set() const{
    return m_node_instance_isSet;
}

bool OAINodeOpeningEvent::is_node_instance_Valid() const{
    return m_node_instance_isValid;
}

QString OAINodeOpeningEvent::getNodeVersion() const {
    return m_node_version;
}
void OAINodeOpeningEvent::setNodeVersion(const QString &node_version) {
    m_node_version = node_version;
    m_node_version_isSet = true;
}

bool OAINodeOpeningEvent::is_node_version_Set() const{
    return m_node_version_isSet;
}

bool OAINodeOpeningEvent::is_node_version_Valid() const{
    return m_node_version_isValid;
}

QString OAINodeOpeningEvent::getUpgradeDomain() const {
    return m_upgrade_domain;
}
void OAINodeOpeningEvent::setUpgradeDomain(const QString &upgrade_domain) {
    m_upgrade_domain = upgrade_domain;
    m_upgrade_domain_isSet = true;
}

bool OAINodeOpeningEvent::is_upgrade_domain_Set() const{
    return m_upgrade_domain_isSet;
}

bool OAINodeOpeningEvent::is_upgrade_domain_Valid() const{
    return m_upgrade_domain_isValid;
}

bool OAINodeOpeningEvent::isSet() const {
...
bool OAINodeOpeningEvent::isValid() const {
