...
/*
 * OAIApplicationHealthReportCreatedEvent.h
 *
 * Application Health Report Created event.
 */

#ifndef OAIApplicationHealthReportCreatedEvent_H
#define OAIApplicationHealthReportCreatedEvent_H
...
class OAIApplicationHealthReportCreatedEvent : public OAIObject {
public:
    OAIApplicationHealthReportCreatedEvent();
    OAIApplicationHealthReportCreatedEvent(QString json);
    ~OAIApplicationHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationHealthReportCreatedEvent)

#endif // OAIApplicationHealthReportCreatedEvent_H
