...
bool OAIServiceCreatedEvent::isValid() const {
    ...
    return m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && m_service_id_isValid && m_application_name_isValid && m_application_type_name_isValid && m_is_stateful_isValid && m_min_replica_set_size_isValid && m_partition_count_isValid && m_partition_id_isValid && m_service_instance_isValid && m_service_package_version_isValid && m_service_type_name_isValid && m_target_replica_set_size_isValid && true;
}
