...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.PartitionBackupEntity();
  });
  ...
  describe('PartitionBackupEntity', function() {
    it('should create an instance of PartitionBackupEntity', function() {
      // uncomment below and update the code to test PartitionBackupEntity
      //var instance = new ServiceFabricClientApis.PartitionBackupEntity();
      //expect(instance).to.be.a(ServiceFabricClientApis.PartitionBackupEntity);
    });
