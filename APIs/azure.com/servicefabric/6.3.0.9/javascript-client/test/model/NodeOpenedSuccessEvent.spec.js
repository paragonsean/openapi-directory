...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.NodeOpenedSuccessEvent();
  });
  ...
  describe('NodeOpenedSuccessEvent', function() {
    it('should create an instance of NodeOpenedSuccessEvent', function() {
      // uncomment below and update the code to test NodeOpenedSuccessEvent
      //var instance = new ServiceFabricClientApis.NodeOpenedSuccessEvent();
      //expect(instance).to.be.a(ServiceFabricClientApis.NodeOpenedSuccessEvent);
    });
