...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.ContainerInstanceView();
  });
  ...
  describe('ContainerInstanceView', function() {
    it('should create an instance of ContainerInstanceView', function() {
      ...
      //var instance = new ServiceFabricClientApis.ContainerInstanceView();
      //expect(instance).to.be.a(ServiceFabricClientApis.ContainerInstanceView);
    });
