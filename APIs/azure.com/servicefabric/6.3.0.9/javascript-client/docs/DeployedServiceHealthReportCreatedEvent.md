# ServiceFabricClientApis.DeployedServiceHealthReportCreatedEvent
...
**servicePackageInstanceId** | **Number** | Id of Service package instance. | 
**sourceId** | **String** | Id of report source. | 
**sourceUtcTimestamp** | **Date** | Source time. | 
**tTLTimespan** | **Number** | Time to live in milli-seconds. | 
