...
export default class ServiceTypeApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getServiceTypeInfoByName operation.
     * @callback module:api/ServiceTypeApi~getServiceTypeInfoByNameCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ServiceTypeInfo} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [timeout = 60)] The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
     * @param {module:api/ServiceTypeApi~getServiceTypeInfoByNameCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ServiceTypeInfo}
     */
    getServiceTypeInfoByName(apiVersion, applicationTypeName, applicationTypeVersion, serviceTypeName, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling getServiceTypeInfoByName");
      }
      // verify the required parameter 'applicationTypeName' is set
      if (applicationTypeName === undefined || applicationTypeName === null) {
        throw new Error("Missing the required parameter 'applicationTypeName' when calling getServiceTypeInfoByName");
      }
      // verify the required parameter 'applicationTypeVersion' is set
      if (applicationTypeVersion === undefined || applicationTypeVersion === null) {
        throw new Error("Missing the required parameter 'applicationTypeVersion' when calling getServiceTypeInfoByName");
      }
      // verify the required parameter 'serviceTypeName' is set
      if (serviceTypeName === undefined || serviceTypeName === null) {
        throw new Error("Missing the required parameter 'serviceTypeName' when calling getServiceTypeInfoByName");
      }
      ...
      return this.apiClient.callApi(
        '/ApplicationTypes/{applicationTypeName}/$/GetServiceTypes/{serviceTypeName}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
