...
/**
 * The NodeOpenedSuccessEvent model module.
 * @module model/NodeOpenedSuccessEvent
 * @version 6.3.0.9
 */
class NodeOpenedSuccessEvent {
    /**
     * Constructs a new <code>NodeOpenedSuccessEvent</code>.
     * Node Opened Success event.
     * @alias module:model/NodeOpenedSuccessEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain) { 
        ...
        NodeOpenedSuccessEvent.initialize(this, eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain);
    }
    ...
    /**
     * Constructs a <code>NodeOpenedSuccessEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeOpenedSuccessEvent} obj Optional instance to populate.
     * @return {module:model/NodeOpenedSuccessEvent} The populated <code>NodeOpenedSuccessEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeOpenedSuccessEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeOpenedSuccessEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeOpenedSuccessEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeOpenedSuccessEvent.RequiredProperties) {
...
NodeOpenedSuccessEvent.RequiredProperties = ["FaultDomain", "Hostname", "IpAddressOrFQDN", "IsSeedNode", "NodeId", "NodeInstance", "NodeVersion", "UpgradeDomain", "EventInstanceId", "Kind", "TimeStamp", "NodeName"];

/**
 * Fault domain of Node.
 * @member {String} FaultDomain
 */
NodeOpenedSuccessEvent.prototype['FaultDomain'] = undefined;

/**
 * Name of Host.
 * @member {String} Hostname
 */
NodeOpenedSuccessEvent.prototype['Hostname'] = undefined;

/**
 * IP address or FQDN.
 * @member {String} IpAddressOrFQDN
 */
NodeOpenedSuccessEvent.prototype['IpAddressOrFQDN'] = undefined;

/**
 * Indicates if it is seed node.
 * @member {Boolean} IsSeedNode
 */
NodeOpenedSuccessEvent.prototype['IsSeedNode'] = undefined;

/**
 * Id of Node.
 * @member {String} NodeId
 */
NodeOpenedSuccessEvent.prototype['NodeId'] = undefined;

/**
 * Id of Node instance.
 * @member {Number} NodeInstance
 */
NodeOpenedSuccessEvent.prototype['NodeInstance'] = undefined;

/**
 * Version of Node.
 * @member {String} NodeVersion
 */
NodeOpenedSuccessEvent.prototype['NodeVersion'] = undefined;

/**
 * Upgrade domain of Node.
 * @member {String} UpgradeDomain
 */
NodeOpenedSuccessEvent.prototype['UpgradeDomain'] = undefined;
...
export default NodeOpenedSuccessEvent;
