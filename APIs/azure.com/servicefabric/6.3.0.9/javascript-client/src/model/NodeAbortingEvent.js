...
/**
 * The NodeAbortingEvent model module.
 * @module model/NodeAbortingEvent
 * @version 6.3.0.9
 */
class NodeAbortingEvent {
    /**
     * Constructs a new <code>NodeAbortingEvent</code>.
     * Node Aborting event.
     * @alias module:model/NodeAbortingEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain) { 
        ...
        NodeAbortingEvent.initialize(this, eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain);
    }
    ...
    /**
     * Constructs a <code>NodeAbortingEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeAbortingEvent} obj Optional instance to populate.
     * @return {module:model/NodeAbortingEvent} The populated <code>NodeAbortingEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeAbortingEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeAbortingEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeAbortingEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeAbortingEvent.RequiredProperties) {
...
NodeAbortingEvent.RequiredProperties = ["FaultDomain", "Hostname", "IpAddressOrFQDN", "IsSeedNode", "NodeId", "NodeInstance", "NodeVersion", "UpgradeDomain", "EventInstanceId", "Kind", "TimeStamp", "NodeName"];

/**
 * Fault domain of Node.
 * @member {String} FaultDomain
 */
NodeAbortingEvent.prototype['FaultDomain'] = undefined;

/**
 * Name of Host.
 * @member {String} Hostname
 */
NodeAbortingEvent.prototype['Hostname'] = undefined;

/**
 * IP address or FQDN.
 * @member {String} IpAddressOrFQDN
 */
NodeAbortingEvent.prototype['IpAddressOrFQDN'] = undefined;

/**
 * Indicates if it is seed node.
 * @member {Boolean} IsSeedNode
 */
NodeAbortingEvent.prototype['IsSeedNode'] = undefined;

/**
 * Id of Node.
 * @member {String} NodeId
 */
NodeAbortingEvent.prototype['NodeId'] = undefined;

/**
 * Id of Node instance.
 * @member {Number} NodeInstance
 */
NodeAbortingEvent.prototype['NodeInstance'] = undefined;

/**
 * Version of Node.
 * @member {String} NodeVersion
 */
NodeAbortingEvent.prototype['NodeVersion'] = undefined;

/**
 * Upgrade domain of Node.
 * @member {String} UpgradeDomain
 */
NodeAbortingEvent.prototype['UpgradeDomain'] = undefined;
...
export default NodeAbortingEvent;
