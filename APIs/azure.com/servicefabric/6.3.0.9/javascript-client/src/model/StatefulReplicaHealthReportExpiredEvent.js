...
/**
 * The StatefulReplicaHealthReportExpiredEvent model module.
 * @module model/StatefulReplicaHealthReportExpiredEvent
 * @version 6.3.0.9
 */
class StatefulReplicaHealthReportExpiredEvent {
    /**
     * Constructs a new <code>StatefulReplicaHealthReportExpiredEvent</code>.
     * Stateful Replica Health Report Expired event.
     * @alias module:model/StatefulReplicaHealthReportExpiredEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, partitionId, replicaId, description, healthState, property, removeWhenExpired, replicaInstanceId, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ...
        StatefulReplicaHealthReportExpiredEvent.initialize(this, eventInstanceId, kind, timeStamp, partitionId, replicaId, description, healthState, property, removeWhenExpired, replicaInstanceId, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
    ...
    /**
     * Constructs a <code>StatefulReplicaHealthReportExpiredEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulReplicaHealthReportExpiredEvent} obj Optional instance to populate.
     * @return {module:model/StatefulReplicaHealthReportExpiredEvent} The populated <code>StatefulReplicaHealthReportExpiredEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulReplicaHealthReportExpiredEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulReplicaHealthReportExpiredEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulReplicaHealthReportExpiredEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatefulReplicaHealthReportExpiredEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
StatefulReplicaHealthReportExpiredEvent.RequiredProperties = ["Description", "HealthState", "Property", "RemoveWhenExpired", "ReplicaInstanceId", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp", "PartitionId", "ReplicaId"];

/**
 * Description of report.
 * @member {String} Description
 */
StatefulReplicaHealthReportExpiredEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
StatefulReplicaHealthReportExpiredEvent.prototype['HealthState'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
StatefulReplicaHealthReportExpiredEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
StatefulReplicaHealthReportExpiredEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Id of Replica instance.
 * @member {Number} ReplicaInstanceId
 */
StatefulReplicaHealthReportExpiredEvent.prototype['ReplicaInstanceId'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
StatefulReplicaHealthReportExpiredEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
StatefulReplicaHealthReportExpiredEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
StatefulReplicaHealthReportExpiredEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
StatefulReplicaHealthReportExpiredEvent.prototype['TimeToLiveMs'] = undefined;
...
export default StatefulReplicaHealthReportExpiredEvent;
