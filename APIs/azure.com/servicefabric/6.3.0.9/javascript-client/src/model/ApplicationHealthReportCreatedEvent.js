...
/**
 * The ApplicationHealthReportCreatedEvent model module.
 * @module model/ApplicationHealthReportCreatedEvent
 * @version 6.3.0.9
 */
class ApplicationHealthReportCreatedEvent {
    /**
     * Constructs a new <code>ApplicationHealthReportCreatedEvent</code>.
     * Application Health Report Created event.
     * @alias module:model/ApplicationHealthReportCreatedEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, applicationId, applicationInstanceId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ...
        ApplicationHealthReportCreatedEvent.initialize(this, eventInstanceId, kind, timeStamp, applicationId, applicationInstanceId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
    ...
    /**
     * Constructs a <code>ApplicationHealthReportCreatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationHealthReportCreatedEvent} obj Optional instance to populate.
     * @return {module:model/ApplicationHealthReportCreatedEvent} The populated <code>ApplicationHealthReportCreatedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationHealthReportCreatedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationHealthReportCreatedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationHealthReportCreatedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationHealthReportCreatedEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
ApplicationHealthReportCreatedEvent.RequiredProperties = ["ApplicationInstanceId", "Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp", "ApplicationId"];

/**
 * Id of Application instance.
 * @member {Number} ApplicationInstanceId
 */
ApplicationHealthReportCreatedEvent.prototype['ApplicationInstanceId'] = undefined;

/**
 * Description of report.
 * @member {String} Description
 */
ApplicationHealthReportCreatedEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
ApplicationHealthReportCreatedEvent.prototype['HealthState'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
ApplicationHealthReportCreatedEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
ApplicationHealthReportCreatedEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
ApplicationHealthReportCreatedEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
ApplicationHealthReportCreatedEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
ApplicationHealthReportCreatedEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
ApplicationHealthReportCreatedEvent.prototype['TimeToLiveMs'] = undefined;
...
export default ApplicationHealthReportCreatedEvent;
