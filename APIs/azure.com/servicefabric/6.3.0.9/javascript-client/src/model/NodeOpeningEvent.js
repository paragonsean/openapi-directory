...
/**
 * The NodeOpeningEvent model module.
 * @module model/NodeOpeningEvent
 * @version 6.3.0.9
 */
class NodeOpeningEvent {
    /**
     * Constructs a new <code>NodeOpeningEvent</code>.
     * Node Opening event.
     * @alias module:model/NodeOpeningEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain) { 
        ...
        NodeOpeningEvent.initialize(this, eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain);
    }
    ...
    /**
     * Constructs a <code>NodeOpeningEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeOpeningEvent} obj Optional instance to populate.
     * @return {module:model/NodeOpeningEvent} The populated <code>NodeOpeningEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeOpeningEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeOpeningEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeOpeningEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeOpeningEvent.RequiredProperties) {
...
NodeOpeningEvent.RequiredProperties = ["FaultDomain", "Hostname", "IpAddressOrFQDN", "IsSeedNode", "NodeId", "NodeInstance", "NodeVersion", "UpgradeDomain", "EventInstanceId", "Kind", "TimeStamp", "NodeName"];

/**
 * Fault domain of Node.
 * @member {String} FaultDomain
 */
NodeOpeningEvent.prototype['FaultDomain'] = undefined;

/**
 * Name of Host.
 * @member {String} Hostname
 */
NodeOpeningEvent.prototype['Hostname'] = undefined;

/**
 * IP address or FQDN.
 * @member {String} IpAddressOrFQDN
 */
NodeOpeningEvent.prototype['IpAddressOrFQDN'] = undefined;

/**
 * Indicates if it is seed node.
 * @member {Boolean} IsSeedNode
 */
NodeOpeningEvent.prototype['IsSeedNode'] = undefined;

/**
 * Id of Node.
 * @member {String} NodeId
 */
NodeOpeningEvent.prototype['NodeId'] = undefined;

/**
 * Id of Node instance.
 * @member {Number} NodeInstance
 */
NodeOpeningEvent.prototype['NodeInstance'] = undefined;

/**
 * Version of Node.
 * @member {String} NodeVersion
 */
NodeOpeningEvent.prototype['NodeVersion'] = undefined;

/**
 * Upgrade domain of Node.
 * @member {String} UpgradeDomain
 */
NodeOpeningEvent.prototype['UpgradeDomain'] = undefined;
...
export default NodeOpeningEvent;
