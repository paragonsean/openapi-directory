...
/**
 * The PartitionHealthReportExpiredEvent model module.
 * @module model/PartitionHealthReportExpiredEvent
 * @version 6.3.0.9
 */
class PartitionHealthReportExpiredEvent {
    /**
     * Constructs a new <code>PartitionHealthReportExpiredEvent</code>.
     * Partition Health Report Expired event.
     * @alias module:model/PartitionHealthReportExpiredEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, partitionId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ...
        PartitionHealthReportExpiredEvent.initialize(this, eventInstanceId, kind, timeStamp, partitionId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
    ...
    /**
     * Constructs a <code>PartitionHealthReportExpiredEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartitionHealthReportExpiredEvent} obj Optional instance to populate.
     * @return {module:model/PartitionHealthReportExpiredEvent} The populated <code>PartitionHealthReportExpiredEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartitionHealthReportExpiredEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>PartitionHealthReportExpiredEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartitionHealthReportExpiredEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartitionHealthReportExpiredEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
PartitionHealthReportExpiredEvent.RequiredProperties = ["Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp", "PartitionId"];

/**
 * Description of report.
 * @member {String} Description
 */
PartitionHealthReportExpiredEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
PartitionHealthReportExpiredEvent.prototype['HealthState'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
PartitionHealthReportExpiredEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
PartitionHealthReportExpiredEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
PartitionHealthReportExpiredEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
PartitionHealthReportExpiredEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
PartitionHealthReportExpiredEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
PartitionHealthReportExpiredEvent.prototype['TimeToLiveMs'] = undefined;
...
export default PartitionHealthReportExpiredEvent;
