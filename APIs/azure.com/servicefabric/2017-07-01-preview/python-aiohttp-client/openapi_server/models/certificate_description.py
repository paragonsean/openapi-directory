...
class CertificateDescription(Model):
    ...
    def __init__(self, thumbprint: str=None, thumbprint_secondary: str=None, x509_store_name: str=None):
    ...
    def x509_store_name(self, x509_store_name):
        ...
        :param x509_store_name: The x509_store_name of this CertificateDescription.
        :type x509_store_name: str
        """
        allowed_values = ["AddressBook", "AuthRoot", "CertificateAuthority", "Disallowed", "My", "Root", "TrustedPeople", "TrustedPublisher"]  # noqa: E501
        if x509_store_name not in allowed_values:
            raise ValueError(
                "Invalid value for `x509_store_name` ({0}), must be one of {1}"
                .format(x509_store_name, allowed_values)
            )
