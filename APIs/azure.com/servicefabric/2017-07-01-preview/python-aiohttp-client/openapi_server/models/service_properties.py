...
class ServiceProperties(Model):
    ...
    def __init__(self, partition_description: PartitionSchemeDescription=None, provisioning_state: str=None, service_kind: ServiceKind=None, service_type_name: str=None, correlation_scheme: List[ServiceCorrelationDescription]=None, default_move_cost: MoveCost=None, placement_constraints: str=None, service_load_metrics: List[ServiceLoadMetricDescription]=None, service_placement_policies: List[ServicePlacementPolicyDescription]=None):
        ...
        :param partition_description: The partition_description of this ServiceProperties.
        :param provisioning_state: The provisioning_state of this ServiceProperties.
        :param service_kind: The service_kind of this ServiceProperties.
        :param service_type_name: The service_type_name of this ServiceProperties.
        :param correlation_scheme: The correlation_scheme of this ServiceProperties.
        :param default_move_cost: The default_move_cost of this ServiceProperties.
        :param placement_constraints: The placement_constraints of this ServiceProperties.
        :param service_load_metrics: The service_load_metrics of this ServiceProperties.
        :param service_placement_policies: The service_placement_policies of this ServiceProperties.
        """
        self.openapi_types = {
    ...
    def partition_description(self):
        """Gets the partition_description of this ServiceProperties.


        :return: The partition_description of this ServiceProperties.
    ...
    def partition_description(self, partition_description):
        """Sets the partition_description of this ServiceProperties.
    ...
    def provisioning_state(self):
        """Gets the provisioning_state of this ServiceProperties.

        The current deployment or provisioning state, which only appears in the response

        :return: The provisioning_state of this ServiceProperties.
        :rtype: str
        """
    ...
    def provisioning_state(self, provisioning_state):
        """Sets the provisioning_state of this ServiceProperties.
    ...
    def service_kind(self):
        """Gets the service_kind of this ServiceProperties.


        :return: The service_kind of this ServiceProperties.
        :rtype: ServiceKind
        """
    ...
    def service_kind(self, service_kind):
        """Sets the service_kind of this ServiceProperties.
    ...
    def service_type_name(self):
        """Gets the service_type_name of this ServiceProperties.

        The name of the service type

        :return: The service_type_name of this ServiceProperties.
        :rtype: str
        """
    ...
    def service_type_name(self, service_type_name):
        """Sets the service_type_name of this ServiceProperties.
    ...
    def correlation_scheme(self):
        """Gets the correlation_scheme of this ServiceProperties.

        A list that describes the correlation of the service with other services.

        :return: The correlation_scheme of this ServiceProperties.
    ...
    def correlation_scheme(self, correlation_scheme):
        """Sets the correlation_scheme of this ServiceProperties.
    ...
    def default_move_cost(self):
        """Gets the default_move_cost of this ServiceProperties.


        :return: The default_move_cost of this ServiceProperties.
        :rtype: MoveCost
        """
    ...
    def default_move_cost(self, default_move_cost):
        """Sets the default_move_cost of this ServiceProperties.
    ...
    def placement_constraints(self):
        """Gets the placement_constraints of this ServiceProperties.

        The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: \"NodeColor == blue)\".

        :return: The placement_constraints of this ServiceProperties.
        :rtype: str
        """
    ...
    def placement_constraints(self, placement_constraints):
        """Sets the placement_constraints of this ServiceProperties.
    ...
    def service_load_metrics(self):
        """Gets the service_load_metrics of this ServiceProperties.

        The service load metrics is given as an array of ServiceLoadMetricDescription objects.

        :return: The service_load_metrics of this ServiceProperties.
    ...
    def service_load_metrics(self, service_load_metrics):
        """Sets the service_load_metrics of this ServiceProperties.
    ...
    def service_placement_policies(self):
        """Gets the service_placement_policies of this ServiceProperties.

        A list that describes the correlation of the service with other services.

        :return: The service_placement_policies of this ServiceProperties.
    ...
    def service_placement_policies(self, service_placement_policies):
        """Sets the service_placement_policies of this ServiceProperties.
