...
public class ServicePropertiesBase {
  ...
  public ServicePropertiesBase correlationScheme(List<ServiceCorrelationDescription> correlationScheme) {
    this.correlationScheme = correlationScheme;
    return this;
  }

  public ServicePropertiesBase addCorrelationSchemeItem(ServiceCorrelationDescription correlationSchemeItem) {
  ...
  public ServicePropertiesBase defaultMoveCost(MoveCost defaultMoveCost) {
  ...
  public ServicePropertiesBase placementConstraints(String placementConstraints) {
  ...
  public ServicePropertiesBase serviceLoadMetrics(List<ServiceLoadMetricDescription> serviceLoadMetrics) {
    this.serviceLoadMetrics = serviceLoadMetrics;
    return this;
  }

  public ServicePropertiesBase addServiceLoadMetricsItem(ServiceLoadMetricDescription serviceLoadMetricsItem) {
  ...
  public ServicePropertiesBase servicePlacementPolicies(List<ServicePlacementPolicyDescription> servicePlacementPolicies) {
    this.servicePlacementPolicies = servicePlacementPolicies;
    return this;
  }

  public ServicePropertiesBase addServicePlacementPoliciesItem(ServicePlacementPolicyDescription servicePlacementPoliciesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ServicePropertiesBase servicePropertiesBase = (ServicePropertiesBase) o;
    return Objects.equals(this.correlationScheme, servicePropertiesBase.correlationScheme) &&
        Objects.equals(this.defaultMoveCost, servicePropertiesBase.defaultMoveCost) &&
        Objects.equals(this.placementConstraints, servicePropertiesBase.placementConstraints) &&
        Objects.equals(this.serviceLoadMetrics, servicePropertiesBase.serviceLoadMetrics) &&
        Objects.equals(this.servicePlacementPolicies, servicePropertiesBase.servicePlacementPolicies);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServicePropertiesBase {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServicePropertiesBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServicePropertiesBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServicePropertiesBase is not found in the empty JSON string", ServicePropertiesBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServicePropertiesBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServicePropertiesBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServicePropertiesBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServicePropertiesBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServicePropertiesBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServicePropertiesBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ServicePropertiesBase>() {
           @Override
           public void write(JsonWriter out, ServicePropertiesBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServicePropertiesBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServicePropertiesBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServicePropertiesBase
   * @throws IOException if the JSON string is invalid with respect to ServicePropertiesBase
   */
  public static ServicePropertiesBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServicePropertiesBase.class);
  }

  /**
   * Convert an instance of ServicePropertiesBase to an JSON string
   *
   * @return JSON string
   */
