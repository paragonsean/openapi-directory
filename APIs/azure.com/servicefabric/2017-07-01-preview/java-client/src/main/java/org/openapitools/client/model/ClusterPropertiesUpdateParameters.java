...
public class ClusterPropertiesUpdateParameters {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addOnFeatures, certificate, clientCertificateCommonNames, clientCertificateThumbprints, clusterCodeVersion, fabricSettings, nodeTypes, reliabilityLevel, reverseProxyCertificate, upgradeDescription, upgradeMode);
  }
