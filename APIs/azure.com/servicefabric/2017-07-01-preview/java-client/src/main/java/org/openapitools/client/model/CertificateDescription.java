...
public class CertificateDescription {
   ...
   */
  @JsonAdapter(X509StoreNameEnum.Adapter.class)
  public enum X509StoreNameEnum {
    ...
    X509StoreNameEnum(String value) {
      this.value = value;
    }
    ...
    public static X509StoreNameEnum fromValue(String value) {
      for (X509StoreNameEnum b : X509StoreNameEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<X509StoreNameEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final X509StoreNameEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public X509StoreNameEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return X509StoreNameEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      X509StoreNameEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_X509_STORE_NAME = "x509StoreName";
  @SerializedName(SERIALIZED_NAME_X509_STORE_NAME)
  private X509StoreNameEnum x509StoreName;
  ...
  public CertificateDescription x509StoreName(X509StoreNameEnum x509StoreName) {
   ...
   */
  @javax.annotation.Nullable
  public X509StoreNameEnum getX509StoreName() {
    return x509StoreName;
  }

  public void setX509StoreName(X509StoreNameEnum x509StoreName) {
    this.x509StoreName = x509StoreName;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("x509StoreName") != null && !jsonObj.get("x509StoreName").isJsonNull()) && !jsonObj.get("x509StoreName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `x509StoreName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("x509StoreName").toString()));
      }
      // validate the optional field `x509StoreName`
      if (jsonObj.get("x509StoreName") != null && !jsonObj.get("x509StoreName").isJsonNull()) {
        X509StoreNameEnum.validateJsonElement(jsonObj.get("x509StoreName"));
      }
  }
