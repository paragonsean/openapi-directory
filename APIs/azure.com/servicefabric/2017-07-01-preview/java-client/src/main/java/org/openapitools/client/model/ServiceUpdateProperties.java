...
public class ServiceUpdateProperties {
  ...
  public ServiceUpdateProperties serviceKind(ServiceKind serviceKind) {
  ...
  public ServiceUpdateProperties correlationScheme(List<ServiceCorrelationDescription> correlationScheme) {
    this.correlationScheme = correlationScheme;
    return this;
  }

  public ServiceUpdateProperties addCorrelationSchemeItem(ServiceCorrelationDescription correlationSchemeItem) {
  ...
  public ServiceUpdateProperties defaultMoveCost(MoveCost defaultMoveCost) {
  ...
  public ServiceUpdateProperties placementConstraints(String placementConstraints) {
  ...
  public ServiceUpdateProperties serviceLoadMetrics(List<ServiceLoadMetricDescription> serviceLoadMetrics) {
    this.serviceLoadMetrics = serviceLoadMetrics;
    return this;
  }

  public ServiceUpdateProperties addServiceLoadMetricsItem(ServiceLoadMetricDescription serviceLoadMetricsItem) {
  ...
  public ServiceUpdateProperties servicePlacementPolicies(List<ServicePlacementPolicyDescription> servicePlacementPolicies) {
    this.servicePlacementPolicies = servicePlacementPolicies;
    return this;
  }

  public ServiceUpdateProperties addServicePlacementPoliciesItem(ServicePlacementPolicyDescription servicePlacementPoliciesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceUpdateProperties serviceUpdateProperties = (ServiceUpdateProperties) o;
    return Objects.equals(this.serviceKind, serviceUpdateProperties.serviceKind) &&
        Objects.equals(this.correlationScheme, serviceUpdateProperties.correlationScheme) &&
        Objects.equals(this.defaultMoveCost, serviceUpdateProperties.defaultMoveCost) &&
        Objects.equals(this.placementConstraints, serviceUpdateProperties.placementConstraints) &&
        Objects.equals(this.serviceLoadMetrics, serviceUpdateProperties.serviceLoadMetrics) &&
        Objects.equals(this.servicePlacementPolicies, serviceUpdateProperties.servicePlacementPolicies);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceUpdateProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceUpdateProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceUpdateProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceUpdateProperties is not found in the empty JSON string", ServiceUpdateProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceUpdateProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceUpdateProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServiceUpdateProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceUpdateProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceUpdateProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceUpdateProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceUpdateProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceUpdateProperties>() {
           @Override
           public void write(JsonWriter out, ServiceUpdateProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceUpdateProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceUpdateProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceUpdateProperties
   * @throws IOException if the JSON string is invalid with respect to ServiceUpdateProperties
   */
  public static ServiceUpdateProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceUpdateProperties.class);
  }

  /**
   * Convert an instance of ServiceUpdateProperties to an JSON string
   *
   * @return JSON string
   */
