...
|------------- | ------------- | -------------|
| [**operationsList**](OperationsApi.md#operationsList) | **GET** /providers/Microsoft.ServiceFabric/operations | Lists all of the available ServiceFabric Resource Manager REST API operations. |
