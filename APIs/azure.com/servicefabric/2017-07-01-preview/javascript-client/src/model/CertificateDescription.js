...
class CertificateDescription {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('x509StoreName')) {
                obj['x509StoreName'] = ApiClient.convertToType(data['x509StoreName'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['x509StoreName'] && !(typeof data['x509StoreName'] === 'string' || data['x509StoreName'] instanceof String)) {
            throw new Error("Expected the field `x509StoreName` to be a primitive type in the JSON string but got " + data['x509StoreName']);
        }
 ...
 * @member {module:model/CertificateDescription.X509StoreNameEnum} x509StoreName
 */
...
/**
 * Allowed values for the <code>x509StoreName</code> property.
 * @enum {String}
 * @readonly
 */
CertificateDescription['X509StoreNameEnum'] = {
