...
/**
 * The ServiceUpdateProperties model module.
 * @module model/ServiceUpdateProperties
 * @version 2017-07-01-preview
 */
class ServiceUpdateProperties {
    /**
     * Constructs a new <code>ServiceUpdateProperties</code>.
     * The service resource properties for patch operations.
     * @alias module:model/ServiceUpdateProperties
    ...
    /**
     * Constructs a <code>ServiceUpdateProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceUpdateProperties} obj Optional instance to populate.
     * @return {module:model/ServiceUpdateProperties} The populated <code>ServiceUpdateProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceUpdateProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceUpdateProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceUpdateProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServiceUpdateProperties.RequiredProperties) {
...
ServiceUpdateProperties.RequiredProperties = ["serviceKind"];

/**
 * @member {module:model/ServiceKind} serviceKind
 */
ServiceUpdateProperties.prototype['serviceKind'] = undefined;
...
export default ServiceUpdateProperties;
