...
QList<OAIAddOnFeatures> OAIClusterPropertiesUpdateParameters::getAddOnFeatures() const {
    return m_add_on_features;
}
void OAIClusterPropertiesUpdateParameters::setAddOnFeatures(const QList<OAIAddOnFeatures> &add_on_features) {
    m_add_on_features = add_on_features;
    m_add_on_features_isSet = true;
}

bool OAIClusterPropertiesUpdateParameters::is_add_on_features_Set() const{
    return m_add_on_features_isSet;
}

bool OAIClusterPropertiesUpdateParameters::is_add_on_features_Valid() const{
