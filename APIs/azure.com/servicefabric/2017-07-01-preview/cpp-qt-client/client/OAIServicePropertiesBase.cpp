...
#include "OAIServicePropertiesBase.h"
...
OAIServicePropertiesBase::OAIServicePropertiesBase(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServicePropertiesBase::OAIServicePropertiesBase() {
    this->initializeModel();
}

OAIServicePropertiesBase::~OAIServicePropertiesBase() {}

void OAIServicePropertiesBase::initializeModel() {
...
void OAIServicePropertiesBase::fromJson(QString jsonString) {
...
void OAIServicePropertiesBase::fromJsonObject(QJsonObject json) {
...
QString OAIServicePropertiesBase::asJson() const {
...
QJsonObject OAIServicePropertiesBase::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIServiceCorrelationDescription> OAIServicePropertiesBase::getCorrelationScheme() const {
    return m_correlation_scheme;
}
void OAIServicePropertiesBase::setCorrelationScheme(const QList<OAIServiceCorrelationDescription> &correlation_scheme) {
    m_correlation_scheme = correlation_scheme;
    m_correlation_scheme_isSet = true;
}

bool OAIServicePropertiesBase::is_correlation_scheme_Set() const{
    return m_correlation_scheme_isSet;
}

bool OAIServicePropertiesBase::is_correlation_scheme_Valid() const{
    return m_correlation_scheme_isValid;
}

OAIMoveCost OAIServicePropertiesBase::getDefaultMoveCost() const {
    return m_default_move_cost;
}
void OAIServicePropertiesBase::setDefaultMoveCost(const OAIMoveCost &default_move_cost) {
    m_default_move_cost = default_move_cost;
    m_default_move_cost_isSet = true;
}

bool OAIServicePropertiesBase::is_default_move_cost_Set() const{
    return m_default_move_cost_isSet;
}

bool OAIServicePropertiesBase::is_default_move_cost_Valid() const{
    return m_default_move_cost_isValid;
}

QString OAIServicePropertiesBase::getPlacementConstraints() const {
    return m_placement_constraints;
}
void OAIServicePropertiesBase::setPlacementConstraints(const QString &placement_constraints) {
    m_placement_constraints = placement_constraints;
    m_placement_constraints_isSet = true;
}

bool OAIServicePropertiesBase::is_placement_constraints_Set() const{
    return m_placement_constraints_isSet;
}

bool OAIServicePropertiesBase::is_placement_constraints_Valid() const{
    return m_placement_constraints_isValid;
}

QList<OAIServiceLoadMetricDescription> OAIServicePropertiesBase::getServiceLoadMetrics() const {
    return m_service_load_metrics;
}
void OAIServicePropertiesBase::setServiceLoadMetrics(const QList<OAIServiceLoadMetricDescription> &service_load_metrics) {
    m_service_load_metrics = service_load_metrics;
    m_service_load_metrics_isSet = true;
}

bool OAIServicePropertiesBase::is_service_load_metrics_Set() const{
    return m_service_load_metrics_isSet;
}

bool OAIServicePropertiesBase::is_service_load_metrics_Valid() const{
    return m_service_load_metrics_isValid;
}

QList<OAIServicePlacementPolicyDescription> OAIServicePropertiesBase::getServicePlacementPolicies() const {
    return m_service_placement_policies;
}
void OAIServicePropertiesBase::setServicePlacementPolicies(const QList<OAIServicePlacementPolicyDescription> &service_placement_policies) {
    m_service_placement_policies = service_placement_policies;
    m_service_placement_policies_isSet = true;
}

bool OAIServicePropertiesBase::is_service_placement_policies_Set() const{
    return m_service_placement_policies_isSet;
}

bool OAIServicePropertiesBase::is_service_placement_policies_Valid() const{
    return m_service_placement_policies_isValid;
}

bool OAIServicePropertiesBase::isSet() const {
...
bool OAIServicePropertiesBase::isValid() const {
