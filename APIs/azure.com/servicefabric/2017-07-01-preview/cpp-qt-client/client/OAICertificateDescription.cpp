...
QString OAICertificateDescription::getX509StoreName() const {
    return m_x509_store_name;
}
void OAICertificateDescription::setX509StoreName(const QString &x509_store_name) {
