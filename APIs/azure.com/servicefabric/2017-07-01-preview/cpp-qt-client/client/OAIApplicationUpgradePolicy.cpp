...
OAIApplicationHealthPolicy OAIApplicationUpgradePolicy::getApplicationHealthPolicy() const {
    return m_application_health_policy;
}
void OAIApplicationUpgradePolicy::setApplicationHealthPolicy(const OAIApplicationHealthPolicy &application_health_policy) {
...
OAIRollingUpgradeMonitoringPolicy OAIApplicationUpgradePolicy::getRollingUpgradeMonitoringPolicy() const {
    return m_rolling_upgrade_monitoring_policy;
}
void OAIApplicationUpgradePolicy::setRollingUpgradeMonitoringPolicy(const OAIRollingUpgradeMonitoringPolicy &rolling_upgrade_monitoring_policy) {
...
qint64 OAIApplicationUpgradePolicy::getUpgradeReplicaSetCheckTimeout() const {
    return m_upgrade_replica_set_check_timeout;
}
void OAIApplicationUpgradePolicy::setUpgradeReplicaSetCheckTimeout(const qint64 &upgrade_replica_set_check_timeout) {
