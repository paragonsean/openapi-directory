...
public:
    ...
    QString getReliabilityLevel() const;
    void setReliabilityLevel(const QString &reliability_level);
    ...
    QString getUpgradeMode() const;
    void setUpgradeMode(const QString &upgrade_mode);
