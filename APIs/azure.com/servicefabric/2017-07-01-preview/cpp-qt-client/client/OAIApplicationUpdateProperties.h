...
/*
 * OAIApplicationUpdateProperties.h
 *
 * The application resource properties for patch operations.
 */

#ifndef OAIApplicationUpdateProperties_H
#define OAIApplicationUpdateProperties_H
...
class OAIApplicationUpdateProperties : public OAIObject {
public:
    OAIApplicationUpdateProperties();
    OAIApplicationUpdateProperties(QString json);
    ~OAIApplicationUpdateProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpdateProperties)

#endif // OAIApplicationUpdateProperties_H
