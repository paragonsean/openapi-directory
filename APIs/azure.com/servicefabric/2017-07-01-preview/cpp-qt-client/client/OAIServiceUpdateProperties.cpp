...
OAIServiceUpdateProperties::OAIServiceUpdateProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceUpdateProperties::OAIServiceUpdateProperties() {
    this->initializeModel();
}

OAIServiceUpdateProperties::~OAIServiceUpdateProperties() {}

void OAIServiceUpdateProperties::initializeModel() {
...
void OAIServiceUpdateProperties::fromJson(QString jsonString) {
...
void OAIServiceUpdateProperties::fromJsonObject(QJsonObject json) {
...
QString OAIServiceUpdateProperties::asJson() const {
...
QJsonObject OAIServiceUpdateProperties::asJsonObject() const {
    QJsonObject obj;
...
OAIServiceKind OAIServiceUpdateProperties::getServiceKind() const {
    return m_service_kind;
}
void OAIServiceUpdateProperties::setServiceKind(const OAIServiceKind &service_kind) {
    m_service_kind = service_kind;
    m_service_kind_isSet = true;
}

bool OAIServiceUpdateProperties::is_service_kind_Set() const{
    return m_service_kind_isSet;
}

bool OAIServiceUpdateProperties::is_service_kind_Valid() const{
    return m_service_kind_isValid;
}

QList<OAIServiceCorrelationDescription> OAIServiceUpdateProperties::getCorrelationScheme() const {
    return m_correlation_scheme;
}
void OAIServiceUpdateProperties::setCorrelationScheme(const QList<OAIServiceCorrelationDescription> &correlation_scheme) {
    m_correlation_scheme = correlation_scheme;
    m_correlation_scheme_isSet = true;
}

bool OAIServiceUpdateProperties::is_correlation_scheme_Set() const{
    return m_correlation_scheme_isSet;
}

bool OAIServiceUpdateProperties::is_correlation_scheme_Valid() const{
    return m_correlation_scheme_isValid;
}

OAIMoveCost OAIServiceUpdateProperties::getDefaultMoveCost() const {
    return m_default_move_cost;
}
void OAIServiceUpdateProperties::setDefaultMoveCost(const OAIMoveCost &default_move_cost) {
    m_default_move_cost = default_move_cost;
    m_default_move_cost_isSet = true;
}

bool OAIServiceUpdateProperties::is_default_move_cost_Set() const{
    return m_default_move_cost_isSet;
}

bool OAIServiceUpdateProperties::is_default_move_cost_Valid() const{
    return m_default_move_cost_isValid;
}

QString OAIServiceUpdateProperties::getPlacementConstraints() const {
    return m_placement_constraints;
}
void OAIServiceUpdateProperties::setPlacementConstraints(const QString &placement_constraints) {
    m_placement_constraints = placement_constraints;
    m_placement_constraints_isSet = true;
}

bool OAIServiceUpdateProperties::is_placement_constraints_Set() const{
    return m_placement_constraints_isSet;
}

bool OAIServiceUpdateProperties::is_placement_constraints_Valid() const{
    return m_placement_constraints_isValid;
}

QList<OAIServiceLoadMetricDescription> OAIServiceUpdateProperties::getServiceLoadMetrics() const {
    return m_service_load_metrics;
}
void OAIServiceUpdateProperties::setServiceLoadMetrics(const QList<OAIServiceLoadMetricDescription> &service_load_metrics) {
    m_service_load_metrics = service_load_metrics;
    m_service_load_metrics_isSet = true;
}

bool OAIServiceUpdateProperties::is_service_load_metrics_Set() const{
    return m_service_load_metrics_isSet;
}

bool OAIServiceUpdateProperties::is_service_load_metrics_Valid() const{
    return m_service_load_metrics_isValid;
}

QList<OAIServicePlacementPolicyDescription> OAIServiceUpdateProperties::getServicePlacementPolicies() const {
    return m_service_placement_policies;
}
void OAIServiceUpdateProperties::setServicePlacementPolicies(const QList<OAIServicePlacementPolicyDescription> &service_placement_policies) {
    m_service_placement_policies = service_placement_policies;
    m_service_placement_policies_isSet = true;
}

bool OAIServiceUpdateProperties::is_service_placement_policies_Set() const{
    return m_service_placement_policies_isSet;
}

bool OAIServiceUpdateProperties::is_service_placement_policies_Valid() const{
    return m_service_placement_policies_isValid;
}

bool OAIServiceUpdateProperties::isSet() const {
...
bool OAIServiceUpdateProperties::isValid() const {
