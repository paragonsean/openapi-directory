...
/**
 * The NodeHealthReport model module.
 * @module model/NodeHealthReport
 * @version 1.0.0
 */
class NodeHealthReport {
    /**
     * Constructs a new <code>NodeHealthReport</code>.
     * The report of the node health
     * @alias module:model/NodeHealthReport
     * @implements module:model/HealthReport
     */
    constructor() { 
        HealthReport.initialize(this);
        NodeHealthReport.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NodeHealthReport</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeHealthReport} obj Optional instance to populate.
     * @return {module:model/NodeHealthReport} The populated <code>NodeHealthReport</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeHealthReport();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeHealthReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeHealthReport</code>.
     */
 ...
 */
NodeHealthReport.prototype['Description'] = undefined;

/**
 * @member {module:model/HealthState} HealthState
 */
NodeHealthReport.prototype['HealthState'] = undefined;

/**
 * @member {String} Property
 */
NodeHealthReport.prototype['Property'] = undefined;

/**
 * @member {Boolean} RemoveWhenExpired
 */
NodeHealthReport.prototype['RemoveWhenExpired'] = undefined;

/**
 * @member {String} SequenceNumber
 */
NodeHealthReport.prototype['SequenceNumber'] = undefined;

/**
 * @member {String} SourceId
 */
NodeHealthReport.prototype['SourceId'] = undefined;

/**
 * @member {String} TimeToLiveInMilliSeconds
 */
NodeHealthReport.prototype['TimeToLiveInMilliSeconds'] = undefined;
...
export default NodeHealthReport;
