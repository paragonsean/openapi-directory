...
/**
 * The DeployedServiceHealthReport model module.
 * @module model/DeployedServiceHealthReport
 * @version 1.0.0
 */
class DeployedServiceHealthReport {
    /**
     * Constructs a new <code>DeployedServiceHealthReport</code>.
     * The report of the deployed service package health
     * @alias module:model/DeployedServiceHealthReport
     * @implements module:model/HealthReport
     */
    constructor() { 
        HealthReport.initialize(this);
        DeployedServiceHealthReport.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeployedServiceHealthReport</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeployedServiceHealthReport} obj Optional instance to populate.
     * @return {module:model/DeployedServiceHealthReport} The populated <code>DeployedServiceHealthReport</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeployedServiceHealthReport();
    ...
    /**
     * Validates the JSON data with respect to <code>DeployedServiceHealthReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeployedServiceHealthReport</code>.
     */
 ...
 */
DeployedServiceHealthReport.prototype['Description'] = undefined;

/**
 * @member {module:model/HealthState} HealthState
 */
DeployedServiceHealthReport.prototype['HealthState'] = undefined;

/**
 * @member {String} Property
 */
DeployedServiceHealthReport.prototype['Property'] = undefined;

/**
 * @member {Boolean} RemoveWhenExpired
 */
DeployedServiceHealthReport.prototype['RemoveWhenExpired'] = undefined;

/**
 * @member {String} SequenceNumber
 */
DeployedServiceHealthReport.prototype['SequenceNumber'] = undefined;

/**
 * @member {String} SourceId
 */
DeployedServiceHealthReport.prototype['SourceId'] = undefined;

/**
 * @member {String} TimeToLiveInMilliSeconds
 */
DeployedServiceHealthReport.prototype['TimeToLiveInMilliSeconds'] = undefined;
...
export default DeployedServiceHealthReport;
