...
/**
 * The PartitionHealthReport model module.
 * @module model/PartitionHealthReport
 * @version 1.0.0
 */
class PartitionHealthReport {
    /**
     * Constructs a new <code>PartitionHealthReport</code>.
     * The report of the partition health
     * @alias module:model/PartitionHealthReport
     * @implements module:model/HealthReport
     */
    constructor() { 
        HealthReport.initialize(this);
        PartitionHealthReport.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PartitionHealthReport</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartitionHealthReport} obj Optional instance to populate.
     * @return {module:model/PartitionHealthReport} The populated <code>PartitionHealthReport</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartitionHealthReport();
    ...
    /**
     * Validates the JSON data with respect to <code>PartitionHealthReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartitionHealthReport</code>.
     */
 ...
 */
PartitionHealthReport.prototype['Description'] = undefined;

/**
 * @member {module:model/HealthState} HealthState
 */
PartitionHealthReport.prototype['HealthState'] = undefined;

/**
 * @member {String} Property
 */
PartitionHealthReport.prototype['Property'] = undefined;

/**
 * @member {Boolean} RemoveWhenExpired
 */
PartitionHealthReport.prototype['RemoveWhenExpired'] = undefined;

/**
 * @member {String} SequenceNumber
 */
PartitionHealthReport.prototype['SequenceNumber'] = undefined;

/**
 * @member {String} SourceId
 */
PartitionHealthReport.prototype['SourceId'] = undefined;

/**
 * @member {String} TimeToLiveInMilliSeconds
 */
PartitionHealthReport.prototype['TimeToLiveInMilliSeconds'] = undefined;
...
export default PartitionHealthReport;
