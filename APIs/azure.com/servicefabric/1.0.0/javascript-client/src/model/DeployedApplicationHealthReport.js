...
/**
 * The DeployedApplicationHealthReport model module.
 * @module model/DeployedApplicationHealthReport
 * @version 1.0.0
 */
class DeployedApplicationHealthReport {
    /**
     * Constructs a new <code>DeployedApplicationHealthReport</code>.
     * The report of the deployed application health
     * @alias module:model/DeployedApplicationHealthReport
     * @implements module:model/HealthReport
     */
    constructor() { 
        HealthReport.initialize(this);
        DeployedApplicationHealthReport.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeployedApplicationHealthReport</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeployedApplicationHealthReport} obj Optional instance to populate.
     * @return {module:model/DeployedApplicationHealthReport} The populated <code>DeployedApplicationHealthReport</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeployedApplicationHealthReport();
    ...
    /**
     * Validates the JSON data with respect to <code>DeployedApplicationHealthReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeployedApplicationHealthReport</code>.
     */
 ...
 */
DeployedApplicationHealthReport.prototype['Description'] = undefined;

/**
 * @member {module:model/HealthState} HealthState
 */
DeployedApplicationHealthReport.prototype['HealthState'] = undefined;

/**
 * @member {String} Property
 */
DeployedApplicationHealthReport.prototype['Property'] = undefined;

/**
 * @member {Boolean} RemoveWhenExpired
 */
DeployedApplicationHealthReport.prototype['RemoveWhenExpired'] = undefined;

/**
 * @member {String} SequenceNumber
 */
DeployedApplicationHealthReport.prototype['SequenceNumber'] = undefined;

/**
 * @member {String} SourceId
 */
DeployedApplicationHealthReport.prototype['SourceId'] = undefined;

/**
 * @member {String} TimeToLiveInMilliSeconds
 */
DeployedApplicationHealthReport.prototype['TimeToLiveInMilliSeconds'] = undefined;
...
export default DeployedApplicationHealthReport;
