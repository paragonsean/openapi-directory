...
/**
 * The ServiceHealthEvaluation model module.
 * @module model/ServiceHealthEvaluation
 * @version 1.0.0
 */
class ServiceHealthEvaluation {
    /**
     * Constructs a new <code>ServiceHealthEvaluation</code>.
     * The evaluation of the service health
     * @alias module:model/ServiceHealthEvaluation
     * @extends module:model/HealthEvaluation
     * @implements module:model/HealthEvaluation
     * @param kind {module:model/ServiceHealthEvaluation.KindEnum} 
     */
    constructor(kind) { 
        HealthEvaluation.initialize(this, kind);
        ServiceHealthEvaluation.initialize(this, kind);
    }
    ...
    /**
     * Constructs a <code>ServiceHealthEvaluation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceHealthEvaluation} obj Optional instance to populate.
     * @return {module:model/ServiceHealthEvaluation} The populated <code>ServiceHealthEvaluation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceHealthEvaluation();
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceHealthEvaluation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceHealthEvaluation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServiceHealthEvaluation.RequiredProperties) {
...
ServiceHealthEvaluation.RequiredProperties = ["Kind"];

/**
 * @member {String} ServiceName
 */
ServiceHealthEvaluation.prototype['ServiceName'] = undefined;

/**
 * @member {Array.<module:model/UnhealthyEvaluation>} UnhealthyEvaluations
 */
ServiceHealthEvaluation.prototype['UnhealthyEvaluations'] = undefined;
...
export default ServiceHealthEvaluation;
