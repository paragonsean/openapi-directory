...
/**
 * The CreateServiceGroupDescription model module.
 * @module model/CreateServiceGroupDescription
 * @version 1.0.0
 */
class CreateServiceGroupDescription {
    /**
     * Constructs a new <code>CreateServiceGroupDescription</code>.
     * The description of the create service group
     * @alias module:model/CreateServiceGroupDescription
    ...
    /**
     * Constructs a <code>CreateServiceGroupDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateServiceGroupDescription} obj Optional instance to populate.
     * @return {module:model/CreateServiceGroupDescription} The populated <code>CreateServiceGroupDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateServiceGroupDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateServiceGroupDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateServiceGroupDescription</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateServiceGroupDescription.RequiredProperties) {
...
CreateServiceGroupDescription.RequiredProperties = ["ServiceKind"];
...
export default CreateServiceGroupDescription;
