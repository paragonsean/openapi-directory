...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClient.PartitionList();
  });
  ...
  describe('PartitionList', function() {
    it('should create an instance of PartitionList', function() {
      // uncomment below and update the code to test PartitionList
      //var instance = new ServiceFabricClient.PartitionList();
      //expect(instance).to.be.a(ServiceFabricClient.PartitionList);
    });
