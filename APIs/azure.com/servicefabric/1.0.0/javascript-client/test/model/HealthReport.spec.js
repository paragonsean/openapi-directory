...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClient.HealthReport();
  });
  ...
  describe('HealthReport', function() {
    it('should create an instance of HealthReport', function() {
      // uncomment below and update the code to test HealthReport
      //var instance = new ServiceFabricClient.HealthReport();
      //expect(instance).to.be.a(ServiceFabricClient.HealthReport);
    });
