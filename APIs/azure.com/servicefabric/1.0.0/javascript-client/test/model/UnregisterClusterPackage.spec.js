...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClient.UnregisterClusterPackage();
  });
  ...
  describe('UnregisterClusterPackage', function() {
    it('should create an instance of UnregisterClusterPackage', function() {
      // uncomment below and update the code to test UnregisterClusterPackage
      //var instance = new ServiceFabricClient.UnregisterClusterPackage();
      //expect(instance).to.be.a(ServiceFabricClient.UnregisterClusterPackage);
    });
