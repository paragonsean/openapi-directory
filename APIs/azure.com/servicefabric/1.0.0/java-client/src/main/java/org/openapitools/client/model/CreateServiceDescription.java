...
public class CreateServiceDescription {
  ...
  public CreateServiceDescription() {
    this.serviceKind = this.getClass().getSimpleName();
  }

  public CreateServiceDescription applicationName(String applicationName) {
  ...
  public CreateServiceDescription correlationScheme(ServiceCorrelationDescription correlationScheme) {
  ...
  public CreateServiceDescription flags(Integer flags) {
    this.flags = flags;
    return this;
  }
  ...
  public CreateServiceDescription partitionDescription(PartitionDescription partitionDescription) {
  ...
  public CreateServiceDescription placementConstraints(String placementConstraints) {
  ...
  public CreateServiceDescription serviceKind(ServiceKind serviceKind) {
  ...
  public CreateServiceDescription serviceLoadMetrics(ServiceCorrelationDescription serviceLoadMetrics) {
  ...
  public CreateServiceDescription serviceName(String serviceName) {
  ...
  public CreateServiceDescription servicePlacementPolicies(ServiceCorrelationDescription servicePlacementPolicies) {
  ...
  public CreateServiceDescription serviceTypeName(String serviceTypeName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateServiceDescription createServiceDescription = (CreateServiceDescription) o;
    return Objects.equals(this.applicationName, createServiceDescription.applicationName) &&
        Objects.equals(this.correlationScheme, createServiceDescription.correlationScheme) &&
        Objects.equals(this.flags, createServiceDescription.flags) &&
        Objects.equals(this.partitionDescription, createServiceDescription.partitionDescription) &&
        Objects.equals(this.placementConstraints, createServiceDescription.placementConstraints) &&
        Objects.equals(this.serviceKind, createServiceDescription.serviceKind) &&
        Objects.equals(this.serviceLoadMetrics, createServiceDescription.serviceLoadMetrics) &&
        Objects.equals(this.serviceName, createServiceDescription.serviceName) &&
        Objects.equals(this.servicePlacementPolicies, createServiceDescription.servicePlacementPolicies) &&
        Objects.equals(this.serviceTypeName, createServiceDescription.serviceTypeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateServiceDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServiceDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServiceDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServiceDescription is not found in the empty JSON string", CreateServiceDescription.openapiRequiredFields.toString()));
        }
      }

      String discriminatorValue = jsonElement.getAsJsonObject().get("ServiceKind").getAsString();
      switch (discriminatorValue) {
        case "StatefulCreateServiceDescription":
          StatefulCreateServiceDescription.validateJsonElement(jsonElement);
          break;
        case "StatelessCreateServiceDescription":
          StatelessCreateServiceDescription.validateJsonElement(jsonElement);
          break;
        default:
  ...
  /**
   * Create an instance of CreateServiceDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServiceDescription
   * @throws IOException if the JSON string is invalid with respect to CreateServiceDescription
   */
  public static CreateServiceDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServiceDescription.class);
  }

  /**
   * Convert an instance of CreateServiceDescription to an JSON string
   *
   * @return JSON string
   */
