...
public class ApplicationHealthPolicy {
  ...
  private ApplicationHealthPolicyDefaultServiceTypeHealthPolicy defaultServiceTypeHealthPolicy;
  ...
  public ApplicationHealthPolicy defaultServiceTypeHealthPolicy(ApplicationHealthPolicyDefaultServiceTypeHealthPolicy defaultServiceTypeHealthPolicy) {
   ...
   */
  @javax.annotation.Nullable
  public ApplicationHealthPolicyDefaultServiceTypeHealthPolicy getDefaultServiceTypeHealthPolicy() {
    return defaultServiceTypeHealthPolicy;
  }

  public void setDefaultServiceTypeHealthPolicy(ApplicationHealthPolicyDefaultServiceTypeHealthPolicy defaultServiceTypeHealthPolicy) {
    this.defaultServiceTypeHealthPolicy = defaultServiceTypeHealthPolicy;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(considerWarningAsError, defaultServiceTypeHealthPolicy, maxPercentUnhealthyDeployedApplications);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("DefaultServiceTypeHealthPolicy") != null && !jsonObj.get("DefaultServiceTypeHealthPolicy").isJsonNull()) {
        ApplicationHealthPolicyDefaultServiceTypeHealthPolicy.validateJsonElement(jsonObj.get("DefaultServiceTypeHealthPolicy"));
      }
  }
