...
public class ApplicationHealthReport {
  ...
  public ApplicationHealthReport description(String description) {
  ...
  public ApplicationHealthReport healthState(HealthState healthState) {
  ...
  public ApplicationHealthReport property(String property) {
  ...
  public ApplicationHealthReport removeWhenExpired(Boolean removeWhenExpired) {
  ...
  public ApplicationHealthReport sequenceNumber(String sequenceNumber) {
  ...
  public ApplicationHealthReport sourceId(String sourceId) {
  ...
  public ApplicationHealthReport timeToLiveInMilliSeconds(String timeToLiveInMilliSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationHealthReport applicationHealthReport = (ApplicationHealthReport) o;
    return Objects.equals(this.description, applicationHealthReport.description) &&
        Objects.equals(this.healthState, applicationHealthReport.healthState) &&
        Objects.equals(this.property, applicationHealthReport.property) &&
        Objects.equals(this.removeWhenExpired, applicationHealthReport.removeWhenExpired) &&
        Objects.equals(this.sequenceNumber, applicationHealthReport.sequenceNumber) &&
        Objects.equals(this.sourceId, applicationHealthReport.sourceId) &&
        Objects.equals(this.timeToLiveInMilliSeconds, applicationHealthReport.timeToLiveInMilliSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationHealthReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationHealthReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationHealthReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationHealthReport is not found in the empty JSON string", ApplicationHealthReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationHealthReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationHealthReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationHealthReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationHealthReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationHealthReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationHealthReport.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationHealthReport>() {
           @Override
           public void write(JsonWriter out, ApplicationHealthReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationHealthReport read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationHealthReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationHealthReport
   * @throws IOException if the JSON string is invalid with respect to ApplicationHealthReport
   */
  public static ApplicationHealthReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationHealthReport.class);
  }

  /**
   * Convert an instance of ApplicationHealthReport to an JSON string
   *
   * @return JSON string
   */
