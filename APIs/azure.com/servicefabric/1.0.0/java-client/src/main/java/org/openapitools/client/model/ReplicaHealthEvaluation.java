...
public class ReplicaHealthEvaluation extends HealthEvaluation {
  ...
  public ReplicaHealthEvaluation partitionId(String partitionId) {
  ...
  public ReplicaHealthEvaluation unhealthyEvaluations(List<UnhealthyEvaluation> unhealthyEvaluations) {
    this.unhealthyEvaluations = unhealthyEvaluations;
    return this;
  }

  public ReplicaHealthEvaluation addUnhealthyEvaluationsItem(UnhealthyEvaluation unhealthyEvaluationsItem) {
