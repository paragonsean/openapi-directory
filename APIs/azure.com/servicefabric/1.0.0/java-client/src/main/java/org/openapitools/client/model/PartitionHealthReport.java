...
public class PartitionHealthReport {
  ...
  public PartitionHealthReport() {
  }

  public PartitionHealthReport description(String description) {
  ...
  public PartitionHealthReport healthState(HealthState healthState) {
  ...
  public PartitionHealthReport property(String property) {
  ...
  public PartitionHealthReport removeWhenExpired(Boolean removeWhenExpired) {
  ...
  public PartitionHealthReport sequenceNumber(String sequenceNumber) {
  ...
  public PartitionHealthReport sourceId(String sourceId) {
  ...
  public PartitionHealthReport timeToLiveInMilliSeconds(String timeToLiveInMilliSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    PartitionHealthReport partitionHealthReport = (PartitionHealthReport) o;
    return Objects.equals(this.description, partitionHealthReport.description) &&
        Objects.equals(this.healthState, partitionHealthReport.healthState) &&
        Objects.equals(this.property, partitionHealthReport.property) &&
        Objects.equals(this.removeWhenExpired, partitionHealthReport.removeWhenExpired) &&
        Objects.equals(this.sequenceNumber, partitionHealthReport.sequenceNumber) &&
        Objects.equals(this.sourceId, partitionHealthReport.sourceId) &&
        Objects.equals(this.timeToLiveInMilliSeconds, partitionHealthReport.timeToLiveInMilliSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class PartitionHealthReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PartitionHealthReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PartitionHealthReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PartitionHealthReport is not found in the empty JSON string", PartitionHealthReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PartitionHealthReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PartitionHealthReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PartitionHealthReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PartitionHealthReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PartitionHealthReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PartitionHealthReport.class));

       return (TypeAdapter<T>) new TypeAdapter<PartitionHealthReport>() {
           @Override
           public void write(JsonWriter out, PartitionHealthReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PartitionHealthReport read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PartitionHealthReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PartitionHealthReport
   * @throws IOException if the JSON string is invalid with respect to PartitionHealthReport
   */
  public static PartitionHealthReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartitionHealthReport.class);
  }

  /**
   * Convert an instance of PartitionHealthReport to an JSON string
   *
   * @return JSON string
   */
