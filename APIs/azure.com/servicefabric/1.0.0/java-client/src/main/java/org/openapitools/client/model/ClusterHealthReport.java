...
public class ClusterHealthReport {
  ...
  public ClusterHealthReport description(String description) {
  ...
  public ClusterHealthReport healthState(HealthState healthState) {
  ...
  public ClusterHealthReport property(String property) {
  ...
  public ClusterHealthReport removeWhenExpired(Boolean removeWhenExpired) {
  ...
  public ClusterHealthReport sequenceNumber(String sequenceNumber) {
  ...
  public ClusterHealthReport sourceId(String sourceId) {
  ...
  public ClusterHealthReport timeToLiveInMilliSeconds(String timeToLiveInMilliSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, clusterHealthReport.description) &&
        Objects.equals(this.healthState, clusterHealthReport.healthState) &&
        Objects.equals(this.property, clusterHealthReport.property) &&
        Objects.equals(this.removeWhenExpired, clusterHealthReport.removeWhenExpired) &&
        Objects.equals(this.sequenceNumber, clusterHealthReport.sequenceNumber) &&
        Objects.equals(this.sourceId, clusterHealthReport.sourceId) &&
        Objects.equals(this.timeToLiveInMilliSeconds, clusterHealthReport.timeToLiveInMilliSeconds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterHealthReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterHealthReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterHealthReport is not found in the empty JSON string", ClusterHealthReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterHealthReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterHealthReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterHealthReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterHealthReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterHealthReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterHealthReport.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterHealthReport>() {
           @Override
           public void write(JsonWriter out, ClusterHealthReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterHealthReport read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterHealthReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterHealthReport
   * @throws IOException if the JSON string is invalid with respect to ClusterHealthReport
   */
  public static ClusterHealthReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterHealthReport.class);
  }

  /**
   * Convert an instance of ClusterHealthReport to an JSON string
   *
   * @return JSON string
   */
