...
public class NodeHealthReport {
  ...
  public NodeHealthReport() {
  }

  public NodeHealthReport description(String description) {
  ...
  public NodeHealthReport healthState(HealthState healthState) {
  ...
  public NodeHealthReport property(String property) {
  ...
  public NodeHealthReport removeWhenExpired(Boolean removeWhenExpired) {
  ...
  public NodeHealthReport sequenceNumber(String sequenceNumber) {
  ...
  public NodeHealthReport sourceId(String sourceId) {
  ...
  public NodeHealthReport timeToLiveInMilliSeconds(String timeToLiveInMilliSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    NodeHealthReport nodeHealthReport = (NodeHealthReport) o;
    return Objects.equals(this.description, nodeHealthReport.description) &&
        Objects.equals(this.healthState, nodeHealthReport.healthState) &&
        Objects.equals(this.property, nodeHealthReport.property) &&
        Objects.equals(this.removeWhenExpired, nodeHealthReport.removeWhenExpired) &&
        Objects.equals(this.sequenceNumber, nodeHealthReport.sequenceNumber) &&
        Objects.equals(this.sourceId, nodeHealthReport.sourceId) &&
        Objects.equals(this.timeToLiveInMilliSeconds, nodeHealthReport.timeToLiveInMilliSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeHealthReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeHealthReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeHealthReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeHealthReport is not found in the empty JSON string", NodeHealthReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeHealthReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeHealthReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeHealthReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeHealthReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeHealthReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeHealthReport.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeHealthReport>() {
           @Override
           public void write(JsonWriter out, NodeHealthReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeHealthReport read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeHealthReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeHealthReport
   * @throws IOException if the JSON string is invalid with respect to NodeHealthReport
   */
  public static NodeHealthReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeHealthReport.class);
  }

  /**
   * Convert an instance of NodeHealthReport to an JSON string
   *
   * @return JSON string
   */
