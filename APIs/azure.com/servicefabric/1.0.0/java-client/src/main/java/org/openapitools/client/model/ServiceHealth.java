...
public class ServiceHealth {
  ...
  private List<ServiceHealthPartitionHealthStatesInner> partitionHealthStates = new ArrayList<>();
  ...
  public ServiceHealth partitionHealthStates(List<ServiceHealthPartitionHealthStatesInner> partitionHealthStates) {
    this.partitionHealthStates = partitionHealthStates;
    return this;
  }

  public ServiceHealth addPartitionHealthStatesItem(ServiceHealthPartitionHealthStatesInner partitionHealthStatesItem) {
  ...
  /**
   * Get partitionHealthStates
   * @return partitionHealthStates
   */
  @javax.annotation.Nullable
  public List<ServiceHealthPartitionHealthStatesInner> getPartitionHealthStates() {
    return partitionHealthStates;
  }

  public void setPartitionHealthStates(List<ServiceHealthPartitionHealthStatesInner> partitionHealthStates) {
    this.partitionHealthStates = partitionHealthStates;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aggregatedHealthState, healthEvents, name, partitionHealthStates);
  }
      ...
      if (jsonObj.get("PartitionHealthStates") != null && !jsonObj.get("PartitionHealthStates").isJsonNull()) {
        ...
        if (jsonArraypartitionHealthStates != null) {
          ...
          for (int i = 0; i < jsonArraypartitionHealthStates.size(); i++) {
            ServiceHealthPartitionHealthStatesInner.validateJsonElement(jsonArraypartitionHealthStates.get(i));
          };
        }
      }
  }
