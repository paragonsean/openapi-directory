...
public class ApplicationDescription {
  ...
  private List<ApplicationDescriptionParameterListInner> parameterList = new ArrayList<>();
  ...
  public ApplicationDescription parameterList(List<ApplicationDescriptionParameterListInner> parameterList) {
    this.parameterList = parameterList;
    return this;
  }

  public ApplicationDescription addParameterListItem(ApplicationDescriptionParameterListInner parameterListItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApplicationDescriptionParameterListInner> getParameterList() {
    return parameterList;
  }

  public void setParameterList(List<ApplicationDescriptionParameterListInner> parameterList) {
    this.parameterList = parameterList;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, applicationDescription.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, parameterList, typeName, typeVersion);
  }
      ...
      if (jsonObj.get("ParameterList") != null && !jsonObj.get("ParameterList").isJsonNull()) {
        ...
        if (jsonArrayparameterList != null) {
          ...
          for (int i = 0; i < jsonArrayparameterList.size(); i++) {
            ApplicationDescriptionParameterListInner.validateJsonElement(jsonArrayparameterList.get(i));
          };
        }
      }
