...
public class ReplicaHealthReport {
  ...
  public ReplicaHealthReport() {
  }

  public ReplicaHealthReport description(String description) {
  ...
  public ReplicaHealthReport healthState(HealthState healthState) {
  ...
  public ReplicaHealthReport property(String property) {
  ...
  public ReplicaHealthReport removeWhenExpired(Boolean removeWhenExpired) {
  ...
  public ReplicaHealthReport sequenceNumber(String sequenceNumber) {
  ...
  public ReplicaHealthReport sourceId(String sourceId) {
  ...
  public ReplicaHealthReport timeToLiveInMilliSeconds(String timeToLiveInMilliSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    ReplicaHealthReport replicaHealthReport = (ReplicaHealthReport) o;
    return Objects.equals(this.description, replicaHealthReport.description) &&
        Objects.equals(this.healthState, replicaHealthReport.healthState) &&
        Objects.equals(this.property, replicaHealthReport.property) &&
        Objects.equals(this.removeWhenExpired, replicaHealthReport.removeWhenExpired) &&
        Objects.equals(this.sequenceNumber, replicaHealthReport.sequenceNumber) &&
        Objects.equals(this.sourceId, replicaHealthReport.sourceId) &&
        Objects.equals(this.timeToLiveInMilliSeconds, replicaHealthReport.timeToLiveInMilliSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplicaHealthReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicaHealthReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicaHealthReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicaHealthReport is not found in the empty JSON string", ReplicaHealthReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicaHealthReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicaHealthReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicaHealthReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicaHealthReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicaHealthReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicaHealthReport.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicaHealthReport>() {
           @Override
           public void write(JsonWriter out, ReplicaHealthReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicaHealthReport read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicaHealthReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicaHealthReport
   * @throws IOException if the JSON string is invalid with respect to ReplicaHealthReport
   */
  public static ReplicaHealthReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicaHealthReport.class);
  }

  /**
   * Convert an instance of ReplicaHealthReport to an JSON string
   *
   * @return JSON string
   */
