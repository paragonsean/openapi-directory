...
public class DeployedServiceHealthReport {
  ...
  public DeployedServiceHealthReport() {
  }

  public DeployedServiceHealthReport description(String description) {
  ...
  public DeployedServiceHealthReport healthState(HealthState healthState) {
  ...
  public DeployedServiceHealthReport property(String property) {
  ...
  public DeployedServiceHealthReport removeWhenExpired(Boolean removeWhenExpired) {
  ...
  public DeployedServiceHealthReport sequenceNumber(String sequenceNumber) {
  ...
  public DeployedServiceHealthReport sourceId(String sourceId) {
  ...
  public DeployedServiceHealthReport timeToLiveInMilliSeconds(String timeToLiveInMilliSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    DeployedServiceHealthReport deployedServiceHealthReport = (DeployedServiceHealthReport) o;
    return Objects.equals(this.description, deployedServiceHealthReport.description) &&
        Objects.equals(this.healthState, deployedServiceHealthReport.healthState) &&
        Objects.equals(this.property, deployedServiceHealthReport.property) &&
        Objects.equals(this.removeWhenExpired, deployedServiceHealthReport.removeWhenExpired) &&
        Objects.equals(this.sequenceNumber, deployedServiceHealthReport.sequenceNumber) &&
        Objects.equals(this.sourceId, deployedServiceHealthReport.sourceId) &&
        Objects.equals(this.timeToLiveInMilliSeconds, deployedServiceHealthReport.timeToLiveInMilliSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeployedServiceHealthReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeployedServiceHealthReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeployedServiceHealthReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeployedServiceHealthReport is not found in the empty JSON string", DeployedServiceHealthReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeployedServiceHealthReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeployedServiceHealthReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeployedServiceHealthReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeployedServiceHealthReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeployedServiceHealthReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeployedServiceHealthReport.class));

       return (TypeAdapter<T>) new TypeAdapter<DeployedServiceHealthReport>() {
           @Override
           public void write(JsonWriter out, DeployedServiceHealthReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeployedServiceHealthReport read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeployedServiceHealthReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeployedServiceHealthReport
   * @throws IOException if the JSON string is invalid with respect to DeployedServiceHealthReport
   */
  public static DeployedServiceHealthReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeployedServiceHealthReport.class);
  }

  /**
   * Convert an instance of DeployedServiceHealthReport to an JSON string
   *
   * @return JSON string
   */
