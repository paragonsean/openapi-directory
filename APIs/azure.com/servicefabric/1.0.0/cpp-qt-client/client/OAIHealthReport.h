...
#ifndef OAIHealthReport_H
#define OAIHealthReport_H
...
class OAIHealthReport : public OAIObject {
public:
    OAIHealthReport();
    OAIHealthReport(QString json);
    ~OAIHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthReport)

#endif // OAIHealthReport_H
