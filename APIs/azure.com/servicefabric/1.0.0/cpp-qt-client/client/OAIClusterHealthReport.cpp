...
OAIClusterHealthReport::OAIClusterHealthReport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClusterHealthReport::OAIClusterHealthReport() {
    this->initializeModel();
}

OAIClusterHealthReport::~OAIClusterHealthReport() {}

void OAIClusterHealthReport::initializeModel() {
...
void OAIClusterHealthReport::fromJson(QString jsonString) {
...
void OAIClusterHealthReport::fromJsonObject(QJsonObject json) {
...
QString OAIClusterHealthReport::asJson() const {
...
QJsonObject OAIClusterHealthReport::asJsonObject() const {
    QJsonObject obj;
...
QString OAIClusterHealthReport::getDescription() const {
    return m_description;
}
void OAIClusterHealthReport::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIClusterHealthReport::is_description_Set() const{
    return m_description_isSet;
}

bool OAIClusterHealthReport::is_description_Valid() const{
    return m_description_isValid;
}

OAIHealthState OAIClusterHealthReport::getHealthState() const {
    return m_health_state;
}
void OAIClusterHealthReport::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIClusterHealthReport::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIClusterHealthReport::is_health_state_Valid() const{
    return m_health_state_isValid;
}

QString OAIClusterHealthReport::getProperty() const {
    return m_property;
}
void OAIClusterHealthReport::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIClusterHealthReport::is_property_Set() const{
    return m_property_isSet;
}

bool OAIClusterHealthReport::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIClusterHealthReport::isRemoveWhenExpired() const {
    return m_remove_when_expired;
}
void OAIClusterHealthReport::setRemoveWhenExpired(const bool &remove_when_expired) {
    m_remove_when_expired = remove_when_expired;
    m_remove_when_expired_isSet = true;
}

bool OAIClusterHealthReport::is_remove_when_expired_Set() const{
    return m_remove_when_expired_isSet;
}

bool OAIClusterHealthReport::is_remove_when_expired_Valid() const{
    return m_remove_when_expired_isValid;
}

QString OAIClusterHealthReport::getSequenceNumber() const {
    return m_sequence_number;
}
void OAIClusterHealthReport::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAIClusterHealthReport::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAIClusterHealthReport::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAIClusterHealthReport::getSourceId() const {
    return m_source_id;
}
void OAIClusterHealthReport::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAIClusterHealthReport::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAIClusterHealthReport::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QString OAIClusterHealthReport::getTimeToLiveInMilliSeconds() const {
    return m_time_to_live_in_milli_seconds;
}
void OAIClusterHealthReport::setTimeToLiveInMilliSeconds(const QString &time_to_live_in_milli_seconds) {
    m_time_to_live_in_milli_seconds = time_to_live_in_milli_seconds;
    m_time_to_live_in_milli_seconds_isSet = true;
}

bool OAIClusterHealthReport::is_time_to_live_in_milli_seconds_Set() const{
    return m_time_to_live_in_milli_seconds_isSet;
}

bool OAIClusterHealthReport::is_time_to_live_in_milli_seconds_Valid() const{
    return m_time_to_live_in_milli_seconds_isValid;
}

bool OAIClusterHealthReport::isSet() const {
...
bool OAIClusterHealthReport::isValid() const {
