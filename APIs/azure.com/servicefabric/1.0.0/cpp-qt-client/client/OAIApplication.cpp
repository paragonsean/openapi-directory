...
OAIHealthState OAIApplication::getHealthState() const {
    return m_health_state;
}
void OAIApplication::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIApplication::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIApplication::is_health_state_Valid() const{
...
QList<OAIApplication_Parameters_inner> OAIApplication::getParameters() const {
    return m_parameters;
}
void OAIApplication::setParameters(const QList<OAIApplication_Parameters_inner> &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIApplication::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIApplication::is_parameters_Valid() const{
...
QString OAIApplication::getTypeName() const {
    return m_type_name;
}
void OAIApplication::setTypeName(const QString &type_name) {
    m_type_name = type_name;
    m_type_name_isSet = true;
}

bool OAIApplication::is_type_name_Set() const{
    return m_type_name_isSet;
}

bool OAIApplication::is_type_name_Valid() const{
    return m_type_name_isValid;
}

QString OAIApplication::getTypeVersion() const {
    return m_type_version;
}
void OAIApplication::setTypeVersion(const QString &type_version) {
    m_type_version = type_version;
    m_type_version_isSet = true;
}

bool OAIApplication::is_type_version_Set() const{
    return m_type_version_isSet;
}

bool OAIApplication::is_type_version_Valid() const{
