...
OAIDeployedServiceHealthReport::OAIDeployedServiceHealthReport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeployedServiceHealthReport::OAIDeployedServiceHealthReport() {
    this->initializeModel();
}

OAIDeployedServiceHealthReport::~OAIDeployedServiceHealthReport() {}

void OAIDeployedServiceHealthReport::initializeModel() {
...
void OAIDeployedServiceHealthReport::fromJson(QString jsonString) {
...
void OAIDeployedServiceHealthReport::fromJsonObject(QJsonObject json) {
...
QString OAIDeployedServiceHealthReport::asJson() const {
...
QJsonObject OAIDeployedServiceHealthReport::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeployedServiceHealthReport::getDescription() const {
    return m_description;
}
void OAIDeployedServiceHealthReport::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDeployedServiceHealthReport::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDeployedServiceHealthReport::is_description_Valid() const{
    return m_description_isValid;
}

OAIHealthState OAIDeployedServiceHealthReport::getHealthState() const {
    return m_health_state;
}
void OAIDeployedServiceHealthReport::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIDeployedServiceHealthReport::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIDeployedServiceHealthReport::is_health_state_Valid() const{
    return m_health_state_isValid;
}

QString OAIDeployedServiceHealthReport::getProperty() const {
    return m_property;
}
void OAIDeployedServiceHealthReport::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIDeployedServiceHealthReport::is_property_Set() const{
    return m_property_isSet;
}

bool OAIDeployedServiceHealthReport::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIDeployedServiceHealthReport::isRemoveWhenExpired() const {
    return m_remove_when_expired;
}
void OAIDeployedServiceHealthReport::setRemoveWhenExpired(const bool &remove_when_expired) {
    m_remove_when_expired = remove_when_expired;
    m_remove_when_expired_isSet = true;
}

bool OAIDeployedServiceHealthReport::is_remove_when_expired_Set() const{
    return m_remove_when_expired_isSet;
}

bool OAIDeployedServiceHealthReport::is_remove_when_expired_Valid() const{
    return m_remove_when_expired_isValid;
}

QString OAIDeployedServiceHealthReport::getSequenceNumber() const {
    return m_sequence_number;
}
void OAIDeployedServiceHealthReport::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAIDeployedServiceHealthReport::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAIDeployedServiceHealthReport::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAIDeployedServiceHealthReport::getSourceId() const {
    return m_source_id;
}
void OAIDeployedServiceHealthReport::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAIDeployedServiceHealthReport::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAIDeployedServiceHealthReport::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QString OAIDeployedServiceHealthReport::getTimeToLiveInMilliSeconds() const {
    return m_time_to_live_in_milli_seconds;
}
void OAIDeployedServiceHealthReport::setTimeToLiveInMilliSeconds(const QString &time_to_live_in_milli_seconds) {
    m_time_to_live_in_milli_seconds = time_to_live_in_milli_seconds;
    m_time_to_live_in_milli_seconds_isSet = true;
}

bool OAIDeployedServiceHealthReport::is_time_to_live_in_milli_seconds_Set() const{
    return m_time_to_live_in_milli_seconds_isSet;
}

bool OAIDeployedServiceHealthReport::is_time_to_live_in_milli_seconds_Valid() const{
    return m_time_to_live_in_milli_seconds_isValid;
}

bool OAIDeployedServiceHealthReport::isSet() const {
...
bool OAIDeployedServiceHealthReport::isValid() const {
