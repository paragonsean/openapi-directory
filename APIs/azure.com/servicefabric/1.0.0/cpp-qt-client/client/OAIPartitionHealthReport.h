...
/*
 * OAIPartitionHealthReport.h
 *
 * The report of the partition health
 */

#ifndef OAIPartitionHealthReport_H
#define OAIPartitionHealthReport_H
...
class OAIPartitionHealthReport : public OAIObject {
public:
    OAIPartitionHealthReport();
    OAIPartitionHealthReport(QString json);
    ~OAIPartitionHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionHealthReport)

#endif // OAIPartitionHealthReport_H
