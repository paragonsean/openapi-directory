...
/*
 * OAICreateServiceGroupDescription.h
 *
 * The description of the create service group
 */

#ifndef OAICreateServiceGroupDescription_H
#define OAICreateServiceGroupDescription_H
...
class OAICreateServiceGroupDescription : public OAIObject {
public:
    OAICreateServiceGroupDescription();
    OAICreateServiceGroupDescription(QString json);
    ~OAICreateServiceGroupDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceGroupDescription)

#endif // OAICreateServiceGroupDescription_H
