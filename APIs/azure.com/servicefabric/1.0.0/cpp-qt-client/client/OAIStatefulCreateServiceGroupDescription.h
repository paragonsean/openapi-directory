...
/*
 * OAIStatefulCreateServiceGroupDescription.h
 *
 * The description of the stateful create service group
 */

#ifndef OAIStatefulCreateServiceGroupDescription_H
#define OAIStatefulCreateServiceGroupDescription_H
...
class OAIStatefulCreateServiceGroupDescription : public OAIObject {
public:
    OAIStatefulCreateServiceGroupDescription();
    OAIStatefulCreateServiceGroupDescription(QString json);
    ~OAIStatefulCreateServiceGroupDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulCreateServiceGroupDescription)

#endif // OAIStatefulCreateServiceGroupDescription_H
