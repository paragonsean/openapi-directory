...
/*
 * OAIStatefulServiceGroupDescription.h
 *
 * The description of the stateful service group
 */

#ifndef OAIStatefulServiceGroupDescription_H
#define OAIStatefulServiceGroupDescription_H
...
class OAIStatefulServiceGroupDescription : public OAIObject {
public:
    OAIStatefulServiceGroupDescription();
    OAIStatefulServiceGroupDescription(QString json);
    ~OAIStatefulServiceGroupDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulServiceGroupDescription)

#endif // OAIStatefulServiceGroupDescription_H
