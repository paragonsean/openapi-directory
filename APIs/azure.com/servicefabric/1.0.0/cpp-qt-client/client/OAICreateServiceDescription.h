...
/*
 * OAICreateServiceDescription.h
 *
 * The description of the create service
 */

#ifndef OAICreateServiceDescription_H
#define OAICreateServiceDescription_H
...
class OAICreateServiceDescription : public OAIObject {
public:
    OAICreateServiceDescription();
    OAICreateServiceDescription(QString json);
    ~OAICreateServiceDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceDescription)

#endif // OAICreateServiceDescription_H
