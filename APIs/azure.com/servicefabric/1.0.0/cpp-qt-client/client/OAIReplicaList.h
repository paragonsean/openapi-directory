...
#ifndef OAIReplicaList_H
#define OAIReplicaList_H
...
class OAIReplicaList : public OAIObject {
public:
    OAIReplicaList();
    OAIReplicaList(QString json);
    ~OAIReplicaList() override;
    ...
    QList<OAIReplica> getItems() const;
    void setItems(const QList<OAIReplica> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicaList)

#endif // OAIReplicaList_H
