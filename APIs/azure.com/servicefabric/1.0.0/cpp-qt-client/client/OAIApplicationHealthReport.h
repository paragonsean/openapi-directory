...
/*
 * OAIApplicationHealthReport.h
 *
 * The report of the application health
 */

#ifndef OAIApplicationHealthReport_H
#define OAIApplicationHealthReport_H
...
class OAIApplicationHealthReport : public OAIObject {
public:
    OAIApplicationHealthReport();
    OAIApplicationHealthReport(QString json);
    ~OAIApplicationHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationHealthReport)

#endif // OAIApplicationHealthReport_H
