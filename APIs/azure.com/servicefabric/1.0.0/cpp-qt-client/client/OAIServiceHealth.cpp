...
QList<OAIServiceHealth_PartitionHealthStates_inner> OAIServiceHealth::getPartitionHealthStates() const {
    return m_partition_health_states;
}
void OAIServiceHealth::setPartitionHealthStates(const QList<OAIServiceHealth_PartitionHealthStates_inner> &partition_health_states) {
