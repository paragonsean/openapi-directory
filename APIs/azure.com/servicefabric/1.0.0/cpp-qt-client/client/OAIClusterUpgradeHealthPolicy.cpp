...
OAIClusterUpgradeHealthPolicy::OAIClusterUpgradeHealthPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClusterUpgradeHealthPolicy::OAIClusterUpgradeHealthPolicy() {
    this->initializeModel();
}

OAIClusterUpgradeHealthPolicy::~OAIClusterUpgradeHealthPolicy() {}

void OAIClusterUpgradeHealthPolicy::initializeModel() {
...
void OAIClusterUpgradeHealthPolicy::fromJson(QString jsonString) {
...
void OAIClusterUpgradeHealthPolicy::fromJsonObject(QJsonObject json) {
...
QString OAIClusterUpgradeHealthPolicy::asJson() const {
...
QJsonObject OAIClusterUpgradeHealthPolicy::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIClusterUpgradeHealthPolicy::getMaxPercentDeltaUnhealthyNodes() const {
    return m_max_percent_delta_unhealthy_nodes;
}
void OAIClusterUpgradeHealthPolicy::setMaxPercentDeltaUnhealthyNodes(const qint32 &max_percent_delta_unhealthy_nodes) {
    m_max_percent_delta_unhealthy_nodes = max_percent_delta_unhealthy_nodes;
    m_max_percent_delta_unhealthy_nodes_isSet = true;
}

bool OAIClusterUpgradeHealthPolicy::is_max_percent_delta_unhealthy_nodes_Set() const{
    return m_max_percent_delta_unhealthy_nodes_isSet;
}

bool OAIClusterUpgradeHealthPolicy::is_max_percent_delta_unhealthy_nodes_Valid() const{
    return m_max_percent_delta_unhealthy_nodes_isValid;
}

qint32 OAIClusterUpgradeHealthPolicy::getMaxPercentUpgradeDomainDeltaUnhealthyNodes() const {
    return m_max_percent_upgrade_domain_delta_unhealthy_nodes;
}
void OAIClusterUpgradeHealthPolicy::setMaxPercentUpgradeDomainDeltaUnhealthyNodes(const qint32 &max_percent_upgrade_domain_delta_unhealthy_nodes) {
...
bool OAIClusterUpgradeHealthPolicy::is_max_percent_upgrade_domain_delta_unhealthy_nodes_Set() const{
    return m_max_percent_upgrade_domain_delta_unhealthy_nodes_isSet;
}

bool OAIClusterUpgradeHealthPolicy::is_max_percent_upgrade_domain_delta_unhealthy_nodes_Valid() const{
    return m_max_percent_upgrade_domain_delta_unhealthy_nodes_isValid;
}

bool OAIClusterUpgradeHealthPolicy::isSet() const {
...
bool OAIClusterUpgradeHealthPolicy::isValid() const {
