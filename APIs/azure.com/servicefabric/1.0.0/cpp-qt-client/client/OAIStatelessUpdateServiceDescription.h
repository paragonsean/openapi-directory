...
/*
 * OAIStatelessUpdateServiceDescription.h
 *
 * The description of the stateless update service
 */

#ifndef OAIStatelessUpdateServiceDescription_H
#define OAIStatelessUpdateServiceDescription_H
...
class OAIStatelessUpdateServiceDescription : public OAIObject {
public:
    OAIStatelessUpdateServiceDescription();
    OAIStatelessUpdateServiceDescription(QString json);
    ~OAIStatelessUpdateServiceDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessUpdateServiceDescription)

#endif // OAIStatelessUpdateServiceDescription_H
