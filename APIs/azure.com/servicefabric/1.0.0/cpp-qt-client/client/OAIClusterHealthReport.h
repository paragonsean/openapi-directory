...
/*
 * OAIClusterHealthReport.h
 *
 * The report of the cluster health
 */

#ifndef OAIClusterHealthReport_H
#define OAIClusterHealthReport_H
...
class OAIClusterHealthReport : public OAIObject {
public:
    OAIClusterHealthReport();
    OAIClusterHealthReport(QString json);
    ~OAIClusterHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterHealthReport)

#endif // OAIClusterHealthReport_H
