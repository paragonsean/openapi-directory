...
OAIServiceCorrelationDescription OAIStatelessServiceDescription::getCorrelationScheme() const {
    return m_correlation_scheme;
}
void OAIStatelessServiceDescription::setCorrelationScheme(const OAIServiceCorrelationDescription &correlation_scheme) {
...
OAIPartitionDescription OAIStatelessServiceDescription::getPartitionDescription() const {
    return m_partition_description;
}
void OAIStatelessServiceDescription::setPartitionDescription(const OAIPartitionDescription &partition_description) {
...
OAIServiceCorrelationDescription OAIStatelessServiceDescription::getServiceLoadMetrics() const {
    return m_service_load_metrics;
}
void OAIStatelessServiceDescription::setServiceLoadMetrics(const OAIServiceCorrelationDescription &service_load_metrics) {
...
OAIServiceCorrelationDescription OAIStatelessServiceDescription::getServicePlacementPolicies() const {
    return m_service_placement_policies;
}
void OAIStatelessServiceDescription::setServicePlacementPolicies(const OAIServiceCorrelationDescription &service_placement_policies) {
