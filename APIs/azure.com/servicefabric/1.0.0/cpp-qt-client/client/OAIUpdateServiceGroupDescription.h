...
/*
 * OAIUpdateServiceGroupDescription.h
 *
 * The description of the update service group
 */

#ifndef OAIUpdateServiceGroupDescription_H
#define OAIUpdateServiceGroupDescription_H
...
class OAIUpdateServiceGroupDescription : public OAIObject {
public:
    OAIUpdateServiceGroupDescription();
    OAIUpdateServiceGroupDescription(QString json);
    ~OAIUpdateServiceGroupDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServiceGroupDescription)

#endif // OAIUpdateServiceGroupDescription_H
