...
/*
 * OAIStatefulUpdateServiceGroupDescription.h
 *
 * The description of the stateful update service group
 */

#ifndef OAIStatefulUpdateServiceGroupDescription_H
#define OAIStatefulUpdateServiceGroupDescription_H
...
class OAIStatefulUpdateServiceGroupDescription : public OAIObject {
public:
    OAIStatefulUpdateServiceGroupDescription();
    OAIStatefulUpdateServiceGroupDescription(QString json);
    ~OAIStatefulUpdateServiceGroupDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulUpdateServiceGroupDescription)

#endif // OAIStatefulUpdateServiceGroupDescription_H
