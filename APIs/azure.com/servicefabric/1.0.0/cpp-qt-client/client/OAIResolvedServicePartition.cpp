...
QList<OAIResolvedServicePartition_Endpoints_inner> OAIResolvedServicePartition::getEndpoints() const {
    return m_endpoints;
}
void OAIResolvedServicePartition::setEndpoints(const QList<OAIResolvedServicePartition_Endpoints_inner> &endpoints) {
