...
/*
 * OAINodeHealthReport.h
 *
 * The report of the node health
 */

#ifndef OAINodeHealthReport_H
#define OAINodeHealthReport_H
...
class OAINodeHealthReport : public OAIObject {
public:
    OAINodeHealthReport();
    OAINodeHealthReport(QString json);
    ~OAINodeHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeHealthReport)

#endif // OAINodeHealthReport_H
