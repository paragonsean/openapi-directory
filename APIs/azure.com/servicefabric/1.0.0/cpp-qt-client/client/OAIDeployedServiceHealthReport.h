...
/*
 * OAIDeployedServiceHealthReport.h
 *
 * The report of the deployed service package health
 */

#ifndef OAIDeployedServiceHealthReport_H
#define OAIDeployedServiceHealthReport_H
...
class OAIDeployedServiceHealthReport : public OAIObject {
public:
    OAIDeployedServiceHealthReport();
    OAIDeployedServiceHealthReport(QString json);
    ~OAIDeployedServiceHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedServiceHealthReport)

#endif // OAIDeployedServiceHealthReport_H
