...
/*
 * OAIStatelessCreateServiceGroupDescription.h
 *
 * The description of the stateless create service group
 */

#ifndef OAIStatelessCreateServiceGroupDescription_H
#define OAIStatelessCreateServiceGroupDescription_H
...
class OAIStatelessCreateServiceGroupDescription : public OAIObject {
public:
    OAIStatelessCreateServiceGroupDescription();
    OAIStatelessCreateServiceGroupDescription(QString json);
    ~OAIStatelessCreateServiceGroupDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessCreateServiceGroupDescription)

#endif // OAIStatelessCreateServiceGroupDescription_H
