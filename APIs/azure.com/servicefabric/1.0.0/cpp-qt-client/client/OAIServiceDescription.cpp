...
OAIServiceCorrelationDescription OAIServiceDescription::getCorrelationScheme() const {
    return m_correlation_scheme;
}
void OAIServiceDescription::setCorrelationScheme(const OAIServiceCorrelationDescription &correlation_scheme) {
...
qint32 OAIServiceDescription::getFlags() const {
    return m_flags;
}
void OAIServiceDescription::setFlags(const qint32 &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAIServiceDescription::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIServiceDescription::is_flags_Valid() const{
    return m_flags_isValid;
}

OAIPartitionDescription OAIServiceDescription::getPartitionDescription() const {
    return m_partition_description;
}
void OAIServiceDescription::setPartitionDescription(const OAIPartitionDescription &partition_description) {
...
OAIServiceCorrelationDescription OAIServiceDescription::getServiceLoadMetrics() const {
    return m_service_load_metrics;
}
void OAIServiceDescription::setServiceLoadMetrics(const OAIServiceCorrelationDescription &service_load_metrics) {
...
OAIServiceCorrelationDescription OAIServiceDescription::getServicePlacementPolicies() const {
    return m_service_placement_policies;
}
void OAIServiceDescription::setServicePlacementPolicies(const OAIServiceCorrelationDescription &service_placement_policies) {
