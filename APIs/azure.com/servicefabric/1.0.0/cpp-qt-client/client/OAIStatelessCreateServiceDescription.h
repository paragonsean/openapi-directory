...
/*
 * OAIStatelessCreateServiceDescription.h
 *
 * The description of the stateless create service
 */

#ifndef OAIStatelessCreateServiceDescription_H
#define OAIStatelessCreateServiceDescription_H
...
class OAIStatelessCreateServiceDescription : public OAIObject {
public:
    OAIStatelessCreateServiceDescription();
    OAIStatelessCreateServiceDescription(QString json);
    ~OAIStatelessCreateServiceDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessCreateServiceDescription)

#endif // OAIStatelessCreateServiceDescription_H
