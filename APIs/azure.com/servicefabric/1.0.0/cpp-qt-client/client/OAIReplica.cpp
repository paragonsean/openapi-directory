...
QString OAIReplica::getAddress() const {
    return m_address;
}
void OAIReplica::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIReplica::is_address_Set() const{
    return m_address_isSet;
}

bool OAIReplica::is_address_Valid() const{
    return m_address_isValid;
}

OAIHealthState OAIReplica::getHealthState() const {
    return m_health_state;
}
void OAIReplica::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIReplica::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIReplica::is_health_state_Valid() const{
    return m_health_state_isValid;
}

QString OAIReplica::getInstanceId() const {
    return m_instance_id;
}
void OAIReplica::setInstanceId(const QString &instance_id) {
    m_instance_id = instance_id;
    m_instance_id_isSet = true;
}

bool OAIReplica::is_instance_id_Set() const{
    return m_instance_id_isSet;
}

bool OAIReplica::is_instance_id_Valid() const{
    return m_instance_id_isValid;
}

QString OAIReplica::getLastInBuildDurationInSeconds() const {
    return m_last_in_build_duration_in_seconds;
}
void OAIReplica::setLastInBuildDurationInSeconds(const QString &last_in_build_duration_in_seconds) {
    m_last_in_build_duration_in_seconds = last_in_build_duration_in_seconds;
    m_last_in_build_duration_in_seconds_isSet = true;
}

bool OAIReplica::is_last_in_build_duration_in_seconds_Set() const{
    return m_last_in_build_duration_in_seconds_isSet;
}

bool OAIReplica::is_last_in_build_duration_in_seconds_Valid() const{
    return m_last_in_build_duration_in_seconds_isValid;
}

QString OAIReplica::getNodeName() const {
    return m_node_name;
}
void OAIReplica::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAIReplica::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAIReplica::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAIReplica::getReplicaId() const {
    return m_replica_id;
}
void OAIReplica::setReplicaId(const QString &replica_id) {
    m_replica_id = replica_id;
    m_replica_id_isSet = true;
}

bool OAIReplica::is_replica_id_Set() const{
    return m_replica_id_isSet;
}

bool OAIReplica::is_replica_id_Valid() const{
    return m_replica_id_isValid;
}

OAIReplicaRole OAIReplica::getReplicaRole() const {
    return m_replica_role;
}
void OAIReplica::setReplicaRole(const OAIReplicaRole &replica_role) {
    m_replica_role = replica_role;
    m_replica_role_isSet = true;
}

bool OAIReplica::is_replica_role_Set() const{
    return m_replica_role_isSet;
}

bool OAIReplica::is_replica_role_Valid() const{
    return m_replica_role_isValid;
}

OAIReplicaStatus OAIReplica::getReplicaStatus() const {
    return m_replica_status;
}
void OAIReplica::setReplicaStatus(const OAIReplicaStatus &replica_status) {
    m_replica_status = replica_status;
    m_replica_status_isSet = true;
}

bool OAIReplica::is_replica_status_Set() const{
    return m_replica_status_isSet;
}

bool OAIReplica::is_replica_status_Valid() const{
    return m_replica_status_isValid;
}

OAIServiceKind OAIReplica::getServiceKind() const {
    return m_service_kind;
}
void OAIReplica::setServiceKind(const OAIServiceKind &service_kind) {
    m_service_kind = service_kind;
    m_service_kind_isSet = true;
}

bool OAIReplica::is_service_kind_Set() const{
    return m_service_kind_isSet;
}

bool OAIReplica::is_service_kind_Valid() const{
