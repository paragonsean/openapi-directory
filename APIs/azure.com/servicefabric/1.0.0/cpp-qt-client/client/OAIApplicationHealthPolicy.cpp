...
OAIApplicationHealthPolicy_DefaultServiceTypeHealthPolicy OAIApplicationHealthPolicy::getDefaultServiceTypeHealthPolicy() const {
    return m_default_service_type_health_policy;
}
void OAIApplicationHealthPolicy::setDefaultServiceTypeHealthPolicy(const OAIApplicationHealthPolicy_DefaultServiceTypeHealthPolicy &default_service_type_health_policy) {
