...
public:
    ...
    QString getLastErrorTransitionAt() const;
    void setLastErrorTransitionAt(const QString &last_error_transition_at);
    bool is_last_error_transition_at_Set() const;
    bool is_last_error_transition_at_Valid() const;

    QString getLastModifiedUtcTimestamp() const;
    void setLastModifiedUtcTimestamp(const QString &last_modified_utc_timestamp);
    bool is_last_modified_utc_timestamp_Set() const;
    bool is_last_modified_utc_timestamp_Valid() const;

    QString getLastOkTransitionAt() const;
    void setLastOkTransitionAt(const QString &last_ok_transition_at);
    bool is_last_ok_transition_at_Set() const;
    bool is_last_ok_transition_at_Valid() const;

    QString getLastWarningTransitionAt() const;
    void setLastWarningTransitionAt(const QString &last_warning_transition_at);
    ...
    QString getSourceUtcTimestamp() const;
    void setSourceUtcTimestamp(const QString &source_utc_timestamp);
...
private:
    ...
    QString m_source_utc_timestamp;
