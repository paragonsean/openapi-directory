...
/*
 * OAIStatelessServiceGroupDescription.h
 *
 * The description of the stateless service group
 */

#ifndef OAIStatelessServiceGroupDescription_H
#define OAIStatelessServiceGroupDescription_H
...
class OAIStatelessServiceGroupDescription : public OAIObject {
public:
    OAIStatelessServiceGroupDescription();
    OAIStatelessServiceGroupDescription(QString json);
    ~OAIStatelessServiceGroupDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessServiceGroupDescription)

#endif // OAIStatelessServiceGroupDescription_H
