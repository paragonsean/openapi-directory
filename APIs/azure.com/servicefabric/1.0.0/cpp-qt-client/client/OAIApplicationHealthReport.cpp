...
OAIApplicationHealthReport::OAIApplicationHealthReport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplicationHealthReport::OAIApplicationHealthReport() {
    this->initializeModel();
}

OAIApplicationHealthReport::~OAIApplicationHealthReport() {}

void OAIApplicationHealthReport::initializeModel() {
...
void OAIApplicationHealthReport::fromJson(QString jsonString) {
...
void OAIApplicationHealthReport::fromJsonObject(QJsonObject json) {
...
QString OAIApplicationHealthReport::asJson() const {
...
QJsonObject OAIApplicationHealthReport::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApplicationHealthReport::getDescription() const {
    return m_description;
}
void OAIApplicationHealthReport::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIApplicationHealthReport::is_description_Set() const{
    return m_description_isSet;
}

bool OAIApplicationHealthReport::is_description_Valid() const{
    return m_description_isValid;
}

OAIHealthState OAIApplicationHealthReport::getHealthState() const {
    return m_health_state;
}
void OAIApplicationHealthReport::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIApplicationHealthReport::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIApplicationHealthReport::is_health_state_Valid() const{
    return m_health_state_isValid;
}

QString OAIApplicationHealthReport::getProperty() const {
    return m_property;
}
void OAIApplicationHealthReport::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIApplicationHealthReport::is_property_Set() const{
    return m_property_isSet;
}

bool OAIApplicationHealthReport::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIApplicationHealthReport::isRemoveWhenExpired() const {
    return m_remove_when_expired;
}
void OAIApplicationHealthReport::setRemoveWhenExpired(const bool &remove_when_expired) {
    m_remove_when_expired = remove_when_expired;
    m_remove_when_expired_isSet = true;
}

bool OAIApplicationHealthReport::is_remove_when_expired_Set() const{
    return m_remove_when_expired_isSet;
}

bool OAIApplicationHealthReport::is_remove_when_expired_Valid() const{
    return m_remove_when_expired_isValid;
}

QString OAIApplicationHealthReport::getSequenceNumber() const {
    return m_sequence_number;
}
void OAIApplicationHealthReport::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAIApplicationHealthReport::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAIApplicationHealthReport::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAIApplicationHealthReport::getSourceId() const {
    return m_source_id;
}
void OAIApplicationHealthReport::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAIApplicationHealthReport::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAIApplicationHealthReport::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QString OAIApplicationHealthReport::getTimeToLiveInMilliSeconds() const {
    return m_time_to_live_in_milli_seconds;
}
void OAIApplicationHealthReport::setTimeToLiveInMilliSeconds(const QString &time_to_live_in_milli_seconds) {
    m_time_to_live_in_milli_seconds = time_to_live_in_milli_seconds;
    m_time_to_live_in_milli_seconds_isSet = true;
}

bool OAIApplicationHealthReport::is_time_to_live_in_milli_seconds_Set() const{
    return m_time_to_live_in_milli_seconds_isSet;
}

bool OAIApplicationHealthReport::is_time_to_live_in_milli_seconds_Valid() const{
    return m_time_to_live_in_milli_seconds_isValid;
}

bool OAIApplicationHealthReport::isSet() const {
...
bool OAIApplicationHealthReport::isValid() const {
