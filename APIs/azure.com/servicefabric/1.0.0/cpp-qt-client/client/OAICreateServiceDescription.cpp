...
OAICreateServiceDescription::OAICreateServiceDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateServiceDescription::OAICreateServiceDescription() {
    this->initializeModel();
}

OAICreateServiceDescription::~OAICreateServiceDescription() {}

void OAICreateServiceDescription::initializeModel() {
...
void OAICreateServiceDescription::fromJson(QString jsonString) {
...
void OAICreateServiceDescription::fromJsonObject(QJsonObject json) {
...
QString OAICreateServiceDescription::asJson() const {
...
QJsonObject OAICreateServiceDescription::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateServiceDescription::getApplicationName() const {
    return m_application_name;
}
void OAICreateServiceDescription::setApplicationName(const QString &application_name) {
    m_application_name = application_name;
    m_application_name_isSet = true;
}

bool OAICreateServiceDescription::is_application_name_Set() const{
    return m_application_name_isSet;
}

bool OAICreateServiceDescription::is_application_name_Valid() const{
    return m_application_name_isValid;
}

OAIServiceCorrelationDescription OAICreateServiceDescription::getCorrelationScheme() const {
    return m_correlation_scheme;
}
void OAICreateServiceDescription::setCorrelationScheme(const OAIServiceCorrelationDescription &correlation_scheme) {
    m_correlation_scheme = correlation_scheme;
    m_correlation_scheme_isSet = true;
}

bool OAICreateServiceDescription::is_correlation_scheme_Set() const{
    return m_correlation_scheme_isSet;
}

bool OAICreateServiceDescription::is_correlation_scheme_Valid() const{
    return m_correlation_scheme_isValid;
}

qint32 OAICreateServiceDescription::getFlags() const {
    return m_flags;
}
void OAICreateServiceDescription::setFlags(const qint32 &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAICreateServiceDescription::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAICreateServiceDescription::is_flags_Valid() const{
    return m_flags_isValid;
}

OAIPartitionDescription OAICreateServiceDescription::getPartitionDescription() const {
    return m_partition_description;
}
void OAICreateServiceDescription::setPartitionDescription(const OAIPartitionDescription &partition_description) {
    m_partition_description = partition_description;
    m_partition_description_isSet = true;
}

bool OAICreateServiceDescription::is_partition_description_Set() const{
    return m_partition_description_isSet;
}

bool OAICreateServiceDescription::is_partition_description_Valid() const{
    return m_partition_description_isValid;
}

QString OAICreateServiceDescription::getPlacementConstraints() const {
    return m_placement_constraints;
}
void OAICreateServiceDescription::setPlacementConstraints(const QString &placement_constraints) {
    m_placement_constraints = placement_constraints;
    m_placement_constraints_isSet = true;
}

bool OAICreateServiceDescription::is_placement_constraints_Set() const{
    return m_placement_constraints_isSet;
}

bool OAICreateServiceDescription::is_placement_constraints_Valid() const{
    return m_placement_constraints_isValid;
}

OAIServiceKind OAICreateServiceDescription::getServiceKind() const {
    return m_service_kind;
}
void OAICreateServiceDescription::setServiceKind(const OAIServiceKind &service_kind) {
    m_service_kind = service_kind;
    m_service_kind_isSet = true;
}

bool OAICreateServiceDescription::is_service_kind_Set() const{
    return m_service_kind_isSet;
}

bool OAICreateServiceDescription::is_service_kind_Valid() const{
    return m_service_kind_isValid;
}

OAIServiceCorrelationDescription OAICreateServiceDescription::getServiceLoadMetrics() const {
    return m_service_load_metrics;
}
void OAICreateServiceDescription::setServiceLoadMetrics(const OAIServiceCorrelationDescription &service_load_metrics) {
    m_service_load_metrics = service_load_metrics;
    m_service_load_metrics_isSet = true;
}

bool OAICreateServiceDescription::is_service_load_metrics_Set() const{
    return m_service_load_metrics_isSet;
}

bool OAICreateServiceDescription::is_service_load_metrics_Valid() const{
    return m_service_load_metrics_isValid;
}

QString OAICreateServiceDescription::getServiceName() const {
    return m_service_name;
}
void OAICreateServiceDescription::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAICreateServiceDescription::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAICreateServiceDescription::is_service_name_Valid() const{
    return m_service_name_isValid;
}

OAIServiceCorrelationDescription OAICreateServiceDescription::getServicePlacementPolicies() const {
    return m_service_placement_policies;
}
void OAICreateServiceDescription::setServicePlacementPolicies(const OAIServiceCorrelationDescription &service_placement_policies) {
    m_service_placement_policies = service_placement_policies;
    m_service_placement_policies_isSet = true;
}

bool OAICreateServiceDescription::is_service_placement_policies_Set() const{
    return m_service_placement_policies_isSet;
}

bool OAICreateServiceDescription::is_service_placement_policies_Valid() const{
    return m_service_placement_policies_isValid;
}

QString OAICreateServiceDescription::getServiceTypeName() const {
    return m_service_type_name;
}
void OAICreateServiceDescription::setServiceTypeName(const QString &service_type_name) {
    m_service_type_name = service_type_name;
    m_service_type_name_isSet = true;
}

bool OAICreateServiceDescription::is_service_type_name_Set() const{
    return m_service_type_name_isSet;
}

bool OAICreateServiceDescription::is_service_type_name_Valid() const{
    return m_service_type_name_isValid;
}

bool OAICreateServiceDescription::isSet() const {
...
bool OAICreateServiceDescription::isValid() const {
