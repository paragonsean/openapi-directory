...
/*
 * OAIServicesHealthEvaluation.h
 *
 * The evaluation of the services health
 */

#ifndef OAIServicesHealthEvaluation_H
#define OAIServicesHealthEvaluation_H
...
class OAIServicesHealthEvaluation : public OAIObject {
public:
    OAIServicesHealthEvaluation();
    OAIServicesHealthEvaluation(QString json);
    ~OAIServicesHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServicesHealthEvaluation)

#endif // OAIServicesHealthEvaluation_H
