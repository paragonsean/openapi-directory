...
/*
 * OAIStartApplicationUpgrade.h
 *
 * The description of the start application upgrade
 */

#ifndef OAIStartApplicationUpgrade_H
#define OAIStartApplicationUpgrade_H
...
class OAIMonitoringPolicy;
class OAIApplication_Parameters_inner;

class OAIStartApplicationUpgrade : public OAIObject {
public:
    OAIStartApplicationUpgrade();
    OAIStartApplicationUpgrade(QString json);
    ~OAIStartApplicationUpgrade() override;
    ...
    OAIMonitoringPolicy getMonitoringPolicy() const;
    void setMonitoringPolicy(const OAIMonitoringPolicy &monitoring_policy);
    ...
    QList<OAIApplication_Parameters_inner> getParameters() const;
    void setParameters(const QList<OAIApplication_Parameters_inner> &parameters);
...
private:
    ...
    OAIMonitoringPolicy m_monitoring_policy;
    ...
    QList<OAIApplication_Parameters_inner> m_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartApplicationUpgrade)

#endif // OAIStartApplicationUpgrade_H
