...
/*
 * OAIUpgradeDomainDeployedApplicationsHealthEvaluation.h
 *
 * The evaluation of the upgrade domain deployed applications health
 */

#ifndef OAIUpgradeDomainDeployedApplicationsHealthEvaluation_H
#define OAIUpgradeDomainDeployedApplicationsHealthEvaluation_H
...
class OAIUpgradeDomainDeployedApplicationsHealthEvaluation : public OAIObject {
public:
    OAIUpgradeDomainDeployedApplicationsHealthEvaluation();
    OAIUpgradeDomainDeployedApplicationsHealthEvaluation(QString json);
    ~OAIUpgradeDomainDeployedApplicationsHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpgradeDomainDeployedApplicationsHealthEvaluation)

#endif // OAIUpgradeDomainDeployedApplicationsHealthEvaluation_H
