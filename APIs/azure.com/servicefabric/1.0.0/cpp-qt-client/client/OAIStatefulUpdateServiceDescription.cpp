...
#include "OAIStatefulUpdateServiceDescription.h"
...
OAIStatefulUpdateServiceDescription::OAIStatefulUpdateServiceDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulUpdateServiceDescription::OAIStatefulUpdateServiceDescription() {
    this->initializeModel();
}

OAIStatefulUpdateServiceDescription::~OAIStatefulUpdateServiceDescription() {}

void OAIStatefulUpdateServiceDescription::initializeModel() {
...
void OAIStatefulUpdateServiceDescription::fromJson(QString jsonString) {
...
void OAIStatefulUpdateServiceDescription::fromJsonObject(QJsonObject json) {
...
QString OAIStatefulUpdateServiceDescription::asJson() const {
...
QJsonObject OAIStatefulUpdateServiceDescription::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIStatefulUpdateServiceDescription::getMinReplicaSetSize() const {
    return m_min_replica_set_size;
}
void OAIStatefulUpdateServiceDescription::setMinReplicaSetSize(const qint32 &min_replica_set_size) {
    m_min_replica_set_size = min_replica_set_size;
    m_min_replica_set_size_isSet = true;
}

bool OAIStatefulUpdateServiceDescription::is_min_replica_set_size_Set() const{
    return m_min_replica_set_size_isSet;
}

bool OAIStatefulUpdateServiceDescription::is_min_replica_set_size_Valid() const{
    return m_min_replica_set_size_isValid;
}

qint32 OAIStatefulUpdateServiceDescription::getQuorumLossWaitDurationInMilliseconds() const {
    return m_quorum_loss_wait_duration_in_milliseconds;
}
void OAIStatefulUpdateServiceDescription::setQuorumLossWaitDurationInMilliseconds(const qint32 &quorum_loss_wait_duration_in_milliseconds) {
...
bool OAIStatefulUpdateServiceDescription::is_quorum_loss_wait_duration_in_milliseconds_Set() const{
    return m_quorum_loss_wait_duration_in_milliseconds_isSet;
}

bool OAIStatefulUpdateServiceDescription::is_quorum_loss_wait_duration_in_milliseconds_Valid() const{
    return m_quorum_loss_wait_duration_in_milliseconds_isValid;
}

qint32 OAIStatefulUpdateServiceDescription::getReplicaRestartWaitDurationInMilliseconds() const {
    return m_replica_restart_wait_duration_in_milliseconds;
}
void OAIStatefulUpdateServiceDescription::setReplicaRestartWaitDurationInMilliseconds(const qint32 &replica_restart_wait_duration_in_milliseconds) {
...
bool OAIStatefulUpdateServiceDescription::is_replica_restart_wait_duration_in_milliseconds_Set() const{
    return m_replica_restart_wait_duration_in_milliseconds_isSet;
}

bool OAIStatefulUpdateServiceDescription::is_replica_restart_wait_duration_in_milliseconds_Valid() const{
    return m_replica_restart_wait_duration_in_milliseconds_isValid;
}

qint32 OAIStatefulUpdateServiceDescription::getStandByReplicaKeepDurationInMilliseconds() const {
    return m_stand_by_replica_keep_duration_in_milliseconds;
}
void OAIStatefulUpdateServiceDescription::setStandByReplicaKeepDurationInMilliseconds(const qint32 &stand_by_replica_keep_duration_in_milliseconds) {
...
bool OAIStatefulUpdateServiceDescription::is_stand_by_replica_keep_duration_in_milliseconds_Set() const{
    return m_stand_by_replica_keep_duration_in_milliseconds_isSet;
}

bool OAIStatefulUpdateServiceDescription::is_stand_by_replica_keep_duration_in_milliseconds_Valid() const{
    return m_stand_by_replica_keep_duration_in_milliseconds_isValid;
}

qint32 OAIStatefulUpdateServiceDescription::getTargetReplicaSetSize() const {
    return m_target_replica_set_size;
}
void OAIStatefulUpdateServiceDescription::setTargetReplicaSetSize(const qint32 &target_replica_set_size) {
    m_target_replica_set_size = target_replica_set_size;
    m_target_replica_set_size_isSet = true;
}

bool OAIStatefulUpdateServiceDescription::is_target_replica_set_size_Set() const{
    return m_target_replica_set_size_isSet;
}

bool OAIStatefulUpdateServiceDescription::is_target_replica_set_size_Valid() const{
    return m_target_replica_set_size_isValid;
}

qint32 OAIStatefulUpdateServiceDescription::getFlags() const {
    return m_flags;
}
void OAIStatefulUpdateServiceDescription::setFlags(const qint32 &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAIStatefulUpdateServiceDescription::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIStatefulUpdateServiceDescription::is_flags_Valid() const{
    return m_flags_isValid;
}

OAIServiceKind OAIStatefulUpdateServiceDescription::getServiceKind() const {
    return m_service_kind;
}
void OAIStatefulUpdateServiceDescription::setServiceKind(const OAIServiceKind &service_kind) {
    m_service_kind = service_kind;
    m_service_kind_isSet = true;
}

bool OAIStatefulUpdateServiceDescription::is_service_kind_Set() const{
    return m_service_kind_isSet;
}

bool OAIStatefulUpdateServiceDescription::is_service_kind_Valid() const{
    return m_service_kind_isValid;
}

bool OAIStatefulUpdateServiceDescription::isSet() const {
...
bool OAIStatefulUpdateServiceDescription::isValid() const {
