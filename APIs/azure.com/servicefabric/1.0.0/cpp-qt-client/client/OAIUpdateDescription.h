...
/*
 * OAIUpdateDescription.h
 *
 * The description of the update
 */

#ifndef OAIUpdateDescription_H
#define OAIUpdateDescription_H
...
class OAIUpdateDescription : public OAIObject {
public:
    OAIUpdateDescription();
    OAIUpdateDescription(QString json);
    ~OAIUpdateDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDescription)

#endif // OAIUpdateDescription_H
