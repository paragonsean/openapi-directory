...
OAIServiceHealthReport::OAIServiceHealthReport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceHealthReport::OAIServiceHealthReport() {
    this->initializeModel();
}

OAIServiceHealthReport::~OAIServiceHealthReport() {}

void OAIServiceHealthReport::initializeModel() {
...
void OAIServiceHealthReport::fromJson(QString jsonString) {
...
void OAIServiceHealthReport::fromJsonObject(QJsonObject json) {
...
QString OAIServiceHealthReport::asJson() const {
...
QJsonObject OAIServiceHealthReport::asJsonObject() const {
    QJsonObject obj;
...
QString OAIServiceHealthReport::getDescription() const {
    return m_description;
}
void OAIServiceHealthReport::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIServiceHealthReport::is_description_Set() const{
    return m_description_isSet;
}

bool OAIServiceHealthReport::is_description_Valid() const{
    return m_description_isValid;
}

OAIHealthState OAIServiceHealthReport::getHealthState() const {
    return m_health_state;
}
void OAIServiceHealthReport::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIServiceHealthReport::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIServiceHealthReport::is_health_state_Valid() const{
    return m_health_state_isValid;
}

QString OAIServiceHealthReport::getProperty() const {
    return m_property;
}
void OAIServiceHealthReport::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIServiceHealthReport::is_property_Set() const{
    return m_property_isSet;
}

bool OAIServiceHealthReport::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIServiceHealthReport::isRemoveWhenExpired() const {
    return m_remove_when_expired;
}
void OAIServiceHealthReport::setRemoveWhenExpired(const bool &remove_when_expired) {
    m_remove_when_expired = remove_when_expired;
    m_remove_when_expired_isSet = true;
}

bool OAIServiceHealthReport::is_remove_when_expired_Set() const{
    return m_remove_when_expired_isSet;
}

bool OAIServiceHealthReport::is_remove_when_expired_Valid() const{
    return m_remove_when_expired_isValid;
}

QString OAIServiceHealthReport::getSequenceNumber() const {
    return m_sequence_number;
}
void OAIServiceHealthReport::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAIServiceHealthReport::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAIServiceHealthReport::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAIServiceHealthReport::getSourceId() const {
    return m_source_id;
}
void OAIServiceHealthReport::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAIServiceHealthReport::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAIServiceHealthReport::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QString OAIServiceHealthReport::getTimeToLiveInMilliSeconds() const {
    return m_time_to_live_in_milli_seconds;
}
void OAIServiceHealthReport::setTimeToLiveInMilliSeconds(const QString &time_to_live_in_milli_seconds) {
    m_time_to_live_in_milli_seconds = time_to_live_in_milli_seconds;
    m_time_to_live_in_milli_seconds_isSet = true;
}

bool OAIServiceHealthReport::is_time_to_live_in_milli_seconds_Set() const{
    return m_time_to_live_in_milli_seconds_isSet;
}

bool OAIServiceHealthReport::is_time_to_live_in_milli_seconds_Valid() const{
    return m_time_to_live_in_milli_seconds_isValid;
}

bool OAIServiceHealthReport::isSet() const {
...
bool OAIServiceHealthReport::isValid() const {
