...
/*
 * OAIDeployedApplicationHealthReport.h
 *
 * The report of the deployed application health
 */

#ifndef OAIDeployedApplicationHealthReport_H
#define OAIDeployedApplicationHealthReport_H
...
class OAIDeployedApplicationHealthReport : public OAIObject {
public:
    OAIDeployedApplicationHealthReport();
    OAIDeployedApplicationHealthReport(QString json);
    ~OAIDeployedApplicationHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedApplicationHealthReport)

#endif // OAIDeployedApplicationHealthReport_H
