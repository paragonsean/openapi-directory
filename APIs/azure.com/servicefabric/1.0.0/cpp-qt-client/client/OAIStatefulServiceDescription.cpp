...
OAIDefaultMoveCost OAIStatefulServiceDescription::getDefaultMoveCost() const {
    return m_default_move_cost;
}
void OAIStatefulServiceDescription::setDefaultMoveCost(const OAIDefaultMoveCost &default_move_cost) {
...
qint32 OAIStatefulServiceDescription::getQuorumLossWaitDurationSeconds() const {
    return m_quorum_loss_wait_duration_seconds;
}
void OAIStatefulServiceDescription::setQuorumLossWaitDurationSeconds(const qint32 &quorum_loss_wait_duration_seconds) {
...
qint32 OAIStatefulServiceDescription::getReplicaRestartWaitDurationSeconds() const {
    return m_replica_restart_wait_duration_seconds;
}
void OAIStatefulServiceDescription::setReplicaRestartWaitDurationSeconds(const qint32 &replica_restart_wait_duration_seconds) {
...
qint32 OAIStatefulServiceDescription::getStandByReplicaKeepDurationSeconds() const {
    return m_stand_by_replica_keep_duration_seconds;
}
void OAIStatefulServiceDescription::setStandByReplicaKeepDurationSeconds(const qint32 &stand_by_replica_keep_duration_seconds) {
...
OAIServiceCorrelationDescription OAIStatefulServiceDescription::getCorrelationScheme() const {
    return m_correlation_scheme;
}
void OAIStatefulServiceDescription::setCorrelationScheme(const OAIServiceCorrelationDescription &correlation_scheme) {
...
OAIPartitionDescription OAIStatefulServiceDescription::getPartitionDescription() const {
    return m_partition_description;
}
void OAIStatefulServiceDescription::setPartitionDescription(const OAIPartitionDescription &partition_description) {
...
OAIServiceCorrelationDescription OAIStatefulServiceDescription::getServiceLoadMetrics() const {
    return m_service_load_metrics;
}
void OAIStatefulServiceDescription::setServiceLoadMetrics(const OAIServiceCorrelationDescription &service_load_metrics) {
...
OAIServiceCorrelationDescription OAIStatefulServiceDescription::getServicePlacementPolicies() const {
    return m_service_placement_policies;
}
void OAIStatefulServiceDescription::setServicePlacementPolicies(const OAIServiceCorrelationDescription &service_placement_policies) {
