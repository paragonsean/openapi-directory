...
qint32 OAIPartitionsHealthEvaluation::getTotalCount() const {
    return m_total_count;
}
void OAIPartitionsHealthEvaluation::setTotalCount(const qint32 &total_count) {
...
QList<OAIUnhealthyEvaluation> OAIPartitionsHealthEvaluation::getUnhealthyEvaluations() const {
    return m_unhealthy_evaluations;
}
void OAIPartitionsHealthEvaluation::setUnhealthyEvaluations(const QList<OAIUnhealthyEvaluation> &unhealthy_evaluations) {
...
QString OAIPartitionsHealthEvaluation::getKind() const {
    return m_kind;
}
void OAIPartitionsHealthEvaluation::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}
