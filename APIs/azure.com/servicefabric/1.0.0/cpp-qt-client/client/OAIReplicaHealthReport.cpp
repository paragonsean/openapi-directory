...
OAIReplicaHealthReport::OAIReplicaHealthReport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReplicaHealthReport::OAIReplicaHealthReport() {
    this->initializeModel();
}

OAIReplicaHealthReport::~OAIReplicaHealthReport() {}

void OAIReplicaHealthReport::initializeModel() {
...
void OAIReplicaHealthReport::fromJson(QString jsonString) {
...
void OAIReplicaHealthReport::fromJsonObject(QJsonObject json) {
...
QString OAIReplicaHealthReport::asJson() const {
...
QJsonObject OAIReplicaHealthReport::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReplicaHealthReport::getDescription() const {
    return m_description;
}
void OAIReplicaHealthReport::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIReplicaHealthReport::is_description_Set() const{
    return m_description_isSet;
}

bool OAIReplicaHealthReport::is_description_Valid() const{
    return m_description_isValid;
}

OAIHealthState OAIReplicaHealthReport::getHealthState() const {
    return m_health_state;
}
void OAIReplicaHealthReport::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIReplicaHealthReport::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIReplicaHealthReport::is_health_state_Valid() const{
    return m_health_state_isValid;
}

QString OAIReplicaHealthReport::getProperty() const {
    return m_property;
}
void OAIReplicaHealthReport::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIReplicaHealthReport::is_property_Set() const{
    return m_property_isSet;
}

bool OAIReplicaHealthReport::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIReplicaHealthReport::isRemoveWhenExpired() const {
    return m_remove_when_expired;
}
void OAIReplicaHealthReport::setRemoveWhenExpired(const bool &remove_when_expired) {
    m_remove_when_expired = remove_when_expired;
    m_remove_when_expired_isSet = true;
}

bool OAIReplicaHealthReport::is_remove_when_expired_Set() const{
    return m_remove_when_expired_isSet;
}

bool OAIReplicaHealthReport::is_remove_when_expired_Valid() const{
    return m_remove_when_expired_isValid;
}

QString OAIReplicaHealthReport::getSequenceNumber() const {
    return m_sequence_number;
}
void OAIReplicaHealthReport::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAIReplicaHealthReport::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAIReplicaHealthReport::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAIReplicaHealthReport::getSourceId() const {
    return m_source_id;
}
void OAIReplicaHealthReport::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAIReplicaHealthReport::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAIReplicaHealthReport::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QString OAIReplicaHealthReport::getTimeToLiveInMilliSeconds() const {
    return m_time_to_live_in_milli_seconds;
}
void OAIReplicaHealthReport::setTimeToLiveInMilliSeconds(const QString &time_to_live_in_milli_seconds) {
    m_time_to_live_in_milli_seconds = time_to_live_in_milli_seconds;
    m_time_to_live_in_milli_seconds_isSet = true;
}

bool OAIReplicaHealthReport::is_time_to_live_in_milli_seconds_Set() const{
    return m_time_to_live_in_milli_seconds_isSet;
}

bool OAIReplicaHealthReport::is_time_to_live_in_milli_seconds_Valid() const{
    return m_time_to_live_in_milli_seconds_isValid;
}

bool OAIReplicaHealthReport::isSet() const {
...
bool OAIReplicaHealthReport::isValid() const {
