...
OAIPartitionHealthReport::OAIPartitionHealthReport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPartitionHealthReport::OAIPartitionHealthReport() {
    this->initializeModel();
}

OAIPartitionHealthReport::~OAIPartitionHealthReport() {}

void OAIPartitionHealthReport::initializeModel() {
...
void OAIPartitionHealthReport::fromJson(QString jsonString) {
...
void OAIPartitionHealthReport::fromJsonObject(QJsonObject json) {
...
QString OAIPartitionHealthReport::asJson() const {
...
QJsonObject OAIPartitionHealthReport::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPartitionHealthReport::getDescription() const {
    return m_description;
}
void OAIPartitionHealthReport::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPartitionHealthReport::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPartitionHealthReport::is_description_Valid() const{
    return m_description_isValid;
}

OAIHealthState OAIPartitionHealthReport::getHealthState() const {
    return m_health_state;
}
void OAIPartitionHealthReport::setHealthState(const OAIHealthState &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAIPartitionHealthReport::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAIPartitionHealthReport::is_health_state_Valid() const{
    return m_health_state_isValid;
}

QString OAIPartitionHealthReport::getProperty() const {
    return m_property;
}
void OAIPartitionHealthReport::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIPartitionHealthReport::is_property_Set() const{
    return m_property_isSet;
}

bool OAIPartitionHealthReport::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIPartitionHealthReport::isRemoveWhenExpired() const {
    return m_remove_when_expired;
}
void OAIPartitionHealthReport::setRemoveWhenExpired(const bool &remove_when_expired) {
    m_remove_when_expired = remove_when_expired;
    m_remove_when_expired_isSet = true;
}

bool OAIPartitionHealthReport::is_remove_when_expired_Set() const{
    return m_remove_when_expired_isSet;
}

bool OAIPartitionHealthReport::is_remove_when_expired_Valid() const{
    return m_remove_when_expired_isValid;
}

QString OAIPartitionHealthReport::getSequenceNumber() const {
    return m_sequence_number;
}
void OAIPartitionHealthReport::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAIPartitionHealthReport::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAIPartitionHealthReport::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAIPartitionHealthReport::getSourceId() const {
    return m_source_id;
}
void OAIPartitionHealthReport::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAIPartitionHealthReport::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAIPartitionHealthReport::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QString OAIPartitionHealthReport::getTimeToLiveInMilliSeconds() const {
    return m_time_to_live_in_milli_seconds;
}
void OAIPartitionHealthReport::setTimeToLiveInMilliSeconds(const QString &time_to_live_in_milli_seconds) {
    m_time_to_live_in_milli_seconds = time_to_live_in_milli_seconds;
    m_time_to_live_in_milli_seconds_isSet = true;
}

bool OAIPartitionHealthReport::is_time_to_live_in_milli_seconds_Set() const{
    return m_time_to_live_in_milli_seconds_isSet;
}

bool OAIPartitionHealthReport::is_time_to_live_in_milli_seconds_Valid() const{
    return m_time_to_live_in_milli_seconds_isValid;
}

bool OAIPartitionHealthReport::isSet() const {
...
bool OAIPartitionHealthReport::isValid() const {
