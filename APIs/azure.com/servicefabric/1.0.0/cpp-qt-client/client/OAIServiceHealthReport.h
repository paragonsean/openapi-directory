...
/*
 * OAIServiceHealthReport.h
 *
 * The report of the service health
 */

#ifndef OAIServiceHealthReport_H
#define OAIServiceHealthReport_H
...
class OAIServiceHealthReport : public OAIObject {
public:
    OAIServiceHealthReport();
    OAIServiceHealthReport(QString json);
    ~OAIServiceHealthReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceHealthReport)

#endif // OAIServiceHealthReport_H
