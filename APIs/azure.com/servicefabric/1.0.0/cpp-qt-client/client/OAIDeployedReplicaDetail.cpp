...
OAIDeployedReplicaDetail::OAIDeployedReplicaDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeployedReplicaDetail::OAIDeployedReplicaDetail() {
    this->initializeModel();
}

OAIDeployedReplicaDetail::~OAIDeployedReplicaDetail() {}

void OAIDeployedReplicaDetail::initializeModel() {
...
void OAIDeployedReplicaDetail::fromJson(QString jsonString) {
...
void OAIDeployedReplicaDetail::fromJsonObject(QJsonObject json) {
...
QString OAIDeployedReplicaDetail::asJson() const {
...
QJsonObject OAIDeployedReplicaDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_current_replicator_operation_isSet) {
        obj.insert(QString("CurrentReplicatorOperation"), ::OpenAPI::toJsonValue(m_current_replicator_operation));
    }
    if (m_current_service_operation_isSet) {
    ...
    if (m_write_status_isSet) {
        obj.insert(QString("WriteStatus"), ::OpenAPI::toJsonValue(m_write_status));
    }
    return obj;
}

qint32 OAIDeployedReplicaDetail::getCurrentReplicatorOperation() const {
    return m_current_replicator_operation;
}
void OAIDeployedReplicaDetail::setCurrentReplicatorOperation(const qint32 &current_replicator_operation) {
    m_current_replicator_operation = current_replicator_operation;
    m_current_replicator_operation_isSet = true;
}

bool OAIDeployedReplicaDetail::is_current_replicator_operation_Set() const{
    return m_current_replicator_operation_isSet;
}

bool OAIDeployedReplicaDetail::is_current_replicator_operation_Valid() const{
    return m_current_replicator_operation_isValid;
}

qint32 OAIDeployedReplicaDetail::getCurrentServiceOperation() const {
    return m_current_service_operation;
}
void OAIDeployedReplicaDetail::setCurrentServiceOperation(const qint32 &current_service_operation) {
    m_current_service_operation = current_service_operation;
    m_current_service_operation_isSet = true;
}

bool OAIDeployedReplicaDetail::is_current_service_operation_Set() const{
    return m_current_service_operation_isSet;
}

bool OAIDeployedReplicaDetail::is_current_service_operation_Valid() const{
    return m_current_service_operation_isValid;
}

QString OAIDeployedReplicaDetail::getCurrentServiceOperationStartTimeUtc() const {
    return m_current_service_operation_start_time_utc;
}
void OAIDeployedReplicaDetail::setCurrentServiceOperationStartTimeUtc(const QString &current_service_operation_start_time_utc) {
...
bool OAIDeployedReplicaDetail::is_current_service_operation_start_time_utc_Set() const{
    return m_current_service_operation_start_time_utc_isSet;
}

bool OAIDeployedReplicaDetail::is_current_service_operation_start_time_utc_Valid() const{
    return m_current_service_operation_start_time_utc_isValid;
}

QString OAIDeployedReplicaDetail::getInstanceId() const {
    return m_instance_id;
}
void OAIDeployedReplicaDetail::setInstanceId(const QString &instance_id) {
    m_instance_id = instance_id;
    m_instance_id_isSet = true;
}

bool OAIDeployedReplicaDetail::is_instance_id_Set() const{
    return m_instance_id_isSet;
}

bool OAIDeployedReplicaDetail::is_instance_id_Valid() const{
    return m_instance_id_isValid;
}

QString OAIDeployedReplicaDetail::getPartitionId() const {
    return m_partition_id;
}
void OAIDeployedReplicaDetail::setPartitionId(const QString &partition_id) {
    m_partition_id = partition_id;
    m_partition_id_isSet = true;
}

bool OAIDeployedReplicaDetail::is_partition_id_Set() const{
    return m_partition_id_isSet;
}

bool OAIDeployedReplicaDetail::is_partition_id_Valid() const{
    return m_partition_id_isValid;
}

qint32 OAIDeployedReplicaDetail::getReadStatus() const {
    return m_read_status;
}
void OAIDeployedReplicaDetail::setReadStatus(const qint32 &read_status) {
    m_read_status = read_status;
    m_read_status_isSet = true;
}

bool OAIDeployedReplicaDetail::is_read_status_Set() const{
    return m_read_status_isSet;
}

bool OAIDeployedReplicaDetail::is_read_status_Valid() const{
    return m_read_status_isValid;
}

QString OAIDeployedReplicaDetail::getReplicaId() const {
    return m_replica_id;
}
void OAIDeployedReplicaDetail::setReplicaId(const QString &replica_id) {
    m_replica_id = replica_id;
    m_replica_id_isSet = true;
}

bool OAIDeployedReplicaDetail::is_replica_id_Set() const{
    return m_replica_id_isSet;
}

bool OAIDeployedReplicaDetail::is_replica_id_Valid() const{
    return m_replica_id_isValid;
}

OAIDeployedReplicaDetail_ReplicatorStatus OAIDeployedReplicaDetail::getReplicatorStatus() const {
    return m_replicator_status;
}
void OAIDeployedReplicaDetail::setReplicatorStatus(const OAIDeployedReplicaDetail_ReplicatorStatus &replicator_status) {
    m_replicator_status = replicator_status;
    m_replicator_status_isSet = true;
}

bool OAIDeployedReplicaDetail::is_replicator_status_Set() const{
    return m_replicator_status_isSet;
}

bool OAIDeployedReplicaDetail::is_replicator_status_Valid() const{
    return m_replicator_status_isValid;
}

OAIServiceKind OAIDeployedReplicaDetail::getServiceKind() const {
    return m_service_kind;
}
void OAIDeployedReplicaDetail::setServiceKind(const OAIServiceKind &service_kind) {
    m_service_kind = service_kind;
    m_service_kind_isSet = true;
}

bool OAIDeployedReplicaDetail::is_service_kind_Set() const{
    return m_service_kind_isSet;
}

bool OAIDeployedReplicaDetail::is_service_kind_Valid() const{
    return m_service_kind_isValid;
}

QString OAIDeployedReplicaDetail::getServiceName() const {
    return m_service_name;
}
void OAIDeployedReplicaDetail::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIDeployedReplicaDetail::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIDeployedReplicaDetail::is_service_name_Valid() const{
    return m_service_name_isValid;
}

qint32 OAIDeployedReplicaDetail::getWriteStatus() const {
    return m_write_status;
}
void OAIDeployedReplicaDetail::setWriteStatus(const qint32 &write_status) {
    m_write_status = write_status;
    m_write_status_isSet = true;
}

bool OAIDeployedReplicaDetail::is_write_status_Set() const{
    return m_write_status_isSet;
}

bool OAIDeployedReplicaDetail::is_write_status_Valid() const{
    return m_write_status_isValid;
}

bool OAIDeployedReplicaDetail::isSet() const {
...
bool OAIDeployedReplicaDetail::isValid() const {
