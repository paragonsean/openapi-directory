...
/*
 * OAIDeployedServiceType.h
 *
 * The type of the deploye service
 */

#ifndef OAIDeployedServiceType_H
#define OAIDeployedServiceType_H
...
class OAIDeployedServiceType : public OAIObject {
public:
    OAIDeployedServiceType();
    OAIDeployedServiceType(QString json);
    ~OAIDeployedServiceType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedServiceType)

#endif // OAIDeployedServiceType_H
