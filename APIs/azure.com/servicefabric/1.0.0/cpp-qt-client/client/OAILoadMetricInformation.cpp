...
void OAILoadMetricInformation::initializeModel() {
    ...
    m_buffered_capacity_isSet = false;
    m_buffered_capacity_isValid = false;
    ...
    m_max_node_load_id_isSet = false;
    m_max_node_load_id_isValid = false;

    m_max_node_load_value_isSet = false;
    m_max_node_load_value_isValid = false;

    m_min_node_load_id_isSet = false;
    m_min_node_load_id_isValid = false;
    ...
    m_remaining_buffered_capacity_isSet = false;
    m_remaining_buffered_capacity_isValid = false;

    m_remaining_unbuffered_capacity_isSet = false;
    m_remaining_unbuffered_capacity_isValid = false;
}
...
void OAILoadMetricInformation::fromJsonObject(QJsonObject json) {
    ...
    m_buffered_capacity_isValid = ::OpenAPI::fromJsonValue(m_buffered_capacity, json[QString("BufferedCapacity")]);
    m_buffered_capacity_isSet = !json[QString("BufferedCapacity")].isNull() && m_buffered_capacity_isValid;
    ...
    m_max_node_load_id_isValid = ::OpenAPI::fromJsonValue(m_max_node_load_id, json[QString("MaxNodeLoadId")]);
    m_max_node_load_id_isSet = !json[QString("MaxNodeLoadId")].isNull() && m_max_node_load_id_isValid;
    ...
    m_min_node_load_id_isValid = ::OpenAPI::fromJsonValue(m_min_node_load_id, json[QString("MinNodeLoadId")]);
    m_min_node_load_id_isSet = !json[QString("MinNodeLoadId")].isNull() && m_min_node_load_id_isValid;
    ...
    m_remaining_buffered_capacity_isValid = ::OpenAPI::fromJsonValue(m_remaining_buffered_capacity, json[QString("RemainingBufferedCapacity")]);
    m_remaining_buffered_capacity_isSet = !json[QString("RemainingBufferedCapacity")].isNull() && m_remaining_buffered_capacity_isValid;

    m_remaining_unbuffered_capacity_isValid = ::OpenAPI::fromJsonValue(m_remaining_unbuffered_capacity, json[QString("RemainingUnbufferedCapacity")]);
    m_remaining_unbuffered_capacity_isSet = !json[QString("RemainingUnbufferedCapacity")].isNull() && m_remaining_unbuffered_capacity_isValid;
}
...
QJsonObject OAILoadMetricInformation::asJsonObject() const {
    ...
    if (m_buffered_capacity_isSet) {
        obj.insert(QString("BufferedCapacity"), ::OpenAPI::toJsonValue(m_buffered_capacity));
    }
    ...
    if (m_max_node_load_id.isSet()) {
        obj.insert(QString("MaxNodeLoadId"), ::OpenAPI::toJsonValue(m_max_node_load_id));
    }
    if (m_max_node_load_value_isSet) {
        obj.insert(QString("MaxNodeLoadValue"), ::OpenAPI::toJsonValue(m_max_node_load_value));
    }
    if (m_min_node_load_id.isSet()) {
        obj.insert(QString("MinNodeLoadId"), ::OpenAPI::toJsonValue(m_min_node_load_id));
    }
    ...
    if (m_remaining_buffered_capacity_isSet) {
        obj.insert(QString("RemainingBufferedCapacity"), ::OpenAPI::toJsonValue(m_remaining_buffered_capacity));
    }
    if (m_remaining_unbuffered_capacity_isSet) {
        obj.insert(QString("RemainingUnbufferedCapacity"), ::OpenAPI::toJsonValue(m_remaining_unbuffered_capacity));
    }
    return obj;
}
...
qint32 OAILoadMetricInformation::getActivityThreshold() const {
    return m_activity_threshold;
}
void OAILoadMetricInformation::setActivityThreshold(const qint32 &activity_threshold) {
...
qint32 OAILoadMetricInformation::getBalancingThreshold() const {
    return m_balancing_threshold;
}
void OAILoadMetricInformation::setBalancingThreshold(const qint32 &balancing_threshold) {
...
QString OAILoadMetricInformation::getBufferedCapacity() const {
    return m_buffered_capacity;
}
void OAILoadMetricInformation::setBufferedCapacity(const QString &buffered_capacity) {
    m_buffered_capacity = buffered_capacity;
    m_buffered_capacity_isSet = true;
}

bool OAILoadMetricInformation::is_buffered_capacity_Set() const{
    return m_buffered_capacity_isSet;
}

bool OAILoadMetricInformation::is_buffered_capacity_Valid() const{
    return m_buffered_capacity_isValid;
}
...
qint32 OAILoadMetricInformation::getDeviationAfter() const {
    return m_deviation_after;
}
void OAILoadMetricInformation::setDeviationAfter(const qint32 &deviation_after) {
...
qint32 OAILoadMetricInformation::getDeviationBefore() const {
    return m_deviation_before;
}
void OAILoadMetricInformation::setDeviationBefore(const qint32 &deviation_before) {
...
OAILoadMetricInformation_MaxNodeLoadId OAILoadMetricInformation::getMaxNodeLoadId() const {
    return m_max_node_load_id;
}
void OAILoadMetricInformation::setMaxNodeLoadId(const OAILoadMetricInformation_MaxNodeLoadId &max_node_load_id) {
    m_max_node_load_id = max_node_load_id;
    m_max_node_load_id_isSet = true;
}

bool OAILoadMetricInformation::is_max_node_load_id_Set() const{
    return m_max_node_load_id_isSet;
}

bool OAILoadMetricInformation::is_max_node_load_id_Valid() const{
    return m_max_node_load_id_isValid;
}
...
OAILoadMetricInformation_MinNodeLoadId OAILoadMetricInformation::getMinNodeLoadId() const {
    return m_min_node_load_id;
}
void OAILoadMetricInformation::setMinNodeLoadId(const OAILoadMetricInformation_MinNodeLoadId &min_node_load_id) {
    m_min_node_load_id = min_node_load_id;
    m_min_node_load_id_isSet = true;
}

bool OAILoadMetricInformation::is_min_node_load_id_Set() const{
    return m_min_node_load_id_isSet;
}

bool OAILoadMetricInformation::is_min_node_load_id_Valid() const{
    return m_min_node_load_id_isValid;
}
...
qint32 OAILoadMetricInformation::getNodeBufferPercentage() const {
    return m_node_buffer_percentage;
}
void OAILoadMetricInformation::setNodeBufferPercentage(const qint32 &node_buffer_percentage) {
...
QString OAILoadMetricInformation::getRemainingBufferedCapacity() const {
    return m_remaining_buffered_capacity;
}
void OAILoadMetricInformation::setRemainingBufferedCapacity(const QString &remaining_buffered_capacity) {
    m_remaining_buffered_capacity = remaining_buffered_capacity;
    m_remaining_buffered_capacity_isSet = true;
}

bool OAILoadMetricInformation::is_remaining_buffered_capacity_Set() const{
    return m_remaining_buffered_capacity_isSet;
}

bool OAILoadMetricInformation::is_remaining_buffered_capacity_Valid() const{
    return m_remaining_buffered_capacity_isValid;
}

QString OAILoadMetricInformation::getRemainingUnbufferedCapacity() const {
    return m_remaining_unbuffered_capacity;
}
void OAILoadMetricInformation::setRemainingUnbufferedCapacity(const QString &remaining_unbuffered_capacity) {
    m_remaining_unbuffered_capacity = remaining_unbuffered_capacity;
    m_remaining_unbuffered_capacity_isSet = true;
}

bool OAILoadMetricInformation::is_remaining_unbuffered_capacity_Set() const{
    return m_remaining_unbuffered_capacity_isSet;
}

bool OAILoadMetricInformation::is_remaining_unbuffered_capacity_Valid() const{
    return m_remaining_unbuffered_capacity_isValid;
}
