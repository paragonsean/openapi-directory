...
QList<QString> OAIPartitionLoadInformation::getPrimaryLoadMetricReports() const {
    return m_primary_load_metric_reports;
}
void OAIPartitionLoadInformation::setPrimaryLoadMetricReports(const QList<QString> &primary_load_metric_reports) {
...
QList<QString> OAIPartitionLoadInformation::getSecondaryLoadMetricReports() const {
    return m_secondary_load_metric_reports;
}
void OAIPartitionLoadInformation::setSecondaryLoadMetricReports(const QList<QString> &secondary_load_metric_reports) {
