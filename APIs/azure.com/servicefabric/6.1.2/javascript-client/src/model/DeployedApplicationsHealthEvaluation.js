...
/**
 * The DeployedApplicationsHealthEvaluation model module.
 * @module model/DeployedApplicationsHealthEvaluation
 * @version 6.1.2
 */
class DeployedApplicationsHealthEvaluation {
    /**
     * Constructs a new <code>DeployedApplicationsHealthEvaluation</code>.
     ...
     * @alias module:model/DeployedApplicationsHealthEvaluation
    ...
    constructor(kind) { 
        ...
        DeployedApplicationsHealthEvaluation.initialize(this, kind);
    }
    ...
    /**
     * Constructs a <code>DeployedApplicationsHealthEvaluation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeployedApplicationsHealthEvaluation} obj Optional instance to populate.
     * @return {module:model/DeployedApplicationsHealthEvaluation} The populated <code>DeployedApplicationsHealthEvaluation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeployedApplicationsHealthEvaluation();
    ...
    /**
     * Validates the JSON data with respect to <code>DeployedApplicationsHealthEvaluation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeployedApplicationsHealthEvaluation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeployedApplicationsHealthEvaluation.RequiredProperties) {
...
DeployedApplicationsHealthEvaluation.RequiredProperties = ["Kind"];
 ...
 */
DeployedApplicationsHealthEvaluation.prototype['MaxPercentUnhealthyDeployedApplications'] = undefined;

/**
 * Total number of deployed applications of the application in the health store.
 * @member {Number} TotalCount
 */
DeployedApplicationsHealthEvaluation.prototype['TotalCount'] = undefined;

/**
 * List of health evaluations that resulted in the current aggregated health state.
 * @member {Array.<module:model/HealthEvaluationWrapper>} UnhealthyEvaluations
 */
DeployedApplicationsHealthEvaluation.prototype['UnhealthyEvaluations'] = undefined;
...
export default DeployedApplicationsHealthEvaluation;
