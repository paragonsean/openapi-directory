...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.NodeHealthStateChunk();
  });
  ...
  describe('NodeHealthStateChunk', function() {
    it('should create an instance of NodeHealthStateChunk', function() {
      // uncomment below and update the code to test NodeHealthStateChunk
      //var instance = new ServiceFabricClientApis.NodeHealthStateChunk();
      //expect(instance).to.be.a(ServiceFabricClientApis.NodeHealthStateChunk);
    });
