...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.PropertyValue();
  });
  ...
  describe('PropertyValue', function() {
    it('should create an instance of PropertyValue', function() {
      ...
      //var instance = new ServiceFabricClientApis.PropertyValue();
      //expect(instance).to.be.a(ServiceFabricClientApis.PropertyValue);
    });
