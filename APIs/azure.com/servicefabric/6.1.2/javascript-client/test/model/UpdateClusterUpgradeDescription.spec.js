...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.UpdateClusterUpgradeDescription();
  });
  ...
  describe('UpdateClusterUpgradeDescription', function() {
    it('should create an instance of UpdateClusterUpgradeDescription', function() {
      // uncomment below and update the code to test UpdateClusterUpgradeDescription
      //var instance = new ServiceFabricClientApis.UpdateClusterUpgradeDescription();
      //expect(instance).to.be.a(ServiceFabricClientApis.UpdateClusterUpgradeDescription);
    });
