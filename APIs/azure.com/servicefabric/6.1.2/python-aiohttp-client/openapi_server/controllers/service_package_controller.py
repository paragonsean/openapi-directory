...
async def deployed_service_package_to_node(request: web.Request, api_version, node_name, deploy_service_package_to_node_description, timeout=None) -> web.Response:
