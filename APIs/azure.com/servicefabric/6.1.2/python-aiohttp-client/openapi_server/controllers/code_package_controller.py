...
async def get_container_logs_deployed_on_node(request: web.Request, api_version, node_name, application_id, service_manifest_name, code_package_name, tail=None, timeout=None) -> web.Response:
