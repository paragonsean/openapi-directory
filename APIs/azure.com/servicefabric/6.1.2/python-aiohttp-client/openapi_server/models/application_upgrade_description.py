...
class ApplicationUpgradeDescription(Model):
    ...
    def __init__(self, application_health_policy: ApplicationHealthPolicy=None, force_restart: bool=False, monitoring_policy: MonitoringPolicyDescription=None, name: str=None, parameters: List[ApplicationParameter]=None, rolling_upgrade_mode: UpgradeMode=UpgradeMode.UNMONITOREDAUTO, target_application_type_version: str=None, upgrade_kind: UpgradeKind=UpgradeKind.ROLLING, upgrade_replica_set_check_timeout_in_seconds: int=None):
