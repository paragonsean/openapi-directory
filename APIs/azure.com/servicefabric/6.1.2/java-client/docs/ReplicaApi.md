...
public class Example {
  public static void main(String[] args) {
    ...
    UUID partitionId = UUID.randomUUID(); // UUID | The identity of the partition.
    String replicaId = "replicaId_example"; // String | The identifier of the replica.
    String serviceKind = "Stateless"; // String | The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values.
...
| **partitionId** | **UUID**| The identity of the partition. | |
| **replicaId** | **String**| The identifier of the replica. | |
| **serviceKind** | **String**| The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values. | [default to Stateful] [enum: Stateless, Stateful] |
