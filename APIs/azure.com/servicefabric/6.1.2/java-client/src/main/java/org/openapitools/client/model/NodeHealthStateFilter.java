...
public class NodeHealthStateFilter {
  ...
  public NodeHealthStateFilter healthStateFilter(Integer healthStateFilter) {
  ...
  public NodeHealthStateFilter nodeNameFilter(String nodeNameFilter) {
  ...
  public boolean equals(Object o) {
    ...
    NodeHealthStateFilter nodeHealthStateFilter = (NodeHealthStateFilter) o;
    return Objects.equals(this.healthStateFilter, nodeHealthStateFilter.healthStateFilter) &&
        Objects.equals(this.nodeNameFilter, nodeHealthStateFilter.nodeNameFilter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(healthStateFilter, nodeNameFilter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NodeHealthStateFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeHealthStateFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeHealthStateFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeHealthStateFilter is not found in the empty JSON string", NodeHealthStateFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeHealthStateFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeHealthStateFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeHealthStateFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeHealthStateFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeHealthStateFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeHealthStateFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeHealthStateFilter>() {
           @Override
           public void write(JsonWriter out, NodeHealthStateFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeHealthStateFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeHealthStateFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeHealthStateFilter
   * @throws IOException if the JSON string is invalid with respect to NodeHealthStateFilter
   */
  public static NodeHealthStateFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeHealthStateFilter.class);
  }

  /**
   * Convert an instance of NodeHealthStateFilter to an JSON string
   *
   * @return JSON string
   */
