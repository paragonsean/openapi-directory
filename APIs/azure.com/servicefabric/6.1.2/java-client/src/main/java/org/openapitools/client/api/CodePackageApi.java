...
public class CodePackageApi {
     ...
     * @param tail Number of lines to fetch from tail end. (optional)
     ...
     */
    public okhttp3.Call getContainerLogsDeployedOnNodeCall(String apiVersion, String nodeName, String applicationId, String serviceManifestName, String codePackageName, String tail, Long timeout, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getContainerLogsDeployedOnNodeValidateBeforeCall(String apiVersion, String nodeName, String applicationId, String serviceManifestName, String codePackageName, String tail, Long timeout, final ApiCallback _callback) throws ApiException {
        ...
        return getContainerLogsDeployedOnNodeCall(apiVersion, nodeName, applicationId, serviceManifestName, codePackageName, tail, timeout, _callback);
     ...
     */
    public ContainerLogs getContainerLogsDeployedOnNode(String apiVersion, String nodeName, String applicationId, String serviceManifestName, String codePackageName, String tail, Long timeout) throws ApiException {
        ApiResponse<ContainerLogs> localVarResp = getContainerLogsDeployedOnNodeWithHttpInfo(apiVersion, nodeName, applicationId, serviceManifestName, codePackageName, tail, timeout);
     ...
     */
    public ApiResponse<ContainerLogs> getContainerLogsDeployedOnNodeWithHttpInfo(String apiVersion, String nodeName, String applicationId, String serviceManifestName, String codePackageName, String tail, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = getContainerLogsDeployedOnNodeValidateBeforeCall(apiVersion, nodeName, applicationId, serviceManifestName, codePackageName, tail, timeout, null);
     ...
     */
    public okhttp3.Call getContainerLogsDeployedOnNodeAsync(String apiVersion, String nodeName, String applicationId, String serviceManifestName, String codePackageName, String tail, Long timeout, final ApiCallback<ContainerLogs> _callback) throws ApiException {

        okhttp3.Call localVarCall = getContainerLogsDeployedOnNodeValidateBeforeCall(apiVersion, nodeName, applicationId, serviceManifestName, codePackageName, tail, timeout, _callback);
        Type localVarReturnType = new TypeToken<ContainerLogs>(){}.getType();
