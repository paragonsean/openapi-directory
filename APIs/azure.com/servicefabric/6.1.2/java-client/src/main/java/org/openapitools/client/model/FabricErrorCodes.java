 ...
 */
@JsonAdapter(FabricErrorCodes.Adapter.class)
public enum FabricErrorCodes {
  ...
  public static FabricErrorCodes fromValue(String value) {
    for (FabricErrorCodes b : FabricErrorCodes.values()) {
  ...
  public static class Adapter extends TypeAdapter<FabricErrorCodes> {
    @Override
    public void write(final JsonWriter jsonWriter, final FabricErrorCodes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FabricErrorCodes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FabricErrorCodes.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FabricErrorCodes.fromValue(value);
  }
}
