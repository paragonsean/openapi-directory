...
#include "OAIPartitionsHealthEvaluation.h"
...
OAIPartitionsHealthEvaluation::OAIPartitionsHealthEvaluation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPartitionsHealthEvaluation::OAIPartitionsHealthEvaluation() {
    this->initializeModel();
}

OAIPartitionsHealthEvaluation::~OAIPartitionsHealthEvaluation() {}

void OAIPartitionsHealthEvaluation::initializeModel() {
...
void OAIPartitionsHealthEvaluation::fromJson(QString jsonString) {
...
void OAIPartitionsHealthEvaluation::fromJsonObject(QJsonObject json) {
...
QString OAIPartitionsHealthEvaluation::asJson() const {
...
QJsonObject OAIPartitionsHealthEvaluation::asJsonObject() const {
    QJsonObject obj;
...
OAIHealthState OAIPartitionsHealthEvaluation::getAggregatedHealthState() const {
    return m_aggregated_health_state;
}
void OAIPartitionsHealthEvaluation::setAggregatedHealthState(const OAIHealthState &aggregated_health_state) {
    m_aggregated_health_state = aggregated_health_state;
    m_aggregated_health_state_isSet = true;
}

bool OAIPartitionsHealthEvaluation::is_aggregated_health_state_Set() const{
    return m_aggregated_health_state_isSet;
}

bool OAIPartitionsHealthEvaluation::is_aggregated_health_state_Valid() const{
    return m_aggregated_health_state_isValid;
}

QString OAIPartitionsHealthEvaluation::getDescription() const {
    return m_description;
}
void OAIPartitionsHealthEvaluation::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPartitionsHealthEvaluation::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPartitionsHealthEvaluation::is_description_Valid() const{
    return m_description_isValid;
}

OAIHealthEvaluationKind OAIPartitionsHealthEvaluation::getKind() const {
    return m_kind;
}
void OAIPartitionsHealthEvaluation::setKind(const OAIHealthEvaluationKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIPartitionsHealthEvaluation::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIPartitionsHealthEvaluation::is_kind_Valid() const{
    return m_kind_isValid;
}

qint32 OAIPartitionsHealthEvaluation::getMaxPercentUnhealthyPartitionsPerService() const {
    return m_max_percent_unhealthy_partitions_per_service;
}
void OAIPartitionsHealthEvaluation::setMaxPercentUnhealthyPartitionsPerService(const qint32 &max_percent_unhealthy_partitions_per_service) {
...
bool OAIPartitionsHealthEvaluation::is_max_percent_unhealthy_partitions_per_service_Set() const{
    return m_max_percent_unhealthy_partitions_per_service_isSet;
}

bool OAIPartitionsHealthEvaluation::is_max_percent_unhealthy_partitions_per_service_Valid() const{
    return m_max_percent_unhealthy_partitions_per_service_isValid;
}

qint64 OAIPartitionsHealthEvaluation::getTotalCount() const {
    return m_total_count;
}
void OAIPartitionsHealthEvaluation::setTotalCount(const qint64 &total_count) {
    m_total_count = total_count;
    m_total_count_isSet = true;
}

bool OAIPartitionsHealthEvaluation::is_total_count_Set() const{
    return m_total_count_isSet;
}

bool OAIPartitionsHealthEvaluation::is_total_count_Valid() const{
    return m_total_count_isValid;
}

QList<OAIHealthEvaluationWrapper> OAIPartitionsHealthEvaluation::getUnhealthyEvaluations() const {
    return m_unhealthy_evaluations;
}
void OAIPartitionsHealthEvaluation::setUnhealthyEvaluations(const QList<OAIHealthEvaluationWrapper> &unhealthy_evaluations) {
    m_unhealthy_evaluations = unhealthy_evaluations;
    m_unhealthy_evaluations_isSet = true;
}

bool OAIPartitionsHealthEvaluation::is_unhealthy_evaluations_Set() const{
    return m_unhealthy_evaluations_isSet;
}

bool OAIPartitionsHealthEvaluation::is_unhealthy_evaluations_Valid() const{
    return m_unhealthy_evaluations_isValid;
}

bool OAIPartitionsHealthEvaluation::isSet() const {
...
bool OAIPartitionsHealthEvaluation::isValid() const {
