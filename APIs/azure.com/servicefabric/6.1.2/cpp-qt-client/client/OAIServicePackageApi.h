...
public:
    ...
    */
    virtual void deployedServicePackageToNode(const QString &api_version, const QString &node_name, const OAIDeployServicePackageToNodeDescription &deploy_service_package_to_node_description, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
private:
    ...
    void deployedServicePackageToNodeCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void deployedServicePackageToNodeSignal();
    ...
    void deployedServicePackageToNodeSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use deployedServicePackageToNodeSignalError() instead")
    void deployedServicePackageToNodeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void deployedServicePackageToNodeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use deployedServicePackageToNodeSignalErrorFull() instead")
    void deployedServicePackageToNodeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deployedServicePackageToNodeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
