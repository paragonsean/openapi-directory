...
public:
    ...
    QList<OAIPartitionHealthState> getPartitionHealthStates() const;
    void setPartitionHealthStates(const QList<OAIPartitionHealthState> &partition_health_states);
...
private:
    ...
    QList<OAIPartitionHealthState> m_partition_health_states;
