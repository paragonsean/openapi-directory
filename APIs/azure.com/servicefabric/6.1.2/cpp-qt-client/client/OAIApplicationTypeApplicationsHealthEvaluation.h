...
/*
 * OAIApplicationTypeApplicationsHealthEvaluation.h
 *
...
#ifndef OAIApplicationTypeApplicationsHealthEvaluation_H
#define OAIApplicationTypeApplicationsHealthEvaluation_H
...
class OAIApplicationTypeApplicationsHealthEvaluation : public OAIObject {
public:
    OAIApplicationTypeApplicationsHealthEvaluation();
    OAIApplicationTypeApplicationsHealthEvaluation(QString json);
    ~OAIApplicationTypeApplicationsHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationTypeApplicationsHealthEvaluation)

#endif // OAIApplicationTypeApplicationsHealthEvaluation_H
