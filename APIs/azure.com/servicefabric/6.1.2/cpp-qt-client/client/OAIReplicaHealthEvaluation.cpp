...
OAIHealthEvaluationKind OAIReplicaHealthEvaluation::getKind() const {
    return m_kind;
}
void OAIReplicaHealthEvaluation::setKind(const OAIHealthEvaluationKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}
...
QList<OAIHealthEvaluationWrapper> OAIReplicaHealthEvaluation::getUnhealthyEvaluations() const {
    return m_unhealthy_evaluations;
}
void OAIReplicaHealthEvaluation::setUnhealthyEvaluations(const QList<OAIHealthEvaluationWrapper> &unhealthy_evaluations) {
