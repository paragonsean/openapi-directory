...
#ifndef OAIPagedBackupEntityList_H
#define OAIPagedBackupEntityList_H
...
class OAIPagedBackupEntityList : public OAIObject {
public:
    OAIPagedBackupEntityList();
    OAIPagedBackupEntityList(QString json);
    ~OAIPagedBackupEntityList() override;
    ...
    QList<OAIBackupEntity> getItems() const;
    void setItems(const QList<OAIBackupEntity> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagedBackupEntityList)

#endif // OAIPagedBackupEntityList_H
