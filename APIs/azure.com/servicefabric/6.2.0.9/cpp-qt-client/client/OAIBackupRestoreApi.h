...
public:
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void disableApplicationBackup(const QString &application_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void disablePartitionBackup(const QString &partition_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void disableServiceBackup(const QString &service_id, const QString &api_version, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
