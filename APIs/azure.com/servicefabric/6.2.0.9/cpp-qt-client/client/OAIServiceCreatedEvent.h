...
/*
 * OAIServiceCreatedEvent.h
 *
 * Service Created event.
 */

#ifndef OAIServiceCreatedEvent_H
#define OAIServiceCreatedEvent_H
...
class OAIServiceCreatedEvent : public OAIObject {
public:
    OAIServiceCreatedEvent();
    OAIServiceCreatedEvent(QString json);
    ~OAIServiceCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceCreatedEvent)

#endif // OAIServiceCreatedEvent_H
