...
/*
 * OAIApplicationHealthReportExpiredEvent.h
 *
 * Application Health Report Expired event.
 */

#ifndef OAIApplicationHealthReportExpiredEvent_H
#define OAIApplicationHealthReportExpiredEvent_H
...
class OAIApplicationHealthReportExpiredEvent : public OAIObject {
public:
    OAIApplicationHealthReportExpiredEvent();
    OAIApplicationHealthReportExpiredEvent(QString json);
    ~OAIApplicationHealthReportExpiredEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationHealthReportExpiredEvent)

#endif // OAIApplicationHealthReportExpiredEvent_H
