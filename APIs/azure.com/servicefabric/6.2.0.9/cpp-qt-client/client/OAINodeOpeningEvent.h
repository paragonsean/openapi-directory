...
/*
 * OAINodeOpeningEvent.h
 *
 * Node Opening event.
 */

#ifndef OAINodeOpeningEvent_H
#define OAINodeOpeningEvent_H
...
class OAINodeOpeningEvent : public OAIObject {
public:
    OAINodeOpeningEvent();
    OAINodeOpeningEvent(QString json);
    ~OAINodeOpeningEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeOpeningEvent)

#endif // OAINodeOpeningEvent_H
