...
/*
 * OAIChaosRestartCodePackageFaultScheduledEvent.h
 *
 * Chaos Restart Code Package Fault Scheduled event.
 */

#ifndef OAIChaosRestartCodePackageFaultScheduledEvent_H
#define OAIChaosRestartCodePackageFaultScheduledEvent_H
...
class OAIChaosRestartCodePackageFaultScheduledEvent : public OAIObject {
public:
    OAIChaosRestartCodePackageFaultScheduledEvent();
    OAIChaosRestartCodePackageFaultScheduledEvent(QString json);
    ~OAIChaosRestartCodePackageFaultScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosRestartCodePackageFaultScheduledEvent)

#endif // OAIChaosRestartCodePackageFaultScheduledEvent_H
