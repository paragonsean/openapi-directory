...
/*
 * OAIClusterHealthReportExpiredEvent.h
 *
 * Cluster Health Report Expired event.
 */

#ifndef OAIClusterHealthReportExpiredEvent_H
#define OAIClusterHealthReportExpiredEvent_H
...
class OAIClusterHealthReportExpiredEvent : public OAIObject {
public:
    OAIClusterHealthReportExpiredEvent();
    OAIClusterHealthReportExpiredEvent(QString json);
    ~OAIClusterHealthReportExpiredEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterHealthReportExpiredEvent)

#endif // OAIClusterHealthReportExpiredEvent_H
