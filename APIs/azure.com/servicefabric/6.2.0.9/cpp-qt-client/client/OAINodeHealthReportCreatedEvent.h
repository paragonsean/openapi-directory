...
/*
 * OAINodeHealthReportCreatedEvent.h
 *
 * Node Health Report Created event.
 */

#ifndef OAINodeHealthReportCreatedEvent_H
#define OAINodeHealthReportCreatedEvent_H
...
class OAINodeHealthReportCreatedEvent : public OAIObject {
public:
    OAINodeHealthReportCreatedEvent();
    OAINodeHealthReportCreatedEvent(QString json);
    ~OAINodeHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeHealthReportCreatedEvent)

#endif // OAINodeHealthReportCreatedEvent_H
