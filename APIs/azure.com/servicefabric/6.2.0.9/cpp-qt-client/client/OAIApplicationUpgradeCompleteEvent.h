...
/*
 * OAIApplicationUpgradeCompleteEvent.h
 *
 * Application Upgrade Complete event.
 */

#ifndef OAIApplicationUpgradeCompleteEvent_H
#define OAIApplicationUpgradeCompleteEvent_H
...
class OAIApplicationUpgradeCompleteEvent : public OAIObject {
public:
    OAIApplicationUpgradeCompleteEvent();
    OAIApplicationUpgradeCompleteEvent(QString json);
    ~OAIApplicationUpgradeCompleteEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeCompleteEvent)

#endif // OAIApplicationUpgradeCompleteEvent_H
