...
#ifndef OAIPagedServiceInfoList_H
#define OAIPagedServiceInfoList_H
...
namespace OpenAPI {
class OAIServiceInfo;

class OAIPagedServiceInfoList : public OAIObject {
public:
    OAIPagedServiceInfoList();
    OAIPagedServiceInfoList(QString json);
    ~OAIPagedServiceInfoList() override;
    ...
    QList<OAIServiceInfo> getItems() const;
    void setItems(const QList<OAIServiceInfo> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagedServiceInfoList)

#endif // OAIPagedServiceInfoList_H
