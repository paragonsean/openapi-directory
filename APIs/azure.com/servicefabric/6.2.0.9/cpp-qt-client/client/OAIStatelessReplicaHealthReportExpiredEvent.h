...
/*
 * OAIStatelessReplicaHealthReportExpiredEvent.h
 *
 * Stateless Replica Health Report Expired event.
 */

#ifndef OAIStatelessReplicaHealthReportExpiredEvent_H
#define OAIStatelessReplicaHealthReportExpiredEvent_H
...
class OAIStatelessReplicaHealthReportExpiredEvent : public OAIObject {
public:
    OAIStatelessReplicaHealthReportExpiredEvent();
    OAIStatelessReplicaHealthReportExpiredEvent(QString json);
    ~OAIStatelessReplicaHealthReportExpiredEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessReplicaHealthReportExpiredEvent)

#endif // OAIStatelessReplicaHealthReportExpiredEvent_H
