...
#ifndef OAIClusterEvent_H
#define OAIClusterEvent_H
...
class OAIClusterEvent : public OAIObject {
public:
    OAIClusterEvent();
    OAIClusterEvent(QString json);
    ~OAIClusterEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterEvent)

#endif // OAIClusterEvent_H
