...
/*
 * OAINodeAbortingEvent.h
 *
 * Node Aborting event.
 */

#ifndef OAINodeAbortingEvent_H
#define OAINodeAbortingEvent_H
...
class OAINodeAbortingEvent : public OAIObject {
public:
    OAINodeAbortingEvent();
    OAINodeAbortingEvent(QString json);
    ~OAINodeAbortingEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeAbortingEvent)

#endif // OAINodeAbortingEvent_H
