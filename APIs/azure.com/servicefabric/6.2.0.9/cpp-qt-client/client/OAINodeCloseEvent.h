...
#ifndef OAINodeCloseEvent_H
#define OAINodeCloseEvent_H
...
class OAINodeCloseEvent : public OAIObject {
public:
    OAINodeCloseEvent();
    OAINodeCloseEvent(QString json);
    ~OAINodeCloseEvent() override;
    ...
    QString getNodeInstance() const;
    void setNodeInstance(const QString &node_instance);
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeCloseEvent)

#endif // OAINodeCloseEvent_H
