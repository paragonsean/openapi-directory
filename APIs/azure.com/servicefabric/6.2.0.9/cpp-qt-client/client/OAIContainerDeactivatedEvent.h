...
/*
 * OAIContainerDeactivatedEvent.h
 *
 * Container Deactivated event.
 */

#ifndef OAIContainerDeactivatedEvent_H
#define OAIContainerDeactivatedEvent_H
...
class OAIContainerDeactivatedEvent : public OAIObject {
public:
    OAIContainerDeactivatedEvent();
    OAIContainerDeactivatedEvent(QString json);
    ~OAIContainerDeactivatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainerDeactivatedEvent)

#endif // OAIContainerDeactivatedEvent_H
