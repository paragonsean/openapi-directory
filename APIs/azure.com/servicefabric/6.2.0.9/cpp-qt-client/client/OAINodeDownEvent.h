...
#ifndef OAINodeDownEvent_H
#define OAINodeDownEvent_H
...
class OAINodeDownEvent : public OAIObject {
public:
    OAINodeDownEvent();
    OAINodeDownEvent(QString json);
    ~OAINodeDownEvent() override;
    ...
    QDateTime getLastNodeUpAt() const;
    void setLastNodeUpAt(const QDateTime &last_node_up_at);
    bool is_last_node_up_at_Set() const;
    bool is_last_node_up_at_Valid() const;
...
private:
    ...
    QDateTime m_last_node_up_at;
    bool m_last_node_up_at_isSet;
    bool m_last_node_up_at_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeDownEvent)

#endif // OAINodeDownEvent_H
