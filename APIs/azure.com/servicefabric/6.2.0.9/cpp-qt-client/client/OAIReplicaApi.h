...
public:
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getReplicaInfo(const QString &api_version, const QString &partition_id, const QString &replica_id, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  partition_id QString [required]
    * @param[in]  replica_id QString [required]
    * @param[in]  replica_health_report_service_kind QString [required]
    * @param[in]  health_information OAIHealthInformation [required]
    * @param[in]  immediate bool [optional]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void reportReplicaHealth(const QString &api_version, const QString &partition_id, const QString &replica_id, const QString &replica_health_report_service_kind, const OAIHealthInformation &health_information, const ::OpenAPI::OptionalParam<bool> &immediate = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
