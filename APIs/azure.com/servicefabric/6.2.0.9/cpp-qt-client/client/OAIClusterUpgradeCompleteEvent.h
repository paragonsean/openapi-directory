...
/*
 * OAIClusterUpgradeCompleteEvent.h
 *
 * Cluster Upgrade Complete event.
 */

#ifndef OAIClusterUpgradeCompleteEvent_H
#define OAIClusterUpgradeCompleteEvent_H
...
class OAIClusterUpgradeCompleteEvent : public OAIObject {
public:
    OAIClusterUpgradeCompleteEvent();
    OAIClusterUpgradeCompleteEvent(QString json);
    ~OAIClusterUpgradeCompleteEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterUpgradeCompleteEvent)

#endif // OAIClusterUpgradeCompleteEvent_H
