...
/*
 * OAIDeployedApplicationsHealthEvaluation.h
 *
...
#ifndef OAIDeployedApplicationsHealthEvaluation_H
#define OAIDeployedApplicationsHealthEvaluation_H
...
class OAIDeployedApplicationsHealthEvaluation : public OAIObject {
public:
    OAIDeployedApplicationsHealthEvaluation();
    OAIDeployedApplicationsHealthEvaluation(QString json);
    ~OAIDeployedApplicationsHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedApplicationsHealthEvaluation)

#endif // OAIDeployedApplicationsHealthEvaluation_H
