...
/*
 * OAIChaosRestartNodeFaultScheduledEvent.h
 *
 * Chaos Restart Node Fault Scheduled event.
 */

#ifndef OAIChaosRestartNodeFaultScheduledEvent_H
#define OAIChaosRestartNodeFaultScheduledEvent_H
...
class OAIChaosRestartNodeFaultScheduledEvent : public OAIObject {
public:
    OAIChaosRestartNodeFaultScheduledEvent();
    OAIChaosRestartNodeFaultScheduledEvent(QString json);
    ~OAIChaosRestartNodeFaultScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosRestartNodeFaultScheduledEvent)

#endif // OAIChaosRestartNodeFaultScheduledEvent_H
