...
/*
 * OAIChaosStoppedEvent.h
 *
 * Chaos Stopped event.
 */

#ifndef OAIChaosStoppedEvent_H
#define OAIChaosStoppedEvent_H
...
class OAIChaosStoppedEvent : public OAIObject {
public:
    OAIChaosStoppedEvent();
    OAIChaosStoppedEvent(QString json);
    ~OAIChaosStoppedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosStoppedEvent)

#endif // OAIChaosStoppedEvent_H
