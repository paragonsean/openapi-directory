...
/*
 * OAIApplicationDeletedEvent.h
 *
 * Application Deleted event.
 */

#ifndef OAIApplicationDeletedEvent_H
#define OAIApplicationDeletedEvent_H
...
class OAIApplicationDeletedEvent : public OAIObject {
public:
    OAIApplicationDeletedEvent();
    OAIApplicationDeletedEvent(QString json);
    ~OAIApplicationDeletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationDeletedEvent)

#endif // OAIApplicationDeletedEvent_H
