...
/*
 * OAIDeployedServiceHealthReportCreatedEvent.h
 *
 * Deployed Service Health Report Created event.
 */

#ifndef OAIDeployedServiceHealthReportCreatedEvent_H
#define OAIDeployedServiceHealthReportCreatedEvent_H
...
class OAIDeployedServiceHealthReportCreatedEvent : public OAIObject {
public:
    OAIDeployedServiceHealthReportCreatedEvent();
    OAIDeployedServiceHealthReportCreatedEvent(QString json);
    ~OAIDeployedServiceHealthReportCreatedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedServiceHealthReportCreatedEvent)

#endif // OAIDeployedServiceHealthReportCreatedEvent_H
