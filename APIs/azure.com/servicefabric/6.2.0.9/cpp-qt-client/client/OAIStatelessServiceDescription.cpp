...
QList<OAIScalingPolicyDescription> OAIStatelessServiceDescription::getScalingPolicies() const {
    return m_scaling_policies;
}
void OAIStatelessServiceDescription::setScalingPolicies(const QList<OAIScalingPolicyDescription> &scaling_policies) {
    m_scaling_policies = scaling_policies;
    m_scaling_policies_isSet = true;
}

bool OAIStatelessServiceDescription::is_scaling_policies_Set() const{
    return m_scaling_policies_isSet;
}

bool OAIStatelessServiceDescription::is_scaling_policies_Valid() const{
