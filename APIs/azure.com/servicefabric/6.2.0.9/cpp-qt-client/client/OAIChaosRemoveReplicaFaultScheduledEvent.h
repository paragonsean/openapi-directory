...
/*
 * OAIChaosRemoveReplicaFaultScheduledEvent.h
 *
 * Chaos Remove Replica Fault Scheduled event.
 */

#ifndef OAIChaosRemoveReplicaFaultScheduledEvent_H
#define OAIChaosRemoveReplicaFaultScheduledEvent_H
...
class OAIChaosRemoveReplicaFaultScheduledEvent : public OAIObject {
public:
    OAIChaosRemoveReplicaFaultScheduledEvent();
    OAIChaosRemoveReplicaFaultScheduledEvent(QString json);
    ~OAIChaosRemoveReplicaFaultScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosRemoveReplicaFaultScheduledEvent)

#endif // OAIChaosRemoveReplicaFaultScheduledEvent_H
