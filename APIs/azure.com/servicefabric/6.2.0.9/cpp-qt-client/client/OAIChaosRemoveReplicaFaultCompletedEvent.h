...
/*
 * OAIChaosRemoveReplicaFaultCompletedEvent.h
 *
 * Chaos Remove Replica Fault Completed event.
 */

#ifndef OAIChaosRemoveReplicaFaultCompletedEvent_H
#define OAIChaosRemoveReplicaFaultCompletedEvent_H
...
class OAIChaosRemoveReplicaFaultCompletedEvent : public OAIObject {
public:
    OAIChaosRemoveReplicaFaultCompletedEvent();
    OAIChaosRemoveReplicaFaultCompletedEvent(QString json);
    ~OAIChaosRemoveReplicaFaultCompletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosRemoveReplicaFaultCompletedEvent)

#endif // OAIChaosRemoveReplicaFaultCompletedEvent_H
