...
public:
    ...
    double getWaitTimeBetweenFautlsInSeconds() const;
    void setWaitTimeBetweenFautlsInSeconds(const double &wait_time_between_fautls_in_seconds);
    bool is_wait_time_between_fautls_in_seconds_Set() const;
    bool is_wait_time_between_fautls_in_seconds_Valid() const;
...
private:
    ...
    double m_wait_time_between_fautls_in_seconds;
    bool m_wait_time_between_fautls_in_seconds_isSet;
    bool m_wait_time_between_fautls_in_seconds_isValid;
