...
/*
 * OAINodeRemovedEvent.h
 *
 * Node Removed event.
 */

#ifndef OAINodeRemovedEvent_H
#define OAINodeRemovedEvent_H
...
class OAINodeRemovedEvent : public OAIObject {
public:
    OAINodeRemovedEvent();
    OAINodeRemovedEvent(QString json);
    ~OAINodeRemovedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeRemovedEvent)

#endif // OAINodeRemovedEvent_H
