...
#ifndef OAIDeployedServiceTypeInfo_H
#define OAIDeployedServiceTypeInfo_H
...
class OAIDeployedServiceTypeInfo : public OAIObject {
public:
    OAIDeployedServiceTypeInfo();
    OAIDeployedServiceTypeInfo(QString json);
    ~OAIDeployedServiceTypeInfo() override;
    ...
    OAIServiceTypeRegistrationStatus getStatus() const;
    void setStatus(const OAIServiceTypeRegistrationStatus &status);
...
private:
    ...
    OAIServiceTypeRegistrationStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedServiceTypeInfo)

#endif // OAIDeployedServiceTypeInfo_H
