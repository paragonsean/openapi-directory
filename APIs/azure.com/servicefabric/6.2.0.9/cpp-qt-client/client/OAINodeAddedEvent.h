...
#ifndef OAINodeAddedEvent_H
#define OAINodeAddedEvent_H
...
class OAINodeAddedEvent : public OAIObject {
public:
    OAINodeAddedEvent();
    OAINodeAddedEvent(QString json);
    ~OAINodeAddedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeAddedEvent)

#endif // OAINodeAddedEvent_H
