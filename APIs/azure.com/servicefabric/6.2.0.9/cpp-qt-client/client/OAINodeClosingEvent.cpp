...
OAINodeClosingEvent::OAINodeClosingEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeClosingEvent::OAINodeClosingEvent() {
    this->initializeModel();
}

OAINodeClosingEvent::~OAINodeClosingEvent() {}

void OAINodeClosingEvent::initializeModel() {
...
void OAINodeClosingEvent::fromJson(QString jsonString) {
...
void OAINodeClosingEvent::fromJsonObject(QJsonObject json) {
...
QString OAINodeClosingEvent::asJson() const {
...
QJsonObject OAINodeClosingEvent::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeClosingEvent::getEventInstanceId() const {
    return m_event_instance_id;
}
void OAINodeClosingEvent::setEventInstanceId(const QString &event_instance_id) {
    m_event_instance_id = event_instance_id;
    m_event_instance_id_isSet = true;
}

bool OAINodeClosingEvent::is_event_instance_id_Set() const{
    return m_event_instance_id_isSet;
}

bool OAINodeClosingEvent::is_event_instance_id_Valid() const{
    return m_event_instance_id_isValid;
}

bool OAINodeClosingEvent::isHasCorrelatedEvents() const {
    return m_has_correlated_events;
}
void OAINodeClosingEvent::setHasCorrelatedEvents(const bool &has_correlated_events) {
    m_has_correlated_events = has_correlated_events;
    m_has_correlated_events_isSet = true;
}

bool OAINodeClosingEvent::is_has_correlated_events_Set() const{
    return m_has_correlated_events_isSet;
}

bool OAINodeClosingEvent::is_has_correlated_events_Valid() const{
    return m_has_correlated_events_isValid;
}

OAIFabricEventKind OAINodeClosingEvent::getKind() const {
    return m_kind;
}
void OAINodeClosingEvent::setKind(const OAIFabricEventKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAINodeClosingEvent::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAINodeClosingEvent::is_kind_Valid() const{
    return m_kind_isValid;
}

QDateTime OAINodeClosingEvent::getTimeStamp() const {
    return m_time_stamp;
}
void OAINodeClosingEvent::setTimeStamp(const QDateTime &time_stamp) {
    m_time_stamp = time_stamp;
    m_time_stamp_isSet = true;
}

bool OAINodeClosingEvent::is_time_stamp_Set() const{
    return m_time_stamp_isSet;
}

bool OAINodeClosingEvent::is_time_stamp_Valid() const{
    return m_time_stamp_isValid;
}

QString OAINodeClosingEvent::getNodeName() const {
    return m_node_name;
}
void OAINodeClosingEvent::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAINodeClosingEvent::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAINodeClosingEvent::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAINodeClosingEvent::getFaultDomain() const {
    return m_fault_domain;
}
void OAINodeClosingEvent::setFaultDomain(const QString &fault_domain) {
    m_fault_domain = fault_domain;
    m_fault_domain_isSet = true;
}

bool OAINodeClosingEvent::is_fault_domain_Set() const{
    return m_fault_domain_isSet;
}

bool OAINodeClosingEvent::is_fault_domain_Valid() const{
    return m_fault_domain_isValid;
}

QString OAINodeClosingEvent::getHostname() const {
    return m_hostname;
}
void OAINodeClosingEvent::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAINodeClosingEvent::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAINodeClosingEvent::is_hostname_Valid() const{
    return m_hostname_isValid;
}

QString OAINodeClosingEvent::getIpAddressOrFqdn() const {
    return m_ip_address_or_fqdn;
}
void OAINodeClosingEvent::setIpAddressOrFqdn(const QString &ip_address_or_fqdn) {
    m_ip_address_or_fqdn = ip_address_or_fqdn;
    m_ip_address_or_fqdn_isSet = true;
}

bool OAINodeClosingEvent::is_ip_address_or_fqdn_Set() const{
    return m_ip_address_or_fqdn_isSet;
}

bool OAINodeClosingEvent::is_ip_address_or_fqdn_Valid() const{
    return m_ip_address_or_fqdn_isValid;
}

bool OAINodeClosingEvent::isIsSeedNode() const {
    return m_is_seed_node;
}
void OAINodeClosingEvent::setIsSeedNode(const bool &is_seed_node) {
    m_is_seed_node = is_seed_node;
    m_is_seed_node_isSet = true;
}

bool OAINodeClosingEvent::is_is_seed_node_Set() const{
    return m_is_seed_node_isSet;
}

bool OAINodeClosingEvent::is_is_seed_node_Valid() const{
    return m_is_seed_node_isValid;
}

QString OAINodeClosingEvent::getNodeId() const {
    return m_node_id;
}
void OAINodeClosingEvent::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAINodeClosingEvent::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAINodeClosingEvent::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint64 OAINodeClosingEvent::getNodeInstance() const {
    return m_node_instance;
}
void OAINodeClosingEvent::setNodeInstance(const qint64 &node_instance) {
    m_node_instance = node_instance;
    m_node_instance_isSet = true;
}

bool OAINodeClosingEvent::is_node_instance_Set() const{
    return m_node_instance_isSet;
}

bool OAINodeClosingEvent::is_node_instance_Valid() const{
    return m_node_instance_isValid;
}

QString OAINodeClosingEvent::getNodeVersion() const {
    return m_node_version;
}
void OAINodeClosingEvent::setNodeVersion(const QString &node_version) {
    m_node_version = node_version;
    m_node_version_isSet = true;
}

bool OAINodeClosingEvent::is_node_version_Set() const{
    return m_node_version_isSet;
}

bool OAINodeClosingEvent::is_node_version_Valid() const{
    return m_node_version_isValid;
}

QString OAINodeClosingEvent::getUpgradeDomain() const {
    return m_upgrade_domain;
}
void OAINodeClosingEvent::setUpgradeDomain(const QString &upgrade_domain) {
    m_upgrade_domain = upgrade_domain;
    m_upgrade_domain_isSet = true;
}

bool OAINodeClosingEvent::is_upgrade_domain_Set() const{
    return m_upgrade_domain_isSet;
}

bool OAINodeClosingEvent::is_upgrade_domain_Valid() const{
    return m_upgrade_domain_isValid;
}

bool OAINodeClosingEvent::isSet() const {
...
bool OAINodeClosingEvent::isValid() const {
