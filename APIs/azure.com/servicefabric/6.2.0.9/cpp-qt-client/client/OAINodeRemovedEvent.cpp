...
OAINodeRemovedEvent::OAINodeRemovedEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeRemovedEvent::OAINodeRemovedEvent() {
    this->initializeModel();
}

OAINodeRemovedEvent::~OAINodeRemovedEvent() {}

void OAINodeRemovedEvent::initializeModel() {
...
void OAINodeRemovedEvent::fromJson(QString jsonString) {
...
void OAINodeRemovedEvent::fromJsonObject(QJsonObject json) {
...
QString OAINodeRemovedEvent::asJson() const {
...
QJsonObject OAINodeRemovedEvent::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeRemovedEvent::getEventInstanceId() const {
    return m_event_instance_id;
}
void OAINodeRemovedEvent::setEventInstanceId(const QString &event_instance_id) {
    m_event_instance_id = event_instance_id;
    m_event_instance_id_isSet = true;
}

bool OAINodeRemovedEvent::is_event_instance_id_Set() const{
    return m_event_instance_id_isSet;
}

bool OAINodeRemovedEvent::is_event_instance_id_Valid() const{
    return m_event_instance_id_isValid;
}

bool OAINodeRemovedEvent::isHasCorrelatedEvents() const {
    return m_has_correlated_events;
}
void OAINodeRemovedEvent::setHasCorrelatedEvents(const bool &has_correlated_events) {
    m_has_correlated_events = has_correlated_events;
    m_has_correlated_events_isSet = true;
}

bool OAINodeRemovedEvent::is_has_correlated_events_Set() const{
    return m_has_correlated_events_isSet;
}

bool OAINodeRemovedEvent::is_has_correlated_events_Valid() const{
    return m_has_correlated_events_isValid;
}

OAIFabricEventKind OAINodeRemovedEvent::getKind() const {
    return m_kind;
}
void OAINodeRemovedEvent::setKind(const OAIFabricEventKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAINodeRemovedEvent::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAINodeRemovedEvent::is_kind_Valid() const{
    return m_kind_isValid;
}

QDateTime OAINodeRemovedEvent::getTimeStamp() const {
    return m_time_stamp;
}
void OAINodeRemovedEvent::setTimeStamp(const QDateTime &time_stamp) {
    m_time_stamp = time_stamp;
    m_time_stamp_isSet = true;
}

bool OAINodeRemovedEvent::is_time_stamp_Set() const{
    return m_time_stamp_isSet;
}

bool OAINodeRemovedEvent::is_time_stamp_Valid() const{
    return m_time_stamp_isValid;
}

QString OAINodeRemovedEvent::getNodeName() const {
    return m_node_name;
}
void OAINodeRemovedEvent::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAINodeRemovedEvent::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAINodeRemovedEvent::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAINodeRemovedEvent::getFabricVersion() const {
    return m_fabric_version;
}
void OAINodeRemovedEvent::setFabricVersion(const QString &fabric_version) {
    m_fabric_version = fabric_version;
    m_fabric_version_isSet = true;
}

bool OAINodeRemovedEvent::is_fabric_version_Set() const{
    return m_fabric_version_isSet;
}

bool OAINodeRemovedEvent::is_fabric_version_Valid() const{
    return m_fabric_version_isValid;
}

QString OAINodeRemovedEvent::getIpAddressOrFqdn() const {
    return m_ip_address_or_fqdn;
}
void OAINodeRemovedEvent::setIpAddressOrFqdn(const QString &ip_address_or_fqdn) {
    m_ip_address_or_fqdn = ip_address_or_fqdn;
    m_ip_address_or_fqdn_isSet = true;
}

bool OAINodeRemovedEvent::is_ip_address_or_fqdn_Set() const{
    return m_ip_address_or_fqdn_isSet;
}

bool OAINodeRemovedEvent::is_ip_address_or_fqdn_Valid() const{
    return m_ip_address_or_fqdn_isValid;
}

QString OAINodeRemovedEvent::getNodeCapacities() const {
    return m_node_capacities;
}
void OAINodeRemovedEvent::setNodeCapacities(const QString &node_capacities) {
    m_node_capacities = node_capacities;
    m_node_capacities_isSet = true;
}

bool OAINodeRemovedEvent::is_node_capacities_Set() const{
    return m_node_capacities_isSet;
}

bool OAINodeRemovedEvent::is_node_capacities_Valid() const{
    return m_node_capacities_isValid;
}

QString OAINodeRemovedEvent::getNodeId() const {
    return m_node_id;
}
void OAINodeRemovedEvent::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAINodeRemovedEvent::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAINodeRemovedEvent::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint64 OAINodeRemovedEvent::getNodeInstance() const {
    return m_node_instance;
}
void OAINodeRemovedEvent::setNodeInstance(const qint64 &node_instance) {
    m_node_instance = node_instance;
    m_node_instance_isSet = true;
}

bool OAINodeRemovedEvent::is_node_instance_Set() const{
    return m_node_instance_isSet;
}

bool OAINodeRemovedEvent::is_node_instance_Valid() const{
    return m_node_instance_isValid;
}

QString OAINodeRemovedEvent::getNodeType() const {
    return m_node_type;
}
void OAINodeRemovedEvent::setNodeType(const QString &node_type) {
    m_node_type = node_type;
    m_node_type_isSet = true;
}

bool OAINodeRemovedEvent::is_node_type_Set() const{
    return m_node_type_isSet;
}

bool OAINodeRemovedEvent::is_node_type_Valid() const{
    return m_node_type_isValid;
}

bool OAINodeRemovedEvent::isSet() const {
...
bool OAINodeRemovedEvent::isValid() const {
