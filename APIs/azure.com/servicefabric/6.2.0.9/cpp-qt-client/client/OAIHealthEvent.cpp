...
QDateTime OAIHealthEvent::getLastErrorTransitionAt() const {
    return m_last_error_transition_at;
}
void OAIHealthEvent::setLastErrorTransitionAt(const QDateTime &last_error_transition_at) {
...
QDateTime OAIHealthEvent::getLastModifiedUtcTimestamp() const {
    return m_last_modified_utc_timestamp;
}
void OAIHealthEvent::setLastModifiedUtcTimestamp(const QDateTime &last_modified_utc_timestamp) {
...
QDateTime OAIHealthEvent::getLastOkTransitionAt() const {
    return m_last_ok_transition_at;
}
void OAIHealthEvent::setLastOkTransitionAt(const QDateTime &last_ok_transition_at) {
...
QDateTime OAIHealthEvent::getLastWarningTransitionAt() const {
    return m_last_warning_transition_at;
}
void OAIHealthEvent::setLastWarningTransitionAt(const QDateTime &last_warning_transition_at) {
...
QDateTime OAIHealthEvent::getSourceUtcTimestamp() const {
    return m_source_utc_timestamp;
}
void OAIHealthEvent::setSourceUtcTimestamp(const QDateTime &source_utc_timestamp) {
