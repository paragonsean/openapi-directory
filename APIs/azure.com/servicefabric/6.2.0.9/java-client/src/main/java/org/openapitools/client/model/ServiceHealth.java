...
import org.openapitools.client.model.PartitionHealthState;
...
public class ServiceHealth {
  ...
  public static final String SERIALIZED_NAME_PARTITION_HEALTH_STATES = "PartitionHealthStates";
  @SerializedName(SERIALIZED_NAME_PARTITION_HEALTH_STATES)
  private List<PartitionHealthState> partitionHealthStates = new ArrayList<>();

  public ServiceHealth() {
  }

  public ServiceHealth aggregatedHealthState(HealthState aggregatedHealthState) {
  ...
  public ServiceHealth healthEvents(List<HealthEvent> healthEvents) {
    this.healthEvents = healthEvents;
    return this;
  }

  public ServiceHealth addHealthEventsItem(HealthEvent healthEventsItem) {
  ...
  public ServiceHealth healthStatistics(HealthStatistics healthStatistics) {
  ...
  public ServiceHealth unhealthyEvaluations(List<HealthEvaluationWrapper> unhealthyEvaluations) {
    this.unhealthyEvaluations = unhealthyEvaluations;
    return this;
  }

  public ServiceHealth addUnhealthyEvaluationsItem(HealthEvaluationWrapper unhealthyEvaluationsItem) {
  ...
  public ServiceHealth name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ServiceHealth partitionHealthStates(List<PartitionHealthState> partitionHealthStates) {
    this.partitionHealthStates = partitionHealthStates;
    return this;
  }

  public ServiceHealth addPartitionHealthStatesItem(PartitionHealthState partitionHealthStatesItem) {
    if (this.partitionHealthStates == null) {
      this.partitionHealthStates = new ArrayList<>();
    }
    this.partitionHealthStates.add(partitionHealthStatesItem);
    return this;
  }

  /**
   * The list of partition health states associated with the service.
   * @return partitionHealthStates
   */
  @javax.annotation.Nullable
  ...
  public void setPartitionHealthStates(List<PartitionHealthState> partitionHealthStates) {
    this.partitionHealthStates = partitionHealthStates;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aggregatedHealthState, serviceHealth.aggregatedHealthState) &&
        Objects.equals(this.healthEvents, serviceHealth.healthEvents) &&
        Objects.equals(this.healthStatistics, serviceHealth.healthStatistics) &&
        Objects.equals(this.unhealthyEvaluations, serviceHealth.unhealthyEvaluations) &&
        Objects.equals(this.name, serviceHealth.name) &&
        Objects.equals(this.partitionHealthStates, serviceHealth.partitionHealthStates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aggregatedHealthState, healthEvents, healthStatistics, unhealthyEvaluations, name, partitionHealthStates);
  }
  ...
  public String toString() {
    ...
    sb.append("    partitionHealthStates: ").append(toIndentedString(partitionHealthStates)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("PartitionHealthStates");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("PartitionHealthStates") != null && !jsonObj.get("PartitionHealthStates").isJsonNull()) {
        JsonArray jsonArraypartitionHealthStates = jsonObj.getAsJsonArray("PartitionHealthStates");
        if (jsonArraypartitionHealthStates != null) {
          // ensure the json data is an array
          if (!jsonObj.get("PartitionHealthStates").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `PartitionHealthStates` to be an array in the JSON string but got `%s`", jsonObj.get("PartitionHealthStates").toString()));
          }

          // validate the optional field `PartitionHealthStates` (array)
          for (int i = 0; i < jsonArraypartitionHealthStates.size(); i++) {
            PartitionHealthState.validateJsonElement(jsonArraypartitionHealthStates.get(i));
          };
        }
      }
  }
