...
public class BackupRestoreApi {
     ...
     */
    public okhttp3.Call disableApplicationBackupCall(String applicationId, String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call disableApplicationBackupValidateBeforeCall(String applicationId, String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        ...
        return disableApplicationBackupCall(applicationId, apiVersion, timeout, _callback);
     ...
     */
    public void disableApplicationBackup(String applicationId, String apiVersion, Long timeout) throws ApiException {
        disableApplicationBackupWithHttpInfo(applicationId, apiVersion, timeout);
    }
     ...
     */
    public ApiResponse<Void> disableApplicationBackupWithHttpInfo(String applicationId, String apiVersion, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = disableApplicationBackupValidateBeforeCall(applicationId, apiVersion, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call disableApplicationBackupAsync(String applicationId, String apiVersion, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = disableApplicationBackupValidateBeforeCall(applicationId, apiVersion, timeout, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call disablePartitionBackupCall(UUID partitionId, String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call disablePartitionBackupValidateBeforeCall(UUID partitionId, String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'partitionId' is set
        if (partitionId == null) {
        ...
        return disablePartitionBackupCall(partitionId, apiVersion, timeout, _callback);
     ...
     */
    public void disablePartitionBackup(UUID partitionId, String apiVersion, Long timeout) throws ApiException {
        disablePartitionBackupWithHttpInfo(partitionId, apiVersion, timeout);
    }
     ...
     */
    public ApiResponse<Void> disablePartitionBackupWithHttpInfo(UUID partitionId, String apiVersion, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = disablePartitionBackupValidateBeforeCall(partitionId, apiVersion, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call disablePartitionBackupAsync(UUID partitionId, String apiVersion, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = disablePartitionBackupValidateBeforeCall(partitionId, apiVersion, timeout, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call disableServiceBackupCall(String serviceId, String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call disableServiceBackupValidateBeforeCall(String serviceId, String apiVersion, Long timeout, final ApiCallback _callback) throws ApiException {
        ...
        return disableServiceBackupCall(serviceId, apiVersion, timeout, _callback);
     ...
     */
    public void disableServiceBackup(String serviceId, String apiVersion, Long timeout) throws ApiException {
        disableServiceBackupWithHttpInfo(serviceId, apiVersion, timeout);
    }
     ...
     */
    public ApiResponse<Void> disableServiceBackupWithHttpInfo(String serviceId, String apiVersion, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = disableServiceBackupValidateBeforeCall(serviceId, apiVersion, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call disableServiceBackupAsync(String serviceId, String apiVersion, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = disableServiceBackupValidateBeforeCall(serviceId, apiVersion, timeout, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
