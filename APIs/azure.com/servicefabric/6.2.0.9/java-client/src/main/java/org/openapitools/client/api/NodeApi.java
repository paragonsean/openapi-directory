...
public class NodeApi {
    ...
    /**
     * Activate a Service Fabric cluster node which is currently deactivated. (asynchronously)
     * Activates a Service Fabric cluster node which is currently deactivated. Once activated, the node will again become a viable target for placing new replicas, and any deactivated replicas remaining on the node will be reactivated.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param nodeName The name of the node. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     ...
     */
    public okhttp3.Call getNodeInfoListCall(String apiVersion, String continuationToken, String nodeStatusFilter, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNodeInfoListValidateBeforeCall(String apiVersion, String continuationToken, String nodeStatusFilter, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getNodeInfoList(Async)");
        }

        return getNodeInfoListCall(apiVersion, continuationToken, nodeStatusFilter, timeout, _callback);
     ...
     */
    public PagedNodeInfoList getNodeInfoList(String apiVersion, String continuationToken, String nodeStatusFilter, Long timeout) throws ApiException {
        ApiResponse<PagedNodeInfoList> localVarResp = getNodeInfoListWithHttpInfo(apiVersion, continuationToken, nodeStatusFilter, timeout);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedNodeInfoList> getNodeInfoListWithHttpInfo(String apiVersion, String continuationToken, String nodeStatusFilter, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = getNodeInfoListValidateBeforeCall(apiVersion, continuationToken, nodeStatusFilter, timeout, null);
     ...
     */
    public okhttp3.Call getNodeInfoListAsync(String apiVersion, String continuationToken, String nodeStatusFilter, Long timeout, final ApiCallback<PagedNodeInfoList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNodeInfoListValidateBeforeCall(apiVersion, continuationToken, nodeStatusFilter, timeout, _callback);
        Type localVarReturnType = new TypeToken<PagedNodeInfoList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
