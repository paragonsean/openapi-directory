...
/**
 * The ServiceHealthReportCreatedEvent model module.
 * @module model/ServiceHealthReportCreatedEvent
 * @version 6.2.0.9
 */
class ServiceHealthReportCreatedEvent {
    /**
     * Constructs a new <code>ServiceHealthReportCreatedEvent</code>.
     * Service Health Report Created event.
     * @alias module:model/ServiceHealthReportCreatedEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, serviceId, description, healthState, instanceId, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ...
        ServiceHealthReportCreatedEvent.initialize(this, eventInstanceId, kind, timeStamp, serviceId, description, healthState, instanceId, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
    ...
    /**
     * Constructs a <code>ServiceHealthReportCreatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceHealthReportCreatedEvent} obj Optional instance to populate.
     * @return {module:model/ServiceHealthReportCreatedEvent} The populated <code>ServiceHealthReportCreatedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceHealthReportCreatedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceHealthReportCreatedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceHealthReportCreatedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServiceHealthReportCreatedEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
ServiceHealthReportCreatedEvent.RequiredProperties = ["Description", "HealthState", "InstanceId", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp", "ServiceId"];

/**
 * Description of report.
 * @member {String} Description
 */
ServiceHealthReportCreatedEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
ServiceHealthReportCreatedEvent.prototype['HealthState'] = undefined;

/**
 * Id of Service instance.
 * @member {Number} InstanceId
 */
ServiceHealthReportCreatedEvent.prototype['InstanceId'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
ServiceHealthReportCreatedEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
ServiceHealthReportCreatedEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
ServiceHealthReportCreatedEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
ServiceHealthReportCreatedEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
ServiceHealthReportCreatedEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
ServiceHealthReportCreatedEvent.prototype['TimeToLiveMs'] = undefined;
...
export default ServiceHealthReportCreatedEvent;
