...
/**
 * The StatelessReplicaHealthReportCreatedEvent model module.
 * @module model/StatelessReplicaHealthReportCreatedEvent
 * @version 6.2.0.9
 */
class StatelessReplicaHealthReportCreatedEvent {
    /**
     * Constructs a new <code>StatelessReplicaHealthReportCreatedEvent</code>.
     * Stateless Replica Health Report Created event.
     * @alias module:model/StatelessReplicaHealthReportCreatedEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, partitionId, replicaId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ...
        StatelessReplicaHealthReportCreatedEvent.initialize(this, eventInstanceId, kind, timeStamp, partitionId, replicaId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
    ...
    /**
     * Constructs a <code>StatelessReplicaHealthReportCreatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatelessReplicaHealthReportCreatedEvent} obj Optional instance to populate.
     * @return {module:model/StatelessReplicaHealthReportCreatedEvent} The populated <code>StatelessReplicaHealthReportCreatedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatelessReplicaHealthReportCreatedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>StatelessReplicaHealthReportCreatedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatelessReplicaHealthReportCreatedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatelessReplicaHealthReportCreatedEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
StatelessReplicaHealthReportCreatedEvent.RequiredProperties = ["Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp", "PartitionId", "ReplicaId"];

/**
 * Description of report.
 * @member {String} Description
 */
StatelessReplicaHealthReportCreatedEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
StatelessReplicaHealthReportCreatedEvent.prototype['HealthState'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
StatelessReplicaHealthReportCreatedEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
StatelessReplicaHealthReportCreatedEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
StatelessReplicaHealthReportCreatedEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
StatelessReplicaHealthReportCreatedEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
StatelessReplicaHealthReportCreatedEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
StatelessReplicaHealthReportCreatedEvent.prototype['TimeToLiveMs'] = undefined;
...
export default StatelessReplicaHealthReportCreatedEvent;
