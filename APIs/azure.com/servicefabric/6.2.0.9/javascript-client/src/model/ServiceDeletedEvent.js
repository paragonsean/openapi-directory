...
class ServiceDeletedEvent {
     ...
     */
    constructor(eventInstanceId, kind, timeStamp, serviceId, applicationName, applicationTypeName, isStateful, minReplicaSetSize, partitionCount, serviceInstance, servicePackageVersion, serviceTypeName, targetReplicaSetSize) { 
        ServiceEvent.initialize(this, eventInstanceId, kind, timeStamp, serviceId);
        ServiceDeletedEvent.initialize(this, eventInstanceId, kind, timeStamp, serviceId, applicationName, applicationTypeName, isStateful, minReplicaSetSize, partitionCount, serviceInstance, servicePackageVersion, serviceTypeName, targetReplicaSetSize);
    }
     ...
     */
    static initialize(obj, eventInstanceId, kind, timeStamp, serviceId, applicationName, applicationTypeName, isStateful, minReplicaSetSize, partitionCount, serviceInstance, servicePackageVersion, serviceTypeName, targetReplicaSetSize) { 
...
ServiceDeletedEvent.RequiredProperties = ["ApplicationName", "ApplicationTypeName", "IsStateful", "MinReplicaSetSize", "PartitionCount", "ServiceInstance", "ServicePackageVersion", "ServiceTypeName", "TargetReplicaSetSize", "EventInstanceId", "Kind", "TimeStamp", "ServiceId"];
