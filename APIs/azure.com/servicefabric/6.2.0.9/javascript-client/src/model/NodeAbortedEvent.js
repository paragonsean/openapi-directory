...
/**
 * The NodeAbortedEvent model module.
 * @module model/NodeAbortedEvent
 * @version 6.2.0.9
 */
class NodeAbortedEvent {
    /**
     * Constructs a new <code>NodeAbortedEvent</code>.
     * Node Aborted event.
     * @alias module:model/NodeAbortedEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain) { 
        ...
        NodeAbortedEvent.initialize(this, eventInstanceId, kind, timeStamp, nodeName, faultDomain, hostname, ipAddressOrFQDN, isSeedNode, nodeId, nodeInstance, nodeVersion, upgradeDomain);
    }
    ...
    /**
     * Constructs a <code>NodeAbortedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeAbortedEvent} obj Optional instance to populate.
     * @return {module:model/NodeAbortedEvent} The populated <code>NodeAbortedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeAbortedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeAbortedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeAbortedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeAbortedEvent.RequiredProperties) {
...
NodeAbortedEvent.RequiredProperties = ["FaultDomain", "Hostname", "IpAddressOrFQDN", "IsSeedNode", "NodeId", "NodeInstance", "NodeVersion", "UpgradeDomain", "EventInstanceId", "Kind", "TimeStamp", "NodeName"];

/**
 * Fault domain of Node.
 * @member {String} FaultDomain
 */
NodeAbortedEvent.prototype['FaultDomain'] = undefined;

/**
 * Name of Host.
 * @member {String} Hostname
 */
NodeAbortedEvent.prototype['Hostname'] = undefined;

/**
 * IP address or FQDN.
 * @member {String} IpAddressOrFQDN
 */
NodeAbortedEvent.prototype['IpAddressOrFQDN'] = undefined;

/**
 * Indicates if it is seed node.
 * @member {Boolean} IsSeedNode
 */
NodeAbortedEvent.prototype['IsSeedNode'] = undefined;

/**
 * Id of Node.
 * @member {String} NodeId
 */
NodeAbortedEvent.prototype['NodeId'] = undefined;

/**
 * Id of Node instance.
 * @member {Number} NodeInstance
 */
NodeAbortedEvent.prototype['NodeInstance'] = undefined;

/**
 * Version of Node.
 * @member {String} NodeVersion
 */
NodeAbortedEvent.prototype['NodeVersion'] = undefined;

/**
 * Upgrade domain of Node.
 * @member {String} UpgradeDomain
 */
NodeAbortedEvent.prototype['UpgradeDomain'] = undefined;
...
export default NodeAbortedEvent;
