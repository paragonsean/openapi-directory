...
/**
 * The ClusterHealthReportCreatedEvent model module.
 * @module model/ClusterHealthReportCreatedEvent
 * @version 6.2.0.9
 */
class ClusterHealthReportCreatedEvent {
    /**
     * Constructs a new <code>ClusterHealthReportCreatedEvent</code>.
     * Cluster Health Report Created event.
     * @alias module:model/ClusterHealthReportCreatedEvent
    ...
    constructor(eventInstanceId, kind, timeStamp, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ...
        ClusterHealthReportCreatedEvent.initialize(this, eventInstanceId, kind, timeStamp, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
    ...
    /**
     * Constructs a <code>ClusterHealthReportCreatedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClusterHealthReportCreatedEvent} obj Optional instance to populate.
     * @return {module:model/ClusterHealthReportCreatedEvent} The populated <code>ClusterHealthReportCreatedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClusterHealthReportCreatedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterHealthReportCreatedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterHealthReportCreatedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClusterHealthReportCreatedEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
ClusterHealthReportCreatedEvent.RequiredProperties = ["Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp"];

/**
 * Description of report.
 * @member {String} Description
 */
ClusterHealthReportCreatedEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
ClusterHealthReportCreatedEvent.prototype['HealthState'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
ClusterHealthReportCreatedEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
ClusterHealthReportCreatedEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
ClusterHealthReportCreatedEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
ClusterHealthReportCreatedEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
ClusterHealthReportCreatedEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
ClusterHealthReportCreatedEvent.prototype['TimeToLiveMs'] = undefined;
...
export default ClusterHealthReportCreatedEvent;
