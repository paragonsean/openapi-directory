...
class NodeHealthReportExpiredEvent {
    ...
    constructor(eventInstanceId, kind, timeStamp, nodeName, description, healthState, nodeInstanceId, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ...
        NodeHealthReportExpiredEvent.initialize(this, eventInstanceId, kind, timeStamp, nodeName, description, healthState, nodeInstanceId, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
...
NodeHealthReportExpiredEvent.RequiredProperties = ["Description", "HealthState", "NodeInstanceId", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp", "NodeName"];
