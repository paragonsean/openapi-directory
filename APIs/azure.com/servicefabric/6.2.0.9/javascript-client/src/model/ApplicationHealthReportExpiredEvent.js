...
/**
 * The ApplicationHealthReportExpiredEvent model module.
 * @module model/ApplicationHealthReportExpiredEvent
 * @version 6.2.0.9
 */
class ApplicationHealthReportExpiredEvent {
    /**
     * Constructs a new <code>ApplicationHealthReportExpiredEvent</code>.
     * Application Health Report Expired event.
     * @alias module:model/ApplicationHealthReportExpiredEvent
     ...
     */
    constructor(eventInstanceId, kind, timeStamp, applicationId, applicationInstanceId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
        ApplicationEvent.initialize(this, eventInstanceId, kind, timeStamp, applicationId);
        ApplicationHealthReportExpiredEvent.initialize(this, eventInstanceId, kind, timeStamp, applicationId, applicationInstanceId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs);
    }
     ...
     */
    static initialize(obj, eventInstanceId, kind, timeStamp, applicationId, applicationInstanceId, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, sourceUtcTimestamp, timeToLiveMs) { 
    ...
    /**
     * Constructs a <code>ApplicationHealthReportExpiredEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationHealthReportExpiredEvent} obj Optional instance to populate.
     * @return {module:model/ApplicationHealthReportExpiredEvent} The populated <code>ApplicationHealthReportExpiredEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationHealthReportExpiredEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationHealthReportExpiredEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationHealthReportExpiredEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationHealthReportExpiredEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
ApplicationHealthReportExpiredEvent.RequiredProperties = ["ApplicationInstanceId", "Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "EventInstanceId", "Kind", "TimeStamp", "ApplicationId"];

/**
 * Id of Application instance.
 * @member {Number} ApplicationInstanceId
 */
ApplicationHealthReportExpiredEvent.prototype['ApplicationInstanceId'] = undefined;

/**
 * Description of report.
 * @member {String} Description
 */
ApplicationHealthReportExpiredEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
ApplicationHealthReportExpiredEvent.prototype['HealthState'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
ApplicationHealthReportExpiredEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
ApplicationHealthReportExpiredEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
ApplicationHealthReportExpiredEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
ApplicationHealthReportExpiredEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
ApplicationHealthReportExpiredEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
ApplicationHealthReportExpiredEvent.prototype['TimeToLiveMs'] = undefined;
...
export default ApplicationHealthReportExpiredEvent;
