...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.StartClusterUpgradeDescription();
  });
  ...
  describe('StartClusterUpgradeDescription', function() {
    it('should create an instance of StartClusterUpgradeDescription', function() {
      // uncomment below and update the code to test StartClusterUpgradeDescription
      //var instance = new ServiceFabricClientApis.StartClusterUpgradeDescription();
      //expect(instance).to.be.a(ServiceFabricClientApis.StartClusterUpgradeDescription);
    });
