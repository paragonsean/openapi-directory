...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.NodeOpeningEvent();
  });
  ...
  describe('NodeOpeningEvent', function() {
    it('should create an instance of NodeOpeningEvent', function() {
      // uncomment below and update the code to test NodeOpeningEvent
      //var instance = new ServiceFabricClientApis.NodeOpeningEvent();
      //expect(instance).to.be.a(ServiceFabricClientApis.NodeOpeningEvent);
    });
