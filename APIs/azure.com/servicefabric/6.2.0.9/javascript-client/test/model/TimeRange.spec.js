...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.TimeRange();
  });
  ...
  describe('TimeRange', function() {
    it('should create an instance of TimeRange', function() {
      ...
      //var instance = new ServiceFabricClientApis.TimeRange();
      //expect(instance).to.be.a(ServiceFabricClientApis.TimeRange);
    });
