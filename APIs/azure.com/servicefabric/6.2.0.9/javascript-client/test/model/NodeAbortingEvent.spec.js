...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.NodeAbortingEvent();
  });
  ...
  describe('NodeAbortingEvent', function() {
    it('should create an instance of NodeAbortingEvent', function() {
      // uncomment below and update the code to test NodeAbortingEvent
      //var instance = new ServiceFabricClientApis.NodeAbortingEvent();
      //expect(instance).to.be.a(ServiceFabricClientApis.NodeAbortingEvent);
    });
