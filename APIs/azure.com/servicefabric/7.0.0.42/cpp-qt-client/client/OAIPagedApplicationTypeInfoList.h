...
/*
 * OAIPagedApplicationTypeInfoList.h
 *
...
#ifndef OAIPagedApplicationTypeInfoList_H
#define OAIPagedApplicationTypeInfoList_H
...
namespace OpenAPI {
class OAIApplicationTypeInfo;

class OAIPagedApplicationTypeInfoList : public OAIObject {
public:
    OAIPagedApplicationTypeInfoList();
    OAIPagedApplicationTypeInfoList(QString json);
    ~OAIPagedApplicationTypeInfoList() override;
    ...
    QList<OAIApplicationTypeInfo> getItems() const;
    void setItems(const QList<OAIApplicationTypeInfo> &items);
...
private:
    ...
    QList<OAIApplicationTypeInfo> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagedApplicationTypeInfoList)

#endif // OAIPagedApplicationTypeInfoList_H
