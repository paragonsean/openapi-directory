...
/*
 * OAIChaosReplicaRemovalScheduledEvent.h
 *
 * Chaos Remove Replica Fault Scheduled event.
 */

#ifndef OAIChaosReplicaRemovalScheduledEvent_H
#define OAIChaosReplicaRemovalScheduledEvent_H
...
class OAIChaosReplicaRemovalScheduledEvent : public OAIObject {
public:
    OAIChaosReplicaRemovalScheduledEvent();
    OAIChaosReplicaRemovalScheduledEvent(QString json);
    ~OAIChaosReplicaRemovalScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosReplicaRemovalScheduledEvent)

#endif // OAIChaosReplicaRemovalScheduledEvent_H
