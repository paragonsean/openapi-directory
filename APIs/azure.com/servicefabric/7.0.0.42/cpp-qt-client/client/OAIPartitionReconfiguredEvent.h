...
/*
 * OAIPartitionReconfiguredEvent.h
 *
 * Partition Reconfiguration event.
 */

#ifndef OAIPartitionReconfiguredEvent_H
#define OAIPartitionReconfiguredEvent_H
...
class OAIPartitionReconfiguredEvent : public OAIObject {
public:
    OAIPartitionReconfiguredEvent();
    OAIPartitionReconfiguredEvent(QString json);
    ~OAIPartitionReconfiguredEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionReconfiguredEvent)

#endif // OAIPartitionReconfiguredEvent_H
