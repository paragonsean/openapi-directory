...
/*
 * OAIContainerInstanceEvent.h
 *
 * Represents the base for all Container Events.
 */

#ifndef OAIContainerInstanceEvent_H
#define OAIContainerInstanceEvent_H
...
class OAIContainerInstanceEvent : public OAIObject {
public:
    OAIContainerInstanceEvent();
    OAIContainerInstanceEvent(QString json);
    ~OAIContainerInstanceEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainerInstanceEvent)

#endif // OAIContainerInstanceEvent_H
