...
/*
 * OAIPartitionHealthReportExpiredEvent.h
 *
 * Partition Health Report Expired event.
 */

#ifndef OAIPartitionHealthReportExpiredEvent_H
#define OAIPartitionHealthReportExpiredEvent_H
...
class OAIPartitionHealthReportExpiredEvent : public OAIObject {
public:
    OAIPartitionHealthReportExpiredEvent();
    OAIPartitionHealthReportExpiredEvent(QString json);
    ~OAIPartitionHealthReportExpiredEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionHealthReportExpiredEvent)

#endif // OAIPartitionHealthReportExpiredEvent_H
