...
qint64 OAIStartClusterUpgradeDescription::getInstanceCloseDelayDurationInSeconds() const {
    return m_instance_close_delay_duration_in_seconds;
}
void OAIStartClusterUpgradeDescription::setInstanceCloseDelayDurationInSeconds(const qint64 &instance_close_delay_duration_in_seconds) {
...
bool OAIStartClusterUpgradeDescription::is_instance_close_delay_duration_in_seconds_Set() const{
    return m_instance_close_delay_duration_in_seconds_isSet;
}

bool OAIStartClusterUpgradeDescription::is_instance_close_delay_duration_in_seconds_Valid() const{
...
OAIUpgradeSortOrder OAIStartClusterUpgradeDescription::getSortOrder() const {
    return m_sort_order;
}
void OAIStartClusterUpgradeDescription::setSortOrder(const OAIUpgradeSortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIStartClusterUpgradeDescription::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIStartClusterUpgradeDescription::is_sort_order_Valid() const{
