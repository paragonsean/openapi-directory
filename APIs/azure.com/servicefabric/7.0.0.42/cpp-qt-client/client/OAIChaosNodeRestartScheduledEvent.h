...
/*
 * OAIChaosNodeRestartScheduledEvent.h
 *
 * Chaos Restart Node Fault Scheduled event.
 */

#ifndef OAIChaosNodeRestartScheduledEvent_H
#define OAIChaosNodeRestartScheduledEvent_H
...
class OAIChaosNodeRestartScheduledEvent : public OAIObject {
public:
    OAIChaosNodeRestartScheduledEvent();
    OAIChaosNodeRestartScheduledEvent(QString json);
    ~OAIChaosNodeRestartScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosNodeRestartScheduledEvent)

#endif // OAIChaosNodeRestartScheduledEvent_H
