...
public:
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getClusterLoad(const QString &api_version, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getClusterVersion(const QString &api_version, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void toggleVerboseServicePlacementHealthReporting(const QString &api_version, const bool &enabled, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
private:
    ...
    void getClusterLoadCallback(OAIHttpRequestWorker *worker);
    ...
    void getClusterVersionCallback(OAIHttpRequestWorker *worker);
    ...
    void toggleVerboseServicePlacementHealthReportingCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void getClusterLoadSignal(OAIClusterLoadInfo summary);
    ...
    void getClusterVersionSignal(OAIClusterVersion summary);
    ...
    void toggleVerboseServicePlacementHealthReportingSignal();
    ...
    void getClusterLoadSignalFull(OAIHttpRequestWorker *worker, OAIClusterLoadInfo summary);
    ...
    void getClusterVersionSignalFull(OAIHttpRequestWorker *worker, OAIClusterVersion summary);
    ...
    void toggleVerboseServicePlacementHealthReportingSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use getClusterLoadSignalError() instead")
    void getClusterLoadSignalE(OAIClusterLoadInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getClusterLoadSignalError(OAIClusterLoadInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getClusterVersionSignalError() instead")
    void getClusterVersionSignalE(OAIClusterVersion summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getClusterVersionSignalError(OAIClusterVersion summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use toggleVerboseServicePlacementHealthReportingSignalError() instead")
    void toggleVerboseServicePlacementHealthReportingSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void toggleVerboseServicePlacementHealthReportingSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getClusterLoadSignalErrorFull() instead")
    void getClusterLoadSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getClusterLoadSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getClusterVersionSignalErrorFull() instead")
    void getClusterVersionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getClusterVersionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use toggleVerboseServicePlacementHealthReportingSignalErrorFull() instead")
    void toggleVerboseServicePlacementHealthReportingSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void toggleVerboseServicePlacementHealthReportingSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
