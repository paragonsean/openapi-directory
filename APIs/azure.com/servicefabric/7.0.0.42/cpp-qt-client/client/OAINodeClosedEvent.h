...
/*
 * OAINodeClosedEvent.h
 *
 * Node Closed event.
 */

#ifndef OAINodeClosedEvent_H
#define OAINodeClosedEvent_H
...
class OAINodeClosedEvent : public OAIObject {
public:
    OAINodeClosedEvent();
    OAINodeClosedEvent(QString json);
    ~OAINodeClosedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeClosedEvent)

#endif // OAINodeClosedEvent_H
