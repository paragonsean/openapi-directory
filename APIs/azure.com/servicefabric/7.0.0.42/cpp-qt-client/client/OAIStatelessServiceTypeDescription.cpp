...
QList<OAIServiceLoadMetricDescription> OAIStatelessServiceTypeDescription::getLoadMetrics() const {
    return m_load_metrics;
}
void OAIStatelessServiceTypeDescription::setLoadMetrics(const QList<OAIServiceLoadMetricDescription> &load_metrics) {
    m_load_metrics = load_metrics;
    m_load_metrics_isSet = true;
}

bool OAIStatelessServiceTypeDescription::is_load_metrics_Set() const{
    return m_load_metrics_isSet;
}

bool OAIStatelessServiceTypeDescription::is_load_metrics_Valid() const{
