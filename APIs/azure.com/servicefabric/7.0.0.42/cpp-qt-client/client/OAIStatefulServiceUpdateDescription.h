...
public:
    ...
    QString getServicePlacementTimeLimitSeconds() const;
    void setServicePlacementTimeLimitSeconds(const QString &service_placement_time_limit_seconds);
...
private:
    ...
    QString m_service_placement_time_limit_seconds;
