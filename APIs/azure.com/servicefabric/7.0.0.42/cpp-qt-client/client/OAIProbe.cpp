...
OAIProbeExec OAIProbe::getExec() const {
    return m_exec;
}
void OAIProbe::setExec(const OAIProbeExec &exec) {
    m_exec = exec;
    m_exec_isSet = true;
}
...
OAIProbeHttpGet OAIProbe::getHttpGet() const {
    return m_http_get;
}
void OAIProbe::setHttpGet(const OAIProbeHttpGet &http_get) {
    m_http_get = http_get;
...
OAIProbeTcpSocket OAIProbe::getTcpSocket() const {
    return m_tcp_socket;
}
void OAIProbe::setTcpSocket(const OAIProbeTcpSocket &tcp_socket) {
