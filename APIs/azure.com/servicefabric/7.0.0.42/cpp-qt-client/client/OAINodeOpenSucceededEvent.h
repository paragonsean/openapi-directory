...
/*
 * OAINodeOpenSucceededEvent.h
 *
 * Node Opened Succeeded event.
 */

#ifndef OAINodeOpenSucceededEvent_H
#define OAINodeOpenSucceededEvent_H
...
class OAINodeOpenSucceededEvent : public OAIObject {
public:
    OAINodeOpenSucceededEvent();
    OAINodeOpenSucceededEvent(QString json);
    ~OAINodeOpenSucceededEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeOpenSucceededEvent)

#endif // OAINodeOpenSucceededEvent_H
