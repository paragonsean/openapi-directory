...
#include "OAINodeRemovedFromClusterEvent.h"
...
OAINodeRemovedFromClusterEvent::OAINodeRemovedFromClusterEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeRemovedFromClusterEvent::OAINodeRemovedFromClusterEvent() {
    this->initializeModel();
}

OAINodeRemovedFromClusterEvent::~OAINodeRemovedFromClusterEvent() {}

void OAINodeRemovedFromClusterEvent::initializeModel() {
...
void OAINodeRemovedFromClusterEvent::fromJson(QString jsonString) {
...
void OAINodeRemovedFromClusterEvent::fromJsonObject(QJsonObject json) {
...
QString OAINodeRemovedFromClusterEvent::asJson() const {
...
QJsonObject OAINodeRemovedFromClusterEvent::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeRemovedFromClusterEvent::getFabricVersion() const {
    return m_fabric_version;
}
void OAINodeRemovedFromClusterEvent::setFabricVersion(const QString &fabric_version) {
    m_fabric_version = fabric_version;
    m_fabric_version_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_fabric_version_Set() const{
    return m_fabric_version_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_fabric_version_Valid() const{
    return m_fabric_version_isValid;
}

QString OAINodeRemovedFromClusterEvent::getIpAddressOrFqdn() const {
    return m_ip_address_or_fqdn;
}
void OAINodeRemovedFromClusterEvent::setIpAddressOrFqdn(const QString &ip_address_or_fqdn) {
    m_ip_address_or_fqdn = ip_address_or_fqdn;
    m_ip_address_or_fqdn_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_ip_address_or_fqdn_Set() const{
    return m_ip_address_or_fqdn_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_ip_address_or_fqdn_Valid() const{
    return m_ip_address_or_fqdn_isValid;
}

QString OAINodeRemovedFromClusterEvent::getNodeCapacities() const {
    return m_node_capacities;
}
void OAINodeRemovedFromClusterEvent::setNodeCapacities(const QString &node_capacities) {
    m_node_capacities = node_capacities;
    m_node_capacities_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_node_capacities_Set() const{
    return m_node_capacities_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_node_capacities_Valid() const{
    return m_node_capacities_isValid;
}

QString OAINodeRemovedFromClusterEvent::getNodeId() const {
    return m_node_id;
}
void OAINodeRemovedFromClusterEvent::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint64 OAINodeRemovedFromClusterEvent::getNodeInstance() const {
    return m_node_instance;
}
void OAINodeRemovedFromClusterEvent::setNodeInstance(const qint64 &node_instance) {
    m_node_instance = node_instance;
    m_node_instance_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_node_instance_Set() const{
    return m_node_instance_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_node_instance_Valid() const{
    return m_node_instance_isValid;
}

QString OAINodeRemovedFromClusterEvent::getNodeType() const {
    return m_node_type;
}
void OAINodeRemovedFromClusterEvent::setNodeType(const QString &node_type) {
    m_node_type = node_type;
    m_node_type_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_node_type_Set() const{
    return m_node_type_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_node_type_Valid() const{
    return m_node_type_isValid;
}

QString OAINodeRemovedFromClusterEvent::getNodeName() const {
    return m_node_name;
}
void OAINodeRemovedFromClusterEvent::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAINodeRemovedFromClusterEvent::getCategory() const {
    return m_category;
}
void OAINodeRemovedFromClusterEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_category_Valid() const{
    return m_category_isValid;
}

QString OAINodeRemovedFromClusterEvent::getEventInstanceId() const {
    return m_event_instance_id;
}
void OAINodeRemovedFromClusterEvent::setEventInstanceId(const QString &event_instance_id) {
    m_event_instance_id = event_instance_id;
    m_event_instance_id_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_event_instance_id_Set() const{
    return m_event_instance_id_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_event_instance_id_Valid() const{
    return m_event_instance_id_isValid;
}

bool OAINodeRemovedFromClusterEvent::isHasCorrelatedEvents() const {
    return m_has_correlated_events;
}
void OAINodeRemovedFromClusterEvent::setHasCorrelatedEvents(const bool &has_correlated_events) {
    m_has_correlated_events = has_correlated_events;
    m_has_correlated_events_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_has_correlated_events_Set() const{
    return m_has_correlated_events_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_has_correlated_events_Valid() const{
    return m_has_correlated_events_isValid;
}

OAIFabricEventKind OAINodeRemovedFromClusterEvent::getKind() const {
    return m_kind;
}
void OAINodeRemovedFromClusterEvent::setKind(const OAIFabricEventKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_kind_Valid() const{
    return m_kind_isValid;
}

QDateTime OAINodeRemovedFromClusterEvent::getTimeStamp() const {
    return m_time_stamp;
}
void OAINodeRemovedFromClusterEvent::setTimeStamp(const QDateTime &time_stamp) {
    m_time_stamp = time_stamp;
    m_time_stamp_isSet = true;
}

bool OAINodeRemovedFromClusterEvent::is_time_stamp_Set() const{
    return m_time_stamp_isSet;
}

bool OAINodeRemovedFromClusterEvent::is_time_stamp_Valid() const{
    return m_time_stamp_isValid;
}

bool OAINodeRemovedFromClusterEvent::isSet() const {
...
bool OAINodeRemovedFromClusterEvent::isValid() const {
