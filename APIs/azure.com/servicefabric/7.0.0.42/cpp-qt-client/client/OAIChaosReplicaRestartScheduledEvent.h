...
/*
 * OAIChaosReplicaRestartScheduledEvent.h
 *
 * Chaos Restart Replica Fault Scheduled event.
 */

#ifndef OAIChaosReplicaRestartScheduledEvent_H
#define OAIChaosReplicaRestartScheduledEvent_H
...
class OAIChaosReplicaRestartScheduledEvent : public OAIObject {
public:
    OAIChaosReplicaRestartScheduledEvent();
    OAIChaosReplicaRestartScheduledEvent(QString json);
    ~OAIChaosReplicaRestartScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosReplicaRestartScheduledEvent)

#endif // OAIChaosReplicaRestartScheduledEvent_H
