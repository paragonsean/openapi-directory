...
/*
 * OAIStatelessReplicaNewHealthReportEvent.h
 *
 * Stateless Replica Health Report Created event.
 */

#ifndef OAIStatelessReplicaNewHealthReportEvent_H
#define OAIStatelessReplicaNewHealthReportEvent_H
...
class OAIStatelessReplicaNewHealthReportEvent : public OAIObject {
public:
    OAIStatelessReplicaNewHealthReportEvent();
    OAIStatelessReplicaNewHealthReportEvent(QString json);
    ~OAIStatelessReplicaNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessReplicaNewHealthReportEvent)

#endif // OAIStatelessReplicaNewHealthReportEvent_H
