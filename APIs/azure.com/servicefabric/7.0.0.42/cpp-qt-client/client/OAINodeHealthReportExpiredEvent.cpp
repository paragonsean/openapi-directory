...
QString OAINodeHealthReportExpiredEvent::getCategory() const {
    return m_category;
}
void OAINodeHealthReportExpiredEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAINodeHealthReportExpiredEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAINodeHealthReportExpiredEvent::is_category_Valid() const{
...
bool OAINodeHealthReportExpiredEvent::isValid() const {
    ...
    return m_description_isValid && m_health_state_isValid && m_node_instance_id_isValid && m_property_isValid && m_remove_when_expired_isValid && m_sequence_number_isValid && m_source_id_isValid && m_source_utc_timestamp_isValid && m_time_to_live_ms_isValid && m_node_name_isValid && m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && true;
}
