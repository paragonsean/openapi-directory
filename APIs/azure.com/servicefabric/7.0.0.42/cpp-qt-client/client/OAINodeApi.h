...
public:
    ...
    * @param[in]  config_parameter_override_list QList<OAIConfigParameterOverride> [required]
    * @param[in]  force bool [optional]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void addConfigurationParameterOverrides(const QString &api_version, const QString &node_name, const QList<OAIConfigParameterOverride> &config_parameter_override_list, const ::OpenAPI::OptionalParam<bool> &force = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getConfigurationOverrides(const QString &api_version, const QString &node_name, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getNodeInfoList(const QString &api_version, const ::OpenAPI::OptionalParam<QString> &continuation_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &node_status_filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint64> &max_results = ::OpenAPI::OptionalParam<qint64>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void removeConfigurationOverrides(const QString &api_version, const QString &node_name, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
private:
    ...
    void addConfigurationParameterOverridesCallback(OAIHttpRequestWorker *worker);
    void disableNodeCallback(OAIHttpRequestWorker *worker);
    void enableNodeCallback(OAIHttpRequestWorker *worker);
    void getConfigurationOverridesCallback(OAIHttpRequestWorker *worker);
    ...
    void removeConfigurationOverridesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void addConfigurationParameterOverridesSignal();
    void disableNodeSignal();
    void enableNodeSignal();
    void getConfigurationOverridesSignal(QList<OAIConfigParameterOverride> summary);
    ...
    void removeConfigurationOverridesSignal();
    void removeNodeStateSignal();
    void reportNodeHealthSignal();
    void restartNodeSignal();


    void addConfigurationParameterOverridesSignalFull(OAIHttpRequestWorker *worker);
    void disableNodeSignalFull(OAIHttpRequestWorker *worker);
    void enableNodeSignalFull(OAIHttpRequestWorker *worker);
    void getConfigurationOverridesSignalFull(OAIHttpRequestWorker *worker, QList<OAIConfigParameterOverride> summary);
    ...
    void removeConfigurationOverridesSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use addConfigurationParameterOverridesSignalError() instead")
    void addConfigurationParameterOverridesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void addConfigurationParameterOverridesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getConfigurationOverridesSignalError() instead")
    void getConfigurationOverridesSignalE(QList<OAIConfigParameterOverride> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getConfigurationOverridesSignalError(QList<OAIConfigParameterOverride> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use removeConfigurationOverridesSignalError() instead")
    void removeConfigurationOverridesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void removeConfigurationOverridesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use addConfigurationParameterOverridesSignalErrorFull() instead")
    void addConfigurationParameterOverridesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void addConfigurationParameterOverridesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getConfigurationOverridesSignalErrorFull() instead")
    void getConfigurationOverridesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getConfigurationOverridesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use removeConfigurationOverridesSignalErrorFull() instead")
    void removeConfigurationOverridesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void removeConfigurationOverridesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
