...
/*
 * OAIChaosPartitionSecondaryMoveScheduledEvent.h
 *
 * Chaos Move Secondary Fault Scheduled event.
 */

#ifndef OAIChaosPartitionSecondaryMoveScheduledEvent_H
#define OAIChaosPartitionSecondaryMoveScheduledEvent_H
...
class OAIChaosPartitionSecondaryMoveScheduledEvent : public OAIObject {
public:
    OAIChaosPartitionSecondaryMoveScheduledEvent();
    OAIChaosPartitionSecondaryMoveScheduledEvent(QString json);
    ~OAIChaosPartitionSecondaryMoveScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosPartitionSecondaryMoveScheduledEvent)

#endif // OAIChaosPartitionSecondaryMoveScheduledEvent_H
