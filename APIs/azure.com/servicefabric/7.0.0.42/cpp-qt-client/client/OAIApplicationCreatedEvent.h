...
/*
 * OAIApplicationCreatedEvent.h
 *
 * Application Created event.
 */

#ifndef OAIApplicationCreatedEvent_H
#define OAIApplicationCreatedEvent_H
...
class OAIApplicationCreatedEvent : public OAIObject {
public:
    OAIApplicationCreatedEvent();
    OAIApplicationCreatedEvent(QString json);
    ~OAIApplicationCreatedEvent() override;
    ...
    QString getApplicationDefinitionKind() const;
    void setApplicationDefinitionKind(const QString &application_definition_kind);
...
private:
    ...
    QString m_application_definition_kind;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationCreatedEvent)

#endif // OAIApplicationCreatedEvent_H
