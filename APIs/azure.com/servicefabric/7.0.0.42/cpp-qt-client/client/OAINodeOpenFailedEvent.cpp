...
QString OAINodeOpenFailedEvent::getCategory() const {
    return m_category;
}
void OAINodeOpenFailedEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAINodeOpenFailedEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAINodeOpenFailedEvent::is_category_Valid() const{
...
bool OAINodeOpenFailedEvent::isValid() const {
    ...
    return m_error_isValid && m_fault_domain_isValid && m_hostname_isValid && m_ip_address_or_fqdn_isValid && m_is_seed_node_isValid && m_node_id_isValid && m_node_instance_isValid && m_node_version_isValid && m_upgrade_domain_isValid && m_node_name_isValid && m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && true;
}
