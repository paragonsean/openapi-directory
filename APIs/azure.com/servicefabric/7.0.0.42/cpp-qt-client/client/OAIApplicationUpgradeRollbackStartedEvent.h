...
/*
 * OAIApplicationUpgradeRollbackStartedEvent.h
 *
 * Application Upgrade Rollback Started event.
 */

#ifndef OAIApplicationUpgradeRollbackStartedEvent_H
#define OAIApplicationUpgradeRollbackStartedEvent_H
...
class OAIApplicationUpgradeRollbackStartedEvent : public OAIObject {
public:
    OAIApplicationUpgradeRollbackStartedEvent();
    OAIApplicationUpgradeRollbackStartedEvent(QString json);
    ~OAIApplicationUpgradeRollbackStartedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeRollbackStartedEvent)

#endif // OAIApplicationUpgradeRollbackStartedEvent_H
