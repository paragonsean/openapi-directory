...
/*
 * OAIPartitionNewHealthReportEvent.h
 *
 * Partition Health Report Created event.
 */

#ifndef OAIPartitionNewHealthReportEvent_H
#define OAIPartitionNewHealthReportEvent_H
...
class OAIPartitionNewHealthReportEvent : public OAIObject {
public:
    OAIPartitionNewHealthReportEvent();
    OAIPartitionNewHealthReportEvent(QString json);
    ~OAIPartitionNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionNewHealthReportEvent)

#endif // OAIPartitionNewHealthReportEvent_H
