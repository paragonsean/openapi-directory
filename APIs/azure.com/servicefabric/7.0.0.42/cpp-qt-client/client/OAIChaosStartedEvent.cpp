...
double OAIChaosStartedEvent::getWaitTimeBetweenFaultsInSeconds() const {
    return m_wait_time_between_faults_in_seconds;
}
void OAIChaosStartedEvent::setWaitTimeBetweenFaultsInSeconds(const double &wait_time_between_faults_in_seconds) {
...
bool OAIChaosStartedEvent::is_wait_time_between_faults_in_seconds_Set() const{
    return m_wait_time_between_faults_in_seconds_isSet;
}

bool OAIChaosStartedEvent::is_wait_time_between_faults_in_seconds_Valid() const{
...
QString OAIChaosStartedEvent::getCategory() const {
    return m_category;
}
void OAIChaosStartedEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIChaosStartedEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAIChaosStartedEvent::is_category_Valid() const{
...
bool OAIChaosStartedEvent::isValid() const {
    ...
    return m_chaos_context_isValid && m_cluster_health_policy_isValid && m_included_application_list_isValid && m_included_node_type_list_isValid && m_max_cluster_stabilization_timeout_in_seconds_isValid && m_max_concurrent_faults_isValid && m_move_replica_fault_enabled_isValid && m_time_to_run_in_seconds_isValid && m_wait_time_between_faults_in_seconds_isValid && m_wait_time_between_iterations_in_seconds_isValid && m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && true;
}
