...
/*
 * OAIStatefulReplicaNewHealthReportEvent.h
 *
 * Stateful Replica Health Report Created event.
 */

#ifndef OAIStatefulReplicaNewHealthReportEvent_H
#define OAIStatefulReplicaNewHealthReportEvent_H
...
class OAIStatefulReplicaNewHealthReportEvent : public OAIObject {
public:
    OAIStatefulReplicaNewHealthReportEvent();
    OAIStatefulReplicaNewHealthReportEvent(QString json);
    ~OAIStatefulReplicaNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulReplicaNewHealthReportEvent)

#endif // OAIStatefulReplicaNewHealthReportEvent_H
