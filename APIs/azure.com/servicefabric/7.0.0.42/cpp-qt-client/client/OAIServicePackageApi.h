...
Q_SIGNALS:
    ...
    void getDeployedServicePackageInfoListByNameSignal(QList<OAIDeployedServicePackageInfo> summary);
    ...
    void getDeployedServicePackageInfoListByNameSignalFull(OAIHttpRequestWorker *worker, QList<OAIDeployedServicePackageInfo> summary);
    ...
    void getDeployedServicePackageInfoListByNameSignalE(QList<OAIDeployedServicePackageInfo> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDeployedServicePackageInfoListByNameSignalError(QList<OAIDeployedServicePackageInfo> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
