...
#ifndef OAIPagedApplicationInfoList_H
#define OAIPagedApplicationInfoList_H
...
class OAIPagedApplicationInfoList : public OAIObject {
public:
    OAIPagedApplicationInfoList();
    OAIPagedApplicationInfoList(QString json);
    ~OAIPagedApplicationInfoList() override;
    ...
    QList<OAIApplicationInfo> getItems() const;
    void setItems(const QList<OAIApplicationInfo> &items);
...
private:
    ...
    QList<OAIApplicationInfo> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagedApplicationInfoList)

#endif // OAIPagedApplicationInfoList_H
