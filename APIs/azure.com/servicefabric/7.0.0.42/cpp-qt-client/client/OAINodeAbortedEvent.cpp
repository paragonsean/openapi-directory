...
QString OAINodeAbortedEvent::getCategory() const {
    return m_category;
}
void OAINodeAbortedEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAINodeAbortedEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAINodeAbortedEvent::is_category_Valid() const{
