...
#include "OAINodeNewHealthReportEvent.h"
...
OAINodeNewHealthReportEvent::OAINodeNewHealthReportEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeNewHealthReportEvent::OAINodeNewHealthReportEvent() {
    this->initializeModel();
}

OAINodeNewHealthReportEvent::~OAINodeNewHealthReportEvent() {}

void OAINodeNewHealthReportEvent::initializeModel() {
...
void OAINodeNewHealthReportEvent::fromJson(QString jsonString) {
...
void OAINodeNewHealthReportEvent::fromJsonObject(QJsonObject json) {
...
QString OAINodeNewHealthReportEvent::asJson() const {
...
QJsonObject OAINodeNewHealthReportEvent::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeNewHealthReportEvent::getDescription() const {
    return m_description;
}
void OAINodeNewHealthReportEvent::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_description_Set() const{
    return m_description_isSet;
}

bool OAINodeNewHealthReportEvent::is_description_Valid() const{
    return m_description_isValid;
}

QString OAINodeNewHealthReportEvent::getHealthState() const {
    return m_health_state;
}
void OAINodeNewHealthReportEvent::setHealthState(const QString &health_state) {
    m_health_state = health_state;
    m_health_state_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_health_state_Set() const{
    return m_health_state_isSet;
}

bool OAINodeNewHealthReportEvent::is_health_state_Valid() const{
    return m_health_state_isValid;
}

qint64 OAINodeNewHealthReportEvent::getNodeInstanceId() const {
    return m_node_instance_id;
}
void OAINodeNewHealthReportEvent::setNodeInstanceId(const qint64 &node_instance_id) {
    m_node_instance_id = node_instance_id;
    m_node_instance_id_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_node_instance_id_Set() const{
    return m_node_instance_id_isSet;
}

bool OAINodeNewHealthReportEvent::is_node_instance_id_Valid() const{
    return m_node_instance_id_isValid;
}

QString OAINodeNewHealthReportEvent::getProperty() const {
    return m_property;
}
void OAINodeNewHealthReportEvent::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_property_Set() const{
    return m_property_isSet;
}

bool OAINodeNewHealthReportEvent::is_property_Valid() const{
    return m_property_isValid;
}

bool OAINodeNewHealthReportEvent::isRemoveWhenExpired() const {
    return m_remove_when_expired;
}
void OAINodeNewHealthReportEvent::setRemoveWhenExpired(const bool &remove_when_expired) {
    m_remove_when_expired = remove_when_expired;
    m_remove_when_expired_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_remove_when_expired_Set() const{
    return m_remove_when_expired_isSet;
}

bool OAINodeNewHealthReportEvent::is_remove_when_expired_Valid() const{
    return m_remove_when_expired_isValid;
}

qint64 OAINodeNewHealthReportEvent::getSequenceNumber() const {
    return m_sequence_number;
}
void OAINodeNewHealthReportEvent::setSequenceNumber(const qint64 &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAINodeNewHealthReportEvent::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAINodeNewHealthReportEvent::getSourceId() const {
    return m_source_id;
}
void OAINodeNewHealthReportEvent::setSourceId(const QString &source_id) {
    m_source_id = source_id;
    m_source_id_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_source_id_Set() const{
    return m_source_id_isSet;
}

bool OAINodeNewHealthReportEvent::is_source_id_Valid() const{
    return m_source_id_isValid;
}

QDateTime OAINodeNewHealthReportEvent::getSourceUtcTimestamp() const {
    return m_source_utc_timestamp;
}
void OAINodeNewHealthReportEvent::setSourceUtcTimestamp(const QDateTime &source_utc_timestamp) {
    m_source_utc_timestamp = source_utc_timestamp;
    m_source_utc_timestamp_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_source_utc_timestamp_Set() const{
    return m_source_utc_timestamp_isSet;
}

bool OAINodeNewHealthReportEvent::is_source_utc_timestamp_Valid() const{
    return m_source_utc_timestamp_isValid;
}

qint64 OAINodeNewHealthReportEvent::getTimeToLiveMs() const {
    return m_time_to_live_ms;
}
void OAINodeNewHealthReportEvent::setTimeToLiveMs(const qint64 &time_to_live_ms) {
    m_time_to_live_ms = time_to_live_ms;
    m_time_to_live_ms_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_time_to_live_ms_Set() const{
    return m_time_to_live_ms_isSet;
}

bool OAINodeNewHealthReportEvent::is_time_to_live_ms_Valid() const{
    return m_time_to_live_ms_isValid;
}

QString OAINodeNewHealthReportEvent::getNodeName() const {
    return m_node_name;
}
void OAINodeNewHealthReportEvent::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAINodeNewHealthReportEvent::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAINodeNewHealthReportEvent::getCategory() const {
    return m_category;
}
void OAINodeNewHealthReportEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAINodeNewHealthReportEvent::is_category_Valid() const{
    return m_category_isValid;
}

QString OAINodeNewHealthReportEvent::getEventInstanceId() const {
    return m_event_instance_id;
}
void OAINodeNewHealthReportEvent::setEventInstanceId(const QString &event_instance_id) {
    m_event_instance_id = event_instance_id;
    m_event_instance_id_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_event_instance_id_Set() const{
    return m_event_instance_id_isSet;
}

bool OAINodeNewHealthReportEvent::is_event_instance_id_Valid() const{
    return m_event_instance_id_isValid;
}

bool OAINodeNewHealthReportEvent::isHasCorrelatedEvents() const {
    return m_has_correlated_events;
}
void OAINodeNewHealthReportEvent::setHasCorrelatedEvents(const bool &has_correlated_events) {
    m_has_correlated_events = has_correlated_events;
    m_has_correlated_events_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_has_correlated_events_Set() const{
    return m_has_correlated_events_isSet;
}

bool OAINodeNewHealthReportEvent::is_has_correlated_events_Valid() const{
    return m_has_correlated_events_isValid;
}

OAIFabricEventKind OAINodeNewHealthReportEvent::getKind() const {
    return m_kind;
}
void OAINodeNewHealthReportEvent::setKind(const OAIFabricEventKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAINodeNewHealthReportEvent::is_kind_Valid() const{
    return m_kind_isValid;
}

QDateTime OAINodeNewHealthReportEvent::getTimeStamp() const {
    return m_time_stamp;
}
void OAINodeNewHealthReportEvent::setTimeStamp(const QDateTime &time_stamp) {
    m_time_stamp = time_stamp;
    m_time_stamp_isSet = true;
}

bool OAINodeNewHealthReportEvent::is_time_stamp_Set() const{
    return m_time_stamp_isSet;
}

bool OAINodeNewHealthReportEvent::is_time_stamp_Valid() const{
    return m_time_stamp_isValid;
}

bool OAINodeNewHealthReportEvent::isSet() const {
...
bool OAINodeNewHealthReportEvent::isValid() const {
