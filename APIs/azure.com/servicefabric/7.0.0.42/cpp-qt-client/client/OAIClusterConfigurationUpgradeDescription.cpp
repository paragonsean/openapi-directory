...
OAIApplicationHealthPolicies OAIClusterConfigurationUpgradeDescription::getApplicationHealthPolicies() const {
    return m_application_health_policies;
}
void OAIClusterConfigurationUpgradeDescription::setApplicationHealthPolicies(const OAIApplicationHealthPolicies &application_health_policies) {
    m_application_health_policies = application_health_policies;
    m_application_health_policies_isSet = true;
}

bool OAIClusterConfigurationUpgradeDescription::is_application_health_policies_Set() const{
    return m_application_health_policies_isSet;
}

bool OAIClusterConfigurationUpgradeDescription::is_application_health_policies_Valid() const{
