...
/*
 * OAIClusterUpgradeRollbackStartedEvent.h
 *
 * Cluster Upgrade Rollback Started event.
 */

#ifndef OAIClusterUpgradeRollbackStartedEvent_H
#define OAIClusterUpgradeRollbackStartedEvent_H
...
class OAIClusterUpgradeRollbackStartedEvent : public OAIObject {
public:
    OAIClusterUpgradeRollbackStartedEvent();
    OAIClusterUpgradeRollbackStartedEvent(QString json);
    ~OAIClusterUpgradeRollbackStartedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterUpgradeRollbackStartedEvent)

#endif // OAIClusterUpgradeRollbackStartedEvent_H
