...
public:
    ...
    QString getHealthReportId() const;
    void setHealthReportId(const QString &health_report_id);
    bool is_health_report_id_Set() const;
    bool is_health_report_id_Valid() const;
...
private:
    ...
    QString m_health_report_id;
    bool m_health_report_id_isSet;
    bool m_health_report_id_isValid;
