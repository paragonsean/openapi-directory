...
OAIServicePartitionKind OAIPartitionInformation::getServicePartitionKind() const {
    return m_service_partition_kind;
}
void OAIPartitionInformation::setServicePartitionKind(const OAIServicePartitionKind &service_partition_kind) {
