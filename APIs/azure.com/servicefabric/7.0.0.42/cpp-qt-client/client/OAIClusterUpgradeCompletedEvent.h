...
/*
 * OAIClusterUpgradeCompletedEvent.h
 *
 * Cluster Upgrade Completed event.
 */

#ifndef OAIClusterUpgradeCompletedEvent_H
#define OAIClusterUpgradeCompletedEvent_H
...
class OAIClusterUpgradeCompletedEvent : public OAIObject {
public:
    OAIClusterUpgradeCompletedEvent();
    OAIClusterUpgradeCompletedEvent(QString json);
    ~OAIClusterUpgradeCompletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterUpgradeCompletedEvent)

#endif // OAIClusterUpgradeCompletedEvent_H
