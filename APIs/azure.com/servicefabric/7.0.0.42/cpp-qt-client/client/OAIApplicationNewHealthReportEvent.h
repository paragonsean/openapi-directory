...
/*
 * OAIApplicationNewHealthReportEvent.h
 *
 * Application Health Report Created event.
 */

#ifndef OAIApplicationNewHealthReportEvent_H
#define OAIApplicationNewHealthReportEvent_H
...
class OAIApplicationNewHealthReportEvent : public OAIObject {
public:
    OAIApplicationNewHealthReportEvent();
    OAIApplicationNewHealthReportEvent(QString json);
    ~OAIApplicationNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationNewHealthReportEvent)

#endif // OAIApplicationNewHealthReportEvent_H
