...
/*
 * OAIChaosPartitionPrimaryMoveScheduledEvent.h
 *
 * Chaos Move Primary Fault Scheduled event.
 */

#ifndef OAIChaosPartitionPrimaryMoveScheduledEvent_H
#define OAIChaosPartitionPrimaryMoveScheduledEvent_H
...
class OAIChaosPartitionPrimaryMoveScheduledEvent : public OAIObject {
public:
    OAIChaosPartitionPrimaryMoveScheduledEvent();
    OAIChaosPartitionPrimaryMoveScheduledEvent(QString json);
    ~OAIChaosPartitionPrimaryMoveScheduledEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChaosPartitionPrimaryMoveScheduledEvent)

#endif // OAIChaosPartitionPrimaryMoveScheduledEvent_H
