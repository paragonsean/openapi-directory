...
QString OAIPartitionEvent::getCategory() const {
    return m_category;
}
void OAIPartitionEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIPartitionEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAIPartitionEvent::is_category_Valid() const{
...
bool OAIPartitionEvent::isValid() const {
    ...
    return m_partition_id_isValid && m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && true;
}
