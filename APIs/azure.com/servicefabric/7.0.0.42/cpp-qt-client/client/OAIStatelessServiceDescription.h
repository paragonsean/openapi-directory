...
public:
    ...
    qint64 getInstanceCloseDelayDurationSeconds() const;
    void setInstanceCloseDelayDurationSeconds(const qint64 &instance_close_delay_duration_seconds);
...
private:
    ...
    qint64 m_instance_close_delay_duration_seconds;
