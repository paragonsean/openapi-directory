...
/*
 * OAIDeployedApplicationNewHealthReportEvent.h
 *
 * Deployed Application Health Report Created event.
 */

#ifndef OAIDeployedApplicationNewHealthReportEvent_H
#define OAIDeployedApplicationNewHealthReportEvent_H
...
class OAIDeployedApplicationNewHealthReportEvent : public OAIObject {
public:
    OAIDeployedApplicationNewHealthReportEvent();
    OAIDeployedApplicationNewHealthReportEvent(QString json);
    ~OAIDeployedApplicationNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedApplicationNewHealthReportEvent)

#endif // OAIDeployedApplicationNewHealthReportEvent_H
