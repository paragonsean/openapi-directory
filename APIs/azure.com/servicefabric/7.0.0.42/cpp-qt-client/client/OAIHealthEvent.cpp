...
void OAIHealthEvent::initializeModel() {
    ...
    m_health_report_id_isSet = false;
    m_health_report_id_isValid = false;
...
void OAIHealthEvent::fromJsonObject(QJsonObject json) {
    ...
    m_health_report_id_isValid = ::OpenAPI::fromJsonValue(m_health_report_id, json[QString("HealthReportId")]);
    m_health_report_id_isSet = !json[QString("HealthReportId")].isNull() && m_health_report_id_isValid;
...
QJsonObject OAIHealthEvent::asJsonObject() const {
    ...
    if (m_health_report_id_isSet) {
        obj.insert(QString("HealthReportId"), ::OpenAPI::toJsonValue(m_health_report_id));
    }
...
QString OAIHealthEvent::getHealthReportId() const {
    return m_health_report_id;
}
void OAIHealthEvent::setHealthReportId(const QString &health_report_id) {
    m_health_report_id = health_report_id;
    m_health_report_id_isSet = true;
}

bool OAIHealthEvent::is_health_report_id_Set() const{
    return m_health_report_id_isSet;
}

bool OAIHealthEvent::is_health_report_id_Valid() const{
    return m_health_report_id_isValid;
}
