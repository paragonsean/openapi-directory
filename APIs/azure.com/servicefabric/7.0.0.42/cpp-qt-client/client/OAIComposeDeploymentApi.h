...
public:
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void startRollbackComposeDeploymentUpgrade(const QString &api_version, const QString &deployment_name, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
private:
    ...
    void startRollbackComposeDeploymentUpgradeCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void startRollbackComposeDeploymentUpgradeSignal();
    ...
    void startRollbackComposeDeploymentUpgradeSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use startRollbackComposeDeploymentUpgradeSignalError() instead")
    void startRollbackComposeDeploymentUpgradeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void startRollbackComposeDeploymentUpgradeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use startRollbackComposeDeploymentUpgradeSignalErrorFull() instead")
    void startRollbackComposeDeploymentUpgradeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void startRollbackComposeDeploymentUpgradeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
