...
/*
 * OAINodeNewHealthReportEvent.h
 *
 * Node Health Report Created event.
 */

#ifndef OAINodeNewHealthReportEvent_H
#define OAINodeNewHealthReportEvent_H
...
class OAINodeNewHealthReportEvent : public OAIObject {
public:
    OAINodeNewHealthReportEvent();
    OAINodeNewHealthReportEvent(QString json);
    ~OAINodeNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeNewHealthReportEvent)

#endif // OAINodeNewHealthReportEvent_H
