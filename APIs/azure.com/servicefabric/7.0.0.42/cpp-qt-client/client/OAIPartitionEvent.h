...
#ifndef OAIPartitionEvent_H
#define OAIPartitionEvent_H
...
class OAIPartitionEvent : public OAIObject {
public:
    OAIPartitionEvent();
    OAIPartitionEvent(QString json);
    ~OAIPartitionEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartitionEvent)

#endif // OAIPartitionEvent_H
