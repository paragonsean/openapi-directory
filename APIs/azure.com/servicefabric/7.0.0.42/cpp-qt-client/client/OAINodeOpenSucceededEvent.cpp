...
#include "OAINodeOpenSucceededEvent.h"
...
OAINodeOpenSucceededEvent::OAINodeOpenSucceededEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINodeOpenSucceededEvent::OAINodeOpenSucceededEvent() {
    this->initializeModel();
}

OAINodeOpenSucceededEvent::~OAINodeOpenSucceededEvent() {}

void OAINodeOpenSucceededEvent::initializeModel() {
...
void OAINodeOpenSucceededEvent::fromJson(QString jsonString) {
...
void OAINodeOpenSucceededEvent::fromJsonObject(QJsonObject json) {
...
QString OAINodeOpenSucceededEvent::asJson() const {
...
QJsonObject OAINodeOpenSucceededEvent::asJsonObject() const {
    QJsonObject obj;
...
QString OAINodeOpenSucceededEvent::getFaultDomain() const {
    return m_fault_domain;
}
void OAINodeOpenSucceededEvent::setFaultDomain(const QString &fault_domain) {
    m_fault_domain = fault_domain;
    m_fault_domain_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_fault_domain_Set() const{
    return m_fault_domain_isSet;
}

bool OAINodeOpenSucceededEvent::is_fault_domain_Valid() const{
    return m_fault_domain_isValid;
}

QString OAINodeOpenSucceededEvent::getHostname() const {
    return m_hostname;
}
void OAINodeOpenSucceededEvent::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAINodeOpenSucceededEvent::is_hostname_Valid() const{
    return m_hostname_isValid;
}

QString OAINodeOpenSucceededEvent::getIpAddressOrFqdn() const {
    return m_ip_address_or_fqdn;
}
void OAINodeOpenSucceededEvent::setIpAddressOrFqdn(const QString &ip_address_or_fqdn) {
    m_ip_address_or_fqdn = ip_address_or_fqdn;
    m_ip_address_or_fqdn_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_ip_address_or_fqdn_Set() const{
    return m_ip_address_or_fqdn_isSet;
}

bool OAINodeOpenSucceededEvent::is_ip_address_or_fqdn_Valid() const{
    return m_ip_address_or_fqdn_isValid;
}

bool OAINodeOpenSucceededEvent::isIsSeedNode() const {
    return m_is_seed_node;
}
void OAINodeOpenSucceededEvent::setIsSeedNode(const bool &is_seed_node) {
    m_is_seed_node = is_seed_node;
    m_is_seed_node_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_is_seed_node_Set() const{
    return m_is_seed_node_isSet;
}

bool OAINodeOpenSucceededEvent::is_is_seed_node_Valid() const{
    return m_is_seed_node_isValid;
}

QString OAINodeOpenSucceededEvent::getNodeId() const {
    return m_node_id;
}
void OAINodeOpenSucceededEvent::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAINodeOpenSucceededEvent::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint64 OAINodeOpenSucceededEvent::getNodeInstance() const {
    return m_node_instance;
}
void OAINodeOpenSucceededEvent::setNodeInstance(const qint64 &node_instance) {
    m_node_instance = node_instance;
    m_node_instance_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_node_instance_Set() const{
    return m_node_instance_isSet;
}

bool OAINodeOpenSucceededEvent::is_node_instance_Valid() const{
    return m_node_instance_isValid;
}

QString OAINodeOpenSucceededEvent::getNodeVersion() const {
    return m_node_version;
}
void OAINodeOpenSucceededEvent::setNodeVersion(const QString &node_version) {
    m_node_version = node_version;
    m_node_version_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_node_version_Set() const{
    return m_node_version_isSet;
}

bool OAINodeOpenSucceededEvent::is_node_version_Valid() const{
    return m_node_version_isValid;
}

QString OAINodeOpenSucceededEvent::getUpgradeDomain() const {
    return m_upgrade_domain;
}
void OAINodeOpenSucceededEvent::setUpgradeDomain(const QString &upgrade_domain) {
    m_upgrade_domain = upgrade_domain;
    m_upgrade_domain_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_upgrade_domain_Set() const{
    return m_upgrade_domain_isSet;
}

bool OAINodeOpenSucceededEvent::is_upgrade_domain_Valid() const{
    return m_upgrade_domain_isValid;
}

QString OAINodeOpenSucceededEvent::getNodeName() const {
    return m_node_name;
}
void OAINodeOpenSucceededEvent::setNodeName(const QString &node_name) {
    m_node_name = node_name;
    m_node_name_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_node_name_Set() const{
    return m_node_name_isSet;
}

bool OAINodeOpenSucceededEvent::is_node_name_Valid() const{
    return m_node_name_isValid;
}

QString OAINodeOpenSucceededEvent::getCategory() const {
    return m_category;
}
void OAINodeOpenSucceededEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAINodeOpenSucceededEvent::is_category_Valid() const{
    return m_category_isValid;
}

QString OAINodeOpenSucceededEvent::getEventInstanceId() const {
    return m_event_instance_id;
}
void OAINodeOpenSucceededEvent::setEventInstanceId(const QString &event_instance_id) {
    m_event_instance_id = event_instance_id;
    m_event_instance_id_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_event_instance_id_Set() const{
    return m_event_instance_id_isSet;
}

bool OAINodeOpenSucceededEvent::is_event_instance_id_Valid() const{
    return m_event_instance_id_isValid;
}

bool OAINodeOpenSucceededEvent::isHasCorrelatedEvents() const {
    return m_has_correlated_events;
}
void OAINodeOpenSucceededEvent::setHasCorrelatedEvents(const bool &has_correlated_events) {
    m_has_correlated_events = has_correlated_events;
    m_has_correlated_events_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_has_correlated_events_Set() const{
    return m_has_correlated_events_isSet;
}

bool OAINodeOpenSucceededEvent::is_has_correlated_events_Valid() const{
    return m_has_correlated_events_isValid;
}

OAIFabricEventKind OAINodeOpenSucceededEvent::getKind() const {
    return m_kind;
}
void OAINodeOpenSucceededEvent::setKind(const OAIFabricEventKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAINodeOpenSucceededEvent::is_kind_Valid() const{
    return m_kind_isValid;
}

QDateTime OAINodeOpenSucceededEvent::getTimeStamp() const {
    return m_time_stamp;
}
void OAINodeOpenSucceededEvent::setTimeStamp(const QDateTime &time_stamp) {
    m_time_stamp = time_stamp;
    m_time_stamp_isSet = true;
}

bool OAINodeOpenSucceededEvent::is_time_stamp_Set() const{
    return m_time_stamp_isSet;
}

bool OAINodeOpenSucceededEvent::is_time_stamp_Valid() const{
    return m_time_stamp_isValid;
}

bool OAINodeOpenSucceededEvent::isSet() const {
...
bool OAINodeOpenSucceededEvent::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fault_domain_isValid && m_hostname_isValid && m_ip_address_or_fqdn_isValid && m_is_seed_node_isValid && m_node_id_isValid && m_node_instance_isValid && m_node_version_isValid && m_upgrade_domain_isValid && m_node_name_isValid && m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && true;
}
