...
public:
    ...
    * @param[in]  only_query_primaries bool [optional]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getUnplacedReplicaInformation(const QString &api_version, const QString &service_id, const ::OpenAPI::OptionalParam<QString> &partition_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &only_query_primaries = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
private:
    ...
    void getUnplacedReplicaInformationCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void getUnplacedReplicaInformationSignal(OAIUnplacedReplicaInformation summary);
    ...
    void getUnplacedReplicaInformationSignalFull(OAIHttpRequestWorker *worker, OAIUnplacedReplicaInformation summary);
    ...
    Q_DECL_DEPRECATED_X("Use getUnplacedReplicaInformationSignalError() instead")
    void getUnplacedReplicaInformationSignalE(OAIUnplacedReplicaInformation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getUnplacedReplicaInformationSignalError(OAIUnplacedReplicaInformation summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getUnplacedReplicaInformationSignalErrorFull() instead")
    void getUnplacedReplicaInformationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getUnplacedReplicaInformationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
