...
/*
 * OAIApplicationUpgradeCompletedEvent.h
 *
 * Application Upgrade Completed event.
 */

#ifndef OAIApplicationUpgradeCompletedEvent_H
#define OAIApplicationUpgradeCompletedEvent_H
...
class OAIApplicationUpgradeCompletedEvent : public OAIObject {
public:
    OAIApplicationUpgradeCompletedEvent();
    OAIApplicationUpgradeCompletedEvent(QString json);
    ~OAIApplicationUpgradeCompletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeCompletedEvent)

#endif // OAIApplicationUpgradeCompletedEvent_H
