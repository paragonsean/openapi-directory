...
/*
 * OAIStatefulReplicaHealthReportExpiredEvent.h
 *
 * Stateful Replica Health Report Expired event.
 */

#ifndef OAIStatefulReplicaHealthReportExpiredEvent_H
#define OAIStatefulReplicaHealthReportExpiredEvent_H
...
class OAIStatefulReplicaHealthReportExpiredEvent : public OAIObject {
public:
    OAIStatefulReplicaHealthReportExpiredEvent();
    OAIStatefulReplicaHealthReportExpiredEvent(QString json);
    ~OAIStatefulReplicaHealthReportExpiredEvent() override;
    ...
    qint64 getReplicaInstanceId() const;
    void setReplicaInstanceId(const qint64 &replica_instance_id);
    bool is_replica_instance_id_Set() const;
    bool is_replica_instance_id_Valid() const;
...
private:
    ...
    qint64 m_replica_instance_id;
    bool m_replica_instance_id_isSet;
    bool m_replica_instance_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulReplicaHealthReportExpiredEvent)

#endif // OAIStatefulReplicaHealthReportExpiredEvent_H
