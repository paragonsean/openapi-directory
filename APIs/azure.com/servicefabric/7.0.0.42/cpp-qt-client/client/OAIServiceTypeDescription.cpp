...
OAIServiceTypeDescription::OAIServiceTypeDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceTypeDescription::OAIServiceTypeDescription() {
    this->initializeModel();
}

OAIServiceTypeDescription::~OAIServiceTypeDescription() {}

void OAIServiceTypeDescription::initializeModel() {
...
void OAIServiceTypeDescription::fromJson(QString jsonString) {
...
void OAIServiceTypeDescription::fromJsonObject(QJsonObject json) {
...
QString OAIServiceTypeDescription::asJson() const {
...
QJsonObject OAIServiceTypeDescription::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIServiceTypeExtensionDescription> OAIServiceTypeDescription::getExtensions() const {
    return m_extensions;
}
void OAIServiceTypeDescription::setExtensions(const QList<OAIServiceTypeExtensionDescription> &extensions) {
    m_extensions = extensions;
    m_extensions_isSet = true;
}

bool OAIServiceTypeDescription::is_extensions_Set() const{
    return m_extensions_isSet;
}

bool OAIServiceTypeDescription::is_extensions_Valid() const{
    return m_extensions_isValid;
}

bool OAIServiceTypeDescription::isIsStateful() const {
    return m_is_stateful;
}
void OAIServiceTypeDescription::setIsStateful(const bool &is_stateful) {
    m_is_stateful = is_stateful;
    m_is_stateful_isSet = true;
}

bool OAIServiceTypeDescription::is_is_stateful_Set() const{
    return m_is_stateful_isSet;
}

bool OAIServiceTypeDescription::is_is_stateful_Valid() const{
    return m_is_stateful_isValid;
}

OAIServiceKind OAIServiceTypeDescription::getKind() const {
    return m_kind;
}
void OAIServiceTypeDescription::setKind(const OAIServiceKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIServiceTypeDescription::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIServiceTypeDescription::is_kind_Valid() const{
    return m_kind_isValid;
}

QList<OAIServiceLoadMetricDescription> OAIServiceTypeDescription::getLoadMetrics() const {
    return m_load_metrics;
}
void OAIServiceTypeDescription::setLoadMetrics(const QList<OAIServiceLoadMetricDescription> &load_metrics) {
    m_load_metrics = load_metrics;
    m_load_metrics_isSet = true;
}

bool OAIServiceTypeDescription::is_load_metrics_Set() const{
    return m_load_metrics_isSet;
}

bool OAIServiceTypeDescription::is_load_metrics_Valid() const{
    return m_load_metrics_isValid;
}

QString OAIServiceTypeDescription::getPlacementConstraints() const {
    return m_placement_constraints;
}
void OAIServiceTypeDescription::setPlacementConstraints(const QString &placement_constraints) {
    m_placement_constraints = placement_constraints;
    m_placement_constraints_isSet = true;
}

bool OAIServiceTypeDescription::is_placement_constraints_Set() const{
    return m_placement_constraints_isSet;
}

bool OAIServiceTypeDescription::is_placement_constraints_Valid() const{
    return m_placement_constraints_isValid;
}

QList<OAIServicePlacementPolicyDescription> OAIServiceTypeDescription::getServicePlacementPolicies() const {
    return m_service_placement_policies;
}
void OAIServiceTypeDescription::setServicePlacementPolicies(const QList<OAIServicePlacementPolicyDescription> &service_placement_policies) {
    m_service_placement_policies = service_placement_policies;
    m_service_placement_policies_isSet = true;
}

bool OAIServiceTypeDescription::is_service_placement_policies_Set() const{
    return m_service_placement_policies_isSet;
}

bool OAIServiceTypeDescription::is_service_placement_policies_Valid() const{
    return m_service_placement_policies_isValid;
}

QString OAIServiceTypeDescription::getServiceTypeName() const {
    return m_service_type_name;
}
void OAIServiceTypeDescription::setServiceTypeName(const QString &service_type_name) {
    m_service_type_name = service_type_name;
    m_service_type_name_isSet = true;
}

bool OAIServiceTypeDescription::is_service_type_name_Set() const{
    return m_service_type_name_isSet;
}

bool OAIServiceTypeDescription::is_service_type_name_Valid() const{
    return m_service_type_name_isValid;
}

bool OAIServiceTypeDescription::isSet() const {
...
bool OAIServiceTypeDescription::isValid() const {
