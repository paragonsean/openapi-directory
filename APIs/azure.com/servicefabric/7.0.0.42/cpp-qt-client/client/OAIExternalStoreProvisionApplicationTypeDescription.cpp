...
bool OAIExternalStoreProvisionApplicationTypeDescription::isValid() const {
    ...
    return m_application_package_download_uri_isValid && m_application_type_name_isValid && m_application_type_version_isValid && m_async_isValid && m_kind_isValid && true;
}
