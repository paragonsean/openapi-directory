...
/*
 * OAIClusterUpgradeRollbackCompletedEvent.h
 *
 * Cluster Upgrade Rollback Completed event.
 */

#ifndef OAIClusterUpgradeRollbackCompletedEvent_H
#define OAIClusterUpgradeRollbackCompletedEvent_H
...
class OAIClusterUpgradeRollbackCompletedEvent : public OAIObject {
public:
    OAIClusterUpgradeRollbackCompletedEvent();
    OAIClusterUpgradeRollbackCompletedEvent(QString json);
    ~OAIClusterUpgradeRollbackCompletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterUpgradeRollbackCompletedEvent)

#endif // OAIClusterUpgradeRollbackCompletedEvent_H
