...
/*
 * OAIApplicationUpgradeDomainCompletedEvent.h
 *
 * Application Upgrade Domain Completed event.
 */

#ifndef OAIApplicationUpgradeDomainCompletedEvent_H
#define OAIApplicationUpgradeDomainCompletedEvent_H
...
class OAIApplicationUpgradeDomainCompletedEvent : public OAIObject {
public:
    OAIApplicationUpgradeDomainCompletedEvent();
    OAIApplicationUpgradeDomainCompletedEvent(QString json);
    ~OAIApplicationUpgradeDomainCompletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeDomainCompletedEvent)

#endif // OAIApplicationUpgradeDomainCompletedEvent_H
