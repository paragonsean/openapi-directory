...
/*
 * OAISecondaryActiveReplicatorStatus.h
 *
 * Status of the secondary replicator when it is in active mode and is part of the replica set.
 */

#ifndef OAISecondaryActiveReplicatorStatus_H
#define OAISecondaryActiveReplicatorStatus_H
...
class OAISecondaryActiveReplicatorStatus : public OAIObject {
public:
    OAISecondaryActiveReplicatorStatus();
    OAISecondaryActiveReplicatorStatus(QString json);
    ~OAISecondaryActiveReplicatorStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecondaryActiveReplicatorStatus)

#endif // OAISecondaryActiveReplicatorStatus_H
