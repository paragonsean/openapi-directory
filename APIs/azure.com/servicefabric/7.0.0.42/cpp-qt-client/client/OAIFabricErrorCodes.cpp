...
void OAIFabricErrorCodes::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("FABRIC_E_IMAGEBUILDER_RESERVED_DIRECTORY_ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFabricErrorCodes::FABRIC_E_IMAGEBUILDER_RESERVED_DIRECTORY_ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIFabricErrorCodes::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIFabricErrorCodes::SERIALIZATIONERROR:
            ...
            break;
        case eOAIFabricErrorCodes::FABRIC_E_IMAGEBUILDER_RESERVED_DIRECTORY_ERROR:
            val = "FABRIC_E_IMAGEBUILDER_RESERVED_DIRECTORY_ERROR";
            break;
        default:
            break;
    }
