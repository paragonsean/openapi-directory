...
class OAIProbe;
class OAIReliableCollectionsRef;
class OAIResourceRequirements;
class OAISetting;
class OAIVolumeReference;
class OAIApplicationScopedVolume;
...
public:
    ...
    QList<OAIProbe> getLivenessProbe() const;
    void setLivenessProbe(const QList<OAIProbe> &liveness_probe);
    ...
    QList<OAIProbe> getReadinessProbe() const;
    void setReadinessProbe(const QList<OAIProbe> &readiness_probe);
    bool is_readiness_probe_Set() const;
    bool is_readiness_probe_Valid() const;

    QList<OAIReliableCollectionsRef> getReliableCollectionsRefs() const;
    void setReliableCollectionsRefs(const QList<OAIReliableCollectionsRef> &reliable_collections_refs);
    bool is_reliable_collections_refs_Set() const;
    bool is_reliable_collections_refs_Valid() const;
    ...
    QList<OAIVolumeReference> getVolumeRefs() const;
    void setVolumeRefs(const QList<OAIVolumeReference> &volume_refs);
    bool is_volume_refs_Set() const;
    bool is_volume_refs_Valid() const;

    QList<OAIApplicationScopedVolume> getVolumes() const;
    void setVolumes(const QList<OAIApplicationScopedVolume> &volumes);
...
private:
    ...
    QList<OAIProbe> m_liveness_probe;
    ...
    QList<OAIProbe> m_readiness_probe;
    bool m_readiness_probe_isSet;
    bool m_readiness_probe_isValid;

    QList<OAIReliableCollectionsRef> m_reliable_collections_refs;
    bool m_reliable_collections_refs_isSet;
    bool m_reliable_collections_refs_isValid;
    ...
    QList<OAIVolumeReference> m_volume_refs;
    bool m_volume_refs_isSet;
    bool m_volume_refs_isValid;

    QList<OAIApplicationScopedVolume> m_volumes;
