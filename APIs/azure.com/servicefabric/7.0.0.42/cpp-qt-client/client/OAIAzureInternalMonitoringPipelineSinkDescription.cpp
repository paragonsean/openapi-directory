...
QString OAIAzureInternalMonitoringPipelineSinkDescription::getFluentdConfigUrl() const {
    return m_fluentd_config_url;
}
void OAIAzureInternalMonitoringPipelineSinkDescription::setFluentdConfigUrl(const QString &fluentd_config_url) {
