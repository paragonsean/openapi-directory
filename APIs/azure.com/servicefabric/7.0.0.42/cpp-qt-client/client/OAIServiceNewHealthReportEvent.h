...
/*
 * OAIServiceNewHealthReportEvent.h
 *
 * Service Health Report Created event.
 */

#ifndef OAIServiceNewHealthReportEvent_H
#define OAIServiceNewHealthReportEvent_H
...
class OAIServiceNewHealthReportEvent : public OAIObject {
public:
    OAIServiceNewHealthReportEvent();
    OAIServiceNewHealthReportEvent(QString json);
    ~OAIServiceNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceNewHealthReportEvent)

#endif // OAIServiceNewHealthReportEvent_H
