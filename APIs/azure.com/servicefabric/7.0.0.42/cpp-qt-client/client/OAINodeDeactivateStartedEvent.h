...
/*
 * OAINodeDeactivateStartedEvent.h
 *
 * Node Deactivate Started event.
 */

#ifndef OAINodeDeactivateStartedEvent_H
#define OAINodeDeactivateStartedEvent_H
...
class OAINodeDeactivateStartedEvent : public OAIObject {
public:
    OAINodeDeactivateStartedEvent();
    OAINodeDeactivateStartedEvent(QString json);
    ~OAINodeDeactivateStartedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeDeactivateStartedEvent)

#endif // OAINodeDeactivateStartedEvent_H
