...
QString OAIFabricEvent::getCategory() const {
    return m_category;
}
void OAIFabricEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIFabricEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAIFabricEvent::is_category_Valid() const{
