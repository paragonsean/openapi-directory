...
/*
 * OAIClusterNewHealthReportEvent.h
 *
 * Cluster Health Report Created event.
 */

#ifndef OAIClusterNewHealthReportEvent_H
#define OAIClusterNewHealthReportEvent_H
...
class OAIClusterNewHealthReportEvent : public OAIObject {
public:
    OAIClusterNewHealthReportEvent();
    OAIClusterNewHealthReportEvent(QString json);
    ~OAIClusterNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterNewHealthReportEvent)

#endif // OAIClusterNewHealthReportEvent_H
