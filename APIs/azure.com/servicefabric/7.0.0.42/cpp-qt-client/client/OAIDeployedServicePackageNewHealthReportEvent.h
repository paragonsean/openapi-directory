...
/*
 * OAIDeployedServicePackageNewHealthReportEvent.h
 *
 * Deployed Service Health Report Created event.
 */

#ifndef OAIDeployedServicePackageNewHealthReportEvent_H
#define OAIDeployedServicePackageNewHealthReportEvent_H
...
class OAIDeployedServicePackageNewHealthReportEvent : public OAIObject {
public:
    OAIDeployedServicePackageNewHealthReportEvent();
    OAIDeployedServicePackageNewHealthReportEvent(QString json);
    ~OAIDeployedServicePackageNewHealthReportEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployedServicePackageNewHealthReportEvent)

#endif // OAIDeployedServicePackageNewHealthReportEvent_H
