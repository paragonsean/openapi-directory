...
void OAIApplicationDescription::initializeModel() {
    ...
    m_managed_application_identity_isSet = false;
    m_managed_application_identity_isValid = false;
...
void OAIApplicationDescription::fromJsonObject(QJsonObject json) {
    ...
    m_managed_application_identity_isValid = ::OpenAPI::fromJsonValue(m_managed_application_identity, json[QString("ManagedApplicationIdentity")]);
    m_managed_application_identity_isSet = !json[QString("ManagedApplicationIdentity")].isNull() && m_managed_application_identity_isValid;
...
QJsonObject OAIApplicationDescription::asJsonObject() const {
    ...
    if (m_managed_application_identity.isSet()) {
        obj.insert(QString("ManagedApplicationIdentity"), ::OpenAPI::toJsonValue(m_managed_application_identity));
    }
    if (m_name_isSet) {
...
OAIManagedApplicationIdentityDescription OAIApplicationDescription::getManagedApplicationIdentity() const {
    return m_managed_application_identity;
}
void OAIApplicationDescription::setManagedApplicationIdentity(const OAIManagedApplicationIdentityDescription &managed_application_identity) {
    m_managed_application_identity = managed_application_identity;
    m_managed_application_identity_isSet = true;
}

bool OAIApplicationDescription::is_managed_application_identity_Set() const{
    return m_managed_application_identity_isSet;
}

bool OAIApplicationDescription::is_managed_application_identity_Valid() const{
    return m_managed_application_identity_isValid;
}
