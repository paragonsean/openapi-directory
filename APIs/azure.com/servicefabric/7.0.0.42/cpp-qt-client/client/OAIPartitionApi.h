...
public:
    ...
    * @param[in]  api_version QString [required]
    * @param[in]  partition_id QString [required]
    * @param[in]  node_name QString [optional]
    * @param[in]  ignore_constraints bool [optional]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void movePrimaryReplica(const QString &api_version, const QString &partition_id, const ::OpenAPI::OptionalParam<QString> &node_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &ignore_constraints = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());

    /**
    * @param[in]  api_version QString [required]
    * @param[in]  partition_id QString [required]
    * @param[in]  current_node_name QString [required]
    * @param[in]  new_node_name QString [optional]
    * @param[in]  ignore_constraints bool [optional]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void moveSecondaryReplica(const QString &api_version, const QString &partition_id, const QString &current_node_name, const ::OpenAPI::OptionalParam<QString> &new_node_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &ignore_constraints = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
private:
    ...
    void movePrimaryReplicaCallback(OAIHttpRequestWorker *worker);
    void moveSecondaryReplicaCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void movePrimaryReplicaSignal();
    void moveSecondaryReplicaSignal();
    ...
    void movePrimaryReplicaSignalFull(OAIHttpRequestWorker *worker);
    void moveSecondaryReplicaSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use movePrimaryReplicaSignalError() instead")
    void movePrimaryReplicaSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void movePrimaryReplicaSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use moveSecondaryReplicaSignalError() instead")
    void moveSecondaryReplicaSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void moveSecondaryReplicaSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use movePrimaryReplicaSignalErrorFull() instead")
    void movePrimaryReplicaSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void movePrimaryReplicaSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use moveSecondaryReplicaSignalErrorFull() instead")
    void moveSecondaryReplicaSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void moveSecondaryReplicaSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
