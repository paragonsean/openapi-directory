...
OAIUpgradeSortOrder OAIClusterUpgradeDescriptionObject::getSortOrder() const {
    return m_sort_order;
}
void OAIClusterUpgradeDescriptionObject::setSortOrder(const OAIUpgradeSortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIClusterUpgradeDescriptionObject::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIClusterUpgradeDescriptionObject::is_sort_order_Valid() const{
