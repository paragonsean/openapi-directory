...
QString OAIServiceResourceProperties::getDnsName() const {
    return m_dns_name;
}
void OAIServiceResourceProperties::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAIServiceResourceProperties::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAIServiceResourceProperties::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

OAIExecutionPolicy OAIServiceResourceProperties::getExecutionPolicy() const {
    return m_execution_policy;
}
void OAIServiceResourceProperties::setExecutionPolicy(const OAIExecutionPolicy &execution_policy) {
    m_execution_policy = execution_policy;
    m_execution_policy_isSet = true;
}

bool OAIServiceResourceProperties::is_execution_policy_Set() const{
    return m_execution_policy_isSet;
}

bool OAIServiceResourceProperties::is_execution_policy_Valid() const{
...
QList<OAIServiceIdentity> OAIServiceResourceProperties::getIdentityRefs() const {
    return m_identity_refs;
}
void OAIServiceResourceProperties::setIdentityRefs(const QList<OAIServiceIdentity> &identity_refs) {
    m_identity_refs = identity_refs;
    m_identity_refs_isSet = true;
}

bool OAIServiceResourceProperties::is_identity_refs_Set() const{
    return m_identity_refs_isSet;
}

bool OAIServiceResourceProperties::is_identity_refs_Valid() const{
