...
/*
 * OAINodeHealthReportExpiredEvent.h
 *
 * Node Health Report Expired event.
 */

#ifndef OAINodeHealthReportExpiredEvent_H
#define OAINodeHealthReportExpiredEvent_H
...
class OAINodeHealthReportExpiredEvent : public OAIObject {
public:
    OAINodeHealthReportExpiredEvent();
    OAINodeHealthReportExpiredEvent(QString json);
    ~OAINodeHealthReportExpiredEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeHealthReportExpiredEvent)

#endif // OAINodeHealthReportExpiredEvent_H
