...
public:
    ...
    qint64 getServicePlacementTimeLimitSeconds() const;
    void setServicePlacementTimeLimitSeconds(const qint64 &service_placement_time_limit_seconds);
    bool is_service_placement_time_limit_seconds_Set() const;
    bool is_service_placement_time_limit_seconds_Valid() const;
...
private:
    ...
    qint64 m_service_placement_time_limit_seconds;
    bool m_service_placement_time_limit_seconds_isSet;
    bool m_service_placement_time_limit_seconds_isValid;
