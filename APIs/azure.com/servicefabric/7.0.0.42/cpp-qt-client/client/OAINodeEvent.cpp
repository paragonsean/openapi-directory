...
QString OAINodeEvent::getCategory() const {
    return m_category;
}
void OAINodeEvent::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAINodeEvent::is_category_Set() const{
    return m_category_isSet;
}

bool OAINodeEvent::is_category_Valid() const{
...
bool OAINodeEvent::isValid() const {
    ...
    return m_node_name_isValid && m_event_instance_id_isValid && m_kind_isValid && m_time_stamp_isValid && true;
}
