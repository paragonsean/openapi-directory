...
async def create_compose_deployment(request: web.Request, api_version, create_compose_deployment_description, timeout=None) -> web.Response:
    ...
    :param api_version: The version of the API. This parameter is required and its value must be &#39;\&quot;6.0-preview&#39;.
...
async def start_rollback_compose_deployment_upgrade(request: web.Request, api_version, deployment_name, timeout=None) -> web.Response:
