...
async def get_image_store_folder_size(request: web.Request, api_version, content_path, timeout=None) -> web.Response:
...
async def get_image_store_info(request: web.Request, api_version, timeout=None) -> web.Response:
...
async def get_image_store_root_folder_size(request: web.Request, api_version, timeout=None) -> web.Response:
