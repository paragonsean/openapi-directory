...
class ChaosStartedEvent(Model):
    ...
    def __init__(self, chaos_context: str=None, cluster_health_policy: str=None, included_application_list: str=None, included_node_type_list: str=None, max_cluster_stabilization_timeout_in_seconds: float=None, max_concurrent_faults: int=None, move_replica_fault_enabled: bool=None, time_to_run_in_seconds: float=None, wait_time_between_faults_in_seconds: float=None, wait_time_between_iterations_in_seconds: float=None, category: str=None, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None):
        ...
        :param wait_time_between_faults_in_seconds: The wait_time_between_faults_in_seconds of this ChaosStartedEvent.
        :param wait_time_between_iterations_in_seconds: The wait_time_between_iterations_in_seconds of this ChaosStartedEvent.
        :param category: The category of this ChaosStartedEvent.
    ...
    def wait_time_between_faults_in_seconds(self):
        """Gets the wait_time_between_faults_in_seconds of this ChaosStartedEvent.

        Wait time between faults in seconds.

        :return: The wait_time_between_faults_in_seconds of this ChaosStartedEvent.
        :rtype: float
        """
    ...
    def wait_time_between_faults_in_seconds(self, wait_time_between_faults_in_seconds):
        """Sets the wait_time_between_faults_in_seconds of this ChaosStartedEvent.
        ...
        """
        if wait_time_between_faults_in_seconds is None:
            raise ValueError("Invalid value for `wait_time_between_faults_in_seconds`, must not be `None`")
    ...
    @property
    def category(self):
        """Gets the category of this ChaosStartedEvent.

        The category of event.

        :return: The category of this ChaosStartedEvent.
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this ChaosStartedEvent.
