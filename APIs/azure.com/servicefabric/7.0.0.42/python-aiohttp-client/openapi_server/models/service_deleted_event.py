...
class ServiceDeletedEvent(Model):
    ...
    def __init__(self, application_name: str=None, application_type_name: str=None, is_stateful: bool=None, min_replica_set_size: int=None, partition_count: int=None, service_instance: int=None, service_package_version: str=None, service_type_name: str=None, target_replica_set_size: int=None, service_id: str=None, category: str=None, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None):
        ...
        :param category: The category of this ServiceDeletedEvent.
    ...
    @property
    def category(self):
        """Gets the category of this ServiceDeletedEvent.

        The category of event.

        :return: The category of this ServiceDeletedEvent.
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this ServiceDeletedEvent.
