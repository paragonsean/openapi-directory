...
class SecondaryReplicatorStatus(Model):
    ...
    def __init__(self, copy_queue_status: ReplicatorQueueStatus=None, is_in_build: bool=None, last_acknowledgement_sent_time_utc: datetime=None, last_copy_operation_received_time_utc: datetime=None, last_replication_operation_received_time_utc: datetime=None, replication_queue_status: ReplicatorQueueStatus=None, kind: ReplicaRole=None):
