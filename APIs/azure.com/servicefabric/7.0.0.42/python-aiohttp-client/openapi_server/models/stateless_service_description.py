...
class StatelessServiceDescription(Model):
    ...
    def instance_close_delay_duration_seconds(self):
        """Gets the instance_close_delay_duration_seconds of this StatelessServiceDescription.
        ...
        :return: The instance_close_delay_duration_seconds of this StatelessServiceDescription.
        :rtype: int
        """
    ...
    def instance_close_delay_duration_seconds(self, instance_close_delay_duration_seconds):
        """Sets the instance_close_delay_duration_seconds of this StatelessServiceDescription.

        Duration in seconds, to wait before a stateless instance is closed, to allow the active requests to drain gracefully. This would be effective when the instance is closing during the application/cluster upgrade and disabling node. The endpoint exposed on this instance is removed prior to starting the delay, which prevents new connections to this instance. In addition, clients that have subscribed to service endpoint change events(https://docs.microsoft.com/en-us/dotnet/api/system.fabric.fabricclient.servicemanagementclient.registerservicenotificationfilterasync), can do the following upon receiving the endpoint removal notification:     - Stop sending new requests to this instance.     - Close existing connections after in-flight requests have completed.     - Connect to a different instance of the service partition for future requests. Note, the default value of InstanceCloseDelayDuration is 0, which indicates that there won't be any delay or removal of the endpoint prior to closing the instance.

        :param instance_close_delay_duration_seconds: The instance_close_delay_duration_seconds of this StatelessServiceDescription.
        :type instance_close_delay_duration_seconds: int
        """
        if instance_close_delay_duration_seconds is not None and instance_close_delay_duration_seconds > 4294967295:
            raise ValueError("Invalid value for `instance_close_delay_duration_seconds`, must be a value less than or equal to `4294967295`")
        if instance_close_delay_duration_seconds is not None and instance_close_delay_duration_seconds < 0:
            raise ValueError("Invalid value for `instance_close_delay_duration_seconds`, must be a value greater than or equal to `0`")
    ...
    def min_instance_count(self):
        """Gets the min_instance_count of this StatelessServiceDescription.

        MinInstanceCount is the minimum number of instances that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstanceCount computation -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.

        :return: The min_instance_count of this StatelessServiceDescription.
        :rtype: int
        """
    ...
    def min_instance_count(self, min_instance_count):
        """Sets the min_instance_count of this StatelessServiceDescription.
    ...
    def min_instance_percentage(self):
        """Gets the min_instance_percentage of this StatelessServiceDescription.

        MinInstancePercentage is the minimum percentage of InstanceCount that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstancePercentage computation, -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.

        :return: The min_instance_percentage of this StatelessServiceDescription.
        :rtype: int
        """
    ...
    def min_instance_percentage(self, min_instance_percentage):
        """Sets the min_instance_percentage of this StatelessServiceDescription.
