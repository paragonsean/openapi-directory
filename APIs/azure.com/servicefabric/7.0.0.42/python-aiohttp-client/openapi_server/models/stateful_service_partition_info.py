...
class StatefulServicePartitionInfo(Model):
    ...
    def __init__(self, last_quorum_loss_duration: str=None, min_replica_set_size: int=None, primary_epoch: Epoch=None, target_replica_set_size: int=None, health_state: HealthState=None, partition_information: PartitionInformation=None, partition_status: ServicePartitionStatus=None, service_kind: ServiceKind=None):
        ...
        :param primary_epoch: The primary_epoch of this StatefulServicePartitionInfo.
    ...
    @property
    def primary_epoch(self):
        """Gets the primary_epoch of this StatefulServicePartitionInfo.


        :return: The primary_epoch of this StatefulServicePartitionInfo.
        :rtype: Epoch
        """
        return self._primary_epoch

    @primary_epoch.setter
    def primary_epoch(self, primary_epoch):
        """Sets the primary_epoch of this StatefulServicePartitionInfo.


        :param primary_epoch: The primary_epoch of this StatefulServicePartitionInfo.
        :type primary_epoch: Epoch
        """
