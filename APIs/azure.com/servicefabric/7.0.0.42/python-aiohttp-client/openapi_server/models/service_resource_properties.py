...
class ServiceResourceProperties(Model):
    ...
    def __init__(self, code_packages: List[ContainerCodePackageProperties]=None, diagnostics: DiagnosticsRef=None, network_refs: List[NetworkRef]=None, os_type: OperatingSystemType=None, auto_scaling_policies: List[AutoScalingPolicy]=None, description: str=None, dns_name: str=None, execution_policy: ExecutionPolicy=None, health_state: HealthState=None, identity_refs: List[ServiceIdentity]=None, replica_count: int=None, status: ResourceStatus=None, status_details: str=None, unhealthy_evaluation: str=None):
        ...
        :param dns_name: The dns_name of this ServiceResourceProperties.
        :param execution_policy: The execution_policy of this ServiceResourceProperties.
        :param health_state: The health_state of this ServiceResourceProperties.
        :param identity_refs: The identity_refs of this ServiceResourceProperties.
    ...
    @property
    def dns_name(self):
        """Gets the dns_name of this ServiceResourceProperties.

        Dns name of the service.

        :return: The dns_name of this ServiceResourceProperties.
        :rtype: str
        """
    ...
    def dns_name(self, dns_name):
        """Sets the dns_name of this ServiceResourceProperties.
    ...
    def execution_policy(self):
        """Gets the execution_policy of this ServiceResourceProperties.


        :return: The execution_policy of this ServiceResourceProperties.
    ...
    def execution_policy(self, execution_policy):
        """Sets the execution_policy of this ServiceResourceProperties.
    ...
    def identity_refs(self):
        """Gets the identity_refs of this ServiceResourceProperties.

        The service identity list.

        :return: The identity_refs of this ServiceResourceProperties.
    ...
    def identity_refs(self, identity_refs):
        """Sets the identity_refs of this ServiceResourceProperties.
