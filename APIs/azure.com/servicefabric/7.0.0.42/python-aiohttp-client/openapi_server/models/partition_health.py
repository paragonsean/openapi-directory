...
class PartitionHealth(Model):
    ...
    def __init__(self, partition_id: str=None, replica_health_states: List[ReplicaHealthState]=None, aggregated_health_state: HealthState=None, health_events: List[HealthEvent]=None, health_statistics: HealthStatistics=None, unhealthy_evaluations: List[HealthEvaluationWrapper]=None):
