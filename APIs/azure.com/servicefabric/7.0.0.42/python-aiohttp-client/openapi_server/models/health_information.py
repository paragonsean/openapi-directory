...
class HealthInformation(Model):
    ...
    def __init__(self, description: str=None, health_report_id: str=None, health_state: HealthState=None, _property: str=None, remove_when_expired: bool=None, sequence_number: str=None, source_id: str=None, time_to_live_in_milli_seconds: str=None):
        """HealthInformation - a model defined in OpenAPI

        :param description: The description of this HealthInformation.
        :param health_report_id: The health_report_id of this HealthInformation.
    ...
    def health_report_id(self):
        """Gets the health_report_id of this HealthInformation.
        ...
        :return: The health_report_id of this HealthInformation.
        :rtype: str
        """
    ...
    def health_report_id(self, health_report_id):
        """Sets the health_report_id of this HealthInformation.
