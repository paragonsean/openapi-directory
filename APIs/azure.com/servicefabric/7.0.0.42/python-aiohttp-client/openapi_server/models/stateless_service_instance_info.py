...
class StatelessServiceInstanceInfo(Model):
    ...
    def __init__(self, instance_id: str=None, address: str=None, health_state: HealthState=None, last_in_build_duration_in_seconds: str=None, node_name: str=None, replica_status: ReplicaStatus=None, service_kind: ServiceKind=None):
