...
class ChaosParameters(Model):
    ...
    def __init__(self, chaos_target_filter: ChaosTargetFilter=None, cluster_health_policy: ClusterHealthPolicy=None, context: ChaosContext=None, enable_move_replica_faults: bool=True, max_cluster_stabilization_timeout_in_seconds: int=60, max_concurrent_faults: int=1, time_to_run_in_seconds: str='4294967295', wait_time_between_faults_in_seconds: int=20, wait_time_between_iterations_in_seconds: int=30):
        ...
        self._chaos_target_filter = chaos_target_filter
    ...
    @property
    def chaos_target_filter(self):
        """Gets the chaos_target_filter of this ChaosParameters.


        :return: The chaos_target_filter of this ChaosParameters.
        :rtype: ChaosTargetFilter
        """
        return self._chaos_target_filter

    @chaos_target_filter.setter
    def chaos_target_filter(self, chaos_target_filter):
        """Sets the chaos_target_filter of this ChaosParameters.


        :param chaos_target_filter: The chaos_target_filter of this ChaosParameters.
        :type chaos_target_filter: ChaosTargetFilter
        """
