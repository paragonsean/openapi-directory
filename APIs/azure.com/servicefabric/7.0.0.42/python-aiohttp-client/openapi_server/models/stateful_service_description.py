...
class StatefulServiceDescription(Model):
    ...
    def __init__(self, flags: int=None, has_persisted_state: bool=None, min_replica_set_size: int=None, quorum_loss_wait_duration_seconds: int=None, replica_restart_wait_duration_seconds: int=None, service_placement_time_limit_seconds: int=None, stand_by_replica_keep_duration_seconds: int=None, target_replica_set_size: int=None, application_name: str=None, correlation_scheme: List[ServiceCorrelationDescription]=None, default_move_cost: MoveCost=None, initialization_data: List[int]=None, is_default_move_cost_specified: bool=None, partition_description: PartitionSchemeDescription=None, placement_constraints: str=None, scaling_policies: List[ScalingPolicyDescription]=None, service_dns_name: str=None, service_kind: ServiceKind=None, service_load_metrics: List[ServiceLoadMetricDescription]=None, service_name: str=None, service_package_activation_mode: ServicePackageActivationMode=None, service_placement_policies: List[ServicePlacementPolicyDescription]=None, service_type_name: str=None):
        ...
        :param service_placement_time_limit_seconds: The service_placement_time_limit_seconds of this StatefulServiceDescription.
        ...
        :param scaling_policies: The scaling_policies of this StatefulServiceDescription.
    ...
    def service_placement_time_limit_seconds(self):
        """Gets the service_placement_time_limit_seconds of this StatefulServiceDescription.

        The duration for which replicas can stay InBuild before reporting that build is stuck.

        :return: The service_placement_time_limit_seconds of this StatefulServiceDescription.
        :rtype: int
        """
    ...
    def service_placement_time_limit_seconds(self, service_placement_time_limit_seconds):
        """Sets the service_placement_time_limit_seconds of this StatefulServiceDescription.

        The duration for which replicas can stay InBuild before reporting that build is stuck.

        :param service_placement_time_limit_seconds: The service_placement_time_limit_seconds of this StatefulServiceDescription.
        :type service_placement_time_limit_seconds: int
        """
        if service_placement_time_limit_seconds is not None and service_placement_time_limit_seconds > 4294967295:
            raise ValueError("Invalid value for `service_placement_time_limit_seconds`, must be a value less than or equal to `4294967295`")
        if service_placement_time_limit_seconds is not None and service_placement_time_limit_seconds < 0:
            raise ValueError("Invalid value for `service_placement_time_limit_seconds`, must be a value greater than or equal to `0`")
    ...
    def scaling_policies(self):
        """Gets the scaling_policies of this StatefulServiceDescription.

        A list that describes the scaling policies.

        :return: The scaling_policies of this StatefulServiceDescription.
    ...
    def scaling_policies(self, scaling_policies):
        """Sets the scaling_policies of this StatefulServiceDescription.
