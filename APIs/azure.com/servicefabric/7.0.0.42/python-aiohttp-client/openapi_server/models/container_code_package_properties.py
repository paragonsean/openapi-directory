...
class ContainerCodePackageProperties(Model):
    ...
    def __init__(self, commands: List[str]=None, diagnostics: DiagnosticsRef=None, endpoints: List[EndpointProperties]=None, entrypoint: str=None, environment_variables: List[EnvironmentVariable]=None, image: str=None, image_registry_credential: ImageRegistryCredential=None, instance_view: ContainerInstanceView=None, labels: List[ContainerLabel]=None, liveness_probe: List[Probe]=None, name: str=None, readiness_probe: List[Probe]=None, reliable_collections_refs: List[ReliableCollectionsRef]=None, resources: ResourceRequirements=None, settings: List[Setting]=None, volume_refs: List[VolumeReference]=None, volumes: List[ApplicationScopedVolume]=None):
        ...
        :param liveness_probe: The liveness_probe of this ContainerCodePackageProperties.
        :param name: The name of this ContainerCodePackageProperties.
        :param readiness_probe: The readiness_probe of this ContainerCodePackageProperties.
    ...
    def liveness_probe(self):
        """Gets the liveness_probe of this ContainerCodePackageProperties.

        An array of liveness probes for a code package. It determines when to restart a code package.

        :return: The liveness_probe of this ContainerCodePackageProperties.
        :rtype: List[Probe]
        """
    ...
    def liveness_probe(self, liveness_probe):
        """Sets the liveness_probe of this ContainerCodePackageProperties.

        An array of liveness probes for a code package. It determines when to restart a code package.

        :param liveness_probe: The liveness_probe of this ContainerCodePackageProperties.
        :type liveness_probe: List[Probe]
        """
    ...
    def readiness_probe(self):
        """Gets the readiness_probe of this ContainerCodePackageProperties.

        An array of readiness probes for a code package. It determines when to unpublish an endpoint.

        :return: The readiness_probe of this ContainerCodePackageProperties.
        :rtype: List[Probe]
        """
    ...
    def readiness_probe(self, readiness_probe):
        """Sets the readiness_probe of this ContainerCodePackageProperties.

        An array of readiness probes for a code package. It determines when to unpublish an endpoint.

        :param readiness_probe: The readiness_probe of this ContainerCodePackageProperties.
        :type readiness_probe: List[Probe]
        """
