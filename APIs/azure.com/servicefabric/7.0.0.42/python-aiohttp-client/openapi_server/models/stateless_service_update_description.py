...
class StatelessServiceUpdateDescription(Model):
    ...
    def __init__(self, instance_close_delay_duration_seconds: str=None, instance_count: int=None, min_instance_count: int=1, min_instance_percentage: int=0, correlation_scheme: List[ServiceCorrelationDescription]=None, default_move_cost: MoveCost=None, flags: str=None, load_metrics: List[ServiceLoadMetricDescription]=None, placement_constraints: str=None, scaling_policies: List[ScalingPolicyDescription]=None, service_kind: ServiceKind=None, service_placement_policies: List[ServicePlacementPolicyDescription]=None):
        """StatelessServiceUpdateDescription - a model defined in OpenAPI

        :param instance_close_delay_duration_seconds: The instance_close_delay_duration_seconds of this StatelessServiceUpdateDescription.
        :param instance_count: The instance_count of this StatelessServiceUpdateDescription.
        :param min_instance_count: The min_instance_count of this StatelessServiceUpdateDescription.
        :param min_instance_percentage: The min_instance_percentage of this StatelessServiceUpdateDescription.
        ...
        self.attribute_map = {
            'instance_close_delay_duration_seconds': 'InstanceCloseDelayDurationSeconds',
        ...
        self._instance_close_delay_duration_seconds = instance_close_delay_duration_seconds
    ...
    @property
    def instance_close_delay_duration_seconds(self):
        """Gets the instance_close_delay_duration_seconds of this StatelessServiceUpdateDescription.
        ...
        :return: The instance_close_delay_duration_seconds of this StatelessServiceUpdateDescription.
        :rtype: str
        """
        return self._instance_close_delay_duration_seconds

    @instance_close_delay_duration_seconds.setter
    def instance_close_delay_duration_seconds(self, instance_close_delay_duration_seconds):
        """Sets the instance_close_delay_duration_seconds of this StatelessServiceUpdateDescription.
    ...
    def min_instance_count(self):
        """Gets the min_instance_count of this StatelessServiceUpdateDescription.

        MinInstanceCount is the minimum number of instances that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstanceCount computation -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.

        :return: The min_instance_count of this StatelessServiceUpdateDescription.
        :rtype: int
        """
    ...
    def min_instance_count(self, min_instance_count):
        """Sets the min_instance_count of this StatelessServiceUpdateDescription.
    ...
    def min_instance_percentage(self):
        """Gets the min_instance_percentage of this StatelessServiceUpdateDescription.

        MinInstancePercentage is the minimum percentage of InstanceCount that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstancePercentage computation, -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.

        :return: The min_instance_percentage of this StatelessServiceUpdateDescription.
        :rtype: int
        """
    ...
    def min_instance_percentage(self, min_instance_percentage):
        """Sets the min_instance_percentage of this StatelessServiceUpdateDescription.
