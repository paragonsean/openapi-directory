 ...
 */
@JsonAdapter(SettingType.Adapter.class)
public enum SettingType {
  ...
  public static class Adapter extends TypeAdapter<SettingType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SettingType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SettingType read(final JsonReader jsonReader) throws IOException {
