...
public class HealthEvent {
  ...
  public static final String SERIALIZED_NAME_HEALTH_REPORT_ID = "HealthReportId";
  @SerializedName(SERIALIZED_NAME_HEALTH_REPORT_ID)
  ...
  public HealthEvent healthReportId(String healthReportId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isExpired, healthEvent.isExpired) &&
        ...
        Objects.equals(this.description, healthEvent.description) &&
        Objects.equals(this.healthReportId, healthEvent.healthReportId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isExpired, lastErrorTransitionAt, lastModifiedUtcTimestamp, lastOkTransitionAt, lastWarningTransitionAt, sourceUtcTimestamp, description, healthReportId, healthState, property, removeWhenExpired, sequenceNumber, sourceId, timeToLiveInMilliSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("    healthReportId: ").append(toIndentedString(healthReportId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("HealthReportId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("HealthReportId") != null && !jsonObj.get("HealthReportId").isJsonNull()) && !jsonObj.get("HealthReportId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `HealthReportId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("HealthReportId").toString()));
      }
