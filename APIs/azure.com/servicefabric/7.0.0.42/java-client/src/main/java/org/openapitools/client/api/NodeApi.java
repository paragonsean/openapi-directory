...
import org.openapitools.client.model.ConfigParameterOverride;
...
public class NodeApi {
    ...
    /**
     * Build call for addConfigurationParameterOverrides
     ...
     * @param configParameterOverrideList Description for adding list of configuration overrides. (required)
     * @param force Force adding configuration overrides on specified nodes. (optional)
     ...
     */
    public okhttp3.Call addConfigurationParameterOverridesCall(String apiVersion, String nodeName, List<ConfigParameterOverride> configParameterOverrideList, Boolean force, Long timeout, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = configParameterOverrideList;

        // create path and map variables
        String localVarPath = "/Nodes/{nodeName}/$/AddConfigurationParameterOverrides"
    ...
    private okhttp3.Call addConfigurationParameterOverridesValidateBeforeCall(String apiVersion, String nodeName, List<ConfigParameterOverride> configParameterOverrideList, Boolean force, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling addConfigurationParameterOverrides(Async)");
        }

        // verify the required parameter 'nodeName' is set
        if (nodeName == null) {
            throw new ApiException("Missing the required parameter 'nodeName' when calling addConfigurationParameterOverrides(Async)");
        }

        // verify the required parameter 'configParameterOverrideList' is set
        if (configParameterOverrideList == null) {
            throw new ApiException("Missing the required parameter 'configParameterOverrideList' when calling addConfigurationParameterOverrides(Async)");
        }

        return addConfigurationParameterOverridesCall(apiVersion, nodeName, configParameterOverrideList, force, timeout, _callback);
     ...
     */
    public void addConfigurationParameterOverrides(String apiVersion, String nodeName, List<ConfigParameterOverride> configParameterOverrideList, Boolean force, Long timeout) throws ApiException {
        addConfigurationParameterOverridesWithHttpInfo(apiVersion, nodeName, configParameterOverrideList, force, timeout);
    }
     ...
     */
    public ApiResponse<Void> addConfigurationParameterOverridesWithHttpInfo(String apiVersion, String nodeName, List<ConfigParameterOverride> configParameterOverrideList, Boolean force, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = addConfigurationParameterOverridesValidateBeforeCall(apiVersion, nodeName, configParameterOverrideList, force, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Adds the list of configuration overrides on the specified node. (asynchronously)
     * This api allows adding all existing configuration overrides on the specified node.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;7.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param nodeName The name of the node. (required)
     * @param configParameterOverrideList Description for adding list of configuration overrides. (required)
     ...
     */
    public okhttp3.Call addConfigurationParameterOverridesAsync(String apiVersion, String nodeName, List<ConfigParameterOverride> configParameterOverrideList, Boolean force, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addConfigurationParameterOverridesValidateBeforeCall(apiVersion, nodeName, configParameterOverrideList, force, timeout, _callback);
    ...
    /**
     * Build call for getConfigurationOverrides
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;7.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param nodeName The name of the node. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback Callback for upload/download progress
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> List of configuration overrides on the node. </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> The detailed error response. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getConfigurationOverridesCall(String apiVersion, String nodeName, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/Nodes/{nodeName}/$/GetConfigurationOverrides"
            .replace("{" + "nodeName" + "}", localVarApiClient.escapeString(nodeName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getConfigurationOverridesValidateBeforeCall(String apiVersion, String nodeName, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getConfigurationOverrides(Async)");
        }

        // verify the required parameter 'nodeName' is set
        if (nodeName == null) {
            throw new ApiException("Missing the required parameter 'nodeName' when calling getConfigurationOverrides(Async)");
        }

        return getConfigurationOverridesCall(apiVersion, nodeName, timeout, _callback);
     ...
     * @param nodeName The name of the node. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @return List&lt;ConfigParameterOverride&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public List<ConfigParameterOverride> getConfigurationOverrides(String apiVersion, String nodeName, Long timeout) throws ApiException {
        ApiResponse<List<ConfigParameterOverride>> localVarResp = getConfigurationOverridesWithHttpInfo(apiVersion, nodeName, timeout);
     ...
     * @param nodeName The name of the node. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @return ApiResponse&lt;List&lt;ConfigParameterOverride&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ConfigParameterOverride>> getConfigurationOverridesWithHttpInfo(String apiVersion, String nodeName, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = getConfigurationOverridesValidateBeforeCall(apiVersion, nodeName, timeout, null);
        Type localVarReturnType = new TypeToken<List<ConfigParameterOverride>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Gets the list of configuration overrides on the specified node. (asynchronously)
     * This api allows getting all existing configuration overrides on the specified node.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;7.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param nodeName The name of the node. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     ...
     */
    public okhttp3.Call getConfigurationOverridesAsync(String apiVersion, String nodeName, Long timeout, final ApiCallback<List<ConfigParameterOverride>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getConfigurationOverridesValidateBeforeCall(apiVersion, nodeName, timeout, _callback);
        Type localVarReturnType = new TypeToken<List<ConfigParameterOverride>>(){}.getType();
    ...
    /**
     * Build call for removeConfigurationOverrides
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;7.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param nodeName The name of the node. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call removeConfigurationOverridesCall(String apiVersion, String nodeName, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/Nodes/{nodeName}/$/RemoveConfigurationOverrides"
            .replace("{" + "nodeName" + "}", localVarApiClient.escapeString(nodeName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeConfigurationOverridesValidateBeforeCall(String apiVersion, String nodeName, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling removeConfigurationOverrides(Async)");
        }

        // verify the required parameter 'nodeName' is set
        if (nodeName == null) {
            throw new ApiException("Missing the required parameter 'nodeName' when calling removeConfigurationOverrides(Async)");
        }

        return removeConfigurationOverridesCall(apiVersion, nodeName, timeout, _callback);
     ...
     */
    public void removeConfigurationOverrides(String apiVersion, String nodeName, Long timeout) throws ApiException {
        removeConfigurationOverridesWithHttpInfo(apiVersion, nodeName, timeout);
    }
     ...
     */
    public ApiResponse<Void> removeConfigurationOverridesWithHttpInfo(String apiVersion, String nodeName, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = removeConfigurationOverridesValidateBeforeCall(apiVersion, nodeName, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Removes configuration overrides on the specified node. (asynchronously)
     * This api allows removing all existing configuration overrides on specified node.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;7.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param nodeName The name of the node. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     ...
     */
    public okhttp3.Call removeConfigurationOverridesAsync(String apiVersion, String nodeName, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeConfigurationOverridesValidateBeforeCall(apiVersion, nodeName, timeout, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
