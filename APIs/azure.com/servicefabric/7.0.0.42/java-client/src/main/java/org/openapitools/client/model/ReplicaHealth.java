...
public class ReplicaHealth {
  ...
  public ReplicaHealth partitionId(UUID partitionId) {
  ...
  public ReplicaHealth serviceKind(ServiceKind serviceKind) {
  ...
  public ReplicaHealth aggregatedHealthState(HealthState aggregatedHealthState) {
  ...
  public ReplicaHealth healthEvents(List<HealthEvent> healthEvents) {
    this.healthEvents = healthEvents;
    return this;
  }

  public ReplicaHealth addHealthEventsItem(HealthEvent healthEventsItem) {
  ...
  public ReplicaHealth healthStatistics(HealthStatistics healthStatistics) {
  ...
  public ReplicaHealth unhealthyEvaluations(List<HealthEvaluationWrapper> unhealthyEvaluations) {
    this.unhealthyEvaluations = unhealthyEvaluations;
    return this;
  }

  public ReplicaHealth addUnhealthyEvaluationsItem(HealthEvaluationWrapper unhealthyEvaluationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ReplicaHealth replicaHealth = (ReplicaHealth) o;
    return Objects.equals(this.partitionId, replicaHealth.partitionId) &&
        Objects.equals(this.serviceKind, replicaHealth.serviceKind) &&
        Objects.equals(this.aggregatedHealthState, replicaHealth.aggregatedHealthState) &&
        Objects.equals(this.healthEvents, replicaHealth.healthEvents) &&
        Objects.equals(this.healthStatistics, replicaHealth.healthStatistics) &&
        Objects.equals(this.unhealthyEvaluations, replicaHealth.unhealthyEvaluations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(partitionId, serviceKind, aggregatedHealthState, healthEvents, healthStatistics, unhealthyEvaluations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReplicaHealth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicaHealth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicaHealth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicaHealth is not found in the empty JSON string", ReplicaHealth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicaHealth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicaHealth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReplicaHealth.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicaHealth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicaHealth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicaHealth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicaHealth.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicaHealth>() {
           @Override
           public void write(JsonWriter out, ReplicaHealth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicaHealth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicaHealth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicaHealth
   * @throws IOException if the JSON string is invalid with respect to ReplicaHealth
   */
  public static ReplicaHealth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicaHealth.class);
  }

  /**
   * Convert an instance of ReplicaHealth to an JSON string
   *
   * @return JSON string
   */
