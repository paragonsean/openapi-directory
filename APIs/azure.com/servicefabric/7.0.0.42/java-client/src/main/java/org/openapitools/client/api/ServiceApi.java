...
import org.openapitools.client.model.UnplacedReplicaInformation;
...
public class ServiceApi {
     ...
     */
    public okhttp3.Call createServiceCall(String apiVersion, String applicationId, ServiceDescription serviceDescription, Long timeout, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createServiceValidateBeforeCall(String apiVersion, String applicationId, ServiceDescription serviceDescription, Long timeout, final ApiCallback _callback) throws ApiException {
        ...
        return createServiceCall(apiVersion, applicationId, serviceDescription, timeout, _callback);
     ...
     */
    public void createService(String apiVersion, String applicationId, ServiceDescription serviceDescription, Long timeout) throws ApiException {
        createServiceWithHttpInfo(apiVersion, applicationId, serviceDescription, timeout);
    }
     ...
     */
    public ApiResponse<Void> createServiceWithHttpInfo(String apiVersion, String applicationId, ServiceDescription serviceDescription, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = createServiceValidateBeforeCall(apiVersion, applicationId, serviceDescription, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Creates the specified Service Fabric service. (asynchronously)
     * This api allows creating a new Service Fabric stateless or stateful service under a specified Service Fabric application. The description for creating the service includes partitioning information and optional properties for placement and load balancing. Some of the properties can later be modified using &#x60;UpdateService&#x60; API.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param applicationId The identity of the application. This is typically the full name of the application without the &#39;fabric:&#39; URI scheme. Starting from version 6.0, hierarchical names are delimited with the \&quot;~\&quot; character. For example, if the application name is \&quot;fabric:/myapp/app1\&quot;, the application identity would be \&quot;myapp~app1\&quot; in 6.0+ and \&quot;myapp/app1\&quot; in previous versions. (required)
     * @param serviceDescription The information necessary to create a service. (required)
     ...
     */
    public okhttp3.Call createServiceAsync(String apiVersion, String applicationId, ServiceDescription serviceDescription, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createServiceValidateBeforeCall(apiVersion, applicationId, serviceDescription, timeout, _callback);
     ...
     */
    public okhttp3.Call createServiceFromTemplateCall(String apiVersion, String applicationId, ServiceFromTemplateDescription serviceFromTemplateDescription, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createServiceFromTemplateValidateBeforeCall(String apiVersion, String applicationId, ServiceFromTemplateDescription serviceFromTemplateDescription, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
        ...
        return createServiceFromTemplateCall(apiVersion, applicationId, serviceFromTemplateDescription, timeout, _callback);
     ...
     */
    public void createServiceFromTemplate(String apiVersion, String applicationId, ServiceFromTemplateDescription serviceFromTemplateDescription, Long timeout) throws ApiException {
        createServiceFromTemplateWithHttpInfo(apiVersion, applicationId, serviceFromTemplateDescription, timeout);
    }
     ...
     */
    public ApiResponse<Void> createServiceFromTemplateWithHttpInfo(String apiVersion, String applicationId, ServiceFromTemplateDescription serviceFromTemplateDescription, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = createServiceFromTemplateValidateBeforeCall(apiVersion, applicationId, serviceFromTemplateDescription, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Creates a Service Fabric service from the service template. (asynchronously)
     * Creates a Service Fabric service from the service template defined in the application manifest. A service template contains the properties that will be same for the service instance of the same type. The API allows overriding the properties that are usually different for different services of the same service type.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param applicationId The identity of the application. This is typically the full name of the application without the &#39;fabric:&#39; URI scheme. Starting from version 6.0, hierarchical names are delimited with the \&quot;~\&quot; character. For example, if the application name is \&quot;fabric:/myapp/app1\&quot;, the application identity would be \&quot;myapp~app1\&quot; in 6.0+ and \&quot;myapp/app1\&quot; in previous versions. (required)
     * @param serviceFromTemplateDescription Describes the service that needs to be created from the template defined in the application manifest. (required)
     ...
     */
    public okhttp3.Call createServiceFromTemplateAsync(String apiVersion, String applicationId, ServiceFromTemplateDescription serviceFromTemplateDescription, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createServiceFromTemplateValidateBeforeCall(apiVersion, applicationId, serviceFromTemplateDescription, timeout, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    /**
     * Gets the information about the specific service belonging to the Service Fabric application. (asynchronously)
     * Returns the information about the specified service belonging to the specified Service Fabric application.
     * @param applicationId The identity of the application. This is typically the full name of the application without the &#39;fabric:&#39; URI scheme. Starting from version 6.0, hierarchical names are delimited with the \&quot;~\&quot; character. For example, if the application name is \&quot;fabric:/myapp/app1\&quot;, the application identity would be \&quot;myapp~app1\&quot; in 6.0+ and \&quot;myapp/app1\&quot; in previous versions. (required)
     * @param serviceId The identity of the service. This ID is typically the full name of the service without the &#39;fabric:&#39; URI scheme. Starting from version 6.0, hierarchical names are delimited with the \&quot;~\&quot; character. For example, if the service name is \&quot;fabric:/myapp/app1/svc1\&quot;, the service identity would be \&quot;myapp~app1~svc1\&quot; in 6.0+ and \&quot;myapp/app1/svc1\&quot; in previous versions. (required)
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
    ...
    /**
     * Build call for getUnplacedReplicaInformation
     ...
     * @param onlyQueryPrimaries Indicates that unplaced replica information will be queries only for primary replicas. (optional, default to false)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getUnplacedReplicaInformationCall(String apiVersion, String serviceId, UUID partitionId, Boolean onlyQueryPrimaries, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/Services/{serviceId}/$/GetUnplacedReplicaInformation"
            .replace("{" + "serviceId" + "}", localVarApiClient.escapeString(serviceId.toString()));
        ...
        if (onlyQueryPrimaries != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("OnlyQueryPrimaries", onlyQueryPrimaries));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUnplacedReplicaInformationValidateBeforeCall(String apiVersion, String serviceId, UUID partitionId, Boolean onlyQueryPrimaries, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling getUnplacedReplicaInformation(Async)");
        }

        // verify the required parameter 'serviceId' is set
        if (serviceId == null) {
            throw new ApiException("Missing the required parameter 'serviceId' when calling getUnplacedReplicaInformation(Async)");
        }

        return getUnplacedReplicaInformationCall(apiVersion, serviceId, partitionId, onlyQueryPrimaries, timeout, _callback);
     ...
     */
    public UnplacedReplicaInformation getUnplacedReplicaInformation(String apiVersion, String serviceId, UUID partitionId, Boolean onlyQueryPrimaries, Long timeout) throws ApiException {
        ApiResponse<UnplacedReplicaInformation> localVarResp = getUnplacedReplicaInformationWithHttpInfo(apiVersion, serviceId, partitionId, onlyQueryPrimaries, timeout);
        return localVarResp.getData();
    }
     ...
     * @param onlyQueryPrimaries Indicates that unplaced replica information will be queries only for primary replicas. (optional, default to false)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @return ApiResponse&lt;UnplacedReplicaInformation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<UnplacedReplicaInformation> getUnplacedReplicaInformationWithHttpInfo(String apiVersion, String serviceId, UUID partitionId, Boolean onlyQueryPrimaries, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = getUnplacedReplicaInformationValidateBeforeCall(apiVersion, serviceId, partitionId, onlyQueryPrimaries, timeout, null);
        Type localVarReturnType = new TypeToken<UnplacedReplicaInformation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Gets the information about unplaced replica of the service. (asynchronously)
     * Returns the information about the unplaced replicas of the service. If PartitionId is specified, then result will contain information only about unplaced replicas for that partition. If PartitionId is not specified, then result will contain information about unplaced replicas for all partitions of that service. If OnlyQueryPrimaries is set to true, then result will contain information only about primary replicas, and will ignore unplaced secondary replicas.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.4&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param serviceId The identity of the service. This ID is typically the full name of the service without the &#39;fabric:&#39; URI scheme. Starting from version 6.0, hierarchical names are delimited with the \&quot;~\&quot; character. For example, if the service name is \&quot;fabric:/myapp/app1/svc1\&quot;, the service identity would be \&quot;myapp~app1~svc1\&quot; in 6.0+ and \&quot;myapp/app1/svc1\&quot; in previous versions. (required)
     * @param partitionId The identity of the partition. (optional)
     ...
     */
    public okhttp3.Call getUnplacedReplicaInformationAsync(String apiVersion, String serviceId, UUID partitionId, Boolean onlyQueryPrimaries, Long timeout, final ApiCallback<UnplacedReplicaInformation> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUnplacedReplicaInformationValidateBeforeCall(apiVersion, serviceId, partitionId, onlyQueryPrimaries, timeout, _callback);
        Type localVarReturnType = new TypeToken<UnplacedReplicaInformation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param previousRspVersion The value in the Version field of the response that was received previously. This is required if the user knows that the result that was gotten previously is stale. (optional)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Updates a Service Fabric service using the specified update description. (asynchronously)
     * This API allows updating properties of a running Service Fabric service. The set of properties that can be updated are a subset of the properties that were specified at the time of creating the service. The current set of properties can be obtained using &#x60;GetServiceDescription&#x60; API. Note that updating the properties of a running service is different than upgrading your application using &#x60;StartApplicationUpgrade&#x60; API. The upgrade is a long running background operation that involves moving the application from one version to another, one upgrade domain at a time, whereas update applies the new properties immediately to the service.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param serviceId The identity of the service. This ID is typically the full name of the service without the &#39;fabric:&#39; URI scheme. Starting from version 6.0, hierarchical names are delimited with the \&quot;~\&quot; character. For example, if the service name is \&quot;fabric:/myapp/app1/svc1\&quot;, the service identity would be \&quot;myapp~app1~svc1\&quot; in 6.0+ and \&quot;myapp/app1/svc1\&quot; in previous versions. (required)
     * @param serviceUpdateDescription The information necessary to update a service. (required)
