...
public class ContainerCodePackageProperties {
  ...
  private List<Probe> livenessProbe = new ArrayList<>();
  ...
  private List<Probe> readinessProbe = new ArrayList<>();
  ...
  public ContainerCodePackageProperties livenessProbe(List<Probe> livenessProbe) {
    this.livenessProbe = livenessProbe;
    return this;
  }

  public ContainerCodePackageProperties addLivenessProbeItem(Probe livenessProbeItem) {
    if (this.livenessProbe == null) {
      this.livenessProbe = new ArrayList<>();
    }
    this.livenessProbe.add(livenessProbeItem);
    return this;
  }
  ...
  public void setLivenessProbe(List<Probe> livenessProbe) {
    this.livenessProbe = livenessProbe;
  }
  ...
  public ContainerCodePackageProperties readinessProbe(List<Probe> readinessProbe) {
    this.readinessProbe = readinessProbe;
    return this;
  }

  public ContainerCodePackageProperties addReadinessProbeItem(Probe readinessProbeItem) {
    if (this.readinessProbe == null) {
      this.readinessProbe = new ArrayList<>();
    }
    this.readinessProbe.add(readinessProbeItem);
    return this;
  }
  ...
  public void setReadinessProbe(List<Probe> readinessProbe) {
    this.readinessProbe = readinessProbe;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commands, containerCodePackageProperties.commands) &&
        ...
        Objects.equals(this.livenessProbe, containerCodePackageProperties.livenessProbe) &&
        Objects.equals(this.name, containerCodePackageProperties.name) &&
        Objects.equals(this.readinessProbe, containerCodePackageProperties.readinessProbe) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commands, diagnostics, endpoints, entrypoint, environmentVariables, image, imageRegistryCredential, instanceView, labels, livenessProbe, name, readinessProbe, reliableCollectionsRefs, resources, settings, volumeRefs, volumes);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("livenessProbe") != null && !jsonObj.get("livenessProbe").isJsonNull()) {
        JsonArray jsonArraylivenessProbe = jsonObj.getAsJsonArray("livenessProbe");
        if (jsonArraylivenessProbe != null) {
          // ensure the json data is an array
          if (!jsonObj.get("livenessProbe").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `livenessProbe` to be an array in the JSON string but got `%s`", jsonObj.get("livenessProbe").toString()));
          }

          // validate the optional field `livenessProbe` (array)
          for (int i = 0; i < jsonArraylivenessProbe.size(); i++) {
            Probe.validateJsonElement(jsonArraylivenessProbe.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("readinessProbe") != null && !jsonObj.get("readinessProbe").isJsonNull()) {
        JsonArray jsonArrayreadinessProbe = jsonObj.getAsJsonArray("readinessProbe");
        if (jsonArrayreadinessProbe != null) {
          // ensure the json data is an array
          if (!jsonObj.get("readinessProbe").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `readinessProbe` to be an array in the JSON string but got `%s`", jsonObj.get("readinessProbe").toString()));
          }

          // validate the optional field `readinessProbe` (array)
          for (int i = 0; i < jsonArrayreadinessProbe.size(); i++) {
            Probe.validateJsonElement(jsonArrayreadinessProbe.get(i));
          };
        }
      }
