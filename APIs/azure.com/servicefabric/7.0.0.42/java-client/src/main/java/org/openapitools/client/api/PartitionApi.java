...
public class PartitionApi {
    ...
    /**
     * Gets the load information of the specified Service Fabric partition. (asynchronously)
     * Returns information about the load of a specified partition. The response includes a list of load reports for a Service Fabric partition. Each report includes the load metric name, value, and last reported time in UTC.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param partitionId The identity of the partition. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
    ...
    /**
     * Build call for movePrimaryReplica
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.5&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param partitionId The identity of the partition. (required)
     * @param nodeName The name of the node. (optional)
     * @param ignoreConstraints Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. (optional, default to false)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call movePrimaryReplicaCall(String apiVersion, UUID partitionId, String nodeName, Boolean ignoreConstraints, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/Partitions/{partitionId}/$/MovePrimaryReplica"
            .replace("{" + "partitionId" + "}", localVarApiClient.escapeString(partitionId.toString()));
        ...
        if (nodeName != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("NodeName", nodeName));
        }

        if (ignoreConstraints != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("IgnoreConstraints", ignoreConstraints));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call movePrimaryReplicaValidateBeforeCall(String apiVersion, UUID partitionId, String nodeName, Boolean ignoreConstraints, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling movePrimaryReplica(Async)");
        }

        // verify the required parameter 'partitionId' is set
        if (partitionId == null) {
            throw new ApiException("Missing the required parameter 'partitionId' when calling movePrimaryReplica(Async)");
        }

        return movePrimaryReplicaCall(apiVersion, partitionId, nodeName, ignoreConstraints, timeout, _callback);
     ...
     */
    public void movePrimaryReplica(String apiVersion, UUID partitionId, String nodeName, Boolean ignoreConstraints, Long timeout) throws ApiException {
        movePrimaryReplicaWithHttpInfo(apiVersion, partitionId, nodeName, ignoreConstraints, timeout);
    }
     ...
     */
    public ApiResponse<Void> movePrimaryReplicaWithHttpInfo(String apiVersion, UUID partitionId, String nodeName, Boolean ignoreConstraints, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = movePrimaryReplicaValidateBeforeCall(apiVersion, partitionId, nodeName, ignoreConstraints, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Moves the primary replica of a partition of a stateful service. (asynchronously)
     * This command moves the primary replica of a partition of a stateful service, respecting all constraints. If NodeName parameter is specified, primary will be moved to the specified node (if constraints allow it). If NodeName parameter is not specified, primary replica will be moved to a random node in the cluster. If IgnoreConstraints parameter is specified and set to true, then primary will be moved regardless of the constraints.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.5&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param partitionId The identity of the partition. (required)
     * @param nodeName The name of the node. (optional)
     ...
     */
    public okhttp3.Call movePrimaryReplicaAsync(String apiVersion, UUID partitionId, String nodeName, Boolean ignoreConstraints, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = movePrimaryReplicaValidateBeforeCall(apiVersion, partitionId, nodeName, ignoreConstraints, timeout, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for moveSecondaryReplica
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.5&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param partitionId The identity of the partition. (required)
     * @param currentNodeName The name of the source node for secondary replica move. (required)
     * @param newNodeName The name of the target node for secondary replica move. If not specified, replica is moved to a random node. (optional)
     * @param ignoreConstraints Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. (optional, default to false)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call moveSecondaryReplicaCall(String apiVersion, UUID partitionId, String currentNodeName, String newNodeName, Boolean ignoreConstraints, Long timeout, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/Partitions/{partitionId}/$/MoveSecondaryReplica"
            .replace("{" + "partitionId" + "}", localVarApiClient.escapeString(partitionId.toString()));
        ...
        if (currentNodeName != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("CurrentNodeName", currentNodeName));
        }

        if (newNodeName != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("NewNodeName", newNodeName));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call moveSecondaryReplicaValidateBeforeCall(String apiVersion, UUID partitionId, String currentNodeName, String newNodeName, Boolean ignoreConstraints, Long timeout, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling moveSecondaryReplica(Async)");
        }

        // verify the required parameter 'partitionId' is set
        if (partitionId == null) {
            throw new ApiException("Missing the required parameter 'partitionId' when calling moveSecondaryReplica(Async)");
        }

        // verify the required parameter 'currentNodeName' is set
        if (currentNodeName == null) {
            throw new ApiException("Missing the required parameter 'currentNodeName' when calling moveSecondaryReplica(Async)");
        }

        return moveSecondaryReplicaCall(apiVersion, partitionId, currentNodeName, newNodeName, ignoreConstraints, timeout, _callback);
     ...
     */
    public void moveSecondaryReplica(String apiVersion, UUID partitionId, String currentNodeName, String newNodeName, Boolean ignoreConstraints, Long timeout) throws ApiException {
        moveSecondaryReplicaWithHttpInfo(apiVersion, partitionId, currentNodeName, newNodeName, ignoreConstraints, timeout);
    }
     ...
     */
    public ApiResponse<Void> moveSecondaryReplicaWithHttpInfo(String apiVersion, UUID partitionId, String currentNodeName, String newNodeName, Boolean ignoreConstraints, Long timeout) throws ApiException {
        okhttp3.Call localVarCall = moveSecondaryReplicaValidateBeforeCall(apiVersion, partitionId, currentNodeName, newNodeName, ignoreConstraints, timeout, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Moves the secondary replica of a partition of a stateful service. (asynchronously)
     * This command moves the secondary replica of a partition of a stateful service, respecting all constraints. CurrentNodeName parameter must be specified to identify the replica that is moved. Source node name must be specified, but new node name can be omitted, and in that case replica is moved to a random node. If IgnoreConstraints parameter is specified and set to true, then secondary will be moved regardless of the constraints.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.5&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param partitionId The identity of the partition. (required)
     * @param currentNodeName The name of the source node for secondary replica move. (required)
     ...
     */
    public okhttp3.Call moveSecondaryReplicaAsync(String apiVersion, UUID partitionId, String currentNodeName, String newNodeName, Boolean ignoreConstraints, Long timeout, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = moveSecondaryReplicaValidateBeforeCall(apiVersion, partitionId, currentNodeName, newNodeName, ignoreConstraints, timeout, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    /**
     * Indicates to the Service Fabric cluster that it should attempt to recover a specific partition that is currently stuck in quorum loss. (asynchronously)
     * This operation should only be performed if it is known that the replicas that are down cannot be recovered. Incorrect use of this API can cause potential data loss.
     * @param partitionId The identity of the partition. (required)
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
    ...
    /**
     * Indicates to the Service Fabric cluster that it should attempt to recover the specified service that is currently stuck in quorum loss. (asynchronously)
     * Indicates to the Service Fabric cluster that it should attempt to recover the specified service that is currently stuck in quorum loss. This operation should only be performed if it is known that the replicas that are down cannot be recovered. Incorrect use of this API can cause potential data loss.
     * @param serviceId The identity of the service. This ID is typically the full name of the service without the &#39;fabric:&#39; URI scheme. Starting from version 6.0, hierarchical names are delimited with the \&quot;~\&quot; character. For example, if the service name is \&quot;fabric:/myapp/app1/svc1\&quot;, the service identity would be \&quot;myapp~app1~svc1\&quot; in 6.0+ and \&quot;myapp/app1/svc1\&quot; in previous versions. (required)
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
    ...
    /**
     * Indicates to the Service Fabric cluster that it should attempt to recover the system services that are currently stuck in quorum loss. (asynchronously)
     * Indicates to the Service Fabric cluster that it should attempt to recover the system services that are currently stuck in quorum loss. This operation should only be performed if it is known that the replicas that are down cannot be recovered. Incorrect use of this API can cause potential data loss.
     * @param apiVersion The version of the API. This parameter is required and its value must be &#39;6.0&#39;.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version. (required)
     * @param timeout The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback The callback to be executed when the API call finishes
