...
|**activityThreshold** | **Double** | The Activity Threshold specified for this metric in the system Cluster Manifest. |  [optional] |
|**balancingThreshold** | **Double** | The balancing threshold for a certain metric. |  [optional] |
|**bufferedClusterCapacityRemaining** | **Double** | Remaining capacity in the cluster excluding the reserved space. |  [optional] |
...
|**currentClusterLoad** | **Double** | The total cluster load. |  [optional] |
|**deviationAfter** | **Double** | The standard average deviation of the metrics after resource balancer run. |  [optional] |
|**deviationBefore** | **Double** | The standard average deviation of the metrics before resource balancer run. |  [optional] |
...
|**maximumNodeLoad** | **Double** | The maximum load on any node for this metric. |  [optional] |
