...
public class Example {
  public static void main(String[] args) {
    ...
    String serviceId = "serviceId_example"; // String | The identity of the infrastructure service. This is the full name of the infrastructure service without the 'fabric:' URI scheme. This parameter required only for the cluster that has more than one instance of infrastructure service running.
