...
<a id="getUnplacedReplicaInformation"></a>
# **getUnplacedReplicaInformation**
> UnplacedReplicaInformation getUnplacedReplicaInformation(apiVersion, serviceId, partitionId, onlyQueryPrimaries, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean onlyQueryPrimaries = false; // Boolean | Indicates that unplaced replica information will be queries only for primary replicas.
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      UnplacedReplicaInformation result = apiInstance.getUnplacedReplicaInformation(apiVersion, serviceId, partitionId, onlyQueryPrimaries, timeout);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServiceApi#getUnplacedReplicaInformation");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
