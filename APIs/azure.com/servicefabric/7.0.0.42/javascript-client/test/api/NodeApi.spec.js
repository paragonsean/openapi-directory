...
(function(root, factory) {
  ...
  describe('NodeApi', function() {
    describe('addConfigurationParameterOverrides', function() {
      it('should call addConfigurationParameterOverrides successfully', function(done) {
        //uncomment below and update the code to test addConfigurationParameterOverrides
        //instance.addConfigurationParameterOverrides(function(error) {
    ...
    describe('getConfigurationOverrides', function() {
      it('should call getConfigurationOverrides successfully', function(done) {
        //uncomment below and update the code to test getConfigurationOverrides
        //instance.getConfigurationOverrides(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('removeConfigurationOverrides', function() {
      it('should call removeConfigurationOverrides successfully', function(done) {
        //uncomment below and update the code to test removeConfigurationOverrides
        //instance.removeConfigurationOverrides(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
