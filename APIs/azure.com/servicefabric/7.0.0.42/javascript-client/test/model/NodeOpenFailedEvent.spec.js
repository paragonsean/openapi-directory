...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.NodeOpenFailedEvent();
  });
  ...
  describe('NodeOpenFailedEvent', function() {
    it('should create an instance of NodeOpenFailedEvent', function() {
      // uncomment below and update the code to test NodeOpenFailedEvent
      //var instance = new ServiceFabricClientApis.NodeOpenFailedEvent();
      //expect(instance).to.be.a(ServiceFabricClientApis.NodeOpenFailedEvent);
    });
