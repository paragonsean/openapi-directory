...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.NodeAbortedEvent();
  });
  ...
  describe('NodeAbortedEvent', function() {
    it('should create an instance of NodeAbortedEvent', function() {
      // uncomment below and update the code to test NodeAbortedEvent
      //var instance = new ServiceFabricClientApis.NodeAbortedEvent();
      //expect(instance).to.be.a(ServiceFabricClientApis.NodeAbortedEvent);
    });
