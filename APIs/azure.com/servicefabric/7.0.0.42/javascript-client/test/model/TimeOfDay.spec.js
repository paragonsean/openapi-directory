...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.TimeOfDay();
  });
  ...
  describe('TimeOfDay', function() {
    it('should create an instance of TimeOfDay', function() {
      ...
      //var instance = new ServiceFabricClientApis.TimeOfDay();
      //expect(instance).to.be.a(ServiceFabricClientApis.TimeOfDay);
    });
