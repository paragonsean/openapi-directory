...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.NodeOpenSucceededEvent();
  });
  ...
  describe('NodeOpenSucceededEvent', function() {
    it('should create an instance of NodeOpenSucceededEvent', function() {
      // uncomment below and update the code to test NodeOpenSucceededEvent
      //var instance = new ServiceFabricClientApis.NodeOpenSucceededEvent();
      //expect(instance).to.be.a(ServiceFabricClientApis.NodeOpenSucceededEvent);
    });
