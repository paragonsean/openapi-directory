...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.UsageInfo();
  });
  ...
  describe('UsageInfo', function() {
    it('should create an instance of UsageInfo', function() {
      ...
      //var instance = new ServiceFabricClientApis.UsageInfo();
      //expect(instance).to.be.a(ServiceFabricClientApis.UsageInfo);
    });
