...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.FileInfo();
  });
  ...
  describe('FileInfo', function() {
    it('should create an instance of FileInfo', function() {
      ...
      //var instance = new ServiceFabricClientApis.FileInfo();
      //expect(instance).to.be.a(ServiceFabricClientApis.FileInfo);
    });
    ...
    it('should have the property fileVersion (base name: "FileVersion")', function() {
      // uncomment below and update the code to test the property fileVersion
      //var instance = new ServiceFabricClientApis.FileInfo();
      //expect(instance).to.be();
    });
