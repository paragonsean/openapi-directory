# ServiceFabricClientApis.NodeApi

All URIs are relative to *http://azure.local:19080*

Method | HTTP request | Description
------------- | ------------- | -------------
[**addConfigurationParameterOverrides**](NodeApi.md#addConfigurationParameterOverrides) | **POST** /Nodes/{nodeName}/$/AddConfigurationParameterOverrides | Adds the list of configuration overrides on the specified node.
...
[**enableNode**](NodeApi.md#enableNode) | **POST** /Nodes/{nodeName}/$/Activate | Activate a Service Fabric cluster node that is currently deactivated.
[**getConfigurationOverrides**](NodeApi.md#getConfigurationOverrides) | **GET** /Nodes/{nodeName}/$/GetConfigurationOverrides | Gets the list of configuration overrides on the specified node.
...
[**getNodeInfo**](NodeApi.md#getNodeInfo) | **GET** /Nodes/{nodeName} | Gets the information about a specific node in the Service Fabric cluster.
...
[**removeConfigurationOverrides**](NodeApi.md#removeConfigurationOverrides) | **DELETE** /Nodes/{nodeName}/$/RemoveConfigurationOverrides | Removes configuration overrides on the specified node.
...
> addConfigurationParameterOverrides(apiVersion, nodeName, configParameterOverrideList, opts)
...
let apiInstance = new ServiceFabricClientApis.NodeApi();
...
let configParameterOverrideList = [new ServiceFabricClientApis.ConfigParameterOverride()]; // [ConfigParameterOverride] | Description for adding list of configuration overrides.
let opts = {
  'force': true, // Boolean | Force adding configuration overrides on specified nodes.
...
apiInstance.addConfigurationParameterOverrides(apiVersion, nodeName, configParameterOverrideList, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **configParameterOverrideList** | [**[ConfigParameterOverride]**](ConfigParameterOverride.md)| Description for adding list of configuration overrides. | 
 **force** | **Boolean**| Force adding configuration overrides on specified nodes. | [optional] 
...
> disableNode(apiVersion, nodeName, deactivationIntentDescription, opts)
...
let nodeName = "nodeName_example"; // String | The name of the node.
let deactivationIntentDescription = new ServiceFabricClientApis.DeactivationIntentDescription(); // DeactivationIntentDescription | Describes the intent or reason for deactivating the node.
let opts = {
  'timeout': 60 // Number | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
};
apiInstance.disableNode(apiVersion, nodeName, deactivationIntentDescription, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> enableNode(apiVersion, nodeName, opts)
...
apiInstance.enableNode(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> [ConfigParameterOverride] getConfigurationOverrides(apiVersion, nodeName, opts)
...
apiInstance.getConfigurationOverrides(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**[ConfigParameterOverride]**](ConfigParameterOverride.md)
...
> NodeHealth getNodeHealth(apiVersion, nodeName, opts)
...
apiInstance.getNodeHealth(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NodeHealth getNodeHealthUsingPolicy(apiVersion, nodeName, opts)
...
let opts = {
  'eventsHealthStateFilter': 0, // Number | Allows filtering the collection of HealthEvent objects returned based on health state. The possible values for this parameter include integer value of one of the following health states. Only events that match the filter are returned. All events are used to evaluate the aggregated health state. If not specified, all entries are returned. The state values are flag-based enumeration, so the value could be a combination of these values, obtained using the bitwise 'OR' operator. For example, If the provided value is 6 then all of the events with HealthState value of OK (2) and Warning (4) are returned.  - Default - Default value. Matches any HealthState. The value is zero. - None - Filter that doesn't match any HealthState value. Used in order to return no results on a given collection of states. The value is 1. - Ok - Filter that matches input with HealthState value Ok. The value is 2. - Warning - Filter that matches input with HealthState value Warning. The value is 4. - Error - Filter that matches input with HealthState value Error. The value is 8. - All - Filter that matches input with any HealthState value. The value is 65535.
  'timeout': 60, // Number | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
  'clusterHealthPolicy': new ServiceFabricClientApis.ClusterHealthPolicy() // ClusterHealthPolicy | Describes the health policies used to evaluate the health of a cluster or node. If not present, the health evaluation uses the health policy from cluster manifest or the default health policy.
};
apiInstance.getNodeHealthUsingPolicy(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NodeInfo getNodeInfo(apiVersion, nodeName, opts)
...
apiInstance.getNodeInfo(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PagedNodeInfoList getNodeInfoList(apiVersion, opts)
...
let opts = {
  ...
  'nodeStatusFilter': "'default'", // String | Allows filtering the nodes based on the NodeStatus. Only the nodes that are matching the specified filter value will be returned. The filter value can be one of the following.
...
apiInstance.getNodeInfoList(apiVersion, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **nodeStatusFilter** | **String**| Allows filtering the nodes based on the NodeStatus. Only the nodes that are matching the specified filter value will be returned. The filter value can be one of the following. | [optional] [default to &#39;default&#39;]
...
> NodeLoadInfo getNodeLoadInfo(apiVersion, nodeName, opts)
...
apiInstance.getNodeLoadInfo(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> removeConfigurationOverrides(apiVersion, nodeName, opts)
...
apiInstance.removeConfigurationOverrides(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> removeNodeState(apiVersion, nodeName, opts)
...
apiInstance.removeNodeState(apiVersion, nodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> reportNodeHealth(apiVersion, nodeName, healthInformation, opts)
...
apiInstance.reportNodeHealth(apiVersion, nodeName, healthInformation, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> restartNode(apiVersion, nodeName, restartNodeDescription, opts)
...
let apiVersion = "'6.0'"; // String | The version of the API. This parameter is required and its value must be '6.0'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accept any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0, but if the runtime is 6.1, in order to make it easier to write the clients, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.
let nodeName = "nodeName_example"; // String | The name of the node.
let restartNodeDescription = new ServiceFabricClientApis.RestartNodeDescription(); // RestartNodeDescription | The instance of the node to be restarted and a flag indicating the need to take dump of the fabric process.
let opts = {
  'timeout': 60 // Number | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
};
apiInstance.restartNode(apiVersion, nodeName, restartNodeDescription, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
