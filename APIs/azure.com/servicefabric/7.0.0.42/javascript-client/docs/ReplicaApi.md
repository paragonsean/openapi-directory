...
> reportReplicaHealth(apiVersion, partitionId, replicaId, serviceKind, healthInformation, opts)
...
let partitionId = "partitionId_example"; // String | The identity of the partition.
let replicaId = "replicaId_example"; // String | The identifier of the replica.
let serviceKind = "'Stateful'"; // String | The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values.
...
apiInstance.reportReplicaHealth(apiVersion, partitionId, replicaId, serviceKind, healthInformation, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **partitionId** | **String**| The identity of the partition. | 
 **replicaId** | **String**| The identifier of the replica. | 
 **serviceKind** | **String**| The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values. | [default to &#39;Stateful&#39;]
