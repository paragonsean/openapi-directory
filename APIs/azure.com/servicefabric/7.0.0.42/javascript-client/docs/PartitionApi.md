...
[**movePrimaryReplica**](PartitionApi.md#movePrimaryReplica) | **POST** /Partitions/{partitionId}/$/MovePrimaryReplica | Moves the primary replica of a partition of a stateful service.
[**moveSecondaryReplica**](PartitionApi.md#moveSecondaryReplica) | **POST** /Partitions/{partitionId}/$/MoveSecondaryReplica | Moves the secondary replica of a partition of a stateful service.
...
> movePrimaryReplica(apiVersion, partitionId, opts)
...
let partitionId = "partitionId_example"; // String | The identity of the partition.
let opts = {
  'nodeName': "nodeName_example", // String | The name of the node.
  'ignoreConstraints': false, // Boolean | Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored.
  'timeout': 60 // Number | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
};
apiInstance.movePrimaryReplica(apiVersion, partitionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **partitionId** | **String**| The identity of the partition. | 
 **nodeName** | **String**| The name of the node. | [optional] 
 **ignoreConstraints** | **Boolean**| Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. | [optional] [default to false]
 **timeout** | **Number**| The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60]
...
> moveSecondaryReplica(apiVersion, partitionId, currentNodeName, opts)
...
let apiVersion = "'6.5'"; // String | The version of the API. This parameter is required and its value must be '6.5'.  Service Fabric REST API version is based on the runtime version in which the API was introduced or was changed. Service Fabric runtime supports more than one version of the API. This version is the latest supported version of the API. If a lower API version is passed, the returned response may be different from the one documented in this specification.  Additionally the runtime accepts any version that is higher than the latest supported version up to the current version of the runtime. So if the latest API version is 6.0 and the runtime is 6.1, the runtime will accept version 6.1 for that API. However the behavior of the API will be as per the documented 6.0 version.
let partitionId = "partitionId_example"; // String | The identity of the partition.
let currentNodeName = "currentNodeName_example"; // String | The name of the source node for secondary replica move.
let opts = {
  'newNodeName': "newNodeName_example", // String | The name of the target node for secondary replica move. If not specified, replica is moved to a random node.
  'ignoreConstraints': false, // Boolean | Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored.
  'timeout': 60 // Number | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
};
apiInstance.moveSecondaryReplica(apiVersion, partitionId, currentNodeName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **newNodeName** | **String**| The name of the target node for secondary replica move. If not specified, replica is moved to a random node. | [optional] 
 **ignoreConstraints** | **Boolean**| Ignore constraints when moving a replica. If this parameter is not specified, all constraints are honored. | [optional] [default to false]
 **timeout** | **Number**| The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60]
