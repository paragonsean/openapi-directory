...
export default class ComposeDeploymentApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the startRollbackComposeDeploymentUpgrade operation.
     * @callback module:api/ComposeDeploymentApi~startRollbackComposeDeploymentUpgradeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [timeout = 60)] The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
     * @param {module:api/ComposeDeploymentApi~startRollbackComposeDeploymentUpgradeCallback} callback The callback function, accepting three arguments: error, data, response
     */
    startRollbackComposeDeploymentUpgrade(apiVersion, deploymentName, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling startRollbackComposeDeploymentUpgrade");
      }
      // verify the required parameter 'deploymentName' is set
      if (deploymentName === undefined || deploymentName === null) {
        throw new Error("Missing the required parameter 'deploymentName' when calling startRollbackComposeDeploymentUpgrade");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/ComposeDeployments/{deploymentName}/$/RollbackUpgrade', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
