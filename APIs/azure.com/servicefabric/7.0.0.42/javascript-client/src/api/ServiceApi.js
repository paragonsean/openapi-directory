...
export default class ServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getUnplacedReplicaInformation operation.
     * @callback module:api/ServiceApi~getUnplacedReplicaInformationCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UnplacedReplicaInformation} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [onlyQueryPrimaries = false)] Indicates that unplaced replica information will be queries only for primary replicas.
     * @param {Number} [timeout = 60)] The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
     * @param {module:api/ServiceApi~getUnplacedReplicaInformationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UnplacedReplicaInformation}
     */
    getUnplacedReplicaInformation(apiVersion, serviceId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling getUnplacedReplicaInformation");
      }
      // verify the required parameter 'serviceId' is set
      if (serviceId === undefined || serviceId === null) {
        throw new Error("Missing the required parameter 'serviceId' when calling getUnplacedReplicaInformation");
      }
      ...
      let queryParams = {
        ...
        'OnlyQueryPrimaries': opts['onlyQueryPrimaries'],
        'timeout': opts['timeout']
      };
      let headerParams = {
      };
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = UnplacedReplicaInformation;
      return this.apiClient.callApi(
        '/Services/{serviceId}/$/GetUnplacedReplicaInformation', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} [previousRspVersion] The value in the Version field of the response that was received previously. This is required if the user knows that the result that was gotten previously is stale.
     * @param {Number} [timeout = 60)] The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
