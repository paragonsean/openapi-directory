...
class PartitionHealthReportExpiredEvent {
    ...
    constructor(partitionId, eventInstanceId, kind, timeStamp) { 
        ...
        PartitionHealthReportExpiredEvent.initialize(this, partitionId, eventInstanceId, kind, timeStamp);
    }
...
PartitionHealthReportExpiredEvent.RequiredProperties = ["Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "PartitionId", "EventInstanceId", "Kind", "TimeStamp"];
