...
class BackupPolicyDescription {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('RetentionPolicy')) {
                obj['RetentionPolicy'] = RetentionPolicyDescription.constructFromObject(data['RetentionPolicy']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['RetentionPolicy']) { // data not null
          RetentionPolicyDescription.validateJSON(data['RetentionPolicy']);
        }
...
/**
 * @member {module:model/RetentionPolicyDescription} RetentionPolicy
 */
BackupPolicyDescription.prototype['RetentionPolicy'] = undefined;
