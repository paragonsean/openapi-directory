    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ServicePlacementTimeLimitSeconds')) {
                obj['ServicePlacementTimeLimitSeconds'] = ApiClient.convertToType(data['ServicePlacementTimeLimitSeconds'], 'Number');
            }
 ...
 * @member {Number} ServicePlacementTimeLimitSeconds
 */
StatefulServiceDescription.prototype['ServicePlacementTimeLimitSeconds'] = undefined;
