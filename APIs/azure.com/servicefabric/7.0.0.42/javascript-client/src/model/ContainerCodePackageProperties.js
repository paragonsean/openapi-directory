...
class ContainerCodePackageProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('livenessProbe')) {
                obj['livenessProbe'] = ApiClient.convertToType(data['livenessProbe'], [Probe]);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('readinessProbe')) {
                obj['readinessProbe'] = ApiClient.convertToType(data['readinessProbe'], [Probe]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['livenessProbe']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['livenessProbe'])) {
                throw new Error("Expected the field `livenessProbe` to be an array in the JSON data but got " + data['livenessProbe']);
            }
            // validate the optional field `livenessProbe` (array)
            for (const item of data['livenessProbe']) {
        ...
        if (data['readinessProbe']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['readinessProbe'])) {
                throw new Error("Expected the field `readinessProbe` to be an array in the JSON data but got " + data['readinessProbe']);
            }
            // validate the optional field `readinessProbe` (array)
            for (const item of data['readinessProbe']) {
                Probe.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/Probe>} livenessProbe
 */
ContainerCodePackageProperties.prototype['livenessProbe'] = undefined;
 ...
 * @member {Array.<module:model/Probe>} readinessProbe
 */
ContainerCodePackageProperties.prototype['readinessProbe'] = undefined;
