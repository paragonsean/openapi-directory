...
class StatefulServicePartitionInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PrimaryEpoch')) {
                obj['PrimaryEpoch'] = Epoch.constructFromObject(data['PrimaryEpoch']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `PrimaryEpoch`
        if (data['PrimaryEpoch']) { // data not null
          Epoch.validateJSON(data['PrimaryEpoch']);
        }
...
/**
 * @member {module:model/Epoch} PrimaryEpoch
 */
StatefulServicePartitionInfo.prototype['PrimaryEpoch'] = undefined;
