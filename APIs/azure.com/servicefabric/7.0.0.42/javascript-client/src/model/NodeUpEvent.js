...
class NodeUpEvent {
    ...
    constructor(nodeName, eventInstanceId, kind, timeStamp) { 
        ...
        NodeUpEvent.initialize(this, nodeName, eventInstanceId, kind, timeStamp);
    }
...
NodeUpEvent.RequiredProperties = ["LastNodeDownAt", "NodeInstance", "NodeName", "EventInstanceId", "Kind", "TimeStamp"];
