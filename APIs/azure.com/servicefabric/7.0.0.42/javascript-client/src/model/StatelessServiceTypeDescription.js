...
/**
 * The StatelessServiceTypeDescription model module.
 * @module model/StatelessServiceTypeDescription
 * @version 7.0.0.42
 */
class StatelessServiceTypeDescription {
    /**
     * Constructs a new <code>StatelessServiceTypeDescription</code>.
     * Describes a stateless service type defined in the service manifest of a provisioned application type.
     * @alias module:model/StatelessServiceTypeDescription
    ...
    constructor(kind) { 
        ...
        StatelessServiceTypeDescription.initialize(this, kind);
    }
    ...
    /**
     * Constructs a <code>StatelessServiceTypeDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatelessServiceTypeDescription} obj Optional instance to populate.
     * @return {module:model/StatelessServiceTypeDescription} The populated <code>StatelessServiceTypeDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatelessServiceTypeDescription();
            ServiceTypeDescription.constructFromObject(data, obj);
            ServiceTypeDescription.constructFromObject(data, obj);

            if (data.hasOwnProperty('UseImplicitHost')) {
                obj['UseImplicitHost'] = ApiClient.convertToType(data['UseImplicitHost'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatelessServiceTypeDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatelessServiceTypeDescription</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatelessServiceTypeDescription.RequiredProperties) {
...
StatelessServiceTypeDescription.RequiredProperties = ["Kind"];
 ...
 * @member {Boolean} UseImplicitHost
 */
StatelessServiceTypeDescription.prototype['UseImplicitHost'] = undefined;
...
export default StatelessServiceTypeDescription;
