...
/**
 * The NodeHealthReportExpiredEvent model module.
 * @module model/NodeHealthReportExpiredEvent
 * @version 7.0.0.42
 */
class NodeHealthReportExpiredEvent {
    /**
     * Constructs a new <code>NodeHealthReportExpiredEvent</code>.
     * Node Health Report Expired event.
     * @alias module:model/NodeHealthReportExpiredEvent
    ...
    constructor(nodeName, eventInstanceId, kind, timeStamp) { 
        ...
        NodeHealthReportExpiredEvent.initialize(this, nodeName, eventInstanceId, kind, timeStamp);
    }
    ...
    /**
     * Constructs a <code>NodeHealthReportExpiredEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeHealthReportExpiredEvent} obj Optional instance to populate.
     * @return {module:model/NodeHealthReportExpiredEvent} The populated <code>NodeHealthReportExpiredEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeHealthReportExpiredEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeHealthReportExpiredEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeHealthReportExpiredEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeHealthReportExpiredEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
NodeHealthReportExpiredEvent.RequiredProperties = ["Description", "HealthState", "NodeInstanceId", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "NodeName", "EventInstanceId", "Kind", "TimeStamp"];

/**
 * Description of report.
 * @member {String} Description
 */
NodeHealthReportExpiredEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
NodeHealthReportExpiredEvent.prototype['HealthState'] = undefined;

/**
 * Id of Node instance.
 * @member {Number} NodeInstanceId
 */
NodeHealthReportExpiredEvent.prototype['NodeInstanceId'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
NodeHealthReportExpiredEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
NodeHealthReportExpiredEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
NodeHealthReportExpiredEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
NodeHealthReportExpiredEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
NodeHealthReportExpiredEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
NodeHealthReportExpiredEvent.prototype['TimeToLiveMs'] = undefined;
...
export default NodeHealthReportExpiredEvent;
