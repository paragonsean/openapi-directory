...
class HealthEvent {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('HealthReportId')) {
                obj['HealthReportId'] = ApiClient.convertToType(data['HealthReportId'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['HealthReportId'] && !(typeof data['HealthReportId'] === 'string' || data['HealthReportId'] instanceof String)) {
            throw new Error("Expected the field `HealthReportId` to be a primitive type in the JSON string but got " + data['HealthReportId']);
        }
        // ensure the json data is a string
 ...
 * @member {String} HealthReportId
 */
HealthEvent.prototype['HealthReportId'] = undefined;
 ...
 * @member {String} HealthReportId
 */
HealthInformation.prototype['HealthReportId'] = undefined;
/**
 * @member {module:model/HealthState} HealthState
 */
