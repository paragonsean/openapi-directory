...
class StatefulServiceUpdateDescription {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ServicePlacementTimeLimitSeconds')) {
                obj['ServicePlacementTimeLimitSeconds'] = ApiClient.convertToType(data['ServicePlacementTimeLimitSeconds'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ServicePlacementTimeLimitSeconds'] && !(typeof data['ServicePlacementTimeLimitSeconds'] === 'string' || data['ServicePlacementTimeLimitSeconds'] instanceof String)) {
            throw new Error("Expected the field `ServicePlacementTimeLimitSeconds` to be a primitive type in the JSON string but got " + data['ServicePlacementTimeLimitSeconds']);
        }
        // ensure the json data is a string
 ...
 * @member {String} ServicePlacementTimeLimitSeconds
 */
StatefulServiceUpdateDescription.prototype['ServicePlacementTimeLimitSeconds'] = undefined;
