...
/**
 * The DeployedApplicationNewHealthReportEvent model module.
 * @module model/DeployedApplicationNewHealthReportEvent
 * @version 7.0.0.42
 */
class DeployedApplicationNewHealthReportEvent {
    /**
     * Constructs a new <code>DeployedApplicationNewHealthReportEvent</code>.
     * Deployed Application Health Report Created event.
     * @alias module:model/DeployedApplicationNewHealthReportEvent
    ...
    constructor(applicationId, eventInstanceId, kind, timeStamp) { 
        ...
        DeployedApplicationNewHealthReportEvent.initialize(this, applicationId, eventInstanceId, kind, timeStamp);
    }
    ...
    /**
     * Constructs a <code>DeployedApplicationNewHealthReportEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeployedApplicationNewHealthReportEvent} obj Optional instance to populate.
     * @return {module:model/DeployedApplicationNewHealthReportEvent} The populated <code>DeployedApplicationNewHealthReportEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeployedApplicationNewHealthReportEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>DeployedApplicationNewHealthReportEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeployedApplicationNewHealthReportEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeployedApplicationNewHealthReportEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
DeployedApplicationNewHealthReportEvent.RequiredProperties = ["ApplicationInstanceId", "Description", "HealthState", "NodeName", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "ApplicationId", "EventInstanceId", "Kind", "TimeStamp"];

/**
 * Id of Application instance.
 * @member {Number} ApplicationInstanceId
 */
DeployedApplicationNewHealthReportEvent.prototype['ApplicationInstanceId'] = undefined;

/**
 * Description of report.
 * @member {String} Description
 */
DeployedApplicationNewHealthReportEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
DeployedApplicationNewHealthReportEvent.prototype['HealthState'] = undefined;

/**
 * The name of a Service Fabric node.
 * @member {String} NodeName
 */
DeployedApplicationNewHealthReportEvent.prototype['NodeName'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
DeployedApplicationNewHealthReportEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
DeployedApplicationNewHealthReportEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
DeployedApplicationNewHealthReportEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
DeployedApplicationNewHealthReportEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
DeployedApplicationNewHealthReportEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
DeployedApplicationNewHealthReportEvent.prototype['TimeToLiveMs'] = undefined;
...
export default DeployedApplicationNewHealthReportEvent;
