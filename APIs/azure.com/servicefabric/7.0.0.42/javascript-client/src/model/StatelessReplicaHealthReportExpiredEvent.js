...
class StatelessReplicaHealthReportExpiredEvent {
    ...
    constructor(partitionId, replicaId, eventInstanceId, kind, timeStamp) { 
        ...
        StatelessReplicaHealthReportExpiredEvent.initialize(this, partitionId, replicaId, eventInstanceId, kind, timeStamp);
    }
...
StatelessReplicaHealthReportExpiredEvent.RequiredProperties = ["Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "PartitionId", "ReplicaId", "EventInstanceId", "Kind", "TimeStamp"];
