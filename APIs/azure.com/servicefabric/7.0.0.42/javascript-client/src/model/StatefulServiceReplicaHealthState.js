...
class StatefulServiceReplicaHealthState {
    ...
    constructor(serviceKind) { 
        ...
        StatefulServiceReplicaHealthState.initialize(this, serviceKind);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of StatefulServiceReplicaHealthState.RequiredProperties) {
...
StatefulServiceReplicaHealthState.RequiredProperties = ["ServiceKind"];
