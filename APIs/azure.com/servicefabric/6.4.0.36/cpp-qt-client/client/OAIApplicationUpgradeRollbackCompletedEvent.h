...
/*
 * OAIApplicationUpgradeRollbackCompletedEvent.h
 *
 * Application Upgrade Rollback Completed event.
 */

#ifndef OAIApplicationUpgradeRollbackCompletedEvent_H
#define OAIApplicationUpgradeRollbackCompletedEvent_H
...
class OAIApplicationUpgradeRollbackCompletedEvent : public OAIObject {
public:
    OAIApplicationUpgradeRollbackCompletedEvent();
    OAIApplicationUpgradeRollbackCompletedEvent(QString json);
    ~OAIApplicationUpgradeRollbackCompletedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationUpgradeRollbackCompletedEvent)

#endif // OAIApplicationUpgradeRollbackCompletedEvent_H
