...
/*
 * OAIApplicationProcessExitedEvent.h
 *
 * Process Exited event.
 */

#ifndef OAIApplicationProcessExitedEvent_H
#define OAIApplicationProcessExitedEvent_H
...
class OAIApplicationProcessExitedEvent : public OAIObject {
public:
    OAIApplicationProcessExitedEvent();
    OAIApplicationProcessExitedEvent(QString json);
    ~OAIApplicationProcessExitedEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationProcessExitedEvent)

#endif // OAIApplicationProcessExitedEvent_H
