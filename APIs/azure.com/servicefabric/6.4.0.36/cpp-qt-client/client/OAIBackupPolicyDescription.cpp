...
OAIRetentionPolicyDescription OAIBackupPolicyDescription::getRetentionPolicy() const {
    return m_retention_policy;
}
void OAIBackupPolicyDescription::setRetentionPolicy(const OAIRetentionPolicyDescription &retention_policy) {
    m_retention_policy = retention_policy;
    m_retention_policy_isSet = true;
}

bool OAIBackupPolicyDescription::is_retention_policy_Set() const{
    return m_retention_policy_isSet;
}

bool OAIBackupPolicyDescription::is_retention_policy_Valid() const{
