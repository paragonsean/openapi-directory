...
public:
    ...
    OAIEpoch getEpochOfLastBackupRecord() const;
    void setEpochOfLastBackupRecord(const OAIEpoch &epoch_of_last_backup_record);
...
private:
    ...
    OAIEpoch m_epoch_of_last_backup_record;
