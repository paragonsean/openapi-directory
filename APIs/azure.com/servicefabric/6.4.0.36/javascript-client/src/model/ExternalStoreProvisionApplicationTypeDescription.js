...
class ExternalStoreProvisionApplicationTypeDescription {
    ...
    static initialize(obj, async, kind) { 
        obj['ApplicationPackageDownloadUri'] = applicationPackageDownloadUri;
...
ExternalStoreProvisionApplicationTypeDescription.RequiredProperties = ["ApplicationPackageDownloadUri", "ApplicationTypeName", "ApplicationTypeVersion", "Async", "Kind"];
