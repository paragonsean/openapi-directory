...
import ApplicationScopedVolume from './ApplicationScopedVolume';
...
import ReliableCollectionsRef from './ReliableCollectionsRef';
...
class ContainerCodePackageProperties {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('reliableCollectionsRefs')) {
                obj['reliableCollectionsRefs'] = ApiClient.convertToType(data['reliableCollectionsRefs'], [ReliableCollectionsRef]);
            }
            ...
            if (data.hasOwnProperty('volumeRefs')) {
                obj['volumeRefs'] = ApiClient.convertToType(data['volumeRefs'], [VolumeReference]);
            }
            if (data.hasOwnProperty('volumes')) {
                obj['volumes'] = ApiClient.convertToType(data['volumes'], [ApplicationScopedVolume]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['reliableCollectionsRefs']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['reliableCollectionsRefs'])) {
                throw new Error("Expected the field `reliableCollectionsRefs` to be an array in the JSON data but got " + data['reliableCollectionsRefs']);
            }
            // validate the optional field `reliableCollectionsRefs` (array)
            for (const item of data['reliableCollectionsRefs']) {
                ReliableCollectionsRef.validateJSON(item);
            };
        }
        ...
        if (data['volumeRefs']) { // data not null
            ...
            for (const item of data['volumeRefs']) {
                VolumeReference.validateJSON(item);
            };
        }
        if (data['volumes']) { // data not null
            ...
            for (const item of data['volumes']) {
                ApplicationScopedVolume.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ReliableCollectionsRef>} reliableCollectionsRefs
 */
ContainerCodePackageProperties.prototype['reliableCollectionsRefs'] = undefined;
 ...
 * @member {Array.<module:model/VolumeReference>} volumeRefs
 */
ContainerCodePackageProperties.prototype['volumeRefs'] = undefined;

/**
 * Volumes to be attached to the container. The lifetime of these volumes is scoped to the application's lifetime.
 * @member {Array.<module:model/ApplicationScopedVolume>} volumes
 */
ContainerCodePackageProperties.prototype['volumes'] = undefined;
