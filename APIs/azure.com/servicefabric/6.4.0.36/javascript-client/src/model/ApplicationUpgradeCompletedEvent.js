...
/**
 * The ApplicationUpgradeCompletedEvent model module.
 * @module model/ApplicationUpgradeCompletedEvent
 * @version 6.4.0.36
 */
class ApplicationUpgradeCompletedEvent {
    /**
     * Constructs a new <code>ApplicationUpgradeCompletedEvent</code>.
     * Application Upgrade Completed event.
     * @alias module:model/ApplicationUpgradeCompletedEvent
    ...
    constructor(applicationId, eventInstanceId, kind, timeStamp) { 
        ...
        ApplicationUpgradeCompletedEvent.initialize(this, applicationId, eventInstanceId, kind, timeStamp);
    }
    ...
    /**
     * Constructs a <code>ApplicationUpgradeCompletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationUpgradeCompletedEvent} obj Optional instance to populate.
     * @return {module:model/ApplicationUpgradeCompletedEvent} The populated <code>ApplicationUpgradeCompletedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationUpgradeCompletedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationUpgradeCompletedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationUpgradeCompletedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationUpgradeCompletedEvent.RequiredProperties) {
...
ApplicationUpgradeCompletedEvent.RequiredProperties = ["ApplicationTypeName", "ApplicationTypeVersion", "OverallUpgradeElapsedTimeInMs", "ApplicationId", "EventInstanceId", "Kind", "TimeStamp"];

/**
 * Application type name.
 * @member {String} ApplicationTypeName
 */
ApplicationUpgradeCompletedEvent.prototype['ApplicationTypeName'] = undefined;

/**
 * Application type version.
 * @member {String} ApplicationTypeVersion
 */
ApplicationUpgradeCompletedEvent.prototype['ApplicationTypeVersion'] = undefined;

/**
 * Overall upgrade time in milli-seconds.
 * @member {Number} OverallUpgradeElapsedTimeInMs
 */
ApplicationUpgradeCompletedEvent.prototype['OverallUpgradeElapsedTimeInMs'] = undefined;
...
export default ApplicationUpgradeCompletedEvent;
