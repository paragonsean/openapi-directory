...
/**
 * The ClusterUpgradeRollbackCompletedEvent model module.
 * @module model/ClusterUpgradeRollbackCompletedEvent
 * @version 6.4.0.36
 */
class ClusterUpgradeRollbackCompletedEvent {
    /**
     * Constructs a new <code>ClusterUpgradeRollbackCompletedEvent</code>.
     * Cluster Upgrade Rollback Completed event.
     * @alias module:model/ClusterUpgradeRollbackCompletedEvent
    ...
    constructor(eventInstanceId, kind, timeStamp) { 
        ...
        ClusterUpgradeRollbackCompletedEvent.initialize(this, eventInstanceId, kind, timeStamp);
    }
    ...
    /**
     * Constructs a <code>ClusterUpgradeRollbackCompletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClusterUpgradeRollbackCompletedEvent} obj Optional instance to populate.
     * @return {module:model/ClusterUpgradeRollbackCompletedEvent} The populated <code>ClusterUpgradeRollbackCompletedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClusterUpgradeRollbackCompletedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterUpgradeRollbackCompletedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterUpgradeRollbackCompletedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClusterUpgradeRollbackCompletedEvent.RequiredProperties) {
...
ClusterUpgradeRollbackCompletedEvent.RequiredProperties = ["FailureReason", "OverallUpgradeElapsedTimeInMs", "TargetClusterVersion", "EventInstanceId", "Kind", "TimeStamp"];

/**
 * Describes failure.
 * @member {String} FailureReason
 */
ClusterUpgradeRollbackCompletedEvent.prototype['FailureReason'] = undefined;

/**
 * Overall duration of upgrade in milli-seconds.
 * @member {Number} OverallUpgradeElapsedTimeInMs
 */
ClusterUpgradeRollbackCompletedEvent.prototype['OverallUpgradeElapsedTimeInMs'] = undefined;

/**
 * Target Cluster version.
 * @member {String} TargetClusterVersion
 */
ClusterUpgradeRollbackCompletedEvent.prototype['TargetClusterVersion'] = undefined;
...
export default ClusterUpgradeRollbackCompletedEvent;
