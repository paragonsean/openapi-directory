...
/**
 * The PartitionNewHealthReportEvent model module.
 * @module model/PartitionNewHealthReportEvent
 * @version 6.4.0.36
 */
class PartitionNewHealthReportEvent {
    /**
     * Constructs a new <code>PartitionNewHealthReportEvent</code>.
     * Partition Health Report Created event.
     * @alias module:model/PartitionNewHealthReportEvent
    ...
    constructor(partitionId, eventInstanceId, kind, timeStamp) { 
        ...
        PartitionNewHealthReportEvent.initialize(this, partitionId, eventInstanceId, kind, timeStamp);
    }
    ...
    /**
     * Constructs a <code>PartitionNewHealthReportEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartitionNewHealthReportEvent} obj Optional instance to populate.
     * @return {module:model/PartitionNewHealthReportEvent} The populated <code>PartitionNewHealthReportEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartitionNewHealthReportEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>PartitionNewHealthReportEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartitionNewHealthReportEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartitionNewHealthReportEvent.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
...
PartitionNewHealthReportEvent.RequiredProperties = ["Description", "HealthState", "Property", "RemoveWhenExpired", "SequenceNumber", "SourceId", "SourceUtcTimestamp", "TimeToLiveMs", "PartitionId", "EventInstanceId", "Kind", "TimeStamp"];

/**
 * Description of report.
 * @member {String} Description
 */
PartitionNewHealthReportEvent.prototype['Description'] = undefined;

/**
 * Describes the property health state.
 * @member {String} HealthState
 */
PartitionNewHealthReportEvent.prototype['HealthState'] = undefined;

/**
 * Describes the property.
 * @member {String} Property
 */
PartitionNewHealthReportEvent.prototype['Property'] = undefined;

/**
 * Indicates the removal when it expires.
 * @member {Boolean} RemoveWhenExpired
 */
PartitionNewHealthReportEvent.prototype['RemoveWhenExpired'] = undefined;

/**
 * Sequence number of report.
 * @member {Number} SequenceNumber
 */
PartitionNewHealthReportEvent.prototype['SequenceNumber'] = undefined;

/**
 * Id of report source.
 * @member {String} SourceId
 */
PartitionNewHealthReportEvent.prototype['SourceId'] = undefined;

/**
 * Source time.
 * @member {Date} SourceUtcTimestamp
 */
PartitionNewHealthReportEvent.prototype['SourceUtcTimestamp'] = undefined;

/**
 * Time to live in milli-seconds.
 * @member {Number} TimeToLiveMs
 */
PartitionNewHealthReportEvent.prototype['TimeToLiveMs'] = undefined;
...
export default PartitionNewHealthReportEvent;
