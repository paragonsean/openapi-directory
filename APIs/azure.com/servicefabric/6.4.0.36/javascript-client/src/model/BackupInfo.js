...
class BackupInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EpochOfLastBackupRecord')) {
                obj['EpochOfLastBackupRecord'] = Epoch.constructFromObject(data['EpochOfLastBackupRecord']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['EpochOfLastBackupRecord']) { // data not null
          Epoch.validateJSON(data['EpochOfLastBackupRecord']);
        }
...
/**
 * @member {module:model/Epoch} EpochOfLastBackupRecord
 */
 ...
 */
BackupInfo.prototype['ServiceManifestVersion'] = undefined;
