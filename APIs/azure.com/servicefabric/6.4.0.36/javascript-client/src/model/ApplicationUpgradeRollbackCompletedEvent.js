...
/**
 * The ApplicationUpgradeRollbackCompletedEvent model module.
 * @module model/ApplicationUpgradeRollbackCompletedEvent
 * @version 6.4.0.36
 */
class ApplicationUpgradeRollbackCompletedEvent {
    /**
     * Constructs a new <code>ApplicationUpgradeRollbackCompletedEvent</code>.
     * Application Upgrade Rollback Completed event.
     * @alias module:model/ApplicationUpgradeRollbackCompletedEvent
    ...
    constructor(applicationId, eventInstanceId, kind, timeStamp) { 
        ...
        ApplicationUpgradeRollbackCompletedEvent.initialize(this, applicationId, eventInstanceId, kind, timeStamp);
    }
    ...
    /**
     * Constructs a <code>ApplicationUpgradeRollbackCompletedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationUpgradeRollbackCompletedEvent} obj Optional instance to populate.
     * @return {module:model/ApplicationUpgradeRollbackCompletedEvent} The populated <code>ApplicationUpgradeRollbackCompletedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationUpgradeRollbackCompletedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationUpgradeRollbackCompletedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationUpgradeRollbackCompletedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationUpgradeRollbackCompletedEvent.RequiredProperties) {
...
ApplicationUpgradeRollbackCompletedEvent.RequiredProperties = ["ApplicationTypeName", "ApplicationTypeVersion", "FailureReason", "OverallUpgradeElapsedTimeInMs", "ApplicationId", "EventInstanceId", "Kind", "TimeStamp"];

/**
 * Application type name.
 * @member {String} ApplicationTypeName
 */
ApplicationUpgradeRollbackCompletedEvent.prototype['ApplicationTypeName'] = undefined;

/**
 * Application type version.
 * @member {String} ApplicationTypeVersion
 */
ApplicationUpgradeRollbackCompletedEvent.prototype['ApplicationTypeVersion'] = undefined;

/**
 * Describes reason of failure.
 * @member {String} FailureReason
 */
ApplicationUpgradeRollbackCompletedEvent.prototype['FailureReason'] = undefined;

/**
 * Overall upgrade time in milli-seconds.
 * @member {Number} OverallUpgradeElapsedTimeInMs
 */
ApplicationUpgradeRollbackCompletedEvent.prototype['OverallUpgradeElapsedTimeInMs'] = undefined;
...
export default ApplicationUpgradeRollbackCompletedEvent;
