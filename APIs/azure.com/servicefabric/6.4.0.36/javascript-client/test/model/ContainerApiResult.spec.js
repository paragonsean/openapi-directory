...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.ContainerApiResult();
  });
  ...
  describe('ContainerApiResult', function() {
    it('should create an instance of ContainerApiResult', function() {
      // uncomment below and update the code to test ContainerApiResult
      //var instance = new ServiceFabricClientApis.ContainerApiResult();
      //expect(instance).to.be.a(ServiceFabricClientApis.ContainerApiResult);
    });
