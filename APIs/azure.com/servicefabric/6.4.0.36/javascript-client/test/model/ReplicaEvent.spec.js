...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.ReplicaEvent();
  });
  ...
  describe('ReplicaEvent', function() {
    it('should create an instance of ReplicaEvent', function() {
      // uncomment below and update the code to test ReplicaEvent
      //var instance = new ServiceFabricClientApis.ReplicaEvent();
      //expect(instance).to.be.a(ServiceFabricClientApis.ReplicaEvent);
    });
