...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.AadMetadata();
  });
  ...
  describe('AadMetadata', function() {
    it('should create an instance of AadMetadata', function() {
      // uncomment below and update the code to test AadMetadata
      //var instance = new ServiceFabricClientApis.AadMetadata();
      //expect(instance).to.be.a(ServiceFabricClientApis.AadMetadata);
    });
