...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.ClusterHealthPolicies();
  });
  ...
  describe('ClusterHealthPolicies', function() {
    it('should create an instance of ClusterHealthPolicies', function() {
      // uncomment below and update the code to test ClusterHealthPolicies
      //var instance = new ServiceFabricClientApis.ClusterHealthPolicies();
      //expect(instance).to.be.a(ServiceFabricClientApis.ClusterHealthPolicies);
    });
