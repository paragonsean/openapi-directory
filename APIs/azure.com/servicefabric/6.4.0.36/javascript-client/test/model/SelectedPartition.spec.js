...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.SelectedPartition();
  });
  ...
  describe('SelectedPartition', function() {
    it('should create an instance of SelectedPartition', function() {
      // uncomment below and update the code to test SelectedPartition
      //var instance = new ServiceFabricClientApis.SelectedPartition();
      //expect(instance).to.be.a(ServiceFabricClientApis.SelectedPartition);
    });
