...
class ChaosStartedEvent(Model):
    ...
    def __init__(self, chaos_context: str=None, cluster_health_policy: str=None, included_application_list: str=None, included_node_type_list: str=None, max_cluster_stabilization_timeout_in_seconds: float=None, max_concurrent_faults: int=None, move_replica_fault_enabled: bool=None, time_to_run_in_seconds: float=None, wait_time_between_fautls_in_seconds: float=None, wait_time_between_iterations_in_seconds: float=None, category: str=None, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None):
