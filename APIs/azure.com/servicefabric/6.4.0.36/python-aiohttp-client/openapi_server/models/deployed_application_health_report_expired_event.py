...
class DeployedApplicationHealthReportExpiredEvent(Model):
    ...
    def __init__(self, application_instance_id: int=None, description: str=None, health_state: str=None, node_name: str=None, _property: str=None, remove_when_expired: bool=None, sequence_number: int=None, source_id: str=None, source_utc_timestamp: datetime=None, time_to_live_ms: int=None, application_id: str=None, category: str=None, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None):
        ...
        :param category: The category of this DeployedApplicationHealthReportExpiredEvent.
    ...
    @property
    def category(self):
        """Gets the category of this DeployedApplicationHealthReportExpiredEvent.

        The category of event.

        :return: The category of this DeployedApplicationHealthReportExpiredEvent.
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this DeployedApplicationHealthReportExpiredEvent.
