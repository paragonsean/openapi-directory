...
class DeployedServicePackageHealthState(Model):
    ...
    def __init__(self, application_name: str=None, node_name: str=None, service_manifest_name: str=None, service_package_activation_id: str=None, aggregated_health_state: HealthState=None):
