...
class ServiceDescription(Model):
    ...
    def __init__(self, application_name: str=None, correlation_scheme: List[ServiceCorrelationDescription]=None, default_move_cost: MoveCost=None, initialization_data: List[int]=None, is_default_move_cost_specified: bool=None, partition_description: PartitionSchemeDescription=None, placement_constraints: str=None, scaling_policies: List[ScalingPolicyDescription]=None, service_dns_name: str=None, service_kind: ServiceKind=None, service_load_metrics: List[ServiceLoadMetricDescription]=None, service_name: str=None, service_package_activation_mode: ServicePackageActivationMode=None, service_placement_policies: List[ServicePlacementPolicyDescription]=None, service_type_name: str=None):
        ...
        :param scaling_policies: The scaling_policies of this ServiceDescription.
    ...
    def scaling_policies(self):
        """Gets the scaling_policies of this ServiceDescription.

        A list that describes the scaling policies.

        :return: The scaling_policies of this ServiceDescription.
    ...
    def scaling_policies(self, scaling_policies):
        """Sets the scaling_policies of this ServiceDescription.
