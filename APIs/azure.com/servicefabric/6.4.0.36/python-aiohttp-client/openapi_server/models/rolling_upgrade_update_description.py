...
class RollingUpgradeUpdateDescription(Model):
    ...
    def __init__(self, failure_action: FailureAction=None, force_restart: bool=False, health_check_retry_timeout_in_milliseconds: str='PT0H10M0S', health_check_stable_duration_in_milliseconds: str='PT0H2M0S', health_check_wait_duration_in_milliseconds: str='0', replica_set_check_timeout_in_milliseconds: int=None, rolling_upgrade_mode: UpgradeMode=UpgradeMode.UNMONITOREDAUTO, upgrade_domain_timeout_in_milliseconds: str='P10675199DT02H48M05.4775807S', upgrade_timeout_in_milliseconds: str='P10675199DT02H48M05.4775807S'):
