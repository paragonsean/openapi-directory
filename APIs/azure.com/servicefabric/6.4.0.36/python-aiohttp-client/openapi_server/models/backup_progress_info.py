...
class BackupProgressInfo(Model):
    ...
    def __init__(self, backup_id: str=None, backup_location: str=None, backup_state: BackupState=None, epoch_of_last_backup_record: Epoch=None, failure_error: FabricErrorError=None, lsn_of_last_backup_record: str=None, time_stamp_utc: datetime=None):
