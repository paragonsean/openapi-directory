...
class ReplicaHealthEvaluation(Model):
    ...
    def __init__(self, partition_id: str=None, replica_or_instance_id: str=None, unhealthy_evaluations: List[HealthEvaluationWrapper]=None, aggregated_health_state: HealthState=None, description: str=None, kind: HealthEvaluationKind=None):
