...
class StatefulServiceInfo(Model):
    ...
    def __init__(self, has_persisted_state: bool=None, health_state: HealthState=None, id: str=None, is_service_group: bool=None, manifest_version: str=None, name: str=None, service_kind: ServiceKind=None, service_status: ServiceStatus=None, type_name: str=None):
