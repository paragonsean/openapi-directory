...
class PartitionHealthReportExpiredEvent(Model):
    ...
    def __init__(self, description: str=None, health_state: str=None, _property: str=None, remove_when_expired: bool=None, sequence_number: int=None, source_id: str=None, source_utc_timestamp: datetime=None, time_to_live_ms: int=None, partition_id: str=None, category: str=None, event_instance_id: str=None, has_correlated_events: bool=None, kind: FabricEventKind=None, time_stamp: datetime=None):
        ...
        :param category: The category of this PartitionHealthReportExpiredEvent.
    ...
    @property
    def category(self):
        """Gets the category of this PartitionHealthReportExpiredEvent.

        The category of event.

        :return: The category of this PartitionHealthReportExpiredEvent.
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this PartitionHealthReportExpiredEvent.
