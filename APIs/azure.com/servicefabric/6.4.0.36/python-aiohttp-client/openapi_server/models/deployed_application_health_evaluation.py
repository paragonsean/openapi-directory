...
class DeployedApplicationHealthEvaluation(Model):
    ...
    def __init__(self, application_name: str=None, node_name: str=None, unhealthy_evaluations: List[HealthEvaluationWrapper]=None, aggregated_health_state: HealthState=None, description: str=None, kind: HealthEvaluationKind=None):
