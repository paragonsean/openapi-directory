...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "6.0-preview"; // String | The version of the API. This parameter is required and its value must be '\"6.0-preview'.
...
|------------- | ------------- | ------------- | -------------|
| **apiVersion** | **String**| The version of the API. This parameter is required and its value must be &#39;\&quot;6.0-preview&#39;. | [default to 6.0-preview] [enum: 6.0-preview] |
...
<a id="startRollbackComposeDeploymentUpgrade"></a>
# **startRollbackComposeDeploymentUpgrade**
> startRollbackComposeDeploymentUpgrade(apiVersion, deploymentName, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      apiInstance.startRollbackComposeDeploymentUpgrade(apiVersion, deploymentName, timeout);
    } catch (ApiException e) {
      System.err.println("Exception when calling ComposeDeploymentApi#startRollbackComposeDeploymentUpgrade");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | A successful response means that the rollback has started. Use GetComposeDeploymentUpgrade operation to get the status of the rollback. |  -  |
| **0** | The detailed error response. |  -  |
