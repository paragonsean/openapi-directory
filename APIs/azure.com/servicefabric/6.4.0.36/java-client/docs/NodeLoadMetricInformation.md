...
|**nodeLoad** | **String** | Current load on the node for this metric. |  [optional] |
|**nodeRemainingBufferedCapacity** | **String** | The remaining reserved capacity for this metric on the node. |  [optional] |
|**nodeRemainingCapacity** | **String** | The remaining capacity on the node for this metric. |  [optional] |
