...
public class HealthEvent {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isExpired, lastErrorTransitionAt, lastModifiedUtcTimestamp, lastOkTransitionAt, lastWarningTransitionAt, sourceUtcTimestamp, description, healthState, property, removeWhenExpired, sequenceNumber, sourceId, timeToLiveInMilliSeconds);
  }
