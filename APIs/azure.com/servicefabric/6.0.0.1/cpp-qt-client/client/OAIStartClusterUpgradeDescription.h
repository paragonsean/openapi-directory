...
/*
 * OAIStartClusterUpgradeDescription.h
 *
 * Describes the parameters for starting a cluster upgrade.
 */

#ifndef OAIStartClusterUpgradeDescription_H
#define OAIStartClusterUpgradeDescription_H
...
class OAIStartClusterUpgradeDescription : public OAIObject {
public:
    OAIStartClusterUpgradeDescription();
    OAIStartClusterUpgradeDescription(QString json);
    ~OAIStartClusterUpgradeDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartClusterUpgradeDescription)

#endif // OAIStartClusterUpgradeDescription_H
