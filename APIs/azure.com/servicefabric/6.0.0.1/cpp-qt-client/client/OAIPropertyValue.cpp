...
OAIPropertyValueKind OAIPropertyValue::getKind() const {
    return m_kind;
}
void OAIPropertyValue::setKind(const OAIPropertyValueKind &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIPropertyValue::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIPropertyValue::is_kind_Valid() const{
