...
/*
 * OAIUpgradeDomainNodesHealthEvaluation.h
 *
...
#ifndef OAIUpgradeDomainNodesHealthEvaluation_H
#define OAIUpgradeDomainNodesHealthEvaluation_H
...
class OAIUpgradeDomainNodesHealthEvaluation : public OAIObject {
public:
    OAIUpgradeDomainNodesHealthEvaluation();
    OAIUpgradeDomainNodesHealthEvaluation(QString json);
    ~OAIUpgradeDomainNodesHealthEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpgradeDomainNodesHealthEvaluation)

#endif // OAIUpgradeDomainNodesHealthEvaluation_H
