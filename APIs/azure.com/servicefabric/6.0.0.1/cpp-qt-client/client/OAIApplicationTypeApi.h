...
public:
    ...
    */
    ...
    /**
    * @param[in]  api_version QString [required]
    * @param[in]  application_type_image_store_path OAIApplicationTypeImageStorePath [required]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void provisionApplicationType(const QString &api_version, const OAIApplicationTypeImageStorePath &application_type_image_store_path, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());

    /**
    * @param[in]  api_version QString [required]
    * @param[in]  application_type_name QString [required]
    * @param[in]  application_type_image_store_version OAIApplicationTypeImageStoreVersion [required]
    * @param[in]  timeout qint64 [optional]
    */
    virtual void unprovisionApplicationType(const QString &api_version, const QString &application_type_name, const OAIApplicationTypeImageStoreVersion &application_type_image_store_version, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
