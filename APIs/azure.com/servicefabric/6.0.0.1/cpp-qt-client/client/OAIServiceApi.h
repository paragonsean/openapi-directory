...
public:
    ...
    */
    virtual void createService(const QString &application_id, const QString &api_version, const OAIServiceDescription &service_description, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void createServiceFromTemplate(const QString &application_id, const QString &api_version, const OAIServiceFromTemplateDescription &service_from_template_description, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
