...
/*
 * OAIStatelessServicePartitionInfo.h
 *
 * Information about a partition of a stateless Service Fabric service.
 */

#ifndef OAIStatelessServicePartitionInfo_H
#define OAIStatelessServicePartitionInfo_H
...
class OAIStatelessServicePartitionInfo : public OAIObject {
public:
    OAIStatelessServicePartitionInfo();
    OAIStatelessServicePartitionInfo(QString json);
    ~OAIStatelessServicePartitionInfo() override;
    ...
    qint64 getInstanceCount() const;
    void setInstanceCount(const qint64 &instance_count);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessServicePartitionInfo)

#endif // OAIStatelessServicePartitionInfo_H
