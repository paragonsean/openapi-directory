...
public:
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getApplicationInfoList(const QString &api_version, const ::OpenAPI::OptionalParam<qint32> &application_definition_kind_filter = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &application_type_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &exclude_application_parameters = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &continuation_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getDeployedApplicationInfo(const QString &api_version, const QString &node_name, const QString &application_id, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
    ...
    * @param[in]  timeout qint64 [optional]
    */
    virtual void getDeployedApplicationInfoList(const QString &api_version, const QString &node_name, const ::OpenAPI::OptionalParam<qint64> &timeout = ::OpenAPI::OptionalParam<qint64>());
...
Q_SIGNALS:
    ...
    void getDeployedApplicationInfoListSignal(QList<OAIDeployedApplicationInfo> summary);
    ...
    void getDeployedApplicationInfoListSignalFull(OAIHttpRequestWorker *worker, QList<OAIDeployedApplicationInfo> summary);
    ...
    void getDeployedApplicationInfoListSignalE(QList<OAIDeployedApplicationInfo> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getDeployedApplicationInfoListSignalError(QList<OAIDeployedApplicationInfo> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
