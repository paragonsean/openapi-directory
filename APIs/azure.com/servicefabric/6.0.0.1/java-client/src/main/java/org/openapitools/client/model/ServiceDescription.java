...
public class ServiceDescription {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationName, correlationScheme, defaultMoveCost, initializationData, isDefaultMoveCostSpecified, partitionDescription, placementConstraints, serviceDnsName, serviceKind, serviceLoadMetrics, serviceName, servicePackageActivationMode, servicePlacementPolicies, serviceTypeName);
  }
