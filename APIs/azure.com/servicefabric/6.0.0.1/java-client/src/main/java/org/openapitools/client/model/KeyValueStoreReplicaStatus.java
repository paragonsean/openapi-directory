...
public class KeyValueStoreReplicaStatus extends ReplicaStatusBase {
  ...
  static {
    ...
    openapiFields.add("CopyNotificationCurrentKeyFilter");
    openapiFields.add("CopyNotificationCurrentProgress");
    openapiFields.add("DatabaseLogicalSizeEstimate");
    openapiFields.add("DatabaseRowCountEstimate");
