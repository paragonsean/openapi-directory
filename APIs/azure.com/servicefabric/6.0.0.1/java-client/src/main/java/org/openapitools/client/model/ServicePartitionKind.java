 ...
 */
@JsonAdapter(ServicePartitionKind.Adapter.class)
public enum ServicePartitionKind {
  ...
  ServicePartitionKind(String value) {
    this.value = value;
  }
  ...
  public static ServicePartitionKind fromValue(String value) {
    for (ServicePartitionKind b : ServicePartitionKind.values()) {
  ...
  public static class Adapter extends TypeAdapter<ServicePartitionKind> {
    @Override
    public void write(final JsonWriter jsonWriter, final ServicePartitionKind enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ServicePartitionKind read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ServicePartitionKind.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ServicePartitionKind.fromValue(value);
  }
}
