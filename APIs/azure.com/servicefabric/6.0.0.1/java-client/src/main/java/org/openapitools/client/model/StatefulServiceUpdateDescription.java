...
public class StatefulServiceUpdateDescription extends ServiceUpdateDescription {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(minReplicaSetSize, quorumLossWaitDurationSeconds, replicaRestartWaitDurationSeconds, standByReplicaKeepDurationSeconds, targetReplicaSetSize, super.hashCode());
  }
