...
public class FaultsApi {
     ...
     * @param nodeName The name of the node. (required)
     * @param operationId A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API (required)
     * @param nodeTransitionType Indicates the type of transition to perform.  NodeTransitionType.Start will start a stopped node.  NodeTransitionType.Stop will stop a node that is up.   - Invalid - Reserved.  Do not pass into API.   - Start - Transition a stopped node to up.   - Stop - Transition an up node to stopped.  (required)
     ...
     * @param partitionId The identity of the partition. (required)
     * @param operationId A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API (required)
     * @param restartPartitionMode - Invalid - Reserved.  Do not pass into API. - AllReplicasOrInstances - All replicas or instances in the partition are restarted at once. - OnlyActiveSecondaries - Only the secondary replicas are restarted.  (required)
     * @param timeout The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. (optional, default to 60)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
