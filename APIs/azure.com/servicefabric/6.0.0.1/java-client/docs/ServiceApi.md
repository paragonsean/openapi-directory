...
|------------- | ------------- | -------------|
| [**createService**](ServiceApi.md#createService) | **POST** /Applications/{applicationId}/$/GetServices/$/Create | Creates the specified service. |
| [**createServiceFromTemplate**](ServiceApi.md#createServiceFromTemplate) | **POST** /Applications/{applicationId}/$/GetServices/$/CreateFromTemplate | Creates a Service Fabric service from the service template defined in the application manifest. |
...
| [**updateService**](ServiceApi.md#updateService) | **POST** /Services/{serviceId}/$/Update | Updates the specified service using the given update description. |


<a id="createService"></a>
# **createService**
> createService(applicationId, apiVersion, serviceDescription, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.createService(applicationId, apiVersion, serviceDescription, timeout);
...
> createServiceFromTemplate(applicationId, apiVersion, serviceFromTemplateDescription, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      apiInstance.createServiceFromTemplate(applicationId, apiVersion, serviceFromTemplateDescription, timeout);
    } catch (ApiException e) {
