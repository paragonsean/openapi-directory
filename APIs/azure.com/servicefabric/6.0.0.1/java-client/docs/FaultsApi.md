...
| **partitionId** | **UUID**| The identity of the partition. | |
| **operationId** | **UUID**| A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API | |
| **dataLossMode** | **String**| This enum is passed to the StartDataLoss API to indicate what type of data loss to induce. - Invalid - Reserved.  Do not pass into API. - PartialDataLoss - PartialDataLoss option will cause a quorum of replicas to go down, triggering an OnDataLoss event in the system for the given partition. - FullDataLoss - FullDataLoss option will drop all the replicas which means that all the data will be lost.  | [enum: Invalid, PartialDataLoss, FullDataLoss] |
| **timeout** | **Long**| The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60] |
...
| **nodeName** | **String**| The name of the node. | |
| **operationId** | **UUID**| A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API | |
| **nodeTransitionType** | **String**| Indicates the type of transition to perform.  NodeTransitionType.Start will start a stopped node.  NodeTransitionType.Stop will stop a node that is up.   - Invalid - Reserved.  Do not pass into API.   - Start - Transition a stopped node to up.   - Stop - Transition an up node to stopped.  | [enum: Invalid, Start, Stop] |
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID partitionId = UUID.randomUUID(); // UUID | The identity of the partition.
    UUID operationId = UUID.randomUUID(); // UUID | A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API
    String restartPartitionMode = "Invalid"; // String | - Invalid - Reserved.  Do not pass into API. - AllReplicasOrInstances - All replicas or instances in the partition are restarted at once. - OnlyActiveSecondaries - Only the secondary replicas are restarted. 
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
...
| **partitionId** | **UUID**| The identity of the partition. | |
| **operationId** | **UUID**| A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API | |
| **restartPartitionMode** | **String**| - Invalid - Reserved.  Do not pass into API. - AllReplicasOrInstances - All replicas or instances in the partition are restarted at once. - OnlyActiveSecondaries - Only the secondary replicas are restarted.  | [enum: Invalid, AllReplicasOrInstances, OnlyActiveSecondaries] |
| **timeout** | **Long**| The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [optional] [default to 60] |
...
| **partitionId** | **UUID**| The identity of the partition. | |
| **operationId** | **UUID**| A GUID that identifies a call of this API.  This is passed into the corresponding GetProgress API | |
| **quorumLossMode** | **String**| This enum is passed to the StartQuorumLoss API to indicate what type of quorum loss to induce.   - Invalid - Reserved.  Do not pass into API.   - QuorumReplicas - Partial Quorum loss mode : Minimum number of replicas for a partition will be down that will cause a quorum loss.   - AllReplicas- Full Quorum loss mode : All replicas for a partition will be down that will cause a quorum loss.  | [enum: Invalid, QuorumReplicas, AllReplicas] |
