...
|------------- | ------------- | ------------- | -------------|
| **apiVersion** | **String**| The version of the API. This is a required parameter and it&#39;s value must be \&quot;6.0\&quot;. | [default to 6.0] [enum: 6.0] |
| **applicationTypeDefinitionKindFilter** | **Integer**| Used to filter on ApplicationTypeDefinitionKind for application type query operations. - Default - Default value, which performs the same function as selecting \&quot;All\&quot;. The value is 0. - All - Filter that matches input with any ApplicationTypeDefinitionKind value. The value is 65535. - ServiceFabricApplicationPackage - Filter that matches input with ApplicationTypeDefinitionKind value ServiceFabricApplicationPackage. The value is 1. - Compose - Filter that matches input with ApplicationTypeDefinitionKind value Compose. The value is 2.  | [optional] [default to 0] |
...
> provisionApplicationType(apiVersion, applicationTypeImageStorePath, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicationTypeApi apiInstance = new ApplicationTypeApi(defaultClient);
    String apiVersion = "6.0"; // String | The version of the API. This is a required parameter and it's value must be \"6.0\".
    ApplicationTypeImageStorePath applicationTypeImageStorePath = new ApplicationTypeImageStorePath(); // ApplicationTypeImageStorePath | The relative path for the application package in the image store specified during the prior copy operation.
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      apiInstance.provisionApplicationType(apiVersion, applicationTypeImageStorePath, timeout);
    } catch (ApiException e) {
...
> unprovisionApplicationType(apiVersion, applicationTypeName, applicationTypeImageStoreVersion, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    String apiVersion = "6.0"; // String | The version of the API. This is a required parameter and it's value must be \"6.0\".
    String applicationTypeName = "applicationTypeName_example"; // String | The name of the application type.
    ApplicationTypeImageStoreVersion applicationTypeImageStoreVersion = new ApplicationTypeImageStoreVersion(); // ApplicationTypeImageStoreVersion | The version of the application type in the image store.
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      apiInstance.unprovisionApplicationType(apiVersion, applicationTypeName, applicationTypeImageStoreVersion, timeout);
    } catch (ApiException e) {
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **202** | A 202 status code indicates the operation was accepted. A successful unprovision will return 202 status code. |  -  |
| **0** | The detailed error response. |  -  |
