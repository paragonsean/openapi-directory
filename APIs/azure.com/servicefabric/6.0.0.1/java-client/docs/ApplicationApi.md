...
> PagedApplicationInfoList getApplicationInfoList(apiVersion, applicationDefinitionKindFilter, applicationTypeName, excludeApplicationParameters, continuationToken, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      PagedApplicationInfoList result = apiInstance.getApplicationInfoList(apiVersion, applicationDefinitionKindFilter, applicationTypeName, excludeApplicationParameters, continuationToken, timeout);
      System.out.println(result);
    } catch (ApiException e) {
...
> DeployedApplicationInfo getDeployedApplicationInfo(apiVersion, nodeName, applicationId, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      DeployedApplicationInfo result = apiInstance.getDeployedApplicationInfo(apiVersion, nodeName, applicationId, timeout);
      System.out.println(result);
    } catch (ApiException e) {
...
> List&lt;DeployedApplicationInfo&gt; getDeployedApplicationInfoList(apiVersion, nodeName, timeout)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long timeout = 60L; // Long | The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
    try {
      List<DeployedApplicationInfo> result = apiInstance.getDeployedApplicationInfoList(apiVersion, nodeName, timeout);
      System.out.println(result);
    } catch (ApiException e) {
