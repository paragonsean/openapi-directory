...
class ApplicationDescription(Model):
    ...
    def __init__(self, application_capacity: ApplicationCapacityDescription=None, name: str=None, parameter_list: List[ApplicationParameter]=None, type_name: str=None, type_version: str=None):
