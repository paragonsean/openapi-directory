...
class ServicesHealthEvaluation(Model):
    ...
    def __init__(self, aggregated_health_state: HealthState=None, description: str=None, kind: HealthEvaluationKind=None, max_percent_unhealthy_services: int=None, service_type_name: str=None, total_count: int=None, unhealthy_evaluations: List[HealthEvaluationWrapper]=None):
