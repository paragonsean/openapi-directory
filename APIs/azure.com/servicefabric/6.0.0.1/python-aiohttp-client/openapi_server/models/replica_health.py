...
class ReplicaHealth(Model):
    ...
    def __init__(self, aggregated_health_state: HealthState=None, health_events: List[HealthEvent]=None, health_statistics: HealthStatistics=None, unhealthy_evaluations: List[HealthEvaluationWrapper]=None, partition_id: str=None, service_kind: ServiceKind=None):
