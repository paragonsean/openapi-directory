...
class DeployedApplicationInfo(Model):
    ...
    def __init__(self, id: str=None, log_directory: str=None, name: str=None, status: DeployedApplicationStatus=None, temp_directory: str=None, type_name: str=None, work_directory: str=None):
