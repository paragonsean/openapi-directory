...
async def create_service(request: web.Request, application_id, api_version, service_description, timeout=None) -> web.Response:
...
async def create_service_from_template(request: web.Request, application_id, api_version, service_from_template_description, timeout=None) -> web.Response:
