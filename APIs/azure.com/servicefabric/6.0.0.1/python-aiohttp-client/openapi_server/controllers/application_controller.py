...
async def get_application_info_list(request: web.Request, api_version, application_definition_kind_filter=None, application_type_name=None, exclude_application_parameters=None, continuation_token=None, timeout=None) -> web.Response:
...
async def get_deployed_application_info(request: web.Request, api_version, node_name, application_id, timeout=None) -> web.Response:
...
async def get_deployed_application_info_list(request: web.Request, api_version, node_name, timeout=None) -> web.Response:
