...
import ApplicationTypeImageStoreVersion from '../model/ApplicationTypeImageStoreVersion';
...
export default class ApplicationTypeApi {
    ...
    */
     ...
     * @param {module:model/String} apiVersion The version of the API. This is a required parameter and it's value must be \"6.0\".
     * @param {module:model/ApplicationTypeImageStorePath} applicationTypeImageStorePath The relative path for the application package in the image store specified during the prior copy operation.
     * @param {Object} opts Optional parameters
     * @param {Number} [timeout = 60)] The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
     ...
     */
    provisionApplicationType(apiVersion, applicationTypeImageStorePath, opts, callback) {
      opts = opts || {};
      let postBody = applicationTypeImageStorePath;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
      ...
      if (applicationTypeImageStorePath === undefined || applicationTypeImageStorePath === null) {
        throw new Error("Missing the required parameter 'applicationTypeImageStorePath' when calling provisionApplicationType");
      }
     ...
     * @param {module:model/String} apiVersion The version of the API. This is a required parameter and it's value must be \"6.0\".
     * @param {String} applicationTypeName The name of the application type.
     * @param {module:model/ApplicationTypeImageStoreVersion} applicationTypeImageStoreVersion The version of the application type in the image store.
     * @param {Object} opts Optional parameters
     * @param {Number} [timeout = 60)] The server timeout for performing the operation in seconds. This specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds.
     ...
     */
    unprovisionApplicationType(apiVersion, applicationTypeName, applicationTypeImageStoreVersion, opts, callback) {
      opts = opts || {};
      let postBody = applicationTypeImageStoreVersion;
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
      ...
      if (applicationTypeImageStoreVersion === undefined || applicationTypeImageStoreVersion === null) {
        throw new Error("Missing the required parameter 'applicationTypeImageStoreVersion' when calling unprovisionApplicationType");
      }
