...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceFabricClientApis.ApplicationUpgradeDescription();
  });
  ...
  describe('ApplicationUpgradeDescription', function() {
    it('should create an instance of ApplicationUpgradeDescription', function() {
      // uncomment below and update the code to test ApplicationUpgradeDescription
      //var instance = new ServiceFabricClientApis.ApplicationUpgradeDescription();
      //expect(instance).to.be.a(ServiceFabricClientApis.ApplicationUpgradeDescription);
    });
