...
#ifndef OAI_OAIClusterListByResourceGroupOperationApi_H
#define OAI_OAIClusterListByResourceGroupOperationApi_H
...
class OAIClusterListByResourceGroupOperationApi : public QObject {
    Q_OBJECT

public:
    OAIClusterListByResourceGroupOperationApi(const int timeOut = 0);
    ~OAIClusterListByResourceGroupOperationApi();
