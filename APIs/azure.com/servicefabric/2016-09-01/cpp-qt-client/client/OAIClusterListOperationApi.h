...
#ifndef OAI_OAIClusterListOperationApi_H
#define OAI_OAIClusterListOperationApi_H
...
class OAIClusterListOperationApi : public QObject {
    Q_OBJECT

public:
    OAIClusterListOperationApi(const int timeOut = 0);
    ~OAIClusterListOperationApi();
