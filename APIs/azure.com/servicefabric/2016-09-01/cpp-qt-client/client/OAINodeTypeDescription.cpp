...
QString OAINodeTypeDescription::getDurabilityLevel() const {
    return m_durability_level;
}
void OAINodeTypeDescription::setDurabilityLevel(const QString &durability_level) {
