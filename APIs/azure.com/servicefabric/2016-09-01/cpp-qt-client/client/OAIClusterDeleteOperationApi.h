...
#ifndef OAI_OAIClusterDeleteOperationApi_H
#define OAI_OAIClusterDeleteOperationApi_H
...
class OAIClusterDeleteOperationApi : public QObject {
    Q_OBJECT

public:
    OAIClusterDeleteOperationApi(const int timeOut = 0);
    ~OAIClusterDeleteOperationApi();
