...
public:
    ...
    */
    virtual void clusterVersionsGet(const QString &location, const QString &environment, const QString &api_version, const QString &subscription_id, const QString &cluster_version);
...
Q_SIGNALS:
    ...
    void clusterVersionsGetSignal(OAIClusterCodeVersionsResult summary);
    ...
    void clusterVersionsGetSignalFull(OAIHttpRequestWorker *worker, OAIClusterCodeVersionsResult summary);
    ...
    void clusterVersionsGetSignalE(OAIClusterCodeVersionsResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void clusterVersionsGetSignalError(OAIClusterCodeVersionsResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
