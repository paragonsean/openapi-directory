...
void OAIClusterUpgradePolicy::initializeModel() {
    ...
    m_override_user_upgrade_policy_isSet = false;
    m_override_user_upgrade_policy_isValid = false;
...
void OAIClusterUpgradePolicy::fromJsonObject(QJsonObject json) {
    ...
    m_override_user_upgrade_policy_isValid = ::OpenAPI::fromJsonValue(m_override_user_upgrade_policy, json[QString("overrideUserUpgradePolicy")]);
    m_override_user_upgrade_policy_isSet = !json[QString("overrideUserUpgradePolicy")].isNull() && m_override_user_upgrade_policy_isValid;
...
QJsonObject OAIClusterUpgradePolicy::asJsonObject() const {
    ...
    if (m_override_user_upgrade_policy_isSet) {
        obj.insert(QString("overrideUserUpgradePolicy"), ::OpenAPI::toJsonValue(m_override_user_upgrade_policy));
    }
...
bool OAIClusterUpgradePolicy::isOverrideUserUpgradePolicy() const {
    return m_override_user_upgrade_policy;
}
void OAIClusterUpgradePolicy::setOverrideUserUpgradePolicy(const bool &override_user_upgrade_policy) {
    m_override_user_upgrade_policy = override_user_upgrade_policy;
    m_override_user_upgrade_policy_isSet = true;
}

bool OAIClusterUpgradePolicy::is_override_user_upgrade_policy_Set() const{
    return m_override_user_upgrade_policy_isSet;
}

bool OAIClusterUpgradePolicy::is_override_user_upgrade_policy_Valid() const{
    return m_override_user_upgrade_policy_isValid;
}
