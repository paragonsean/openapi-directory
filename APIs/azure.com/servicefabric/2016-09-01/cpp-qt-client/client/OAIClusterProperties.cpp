...
QString OAIClusterProperties::getClusterState() const {
    return m_cluster_state;
}
void OAIClusterProperties::setClusterState(const QString &cluster_state) {
...
QString OAIClusterProperties::getReliabilityLevel() const {
    return m_reliability_level;
}
void OAIClusterProperties::setReliabilityLevel(const QString &reliability_level) {
...
QString OAIClusterProperties::getUpgradeMode() const {
    return m_upgrade_mode;
}
void OAIClusterProperties::setUpgradeMode(const QString &upgrade_mode) {
