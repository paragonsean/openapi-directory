...
#ifndef OAI_OAIClusterGetOperationApi_H
#define OAI_OAIClusterGetOperationApi_H
...
class OAIClusterGetOperationApi : public QObject {
    Q_OBJECT

public:
    OAIClusterGetOperationApi(const int timeOut = 0);
    ~OAIClusterGetOperationApi();
