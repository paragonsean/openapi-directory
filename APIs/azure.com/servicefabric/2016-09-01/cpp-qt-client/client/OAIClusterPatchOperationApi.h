...
#ifndef OAI_OAIClusterPatchOperationApi_H
#define OAI_OAIClusterPatchOperationApi_H
...
class OAIClusterPatchOperationApi : public QObject {
    Q_OBJECT

public:
    OAIClusterPatchOperationApi(const int timeOut = 0);
    ~OAIClusterPatchOperationApi();
