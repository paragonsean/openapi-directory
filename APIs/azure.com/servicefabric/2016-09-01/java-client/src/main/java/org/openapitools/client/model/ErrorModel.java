...
import org.openapitools.client.model.ErrorModelError;
...
public class ErrorModel {
  ...
  public ErrorModel error(ErrorModelError error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorModelError getError() {
    return error;
  }

  public void setError(ErrorModelError error) {
    this.error = error;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        ErrorModelError.validateJsonElement(jsonObj.get("error"));
      }
  }
