...
public class NodeTypeDescription {
   ...
   */
  @JsonAdapter(DurabilityLevelEnum.Adapter.class)
  public enum DurabilityLevelEnum {
    BRONZE("Bronze"),
    ...
    DurabilityLevelEnum(String value) {
      this.value = value;
    }
    ...
    public static DurabilityLevelEnum fromValue(String value) {
      for (DurabilityLevelEnum b : DurabilityLevelEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<DurabilityLevelEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DurabilityLevelEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DurabilityLevelEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return DurabilityLevelEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      DurabilityLevelEnum.fromValue(value);
    }
  }
  ...
  private DurabilityLevelEnum durabilityLevel;
  ...
  public NodeTypeDescription durabilityLevel(DurabilityLevelEnum durabilityLevel) {
   ...
   */
  @javax.annotation.Nullable
  public DurabilityLevelEnum getDurabilityLevel() {
    return durabilityLevel;
  }

  public void setDurabilityLevel(DurabilityLevelEnum durabilityLevel) {
    this.durabilityLevel = durabilityLevel;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("durabilityLevel") != null && !jsonObj.get("durabilityLevel").isJsonNull()) && !jsonObj.get("durabilityLevel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `durabilityLevel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("durabilityLevel").toString()));
      }
      // validate the optional field `durabilityLevel`
      if (jsonObj.get("durabilityLevel") != null && !jsonObj.get("durabilityLevel").isJsonNull()) {
        DurabilityLevelEnum.validateJsonElement(jsonObj.get("durabilityLevel"));
      }
