...
class SettingsSectionDescription {
     ...
     * @param name {String} The name of settings section
     * @param parameters {Array.<module:model/SettingsParameterDescription>} Collection of settings in the section, each setting is a tuple consisting of setting name and value
     */
