...
class NodeTypeDescription {
     ...
     * @param isPrimary {Boolean} Mark this as the primary node type
     * @param name {String} Name of the node type
     * @param vmInstanceCount {Number} The number of node instances in the node type
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('durabilityLevel')) {
                obj['durabilityLevel'] = ApiClient.convertToType(data['durabilityLevel'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['durabilityLevel'] && !(typeof data['durabilityLevel'] === 'string' || data['durabilityLevel'] instanceof String)) {
            throw new Error("Expected the field `durabilityLevel` to be a primitive type in the JSON string but got " + data['durabilityLevel']);
        }
 ...
 * @member {module:model/NodeTypeDescription.DurabilityLevelEnum} durabilityLevel
 */
...
/**
 * Allowed values for the <code>durabilityLevel</code> property.
 * @enum {String}
 * @readonly
 */
NodeTypeDescription['DurabilityLevelEnum'] = {
