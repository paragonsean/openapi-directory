...
class DiagnosticsStorageAccountConfig {
     ...
     * @param blobEndpoint {String} Diagnostics storage account blob endpoint
     * @param protectedAccountKeyName {String} Protected Diagnostics storage key name
     * @param queueEndpoint {String} Diagnostics storage account queue endpoint
     * @param storageAccountName {String} Diagnostics storage account name
     * @param tableEndpoint {String} Diagnostics storage account table endpoint
     */
