...
class ServiceDiagnosticSettings(Model):
    ...
    def __init__(self, logs: List[LogSettings]=None, metrics: List[MetricSettings]=None, service_bus_rule_id: str=None, storage_account_id: str=None, workspace_id: str=None):
