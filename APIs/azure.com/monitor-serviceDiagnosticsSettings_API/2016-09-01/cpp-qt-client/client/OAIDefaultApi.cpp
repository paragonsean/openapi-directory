...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("serviceDiagnosticSettingsUpdate", defaultConf);
    _serverIndices.insert("serviceDiagnosticSettingsUpdate", 0);
}
...
void OAIDefaultApi::serviceDiagnosticSettingsUpdate(const QString &resource_uri, const QString &api_version, const OAIServiceDiagnosticSettingsResourcePatch &service_diagnostic_settings_resource) {
    QString fullPath = QString(_serverConfigs["serviceDiagnosticSettingsUpdate"][_serverIndices.value("serviceDiagnosticSettingsUpdate")].URL()+"/{resourceUri}/providers/microsoft.insights/diagnosticSettings/service");
...

    {
        ...
        QByteArray output = service_diagnostic_settings_resource.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::serviceDiagnosticSettingsUpdateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::serviceDiagnosticSettingsUpdateCallback);
...
void OAIDefaultApi::serviceDiagnosticSettingsUpdateCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIServiceDiagnosticSettingsResource output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT serviceDiagnosticSettingsUpdateSignal(output);
        Q_EMIT serviceDiagnosticSettingsUpdateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT serviceDiagnosticSettingsUpdateSignalE(output, error_type, error_str);
        Q_EMIT serviceDiagnosticSettingsUpdateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT serviceDiagnosticSettingsUpdateSignalError(output, error_type, error_str);
        Q_EMIT serviceDiagnosticSettingsUpdateSignalErrorFull(worker, error_type, error_str);
    }
}
