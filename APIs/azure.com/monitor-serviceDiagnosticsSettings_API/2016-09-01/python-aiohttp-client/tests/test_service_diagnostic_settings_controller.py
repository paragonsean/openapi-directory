...
async def test_service_diagnostic_settings_create_or_update(client):
    ...
    """
    parameters = {"properties":{"serviceBusRuleId":"serviceBusRuleId","storageAccountId":"storageAccountId","eventHubAuthorizationRuleId":"eventHubAuthorizationRuleId","metrics":[{"timeGrain":"timeGrain","retentionPolicy":{"days":0,"enabled":True},"enabled":True},{"timeGrain":"timeGrain","retentionPolicy":{"days":0,"enabled":True},"enabled":True}],"logs":[{"retentionPolicy":{"days":0,"enabled":True},"category":"category","enabled":True},{"retentionPolicy":{"days":0,"enabled":True},"category":"category","enabled":True}],"workspaceId":"workspaceId"}}
