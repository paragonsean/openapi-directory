...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.OperationDisplay();
  });
  ...
  describe('OperationDisplay', function() {
    it('should create an instance of OperationDisplay', function() {
      ...
      //var instance = new HdInsightManagementClient.OperationDisplay();
      //expect(instance).to.be.a(HdInsightManagementClient.OperationDisplay);
    });
