...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new HdInsightManagementClient.ErrorResponse();
      //expect(instance).to.be.a(HdInsightManagementClient.ErrorResponse);
    });
