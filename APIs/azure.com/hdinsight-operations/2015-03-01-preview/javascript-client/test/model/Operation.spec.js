...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HdInsightManagementClient.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new HdInsightManagementClient.Operation();
      //expect(instance).to.be.a(HdInsightManagementClient.Operation);
    });
