...
public class ServersApiTest {
     ...
     */
    @Test
    public void serversCreateOrUpdateTest() throws ApiException {
        String apiVersion = null;
        String subscriptionId = null;
        String resourceGroupName = null;
        String serverName = null;
        ServerForCreate parameters = null;
        Server response = api.serversCreateOrUpdate(apiVersion, subscriptionId, resourceGroupName, serverName, parameters);
