...
async def test_servers_create_or_update(client):
    """Test case for servers_create_or_update

    
    """
    parameters = {"location":"location","sku":{"size":"size","tier":"Basic","name":"name","family":"family","capacity":0},"properties":{"sslEnforcement":"Enabled","createMode":"Default","storageMB":1024,"version":"5.6"},"tags":{"key":"tags"}}
...
async def test_servers_update(client):
    ...
    """
    parameters = {"sku":{"size":"size","tier":"Basic","name":"name","family":"family","capacity":0},"properties":{"sslEnforcement":"Enabled","administratorLoginPassword":"administratorLoginPassword","storageMB":1024,"version":"5.6"},"tags":{"key":"tags"}}
    params = [('api-version', 'api_version_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
