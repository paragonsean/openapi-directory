...
class Configuration {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = ConfigurationProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          ConfigurationProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/ConfigurationProperties} properties
 */
