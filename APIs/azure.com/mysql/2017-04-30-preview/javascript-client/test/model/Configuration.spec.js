...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MySqlManagementClient.Configuration();
  });
  ...
  describe('Configuration', function() {
    it('should create an instance of Configuration', function() {
      ...
      //var instance = new MySqlManagementClient.Configuration();
      //expect(instance).to.be.a(MySqlManagementClient.Configuration);
    });
