...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MySqlManagementClient.PerformanceTierServiceLevelObjectives();
  });
  ...
  describe('PerformanceTierServiceLevelObjectives', function() {
    it('should create an instance of PerformanceTierServiceLevelObjectives', function() {
      ...
      //var instance = new MySqlManagementClient.PerformanceTierServiceLevelObjectives();
      //expect(instance).to.be.a(MySqlManagementClient.PerformanceTierServiceLevelObjectives);
    });
