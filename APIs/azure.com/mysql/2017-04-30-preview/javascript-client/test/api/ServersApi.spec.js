...
(function(root, factory) {
  ...
  describe('ServersApi', function() {
    describe('serversCreateOrUpdate', function() {
      it('should call serversCreateOrUpdate successfully', function(done) {
        //uncomment below and update the code to test serversCreateOrUpdate
        //instance.serversCreateOrUpdate(function(error) {
