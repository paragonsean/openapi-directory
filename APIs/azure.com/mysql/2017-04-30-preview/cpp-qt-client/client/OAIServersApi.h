...
public:
    ...
    */
    virtual void serversCreateOrUpdate(const QString &api_version, const QString &subscription_id, const QString &resource_group_name, const QString &server_name, const OAIServerForCreate &parameters);
...
private:
    ...
    void serversCreateOrUpdateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void serversCreateOrUpdateSignal(OAIServer summary);
    ...
    void serversCreateOrUpdateSignalFull(OAIHttpRequestWorker *worker, OAIServer summary);
    ...
    Q_DECL_DEPRECATED_X("Use serversCreateOrUpdateSignalError() instead")
    void serversCreateOrUpdateSignalE(OAIServer summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serversCreateOrUpdateSignalError(OAIServer summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use serversCreateOrUpdateSignalErrorFull() instead")
    void serversCreateOrUpdateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serversCreateOrUpdateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
