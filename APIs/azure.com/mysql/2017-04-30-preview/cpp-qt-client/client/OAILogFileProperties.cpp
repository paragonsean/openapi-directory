...
QString OAILogFileProperties::getName() const {
    return m_name;
}
void OAILogFileProperties::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILogFileProperties::is_name_Set() const{
    return m_name_isSet;
}

bool OAILogFileProperties::is_name_Valid() const{
