...
OAIConfigurationProperties OAIConfiguration::getProperties() const {
    return m_properties;
}
void OAIConfiguration::setProperties(const OAIConfigurationProperties &properties) {
...
QString OAIConfiguration::getType() const {
    return m_type;
}
void OAIConfiguration::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIConfiguration::is_type_Valid() const{
